...
public class DatabasesApi {
    ...
    public okhttp3.Call databasesCreateOrUpdateCall(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName, Database parameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/databases/{databaseName}"
     ...
     */
    public okhttp3.Call databasesGetCall(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call databasesGetValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return databasesGetCall(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName, _callback);
     ...
     */
    public Database databasesGet(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName) throws ApiException {
        ApiResponse<Database> localVarResp = databasesGetWithHttpInfo(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Database> databasesGetWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName) throws ApiException {
        okhttp3.Call localVarCall = databasesGetValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName, null);
        Type localVarReturnType = new TypeToken<Database>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call databasesGetAsync(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, String databaseName, final ApiCallback<Database> _callback) throws ApiException {

        okhttp3.Call localVarCall = databasesGetValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName, _callback);
        Type localVarReturnType = new TypeToken<Database>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call databasesListByServerCall(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/databases"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "serverName" + "}", localVarApiClient.escapeString(serverName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call databasesListByServerValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return databasesListByServerCall(apiVersion, subscriptionId, resourceGroupName, serverName, _callback);
     ...
     */
    public DatabaseListResult databasesListByServer(String apiVersion, String subscriptionId, String resourceGroupName, String serverName) throws ApiException {
        ApiResponse<DatabaseListResult> localVarResp = databasesListByServerWithHttpInfo(apiVersion, subscriptionId, resourceGroupName, serverName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DatabaseListResult> databasesListByServerWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName, String serverName) throws ApiException {
        okhttp3.Call localVarCall = databasesListByServerValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, serverName, null);
     ...
     */
    public okhttp3.Call databasesListByServerAsync(String apiVersion, String subscriptionId, String resourceGroupName, String serverName, final ApiCallback<DatabaseListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = databasesListByServerValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, serverName, _callback);
        Type localVarReturnType = new TypeToken<DatabaseListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
