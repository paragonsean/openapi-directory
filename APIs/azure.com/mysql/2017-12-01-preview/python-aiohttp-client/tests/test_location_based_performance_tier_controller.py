...
async def test_location_based_performance_tier_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/providers/Microsoft.DBforMySQL/locations/{location_name}/performanceTiers'.format(subscription_id='subscription_id_example', location_name='location_name_example'),
        headers=headers,
        params=params,
        )
