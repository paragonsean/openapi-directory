...
/**
 * The ServerPropertiesForReplica model module.
 * @module model/ServerPropertiesForReplica
 * @version 2017-12-01-preview
 */
class ServerPropertiesForReplica {
    /**
     * Constructs a new <code>ServerPropertiesForReplica</code>.
     * The properties to create a new replica.
     * @alias module:model/ServerPropertiesForReplica
     * @extends module:model/ServerPropertiesForCreate
     * @implements module:model/ServerPropertiesForCreate
     * @param createMode {module:model/ServerPropertiesForReplica.CreateModeEnum} The mode to create a new server.
     */
    constructor(createMode) { 
        ServerPropertiesForCreate.initialize(this, createMode);
        ServerPropertiesForReplica.initialize(this, createMode);
    }
    ...
    /**
     * Constructs a <code>ServerPropertiesForReplica</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerPropertiesForReplica} obj Optional instance to populate.
     * @return {module:model/ServerPropertiesForReplica} The populated <code>ServerPropertiesForReplica</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerPropertiesForReplica();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerPropertiesForReplica</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerPropertiesForReplica</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerPropertiesForReplica.RequiredProperties) {
...
ServerPropertiesForReplica.RequiredProperties = ["sourceServerId", "createMode"];

/**
 * The master server id to create replica from.
 * @member {String} sourceServerId
 */
ServerPropertiesForReplica.prototype['sourceServerId'] = undefined;
...
export default ServerPropertiesForReplica;
