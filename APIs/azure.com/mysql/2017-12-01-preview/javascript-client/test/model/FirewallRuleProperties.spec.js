...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MySqlManagementClient.FirewallRuleProperties();
  });
  ...
  describe('FirewallRuleProperties', function() {
    it('should create an instance of FirewallRuleProperties', function() {
      ...
      //var instance = new MySqlManagementClient.FirewallRuleProperties();
      //expect(instance).to.be.a(MySqlManagementClient.FirewallRuleProperties);
    });
