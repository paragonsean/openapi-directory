...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MySqlManagementClient.FirewallRule();
  });
  ...
  describe('FirewallRule', function() {
    it('should create an instance of FirewallRule', function() {
      ...
      //var instance = new MySqlManagementClient.FirewallRule();
      //expect(instance).to.be.a(MySqlManagementClient.FirewallRule);
    });
