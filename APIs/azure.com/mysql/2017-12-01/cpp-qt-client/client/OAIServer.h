...
public:
    ...
    OAIServerProperties getProperties() const;
    void setProperties(const OAIServerProperties &properties);
...
private:
    ...
    OAIServerProperties m_properties;
