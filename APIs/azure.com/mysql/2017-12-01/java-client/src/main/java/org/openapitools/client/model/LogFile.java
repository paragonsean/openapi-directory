...
public class LogFile {
  ...
  public LogFile properties(LogFileProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, logFile.name) &&
        Objects.equals(this.properties, logFile.properties) &&
        Objects.equals(this.id, logFile.id) &&
        Objects.equals(this.type, logFile.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, properties, id, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        LogFileProperties.validateJsonElement(jsonObj.get("properties"));
      }
