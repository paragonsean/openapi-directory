# MySqlManagementClient.ServerSecurityAlertPoliciesApi
...
let apiInstance = new MySqlManagementClient.ServerSecurityAlertPoliciesApi();
...
let parameters = new MySqlManagementClient.ServerSecurityAlertPolicy(); // ServerSecurityAlertPolicy | The server security alert policy.
