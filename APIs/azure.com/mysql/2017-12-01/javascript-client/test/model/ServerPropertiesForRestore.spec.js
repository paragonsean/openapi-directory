...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MySqlManagementClient.ServerPropertiesForRestore();
  });
  ...
  describe('ServerPropertiesForRestore', function() {
    it('should create an instance of ServerPropertiesForRestore', function() {
      // uncomment below and update the code to test ServerPropertiesForRestore
      //var instance = new MySqlManagementClient.ServerPropertiesForRestore();
      //expect(instance).to.be.a(MySqlManagementClient.ServerPropertiesForRestore);
    });
