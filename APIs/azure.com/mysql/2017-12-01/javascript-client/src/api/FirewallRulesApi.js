    ...
    */
    ...
    firewallRulesCreateOrUpdate(apiVersion, subscriptionId, resourceGroupName, serverName, firewallRuleName, parameters, callback) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/firewallRules/{firewallRuleName}', 'PUT',
    ...
    firewallRulesDelete(apiVersion, subscriptionId, resourceGroupName, serverName, firewallRuleName, callback) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/firewallRules/{firewallRuleName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    firewallRulesGet(apiVersion, subscriptionId, resourceGroupName, serverName, firewallRuleName, callback) {
      ...
      let returnType = FirewallRule;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/firewallRules/{firewallRuleName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
