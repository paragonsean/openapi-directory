...
async def test_location_based_recommended_action_sessions_operation_status_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/providers/Microsoft.DBforMySQL/locations/{location_name}/recommendedActionSessionsAzureAsyncOperation/{operation_id}'.format(subscription_id='subscription_id_example', location_name='location_name_example', operation_id='operation_id_example'),
        headers=headers,
        params=params,
        )
