...
from openapi_server.models.server_properties_for_geo_restore import ServerPropertiesForGeoRestore
from openapi_server.models.server_properties_for_replica import ServerPropertiesForReplica
