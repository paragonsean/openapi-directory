...
class SloUsageMetric(Model):
    ...
    def __init__(self, in_range_time_ratio: float=None, service_level_objective: str=None, service_level_objective_id: str=None):
        """SloUsageMetric - a model defined in OpenAPI

        :param in_range_time_ratio: The in_range_time_ratio of this SloUsageMetric.
        :param service_level_objective: The service_level_objective of this SloUsageMetric.
        :param service_level_objective_id: The service_level_objective_id of this SloUsageMetric.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SloUsageMetric':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SloUsageMetric of this SloUsageMetric.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def in_range_time_ratio(self):
        """Gets the in_range_time_ratio of this SloUsageMetric.

        Gets or sets inRangeTimeRatio for SLO usage metric.

        :return: The in_range_time_ratio of this SloUsageMetric.
        :rtype: float
        """
    ...
    def in_range_time_ratio(self, in_range_time_ratio):
        """Sets the in_range_time_ratio of this SloUsageMetric.
    ...
    def service_level_objective(self):
        """Gets the service_level_objective of this SloUsageMetric.

        The serviceLevelObjective for SLO usage metric.

        :return: The service_level_objective of this SloUsageMetric.
        :rtype: str
        """
    ...
    def service_level_objective(self, service_level_objective):
        """Sets the service_level_objective of this SloUsageMetric.
    ...
    def service_level_objective_id(self):
        """Gets the service_level_objective_id of this SloUsageMetric.

        The serviceLevelObjectiveId for SLO usage metric.

        :return: The service_level_objective_id of this SloUsageMetric.
        :rtype: str
        """
    ...
    def service_level_objective_id(self, service_level_objective_id):
        """Sets the service_level_objective_id of this SloUsageMetric.
