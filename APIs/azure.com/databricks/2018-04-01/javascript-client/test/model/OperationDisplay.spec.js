...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatabricksClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new DatabricksClient.OperationDisplay();
      //expect(instance).to.be.a(DatabricksClient.OperationDisplay);
    });
