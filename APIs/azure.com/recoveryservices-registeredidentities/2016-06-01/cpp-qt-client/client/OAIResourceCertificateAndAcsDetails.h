...
/*
 * OAIResourceCertificateAndAcsDetails.h
 *
 * Certificate details representing the Vault credentials for ACS.
 */

#ifndef OAIResourceCertificateAndAcsDetails_H
#define OAIResourceCertificateAndAcsDetails_H
...
class OAIResourceCertificateAndAcsDetails : public OAIObject {
public:
    OAIResourceCertificateAndAcsDetails();
    OAIResourceCertificateAndAcsDetails(QString json);
    ~OAIResourceCertificateAndAcsDetails() override;
    ...
    QString getGlobalAcsHostName() const;
    void setGlobalAcsHostName(const QString &global_acs_host_name);
    bool is_global_acs_host_name_Set() const;
    bool is_global_acs_host_name_Valid() const;

    QString getGlobalAcsNamespace() const;
    void setGlobalAcsNamespace(const QString &global_acs_namespace);
    bool is_global_acs_namespace_Set() const;
    bool is_global_acs_namespace_Valid() const;

    QString getGlobalAcsRpRealm() const;
    void setGlobalAcsRpRealm(const QString &global_acs_rp_realm);
    bool is_global_acs_rp_realm_Set() const;
    bool is_global_acs_rp_realm_Valid() const;
...
private:
    ...
    QString m_global_acs_host_name;
    bool m_global_acs_host_name_isSet;
    bool m_global_acs_host_name_isValid;

    QString m_global_acs_namespace;
    bool m_global_acs_namespace_isSet;
    bool m_global_acs_namespace_isValid;

    QString m_global_acs_rp_realm;
    bool m_global_acs_rp_realm_isSet;
    bool m_global_acs_rp_realm_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceCertificateAndAcsDetails)

#endif // OAIResourceCertificateAndAcsDetails_H
