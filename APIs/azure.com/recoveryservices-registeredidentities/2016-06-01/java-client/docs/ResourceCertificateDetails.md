...
|**resourceId** | **Long** | Resource ID of the vault. |  [optional] |
|**subject** | **String** | Certificate Subject Name. |  [optional] |
|**thumbprint** | **String** | Certificate thumbprint. |  [optional] |
|**validFrom** | **OffsetDateTime** | Certificate Validity start Date time. |  [optional] |
|**validTo** | **OffsetDateTime** | Certificate Validity End Date time. |  [optional] |
