...
/*
 * OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties.h
 *
 * Properties of the peer express route circuit connection.
 */

#ifndef OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties_H
#define OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties_H
...
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties : public OAIObject {
public:
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties();
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties(QString json);
    ~OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties)

#endif // OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner_properties_H
