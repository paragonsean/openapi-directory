...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.RouteFilterPropertiesFormatIpv6PeeringsInnerProperties();
  });
  ...
  describe('RouteFilterPropertiesFormatIpv6PeeringsInnerProperties', function() {
    it('should create an instance of RouteFilterPropertiesFormatIpv6PeeringsInnerProperties', function() {
      // uncomment below and update the code to test RouteFilterPropertiesFormatIpv6PeeringsInnerProperties
      //var instance = new NetworkManagementClient.RouteFilterPropertiesFormatIpv6PeeringsInnerProperties();
      //expect(instance).to.be.a(NetworkManagementClient.RouteFilterPropertiesFormatIpv6PeeringsInnerProperties);
    });
