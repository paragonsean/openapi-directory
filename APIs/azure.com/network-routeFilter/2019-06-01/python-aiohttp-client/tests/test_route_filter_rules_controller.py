...
async def test_route_filter_rules_create_or_update(client):
    ...
    """
    route_filter_rule_parameters = {"name":"name","etag":"etag","location":"location","properties":{"access":"Allow","routeFilterRuleType":"Community","provisioningState":"provisioningState","communities":["communities","communities"]}}
...
async def test_route_filter_rules_update(client):
    ...
    """
    route_filter_rule_parameters = {"name":"name","etag":"etag","properties":{"access":"Allow","routeFilterRuleType":"Community","provisioningState":"provisioningState","communities":["communities","communities"]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
