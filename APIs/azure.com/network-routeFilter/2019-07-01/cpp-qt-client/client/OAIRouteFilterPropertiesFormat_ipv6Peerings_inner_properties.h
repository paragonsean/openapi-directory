...
/*
 * OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties.h
 *
 * Properties of the express route circuit peering.
 */

#ifndef OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_H
#define OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_H
...
#include "OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_expressRouteConnection.h"
...
namespace OpenAPI {
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_connections_inner;
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_expressRouteConnection;
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_ipv6PeeringConfig;
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_ipv6PeeringConfig_microsoftPeeringConfig;
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner;
...
class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_stats;

class OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties : public OAIObject {
public:
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties();
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties(QString json);
    ~OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties() override;
    ...
    QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_connections_inner> getConnections() const;
    void setConnections(const QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_connections_inner> &connections);
    bool is_connections_Set() const;
    bool is_connections_Valid() const;

    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_expressRouteConnection getExpressRouteConnection() const;
    void setExpressRouteConnection(const OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_expressRouteConnection &express_route_connection);
    ...
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_ipv6PeeringConfig getIpv6PeeringConfig() const;
    void setIpv6PeeringConfig(const OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_ipv6PeeringConfig &ipv6_peering_config);
    ...
    QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner> getPeeredConnections() const;
    void setPeeredConnections(const QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner> &peered_connections);
    ...
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_stats getStats() const;
    void setStats(const OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_stats &stats);
...
private:
    ...
    QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_connections_inner> m_connections;
    bool m_connections_isSet;
    bool m_connections_isValid;

    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_expressRouteConnection m_express_route_connection;
    ...
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_ipv6PeeringConfig m_ipv6_peering_config;
    ...
    QList<OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_peeredConnections_inner> m_peered_connections;
    ...
    OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_stats m_stats;
    bool m_stats_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties)

#endif // OAIRouteFilterPropertiesFormat_ipv6Peerings_inner_properties_H
