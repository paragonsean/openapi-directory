...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MediaServicesManagementClient.ApiEndpoint();
  });
  ...
  describe('ApiEndpoint', function() {
    it('should create an instance of ApiEndpoint', function() {
      // uncomment below and update the code to test ApiEndpoint
      //var instance = new MediaServicesManagementClient.ApiEndpoint();
      //expect(instance).to.be.a(MediaServicesManagementClient.ApiEndpoint);
    });
