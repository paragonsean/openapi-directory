...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MediaServicesManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new MediaServicesManagementClient.Operation();
      //expect(instance).to.be.a(MediaServicesManagementClient.Operation);
    });
