...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MediaServicesManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MediaServicesManagementClient.OperationDisplay();
      //expect(instance).to.be.a(MediaServicesManagementClient.OperationDisplay);
    });
