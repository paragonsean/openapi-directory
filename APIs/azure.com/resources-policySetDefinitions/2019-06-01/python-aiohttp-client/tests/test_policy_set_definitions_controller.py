...
async def test_policy_set_definitions_create_or_update(client):
    ...
    """
    parameters = {"name":"name","id":"id","type":"type","properties":{"metadata":"{}","displayName":"displayName","policyType":"NotSpecified","description":"description","policyDefinitions":[{"policyDefinitionId":"policyDefinitionId","parameters":"{}"},{"policyDefinitionId":"policyDefinitionId","parameters":"{}"}],"parameters":"{}"}}
