...
void OAIPolicySetDefinitionProperties::initializeModel() {
    ...
    m_policy_definition_groups_isSet = false;
    m_policy_definition_groups_isValid = false;
...
void OAIPolicySetDefinitionProperties::fromJsonObject(QJsonObject json) {
    ...
    m_policy_definition_groups_isValid = ::OpenAPI::fromJsonValue(m_policy_definition_groups, json[QString("policyDefinitionGroups")]);
    m_policy_definition_groups_isSet = !json[QString("policyDefinitionGroups")].isNull() && m_policy_definition_groups_isValid;
...
QJsonObject OAIPolicySetDefinitionProperties::asJsonObject() const {
    ...
    if (m_policy_definition_groups.size() > 0) {
        obj.insert(QString("policyDefinitionGroups"), ::OpenAPI::toJsonValue(m_policy_definition_groups));
    }
...
QMap<QString, OAIPolicySetDefinitionProperties_parameters_value> OAIPolicySetDefinitionProperties::getParameters() const {
    return m_parameters;
}
void OAIPolicySetDefinitionProperties::setParameters(const QMap<QString, OAIPolicySetDefinitionProperties_parameters_value> &parameters) {
...
QList<OAIPolicyDefinitionGroup> OAIPolicySetDefinitionProperties::getPolicyDefinitionGroups() const {
    return m_policy_definition_groups;
}
void OAIPolicySetDefinitionProperties::setPolicyDefinitionGroups(const QList<OAIPolicyDefinitionGroup> &policy_definition_groups) {
    m_policy_definition_groups = policy_definition_groups;
    m_policy_definition_groups_isSet = true;
}

bool OAIPolicySetDefinitionProperties::is_policy_definition_groups_Set() const{
    return m_policy_definition_groups_isSet;
}

bool OAIPolicySetDefinitionProperties::is_policy_definition_groups_Valid() const{
    return m_policy_definition_groups_isValid;
}
