...
/*
 * OAIServerOperationProperties.h
 *
 * The properties of a server operation.
 */

#ifndef OAIServerOperationProperties_H
#define OAIServerOperationProperties_H
...
class OAIServerOperationProperties : public OAIObject {
public:
    OAIServerOperationProperties();
    OAIServerOperationProperties(QString json);
    ~OAIServerOperationProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOperationProperties)

#endif // OAIServerOperationProperties_H
