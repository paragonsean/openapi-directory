...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.ServerOperationProperties();
  });
  ...
  describe('ServerOperationProperties', function() {
    it('should create an instance of ServerOperationProperties', function() {
      // uncomment below and update the code to test ServerOperationProperties
      //var instance = new SqlManagementClient.ServerOperationProperties();
      //expect(instance).to.be.a(SqlManagementClient.ServerOperationProperties);
    });
