...
import ServerOperation from './model/ServerOperation';
import ServerOperationListResult from './model/ServerOperationListResult';
import ServerOperationProperties from './model/ServerOperationProperties';
import ServerOperationsApi from './api/ServerOperationsApi';
...
export {
    ...
    /**
     * The ServerOperation model constructor.
     * @property {module:model/ServerOperation}
     */
    ServerOperation,

    /**
     * The ServerOperationListResult model constructor.
     * @property {module:model/ServerOperationListResult}
     */
    ServerOperationListResult,

    /**
     * The ServerOperationProperties model constructor.
     * @property {module:model/ServerOperationProperties}
     */
    ServerOperationProperties,

    /**
    * The ServerOperationsApi service constructor.
    * @property {module:api/ServerOperationsApi}
    */
    ServerOperationsApi
};
