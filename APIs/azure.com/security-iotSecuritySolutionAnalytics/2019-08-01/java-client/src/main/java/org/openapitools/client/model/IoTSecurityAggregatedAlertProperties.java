...
import org.openapitools.client.model.IoTSecurityAggregatedAlertPropertiesTopDevicesListInner;
...
public class IoTSecurityAggregatedAlertProperties {
  ...
  public static final String SERIALIZED_NAME_TOP_DEVICES_LIST = "topDevicesList";
  @SerializedName(SERIALIZED_NAME_TOP_DEVICES_LIST)
  private List<IoTSecurityAggregatedAlertPropertiesTopDevicesListInner> topDevicesList = new ArrayList<>();
  ...
  public IoTSecurityAggregatedAlertProperties(
     ...
     String systemSource, 
     List<IoTSecurityAggregatedAlertPropertiesTopDevicesListInner> topDevicesList, 
     String vendorName
  ) {
    this();
   ...
   * @return topDevicesList
   */
  @javax.annotation.Nullable
  public List<IoTSecurityAggregatedAlertPropertiesTopDevicesListInner> getTopDevicesList() {
    return topDevicesList;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionTaken, ioTSecurityAggregatedAlertProperties.actionTaken) &&
        ...
        Objects.equals(this.topDevicesList, ioTSecurityAggregatedAlertProperties.topDevicesList) &&
        Objects.equals(this.vendorName, ioTSecurityAggregatedAlertProperties.vendorName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionTaken, aggregatedDateUtc, alertDisplayName, alertType, count, description, effectedResourceType, logAnalyticsQuery, remediationSteps, reportedSeverity, systemSource, topDevicesList, vendorName);
  }
  ...
  public String toString() {
    ...
    sb.append("    topDevicesList: ").append(toIndentedString(topDevicesList)).append("\n");
  ...
  static {
    ...
    openapiFields.add("topDevicesList");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("topDevicesList") != null && !jsonObj.get("topDevicesList").isJsonNull()) {
        JsonArray jsonArraytopDevicesList = jsonObj.getAsJsonArray("topDevicesList");
        if (jsonArraytopDevicesList != null) {
          // ensure the json data is an array
          if (!jsonObj.get("topDevicesList").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `topDevicesList` to be an array in the JSON string but got `%s`", jsonObj.get("topDevicesList").toString()));
          }

          // validate the optional field `topDevicesList` (array)
          for (int i = 0; i < jsonArraytopDevicesList.size(); i++) {
            IoTSecurityAggregatedAlertPropertiesTopDevicesListInner.validateJsonElement(jsonArraytopDevicesList.get(i));
          };
        }
      }
