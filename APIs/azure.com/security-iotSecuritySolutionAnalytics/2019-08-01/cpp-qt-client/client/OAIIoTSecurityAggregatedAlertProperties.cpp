...
void OAIIoTSecurityAggregatedAlertProperties::initializeModel() {
    ...
    m_top_devices_list_isSet = false;
    m_top_devices_list_isValid = false;
...
void OAIIoTSecurityAggregatedAlertProperties::fromJsonObject(QJsonObject json) {
    ...
    m_top_devices_list_isValid = ::OpenAPI::fromJsonValue(m_top_devices_list, json[QString("topDevicesList")]);
    m_top_devices_list_isSet = !json[QString("topDevicesList")].isNull() && m_top_devices_list_isValid;
...
QJsonObject OAIIoTSecurityAggregatedAlertProperties::asJsonObject() const {
    ...
    if (m_top_devices_list.size() > 0) {
        obj.insert(QString("topDevicesList"), ::OpenAPI::toJsonValue(m_top_devices_list));
    }
...
QList<OAIIoTSecurityAggregatedAlertProperties_topDevicesList_inner> OAIIoTSecurityAggregatedAlertProperties::getTopDevicesList() const {
    return m_top_devices_list;
}
void OAIIoTSecurityAggregatedAlertProperties::setTopDevicesList(const QList<OAIIoTSecurityAggregatedAlertProperties_topDevicesList_inner> &top_devices_list) {
    m_top_devices_list = top_devices_list;
    m_top_devices_list_isSet = true;
}

bool OAIIoTSecurityAggregatedAlertProperties::is_top_devices_list_Set() const{
    return m_top_devices_list_isSet;
}

bool OAIIoTSecurityAggregatedAlertProperties::is_top_devices_list_Valid() const{
    return m_top_devices_list_isValid;
}
