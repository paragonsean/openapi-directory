...
/*
 * OAIPaginatedArtifactList.h
 *
 * A paginated list of Artifacts.
 */

#ifndef OAIPaginatedArtifactList_H
#define OAIPaginatedArtifactList_H
...
class OAIPaginatedArtifactList : public OAIObject {
public:
    OAIPaginatedArtifactList();
    OAIPaginatedArtifactList(QString json);
    ~OAIPaginatedArtifactList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginatedArtifactList)

#endif // OAIPaginatedArtifactList_H
