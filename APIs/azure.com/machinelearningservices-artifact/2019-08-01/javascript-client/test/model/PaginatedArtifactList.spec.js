...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Artifact.PaginatedArtifactList();
  });
  ...
  describe('PaginatedArtifactList', function() {
    it('should create an instance of PaginatedArtifactList', function() {
      // uncomment below and update the code to test PaginatedArtifactList
      //var instance = new Artifact.PaginatedArtifactList();
      //expect(instance).to.be.a(Artifact.PaginatedArtifactList);
    });
