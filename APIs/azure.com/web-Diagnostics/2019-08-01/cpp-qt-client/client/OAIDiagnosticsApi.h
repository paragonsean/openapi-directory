...
#include "OAIDiagnostics_ListHostingEnvironmentDetectorResponses_default_response.h"
#include <QString>
...
Q_SIGNALS:
    ...
    void diagnosticsGetSiteAnalysisSignal(OAIAnalysisDefinition summary);
    void diagnosticsGetSiteAnalysisSlotSignal(OAIAnalysisDefinition summary);
    void diagnosticsGetSiteDetectorSignal(OAIDetectorDefinition summary);
    ...
    void diagnosticsGetSiteDetectorSlotSignal(OAIDetectorDefinition summary);
    ...
    void diagnosticsGetSiteAnalysisSignalFull(OAIHttpRequestWorker *worker, OAIAnalysisDefinition summary);
    void diagnosticsGetSiteAnalysisSlotSignalFull(OAIHttpRequestWorker *worker, OAIAnalysisDefinition summary);
    void diagnosticsGetSiteDetectorSignalFull(OAIHttpRequestWorker *worker, OAIDetectorDefinition summary);
    ...
    void diagnosticsGetSiteDetectorSlotSignalFull(OAIHttpRequestWorker *worker, OAIDetectorDefinition summary);
    ...
    void diagnosticsGetSiteAnalysisSignalE(OAIAnalysisDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticsGetSiteAnalysisSignalError(OAIAnalysisDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use diagnosticsGetSiteAnalysisSlotSignalError() instead")
    void diagnosticsGetSiteAnalysisSlotSignalE(OAIAnalysisDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticsGetSiteAnalysisSlotSignalError(OAIAnalysisDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use diagnosticsGetSiteDetectorSignalError() instead")
    void diagnosticsGetSiteDetectorSignalE(OAIDetectorDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticsGetSiteDetectorSignalError(OAIDetectorDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void diagnosticsGetSiteDetectorSlotSignalE(OAIDetectorDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticsGetSiteDetectorSlotSignalError(OAIDetectorDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
