...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizationManagementClient.DenyAssignmentListResult();
  });
  ...
  describe('DenyAssignmentListResult', function() {
    it('should create an instance of DenyAssignmentListResult', function() {
      // uncomment below and update the code to test DenyAssignmentListResult
      //var instance = new AuthorizationManagementClient.DenyAssignmentListResult();
      //expect(instance).to.be.a(AuthorizationManagementClient.DenyAssignmentListResult);
    });
