...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizationManagementClient.Principal();
  });
  ...
  describe('Principal', function() {
    it('should create an instance of Principal', function() {
      ...
      //var instance = new AuthorizationManagementClient.Principal();
      //expect(instance).to.be.a(AuthorizationManagementClient.Principal);
    });
