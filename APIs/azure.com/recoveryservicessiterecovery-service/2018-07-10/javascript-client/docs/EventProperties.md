# SiteRecoveryManagementClient.EventProperties
...
**healthErrors** | [**[HealthError]**](HealthError.md) | The list of errors / warnings capturing details associated with the issue(s). | [optional] 
...
**timeOfOccurrence** | **Date** | The time of occurrence of the event. | [optional] 
