# SiteRecoveryManagementClient.EventQueryParameter
...
**endTime** | **Date** | The end time of the time range within which the events are to be queried. | [optional] 
...
**startTime** | **Date** | The start time of the time range within which the events are to be queried. | [optional] 
