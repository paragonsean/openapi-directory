...
**unprotectedDisks** | [**[A2AUnprotectedDiskDetails]**](A2AUnprotectedDiskDetails.md) | The list of unprotected disks. | [optional] 
**vmEncryptionType** | **String** | The encryption type of the VM. | [optional] [readonly] 
...
* `NotEncrypted` (value: `"NotEncrypted"`)

* `OnePassEncrypted` (value: `"OnePassEncrypted"`)

* `TwoPassEncrypted` (value: `"TwoPassEncrypted"`)
