...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.A2AReprotectInput();
  });
  ...
  describe('A2AReprotectInput', function() {
    it('should create an instance of A2AReprotectInput', function() {
      // uncomment below and update the code to test A2AReprotectInput
      //var instance = new SiteRecoveryManagementClient.A2AReprotectInput();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.A2AReprotectInput);
    });
