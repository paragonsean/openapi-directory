...
(function(root, factory) {
  ...
  describe('A2AReplicationDetails', function() {
    ...
    it('should have the property initialPrimaryFabricLocation (base name: "initialPrimaryFabricLocation")', function() {
      // uncomment below and update the code to test the property initialPrimaryFabricLocation
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });

    it('should have the property initialRecoveryFabricLocation (base name: "initialRecoveryFabricLocation")', function() {
      // uncomment below and update the code to test the property initialRecoveryFabricLocation
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property multiVmGroupCreateOption (base name: "multiVmGroupCreateOption")', function() {
      // uncomment below and update the code to test the property multiVmGroupCreateOption
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tfoAzureVMName (base name: "tfoAzureVMName")', function() {
      // uncomment below and update the code to test the property tfoAzureVMName
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });

    it('should have the property unprotectedDisks (base name: "unprotectedDisks")', function() {
      // uncomment below and update the code to test the property unprotectedDisks
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });

    it('should have the property vmEncryptionType (base name: "vmEncryptionType")', function() {
      // uncomment below and update the code to test the property vmEncryptionType
      //var instance = new SiteRecoveryManagementClient.A2AReplicationDetails();
      //expect(instance).to.be();
    });
