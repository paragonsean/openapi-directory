...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.JobDetails();
  });
  ...
  describe('JobDetails', function() {
    it('should create an instance of JobDetails', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.JobDetails();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.JobDetails);
    });

    it('should have the property affectedObjectDetails (base name: "affectedObjectDetails")', function() {
      // uncomment below and update the code to test the property affectedObjectDetails
      //var instance = new SiteRecoveryManagementClient.JobDetails();
