...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.EnableProtectionInputProperties();
  });
  ...
  describe('EnableProtectionInputProperties', function() {
    it('should create an instance of EnableProtectionInputProperties', function() {
      // uncomment below and update the code to test EnableProtectionInputProperties
      //var instance = new SiteRecoveryManagementClient.EnableProtectionInputProperties();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.EnableProtectionInputProperties);
    });
