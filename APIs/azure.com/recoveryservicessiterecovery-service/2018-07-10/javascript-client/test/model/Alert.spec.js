...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Alert();
  });
  ...
  describe('Alert', function() {
    it('should create an instance of Alert', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Alert();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Alert);
    });
