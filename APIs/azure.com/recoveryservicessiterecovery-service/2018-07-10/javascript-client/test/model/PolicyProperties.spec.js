...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.PolicyProperties();
  });
  ...
  describe('PolicyProperties', function() {
    it('should create an instance of PolicyProperties', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.PolicyProperties();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.PolicyProperties);
    });
