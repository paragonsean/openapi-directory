...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.VMwareCbtUpdateMigrationItemInput();
  });
  ...
  describe('VMwareCbtUpdateMigrationItemInput', function() {
    it('should create an instance of VMwareCbtUpdateMigrationItemInput', function() {
      // uncomment below and update the code to test VMwareCbtUpdateMigrationItemInput
      //var instance = new SiteRecoveryManagementClient.VMwareCbtUpdateMigrationItemInput();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.VMwareCbtUpdateMigrationItemInput);
    });
