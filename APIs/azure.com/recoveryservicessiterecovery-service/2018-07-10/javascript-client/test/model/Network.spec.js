...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Network();
  });
  ...
  describe('Network', function() {
    it('should create an instance of Network', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Network();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Network);
    });
