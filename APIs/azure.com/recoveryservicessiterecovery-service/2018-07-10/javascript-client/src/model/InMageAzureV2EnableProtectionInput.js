...
import InMageAzureV2DiskInputDetails from './InMageAzureV2DiskInputDetails';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('disksToInclude')) {
                obj['disksToInclude'] = ApiClient.convertToType(data['disksToInclude'], [InMageAzureV2DiskInputDetails]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['disksToInclude']) { // data not null
            ...
            for (const item of data['disksToInclude']) {
                InMageAzureV2DiskInputDetails.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
InMageAzureV2EnableProtectionInput.prototype['diskEncryptionSetId'] = undefined;

/**
 * The DiskType.
 * @member {module:model/InMageAzureV2EnableProtectionInput.DiskTypeEnum} diskType
 */
InMageAzureV2EnableProtectionInput.prototype['diskType'] = undefined;

/**
 * The disks to include list.
 * @member {Array.<module:model/InMageAzureV2DiskInputDetails>} disksToInclude
 */
 ...
 * @readonly
 */
InMageAzureV2EnableProtectionInput['DiskTypeEnum'] = {
