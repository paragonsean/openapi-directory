...
import ProtectionContainerProperties from './ProtectionContainerProperties';
...
class ProtectionContainer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ProtectionContainerProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ProtectionContainerProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ProtectionContainerProperties} properties
 */
ProtectionContainer.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
ProtectionContainer.prototype['id'] = undefined;

/**
 * Resource Location
 * @member {String} location
 */
ProtectionContainer.prototype['location'] = undefined;

/**
 * Resource Name
 * @member {String} name
 */
ProtectionContainer.prototype['name'] = undefined;

/**
 * Resource Type
 * @member {String} type
 */
ProtectionContainer.prototype['type'] = undefined;
