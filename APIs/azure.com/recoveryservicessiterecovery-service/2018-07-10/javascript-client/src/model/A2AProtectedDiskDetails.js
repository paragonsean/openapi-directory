...
class A2AProtectedDiskDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allowedDiskLevelOperation')) {
                obj['allowedDiskLevelOperation'] = ApiClient.convertToType(data['allowedDiskLevelOperation'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['allowedDiskLevelOperation'])) {
            throw new Error("Expected the field `allowedDiskLevelOperation` to be an array in the JSON data but got " + data['allowedDiskLevelOperation']);
        }
 ...
 * @member {Array.<String>} allowedDiskLevelOperation
 */
A2AProtectedDiskDetails.prototype['allowedDiskLevelOperation'] = undefined;
...
/**
 * The disk state.
 * @member {String} diskState
 */
A2AProtectedDiskDetails.prototype['diskState'] = undefined;
