...
class HealthError {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customerResolvability')) {
                obj['customerResolvability'] = ApiClient.convertToType(data['customerResolvability'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['customerResolvability'] && !(typeof data['customerResolvability'] === 'string' || data['customerResolvability'] instanceof String)) {
            throw new Error("Expected the field `customerResolvability` to be a primitive type in the JSON string but got " + data['customerResolvability']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/HealthError.CustomerResolvabilityEnum} customerResolvability
 */
HealthError.prototype['customerResolvability'] = undefined;
 ...
 */
HealthError.prototype['errorId'] = undefined;
...
/**
 * Allowed values for the <code>customerResolvability</code> property.
 * @enum {String}
 * @readonly
 */
HealthError['CustomerResolvabilityEnum'] = {
