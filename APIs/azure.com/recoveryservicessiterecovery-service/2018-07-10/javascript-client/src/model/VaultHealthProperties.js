...
class VaultHealthProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('containersHealth')) {
                obj['containersHealth'] = ResourceHealthSummary.constructFromObject(data['containersHealth']);
            }
    ...
    static validateJSON(data) {
        // validate the optional field `containersHealth`
        if (data['containersHealth']) { // data not null
          ResourceHealthSummary.validateJSON(data['containersHealth']);
        }
...
/**
 * @member {module:model/ResourceHealthSummary} containersHealth
 */
VaultHealthProperties.prototype['containersHealth'] = undefined;
