...
import InMageAzureV2ManagedDiskDetails from './InMageAzureV2ManagedDiskDetails';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('protectedManagedDisks')) {
                obj['protectedManagedDisks'] = ApiClient.convertToType(data['protectedManagedDisks'], [InMageAzureV2ManagedDiskDetails]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['protectedManagedDisks']) { // data not null
            ...
            for (const item of data['protectedManagedDisks']) {
                InMageAzureV2ManagedDiskDetails.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/InMageAzureV2ManagedDiskDetails>} protectedManagedDisks
 */
InMageAzureV2ReplicationDetails.prototype['protectedManagedDisks'] = undefined;
