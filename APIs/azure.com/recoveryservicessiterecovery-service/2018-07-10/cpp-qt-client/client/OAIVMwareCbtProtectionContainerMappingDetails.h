...
/*
 * OAIVMwareCbtProtectionContainerMappingDetails.h
 *
 * VMwareCbt provider specific container mapping details.
 */

#ifndef OAIVMwareCbtProtectionContainerMappingDetails_H
#define OAIVMwareCbtProtectionContainerMappingDetails_H
...
class OAIVMwareCbtProtectionContainerMappingDetails : public OAIObject {
public:
    OAIVMwareCbtProtectionContainerMappingDetails();
    OAIVMwareCbtProtectionContainerMappingDetails(QString json);
    ~OAIVMwareCbtProtectionContainerMappingDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVMwareCbtProtectionContainerMappingDetails)

#endif // OAIVMwareCbtProtectionContainerMappingDetails_H
