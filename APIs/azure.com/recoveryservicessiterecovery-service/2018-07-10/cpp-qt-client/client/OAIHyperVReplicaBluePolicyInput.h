...
/*
 * OAIHyperVReplicaBluePolicyInput.h
 *
 * HyperV Replica Blue policy input.
 */

#ifndef OAIHyperVReplicaBluePolicyInput_H
#define OAIHyperVReplicaBluePolicyInput_H
...
class OAIHyperVReplicaBluePolicyInput : public OAIObject {
public:
    OAIHyperVReplicaBluePolicyInput();
    OAIHyperVReplicaBluePolicyInput(QString json);
    ~OAIHyperVReplicaBluePolicyInput() override;
    ...
    QString getReplicaDeletion() const;
    void setReplicaDeletion(const QString &replica_deletion);
    bool is_replica_deletion_Set() const;
    bool is_replica_deletion_Valid() const;

    qint32 getReplicationFrequencyInSeconds() const;
    void setReplicationFrequencyInSeconds(const qint32 &replication_frequency_in_seconds);
    bool is_replication_frequency_in_seconds_Set() const;
    bool is_replication_frequency_in_seconds_Valid() const;
...
private:
    ...
    QString m_replica_deletion;
    bool m_replica_deletion_isSet;
    bool m_replica_deletion_isValid;

    qint32 m_replication_frequency_in_seconds;
    bool m_replication_frequency_in_seconds_isSet;
    bool m_replication_frequency_in_seconds_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaBluePolicyInput)

#endif // OAIHyperVReplicaBluePolicyInput_H
