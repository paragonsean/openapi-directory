...
/*
 * OAIHyperVReplicaBasePolicyDetails.h
 *
 * Base class for HyperVReplica policy details.
 */

#ifndef OAIHyperVReplicaBasePolicyDetails_H
#define OAIHyperVReplicaBasePolicyDetails_H
...
class OAIHyperVReplicaBasePolicyDetails : public OAIObject {
public:
    OAIHyperVReplicaBasePolicyDetails();
    OAIHyperVReplicaBasePolicyDetails(QString json);
    ~OAIHyperVReplicaBasePolicyDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaBasePolicyDetails)

#endif // OAIHyperVReplicaBasePolicyDetails_H
