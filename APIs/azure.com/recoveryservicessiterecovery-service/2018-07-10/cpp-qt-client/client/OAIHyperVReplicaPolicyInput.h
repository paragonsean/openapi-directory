...
/*
 * OAIHyperVReplicaPolicyInput.h
 *
 * Hyper-V Replica specific policy Input.
 */

#ifndef OAIHyperVReplicaPolicyInput_H
#define OAIHyperVReplicaPolicyInput_H
...
class OAIHyperVReplicaPolicyInput : public OAIObject {
public:
    OAIHyperVReplicaPolicyInput();
    OAIHyperVReplicaPolicyInput(QString json);
    ~OAIHyperVReplicaPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaPolicyInput)

#endif // OAIHyperVReplicaPolicyInput_H
