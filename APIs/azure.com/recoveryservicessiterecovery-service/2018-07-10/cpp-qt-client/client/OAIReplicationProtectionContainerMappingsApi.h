...
public:
    ...
    * @param[in]  protection_container_name QString [required]
    * @param[in]  mapping_name QString [required]
    * @param[in]  update_input OAIUpdateProtectionContainerMappingInput [required]
    */
    virtual void replicationProtectionContainerMappingsUpdate(const QString &api_version, const QString &resource_name, const QString &resource_group_name, const QString &subscription_id, const QString &fabric_name, const QString &protection_container_name, const QString &mapping_name, const OAIUpdateProtectionContainerMappingInput &update_input);
...
private:
    ...
    void replicationProtectionContainerMappingsUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void replicationProtectionContainerMappingsUpdateSignal(OAIProtectionContainerMapping summary);
    ...
    void replicationProtectionContainerMappingsUpdateSignalFull(OAIHttpRequestWorker *worker, OAIProtectionContainerMapping summary);
    ...
    Q_DECL_DEPRECATED_X("Use replicationProtectionContainerMappingsUpdateSignalError() instead")
    void replicationProtectionContainerMappingsUpdateSignalE(OAIProtectionContainerMapping summary, QNetworkReply::NetworkError error_type, QString error_str);
    void replicationProtectionContainerMappingsUpdateSignalError(OAIProtectionContainerMapping summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use replicationProtectionContainerMappingsUpdateSignalErrorFull() instead")
    void replicationProtectionContainerMappingsUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void replicationProtectionContainerMappingsUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
