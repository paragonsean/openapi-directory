...
OAIDiskEncryptionInfo OAIA2AVmManagedDiskInputDetails::getDiskEncryptionInfo() const {
    return m_disk_encryption_info;
}
void OAIA2AVmManagedDiskInputDetails::setDiskEncryptionInfo(const OAIDiskEncryptionInfo &disk_encryption_info) {
    m_disk_encryption_info = disk_encryption_info;
    m_disk_encryption_info_isSet = true;
}

bool OAIA2AVmManagedDiskInputDetails::is_disk_encryption_info_Set() const{
    return m_disk_encryption_info_isSet;
}

bool OAIA2AVmManagedDiskInputDetails::is_disk_encryption_info_Valid() const{
...
QString OAIA2AVmManagedDiskInputDetails::getRecoveryDiskEncryptionSetId() const {
    return m_recovery_disk_encryption_set_id;
}
void OAIA2AVmManagedDiskInputDetails::setRecoveryDiskEncryptionSetId(const QString &recovery_disk_encryption_set_id) {
    m_recovery_disk_encryption_set_id = recovery_disk_encryption_set_id;
    m_recovery_disk_encryption_set_id_isSet = true;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_disk_encryption_set_id_Set() const{
    return m_recovery_disk_encryption_set_id_isSet;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_disk_encryption_set_id_Valid() const{
