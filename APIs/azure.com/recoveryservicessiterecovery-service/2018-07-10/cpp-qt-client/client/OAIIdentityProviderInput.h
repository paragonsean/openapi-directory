...
/*
 * OAIIdentityProviderInput.h
 *
 * Identity provider input.
 */

#ifndef OAIIdentityProviderInput_H
#define OAIIdentityProviderInput_H
...
class OAIIdentityProviderInput : public OAIObject {
public:
    OAIIdentityProviderInput();
    OAIIdentityProviderInput(QString json);
    ~OAIIdentityProviderInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityProviderInput)

#endif // OAIIdentityProviderInput_H
