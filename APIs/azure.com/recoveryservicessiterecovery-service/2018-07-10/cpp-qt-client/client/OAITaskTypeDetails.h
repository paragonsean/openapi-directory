...
/*
 * OAITaskTypeDetails.h
 *
 * Task details based on specific task type.
 */

#ifndef OAITaskTypeDetails_H
#define OAITaskTypeDetails_H
...
class OAITaskTypeDetails : public OAIObject {
public:
    OAITaskTypeDetails();
    OAITaskTypeDetails(QString json);
    ~OAITaskTypeDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskTypeDetails)

#endif // OAITaskTypeDetails_H
