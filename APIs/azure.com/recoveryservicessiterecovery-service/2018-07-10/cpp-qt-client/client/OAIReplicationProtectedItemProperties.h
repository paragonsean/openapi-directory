...
public:
    ...
    QString getPrimaryFabricProvider() const;
    void setPrimaryFabricProvider(const QString &primary_fabric_provider);
    bool is_primary_fabric_provider_Set() const;
    bool is_primary_fabric_provider_Valid() const;
...
private:
    ...
    QString m_primary_fabric_provider;
    bool m_primary_fabric_provider_isSet;
    bool m_primary_fabric_provider_isValid;
