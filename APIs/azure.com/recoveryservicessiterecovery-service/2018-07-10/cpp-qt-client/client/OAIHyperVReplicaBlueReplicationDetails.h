...
/*
 * OAIHyperVReplicaBlueReplicationDetails.h
 *
 * HyperV replica 2012 R2 (Blue) replication details.
 */

#ifndef OAIHyperVReplicaBlueReplicationDetails_H
#define OAIHyperVReplicaBlueReplicationDetails_H
...
class OAIHyperVReplicaBlueReplicationDetails : public OAIObject {
public:
    OAIHyperVReplicaBlueReplicationDetails();
    OAIHyperVReplicaBlueReplicationDetails(QString json);
    ~OAIHyperVReplicaBlueReplicationDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaBlueReplicationDetails)

#endif // OAIHyperVReplicaBlueReplicationDetails_H
