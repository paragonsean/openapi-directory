...
OAIRecoveryPlanTestFailoverInputProperties::OAIRecoveryPlanTestFailoverInputProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecoveryPlanTestFailoverInputProperties::OAIRecoveryPlanTestFailoverInputProperties() {
    this->initializeModel();
}

OAIRecoveryPlanTestFailoverInputProperties::~OAIRecoveryPlanTestFailoverInputProperties() {}

void OAIRecoveryPlanTestFailoverInputProperties::initializeModel() {
...
void OAIRecoveryPlanTestFailoverInputProperties::fromJson(QString jsonString) {
...
void OAIRecoveryPlanTestFailoverInputProperties::fromJsonObject(QJsonObject json) {
...
QString OAIRecoveryPlanTestFailoverInputProperties::asJson() const {
...
QJsonObject OAIRecoveryPlanTestFailoverInputProperties::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRecoveryPlanTestFailoverInputProperties::getFailoverDirection() const {
    return m_failover_direction;
}
void OAIRecoveryPlanTestFailoverInputProperties::setFailoverDirection(const QString &failover_direction) {
    m_failover_direction = failover_direction;
    m_failover_direction_isSet = true;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_failover_direction_Set() const{
    return m_failover_direction_isSet;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_failover_direction_Valid() const{
    return m_failover_direction_isValid;
}

QString OAIRecoveryPlanTestFailoverInputProperties::getNetworkId() const {
    return m_network_id;
}
void OAIRecoveryPlanTestFailoverInputProperties::setNetworkId(const QString &network_id) {
    m_network_id = network_id;
    m_network_id_isSet = true;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_network_id_Set() const{
    return m_network_id_isSet;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_network_id_Valid() const{
    return m_network_id_isValid;
}

QString OAIRecoveryPlanTestFailoverInputProperties::getNetworkType() const {
    return m_network_type;
}
void OAIRecoveryPlanTestFailoverInputProperties::setNetworkType(const QString &network_type) {
    m_network_type = network_type;
    m_network_type_isSet = true;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_network_type_Set() const{
    return m_network_type_isSet;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_network_type_Valid() const{
    return m_network_type_isValid;
}

QList<OAIRecoveryPlanProviderSpecificFailoverInput> OAIRecoveryPlanTestFailoverInputProperties::getProviderSpecificDetails() const {
    return m_provider_specific_details;
}
void OAIRecoveryPlanTestFailoverInputProperties::setProviderSpecificDetails(const QList<OAIRecoveryPlanProviderSpecificFailoverInput> &provider_specific_details) {
    m_provider_specific_details = provider_specific_details;
    m_provider_specific_details_isSet = true;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_provider_specific_details_Set() const{
    return m_provider_specific_details_isSet;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_provider_specific_details_Valid() const{
    return m_provider_specific_details_isValid;
}

QString OAIRecoveryPlanTestFailoverInputProperties::getSkipTestFailoverCleanup() const {
    return m_skip_test_failover_cleanup;
}
void OAIRecoveryPlanTestFailoverInputProperties::setSkipTestFailoverCleanup(const QString &skip_test_failover_cleanup) {
    m_skip_test_failover_cleanup = skip_test_failover_cleanup;
    m_skip_test_failover_cleanup_isSet = true;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_skip_test_failover_cleanup_Set() const{
    return m_skip_test_failover_cleanup_isSet;
}

bool OAIRecoveryPlanTestFailoverInputProperties::is_skip_test_failover_cleanup_Valid() const{
    return m_skip_test_failover_cleanup_isValid;
}

bool OAIRecoveryPlanTestFailoverInputProperties::isSet() const {
...
bool OAIRecoveryPlanTestFailoverInputProperties::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_failover_direction_isValid && m_network_type_isValid && true;
}
