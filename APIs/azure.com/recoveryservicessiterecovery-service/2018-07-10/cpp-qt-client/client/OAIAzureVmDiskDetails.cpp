...
QString OAIAzureVmDiskDetails::getDiskEncryptionSetId() const {
    return m_disk_encryption_set_id;
}
void OAIAzureVmDiskDetails::setDiskEncryptionSetId(const QString &disk_encryption_set_id) {
    m_disk_encryption_set_id = disk_encryption_set_id;
    m_disk_encryption_set_id_isSet = true;
}

bool OAIAzureVmDiskDetails::is_disk_encryption_set_id_Set() const{
    return m_disk_encryption_set_id_isSet;
}

bool OAIAzureVmDiskDetails::is_disk_encryption_set_id_Valid() const{
    return m_disk_encryption_set_id_isValid;
}

QString OAIAzureVmDiskDetails::getDiskId() const {
    return m_disk_id;
}
void OAIAzureVmDiskDetails::setDiskId(const QString &disk_id) {
    m_disk_id = disk_id;
    m_disk_id_isSet = true;
}

bool OAIAzureVmDiskDetails::is_disk_id_Set() const{
    return m_disk_id_isSet;
}

bool OAIAzureVmDiskDetails::is_disk_id_Valid() const{
