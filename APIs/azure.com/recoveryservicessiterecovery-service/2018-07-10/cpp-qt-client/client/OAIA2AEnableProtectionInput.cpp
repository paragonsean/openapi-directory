...
void OAIA2AEnableProtectionInput::initializeModel() {
    ...
    m_recovery_azure_network_id_isSet = false;
    m_recovery_azure_network_id_isValid = false;
    ...
    m_recovery_subnet_name_isSet = false;
    m_recovery_subnet_name_isValid = false;
...
void OAIA2AEnableProtectionInput::fromJsonObject(QJsonObject json) {
    ...
    m_recovery_azure_network_id_isValid = ::OpenAPI::fromJsonValue(m_recovery_azure_network_id, json[QString("recoveryAzureNetworkId")]);
    m_recovery_azure_network_id_isSet = !json[QString("recoveryAzureNetworkId")].isNull() && m_recovery_azure_network_id_isValid;
    ...
    m_recovery_subnet_name_isValid = ::OpenAPI::fromJsonValue(m_recovery_subnet_name, json[QString("recoverySubnetName")]);
    m_recovery_subnet_name_isSet = !json[QString("recoverySubnetName")].isNull() && m_recovery_subnet_name_isValid;
...
QJsonObject OAIA2AEnableProtectionInput::asJsonObject() const {
    ...
    if (m_recovery_azure_network_id_isSet) {
        obj.insert(QString("recoveryAzureNetworkId"), ::OpenAPI::toJsonValue(m_recovery_azure_network_id));
    }
    ...
    if (m_recovery_subnet_name_isSet) {
        obj.insert(QString("recoverySubnetName"), ::OpenAPI::toJsonValue(m_recovery_subnet_name));
    }
...
QString OAIA2AEnableProtectionInput::getRecoveryAvailabilityZone() const {
    return m_recovery_availability_zone;
}
void OAIA2AEnableProtectionInput::setRecoveryAvailabilityZone(const QString &recovery_availability_zone) {
    m_recovery_availability_zone = recovery_availability_zone;
    m_recovery_availability_zone_isSet = true;
}

bool OAIA2AEnableProtectionInput::is_recovery_availability_zone_Set() const{
    return m_recovery_availability_zone_isSet;
}

bool OAIA2AEnableProtectionInput::is_recovery_availability_zone_Valid() const{
    return m_recovery_availability_zone_isValid;
}

QString OAIA2AEnableProtectionInput::getRecoveryAzureNetworkId() const {
    return m_recovery_azure_network_id;
}
void OAIA2AEnableProtectionInput::setRecoveryAzureNetworkId(const QString &recovery_azure_network_id) {
    m_recovery_azure_network_id = recovery_azure_network_id;
    m_recovery_azure_network_id_isSet = true;
}

bool OAIA2AEnableProtectionInput::is_recovery_azure_network_id_Set() const{
    return m_recovery_azure_network_id_isSet;
}

bool OAIA2AEnableProtectionInput::is_recovery_azure_network_id_Valid() const{
    return m_recovery_azure_network_id_isValid;
}
...
QString OAIA2AEnableProtectionInput::getRecoverySubnetName() const {
    return m_recovery_subnet_name;
}
void OAIA2AEnableProtectionInput::setRecoverySubnetName(const QString &recovery_subnet_name) {
    m_recovery_subnet_name = recovery_subnet_name;
    m_recovery_subnet_name_isSet = true;
}

bool OAIA2AEnableProtectionInput::is_recovery_subnet_name_Set() const{
    return m_recovery_subnet_name_isSet;
}

bool OAIA2AEnableProtectionInput::is_recovery_subnet_name_Valid() const{
    return m_recovery_subnet_name_isValid;
}
