...
QString OAIMigrationItemProperties::getRecoveryServicesProviderId() const {
    return m_recovery_services_provider_id;
}
void OAIMigrationItemProperties::setRecoveryServicesProviderId(const QString &recovery_services_provider_id) {
    m_recovery_services_provider_id = recovery_services_provider_id;
    m_recovery_services_provider_id_isSet = true;
}

bool OAIMigrationItemProperties::is_recovery_services_provider_id_Set() const{
    return m_recovery_services_provider_id_isSet;
}

bool OAIMigrationItemProperties::is_recovery_services_provider_id_Valid() const{
