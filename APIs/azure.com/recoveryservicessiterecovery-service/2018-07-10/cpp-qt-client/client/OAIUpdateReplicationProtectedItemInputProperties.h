...
public:
    ...
    QString getSelectedTfoAzureNetworkId() const;
    void setSelectedTfoAzureNetworkId(const QString &selected_tfo_azure_network_id);
    bool is_selected_tfo_azure_network_id_Set() const;
    bool is_selected_tfo_azure_network_id_Valid() const;
...
private:
    ...
    QString m_selected_tfo_azure_network_id;
    bool m_selected_tfo_azure_network_id_isSet;
    bool m_selected_tfo_azure_network_id_isValid;
