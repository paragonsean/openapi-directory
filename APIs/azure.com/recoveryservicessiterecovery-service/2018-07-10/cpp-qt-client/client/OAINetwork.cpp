...
OAINetworkProperties OAINetwork::getProperties() const {
    return m_properties;
}
void OAINetwork::setProperties(const OAINetworkProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAINetwork::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAINetwork::is_properties_Valid() const{
...
QString OAINetwork::getLocation() const {
    return m_location;
}
void OAINetwork::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAINetwork::is_location_Set() const{
    return m_location_isSet;
}

bool OAINetwork::is_location_Valid() const{
