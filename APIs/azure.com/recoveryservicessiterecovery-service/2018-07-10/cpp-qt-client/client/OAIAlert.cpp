...
OAIAlertProperties OAIAlert::getProperties() const {
    return m_properties;
}
void OAIAlert::setProperties(const OAIAlertProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIAlert::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIAlert::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIAlert::getId() const {
    return m_id;
}
void OAIAlert::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAlert::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAlert::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAlert::getLocation() const {
    return m_location;
}
void OAIAlert::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIAlert::is_location_Set() const{
    return m_location_isSet;
}

bool OAIAlert::is_location_Valid() const{
