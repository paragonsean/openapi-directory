...
/*
 * OAIAddVCenterRequestProperties.h
 *
 * The properties of an add vCenter request.
 */

#ifndef OAIAddVCenterRequestProperties_H
#define OAIAddVCenterRequestProperties_H
...
class OAIAddVCenterRequestProperties : public OAIObject {
public:
    OAIAddVCenterRequestProperties();
    OAIAddVCenterRequestProperties(QString json);
    ~OAIAddVCenterRequestProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddVCenterRequestProperties)

#endif // OAIAddVCenterRequestProperties_H
