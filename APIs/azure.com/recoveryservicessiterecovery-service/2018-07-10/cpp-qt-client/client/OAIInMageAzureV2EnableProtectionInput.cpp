...
QString OAIInMageAzureV2EnableProtectionInput::getDiskEncryptionSetId() const {
    return m_disk_encryption_set_id;
}
void OAIInMageAzureV2EnableProtectionInput::setDiskEncryptionSetId(const QString &disk_encryption_set_id) {
    m_disk_encryption_set_id = disk_encryption_set_id;
    m_disk_encryption_set_id_isSet = true;
}

bool OAIInMageAzureV2EnableProtectionInput::is_disk_encryption_set_id_Set() const{
    return m_disk_encryption_set_id_isSet;
}

bool OAIInMageAzureV2EnableProtectionInput::is_disk_encryption_set_id_Valid() const{
    return m_disk_encryption_set_id_isValid;
}

QString OAIInMageAzureV2EnableProtectionInput::getDiskType() const {
    return m_disk_type;
}
void OAIInMageAzureV2EnableProtectionInput::setDiskType(const QString &disk_type) {
    m_disk_type = disk_type;
    m_disk_type_isSet = true;
}

bool OAIInMageAzureV2EnableProtectionInput::is_disk_type_Set() const{
    return m_disk_type_isSet;
}

bool OAIInMageAzureV2EnableProtectionInput::is_disk_type_Valid() const{
    return m_disk_type_isValid;
}

QList<OAIInMageAzureV2DiskInputDetails> OAIInMageAzureV2EnableProtectionInput::getDisksToInclude() const {
    return m_disks_to_include;
}
void OAIInMageAzureV2EnableProtectionInput::setDisksToInclude(const QList<OAIInMageAzureV2DiskInputDetails> &disks_to_include) {
...
void OAIInMageAzureV2EnableProtectionInput::setEnableRdpOnTargetOption(const QString &enable_rdp_on_target_option) {
    m_enable_rdp_on_target_option = enable_rdp_on_target_option;
    m_enable_rdp_on_target_option_isSet = true;
}

bool OAIInMageAzureV2EnableProtectionInput::is_enable_rdp_on_target_option_Set() const{
    return m_enable_rdp_on_target_option_isSet;
}

bool OAIInMageAzureV2EnableProtectionInput::is_enable_rdp_on_target_option_Valid() const{
