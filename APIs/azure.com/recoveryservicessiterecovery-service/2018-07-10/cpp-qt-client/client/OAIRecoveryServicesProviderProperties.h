...
namespace OpenAPI {
class OAIIdentityProviderDetails;
...
public:
    ...
    OAIIdentityProviderDetails getAuthenticationIdentityDetails() const;
    void setAuthenticationIdentityDetails(const OAIIdentityProviderDetails &authentication_identity_details);
    bool is_authentication_identity_details_Set() const;
    bool is_authentication_identity_details_Valid() const;
    ...
    OAIVersionDetails getProviderVersionDetails() const;
    void setProviderVersionDetails(const OAIVersionDetails &provider_version_details);
    bool is_provider_version_details_Set() const;
    bool is_provider_version_details_Valid() const;
    ...
    OAIIdentityProviderDetails getResourceAccessIdentityDetails() const;
    void setResourceAccessIdentityDetails(const OAIIdentityProviderDetails &resource_access_identity_details);
    bool is_resource_access_identity_details_Set() const;
    bool is_resource_access_identity_details_Valid() const;
...
private:
    ...
    OAIIdentityProviderDetails m_authentication_identity_details;
    bool m_authentication_identity_details_isSet;
    bool m_authentication_identity_details_isValid;
    ...
    OAIVersionDetails m_provider_version_details;
    bool m_provider_version_details_isSet;
    bool m_provider_version_details_isValid;
    ...
    OAIIdentityProviderDetails m_resource_access_identity_details;
    bool m_resource_access_identity_details_isSet;
    bool m_resource_access_identity_details_isValid;
