...
QDateTime OAIVMwareDetails::getAgentExpiryDate() const {
    return m_agent_expiry_date;
}
void OAIVMwareDetails::setAgentExpiryDate(const QDateTime &agent_expiry_date) {
    m_agent_expiry_date = agent_expiry_date;
    m_agent_expiry_date_isSet = true;
}

bool OAIVMwareDetails::is_agent_expiry_date_Set() const{
    return m_agent_expiry_date_isSet;
}

bool OAIVMwareDetails::is_agent_expiry_date_Valid() const{
...
OAIVersionDetails OAIVMwareDetails::getAgentVersionDetails() const {
    return m_agent_version_details;
}
void OAIVMwareDetails::setAgentVersionDetails(const OAIVersionDetails &agent_version_details) {
    m_agent_version_details = agent_version_details;
    m_agent_version_details_isSet = true;
}

bool OAIVMwareDetails::is_agent_version_details_Set() const{
    return m_agent_version_details_isSet;
}

bool OAIVMwareDetails::is_agent_version_details_Valid() const{
