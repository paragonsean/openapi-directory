...
QString OAIA2AUpdateReplicationProtectedItemInput::getTfoAzureVmName() const {
    return m_tfo_azure_vm_name;
}
void OAIA2AUpdateReplicationProtectedItemInput::setTfoAzureVmName(const QString &tfo_azure_vm_name) {
    m_tfo_azure_vm_name = tfo_azure_vm_name;
    m_tfo_azure_vm_name_isSet = true;
}

bool OAIA2AUpdateReplicationProtectedItemInput::is_tfo_azure_vm_name_Set() const{
    return m_tfo_azure_vm_name_isSet;
}

bool OAIA2AUpdateReplicationProtectedItemInput::is_tfo_azure_vm_name_Valid() const{
