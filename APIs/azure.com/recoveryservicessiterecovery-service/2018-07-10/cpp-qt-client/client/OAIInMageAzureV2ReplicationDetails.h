...
class OAIInMageAzureV2ManagedDiskDetails;
...
public:
    ...
    QList<OAIInMageAzureV2ManagedDiskDetails> getProtectedManagedDisks() const;
    void setProtectedManagedDisks(const QList<OAIInMageAzureV2ManagedDiskDetails> &protected_managed_disks);
...
private:
    ...
    QList<OAIInMageAzureV2ManagedDiskDetails> m_protected_managed_disks;
