...
|**initialPrimaryFabricLocation** | **String** | The initial primary fabric location. |  [optional] [readonly] |
|**initialRecoveryFabricLocation** | **String** | The initial recovery fabric location. |  [optional] [readonly] |
...
|**recoveryAvailabilityZone** | **String** | The recovery availability zone. |  [optional] |
...
|**selectedTfoAzureNetworkId** | **String** | The test failover virtual network. |  [optional] |
|**testFailoverRecoveryFabricObjectId** | **String** | The test failover fabric object Id. |  [optional] |
|**tfoAzureVMName** | **String** | The test failover VM name. |  [optional] |
|**unprotectedDisks** | [**List&lt;A2AUnprotectedDiskDetails&gt;**](A2AUnprotectedDiskDetails.md) | The list of unprotected disks. |  [optional] |
|**vmEncryptionType** | [**VmEncryptionTypeEnum**](#VmEncryptionTypeEnum) | The encryption type of the VM. |  [optional] [readonly] |
