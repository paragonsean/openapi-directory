...
|**recoveryLBBackendAddressPoolIds** | **List&lt;String&gt;** | The target backend address pools for the NIC. |  [optional] |
...
|**tfoIPConfigs** | [**List&lt;IPConfig&gt;**](IPConfig.md) | The IP configurations to be used by NIC during test failover. |  [optional] |
