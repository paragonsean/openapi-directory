...
# **replicationProtectableItemsListByReplicationProtectionContainers**
> ProtectableItemCollection replicationProtectableItemsListByReplicationProtectionContainers(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProtectableItemCollection result = apiInstance.replicationProtectableItemsListByReplicationProtectionContainers(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, $filter);
      System.out.println(result);
    } catch (ApiException e) {
