...
public class HyperVReplicaPolicyDetails extends PolicyProviderSpecificDetails {
  ...
  public HyperVReplicaPolicyDetails allowedAuthenticationType(Integer allowedAuthenticationType) {
  ...
  public HyperVReplicaPolicyDetails applicationConsistentSnapshotFrequencyInHours(Integer applicationConsistentSnapshotFrequencyInHours) {
  ...
  public HyperVReplicaPolicyDetails compression(String compression) {
  ...
  public HyperVReplicaPolicyDetails initialReplicationMethod(String initialReplicationMethod) {
  ...
  public HyperVReplicaPolicyDetails offlineReplicationExportPath(String offlineReplicationExportPath) {
  ...
  public HyperVReplicaPolicyDetails offlineReplicationImportPath(String offlineReplicationImportPath) {
  ...
  public HyperVReplicaPolicyDetails onlineReplicationStartTime(String onlineReplicationStartTime) {
  ...
  public HyperVReplicaPolicyDetails recoveryPoints(Integer recoveryPoints) {
  ...
  public HyperVReplicaPolicyDetails replicaDeletionOption(String replicaDeletionOption) {
  ...
  public HyperVReplicaPolicyDetails replicationPort(Integer replicationPort) {
  ...
  public boolean equals(Object o) {
    ...
    HyperVReplicaPolicyDetails hyperVReplicaPolicyDetails = (HyperVReplicaPolicyDetails) o;
    return Objects.equals(this.allowedAuthenticationType, hyperVReplicaPolicyDetails.allowedAuthenticationType) &&
        Objects.equals(this.applicationConsistentSnapshotFrequencyInHours, hyperVReplicaPolicyDetails.applicationConsistentSnapshotFrequencyInHours) &&
        Objects.equals(this.compression, hyperVReplicaPolicyDetails.compression) &&
        Objects.equals(this.initialReplicationMethod, hyperVReplicaPolicyDetails.initialReplicationMethod) &&
        Objects.equals(this.offlineReplicationExportPath, hyperVReplicaPolicyDetails.offlineReplicationExportPath) &&
        Objects.equals(this.offlineReplicationImportPath, hyperVReplicaPolicyDetails.offlineReplicationImportPath) &&
        Objects.equals(this.onlineReplicationStartTime, hyperVReplicaPolicyDetails.onlineReplicationStartTime) &&
        Objects.equals(this.recoveryPoints, hyperVReplicaPolicyDetails.recoveryPoints) &&
        Objects.equals(this.replicaDeletionOption, hyperVReplicaPolicyDetails.replicaDeletionOption) &&
        Objects.equals(this.replicationPort, hyperVReplicaPolicyDetails.replicationPort) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class HyperVReplicaPolicyDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HyperVReplicaPolicyDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HyperVReplicaPolicyDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HyperVReplicaPolicyDetails is not found in the empty JSON string", HyperVReplicaPolicyDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HyperVReplicaPolicyDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HyperVReplicaPolicyDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HyperVReplicaPolicyDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HyperVReplicaPolicyDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HyperVReplicaPolicyDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HyperVReplicaPolicyDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<HyperVReplicaPolicyDetails>() {
           @Override
           public void write(JsonWriter out, HyperVReplicaPolicyDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HyperVReplicaPolicyDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HyperVReplicaPolicyDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HyperVReplicaPolicyDetails
   * @throws IOException if the JSON string is invalid with respect to HyperVReplicaPolicyDetails
   */
  public static HyperVReplicaPolicyDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HyperVReplicaPolicyDetails.class);
  }

  /**
   * Convert an instance of HyperVReplicaPolicyDetails to an JSON string
   *
   * @return JSON string
   */
