...
public class Event {
  ...
  public Event properties(EventProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    Event event = (Event) o;
    return Objects.equals(this.properties, event.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        EventProperties.validateJsonElement(jsonObj.get("properties"));
      }
