...
public class ReplicationProtectionContainerMappingsApi {
    ...
    /**
     * Build call for replicationProtectionContainerMappingsUpdate
     * @param apiVersion Client Api Version. (required)
     * @param resourceName The name of the recovery services vault. (required)
     * @param resourceGroupName The name of the resource group where the recovery services vault is present. (required)
     * @param subscriptionId The subscription Id. (required)
     ...
     * @param protectionContainerName Protection container name. (required)
     * @param mappingName Protection container mapping name. (required)
     * @param updateInput Mapping update input. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call replicationProtectionContainerMappingsUpdateCall(String apiVersion, String resourceName, String resourceGroupName, String subscriptionId, String fabricName, String protectionContainerName, String mappingName, UpdateProtectionContainerMappingInput updateInput, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateInput;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replicationProtectionContainerMappingsUpdateValidateBeforeCall(String apiVersion, String resourceName, String resourceGroupName, String subscriptionId, String fabricName, String protectionContainerName, String mappingName, UpdateProtectionContainerMappingInput updateInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'resourceName' is set
        if (resourceName == null) {
            throw new ApiException("Missing the required parameter 'resourceName' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'fabricName' is set
        if (fabricName == null) {
            throw new ApiException("Missing the required parameter 'fabricName' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'protectionContainerName' is set
        if (protectionContainerName == null) {
            throw new ApiException("Missing the required parameter 'protectionContainerName' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'mappingName' is set
        if (mappingName == null) {
            throw new ApiException("Missing the required parameter 'mappingName' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        // verify the required parameter 'updateInput' is set
        if (updateInput == null) {
            throw new ApiException("Missing the required parameter 'updateInput' when calling replicationProtectionContainerMappingsUpdate(Async)");
        }

        return replicationProtectionContainerMappingsUpdateCall(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, mappingName, updateInput, _callback);
     ...
     */
    public ProtectionContainerMapping replicationProtectionContainerMappingsUpdate(String apiVersion, String resourceName, String resourceGroupName, String subscriptionId, String fabricName, String protectionContainerName, String mappingName, UpdateProtectionContainerMappingInput updateInput) throws ApiException {
        ApiResponse<ProtectionContainerMapping> localVarResp = replicationProtectionContainerMappingsUpdateWithHttpInfo(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, mappingName, updateInput);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProtectionContainerMapping> replicationProtectionContainerMappingsUpdateWithHttpInfo(String apiVersion, String resourceName, String resourceGroupName, String subscriptionId, String fabricName, String protectionContainerName, String mappingName, UpdateProtectionContainerMappingInput updateInput) throws ApiException {
        okhttp3.Call localVarCall = replicationProtectionContainerMappingsUpdateValidateBeforeCall(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, mappingName, updateInput, null);
        Type localVarReturnType = new TypeToken<ProtectionContainerMapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update protection container mapping. (asynchronously)
     * The operation to update protection container mapping.
     * @param apiVersion Client Api Version. (required)
     * @param resourceName The name of the recovery services vault. (required)
     * @param resourceGroupName The name of the resource group where the recovery services vault is present. (required)
     ...
     */
    public okhttp3.Call replicationProtectionContainerMappingsUpdateAsync(String apiVersion, String resourceName, String resourceGroupName, String subscriptionId, String fabricName, String protectionContainerName, String mappingName, UpdateProtectionContainerMappingInput updateInput, final ApiCallback<ProtectionContainerMapping> _callback) throws ApiException {

        okhttp3.Call localVarCall = replicationProtectionContainerMappingsUpdateValidateBeforeCall(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, mappingName, updateInput, _callback);
        Type localVarReturnType = new TypeToken<ProtectionContainerMapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
