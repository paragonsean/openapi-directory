...
import org.openapitools.client.model.InMageAzureV2ManagedDiskDetails;
...
public class InMageAzureV2ReplicationDetails extends ReplicationProviderSpecificSettings {
  ...
  private List<InMageAzureV2ManagedDiskDetails> protectedManagedDisks = new ArrayList<>();
  ...
  public InMageAzureV2ReplicationDetails protectedManagedDisks(List<InMageAzureV2ManagedDiskDetails> protectedManagedDisks) {
    this.protectedManagedDisks = protectedManagedDisks;
    return this;
  }

  public InMageAzureV2ReplicationDetails addProtectedManagedDisksItem(InMageAzureV2ManagedDiskDetails protectedManagedDisksItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<InMageAzureV2ManagedDiskDetails> getProtectedManagedDisks() {
    return protectedManagedDisks;
  }

  public void setProtectedManagedDisks(List<InMageAzureV2ManagedDiskDetails> protectedManagedDisks) {
    this.protectedManagedDisks = protectedManagedDisks;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentExpiryDate, inMageAzureV2ReplicationDetails.agentExpiryDate) &&
        ...
        Objects.equals(this.protectedManagedDisks, inMageAzureV2ReplicationDetails.protectedManagedDisks) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentExpiryDate, agentVersion, azureVMDiskDetails, compressedDataRateInMB, datastores, discoveryType, diskResized, enableRdpOnTargetOption, infrastructureVmId, ipAddress, isAgentUpdateRequired, isRebootAfterUpdateRequired, lastHeartbeat, lastRpoCalculatedTime, lastUpdateReceivedTime, licenseType, masterTargetId, multiVmGroupId, multiVmGroupName, multiVmSyncStatus, osDiskId, osType, osVersion, processServerId, protectedDisks, protectedManagedDisks, protectionStage, recoveryAvailabilitySetId, recoveryAzureLogStorageAccountId, recoveryAzureResourceGroupId, recoveryAzureStorageAccount, recoveryAzureVMName, recoveryAzureVMSize, replicaId, resyncProgressPercentage, rpoInSeconds, selectedRecoveryAzureNetworkId, selectedSourceNicId, sourceVmCpuCount, sourceVmRamSizeInMB, targetVmId, uncompressedDataRateInMB, useManagedDisks, vCenterInfrastructureId, validationErrors, vhdName, vmId, vmNics, vmProtectionState, vmProtectionStateDescription, super.hashCode());
  }
