...
public class UpdateReplicationProtectedItemInputProperties {
  ...
  public UpdateReplicationProtectedItemInputProperties selectedSourceNicId(String selectedSourceNicId) {
  ...
  public UpdateReplicationProtectedItemInputProperties selectedTfoAzureNetworkId(String selectedTfoAzureNetworkId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enableRdpOnTargetOption, updateReplicationProtectedItemInputProperties.enableRdpOnTargetOption) &&
        ...
        Objects.equals(this.selectedSourceNicId, updateReplicationProtectedItemInputProperties.selectedSourceNicId) &&
        Objects.equals(this.selectedTfoAzureNetworkId, updateReplicationProtectedItemInputProperties.selectedTfoAzureNetworkId) &&
        Objects.equals(this.vmNics, updateReplicationProtectedItemInputProperties.vmNics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enableRdpOnTargetOption, licenseType, providerSpecificDetails, recoveryAvailabilitySetId, recoveryAzureVMName, recoveryAzureVMSize, selectedRecoveryAzureNetworkId, selectedSourceNicId, selectedTfoAzureNetworkId, vmNics);
  }
  ...
  static {
    ...
    openapiFields.add("selectedSourceNicId");
    openapiFields.add("selectedTfoAzureNetworkId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("selectedSourceNicId") != null && !jsonObj.get("selectedSourceNicId").isJsonNull()) && !jsonObj.get("selectedSourceNicId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `selectedSourceNicId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selectedSourceNicId").toString()));
      }
      if ((jsonObj.get("selectedTfoAzureNetworkId") != null && !jsonObj.get("selectedTfoAzureNetworkId").isJsonNull()) && !jsonObj.get("selectedTfoAzureNetworkId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `selectedTfoAzureNetworkId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selectedTfoAzureNetworkId").toString()));
      }
