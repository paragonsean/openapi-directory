...
public class EventCollection {
  ...
  private List<Event> value = new ArrayList<>();
  ...
  public EventCollection value(List<Event> value) {
    this.value = value;
    return this;
  }

  public EventCollection addValueItem(Event valueItem) {
    if (this.value == null) {
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            Event.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
