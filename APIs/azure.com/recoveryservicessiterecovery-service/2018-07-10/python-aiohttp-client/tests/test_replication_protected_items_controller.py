...
async def test_replication_protected_items_add_disks(client):
    """Test case for replication_protected_items_add_disks

    Add disk(s) for protection.
    """
    add_disks_input = {"properties":{"providerSpecificDetails":{"instanceType":"instanceType"}}}
...
async def test_replication_protected_items_remove_disks(client):
    """Test case for replication_protected_items_remove_disks

    Removes disk(s).
    """
    remove_disks_input = {"properties":{"providerSpecificDetails":{"instanceType":"instanceType"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/Subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/{resource_name}/replicationFabrics/{fabric_name}/replicationProtectionContainers/{protection_container_name}/replicationProtectedItems/{replicated_protected_item_name}/removeDisks'.format(resource_name='resource_name_example', resource_group_name='resource_group_name_example', subscription_id='subscription_id_example', fabric_name='fabric_name_example', protection_container_name='protection_container_name_example', replicated_protected_item_name='replicated_protected_item_name_example'),
        headers=headers,
        json=remove_disks_input,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_replication_protected_items_resolve_health_errors(client):
    """Test case for replication_protected_items_resolve_health_errors

    Resolve health errors.
    """
    resolve_health_input = {"properties":{"healthErrors":[{"healthErrorId":"healthErrorId"},{"healthErrorId":"healthErrorId"}]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/Subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/{resource_name}/replicationFabrics/{fabric_name}/replicationProtectionContainers/{protection_container_name}/replicationProtectedItems/{replicated_protected_item_name}/ResolveHealthErrors'.format(resource_name='resource_name_example', resource_group_name='resource_group_name_example', subscription_id='subscription_id_example', fabric_name='fabric_name_example', protection_container_name='protection_container_name_example', replicated_protected_item_name='replicated_protected_item_name_example'),
        headers=headers,
        json=resolve_health_input,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_replication_protected_items_update(client):
    ...
    Updates protection.
    """
    update_protection_input = {"properties":{"licenseType":"NotSpecified","vmNics":[{"enableAcceleratedNetworkingOnRecovery":True,"selectionType":"selectionType","tfoVMSubnetName":"tfoVMSubnetName","enableAcceleratedNetworkingOnTfo":True,"tfoNetworkSecurityGroupId":"tfoNetworkSecurityGroupId","recoveryLBBackendAddressPoolIds":["recoveryLBBackendAddressPoolIds","recoveryLBBackendAddressPoolIds"],"recoveryPublicIpAddressId":"recoveryPublicIpAddressId","nicId":"nicId","replicaNicStaticIPAddress":"replicaNicStaticIPAddress","tfoIPConfigs":[{"staticIPAddress":"staticIPAddress","lBBackendAddressPoolIds":["lBBackendAddressPoolIds","lBBackendAddressPoolIds"],"publicIpAddressId":"publicIpAddressId"},{"staticIPAddress":"staticIPAddress","lBBackendAddressPoolIds":["lBBackendAddressPoolIds","lBBackendAddressPoolIds"],"publicIpAddressId":"publicIpAddressId"}],"recoveryVMSubnetName":"recoveryVMSubnetName","recoveryNetworkSecurityGroupId":"recoveryNetworkSecurityGroupId"},{"enableAcceleratedNetworkingOnRecovery":True,"selectionType":"selectionType","tfoVMSubnetName":"tfoVMSubnetName","enableAcceleratedNetworkingOnTfo":True,"tfoNetworkSecurityGroupId":"tfoNetworkSecurityGroupId","recoveryLBBackendAddressPoolIds":["recoveryLBBackendAddressPoolIds","recoveryLBBackendAddressPoolIds"],"recoveryPublicIpAddressId":"recoveryPublicIpAddressId","nicId":"nicId","replicaNicStaticIPAddress":"replicaNicStaticIPAddress","tfoIPConfigs":[{"staticIPAddress":"staticIPAddress","lBBackendAddressPoolIds":["lBBackendAddressPoolIds","lBBackendAddressPoolIds"],"publicIpAddressId":"publicIpAddressId"},{"staticIPAddress":"staticIPAddress","lBBackendAddressPoolIds":["lBBackendAddressPoolIds","lBBackendAddressPoolIds"],"publicIpAddressId":"publicIpAddressId"}],"recoveryVMSubnetName":"recoveryVMSubnetName","recoveryNetworkSecurityGroupId":"recoveryNetworkSecurityGroupId"}],"providerSpecificDetails":{"instanceType":"instanceType"},"recoveryAvailabilitySetId":"recoveryAvailabilitySetId","enableRdpOnTargetOption":"enableRdpOnTargetOption","selectedSourceNicId":"selectedSourceNicId","recoveryAzureVMName":"recoveryAzureVMName","recoveryAzureVMSize":"recoveryAzureVMSize","selectedTfoAzureNetworkId":"selectedTfoAzureNetworkId","selectedRecoveryAzureNetworkId":"selectedRecoveryAzureNetworkId"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
