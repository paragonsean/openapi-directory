...
class ProcessServer(Model):
    ...
    def __init__(self, agent_expiry_date: datetime=None, agent_version: str=None, agent_version_details: VersionDetails=None, available_memory_in_bytes: int=None, available_space_in_bytes: int=None, cpu_load: str=None, cpu_load_status: str=None, friendly_name: str=None, health_errors: List[HealthError]=None, host_id: str=None, id: str=None, ip_address: str=None, last_heartbeat: datetime=None, machine_count: str=None, memory_usage_status: str=None, mobility_service_updates: List[MobilityServiceUpdate]=None, os_type: str=None, os_version: str=None, ps_service_status: str=None, replication_pair_count: str=None, space_usage_status: str=None, ssl_cert_expiry_date: datetime=None, ssl_cert_expiry_remaining_days: int=None, system_load: str=None, system_load_status: str=None, total_memory_in_bytes: int=None, total_space_in_bytes: int=None, version_status: str=None):
        ...
        :param health_errors: The health_errors of this ProcessServer.
    ...
    def agent_expiry_date(self):
        """Gets the agent_expiry_date of this ProcessServer.

        Agent expiry date.

        :return: The agent_expiry_date of this ProcessServer.
        :rtype: datetime
        """
    ...
    def agent_expiry_date(self, agent_expiry_date):
        """Sets the agent_expiry_date of this ProcessServer.
    ...
    def agent_version_details(self):
        """Gets the agent_version_details of this ProcessServer.


        :return: The agent_version_details of this ProcessServer.
    ...
    def agent_version_details(self, agent_version_details):
        """Sets the agent_version_details of this ProcessServer.
    ...
    def health_errors(self):
        """Gets the health_errors of this ProcessServer.

        Health errors.

        :return: The health_errors of this ProcessServer.
    ...
    def health_errors(self, health_errors):
        """Sets the health_errors of this ProcessServer.
