...
class HyperVReplicaPolicyDetails(Model):
    ...
    def __init__(self, allowed_authentication_type: int=None, application_consistent_snapshot_frequency_in_hours: int=None, compression: str=None, initial_replication_method: str=None, offline_replication_export_path: str=None, offline_replication_import_path: str=None, online_replication_start_time: str=None, recovery_points: int=None, replica_deletion_option: str=None, replication_port: int=None, instance_type: str=None):
        """HyperVReplicaPolicyDetails - a model defined in OpenAPI

        :param allowed_authentication_type: The allowed_authentication_type of this HyperVReplicaPolicyDetails.
        :param application_consistent_snapshot_frequency_in_hours: The application_consistent_snapshot_frequency_in_hours of this HyperVReplicaPolicyDetails.
        :param compression: The compression of this HyperVReplicaPolicyDetails.
        :param initial_replication_method: The initial_replication_method of this HyperVReplicaPolicyDetails.
        :param offline_replication_export_path: The offline_replication_export_path of this HyperVReplicaPolicyDetails.
        :param offline_replication_import_path: The offline_replication_import_path of this HyperVReplicaPolicyDetails.
        :param online_replication_start_time: The online_replication_start_time of this HyperVReplicaPolicyDetails.
        :param recovery_points: The recovery_points of this HyperVReplicaPolicyDetails.
        :param replica_deletion_option: The replica_deletion_option of this HyperVReplicaPolicyDetails.
        :param replication_port: The replication_port of this HyperVReplicaPolicyDetails.
        :param instance_type: The instance_type of this HyperVReplicaPolicyDetails.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'HyperVReplicaPolicyDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The HyperVReplicaPolicyDetails of this HyperVReplicaPolicyDetails.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allowed_authentication_type(self):
        """Gets the allowed_authentication_type of this HyperVReplicaPolicyDetails.

        A value indicating the authentication type.

        :return: The allowed_authentication_type of this HyperVReplicaPolicyDetails.
        :rtype: int
        """
    ...
    def allowed_authentication_type(self, allowed_authentication_type):
        """Sets the allowed_authentication_type of this HyperVReplicaPolicyDetails.
    ...
    def application_consistent_snapshot_frequency_in_hours(self):
        """Gets the application_consistent_snapshot_frequency_in_hours of this HyperVReplicaPolicyDetails.

        A value indicating the application consistent frequency.

        :return: The application_consistent_snapshot_frequency_in_hours of this HyperVReplicaPolicyDetails.
        :rtype: int
        """
    ...
    def application_consistent_snapshot_frequency_in_hours(self, application_consistent_snapshot_frequency_in_hours):
        """Sets the application_consistent_snapshot_frequency_in_hours of this HyperVReplicaPolicyDetails.
    ...
    def compression(self):
        """Gets the compression of this HyperVReplicaPolicyDetails.

        A value indicating whether compression has to be enabled.

        :return: The compression of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def compression(self, compression):
        """Sets the compression of this HyperVReplicaPolicyDetails.
    ...
    def initial_replication_method(self):
        """Gets the initial_replication_method of this HyperVReplicaPolicyDetails.

        A value indicating whether IR is online.

        :return: The initial_replication_method of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def initial_replication_method(self, initial_replication_method):
        """Sets the initial_replication_method of this HyperVReplicaPolicyDetails.
    ...
    def offline_replication_export_path(self):
        """Gets the offline_replication_export_path of this HyperVReplicaPolicyDetails.

        A value indicating the offline IR export path.

        :return: The offline_replication_export_path of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def offline_replication_export_path(self, offline_replication_export_path):
        """Sets the offline_replication_export_path of this HyperVReplicaPolicyDetails.
    ...
    def offline_replication_import_path(self):
        """Gets the offline_replication_import_path of this HyperVReplicaPolicyDetails.

        A value indicating the offline IR import path.

        :return: The offline_replication_import_path of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def offline_replication_import_path(self, offline_replication_import_path):
        """Sets the offline_replication_import_path of this HyperVReplicaPolicyDetails.
    ...
    def online_replication_start_time(self):
        """Gets the online_replication_start_time of this HyperVReplicaPolicyDetails.

        A value indicating the online IR start time.

        :return: The online_replication_start_time of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def online_replication_start_time(self, online_replication_start_time):
        """Sets the online_replication_start_time of this HyperVReplicaPolicyDetails.
    ...
    def recovery_points(self):
        """Gets the recovery_points of this HyperVReplicaPolicyDetails.

        A value indicating the number of recovery points.

        :return: The recovery_points of this HyperVReplicaPolicyDetails.
        :rtype: int
        """
    ...
    def recovery_points(self, recovery_points):
        """Sets the recovery_points of this HyperVReplicaPolicyDetails.
    ...
    def replica_deletion_option(self):
        """Gets the replica_deletion_option of this HyperVReplicaPolicyDetails.

        A value indicating whether the VM has to be auto deleted. Supported Values: String.Empty, None, OnRecoveryCloud

        :return: The replica_deletion_option of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def replica_deletion_option(self, replica_deletion_option):
        """Sets the replica_deletion_option of this HyperVReplicaPolicyDetails.
    ...
    def replication_port(self):
        """Gets the replication_port of this HyperVReplicaPolicyDetails.

        A value indicating the recovery HTTPS port.

        :return: The replication_port of this HyperVReplicaPolicyDetails.
        :rtype: int
        """
    ...
    def replication_port(self, replication_port):
        """Sets the replication_port of this HyperVReplicaPolicyDetails.
    ...
    def instance_type(self):
        """Gets the instance_type of this HyperVReplicaPolicyDetails.

        Gets the class type. Overridden in derived classes.

        :return: The instance_type of this HyperVReplicaPolicyDetails.
        :rtype: str
        """
    ...
    def instance_type(self, instance_type):
        """Sets the instance_type of this HyperVReplicaPolicyDetails.
