...
class VCenterProperties(Model):
    ...
    def __init__(self, discovery_status: str=None, fabric_arm_resource_name: str=None, friendly_name: str=None, health_errors: List[HealthError]=None, infrastructure_id: str=None, internal_id: str=None, ip_address: str=None, last_heartbeat: datetime=None, port: str=None, process_server_id: str=None, run_as_account_id: str=None):
        ...
        :param health_errors: The health_errors of this VCenterProperties.
    ...
    def health_errors(self):
        """Gets the health_errors of this VCenterProperties.

        The health errors for this VCenter.

        :return: The health_errors of this VCenterProperties.
    ...
    def health_errors(self, health_errors):
        """Sets the health_errors of this VCenterProperties.
