...
class VMwareCbtUpdateMigrationItemInput(Model):
    ...
    def __init__(self, license_type: str=None, target_availability_set_id: str=None, target_boot_diagnostics_storage_account_id: str=None, target_network_id: str=None, target_resource_group_id: str=None, target_vm_name: str=None, target_vm_size: str=None, vm_nics: List[VMwareCbtNicInput]=None, instance_type: str=None):
