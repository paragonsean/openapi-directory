...
class HyperVReplicaAzurePolicyInput(Model):
    ...
    def __init__(self, application_consistent_snapshot_frequency_in_hours: int=None, online_replication_start_time: str=None, recovery_point_history_duration: int=None, replication_interval: int=None, storage_accounts: List[str]=None, instance_type: str=None):
