...
async def replication_protected_items_add_disks(request: web.Request, api_version, resource_name, resource_group_name, subscription_id, fabric_name, protection_container_name, replicated_protected_item_name, add_disks_input) -> web.Response:
    ...
    :type add_disks_input: dict | bytes

    """
    add_disks_input = AddDisksInput.from_dict(add_disks_input)
...
async def replication_protected_items_remove_disks(request: web.Request, api_version, resource_name, resource_group_name, subscription_id, fabric_name, protection_container_name, replicated_protected_item_name, remove_disks_input) -> web.Response:
    """Removes disk(s).
    ...
    :type remove_disks_input: dict | bytes

    """
    remove_disks_input = RemoveDisksInput.from_dict(remove_disks_input)
    return web.Response(status=200)
...
async def replication_protected_items_resolve_health_errors(request: web.Request, api_version, resource_name, resource_group_name, subscription_id, fabric_name, protection_container_name, replicated_protected_item_name, resolve_health_input) -> web.Response:
    ...
    :type resolve_health_input: dict | bytes

    """
    resolve_health_input = ResolveHealthInput.from_dict(resolve_health_input)
    return web.Response(status=200)
