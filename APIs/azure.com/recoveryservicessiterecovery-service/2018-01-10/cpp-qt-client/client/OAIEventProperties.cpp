...
void OAIEventProperties::initializeModel() {
    ...
    m_affected_object_correlation_id_isSet = false;
    m_affected_object_correlation_id_isValid = false;
...
void OAIEventProperties::fromJsonObject(QJsonObject json) {
    ...
    m_affected_object_correlation_id_isValid = ::OpenAPI::fromJsonValue(m_affected_object_correlation_id, json[QString("affectedObjectCorrelationId")]);
    m_affected_object_correlation_id_isSet = !json[QString("affectedObjectCorrelationId")].isNull() && m_affected_object_correlation_id_isValid;
...
QJsonObject OAIEventProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_affected_object_correlation_id_isSet) {
        obj.insert(QString("affectedObjectCorrelationId"), ::OpenAPI::toJsonValue(m_affected_object_correlation_id));
    }
...
QString OAIEventProperties::getAffectedObjectCorrelationId() const {
    return m_affected_object_correlation_id;
}
void OAIEventProperties::setAffectedObjectCorrelationId(const QString &affected_object_correlation_id) {
    m_affected_object_correlation_id = affected_object_correlation_id;
    m_affected_object_correlation_id_isSet = true;
}

bool OAIEventProperties::is_affected_object_correlation_id_Set() const{
    return m_affected_object_correlation_id_isSet;
}

bool OAIEventProperties::is_affected_object_correlation_id_Valid() const{
    return m_affected_object_correlation_id_isValid;
}
