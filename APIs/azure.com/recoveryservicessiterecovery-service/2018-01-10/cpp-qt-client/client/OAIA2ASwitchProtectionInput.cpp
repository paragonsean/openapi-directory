...
OAIDiskEncryptionInfo OAIA2ASwitchProtectionInput::getDiskEncryptionInfo() const {
    return m_disk_encryption_info;
}
void OAIA2ASwitchProtectionInput::setDiskEncryptionInfo(const OAIDiskEncryptionInfo &disk_encryption_info) {
    m_disk_encryption_info = disk_encryption_info;
    m_disk_encryption_info_isSet = true;
}

bool OAIA2ASwitchProtectionInput::is_disk_encryption_info_Set() const{
    return m_disk_encryption_info_isSet;
}

bool OAIA2ASwitchProtectionInput::is_disk_encryption_info_Valid() const{
...
QString OAIA2ASwitchProtectionInput::getRecoveryBootDiagStorageAccountId() const {
    return m_recovery_boot_diag_storage_account_id;
}
void OAIA2ASwitchProtectionInput::setRecoveryBootDiagStorageAccountId(const QString &recovery_boot_diag_storage_account_id) {
...
bool OAIA2ASwitchProtectionInput::is_recovery_boot_diag_storage_account_id_Set() const{
    return m_recovery_boot_diag_storage_account_id_isSet;
}

bool OAIA2ASwitchProtectionInput::is_recovery_boot_diag_storage_account_id_Valid() const{
