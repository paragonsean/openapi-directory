...
QString OAIEventQueryParameter::getAffectedObjectCorrelationId() const {
    return m_affected_object_correlation_id;
}
void OAIEventQueryParameter::setAffectedObjectCorrelationId(const QString &affected_object_correlation_id) {
    m_affected_object_correlation_id = affected_object_correlation_id;
    m_affected_object_correlation_id_isSet = true;
}

bool OAIEventQueryParameter::is_affected_object_correlation_id_Set() const{
    return m_affected_object_correlation_id_isSet;
}

bool OAIEventQueryParameter::is_affected_object_correlation_id_Valid() const{
