...
public:
    ...
    * @param[in]  protection_container_name QString [required]
    * @param[in]  migration_item_name QString [required]
    * @param[in]  input OAIResyncInput [required]
    */
    virtual void replicationMigrationItemsResync(const QString &api_version, const QString &resource_name, const QString &resource_group_name, const QString &subscription_id, const QString &fabric_name, const QString &protection_container_name, const QString &migration_item_name, const OAIResyncInput &input);
...
private:
    ...
    void replicationMigrationItemsResyncCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void replicationMigrationItemsResyncSignal(OAIMigrationItem summary);
    ...
    void replicationMigrationItemsResyncSignalFull(OAIHttpRequestWorker *worker, OAIMigrationItem summary);
    ...
    Q_DECL_DEPRECATED_X("Use replicationMigrationItemsResyncSignalError() instead")
    void replicationMigrationItemsResyncSignalE(OAIMigrationItem summary, QNetworkReply::NetworkError error_type, QString error_str);
    void replicationMigrationItemsResyncSignalError(OAIMigrationItem summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use replicationMigrationItemsResyncSignalErrorFull() instead")
    void replicationMigrationItemsResyncSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void replicationMigrationItemsResyncSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
