...
QString OAIVMwareCbtEnableMigrationInput::getPerformAutoResync() const {
    return m_perform_auto_resync;
}
void OAIVMwareCbtEnableMigrationInput::setPerformAutoResync(const QString &perform_auto_resync) {
    m_perform_auto_resync = perform_auto_resync;
    m_perform_auto_resync_isSet = true;
}

bool OAIVMwareCbtEnableMigrationInput::is_perform_auto_resync_Set() const{
    return m_perform_auto_resync_isSet;
}

bool OAIVMwareCbtEnableMigrationInput::is_perform_auto_resync_Valid() const{
