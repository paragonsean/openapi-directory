...
void OAIRecoveryServicesProviderProperties::initializeModel() {
    ...
    m_authentication_identity_details_isSet = false;
    m_authentication_identity_details_isValid = false;
    ...
    m_provider_version_details_isSet = false;
    m_provider_version_details_isValid = false;
    ...
    m_resource_access_identity_details_isSet = false;
    m_resource_access_identity_details_isValid = false;
...
void OAIRecoveryServicesProviderProperties::fromJsonObject(QJsonObject json) {
    ...
    m_authentication_identity_details_isValid = ::OpenAPI::fromJsonValue(m_authentication_identity_details, json[QString("authenticationIdentityDetails")]);
    m_authentication_identity_details_isSet = !json[QString("authenticationIdentityDetails")].isNull() && m_authentication_identity_details_isValid;
    ...
    m_provider_version_details_isValid = ::OpenAPI::fromJsonValue(m_provider_version_details, json[QString("providerVersionDetails")]);
    m_provider_version_details_isSet = !json[QString("providerVersionDetails")].isNull() && m_provider_version_details_isValid;
    ...
    m_resource_access_identity_details_isValid = ::OpenAPI::fromJsonValue(m_resource_access_identity_details, json[QString("resourceAccessIdentityDetails")]);
    m_resource_access_identity_details_isSet = !json[QString("resourceAccessIdentityDetails")].isNull() && m_resource_access_identity_details_isValid;
...
QJsonObject OAIRecoveryServicesProviderProperties::asJsonObject() const {
    ...
    if (m_authentication_identity_details.isSet()) {
        obj.insert(QString("authenticationIdentityDetails"), ::OpenAPI::toJsonValue(m_authentication_identity_details));
    }
    ...
    if (m_provider_version_details.isSet()) {
        obj.insert(QString("providerVersionDetails"), ::OpenAPI::toJsonValue(m_provider_version_details));
    }
    ...
    if (m_resource_access_identity_details.isSet()) {
        obj.insert(QString("resourceAccessIdentityDetails"), ::OpenAPI::toJsonValue(m_resource_access_identity_details));
    }
...
OAIIdentityProviderDetails OAIRecoveryServicesProviderProperties::getAuthenticationIdentityDetails() const {
    return m_authentication_identity_details;
}
void OAIRecoveryServicesProviderProperties::setAuthenticationIdentityDetails(const OAIIdentityProviderDetails &authentication_identity_details) {
    m_authentication_identity_details = authentication_identity_details;
    m_authentication_identity_details_isSet = true;
}

bool OAIRecoveryServicesProviderProperties::is_authentication_identity_details_Set() const{
    return m_authentication_identity_details_isSet;
}

bool OAIRecoveryServicesProviderProperties::is_authentication_identity_details_Valid() const{
    return m_authentication_identity_details_isValid;
}
...
OAIVersionDetails OAIRecoveryServicesProviderProperties::getProviderVersionDetails() const {
    return m_provider_version_details;
}
void OAIRecoveryServicesProviderProperties::setProviderVersionDetails(const OAIVersionDetails &provider_version_details) {
    m_provider_version_details = provider_version_details;
    m_provider_version_details_isSet = true;
}

bool OAIRecoveryServicesProviderProperties::is_provider_version_details_Set() const{
    return m_provider_version_details_isSet;
}

bool OAIRecoveryServicesProviderProperties::is_provider_version_details_Valid() const{
    return m_provider_version_details_isValid;
}
...
OAIIdentityProviderDetails OAIRecoveryServicesProviderProperties::getResourceAccessIdentityDetails() const {
    return m_resource_access_identity_details;
}
void OAIRecoveryServicesProviderProperties::setResourceAccessIdentityDetails(const OAIIdentityProviderDetails &resource_access_identity_details) {
    m_resource_access_identity_details = resource_access_identity_details;
    m_resource_access_identity_details_isSet = true;
}

bool OAIRecoveryServicesProviderProperties::is_resource_access_identity_details_Set() const{
    return m_resource_access_identity_details_isSet;
}

bool OAIRecoveryServicesProviderProperties::is_resource_access_identity_details_Valid() const{
    return m_resource_access_identity_details_isValid;
}
