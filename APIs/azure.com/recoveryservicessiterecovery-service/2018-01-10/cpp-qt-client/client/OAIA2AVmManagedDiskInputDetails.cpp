...
QString OAIA2AVmManagedDiskInputDetails::getRecoveryReplicaDiskAccountType() const {
    return m_recovery_replica_disk_account_type;
}
void OAIA2AVmManagedDiskInputDetails::setRecoveryReplicaDiskAccountType(const QString &recovery_replica_disk_account_type) {
    m_recovery_replica_disk_account_type = recovery_replica_disk_account_type;
    m_recovery_replica_disk_account_type_isSet = true;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_replica_disk_account_type_Set() const{
    return m_recovery_replica_disk_account_type_isSet;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_replica_disk_account_type_Valid() const{
...
QString OAIA2AVmManagedDiskInputDetails::getRecoveryTargetDiskAccountType() const {
    return m_recovery_target_disk_account_type;
}
void OAIA2AVmManagedDiskInputDetails::setRecoveryTargetDiskAccountType(const QString &recovery_target_disk_account_type) {
    m_recovery_target_disk_account_type = recovery_target_disk_account_type;
    m_recovery_target_disk_account_type_isSet = true;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_target_disk_account_type_Set() const{
    return m_recovery_target_disk_account_type_isSet;
}

bool OAIA2AVmManagedDiskInputDetails::is_recovery_target_disk_account_type_Valid() const{
