...
public class ReplicationRecoveryServicesProvidersApiTest {
     ...
     */
    @Test
    public void replicationRecoveryServicesProvidersCreateTest() throws ApiException {
        ...
        AddRecoveryServicesProviderInput addProviderInput = null;
        RecoveryServicesProvider response = api.replicationRecoveryServicesProvidersCreate(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, providerName, addProviderInput);
