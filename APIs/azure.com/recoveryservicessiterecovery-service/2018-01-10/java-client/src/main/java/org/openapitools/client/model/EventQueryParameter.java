...
public class EventQueryParameter {
  public static final String SERIALIZED_NAME_AFFECTED_OBJECT_CORRELATION_ID = "affectedObjectCorrelationId";
  @SerializedName(SERIALIZED_NAME_AFFECTED_OBJECT_CORRELATION_ID)
  ...
  public EventQueryParameter(
     String affectedObjectCorrelationId
  ) {
    this();
   ...
   * @return affectedObjectCorrelationId
   */
  @javax.annotation.Nullable
  public String getAffectedObjectCorrelationId() {
    return affectedObjectCorrelationId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.affectedObjectCorrelationId, eventQueryParameter.affectedObjectCorrelationId) &&
        Objects.equals(this.affectedObjectFriendlyName, eventQueryParameter.affectedObjectFriendlyName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affectedObjectCorrelationId, affectedObjectFriendlyName, endTime, eventCode, eventType, fabricName, severity, startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    affectedObjectCorrelationId: ").append(toIndentedString(affectedObjectCorrelationId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("affectedObjectCorrelationId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("affectedObjectCorrelationId") != null && !jsonObj.get("affectedObjectCorrelationId").isJsonNull()) && !jsonObj.get("affectedObjectCorrelationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `affectedObjectCorrelationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("affectedObjectCorrelationId").toString()));
      }
