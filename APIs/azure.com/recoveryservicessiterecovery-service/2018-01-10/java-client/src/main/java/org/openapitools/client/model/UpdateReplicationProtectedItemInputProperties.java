...
public class UpdateReplicationProtectedItemInputProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableRdpOnTargetOption, licenseType, providerSpecificDetails, recoveryAvailabilitySetId, recoveryAzureVMName, recoveryAzureVMSize, selectedRecoveryAzureNetworkId, selectedSourceNicId, vmNics);
  }
