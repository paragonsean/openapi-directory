...
public class RecoveryPlanPlannedFailoverInputProperties {
  ...
  public RecoveryPlanPlannedFailoverInputProperties failoverDirection(FailoverDirectionEnum failoverDirection) {
  ...
  public RecoveryPlanPlannedFailoverInputProperties providerSpecificDetails(List<RecoveryPlanProviderSpecificFailoverInput> providerSpecificDetails) {
    this.providerSpecificDetails = providerSpecificDetails;
    return this;
  }

  public RecoveryPlanPlannedFailoverInputProperties addProviderSpecificDetailsItem(RecoveryPlanProviderSpecificFailoverInput providerSpecificDetailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RecoveryPlanPlannedFailoverInputProperties recoveryPlanPlannedFailoverInputProperties = (RecoveryPlanPlannedFailoverInputProperties) o;
    return Objects.equals(this.failoverDirection, recoveryPlanPlannedFailoverInputProperties.failoverDirection) &&
        Objects.equals(this.providerSpecificDetails, recoveryPlanPlannedFailoverInputProperties.providerSpecificDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecoveryPlanPlannedFailoverInputProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecoveryPlanPlannedFailoverInputProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecoveryPlanPlannedFailoverInputProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecoveryPlanPlannedFailoverInputProperties is not found in the empty JSON string", RecoveryPlanPlannedFailoverInputProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecoveryPlanPlannedFailoverInputProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecoveryPlanPlannedFailoverInputProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecoveryPlanPlannedFailoverInputProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecoveryPlanPlannedFailoverInputProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecoveryPlanPlannedFailoverInputProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecoveryPlanPlannedFailoverInputProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecoveryPlanPlannedFailoverInputProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<RecoveryPlanPlannedFailoverInputProperties>() {
           @Override
           public void write(JsonWriter out, RecoveryPlanPlannedFailoverInputProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecoveryPlanPlannedFailoverInputProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecoveryPlanPlannedFailoverInputProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecoveryPlanPlannedFailoverInputProperties
   * @throws IOException if the JSON string is invalid with respect to RecoveryPlanPlannedFailoverInputProperties
   */
  public static RecoveryPlanPlannedFailoverInputProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecoveryPlanPlannedFailoverInputProperties.class);
  }

  /**
   * Convert an instance of RecoveryPlanPlannedFailoverInputProperties to an JSON string
   *
   * @return JSON string
   */
