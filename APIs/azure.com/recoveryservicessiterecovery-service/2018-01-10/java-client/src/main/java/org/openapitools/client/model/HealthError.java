...
public class HealthError {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationTimeUtc, entityId, errorCategory, errorCode, errorLevel, errorMessage, errorSource, errorType, innerHealthErrors, possibleCauses, recommendedAction, recoveryProviderErrorMessage, summaryMessage);
  }
