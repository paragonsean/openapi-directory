...
|**allowedOperations** | **List&lt;String&gt;** | The allowed operations on the Replication protected item. |  [optional] |
...
|**healthErrors** | [**List&lt;HealthError&gt;**](HealthError.md) | List of health errors. |  [optional] |
|**lastSuccessfulFailoverTime** | **OffsetDateTime** | The Last successful failover time. |  [optional] |
|**lastSuccessfulTestFailoverTime** | **OffsetDateTime** | The Last successful test failover time. |  [optional] |
...
|**primaryFabricProvider** | **String** | The fabric provider of the primary fabric. |  [optional] |
