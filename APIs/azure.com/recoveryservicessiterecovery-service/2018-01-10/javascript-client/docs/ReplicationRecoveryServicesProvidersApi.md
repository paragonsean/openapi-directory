...
let addProviderInput = new SiteRecoveryManagementClient.AddRecoveryServicesProviderInput(); // AddRecoveryServicesProviderInput | Add provider input.
apiInstance.replicationRecoveryServicesProvidersCreate(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, providerName, addProviderInput, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
