# SiteRecoveryManagementClient.VMwareCbtPolicyCreationInput
...
**recoveryPointHistoryInMinutes** | **Number** | The duration in minutes until which the recovery points need to be stored. | [optional] 
