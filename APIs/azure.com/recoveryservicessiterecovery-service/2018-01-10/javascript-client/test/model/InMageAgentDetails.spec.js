...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.InMageAgentDetails();
  });
  ...
  describe('InMageAgentDetails', function() {
    it('should create an instance of InMageAgentDetails', function() {
      // uncomment below and update the code to test InMageAgentDetails
      //var instance = new SiteRecoveryManagementClient.InMageAgentDetails();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.InMageAgentDetails);
    });
