...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Display();
  });
  ...
  describe('Display', function() {
    it('should create an instance of Display', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Display();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Display);
    });
