...
(function(root, factory) {
  ...
  describe('VMwareCbtMigrationDetails', function() {
    ...
    it('should have the property initialSeedingProgressPercentage (base name: "initialSeedingProgressPercentage")', function() {
      // uncomment below and update the code to test the property initialSeedingProgressPercentage
      //var instance = new SiteRecoveryManagementClient.VMwareCbtMigrationDetails();
      //expect(instance).to.be();
    });

    it('should have the property lastRecoveryPointId (base name: "lastRecoveryPointId")', function() {
      // uncomment below and update the code to test the property lastRecoveryPointId
      //var instance = new SiteRecoveryManagementClient.VMwareCbtMigrationDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property migrationProgressPercentage (base name: "migrationProgressPercentage")', function() {
      // uncomment below and update the code to test the property migrationProgressPercentage
      //var instance = new SiteRecoveryManagementClient.VMwareCbtMigrationDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property performAutoResync (base name: "performAutoResync")', function() {
      // uncomment below and update the code to test the property performAutoResync
      //var instance = new SiteRecoveryManagementClient.VMwareCbtMigrationDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property resyncState (base name: "resyncState")', function() {
      // uncomment below and update the code to test the property resyncState
      //var instance = new SiteRecoveryManagementClient.VMwareCbtMigrationDetails();
      //expect(instance).to.be();
    });
