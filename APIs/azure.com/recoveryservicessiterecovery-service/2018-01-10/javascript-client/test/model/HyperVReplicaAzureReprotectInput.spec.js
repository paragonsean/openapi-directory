...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.HyperVReplicaAzureReprotectInput();
  });
  ...
  describe('HyperVReplicaAzureReprotectInput', function() {
    it('should create an instance of HyperVReplicaAzureReprotectInput', function() {
      // uncomment below and update the code to test HyperVReplicaAzureReprotectInput
      //var instance = new SiteRecoveryManagementClient.HyperVReplicaAzureReprotectInput();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.HyperVReplicaAzureReprotectInput);
    });
