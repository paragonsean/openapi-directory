...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Event();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Event);
    });
