...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Job();
  });
  ...
  describe('Job', function() {
    it('should create an instance of Job', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Job();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Job);
    });
