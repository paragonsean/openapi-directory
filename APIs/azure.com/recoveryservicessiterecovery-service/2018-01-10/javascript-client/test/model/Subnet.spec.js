...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Subnet();
  });
  ...
  describe('Subnet', function() {
    it('should create an instance of Subnet', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Subnet();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Subnet);
    });
