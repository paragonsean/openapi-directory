...
export default class ReplicationMigrationItemsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the replicationMigrationItemsResync operation.
     * @callback module:api/ReplicationMigrationItemsApi~replicationMigrationItemsResyncCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MigrationItem} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} protectionContainerName Protection container name.
     * @param {String} migrationItemName Migration item name.
     * @param {module:model/ResyncInput} input Resync input.
     * @param {module:api/ReplicationMigrationItemsApi~replicationMigrationItemsResyncCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MigrationItem}
     */
    replicationMigrationItemsResync(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, migrationItemName, input, callback) {
      let postBody = input;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'fabricName' is set
      if (fabricName === undefined || fabricName === null) {
        throw new Error("Missing the required parameter 'fabricName' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'protectionContainerName' is set
      if (protectionContainerName === undefined || protectionContainerName === null) {
        throw new Error("Missing the required parameter 'protectionContainerName' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'migrationItemName' is set
      if (migrationItemName === undefined || migrationItemName === null) {
        throw new Error("Missing the required parameter 'migrationItemName' when calling replicationMigrationItemsResync");
      }
      // verify the required parameter 'input' is set
      if (input === undefined || input === null) {
        throw new Error("Missing the required parameter 'input' when calling replicationMigrationItemsResync");
      }
      ...
      let returnType = MigrationItem;
      return this.apiClient.callApi(
        '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/resync', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
