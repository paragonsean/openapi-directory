...
export default class ReplicationProtectionContainerMappingsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the replicationProtectionContainerMappingsUpdate operation.
     * @callback module:api/ReplicationProtectionContainerMappingsApi~replicationProtectionContainerMappingsUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProtectionContainerMapping} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} protectionContainerName Protection container name.
     * @param {String} mappingName Protection container mapping name.
     * @param {module:model/UpdateProtectionContainerMappingInput} updateInput Mapping update input.
     * @param {module:api/ReplicationProtectionContainerMappingsApi~replicationProtectionContainerMappingsUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProtectionContainerMapping}
     */
    replicationProtectionContainerMappingsUpdate(apiVersion, resourceName, resourceGroupName, subscriptionId, fabricName, protectionContainerName, mappingName, updateInput, callback) {
      let postBody = updateInput;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'fabricName' is set
      if (fabricName === undefined || fabricName === null) {
        throw new Error("Missing the required parameter 'fabricName' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'protectionContainerName' is set
      if (protectionContainerName === undefined || protectionContainerName === null) {
        throw new Error("Missing the required parameter 'protectionContainerName' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'mappingName' is set
      if (mappingName === undefined || mappingName === null) {
        throw new Error("Missing the required parameter 'mappingName' when calling replicationProtectionContainerMappingsUpdate");
      }
      // verify the required parameter 'updateInput' is set
      if (updateInput === undefined || updateInput === null) {
        throw new Error("Missing the required parameter 'updateInput' when calling replicationProtectionContainerMappingsUpdate");
      }
      ...
      let returnType = ProtectionContainerMapping;
      return this.apiClient.callApi(
        '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationProtectionContainerMappings/{mappingName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
