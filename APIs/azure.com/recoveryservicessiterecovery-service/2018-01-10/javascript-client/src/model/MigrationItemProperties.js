...
class MigrationItemProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('eventCorrelationId')) {
                obj['eventCorrelationId'] = ApiClient.convertToType(data['eventCorrelationId'], 'String');
            }
            ...
            if (data.hasOwnProperty('lastTestMigrationStatus')) {
                obj['lastTestMigrationStatus'] = ApiClient.convertToType(data['lastTestMigrationStatus'], 'String');
            }
            if (data.hasOwnProperty('lastTestMigrationTime')) {
                obj['lastTestMigrationTime'] = ApiClient.convertToType(data['lastTestMigrationTime'], 'Date');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['eventCorrelationId'] && !(typeof data['eventCorrelationId'] === 'string' || data['eventCorrelationId'] instanceof String)) {
            throw new Error("Expected the field `eventCorrelationId` to be a primitive type in the JSON string but got " + data['eventCorrelationId']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['lastTestMigrationStatus'] && !(typeof data['lastTestMigrationStatus'] === 'string' || data['lastTestMigrationStatus'] instanceof String)) {
            throw new Error("Expected the field `lastTestMigrationStatus` to be a primitive type in the JSON string but got " + data['lastTestMigrationStatus']);
        }
        // ensure the json data is a string
 ...
 * @member {String} eventCorrelationId
 */
MigrationItemProperties.prototype['eventCorrelationId'] = undefined;

/**
 * The consolidated health.
 * @member {module:model/MigrationItemProperties.HealthEnum} health
 */
 ...
 * @member {String} lastTestMigrationStatus
 */
MigrationItemProperties.prototype['lastTestMigrationStatus'] = undefined;

/**
 * The last test migration time.
 * @member {Date} lastTestMigrationTime
 */
MigrationItemProperties.prototype['lastTestMigrationTime'] = undefined;
 ...
 * @readonly
 */
MigrationItemProperties['HealthEnum'] = {
