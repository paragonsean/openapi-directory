...
class EventQueryParameter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('affectedObjectCorrelationId')) {
                obj['affectedObjectCorrelationId'] = ApiClient.convertToType(data['affectedObjectCorrelationId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['affectedObjectCorrelationId'] && !(typeof data['affectedObjectCorrelationId'] === 'string' || data['affectedObjectCorrelationId'] instanceof String)) {
            throw new Error("Expected the field `affectedObjectCorrelationId` to be a primitive type in the JSON string but got " + data['affectedObjectCorrelationId']);
        }
        // ensure the json data is a string
 ...
 * @member {String} affectedObjectCorrelationId
 */
EventQueryParameter.prototype['affectedObjectCorrelationId'] = undefined;
