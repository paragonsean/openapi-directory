...
class MasterTargetServer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('marsAgentExpiryDate')) {
                obj['marsAgentExpiryDate'] = ApiClient.convertToType(data['marsAgentExpiryDate'], 'Date');
            }
            if (data.hasOwnProperty('marsAgentVersion')) {
                obj['marsAgentVersion'] = ApiClient.convertToType(data['marsAgentVersion'], 'String');
            }
            if (data.hasOwnProperty('marsAgentVersionDetails')) {
                obj['marsAgentVersionDetails'] = VersionDetails.constructFromObject(data['marsAgentVersionDetails']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['marsAgentVersion'] && !(typeof data['marsAgentVersion'] === 'string' || data['marsAgentVersion'] instanceof String)) {
            throw new Error("Expected the field `marsAgentVersion` to be a primitive type in the JSON string but got " + data['marsAgentVersion']);
        }
        // validate the optional field `marsAgentVersionDetails`
        if (data['marsAgentVersionDetails']) { // data not null
          VersionDetails.validateJSON(data['marsAgentVersionDetails']);
        }
        // ensure the json data is a string
 ...
 */
MasterTargetServer.prototype['agentExpiryDate'] = undefined;
 ...
 */
MasterTargetServer.prototype['agentVersionDetails'] = undefined;
 ...
 */
MasterTargetServer.prototype['healthErrors'] = undefined;
 ...
 * @member {Date} marsAgentExpiryDate
 */
MasterTargetServer.prototype['marsAgentExpiryDate'] = undefined;

/**
 * MARS agent version.
 * @member {String} marsAgentVersion
 */
MasterTargetServer.prototype['marsAgentVersion'] = undefined;

/**
 * @member {module:model/VersionDetails} marsAgentVersionDetails
 */
MasterTargetServer.prototype['marsAgentVersionDetails'] = undefined;
