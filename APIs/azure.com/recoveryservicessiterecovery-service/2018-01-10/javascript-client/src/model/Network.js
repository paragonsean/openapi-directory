...
class Network {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = NetworkProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          NetworkProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/NetworkProperties} properties
 */
Network.prototype['properties'] = undefined;
 ...
 */
Network.prototype['location'] = undefined;
