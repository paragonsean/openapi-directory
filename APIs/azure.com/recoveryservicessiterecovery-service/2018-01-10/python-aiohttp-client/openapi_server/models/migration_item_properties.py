...
class MigrationItemProperties(Model):
    ...
    def __init__(self, allowed_operations: List[str]=None, current_job: CurrentJobDetails=None, event_correlation_id: str=None, health: str=None, health_errors: List[HealthError]=None, last_test_migration_status: str=None, last_test_migration_time: datetime=None, machine_name: str=None, migration_state: str=None, migration_state_description: str=None, policy_friendly_name: str=None, policy_id: str=None, provider_specific_details: MigrationProviderSpecificSettings=None, test_migrate_state: str=None, test_migrate_state_description: str=None):
        ...
        :param event_correlation_id: The event_correlation_id of this MigrationItemProperties.
        ...
        :param last_test_migration_status: The last_test_migration_status of this MigrationItemProperties.
        :param last_test_migration_time: The last_test_migration_time of this MigrationItemProperties.
        ...
        self.openapi_types = {
            ...
            'last_test_migration_time': datetime,
            'machine_name': str,
            'migration_state': str,
        ...
        self._last_test_migration_status = last_test_migration_status
        self._last_test_migration_time = last_test_migration_time
    ...
    def allowed_operations(self, allowed_operations):
        ...
        """
        allowed_values = ["DisableMigration", "TestMigrate", "TestMigrateCleanup", "Migrate", "StartResync"]  # noqa: E501
    ...
    def event_correlation_id(self):
        """Gets the event_correlation_id of this MigrationItemProperties.

        The correlation Id for events associated with this migration item.

        :return: The event_correlation_id of this MigrationItemProperties.
        :rtype: str
        """
    ...
    def event_correlation_id(self, event_correlation_id):
        """Sets the event_correlation_id of this MigrationItemProperties.
    ...
    def health(self, health):
        ...
        :type health: str
        """
        allowed_values = ["None", "Normal", "Warning", "Critical"]  # noqa: E501
    ...
    @property
    def last_test_migration_status(self):
        """Gets the last_test_migration_status of this MigrationItemProperties.

        The status of the last test migration.

        :return: The last_test_migration_status of this MigrationItemProperties.
        :rtype: str
        """
        return self._last_test_migration_status

    @last_test_migration_status.setter
    def last_test_migration_status(self, last_test_migration_status):
        """Sets the last_test_migration_status of this MigrationItemProperties.

        The status of the last test migration.

        :param last_test_migration_status: The last_test_migration_status of this MigrationItemProperties.
        :type last_test_migration_status: str
        """

        self._last_test_migration_status = last_test_migration_status

    @property
    def last_test_migration_time(self):
        """Gets the last_test_migration_time of this MigrationItemProperties.

        The last test migration time.

        :return: The last_test_migration_time of this MigrationItemProperties.
        :rtype: datetime
        """
        return self._last_test_migration_time

    @last_test_migration_time.setter
    def last_test_migration_time(self, last_test_migration_time):
        """Sets the last_test_migration_time of this MigrationItemProperties.

        The last test migration time.

        :param last_test_migration_time: The last_test_migration_time of this MigrationItemProperties.
        :type last_test_migration_time: datetime
        """
