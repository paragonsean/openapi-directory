...
class VMNicInputDetails(Model):
    ...
    def __init__(self, enable_accelerated_networking_on_recovery: bool=None, nic_id: str=None, recovery_vm_subnet_name: str=None, replica_nic_static_ip_address: str=None, selection_type: str=None):
