...
class VMwareCbtEnableMigrationInput(Model):
    ...
    def __init__(self, data_mover_run_as_account_id: str=None, disks_to_include: List[VMwareCbtDiskInput]=None, license_type: str=None, perform_auto_resync: str=None, snapshot_run_as_account_id: str=None, target_availability_set_id: str=None, target_boot_diagnostics_storage_account_id: str=None, target_network_id: str=None, target_resource_group_id: str=None, target_subnet_name: str=None, target_vm_name: str=None, target_vm_size: str=None, vmware_machine_id: str=None, instance_type: str=None):
        ...
        :param perform_auto_resync: The perform_auto_resync of this VMwareCbtEnableMigrationInput.
    ...
    def perform_auto_resync(self):
        """Gets the perform_auto_resync of this VMwareCbtEnableMigrationInput.

        A value indicating whether auto resync is to be done.

        :return: The perform_auto_resync of this VMwareCbtEnableMigrationInput.
        :rtype: str
        """
    ...
    def perform_auto_resync(self, perform_auto_resync):
        """Sets the perform_auto_resync of this VMwareCbtEnableMigrationInput.
