...
class EventQueryParameter(Model):
    ...
    def __init__(self, affected_object_correlation_id: str=None, affected_object_friendly_name: str=None, end_time: datetime=None, event_code: str=None, event_type: str=None, fabric_name: str=None, severity: str=None, start_time: datetime=None):
        """EventQueryParameter - a model defined in OpenAPI

        :param affected_object_correlation_id: The affected_object_correlation_id of this EventQueryParameter.
        ...
        """
        self.openapi_types = {
            'affected_object_correlation_id': str,
        ...
        self.attribute_map = {
            'affected_object_correlation_id': 'affectedObjectCorrelationId',
        ...
        self._affected_object_correlation_id = affected_object_correlation_id
    ...
    @property
    def affected_object_correlation_id(self):
        """Gets the affected_object_correlation_id of this EventQueryParameter.

        The affected object correlationId for the events to be queried.

        :return: The affected_object_correlation_id of this EventQueryParameter.
        :rtype: str
        """
        return self._affected_object_correlation_id

    @affected_object_correlation_id.setter
    def affected_object_correlation_id(self, affected_object_correlation_id):
        """Sets the affected_object_correlation_id of this EventQueryParameter.
