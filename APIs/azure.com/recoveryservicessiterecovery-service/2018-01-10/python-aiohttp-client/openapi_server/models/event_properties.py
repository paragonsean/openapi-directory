...
class EventProperties(Model):
    ...
    def __init__(self, affected_object_correlation_id: str=None, affected_object_friendly_name: str=None, description: str=None, event_code: str=None, event_specific_details: EventSpecificDetails=None, event_type: str=None, fabric_id: str=None, health_errors: List[HealthError]=None, provider_specific_details: EventProviderSpecificDetails=None, severity: str=None, time_of_occurrence: datetime=None):
        """EventProperties - a model defined in OpenAPI

        :param affected_object_correlation_id: The affected_object_correlation_id of this EventProperties.
    ...
    def affected_object_correlation_id(self):
        """Gets the affected_object_correlation_id of this EventProperties.

        The affected object correlationId for the event.

        :return: The affected_object_correlation_id of this EventProperties.
        :rtype: str
        """
    ...
    def affected_object_correlation_id(self, affected_object_correlation_id):
        """Sets the affected_object_correlation_id of this EventProperties.
