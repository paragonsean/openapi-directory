...
class VMwareV2FabricCreationInput(Model):
    ...
    def __init__(self, migration_solution_id: str=None, physical_site_id: str=None, vmware_site_id: str=None, instance_type: str=None):
        ...
        :param physical_site_id: The physical_site_id of this VMwareV2FabricCreationInput.
    ...
    def physical_site_id(self):
        """Gets the physical_site_id of this VMwareV2FabricCreationInput.

        The ARM Id of the physical site.

        :return: The physical_site_id of this VMwareV2FabricCreationInput.
        :rtype: str
        """
    ...
    def physical_site_id(self, physical_site_id):
        """Sets the physical_site_id of this VMwareV2FabricCreationInput.
