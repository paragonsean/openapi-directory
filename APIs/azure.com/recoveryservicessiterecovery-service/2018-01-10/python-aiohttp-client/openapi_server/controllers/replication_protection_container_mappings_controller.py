...
async def replication_protection_container_mappings_update(request: web.Request, api_version, resource_name, resource_group_name, subscription_id, fabric_name, protection_container_name, mapping_name, update_input) -> web.Response:
    ...
    """
    update_input = UpdateProtectionContainerMappingInput.from_dict(update_input)
    return web.Response(status=200)
