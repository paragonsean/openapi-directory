...
async def replication_migration_items_resync(request: web.Request, api_version, resource_name, resource_group_name, subscription_id, fabric_name, protection_container_name, migration_item_name, input) -> web.Response:
    ...
    """
    input = ResyncInput.from_dict(input)
    return web.Response(status=200)
