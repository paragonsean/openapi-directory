...
async def test_replication_recovery_services_providers_create(client):
    """Test case for replication_recovery_services_providers_create

    Adds a recovery services provider.
    """
    add_provider_input = {"properties":{"resourceAccessIdentityInput":{"aadAuthority":"aadAuthority","audience":"audience","tenantId":"tenantId","applicationId":"applicationId","objectId":"objectId"},"machineName":"machineName","authenticationIdentityInput":{"aadAuthority":"aadAuthority","audience":"audience","tenantId":"tenantId","applicationId":"applicationId","objectId":"objectId"}}}
