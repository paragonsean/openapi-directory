...
public class Network {
  ...
  public Network properties(NetworkProperties properties) {
  ...
  public Network location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, network.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        NetworkProperties.validateJsonElement(jsonObj.get("properties"));
      }
