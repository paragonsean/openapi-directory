...
public class ReplicationProtectedItemProperties {
  ...
  public static final String SERIALIZED_NAME_FAILOVER_HEALTH_ERRORS = "failoverHealthErrors";
  @SerializedName(SERIALIZED_NAME_FAILOVER_HEALTH_ERRORS)
  private List<HealthError> failoverHealthErrors = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_REPLICATION_HEALTH_ERRORS = "replicationHealthErrors";
  @SerializedName(SERIALIZED_NAME_REPLICATION_HEALTH_ERRORS)
  private List<HealthError> replicationHealthErrors = new ArrayList<>();
  ...
  public ReplicationProtectedItemProperties failoverHealthErrors(List<HealthError> failoverHealthErrors) {
    this.failoverHealthErrors = failoverHealthErrors;
    return this;
  }

  public ReplicationProtectedItemProperties addFailoverHealthErrorsItem(HealthError failoverHealthErrorsItem) {
    if (this.failoverHealthErrors == null) {
      this.failoverHealthErrors = new ArrayList<>();
    }
    this.failoverHealthErrors.add(failoverHealthErrorsItem);
    return this;
  }

  /**
   * List of failover health errors.
   * @return failoverHealthErrors
   */
  @javax.annotation.Nullable
  public List<HealthError> getFailoverHealthErrors() {
    return failoverHealthErrors;
  }

  public void setFailoverHealthErrors(List<HealthError> failoverHealthErrors) {
    this.failoverHealthErrors = failoverHealthErrors;
  }
  ...
  public ReplicationProtectedItemProperties replicationHealthErrors(List<HealthError> replicationHealthErrors) {
    this.replicationHealthErrors = replicationHealthErrors;
    return this;
  }

  public ReplicationProtectedItemProperties addReplicationHealthErrorsItem(HealthError replicationHealthErrorsItem) {
    if (this.replicationHealthErrors == null) {
      this.replicationHealthErrors = new ArrayList<>();
    }
    this.replicationHealthErrors.add(replicationHealthErrorsItem);
    return this;
  }

  /**
   * List of replication health errors.
   * @return replicationHealthErrors
   */
  @javax.annotation.Nullable
  public List<HealthError> getReplicationHealthErrors() {
    return replicationHealthErrors;
  }

  public void setReplicationHealthErrors(List<HealthError> replicationHealthErrors) {
    this.replicationHealthErrors = replicationHealthErrors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activeLocation, replicationProtectedItemProperties.activeLocation) &&
        ...
        Objects.equals(this.failoverHealthErrors, replicationProtectedItemProperties.failoverHealthErrors) &&
        ...
        Objects.equals(this.replicationHealthErrors, replicationProtectedItemProperties.replicationHealthErrors) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeLocation, allowedOperations, currentScenario, failoverHealth, failoverHealthErrors, failoverRecoveryPointId, friendlyName, lastSuccessfulFailoverTime, lastSuccessfulTestFailoverTime, policyFriendlyName, policyId, primaryFabricFriendlyName, primaryProtectionContainerFriendlyName, protectableItemId, protectedItemType, protectionState, protectionStateDescription, providerSpecificDetails, recoveryContainerId, recoveryFabricFriendlyName, recoveryFabricId, recoveryProtectionContainerFriendlyName, recoveryServicesProviderId, replicationHealth, replicationHealthErrors, testFailoverState, testFailoverStateDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("    failoverHealthErrors: ").append(toIndentedString(failoverHealthErrors)).append("\n");
    ...
    sb.append("    replicationHealthErrors: ").append(toIndentedString(replicationHealthErrors)).append("\n");
  ...
  static {
    ...
    openapiFields.add("failoverHealthErrors");
    ...
    openapiFields.add("replicationHealthErrors");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("failoverHealthErrors") != null && !jsonObj.get("failoverHealthErrors").isJsonNull()) {
        JsonArray jsonArrayfailoverHealthErrors = jsonObj.getAsJsonArray("failoverHealthErrors");
        if (jsonArrayfailoverHealthErrors != null) {
          // ensure the json data is an array
          if (!jsonObj.get("failoverHealthErrors").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `failoverHealthErrors` to be an array in the JSON string but got `%s`", jsonObj.get("failoverHealthErrors").toString()));
          }

          // validate the optional field `failoverHealthErrors` (array)
          for (int i = 0; i < jsonArrayfailoverHealthErrors.size(); i++) {
            HealthError.validateJsonElement(jsonArrayfailoverHealthErrors.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("replicationHealthErrors") != null && !jsonObj.get("replicationHealthErrors").isJsonNull()) {
        JsonArray jsonArrayreplicationHealthErrors = jsonObj.getAsJsonArray("replicationHealthErrors");
        if (jsonArrayreplicationHealthErrors != null) {
          // ensure the json data is an array
          if (!jsonObj.get("replicationHealthErrors").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `replicationHealthErrors` to be an array in the JSON string but got `%s`", jsonObj.get("replicationHealthErrors").toString()));
          }

          // validate the optional field `replicationHealthErrors` (array)
          for (int i = 0; i < jsonArrayreplicationHealthErrors.size(); i++) {
            HealthError.validateJsonElement(jsonArrayreplicationHealthErrors.get(i));
          };
        }
      }
