...
public class HyperVReplicaAzureReplicationDetails extends ReplicationProviderSpecificSettings {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azureVMDiskDetails, enableRDPOnTargetOption, encryption, initialReplicationDetails, lastReplicatedTime, licenseType, oSDetails, recoveryAvailabilitySetId, recoveryAzureLogStorageAccountId, recoveryAzureResourceGroupId, recoveryAzureStorageAccount, recoveryAzureVMName, recoveryAzureVMSize, selectedRecoveryAzureNetworkId, sourceVmCPUCount, sourceVmRAMSizeInMB, useManagedDisks, vmId, vmNics, vmProtectionState, vmProtectionStateDescription, super.hashCode());
  }
