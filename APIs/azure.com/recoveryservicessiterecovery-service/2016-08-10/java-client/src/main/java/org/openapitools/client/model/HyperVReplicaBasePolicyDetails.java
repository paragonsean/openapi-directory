...
public class HyperVReplicaBasePolicyDetails extends PolicyProviderSpecificDetails {
  ...
  public HyperVReplicaBasePolicyDetails allowedAuthenticationType(Integer allowedAuthenticationType) {
  ...
  public HyperVReplicaBasePolicyDetails applicationConsistentSnapshotFrequencyInHours(Integer applicationConsistentSnapshotFrequencyInHours) {
  ...
  public HyperVReplicaBasePolicyDetails compression(String compression) {
  ...
  public HyperVReplicaBasePolicyDetails initialReplicationMethod(String initialReplicationMethod) {
  ...
  public HyperVReplicaBasePolicyDetails offlineReplicationExportPath(String offlineReplicationExportPath) {
  ...
  public HyperVReplicaBasePolicyDetails offlineReplicationImportPath(String offlineReplicationImportPath) {
  ...
  public HyperVReplicaBasePolicyDetails onlineReplicationStartTime(String onlineReplicationStartTime) {
  ...
  public HyperVReplicaBasePolicyDetails recoveryPoints(Integer recoveryPoints) {
  ...
  public HyperVReplicaBasePolicyDetails replicaDeletionOption(String replicaDeletionOption) {
  ...
  public HyperVReplicaBasePolicyDetails replicationPort(Integer replicationPort) {
  ...
  public boolean equals(Object o) {
    ...
    HyperVReplicaBasePolicyDetails hyperVReplicaBasePolicyDetails = (HyperVReplicaBasePolicyDetails) o;
    return Objects.equals(this.allowedAuthenticationType, hyperVReplicaBasePolicyDetails.allowedAuthenticationType) &&
        Objects.equals(this.applicationConsistentSnapshotFrequencyInHours, hyperVReplicaBasePolicyDetails.applicationConsistentSnapshotFrequencyInHours) &&
        Objects.equals(this.compression, hyperVReplicaBasePolicyDetails.compression) &&
        Objects.equals(this.initialReplicationMethod, hyperVReplicaBasePolicyDetails.initialReplicationMethod) &&
        Objects.equals(this.offlineReplicationExportPath, hyperVReplicaBasePolicyDetails.offlineReplicationExportPath) &&
        Objects.equals(this.offlineReplicationImportPath, hyperVReplicaBasePolicyDetails.offlineReplicationImportPath) &&
        Objects.equals(this.onlineReplicationStartTime, hyperVReplicaBasePolicyDetails.onlineReplicationStartTime) &&
        Objects.equals(this.recoveryPoints, hyperVReplicaBasePolicyDetails.recoveryPoints) &&
        Objects.equals(this.replicaDeletionOption, hyperVReplicaBasePolicyDetails.replicaDeletionOption) &&
        Objects.equals(this.replicationPort, hyperVReplicaBasePolicyDetails.replicationPort) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedAuthenticationType, applicationConsistentSnapshotFrequencyInHours, compression, initialReplicationMethod, offlineReplicationExportPath, offlineReplicationImportPath, onlineReplicationStartTime, recoveryPoints, replicaDeletionOption, replicationPort, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HyperVReplicaBasePolicyDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HyperVReplicaBasePolicyDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HyperVReplicaBasePolicyDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HyperVReplicaBasePolicyDetails is not found in the empty JSON string", HyperVReplicaBasePolicyDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HyperVReplicaBasePolicyDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HyperVReplicaBasePolicyDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HyperVReplicaBasePolicyDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HyperVReplicaBasePolicyDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HyperVReplicaBasePolicyDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HyperVReplicaBasePolicyDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<HyperVReplicaBasePolicyDetails>() {
           @Override
           public void write(JsonWriter out, HyperVReplicaBasePolicyDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HyperVReplicaBasePolicyDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HyperVReplicaBasePolicyDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HyperVReplicaBasePolicyDetails
   * @throws IOException if the JSON string is invalid with respect to HyperVReplicaBasePolicyDetails
   */
  public static HyperVReplicaBasePolicyDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HyperVReplicaBasePolicyDetails.class);
  }

  /**
   * Convert an instance of HyperVReplicaBasePolicyDetails to an JSON string
   *
   * @return JSON string
   */
