...
public class InMageAzureV2ReplicationDetails extends ReplicationProviderSpecificSettings {
  ...
  public static final String SERIALIZED_NAME_SOURCE_VM_C_P_U_COUNT = "sourceVmCPUCount";
  @SerializedName(SERIALIZED_NAME_SOURCE_VM_C_P_U_COUNT)
  private Integer sourceVmCPUCount;

  public static final String SERIALIZED_NAME_SOURCE_VM_R_A_M_SIZE_IN_M_B = "sourceVmRAMSizeInMB";
  @SerializedName(SERIALIZED_NAME_SOURCE_VM_R_A_M_SIZE_IN_M_B)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentVersion, inMageAzureV2ReplicationDetails.agentVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentVersion, azureVMDiskDetails, compressedDataRateInMB, datastores, discoveryType, diskResized, enableRDPOnTargetOption, infrastructureVmId, ipAddress, isAgentUpdateRequired, isRebootAfterUpdateRequired, lastHeartbeat, lastRpoCalculatedTime, lastUpdateReceivedTime, licenseType, masterTargetId, multiVmGroupId, multiVmGroupName, multiVmSyncStatus, osDiskId, osType, osVersion, processServerId, protectedDisks, protectionStage, recoveryAvailabilitySetId, recoveryAzureLogStorageAccountId, recoveryAzureResourceGroupId, recoveryAzureStorageAccount, recoveryAzureVMName, recoveryAzureVMSize, replicaId, resyncProgressPercentage, rpoInSeconds, selectedRecoveryAzureNetworkId, sourceVmCPUCount, sourceVmRAMSizeInMB, targetVmId, uncompressedDataRateInMB, useManagedDisks, vCenterInfrastructureId, validationErrors, vhdName, vmId, vmNics, vmProtectionState, vmProtectionStateDescription, super.hashCode());
  }
