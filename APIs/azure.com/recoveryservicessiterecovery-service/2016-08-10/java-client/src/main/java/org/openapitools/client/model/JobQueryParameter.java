...
public class JobQueryParameter {
  ...
  private List<String> affectedObjectTypes = new ArrayList<>();
  ...
  private List<String> jobStatus = new ArrayList<>();
  ...
  public JobQueryParameter affectedObjectTypes(List<String> affectedObjectTypes) {
    this.affectedObjectTypes = affectedObjectTypes;
    return this;
  }

  public JobQueryParameter addAffectedObjectTypesItem(String affectedObjectTypesItem) {
    if (this.affectedObjectTypes == null) {
      this.affectedObjectTypes = new ArrayList<>();
    }
    this.affectedObjectTypes.add(affectedObjectTypesItem);
    return this;
  }
  ...
  public List<String> getAffectedObjectTypes() {
    return affectedObjectTypes;
  }

  public void setAffectedObjectTypes(List<String> affectedObjectTypes) {
    this.affectedObjectTypes = affectedObjectTypes;
  }
  ...
  public JobQueryParameter jobStatus(List<String> jobStatus) {
    this.jobStatus = jobStatus;
    return this;
  }

  public JobQueryParameter addJobStatusItem(String jobStatusItem) {
    if (this.jobStatus == null) {
      this.jobStatus = new ArrayList<>();
    }
    this.jobStatus.add(jobStatusItem);
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("affectedObjectTypes") != null && !jsonObj.get("affectedObjectTypes").isJsonNull() && !jsonObj.get("affectedObjectTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `affectedObjectTypes` to be an array in the JSON string but got `%s`", jsonObj.get("affectedObjectTypes").toString()));
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("jobStatus") != null && !jsonObj.get("jobStatus").isJsonNull() && !jsonObj.get("jobStatus").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `jobStatus` to be an array in the JSON string but got `%s`", jsonObj.get("jobStatus").toString()));
      }
