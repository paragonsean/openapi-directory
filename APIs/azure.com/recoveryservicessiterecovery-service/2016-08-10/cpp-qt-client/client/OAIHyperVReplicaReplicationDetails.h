...
/*
 * OAIHyperVReplicaReplicationDetails.h
 *
 * HyperV replica 2012 replication details.
 */

#ifndef OAIHyperVReplicaReplicationDetails_H
#define OAIHyperVReplicaReplicationDetails_H
...
class OAIHyperVReplicaReplicationDetails : public OAIObject {
public:
    OAIHyperVReplicaReplicationDetails();
    OAIHyperVReplicaReplicationDetails(QString json);
    ~OAIHyperVReplicaReplicationDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaReplicationDetails)

#endif // OAIHyperVReplicaReplicationDetails_H
