...
public:
    ...
    QString getRecoveryDiskId() const;
    void setRecoveryDiskId(const QString &recovery_disk_id);
    bool is_recovery_disk_id_Set() const;
    bool is_recovery_disk_id_Valid() const;
...
private:
    ...
    QString m_recovery_disk_id;
    bool m_recovery_disk_id_isSet;
    bool m_recovery_disk_id_isValid;
