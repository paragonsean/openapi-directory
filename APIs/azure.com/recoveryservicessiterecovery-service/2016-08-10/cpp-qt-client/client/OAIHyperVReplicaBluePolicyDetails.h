...
/*
 * OAIHyperVReplicaBluePolicyDetails.h
 *
 * Hyper-V Replica Blue specific protection profile details.
 */

#ifndef OAIHyperVReplicaBluePolicyDetails_H
#define OAIHyperVReplicaBluePolicyDetails_H
...
class OAIHyperVReplicaBluePolicyDetails : public OAIObject {
public:
    OAIHyperVReplicaBluePolicyDetails();
    OAIHyperVReplicaBluePolicyDetails(QString json);
    ~OAIHyperVReplicaBluePolicyDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHyperVReplicaBluePolicyDetails)

#endif // OAIHyperVReplicaBluePolicyDetails_H
