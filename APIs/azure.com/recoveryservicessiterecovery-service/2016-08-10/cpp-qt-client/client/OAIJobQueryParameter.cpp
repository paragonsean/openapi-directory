...
QJsonObject OAIJobQueryParameter::asJsonObject() const {
    QJsonObject obj;
    if (m_affected_object_types.size() > 0) {
...
QList<QString> OAIJobQueryParameter::getAffectedObjectTypes() const {
    return m_affected_object_types;
}
void OAIJobQueryParameter::setAffectedObjectTypes(const QList<QString> &affected_object_types) {
...
QList<QString> OAIJobQueryParameter::getJobStatus() const {
    return m_job_status;
}
void OAIJobQueryParameter::setJobStatus(const QList<QString> &job_status) {
