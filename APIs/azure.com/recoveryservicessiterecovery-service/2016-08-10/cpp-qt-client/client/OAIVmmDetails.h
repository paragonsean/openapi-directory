...
#ifndef OAIVmmDetails_H
#define OAIVmmDetails_H
...
class OAIVmmDetails : public OAIObject {
public:
    OAIVmmDetails();
    OAIVmmDetails(QString json);
    ~OAIVmmDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmmDetails)

#endif // OAIVmmDetails_H
