...
void OAIReplicationProtectedItemProperties::initializeModel() {
    ...
    m_failover_health_errors_isSet = false;
    m_failover_health_errors_isValid = false;
    ...
    m_replication_health_errors_isSet = false;
    m_replication_health_errors_isValid = false;
...
void OAIReplicationProtectedItemProperties::fromJsonObject(QJsonObject json) {
    ...
    m_failover_health_errors_isValid = ::OpenAPI::fromJsonValue(m_failover_health_errors, json[QString("failoverHealthErrors")]);
    m_failover_health_errors_isSet = !json[QString("failoverHealthErrors")].isNull() && m_failover_health_errors_isValid;
    ...
    m_replication_health_errors_isValid = ::OpenAPI::fromJsonValue(m_replication_health_errors, json[QString("replicationHealthErrors")]);
    m_replication_health_errors_isSet = !json[QString("replicationHealthErrors")].isNull() && m_replication_health_errors_isValid;
...
QJsonObject OAIReplicationProtectedItemProperties::asJsonObject() const {
    ...
    if (m_failover_health_errors.size() > 0) {
        obj.insert(QString("failoverHealthErrors"), ::OpenAPI::toJsonValue(m_failover_health_errors));
    }
    ...
    if (m_replication_health_errors.size() > 0) {
        obj.insert(QString("replicationHealthErrors"), ::OpenAPI::toJsonValue(m_replication_health_errors));
    }
...
QList<OAIHealthError> OAIReplicationProtectedItemProperties::getFailoverHealthErrors() const {
    return m_failover_health_errors;
}
void OAIReplicationProtectedItemProperties::setFailoverHealthErrors(const QList<OAIHealthError> &failover_health_errors) {
    m_failover_health_errors = failover_health_errors;
    m_failover_health_errors_isSet = true;
}

bool OAIReplicationProtectedItemProperties::is_failover_health_errors_Set() const{
    return m_failover_health_errors_isSet;
}

bool OAIReplicationProtectedItemProperties::is_failover_health_errors_Valid() const{
    return m_failover_health_errors_isValid;
}
...
QList<OAIHealthError> OAIReplicationProtectedItemProperties::getReplicationHealthErrors() const {
    return m_replication_health_errors;
}
void OAIReplicationProtectedItemProperties::setReplicationHealthErrors(const QList<OAIHealthError> &replication_health_errors) {
    m_replication_health_errors = replication_health_errors;
    m_replication_health_errors_isSet = true;
}

bool OAIReplicationProtectedItemProperties::is_replication_health_errors_Set() const{
    return m_replication_health_errors_isSet;
}

bool OAIReplicationProtectedItemProperties::is_replication_health_errors_Valid() const{
    return m_replication_health_errors_isValid;
}
