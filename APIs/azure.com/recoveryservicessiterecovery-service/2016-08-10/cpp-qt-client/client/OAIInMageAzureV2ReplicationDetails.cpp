...
void OAIInMageAzureV2ReplicationDetails::setEnableRdponTargetOption(const QString &enable_rdpon_target_option) {
    m_enable_rdpon_target_option = enable_rdpon_target_option;
    m_enable_rdpon_target_option_isSet = true;
}

bool OAIInMageAzureV2ReplicationDetails::is_enable_rdpon_target_option_Set() const{
    return m_enable_rdpon_target_option_isSet;
}

bool OAIInMageAzureV2ReplicationDetails::is_enable_rdpon_target_option_Valid() const{
