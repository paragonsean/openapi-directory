...
void OAIHyperVReplicaAzureReplicationDetails::setEnableRdponTargetOption(const QString &enable_rdpon_target_option) {
    m_enable_rdpon_target_option = enable_rdpon_target_option;
    m_enable_rdpon_target_option_isSet = true;
}

bool OAIHyperVReplicaAzureReplicationDetails::is_enable_rdpon_target_option_Set() const{
    return m_enable_rdpon_target_option_isSet;
}

bool OAIHyperVReplicaAzureReplicationDetails::is_enable_rdpon_target_option_Valid() const{
