...
async def test_replication_protected_items_update(client):
    ...
    Updates protection.
    """
    update_protection_input = {"properties":{"licenseType":"NotSpecified","vmNics":[{"selectionType":"selectionType","nicId":"nicId","replicaNicStaticIPAddress":"replicaNicStaticIPAddress","recoveryVMSubnetName":"recoveryVMSubnetName"},{"selectionType":"selectionType","nicId":"nicId","replicaNicStaticIPAddress":"replicaNicStaticIPAddress","recoveryVMSubnetName":"recoveryVMSubnetName"}],"providerSpecificDetails":{"instanceType":"instanceType"},"recoveryAvailabilitySetId":"recoveryAvailabilitySetId","recoveryAzureVMName":"recoveryAzureVMName","recoveryAzureVMSize":"recoveryAzureVMSize","selectedRecoveryAzureNetworkId":"selectedRecoveryAzureNetworkId","enableRDPOnTargetOption":"enableRDPOnTargetOption"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
