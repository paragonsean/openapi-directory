...
class JobQueryParameter(Model):
    ...
    def __init__(self, affected_object_types: List[str]=None, end_time: str=None, fabric_id: str=None, job_status: List[str]=None, start_time: str=None):
    ...
    def affected_object_types(self, affected_object_types):
        ...
        :param affected_object_types: The affected_object_types of this JobQueryParameter.
        :type affected_object_types: List[str]
        """
