...
class JobDetails(Model):
    ...
    def __init__(self, affected_object_details: Dict[str, str]=None, instance_type: str=None):
        ...
        :param affected_object_details: The affected_object_details of this JobDetails.
        :param instance_type: The instance_type of this JobDetails.
        """
        self.openapi_types = {
    ...
    def affected_object_details(self):
        """Gets the affected_object_details of this JobDetails.

        The affected object properties like source server, source cloud, target server, target cloud etc. based on the workflow object details.

        :return: The affected_object_details of this JobDetails.
        :rtype: Dict[str, str]
        """
    ...
    def affected_object_details(self, affected_object_details):
        """Sets the affected_object_details of this JobDetails.
    ...
    def instance_type(self):
        """Gets the instance_type of this JobDetails.

        Gets the type of job details (see JobDetailsTypes enum for possible values).

        :return: The instance_type of this JobDetails.
        :rtype: str
        """
    ...
    def instance_type(self, instance_type):
        """Sets the instance_type of this JobDetails.
