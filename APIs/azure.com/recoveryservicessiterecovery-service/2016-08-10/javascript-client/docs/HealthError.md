# SiteRecoveryManagementClient.HealthError

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**childErrors** | [**[HealthError]**](HealthError.md) | The child health errors. | [optional] 
**creationTimeUtc** | **Date** | Error creation time (UTC) | [optional] 
