# SiteRecoveryManagementClient.JobProperties
...
**allowedActions** | **[String]** | The Allowed action the job. | [optional] 
**customDetails** | [**JobDetails**](JobDetails.md) |  | [optional] 
**endTime** | **Date** | The end time. | [optional] 
**errors** | [**[JobErrorDetails]**](JobErrorDetails.md) | The errors. | [optional] 
...
**tasks** | [**[ASRTask]**](ASRTask.md) | The tasks. | [optional] 
