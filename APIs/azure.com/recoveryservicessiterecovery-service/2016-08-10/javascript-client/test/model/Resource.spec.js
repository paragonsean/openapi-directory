...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Resource();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Resource);
    });
