...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.Policy();
  });
  ...
  describe('Policy', function() {
    it('should create an instance of Policy', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.Policy();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.Policy);
    });
