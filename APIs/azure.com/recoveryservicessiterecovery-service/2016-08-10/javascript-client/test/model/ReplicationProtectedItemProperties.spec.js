...
(function(root, factory) {
  ...
  describe('ReplicationProtectedItemProperties', function() {
    ...
    it('should have the property failoverHealthErrors (base name: "failoverHealthErrors")', function() {
      // uncomment below and update the code to test the property failoverHealthErrors
      //var instance = new SiteRecoveryManagementClient.ReplicationProtectedItemProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property replicationHealthErrors (base name: "replicationHealthErrors")', function() {
      // uncomment below and update the code to test the property replicationHealthErrors
      //var instance = new SiteRecoveryManagementClient.ReplicationProtectedItemProperties();
      //expect(instance).to.be();
    });
