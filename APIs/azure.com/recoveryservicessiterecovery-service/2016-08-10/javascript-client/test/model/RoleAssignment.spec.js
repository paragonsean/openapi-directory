...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.RoleAssignment();
  });
  ...
  describe('RoleAssignment', function() {
    it('should create an instance of RoleAssignment', function() {
      ...
      //var instance = new SiteRecoveryManagementClient.RoleAssignment();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.RoleAssignment);
    });
