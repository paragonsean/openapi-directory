...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiteRecoveryManagementClient.IdentityInformation();
  });
  ...
  describe('IdentityInformation', function() {
    it('should create an instance of IdentityInformation', function() {
      // uncomment below and update the code to test IdentityInformation
      //var instance = new SiteRecoveryManagementClient.IdentityInformation();
      //expect(instance).to.be.a(SiteRecoveryManagementClient.IdentityInformation);
    });
