...
class JobQueryParameter {
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['affectedObjectTypes'])) {
            throw new Error("Expected the field `affectedObjectTypes` to be an array in the JSON data but got " + data['affectedObjectTypes']);
        }
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['jobStatus'])) {
            throw new Error("Expected the field `jobStatus` to be an array in the JSON data but got " + data['jobStatus']);
        }
        // ensure the json data is a string
...
/**
 * The type of objects.
 * @member {Array.<String>} affectedObjectTypes
 */
