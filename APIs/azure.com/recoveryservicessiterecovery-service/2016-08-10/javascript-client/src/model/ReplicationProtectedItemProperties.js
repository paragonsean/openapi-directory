...
class ReplicationProtectedItemProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('failoverHealthErrors')) {
                obj['failoverHealthErrors'] = ApiClient.convertToType(data['failoverHealthErrors'], [HealthError]);
            }
            ...
            if (data.hasOwnProperty('replicationHealthErrors')) {
                obj['replicationHealthErrors'] = ApiClient.convertToType(data['replicationHealthErrors'], [HealthError]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['failoverHealthErrors']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['failoverHealthErrors'])) {
                throw new Error("Expected the field `failoverHealthErrors` to be an array in the JSON data but got " + data['failoverHealthErrors']);
            }
            // validate the optional field `failoverHealthErrors` (array)
            for (const item of data['failoverHealthErrors']) {
        ...
        if (data['replicationHealthErrors']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['replicationHealthErrors'])) {
                throw new Error("Expected the field `replicationHealthErrors` to be an array in the JSON data but got " + data['replicationHealthErrors']);
            }
            // validate the optional field `replicationHealthErrors` (array)
            for (const item of data['replicationHealthErrors']) {
                HealthError.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/HealthError>} failoverHealthErrors
 */
ReplicationProtectedItemProperties.prototype['failoverHealthErrors'] = undefined;
 ...
 * @member {Array.<module:model/HealthError>} replicationHealthErrors
 */
ReplicationProtectedItemProperties.prototype['replicationHealthErrors'] = undefined;
