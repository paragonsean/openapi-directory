...
class Fabric {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = FabricProperties.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Fabric</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Fabric</code>.
     */
    static validateJSON(data) {
        // validate the optional field `properties`
        if (data['properties']) { // data not null
          FabricProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/FabricProperties} properties
 */
Fabric.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
Fabric.prototype['id'] = undefined;

/**
 * Resource Location
 * @member {String} location
 */
Fabric.prototype['location'] = undefined;

/**
 * Resource Name
 * @member {String} name
 */
Fabric.prototype['name'] = undefined;

/**
 * Resource Type
 * @member {String} type
 */
Fabric.prototype['type'] = undefined;
