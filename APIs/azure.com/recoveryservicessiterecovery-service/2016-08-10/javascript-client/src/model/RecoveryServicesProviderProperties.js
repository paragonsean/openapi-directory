...
class RecoveryServicesProviderProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('identityDetails')) {
                obj['identityDetails'] = IdentityInformation.constructFromObject(data['identityDetails']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['identityDetails']) { // data not null
          IdentityInformation.validateJSON(data['identityDetails']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/IdentityInformation} identityDetails
 */
RecoveryServicesProviderProperties.prototype['identityDetails'] = undefined;
