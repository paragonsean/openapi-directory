...
QDateTime OAISecurityAlertPolicyProperties::getCreationTime() const {
    return m_creation_time;
}
void OAISecurityAlertPolicyProperties::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAISecurityAlertPolicyProperties::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAISecurityAlertPolicyProperties::is_creation_time_Valid() const{
