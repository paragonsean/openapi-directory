...
qint64 OAIElasticPoolPerDatabaseMaxDtuCapability::getLimit() const {
    return m_limit;
}
void OAIElasticPoolPerDatabaseMaxDtuCapability::setLimit(const qint64 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}
...
OAICapabilityStatus OAIElasticPoolPerDatabaseMaxDtuCapability::getStatus() const {
    return m_status;
}
void OAIElasticPoolPerDatabaseMaxDtuCapability::setStatus(const OAICapabilityStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
