...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabaseCapabilities.ElasticPoolPerDatabaseMaxDtuCapability();
  });
  ...
  describe('ElasticPoolPerDatabaseMaxDtuCapability', function() {
    it('should create an instance of ElasticPoolPerDatabaseMaxDtuCapability', function() {
      ...
      //var instance = new AzureSqlDatabaseCapabilities.ElasticPoolPerDatabaseMaxDtuCapability();
      //expect(instance).to.be.a(AzureSqlDatabaseCapabilities.ElasticPoolPerDatabaseMaxDtuCapability);
    });
