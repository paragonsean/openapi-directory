...
import ReadScaleCapability from './ReadScaleCapability';
import ServiceObjectiveCapability from './ServiceObjectiveCapability';
import StorageCapability from './StorageCapability';
...
class EditionCapability {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('readScale')) {
                obj['readScale'] = ReadScaleCapability.constructFromObject(data['readScale']);
            }
            ...
            if (data.hasOwnProperty('supportedStorageCapabilities')) {
                obj['supportedStorageCapabilities'] = ApiClient.convertToType(data['supportedStorageCapabilities'], [StorageCapability]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['readScale']) { // data not null
          ReadScaleCapability.validateJSON(data['readScale']);
        }
        // ensure the json data is a string
        ...
        if (data['supportedStorageCapabilities']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['supportedStorageCapabilities'])) {
                throw new Error("Expected the field `supportedStorageCapabilities` to be an array in the JSON data but got " + data['supportedStorageCapabilities']);
            }
            // validate the optional field `supportedStorageCapabilities` (array)
            for (const item of data['supportedStorageCapabilities']) {
                StorageCapability.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/ReadScaleCapability} readScale
 */
EditionCapability.prototype['readScale'] = undefined;
 ...
 * @member {Array.<module:model/StorageCapability>} supportedStorageCapabilities
 */
EditionCapability.prototype['supportedStorageCapabilities'] = undefined;
