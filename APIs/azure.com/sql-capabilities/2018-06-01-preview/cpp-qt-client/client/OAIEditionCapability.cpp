...
void OAIEditionCapability::initializeModel() {
    ...
    m_supported_storage_capabilities_isSet = false;
    m_supported_storage_capabilities_isValid = false;
...
void OAIEditionCapability::fromJsonObject(QJsonObject json) {
    ...
    m_supported_storage_capabilities_isValid = ::OpenAPI::fromJsonValue(m_supported_storage_capabilities, json[QString("supportedStorageCapabilities")]);
    m_supported_storage_capabilities_isSet = !json[QString("supportedStorageCapabilities")].isNull() && m_supported_storage_capabilities_isValid;
...
QJsonObject OAIEditionCapability::asJsonObject() const {
    ...
    if (m_supported_storage_capabilities.size() > 0) {
        obj.insert(QString("supportedStorageCapabilities"), ::OpenAPI::toJsonValue(m_supported_storage_capabilities));
    }
...
OAIReadScaleCapability OAIEditionCapability::getReadScale() const {
    return m_read_scale;
}
void OAIEditionCapability::setReadScale(const OAIReadScaleCapability &read_scale) {
    m_read_scale = read_scale;
    m_read_scale_isSet = true;
}

bool OAIEditionCapability::is_read_scale_Set() const{
    return m_read_scale_isSet;
}

bool OAIEditionCapability::is_read_scale_Valid() const{
...
QList<OAIStorageCapability> OAIEditionCapability::getSupportedStorageCapabilities() const {
    return m_supported_storage_capabilities;
}
void OAIEditionCapability::setSupportedStorageCapabilities(const QList<OAIStorageCapability> &supported_storage_capabilities) {
    m_supported_storage_capabilities = supported_storage_capabilities;
    m_supported_storage_capabilities_isSet = true;
}

bool OAIEditionCapability::is_supported_storage_capabilities_Set() const{
    return m_supported_storage_capabilities_isSet;
}

bool OAIEditionCapability::is_supported_storage_capabilities_Valid() const{
    return m_supported_storage_capabilities_isValid;
}
