...
void OAIServiceObjectiveCapability::initializeModel() {
    ...
    m_compute_model_isSet = false;
    m_compute_model_isValid = false;
    ...
    m_supported_auto_pause_delay_isSet = false;
    m_supported_auto_pause_delay_isValid = false;
    ...
    m_supported_min_capacities_isSet = false;
    m_supported_min_capacities_isValid = false;
...
void OAIServiceObjectiveCapability::fromJsonObject(QJsonObject json) {
    ...
    m_compute_model_isValid = ::OpenAPI::fromJsonValue(m_compute_model, json[QString("computeModel")]);
    m_compute_model_isSet = !json[QString("computeModel")].isNull() && m_compute_model_isValid;
    ...
    m_supported_auto_pause_delay_isValid = ::OpenAPI::fromJsonValue(m_supported_auto_pause_delay, json[QString("supportedAutoPauseDelay")]);
    m_supported_auto_pause_delay_isSet = !json[QString("supportedAutoPauseDelay")].isNull() && m_supported_auto_pause_delay_isValid;
    ...
    m_supported_min_capacities_isValid = ::OpenAPI::fromJsonValue(m_supported_min_capacities, json[QString("supportedMinCapacities")]);
    m_supported_min_capacities_isSet = !json[QString("supportedMinCapacities")].isNull() && m_supported_min_capacities_isValid;
...
QJsonObject OAIServiceObjectiveCapability::asJsonObject() const {
    QJsonObject obj;
    if (m_compute_model_isSet) {
        obj.insert(QString("computeModel"), ::OpenAPI::toJsonValue(m_compute_model));
    }
    if (m_id_isSet) {
    ...
    if (m_supported_auto_pause_delay.isSet()) {
        obj.insert(QString("supportedAutoPauseDelay"), ::OpenAPI::toJsonValue(m_supported_auto_pause_delay));
    }
    ...
    if (m_supported_min_capacities.size() > 0) {
        obj.insert(QString("supportedMinCapacities"), ::OpenAPI::toJsonValue(m_supported_min_capacities));
    }
...
QString OAIServiceObjectiveCapability::getComputeModel() const {
    return m_compute_model;
}
void OAIServiceObjectiveCapability::setComputeModel(const QString &compute_model) {
    m_compute_model = compute_model;
    m_compute_model_isSet = true;
}

bool OAIServiceObjectiveCapability::is_compute_model_Set() const{
    return m_compute_model_isSet;
}

bool OAIServiceObjectiveCapability::is_compute_model_Valid() const{
    return m_compute_model_isValid;
}
...
OAIAutoPauseDelayTimeRange OAIServiceObjectiveCapability::getSupportedAutoPauseDelay() const {
    return m_supported_auto_pause_delay;
}
void OAIServiceObjectiveCapability::setSupportedAutoPauseDelay(const OAIAutoPauseDelayTimeRange &supported_auto_pause_delay) {
    m_supported_auto_pause_delay = supported_auto_pause_delay;
    m_supported_auto_pause_delay_isSet = true;
}

bool OAIServiceObjectiveCapability::is_supported_auto_pause_delay_Set() const{
    return m_supported_auto_pause_delay_isSet;
}

bool OAIServiceObjectiveCapability::is_supported_auto_pause_delay_Valid() const{
    return m_supported_auto_pause_delay_isValid;
}
...
QList<OAIMinCapacityCapability> OAIServiceObjectiveCapability::getSupportedMinCapacities() const {
    return m_supported_min_capacities;
}
void OAIServiceObjectiveCapability::setSupportedMinCapacities(const QList<OAIMinCapacityCapability> &supported_min_capacities) {
    m_supported_min_capacities = supported_min_capacities;
    m_supported_min_capacities_isSet = true;
}

bool OAIServiceObjectiveCapability::is_supported_min_capacities_Set() const{
    return m_supported_min_capacities_isSet;
}

bool OAIServiceObjectiveCapability::is_supported_min_capacities_Valid() const{
    return m_supported_min_capacities_isValid;
}

bool OAIServiceObjectiveCapability::isZoneRedundant() const {
    return m_zone_redundant;
}
void OAIServiceObjectiveCapability::setZoneRedundant(const bool &zone_redundant) {
    m_zone_redundant = zone_redundant;
    m_zone_redundant_isSet = true;
}

bool OAIServiceObjectiveCapability::is_zone_redundant_Set() const{
    return m_zone_redundant_isSet;
}

bool OAIServiceObjectiveCapability::is_zone_redundant_Valid() const{
