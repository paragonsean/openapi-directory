...
public class ElasticPoolEditionCapability {
  ...
  public static final String SERIALIZED_NAME_SUPPORTED_ELASTIC_POOL_PERFORMANCE_LEVELS = "supportedElasticPoolPerformanceLevels";
  @SerializedName(SERIALIZED_NAME_SUPPORTED_ELASTIC_POOL_PERFORMANCE_LEVELS)
  private List<ElasticPoolPerformanceLevelCapability> supportedElasticPoolPerformanceLevels = new ArrayList<>();
  ...
  public ElasticPoolEditionCapability reason(String reason) {
    this.reason = reason;
    return this;
  }
   ...
   * @return supportedElasticPoolPerformanceLevels
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, elasticPoolEditionCapability.name) &&
        Objects.equals(this.reason, elasticPoolEditionCapability.reason) &&
        Objects.equals(this.status, elasticPoolEditionCapability.status) &&
        Objects.equals(this.supportedElasticPoolPerformanceLevels, elasticPoolEditionCapability.supportedElasticPoolPerformanceLevels) &&
        Objects.equals(this.zoneRedundant, elasticPoolEditionCapability.zoneRedundant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, reason, status, supportedElasticPoolPerformanceLevels, zoneRedundant);
  }
  ...
  public String toString() {
    ...
    sb.append("    supportedElasticPoolPerformanceLevels: ").append(toIndentedString(supportedElasticPoolPerformanceLevels)).append("\n");
  ...
  static {
    ...
    openapiFields.add("supportedElasticPoolPerformanceLevels");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("supportedElasticPoolPerformanceLevels") != null && !jsonObj.get("supportedElasticPoolPerformanceLevels").isJsonNull()) {
        JsonArray jsonArraysupportedElasticPoolPerformanceLevels = jsonObj.getAsJsonArray("supportedElasticPoolPerformanceLevels");
        if (jsonArraysupportedElasticPoolPerformanceLevels != null) {
          // ensure the json data is an array
          if (!jsonObj.get("supportedElasticPoolPerformanceLevels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `supportedElasticPoolPerformanceLevels` to be an array in the JSON string but got `%s`", jsonObj.get("supportedElasticPoolPerformanceLevels").toString()));
          }

          // validate the optional field `supportedElasticPoolPerformanceLevels` (array)
          for (int i = 0; i < jsonArraysupportedElasticPoolPerformanceLevels.size(); i++) {
            ElasticPoolPerformanceLevelCapability.validateJsonElement(jsonArraysupportedElasticPoolPerformanceLevels.get(i));
          };
        }
      }
  }
