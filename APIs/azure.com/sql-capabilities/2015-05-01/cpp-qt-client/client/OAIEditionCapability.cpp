...
QList<OAIServiceLevelObjectiveCapability> OAIEditionCapability::getSupportedServiceLevelObjectives() const {
    return m_supported_service_level_objectives;
}
void OAIEditionCapability::setSupportedServiceLevelObjectives(const QList<OAIServiceLevelObjectiveCapability> &supported_service_level_objectives) {
