...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceRpService.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MarketplaceRpService.OperationDisplay();
      //expect(instance).to.be.a(MarketplaceRpService.OperationDisplay);
    });
