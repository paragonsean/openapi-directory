...
import FarmProperties from './FarmProperties';
...
class Farm {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = FarmProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          FarmProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/FarmProperties} properties
 */
Farm.prototype['properties'] = undefined;
 ...
 */
Farm.prototype['location'] = undefined;
 ...
 */
Farm.prototype['tags'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
Farm.prototype['type'] = undefined;
