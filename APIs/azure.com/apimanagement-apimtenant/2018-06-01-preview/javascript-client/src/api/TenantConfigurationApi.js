...
export default class TenantConfigurationApi {
    ...
    */
     ...
     * @param {module:model/TenantConfigurationDeploy200Response} data The data returned by the service call.
     ...
     * @param {module:model/TenantConfigurationDeployRequest} parameters Deploy Configuration parameters.
     ...
     * data is of type: {@link module:model/TenantConfigurationDeploy200Response}
     */
    tenantConfigurationDeploy(resourceGroupName, serviceName, apiVersion, subscriptionId, configurationName, parameters, callback) {
      ...
      let returnType = TenantConfigurationDeploy200Response;
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/String} configurationName The identifier of the Git Configuration Operation.
     * @param {module:model/TenantConfigurationSaveRequest} parameters Save Configuration parameters.
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/String} configurationName The identifier of the Git Configuration Operation.
     * @param {module:model/TenantConfigurationDeployRequest} parameters Validate Configuration parameters.
