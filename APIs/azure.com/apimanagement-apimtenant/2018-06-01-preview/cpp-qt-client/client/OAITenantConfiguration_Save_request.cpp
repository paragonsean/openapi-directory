...
QString OAITenantConfiguration_Save_request::getBranch() const {
    return m_branch;
}
void OAITenantConfiguration_Save_request::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAITenantConfiguration_Save_request::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAITenantConfiguration_Save_request::is_branch_Valid() const{
    return m_branch_isValid;
}

bool OAITenantConfiguration_Save_request::isForce() const {
    return m_force;
}
void OAITenantConfiguration_Save_request::setForce(const bool &force) {
    m_force = force;
    m_force_isSet = true;
}

bool OAITenantConfiguration_Save_request::is_force_Set() const{
    return m_force_isSet;
}

bool OAITenantConfiguration_Save_request::is_force_Valid() const{
