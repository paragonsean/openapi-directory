...
public:
    ...
    */
    virtual void tenantAccessGet(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void tenantAccessRegeneratePrimaryKey(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void tenantAccessRegenerateSecondaryKey(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id);
    ...
    */
    virtual void tenantAccessUpdate(const QString &resource_group_name, const QString &service_name, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIAccessInformationUpdateParameters &parameters);
