...
public:
    ...
    * @param[in]  access_name QString [required]
    */
    virtual void tenantAccessGetEntityTag(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &access_name);
    ...
    * @param[in]  access_name QString [required]
    */
    virtual void tenantAccessListSecrets(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &access_name);
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAITenantAccess_Update_request [required]
    */
    virtual void tenantAccessUpdate(const QString &resource_group_name, const QString &service_name, const QString &access_name, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAITenantAccess_Update_request &parameters);
...
private:
    ...
    void tenantAccessGetEntityTagCallback(OAIHttpRequestWorker *worker);
    void tenantAccessListSecretsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void tenantAccessGetSignal(OAITenantAccess_Get_200_response summary);
    void tenantAccessGetEntityTagSignal();
    void tenantAccessListSecretsSignal(OAITenantAccess_Get_200_response summary);
    void tenantAccessRegeneratePrimaryKeySignal();
    void tenantAccessRegenerateSecondaryKeySignal();
    void tenantAccessUpdateSignal();


    void tenantAccessGetSignalFull(OAIHttpRequestWorker *worker, OAITenantAccess_Get_200_response summary);
    void tenantAccessGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void tenantAccessListSecretsSignalFull(OAIHttpRequestWorker *worker, OAITenantAccess_Get_200_response summary);
    ...
    void tenantAccessGetSignalE(OAITenantAccess_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tenantAccessGetSignalError(OAITenantAccess_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use tenantAccessGetEntityTagSignalError() instead")
    void tenantAccessGetEntityTagSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void tenantAccessGetEntityTagSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use tenantAccessListSecretsSignalError() instead")
    void tenantAccessListSecretsSignalE(OAITenantAccess_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tenantAccessListSecretsSignalError(OAITenantAccess_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use tenantAccessGetEntityTagSignalErrorFull() instead")
    void tenantAccessGetEntityTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void tenantAccessGetEntityTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use tenantAccessListSecretsSignalErrorFull() instead")
    void tenantAccessListSecretsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void tenantAccessListSecretsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
