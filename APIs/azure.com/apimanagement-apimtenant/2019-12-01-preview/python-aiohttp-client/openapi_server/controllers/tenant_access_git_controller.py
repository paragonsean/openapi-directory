...
async def tenant_access_git_list_secrets(request: web.Request, resource_group_name, service_name, api_version, subscription_id, access_name) -> web.Response:
    """tenant_access_git_list_secrets
