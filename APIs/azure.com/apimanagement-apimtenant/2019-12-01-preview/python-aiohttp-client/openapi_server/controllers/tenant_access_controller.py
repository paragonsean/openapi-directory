...
async def tenant_access_get_entity_tag(request: web.Request, resource_group_name, service_name, api_version, subscription_id, access_name) -> web.Response:
...
async def tenant_access_list_secrets(request: web.Request, resource_group_name, service_name, api_version, subscription_id, access_name) -> web.Response:
...
async def tenant_access_update(request: web.Request, resource_group_name, service_name, access_name, if_match, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = TenantAccessUpdateRequest.from_dict(parameters)
    return web.Response(status=200)
