...
(function(root, factory) {
  ...
  describe('TenantAccessApi', function() {
    ...
    describe('tenantAccessListSecrets', function() {
      it('should call tenantAccessListSecrets successfully', function(done) {
        //uncomment below and update the code to test tenantAccessListSecrets
        //instance.tenantAccessListSecrets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
