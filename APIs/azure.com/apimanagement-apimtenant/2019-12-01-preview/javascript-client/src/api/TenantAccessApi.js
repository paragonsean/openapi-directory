...
export default class TenantAccessApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the tenantAccessListSecrets operation.
     * @callback module:api/TenantAccessApi~tenantAccessListSecretsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TenantAccessGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/String} accessName The identifier of the Access configuration.
     * @param {module:api/TenantAccessApi~tenantAccessListSecretsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TenantAccessGet200Response}
     */
    tenantAccessListSecrets(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling tenantAccessListSecrets");
      }
      // verify the required parameter 'serviceName' is set
      if (serviceName === undefined || serviceName === null) {
        throw new Error("Missing the required parameter 'serviceName' when calling tenantAccessListSecrets");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling tenantAccessListSecrets");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling tenantAccessListSecrets");
      }
      // verify the required parameter 'accessName' is set
      if (accessName === undefined || accessName === null) {
        throw new Error("Missing the required parameter 'accessName' when calling tenantAccessListSecrets");
      }
      ...
      let returnType = TenantAccessGet200Response;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/tenant/{accessName}/listSecrets', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
