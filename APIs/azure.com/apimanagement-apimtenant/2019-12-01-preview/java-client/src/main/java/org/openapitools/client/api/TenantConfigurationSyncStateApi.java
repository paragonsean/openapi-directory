...
public class TenantConfigurationSyncStateApi {
     ...
     */
    public TenantConfigurationGetSyncState200Response tenantConfigurationGetSyncState(String resourceGroupName, String serviceName, String apiVersion, String subscriptionId, String configurationName) throws ApiException {
        ApiResponse<TenantConfigurationGetSyncState200Response> localVarResp = tenantConfigurationGetSyncStateWithHttpInfo(resourceGroupName, serviceName, apiVersion, subscriptionId, configurationName);
     ...
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param configurationName The identifier of the Git Configuration Operation. (required)
     * @return ApiResponse&lt;TenantConfigurationGetSyncState200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TenantConfigurationGetSyncState200Response> tenantConfigurationGetSyncStateWithHttpInfo(String resourceGroupName, String serviceName, String apiVersion, String subscriptionId, String configurationName) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<TenantConfigurationGetSyncState200Response>(){}.getType();
     ...
     */
    public okhttp3.Call tenantConfigurationGetSyncStateAsync(String resourceGroupName, String serviceName, String apiVersion, String subscriptionId, String configurationName, final ApiCallback<TenantConfigurationGetSyncState200Response> _callback) throws ApiException {
