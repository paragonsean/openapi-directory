...
| [**tenantAccessListSecrets**](TenantAccessApi.md#tenantAccessListSecrets) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/tenant/{accessName}/listSecrets |  |
...
<a id="tenantAccessListSecrets"></a>
# **tenantAccessListSecrets**
> TenantAccessGet200Response tenantAccessListSecrets(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accessName = "access"; // String | The identifier of the Access configuration.
    try {
      TenantAccessGet200Response result = apiInstance.tenantAccessListSecrets(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TenantAccessApi#tenantAccessListSecrets");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
