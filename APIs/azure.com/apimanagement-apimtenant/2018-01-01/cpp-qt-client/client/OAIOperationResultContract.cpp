...
OAITenantAccess_Update_default_response_error OAIOperationResultContract::getError() const {
    return m_error;
}
void OAIOperationResultContract::setError(const OAITenantAccess_Update_default_response_error &error) {
    m_error = error;
    m_error_isSet = true;
}
