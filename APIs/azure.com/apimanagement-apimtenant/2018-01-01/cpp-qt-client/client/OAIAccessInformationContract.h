...
/*
 * OAIAccessInformationContract.h
 *
 * Tenant access information contract of the API Management service.
 */

#ifndef OAIAccessInformationContract_H
#define OAIAccessInformationContract_H
...
class OAIAccessInformationContract : public OAIObject {
public:
    OAIAccessInformationContract();
    OAIAccessInformationContract(QString json);
    ~OAIAccessInformationContract() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessInformationContract)

#endif // OAIAccessInformationContract_H
