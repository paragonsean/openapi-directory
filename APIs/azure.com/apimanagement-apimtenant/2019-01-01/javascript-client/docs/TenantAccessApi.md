...
apiInstance.tenantAccessGet(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let accessName = "accessName_example"; // String | The identifier of the Access configuration.
apiInstance.tenantAccessGetEntityTag(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let accessName = "accessName_example"; // String | The identifier of the Access configuration.
apiInstance.tenantAccessRegeneratePrimaryKey(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let accessName = "accessName_example"; // String | The identifier of the Access configuration.
apiInstance.tenantAccessRegenerateSecondaryKey(resourceGroupName, serviceName, apiVersion, subscriptionId, accessName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new ApiManagementClient.TenantAccessUpdateRequest(); // TenantAccessUpdateRequest | Parameters supplied to retrieve the Tenant Access Information.
apiInstance.tenantAccessUpdate(resourceGroupName, serviceName, accessName, ifMatch, apiVersion, subscriptionId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
