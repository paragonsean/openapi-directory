...
> TenantConfigurationGetSyncState200Response tenantConfigurationGetSyncState(resourceGroupName, serviceName, apiVersion, subscriptionId, configurationName)
...
apiInstance.tenantConfigurationGetSyncState(resourceGroupName, serviceName, apiVersion, subscriptionId, configurationName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
