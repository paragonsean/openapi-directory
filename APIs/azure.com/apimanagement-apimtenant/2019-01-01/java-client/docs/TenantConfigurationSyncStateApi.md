...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TenantConfigurationGetSyncState200Response result = apiInstance.tenantConfigurationGetSyncState(resourceGroupName, serviceName, apiVersion, subscriptionId, configurationName);
