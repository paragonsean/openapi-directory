...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationResultContract();
  });
  ...
  describe('OperationResultContract', function() {
    it('should create an instance of OperationResultContract', function() {
      // uncomment below and update the code to test OperationResultContract
      //var instance = new ApiManagementClient.OperationResultContract();
      //expect(instance).to.be.a(ApiManagementClient.OperationResultContract);
    });
