...
public:
    ...
    */
    virtual void tenantConfigurationGetSyncState(const QString &api_version, const QString &configuration_name);
...
Q_SIGNALS:
    ...
    void tenantConfigurationGetSyncStateSignal(OAITenantConfigurationSyncStateContract summary);


    void tenantConfigurationGetSyncStateSignalFull(OAIHttpRequestWorker *worker, OAITenantConfigurationSyncStateContract summary);

    Q_DECL_DEPRECATED_X("Use tenantConfigurationGetSyncStateSignalError() instead")
    void tenantConfigurationGetSyncStateSignalE(OAITenantConfigurationSyncStateContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tenantConfigurationGetSyncStateSignalError(OAITenantConfigurationSyncStateContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
