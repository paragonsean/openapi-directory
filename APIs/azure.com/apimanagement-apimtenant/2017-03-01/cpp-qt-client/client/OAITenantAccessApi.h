...
public:
    ...
    */
    virtual void tenantAccessGet(const QString &api_version, const QString &access_name);

    /**
    * @param[in]  api_version QString [required]
    * @param[in]  access_name QString [required]
    */
    virtual void tenantAccessRegeneratePrimaryKey(const QString &api_version, const QString &access_name);

    /**
    * @param[in]  api_version QString [required]
    * @param[in]  access_name QString [required]
    */
    virtual void tenantAccessRegenerateSecondaryKey(const QString &api_version, const QString &access_name);
    ...
    */
    virtual void tenantAccessUpdate(const QString &access_name, const QString &if_match, const QString &api_version, const OAIAccessInformationUpdateParameters &parameters);
