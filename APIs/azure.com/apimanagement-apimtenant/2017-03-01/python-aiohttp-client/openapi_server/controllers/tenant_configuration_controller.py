...
async def tenant_configuration_deploy(request: web.Request, api_version, configuration_name, parameters) -> web.Response:
...
async def tenant_configuration_save(request: web.Request, api_version, configuration_name, parameters) -> web.Response:
...
async def tenant_configuration_validate(request: web.Request, api_version, configuration_name, parameters) -> web.Response:
