...
void OAIContainerServiceProperties::initializeModel() {
    ...
    m_custom_profile_isSet = false;
    m_custom_profile_isValid = false;
...
void OAIContainerServiceProperties::fromJsonObject(QJsonObject json) {
    ...
    m_custom_profile_isValid = ::OpenAPI::fromJsonValue(m_custom_profile, json[QString("customProfile")]);
    m_custom_profile_isSet = !json[QString("customProfile")].isNull() && m_custom_profile_isValid;
...
QJsonObject OAIContainerServiceProperties::asJsonObject() const {
    ...
    if (m_custom_profile.isSet()) {
        obj.insert(QString("customProfile"), ::OpenAPI::toJsonValue(m_custom_profile));
    }
...
OAIContainerServiceCustomProfile OAIContainerServiceProperties::getCustomProfile() const {
    return m_custom_profile;
}
void OAIContainerServiceProperties::setCustomProfile(const OAIContainerServiceCustomProfile &custom_profile) {
    m_custom_profile = custom_profile;
    m_custom_profile_isSet = true;
}

bool OAIContainerServiceProperties::is_custom_profile_Set() const{
    return m_custom_profile_isSet;
}

bool OAIContainerServiceProperties::is_custom_profile_Valid() const{
    return m_custom_profile_isValid;
}
...
OAIContainerServiceServicePrincipalProfile OAIContainerServiceProperties::getServicePrincipalProfile() const {
    return m_service_principal_profile;
}
void OAIContainerServiceProperties::setServicePrincipalProfile(const OAIContainerServiceServicePrincipalProfile &service_principal_profile) {
    m_service_principal_profile = service_principal_profile;
    m_service_principal_profile_isSet = true;
}

bool OAIContainerServiceProperties::is_service_principal_profile_Set() const{
    return m_service_principal_profile_isSet;
}

bool OAIContainerServiceProperties::is_service_principal_profile_Valid() const{
...
bool OAIContainerServiceProperties::isValid() const {
    ...
    return m_linux_profile_isValid && m_master_profile_isValid && m_orchestrator_profile_isValid && true;
}
