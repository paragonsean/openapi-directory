...
class ContainerServiceOrchestratorProfile {
     ...
     * @param orchestratorType {module:model/ContainerServiceOrchestratorProfile.OrchestratorTypeEnum} The orchestrator to use to manage container service cluster resources. Valid values are Kubernetes, Swarm, DCOS, DockerCE and Custom.
     */
    constructor(orchestratorType) { 
        
        ContainerServiceOrchestratorProfile.initialize(this, orchestratorType);
    }
     ...
     */
    static initialize(obj, orchestratorType) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of ContainerServiceOrchestratorProfile.RequiredProperties) {
...
ContainerServiceOrchestratorProfile.RequiredProperties = ["orchestratorType"];
 ...
 */
ContainerServiceOrchestratorProfile.prototype['orchestratorVersion'] = undefined;
