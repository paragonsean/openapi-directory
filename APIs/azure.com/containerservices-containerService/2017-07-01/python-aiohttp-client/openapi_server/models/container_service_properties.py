...
class ContainerServiceProperties(Model):
    ...
    def __init__(self, agent_pool_profiles: List[ContainerServiceAgentPoolProfile]=None, custom_profile: ContainerServiceCustomProfile=None, diagnostics_profile: ContainerServiceDiagnosticsProfile=None, linux_profile: ContainerServiceLinuxProfile=None, master_profile: ContainerServiceMasterProfile=None, orchestrator_profile: ContainerServiceOrchestratorProfile=None, provisioning_state: str=None, service_principal_profile: ContainerServiceServicePrincipalProfile=None, windows_profile: ContainerServiceWindowsProfile=None):
        ...
        :param custom_profile: The custom_profile of this ContainerServiceProperties.
        ...
        :param service_principal_profile: The service_principal_profile of this ContainerServiceProperties.
        ...
        self.openapi_types = {
            ...
            'custom_profile': ContainerServiceCustomProfile,
    ...
    def custom_profile(self):
        """Gets the custom_profile of this ContainerServiceProperties.


        :return: The custom_profile of this ContainerServiceProperties.
        :rtype: ContainerServiceCustomProfile
        """
        return self._custom_profile

    @custom_profile.setter
    def custom_profile(self, custom_profile):
        """Sets the custom_profile of this ContainerServiceProperties.


        :param custom_profile: The custom_profile of this ContainerServiceProperties.
        :type custom_profile: ContainerServiceCustomProfile
        """
    ...
    def orchestrator_profile(self, orchestrator_profile):
        ...
        if orchestrator_profile is None:
            raise ValueError("Invalid value for `orchestrator_profile`, must not be `None`")
    ...
    def service_principal_profile(self):
        """Gets the service_principal_profile of this ContainerServiceProperties.


        :return: The service_principal_profile of this ContainerServiceProperties.
    ...
    def service_principal_profile(self, service_principal_profile):
        """Sets the service_principal_profile of this ContainerServiceProperties.
