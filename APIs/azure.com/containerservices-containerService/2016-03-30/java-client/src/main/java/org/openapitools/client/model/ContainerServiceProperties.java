...
public class ContainerServiceProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentPoolProfiles, diagnosticsProfile, linuxProfile, masterProfile, orchestratorProfile, provisioningState, windowsProfile);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("orchestratorProfile") != null && !jsonObj.get("orchestratorProfile").isJsonNull()) {
