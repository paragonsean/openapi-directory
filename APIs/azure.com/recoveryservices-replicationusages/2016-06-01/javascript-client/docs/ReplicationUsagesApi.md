# RecoveryServicesClient.ReplicationUsagesApi
...
let apiInstance = new RecoveryServicesClient.ReplicationUsagesApi();
...
apiInstance.replicationUsagesList(subscriptionId, apiVersion, resourceGroupName, vaultName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
