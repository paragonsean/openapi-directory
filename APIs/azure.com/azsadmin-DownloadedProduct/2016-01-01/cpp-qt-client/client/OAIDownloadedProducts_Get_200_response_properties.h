...
/*
 * OAIDownloadedProducts_Get_200_response_properties.h
 *
 * Properties for aggregate usage.
 */

#ifndef OAIDownloadedProducts_Get_200_response_properties_H
#define OAIDownloadedProducts_Get_200_response_properties_H
...
namespace OpenAPI {
class OAIDownloadedProducts_Get_200_response_properties_links_inner;

class OAIDownloadedProducts_Get_200_response_properties : public OAIObject {
public:
    OAIDownloadedProducts_Get_200_response_properties();
    OAIDownloadedProducts_Get_200_response_properties(QString json);
    ~OAIDownloadedProducts_Get_200_response_properties() override;
    ...
    QList<OAIDownloadedProducts_Get_200_response_properties_links_inner> getLinks() const;
    void setLinks(const QList<OAIDownloadedProducts_Get_200_response_properties_links_inner> &links);
...
private:
    ...
    QList<OAIDownloadedProducts_Get_200_response_properties_links_inner> m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDownloadedProducts_Get_200_response_properties)

#endif // OAIDownloadedProducts_Get_200_response_properties_H
