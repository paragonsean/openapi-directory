...
public class NetworkProfile {
  ...
  private List<IpAddress> networkInterfaces = new ArrayList<>();
  ...
  public NetworkProfile networkInterfaces(List<IpAddress> networkInterfaces) {
    this.networkInterfaces = networkInterfaces;
    return this;
  }

  public NetworkProfile addNetworkInterfacesItem(IpAddress networkInterfacesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<IpAddress> getNetworkInterfaces() {
    return networkInterfaces;
  }

  public void setNetworkInterfaces(List<IpAddress> networkInterfaces) {
    this.networkInterfaces = networkInterfaces;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.circuitId, networkProfile.circuitId) &&
        Objects.equals(this.networkInterfaces, networkProfile.networkInterfaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(circuitId, networkInterfaces);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("circuitId") != null && !jsonObj.get("circuitId").isJsonNull()) && !jsonObj.get("circuitId").isJsonPrimitive()) {
      ...
      if (jsonObj.get("networkInterfaces") != null && !jsonObj.get("networkInterfaces").isJsonNull()) {
        ...
        if (jsonArraynetworkInterfaces != null) {
          ...
          for (int i = 0; i < jsonArraynetworkInterfaces.size(); i++) {
            IpAddress.validateJsonElement(jsonArraynetworkInterfaces.get(i));
          };
        }
      }
  }
