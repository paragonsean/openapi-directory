...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HanaManagementClient.OperationList();
  });
  ...
  describe('OperationList', function() {
    it('should create an instance of OperationList', function() {
      ...
      //var instance = new HanaManagementClient.OperationList();
      //expect(instance).to.be.a(HanaManagementClient.OperationList);
    });
