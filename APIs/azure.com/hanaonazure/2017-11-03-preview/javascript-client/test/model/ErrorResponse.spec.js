...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HanaManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new HanaManagementClient.ErrorResponse();
      //expect(instance).to.be.a(HanaManagementClient.ErrorResponse);
    });
