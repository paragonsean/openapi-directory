...
async def test_iot_hub_resource_create_or_update(client):
    ...
    """
    iot_hub_description = {"resourcegroup":"resourcegroup","etag":"etag","sku":{"tier":"Free","name":"F1","capacity":2},"subscriptionid":"subscriptionid","properties":{"features":"None","hostName":"hostName","storageEndpoints":{"key":{"connectionString":"connectionString","sasTtlAsIso8601":"sasTtlAsIso8601","containerName":"containerName"}},"comments":"comments","ipFilterRules":[{"filterName":"filterName","ipMask":"ipMask","action":"Accept"},{"filterName":"filterName","ipMask":"ipMask","action":"Accept"}],"eventHubEndpoints":{"key":{"partitionCount":1,"path":"path","endpoint":"endpoint","retentionTimeInDays":5,"partitionIds":["partitionIds","partitionIds"]}},"operationsMonitoringProperties":{"events":{"key":"None"}},"enableFileUploadNotifications":True,"provisioningState":"provisioningState","authorizationPolicies":[{"secondaryKey":"secondaryKey","rights":"RegistryRead","keyName":"keyName","primaryKey":"primaryKey"},{"secondaryKey":"secondaryKey","rights":"RegistryRead","keyName":"keyName","primaryKey":"primaryKey"}],"messagingEndpoints":{"key":{"ttlAsIso8601":"ttlAsIso8601","maxDeliveryCount":56,"lockDurationAsIso8601":"lockDurationAsIso8601"}},"cloudToDevice":{"feedback":{"ttlAsIso8601":"ttlAsIso8601","maxDeliveryCount":8,"lockDurationAsIso8601":"lockDurationAsIso8601"},"defaultTtlAsIso8601":"defaultTtlAsIso8601","maxDeliveryCount":60}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
