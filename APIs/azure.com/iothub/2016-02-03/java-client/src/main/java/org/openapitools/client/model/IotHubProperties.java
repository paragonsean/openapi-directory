...
public class IotHubProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationPolicies, cloudToDevice, comments, enableFileUploadNotifications, eventHubEndpoints, features, hostName, ipFilterRules, messagingEndpoints, operationsMonitoringProperties, provisioningState, storageEndpoints);
  }
