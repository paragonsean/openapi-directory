# IotHubClient.FeedbackProperties
...
**maxDeliveryCount** | **Number** | The number of times the IoT hub attempts to deliver a message on the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages. | [optional] 
