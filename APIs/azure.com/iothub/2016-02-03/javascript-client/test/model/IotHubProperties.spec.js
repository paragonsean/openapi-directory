...
(function(root, factory) {
  ...
  describe('IotHubProperties', function() {
    ...
    it('should have the property operationsMonitoringProperties (base name: "operationsMonitoringProperties")', function() {
      // uncomment below and update the code to test the property operationsMonitoringProperties
      //var instance = new IotHubClient.IotHubProperties();
      //expect(instance).to.be();
    });
