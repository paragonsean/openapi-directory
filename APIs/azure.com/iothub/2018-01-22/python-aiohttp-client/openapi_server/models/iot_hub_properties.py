...
class IotHubProperties(Model):
    ...
    def __init__(self, authorization_policies: List[SharedAccessSignatureAuthorizationRule]=None, cloud_to_device: CloudToDeviceProperties=None, comments: str=None, enable_file_upload_notifications: bool=None, event_hub_endpoints: Dict[str, EventHubProperties]=None, features: str=None, host_name: str=None, ip_filter_rules: List[IpFilterRule]=None, messaging_endpoints: Dict[str, MessagingEndpointProperties]=None, operations_monitoring_properties: OperationsMonitoringProperties=None, provisioning_state: str=None, routing: RoutingProperties=None, state: str=None, storage_endpoints: Dict[str, StorageEndpointProperties]=None):
        ...
        :param operations_monitoring_properties: The operations_monitoring_properties of this IotHubProperties.
        ...
        self._operations_monitoring_properties = operations_monitoring_properties
    ...
    @property
    def operations_monitoring_properties(self):
        """Gets the operations_monitoring_properties of this IotHubProperties.


        :return: The operations_monitoring_properties of this IotHubProperties.
        :rtype: OperationsMonitoringProperties
        """
        return self._operations_monitoring_properties

    @operations_monitoring_properties.setter
    def operations_monitoring_properties(self, operations_monitoring_properties):
        """Sets the operations_monitoring_properties of this IotHubProperties.


        :param operations_monitoring_properties: The operations_monitoring_properties of this IotHubProperties.
        :type operations_monitoring_properties: OperationsMonitoringProperties
        """
