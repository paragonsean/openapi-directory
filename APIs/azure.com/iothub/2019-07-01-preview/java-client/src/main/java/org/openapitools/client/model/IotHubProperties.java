...
public class IotHubProperties {
  ...
  public static final String SERIALIZED_NAME_DEVICE_STREAMS = "deviceStreams";
  @SerializedName(SERIALIZED_NAME_DEVICE_STREAMS)
  ...
  private List<IotHubLocationDescription> locations = new ArrayList<>();
  ...
  public IotHubProperties deviceStreams(IotHubPropertiesDeviceStreams deviceStreams) {
   ...
   */
  @javax.annotation.Nullable
  public IotHubPropertiesDeviceStreams getDeviceStreams() {
    return deviceStreams;
  }

  public void setDeviceStreams(IotHubPropertiesDeviceStreams deviceStreams) {
    this.deviceStreams = deviceStreams;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<IotHubLocationDescription> getLocations() {
    return locations;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationPolicies, iotHubProperties.authorizationPolicies) &&
        ...
        Objects.equals(this.deviceStreams, iotHubProperties.deviceStreams) &&
        ...
        Objects.equals(this.locations, iotHubProperties.locations) &&
        ...
        Objects.equals(this.state, iotHubProperties.state) &&
        Objects.equals(this.storageEndpoints, iotHubProperties.storageEndpoints);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationPolicies, cloudToDevice, comments, deviceStreams, enableFileUploadNotifications, eventHubEndpoints, features, hostName, ipFilterRules, locations, messagingEndpoints, provisioningState, routing, state, storageEndpoints);
  }
  ...
  static {
    ...
    openapiFields.add("deviceStreams");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("deviceStreams") != null && !jsonObj.get("deviceStreams").isJsonNull()) {
        IotHubPropertiesDeviceStreams.validateJsonElement(jsonObj.get("deviceStreams"));
      }
      ...
      if (jsonObj.get("locations") != null && !jsonObj.get("locations").isJsonNull()) {
        ...
        if (jsonArraylocations != null) {
          ...
          for (int i = 0; i < jsonArraylocations.size(); i++) {
            IotHubLocationDescription.validateJsonElement(jsonArraylocations.get(i));
          };
        }
      }
