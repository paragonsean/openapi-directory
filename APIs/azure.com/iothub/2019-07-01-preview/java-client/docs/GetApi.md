...
<a id="iotHubResourceGetEndpointHealth"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String iotHubName = "iotHubName_example"; // String | 
    String apiVersion = "apiVersion_example"; // String | The version of the API.
    try {
      EndpointHealthDataListResult result = apiInstance.iotHubResourceGetEndpointHealth(subscriptionId, resourceGroupName, iotHubName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GetApi#iotHubResourceGetEndpointHealth");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="resourceProviderCommonGetSubscriptionQuota"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The version of the API.
    try {
      UserSubscriptionQuotaListResult result = apiInstance.resourceProviderCommonGetSubscriptionQuota(subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GetApi#resourceProviderCommonGetSubscriptionQuota");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
