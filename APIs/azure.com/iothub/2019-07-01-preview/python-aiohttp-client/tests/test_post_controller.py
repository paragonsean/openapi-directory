...
async def test_iot_hub_manual_failover(client):
    """Test case for iot_hub_manual_failover

    Manual Failover Fail over
    """
    failover_input = {"failoverRegion":"failoverRegion"}
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Devices/IotHubs/{iot_hub_name}/failover'.format(iot_hub_name='iot_hub_name_example', subscription_id='subscription_id_example', resource_group_name='resource_group_name_example'),
        headers=headers,
        json=failover_input,
        params=params,
        )
...
async def test_iot_hub_resource_test_all_routes(client):
    """Test case for iot_hub_resource_test_all_routes

    Test all routes
    """
    input = {"routingSource":"Invalid","message":{"systemProperties":{"key":"systemProperties"},"body":"body","appProperties":{"key":"appProperties"}},"twin":{"properties":{"desired":"{}","reported":"{}"},"tags":"{}"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Devices/IotHubs/{iot_hub_name}/routing/routes/$testall'.format(iot_hub_name='iot_hub_name_example', subscription_id='subscription_id_example', resource_group_name='resource_group_name_example'),
        headers=headers,
        json=input,
        params=params,
        )
...
async def test_iot_hub_resource_test_route(client):
    """Test case for iot_hub_resource_test_route

    Test the new route
    """
    input = {"route":{"condition":"condition","isEnabled":True,"name":"name","source":"Invalid","endpointNames":["endpointNames"]},"message":{"systemProperties":{"key":"systemProperties"},"body":"body","appProperties":{"key":"appProperties"}},"twin":{"properties":{"desired":"{}","reported":"{}"},"tags":"{}"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Devices/IotHubs/{iot_hub_name}/routing/routes/$testnew'.format(iot_hub_name='iot_hub_name_example', subscription_id='subscription_id_example', resource_group_name='resource_group_name_example'),
        headers=headers,
        json=input,
        params=params,
        )
