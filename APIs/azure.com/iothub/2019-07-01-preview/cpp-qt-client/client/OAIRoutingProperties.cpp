...
QList<OAIEnrichmentProperties> OAIRoutingProperties::getEnrichments() const {
    return m_enrichments;
}
void OAIRoutingProperties::setEnrichments(const QList<OAIEnrichmentProperties> &enrichments) {
    m_enrichments = enrichments;
    m_enrichments_isSet = true;
}

bool OAIRoutingProperties::is_enrichments_Set() const{
    return m_enrichments_isSet;
}

bool OAIRoutingProperties::is_enrichments_Valid() const{
