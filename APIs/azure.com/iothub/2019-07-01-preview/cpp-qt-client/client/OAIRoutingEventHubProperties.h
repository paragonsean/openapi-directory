...
/*
 * OAIRoutingEventHubProperties.h
 *
 * The properties related to an event hub endpoint.
 */

#ifndef OAIRoutingEventHubProperties_H
#define OAIRoutingEventHubProperties_H
...
class OAIRoutingEventHubProperties : public OAIObject {
public:
    OAIRoutingEventHubProperties();
    OAIRoutingEventHubProperties(QString json);
    ~OAIRoutingEventHubProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutingEventHubProperties)

#endif // OAIRoutingEventHubProperties_H
