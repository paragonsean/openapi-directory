...
import FailoverInput from '../model/FailoverInput';
...
export default class POSTApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the iotHubManualFailover operation.
     * @callback module:api/POSTApi~iotHubManualFailoverCallback
     ...
     * @param {module:model/FailoverInput} failoverInput Region to failover to. Must be a azure DR pair
     * @param {module:api/POSTApi~iotHubManualFailoverCallback} callback The callback function, accepting three arguments: error, data, response
     */
    iotHubManualFailover(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput, callback) {
      let postBody = failoverInput;
      // verify the required parameter 'iotHubName' is set
      if (iotHubName === undefined || iotHubName === null) {
        throw new Error("Missing the required parameter 'iotHubName' when calling iotHubManualFailover");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling iotHubManualFailover");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling iotHubManualFailover");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling iotHubManualFailover");
      }
      // verify the required parameter 'failoverInput' is set
      if (failoverInput === undefined || failoverInput === null) {
        throw new Error("Missing the required parameter 'failoverInput' when calling iotHubManualFailover");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{iotHubName}/failover', 'POST',
