...
class RoutingEndpoints(Model):
    ...
    def __init__(self, event_hubs: List[RoutingEventHubProperties]=None, service_bus_queues: List[RoutingServiceBusQueueEndpointProperties]=None, service_bus_topics: List[RoutingServiceBusTopicEndpointProperties]=None):
