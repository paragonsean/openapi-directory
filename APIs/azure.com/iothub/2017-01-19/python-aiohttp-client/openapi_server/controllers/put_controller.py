...
async def iot_hub_resource_create_or_update(request: web.Request, api_version, subscription_id, resource_group_name, resource_name, iot_hub_description) -> web.Response:
