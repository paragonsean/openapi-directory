...
|**eventHubEndpoints** | [**Map&lt;String, EventHubProperties&gt;**](EventHubProperties.md) | The Event Hub-compatible endpoint properties. The possible keys to this dictionary are events and operationsMonitoringEvents. Both of these keys have to be present in the dictionary while making create or update calls for the IoT hub. |  [optional] |
