...
class OAIOperationsMonitoringProperties;
...
public:
    ...
    OAIOperationsMonitoringProperties getOperationsMonitoringProperties() const;
    void setOperationsMonitoringProperties(const OAIOperationsMonitoringProperties &operations_monitoring_properties);
    bool is_operations_monitoring_properties_Set() const;
    bool is_operations_monitoring_properties_Valid() const;
...
private:
    ...
    OAIOperationsMonitoringProperties m_operations_monitoring_properties;
    bool m_operations_monitoring_properties_isSet;
    bool m_operations_monitoring_properties_isValid;
