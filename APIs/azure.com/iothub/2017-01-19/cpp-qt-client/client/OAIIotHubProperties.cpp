...
void OAIIotHubProperties::initializeModel() {
    ...
    m_operations_monitoring_properties_isSet = false;
    m_operations_monitoring_properties_isValid = false;
...
void OAIIotHubProperties::fromJsonObject(QJsonObject json) {
    ...
    m_operations_monitoring_properties_isValid = ::OpenAPI::fromJsonValue(m_operations_monitoring_properties, json[QString("operationsMonitoringProperties")]);
    m_operations_monitoring_properties_isSet = !json[QString("operationsMonitoringProperties")].isNull() && m_operations_monitoring_properties_isValid;
...
QJsonObject OAIIotHubProperties::asJsonObject() const {
    ...
    if (m_operations_monitoring_properties.isSet()) {
        obj.insert(QString("operationsMonitoringProperties"), ::OpenAPI::toJsonValue(m_operations_monitoring_properties));
    }
...
OAIOperationsMonitoringProperties OAIIotHubProperties::getOperationsMonitoringProperties() const {
    return m_operations_monitoring_properties;
}
void OAIIotHubProperties::setOperationsMonitoringProperties(const OAIOperationsMonitoringProperties &operations_monitoring_properties) {
    m_operations_monitoring_properties = operations_monitoring_properties;
    m_operations_monitoring_properties_isSet = true;
}

bool OAIIotHubProperties::is_operations_monitoring_properties_Set() const{
    return m_operations_monitoring_properties_isSet;
}

bool OAIIotHubProperties::is_operations_monitoring_properties_Valid() const{
    return m_operations_monitoring_properties_isValid;
}
