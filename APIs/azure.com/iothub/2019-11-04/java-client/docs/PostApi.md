...
public class Example {
  public static void main(String[] args) {
    ...
    String iotHubName = "iotHubName_example"; // String | Name of the IoT hub to failover
    String subscriptionId = "subscriptionId_example"; // String | The subscription identifier.
    String resourceGroupName = "resourceGroupName_example"; // String | Name of the resource group containing the IoT hub resource
    String apiVersion = "apiVersion_example"; // String | The version of the API.
    FailoverInput failoverInput = new FailoverInput(); // FailoverInput | Region to failover to. Must be the Azure paired region. Get the value from the secondary location in the locations property. To learn more, see https://aka.ms/manualfailover/region
    try {
