...
from openapi_server.models.enrichment_properties import EnrichmentProperties
...
class RoutingProperties(Model):
    ...
    def __init__(self, endpoints: RoutingEndpoints=None, enrichments: List[EnrichmentProperties]=None, fallback_route: FallbackRouteProperties=None, routes: List[RouteProperties]=None):
        """RoutingProperties - a model defined in OpenAPI

        :param endpoints: The endpoints of this RoutingProperties.
        :param enrichments: The enrichments of this RoutingProperties.
    ...
    def enrichments(self):
        """Gets the enrichments of this RoutingProperties.

        The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid

        :return: The enrichments of this RoutingProperties.
        :rtype: List[EnrichmentProperties]
        """
        return self._enrichments

    @enrichments.setter
    def enrichments(self, enrichments):
        """Sets the enrichments of this RoutingProperties.

        The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid

        :param enrichments: The enrichments of this RoutingProperties.
        :type enrichments: List[EnrichmentProperties]
        """
