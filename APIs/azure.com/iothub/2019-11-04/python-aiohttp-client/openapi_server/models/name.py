...
class Name(Model):
    ...
    def __init__(self, localized_value: str=None, value: str=None):
        ...
        :param localized_value: The localized_value of this Name.
    ...
    def localized_value(self):
        """Gets the localized_value of this Name.

        Localized value of name

        :return: The localized_value of this Name.
        :rtype: str
        """
    ...
    def localized_value(self, localized_value):
        """Sets the localized_value of this Name.
