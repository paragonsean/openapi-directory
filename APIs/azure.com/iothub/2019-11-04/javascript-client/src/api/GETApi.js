...
export default class GETApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the iotHubResourceGetEndpointHealth operation.
     * @callback module:api/GETApi~iotHubResourceGetEndpointHealthCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EndpointHealthDataListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion The version of the API.
     * @param {module:api/GETApi~iotHubResourceGetEndpointHealthCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EndpointHealthDataListResult}
     */
    iotHubResourceGetEndpointHealth(subscriptionId, resourceGroupName, iotHubName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling iotHubResourceGetEndpointHealth");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling iotHubResourceGetEndpointHealth");
      }
      // verify the required parameter 'iotHubName' is set
      if (iotHubName === undefined || iotHubName === null) {
        throw new Error("Missing the required parameter 'iotHubName' when calling iotHubResourceGetEndpointHealth");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling iotHubResourceGetEndpointHealth");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EndpointHealthDataListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{iotHubName}/routingEndpointsHealth', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the resourceProviderCommonGetSubscriptionQuota operation.
     * @callback module:api/GETApi~resourceProviderCommonGetSubscriptionQuotaCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UserSubscriptionQuotaListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription identifier.
     * @param {String} apiVersion The version of the API.
     * @param {module:api/GETApi~resourceProviderCommonGetSubscriptionQuotaCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UserSubscriptionQuotaListResult}
     */
    resourceProviderCommonGetSubscriptionQuota(subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling resourceProviderCommonGetSubscriptionQuota");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling resourceProviderCommonGetSubscriptionQuota");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UserSubscriptionQuotaListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.Devices/usages', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
