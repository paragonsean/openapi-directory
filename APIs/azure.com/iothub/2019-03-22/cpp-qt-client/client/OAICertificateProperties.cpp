...
QString OAICertificateProperties::getCertificate() const {
    return m_certificate;
}
void OAICertificateProperties::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAICertificateProperties::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAICertificateProperties::is_certificate_Valid() const{
