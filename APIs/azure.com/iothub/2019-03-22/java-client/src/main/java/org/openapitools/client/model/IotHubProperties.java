...
public class IotHubProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationPolicies, cloudToDevice, comments, enableFileUploadNotifications, eventHubEndpoints, features, hostName, ipFilterRules, locations, messagingEndpoints, provisioningState, routing, state, storageEndpoints);
  }
