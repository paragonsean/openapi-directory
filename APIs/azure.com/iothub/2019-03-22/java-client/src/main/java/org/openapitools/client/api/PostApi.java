...
import org.openapitools.client.model.FailoverInput;
...
public class PostApi {
    ...
    /**
     * Build call for iotHubManualFailover
     * @param iotHubName Name of the IoT hub to failover (required)
     * @param subscriptionId The subscription identifier. (required)
     * @param resourceGroupName Name of the resource group containing the IoT hub resource (required)
     * @param apiVersion The version of the API. (required)
     * @param failoverInput Region to failover to. Must be the Azure paired region. Get the value from the secondary location in the locations property. To learn more, see https://aka.ms/manualfailover/region (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Long running manual failover operation for the IoT hub completed </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Manual failover initiated </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> DefaultErrorResponse </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call iotHubManualFailoverCall(String iotHubName, String subscriptionId, String resourceGroupName, String apiVersion, FailoverInput failoverInput, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{iotHubName}/failover"
    ...
    private okhttp3.Call iotHubManualFailoverValidateBeforeCall(String iotHubName, String subscriptionId, String resourceGroupName, String apiVersion, FailoverInput failoverInput, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'iotHubName' is set
        if (iotHubName == null) {
            throw new ApiException("Missing the required parameter 'iotHubName' when calling iotHubManualFailover(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling iotHubManualFailover(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling iotHubManualFailover(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling iotHubManualFailover(Async)");
        }

        // verify the required parameter 'failoverInput' is set
        if (failoverInput == null) {
            throw new ApiException("Missing the required parameter 'failoverInput' when calling iotHubManualFailover(Async)");
        }

        return iotHubManualFailoverCall(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput, _callback);
     ...
     */
    public void iotHubManualFailover(String iotHubName, String subscriptionId, String resourceGroupName, String apiVersion, FailoverInput failoverInput) throws ApiException {
        iotHubManualFailoverWithHttpInfo(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput);
    }
     ...
     */
    public ApiResponse<Void> iotHubManualFailoverWithHttpInfo(String iotHubName, String subscriptionId, String resourceGroupName, String apiVersion, FailoverInput failoverInput) throws ApiException {
        okhttp3.Call localVarCall = iotHubManualFailoverValidateBeforeCall(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Manually initiate a failover for the IoT Hub to its secondary region (asynchronously)
     * Manually initiate a failover for the IoT Hub to its secondary region. To learn more, see https://aka.ms/manualfailover
     * @param iotHubName Name of the IoT hub to failover (required)
     * @param subscriptionId The subscription identifier. (required)
     * @param resourceGroupName Name of the resource group containing the IoT hub resource (required)
     ...
     */
    public okhttp3.Call iotHubManualFailoverAsync(String iotHubName, String subscriptionId, String resourceGroupName, String apiVersion, FailoverInput failoverInput, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = iotHubManualFailoverValidateBeforeCall(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput, _callback);
