...
**eventHubEndpoints** | [**{String: EventHubProperties}**](EventHubProperties.md) | The Event Hub-compatible endpoint properties. The only possible keys to this dictionary is events. This key has to be present in the dictionary while making create or update calls for the IoT hub. | [optional] 
...
**locations** | [**[IotHubLocationDescription]**](IotHubLocationDescription.md) | Primary and secondary location for iot hub | [optional] [readonly] 
