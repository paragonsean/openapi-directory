...
class OAIIotHubProperties_deviceStreams;
...
public:
    ...
    OAIIotHubProperties_deviceStreams getDeviceStreams() const;
    void setDeviceStreams(const OAIIotHubProperties_deviceStreams &device_streams);
    bool is_device_streams_Set() const;
    bool is_device_streams_Valid() const;
...
private:
    ...
    OAIIotHubProperties_deviceStreams m_device_streams;
    bool m_device_streams_isSet;
    bool m_device_streams_isValid;
