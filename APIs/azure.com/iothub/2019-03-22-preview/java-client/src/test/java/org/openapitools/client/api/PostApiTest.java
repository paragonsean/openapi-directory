...
public class PostApiTest {
     ...
     */
    @Test
    public void iotHubManualFailoverTest() throws ApiException {
        String iotHubName = null;
        String subscriptionId = null;
        String resourceGroupName = null;
        String apiVersion = null;
        FailoverInput failoverInput = null;
        api.iotHubManualFailover(iotHubName, subscriptionId, resourceGroupName, apiVersion, failoverInput);
