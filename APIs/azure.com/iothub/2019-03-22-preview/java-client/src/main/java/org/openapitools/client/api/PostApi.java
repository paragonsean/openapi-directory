...
public class PostApi {
     ...
     * @param iotHubName IotHub to fail over (required)
     ...
     * @param failoverInput Region to failover to. Must be a azure DR pair (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Long running Manual failover operation completed </td><td>  -  </td></tr>
    ...
    /**
     * Manual Failover Fail over (asynchronously)
     * Perform manual fail over of given hub
     * @param iotHubName IotHub to fail over (required)
     * @param subscriptionId The subscription identifier. (required)
     * @param resourceGroupName resource group which Iot Hub belongs to (required)
