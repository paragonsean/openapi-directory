...
import EnrichmentProperties from './EnrichmentProperties';
...
class RoutingProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('enrichments')) {
                obj['enrichments'] = ApiClient.convertToType(data['enrichments'], [EnrichmentProperties]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['enrichments']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['enrichments'])) {
                throw new Error("Expected the field `enrichments` to be an array in the JSON data but got " + data['enrichments']);
            }
            // validate the optional field `enrichments` (array)
            for (const item of data['enrichments']) {
                EnrichmentProperties.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/EnrichmentProperties>} enrichments
 */
RoutingProperties.prototype['enrichments'] = undefined;
