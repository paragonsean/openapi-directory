...
let iotHubName = "iotHubName_example"; // String | IotHub to fail over
...
let failoverInput = new IotHubClient.FailoverInput(); // FailoverInput | Region to failover to. Must be a azure DR pair
