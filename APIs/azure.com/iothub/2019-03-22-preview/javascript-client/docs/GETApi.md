...
[**iotHubResourceGetEndpointHealth**](GETApi.md#iotHubResourceGetEndpointHealth) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/IotHubs/{iotHubName}/routingEndpointsHealth | Get the health for routing endpoints
...
[**resourceProviderCommonGetSubscriptionQuota**](GETApi.md#resourceProviderCommonGetSubscriptionQuota) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Devices/usages | Get the number of iot hubs in the subscription
...
> EndpointHealthDataListResult iotHubResourceGetEndpointHealth(subscriptionId, resourceGroupName, iotHubName, apiVersion)
...
let iotHubName = "iotHubName_example"; // String | 
let apiVersion = "apiVersion_example"; // String | The version of the API.
apiInstance.iotHubResourceGetEndpointHealth(subscriptionId, resourceGroupName, iotHubName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**EndpointHealthDataListResult**](EndpointHealthDataListResult.md)
...
> UserSubscriptionQuotaListResult resourceProviderCommonGetSubscriptionQuota(subscriptionId, apiVersion)
...
let subscriptionId = "subscriptionId_example"; // String | The subscription identifier.
let apiVersion = "apiVersion_example"; // String | The version of the API.
apiInstance.resourceProviderCommonGetSubscriptionQuota(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**UserSubscriptionQuotaListResult**](UserSubscriptionQuotaListResult.md)
