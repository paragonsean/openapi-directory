...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotHubClient.RoutingEventHubProperties();
  });
  ...
  describe('RoutingEventHubProperties', function() {
    it('should create an instance of RoutingEventHubProperties', function() {
      // uncomment below and update the code to test RoutingEventHubProperties
      //var instance = new IotHubClient.RoutingEventHubProperties();
      //expect(instance).to.be.a(IotHubClient.RoutingEventHubProperties);
    });
