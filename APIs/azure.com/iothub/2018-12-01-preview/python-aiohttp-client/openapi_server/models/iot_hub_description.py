...
class IotHubDescription(Model):
    ...
    def __init__(self, etag: str=None, properties: IotHubProperties=None, sku: IotHubSkuInfo=None, id: str=None, location: str=None, name: str=None, tags: Dict[str, str]=None, type: str=None):
