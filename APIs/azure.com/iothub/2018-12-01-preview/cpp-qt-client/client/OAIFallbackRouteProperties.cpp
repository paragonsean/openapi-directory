...
QString OAIFallbackRouteProperties::getName() const {
    return m_name;
}
void OAIFallbackRouteProperties::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFallbackRouteProperties::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFallbackRouteProperties::is_name_Valid() const{
