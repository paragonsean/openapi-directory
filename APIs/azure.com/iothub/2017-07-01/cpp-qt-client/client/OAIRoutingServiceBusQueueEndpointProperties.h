...
/*
 * OAIRoutingServiceBusQueueEndpointProperties.h
 *
 * The properties related to service bus queue endpoint types.
 */

#ifndef OAIRoutingServiceBusQueueEndpointProperties_H
#define OAIRoutingServiceBusQueueEndpointProperties_H
...
class OAIRoutingServiceBusQueueEndpointProperties : public OAIObject {
public:
    OAIRoutingServiceBusQueueEndpointProperties();
    OAIRoutingServiceBusQueueEndpointProperties(QString json);
    ~OAIRoutingServiceBusQueueEndpointProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutingServiceBusQueueEndpointProperties)

#endif // OAIRoutingServiceBusQueueEndpointProperties_H
