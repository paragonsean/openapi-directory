...
> IotHubDescription iotHubResourceCreateOrUpdate(apiVersion, subscriptionId, resourceGroupName, resourceName, iotHubDescription, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ifMatch = "ifMatch_example"; // String | ETag of the IoT Hub. Do not specify for creating a brand new IoT Hub. Required to update an existing IoT Hub.
    try {
      IotHubDescription result = apiInstance.iotHubResourceCreateOrUpdate(apiVersion, subscriptionId, resourceGroupName, resourceName, iotHubDescription, ifMatch);
      System.out.println(result);
    } catch (ApiException e) {
