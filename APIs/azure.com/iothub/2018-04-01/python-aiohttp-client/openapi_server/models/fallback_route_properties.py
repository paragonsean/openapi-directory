...
class FallbackRouteProperties(Model):
    ...
    def __init__(self, condition: str=None, endpoint_names: List[str]=None, is_enabled: bool=None, name: str=None, source: str=None):
        ...
        :param name: The name of this FallbackRouteProperties.
    ...
    @property
    def name(self):
        """Gets the name of this FallbackRouteProperties.

        The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.

        :return: The name of this FallbackRouteProperties.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FallbackRouteProperties.
