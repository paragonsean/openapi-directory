...
async def test_iot_hub_resource_test_all_routes(client):
    ...
    Test all routes
    """
    input = {"routingSource":"Invalid","message":{"systemProperties":{"key":"systemProperties"},"body":"body","appProperties":{"key":"appProperties"}},"twin":{"properties":{"desiredProperties":"{}","reportedProperties":"{}"},"tags":"{}"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_iot_hub_resource_test_route(client):
    ...
    Test the new route
    """
    input = {"route":{"condition":"condition","isEnabled":True,"name":"name","source":"Invalid","endpointNames":["endpointNames"]},"message":{"systemProperties":{"key":"systemProperties"},"body":"body","appProperties":{"key":"appProperties"}},"twin":{"properties":{"desiredProperties":"{}","reportedProperties":"{}"},"tags":"{}"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
