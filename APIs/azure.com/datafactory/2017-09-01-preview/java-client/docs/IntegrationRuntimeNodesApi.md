...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IntegrationRuntimeNodesUpdate200Response result = apiInstance.integrationRuntimeNodesUpdate(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, nodeName, apiVersion, updateIntegrationRuntimeNodeRequest);
      System.out.println(result);
    } catch (ApiException e) {
