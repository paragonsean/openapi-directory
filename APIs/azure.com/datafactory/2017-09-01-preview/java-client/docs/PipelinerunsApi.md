...
<a id="factoriesCancelPipelineRun"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.factoriesCancelPipelineRun(subscriptionId, resourceGroupName, factoryName, runId, apiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling PipelinerunsApi#factoriesCancelPipelineRun");
...
public class Example {
  public static void main(String[] args) {
    ...
    String factoryName = "factoryName_example"; // String | The factory name.
    String apiVersion = "apiVersion_example"; // String | The API version.
    PipelineRunFilterParameters filterParameters = new PipelineRunFilterParameters(); // PipelineRunFilterParameters | Parameters to filter the pipeline run.
    try {
      PipelineRunQueryResponse result = apiInstance.pipelineRunsQueryByFactory(subscriptionId, resourceGroupName, factoryName, apiVersion, filterParameters);
      System.out.println(result);
    } catch (ApiException e) {
