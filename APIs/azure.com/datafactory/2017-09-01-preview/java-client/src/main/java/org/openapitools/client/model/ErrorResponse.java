...
public class ErrorResponse {
  ...
  public ErrorResponse details(List<ErrorResponse> details) {
    this.details = details;
    return this;
  }

  public ErrorResponse addDetailsItem(ErrorResponse detailsItem) {
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ErrorResponse.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
