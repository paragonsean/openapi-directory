...
public class IntegrationRuntimeNodesApi {
     ...
     */
    public IntegrationRuntimeNodesUpdate200Response integrationRuntimeNodesUpdate(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String nodeName, String apiVersion, UpdateIntegrationRuntimeNodeRequest updateIntegrationRuntimeNodeRequest) throws ApiException {
        ApiResponse<IntegrationRuntimeNodesUpdate200Response> localVarResp = integrationRuntimeNodesUpdateWithHttpInfo(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, nodeName, apiVersion, updateIntegrationRuntimeNodeRequest);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion The API version. (required)
     * @param updateIntegrationRuntimeNodeRequest The parameters for updating an integration runtime node. (required)
     * @return ApiResponse&lt;IntegrationRuntimeNodesUpdate200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IntegrationRuntimeNodesUpdate200Response> integrationRuntimeNodesUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String nodeName, String apiVersion, UpdateIntegrationRuntimeNodeRequest updateIntegrationRuntimeNodeRequest) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<IntegrationRuntimeNodesUpdate200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call integrationRuntimeNodesUpdateAsync(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String nodeName, String apiVersion, UpdateIntegrationRuntimeNodeRequest updateIntegrationRuntimeNodeRequest, final ApiCallback<IntegrationRuntimeNodesUpdate200Response> _callback) throws ApiException {
