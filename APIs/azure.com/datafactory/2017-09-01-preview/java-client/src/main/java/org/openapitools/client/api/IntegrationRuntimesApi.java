...
public class IntegrationRuntimesApi {
     ...
     */
    public okhttp3.Call integrationRuntimesGetCall(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call integrationRuntimesGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return integrationRuntimesGetCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, _callback);
     ...
     */
    public IntegrationRuntimeResource integrationRuntimesGet(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion) throws ApiException {
        ApiResponse<IntegrationRuntimeResource> localVarResp = integrationRuntimesGetWithHttpInfo(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IntegrationRuntimeResource> integrationRuntimesGetWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = integrationRuntimesGetValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, null);
        Type localVarReturnType = new TypeToken<IntegrationRuntimeResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call integrationRuntimesGetAsync(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, final ApiCallback<IntegrationRuntimeResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = integrationRuntimesGetValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<IntegrationRuntimeResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for integrationRuntimesRemoveNode
     * @param subscriptionId The subscription identifier. (required)
     * @param resourceGroupName The resource group name. (required)
     * @param factoryName The factory name. (required)
     * @param integrationRuntimeName The integration runtime name. (required)
     * @param apiVersion The API version. (required)
     * @param removeNodeParameters The name of the node to be removed from an integration runtime. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call integrationRuntimesRemoveNodeCall(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, IntegrationRuntimesRemoveNodeRequest removeNodeParameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = removeNodeParameters;

        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/integrationRuntimes/{integrationRuntimeName}/removeNode"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "factoryName" + "}", localVarApiClient.escapeString(factoryName.toString()))
            .replace("{" + "integrationRuntimeName" + "}", localVarApiClient.escapeString(integrationRuntimeName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call integrationRuntimesRemoveNodeValidateBeforeCall(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, IntegrationRuntimesRemoveNodeRequest removeNodeParameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling integrationRuntimesRemoveNode(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling integrationRuntimesRemoveNode(Async)");
        }

        // verify the required parameter 'factoryName' is set
        if (factoryName == null) {
            throw new ApiException("Missing the required parameter 'factoryName' when calling integrationRuntimesRemoveNode(Async)");
        }

        // verify the required parameter 'integrationRuntimeName' is set
        if (integrationRuntimeName == null) {
            throw new ApiException("Missing the required parameter 'integrationRuntimeName' when calling integrationRuntimesRemoveNode(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling integrationRuntimesRemoveNode(Async)");
        }

        // verify the required parameter 'removeNodeParameters' is set
        if (removeNodeParameters == null) {
            throw new ApiException("Missing the required parameter 'removeNodeParameters' when calling integrationRuntimesRemoveNode(Async)");
        }

        return integrationRuntimesRemoveNodeCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, removeNodeParameters, _callback);
     ...
     */
    public void integrationRuntimesRemoveNode(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, IntegrationRuntimesRemoveNodeRequest removeNodeParameters) throws ApiException {
        integrationRuntimesRemoveNodeWithHttpInfo(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, removeNodeParameters);
    }
     ...
     */
    public ApiResponse<Void> integrationRuntimesRemoveNodeWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, IntegrationRuntimesRemoveNodeRequest removeNodeParameters) throws ApiException {
        okhttp3.Call localVarCall = integrationRuntimesRemoveNodeValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, removeNodeParameters, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call integrationRuntimesRemoveNodeAsync(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, IntegrationRuntimesRemoveNodeRequest removeNodeParameters, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = integrationRuntimesRemoveNodeValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, removeNodeParameters, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public IntegrationRuntimeStatusResponse integrationRuntimesUpdate(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, UpdateIntegrationRuntimeRequest updateIntegrationRuntimeRequest) throws ApiException {
        ApiResponse<IntegrationRuntimeStatusResponse> localVarResp = integrationRuntimesUpdateWithHttpInfo(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, apiVersion, updateIntegrationRuntimeRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IntegrationRuntimeStatusResponse> integrationRuntimesUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String integrationRuntimeName, String apiVersion, UpdateIntegrationRuntimeRequest updateIntegrationRuntimeRequest) throws ApiException {
