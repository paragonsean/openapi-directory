...
public class PipelinesApi {
     ...
     * @param pipelineName The pipeline name. (required)
     * @param apiVersion The API version. (required)
     * @param parameters Parameters of the pipeline run. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call pipelinesCreateRunCall(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, Map<String, Object> parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pipelinesCreateRunValidateBeforeCall(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, Map<String, Object> parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return pipelinesCreateRunCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, parameters, _callback);
     ...
     */
    public CreateRunResponse pipelinesCreateRun(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, Map<String, Object> parameters) throws ApiException {
        ApiResponse<CreateRunResponse> localVarResp = pipelinesCreateRunWithHttpInfo(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateRunResponse> pipelinesCreateRunWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, Map<String, Object> parameters) throws ApiException {
        okhttp3.Call localVarCall = pipelinesCreateRunValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, parameters, null);
     ...
     */
    public okhttp3.Call pipelinesCreateRunAsync(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, Map<String, Object> parameters, final ApiCallback<CreateRunResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = pipelinesCreateRunValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<CreateRunResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call pipelinesGetCall(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pipelinesGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return pipelinesGetCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, _callback);
     ...
     */
    public PipelineResource pipelinesGet(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion) throws ApiException {
        ApiResponse<PipelineResource> localVarResp = pipelinesGetWithHttpInfo(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PipelineResource> pipelinesGetWithHttpInfo(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = pipelinesGetValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, null);
        Type localVarReturnType = new TypeToken<PipelineResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call pipelinesGetAsync(String subscriptionId, String resourceGroupName, String factoryName, String pipelineName, String apiVersion, final ApiCallback<PipelineResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = pipelinesGetValidateBeforeCall(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<PipelineResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
