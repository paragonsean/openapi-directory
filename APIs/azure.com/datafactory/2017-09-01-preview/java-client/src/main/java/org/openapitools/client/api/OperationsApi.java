...
public class OperationsApi {
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.DataFactory/operations";
     ...
     */
    public OperationListResponse operationsList(String apiVersion) throws ApiException {
        ApiResponse<OperationListResponse> localVarResp = operationsListWithHttpInfo(apiVersion);
     ...
     * Lists the available Azure Data Factory API operations.
     * @param apiVersion The API version. (required)
     * @return ApiResponse&lt;OperationListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<OperationListResponse> operationsListWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = operationsListValidateBeforeCall(apiVersion, null);
        Type localVarReturnType = new TypeToken<OperationListResponse>(){}.getType();
     ...
     */
    public okhttp3.Call operationsListAsync(String apiVersion, final ApiCallback<OperationListResponse> _callback) throws ApiException {
