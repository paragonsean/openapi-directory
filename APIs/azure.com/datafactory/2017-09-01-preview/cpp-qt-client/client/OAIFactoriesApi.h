...
public:
    ...
    */
    virtual void factoriesCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &factory_name, const QString &api_version, const OAIFactory &factory);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void factoriesGet(const QString &subscription_id, const QString &resource_group_name, const QString &factory_name, const QString &api_version);
