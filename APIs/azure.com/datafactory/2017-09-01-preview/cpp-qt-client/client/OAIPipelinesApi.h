...
public:
    ...
    */
    virtual void pipelinesCreateRun(const QString &subscription_id, const QString &resource_group_name, const QString &factory_name, const QString &pipeline_name, const QString &api_version, const ::OpenAPI::OptionalParam<QMap<QString, OAIObject>> &parameters = ::OpenAPI::OptionalParam<QMap<QString, OAIObject>>());
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void pipelinesGet(const QString &subscription_id, const QString &resource_group_name, const QString &factory_name, const QString &pipeline_name, const QString &api_version);
