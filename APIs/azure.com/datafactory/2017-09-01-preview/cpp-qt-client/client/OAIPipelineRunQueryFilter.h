...
/*
 * OAIPipelineRunQueryFilter.h
 *
 * Query filter option for listing pipeline runs.
 */

#ifndef OAIPipelineRunQueryFilter_H
#define OAIPipelineRunQueryFilter_H
...
class OAIPipelineRunQueryFilter : public OAIObject {
public:
    OAIPipelineRunQueryFilter();
    OAIPipelineRunQueryFilter(QString json);
    ~OAIPipelineRunQueryFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineRunQueryFilter)

#endif // OAIPipelineRunQueryFilter_H
