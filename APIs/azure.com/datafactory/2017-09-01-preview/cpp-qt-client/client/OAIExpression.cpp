...
QString OAIExpression::getType() const {
    return m_type;
}
void OAIExpression::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExpression::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExpression::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIExpression::getValue() const {
    return m_value;
}
void OAIExpression::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}
