...
class OperationMetricSpecification(Model):
    ...
    def __init__(self, aggregation_type: str=None, availabilities: List[OperationMetricAvailability]=None, display_description: str=None, display_name: str=None, enable_regional_mdm_account: str=None, name: str=None, source_mdm_account: str=None, source_mdm_namespace: str=None, unit: str=None):
