...
class PipelineRun(Model):
    ...
    def __init__(self, duration_in_ms: int=None, invoked_by: PipelineRunInvokedBy=None, last_updated: datetime=None, message: str=None, parameters: Dict[str, str]=None, pipeline_name: str=None, run_end: datetime=None, run_id: str=None, run_start: datetime=None, status: str=None):
