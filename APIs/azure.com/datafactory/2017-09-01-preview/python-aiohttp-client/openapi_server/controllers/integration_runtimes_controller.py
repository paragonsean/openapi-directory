...
async def integration_runtimes_get(request: web.Request, subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version) -> web.Response:
...
async def integration_runtimes_remove_node(request: web.Request, subscription_id, resource_group_name, factory_name, integration_runtime_name, api_version, remove_node_parameters) -> web.Response:
    ...
    :param api_version: The API version.
    :type api_version: str
    :param remove_node_parameters: The name of the node to be removed from an integration runtime.
    :type remove_node_parameters: dict | bytes

    """
    remove_node_parameters = IntegrationRuntimesRemoveNodeRequest.from_dict(remove_node_parameters)
    return web.Response(status=200)
