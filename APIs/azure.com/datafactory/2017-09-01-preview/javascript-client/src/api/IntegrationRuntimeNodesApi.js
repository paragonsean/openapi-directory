...
export default class IntegrationRuntimeNodesApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationRuntimeNodesUpdate200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/IntegrationRuntimeNodesUpdate200Response}
     */
    integrationRuntimeNodesUpdate(subscriptionId, resourceGroupName, factoryName, integrationRuntimeName, nodeName, apiVersion, updateIntegrationRuntimeNodeRequest, callback) {
      ...
      let accepts = ['application/json'];
      let returnType = IntegrationRuntimeNodesUpdate200Response;
      return this.apiClient.callApi(
