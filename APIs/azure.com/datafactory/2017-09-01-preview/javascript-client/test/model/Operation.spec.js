...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new DataFactoryManagementClient.Operation();
      //expect(instance).to.be.a(DataFactoryManagementClient.Operation);
    });
