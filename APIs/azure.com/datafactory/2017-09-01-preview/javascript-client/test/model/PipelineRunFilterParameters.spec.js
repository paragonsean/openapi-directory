...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.PipelineRunFilterParameters();
  });
  ...
  describe('PipelineRunFilterParameters', function() {
    it('should create an instance of PipelineRunFilterParameters', function() {
      // uncomment below and update the code to test PipelineRunFilterParameters
      //var instance = new DataFactoryManagementClient.PipelineRunFilterParameters();
      //expect(instance).to.be.a(DataFactoryManagementClient.PipelineRunFilterParameters);
    });
