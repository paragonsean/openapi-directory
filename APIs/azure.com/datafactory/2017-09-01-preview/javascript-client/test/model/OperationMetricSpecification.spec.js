...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.OperationMetricSpecification();
  });
  ...
  describe('OperationMetricSpecification', function() {
    it('should create an instance of OperationMetricSpecification', function() {
      // uncomment below and update the code to test OperationMetricSpecification
      //var instance = new DataFactoryManagementClient.OperationMetricSpecification();
      //expect(instance).to.be.a(DataFactoryManagementClient.OperationMetricSpecification);
    });
