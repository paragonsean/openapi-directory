...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.PipelineRunQueryFilter();
  });
  ...
  describe('PipelineRunQueryFilter', function() {
    it('should create an instance of PipelineRunQueryFilter', function() {
      // uncomment below and update the code to test PipelineRunQueryFilter
      //var instance = new DataFactoryManagementClient.PipelineRunQueryFilter();
      //expect(instance).to.be.a(DataFactoryManagementClient.PipelineRunQueryFilter);
    });
