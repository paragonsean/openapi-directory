...
class TriggerRun(Model):
    ...
    def __init__(self, dependency_status: Dict[str, object]=None, message: str=None, properties: Dict[str, str]=None, run_dimension: Dict[str, str]=None, status: str=None, trigger_name: str=None, trigger_run_id: str=None, trigger_run_timestamp: datetime=None, trigger_type: str=None, triggered_pipelines: Dict[str, str]=None):
        """TriggerRun - a model defined in OpenAPI

        :param dependency_status: The dependency_status of this TriggerRun.
        :param message: The message of this TriggerRun.
        :param properties: The properties of this TriggerRun.
        :param run_dimension: The run_dimension of this TriggerRun.
        ...
        self._run_dimension = run_dimension
        self._status = status
    ...
    def dependency_status(self):
        """Gets the dependency_status of this TriggerRun.

        Status of the upstream pipelines.

        :return: The dependency_status of this TriggerRun.
        :rtype: Dict[str, object]
        """
        return self._dependency_status

    @dependency_status.setter
    def dependency_status(self, dependency_status):
        """Sets the dependency_status of this TriggerRun.

        Status of the upstream pipelines.

        :param dependency_status: The dependency_status of this TriggerRun.
        :type dependency_status: Dict[str, object]
        """
    ...
    def run_dimension(self):
        """Gets the run_dimension of this TriggerRun.

        Run dimension for which trigger was fired.

        :return: The run_dimension of this TriggerRun.
        :rtype: Dict[str, str]
        """
        return self._run_dimension

    @run_dimension.setter
    def run_dimension(self, run_dimension):
        """Sets the run_dimension of this TriggerRun.

        Run dimension for which trigger was fired.

        :param run_dimension: The run_dimension of this TriggerRun.
        :type run_dimension: Dict[str, str]
        """
