...
async def test_integration_runtimes_create_linked_integration_runtime(client):
    """Test case for integration_runtimes_create_linked_integration_runtime

    
    """
    create_linked_integration_runtime_request = {"dataFactoryLocation":"dataFactoryLocation","dataFactoryName":"dataFactoryName","name":"name","subscriptionId":"subscriptionId"}
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DataFactory/factories/{factory_name}/integrationRuntimes/{integration_runtime_name}/linkedIntegrationRuntime'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', factory_name='factory_name_example', integration_runtime_name='integration_runtime_name_example'),
        headers=headers,
        json=create_linked_integration_runtime_request,
        params=params,
        )
...
async def test_integration_runtimes_remove_links(client):
    """Test case for integration_runtimes_remove_links

    
    """
    linked_integration_runtime_request = {"factoryName":"factoryName"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.DataFactory/factories/{factory_name}/integrationRuntimes/{integration_runtime_name}/removeLinks'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', factory_name='factory_name_example', integration_runtime_name='integration_runtime_name_example'),
        headers=headers,
        json=linked_integration_runtime_request,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
