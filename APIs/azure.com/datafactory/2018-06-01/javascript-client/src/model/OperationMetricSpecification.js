...
import OperationMetricDimension from './OperationMetricDimension';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dimensions')) {
                obj['dimensions'] = ApiClient.convertToType(data['dimensions'], [OperationMetricDimension]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['dimensions']) { // data not null
            ...
            for (const item of data['dimensions']) {
                OperationMetricDimension.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/OperationMetricDimension>} dimensions
 */
OperationMetricSpecification.prototype['dimensions'] = undefined;
