...
class PipelineRun {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('runDimensions')) {
                obj['runDimensions'] = ApiClient.convertToType(data['runDimensions'], {'String': 'String'});
            }
 ...
 */
PipelineRun.prototype['isLatest'] = undefined;
 ...
 * @member {Object.<String, String>} runDimensions
 */
PipelineRun.prototype['runDimensions'] = undefined;
 ...
 */
PipelineRun.prototype['runGroupId'] = undefined;
