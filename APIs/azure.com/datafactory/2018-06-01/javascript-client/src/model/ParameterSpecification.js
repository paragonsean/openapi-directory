...
class ParameterSpecification {
     ...
     * @param type {module:model/ParameterSpecification.TypeEnum} Parameter type.
     */
    constructor(type) { 
        
        ParameterSpecification.initialize(this, type);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ParameterSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ParameterSpecification.RequiredProperties) {
...
ParameterSpecification.RequiredProperties = ["type"];

/**
 * Default value of parameter.
 * @member {Object} defaultValue
 */
ParameterSpecification.prototype['defaultValue'] = undefined;
