...
class CloudError {
     ...
     * @param error {module:model/CloudErrorBody} 
     */
    constructor(error) { 
        
        CloudError.initialize(this, error);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CloudError.RequiredProperties) {
...
CloudError.RequiredProperties = ["error"];
