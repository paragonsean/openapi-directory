...
export default class PipelinesApi {
    ...
    */
     ...
     * @param {Object.<String, {String: Object}>} [parameters] Parameters of the pipeline run. These parameters will be used only if the runId is not specified.
    ...
    pipelinesCreateRun(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, opts, callback) {
      ...
      let queryParams = {
        'api-version': apiVersion,
        'referencePipelineRunId': opts['referencePipelineRunId'],
        'isRecovery': opts['isRecovery'],
        'startActivityName': opts['startActivityName']
      };
      let headerParams = {
      };
      let formParams = {
     ...
     * @param {String} apiVersion The API version.
     * @param {Object} opts Optional parameters
     * @param {String} [ifNoneMatch] ETag of the pipeline entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned.
     ...
     * data is of type: {@link module:model/PipelineResource}
     */
    pipelinesGet(subscriptionId, resourceGroupName, factoryName, pipelineName, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
