...
export default class LinkedServicesApi {
    ...
    */
     ...
     * @param {String} apiVersion The API version.
     * @param {Object} opts Optional parameters
     * @param {String} [ifNoneMatch] ETag of the linked service entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned.
     ...
     * data is of type: {@link module:model/LinkedServiceResource}
     */
    linkedServicesGet(subscriptionId, resourceGroupName, factoryName, linkedServiceName, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
