...
(function(root, factory) {
  ...
  describe('IntegrationRuntimesApi', function() {
    describe('integrationRuntimesCreateLinkedIntegrationRuntime', function() {
      it('should call integrationRuntimesCreateLinkedIntegrationRuntime successfully', function(done) {
        //uncomment below and update the code to test integrationRuntimesCreateLinkedIntegrationRuntime
        //instance.integrationRuntimesCreateLinkedIntegrationRuntime(function(error) {
    ...
    describe('integrationRuntimesRemoveLinks', function() {
      it('should call integrationRuntimesRemoveLinks successfully', function(done) {
        //uncomment below and update the code to test integrationRuntimesRemoveLinks
        //instance.integrationRuntimesRemoveLinks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
