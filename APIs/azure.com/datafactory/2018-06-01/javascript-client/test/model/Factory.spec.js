...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.Factory();
  });
  ...
  describe('Factory', function() {
    it('should create an instance of Factory', function() {
      // uncomment below and update the code to test Factory
      //var instance = new DataFactoryManagementClient.Factory();
      //expect(instance).to.be.a(DataFactoryManagementClient.Factory);
    });
