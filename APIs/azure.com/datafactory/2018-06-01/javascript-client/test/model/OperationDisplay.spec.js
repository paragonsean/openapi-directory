...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new DataFactoryManagementClient.OperationDisplay();
      //expect(instance).to.be.a(DataFactoryManagementClient.OperationDisplay);
    });
