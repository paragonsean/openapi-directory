...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataFactoryManagementClient.RunQueryFilter();
  });
  ...
  describe('RunQueryFilter', function() {
    it('should create an instance of RunQueryFilter', function() {
      // uncomment below and update the code to test RunQueryFilter
      //var instance = new DataFactoryManagementClient.RunQueryFilter();
      //expect(instance).to.be.a(DataFactoryManagementClient.RunQueryFilter);
    });
