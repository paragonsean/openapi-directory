...
> TriggerResource triggersGet(subscriptionId, resourceGroupName, factoryName, triggerName, apiVersion, opts)
...
let opts = {
  'ifNoneMatch': "ifNoneMatch_example" // String | ETag of the trigger entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned.
};
apiInstance.triggersGet(subscriptionId, resourceGroupName, factoryName, triggerName, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **ifNoneMatch** | **String**| ETag of the trigger entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned. | [optional] 
