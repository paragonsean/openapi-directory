...
<a id="triggersGet"></a>
# **triggersGet**
> TriggerResource triggersGet(subscriptionId, resourceGroupName, factoryName, triggerName, apiVersion, ifNoneMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ifNoneMatch = "ifNoneMatch_example"; // String | ETag of the trigger entity. Should only be specified for get. If the ETag matches the existing entity tag, or if * was provided, then no content will be returned.
    try {
      TriggerResource result = apiInstance.triggersGet(subscriptionId, resourceGroupName, factoryName, triggerName, apiVersion, ifNoneMatch);
