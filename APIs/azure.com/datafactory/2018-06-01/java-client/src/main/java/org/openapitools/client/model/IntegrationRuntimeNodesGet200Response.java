...
public class IntegrationRuntimeNodesGet200Response {
  ...
  public IntegrationRuntimeNodesGet200Response() {
  }
   ...
   * @return the IntegrationRuntimeNodesGet200Response instance itself
   */
  public IntegrationRuntimeNodesGet200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IntegrationRuntimeNodesGet200Response integrationRuntimeNodesGet200Response = (IntegrationRuntimeNodesGet200Response) o;
    return Objects.equals(this.capabilities, integrationRuntimeNodesGet200Response.capabilities) &&
        Objects.equals(this.concurrentJobsLimit, integrationRuntimeNodesGet200Response.concurrentJobsLimit) &&
        Objects.equals(this.expiryTime, integrationRuntimeNodesGet200Response.expiryTime) &&
        Objects.equals(this.hostServiceUri, integrationRuntimeNodesGet200Response.hostServiceUri) &&
        Objects.equals(this.isActiveDispatcher, integrationRuntimeNodesGet200Response.isActiveDispatcher) &&
        Objects.equals(this.lastConnectTime, integrationRuntimeNodesGet200Response.lastConnectTime) &&
        Objects.equals(this.lastEndUpdateTime, integrationRuntimeNodesGet200Response.lastEndUpdateTime) &&
        Objects.equals(this.lastStartTime, integrationRuntimeNodesGet200Response.lastStartTime) &&
        Objects.equals(this.lastStartUpdateTime, integrationRuntimeNodesGet200Response.lastStartUpdateTime) &&
        Objects.equals(this.lastStopTime, integrationRuntimeNodesGet200Response.lastStopTime) &&
        Objects.equals(this.lastUpdateResult, integrationRuntimeNodesGet200Response.lastUpdateResult) &&
        Objects.equals(this.machineName, integrationRuntimeNodesGet200Response.machineName) &&
        Objects.equals(this.maxConcurrentJobs, integrationRuntimeNodesGet200Response.maxConcurrentJobs) &&
        Objects.equals(this.nodeName, integrationRuntimeNodesGet200Response.nodeName) &&
        Objects.equals(this.registerTime, integrationRuntimeNodesGet200Response.registerTime) &&
        Objects.equals(this.status, integrationRuntimeNodesGet200Response.status) &&
        Objects.equals(this.version, integrationRuntimeNodesGet200Response.version) &&
        Objects.equals(this.versionStatus, integrationRuntimeNodesGet200Response.versionStatus)&&
        Objects.equals(this.additionalProperties, integrationRuntimeNodesGet200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegrationRuntimeNodesGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegrationRuntimeNodesGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegrationRuntimeNodesGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntegrationRuntimeNodesGet200Response is not found in the empty JSON string", IntegrationRuntimeNodesGet200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegrationRuntimeNodesGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegrationRuntimeNodesGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegrationRuntimeNodesGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegrationRuntimeNodesGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegrationRuntimeNodesGet200Response>() {
           @Override
           public void write(JsonWriter out, IntegrationRuntimeNodesGet200Response value) throws IOException {
           ...
           @Override
           public IntegrationRuntimeNodesGet200Response read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IntegrationRuntimeNodesGet200Response instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IntegrationRuntimeNodesGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegrationRuntimeNodesGet200Response
   * @throws IOException if the JSON string is invalid with respect to IntegrationRuntimeNodesGet200Response
   */
  public static IntegrationRuntimeNodesGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegrationRuntimeNodesGet200Response.class);
  }

  /**
   * Convert an instance of IntegrationRuntimeNodesGet200Response to an JSON string
   *
   * @return JSON string
   */
