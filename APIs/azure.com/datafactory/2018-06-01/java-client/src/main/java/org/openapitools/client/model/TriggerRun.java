...
public class TriggerRun {
  ...
  private Map<String, Object> dependencyStatus = new HashMap<>();
  ...
  public static final String SERIALIZED_NAME_RUN_DIMENSION = "runDimension";
  @SerializedName(SERIALIZED_NAME_RUN_DIMENSION)
  private Map<String, String> runDimension = new HashMap<>();
  ...
  public Map<String, Object> getDependencyStatus() {
    return dependencyStatus;
  }
   ...
   */
  @javax.annotation.Nullable
  public Map<String, String> getRunDimension() {
    return runDimension;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dependencyStatus, triggerRun.dependencyStatus) &&
        Objects.equals(this.message, triggerRun.message) &&
        Objects.equals(this.properties, triggerRun.properties) &&
        Objects.equals(this.runDimension, triggerRun.runDimension) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dependencyStatus, message, properties, runDimension, status, triggerName, triggerRunId, triggerRunTimestamp, triggerType, triggeredPipelines, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    runDimension: ").append(toIndentedString(runDimension)).append("\n");
  ...
  static {
    ...
    openapiFields.add("runDimension");
