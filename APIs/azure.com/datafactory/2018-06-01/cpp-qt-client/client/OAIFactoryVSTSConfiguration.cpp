...
QString OAIFactoryVSTSConfiguration::getType() const {
    return m_type;
}
void OAIFactoryVSTSConfiguration::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFactoryVSTSConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFactoryVSTSConfiguration::is_type_Valid() const{
...
bool OAIFactoryVSTSConfiguration::isValid() const {
    ...
    return m_project_name_isValid && m_account_name_isValid && m_collaboration_branch_isValid && m_repository_name_isValid && m_root_folder_isValid && m_type_isValid && true;
}
