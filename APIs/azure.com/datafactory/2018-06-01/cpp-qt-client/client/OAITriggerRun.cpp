...
void OAITriggerRun::initializeModel() {
    ...
    m_dependency_status_isSet = false;
    m_dependency_status_isValid = false;
    ...
    m_run_dimension_isSet = false;
    m_run_dimension_isValid = false;
...
void OAITriggerRun::fromJsonObject(QJsonObject json) {
    ...
    m_dependency_status_isValid = ::OpenAPI::fromJsonValue(m_dependency_status, json[QString("dependencyStatus")]);
    m_dependency_status_isSet = !json[QString("dependencyStatus")].isNull() && m_dependency_status_isValid;
    ...
    m_run_dimension_isValid = ::OpenAPI::fromJsonValue(m_run_dimension, json[QString("runDimension")]);
    m_run_dimension_isSet = !json[QString("runDimension")].isNull() && m_run_dimension_isValid;
...
QJsonObject OAITriggerRun::asJsonObject() const {
    QJsonObject obj;
    if (m_dependency_status.size() > 0) {
        obj.insert(QString("dependencyStatus"), ::OpenAPI::toJsonValue(m_dependency_status));
    }
    if (m_message_isSet) {
    ...
    if (m_run_dimension.size() > 0) {
        obj.insert(QString("runDimension"), ::OpenAPI::toJsonValue(m_run_dimension));
    }
    if (m_status_isSet) {
...
QMap<QString, OAIObject> OAITriggerRun::getDependencyStatus() const {
    return m_dependency_status;
}
void OAITriggerRun::setDependencyStatus(const QMap<QString, OAIObject> &dependency_status) {
    m_dependency_status = dependency_status;
    m_dependency_status_isSet = true;
}

bool OAITriggerRun::is_dependency_status_Set() const{
    return m_dependency_status_isSet;
}

bool OAITriggerRun::is_dependency_status_Valid() const{
    return m_dependency_status_isValid;
}
...
QMap<QString, QString> OAITriggerRun::getRunDimension() const {
    return m_run_dimension;
}
void OAITriggerRun::setRunDimension(const QMap<QString, QString> &run_dimension) {
    m_run_dimension = run_dimension;
    m_run_dimension_isSet = true;
}

bool OAITriggerRun::is_run_dimension_Set() const{
    return m_run_dimension_isSet;
}

bool OAITriggerRun::is_run_dimension_Valid() const{
    return m_run_dimension_isValid;
}
