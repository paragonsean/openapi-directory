...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.AvailableDelegation();
  });
  ...
  describe('AvailableDelegation', function() {
    it('should create an instance of AvailableDelegation', function() {
      // uncomment below and update the code to test AvailableDelegation
      //var instance = new NetworkManagementClient.AvailableDelegation();
      //expect(instance).to.be.a(NetworkManagementClient.AvailableDelegation);
    });
