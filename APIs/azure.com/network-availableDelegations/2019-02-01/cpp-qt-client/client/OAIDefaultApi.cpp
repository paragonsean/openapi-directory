...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("availableDelegationsList", defaultConf);
    _serverIndices.insert("availableDelegationsList", 0);
    _serverConfigs.insert("availableResourceGroupDelegationsList", defaultConf);
    _serverIndices.insert("availableResourceGroupDelegationsList", 0);
}
...
void OAIDefaultApi::availableDelegationsList(const QString &location, const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["availableDelegationsList"][_serverIndices.value("availableDelegationsList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/availableDelegations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableDelegationsListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableDelegationsListCallback);
...
void OAIDefaultApi::availableDelegationsListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAvailableDelegationsResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT availableDelegationsListSignal(output);
        Q_EMIT availableDelegationsListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT availableDelegationsListSignalE(output, error_type, error_str);
        Q_EMIT availableDelegationsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT availableDelegationsListSignalError(output, error_type, error_str);
        Q_EMIT availableDelegationsListSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::availableResourceGroupDelegationsList(const QString &location, const QString &resource_group_name, const QString &subscription_id, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["availableResourceGroupDelegationsList"][_serverIndices.value("availableResourceGroupDelegationsList")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/locations/{location}/availableDelegations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableResourceGroupDelegationsListCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableResourceGroupDelegationsListCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::availableResourceGroupDelegationsListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT availableResourceGroupDelegationsListSignal(output);
        Q_EMIT availableResourceGroupDelegationsListSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT availableResourceGroupDelegationsListSignalE(output, error_type, error_str);
        Q_EMIT availableResourceGroupDelegationsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT availableResourceGroupDelegationsListSignalError(output, error_type, error_str);
        Q_EMIT availableResourceGroupDelegationsListSignalErrorFull(worker, error_type, error_str);
    }
}
