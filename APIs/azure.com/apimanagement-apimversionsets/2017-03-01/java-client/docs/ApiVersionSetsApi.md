...
> ApiVersionSetContract apiVersionSetCreateOrUpdate(resourceGroupName, serviceName, apiVersion, subscriptionId, versionSetId, parameters, ifMatch)
...
| **ifMatch** | **String**| The entity state (Etag) version of the user to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String versionSetId = "versionSetId_example"; // String | Api Version Set identifier. Must be unique in the current API Management service instance.
    String ifMatch = "ifMatch_example"; // String | The entity state (Etag) version of the Api Version Set to delete. A value of \"*\" can be used for If-Match to unconditionally apply the operation.
    try {
      apiInstance.apiVersionSetDelete(resourceGroupName, serviceName, apiVersion, subscriptionId, versionSetId, ifMatch);
    } catch (ApiException e) {
...
| **subscriptionId** | **String**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | |
| **versionSetId** | **String**| Api Version Set identifier. Must be unique in the current API Management service instance. | |
| **ifMatch** | **String**| The entity state (Etag) version of the Api Version Set to delete. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionSetId = "versionSetId_example"; // String | Api Version Set identifier. Must be unique in the current API Management service instance.
    try {
      ApiVersionSetContract result = apiInstance.apiVersionSetGet(resourceGroupName, serviceName, apiVersion, subscriptionId, versionSetId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiVersionSetsApi#apiVersionSetGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionSetId = "versionSetId_example"; // String | Api Version Set identifier. Must be unique in the current API Management service instance.
    try {
      apiInstance.apiVersionSetGetEntityTag(resourceGroupName, serviceName, apiVersion, subscriptionId, versionSetId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiVersionSetsApi#apiVersionSetGetEntityTag");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> ApiVersionSetCollection apiVersionSetListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiVersionSetCollection result = apiInstance.apiVersionSetListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiVersionSetsApi#apiVersionSetListByService");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionSetId = "versionSetId_example"; // String | Api Version Set identifier. Must be unique in the current API Management service instance.
    String ifMatch = "ifMatch_example"; // String | The entity state (Etag) version of the user to update. A value of \"*\" can be used for If-Match to unconditionally apply the operation.
    ApiVersionSetUpdateParameters parameters = new ApiVersionSetUpdateParameters(); // ApiVersionSetUpdateParameters | Update parameters.
    try {
      apiInstance.apiVersionSetUpdate(resourceGroupName, serviceName, apiVersion, subscriptionId, versionSetId, ifMatch, parameters);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiVersionSetsApi#apiVersionSetUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
