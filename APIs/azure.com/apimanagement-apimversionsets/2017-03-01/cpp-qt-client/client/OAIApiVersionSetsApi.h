...
#ifndef OAI_OAIApiVersionSetsApi_H
#define OAI_OAIApiVersionSetsApi_H
...
class OAIApiVersionSetsApi : public QObject {
    Q_OBJECT

public:
    OAIApiVersionSetsApi(const int timeOut = 0);
    ~OAIApiVersionSetsApi();
    ...
    * @param[in]  parameters OAIApiVersionSetContract [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void apiVersionSetCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &version_set_id, const OAIApiVersionSetContract &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void apiVersionSetDelete(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &version_set_id, const QString &if_match);
    ...
    * @param[in]  version_set_id QString [required]
    */
    virtual void apiVersionSetGet(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &version_set_id);
    ...
    * @param[in]  version_set_id QString [required]
    */
    virtual void apiVersionSetGetEntityTag(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &version_set_id);
    ...
    * @param[in]  version_set_id QString [required]
    * @param[in]  if_match QString [required]
    * @param[in]  parameters OAIApiVersionSetUpdateParameters [required]
    */
    virtual void apiVersionSetUpdate(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &version_set_id, const QString &if_match, const OAIApiVersionSetUpdateParameters &parameters);
...
private:
    ...
    void apiVersionSetDeleteCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apiVersionSetCreateOrUpdateSignal(OAIApiVersionSetContract summary);
    void apiVersionSetDeleteSignal();
    void apiVersionSetGetSignal(OAIApiVersionSetContract summary);
    void apiVersionSetGetEntityTagSignal();
    void apiVersionSetListByServiceSignal(OAIApiVersionSetCollection summary);
    void apiVersionSetUpdateSignal();


    void apiVersionSetCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIApiVersionSetContract summary);
    void apiVersionSetDeleteSignalFull(OAIHttpRequestWorker *worker);
    void apiVersionSetGetSignalFull(OAIHttpRequestWorker *worker, OAIApiVersionSetContract summary);
    void apiVersionSetGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void apiVersionSetListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIApiVersionSetCollection summary);
    ...
    void apiVersionSetCreateOrUpdateSignalE(OAIApiVersionSetContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiVersionSetCreateOrUpdateSignalError(OAIApiVersionSetContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiVersionSetDeleteSignalError() instead")
    void apiVersionSetDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apiVersionSetDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiVersionSetGetSignalError() instead")
    void apiVersionSetGetSignalE(OAIApiVersionSetContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiVersionSetGetSignalError(OAIApiVersionSetContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void apiVersionSetListByServiceSignalE(OAIApiVersionSetCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiVersionSetListByServiceSignalError(OAIApiVersionSetCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apiVersionSetDeleteSignalErrorFull() instead")
    void apiVersionSetDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiVersionSetDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
