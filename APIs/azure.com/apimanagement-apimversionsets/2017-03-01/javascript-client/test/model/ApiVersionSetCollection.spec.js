...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiVersionSetCollection();
  });
  ...
  describe('ApiVersionSetCollection', function() {
    it('should create an instance of ApiVersionSetCollection', function() {
      // uncomment below and update the code to test ApiVersionSetCollection
      //var instance = new ApiManagementClient.ApiVersionSetCollection();
      //expect(instance).to.be.a(ApiManagementClient.ApiVersionSetCollection);
    });
