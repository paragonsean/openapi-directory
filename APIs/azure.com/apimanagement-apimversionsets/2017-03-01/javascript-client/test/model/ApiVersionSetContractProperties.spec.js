...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiVersionSetContractProperties();
  });
  ...
  describe('ApiVersionSetContractProperties', function() {
    it('should create an instance of ApiVersionSetContractProperties', function() {
      // uncomment below and update the code to test ApiVersionSetContractProperties
      //var instance = new ApiManagementClient.ApiVersionSetContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.ApiVersionSetContractProperties);
    });
