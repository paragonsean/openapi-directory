# ApiManagementClient.ApiVersionSetContractProperties
...
**versioningScheme** | **String** | An value that determines where the API Version identifer will be located in a HTTP request. | 
