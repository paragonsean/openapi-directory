...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagResourceListByService200ResponseValueInner();
  });
  ...
  describe('TagResourceListByService200ResponseValueInner', function() {
    it('should create an instance of TagResourceListByService200ResponseValueInner', function() {
      // uncomment below and update the code to test TagResourceListByService200ResponseValueInner
      //var instance = new ApiManagementClient.TagResourceListByService200ResponseValueInner();
      //expect(instance).to.be.a(ApiManagementClient.TagResourceListByService200ResponseValueInner);
    });
