...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationEntityContractProperties();
  });
  ...
  describe('OperationEntityContractProperties', function() {
    it('should create an instance of OperationEntityContractProperties', function() {
      // uncomment below and update the code to test OperationEntityContractProperties
      //var instance = new ApiManagementClient.OperationEntityContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.OperationEntityContractProperties);
    });
