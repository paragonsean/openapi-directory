...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagResourceContractProperties();
  });
  ...
  describe('TagResourceContractProperties', function() {
    it('should create an instance of TagResourceContractProperties', function() {
      // uncomment below and update the code to test TagResourceContractProperties
      //var instance = new ApiManagementClient.TagResourceContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.TagResourceContractProperties);
    });
