...
> TagResourceCollection tagResourceListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip)
...
import org.openapitools.client.api.TagResourcesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TagResourcesApi apiInstance = new TagResourcesApi(defaultClient);
    ...
    try {
      TagResourceCollection result = apiInstance.tagResourceListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TagResourcesApi#tagResourceListByService");
