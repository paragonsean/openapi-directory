...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationTagResourceContractProperties();
  });
  ...
  describe('OperationTagResourceContractProperties', function() {
    it('should create an instance of OperationTagResourceContractProperties', function() {
      // uncomment below and update the code to test OperationTagResourceContractProperties
      //var instance = new ApiManagementClient.OperationTagResourceContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.OperationTagResourceContractProperties);
    });
