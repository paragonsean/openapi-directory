...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagResourceContract();
  });
  ...
  describe('TagResourceContract', function() {
    it('should create an instance of TagResourceContract', function() {
      // uncomment below and update the code to test TagResourceContract
      //var instance = new ApiManagementClient.TagResourceContract();
      //expect(instance).to.be.a(ApiManagementClient.TagResourceContract);
    });
