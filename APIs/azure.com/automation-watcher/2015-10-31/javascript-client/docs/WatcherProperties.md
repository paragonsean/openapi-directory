# AutomationManagement.WatcherProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**creationTime** | **Date** | Gets or sets the creation time. | [optional] [readonly] 
**description** | **String** | Gets or sets the description. | [optional] 
**executionFrequencyInSeconds** | **Number** | Gets or sets the frequency at which the watcher is invoked. | [optional] 
**lastModifiedBy** | **String** | Details of the user who last modified the watcher. | [optional] [readonly] 
**lastModifiedTime** | **Date** | Gets or sets the last modified time. | [optional] [readonly] 
...
**scriptParameters** | **{String: String}** | Gets or sets the parameters of the script. | [optional] 
