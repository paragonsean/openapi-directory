...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiskResourceProviderClient.SnapshotList();
  });
  ...
  describe('SnapshotList', function() {
    it('should create an instance of SnapshotList', function() {
      // uncomment below and update the code to test SnapshotList
      //var instance = new DiskResourceProviderClient.SnapshotList();
      //expect(instance).to.be.a(DiskResourceProviderClient.SnapshotList);
    });
