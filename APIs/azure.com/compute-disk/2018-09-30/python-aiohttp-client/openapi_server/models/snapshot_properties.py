...
class SnapshotProperties(Model):
    ...
    def __init__(self, creation_data: CreationData=None, disk_size_gb: int=None, encryption_settings_collection: EncryptionSettingsCollection=None, hyper_v_generation: str=None, os_type: str=None, provisioning_state: str=None, time_created: datetime=None):
