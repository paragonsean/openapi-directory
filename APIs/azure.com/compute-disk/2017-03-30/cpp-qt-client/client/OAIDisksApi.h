...
Q_SIGNALS:
    ...
    void disksDeleteSignal(OAIOperationStatusResponse summary);
    ...
    void disksRevokeAccessSignal(OAIOperationStatusResponse summary);
    void disksUpdateSignal(OAIDisk summary);


    void disksCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIDisk summary);
    void disksDeleteSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void disksRevokeAccessSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void disksDeleteSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void disksDeleteSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void disksRevokeAccessSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void disksRevokeAccessSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
