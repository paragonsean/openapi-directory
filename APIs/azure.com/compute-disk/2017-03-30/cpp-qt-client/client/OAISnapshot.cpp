...
OAIDiskProperties OAISnapshot::getProperties() const {
    return m_properties;
}
void OAISnapshot::setProperties(const OAIDiskProperties &properties) {
...
OAIDiskSku OAISnapshot::getSku() const {
    return m_sku;
}
void OAISnapshot::setSku(const OAIDiskSku &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}
