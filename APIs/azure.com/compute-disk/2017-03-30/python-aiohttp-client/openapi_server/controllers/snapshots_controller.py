...
async def snapshots_create_or_update(request: web.Request, subscription_id, resource_group_name, snapshot_name, api_version, snapshot) -> web.Response:
    ...
    :param snapshot_name: The name of the snapshot that is being created. The name can&#39;t be changed after the snapshot is created. Supported characters for the name are a-z, A-Z, 0-9 and _. The max name length is 80 characters.
