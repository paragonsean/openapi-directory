...
public class SnapshotProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationData, diskSizeBytes, diskSizeGB, encryptionSettingsCollection, hyperVGeneration, incremental, osType, provisioningState, timeCreated, uniqueId);
  }
