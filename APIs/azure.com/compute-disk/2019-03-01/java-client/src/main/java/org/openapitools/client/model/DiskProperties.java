...
public class DiskProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationData, diskIOPSReadWrite, diskMBpsReadWrite, diskSizeBytes, diskSizeGB, diskState, encryptionSettingsCollection, hyperVGeneration, osType, provisioningState, timeCreated, uniqueId);
  }
