...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    try {
      apiInstance.snapshotsDelete(subscriptionId, resourceGroupName, snapshotName, apiVersion);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    try {
      apiInstance.snapshotsRevokeAccess(subscriptionId, resourceGroupName, snapshotName, apiVersion);
    } catch (ApiException e) {
