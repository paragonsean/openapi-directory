...
class DiskProperties(Model):
    ...
    def __init__(self, creation_data: CreationData=None, disk_iops_read_write: int=None, disk_m_bps_read_write: int=None, disk_size_bytes: int=None, disk_size_gb: int=None, disk_state: str=None, encryption_settings_collection: EncryptionSettingsCollection=None, hyper_v_generation: str=None, os_type: str=None, provisioning_state: str=None, time_created: datetime=None, unique_id: str=None):
