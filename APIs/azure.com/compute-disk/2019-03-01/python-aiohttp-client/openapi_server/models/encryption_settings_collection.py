...
class EncryptionSettingsCollection(Model):
    ...
    def __init__(self, enabled: bool=None, encryption_settings: List[EncryptionSettingsElement]=None, encryption_settings_version: str=None):
        ...
        :param encryption_settings_version: The encryption_settings_version of this EncryptionSettingsCollection.
        """
        self.openapi_types = {
            'enabled': bool,
        ...
        self._encryption_settings_version = encryption_settings_version
    ...
    @property
    def encryption_settings_version(self):
        """Gets the encryption_settings_version of this EncryptionSettingsCollection.

        Describes what type of encryption is used for the disks. Once this field is set, it cannot be overwritten. '1.0' corresponds to Azure Disk Encryption with AAD app.'1.1' corresponds to Azure Disk Encryption.

        :return: The encryption_settings_version of this EncryptionSettingsCollection.
        :rtype: str
        """
        return self._encryption_settings_version

    @encryption_settings_version.setter
    def encryption_settings_version(self, encryption_settings_version):
        """Sets the encryption_settings_version of this EncryptionSettingsCollection.
