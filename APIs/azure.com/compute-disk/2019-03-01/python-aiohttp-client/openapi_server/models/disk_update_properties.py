...
class DiskUpdateProperties(Model):
    ...
    def __init__(self, disk_iops_read_write: int=None, disk_m_bps_read_write: int=None, disk_size_gb: int=None, encryption_settings_collection: EncryptionSettingsCollection=None, os_type: str=None):
