...
void OAICreationData::initializeModel() {
    ...
    m_source_unique_id_isSet = false;
    m_source_unique_id_isValid = false;
    ...
    m_upload_size_bytes_isSet = false;
    m_upload_size_bytes_isValid = false;
}
...
void OAICreationData::fromJsonObject(QJsonObject json) {
    ...
    m_source_unique_id_isValid = ::OpenAPI::fromJsonValue(m_source_unique_id, json[QString("sourceUniqueId")]);
    m_source_unique_id_isSet = !json[QString("sourceUniqueId")].isNull() && m_source_unique_id_isValid;
    ...
    m_upload_size_bytes_isValid = ::OpenAPI::fromJsonValue(m_upload_size_bytes, json[QString("uploadSizeBytes")]);
    m_upload_size_bytes_isSet = !json[QString("uploadSizeBytes")].isNull() && m_upload_size_bytes_isValid;
}
...
QJsonObject OAICreationData::asJsonObject() const {
    ...
    if (m_source_unique_id_isSet) {
        obj.insert(QString("sourceUniqueId"), ::OpenAPI::toJsonValue(m_source_unique_id));
    }
    ...
    if (m_upload_size_bytes_isSet) {
        obj.insert(QString("uploadSizeBytes"), ::OpenAPI::toJsonValue(m_upload_size_bytes));
    }
    return obj;
}
...
QString OAICreationData::getSourceUniqueId() const {
    return m_source_unique_id;
}
void OAICreationData::setSourceUniqueId(const QString &source_unique_id) {
    m_source_unique_id = source_unique_id;
    m_source_unique_id_isSet = true;
}

bool OAICreationData::is_source_unique_id_Set() const{
    return m_source_unique_id_isSet;
}

bool OAICreationData::is_source_unique_id_Valid() const{
    return m_source_unique_id_isValid;
}
...
qint64 OAICreationData::getUploadSizeBytes() const {
    return m_upload_size_bytes;
}
void OAICreationData::setUploadSizeBytes(const qint64 &upload_size_bytes) {
    m_upload_size_bytes = upload_size_bytes;
    m_upload_size_bytes_isSet = true;
}

bool OAICreationData::is_upload_size_bytes_Set() const{
    return m_upload_size_bytes_isSet;
}

bool OAICreationData::is_upload_size_bytes_Valid() const{
    return m_upload_size_bytes_isValid;
}
