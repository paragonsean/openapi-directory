...
public class Example {
  public static void main(String[] args) {
    ...
    String snapshotName = "snapshotName_example"; // String | The name of the snapshot within the given subscription and resource group.
...
| **snapshotName** | **String**| The name of the snapshot within the given subscription and resource group. | |
