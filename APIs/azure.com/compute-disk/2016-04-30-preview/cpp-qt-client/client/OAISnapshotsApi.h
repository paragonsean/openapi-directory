...
Q_SIGNALS:
    ...
    void snapshotsDeleteSignal(OAIOperationStatusResponse summary);
    ...
    void snapshotsRevokeAccessSignal(OAIOperationStatusResponse summary);
    ...
    void snapshotsDeleteSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void snapshotsRevokeAccessSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void snapshotsDeleteSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void snapshotsDeleteSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void snapshotsRevokeAccessSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void snapshotsRevokeAccessSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
