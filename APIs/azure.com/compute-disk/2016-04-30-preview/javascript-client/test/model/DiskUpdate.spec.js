...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiskResourceProviderClient.DiskUpdate();
  });
  ...
  describe('DiskUpdate', function() {
    it('should create an instance of DiskUpdate', function() {
      // uncomment below and update the code to test DiskUpdate
      //var instance = new DiskResourceProviderClient.DiskUpdate();
      //expect(instance).to.be.a(DiskResourceProviderClient.DiskUpdate);
    });
