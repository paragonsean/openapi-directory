...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiskResourceProviderClient.Snapshot();
  });
  ...
  describe('Snapshot', function() {
    it('should create an instance of Snapshot', function() {
      ...
      //var instance = new DiskResourceProviderClient.Snapshot();
      //expect(instance).to.be.a(DiskResourceProviderClient.Snapshot);
    });
