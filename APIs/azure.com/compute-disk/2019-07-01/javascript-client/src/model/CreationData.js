...
class CreationData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sourceUniqueId')) {
                obj['sourceUniqueId'] = ApiClient.convertToType(data['sourceUniqueId'], 'String');
            }
            ...
            if (data.hasOwnProperty('uploadSizeBytes')) {
                obj['uploadSizeBytes'] = ApiClient.convertToType(data['uploadSizeBytes'], 'Number');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sourceUniqueId'] && !(typeof data['sourceUniqueId'] === 'string' || data['sourceUniqueId'] instanceof String)) {
            throw new Error("Expected the field `sourceUniqueId` to be a primitive type in the JSON string but got " + data['sourceUniqueId']);
        }
        // ensure the json data is a string
 ...
 * @member {String} sourceUniqueId
 */
CreationData.prototype['sourceUniqueId'] = undefined;
 ...
 * @member {Number} uploadSizeBytes
 */
CreationData.prototype['uploadSizeBytes'] = undefined;
