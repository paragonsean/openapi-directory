...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiskResourceProviderClient.DiskList();
  });
  ...
  describe('DiskList', function() {
    it('should create an instance of DiskList', function() {
      // uncomment below and update the code to test DiskList
      //var instance = new DiskResourceProviderClient.DiskList();
      //expect(instance).to.be.a(DiskResourceProviderClient.DiskList);
    });
