...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiskResourceProviderClient.ApiError();
  });
  ...
  describe('ApiError', function() {
    it('should create an instance of ApiError', function() {
      ...
      //var instance = new DiskResourceProviderClient.ApiError();
      //expect(instance).to.be.a(DiskResourceProviderClient.ApiError);
    });
