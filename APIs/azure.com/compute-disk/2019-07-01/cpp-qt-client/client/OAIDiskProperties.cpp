...
OAIEncryption OAIDiskProperties::getEncryption() const {
    return m_encryption;
}
void OAIDiskProperties::setEncryption(const OAIEncryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIDiskProperties::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIDiskProperties::is_encryption_Valid() const{
