...
OAIEncryption OAISnapshotProperties::getEncryption() const {
    return m_encryption;
}
void OAISnapshotProperties::setEncryption(const OAIEncryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAISnapshotProperties::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAISnapshotProperties::is_encryption_Valid() const{
