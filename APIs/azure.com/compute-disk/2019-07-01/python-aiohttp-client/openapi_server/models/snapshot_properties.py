...
class SnapshotProperties(Model):
    ...
    def __init__(self, creation_data: CreationData=None, disk_size_bytes: int=None, disk_size_gb: int=None, encryption: Encryption=None, encryption_settings_collection: EncryptionSettingsCollection=None, hyper_v_generation: str=None, incremental: bool=None, os_type: str=None, provisioning_state: str=None, time_created: datetime=None, unique_id: str=None):
        ...
        :param encryption: The encryption of this SnapshotProperties.
    ...
    @property
    def encryption(self):
        """Gets the encryption of this SnapshotProperties.


        :return: The encryption of this SnapshotProperties.
        :rtype: Encryption
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this SnapshotProperties.
