...
class SnapshotUpdateProperties(Model):
    ...
    def __init__(self, disk_size_gb: int=None, encryption: Encryption=None, encryption_settings_collection: EncryptionSettingsCollection=None, os_type: str=None):
        """SnapshotUpdateProperties - a model defined in OpenAPI

        :param disk_size_gb: The disk_size_gb of this SnapshotUpdateProperties.
        :param encryption: The encryption of this SnapshotUpdateProperties.
    ...
    @property
    def encryption(self):
        """Gets the encryption of this SnapshotUpdateProperties.


        :return: The encryption of this SnapshotUpdateProperties.
        :rtype: Encryption
        """
    ...
    def encryption(self, encryption):
        """Sets the encryption of this SnapshotUpdateProperties.
