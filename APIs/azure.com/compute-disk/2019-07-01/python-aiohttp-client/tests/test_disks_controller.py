...
async def test_disks_create_or_update(client):
    ...
    """
    disk = {"managedBy":"managedBy","sku":{"tier":"tier","name":"Standard_LRS"},"zones":["zones","zones"],"properties":{"diskMBpsReadWrite":5,"creationData":{"storageAccountId":"storageAccountId","uploadSizeBytes":6,"sourceUri":"sourceUri","sourceUniqueId":"sourceUniqueId","imageReference":{"lun":0,"id":"id"},"createOption":"Empty","sourceResourceId":"sourceResourceId"},"diskIOPSReadWrite":1,"hyperVGeneration":"V1","provisioningState":"provisioningState","encryption":{"type":"EncryptionAtRestWithPlatformKey","diskEncryptionSetId":"diskEncryptionSetId"},"diskState":"Unattached","osType":"Windows","timeCreated":"2000-01-23T04:56:07.000+00:00","diskSizeBytes":5,"encryptionSettingsCollection":{"encryptionSettingsVersion":"encryptionSettingsVersion","enabled":True,"encryptionSettings":[{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}},{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}]},"uniqueId":"uniqueId","diskSizeGB":2}}
