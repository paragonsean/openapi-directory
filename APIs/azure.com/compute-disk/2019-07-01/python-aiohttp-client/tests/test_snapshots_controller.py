...
async def test_snapshots_create_or_update(client):
    ...
    """
    snapshot = {"managedBy":"managedBy","sku":{"tier":"tier","name":"Standard_LRS"},"properties":{"encryption":{"type":"EncryptionAtRestWithPlatformKey","diskEncryptionSetId":"diskEncryptionSetId"},"creationData":{"storageAccountId":"storageAccountId","uploadSizeBytes":6,"sourceUri":"sourceUri","sourceUniqueId":"sourceUniqueId","imageReference":{"lun":0,"id":"id"},"createOption":"Empty","sourceResourceId":"sourceResourceId"},"osType":"Windows","hyperVGeneration":"V1","timeCreated":"2000-01-23T04:56:07.000+00:00","incremental":True,"provisioningState":"provisioningState","diskSizeBytes":0,"encryptionSettingsCollection":{"encryptionSettingsVersion":"encryptionSettingsVersion","enabled":True,"encryptionSettings":[{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}},{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}]},"uniqueId":"uniqueId","diskSizeGB":6}}
...
async def test_snapshots_update(client):
    ...
    """
    snapshot = {"sku":{"tier":"tier","name":"Standard_LRS"},"properties":{"encryption":{"type":"EncryptionAtRestWithPlatformKey","diskEncryptionSetId":"diskEncryptionSetId"},"osType":"Windows","encryptionSettingsCollection":{"encryptionSettingsVersion":"encryptionSettingsVersion","enabled":True,"encryptionSettings":[{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}},{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}]},"diskSizeGB":0},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
