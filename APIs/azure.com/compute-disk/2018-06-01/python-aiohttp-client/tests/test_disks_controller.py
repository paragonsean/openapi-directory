...
async def test_disks_create_or_update(client):
    ...
    """
    disk = {"managedBy":"managedBy","sku":{"tier":"Standard","name":"Standard_LRS"},"zones":["zones","zones"],"properties":{"diskMBpsReadWrite":1,"creationData":{"storageAccountId":"storageAccountId","sourceUri":"sourceUri","imageReference":{"lun":0,"id":"id"},"createOption":"Empty","sourceResourceId":"sourceResourceId"},"diskIOPSReadWrite":6,"osType":"Windows","timeCreated":"2000-01-23T04:56:07.000+00:00","provisioningState":"provisioningState","diskSizeGB":5,"encryptionSettings":{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}}}
...
async def test_disks_update(client):
    ...
    """
    disk = {"sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"diskMBpsReadWrite":6,"diskIOPSReadWrite":0,"osType":"Windows","diskSizeGB":1,"encryptionSettings":{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
