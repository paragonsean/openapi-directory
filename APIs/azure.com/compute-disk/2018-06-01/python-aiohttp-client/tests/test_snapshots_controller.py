...
async def test_snapshots_update(client):
    ...
    """
    snapshot = {"sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"osType":"Windows","diskSizeGB":0,"encryptionSettings":{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
