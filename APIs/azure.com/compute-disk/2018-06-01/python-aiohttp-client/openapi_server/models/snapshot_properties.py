...
class SnapshotProperties(Model):
    ...
    def __init__(self, creation_data: CreationData=None, disk_size_gb: int=None, encryption_settings: EncryptionSettings=None, os_type: str=None, provisioning_state: str=None, time_created: datetime=None):
        ...
        :param encryption_settings: The encryption_settings of this SnapshotProperties.
    ...
    def encryption_settings(self):
        """Gets the encryption_settings of this SnapshotProperties.


        :return: The encryption_settings of this SnapshotProperties.
    ...
    def encryption_settings(self, encryption_settings):
        """Sets the encryption_settings of this SnapshotProperties.
