...
(function(root, factory) {
  ...
  describe('QueryType', function() {
    it('should create an instance of QueryType', function() {
      // uncomment below and update the code to test QueryType
      //var instance = new SearchIndexClient.QueryType();
      //expect(instance).to.be.a(SearchIndexClient.QueryType);
    });
