...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchIndexClient.SuggestParametersPayload();
  });
  ...
  describe('SuggestParametersPayload', function() {
    it('should create an instance of SuggestParametersPayload', function() {
      // uncomment below and update the code to test SuggestParametersPayload
      //var instance = new SearchIndexClient.SuggestParametersPayload();
      //expect(instance).to.be.a(SearchIndexClient.SuggestParametersPayload);
    });
    ...
    it('should have the property suggesterName (base name: "suggesterName")', function() {
      // uncomment below and update the code to test the property suggesterName
      //var instance = new SearchIndexClient.SuggestParametersPayload();
      //expect(instance).to.be();
    });
