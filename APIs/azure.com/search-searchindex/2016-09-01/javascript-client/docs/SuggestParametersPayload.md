# SearchIndexClient.SuggestParametersPayload
...
**top** | **Number** | The number of suggestions to retrieve. This must be a value between 1 and 100. The default is to 5. | [optional] 
