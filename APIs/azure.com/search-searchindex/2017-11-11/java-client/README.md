...
- API version: 2017-11-11
  - Build date: 2024-10-12T11:12:21.758847-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2017-11-11"
  }
```
...
* `target/openapi-java-client-2017-11-11.jar`
* `target/lib/*.jar`
