...
public:
    ...
    */
    virtual void spatialAnchorsAccountsCreate(const QString &subscription_id, const QString &resource_group_name, const QString &spatial_anchors_account_name, const QString &api_version, const OAISpatialAnchorsAccount &spatial_anchors_account);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void spatialAnchorsAccountsDelete(const QString &subscription_id, const QString &resource_group_name, const QString &spatial_anchors_account_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void spatialAnchorsAccountsGet(const QString &subscription_id, const QString &resource_group_name, const QString &spatial_anchors_account_name, const QString &api_version);
    ...
    * @param[in]  spatial_anchors_account OAISpatialAnchorsAccount [required]
    */
    virtual void spatialAnchorsAccountsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &spatial_anchors_account_name, const QString &api_version, const OAISpatialAnchorsAccount &spatial_anchors_account);
...
Q_SIGNALS:
    ...
    void spatialAnchorsAccountsListByResourceGroupSignal(OAISpatialAnchorsAccountList summary);
    ...
    void spatialAnchorsAccountsListByResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAISpatialAnchorsAccountList summary);
    ...
    void spatialAnchorsAccountsListByResourceGroupSignalE(OAISpatialAnchorsAccountList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void spatialAnchorsAccountsListByResourceGroupSignalError(OAISpatialAnchorsAccountList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
