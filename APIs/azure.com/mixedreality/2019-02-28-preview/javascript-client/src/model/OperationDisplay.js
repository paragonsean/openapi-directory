...
class OperationDisplay {
     ...
     * @param description {String} Description of operation
     * @param operation {String} Operation type: Read, write, delete, etc.
     * @param provider {String} Service provider: Microsoft.ResourceProvider
     * @param resource {String} Resource on which the operation is performed: Profile, endpoint, etc.
     */
    constructor(description, operation, provider, resource) { 
        
        OperationDisplay.initialize(this, description, operation, provider, resource);
    }
     ...
     */
    static initialize(obj, description, operation, provider, resource) { 
...
OperationDisplay.RequiredProperties = ["description", "operation", "provider", "resource"];
