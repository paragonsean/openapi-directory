...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MixedReality.SpatialAnchorsAccountKeys();
  });
  ...
  describe('SpatialAnchorsAccountKeys', function() {
    it('should create an instance of SpatialAnchorsAccountKeys', function() {
      // uncomment below and update the code to test SpatialAnchorsAccountKeys
      //var instance = new MixedReality.SpatialAnchorsAccountKeys();
      //expect(instance).to.be.a(MixedReality.SpatialAnchorsAccountKeys);
    });
