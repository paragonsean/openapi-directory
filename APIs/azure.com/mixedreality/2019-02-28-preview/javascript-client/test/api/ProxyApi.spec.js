...
(function(root, factory) {
  ...
  describe('ProxyApi', function() {
    ...
    describe('spatialAnchorsAccountsListBySubscription_0', function() {
      it('should call spatialAnchorsAccountsListBySubscription_0 successfully', function(done) {
        //uncomment below and update the code to test spatialAnchorsAccountsListBySubscription_0
        //instance.spatialAnchorsAccountsListBySubscription_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
