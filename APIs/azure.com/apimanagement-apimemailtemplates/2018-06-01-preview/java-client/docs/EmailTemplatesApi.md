...
# **emailTemplateUpdate**
> emailTemplateUpdate(resourceGroupName, serviceName, templateName, apiVersion, subscriptionId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.emailTemplateUpdate(resourceGroupName, serviceName, templateName, apiVersion, subscriptionId, parameters);
    } catch (ApiException e) {
