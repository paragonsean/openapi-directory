...
public:
    ...
    * @param[in]  parameters OAIEmailTemplate_CreateOrUpdate_request [required]
    */
    virtual void emailTemplateUpdate(const QString &resource_group_name, const QString &service_name, const QString &template_name, const QString &api_version, const QString &subscription_id, const OAIEmailTemplate_CreateOrUpdate_request &parameters);
