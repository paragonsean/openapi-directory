...
async def email_template_update(request: web.Request, resource_group_name, service_name, template_name, api_version, subscription_id, parameters) -> web.Response:
