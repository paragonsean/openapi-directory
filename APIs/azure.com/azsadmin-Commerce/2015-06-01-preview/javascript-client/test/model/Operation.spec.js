...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new CommerceManagementClient.Operation();
      //expect(instance).to.be.a(CommerceManagementClient.Operation);
    });
