...
<a id="usagesListByAutomationAccount"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageListResult result = apiInstance.usagesListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsagesApi#usagesListByAutomationAccount");
