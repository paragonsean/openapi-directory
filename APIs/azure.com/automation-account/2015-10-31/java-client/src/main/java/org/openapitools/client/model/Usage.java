...
import org.openapitools.client.model.UsageCounterName;
...
public class Usage {
  ...
  public static final String SERIALIZED_NAME_THROTTLE_STATUS = "throttleStatus";
  @SerializedName(SERIALIZED_NAME_THROTTLE_STATUS)
  ...
  public Usage currentValue(Double currentValue) {
  ...
  public Usage name(UsageCounterName name) {
    this.name = name;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public UsageCounterName getName() {
    return name;
  }

  public void setName(UsageCounterName name) {
    this.name = name;
  }


  public Usage throttleStatus(String throttleStatus) {
  ...
  public void setThrottleStatus(String throttleStatus) {
    this.throttleStatus = throttleStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentValue, usage.currentValue) &&
        ...
        Objects.equals(this.throttleStatus, usage.throttleStatus) &&
        Objects.equals(this.unit, usage.unit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentValue, id, limit, name, throttleStatus, unit);
  }
  ...
  public String toString() {
    ...
    sb.append("    throttleStatus: ").append(toIndentedString(throttleStatus)).append("\n");
  ...
  static {
    ...
    openapiFields.add("throttleStatus");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) {
        UsageCounterName.validateJsonElement(jsonObj.get("name"));
      }
      if ((jsonObj.get("throttleStatus") != null && !jsonObj.get("throttleStatus").isJsonNull()) && !jsonObj.get("throttleStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `throttleStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("throttleStatus").toString()));
      }
