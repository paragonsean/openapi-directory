...
QString OAIOperations_List_default_response::getCode() const {
    return m_code;
}
void OAIOperations_List_default_response::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIOperations_List_default_response::is_code_Set() const{
    return m_code_isSet;
}

bool OAIOperations_List_default_response::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIOperations_List_default_response::getMessage() const {
    return m_message;
}
void OAIOperations_List_default_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIOperations_List_default_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIOperations_List_default_response::is_message_Valid() const{
