...
void OAIStatisticsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("statisticsListByAutomationAccount", defaultConf);
    _serverIndices.insert("statisticsListByAutomationAccount", 0);
}
...
void OAIStatisticsApi::statisticsListByAutomationAccount(const QString &resource_group_name, const QString &automation_account_name, const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["statisticsListByAutomationAccount"][_serverIndices.value("statisticsListByAutomationAccount")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/statistics");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatisticsApi::statisticsListByAutomationAccountCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatisticsApi::statisticsListByAutomationAccountCallback);
...
void OAIStatisticsApi::statisticsListByAutomationAccountCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIStatisticsListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT statisticsListByAutomationAccountSignal(output);
        Q_EMIT statisticsListByAutomationAccountSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT statisticsListByAutomationAccountSignalE(output, error_type, error_str);
        Q_EMIT statisticsListByAutomationAccountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT statisticsListByAutomationAccountSignalError(output, error_type, error_str);
        Q_EMIT statisticsListByAutomationAccountSignalErrorFull(worker, error_type, error_str);
    }
}
