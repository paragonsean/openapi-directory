...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AutomationManagement.OperationDisplay();
      //expect(instance).to.be.a(AutomationManagement.OperationDisplay);
    });
