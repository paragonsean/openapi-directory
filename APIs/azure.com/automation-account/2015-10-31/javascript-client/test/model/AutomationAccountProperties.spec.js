...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.AutomationAccountProperties();
  });
  ...
  describe('AutomationAccountProperties', function() {
    it('should create an instance of AutomationAccountProperties', function() {
      // uncomment below and update the code to test AutomationAccountProperties
      //var instance = new AutomationManagement.AutomationAccountProperties();
      //expect(instance).to.be.a(AutomationManagement.AutomationAccountProperties);
    });
