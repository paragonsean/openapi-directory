# AutomationManagement.ListKeysApi
...
let apiInstance = new AutomationManagement.ListKeysApi();
...
apiInstance.keysListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
