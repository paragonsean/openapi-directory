# AutomationManagement.StatisticsApi
...
> StatisticsListResult statisticsListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion, opts)
...
let apiInstance = new AutomationManagement.StatisticsApi();
...
apiInstance.statisticsListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
