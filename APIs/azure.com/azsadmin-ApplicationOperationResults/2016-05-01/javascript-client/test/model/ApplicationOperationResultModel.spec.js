...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabricAdminClient.ApplicationOperationResultModel();
  });
  ...
  describe('ApplicationOperationResultModel', function() {
    it('should create an instance of ApplicationOperationResultModel', function() {
      // uncomment below and update the code to test ApplicationOperationResultModel
      //var instance = new FabricAdminClient.ApplicationOperationResultModel();
      //expect(instance).to.be.a(FabricAdminClient.ApplicationOperationResultModel);
    });
