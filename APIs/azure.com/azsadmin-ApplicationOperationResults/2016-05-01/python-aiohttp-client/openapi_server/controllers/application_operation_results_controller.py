...
async def application_operation_results_get(request: web.Request, subscription_id, resource_group_name, location, operation, api_version) -> web.Response:
...
async def application_operation_results_list(request: web.Request, subscription_id, resource_group_name, location, api_version, filter=None) -> web.Response:
