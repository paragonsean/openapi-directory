...
import DataWarehouseUserActivitiesProperties from './model/DataWarehouseUserActivitiesProperties';
import DataWarehouseUserActivitiesApi from './api/DataWarehouseUserActivitiesApi';
...
export {
    ...
    /**
     * The DataWarehouseUserActivities model constructor.
     * @property {module:model/DataWarehouseUserActivities}
     */
    DataWarehouseUserActivities,

    /**
     * The DataWarehouseUserActivitiesProperties model constructor.
     * @property {module:model/DataWarehouseUserActivitiesProperties}
     */
    DataWarehouseUserActivitiesProperties,

    /**
    * The DataWarehouseUserActivitiesApi service constructor.
    * @property {module:api/DataWarehouseUserActivitiesApi}
    */
