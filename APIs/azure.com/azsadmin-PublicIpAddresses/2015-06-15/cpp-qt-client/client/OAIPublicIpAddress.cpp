...
OAIPublicIPAddressProperties OAIPublicIpAddress::getProperties() const {
    return m_properties;
}
void OAIPublicIpAddress::setProperties(const OAIPublicIPAddressProperties &properties) {
