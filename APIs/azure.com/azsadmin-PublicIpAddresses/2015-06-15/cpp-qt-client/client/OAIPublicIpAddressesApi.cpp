...
void OAIPublicIpAddressesApi::publicIPAddressesList(const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<QString> &top, const ::OpenAPI::OptionalParam<QString> &skip, const ::OpenAPI::OptionalParam<QString> &inline_count) {
    QString fullPath = QString(_serverConfigs["publicIPAddressesList"][_serverIndices.value("publicIPAddressesList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/adminPublicIpAddresses");
    ...
    if (inline_count.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("$inlineCount")).append(querySuffix).append(QUrl::toPercentEncoding(inline_count.stringValue()));
    }
...
void OAIPublicIpAddressesApi::publicIPAddressesListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPublicIpAddressList output(QString(worker->response));
    worker->deleteLater();
