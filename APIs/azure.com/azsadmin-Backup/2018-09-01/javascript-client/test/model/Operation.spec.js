...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new BackupManagementClient.Operation();
      //expect(instance).to.be.a(BackupManagementClient.Operation);
    });
