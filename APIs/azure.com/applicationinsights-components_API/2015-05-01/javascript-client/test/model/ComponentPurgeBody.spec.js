...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.ComponentPurgeBody();
  });
  ...
  describe('ComponentPurgeBody', function() {
    it('should create an instance of ComponentPurgeBody', function() {
      // uncomment below and update the code to test ComponentPurgeBody
      //var instance = new ApplicationInsightsManagementClient.ComponentPurgeBody();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.ComponentPurgeBody);
    });
