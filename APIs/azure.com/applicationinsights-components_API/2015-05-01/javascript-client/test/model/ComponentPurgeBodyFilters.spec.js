...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.ComponentPurgeBodyFilters();
  });
  ...
  describe('ComponentPurgeBodyFilters', function() {
    it('should create an instance of ComponentPurgeBodyFilters', function() {
      // uncomment below and update the code to test ComponentPurgeBodyFilters
      //var instance = new ApplicationInsightsManagementClient.ComponentPurgeBodyFilters();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.ComponentPurgeBodyFilters);
    });
