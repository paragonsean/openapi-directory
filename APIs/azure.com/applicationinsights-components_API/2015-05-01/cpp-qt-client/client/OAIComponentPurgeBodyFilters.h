...
/*
 * OAIComponentPurgeBodyFilters.h
 *
 * User-defined filters to return data which will be purged from the table.
 */

#ifndef OAIComponentPurgeBodyFilters_H
#define OAIComponentPurgeBodyFilters_H
...
class OAIComponentPurgeBodyFilters : public OAIObject {
public:
    OAIComponentPurgeBodyFilters();
    OAIComponentPurgeBodyFilters(QString json);
    ~OAIComponentPurgeBodyFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentPurgeBodyFilters)

#endif // OAIComponentPurgeBodyFilters_H
