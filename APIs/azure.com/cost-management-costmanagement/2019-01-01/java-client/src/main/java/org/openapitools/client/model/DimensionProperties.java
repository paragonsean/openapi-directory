...
public class DimensionProperties {
  ...
  public DimensionProperties description(String description) {
  ...
  public DimensionProperties filterEnabled(Boolean filterEnabled) {
  ...
  public DimensionProperties groupingEnabled(Boolean groupingEnabled) {
