...
class Export {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ExportProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ExportProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ExportProperties} properties
 */
Export.prototype['properties'] = undefined;
 ...
 * @member {String} name
 */
Export.prototype['name'] = undefined;

/**
 * Resource tags.
 * @member {Object.<String, String>} tags
 */
Export.prototype['tags'] = undefined;
