...
export default class ForecastApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the forecastUsageByManagmentGroup operation.
     * @callback module:api/ForecastApi~forecastUsageByManagmentGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/QueryResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ReportConfigDefinition} parameters Parameters supplied to the CreateOrUpdate Report Config operation.
     * @param {module:api/ForecastApi~forecastUsageByManagmentGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/QueryResult}
     */
    forecastUsageByManagmentGroup(apiVersion, managementGroupId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling forecastUsageByManagmentGroup");
      }
      // verify the required parameter 'managementGroupId' is set
      if (managementGroupId === undefined || managementGroupId === null) {
        throw new Error("Missing the required parameter 'managementGroupId' when calling forecastUsageByManagmentGroup");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling forecastUsageByManagmentGroup");
      }
