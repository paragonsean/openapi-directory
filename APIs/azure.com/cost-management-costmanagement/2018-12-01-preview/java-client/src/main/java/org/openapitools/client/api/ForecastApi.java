...
public class ForecastApi {
    ...
    /**
     * Build call for forecastUsageByManagmentGroup
     * @param apiVersion Version of the API to be used with the client request. The current version is 2018-05-31. (required)
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/costmanagement/"> Documentation</a>
     */
    public okhttp3.Call forecastUsageByManagmentGroupCall(String apiVersion, String managementGroupId, ReportConfigDefinition parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call forecastUsageByManagmentGroupValidateBeforeCall(String apiVersion, String managementGroupId, ReportConfigDefinition parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling forecastUsageByManagmentGroup(Async)");
        }

        // verify the required parameter 'managementGroupId' is set
        if (managementGroupId == null) {
            throw new ApiException("Missing the required parameter 'managementGroupId' when calling forecastUsageByManagmentGroup(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling forecastUsageByManagmentGroup(Async)");
        }

        return forecastUsageByManagmentGroupCall(apiVersion, managementGroupId, parameters, _callback);
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/costmanagement/"> Documentation</a>
     */
    public QueryResult forecastUsageByManagmentGroup(String apiVersion, String managementGroupId, ReportConfigDefinition parameters) throws ApiException {
        ApiResponse<QueryResult> localVarResp = forecastUsageByManagmentGroupWithHttpInfo(apiVersion, managementGroupId, parameters);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/costmanagement/"> Documentation</a>
     */
    public ApiResponse<QueryResult> forecastUsageByManagmentGroupWithHttpInfo(String apiVersion, String managementGroupId, ReportConfigDefinition parameters) throws ApiException {
        okhttp3.Call localVarCall = forecastUsageByManagmentGroupValidateBeforeCall(apiVersion, managementGroupId, parameters, null);
        Type localVarReturnType = new TypeToken<QueryResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/costmanagement/"> Documentation</a>
     */
    public okhttp3.Call forecastUsageByManagmentGroupAsync(String apiVersion, String managementGroupId, ReportConfigDefinition parameters, final ApiCallback<QueryResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = forecastUsageByManagmentGroupValidateBeforeCall(apiVersion, managementGroupId, parameters, _callback);
        Type localVarReturnType = new TypeToken<QueryResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
