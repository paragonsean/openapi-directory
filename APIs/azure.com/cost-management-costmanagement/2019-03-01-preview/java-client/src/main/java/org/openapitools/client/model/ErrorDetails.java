...
public class ErrorDetails {
  ...
  private List<ErrorBase> details = new ArrayList<>();
  ...
  public ErrorDetails details(List<ErrorBase> details) {
    this.details = details;
    return this;
  }

  public ErrorDetails addDetailsItem(ErrorBase detailsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ErrorBase> getDetails() {
    return details;
  }

  public void setDetails(List<ErrorBase> details) {
    this.details = details;
  }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ErrorBase.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
