...
<a id="forecastUsageByExternalBillingAccount"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ReportConfigDefinition parameters = new ReportConfigDefinition(); // ReportConfigDefinition | Parameters supplied to the CreateOrUpdate Report Config operation.
    try {
      QueryResult result = apiInstance.forecastUsageByExternalBillingAccount(apiVersion, externalBillingAccountName, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ForecastApi#forecastUsageByExternalBillingAccount");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="forecastUsageByManagementGroup"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ReportConfigDefinition parameters = new ReportConfigDefinition(); // ReportConfigDefinition | Parameters supplied to the CreateOrUpdate Report Config operation.
    try {
      QueryResult result = apiInstance.forecastUsageByManagementGroup(apiVersion, managementGroupId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ForecastApi#forecastUsageByManagementGroup");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
