...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.ReportConfigFilter();
  });
  ...
  describe('ReportConfigFilter', function() {
    it('should create an instance of ReportConfigFilter', function() {
      // uncomment below and update the code to test ReportConfigFilter
      //var instance = new CostManagementClient.ReportConfigFilter();
      //expect(instance).to.be.a(CostManagementClient.ReportConfigFilter);
    });
