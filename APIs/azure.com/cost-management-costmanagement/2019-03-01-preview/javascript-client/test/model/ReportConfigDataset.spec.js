...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.ReportConfigDataset();
  });
  ...
  describe('ReportConfigDataset', function() {
    it('should create an instance of ReportConfigDataset', function() {
      // uncomment below and update the code to test ReportConfigDataset
      //var instance = new CostManagementClient.ReportConfigDataset();
      //expect(instance).to.be.a(CostManagementClient.ReportConfigDataset);
    });
