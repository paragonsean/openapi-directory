...
void OAIDimensionProperties::initializeModel() {
    ...
    m_grouping_enabled_isSet = false;
    m_grouping_enabled_isValid = false;
...
void OAIDimensionProperties::fromJsonObject(QJsonObject json) {
    ...
    m_filter_enabled_isValid = ::OpenAPI::fromJsonValue(m_filter_enabled, json[QString("filterEnabled")]);
    m_filter_enabled_isSet = !json[QString("filterEnabled")].isNull() && m_filter_enabled_isValid;

    m_grouping_enabled_isValid = ::OpenAPI::fromJsonValue(m_grouping_enabled, json[QString("groupingEnabled")]);
    m_grouping_enabled_isSet = !json[QString("groupingEnabled")].isNull() && m_grouping_enabled_isValid;
...
QJsonObject OAIDimensionProperties::asJsonObject() const {
    ...
    if (m_filter_enabled_isSet) {
        obj.insert(QString("filterEnabled"), ::OpenAPI::toJsonValue(m_filter_enabled));
    }
    if (m_grouping_enabled_isSet) {
        obj.insert(QString("groupingEnabled"), ::OpenAPI::toJsonValue(m_grouping_enabled));
    }
...
QString OAIDimensionProperties::getDescription() const {
    return m_description;
}
void OAIDimensionProperties::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDimensionProperties::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDimensionProperties::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIDimensionProperties::isFilterEnabled() const {
    return m_filter_enabled;
}
void OAIDimensionProperties::setFilterEnabled(const bool &filter_enabled) {
    m_filter_enabled = filter_enabled;
    m_filter_enabled_isSet = true;
}

bool OAIDimensionProperties::is_filter_enabled_Set() const{
    return m_filter_enabled_isSet;
}

bool OAIDimensionProperties::is_filter_enabled_Valid() const{
    return m_filter_enabled_isValid;
}

bool OAIDimensionProperties::isGroupingEnabled() const {
    return m_grouping_enabled;
}
void OAIDimensionProperties::setGroupingEnabled(const bool &grouping_enabled) {
    m_grouping_enabled = grouping_enabled;
    m_grouping_enabled_isSet = true;
}

bool OAIDimensionProperties::is_grouping_enabled_Set() const{
    return m_grouping_enabled_isSet;
}

bool OAIDimensionProperties::is_grouping_enabled_Valid() const{
    return m_grouping_enabled_isValid;
}
