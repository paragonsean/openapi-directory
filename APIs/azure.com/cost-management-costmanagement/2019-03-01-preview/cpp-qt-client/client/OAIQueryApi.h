...
public:
    ...
    * @param[in]  parameters OAIReportConfigDefinition [required]
    */
    virtual void queryUsageByManagementGroup(const QString &api_version, const QString &management_group_id, const OAIReportConfigDefinition &parameters);
...
private:
    ...
    void queryUsageByManagementGroupCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void queryUsageByManagementGroupSignal(OAIQueryResult summary);
    ...
    void queryUsageByManagementGroupSignalFull(OAIHttpRequestWorker *worker, OAIQueryResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use queryUsageByManagementGroupSignalError() instead")
    void queryUsageByManagementGroupSignalE(OAIQueryResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void queryUsageByManagementGroupSignalError(OAIQueryResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use queryUsageByManagementGroupSignalErrorFull() instead")
    void queryUsageByManagementGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void queryUsageByManagementGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
