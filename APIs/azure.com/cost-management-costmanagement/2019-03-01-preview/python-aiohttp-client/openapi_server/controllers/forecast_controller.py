...
async def forecast_usage_by_billing_account(request: web.Request, api_version, billing_account_id, parameters) -> web.Response:
...
async def forecast_usage_by_department(request: web.Request, api_version, billing_account_id, department_id, parameters) -> web.Response:
...
async def forecast_usage_by_enrollment_account(request: web.Request, api_version, billing_account_id, enrollment_account_id, parameters) -> web.Response:
...
async def forecast_usage_by_external_billing_account(request: web.Request, api_version, external_billing_account_name, parameters) -> web.Response:
...
async def forecast_usage_by_management_group(request: web.Request, api_version, management_group_id, parameters) -> web.Response:
...
async def forecast_usage_by_resource_group(request: web.Request, api_version, subscription_id, resource_group_name, parameters) -> web.Response:
...
async def forecast_usage_by_subscription(request: web.Request, api_version, subscription_id, parameters) -> web.Response:
