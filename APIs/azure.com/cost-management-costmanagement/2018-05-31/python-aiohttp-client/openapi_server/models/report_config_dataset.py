...
class ReportConfigDataset(Model):
    ...
    def __init__(self, aggregation: Dict[str, ReportConfigAggregation]=None, configuration: ReportConfigDatasetConfiguration=None, filter: ReportConfigFilter=None, granularity: str=None, grouping: List[ReportConfigGrouping]=None):
