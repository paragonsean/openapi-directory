...
/*
 * OAIReportComparisonExpression.h
 *
 * The comparison expression to be used in the report.
 */

#ifndef OAIReportComparisonExpression_H
#define OAIReportComparisonExpression_H
...
class OAIReportComparisonExpression : public OAIObject {
public:
    OAIReportComparisonExpression();
    OAIReportComparisonExpression(QString json);
    ~OAIReportComparisonExpression() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportComparisonExpression)

#endif // OAIReportComparisonExpression_H
