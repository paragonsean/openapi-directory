...
public:
    ...
    OAIReportProperties getProperties() const;
    void setProperties(const OAIReportProperties &properties);
...
private:
    ...
    OAIReportProperties m_properties;
