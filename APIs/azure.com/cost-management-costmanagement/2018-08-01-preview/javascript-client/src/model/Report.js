...
class Report {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ReportProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ReportProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ReportProperties} properties
 */
 ...
 */
Report.prototype['tags'] = undefined;
