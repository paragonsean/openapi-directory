...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new CostManagementClient.OperationDisplay();
      //expect(instance).to.be.a(CostManagementClient.OperationDisplay);
    });
