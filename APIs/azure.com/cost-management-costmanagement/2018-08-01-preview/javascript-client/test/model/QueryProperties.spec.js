...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.QueryProperties();
  });
  ...
  describe('QueryProperties', function() {
    it('should create an instance of QueryProperties', function() {
      // uncomment below and update the code to test QueryProperties
      //var instance = new CostManagementClient.QueryProperties();
      //expect(instance).to.be.a(CostManagementClient.QueryProperties);
    });
