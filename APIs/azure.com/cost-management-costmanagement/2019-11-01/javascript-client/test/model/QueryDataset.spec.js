...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.QueryDataset();
  });
  ...
  describe('QueryDataset', function() {
    it('should create an instance of QueryDataset', function() {
      // uncomment below and update the code to test QueryDataset
      //var instance = new CostManagementClient.QueryDataset();
      //expect(instance).to.be.a(CostManagementClient.QueryDataset);
    });
