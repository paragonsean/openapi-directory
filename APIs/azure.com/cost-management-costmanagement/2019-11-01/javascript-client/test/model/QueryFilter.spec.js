...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CostManagementClient.QueryFilter();
  });
  ...
  describe('QueryFilter', function() {
    it('should create an instance of QueryFilter', function() {
      ...
      //var instance = new CostManagementClient.QueryFilter();
      //expect(instance).to.be.a(CostManagementClient.QueryFilter);
    });
