...
public class OperationsApi {
     ...
     * @param apiVersion Version of the API to be used with the client request. The current version is 2019-11-01. (required)
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.CostManagement/operations";
