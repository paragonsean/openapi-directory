...
OAIDimensionProperties OAIDimension::getProperties() const {
    return m_properties;
}
void OAIDimension::setProperties(const OAIDimensionProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIDimension::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIDimension::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIDimension::getId() const {
    return m_id;
}
void OAIDimension::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDimension::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDimension::is_id_Valid() const{
    return m_id_isValid;
}
...
QMap<QString, QString> OAIDimension::getTags() const {
    return m_tags;
}
void OAIDimension::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDimension::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDimension::is_tags_Valid() const{
