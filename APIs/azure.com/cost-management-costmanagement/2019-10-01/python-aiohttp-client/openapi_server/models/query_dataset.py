...
from openapi_server.models.query_sorting_configuration import QuerySortingConfiguration
...
class QueryDataset(Model):
    ...
    def __init__(self, aggregation: Dict[str, QueryAggregation]=None, configuration: QueryDatasetConfiguration=None, filter: QueryFilter=None, granularity: str=None, grouping: List[QueryGrouping]=None, sorting: List[QuerySortingConfiguration]=None):
        ...
        :param sorting: The sorting of this QueryDataset.
        """
        self.openapi_types = {
            ...
            'sorting': List[QuerySortingConfiguration]
        }
    ...
    @property
    def sorting(self):
        """Gets the sorting of this QueryDataset.

        Array of sorting by columns in query.

        :return: The sorting of this QueryDataset.
        :rtype: List[QuerySortingConfiguration]
        """
        return self._sorting

    @sorting.setter
    def sorting(self, sorting):
        """Sets the sorting of this QueryDataset.

        Array of sorting by columns in query.

        :param sorting: The sorting of this QueryDataset.
        :type sorting: List[QuerySortingConfiguration]
        """
