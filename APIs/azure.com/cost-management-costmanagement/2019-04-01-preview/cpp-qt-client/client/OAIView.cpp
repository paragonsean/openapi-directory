...
QString OAIView::getETag() const {
    return m_e_tag;
}
void OAIView::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIView::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIView::is_e_tag_Valid() const{
...
QString OAIView::getType() const {
    return m_type;
}
void OAIView::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIView::is_type_Set() const{
    return m_type_isSet;
}

bool OAIView::is_type_Valid() const{
