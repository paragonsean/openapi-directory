...
OAIReportConfigFilter OAIBudgetProperties::getFilter() const {
    return m_filter;
}
void OAIBudgetProperties::setFilter(const OAIReportConfigFilter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIBudgetProperties::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIBudgetProperties::is_filter_Valid() const{
