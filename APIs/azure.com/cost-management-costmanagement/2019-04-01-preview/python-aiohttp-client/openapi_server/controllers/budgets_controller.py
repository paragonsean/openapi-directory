...
async def budget_create_or_update(request: web.Request, scope, api_version, budget_name, parameters=None) -> web.Response:
    ...
    """
    parameters = BudgetModel.from_dict(parameters)
    return web.Response(status=200)


async def budget_delete(request: web.Request, scope, api_version, budget_name) -> web.Response:
    """budget_delete
...
async def budget_get(request: web.Request, scope, api_version, budget_name) -> web.Response:
    """budget_get
