...
class BudgetProperties(Model):
    ...
    def __init__(self, amount: float=None, category: str=None, current_spend: CurrentSpend=None, filter: ReportConfigFilter=None, notifications: Dict[str, Notification]=None, time_grain: str=None, time_period: BudgetTimePeriod=None):
        ...
        :param filter: The filter of this BudgetProperties.
    ...
    @property
    def filter(self):
        """Gets the filter of this BudgetProperties.


        :return: The filter of this BudgetProperties.
    ...
    def filter(self, filter):
        """Sets the filter of this BudgetProperties.
