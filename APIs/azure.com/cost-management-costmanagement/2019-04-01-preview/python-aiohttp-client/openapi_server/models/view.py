...
class View(Model):
    ...
    def __init__(self, properties: ViewProperties=None, e_tag: str=None, id: str=None, name: str=None, type: str=None):
        """View - a model defined in OpenAPI

        :param properties: The properties of this View.
        :param e_tag: The e_tag of this View.
    ...
    @property
    def e_tag(self):
        """Gets the e_tag of this View.

        eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.

        :return: The e_tag of this View.
        :rtype: str
        """
        return self._e_tag
