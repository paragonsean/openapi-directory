...
public class Scope {
  public static final String SERIALIZED_NAME_CHILD_SCOPE = "childScope";
  @SerializedName(SERIALIZED_NAME_CHILD_SCOPE)
  ...
  public Scope childScope(Scope childScope) {
  ...
  public boolean equals(Object o) {
    ...
    Scope scope = (Scope) o;
    return Objects.equals(this.childScope, scope.childScope) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(childScope, id, name, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    childScope: ").append(toIndentedString(childScope)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("childScope") != null && !jsonObj.get("childScope").isJsonNull()) {
        Scope.validateJsonElement(jsonObj.get("childScope"));
      }
