...
<a id="budgetCreateOrUpdate"></a>
# **budgetCreateOrUpdate**
> BudgetModel budgetCreateOrUpdate(scope, apiVersion, budgetName, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    String budgetName = "budgetName_example"; // String | Budget Name.
    try {
      apiInstance.budgetDelete(scope, apiVersion, budgetName);
    } catch (ApiException e) {
      System.err.println("Exception when calling BudgetsApi#budgetDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String budgetName = "budgetName_example"; // String | Budget Name.
    try {
      BudgetModel result = apiInstance.budgetGet(scope, apiVersion, budgetName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BudgetsApi#budgetGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
