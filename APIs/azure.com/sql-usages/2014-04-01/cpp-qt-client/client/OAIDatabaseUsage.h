...
#ifndef OAIDatabaseUsage_H
#define OAIDatabaseUsage_H
...
class OAIDatabaseUsage : public OAIObject {
public:
    OAIDatabaseUsage();
    OAIDatabaseUsage(QString json);
    ~OAIDatabaseUsage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseUsage)

#endif // OAIDatabaseUsage_H
