...
public class DatabasesApiTest {
     ...
     */
    @Test
    public void databaseUsagesListByDatabaseTest() throws ApiException {
        String apiVersion = null;
        String subscriptionId = null;
        String resourceGroupName = null;
        String serverName = null;
        String databaseName = null;
        DatabaseUsageListResult response = api.databaseUsagesListByDatabase(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName);
