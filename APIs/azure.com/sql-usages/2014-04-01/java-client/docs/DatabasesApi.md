...
<a id="databaseUsagesListByDatabase"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DatabaseUsageListResult result = apiInstance.databaseUsagesListByDatabase(apiVersion, subscriptionId, resourceGroupName, serverName, databaseName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabasesApi#databaseUsagesListByDatabase");
