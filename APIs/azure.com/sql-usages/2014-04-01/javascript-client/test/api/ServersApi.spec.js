...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.ServersApi();
  });
  ...
  describe('ServersApi', function() {
    describe('serverUsagesListByServer', function() {
      it('should call serverUsagesListByServer successfully', function(done) {
        //uncomment below and update the code to test serverUsagesListByServer
        //instance.serverUsagesListByServer(function(error) {
