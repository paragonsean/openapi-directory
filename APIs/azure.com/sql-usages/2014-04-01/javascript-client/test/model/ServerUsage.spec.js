...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.ServerUsage();
  });
  ...
  describe('ServerUsage', function() {
    it('should create an instance of ServerUsage', function() {
      // uncomment below and update the code to test ServerUsage
      //var instance = new AzureSqlDatabase.ServerUsage();
      //expect(instance).to.be.a(AzureSqlDatabase.ServerUsage);
    });
