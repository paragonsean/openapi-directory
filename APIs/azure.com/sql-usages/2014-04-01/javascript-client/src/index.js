...
import DatabaseUsageListResult from './model/DatabaseUsageListResult';
import ServerUsage from './model/ServerUsage';
...
export {
    ...
    /**
     * The DatabaseUsage model constructor.
     * @property {module:model/DatabaseUsage}
     */
    DatabaseUsage,

    /**
     * The DatabaseUsageListResult model constructor.
     * @property {module:model/DatabaseUsageListResult}
     */
    DatabaseUsageListResult,

    /**
     * The ServerUsage model constructor.
     * @property {module:model/ServerUsage}
     */
    ServerUsage,

    /**
     * The ServerUsageListResult model constructor.
     * @property {module:model/ServerUsageListResult}
     */
