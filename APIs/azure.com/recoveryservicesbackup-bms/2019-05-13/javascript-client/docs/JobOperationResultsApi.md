...
let jobName = "jobName_example"; // String | Job name whose operation result has to be fetched.
let operationId = "operationId_example"; // String | OperationID which represents the operation whose result has to be fetched.
