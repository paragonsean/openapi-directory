...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.AzureVmWorkloadProtectedItemExtendedInfo();
  });
  ...
  describe('AzureVmWorkloadProtectedItemExtendedInfo', function() {
    it('should create an instance of AzureVmWorkloadProtectedItemExtendedInfo', function() {
      // uncomment below and update the code to test AzureVmWorkloadProtectedItemExtendedInfo
      //var instance = new RecoveryServicesBackupClient.AzureVmWorkloadProtectedItemExtendedInfo();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.AzureVmWorkloadProtectedItemExtendedInfo);
    });
