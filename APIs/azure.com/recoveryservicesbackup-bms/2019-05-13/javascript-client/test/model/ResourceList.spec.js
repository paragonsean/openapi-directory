...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.ResourceList();
  });
  ...
  describe('ResourceList', function() {
    it('should create an instance of ResourceList', function() {
      // uncomment below and update the code to test ResourceList
      //var instance = new RecoveryServicesBackupClient.ResourceList();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.ResourceList);
    });
