...
/*
 * OAIAzureFileShareProtectionPolicy.h
 *
 * AzureStorage backup policy.
 */

#ifndef OAIAzureFileShareProtectionPolicy_H
#define OAIAzureFileShareProtectionPolicy_H
...
class OAIAzureFileShareProtectionPolicy : public OAIObject {
public:
    OAIAzureFileShareProtectionPolicy();
    OAIAzureFileShareProtectionPolicy(QString json);
    ~OAIAzureFileShareProtectionPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureFileShareProtectionPolicy)

#endif // OAIAzureFileShareProtectionPolicy_H
