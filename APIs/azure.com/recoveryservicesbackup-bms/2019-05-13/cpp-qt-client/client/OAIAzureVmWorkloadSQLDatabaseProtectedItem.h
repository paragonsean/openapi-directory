...
/*
 * OAIAzureVmWorkloadSQLDatabaseProtectedItem.h
 *
 * Azure VM workload-specific protected item representing SQL Database.
 */

#ifndef OAIAzureVmWorkloadSQLDatabaseProtectedItem_H
#define OAIAzureVmWorkloadSQLDatabaseProtectedItem_H
...
class OAIAzureVmWorkloadSQLDatabaseProtectedItem : public OAIObject {
public:
    OAIAzureVmWorkloadSQLDatabaseProtectedItem();
    OAIAzureVmWorkloadSQLDatabaseProtectedItem(QString json);
    ~OAIAzureVmWorkloadSQLDatabaseProtectedItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureVmWorkloadSQLDatabaseProtectedItem)

#endif // OAIAzureVmWorkloadSQLDatabaseProtectedItem_H
