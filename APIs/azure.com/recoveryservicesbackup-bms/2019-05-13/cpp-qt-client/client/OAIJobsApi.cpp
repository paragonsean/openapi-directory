...
void OAIJobsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("jobsExport", defaultConf);
    _serverIndices.insert("jobsExport", 0);
}
...
void OAIJobsApi::jobsExport(const QString &api_version, const QString &vault_name, const QString &resource_group_name, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["jobsExport"][_serverIndices.value("jobsExport")].URL()+"/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobsExport");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIJobsApi::jobsExportCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIJobsApi::jobsExportCallback);
...
void OAIJobsApi::jobsExportCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT jobsExportSignal();
        Q_EMIT jobsExportSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT jobsExportSignalE(error_type, error_str);
        Q_EMIT jobsExportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT jobsExportSignalError(error_type, error_str);
        Q_EMIT jobsExportSignalErrorFull(worker, error_type, error_str);
    }
}
