...
class BackupResourceConfig(Model):
    ...
    def __init__(self, storage_model_type: str=None, storage_type: str=None, storage_type_state: str=None):
        """BackupResourceConfig - a model defined in OpenAPI

        :param storage_model_type: The storage_model_type of this BackupResourceConfig.
        :param storage_type: The storage_type of this BackupResourceConfig.
        :param storage_type_state: The storage_type_state of this BackupResourceConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BackupResourceConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BackupResourceConfig of this BackupResourceConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def storage_model_type(self):
        """Gets the storage_model_type of this BackupResourceConfig.

        Storage type

        :return: The storage_model_type of this BackupResourceConfig.
        :rtype: str
        """
    ...
    def storage_model_type(self, storage_model_type):
        """Sets the storage_model_type of this BackupResourceConfig.
    ...
    def storage_type(self):
        """Gets the storage_type of this BackupResourceConfig.

        Storage type.

        :return: The storage_type of this BackupResourceConfig.
        :rtype: str
        """
    ...
    def storage_type(self, storage_type):
        """Sets the storage_type of this BackupResourceConfig.
    ...
    def storage_type_state(self):
        """Gets the storage_type_state of this BackupResourceConfig.

        Locked or Unlocked. Once a machine is registered against a resource, the storageTypeState is always Locked.

        :return: The storage_type_state of this BackupResourceConfig.
        :rtype: str
        """
    ...
    def storage_type_state(self, storage_type_state):
        """Sets the storage_type_state of this BackupResourceConfig.
