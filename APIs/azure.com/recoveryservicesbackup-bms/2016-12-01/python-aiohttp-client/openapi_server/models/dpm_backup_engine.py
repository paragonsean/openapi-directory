...
class DpmBackupEngine(Model):
    ...
    def __init__(self, azure_backup_agent_version: str=None, backup_engine_id: str=None, backup_engine_state: str=None, backup_engine_type: str=None, backup_management_type: str=None, can_re_register: bool=None, dpm_version: str=None, extended_info: BackupEngineExtendedInfo=None, friendly_name: str=None, health_status: str=None, is_azure_backup_agent_upgrade_available: bool=None, is_dpm_upgrade_available: bool=None, registration_status: str=None):
        ...
        :param azure_backup_agent_version: The azure_backup_agent_version of this DpmBackupEngine.
        :param backup_engine_id: The backup_engine_id of this DpmBackupEngine.
        :param backup_engine_state: The backup_engine_state of this DpmBackupEngine.
        ...
        :param dpm_version: The dpm_version of this DpmBackupEngine.
        :param extended_info: The extended_info of this DpmBackupEngine.
        ...
        :param is_azure_backup_agent_upgrade_available: The is_azure_backup_agent_upgrade_available of this DpmBackupEngine.
        :param is_dpm_upgrade_available: The is_dpm_upgrade_available of this DpmBackupEngine.
    ...
    def azure_backup_agent_version(self):
        """Gets the azure_backup_agent_version of this DpmBackupEngine.

        Backup agent version

        :return: The azure_backup_agent_version of this DpmBackupEngine.
        :rtype: str
        """
    ...
    def azure_backup_agent_version(self, azure_backup_agent_version):
        """Sets the azure_backup_agent_version of this DpmBackupEngine.
    ...
    def backup_engine_state(self):
        """Gets the backup_engine_state of this DpmBackupEngine.

        Status of the backup engine with the Recovery Services Vault. = {Active/Deleting/DeleteFailed}

        :return: The backup_engine_state of this DpmBackupEngine.
        :rtype: str
        """
    ...
    def backup_engine_state(self, backup_engine_state):
        """Sets the backup_engine_state of this DpmBackupEngine.
    ...
    def dpm_version(self):
        """Gets the dpm_version of this DpmBackupEngine.

        Backup engine version

        :return: The dpm_version of this DpmBackupEngine.
        :rtype: str
        """
    ...
    def dpm_version(self, dpm_version):
        """Sets the dpm_version of this DpmBackupEngine.
    ...
    def extended_info(self):
        """Gets the extended_info of this DpmBackupEngine.


        :return: The extended_info of this DpmBackupEngine.
    ...
    def extended_info(self, extended_info):
        """Sets the extended_info of this DpmBackupEngine.
    ...
    def is_azure_backup_agent_upgrade_available(self):
        """Gets the is_azure_backup_agent_upgrade_available of this DpmBackupEngine.

        To check if backup agent upgrade available

        :return: The is_azure_backup_agent_upgrade_available of this DpmBackupEngine.
        :rtype: bool
        """
    ...
    def is_azure_backup_agent_upgrade_available(self, is_azure_backup_agent_upgrade_available):
        """Sets the is_azure_backup_agent_upgrade_available of this DpmBackupEngine.
    ...
    def is_dpm_upgrade_available(self):
        """Gets the is_dpm_upgrade_available of this DpmBackupEngine.

        To check if backup engine upgrade available

        :return: The is_dpm_upgrade_available of this DpmBackupEngine.
        :rtype: bool
        """
    ...
    def is_dpm_upgrade_available(self, is_dpm_upgrade_available):
        """Sets the is_dpm_upgrade_available of this DpmBackupEngine.
