...
class DpmContainer(Model):
    ...
    def __init__(self, can_re_register: bool=None, container_id: str=None, dpm_agent_version: str=None, dpm_servers: List[str]=None, extended_info: DPMContainerExtendedInfo=None, protected_item_count: int=None, protection_status: str=None, upgrade_available: bool=None, backup_management_type: str=None, container_type: str=None, friendly_name: str=None, health_status: str=None, registration_status: str=None):
        """DpmContainer - a model defined in OpenAPI

        :param can_re_register: The can_re_register of this DpmContainer.
        :param container_id: The container_id of this DpmContainer.
        :param dpm_agent_version: The dpm_agent_version of this DpmContainer.
        :param dpm_servers: The dpm_servers of this DpmContainer.
        :param extended_info: The extended_info of this DpmContainer.
        :param protected_item_count: The protected_item_count of this DpmContainer.
        :param protection_status: The protection_status of this DpmContainer.
        :param upgrade_available: The upgrade_available of this DpmContainer.
        :param backup_management_type: The backup_management_type of this DpmContainer.
        :param container_type: The container_type of this DpmContainer.
        :param friendly_name: The friendly_name of this DpmContainer.
        :param health_status: The health_status of this DpmContainer.
        :param registration_status: The registration_status of this DpmContainer.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DpmContainer':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DpmContainer of this DpmContainer.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def can_re_register(self):
        """Gets the can_re_register of this DpmContainer.

        Specifies whether the container is re-registrable.

        :return: The can_re_register of this DpmContainer.
        :rtype: bool
        """
    ...
    def can_re_register(self, can_re_register):
        """Sets the can_re_register of this DpmContainer.
    ...
    def container_id(self):
        """Gets the container_id of this DpmContainer.

        ID of container.

        :return: The container_id of this DpmContainer.
        :rtype: str
        """
    ...
    def container_id(self, container_id):
        """Sets the container_id of this DpmContainer.
    ...
    def dpm_agent_version(self):
        """Gets the dpm_agent_version of this DpmContainer.

        Backup engine Agent version

        :return: The dpm_agent_version of this DpmContainer.
        :rtype: str
        """
    ...
    def dpm_agent_version(self, dpm_agent_version):
        """Sets the dpm_agent_version of this DpmContainer.
    ...
    def dpm_servers(self):
        """Gets the dpm_servers of this DpmContainer.

        List of BackupEngines protecting the container

        :return: The dpm_servers of this DpmContainer.
        :rtype: List[str]
        """
    ...
    def dpm_servers(self, dpm_servers):
        """Sets the dpm_servers of this DpmContainer.
    ...
    def extended_info(self):
        """Gets the extended_info of this DpmContainer.


        :return: The extended_info of this DpmContainer.
    ...
    def extended_info(self, extended_info):
        """Sets the extended_info of this DpmContainer.
    ...
    def protected_item_count(self):
        """Gets the protected_item_count of this DpmContainer.

        Number of protected items in the BackupEngine

        :return: The protected_item_count of this DpmContainer.
        :rtype: int
        """
    ...
    def protected_item_count(self, protected_item_count):
        """Sets the protected_item_count of this DpmContainer.
    ...
    def protection_status(self):
        """Gets the protection_status of this DpmContainer.

        Protection status of the container.

        :return: The protection_status of this DpmContainer.
        :rtype: str
        """
    ...
    def protection_status(self, protection_status):
        """Sets the protection_status of this DpmContainer.
    ...
    def upgrade_available(self):
        """Gets the upgrade_available of this DpmContainer.

        To check if upgrade available

        :return: The upgrade_available of this DpmContainer.
        :rtype: bool
        """
    ...
    def upgrade_available(self, upgrade_available):
        """Sets the upgrade_available of this DpmContainer.
    ...
    def backup_management_type(self):
        """Gets the backup_management_type of this DpmContainer.

        Type of backup management for the container.

        :return: The backup_management_type of this DpmContainer.
        :rtype: str
        """
    ...
    def backup_management_type(self, backup_management_type):
        """Sets the backup_management_type of this DpmContainer.
    ...
    def container_type(self):
        """Gets the container_type of this DpmContainer.
        ...
        :return: The container_type of this DpmContainer.
        :rtype: str
        """
    ...
    def container_type(self, container_type):
        """Sets the container_type of this DpmContainer.
    ...
    def friendly_name(self):
        """Gets the friendly_name of this DpmContainer.

        Friendly name of the container.

        :return: The friendly_name of this DpmContainer.
        :rtype: str
        """
    ...
    def friendly_name(self, friendly_name):
        """Sets the friendly_name of this DpmContainer.
    ...
    def health_status(self):
        """Gets the health_status of this DpmContainer.

        Status of health of the container.

        :return: The health_status of this DpmContainer.
        :rtype: str
        """
    ...
    def health_status(self, health_status):
        """Sets the health_status of this DpmContainer.
    ...
    def registration_status(self):
        """Gets the registration_status of this DpmContainer.

        Status of registration of the container with the Recovery Services Vault.

        :return: The registration_status of this DpmContainer.
        :rtype: str
        """
    ...
    def registration_status(self, registration_status):
        """Sets the registration_status of this DpmContainer.
