...
#ifndef OAIWorkloadItem_H
#define OAIWorkloadItem_H
...
class OAIWorkloadItem : public OAIObject {
public:
    OAIWorkloadItem();
    OAIWorkloadItem(QString json);
    ~OAIWorkloadItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkloadItem)

#endif // OAIWorkloadItem_H
