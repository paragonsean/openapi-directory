...
QString OAIAzureIaaSClassicComputeVMProtectableItem::getWorkloadType() const {
    return m_workload_type;
}
void OAIAzureIaaSClassicComputeVMProtectableItem::setWorkloadType(const QString &workload_type) {
    m_workload_type = workload_type;
    m_workload_type_isSet = true;
}

bool OAIAzureIaaSClassicComputeVMProtectableItem::is_workload_type_Set() const{
    return m_workload_type_isSet;
}

bool OAIAzureIaaSClassicComputeVMProtectableItem::is_workload_type_Valid() const{
