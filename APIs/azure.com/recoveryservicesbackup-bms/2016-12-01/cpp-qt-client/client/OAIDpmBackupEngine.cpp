...
QString OAIDpmBackupEngine::getAzureBackupAgentVersion() const {
    return m_azure_backup_agent_version;
}
void OAIDpmBackupEngine::setAzureBackupAgentVersion(const QString &azure_backup_agent_version) {
    m_azure_backup_agent_version = azure_backup_agent_version;
    m_azure_backup_agent_version_isSet = true;
}

bool OAIDpmBackupEngine::is_azure_backup_agent_version_Set() const{
    return m_azure_backup_agent_version_isSet;
}

bool OAIDpmBackupEngine::is_azure_backup_agent_version_Valid() const{
...
QString OAIDpmBackupEngine::getBackupEngineState() const {
    return m_backup_engine_state;
}
void OAIDpmBackupEngine::setBackupEngineState(const QString &backup_engine_state) {
    m_backup_engine_state = backup_engine_state;
    m_backup_engine_state_isSet = true;
}

bool OAIDpmBackupEngine::is_backup_engine_state_Set() const{
    return m_backup_engine_state_isSet;
}

bool OAIDpmBackupEngine::is_backup_engine_state_Valid() const{
...
QString OAIDpmBackupEngine::getDpmVersion() const {
    return m_dpm_version;
}
void OAIDpmBackupEngine::setDpmVersion(const QString &dpm_version) {
    m_dpm_version = dpm_version;
    m_dpm_version_isSet = true;
}

bool OAIDpmBackupEngine::is_dpm_version_Set() const{
    return m_dpm_version_isSet;
}

bool OAIDpmBackupEngine::is_dpm_version_Valid() const{
    return m_dpm_version_isValid;
}

OAIBackupEngineExtendedInfo OAIDpmBackupEngine::getExtendedInfo() const {
    return m_extended_info;
}
void OAIDpmBackupEngine::setExtendedInfo(const OAIBackupEngineExtendedInfo &extended_info) {
    m_extended_info = extended_info;
    m_extended_info_isSet = true;
}

bool OAIDpmBackupEngine::is_extended_info_Set() const{
    return m_extended_info_isSet;
}

bool OAIDpmBackupEngine::is_extended_info_Valid() const{
...
bool OAIDpmBackupEngine::isIsAzureBackupAgentUpgradeAvailable() const {
    return m_is_azure_backup_agent_upgrade_available;
}
void OAIDpmBackupEngine::setIsAzureBackupAgentUpgradeAvailable(const bool &is_azure_backup_agent_upgrade_available) {
...
bool OAIDpmBackupEngine::is_is_azure_backup_agent_upgrade_available_Set() const{
    return m_is_azure_backup_agent_upgrade_available_isSet;
}

bool OAIDpmBackupEngine::is_is_azure_backup_agent_upgrade_available_Valid() const{
    return m_is_azure_backup_agent_upgrade_available_isValid;
}

bool OAIDpmBackupEngine::isIsDpmUpgradeAvailable() const {
    return m_is_dpm_upgrade_available;
}
void OAIDpmBackupEngine::setIsDpmUpgradeAvailable(const bool &is_dpm_upgrade_available) {
    m_is_dpm_upgrade_available = is_dpm_upgrade_available;
    m_is_dpm_upgrade_available_isSet = true;
}

bool OAIDpmBackupEngine::is_is_dpm_upgrade_available_Set() const{
    return m_is_dpm_upgrade_available_isSet;
}

bool OAIDpmBackupEngine::is_is_dpm_upgrade_available_Valid() const{
