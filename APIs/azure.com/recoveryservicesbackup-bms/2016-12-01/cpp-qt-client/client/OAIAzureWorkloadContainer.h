...
/*
 * OAIAzureWorkloadContainer.h
 *
 * Container for the workloads running inside Azure Compute or Classic Compute.
 */

#ifndef OAIAzureWorkloadContainer_H
#define OAIAzureWorkloadContainer_H
...
class OAIAzureWorkloadContainer : public OAIObject {
public:
    OAIAzureWorkloadContainer();
    OAIAzureWorkloadContainer(QString json);
    ~OAIAzureWorkloadContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureWorkloadContainer)

#endif // OAIAzureWorkloadContainer_H
