...
QString OAIAzureIaaSComputeVMProtectableItem::getWorkloadType() const {
    return m_workload_type;
}
void OAIAzureIaaSComputeVMProtectableItem::setWorkloadType(const QString &workload_type) {
    m_workload_type = workload_type;
    m_workload_type_isSet = true;
}

bool OAIAzureIaaSComputeVMProtectableItem::is_workload_type_Set() const{
    return m_workload_type_isSet;
}

bool OAIAzureIaaSComputeVMProtectableItem::is_workload_type_Valid() const{
