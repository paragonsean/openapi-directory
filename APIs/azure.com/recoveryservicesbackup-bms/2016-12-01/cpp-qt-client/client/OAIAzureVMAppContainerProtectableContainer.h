...
/*
 * OAIAzureVMAppContainerProtectableContainer.h
 *
 * Azure workload-specific container
 */

#ifndef OAIAzureVMAppContainerProtectableContainer_H
#define OAIAzureVMAppContainerProtectableContainer_H
...
class OAIAzureVMAppContainerProtectableContainer : public OAIObject {
public:
    OAIAzureVMAppContainerProtectableContainer();
    OAIAzureVMAppContainerProtectableContainer(QString json);
    ~OAIAzureVMAppContainerProtectableContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureVMAppContainerProtectableContainer)

#endif // OAIAzureVMAppContainerProtectableContainer_H
