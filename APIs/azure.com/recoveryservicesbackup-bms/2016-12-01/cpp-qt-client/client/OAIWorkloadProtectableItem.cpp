...
QString OAIWorkloadProtectableItem::getWorkloadType() const {
    return m_workload_type;
}
void OAIWorkloadProtectableItem::setWorkloadType(const QString &workload_type) {
    m_workload_type = workload_type;
    m_workload_type_isSet = true;
}

bool OAIWorkloadProtectableItem::is_workload_type_Set() const{
    return m_workload_type_isSet;
}

bool OAIWorkloadProtectableItem::is_workload_type_Valid() const{
