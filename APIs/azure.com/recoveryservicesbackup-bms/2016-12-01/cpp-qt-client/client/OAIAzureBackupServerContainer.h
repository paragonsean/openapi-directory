...
/*
 * OAIAzureBackupServerContainer.h
 *
 * AzureBackupServer (DPMVenus) workload-specific protection container.
 */

#ifndef OAIAzureBackupServerContainer_H
#define OAIAzureBackupServerContainer_H
...
class OAIAzureBackupServerContainer : public OAIObject {
public:
    OAIAzureBackupServerContainer();
    OAIAzureBackupServerContainer(QString json);
    ~OAIAzureBackupServerContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureBackupServerContainer)

#endif // OAIAzureBackupServerContainer_H
