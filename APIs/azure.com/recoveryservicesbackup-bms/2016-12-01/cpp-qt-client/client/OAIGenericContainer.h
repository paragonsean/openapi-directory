...
/*
 * OAIGenericContainer.h
 *
 * Base class for generic container of backup items
 */

#ifndef OAIGenericContainer_H
#define OAIGenericContainer_H
...
namespace OpenAPI {
class OAIGenericContainerExtendedInfo;

class OAIGenericContainer : public OAIObject {
public:
    OAIGenericContainer();
    OAIGenericContainer(QString json);
    ~OAIGenericContainer() override;
    ...
    OAIGenericContainerExtendedInfo getExtendedInformation() const;
    void setExtendedInformation(const OAIGenericContainerExtendedInfo &extended_information);
    bool is_extended_information_Set() const;
    bool is_extended_information_Valid() const;
...
private:
    ...
    OAIGenericContainerExtendedInfo m_extended_information;
    bool m_extended_information_isSet;
    bool m_extended_information_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericContainer)

#endif // OAIGenericContainer_H
