...
QList<QString> OAIErrorDetail::getRecommendations() const {
    return m_recommendations;
}
void OAIErrorDetail::setRecommendations(const QList<QString> &recommendations) {
    m_recommendations = recommendations;
    m_recommendations_isSet = true;
}

bool OAIErrorDetail::is_recommendations_Set() const{
    return m_recommendations_isSet;
}

bool OAIErrorDetail::is_recommendations_Valid() const{
