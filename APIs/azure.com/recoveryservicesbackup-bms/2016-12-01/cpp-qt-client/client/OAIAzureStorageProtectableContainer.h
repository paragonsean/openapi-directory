...
/*
 * OAIAzureStorageProtectableContainer.h
 *
 * Azure Storage-specific protectable containers
 */

#ifndef OAIAzureStorageProtectableContainer_H
#define OAIAzureStorageProtectableContainer_H
...
class OAIAzureStorageProtectableContainer : public OAIObject {
public:
    OAIAzureStorageProtectableContainer();
    OAIAzureStorageProtectableContainer(QString json);
    ~OAIAzureStorageProtectableContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureStorageProtectableContainer)

#endif // OAIAzureStorageProtectableContainer_H
