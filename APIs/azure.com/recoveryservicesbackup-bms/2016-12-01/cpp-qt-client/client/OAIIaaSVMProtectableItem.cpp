...
OAIIaaSVMProtectableItem::OAIIaaSVMProtectableItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIaaSVMProtectableItem::OAIIaaSVMProtectableItem() {
    this->initializeModel();
}

OAIIaaSVMProtectableItem::~OAIIaaSVMProtectableItem() {}

void OAIIaaSVMProtectableItem::initializeModel() {
...
void OAIIaaSVMProtectableItem::fromJson(QString jsonString) {
...
void OAIIaaSVMProtectableItem::fromJsonObject(QJsonObject json) {
...
QString OAIIaaSVMProtectableItem::asJson() const {
...
QJsonObject OAIIaaSVMProtectableItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIaaSVMProtectableItem::getVirtualMachineId() const {
    return m_virtual_machine_id;
}
void OAIIaaSVMProtectableItem::setVirtualMachineId(const QString &virtual_machine_id) {
    m_virtual_machine_id = virtual_machine_id;
    m_virtual_machine_id_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_virtual_machine_id_Set() const{
    return m_virtual_machine_id_isSet;
}

bool OAIIaaSVMProtectableItem::is_virtual_machine_id_Valid() const{
    return m_virtual_machine_id_isValid;
}

QString OAIIaaSVMProtectableItem::getBackupManagementType() const {
    return m_backup_management_type;
}
void OAIIaaSVMProtectableItem::setBackupManagementType(const QString &backup_management_type) {
    m_backup_management_type = backup_management_type;
    m_backup_management_type_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_backup_management_type_Set() const{
    return m_backup_management_type_isSet;
}

bool OAIIaaSVMProtectableItem::is_backup_management_type_Valid() const{
    return m_backup_management_type_isValid;
}

QString OAIIaaSVMProtectableItem::getFriendlyName() const {
    return m_friendly_name;
}
void OAIIaaSVMProtectableItem::setFriendlyName(const QString &friendly_name) {
    m_friendly_name = friendly_name;
    m_friendly_name_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_friendly_name_Set() const{
    return m_friendly_name_isSet;
}

bool OAIIaaSVMProtectableItem::is_friendly_name_Valid() const{
    return m_friendly_name_isValid;
}

QString OAIIaaSVMProtectableItem::getProtectableItemType() const {
    return m_protectable_item_type;
}
void OAIIaaSVMProtectableItem::setProtectableItemType(const QString &protectable_item_type) {
    m_protectable_item_type = protectable_item_type;
    m_protectable_item_type_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_protectable_item_type_Set() const{
    return m_protectable_item_type_isSet;
}

bool OAIIaaSVMProtectableItem::is_protectable_item_type_Valid() const{
    return m_protectable_item_type_isValid;
}

QString OAIIaaSVMProtectableItem::getProtectionState() const {
    return m_protection_state;
}
void OAIIaaSVMProtectableItem::setProtectionState(const QString &protection_state) {
    m_protection_state = protection_state;
    m_protection_state_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_protection_state_Set() const{
    return m_protection_state_isSet;
}

bool OAIIaaSVMProtectableItem::is_protection_state_Valid() const{
    return m_protection_state_isValid;
}

QString OAIIaaSVMProtectableItem::getWorkloadType() const {
    return m_workload_type;
}
void OAIIaaSVMProtectableItem::setWorkloadType(const QString &workload_type) {
    m_workload_type = workload_type;
    m_workload_type_isSet = true;
}

bool OAIIaaSVMProtectableItem::is_workload_type_Set() const{
    return m_workload_type_isSet;
}

bool OAIIaaSVMProtectableItem::is_workload_type_Valid() const{
    return m_workload_type_isValid;
}

bool OAIIaaSVMProtectableItem::isSet() const {
...
bool OAIIaaSVMProtectableItem::isValid() const {
