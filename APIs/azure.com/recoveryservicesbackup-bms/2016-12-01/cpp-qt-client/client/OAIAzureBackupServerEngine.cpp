...
QString OAIAzureBackupServerEngine::getAzureBackupAgentVersion() const {
    return m_azure_backup_agent_version;
}
void OAIAzureBackupServerEngine::setAzureBackupAgentVersion(const QString &azure_backup_agent_version) {
    m_azure_backup_agent_version = azure_backup_agent_version;
    m_azure_backup_agent_version_isSet = true;
}

bool OAIAzureBackupServerEngine::is_azure_backup_agent_version_Set() const{
    return m_azure_backup_agent_version_isSet;
}

bool OAIAzureBackupServerEngine::is_azure_backup_agent_version_Valid() const{
...
QString OAIAzureBackupServerEngine::getBackupEngineState() const {
    return m_backup_engine_state;
}
void OAIAzureBackupServerEngine::setBackupEngineState(const QString &backup_engine_state) {
    m_backup_engine_state = backup_engine_state;
    m_backup_engine_state_isSet = true;
}

bool OAIAzureBackupServerEngine::is_backup_engine_state_Set() const{
    return m_backup_engine_state_isSet;
}

bool OAIAzureBackupServerEngine::is_backup_engine_state_Valid() const{
...
QString OAIAzureBackupServerEngine::getDpmVersion() const {
    return m_dpm_version;
}
void OAIAzureBackupServerEngine::setDpmVersion(const QString &dpm_version) {
    m_dpm_version = dpm_version;
    m_dpm_version_isSet = true;
}

bool OAIAzureBackupServerEngine::is_dpm_version_Set() const{
    return m_dpm_version_isSet;
}

bool OAIAzureBackupServerEngine::is_dpm_version_Valid() const{
    return m_dpm_version_isValid;
}

OAIBackupEngineExtendedInfo OAIAzureBackupServerEngine::getExtendedInfo() const {
    return m_extended_info;
}
void OAIAzureBackupServerEngine::setExtendedInfo(const OAIBackupEngineExtendedInfo &extended_info) {
    m_extended_info = extended_info;
    m_extended_info_isSet = true;
}

bool OAIAzureBackupServerEngine::is_extended_info_Set() const{
    return m_extended_info_isSet;
}

bool OAIAzureBackupServerEngine::is_extended_info_Valid() const{
...
bool OAIAzureBackupServerEngine::isIsAzureBackupAgentUpgradeAvailable() const {
    return m_is_azure_backup_agent_upgrade_available;
}
void OAIAzureBackupServerEngine::setIsAzureBackupAgentUpgradeAvailable(const bool &is_azure_backup_agent_upgrade_available) {
...
bool OAIAzureBackupServerEngine::is_is_azure_backup_agent_upgrade_available_Set() const{
    return m_is_azure_backup_agent_upgrade_available_isSet;
}

bool OAIAzureBackupServerEngine::is_is_azure_backup_agent_upgrade_available_Valid() const{
    return m_is_azure_backup_agent_upgrade_available_isValid;
}

bool OAIAzureBackupServerEngine::isIsDpmUpgradeAvailable() const {
    return m_is_dpm_upgrade_available;
}
void OAIAzureBackupServerEngine::setIsDpmUpgradeAvailable(const bool &is_dpm_upgrade_available) {
    m_is_dpm_upgrade_available = is_dpm_upgrade_available;
    m_is_dpm_upgrade_available_isSet = true;
}

bool OAIAzureBackupServerEngine::is_is_dpm_upgrade_available_Set() const{
    return m_is_dpm_upgrade_available_isSet;
}

bool OAIAzureBackupServerEngine::is_is_dpm_upgrade_available_Valid() const{
