# RecoveryServicesBackupClient.BackupWorkloadItemsApi
...
> WorkloadItemResourceList backupWorkloadItemsList(apiVersion, vaultName, resourceGroupName, subscriptionId, fabricName, containerName, opts)
...
let apiInstance = new RecoveryServicesBackupClient.BackupWorkloadItemsApi();
...
apiInstance.backupWorkloadItemsList(apiVersion, vaultName, resourceGroupName, subscriptionId, fabricName, containerName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
