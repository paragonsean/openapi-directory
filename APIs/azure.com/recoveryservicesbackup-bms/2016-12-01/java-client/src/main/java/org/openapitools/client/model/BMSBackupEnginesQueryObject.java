...
public class BMSBackupEnginesQueryObject {
  ...
  public BMSBackupEnginesQueryObject backupManagementType(BackupManagementTypeEnum backupManagementType) {
  ...
  public BMSBackupEnginesQueryObject expand(String expand) {
    this.expand = expand;
    return this;
  }
  ...
  public BMSBackupEnginesQueryObject friendlyName(String friendlyName) {
  ...
  public boolean equals(Object o) {
    ...
    BMSBackupEnginesQueryObject bmSBackupEnginesQueryObject = (BMSBackupEnginesQueryObject) o;
    return Objects.equals(this.backupManagementType, bmSBackupEnginesQueryObject.backupManagementType) &&
        Objects.equals(this.expand, bmSBackupEnginesQueryObject.expand) &&
        Objects.equals(this.friendlyName, bmSBackupEnginesQueryObject.friendlyName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backupManagementType, expand, friendlyName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BMSBackupEnginesQueryObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BMSBackupEnginesQueryObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BMSBackupEnginesQueryObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BMSBackupEnginesQueryObject is not found in the empty JSON string", BMSBackupEnginesQueryObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BMSBackupEnginesQueryObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BMSBackupEnginesQueryObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BMSBackupEnginesQueryObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BMSBackupEnginesQueryObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BMSBackupEnginesQueryObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BMSBackupEnginesQueryObject.class));

       return (TypeAdapter<T>) new TypeAdapter<BMSBackupEnginesQueryObject>() {
           @Override
           public void write(JsonWriter out, BMSBackupEnginesQueryObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BMSBackupEnginesQueryObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BMSBackupEnginesQueryObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BMSBackupEnginesQueryObject
   * @throws IOException if the JSON string is invalid with respect to BMSBackupEnginesQueryObject
   */
  public static BMSBackupEnginesQueryObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BMSBackupEnginesQueryObject.class);
  }

  /**
   * Convert an instance of BMSBackupEnginesQueryObject to an JSON string
   *
   * @return JSON string
   */
