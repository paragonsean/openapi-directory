...
public class BMSRefreshContainersQueryObject {
  ...
  public BMSRefreshContainersQueryObject backupManagementType(BackupManagementTypeEnum backupManagementType) {
  ...
  public boolean equals(Object o) {
    ...
    BMSRefreshContainersQueryObject bmSRefreshContainersQueryObject = (BMSRefreshContainersQueryObject) o;
    return Objects.equals(this.backupManagementType, bmSRefreshContainersQueryObject.backupManagementType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backupManagementType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BMSRefreshContainersQueryObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BMSRefreshContainersQueryObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BMSRefreshContainersQueryObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BMSRefreshContainersQueryObject is not found in the empty JSON string", BMSRefreshContainersQueryObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BMSRefreshContainersQueryObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BMSRefreshContainersQueryObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BMSRefreshContainersQueryObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BMSRefreshContainersQueryObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BMSRefreshContainersQueryObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BMSRefreshContainersQueryObject.class));

       return (TypeAdapter<T>) new TypeAdapter<BMSRefreshContainersQueryObject>() {
           @Override
           public void write(JsonWriter out, BMSRefreshContainersQueryObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BMSRefreshContainersQueryObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BMSRefreshContainersQueryObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BMSRefreshContainersQueryObject
   * @throws IOException if the JSON string is invalid with respect to BMSRefreshContainersQueryObject
   */
  public static BMSRefreshContainersQueryObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BMSRefreshContainersQueryObject.class);
  }

  /**
   * Convert an instance of BMSRefreshContainersQueryObject to an JSON string
   *
   * @return JSON string
   */
