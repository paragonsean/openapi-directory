...
class TargetRestoreInfo(Model):
    ...
    def __init__(self, container_id: str=None, database_name: str=None, overwrite_option: str=None, target_directory_for_file_restore: str=None):
        ...
        :param target_directory_for_file_restore: The target_directory_for_file_restore of this TargetRestoreInfo.
        """
        self.openapi_types = {
            'container_id': str,
            'database_name': str,
        ...
        self.attribute_map = {
            ...
            'target_directory_for_file_restore': 'targetDirectoryForFileRestore'
        }

        self._container_id = container_id
        self._database_name = database_name
        self._overwrite_option = overwrite_option
        self._target_directory_for_file_restore = target_directory_for_file_restore
    ...
    @property
    def target_directory_for_file_restore(self):
        """Gets the target_directory_for_file_restore of this TargetRestoreInfo.

        Target directory location for restore as files.

        :return: The target_directory_for_file_restore of this TargetRestoreInfo.
        :rtype: str
        """
        return self._target_directory_for_file_restore

    @target_directory_for_file_restore.setter
    def target_directory_for_file_restore(self, target_directory_for_file_restore):
        """Sets the target_directory_for_file_restore of this TargetRestoreInfo.
