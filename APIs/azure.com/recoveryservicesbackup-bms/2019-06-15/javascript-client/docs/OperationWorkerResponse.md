# RecoveryServicesBackupClient.OperationWorkerResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**headers** | **{String: [String]}** | HTTP headers associated with this operation. | [optional] 
**statusCode** | **String** | HTTP Status Code of the operation. | [optional] 
