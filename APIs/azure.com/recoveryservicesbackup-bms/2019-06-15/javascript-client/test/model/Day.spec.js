...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.Day();
  });
  ...
  describe('Day', function() {
    it('should create an instance of Day', function() {
      ...
      //var instance = new RecoveryServicesBackupClient.Day();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.Day);
    });
