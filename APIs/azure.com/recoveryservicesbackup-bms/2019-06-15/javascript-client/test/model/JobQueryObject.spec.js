...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.JobQueryObject();
  });
  ...
  describe('JobQueryObject', function() {
    it('should create an instance of JobQueryObject', function() {
      // uncomment below and update the code to test JobQueryObject
      //var instance = new RecoveryServicesBackupClient.JobQueryObject();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.JobQueryObject);
    });
