...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.AzureSqlProtectedItemExtendedInfo();
  });
  ...
  describe('AzureSqlProtectedItemExtendedInfo', function() {
    it('should create an instance of AzureSqlProtectedItemExtendedInfo', function() {
      // uncomment below and update the code to test AzureSqlProtectedItemExtendedInfo
      //var instance = new RecoveryServicesBackupClient.AzureSqlProtectedItemExtendedInfo();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.AzureSqlProtectedItemExtendedInfo);
    });
