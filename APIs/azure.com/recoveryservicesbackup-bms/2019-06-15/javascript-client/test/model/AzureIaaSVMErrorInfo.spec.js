...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.AzureIaaSVMErrorInfo();
  });
  ...
  describe('AzureIaaSVMErrorInfo', function() {
    it('should create an instance of AzureIaaSVMErrorInfo', function() {
      // uncomment below and update the code to test AzureIaaSVMErrorInfo
      //var instance = new RecoveryServicesBackupClient.AzureIaaSVMErrorInfo();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.AzureIaaSVMErrorInfo);
    });
