...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new RecoveryServicesBackupClient.ErrorDetail();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.ErrorDetail);
    });
