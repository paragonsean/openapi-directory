...
/*
 * OAIAzureWorkloadErrorInfo.h
 *
 * Azure storage specific error information
 */

#ifndef OAIAzureWorkloadErrorInfo_H
#define OAIAzureWorkloadErrorInfo_H
...
class OAIAzureWorkloadErrorInfo : public OAIObject {
public:
    OAIAzureWorkloadErrorInfo();
    OAIAzureWorkloadErrorInfo(QString json);
    ~OAIAzureWorkloadErrorInfo() override;
    ...
    QString getAdditionalDetails() const;
    void setAdditionalDetails(const QString &additional_details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureWorkloadErrorInfo)

#endif // OAIAzureWorkloadErrorInfo_H
