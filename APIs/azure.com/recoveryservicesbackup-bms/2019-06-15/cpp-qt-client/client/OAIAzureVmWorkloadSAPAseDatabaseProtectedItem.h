...
/*
 * OAIAzureVmWorkloadSAPAseDatabaseProtectedItem.h
 *
 * Azure VM workload-specific protected item representing SAP ASE Database.
 */

#ifndef OAIAzureVmWorkloadSAPAseDatabaseProtectedItem_H
#define OAIAzureVmWorkloadSAPAseDatabaseProtectedItem_H
...
class OAIAzureVmWorkloadSAPAseDatabaseProtectedItem : public OAIObject {
public:
    OAIAzureVmWorkloadSAPAseDatabaseProtectedItem();
    OAIAzureVmWorkloadSAPAseDatabaseProtectedItem(QString json);
    ~OAIAzureVmWorkloadSAPAseDatabaseProtectedItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureVmWorkloadSAPAseDatabaseProtectedItem)

#endif // OAIAzureVmWorkloadSAPAseDatabaseProtectedItem_H
