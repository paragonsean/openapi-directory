...
void OAIIaasVMRecoveryPoint::initializeModel() {
    ...
    m_is_managed_virtual_machine_isSet = false;
    m_is_managed_virtual_machine_isValid = false;
    ...
    m_recovery_point_disk_configuration_isSet = false;
    m_recovery_point_disk_configuration_isValid = false;

    m_recovery_point_tier_details_isSet = false;
    m_recovery_point_tier_details_isValid = false;
...
void OAIIaasVMRecoveryPoint::fromJsonObject(QJsonObject json) {
    ...
    m_is_managed_virtual_machine_isValid = ::OpenAPI::fromJsonValue(m_is_managed_virtual_machine, json[QString("isManagedVirtualMachine")]);
    m_is_managed_virtual_machine_isSet = !json[QString("isManagedVirtualMachine")].isNull() && m_is_managed_virtual_machine_isValid;
    ...
    m_recovery_point_disk_configuration_isValid = ::OpenAPI::fromJsonValue(m_recovery_point_disk_configuration, json[QString("recoveryPointDiskConfiguration")]);
    m_recovery_point_disk_configuration_isSet = !json[QString("recoveryPointDiskConfiguration")].isNull() && m_recovery_point_disk_configuration_isValid;

    m_recovery_point_tier_details_isValid = ::OpenAPI::fromJsonValue(m_recovery_point_tier_details, json[QString("recoveryPointTierDetails")]);
    m_recovery_point_tier_details_isSet = !json[QString("recoveryPointTierDetails")].isNull() && m_recovery_point_tier_details_isValid;
...
QJsonObject OAIIaasVMRecoveryPoint::asJsonObject() const {
    ...
    if (m_is_managed_virtual_machine_isSet) {
        obj.insert(QString("isManagedVirtualMachine"), ::OpenAPI::toJsonValue(m_is_managed_virtual_machine));
    }
    ...
    if (m_recovery_point_disk_configuration.isSet()) {
        obj.insert(QString("recoveryPointDiskConfiguration"), ::OpenAPI::toJsonValue(m_recovery_point_disk_configuration));
    }
    if (m_recovery_point_tier_details.size() > 0) {
        obj.insert(QString("recoveryPointTierDetails"), ::OpenAPI::toJsonValue(m_recovery_point_tier_details));
    }
...
bool OAIIaasVMRecoveryPoint::isIsManagedVirtualMachine() const {
    return m_is_managed_virtual_machine;
}
void OAIIaasVMRecoveryPoint::setIsManagedVirtualMachine(const bool &is_managed_virtual_machine) {
    m_is_managed_virtual_machine = is_managed_virtual_machine;
    m_is_managed_virtual_machine_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_is_managed_virtual_machine_Set() const{
    return m_is_managed_virtual_machine_isSet;
}

bool OAIIaasVMRecoveryPoint::is_is_managed_virtual_machine_Valid() const{
    return m_is_managed_virtual_machine_isValid;
}
...
bool OAIIaasVMRecoveryPoint::isOriginalStorageAccountOption() const {
    return m_original_storage_account_option;
}
void OAIIaasVMRecoveryPoint::setOriginalStorageAccountOption(const bool &original_storage_account_option) {
    m_original_storage_account_option = original_storage_account_option;
    m_original_storage_account_option_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_original_storage_account_option_Set() const{
    return m_original_storage_account_option_isSet;
}

bool OAIIaasVMRecoveryPoint::is_original_storage_account_option_Valid() const{
    return m_original_storage_account_option_isValid;
}

QString OAIIaasVMRecoveryPoint::getOsType() const {
    return m_os_type;
}
void OAIIaasVMRecoveryPoint::setOsType(const QString &os_type) {
    m_os_type = os_type;
    m_os_type_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_os_type_Set() const{
    return m_os_type_isSet;
}

bool OAIIaasVMRecoveryPoint::is_os_type_Valid() const{
...
OAIRecoveryPointDiskConfiguration OAIIaasVMRecoveryPoint::getRecoveryPointDiskConfiguration() const {
    return m_recovery_point_disk_configuration;
}
void OAIIaasVMRecoveryPoint::setRecoveryPointDiskConfiguration(const OAIRecoveryPointDiskConfiguration &recovery_point_disk_configuration) {
    m_recovery_point_disk_configuration = recovery_point_disk_configuration;
    m_recovery_point_disk_configuration_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_recovery_point_disk_configuration_Set() const{
    return m_recovery_point_disk_configuration_isSet;
}

bool OAIIaasVMRecoveryPoint::is_recovery_point_disk_configuration_Valid() const{
    return m_recovery_point_disk_configuration_isValid;
}

QList<OAIRecoveryPointTierInformation> OAIIaasVMRecoveryPoint::getRecoveryPointTierDetails() const {
    return m_recovery_point_tier_details;
}
void OAIIaasVMRecoveryPoint::setRecoveryPointTierDetails(const QList<OAIRecoveryPointTierInformation> &recovery_point_tier_details) {
    m_recovery_point_tier_details = recovery_point_tier_details;
    m_recovery_point_tier_details_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_recovery_point_tier_details_Set() const{
    return m_recovery_point_tier_details_isSet;
}

bool OAIIaasVMRecoveryPoint::is_recovery_point_tier_details_Valid() const{
    return m_recovery_point_tier_details_isValid;
}
...
QString OAIIaasVMRecoveryPoint::getVirtualMachineSize() const {
    return m_virtual_machine_size;
}
void OAIIaasVMRecoveryPoint::setVirtualMachineSize(const QString &virtual_machine_size) {
    m_virtual_machine_size = virtual_machine_size;
    m_virtual_machine_size_isSet = true;
}

bool OAIIaasVMRecoveryPoint::is_virtual_machine_size_Set() const{
    return m_virtual_machine_size_isSet;
}

bool OAIIaasVMRecoveryPoint::is_virtual_machine_size_Valid() const{
