...
void OAITargetRestoreInfo::initializeModel() {
    ...
    m_target_directory_for_file_restore_isSet = false;
    m_target_directory_for_file_restore_isValid = false;
}
...
void OAITargetRestoreInfo::fromJsonObject(QJsonObject json) {
    ...
    m_target_directory_for_file_restore_isValid = ::OpenAPI::fromJsonValue(m_target_directory_for_file_restore, json[QString("targetDirectoryForFileRestore")]);
    m_target_directory_for_file_restore_isSet = !json[QString("targetDirectoryForFileRestore")].isNull() && m_target_directory_for_file_restore_isValid;
}
...
QJsonObject OAITargetRestoreInfo::asJsonObject() const {
    ...
    if (m_target_directory_for_file_restore_isSet) {
        obj.insert(QString("targetDirectoryForFileRestore"), ::OpenAPI::toJsonValue(m_target_directory_for_file_restore));
    }
    return obj;
}
...
QString OAITargetRestoreInfo::getTargetDirectoryForFileRestore() const {
    return m_target_directory_for_file_restore;
}
void OAITargetRestoreInfo::setTargetDirectoryForFileRestore(const QString &target_directory_for_file_restore) {
    m_target_directory_for_file_restore = target_directory_for_file_restore;
    m_target_directory_for_file_restore_isSet = true;
}

bool OAITargetRestoreInfo::is_target_directory_for_file_restore_Set() const{
    return m_target_directory_for_file_restore_isSet;
}

bool OAITargetRestoreInfo::is_target_directory_for_file_restore_Valid() const{
    return m_target_directory_for_file_restore_isValid;
}
