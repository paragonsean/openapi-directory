...
/*
 * OAIAzureIaaSComputeVMProtectedItem.h
 *
 * IaaS VM workload-specific backup item representing the Azure Resource Manager VM.
 */

#ifndef OAIAzureIaaSComputeVMProtectedItem_H
#define OAIAzureIaaSComputeVMProtectedItem_H
...
class OAIAzureIaaSComputeVMProtectedItem : public OAIObject {
public:
    OAIAzureIaaSComputeVMProtectedItem();
    OAIAzureIaaSComputeVMProtectedItem(QString json);
    ~OAIAzureIaaSComputeVMProtectedItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureIaaSComputeVMProtectedItem)

#endif // OAIAzureIaaSComputeVMProtectedItem_H
