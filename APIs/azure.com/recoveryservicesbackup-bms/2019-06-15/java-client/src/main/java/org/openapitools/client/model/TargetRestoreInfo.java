...
public class TargetRestoreInfo {
  ...
  public static final String SERIALIZED_NAME_TARGET_DIRECTORY_FOR_FILE_RESTORE = "targetDirectoryForFileRestore";
  @SerializedName(SERIALIZED_NAME_TARGET_DIRECTORY_FOR_FILE_RESTORE)
  ...
  public TargetRestoreInfo targetDirectoryForFileRestore(String targetDirectoryForFileRestore) {
   ...
   * @return targetDirectoryForFileRestore
   */
  @javax.annotation.Nullable
  public String getTargetDirectoryForFileRestore() {
    return targetDirectoryForFileRestore;
  }

  public void setTargetDirectoryForFileRestore(String targetDirectoryForFileRestore) {
    this.targetDirectoryForFileRestore = targetDirectoryForFileRestore;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.containerId, targetRestoreInfo.containerId) &&
        ...
        Objects.equals(this.targetDirectoryForFileRestore, targetRestoreInfo.targetDirectoryForFileRestore);
  }

  @Override
  public int hashCode() {
    return Objects.hash(containerId, databaseName, overwriteOption, targetDirectoryForFileRestore);
  }
  ...
  public String toString() {
    ...
    sb.append("    targetDirectoryForFileRestore: ").append(toIndentedString(targetDirectoryForFileRestore)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("targetDirectoryForFileRestore");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("targetDirectoryForFileRestore") != null && !jsonObj.get("targetDirectoryForFileRestore").isJsonNull()) && !jsonObj.get("targetDirectoryForFileRestore").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `targetDirectoryForFileRestore` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetDirectoryForFileRestore").toString()));
      }
  }
