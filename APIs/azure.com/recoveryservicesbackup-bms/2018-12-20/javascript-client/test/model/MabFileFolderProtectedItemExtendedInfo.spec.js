...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.MabFileFolderProtectedItemExtendedInfo();
  });
  ...
  describe('MabFileFolderProtectedItemExtendedInfo', function() {
    it('should create an instance of MabFileFolderProtectedItemExtendedInfo', function() {
      // uncomment below and update the code to test MabFileFolderProtectedItemExtendedInfo
      //var instance = new RecoveryServicesBackupClient.MabFileFolderProtectedItemExtendedInfo();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.MabFileFolderProtectedItemExtendedInfo);
    });
