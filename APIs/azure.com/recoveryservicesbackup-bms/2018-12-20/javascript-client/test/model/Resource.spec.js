...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new RecoveryServicesBackupClient.Resource();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.Resource);
    });
