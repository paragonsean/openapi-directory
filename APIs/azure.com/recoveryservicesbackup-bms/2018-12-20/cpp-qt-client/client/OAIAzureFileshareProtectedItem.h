...
/*
 * OAIAzureFileshareProtectedItem.h
 *
 * Azure File Share workload-specific backup item.
 */

#ifndef OAIAzureFileshareProtectedItem_H
#define OAIAzureFileshareProtectedItem_H
...
namespace OpenAPI {
class OAIAzureFileshareProtectedItemExtendedInfo;

class OAIAzureFileshareProtectedItem : public OAIObject {
public:
    OAIAzureFileshareProtectedItem();
    OAIAzureFileshareProtectedItem(QString json);
    ~OAIAzureFileshareProtectedItem() override;
    ...
    OAIAzureFileshareProtectedItemExtendedInfo getExtendedInfo() const;
    void setExtendedInfo(const OAIAzureFileshareProtectedItemExtendedInfo &extended_info);
...
private:
    ...
    OAIAzureFileshareProtectedItemExtendedInfo m_extended_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureFileshareProtectedItem)

#endif // OAIAzureFileshareProtectedItem_H
