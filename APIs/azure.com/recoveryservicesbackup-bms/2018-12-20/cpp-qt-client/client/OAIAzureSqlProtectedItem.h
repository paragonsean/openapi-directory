...
/*
 * OAIAzureSqlProtectedItem.h
 *
 * Azure SQL workload-specific backup item.
 */

#ifndef OAIAzureSqlProtectedItem_H
#define OAIAzureSqlProtectedItem_H
...
namespace OpenAPI {
class OAIAzureSqlProtectedItemExtendedInfo;

class OAIAzureSqlProtectedItem : public OAIObject {
public:
    OAIAzureSqlProtectedItem();
    OAIAzureSqlProtectedItem(QString json);
    ~OAIAzureSqlProtectedItem() override;
    ...
    OAIAzureSqlProtectedItemExtendedInfo getExtendedInfo() const;
    void setExtendedInfo(const OAIAzureSqlProtectedItemExtendedInfo &extended_info);
...
private:
    ...
    OAIAzureSqlProtectedItemExtendedInfo m_extended_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureSqlProtectedItem)

#endif // OAIAzureSqlProtectedItem_H
