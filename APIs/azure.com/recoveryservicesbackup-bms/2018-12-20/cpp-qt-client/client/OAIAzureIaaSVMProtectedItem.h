...
/*
 * OAIAzureIaaSVMProtectedItem.h
 *
 * IaaS VM workload-specific backup item.
 */

#ifndef OAIAzureIaaSVMProtectedItem_H
#define OAIAzureIaaSVMProtectedItem_H
...
class OAIAzureIaaSVMProtectedItem : public OAIObject {
public:
    OAIAzureIaaSVMProtectedItem();
    OAIAzureIaaSVMProtectedItem(QString json);
    ~OAIAzureIaaSVMProtectedItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureIaaSVMProtectedItem)

#endif // OAIAzureIaaSVMProtectedItem_H
