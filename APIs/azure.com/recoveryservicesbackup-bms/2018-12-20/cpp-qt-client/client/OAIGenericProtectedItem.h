...
/*
 * OAIGenericProtectedItem.h
 *
 * Base class for backup items.
 */

#ifndef OAIGenericProtectedItem_H
#define OAIGenericProtectedItem_H
...
class OAIGenericProtectedItem : public OAIObject {
public:
    OAIGenericProtectedItem();
    OAIGenericProtectedItem(QString json);
    ~OAIGenericProtectedItem() override;
    ...
    qint64 getProtectedItemId() const;
    void setProtectedItemId(const qint64 &protected_item_id);
    bool is_protected_item_id_Set() const;
    bool is_protected_item_id_Valid() const;
    ...
    QMap<QString, QString> getSourceAssociations() const;
    void setSourceAssociations(const QMap<QString, QString> &source_associations);
    bool is_source_associations_Set() const;
    bool is_source_associations_Valid() const;
...
private:
    ...
    qint64 m_protected_item_id;
    bool m_protected_item_id_isSet;
    bool m_protected_item_id_isValid;

    QString m_protection_state;
    bool m_protection_state_isSet;
    bool m_protection_state_isValid;

    QMap<QString, QString> m_source_associations;
    bool m_source_associations_isSet;
    bool m_source_associations_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenericProtectedItem)

#endif // OAIGenericProtectedItem_H
