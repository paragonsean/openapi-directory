...
/*
 * OAIMabFileFolderProtectedItem.h
 *
 * MAB workload-specific backup item.
 */

#ifndef OAIMabFileFolderProtectedItem_H
#define OAIMabFileFolderProtectedItem_H
...
namespace OpenAPI {
class OAIMabFileFolderProtectedItemExtendedInfo;

class OAIMabFileFolderProtectedItem : public OAIObject {
public:
    OAIMabFileFolderProtectedItem();
    OAIMabFileFolderProtectedItem(QString json);
    ~OAIMabFileFolderProtectedItem() override;
    ...
    qint64 getDeferredDeleteSyncTimeInUtc() const;
    void setDeferredDeleteSyncTimeInUtc(const qint64 &deferred_delete_sync_time_in_utc);
    bool is_deferred_delete_sync_time_in_utc_Set() const;
    bool is_deferred_delete_sync_time_in_utc_Valid() const;

    OAIMabFileFolderProtectedItemExtendedInfo getExtendedInfo() const;
    void setExtendedInfo(const OAIMabFileFolderProtectedItemExtendedInfo &extended_info);
...
private:
    ...
    qint64 m_deferred_delete_sync_time_in_utc;
    bool m_deferred_delete_sync_time_in_utc_isSet;
    bool m_deferred_delete_sync_time_in_utc_isValid;

    OAIMabFileFolderProtectedItemExtendedInfo m_extended_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMabFileFolderProtectedItem)

#endif // OAIMabFileFolderProtectedItem_H
