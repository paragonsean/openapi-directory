...
/*
 * OAIDPMProtectedItem.h
 *
 * Additional information on Backup engine specific backup item.
 */

#ifndef OAIDPMProtectedItem_H
#define OAIDPMProtectedItem_H
...
namespace OpenAPI {
class OAIDPMProtectedItemExtendedInfo;

class OAIDPMProtectedItem : public OAIObject {
public:
    OAIDPMProtectedItem();
    OAIDPMProtectedItem(QString json);
    ~OAIDPMProtectedItem() override;
    ...
    OAIDPMProtectedItemExtendedInfo getExtendedInfo() const;
    void setExtendedInfo(const OAIDPMProtectedItemExtendedInfo &extended_info);
...
private:
    ...
    OAIDPMProtectedItemExtendedInfo m_extended_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDPMProtectedItem)

#endif // OAIDPMProtectedItem_H
