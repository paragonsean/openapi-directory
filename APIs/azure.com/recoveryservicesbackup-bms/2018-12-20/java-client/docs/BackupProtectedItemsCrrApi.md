...
<a id="backupProtectedItemsCrrList"></a>
# **backupProtectedItemsCrrList**
> ProtectedItemResourceList backupProtectedItemsCrrList(apiVersion, vaultName, resourceGroupName, subscriptionId, $filter, $skipToken)
...
import org.openapitools.client.api.BackupProtectedItemsCrrApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    BackupProtectedItemsCrrApi apiInstance = new BackupProtectedItemsCrrApi(defaultClient);
    ...
    try {
      ProtectedItemResourceList result = apiInstance.backupProtectedItemsCrrList(apiVersion, vaultName, resourceGroupName, subscriptionId, $filter, $skipToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BackupProtectedItemsCrrApi#backupProtectedItemsCrrList");
