...
<a id="recoveryPointsGetAccessToken"></a>
# **recoveryPointsGetAccessToken**
...
public class Example {
  public static void main(String[] args) {
    ...
    String protectedItemName = "protectedItemName_example"; // String | Name of the Protected Item.
    String recoveryPointId = "recoveryPointId_example"; // String | Recovery Point Id
    try {
      CrrAccessTokenResource result = apiInstance.recoveryPointsGetAccessToken(apiVersion, vaultName, resourceGroupName, subscriptionId, fabricName, containerName, protectedItemName, recoveryPointId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RecoveryPointsApi#recoveryPointsGetAccessToken");
