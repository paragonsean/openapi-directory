...
/*
 * OAIAzureWorkloadAutoProtectionIntent.h
 *
 * Azure Recovery Services Vault specific protection intent item.
 */

#ifndef OAIAzureWorkloadAutoProtectionIntent_H
#define OAIAzureWorkloadAutoProtectionIntent_H
...
class OAIAzureWorkloadAutoProtectionIntent : public OAIObject {
public:
    OAIAzureWorkloadAutoProtectionIntent();
    OAIAzureWorkloadAutoProtectionIntent(QString json);
    ~OAIAzureWorkloadAutoProtectionIntent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureWorkloadAutoProtectionIntent)

#endif // OAIAzureWorkloadAutoProtectionIntent_H
