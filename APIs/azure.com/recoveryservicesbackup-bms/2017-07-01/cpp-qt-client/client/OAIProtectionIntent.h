...
/*
 * OAIProtectionIntent.h
 *
 * Base class for backup ProtectionIntent.
 */

#ifndef OAIProtectionIntent_H
#define OAIProtectionIntent_H
...
class OAIProtectionIntent : public OAIObject {
public:
    OAIProtectionIntent();
    OAIProtectionIntent(QString json);
    ~OAIProtectionIntent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtectionIntent)

#endif // OAIProtectionIntent_H
