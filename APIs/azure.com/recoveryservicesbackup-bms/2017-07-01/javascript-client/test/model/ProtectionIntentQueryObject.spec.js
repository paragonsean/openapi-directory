...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.ProtectionIntentQueryObject();
  });
  ...
  describe('ProtectionIntentQueryObject', function() {
    it('should create an instance of ProtectionIntentQueryObject', function() {
      // uncomment below and update the code to test ProtectionIntentQueryObject
      //var instance = new RecoveryServicesBackupClient.ProtectionIntentQueryObject();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.ProtectionIntentQueryObject);
    });
