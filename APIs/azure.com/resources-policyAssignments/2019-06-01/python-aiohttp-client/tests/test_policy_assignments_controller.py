...
async def test_policy_assignments_create(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"name":"name","location":"location","id":"id","sku":{"tier":"tier","name":"name"},"type":"type","properties":{"policyDefinitionId":"policyDefinitionId","metadata":"{}","notScopes":["notScopes","notScopes"],"displayName":"displayName","scope":"scope","description":"description","enforcementMode":"Default","parameters":"{}"}}
