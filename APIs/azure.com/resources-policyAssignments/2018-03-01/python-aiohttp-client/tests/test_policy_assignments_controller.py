...
async def test_policy_assignments_create(client):
    ...
    """
    parameters = {"name":"name","id":"id","sku":{"tier":"tier","name":"name"},"type":"type","properties":{"policyDefinitionId":"policyDefinitionId","metadata":"{}","notScopes":["notScopes","notScopes"],"displayName":"displayName","scope":"scope","description":"description","parameters":"{}"}}
