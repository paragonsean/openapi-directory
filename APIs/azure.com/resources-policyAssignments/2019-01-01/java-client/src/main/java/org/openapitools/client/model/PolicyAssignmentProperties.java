...
public class PolicyAssignmentProperties {
  ...
  public PolicyAssignmentProperties parameters(Object parameters) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, metadata, notScopes, parameters, policyDefinitionId, scope);
  }
