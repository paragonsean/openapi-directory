...
public class PolicyAssignmentsApi {
    ...
    /**
     * Build call for policyAssignmentsListForManagementGroup
     * @param managementGroupId The ID of the management group. (required)
     * @param $filter The filter to apply on the operation. Valid values for $filter are: &#39;atScope()&#39; or &#39;policyDefinitionId eq &#39;{value}&#39;&#39;. A filter is required when listing policy assignments at management group scope. (required)
     * @param apiVersion The API version to use for the operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call policyAssignmentsListForManagementGroupCall(String managementGroupId, String $filter, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/providers/Microsoft.Management/managementgroups/{managementGroupId}/providers/Microsoft.Authorization/policyAssignments"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call policyAssignmentsListForManagementGroupValidateBeforeCall(String managementGroupId, String $filter, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'managementGroupId' is set
        if (managementGroupId == null) {
            throw new ApiException("Missing the required parameter 'managementGroupId' when calling policyAssignmentsListForManagementGroup(Async)");
        }

        // verify the required parameter '$filter' is set
        if ($filter == null) {
            throw new ApiException("Missing the required parameter '$filter' when calling policyAssignmentsListForManagementGroup(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling policyAssignmentsListForManagementGroup(Async)");
        }

        return policyAssignmentsListForManagementGroupCall(managementGroupId, $filter, apiVersion, _callback);
     ...
     */
    public PolicyAssignmentListResult policyAssignmentsListForManagementGroup(String managementGroupId, String $filter, String apiVersion) throws ApiException {
        ApiResponse<PolicyAssignmentListResult> localVarResp = policyAssignmentsListForManagementGroupWithHttpInfo(managementGroupId, $filter, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PolicyAssignmentListResult> policyAssignmentsListForManagementGroupWithHttpInfo(String managementGroupId, String $filter, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = policyAssignmentsListForManagementGroupValidateBeforeCall(managementGroupId, $filter, apiVersion, null);
        Type localVarReturnType = new TypeToken<PolicyAssignmentListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieves all policy assignments that apply to a management group. (asynchronously)
     * This operation retrieves the list of all policy assignments applicable to the management group that match the given $filter. Valid values for $filter are: &#39;atScope()&#39; or &#39;policyDefinitionId eq &#39;{value}&#39;&#39;. If $filter&#x3D;atScope() is provided, the returned list includes all policy assignments that are assigned to the management group or the management group&#39;s ancestors. If $filter&#x3D;policyDefinitionId eq &#39;{value}&#39; is provided, the returned list includes all policy assignments of the policy definition whose id is {value} that apply to the management group.
     * @param managementGroupId The ID of the management group. (required)
     * @param $filter The filter to apply on the operation. Valid values for $filter are: &#39;atScope()&#39; or &#39;policyDefinitionId eq &#39;{value}&#39;&#39;. A filter is required when listing policy assignments at management group scope. (required)
     * @param apiVersion The API version to use for the operation. (required)
     ...
     */
    public okhttp3.Call policyAssignmentsListForManagementGroupAsync(String managementGroupId, String $filter, String apiVersion, final ApiCallback<PolicyAssignmentListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = policyAssignmentsListForManagementGroupValidateBeforeCall(managementGroupId, $filter, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<PolicyAssignmentListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
