...
import ParameterValuesValue from './ParameterValuesValue';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('parameters')) {
                obj['parameters'] = ApiClient.convertToType(data['parameters'], {'String': ParameterValuesValue});
            }
 ...
 * @member {module:model/PolicyAssignmentProperties.EnforcementModeEnum} enforcementMode
 */
PolicyAssignmentProperties.prototype['enforcementMode'] = undefined;
 ...
 * @member {Object.<String, module:model/ParameterValuesValue>} parameters
 */
 ...
 * @readonly
 */
PolicyAssignmentProperties['EnforcementModeEnum'] = {
