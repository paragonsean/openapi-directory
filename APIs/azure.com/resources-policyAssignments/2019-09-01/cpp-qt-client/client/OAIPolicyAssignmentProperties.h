...
#include "OAIObject.h"
#include "OAIParameterValuesValue.h"
#include <QList>
#include <QMap>
#include <QString>
...
public:
    ...
    QMap<QString, OAIParameterValuesValue> getParameters() const;
    void setParameters(const QMap<QString, OAIParameterValuesValue> &parameters);
...
private:
    ...
    QMap<QString, OAIParameterValuesValue> m_parameters;
