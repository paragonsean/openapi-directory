...
class PolicyAssignmentProperties(Model):
    ...
    def __init__(self, description: str=None, display_name: str=None, enforcement_mode: str=None, metadata: object=None, not_scopes: List[str]=None, parameters: Dict[str, ParameterValuesValue]=None, policy_definition_id: str=None, scope: str=None):
    ...
    def parameters(self):
        ...
        :rtype: Dict[str, ParameterValuesValue]
        """
    ...
    def parameters(self, parameters):
        ...
        :param parameters: The parameters of this PolicyAssignmentProperties.
        :type parameters: Dict[str, ParameterValuesValue]
        """
