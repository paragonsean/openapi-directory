...
class PolicyAssignmentProperties(Model):
    ...
    def __init__(self, description: str=None, display_name: str=None, metadata: object=None, not_scopes: List[str]=None, parameters: object=None, policy_definition_id: str=None, scope: str=None):
