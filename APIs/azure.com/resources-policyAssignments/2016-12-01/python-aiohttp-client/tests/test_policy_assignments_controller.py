...
async def test_policy_assignments_create(client):
    ...
    """
    parameters = {"name":"name","id":"id","type":"type","properties":{"policyDefinitionId":"policyDefinitionId","displayName":"displayName","scope":"scope","description":"description","parameters":"{}"}}
