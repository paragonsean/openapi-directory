...
public class ReservationSummaryProperties {
  ...
  public boolean equals(Object o) {
    ...
    ReservationSummaryProperties reservationSummaryProperties = (ReservationSummaryProperties) o;
    return Objects.equals(this.avgUtilizationPercentage, reservationSummaryProperties.avgUtilizationPercentage) &&
        Objects.equals(this.maxUtilizationPercentage, reservationSummaryProperties.maxUtilizationPercentage) &&
        Objects.equals(this.minUtilizationPercentage, reservationSummaryProperties.minUtilizationPercentage) &&
        Objects.equals(this.reservationId, reservationSummaryProperties.reservationId) &&
        Objects.equals(this.reservationOrderId, reservationSummaryProperties.reservationOrderId) &&
        Objects.equals(this.reservedHours, reservationSummaryProperties.reservedHours) &&
        Objects.equals(this.skuName, reservationSummaryProperties.skuName) &&
        Objects.equals(this.usageDate, reservationSummaryProperties.usageDate) &&
        Objects.equals(this.usedHours, reservationSummaryProperties.usedHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservationSummaryProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservationSummaryProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservationSummaryProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservationSummaryProperties is not found in the empty JSON string", ReservationSummaryProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservationSummaryProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservationSummaryProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservationSummaryProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservationSummaryProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservationSummaryProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservationSummaryProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservationSummaryProperties>() {
           @Override
           public void write(JsonWriter out, ReservationSummaryProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservationSummaryProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservationSummaryProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservationSummaryProperties
   * @throws IOException if the JSON string is invalid with respect to ReservationSummaryProperties
   */
  public static ReservationSummaryProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservationSummaryProperties.class);
  }

  /**
   * Convert an instance of ReservationSummaryProperties to an JSON string
   *
   * @return JSON string
   */
