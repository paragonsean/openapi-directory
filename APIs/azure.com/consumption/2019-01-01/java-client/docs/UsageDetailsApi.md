...
# **usageDetailsList**
> UsageDetailsListResult usageDetailsList(scope, apiVersion, $expand, $filter, $skiptoken, $top, $apply)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageDetailsListResult result = apiInstance.usageDetailsList(scope, apiVersion, $expand, $filter, $skiptoken, $top, $apply);
