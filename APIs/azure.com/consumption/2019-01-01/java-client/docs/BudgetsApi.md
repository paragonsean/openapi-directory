...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Budget result = apiInstance.budgetsCreateOrUpdate(scope, apiVersion, budgetName, parameters);
...
public class Example {
  public static void main(String[] args) {
    ...
    String budgetName = "budgetName_example"; // String | Budget Name.
    try {
      apiInstance.budgetsDelete(scope, apiVersion, budgetName);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String budgetName = "budgetName_example"; // String | Budget Name.
    try {
      Budget result = apiInstance.budgetsGet(scope, apiVersion, budgetName);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request. The current version is 2019-01-01.
    try {
      BudgetsListResult result = apiInstance.budgetsList(scope, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
