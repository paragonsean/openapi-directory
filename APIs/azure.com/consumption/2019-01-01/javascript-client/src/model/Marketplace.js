...
class Marketplace {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = MarketplaceProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          MarketplaceProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/MarketplaceProperties} properties
 */
Marketplace.prototype['properties'] = undefined;
 ...
 */
Marketplace.prototype['tags'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
Marketplace.prototype['type'] = undefined;
