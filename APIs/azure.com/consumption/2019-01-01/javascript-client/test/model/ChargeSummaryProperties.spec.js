...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.ChargeSummaryProperties();
  });
  ...
  describe('ChargeSummaryProperties', function() {
    it('should create an instance of ChargeSummaryProperties', function() {
      // uncomment below and update the code to test ChargeSummaryProperties
      //var instance = new ConsumptionManagementClient.ChargeSummaryProperties();
      //expect(instance).to.be.a(ConsumptionManagementClient.ChargeSummaryProperties);
    });
