...
public:
    ...
    bool isIsRecurringCharge() const;
    void setIsRecurringCharge(const bool &is_recurring_charge);
    bool is_is_recurring_charge_Set() const;
    bool is_is_recurring_charge_Valid() const;
...
private:
    ...
    bool m_is_recurring_charge;
    bool m_is_recurring_charge_isSet;
    bool m_is_recurring_charge_isValid;
