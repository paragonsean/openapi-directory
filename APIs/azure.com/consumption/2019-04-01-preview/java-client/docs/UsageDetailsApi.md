...
> UsageDetailsDownloadResponse usageDetailsDownload(scope, apiVersion, metric)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageDetailsDownloadResponse result = apiInstance.usageDetailsDownload(scope, apiVersion, metric);
