...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.DownloadUrl();
  });
  ...
  describe('DownloadUrl', function() {
    it('should create an instance of DownloadUrl', function() {
      ...
      //var instance = new ConsumptionManagementClient.DownloadUrl();
      //expect(instance).to.be.a(ConsumptionManagementClient.DownloadUrl);
    });
