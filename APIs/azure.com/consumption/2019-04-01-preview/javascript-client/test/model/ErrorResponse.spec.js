...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ConsumptionManagementClient.ErrorResponse();
      //expect(instance).to.be.a(ConsumptionManagementClient.ErrorResponse);
    });
