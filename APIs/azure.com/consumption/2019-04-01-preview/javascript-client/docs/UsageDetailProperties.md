...
**billingPeriodEndDate** | **Date** | The billing period end date. | [optional] [readonly] 
**billingPeriodStartDate** | **Date** | The billing period start date. | [optional] [readonly] 
...
**cost** | **Number** | The amount of cost before tax. | [optional] [readonly] 
...
**date** | **Date** | Date for the usage record. | [optional] [readonly] 
**effectivePrice** | **Number** | Effective Price that’s charged for the usage. | [optional] [readonly] 
...
**meterId** | **String** | The meter id (GUID). Not available for marketplace. For reserved instance this represents the primary meter for which the reservation was purchased. For the actual VM Size for which the reservation is purchased see productOrderName. | [optional] [readonly] 
...
**quantity** | **Number** | The usage quantity. | [optional] [readonly] 
...
**unitPrice** | **Number** | Unit Price is the price applicable to you. (your EA or other contract price). | [optional] [readonly] 
