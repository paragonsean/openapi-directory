...
void OAIMeterDetails::fromJsonObject(QJsonObject json) {
    ...
    m_service_tier_isValid = ::OpenAPI::fromJsonValue(m_service_tier, json[QString("serviceTier")]);
    m_service_tier_isSet = !json[QString("serviceTier")].isNull() && m_service_tier_isValid;
...
QJsonObject OAIMeterDetails::asJsonObject() const {
    ...
    if (m_service_tier_isSet) {
        obj.insert(QString("serviceTier"), ::OpenAPI::toJsonValue(m_service_tier));
    }
...
QString OAIMeterDetails::getServiceName() const {
    return m_service_name;
}
void OAIMeterDetails::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIMeterDetails::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIMeterDetails::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIMeterDetails::getServiceTier() const {
    return m_service_tier;
}
void OAIMeterDetails::setServiceTier(const QString &service_tier) {
    m_service_tier = service_tier;
    m_service_tier_isSet = true;
}

bool OAIMeterDetails::is_service_tier_Set() const{
    return m_service_tier_isSet;
}

bool OAIMeterDetails::is_service_tier_Valid() const{
