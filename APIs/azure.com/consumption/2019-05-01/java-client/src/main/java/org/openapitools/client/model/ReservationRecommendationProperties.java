...
public class ReservationRecommendationProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(costWithNoReservedInstances, firstUsageDate, instanceFlexibilityGroup, instanceFlexibilityRatio, lookBackPeriod, meterId, netSavings, normalizedSize, recommendedQuantity, recommendedQuantityNormalized, scope, term, totalCostWithReservedInstances);
  }
