...
async def reservations_details_list_by_billing_account_id(request: web.Request, billing_account_id, filter, api_version) -> web.Response:
    """reservations_details_list_by_billing_account_id
...
async def reservations_summaries_list_by_billing_account_id(request: web.Request, billing_account_id, grain, api_version, filter=None) -> web.Response:
    """reservations_summaries_list_by_billing_account_id
