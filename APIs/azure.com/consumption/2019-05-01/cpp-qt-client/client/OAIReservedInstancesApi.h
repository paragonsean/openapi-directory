...
public:
    ...
    */
    virtual void reservationsDetailsListByBillingAccountId(const QString &billing_account_id, const QString &filter, const QString &api_version);
    ...
    */
    virtual void reservationsSummariesListByBillingAccountId(const QString &billing_account_id, const QString &grain, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void reservationsDetailsListByBillingAccountIdCallback(OAIHttpRequestWorker *worker);
    ...
    void reservationsSummariesListByBillingAccountIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void reservationsDetailsListByBillingAccountIdSignal(OAIReservationDetailsListResult summary);
    ...
    void reservationsSummariesListByBillingAccountIdSignal(OAIReservationSummariesListResult summary);
    ...
    void reservationsDetailsListByBillingAccountIdSignalFull(OAIHttpRequestWorker *worker, OAIReservationDetailsListResult summary);
    ...
    void reservationsSummariesListByBillingAccountIdSignalFull(OAIHttpRequestWorker *worker, OAIReservationSummariesListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use reservationsDetailsListByBillingAccountIdSignalError() instead")
    void reservationsDetailsListByBillingAccountIdSignalE(OAIReservationDetailsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void reservationsDetailsListByBillingAccountIdSignalError(OAIReservationDetailsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use reservationsSummariesListByBillingAccountIdSignalError() instead")
    void reservationsSummariesListByBillingAccountIdSignalE(OAIReservationSummariesListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void reservationsSummariesListByBillingAccountIdSignalError(OAIReservationSummariesListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use reservationsDetailsListByBillingAccountIdSignalErrorFull() instead")
    void reservationsDetailsListByBillingAccountIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void reservationsDetailsListByBillingAccountIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use reservationsSummariesListByBillingAccountIdSignalErrorFull() instead")
    void reservationsSummariesListByBillingAccountIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void reservationsSummariesListByBillingAccountIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
