...
public:
    ...
    OAIBalanceProperties getProperties() const;
    void setProperties(const OAIBalanceProperties &properties);
...
private:
    ...
    OAIBalanceProperties m_properties;
