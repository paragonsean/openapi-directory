...
void OAITagsApi::tagsGet(const QString &scope, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["tagsGet"][_serverIndices.value("tagsGet")].URL()+"/{scope}/providers/Microsoft.Consumption/tags");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITagsApi::tagsGetCallback);
...
void OAITagsApi::tagsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITagsResult output(QString(worker->response));
    worker->deleteLater();
