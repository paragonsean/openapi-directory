...
> CostTag costTagsCreateOrUpdate(apiVersion, billingAccountId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    CostTag parameters = new CostTag(); // CostTag | Parameters supplied to the Create cost tags operation.
    try {
      CostTag result = apiInstance.costTagsCreateOrUpdate(apiVersion, billingAccountId, parameters);
...
<a id="costTagsGet"></a>
# **costTagsGet**
> CostTag costTagsGet(apiVersion, billingAccountId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String billingAccountId = "billingAccountId_example"; // String | BillingAccount ID
    try {
      CostTag result = apiInstance.costTagsGet(apiVersion, billingAccountId);
      System.out.println(result);
    } catch (ApiException e) {
