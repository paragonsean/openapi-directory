...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Balance();
  });
  ...
  describe('Balance', function() {
    it('should create an instance of Balance', function() {
      ...
      //var instance = new ConsumptionManagementClient.Balance();
      //expect(instance).to.be.a(ConsumptionManagementClient.Balance);
    });
