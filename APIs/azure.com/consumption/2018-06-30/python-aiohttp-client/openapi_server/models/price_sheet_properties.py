...
class PriceSheetProperties(Model):
    ...
    def __init__(self, billing_period_id: str=None, currency_code: str=None, included_quantity: float=None, meter_details: MeterDetails=None, meter_id: str=None, offer_id: str=None, part_number: str=None, unit_of_measure: str=None, unit_price: float=None):
        ...
        :param offer_id: The offer_id of this PriceSheetProperties.
    ...
    @property
    def offer_id(self):
        """Gets the offer_id of this PriceSheetProperties.

        Offer Id

        :return: The offer_id of this PriceSheetProperties.
        :rtype: str
        """
    ...
    def offer_id(self, offer_id):
        """Sets the offer_id of this PriceSheetProperties.
