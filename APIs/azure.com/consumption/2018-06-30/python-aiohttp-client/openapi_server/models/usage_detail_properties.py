...
class UsageDetailProperties(Model):
    ...
    def __init__(self, account_name: str=None, additional_properties: str=None, billable_quantity: float=None, billing_period_id: str=None, charges_billed_separately: bool=None, consumed_service: str=None, cost_center: str=None, currency: str=None, department_name: str=None, instance_id: str=None, instance_location: str=None, instance_name: str=None, invoice_id: str=None, is_estimated: bool=None, location: str=None, meter_details: MeterDetails=None, meter_id: str=None, offer_id: str=None, part_number: str=None, pretax_cost: float=None, product: str=None, resource_guid: str=None, subscription_guid: str=None, subscription_name: str=None, usage_end: datetime=None, usage_quantity: float=None, usage_start: datetime=None):
        ...
        :param location: The location of this UsageDetailProperties.
    ...
    @property
    def location(self):
        """Gets the location of this UsageDetailProperties.

        Resource Location

        :return: The location of this UsageDetailProperties.
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this UsageDetailProperties.
