...
<a id="chargesList"></a>
# **chargesList**
> ChargesListResult chargesList(scope, apiVersion, startDate, endDate, $filter, $apply)
...
public class Example {
  public static void main(String[] args) {
    ...
    String $apply = "$apply_example"; // String | May be used to group charges for billingAccount scope by properties/billingProfileId, properties/invoiceSectionId, properties/customerId (specific for Partner Led), or for billingProfile scope by properties/invoiceSectionId.
    try {
      ChargesListResult result = apiInstance.chargesList(scope, apiVersion, startDate, endDate, $filter, $apply);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChargesApi#chargesList");
