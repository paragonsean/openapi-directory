...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Events result = apiInstance.eventsList(billingAccountId, billingProfileId, apiVersion, startDate, endDate);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EventsApi#eventsList");
