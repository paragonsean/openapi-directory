...
public class LegacyChargeSummaryProperties {
  ...
  public boolean equals(Object o) {
    ...
    LegacyChargeSummaryProperties legacyChargeSummaryProperties = (LegacyChargeSummaryProperties) o;
    return Objects.equals(this.azureCharges, legacyChargeSummaryProperties.azureCharges) &&
        Objects.equals(this.billingPeriodId, legacyChargeSummaryProperties.billingPeriodId) &&
        Objects.equals(this.chargesBilledSeparately, legacyChargeSummaryProperties.chargesBilledSeparately) &&
        Objects.equals(this.currency, legacyChargeSummaryProperties.currency) &&
        Objects.equals(this.marketplaceCharges, legacyChargeSummaryProperties.marketplaceCharges) &&
        Objects.equals(this.usageEnd, legacyChargeSummaryProperties.usageEnd) &&
        Objects.equals(this.usageStart, legacyChargeSummaryProperties.usageStart);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegacyChargeSummaryProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegacyChargeSummaryProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegacyChargeSummaryProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegacyChargeSummaryProperties is not found in the empty JSON string", LegacyChargeSummaryProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegacyChargeSummaryProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegacyChargeSummaryProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegacyChargeSummaryProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegacyChargeSummaryProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegacyChargeSummaryProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegacyChargeSummaryProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<LegacyChargeSummaryProperties>() {
           @Override
           public void write(JsonWriter out, LegacyChargeSummaryProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegacyChargeSummaryProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegacyChargeSummaryProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegacyChargeSummaryProperties
   * @throws IOException if the JSON string is invalid with respect to LegacyChargeSummaryProperties
   */
  public static LegacyChargeSummaryProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegacyChargeSummaryProperties.class);
  }

  /**
   * Convert an instance of LegacyChargeSummaryProperties to an JSON string
   *
   * @return JSON string
   */
