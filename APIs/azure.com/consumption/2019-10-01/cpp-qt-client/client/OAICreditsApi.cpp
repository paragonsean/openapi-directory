...
void OAICreditsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("creditsGet", defaultConf);
    _serverIndices.insert("creditsGet", 0);
}
...
void OAICreditsApi::creditsGet(const QString &billing_account_id, const QString &billing_profile_id, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["creditsGet"][_serverIndices.value("creditsGet")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/credits/balanceSummary");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICreditsApi::creditsGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICreditsApi::creditsGetCallback);
    connect(this, &OAICreditsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAICreditsApi::creditsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreditSummary output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT creditsGetSignal(output);
        Q_EMIT creditsGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT creditsGetSignalE(output, error_type, error_str);
        Q_EMIT creditsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT creditsGetSignalError(output, error_type, error_str);
        Q_EMIT creditsGetSignalErrorFull(worker, error_type, error_str);
    }
}
