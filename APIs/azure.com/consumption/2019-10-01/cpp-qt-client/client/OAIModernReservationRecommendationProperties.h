...
/*
 * OAIModernReservationRecommendationProperties.h
 *
 * The properties of the reservation recommendation.
 */

#ifndef OAIModernReservationRecommendationProperties_H
#define OAIModernReservationRecommendationProperties_H
...
class OAIModernReservationRecommendationProperties : public OAIObject {
public:
    OAIModernReservationRecommendationProperties();
    OAIModernReservationRecommendationProperties(QString json);
    ~OAIModernReservationRecommendationProperties() override;
    ...
    OAIAmount getCostWithNoReservedInstances() const;
    void setCostWithNoReservedInstances(const OAIAmount &cost_with_no_reserved_instances);
    ...
    OAIAmount getNetSavings() const;
    void setNetSavings(const OAIAmount &net_savings);
    ...
    OAIAmount getTotalCostWithReservedInstances() const;
    void setTotalCostWithReservedInstances(const OAIAmount &total_cost_with_reserved_instances);
...
private:
    ...
    OAIAmount m_cost_with_no_reserved_instances;
    ...
    OAIAmount m_total_cost_with_reserved_instances;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModernReservationRecommendationProperties)

#endif // OAIModernReservationRecommendationProperties_H
