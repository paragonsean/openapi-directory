...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("eventsList", defaultConf);
    _serverIndices.insert("eventsList", 0);
}
...
void OAIEventsApi::eventsList(const QString &billing_account_id, const QString &billing_profile_id, const QString &api_version, const QString &start_date, const QString &end_date) {
    QString fullPath = QString(_serverConfigs["eventsList"][_serverIndices.value("eventsList")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListCallback);
...
void OAIEventsApi::eventsListCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT eventsListSignal(output);
        Q_EMIT eventsListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT eventsListSignalE(output, error_type, error_str);
        Q_EMIT eventsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT eventsListSignalError(output, error_type, error_str);
        Q_EMIT eventsListSignalErrorFull(worker, error_type, error_str);
    }
}
