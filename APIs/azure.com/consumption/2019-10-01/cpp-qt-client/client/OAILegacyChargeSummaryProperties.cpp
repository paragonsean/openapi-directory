...
OAILegacyChargeSummaryProperties::OAILegacyChargeSummaryProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILegacyChargeSummaryProperties::OAILegacyChargeSummaryProperties() {
    this->initializeModel();
}

OAILegacyChargeSummaryProperties::~OAILegacyChargeSummaryProperties() {}

void OAILegacyChargeSummaryProperties::initializeModel() {
...
void OAILegacyChargeSummaryProperties::fromJson(QString jsonString) {
...
void OAILegacyChargeSummaryProperties::fromJsonObject(QJsonObject json) {
...
QString OAILegacyChargeSummaryProperties::asJson() const {
...
QJsonObject OAILegacyChargeSummaryProperties::asJsonObject() const {
    QJsonObject obj;
...
double OAILegacyChargeSummaryProperties::getAzureCharges() const {
    return m_azure_charges;
}
void OAILegacyChargeSummaryProperties::setAzureCharges(const double &azure_charges) {
    m_azure_charges = azure_charges;
    m_azure_charges_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_azure_charges_Set() const{
    return m_azure_charges_isSet;
}

bool OAILegacyChargeSummaryProperties::is_azure_charges_Valid() const{
    return m_azure_charges_isValid;
}

QString OAILegacyChargeSummaryProperties::getBillingPeriodId() const {
    return m_billing_period_id;
}
void OAILegacyChargeSummaryProperties::setBillingPeriodId(const QString &billing_period_id) {
    m_billing_period_id = billing_period_id;
    m_billing_period_id_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_billing_period_id_Set() const{
    return m_billing_period_id_isSet;
}

bool OAILegacyChargeSummaryProperties::is_billing_period_id_Valid() const{
    return m_billing_period_id_isValid;
}

double OAILegacyChargeSummaryProperties::getChargesBilledSeparately() const {
    return m_charges_billed_separately;
}
void OAILegacyChargeSummaryProperties::setChargesBilledSeparately(const double &charges_billed_separately) {
    m_charges_billed_separately = charges_billed_separately;
    m_charges_billed_separately_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_charges_billed_separately_Set() const{
    return m_charges_billed_separately_isSet;
}

bool OAILegacyChargeSummaryProperties::is_charges_billed_separately_Valid() const{
    return m_charges_billed_separately_isValid;
}

QString OAILegacyChargeSummaryProperties::getCurrency() const {
    return m_currency;
}
void OAILegacyChargeSummaryProperties::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAILegacyChargeSummaryProperties::is_currency_Valid() const{
    return m_currency_isValid;
}

double OAILegacyChargeSummaryProperties::getMarketplaceCharges() const {
    return m_marketplace_charges;
}
void OAILegacyChargeSummaryProperties::setMarketplaceCharges(const double &marketplace_charges) {
    m_marketplace_charges = marketplace_charges;
    m_marketplace_charges_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_marketplace_charges_Set() const{
    return m_marketplace_charges_isSet;
}

bool OAILegacyChargeSummaryProperties::is_marketplace_charges_Valid() const{
    return m_marketplace_charges_isValid;
}

QString OAILegacyChargeSummaryProperties::getUsageEnd() const {
    return m_usage_end;
}
void OAILegacyChargeSummaryProperties::setUsageEnd(const QString &usage_end) {
    m_usage_end = usage_end;
    m_usage_end_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_usage_end_Set() const{
    return m_usage_end_isSet;
}

bool OAILegacyChargeSummaryProperties::is_usage_end_Valid() const{
    return m_usage_end_isValid;
}

QString OAILegacyChargeSummaryProperties::getUsageStart() const {
    return m_usage_start;
}
void OAILegacyChargeSummaryProperties::setUsageStart(const QString &usage_start) {
    m_usage_start = usage_start;
    m_usage_start_isSet = true;
}

bool OAILegacyChargeSummaryProperties::is_usage_start_Set() const{
    return m_usage_start_isSet;
}

bool OAILegacyChargeSummaryProperties::is_usage_start_Valid() const{
    return m_usage_start_isValid;
}

bool OAILegacyChargeSummaryProperties::isSet() const {
...
bool OAILegacyChargeSummaryProperties::isValid() const {
