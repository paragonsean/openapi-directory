...
#ifndef OAI_OAIReservationSummariesApi_H
#define OAI_OAIReservationSummariesApi_H
...
class OAIReservationSummariesApi : public QObject {
    Q_OBJECT

public:
    OAIReservationSummariesApi(const int timeOut = 0);
    ~OAIReservationSummariesApi();
