...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.ModernChargeSummaryProperties();
  });
  ...
  describe('ModernChargeSummaryProperties', function() {
    it('should create an instance of ModernChargeSummaryProperties', function() {
      // uncomment below and update the code to test ModernChargeSummaryProperties
      //var instance = new ConsumptionManagementClient.ModernChargeSummaryProperties();
      //expect(instance).to.be.a(ConsumptionManagementClient.ModernChargeSummaryProperties);
    });
