...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Events();
  });
  ...
  describe('Events', function() {
    it('should create an instance of Events', function() {
      ...
      //var instance = new ConsumptionManagementClient.Events();
      //expect(instance).to.be.a(ConsumptionManagementClient.Events);
    });
