...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Amount();
  });
  ...
  describe('Amount', function() {
    it('should create an instance of Amount', function() {
      ...
      //var instance = new ConsumptionManagementClient.Amount();
      //expect(instance).to.be.a(ConsumptionManagementClient.Amount);
    });
