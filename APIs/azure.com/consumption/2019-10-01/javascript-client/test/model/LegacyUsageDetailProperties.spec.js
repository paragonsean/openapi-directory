...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.LegacyUsageDetailProperties();
  });
  ...
  describe('LegacyUsageDetailProperties', function() {
    it('should create an instance of LegacyUsageDetailProperties', function() {
      // uncomment below and update the code to test LegacyUsageDetailProperties
      //var instance = new ConsumptionManagementClient.LegacyUsageDetailProperties();
      //expect(instance).to.be.a(ConsumptionManagementClient.LegacyUsageDetailProperties);
    });
