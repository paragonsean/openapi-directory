...
export default class ReservationRecommendationsApi {
    ...
    */
     ...
     */
    reservationRecommendationsList(apiVersion, scope, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling reservationRecommendationsList");
      }
      ...
      return this.apiClient.callApi(
        '/{scope}/providers/Microsoft.Consumption/reservationRecommendations', 'GET',
