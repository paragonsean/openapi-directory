...
export default class EventsApi {
    ...
    */
     ...
     */
    eventsList(billingAccountId, billingProfileId, apiVersion, startDate, endDate, callback) {
      let postBody = null;
      // verify the required parameter 'billingAccountId' is set
      if (billingAccountId === undefined || billingAccountId === null) {
        throw new Error("Missing the required parameter 'billingAccountId' when calling eventsList");
      }
      // verify the required parameter 'billingProfileId' is set
      if (billingProfileId === undefined || billingProfileId === null) {
        throw new Error("Missing the required parameter 'billingProfileId' when calling eventsList");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling eventsList");
      }
      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling eventsList");
      }
      // verify the required parameter 'endDate' is set
      if (endDate === undefined || endDate === null) {
        throw new Error("Missing the required parameter 'endDate' when calling eventsList");
      }
