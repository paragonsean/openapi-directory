...
/**
 * The LegacyUsageDetailProperties model module.
 * @module model/LegacyUsageDetailProperties
 * @version 2019-10-01
 */
class LegacyUsageDetailProperties {
    /**
     * Constructs a new <code>LegacyUsageDetailProperties</code>.
     * The properties of the legacy usage detail.
     * @alias module:model/LegacyUsageDetailProperties
     */
    constructor() { 
        
        LegacyUsageDetailProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LegacyUsageDetailProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LegacyUsageDetailProperties} obj Optional instance to populate.
     * @return {module:model/LegacyUsageDetailProperties} The populated <code>LegacyUsageDetailProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LegacyUsageDetailProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>LegacyUsageDetailProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LegacyUsageDetailProperties</code>.
     */
 ...
 */
LegacyUsageDetailProperties.prototype['accountName'] = undefined;

/**
 * Account Owner Id.
 * @member {String} accountOwnerId
 */
LegacyUsageDetailProperties.prototype['accountOwnerId'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['additionalInfo'] = undefined;

/**
 * Billing Account identifier.
 * @member {String} billingAccountId
 */
LegacyUsageDetailProperties.prototype['billingAccountId'] = undefined;

/**
 * Billing Account Name.
 * @member {String} billingAccountName
 */
LegacyUsageDetailProperties.prototype['billingAccountName'] = undefined;

/**
 * Billing Currency.
 * @member {String} billingCurrency
 */
LegacyUsageDetailProperties.prototype['billingCurrency'] = undefined;

/**
 * The billing period end date.
 * @member {Date} billingPeriodEndDate
 */
LegacyUsageDetailProperties.prototype['billingPeriodEndDate'] = undefined;

/**
 * The billing period start date.
 * @member {Date} billingPeriodStartDate
 */
LegacyUsageDetailProperties.prototype['billingPeriodStartDate'] = undefined;

/**
 * Billing Profile identifier.
 * @member {String} billingProfileId
 */
LegacyUsageDetailProperties.prototype['billingProfileId'] = undefined;

/**
 * Billing Profile Name.
 * @member {String} billingProfileName
 */
LegacyUsageDetailProperties.prototype['billingProfileName'] = undefined;

/**
 * Indicates a charge represents credits, usage, a Marketplace purchase, a reservation fee, or a refund.
 * @member {String} chargeType
 */
LegacyUsageDetailProperties.prototype['chargeType'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['consumedService'] = undefined;

/**
 * The amount of cost before tax.
 * @member {Number} cost
 */
LegacyUsageDetailProperties.prototype['cost'] = undefined;

/**
 * The cost center of this department if it is a department and a cost center is provided.
 * @member {String} costCenter
 */
LegacyUsageDetailProperties.prototype['costCenter'] = undefined;

/**
 * Date for the usage record.
 * @member {Date} date
 */
LegacyUsageDetailProperties.prototype['date'] = undefined;

/**
 * Effective Price that's charged for the usage.
 * @member {Number} effectivePrice
 */
LegacyUsageDetailProperties.prototype['effectivePrice'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['frequency'] = undefined;

/**
 * Invoice Section Name.
 * @member {String} invoiceSection
 */
LegacyUsageDetailProperties.prototype['invoiceSection'] = undefined;

/**
 * Is Azure Credit Eligible.
 * @member {Boolean} isAzureCreditEligible
 */
LegacyUsageDetailProperties.prototype['isAzureCreditEligible'] = undefined;

/**
 * @member {module:model/MeterDetailsResponse} meterDetails
 */
LegacyUsageDetailProperties.prototype['meterDetails'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['meterId'] = undefined;

/**
 * Offer Id. Ex: MS-AZR-0017P, MS-AZR-0148P.
 * @member {String} offerId
 */
LegacyUsageDetailProperties.prototype['offerId'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['partNumber'] = undefined;

/**
 * Plan Name.
 * @member {String} planName
 */
LegacyUsageDetailProperties.prototype['planName'] = undefined;

/**
 * Product name for the consumed service or purchase. Not available for Marketplace.
 * @member {String} product
 */
LegacyUsageDetailProperties.prototype['product'] = undefined;

/**
 * Product Order Id. For reservations this is the Reservation Order ID.
 * @member {String} productOrderId
 */
LegacyUsageDetailProperties.prototype['productOrderId'] = undefined;

/**
 * Product Order Name. For reservations this is the SKU that was purchased.
 * @member {String} productOrderName
 */
LegacyUsageDetailProperties.prototype['productOrderName'] = undefined;

/**
 * Publisher Name.
 * @member {String} publisherName
 */
LegacyUsageDetailProperties.prototype['publisherName'] = undefined;

/**
 * Publisher Type.
 * @member {String} publisherType
 */
LegacyUsageDetailProperties.prototype['publisherType'] = undefined;

/**
 * The usage quantity.
 * @member {Number} quantity
 */
LegacyUsageDetailProperties.prototype['quantity'] = undefined;

/**
 * ARM resource id of the reservation. Only applies to records relevant to reservations.
 * @member {String} reservationId
 */
LegacyUsageDetailProperties.prototype['reservationId'] = undefined;
 ...
 */
LegacyUsageDetailProperties.prototype['reservationName'] = undefined;

/**
 * Resource Group Name.
 * @member {String} resourceGroup
 */
LegacyUsageDetailProperties.prototype['resourceGroup'] = undefined;

/**
 * Azure resource manager resource identifier.
 * @member {String} resourceId
 */
LegacyUsageDetailProperties.prototype['resourceId'] = undefined;

/**
 * Resource Location.
 * @member {String} resourceLocation
 */
LegacyUsageDetailProperties.prototype['resourceLocation'] = undefined;

/**
 * Resource Name.
 * @member {String} resourceName
 */
LegacyUsageDetailProperties.prototype['resourceName'] = undefined;

/**
 * Service Info 1.
 * @member {String} serviceInfo1
 */
LegacyUsageDetailProperties.prototype['serviceInfo1'] = undefined;

/**
 * Service Info 2.
 * @member {String} serviceInfo2
 */
LegacyUsageDetailProperties.prototype['serviceInfo2'] = undefined;

/**
 * Subscription guid.
 * @member {String} subscriptionId
 */
LegacyUsageDetailProperties.prototype['subscriptionId'] = undefined;

/**
 * Subscription name.
 * @member {String} subscriptionName
 */
LegacyUsageDetailProperties.prototype['subscriptionName'] = undefined;
 ...
 * @member {String} term
 */
LegacyUsageDetailProperties.prototype['term'] = undefined;

/**
 * Unit Price is the price applicable to you. (your EA or other contract price).
 * @member {Number} unitPrice
 */
LegacyUsageDetailProperties.prototype['unitPrice'] = undefined;
...
export default LegacyUsageDetailProperties;
