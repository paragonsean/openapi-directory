...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.ReservationDetailsProperties();
  });
  ...
  describe('ReservationDetailsProperties', function() {
    it('should create an instance of ReservationDetailsProperties', function() {
      // uncomment below and update the code to test ReservationDetailsProperties
      //var instance = new ConsumptionManagementClient.ReservationDetailsProperties();
      //expect(instance).to.be.a(ConsumptionManagementClient.ReservationDetailsProperties);
    });
