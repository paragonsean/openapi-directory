...
# **usageDetailsList**
> UsageDetailsListResult usageDetailsList(subscriptionId, apiVersion, $expand, $filter, $skiptoken, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageDetailsListResult result = apiInstance.usageDetailsList(subscriptionId, apiVersion, $expand, $filter, $skiptoken, $top);
...
> UsageDetailsListResult usageDetailsListByBillingPeriod(subscriptionId, billingPeriodName, apiVersion, $expand, $filter, $skiptoken, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | May be used to limit the number of results to the most recent N usageDetails.
    try {
      UsageDetailsListResult result = apiInstance.usageDetailsListByBillingPeriod(subscriptionId, billingPeriodName, apiVersion, $expand, $filter, $skiptoken, $top);
      System.out.println(result);
    } catch (ApiException e) {
