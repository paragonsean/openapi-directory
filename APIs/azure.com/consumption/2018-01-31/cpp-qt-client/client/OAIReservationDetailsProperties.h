...
/*
 * OAIReservationDetailsProperties.h
 *
 * The properties of the reservation details.
 */

#ifndef OAIReservationDetailsProperties_H
#define OAIReservationDetailsProperties_H
...
class OAIReservationDetailsProperties : public OAIObject {
public:
    OAIReservationDetailsProperties();
    OAIReservationDetailsProperties(QString json);
    ~OAIReservationDetailsProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationDetailsProperties)

#endif // OAIReservationDetailsProperties_H
