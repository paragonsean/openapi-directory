...
async def usage_details_list(request: web.Request, subscription_id, api_version, expand=None, filter=None, skiptoken=None, top=None) -> web.Response:
    """usage_details_list
...
async def usage_details_list_by_billing_period(request: web.Request, subscription_id, billing_period_name, api_version, expand=None, filter=None, skiptoken=None, top=None) -> web.Response:
