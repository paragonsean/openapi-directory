...
class UsageDetailProperties(Model):
    ...
    def __init__(self, account_name: str=None, additional_properties: str=None, billable_quantity: float=None, billing_period_id: str=None, consumed_service: str=None, cost_center: str=None, currency: str=None, department_name: str=None, instance_id: str=None, instance_location: str=None, instance_name: str=None, invoice_id: str=None, is_estimated: bool=None, meter_details: MeterDetails=None, meter_id: str=None, pretax_cost: float=None, product: str=None, subscription_guid: str=None, subscription_name: str=None, usage_end: datetime=None, usage_quantity: float=None, usage_start: datetime=None):
