...
- API version: 2017-04-24-preview
  - Build date: 2024-10-12T10:38:20.578237-04:00[America/New_York]
...
<dependency>
  ...
  <version>2017-04-24-preview</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2017-04-24-preview"
  }
```
...
* `target/openapi-java-client-2017-04-24-preview.jar`
* `target/lib/*.jar`
