...
------------ | ------------- | ------------- | -------------
**additionalProperties** | **{String: String}** | The list of key/value pairs for the additional properties, in the format &#39;key&#39;:&#39;value&#39; where key &#x3D; the field name, and value &#x3D; the field value. By default this is not populated, unless it&#39;s specified in $expand. | [optional] [readonly] 
