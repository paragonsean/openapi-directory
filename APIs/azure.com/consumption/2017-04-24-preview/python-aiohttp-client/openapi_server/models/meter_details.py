...
class MeterDetails(Model):
    ...
    def __init__(self, meter_category: str=None, meter_location: str=None, meter_name: str=None, meter_sub_category: str=None, pretax_standard_rate: float=None, total_included_quantity: float=None, unit: str=None):
