...
QMap<QString, QString> OAIUsageDetailProperties::getAdditionalProperties() const {
    return m_additional_properties;
}
void OAIUsageDetailProperties::setAdditionalProperties(const QMap<QString, QString> &additional_properties) {
