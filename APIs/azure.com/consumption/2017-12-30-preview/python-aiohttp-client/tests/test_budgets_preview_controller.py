...
async def test_budgets_create_or_update(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/providers/Microsoft.Consumption/budgets/{name}'.format(subscription_id='subscription_id_example', name='name_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
