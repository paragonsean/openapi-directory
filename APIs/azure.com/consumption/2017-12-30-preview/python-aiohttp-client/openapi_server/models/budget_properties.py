...
class BudgetProperties(Model):
    ...
    def __init__(self, amount: float=None, category: str=None, current_spend: CurrentSpend=None, notifications: Dict[str, Notification]=None, time_grain: str=None, time_period: BudgetTimePeriod=None):
