...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Budget();
  });
  ...
  describe('Budget', function() {
    it('should create an instance of Budget', function() {
      ...
      //var instance = new ConsumptionManagementClient.Budget();
      //expect(instance).to.be.a(ConsumptionManagementClient.Budget);
    });
