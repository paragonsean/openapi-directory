...
class TagsResult {
    ...
    /**
     * Validates the JSON data with respect to <code>TagsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagsResult</code>.
     */
 ...
 */
TagsResult.prototype['properties'] = undefined;

/**
 * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
 * @member {String} eTag
 */
TagsResult.prototype['eTag'] = undefined;

/**
 * Resource Id.
 * @member {String} id
 */
TagsResult.prototype['id'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
TagsResult.prototype['name'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
TagsResult.prototype['type'] = undefined;
