...
void OAITagsApi::tagsGet(const QString &api_version, const QString &billing_account_id) {
    QString fullPath = QString(_serverConfigs["tagsGet"][_serverIndices.value("tagsGet")].URL()+"/providers/Microsoft.CostManagement/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/tags");
