...
public:
    ...
    */
    virtual void tagsGet(const QString &api_version, const QString &billing_account_id);
...
Q_SIGNALS:
    ...
    void tagsGetSignal(OAITagsResult summary);


    void tagsGetSignalFull(OAIHttpRequestWorker *worker, OAITagsResult summary);

    Q_DECL_DEPRECATED_X("Use tagsGetSignalError() instead")
    void tagsGetSignalE(OAITagsResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tagsGetSignalError(OAITagsResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
