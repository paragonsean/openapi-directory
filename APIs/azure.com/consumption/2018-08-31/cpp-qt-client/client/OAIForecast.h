...
public:
    ...
    OAIForecastProperties getProperties() const;
    void setProperties(const OAIForecastProperties &properties);
...
private:
    ...
    OAIForecastProperties m_properties;
