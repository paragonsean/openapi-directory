...
void OAICreditsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("creditSummaryByBillingProfileGet", defaultConf);
    _serverIndices.insert("creditSummaryByBillingProfileGet", 0);
}
...
void OAICreditsApi::creditSummaryByBillingProfileGet(const QString &billing_account_id, const QString &billing_profile_id, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["creditSummaryByBillingProfileGet"][_serverIndices.value("creditSummaryByBillingProfileGet")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/credits/balanceSummary");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICreditsApi::creditSummaryByBillingProfileGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICreditsApi::creditSummaryByBillingProfileGetCallback);
...
void OAICreditsApi::creditSummaryByBillingProfileGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT creditSummaryByBillingProfileGetSignal(output);
        Q_EMIT creditSummaryByBillingProfileGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT creditSummaryByBillingProfileGetSignalE(output, error_type, error_str);
        Q_EMIT creditSummaryByBillingProfileGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT creditSummaryByBillingProfileGetSignalError(output, error_type, error_str);
        Q_EMIT creditSummaryByBillingProfileGetSignalErrorFull(worker, error_type, error_str);
    }
}
