# ConsumptionManagementClient.CreditsApi
...
let apiInstance = new ConsumptionManagementClient.CreditsApi();
...
apiInstance.creditSummaryByBillingProfileGet(billingAccountId, billingProfileId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
