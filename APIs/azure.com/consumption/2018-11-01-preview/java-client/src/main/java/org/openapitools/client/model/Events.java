...
public class Events {
  ...
  private List<EventSummary> value = new ArrayList<>();

  public Events() {
  }

  public Events(
     List<EventSummary> value
  ) {
    this();
    this.value = value;
  }
  ...
  public List<EventSummary> getValue() {
    return value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, events.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            EventSummary.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
