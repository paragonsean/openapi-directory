...
async def marketplaces_list_by_management_group(request: web.Request, api_version, management_group_id, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_list_for_billing_period_by_management_group(request: web.Request, api_version, management_group_id, billing_period_name, filter=None, top=None, skiptoken=None) -> web.Response:
