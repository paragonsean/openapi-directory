# ConsumptionManagementClient.TenantsApi
...
let apiInstance = new ConsumptionManagementClient.TenantsApi();
let billingAccountId = "billingAccountId_example"; // String | Billing Account Id.
...
apiInstance.tenantsGet(billingAccountId, billingProfileId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
