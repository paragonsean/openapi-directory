...
class Tenant {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = TenantProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          TenantProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/TenantProperties} properties
 */
Tenant.prototype['properties'] = undefined;
