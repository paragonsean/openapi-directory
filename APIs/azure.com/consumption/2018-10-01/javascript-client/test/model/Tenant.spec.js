...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Tenant();
  });
  ...
  describe('Tenant', function() {
    it('should create an instance of Tenant', function() {
      ...
      //var instance = new ConsumptionManagementClient.Tenant();
      //expect(instance).to.be.a(ConsumptionManagementClient.Tenant);
    });
