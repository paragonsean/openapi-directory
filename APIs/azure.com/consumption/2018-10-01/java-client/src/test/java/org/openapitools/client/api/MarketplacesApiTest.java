...
public class MarketplacesApiTest {
     ...
     */
    @Test
    public void marketplacesListByManagementGroupTest() throws ApiException {
        String apiVersion = null;
        String managementGroupId = null;
        String $filter = null;
        Integer $top = null;
        String $skiptoken = null;
        MarketplacesListResult response = api.marketplacesListByManagementGroup(apiVersion, managementGroupId, $filter, $top, $skiptoken);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void marketplacesListForBillingPeriodByManagementGroupTest() throws ApiException {
        String apiVersion = null;
        String managementGroupId = null;
        String billingPeriodName = null;
        String $filter = null;
        Integer $top = null;
        String $skiptoken = null;
        MarketplacesListResult response = api.marketplacesListForBillingPeriodByManagementGroup(apiVersion, managementGroupId, billingPeriodName, $filter, $top, $skiptoken);
        // TODO: test validations
    }
