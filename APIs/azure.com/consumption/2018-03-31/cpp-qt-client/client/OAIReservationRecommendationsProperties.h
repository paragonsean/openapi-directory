...
/*
 * OAIReservationRecommendationsProperties.h
 *
 * The properties of the reservation recommendations.
 */

#ifndef OAIReservationRecommendationsProperties_H
#define OAIReservationRecommendationsProperties_H
...
class OAIReservationRecommendationsProperties : public OAIObject {
public:
    OAIReservationRecommendationsProperties();
    OAIReservationRecommendationsProperties(QString json);
    ~OAIReservationRecommendationsProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationRecommendationsProperties)

#endif // OAIReservationRecommendationsProperties_H
