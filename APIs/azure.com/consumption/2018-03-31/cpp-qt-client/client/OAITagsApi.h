...
Q_SIGNALS:
    ...
    void tagsGetSignal(OAITags summary);


    void tagsGetSignalFull(OAIHttpRequestWorker *worker, OAITags summary);

    Q_DECL_DEPRECATED_X("Use tagsGetSignalError() instead")
    void tagsGetSignalE(OAITags summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tagsGetSignalError(OAITags summary, QNetworkReply::NetworkError error_type, const QString &error_str);
