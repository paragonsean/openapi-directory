...
import ReservationDetailsProperties from './ReservationDetailsProperties';
...
class ReservationDetails {
    ...
    constructor() { 
        ...
        ReservationDetails.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ReservationDetailsProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ReservationDetailsProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ReservationDetailsProperties} properties
 */
ReservationDetails.prototype['properties'] = undefined;

/**
 * Resource Id.
 * @member {String} id
 */
ReservationDetails.prototype['id'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
ReservationDetails.prototype['name'] = undefined;

/**
 * Resource tags.
 * @member {Object.<String, String>} tags
 */
ReservationDetails.prototype['tags'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
ReservationDetails.prototype['type'] = undefined;
