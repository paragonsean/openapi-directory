...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.Tags();
  });
  ...
  describe('Tags', function() {
    it('should create an instance of Tags', function() {
      // uncomment below and update the code to test Tags
      //var instance = new ConsumptionManagementClient.Tags();
      //expect(instance).to.be.a(ConsumptionManagementClient.Tags);
    });
