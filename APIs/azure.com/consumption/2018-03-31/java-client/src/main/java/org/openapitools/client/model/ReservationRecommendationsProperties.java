...
public class ReservationRecommendationsProperties {
  ...
  public ReservationRecommendationsProperties() {
  }
  ...
  public boolean equals(Object o) {
    ...
    ReservationRecommendationsProperties reservationRecommendationsProperties = (ReservationRecommendationsProperties) o;
    return Objects.equals(this.costWithNoReservedInstances, reservationRecommendationsProperties.costWithNoReservedInstances) &&
        Objects.equals(this.firstUsageDate, reservationRecommendationsProperties.firstUsageDate) &&
        Objects.equals(this.lookBackPeriod, reservationRecommendationsProperties.lookBackPeriod) &&
        Objects.equals(this.meterId, reservationRecommendationsProperties.meterId) &&
        Objects.equals(this.netSavings, reservationRecommendationsProperties.netSavings) &&
        Objects.equals(this.recommendedQuantity, reservationRecommendationsProperties.recommendedQuantity) &&
        Objects.equals(this.scope, reservationRecommendationsProperties.scope) &&
        Objects.equals(this.term, reservationRecommendationsProperties.term) &&
        Objects.equals(this.totalCostWithReservedInstances, reservationRecommendationsProperties.totalCostWithReservedInstances);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservationRecommendationsProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservationRecommendationsProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservationRecommendationsProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservationRecommendationsProperties is not found in the empty JSON string", ReservationRecommendationsProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservationRecommendationsProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservationRecommendationsProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservationRecommendationsProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservationRecommendationsProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservationRecommendationsProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservationRecommendationsProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservationRecommendationsProperties>() {
           @Override
           public void write(JsonWriter out, ReservationRecommendationsProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservationRecommendationsProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservationRecommendationsProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservationRecommendationsProperties
   * @throws IOException if the JSON string is invalid with respect to ReservationRecommendationsProperties
   */
  public static ReservationRecommendationsProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservationRecommendationsProperties.class);
  }

  /**
   * Convert an instance of ReservationRecommendationsProperties to an JSON string
   *
   * @return JSON string
   */
