...
public class ReservationDetailsProperties {
  ...
  public boolean equals(Object o) {
    ...
    ReservationDetailsProperties reservationDetailsProperties = (ReservationDetailsProperties) o;
    return Objects.equals(this.instanceId, reservationDetailsProperties.instanceId) &&
        Objects.equals(this.reservationId, reservationDetailsProperties.reservationId) &&
        Objects.equals(this.reservationOrderId, reservationDetailsProperties.reservationOrderId) &&
        Objects.equals(this.reservedHours, reservationDetailsProperties.reservedHours) &&
        Objects.equals(this.skuName, reservationDetailsProperties.skuName) &&
        Objects.equals(this.totalReservedQuantity, reservationDetailsProperties.totalReservedQuantity) &&
        Objects.equals(this.usageDate, reservationDetailsProperties.usageDate) &&
        Objects.equals(this.usedHours, reservationDetailsProperties.usedHours);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instanceId, reservationId, reservationOrderId, reservedHours, skuName, totalReservedQuantity, usageDate, usedHours);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReservationDetailsProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservationDetailsProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservationDetailsProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservationDetailsProperties is not found in the empty JSON string", ReservationDetailsProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservationDetailsProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservationDetailsProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservationDetailsProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservationDetailsProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservationDetailsProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservationDetailsProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservationDetailsProperties>() {
           @Override
           public void write(JsonWriter out, ReservationDetailsProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservationDetailsProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservationDetailsProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservationDetailsProperties
   * @throws IOException if the JSON string is invalid with respect to ReservationDetailsProperties
   */
  public static ReservationDetailsProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservationDetailsProperties.class);
  }

  /**
   * Convert an instance of ReservationDetailsProperties to an JSON string
   *
   * @return JSON string
   */
