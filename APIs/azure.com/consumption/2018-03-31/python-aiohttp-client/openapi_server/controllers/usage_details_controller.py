...
async def usage_details_by_billing_account_list(request: web.Request, billing_account_id, api_version, expand=None, filter=None, skiptoken=None, top=None, apply=None) -> web.Response:
    """usage_details_by_billing_account_list
...
async def usage_details_by_billing_account_list_by_billing_period(request: web.Request, billing_account_id, billing_period_name, api_version, expand=None, filter=None, apply=None, skiptoken=None, top=None) -> web.Response:
    """usage_details_by_billing_account_list_by_billing_period
...
async def usage_details_by_department_list(request: web.Request, department_id, api_version, expand=None, filter=None, skiptoken=None, top=None, apply=None) -> web.Response:
    """usage_details_by_department_list
...
async def usage_details_by_department_list_by_billing_period(request: web.Request, department_id, billing_period_name, api_version, expand=None, filter=None, apply=None, skiptoken=None, top=None) -> web.Response:
    """usage_details_by_department_list_by_billing_period
...
async def usage_details_by_enrollment_account_list(request: web.Request, enrollment_account_id, api_version, expand=None, filter=None, skiptoken=None, top=None, apply=None) -> web.Response:
    """usage_details_by_enrollment_account_list
...
async def usage_details_by_enrollment_account_list_by_billing_period(request: web.Request, enrollment_account_id, billing_period_name, api_version, expand=None, filter=None, apply=None, skiptoken=None, top=None) -> web.Response:
    """usage_details_by_enrollment_account_list_by_billing_period
