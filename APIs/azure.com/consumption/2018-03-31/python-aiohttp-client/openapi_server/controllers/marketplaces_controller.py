...
async def marketplaces_by_billing_account_list(request: web.Request, api_version, billing_account_id, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_by_billing_account_list_by_billing_period(request: web.Request, api_version, billing_account_id, billing_period_name, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_by_department_list(request: web.Request, api_version, department_id, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_by_department_list_by_billing_period(request: web.Request, api_version, department_id, billing_period_name, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_by_enrollment_accounts_list(request: web.Request, api_version, enrollment_account_id, filter=None, top=None, skiptoken=None) -> web.Response:
...
async def marketplaces_by_enrollment_accounts_list_by_billing_period(request: web.Request, api_version, enrollment_account_id, billing_period_name, filter=None, top=None, skiptoken=None) -> web.Response:
