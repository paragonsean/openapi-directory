...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConsumptionManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ConsumptionManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ConsumptionManagementClient.OperationDisplay);
    });
