...
**purchasedQuantity** | **Number** | This is the purchased quantity for the reservationId. | [optional] [readonly] 
**remainingQuantity** | **Number** | This is the remaining quantity for the reservationId. | [optional] [readonly] 
...
**usedQuantity** | **Number** | This is the used quantity for the reservationId. | [optional] [readonly] 
**utilizedPercentage** | **Number** | This is the utilized percentage for the reservation Id. | [optional] [readonly] 
