...
> ReservationTransactionsListResult reservationTransactionsListByBillingAccountId(apiVersion, billingAccountId, opts)
...
apiInstance.reservationTransactionsListByBillingAccountId(apiVersion, billingAccountId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
