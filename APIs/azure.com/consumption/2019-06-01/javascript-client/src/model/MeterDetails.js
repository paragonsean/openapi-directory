...
class MeterDetails {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['serviceTier'] && !(typeof data['serviceTier'] === 'string' || data['serviceTier'] instanceof String)) {
            throw new Error("Expected the field `serviceTier` to be a primitive type in the JSON string but got " + data['serviceTier']);
        }
        // ensure the json data is a string
 ...
 */
MeterDetails.prototype['serviceName'] = undefined;

/**
 * The service tier.
 * @member {String} serviceTier
 */
MeterDetails.prototype['serviceTier'] = undefined;
