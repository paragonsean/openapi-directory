...
QString OAIReservationDetailProperties::getInstanceFlexibilityGroup() const {
    return m_instance_flexibility_group;
}
void OAIReservationDetailProperties::setInstanceFlexibilityGroup(const QString &instance_flexibility_group) {
    m_instance_flexibility_group = instance_flexibility_group;
    m_instance_flexibility_group_isSet = true;
}

bool OAIReservationDetailProperties::is_instance_flexibility_group_Set() const{
    return m_instance_flexibility_group_isSet;
}

bool OAIReservationDetailProperties::is_instance_flexibility_group_Valid() const{
    return m_instance_flexibility_group_isValid;
}

QString OAIReservationDetailProperties::getInstanceFlexibilityRatio() const {
    return m_instance_flexibility_ratio;
}
void OAIReservationDetailProperties::setInstanceFlexibilityRatio(const QString &instance_flexibility_ratio) {
    m_instance_flexibility_ratio = instance_flexibility_ratio;
    m_instance_flexibility_ratio_isSet = true;
}

bool OAIReservationDetailProperties::is_instance_flexibility_ratio_Set() const{
    return m_instance_flexibility_ratio_isSet;
}

bool OAIReservationDetailProperties::is_instance_flexibility_ratio_Valid() const{
...
QString OAIReservationDetailProperties::getKind() const {
    return m_kind;
}
void OAIReservationDetailProperties::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIReservationDetailProperties::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIReservationDetailProperties::is_kind_Valid() const{
