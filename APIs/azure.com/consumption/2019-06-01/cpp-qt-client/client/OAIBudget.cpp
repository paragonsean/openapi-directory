...
OAIBudgetProperties OAIBudget::getProperties() const {
    return m_properties;
}
void OAIBudget::setProperties(const OAIBudgetProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIBudget::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIBudget::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIBudget::getETag() const {
    return m_e_tag;
}
void OAIBudget::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIBudget::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIBudget::is_e_tag_Valid() const{
...
QString OAIBudget::getName() const {
    return m_name;
}
void OAIBudget::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBudget::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBudget::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIBudget::getType() const {
    return m_type;
}
void OAIBudget::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBudget::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBudget::is_type_Valid() const{
