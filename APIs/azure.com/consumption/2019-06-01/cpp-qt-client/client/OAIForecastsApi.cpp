...
void OAIForecastsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("forecastsList", defaultConf);
    _serverIndices.insert("forecastsList", 0);
}
...
void OAIForecastsApi::forecastsList(const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["forecastsList"][_serverIndices.value("forecastsList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Consumption/forecasts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIForecastsApi::forecastsListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIForecastsApi::forecastsListCallback);
    connect(this, &OAIForecastsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIForecastsApi::forecastsListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIForecastsListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT forecastsListSignal(output);
        Q_EMIT forecastsListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT forecastsListSignalE(output, error_type, error_str);
        Q_EMIT forecastsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT forecastsListSignalError(output, error_type, error_str);
        Q_EMIT forecastsListSignalErrorFull(worker, error_type, error_str);
    }
}
