...
QString OAIReservationRecommendationProperties::getInstanceFlexibilityGroup() const {
    return m_instance_flexibility_group;
}
void OAIReservationRecommendationProperties::setInstanceFlexibilityGroup(const QString &instance_flexibility_group) {
    m_instance_flexibility_group = instance_flexibility_group;
    m_instance_flexibility_group_isSet = true;
}

bool OAIReservationRecommendationProperties::is_instance_flexibility_group_Set() const{
    return m_instance_flexibility_group_isSet;
}

bool OAIReservationRecommendationProperties::is_instance_flexibility_group_Valid() const{
    return m_instance_flexibility_group_isValid;
}

qint32 OAIReservationRecommendationProperties::getInstanceFlexibilityRatio() const {
    return m_instance_flexibility_ratio;
}
void OAIReservationRecommendationProperties::setInstanceFlexibilityRatio(const qint32 &instance_flexibility_ratio) {
    m_instance_flexibility_ratio = instance_flexibility_ratio;
    m_instance_flexibility_ratio_isSet = true;
}

bool OAIReservationRecommendationProperties::is_instance_flexibility_ratio_Set() const{
    return m_instance_flexibility_ratio_isSet;
}

bool OAIReservationRecommendationProperties::is_instance_flexibility_ratio_Valid() const{
...
QString OAIReservationRecommendationProperties::getNormalizedSize() const {
    return m_normalized_size;
}
void OAIReservationRecommendationProperties::setNormalizedSize(const QString &normalized_size) {
    m_normalized_size = normalized_size;
    m_normalized_size_isSet = true;
}

bool OAIReservationRecommendationProperties::is_normalized_size_Set() const{
    return m_normalized_size_isSet;
}

bool OAIReservationRecommendationProperties::is_normalized_size_Valid() const{
...
double OAIReservationRecommendationProperties::getRecommendedQuantityNormalized() const {
    return m_recommended_quantity_normalized;
}
void OAIReservationRecommendationProperties::setRecommendedQuantityNormalized(const double &recommended_quantity_normalized) {
    m_recommended_quantity_normalized = recommended_quantity_normalized;
    m_recommended_quantity_normalized_isSet = true;
}

bool OAIReservationRecommendationProperties::is_recommended_quantity_normalized_Set() const{
    return m_recommended_quantity_normalized_isSet;
}

bool OAIReservationRecommendationProperties::is_recommended_quantity_normalized_Valid() const{
...
QList<OAISkuProperty> OAIReservationRecommendationProperties::getSkuProperties() const {
    return m_sku_properties;
}
void OAIReservationRecommendationProperties::setSkuProperties(const QList<OAISkuProperty> &sku_properties) {
    m_sku_properties = sku_properties;
    m_sku_properties_isSet = true;
}

bool OAIReservationRecommendationProperties::is_sku_properties_Set() const{
    return m_sku_properties_isSet;
}

bool OAIReservationRecommendationProperties::is_sku_properties_Valid() const{
