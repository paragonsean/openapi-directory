...
|**instanceFlexibilityRatio** | **String** | The instance Flexibility Ratio. |  [optional] [readonly] |
|**instanceId** | **String** | This identifier is the name of the resource or the fully qualified Resource ID. |  [optional] [readonly] |
|**kind** | **String** | The reservation kind. |  [optional] [readonly] |
...
|**reservedHours** | **BigDecimal** | This is the total hours reserved for the day. E.g. if reservation for 1 instance was made on 1 PM, this will be 11 hours for that day and 24 hours from subsequent days. |  [optional] [readonly] |
...
|**totalReservedQuantity** | **BigDecimal** | This is the total count of instances that are reserved for the reservationId. |  [optional] [readonly] |
|**usageDate** | **OffsetDateTime** | The date on which consumption occurred. |  [optional] [readonly] |
|**usedHours** | **BigDecimal** | This is the total hours used by the instance. |  [optional] [readonly] |
