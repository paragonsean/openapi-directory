...
|**amount** | **BigDecimal** | The charge of the transaction. |  [optional] [readonly] |
...
|**eventDate** | **OffsetDateTime** | The date of the transaction |  [optional] [readonly] |
...
|**purchasingSubscriptionGuid** | **UUID** | The subscription guid that makes the transaction. |  [optional] [readonly] |
|**purchasingSubscriptionName** | **String** | The subscription name that makes the transaction. |  [optional] [readonly] |
|**quantity** | **BigDecimal** | The quantity of the transaction. |  [optional] [readonly] |
