...
export default class ComputeApi {
    ...
    */
     ...
     * @callback module:api/ComputeApi~operationsListCallback
     ...
     * @param {module:api/ComputeApi~operationsListCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    operationsList(apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/providers/Microsoft.Compute.Admin/operations', 'GET',
