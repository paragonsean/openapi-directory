...
class ContainerServiceAgentPoolProfile {
     ...
     */
    constructor(dnsPrefix, name, vmSize) { 
        
        ContainerServiceAgentPoolProfile.initialize(this, dnsPrefix, name, vmSize);
    }
     ...
     */
    static initialize(obj, dnsPrefix, name, vmSize) { 
...
ContainerServiceAgentPoolProfile.RequiredProperties = ["dnsPrefix", "name", "vmSize"];
