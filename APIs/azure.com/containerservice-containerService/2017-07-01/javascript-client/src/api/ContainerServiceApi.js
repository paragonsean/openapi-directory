...
export default class ContainerServiceApi {
    ...
    */
     ...
     * @callback module:api/ContainerServiceApi~containerServicesCreateOrUpdateCallback
     ...
     * @param {module:api/ContainerServiceApi~containerServicesCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
