...
public class PostArgsMatchConditionParameters {
  ...
  public PostArgsMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public PostArgsMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public PostArgsMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public PostArgsMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public PostArgsMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public PostArgsMatchConditionParameters selector(String selector) {
  ...
  public PostArgsMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public PostArgsMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PostArgsMatchConditionParameters postArgsMatchConditionParameters = (PostArgsMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, postArgsMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, postArgsMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, postArgsMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, postArgsMatchConditionParameters.operator) &&
        Objects.equals(this.selector, postArgsMatchConditionParameters.selector) &&
        Objects.equals(this.transforms, postArgsMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostArgsMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostArgsMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostArgsMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostArgsMatchConditionParameters is not found in the empty JSON string", PostArgsMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostArgsMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostArgsMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostArgsMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostArgsMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostArgsMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostArgsMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostArgsMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<PostArgsMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, PostArgsMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostArgsMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostArgsMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostArgsMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to PostArgsMatchConditionParameters
   */
  public static PostArgsMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostArgsMatchConditionParameters.class);
  }

  /**
   * Convert an instance of PostArgsMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
