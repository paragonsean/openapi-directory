...
public class QueryStringMatchConditionParameters {
  ...
  public QueryStringMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public QueryStringMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public QueryStringMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public QueryStringMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public QueryStringMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public QueryStringMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public QueryStringMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    QueryStringMatchConditionParameters queryStringMatchConditionParameters = (QueryStringMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, queryStringMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, queryStringMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, queryStringMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, queryStringMatchConditionParameters.operator) &&
        Objects.equals(this.transforms, queryStringMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryStringMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryStringMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryStringMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryStringMatchConditionParameters is not found in the empty JSON string", QueryStringMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryStringMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryStringMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueryStringMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryStringMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryStringMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryStringMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryStringMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryStringMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, QueryStringMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryStringMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryStringMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryStringMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to QueryStringMatchConditionParameters
   */
  public static QueryStringMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryStringMatchConditionParameters.class);
  }

  /**
   * Convert an instance of QueryStringMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
