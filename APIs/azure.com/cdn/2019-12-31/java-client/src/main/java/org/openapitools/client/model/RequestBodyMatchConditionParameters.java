...
public class RequestBodyMatchConditionParameters {
  ...
  public RequestBodyMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public RequestBodyMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public RequestBodyMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public RequestBodyMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public RequestBodyMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public RequestBodyMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public RequestBodyMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RequestBodyMatchConditionParameters requestBodyMatchConditionParameters = (RequestBodyMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, requestBodyMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, requestBodyMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, requestBodyMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, requestBodyMatchConditionParameters.operator) &&
        Objects.equals(this.transforms, requestBodyMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestBodyMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestBodyMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestBodyMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestBodyMatchConditionParameters is not found in the empty JSON string", RequestBodyMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestBodyMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestBodyMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestBodyMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestBodyMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestBodyMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestBodyMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestBodyMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestBodyMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, RequestBodyMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestBodyMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestBodyMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestBodyMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to RequestBodyMatchConditionParameters
   */
  public static RequestBodyMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestBodyMatchConditionParameters.class);
  }

  /**
   * Convert an instance of RequestBodyMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
