...
public class RequestHeaderMatchConditionParameters {
  ...
  public RequestHeaderMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public RequestHeaderMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public RequestHeaderMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public RequestHeaderMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public RequestHeaderMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public RequestHeaderMatchConditionParameters selector(String selector) {
  ...
  public RequestHeaderMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public RequestHeaderMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RequestHeaderMatchConditionParameters requestHeaderMatchConditionParameters = (RequestHeaderMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, requestHeaderMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, requestHeaderMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, requestHeaderMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, requestHeaderMatchConditionParameters.operator) &&
        Objects.equals(this.selector, requestHeaderMatchConditionParameters.selector) &&
        Objects.equals(this.transforms, requestHeaderMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestHeaderMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestHeaderMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestHeaderMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestHeaderMatchConditionParameters is not found in the empty JSON string", RequestHeaderMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestHeaderMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestHeaderMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestHeaderMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestHeaderMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestHeaderMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestHeaderMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestHeaderMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestHeaderMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, RequestHeaderMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestHeaderMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestHeaderMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestHeaderMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to RequestHeaderMatchConditionParameters
   */
  public static RequestHeaderMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestHeaderMatchConditionParameters.class);
  }

  /**
   * Convert an instance of RequestHeaderMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
