...
public class UrlFileNameMatchConditionParameters {
  ...
  public UrlFileNameMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public UrlFileNameMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public UrlFileNameMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public UrlFileNameMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public UrlFileNameMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public UrlFileNameMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public UrlFileNameMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UrlFileNameMatchConditionParameters urlFileNameMatchConditionParameters = (UrlFileNameMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, urlFileNameMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, urlFileNameMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, urlFileNameMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, urlFileNameMatchConditionParameters.operator) &&
        Objects.equals(this.transforms, urlFileNameMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class UrlFileNameMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UrlFileNameMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlFileNameMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UrlFileNameMatchConditionParameters is not found in the empty JSON string", UrlFileNameMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UrlFileNameMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UrlFileNameMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UrlFileNameMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlFileNameMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlFileNameMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlFileNameMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlFileNameMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlFileNameMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, UrlFileNameMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UrlFileNameMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UrlFileNameMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UrlFileNameMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to UrlFileNameMatchConditionParameters
   */
  public static UrlFileNameMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UrlFileNameMatchConditionParameters.class);
  }

  /**
   * Convert an instance of UrlFileNameMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
