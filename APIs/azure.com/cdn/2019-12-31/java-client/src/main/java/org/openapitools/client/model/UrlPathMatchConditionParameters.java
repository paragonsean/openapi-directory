...
public class UrlPathMatchConditionParameters {
  ...
  public UrlPathMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public UrlPathMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public UrlPathMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public UrlPathMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public UrlPathMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public UrlPathMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public UrlPathMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UrlPathMatchConditionParameters urlPathMatchConditionParameters = (UrlPathMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, urlPathMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, urlPathMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, urlPathMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, urlPathMatchConditionParameters.operator) &&
        Objects.equals(this.transforms, urlPathMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class UrlPathMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UrlPathMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlPathMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UrlPathMatchConditionParameters is not found in the empty JSON string", UrlPathMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UrlPathMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UrlPathMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UrlPathMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlPathMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlPathMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlPathMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlPathMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlPathMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, UrlPathMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UrlPathMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UrlPathMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UrlPathMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to UrlPathMatchConditionParameters
   */
  public static UrlPathMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UrlPathMatchConditionParameters.class);
  }

  /**
   * Convert an instance of UrlPathMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
