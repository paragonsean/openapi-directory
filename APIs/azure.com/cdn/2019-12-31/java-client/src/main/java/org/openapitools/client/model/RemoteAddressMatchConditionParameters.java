...
public class RemoteAddressMatchConditionParameters {
  ...
  public RemoteAddressMatchConditionParameters atOdataType(AtOdataTypeEnum atOdataType) {
  ...
  public RemoteAddressMatchConditionParameters matchValues(List<String> matchValues) {
    this.matchValues = matchValues;
    return this;
  }

  public RemoteAddressMatchConditionParameters addMatchValuesItem(String matchValuesItem) {
  ...
  public RemoteAddressMatchConditionParameters negateCondition(Boolean negateCondition) {
  ...
  public RemoteAddressMatchConditionParameters operator(OperatorEnum operator) {
  ...
  public RemoteAddressMatchConditionParameters transforms(List<Transform> transforms) {
    this.transforms = transforms;
    return this;
  }

  public RemoteAddressMatchConditionParameters addTransformsItem(Transform transformsItem) {
  ...
  public boolean equals(Object o) {
    ...
    RemoteAddressMatchConditionParameters remoteAddressMatchConditionParameters = (RemoteAddressMatchConditionParameters) o;
    return Objects.equals(this.atOdataType, remoteAddressMatchConditionParameters.atOdataType) &&
        Objects.equals(this.matchValues, remoteAddressMatchConditionParameters.matchValues) &&
        Objects.equals(this.negateCondition, remoteAddressMatchConditionParameters.negateCondition) &&
        Objects.equals(this.operator, remoteAddressMatchConditionParameters.operator) &&
        Objects.equals(this.transforms, remoteAddressMatchConditionParameters.transforms);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoteAddressMatchConditionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoteAddressMatchConditionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoteAddressMatchConditionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoteAddressMatchConditionParameters is not found in the empty JSON string", RemoteAddressMatchConditionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoteAddressMatchConditionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoteAddressMatchConditionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemoteAddressMatchConditionParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoteAddressMatchConditionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoteAddressMatchConditionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoteAddressMatchConditionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoteAddressMatchConditionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoteAddressMatchConditionParameters>() {
           @Override
           public void write(JsonWriter out, RemoteAddressMatchConditionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoteAddressMatchConditionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoteAddressMatchConditionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoteAddressMatchConditionParameters
   * @throws IOException if the JSON string is invalid with respect to RemoteAddressMatchConditionParameters
   */
  public static RemoteAddressMatchConditionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoteAddressMatchConditionParameters.class);
  }

  /**
   * Convert an instance of RemoteAddressMatchConditionParameters to an JSON string
   *
   * @return JSON string
   */
