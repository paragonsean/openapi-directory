...
public class DeepCreatedOriginGroupProperties {
  ...
  public DeepCreatedOriginGroupProperties healthProbeSettings(HealthProbeParameters healthProbeSettings) {
  ...
  public DeepCreatedOriginGroupProperties origins(List<ResourceReference> origins) {
    this.origins = origins;
    return this;
  }

  public DeepCreatedOriginGroupProperties addOriginsItem(ResourceReference originsItem) {
  ...
  public DeepCreatedOriginGroupProperties responseBasedOriginErrorDetectionSettings(ResponseBasedOriginErrorDetectionParameters responseBasedOriginErrorDetectionSettings) {
  ...
  public DeepCreatedOriginGroupProperties trafficRestorationTimeToHealedOrNewEndpointsInMinutes(Integer trafficRestorationTimeToHealedOrNewEndpointsInMinutes) {
  ...
  public boolean equals(Object o) {
    ...
    DeepCreatedOriginGroupProperties deepCreatedOriginGroupProperties = (DeepCreatedOriginGroupProperties) o;
    return Objects.equals(this.healthProbeSettings, deepCreatedOriginGroupProperties.healthProbeSettings) &&
        Objects.equals(this.origins, deepCreatedOriginGroupProperties.origins) &&
        Objects.equals(this.responseBasedOriginErrorDetectionSettings, deepCreatedOriginGroupProperties.responseBasedOriginErrorDetectionSettings) &&
        Objects.equals(this.trafficRestorationTimeToHealedOrNewEndpointsInMinutes, deepCreatedOriginGroupProperties.trafficRestorationTimeToHealedOrNewEndpointsInMinutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeepCreatedOriginGroupProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeepCreatedOriginGroupProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeepCreatedOriginGroupProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeepCreatedOriginGroupProperties is not found in the empty JSON string", DeepCreatedOriginGroupProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeepCreatedOriginGroupProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeepCreatedOriginGroupProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeepCreatedOriginGroupProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeepCreatedOriginGroupProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeepCreatedOriginGroupProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeepCreatedOriginGroupProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeepCreatedOriginGroupProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DeepCreatedOriginGroupProperties>() {
           @Override
           public void write(JsonWriter out, DeepCreatedOriginGroupProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeepCreatedOriginGroupProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeepCreatedOriginGroupProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeepCreatedOriginGroupProperties
   * @throws IOException if the JSON string is invalid with respect to DeepCreatedOriginGroupProperties
   */
  public static DeepCreatedOriginGroupProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeepCreatedOriginGroupProperties.class);
  }

  /**
   * Convert an instance of DeepCreatedOriginGroupProperties to an JSON string
   *
   * @return JSON string
   */
