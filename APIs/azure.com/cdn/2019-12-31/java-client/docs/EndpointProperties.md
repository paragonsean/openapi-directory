...
|------------ | ------------- | ------------- | -------------|
|**hostName** | **String** | The host name of the endpoint structured as {endpointName}.{DNSZone}, e.g. contoso.azureedge.net |  [optional] [readonly] |
|**originGroups** | [**List&lt;DeepCreatedOriginGroup&gt;**](DeepCreatedOriginGroup.md) | The origin groups comprising of origins that are used for load balancing the traffic based on availability. |  [optional] |
|**origins** | [**List&lt;DeepCreatedOrigin&gt;**](DeepCreatedOrigin.md) | The source of the content being delivered via CDN. |  |
|**provisioningState** | **String** | Provisioning status of the endpoint. |  [optional] [readonly] |
