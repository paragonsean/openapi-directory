...
async def test_endpoints_create(client):
    ...
    """
    endpoint = {"properties":{"hostName":"hostName","originGroups":[{"name":"name","properties":{"responseBasedOriginErrorDetectionSettings":{"responseBasedFailoverThresholdPercentage":59,"httpErrorRanges":[{"end":231,"begin":641},{"end":231,"begin":641}],"responseBasedDetectedErrorTypes":"None"},"healthProbeSettings":{"probeProtocol":"NotSet","probeIntervalInSeconds":21,"probePath":"probePath","probeRequestType":"NotSet"},"origins":[{"id":"id"},{"id":"id"}],"trafficRestorationTimeToHealedOrNewEndpointsInMinutes":28}},{"name":"name","properties":{"responseBasedOriginErrorDetectionSettings":{"responseBasedFailoverThresholdPercentage":59,"httpErrorRanges":[{"end":231,"begin":641},{"end":231,"begin":641}],"responseBasedDetectedErrorTypes":"None"},"healthProbeSettings":{"probeProtocol":"NotSet","probeIntervalInSeconds":21,"probePath":"probePath","probeRequestType":"NotSet"},"origins":[{"id":"id"},{"id":"id"}],"trafficRestorationTimeToHealedOrNewEndpointsInMinutes":28}}],"origins":[{"name":"name","properties":{"hostName":"hostName","httpPort":15087,"originHostHeader":"originHostHeader","weight":362,"priority":4,"httpsPort":46277,"enabled":True}},{"name":"name","properties":{"hostName":"hostName","httpPort":15087,"originHostHeader":"originHostHeader","weight":362,"priority":4,"httpsPort":46277,"enabled":True}}],"resourceState":"Creating","provisioningState":"provisioningState"}}
