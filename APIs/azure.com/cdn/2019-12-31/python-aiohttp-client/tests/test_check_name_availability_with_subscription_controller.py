...
async def test_check_name_availability_with_subscription(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/providers/Microsoft.Cdn/checkNameAvailability'.format(subscription_id='subscription_id_example'),
        headers=headers,
