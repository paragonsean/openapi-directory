...
class DeepCreatedOriginGroupProperties(Model):
    ...
    def __init__(self, health_probe_settings: HealthProbeParameters=None, origins: List[ResourceReference]=None, response_based_origin_error_detection_settings: ResponseBasedOriginErrorDetectionParameters=None, traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: int=None):
        """DeepCreatedOriginGroupProperties - a model defined in OpenAPI

        :param health_probe_settings: The health_probe_settings of this DeepCreatedOriginGroupProperties.
        :param origins: The origins of this DeepCreatedOriginGroupProperties.
        :param response_based_origin_error_detection_settings: The response_based_origin_error_detection_settings of this DeepCreatedOriginGroupProperties.
        :param traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: The traffic_restoration_time_to_healed_or_new_endpoints_in_minutes of this DeepCreatedOriginGroupProperties.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeepCreatedOriginGroupProperties':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeepCreatedOriginGroupProperties of this DeepCreatedOriginGroupProperties.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def health_probe_settings(self):
        """Gets the health_probe_settings of this DeepCreatedOriginGroupProperties.


        :return: The health_probe_settings of this DeepCreatedOriginGroupProperties.
    ...
    def health_probe_settings(self, health_probe_settings):
        """Sets the health_probe_settings of this DeepCreatedOriginGroupProperties.
    ...
    @property
    def origins(self):
        """Gets the origins of this DeepCreatedOriginGroupProperties.

        The source of the content being delivered via CDN within given origin group.

        :return: The origins of this DeepCreatedOriginGroupProperties.
    ...
    def origins(self, origins):
        """Sets the origins of this DeepCreatedOriginGroupProperties.
    ...
    def response_based_origin_error_detection_settings(self):
        """Gets the response_based_origin_error_detection_settings of this DeepCreatedOriginGroupProperties.


        :return: The response_based_origin_error_detection_settings of this DeepCreatedOriginGroupProperties.
    ...
    def response_based_origin_error_detection_settings(self, response_based_origin_error_detection_settings):
        """Sets the response_based_origin_error_detection_settings of this DeepCreatedOriginGroupProperties.
    ...
    def traffic_restoration_time_to_healed_or_new_endpoints_in_minutes(self):
        """Gets the traffic_restoration_time_to_healed_or_new_endpoints_in_minutes of this DeepCreatedOriginGroupProperties.

        Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.

        :return: The traffic_restoration_time_to_healed_or_new_endpoints_in_minutes of this DeepCreatedOriginGroupProperties.
        :rtype: int
        """
    ...
    def traffic_restoration_time_to_healed_or_new_endpoints_in_minutes(self, traffic_restoration_time_to_healed_or_new_endpoints_in_minutes):
        """Sets the traffic_restoration_time_to_healed_or_new_endpoints_in_minutes of this DeepCreatedOriginGroupProperties.
