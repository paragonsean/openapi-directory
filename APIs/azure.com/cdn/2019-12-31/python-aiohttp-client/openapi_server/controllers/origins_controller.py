...
async def origins_create(request: web.Request, resource_group_name, profile_name, endpoint_name, origin_name, subscription_id, api_version, origin) -> web.Response:
    """origins_create
...
async def origins_delete(request: web.Request, resource_group_name, profile_name, endpoint_name, origin_name, subscription_id, api_version) -> web.Response:
    """origins_delete
