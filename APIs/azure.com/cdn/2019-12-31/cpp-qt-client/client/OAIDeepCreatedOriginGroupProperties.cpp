...
OAIDeepCreatedOriginGroupProperties::OAIDeepCreatedOriginGroupProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeepCreatedOriginGroupProperties::OAIDeepCreatedOriginGroupProperties() {
    this->initializeModel();
}

OAIDeepCreatedOriginGroupProperties::~OAIDeepCreatedOriginGroupProperties() {}

void OAIDeepCreatedOriginGroupProperties::initializeModel() {
...
void OAIDeepCreatedOriginGroupProperties::fromJson(QString jsonString) {
...
void OAIDeepCreatedOriginGroupProperties::fromJsonObject(QJsonObject json) {
...
QString OAIDeepCreatedOriginGroupProperties::asJson() const {
...
QJsonObject OAIDeepCreatedOriginGroupProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIHealthProbeParameters OAIDeepCreatedOriginGroupProperties::getHealthProbeSettings() const {
    return m_health_probe_settings;
}
void OAIDeepCreatedOriginGroupProperties::setHealthProbeSettings(const OAIHealthProbeParameters &health_probe_settings) {
    m_health_probe_settings = health_probe_settings;
    m_health_probe_settings_isSet = true;
}

bool OAIDeepCreatedOriginGroupProperties::is_health_probe_settings_Set() const{
    return m_health_probe_settings_isSet;
}

bool OAIDeepCreatedOriginGroupProperties::is_health_probe_settings_Valid() const{
    return m_health_probe_settings_isValid;
}

QList<OAIResourceReference> OAIDeepCreatedOriginGroupProperties::getOrigins() const {
    return m_origins;
}
void OAIDeepCreatedOriginGroupProperties::setOrigins(const QList<OAIResourceReference> &origins) {
    m_origins = origins;
    m_origins_isSet = true;
}

bool OAIDeepCreatedOriginGroupProperties::is_origins_Set() const{
    return m_origins_isSet;
}

bool OAIDeepCreatedOriginGroupProperties::is_origins_Valid() const{
    return m_origins_isValid;
}

OAIResponseBasedOriginErrorDetectionParameters OAIDeepCreatedOriginGroupProperties::getResponseBasedOriginErrorDetectionSettings() const {
    return m_response_based_origin_error_detection_settings;
}
void OAIDeepCreatedOriginGroupProperties::setResponseBasedOriginErrorDetectionSettings(const OAIResponseBasedOriginErrorDetectionParameters &response_based_origin_error_detection_settings) {
...
bool OAIDeepCreatedOriginGroupProperties::is_response_based_origin_error_detection_settings_Set() const{
    return m_response_based_origin_error_detection_settings_isSet;
}

bool OAIDeepCreatedOriginGroupProperties::is_response_based_origin_error_detection_settings_Valid() const{
    return m_response_based_origin_error_detection_settings_isValid;
}

qint32 OAIDeepCreatedOriginGroupProperties::getTrafficRestorationTimeToHealedOrNewEndpointsInMinutes() const {
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes;
}
void OAIDeepCreatedOriginGroupProperties::setTrafficRestorationTimeToHealedOrNewEndpointsInMinutes(const qint32 &traffic_restoration_time_to_healed_or_new_endpoints_in_minutes) {
...
bool OAIDeepCreatedOriginGroupProperties::is_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_Set() const{
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_isSet;
}

bool OAIDeepCreatedOriginGroupProperties::is_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_Valid() const{
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_isValid;
}

bool OAIDeepCreatedOriginGroupProperties::isSet() const {
...
bool OAIDeepCreatedOriginGroupProperties::isValid() const {
