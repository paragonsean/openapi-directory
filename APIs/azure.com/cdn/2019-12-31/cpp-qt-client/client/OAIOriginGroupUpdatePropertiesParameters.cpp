...
OAIOriginGroupUpdatePropertiesParameters::OAIOriginGroupUpdatePropertiesParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOriginGroupUpdatePropertiesParameters::OAIOriginGroupUpdatePropertiesParameters() {
    this->initializeModel();
}

OAIOriginGroupUpdatePropertiesParameters::~OAIOriginGroupUpdatePropertiesParameters() {}

void OAIOriginGroupUpdatePropertiesParameters::initializeModel() {
...
void OAIOriginGroupUpdatePropertiesParameters::fromJson(QString jsonString) {
...
void OAIOriginGroupUpdatePropertiesParameters::fromJsonObject(QJsonObject json) {
...
QString OAIOriginGroupUpdatePropertiesParameters::asJson() const {
...
QJsonObject OAIOriginGroupUpdatePropertiesParameters::asJsonObject() const {
    QJsonObject obj;
...
OAIHealthProbeParameters OAIOriginGroupUpdatePropertiesParameters::getHealthProbeSettings() const {
    return m_health_probe_settings;
}
void OAIOriginGroupUpdatePropertiesParameters::setHealthProbeSettings(const OAIHealthProbeParameters &health_probe_settings) {
    m_health_probe_settings = health_probe_settings;
    m_health_probe_settings_isSet = true;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_health_probe_settings_Set() const{
    return m_health_probe_settings_isSet;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_health_probe_settings_Valid() const{
    return m_health_probe_settings_isValid;
}

QList<OAIResourceReference> OAIOriginGroupUpdatePropertiesParameters::getOrigins() const {
    return m_origins;
}
void OAIOriginGroupUpdatePropertiesParameters::setOrigins(const QList<OAIResourceReference> &origins) {
    m_origins = origins;
    m_origins_isSet = true;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_origins_Set() const{
    return m_origins_isSet;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_origins_Valid() const{
    return m_origins_isValid;
}

OAIResponseBasedOriginErrorDetectionParameters OAIOriginGroupUpdatePropertiesParameters::getResponseBasedOriginErrorDetectionSettings() const {
    return m_response_based_origin_error_detection_settings;
}
void OAIOriginGroupUpdatePropertiesParameters::setResponseBasedOriginErrorDetectionSettings(const OAIResponseBasedOriginErrorDetectionParameters &response_based_origin_error_detection_settings) {
...
bool OAIOriginGroupUpdatePropertiesParameters::is_response_based_origin_error_detection_settings_Set() const{
    return m_response_based_origin_error_detection_settings_isSet;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_response_based_origin_error_detection_settings_Valid() const{
    return m_response_based_origin_error_detection_settings_isValid;
}

qint32 OAIOriginGroupUpdatePropertiesParameters::getTrafficRestorationTimeToHealedOrNewEndpointsInMinutes() const {
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes;
}
void OAIOriginGroupUpdatePropertiesParameters::setTrafficRestorationTimeToHealedOrNewEndpointsInMinutes(const qint32 &traffic_restoration_time_to_healed_or_new_endpoints_in_minutes) {
...
bool OAIOriginGroupUpdatePropertiesParameters::is_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_Set() const{
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_isSet;
}

bool OAIOriginGroupUpdatePropertiesParameters::is_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_Valid() const{
    return m_traffic_restoration_time_to_healed_or_new_endpoints_in_minutes_isValid;
}

bool OAIOriginGroupUpdatePropertiesParameters::isSet() const {
...
bool OAIOriginGroupUpdatePropertiesParameters::isValid() const {
