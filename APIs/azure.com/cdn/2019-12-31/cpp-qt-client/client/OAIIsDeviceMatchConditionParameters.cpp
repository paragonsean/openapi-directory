...
OAIIsDeviceMatchConditionParameters::OAIIsDeviceMatchConditionParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsDeviceMatchConditionParameters::OAIIsDeviceMatchConditionParameters() {
    this->initializeModel();
}

OAIIsDeviceMatchConditionParameters::~OAIIsDeviceMatchConditionParameters() {}

void OAIIsDeviceMatchConditionParameters::initializeModel() {
...
void OAIIsDeviceMatchConditionParameters::fromJson(QString jsonString) {
...
void OAIIsDeviceMatchConditionParameters::fromJsonObject(QJsonObject json) {
...
QString OAIIsDeviceMatchConditionParameters::asJson() const {
...
QJsonObject OAIIsDeviceMatchConditionParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIsDeviceMatchConditionParameters::getOdataType() const {
    return m_odata_type;
}
void OAIIsDeviceMatchConditionParameters::setOdataType(const QString &odata_type) {
    m_odata_type = odata_type;
    m_odata_type_isSet = true;
}

bool OAIIsDeviceMatchConditionParameters::is_odata_type_Set() const{
    return m_odata_type_isSet;
}

bool OAIIsDeviceMatchConditionParameters::is_odata_type_Valid() const{
    return m_odata_type_isValid;
}

QList<QString> OAIIsDeviceMatchConditionParameters::getMatchValues() const {
    return m_match_values;
}
void OAIIsDeviceMatchConditionParameters::setMatchValues(const QList<QString> &match_values) {
    m_match_values = match_values;
    m_match_values_isSet = true;
}

bool OAIIsDeviceMatchConditionParameters::is_match_values_Set() const{
    return m_match_values_isSet;
}

bool OAIIsDeviceMatchConditionParameters::is_match_values_Valid() const{
    return m_match_values_isValid;
}

bool OAIIsDeviceMatchConditionParameters::isNegateCondition() const {
    return m_negate_condition;
}
void OAIIsDeviceMatchConditionParameters::setNegateCondition(const bool &negate_condition) {
    m_negate_condition = negate_condition;
    m_negate_condition_isSet = true;
}

bool OAIIsDeviceMatchConditionParameters::is_negate_condition_Set() const{
    return m_negate_condition_isSet;
}

bool OAIIsDeviceMatchConditionParameters::is_negate_condition_Valid() const{
    return m_negate_condition_isValid;
}

QString OAIIsDeviceMatchConditionParameters::getROperator() const {
    return m_r_operator;
}
void OAIIsDeviceMatchConditionParameters::setROperator(const QString &r_operator) {
    m_r_operator = r_operator;
    m_r_operator_isSet = true;
}

bool OAIIsDeviceMatchConditionParameters::is_r_operator_Set() const{
    return m_r_operator_isSet;
}

bool OAIIsDeviceMatchConditionParameters::is_r_operator_Valid() const{
    return m_r_operator_isValid;
}

QList<OAITransform> OAIIsDeviceMatchConditionParameters::getTransforms() const {
    return m_transforms;
}
void OAIIsDeviceMatchConditionParameters::setTransforms(const QList<OAITransform> &transforms) {
    m_transforms = transforms;
    m_transforms_isSet = true;
}

bool OAIIsDeviceMatchConditionParameters::is_transforms_Set() const{
    return m_transforms_isSet;
}

bool OAIIsDeviceMatchConditionParameters::is_transforms_Valid() const{
    return m_transforms_isValid;
}

bool OAIIsDeviceMatchConditionParameters::isSet() const {
...
bool OAIIsDeviceMatchConditionParameters::isValid() const {
