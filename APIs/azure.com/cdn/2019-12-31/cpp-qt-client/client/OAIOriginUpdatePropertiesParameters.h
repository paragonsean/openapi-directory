...
/*
 * OAIOriginUpdatePropertiesParameters.h
 *
 * The JSON object that contains the properties of the origin.
 */

#ifndef OAIOriginUpdatePropertiesParameters_H
#define OAIOriginUpdatePropertiesParameters_H
...
class OAIOriginUpdatePropertiesParameters : public OAIObject {
public:
    OAIOriginUpdatePropertiesParameters();
    OAIOriginUpdatePropertiesParameters(QString json);
    ~OAIOriginUpdatePropertiesParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginUpdatePropertiesParameters)

#endif // OAIOriginUpdatePropertiesParameters_H
