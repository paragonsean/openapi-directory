...
void OAIResourceType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Microsoft.Cdn/Profiles/Endpoints", Qt::CaseInsensitive) == 0) {
        m_value = eOAIResourceType::MICROSOFT_CDN_PROFILES_ENDPOINTS;
...
QString OAIResourceType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIResourceType::MICROSOFT_CDN_PROFILES_ENDPOINTS:
            val = "Microsoft.Cdn/Profiles/Endpoints";
            break;
        default:
            break;
    }
