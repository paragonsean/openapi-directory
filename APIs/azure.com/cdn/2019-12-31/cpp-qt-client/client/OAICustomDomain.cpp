...
OAICustomDomainProperties OAICustomDomain::getProperties() const {
    return m_properties;
}
void OAICustomDomain::setProperties(const OAICustomDomainProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAICustomDomain::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAICustomDomain::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAICustomDomain::getId() const {
    return m_id;
}
void OAICustomDomain::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICustomDomain::is_id_Set() const{
    return m_id_isSet;
}

bool OAICustomDomain::is_id_Valid() const{
    return m_id_isValid;
}
...
QString OAICustomDomain::getType() const {
    return m_type;
}
void OAICustomDomain::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICustomDomain::is_type_Set() const{
    return m_type_isSet;
}

bool OAICustomDomain::is_type_Valid() const{
