...
/*
 * OAIOriginProperties.h
 *
 * The JSON object that contains the properties of the origin.
 */

#ifndef OAIOriginProperties_H
#define OAIOriginProperties_H
...
class OAIOriginProperties : public OAIObject {
public:
    OAIOriginProperties();
    OAIOriginProperties(QString json);
    ~OAIOriginProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginProperties)

#endif // OAIOriginProperties_H
