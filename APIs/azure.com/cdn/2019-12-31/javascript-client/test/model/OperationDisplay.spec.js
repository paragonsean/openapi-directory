...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdnManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new CdnManagementClient.OperationDisplay();
      //expect(instance).to.be.a(CdnManagementClient.OperationDisplay);
    });
