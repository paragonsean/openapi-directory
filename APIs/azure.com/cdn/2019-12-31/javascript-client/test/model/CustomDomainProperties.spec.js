...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CdnManagementClient.CustomDomainProperties();
  });
  ...
  describe('CustomDomainProperties', function() {
    it('should create an instance of CustomDomainProperties', function() {
      // uncomment below and update the code to test CustomDomainProperties
      //var instance = new CdnManagementClient.CustomDomainProperties();
      //expect(instance).to.be.a(CdnManagementClient.CustomDomainProperties);
    });
