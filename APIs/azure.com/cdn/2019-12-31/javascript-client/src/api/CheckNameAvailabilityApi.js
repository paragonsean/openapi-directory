...
export default class CheckNameAvailabilityApi {
    ...
    */
     ...
     */
    checkNameAvailability(apiVersion, checkNameAvailabilityInput, callback) {
      ...
      if (checkNameAvailabilityInput === undefined || checkNameAvailabilityInput === null) {
        throw new Error("Missing the required parameter 'checkNameAvailabilityInput' when calling checkNameAvailability");
      }
