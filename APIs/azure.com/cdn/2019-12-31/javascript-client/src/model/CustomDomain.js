...
import CustomDomainProperties from './CustomDomainProperties';
...
class CustomDomain {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = CustomDomainProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          CustomDomainProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/CustomDomainProperties} properties
 */
CustomDomain.prototype['properties'] = undefined;
 ...
 * @member {String} type
 */
CustomDomain.prototype['type'] = undefined;
