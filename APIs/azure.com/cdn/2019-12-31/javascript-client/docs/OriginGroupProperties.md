# CdnManagementClient.OriginGroupProperties
...
**resourceState** | **String** | Resource status of the origin group. | [optional] [readonly] 
**healthProbeSettings** | [**HealthProbeParameters**](HealthProbeParameters.md) |  | [optional] 
**origins** | [**[ResourceReference]**](ResourceReference.md) | The source of the content being delivered via CDN within given origin group. | [optional] 
