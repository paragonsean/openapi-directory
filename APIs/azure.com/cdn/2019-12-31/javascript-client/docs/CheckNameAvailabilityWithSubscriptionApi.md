# CdnManagementClient.CheckNameAvailabilityWithSubscriptionApi
...
let apiInstance = new CdnManagementClient.CheckNameAvailabilityWithSubscriptionApi();
...
apiInstance.checkNameAvailabilityWithSubscription(subscriptionId, apiVersion, checkNameAvailabilityInput, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
