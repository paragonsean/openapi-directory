...
let originName = "originName_example"; // String | Name of the origin that is unique within the endpoint.
...
let origin = new CdnManagementClient.Origin(); // Origin | Origin properties
apiInstance.originsCreate(resourceGroupName, profileName, endpointName, originName, subscriptionId, apiVersion, origin, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | Azure Subscription ID.
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request. Current version is 2017-04-02.
apiInstance.originsDelete(resourceGroupName, profileName, endpointName, originName, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
