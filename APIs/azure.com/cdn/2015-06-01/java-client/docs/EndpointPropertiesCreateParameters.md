...
|**originHostHeader** | **String** | The host header CDN provider will send along with content requests to origins. The default value is the host name of the origin. |  [optional] |
