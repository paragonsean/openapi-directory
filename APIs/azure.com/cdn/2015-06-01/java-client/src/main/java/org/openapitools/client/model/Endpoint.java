...
public class Endpoint {
  ...
  public Endpoint tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Endpoint putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, endpoint.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        EndpointProperties.validateJsonElement(jsonObj.get("properties"));
      }
