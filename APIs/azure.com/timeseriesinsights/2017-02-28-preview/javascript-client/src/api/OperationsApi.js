...
export default class OperationsApi {
    ...
    */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request. Current version is 2017-02-28-preview.
    ...
    operationsList(apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/providers/Microsoft.TimeSeriesInsights/operations', 'GET',
