...
async def test_environments_create_or_update(client):
    ...
    """
    parameters = {"sku":{"name":"S1","capacity":1},"properties":{"storageLimitExceededBehavior":"PurgeOldData","dataRetentionTime":"dataRetentionTime"}}
...
async def test_environments_update(client):
    ...
    """
    environment_update_parameters = {"sku":{"name":"S1","capacity":1},"properties":{"dataRetentionTime":"dataRetentionTime"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
