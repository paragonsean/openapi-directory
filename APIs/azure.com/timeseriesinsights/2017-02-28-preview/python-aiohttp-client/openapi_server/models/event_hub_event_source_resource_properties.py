...
class EventHubEventSourceResourceProperties(Model):
    ...
    def __init__(self, consumer_group_name: str=None, event_hub_name: str=None, key_name: str=None, service_bus_namespace: str=None, event_source_resource_id: str=None, timestamp_property_name: str=None, creation_time: datetime=None, provisioning_state: str=None):
