...
class IoTHubEventSourceCreationProperties(Model):
    ...
    def __init__(self, shared_access_key: str=None, consumer_group_name: str=None, iot_hub_name: str=None, key_name: str=None, event_source_resource_id: str=None, timestamp_property_name: str=None, creation_time: datetime=None, provisioning_state: str=None):
