...
public class EnvironmentsApi {
     ...
     */
    public okhttp3.Call environmentsGetCall(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call environmentsGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return environmentsGetCall(subscriptionId, resourceGroupName, environmentName, apiVersion, _callback);
     ...
     */
    public EnvironmentResource environmentsGet(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion) throws ApiException {
        ApiResponse<EnvironmentResource> localVarResp = environmentsGetWithHttpInfo(subscriptionId, resourceGroupName, environmentName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EnvironmentResource> environmentsGetWithHttpInfo(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = environmentsGetValidateBeforeCall(subscriptionId, resourceGroupName, environmentName, apiVersion, null);
        Type localVarReturnType = new TypeToken<EnvironmentResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call environmentsGetAsync(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, final ApiCallback<EnvironmentResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = environmentsGetValidateBeforeCall(subscriptionId, resourceGroupName, environmentName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<EnvironmentResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
