...
public class TypesBatchResponse {
  ...
  private List<TimeSeriesTypeOrError> get = new ArrayList<>();

  public static final String SERIALIZED_NAME_PUT = "put";
  @SerializedName(SERIALIZED_NAME_PUT)
  private List<TimeSeriesTypeOrError> put = new ArrayList<>();
  ...
  public TypesBatchResponse(
     ...
     List<TimeSeriesTypeOrError> get, 
     List<TimeSeriesTypeOrError> put
  ) {
    this();
    this.delete = delete;
    this.get = get;
   ...
   */
  @javax.annotation.Nullable
  public List<TimeSeriesTypeOrError> getGet() {
    return get;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<TimeSeriesTypeOrError> getPut() {
    return put;
  }
  ...
  public boolean equals(Object o) {
    ...
    TypesBatchResponse typesBatchResponse = (TypesBatchResponse) o;
    return Objects.equals(this.delete, typesBatchResponse.delete) &&
        Objects.equals(this.get, typesBatchResponse.get) &&
        Objects.equals(this.put, typesBatchResponse.put);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypesBatchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypesBatchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TypesBatchResponse is not found in the empty JSON string", TypesBatchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypesBatchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TypesBatchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("get") != null && !jsonObj.get("get").isJsonNull()) {
        ...
        if (jsonArrayget != null) {
          ...
          for (int i = 0; i < jsonArrayget.size(); i++) {
            TimeSeriesTypeOrError.validateJsonElement(jsonArrayget.get(i));
          };
        }
      }
      if (jsonObj.get("put") != null && !jsonObj.get("put").isJsonNull()) {
        ...
        if (jsonArrayput != null) {
          ...
          for (int i = 0; i < jsonArrayput.size(); i++) {
            TimeSeriesTypeOrError.validateJsonElement(jsonArrayput.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypesBatchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypesBatchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypesBatchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypesBatchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TypesBatchResponse>() {
           @Override
           public void write(JsonWriter out, TypesBatchResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TypesBatchResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TypesBatchResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypesBatchResponse
   * @throws IOException if the JSON string is invalid with respect to TypesBatchResponse
   */
  public static TypesBatchResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypesBatchResponse.class);
  }

  /**
   * Convert an instance of TypesBatchResponse to an JSON string
   *
   * @return JSON string
   */
