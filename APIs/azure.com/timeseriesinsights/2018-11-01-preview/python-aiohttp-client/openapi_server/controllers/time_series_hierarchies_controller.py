...
async def time_series_hierarchies_execute_batch(request: web.Request, api_version, parameters, x_ms_client_request_id=None, x_ms_client_session_id=None) -> web.Response:
    """time_series_hierarchies_execute_batch
    ...
    """
    parameters = HierarchiesBatchRequest.from_dict(parameters)
    return web.Response(status=200)


async def time_series_hierarchies_get(request: web.Request, api_version, x_ms_continuation=None, x_ms_client_request_id=None, x_ms_client_session_id=None) -> web.Response:
    """time_series_hierarchies_get
