...
/**
 * The GetHierarchiesPage model module.
 * @module model/GetHierarchiesPage
 * @version 2018-11-01-preview
 */
class GetHierarchiesPage {
    /**
     * Constructs a new <code>GetHierarchiesPage</code>.
     * Partial list of time series hierarchies returned in a single request.
     * @alias module:model/GetHierarchiesPage
     * @implements module:model/PagedResponse
     */
    constructor() { 
        PagedResponse.initialize(this);
        GetHierarchiesPage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetHierarchiesPage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetHierarchiesPage} obj Optional instance to populate.
     * @return {module:model/GetHierarchiesPage} The populated <code>GetHierarchiesPage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetHierarchiesPage();
            ...
            if (data.hasOwnProperty('hierarchies')) {
                obj['hierarchies'] = ApiClient.convertToType(data['hierarchies'], [TimeSeriesHierarchy]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetHierarchiesPage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHierarchiesPage</code>.
     */
 ...
 */
GetHierarchiesPage.prototype['continuationToken'] = undefined;
 ...
 * @member {Array.<module:model/TimeSeriesHierarchy>} hierarchies
 */
GetHierarchiesPage.prototype['hierarchies'] = undefined;
...
export default GetHierarchiesPage;
