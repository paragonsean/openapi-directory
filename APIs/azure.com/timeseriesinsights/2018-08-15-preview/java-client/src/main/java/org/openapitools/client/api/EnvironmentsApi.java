...
import org.openapitools.client.model.StandardEnvironmentUpdateParameters;
...
public class EnvironmentsApi {
     ...
     * @param environmentName The name of the Time Series Insights environment associated with the specified resource group. (required)
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param standardEnvironmentUpdateParameters Request object that contains the updated information for the environment. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call environmentsUpdateCall(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = standardEnvironmentUpdateParameters;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call environmentsUpdateValidateBeforeCall(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        if (standardEnvironmentUpdateParameters == null) {
            throw new ApiException("Missing the required parameter 'standardEnvironmentUpdateParameters' when calling environmentsUpdate(Async)");
        }

        return environmentsUpdateCall(subscriptionId, resourceGroupName, environmentName, apiVersion, standardEnvironmentUpdateParameters, _callback);
     ...
     */
    public EnvironmentResource environmentsUpdate(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters) throws ApiException {
        ApiResponse<EnvironmentResource> localVarResp = environmentsUpdateWithHttpInfo(subscriptionId, resourceGroupName, environmentName, apiVersion, standardEnvironmentUpdateParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EnvironmentResource> environmentsUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters) throws ApiException {
        okhttp3.Call localVarCall = environmentsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, environmentName, apiVersion, standardEnvironmentUpdateParameters, null);
        Type localVarReturnType = new TypeToken<EnvironmentResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call environmentsUpdateAsync(String subscriptionId, String resourceGroupName, String environmentName, String apiVersion, StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters, final ApiCallback<EnvironmentResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = environmentsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, environmentName, apiVersion, standardEnvironmentUpdateParameters, _callback);
        Type localVarReturnType = new TypeToken<EnvironmentResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
