...
public class StandardEnvironmentMutableProperties {
  ...
  public StandardEnvironmentMutableProperties dataRetentionTime(String dataRetentionTime) {
  ...
  public StandardEnvironmentMutableProperties partitionKeyProperties(List<TimeSeriesIdProperty> partitionKeyProperties) {
    this.partitionKeyProperties = partitionKeyProperties;
    return this;
  }

  public StandardEnvironmentMutableProperties addPartitionKeyPropertiesItem(TimeSeriesIdProperty partitionKeyPropertiesItem) {
  ...
  public StandardEnvironmentMutableProperties storageLimitExceededBehavior(StorageLimitExceededBehaviorEnum storageLimitExceededBehavior) {
  ...
  public boolean equals(Object o) {
    ...
    StandardEnvironmentMutableProperties standardEnvironmentMutableProperties = (StandardEnvironmentMutableProperties) o;
    return Objects.equals(this.dataRetentionTime, standardEnvironmentMutableProperties.dataRetentionTime) &&
        Objects.equals(this.partitionKeyProperties, standardEnvironmentMutableProperties.partitionKeyProperties) &&
        Objects.equals(this.storageLimitExceededBehavior, standardEnvironmentMutableProperties.storageLimitExceededBehavior);
  }
  ...
  public String toString() {
    ...
    sb.append("class StandardEnvironmentMutableProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StandardEnvironmentMutableProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StandardEnvironmentMutableProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StandardEnvironmentMutableProperties is not found in the empty JSON string", StandardEnvironmentMutableProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StandardEnvironmentMutableProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StandardEnvironmentMutableProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StandardEnvironmentMutableProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StandardEnvironmentMutableProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StandardEnvironmentMutableProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StandardEnvironmentMutableProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<StandardEnvironmentMutableProperties>() {
           @Override
           public void write(JsonWriter out, StandardEnvironmentMutableProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StandardEnvironmentMutableProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StandardEnvironmentMutableProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StandardEnvironmentMutableProperties
   * @throws IOException if the JSON string is invalid with respect to StandardEnvironmentMutableProperties
   */
  public static StandardEnvironmentMutableProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StandardEnvironmentMutableProperties.class);
  }

  /**
   * Convert an instance of StandardEnvironmentMutableProperties to an JSON string
   *
   * @return JSON string
   */
