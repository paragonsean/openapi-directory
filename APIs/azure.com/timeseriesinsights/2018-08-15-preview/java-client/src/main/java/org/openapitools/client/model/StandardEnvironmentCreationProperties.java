...
public class StandardEnvironmentCreationProperties {
  ...
  public StandardEnvironmentCreationProperties dataRetentionTime(String dataRetentionTime) {
  ...
  public StandardEnvironmentCreationProperties partitionKeyProperties(List<TimeSeriesIdProperty> partitionKeyProperties) {
    this.partitionKeyProperties = partitionKeyProperties;
    return this;
  }

  public StandardEnvironmentCreationProperties addPartitionKeyPropertiesItem(TimeSeriesIdProperty partitionKeyPropertiesItem) {
  ...
  public StandardEnvironmentCreationProperties storageLimitExceededBehavior(StorageLimitExceededBehaviorEnum storageLimitExceededBehavior) {
  ...
  public boolean equals(Object o) {
    ...
    StandardEnvironmentCreationProperties standardEnvironmentCreationProperties = (StandardEnvironmentCreationProperties) o;
    return Objects.equals(this.dataRetentionTime, standardEnvironmentCreationProperties.dataRetentionTime) &&
        Objects.equals(this.partitionKeyProperties, standardEnvironmentCreationProperties.partitionKeyProperties) &&
        Objects.equals(this.storageLimitExceededBehavior, standardEnvironmentCreationProperties.storageLimitExceededBehavior);
  }
  ...
  public String toString() {
    ...
    sb.append("class StandardEnvironmentCreationProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StandardEnvironmentCreationProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StandardEnvironmentCreationProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StandardEnvironmentCreationProperties is not found in the empty JSON string", StandardEnvironmentCreationProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StandardEnvironmentCreationProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StandardEnvironmentCreationProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StandardEnvironmentCreationProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StandardEnvironmentCreationProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StandardEnvironmentCreationProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StandardEnvironmentCreationProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StandardEnvironmentCreationProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<StandardEnvironmentCreationProperties>() {
           @Override
           public void write(JsonWriter out, StandardEnvironmentCreationProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StandardEnvironmentCreationProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StandardEnvironmentCreationProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StandardEnvironmentCreationProperties
   * @throws IOException if the JSON string is invalid with respect to StandardEnvironmentCreationProperties
   */
  public static StandardEnvironmentCreationProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StandardEnvironmentCreationProperties.class);
  }

  /**
   * Convert an instance of StandardEnvironmentCreationProperties to an JSON string
   *
   * @return JSON string
   */
