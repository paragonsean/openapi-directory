...
public class EnvironmentsApiTest {
    ...
    public void environmentsUpdateTest() throws ApiException {
        ...
        String environmentName = null;
        String apiVersion = null;
        StandardEnvironmentUpdateParameters standardEnvironmentUpdateParameters = null;
        EnvironmentResource response = api.environmentsUpdate(subscriptionId, resourceGroupName, environmentName, apiVersion, standardEnvironmentUpdateParameters);
        // TODO: test validations
    }
