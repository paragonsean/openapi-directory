...
public:
    ...
    * @param[in]  environment_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  standard_environment_update_parameters OAIStandardEnvironmentUpdateParameters [required]
    */
    virtual void environmentsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &environment_name, const QString &api_version, const OAIStandardEnvironmentUpdateParameters &standard_environment_update_parameters);
