...
/**
 * The IoTHubEventSourceCreationProperties model module.
 * @module model/IoTHubEventSourceCreationProperties
 * @version 2018-08-15-preview
 */
class IoTHubEventSourceCreationProperties {
    /**
     * Constructs a new <code>IoTHubEventSourceCreationProperties</code>.
     * Properties of the IoTHub event source that are required on create or update requests.
     * @alias module:model/IoTHubEventSourceCreationProperties
    ...
    constructor(consumerGroupName, iotHubName, keyName, eventSourceResourceId) { 
        ...
        IoTHubEventSourceCreationProperties.initialize(this, consumerGroupName, iotHubName, keyName, eventSourceResourceId);
    }
    ...
    /**
     * Constructs a <code>IoTHubEventSourceCreationProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IoTHubEventSourceCreationProperties} obj Optional instance to populate.
     * @return {module:model/IoTHubEventSourceCreationProperties} The populated <code>IoTHubEventSourceCreationProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoTHubEventSourceCreationProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>IoTHubEventSourceCreationProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoTHubEventSourceCreationProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoTHubEventSourceCreationProperties.RequiredProperties) {
...
IoTHubEventSourceCreationProperties.RequiredProperties = ["sharedAccessKey", "consumerGroupName", "iotHubName", "keyName", "eventSourceResourceId"];
 ...
 */
IoTHubEventSourceCreationProperties.prototype['sharedAccessKey'] = undefined;

/**
 * The name of the iot hub's consumer group that holds the partitions from which events will be read.
 * @member {String} consumerGroupName
 */
IoTHubEventSourceCreationProperties.prototype['consumerGroupName'] = undefined;

/**
 * The name of the iot hub.
 * @member {String} iotHubName
 */
IoTHubEventSourceCreationProperties.prototype['iotHubName'] = undefined;

/**
 * The name of the Shared Access Policy key that grants the Time Series Insights service access to the iot hub. This shared access policy key must grant 'service connect' permissions to the iot hub.
 * @member {String} keyName
 */
IoTHubEventSourceCreationProperties.prototype['keyName'] = undefined;

/**
 * The resource id of the event source in Azure Resource Manager.
 * @member {String} eventSourceResourceId
 */
IoTHubEventSourceCreationProperties.prototype['eventSourceResourceId'] = undefined;

/**
 * The event property that will be used as the event source's timestamp. If a value isn't specified for timestampPropertyName, or if null or empty-string is specified, the event creation time will be used.
 * @member {String} timestampPropertyName
 */
IoTHubEventSourceCreationProperties.prototype['timestampPropertyName'] = undefined;

/**
 * The time the resource was created.
 * @member {Date} creationTime
 */
IoTHubEventSourceCreationProperties.prototype['creationTime'] = undefined;

/**
 * @member {module:model/ProvisioningState} provisioningState
 */
IoTHubEventSourceCreationProperties.prototype['provisioningState'] = undefined;
...
export default IoTHubEventSourceCreationProperties;
