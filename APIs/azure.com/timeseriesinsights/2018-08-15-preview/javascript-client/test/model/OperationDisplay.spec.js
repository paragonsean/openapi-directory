...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimeSeriesInsightsClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new TimeSeriesInsightsClient.OperationDisplay();
      //expect(instance).to.be.a(TimeSeriesInsightsClient.OperationDisplay);
    });
