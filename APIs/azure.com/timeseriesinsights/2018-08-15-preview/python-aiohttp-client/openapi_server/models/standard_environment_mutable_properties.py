...
class StandardEnvironmentMutableProperties(Model):
    ...
    def __init__(self, data_retention_time: str=None, partition_key_properties: List[TimeSeriesIdProperty]=None, storage_limit_exceeded_behavior: str=None):
        """StandardEnvironmentMutableProperties - a model defined in OpenAPI

        :param data_retention_time: The data_retention_time of this StandardEnvironmentMutableProperties.
        :param partition_key_properties: The partition_key_properties of this StandardEnvironmentMutableProperties.
        :param storage_limit_exceeded_behavior: The storage_limit_exceeded_behavior of this StandardEnvironmentMutableProperties.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StandardEnvironmentMutableProperties':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StandardEnvironmentMutableProperties of this StandardEnvironmentMutableProperties.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_retention_time(self):
        """Gets the data_retention_time of this StandardEnvironmentMutableProperties.

        ISO8601 timespan specifying the minimum number of days the environment's events will be available for query.

        :return: The data_retention_time of this StandardEnvironmentMutableProperties.
        :rtype: str
        """
    ...
    def data_retention_time(self, data_retention_time):
        """Sets the data_retention_time of this StandardEnvironmentMutableProperties.
    ...
    def partition_key_properties(self):
        """Gets the partition_key_properties of this StandardEnvironmentMutableProperties.

        The list of event properties which will be used to partition data in the environment.

        :return: The partition_key_properties of this StandardEnvironmentMutableProperties.
    ...
    def partition_key_properties(self, partition_key_properties):
        """Sets the partition_key_properties of this StandardEnvironmentMutableProperties.
    ...
    def storage_limit_exceeded_behavior(self):
        """Gets the storage_limit_exceeded_behavior of this StandardEnvironmentMutableProperties.

        The behavior the Time Series Insights service should take when the environment's capacity has been exceeded. If \"PauseIngress\" is specified, new events will not be read from the event source. If \"PurgeOldData\" is specified, new events will continue to be read and old events will be deleted from the environment. The default behavior is PurgeOldData.

        :return: The storage_limit_exceeded_behavior of this StandardEnvironmentMutableProperties.
        :rtype: str
        """
    ...
    def storage_limit_exceeded_behavior(self, storage_limit_exceeded_behavior):
        """Sets the storage_limit_exceeded_behavior of this StandardEnvironmentMutableProperties.
