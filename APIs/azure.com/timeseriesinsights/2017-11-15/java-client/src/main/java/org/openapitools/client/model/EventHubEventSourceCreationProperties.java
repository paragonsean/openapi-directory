...
public class EventHubEventSourceCreationProperties {
  ...
  public EventHubEventSourceCreationProperties sharedAccessKey(String sharedAccessKey) {
  ...
  public EventHubEventSourceCreationProperties consumerGroupName(String consumerGroupName) {
  ...
  public EventHubEventSourceCreationProperties eventHubName(String eventHubName) {
  ...
  public EventHubEventSourceCreationProperties keyName(String keyName) {
  ...
  public EventHubEventSourceCreationProperties serviceBusNamespace(String serviceBusNamespace) {
  ...
  public EventHubEventSourceCreationProperties eventSourceResourceId(String eventSourceResourceId) {
  ...
  public EventHubEventSourceCreationProperties timestampPropertyName(String timestampPropertyName) {
  ...
  public EventHubEventSourceCreationProperties provisioningState(ProvisioningState provisioningState) {
  ...
  public boolean equals(Object o) {
    ...
    EventHubEventSourceCreationProperties eventHubEventSourceCreationProperties = (EventHubEventSourceCreationProperties) o;
    return Objects.equals(this.sharedAccessKey, eventHubEventSourceCreationProperties.sharedAccessKey) &&
        Objects.equals(this.consumerGroupName, eventHubEventSourceCreationProperties.consumerGroupName) &&
        Objects.equals(this.eventHubName, eventHubEventSourceCreationProperties.eventHubName) &&
        Objects.equals(this.keyName, eventHubEventSourceCreationProperties.keyName) &&
        Objects.equals(this.serviceBusNamespace, eventHubEventSourceCreationProperties.serviceBusNamespace) &&
        Objects.equals(this.eventSourceResourceId, eventHubEventSourceCreationProperties.eventSourceResourceId) &&
        Objects.equals(this.timestampPropertyName, eventHubEventSourceCreationProperties.timestampPropertyName) &&
        Objects.equals(this.creationTime, eventHubEventSourceCreationProperties.creationTime) &&
        Objects.equals(this.provisioningState, eventHubEventSourceCreationProperties.provisioningState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sharedAccessKey, consumerGroupName, eventHubName, keyName, serviceBusNamespace, eventSourceResourceId, timestampPropertyName, creationTime, provisioningState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventHubEventSourceCreationProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventHubEventSourceCreationProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventHubEventSourceCreationProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventHubEventSourceCreationProperties is not found in the empty JSON string", EventHubEventSourceCreationProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventHubEventSourceCreationProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventHubEventSourceCreationProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventHubEventSourceCreationProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventHubEventSourceCreationProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventHubEventSourceCreationProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventHubEventSourceCreationProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventHubEventSourceCreationProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<EventHubEventSourceCreationProperties>() {
           @Override
           public void write(JsonWriter out, EventHubEventSourceCreationProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventHubEventSourceCreationProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventHubEventSourceCreationProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventHubEventSourceCreationProperties
   * @throws IOException if the JSON string is invalid with respect to EventHubEventSourceCreationProperties
   */
  public static EventHubEventSourceCreationProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventHubEventSourceCreationProperties.class);
  }

  /**
   * Convert an instance of EventHubEventSourceCreationProperties to an JSON string
   *
   * @return JSON string
   */
