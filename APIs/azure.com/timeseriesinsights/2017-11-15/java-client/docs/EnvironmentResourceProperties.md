...
|**partitionKeyProperties** | [**List&lt;PartitionKeyProperty&gt;**](PartitionKeyProperty.md) | The list of partition keys according to which the data in the environment will be ordered. |  [optional] |
