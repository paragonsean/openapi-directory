...
export default class EnvironmentsApi {
    ...
    */
     ...
     * @param {String} environmentName The name of the Time Series Insights environment associated with the specified resource group.
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {module:model/EnvironmentUpdateParameters} environmentUpdateParameters Request object that contains the updated information for the environment.
     ...
     * data is of type: {@link module:model/EnvironmentResource}
     */
    environmentsUpdate(subscriptionId, resourceGroupName, environmentName, apiVersion, environmentUpdateParameters, callback) {
      let postBody = environmentUpdateParameters;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      if (environmentUpdateParameters === undefined || environmentUpdateParameters === null) {
        throw new Error("Missing the required parameter 'environmentUpdateParameters' when calling environmentsUpdate");
      }
