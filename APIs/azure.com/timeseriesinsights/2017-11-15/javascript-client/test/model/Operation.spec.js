...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimeSeriesInsightsClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new TimeSeriesInsightsClient.Operation();
      //expect(instance).to.be.a(TimeSeriesInsightsClient.Operation);
    });
