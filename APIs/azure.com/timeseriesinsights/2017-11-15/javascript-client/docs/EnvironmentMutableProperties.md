# TimeSeriesInsightsClient.EnvironmentMutableProperties
...
**partitionKeyProperties** | [**[PartitionKeyProperty]**](PartitionKeyProperty.md) | The list of event properties which will be used to partition data in the environment. | [optional] 
