...
QList<OAIPartitionKeyProperty> OAIEnvironmentCreationProperties::getPartitionKeyProperties() const {
    return m_partition_key_properties;
}
void OAIEnvironmentCreationProperties::setPartitionKeyProperties(const QList<OAIPartitionKeyProperty> &partition_key_properties) {
    m_partition_key_properties = partition_key_properties;
    m_partition_key_properties_isSet = true;
}

bool OAIEnvironmentCreationProperties::is_partition_key_properties_Set() const{
    return m_partition_key_properties_isSet;
}

bool OAIEnvironmentCreationProperties::is_partition_key_properties_Valid() const{
