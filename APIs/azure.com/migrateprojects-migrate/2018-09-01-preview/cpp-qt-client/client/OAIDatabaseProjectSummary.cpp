...
#include "OAIDatabaseProjectSummary.h"
...
OAIDatabaseProjectSummary::OAIDatabaseProjectSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseProjectSummary::OAIDatabaseProjectSummary() {
    this->initializeModel();
}

OAIDatabaseProjectSummary::~OAIDatabaseProjectSummary() {}

void OAIDatabaseProjectSummary::initializeModel() {
...
void OAIDatabaseProjectSummary::fromJson(QString jsonString) {
...
void OAIDatabaseProjectSummary::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseProjectSummary::asJson() const {
...
QJsonObject OAIDatabaseProjectSummary::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAIDatabaseProjectSummary::getExtendedSummary() const {
    return m_extended_summary;
}
void OAIDatabaseProjectSummary::setExtendedSummary(const QMap<QString, QString> &extended_summary) {
    m_extended_summary = extended_summary;
    m_extended_summary_isSet = true;
}

bool OAIDatabaseProjectSummary::is_extended_summary_Set() const{
    return m_extended_summary_isSet;
}

bool OAIDatabaseProjectSummary::is_extended_summary_Valid() const{
    return m_extended_summary_isValid;
}

QString OAIDatabaseProjectSummary::getInstanceType() const {
    return m_instance_type;
}
void OAIDatabaseProjectSummary::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIDatabaseProjectSummary::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIDatabaseProjectSummary::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QDateTime OAIDatabaseProjectSummary::getLastSummaryRefreshedTime() const {
    return m_last_summary_refreshed_time;
}
void OAIDatabaseProjectSummary::setLastSummaryRefreshedTime(const QDateTime &last_summary_refreshed_time) {
    m_last_summary_refreshed_time = last_summary_refreshed_time;
    m_last_summary_refreshed_time_isSet = true;
}

bool OAIDatabaseProjectSummary::is_last_summary_refreshed_time_Set() const{
    return m_last_summary_refreshed_time_isSet;
}

bool OAIDatabaseProjectSummary::is_last_summary_refreshed_time_Valid() const{
    return m_last_summary_refreshed_time_isValid;
}

QString OAIDatabaseProjectSummary::getRefreshSummaryState() const {
    return m_refresh_summary_state;
}
void OAIDatabaseProjectSummary::setRefreshSummaryState(const QString &refresh_summary_state) {
    m_refresh_summary_state = refresh_summary_state;
    m_refresh_summary_state_isSet = true;
}

bool OAIDatabaseProjectSummary::is_refresh_summary_state_Set() const{
    return m_refresh_summary_state_isSet;
}

bool OAIDatabaseProjectSummary::is_refresh_summary_state_Valid() const{
    return m_refresh_summary_state_isValid;
}

bool OAIDatabaseProjectSummary::isSet() const {
...
bool OAIDatabaseProjectSummary::isValid() const {
