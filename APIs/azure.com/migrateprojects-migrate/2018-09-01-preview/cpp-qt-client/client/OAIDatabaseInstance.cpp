...
QString OAIDatabaseInstance::getId() const {
    return m_id;
}
void OAIDatabaseInstance::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseInstance::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseInstance::is_id_Valid() const{
    return m_id_isValid;
}
...
OAIDatabaseInstanceProperties OAIDatabaseInstance::getProperties() const {
    return m_properties;
}
void OAIDatabaseInstance::setProperties(const OAIDatabaseInstanceProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIDatabaseInstance::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIDatabaseInstance::is_properties_Valid() const{
