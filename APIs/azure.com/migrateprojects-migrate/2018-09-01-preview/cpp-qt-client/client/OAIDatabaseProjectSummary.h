...
/*
 * OAIDatabaseProjectSummary.h
 *
 * The database project summary class.
 */

#ifndef OAIDatabaseProjectSummary_H
#define OAIDatabaseProjectSummary_H
...
class OAIDatabaseProjectSummary : public OAIObject {
public:
    OAIDatabaseProjectSummary();
    OAIDatabaseProjectSummary(QString json);
    ~OAIDatabaseProjectSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseProjectSummary)

#endif // OAIDatabaseProjectSummary_H
