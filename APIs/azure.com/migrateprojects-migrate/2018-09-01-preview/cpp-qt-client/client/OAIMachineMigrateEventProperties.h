...
/*
 * OAIMachineMigrateEventProperties.h
 *
 * Properties of the machine error resource.
 */

#ifndef OAIMachineMigrateEventProperties_H
#define OAIMachineMigrateEventProperties_H
...
class OAIMachineMigrateEventProperties : public OAIObject {
public:
    OAIMachineMigrateEventProperties();
    OAIMachineMigrateEventProperties(QString json);
    ~OAIMachineMigrateEventProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMachineMigrateEventProperties)

#endif // OAIMachineMigrateEventProperties_H
