...
public class EventCollection {
  ...
  private List<MigrateEvent> value = new ArrayList<>();

  public EventCollection() {
  }

  public EventCollection nextLink(String nextLink) {
  ...
  public EventCollection value(List<MigrateEvent> value) {
    this.value = value;
    return this;
  }

  public EventCollection addValueItem(MigrateEvent valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<MigrateEvent> getValue() {
    return value;
  }

  public void setValue(List<MigrateEvent> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, eventCollection.nextLink) &&
        Objects.equals(this.value, eventCollection.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            MigrateEvent.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
