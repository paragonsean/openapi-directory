...
/**
 * The IEdmProperty model module.
 * @module model/IEdmProperty
 * @version 2018-09-01-preview
 */
class IEdmProperty {
    /**
     * Constructs a new <code>IEdmProperty</code>.
     * @alias module:model/IEdmProperty
     */
    constructor() { 
        
        IEdmProperty.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IEdmProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IEdmProperty} obj Optional instance to populate.
     * @return {module:model/IEdmProperty} The populated <code>IEdmProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IEdmProperty();
    ...
    /**
     * Validates the JSON data with respect to <code>IEdmProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IEdmProperty</code>.
     */
 ...
 */
IEdmProperty.prototype['declaringType'] = undefined;

/**
 * @member {String} name
 */
IEdmProperty.prototype['name'] = undefined;

/**
 * @member {module:model/IEdmProperty.PropertyKindEnum} propertyKind
 */
IEdmProperty.prototype['propertyKind'] = undefined;

/**
 * @member {module:model/IEdmTypeReference} type
 */
IEdmProperty.prototype['type'] = undefined;
