...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMigrateHub.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureMigrateHub.OperationDisplay();
      //expect(instance).to.be.a(AzureMigrateHub.OperationDisplay);
    });
