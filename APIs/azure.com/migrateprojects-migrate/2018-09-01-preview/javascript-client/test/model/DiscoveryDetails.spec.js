...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMigrateHub.DiscoveryDetails();
  });
  ...
  describe('DiscoveryDetails', function() {
    it('should create an instance of DiscoveryDetails', function() {
      // uncomment below and update the code to test DiscoveryDetails
      //var instance = new AzureMigrateHub.DiscoveryDetails();
      //expect(instance).to.be.a(AzureMigrateHub.DiscoveryDetails);
    });
