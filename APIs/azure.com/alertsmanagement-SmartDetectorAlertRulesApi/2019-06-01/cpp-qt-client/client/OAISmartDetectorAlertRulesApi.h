...
public:
    ...
    * @param[in]  expand_detector bool [optional]
    */
    virtual void smartDetectorAlertRulesList(const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &expand_detector = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  expand_detector bool [optional]
    */
    virtual void smartDetectorAlertRulesListByResourceGroup(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &expand_detector = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  alert_rule_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  parameters OAIAlertRulePatchObject [required]
    */
    virtual void smartDetectorAlertRulesPatch(const QString &subscription_id, const QString &resource_group_name, const QString &alert_rule_name, const QString &api_version, const OAIAlertRulePatchObject &parameters);
...
private:
    ...
    void smartDetectorAlertRulesPatchCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void smartDetectorAlertRulesPatchSignal(OAIAlertRule summary);
    ...
    void smartDetectorAlertRulesPatchSignalFull(OAIHttpRequestWorker *worker, OAIAlertRule summary);
    ...
    Q_DECL_DEPRECATED_X("Use smartDetectorAlertRulesPatchSignalError() instead")
    void smartDetectorAlertRulesPatchSignalE(OAIAlertRule summary, QNetworkReply::NetworkError error_type, QString error_str);
    void smartDetectorAlertRulesPatchSignalError(OAIAlertRule summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use smartDetectorAlertRulesPatchSignalErrorFull() instead")
    void smartDetectorAlertRulesPatchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void smartDetectorAlertRulesPatchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
