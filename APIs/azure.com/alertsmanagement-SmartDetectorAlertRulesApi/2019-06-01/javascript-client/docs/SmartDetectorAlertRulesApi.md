...
> AlertRulesList smartDetectorAlertRulesList(subscriptionId, apiVersion, opts)
...
apiInstance.smartDetectorAlertRulesList(subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> AlertRulesList smartDetectorAlertRulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, opts)
...
apiInstance.smartDetectorAlertRulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let alertRuleName = "alertRuleName_example"; // String | The name of the alert rule.
let apiVersion = "apiVersion_example"; // String | Client Api Version.
let parameters = new AzureAlertsManagementServiceResourceProvider.AlertRulePatchObject(); // AlertRulePatchObject | Parameters supplied to the operation.
apiInstance.smartDetectorAlertRulesPatch(subscriptionId, resourceGroupName, alertRuleName, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
