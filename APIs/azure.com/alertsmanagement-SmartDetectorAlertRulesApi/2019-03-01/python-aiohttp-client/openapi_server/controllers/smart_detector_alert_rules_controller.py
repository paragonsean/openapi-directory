...
async def smart_detector_alert_rules_list(request: web.Request, subscription_id, api_version) -> web.Response:
...
async def smart_detector_alert_rules_list_by_resource_group(request: web.Request, subscription_id, resource_group_name, api_version) -> web.Response:
