...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.AlertRule();
  });
  ...
  describe('AlertRule', function() {
    it('should create an instance of AlertRule', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.AlertRule();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.AlertRule);
    });
