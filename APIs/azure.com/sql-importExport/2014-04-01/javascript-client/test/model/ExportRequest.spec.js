...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabaseImportExportSpec.ExportRequest();
  });
  ...
  describe('ExportRequest', function() {
    it('should create an instance of ExportRequest', function() {
      ...
      //var instance = new AzureSqlDatabaseImportExportSpec.ExportRequest();
      //expect(instance).to.be.a(AzureSqlDatabaseImportExportSpec.ExportRequest);
    });
