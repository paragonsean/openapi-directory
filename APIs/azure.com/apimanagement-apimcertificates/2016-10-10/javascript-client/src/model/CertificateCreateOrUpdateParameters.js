...
class CertificateCreateOrUpdateParameters {
    ...
    constructor(data, password) { 
        ...
        CertificateCreateOrUpdateParameters.initialize(this, data, password);
    }
...
CertificateCreateOrUpdateParameters.RequiredProperties = ["data", "password"];

/**
 * Base 64 encoded certificate using the application/x-pkcs12 representation.
 * @member {String} data
 */
CertificateCreateOrUpdateParameters.prototype['data'] = undefined;

/**
 * Password for the Certificate
 * @member {String} password
 */
CertificateCreateOrUpdateParameters.prototype['password'] = undefined;
