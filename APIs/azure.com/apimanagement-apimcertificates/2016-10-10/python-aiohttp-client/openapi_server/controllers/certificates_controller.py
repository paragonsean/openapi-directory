...
async def certificates_create_or_update(request: web.Request, resource_group_name, service_name, certificate_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
...
async def certificates_delete(request: web.Request, resource_group_name, service_name, certificate_id, if_match, api_version, subscription_id) -> web.Response:
    """certificates_delete
...
async def certificates_get(request: web.Request, resource_group_name, service_name, certificate_id, api_version, subscription_id) -> web.Response:
    """certificates_get
...
async def certificates_list_by_service(request: web.Request, resource_group_name, service_name, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
