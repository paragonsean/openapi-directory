...
qint64 OAICertificateCollection::getCount() const {
    return m_count;
}
void OAICertificateCollection::setCount(const qint64 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAICertificateCollection::is_count_Set() const{
    return m_count_isSet;
}

bool OAICertificateCollection::is_count_Valid() const{
