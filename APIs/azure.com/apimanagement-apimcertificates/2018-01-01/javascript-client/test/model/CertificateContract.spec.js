...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.CertificateContract();
  });
  ...
  describe('CertificateContract', function() {
    it('should create an instance of CertificateContract', function() {
      // uncomment below and update the code to test CertificateContract
      //var instance = new ApiManagementClient.CertificateContract();
      //expect(instance).to.be.a(ApiManagementClient.CertificateContract);
    });
