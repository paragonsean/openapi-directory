...
export default class CertificatesApi {
    ...
    */
     ...
     * @callback module:api/CertificatesApi~certificateCreateOrUpdateCallback
     ...
     * @param {module:model/CertificateCreateOrUpdateParameters} parameters Create or Update parameters.
     * @param {Object} opts Optional parameters
     * @param {String} [ifMatch] ETag of the Entity. Not required when creating an entity, but required when updating an entity.
     * @param {module:api/CertificatesApi~certificateCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CertificatesApi~certificateGetEntityTagCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/CertificatesApi~certificateGetEntityTagCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/CertificatesApi~certificateListByServiceCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CertificatesApi~certificateListByServiceCallback} callback The callback function, accepting three arguments: error, data, response
