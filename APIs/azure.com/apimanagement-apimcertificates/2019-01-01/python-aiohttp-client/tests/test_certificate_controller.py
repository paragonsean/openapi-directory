...
async def test_certificate_create_or_update(client):
    ...
    """
    parameters = openapi_server.CertificateCreateOrUpdateRequest()
...
async def test_certificate_get_entity_tag(client):
...
async def test_certificate_list_by_service(client):
