...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.CertificateCollection();
  });
  ...
  describe('CertificateCollection', function() {
    it('should create an instance of CertificateCollection', function() {
      ...
      //var instance = new ApiManagementClient.CertificateCollection();
      //expect(instance).to.be.a(ApiManagementClient.CertificateCollection);
    });
