...
Q_SIGNALS:
    ...
    void certificateCreateOrUpdateSignal(OAICertificateContract summary);
    void certificateDeleteSignal();
    void certificateGetSignal(OAICertificateContract summary);
    void certificateGetEntityTagSignal();
    void certificateListByServiceSignal(OAICertificateCollection summary);


    void certificateCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAICertificateContract summary);
    void certificateDeleteSignalFull(OAIHttpRequestWorker *worker);
    void certificateGetSignalFull(OAIHttpRequestWorker *worker, OAICertificateContract summary);
    void certificateGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void certificateListByServiceSignalFull(OAIHttpRequestWorker *worker, OAICertificateCollection summary);

    Q_DECL_DEPRECATED_X("Use certificateCreateOrUpdateSignalError() instead")
    void certificateCreateOrUpdateSignalE(OAICertificateContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void certificateCreateOrUpdateSignalError(OAICertificateContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void certificateGetSignalE(OAICertificateContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void certificateGetSignalError(OAICertificateContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void certificateListByServiceSignalE(OAICertificateCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void certificateListByServiceSignalError(OAICertificateCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
