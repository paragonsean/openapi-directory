...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabricAdminClient.NetworkDefinitionParameter();
  });
  ...
  describe('NetworkDefinitionParameter', function() {
    it('should create an instance of NetworkDefinitionParameter', function() {
      // uncomment below and update the code to test NetworkDefinitionParameter
      //var instance = new FabricAdminClient.NetworkDefinitionParameter();
      //expect(instance).to.be.a(FabricAdminClient.NetworkDefinitionParameter);
    });
