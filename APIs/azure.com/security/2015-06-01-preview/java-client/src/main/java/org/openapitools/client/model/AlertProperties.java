...
public class AlertProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionTaken, alertDisplayName, alertName, associatedResource, canBeInvestigated, compromisedEntity, confidenceReasons, confidenceScore, description, detectedTimeUtc, entities, extendedProperties, instanceId, isIncident, remediationSteps, reportedSeverity, reportedTimeUtc, state, subscriptionId, systemSource, vendorName, workspaceArmId);
  }
