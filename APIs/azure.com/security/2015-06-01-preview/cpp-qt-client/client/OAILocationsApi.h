...
Q_SIGNALS:
    ...
    void locationsGetSignal(OAIAscLocation summary);
    void locationsListSignal(OAIAscLocationList summary);


    void locationsGetSignalFull(OAIHttpRequestWorker *worker, OAIAscLocation summary);
    void locationsListSignalFull(OAIHttpRequestWorker *worker, OAIAscLocationList summary);

    Q_DECL_DEPRECATED_X("Use locationsGetSignalError() instead")
    void locationsGetSignalE(OAIAscLocation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void locationsGetSignalError(OAIAscLocation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use locationsListSignalError() instead")
    void locationsListSignalE(OAIAscLocationList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void locationsListSignalError(OAIAscLocationList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
