...
class AlertProperties(Model):
    ...
    def reported_severity(self, reported_severity):
        ...
        """
        allowed_values = ["Silent", "Information", "Low", "High"]  # noqa: E501
