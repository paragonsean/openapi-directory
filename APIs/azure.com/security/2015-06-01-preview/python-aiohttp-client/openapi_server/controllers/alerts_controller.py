...
async def alerts_update_resource_group_level_alert_state(request: web.Request, api_version, subscription_id, asc_location, alert_name, alert_update_action_type, resource_group_name) -> web.Response:
    ...
    :param alert_name: Name of the alert object
    :type alert_name: str
    :param alert_update_action_type: Type of the action to do on the alert
...
async def alerts_update_subscription_level_alert_state(request: web.Request, api_version, subscription_id, asc_location, alert_name, alert_update_action_type) -> web.Response:
