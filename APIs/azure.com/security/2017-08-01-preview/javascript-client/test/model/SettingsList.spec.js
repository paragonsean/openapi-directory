...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecurityCenter.SettingsList();
  });
  ...
  describe('SettingsList', function() {
    it('should create an instance of SettingsList', function() {
      // uncomment below and update the code to test SettingsList
      //var instance = new SecurityCenter.SettingsList();
      //expect(instance).to.be.a(SecurityCenter.SettingsList);
    });
