...
async def recommendations_list_history_for_web_app(request: web.Request, resource_group_name, site_name, subscription_id, api_version, filter=None) -> web.Response:
