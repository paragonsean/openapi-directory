...
public class RecommendationsApi {
     ...
     * @param $filter Filter is specified by using OData syntax. Example: $filter&#x3D;channels eq &#39;Api&#39; or channel eq &#39;Notification&#39; and startTime eq &#39;2014-01-01T00:00:00Z&#39; and endTime eq &#39;2014-12-31T23:59:59Z&#39; and timeGrain eq duration&#39;[PT1H|PT1M|P1D] (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call recommendationsListHistoryForWebAppCall(String resourceGroupName, String siteName, String subscriptionId, String apiVersion, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call recommendationsListHistoryForWebAppValidateBeforeCall(String resourceGroupName, String siteName, String subscriptionId, String apiVersion, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return recommendationsListHistoryForWebAppCall(resourceGroupName, siteName, subscriptionId, apiVersion, $filter, _callback);
     ...
     */
    public RecommendationCollection recommendationsListHistoryForWebApp(String resourceGroupName, String siteName, String subscriptionId, String apiVersion, String $filter) throws ApiException {
        ApiResponse<RecommendationCollection> localVarResp = recommendationsListHistoryForWebAppWithHttpInfo(resourceGroupName, siteName, subscriptionId, apiVersion, $filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RecommendationCollection> recommendationsListHistoryForWebAppWithHttpInfo(String resourceGroupName, String siteName, String subscriptionId, String apiVersion, String $filter) throws ApiException {
        okhttp3.Call localVarCall = recommendationsListHistoryForWebAppValidateBeforeCall(resourceGroupName, siteName, subscriptionId, apiVersion, $filter, null);
        Type localVarReturnType = new TypeToken<RecommendationCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call recommendationsListHistoryForWebAppAsync(String resourceGroupName, String siteName, String subscriptionId, String apiVersion, String $filter, final ApiCallback<RecommendationCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = recommendationsListHistoryForWebAppValidateBeforeCall(resourceGroupName, siteName, subscriptionId, apiVersion, $filter, _callback);
        Type localVarReturnType = new TypeToken<RecommendationCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
