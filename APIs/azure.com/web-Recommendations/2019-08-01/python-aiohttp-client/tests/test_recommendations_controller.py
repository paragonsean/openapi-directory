...
async def test_recommendations_disable_all_for_hosting_environment(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendations/disable'.format(resource_group_name='resource_group_name_example', hosting_environment_name='hosting_environment_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
...
async def test_recommendations_disable_recommendation_for_hosting_environment(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendations/{name}/disable'.format(resource_group_name='resource_group_name_example', name='name_example', hosting_environment_name='hosting_environment_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_recommendations_get_rule_details_by_hosting_environment(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendations/{name}'.format(resource_group_name='resource_group_name_example', hosting_environment_name='hosting_environment_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_recommendations_list_history_for_hosting_environment(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendationHistory'.format(resource_group_name='resource_group_name_example', hosting_environment_name='hosting_environment_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_recommendations_list_recommended_rules_for_hosting_environment(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendations'.format(resource_group_name='resource_group_name_example', hosting_environment_name='hosting_environment_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_recommendations_reset_all_filters_for_hosting_environment(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/{hosting_environment_name}/recommendations/reset'.format(resource_group_name='resource_group_name_example', hosting_environment_name='hosting_environment_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
