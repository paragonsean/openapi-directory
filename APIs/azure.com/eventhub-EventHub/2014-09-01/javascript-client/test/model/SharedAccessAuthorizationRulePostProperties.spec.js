...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventHubManagementClient.SharedAccessAuthorizationRulePostProperties();
  });
  ...
  describe('SharedAccessAuthorizationRulePostProperties', function() {
    it('should create an instance of SharedAccessAuthorizationRulePostProperties', function() {
      // uncomment below and update the code to test SharedAccessAuthorizationRulePostProperties
      //var instance = new EventHubManagementClient.SharedAccessAuthorizationRulePostProperties();
      //expect(instance).to.be.a(EventHubManagementClient.SharedAccessAuthorizationRulePostProperties);
    });
