...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventHubManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new EventHubManagementClient.Operation();
      //expect(instance).to.be.a(EventHubManagementClient.Operation);
    });
