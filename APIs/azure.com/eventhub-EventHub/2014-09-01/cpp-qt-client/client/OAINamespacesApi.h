...
#include "OAISharedAccessAuthorizationRulePostResource.h"
...
public:
    ...
    * @param[in]  parameters OAICheckNameAvailabilityParameter [required]
    */
    virtual void namespacesCheckNameSpaceAvailability(const QString &api_version, const QString &subscription_id, const OAICheckNameAvailabilityParameter &parameters);
...
Q_SIGNALS:
    ...
    void namespacesPostAuthorizationRuleSignal(OAISharedAccessAuthorizationRulePostResource summary);
    ...
    void namespacesPostAuthorizationRuleSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRulePostResource summary);
    ...
    void namespacesPostAuthorizationRuleSignalE(OAISharedAccessAuthorizationRulePostResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void namespacesPostAuthorizationRuleSignalError(OAISharedAccessAuthorizationRulePostResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
