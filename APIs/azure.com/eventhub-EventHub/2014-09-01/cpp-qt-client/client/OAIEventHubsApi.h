...
Q_SIGNALS:
    ...
    void eventHubsPostAuthorizationRuleSignal(OAISharedAccessAuthorizationRulePostResource summary);
    ...
    void eventHubsPostAuthorizationRuleSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRulePostResource summary);
    ...
    void eventHubsPostAuthorizationRuleSignalE(OAISharedAccessAuthorizationRulePostResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void eventHubsPostAuthorizationRuleSignalError(OAISharedAccessAuthorizationRulePostResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
