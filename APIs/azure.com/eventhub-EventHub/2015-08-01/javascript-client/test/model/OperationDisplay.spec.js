...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventHubManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new EventHubManagementClient.OperationDisplay();
      //expect(instance).to.be.a(EventHubManagementClient.OperationDisplay);
    });
