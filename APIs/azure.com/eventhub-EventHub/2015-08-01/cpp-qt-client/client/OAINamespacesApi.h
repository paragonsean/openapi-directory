...
public:
    ...
    * @param[in]  parameters OAICheckNameAvailabilityParameter [required]
    */
    virtual void namespacesCheckNameAvailability(const QString &api_version, const QString &subscription_id, const OAICheckNameAvailabilityParameter &parameters);
    ...
    */
    virtual void namespacesRegenerateKeys(const QString &resource_group_name, const QString &namespace_name, const QString &authorization_rule_name, const QString &api_version, const QString &subscription_id, const OAIRegenerateKeysParameters &parameters);
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAINamespaceUpdateParameter [required]
    */
    virtual void namespacesUpdate(const QString &resource_group_name, const QString &namespace_name, const QString &api_version, const QString &subscription_id, const OAINamespaceUpdateParameter &parameters);
