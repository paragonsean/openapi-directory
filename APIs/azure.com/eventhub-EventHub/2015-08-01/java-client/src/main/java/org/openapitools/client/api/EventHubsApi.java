...
public class EventHubsApi {
    ...
    /**
     * Build call for eventHubsListKeys
     * @param resourceGroupName Name of the resource group within the azure subscription. (required)
     * @param namespaceName The Namespace name (required)
     * @param eventHubName The Event Hub name (required)
     * @param authorizationRuleName The authorization rule name. (required)
     ...
     * 
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706098.aspx"> Documentation</a>
     */
    public okhttp3.Call eventHubsListKeysCall(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/eventhubs/{eventHubName}/authorizationRules/{authorizationRuleName}/ListKeys"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "namespaceName" + "}", localVarApiClient.escapeString(namespaceName.toString()))
            .replace("{" + "eventHubName" + "}", localVarApiClient.escapeString(eventHubName.toString()))
            .replace("{" + "authorizationRuleName" + "}", localVarApiClient.escapeString(authorizationRuleName.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call eventHubsListKeysValidateBeforeCall(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling eventHubsListKeys(Async)");
        }

        // verify the required parameter 'namespaceName' is set
        if (namespaceName == null) {
            throw new ApiException("Missing the required parameter 'namespaceName' when calling eventHubsListKeys(Async)");
        }

        // verify the required parameter 'eventHubName' is set
        if (eventHubName == null) {
            throw new ApiException("Missing the required parameter 'eventHubName' when calling eventHubsListKeys(Async)");
        }

        // verify the required parameter 'authorizationRuleName' is set
        if (authorizationRuleName == null) {
            throw new ApiException("Missing the required parameter 'authorizationRuleName' when calling eventHubsListKeys(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling eventHubsListKeys(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling eventHubsListKeys(Async)");
        }

        return eventHubsListKeysCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, _callback);
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706098.aspx"> Documentation</a>
     */
    public ResourceListKeys eventHubsListKeys(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ResourceListKeys> localVarResp = eventHubsListKeysWithHttpInfo(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706098.aspx"> Documentation</a>
     */
    public ApiResponse<ResourceListKeys> eventHubsListKeysWithHttpInfo(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = eventHubsListKeysValidateBeforeCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, null);
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706098.aspx"> Documentation</a>
     */
    public okhttp3.Call eventHubsListKeysAsync(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, final ApiCallback<ResourceListKeys> _callback) throws ApiException {

        okhttp3.Call localVarCall = eventHubsListKeysValidateBeforeCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<ResourceListKeys>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706097.aspx"> Documentation</a>
     */
    public SharedAccessAuthorizationRuleResource eventHubsPostAuthorizationRule(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<SharedAccessAuthorizationRuleResource> localVarResp = eventHubsPostAuthorizationRuleWithHttpInfo(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706097.aspx"> Documentation</a>
     */
    public ApiResponse<SharedAccessAuthorizationRuleResource> eventHubsPostAuthorizationRuleWithHttpInfo(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId) throws ApiException {
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706097.aspx"> Documentation</a>
     */
    public okhttp3.Call eventHubsPostAuthorizationRuleAsync(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, final ApiCallback<SharedAccessAuthorizationRuleResource> _callback) throws ApiException {
    ...
    /**
     * Build call for eventHubsRegenerateKeys
     * @param resourceGroupName Name of the resource group within the azure subscription. (required)
     * @param namespaceName The Namespace name (required)
     * @param eventHubName The Event Hub name (required)
     * @param authorizationRuleName The authorization rule name. (required)
     ...
     * 
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706099.aspx"> Documentation</a>
     */
    public okhttp3.Call eventHubsRegenerateKeysCall(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, RegenerateKeysParameters parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/eventhubs/{eventHubName}/authorizationRules/{authorizationRuleName}/regenerateKeys"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "namespaceName" + "}", localVarApiClient.escapeString(namespaceName.toString()))
            .replace("{" + "eventHubName" + "}", localVarApiClient.escapeString(eventHubName.toString()))
            .replace("{" + "authorizationRuleName" + "}", localVarApiClient.escapeString(authorizationRuleName.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call eventHubsRegenerateKeysValidateBeforeCall(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, RegenerateKeysParameters parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'namespaceName' is set
        if (namespaceName == null) {
            throw new ApiException("Missing the required parameter 'namespaceName' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'eventHubName' is set
        if (eventHubName == null) {
            throw new ApiException("Missing the required parameter 'eventHubName' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'authorizationRuleName' is set
        if (authorizationRuleName == null) {
            throw new ApiException("Missing the required parameter 'authorizationRuleName' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling eventHubsRegenerateKeys(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling eventHubsRegenerateKeys(Async)");
        }

        return eventHubsRegenerateKeysCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, parameters, _callback);
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706099.aspx"> Documentation</a>
     */
    public ResourceListKeys eventHubsRegenerateKeys(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, RegenerateKeysParameters parameters) throws ApiException {
        ApiResponse<ResourceListKeys> localVarResp = eventHubsRegenerateKeysWithHttpInfo(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706099.aspx"> Documentation</a>
     */
    public ApiResponse<ResourceListKeys> eventHubsRegenerateKeysWithHttpInfo(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, RegenerateKeysParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = eventHubsRegenerateKeysValidateBeforeCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<ResourceListKeys>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://msdn.microsoft.com/en-us/library/azure/mt706099.aspx"> Documentation</a>
     */
    public okhttp3.Call eventHubsRegenerateKeysAsync(String resourceGroupName, String namespaceName, String eventHubName, String authorizationRuleName, String apiVersion, String subscriptionId, RegenerateKeysParameters parameters, final ApiCallback<ResourceListKeys> _callback) throws ApiException {

        okhttp3.Call localVarCall = eventHubsRegenerateKeysValidateBeforeCall(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<ResourceListKeys>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
