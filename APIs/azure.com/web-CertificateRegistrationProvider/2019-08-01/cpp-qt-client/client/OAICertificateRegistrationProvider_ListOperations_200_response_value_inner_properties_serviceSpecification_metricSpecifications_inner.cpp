...
QList<QString> OAICertificateRegistrationProvider_ListOperations_200_response_value_inner_properties_serviceSpecification_metricSpecifications_inner::getSupportedTimeGrainTypes() const {
    return m_supported_time_grain_types;
}
void OAICertificateRegistrationProvider_ListOperations_200_response_value_inner_properties_serviceSpecification_metricSpecifications_inner::setSupportedTimeGrainTypes(const QList<QString> &supported_time_grain_types) {
    m_supported_time_grain_types = supported_time_grain_types;
    m_supported_time_grain_types_isSet = true;
}

bool OAICertificateRegistrationProvider_ListOperations_200_response_value_inner_properties_serviceSpecification_metricSpecifications_inner::is_supported_time_grain_types_Set() const{
    return m_supported_time_grain_types_isSet;
}

bool OAICertificateRegistrationProvider_ListOperations_200_response_value_inner_properties_serviceSpecification_metricSpecifications_inner::is_supported_time_grain_types_Valid() const{
