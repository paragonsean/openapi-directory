...
QString OAIDatabaseUpdate::getId() const {
    return m_id;
}
void OAIDatabaseUpdate::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseUpdate::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseUpdate::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseUpdate::getName() const {
    return m_name;
}
void OAIDatabaseUpdate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDatabaseUpdate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDatabaseUpdate::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDatabaseUpdate::getType() const {
    return m_type;
}
void OAIDatabaseUpdate::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseUpdate::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseUpdate::is_type_Valid() const{
