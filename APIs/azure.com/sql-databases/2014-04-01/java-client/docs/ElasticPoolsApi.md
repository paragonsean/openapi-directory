...
<a id="databasesGetByElasticPool"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Database result = apiInstance.databasesGetByElasticPool(apiVersion, subscriptionId, resourceGroupName, serverName, elasticPoolName, databaseName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElasticPoolsApi#databasesGetByElasticPool");
