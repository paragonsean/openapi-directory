...
public class DatabasePropertiesServiceTierAdvisorsInnerProperties {
  ...
  private List<DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner> serviceLevelObjectiveUsageMetrics = new ArrayList<>();
  ...
  public DatabasePropertiesServiceTierAdvisorsInnerProperties() {
  }
  ...
  public DatabasePropertiesServiceTierAdvisorsInnerProperties(
     ...
     List<DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner> serviceLevelObjectiveUsageMetrics, 
   ...
   */
  @javax.annotation.Nullable
  public List<DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner> getServiceLevelObjectiveUsageMetrics() {
    return serviceLevelObjectiveUsageMetrics;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabasePropertiesServiceTierAdvisorsInnerProperties databasePropertiesServiceTierAdvisorsInnerProperties = (DatabasePropertiesServiceTierAdvisorsInnerProperties) o;
    return Objects.equals(this.activeTimeRatio, databasePropertiesServiceTierAdvisorsInnerProperties.activeTimeRatio) &&
        Objects.equals(this.avgDtu, databasePropertiesServiceTierAdvisorsInnerProperties.avgDtu) &&
        Objects.equals(this.confidence, databasePropertiesServiceTierAdvisorsInnerProperties.confidence) &&
        Objects.equals(this.currentServiceLevelObjective, databasePropertiesServiceTierAdvisorsInnerProperties.currentServiceLevelObjective) &&
        Objects.equals(this.currentServiceLevelObjectiveId, databasePropertiesServiceTierAdvisorsInnerProperties.currentServiceLevelObjectiveId) &&
        Objects.equals(this.databaseSizeBasedRecommendationServiceLevelObjective, databasePropertiesServiceTierAdvisorsInnerProperties.databaseSizeBasedRecommendationServiceLevelObjective) &&
        Objects.equals(this.databaseSizeBasedRecommendationServiceLevelObjectiveId, databasePropertiesServiceTierAdvisorsInnerProperties.databaseSizeBasedRecommendationServiceLevelObjectiveId) &&
        Objects.equals(this.disasterPlanBasedRecommendationServiceLevelObjective, databasePropertiesServiceTierAdvisorsInnerProperties.disasterPlanBasedRecommendationServiceLevelObjective) &&
        Objects.equals(this.disasterPlanBasedRecommendationServiceLevelObjectiveId, databasePropertiesServiceTierAdvisorsInnerProperties.disasterPlanBasedRecommendationServiceLevelObjectiveId) &&
        Objects.equals(this.maxDtu, databasePropertiesServiceTierAdvisorsInnerProperties.maxDtu) &&
        Objects.equals(this.maxSizeInGB, databasePropertiesServiceTierAdvisorsInnerProperties.maxSizeInGB) &&
        Objects.equals(this.minDtu, databasePropertiesServiceTierAdvisorsInnerProperties.minDtu) &&
        Objects.equals(this.observationPeriodEnd, databasePropertiesServiceTierAdvisorsInnerProperties.observationPeriodEnd) &&
        Objects.equals(this.observationPeriodStart, databasePropertiesServiceTierAdvisorsInnerProperties.observationPeriodStart) &&
        Objects.equals(this.overallRecommendationServiceLevelObjective, databasePropertiesServiceTierAdvisorsInnerProperties.overallRecommendationServiceLevelObjective) &&
        Objects.equals(this.overallRecommendationServiceLevelObjectiveId, databasePropertiesServiceTierAdvisorsInnerProperties.overallRecommendationServiceLevelObjectiveId) &&
        Objects.equals(this.serviceLevelObjectiveUsageMetrics, databasePropertiesServiceTierAdvisorsInnerProperties.serviceLevelObjectiveUsageMetrics) &&
        Objects.equals(this.usageBasedRecommendationServiceLevelObjective, databasePropertiesServiceTierAdvisorsInnerProperties.usageBasedRecommendationServiceLevelObjective) &&
        Objects.equals(this.usageBasedRecommendationServiceLevelObjectiveId, databasePropertiesServiceTierAdvisorsInnerProperties.usageBasedRecommendationServiceLevelObjectiveId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabasePropertiesServiceTierAdvisorsInnerProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabasePropertiesServiceTierAdvisorsInnerProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabasePropertiesServiceTierAdvisorsInnerProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasePropertiesServiceTierAdvisorsInnerProperties is not found in the empty JSON string", DatabasePropertiesServiceTierAdvisorsInnerProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabasePropertiesServiceTierAdvisorsInnerProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabasePropertiesServiceTierAdvisorsInnerProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("serviceLevelObjectiveUsageMetrics") != null && !jsonObj.get("serviceLevelObjectiveUsageMetrics").isJsonNull()) {
        ...
        if (jsonArrayserviceLevelObjectiveUsageMetrics != null) {
          ...
          for (int i = 0; i < jsonArrayserviceLevelObjectiveUsageMetrics.size(); i++) {
            DatabasePropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner.validateJsonElement(jsonArrayserviceLevelObjectiveUsageMetrics.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasePropertiesServiceTierAdvisorsInnerProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasePropertiesServiceTierAdvisorsInnerProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasePropertiesServiceTierAdvisorsInnerProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasePropertiesServiceTierAdvisorsInnerProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasePropertiesServiceTierAdvisorsInnerProperties>() {
           @Override
           public void write(JsonWriter out, DatabasePropertiesServiceTierAdvisorsInnerProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabasePropertiesServiceTierAdvisorsInnerProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabasePropertiesServiceTierAdvisorsInnerProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabasePropertiesServiceTierAdvisorsInnerProperties
   * @throws IOException if the JSON string is invalid with respect to DatabasePropertiesServiceTierAdvisorsInnerProperties
   */
  public static DatabasePropertiesServiceTierAdvisorsInnerProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasePropertiesServiceTierAdvisorsInnerProperties.class);
  }

  /**
   * Convert an instance of DatabasePropertiesServiceTierAdvisorsInnerProperties to an JSON string
   *
   * @return JSON string
   */
