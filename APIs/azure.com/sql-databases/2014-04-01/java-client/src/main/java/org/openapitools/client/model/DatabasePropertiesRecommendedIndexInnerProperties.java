...
public class DatabasePropertiesRecommendedIndexInnerProperties {
  /**
  ...
  private List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> estimatedImpact = new ArrayList<>();
  ...
  private List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> reportedImpact = new ArrayList<>();
  ...
  public DatabasePropertiesRecommendedIndexInnerProperties() {
  }
  ...
  public DatabasePropertiesRecommendedIndexInnerProperties(
     ...
     List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> estimatedImpact, 
     List<String> includedColumns, 
     String indexScript, 
     IndexTypeEnum indexType, 
     OffsetDateTime lastModified, 
     List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> reportedImpact, 
     String schema, 
     StateEnum state, 
     String table
  ) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> getEstimatedImpact() {
    return estimatedImpact;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner> getReportedImpact() {
    return reportedImpact;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabasePropertiesRecommendedIndexInnerProperties databasePropertiesRecommendedIndexInnerProperties = (DatabasePropertiesRecommendedIndexInnerProperties) o;
    return Objects.equals(this.action, databasePropertiesRecommendedIndexInnerProperties.action) &&
        Objects.equals(this.columns, databasePropertiesRecommendedIndexInnerProperties.columns) &&
        Objects.equals(this.created, databasePropertiesRecommendedIndexInnerProperties.created) &&
        Objects.equals(this.estimatedImpact, databasePropertiesRecommendedIndexInnerProperties.estimatedImpact) &&
        Objects.equals(this.includedColumns, databasePropertiesRecommendedIndexInnerProperties.includedColumns) &&
        Objects.equals(this.indexScript, databasePropertiesRecommendedIndexInnerProperties.indexScript) &&
        Objects.equals(this.indexType, databasePropertiesRecommendedIndexInnerProperties.indexType) &&
        Objects.equals(this.lastModified, databasePropertiesRecommendedIndexInnerProperties.lastModified) &&
        Objects.equals(this.reportedImpact, databasePropertiesRecommendedIndexInnerProperties.reportedImpact) &&
        Objects.equals(this.schema, databasePropertiesRecommendedIndexInnerProperties.schema) &&
        Objects.equals(this.state, databasePropertiesRecommendedIndexInnerProperties.state) &&
        Objects.equals(this.table, databasePropertiesRecommendedIndexInnerProperties.table);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabasePropertiesRecommendedIndexInnerProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabasePropertiesRecommendedIndexInnerProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabasePropertiesRecommendedIndexInnerProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasePropertiesRecommendedIndexInnerProperties is not found in the empty JSON string", DatabasePropertiesRecommendedIndexInnerProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabasePropertiesRecommendedIndexInnerProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabasePropertiesRecommendedIndexInnerProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("estimatedImpact") != null && !jsonObj.get("estimatedImpact").isJsonNull()) {
        ...
        if (jsonArrayestimatedImpact != null) {
          ...
          for (int i = 0; i < jsonArrayestimatedImpact.size(); i++) {
            DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner.validateJsonElement(jsonArrayestimatedImpact.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("reportedImpact") != null && !jsonObj.get("reportedImpact").isJsonNull()) {
        ...
        if (jsonArrayreportedImpact != null) {
          ...
          for (int i = 0; i < jsonArrayreportedImpact.size(); i++) {
            DatabasePropertiesRecommendedIndexInnerPropertiesEstimatedImpactInner.validateJsonElement(jsonArrayreportedImpact.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasePropertiesRecommendedIndexInnerProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasePropertiesRecommendedIndexInnerProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasePropertiesRecommendedIndexInnerProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasePropertiesRecommendedIndexInnerProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasePropertiesRecommendedIndexInnerProperties>() {
           @Override
           public void write(JsonWriter out, DatabasePropertiesRecommendedIndexInnerProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabasePropertiesRecommendedIndexInnerProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabasePropertiesRecommendedIndexInnerProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabasePropertiesRecommendedIndexInnerProperties
   * @throws IOException if the JSON string is invalid with respect to DatabasePropertiesRecommendedIndexInnerProperties
   */
  public static DatabasePropertiesRecommendedIndexInnerProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasePropertiesRecommendedIndexInnerProperties.class);
  }

  /**
   * Convert an instance of DatabasePropertiesRecommendedIndexInnerProperties to an JSON string
   *
   * @return JSON string
   */
