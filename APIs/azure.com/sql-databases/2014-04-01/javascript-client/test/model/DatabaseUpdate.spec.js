...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.DatabaseUpdate();
  });
  ...
  describe('DatabaseUpdate', function() {
    it('should create an instance of DatabaseUpdate', function() {
      // uncomment below and update the code to test DatabaseUpdate
      //var instance = new AzureSqlDatabase.DatabaseUpdate();
      //expect(instance).to.be.a(AzureSqlDatabase.DatabaseUpdate);
    });
