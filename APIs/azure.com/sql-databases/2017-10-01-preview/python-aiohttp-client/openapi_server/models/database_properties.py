...
class DatabaseProperties(Model):
    ...
    def __init__(self, auto_pause_delay: int=None, catalog_collation: str=None, collation: str=None, create_mode: str=None, creation_date: datetime=None, current_service_objective_name: str=None, current_sku: Sku=None, database_id: str=None, default_secondary_location: str=None, earliest_restore_date: datetime=None, elastic_pool_id: str=None, failover_group_id: str=None, license_type: str=None, long_term_retention_backup_resource_id: str=None, max_log_size_bytes: int=None, max_size_bytes: int=None, min_capacity: float=None, paused_date: datetime=None, read_replica_count: int=None, read_scale: str=None, recoverable_database_id: str=None, recovery_services_recovery_point_id: str=None, requested_service_objective_name: str=None, restorable_dropped_database_id: str=None, restore_point_in_time: datetime=None, resumed_date: datetime=None, sample_name: str=None, source_database_deletion_date: datetime=None, source_database_id: str=None, status: str=None, zone_redundant: bool=None):
