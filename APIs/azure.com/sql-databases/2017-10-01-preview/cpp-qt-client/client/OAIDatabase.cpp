...
QString OAIDatabase::getManagedBy() const {
    return m_managed_by;
}
void OAIDatabase::setManagedBy(const QString &managed_by) {
    m_managed_by = managed_by;
    m_managed_by_isSet = true;
}

bool OAIDatabase::is_managed_by_Set() const{
    return m_managed_by_isSet;
}

bool OAIDatabase::is_managed_by_Valid() const{
...
OAISku OAIDatabase::getSku() const {
    return m_sku;
}
void OAIDatabase::setSku(const OAISku &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIDatabase::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIDatabase::is_sku_Valid() const{
