...
async def databases_list_inaccessible_by_server(request: web.Request, resource_group_name, server_name, subscription_id, api_version) -> web.Response:
    """databases_list_inaccessible_by_server
