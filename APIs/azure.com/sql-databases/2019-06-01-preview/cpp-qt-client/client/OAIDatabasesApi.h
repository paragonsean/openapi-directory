...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void databasesListInaccessibleByServer(const QString &resource_group_name, const QString &server_name, const QString &subscription_id, const QString &api_version);
...
private:
    ...
    void databasesListInaccessibleByServerCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void databasesListInaccessibleByServerSignal(OAIDatabaseListResult summary);
    ...
    void databasesListInaccessibleByServerSignalFull(OAIHttpRequestWorker *worker, OAIDatabaseListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use databasesListInaccessibleByServerSignalError() instead")
    void databasesListInaccessibleByServerSignalE(OAIDatabaseListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void databasesListInaccessibleByServerSignalError(OAIDatabaseListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use databasesListInaccessibleByServerSignalErrorFull() instead")
    void databasesListInaccessibleByServerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void databasesListInaccessibleByServerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
