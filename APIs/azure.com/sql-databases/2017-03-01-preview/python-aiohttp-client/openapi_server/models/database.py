...
class Database(Model):
    ...
    def __init__(self, kind: str=None, properties: DatabaseProperties=None, sku: object=None, location: str=None, tags: Dict[str, str]=None, id: str=None, name: str=None, type: str=None):
