...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.DatabaseUpdateSku();
  });
  ...
  describe('DatabaseUpdateSku', function() {
    it('should create an instance of DatabaseUpdateSku', function() {
      // uncomment below and update the code to test DatabaseUpdateSku
      //var instance = new SqlManagementClient.DatabaseUpdateSku();
      //expect(instance).to.be.a(SqlManagementClient.DatabaseUpdateSku);
    });
