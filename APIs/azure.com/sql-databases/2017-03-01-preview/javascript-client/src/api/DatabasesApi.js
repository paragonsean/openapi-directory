...
export default class DatabasesApi {
    ...
    */
     ...
     * @callback module:api/DatabasesApi~databasesExportCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ImportExportOperationResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription ID that identifies an Azure subscription.
     * @param {String} apiVersion The API version to use for the request.
     * @param {module:model/ImportExportDatabaseDefinition} parameters The database export request parameters.
     * @param {module:api/DatabasesApi~databasesExportCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ImportExportOperationResult}
     */
    databasesExport(resourceGroupName, serverName, databaseName, subscriptionId, apiVersion, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ImportExportOperationResult;
      return this.apiClient.callApi(
