...
/*
 * OAIDatabaseUpdate_sku.h
 *
 * An ARM Resource SKU.
 */

#ifndef OAIDatabaseUpdate_sku_H
#define OAIDatabaseUpdate_sku_H
...
class OAIDatabaseUpdate_sku : public OAIObject {
public:
    OAIDatabaseUpdate_sku();
    OAIDatabaseUpdate_sku(QString json);
    ~OAIDatabaseUpdate_sku() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseUpdate_sku)

#endif // OAIDatabaseUpdate_sku_H
