...
/**
 * The ServiceResourceUpdateProperties model module.
 * @module model/ServiceResourceUpdateProperties
 * @version 2017-07-01-preview
 */
class ServiceResourceUpdateProperties {
    /**
     * Constructs a new <code>ServiceResourceUpdateProperties</code>.
     * The service resource properties for patch operations.
     * @alias module:model/ServiceResourceUpdateProperties
    ...
    /**
     * Constructs a <code>ServiceResourceUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceResourceUpdateProperties} obj Optional instance to populate.
     * @return {module:model/ServiceResourceUpdateProperties} The populated <code>ServiceResourceUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceResourceUpdateProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceResourceUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceResourceUpdateProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServiceResourceUpdateProperties.RequiredProperties) {
...
ServiceResourceUpdateProperties.RequiredProperties = ["serviceKind"];

/**
 * @member {module:model/ServiceKind} serviceKind
 */
ServiceResourceUpdateProperties.prototype['serviceKind'] = undefined;
...
export default ServiceResourceUpdateProperties;
