...
async def test_services_create(client):
    ...
    """
    parameters = {"properties":{"serviceKind":"Invalid","servicePackageActivationMode":"SharedProcess","partitionDescription":{"partitionScheme":"Invalid"},"provisioningState":"provisioningState","serviceTypeName":"serviceTypeName"}}
