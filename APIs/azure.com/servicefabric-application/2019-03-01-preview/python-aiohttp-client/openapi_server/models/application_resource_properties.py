...
class ApplicationResourceProperties(Model):
    ...
    def __init__(self, provisioning_state: str=None, type_name: str=None, maximum_nodes: int=0, metrics: List[ApplicationMetricDescription]=None, minimum_nodes: int=None, parameters: Dict[str, str]=None, remove_application_capacity: bool=None, type_version: str=None, upgrade_policy: ApplicationUpgradePolicy=None):
