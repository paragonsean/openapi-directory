...
async def application_type_versions_create_or_update(request: web.Request, subscription_id, resource_group_name, cluster_name, application_type_name, version, api_version, parameters) -> web.Response:
