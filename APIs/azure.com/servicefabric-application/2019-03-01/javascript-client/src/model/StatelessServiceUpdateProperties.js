...
/**
 * The StatelessServiceUpdateProperties model module.
 * @module model/StatelessServiceUpdateProperties
 * @version 2019-03-01
 */
class StatelessServiceUpdateProperties {
    /**
     * Constructs a new <code>StatelessServiceUpdateProperties</code>.
     * The properties of a stateless service resource for patch operations.
     * @alias module:model/StatelessServiceUpdateProperties
    ...
    constructor(serviceKind) { 
        ...
        StatelessServiceUpdateProperties.initialize(this, serviceKind);
    }
    ...
    /**
     * Constructs a <code>StatelessServiceUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessServiceUpdateProperties} obj Optional instance to populate.
     * @return {module:model/StatelessServiceUpdateProperties} The populated <code>StatelessServiceUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessServiceUpdateProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessServiceUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessServiceUpdateProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessServiceUpdateProperties.RequiredProperties) {
...
StatelessServiceUpdateProperties.RequiredProperties = ["serviceKind"];

/**
 * The instance count.
 * @member {Number} instanceCount
 */
StatelessServiceUpdateProperties.prototype['instanceCount'] = undefined;

/**
 * @member {module:model/ServiceKind} serviceKind
 */
StatelessServiceUpdateProperties.prototype['serviceKind'] = undefined;

/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServiceCorrelationDescription>} correlationScheme
 */
StatelessServiceUpdateProperties.prototype['correlationScheme'] = undefined;

/**
 * @member {module:model/MoveCost} defaultMoveCost
 */
StatelessServiceUpdateProperties.prototype['defaultMoveCost'] = undefined;

/**
 * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: \"NodeColor == blue)\".
 * @member {String} placementConstraints
 */
StatelessServiceUpdateProperties.prototype['placementConstraints'] = undefined;

/**
 * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
 * @member {Array.<module:model/ServiceLoadMetricDescription>} serviceLoadMetrics
 */
StatelessServiceUpdateProperties.prototype['serviceLoadMetrics'] = undefined;

/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServicePlacementPolicyDescription>} servicePlacementPolicies
 */
StatelessServiceUpdateProperties.prototype['servicePlacementPolicies'] = undefined;
...
export default StatelessServiceUpdateProperties;
