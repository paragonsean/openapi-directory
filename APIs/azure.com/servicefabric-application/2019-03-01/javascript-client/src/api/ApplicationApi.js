...
export default class ApplicationApi {
    ...
    */
     ...
     * @callback module:api/ApplicationApi~applicationsCreateOrUpdateCallback
     ...
     * @param {module:api/ApplicationApi~applicationsCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApplicationResource}
     */
    applicationsCreateOrUpdate(subscriptionId, resourceGroupName, clusterName, applicationName, apiVersion, parameters, callback) {
      ...
      if (clusterName === undefined || clusterName === null) {
        throw new Error("Missing the required parameter 'clusterName' when calling applicationsCreateOrUpdate");
      }
