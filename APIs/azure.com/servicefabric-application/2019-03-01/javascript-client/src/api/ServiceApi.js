...
export default class ServiceApi {
    ...
    */
     ...
     * @callback module:api/ServiceApi~servicesCreateOrUpdateCallback
     ...
     * @param {module:api/ServiceApi~servicesCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ServiceResource}
     */
    servicesCreateOrUpdate(subscriptionId, resourceGroupName, clusterName, applicationName, serviceName, apiVersion, parameters, callback) {
      ...
      if (clusterName === undefined || clusterName === null) {
        throw new Error("Missing the required parameter 'clusterName' when calling servicesCreateOrUpdate");
      }
      // verify the required parameter 'applicationName' is set
      if (applicationName === undefined || applicationName === null) {
        throw new Error("Missing the required parameter 'applicationName' when calling servicesCreateOrUpdate");
      }
