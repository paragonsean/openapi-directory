...
public:
    ...
    */
    virtual void applicationTypeVersionsCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &cluster_name, const QString &application_type_name, const QString &version, const QString &api_version, const OAIApplicationTypeVersionResource &parameters);
...
private:
    ...
    void applicationTypeVersionsCreateOrUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void applicationTypeVersionsCreateOrUpdateSignal(OAIApplicationTypeVersionResource summary);
    ...
    void applicationTypeVersionsCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIApplicationTypeVersionResource summary);
    ...
    Q_DECL_DEPRECATED_X("Use applicationTypeVersionsCreateOrUpdateSignalError() instead")
    void applicationTypeVersionsCreateOrUpdateSignalE(OAIApplicationTypeVersionResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void applicationTypeVersionsCreateOrUpdateSignalError(OAIApplicationTypeVersionResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use applicationTypeVersionsCreateOrUpdateSignalErrorFull() instead")
    void applicationTypeVersionsCreateOrUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void applicationTypeVersionsCreateOrUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
