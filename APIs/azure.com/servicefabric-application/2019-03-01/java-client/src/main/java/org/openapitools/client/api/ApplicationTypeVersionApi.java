...
public class ApplicationTypeVersionApi {
    ...
    /**
     * Build call for applicationTypeVersionsCreateOrUpdate
     ...
     */
    public okhttp3.Call applicationTypeVersionsCreateOrUpdateCall(String subscriptionId, String resourceGroupName, String clusterName, String applicationTypeName, String version, String apiVersion, ApplicationTypeVersionResource parameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call applicationTypeVersionsCreateOrUpdateValidateBeforeCall(String subscriptionId, String resourceGroupName, String clusterName, String applicationTypeName, String version, String apiVersion, ApplicationTypeVersionResource parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'clusterName' is set
        if (clusterName == null) {
            throw new ApiException("Missing the required parameter 'clusterName' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'applicationTypeName' is set
        if (applicationTypeName == null) {
            throw new ApiException("Missing the required parameter 'applicationTypeName' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'version' is set
        if (version == null) {
            throw new ApiException("Missing the required parameter 'version' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling applicationTypeVersionsCreateOrUpdate(Async)");
        }

        return applicationTypeVersionsCreateOrUpdateCall(subscriptionId, resourceGroupName, clusterName, applicationTypeName, version, apiVersion, parameters, _callback);
     ...
     */
    public ApplicationTypeVersionResource applicationTypeVersionsCreateOrUpdate(String subscriptionId, String resourceGroupName, String clusterName, String applicationTypeName, String version, String apiVersion, ApplicationTypeVersionResource parameters) throws ApiException {
        ApiResponse<ApplicationTypeVersionResource> localVarResp = applicationTypeVersionsCreateOrUpdateWithHttpInfo(subscriptionId, resourceGroupName, clusterName, applicationTypeName, version, apiVersion, parameters);
     ...
     */
    public ApiResponse<ApplicationTypeVersionResource> applicationTypeVersionsCreateOrUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String clusterName, String applicationTypeName, String version, String apiVersion, ApplicationTypeVersionResource parameters) throws ApiException {
        okhttp3.Call localVarCall = applicationTypeVersionsCreateOrUpdateValidateBeforeCall(subscriptionId, resourceGroupName, clusterName, applicationTypeName, version, apiVersion, parameters, null);
     ...
     */
    public okhttp3.Call applicationTypeVersionsCreateOrUpdateAsync(String subscriptionId, String resourceGroupName, String clusterName, String applicationTypeName, String version, String apiVersion, ApplicationTypeVersionResource parameters, final ApiCallback<ApplicationTypeVersionResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationTypeVersionsCreateOrUpdateValidateBeforeCall(subscriptionId, resourceGroupName, clusterName, applicationTypeName, version, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<ApplicationTypeVersionResource>(){}.getType();
