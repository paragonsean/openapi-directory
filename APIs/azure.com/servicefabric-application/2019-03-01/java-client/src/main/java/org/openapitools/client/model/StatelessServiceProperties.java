...
public class StatelessServiceProperties {
   ...
   */
  @JsonAdapter(ServicePackageActivationModeEnum.Adapter.class)
  public enum ServicePackageActivationModeEnum {
    ...
    ServicePackageActivationModeEnum(String value) {
      this.value = value;
    }
    ...
    public static ServicePackageActivationModeEnum fromValue(String value) {
      for (ServicePackageActivationModeEnum b : ServicePackageActivationModeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ServicePackageActivationModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ServicePackageActivationModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ServicePackageActivationModeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ServicePackageActivationModeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ServicePackageActivationModeEnum.fromValue(value);
    }
  }
  ...
  private ServicePackageActivationModeEnum servicePackageActivationMode;
  ...
  public StatelessServiceProperties instanceCount(Integer instanceCount) {
  ...
  public StatelessServiceProperties partitionDescription(PartitionSchemeDescription partitionDescription) {
  ...
  public StatelessServiceProperties serviceKind(ServiceKind serviceKind) {
  ...
  public StatelessServiceProperties servicePackageActivationMode(ServicePackageActivationModeEnum servicePackageActivationMode) {
   ...
   */
  @javax.annotation.Nullable
  public ServicePackageActivationModeEnum getServicePackageActivationMode() {
    return servicePackageActivationMode;
  }

  public void setServicePackageActivationMode(ServicePackageActivationModeEnum servicePackageActivationMode) {
    this.servicePackageActivationMode = servicePackageActivationMode;
  }


  public StatelessServiceProperties serviceTypeName(String serviceTypeName) {
  ...
  public StatelessServiceProperties correlationScheme(List<ServiceCorrelationDescription> correlationScheme) {
    this.correlationScheme = correlationScheme;
    return this;
  }

  public StatelessServiceProperties addCorrelationSchemeItem(ServiceCorrelationDescription correlationSchemeItem) {
  ...
  public StatelessServiceProperties defaultMoveCost(MoveCost defaultMoveCost) {
  ...
  public StatelessServiceProperties placementConstraints(String placementConstraints) {
  ...
  public StatelessServiceProperties serviceLoadMetrics(List<ServiceLoadMetricDescription> serviceLoadMetrics) {
    this.serviceLoadMetrics = serviceLoadMetrics;
    return this;
  }

  public StatelessServiceProperties addServiceLoadMetricsItem(ServiceLoadMetricDescription serviceLoadMetricsItem) {
  ...
  public StatelessServiceProperties servicePlacementPolicies(List<ServicePlacementPolicyDescription> servicePlacementPolicies) {
    this.servicePlacementPolicies = servicePlacementPolicies;
    return this;
  }

  public StatelessServiceProperties addServicePlacementPoliciesItem(ServicePlacementPolicyDescription servicePlacementPoliciesItem) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessServiceProperties statelessServiceProperties = (StatelessServiceProperties) o;
    return Objects.equals(this.instanceCount, statelessServiceProperties.instanceCount) &&
        Objects.equals(this.partitionDescription, statelessServiceProperties.partitionDescription) &&
        Objects.equals(this.provisioningState, statelessServiceProperties.provisioningState) &&
        Objects.equals(this.serviceKind, statelessServiceProperties.serviceKind) &&
        Objects.equals(this.servicePackageActivationMode, statelessServiceProperties.servicePackageActivationMode) &&
        Objects.equals(this.serviceTypeName, statelessServiceProperties.serviceTypeName) &&
        Objects.equals(this.correlationScheme, statelessServiceProperties.correlationScheme) &&
        Objects.equals(this.defaultMoveCost, statelessServiceProperties.defaultMoveCost) &&
        Objects.equals(this.placementConstraints, statelessServiceProperties.placementConstraints) &&
        Objects.equals(this.serviceLoadMetrics, statelessServiceProperties.serviceLoadMetrics) &&
        Objects.equals(this.servicePlacementPolicies, statelessServiceProperties.servicePlacementPolicies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instanceCount, partitionDescription, provisioningState, serviceKind, servicePackageActivationMode, serviceTypeName, correlationScheme, defaultMoveCost, placementConstraints, serviceLoadMetrics, servicePlacementPolicies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessServiceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessServiceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessServiceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessServiceProperties is not found in the empty JSON string", StatelessServiceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessServiceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessServiceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessServiceProperties.openapiRequiredFields) {
      ...
      if ((jsonObj.get("servicePackageActivationMode") != null && !jsonObj.get("servicePackageActivationMode").isJsonNull()) && !jsonObj.get("servicePackageActivationMode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `servicePackageActivationMode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("servicePackageActivationMode").toString()));
      }
      ...
      if (jsonObj.get("servicePackageActivationMode") != null && !jsonObj.get("servicePackageActivationMode").isJsonNull()) {
        ServicePackageActivationModeEnum.validateJsonElement(jsonObj.get("servicePackageActivationMode"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessServiceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessServiceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessServiceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessServiceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessServiceProperties>() {
           @Override
           public void write(JsonWriter out, StatelessServiceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessServiceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessServiceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessServiceProperties
   * @throws IOException if the JSON string is invalid with respect to StatelessServiceProperties
   */
  public static StatelessServiceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessServiceProperties.class);
  }

  /**
   * Convert an instance of StatelessServiceProperties to an JSON string
   *
   * @return JSON string
   */
