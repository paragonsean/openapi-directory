...
public class ApplicationResourceProperties {
  ...
  private List<ApplicationUserAssignedIdentity> managedIdentities = new ArrayList<>();
  ...
  public ApplicationResourceProperties typeName(String typeName) {
  ...
  public ApplicationResourceProperties managedIdentities(List<ApplicationUserAssignedIdentity> managedIdentities) {
    this.managedIdentities = managedIdentities;
    return this;
  }

  public ApplicationResourceProperties addManagedIdentitiesItem(ApplicationUserAssignedIdentity managedIdentitiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationUserAssignedIdentity> getManagedIdentities() {
    return managedIdentities;
  }

  public void setManagedIdentities(List<ApplicationUserAssignedIdentity> managedIdentities) {
    this.managedIdentities = managedIdentities;
  }


  public ApplicationResourceProperties maximumNodes(Long maximumNodes) {
  ...
  public ApplicationResourceProperties metrics(List<ApplicationMetricDescription> metrics) {
    this.metrics = metrics;
    return this;
  }

  public ApplicationResourceProperties addMetricsItem(ApplicationMetricDescription metricsItem) {
  ...
  public ApplicationResourceProperties minimumNodes(Long minimumNodes) {
  ...
  public ApplicationResourceProperties parameters(Map<String, String> parameters) {
    this.parameters = parameters;
    return this;
  }

  public ApplicationResourceProperties putParametersItem(String key, String parametersItem) {
  ...
  public ApplicationResourceProperties removeApplicationCapacity(Boolean removeApplicationCapacity) {
  ...
  public ApplicationResourceProperties typeVersion(String typeVersion) {
  ...
  public ApplicationResourceProperties upgradePolicy(ApplicationUpgradePolicy upgradePolicy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.provisioningState, applicationResourceProperties.provisioningState) &&
        Objects.equals(this.typeName, applicationResourceProperties.typeName) &&
        Objects.equals(this.managedIdentities, applicationResourceProperties.managedIdentities) &&
        Objects.equals(this.maximumNodes, applicationResourceProperties.maximumNodes) &&
        Objects.equals(this.metrics, applicationResourceProperties.metrics) &&
        Objects.equals(this.minimumNodes, applicationResourceProperties.minimumNodes) &&
        Objects.equals(this.parameters, applicationResourceProperties.parameters) &&
        Objects.equals(this.removeApplicationCapacity, applicationResourceProperties.removeApplicationCapacity) &&
        Objects.equals(this.typeVersion, applicationResourceProperties.typeVersion) &&
        Objects.equals(this.upgradePolicy, applicationResourceProperties.upgradePolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(provisioningState, typeName, managedIdentities, maximumNodes, metrics, minimumNodes, parameters, removeApplicationCapacity, typeVersion, upgradePolicy);
  }
      ...
      if (jsonObj.get("managedIdentities") != null && !jsonObj.get("managedIdentities").isJsonNull()) {
        ...
        if (jsonArraymanagedIdentities != null) {
          ...
          for (int i = 0; i < jsonArraymanagedIdentities.size(); i++) {
            ApplicationUserAssignedIdentity.validateJsonElement(jsonArraymanagedIdentities.get(i));
          };
        }
      }
