...
public class StatelessServiceUpdateProperties {
  ...
  public StatelessServiceUpdateProperties instanceCount(Integer instanceCount) {
  ...
  public StatelessServiceUpdateProperties serviceKind(ServiceKind serviceKind) {
  ...
  public StatelessServiceUpdateProperties correlationScheme(List<ServiceCorrelationDescription> correlationScheme) {
    this.correlationScheme = correlationScheme;
    return this;
  }

  public StatelessServiceUpdateProperties addCorrelationSchemeItem(ServiceCorrelationDescription correlationSchemeItem) {
  ...
  public StatelessServiceUpdateProperties defaultMoveCost(MoveCost defaultMoveCost) {
  ...
  public StatelessServiceUpdateProperties placementConstraints(String placementConstraints) {
  ...
  public StatelessServiceUpdateProperties serviceLoadMetrics(List<ServiceLoadMetricDescription> serviceLoadMetrics) {
    this.serviceLoadMetrics = serviceLoadMetrics;
    return this;
  }

  public StatelessServiceUpdateProperties addServiceLoadMetricsItem(ServiceLoadMetricDescription serviceLoadMetricsItem) {
  ...
  public StatelessServiceUpdateProperties servicePlacementPolicies(List<ServicePlacementPolicyDescription> servicePlacementPolicies) {
    this.servicePlacementPolicies = servicePlacementPolicies;
    return this;
  }

  public StatelessServiceUpdateProperties addServicePlacementPoliciesItem(ServicePlacementPolicyDescription servicePlacementPoliciesItem) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessServiceUpdateProperties statelessServiceUpdateProperties = (StatelessServiceUpdateProperties) o;
    return Objects.equals(this.instanceCount, statelessServiceUpdateProperties.instanceCount) &&
        Objects.equals(this.serviceKind, statelessServiceUpdateProperties.serviceKind) &&
        Objects.equals(this.correlationScheme, statelessServiceUpdateProperties.correlationScheme) &&
        Objects.equals(this.defaultMoveCost, statelessServiceUpdateProperties.defaultMoveCost) &&
        Objects.equals(this.placementConstraints, statelessServiceUpdateProperties.placementConstraints) &&
        Objects.equals(this.serviceLoadMetrics, statelessServiceUpdateProperties.serviceLoadMetrics) &&
        Objects.equals(this.servicePlacementPolicies, statelessServiceUpdateProperties.servicePlacementPolicies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instanceCount, serviceKind, correlationScheme, defaultMoveCost, placementConstraints, serviceLoadMetrics, servicePlacementPolicies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessServiceUpdateProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessServiceUpdateProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessServiceUpdateProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessServiceUpdateProperties is not found in the empty JSON string", StatelessServiceUpdateProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessServiceUpdateProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessServiceUpdateProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessServiceUpdateProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessServiceUpdateProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessServiceUpdateProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessServiceUpdateProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessServiceUpdateProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessServiceUpdateProperties>() {
           @Override
           public void write(JsonWriter out, StatelessServiceUpdateProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessServiceUpdateProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessServiceUpdateProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessServiceUpdateProperties
   * @throws IOException if the JSON string is invalid with respect to StatelessServiceUpdateProperties
   */
  public static StatelessServiceUpdateProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessServiceUpdateProperties.class);
  }

  /**
   * Convert an instance of StatelessServiceUpdateProperties to an JSON string
   *
   * @return JSON string
   */
