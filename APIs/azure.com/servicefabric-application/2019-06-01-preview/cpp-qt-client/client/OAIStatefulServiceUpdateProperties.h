...
/*
 * OAIStatefulServiceUpdateProperties.h
 *
 * The properties of a stateful service resource for patch operations.
 */

#ifndef OAIStatefulServiceUpdateProperties_H
#define OAIStatefulServiceUpdateProperties_H
...
class OAIStatefulServiceUpdateProperties : public OAIObject {
public:
    OAIStatefulServiceUpdateProperties();
    OAIStatefulServiceUpdateProperties(QString json);
    ~OAIStatefulServiceUpdateProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulServiceUpdateProperties)

#endif // OAIStatefulServiceUpdateProperties_H
