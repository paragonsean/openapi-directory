...
/*
 * OAIApplicationResourceProperties.h
 *
 * The application resource properties.
 */

#ifndef OAIApplicationResourceProperties_H
#define OAIApplicationResourceProperties_H
...
class OAIApplicationResourceProperties : public OAIObject {
public:
    OAIApplicationResourceProperties();
    OAIApplicationResourceProperties(QString json);
    ~OAIApplicationResourceProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationResourceProperties)

#endif // OAIApplicationResourceProperties_H
