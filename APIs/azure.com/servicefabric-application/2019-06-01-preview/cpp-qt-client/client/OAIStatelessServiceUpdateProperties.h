...
/*
 * OAIStatelessServiceUpdateProperties.h
 *
 * The properties of a stateless service resource for patch operations.
 */

#ifndef OAIStatelessServiceUpdateProperties_H
#define OAIStatelessServiceUpdateProperties_H
...
class OAIStatelessServiceUpdateProperties : public OAIObject {
public:
    OAIStatelessServiceUpdateProperties();
    OAIStatelessServiceUpdateProperties(QString json);
    ~OAIStatelessServiceUpdateProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessServiceUpdateProperties)

#endif // OAIStatelessServiceUpdateProperties_H
