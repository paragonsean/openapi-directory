...
namespace OpenAPI {
class OAIArmApplicationHealthPolicy;
class OAIArmRollingUpgradeMonitoringPolicy;
...
public:
    ...
    OAIArmApplicationHealthPolicy getApplicationHealthPolicy() const;
    void setApplicationHealthPolicy(const OAIArmApplicationHealthPolicy &application_health_policy);
    ...
    OAIArmRollingUpgradeMonitoringPolicy getRollingUpgradeMonitoringPolicy() const;
    void setRollingUpgradeMonitoringPolicy(const OAIArmRollingUpgradeMonitoringPolicy &rolling_upgrade_monitoring_policy);
...
private:
    ...
    OAIArmApplicationHealthPolicy m_application_health_policy;
    ...
    OAIArmRollingUpgradeMonitoringPolicy m_rolling_upgrade_monitoring_policy;
