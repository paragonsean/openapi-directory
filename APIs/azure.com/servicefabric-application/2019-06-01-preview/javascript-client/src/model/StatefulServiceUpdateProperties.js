...
/**
 * The StatefulServiceUpdateProperties model module.
 * @module model/StatefulServiceUpdateProperties
 * @version 2019-06-01-preview
 */
class StatefulServiceUpdateProperties {
    /**
     * Constructs a new <code>StatefulServiceUpdateProperties</code>.
     * The properties of a stateful service resource for patch operations.
     * @alias module:model/StatefulServiceUpdateProperties
     * @implements module:model/ServiceResourceUpdateProperties
     * @param serviceKind {module:model/ServiceKind} 
     */
    constructor(serviceKind) { 
        ServiceResourceUpdateProperties.initialize(this);
        StatefulServiceUpdateProperties.initialize(this, serviceKind);
    }
    ...
    /**
     * Constructs a <code>StatefulServiceUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulServiceUpdateProperties} obj Optional instance to populate.
     * @return {module:model/StatefulServiceUpdateProperties} The populated <code>StatefulServiceUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulServiceUpdateProperties();
            ServiceResourceUpdateProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulServiceUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulServiceUpdateProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatefulServiceUpdateProperties.RequiredProperties) {
...
StatefulServiceUpdateProperties.RequiredProperties = ["serviceKind"];

/**
 * The minimum replica set size as a number.
 * @member {Number} minReplicaSetSize
 */
StatefulServiceUpdateProperties.prototype['minReplicaSetSize'] = undefined;
 ...
 */
StatefulServiceUpdateProperties.prototype['quorumLossWaitDuration'] = undefined;
 ...
 */
StatefulServiceUpdateProperties.prototype['replicaRestartWaitDuration'] = undefined;
 ...
 */
StatefulServiceUpdateProperties.prototype['standByReplicaKeepDuration'] = undefined;

/**
 * The target replica set size as a number.
 * @member {Number} targetReplicaSetSize
 */
StatefulServiceUpdateProperties.prototype['targetReplicaSetSize'] = undefined;

/**
 * @member {module:model/ServiceKind} serviceKind
 */
StatefulServiceUpdateProperties.prototype['serviceKind'] = undefined;

/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServiceCorrelationDescription>} correlationScheme
 */
StatefulServiceUpdateProperties.prototype['correlationScheme'] = undefined;

/**
 * @member {module:model/MoveCost} defaultMoveCost
 */
StatefulServiceUpdateProperties.prototype['defaultMoveCost'] = undefined;

/**
 * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: \"NodeColor == blue)\".
 * @member {String} placementConstraints
 */
StatefulServiceUpdateProperties.prototype['placementConstraints'] = undefined;

/**
 * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
 * @member {Array.<module:model/ServiceLoadMetricDescription>} serviceLoadMetrics
 */
StatefulServiceUpdateProperties.prototype['serviceLoadMetrics'] = undefined;

/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServicePlacementPolicyDescription>} servicePlacementPolicies
 */
StatefulServiceUpdateProperties.prototype['servicePlacementPolicies'] = undefined;


// Implement ServiceResourceUpdateProperties interface:
/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServiceCorrelationDescription>} correlationScheme
 */
ServiceResourceUpdateProperties.prototype['correlationScheme'] = undefined;
/**
 * @member {module:model/MoveCost} defaultMoveCost
 */
ServiceResourceUpdateProperties.prototype['defaultMoveCost'] = undefined;
/**
 * The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: \"NodeColor == blue)\".
 * @member {String} placementConstraints
 */
ServiceResourceUpdateProperties.prototype['placementConstraints'] = undefined;
/**
 * The service load metrics is given as an array of ServiceLoadMetricDescription objects.
 * @member {Array.<module:model/ServiceLoadMetricDescription>} serviceLoadMetrics
 */
ServiceResourceUpdateProperties.prototype['serviceLoadMetrics'] = undefined;
/**
 * A list that describes the correlation of the service with other services.
 * @member {Array.<module:model/ServicePlacementPolicyDescription>} servicePlacementPolicies
 */
ServiceResourceUpdateProperties.prototype['servicePlacementPolicies'] = undefined;




export default StatefulServiceUpdateProperties;
