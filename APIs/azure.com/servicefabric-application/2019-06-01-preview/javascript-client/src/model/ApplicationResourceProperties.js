...
import ApplicationUserAssignedIdentity from './ApplicationUserAssignedIdentity';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('managedIdentities')) {
                obj['managedIdentities'] = ApiClient.convertToType(data['managedIdentities'], [ApplicationUserAssignedIdentity]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['managedIdentities']) { // data not null
            ...
            for (const item of data['managedIdentities']) {
                ApplicationUserAssignedIdentity.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ApplicationUserAssignedIdentity>} managedIdentities
 */
ApplicationResourceProperties.prototype['managedIdentities'] = undefined;
 ...
 * @member {Array.<module:model/ApplicationUserAssignedIdentity>} managedIdentities
 */
ApplicationResourceUpdateProperties.prototype['managedIdentities'] = undefined;
/**
 * The maximum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. By default, the value of this property is zero and it means that the services can be placed on any node.
 * @member {Number} maximumNodes
 * @default 0
