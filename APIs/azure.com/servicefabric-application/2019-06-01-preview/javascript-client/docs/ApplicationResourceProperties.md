...
**managedIdentities** | [**[ApplicationUserAssignedIdentity]**](ApplicationUserAssignedIdentity.md) | List of user assigned identities for the application, each mapped to a friendly name. | [optional] 
