...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMediaServices.AacAudio();
  });
  ...
  describe('AacAudio', function() {
    it('should create an instance of AacAudio', function() {
      // uncomment below and update the code to test AacAudio
      //var instance = new AzureMediaServices.AacAudio();
      //expect(instance).to.be.a(AzureMediaServices.AacAudio);
    });
