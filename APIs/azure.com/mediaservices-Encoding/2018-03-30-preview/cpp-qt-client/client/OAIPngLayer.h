...
#ifndef OAIPngLayer_H
#define OAIPngLayer_H
...
class OAIPngLayer : public OAIObject {
public:
    OAIPngLayer();
    OAIPngLayer(QString json);
    ~OAIPngLayer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPngLayer)
