...
QString OAIJobInputs::getLabel() const {
    return m_label;
}
void OAIJobInputs::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIJobInputs::is_label_Set() const{
    return m_label_isSet;
}

bool OAIJobInputs::is_label_Valid() const{
