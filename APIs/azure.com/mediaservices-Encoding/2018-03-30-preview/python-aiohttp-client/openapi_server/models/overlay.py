...
class Overlay(Model):
    ...
    def __init__(self, odata_type: str=None, audio_gain_level: float=None, end: str=None, fade_in_duration: str=None, fade_out_duration: str=None, input_label: str=None, start: str=None):
        ...
        :param odata_type: The odata_type of this Overlay.
        :param audio_gain_level: The audio_gain_level of this Overlay.
        :param end: The end of this Overlay.
        :param fade_in_duration: The fade_in_duration of this Overlay.
        :param fade_out_duration: The fade_out_duration of this Overlay.
        :param input_label: The input_label of this Overlay.
        :param start: The start of this Overlay.
        """
        self.openapi_types = {
            'odata_type': str,
    ...
    @property
    def odata_type(self):
        """Gets the odata_type of this Overlay.

        The discriminator for derived types.

        :return: The odata_type of this Overlay.
        :rtype: str
        """
    ...
    def odata_type(self, odata_type):
        """Sets the odata_type of this Overlay.
    ...
    def audio_gain_level(self):
        """Gets the audio_gain_level of this Overlay.

        The gain level of audio in the overlay. The value should be in the range [0, 1.0]. The default is 1.0.

        :return: The audio_gain_level of this Overlay.
        :rtype: float
        """
    ...
    def audio_gain_level(self, audio_gain_level):
        """Sets the audio_gain_level of this Overlay.
    ...
    def end(self):
        ...
        :return: The end of this Overlay.
        :rtype: str
        """
        return self._end
    ...
    def fade_in_duration(self):
        """Gets the fade_in_duration of this Overlay.

        The duration over which the overlay fades in onto the input video. The value should be in ISO 8601 duration format. If not specified the default behavior is to have no fade in (same as PT0S).

        :return: The fade_in_duration of this Overlay.
        :rtype: str
        """
    ...
    def fade_in_duration(self, fade_in_duration):
        """Sets the fade_in_duration of this Overlay.
    ...
    def fade_out_duration(self):
        """Gets the fade_out_duration of this Overlay.

        The duration over which the overlay fades out of the input video. The value should be in ISO 8601 duration format. If not specified the default behavior is to have no fade out (same as PT0S).

        :return: The fade_out_duration of this Overlay.
        :rtype: str
        """
    ...
    def fade_out_duration(self, fade_out_duration):
        """Sets the fade_out_duration of this Overlay.
    ...
    def input_label(self):
        """Gets the input_label of this Overlay.
        ...
        :return: The input_label of this Overlay.
        :rtype: str
        """
    ...
    def input_label(self, input_label):
        """Sets the input_label of this Overlay.
    ...
    @property
    def start(self):
        """Gets the start of this Overlay.
        ...
        :return: The start of this Overlay.
        :rtype: str
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this Overlay.
