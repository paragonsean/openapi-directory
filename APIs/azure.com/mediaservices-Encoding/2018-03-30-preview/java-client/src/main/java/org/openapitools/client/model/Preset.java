...
public class Preset {
  ...
  public Preset atOdataType(String atOdataType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atOdataType, preset.atOdataType);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      switch (discriminatorValue) {
        case "AudioAnalyzerPreset":
          AudioAnalyzerPreset.validateJsonElement(jsonElement);
          break;
        case "BuiltInStandardEncoderPreset":
          BuiltInStandardEncoderPreset.validateJsonElement(jsonElement);
          break;
        case "StandardEncoderPreset":
          StandardEncoderPreset.validateJsonElement(jsonElement);
          break;
