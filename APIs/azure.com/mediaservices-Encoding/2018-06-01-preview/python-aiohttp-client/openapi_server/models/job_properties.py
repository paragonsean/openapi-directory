...
class JobProperties(Model):
    ...
    def __init__(self, correlation_data: Dict[str, str]=None, created: datetime=None, description: str=None, input: JobInput=None, last_modified: datetime=None, outputs: List[JobOutput]=None, priority: str=None, state: str=None):
        """JobProperties - a model defined in OpenAPI

        :param correlation_data: The correlation_data of this JobProperties.
    ...
    def correlation_data(self):
        """Gets the correlation_data of this JobProperties.

        Customer provided correlation data that will be returned in Job completed events.

        :return: The correlation_data of this JobProperties.
        :rtype: Dict[str, str]
        """
    ...
    def correlation_data(self, correlation_data):
        """Sets the correlation_data of this JobProperties.
