...
#ifndef OAICopyVideo_H
#define OAICopyVideo_H
...
class OAICopyVideo : public OAIObject {
public:
    OAICopyVideo();
    OAICopyVideo(QString json);
    ~OAICopyVideo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyVideo)

#endif // OAICopyVideo_H
