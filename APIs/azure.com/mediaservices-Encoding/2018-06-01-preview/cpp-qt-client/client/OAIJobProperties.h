...
public:
    ...
    QMap<QString, QString> getCorrelationData() const;
    void setCorrelationData(const QMap<QString, QString> &correlation_data);
    bool is_correlation_data_Set() const;
    bool is_correlation_data_Valid() const;
...
private:
    ...
    QMap<QString, QString> m_correlation_data;
    bool m_correlation_data_isSet;
    bool m_correlation_data_isValid;
