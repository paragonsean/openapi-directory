...
class H264Layer {
     ...
     * @param bitrate {Number} The average bitrate in bits per second at which to encode the input video when generating this layer. This is a required field.
     * @param odataType {String} The discriminator for derived types.
     */
    constructor(bitrate, odataType) { 
        VideoLayer.initialize(this, odataType);
        H264Layer.initialize(this, bitrate, odataType);
    }
     ...
     */
    static initialize(obj, bitrate, odataType) { 
    }
...
H264Layer.RequiredProperties = ["bitrate", "@odata.type"];
