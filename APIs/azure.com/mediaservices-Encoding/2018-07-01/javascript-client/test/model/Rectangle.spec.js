...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMediaServices.Rectangle();
  });
  ...
  describe('Rectangle', function() {
    it('should create an instance of Rectangle', function() {
      // uncomment below and update the code to test Rectangle
      //var instance = new AzureMediaServices.Rectangle();
      //expect(instance).to.be.a(AzureMediaServices.Rectangle);
    });
