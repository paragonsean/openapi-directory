...
public class ClipTime {
  ...
  public ClipTime atOdataType(String atOdataType) {
  ...
  public boolean equals(Object o) {
    ...
    ClipTime clipTime = (ClipTime) o;
    return Objects.equals(this.atOdataType, clipTime.atOdataType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClipTime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClipTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClipTime is not found in the empty JSON string", ClipTime.openapiRequiredFields.toString()));
        }
      }

      String discriminatorValue = jsonElement.getAsJsonObject().get("@odata.type").getAsString();
      switch (discriminatorValue) {
        case "AbsoluteClipTime":
          AbsoluteClipTime.validateJsonElement(jsonElement);
          break;
        default:
  ...
  /**
   * Create an instance of ClipTime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClipTime
   * @throws IOException if the JSON string is invalid with respect to ClipTime
   */
  public static ClipTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClipTime.class);
  }

  /**
   * Convert an instance of ClipTime to an JSON string
   *
   * @return JSON string
   */
