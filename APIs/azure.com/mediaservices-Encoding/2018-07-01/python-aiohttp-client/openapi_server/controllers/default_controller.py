...
async def jobs_list(request: web.Request, subscription_id, resource_group_name, account_name, transform_name, api_version, filter=None, orderby=None) -> web.Response:
    """List Jobs
...
async def jobs_update(request: web.Request, subscription_id, resource_group_name, account_name, transform_name, job_name, api_version, parameters) -> web.Response:
    """Update Job
...
async def transforms_list(request: web.Request, subscription_id, resource_group_name, account_name, api_version, filter=None, orderby=None) -> web.Response:
    """List Transforms
