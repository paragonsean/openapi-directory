...
class JobOutputAsset(Model):
    ...
    def __init__(self, asset_name: str=None, odata_type: str=None, error: JobError=None, label: str=None, progress: int=None, state: str=None):
        ...
        :param label: The label of this JobOutputAsset.
    ...
    @property
    def label(self):
        """Gets the label of this JobOutputAsset.
        ...
        :return: The label of this JobOutputAsset.
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this JobOutputAsset.
