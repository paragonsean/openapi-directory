...
async def test_jobs_create(client):
    ...
    Create Job
    """
    parameters = {"properties":{"correlationData":{"key":"correlationData"},"outputs":[{"@odata.type":"@odata.type","progress":0,"label":"label","state":"Canceled","error":{"code":"ServiceError","details":[{"code":"code","message":"message"},{"code":"code","message":"message"}],"category":"Service","message":"message","retry":"DoNotRetry"}},{"@odata.type":"@odata.type","progress":0,"label":"label","state":"Canceled","error":{"code":"ServiceError","details":[{"code":"code","message":"message"},{"code":"code","message":"message"}],"category":"Service","message":"message","retry":"DoNotRetry"}}],"input":{"@odata.type":"@odata.type"},"created":"2000-01-23T04:56:07.000+00:00","description":"description","lastModified":"2000-01-23T04:56:07.000+00:00","state":"Canceled","priority":"Low"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
