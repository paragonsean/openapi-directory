...
void OAIVideoAnalyzerPreset::initializeModel() {
    ...
    m_insights_to_extract_isSet = false;
    m_insights_to_extract_isValid = false;
...
void OAIVideoAnalyzerPreset::fromJsonObject(QJsonObject json) {
    ...
    m_insights_to_extract_isValid = ::OpenAPI::fromJsonValue(m_insights_to_extract, json[QString("insightsToExtract")]);
    m_insights_to_extract_isSet = !json[QString("insightsToExtract")].isNull() && m_insights_to_extract_isValid;
...
QJsonObject OAIVideoAnalyzerPreset::asJsonObject() const {
    QJsonObject obj;
    if (m_insights_to_extract_isSet) {
        obj.insert(QString("insightsToExtract"), ::OpenAPI::toJsonValue(m_insights_to_extract));
    }
...
QString OAIVideoAnalyzerPreset::getInsightsToExtract() const {
    return m_insights_to_extract;
}
void OAIVideoAnalyzerPreset::setInsightsToExtract(const QString &insights_to_extract) {
    m_insights_to_extract = insights_to_extract;
    m_insights_to_extract_isSet = true;
}

bool OAIVideoAnalyzerPreset::is_insights_to_extract_Set() const{
    return m_insights_to_extract_isSet;
}

bool OAIVideoAnalyzerPreset::is_insights_to_extract_Valid() const{
    return m_insights_to_extract_isValid;
}
