...
QString OAIJobOutput::getLabel() const {
    return m_label;
}
void OAIJobOutput::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIJobOutput::is_label_Set() const{
    return m_label_isSet;
}

bool OAIJobOutput::is_label_Valid() const{
