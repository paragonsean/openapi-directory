...
void OAIJobProperties::initializeModel() {
    ...
    m_correlation_data_isSet = false;
    m_correlation_data_isValid = false;
...
void OAIJobProperties::fromJsonObject(QJsonObject json) {
    ...
    m_correlation_data_isValid = ::OpenAPI::fromJsonValue(m_correlation_data, json[QString("correlationData")]);
    m_correlation_data_isSet = !json[QString("correlationData")].isNull() && m_correlation_data_isValid;
...
QJsonObject OAIJobProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_correlation_data.size() > 0) {
        obj.insert(QString("correlationData"), ::OpenAPI::toJsonValue(m_correlation_data));
    }
    if (m_created_isSet) {
...
QMap<QString, QString> OAIJobProperties::getCorrelationData() const {
    return m_correlation_data;
}
void OAIJobProperties::setCorrelationData(const QMap<QString, QString> &correlation_data) {
    m_correlation_data = correlation_data;
    m_correlation_data_isSet = true;
}

bool OAIJobProperties::is_correlation_data_Set() const{
    return m_correlation_data_isSet;
}

bool OAIJobProperties::is_correlation_data_Valid() const{
    return m_correlation_data_isValid;
}
