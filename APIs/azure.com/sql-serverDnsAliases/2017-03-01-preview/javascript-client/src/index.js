...
import ServerDnsAliasProperties from './model/ServerDnsAliasProperties';
import ServerDnsAliasesApi from './api/ServerDnsAliasesApi';
...
export {
    ...
    /**
     * The ServerDnsAlias model constructor.
     * @property {module:model/ServerDnsAlias}
     */
    ServerDnsAlias,

    /**
     * The ServerDnsAliasAcquisition model constructor.
     * @property {module:model/ServerDnsAliasAcquisition}
     */
    ServerDnsAliasAcquisition,

    /**
     * The ServerDnsAliasListResult model constructor.
     * @property {module:model/ServerDnsAliasListResult}
     */
    ServerDnsAliasListResult,

    /**
     * The ServerDnsAliasProperties model constructor.
     * @property {module:model/ServerDnsAliasProperties}
     */
    ServerDnsAliasProperties,

    /**
    * The ServerDnsAliasesApi service constructor.
    * @property {module:api/ServerDnsAliasesApi}
    */
    ServerDnsAliasesApi
};
