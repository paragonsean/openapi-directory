...
class StackMinorVersion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isRemoteDebuggingEnabled')) {
                obj['isRemoteDebuggingEnabled'] = ApiClient.convertToType(data['isRemoteDebuggingEnabled'], 'Boolean');
            }
 ...
 * @member {Boolean} isRemoteDebuggingEnabled
 */
StackMinorVersion.prototype['isRemoteDebuggingEnabled'] = undefined;
