...
class StackMinorVersion(Model):
    ...
    def __init__(self, display_version: str=None, is_default: bool=None, is_remote_debugging_enabled: bool=None, runtime_version: str=None):
        ...
        :param is_remote_debugging_enabled: The is_remote_debugging_enabled of this StackMinorVersion.
        :param runtime_version: The runtime_version of this StackMinorVersion.
        """
        self.openapi_types = {
            'display_version': str,
            'is_default': bool,
            'is_remote_debugging_enabled': bool,
            'runtime_version': str
        }
        ...
        self.attribute_map = {
            ...
            'is_remote_debugging_enabled': 'isRemoteDebuggingEnabled',
            'runtime_version': 'runtimeVersion'
        }

        self._display_version = display_version
        self._is_default = is_default
        self._is_remote_debugging_enabled = is_remote_debugging_enabled
    ...
    @property
    def is_remote_debugging_enabled(self):
        """Gets the is_remote_debugging_enabled of this StackMinorVersion.

        <code>true</code> if this supports Remote Debugging, otherwise <code>false</code>.

        :return: The is_remote_debugging_enabled of this StackMinorVersion.
        :rtype: bool
        """
        return self._is_remote_debugging_enabled

    @is_remote_debugging_enabled.setter
    def is_remote_debugging_enabled(self, is_remote_debugging_enabled):
        """Sets the is_remote_debugging_enabled of this StackMinorVersion.
