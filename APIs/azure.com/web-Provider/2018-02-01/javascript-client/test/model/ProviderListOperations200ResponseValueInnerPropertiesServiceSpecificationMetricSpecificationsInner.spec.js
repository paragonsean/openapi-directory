...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProviderApiClient.ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner();
  });
  ...
  describe('ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner', function() {
    it('should create an instance of ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner', function() {
      // uncomment below and update the code to test ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner
      //var instance = new ProviderApiClient.ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner();
      //expect(instance).to.be.a(ProviderApiClient.ProviderListOperations200ResponseValueInnerPropertiesServiceSpecificationMetricSpecificationsInner);
    });
