...
class StackMajorVersion(Model):
    ...
    def __init__(self, application_insights: bool=None, display_version: str=None, is_default: bool=None, minor_versions: List[StackMinorVersion]=None, runtime_version: str=None):
