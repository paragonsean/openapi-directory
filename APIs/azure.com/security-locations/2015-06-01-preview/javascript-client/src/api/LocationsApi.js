...
export default class LocationsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/LocationsList200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/LocationsList200Response}
     */
    locationsList(apiVersion, subscriptionId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = LocationsList200Response;
      return this.apiClient.callApi(
