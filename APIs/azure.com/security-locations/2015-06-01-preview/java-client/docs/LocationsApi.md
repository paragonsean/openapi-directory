...
<a id="locationsGet"></a>
# **locationsGet**
> LocationsGet200Response locationsGet(apiVersion, subscriptionId, ascLocation)
...
# **locationsList**
> LocationsList200Response locationsList(apiVersion, subscriptionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Azure subscription ID
    try {
      LocationsList200Response result = apiInstance.locationsList(apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
...
[**LocationsList200Response**](LocationsList200Response.md)
