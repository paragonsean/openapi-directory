...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.GroupApi();
  });
  ...
  describe('GroupApi', function() {
    ...
    describe('groupGetEntityTag', function() {
      it('should call groupGetEntityTag successfully', function(done) {
        //uncomment below and update the code to test groupGetEntityTag
        //instance.groupGetEntityTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('groupListByService', function() {
      it('should call groupListByService successfully', function(done) {
        //uncomment below and update the code to test groupListByService
        //instance.groupListByService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
