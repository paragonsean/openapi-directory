...
public:
    ...
    */
    virtual void groupCreateOrUpdate(const QString &group_id, const QString &api_version, const OAIGroupCreateParameters &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void groupDelete(const QString &group_id, const QString &if_match, const QString &api_version);

    /**
    * @param[in]  group_id QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void groupGet(const QString &group_id, const QString &api_version);
    ...
    */
    virtual void groupList(const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void groupUpdate(const QString &group_id, const QString &if_match, const QString &api_version, const OAIGroupUpdateParameters &parameters);
...
private:
    ...
    void groupListCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void groupListSignal(OAIGroupCollection summary);
    ...
    void groupListSignalFull(OAIHttpRequestWorker *worker, OAIGroupCollection summary);
    ...
    Q_DECL_DEPRECATED_X("Use groupListSignalError() instead")
    void groupListSignalE(OAIGroupCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void groupListSignalError(OAIGroupCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use groupListSignalErrorFull() instead")
    void groupListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void groupListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
