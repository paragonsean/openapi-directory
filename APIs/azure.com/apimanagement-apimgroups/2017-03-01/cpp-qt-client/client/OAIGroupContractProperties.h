...
/*
 * OAIGroupContractProperties.h
 *
 * Developer group.
 */

#ifndef OAIGroupContractProperties_H
#define OAIGroupContractProperties_H
...
class OAIGroupContractProperties : public OAIObject {
public:
    OAIGroupContractProperties();
    OAIGroupContractProperties(QString json);
    ~OAIGroupContractProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupContractProperties)

#endif // OAIGroupContractProperties_H
