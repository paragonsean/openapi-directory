...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.GroupCollection();
  });
  ...
  describe('GroupCollection', function() {
    it('should create an instance of GroupCollection', function() {
      ...
      //var instance = new ApiManagementClient.GroupCollection();
      //expect(instance).to.be.a(ApiManagementClient.GroupCollection);
    });
