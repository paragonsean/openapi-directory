...
export default class GroupUsersApi {
    ...
    */
     ...
     */
    groupUserCreate(groupId, uid, apiVersion, callback) {
      let postBody = null;
     ...
     */
    groupUserDelete(groupId, uid, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/groups/{groupId}/users/{uid}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    groupUserList(groupId, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
