...
> GroupContract groupCreateOrUpdate(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId, parameters, opts)
...
> GroupCollection groupListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
