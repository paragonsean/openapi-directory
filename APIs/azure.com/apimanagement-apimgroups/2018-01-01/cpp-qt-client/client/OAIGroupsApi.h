...
public:
    ...
    */
    virtual void groupCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &group_id, const QString &api_version, const QString &subscription_id, const OAIGroupCreateParameters &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void groupUpdate(const QString &resource_group_name, const QString &service_name, const QString &group_id, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIGroupUpdateParameters &parameters);
...
Q_SIGNALS:
    ...
    void groupCreateOrUpdateSignal(OAIGroupContract summary);
    void groupDeleteSignal();
    void groupGetSignal(OAIGroupContract summary);
    void groupGetEntityTagSignal();
    void groupListByServiceSignal(OAIGroupCollection summary);
    void groupUpdateSignal();


    void groupCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIGroupContract summary);
    void groupDeleteSignalFull(OAIHttpRequestWorker *worker);
    void groupGetSignalFull(OAIHttpRequestWorker *worker, OAIGroupContract summary);
    void groupGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void groupListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIGroupCollection summary);
    void groupUpdateSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use groupCreateOrUpdateSignalError() instead")
    void groupCreateOrUpdateSignalE(OAIGroupContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void groupCreateOrUpdateSignalError(OAIGroupContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void groupGetSignalE(OAIGroupContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void groupGetSignalError(OAIGroupContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void groupListByServiceSignalE(OAIGroupCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void groupListByServiceSignalError(OAIGroupCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
