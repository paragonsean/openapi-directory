...
|------------- | ------------- | -------------|
| [**groupCreateOrUpdate**](GroupsApi.md#groupCreateOrUpdate) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} |  |
| [**groupDelete**](GroupsApi.md#groupDelete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} |  |
| [**groupGet**](GroupsApi.md#groupGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} |  |
| [**groupGetEntityTag**](GroupsApi.md#groupGetEntityTag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} |  |
| [**groupListByService**](GroupsApi.md#groupListByService) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups |  |
| [**groupUpdate**](GroupsApi.md#groupUpdate) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/groups/{groupId} |  |


<a id="groupCreateOrUpdate"></a>
# **groupCreateOrUpdate**
> GroupContract groupCreateOrUpdate(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId, parameters, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GroupContract result = apiInstance.groupCreateOrUpdate(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId, parameters, ifMatch);
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      apiInstance.groupDelete(resourceGroupName, serviceName, groupId, ifMatch, apiVersion, subscriptionId);
    } catch (ApiException e) {
...
<a id="groupGet"></a>
# **groupGet**
> GroupContract groupGet(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      GroupContract result = apiInstance.groupGet(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      apiInstance.groupGetEntityTag(resourceGroupName, serviceName, groupId, apiVersion, subscriptionId);
    } catch (ApiException e) {
      System.err.println("Exception when calling GroupsApi#groupGetEntityTag");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="groupListByService"></a>
# **groupListByService**
> GroupCollection groupListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GroupCollection result = apiInstance.groupListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GroupsApi#groupListByService");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.groupUpdate(resourceGroupName, serviceName, groupId, ifMatch, apiVersion, subscriptionId, parameters);
    } catch (ApiException e) {
