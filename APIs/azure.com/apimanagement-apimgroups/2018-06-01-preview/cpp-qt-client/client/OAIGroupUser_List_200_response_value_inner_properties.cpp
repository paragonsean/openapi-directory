...
QList<OAIGroup_ListByService_200_response_value_inner_properties> OAIGroupUser_List_200_response_value_inner_properties::getGroups() const {
    return m_groups;
}
void OAIGroupUser_List_200_response_value_inner_properties::setGroups(const QList<OAIGroup_ListByService_200_response_value_inner_properties> &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}
