...
#ifndef OAI_OAIGroupUserApi_H
#define OAI_OAIGroupUserApi_H
...
class OAIGroupUserApi : public QObject {
    Q_OBJECT

public:
    OAIGroupUserApi(const int timeOut = 0);
    ~OAIGroupUserApi();
    ...
    */
    virtual void groupUserCheckEntityExists(const QString &resource_group_name, const QString &service_name, const QString &group_id, const QString &user_id, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void groupUserCreate(const QString &resource_group_name, const QString &service_name, const QString &group_id, const QString &user_id, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void groupUserDelete(const QString &resource_group_name, const QString &service_name, const QString &group_id, const QString &user_id, const QString &api_version, const QString &subscription_id);
...
private:
    ...
    void groupUserCheckEntityExistsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void groupUserCheckEntityExistsSignal();
    ...
    void groupUserCheckEntityExistsSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use groupUserCheckEntityExistsSignalError() instead")
    void groupUserCheckEntityExistsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void groupUserCheckEntityExistsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use groupUserCheckEntityExistsSignalErrorFull() instead")
    void groupUserCheckEntityExistsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void groupUserCheckEntityExistsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
