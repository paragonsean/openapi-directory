...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.GroupUsersListByGroups200ResponseValueInner();
  });
  ...
  describe('GroupUsersListByGroups200ResponseValueInner', function() {
    it('should create an instance of GroupUsersListByGroups200ResponseValueInner', function() {
      // uncomment below and update the code to test GroupUsersListByGroups200ResponseValueInner
      //var instance = new ApiManagementClient.GroupUsersListByGroups200ResponseValueInner();
      //expect(instance).to.be.a(ApiManagementClient.GroupUsersListByGroups200ResponseValueInner);
    });
