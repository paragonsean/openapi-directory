...
async def group_users_create(request: web.Request, resource_group_name, service_name, group_id, uid, api_version, subscription_id) -> web.Response:
    """group_users_create
...
async def group_users_delete(request: web.Request, resource_group_name, service_name, group_id, uid, api_version, subscription_id) -> web.Response:
    """group_users_delete
...
async def group_users_list_by_groups(request: web.Request, resource_group_name, service_name, group_id, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
    """group_users_list_by_groups
