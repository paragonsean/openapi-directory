...
async def test_groups_create_or_update(client):
    """Test case for groups_create_or_update
...
async def test_groups_list_by_service(client):
    """Test case for groups_list_by_service
...
async def test_groups_update(client):
