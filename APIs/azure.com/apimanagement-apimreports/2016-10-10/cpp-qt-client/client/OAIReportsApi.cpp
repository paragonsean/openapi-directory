...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("reportsListByService", defaultConf);
    _serverIndices.insert("reportsListByService", 0);
}
...
void OAIReportsApi::reportsListByService(const QString &resource_group_name, const QString &service_name, const QString &aggregation, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &top, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &interval) {
    QString fullPath = QString(_serverConfigs["reportsListByService"][_serverIndices.value("reportsListByService")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/reports/{aggregation}");
    ...
    {
        QString aggregationPathParam("{");
        aggregationPathParam.append("aggregation").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "aggregation", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"aggregation"+pathSuffix : pathPrefix;
        fullPath.replace(aggregationPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(aggregation)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::reportsListByServiceCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::reportsListByServiceCallback);
...
void OAIReportsApi::reportsListByServiceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT reportsListByServiceSignal(output);
        Q_EMIT reportsListByServiceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT reportsListByServiceSignalE(output, error_type, error_str);
        Q_EMIT reportsListByServiceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT reportsListByServiceSignalError(output, error_type, error_str);
        Q_EMIT reportsListByServiceSignalErrorFull(worker, error_type, error_str);
    }
}
