...
/*
 * OAIRequestReportRecordContract.h
 *
 * Request Report data.
 */

#ifndef OAIRequestReportRecordContract_H
#define OAIRequestReportRecordContract_H
...
class OAIRequestReportRecordContract : public OAIObject {
public:
    OAIRequestReportRecordContract();
    OAIRequestReportRecordContract(QString json);
    ~OAIRequestReportRecordContract() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestReportRecordContract)

#endif // OAIRequestReportRecordContract_H
