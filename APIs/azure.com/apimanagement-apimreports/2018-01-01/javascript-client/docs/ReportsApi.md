...
> ReportCollection reportsListByApi(resourceGroupName, serviceName, filter, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListByGeo(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListByOperation(resourceGroupName, serviceName, filter, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListByProduct(resourceGroupName, serviceName, filter, apiVersion, subscriptionId, opts)
...
> RequestReportCollection reportsListByRequest(resourceGroupName, serviceName, filter, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListBySubscription(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListByTime(resourceGroupName, serviceName, interval, apiVersion, subscriptionId, opts)
...
> ReportCollection reportsListByUser(resourceGroupName, serviceName, filter, apiVersion, subscriptionId, opts)
