 ...
 * Request Report data.
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T10:47:31.345451-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class RequestReportRecordContract {
  ...
  public RequestReportRecordContract apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public RequestReportRecordContract apiRegion(String apiRegion) {
  ...
  public RequestReportRecordContract apiTime(Double apiTime) {
  ...
  public RequestReportRecordContract backendResponseCode(String backendResponseCode) {
  ...
  public RequestReportRecordContract cache(String cache) {
    this.cache = cache;
    return this;
  }
  ...
  public RequestReportRecordContract ipAddress(String ipAddress) {
  ...
  public RequestReportRecordContract method(String method) {
    this.method = method;
    return this;
  }
  ...
  public RequestReportRecordContract operationId(String operationId) {
  ...
  public RequestReportRecordContract requestId(String requestId) {
  ...
  public RequestReportRecordContract requestSize(Integer requestSize) {
  ...
  public RequestReportRecordContract responseCode(Integer responseCode) {
  ...
  public RequestReportRecordContract responseSize(Integer responseSize) {
  ...
  public RequestReportRecordContract serviceTime(Double serviceTime) {
  ...
  public RequestReportRecordContract subscriptionId(String subscriptionId) {
  ...
  public RequestReportRecordContract timestamp(OffsetDateTime timestamp) {
  ...
  public RequestReportRecordContract url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RequestReportRecordContract requestReportRecordContract = (RequestReportRecordContract) o;
    return Objects.equals(this.apiId, requestReportRecordContract.apiId) &&
        Objects.equals(this.apiRegion, requestReportRecordContract.apiRegion) &&
        Objects.equals(this.apiTime, requestReportRecordContract.apiTime) &&
        Objects.equals(this.backendResponseCode, requestReportRecordContract.backendResponseCode) &&
        Objects.equals(this.cache, requestReportRecordContract.cache) &&
        Objects.equals(this.ipAddress, requestReportRecordContract.ipAddress) &&
        Objects.equals(this.method, requestReportRecordContract.method) &&
        Objects.equals(this.operationId, requestReportRecordContract.operationId) &&
        Objects.equals(this.productId, requestReportRecordContract.productId) &&
        Objects.equals(this.requestId, requestReportRecordContract.requestId) &&
        Objects.equals(this.requestSize, requestReportRecordContract.requestSize) &&
        Objects.equals(this.responseCode, requestReportRecordContract.responseCode) &&
        Objects.equals(this.responseSize, requestReportRecordContract.responseSize) &&
        Objects.equals(this.serviceTime, requestReportRecordContract.serviceTime) &&
        Objects.equals(this.subscriptionId, requestReportRecordContract.subscriptionId) &&
        Objects.equals(this.timestamp, requestReportRecordContract.timestamp) &&
        Objects.equals(this.url, requestReportRecordContract.url) &&
        Objects.equals(this.userId, requestReportRecordContract.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestReportRecordContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestReportRecordContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestReportRecordContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RequestReportRecordContract is not found in the empty JSON string", RequestReportRecordContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestReportRecordContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RequestReportRecordContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestReportRecordContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestReportRecordContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestReportRecordContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestReportRecordContract.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestReportRecordContract>() {
           @Override
           public void write(JsonWriter out, RequestReportRecordContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestReportRecordContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestReportRecordContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestReportRecordContract
   * @throws IOException if the JSON string is invalid with respect to RequestReportRecordContract
   */
  public static RequestReportRecordContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestReportRecordContract.class);
  }

  /**
   * Convert an instance of RequestReportRecordContract to an JSON string
   *
   * @return JSON string
   */
