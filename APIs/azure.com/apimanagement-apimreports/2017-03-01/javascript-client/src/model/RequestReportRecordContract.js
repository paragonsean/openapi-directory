...
/**
 * The RequestReportRecordContract model module.
 * @module model/RequestReportRecordContract
 * @version 2017-03-01
 */
class RequestReportRecordContract {
    /**
     * Constructs a new <code>RequestReportRecordContract</code>.
     * Request Report data.
     * @alias module:model/RequestReportRecordContract
     */
    constructor() { 
        
        RequestReportRecordContract.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RequestReportRecordContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestReportRecordContract} obj Optional instance to populate.
     * @return {module:model/RequestReportRecordContract} The populated <code>RequestReportRecordContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestReportRecordContract();
    ...
    /**
     * Validates the JSON data with respect to <code>RequestReportRecordContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestReportRecordContract</code>.
     */
 ...
 * @member {String} apiId
 */
RequestReportRecordContract.prototype['apiId'] = undefined;

/**
 * Azure region where the gateway that processed this request is located.
 * @member {String} apiRegion
 */
RequestReportRecordContract.prototype['apiRegion'] = undefined;

/**
 * The total time it took to process this request.
 * @member {Number} apiTime
 */
RequestReportRecordContract.prototype['apiTime'] = undefined;
 ...
 */
RequestReportRecordContract.prototype['backendResponseCode'] = undefined;
 ...
 * @member {String} cache
 */
RequestReportRecordContract.prototype['cache'] = undefined;

/**
 * The client IP address associated with this request.
 * @member {String} ipAddress
 */
RequestReportRecordContract.prototype['ipAddress'] = undefined;

/**
 * The HTTP method associated with this request..
 * @member {String} method
 */
RequestReportRecordContract.prototype['method'] = undefined;

/**
 * Operation identifier path. /apis/{apiId}/operations/{operationId}
 * @member {String} operationId
 */
RequestReportRecordContract.prototype['operationId'] = undefined;

/**
 * Product identifier path. /products/{productId}
 * @member {String} productId
 */
RequestReportRecordContract.prototype['productId'] = undefined;

/**
 * Request Identifier.
 * @member {String} requestId
 */
RequestReportRecordContract.prototype['requestId'] = undefined;

/**
 * The size of this request..
 * @member {Number} requestSize
 */
RequestReportRecordContract.prototype['requestSize'] = undefined;

/**
 * The HTTP status code returned by the gateway.
 * @member {Number} responseCode
 */
RequestReportRecordContract.prototype['responseCode'] = undefined;

/**
 * The size of the response returned by the gateway.
 * @member {Number} responseSize
 */
RequestReportRecordContract.prototype['responseSize'] = undefined;

/**
 * he time it took to forward this request to the backend and get the response back.
 * @member {Number} serviceTime
 */
RequestReportRecordContract.prototype['serviceTime'] = undefined;

/**
 * Subscription identifier path. /subscriptions/{subscriptionId}
 * @member {String} subscriptionId
 */
RequestReportRecordContract.prototype['subscriptionId'] = undefined;

/**
 * The date and time when this request was received by the gateway in ISO 8601 format.
 * @member {Date} timestamp
 */
RequestReportRecordContract.prototype['timestamp'] = undefined;

/**
 * The full URL associated with this request.
 * @member {String} url
 */
RequestReportRecordContract.prototype['url'] = undefined;

/**
 * User identifier path. /users/{userId}
 * @member {String} userId
 */
RequestReportRecordContract.prototype['userId'] = undefined;
...
export default RequestReportRecordContract;
