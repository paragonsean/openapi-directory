...
/*
 * OAIReports_ListByApi_200_response_value_inner.h
 *
 * Report data.
 */

#ifndef OAIReports_ListByApi_200_response_value_inner_H
#define OAIReports_ListByApi_200_response_value_inner_H
...
class OAIReports_ListByApi_200_response_value_inner : public OAIObject {
public:
    OAIReports_ListByApi_200_response_value_inner();
    OAIReports_ListByApi_200_response_value_inner(QString json);
    ~OAIReports_ListByApi_200_response_value_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReports_ListByApi_200_response_value_inner)

#endif // OAIReports_ListByApi_200_response_value_inner_H
