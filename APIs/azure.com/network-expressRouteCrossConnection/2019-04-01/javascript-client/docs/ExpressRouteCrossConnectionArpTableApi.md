# ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionArpTableApi
...
let apiInstance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionArpTableApi();
...
apiInstance.expressRouteCrossConnectionsListArpTable(resourceGroupName, crossConnectionName, peeringName, devicePath, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
