...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeering();
  });
  ...
  describe('ExpressRouteCrossConnectionPeering', function() {
    it('should create an instance of ExpressRouteCrossConnectionPeering', function() {
      // uncomment below and update the code to test ExpressRouteCrossConnectionPeering
      //var instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeering();
      //expect(instance).to.be.a(ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeering);
    });
