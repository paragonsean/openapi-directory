...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeeringList();
  });
  ...
  describe('ExpressRouteCrossConnectionPeeringList', function() {
    it('should create an instance of ExpressRouteCrossConnectionPeeringList', function() {
      // uncomment below and update the code to test ExpressRouteCrossConnectionPeeringList
      //var instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeeringList();
      //expect(instance).to.be.a(ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnectionPeeringList);
    });
