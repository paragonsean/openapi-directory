...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnection();
  });
  ...
  describe('ExpressRouteCrossConnection', function() {
    it('should create an instance of ExpressRouteCrossConnection', function() {
      // uncomment below and update the code to test ExpressRouteCrossConnection
      //var instance = new ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnection();
      //expect(instance).to.be.a(ExpressRouteCrossConnectionRestApis.ExpressRouteCrossConnection);
    });
