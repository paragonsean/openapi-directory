...
export default class FileServiceApi {
    ...
    */
     ...
     * @param {String} subscriptionId The ID of the target subscription.
     * @param {module:model/String} fileServicesName The name of the file Service within the specified storage account. File Service Name must be \"default\"
     * @param {module:model/FileServiceProperties} parameters The properties of file services in storage accounts, including CORS (Cross-Origin Resource Sharing) rules.
     ...
     * data is of type: {@link module:model/FileServiceProperties}
     */
    fileServicesSetServiceProperties(resourceGroupName, accountName, apiVersion, subscriptionId, fileServicesName, parameters, callback) {
      ...
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling fileServicesSetServiceProperties");
      }
