...
export default class FileSharesApi {
    ...
    */
     ...
     */
    fileSharesCreate(resourceGroupName, accountName, shareName, apiVersion, subscriptionId, fileShare, callback) {
     ...
     */
    fileSharesDelete(resourceGroupName, accountName, shareName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     * data is of type: {@link module:model/FileShare}
     */
    fileSharesGet(resourceGroupName, accountName, shareName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     * @param {String} [skipToken] Optional. Continuation token for the list operation.
