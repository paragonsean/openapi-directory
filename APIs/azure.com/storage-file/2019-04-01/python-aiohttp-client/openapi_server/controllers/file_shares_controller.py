...
async def file_shares_list(request: web.Request, resource_group_name, account_name, api_version, subscription_id, skip_token=None, maxpagesize=None, filter=None) -> web.Response:
    """file_shares_list
