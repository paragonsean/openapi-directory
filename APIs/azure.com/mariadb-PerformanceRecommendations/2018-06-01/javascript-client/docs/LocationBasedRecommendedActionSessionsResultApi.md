# MariaDbManagementClient.LocationBasedRecommendedActionSessionsResultApi
...
let apiInstance = new MariaDbManagementClient.LocationBasedRecommendedActionSessionsResultApi();
