...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.RecommendationActionsResultList();
  });
  ...
  describe('RecommendationActionsResultList', function() {
    it('should create an instance of RecommendationActionsResultList', function() {
      ...
      //var instance = new MariaDbManagementClient.RecommendationActionsResultList();
      //expect(instance).to.be.a(MariaDbManagementClient.RecommendationActionsResultList);
    });
