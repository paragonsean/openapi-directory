...
OAIClusterIdentity OAICluster::getIdentity() const {
    return m_identity;
}
void OAICluster::setIdentity(const OAIClusterIdentity &identity) {
    m_identity = identity;
...
OAIClusterGetProperties OAICluster::getProperties() const {
    return m_properties;
}
void OAICluster::setProperties(const OAIClusterGetProperties &properties) {
