...
/*
 * OAIAutoscaleCapacity.h
 *
 * The load-based autoscale request parameters
 */

#ifndef OAIAutoscaleCapacity_H
#define OAIAutoscaleCapacity_H
...
class OAIAutoscaleCapacity : public OAIObject {
public:
    OAIAutoscaleCapacity();
    OAIAutoscaleCapacity(QString json);
    ~OAIAutoscaleCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoscaleCapacity)

#endif // OAIAutoscaleCapacity_H
