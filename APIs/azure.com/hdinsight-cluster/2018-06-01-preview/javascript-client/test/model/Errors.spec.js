...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.Errors();
  });
  ...
  describe('Errors', function() {
    it('should create an instance of Errors', function() {
      ...
      //var instance = new HdInsightManagementClient.Errors();
      //expect(instance).to.be.a(HdInsightManagementClient.Errors);
    });
