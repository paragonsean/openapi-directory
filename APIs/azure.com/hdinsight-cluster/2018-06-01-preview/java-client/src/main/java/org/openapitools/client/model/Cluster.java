...
import org.openapitools.client.model.ClusterGetProperties;
...
public class Cluster {
  ...
  public Cluster identity(ClusterIdentity identity) {
  ...
  public Cluster properties(ClusterGetProperties properties) {
   ...
   */
  @javax.annotation.Nullable
  public ClusterGetProperties getProperties() {
    return properties;
  }

  public void setProperties(ClusterGetProperties properties) {
    this.properties = properties;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(etag, identity, properties, location, tags, id, name, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        ClusterGetProperties.validateJsonElement(jsonObj.get("properties"));
      }
