...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.AutoscaleTimeAndCapacity();
  });
  ...
  describe('AutoscaleTimeAndCapacity', function() {
    it('should create an instance of AutoscaleTimeAndCapacity', function() {
      // uncomment below and update the code to test AutoscaleTimeAndCapacity
      //var instance = new HdInsightManagementClient.AutoscaleTimeAndCapacity();
      //expect(instance).to.be.a(HdInsightManagementClient.AutoscaleTimeAndCapacity);
    });
