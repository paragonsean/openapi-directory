...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.Cluster();
  });
  ...
  describe('Cluster', function() {
    it('should create an instance of Cluster', function() {
      ...
      //var instance = new HdInsightManagementClient.Cluster();
      //expect(instance).to.be.a(HdInsightManagementClient.Cluster);
    });
