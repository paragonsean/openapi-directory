...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new HdInsightManagementClient.Resource();
      //expect(instance).to.be.a(HdInsightManagementClient.Resource);
    });
