...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.AutoscaleCapacity();
  });
  ...
  describe('AutoscaleCapacity', function() {
    it('should create an instance of AutoscaleCapacity', function() {
      // uncomment below and update the code to test AutoscaleCapacity
      //var instance = new HdInsightManagementClient.AutoscaleCapacity();
      //expect(instance).to.be.a(HdInsightManagementClient.AutoscaleCapacity);
    });
