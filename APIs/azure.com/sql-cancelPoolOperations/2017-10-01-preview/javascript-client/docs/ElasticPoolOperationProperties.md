# SqlManagementClient.ElasticPoolOperationProperties
...
**elasticPoolName** | **String** | The name of the elastic pool the operation is being performed on. | [optional] [readonly] 
