...
/*
 * OAIElasticPoolOperationProperties.h
 *
 * The properties of a elastic pool operation.
 */

#ifndef OAIElasticPoolOperationProperties_H
#define OAIElasticPoolOperationProperties_H
...
class OAIElasticPoolOperationProperties : public OAIObject {
public:
    OAIElasticPoolOperationProperties();
    OAIElasticPoolOperationProperties(QString json);
    ~OAIElasticPoolOperationProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticPoolOperationProperties)

#endif // OAIElasticPoolOperationProperties_H
