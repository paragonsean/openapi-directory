...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationContract();
  });
  ...
  describe('OperationContract', function() {
    it('should create an instance of OperationContract', function() {
      // uncomment below and update the code to test OperationContract
      //var instance = new ApiManagementClient.OperationContract();
      //expect(instance).to.be.a(ApiManagementClient.OperationContract);
    });
