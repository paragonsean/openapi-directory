# ApiManagementClient.ApiProductsListByApis200ResponseValueInner
...
**state** | **String** | whether product is published or not. Published products are discoverable by users of developer portal. Non published products are visible only to administrators. Default state of Product is NotPublished. | [optional] [default to &#39;NotPublished&#39;]
