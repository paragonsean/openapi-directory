...
public class ApiContract {
  ...
  public ApiContract name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiContract path(String path) {
    this.path = path;
    return this;
  }
  ...
  public ApiContract protocols(List<ProtocolsEnum> protocols) {
    this.protocols = protocols;
    return this;
  }

  public ApiContract addProtocolsItem(ProtocolsEnum protocolsItem) {
  ...
  public ApiContract serviceUrl(String serviceUrl) {
  ...
  public ApiContract authenticationSettings(AuthenticationSettingsContract authenticationSettings) {
  ...
  public ApiContract description(String description) {
  ...
  public ApiContract subscriptionKeyParameterNames(SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames) {
  ...
  public ApiContract type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiContract apiContract = (ApiContract) o;
    return Objects.equals(this.id, apiContract.id) &&
        Objects.equals(this.name, apiContract.name) &&
        Objects.equals(this.path, apiContract.path) &&
        Objects.equals(this.protocols, apiContract.protocols) &&
        Objects.equals(this.serviceUrl, apiContract.serviceUrl) &&
        Objects.equals(this.authenticationSettings, apiContract.authenticationSettings) &&
        Objects.equals(this.description, apiContract.description) &&
        Objects.equals(this.subscriptionKeyParameterNames, apiContract.subscriptionKeyParameterNames) &&
        Objects.equals(this.type, apiContract.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiContract is not found in the empty JSON string", ApiContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiContract.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiContract.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiContract>() {
           @Override
           public void write(JsonWriter out, ApiContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiContract
   * @throws IOException if the JSON string is invalid with respect to ApiContract
   */
  public static ApiContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiContract.class);
  }

  /**
   * Convert an instance of ApiContract to an JSON string
   *
   * @return JSON string
   */
