...
<a id="apiProductsListByApis"></a>
# **apiProductsListByApis**
> ApiProductsListByApis200Response apiProductsListByApis(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, $filter, $top, $skip)
...
import org.openapitools.client.api.ApiProductsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiProductsListByApis200Response result = apiInstance.apiProductsListByApis(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, $filter, $top, $skip);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiProductsApi#apiProductsListByApis");
