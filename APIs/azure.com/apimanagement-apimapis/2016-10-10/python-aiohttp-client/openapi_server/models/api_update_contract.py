...
class ApiUpdateContract(Model):
    ...
    def __init__(self, id: str=None, name: str=None, path: str=None, protocols: List[str]=None, service_url: str=None, authentication_settings: AuthenticationSettingsContract=None, description: str=None, subscription_key_parameter_names: SubscriptionKeyParameterNamesContract=None, type: str=None):
        ...
        :param id: The id of this ApiUpdateContract.
        :param name: The name of this ApiUpdateContract.
        :param path: The path of this ApiUpdateContract.
        :param protocols: The protocols of this ApiUpdateContract.
        :param service_url: The service_url of this ApiUpdateContract.
        :param authentication_settings: The authentication_settings of this ApiUpdateContract.
        :param description: The description of this ApiUpdateContract.
        :param subscription_key_parameter_names: The subscription_key_parameter_names of this ApiUpdateContract.
        :param type: The type of this ApiUpdateContract.
        """
        self.openapi_types = {
            'id': str,
            'name': str,
    ...
    @property
    def id(self):
        """Gets the id of this ApiUpdateContract.

        API identifier path: /apis/{apiId}

        :return: The id of this ApiUpdateContract.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ApiUpdateContract.
    ...
    @property
    def name(self):
        """Gets the name of this ApiUpdateContract.

        API name.

        :return: The name of this ApiUpdateContract.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ApiUpdateContract.
    ...
    @property
    def path(self):
        """Gets the path of this ApiUpdateContract.

        Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.

        :return: The path of this ApiUpdateContract.
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this ApiUpdateContract.
    ...
    @property
    def protocols(self):
        """Gets the protocols of this ApiUpdateContract.

        Describes on which protocols the operations in this API can be invoked.

        :return: The protocols of this ApiUpdateContract.
        :rtype: List[str]
        """
    ...
    def protocols(self, protocols):
        """Sets the protocols of this ApiUpdateContract.
    ...
    def service_url(self):
        """Gets the service_url of this ApiUpdateContract.

        Absolute URL of the backend service implementing this API.

        :return: The service_url of this ApiUpdateContract.
        :rtype: str
        """
    ...
    def service_url(self, service_url):
        """Sets the service_url of this ApiUpdateContract.
    ...
    def authentication_settings(self):
        """Gets the authentication_settings of this ApiUpdateContract.


        :return: The authentication_settings of this ApiUpdateContract.
    ...
    def authentication_settings(self, authentication_settings):
        """Sets the authentication_settings of this ApiUpdateContract.
    ...
    def description(self):
        """Gets the description of this ApiUpdateContract.

        Description of the API. May include HTML formatting tags.

        :return: The description of this ApiUpdateContract.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ApiUpdateContract.
    ...
    def subscription_key_parameter_names(self):
        """Gets the subscription_key_parameter_names of this ApiUpdateContract.


        :return: The subscription_key_parameter_names of this ApiUpdateContract.
    ...
    def subscription_key_parameter_names(self, subscription_key_parameter_names):
        """Sets the subscription_key_parameter_names of this ApiUpdateContract.
    ...
    @property
    def type(self):
        """Gets the type of this ApiUpdateContract.

        Type of API.

        :return: The type of this ApiUpdateContract.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ApiUpdateContract.
