...
async def test_apis_create_or_update(client):
    """Test case for apis_create_or_update

    
    """
    parameters = {"path":"path","name":"name","serviceUrl":"serviceUrl","id":"id","protocols":["Http","Http"]}
...
async def test_apis_delete(client):
...
async def test_apis_get(client):
...
async def test_apis_list_by_service(client):
...
async def test_apis_update(client):
