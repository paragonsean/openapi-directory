...
QString OAIApi_CreateOrUpdate_request_properties::getFormat() const {
    return m_format;
}
void OAIApi_CreateOrUpdate_request_properties::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIApi_CreateOrUpdate_request_properties::is_format_Set() const{
    return m_format_isSet;
}

bool OAIApi_CreateOrUpdate_request_properties::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIApi_CreateOrUpdate_request_properties::getValue() const {
    return m_value;
}
void OAIApi_CreateOrUpdate_request_properties::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIApi_CreateOrUpdate_request_properties::is_value_Set() const{
    return m_value_isSet;
}

bool OAIApi_CreateOrUpdate_request_properties::is_value_Valid() const{
