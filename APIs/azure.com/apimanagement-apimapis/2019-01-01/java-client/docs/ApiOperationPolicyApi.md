...
> ApiOperationPolicyGet200Response apiOperationPolicyGet(resourceGroupName, serviceName, apiId, operationId, policyId, apiVersion, subscriptionId, format)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiOperationPolicyGet200Response result = apiInstance.apiOperationPolicyGet(resourceGroupName, serviceName, apiId, operationId, policyId, apiVersion, subscriptionId, format);
      System.out.println(result);
    } catch (ApiException e) {
