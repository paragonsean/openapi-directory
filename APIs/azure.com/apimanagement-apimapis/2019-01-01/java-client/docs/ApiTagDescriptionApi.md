...
> ApiTagDescriptionGet200Response apiTagDescriptionCreateOrUpdate(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, parameters, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiTagDescriptionGet200Response result = apiInstance.apiTagDescriptionCreateOrUpdate(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, parameters, ifMatch);
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      apiInstance.apiTagDescriptionDelete(resourceGroupName, serviceName, apiId, tagId, ifMatch, apiVersion, subscriptionId);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      ApiTagDescriptionGet200Response result = apiInstance.apiTagDescriptionGet(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      apiInstance.apiTagDescriptionGetEntityTag(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId);
    } catch (ApiException e) {
