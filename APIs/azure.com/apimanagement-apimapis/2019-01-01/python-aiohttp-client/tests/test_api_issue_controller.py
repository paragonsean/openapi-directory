...
async def test_api_issue_create_or_update(client):
    ...
    """
    parameters = openapi_server.ApiIssueGet200Response()
...
async def test_api_issue_get(client):
    ...
    """
    params = [('expandCommentsAttachments', True),
...
async def test_api_issue_list_by_service(client):
    ...
    params = [('$filter', 'filter_example'),
                    ('expandCommentsAttachments', True),
                    ('$top', 56),
                    ('$skip', 56),
                    ('api-version', 'api_version_example')]
    headers = { 
...
async def test_api_issue_update(client):
    ...
    """
    parameters = openapi_server.ApiIssueUpdateRequest()
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
