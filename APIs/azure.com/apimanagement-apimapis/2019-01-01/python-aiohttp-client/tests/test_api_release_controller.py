...
async def test_api_release_create_or_update(client):
    """Test case for api_release_create_or_update

    
    """
    parameters = openapi_server.ApiReleaseGet200Response()
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/apis/{api_id}/releases/{release_id}'.format(resource_group_name='resource_group_name_example', service_name='service_name_example', api_id='api_id_example', release_id='release_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_api_release_list_by_service(client):
