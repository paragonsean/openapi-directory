...
async def api_tag_description_create_or_update(request: web.Request, resource_group_name, service_name, api_id, tag_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
...
async def api_tag_description_delete(request: web.Request, resource_group_name, service_name, api_id, tag_id, if_match, api_version, subscription_id) -> web.Response:
...
async def api_tag_description_get(request: web.Request, resource_group_name, service_name, api_id, tag_id, api_version, subscription_id) -> web.Response:
...
async def api_tag_description_get_entity_tag(request: web.Request, resource_group_name, service_name, api_id, tag_id, api_version, subscription_id) -> web.Response:
