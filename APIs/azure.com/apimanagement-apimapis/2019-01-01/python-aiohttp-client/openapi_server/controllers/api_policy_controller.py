...
async def api_policy_create_or_update(request: web.Request, resource_group_name, service_name, api_id, policy_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
...
async def api_policy_get(request: web.Request, resource_group_name, service_name, api_id, policy_id, api_version, subscription_id, format=None) -> web.Response:
    """api_policy_get
