...
------------- | ------------- | -------------
[**apiTagDescriptionCreateOrUpdate**](ApiTagDescriptionApi.md#apiTagDescriptionCreateOrUpdate) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**apiTagDescriptionDelete**](ApiTagDescriptionApi.md#apiTagDescriptionDelete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**apiTagDescriptionGet**](ApiTagDescriptionApi.md#apiTagDescriptionGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
[**apiTagDescriptionGetEntityTag**](ApiTagDescriptionApi.md#apiTagDescriptionGetEntityTag) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tagDescriptions/{tagId} | 
...
> ApiTagDescriptionGet200Response apiTagDescriptionCreateOrUpdate(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, parameters, opts)
...
apiInstance.apiTagDescriptionCreateOrUpdate(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, parameters, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> apiTagDescriptionDelete(resourceGroupName, serviceName, apiId, tagId, ifMatch, apiVersion, subscriptionId)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.apiTagDescriptionDelete(resourceGroupName, serviceName, apiId, tagId, ifMatch, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ApiTagDescriptionGet200Response apiTagDescriptionGet(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.apiTagDescriptionGet(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> apiTagDescriptionGetEntityTag(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.apiTagDescriptionGetEntityTag(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
