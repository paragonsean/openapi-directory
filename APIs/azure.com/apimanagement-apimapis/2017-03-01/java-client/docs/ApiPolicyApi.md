...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiOperationPolicyGet200Response result = apiInstance.apiPolicyCreateOrUpdate(resourceGroupName, serviceName, apiId, policyId, ifMatch, apiVersion, subscriptionId, parameters);
