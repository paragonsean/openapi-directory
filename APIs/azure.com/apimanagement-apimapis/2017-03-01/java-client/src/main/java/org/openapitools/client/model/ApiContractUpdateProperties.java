...
public class ApiContractUpdateProperties {
  ...
  public ApiContractUpdateProperties authenticationSettings(ApiContractPropertiesAllOfAuthenticationSettings authenticationSettings) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName, path, protocols, serviceUrl, apiRevision, apiVersion, apiVersionSetId, authenticationSettings, description, isCurrent, isOnline, subscriptionKeyParameterNames, type);
  }
