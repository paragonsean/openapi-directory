...
public class OperationUpdateContractProperties {
  ...
  public OperationUpdateContractProperties displayName(String displayName) {
  ...
  public OperationUpdateContractProperties method(String method) {
    this.method = method;
    return this;
  }
  ...
  public OperationUpdateContractProperties urlTemplate(String urlTemplate) {
  ...
  public OperationUpdateContractProperties description(String description) {
  ...
  public OperationUpdateContractProperties policies(String policies) {
  ...
  public OperationUpdateContractProperties request(RequestContract request) {
  ...
  public OperationUpdateContractProperties responses(List<ResponseContract> responses) {
    this.responses = responses;
    return this;
  }

  public OperationUpdateContractProperties addResponsesItem(ResponseContract responsesItem) {
  ...
  public OperationUpdateContractProperties templateParameters(List<ParameterContract> templateParameters) {
    this.templateParameters = templateParameters;
    return this;
  }

  public OperationUpdateContractProperties addTemplateParametersItem(ParameterContract templateParametersItem) {
  ...
  public boolean equals(Object o) {
    ...
    OperationUpdateContractProperties operationUpdateContractProperties = (OperationUpdateContractProperties) o;
    return Objects.equals(this.displayName, operationUpdateContractProperties.displayName) &&
        Objects.equals(this.method, operationUpdateContractProperties.method) &&
        Objects.equals(this.urlTemplate, operationUpdateContractProperties.urlTemplate) &&
        Objects.equals(this.description, operationUpdateContractProperties.description) &&
        Objects.equals(this.policies, operationUpdateContractProperties.policies) &&
        Objects.equals(this.request, operationUpdateContractProperties.request) &&
        Objects.equals(this.responses, operationUpdateContractProperties.responses) &&
        Objects.equals(this.templateParameters, operationUpdateContractProperties.templateParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperationUpdateContractProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OperationUpdateContractProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OperationUpdateContractProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OperationUpdateContractProperties is not found in the empty JSON string", OperationUpdateContractProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OperationUpdateContractProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OperationUpdateContractProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OperationUpdateContractProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OperationUpdateContractProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OperationUpdateContractProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OperationUpdateContractProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<OperationUpdateContractProperties>() {
           @Override
           public void write(JsonWriter out, OperationUpdateContractProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OperationUpdateContractProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OperationUpdateContractProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OperationUpdateContractProperties
   * @throws IOException if the JSON string is invalid with respect to OperationUpdateContractProperties
   */
  public static OperationUpdateContractProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OperationUpdateContractProperties.class);
  }

  /**
   * Convert an instance of OperationUpdateContractProperties to an JSON string
   *
   * @return JSON string
   */
