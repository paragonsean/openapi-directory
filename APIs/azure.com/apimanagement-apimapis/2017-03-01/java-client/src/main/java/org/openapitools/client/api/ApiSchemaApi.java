...
public class ApiSchemaApi {
     ...
     * @param ifMatch The entity state (Etag) version of the Api Schema to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Api schema configuration of the tenant was successfully updated. </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> Api schema configuration was successfully created. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call apiSchemaCreateOrUpdateCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, SchemaContract parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiSchemaCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, SchemaContract parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
     ...
     */
    public SchemaContract apiSchemaCreateOrUpdate(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, SchemaContract parameters, String ifMatch) throws ApiException {
        ApiResponse<SchemaContract> localVarResp = apiSchemaCreateOrUpdateWithHttpInfo(resourceGroupName, serviceName, apiId, schemaId, apiVersion, subscriptionId, parameters, ifMatch);
     ...
     * @param parameters The schema contents to apply. (required)
     * @param ifMatch The entity state (Etag) version of the Api Schema to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. (optional)
     * @return ApiResponse&lt;SchemaContract&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SchemaContract> apiSchemaCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, SchemaContract parameters, String ifMatch) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<SchemaContract>(){}.getType();
     ...
     */
    public okhttp3.Call apiSchemaCreateOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, SchemaContract parameters, String ifMatch, final ApiCallback<SchemaContract> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call apiSchemaDeleteCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String ifMatch, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiSchemaDeleteValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String ifMatch, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return apiSchemaDeleteCall(resourceGroupName, serviceName, apiId, schemaId, ifMatch, apiVersion, subscriptionId, _callback);
     ...
     */
    public void apiSchemaDelete(String resourceGroupName, String serviceName, String apiId, String schemaId, String ifMatch, String apiVersion, String subscriptionId) throws ApiException {
        apiSchemaDeleteWithHttpInfo(resourceGroupName, serviceName, apiId, schemaId, ifMatch, apiVersion, subscriptionId);
    }
     ...
     */
    public ApiResponse<Void> apiSchemaDeleteWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String schemaId, String ifMatch, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = apiSchemaDeleteValidateBeforeCall(resourceGroupName, serviceName, apiId, schemaId, ifMatch, apiVersion, subscriptionId, null);
     ...
     */
    public okhttp3.Call apiSchemaDeleteAsync(String resourceGroupName, String serviceName, String apiId, String schemaId, String ifMatch, String apiVersion, String subscriptionId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiSchemaDeleteValidateBeforeCall(resourceGroupName, serviceName, apiId, schemaId, ifMatch, apiVersion, subscriptionId, _callback);
     ...
     */
    public SchemaContract apiSchemaGet(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<SchemaContract> localVarResp = apiSchemaGetWithHttpInfo(resourceGroupName, serviceName, apiId, schemaId, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SchemaContract> apiSchemaGetWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId) throws ApiException {
     ...
     */
    public okhttp3.Call apiSchemaGetAsync(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, final ApiCallback<SchemaContract> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Apis Schema Collection. </td><td>  * ETag - Current entity state version. Should be treated as opaque and used to make conditional HTTP requests. <br>  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call apiSchemaListByApiCall(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiSchemaListByApiValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return apiSchemaListByApiCall(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, _callback);
     ...
     */
    public SchemaCollection apiSchemaListByApi(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<SchemaCollection> localVarResp = apiSchemaListByApiWithHttpInfo(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;SchemaCollection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SchemaCollection> apiSchemaListByApiWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = apiSchemaListByApiValidateBeforeCall(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<SchemaCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiSchemaListByApiAsync(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, final ApiCallback<SchemaCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiSchemaListByApiValidateBeforeCall(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<SchemaCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
