...
public class ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties() {
  }

  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties evaluationInterval(String evaluationInterval) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties initialPercentage(Double initialPercentage) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties maxPercentage(Double maxPercentage) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties maxTelemetryItemsPerSecond(Integer maxTelemetryItemsPerSecond) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties minPercentage(Double minPercentage) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties movingAverageRatio(Double movingAverageRatio) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties percentage(Double percentage) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties percentageDecreaseTimeout(String percentageDecreaseTimeout) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties percentageIncreaseTimeout(String percentageIncreaseTimeout) {
  ...
  public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties samplingType(SamplingTypeEnum samplingType) {
  ...
  public boolean equals(Object o) {
    ...
    ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties = (ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties) o;
    return Objects.equals(this.evaluationInterval, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.evaluationInterval) &&
        Objects.equals(this.initialPercentage, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.initialPercentage) &&
        Objects.equals(this.maxPercentage, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.maxPercentage) &&
        Objects.equals(this.maxTelemetryItemsPerSecond, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.maxTelemetryItemsPerSecond) &&
        Objects.equals(this.minPercentage, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.minPercentage) &&
        Objects.equals(this.movingAverageRatio, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.movingAverageRatio) &&
        Objects.equals(this.percentage, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.percentage) &&
        Objects.equals(this.percentageDecreaseTimeout, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.percentageDecreaseTimeout) &&
        Objects.equals(this.percentageIncreaseTimeout, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.percentageIncreaseTimeout) &&
        Objects.equals(this.samplingType, apiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.samplingType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties is not found in the empty JSON string", ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties>() {
           @Override
           public void write(JsonWriter out, ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties
   * @throws IOException if the JSON string is invalid with respect to ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties
   */
  public static ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.class);
  }

  /**
   * Convert an instance of ApiDiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties to an JSON string
   *
   * @return JSON string
   */
