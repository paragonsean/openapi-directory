...
public class ApiRevisionContractProperties {
  ...
  public ApiRevisionContractProperties() {
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiRevisionContractProperties apiRevisionContractProperties = (ApiRevisionContractProperties) o;
    return Objects.equals(this.apiId, apiRevisionContractProperties.apiId) &&
        Objects.equals(this.apiRevision, apiRevisionContractProperties.apiRevision) &&
        Objects.equals(this.createdDateTime, apiRevisionContractProperties.createdDateTime) &&
        Objects.equals(this.description, apiRevisionContractProperties.description) &&
        Objects.equals(this.isCurrent, apiRevisionContractProperties.isCurrent) &&
        Objects.equals(this.isOnline, apiRevisionContractProperties.isOnline) &&
        Objects.equals(this.privateUrl, apiRevisionContractProperties.privateUrl) &&
        Objects.equals(this.updatedDateTime, apiRevisionContractProperties.updatedDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiRevisionContractProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiRevisionContractProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiRevisionContractProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiRevisionContractProperties is not found in the empty JSON string", ApiRevisionContractProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiRevisionContractProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiRevisionContractProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiRevisionContractProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiRevisionContractProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiRevisionContractProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiRevisionContractProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiRevisionContractProperties>() {
           @Override
           public void write(JsonWriter out, ApiRevisionContractProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiRevisionContractProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiRevisionContractProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiRevisionContractProperties
   * @throws IOException if the JSON string is invalid with respect to ApiRevisionContractProperties
   */
  public static ApiRevisionContractProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiRevisionContractProperties.class);
  }

  /**
   * Convert an instance of ApiRevisionContractProperties to an JSON string
   *
   * @return JSON string
   */
