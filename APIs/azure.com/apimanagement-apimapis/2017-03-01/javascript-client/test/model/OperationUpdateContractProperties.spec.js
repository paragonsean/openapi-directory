...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationUpdateContractProperties();
  });
  ...
  describe('OperationUpdateContractProperties', function() {
    it('should create an instance of OperationUpdateContractProperties', function() {
      // uncomment below and update the code to test OperationUpdateContractProperties
      //var instance = new ApiManagementClient.OperationUpdateContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.OperationUpdateContractProperties);
    });
