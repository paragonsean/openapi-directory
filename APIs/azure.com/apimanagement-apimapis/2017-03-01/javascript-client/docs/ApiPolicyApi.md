...
> ApiOperationPolicyGet200Response apiPolicyCreateOrUpdate(resourceGroupName, serviceName, apiId, policyId, ifMatch, apiVersion, subscriptionId, parameters)
...
apiInstance.apiPolicyCreateOrUpdate(resourceGroupName, serviceName, apiId, policyId, ifMatch, apiVersion, subscriptionId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
