# ApiManagementClient.ApiProductApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**apiProductListByApis**](ApiProductApi.md#apiProductListByApis) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/products | 



## apiProductListByApis

> ApiProductListByApis200Response apiProductListByApis(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, opts)
...
let apiInstance = new ApiManagementClient.ApiProductApi();
...
apiInstance.apiProductListByApis(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
