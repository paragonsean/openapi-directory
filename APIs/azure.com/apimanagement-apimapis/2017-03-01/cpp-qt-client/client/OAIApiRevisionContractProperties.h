...
/*
 * OAIApiRevisionContractProperties.h
 *
 * Summary of revision metadata.
 */

#ifndef OAIApiRevisionContractProperties_H
#define OAIApiRevisionContractProperties_H
...
class OAIApiRevisionContractProperties : public OAIObject {
public:
    OAIApiRevisionContractProperties();
    OAIApiRevisionContractProperties(QString json);
    ~OAIApiRevisionContractProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiRevisionContractProperties)

#endif // OAIApiRevisionContractProperties_H
