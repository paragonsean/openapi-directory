...
QString OAIApiEntityBaseContract::getApiRevision() const {
    return m_api_revision;
}
void OAIApiEntityBaseContract::setApiRevision(const QString &api_revision) {
    m_api_revision = api_revision;
    m_api_revision_isSet = true;
}

bool OAIApiEntityBaseContract::is_api_revision_Set() const{
    return m_api_revision_isSet;
}

bool OAIApiEntityBaseContract::is_api_revision_Valid() const{
    return m_api_revision_isValid;
}

QString OAIApiEntityBaseContract::getApiVersion() const {
    return m_api_version;
}
void OAIApiEntityBaseContract::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIApiEntityBaseContract::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIApiEntityBaseContract::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QString OAIApiEntityBaseContract::getApiVersionSetId() const {
    return m_api_version_set_id;
}
void OAIApiEntityBaseContract::setApiVersionSetId(const QString &api_version_set_id) {
    m_api_version_set_id = api_version_set_id;
    m_api_version_set_id_isSet = true;
}

bool OAIApiEntityBaseContract::is_api_version_set_id_Set() const{
    return m_api_version_set_id_isSet;
}

bool OAIApiEntityBaseContract::is_api_version_set_id_Valid() const{
    return m_api_version_set_id_isValid;
}

OAIApiContractProperties_allOf_authenticationSettings OAIApiEntityBaseContract::getAuthenticationSettings() const {
    return m_authentication_settings;
}
void OAIApiEntityBaseContract::setAuthenticationSettings(const OAIApiContractProperties_allOf_authenticationSettings &authentication_settings) {
...
bool OAIApiEntityBaseContract::isIsCurrent() const {
    return m_is_current;
}
void OAIApiEntityBaseContract::setIsCurrent(const bool &is_current) {
    m_is_current = is_current;
    m_is_current_isSet = true;
}

bool OAIApiEntityBaseContract::is_is_current_Set() const{
    return m_is_current_isSet;
}

bool OAIApiEntityBaseContract::is_is_current_Valid() const{
    return m_is_current_isValid;
}

bool OAIApiEntityBaseContract::isIsOnline() const {
    return m_is_online;
}
void OAIApiEntityBaseContract::setIsOnline(const bool &is_online) {
    m_is_online = is_online;
    m_is_online_isSet = true;
}

bool OAIApiEntityBaseContract::is_is_online_Set() const{
    return m_is_online_isSet;
}

bool OAIApiEntityBaseContract::is_is_online_Valid() const{
    return m_is_online_isValid;
}

OAIApiEntityBaseContract_subscriptionKeyParameterNames OAIApiEntityBaseContract::getSubscriptionKeyParameterNames() const {
    return m_subscription_key_parameter_names;
}
void OAIApiEntityBaseContract::setSubscriptionKeyParameterNames(const OAIApiEntityBaseContract_subscriptionKeyParameterNames &subscription_key_parameter_names) {
