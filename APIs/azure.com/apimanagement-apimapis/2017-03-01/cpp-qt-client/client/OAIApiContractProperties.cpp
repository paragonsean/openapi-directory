...
OAIObject OAIApiContractProperties::getApiVersionSet() const {
    return m_api_version_set;
}
void OAIApiContractProperties::setApiVersionSet(const OAIObject &api_version_set) {
...
OAIApiContractProperties_allOf_authenticationSettings OAIApiContractProperties::getAuthenticationSettings() const {
    return m_authentication_settings;
}
void OAIApiContractProperties::setAuthenticationSettings(const OAIApiContractProperties_allOf_authenticationSettings &authentication_settings) {
...
OAIApiContractProperties_allOf_subscriptionKeyParameterNames OAIApiContractProperties::getSubscriptionKeyParameterNames() const {
    return m_subscription_key_parameter_names;
}
void OAIApiContractProperties::setSubscriptionKeyParameterNames(const OAIApiContractProperties_allOf_subscriptionKeyParameterNames &subscription_key_parameter_names) {
