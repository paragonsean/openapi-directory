...
/*
 * OAIResponseContract.h
 *
 * Operation response details.
 */

#ifndef OAIResponseContract_H
#define OAIResponseContract_H
...
class OAIResponseContract : public OAIObject {
public:
    OAIResponseContract();
    OAIResponseContract(QString json);
    ~OAIResponseContract() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseContract)

#endif // OAIResponseContract_H
