...
OAIApi_ListByTags_200_response_value_inner_properties_api_properties_apiVersionSet_properties OAIApiRevisionInfoContract::getApiVersionSet() const {
    return m_api_version_set;
}
void OAIApiRevisionInfoContract::setApiVersionSet(const OAIApi_ListByTags_200_response_value_inner_properties_api_properties_apiVersionSet_properties &api_version_set) {
