...
/*
 * OAIIssueContractProperties.h
 *
 * Issue contract Properties.
 */

#ifndef OAIIssueContractProperties_H
#define OAIIssueContractProperties_H
...
class OAIIssueContractProperties : public OAIObject {
public:
    OAIIssueContractProperties();
    OAIIssueContractProperties(QString json);
    ~OAIIssueContractProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueContractProperties)

#endif // OAIIssueContractProperties_H
