...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void apiDelete(const QString &resource_group_name, const QString &service_name, const QString &api_id, const QString &if_match, const QString &api_version, const QString &subscription_id);
