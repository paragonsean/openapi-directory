...
async def test_api_create_or_update(client):
    ...
    """
    parameters = {"properties":{"contentValue":"contentValue","contentFormat":"wadl-xml","wsdlSelector":"{}"}}
...
async def test_api_update(client):
    ...
    """
    parameters = {"properties":{"path":"path","displayName":"displayName","serviceUrl":"serviceUrl","protocols":["http","http"]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
