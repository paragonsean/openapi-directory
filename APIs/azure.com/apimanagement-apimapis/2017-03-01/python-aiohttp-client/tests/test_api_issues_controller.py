...
async def test_api_issue_create_or_update(client):
    ...
    """
    parameters = {"properties":{"createdDate":"2000-01-23T04:56:07.000+00:00","description":"description","state":"proposed","title":"title","userId":"userId","apiId":"apiId"}}
...
async def test_api_issue_head(client):
...
async def test_api_issues_list_by_service(client):
