...
class ApiRevisionInfoContract(Model):
    ...
    def __init__(self, api_revision_description: str=None, api_version_name: str=None, api_version_set: ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSetProperties=None, source_api_id: str=None):
        ...
        self.openapi_types = {
            ...
            'api_version_set': ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSetProperties,
            'source_api_id': str
        }
    ...
    def api_version_set(self, api_version_set):
        ...
        :param api_version_set: The api_version_set of this ApiRevisionInfoContract.
        :type api_version_set: ApiListByTags200ResponseValueInnerPropertiesApiPropertiesApiVersionSetProperties
        """
