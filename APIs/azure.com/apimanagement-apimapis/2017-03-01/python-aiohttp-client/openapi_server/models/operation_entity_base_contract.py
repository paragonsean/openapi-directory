...
class OperationEntityBaseContract(Model):
    ...
    def __init__(self, description: str=None, policies: str=None, request: RequestContract=None, responses: List[ResponseContract]=None, template_parameters: List[ParameterContract]=None):
        ...
        :param policies: The policies of this OperationEntityBaseContract.
    ...
    @property
    def policies(self):
        """Gets the policies of this OperationEntityBaseContract.

        Operation Policies

        :return: The policies of this OperationEntityBaseContract.
        :rtype: str
        """
    ...
    def policies(self, policies):
        """Sets the policies of this OperationEntityBaseContract.
