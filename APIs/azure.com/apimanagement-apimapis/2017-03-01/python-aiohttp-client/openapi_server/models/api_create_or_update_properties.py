...
class ApiCreateOrUpdateProperties(Model):
    ...
    def __init__(self, content_format: str=None, content_value: str=None, wsdl_selector: object=None, api_version_set: object=None, display_name: str=None, path: str=None, protocols: List[str]=None, service_url: str=None, api_revision: str=None, api_version: str=None, api_version_set_id: str=None, authentication_settings: ApiContractPropertiesAllOfAuthenticationSettings=None, description: str=None, is_current: bool=None, is_online: bool=None, subscription_key_parameter_names: ApiContractPropertiesAllOfSubscriptionKeyParameterNames=None, type: str=None):
        ...
        self.openapi_types = {
            ...
            'is_current': bool,
            'is_online': bool,
            'subscription_key_parameter_names': ApiContractPropertiesAllOfSubscriptionKeyParameterNames,
            'type': str
        }
    ...
    def subscription_key_parameter_names(self):
        ...
        :rtype: ApiContractPropertiesAllOfSubscriptionKeyParameterNames
        """
    ...
    def subscription_key_parameter_names(self, subscription_key_parameter_names):
        ...
        :param subscription_key_parameter_names: The subscription_key_parameter_names of this ApiCreateOrUpdateProperties.
        :type subscription_key_parameter_names: ApiContractPropertiesAllOfSubscriptionKeyParameterNames
        """
