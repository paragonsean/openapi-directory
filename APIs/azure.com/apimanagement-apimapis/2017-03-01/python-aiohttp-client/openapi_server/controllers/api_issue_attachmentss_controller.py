...
async def api_issu_attachment_head(request: web.Request, resource_group_name, service_name, api_id, issue_id, attachment_id, api_version, subscription_id) -> web.Response:
