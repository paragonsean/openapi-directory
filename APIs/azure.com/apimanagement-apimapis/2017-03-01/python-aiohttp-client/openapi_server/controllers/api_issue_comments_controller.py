...
async def api_issue_comments_list_by_service(request: web.Request, resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=None, top=None, skip=None) -> web.Response:
    """api_issue_comments_list_by_service
