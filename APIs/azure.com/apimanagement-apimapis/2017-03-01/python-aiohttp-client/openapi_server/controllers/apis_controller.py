...
async def api_create_or_update(request: web.Request, resource_group_name, service_name, api_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    ...
    """
    parameters = ApiCreateOrUpdateParameter.from_dict(parameters)
    return web.Response(status=200)


async def api_delete(request: web.Request, resource_group_name, service_name, api_id, if_match, api_version, subscription_id) -> web.Response:
    """api_delete
...
async def api_list_by_service(request: web.Request, resource_group_name, service_name, api_version, subscription_id, filter=None, top=None, skip=None, expand_api_version_set=None) -> web.Response:
    """api_list_by_service
