...
async def api_operation_policy_create_or_update(request: web.Request, resource_group_name, service_name, api_id, operation_id, policy_id, if_match, api_version, subscription_id, parameters) -> web.Response:
...
async def api_operation_policy_delete(request: web.Request, resource_group_name, service_name, api_id, operation_id, if_match, policy_id, api_version, subscription_id) -> web.Response:
    ...
    :param operation_id: Operation identifier within an API. Must be unique in the current API Management service instance.
    :type operation_id: str
    :param if_match: The entity state (Etag) version of the Api Operation Policy to delete. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation.
    :type if_match: str
    :param policy_id: The identifier of the Policy.
    :type policy_id: str
    :param api_version: Version of the API to be used with the client request.
