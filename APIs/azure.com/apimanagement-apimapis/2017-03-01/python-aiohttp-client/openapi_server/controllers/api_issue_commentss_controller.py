...
async def api_issu_comment_head(request: web.Request, resource_group_name, service_name, api_id, issue_id, comment_id, api_version, subscription_id) -> web.Response:
    """api_issu_comment_head
