...
async def api_issue_list_by_service(request: web.Request, resource_group_name, service_name, api_id, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
...
async def api_issue_update(request: web.Request, resource_group_name, service_name, api_id, issue_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    """api_issue_update
    ...
    """
    parameters = IssueUpdateContract.from_dict(parameters)
    return web.Response(status=200)
