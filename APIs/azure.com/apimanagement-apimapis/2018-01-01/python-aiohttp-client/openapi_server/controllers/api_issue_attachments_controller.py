...
async def api_issue_attachment_create_or_update(request: web.Request, resource_group_name, service_name, api_id, issue_id, attachment_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    ...
    """
    parameters = IssueAttachmentContract.from_dict(parameters)
...
async def api_issue_attachment_list_by_service(request: web.Request, resource_group_name, service_name, api_id, api_version, issue_id, subscription_id, filter=None, top=None, skip=None) -> web.Response:
