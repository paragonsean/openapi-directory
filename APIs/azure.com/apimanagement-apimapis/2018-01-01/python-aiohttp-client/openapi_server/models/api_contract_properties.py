...
class ApiContractProperties(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, api_version_set: ApiVersionSetContractDetails=None, display_name: str=None, path: str=None, protocols: List[str]=None, service_url: str=None, api_revision: str=None, api_revision_description: str=None, api_version: str=None, api_version_description: str=None, api_version_set_id: str=None, authentication_settings: ApiEntityBaseContractAuthenticationSettings=None, description: str=None, is_current: bool=None, is_online: bool=None, subscription_key_parameter_names: ApiEntityBaseContractSubscriptionKeyParameterNames=None, type: str=None):
        """ApiContractProperties - a model defined in OpenAPI

        :param api_version_set: The api_version_set of this ApiContractProperties.
        :param display_name: The display_name of this ApiContractProperties.
        :param path: The path of this ApiContractProperties.
        :param protocols: The protocols of this ApiContractProperties.
        :param service_url: The service_url of this ApiContractProperties.
        :param api_revision: The api_revision of this ApiContractProperties.
        :param api_revision_description: The api_revision_description of this ApiContractProperties.
        :param api_version: The api_version of this ApiContractProperties.
        :param api_version_description: The api_version_description of this ApiContractProperties.
        :param api_version_set_id: The api_version_set_id of this ApiContractProperties.
        :param authentication_settings: The authentication_settings of this ApiContractProperties.
        :param description: The description of this ApiContractProperties.
        :param is_current: The is_current of this ApiContractProperties.
        :param is_online: The is_online of this ApiContractProperties.
        :param subscription_key_parameter_names: The subscription_key_parameter_names of this ApiContractProperties.
        :param type: The type of this ApiContractProperties.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ApiContractProperties':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ApiContractProperties of this ApiContractProperties.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def api_version_set(self):
        """Gets the api_version_set of this ApiContractProperties.


        :return: The api_version_set of this ApiContractProperties.
    ...
    def api_version_set(self, api_version_set):
        """Sets the api_version_set of this ApiContractProperties.
    ...
    def display_name(self):
        """Gets the display_name of this ApiContractProperties.

        API name.

        :return: The display_name of this ApiContractProperties.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this ApiContractProperties.
    ...
    @property
    def path(self):
        """Gets the path of this ApiContractProperties.

        Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.

        :return: The path of this ApiContractProperties.
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this ApiContractProperties.
    ...
    @property
    def protocols(self):
        """Gets the protocols of this ApiContractProperties.

        Describes on which protocols the operations in this API can be invoked.

        :return: The protocols of this ApiContractProperties.
        :rtype: List[str]
        """
    ...
    def protocols(self, protocols):
        """Sets the protocols of this ApiContractProperties.
    ...
    def service_url(self):
        """Gets the service_url of this ApiContractProperties.

        Absolute URL of the backend service implementing this API.

        :return: The service_url of this ApiContractProperties.
        :rtype: str
        """
    ...
    def service_url(self, service_url):
        """Sets the service_url of this ApiContractProperties.
    ...
    def api_revision(self):
        """Gets the api_revision of this ApiContractProperties.

        Describes the Revision of the Api. If no value is provided, default revision 1 is created

        :return: The api_revision of this ApiContractProperties.
        :rtype: str
        """
    ...
    def api_revision(self, api_revision):
        """Sets the api_revision of this ApiContractProperties.
    ...
    def api_revision_description(self):
        """Gets the api_revision_description of this ApiContractProperties.

        Description of the Api Revision.

        :return: The api_revision_description of this ApiContractProperties.
        :rtype: str
        """
    ...
    def api_revision_description(self, api_revision_description):
        """Sets the api_revision_description of this ApiContractProperties.
    ...
    def api_version(self):
        """Gets the api_version of this ApiContractProperties.

        Indicates the Version identifier of the API if the API is versioned

        :return: The api_version of this ApiContractProperties.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """Sets the api_version of this ApiContractProperties.
    ...
    def api_version_description(self):
        """Gets the api_version_description of this ApiContractProperties.

        Description of the Api Version.

        :return: The api_version_description of this ApiContractProperties.
        :rtype: str
        """
    ...
    def api_version_description(self, api_version_description):
        """Sets the api_version_description of this ApiContractProperties.
    ...
    def api_version_set_id(self):
        """Gets the api_version_set_id of this ApiContractProperties.

        A resource identifier for the related ApiVersionSet.

        :return: The api_version_set_id of this ApiContractProperties.
        :rtype: str
        """
    ...
    def api_version_set_id(self, api_version_set_id):
        """Sets the api_version_set_id of this ApiContractProperties.
    ...
    def authentication_settings(self):
        """Gets the authentication_settings of this ApiContractProperties.


        :return: The authentication_settings of this ApiContractProperties.
    ...
    def authentication_settings(self, authentication_settings):
        """Sets the authentication_settings of this ApiContractProperties.
    ...
    def description(self):
        """Gets the description of this ApiContractProperties.

        Description of the API. May include HTML formatting tags.

        :return: The description of this ApiContractProperties.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ApiContractProperties.
    ...
    @property
    def is_current(self):
        """Gets the is_current of this ApiContractProperties.

        Indicates if API revision is current api revision.

        :return: The is_current of this ApiContractProperties.
        :rtype: bool
        """
    ...
    def is_current(self, is_current):
        """Sets the is_current of this ApiContractProperties.
    ...
    @property
    def is_online(self):
        """Gets the is_online of this ApiContractProperties.

        Indicates if API revision is accessible via the gateway.

        :return: The is_online of this ApiContractProperties.
        :rtype: bool
        """
    ...
    def is_online(self, is_online):
        """Sets the is_online of this ApiContractProperties.
    ...
    def subscription_key_parameter_names(self):
        """Gets the subscription_key_parameter_names of this ApiContractProperties.


        :return: The subscription_key_parameter_names of this ApiContractProperties.
    ...
    def subscription_key_parameter_names(self, subscription_key_parameter_names):
        """Sets the subscription_key_parameter_names of this ApiContractProperties.
    ...
    @property
    def type(self):
        """Gets the type of this ApiContractProperties.

        Type of API.

        :return: The type of this ApiContractProperties.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ApiContractProperties.
