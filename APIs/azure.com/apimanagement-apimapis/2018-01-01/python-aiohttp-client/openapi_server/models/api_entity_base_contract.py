...
class ApiEntityBaseContract(Model):
    ...
    def __init__(self, api_revision: str=None, api_revision_description: str=None, api_version: str=None, api_version_description: str=None, api_version_set_id: str=None, authentication_settings: ApiEntityBaseContractAuthenticationSettings=None, description: str=None, is_current: bool=None, is_online: bool=None, subscription_key_parameter_names: ApiEntityBaseContractSubscriptionKeyParameterNames=None, type: str=None):
        """ApiEntityBaseContract - a model defined in OpenAPI

        :param api_revision: The api_revision of this ApiEntityBaseContract.
        :param api_revision_description: The api_revision_description of this ApiEntityBaseContract.
        :param api_version: The api_version of this ApiEntityBaseContract.
        :param api_version_description: The api_version_description of this ApiEntityBaseContract.
    ...
    def api_revision_description(self):
        """Gets the api_revision_description of this ApiEntityBaseContract.

        Description of the Api Revision.

        :return: The api_revision_description of this ApiEntityBaseContract.
        :rtype: str
        """
    ...
    def api_revision_description(self, api_revision_description):
        """Sets the api_revision_description of this ApiEntityBaseContract.
    ...
    def api_version_description(self):
        """Gets the api_version_description of this ApiEntityBaseContract.

        Description of the Api Version.

        :return: The api_version_description of this ApiEntityBaseContract.
        :rtype: str
        """
    ...
    def api_version_description(self, api_version_description):
        """Sets the api_version_description of this ApiEntityBaseContract.
