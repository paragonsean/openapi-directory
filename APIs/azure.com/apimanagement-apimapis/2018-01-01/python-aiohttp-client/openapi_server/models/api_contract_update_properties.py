...
class ApiContractUpdateProperties(Model):
    ...
    def __init__(self, display_name: str=None, path: str=None, protocols: List[str]=None, service_url: str=None, api_revision: str=None, api_revision_description: str=None, api_version: str=None, api_version_description: str=None, api_version_set_id: str=None, authentication_settings: ApiEntityBaseContractAuthenticationSettings=None, description: str=None, is_current: bool=None, is_online: bool=None, subscription_key_parameter_names: ApiEntityBaseContractSubscriptionKeyParameterNames=None, type: str=None):
        ...
        :param api_revision_description: The api_revision_description of this ApiContractUpdateProperties.
        :param api_version: The api_version of this ApiContractUpdateProperties.
        :param api_version_description: The api_version_description of this ApiContractUpdateProperties.
    ...
    def api_revision_description(self):
        """Gets the api_revision_description of this ApiContractUpdateProperties.

        Description of the Api Revision.

        :return: The api_revision_description of this ApiContractUpdateProperties.
        :rtype: str
        """
    ...
    def api_revision_description(self, api_revision_description):
        """Sets the api_revision_description of this ApiContractUpdateProperties.
    ...
    def api_version_description(self):
        """Gets the api_version_description of this ApiContractUpdateProperties.

        Description of the Api Version.

        :return: The api_version_description of this ApiContractUpdateProperties.
        :rtype: str
        """
    ...
    def api_version_description(self, api_version_description):
        """Sets the api_version_description of this ApiContractUpdateProperties.
