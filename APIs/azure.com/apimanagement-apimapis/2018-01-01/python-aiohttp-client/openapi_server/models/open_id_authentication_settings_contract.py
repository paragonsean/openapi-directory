...
class OpenIdAuthenticationSettingsContract(Model):
    ...
    def __init__(self, bearer_token_sending_methods: List[str]=None, openid_provider_id: str=None):
        """OpenIdAuthenticationSettingsContract - a model defined in OpenAPI

        :param bearer_token_sending_methods: The bearer_token_sending_methods of this OpenIdAuthenticationSettingsContract.
        :param openid_provider_id: The openid_provider_id of this OpenIdAuthenticationSettingsContract.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OpenIdAuthenticationSettingsContract':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OpenIdAuthenticationSettingsContract of this OpenIdAuthenticationSettingsContract.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bearer_token_sending_methods(self):
        """Gets the bearer_token_sending_methods of this OpenIdAuthenticationSettingsContract.

        How to send token to the server.

        :return: The bearer_token_sending_methods of this OpenIdAuthenticationSettingsContract.
        :rtype: List[str]
        """
    ...
    def bearer_token_sending_methods(self, bearer_token_sending_methods):
        """Sets the bearer_token_sending_methods of this OpenIdAuthenticationSettingsContract.
    ...
    def openid_provider_id(self):
        """Gets the openid_provider_id of this OpenIdAuthenticationSettingsContract.

        OAuth authorization server identifier.

        :return: The openid_provider_id of this OpenIdAuthenticationSettingsContract.
        :rtype: str
        """
    ...
    def openid_provider_id(self, openid_provider_id):
        """Sets the openid_provider_id of this OpenIdAuthenticationSettingsContract.
