# ApiManagementClient.ReleasesApi
...
let apiInstance = new ApiManagementClient.ReleasesApi();
...
let parameters = new ApiManagementClient.ApiReleaseContract(); // ApiReleaseContract | Create parameters.
apiInstance.apiReleaseCreate(resourceGroupName, serviceName, apiVersion, subscriptionId, apiId, releaseId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.apiReleaseDelete(resourceGroupName, serviceName, apiVersion, subscriptionId, apiId, releaseId, ifMatch, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiId = "apiId_example"; // String | API identifier. Must be unique in the current API Management service instance.
let releaseId = "releaseId_example"; // String | Release identifier within an API. Must be unique in the current API Management service instance.
apiInstance.apiReleaseGet(resourceGroupName, serviceName, apiVersion, subscriptionId, apiId, releaseId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiId = "apiId_example"; // String | API identifier. Must be unique in the current API Management service instance.
let releaseId = "releaseId_example"; // String | Release identifier within an API. Must be unique in the current API Management service instance.
apiInstance.apiReleaseGetEntityTag(resourceGroupName, serviceName, apiVersion, subscriptionId, apiId, releaseId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> ApiReleaseCollection apiReleaseList(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, opts)
...
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let opts = {
  'filter': "filter_example", // String | | Field | Supported operators    | Supported functions                         | |-------|------------------------|---------------------------------------------| | name  | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | |notes|ge le eq ne gt lt|substringof contains startswith endswith|
...
let releaseId = "releaseId_example"; // String | Release identifier within an API. Must be unique in the current API Management service instance.
let ifMatch = "ifMatch_example"; // String | ETag of the Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update.
let parameters = new ApiManagementClient.ApiReleaseContract(); // ApiReleaseContract | API Release Update parameters.
apiInstance.apiReleaseUpdate(resourceGroupName, serviceName, apiVersion, subscriptionId, apiId, releaseId, ifMatch, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
