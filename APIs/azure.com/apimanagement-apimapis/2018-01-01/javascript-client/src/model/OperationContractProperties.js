...
/**
 * The OperationContractProperties model module.
 * @module model/OperationContractProperties
 * @version 2018-01-01
 */
class OperationContractProperties {
    /**
     * Constructs a new <code>OperationContractProperties</code>.
     * Operation Contract Properties
     * @alias module:model/OperationContractProperties
     * @implements module:model/OperationEntityBaseContract
     */
    constructor() { 
        OperationEntityBaseContract.initialize(this);
        OperationContractProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OperationContractProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OperationContractProperties} obj Optional instance to populate.
     * @return {module:model/OperationContractProperties} The populated <code>OperationContractProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationContractProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>OperationContractProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OperationContractProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OperationContractProperties.RequiredProperties) {
...
OperationContractProperties.RequiredProperties = ["displayName", "method", "urlTemplate"];

/**
 * Operation Name.
 * @member {String} displayName
 */
OperationContractProperties.prototype['displayName'] = undefined;

/**
 * A Valid HTTP Operation Method. Typical Http Methods like GET, PUT, POST but not limited by only them.
 * @member {String} method
 */
OperationContractProperties.prototype['method'] = undefined;

/**
 * Relative URL template identifying the target resource for this operation. May include parameters. Example: /customers/{cid}/orders/{oid}/?date={date}
 * @member {String} urlTemplate
 */
OperationContractProperties.prototype['urlTemplate'] = undefined;

/**
 * Description of the operation. May include HTML formatting tags.
 * @member {String} description
 */
OperationContractProperties.prototype['description'] = undefined;

/**
 * Operation Policies
 * @member {String} policies
 */
OperationContractProperties.prototype['policies'] = undefined;

/**
 * @member {module:model/RequestContract} request
 */
OperationContractProperties.prototype['request'] = undefined;

/**
 * Array of Operation responses.
 * @member {Array.<module:model/ResponseContract>} responses
 */
OperationContractProperties.prototype['responses'] = undefined;

/**
 * Collection of URL template parameters.
 * @member {Array.<module:model/ParameterContract>} templateParameters
 */
OperationContractProperties.prototype['templateParameters'] = undefined;
...
export default OperationContractProperties;
