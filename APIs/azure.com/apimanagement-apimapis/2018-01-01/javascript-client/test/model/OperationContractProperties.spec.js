...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationContractProperties();
  });
  ...
  describe('OperationContractProperties', function() {
    it('should create an instance of OperationContractProperties', function() {
      // uncomment below and update the code to test OperationContractProperties
      //var instance = new ApiManagementClient.OperationContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.OperationContractProperties);
    });
