...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiRevisionContract();
  });
  ...
  describe('ApiRevisionContract', function() {
    it('should create an instance of ApiRevisionContract', function() {
      // uncomment below and update the code to test ApiRevisionContract
      //var instance = new ApiManagementClient.ApiRevisionContract();
      //expect(instance).to.be.a(ApiManagementClient.ApiRevisionContract);
    });
