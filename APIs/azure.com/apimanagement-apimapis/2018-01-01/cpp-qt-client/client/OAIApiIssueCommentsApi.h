...
Q_SIGNALS:
    ...
    void apiIssueCommentListByServiceSignal(OAIIssueCommentCollection summary);
    ...
    void apiIssueCommentListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIIssueCommentCollection summary);
    ...
    void apiIssueCommentListByServiceSignalE(OAIIssueCommentCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiIssueCommentListByServiceSignalError(OAIIssueCommentCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
