...
/*
 * OAIIssueContractBaseProperties.h
 *
 * Issue contract Base Properties.
 */

#ifndef OAIIssueContractBaseProperties_H
#define OAIIssueContractBaseProperties_H
...
class OAIIssueContractBaseProperties : public OAIObject {
public:
    OAIIssueContractBaseProperties();
    OAIIssueContractBaseProperties(QString json);
    ~OAIIssueContractBaseProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueContractBaseProperties)

#endif // OAIIssueContractBaseProperties_H
