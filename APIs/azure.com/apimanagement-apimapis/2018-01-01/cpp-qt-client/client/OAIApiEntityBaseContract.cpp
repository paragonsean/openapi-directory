...
QString OAIApiEntityBaseContract::getApiRevisionDescription() const {
    return m_api_revision_description;
}
void OAIApiEntityBaseContract::setApiRevisionDescription(const QString &api_revision_description) {
    m_api_revision_description = api_revision_description;
    m_api_revision_description_isSet = true;
}

bool OAIApiEntityBaseContract::is_api_revision_description_Set() const{
    return m_api_revision_description_isSet;
}

bool OAIApiEntityBaseContract::is_api_revision_description_Valid() const{
...
QString OAIApiEntityBaseContract::getApiVersionDescription() const {
    return m_api_version_description;
}
void OAIApiEntityBaseContract::setApiVersionDescription(const QString &api_version_description) {
    m_api_version_description = api_version_description;
    m_api_version_description_isSet = true;
}

bool OAIApiEntityBaseContract::is_api_version_description_Set() const{
    return m_api_version_description_isSet;
}

bool OAIApiEntityBaseContract::is_api_version_description_Valid() const{
...
OAIApiEntityBaseContract_authenticationSettings OAIApiEntityBaseContract::getAuthenticationSettings() const {
    return m_authentication_settings;
}
void OAIApiEntityBaseContract::setAuthenticationSettings(const OAIApiEntityBaseContract_authenticationSettings &authentication_settings) {
