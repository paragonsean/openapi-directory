...
QString OAIApiCreateOrUpdateProperties::getApiType() const {
    return m_api_type;
}
void OAIApiCreateOrUpdateProperties::setApiType(const QString &api_type) {
    m_api_type = api_type;
    m_api_type_isSet = true;
}

bool OAIApiCreateOrUpdateProperties::is_api_type_Set() const{
    return m_api_type_isSet;
}

bool OAIApiCreateOrUpdateProperties::is_api_type_Valid() const{
...
OAIApiVersionSetContractDetails OAIApiCreateOrUpdateProperties::getApiVersionSet() const {
    return m_api_version_set;
}
void OAIApiCreateOrUpdateProperties::setApiVersionSet(const OAIApiVersionSetContractDetails &api_version_set) {
...
QString OAIApiCreateOrUpdateProperties::getApiRevisionDescription() const {
    return m_api_revision_description;
}
void OAIApiCreateOrUpdateProperties::setApiRevisionDescription(const QString &api_revision_description) {
    m_api_revision_description = api_revision_description;
    m_api_revision_description_isSet = true;
}

bool OAIApiCreateOrUpdateProperties::is_api_revision_description_Set() const{
    return m_api_revision_description_isSet;
}

bool OAIApiCreateOrUpdateProperties::is_api_revision_description_Valid() const{
...
QString OAIApiCreateOrUpdateProperties::getApiVersionDescription() const {
    return m_api_version_description;
}
void OAIApiCreateOrUpdateProperties::setApiVersionDescription(const QString &api_version_description) {
    m_api_version_description = api_version_description;
    m_api_version_description_isSet = true;
}

bool OAIApiCreateOrUpdateProperties::is_api_version_description_Set() const{
    return m_api_version_description_isSet;
}

bool OAIApiCreateOrUpdateProperties::is_api_version_description_Valid() const{
...
OAIApiEntityBaseContract_authenticationSettings OAIApiCreateOrUpdateProperties::getAuthenticationSettings() const {
    return m_authentication_settings;
}
void OAIApiCreateOrUpdateProperties::setAuthenticationSettings(const OAIApiEntityBaseContract_authenticationSettings &authentication_settings) {
...
OAIApiEntityBaseContract_subscriptionKeyParameterNames OAIApiCreateOrUpdateProperties::getSubscriptionKeyParameterNames() const {
    return m_subscription_key_parameter_names;
}
void OAIApiCreateOrUpdateProperties::setSubscriptionKeyParameterNames(const OAIApiEntityBaseContract_subscriptionKeyParameterNames &subscription_key_parameter_names) {
