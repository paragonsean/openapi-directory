...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void apiPolicyGet(const QString &resource_group_name, const QString &service_name, const QString &api_id, const QString &policy_id, const QString &api_version, const QString &subscription_id);
