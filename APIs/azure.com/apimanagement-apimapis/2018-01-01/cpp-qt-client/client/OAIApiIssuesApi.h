...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIIssueUpdateContract [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void apiIssueUpdate(const QString &resource_group_name, const QString &service_name, const QString &api_id, const QString &issue_id, const QString &api_version, const QString &subscription_id, const OAIIssueUpdateContract &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void apiIssueListByServiceSignal(OAIIssueCollection summary);
    ...
    void apiIssueListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIIssueCollection summary);
    ...
    void apiIssueListByServiceSignalE(OAIIssueCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiIssueListByServiceSignalError(OAIIssueCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
