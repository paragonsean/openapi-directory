...
#ifndef OAI_OAIApiOperationPoliciesApi_H
#define OAI_OAIApiOperationPoliciesApi_H
...
class OAIApiOperationPoliciesApi : public QObject {
    Q_OBJECT

public:
    OAIApiOperationPoliciesApi(const int timeOut = 0);
    ~OAIApiOperationPoliciesApi();
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void apiOperationPolicyDelete(const QString &resource_group_name, const QString &service_name, const QString &api_id, const QString &operation_id, const QString &if_match, const QString &policy_id, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void apiOperationPolicyGet(const QString &resource_group_name, const QString &service_name, const QString &api_id, const QString &operation_id, const QString &policy_id, const QString &api_version, const QString &subscription_id);
