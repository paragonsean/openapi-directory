...
public class ApiPolicyApiTest {
    ...
    public void apiPolicyCreateOrUpdateTest() throws ApiException {
        ...
        String ifMatch = null;
        ApiOperationPolicyGet200Response response = api.apiPolicyCreateOrUpdate(resourceGroupName, serviceName, apiId, policyId, apiVersion, subscriptionId, parameters, ifMatch);
