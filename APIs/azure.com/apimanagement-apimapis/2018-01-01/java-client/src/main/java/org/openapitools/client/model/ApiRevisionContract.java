...
public class ApiRevisionContract {
  ...
  public boolean equals(Object o) {
    ...
    ApiRevisionContract apiRevisionContract = (ApiRevisionContract) o;
    return Objects.equals(this.apiId, apiRevisionContract.apiId) &&
        Objects.equals(this.apiRevision, apiRevisionContract.apiRevision) &&
        Objects.equals(this.createdDateTime, apiRevisionContract.createdDateTime) &&
        Objects.equals(this.description, apiRevisionContract.description) &&
        Objects.equals(this.isCurrent, apiRevisionContract.isCurrent) &&
        Objects.equals(this.isOnline, apiRevisionContract.isOnline) &&
        Objects.equals(this.privateUrl, apiRevisionContract.privateUrl) &&
        Objects.equals(this.updatedDateTime, apiRevisionContract.updatedDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiRevisionContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiRevisionContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiRevisionContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiRevisionContract is not found in the empty JSON string", ApiRevisionContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiRevisionContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiRevisionContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiRevisionContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiRevisionContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiRevisionContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiRevisionContract.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiRevisionContract>() {
           @Override
           public void write(JsonWriter out, ApiRevisionContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiRevisionContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiRevisionContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiRevisionContract
   * @throws IOException if the JSON string is invalid with respect to ApiRevisionContract
   */
  public static ApiRevisionContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiRevisionContract.class);
  }

  /**
   * Convert an instance of ApiRevisionContract to an JSON string
   *
   * @return JSON string
   */
