...
public class OperationsApi {
     ...
     */
    public okhttp3.Call apiOperationCreateOrUpdateCall(String resourceGroupName, String serviceName, String apiId, String operationId, String apiVersion, String subscriptionId, OperationContract parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiOperationCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String operationId, String apiVersion, String subscriptionId, OperationContract parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
     ...
     */
    public OperationContract apiOperationCreateOrUpdate(String resourceGroupName, String serviceName, String apiId, String operationId, String apiVersion, String subscriptionId, OperationContract parameters, String ifMatch) throws ApiException {
        ApiResponse<OperationContract> localVarResp = apiOperationCreateOrUpdateWithHttpInfo(resourceGroupName, serviceName, apiId, operationId, apiVersion, subscriptionId, parameters, ifMatch);
     ...
     */
    public ApiResponse<OperationContract> apiOperationCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String operationId, String apiVersion, String subscriptionId, OperationContract parameters, String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call apiOperationCreateOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, String operationId, String apiVersion, String subscriptionId, OperationContract parameters, String ifMatch, final ApiCallback<OperationContract> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The operation was successfully deleted. </td><td>  -  </td></tr>
