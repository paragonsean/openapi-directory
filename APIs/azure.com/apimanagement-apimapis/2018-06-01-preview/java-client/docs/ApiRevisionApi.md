...
|------------- | ------------- | -------------|
| [**apiRevisionsList**](ApiRevisionApi.md#apiRevisionsList) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/revisions |  |


<a id="apiRevisionsList"></a>
# **apiRevisionsList**
> ApiRevisionsList200Response apiRevisionsList(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, $filter, $top, $skip)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiRevisionsList200Response result = apiInstance.apiRevisionsList(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, $filter, $top, $skip);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiRevisionApi#apiRevisionsList");
...
[**ApiRevisionsList200Response**](ApiRevisionsList200Response.md)
