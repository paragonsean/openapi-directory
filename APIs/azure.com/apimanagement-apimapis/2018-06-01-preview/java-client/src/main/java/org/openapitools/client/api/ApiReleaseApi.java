...
public class ApiReleaseApi {
     ...
     */
    public okhttp3.Call apiReleaseCreateCall(String resourceGroupName, String serviceName, String apiId, String releaseId, String apiVersion, String subscriptionId, ApiReleaseGet200Response parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiReleaseCreateValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String releaseId, String apiVersion, String subscriptionId, ApiReleaseGet200Response parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
        ...
        return apiReleaseCreateCall(resourceGroupName, serviceName, apiId, releaseId, apiVersion, subscriptionId, parameters, ifMatch, _callback);
     ...
     */
    public ApiReleaseGet200Response apiReleaseCreate(String resourceGroupName, String serviceName, String apiId, String releaseId, String apiVersion, String subscriptionId, ApiReleaseGet200Response parameters, String ifMatch) throws ApiException {
        ApiResponse<ApiReleaseGet200Response> localVarResp = apiReleaseCreateWithHttpInfo(resourceGroupName, serviceName, apiId, releaseId, apiVersion, subscriptionId, parameters, ifMatch);
     ...
     */
    public ApiResponse<ApiReleaseGet200Response> apiReleaseCreateWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String releaseId, String apiVersion, String subscriptionId, ApiReleaseGet200Response parameters, String ifMatch) throws ApiException {
        okhttp3.Call localVarCall = apiReleaseCreateValidateBeforeCall(resourceGroupName, serviceName, apiId, releaseId, apiVersion, subscriptionId, parameters, ifMatch, null);
     ...
     */
    public okhttp3.Call apiReleaseCreateAsync(String resourceGroupName, String serviceName, String apiId, String releaseId, String apiVersion, String subscriptionId, ApiReleaseGet200Response parameters, String ifMatch, final ApiCallback<ApiReleaseGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiReleaseCreateValidateBeforeCall(resourceGroupName, serviceName, apiId, releaseId, apiVersion, subscriptionId, parameters, ifMatch, _callback);
        Type localVarReturnType = new TypeToken<ApiReleaseGet200Response>(){}.getType();
     ...
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param $filter | Field       | Supported operators    | Supported functions               | |-------------|------------------------|-----------------------------------|   |notes | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith|  (optional)
     ...
     */
    public ApiReleaseList200Response apiReleaseList(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, String $filter, Integer $top, Integer $skip) throws ApiException {
        ApiResponse<ApiReleaseList200Response> localVarResp = apiReleaseListWithHttpInfo(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, $filter, $top, $skip);
        return localVarResp.getData();
    }
     ...
     * @param $top Number of records to return. (optional)
     * @param $skip Number of records to skip. (optional)
     * @return ApiResponse&lt;ApiReleaseList200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ApiReleaseList200Response> apiReleaseListWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, String $filter, Integer $top, Integer $skip) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ApiReleaseList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiReleaseListAsync(String resourceGroupName, String serviceName, String apiId, String apiVersion, String subscriptionId, String $filter, Integer $top, Integer $skip, final ApiCallback<ApiReleaseList200Response> _callback) throws ApiException {
