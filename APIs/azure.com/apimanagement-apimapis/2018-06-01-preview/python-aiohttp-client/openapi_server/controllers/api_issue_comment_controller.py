...
async def api_issue_comment_create_or_update(request: web.Request, resource_group_name, service_name, api_id, issue_id, comment_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    ...
    """
    parameters = ApiIssueCommentGet200Response.from_dict(parameters)
...
async def api_issue_comment_list_by_service(request: web.Request, resource_group_name, service_name, api_id, issue_id, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
