...
async def api_release_create(request: web.Request, resource_group_name, service_name, api_id, release_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    """api_release_create
