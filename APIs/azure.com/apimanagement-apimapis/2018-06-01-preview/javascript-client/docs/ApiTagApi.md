...
let apiInstance = new ApiManagementClient.ApiTagApi();
...
apiInstance.tagAssignToApi(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.tagDetachFromApi(resourceGroupName, serviceName, apiId, tagId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> TagListByOperation200Response tagListByApi(resourceGroupName, serviceName, apiId, apiVersion, subscriptionId, opts)
