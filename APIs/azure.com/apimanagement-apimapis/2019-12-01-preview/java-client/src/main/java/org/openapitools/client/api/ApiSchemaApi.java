...
public class ApiSchemaApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 202 </td><td> Request to create or update Api schema configuration was accepted. Location header contains the URL where the status of the long running operation can be checked. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call apiSchemaCreateOrUpdateCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, ApiSchemaGet200Response parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiSchemaCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, ApiSchemaGet200Response parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiSchemaGet200Response apiSchemaCreateOrUpdate(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, ApiSchemaGet200Response parameters, String ifMatch) throws ApiException {
     ...
     */
    public ApiResponse<ApiSchemaGet200Response> apiSchemaCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, ApiSchemaGet200Response parameters, String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call apiSchemaCreateOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, String schemaId, String apiVersion, String subscriptionId, ApiSchemaGet200Response parameters, String ifMatch, final ApiCallback<ApiSchemaGet200Response> _callback) throws ApiException {
