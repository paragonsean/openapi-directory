...
<a id="apiPolicyGet"></a>
# **apiPolicyGet**
> ApiOperationPolicyGet200Response apiPolicyGet(resourceGroupName, serviceName, apiId, policyId, apiVersion, subscriptionId, format)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiOperationPolicyGet200Response result = apiInstance.apiPolicyGet(resourceGroupName, serviceName, apiId, policyId, apiVersion, subscriptionId, format);
      System.out.println(result);
    } catch (ApiException e) {
