...
/*
 * OAIApiRevision_ListByService_200_response_value_inner.h
 *
 * Summary of revision metadata.
 */

#ifndef OAIApiRevision_ListByService_200_response_value_inner_H
#define OAIApiRevision_ListByService_200_response_value_inner_H
...
class OAIApiRevision_ListByService_200_response_value_inner : public OAIObject {
public:
    OAIApiRevision_ListByService_200_response_value_inner();
    OAIApiRevision_ListByService_200_response_value_inner(QString json);
    ~OAIApiRevision_ListByService_200_response_value_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiRevision_ListByService_200_response_value_inner)

#endif // OAIApiRevision_ListByService_200_response_value_inner_H
