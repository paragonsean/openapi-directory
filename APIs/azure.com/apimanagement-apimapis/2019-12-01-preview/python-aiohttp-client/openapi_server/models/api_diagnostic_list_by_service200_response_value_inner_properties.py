...
class ApiDiagnosticListByService200ResponseValueInnerProperties(Model):
    ...
    def __init__(self, always_log: str=None, backend: ApiDiagnosticListByService200ResponseValueInnerPropertiesBackend=None, frontend: ApiDiagnosticListByService200ResponseValueInnerPropertiesBackend=None, http_correlation_protocol: str=None, log_client_ip: bool=None, logger_id: str=None, sampling: ApiDiagnosticListByService200ResponseValueInnerPropertiesSampling=None, verbosity: str=None):
        ...
        :param log_client_ip: The log_client_ip of this ApiDiagnosticListByService200ResponseValueInnerProperties.
        ...
        self._log_client_ip = log_client_ip
    ...
    def log_client_ip(self):
        """Gets the log_client_ip of this ApiDiagnosticListByService200ResponseValueInnerProperties.

        Log the ClientIP. Default is false.

        :return: The log_client_ip of this ApiDiagnosticListByService200ResponseValueInnerProperties.
        :rtype: bool
        """
        return self._log_client_ip

    @log_client_ip.setter
    def log_client_ip(self, log_client_ip):
        """Sets the log_client_ip of this ApiDiagnosticListByService200ResponseValueInnerProperties.
