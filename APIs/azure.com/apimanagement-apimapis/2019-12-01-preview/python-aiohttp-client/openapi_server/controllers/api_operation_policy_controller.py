...
async def api_operation_policy_delete(request: web.Request, resource_group_name, service_name, api_id, operation_id, policy_id, if_match, api_version, subscription_id) -> web.Response:
...
async def api_operation_policy_get(request: web.Request, resource_group_name, service_name, api_id, operation_id, policy_id, api_version, subscription_id, format=None) -> web.Response:
