...
async def test_api_issue_comment_create_or_update(client):
    ...
    """
    parameters = openapi_server.ApiIssueCommentGet200Response()
...
async def test_api_issue_comment_get_entity_tag(client):
...
async def test_api_issue_comment_list_by_service(client):
