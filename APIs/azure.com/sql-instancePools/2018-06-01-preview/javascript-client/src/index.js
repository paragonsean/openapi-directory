...
import InstancePoolProperties from './model/InstancePoolProperties';
import InstancePoolUpdate from './model/InstancePoolUpdate';
import InstancePoolsApi from './api/InstancePoolsApi';
...
export {
    ...
    /**
     * The InstancePool model constructor.
     * @property {module:model/InstancePool}
     */
    InstancePool,

    /**
     * The InstancePoolListResult model constructor.
     * @property {module:model/InstancePoolListResult}
     */
    InstancePoolListResult,

    /**
     * The InstancePoolProperties model constructor.
     * @property {module:model/InstancePoolProperties}
     */
    InstancePoolProperties,

    /**
     * The InstancePoolUpdate model constructor.
     * @property {module:model/InstancePoolUpdate}
     */
    InstancePoolUpdate,

    /**
    * The InstancePoolsApi service constructor.
    * @property {module:api/InstancePoolsApi}
    */
    InstancePoolsApi
};
