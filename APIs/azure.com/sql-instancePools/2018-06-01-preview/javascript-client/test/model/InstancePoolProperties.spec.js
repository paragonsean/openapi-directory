...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.InstancePoolProperties();
  });
  ...
  describe('InstancePoolProperties', function() {
    it('should create an instance of InstancePoolProperties', function() {
      // uncomment below and update the code to test InstancePoolProperties
      //var instance = new SqlManagementClient.InstancePoolProperties();
      //expect(instance).to.be.a(SqlManagementClient.InstancePoolProperties);
    });
