...
class BGPCommunity(Model):
    ...
    def __init__(self, community_name: str=None, community_prefixes: List[str]=None, community_value: str=None, is_authorized_to_use: bool=None, service_group: str=None, service_supported_region: str=None):
        ...
        :param is_authorized_to_use: The is_authorized_to_use of this BGPCommunity.
        :param service_group: The service_group of this BGPCommunity.
        ...
        self.attribute_map = {
            ...
            'is_authorized_to_use': 'isAuthorizedToUse',
        ...
        self._is_authorized_to_use = is_authorized_to_use
    ...
    @property
    def is_authorized_to_use(self):
        """Gets the is_authorized_to_use of this BGPCommunity.

        Customer is authorized to use bgp community or not.

        :return: The is_authorized_to_use of this BGPCommunity.
        :rtype: bool
        """
        return self._is_authorized_to_use

    @is_authorized_to_use.setter
    def is_authorized_to_use(self, is_authorized_to_use):
        """Sets the is_authorized_to_use of this BGPCommunity.
    ...
    def service_group(self):
        """Gets the service_group of this BGPCommunity.

        The service group of the bgp community contains.

        :return: The service_group of this BGPCommunity.
        :rtype: str
        """
    ...
    def service_group(self, service_group):
        """Sets the service_group of this BGPCommunity.
