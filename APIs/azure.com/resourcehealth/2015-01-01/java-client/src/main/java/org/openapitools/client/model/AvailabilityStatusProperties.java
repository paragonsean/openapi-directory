...
public class AvailabilityStatusProperties {
  ...
  public static final String SERIALIZED_NAME_IS_ARM_RESOURCE = "isArmResource";
  @SerializedName(SERIALIZED_NAME_IS_ARM_RESOURCE)
  ...
  public AvailabilityStatusProperties isArmResource(Boolean isArmResource) {
   ...
   * @return isArmResource
   */
  @javax.annotation.Nullable
  public Boolean getIsArmResource() {
    return isArmResource;
  }

  public void setIsArmResource(Boolean isArmResource) {
    this.isArmResource = isArmResource;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availabilityState, availabilityStatusProperties.availabilityState) &&
        ...
        Objects.equals(this.isArmResource, availabilityStatusProperties.isArmResource) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilityState, detailedStatus, isArmResource, occuredTime, reasonChronicity, reasonType, recentlyResolvedState, recommendedActions, reportedTime, resolutionETA, rootCauseAttributionTime, serviceImpactingEvents, summary);
  }
  ...
  public String toString() {
    ...
    sb.append("    isArmResource: ").append(toIndentedString(isArmResource)).append("\n");
  ...
  static {
    ...
    openapiFields.add("isArmResource");
