...
import AvailabilityStatusPropertiesRecentlyResolvedState from './AvailabilityStatusPropertiesRecentlyResolvedState';
...
class AvailabilityStatusProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isArmResource')) {
                obj['isArmResource'] = ApiClient.convertToType(data['isArmResource'], 'Boolean');
            }
            if (data.hasOwnProperty('occuredTime')) {
                obj['occuredTime'] = ApiClient.convertToType(data['occuredTime'], 'Date');
            }
            ...
            if (data.hasOwnProperty('recentlyResolvedState')) {
                obj['recentlyResolvedState'] = AvailabilityStatusPropertiesRecentlyResolvedState.constructFromObject(data['recentlyResolvedState']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `recentlyResolvedState`
        if (data['recentlyResolvedState']) { // data not null
          AvailabilityStatusPropertiesRecentlyResolvedState.validateJSON(data['recentlyResolvedState']);
        }
 ...
 * @member {Boolean} isArmResource
 */
AvailabilityStatusProperties.prototype['isArmResource'] = undefined;

/**
 * Timestamp for when last change in health status occurred.
 * @member {Date} occuredTime
 */
AvailabilityStatusProperties.prototype['occuredTime'] = undefined;
...
/**
 * @member {module:model/AvailabilityStatusPropertiesRecentlyResolvedState} recentlyResolvedState
 */
AvailabilityStatusProperties.prototype['recentlyResolvedState'] = undefined;
