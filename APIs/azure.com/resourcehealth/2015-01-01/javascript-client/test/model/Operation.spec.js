...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftResourceHealth.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new MicrosoftResourceHealth.Operation();
      //expect(instance).to.be.a(MicrosoftResourceHealth.Operation);
    });
