...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftResourceHealth.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MicrosoftResourceHealth.OperationDisplay();
      //expect(instance).to.be.a(MicrosoftResourceHealth.OperationDisplay);
    });
