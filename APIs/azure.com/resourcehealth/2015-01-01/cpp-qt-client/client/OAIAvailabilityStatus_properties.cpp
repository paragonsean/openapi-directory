...
void OAIAvailabilityStatus_properties::initializeModel() {
    ...
    m_is_arm_resource_isSet = false;
    m_is_arm_resource_isValid = false;

    m_occured_time_isSet = false;
    m_occured_time_isValid = false;
    ...
    m_recently_resolved_state_isSet = false;
    m_recently_resolved_state_isValid = false;
...
void OAIAvailabilityStatus_properties::fromJsonObject(QJsonObject json) {
    ...
    m_is_arm_resource_isValid = ::OpenAPI::fromJsonValue(m_is_arm_resource, json[QString("isArmResource")]);
    m_is_arm_resource_isSet = !json[QString("isArmResource")].isNull() && m_is_arm_resource_isValid;

    m_occured_time_isValid = ::OpenAPI::fromJsonValue(m_occured_time, json[QString("occuredTime")]);
    m_occured_time_isSet = !json[QString("occuredTime")].isNull() && m_occured_time_isValid;
    ...
    m_recently_resolved_state_isValid = ::OpenAPI::fromJsonValue(m_recently_resolved_state, json[QString("recentlyResolvedState")]);
    m_recently_resolved_state_isSet = !json[QString("recentlyResolvedState")].isNull() && m_recently_resolved_state_isValid;
...
QJsonObject OAIAvailabilityStatus_properties::asJsonObject() const {
    ...
    if (m_is_arm_resource_isSet) {
        obj.insert(QString("isArmResource"), ::OpenAPI::toJsonValue(m_is_arm_resource));
    }
    if (m_occured_time_isSet) {
        obj.insert(QString("occuredTime"), ::OpenAPI::toJsonValue(m_occured_time));
    }
    ...
    if (m_recently_resolved_state.isSet()) {
        obj.insert(QString("recentlyResolvedState"), ::OpenAPI::toJsonValue(m_recently_resolved_state));
    }
...
bool OAIAvailabilityStatus_properties::isIsArmResource() const {
    return m_is_arm_resource;
}
void OAIAvailabilityStatus_properties::setIsArmResource(const bool &is_arm_resource) {
    m_is_arm_resource = is_arm_resource;
    m_is_arm_resource_isSet = true;
}

bool OAIAvailabilityStatus_properties::is_is_arm_resource_Set() const{
    return m_is_arm_resource_isSet;
}

bool OAIAvailabilityStatus_properties::is_is_arm_resource_Valid() const{
    return m_is_arm_resource_isValid;
}

QDateTime OAIAvailabilityStatus_properties::getOccuredTime() const {
    return m_occured_time;
}
void OAIAvailabilityStatus_properties::setOccuredTime(const QDateTime &occured_time) {
    m_occured_time = occured_time;
    m_occured_time_isSet = true;
}

bool OAIAvailabilityStatus_properties::is_occured_time_Set() const{
    return m_occured_time_isSet;
}

bool OAIAvailabilityStatus_properties::is_occured_time_Valid() const{
    return m_occured_time_isValid;
}
...
OAIAvailabilityStatus_properties_recentlyResolvedState OAIAvailabilityStatus_properties::getRecentlyResolvedState() const {
    return m_recently_resolved_state;
}
void OAIAvailabilityStatus_properties::setRecentlyResolvedState(const OAIAvailabilityStatus_properties_recentlyResolvedState &recently_resolved_state) {
    m_recently_resolved_state = recently_resolved_state;
    m_recently_resolved_state_isSet = true;
}

bool OAIAvailabilityStatus_properties::is_recently_resolved_state_Set() const{
    return m_recently_resolved_state_isSet;
}

bool OAIAvailabilityStatus_properties::is_recently_resolved_state_Valid() const{
    return m_recently_resolved_state_isValid;
}
