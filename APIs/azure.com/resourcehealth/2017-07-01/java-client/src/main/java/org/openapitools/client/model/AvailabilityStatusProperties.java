...
public class AvailabilityStatusProperties {
  ...
  public static final String SERIALIZED_NAME_RECENTLY_RESOLVED_STATE = "recentlyResolvedState";
  @SerializedName(SERIALIZED_NAME_RECENTLY_RESOLVED_STATE)
  ...
  public AvailabilityStatusProperties recentlyResolvedState(AvailabilityStatusPropertiesRecentlyResolvedState recentlyResolvedState) {
    this.recentlyResolvedState = recentlyResolvedState;
    return this;
  }

  /**
   * Get recentlyResolvedState
   * @return recentlyResolvedState
   */
  @javax.annotation.Nullable
  public AvailabilityStatusPropertiesRecentlyResolvedState getRecentlyResolvedState() {
    return recentlyResolvedState;
  }

  public void setRecentlyResolvedState(AvailabilityStatusPropertiesRecentlyResolvedState recentlyResolvedState) {
    this.recentlyResolvedState = recentlyResolvedState;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availabilityState, availabilityStatusProperties.availabilityState) &&
        ...
        Objects.equals(this.recentlyResolvedState, availabilityStatusProperties.recentlyResolvedState) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilityState, detailedStatus, healthEventCategory, healthEventCause, healthEventId, healthEventType, occuredTime, reasonChronicity, reasonType, recentlyResolvedState, recommendedActions, reportedTime, resolutionETA, rootCauseAttributionTime, serviceImpactingEvents, summary);
  }
  ...
  public String toString() {
    ...
    sb.append("    recentlyResolvedState: ").append(toIndentedString(recentlyResolvedState)).append("\n");
  ...
  static {
    ...
    openapiFields.add("recentlyResolvedState");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("recentlyResolvedState") != null && !jsonObj.get("recentlyResolvedState").isJsonNull()) {
        AvailabilityStatusPropertiesRecentlyResolvedState.validateJsonElement(jsonObj.get("recentlyResolvedState"));
      }
