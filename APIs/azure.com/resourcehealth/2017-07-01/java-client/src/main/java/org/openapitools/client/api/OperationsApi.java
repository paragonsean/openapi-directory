...
public class OperationsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The body contains the list of available operations for the resourcehealth resource provider </td><td>  -  </td></tr>
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.ResourceHealth/operations";
