...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftResourceHealth.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new MicrosoftResourceHealth.ErrorResponse();
      //expect(instance).to.be.a(MicrosoftResourceHealth.ErrorResponse);
    });
