...
class CustomRPActionRouteDefinition(Model):
    ...
    def __init__(self, routing_type: str=None, endpoint: str=None, name: str=None):
        """CustomRPActionRouteDefinition - a model defined in OpenAPI

        :param routing_type: The routing_type of this CustomRPActionRouteDefinition.
        :param endpoint: The endpoint of this CustomRPActionRouteDefinition.
        :param name: The name of this CustomRPActionRouteDefinition.
        """
        self.openapi_types = {
            'routing_type': str,
            'endpoint': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomRPActionRouteDefinition':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomRPActionRouteDefinition of this CustomRPActionRouteDefinition.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def routing_type(self):
        """Gets the routing_type of this CustomRPActionRouteDefinition.

        The routing types that are supported for action requests.

        :return: The routing_type of this CustomRPActionRouteDefinition.
        :rtype: str
        """
    ...
    def routing_type(self, routing_type):
        """Sets the routing_type of this CustomRPActionRouteDefinition.
    ...
    @property
    def endpoint(self):
        """Gets the endpoint of this CustomRPActionRouteDefinition.
        ...
        :return: The endpoint of this CustomRPActionRouteDefinition.
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this CustomRPActionRouteDefinition.
    ...
    @property
    def name(self):
        """Gets the name of this CustomRPActionRouteDefinition.
        ...
        :return: The name of this CustomRPActionRouteDefinition.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CustomRPActionRouteDefinition.
