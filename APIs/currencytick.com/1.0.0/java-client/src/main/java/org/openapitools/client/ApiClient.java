...
public class ApiClient {
    ...
    private String basePath = "https://api.currencytick.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.currencytick.com",
    ...
    public ApiClient() {
        ...
        authentications.put("default", new ApiKeyAuth("query", "apikey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.currencytick.com
