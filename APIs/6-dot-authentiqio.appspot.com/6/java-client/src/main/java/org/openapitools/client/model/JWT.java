...
public class JWT {
  ...
  public JWT since(OffsetDateTime since) {
    this.since = since;
    return this;
  }
  ...
  public JWT status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JWT JWT = (JWT) o;
    return Objects.equals(this.since, JWT.since) &&
        Objects.equals(this.status, JWT.status) &&
        Objects.equals(this.sub, JWT.sub);
  }

  @Override
  public int hashCode() {
    return Objects.hash(since, status, sub);
  }
