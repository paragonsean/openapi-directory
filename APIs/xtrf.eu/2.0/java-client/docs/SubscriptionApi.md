...
public class Example {
  public static void main(String[] args) {
    ...
    SubscriptionApi apiInstance = new SubscriptionApi(defaultClient);
    SubscriptionDTO subscriptionDTO = new SubscriptionDTO(); // SubscriptionDTO | Returns subscription Id.
    try {
      String result = apiInstance.subscribe(subscriptionDTO);
      System.out.println(result);
    } catch (ApiException e) {
