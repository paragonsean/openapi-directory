...
public class PayableCreateDTO {
  ...
  public PayableCreateDTO calculationUnitId(Long calculationUnitId) {
  ...
  public PayableCreateDTO catLogFile(FileDTO catLogFile) {
  ...
  public PayableCreateDTO currencyId(Long currencyId) {
  ...
  public PayableCreateDTO description(String description) {
  ...
  public PayableCreateDTO id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public PayableCreateDTO ignoreMinimumCharge(Boolean ignoreMinimumCharge) {
  ...
  public PayableCreateDTO invoiceId(String invoiceId) {
  ...
  public PayableCreateDTO jobId(Object jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public PayableCreateDTO jobTypeId(Long jobTypeId) {
  ...
  public PayableCreateDTO languageCombination(ChargeLanguageCombinationDTO languageCombination) {
  ...
  public PayableCreateDTO languageCombinationIdNumber(String languageCombinationIdNumber) {
  ...
  public PayableCreateDTO minimumCharge(BigDecimal minimumCharge) {
  ...
  public PayableCreateDTO quantity(BigDecimal quantity) {
  ...
  public PayableCreateDTO rate(BigDecimal rate) {
    this.rate = rate;
    return this;
  }
  ...
  public PayableCreateDTO rateOrigin(RateOriginEnum rateOrigin) {
  ...
  public PayableCreateDTO total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public PayableCreateDTO type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PayableCreateDTO payableCreateDTO = (PayableCreateDTO) o;
    return Objects.equals(this.calculationUnitId, payableCreateDTO.calculationUnitId) &&
        Objects.equals(this.catLogFile, payableCreateDTO.catLogFile) &&
        Objects.equals(this.currencyId, payableCreateDTO.currencyId) &&
        Objects.equals(this.description, payableCreateDTO.description) &&
        Objects.equals(this.id, payableCreateDTO.id) &&
        Objects.equals(this.ignoreMinimumCharge, payableCreateDTO.ignoreMinimumCharge) &&
        Objects.equals(this.invoiceId, payableCreateDTO.invoiceId) &&
        Objects.equals(this.jobId, payableCreateDTO.jobId) &&
        Objects.equals(this.jobTypeId, payableCreateDTO.jobTypeId) &&
        Objects.equals(this.languageCombination, payableCreateDTO.languageCombination) &&
        Objects.equals(this.languageCombinationIdNumber, payableCreateDTO.languageCombinationIdNumber) &&
        Objects.equals(this.minimumCharge, payableCreateDTO.minimumCharge) &&
        Objects.equals(this.quantity, payableCreateDTO.quantity) &&
        Objects.equals(this.rate, payableCreateDTO.rate) &&
        Objects.equals(this.rateOrigin, payableCreateDTO.rateOrigin) &&
        Objects.equals(this.total, payableCreateDTO.total) &&
        Objects.equals(this.type, payableCreateDTO.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(calculationUnitId, catLogFile, currencyId, description, id, ignoreMinimumCharge, invoiceId, jobId, jobTypeId, languageCombination, languageCombinationIdNumber, minimumCharge, quantity, rate, rateOrigin, total, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayableCreateDTO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayableCreateDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayableCreateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayableCreateDTO is not found in the empty JSON string", PayableCreateDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayableCreateDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayableCreateDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayableCreateDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayableCreateDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayableCreateDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayableCreateDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PayableCreateDTO>() {
           @Override
           public void write(JsonWriter out, PayableCreateDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayableCreateDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayableCreateDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayableCreateDTO
   * @throws IOException if the JSON string is invalid with respect to PayableCreateDTO
   */
  public static PayableCreateDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayableCreateDTO.class);
  }

  /**
   * Convert an instance of PayableCreateDTO to an JSON string
   *
   * @return JSON string
   */
