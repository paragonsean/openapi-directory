...
public class ReceivableDTO {
  ...
  public ReceivableDTO taskId(Long taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.calculationUnitId, receivableDTO.calculationUnitId) &&
        Objects.equals(this.currencyId, receivableDTO.currencyId) &&
        Objects.equals(this.description, receivableDTO.description) &&
        Objects.equals(this.id, receivableDTO.id) &&
        ...
        Objects.equals(this.taskId, receivableDTO.taskId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calculationUnitId, currencyId, description, id, ignoreMinimumCharge, invoiceId, jobTypeId, languageCombination, languageCombinationIdNumber, minimumCharge, quantity, rate, rateOrigin, taskId, total, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReceivableDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReceivableDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceivableDTO is not found in the empty JSON string", ReceivableDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReceivableDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReceivableDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceivableDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceivableDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceivableDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceivableDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceivableDTO>() {
           @Override
           public void write(JsonWriter out, ReceivableDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReceivableDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReceivableDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReceivableDTO
   * @throws IOException if the JSON string is invalid with respect to ReceivableDTO
   */
  public static ReceivableDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceivableDTO.class);
  }

  /**
   * Convert an instance of ReceivableDTO to an JSON string
   *
   * @return JSON string
   */
