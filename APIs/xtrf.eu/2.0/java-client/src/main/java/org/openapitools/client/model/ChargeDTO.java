...
public class ChargeDTO {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.calculationUnitId, chargeDTO.calculationUnitId) &&
        Objects.equals(this.currencyId, chargeDTO.currencyId) &&
        Objects.equals(this.description, chargeDTO.description) &&
        Objects.equals(this.id, chargeDTO.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calculationUnitId, currencyId, description, id, ignoreMinimumCharge, invoiceId, jobTypeId, languageCombination, languageCombinationIdNumber, minimumCharge, rateOrigin, total, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChargeDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChargeDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChargeDTO is not found in the empty JSON string", ChargeDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChargeDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChargeDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChargeDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChargeDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChargeDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChargeDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<ChargeDTO>() {
           @Override
           public void write(JsonWriter out, ChargeDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChargeDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChargeDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChargeDTO
   * @throws IOException if the JSON string is invalid with respect to ChargeDTO
   */
  public static ChargeDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChargeDTO.class);
  }

  /**
   * Convert an instance of ChargeDTO to an JSON string
   *
   * @return JSON string
   */
