...
public class FormDataMultiPart {
  ...
  public FormDataMultiPart headers(BodyPartHeaders headers) {
  ...
  public FormDataMultiPart parameterizedHeaders(BodyPartParameterizedHeaders parameterizedHeaders) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormDataMultiPart
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormDataMultiPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormDataMultiPart is not found in the empty JSON string", FormDataMultiPart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormDataMultiPart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormDataMultiPart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormDataMultiPart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormDataMultiPart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormDataMultiPart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormDataMultiPart.class));

       return (TypeAdapter<T>) new TypeAdapter<FormDataMultiPart>() {
           @Override
           public void write(JsonWriter out, FormDataMultiPart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormDataMultiPart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormDataMultiPart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormDataMultiPart
   * @throws IOException if the JSON string is invalid with respect to FormDataMultiPart
   */
  public static FormDataMultiPart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormDataMultiPart.class);
  }

  /**
   * Convert an instance of FormDataMultiPart to an JSON string
   *
   * @return JSON string
   */
