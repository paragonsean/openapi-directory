...
/*
 * OAIContentDisposition.h
 *
 * 
 */

#ifndef OAIContentDisposition_H
#define OAIContentDisposition_H
...
class OAIContentDisposition : public OAIObject {
public:
    OAIContentDisposition();
    OAIContentDisposition(QString json);
    ~OAIContentDisposition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentDisposition)

#endif // OAIContentDisposition_H
