...
/*
 * OAIPersonPositionDTO.h
 *
 * person&#39;s position (ie. proofreader)
 */

#ifndef OAIPersonPositionDTO_H
#define OAIPersonPositionDTO_H
...
class OAIPersonPositionDTO : public OAIObject {
public:
    OAIPersonPositionDTO();
    OAIPersonPositionDTO(QString json);
    ~OAIPersonPositionDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonPositionDTO)

#endif // OAIPersonPositionDTO_H
