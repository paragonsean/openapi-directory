...
#ifndef OAIServiceDTO_H
#define OAIServiceDTO_H
...
class OAIServiceDTO : public OAIObject {
public:
    OAIServiceDTO();
    OAIServiceDTO(QString json);
    ~OAIServiceDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceDTO)

#endif // OAIServiceDTO_H
