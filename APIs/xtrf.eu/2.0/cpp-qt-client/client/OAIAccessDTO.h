...
#ifndef OAIAccessDTO_H
#define OAIAccessDTO_H
...
class OAIAccessDTO : public OAIObject {
public:
    OAIAccessDTO();
    OAIAccessDTO(QString json);
    ~OAIAccessDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessDTO)

#endif // OAIAccessDTO_H
