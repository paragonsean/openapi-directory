...
#ifndef OAIMultiPart_H
#define OAIMultiPart_H
...
class OAIMultiPart : public OAIObject {
public:
    OAIMultiPart();
    OAIMultiPart(QString json);
    ~OAIMultiPart() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiPart)

#endif // OAIMultiPart_H
