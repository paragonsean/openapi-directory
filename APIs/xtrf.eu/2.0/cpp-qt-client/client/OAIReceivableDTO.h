...
#ifndef OAIReceivableDTO_H
#define OAIReceivableDTO_H
...
class OAIReceivableDTO : public OAIObject {
public:
    OAIReceivableDTO();
    OAIReceivableDTO(QString json);
    ~OAIReceivableDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceivableDTO)

#endif // OAIReceivableDTO_H
