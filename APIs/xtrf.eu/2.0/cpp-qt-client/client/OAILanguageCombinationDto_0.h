...
/*
 * OAILanguageCombinationDto.h
 *
 * 
 */

#ifndef OAILanguageCombinationDto_H
#define OAILanguageCombinationDto_H
...
class OAILanguageCombinationDto : public OAIObject {
public:
    OAILanguageCombinationDto();
    OAILanguageCombinationDto(QString json);
    ~OAILanguageCombinationDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguageCombinationDto)

#endif // OAILanguageCombinationDto_H
