...
#ifndef OAIProvinceDTO_H
#define OAIProvinceDTO_H
...
class OAIProvinceDTO : public OAIObject {
public:
    OAIProvinceDTO();
    OAIProvinceDTO(QString json);
    ~OAIProvinceDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvinceDTO)

#endif // OAIProvinceDTO_H
