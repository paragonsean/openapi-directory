...
OAIPayableCreateDTO::OAIPayableCreateDTO(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayableCreateDTO::OAIPayableCreateDTO() {
    this->initializeModel();
}

OAIPayableCreateDTO::~OAIPayableCreateDTO() {}

void OAIPayableCreateDTO::initializeModel() {
...
void OAIPayableCreateDTO::fromJson(QString jsonString) {
...
void OAIPayableCreateDTO::fromJsonObject(QJsonObject json) {
...
QString OAIPayableCreateDTO::asJson() const {
...
QJsonObject OAIPayableCreateDTO::asJsonObject() const {
    QJsonObject obj;
...
qint64 OAIPayableCreateDTO::getCalculationUnitId() const {
    return m_calculation_unit_id;
}
void OAIPayableCreateDTO::setCalculationUnitId(const qint64 &calculation_unit_id) {
    m_calculation_unit_id = calculation_unit_id;
    m_calculation_unit_id_isSet = true;
}

bool OAIPayableCreateDTO::is_calculation_unit_id_Set() const{
    return m_calculation_unit_id_isSet;
}

bool OAIPayableCreateDTO::is_calculation_unit_id_Valid() const{
    return m_calculation_unit_id_isValid;
}

OAIFileDTO OAIPayableCreateDTO::getCatLogFile() const {
    return m_cat_log_file;
}
void OAIPayableCreateDTO::setCatLogFile(const OAIFileDTO &cat_log_file) {
    m_cat_log_file = cat_log_file;
    m_cat_log_file_isSet = true;
}

bool OAIPayableCreateDTO::is_cat_log_file_Set() const{
    return m_cat_log_file_isSet;
}

bool OAIPayableCreateDTO::is_cat_log_file_Valid() const{
    return m_cat_log_file_isValid;
}

qint64 OAIPayableCreateDTO::getCurrencyId() const {
    return m_currency_id;
}
void OAIPayableCreateDTO::setCurrencyId(const qint64 &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAIPayableCreateDTO::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAIPayableCreateDTO::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

QString OAIPayableCreateDTO::getDescription() const {
    return m_description;
}
void OAIPayableCreateDTO::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPayableCreateDTO::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPayableCreateDTO::is_description_Valid() const{
    return m_description_isValid;
}

qint64 OAIPayableCreateDTO::getId() const {
    return m_id;
}
void OAIPayableCreateDTO::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPayableCreateDTO::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPayableCreateDTO::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPayableCreateDTO::isIgnoreMinimumCharge() const {
    return m_ignore_minimum_charge;
}
void OAIPayableCreateDTO::setIgnoreMinimumCharge(const bool &ignore_minimum_charge) {
    m_ignore_minimum_charge = ignore_minimum_charge;
    m_ignore_minimum_charge_isSet = true;
}

bool OAIPayableCreateDTO::is_ignore_minimum_charge_Set() const{
    return m_ignore_minimum_charge_isSet;
}

bool OAIPayableCreateDTO::is_ignore_minimum_charge_Valid() const{
    return m_ignore_minimum_charge_isValid;
}

QString OAIPayableCreateDTO::getInvoiceId() const {
    return m_invoice_id;
}
void OAIPayableCreateDTO::setInvoiceId(const QString &invoice_id) {
    m_invoice_id = invoice_id;
    m_invoice_id_isSet = true;
}

bool OAIPayableCreateDTO::is_invoice_id_Set() const{
    return m_invoice_id_isSet;
}

bool OAIPayableCreateDTO::is_invoice_id_Valid() const{
    return m_invoice_id_isValid;
}

OAIObject OAIPayableCreateDTO::getJobId() const {
    return m_job_id;
}
void OAIPayableCreateDTO::setJobId(const OAIObject &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIPayableCreateDTO::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIPayableCreateDTO::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint64 OAIPayableCreateDTO::getJobTypeId() const {
    return m_job_type_id;
}
void OAIPayableCreateDTO::setJobTypeId(const qint64 &job_type_id) {
    m_job_type_id = job_type_id;
    m_job_type_id_isSet = true;
}

bool OAIPayableCreateDTO::is_job_type_id_Set() const{
    return m_job_type_id_isSet;
}

bool OAIPayableCreateDTO::is_job_type_id_Valid() const{
    return m_job_type_id_isValid;
}

OAIChargeLanguageCombinationDTO OAIPayableCreateDTO::getLanguageCombination() const {
    return m_language_combination;
}
void OAIPayableCreateDTO::setLanguageCombination(const OAIChargeLanguageCombinationDTO &language_combination) {
    m_language_combination = language_combination;
    m_language_combination_isSet = true;
}

bool OAIPayableCreateDTO::is_language_combination_Set() const{
    return m_language_combination_isSet;
}

bool OAIPayableCreateDTO::is_language_combination_Valid() const{
    return m_language_combination_isValid;
}

QString OAIPayableCreateDTO::getLanguageCombinationIdNumber() const {
    return m_language_combination_id_number;
}
void OAIPayableCreateDTO::setLanguageCombinationIdNumber(const QString &language_combination_id_number) {
    m_language_combination_id_number = language_combination_id_number;
    m_language_combination_id_number_isSet = true;
}

bool OAIPayableCreateDTO::is_language_combination_id_number_Set() const{
    return m_language_combination_id_number_isSet;
}

bool OAIPayableCreateDTO::is_language_combination_id_number_Valid() const{
    return m_language_combination_id_number_isValid;
}

double OAIPayableCreateDTO::getMinimumCharge() const {
    return m_minimum_charge;
}
void OAIPayableCreateDTO::setMinimumCharge(const double &minimum_charge) {
    m_minimum_charge = minimum_charge;
    m_minimum_charge_isSet = true;
}

bool OAIPayableCreateDTO::is_minimum_charge_Set() const{
    return m_minimum_charge_isSet;
}

bool OAIPayableCreateDTO::is_minimum_charge_Valid() const{
    return m_minimum_charge_isValid;
}

double OAIPayableCreateDTO::getQuantity() const {
    return m_quantity;
}
void OAIPayableCreateDTO::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIPayableCreateDTO::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIPayableCreateDTO::is_quantity_Valid() const{
    return m_quantity_isValid;
}

double OAIPayableCreateDTO::getRate() const {
    return m_rate;
}
void OAIPayableCreateDTO::setRate(const double &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIPayableCreateDTO::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIPayableCreateDTO::is_rate_Valid() const{
    return m_rate_isValid;
}

QString OAIPayableCreateDTO::getRateOrigin() const {
    return m_rate_origin;
}
void OAIPayableCreateDTO::setRateOrigin(const QString &rate_origin) {
    m_rate_origin = rate_origin;
    m_rate_origin_isSet = true;
}

bool OAIPayableCreateDTO::is_rate_origin_Set() const{
    return m_rate_origin_isSet;
}

bool OAIPayableCreateDTO::is_rate_origin_Valid() const{
    return m_rate_origin_isValid;
}

double OAIPayableCreateDTO::getTotal() const {
    return m_total;
}
void OAIPayableCreateDTO::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIPayableCreateDTO::is_total_Set() const{
    return m_total_isSet;
}

bool OAIPayableCreateDTO::is_total_Valid() const{
    return m_total_isValid;
}

QString OAIPayableCreateDTO::getType() const {
    return m_type;
}
void OAIPayableCreateDTO::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPayableCreateDTO::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPayableCreateDTO::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPayableCreateDTO::isSet() const {
...
bool OAIPayableCreateDTO::isValid() const {
