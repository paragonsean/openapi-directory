...
/*
 * OAIFormDataMultiPart.h
 *
 * 
 */

#ifndef OAIFormDataMultiPart_H
#define OAIFormDataMultiPart_H
...
class OAIFormDataBodyPart;
class OAIBodyPart_mediaType;
class OAIMultiPart;

class OAIFormDataMultiPart : public OAIObject {
public:
    OAIFormDataMultiPart();
    OAIFormDataMultiPart(QString json);
    ~OAIFormDataMultiPart() override;
    ...
    QList<OAIBodyPart> getBodyParts() const;
    void setBodyParts(const QList<OAIBodyPart> &body_parts);
    ...
    QMap<QString, QList<OAIFormDataBodyPart>> getFields() const;
    void setFields(const QMap<QString, QList<OAIFormDataBodyPart>> &fields);
...
private:
    ...
    QList<OAIBodyPart> m_body_parts;
    ...
    QMap<QString, QList<OAIFormDataBodyPart>> m_fields;
    bool m_fields_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormDataMultiPart)

#endif // OAIFormDataMultiPart_H
