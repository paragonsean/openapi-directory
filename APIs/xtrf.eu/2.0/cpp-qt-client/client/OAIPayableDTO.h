...
#ifndef OAIPayableDTO_H
#define OAIPayableDTO_H
...
class OAIPayableDTO : public OAIObject {
public:
    OAIPayableDTO();
    OAIPayableDTO(QString json);
    ~OAIPayableDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayableDTO)

#endif // OAIPayableDTO_H
