...
OAIMultiPart::OAIMultiPart(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMultiPart::OAIMultiPart() {
    this->initializeModel();
}

OAIMultiPart::~OAIMultiPart() {}

void OAIMultiPart::initializeModel() {
...
void OAIMultiPart::fromJson(QString jsonString) {
...
void OAIMultiPart::fromJsonObject(QJsonObject json) {
...
QString OAIMultiPart::asJson() const {
...
QJsonObject OAIMultiPart::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIBodyPart> OAIMultiPart::getBodyParts() const {
    return m_body_parts;
}
void OAIMultiPart::setBodyParts(const QList<OAIBodyPart> &body_parts) {
    m_body_parts = body_parts;
    m_body_parts_isSet = true;
}

bool OAIMultiPart::is_body_parts_Set() const{
    return m_body_parts_isSet;
}

bool OAIMultiPart::is_body_parts_Valid() const{
    return m_body_parts_isValid;
}

OAIContentDisposition OAIMultiPart::getContentDisposition() const {
    return m_content_disposition;
}
void OAIMultiPart::setContentDisposition(const OAIContentDisposition &content_disposition) {
    m_content_disposition = content_disposition;
    m_content_disposition_isSet = true;
}

bool OAIMultiPart::is_content_disposition_Set() const{
    return m_content_disposition_isSet;
}

bool OAIMultiPart::is_content_disposition_Valid() const{
    return m_content_disposition_isValid;
}

OAIObject OAIMultiPart::getEntity() const {
    return m_entity;
}
void OAIMultiPart::setEntity(const OAIObject &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIMultiPart::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIMultiPart::is_entity_Valid() const{
    return m_entity_isValid;
}

OAIBodyPart_headers OAIMultiPart::getHeaders() const {
    return m_headers;
}
void OAIMultiPart::setHeaders(const OAIBodyPart_headers &headers) {
    m_headers = headers;
    m_headers_isSet = true;
}

bool OAIMultiPart::is_headers_Set() const{
    return m_headers_isSet;
}

bool OAIMultiPart::is_headers_Valid() const{
    return m_headers_isValid;
}

OAIBodyPart_mediaType OAIMultiPart::getMediaType() const {
    return m_media_type;
}
void OAIMultiPart::setMediaType(const OAIBodyPart_mediaType &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIMultiPart::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIMultiPart::is_media_type_Valid() const{
    return m_media_type_isValid;
}

OAIObject OAIMultiPart::getMessageBodyWorkers() const {
    return m_message_body_workers;
}
void OAIMultiPart::setMessageBodyWorkers(const OAIObject &message_body_workers) {
    m_message_body_workers = message_body_workers;
    m_message_body_workers_isSet = true;
}

bool OAIMultiPart::is_message_body_workers_Set() const{
    return m_message_body_workers_isSet;
}

bool OAIMultiPart::is_message_body_workers_Valid() const{
    return m_message_body_workers_isValid;
}

OAIBodyPart_parameterizedHeaders OAIMultiPart::getParameterizedHeaders() const {
    return m_parameterized_headers;
}
void OAIMultiPart::setParameterizedHeaders(const OAIBodyPart_parameterizedHeaders &parameterized_headers) {
    m_parameterized_headers = parameterized_headers;
    m_parameterized_headers_isSet = true;
}

bool OAIMultiPart::is_parameterized_headers_Set() const{
    return m_parameterized_headers_isSet;
}

bool OAIMultiPart::is_parameterized_headers_Valid() const{
    return m_parameterized_headers_isValid;
}

OAIMultiPart OAIMultiPart::getParent() const {
    return m_parent;
}
void OAIMultiPart::setParent(const OAIMultiPart &parent) {
    m_parent = parent;
    m_parent_isSet = true;
}

bool OAIMultiPart::is_parent_Set() const{
    return m_parent_isSet;
}

bool OAIMultiPart::is_parent_Valid() const{
    return m_parent_isValid;
}

OAIObject OAIMultiPart::getProviders() const {
    return m_providers;
}
void OAIMultiPart::setProviders(const OAIObject &providers) {
    m_providers = providers;
    m_providers_isSet = true;
}

bool OAIMultiPart::is_providers_Set() const{
    return m_providers_isSet;
}

bool OAIMultiPart::is_providers_Valid() const{
    return m_providers_isValid;
}

bool OAIMultiPart::isSet() const {
...
bool OAIMultiPart::isValid() const {
