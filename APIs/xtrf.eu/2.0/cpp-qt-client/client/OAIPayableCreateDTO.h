...
/*
 * OAIPayableCreateDTO.h
 *
 * 
 */

#ifndef OAIPayableCreateDTO_H
#define OAIPayableCreateDTO_H
...
class OAIPayableCreateDTO : public OAIObject {
public:
    OAIPayableCreateDTO();
    OAIPayableCreateDTO(QString json);
    ~OAIPayableCreateDTO() override;
    ...
    OAIObject getJobId() const;
    void setJobId(const OAIObject &job_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayableCreateDTO)

#endif // OAIPayableCreateDTO_H
