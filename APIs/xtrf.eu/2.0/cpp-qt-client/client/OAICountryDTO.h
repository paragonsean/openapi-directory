...
#ifndef OAICountryDTO_H
#define OAICountryDTO_H
...
class OAICountryDTO : public OAIObject {
public:
    OAICountryDTO();
    OAICountryDTO(QString json);
    ~OAICountryDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryDTO)

#endif // OAICountryDTO_H
