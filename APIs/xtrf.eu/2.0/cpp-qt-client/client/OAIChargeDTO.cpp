...
OAIChargeDTO::OAIChargeDTO(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChargeDTO::OAIChargeDTO() {
    this->initializeModel();
}

OAIChargeDTO::~OAIChargeDTO() {}

void OAIChargeDTO::initializeModel() {
...
void OAIChargeDTO::fromJson(QString jsonString) {
...
void OAIChargeDTO::fromJsonObject(QJsonObject json) {
...
QString OAIChargeDTO::asJson() const {
...
QJsonObject OAIChargeDTO::asJsonObject() const {
    QJsonObject obj;
...
qint64 OAIChargeDTO::getCalculationUnitId() const {
    return m_calculation_unit_id;
}
void OAIChargeDTO::setCalculationUnitId(const qint64 &calculation_unit_id) {
    m_calculation_unit_id = calculation_unit_id;
    m_calculation_unit_id_isSet = true;
}

bool OAIChargeDTO::is_calculation_unit_id_Set() const{
    return m_calculation_unit_id_isSet;
}

bool OAIChargeDTO::is_calculation_unit_id_Valid() const{
    return m_calculation_unit_id_isValid;
}

qint64 OAIChargeDTO::getCurrencyId() const {
    return m_currency_id;
}
void OAIChargeDTO::setCurrencyId(const qint64 &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAIChargeDTO::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAIChargeDTO::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

QString OAIChargeDTO::getDescription() const {
    return m_description;
}
void OAIChargeDTO::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIChargeDTO::is_description_Set() const{
    return m_description_isSet;
}

bool OAIChargeDTO::is_description_Valid() const{
    return m_description_isValid;
}

qint64 OAIChargeDTO::getId() const {
    return m_id;
}
void OAIChargeDTO::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChargeDTO::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChargeDTO::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIChargeDTO::isIgnoreMinimumCharge() const {
    return m_ignore_minimum_charge;
}
void OAIChargeDTO::setIgnoreMinimumCharge(const bool &ignore_minimum_charge) {
    m_ignore_minimum_charge = ignore_minimum_charge;
    m_ignore_minimum_charge_isSet = true;
}

bool OAIChargeDTO::is_ignore_minimum_charge_Set() const{
    return m_ignore_minimum_charge_isSet;
}

bool OAIChargeDTO::is_ignore_minimum_charge_Valid() const{
    return m_ignore_minimum_charge_isValid;
}

QString OAIChargeDTO::getInvoiceId() const {
    return m_invoice_id;
}
void OAIChargeDTO::setInvoiceId(const QString &invoice_id) {
    m_invoice_id = invoice_id;
    m_invoice_id_isSet = true;
}

bool OAIChargeDTO::is_invoice_id_Set() const{
    return m_invoice_id_isSet;
}

bool OAIChargeDTO::is_invoice_id_Valid() const{
    return m_invoice_id_isValid;
}

qint64 OAIChargeDTO::getJobTypeId() const {
    return m_job_type_id;
}
void OAIChargeDTO::setJobTypeId(const qint64 &job_type_id) {
    m_job_type_id = job_type_id;
    m_job_type_id_isSet = true;
}

bool OAIChargeDTO::is_job_type_id_Set() const{
    return m_job_type_id_isSet;
}

bool OAIChargeDTO::is_job_type_id_Valid() const{
    return m_job_type_id_isValid;
}

OAIChargeLanguageCombinationDTO OAIChargeDTO::getLanguageCombination() const {
    return m_language_combination;
}
void OAIChargeDTO::setLanguageCombination(const OAIChargeLanguageCombinationDTO &language_combination) {
    m_language_combination = language_combination;
    m_language_combination_isSet = true;
}

bool OAIChargeDTO::is_language_combination_Set() const{
    return m_language_combination_isSet;
}

bool OAIChargeDTO::is_language_combination_Valid() const{
    return m_language_combination_isValid;
}

QString OAIChargeDTO::getLanguageCombinationIdNumber() const {
    return m_language_combination_id_number;
}
void OAIChargeDTO::setLanguageCombinationIdNumber(const QString &language_combination_id_number) {
    m_language_combination_id_number = language_combination_id_number;
    m_language_combination_id_number_isSet = true;
}

bool OAIChargeDTO::is_language_combination_id_number_Set() const{
    return m_language_combination_id_number_isSet;
}

bool OAIChargeDTO::is_language_combination_id_number_Valid() const{
    return m_language_combination_id_number_isValid;
}

double OAIChargeDTO::getMinimumCharge() const {
    return m_minimum_charge;
}
void OAIChargeDTO::setMinimumCharge(const double &minimum_charge) {
    m_minimum_charge = minimum_charge;
    m_minimum_charge_isSet = true;
}

bool OAIChargeDTO::is_minimum_charge_Set() const{
    return m_minimum_charge_isSet;
}

bool OAIChargeDTO::is_minimum_charge_Valid() const{
    return m_minimum_charge_isValid;
}

QString OAIChargeDTO::getRateOrigin() const {
    return m_rate_origin;
}
void OAIChargeDTO::setRateOrigin(const QString &rate_origin) {
    m_rate_origin = rate_origin;
    m_rate_origin_isSet = true;
}

bool OAIChargeDTO::is_rate_origin_Set() const{
    return m_rate_origin_isSet;
}

bool OAIChargeDTO::is_rate_origin_Valid() const{
    return m_rate_origin_isValid;
}

double OAIChargeDTO::getTotal() const {
    return m_total;
}
void OAIChargeDTO::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIChargeDTO::is_total_Set() const{
    return m_total_isSet;
}

bool OAIChargeDTO::is_total_Valid() const{
    return m_total_isValid;
}

QString OAIChargeDTO::getType() const {
    return m_type;
}
void OAIChargeDTO::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIChargeDTO::is_type_Set() const{
    return m_type_isSet;
}

bool OAIChargeDTO::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIChargeDTO::isSet() const {
...
bool OAIChargeDTO::isValid() const {
