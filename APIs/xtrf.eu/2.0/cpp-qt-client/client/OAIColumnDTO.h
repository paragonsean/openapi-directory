...
#ifndef OAIColumnDTO_H
#define OAIColumnDTO_H
...
class OAIColumnDTO : public OAIObject {
public:
    OAIColumnDTO();
    OAIColumnDTO(QString json);
    ~OAIColumnDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnDTO)

#endif // OAIColumnDTO_H
