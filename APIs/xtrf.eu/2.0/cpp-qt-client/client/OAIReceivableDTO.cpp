...
OAIReceivableDTO::OAIReceivableDTO(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReceivableDTO::OAIReceivableDTO() {
    this->initializeModel();
}

OAIReceivableDTO::~OAIReceivableDTO() {}

void OAIReceivableDTO::initializeModel() {
...
void OAIReceivableDTO::fromJson(QString jsonString) {
...
void OAIReceivableDTO::fromJsonObject(QJsonObject json) {
...
QString OAIReceivableDTO::asJson() const {
...
QJsonObject OAIReceivableDTO::asJsonObject() const {
    QJsonObject obj;
...
qint64 OAIReceivableDTO::getCalculationUnitId() const {
    return m_calculation_unit_id;
}
void OAIReceivableDTO::setCalculationUnitId(const qint64 &calculation_unit_id) {
    m_calculation_unit_id = calculation_unit_id;
    m_calculation_unit_id_isSet = true;
}

bool OAIReceivableDTO::is_calculation_unit_id_Set() const{
    return m_calculation_unit_id_isSet;
}

bool OAIReceivableDTO::is_calculation_unit_id_Valid() const{
    return m_calculation_unit_id_isValid;
}

qint64 OAIReceivableDTO::getCurrencyId() const {
    return m_currency_id;
}
void OAIReceivableDTO::setCurrencyId(const qint64 &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAIReceivableDTO::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAIReceivableDTO::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

QString OAIReceivableDTO::getDescription() const {
    return m_description;
}
void OAIReceivableDTO::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIReceivableDTO::is_description_Set() const{
    return m_description_isSet;
}

bool OAIReceivableDTO::is_description_Valid() const{
    return m_description_isValid;
}

qint64 OAIReceivableDTO::getId() const {
    return m_id;
}
void OAIReceivableDTO::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIReceivableDTO::is_id_Set() const{
    return m_id_isSet;
}

bool OAIReceivableDTO::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIReceivableDTO::isIgnoreMinimumCharge() const {
    return m_ignore_minimum_charge;
}
void OAIReceivableDTO::setIgnoreMinimumCharge(const bool &ignore_minimum_charge) {
    m_ignore_minimum_charge = ignore_minimum_charge;
    m_ignore_minimum_charge_isSet = true;
}

bool OAIReceivableDTO::is_ignore_minimum_charge_Set() const{
    return m_ignore_minimum_charge_isSet;
}

bool OAIReceivableDTO::is_ignore_minimum_charge_Valid() const{
    return m_ignore_minimum_charge_isValid;
}

QString OAIReceivableDTO::getInvoiceId() const {
    return m_invoice_id;
}
void OAIReceivableDTO::setInvoiceId(const QString &invoice_id) {
    m_invoice_id = invoice_id;
    m_invoice_id_isSet = true;
}

bool OAIReceivableDTO::is_invoice_id_Set() const{
    return m_invoice_id_isSet;
}

bool OAIReceivableDTO::is_invoice_id_Valid() const{
    return m_invoice_id_isValid;
}

qint64 OAIReceivableDTO::getJobTypeId() const {
    return m_job_type_id;
}
void OAIReceivableDTO::setJobTypeId(const qint64 &job_type_id) {
    m_job_type_id = job_type_id;
    m_job_type_id_isSet = true;
}

bool OAIReceivableDTO::is_job_type_id_Set() const{
    return m_job_type_id_isSet;
}

bool OAIReceivableDTO::is_job_type_id_Valid() const{
    return m_job_type_id_isValid;
}

OAIChargeLanguageCombinationDTO OAIReceivableDTO::getLanguageCombination() const {
    return m_language_combination;
}
void OAIReceivableDTO::setLanguageCombination(const OAIChargeLanguageCombinationDTO &language_combination) {
    m_language_combination = language_combination;
    m_language_combination_isSet = true;
}

bool OAIReceivableDTO::is_language_combination_Set() const{
    return m_language_combination_isSet;
}

bool OAIReceivableDTO::is_language_combination_Valid() const{
    return m_language_combination_isValid;
}

QString OAIReceivableDTO::getLanguageCombinationIdNumber() const {
    return m_language_combination_id_number;
}
void OAIReceivableDTO::setLanguageCombinationIdNumber(const QString &language_combination_id_number) {
    m_language_combination_id_number = language_combination_id_number;
    m_language_combination_id_number_isSet = true;
}

bool OAIReceivableDTO::is_language_combination_id_number_Set() const{
    return m_language_combination_id_number_isSet;
}

bool OAIReceivableDTO::is_language_combination_id_number_Valid() const{
    return m_language_combination_id_number_isValid;
}

double OAIReceivableDTO::getMinimumCharge() const {
    return m_minimum_charge;
}
void OAIReceivableDTO::setMinimumCharge(const double &minimum_charge) {
    m_minimum_charge = minimum_charge;
    m_minimum_charge_isSet = true;
}

bool OAIReceivableDTO::is_minimum_charge_Set() const{
    return m_minimum_charge_isSet;
}

bool OAIReceivableDTO::is_minimum_charge_Valid() const{
    return m_minimum_charge_isValid;
}

double OAIReceivableDTO::getQuantity() const {
    return m_quantity;
}
void OAIReceivableDTO::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIReceivableDTO::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIReceivableDTO::is_quantity_Valid() const{
    return m_quantity_isValid;
}

double OAIReceivableDTO::getRate() const {
    return m_rate;
}
void OAIReceivableDTO::setRate(const double &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIReceivableDTO::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIReceivableDTO::is_rate_Valid() const{
    return m_rate_isValid;
}

QString OAIReceivableDTO::getRateOrigin() const {
    return m_rate_origin;
}
void OAIReceivableDTO::setRateOrigin(const QString &rate_origin) {
    m_rate_origin = rate_origin;
    m_rate_origin_isSet = true;
}

bool OAIReceivableDTO::is_rate_origin_Set() const{
    return m_rate_origin_isSet;
}

bool OAIReceivableDTO::is_rate_origin_Valid() const{
    return m_rate_origin_isValid;
}

qint64 OAIReceivableDTO::getTaskId() const {
    return m_task_id;
}
void OAIReceivableDTO::setTaskId(const qint64 &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAIReceivableDTO::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAIReceivableDTO::is_task_id_Valid() const{
    return m_task_id_isValid;
}

double OAIReceivableDTO::getTotal() const {
    return m_total;
}
void OAIReceivableDTO::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIReceivableDTO::is_total_Set() const{
    return m_total_isSet;
}

bool OAIReceivableDTO::is_total_Valid() const{
    return m_total_isValid;
}

QString OAIReceivableDTO::getType() const {
    return m_type;
}
void OAIReceivableDTO::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIReceivableDTO::is_type_Set() const{
    return m_type_isSet;
}

bool OAIReceivableDTO::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIReceivableDTO::isSet() const {
...
bool OAIReceivableDTO::isValid() const {
