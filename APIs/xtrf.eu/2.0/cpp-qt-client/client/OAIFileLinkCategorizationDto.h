...
/*
 * OAIFileLinkCategorizationDto.h
 *
 * 
 */

#ifndef OAIFileLinkCategorizationDto_H
#define OAIFileLinkCategorizationDto_H
...
class OAIFileLinkCategorizationDto : public OAIObject {
public:
    OAIFileLinkCategorizationDto();
    OAIFileLinkCategorizationDto(QString json);
    ~OAIFileLinkCategorizationDto() override;
    ...
    bool isToBeGenerated() const;
    void setToBeGenerated(const bool &to_be_generated);
    bool is_to_be_generated_Set() const;
    bool is_to_be_generated_Valid() const;
...
private:
    ...
    bool m_to_be_generated;
    bool m_to_be_generated_isSet;
    bool m_to_be_generated_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileLinkCategorizationDto)

#endif // OAIFileLinkCategorizationDto_H
