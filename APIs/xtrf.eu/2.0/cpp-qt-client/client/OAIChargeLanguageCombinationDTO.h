...
/*
 * OAIChargeLanguageCombinationDTO.h
 *
 * 
 */

#ifndef OAIChargeLanguageCombinationDTO_H
#define OAIChargeLanguageCombinationDTO_H
...
class OAIChargeLanguageCombinationDTO : public OAIObject {
public:
    OAIChargeLanguageCombinationDTO();
    OAIChargeLanguageCombinationDTO(QString json);
    ~OAIChargeLanguageCombinationDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChargeLanguageCombinationDTO)

#endif // OAIChargeLanguageCombinationDTO_H
