...
#ifndef OAIIndustryDTO_H
#define OAIIndustryDTO_H
...
class OAIIndustryDTO : public OAIObject {
public:
    OAIIndustryDTO();
    OAIIndustryDTO(QString json);
    ~OAIIndustryDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndustryDTO)

#endif // OAIIndustryDTO_H
