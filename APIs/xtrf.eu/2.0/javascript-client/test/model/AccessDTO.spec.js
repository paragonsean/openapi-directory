...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.AccessDTO();
  });
  ...
  describe('AccessDTO', function() {
    it('should create an instance of AccessDTO', function() {
      // uncomment below and update the code to test AccessDTO
      //var instance = new XtrfHomePortalApi.AccessDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.AccessDTO);
    });
