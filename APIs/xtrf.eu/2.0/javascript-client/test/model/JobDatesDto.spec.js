...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.JobDatesDto();
  });
  ...
  describe('JobDatesDto', function() {
    it('should create an instance of JobDatesDto', function() {
      // uncomment below and update the code to test JobDatesDto
      //var instance = new XtrfHomePortalApi.JobDatesDto();
      //expect(instance).to.be.a(XtrfHomePortalApi.JobDatesDto);
    });
