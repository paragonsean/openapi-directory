...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.CustomerContactEmailsDTO();
  });
  ...
  describe('CustomerContactEmailsDTO', function() {
    it('should create an instance of CustomerContactEmailsDTO', function() {
      // uncomment below and update the code to test CustomerContactEmailsDTO
      //var instance = new XtrfHomePortalApi.CustomerContactEmailsDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.CustomerContactEmailsDTO);
    });
