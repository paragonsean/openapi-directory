...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ProviderPersonDTO();
  });
  ...
  describe('ProviderPersonDTO', function() {
    it('should create an instance of ProviderPersonDTO', function() {
      // uncomment below and update the code to test ProviderPersonDTO
      //var instance = new XtrfHomePortalApi.ProviderPersonDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ProviderPersonDTO);
    });
