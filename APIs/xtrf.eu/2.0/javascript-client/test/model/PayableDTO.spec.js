...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.PayableDTO();
  });
  ...
  describe('PayableDTO', function() {
    it('should create an instance of PayableDTO', function() {
      // uncomment below and update the code to test PayableDTO
      //var instance = new XtrfHomePortalApi.PayableDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.PayableDTO);
    });
