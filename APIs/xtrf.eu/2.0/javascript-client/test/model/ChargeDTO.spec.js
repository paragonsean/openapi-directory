...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ChargeDTO();
  });
  ...
  describe('ChargeDTO', function() {
    it('should create an instance of ChargeDTO', function() {
      // uncomment below and update the code to test ChargeDTO
      //var instance = new XtrfHomePortalApi.ChargeDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ChargeDTO);
    });
