...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.MacroRequestDTO();
  });
  ...
  describe('MacroRequestDTO', function() {
    it('should create an instance of MacroRequestDTO', function() {
      // uncomment below and update the code to test MacroRequestDTO
      //var instance = new XtrfHomePortalApi.MacroRequestDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.MacroRequestDTO);
    });
