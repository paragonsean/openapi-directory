...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ReceivableDTO();
  });
  ...
  describe('ReceivableDTO', function() {
    it('should create an instance of ReceivableDTO', function() {
      // uncomment below and update the code to test ReceivableDTO
      //var instance = new XtrfHomePortalApi.ReceivableDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ReceivableDTO);
    });
