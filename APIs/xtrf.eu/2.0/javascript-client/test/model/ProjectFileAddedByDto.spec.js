...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ProjectFileAddedByDto();
  });
  ...
  describe('ProjectFileAddedByDto', function() {
    it('should create an instance of ProjectFileAddedByDto', function() {
      // uncomment below and update the code to test ProjectFileAddedByDto
      //var instance = new XtrfHomePortalApi.ProjectFileAddedByDto();
      //expect(instance).to.be.a(XtrfHomePortalApi.ProjectFileAddedByDto);
    });
