...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ProviderDTO();
  });
  ...
  describe('ProviderDTO', function() {
    it('should create an instance of ProviderDTO', function() {
      ...
      //var instance = new XtrfHomePortalApi.ProviderDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ProviderDTO);
    });
    ...
    it('should have the property competencies (base name: "competencies")', function() {
      // uncomment below and update the code to test the property competencies
      //var instance = new XtrfHomePortalApi.ProviderDTO();
      //expect(instance).to.be();
    });
