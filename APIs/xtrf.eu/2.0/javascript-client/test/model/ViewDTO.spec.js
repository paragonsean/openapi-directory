...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ViewDTO();
  });
  ...
  describe('ViewDTO', function() {
    it('should create an instance of ViewDTO', function() {
      // uncomment below and update the code to test ViewDTO
      //var instance = new XtrfHomePortalApi.ViewDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ViewDTO);
    });
