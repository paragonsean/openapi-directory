...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ViewDetailsDTO();
  });
  ...
  describe('ViewDetailsDTO', function() {
    it('should create an instance of ViewDetailsDTO', function() {
      // uncomment below and update the code to test ViewDetailsDTO
      //var instance = new XtrfHomePortalApi.ViewDetailsDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ViewDetailsDTO);
    });
