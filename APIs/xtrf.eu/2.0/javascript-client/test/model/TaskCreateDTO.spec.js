...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.TaskCreateDTO();
  });
  ...
  describe('TaskCreateDTO', function() {
    it('should create an instance of TaskCreateDTO', function() {
      // uncomment below and update the code to test TaskCreateDTO
      //var instance = new XtrfHomePortalApi.TaskCreateDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.TaskCreateDTO);
    });
