...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.AddressDTO();
  });
  ...
  describe('AddressDTO', function() {
    it('should create an instance of AddressDTO', function() {
      ...
      //var instance = new XtrfHomePortalApi.AddressDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.AddressDTO);
    });
    ...
    it('should have the property provinceId (base name: "provinceId")', function() {
      // uncomment below and update the code to test the property provinceId
      //var instance = new XtrfHomePortalApi.AddressDTO();
      //expect(instance).to.be();
    });

    it('should have the property sameAsBillingAddress (base name: "sameAsBillingAddress")', function() {
      // uncomment below and update the code to test the property sameAsBillingAddress
      //var instance = new XtrfHomePortalApi.AddressDTO();
      //expect(instance).to.be();
    });
