...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.QuoteDTOv2();
  });
  ...
  describe('QuoteDTOv2', function() {
    it('should create an instance of QuoteDTOv2', function() {
      // uncomment below and update the code to test QuoteDTOv2
      //var instance = new XtrfHomePortalApi.QuoteDTOv2();
      //expect(instance).to.be.a(XtrfHomePortalApi.QuoteDTOv2);
    });
    ...
    it('should have the property quoteExpiry (base name: "quoteExpiry")', function() {
      // uncomment below and update the code to test the property quoteExpiry
      //var instance = new XtrfHomePortalApi.QuoteDTOv2();
      //expect(instance).to.be();
    });
