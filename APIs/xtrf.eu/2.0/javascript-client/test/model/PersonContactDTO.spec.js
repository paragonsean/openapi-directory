...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.PersonContactDTO();
  });
  ...
  describe('PersonContactDTO', function() {
    it('should create an instance of PersonContactDTO', function() {
      // uncomment below and update the code to test PersonContactDTO
      //var instance = new XtrfHomePortalApi.PersonContactDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.PersonContactDTO);
    });
