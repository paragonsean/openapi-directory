...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.JobDto();
  });
  ...
  describe('JobDto', function() {
    it('should create an instance of JobDto', function() {
      // uncomment below and update the code to test JobDto
      //var instance = new XtrfHomePortalApi.JobDto();
      //expect(instance).to.be.a(XtrfHomePortalApi.JobDto);
    });
    ...
    it('should have the property stepNumber (base name: "stepNumber")', function() {
