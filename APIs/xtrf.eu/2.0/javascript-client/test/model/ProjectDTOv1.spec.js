...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ProjectDTOv1();
  });
  ...
  describe('ProjectDTOv1', function() {
    it('should create an instance of ProjectDTOv1', function() {
      // uncomment below and update the code to test ProjectDTOv1
      //var instance = new XtrfHomePortalApi.ProjectDTOv1();
      //expect(instance).to.be.a(XtrfHomePortalApi.ProjectDTOv1);
    });
