...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ViewsBriefDTO();
  });
  ...
  describe('ViewsBriefDTO', function() {
    it('should create an instance of ViewsBriefDTO', function() {
      // uncomment below and update the code to test ViewsBriefDTO
      //var instance = new XtrfHomePortalApi.ViewsBriefDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ViewsBriefDTO);
    });
