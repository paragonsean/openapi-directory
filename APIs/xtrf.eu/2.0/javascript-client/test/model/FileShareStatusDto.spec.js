...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.FileShareStatusDto();
  });
  ...
  describe('FileShareStatusDto', function() {
    it('should create an instance of FileShareStatusDto', function() {
      // uncomment below and update the code to test FileShareStatusDto
      //var instance = new XtrfHomePortalApi.FileShareStatusDto();
      //expect(instance).to.be.a(XtrfHomePortalApi.FileShareStatusDto);
    });
