...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ReceivableCreateDTO();
  });
  ...
  describe('ReceivableCreateDTO', function() {
    it('should create an instance of ReceivableCreateDTO', function() {
      // uncomment below and update the code to test ReceivableCreateDTO
      //var instance = new XtrfHomePortalApi.ReceivableCreateDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ReceivableCreateDTO);
    });
