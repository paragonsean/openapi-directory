...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.FormDataMultiPart();
  });
  ...
  describe('FormDataMultiPart', function() {
    it('should create an instance of FormDataMultiPart', function() {
      // uncomment below and update the code to test FormDataMultiPart
      //var instance = new XtrfHomePortalApi.FormDataMultiPart();
      //expect(instance).to.be.a(XtrfHomePortalApi.FormDataMultiPart);
    });
