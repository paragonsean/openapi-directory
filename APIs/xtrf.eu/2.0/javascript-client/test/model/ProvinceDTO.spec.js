...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ProvinceDTO();
  });
  ...
  describe('ProvinceDTO', function() {
    it('should create an instance of ProvinceDTO', function() {
      // uncomment below and update the code to test ProvinceDTO
      //var instance = new XtrfHomePortalApi.ProvinceDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ProvinceDTO);
    });
