...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.BodyPartMediaType();
  });
  ...
  describe('BodyPartMediaType', function() {
    it('should create an instance of BodyPartMediaType', function() {
      ...
      //var instance = new XtrfHomePortalApi.BodyPartMediaType();
      //expect(instance).to.be.a(XtrfHomePortalApi.BodyPartMediaType);
    });
