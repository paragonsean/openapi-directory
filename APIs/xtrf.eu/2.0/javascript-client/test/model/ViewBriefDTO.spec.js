...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XtrfHomePortalApi.ViewBriefDTO();
  });
  ...
  describe('ViewBriefDTO', function() {
    it('should create an instance of ViewBriefDTO', function() {
      // uncomment below and update the code to test ViewBriefDTO
      //var instance = new XtrfHomePortalApi.ViewBriefDTO();
      //expect(instance).to.be.a(XtrfHomePortalApi.ViewBriefDTO);
    });
