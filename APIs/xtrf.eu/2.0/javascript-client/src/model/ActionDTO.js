...
class ActionDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>ActionDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionDTO</code>.
     */
 ...
 */
ActionDTO.prototype['header'] = undefined;

/**
 * @member {String} name
 */
ActionDTO.prototype['name'] = undefined;
