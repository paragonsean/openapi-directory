...
class SubscriptionDTO {
    ...
    constructor() { 
        ...
        SubscriptionDTO.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionDTO</code>.
     */
 ...
 * @member {String} embed
 */
SubscriptionDTO.prototype['embed'] = undefined;

/**
 * event to which you want to subscribe
 * @member {String} event
 */
SubscriptionDTO.prototype['event'] = undefined;

/**
 * filter expression in the form 'attribute=value'
 * @member {String} filter
 */
SubscriptionDTO.prototype['filter'] = undefined;

/**
 * url that will be invoked by XTRF on event
 * @member {String} url
 */
SubscriptionDTO.prototype['url'] = undefined;
