...
class SettingsDTO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('local')) {
                obj['local'] = LocalSettingsDTO.constructFromObject(data['local']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['local']) { // data not null
          LocalSettingsDTO.validateJSON(data['local']);
        }
...
/**
 * @member {module:model/LocalSettingsDTO} local
 */
SettingsDTO.prototype['local'] = undefined;

/**
 * @member {String} name
 */
SettingsDTO.prototype['name'] = undefined;
