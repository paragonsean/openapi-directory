...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://presentation.s.xtrf.eu/home-api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://presentation.s.xtrf.eu/home-api
         */
        ...
        this.authentications = {
            'X-AUTH-ACCESS-TOKEN': {type: 'apiKey', 'in': 'header', name: 'X-AUTH-ACCESS-TOKEN'}
        }
