...
<a id="getChart"></a>
# **getChart**
> String getChart(cht, chl, chd, chds, choe, chld, chxr, chxp, chof, chs, chdl, chdls, chg, chco, chtt, chts, chxt, chxl, chxs, chm, chls, chlps, chma, chdlp, chf, chbh, chbr, chan, chli, icac, ichm, icff, icfs, iclocale, icwt, icretina, icqrb, icqrf)
...
|------------- | ------------- | ------------- | -------------|
| **cht** | **String**| Chart type | [enum: bvs, bvg, bhs, bhg, bvo, p, p3, pc, pd, ls, lc, lxy, ls:nda, lc:nda, lxy:nda, pa, bb, gv, gv:dot, gv:neato, gv:circo, gv:fdp, gv:osage, gv:twopi, qr, r] |
...
| **choe** | **String**| QRCode data encoding | [optional] [enum: UTF-8] |
