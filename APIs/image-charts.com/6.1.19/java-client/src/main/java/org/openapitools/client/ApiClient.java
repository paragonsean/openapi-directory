...
public class ApiClient {
    ...
    private String basePath = "https://image-charts.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.1.19/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://image-charts.com
