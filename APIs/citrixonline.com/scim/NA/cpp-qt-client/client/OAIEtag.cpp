...
void OAIEtag::initializeModel() {

    m_supported_isSet = false;
    m_supported_isValid = false;
}

void OAIEtag::fromJson(QString jsonString) {
...
void OAIEtag::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIEtag::asJsonObject() const {
    QJsonObject obj;
...
bool OAIEtag::isSupported() const {
    return m_supported;
}
void OAIEtag::setSupported(const bool &supported) {
    m_supported = supported;
    m_supported_isSet = true;
}

bool OAIEtag::is_supported_Set() const{
    return m_supported_isSet;
}

bool OAIEtag::is_supported_Valid() const{
    return m_supported_isValid;
}

bool OAIEtag::isSet() const {
