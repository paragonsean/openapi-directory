...
#ifndef OAIXmlDataFormat_H
#define OAIXmlDataFormat_H
...
class OAIXmlDataFormat : public OAIObject {
public:
    OAIXmlDataFormat();
    OAIXmlDataFormat(QString json);
    ~OAIXmlDataFormat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXmlDataFormat)

#endif // OAIXmlDataFormat_H
