...
public:
    ...
    QList<OAISchemaSubAttribute> getSubAttributes() const;
    void setSubAttributes(const QList<OAISchemaSubAttribute> &sub_attributes);
...
private:
    ...
    QList<OAISchemaSubAttribute> m_sub_attributes;
