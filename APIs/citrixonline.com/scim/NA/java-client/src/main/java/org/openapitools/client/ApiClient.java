...
public class ApiClient {
    ...
    private String basePath = "https://api.citrixonline.com/identity/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/N/A/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.citrixonline.com/identity/v1
