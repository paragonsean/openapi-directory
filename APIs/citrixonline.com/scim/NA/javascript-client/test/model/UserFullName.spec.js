...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Scim.UserFullName();
  });
  ...
  describe('UserFullName', function() {
    it('should create an instance of UserFullName', function() {
      // uncomment below and update the code to test UserFullName
      //var instance = new Scim.UserFullName();
      //expect(instance).to.be.a(Scim.UserFullName);
    });
