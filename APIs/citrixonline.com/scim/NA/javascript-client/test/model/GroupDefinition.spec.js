...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Scim.GroupDefinition();
  });
  ...
  describe('GroupDefinition', function() {
    it('should create an instance of GroupDefinition', function() {
      // uncomment below and update the code to test GroupDefinition
      //var instance = new Scim.GroupDefinition();
      //expect(instance).to.be.a(Scim.GroupDefinition);
    });
