...
public class AttendeeByOrganizer {
  ...
  public AttendeeByOrganizer() {
  }

  public AttendeeByOrganizer attendeeEmail(String attendeeEmail) {
  ...
  public AttendeeByOrganizer attendeeName(String attendeeName) {
  ...
  public AttendeeByOrganizer conferenceCallInfo(String conferenceCallInfo) {
  ...
  public AttendeeByOrganizer duration(Integer duration) {
  ...
  public AttendeeByOrganizer email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AttendeeByOrganizer endTime(OffsetDateTime endTime) {
  ...
  public AttendeeByOrganizer firstName(String firstName) {
  ...
  public AttendeeByOrganizer groupName(String groupName) {
  ...
  public AttendeeByOrganizer joinTime(OffsetDateTime joinTime) {
  ...
  public AttendeeByOrganizer lastName(String lastName) {
  ...
  public AttendeeByOrganizer leaveTime(OffsetDateTime leaveTime) {
  ...
  public AttendeeByOrganizer meetingId(Long meetingId) {
  ...
  public AttendeeByOrganizer meetingInstanceKey(Long meetingInstanceKey) {
  ...
  public AttendeeByOrganizer meetingType(MeetingType meetingType) {
  ...
  public AttendeeByOrganizer name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AttendeeByOrganizer newMeetingId(String newMeetingId) {
  ...
  public AttendeeByOrganizer numAttendees(Integer numAttendees) {
  ...
  public AttendeeByOrganizer organizerkey(Long organizerkey) {
  ...
  public AttendeeByOrganizer startTime(OffsetDateTime startTime) {
  ...
  public AttendeeByOrganizer subject(String subject) {
  ...
  public boolean equals(Object o) {
    ...
    AttendeeByOrganizer attendeeByOrganizer = (AttendeeByOrganizer) o;
    return Objects.equals(this.attendeeEmail, attendeeByOrganizer.attendeeEmail) &&
        Objects.equals(this.attendeeName, attendeeByOrganizer.attendeeName) &&
        Objects.equals(this.conferenceCallInfo, attendeeByOrganizer.conferenceCallInfo) &&
        Objects.equals(this.duration, attendeeByOrganizer.duration) &&
        Objects.equals(this.email, attendeeByOrganizer.email) &&
        Objects.equals(this.endTime, attendeeByOrganizer.endTime) &&
        Objects.equals(this.firstName, attendeeByOrganizer.firstName) &&
        Objects.equals(this.groupName, attendeeByOrganizer.groupName) &&
        Objects.equals(this.joinTime, attendeeByOrganizer.joinTime) &&
        Objects.equals(this.lastName, attendeeByOrganizer.lastName) &&
        Objects.equals(this.leaveTime, attendeeByOrganizer.leaveTime) &&
        Objects.equals(this.meetingId, attendeeByOrganizer.meetingId) &&
        Objects.equals(this.meetingInstanceKey, attendeeByOrganizer.meetingInstanceKey) &&
        Objects.equals(this.meetingType, attendeeByOrganizer.meetingType) &&
        Objects.equals(this.name, attendeeByOrganizer.name) &&
        Objects.equals(this.newMeetingId, attendeeByOrganizer.newMeetingId) &&
        Objects.equals(this.numAttendees, attendeeByOrganizer.numAttendees) &&
        Objects.equals(this.organizerkey, attendeeByOrganizer.organizerkey) &&
        Objects.equals(this.startTime, attendeeByOrganizer.startTime) &&
        Objects.equals(this.subject, attendeeByOrganizer.subject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attendeeEmail, attendeeName, conferenceCallInfo, duration, email, endTime, firstName, groupName, joinTime, lastName, leaveTime, meetingId, meetingInstanceKey, meetingType, name, newMeetingId, numAttendees, organizerkey, startTime, subject);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttendeeByOrganizer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttendeeByOrganizer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttendeeByOrganizer is not found in the empty JSON string", AttendeeByOrganizer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttendeeByOrganizer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttendeeByOrganizer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttendeeByOrganizer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttendeeByOrganizer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttendeeByOrganizer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttendeeByOrganizer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttendeeByOrganizer.class));

       return (TypeAdapter<T>) new TypeAdapter<AttendeeByOrganizer>() {
           @Override
           public void write(JsonWriter out, AttendeeByOrganizer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttendeeByOrganizer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttendeeByOrganizer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttendeeByOrganizer
   * @throws IOException if the JSON string is invalid with respect to AttendeeByOrganizer
   */
  public static AttendeeByOrganizer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttendeeByOrganizer.class);
  }

  /**
   * Convert an instance of AttendeeByOrganizer to an JSON string
   *
   * @return JSON string
   */
