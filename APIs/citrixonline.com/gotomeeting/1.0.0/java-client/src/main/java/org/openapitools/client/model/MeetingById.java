...
public class MeetingById {
  ...
  public MeetingById conferenceCallInfo(String conferenceCallInfo) {
  ...
  public MeetingById createTime(OffsetDateTime createTime) {
  ...
  public MeetingById duration(Integer duration) {
  ...
  public MeetingById endTime(OffsetDateTime endTime) {
  ...
  public MeetingById maxParticipants(Integer maxParticipants) {
  ...
  public MeetingById meetingId(Long meetingId) {
  ...
  public MeetingById meetingKey(Long meetingKey) {
  ...
  public MeetingById meetingType(MeetingType meetingType) {
  ...
  public MeetingById passwordRequired(Boolean passwordRequired) {
  ...
  public MeetingById startTime(OffsetDateTime startTime) {
  ...
  public MeetingById status(MeetingStatus status) {
    this.status = status;
    return this;
  }
  ...
  public MeetingById subject(String subject) {
  ...
  public MeetingById uniqueMeetingId(Long uniqueMeetingId) {
  ...
  public boolean equals(Object o) {
    ...
    MeetingById meetingById = (MeetingById) o;
    return Objects.equals(this.conferenceCallInfo, meetingById.conferenceCallInfo) &&
        Objects.equals(this.createTime, meetingById.createTime) &&
        Objects.equals(this.duration, meetingById.duration) &&
        Objects.equals(this.endTime, meetingById.endTime) &&
        Objects.equals(this.maxParticipants, meetingById.maxParticipants) &&
        Objects.equals(this.meetingId, meetingById.meetingId) &&
        Objects.equals(this.meetingKey, meetingById.meetingKey) &&
        Objects.equals(this.meetingType, meetingById.meetingType) &&
        Objects.equals(this.passwordRequired, meetingById.passwordRequired) &&
        Objects.equals(this.startTime, meetingById.startTime) &&
        Objects.equals(this.status, meetingById.status) &&
        Objects.equals(this.subject, meetingById.subject) &&
        Objects.equals(this.uniqueMeetingId, meetingById.uniqueMeetingId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conferenceCallInfo, createTime, duration, endTime, maxParticipants, meetingId, meetingKey, meetingType, passwordRequired, startTime, status, subject, uniqueMeetingId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MeetingById
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MeetingById.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MeetingById is not found in the empty JSON string", MeetingById.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MeetingById.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MeetingById` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MeetingById.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MeetingById.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MeetingById' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MeetingById> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MeetingById.class));

       return (TypeAdapter<T>) new TypeAdapter<MeetingById>() {
           @Override
           public void write(JsonWriter out, MeetingById value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MeetingById read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MeetingById given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MeetingById
   * @throws IOException if the JSON string is invalid with respect to MeetingById
   */
  public static MeetingById fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MeetingById.class);
  }

  /**
   * Convert an instance of MeetingById to an JSON string
   *
   * @return JSON string
   */
