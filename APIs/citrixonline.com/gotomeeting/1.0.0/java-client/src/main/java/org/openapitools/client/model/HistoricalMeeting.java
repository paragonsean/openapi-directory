...
public class HistoricalMeeting {
  ...
  public HistoricalMeeting() {
  }

  public HistoricalMeeting accountKey(String accountKey) {
  ...
  public HistoricalMeeting conferenceCallInfo(String conferenceCallInfo) {
  ...
  public HistoricalMeeting duration(String duration) {
  ...
  public HistoricalMeeting email(String email) {
    this.email = email;
    return this;
  }
  ...
  public HistoricalMeeting endTime(OffsetDateTime endTime) {
  ...
  public HistoricalMeeting firstName(String firstName) {
  ...
  public HistoricalMeeting lastName(String lastName) {
  ...
  public HistoricalMeeting locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public HistoricalMeeting meetingId(String meetingId) {
  ...
  public HistoricalMeeting meetingType(MeetingType meetingType) {
  ...
  public HistoricalMeeting numAttendees(String numAttendees) {
  ...
  public HistoricalMeeting organizerKey(String organizerKey) {
  ...
  public HistoricalMeeting sessionId(String sessionId) {
  ...
  public HistoricalMeeting startTime(OffsetDateTime startTime) {
  ...
  public HistoricalMeeting subject(String subject) {
  ...
  public boolean equals(Object o) {
    ...
    HistoricalMeeting historicalMeeting = (HistoricalMeeting) o;
    return Objects.equals(this.accountKey, historicalMeeting.accountKey) &&
        Objects.equals(this.conferenceCallInfo, historicalMeeting.conferenceCallInfo) &&
        Objects.equals(this.duration, historicalMeeting.duration) &&
        Objects.equals(this.email, historicalMeeting.email) &&
        Objects.equals(this.endTime, historicalMeeting.endTime) &&
        Objects.equals(this.firstName, historicalMeeting.firstName) &&
        Objects.equals(this.lastName, historicalMeeting.lastName) &&
        Objects.equals(this.locale, historicalMeeting.locale) &&
        Objects.equals(this.meetingId, historicalMeeting.meetingId) &&
        Objects.equals(this.meetingType, historicalMeeting.meetingType) &&
        Objects.equals(this.numAttendees, historicalMeeting.numAttendees) &&
        Objects.equals(this.organizerKey, historicalMeeting.organizerKey) &&
        Objects.equals(this.sessionId, historicalMeeting.sessionId) &&
        Objects.equals(this.startTime, historicalMeeting.startTime) &&
        Objects.equals(this.subject, historicalMeeting.subject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountKey, conferenceCallInfo, duration, email, endTime, firstName, lastName, locale, meetingId, meetingType, numAttendees, organizerKey, sessionId, startTime, subject);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HistoricalMeeting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HistoricalMeeting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HistoricalMeeting is not found in the empty JSON string", HistoricalMeeting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HistoricalMeeting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HistoricalMeeting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HistoricalMeeting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HistoricalMeeting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HistoricalMeeting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HistoricalMeeting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HistoricalMeeting.class));

       return (TypeAdapter<T>) new TypeAdapter<HistoricalMeeting>() {
           @Override
           public void write(JsonWriter out, HistoricalMeeting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HistoricalMeeting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HistoricalMeeting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HistoricalMeeting
   * @throws IOException if the JSON string is invalid with respect to HistoricalMeeting
   */
  public static HistoricalMeeting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HistoricalMeeting.class);
  }

  /**
   * Convert an instance of HistoricalMeeting to an JSON string
   *
   * @return JSON string
   */
