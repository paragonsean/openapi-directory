...
/*
 * OAIHistoricalMeetingByGroup.h
 *
 * Describes a historical meeting within specified dates for a specified group.
 */

#ifndef OAIHistoricalMeetingByGroup_H
#define OAIHistoricalMeetingByGroup_H
...
class OAIHistoricalMeetingByGroup : public OAIObject {
public:
    OAIHistoricalMeetingByGroup();
    OAIHistoricalMeetingByGroup(QString json);
    ~OAIHistoricalMeetingByGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalMeetingByGroup)

#endif // OAIHistoricalMeetingByGroup_H
