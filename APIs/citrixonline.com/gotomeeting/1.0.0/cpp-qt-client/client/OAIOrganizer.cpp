...
QString OAIOrganizer::getFirstName() const {
    return m_first_name;
}
void OAIOrganizer::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIOrganizer::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIOrganizer::is_first_name_Valid() const{
    return m_first_name_isValid;
}

qint64 OAIOrganizer::getGroupId() const {
    return m_group_id;
}
void OAIOrganizer::setGroupId(const qint64 &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIOrganizer::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIOrganizer::is_group_id_Valid() const{
    return m_group_id_isValid;
}

QString OAIOrganizer::getGroupName() const {
    return m_group_name;
}
void OAIOrganizer::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIOrganizer::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIOrganizer::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIOrganizer::getLastName() const {
    return m_last_name;
}
void OAIOrganizer::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIOrganizer::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIOrganizer::is_last_name_Valid() const{
    return m_last_name_isValid;
}

qint32 OAIOrganizer::getMaxNumAttendeesAllowed() const {
    return m_max_num_attendees_allowed;
}
void OAIOrganizer::setMaxNumAttendeesAllowed(const qint32 &max_num_attendees_allowed) {
    m_max_num_attendees_allowed = max_num_attendees_allowed;
    m_max_num_attendees_allowed_isSet = true;
}

bool OAIOrganizer::is_max_num_attendees_allowed_Set() const{
    return m_max_num_attendees_allowed_isSet;
}

bool OAIOrganizer::is_max_num_attendees_allowed_Valid() const{
    return m_max_num_attendees_allowed_isValid;
}

qint64 OAIOrganizer::getOrganizerKey() const {
    return m_organizer_key;
}
void OAIOrganizer::setOrganizerKey(const qint64 &organizer_key) {
...
QList<OAIProduct> OAIOrganizer::getProducts() const {
    return m_products;
}
void OAIOrganizer::setProducts(const QList<OAIProduct> &products) {
    m_products = products;
    m_products_isSet = true;
}

bool OAIOrganizer::is_products_Set() const{
    return m_products_isSet;
}

bool OAIOrganizer::is_products_Valid() const{
    return m_products_isValid;
}

OAIStatus OAIOrganizer::getStatus() const {
    return m_status;
}
void OAIOrganizer::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOrganizer::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOrganizer::is_status_Valid() const{
