...
OAIAttendeeByMeeting::OAIAttendeeByMeeting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttendeeByMeeting::OAIAttendeeByMeeting() {
    this->initializeModel();
}

OAIAttendeeByMeeting::~OAIAttendeeByMeeting() {}

void OAIAttendeeByMeeting::initializeModel() {
...
void OAIAttendeeByMeeting::fromJson(QString jsonString) {
...
void OAIAttendeeByMeeting::fromJsonObject(QJsonObject json) {
...
QString OAIAttendeeByMeeting::asJson() const {
...
QJsonObject OAIAttendeeByMeeting::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttendeeByMeeting::getAttendeeEmail() const {
    return m_attendee_email;
}
void OAIAttendeeByMeeting::setAttendeeEmail(const QString &attendee_email) {
    m_attendee_email = attendee_email;
    m_attendee_email_isSet = true;
}

bool OAIAttendeeByMeeting::is_attendee_email_Set() const{
    return m_attendee_email_isSet;
}

bool OAIAttendeeByMeeting::is_attendee_email_Valid() const{
    return m_attendee_email_isValid;
}

QString OAIAttendeeByMeeting::getAttendeeName() const {
    return m_attendee_name;
}
void OAIAttendeeByMeeting::setAttendeeName(const QString &attendee_name) {
    m_attendee_name = attendee_name;
    m_attendee_name_isSet = true;
}

bool OAIAttendeeByMeeting::is_attendee_name_Set() const{
    return m_attendee_name_isSet;
}

bool OAIAttendeeByMeeting::is_attendee_name_Valid() const{
    return m_attendee_name_isValid;
}

QString OAIAttendeeByMeeting::getConferenceCallInfo() const {
    return m_conference_call_info;
}
void OAIAttendeeByMeeting::setConferenceCallInfo(const QString &conference_call_info) {
    m_conference_call_info = conference_call_info;
    m_conference_call_info_isSet = true;
}

bool OAIAttendeeByMeeting::is_conference_call_info_Set() const{
    return m_conference_call_info_isSet;
}

bool OAIAttendeeByMeeting::is_conference_call_info_Valid() const{
    return m_conference_call_info_isValid;
}

qint32 OAIAttendeeByMeeting::getDuration() const {
    return m_duration;
}
void OAIAttendeeByMeeting::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIAttendeeByMeeting::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIAttendeeByMeeting::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIAttendeeByMeeting::getEmail() const {
    return m_email;
}
void OAIAttendeeByMeeting::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIAttendeeByMeeting::is_email_Set() const{
    return m_email_isSet;
}

bool OAIAttendeeByMeeting::is_email_Valid() const{
    return m_email_isValid;
}

QDateTime OAIAttendeeByMeeting::getEndTime() const {
    return m_end_time;
}
void OAIAttendeeByMeeting::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIAttendeeByMeeting::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIAttendeeByMeeting::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIAttendeeByMeeting::getFirstName() const {
    return m_first_name;
}
void OAIAttendeeByMeeting::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIAttendeeByMeeting::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIAttendeeByMeeting::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIAttendeeByMeeting::getGroupName() const {
    return m_group_name;
}
void OAIAttendeeByMeeting::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIAttendeeByMeeting::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIAttendeeByMeeting::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QDateTime OAIAttendeeByMeeting::getJoinTime() const {
    return m_join_time;
}
void OAIAttendeeByMeeting::setJoinTime(const QDateTime &join_time) {
    m_join_time = join_time;
    m_join_time_isSet = true;
}

bool OAIAttendeeByMeeting::is_join_time_Set() const{
    return m_join_time_isSet;
}

bool OAIAttendeeByMeeting::is_join_time_Valid() const{
    return m_join_time_isValid;
}

QString OAIAttendeeByMeeting::getLastName() const {
    return m_last_name;
}
void OAIAttendeeByMeeting::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIAttendeeByMeeting::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIAttendeeByMeeting::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QDateTime OAIAttendeeByMeeting::getLeaveTime() const {
    return m_leave_time;
}
void OAIAttendeeByMeeting::setLeaveTime(const QDateTime &leave_time) {
    m_leave_time = leave_time;
    m_leave_time_isSet = true;
}

bool OAIAttendeeByMeeting::is_leave_time_Set() const{
    return m_leave_time_isSet;
}

bool OAIAttendeeByMeeting::is_leave_time_Valid() const{
    return m_leave_time_isValid;
}

qint64 OAIAttendeeByMeeting::getMeetingId() const {
    return m_meeting_id;
}
void OAIAttendeeByMeeting::setMeetingId(const qint64 &meeting_id) {
    m_meeting_id = meeting_id;
    m_meeting_id_isSet = true;
}

bool OAIAttendeeByMeeting::is_meeting_id_Set() const{
    return m_meeting_id_isSet;
}

bool OAIAttendeeByMeeting::is_meeting_id_Valid() const{
    return m_meeting_id_isValid;
}

qint64 OAIAttendeeByMeeting::getMeetingInstanceKey() const {
    return m_meeting_instance_key;
}
void OAIAttendeeByMeeting::setMeetingInstanceKey(const qint64 &meeting_instance_key) {
    m_meeting_instance_key = meeting_instance_key;
    m_meeting_instance_key_isSet = true;
}

bool OAIAttendeeByMeeting::is_meeting_instance_key_Set() const{
    return m_meeting_instance_key_isSet;
}

bool OAIAttendeeByMeeting::is_meeting_instance_key_Valid() const{
    return m_meeting_instance_key_isValid;
}

OAIMeetingType OAIAttendeeByMeeting::getMeetingType() const {
    return m_meeting_type;
}
void OAIAttendeeByMeeting::setMeetingType(const OAIMeetingType &meeting_type) {
    m_meeting_type = meeting_type;
    m_meeting_type_isSet = true;
}

bool OAIAttendeeByMeeting::is_meeting_type_Set() const{
    return m_meeting_type_isSet;
}

bool OAIAttendeeByMeeting::is_meeting_type_Valid() const{
    return m_meeting_type_isValid;
}

QString OAIAttendeeByMeeting::getName() const {
    return m_name;
}
void OAIAttendeeByMeeting::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAttendeeByMeeting::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAttendeeByMeeting::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIAttendeeByMeeting::getNumAttendees() const {
    return m_num_attendees;
}
void OAIAttendeeByMeeting::setNumAttendees(const qint32 &num_attendees) {
    m_num_attendees = num_attendees;
    m_num_attendees_isSet = true;
}

bool OAIAttendeeByMeeting::is_num_attendees_Set() const{
    return m_num_attendees_isSet;
}

bool OAIAttendeeByMeeting::is_num_attendees_Valid() const{
    return m_num_attendees_isValid;
}

qint64 OAIAttendeeByMeeting::getOrganizerkey() const {
    return m_organizerkey;
}
void OAIAttendeeByMeeting::setOrganizerkey(const qint64 &organizerkey) {
    m_organizerkey = organizerkey;
    m_organizerkey_isSet = true;
}

bool OAIAttendeeByMeeting::is_organizerkey_Set() const{
    return m_organizerkey_isSet;
}

bool OAIAttendeeByMeeting::is_organizerkey_Valid() const{
    return m_organizerkey_isValid;
}

QDateTime OAIAttendeeByMeeting::getStartTime() const {
    return m_start_time;
}
void OAIAttendeeByMeeting::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIAttendeeByMeeting::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIAttendeeByMeeting::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIAttendeeByMeeting::getSubject() const {
    return m_subject;
}
void OAIAttendeeByMeeting::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAIAttendeeByMeeting::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIAttendeeByMeeting::is_subject_Valid() const{
    return m_subject_isValid;
}

bool OAIAttendeeByMeeting::isSet() const {
