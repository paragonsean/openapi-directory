...
/*
 * OAIHistoricalMeeting.h
 *
 * Describes a historical meeting within specified dates.
 */

#ifndef OAIHistoricalMeeting_H
#define OAIHistoricalMeeting_H
...
class OAIHistoricalMeeting : public OAIObject {
public:
    OAIHistoricalMeeting();
    OAIHistoricalMeeting(QString json);
    ~OAIHistoricalMeeting() override;
    ...
    QString getNumAttendees() const;
    void setNumAttendees(const QString &num_attendees);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalMeeting)

#endif // OAIHistoricalMeeting_H
