...
/*
 * OAIMeetingScheduled.h
 *
 * Describes a scheduled meeting.
 */

#ifndef OAIMeetingScheduled_H
#define OAIMeetingScheduled_H
...
class OAIMeetingScheduled : public OAIObject {
public:
    OAIMeetingScheduled();
    OAIMeetingScheduled(QString json);
    ~OAIMeetingScheduled() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeetingScheduled)

#endif // OAIMeetingScheduled_H
