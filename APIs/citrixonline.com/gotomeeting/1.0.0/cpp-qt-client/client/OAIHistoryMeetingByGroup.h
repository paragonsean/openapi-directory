...
/*
 * OAIHistoryMeetingByGroup.h
 *
 * Describes past meeting instance(s) held by an organizer within a specified group.
 */

#ifndef OAIHistoryMeetingByGroup_H
#define OAIHistoryMeetingByGroup_H
...
class OAIHistoryMeetingByGroup : public OAIObject {
public:
    OAIHistoryMeetingByGroup();
    OAIHistoryMeetingByGroup(QString json);
    ~OAIHistoryMeetingByGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryMeetingByGroup)

#endif // OAIHistoryMeetingByGroup_H
