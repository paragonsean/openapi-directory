...
/*
 * OAIMeetingReqUpdate.h
 *
 * Describes the information required to update a meeting.
 */

#ifndef OAIMeetingReqUpdate_H
#define OAIMeetingReqUpdate_H
...
class OAIMeetingReqUpdate : public OAIObject {
public:
    OAIMeetingReqUpdate();
    OAIMeetingReqUpdate(QString json);
    ~OAIMeetingReqUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeetingReqUpdate)

#endif // OAIMeetingReqUpdate_H
