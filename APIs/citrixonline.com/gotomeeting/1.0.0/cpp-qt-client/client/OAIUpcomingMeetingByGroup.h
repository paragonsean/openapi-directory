...
/*
 * OAIUpcomingMeetingByGroup.h
 *
 * Describes an upcoming meeting of a group.
 */

#ifndef OAIUpcomingMeetingByGroup_H
#define OAIUpcomingMeetingByGroup_H
...
class OAIUpcomingMeetingByGroup : public OAIObject {
public:
    OAIUpcomingMeetingByGroup();
    OAIUpcomingMeetingByGroup(QString json);
    ~OAIUpcomingMeetingByGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpcomingMeetingByGroup)

#endif // OAIUpcomingMeetingByGroup_H
