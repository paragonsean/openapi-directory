...
/*
 * OAIOrganizerByGroup.h
 *
 * Describes an organizer within a specified group.
 */

#ifndef OAIOrganizerByGroup_H
#define OAIOrganizerByGroup_H
...
class OAIOrganizerByGroup : public OAIObject {
public:
    OAIOrganizerByGroup();
    OAIOrganizerByGroup(QString json);
    ~OAIOrganizerByGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizerByGroup)

#endif // OAIOrganizerByGroup_H
