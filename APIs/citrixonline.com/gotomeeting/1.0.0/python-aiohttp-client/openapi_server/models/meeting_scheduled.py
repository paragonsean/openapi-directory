...
class MeetingScheduled(Model):
    ...
    def __init__(self, conference_call_info: str=None, create_time: datetime=None, end_time: datetime=None, max_participants: int=None, meeting_type: MeetingType=None, meetingid: int=None, password_required: bool=None, start_time: datetime=None, status: MeetingStatus=None, subject: str=None, unique_meeting_id: int=None):
        """MeetingScheduled - a model defined in OpenAPI

        :param conference_call_info: The conference_call_info of this MeetingScheduled.
        :param create_time: The create_time of this MeetingScheduled.
        :param end_time: The end_time of this MeetingScheduled.
        :param max_participants: The max_participants of this MeetingScheduled.
        :param meeting_type: The meeting_type of this MeetingScheduled.
        :param meetingid: The meetingid of this MeetingScheduled.
        :param password_required: The password_required of this MeetingScheduled.
        :param start_time: The start_time of this MeetingScheduled.
        :param status: The status of this MeetingScheduled.
        :param subject: The subject of this MeetingScheduled.
        :param unique_meeting_id: The unique_meeting_id of this MeetingScheduled.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MeetingScheduled':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MeetingScheduled of this MeetingScheduled.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def conference_call_info(self):
        """Gets the conference_call_info of this MeetingScheduled.

        Audio options for the meeting.

        :return: The conference_call_info of this MeetingScheduled.
        :rtype: str
        """
    ...
    def conference_call_info(self, conference_call_info):
        """Sets the conference_call_info of this MeetingScheduled.
    ...
    def create_time(self):
        """Gets the create_time of this MeetingScheduled.

        The time the meeting was created.

        :return: The create_time of this MeetingScheduled.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this MeetingScheduled.
    ...
    @property
    def end_time(self):
        """Gets the end_time of this MeetingScheduled.

        The ending time of the meeting.

        :return: The end_time of this MeetingScheduled.
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this MeetingScheduled.
    ...
    def max_participants(self):
        """Gets the max_participants of this MeetingScheduled.

        The maximum number of participants allowed at the meeting.

        :return: The max_participants of this MeetingScheduled.
        :rtype: int
        """
    ...
    def max_participants(self, max_participants):
        """Sets the max_participants of this MeetingScheduled.
    ...
    def meeting_type(self):
        """Gets the meeting_type of this MeetingScheduled.


        :return: The meeting_type of this MeetingScheduled.
        :rtype: MeetingType
        """
    ...
    def meeting_type(self, meeting_type):
        """Sets the meeting_type of this MeetingScheduled.
    ...
    @property
    def meetingid(self):
        """Gets the meetingid of this MeetingScheduled.

        The meeting ID.

        :return: The meetingid of this MeetingScheduled.
        :rtype: int
        """
    ...
    def meetingid(self, meetingid):
        """Sets the meetingid of this MeetingScheduled.
    ...
    def password_required(self):
        """Gets the password_required of this MeetingScheduled.

        Indicates whether a password is required to join the meeting.

        :return: The password_required of this MeetingScheduled.
        :rtype: bool
        """
    ...
    def password_required(self, password_required):
        """Sets the password_required of this MeetingScheduled.
    ...
    @property
    def start_time(self):
        """Gets the start_time of this MeetingScheduled.

        The starting time of the meeting.

        :return: The start_time of this MeetingScheduled.
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this MeetingScheduled.
    ...
    @property
    def status(self):
        """Gets the status of this MeetingScheduled.


        :return: The status of this MeetingScheduled.
        :rtype: MeetingStatus
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this MeetingScheduled.
    ...
    @property
    def subject(self):
        """Gets the subject of this MeetingScheduled.

        The subject of the meeting.

        :return: The subject of this MeetingScheduled.
        :rtype: str
        """
    ...
    def subject(self, subject):
        """Sets the subject of this MeetingScheduled.
    ...
    def unique_meeting_id(self):
        """Gets the unique_meeting_id of this MeetingScheduled.

        The meeting ID. Field retained for backwards compatibility reasons.

        :return: The unique_meeting_id of this MeetingScheduled.
        :rtype: int
        """
    ...
    def unique_meeting_id(self, unique_meeting_id):
        """Sets the unique_meeting_id of this MeetingScheduled.
