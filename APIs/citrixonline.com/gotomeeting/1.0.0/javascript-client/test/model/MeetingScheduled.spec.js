...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.MeetingScheduled();
  });
  ...
  describe('MeetingScheduled', function() {
    it('should create an instance of MeetingScheduled', function() {
      // uncomment below and update the code to test MeetingScheduled
      //var instance = new GoToMeeting.MeetingScheduled();
      //expect(instance).to.be.a(GoToMeeting.MeetingScheduled);
    });
