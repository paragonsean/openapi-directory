...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.MeetingById();
  });
  ...
  describe('MeetingById', function() {
    it('should create an instance of MeetingById', function() {
      // uncomment below and update the code to test MeetingById
      //var instance = new GoToMeeting.MeetingById();
      //expect(instance).to.be.a(GoToMeeting.MeetingById);
    });
