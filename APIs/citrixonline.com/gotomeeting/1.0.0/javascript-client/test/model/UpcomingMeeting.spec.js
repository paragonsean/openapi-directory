...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.UpcomingMeeting();
  });
  ...
  describe('UpcomingMeeting', function() {
    it('should create an instance of UpcomingMeeting', function() {
      // uncomment below and update the code to test UpcomingMeeting
      //var instance = new GoToMeeting.UpcomingMeeting();
      //expect(instance).to.be.a(GoToMeeting.UpcomingMeeting);
    });
