...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.AttendeeByOrganizer();
  });
  ...
  describe('AttendeeByOrganizer', function() {
    it('should create an instance of AttendeeByOrganizer', function() {
      // uncomment below and update the code to test AttendeeByOrganizer
      //var instance = new GoToMeeting.AttendeeByOrganizer();
      //expect(instance).to.be.a(GoToMeeting.AttendeeByOrganizer);
    });
