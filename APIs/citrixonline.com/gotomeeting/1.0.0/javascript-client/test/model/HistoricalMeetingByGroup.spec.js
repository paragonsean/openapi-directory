...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.HistoricalMeetingByGroup();
  });
  ...
  describe('HistoricalMeetingByGroup', function() {
    it('should create an instance of HistoricalMeetingByGroup', function() {
      // uncomment below and update the code to test HistoricalMeetingByGroup
      //var instance = new GoToMeeting.HistoricalMeetingByGroup();
      //expect(instance).to.be.a(GoToMeeting.HistoricalMeetingByGroup);
    });
