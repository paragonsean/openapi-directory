...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.ScheduledMeetingByGroup();
  });
  ...
  describe('ScheduledMeetingByGroup', function() {
    it('should create an instance of ScheduledMeetingByGroup', function() {
      // uncomment below and update the code to test ScheduledMeetingByGroup
      //var instance = new GoToMeeting.ScheduledMeetingByGroup();
      //expect(instance).to.be.a(GoToMeeting.ScheduledMeetingByGroup);
    });
