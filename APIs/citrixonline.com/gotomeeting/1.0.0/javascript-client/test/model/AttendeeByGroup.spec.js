...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.AttendeeByGroup();
  });
  ...
  describe('AttendeeByGroup', function() {
    it('should create an instance of AttendeeByGroup', function() {
      // uncomment below and update the code to test AttendeeByGroup
      //var instance = new GoToMeeting.AttendeeByGroup();
      //expect(instance).to.be.a(GoToMeeting.AttendeeByGroup);
    });
