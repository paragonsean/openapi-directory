...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.UpcomingMeetingByGroup();
  });
  ...
  describe('UpcomingMeetingByGroup', function() {
    it('should create an instance of UpcomingMeetingByGroup', function() {
      // uncomment below and update the code to test UpcomingMeetingByGroup
      //var instance = new GoToMeeting.UpcomingMeetingByGroup();
      //expect(instance).to.be.a(GoToMeeting.UpcomingMeetingByGroup);
    });
