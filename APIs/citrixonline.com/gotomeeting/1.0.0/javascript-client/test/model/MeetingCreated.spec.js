...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.MeetingCreated();
  });
  ...
  describe('MeetingCreated', function() {
    it('should create an instance of MeetingCreated', function() {
      // uncomment below and update the code to test MeetingCreated
      //var instance = new GoToMeeting.MeetingCreated();
      //expect(instance).to.be.a(GoToMeeting.MeetingCreated);
    });
