...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.HistoryMeetingByGroup();
  });
  ...
  describe('HistoryMeetingByGroup', function() {
    it('should create an instance of HistoryMeetingByGroup', function() {
      // uncomment below and update the code to test HistoryMeetingByGroup
      //var instance = new GoToMeeting.HistoryMeetingByGroup();
      //expect(instance).to.be.a(GoToMeeting.HistoryMeetingByGroup);
    });
