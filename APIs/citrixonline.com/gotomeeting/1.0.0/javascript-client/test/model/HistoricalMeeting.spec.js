...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToMeeting.HistoricalMeeting();
  });
  ...
  describe('HistoricalMeeting', function() {
    it('should create an instance of HistoricalMeeting', function() {
      // uncomment below and update the code to test HistoricalMeeting
      //var instance = new GoToMeeting.HistoricalMeeting();
      //expect(instance).to.be.a(GoToMeeting.HistoricalMeeting);
    });
