...
/**
 * The MeetingScheduled model module.
 * @module model/MeetingScheduled
 * @version 1.0.0
 */
class MeetingScheduled {
    /**
     * Constructs a new <code>MeetingScheduled</code>.
     * Describes a scheduled meeting.
     * @alias module:model/MeetingScheduled
     * @param conferenceCallInfo {String} Audio options for the meeting.
     * @param createTime {Date} The time the meeting was created.
    ...
    constructor(conferenceCallInfo, createTime, endTime, maxParticipants, meetingType, meetingid, passwordRequired, startTime, status, subject, uniqueMeetingId) { 
        ...
        MeetingScheduled.initialize(this, conferenceCallInfo, createTime, endTime, maxParticipants, meetingType, meetingid, passwordRequired, startTime, status, subject, uniqueMeetingId);
    }
    ...
    /**
     * Constructs a <code>MeetingScheduled</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeetingScheduled} obj Optional instance to populate.
     * @return {module:model/MeetingScheduled} The populated <code>MeetingScheduled</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeetingScheduled();
    ...
    /**
     * Validates the JSON data with respect to <code>MeetingScheduled</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeetingScheduled</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MeetingScheduled.RequiredProperties) {
...
MeetingScheduled.RequiredProperties = ["conferenceCallInfo", "createTime", "endTime", "maxParticipants", "meetingType", "meetingid", "passwordRequired", "startTime", "status", "subject", "uniqueMeetingId"];

/**
 * Audio options for the meeting.
 * @member {String} conferenceCallInfo
 */
MeetingScheduled.prototype['conferenceCallInfo'] = undefined;

/**
 * The time the meeting was created.
 * @member {Date} createTime
 */
MeetingScheduled.prototype['createTime'] = undefined;

/**
 * The ending time of the meeting.
 * @member {Date} endTime
 */
MeetingScheduled.prototype['endTime'] = undefined;

/**
 * The maximum number of participants allowed at the meeting.
 * @member {Number} maxParticipants
 */
MeetingScheduled.prototype['maxParticipants'] = undefined;

/**
 * @member {module:model/MeetingType} meetingType
 */
MeetingScheduled.prototype['meetingType'] = undefined;

/**
 * The meeting ID.
 * @member {Number} meetingid
 */
MeetingScheduled.prototype['meetingid'] = undefined;

/**
 * Indicates whether a password is required to join the meeting.
 * @member {Boolean} passwordRequired
 */
MeetingScheduled.prototype['passwordRequired'] = undefined;

/**
 * The starting time of the meeting.
 * @member {Date} startTime
 */
MeetingScheduled.prototype['startTime'] = undefined;

/**
 * @member {module:model/MeetingStatus} status
 */
MeetingScheduled.prototype['status'] = undefined;

/**
 * The subject of the meeting.
 * @member {String} subject
 */
MeetingScheduled.prototype['subject'] = undefined;

/**
 * The meeting ID. Field retained for backwards compatibility reasons.
 * @member {Number} uniqueMeetingId
 */
MeetingScheduled.prototype['uniqueMeetingId'] = undefined;
