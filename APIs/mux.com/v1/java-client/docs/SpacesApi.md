...
public class Example {
  public static void main(String[] args) {
    ...
    CreateSpaceRequest createSpaceRequest = new CreateSpaceRequest(); // CreateSpaceRequest | 
    try {
