...
<a id="createPlaybackRestriction"></a>
...
import org.openapitools.client.api.PlaybackRestrictionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CreatePlaybackRestrictionRequest createPlaybackRestrictionRequest = new CreatePlaybackRestrictionRequest(); // CreatePlaybackRestrictionRequest | 
    try {
...
<a id="deletePlaybackRestriction"></a>
...
<a id="listPlaybackRestrictions"></a>
...
<a id="updateReferrerDomainRestriction"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    PlaybackRestrictionsApi apiInstance = new PlaybackRestrictionsApi(defaultClient);
    String PLAYBACK_RESTRICTION_ID = "PLAYBACK_RESTRICTION_ID_example"; // String | ID of the Playback Restriction.
    UpdateReferrerDomainRestrictionRequest updateReferrerDomainRestrictionRequest = new UpdateReferrerDomainRestrictionRequest(); // UpdateReferrerDomainRestrictionRequest | 
    try {
