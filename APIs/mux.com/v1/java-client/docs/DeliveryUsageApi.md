...
import org.openapitools.client.api.DeliveryUsageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> timeframe = Arrays.asList(); // List<String> | Time window to get delivery usage information. timeframe[0] indicates the start time, timeframe[1] indicates the end time in seconds since the Unix epoch. Default time window is 1 hour representing usage from 13th to 12th hour from when the request is made.
    try {
