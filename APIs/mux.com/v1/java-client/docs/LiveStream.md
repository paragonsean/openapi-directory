...
|**recentAssetIds** | **List&lt;String&gt;** | An array of strings with the most recent Asset IDs that were created from this Live Stream. The most recently generated Asset ID is the last entry in the list. |  [optional] |
