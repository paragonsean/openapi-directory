...
public class DeliveryUsageApi {
    ...
    private okhttp3.Call listDeliveryUsageCall(Integer page, Integer limit, String assetId, String liveStreamId, List<String> timeframe, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listDeliveryUsageValidateBeforeCall(Integer page, Integer limit, String assetId, String liveStreamId, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        return listDeliveryUsageCall(page, limit, assetId, liveStreamId, timeframe, _callback);

    }


    private ApiResponse<ListDeliveryUsageResponse> listDeliveryUsageWithHttpInfo(Integer page, Integer limit, String assetId, String liveStreamId, List<String> timeframe) throws ApiException {
    ...
    private okhttp3.Call listDeliveryUsageAsync(Integer page, Integer limit, String assetId, String liveStreamId, List<String> timeframe, final ApiCallback<ListDeliveryUsageResponse> _callback) throws ApiException {
    ...
    public class APIlistDeliveryUsageRequest {
         ...
         * @return APIlistDeliveryUsageRequest
         */
        public APIlistDeliveryUsageRequest timeframe(List<String> timeframe) {
