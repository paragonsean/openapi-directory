...
import org.openapitools.client.model.MonitoringHistogramTimeseriesBucketValues;
...
public class MonitoringHistogramTimeseriesDatapoint {
  ...
  private List<MonitoringHistogramTimeseriesBucketValues> bucketValues = new ArrayList<>();
  ...
  public MonitoringHistogramTimeseriesDatapoint bucketValues(List<MonitoringHistogramTimeseriesBucketValues> bucketValues) {
   ...
   */
  @javax.annotation.Nullable
  public List<MonitoringHistogramTimeseriesBucketValues> getBucketValues() {
    return bucketValues;
  }

  public void setBucketValues(List<MonitoringHistogramTimeseriesBucketValues> bucketValues) {
    this.bucketValues = bucketValues;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.average, monitoringHistogramTimeseriesDatapoint.average) &&
        ...
        Objects.equals(this.timestamp, monitoringHistogramTimeseriesDatapoint.timestamp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitoringHistogramTimeseriesDatapoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitoringHistogramTimeseriesDatapoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitoringHistogramTimeseriesDatapoint is not found in the empty JSON string", MonitoringHistogramTimeseriesDatapoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitoringHistogramTimeseriesDatapoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitoringHistogramTimeseriesDatapoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bucket_values") != null && !jsonObj.get("bucket_values").isJsonNull()) {
        ...
        if (jsonArraybucketValues != null) {
          ...
          for (int i = 0; i < jsonArraybucketValues.size(); i++) {
            MonitoringHistogramTimeseriesBucketValues.validateJsonElement(jsonArraybucketValues.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitoringHistogramTimeseriesDatapoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitoringHistogramTimeseriesDatapoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitoringHistogramTimeseriesDatapoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitoringHistogramTimeseriesDatapoint.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitoringHistogramTimeseriesDatapoint>() {
           @Override
           public void write(JsonWriter out, MonitoringHistogramTimeseriesDatapoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitoringHistogramTimeseriesDatapoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitoringHistogramTimeseriesDatapoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitoringHistogramTimeseriesDatapoint
   * @throws IOException if the JSON string is invalid with respect to MonitoringHistogramTimeseriesDatapoint
   */
  public static MonitoringHistogramTimeseriesDatapoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitoringHistogramTimeseriesDatapoint.class);
  }

  /**
   * Convert an instance of MonitoringHistogramTimeseriesDatapoint to an JSON string
   *
   * @return JSON string
   */
