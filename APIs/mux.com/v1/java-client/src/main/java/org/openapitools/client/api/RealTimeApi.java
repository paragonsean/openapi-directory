...
public class RealTimeApi {
    ...
    private okhttp3.Call getRealtimeBreakdownCall(String REALTIME_METRIC_ID, String dimension, Integer timestamp, List<String> filters, String orderBy, String orderDirection, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/data/v1/realtime/metrics/{REALTIME_METRIC_ID}/breakdown"
            .replace("{" + "REALTIME_METRIC_ID" + "}", localVarApiClient.escapeString(REALTIME_METRIC_ID.toString()));
    ...
    private okhttp3.Call getRealtimeBreakdownValidateBeforeCall(String REALTIME_METRIC_ID, String dimension, Integer timestamp, List<String> filters, String orderBy, String orderDirection, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<GetRealTimeBreakdownResponse> getRealtimeBreakdownWithHttpInfo(String REALTIME_METRIC_ID, String dimension, Integer timestamp, List<String> filters, String orderBy, String orderDirection) throws ApiException {
    ...
    private okhttp3.Call getRealtimeBreakdownAsync(String REALTIME_METRIC_ID, String dimension, Integer timestamp, List<String> filters, String orderBy, String orderDirection, final ApiCallback<GetRealTimeBreakdownResponse> _callback) throws ApiException {
    ...
    public class APIgetRealtimeBreakdownRequest {
         ...
         * @return APIgetRealtimeBreakdownRequest
         */
        public APIgetRealtimeBreakdownRequest filters(List<String> filters) {
    ...
    private okhttp3.Call getRealtimeHistogramTimeseriesCall(String REALTIME_HISTOGRAM_METRIC_ID, List<String> filters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        String localVarPath = "/data/v1/realtime/metrics/{REALTIME_HISTOGRAM_METRIC_ID}/histogram-timeseries"
            .replace("{" + "REALTIME_HISTOGRAM_METRIC_ID" + "}", localVarApiClient.escapeString(REALTIME_HISTOGRAM_METRIC_ID.toString()));
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRealtimeHistogramTimeseriesValidateBeforeCall(String REALTIME_HISTOGRAM_METRIC_ID, List<String> filters, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<GetRealTimeHistogramTimeseriesResponse> getRealtimeHistogramTimeseriesWithHttpInfo(String REALTIME_HISTOGRAM_METRIC_ID, List<String> filters) throws ApiException {
    ...
    private okhttp3.Call getRealtimeHistogramTimeseriesAsync(String REALTIME_HISTOGRAM_METRIC_ID, List<String> filters, final ApiCallback<GetRealTimeHistogramTimeseriesResponse> _callback) throws ApiException {
    ...
    public class APIgetRealtimeHistogramTimeseriesRequest {
         ...
         */
        public APIgetRealtimeHistogramTimeseriesRequest filters(List<String> filters) {
            this.filters = filters;
            return this;
        }
    ...
    private okhttp3.Call getRealtimeTimeseriesCall(String REALTIME_METRIC_ID, List<String> filters, Integer timestamp, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRealtimeTimeseriesValidateBeforeCall(String REALTIME_METRIC_ID, List<String> filters, Integer timestamp, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'REALTIME_METRIC_ID' is set
        if (REALTIME_METRIC_ID == null) {
    ...
    private ApiResponse<GetRealTimeTimeseriesResponse> getRealtimeTimeseriesWithHttpInfo(String REALTIME_METRIC_ID, List<String> filters, Integer timestamp) throws ApiException {
    ...
    private okhttp3.Call getRealtimeTimeseriesAsync(String REALTIME_METRIC_ID, List<String> filters, Integer timestamp, final ApiCallback<GetRealTimeTimeseriesResponse> _callback) throws ApiException {
    ...
    public class APIgetRealtimeTimeseriesRequest {
         ...
         */
        public APIgetRealtimeTimeseriesRequest filters(List<String> filters) {
            this.filters = filters;
            return this;
        }
