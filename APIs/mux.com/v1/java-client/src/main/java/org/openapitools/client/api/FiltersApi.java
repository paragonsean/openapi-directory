...
public class FiltersApi {
    ...
    private okhttp3.Call listFilterValuesCall(String FILTER_ID, Integer limit, Integer page, List<String> filters, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/data/v1/filters/{FILTER_ID}"
            .replace("{" + "FILTER_ID" + "}", localVarApiClient.escapeString(FILTER_ID.toString()));
    ...
    private okhttp3.Call listFilterValuesValidateBeforeCall(String FILTER_ID, Integer limit, Integer page, List<String> filters, List<String> timeframe, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<ListFilterValuesResponse> listFilterValuesWithHttpInfo(String FILTER_ID, Integer limit, Integer page, List<String> filters, List<String> timeframe) throws ApiException {
    ...
    private okhttp3.Call listFilterValuesAsync(String FILTER_ID, Integer limit, Integer page, List<String> filters, List<String> timeframe, final ApiCallback<ListFilterValuesResponse> _callback) throws ApiException {
    ...
    public class APIlistFilterValuesRequest {
         ...
         * @return APIlistFilterValuesRequest
         */
        public APIlistFilterValuesRequest filters(List<String> filters) {
         ...
         * @return APIlistFilterValuesRequest
         */
        public APIlistFilterValuesRequest timeframe(List<String> timeframe) {
