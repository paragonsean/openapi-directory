...
public class UpdateAssetMasterAccessRequest {
  ...
  public UpdateAssetMasterAccessRequest() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAssetMasterAccessRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAssetMasterAccessRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAssetMasterAccessRequest is not found in the empty JSON string", UpdateAssetMasterAccessRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAssetMasterAccessRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAssetMasterAccessRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAssetMasterAccessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAssetMasterAccessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAssetMasterAccessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAssetMasterAccessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAssetMasterAccessRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAssetMasterAccessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAssetMasterAccessRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAssetMasterAccessRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAssetMasterAccessRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAssetMasterAccessRequest
   */
  public static UpdateAssetMasterAccessRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAssetMasterAccessRequest.class);
  }

  /**
   * Convert an instance of UpdateAssetMasterAccessRequest to an JSON string
   *
   * @return JSON string
   */
