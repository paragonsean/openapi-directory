...
public class VideoViewsApi {
    ...
    private okhttp3.Call getVideoViewCall(String VIDEO_VIEW_ID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/data/v1/video-views/{VIDEO_VIEW_ID}"
            .replace("{" + "VIDEO_VIEW_ID" + "}", localVarApiClient.escapeString(VIDEO_VIEW_ID.toString()));
    ...
    private okhttp3.Call listVideoViewsCall(Integer limit, Integer page, String viewerId, Integer errorId, String orderDirection, List<String> filters, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listVideoViewsValidateBeforeCall(Integer limit, Integer page, String viewerId, Integer errorId, String orderDirection, List<String> filters, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        return listVideoViewsCall(limit, page, viewerId, errorId, orderDirection, filters, timeframe, _callback);

    }


    private ApiResponse<ListVideoViewsResponse> listVideoViewsWithHttpInfo(Integer limit, Integer page, String viewerId, Integer errorId, String orderDirection, List<String> filters, List<String> timeframe) throws ApiException {
    ...
    private okhttp3.Call listVideoViewsAsync(Integer limit, Integer page, String viewerId, Integer errorId, String orderDirection, List<String> filters, List<String> timeframe, final ApiCallback<ListVideoViewsResponse> _callback) throws ApiException {
    ...
    public class APIlistVideoViewsRequest {
         ...
         * @return APIlistVideoViewsRequest
         */
        public APIlistVideoViewsRequest filters(List<String> filters) {
         ...
         * @return APIlistVideoViewsRequest
         */
        public APIlistVideoViewsRequest timeframe(List<String> timeframe) {
