...
public class MetricsApi {
    ...
    private okhttp3.Call getMetricTimeseriesDataCall(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, String orderDirection, String groupBy, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/data/v1/metrics/{METRIC_ID}/timeseries"
            .replace("{" + "METRIC_ID" + "}", localVarApiClient.escapeString(METRIC_ID.toString()));
    ...
    private okhttp3.Call getMetricTimeseriesDataValidateBeforeCall(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, String orderDirection, String groupBy, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<GetMetricTimeseriesDataResponse> getMetricTimeseriesDataWithHttpInfo(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, String orderDirection, String groupBy) throws ApiException {
    ...
    private okhttp3.Call getMetricTimeseriesDataAsync(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, String orderDirection, String groupBy, final ApiCallback<GetMetricTimeseriesDataResponse> _callback) throws ApiException {
    ...
    public class APIgetMetricTimeseriesDataRequest {
         ...
         */
        public APIgetMetricTimeseriesDataRequest timeframe(List<String> timeframe) {
         ...
         * @return APIgetMetricTimeseriesDataRequest
         */
        public APIgetMetricTimeseriesDataRequest filters(List<String> filters) {
    ...
    private okhttp3.Call getOverallValuesCall(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOverallValuesValidateBeforeCall(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'METRIC_ID' is set
        if (METRIC_ID == null) {
    ...
    private ApiResponse<GetOverallValuesResponse> getOverallValuesWithHttpInfo(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement) throws ApiException {
    ...
    private okhttp3.Call getOverallValuesAsync(String METRIC_ID, List<String> timeframe, List<String> filters, String measurement, final ApiCallback<GetOverallValuesResponse> _callback) throws ApiException {
    ...
    public class APIgetOverallValuesRequest {
         ...
         */
        public APIgetOverallValuesRequest timeframe(List<String> timeframe) {
            this.timeframe = timeframe;
            return this;
        }
         ...
         * @return APIgetOverallValuesRequest
         */
        public APIgetOverallValuesRequest filters(List<String> filters) {
            this.filters = filters;
            return this;
        }
    ...
    private okhttp3.Call listAllMetricValuesCall(List<String> timeframe, List<String> filters, String dimension, String value, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllMetricValuesValidateBeforeCall(List<String> timeframe, List<String> filters, String dimension, String value, final ApiCallback _callback) throws ApiException {
        return listAllMetricValuesCall(timeframe, filters, dimension, value, _callback);

    }


    private ApiResponse<ListAllMetricValuesResponse> listAllMetricValuesWithHttpInfo(List<String> timeframe, List<String> filters, String dimension, String value) throws ApiException {
    ...
    private okhttp3.Call listAllMetricValuesAsync(List<String> timeframe, List<String> filters, String dimension, String value, final ApiCallback<ListAllMetricValuesResponse> _callback) throws ApiException {
    ...
    public class APIlistAllMetricValuesRequest {
         ...
         */
        public APIlistAllMetricValuesRequest timeframe(List<String> timeframe) {
            this.timeframe = timeframe;
            return this;
        }
         ...
         * @return APIlistAllMetricValuesRequest
         */
        public APIlistAllMetricValuesRequest filters(List<String> filters) {
            this.filters = filters;
            return this;
        }
    ...
    private okhttp3.Call listBreakdownValuesCall(String METRIC_ID, String groupBy, String measurement, List<String> filters, Integer limit, Integer page, String orderBy, String orderDirection, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBreakdownValuesValidateBeforeCall(String METRIC_ID, String groupBy, String measurement, List<String> filters, Integer limit, Integer page, String orderBy, String orderDirection, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'METRIC_ID' is set
        if (METRIC_ID == null) {
    ...
    private ApiResponse<ListBreakdownValuesResponse> listBreakdownValuesWithHttpInfo(String METRIC_ID, String groupBy, String measurement, List<String> filters, Integer limit, Integer page, String orderBy, String orderDirection, List<String> timeframe) throws ApiException {
    ...
    private okhttp3.Call listBreakdownValuesAsync(String METRIC_ID, String groupBy, String measurement, List<String> filters, Integer limit, Integer page, String orderBy, String orderDirection, List<String> timeframe, final ApiCallback<ListBreakdownValuesResponse> _callback) throws ApiException {
    ...
    public class APIlistBreakdownValuesRequest {
         ...
         * @return APIlistBreakdownValuesRequest
         */
        public APIlistBreakdownValuesRequest filters(List<String> filters) {
            this.filters = filters;
            return this;
        }
         ...
         * @return APIlistBreakdownValuesRequest
         */
        public APIlistBreakdownValuesRequest timeframe(List<String> timeframe) {
            this.timeframe = timeframe;
            return this;
        }
    ...
    private okhttp3.Call listInsightsCall(String METRIC_ID, String measurement, String orderDirection, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listInsightsValidateBeforeCall(String METRIC_ID, String measurement, String orderDirection, List<String> timeframe, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'METRIC_ID' is set
        if (METRIC_ID == null) {
    ...
    private ApiResponse<ListInsightsResponse> listInsightsWithHttpInfo(String METRIC_ID, String measurement, String orderDirection, List<String> timeframe) throws ApiException {
    ...
    private okhttp3.Call listInsightsAsync(String METRIC_ID, String measurement, String orderDirection, List<String> timeframe, final ApiCallback<ListInsightsResponse> _callback) throws ApiException {
    ...
    public class APIlistInsightsRequest {
         ...
         * @return APIlistInsightsRequest
         */
        public APIlistInsightsRequest timeframe(List<String> timeframe) {
            this.timeframe = timeframe;
            return this;
        }
