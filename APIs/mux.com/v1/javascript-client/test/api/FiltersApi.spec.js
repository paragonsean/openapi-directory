...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MuxApi.FiltersApi();
  });
  ...
  describe('FiltersApi', function() {
    describe('listFilterValues', function() {
      it('should call listFilterValues successfully', function(done) {
        //uncomment below and update the code to test listFilterValues
        //instance.listFilterValues(function(error) {
