...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MuxApi.ExportsApi();
  });
  ...
  describe('ExportsApi', function() {
    ...
    describe('listExportsViews', function() {
      it('should call listExportsViews successfully', function(done) {
        //uncomment below and update the code to test listExportsViews
        //instance.listExportsViews(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
