...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MuxApi.CreateBroadcastRequest();
  });
  ...
  describe('CreateBroadcastRequest', function() {
    it('should create an instance of CreateBroadcastRequest', function() {
      // uncomment below and update the code to test CreateBroadcastRequest
      //var instance = new MuxApi.CreateBroadcastRequest();
      //expect(instance).to.be.a(MuxApi.CreateBroadcastRequest);
    });
