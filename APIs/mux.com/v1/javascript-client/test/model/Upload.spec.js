...
(function(root, factory) {
  ...
  describe('Upload', function() {
    it('should create an instance of Upload', function() {
      ...
      //var instance = new MuxApi.Upload();
      //expect(instance).to.be.a(MuxApi.Upload);
    });
    ...
    it('should have the property corsOrigin (base name: "cors_origin")', function() {
      // uncomment below and update the code to test the property corsOrigin
      //var instance = new MuxApi.Upload();
      //expect(instance).to.be();
    });
