...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MuxApi.TranscriptionVocabulary();
  });
  ...
  describe('TranscriptionVocabulary', function() {
    it('should create an instance of TranscriptionVocabulary', function() {
      // uncomment below and update the code to test TranscriptionVocabulary
      //var instance = new MuxApi.TranscriptionVocabulary();
      //expect(instance).to.be.a(MuxApi.TranscriptionVocabulary);
    });
