...
(function(root, factory) {
  ...
  describe('Space', function() {
    it('should create an instance of Space', function() {
      ...
      //var instance = new MuxApi.Space();
      //expect(instance).to.be.a(MuxApi.Space);
    });

    it('should have the property activeSessionId (base name: "active_session_id")', function() {
