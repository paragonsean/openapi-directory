...
public class ApiClient {
    ...
    private String basePath = "https://neutrinoapi.net";
    ...
    public ApiClient() {
        ...
        authentications.put("user-id", new ApiKeyAuth("header", "user-id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://neutrinoapi.net
