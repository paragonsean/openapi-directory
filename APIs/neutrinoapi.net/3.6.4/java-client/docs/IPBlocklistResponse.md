...
|------------ | ------------- | ------------- | -------------|
|**blocklists** | **List&lt;String&gt;** | An array of strings indicating which blocklist categories this IP is listed on |  |
...
|**lastSeen** | **Integer** | The unix time when this IP was last seen on any blocklist. IPs are automatically removed after 7 days therefor this value will never be older than 7 days |  |
|**listCount** | **Integer** | The number of blocklists the IP is listed on |  |
