...
|------------ | ------------- | ------------- | -------------|
|**asAge** | **Integer** | The age of the autonomous system (AS) in number of years since registration |  |
...
|**asDomains** | **List&lt;String&gt;** | Array of all the domains associated with the autonomous system (AS) |  |
