...
|**addressComponents** | **Map&lt;String, String&gt;** | The components which make up the address such as road, city, state, etc |  |
...
|**locationTags** | **List&lt;String&gt;** | Array of strings containing any location tags associated with the address. Tags are additional pieces of metadata about a specific location, there are thousands of different tags. Some examples of tags: shop, office, cafe, bank, pub |  |
