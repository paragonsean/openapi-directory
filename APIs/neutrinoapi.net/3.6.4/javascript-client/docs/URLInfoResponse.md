...
**contentSize** | **Number** | The size of the URL content in bytes | 
...
**httpStatus** | **Number** | The HTTP status code this URL responded with. An HTTP status of 0 indicates a network level issue | 
**httpStatusMessage** | **Number** | The HTTP status message assoicated with the status code | 
...
**loadTime** | **Number** | The time taken to load the URL content in seconds | 
**query** | **{String: String}** | A key-value map of the URL query paramaters | 
