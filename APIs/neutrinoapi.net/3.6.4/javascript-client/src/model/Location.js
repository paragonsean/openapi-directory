...
class Location {
     ...
     */
    constructor(address, addressComponents, city, country, countryCode, countryCode3, currencyCode, latitude, locationTags, locationType, longitude, postalAddress, postalCode, regionCode, state, timezone) { 
        
        Location.initialize(this, address, addressComponents, city, country, countryCode, countryCode3, currencyCode, latitude, locationTags, locationType, longitude, postalAddress, postalCode, regionCode, state, timezone);
    }
     ...
     */
    static initialize(obj, address, addressComponents, city, country, countryCode, countryCode3, currencyCode, latitude, locationTags, locationType, longitude, postalAddress, postalCode, regionCode, state, timezone) { 
        obj['address'] = address;
...
Location.RequiredProperties = ["address", "address-components", "city", "country", "country-code", "country-code3", "currency-code", "latitude", "location-tags", "location-type", "longitude", "postal-address", "postal-code", "region-code", "state", "timezone"];
 ...
 */
Location.prototype['address-components'] = undefined;
 ...
 */
Location.prototype['country-code'] = undefined;

/**
 * The ISO 3-letter country code of the location
 * @member {String} country-code3
 */
Location.prototype['country-code3'] = undefined;

/**
 * ISO 4217 currency code associated with the country
 * @member {String} currency-code
 */
Location.prototype['currency-code'] = undefined;
 ...
 */
Location.prototype['location-tags'] = undefined;
 ...
 */
Location.prototype['postal-address'] = undefined;

/**
 * The postal code for the location
 * @member {String} postal-code
 */
Location.prototype['postal-code'] = undefined;

/**
 * The ISO 3166-2 region code for the location
 * @member {String} region-code
 */
Location.prototype['region-code'] = undefined;
