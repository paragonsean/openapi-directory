...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://neutrinoapi.net') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://neutrinoapi.net
         */
        ...
        this.authentications = {
            ...
            'user-id': {type: 'apiKey', 'in': 'header', name: 'user-id'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.6.4/Javascript'
        };
