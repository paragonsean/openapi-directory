...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeutrinoApi.GeocodeReverseResponse();
  });
  ...
  describe('GeocodeReverseResponse', function() {
    it('should create an instance of GeocodeReverseResponse', function() {
      // uncomment below and update the code to test GeocodeReverseResponse
      //var instance = new NeutrinoApi.GeocodeReverseResponse();
      //expect(instance).to.be.a(NeutrinoApi.GeocodeReverseResponse);
    });
