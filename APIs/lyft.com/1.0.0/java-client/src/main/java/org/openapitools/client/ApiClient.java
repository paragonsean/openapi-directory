...
public class ApiClient {
    ...
    private String basePath = "https://api.lyft.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("Client Authentication", new OAuth());
        authentications.put("User Authentication", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.lyft.com/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.lyft.com/v1
