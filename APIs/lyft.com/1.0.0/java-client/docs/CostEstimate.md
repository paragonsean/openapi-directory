...
|**estimatedCostCentsMax** | **Integer** | Estimated upper bound for trip cost, in minor units (cents). Estimates are not guaranteed, and only provide a reasonable range based on current conditions.  |  [optional] |
|**estimatedCostCentsMin** | **Integer** | Estimated lower bound for trip cost, in minor units (cents). Estimates are not guaranteed, and only provide a reasonable range based on current conditions.  |  [optional] |
|**estimatedDistanceMiles** | **Double** | Estimated distance for this trip  |  [optional] |
|**estimatedDurationSeconds** | **Integer** | Estimated time to get from the start location to the end.  |  [optional] |
...
|**rideType** | **RideTypeEnum** |  |  [optional] |
