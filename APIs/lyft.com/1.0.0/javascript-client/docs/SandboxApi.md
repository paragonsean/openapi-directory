...
apiInstance.setPrimeTime(request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.setRideStatus(id, request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.setRideTypeAvailability(rideType, request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.setRideTypes(request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
