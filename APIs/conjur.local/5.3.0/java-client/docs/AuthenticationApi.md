...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationApi apiInstance = new AuthenticationApi(defaultClient);
    String authenticator = "authn-iam"; // String | The authenticator to update
...
<a id="enableAuthenticatorInstance"></a>
# **enableAuthenticatorInstance**
> enableAuthenticatorInstance(authenticator, serviceId, account, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationApi apiInstance = new AuthenticationApi(defaultClient);
    ERRORUNKNOWN authenticator = new ERRORUNKNOWN(); // ERRORUNKNOWN | The authenticator to update
    String serviceId = "prod%2fgke"; // String | URL-Encoded authenticator service ID
    String account = "dev"; // String | Organization account name
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
      apiInstance.enableAuthenticatorInstance(authenticator, serviceId, account, xRequestId);
    } catch (ApiException e) {
...
<a id="getAPIKeyViaLDAP"></a>
# **getAPIKeyViaLDAP**
> getAPIKeyViaLDAP(serviceId, account, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
      apiInstance.getAPIKeyViaLDAP(serviceId, account, xRequestId);
    } catch (ApiException e) {
...
# **getAccessToken**
> String getAccessToken(account, login, body, xRequestId, acceptEncoding)
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationApi apiInstance = new AuthenticationApi(defaultClient);
    String account = "account_example"; // String | Organization account name
    String login = "admin"; // String | URL-encoded login name. For users, it’s the user ID. For hosts, the login name is `host/<host-id>`
    Object body = null; // Object | API Key
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    ...
    try {
      String result = apiInstance.getAccessToken(account, login, body, xRequestId, acceptEncoding);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaAWS"></a>
# **getAccessTokenViaAWS**
> getAccessTokenViaAWS(serviceId, account, login, body, xRequestId, acceptEncoding)
...
public class Example {
  public static void main(String[] args) {
    ...
    String serviceId = "prod%2fgke"; // String | URL-Encoded authenticator service ID
    String account = "account_example"; // String | Organization account name
    ERRORUNKNOWN login = new ERRORUNKNOWN(); // ERRORUNKNOWN | URL-encoded login name. For hosts, the login name is `host/<host-id>`
    String body = "body_example"; // String | AWS Signature header
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    String acceptEncoding = "application/json"; // String | Setting the Accept-Encoding header to base64 will return a pre-encoded access token
    try {
      apiInstance.getAccessTokenViaAWS(serviceId, account, login, body, xRequestId, acceptEncoding);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaAzure"></a>
# **getAccessTokenViaAzure**
> getAccessTokenViaAzure(serviceId, account, login, xRequestId, acceptEncoding, jwt)
...
public class Example {
  public static void main(String[] args) {
    ...
    String serviceId = "prod%2fgke"; // String | URL-Encoded authenticator service ID
    String account = "account_example"; // String | Organization account name
    ERRORUNKNOWN login = new ERRORUNKNOWN(); // ERRORUNKNOWN | URL-encoded login name. For users, it’s the user ID. For hosts, the login name is `host/<host-id>`
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    String acceptEncoding = "application/json"; // String | Setting the Accept-Encoding header to base64 will return a pre-encoded access token
    String jwt = "jwt_example"; // String | 
    try {
      apiInstance.getAccessTokenViaAzure(serviceId, account, login, xRequestId, acceptEncoding, jwt);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaGCP"></a>
# **getAccessTokenViaGCP**
> getAccessTokenViaGCP(account, xRequestId, acceptEncoding, jwt)
...
public class Example {
  public static void main(String[] args) {
    ...
    String account = "dev"; // String | Organization account name
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    String acceptEncoding = "base64"; // String | Setting the Accept-Encoding header to base64 will return a pre-encoded access token
    String jwt = "jwt_example"; // String | 
    try {
      apiInstance.getAccessTokenViaGCP(account, xRequestId, acceptEncoding, jwt);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaJWT"></a>
# **getAccessTokenViaJWT**
> getAccessTokenViaJWT(account, serviceId, xRequestId, jwt)
...
public class Example {
  public static void main(String[] args) {
    ...
    String jwt = "jwt_example"; // String | 
    try {
      apiInstance.getAccessTokenViaJWT(account, serviceId, xRequestId, jwt);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaJWTWithId"></a>
# **getAccessTokenViaJWTWithId**
> getAccessTokenViaJWTWithId(account, id, serviceId, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthenticationApi apiInstance = new AuthenticationApi(defaultClient);
    String account = "account_example"; // String | Organization account name
    String id = "SomeUserID"; // String | Organization user id
    String serviceId = "prod%2fgke"; // String | URL-Encoded authenticator service ID
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
      apiInstance.getAccessTokenViaJWTWithId(account, id, serviceId, xRequestId);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaKubernetes"></a>
# **getAccessTokenViaKubernetes**
> getAccessTokenViaKubernetes(serviceId, account, login, xRequestId, acceptEncoding)
...
public class Example {
  public static void main(String[] args) {
    ...
    String acceptEncoding = "application/json"; // String | Setting the Accept-Encoding header to base64 will return a pre-encoded access token
    try {
      apiInstance.getAccessTokenViaKubernetes(serviceId, account, login, xRequestId, acceptEncoding);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaLDAP"></a>
# **getAccessTokenViaLDAP**
> getAccessTokenViaLDAP(serviceId, account, login, xRequestId, acceptEncoding, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object body = null; // Object | API key
    try {
      apiInstance.getAccessTokenViaLDAP(serviceId, account, login, xRequestId, acceptEncoding, body);
    } catch (ApiException e) {
...
<a id="getAccessTokenViaOIDC"></a>
# **getAccessTokenViaOIDC**
> getAccessTokenViaOIDC(serviceId, account, xRequestId, idToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getAccessTokenViaOIDC(serviceId, account, xRequestId, idToken);
    } catch (ApiException e) {
...
<a id="k8sInjectClientCert"></a>
# **k8sInjectClientCert**
> k8sInjectClientCert(serviceId, body, xRequestId, hostIdPrefix)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.k8sInjectClientCert(serviceId, body, xRequestId, hostIdPrefix);
    } catch (ApiException e) {
...
<a id="rotateApiKey"></a>
# **rotateApiKey**
> rotateApiKey(account, xRequestId, role)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.rotateApiKey(account, xRequestId, role);
    } catch (ApiException e) {
