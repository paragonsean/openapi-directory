...
<a id="sign"></a>
# **sign**
> Sign201Response sign(account, serviceId, csr, ttl, xRequestId, accept)
...
import org.openapitools.client.api.CertificateAuthorityApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Sign201Response result = apiInstance.sign(account, serviceId, csr, ttl, xRequestId, accept);
