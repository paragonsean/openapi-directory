...
<a id="loadPolicy"></a>
# **loadPolicy**
> loadPolicy(account, identifier, body, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object body = null; // Object | Policy
    ...
    try {
      apiInstance.loadPolicy(account, identifier, body, xRequestId);
...
<a id="replacePolicy"></a>
# **replacePolicy**
> ReplacePolicy201Response replacePolicy(account, identifier, body, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
      ReplacePolicy201Response result = apiInstance.replacePolicy(account, identifier, body, xRequestId);
...
<a id="updatePolicy"></a>
# **updatePolicy**
> updatePolicy(account, identifier, body, xRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
      apiInstance.updatePolicy(account, identifier, body, xRequestId);
    } catch (ApiException e) {
