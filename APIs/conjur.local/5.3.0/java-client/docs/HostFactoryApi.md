...
<a id="createHost"></a>
# **createHost**
> CreateHost201Response createHost(id, xRequestId, annotations)
...
import org.openapitools.client.api.HostFactoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateHost201Response result = apiInstance.createHost(id, xRequestId, annotations);
...
<a id="createToken"></a>
# **createToken**
> List&lt;CreateToken200ResponseInner&gt; createToken(expiration, hostFactory, xRequestId, cidr, count)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    List<String> cidr = Arrays.asList(); // List<String> | Number of host tokens to create
    Integer count = 56; // Integer | Number of host tokens to create
    try {
      List<CreateToken200ResponseInner> result = apiInstance.createToken(expiration, hostFactory, xRequestId, cidr, count);
      System.out.println(result);
    } catch (ApiException e) {
...
[**List&lt;CreateToken200ResponseInner&gt;**](CreateToken200ResponseInner.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    HostFactoryApi apiInstance = new HostFactoryApi(defaultClient);
    String token = "2c0vfj61pmah3efbgpcz2x9vzcy1ycskfkyqy0kgk1fv014880f4"; // String | The host factory token to revoke
    String xRequestId = "test-id"; // String | Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
    try {
