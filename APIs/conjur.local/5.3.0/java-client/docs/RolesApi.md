...
<a id="showRole"></a>
# **showRole**
> Object showRole(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.showRole(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph);
