...
public class RolesApi {
    ...
    private okhttp3.Call addMemberToRoleValidateBeforeCall(String account, String kind, String identifier, String members, String member, String xRequestId, final ApiCallback _callback) throws ApiException {
        ...
        return addMemberToRoleCall(account, kind, identifier, members, member, xRequestId, _callback);
    ...
    private okhttp3.Call removeMemberFromRoleValidateBeforeCall(String account, String kind, String identifier, String members, String member, String xRequestId, final ApiCallback _callback) throws ApiException {
        ...
        return removeMemberFromRoleCall(account, kind, identifier, members, member, xRequestId, _callback);
     ...
     */
    public okhttp3.Call showRoleCall(String account, String kind, String identifier, String xRequestId, String all, String memberships, String members, Integer offset, Integer limit, Boolean count, String search, String graph, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call showRoleValidateBeforeCall(String account, String kind, String identifier, String xRequestId, String all, String memberships, String members, Integer offset, Integer limit, Boolean count, String search, String graph, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'account' is set
        if (account == null) {
        ...
        return showRoleCall(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph, _callback);
     ...
     */
    public Object showRole(String account, String kind, String identifier, String xRequestId, String all, String memberships, String members, Integer offset, Integer limit, Boolean count, String search, String graph) throws ApiException {
        ApiResponse<Object> localVarResp = showRoleWithHttpInfo(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph);
     ...
     */
    public ApiResponse<Object> showRoleWithHttpInfo(String account, String kind, String identifier, String xRequestId, String all, String memberships, String members, Integer offset, Integer limit, Boolean count, String search, String graph) throws ApiException {
        okhttp3.Call localVarCall = showRoleValidateBeforeCall(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph, null);
     ...
     */
    public okhttp3.Call showRoleAsync(String account, String kind, String identifier, String xRequestId, String all, String memberships, String members, Integer offset, Integer limit, Boolean count, String search, String graph, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = showRoleValidateBeforeCall(account, kind, identifier, xRequestId, all, memberships, members, offset, limit, count, search, graph, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
