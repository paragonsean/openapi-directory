...
public class HostFactoryApiTest {
    ...
    public void createHostTest() throws ApiException {
        ...
        CreateHost201Response response = api.createHost(id, xRequestId, annotations);
    ...
    public void createTokenTest() throws ApiException {
        ...
        Integer count = null;
        List<CreateToken200ResponseInner> response = api.createToken(expiration, hostFactory, xRequestId, cidr, count);
        // TODO: test validations
    }
