...
/*
 * OAICompactJurisdiction.h
 *
 * 
 */

#ifndef OAICompactJurisdiction_H
#define OAICompactJurisdiction_H
...
class OAICompactJurisdiction : public OAIObject {
public:
    OAICompactJurisdiction();
    OAICompactJurisdiction(QString json);
    ~OAICompactJurisdiction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompactJurisdiction)

#endif // OAICompactJurisdiction_H
