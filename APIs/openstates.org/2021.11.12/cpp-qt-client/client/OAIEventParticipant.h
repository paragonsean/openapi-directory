...
/*
 * OAIEventParticipant.h
 *
 * 
 */

#ifndef OAIEventParticipant_H
#define OAIEventParticipant_H
...
class OAIEventParticipant : public OAIObject {
public:
    OAIEventParticipant();
    OAIEventParticipant(QString json);
    ~OAIEventParticipant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventParticipant)

#endif // OAIEventParticipant_H
