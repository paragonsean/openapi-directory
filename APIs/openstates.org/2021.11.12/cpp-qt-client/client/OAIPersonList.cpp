...
OAIPaginationMeta OAIPersonList::getPagination() const {
    return m_pagination;
}
void OAIPersonList::setPagination(const OAIPaginationMeta &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIPersonList::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIPersonList::is_pagination_Valid() const{
    return m_pagination_isValid;
}

QList<OAIPerson> OAIPersonList::getResults() const {
    return m_results;
}
void OAIPersonList::setResults(const QList<OAIPerson> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIPersonList::is_results_Set() const{
    return m_results_isSet;
}

bool OAIPersonList::is_results_Valid() const{
