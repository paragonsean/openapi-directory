...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("metricsMetricsGet", defaultConf);
    _serverIndices.insert("metricsMetricsGet", 0);
}
...
void OAIDefaultApi::metricsMetricsGet() {
    QString fullPath = QString(_serverConfigs["metricsMetricsGet"][_serverIndices.value("metricsMetricsGet")].URL()+"/metrics");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::metricsMetricsGetCallback);
...
void OAIDefaultApi::metricsMetricsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT metricsMetricsGetSignal(output);
        Q_EMIT metricsMetricsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT metricsMetricsGetSignalE(output, error_type, error_str);
        Q_EMIT metricsMetricsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT metricsMetricsGetSignalError(output, error_type, error_str);
        Q_EMIT metricsMetricsGetSignalErrorFull(worker, error_type, error_str);
    }
}
