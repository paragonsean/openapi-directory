...
#ifndef OAIEventMedia_H
#define OAIEventMedia_H
...
class OAIEventMedia : public OAIObject {
public:
    OAIEventMedia();
    OAIEventMedia(QString json);
    ~OAIEventMedia() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventMedia)

#endif // OAIEventMedia_H
