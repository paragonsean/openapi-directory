...
class PersonList {
    ...
    constructor(pagination, results) { 
        ...
        PersonList.initialize(this, pagination, results);
    }
...
PersonList.RequiredProperties = ["pagination", "results"];

/**
 * @member {module:model/PaginationMeta} pagination
 */
PersonList.prototype['pagination'] = undefined;

/**
 * @member {Array.<module:model/Person>} results
 */
PersonList.prototype['results'] = undefined;
