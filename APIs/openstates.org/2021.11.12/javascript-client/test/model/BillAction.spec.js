...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.BillAction();
  });
  ...
  describe('BillAction', function() {
    it('should create an instance of BillAction', function() {
      // uncomment below and update the code to test BillAction
      //var instance = new OpenStatesApiV3.BillAction();
      //expect(instance).to.be.a(OpenStatesApiV3.BillAction);
    });
