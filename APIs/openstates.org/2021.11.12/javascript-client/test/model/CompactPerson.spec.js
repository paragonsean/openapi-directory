...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.CompactPerson();
  });
  ...
  describe('CompactPerson', function() {
    it('should create an instance of CompactPerson', function() {
      // uncomment below and update the code to test CompactPerson
      //var instance = new OpenStatesApiV3.CompactPerson();
      //expect(instance).to.be.a(OpenStatesApiV3.CompactPerson);
    });
