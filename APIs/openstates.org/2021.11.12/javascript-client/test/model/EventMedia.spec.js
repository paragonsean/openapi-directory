...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.EventMedia();
  });
  ...
  describe('EventMedia', function() {
    it('should create an instance of EventMedia', function() {
      // uncomment below and update the code to test EventMedia
      //var instance = new OpenStatesApiV3.EventMedia();
      //expect(instance).to.be.a(OpenStatesApiV3.EventMedia);
    });
