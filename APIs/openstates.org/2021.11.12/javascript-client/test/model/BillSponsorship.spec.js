...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.BillSponsorship();
  });
  ...
  describe('BillSponsorship', function() {
    it('should create an instance of BillSponsorship', function() {
      // uncomment below and update the code to test BillSponsorship
      //var instance = new OpenStatesApiV3.BillSponsorship();
      //expect(instance).to.be.a(OpenStatesApiV3.BillSponsorship);
    });
