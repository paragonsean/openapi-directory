...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.Chamber();
  });
  ...
  describe('Chamber', function() {
    it('should create an instance of Chamber', function() {
      // uncomment below and update the code to test Chamber
      //var instance = new OpenStatesApiV3.Chamber();
      //expect(instance).to.be.a(OpenStatesApiV3.Chamber);
    });
