...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new OpenStatesApiV3.HTTPValidationError();
      //expect(instance).to.be.a(OpenStatesApiV3.HTTPValidationError);
    });
