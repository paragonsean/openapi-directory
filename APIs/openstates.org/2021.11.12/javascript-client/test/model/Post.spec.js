...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.Post();
  });
  ...
  describe('Post', function() {
    it('should create an instance of Post', function() {
      ...
      //var instance = new OpenStatesApiV3.Post();
      //expect(instance).to.be.a(OpenStatesApiV3.Post);
    });
    ...
    it('should have the property maximumMemberships (base name: "maximum_memberships")', function() {
      // uncomment below and update the code to test the property maximumMemberships
      //var instance = new OpenStatesApiV3.Post();
      //expect(instance).to.be();
    });
