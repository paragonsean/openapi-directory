...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.LegislativeSession();
  });
  ...
  describe('LegislativeSession', function() {
    it('should create an instance of LegislativeSession', function() {
      // uncomment below and update the code to test LegislativeSession
      //var instance = new OpenStatesApiV3.LegislativeSession();
      //expect(instance).to.be.a(OpenStatesApiV3.LegislativeSession);
    });
