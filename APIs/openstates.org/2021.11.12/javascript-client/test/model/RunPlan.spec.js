...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.RunPlan();
  });
  ...
  describe('RunPlan', function() {
    it('should create an instance of RunPlan', function() {
      // uncomment below and update the code to test RunPlan
      //var instance = new OpenStatesApiV3.RunPlan();
      //expect(instance).to.be.a(OpenStatesApiV3.RunPlan);
    });
