...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStatesApiV3.EventRelatedEntity();
  });
  ...
  describe('EventRelatedEntity', function() {
    it('should create an instance of EventRelatedEntity', function() {
      // uncomment below and update the code to test EventRelatedEntity
      //var instance = new OpenStatesApiV3.EventRelatedEntity();
      //expect(instance).to.be.a(OpenStatesApiV3.EventRelatedEntity);
    });
