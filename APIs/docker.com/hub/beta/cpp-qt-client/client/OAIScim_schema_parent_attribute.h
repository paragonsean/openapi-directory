...
/*
 * OAIScim_schema_parent_attribute.h
 *
 * 
 */

#ifndef OAIScim_schema_parent_attribute_H
#define OAIScim_schema_parent_attribute_H
...
namespace OpenAPI {
class OAIScim_schema_attribute;

class OAIScim_schema_parent_attribute : public OAIObject {
public:
    OAIScim_schema_parent_attribute();
    OAIScim_schema_parent_attribute(QString json);
    ~OAIScim_schema_parent_attribute() override;
    ...
    QList<OAIScim_schema_attribute> getSubAttributes() const;
    void setSubAttributes(const QList<OAIScim_schema_attribute> &sub_attributes);
    bool is_sub_attributes_Set() const;
    bool is_sub_attributes_Valid() const;
...
private:
    ...
    QList<OAIScim_schema_attribute> m_sub_attributes;
    bool m_sub_attributes_isSet;
    bool m_sub_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIScim_schema_parent_attribute)

#endif // OAIScim_schema_parent_attribute_H
