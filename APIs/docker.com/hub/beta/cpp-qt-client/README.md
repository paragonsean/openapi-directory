...
void Example::exampleFunction1(){
     OAIAccessTokensApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccessTokensApi::v2AccessTokensGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccessTokensApi::v2AccessTokensGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      double page = create(); // double | 
      ...
      double page_size = create(); // double | 
      apiInstance.v2AccessTokensGet(pagepage_size);
