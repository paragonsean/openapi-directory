# DockerHubApi.AuthenticationApi
...
let apiInstance = new DockerHubApi.AuthenticationApi();
let users2FALoginRequest = new DockerHubApi.Users2FALoginRequest(); // Users2FALoginRequest | Login details.
...
let apiInstance = new DockerHubApi.AuthenticationApi();
let usersLoginRequest = new DockerHubApi.UsersLoginRequest(); // UsersLoginRequest | Login details.
