...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerHubApi.ScimEmail();
  });
  ...
  describe('ScimEmail', function() {
    it('should create an instance of ScimEmail', function() {
      // uncomment below and update the code to test ScimEmail
      //var instance = new DockerHubApi.ScimEmail();
      //expect(instance).to.be.a(DockerHubApi.ScimEmail);
    });
