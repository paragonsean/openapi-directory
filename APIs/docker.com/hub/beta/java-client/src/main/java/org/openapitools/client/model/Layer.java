...
public class Layer {
  ...
  public Layer digest(String digest) {
    this.digest = digest;
    return this;
  }
  ...
  public Layer instruction(String instruction) {
  ...
  public Layer size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.digest, layer.digest) &&
        Objects.equals(this.instruction, layer.instruction) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(digest, instruction, size);
  }
