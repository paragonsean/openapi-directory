...
/**
 * The MonthData model module.
 * @module model/MonthData
 * @version 1.0.0
 */
class MonthData {
    /**
     * Constructs a new <code>MonthData</code>.
     * @alias module:model/MonthData
     */
    constructor() { 
        
        MonthData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MonthData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonthData} obj Optional instance to populate.
     * @return {module:model/MonthData} The populated <code>MonthData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonthData();

            if (data.hasOwnProperty('months')) {
                obj['months'] = ApiClient.convertToType(data['months'], [MonthModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MonthData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonthData</code>.
     */
 ...
 */
MonthData.prototype['months'] = undefined;
