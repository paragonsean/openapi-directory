...
* @readonly
*/
export default class TimespanType {
    ...
    /**
    * Returns a <code>TimespanType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TimespanType} The enum <code>TimespanType</code> value.
    */
