...
/**
 * The WeekData model module.
 * @module model/WeekData
 * @version 1.0.0
 */
class WeekData {
    /**
     * Constructs a new <code>WeekData</code>.
     * @alias module:model/WeekData
     */
    constructor() { 
        
        WeekData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WeekData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WeekData} obj Optional instance to populate.
     * @return {module:model/WeekData} The populated <code>WeekData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WeekData();

            if (data.hasOwnProperty('weeks')) {
                obj['weeks'] = ApiClient.convertToType(data['weeks'], [WeekModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WeekData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WeekData</code>.
     */
 ...
 */
WeekData.prototype['weeks'] = undefined;
