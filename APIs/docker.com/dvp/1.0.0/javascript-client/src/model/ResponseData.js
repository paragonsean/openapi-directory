    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ResponseDataFile]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ResponseDataFile.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ResponseDataFile>} data
 */
ResponseData.prototype['data'] = undefined;
