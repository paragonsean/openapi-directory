...
/**
 * The YearData model module.
 * @module model/YearData
 * @version 1.0.0
 */
class YearData {
    /**
     * Constructs a new <code>YearData</code>.
     * @alias module:model/YearData
     */
    constructor() { 
        
        YearData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>YearData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/YearData} obj Optional instance to populate.
     * @return {module:model/YearData} The populated <code>YearData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new YearData();

            if (data.hasOwnProperty('years')) {
                obj['years'] = ApiClient.convertToType(data['years'], [YearModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>YearData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>YearData</code>.
     */
    static validateJSON(data) {
        if (data['years']) { // data not null
...
/**
 * @member {Array.<module:model/YearModel>} years
 */
YearData.prototype['years'] = undefined;
