...
* @readonly
*/
export default class DataviewType {
    ...
    /**
    * Returns a <code>DataviewType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DataviewType} The enum <code>DataviewType</code> value.
    */
