...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    describe('postUsers2FALogin', function() {
      it('should call postUsers2FALogin successfully', function(done) {
        //uncomment below and update the code to test postUsers2FALogin
        //instance.postUsers2FALogin(function(error) {
    ...
    describe('postUsersLogin', function() {
      it('should call postUsersLogin successfully', function(done) {
        //uncomment below and update the code to test postUsersLogin
        //instance.postUsersLogin(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
