...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.NamespacesApi();
  });
  ...
  describe('NamespacesApi', function() {
    describe('getNamespaceDataByTimespan', function() {
      it('should call getNamespaceDataByTimespan successfully', function(done) {
        //uncomment below and update the code to test getNamespaceDataByTimespan
        //instance.getNamespaceDataByTimespan(function(error) {
    ...
    describe('getNamespaceTimespanMetadata', function() {
      it('should call getNamespaceTimespanMetadata successfully', function(done) {
        //uncomment below and update the code to test getNamespaceTimespanMetadata
        //instance.getNamespaceTimespanMetadata(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getNamespaceTimespans', function() {
      it('should call getNamespaceTimespans successfully', function(done) {
        //uncomment below and update the code to test getNamespaceTimespans
        //instance.getNamespaceTimespans(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getNamespaceYears', function() {
      it('should call getNamespaceYears successfully', function(done) {
        //uncomment below and update the code to test getNamespaceYears
        //instance.getNamespaceYears(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
