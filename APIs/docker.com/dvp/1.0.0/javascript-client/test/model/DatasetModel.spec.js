...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.DatasetModel();
  });
  ...
  describe('DatasetModel', function() {
    it('should create an instance of DatasetModel', function() {
      // uncomment below and update the code to test DatasetModel
      //var instance = new DvpDataApi.DatasetModel();
      //expect(instance).to.be.a(DvpDataApi.DatasetModel);
    });
    ...
    it('should have the property timespans (base name: "timespans")', function() {
      // uncomment below and update the code to test the property timespans
      //var instance = new DvpDataApi.DatasetModel();
      //expect(instance).to.be();
    });
