...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.NamespaceMetadata();
  });
  ...
  describe('NamespaceMetadata', function() {
    it('should create an instance of NamespaceMetadata', function() {
      // uncomment below and update the code to test NamespaceMetadata
      //var instance = new DvpDataApi.NamespaceMetadata();
      //expect(instance).to.be.a(DvpDataApi.NamespaceMetadata);
    });
    ...
    it('should have the property extraRepos (base name: "extraRepos")', function() {
      // uncomment below and update the code to test the property extraRepos
      //var instance = new DvpDataApi.NamespaceMetadata();
      //expect(instance).to.be();
    });
