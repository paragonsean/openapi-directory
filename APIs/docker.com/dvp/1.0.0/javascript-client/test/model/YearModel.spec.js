...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.YearModel();
  });
  ...
  describe('YearModel', function() {
    it('should create an instance of YearModel', function() {
      // uncomment below and update the code to test YearModel
      //var instance = new DvpDataApi.YearModel();
      //expect(instance).to.be.a(DvpDataApi.YearModel);
    });
