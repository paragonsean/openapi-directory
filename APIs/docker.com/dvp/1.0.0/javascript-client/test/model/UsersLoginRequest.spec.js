...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.UsersLoginRequest();
  });
  ...
  describe('UsersLoginRequest', function() {
    it('should create an instance of UsersLoginRequest', function() {
      // uncomment below and update the code to test UsersLoginRequest
      //var instance = new DvpDataApi.UsersLoginRequest();
      //expect(instance).to.be.a(DvpDataApi.UsersLoginRequest);
    });
