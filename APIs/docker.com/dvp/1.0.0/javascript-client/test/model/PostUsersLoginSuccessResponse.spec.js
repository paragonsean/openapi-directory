...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.PostUsersLoginSuccessResponse();
  });
  ...
  describe('PostUsersLoginSuccessResponse', function() {
    it('should create an instance of PostUsersLoginSuccessResponse', function() {
      // uncomment below and update the code to test PostUsersLoginSuccessResponse
      //var instance = new DvpDataApi.PostUsersLoginSuccessResponse();
      //expect(instance).to.be.a(DvpDataApi.PostUsersLoginSuccessResponse);
    });
