...
(function(root, factory) {
  ...
  describe('DataviewType', function() {
    it('should create an instance of DataviewType', function() {
      // uncomment below and update the code to test DataviewType
      //var instance = new DvpDataApi.DataviewType();
      //expect(instance).to.be.a(DvpDataApi.DataviewType);
    });
