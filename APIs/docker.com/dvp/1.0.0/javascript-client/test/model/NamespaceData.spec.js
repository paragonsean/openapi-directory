...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.NamespaceData();
  });
  ...
  describe('NamespaceData', function() {
    it('should create an instance of NamespaceData', function() {
      // uncomment below and update the code to test NamespaceData
      //var instance = new DvpDataApi.NamespaceData();
      //expect(instance).to.be.a(DvpDataApi.NamespaceData);
    });
