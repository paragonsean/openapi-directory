...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.MonthData();
  });
  ...
  describe('MonthData', function() {
    it('should create an instance of MonthData', function() {
      // uncomment below and update the code to test MonthData
      //var instance = new DvpDataApi.MonthData();
      //expect(instance).to.be.a(DvpDataApi.MonthData);
    });
