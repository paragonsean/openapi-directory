...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.WeekData();
  });
  ...
  describe('WeekData', function() {
    it('should create an instance of WeekData', function() {
      // uncomment below and update the code to test WeekData
      //var instance = new DvpDataApi.WeekData();
      //expect(instance).to.be.a(DvpDataApi.WeekData);
    });
