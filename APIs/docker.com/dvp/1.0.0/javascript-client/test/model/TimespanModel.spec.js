...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.TimespanModel();
  });
  ...
  describe('TimespanModel', function() {
    it('should create an instance of TimespanModel', function() {
      // uncomment below and update the code to test TimespanModel
      //var instance = new DvpDataApi.TimespanModel();
      //expect(instance).to.be.a(DvpDataApi.TimespanModel);
    });
