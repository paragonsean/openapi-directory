...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.YearData();
  });
  ...
  describe('YearData', function() {
    it('should create an instance of YearData', function() {
      // uncomment below and update the code to test YearData
      //var instance = new DvpDataApi.YearData();
      //expect(instance).to.be.a(DvpDataApi.YearData);
    });
