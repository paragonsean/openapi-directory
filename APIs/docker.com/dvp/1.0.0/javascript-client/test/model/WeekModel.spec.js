...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.WeekModel();
  });
  ...
  describe('WeekModel', function() {
    it('should create an instance of WeekModel', function() {
      // uncomment below and update the code to test WeekModel
      //var instance = new DvpDataApi.WeekModel();
      //expect(instance).to.be.a(DvpDataApi.WeekModel);
    });
