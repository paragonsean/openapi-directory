...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.MonthModel();
  });
  ...
  describe('MonthModel', function() {
    it('should create an instance of MonthModel', function() {
      // uncomment below and update the code to test MonthModel
      //var instance = new DvpDataApi.MonthModel();
      //expect(instance).to.be.a(DvpDataApi.MonthModel);
    });
