...
(function(root, factory) {
  ...
  describe('TimespanType', function() {
    it('should create an instance of TimespanType', function() {
      // uncomment below and update the code to test TimespanType
      //var instance = new DvpDataApi.TimespanType();
      //expect(instance).to.be.a(DvpDataApi.TimespanType);
    });
