...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.PostUsersLoginErrorResponse();
  });
  ...
  describe('PostUsersLoginErrorResponse', function() {
    it('should create an instance of PostUsersLoginErrorResponse', function() {
      // uncomment below and update the code to test PostUsersLoginErrorResponse
      //var instance = new DvpDataApi.PostUsersLoginErrorResponse();
      //expect(instance).to.be.a(DvpDataApi.PostUsersLoginErrorResponse);
    });
