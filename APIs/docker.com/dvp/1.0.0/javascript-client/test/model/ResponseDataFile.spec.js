...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.ResponseDataFile();
  });
  ...
  describe('ResponseDataFile', function() {
    it('should create an instance of ResponseDataFile', function() {
      // uncomment below and update the code to test ResponseDataFile
      //var instance = new DvpDataApi.ResponseDataFile();
      //expect(instance).to.be.a(DvpDataApi.ResponseDataFile);
    });
