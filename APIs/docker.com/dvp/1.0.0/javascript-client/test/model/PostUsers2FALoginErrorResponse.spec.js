...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.PostUsers2FALoginErrorResponse();
  });
  ...
  describe('PostUsers2FALoginErrorResponse', function() {
    it('should create an instance of PostUsers2FALoginErrorResponse', function() {
      ...
      //var instance = new DvpDataApi.PostUsers2FALoginErrorResponse();
      //expect(instance).to.be.a(DvpDataApi.PostUsers2FALoginErrorResponse);
    });
