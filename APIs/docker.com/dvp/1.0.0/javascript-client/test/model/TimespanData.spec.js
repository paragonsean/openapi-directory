...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DvpDataApi.TimespanData();
  });
  ...
  describe('TimespanData', function() {
    it('should create an instance of TimespanData', function() {
      // uncomment below and update the code to test TimespanData
      //var instance = new DvpDataApi.TimespanData();
      //expect(instance).to.be.a(DvpDataApi.TimespanData);
    });
