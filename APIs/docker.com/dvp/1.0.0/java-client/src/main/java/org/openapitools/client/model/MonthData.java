...
public class MonthData {
  ...
  private List<MonthModel> months = new ArrayList<>();

  public MonthData() {
  }

  public MonthData months(List<MonthModel> months) {
    this.months = months;
    return this;
  }

  public MonthData addMonthsItem(MonthModel monthsItem) {
    if (this.months == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.months, monthData.months);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonthData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonthData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonthData is not found in the empty JSON string", MonthData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonthData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonthData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("months") != null && !jsonObj.get("months").isJsonNull()) {
        ...
        if (jsonArraymonths != null) {
          ...
          for (int i = 0; i < jsonArraymonths.size(); i++) {
            MonthModel.validateJsonElement(jsonArraymonths.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonthData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonthData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonthData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonthData.class));

       return (TypeAdapter<T>) new TypeAdapter<MonthData>() {
           @Override
           public void write(JsonWriter out, MonthData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonthData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonthData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonthData
   * @throws IOException if the JSON string is invalid with respect to MonthData
   */
  public static MonthData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonthData.class);
  }

  /**
   * Convert an instance of MonthData to an JSON string
   *
   * @return JSON string
   */
