...
public class MonthModel {
  ...
  public MonthModel month(Integer month) {
    this.month = month;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonthModel monthModel = (MonthModel) o;
    return Objects.equals(this.month, monthModel.month);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonthModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonthModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonthModel is not found in the empty JSON string", MonthModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonthModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonthModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonthModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonthModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonthModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonthModel.class));

       return (TypeAdapter<T>) new TypeAdapter<MonthModel>() {
           @Override
           public void write(JsonWriter out, MonthModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonthModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonthModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonthModel
   * @throws IOException if the JSON string is invalid with respect to MonthModel
   */
  public static MonthModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonthModel.class);
  }

  /**
   * Convert an instance of MonthModel to an JSON string
   *
   * @return JSON string
   */
