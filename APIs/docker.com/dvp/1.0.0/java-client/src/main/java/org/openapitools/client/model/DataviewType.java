...
/**
 * Gets or Sets DataviewType
 */
@JsonAdapter(DataviewType.Adapter.class)
public enum DataviewType {
  ...
  public static DataviewType fromValue(String value) {
    for (DataviewType b : DataviewType.values()) {
  ...
  public static class Adapter extends TypeAdapter<DataviewType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DataviewType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DataviewType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DataviewType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DataviewType.fromValue(value);
  }
}
