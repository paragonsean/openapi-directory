...
public class WeekData {
  ...
  private List<WeekModel> weeks = new ArrayList<>();

  public WeekData() {
  }

  public WeekData weeks(List<WeekModel> weeks) {
    this.weeks = weeks;
    return this;
  }

  public WeekData addWeeksItem(WeekModel weeksItem) {
    if (this.weeks == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.weeks, weekData.weeks);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WeekData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WeekData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WeekData is not found in the empty JSON string", WeekData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WeekData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WeekData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("weeks") != null && !jsonObj.get("weeks").isJsonNull()) {
        ...
        if (jsonArrayweeks != null) {
          ...
          for (int i = 0; i < jsonArrayweeks.size(); i++) {
            WeekModel.validateJsonElement(jsonArrayweeks.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WeekData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WeekData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WeekData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WeekData.class));

       return (TypeAdapter<T>) new TypeAdapter<WeekData>() {
           @Override
           public void write(JsonWriter out, WeekData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WeekData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WeekData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WeekData
   * @throws IOException if the JSON string is invalid with respect to WeekData
   */
  public static WeekData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WeekData.class);
  }

  /**
   * Convert an instance of WeekData to an JSON string
   *
   * @return JSON string
   */
