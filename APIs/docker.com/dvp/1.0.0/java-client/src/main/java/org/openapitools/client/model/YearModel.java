...
public class YearModel {
  ...
  public YearModel year(Integer year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.year, yearModel.year);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to YearModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!YearModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in YearModel is not found in the empty JSON string", YearModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!YearModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `YearModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!YearModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'YearModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<YearModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(YearModel.class));

       return (TypeAdapter<T>) new TypeAdapter<YearModel>() {
           @Override
           public void write(JsonWriter out, YearModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public YearModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of YearModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of YearModel
   * @throws IOException if the JSON string is invalid with respect to YearModel
   */
  public static YearModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, YearModel.class);
  }

  /**
   * Convert an instance of YearModel to an JSON string
   *
   * @return JSON string
   */
