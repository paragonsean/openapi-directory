...
#ifndef OAIMonthData_H
#define OAIMonthData_H
...
class OAIMonthData : public OAIObject {
public:
    OAIMonthData();
    OAIMonthData(QString json);
    ~OAIMonthData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonthData)

#endif // OAIMonthData_H
