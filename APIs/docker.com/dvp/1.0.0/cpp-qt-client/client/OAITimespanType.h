...
#ifndef OAITimespanType_H
#define OAITimespanType_H
...
class OAITimespanType : public OAIEnum {
public:
    OAITimespanType();
    OAITimespanType(QString json);
    ~OAITimespanType() override;
    ...
    enum class eOAITimespanType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        MONTHS, 
        WEEKS
    };
    OAITimespanType::eOAITimespanType getValue() const;
    void setValue(const OAITimespanType::eOAITimespanType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITimespanType)

#endif // OAITimespanType_H
