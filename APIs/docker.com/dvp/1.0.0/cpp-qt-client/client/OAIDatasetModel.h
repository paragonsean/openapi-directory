...
#ifndef OAIDatasetModel_H
#define OAIDatasetModel_H
...
class OAIDatasetModel : public OAIObject {
public:
    OAIDatasetModel();
    OAIDatasetModel(QString json);
    ~OAIDatasetModel() override;
    ...
    OAIDatasetType getName() const;
    void setName(const OAIDatasetType &name);
    bool is_name_Set() const;
    bool is_name_Valid() const;

    QList<OAITimespanType> getTimespans() const;
    void setTimespans(const QList<OAITimespanType> &timespans);
    bool is_timespans_Set() const;
    bool is_timespans_Valid() const;

    QList<OAIDataviewType> getViews() const;
    void setViews(const QList<OAIDataviewType> &views);
...
private:
    ...
    OAIDatasetType m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QList<OAITimespanType> m_timespans;
    bool m_timespans_isSet;
    bool m_timespans_isValid;

    QList<OAIDataviewType> m_views;
    bool m_views_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetModel)

#endif // OAIDatasetModel_H
