...
QList<OAIResponseDataFile> OAIResponseData::getData() const {
    return m_data;
}
void OAIResponseData::setData(const QList<OAIResponseDataFile> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIResponseData::is_data_Set() const{
    return m_data_isSet;
}

bool OAIResponseData::is_data_Valid() const{
