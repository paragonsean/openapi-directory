...
/*
 * OAIResponseDataFile.h
 *
 * 
 */

#ifndef OAIResponseDataFile_H
#define OAIResponseDataFile_H
...
class OAIResponseDataFile : public OAIObject {
public:
    OAIResponseDataFile();
    OAIResponseDataFile(QString json);
    ~OAIResponseDataFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseDataFile)

#endif // OAIResponseDataFile_H
