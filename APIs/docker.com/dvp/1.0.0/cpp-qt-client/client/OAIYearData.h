...
#ifndef OAIYearData_H
#define OAIYearData_H
...
class OAIYearData : public OAIObject {
public:
    OAIYearData();
    OAIYearData(QString json);
    ~OAIYearData() override;
    ...
    QList<OAIYearModel> getYears() const;
    void setYears(const QList<OAIYearModel> &years);
...
Q_DECLARE_METATYPE(OpenAPI::OAIYearData)
