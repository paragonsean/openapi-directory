...
#ifndef OAIMonthModel_H
#define OAIMonthModel_H
...
class OAIMonthModel : public OAIObject {
public:
    OAIMonthModel();
    OAIMonthModel(QString json);
    ~OAIMonthModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonthModel)

#endif // OAIMonthModel_H
