...
#ifndef OAITimespanModel_H
#define OAITimespanModel_H
...
class OAITimespanModel : public OAIObject {
public:
    OAITimespanModel();
    OAITimespanModel(QString json);
    ~OAITimespanModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimespanModel)

#endif // OAITimespanModel_H
