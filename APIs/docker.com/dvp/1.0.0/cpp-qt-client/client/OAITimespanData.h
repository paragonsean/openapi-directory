...
#ifndef OAITimespanData_H
#define OAITimespanData_H
...
class OAITimespanData : public OAIObject {
public:
    OAITimespanData();
    OAITimespanData(QString json);
    ~OAITimespanData() override;
    ...
    QList<OAIMonthModel> getMonths() const;
    void setMonths(const QList<OAIMonthModel> &months);
    bool is_months_Set() const;
    bool is_months_Valid() const;

    QList<OAIWeekModel> getWeeks() const;
    void setWeeks(const QList<OAIWeekModel> &weeks);
...
private:
    ...
    QList<OAIMonthModel> m_months;
    bool m_months_isSet;
    bool m_months_isValid;

    QList<OAIWeekModel> m_weeks;
    bool m_weeks_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimespanData)

#endif // OAITimespanData_H
