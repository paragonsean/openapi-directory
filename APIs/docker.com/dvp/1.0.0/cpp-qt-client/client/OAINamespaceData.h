...
#ifndef OAINamespaceData_H
#define OAINamespaceData_H
...
class OAINamespaceData : public OAIObject {
public:
    OAINamespaceData();
    OAINamespaceData(QString json);
    ~OAINamespaceData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINamespaceData)

#endif // OAINamespaceData_H
