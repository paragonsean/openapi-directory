...
#ifndef OAIWeekModel_H
#define OAIWeekModel_H
...
class OAIWeekModel : public OAIObject {
public:
    OAIWeekModel();
    OAIWeekModel(QString json);
    ~OAIWeekModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWeekModel)

#endif // OAIWeekModel_H
