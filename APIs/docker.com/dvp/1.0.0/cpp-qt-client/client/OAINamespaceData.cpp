...
OAINamespaceData::OAINamespaceData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINamespaceData::OAINamespaceData() {
    this->initializeModel();
}

OAINamespaceData::~OAINamespaceData() {}

void OAINamespaceData::initializeModel() {

    m_namespaces_isSet = false;
    m_namespaces_isValid = false;
}

void OAINamespaceData::fromJson(QString jsonString) {
...
void OAINamespaceData::fromJsonObject(QJsonObject json) {
...
QString OAINamespaceData::asJson() const {
...
QJsonObject OAINamespaceData::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAINamespaceData::getNamespaces() const {
    return m_namespaces;
}
void OAINamespaceData::setNamespaces(const QList<QString> &namespaces) {
    m_namespaces = namespaces;
    m_namespaces_isSet = true;
}

bool OAINamespaceData::is_namespaces_Set() const{
    return m_namespaces_isSet;
}

bool OAINamespaceData::is_namespaces_Valid() const{
    return m_namespaces_isValid;
}

bool OAINamespaceData::isSet() const {
...
bool OAINamespaceData::isValid() const {
