...
#ifndef OAIYearModel_H
#define OAIYearModel_H
...
class OAIYearModel : public OAIObject {
public:
    OAIYearModel();
    OAIYearModel(QString json);
    ~OAIYearModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIYearModel)

#endif // OAIYearModel_H
