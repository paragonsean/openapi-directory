...
#ifndef OAIWeekData_H
#define OAIWeekData_H
...
class OAIWeekData : public OAIObject {
public:
    OAIWeekData();
    OAIWeekData(QString json);
    ~OAIWeekData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWeekData)
