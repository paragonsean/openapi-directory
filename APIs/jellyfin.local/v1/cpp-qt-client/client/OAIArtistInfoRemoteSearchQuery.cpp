...
OAIArtistInfoRemoteSearchQuery::OAIArtistInfoRemoteSearchQuery(QString json) {
...
void OAIArtistInfoRemoteSearchQuery::initializeModel() {
...
void OAIArtistInfoRemoteSearchQuery::fromJson(QString jsonString) {
...
void OAIArtistInfoRemoteSearchQuery::fromJsonObject(QJsonObject json) {
...
QString OAIArtistInfoRemoteSearchQuery::asJson() const {
...
QJsonObject OAIArtistInfoRemoteSearchQuery::asJsonObject() const {
    QJsonObject obj;
...
bool OAIArtistInfoRemoteSearchQuery::isIncludeDisabledProviders() const {
    return m_include_disabled_providers;
}
void OAIArtistInfoRemoteSearchQuery::setIncludeDisabledProviders(const bool &include_disabled_providers) {
    m_include_disabled_providers = include_disabled_providers;
    m_include_disabled_providers_isSet = true;
}

bool OAIArtistInfoRemoteSearchQuery::is_include_disabled_providers_Set() const{
    return m_include_disabled_providers_isSet;
}

bool OAIArtistInfoRemoteSearchQuery::is_include_disabled_providers_Valid() const{
    return m_include_disabled_providers_isValid;
}

QString OAIArtistInfoRemoteSearchQuery::getItemId() const {
    return m_item_id;
}
void OAIArtistInfoRemoteSearchQuery::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIArtistInfoRemoteSearchQuery::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIArtistInfoRemoteSearchQuery::is_item_id_Valid() const{
    return m_item_id_isValid;
}

OAIArtistInfo OAIArtistInfoRemoteSearchQuery::getSearchInfo() const {
    return m_search_info;
}
void OAIArtistInfoRemoteSearchQuery::setSearchInfo(const OAIArtistInfo &search_info) {
    m_search_info = search_info;
    m_search_info_isSet = true;
}

bool OAIArtistInfoRemoteSearchQuery::is_search_info_Set() const{
    return m_search_info_isSet;
}

bool OAIArtistInfoRemoteSearchQuery::is_search_info_Valid() const{
    return m_search_info_isValid;
}

QString OAIArtistInfoRemoteSearchQuery::getSearchProviderName() const {
    return m_search_provider_name;
}
void OAIArtistInfoRemoteSearchQuery::setSearchProviderName(const QString &search_provider_name) {
    m_search_provider_name = search_provider_name;
    m_search_provider_name_isSet = true;
}

bool OAIArtistInfoRemoteSearchQuery::is_search_provider_name_Set() const{
    return m_search_provider_name_isSet;
}

bool OAIArtistInfoRemoteSearchQuery::is_search_provider_name_Valid() const{
    return m_search_provider_name_isValid;
}

bool OAIArtistInfoRemoteSearchQuery::isSet() const {
...
bool OAIArtistInfoRemoteSearchQuery::isValid() const {
