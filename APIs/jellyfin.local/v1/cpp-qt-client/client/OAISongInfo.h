...
#ifndef OAISongInfo_H
#define OAISongInfo_H
...
class OAISongInfo : public OAIObject {
public:
    OAISongInfo();
    OAISongInfo(QString json);
    ~OAISongInfo() override;
    ...
    QList<QString> getAlbumArtists() const;
    void setAlbumArtists(const QList<QString> &album_artists);
...
Q_DECLARE_METATYPE(OpenAPI::OAISongInfo)
