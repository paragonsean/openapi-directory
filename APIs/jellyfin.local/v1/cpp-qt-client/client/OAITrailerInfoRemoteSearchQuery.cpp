...
OAITrailerInfoRemoteSearchQuery::OAITrailerInfoRemoteSearchQuery(QString json) {
...
void OAITrailerInfoRemoteSearchQuery::initializeModel() {
...
void OAITrailerInfoRemoteSearchQuery::fromJson(QString jsonString) {
...
void OAITrailerInfoRemoteSearchQuery::fromJsonObject(QJsonObject json) {
...
QString OAITrailerInfoRemoteSearchQuery::asJson() const {
...
QJsonObject OAITrailerInfoRemoteSearchQuery::asJsonObject() const {
    QJsonObject obj;
...
bool OAITrailerInfoRemoteSearchQuery::isIncludeDisabledProviders() const {
    return m_include_disabled_providers;
}
void OAITrailerInfoRemoteSearchQuery::setIncludeDisabledProviders(const bool &include_disabled_providers) {
    m_include_disabled_providers = include_disabled_providers;
    m_include_disabled_providers_isSet = true;
}

bool OAITrailerInfoRemoteSearchQuery::is_include_disabled_providers_Set() const{
    return m_include_disabled_providers_isSet;
}

bool OAITrailerInfoRemoteSearchQuery::is_include_disabled_providers_Valid() const{
    return m_include_disabled_providers_isValid;
}

QString OAITrailerInfoRemoteSearchQuery::getItemId() const {
    return m_item_id;
}
void OAITrailerInfoRemoteSearchQuery::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAITrailerInfoRemoteSearchQuery::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAITrailerInfoRemoteSearchQuery::is_item_id_Valid() const{
    return m_item_id_isValid;
}

OAITrailerInfo OAITrailerInfoRemoteSearchQuery::getSearchInfo() const {
    return m_search_info;
}
void OAITrailerInfoRemoteSearchQuery::setSearchInfo(const OAITrailerInfo &search_info) {
    m_search_info = search_info;
    m_search_info_isSet = true;
}

bool OAITrailerInfoRemoteSearchQuery::is_search_info_Set() const{
    return m_search_info_isSet;
}

bool OAITrailerInfoRemoteSearchQuery::is_search_info_Valid() const{
    return m_search_info_isValid;
}

QString OAITrailerInfoRemoteSearchQuery::getSearchProviderName() const {
    return m_search_provider_name;
}
void OAITrailerInfoRemoteSearchQuery::setSearchProviderName(const QString &search_provider_name) {
    m_search_provider_name = search_provider_name;
    m_search_provider_name_isSet = true;
}

bool OAITrailerInfoRemoteSearchQuery::is_search_provider_name_Set() const{
    return m_search_provider_name_isSet;
}

bool OAITrailerInfoRemoteSearchQuery::is_search_provider_name_Valid() const{
    return m_search_provider_name_isValid;
}

bool OAITrailerInfoRemoteSearchQuery::isSet() const {
...
bool OAITrailerInfoRemoteSearchQuery::isValid() const {
