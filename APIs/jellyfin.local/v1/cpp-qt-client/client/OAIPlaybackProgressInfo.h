...
#ifndef OAIPlaybackProgressInfo_H
#define OAIPlaybackProgressInfo_H
...
class OAIPlaybackProgressInfo : public OAIObject {
public:
    OAIPlaybackProgressInfo();
    OAIPlaybackProgressInfo(QString json);
    ~OAIPlaybackProgressInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaybackProgressInfo)

#endif // OAIPlaybackProgressInfo_H
