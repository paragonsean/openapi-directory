...
#ifndef OAISeriesTimerInfoDtoQueryResult_H
#define OAISeriesTimerInfoDtoQueryResult_H
...
class OAISeriesTimerInfoDtoQueryResult : public OAIObject {
public:
    OAISeriesTimerInfoDtoQueryResult();
    OAISeriesTimerInfoDtoQueryResult(QString json);
    ~OAISeriesTimerInfoDtoQueryResult() override;
    ...
    QList<OAISeriesTimerInfoDto> getItems() const;
    void setItems(const QList<OAISeriesTimerInfoDto> &items);
...
private:
    ...
    QList<OAISeriesTimerInfoDto> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesTimerInfoDtoQueryResult)

#endif // OAISeriesTimerInfoDtoQueryResult_H
