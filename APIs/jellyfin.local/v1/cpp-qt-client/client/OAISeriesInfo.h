...
#ifndef OAISeriesInfo_H
#define OAISeriesInfo_H
...
class OAISeriesInfo : public OAIObject {
public:
    OAISeriesInfo();
    OAISeriesInfo(QString json);
    ~OAISeriesInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesInfo)

#endif // OAISeriesInfo_H
