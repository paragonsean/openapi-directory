...
#ifndef OAIDeviceInfoQueryResult_H
#define OAIDeviceInfoQueryResult_H
...
class OAIDeviceInfoQueryResult : public OAIObject {
public:
    OAIDeviceInfoQueryResult();
    OAIDeviceInfoQueryResult(QString json);
    ~OAIDeviceInfoQueryResult() override;
    ...
    QList<OAIDeviceInfo> getItems() const;
    void setItems(const QList<OAIDeviceInfo> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceInfoQueryResult)

#endif // OAIDeviceInfoQueryResult_H
