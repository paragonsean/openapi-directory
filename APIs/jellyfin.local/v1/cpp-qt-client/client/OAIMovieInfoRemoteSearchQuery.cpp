...
OAIMovieInfoRemoteSearchQuery::OAIMovieInfoRemoteSearchQuery(QString json) {
...
void OAIMovieInfoRemoteSearchQuery::initializeModel() {
...
void OAIMovieInfoRemoteSearchQuery::fromJson(QString jsonString) {
...
void OAIMovieInfoRemoteSearchQuery::fromJsonObject(QJsonObject json) {
...
QString OAIMovieInfoRemoteSearchQuery::asJson() const {
...
QJsonObject OAIMovieInfoRemoteSearchQuery::asJsonObject() const {
    QJsonObject obj;
...
bool OAIMovieInfoRemoteSearchQuery::isIncludeDisabledProviders() const {
    return m_include_disabled_providers;
}
void OAIMovieInfoRemoteSearchQuery::setIncludeDisabledProviders(const bool &include_disabled_providers) {
    m_include_disabled_providers = include_disabled_providers;
    m_include_disabled_providers_isSet = true;
}

bool OAIMovieInfoRemoteSearchQuery::is_include_disabled_providers_Set() const{
    return m_include_disabled_providers_isSet;
}

bool OAIMovieInfoRemoteSearchQuery::is_include_disabled_providers_Valid() const{
    return m_include_disabled_providers_isValid;
}

QString OAIMovieInfoRemoteSearchQuery::getItemId() const {
    return m_item_id;
}
void OAIMovieInfoRemoteSearchQuery::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIMovieInfoRemoteSearchQuery::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIMovieInfoRemoteSearchQuery::is_item_id_Valid() const{
    return m_item_id_isValid;
}

OAIMovieInfo OAIMovieInfoRemoteSearchQuery::getSearchInfo() const {
    return m_search_info;
}
void OAIMovieInfoRemoteSearchQuery::setSearchInfo(const OAIMovieInfo &search_info) {
    m_search_info = search_info;
    m_search_info_isSet = true;
}

bool OAIMovieInfoRemoteSearchQuery::is_search_info_Set() const{
    return m_search_info_isSet;
}

bool OAIMovieInfoRemoteSearchQuery::is_search_info_Valid() const{
    return m_search_info_isValid;
}

QString OAIMovieInfoRemoteSearchQuery::getSearchProviderName() const {
    return m_search_provider_name;
}
void OAIMovieInfoRemoteSearchQuery::setSearchProviderName(const QString &search_provider_name) {
    m_search_provider_name = search_provider_name;
    m_search_provider_name_isSet = true;
}

bool OAIMovieInfoRemoteSearchQuery::is_search_provider_name_Set() const{
    return m_search_provider_name_isSet;
}

bool OAIMovieInfoRemoteSearchQuery::is_search_provider_name_Valid() const{
    return m_search_provider_name_isValid;
}

bool OAIMovieInfoRemoteSearchQuery::isSet() const {
...
bool OAIMovieInfoRemoteSearchQuery::isValid() const {
