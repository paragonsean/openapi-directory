...
#ifndef OAIMovieInfo_H
#define OAIMovieInfo_H
...
class OAIMovieInfo : public OAIObject {
public:
    OAIMovieInfo();
    OAIMovieInfo(QString json);
    ~OAIMovieInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMovieInfo)

#endif // OAIMovieInfo_H
