...
#ifndef OAIBookInfo_H
#define OAIBookInfo_H
...
class OAIBookInfo : public OAIObject {
public:
    OAIBookInfo();
    OAIBookInfo(QString json);
    ~OAIBookInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBookInfo)
