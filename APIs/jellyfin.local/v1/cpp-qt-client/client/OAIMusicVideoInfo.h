...
#ifndef OAIMusicVideoInfo_H
#define OAIMusicVideoInfo_H
...
class OAIMusicVideoInfo : public OAIObject {
public:
    OAIMusicVideoInfo();
    OAIMusicVideoInfo(QString json);
    ~OAIMusicVideoInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMusicVideoInfo)

#endif // OAIMusicVideoInfo_H
