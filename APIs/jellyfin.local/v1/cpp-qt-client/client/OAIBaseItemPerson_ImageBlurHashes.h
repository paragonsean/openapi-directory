...
/*
 * OAIBaseItemPerson_ImageBlurHashes.h
 *
 * Gets or sets the primary image blurhash.
 */

#ifndef OAIBaseItemPerson_ImageBlurHashes_H
#define OAIBaseItemPerson_ImageBlurHashes_H
...
class OAIBaseItemPerson_ImageBlurHashes : public OAIObject {
public:
    OAIBaseItemPerson_ImageBlurHashes();
    OAIBaseItemPerson_ImageBlurHashes(QString json);
    ~OAIBaseItemPerson_ImageBlurHashes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseItemPerson_ImageBlurHashes)

#endif // OAIBaseItemPerson_ImageBlurHashes_H
