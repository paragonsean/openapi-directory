...
#ifndef OAIBufferRequestDto_H
#define OAIBufferRequestDto_H
...
class OAIBufferRequestDto : public OAIObject {
public:
    OAIBufferRequestDto();
    OAIBufferRequestDto(QString json);
    ~OAIBufferRequestDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBufferRequestDto)

#endif // OAIBufferRequestDto_H
