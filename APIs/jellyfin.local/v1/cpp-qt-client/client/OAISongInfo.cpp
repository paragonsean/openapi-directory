...
OAISongInfo::OAISongInfo(QString json) {
...
void OAISongInfo::initializeModel() {
...
void OAISongInfo::fromJson(QString jsonString) {
...
void OAISongInfo::fromJsonObject(QJsonObject json) {
...
QString OAISongInfo::asJson() const {
...
QJsonObject OAISongInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_album_isSet) {
...
QString OAISongInfo::getAlbum() const {
    return m_album;
}
void OAISongInfo::setAlbum(const QString &album) {
    m_album = album;
    m_album_isSet = true;
}

bool OAISongInfo::is_album_Set() const{
    return m_album_isSet;
}

bool OAISongInfo::is_album_Valid() const{
    return m_album_isValid;
}

QList<QString> OAISongInfo::getAlbumArtists() const {
    return m_album_artists;
}
void OAISongInfo::setAlbumArtists(const QList<QString> &album_artists) {
    m_album_artists = album_artists;
    m_album_artists_isSet = true;
}

bool OAISongInfo::is_album_artists_Set() const{
    return m_album_artists_isSet;
}

bool OAISongInfo::is_album_artists_Valid() const{
    return m_album_artists_isValid;
}

QList<QString> OAISongInfo::getArtists() const {
    return m_artists;
}
void OAISongInfo::setArtists(const QList<QString> &artists) {
    m_artists = artists;
    m_artists_isSet = true;
}

bool OAISongInfo::is_artists_Set() const{
    return m_artists_isSet;
}

bool OAISongInfo::is_artists_Valid() const{
    return m_artists_isValid;
}

qint32 OAISongInfo::getIndexNumber() const {
    return m_index_number;
}
void OAISongInfo::setIndexNumber(const qint32 &index_number) {
    m_index_number = index_number;
    m_index_number_isSet = true;
}

bool OAISongInfo::is_index_number_Set() const{
    return m_index_number_isSet;
}

bool OAISongInfo::is_index_number_Valid() const{
    return m_index_number_isValid;
}

bool OAISongInfo::isIsAutomated() const {
    return m_is_automated;
}
void OAISongInfo::setIsAutomated(const bool &is_automated) {
    m_is_automated = is_automated;
    m_is_automated_isSet = true;
}

bool OAISongInfo::is_is_automated_Set() const{
    return m_is_automated_isSet;
}

bool OAISongInfo::is_is_automated_Valid() const{
    return m_is_automated_isValid;
}

QString OAISongInfo::getMetadataCountryCode() const {
    return m_metadata_country_code;
}
void OAISongInfo::setMetadataCountryCode(const QString &metadata_country_code) {
    m_metadata_country_code = metadata_country_code;
    m_metadata_country_code_isSet = true;
}

bool OAISongInfo::is_metadata_country_code_Set() const{
    return m_metadata_country_code_isSet;
}

bool OAISongInfo::is_metadata_country_code_Valid() const{
    return m_metadata_country_code_isValid;
}

QString OAISongInfo::getMetadataLanguage() const {
    return m_metadata_language;
}
void OAISongInfo::setMetadataLanguage(const QString &metadata_language) {
    m_metadata_language = metadata_language;
    m_metadata_language_isSet = true;
}

bool OAISongInfo::is_metadata_language_Set() const{
    return m_metadata_language_isSet;
}

bool OAISongInfo::is_metadata_language_Valid() const{
    return m_metadata_language_isValid;
}

QString OAISongInfo::getName() const {
    return m_name;
}
void OAISongInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISongInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAISongInfo::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAISongInfo::getParentIndexNumber() const {
    return m_parent_index_number;
}
void OAISongInfo::setParentIndexNumber(const qint32 &parent_index_number) {
    m_parent_index_number = parent_index_number;
    m_parent_index_number_isSet = true;
}

bool OAISongInfo::is_parent_index_number_Set() const{
    return m_parent_index_number_isSet;
}

bool OAISongInfo::is_parent_index_number_Valid() const{
    return m_parent_index_number_isValid;
}

QString OAISongInfo::getPath() const {
    return m_path;
}
void OAISongInfo::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAISongInfo::is_path_Set() const{
    return m_path_isSet;
}

bool OAISongInfo::is_path_Valid() const{
    return m_path_isValid;
}

QDateTime OAISongInfo::getPremiereDate() const {
    return m_premiere_date;
}
void OAISongInfo::setPremiereDate(const QDateTime &premiere_date) {
    m_premiere_date = premiere_date;
    m_premiere_date_isSet = true;
}

bool OAISongInfo::is_premiere_date_Set() const{
    return m_premiere_date_isSet;
}

bool OAISongInfo::is_premiere_date_Valid() const{
    return m_premiere_date_isValid;
}

QMap<QString, QString> OAISongInfo::getProviderIds() const {
    return m_provider_ids;
}
void OAISongInfo::setProviderIds(const QMap<QString, QString> &provider_ids) {
    m_provider_ids = provider_ids;
    m_provider_ids_isSet = true;
}

bool OAISongInfo::is_provider_ids_Set() const{
    return m_provider_ids_isSet;
}

bool OAISongInfo::is_provider_ids_Valid() const{
    return m_provider_ids_isValid;
}

qint32 OAISongInfo::getYear() const {
    return m_year;
}
void OAISongInfo::setYear(const qint32 &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAISongInfo::is_year_Set() const{
    return m_year_isSet;
}

bool OAISongInfo::is_year_Valid() const{
    return m_year_isValid;
}

bool OAISongInfo::isSet() const {
...
bool OAISongInfo::isValid() const {
