...
OAITrailerInfo::OAITrailerInfo(QString json) {
...
void OAITrailerInfo::initializeModel() {
...
void OAITrailerInfo::fromJson(QString jsonString) {
...
void OAITrailerInfo::fromJsonObject(QJsonObject json) {
...
QString OAITrailerInfo::asJson() const {
...
QJsonObject OAITrailerInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAITrailerInfo::getIndexNumber() const {
    return m_index_number;
}
void OAITrailerInfo::setIndexNumber(const qint32 &index_number) {
    m_index_number = index_number;
    m_index_number_isSet = true;
}

bool OAITrailerInfo::is_index_number_Set() const{
    return m_index_number_isSet;
}

bool OAITrailerInfo::is_index_number_Valid() const{
    return m_index_number_isValid;
}

bool OAITrailerInfo::isIsAutomated() const {
    return m_is_automated;
}
void OAITrailerInfo::setIsAutomated(const bool &is_automated) {
    m_is_automated = is_automated;
    m_is_automated_isSet = true;
}

bool OAITrailerInfo::is_is_automated_Set() const{
    return m_is_automated_isSet;
}

bool OAITrailerInfo::is_is_automated_Valid() const{
    return m_is_automated_isValid;
}

QString OAITrailerInfo::getMetadataCountryCode() const {
    return m_metadata_country_code;
}
void OAITrailerInfo::setMetadataCountryCode(const QString &metadata_country_code) {
    m_metadata_country_code = metadata_country_code;
    m_metadata_country_code_isSet = true;
}

bool OAITrailerInfo::is_metadata_country_code_Set() const{
    return m_metadata_country_code_isSet;
}

bool OAITrailerInfo::is_metadata_country_code_Valid() const{
    return m_metadata_country_code_isValid;
}

QString OAITrailerInfo::getMetadataLanguage() const {
    return m_metadata_language;
}
void OAITrailerInfo::setMetadataLanguage(const QString &metadata_language) {
    m_metadata_language = metadata_language;
    m_metadata_language_isSet = true;
}

bool OAITrailerInfo::is_metadata_language_Set() const{
    return m_metadata_language_isSet;
}

bool OAITrailerInfo::is_metadata_language_Valid() const{
    return m_metadata_language_isValid;
}

QString OAITrailerInfo::getName() const {
    return m_name;
}
void OAITrailerInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITrailerInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAITrailerInfo::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAITrailerInfo::getParentIndexNumber() const {
    return m_parent_index_number;
}
void OAITrailerInfo::setParentIndexNumber(const qint32 &parent_index_number) {
    m_parent_index_number = parent_index_number;
    m_parent_index_number_isSet = true;
}

bool OAITrailerInfo::is_parent_index_number_Set() const{
    return m_parent_index_number_isSet;
}

bool OAITrailerInfo::is_parent_index_number_Valid() const{
    return m_parent_index_number_isValid;
}

QString OAITrailerInfo::getPath() const {
    return m_path;
}
void OAITrailerInfo::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAITrailerInfo::is_path_Set() const{
    return m_path_isSet;
}

bool OAITrailerInfo::is_path_Valid() const{
    return m_path_isValid;
}

QDateTime OAITrailerInfo::getPremiereDate() const {
    return m_premiere_date;
}
void OAITrailerInfo::setPremiereDate(const QDateTime &premiere_date) {
    m_premiere_date = premiere_date;
    m_premiere_date_isSet = true;
}

bool OAITrailerInfo::is_premiere_date_Set() const{
    return m_premiere_date_isSet;
}

bool OAITrailerInfo::is_premiere_date_Valid() const{
    return m_premiere_date_isValid;
}

QMap<QString, QString> OAITrailerInfo::getProviderIds() const {
    return m_provider_ids;
}
void OAITrailerInfo::setProviderIds(const QMap<QString, QString> &provider_ids) {
    m_provider_ids = provider_ids;
    m_provider_ids_isSet = true;
}

bool OAITrailerInfo::is_provider_ids_Set() const{
    return m_provider_ids_isSet;
}

bool OAITrailerInfo::is_provider_ids_Valid() const{
    return m_provider_ids_isValid;
}

qint32 OAITrailerInfo::getYear() const {
    return m_year;
}
void OAITrailerInfo::setYear(const qint32 &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAITrailerInfo::is_year_Set() const{
    return m_year_isSet;
}

bool OAITrailerInfo::is_year_Valid() const{
    return m_year_isValid;
}

bool OAITrailerInfo::isSet() const {
...
bool OAITrailerInfo::isValid() const {
