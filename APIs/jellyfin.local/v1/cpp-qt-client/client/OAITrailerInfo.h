...
#ifndef OAITrailerInfo_H
#define OAITrailerInfo_H
...
class OAITrailerInfo : public OAIObject {
public:
    OAITrailerInfo();
    OAITrailerInfo(QString json);
    ~OAITrailerInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrailerInfo)

#endif // OAITrailerInfo_H
