...
OAIMovieInfo::OAIMovieInfo(QString json) {
...
void OAIMovieInfo::initializeModel() {
...
void OAIMovieInfo::fromJson(QString jsonString) {
...
void OAIMovieInfo::fromJsonObject(QJsonObject json) {
...
QString OAIMovieInfo::asJson() const {
...
QJsonObject OAIMovieInfo::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMovieInfo::getIndexNumber() const {
    return m_index_number;
}
void OAIMovieInfo::setIndexNumber(const qint32 &index_number) {
    m_index_number = index_number;
    m_index_number_isSet = true;
}

bool OAIMovieInfo::is_index_number_Set() const{
    return m_index_number_isSet;
}

bool OAIMovieInfo::is_index_number_Valid() const{
    return m_index_number_isValid;
}

bool OAIMovieInfo::isIsAutomated() const {
    return m_is_automated;
}
void OAIMovieInfo::setIsAutomated(const bool &is_automated) {
    m_is_automated = is_automated;
    m_is_automated_isSet = true;
}

bool OAIMovieInfo::is_is_automated_Set() const{
    return m_is_automated_isSet;
}

bool OAIMovieInfo::is_is_automated_Valid() const{
    return m_is_automated_isValid;
}

QString OAIMovieInfo::getMetadataCountryCode() const {
    return m_metadata_country_code;
}
void OAIMovieInfo::setMetadataCountryCode(const QString &metadata_country_code) {
    m_metadata_country_code = metadata_country_code;
    m_metadata_country_code_isSet = true;
}

bool OAIMovieInfo::is_metadata_country_code_Set() const{
    return m_metadata_country_code_isSet;
}

bool OAIMovieInfo::is_metadata_country_code_Valid() const{
    return m_metadata_country_code_isValid;
}

QString OAIMovieInfo::getMetadataLanguage() const {
    return m_metadata_language;
}
void OAIMovieInfo::setMetadataLanguage(const QString &metadata_language) {
    m_metadata_language = metadata_language;
    m_metadata_language_isSet = true;
}

bool OAIMovieInfo::is_metadata_language_Set() const{
    return m_metadata_language_isSet;
}

bool OAIMovieInfo::is_metadata_language_Valid() const{
    return m_metadata_language_isValid;
}

QString OAIMovieInfo::getName() const {
    return m_name;
}
void OAIMovieInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMovieInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMovieInfo::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIMovieInfo::getParentIndexNumber() const {
    return m_parent_index_number;
}
void OAIMovieInfo::setParentIndexNumber(const qint32 &parent_index_number) {
    m_parent_index_number = parent_index_number;
    m_parent_index_number_isSet = true;
}

bool OAIMovieInfo::is_parent_index_number_Set() const{
    return m_parent_index_number_isSet;
}

bool OAIMovieInfo::is_parent_index_number_Valid() const{
    return m_parent_index_number_isValid;
}

QString OAIMovieInfo::getPath() const {
    return m_path;
}
void OAIMovieInfo::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIMovieInfo::is_path_Set() const{
    return m_path_isSet;
}

bool OAIMovieInfo::is_path_Valid() const{
    return m_path_isValid;
}

QDateTime OAIMovieInfo::getPremiereDate() const {
    return m_premiere_date;
}
void OAIMovieInfo::setPremiereDate(const QDateTime &premiere_date) {
    m_premiere_date = premiere_date;
    m_premiere_date_isSet = true;
}

bool OAIMovieInfo::is_premiere_date_Set() const{
    return m_premiere_date_isSet;
}

bool OAIMovieInfo::is_premiere_date_Valid() const{
    return m_premiere_date_isValid;
}

QMap<QString, QString> OAIMovieInfo::getProviderIds() const {
    return m_provider_ids;
}
void OAIMovieInfo::setProviderIds(const QMap<QString, QString> &provider_ids) {
    m_provider_ids = provider_ids;
    m_provider_ids_isSet = true;
}

bool OAIMovieInfo::is_provider_ids_Set() const{
    return m_provider_ids_isSet;
}

bool OAIMovieInfo::is_provider_ids_Valid() const{
    return m_provider_ids_isValid;
}

qint32 OAIMovieInfo::getYear() const {
    return m_year;
}
void OAIMovieInfo::setYear(const qint32 &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIMovieInfo::is_year_Set() const{
    return m_year_isSet;
}

bool OAIMovieInfo::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIMovieInfo::isSet() const {
...
bool OAIMovieInfo::isValid() const {
