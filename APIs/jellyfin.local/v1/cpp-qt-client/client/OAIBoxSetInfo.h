...
#ifndef OAIBoxSetInfo_H
#define OAIBoxSetInfo_H
...
class OAIBoxSetInfo : public OAIObject {
public:
    OAIBoxSetInfo();
    OAIBoxSetInfo(QString json);
    ~OAIBoxSetInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoxSetInfo)

#endif // OAIBoxSetInfo_H
