...
OAIPlaybackStartInfo::OAIPlaybackStartInfo(QString json) {
...
void OAIPlaybackStartInfo::initializeModel() {
...
void OAIPlaybackStartInfo::fromJson(QString jsonString) {
...
void OAIPlaybackStartInfo::fromJsonObject(QJsonObject json) {
...
QString OAIPlaybackStartInfo::asJson() const {
...
QJsonObject OAIPlaybackStartInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPlaybackStartInfo::getAspectRatio() const {
    return m_aspect_ratio;
}
void OAIPlaybackStartInfo::setAspectRatio(const QString &aspect_ratio) {
    m_aspect_ratio = aspect_ratio;
    m_aspect_ratio_isSet = true;
}

bool OAIPlaybackStartInfo::is_aspect_ratio_Set() const{
    return m_aspect_ratio_isSet;
}

bool OAIPlaybackStartInfo::is_aspect_ratio_Valid() const{
    return m_aspect_ratio_isValid;
}

qint32 OAIPlaybackStartInfo::getAudioStreamIndex() const {
    return m_audio_stream_index;
}
void OAIPlaybackStartInfo::setAudioStreamIndex(const qint32 &audio_stream_index) {
    m_audio_stream_index = audio_stream_index;
    m_audio_stream_index_isSet = true;
}

bool OAIPlaybackStartInfo::is_audio_stream_index_Set() const{
    return m_audio_stream_index_isSet;
}

bool OAIPlaybackStartInfo::is_audio_stream_index_Valid() const{
    return m_audio_stream_index_isValid;
}

qint32 OAIPlaybackStartInfo::getBrightness() const {
    return m_brightness;
}
void OAIPlaybackStartInfo::setBrightness(const qint32 &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIPlaybackStartInfo::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIPlaybackStartInfo::is_brightness_Valid() const{
    return m_brightness_isValid;
}

bool OAIPlaybackStartInfo::isCanSeek() const {
    return m_can_seek;
}
void OAIPlaybackStartInfo::setCanSeek(const bool &can_seek) {
    m_can_seek = can_seek;
    m_can_seek_isSet = true;
}

bool OAIPlaybackStartInfo::is_can_seek_Set() const{
    return m_can_seek_isSet;
}

bool OAIPlaybackStartInfo::is_can_seek_Valid() const{
    return m_can_seek_isValid;
}

bool OAIPlaybackStartInfo::isIsMuted() const {
    return m_is_muted;
}
void OAIPlaybackStartInfo::setIsMuted(const bool &is_muted) {
    m_is_muted = is_muted;
    m_is_muted_isSet = true;
}

bool OAIPlaybackStartInfo::is_is_muted_Set() const{
    return m_is_muted_isSet;
}

bool OAIPlaybackStartInfo::is_is_muted_Valid() const{
    return m_is_muted_isValid;
}

bool OAIPlaybackStartInfo::isIsPaused() const {
    return m_is_paused;
}
void OAIPlaybackStartInfo::setIsPaused(const bool &is_paused) {
    m_is_paused = is_paused;
    m_is_paused_isSet = true;
}

bool OAIPlaybackStartInfo::is_is_paused_Set() const{
    return m_is_paused_isSet;
}

bool OAIPlaybackStartInfo::is_is_paused_Valid() const{
    return m_is_paused_isValid;
}

OAIBaseItemDto OAIPlaybackStartInfo::getItem() const {
    return m_item;
}
void OAIPlaybackStartInfo::setItem(const OAIBaseItemDto &item) {
    m_item = item;
    m_item_isSet = true;
}

bool OAIPlaybackStartInfo::is_item_Set() const{
    return m_item_isSet;
}

bool OAIPlaybackStartInfo::is_item_Valid() const{
    return m_item_isValid;
}

QString OAIPlaybackStartInfo::getItemId() const {
    return m_item_id;
}
void OAIPlaybackStartInfo::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIPlaybackStartInfo::is_item_id_Valid() const{
    return m_item_id_isValid;
}

QString OAIPlaybackStartInfo::getLiveStreamId() const {
    return m_live_stream_id;
}
void OAIPlaybackStartInfo::setLiveStreamId(const QString &live_stream_id) {
    m_live_stream_id = live_stream_id;
    m_live_stream_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_live_stream_id_Set() const{
    return m_live_stream_id_isSet;
}

bool OAIPlaybackStartInfo::is_live_stream_id_Valid() const{
    return m_live_stream_id_isValid;
}

QString OAIPlaybackStartInfo::getMediaSourceId() const {
    return m_media_source_id;
}
void OAIPlaybackStartInfo::setMediaSourceId(const QString &media_source_id) {
    m_media_source_id = media_source_id;
    m_media_source_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_media_source_id_Set() const{
    return m_media_source_id_isSet;
}

bool OAIPlaybackStartInfo::is_media_source_id_Valid() const{
    return m_media_source_id_isValid;
}

QList<OAIQueueItem> OAIPlaybackStartInfo::getNowPlayingQueue() const {
    return m_now_playing_queue;
}
void OAIPlaybackStartInfo::setNowPlayingQueue(const QList<OAIQueueItem> &now_playing_queue) {
    m_now_playing_queue = now_playing_queue;
    m_now_playing_queue_isSet = true;
}

bool OAIPlaybackStartInfo::is_now_playing_queue_Set() const{
    return m_now_playing_queue_isSet;
}

bool OAIPlaybackStartInfo::is_now_playing_queue_Valid() const{
    return m_now_playing_queue_isValid;
}

OAIPlayMethod OAIPlaybackStartInfo::getPlayMethod() const {
    return m_play_method;
}
void OAIPlaybackStartInfo::setPlayMethod(const OAIPlayMethod &play_method) {
    m_play_method = play_method;
    m_play_method_isSet = true;
}

bool OAIPlaybackStartInfo::is_play_method_Set() const{
    return m_play_method_isSet;
}

bool OAIPlaybackStartInfo::is_play_method_Valid() const{
    return m_play_method_isValid;
}

QString OAIPlaybackStartInfo::getPlaySessionId() const {
    return m_play_session_id;
}
void OAIPlaybackStartInfo::setPlaySessionId(const QString &play_session_id) {
    m_play_session_id = play_session_id;
    m_play_session_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_play_session_id_Set() const{
    return m_play_session_id_isSet;
}

bool OAIPlaybackStartInfo::is_play_session_id_Valid() const{
    return m_play_session_id_isValid;
}

qint64 OAIPlaybackStartInfo::getPlaybackStartTimeTicks() const {
    return m_playback_start_time_ticks;
}
void OAIPlaybackStartInfo::setPlaybackStartTimeTicks(const qint64 &playback_start_time_ticks) {
    m_playback_start_time_ticks = playback_start_time_ticks;
    m_playback_start_time_ticks_isSet = true;
}

bool OAIPlaybackStartInfo::is_playback_start_time_ticks_Set() const{
    return m_playback_start_time_ticks_isSet;
}

bool OAIPlaybackStartInfo::is_playback_start_time_ticks_Valid() const{
    return m_playback_start_time_ticks_isValid;
}

QString OAIPlaybackStartInfo::getPlaylistItemId() const {
    return m_playlist_item_id;
}
void OAIPlaybackStartInfo::setPlaylistItemId(const QString &playlist_item_id) {
    m_playlist_item_id = playlist_item_id;
    m_playlist_item_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_playlist_item_id_Set() const{
    return m_playlist_item_id_isSet;
}

bool OAIPlaybackStartInfo::is_playlist_item_id_Valid() const{
    return m_playlist_item_id_isValid;
}

qint64 OAIPlaybackStartInfo::getPositionTicks() const {
    return m_position_ticks;
}
void OAIPlaybackStartInfo::setPositionTicks(const qint64 &position_ticks) {
    m_position_ticks = position_ticks;
    m_position_ticks_isSet = true;
}

bool OAIPlaybackStartInfo::is_position_ticks_Set() const{
    return m_position_ticks_isSet;
}

bool OAIPlaybackStartInfo::is_position_ticks_Valid() const{
    return m_position_ticks_isValid;
}

OAIRepeatMode OAIPlaybackStartInfo::getRepeatMode() const {
    return m_repeat_mode;
}
void OAIPlaybackStartInfo::setRepeatMode(const OAIRepeatMode &repeat_mode) {
    m_repeat_mode = repeat_mode;
    m_repeat_mode_isSet = true;
}

bool OAIPlaybackStartInfo::is_repeat_mode_Set() const{
    return m_repeat_mode_isSet;
}

bool OAIPlaybackStartInfo::is_repeat_mode_Valid() const{
    return m_repeat_mode_isValid;
}

QString OAIPlaybackStartInfo::getSessionId() const {
    return m_session_id;
}
void OAIPlaybackStartInfo::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIPlaybackStartInfo::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIPlaybackStartInfo::is_session_id_Valid() const{
    return m_session_id_isValid;
}

qint32 OAIPlaybackStartInfo::getSubtitleStreamIndex() const {
    return m_subtitle_stream_index;
}
void OAIPlaybackStartInfo::setSubtitleStreamIndex(const qint32 &subtitle_stream_index) {
    m_subtitle_stream_index = subtitle_stream_index;
    m_subtitle_stream_index_isSet = true;
}

bool OAIPlaybackStartInfo::is_subtitle_stream_index_Set() const{
    return m_subtitle_stream_index_isSet;
}

bool OAIPlaybackStartInfo::is_subtitle_stream_index_Valid() const{
    return m_subtitle_stream_index_isValid;
}

qint32 OAIPlaybackStartInfo::getVolumeLevel() const {
    return m_volume_level;
}
void OAIPlaybackStartInfo::setVolumeLevel(const qint32 &volume_level) {
    m_volume_level = volume_level;
    m_volume_level_isSet = true;
}

bool OAIPlaybackStartInfo::is_volume_level_Set() const{
    return m_volume_level_isSet;
}

bool OAIPlaybackStartInfo::is_volume_level_Valid() const{
    return m_volume_level_isValid;
}

bool OAIPlaybackStartInfo::isSet() const {
...
bool OAIPlaybackStartInfo::isValid() const {
