...
#ifndef OAIAlbumInfo_H
#define OAIAlbumInfo_H
...
class OAIAlbumInfo : public OAIObject {
public:
    OAIAlbumInfo();
    OAIAlbumInfo(QString json);
    ~OAIAlbumInfo() override;
    ...
    QMap<QString, QString> getArtistProviderIds() const;
    void setArtistProviderIds(const QMap<QString, QString> &artist_provider_ids);
    bool is_artist_provider_ids_Set() const;
    bool is_artist_provider_ids_Valid() const;
...
private:
    ...
    QMap<QString, QString> m_artist_provider_ids;
    bool m_artist_provider_ids_isSet;
    bool m_artist_provider_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlbumInfo)

#endif // OAIAlbumInfo_H
