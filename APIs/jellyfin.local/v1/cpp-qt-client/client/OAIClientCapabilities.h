...
#ifndef OAIClientCapabilities_H
#define OAIClientCapabilities_H
...
class OAIClientCapabilities : public OAIObject {
public:
    OAIClientCapabilities();
    OAIClientCapabilities(QString json);
    ~OAIClientCapabilities() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientCapabilities)

#endif // OAIClientCapabilities_H
