...
OAIPersonLookupInfoRemoteSearchQuery::OAIPersonLookupInfoRemoteSearchQuery(QString json) {
...
void OAIPersonLookupInfoRemoteSearchQuery::initializeModel() {
...
void OAIPersonLookupInfoRemoteSearchQuery::fromJson(QString jsonString) {
...
void OAIPersonLookupInfoRemoteSearchQuery::fromJsonObject(QJsonObject json) {
...
QString OAIPersonLookupInfoRemoteSearchQuery::asJson() const {
...
QJsonObject OAIPersonLookupInfoRemoteSearchQuery::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPersonLookupInfoRemoteSearchQuery::isIncludeDisabledProviders() const {
    return m_include_disabled_providers;
}
void OAIPersonLookupInfoRemoteSearchQuery::setIncludeDisabledProviders(const bool &include_disabled_providers) {
    m_include_disabled_providers = include_disabled_providers;
    m_include_disabled_providers_isSet = true;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_include_disabled_providers_Set() const{
    return m_include_disabled_providers_isSet;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_include_disabled_providers_Valid() const{
    return m_include_disabled_providers_isValid;
}

QString OAIPersonLookupInfoRemoteSearchQuery::getItemId() const {
    return m_item_id;
}
void OAIPersonLookupInfoRemoteSearchQuery::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_item_id_Valid() const{
    return m_item_id_isValid;
}

OAIPersonLookupInfo OAIPersonLookupInfoRemoteSearchQuery::getSearchInfo() const {
    return m_search_info;
}
void OAIPersonLookupInfoRemoteSearchQuery::setSearchInfo(const OAIPersonLookupInfo &search_info) {
    m_search_info = search_info;
    m_search_info_isSet = true;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_search_info_Set() const{
    return m_search_info_isSet;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_search_info_Valid() const{
    return m_search_info_isValid;
}

QString OAIPersonLookupInfoRemoteSearchQuery::getSearchProviderName() const {
    return m_search_provider_name;
}
void OAIPersonLookupInfoRemoteSearchQuery::setSearchProviderName(const QString &search_provider_name) {
    m_search_provider_name = search_provider_name;
    m_search_provider_name_isSet = true;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_search_provider_name_Set() const{
    return m_search_provider_name_isSet;
}

bool OAIPersonLookupInfoRemoteSearchQuery::is_search_provider_name_Valid() const{
    return m_search_provider_name_isValid;
}

bool OAIPersonLookupInfoRemoteSearchQuery::isSet() const {
...
bool OAIPersonLookupInfoRemoteSearchQuery::isValid() const {
