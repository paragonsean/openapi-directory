...
#ifndef OAITimerInfoDtoQueryResult_H
#define OAITimerInfoDtoQueryResult_H
...
class OAITimerInfoDtoQueryResult : public OAIObject {
public:
    OAITimerInfoDtoQueryResult();
    OAITimerInfoDtoQueryResult(QString json);
    ~OAITimerInfoDtoQueryResult() override;
    ...
    QList<OAITimerInfoDto> getItems() const;
    void setItems(const QList<OAITimerInfoDto> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAITimerInfoDtoQueryResult)

#endif // OAITimerInfoDtoQueryResult_H
