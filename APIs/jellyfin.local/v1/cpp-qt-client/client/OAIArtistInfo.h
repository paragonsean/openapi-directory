...
#ifndef OAIArtistInfo_H
#define OAIArtistInfo_H
...
class OAIArtistInfo : public OAIObject {
public:
    OAIArtistInfo();
    OAIArtistInfo(QString json);
    ~OAIArtistInfo() override;
    ...
    QList<OAISongInfo> getSongInfos() const;
    void setSongInfos(const QList<OAISongInfo> &song_infos);
    bool is_song_infos_Set() const;
    bool is_song_infos_Valid() const;
...
private:
    ...
    QList<OAISongInfo> m_song_infos;
    bool m_song_infos_isSet;
    bool m_song_infos_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtistInfo)

#endif // OAIArtistInfo_H
