...
#ifndef OAISetPlaylistItemRequestDto_H
#define OAISetPlaylistItemRequestDto_H
...
class OAISetPlaylistItemRequestDto : public OAIObject {
public:
    OAISetPlaylistItemRequestDto();
    OAISetPlaylistItemRequestDto(QString json);
    ~OAISetPlaylistItemRequestDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetPlaylistItemRequestDto)

#endif // OAISetPlaylistItemRequestDto_H
