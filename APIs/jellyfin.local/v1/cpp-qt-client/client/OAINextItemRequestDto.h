...
#ifndef OAINextItemRequestDto_H
#define OAINextItemRequestDto_H
...
class OAINextItemRequestDto : public OAIObject {
public:
    OAINextItemRequestDto();
    OAINextItemRequestDto(QString json);
    ~OAINextItemRequestDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINextItemRequestDto)

#endif // OAINextItemRequestDto_H
