...
OAIAlbumInfo::OAIAlbumInfo(QString json) {
...
void OAIAlbumInfo::initializeModel() {

    m_album_artists_isSet = false;
    m_album_artists_isValid = false;

    m_artist_provider_ids_isSet = false;
    m_artist_provider_ids_isValid = false;
...
void OAIAlbumInfo::fromJson(QString jsonString) {
...
void OAIAlbumInfo::fromJsonObject(QJsonObject json) {
    ...
    m_artist_provider_ids_isValid = ::OpenAPI::fromJsonValue(m_artist_provider_ids, json[QString("ArtistProviderIds")]);
    m_artist_provider_ids_isSet = !json[QString("ArtistProviderIds")].isNull() && m_artist_provider_ids_isValid;
...
QString OAIAlbumInfo::asJson() const {
...
QJsonObject OAIAlbumInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_album_artists.size() > 0) {
        obj.insert(QString("AlbumArtists"), ::OpenAPI::toJsonValue(m_album_artists));
    }
    if (m_artist_provider_ids.size() > 0) {
        obj.insert(QString("ArtistProviderIds"), ::OpenAPI::toJsonValue(m_artist_provider_ids));
    }
...
QList<QString> OAIAlbumInfo::getAlbumArtists() const {
    return m_album_artists;
}
void OAIAlbumInfo::setAlbumArtists(const QList<QString> &album_artists) {
    m_album_artists = album_artists;
    m_album_artists_isSet = true;
}

bool OAIAlbumInfo::is_album_artists_Set() const{
    return m_album_artists_isSet;
}

bool OAIAlbumInfo::is_album_artists_Valid() const{
    return m_album_artists_isValid;
}

QMap<QString, QString> OAIAlbumInfo::getArtistProviderIds() const {
    return m_artist_provider_ids;
}
void OAIAlbumInfo::setArtistProviderIds(const QMap<QString, QString> &artist_provider_ids) {
    m_artist_provider_ids = artist_provider_ids;
    m_artist_provider_ids_isSet = true;
}

bool OAIAlbumInfo::is_artist_provider_ids_Set() const{
    return m_artist_provider_ids_isSet;
}

bool OAIAlbumInfo::is_artist_provider_ids_Valid() const{
    return m_artist_provider_ids_isValid;
}

qint32 OAIAlbumInfo::getIndexNumber() const {
    return m_index_number;
}
void OAIAlbumInfo::setIndexNumber(const qint32 &index_number) {
    m_index_number = index_number;
    m_index_number_isSet = true;
}

bool OAIAlbumInfo::is_index_number_Set() const{
    return m_index_number_isSet;
}

bool OAIAlbumInfo::is_index_number_Valid() const{
    return m_index_number_isValid;
}

bool OAIAlbumInfo::isIsAutomated() const {
    return m_is_automated;
}
void OAIAlbumInfo::setIsAutomated(const bool &is_automated) {
    m_is_automated = is_automated;
    m_is_automated_isSet = true;
}

bool OAIAlbumInfo::is_is_automated_Set() const{
    return m_is_automated_isSet;
}

bool OAIAlbumInfo::is_is_automated_Valid() const{
    return m_is_automated_isValid;
}

QString OAIAlbumInfo::getMetadataCountryCode() const {
    return m_metadata_country_code;
}
void OAIAlbumInfo::setMetadataCountryCode(const QString &metadata_country_code) {
    m_metadata_country_code = metadata_country_code;
    m_metadata_country_code_isSet = true;
}

bool OAIAlbumInfo::is_metadata_country_code_Set() const{
    return m_metadata_country_code_isSet;
}

bool OAIAlbumInfo::is_metadata_country_code_Valid() const{
    return m_metadata_country_code_isValid;
}

QString OAIAlbumInfo::getMetadataLanguage() const {
    return m_metadata_language;
}
void OAIAlbumInfo::setMetadataLanguage(const QString &metadata_language) {
    m_metadata_language = metadata_language;
    m_metadata_language_isSet = true;
}

bool OAIAlbumInfo::is_metadata_language_Set() const{
    return m_metadata_language_isSet;
}

bool OAIAlbumInfo::is_metadata_language_Valid() const{
    return m_metadata_language_isValid;
}

QString OAIAlbumInfo::getName() const {
    return m_name;
}
void OAIAlbumInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAlbumInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAlbumInfo::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIAlbumInfo::getParentIndexNumber() const {
    return m_parent_index_number;
}
void OAIAlbumInfo::setParentIndexNumber(const qint32 &parent_index_number) {
    m_parent_index_number = parent_index_number;
    m_parent_index_number_isSet = true;
}

bool OAIAlbumInfo::is_parent_index_number_Set() const{
    return m_parent_index_number_isSet;
}

bool OAIAlbumInfo::is_parent_index_number_Valid() const{
    return m_parent_index_number_isValid;
}

QString OAIAlbumInfo::getPath() const {
    return m_path;
}
void OAIAlbumInfo::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIAlbumInfo::is_path_Set() const{
    return m_path_isSet;
}

bool OAIAlbumInfo::is_path_Valid() const{
    return m_path_isValid;
}

QDateTime OAIAlbumInfo::getPremiereDate() const {
    return m_premiere_date;
}
void OAIAlbumInfo::setPremiereDate(const QDateTime &premiere_date) {
    m_premiere_date = premiere_date;
    m_premiere_date_isSet = true;
}

bool OAIAlbumInfo::is_premiere_date_Set() const{
    return m_premiere_date_isSet;
}

bool OAIAlbumInfo::is_premiere_date_Valid() const{
    return m_premiere_date_isValid;
}

QMap<QString, QString> OAIAlbumInfo::getProviderIds() const {
    return m_provider_ids;
}
void OAIAlbumInfo::setProviderIds(const QMap<QString, QString> &provider_ids) {
    m_provider_ids = provider_ids;
    m_provider_ids_isSet = true;
}

bool OAIAlbumInfo::is_provider_ids_Set() const{
    return m_provider_ids_isSet;
}

bool OAIAlbumInfo::is_provider_ids_Valid() const{
    return m_provider_ids_isValid;
}

QList<OAISongInfo> OAIAlbumInfo::getSongInfos() const {
    return m_song_infos;
}
void OAIAlbumInfo::setSongInfos(const QList<OAISongInfo> &song_infos) {
    m_song_infos = song_infos;
    m_song_infos_isSet = true;
}

bool OAIAlbumInfo::is_song_infos_Set() const{
    return m_song_infos_isSet;
}

bool OAIAlbumInfo::is_song_infos_Valid() const{
    return m_song_infos_isValid;
}

qint32 OAIAlbumInfo::getYear() const {
    return m_year;
}
void OAIAlbumInfo::setYear(const qint32 &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIAlbumInfo::is_year_Set() const{
    return m_year_isSet;
}

bool OAIAlbumInfo::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIAlbumInfo::isSet() const {
...
bool OAIAlbumInfo::isValid() const {
