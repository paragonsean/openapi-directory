...
/**
 * API tests for StudiosApi
 */
@Disabled
public class StudiosApiTest {

    private final StudiosApi api = new StudiosApi();
    ...
    public void getStudioTest() throws ApiException {
        String name = null;
        UUID userId = null;
        BaseItemDto response = api.getStudio(name, userId);
     ...
     */
    @Test
    public void getStudiosTest() throws ApiException {
        ...
        BaseItemDtoQueryResult response = api.getStudios(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount);
        // TODO: test validations
    }
