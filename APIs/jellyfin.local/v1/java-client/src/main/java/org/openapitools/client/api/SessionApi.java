...
public class SessionApi {
     ...
     */
    public okhttp3.Call displayContentCall(String sessionId, String itemType, String itemId, String itemName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call displayContentValidateBeforeCall(String sessionId, String itemType, String itemId, String itemName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
     ...
     */
    public void displayContent(String sessionId, String itemType, String itemId, String itemName) throws ApiException {
     ...
     */
    public ApiResponse<Void> displayContentWithHttpInfo(String sessionId, String itemType, String itemId, String itemName) throws ApiException {
     ...
     */
    public okhttp3.Call displayContentAsync(String sessionId, String itemType, String itemId, String itemName, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call playCall(String sessionId, PlayCommand playCommand, List<UUID> itemIds, Long startPositionTicks, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call playValidateBeforeCall(String sessionId, PlayCommand playCommand, List<UUID> itemIds, Long startPositionTicks, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
        ...
        return playCall(sessionId, playCommand, itemIds, startPositionTicks, _callback);
     ...
     */
    public void play(String sessionId, PlayCommand playCommand, List<UUID> itemIds, Long startPositionTicks) throws ApiException {
        playWithHttpInfo(sessionId, playCommand, itemIds, startPositionTicks);
    }
     ...
     */
    public ApiResponse<Void> playWithHttpInfo(String sessionId, PlayCommand playCommand, List<UUID> itemIds, Long startPositionTicks) throws ApiException {
        okhttp3.Call localVarCall = playValidateBeforeCall(sessionId, playCommand, itemIds, startPositionTicks, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call playAsync(String sessionId, PlayCommand playCommand, List<UUID> itemIds, Long startPositionTicks, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = playValidateBeforeCall(sessionId, playCommand, itemIds, startPositionTicks, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     * @param sessionId The session id. (required)
     * @param text The message test. (required)
     ...
     */
    public okhttp3.Call sendMessageCommandCall(String sessionId, String text, String header, Long timeoutMs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (header != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("header", header));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sendMessageCommandValidateBeforeCall(String sessionId, String text, String header, Long timeoutMs, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
        ...
        if (text == null) {
            throw new ApiException("Missing the required parameter 'text' when calling sendMessageCommand(Async)");
        }

        return sendMessageCommandCall(sessionId, text, header, timeoutMs, _callback);
     ...
     */
    public void sendMessageCommand(String sessionId, String text, String header, Long timeoutMs) throws ApiException {
        sendMessageCommandWithHttpInfo(sessionId, text, header, timeoutMs);
    }
     ...
     */
    public ApiResponse<Void> sendMessageCommandWithHttpInfo(String sessionId, String text, String header, Long timeoutMs) throws ApiException {
        okhttp3.Call localVarCall = sendMessageCommandValidateBeforeCall(sessionId, text, header, timeoutMs, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call sendMessageCommandAsync(String sessionId, String text, String header, Long timeoutMs, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendMessageCommandValidateBeforeCall(sessionId, text, header, timeoutMs, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
