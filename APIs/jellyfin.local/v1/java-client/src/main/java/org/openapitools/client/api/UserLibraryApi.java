...
public class UserLibraryApi {
     ...
     */
    public okhttp3.Call getLatestMediaCall(UUID userId, UUID parentId, List<ItemFields> fields, List<String> includeItemTypes, Boolean isPlayed, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, Integer limit, Boolean groupItems, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLatestMediaValidateBeforeCall(UUID userId, UUID parentId, List<ItemFields> fields, List<String> includeItemTypes, Boolean isPlayed, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, Integer limit, Boolean groupItems, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
     ...
     */
    public List<BaseItemDto> getLatestMedia(UUID userId, UUID parentId, List<ItemFields> fields, List<String> includeItemTypes, Boolean isPlayed, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, Integer limit, Boolean groupItems) throws ApiException {
     ...
     */
    public ApiResponse<List<BaseItemDto>> getLatestMediaWithHttpInfo(UUID userId, UUID parentId, List<ItemFields> fields, List<String> includeItemTypes, Boolean isPlayed, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, Integer limit, Boolean groupItems) throws ApiException {
