...
public class MusicGenresApi {
     ...
     */
    @Deprecated
    public okhttp3.Call getMusicGenresCall(Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, Boolean enableImages, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMusicGenresValidateBeforeCall(Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, Boolean enableImages, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
        return getMusicGenresCall(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, _callback);
     ...
     */
    @Deprecated
    public BaseItemDtoQueryResult getMusicGenres(Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, Boolean enableImages, Boolean enableTotalRecordCount) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResp = getMusicGenresWithHttpInfo(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<BaseItemDtoQueryResult> getMusicGenresWithHttpInfo(Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, Boolean enableImages, Boolean enableTotalRecordCount) throws ApiException {
        okhttp3.Call localVarCall = getMusicGenresValidateBeforeCall(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, null);
     ...
     */
    @Deprecated
    public okhttp3.Call getMusicGenresAsync(Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, Boolean enableImages, Boolean enableTotalRecordCount, final ApiCallback<BaseItemDtoQueryResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMusicGenresValidateBeforeCall(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, _callback);
        Type localVarReturnType = new TypeToken<BaseItemDtoQueryResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
