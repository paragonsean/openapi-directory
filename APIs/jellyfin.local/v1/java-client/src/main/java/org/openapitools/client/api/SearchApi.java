...
public class SearchApi {
     ...
     */
    public okhttp3.Call getCall(String searchTerm, Integer startIndex, Integer limit, UUID userId, List<String> includeItemTypes, List<String> excludeItemTypes, List<String> mediaTypes, UUID parentId, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Boolean includePeople, Boolean includeMedia, Boolean includeGenres, Boolean includeStudios, Boolean includeArtists, final ApiCallback _callback) throws ApiException {
