...
public class RemoteImageApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Remote image returned. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Remote image not found. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getRemoteImageCall(URI imageUrl, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRemoteImageValidateBeforeCall(URI imageUrl, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageUrl' is set
        if (imageUrl == null) {
            throw new ApiException("Missing the required parameter 'imageUrl' when calling getRemoteImage(Async)");
        }

        return getRemoteImageCall(imageUrl, _callback);
     ...
     */
    public File getRemoteImage(URI imageUrl) throws ApiException {
        ApiResponse<File> localVarResp = getRemoteImageWithHttpInfo(imageUrl);
     ...
     */
    public ApiResponse<File> getRemoteImageWithHttpInfo(URI imageUrl) throws ApiException {
        okhttp3.Call localVarCall = getRemoteImageValidateBeforeCall(imageUrl, null);
     ...
     */
    public okhttp3.Call getRemoteImageAsync(URI imageUrl, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRemoteImageValidateBeforeCall(imageUrl, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
