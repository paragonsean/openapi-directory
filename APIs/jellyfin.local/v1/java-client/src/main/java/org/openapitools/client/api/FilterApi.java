...
public class FilterApi {
     ...
     */
    public okhttp3.Call getQueryFiltersCall(UUID userId, UUID parentId, List<String> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries, Boolean recursive, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getQueryFiltersValidateBeforeCall(UUID userId, UUID parentId, List<String> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries, Boolean recursive, final ApiCallback _callback) throws ApiException {
     ...
     */
    public QueryFilters getQueryFilters(UUID userId, UUID parentId, List<String> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries, Boolean recursive) throws ApiException {
     ...
     */
    public ApiResponse<QueryFilters> getQueryFiltersWithHttpInfo(UUID userId, UUID parentId, List<String> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries, Boolean recursive) throws ApiException {
     ...
     */
    public okhttp3.Call getQueryFiltersAsync(UUID userId, UUID parentId, List<String> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries, Boolean recursive, final ApiCallback<QueryFilters> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getQueryFiltersLegacyCall(UUID userId, UUID parentId, List<String> includeItemTypes, List<String> mediaTypes, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getQueryFiltersLegacyValidateBeforeCall(UUID userId, UUID parentId, List<String> includeItemTypes, List<String> mediaTypes, final ApiCallback _callback) throws ApiException {
     ...
     */
    public QueryFiltersLegacy getQueryFiltersLegacy(UUID userId, UUID parentId, List<String> includeItemTypes, List<String> mediaTypes) throws ApiException {
     ...
     */
    public ApiResponse<QueryFiltersLegacy> getQueryFiltersLegacyWithHttpInfo(UUID userId, UUID parentId, List<String> includeItemTypes, List<String> mediaTypes) throws ApiException {
     ...
     */
    public okhttp3.Call getQueryFiltersLegacyAsync(UUID userId, UUID parentId, List<String> includeItemTypes, List<String> mediaTypes, final ApiCallback<QueryFiltersLegacy> _callback) throws ApiException {
