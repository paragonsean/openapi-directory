...
public class UserApi {
     ...
     */
    public okhttp3.Call forgotPasswordPinCall(String body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call forgotPasswordPinValidateBeforeCall(String body, final ApiCallback _callback) throws ApiException {
        return forgotPasswordPinCall(body, _callback);
     ...
     */
    public PinRedeemResult forgotPasswordPin(String body) throws ApiException {
        ApiResponse<PinRedeemResult> localVarResp = forgotPasswordPinWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PinRedeemResult> forgotPasswordPinWithHttpInfo(String body) throws ApiException {
        okhttp3.Call localVarCall = forgotPasswordPinValidateBeforeCall(body, null);
     ...
     */
    public okhttp3.Call forgotPasswordPinAsync(String body, final ApiCallback<PinRedeemResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = forgotPasswordPinValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<PinRedeemResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
