...
public class ApiClient {
    ...
    private String basePath = "http://jellyfin.local";
    ...
    public ApiClient() {
        ...
        authentications.put("CustomAuthentication", new ApiKeyAuth("header", "X-Emby-Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://jellyfin.local
