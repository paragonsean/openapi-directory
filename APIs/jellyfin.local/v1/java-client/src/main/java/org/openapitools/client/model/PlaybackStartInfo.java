...
public class PlaybackStartInfo {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aspectRatio, playbackStartInfo.aspectRatio) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaybackStartInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaybackStartInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaybackStartInfo is not found in the empty JSON string", PlaybackStartInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaybackStartInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaybackStartInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaybackStartInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaybackStartInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaybackStartInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaybackStartInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaybackStartInfo>() {
           @Override
           public void write(JsonWriter out, PlaybackStartInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaybackStartInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaybackStartInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaybackStartInfo
   * @throws IOException if the JSON string is invalid with respect to PlaybackStartInfo
   */
  public static PlaybackStartInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaybackStartInfo.class);
  }

  /**
   * Convert an instance of PlaybackStartInfo to an JSON string
   *
   * @return JSON string
   */
