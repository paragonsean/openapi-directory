...
public class BoxSetInfoRemoteSearchQuery {
  ...
  public BoxSetInfoRemoteSearchQuery includeDisabledProviders(Boolean includeDisabledProviders) {
  ...
  public BoxSetInfoRemoteSearchQuery itemId(UUID itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public BoxSetInfoRemoteSearchQuery searchInfo(BoxSetInfo searchInfo) {
  ...
  public void setSearchInfo(BoxSetInfo searchInfo) {
    this.searchInfo = searchInfo;
  }


  public BoxSetInfoRemoteSearchQuery searchProviderName(String searchProviderName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeDisabledProviders, boxSetInfoRemoteSearchQuery.includeDisabledProviders) &&
        Objects.equals(this.itemId, boxSetInfoRemoteSearchQuery.itemId) &&
        Objects.equals(this.searchInfo, boxSetInfoRemoteSearchQuery.searchInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(includeDisabledProviders, itemId, searchInfo, searchProviderName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoxSetInfoRemoteSearchQuery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoxSetInfoRemoteSearchQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoxSetInfoRemoteSearchQuery is not found in the empty JSON string", BoxSetInfoRemoteSearchQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoxSetInfoRemoteSearchQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoxSetInfoRemoteSearchQuery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("SearchInfo") != null && !jsonObj.get("SearchInfo").isJsonNull()) {
        BoxSetInfo.validateJsonElement(jsonObj.get("SearchInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoxSetInfoRemoteSearchQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoxSetInfoRemoteSearchQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoxSetInfoRemoteSearchQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoxSetInfoRemoteSearchQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<BoxSetInfoRemoteSearchQuery>() {
           @Override
           public void write(JsonWriter out, BoxSetInfoRemoteSearchQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoxSetInfoRemoteSearchQuery read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoxSetInfoRemoteSearchQuery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoxSetInfoRemoteSearchQuery
   * @throws IOException if the JSON string is invalid with respect to BoxSetInfoRemoteSearchQuery
   */
  public static BoxSetInfoRemoteSearchQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoxSetInfoRemoteSearchQuery.class);
  }

  /**
   * Convert an instance of BoxSetInfoRemoteSearchQuery to an JSON string
   *
   * @return JSON string
   */
