...
public class ItemLookupApi {
    ...
    /**
     * Build call for getRemoteSearchImage
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Remote image retrieved. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getRemoteSearchImageCall(String imageUrl, String providerName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRemoteSearchImageValidateBeforeCall(String imageUrl, String providerName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageUrl' is set
        if (imageUrl == null) {
            throw new ApiException("Missing the required parameter 'imageUrl' when calling getRemoteSearchImage(Async)");
        }

        // verify the required parameter 'providerName' is set
        if (providerName == null) {
            throw new ApiException("Missing the required parameter 'providerName' when calling getRemoteSearchImage(Async)");
        }

        return getRemoteSearchImageCall(imageUrl, providerName, _callback);
     ...
     */
    public File getRemoteSearchImage(String imageUrl, String providerName) throws ApiException {
        ApiResponse<File> localVarResp = getRemoteSearchImageWithHttpInfo(imageUrl, providerName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> getRemoteSearchImageWithHttpInfo(String imageUrl, String providerName) throws ApiException {
        okhttp3.Call localVarCall = getRemoteSearchImageValidateBeforeCall(imageUrl, providerName, null);
     ...
     */
    public okhttp3.Call getRemoteSearchImageAsync(String imageUrl, String providerName, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRemoteSearchImageValidateBeforeCall(imageUrl, providerName, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
