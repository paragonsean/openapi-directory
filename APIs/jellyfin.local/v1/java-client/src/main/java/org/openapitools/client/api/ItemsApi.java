...
public class ItemsApi {
    ...
    private okhttp3.Call getItemsValidateBeforeCall(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages, final ApiCallback _callback) throws ApiException {
        return getItemsCall(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages, _callback);
    ...
    public BaseItemDtoQueryResult getItems(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResp = getItemsWithHttpInfo(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages);
    ...
    public ApiResponse<BaseItemDtoQueryResult> getItemsWithHttpInfo(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        okhttp3.Call localVarCall = getItemsValidateBeforeCall(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages, null);
    ...
    /**
     * Build call for getItemsByUserId
     ...
     * @param excludeLocationTypes Optional. If specified, results will be filtered based on the LocationType. This allows multiple, comma delimeted. (optional)
     * @param isMissing Optional filter by items that are missing episodes or not. (optional)
     * @param isUnaired Optional filter by items that are unaired episodes or not. (optional)
     * @param minCommunityRating Optional filter by minimum community rating. (optional)
     * @param minCriticRating Optional filter by minimum critic rating. (optional)
     ...
     * @param includeItemTypes Optional. If specified, results will be filtered based on the item type. This allows multiple, comma delimeted. (optional)
     ...
     * @param artists Optional. If specified, results will be filtered based on artists. This allows multiple, pipe delimeted. (optional)
     * @param excludeArtistIds Optional. If specified, results will be filtered based on artist id. This allows multiple, pipe delimeted. (optional)
     * @param artistIds Optional. If specified, results will be filtered to include only those containing the specified artist id. (optional)
     * @param albumArtistIds Optional. If specified, results will be filtered to include only those containing the specified album artist id. (optional)
     * @param contributingArtistIds Optional. If specified, results will be filtered to include only those containing the specified contributing artist id. (optional)
     * @param albums Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimeted. (optional)
     * @param albumIds Optional. If specified, results will be filtered based on album id. This allows multiple, pipe delimeted. (optional)
     * @param ids Optional. If specific items are needed, specify a list of item id&#39;s to retrieve. This allows multiple, comma delimited. (optional)
     ...
     * @param nameStartsWith Optional filter by items whose name is sorted equally than a given input string. (optional)
     * @param nameLessThan Optional filter by items whose name is equally or lesser than a given input string. (optional)
     * @param studioIds Optional. If specified, results will be filtered based on studio id. This allows multiple, pipe delimeted. (optional)
     * @param genreIds Optional. If specified, results will be filtered based on genre id. This allows multiple, pipe delimeted. (optional)
     * @param enableTotalRecordCount Optional. Enable the total record count. (optional, default to true)
     * @param enableImages Optional, include image information in output. (optional, default to true)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getItemsByUserIdValidateBeforeCall(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling getItemsByUserId(Async)");
        }

        return getItemsByUserIdCall(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages, _callback);
    ...
    public BaseItemDtoQueryResult getItemsByUserId(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResp = getItemsByUserIdWithHttpInfo(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BaseItemDtoQueryResult> getItemsByUserIdWithHttpInfo(UUID userId, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K, List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, List<UUID> excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<ItemFilter> filters, Boolean isFavorite, List<String> mediaTypes, List<ImageType> imageTypes, String sortBy, Boolean isPlayed, List<String> genres, List<String> officialRatings, List<String> tags, List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<String> artists, List<UUID> excludeArtistIds, List<UUID> artistIds, List<UUID> albumArtistIds, List<UUID> contributingArtistIds, List<String> albums, List<UUID> albumIds, List<UUID> ids, List<VideoType> videoTypes, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean collapseBoxSetItems, Integer minWidth, Integer minHeight, Integer maxWidth, Integer maxHeight, Boolean is3D, List<SeriesStatus> seriesStatus, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<UUID> studioIds, List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        okhttp3.Call localVarCall = getItemsByUserIdValidateBeforeCall(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds, artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth, maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds, genreIds, enableTotalRecordCount, enableImages, null);
        Type localVarReturnType = new TypeToken<BaseItemDtoQueryResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getResumeItemsCall(UUID userId, Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> mediaTypes, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean enableTotalRecordCount, Boolean enableImages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getResumeItemsValidateBeforeCall(UUID userId, Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> mediaTypes, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean enableTotalRecordCount, Boolean enableImages, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling getResumeItems(Async)");
        }

        return getResumeItemsCall(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData, imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount, enableImages, _callback);
     ...
     */
    public BaseItemDtoQueryResult getResumeItems(UUID userId, Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> mediaTypes, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResp = getResumeItemsWithHttpInfo(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData, imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount, enableImages);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BaseItemDtoQueryResult> getResumeItemsWithHttpInfo(UUID userId, Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> mediaTypes, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
        okhttp3.Call localVarCall = getResumeItemsValidateBeforeCall(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData, imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount, enableImages, null);
        Type localVarReturnType = new TypeToken<BaseItemDtoQueryResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getResumeItemsAsync(UUID userId, Integer startIndex, Integer limit, String searchTerm, UUID parentId, List<ItemFields> fields, List<String> mediaTypes, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludeItemTypes, List<String> includeItemTypes, Boolean enableTotalRecordCount, Boolean enableImages, final ApiCallback<BaseItemDtoQueryResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getResumeItemsValidateBeforeCall(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData, imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount, enableImages, _callback);
        Type localVarReturnType = new TypeToken<BaseItemDtoQueryResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
