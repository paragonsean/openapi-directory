...
public class UserDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_configuration, enableAutoLogin, hasConfiguredEasyPassword, hasConfiguredPassword, hasPassword, id, lastActivityDate, lastLoginDate, name, policy, primaryImageAspectRatio, primaryImageTag, serverId, serverName);
  }
