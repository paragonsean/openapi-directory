...
public class SuggestionsApi {
     ...
     */
    public okhttp3.Call getSuggestionsCall(UUID userId, List<String> mediaType, List<String> type, Integer startIndex, Integer limit, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getSuggestionsValidateBeforeCall(UUID userId, List<String> mediaType, List<String> type, Integer startIndex, Integer limit, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
     ...
     */
    public BaseItemDtoQueryResult getSuggestions(UUID userId, List<String> mediaType, List<String> type, Integer startIndex, Integer limit, Boolean enableTotalRecordCount) throws ApiException {
     ...
     */
    public ApiResponse<BaseItemDtoQueryResult> getSuggestionsWithHttpInfo(UUID userId, List<String> mediaType, List<String> type, Integer startIndex, Integer limit, Boolean enableTotalRecordCount) throws ApiException {
     ...
     */
    public okhttp3.Call getSuggestionsAsync(UUID userId, List<String> mediaType, List<String> type, Integer startIndex, Integer limit, Boolean enableTotalRecordCount, final ApiCallback<BaseItemDtoQueryResult> _callback) throws ApiException {
