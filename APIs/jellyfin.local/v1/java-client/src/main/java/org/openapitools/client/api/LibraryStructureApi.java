...
public class LibraryStructureApi {
     ...
     */
    public okhttp3.Call addVirtualFolderCall(String name, String collectionType, List<String> paths, Boolean refreshLibrary, AddVirtualFolderDto addVirtualFolderDto, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addVirtualFolderValidateBeforeCall(String name, String collectionType, List<String> paths, Boolean refreshLibrary, AddVirtualFolderDto addVirtualFolderDto, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void addVirtualFolder(String name, String collectionType, List<String> paths, Boolean refreshLibrary, AddVirtualFolderDto addVirtualFolderDto) throws ApiException {
     ...
     */
    public ApiResponse<Void> addVirtualFolderWithHttpInfo(String name, String collectionType, List<String> paths, Boolean refreshLibrary, AddVirtualFolderDto addVirtualFolderDto) throws ApiException {
     ...
     */
    public okhttp3.Call addVirtualFolderAsync(String name, String collectionType, List<String> paths, Boolean refreshLibrary, AddVirtualFolderDto addVirtualFolderDto, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @param name The name of the library. (optional)
     * @param mediaPathInfo The path info. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateMediaPathCall(String name, MediaPathInfo mediaPathInfo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = mediaPathInfo;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMediaPathValidateBeforeCall(String name, MediaPathInfo mediaPathInfo, final ApiCallback _callback) throws ApiException {
        return updateMediaPathCall(name, mediaPathInfo, _callback);
     ...
     */
    public void updateMediaPath(String name, MediaPathInfo mediaPathInfo) throws ApiException {
        updateMediaPathWithHttpInfo(name, mediaPathInfo);
    }
     ...
     */
    public ApiResponse<Void> updateMediaPathWithHttpInfo(String name, MediaPathInfo mediaPathInfo) throws ApiException {
        okhttp3.Call localVarCall = updateMediaPathValidateBeforeCall(name, mediaPathInfo, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateMediaPathAsync(String name, MediaPathInfo mediaPathInfo, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateMediaPathValidateBeforeCall(name, mediaPathInfo, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
