...
public class UserConfiguration {
  ...
  public void setGroupedFolders(List<String> groupedFolders) {
    this.groupedFolders = groupedFolders;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audioLanguagePreference, displayCollectionsView, displayMissingEpisodes, enableLocalPassword, enableNextEpisodeAutoPlay, groupedFolders, hidePlayedInLatest, latestItemsExcludes, myMediaExcludes, orderedViews, playDefaultAudioTrack, rememberAudioSelections, rememberSubtitleSelections, subtitleLanguagePreference, subtitleMode);
  }
