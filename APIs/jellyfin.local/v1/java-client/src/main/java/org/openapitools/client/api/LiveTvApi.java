...
public class LiveTvApi {
     ...
     */
    public okhttp3.Call getLiveTvProgramsCall(List<UUID> channelIds, UUID userId, OffsetDateTime minStartDate, Boolean hasAired, Boolean isAiring, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Integer startIndex, Integer limit, String sortBy, String sortOrder, List<String> genres, List<UUID> genreIds, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String seriesTimerId, UUID librarySeriesId, List<ItemFields> fields, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLiveTvProgramsValidateBeforeCall(List<UUID> channelIds, UUID userId, OffsetDateTime minStartDate, Boolean hasAired, Boolean isAiring, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Integer startIndex, Integer limit, String sortBy, String sortOrder, List<String> genres, List<UUID> genreIds, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String seriesTimerId, UUID librarySeriesId, List<ItemFields> fields, Boolean enableTotalRecordCount, final ApiCallback _callback) throws ApiException {
     ...
     */
    public BaseItemDtoQueryResult getLiveTvPrograms(List<UUID> channelIds, UUID userId, OffsetDateTime minStartDate, Boolean hasAired, Boolean isAiring, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Integer startIndex, Integer limit, String sortBy, String sortOrder, List<String> genres, List<UUID> genreIds, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String seriesTimerId, UUID librarySeriesId, List<ItemFields> fields, Boolean enableTotalRecordCount) throws ApiException {
     ...
     */
    public ApiResponse<BaseItemDtoQueryResult> getLiveTvProgramsWithHttpInfo(List<UUID> channelIds, UUID userId, OffsetDateTime minStartDate, Boolean hasAired, Boolean isAiring, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Integer startIndex, Integer limit, String sortBy, String sortOrder, List<String> genres, List<UUID> genreIds, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String seriesTimerId, UUID librarySeriesId, List<ItemFields> fields, Boolean enableTotalRecordCount) throws ApiException {
     ...
     */
    public okhttp3.Call getLiveTvProgramsAsync(List<UUID> channelIds, UUID userId, OffsetDateTime minStartDate, Boolean hasAired, Boolean isAiring, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Boolean isMovie, Boolean isSeries, Boolean isNews, Boolean isKids, Boolean isSports, Integer startIndex, Integer limit, String sortBy, String sortOrder, List<String> genres, List<UUID> genreIds, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String seriesTimerId, UUID librarySeriesId, List<ItemFields> fields, Boolean enableTotalRecordCount, final ApiCallback<BaseItemDtoQueryResult> _callback) throws ApiException {
