...
public class YearsApi {
     ...
     */
    public okhttp3.Call getYearsCall(Integer startIndex, Integer limit, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<String> mediaTypes, String sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getYearsValidateBeforeCall(Integer startIndex, Integer limit, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<String> mediaTypes, String sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<BaseItemDtoQueryResult> getYearsWithHttpInfo(Integer startIndex, Integer limit, String sortOrder, UUID parentId, List<ItemFields> fields, List<String> excludeItemTypes, List<String> includeItemTypes, List<String> mediaTypes, String sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages) throws ApiException {
