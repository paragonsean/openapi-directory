...
public class Example {
  public static void main(String[] args) {
    ...
    String collectionType = "collectionType_example"; // String | The type of the collection.
...
# **updateMediaPath**
> updateMediaPath(name, mediaPathInfo)
...
public class Example {
  public static void main(String[] args) {
    ...
    LibraryStructureApi apiInstance = new LibraryStructureApi(defaultClient);
    String name = "name_example"; // String | The name of the library.
    MediaPathInfo mediaPathInfo = new MediaPathInfo(); // MediaPathInfo | The path info.
    try {
      apiInstance.updateMediaPath(name, mediaPathInfo);
    } catch (ApiException e) {
