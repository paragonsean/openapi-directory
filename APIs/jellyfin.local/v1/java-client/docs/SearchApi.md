...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> includeItemTypes = Arrays.asList(); // List<String> | If specified, only results with the specified item types are returned. This allows multiple, comma delimeted.
    List<String> excludeItemTypes = Arrays.asList(); // List<String> | If specified, results with these item types are filtered out. This allows multiple, comma delimeted.
