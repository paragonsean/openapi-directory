...
public class Example {
  public static void main(String[] args) {
    ...
    String url = "url_example"; // String | The URL of the notification.
    NotificationLevel level = NotificationLevel.fromValue("Normal"); // NotificationLevel | The level of the notification.
    String name = ""; // String | The name of the notification.
    String description = ""; // String | The description of the notification.
    try {
...
| **level** | [**NotificationLevel**](.md)| The level of the notification. | [optional] [enum: Normal, Warning, Error] |
