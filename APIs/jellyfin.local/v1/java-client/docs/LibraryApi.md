...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean isNewLibrary = true; // Boolean | Whether this is a new library.
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    LibraryApi apiInstance = new LibraryApi(defaultClient);
    List<MediaUpdateInfoDto> mediaUpdateInfoDto = Arrays.asList(); // List<MediaUpdateInfoDto> | A list of updated media paths.
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **mediaUpdateInfoDto** | [**List&lt;MediaUpdateInfoDto&gt;**](MediaUpdateInfoDto.md)| A list of updated media paths. | |
