...
public class Example {
  public static void main(String[] args) {
    ...
    String sortOrder = "sortOrder_example"; // String | Sort Order - Ascending,Descending.
    ...
    List<String> excludeItemTypes = Arrays.asList(); // List<String> | Optional. If specified, results will be excluded based on item type. This allows multiple, comma delimited.
    List<String> includeItemTypes = Arrays.asList(); // List<String> | Optional. If specified, results will be included based on item type. This allows multiple, comma delimited.
