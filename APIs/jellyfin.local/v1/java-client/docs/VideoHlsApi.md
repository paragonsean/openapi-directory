...
import org.openapitools.client.api.VideoHlsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VideoHlsApi apiInstance = new VideoHlsApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling VideoHlsApi#getLiveHlsStream");
