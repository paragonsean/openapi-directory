...
public class Example {
  public static void main(String[] args) {
    ...
    SessionApi apiInstance = new SessionApi(defaultClient);
    String sessionId = "sessionId_example"; // String | The session Id.
    String itemType = "itemType_example"; // String | The type of item to browse to.
...
<a id="play"></a>
# **play**
> play(sessionId, playCommand, itemIds, startPositionTicks)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.play(sessionId, playCommand, itemIds, startPositionTicks);
    } catch (ApiException e) {
...
# **sendMessageCommand**
> sendMessageCommand(sessionId, text, header, timeoutMs)
...
public class Example {
  public static void main(String[] args) {
    ...
    SessionApi apiInstance = new SessionApi(defaultClient);
    String sessionId = "sessionId_example"; // String | The session id.
    String text = "text_example"; // String | The message test.
    String header = "header_example"; // String | The message header.
    Long timeoutMs = 56L; // Long | The message timeout. If omitted the user will have to confirm viewing the message.
    try {
      apiInstance.sendMessageCommand(sessionId, text, header, timeoutMs);
    } catch (ApiException e) {
