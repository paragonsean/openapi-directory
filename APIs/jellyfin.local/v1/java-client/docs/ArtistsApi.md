...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> excludeItemTypes = Arrays.asList(); // List<String> | Optional. If specified, results will be filtered out based on item type. This allows multiple, comma delimited.
    List<String> includeItemTypes = Arrays.asList(); // List<String> | Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimited.
