...
public class Example {
  public static void main(String[] args) {
    ...
    Version version = new Version(); // Version | Plugin version.
    try {
...
<a id="updatePluginSecurityInfo"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    PluginsApi apiInstance = new PluginsApi(defaultClient);
    PluginSecurityInfo pluginSecurityInfo = new PluginSecurityInfo(); // PluginSecurityInfo | Plugin security info.
    try {
      apiInstance.updatePluginSecurityInfo(pluginSecurityInfo);
    } catch (ApiException e) {
      System.err.println("Exception when calling PluginsApi#updatePluginSecurityInfo");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
