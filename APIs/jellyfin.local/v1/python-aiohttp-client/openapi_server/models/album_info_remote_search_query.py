...
class AlbumInfoRemoteSearchQuery(Model):
    ...
    def __init__(self, include_disabled_providers: bool=None, item_id: str=None, search_info: AlbumInfo=None, search_provider_name: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AlbumInfoRemoteSearchQuery':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AlbumInfoRemoteSearchQuery of this AlbumInfoRemoteSearchQuery.
        """
