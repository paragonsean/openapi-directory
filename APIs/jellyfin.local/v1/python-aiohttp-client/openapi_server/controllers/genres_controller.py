...
async def get_genre(request: web.Request, genre_name, user_id=None) -> web.Response:
...
async def get_genres(request: web.Request, start_index=None, limit=None, search_term=None, parent_id=None, fields=None, exclude_item_types=None, include_item_types=None, is_favorite=None, image_type_limit=None, enable_image_types=None, user_id=None, name_starts_with_or_greater=None, name_starts_with=None, name_less_than=None, enable_images=None, enable_total_record_count=None) -> web.Response:
