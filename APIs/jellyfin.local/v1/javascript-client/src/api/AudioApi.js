...
export default class AudioApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAudioStream operation.
     * @callback module:api/AudioApi~getAudioStreamCallback
     ...
     * @param {module:api/AudioApi~getAudioStreamCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    getAudioStream(itemId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'itemId' is set
      if (itemId === undefined || itemId === null) {
        throw new Error("Missing the required parameter 'itemId' when calling getAudioStream");
      }
    ...
    /**
     * Callback function to receive the result of the getAudioStreamByContainer operation.
     * @callback module:api/AudioApi~getAudioStreamByContainerCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/EncodingContext} [context] Optional. The MediaBrowser.Model.Dlna.EncodingContext.
     * @param {Object.<String, {String: String}>} [streamOptions] Optional. The streaming options.
     * @param {module:api/AudioApi~getAudioStreamByContainerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    getAudioStreamByContainer(itemId, container, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'itemId' is set
      if (itemId === undefined || itemId === null) {
        throw new Error("Missing the required parameter 'itemId' when calling getAudioStreamByContainer");
      }
      // verify the required parameter 'container' is set
      if (container === undefined || container === null) {
        throw new Error("Missing the required parameter 'container' when calling getAudioStreamByContainer");
      }
      ...
      let returnType = File;
      return this.apiClient.callApi(
        '/Audio/{itemId}/stream.{container}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the headAudioStream operation.
     * @callback module:api/AudioApi~headAudioStreamCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/EncodingContext} [context] Optional. The MediaBrowser.Model.Dlna.EncodingContext.
     * @param {Object.<String, {String: String}>} [streamOptions] Optional. The streaming options.
     * @param {module:api/AudioApi~headAudioStreamCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    headAudioStream(itemId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'itemId' is set
      if (itemId === undefined || itemId === null) {
        throw new Error("Missing the required parameter 'itemId' when calling headAudioStream");
      }
    ...
    /**
     * Callback function to receive the result of the headAudioStreamByContainer operation.
     * @callback module:api/AudioApi~headAudioStreamByContainerCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/EncodingContext} [context] Optional. The MediaBrowser.Model.Dlna.EncodingContext.
     * @param {Object.<String, {String: String}>} [streamOptions] Optional. The streaming options.
     * @param {module:api/AudioApi~headAudioStreamByContainerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    headAudioStreamByContainer(itemId, container, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'itemId' is set
      if (itemId === undefined || itemId === null) {
        throw new Error("Missing the required parameter 'itemId' when calling headAudioStreamByContainer");
      }
      // verify the required parameter 'container' is set
      if (container === undefined || container === null) {
        throw new Error("Missing the required parameter 'container' when calling headAudioStreamByContainer");
      }
      ...
      let returnType = File;
      return this.apiClient.callApi(
        '/Audio/{itemId}/stream.{container}', 'HEAD',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
