...
/**
 * The BoxSetInfo model module.
 * @module model/BoxSetInfo
 * @version v1
 */
class BoxSetInfo {
    /**
     * Constructs a new <code>BoxSetInfo</code>.
     * @alias module:model/BoxSetInfo
     */
    constructor() { 
        
        BoxSetInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BoxSetInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BoxSetInfo} obj Optional instance to populate.
     * @return {module:model/BoxSetInfo} The populated <code>BoxSetInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BoxSetInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>BoxSetInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoxSetInfo</code>.
     */
 ...
 */
BoxSetInfo.prototype['IndexNumber'] = undefined;

/**
 * @member {Boolean} IsAutomated
 */
BoxSetInfo.prototype['IsAutomated'] = undefined;

/**
 * Gets or sets the metadata country code.
 * @member {String} MetadataCountryCode
 */
BoxSetInfo.prototype['MetadataCountryCode'] = undefined;

/**
 * Gets or sets the metadata language.
 * @member {String} MetadataLanguage
 */
BoxSetInfo.prototype['MetadataLanguage'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} Name
 */
BoxSetInfo.prototype['Name'] = undefined;

/**
 * @member {Number} ParentIndexNumber
 */
BoxSetInfo.prototype['ParentIndexNumber'] = undefined;

/**
 * Gets or sets the path.
 * @member {String} Path
 */
BoxSetInfo.prototype['Path'] = undefined;

/**
 * @member {Date} PremiereDate
 */
BoxSetInfo.prototype['PremiereDate'] = undefined;

/**
 * Gets or sets the provider ids.
 * @member {Object.<String, String>} ProviderIds
 */
BoxSetInfo.prototype['ProviderIds'] = undefined;

/**
 * Gets or sets the year.
 * @member {Number} Year
 */
BoxSetInfo.prototype['Year'] = undefined;
