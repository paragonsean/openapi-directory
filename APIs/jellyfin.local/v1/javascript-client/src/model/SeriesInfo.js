...
class SeriesInfo {
    /**
     * Constructs a new <code>SeriesInfo</code>.
     * @alias module:model/SeriesInfo
     */
    constructor() { 
        
        SeriesInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SeriesInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeriesInfo} obj Optional instance to populate.
     * @return {module:model/SeriesInfo} The populated <code>SeriesInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeriesInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>SeriesInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeriesInfo</code>.
     */
 ...
 */
SeriesInfo.prototype['IndexNumber'] = undefined;

/**
 * @member {Boolean} IsAutomated
 */
SeriesInfo.prototype['IsAutomated'] = undefined;

/**
 * Gets or sets the metadata country code.
 * @member {String} MetadataCountryCode
 */
SeriesInfo.prototype['MetadataCountryCode'] = undefined;

/**
 * Gets or sets the metadata language.
 * @member {String} MetadataLanguage
 */
SeriesInfo.prototype['MetadataLanguage'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} Name
 */
SeriesInfo.prototype['Name'] = undefined;

/**
 * @member {Number} ParentIndexNumber
 */
SeriesInfo.prototype['ParentIndexNumber'] = undefined;

/**
 * Gets or sets the path.
 * @member {String} Path
 */
SeriesInfo.prototype['Path'] = undefined;

/**
 * @member {Date} PremiereDate
 */
SeriesInfo.prototype['PremiereDate'] = undefined;

/**
 * Gets or sets the provider ids.
 * @member {Object.<String, String>} ProviderIds
 */
SeriesInfo.prototype['ProviderIds'] = undefined;

/**
 * Gets or sets the year.
 * @member {Number} Year
 */
SeriesInfo.prototype['Year'] = undefined;
