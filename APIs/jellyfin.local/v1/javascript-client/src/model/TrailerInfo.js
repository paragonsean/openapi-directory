...
class TrailerInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>TrailerInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrailerInfo</code>.
     */
 ...
 */
TrailerInfo.prototype['IndexNumber'] = undefined;

/**
 * @member {Boolean} IsAutomated
 */
TrailerInfo.prototype['IsAutomated'] = undefined;

/**
 * Gets or sets the metadata country code.
 * @member {String} MetadataCountryCode
 */
TrailerInfo.prototype['MetadataCountryCode'] = undefined;

/**
 * Gets or sets the metadata language.
 * @member {String} MetadataLanguage
 */
TrailerInfo.prototype['MetadataLanguage'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} Name
 */
TrailerInfo.prototype['Name'] = undefined;

/**
 * @member {Number} ParentIndexNumber
 */
TrailerInfo.prototype['ParentIndexNumber'] = undefined;

/**
 * Gets or sets the path.
 * @member {String} Path
 */
TrailerInfo.prototype['Path'] = undefined;

/**
 * @member {Date} PremiereDate
 */
TrailerInfo.prototype['PremiereDate'] = undefined;

/**
 * Gets or sets the provider ids.
 * @member {Object.<String, String>} ProviderIds
 */
TrailerInfo.prototype['ProviderIds'] = undefined;

/**
 * Gets or sets the year.
 * @member {Number} Year
 */
TrailerInfo.prototype['Year'] = undefined;
