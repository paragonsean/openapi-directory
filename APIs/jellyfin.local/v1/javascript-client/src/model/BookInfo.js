...
class BookInfo {
    ...
    /**
     * Validates the JSON data with respect to <code>BookInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BookInfo</code>.
     */
 ...
 */
BookInfo.prototype['IndexNumber'] = undefined;

/**
 * @member {Boolean} IsAutomated
 */
BookInfo.prototype['IsAutomated'] = undefined;

/**
 * Gets or sets the metadata country code.
 * @member {String} MetadataCountryCode
 */
BookInfo.prototype['MetadataCountryCode'] = undefined;

/**
 * Gets or sets the metadata language.
 * @member {String} MetadataLanguage
 */
BookInfo.prototype['MetadataLanguage'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} Name
 */
BookInfo.prototype['Name'] = undefined;

/**
 * @member {Number} ParentIndexNumber
 */
BookInfo.prototype['ParentIndexNumber'] = undefined;

/**
 * Gets or sets the path.
 * @member {String} Path
 */
BookInfo.prototype['Path'] = undefined;

/**
 * @member {Date} PremiereDate
 */
BookInfo.prototype['PremiereDate'] = undefined;

/**
 * Gets or sets the provider ids.
 * @member {Object.<String, String>} ProviderIds
 */
BookInfo.prototype['ProviderIds'] = undefined;

/**
 * @member {String} SeriesName
 */
BookInfo.prototype['SeriesName'] = undefined;

/**
 * Gets or sets the year.
 * @member {Number} Year
 */
BookInfo.prototype['Year'] = undefined;
