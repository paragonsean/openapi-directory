...
/**
 * The ArtistInfo model module.
 * @module model/ArtistInfo
 * @version v1
 */
class ArtistInfo {
    /**
     * Constructs a new <code>ArtistInfo</code>.
     * @alias module:model/ArtistInfo
     */
    constructor() { 
        
        ArtistInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArtistInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArtistInfo} obj Optional instance to populate.
     * @return {module:model/ArtistInfo} The populated <code>ArtistInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArtistInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>ArtistInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArtistInfo</code>.
     */
 ...
 */
ArtistInfo.prototype['IndexNumber'] = undefined;

/**
 * @member {Boolean} IsAutomated
 */
ArtistInfo.prototype['IsAutomated'] = undefined;

/**
 * Gets or sets the metadata country code.
 * @member {String} MetadataCountryCode
 */
ArtistInfo.prototype['MetadataCountryCode'] = undefined;

/**
 * Gets or sets the metadata language.
 * @member {String} MetadataLanguage
 */
ArtistInfo.prototype['MetadataLanguage'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} Name
 */
ArtistInfo.prototype['Name'] = undefined;

/**
 * @member {Number} ParentIndexNumber
 */
ArtistInfo.prototype['ParentIndexNumber'] = undefined;

/**
 * Gets or sets the path.
 * @member {String} Path
 */
ArtistInfo.prototype['Path'] = undefined;

/**
 * @member {Date} PremiereDate
 */
ArtistInfo.prototype['PremiereDate'] = undefined;

/**
 * Gets or sets the provider ids.
 * @member {Object.<String, String>} ProviderIds
 */
ArtistInfo.prototype['ProviderIds'] = undefined;

/**
 * @member {Array.<module:model/SongInfo>} SongInfos
 */
ArtistInfo.prototype['SongInfos'] = undefined;

/**
 * Gets or sets the year.
 * @member {Number} Year
 */
ArtistInfo.prototype['Year'] = undefined;
