...
class CreateUserByName {
    ...
    constructor() { 
        ...
        CreateUserByName.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserByName</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserByName</code>.
     */
 ...
 * @member {String} Name
 */
CreateUserByName.prototype['Name'] = undefined;

/**
 * Gets or sets the password.
 * @member {String} Password
 */
CreateUserByName.prototype['Password'] = undefined;
