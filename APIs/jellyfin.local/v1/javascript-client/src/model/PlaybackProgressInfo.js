...
class PlaybackProgressInfo {
    ...
    constructor() { 
        ...
        PlaybackProgressInfo.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PlaybackProgressInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaybackProgressInfo</code>.
     */
 ...
 */
PlaybackProgressInfo.prototype['AspectRatio'] = undefined;

/**
 * Gets or sets the index of the audio stream.
 * @member {Number} AudioStreamIndex
 */
PlaybackProgressInfo.prototype['AudioStreamIndex'] = undefined;

/**
 * @member {Number} Brightness
 */
PlaybackProgressInfo.prototype['Brightness'] = undefined;

/**
 * Gets or sets a value indicating whether this instance can seek.
 * @member {Boolean} CanSeek
 */
PlaybackProgressInfo.prototype['CanSeek'] = undefined;

/**
 * Gets or sets a value indicating whether this instance is muted.
 * @member {Boolean} IsMuted
 */
PlaybackProgressInfo.prototype['IsMuted'] = undefined;

/**
 * Gets or sets a value indicating whether this instance is paused.
 * @member {Boolean} IsPaused
 */
PlaybackProgressInfo.prototype['IsPaused'] = undefined;

/**
 * @member {module:model/BaseItemDto} Item
 */
PlaybackProgressInfo.prototype['Item'] = undefined;

/**
 * Gets or sets the item identifier.
 * @member {String} ItemId
 */
PlaybackProgressInfo.prototype['ItemId'] = undefined;

/**
 * Gets or sets the live stream identifier.
 * @member {String} LiveStreamId
 */
PlaybackProgressInfo.prototype['LiveStreamId'] = undefined;

/**
 * Gets or sets the media version identifier.
 * @member {String} MediaSourceId
 */
PlaybackProgressInfo.prototype['MediaSourceId'] = undefined;

/**
 * @member {Array.<module:model/QueueItem>} NowPlayingQueue
 */
PlaybackProgressInfo.prototype['NowPlayingQueue'] = undefined;

/**
 * @member {module:model/PlayMethod} PlayMethod
 */
PlaybackProgressInfo.prototype['PlayMethod'] = undefined;

/**
 * Gets or sets the play session identifier.
 * @member {String} PlaySessionId
 */
PlaybackProgressInfo.prototype['PlaySessionId'] = undefined;

/**
 * @member {Number} PlaybackStartTimeTicks
 */
PlaybackProgressInfo.prototype['PlaybackStartTimeTicks'] = undefined;

/**
 * @member {String} PlaylistItemId
 */
PlaybackProgressInfo.prototype['PlaylistItemId'] = undefined;

/**
 * Gets or sets the position ticks.
 * @member {Number} PositionTicks
 */
PlaybackProgressInfo.prototype['PositionTicks'] = undefined;

/**
 * @member {module:model/RepeatMode} RepeatMode
 */
PlaybackProgressInfo.prototype['RepeatMode'] = undefined;

/**
 * Gets or sets the session id.
 * @member {String} SessionId
 */
PlaybackProgressInfo.prototype['SessionId'] = undefined;

/**
 * Gets or sets the index of the subtitle stream.
 * @member {Number} SubtitleStreamIndex
 */
PlaybackProgressInfo.prototype['SubtitleStreamIndex'] = undefined;

/**
 * Gets or sets the volume level.
 * @member {Number} VolumeLevel
 */
PlaybackProgressInfo.prototype['VolumeLevel'] = undefined;
...
export default PlaybackProgressInfo;
