...
------------ | ------------- | ------------- | -------------
**additionalUsers** | [**[SessionUserInfo]**](SessionUserInfo.md) |  | [optional] 
...
**supportedCommands** | [**[GeneralCommandType]**](GeneralCommandType.md) | Gets or sets the supported commands. | [optional] [readonly] 
