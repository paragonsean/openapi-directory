...
**completedInstallations** | [**[InstallationInfo]**](InstallationInfo.md) | Gets or sets the completed installations. | [optional] 
...
**webSocketPortNumber** | **Number** | Gets or sets the web socket port number. | [optional] 
