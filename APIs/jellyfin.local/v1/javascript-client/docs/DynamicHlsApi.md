...
> File getHlsAudioSegment(itemId, playlistId, segmentId, container, opts)
...
apiInstance.getHlsAudioSegment(itemId, playlistId, segmentId, container, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **segmentId** | **Number**| The segment id. | 
...
> File getHlsVideoSegment(itemId, playlistId, segmentId, container, opts)
...
apiInstance.getHlsVideoSegment(itemId, playlistId, segmentId, container, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File getMasterHlsAudioPlaylist(itemId, mediaSourceId, opts)
...
let opts = {
  ...
  'context': new JellyfinApi.EncodingContext(), // EncodingContext | Optional. The MediaBrowser.Model.Dlna.EncodingContext.
  'streamOptions': {key: "null"}, // {String: String} | Optional. The streaming options.
  'enableAdaptiveBitrateStreaming': true // Boolean | Enable adaptive bitrate streaming.
};
apiInstance.getMasterHlsAudioPlaylist(itemId, mediaSourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File getMasterHlsVideoPlaylist(itemId, mediaSourceId, opts)
...
apiInstance.getMasterHlsVideoPlaylist(itemId, mediaSourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File getVariantHlsAudioPlaylist(itemId, opts)
...
apiInstance.getVariantHlsAudioPlaylist(itemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File getVariantHlsVideoPlaylist(itemId, opts)
...
apiInstance.getVariantHlsVideoPlaylist(itemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File headMasterHlsAudioPlaylist(itemId, mediaSourceId, opts)
...
apiInstance.headMasterHlsAudioPlaylist(itemId, mediaSourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File headMasterHlsVideoPlaylist(itemId, mediaSourceId, opts)
...
apiInstance.headMasterHlsVideoPlaylist(itemId, mediaSourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
