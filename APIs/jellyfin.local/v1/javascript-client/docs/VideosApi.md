...
let apiInstance = new JellyfinApi.VideosApi();
let itemId = "itemId_example"; // String | The item id.
apiInstance.deleteAlternateSources(itemId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BaseItemDtoQueryResult getAdditionalPart(itemId, opts)
...
apiInstance.getAdditionalPart(itemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> File getVideoStream(itemId, opts)
...
apiInstance.getVideoStream(itemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File getVideoStreamByContainer(itemId, container, stream, opts)
...
apiInstance.getVideoStreamByContainer(itemId, container, stream, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File headVideoStream(itemId, opts)
...
apiInstance.headVideoStream(itemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File headVideoStreamByContainer(itemId, container, stream, opts)
...
apiInstance.headVideoStreamByContainer(itemId, container, stream, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new JellyfinApi.VideosApi();
let ids = ["null"]; // [String] | Item id list. This allows multiple, comma delimited.
apiInstance.mergeVersions(ids, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
