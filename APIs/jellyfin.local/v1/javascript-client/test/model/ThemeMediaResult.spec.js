...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.ThemeMediaResult();
  });
  ...
  describe('ThemeMediaResult', function() {
    it('should create an instance of ThemeMediaResult', function() {
      // uncomment below and update the code to test ThemeMediaResult
      //var instance = new JellyfinApi.ThemeMediaResult();
      //expect(instance).to.be.a(JellyfinApi.ThemeMediaResult);
    });
