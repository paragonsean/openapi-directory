...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.MusicVideoInfo();
  });
  ...
  describe('MusicVideoInfo', function() {
    it('should create an instance of MusicVideoInfo', function() {
      // uncomment below and update the code to test MusicVideoInfo
      //var instance = new JellyfinApi.MusicVideoInfo();
      //expect(instance).to.be.a(JellyfinApi.MusicVideoInfo);
    });
