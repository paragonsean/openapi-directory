...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.UpdateUserEasyPassword();
  });
  ...
  describe('UpdateUserEasyPassword', function() {
    it('should create an instance of UpdateUserEasyPassword', function() {
      // uncomment below and update the code to test UpdateUserEasyPassword
      //var instance = new JellyfinApi.UpdateUserEasyPassword();
      //expect(instance).to.be.a(JellyfinApi.UpdateUserEasyPassword);
    });
