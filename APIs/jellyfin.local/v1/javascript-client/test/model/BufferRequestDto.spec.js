...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.BufferRequestDto();
  });
  ...
  describe('BufferRequestDto', function() {
    it('should create an instance of BufferRequestDto', function() {
      // uncomment below and update the code to test BufferRequestDto
      //var instance = new JellyfinApi.BufferRequestDto();
      //expect(instance).to.be.a(JellyfinApi.BufferRequestDto);
    });
