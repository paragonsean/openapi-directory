...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.BookInfo();
  });
  ...
  describe('BookInfo', function() {
    it('should create an instance of BookInfo', function() {
      // uncomment below and update the code to test BookInfo
      //var instance = new JellyfinApi.BookInfo();
      //expect(instance).to.be.a(JellyfinApi.BookInfo);
    });
