...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.FontFile();
  });
  ...
  describe('FontFile', function() {
    it('should create an instance of FontFile', function() {
      // uncomment below and update the code to test FontFile
      //var instance = new JellyfinApi.FontFile();
      //expect(instance).to.be.a(JellyfinApi.FontFile);
    });
