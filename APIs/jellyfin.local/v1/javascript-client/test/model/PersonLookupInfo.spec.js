...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.PersonLookupInfo();
  });
  ...
  describe('PersonLookupInfo', function() {
    it('should create an instance of PersonLookupInfo', function() {
      // uncomment below and update the code to test PersonLookupInfo
      //var instance = new JellyfinApi.PersonLookupInfo();
      //expect(instance).to.be.a(JellyfinApi.PersonLookupInfo);
    });
