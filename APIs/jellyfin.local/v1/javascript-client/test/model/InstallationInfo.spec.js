...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.InstallationInfo();
  });
  ...
  describe('InstallationInfo', function() {
    it('should create an instance of InstallationInfo', function() {
      // uncomment below and update the code to test InstallationInfo
      //var instance = new JellyfinApi.InstallationInfo();
      //expect(instance).to.be.a(JellyfinApi.InstallationInfo);
    });
