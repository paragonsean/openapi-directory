...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.AlbumInfo();
  });
  ...
  describe('AlbumInfo', function() {
    it('should create an instance of AlbumInfo', function() {
      // uncomment below and update the code to test AlbumInfo
      //var instance = new JellyfinApi.AlbumInfo();
      //expect(instance).to.be.a(JellyfinApi.AlbumInfo);
    });
    ...
    it('should have the property artistProviderIds (base name: "ArtistProviderIds")', function() {
      // uncomment below and update the code to test the property artistProviderIds
      //var instance = new JellyfinApi.AlbumInfo();
      //expect(instance).to.be();
    });
