...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.SeriesInfo();
  });
  ...
  describe('SeriesInfo', function() {
    it('should create an instance of SeriesInfo', function() {
      // uncomment below and update the code to test SeriesInfo
      //var instance = new JellyfinApi.SeriesInfo();
      //expect(instance).to.be.a(JellyfinApi.SeriesInfo);
    });
