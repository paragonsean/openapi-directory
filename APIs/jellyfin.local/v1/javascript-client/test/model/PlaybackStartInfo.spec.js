...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.PlaybackStartInfo();
  });
  ...
  describe('PlaybackStartInfo', function() {
    it('should create an instance of PlaybackStartInfo', function() {
      // uncomment below and update the code to test PlaybackStartInfo
      //var instance = new JellyfinApi.PlaybackStartInfo();
      //expect(instance).to.be.a(JellyfinApi.PlaybackStartInfo);
    });
