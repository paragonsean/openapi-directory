...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.ActivityLogEntryQueryResult();
  });
  ...
  describe('ActivityLogEntryQueryResult', function() {
    it('should create an instance of ActivityLogEntryQueryResult', function() {
      // uncomment below and update the code to test ActivityLogEntryQueryResult
      //var instance = new JellyfinApi.ActivityLogEntryQueryResult();
      //expect(instance).to.be.a(JellyfinApi.ActivityLogEntryQueryResult);
    });
