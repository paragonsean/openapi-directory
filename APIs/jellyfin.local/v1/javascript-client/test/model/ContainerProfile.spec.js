...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.ContainerProfile();
  });
  ...
  describe('ContainerProfile', function() {
    it('should create an instance of ContainerProfile', function() {
      // uncomment below and update the code to test ContainerProfile
      //var instance = new JellyfinApi.ContainerProfile();
      //expect(instance).to.be.a(JellyfinApi.ContainerProfile);
    });
