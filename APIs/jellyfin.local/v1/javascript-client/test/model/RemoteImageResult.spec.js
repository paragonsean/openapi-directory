...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.RemoteImageResult();
  });
  ...
  describe('RemoteImageResult', function() {
    it('should create an instance of RemoteImageResult', function() {
      // uncomment below and update the code to test RemoteImageResult
      //var instance = new JellyfinApi.RemoteImageResult();
      //expect(instance).to.be.a(JellyfinApi.RemoteImageResult);
    });
