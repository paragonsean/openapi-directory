...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.PlaybackInfoResponse();
  });
  ...
  describe('PlaybackInfoResponse', function() {
    it('should create an instance of PlaybackInfoResponse', function() {
      // uncomment below and update the code to test PlaybackInfoResponse
      //var instance = new JellyfinApi.PlaybackInfoResponse();
      //expect(instance).to.be.a(JellyfinApi.PlaybackInfoResponse);
    });
