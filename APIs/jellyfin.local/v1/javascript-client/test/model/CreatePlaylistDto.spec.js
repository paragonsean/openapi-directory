...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.CreatePlaylistDto();
  });
  ...
  describe('CreatePlaylistDto', function() {
    it('should create an instance of CreatePlaylistDto', function() {
      // uncomment below and update the code to test CreatePlaylistDto
      //var instance = new JellyfinApi.CreatePlaylistDto();
      //expect(instance).to.be.a(JellyfinApi.CreatePlaylistDto);
    });
