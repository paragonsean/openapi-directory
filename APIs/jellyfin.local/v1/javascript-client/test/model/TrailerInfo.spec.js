...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.TrailerInfo();
  });
  ...
  describe('TrailerInfo', function() {
    it('should create an instance of TrailerInfo', function() {
      // uncomment below and update the code to test TrailerInfo
      //var instance = new JellyfinApi.TrailerInfo();
      //expect(instance).to.be.a(JellyfinApi.TrailerInfo);
    });
