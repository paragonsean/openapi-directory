...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.BoxSetInfo();
  });
  ...
  describe('BoxSetInfo', function() {
    it('should create an instance of BoxSetInfo', function() {
      // uncomment below and update the code to test BoxSetInfo
      //var instance = new JellyfinApi.BoxSetInfo();
      //expect(instance).to.be.a(JellyfinApi.BoxSetInfo);
    });
