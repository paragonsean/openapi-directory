...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.BaseItemDtoQueryResult();
  });
  ...
  describe('BaseItemDtoQueryResult', function() {
    it('should create an instance of BaseItemDtoQueryResult', function() {
      // uncomment below and update the code to test BaseItemDtoQueryResult
      //var instance = new JellyfinApi.BaseItemDtoQueryResult();
      //expect(instance).to.be.a(JellyfinApi.BaseItemDtoQueryResult);
    });
