...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.NotificationResultDto();
  });
  ...
  describe('NotificationResultDto', function() {
    it('should create an instance of NotificationResultDto', function() {
      // uncomment below and update the code to test NotificationResultDto
      //var instance = new JellyfinApi.NotificationResultDto();
      //expect(instance).to.be.a(JellyfinApi.NotificationResultDto);
    });
