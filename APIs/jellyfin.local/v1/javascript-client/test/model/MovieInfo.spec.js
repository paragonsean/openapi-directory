...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.MovieInfo();
  });
  ...
  describe('MovieInfo', function() {
    it('should create an instance of MovieInfo', function() {
      // uncomment below and update the code to test MovieInfo
      //var instance = new JellyfinApi.MovieInfo();
      //expect(instance).to.be.a(JellyfinApi.MovieInfo);
    });
