...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.BaseItemPersonImageBlurHashes();
  });
  ...
  describe('BaseItemPersonImageBlurHashes', function() {
    it('should create an instance of BaseItemPersonImageBlurHashes', function() {
      // uncomment below and update the code to test BaseItemPersonImageBlurHashes
      //var instance = new JellyfinApi.BaseItemPersonImageBlurHashes();
      //expect(instance).to.be.a(JellyfinApi.BaseItemPersonImageBlurHashes);
    });
