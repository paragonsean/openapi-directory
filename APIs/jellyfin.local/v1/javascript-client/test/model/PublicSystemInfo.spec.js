...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.PublicSystemInfo();
  });
  ...
  describe('PublicSystemInfo', function() {
    it('should create an instance of PublicSystemInfo', function() {
      // uncomment below and update the code to test PublicSystemInfo
      //var instance = new JellyfinApi.PublicSystemInfo();
      //expect(instance).to.be.a(JellyfinApi.PublicSystemInfo);
    });
