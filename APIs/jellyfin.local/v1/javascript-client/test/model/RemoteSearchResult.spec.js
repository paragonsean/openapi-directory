...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.RemoteSearchResult();
  });
  ...
  describe('RemoteSearchResult', function() {
    it('should create an instance of RemoteSearchResult', function() {
      // uncomment below and update the code to test RemoteSearchResult
      //var instance = new JellyfinApi.RemoteSearchResult();
      //expect(instance).to.be.a(JellyfinApi.RemoteSearchResult);
    });
