...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.AccessSchedule();
  });
  ...
  describe('AccessSchedule', function() {
    it('should create an instance of AccessSchedule', function() {
      // uncomment below and update the code to test AccessSchedule
      //var instance = new JellyfinApi.AccessSchedule();
      //expect(instance).to.be.a(JellyfinApi.AccessSchedule);
    });
