...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.ProfileCondition();
  });
  ...
  describe('ProfileCondition', function() {
    it('should create an instance of ProfileCondition', function() {
      // uncomment below and update the code to test ProfileCondition
      //var instance = new JellyfinApi.ProfileCondition();
      //expect(instance).to.be.a(JellyfinApi.ProfileCondition);
    });
