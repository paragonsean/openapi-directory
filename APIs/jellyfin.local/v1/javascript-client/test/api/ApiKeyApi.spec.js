...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.ApiKeyApi();
  });
  ...
  describe('ApiKeyApi', function() {
    ...
    describe('revokeKey', function() {
      it('should call revokeKey successfully', function(done) {
        //uncomment below and update the code to test revokeKey
        //instance.revokeKey(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
