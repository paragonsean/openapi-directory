...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JellyfinApi.GenresApi();
  });
  ...
  describe('GenresApi', function() {
    describe('getGenre', function() {
      it('should call getGenre successfully', function(done) {
        //uncomment below and update the code to test getGenre
        //instance.getGenre(function(error) {
