...
public class CardDataPutandPatch {
  ...
  public CardDataPutandPatch() {
  }

  public CardDataPutandPatch addressCity(String addressCity) {
  ...
  public CardDataPutandPatch addressCountry(String addressCountry) {
  ...
  public CardDataPutandPatch addressLine1(String addressLine1) {
  ...
  public CardDataPutandPatch addressLine2(String addressLine2) {
  ...
  public CardDataPutandPatch addressState(String addressState) {
  ...
  public CardDataPutandPatch addressZip(String addressZip) {
  ...
  public CardDataPutandPatch expMonth(Integer expMonth) {
  ...
  public CardDataPutandPatch expYear(Integer expYear) {
  ...
  public CardDataPutandPatch name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CardDataPutandPatch cardDataPutandPatch = (CardDataPutandPatch) o;
    return Objects.equals(this.addressCity, cardDataPutandPatch.addressCity) &&
        Objects.equals(this.addressCountry, cardDataPutandPatch.addressCountry) &&
        Objects.equals(this.addressLine1, cardDataPutandPatch.addressLine1) &&
        Objects.equals(this.addressLine2, cardDataPutandPatch.addressLine2) &&
        Objects.equals(this.addressState, cardDataPutandPatch.addressState) &&
        Objects.equals(this.addressZip, cardDataPutandPatch.addressZip) &&
        Objects.equals(this.expMonth, cardDataPutandPatch.expMonth) &&
        Objects.equals(this.expYear, cardDataPutandPatch.expYear) &&
        Objects.equals(this.name, cardDataPutandPatch.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressCity, addressCountry, addressLine1, addressLine2, addressState, addressZip, expMonth, expYear, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CardDataPutandPatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardDataPutandPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardDataPutandPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardDataPutandPatch is not found in the empty JSON string", CardDataPutandPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardDataPutandPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardDataPutandPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardDataPutandPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardDataPutandPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardDataPutandPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardDataPutandPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<CardDataPutandPatch>() {
           @Override
           public void write(JsonWriter out, CardDataPutandPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CardDataPutandPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CardDataPutandPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CardDataPutandPatch
   * @throws IOException if the JSON string is invalid with respect to CardDataPutandPatch
   */
  public static CardDataPutandPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardDataPutandPatch.class);
  }

  /**
   * Convert an instance of CardDataPutandPatch to an JSON string
   *
   * @return JSON string
   */
