...
public class GroupError {
  ...
  public GroupError description(List<String> description) {
    this.description = description;
    return this;
  }

  public GroupError addDescriptionItem(String descriptionItem) {
  ...
  public GroupError id(List<String> id) {
    this.id = id;
    return this;
  }

  public GroupError addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public GroupError name(List<String> name) {
    this.name = name;
    return this;
  }

  public GroupError addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public GroupError nonFieldErrors(List<String> nonFieldErrors) {
    this.nonFieldErrors = nonFieldErrors;
    return this;
  }

  public GroupError addNonFieldErrorsItem(String nonFieldErrorsItem) {
  ...
  public GroupError parent(List<String> parent) {
    this.parent = parent;
    return this;
  }

  public GroupError addParentItem(String parentItem) {
    if (this.parent == null) {
  ...
  public GroupError _private(List<String> _private) {
    this._private = _private;
    return this;
  }

  public GroupError addPrivateItem(String _privateItem) {
  ...
  public boolean equals(Object o) {
    ...
    GroupError groupError = (GroupError) o;
    return Objects.equals(this.description, groupError.description) &&
        Objects.equals(this.id, groupError.id) &&
        Objects.equals(this.name, groupError.name) &&
        Objects.equals(this.nonFieldErrors, groupError.nonFieldErrors) &&
        Objects.equals(this.parent, groupError.parent) &&
        Objects.equals(this._private, groupError._private);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, nonFieldErrors, parent, _private);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupError is not found in the empty JSON string", GroupError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupError.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupError>() {
           @Override
           public void write(JsonWriter out, GroupError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupError
   * @throws IOException if the JSON string is invalid with respect to GroupError
   */
  public static GroupError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupError.class);
  }

  /**
   * Convert an instance of GroupError to an JSON string
   *
   * @return JSON string
   */
