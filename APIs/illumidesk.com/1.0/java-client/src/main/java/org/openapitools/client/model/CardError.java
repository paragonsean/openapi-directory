...
public class CardError {
  ...
  public CardError addressCity(List<String> addressCity) {
    this.addressCity = addressCity;
    return this;
  }

  public CardError addAddressCityItem(String addressCityItem) {
  ...
  public CardError addressCountry(List<String> addressCountry) {
    this.addressCountry = addressCountry;
    return this;
  }

  public CardError addAddressCountryItem(String addressCountryItem) {
  ...
  public CardError addressLine1(List<String> addressLine1) {
    this.addressLine1 = addressLine1;
    return this;
  }

  public CardError addAddressLine1Item(String addressLine1Item) {
  ...
  public CardError addressLine1Check(List<String> addressLine1Check) {
    this.addressLine1Check = addressLine1Check;
    return this;
  }

  public CardError addAddressLine1CheckItem(String addressLine1CheckItem) {
  ...
  public CardError addressLine2(List<String> addressLine2) {
    this.addressLine2 = addressLine2;
    return this;
  }

  public CardError addAddressLine2Item(String addressLine2Item) {
  ...
  public CardError addressState(List<String> addressState) {
    this.addressState = addressState;
    return this;
  }

  public CardError addAddressStateItem(String addressStateItem) {
  ...
  public CardError addressZip(List<String> addressZip) {
    this.addressZip = addressZip;
    return this;
  }

  public CardError addAddressZipItem(String addressZipItem) {
  ...
  public CardError addressZipCheck(List<String> addressZipCheck) {
    this.addressZipCheck = addressZipCheck;
    return this;
  }

  public CardError addAddressZipCheckItem(String addressZipCheckItem) {
  ...
  public CardError brand(List<String> brand) {
    this.brand = brand;
    return this;
  }

  public CardError addBrandItem(String brandItem) {
    if (this.brand == null) {
  ...
  public CardError created(List<String> created) {
    this.created = created;
    return this;
  }

  public CardError addCreatedItem(String createdItem) {
  ...
  public CardError customer(List<String> customer) {
    this.customer = customer;
    return this;
  }

  public CardError addCustomerItem(String customerItem) {
  ...
  public CardError cvcCheck(List<String> cvcCheck) {
    this.cvcCheck = cvcCheck;
    return this;
  }

  public CardError addCvcCheckItem(String cvcCheckItem) {
  ...
  public CardError expMonth(List<String> expMonth) {
    this.expMonth = expMonth;
    return this;
  }

  public CardError addExpMonthItem(String expMonthItem) {
  ...
  public CardError expYear(List<String> expYear) {
    this.expYear = expYear;
    return this;
  }

  public CardError addExpYearItem(String expYearItem) {
  ...
  public CardError fingerprint(List<String> fingerprint) {
    this.fingerprint = fingerprint;
    return this;
  }

  public CardError addFingerprintItem(String fingerprintItem) {
  ...
  public CardError funding(List<String> funding) {
    this.funding = funding;
    return this;
  }

  public CardError addFundingItem(String fundingItem) {
  ...
  public CardError id(List<String> id) {
    this.id = id;
    return this;
  }

  public CardError addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public CardError last4(List<String> last4) {
    this.last4 = last4;
    return this;
  }

  public CardError addLast4Item(String last4Item) {
    if (this.last4 == null) {
  ...
  public CardError name(List<String> name) {
    this.name = name;
    return this;
  }

  public CardError addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public CardError nonFieldErrors(List<String> nonFieldErrors) {
    this.nonFieldErrors = nonFieldErrors;
    return this;
  }

  public CardError addNonFieldErrorsItem(String nonFieldErrorsItem) {
  ...
  public CardError stripeId(List<String> stripeId) {
    this.stripeId = stripeId;
    return this;
  }

  public CardError addStripeIdItem(String stripeIdItem) {
  ...
  public CardError token(List<String> token) {
    this.token = token;
    return this;
  }

  public CardError addTokenItem(String tokenItem) {
    if (this.token == null) {
  ...
  public boolean equals(Object o) {
    ...
    CardError cardError = (CardError) o;
    return Objects.equals(this.addressCity, cardError.addressCity) &&
        Objects.equals(this.addressCountry, cardError.addressCountry) &&
        Objects.equals(this.addressLine1, cardError.addressLine1) &&
        Objects.equals(this.addressLine1Check, cardError.addressLine1Check) &&
        Objects.equals(this.addressLine2, cardError.addressLine2) &&
        Objects.equals(this.addressState, cardError.addressState) &&
        Objects.equals(this.addressZip, cardError.addressZip) &&
        Objects.equals(this.addressZipCheck, cardError.addressZipCheck) &&
        Objects.equals(this.brand, cardError.brand) &&
        Objects.equals(this.created, cardError.created) &&
        Objects.equals(this.customer, cardError.customer) &&
        Objects.equals(this.cvcCheck, cardError.cvcCheck) &&
        Objects.equals(this.expMonth, cardError.expMonth) &&
        Objects.equals(this.expYear, cardError.expYear) &&
        Objects.equals(this.fingerprint, cardError.fingerprint) &&
        Objects.equals(this.funding, cardError.funding) &&
        Objects.equals(this.id, cardError.id) &&
        Objects.equals(this.last4, cardError.last4) &&
        Objects.equals(this.name, cardError.name) &&
        Objects.equals(this.nonFieldErrors, cardError.nonFieldErrors) &&
        Objects.equals(this.stripeId, cardError.stripeId) &&
        Objects.equals(this.token, cardError.token);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardError is not found in the empty JSON string", CardError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardError.class));

       return (TypeAdapter<T>) new TypeAdapter<CardError>() {
           @Override
           public void write(JsonWriter out, CardError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CardError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CardError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CardError
   * @throws IOException if the JSON string is invalid with respect to CardError
   */
  public static CardError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardError.class);
  }

  /**
   * Convert an instance of CardError to an JSON string
   *
   * @return JSON string
   */
