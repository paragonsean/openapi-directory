...
|**connected** | **List&lt;String&gt;** | Array that represents what other servers the server is connected to. |  [optional] |
...
|**status** | [**StatusEnum**](#StatusEnum) | Server status, such as Running or Error. |  [optional] |
