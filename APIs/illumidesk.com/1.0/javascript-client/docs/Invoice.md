...
------------ | ------------- | ------------- | -------------
**amountDue** | **Number** | Amount due set in invoice. | 
**applicationFee** | **Number** | Application fee set in invoice. | [optional] 
**attemptCount** | **Number** | Number of attempts to deliver invoice. | [optional] 
...
**startingBalance** | **Number** | Invoice starting balance. | 
...
**subtotal** | **Number** | Invoice sub total. | 
**tax** | **Number** | Tax, if applicable. | [optional] 
