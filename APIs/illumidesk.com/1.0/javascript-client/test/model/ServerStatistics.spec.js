...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.ServerStatistics();
  });
  ...
  describe('ServerStatistics', function() {
    it('should create an instance of ServerStatistics', function() {
      // uncomment below and update the code to test ServerStatistics
      //var instance = new IllumiDesk.ServerStatistics();
      //expect(instance).to.be.a(IllumiDesk.ServerStatistics);
    });
