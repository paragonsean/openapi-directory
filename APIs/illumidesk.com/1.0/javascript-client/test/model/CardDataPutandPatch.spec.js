...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.CardDataPutandPatch();
  });
  ...
  describe('CardDataPutandPatch', function() {
    it('should create an instance of CardDataPutandPatch', function() {
      // uncomment below and update the code to test CardDataPutandPatch
      //var instance = new IllumiDesk.CardDataPutandPatch();
      //expect(instance).to.be.a(IllumiDesk.CardDataPutandPatch);
    });
