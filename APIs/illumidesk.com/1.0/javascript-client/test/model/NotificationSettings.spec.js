...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.NotificationSettings();
  });
  ...
  describe('NotificationSettings', function() {
    it('should create an instance of NotificationSettings', function() {
      ...
      //var instance = new IllumiDesk.NotificationSettings();
      //expect(instance).to.be.a(IllumiDesk.NotificationSettings);
    });
    ...
    it('should have the property emailsEnabled (base name: "emails_enabled")', function() {
      // uncomment below and update the code to test the property emailsEnabled
      //var instance = new IllumiDesk.NotificationSettings();
      //expect(instance).to.be();
    });
