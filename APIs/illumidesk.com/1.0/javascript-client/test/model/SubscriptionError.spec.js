...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.SubscriptionError();
  });
  ...
  describe('SubscriptionError', function() {
    it('should create an instance of SubscriptionError', function() {
      // uncomment below and update the code to test SubscriptionError
      //var instance = new IllumiDesk.SubscriptionError();
      //expect(instance).to.be.a(IllumiDesk.SubscriptionError);
    });
