...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.DeploymentData();
  });
  ...
  describe('DeploymentData', function() {
    it('should create an instance of DeploymentData', function() {
      // uncomment below and update the code to test DeploymentData
      //var instance = new IllumiDesk.DeploymentData();
      //expect(instance).to.be.a(IllumiDesk.DeploymentData);
    });
