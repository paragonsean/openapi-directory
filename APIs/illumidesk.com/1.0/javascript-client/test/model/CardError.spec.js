...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.CardError();
  });
  ...
  describe('CardError', function() {
    it('should create an instance of CardError', function() {
      // uncomment below and update the code to test CardError
      //var instance = new IllumiDesk.CardError();
      //expect(instance).to.be.a(IllumiDesk.CardError);
    });
