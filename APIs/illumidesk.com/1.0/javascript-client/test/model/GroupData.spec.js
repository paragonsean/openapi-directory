...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.GroupData();
  });
  ...
  describe('GroupData', function() {
    it('should create an instance of GroupData', function() {
      // uncomment below and update the code to test GroupData
      //var instance = new IllumiDesk.GroupData();
      //expect(instance).to.be.a(IllumiDesk.GroupData);
    });
