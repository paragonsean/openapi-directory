...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.ServerAction();
  });
  ...
  describe('ServerAction', function() {
    it('should create an instance of ServerAction', function() {
      // uncomment below and update the code to test ServerAction
      //var instance = new IllumiDesk.ServerAction();
      //expect(instance).to.be.a(IllumiDesk.ServerAction);
    });
