...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IllumiDesk.ServerActionData();
  });
  ...
  describe('ServerActionData', function() {
    it('should create an instance of ServerActionData', function() {
      // uncomment below and update the code to test ServerActionData
      //var instance = new IllumiDesk.ServerActionData();
      //expect(instance).to.be.a(IllumiDesk.ServerActionData);
    });
