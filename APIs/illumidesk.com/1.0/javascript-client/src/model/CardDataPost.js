...
/**
 * The CardDataPost model module.
 * @module model/CardDataPost
 * @version 1.0
 */
class CardDataPost {
    /**
     * Constructs a new <code>CardDataPost</code>.
     * @alias module:model/CardDataPost
     */
    constructor() { 
        
        CardDataPost.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CardDataPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CardDataPost} obj Optional instance to populate.
     * @return {module:model/CardDataPost} The populated <code>CardDataPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CardDataPost();
    ...
    /**
     * Validates the JSON data with respect to <code>CardDataPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CardDataPost</code>.
     */
 ...
 */
CardDataPost.prototype['address_city'] = undefined;

/**
 * Address country.
 * @member {String} address_country
 */
CardDataPost.prototype['address_country'] = undefined;

/**
 * Address line 1.
 * @member {String} address_line1
 */
CardDataPost.prototype['address_line1'] = undefined;

/**
 * Address line 2.
 * @member {String} address_line2
 */
CardDataPost.prototype['address_line2'] = undefined;

/**
 * Address state.
 * @member {String} address_state
 */
CardDataPost.prototype['address_state'] = undefined;

/**
 * Address zip code.
 * @member {String} address_zip
 */
CardDataPost.prototype['address_zip'] = undefined;

/**
 * Card expiration month.
 * @member {Number} exp_month
 */
CardDataPost.prototype['exp_month'] = undefined;

/**
 * Card expiration year.
 * @member {Number} exp_year
 */
CardDataPost.prototype['exp_year'] = undefined;

/**
 * Card name.
 * @member {String} name
 */
CardDataPost.prototype['name'] = undefined;

/**
 * Card unique token.
 * @member {String} token
 */
CardDataPost.prototype['token'] = undefined;
