...
/**
 * The CardUpdateError model module.
 * @module model/CardUpdateError
 * @version 1.0
 */
class CardUpdateError {
    /**
     * Constructs a new <code>CardUpdateError</code>.
     * @alias module:model/CardUpdateError
     */
    constructor() { 
        
        CardUpdateError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CardUpdateError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CardUpdateError} obj Optional instance to populate.
     * @return {module:model/CardUpdateError} The populated <code>CardUpdateError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CardUpdateError();
    ...
    /**
     * Validates the JSON data with respect to <code>CardUpdateError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CardUpdateError</code>.
     */
 ...
 */
CardUpdateError.prototype['address_city'] = undefined;

/**
 * address_country field errors
 * @member {Array.<String>} address_country
 */
CardUpdateError.prototype['address_country'] = undefined;

/**
 * address_line1 field errors
 * @member {Array.<String>} address_line1
 */
CardUpdateError.prototype['address_line1'] = undefined;

/**
 * address_line1_check field errors
 * @member {Array.<String>} address_line1_check
 */
CardUpdateError.prototype['address_line1_check'] = undefined;

/**
 * address_line2 field errors
 * @member {Array.<String>} address_line2
 */
CardUpdateError.prototype['address_line2'] = undefined;

/**
 * address_state field errors
 * @member {Array.<String>} address_state
 */
CardUpdateError.prototype['address_state'] = undefined;

/**
 * address_zip field errors
 * @member {Array.<String>} address_zip
 */
CardUpdateError.prototype['address_zip'] = undefined;

/**
 * address_zip_check field errors
 * @member {Array.<String>} address_zip_check
 */
CardUpdateError.prototype['address_zip_check'] = undefined;

/**
 * brand field errors
 * @member {Array.<String>} brand
 */
CardUpdateError.prototype['brand'] = undefined;

/**
 * created field errors
 * @member {Array.<String>} created
 */
CardUpdateError.prototype['created'] = undefined;

/**
 * customer field errors
 * @member {Array.<String>} customer
 */
CardUpdateError.prototype['customer'] = undefined;

/**
 * cvc_check field errors
 * @member {Array.<String>} cvc_check
 */
CardUpdateError.prototype['cvc_check'] = undefined;

/**
 * exp_month field errors
 * @member {Array.<String>} exp_month
 */
CardUpdateError.prototype['exp_month'] = undefined;

/**
 * exp_year field errors
 * @member {Array.<String>} exp_year
 */
CardUpdateError.prototype['exp_year'] = undefined;

/**
 * fingerprint field errors
 * @member {Array.<String>} fingerprint
 */
CardUpdateError.prototype['fingerprint'] = undefined;

/**
 * funding field errors
 * @member {Array.<String>} funding
 */
CardUpdateError.prototype['funding'] = undefined;

/**
 * id field errors
 * @member {Array.<String>} id
 */
CardUpdateError.prototype['id'] = undefined;

/**
 * last4 field errors
 * @member {Array.<String>} last4
 */
CardUpdateError.prototype['last4'] = undefined;

/**
 * name field errors
 * @member {Array.<String>} name
 */
CardUpdateError.prototype['name'] = undefined;

/**
 * Errors not connected to any field
 * @member {Array.<String>} non_field_errors
 */
CardUpdateError.prototype['non_field_errors'] = undefined;

/**
 * stripe_id field errors
 * @member {Array.<String>} stripe_id
 */
CardUpdateError.prototype['stripe_id'] = undefined;

/**
 * token field errors
 * @member {Array.<String>} token
 */
CardUpdateError.prototype['token'] = undefined;
...
export default CardUpdateError;
