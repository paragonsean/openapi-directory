...
void OAISearchApi::search(const QString &r_namespace, const QString &q, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset) {
    QString fullPath = QString(_serverConfigs["search"][_serverIndices.value("search")].URL()+"/v1/{namespace}/search/");
