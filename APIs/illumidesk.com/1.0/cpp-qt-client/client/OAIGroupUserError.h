...
#ifndef OAIGroupUserError_H
#define OAIGroupUserError_H
...
class OAIGroupUserError : public OAIObject {
public:
    OAIGroupUserError();
    OAIGroupUserError(QString json);
    ~OAIGroupUserError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupUserError)

#endif // OAIGroupUserError_H
