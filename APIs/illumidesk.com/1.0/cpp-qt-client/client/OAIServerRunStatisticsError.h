...
/*
 * OAIServerRunStatisticsError.h
 *
 * 
 */

#ifndef OAIServerRunStatisticsError_H
#define OAIServerRunStatisticsError_H
...
class OAIServerRunStatisticsError : public OAIObject {
public:
    OAIServerRunStatisticsError();
    OAIServerRunStatisticsError(QString json);
    ~OAIServerRunStatisticsError() override;
    ...
    QList<QString> getExitCode() const;
    void setExitCode(const QList<QString> &exit_code);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerRunStatisticsError)

#endif // OAIServerRunStatisticsError_H
