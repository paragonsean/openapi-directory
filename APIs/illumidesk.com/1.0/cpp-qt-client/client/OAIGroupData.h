...
#ifndef OAIGroupData_H
#define OAIGroupData_H
...
class OAIGroupData : public OAIObject {
public:
    OAIGroupData();
    OAIGroupData(QString json);
    ~OAIGroupData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupData)

#endif // OAIGroupData_H
