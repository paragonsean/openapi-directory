...
/*
 * OAIRefreshJSONWebTokenError.h
 *
 * 
 */

#ifndef OAIRefreshJSONWebTokenError_H
#define OAIRefreshJSONWebTokenError_H
...
class OAIRefreshJSONWebTokenError : public OAIObject {
public:
    OAIRefreshJSONWebTokenError();
    OAIRefreshJSONWebTokenError(QString json);
    ~OAIRefreshJSONWebTokenError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshJSONWebTokenError)

#endif // OAIRefreshJSONWebTokenError_H
