...
/*
 * OAIServerStatisticsData.h
 *
 * 
 */

#ifndef OAIServerStatisticsData_H
#define OAIServerStatisticsData_H
...
class OAIServerStatisticsData : public OAIObject {
public:
    OAIServerStatisticsData();
    OAIServerStatisticsData(QString json);
    ~OAIServerStatisticsData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerStatisticsData)

#endif // OAIServerStatisticsData_H
