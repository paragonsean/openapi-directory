...
#ifndef OAIAuthTokenError_H
#define OAIAuthTokenError_H
...
class OAIAuthTokenError : public OAIObject {
public:
    OAIAuthTokenError();
    OAIAuthTokenError(QString json);
    ~OAIAuthTokenError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthTokenError)

#endif // OAIAuthTokenError_H
