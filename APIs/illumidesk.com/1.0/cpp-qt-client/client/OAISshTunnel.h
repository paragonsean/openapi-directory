...
#ifndef OAISshTunnel_H
#define OAISshTunnel_H
...
class OAISshTunnel : public OAIObject {
public:
    OAISshTunnel();
    OAISshTunnel(QString json);
    ~OAISshTunnel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISshTunnel)

#endif // OAISshTunnel_H
