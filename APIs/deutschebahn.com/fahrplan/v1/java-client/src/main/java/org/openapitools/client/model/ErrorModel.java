...
public class ErrorModel {
  ...
  public static final String SERIALIZED_NAME_INTERNAL_MESSAGE = "internal_message";
  ...
  public ErrorModel internalCode(Integer internalCode) {
  ...
  public ErrorModel internalMessage(String internalMessage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errorModel.code) &&
        Objects.equals(this.internalCode, errorModel.internalCode) &&
        Objects.equals(this.internalMessage, errorModel.internalMessage) &&
        Objects.equals(this.message, errorModel.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, internalCode, internalMessage, message);
  }
  ...
  static {
    ...
    openapiFields.add("internal_message");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("internal_message") != null && !jsonObj.get("internal_message").isJsonNull()) && !jsonObj.get("internal_message").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `internal_message` to be a primitive type in the JSON string but got `%s`", jsonObj.get("internal_message").toString()));
      }
