...
public class ApiClient {
    ...
    private String basePath = "https://api.deutschebahn.com/betriebsstellen/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.deutschebahn.com/betriebsstellen/v1
