...
/*
 * OAIFeatureCollection.h
 *
 * 
 */

#ifndef OAIFeatureCollection_H
#define OAIFeatureCollection_H
...
class OAIFeatureCollection : public OAIObject {
public:
    OAIFeatureCollection();
    OAIFeatureCollection(QString json);
    ~OAIFeatureCollection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeatureCollection)

#endif // OAIFeatureCollection_H
