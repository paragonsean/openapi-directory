...
#ifndef OAIProviderJO_H
#define OAIProviderJO_H
...
class OAIProviderJO : public OAIObject {
public:
    OAIProviderJO();
    OAIProviderJO(QString json);
    ~OAIProviderJO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProviderJO)

#endif // OAIProviderJO_H
