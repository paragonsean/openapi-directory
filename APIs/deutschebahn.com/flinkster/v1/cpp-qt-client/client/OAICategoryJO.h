...
#ifndef OAICategoryJO_H
#define OAICategoryJO_H
...
class OAICategoryJO : public OAIObject {
public:
    OAICategoryJO();
    OAICategoryJO(QString json);
    ~OAICategoryJO() override;
    ...
    QList<OAIPriceJO> getPrice() const;
    void setPrice(const QList<OAIPriceJO> &price);
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryJO)

#endif // OAICategoryJO_H
