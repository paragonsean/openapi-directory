...
OAIGeoJsonObject::OAIGeoJsonObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeoJsonObject::OAIGeoJsonObject() {
    this->initializeModel();
}

OAIGeoJsonObject::~OAIGeoJsonObject() {}

void OAIGeoJsonObject::initializeModel() {
...
void OAIGeoJsonObject::fromJson(QString jsonString) {
...
void OAIGeoJsonObject::fromJsonObject(QJsonObject json) {
...
QString OAIGeoJsonObject::asJson() const {
...
QJsonObject OAIGeoJsonObject::asJsonObject() const {
    QJsonObject obj;
    if (m_bbox.size() > 0) {
...
QList<double> OAIGeoJsonObject::getBbox() const {
    return m_bbox;
}
void OAIGeoJsonObject::setBbox(const QList<double> &bbox) {
    m_bbox = bbox;
    m_bbox_isSet = true;
}

bool OAIGeoJsonObject::is_bbox_Set() const{
    return m_bbox_isSet;
}

bool OAIGeoJsonObject::is_bbox_Valid() const{
    return m_bbox_isValid;
}

OAICrs OAIGeoJsonObject::getCrs() const {
    return m_crs;
}
void OAIGeoJsonObject::setCrs(const OAICrs &crs) {
    m_crs = crs;
    m_crs_isSet = true;
}

bool OAIGeoJsonObject::is_crs_Set() const{
    return m_crs_isSet;
}

bool OAIGeoJsonObject::is_crs_Valid() const{
    return m_crs_isValid;
}

bool OAIGeoJsonObject::isSet() const {
...
bool OAIGeoJsonObject::isValid() const {
