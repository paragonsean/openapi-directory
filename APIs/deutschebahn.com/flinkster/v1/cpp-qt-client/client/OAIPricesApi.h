...
public:
    ...
    */
    virtual void getPrices(const QString &providernetwork_uid);
...
Q_SIGNALS:
    ...
    void getPricesSignal(OAIRentalObjectJO summary);


    void getPricesSignalFull(OAIHttpRequestWorker *worker, OAIRentalObjectJO summary);

    Q_DECL_DEPRECATED_X("Use getPricesSignalError() instead")
    void getPricesSignalE(OAIRentalObjectJO summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getPricesSignalError(OAIRentalObjectJO summary, QNetworkReply::NetworkError error_type, const QString &error_str);
