...
QList<double> OAIPolygon::getBbox() const {
    return m_bbox;
}
void OAIPolygon::setBbox(const QList<double> &bbox) {
    m_bbox = bbox;
    m_bbox_isSet = true;
}

bool OAIPolygon::is_bbox_Set() const{
    return m_bbox_isSet;
}

bool OAIPolygon::is_bbox_Valid() const{
    return m_bbox_isValid;
}

OAICrs OAIPolygon::getCrs() const {
    return m_crs;
}
void OAIPolygon::setCrs(const OAICrs &crs) {
    m_crs = crs;
    m_crs_isSet = true;
}

bool OAIPolygon::is_crs_Set() const{
    return m_crs_isSet;
}

bool OAIPolygon::is_crs_Valid() const{
    return m_crs_isValid;
}

QList<QList<OAILngLatAlt>> OAIPolygon::getCoordinates() const {
    return m_coordinates;
}
void OAIPolygon::setCoordinates(const QList<QList<OAILngLatAlt>> &coordinates) {
