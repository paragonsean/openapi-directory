...
/*
 * OAIMultiLineString.h
 *
 * 
 */

#ifndef OAIMultiLineString_H
#define OAIMultiLineString_H
...
class OAIMultiLineString : public OAIObject {
public:
    OAIMultiLineString();
    OAIMultiLineString(QString json);
    ~OAIMultiLineString() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiLineString)

#endif // OAIMultiLineString_H
