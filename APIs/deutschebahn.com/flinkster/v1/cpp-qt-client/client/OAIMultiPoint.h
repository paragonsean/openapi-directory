...
#ifndef OAIMultiPoint_H
#define OAIMultiPoint_H
...
class OAIMultiPoint : public OAIObject {
public:
    OAIMultiPoint();
    OAIMultiPoint(QString json);
    ~OAIMultiPoint() override;
    ...
    QList<OAILngLatAlt> getCoordinates() const;
    void setCoordinates(const QList<OAILngLatAlt> &coordinates);
...
private:
    ...
    QList<OAILngLatAlt> m_coordinates;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiPoint)

#endif // OAIMultiPoint_H
