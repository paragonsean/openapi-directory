...
#include "OAIFeatureCollection.h"
...
OAIFeatureCollection::OAIFeatureCollection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFeatureCollection::OAIFeatureCollection() {
    this->initializeModel();
}

OAIFeatureCollection::~OAIFeatureCollection() {}

void OAIFeatureCollection::initializeModel() {
...
void OAIFeatureCollection::fromJson(QString jsonString) {
...
void OAIFeatureCollection::fromJsonObject(QJsonObject json) {
...
QString OAIFeatureCollection::asJson() const {
...
QJsonObject OAIFeatureCollection::asJsonObject() const {
    QJsonObject obj;
    if (m_bbox.size() > 0) {
...
QList<double> OAIFeatureCollection::getBbox() const {
    return m_bbox;
}
void OAIFeatureCollection::setBbox(const QList<double> &bbox) {
    m_bbox = bbox;
    m_bbox_isSet = true;
}

bool OAIFeatureCollection::is_bbox_Set() const{
    return m_bbox_isSet;
}

bool OAIFeatureCollection::is_bbox_Valid() const{
    return m_bbox_isValid;
}

OAICrs OAIFeatureCollection::getCrs() const {
    return m_crs;
}
void OAIFeatureCollection::setCrs(const OAICrs &crs) {
    m_crs = crs;
    m_crs_isSet = true;
}

bool OAIFeatureCollection::is_crs_Set() const{
    return m_crs_isSet;
}

bool OAIFeatureCollection::is_crs_Valid() const{
    return m_crs_isValid;
}

QList<OAIFeature> OAIFeatureCollection::getFeatures() const {
    return m_features;
}
void OAIFeatureCollection::setFeatures(const QList<OAIFeature> &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIFeatureCollection::is_features_Set() const{
    return m_features_isSet;
}

bool OAIFeatureCollection::is_features_Valid() const{
    return m_features_isValid;
}

bool OAIFeatureCollection::isSet() const {
...
bool OAIFeatureCollection::isValid() const {
