...
void OAIPricesApi::getPrices(const QString &providernetwork_uid) {
    QString fullPath = QString(_serverConfigs["getPrices"][_serverIndices.value("getPrices")].URL()+"/providernetworks/{providernetworkUID}/prices");
