...
#ifndef OAIGeoJsonObject_H
#define OAIGeoJsonObject_H
...
class OAIGeoJsonObject : public OAIObject {
public:
    OAIGeoJsonObject();
    OAIGeoJsonObject(QString json);
    ~OAIGeoJsonObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoJsonObject)

#endif // OAIGeoJsonObject_H
