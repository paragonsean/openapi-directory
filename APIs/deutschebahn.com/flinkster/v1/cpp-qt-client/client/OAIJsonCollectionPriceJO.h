...
/*
 * OAIJsonCollectionPriceJO.h
 *
 * 
 */

#ifndef OAIJsonCollectionPriceJO_H
#define OAIJsonCollectionPriceJO_H
...
class OAIJsonCollectionPriceJO : public OAIObject {
public:
    OAIJsonCollectionPriceJO();
    OAIJsonCollectionPriceJO(QString json);
    ~OAIJsonCollectionPriceJO() override;
    ...
    QList<OAIPriceJO> getItems() const;
    void setItems(const QList<OAIPriceJO> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJsonCollectionPriceJO)

#endif // OAIJsonCollectionPriceJO_H
