...
#ifndef OAI_OAIIndexApi_H
#define OAI_OAIIndexApi_H
...
class OAIIndexApi : public QObject {
    Q_OBJECT

public:
    OAIIndexApi(const int timeOut = 0);
    ~OAIIndexApi();
...
Q_SIGNALS:
    ...
    void getIndexSignal(OAIJsonCollection summary);


    void getIndexSignalFull(OAIHttpRequestWorker *worker, OAIJsonCollection summary);

    Q_DECL_DEPRECATED_X("Use getIndexSignalError() instead")
    void getIndexSignalE(OAIJsonCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getIndexSignalError(OAIJsonCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
