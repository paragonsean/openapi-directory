...
/**
 * The GeoJsonObject model module.
 * @module model/GeoJsonObject
 * @version v1
 */
class GeoJsonObject {
    /**
     * Constructs a new <code>GeoJsonObject</code>.
     * @alias module:model/GeoJsonObject
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>GeoJsonObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoJsonObject} obj Optional instance to populate.
     * @return {module:model/GeoJsonObject} The populated <code>GeoJsonObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoJsonObject();
    ...
    /**
     * Validates the JSON data with respect to <code>GeoJsonObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeoJsonObject</code>.
     */
