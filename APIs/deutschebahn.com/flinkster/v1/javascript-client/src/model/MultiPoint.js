...
class MultiPoint {
    ...
    /**
     * Validates the JSON data with respect to <code>MultiPoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultiPoint</code>.
     */
...
/**
 * @member {Array.<module:model/LngLatAlt>} coordinates
 */
