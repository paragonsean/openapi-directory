...
/**
 * The CategoryJO model module.
 * @module model/CategoryJO
 * @version v1
 */
class CategoryJO {
    /**
     * Constructs a new <code>CategoryJO</code>.
     * @alias module:model/CategoryJO
     */
    constructor() { 
        
        CategoryJO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryJO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryJO} obj Optional instance to populate.
     * @return {module:model/CategoryJO} The populated <code>CategoryJO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryJO();
            ...
            if (data.hasOwnProperty('price')) {
                obj['price'] = ApiClient.convertToType(data['price'], [PriceJO]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CategoryJO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoryJO</code>.
     */
 ...
 */
CategoryJO.prototype['_links'] = undefined;

/**
 * @member {Object.<String, Object>} attributes
 */
CategoryJO.prototype['attributes'] = undefined;

/**
 * @member {String} description
 */
CategoryJO.prototype['description'] = undefined;

/**
 * @member {String} expand
 */
CategoryJO.prototype['expand'] = undefined;

/**
 * @member {String} href
 */
CategoryJO.prototype['href'] = undefined;

/**
 * @member {String} name
 */
CategoryJO.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/PriceJO>} price
 */
CategoryJO.prototype['price'] = undefined;

/**
 * @member {String} uid
 */
CategoryJO.prototype['uid'] = undefined;
