...
/**
 * The JsonCollection model module.
 * @module model/JsonCollection
 * @version v1
 */
class JsonCollection {
    /**
     * Constructs a new <code>JsonCollection</code>.
     * @alias module:model/JsonCollection
     */
    constructor() { 
        
        JsonCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCollection} obj Optional instance to populate.
     * @return {module:model/JsonCollection} The populated <code>JsonCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCollection();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [JsonObject]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCollection</code>.
     */
 ...
 */
JsonCollection.prototype['_links'] = undefined;

/**
 * @member {String} href
 */
JsonCollection.prototype['href'] = undefined;

/**
 * @member {Array.<module:model/JsonObject>} items
 */
JsonCollection.prototype['items'] = undefined;

/**
 * @member {Number} limit
 */
JsonCollection.prototype['limit'] = undefined;

/**
 * @member {Number} offset
 */
JsonCollection.prototype['offset'] = undefined;

/**
 * @member {Number} size
 */
JsonCollection.prototype['size'] = undefined;
