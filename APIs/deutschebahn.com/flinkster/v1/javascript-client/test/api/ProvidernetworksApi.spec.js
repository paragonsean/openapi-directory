...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.ProvidernetworksApi();
  });
  ...
  describe('ProvidernetworksApi', function() {
    describe('getProviderNetwork', function() {
      it('should call getProviderNetwork successfully', function(done) {
        //uncomment below and update the code to test getProviderNetwork
        //instance.getProviderNetwork(function(error) {
