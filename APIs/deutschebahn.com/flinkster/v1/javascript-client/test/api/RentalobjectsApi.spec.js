...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.RentalobjectsApi();
  });
  ...
  describe('RentalobjectsApi', function() {
    describe('getRentalObject', function() {
      it('should call getRentalObject successfully', function(done) {
        //uncomment below and update the code to test getRentalObject
        //instance.getRentalObject(function(error) {
