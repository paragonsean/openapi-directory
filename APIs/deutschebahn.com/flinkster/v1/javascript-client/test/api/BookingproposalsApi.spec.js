...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.BookingproposalsApi();
  });
  ...
  describe('BookingproposalsApi', function() {
    describe('listBookingProposals', function() {
      it('should call listBookingProposals successfully', function(done) {
        //uncomment below and update the code to test listBookingProposals
        //instance.listBookingProposals(function(error) {
