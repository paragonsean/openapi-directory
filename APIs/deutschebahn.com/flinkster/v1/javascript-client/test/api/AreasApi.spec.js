...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.AreasApi();
  });
  ...
  describe('AreasApi', function() {
    ...
    describe('listAreas', function() {
      it('should call listAreas successfully', function(done) {
        //uncomment below and update the code to test listAreas
        //instance.listAreas(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
