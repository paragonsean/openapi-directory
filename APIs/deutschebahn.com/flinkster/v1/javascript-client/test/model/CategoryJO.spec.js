...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.CategoryJO();
  });
  ...
  describe('CategoryJO', function() {
    it('should create an instance of CategoryJO', function() {
      // uncomment below and update the code to test CategoryJO
      //var instance = new FlinksterApiNg.CategoryJO();
      //expect(instance).to.be.a(FlinksterApiNg.CategoryJO);
    });
