...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.GeoJsonObject();
  });
  ...
  describe('GeoJsonObject', function() {
    it('should create an instance of GeoJsonObject', function() {
      // uncomment below and update the code to test GeoJsonObject
      //var instance = new FlinksterApiNg.GeoJsonObject();
      //expect(instance).to.be.a(FlinksterApiNg.GeoJsonObject);
    });
