...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.ErrorJO();
  });
  ...
  describe('ErrorJO', function() {
    it('should create an instance of ErrorJO', function() {
      // uncomment below and update the code to test ErrorJO
      //var instance = new FlinksterApiNg.ErrorJO();
      //expect(instance).to.be.a(FlinksterApiNg.ErrorJO);
    });
