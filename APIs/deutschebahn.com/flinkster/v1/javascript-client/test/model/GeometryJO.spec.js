...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.GeometryJO();
  });
  ...
  describe('GeometryJO', function() {
    it('should create an instance of GeometryJO', function() {
      // uncomment below and update the code to test GeometryJO
      //var instance = new FlinksterApiNg.GeometryJO();
      //expect(instance).to.be.a(FlinksterApiNg.GeometryJO);
    });
