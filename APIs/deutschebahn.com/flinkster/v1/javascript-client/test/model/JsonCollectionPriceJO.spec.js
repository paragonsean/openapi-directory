...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.JsonCollectionPriceJO();
  });
  ...
  describe('JsonCollectionPriceJO', function() {
    it('should create an instance of JsonCollectionPriceJO', function() {
      // uncomment below and update the code to test JsonCollectionPriceJO
      //var instance = new FlinksterApiNg.JsonCollectionPriceJO();
      //expect(instance).to.be.a(FlinksterApiNg.JsonCollectionPriceJO);
    });
