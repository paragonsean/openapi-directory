...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.MultiPolygon();
  });
  ...
  describe('MultiPolygon', function() {
    it('should create an instance of MultiPolygon', function() {
      // uncomment below and update the code to test MultiPolygon
      //var instance = new FlinksterApiNg.MultiPolygon();
      //expect(instance).to.be.a(FlinksterApiNg.MultiPolygon);
    });
