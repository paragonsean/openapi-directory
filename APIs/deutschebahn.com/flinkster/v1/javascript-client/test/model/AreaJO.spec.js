...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.AreaJO();
  });
  ...
  describe('AreaJO', function() {
    it('should create an instance of AreaJO', function() {
      // uncomment below and update the code to test AreaJO
      //var instance = new FlinksterApiNg.AreaJO();
      //expect(instance).to.be.a(FlinksterApiNg.AreaJO);
    });
    ...
    it('should have the property providerAreaId (base name: "providerAreaId")', function() {
      // uncomment below and update the code to test the property providerAreaId
      //var instance = new FlinksterApiNg.AreaJO();
      //expect(instance).to.be();
    });

    it('should have the property providerNetworkIds (base name: "providerNetworkIds")', function() {
      // uncomment below and update the code to test the property providerNetworkIds
      //var instance = new FlinksterApiNg.AreaJO();
      //expect(instance).to.be();
    });
