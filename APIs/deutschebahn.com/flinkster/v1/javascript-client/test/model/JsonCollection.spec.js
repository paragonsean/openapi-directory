...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.JsonCollection();
  });
  ...
  describe('JsonCollection', function() {
    it('should create an instance of JsonCollection', function() {
      // uncomment below and update the code to test JsonCollection
      //var instance = new FlinksterApiNg.JsonCollection();
      //expect(instance).to.be.a(FlinksterApiNg.JsonCollection);
    });
