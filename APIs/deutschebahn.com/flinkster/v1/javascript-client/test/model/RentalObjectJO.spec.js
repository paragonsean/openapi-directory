...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.RentalObjectJO();
  });
  ...
  describe('RentalObjectJO', function() {
    it('should create an instance of RentalObjectJO', function() {
      // uncomment below and update the code to test RentalObjectJO
      //var instance = new FlinksterApiNg.RentalObjectJO();
      //expect(instance).to.be.a(FlinksterApiNg.RentalObjectJO);
    });
    ...
    it('should have the property providerRentalObjectId (base name: "providerRentalObjectId")', function() {
      // uncomment below and update the code to test the property providerRentalObjectId
      //var instance = new FlinksterApiNg.RentalObjectJO();
      //expect(instance).to.be();
    });

    it('should have the property rentalModel (base name: "rentalModel")', function() {
      // uncomment below and update the code to test the property rentalModel
      //var instance = new FlinksterApiNg.RentalObjectJO();
      //expect(instance).to.be();
    });
