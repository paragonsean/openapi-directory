...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.MultiLineString();
  });
  ...
  describe('MultiLineString', function() {
    it('should create an instance of MultiLineString', function() {
      // uncomment below and update the code to test MultiLineString
      //var instance = new FlinksterApiNg.MultiLineString();
      //expect(instance).to.be.a(FlinksterApiNg.MultiLineString);
    });
