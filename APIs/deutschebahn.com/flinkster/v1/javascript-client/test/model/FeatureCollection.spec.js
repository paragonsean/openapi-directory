...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.FeatureCollection();
  });
  ...
  describe('FeatureCollection', function() {
    it('should create an instance of FeatureCollection', function() {
      ...
      //var instance = new FlinksterApiNg.FeatureCollection();
      //expect(instance).to.be.a(FlinksterApiNg.FeatureCollection);
    });
