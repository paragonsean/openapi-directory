...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.BookingProposalJO();
  });
  ...
  describe('BookingProposalJO', function() {
    it('should create an instance of BookingProposalJO', function() {
      // uncomment below and update the code to test BookingProposalJO
      //var instance = new FlinksterApiNg.BookingProposalJO();
      //expect(instance).to.be.a(FlinksterApiNg.BookingProposalJO);
    });
    ...
    it('should have the property rentalObject (base name: "rentalObject")', function() {
      // uncomment below and update the code to test the property rentalObject
      //var instance = new FlinksterApiNg.BookingProposalJO();
      //expect(instance).to.be();
    });
