...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.AddressJO();
  });
  ...
  describe('AddressJO', function() {
    it('should create an instance of AddressJO', function() {
      // uncomment below and update the code to test AddressJO
      //var instance = new FlinksterApiNg.AddressJO();
      //expect(instance).to.be.a(FlinksterApiNg.AddressJO);
    });
