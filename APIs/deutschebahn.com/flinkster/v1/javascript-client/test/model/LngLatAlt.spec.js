...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.LngLatAlt();
  });
  ...
  describe('LngLatAlt', function() {
    it('should create an instance of LngLatAlt', function() {
      // uncomment below and update the code to test LngLatAlt
      //var instance = new FlinksterApiNg.LngLatAlt();
      //expect(instance).to.be.a(FlinksterApiNg.LngLatAlt);
    });
