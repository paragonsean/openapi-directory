...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.Crs();
  });
  ...
  describe('Crs', function() {
    it('should create an instance of Crs', function() {
      // uncomment below and update the code to test Crs
      //var instance = new FlinksterApiNg.Crs();
      //expect(instance).to.be.a(FlinksterApiNg.Crs);
    });
