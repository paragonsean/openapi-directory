...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlinksterApiNg.LinkJO();
  });
  ...
  describe('LinkJO', function() {
    it('should create an instance of LinkJO', function() {
      // uncomment below and update the code to test LinkJO
      //var instance = new FlinksterApiNg.LinkJO();
      //expect(instance).to.be.a(FlinksterApiNg.LinkJO);
    });
