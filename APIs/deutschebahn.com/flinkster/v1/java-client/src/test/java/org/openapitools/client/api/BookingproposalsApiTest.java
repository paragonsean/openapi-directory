...
/**
 * API tests for BookingproposalsApi
 */
@Disabled
public class BookingproposalsApiTest {

    private final BookingproposalsApi api = new BookingproposalsApi();
     ...
     */
    @Test
    public void listBookingProposalsTest() throws ApiException {
        Double lat = null;
        Double lon = null;
        Integer radius = null;
        Integer offset = null;
        ...
        String expand = null;
        String view = null;
        RentalObjectJO response = api.listBookingProposals(lat, lon, radius, offset, limit, providernetwork, begin, end, expand, view);
