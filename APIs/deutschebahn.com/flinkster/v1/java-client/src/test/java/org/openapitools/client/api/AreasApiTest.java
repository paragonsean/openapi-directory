...
public class AreasApiTest {
     ...
     */
    @Test
    public void getAreaTest() throws ApiException {
        String areaUID = null;
        String expand = null;
        AreaJO response = api.getArea(areaUID, expand);
     ...
     */
    @Test
    public void listAreasTest() throws ApiException {
        Double lat = null;
        Double lon = null;
        Integer radius = null;
        Integer offset = null;
        ...
        AreaJO response = api.listAreas(lat, lon, radius, offset, limit, expand, type, provider, providernetwork);
        // TODO: test validations
    }
