...
/**
 * API tests for RentalobjectsApi
 */
@Disabled
public class RentalobjectsApiTest {

    private final RentalobjectsApi api = new RentalobjectsApi();
     ...
     */
    @Test
    public void getRentalObjectTest() throws ApiException {
        String rentalObjectUID = null;
        String providernetworkUID = null;
        String expand = null;
        RentalObjectJO response = api.getRentalObject(rentalObjectUID, providernetworkUID, expand);
