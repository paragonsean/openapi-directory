...
public class ProvidernetworksApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProvidernetworksApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ProvidernetworksApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getProviderNetwork
     * @param uid  (required)
     ...
     */
    public okhttp3.Call getProviderNetworkCall(String uid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providernetworks/{uid}"
    ...
    private okhttp3.Call getProviderNetworkValidateBeforeCall(String uid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'uid' is set
        if (uid == null) {
            throw new ApiException("Missing the required parameter 'uid' when calling getProviderNetwork(Async)");
        }

        return getProviderNetworkCall(uid, _callback);
     ...
     */
    public RentalObjectJO getProviderNetwork(String uid) throws ApiException {
        ApiResponse<RentalObjectJO> localVarResp = getProviderNetworkWithHttpInfo(uid);
     ...
     */
    public ApiResponse<RentalObjectJO> getProviderNetworkWithHttpInfo(String uid) throws ApiException {
        okhttp3.Call localVarCall = getProviderNetworkValidateBeforeCall(uid, null);
        Type localVarReturnType = new TypeToken<RentalObjectJO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get information about the ProviderNetworkResources. (asynchronously)
     * Get information about the ProviderNetworkResources. 
     * @param uid  (required)
     ...
     */
    public okhttp3.Call getProviderNetworkAsync(String uid, final ApiCallback<RentalObjectJO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProviderNetworkValidateBeforeCall(uid, _callback);
        Type localVarReturnType = new TypeToken<RentalObjectJO>(){}.getType();
