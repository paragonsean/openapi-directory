...
public class IndexApi {
     ...
     */
    public okhttp3.Call getIndexCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIndexValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getIndexCall(_callback);
     ...
     */
    public JsonCollection getIndex() throws ApiException {
        ApiResponse<JsonCollection> localVarResp = getIndexWithHttpInfo();
     ...
     * Show index.
     * Show Service index.
     * @return ApiResponse&lt;JsonCollection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<JsonCollection> getIndexWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getIndexValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<JsonCollection>(){}.getType();
     ...
     */
    public okhttp3.Call getIndexAsync(final ApiCallback<JsonCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIndexValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<JsonCollection>(){}.getType();
