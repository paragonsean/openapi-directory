...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.Regionalbereich();
  });
  ...
  describe('Regionalbereich', function() {
    it('should create an instance of Regionalbereich', function() {
      // uncomment below and update the code to test Regionalbereich
      //var instance = new Stationsdatenbereitstellung.Regionalbereich();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.Regionalbereich);
    });
