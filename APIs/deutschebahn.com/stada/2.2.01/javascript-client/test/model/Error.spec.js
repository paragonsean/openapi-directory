...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new Stationsdatenbereitstellung.Error();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.Error);
    });
