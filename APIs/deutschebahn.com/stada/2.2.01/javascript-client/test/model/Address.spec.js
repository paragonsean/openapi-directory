...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instance = new Stationsdatenbereitstellung.Address();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.Address);
    });
