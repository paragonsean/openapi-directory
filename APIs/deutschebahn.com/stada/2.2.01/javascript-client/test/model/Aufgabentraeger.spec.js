...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.Aufgabentraeger();
  });
  ...
  describe('Aufgabentraeger', function() {
    it('should create an instance of Aufgabentraeger', function() {
      // uncomment below and update the code to test Aufgabentraeger
      //var instance = new Stationsdatenbereitstellung.Aufgabentraeger();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.Aufgabentraeger);
    });
