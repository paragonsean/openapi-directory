...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.GeographicPoint();
  });
  ...
  describe('GeographicPoint', function() {
    it('should create an instance of GeographicPoint', function() {
      // uncomment below and update the code to test GeographicPoint
      //var instance = new Stationsdatenbereitstellung.GeographicPoint();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.GeographicPoint);
    });
