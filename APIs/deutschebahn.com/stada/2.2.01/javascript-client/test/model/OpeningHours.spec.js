...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Stationsdatenbereitstellung.OpeningHours();
  });
  ...
  describe('OpeningHours', function() {
    it('should create an instance of OpeningHours', function() {
      // uncomment below and update the code to test OpeningHours
      //var instance = new Stationsdatenbereitstellung.OpeningHours();
      //expect(instance).to.be.a(Stationsdatenbereitstellung.OpeningHours);
    });
