...
public class ApiClient {
    ...
    private String basePath = "https://api.deutschebahn.com/stada/v2";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.2.01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.deutschebahn.com/stada/v2
