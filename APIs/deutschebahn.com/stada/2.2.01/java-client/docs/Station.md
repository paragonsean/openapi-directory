...
|**category** | **Integer** | the stations category (-1...7). Stations with category -1 or 0 are not in production, e.g. planned, saled, without train stops. |  [optional] |
...
|**number** | **Integer** | unique identifier representing a specific railway station |  [optional] |
|**priceCategory** | **Integer** | determines in some respect the price for train stops at a specific station (1..7) |  [optional] |
