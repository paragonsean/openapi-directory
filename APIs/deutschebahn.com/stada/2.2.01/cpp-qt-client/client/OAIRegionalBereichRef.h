...
class OAIRegionalBereichRef : public OAIObject {
public:
    OAIRegionalBereichRef();
    OAIRegionalBereichRef(QString json);
    ~OAIRegionalBereichRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionalBereichRef)

#endif // OAIRegionalBereichRef_H
