...
#ifndef OAIStationQuery_H
#define OAIStationQuery_H
...
class OAIStationQuery : public OAIObject {
public:
    OAIStationQuery();
    OAIStationQuery(QString json);
    ~OAIStationQuery() override;
    ...
    QList<OAIStation> getResult() const;
    void setResult(const QList<OAIStation> &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStationQuery)

#endif // OAIStationQuery_H
