...
public class RateLimit {
  ...
  private List<RateLimitErrorsInner> errors = new ArrayList<>();

  public RateLimit() {
  }

  public RateLimit errors(List<RateLimitErrorsInner> errors) {
    this.errors = errors;
    return this;
  }

  public RateLimit addErrorsItem(RateLimitErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public List<RateLimitErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<RateLimitErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, rateLimit.errors);
  }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            RateLimitErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
