...
#ifndef OAI_OAIFetchAccountInfoApi_H
#define OAI_OAIFetchAccountInfoApi_H
...
class OAIFetchAccountInfoApi : public QObject {
    Q_OBJECT

public:
    OAIFetchAccountInfoApi(const int timeOut = 0);
    ~OAIFetchAccountInfoApi();
