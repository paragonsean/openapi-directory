...
OAI_account_get_200_response_data OAI_account_get_200_response::getData() const {
    return m_data;
}
void OAI_account_get_200_response::setData(const OAI_account_get_200_response_data &data) {
    m_data = data;
    m_data_isSet = true;
}
