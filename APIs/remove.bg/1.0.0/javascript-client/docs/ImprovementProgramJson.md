# BackgroundRemovalApi.ImprovementProgramJson
...
**imageFilename** | **String** | Filename of the image, if not provided it will be autodetected form the submitted data. | [optional] 
**imageUrl** | **String** | Source image URL. (If this parameter is present, the other image source parameters must be empty.) | [optional] 
**tag** | **String** | Images with the same tag are grouped together. | [optional] 
