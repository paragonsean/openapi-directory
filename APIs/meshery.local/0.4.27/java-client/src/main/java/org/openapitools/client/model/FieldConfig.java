...
import org.openapitools.client.model.FieldConfigDefaults;
...
public class FieldConfig {
  ...
  private FieldConfigDefaults defaults;

  public FieldConfig() {
  }

  public FieldConfig defaults(FieldConfigDefaults defaults) {
  ...
  public FieldConfigDefaults getDefaults() {
    return defaults;
  }

  public void setDefaults(FieldConfigDefaults defaults) {
    this.defaults = defaults;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaults, fieldConfig.defaults);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("defaults") != null && !jsonObj.get("defaults").isJsonNull()) {
        FieldConfigDefaults.validateJsonElement(jsonObj.get("defaults"));
      }
  }
