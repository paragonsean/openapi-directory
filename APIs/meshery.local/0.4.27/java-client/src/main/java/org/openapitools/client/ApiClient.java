...
public class ApiClient {
    ...
    private String basePath = "http://meshery.local";
    ...
    public ApiClient() {
        ...
        authentications.put("token", new ApiKeyAuth("cookie", "token"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.4.27/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://meshery.local
