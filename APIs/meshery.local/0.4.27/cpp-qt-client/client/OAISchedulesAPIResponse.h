...
/*
 * OAISchedulesAPIResponse.h
 *
 * API response model for SchedulesAPI
 */

#ifndef OAISchedulesAPIResponse_H
#define OAISchedulesAPIResponse_H
...
class OAISchedulesAPIResponse : public OAIObject {
public:
    OAISchedulesAPIResponse();
    OAISchedulesAPIResponse(QString json);
    ~OAISchedulesAPIResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedulesAPIResponse)

#endif // OAISchedulesAPIResponse_H
