...
/*
 * OAIVolumeListOKBody.h
 *
 * VolumeListOKBody Volume list response
 */

#ifndef OAIVolumeListOKBody_H
#define OAIVolumeListOKBody_H
...
class OAIVolumeListOKBody : public OAIObject {
public:
    OAIVolumeListOKBody();
    OAIVolumeListOKBody(QString json);
    ~OAIVolumeListOKBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolumeListOKBody)

#endif // OAIVolumeListOKBody_H
