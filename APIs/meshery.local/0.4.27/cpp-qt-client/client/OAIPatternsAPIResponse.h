...
/*
 * OAIPatternsAPIResponse.h
 *
 * PatternsAPIResponse response retruned by patternfile endpoint on meshery server
 */

#ifndef OAIPatternsAPIResponse_H
#define OAIPatternsAPIResponse_H
...
namespace OpenAPI {
class OAIMesheryPattern;

class OAIPatternsAPIResponse : public OAIObject {
public:
    OAIPatternsAPIResponse();
    OAIPatternsAPIResponse(QString json);
    ~OAIPatternsAPIResponse() override;
    ...
    QList<OAIMesheryPattern> getPatterns() const;
    void setPatterns(const QList<OAIMesheryPattern> &patterns);
...
private:
    ...
    QList<OAIMesheryPattern> m_patterns;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatternsAPIResponse)

#endif // OAIPatternsAPIResponse_H
