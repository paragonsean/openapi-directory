...
/*
 * OAIPerformanceResultsAPIResponse.h
 *
 * PerformanceResultsAPIResponse response retruned by performance endpoint on meshery server
 */

#ifndef OAIPerformanceResultsAPIResponse_H
#define OAIPerformanceResultsAPIResponse_H
...
namespace OpenAPI {
class OAIPerformanceResult;

class OAIPerformanceResultsAPIResponse : public OAIObject {
public:
    OAIPerformanceResultsAPIResponse();
    OAIPerformanceResultsAPIResponse(QString json);
    ~OAIPerformanceResultsAPIResponse() override;
    ...
    QList<OAIPerformanceResult> getResults() const;
    void setResults(const QList<OAIPerformanceResult> &results);
...
private:
    ...
    QList<OAIPerformanceResult> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPerformanceResultsAPIResponse)

#endif // OAIPerformanceResultsAPIResponse_H
