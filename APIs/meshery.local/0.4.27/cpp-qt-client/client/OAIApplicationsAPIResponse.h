...
/*
 * OAIApplicationsAPIResponse.h
 *
 * ApplicationsAPIResponse response retruned by patternfile endpoint on meshery server
 */

#ifndef OAIApplicationsAPIResponse_H
#define OAIApplicationsAPIResponse_H
...
namespace OpenAPI {
class OAIMesheryApplication;

class OAIApplicationsAPIResponse : public OAIObject {
public:
    OAIApplicationsAPIResponse();
    OAIApplicationsAPIResponse(QString json);
    ~OAIApplicationsAPIResponse() override;
    ...
    QList<OAIMesheryApplication> getApplications() const;
    void setApplications(const QList<OAIMesheryApplication> &applications);
...
private:
    ...
    QList<OAIMesheryApplication> m_applications;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationsAPIResponse)

#endif // OAIApplicationsAPIResponse_H
