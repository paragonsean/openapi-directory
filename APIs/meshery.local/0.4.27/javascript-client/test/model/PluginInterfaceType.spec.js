...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.PluginInterfaceType();
  });
  ...
  describe('PluginInterfaceType', function() {
    it('should create an instance of PluginInterfaceType', function() {
      // uncomment below and update the code to test PluginInterfaceType
      //var instance = new MesheryApi.PluginInterfaceType();
      //expect(instance).to.be.a(MesheryApi.PluginInterfaceType);
    });
