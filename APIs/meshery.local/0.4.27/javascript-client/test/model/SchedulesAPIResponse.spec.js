...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.SchedulesAPIResponse();
  });
  ...
  describe('SchedulesAPIResponse', function() {
    it('should create an instance of SchedulesAPIResponse', function() {
      // uncomment below and update the code to test SchedulesAPIResponse
      //var instance = new MesheryApi.SchedulesAPIResponse();
      //expect(instance).to.be.a(MesheryApi.SchedulesAPIResponse);
    });
