...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.FiltersAPIResponse();
  });
  ...
  describe('FiltersAPIResponse', function() {
    it('should create an instance of FiltersAPIResponse', function() {
      // uncomment below and update the code to test FiltersAPIResponse
      //var instance = new MesheryApi.FiltersAPIResponse();
      //expect(instance).to.be.a(MesheryApi.FiltersAPIResponse);
    });
