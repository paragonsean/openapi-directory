...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.PerformanceProfilesAPIResponse();
  });
  ...
  describe('PerformanceProfilesAPIResponse', function() {
    it('should create an instance of PerformanceProfilesAPIResponse', function() {
      // uncomment below and update the code to test PerformanceProfilesAPIResponse
      //var instance = new MesheryApi.PerformanceProfilesAPIResponse();
      //expect(instance).to.be.a(MesheryApi.PerformanceProfilesAPIResponse);
    });
