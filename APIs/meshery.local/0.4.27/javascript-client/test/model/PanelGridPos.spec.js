...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.PanelGridPos();
  });
  ...
  describe('PanelGridPos', function() {
    it('should create an instance of PanelGridPos', function() {
      // uncomment below and update the code to test PanelGridPos
      //var instance = new MesheryApi.PanelGridPos();
      //expect(instance).to.be.a(MesheryApi.PanelGridPos);
    });
