...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.ApplicationsAPIResponse();
  });
  ...
  describe('ApplicationsAPIResponse', function() {
    it('should create an instance of ApplicationsAPIResponse', function() {
      // uncomment below and update the code to test ApplicationsAPIResponse
      //var instance = new MesheryApi.ApplicationsAPIResponse();
      //expect(instance).to.be.a(MesheryApi.ApplicationsAPIResponse);
    });
