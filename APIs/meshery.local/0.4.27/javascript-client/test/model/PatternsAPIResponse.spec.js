...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.PatternsAPIResponse();
  });
  ...
  describe('PatternsAPIResponse', function() {
    it('should create an instance of PatternsAPIResponse', function() {
      // uncomment below and update the code to test PatternsAPIResponse
      //var instance = new MesheryApi.PatternsAPIResponse();
      //expect(instance).to.be.a(MesheryApi.PatternsAPIResponse);
    });
