...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.PerformanceTestParameters();
  });
  ...
  describe('PerformanceTestParameters', function() {
    it('should create an instance of PerformanceTestParameters', function() {
      // uncomment below and update the code to test PerformanceTestParameters
      //var instance = new MesheryApi.PerformanceTestParameters();
      //expect(instance).to.be.a(MesheryApi.PerformanceTestParameters);
    });
    ...
    it('should have the property dur (base name: "dur")', function() {
      // uncomment below and update the code to test the property dur
      //var instance = new MesheryApi.PerformanceTestParameters();
      //expect(instance).to.be();
    });

    it('should have the property loadGenerator (base name: "loadGenerator")', function() {
