...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.ContainerTopOKBody();
  });
  ...
  describe('ContainerTopOKBody', function() {
    it('should create an instance of ContainerTopOKBody', function() {
      // uncomment below and update the code to test ContainerTopOKBody
      //var instance = new MesheryApi.ContainerTopOKBody();
      //expect(instance).to.be.a(MesheryApi.ContainerTopOKBody);
    });
