...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.VolumeListOKBody();
  });
  ...
  describe('VolumeListOKBody', function() {
    it('should create an instance of VolumeListOKBody', function() {
      // uncomment below and update the code to test VolumeListOKBody
      //var instance = new MesheryApi.VolumeListOKBody();
      //expect(instance).to.be.a(MesheryApi.VolumeListOKBody);
    });
