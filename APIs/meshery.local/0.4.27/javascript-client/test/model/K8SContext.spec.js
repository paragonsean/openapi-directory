...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.K8SContext();
  });
  ...
  describe('K8SContext', function() {
    it('should create an instance of K8SContext', function() {
      // uncomment below and update the code to test K8SContext
      //var instance = new MesheryApi.K8SContext();
      //expect(instance).to.be.a(MesheryApi.K8SContext);
    });
    ...
    it('should have the property currentContext (base name: "currentContext")', function() {
