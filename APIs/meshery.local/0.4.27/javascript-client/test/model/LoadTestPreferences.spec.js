...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.LoadTestPreferences();
  });
  ...
  describe('LoadTestPreferences', function() {
    it('should create an instance of LoadTestPreferences', function() {
      // uncomment below and update the code to test LoadTestPreferences
      //var instance = new MesheryApi.LoadTestPreferences();
      //expect(instance).to.be.a(MesheryApi.LoadTestPreferences);
    });
