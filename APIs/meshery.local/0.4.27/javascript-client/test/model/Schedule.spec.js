...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MesheryApi.Schedule();
  });
  ...
  describe('Schedule', function() {
    it('should create an instance of Schedule', function() {
      ...
      //var instance = new MesheryApi.Schedule();
      //expect(instance).to.be.a(MesheryApi.Schedule);
    });

    it('should have the property cronExpression (base name: "cron_expression")', function() {
