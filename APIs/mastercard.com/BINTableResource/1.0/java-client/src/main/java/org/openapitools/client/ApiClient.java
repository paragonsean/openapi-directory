...
public class ApiClient {
    ...
    private String basePath = "https://api.mastercard.com/fraud/mtf/bintable/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.mastercard.com/fraud/mtf/bintable/v1",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mastercard.com/fraud/mtf/bintable/v1
