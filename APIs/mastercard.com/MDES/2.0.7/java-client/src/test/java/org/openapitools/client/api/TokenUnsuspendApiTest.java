...
/**
 * API tests for TokenUnsuspendApi
 */
@Disabled
public class TokenUnsuspendApiTest {

    private final TokenUnsuspendApi api = new TokenUnsuspendApi();
     ...
     */
    @Test
    public void tokenUnsuspendPostTest() throws ApiException {
        TokenUnsuspendRequestSchema tokenUnsuspendRequestSchema = null;
        TokenUnsuspendResponseSchema response = api.tokenUnsuspendPost(tokenUnsuspendRequestSchema);
