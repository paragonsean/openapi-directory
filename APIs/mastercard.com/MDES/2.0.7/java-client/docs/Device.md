...
|------------ | ------------- | ------------- | -------------|
|**deviceId** | **String** | Serial number of the device provisioned with the token. May be masked. Conditional field, not present for CoF tokens, and only present when provided by a Wallet Provider. May be masked (by the Wallet Provider).&lt;br /&gt;Example (unmasked) \&quot;C2ZBY14310005664\&quot;. Example (masked) \&quot;xxxxY1431xxxxxxx\&quot;. |  [optional] |
