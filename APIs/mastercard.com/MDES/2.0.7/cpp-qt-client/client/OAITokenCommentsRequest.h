...
/*
 * OAITokenCommentsRequest.h
 *
 * 
 */

#ifndef OAITokenCommentsRequest_H
#define OAITokenCommentsRequest_H
...
class OAITokenCommentsRequest : public OAIObject {
public:
    OAITokenCommentsRequest();
    OAITokenCommentsRequest(QString json);
    ~OAITokenCommentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenCommentsRequest)

#endif // OAITokenCommentsRequest_H
