...
OAITokenDeleteRequest::OAITokenDeleteRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITokenDeleteRequest::OAITokenDeleteRequest() {
    this->initializeModel();
}

OAITokenDeleteRequest::~OAITokenDeleteRequest() {}

void OAITokenDeleteRequest::initializeModel() {
...
void OAITokenDeleteRequest::fromJson(QString jsonString) {
...
void OAITokenDeleteRequest::fromJsonObject(QJsonObject json) {
...
QString OAITokenDeleteRequest::asJson() const {
...
QJsonObject OAITokenDeleteRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIAuditInfo OAITokenDeleteRequest::getAuditInfo() const {
    return m_audit_info;
}
void OAITokenDeleteRequest::setAuditInfo(const OAIAuditInfo &audit_info) {
    m_audit_info = audit_info;
    m_audit_info_isSet = true;
}

bool OAITokenDeleteRequest::is_audit_info_Set() const{
    return m_audit_info_isSet;
}

bool OAITokenDeleteRequest::is_audit_info_Valid() const{
    return m_audit_info_isValid;
}

QString OAITokenDeleteRequest::getCommentText() const {
    return m_comment_text;
}
void OAITokenDeleteRequest::setCommentText(const QString &comment_text) {
    m_comment_text = comment_text;
    m_comment_text_isSet = true;
}

bool OAITokenDeleteRequest::is_comment_text_Set() const{
    return m_comment_text_isSet;
}

bool OAITokenDeleteRequest::is_comment_text_Valid() const{
    return m_comment_text_isValid;
}

QString OAITokenDeleteRequest::getReasonCode() const {
    return m_reason_code;
}
void OAITokenDeleteRequest::setReasonCode(const QString &reason_code) {
    m_reason_code = reason_code;
    m_reason_code_isSet = true;
}

bool OAITokenDeleteRequest::is_reason_code_Set() const{
    return m_reason_code_isSet;
}

bool OAITokenDeleteRequest::is_reason_code_Valid() const{
    return m_reason_code_isValid;
}

QString OAITokenDeleteRequest::getTokenUniqueReference() const {
    return m_token_unique_reference;
}
void OAITokenDeleteRequest::setTokenUniqueReference(const QString &token_unique_reference) {
    m_token_unique_reference = token_unique_reference;
    m_token_unique_reference_isSet = true;
}

bool OAITokenDeleteRequest::is_token_unique_reference_Set() const{
    return m_token_unique_reference_isSet;
}

bool OAITokenDeleteRequest::is_token_unique_reference_Valid() const{
    return m_token_unique_reference_isValid;
}

bool OAITokenDeleteRequest::isSet() const {
...
bool OAITokenDeleteRequest::isValid() const {
