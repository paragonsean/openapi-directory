...
/*
 * OAITokenDeleteRequest.h
 *
 * 
 */

#ifndef OAITokenDeleteRequest_H
#define OAITokenDeleteRequest_H
...
class OAITokenDeleteRequest : public OAIObject {
public:
    OAITokenDeleteRequest();
    OAITokenDeleteRequest(QString json);
    ~OAITokenDeleteRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenDeleteRequest)

#endif // OAITokenDeleteRequest_H
