...
OAITokenSuspendRequest::OAITokenSuspendRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITokenSuspendRequest::OAITokenSuspendRequest() {
    this->initializeModel();
}

OAITokenSuspendRequest::~OAITokenSuspendRequest() {}

void OAITokenSuspendRequest::initializeModel() {
...
void OAITokenSuspendRequest::fromJson(QString jsonString) {
...
void OAITokenSuspendRequest::fromJsonObject(QJsonObject json) {
...
QString OAITokenSuspendRequest::asJson() const {
...
QJsonObject OAITokenSuspendRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIAuditInfo OAITokenSuspendRequest::getAuditInfo() const {
    return m_audit_info;
}
void OAITokenSuspendRequest::setAuditInfo(const OAIAuditInfo &audit_info) {
    m_audit_info = audit_info;
    m_audit_info_isSet = true;
}

bool OAITokenSuspendRequest::is_audit_info_Set() const{
    return m_audit_info_isSet;
}

bool OAITokenSuspendRequest::is_audit_info_Valid() const{
    return m_audit_info_isValid;
}

QString OAITokenSuspendRequest::getCommentText() const {
    return m_comment_text;
}
void OAITokenSuspendRequest::setCommentText(const QString &comment_text) {
    m_comment_text = comment_text;
    m_comment_text_isSet = true;
}

bool OAITokenSuspendRequest::is_comment_text_Set() const{
    return m_comment_text_isSet;
}

bool OAITokenSuspendRequest::is_comment_text_Valid() const{
    return m_comment_text_isValid;
}

QString OAITokenSuspendRequest::getReasonCode() const {
    return m_reason_code;
}
void OAITokenSuspendRequest::setReasonCode(const QString &reason_code) {
    m_reason_code = reason_code;
    m_reason_code_isSet = true;
}

bool OAITokenSuspendRequest::is_reason_code_Set() const{
    return m_reason_code_isSet;
}

bool OAITokenSuspendRequest::is_reason_code_Valid() const{
    return m_reason_code_isValid;
}

QString OAITokenSuspendRequest::getTokenUniqueReference() const {
    return m_token_unique_reference;
}
void OAITokenSuspendRequest::setTokenUniqueReference(const QString &token_unique_reference) {
    m_token_unique_reference = token_unique_reference;
    m_token_unique_reference_isSet = true;
}

bool OAITokenSuspendRequest::is_token_unique_reference_Set() const{
    return m_token_unique_reference_isSet;
}

bool OAITokenSuspendRequest::is_token_unique_reference_Valid() const{
    return m_token_unique_reference_isValid;
}

bool OAITokenSuspendRequest::isSet() const {
...
bool OAITokenSuspendRequest::isValid() const {
