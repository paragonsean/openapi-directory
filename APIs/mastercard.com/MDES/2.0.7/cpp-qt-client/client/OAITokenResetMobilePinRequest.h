...
/*
 * OAITokenResetMobilePinRequest.h
 *
 * 
 */

#ifndef OAITokenResetMobilePinRequest_H
#define OAITokenResetMobilePinRequest_H
...
class OAITokenResetMobilePinRequest : public OAIObject {
public:
    OAITokenResetMobilePinRequest();
    OAITokenResetMobilePinRequest(QString json);
    ~OAITokenResetMobilePinRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenResetMobilePinRequest)

#endif // OAITokenResetMobilePinRequest_H
