...
void OAITransactionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("transactionsPost", defaultConf);
    _serverIndices.insert("transactionsPost", 0);
}
...
void OAITransactionsApi::transactionsPost(const ::OpenAPI::OptionalParam<OAITransactionsRequestSchema> &transactions_request_schema) {
    QString fullPath = QString(_serverConfigs["transactionsPost"][_serverIndices.value("transactionsPost")].URL()+"/transactions");
    ...
    if (transactions_request_schema.hasValue()){

        
        QByteArray output = transactions_request_schema.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITransactionsApi::transactionsPostCallback);
...
void OAITransactionsApi::transactionsPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITransactionsResponseSchema output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT transactionsPostSignal(output);
        Q_EMIT transactionsPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT transactionsPostSignalE(output, error_type, error_str);
        Q_EMIT transactionsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT transactionsPostSignalError(output, error_type, error_str);
        Q_EMIT transactionsPostSignalErrorFull(worker, error_type, error_str);
    }
}
