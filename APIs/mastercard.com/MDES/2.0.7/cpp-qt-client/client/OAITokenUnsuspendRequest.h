...
/*
 * OAITokenUnsuspendRequest.h
 *
 * 
 */

#ifndef OAITokenUnsuspendRequest_H
#define OAITokenUnsuspendRequest_H
...
class OAITokenUnsuspendRequest : public OAIObject {
public:
    OAITokenUnsuspendRequest();
    OAITokenUnsuspendRequest(QString json);
    ~OAITokenUnsuspendRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenUnsuspendRequest)

#endif // OAITokenUnsuspendRequest_H
