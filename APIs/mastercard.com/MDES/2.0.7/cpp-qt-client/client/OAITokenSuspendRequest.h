...
/*
 * OAITokenSuspendRequest.h
 *
 * 
 */

#ifndef OAITokenSuspendRequest_H
#define OAITokenSuspendRequest_H
...
class OAITokenSuspendRequest : public OAIObject {
public:
    OAITokenSuspendRequest();
    OAITokenSuspendRequest(QString json);
    ~OAITokenSuspendRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenSuspendRequest)

#endif // OAITokenSuspendRequest_H
