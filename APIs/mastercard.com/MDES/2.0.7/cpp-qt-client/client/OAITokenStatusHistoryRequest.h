...
/*
 * OAITokenStatusHistoryRequest.h
 *
 * 
 */

#ifndef OAITokenStatusHistoryRequest_H
#define OAITokenStatusHistoryRequest_H
...
class OAITokenStatusHistoryRequest : public OAIObject {
public:
    OAITokenStatusHistoryRequest();
    OAITokenStatusHistoryRequest(QString json);
    ~OAITokenStatusHistoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenStatusHistoryRequest)

#endif // OAITokenStatusHistoryRequest_H
