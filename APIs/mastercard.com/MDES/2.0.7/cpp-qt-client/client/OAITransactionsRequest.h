...
/*
 * OAITransactionsRequest.h
 *
 * 
 */

#ifndef OAITransactionsRequest_H
#define OAITransactionsRequest_H
...
class OAITransactionsRequest : public OAIObject {
public:
    OAITransactionsRequest();
    OAITransactionsRequest(QString json);
    ~OAITransactionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionsRequest)

#endif // OAITransactionsRequest_H
