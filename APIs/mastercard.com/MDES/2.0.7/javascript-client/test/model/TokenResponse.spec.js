...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new MdesCustomerService.TokenResponse();
      //expect(instance).to.be.a(MdesCustomerService.TokenResponse);
    });
