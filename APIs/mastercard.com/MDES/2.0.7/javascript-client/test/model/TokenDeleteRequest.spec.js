...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenDeleteRequest();
  });
  ...
  describe('TokenDeleteRequest', function() {
    it('should create an instance of TokenDeleteRequest', function() {
      // uncomment below and update the code to test TokenDeleteRequest
      //var instance = new MdesCustomerService.TokenDeleteRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenDeleteRequest);
    });
