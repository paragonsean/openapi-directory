...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.SearchRequest();
  });
  ...
  describe('SearchRequest', function() {
    it('should create an instance of SearchRequest', function() {
      ...
      //var instance = new MdesCustomerService.SearchRequest();
      //expect(instance).to.be.a(MdesCustomerService.SearchRequest);
    });
    ...
    it('should have the property alternateAccountIdentifier (base name: "AlternateAccountIdentifier")', function() {
      // uncomment below and update the code to test the property alternateAccountIdentifier
      //var instance = new MdesCustomerService.SearchRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property excludeDeletedIndicator (base name: "ExcludeDeletedIndicator")', function() {
      // uncomment below and update the code to test the property excludeDeletedIndicator
      //var instance = new MdesCustomerService.SearchRequest();
      //expect(instance).to.be();
    });
