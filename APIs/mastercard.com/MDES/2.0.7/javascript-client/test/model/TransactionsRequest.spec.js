...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TransactionsRequest();
  });
  ...
  describe('TransactionsRequest', function() {
    it('should create an instance of TransactionsRequest', function() {
      // uncomment below and update the code to test TransactionsRequest
      //var instance = new MdesCustomerService.TransactionsRequest();
      //expect(instance).to.be.a(MdesCustomerService.TransactionsRequest);
    });
