...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.Transactions();
  });
  ...
  describe('Transactions', function() {
    it('should create an instance of Transactions', function() {
      ...
      //var instance = new MdesCustomerService.Transactions();
      //expect(instance).to.be.a(MdesCustomerService.Transactions);
    });
