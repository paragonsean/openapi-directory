...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenUnsuspendRequest();
  });
  ...
  describe('TokenUnsuspendRequest', function() {
    it('should create an instance of TokenUnsuspendRequest', function() {
      // uncomment below and update the code to test TokenUnsuspendRequest
      //var instance = new MdesCustomerService.TokenUnsuspendRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenUnsuspendRequest);
    });
