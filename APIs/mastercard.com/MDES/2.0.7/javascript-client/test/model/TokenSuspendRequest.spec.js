...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenSuspendRequest();
  });
  ...
  describe('TokenSuspendRequest', function() {
    it('should create an instance of TokenSuspendRequest', function() {
      // uncomment below and update the code to test TokenSuspendRequest
      //var instance = new MdesCustomerService.TokenSuspendRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenSuspendRequest);
    });
