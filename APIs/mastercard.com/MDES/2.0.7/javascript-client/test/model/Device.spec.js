...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.Device();
  });
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new MdesCustomerService.Device();
      //expect(instance).to.be.a(MdesCustomerService.Device);
    });
    ...
    it('should have the property secureElementId (base name: "SecureElementId")', function() {
      // uncomment below and update the code to test the property secureElementId
      //var instance = new MdesCustomerService.Device();
      //expect(instance).to.be();
    });
