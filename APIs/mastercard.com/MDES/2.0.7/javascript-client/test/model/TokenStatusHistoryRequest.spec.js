...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenStatusHistoryRequest();
  });
  ...
  describe('TokenStatusHistoryRequest', function() {
    it('should create an instance of TokenStatusHistoryRequest', function() {
      // uncomment below and update the code to test TokenStatusHistoryRequest
      //var instance = new MdesCustomerService.TokenStatusHistoryRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenStatusHistoryRequest);
    });
