...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenCommentsRequest();
  });
  ...
  describe('TokenCommentsRequest', function() {
    it('should create an instance of TokenCommentsRequest', function() {
      // uncomment below and update the code to test TokenCommentsRequest
      //var instance = new MdesCustomerService.TokenCommentsRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenCommentsRequest);
    });
