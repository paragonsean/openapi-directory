...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MdesCustomerService.TokenResetMobilePinRequest();
  });
  ...
  describe('TokenResetMobilePinRequest', function() {
    it('should create an instance of TokenResetMobilePinRequest', function() {
      // uncomment below and update the code to test TokenResetMobilePinRequest
      //var instance = new MdesCustomerService.TokenResetMobilePinRequest();
      //expect(instance).to.be.a(MdesCustomerService.TokenResetMobilePinRequest);
    });
