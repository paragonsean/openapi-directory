...
class TokenResponse {
    ...
    constructor(tokenUniqueReference) { 
        ...
        TokenResponse.initialize(this, tokenUniqueReference);
    }
...
TokenResponse.RequiredProperties = ["TokenUniqueReference"];

/**
 * Unique reference to the Token.
 * @member {String} TokenUniqueReference
 */
TokenResponse.prototype['TokenUniqueReference'] = undefined;
