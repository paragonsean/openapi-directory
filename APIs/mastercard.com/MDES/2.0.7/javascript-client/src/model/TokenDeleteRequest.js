...
class TokenDeleteRequest {
    ...
    constructor(auditInfo, reasonCode, tokenUniqueReference) { 
        ...
        TokenDeleteRequest.initialize(this, auditInfo, reasonCode, tokenUniqueReference);
    }
    ...
    /**
     * Constructs a <code>TokenDeleteRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenDeleteRequest} obj Optional instance to populate.
     * @return {module:model/TokenDeleteRequest} The populated <code>TokenDeleteRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenDeleteRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TokenDeleteRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenDeleteRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TokenDeleteRequest.RequiredProperties) {
...
TokenDeleteRequest.RequiredProperties = ["AuditInfo", "ReasonCode", "TokenUniqueReference"];

/**
 * @member {module:model/AuditInfo} AuditInfo
 */
TokenDeleteRequest.prototype['AuditInfo'] = undefined;

/**
 * Comment related to deletion.
 * @member {String} CommentText
 */
TokenDeleteRequest.prototype['CommentText'] = undefined;

/**
 * The reason for the action. Valid values:<br />    \"L\" - Cardholder confirmed token device lost<br />    \"S\" - Cardholder confirmed token device stolen<br />    \"F\" - Issuer or cardholder confirmed fraudulent token transactions (Deprecated)<br />    \"T\" - Issuer or cardholder confirmed fraudulent token transactions<br />    \"C\" - Account closed<br />    \"Z\" - Other
 * @member {String} ReasonCode
 */
TokenDeleteRequest.prototype['ReasonCode'] = undefined;

/**
 * The TokenUniqueReference of the token.
 * @member {String} TokenUniqueReference
 */
TokenDeleteRequest.prototype['TokenUniqueReference'] = undefined;
...
export default TokenDeleteRequest;
