...
class TokenCommentsRequest(Model):
    ...
    def __init__(self, audit_info: AuditInfo=None, token_unique_reference: str=None):
        """TokenCommentsRequest - a model defined in OpenAPI

        :param audit_info: The audit_info of this TokenCommentsRequest.
        :param token_unique_reference: The token_unique_reference of this TokenCommentsRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TokenCommentsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TokenCommentsRequest of this TokenCommentsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def audit_info(self):
        """Gets the audit_info of this TokenCommentsRequest.


        :return: The audit_info of this TokenCommentsRequest.
        :rtype: AuditInfo
        """
    ...
    def audit_info(self, audit_info):
        """Sets the audit_info of this TokenCommentsRequest.
    ...
    def token_unique_reference(self):
        """Gets the token_unique_reference of this TokenCommentsRequest.

        The TokenUniqueReference of the token.

        :return: The token_unique_reference of this TokenCommentsRequest.
        :rtype: str
        """
    ...
    def token_unique_reference(self, token_unique_reference):
        """Sets the token_unique_reference of this TokenCommentsRequest.
