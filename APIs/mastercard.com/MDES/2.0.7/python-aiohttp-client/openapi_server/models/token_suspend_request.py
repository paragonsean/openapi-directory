...
class TokenSuspendRequest(Model):
    ...
    def __init__(self, audit_info: AuditInfo=None, comment_text: str=None, reason_code: str=None, token_unique_reference: str=None):
        """TokenSuspendRequest - a model defined in OpenAPI

        :param audit_info: The audit_info of this TokenSuspendRequest.
        :param comment_text: The comment_text of this TokenSuspendRequest.
        :param reason_code: The reason_code of this TokenSuspendRequest.
        :param token_unique_reference: The token_unique_reference of this TokenSuspendRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TokenSuspendRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TokenSuspendRequest of this TokenSuspendRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def audit_info(self):
        """Gets the audit_info of this TokenSuspendRequest.


        :return: The audit_info of this TokenSuspendRequest.
        :rtype: AuditInfo
        """
    ...
    def audit_info(self, audit_info):
        """Sets the audit_info of this TokenSuspendRequest.
    ...
    def comment_text(self):
        """Gets the comment_text of this TokenSuspendRequest.

        Comment related to suspension.

        :return: The comment_text of this TokenSuspendRequest.
        :rtype: str
        """
    ...
    def comment_text(self, comment_text):
        """Sets the comment_text of this TokenSuspendRequest.
    ...
    def reason_code(self):
        """Gets the reason_code of this TokenSuspendRequest.
        ...
        :return: The reason_code of this TokenSuspendRequest.
        :rtype: str
        """
    ...
    def reason_code(self, reason_code):
        """Sets the reason_code of this TokenSuspendRequest.
        ...
        if reason_code is not None and len(reason_code) < 1:
            raise ValueError("Invalid value for `reason_code`, length must be greater than or equal to `1`")

        self._reason_code = reason_code

    @property
    def token_unique_reference(self):
        """Gets the token_unique_reference of this TokenSuspendRequest.

        The TokenUniqueReference of the token.

        :return: The token_unique_reference of this TokenSuspendRequest.
        :rtype: str
        """
    ...
    def token_unique_reference(self, token_unique_reference):
        """Sets the token_unique_reference of this TokenSuspendRequest.
