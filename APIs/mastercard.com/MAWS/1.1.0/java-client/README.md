...
MasterCard ABU API
- API version: 1.1.0
  - Build date: 2024-10-12T10:09:11.500532-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AbuApi* | [**abuPost**](docs/AbuApi.md#abuPost) | **POST** /v1/maws | Access methods for merchants to ABU program.


## Documentation for Models

 - [ABU](docs/ABU.md)
 - [AbuDTO](docs/AbuDTO.md)
 - [AbuResponse](docs/AbuResponse.md)
 - [AbuResultDTO](docs/AbuResultDTO.md)
