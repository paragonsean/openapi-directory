...
/**
 * API tests for AbuApi
 */
@Disabled
public class AbuApiTest {

    private final AbuApi api = new AbuApi();
     ...
     */
    @Test
    public void abuPostTest() throws ApiException {
        ABU abuRequest = null;
        AbuResponse response = api.abuPost(abuRequest);
