...
QString OAIAddress::getCountrySubdivision() const {
    return m_country_subdivision;
}
void OAIAddress::setCountrySubdivision(const QString &country_subdivision) {
...
bool OAIAddress::isValid() const {
    ...
    return m_city_isValid && m_country_isValid && m_country_subdivision_isValid && m_line1_isValid && m_postal_code_isValid && true;
}
