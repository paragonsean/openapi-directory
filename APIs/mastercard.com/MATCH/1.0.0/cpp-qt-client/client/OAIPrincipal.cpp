...
OAIAddress OAIPrincipal::getAddress() const {
    return m_address;
}
void OAIPrincipal::setAddress(const OAIAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIPrincipal::is_address_Set() const{
    return m_address_isSet;
}

bool OAIPrincipal::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIPrincipal::getAltPhoneNumber() const {
    return m_alt_phone_number;
}
void OAIPrincipal::setAltPhoneNumber(const QString &alt_phone_number) {
    m_alt_phone_number = alt_phone_number;
    m_alt_phone_number_isSet = true;
}

bool OAIPrincipal::is_alt_phone_number_Set() const{
    return m_alt_phone_number_isSet;
}

bool OAIPrincipal::is_alt_phone_number_Valid() const{
    return m_alt_phone_number_isValid;
}

OAIDriversLicense OAIPrincipal::getDriversLicense() const {
    return m_drivers_license;
}
void OAIPrincipal::setDriversLicense(const OAIDriversLicense &drivers_license) {
    m_drivers_license = drivers_license;
    m_drivers_license_isSet = true;
}

bool OAIPrincipal::is_drivers_license_Set() const{
    return m_drivers_license_isSet;
}

bool OAIPrincipal::is_drivers_license_Valid() const{
    return m_drivers_license_isValid;
}

QString OAIPrincipal::getFirstName() const {
    return m_first_name;
}
void OAIPrincipal::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIPrincipal::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIPrincipal::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIPrincipal::getLastName() const {
    return m_last_name;
}
void OAIPrincipal::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIPrincipal::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIPrincipal::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIPrincipal::getMiddleInitial() const {
    return m_middle_initial;
}
void OAIPrincipal::setMiddleInitial(const QString &middle_initial) {
    m_middle_initial = middle_initial;
    m_middle_initial_isSet = true;
}

bool OAIPrincipal::is_middle_initial_Set() const{
    return m_middle_initial_isSet;
}

bool OAIPrincipal::is_middle_initial_Valid() const{
    return m_middle_initial_isValid;
}

QString OAIPrincipal::getNationalId() const {
    return m_national_id;
}
void OAIPrincipal::setNationalId(const QString &national_id) {
    m_national_id = national_id;
    m_national_id_isSet = true;
}

bool OAIPrincipal::is_national_id_Set() const{
    return m_national_id_isSet;
}

bool OAIPrincipal::is_national_id_Valid() const{
    return m_national_id_isValid;
}

QString OAIPrincipal::getPhoneNumber() const {
    return m_phone_number;
}
void OAIPrincipal::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIPrincipal::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIPrincipal::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

OAISearchCriteria OAIPrincipal::getSearchCriteria() const {
    return m_search_criteria;
}
void OAIPrincipal::setSearchCriteria(const OAISearchCriteria &search_criteria) {
    m_search_criteria = search_criteria;
    m_search_criteria_isSet = true;
}

bool OAIPrincipal::is_search_criteria_Set() const{
    return m_search_criteria_isSet;
}

bool OAIPrincipal::is_search_criteria_Valid() const{
