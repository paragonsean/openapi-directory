...
public class ContactResponse {
  ...
  public ContactResponse contact(List<Contact> contact) {
    this.contact = contact;
    return this;
  }

  public ContactResponse addContactItem(Contact contactItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contact, contactResponse.contact);
  }
      ...
      if (jsonObj.get("Contact") != null && !jsonObj.get("Contact").isJsonNull()) {
        ...
        if (jsonArraycontact != null) {
          ...
          for (int i = 0; i < jsonArraycontact.size(); i++) {
            Contact.validateJsonElement(jsonArraycontact.get(i));
          };
        }
      }
  }
