...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchApi.InquiredMerchantMerchant();
  });
  ...
  describe('InquiredMerchantMerchant', function() {
    it('should create an instance of InquiredMerchantMerchant', function() {
      // uncomment below and update the code to test InquiredMerchantMerchant
      //var instance = new MatchApi.InquiredMerchantMerchant();
      //expect(instance).to.be.a(MatchApi.InquiredMerchantMerchant);
    });
