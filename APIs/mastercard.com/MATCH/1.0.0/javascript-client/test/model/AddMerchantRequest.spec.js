...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchApi.AddMerchantRequest();
  });
  ...
  describe('AddMerchantRequest', function() {
    it('should create an instance of AddMerchantRequest', function() {
      // uncomment below and update the code to test AddMerchantRequest
      //var instance = new MatchApi.AddMerchantRequest();
      //expect(instance).to.be.a(MatchApi.AddMerchantRequest);
    });
