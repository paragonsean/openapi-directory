...
public class ApiClient {
    ...
    private String basePath = "http://api.mastercard.com/merchant-id/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "//api.mastercard.com/merchant-id/v2",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.mastercard.com/merchant-id/v2
