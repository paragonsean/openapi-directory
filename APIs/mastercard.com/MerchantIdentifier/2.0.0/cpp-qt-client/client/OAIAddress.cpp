...
QJsonObject OAIAddress::asJsonObject() const {
    ...
    if (m_country_subdivision.isSet()) {
...
OAICountrySubdivision OAIAddress::getCountrySubdivision() const {
    return m_country_subdivision;
}
void OAIAddress::setCountrySubdivision(const OAICountrySubdivision &country_subdivision) {
    m_country_subdivision = country_subdivision;
    m_country_subdivision_isSet = true;
}

bool OAIAddress::is_country_subdivision_Set() const{
    return m_country_subdivision_isSet;
}

bool OAIAddress::is_country_subdivision_Valid() const{
