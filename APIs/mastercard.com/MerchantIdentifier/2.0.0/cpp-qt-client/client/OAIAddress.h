...
public:
    ...
    OAICountrySubdivision getCountrySubdivision() const;
    void setCountrySubdivision(const OAICountrySubdivision &country_subdivision);
...
private:
    ...
    OAICountrySubdivision m_country_subdivision;
