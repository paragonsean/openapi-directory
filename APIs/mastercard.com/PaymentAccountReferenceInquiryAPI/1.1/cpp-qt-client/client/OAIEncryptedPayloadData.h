...
/*
 * OAIEncryptedPayloadData.h
 *
 * 
 */

#ifndef OAIEncryptedPayloadData_H
#define OAIEncryptedPayloadData_H
...
class OAIEncryptedPayloadData : public OAIObject {
public:
    OAIEncryptedPayloadData();
    OAIEncryptedPayloadData(QString json);
    ~OAIEncryptedPayloadData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptedPayloadData)

#endif // OAIEncryptedPayloadData_H
