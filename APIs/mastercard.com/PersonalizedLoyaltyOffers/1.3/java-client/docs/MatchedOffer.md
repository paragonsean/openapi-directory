...
|**eventEndDate** | **LocalDate** | Last day that redemption can be made. |  [optional] |
|**eventStartDate** | **LocalDate** | First day that redemption can be made by any user, may not apply to the specified user. |  [optional] |
