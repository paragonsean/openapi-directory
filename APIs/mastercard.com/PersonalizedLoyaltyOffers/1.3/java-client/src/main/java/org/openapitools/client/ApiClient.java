...
public class ApiClient {
    ...
    private String basePath = "https://api.mastercard.com/plo/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.mastercard.com/plo/v1",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mastercard.com/plo/v1
