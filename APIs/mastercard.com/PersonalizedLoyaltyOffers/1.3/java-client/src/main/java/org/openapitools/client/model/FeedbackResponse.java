...
public class FeedbackResponse {
  ...
  public FeedbackResponse status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public FeedbackResponse userFeedback(UserFeedback userFeedback) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, feedbackResponse.status) &&
        Objects.equals(this.userFeedback, feedbackResponse.userFeedback);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, userFeedback);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("UserFeedback") != null && !jsonObj.get("UserFeedback").isJsonNull()) {
        UserFeedback.validateJsonElement(jsonObj.get("UserFeedback"));
      }
  }
