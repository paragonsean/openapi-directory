...
/**
 * Model tests for UserTokenResponse
 */
public class UserTokenResponseTest {
    private final UserTokenResponse model = new UserTokenResponse();
