...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.UserTokenApi();
  });
  ...
  describe('UserTokenApi', function() {
    describe('usertokenGet', function() {
      it('should call usertokenGet successfully', function(done) {
        //uncomment below and update the code to test usertokenGet
        //instance.usertokenGet(function(error) {
