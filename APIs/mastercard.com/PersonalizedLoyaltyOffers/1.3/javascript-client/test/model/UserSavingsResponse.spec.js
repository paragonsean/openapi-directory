...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.UserSavingsResponse();
  });
  ...
  describe('UserSavingsResponse', function() {
    it('should create an instance of UserSavingsResponse', function() {
      // uncomment below and update the code to test UserSavingsResponse
      //var instance = new PersonalizedOffers.UserSavingsResponse();
      //expect(instance).to.be.a(PersonalizedOffers.UserSavingsResponse);
    });
