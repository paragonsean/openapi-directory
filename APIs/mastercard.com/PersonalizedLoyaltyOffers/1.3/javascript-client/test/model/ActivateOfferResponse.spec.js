...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.ActivateOfferResponse();
  });
  ...
  describe('ActivateOfferResponse', function() {
    it('should create an instance of ActivateOfferResponse', function() {
      // uncomment below and update the code to test ActivateOfferResponse
      //var instance = new PersonalizedOffers.ActivateOfferResponse();
      //expect(instance).to.be.a(PersonalizedOffers.ActivateOfferResponse);
    });
