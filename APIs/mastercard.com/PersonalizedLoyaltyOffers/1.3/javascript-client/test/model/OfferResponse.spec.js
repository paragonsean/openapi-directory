...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.OfferResponse();
  });
  ...
  describe('OfferResponse', function() {
    it('should create an instance of OfferResponse', function() {
      ...
      //var instance = new PersonalizedOffers.OfferResponse();
      //expect(instance).to.be.a(PersonalizedOffers.OfferResponse);
    });
