...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.MatchedOffersResponse();
  });
  ...
  describe('MatchedOffersResponse', function() {
    it('should create an instance of MatchedOffersResponse', function() {
      // uncomment below and update the code to test MatchedOffersResponse
      //var instance = new PersonalizedOffers.MatchedOffersResponse();
      //expect(instance).to.be.a(PersonalizedOffers.MatchedOffersResponse);
    });
