...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new PersonalizedOffers.ErrorResponse();
      //expect(instance).to.be.a(PersonalizedOffers.ErrorResponse);
    });
