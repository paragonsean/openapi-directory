...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.ReedemedResponse();
  });
  ...
  describe('ReedemedResponse', function() {
    it('should create an instance of ReedemedResponse', function() {
      // uncomment below and update the code to test ReedemedResponse
      //var instance = new PersonalizedOffers.ReedemedResponse();
      //expect(instance).to.be.a(PersonalizedOffers.ReedemedResponse);
    });
