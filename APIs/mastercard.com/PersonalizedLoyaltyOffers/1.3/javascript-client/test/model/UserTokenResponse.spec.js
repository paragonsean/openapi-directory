...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.UserTokenResponse();
  });
  ...
  describe('UserTokenResponse', function() {
    it('should create an instance of UserTokenResponse', function() {
      // uncomment below and update the code to test UserTokenResponse
      //var instance = new PersonalizedOffers.UserTokenResponse();
      //expect(instance).to.be.a(PersonalizedOffers.UserTokenResponse);
    });
