...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new PersonalizedOffers.TokenResponse();
      //expect(instance).to.be.a(PersonalizedOffers.TokenResponse);
    });
