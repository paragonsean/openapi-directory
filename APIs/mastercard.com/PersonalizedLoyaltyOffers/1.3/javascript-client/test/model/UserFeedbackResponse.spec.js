...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.UserFeedbackResponse();
  });
  ...
  describe('UserFeedbackResponse', function() {
    it('should create an instance of UserFeedbackResponse', function() {
      // uncomment below and update the code to test UserFeedbackResponse
      //var instance = new PersonalizedOffers.UserFeedbackResponse();
      //expect(instance).to.be.a(PersonalizedOffers.UserFeedbackResponse);
    });
