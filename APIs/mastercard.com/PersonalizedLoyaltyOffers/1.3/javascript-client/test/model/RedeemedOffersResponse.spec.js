...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PersonalizedOffers.RedeemedOffersResponse();
  });
  ...
  describe('RedeemedOffersResponse', function() {
    it('should create an instance of RedeemedOffersResponse', function() {
      // uncomment below and update the code to test RedeemedOffersResponse
      //var instance = new PersonalizedOffers.RedeemedOffersResponse();
      //expect(instance).to.be.a(PersonalizedOffers.RedeemedOffersResponse);
    });
