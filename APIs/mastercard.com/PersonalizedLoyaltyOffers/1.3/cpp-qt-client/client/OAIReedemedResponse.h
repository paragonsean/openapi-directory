...
/*
 * OAIReedemedResponse.h
 *
 * 
 */

#ifndef OAIReedemedResponse_H
#define OAIReedemedResponse_H
...
namespace OpenAPI {
class OAIRedemedItems;
class OAIStatus;

class OAIReedemedResponse : public OAIObject {
public:
    OAIReedemedResponse();
    OAIReedemedResponse(QString json);
    ~OAIReedemedResponse() override;
    ...
    OAIRedemedItems getItems() const;
    void setItems(const OAIRedemedItems &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReedemedResponse)

#endif // OAIReedemedResponse_H
