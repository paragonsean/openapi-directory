...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LocationsApi.CountrySubdivisions();
  });
  ...
  describe('CountrySubdivisions', function() {
    it('should create an instance of CountrySubdivisions', function() {
      // uncomment below and update the code to test CountrySubdivisions
      //var instance = new LocationsApi.CountrySubdivisions();
      //expect(instance).to.be.a(LocationsApi.CountrySubdivisions);
    });
