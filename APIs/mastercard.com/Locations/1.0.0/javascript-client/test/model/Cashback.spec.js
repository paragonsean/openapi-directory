...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LocationsApi.Cashback();
  });
  ...
  describe('Cashback', function() {
    it('should create an instance of Cashback', function() {
      // uncomment below and update the code to test Cashback
      //var instance = new LocationsApi.Cashback();
      //expect(instance).to.be.a(LocationsApi.Cashback);
    });
