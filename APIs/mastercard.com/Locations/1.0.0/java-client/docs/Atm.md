...
|**internationalMaestroAccepted** | **Integer** | This field will provide ATM Terminals which can still process Maestro transactions but are not yet EMV chip reader enabled. Information available only for USA and Argentina till October 2014. 1&#x3D;Yes. |  [optional] |
...
|**supportEMV** | **Integer** | This indicates whether the ATM has the ability to read chip cards or not. Options are 1 &#x3D; Yes 2 &#x3D; No or Empty &#x3D; Unknown. |  [optional] |
