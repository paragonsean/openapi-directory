...
void OAICountry::initializeModel() {
    ...
    m_geocoding_isSet = false;
    m_geocoding_isValid = false;
...
void OAICountry::fromJsonObject(QJsonObject json) {
    ...
    m_geocoding_isValid = ::OpenAPI::fromJsonValue(m_geocoding, json[QString("Geocoding")]);
    m_geocoding_isSet = !json[QString("Geocoding")].isNull() && m_geocoding_isValid;
...
QJsonObject OAICountry::asJsonObject() const {
    ...
    if (m_geocoding_isSet) {
        obj.insert(QString("Geocoding"), ::OpenAPI::toJsonValue(m_geocoding));
    }
    if (m_name_isSet) {
...
bool OAICountry::isGeocoding() const {
    return m_geocoding;
}
void OAICountry::setGeocoding(const bool &geocoding) {
    m_geocoding = geocoding;
    m_geocoding_isSet = true;
}

bool OAICountry::is_geocoding_Set() const{
    return m_geocoding_isSet;
}

bool OAICountry::is_geocoding_Valid() const{
    return m_geocoding_isValid;
}
