...
public class Currency {
  public static final String SERIALIZED_NAME_ALPHA_CD = "alphaCd";
  @SerializedName(SERIALIZED_NAME_ALPHA_CD)
  private String alphaCd;

  public static final String SERIALIZED_NAME_CURR_NAM = "currNam";
  @SerializedName(SERIALIZED_NAME_CURR_NAM)
  private String currNam;

  public Currency() {
  }

  public Currency alphaCd(String alphaCd) {
  ...
  public Currency currNam(String currNam) {
    this.currNam = currNam;
    return this;
  }
  ...
  public void setCurrNam(String currNam) {
    this.currNam = currNam;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alphaCd, currency.alphaCd) &&
        Objects.equals(this.currNam, currency.currNam);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alphaCd, currNam);
  }
  ...
  public String toString() {
    ...
    sb.append("    alphaCd: ").append(toIndentedString(alphaCd)).append("\n");
    sb.append("    currNam: ").append(toIndentedString(currNam)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("alphaCd");
    openapiFields.add("currNam");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("alphaCd") != null && !jsonObj.get("alphaCd").isJsonNull()) && !jsonObj.get("alphaCd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `alphaCd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("alphaCd").toString()));
      }
      if ((jsonObj.get("currNam") != null && !jsonObj.get("currNam").isJsonNull()) && !jsonObj.get("currNam").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `currNam` to be a primitive type in the JSON string but got `%s`", jsonObj.get("currNam").toString()));
      }
  }
