...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiForTheSettlementCurrencyRateConverter.Conversion();
  });
  ...
  describe('Conversion', function() {
    it('should create an instance of Conversion', function() {
      ...
      //var instance = new ApiForTheSettlementCurrencyRateConverter.Conversion();
      //expect(instance).to.be.a(ApiForTheSettlementCurrencyRateConverter.Conversion);
    });
