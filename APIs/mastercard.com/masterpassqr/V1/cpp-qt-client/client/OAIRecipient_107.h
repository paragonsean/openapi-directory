...
#ifndef OAIRecipient_107_H
#define OAIRecipient_107_H

#include <QJsonObject>

#include "OAIAdditionalMerchantData_109.h"
#include "OAIAddress_108.h"
#include <QString>
...
namespace OpenAPI {
class OAIAdditionalMerchantData_109;
class OAIAddress_108;

class OAIRecipient_107 : public OAIObject {
public:
    OAIRecipient_107();
    OAIRecipient_107(QString json);
    ~OAIRecipient_107() override;
    ...
    OAIAdditionalMerchantData_109 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_109 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_108 getAddress() const;
    void setAddress(const OAIAddress_108 &address);
...
private:
    ...
    OAIAdditionalMerchantData_109 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_108 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_107)

#endif // OAIRecipient_107_H
