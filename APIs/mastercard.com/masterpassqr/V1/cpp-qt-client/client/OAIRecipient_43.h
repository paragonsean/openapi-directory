...
#ifndef OAIRecipient_43_H
#define OAIRecipient_43_H
...
namespace OpenAPI {
class OAIAdditionalMerchantData_45;
class OAIAddress_44;

class OAIRecipient_43 : public OAIObject {
public:
    OAIRecipient_43();
    OAIRecipient_43(QString json);
    ~OAIRecipient_43() override;
    ...
    OAIAdditionalMerchantData_45 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_45 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_44 getAddress() const;
    void setAddress(const OAIAddress_44 &address);
...
private:
    ...
    OAIAdditionalMerchantData_45 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_44 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_43)

#endif // OAIRecipient_43_H
