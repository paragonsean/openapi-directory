...
#ifndef OAIRecipient_96_H
#define OAIRecipient_96_H

#include <QJsonObject>

#include "OAIAdditionalMerchantData_98.h"
...
namespace OpenAPI {
class OAIAdditionalMerchantData_98;
class OAIAddress_97;

class OAIRecipient_96 : public OAIObject {
public:
    OAIRecipient_96();
    OAIRecipient_96(QString json);
    ~OAIRecipient_96() override;
    ...
    OAIAdditionalMerchantData_98 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_98 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_97 getAddress() const;
    void setAddress(const OAIAddress_97 &address);
...
private:
    ...
    OAIAdditionalMerchantData_98 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_97 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_96)

#endif // OAIRecipient_96_H
