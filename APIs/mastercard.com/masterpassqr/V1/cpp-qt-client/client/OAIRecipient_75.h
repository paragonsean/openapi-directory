...
#ifndef OAIRecipient_75_H
#define OAIRecipient_75_H
...
namespace OpenAPI {
class OAIAdditionalMerchantData_77;
class OAIAddress_76;

class OAIRecipient_75 : public OAIObject {
public:
    OAIRecipient_75();
    OAIRecipient_75(QString json);
    ~OAIRecipient_75() override;
    ...
    OAIAdditionalMerchantData_77 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_77 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_76 getAddress() const;
    void setAddress(const OAIAddress_76 &address);
...
private:
    ...
    OAIAdditionalMerchantData_77 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_76 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_75)

#endif // OAIRecipient_75_H
