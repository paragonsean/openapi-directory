...
/*
 * OAIMerchantTransfer_71.h
 *
 * An array containing the Transactions in the transfer
 */

#ifndef OAIMerchantTransfer_71_H
#define OAIMerchantTransfer_71_H
...
#include "OAITransferAmount_78.h"
#include <QString>
...
namespace OpenAPI {
class OAIParticipant_85;
class OAIRecipient_75;
class OAIReconciliationData_83;
class OAISender_72;
class OAITransactionHistory_79;
class OAITransferAmount_78;

class OAIMerchantTransfer_71 : public OAIObject {
public:
    OAIMerchantTransfer_71();
    OAIMerchantTransfer_71(QString json);
    ~OAIMerchantTransfer_71() override;
    ...
    OAIParticipant_85 getParticipant() const;
    void setParticipant(const OAIParticipant_85 &participant);
    ...
    OAIRecipient_75 getRecipient() const;
    void setRecipient(const OAIRecipient_75 &recipient);
    ...
    OAIReconciliationData_83 getReconciliationData() const;
    void setReconciliationData(const OAIReconciliationData_83 &reconciliation_data);
    ...
    OAISender_72 getSender() const;
    void setSender(const OAISender_72 &sender);
    ...
    OAITransactionHistory_79 getTransactionHistory() const;
    void setTransactionHistory(const OAITransactionHistory_79 &transaction_history);
    ...
    OAITransferAmount_78 getTransferAmount() const;
    void setTransferAmount(const OAITransferAmount_78 &transfer_amount);
...
private:
    ...
    OAIParticipant_85 m_participant;
    ...
    OAIReconciliationData_83 m_reconciliation_data;
    ...
    OAITransactionHistory_79 m_transaction_history;
    ...
    OAITransferAmount_78 m_transfer_amount;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantTransfer_71)

#endif // OAIMerchantTransfer_71_H
