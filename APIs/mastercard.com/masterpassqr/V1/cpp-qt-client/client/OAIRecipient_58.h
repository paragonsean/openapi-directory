...
#ifndef OAIRecipient_58_H
#define OAIRecipient_58_H

#include <QJsonObject>

#include "OAIAdditionalMerchantData_60.h"
#include "OAIAddress_59.h"
#include <QString>
...
namespace OpenAPI {
class OAIAdditionalMerchantData_60;
class OAIAddress_59;

class OAIRecipient_58 : public OAIObject {
public:
    OAIRecipient_58();
    OAIRecipient_58(QString json);
    ~OAIRecipient_58() override;
    ...
    OAIAdditionalMerchantData_60 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_60 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_59 getAddress() const;
    void setAddress(const OAIAddress_59 &address);
...
private:
    ...
    OAIAdditionalMerchantData_60 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_59 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_58)

#endif // OAIRecipient_58_H
