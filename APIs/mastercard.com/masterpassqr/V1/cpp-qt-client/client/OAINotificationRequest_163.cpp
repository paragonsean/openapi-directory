...
OAINotificationRequest_163::OAINotificationRequest_163(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationRequest_163::OAINotificationRequest_163() {
    this->initializeModel();
}

OAINotificationRequest_163::~OAINotificationRequest_163() {}

void OAINotificationRequest_163::initializeModel() {
...
void OAINotificationRequest_163::fromJson(QString jsonString) {
...
void OAINotificationRequest_163::fromJsonObject(QJsonObject json) {
...
QString OAINotificationRequest_163::asJson() const {
...
QJsonObject OAINotificationRequest_163::asJsonObject() const {
    QJsonObject obj;
...
QString OAINotificationRequest_163::getAdditionalMessage() const {
    return m_additional_message;
}
void OAINotificationRequest_163::setAdditionalMessage(const QString &additional_message) {
    m_additional_message = additional_message;
    m_additional_message_isSet = true;
}

bool OAINotificationRequest_163::is_additional_message_Set() const{
    return m_additional_message_isSet;
}

bool OAINotificationRequest_163::is_additional_message_Valid() const{
    return m_additional_message_isValid;
}

QString OAINotificationRequest_163::getMastercardAssignedId() const {
    return m_mastercard_assigned_id;
}
void OAINotificationRequest_163::setMastercardAssignedId(const QString &mastercard_assigned_id) {
    m_mastercard_assigned_id = mastercard_assigned_id;
    m_mastercard_assigned_id_isSet = true;
}

bool OAINotificationRequest_163::is_mastercard_assigned_id_Set() const{
    return m_mastercard_assigned_id_isSet;
}

bool OAINotificationRequest_163::is_mastercard_assigned_id_Valid() const{
    return m_mastercard_assigned_id_isValid;
}

QString OAINotificationRequest_163::getMerchantCategoryCode() const {
    return m_merchant_category_code;
}
void OAINotificationRequest_163::setMerchantCategoryCode(const QString &merchant_category_code) {
    m_merchant_category_code = merchant_category_code;
    m_merchant_category_code_isSet = true;
}

bool OAINotificationRequest_163::is_merchant_category_code_Set() const{
    return m_merchant_category_code_isSet;
}

bool OAINotificationRequest_163::is_merchant_category_code_Valid() const{
    return m_merchant_category_code_isValid;
}

QString OAINotificationRequest_163::getPaymentFacilitatorId() const {
    return m_payment_facilitator_id;
}
void OAINotificationRequest_163::setPaymentFacilitatorId(const QString &payment_facilitator_id) {
    m_payment_facilitator_id = payment_facilitator_id;
    m_payment_facilitator_id_isSet = true;
}

bool OAINotificationRequest_163::is_payment_facilitator_id_Set() const{
    return m_payment_facilitator_id_isSet;
}

bool OAINotificationRequest_163::is_payment_facilitator_id_Valid() const{
    return m_payment_facilitator_id_isValid;
}

QString OAINotificationRequest_163::getPaymentType() const {
    return m_payment_type;
}
void OAINotificationRequest_163::setPaymentType(const QString &payment_type) {
    m_payment_type = payment_type;
    m_payment_type_isSet = true;
}

bool OAINotificationRequest_163::is_payment_type_Set() const{
    return m_payment_type_isSet;
}

bool OAINotificationRequest_163::is_payment_type_Valid() const{
    return m_payment_type_isValid;
}

OAIRecipient_165 OAINotificationRequest_163::getRecipient() const {
    return m_recipient;
}
void OAINotificationRequest_163::setRecipient(const OAIRecipient_165 &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAINotificationRequest_163::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAINotificationRequest_163::is_recipient_Valid() const{
    return m_recipient_isValid;
}

QString OAINotificationRequest_163::getRecipientAccountUri() const {
    return m_recipient_account_uri;
}
void OAINotificationRequest_163::setRecipientAccountUri(const QString &recipient_account_uri) {
    m_recipient_account_uri = recipient_account_uri;
    m_recipient_account_uri_isSet = true;
}

bool OAINotificationRequest_163::is_recipient_account_uri_Set() const{
    return m_recipient_account_uri_isSet;
}

bool OAINotificationRequest_163::is_recipient_account_uri_Valid() const{
    return m_recipient_account_uri_isValid;
}

OAITransactionAmount_164 OAINotificationRequest_163::getTransactionAmount() const {
    return m_transaction_amount;
}
void OAINotificationRequest_163::setTransactionAmount(const OAITransactionAmount_164 &transaction_amount) {
    m_transaction_amount = transaction_amount;
    m_transaction_amount_isSet = true;
}

bool OAINotificationRequest_163::is_transaction_amount_Set() const{
    return m_transaction_amount_isSet;
}

bool OAINotificationRequest_163::is_transaction_amount_Valid() const{
    return m_transaction_amount_isValid;
}

QString OAINotificationRequest_163::getTransferStatus() const {
    return m_transfer_status;
}
void OAINotificationRequest_163::setTransferStatus(const QString &transfer_status) {
    m_transfer_status = transfer_status;
    m_transfer_status_isSet = true;
}

bool OAINotificationRequest_163::is_transfer_status_Set() const{
    return m_transfer_status_isSet;
}

bool OAINotificationRequest_163::is_transfer_status_Valid() const{
    return m_transfer_status_isValid;
}

bool OAINotificationRequest_163::isSet() const {
...
bool OAINotificationRequest_163::isValid() const {
