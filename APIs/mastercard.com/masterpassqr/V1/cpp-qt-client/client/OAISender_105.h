...
#ifndef OAISender_105_H
#define OAISender_105_H
...
namespace OpenAPI {
class OAIAddress_106;

class OAISender_105 : public OAIObject {
public:
    OAISender_105();
    OAISender_105(QString json);
    ~OAISender_105() override;
    ...
    OAIAddress_106 getAddress() const;
    void setAddress(const OAIAddress_106 &address);
...
Q_DECLARE_METATYPE(OpenAPI::OAISender_105)

#endif // OAISender_105_H
