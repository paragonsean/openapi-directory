...
/*
 * OAINotificationRequest_163.h
 *
 * Contains the details of the request message.
 */

#ifndef OAINotificationRequest_163_H
#define OAINotificationRequest_163_H
...
namespace OpenAPI {
class OAIRecipient_165;
class OAITransactionAmount_164;

class OAINotificationRequest_163 : public OAIObject {
public:
    OAINotificationRequest_163();
    OAINotificationRequest_163(QString json);
    ~OAINotificationRequest_163() override;
    ...
    OAIRecipient_165 getRecipient() const;
    void setRecipient(const OAIRecipient_165 &recipient);
    ...
    OAITransactionAmount_164 getTransactionAmount() const;
    void setTransactionAmount(const OAITransactionAmount_164 &transaction_amount);
...
private:
    ...
    OAITransactionAmount_164 m_transaction_amount;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRequest_163)

#endif // OAINotificationRequest_163_H
