...
#ifndef OAIAddress_4_H
#define OAIAddress_4_H
...
class OAIAddress_4 : public OAIObject {
public:
    OAIAddress_4();
    OAIAddress_4(QString json);
    ~OAIAddress_4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress_4)

#endif // OAIAddress_4_H
