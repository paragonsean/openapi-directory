...
#ifndef OAIRecipient_149_H
#define OAIRecipient_149_H

#include <QJsonObject>

#include "OAIAddress_150.h"
...
namespace OpenAPI {
class OAIAddress_150;
class OAIGovernmentIds_151;

class OAIRecipient_149 : public OAIObject {
public:
    OAIRecipient_149();
    OAIRecipient_149(QString json);
    ~OAIRecipient_149() override;
    ...
    OAIAddress_150 getAddress() const;
    void setAddress(const OAIAddress_150 &address);
    ...
    OAIGovernmentIds_151 getGovernmentIds() const;
    void setGovernmentIds(const OAIGovernmentIds_151 &government_ids);
...
private:
    ...
    OAIGovernmentIds_151 m_government_ids;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipient_149)

#endif // OAIRecipient_149_H
