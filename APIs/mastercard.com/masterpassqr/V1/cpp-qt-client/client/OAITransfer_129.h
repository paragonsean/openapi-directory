...
#ifndef OAITransfer_129_H
#define OAITransfer_129_H
...
#include "OAITransferAmount_137.h"
#include <QString>
...
namespace OpenAPI {
class OAIRecipient_134;
class OAIReconciliationData_142;
class OAISender_130;
class OAITransactionHistory_138;
class OAITransferAmount_137;

class OAITransfer_129 : public OAIObject {
public:
    OAITransfer_129();
    OAITransfer_129(QString json);
    ~OAITransfer_129() override;
    ...
    OAIRecipient_134 getRecipient() const;
    void setRecipient(const OAIRecipient_134 &recipient);
    ...
    OAIReconciliationData_142 getReconciliationData() const;
    void setReconciliationData(const OAIReconciliationData_142 &reconciliation_data);
    ...
    OAISender_130 getSender() const;
    void setSender(const OAISender_130 &sender);
    ...
    OAITransactionHistory_138 getTransactionHistory() const;
    void setTransactionHistory(const OAITransactionHistory_138 &transaction_history);
    bool is_transaction_history_Set() const;
    bool is_transaction_history_Valid() const;

    OAITransferAmount_137 getTransferAmount() const;
    void setTransferAmount(const OAITransferAmount_137 &transfer_amount);
...
private:
    ...
    OAIReconciliationData_142 m_reconciliation_data;
    ...
    OAITransactionHistory_138 m_transaction_history;
    bool m_transaction_history_isSet;
    bool m_transaction_history_isValid;

    OAITransferAmount_137 m_transfer_amount;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransfer_129)

#endif // OAITransfer_129_H
