...
#ifndef OAIAddress_8_H
#define OAIAddress_8_H
...
class OAIAddress_8 : public OAIObject {
public:
    OAIAddress_8();
    OAIAddress_8(QString json);
    ~OAIAddress_8() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress_8)

#endif // OAIAddress_8_H
