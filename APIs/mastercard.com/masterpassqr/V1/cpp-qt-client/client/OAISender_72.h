...
#ifndef OAISender_72_H
#define OAISender_72_H
...
namespace OpenAPI {
class OAIAdditionalMerchantData_74;
class OAIAddress_73;

class OAISender_72 : public OAIObject {
public:
    OAISender_72();
    OAISender_72(QString json);
    ~OAISender_72() override;
    ...
    OAIAdditionalMerchantData_74 getAdditionalMerchantData() const;
    void setAdditionalMerchantData(const OAIAdditionalMerchantData_74 &additional_merchant_data);
    bool is_additional_merchant_data_Set() const;
    bool is_additional_merchant_data_Valid() const;

    OAIAddress_73 getAddress() const;
    void setAddress(const OAIAddress_73 &address);
...
private:
    ...
    OAIAdditionalMerchantData_74 m_additional_merchant_data;
    bool m_additional_merchant_data_isSet;
    bool m_additional_merchant_data_isValid;

    OAIAddress_73 m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAISender_72)

#endif // OAISender_72_H
