...
public class Address31 {
  ...
  public Address31 city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Address31 country(String country) {
  ...
  public Address31 countrySubdivision(String countrySubdivision) {
  ...
  public Address31 line1(String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public Address31 line2(String line2) {
    this.line2 = line2;
    return this;
  }
  ...
  public Address31 postalCode(String postalCode) {
  ...
  public boolean equals(Object o) {
    ...
    Address31 address31 = (Address31) o;
    return Objects.equals(this.city, address31.city) &&
        Objects.equals(this.country, address31.country) &&
        Objects.equals(this.countrySubdivision, address31.countrySubdivision) &&
        Objects.equals(this.line1, address31.line1) &&
        Objects.equals(this.line2, address31.line2) &&
        Objects.equals(this.postalCode, address31.postalCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Address31
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Address31.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Address31 is not found in the empty JSON string", Address31.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Address31.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Address31` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Address31.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Address31.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Address31' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Address31> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Address31.class));

       return (TypeAdapter<T>) new TypeAdapter<Address31>() {
           @Override
           public void write(JsonWriter out, Address31 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Address31 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Address31 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Address31
   * @throws IOException if the JSON string is invalid with respect to Address31
   */
  public static Address31 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Address31.class);
  }

  /**
   * Convert an instance of Address31 to an JSON string
   *
   * @return JSON string
   */
