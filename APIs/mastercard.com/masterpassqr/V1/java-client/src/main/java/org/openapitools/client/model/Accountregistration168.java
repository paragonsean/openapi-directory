...
public class Accountregistration168 {
  ...
  public Accountregistration168() {
  }

  public Accountregistration168 accountRegistrationReference(String accountRegistrationReference) {
  ...
  public Accountregistration168 accountUri(String accountUri) {
  ...
  public Accountregistration168 notificationPartnerId(String notificationPartnerId) {
  ...
  public Accountregistration168 notificationPartnerName(String notificationPartnerName) {
  ...
  public boolean equals(Object o) {
    ...
    Accountregistration168 accountregistration168 = (Accountregistration168) o;
    return Objects.equals(this.accountRegistrationReference, accountregistration168.accountRegistrationReference) &&
        Objects.equals(this.accountUri, accountregistration168.accountUri) &&
        Objects.equals(this.notificationPartnerId, accountregistration168.notificationPartnerId) &&
        Objects.equals(this.notificationPartnerName, accountregistration168.notificationPartnerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class Accountregistration168 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Accountregistration168
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Accountregistration168.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Accountregistration168 is not found in the empty JSON string", Accountregistration168.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Accountregistration168.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Accountregistration168` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Accountregistration168.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Accountregistration168' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Accountregistration168> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Accountregistration168.class));

       return (TypeAdapter<T>) new TypeAdapter<Accountregistration168>() {
           @Override
           public void write(JsonWriter out, Accountregistration168 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Accountregistration168 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Accountregistration168 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Accountregistration168
   * @throws IOException if the JSON string is invalid with respect to Accountregistration168
   */
  public static Accountregistration168 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Accountregistration168.class);
  }

  /**
   * Convert an instance of Accountregistration168 to an JSON string
   *
   * @return JSON string
   */
