...
public class Accountregistration170 {
  ...
  public Accountregistration170() {
  }

  public Accountregistration170 accountRegistrationReference(String accountRegistrationReference) {
  ...
  public Accountregistration170 accountUri(String accountUri) {
  ...
  public Accountregistration170 notificationPartnerId(String notificationPartnerId) {
  ...
  public Accountregistration170 notificationPartnerName(String notificationPartnerName) {
  ...
  public boolean equals(Object o) {
    ...
    Accountregistration170 accountregistration170 = (Accountregistration170) o;
    return Objects.equals(this.accountRegistrationReference, accountregistration170.accountRegistrationReference) &&
        Objects.equals(this.accountUri, accountregistration170.accountUri) &&
        Objects.equals(this.notificationPartnerId, accountregistration170.notificationPartnerId) &&
        Objects.equals(this.notificationPartnerName, accountregistration170.notificationPartnerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class Accountregistration170 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Accountregistration170
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Accountregistration170.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Accountregistration170 is not found in the empty JSON string", Accountregistration170.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Accountregistration170.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Accountregistration170` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Accountregistration170.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Accountregistration170' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Accountregistration170> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Accountregistration170.class));

       return (TypeAdapter<T>) new TypeAdapter<Accountregistration170>() {
           @Override
           public void write(JsonWriter out, Accountregistration170 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Accountregistration170 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Accountregistration170 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Accountregistration170
   * @throws IOException if the JSON string is invalid with respect to Accountregistration170
   */
  public static Accountregistration170 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Accountregistration170.class);
  }

  /**
   * Convert an instance of Accountregistration170 to an JSON string
   *
   * @return JSON string
   */
