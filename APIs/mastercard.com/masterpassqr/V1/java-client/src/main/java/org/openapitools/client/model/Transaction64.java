...
public class Transaction64 {
  ...
  private TransactionAmount65 transactionAmount;
  ...
  public Transaction64() {
  }

  public Transaction64 accountUri(String accountUri) {
  ...
  public Transaction64 authorizationId(String authorizationId) {
  ...
  public Transaction64 convenienceAmount(String convenienceAmount) {
  ...
  public Transaction64 convenienceIndicator(String convenienceIndicator) {
  ...
  public Transaction64 createTimestamp(String createTimestamp) {
  ...
  public Transaction64 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction64 network(String network) {
  ...
  public Transaction64 networkStatusCode(String networkStatusCode) {
  ...
  public Transaction64 networkStatusDescription(String networkStatusDescription) {
  ...
  public Transaction64 paymentAccountReference(String paymentAccountReference) {
  ...
  public Transaction64 qrData(String qrData) {
    this.qrData = qrData;
    return this;
  }
  ...
  public Transaction64 resourceType(String resourceType) {
  ...
  public Transaction64 retrievalReference(String retrievalReference) {
  ...
  public Transaction64 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Transaction64 statusReason(String statusReason) {
  ...
  public Transaction64 statusTimestamp(String statusTimestamp) {
  ...
  public Transaction64 switchSerialNumber(String switchSerialNumber) {
  ...
  public Transaction64 systemTraceAuditNumber(String systemTraceAuditNumber) {
  ...
  public Transaction64 transactionAmount(TransactionAmount65 transactionAmount) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionAmount65 getTransactionAmount() {
    return transactionAmount;
  }

  public void setTransactionAmount(TransactionAmount65 transactionAmount) {
    this.transactionAmount = transactionAmount;
  }


  public Transaction64 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Transaction64 uniqueReferenceNumber(String uniqueReferenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    Transaction64 transaction64 = (Transaction64) o;
    return Objects.equals(this.accountUri, transaction64.accountUri) &&
        Objects.equals(this.authorizationId, transaction64.authorizationId) &&
        Objects.equals(this.convenienceAmount, transaction64.convenienceAmount) &&
        Objects.equals(this.convenienceIndicator, transaction64.convenienceIndicator) &&
        Objects.equals(this.createTimestamp, transaction64.createTimestamp) &&
        Objects.equals(this.id, transaction64.id) &&
        Objects.equals(this.network, transaction64.network) &&
        Objects.equals(this.networkStatusCode, transaction64.networkStatusCode) &&
        Objects.equals(this.networkStatusDescription, transaction64.networkStatusDescription) &&
        Objects.equals(this.paymentAccountReference, transaction64.paymentAccountReference) &&
        Objects.equals(this.qrData, transaction64.qrData) &&
        Objects.equals(this.resourceType, transaction64.resourceType) &&
        Objects.equals(this.retrievalReference, transaction64.retrievalReference) &&
        Objects.equals(this.status, transaction64.status) &&
        Objects.equals(this.statusReason, transaction64.statusReason) &&
        Objects.equals(this.statusTimestamp, transaction64.statusTimestamp) &&
        Objects.equals(this.switchSerialNumber, transaction64.switchSerialNumber) &&
        Objects.equals(this.systemTraceAuditNumber, transaction64.systemTraceAuditNumber) &&
        Objects.equals(this.transactionAmount, transaction64.transactionAmount) &&
        Objects.equals(this.type, transaction64.type) &&
        Objects.equals(this.uniqueReferenceNumber, transaction64.uniqueReferenceNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction64
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction64.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction64 is not found in the empty JSON string", Transaction64.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction64.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction64` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("transaction_amount") != null && !jsonObj.get("transaction_amount").isJsonNull()) {
        TransactionAmount65.validateJsonElement(jsonObj.get("transaction_amount"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction64.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction64>() {
           @Override
           public void write(JsonWriter out, Transaction64 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction64 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction64 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction64
   * @throws IOException if the JSON string is invalid with respect to Transaction64
   */
  public static Transaction64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction64.class);
  }

  /**
   * Convert an instance of Transaction64 to an JSON string
   *
   * @return JSON string
   */
