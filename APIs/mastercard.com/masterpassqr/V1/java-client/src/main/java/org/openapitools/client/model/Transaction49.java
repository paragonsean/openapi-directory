...
import org.openapitools.client.model.TransactionAmount50;
...
public class Transaction49 {
  ...
  private TransactionAmount50 transactionAmount;
  ...
  public Transaction49() {
  }

  public Transaction49 accountUri(String accountUri) {
  ...
  public Transaction49 authorizationId(String authorizationId) {
  ...
  public Transaction49 createTimestamp(String createTimestamp) {
  ...
  public Transaction49 fundsAvailability(String fundsAvailability) {
  ...
  public Transaction49 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction49 network(String network) {
  ...
  public Transaction49 networkStatusCode(String networkStatusCode) {
  ...
  public Transaction49 networkStatusDescription(String networkStatusDescription) {
  ...
  public Transaction49 paymentAccountReference(String paymentAccountReference) {
  ...
  public Transaction49 resourceType(String resourceType) {
  ...
  public Transaction49 retrievalReference(String retrievalReference) {
  ...
  public Transaction49 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Transaction49 statusReason(String statusReason) {
  ...
  public Transaction49 statusTimestamp(String statusTimestamp) {
  ...
  public Transaction49 switchSerialNumber(String switchSerialNumber) {
  ...
  public Transaction49 systemTraceAuditNumber(String systemTraceAuditNumber) {
  ...
  public Transaction49 transactionAmount(TransactionAmount50 transactionAmount) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionAmount50 getTransactionAmount() {
    return transactionAmount;
  }

  public void setTransactionAmount(TransactionAmount50 transactionAmount) {
    this.transactionAmount = transactionAmount;
  }


  public Transaction49 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Transaction49 uniqueReferenceNumber(String uniqueReferenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    Transaction49 transaction49 = (Transaction49) o;
    return Objects.equals(this.accountUri, transaction49.accountUri) &&
        Objects.equals(this.authorizationId, transaction49.authorizationId) &&
        Objects.equals(this.createTimestamp, transaction49.createTimestamp) &&
        Objects.equals(this.fundsAvailability, transaction49.fundsAvailability) &&
        Objects.equals(this.id, transaction49.id) &&
        Objects.equals(this.network, transaction49.network) &&
        Objects.equals(this.networkStatusCode, transaction49.networkStatusCode) &&
        Objects.equals(this.networkStatusDescription, transaction49.networkStatusDescription) &&
        Objects.equals(this.paymentAccountReference, transaction49.paymentAccountReference) &&
        Objects.equals(this.resourceType, transaction49.resourceType) &&
        Objects.equals(this.retrievalReference, transaction49.retrievalReference) &&
        Objects.equals(this.status, transaction49.status) &&
        Objects.equals(this.statusReason, transaction49.statusReason) &&
        Objects.equals(this.statusTimestamp, transaction49.statusTimestamp) &&
        Objects.equals(this.switchSerialNumber, transaction49.switchSerialNumber) &&
        Objects.equals(this.systemTraceAuditNumber, transaction49.systemTraceAuditNumber) &&
        Objects.equals(this.transactionAmount, transaction49.transactionAmount) &&
        Objects.equals(this.type, transaction49.type) &&
        Objects.equals(this.uniqueReferenceNumber, transaction49.uniqueReferenceNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction49
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction49.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction49 is not found in the empty JSON string", Transaction49.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction49.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction49` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("transaction_amount") != null && !jsonObj.get("transaction_amount").isJsonNull()) {
        TransactionAmount50.validateJsonElement(jsonObj.get("transaction_amount"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction49.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction49' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction49> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction49.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction49>() {
           @Override
           public void write(JsonWriter out, Transaction49 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction49 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction49 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction49
   * @throws IOException if the JSON string is invalid with respect to Transaction49
   */
  public static Transaction49 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction49.class);
  }

  /**
   * Convert an instance of Transaction49 to an JSON string
   *
   * @return JSON string
   */
