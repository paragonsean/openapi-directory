...
import org.openapitools.client.model.TransactionAmount114;
...
public class Transaction113 {
  ...
  private TransactionAmount114 transactionAmount;
  ...
  public Transaction113() {
  }

  public Transaction113 accountUri(String accountUri) {
  ...
  public Transaction113 authorizationId(String authorizationId) {
  ...
  public Transaction113 createTimestamp(String createTimestamp) {
  ...
  public Transaction113 fundsAvailability(String fundsAvailability) {
  ...
  public Transaction113 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Transaction113 network(String network) {
  ...
  public Transaction113 networkStatusCode(String networkStatusCode) {
  ...
  public Transaction113 networkStatusDescription(String networkStatusDescription) {
  ...
  public Transaction113 paymentAccountReference(String paymentAccountReference) {
  ...
  public Transaction113 resourceType(String resourceType) {
  ...
  public Transaction113 retrievalReference(String retrievalReference) {
  ...
  public Transaction113 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Transaction113 statusReason(String statusReason) {
  ...
  public Transaction113 statusTimestamp(String statusTimestamp) {
  ...
  public Transaction113 switchSerialNumber(String switchSerialNumber) {
  ...
  public Transaction113 systemTraceAuditNumber(String systemTraceAuditNumber) {
  ...
  public Transaction113 transactionAmount(TransactionAmount114 transactionAmount) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionAmount114 getTransactionAmount() {
    return transactionAmount;
  }

  public void setTransactionAmount(TransactionAmount114 transactionAmount) {
    this.transactionAmount = transactionAmount;
  }


  public Transaction113 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Transaction113 uniqueReferenceNumber(String uniqueReferenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    Transaction113 transaction113 = (Transaction113) o;
    return Objects.equals(this.accountUri, transaction113.accountUri) &&
        Objects.equals(this.authorizationId, transaction113.authorizationId) &&
        Objects.equals(this.createTimestamp, transaction113.createTimestamp) &&
        Objects.equals(this.fundsAvailability, transaction113.fundsAvailability) &&
        Objects.equals(this.id, transaction113.id) &&
        Objects.equals(this.network, transaction113.network) &&
        Objects.equals(this.networkStatusCode, transaction113.networkStatusCode) &&
        Objects.equals(this.networkStatusDescription, transaction113.networkStatusDescription) &&
        Objects.equals(this.paymentAccountReference, transaction113.paymentAccountReference) &&
        Objects.equals(this.resourceType, transaction113.resourceType) &&
        Objects.equals(this.retrievalReference, transaction113.retrievalReference) &&
        Objects.equals(this.status, transaction113.status) &&
        Objects.equals(this.statusReason, transaction113.statusReason) &&
        Objects.equals(this.statusTimestamp, transaction113.statusTimestamp) &&
        Objects.equals(this.switchSerialNumber, transaction113.switchSerialNumber) &&
        Objects.equals(this.systemTraceAuditNumber, transaction113.systemTraceAuditNumber) &&
        Objects.equals(this.transactionAmount, transaction113.transactionAmount) &&
        Objects.equals(this.type, transaction113.type) &&
        Objects.equals(this.uniqueReferenceNumber, transaction113.uniqueReferenceNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountUri, authorizationId, createTimestamp, fundsAvailability, id, network, networkStatusCode, networkStatusDescription, paymentAccountReference, resourceType, retrievalReference, status, statusReason, statusTimestamp, switchSerialNumber, systemTraceAuditNumber, transactionAmount, type, uniqueReferenceNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Transaction113 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction113
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction113.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction113 is not found in the empty JSON string", Transaction113.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction113.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction113` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("transaction_amount") != null && !jsonObj.get("transaction_amount").isJsonNull()) {
        TransactionAmount114.validateJsonElement(jsonObj.get("transaction_amount"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction113.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction113' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction113> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction113.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction113>() {
           @Override
           public void write(JsonWriter out, Transaction113 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction113 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction113 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction113
   * @throws IOException if the JSON string is invalid with respect to Transaction113
   */
  public static Transaction113 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction113.class);
  }

  /**
   * Convert an instance of Transaction113 to an JSON string
   *
   * @return JSON string
   */
