...
public class MerchantTransfer54 {
  ...
  private Participant68 participant;
  ...
  private ReconciliationData66 reconciliationData;
  ...
  private TransactionHistory62 transactionHistory;
  ...
  private TransferAmount61 transferAmount;
  ...
  public MerchantTransfer54() {
  }

  public MerchantTransfer54 channel(String channel) {
  ...
  public MerchantTransfer54 created(String created) {
  ...
  public MerchantTransfer54 deviceId(String deviceId) {
  ...
  public MerchantTransfer54 digitalAccountReferenceNumber(String digitalAccountReferenceNumber) {
  ...
  public MerchantTransfer54 fundingSource(String fundingSource) {
  ...
  public MerchantTransfer54 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MerchantTransfer54 interchangeRateDesignator(String interchangeRateDesignator) {
  ...
  public MerchantTransfer54 location(String location) {
  ...
  public MerchantTransfer54 originalStatus(String originalStatus) {
  ...
  public MerchantTransfer54 participant(Participant68 participant) {
   ...
   */
  @javax.annotation.Nullable
  public Participant68 getParticipant() {
    return participant;
  }

  public void setParticipant(Participant68 participant) {
    this.participant = participant;
  }


  public MerchantTransfer54 paymentOriginationCountry(String paymentOriginationCountry) {
  ...
  public MerchantTransfer54 paymentType(String paymentType) {
  ...
  public MerchantTransfer54 processorId(String processorId) {
  ...
  public MerchantTransfer54 recipient(Recipient58 recipient) {
   ...
   */
  @javax.annotation.Nullable
  public Recipient58 getRecipient() {
    return recipient;
  }

  public void setRecipient(Recipient58 recipient) {
    this.recipient = recipient;
  }


  public MerchantTransfer54 recipientAccountUri(String recipientAccountUri) {
  ...
  public MerchantTransfer54 reconciliationData(ReconciliationData66 reconciliationData) {
   ...
   */
  @javax.annotation.Nullable
  public ReconciliationData66 getReconciliationData() {
    return reconciliationData;
  }

  public void setReconciliationData(ReconciliationData66 reconciliationData) {
    this.reconciliationData = reconciliationData;
  }


  public MerchantTransfer54 resourceType(String resourceType) {
  ...
  public MerchantTransfer54 routingTransitNumber(String routingTransitNumber) {
  ...
  public MerchantTransfer54 sender(Sender55 sender) {
    this.sender = sender;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Sender55 getSender() {
    return sender;
  }

  public void setSender(Sender55 sender) {
    this.sender = sender;
  }


  public MerchantTransfer54 senderAccountUri(String senderAccountUri) {
  ...
  public MerchantTransfer54 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public MerchantTransfer54 statusTimestamp(String statusTimestamp) {
  ...
  public MerchantTransfer54 transactionHistory(TransactionHistory62 transactionHistory) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionHistory62 getTransactionHistory() {
    return transactionHistory;
  }

  public void setTransactionHistory(TransactionHistory62 transactionHistory) {
    this.transactionHistory = transactionHistory;
  }


  public MerchantTransfer54 transactionLocalDateTime(String transactionLocalDateTime) {
  ...
  public MerchantTransfer54 transferAmount(TransferAmount61 transferAmount) {
   ...
   */
  @javax.annotation.Nullable
  public TransferAmount61 getTransferAmount() {
    return transferAmount;
  }

  public void setTransferAmount(TransferAmount61 transferAmount) {
    this.transferAmount = transferAmount;
  }


  public MerchantTransfer54 transferReference(String transferReference) {
  ...
  public boolean equals(Object o) {
    ...
    MerchantTransfer54 merchantTransfer54 = (MerchantTransfer54) o;
    return Objects.equals(this.channel, merchantTransfer54.channel) &&
        Objects.equals(this.created, merchantTransfer54.created) &&
        Objects.equals(this.deviceId, merchantTransfer54.deviceId) &&
        Objects.equals(this.digitalAccountReferenceNumber, merchantTransfer54.digitalAccountReferenceNumber) &&
        Objects.equals(this.fundingSource, merchantTransfer54.fundingSource) &&
        Objects.equals(this.id, merchantTransfer54.id) &&
        Objects.equals(this.interchangeRateDesignator, merchantTransfer54.interchangeRateDesignator) &&
        Objects.equals(this.location, merchantTransfer54.location) &&
        Objects.equals(this.originalStatus, merchantTransfer54.originalStatus) &&
        Objects.equals(this.participant, merchantTransfer54.participant) &&
        Objects.equals(this.paymentOriginationCountry, merchantTransfer54.paymentOriginationCountry) &&
        Objects.equals(this.paymentType, merchantTransfer54.paymentType) &&
        Objects.equals(this.processorId, merchantTransfer54.processorId) &&
        Objects.equals(this.recipient, merchantTransfer54.recipient) &&
        Objects.equals(this.recipientAccountUri, merchantTransfer54.recipientAccountUri) &&
        Objects.equals(this.reconciliationData, merchantTransfer54.reconciliationData) &&
        Objects.equals(this.resourceType, merchantTransfer54.resourceType) &&
        Objects.equals(this.routingTransitNumber, merchantTransfer54.routingTransitNumber) &&
        Objects.equals(this.sender, merchantTransfer54.sender) &&
        Objects.equals(this.senderAccountUri, merchantTransfer54.senderAccountUri) &&
        Objects.equals(this.status, merchantTransfer54.status) &&
        Objects.equals(this.statusTimestamp, merchantTransfer54.statusTimestamp) &&
        Objects.equals(this.transactionHistory, merchantTransfer54.transactionHistory) &&
        Objects.equals(this.transactionLocalDateTime, merchantTransfer54.transactionLocalDateTime) &&
        Objects.equals(this.transferAmount, merchantTransfer54.transferAmount) &&
        Objects.equals(this.transferReference, merchantTransfer54.transferReference);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantTransfer54 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantTransfer54
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantTransfer54.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantTransfer54 is not found in the empty JSON string", MerchantTransfer54.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantTransfer54.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantTransfer54` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("participant") != null && !jsonObj.get("participant").isJsonNull()) {
        Participant68.validateJsonElement(jsonObj.get("participant"));
      }
      ...
      if (jsonObj.get("recipient") != null && !jsonObj.get("recipient").isJsonNull()) {
        Recipient58.validateJsonElement(jsonObj.get("recipient"));
      }
      ...
      if (jsonObj.get("reconciliation_data") != null && !jsonObj.get("reconciliation_data").isJsonNull()) {
        ReconciliationData66.validateJsonElement(jsonObj.get("reconciliation_data"));
      }
      ...
      if (jsonObj.get("sender") != null && !jsonObj.get("sender").isJsonNull()) {
        Sender55.validateJsonElement(jsonObj.get("sender"));
      }
      ...
      if (jsonObj.get("transaction_history") != null && !jsonObj.get("transaction_history").isJsonNull()) {
        TransactionHistory62.validateJsonElement(jsonObj.get("transaction_history"));
      }
      ...
      if (jsonObj.get("transfer_amount") != null && !jsonObj.get("transfer_amount").isJsonNull()) {
        TransferAmount61.validateJsonElement(jsonObj.get("transfer_amount"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantTransfer54.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantTransfer54' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantTransfer54> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantTransfer54.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantTransfer54>() {
           @Override
           public void write(JsonWriter out, MerchantTransfer54 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantTransfer54 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantTransfer54 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantTransfer54
   * @throws IOException if the JSON string is invalid with respect to MerchantTransfer54
   */
  public static MerchantTransfer54 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantTransfer54.class);
  }

  /**
   * Convert an instance of MerchantTransfer54 to an JSON string
   *
   * @return JSON string
   */
