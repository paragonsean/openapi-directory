...
|**authorizationId** | **String** | Transaction response ID code that the authorizing institution assigns. This ID will be same as the original funding only transaction.  Type: Alphanumeric [a-zA-Z 0-9], Length: 6. |  [optional] |
...
|**paymentAccountReference** | **String** | A unique value associated with a single PAN and attributed to all tokens associated with that PAN. This attribute will be same as original funidng only transaction.  Type: Alphanumeric [a-zA-Z 0-9], Length: 29. |  [optional] |
...
|**reversalReason** | **String** | Brief description of reason for reversal. |  [optional] |
...
|**transactionAmount** | [**TransactionAmount156**](TransactionAmount156.md) |  |  [optional] |
