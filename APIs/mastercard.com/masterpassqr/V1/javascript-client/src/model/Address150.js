...
/**
 * The Address150 model module.
 * @module model/Address150
 * @version V1
 */
class Address150 {
    /**
     * Constructs a new <code>Address150</code>.
     *  Address of the recipient.
     * @alias module:model/Address150
     */
    constructor() { 
        
        Address150.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address150</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address150} obj Optional instance to populate.
     * @return {module:model/Address150} The populated <code>Address150</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address150();
    ...
    /**
     * Validates the JSON data with respect to <code>Address150</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address150</code>.
     */
 ...
 * @member {String} city
 */
Address150.prototype['city'] = undefined;

/**
 * Country of the recipient as an ISO alpha country code.
 * @member {String} country
 */
Address150.prototype['country'] = undefined;

/**
 * State or province of the recipient.
 * @member {String} country_subdivision
 */
Address150.prototype['country_subdivision'] = undefined;

/**
 * First line of the address of the recipient.
 * @member {String} line1
 */
Address150.prototype['line1'] = undefined;

/**
 * Second line of the address of the recipient.
 * @member {String} line2
 */
Address150.prototype['line2'] = undefined;

/**
 * Postal code of the recipient.
 * @member {String} postal_code
 */
Address150.prototype['postal_code'] = undefined;
