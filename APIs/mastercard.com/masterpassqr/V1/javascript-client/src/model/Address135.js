...
/**
 * The Address135 model module.
 * @module model/Address135
 * @version V1
 */
class Address135 {
    /**
     * Constructs a new <code>Address135</code>.
     *  Address of the recipient.
     * @alias module:model/Address135
     */
    constructor() { 
        
        Address135.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address135</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address135} obj Optional instance to populate.
     * @return {module:model/Address135} The populated <code>Address135</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address135();
    ...
    /**
     * Validates the JSON data with respect to <code>Address135</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address135</code>.
     */
 ...
 * @member {String} city
 */
Address135.prototype['city'] = undefined;

/**
 * Country of the recipient as an ISO alpha country code.
 * @member {String} country
 */
Address135.prototype['country'] = undefined;

/**
 * State or province of the recipient.
 * @member {String} country_subdivision
 */
Address135.prototype['country_subdivision'] = undefined;

/**
 * First line of the address of the recipient.
 * @member {String} line1
 */
Address135.prototype['line1'] = undefined;

/**
 * Second line of the address of the recipient.
 * @member {String} line2
 */
Address135.prototype['line2'] = undefined;

/**
 * Postal code of the recipient.
 * @member {String} postal_code
 */
Address135.prototype['postal_code'] = undefined;
