...
import Participant68 from './Participant68';
import Recipient58 from './Recipient58';
import ReconciliationData66 from './ReconciliationData66';
import Sender55 from './Sender55';
import TransactionHistory62 from './TransactionHistory62';
import TransferAmount61 from './TransferAmount61';

/**
 * The MerchantTransfer54 model module.
 * @module model/MerchantTransfer54
 * @version V1
 */
class MerchantTransfer54 {
    /**
     * Constructs a new <code>MerchantTransfer54</code>.
     * Response details for a merchant transfer.
     * @alias module:model/MerchantTransfer54
     */
    constructor() { 
        
        MerchantTransfer54.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantTransfer54</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantTransfer54} obj Optional instance to populate.
     * @return {module:model/MerchantTransfer54} The populated <code>MerchantTransfer54</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantTransfer54();
            ...
            if (data.hasOwnProperty('participant')) {
                obj['participant'] = Participant68.constructFromObject(data['participant']);
            }
            ...
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Recipient58.constructFromObject(data['recipient']);
            }
            ...
            if (data.hasOwnProperty('reconciliation_data')) {
                obj['reconciliation_data'] = ReconciliationData66.constructFromObject(data['reconciliation_data']);
            }
            ...
            if (data.hasOwnProperty('sender')) {
                obj['sender'] = Sender55.constructFromObject(data['sender']);
            }
            ...
            if (data.hasOwnProperty('transaction_history')) {
                obj['transaction_history'] = TransactionHistory62.constructFromObject(data['transaction_history']);
            }
            ...
            if (data.hasOwnProperty('transfer_amount')) {
                obj['transfer_amount'] = TransferAmount61.constructFromObject(data['transfer_amount']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantTransfer54</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantTransfer54</code>.
     */
    static validateJSON(data) {
        ...
        if (data['participant']) { // data not null
          Participant68.validateJSON(data['participant']);
        }
        // ensure the json data is a string
        ...
        if (data['recipient']) { // data not null
          Recipient58.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
        ...
        if (data['reconciliation_data']) { // data not null
          ReconciliationData66.validateJSON(data['reconciliation_data']);
        }
        // ensure the json data is a string
        ...
        if (data['sender']) { // data not null
          Sender55.validateJSON(data['sender']);
        }
        // ensure the json data is a string
        ...
        if (data['transaction_history']) { // data not null
          TransactionHistory62.validateJSON(data['transaction_history']);
        }
        // ensure the json data is a string
        ...
        if (data['transfer_amount']) { // data not null
          TransferAmount61.validateJSON(data['transfer_amount']);
        }
        // ensure the json data is a string
 ...
 */
MerchantTransfer54.prototype['channel'] = undefined;
 ...
 */
MerchantTransfer54.prototype['created'] = undefined;

/**
 * The serial number of a device that initiated the transfer.
 * @member {String} device_id
 */
MerchantTransfer54.prototype['device_id'] = undefined;
 ...
 */
MerchantTransfer54.prototype['digital_account_reference_number'] = undefined;
 ...
 */
MerchantTransfer54.prototype['funding_source'] = undefined;

/**
 * System generated unique merchant transfer identifier.
 * @member {String} id
 */
MerchantTransfer54.prototype['id'] = undefined;
 ...
 */
MerchantTransfer54.prototype['interchange_rate_designator'] = undefined;

/**
 * Location where the transaction is initiated. Valid Values- Refer 'Location URIs'.
 * @member {String} location
 */
MerchantTransfer54.prototype['location'] = undefined;

/**
 * Original status of the transfer. One of APPROVED, DECLINED, ERROR, PENDING, UNKNOWN.
 * @member {String} original_status
 */
MerchantTransfer54.prototype['original_status'] = undefined;

/**
 * @member {module:model/Participant68} participant
 */
MerchantTransfer54.prototype['participant'] = undefined;
 ...
 */
MerchantTransfer54.prototype['payment_origination_country'] = undefined;

/**
 * P2M: Person to Merchant
 * @member {String} payment_type
 */
MerchantTransfer54.prototype['payment_type'] = undefined;
 ...
 */
MerchantTransfer54.prototype['processor_id'] = undefined;

/**
 * @member {module:model/Recipient58} recipient
 */
MerchantTransfer54.prototype['recipient'] = undefined;
 ...
 */
MerchantTransfer54.prototype['recipient_account_uri'] = undefined;

/**
 * @member {module:model/ReconciliationData66} reconciliation_data
 */
MerchantTransfer54.prototype['reconciliation_data'] = undefined;

/**
 * Type of the resource that is being returned. Valid value: merchant_transfer
 * @member {String} resource_type
 */
MerchantTransfer54.prototype['resource_type'] = undefined;
 ...
 */
MerchantTransfer54.prototype['routing_transit_number'] = undefined;

/**
 * @member {module:model/Sender55} sender
 */
MerchantTransfer54.prototype['sender'] = undefined;
 ...
 */
MerchantTransfer54.prototype['sender_account_uri'] = undefined;

/**
 * Status of the transfer. Values: APPROVED, DECLINED, ERROR, PENDING, REVERSED, CANCELLED.
 * @member {String} status
 */
MerchantTransfer54.prototype['status'] = undefined;
 ...
 */
MerchantTransfer54.prototype['status_timestamp'] = undefined;

/**
 * @member {module:model/TransactionHistory62} transaction_history
 */
MerchantTransfer54.prototype['transaction_history'] = undefined;
 ...
 */
MerchantTransfer54.prototype['transaction_local_date_time'] = undefined;

/**
 * @member {module:model/TransferAmount61} transfer_amount
 */
MerchantTransfer54.prototype['transfer_amount'] = undefined;

/**
 * Unique transaction reference number provided when the Transfer was created.
 * @member {String} transfer_reference
 */
MerchantTransfer54.prototype['transfer_reference'] = undefined;
...
export default MerchantTransfer54;
