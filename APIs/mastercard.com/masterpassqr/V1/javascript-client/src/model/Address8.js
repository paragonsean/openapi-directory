...
class Address8 {
     ...
     * @param country {String} The recipient''s/merchant''s home country as an ISO 3166-1 alpha-3 country code.   Type: Alpha [A-Z], Length: 3
     */
    constructor(city, country) { 
        
        Address8.initialize(this, city, country);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Address8</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address8</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Address8.RequiredProperties) {
...
Address8.RequiredProperties = ["city", "country"];
 ...
 */
Address8.prototype['country_subdivision'] = undefined;
