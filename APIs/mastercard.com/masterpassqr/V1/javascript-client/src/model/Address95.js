...
/**
 * The Address95 model module.
 * @module model/Address95
 * @version V1
 */
class Address95 {
    /**
     * Constructs a new <code>Address95</code>.
     * Address of the sender. If this field is included then city and country field are also required.
     * @alias module:model/Address95
    ...
    constructor(city, country) { 
        ...
        Address95.initialize(this, city, country);
    }
    ...
    /**
     * Constructs a <code>Address95</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address95} obj Optional instance to populate.
     * @return {module:model/Address95} The populated <code>Address95</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address95();
    ...
    /**
     * Validates the JSON data with respect to <code>Address95</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address95</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Address95.RequiredProperties) {
...
Address95.RequiredProperties = ["city", "country"];

/**
 * City of the sender.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./\\:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÚÚÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], Length: 1-25
 * @member {String} city
 */
Address95.prototype['city'] = undefined;

/**
 * Country of the sender as an ISO alpha country code. Details- Alpha, Length: 3
 * @member {String} country
 */
Address95.prototype['country'] = undefined;
 ...
 */
Address95.prototype['country_subdivision'] = undefined;
