...
/**
 * The Address147 model module.
 * @module model/Address147
 * @version V1
 */
class Address147 {
    /**
     * Constructs a new <code>Address147</code>.
     * Address of the sender.
     * @alias module:model/Address147
     */
    constructor() { 
        
        Address147.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address147</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address147} obj Optional instance to populate.
     * @return {module:model/Address147} The populated <code>Address147</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address147();
    ...
    /**
     * Validates the JSON data with respect to <code>Address147</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address147</code>.
     */
 ...
 * @member {String} city
 */
Address147.prototype['city'] = undefined;

/**
 * Country of the sender as an ISO alpha country code.
 * @member {String} country
 */
Address147.prototype['country'] = undefined;

/**
 * State or province of the sender.
 * @member {String} country_subdivision
 */
Address147.prototype['country_subdivision'] = undefined;

/**
 * First line of the address of the sender.
 * @member {String} line1
 */
Address147.prototype['line1'] = undefined;

/**
 * Second line of the address of the sender.
 * @member {String} line2
 */
Address147.prototype['line2'] = undefined;

/**
 * Postal code of the sender.
 * @member {String} postal_code
 */
Address147.prototype['postal_code'] = undefined;
