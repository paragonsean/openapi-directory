...
import Recipient161 from './Recipient161';
import TransactionAmount160 from './TransactionAmount160';

/**
 * The NotificationRequest159 model module.
 * @module model/NotificationRequest159
 * @version V1
 */
class NotificationRequest159 {
    /**
     * Constructs a new <code>NotificationRequest159</code>.
     * Contains the details of the request message.
     * @alias module:model/NotificationRequest159
     * @param paymentType {String} P2M: Person to Merchant, ACO: Agent Cash Out
    ...
    constructor(paymentType, recipientAccountUri, transferStatus) { 
        ...
        NotificationRequest159.initialize(this, paymentType, recipientAccountUri, transferStatus);
    }
    ...
    /**
     * Constructs a <code>NotificationRequest159</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotificationRequest159} obj Optional instance to populate.
     * @return {module:model/NotificationRequest159} The populated <code>NotificationRequest159</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotificationRequest159();
            ...
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Recipient161.constructFromObject(data['recipient']);
            }
            ...
            if (data.hasOwnProperty('transaction_amount')) {
                obj['transaction_amount'] = TransactionAmount160.constructFromObject(data['transaction_amount']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationRequest159</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationRequest159</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotificationRequest159.RequiredProperties) {
        ...
        if (data['recipient']) { // data not null
          Recipient161.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
        ...
        if (data['transaction_amount']) { // data not null
          TransactionAmount160.validateJSON(data['transaction_amount']);
        }
        // ensure the json data is a string
...
NotificationRequest159.RequiredProperties = ["payment_type", "recipient_account_uri", "transfer_status"];

/**
 * Message a financial institution will associate to the transfer and may display
 * @member {String} additional_message
 */
NotificationRequest159.prototype['additional_message'] = undefined;
 ...
 */
NotificationRequest159.prototype['mastercard_assigned_id'] = undefined;

/**
 * Merchant category code
 * @member {String} merchant_category_code
 */
NotificationRequest159.prototype['merchant_category_code'] = undefined;
 ...
 */
NotificationRequest159.prototype['payment_facilitator_id'] = undefined;

/**
 * P2M: Person to Merchant, ACO: Agent Cash Out
 * @member {String} payment_type
 */
NotificationRequest159.prototype['payment_type'] = undefined;

/**
 * @member {module:model/Recipient161} recipient
 */
NotificationRequest159.prototype['recipient'] = undefined;

/**
 * Recepient Account uri . Only accept format: pan:[16 digit]
 * @member {String} recipient_account_uri
 */
NotificationRequest159.prototype['recipient_account_uri'] = undefined;

/**
 * @member {module:model/TransactionAmount160} transaction_amount
 */
NotificationRequest159.prototype['transaction_amount'] = undefined;

/**
 * APPROVED or DECLINED
 * @member {String} transfer_status
 */
NotificationRequest159.prototype['transfer_status'] = undefined;
...
export default NotificationRequest159;
