...
/**
 * The TokenCryptogram39 model module.
 * @module model/TokenCryptogram39
 * @version V1
 */
class TokenCryptogram39 {
    /**
     * Constructs a new <code>TokenCryptogram39</code>.
     * Token Cryptogram is a value that needs to be processed along with the token when submitting a transaction.
     * @alias module:model/TokenCryptogram39
    ...
    constructor(type, value) { 
        ...
        TokenCryptogram39.initialize(this, type, value);
    }
    ...
    /**
     * Constructs a <code>TokenCryptogram39</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenCryptogram39} obj Optional instance to populate.
     * @return {module:model/TokenCryptogram39} The populated <code>TokenCryptogram39</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenCryptogram39();
    ...
    /**
     * Validates the JSON data with respect to <code>TokenCryptogram39</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenCryptogram39</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TokenCryptogram39.RequiredProperties) {
...
TokenCryptogram39.RequiredProperties = ["type", "value"];
...
export default TokenCryptogram39;
