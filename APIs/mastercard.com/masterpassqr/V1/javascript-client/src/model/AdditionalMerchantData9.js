...
/**
 * The AdditionalMerchantData9 model module.
 * @module model/AdditionalMerchantData9
 * @version V1
 */
class AdditionalMerchantData9 {
    /**
     * Constructs a new <code>AdditionalMerchantData9</code>.
     * Additional merchant data of recipient.
     * @alias module:model/AdditionalMerchantData9
    ...
    constructor(paymentFacilitatorId, subMerchantId) { 
        ...
        AdditionalMerchantData9.initialize(this, paymentFacilitatorId, subMerchantId);
    }
    ...
    /**
     * Constructs a <code>AdditionalMerchantData9</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalMerchantData9} obj Optional instance to populate.
     * @return {module:model/AdditionalMerchantData9} The populated <code>AdditionalMerchantData9</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalMerchantData9();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalMerchantData9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalMerchantData9</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdditionalMerchantData9.RequiredProperties) {
...
AdditionalMerchantData9.RequiredProperties = ["payment_facilitator_id", "sub_merchant_id"];
 ...
 */
AdditionalMerchantData9.prototype['payment_facilitator_id'] = undefined;
 ...
 */
AdditionalMerchantData9.prototype['sub_merchant_id'] = undefined;
...
export default AdditionalMerchantData9;
