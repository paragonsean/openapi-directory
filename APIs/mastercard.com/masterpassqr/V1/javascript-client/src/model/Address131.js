...
/**
 * The Address131 model module.
 * @module model/Address131
 * @version V1
 */
class Address131 {
    /**
     * Constructs a new <code>Address131</code>.
     * Address of the sender.
     * @alias module:model/Address131
     */
    constructor() { 
        
        Address131.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address131</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address131} obj Optional instance to populate.
     * @return {module:model/Address131} The populated <code>Address131</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address131();
    ...
    /**
     * Validates the JSON data with respect to <code>Address131</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address131</code>.
     */
 ...
 * @member {String} city
 */
Address131.prototype['city'] = undefined;

/**
 * Country of the sender as an ISO alpha country code.
 * @member {String} country
 */
Address131.prototype['country'] = undefined;

/**
 * State or province of the sender.
 * @member {String} country_subdivision
 */
Address131.prototype['country_subdivision'] = undefined;

/**
 * First line of the address of the sender.
 * @member {String} line1
 */
Address131.prototype['line1'] = undefined;

/**
 * Second line of the address of the sender.
 * @member {String} line2
 */
Address131.prototype['line2'] = undefined;

/**
 * Postal code of the sender.
 * @member {String} postal_code
 */
Address131.prototype['postal_code'] = undefined;
