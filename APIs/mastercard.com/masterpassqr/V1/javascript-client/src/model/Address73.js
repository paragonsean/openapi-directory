...
/**
 * The Address73 model module.
 * @module model/Address73
 * @version V1
 */
class Address73 {
    /**
     * Constructs a new <code>Address73</code>.
     * Address of the sender.
     * @alias module:model/Address73
     */
    constructor() { 
        
        Address73.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address73</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address73} obj Optional instance to populate.
     * @return {module:model/Address73} The populated <code>Address73</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address73();
    ...
    /**
     * Validates the JSON data with respect to <code>Address73</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address73</code>.
     */
