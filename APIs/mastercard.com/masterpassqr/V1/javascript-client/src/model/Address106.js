...
/**
 * The Address106 model module.
 * @module model/Address106
 * @version V1
 */
class Address106 {
    /**
     * Constructs a new <code>Address106</code>.
     * Address of the sender.
     * @alias module:model/Address106
     */
    constructor() { 
        
        Address106.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address106</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address106} obj Optional instance to populate.
     * @return {module:model/Address106} The populated <code>Address106</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address106();
    ...
    /**
     * Validates the JSON data with respect to <code>Address106</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address106</code>.
     */
