...
/**
 * The Address108 model module.
 * @module model/Address108
 * @version V1
 */
class Address108 {
    /**
     * Constructs a new <code>Address108</code>.
     * Address of the recipient/merchant.
     * @alias module:model/Address108
     */
    constructor() { 
        
        Address108.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address108</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address108} obj Optional instance to populate.
     * @return {module:model/Address108} The populated <code>Address108</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address108();
    ...
    /**
     * Validates the JSON data with respect to <code>Address108</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address108</code>.
     */
