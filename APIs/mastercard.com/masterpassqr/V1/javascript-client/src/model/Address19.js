...
/**
 * The Address19 model module.
 * @module model/Address19
 * @version V1
 */
class Address19 {
    /**
     * Constructs a new <code>Address19</code>.
     * Address of the recipient/merchant.
     * @alias module:model/Address19
     */
    constructor() { 
        
        Address19.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address19</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address19} obj Optional instance to populate.
     * @return {module:model/Address19} The populated <code>Address19</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address19();
    ...
    /**
     * Validates the JSON data with respect to <code>Address19</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address19</code>.
     */
 ...
 * @member {String} city
 */
Address19.prototype['city'] = undefined;

/**
 * Country of the recipient as an ISO alpha country code.   Type: Alpha [A-Z], Maximum Length: 3
 * @member {String} country
 */
Address19.prototype['country'] = undefined;

/**
 * State or province of the recipient/merchant. If the merchant_transfer.recipient.address.country is USA or CAN, the country subdivision code is required.   Type: Alpha [A-Z], Maximum Length: 3
 * @member {String} country_subdivision
 */
Address19.prototype['country_subdivision'] = undefined;
 ...
 * @member {String} line1
 */
Address19.prototype['line1'] = undefined;

/**
 * Second line of the address of the recipient/merchant.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./\\:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÚÚÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], Maximum Length: 50
 * @member {String} line2
 */
Address19.prototype['line2'] = undefined;

/**
 * Postal code of the recipient.   Type: Alphanumeric Special [a-zA-Z0-9- ], Maximum Length: 10
 * @member {String} postal_code
 */
Address19.prototype['postal_code'] = undefined;
