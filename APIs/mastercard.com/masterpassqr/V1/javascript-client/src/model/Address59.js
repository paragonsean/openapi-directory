...
/**
 * The Address59 model module.
 * @module model/Address59
 * @version V1
 */
class Address59 {
    /**
     * Constructs a new <code>Address59</code>.
     * Address of the recipient/merchant.
     * @alias module:model/Address59
     */
    constructor() { 
        
        Address59.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address59</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address59} obj Optional instance to populate.
     * @return {module:model/Address59} The populated <code>Address59</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address59();
    ...
    /**
     * Validates the JSON data with respect to <code>Address59</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address59</code>.
     */
