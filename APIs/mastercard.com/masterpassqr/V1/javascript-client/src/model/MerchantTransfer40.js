...
import Participant53 from './Participant53';
import Recipient43 from './Recipient43';
import ReconciliationData51 from './ReconciliationData51';
import Sender41 from './Sender41';
import TransactionHistory47 from './TransactionHistory47';
import TransferAmount46 from './TransferAmount46';

/**
 * The MerchantTransfer40 model module.
 * @module model/MerchantTransfer40
 * @version V1
 */
class MerchantTransfer40 {
    /**
     * Constructs a new <code>MerchantTransfer40</code>.
     * Response details for a merchant transfer.
     * @alias module:model/MerchantTransfer40
     */
    constructor() { 
        
        MerchantTransfer40.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantTransfer40</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantTransfer40} obj Optional instance to populate.
     * @return {module:model/MerchantTransfer40} The populated <code>MerchantTransfer40</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantTransfer40();
            ...
            if (data.hasOwnProperty('participant')) {
                obj['participant'] = Participant53.constructFromObject(data['participant']);
            }
            ...
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Recipient43.constructFromObject(data['recipient']);
            }
            ...
            if (data.hasOwnProperty('reconciliation_data')) {
                obj['reconciliation_data'] = ReconciliationData51.constructFromObject(data['reconciliation_data']);
            }
            ...
            if (data.hasOwnProperty('sender')) {
                obj['sender'] = Sender41.constructFromObject(data['sender']);
            }
            ...
            if (data.hasOwnProperty('transaction_history')) {
                obj['transaction_history'] = TransactionHistory47.constructFromObject(data['transaction_history']);
            }
            ...
            if (data.hasOwnProperty('transfer_amount')) {
                obj['transfer_amount'] = TransferAmount46.constructFromObject(data['transfer_amount']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantTransfer40</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantTransfer40</code>.
     */
    static validateJSON(data) {
        ...
        if (data['participant']) { // data not null
          Participant53.validateJSON(data['participant']);
        }
        // ensure the json data is a string
        ...
        if (data['recipient']) { // data not null
          Recipient43.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
        ...
        if (data['reconciliation_data']) { // data not null
          ReconciliationData51.validateJSON(data['reconciliation_data']);
        }
        // ensure the json data is a string
        ...
        if (data['sender']) { // data not null
          Sender41.validateJSON(data['sender']);
        }
        // ensure the json data is a string
        ...
        if (data['transaction_history']) { // data not null
          TransactionHistory47.validateJSON(data['transaction_history']);
        }
        // ensure the json data is a string
        ...
        if (data['transfer_amount']) { // data not null
          TransferAmount46.validateJSON(data['transfer_amount']);
        }
        // ensure the json data is a string
 ...
 */
MerchantTransfer40.prototype['additional_message'] = undefined;

/**
 * Initiation channel of the transfer request. Values: WEB, MOBILE, BANK, KIOSK.
 * @member {String} channel
 */
MerchantTransfer40.prototype['channel'] = undefined;
 ...
 */
MerchantTransfer40.prototype['convenience_amount'] = undefined;
 ...
 */
MerchantTransfer40.prototype['convenience_indicator'] = undefined;
 ...
 */
MerchantTransfer40.prototype['created'] = undefined;

/**
 * The serial number of a device that initiated the transfer.
 * @member {String} device_id
 */
MerchantTransfer40.prototype['device_id'] = undefined;
 ...
 */
MerchantTransfer40.prototype['digital_account_reference_number'] = undefined;
 ...
 */
MerchantTransfer40.prototype['funding_source'] = undefined;

/**
 * System generated unique merchant transfer identifier.
 * @member {String} id
 */
MerchantTransfer40.prototype['id'] = undefined;
 ...
 */
MerchantTransfer40.prototype['interchange_rate_designator'] = undefined;

/**
 * Location where the transaction is initiated. Valid Values- Refer 'Location URIs'.
 * @member {String} location
 */
MerchantTransfer40.prototype['location'] = undefined;

/**
 * Original status of the transfer. One of APPROVED, DECLINED, ERROR, PENDING, UNKNOWN.
 * @member {String} original_status
 */
MerchantTransfer40.prototype['original_status'] = undefined;

/**
 * @member {module:model/Participant53} participant
 */
MerchantTransfer40.prototype['participant'] = undefined;
 ...
 */
MerchantTransfer40.prototype['participation_id'] = undefined;
 ...
 */
MerchantTransfer40.prototype['payment_origination_country'] = undefined;

/**
 * P2M: Person to Merchant
 * @member {String} payment_type
 */
MerchantTransfer40.prototype['payment_type'] = undefined;
 ...
 */
MerchantTransfer40.prototype['processor_id'] = undefined;

/**
 * Contains QR data. For future use. Details- alpha numeric special characters 1-237.
 * @member {String} qr_data
 */
MerchantTransfer40.prototype['qr_data'] = undefined;

/**
 * @member {module:model/Recipient43} recipient
 */
MerchantTransfer40.prototype['recipient'] = undefined;
 ...
 */
MerchantTransfer40.prototype['recipient_account_uri'] = undefined;

/**
 * @member {module:model/ReconciliationData51} reconciliation_data
 */
MerchantTransfer40.prototype['reconciliation_data'] = undefined;

/**
 * Type of the resource that is being returned. Valid value: merchant_transfer
 * @member {String} resource_type
 */
MerchantTransfer40.prototype['resource_type'] = undefined;
 ...
 */
MerchantTransfer40.prototype['routing_transit_number'] = undefined;

/**
 * @member {module:model/Sender41} sender
 */
MerchantTransfer40.prototype['sender'] = undefined;
 ...
 */
MerchantTransfer40.prototype['sender_account_uri'] = undefined;

/**
 * Status of the transfer. Values: APPROVED, DECLINED, ERROR, PENDING, REVERSED, CANCELLED.
 * @member {String} status
 */
MerchantTransfer40.prototype['status'] = undefined;
 ...
 */
MerchantTransfer40.prototype['status_timestamp'] = undefined;

/**
 * @member {module:model/TransactionHistory47} transaction_history
 */
MerchantTransfer40.prototype['transaction_history'] = undefined;
 ...
 */
MerchantTransfer40.prototype['transaction_local_date_time'] = undefined;

/**
 * @member {module:model/TransferAmount46} transfer_amount
 */
MerchantTransfer40.prototype['transfer_amount'] = undefined;

/**
 * Unique transaction reference number provided when the Transfer was created.
 * @member {String} transfer_reference
 */
MerchantTransfer40.prototype['transfer_reference'] = undefined;
...
export default MerchantTransfer40;
