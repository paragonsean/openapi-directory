...
import Participant117 from './Participant117';
import Recipient107 from './Recipient107';
import ReconciliationData115 from './ReconciliationData115';
import Sender105 from './Sender105';
import TransactionHistory111 from './TransactionHistory111';
import TransferAmount110 from './TransferAmount110';

/**
 * The MerchantTransfer104 model module.
 * @module model/MerchantTransfer104
 * @version V1
 */
class MerchantTransfer104 {
    /**
     * Constructs a new <code>MerchantTransfer104</code>.
     * Response details for a merchant transfer.
     * @alias module:model/MerchantTransfer104
     */
    constructor() { 
        
        MerchantTransfer104.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantTransfer104</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantTransfer104} obj Optional instance to populate.
     * @return {module:model/MerchantTransfer104} The populated <code>MerchantTransfer104</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantTransfer104();
            ...
            if (data.hasOwnProperty('participant')) {
                obj['participant'] = Participant117.constructFromObject(data['participant']);
            }
            ...
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Recipient107.constructFromObject(data['recipient']);
            }
            ...
            if (data.hasOwnProperty('reconciliation_data')) {
                obj['reconciliation_data'] = ReconciliationData115.constructFromObject(data['reconciliation_data']);
            }
            ...
            if (data.hasOwnProperty('sender')) {
                obj['sender'] = Sender105.constructFromObject(data['sender']);
            }
            ...
            if (data.hasOwnProperty('transaction_history')) {
                obj['transaction_history'] = TransactionHistory111.constructFromObject(data['transaction_history']);
            }
            ...
            if (data.hasOwnProperty('transfer_amount')) {
                obj['transfer_amount'] = TransferAmount110.constructFromObject(data['transfer_amount']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantTransfer104</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantTransfer104</code>.
     */
    static validateJSON(data) {
        ...
        if (data['participant']) { // data not null
          Participant117.validateJSON(data['participant']);
        }
        // ensure the json data is a string
        ...
        if (data['recipient']) { // data not null
          Recipient107.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
        ...
        if (data['reconciliation_data']) { // data not null
          ReconciliationData115.validateJSON(data['reconciliation_data']);
        }
        // ensure the json data is a string
        ...
        if (data['sender']) { // data not null
          Sender105.validateJSON(data['sender']);
        }
        // ensure the json data is a string
        ...
        if (data['transaction_history']) { // data not null
          TransactionHistory111.validateJSON(data['transaction_history']);
        }
        // ensure the json data is a string
        ...
        if (data['transfer_amount']) { // data not null
          TransferAmount110.validateJSON(data['transfer_amount']);
        }
        // ensure the json data is a string
 ...
 */
MerchantTransfer104.prototype['channel'] = undefined;
 ...
 */
MerchantTransfer104.prototype['created'] = undefined;

/**
 * The serial number of a device that initiated the transfer.
 * @member {String} device_id
 */
MerchantTransfer104.prototype['device_id'] = undefined;
 ...
 */
MerchantTransfer104.prototype['digital_account_reference_number'] = undefined;
 ...
 */
MerchantTransfer104.prototype['funding_source'] = undefined;

/**
 * System generated unique merchant transfer identifier.
 * @member {String} id
 */
MerchantTransfer104.prototype['id'] = undefined;
 ...
 */
MerchantTransfer104.prototype['interchange_rate_designator'] = undefined;

/**
 * Location where the transaction is initiated. Valid Values- Refer 'Location URIs'.
 * @member {String} location
 */
MerchantTransfer104.prototype['location'] = undefined;

/**
 * Original status of the transfer. One of APPROVED, DECLINED, ERROR, PENDING, UNKNOWN.
 * @member {String} original_status
 */
MerchantTransfer104.prototype['original_status'] = undefined;

/**
 * @member {module:model/Participant117} participant
 */
MerchantTransfer104.prototype['participant'] = undefined;
 ...
 */
MerchantTransfer104.prototype['payment_origination_country'] = undefined;

/**
 * P2M: Person to Merchant
 * @member {String} payment_type
 */
MerchantTransfer104.prototype['payment_type'] = undefined;
 ...
 */
MerchantTransfer104.prototype['processor_id'] = undefined;

/**
 * @member {module:model/Recipient107} recipient
 */
MerchantTransfer104.prototype['recipient'] = undefined;
 ...
 */
MerchantTransfer104.prototype['recipient_account_uri'] = undefined;

/**
 * @member {module:model/ReconciliationData115} reconciliation_data
 */
MerchantTransfer104.prototype['reconciliation_data'] = undefined;

/**
 * Type of the resource that is being returned. Valid value: merchant_refund_transfer
 * @member {String} resource_type
 */
MerchantTransfer104.prototype['resource_type'] = undefined;
 ...
 */
MerchantTransfer104.prototype['routing_transit_number'] = undefined;

/**
 * @member {module:model/Sender105} sender
 */
MerchantTransfer104.prototype['sender'] = undefined;
 ...
 */
MerchantTransfer104.prototype['sender_account_uri'] = undefined;

/**
 * Status of the transfer. Values: APPROVED, DECLINED, ERROR, PENDING, REVERSED, CANCELLED.
 * @member {String} status
 */
MerchantTransfer104.prototype['status'] = undefined;
 ...
 */
MerchantTransfer104.prototype['status_timestamp'] = undefined;

/**
 * @member {module:model/TransactionHistory111} transaction_history
 */
MerchantTransfer104.prototype['transaction_history'] = undefined;
 ...
 */
MerchantTransfer104.prototype['transaction_local_date_time'] = undefined;

/**
 * @member {module:model/TransferAmount110} transfer_amount
 */
MerchantTransfer104.prototype['transfer_amount'] = undefined;

/**
 * Unique transaction reference number provided when the Transfer was created.
 * @member {String} transfer_reference
 */
MerchantTransfer104.prototype['transfer_reference'] = undefined;
...
export default MerchantTransfer104;
