...
/**
 * The Address97 model module.
 * @module model/Address97
 * @version V1
 */
class Address97 {
    /**
     * Constructs a new <code>Address97</code>.
     * Address of the recipient/merchant.
     * @alias module:model/Address97
    ...
    constructor(city, country) { 
        ...
        Address97.initialize(this, city, country);
    }
    ...
    /**
     * Constructs a <code>Address97</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address97} obj Optional instance to populate.
     * @return {module:model/Address97} The populated <code>Address97</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address97();
    ...
    /**
     * Validates the JSON data with respect to <code>Address97</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address97</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Address97.RequiredProperties) {
 ...
 */
Address97.prototype['country_subdivision'] = undefined;
 ...
 * @member {String} line1
 */
Address97.prototype['line1'] = undefined;

/**
 * Second line of the address of the recipient/merchant.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./\\:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÚÚÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], Length: 1-50
 * @member {String} line2
 */
Address97.prototype['line2'] = undefined;
 ...
 */
Address97.prototype['postal_code'] = undefined;
