...
import Address42 from './Address42';

/**
 * The Sender41 model module.
 * @module model/Sender41
 * @version V1
 */
class Sender41 {
    /**
     * Constructs a new <code>Sender41</code>.
     * Information about the sender of the transaction.
     * @alias module:model/Sender41
     */
    constructor() { 
        
        Sender41.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Sender41</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Sender41} obj Optional instance to populate.
     * @return {module:model/Sender41} The populated <code>Sender41</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Sender41();

            if (data.hasOwnProperty('address')) {
                obj['address'] = Address42.constructFromObject(data['address']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Sender41</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Sender41</code>.
     */
    static validateJSON(data) {
        // validate the optional field `address`
        if (data['address']) { // data not null
          Address42.validateJSON(data['address']);
        }
 ...
 * @member {String} email
 */
Sender41.prototype['email'] = undefined;

/**
 * First name of the sender.
 * @member {String} first_name
 */
Sender41.prototype['first_name'] = undefined;

/**
 * Last name of the sender.
 * @member {String} last_name
 */
Sender41.prototype['last_name'] = undefined;

/**
 * Middle name of the sender.
 * @member {String} middle_name
 */
Sender41.prototype['middle_name'] = undefined;
 ...
 * @member {String} phone
 */
Sender41.prototype['phone'] = undefined;
