...
/**
 * The Participant85 model module.
 * @module model/Participant85
 * @version V1
 */
class Participant85 {
    /**
     * Constructs a new <code>Participant85</code>.
     * Information about a participant that may be passed along to the network.
     * @alias module:model/Participant85
     */
    constructor() { 
        
        Participant85.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Participant85</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Participant85} obj Optional instance to populate.
     * @return {module:model/Participant85} The populated <code>Participant85</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Participant85();
    ...
    /**
     * Validates the JSON data with respect to <code>Participant85</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Participant85</code>.
     */
 ...
 */
Participant85.prototype['card_acceptor_id'] = undefined;
 ...
 */
Participant85.prototype['card_acceptor_name'] = undefined;
