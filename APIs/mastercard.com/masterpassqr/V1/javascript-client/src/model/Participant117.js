...
/**
 * The Participant117 model module.
 * @module model/Participant117
 * @version V1
 */
class Participant117 {
    /**
     * Constructs a new <code>Participant117</code>.
     * Information about a participant that may be passed along to the network.
     * @alias module:model/Participant117
     */
    constructor() { 
        
        Participant117.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Participant117</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Participant117} obj Optional instance to populate.
     * @return {module:model/Participant117} The populated <code>Participant117</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Participant117();
    ...
    /**
     * Validates the JSON data with respect to <code>Participant117</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Participant117</code>.
     */
 ...
 */
Participant117.prototype['card_acceptor_id'] = undefined;
 ...
 */
Participant117.prototype['card_acceptor_name'] = undefined;
