...
/**
 * The TokenCryptogram128 model module.
 * @module model/TokenCryptogram128
 * @version V1
 */
class TokenCryptogram128 {
    /**
     * Constructs a new <code>TokenCryptogram128</code>.
     * Token Cryptogram is a value that needs to be processed along with the token when submitting a transaction.
     * @alias module:model/TokenCryptogram128
    ...
    constructor(type, value) { 
        ...
        TokenCryptogram128.initialize(this, type, value);
    }
    ...
    /**
     * Constructs a <code>TokenCryptogram128</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenCryptogram128} obj Optional instance to populate.
     * @return {module:model/TokenCryptogram128} The populated <code>TokenCryptogram128</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenCryptogram128();
    ...
    /**
     * Validates the JSON data with respect to <code>TokenCryptogram128</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenCryptogram128</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TokenCryptogram128.RequiredProperties) {
...
TokenCryptogram128.RequiredProperties = ["type", "value"];
...
export default TokenCryptogram128;
