...
/**
 * The Address31 model module.
 * @module model/Address31
 * @version V1
 */
class Address31 {
    /**
     * Constructs a new <code>Address31</code>.
     * Address of the sender. Optional.
     * @alias module:model/Address31
     ...
     * @param country {String} Country of the sender as an ISO alpha country code. Details- Alpha, Length: 3
     */
    constructor(city, country) { 
        
        Address31.initialize(this, city, country);
    }
    ...
    /**
     * Constructs a <code>Address31</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address31} obj Optional instance to populate.
     * @return {module:model/Address31} The populated <code>Address31</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address31();
    ...
    /**
     * Validates the JSON data with respect to <code>Address31</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address31</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Address31.RequiredProperties) {
...
Address31.RequiredProperties = ["city", "country"];

/**
 * City of the sender.\\n\\nType: Alphanumeric Special [a-zA-Z0-9 !\"#$%&'()*+,-./\\:;<=>?@[]_`{|}~ÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÚÚÝàáâãäåçèéêëìíîïñòóôõöùúûüýÿ], Length: 1-25
 * @member {String} city
 */
Address31.prototype['city'] = undefined;

/**
 * Country of the sender as an ISO alpha country code. Details- Alpha, Length: 3
 * @member {String} country
 */
Address31.prototype['country'] = undefined;
 ...
 */
Address31.prototype['country_subdivision'] = undefined;
