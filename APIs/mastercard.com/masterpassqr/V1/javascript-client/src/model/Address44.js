...
/**
 * The Address44 model module.
 * @module model/Address44
 * @version V1
 */
class Address44 {
    /**
     * Constructs a new <code>Address44</code>.
     * Address of the recipient/merchant.
     * @alias module:model/Address44
     */
    constructor() { 
        
        Address44.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address44</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address44} obj Optional instance to populate.
     * @return {module:model/Address44} The populated <code>Address44</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address44();
    ...
    /**
     * Validates the JSON data with respect to <code>Address44</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address44</code>.
     */
