...
/**
 * The Address120 model module.
 * @module model/Address120
 * @version V1
 */
class Address120 {
    /**
     * Constructs a new <code>Address120</code>.
     * Sender&#39;s home address.
     * @alias module:model/Address120
     */
    constructor() { 
        
        Address120.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Address120</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Address120} obj Optional instance to populate.
     * @return {module:model/Address120} The populated <code>Address120</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Address120();
    ...
    /**
     * Validates the JSON data with respect to <code>Address120</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Address120</code>.
     */
 ...
 * @member {String} city
 */
Address120.prototype['city'] = undefined;
