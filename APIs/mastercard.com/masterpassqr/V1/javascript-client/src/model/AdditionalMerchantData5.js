...
/**
 * The AdditionalMerchantData5 model module.
 * @module model/AdditionalMerchantData5
 * @version V1
 */
class AdditionalMerchantData5 {
    /**
     * Constructs a new <code>AdditionalMerchantData5</code>.
     * Additional merchant data of sender.
     * @alias module:model/AdditionalMerchantData5
    ...
    constructor(paymentFacilitatorId, subMerchantId) { 
        ...
        AdditionalMerchantData5.initialize(this, paymentFacilitatorId, subMerchantId);
    }
    ...
    /**
     * Constructs a <code>AdditionalMerchantData5</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalMerchantData5} obj Optional instance to populate.
     * @return {module:model/AdditionalMerchantData5} The populated <code>AdditionalMerchantData5</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalMerchantData5();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalMerchantData5</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalMerchantData5</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdditionalMerchantData5.RequiredProperties) {
...
AdditionalMerchantData5.RequiredProperties = ["payment_facilitator_id", "sub_merchant_id"];
 ...
 */
AdditionalMerchantData5.prototype['payment_facilitator_id'] = undefined;
 ...
 */
AdditionalMerchantData5.prototype['sub_merchant_id'] = undefined;
...
export default AdditionalMerchantData5;
