...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory138();
  });
  ...
  describe('TransactionHistory138', function() {
    it('should create an instance of TransactionHistory138', function() {
      // uncomment below and update the code to test TransactionHistory138
      //var instance = new SendPersonToMerchant.TransactionHistory138();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory138);
    });
