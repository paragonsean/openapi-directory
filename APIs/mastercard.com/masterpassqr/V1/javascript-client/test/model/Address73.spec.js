...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address73();
  });
  ...
  describe('Address73', function() {
    it('should create an instance of Address73', function() {
      // uncomment below and update the code to test Address73
      //var instance = new SendPersonToMerchant.Address73();
      //expect(instance).to.be.a(SendPersonToMerchant.Address73);
    });
