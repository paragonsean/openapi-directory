...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address97();
  });
  ...
  describe('Address97', function() {
    it('should create an instance of Address97', function() {
      // uncomment below and update the code to test Address97
      //var instance = new SendPersonToMerchant.Address97();
      //expect(instance).to.be.a(SendPersonToMerchant.Address97);
    });
