...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.FundingTransfer118();
  });
  ...
  describe('FundingTransfer118', function() {
    it('should create an instance of FundingTransfer118', function() {
      // uncomment below and update the code to test FundingTransfer118
      //var instance = new SendPersonToMerchant.FundingTransfer118();
      //expect(instance).to.be.a(SendPersonToMerchant.FundingTransfer118);
    });
    ...
    it('should have the property fundingHints (base name: "funding_hints")', function() {
      // uncomment below and update the code to test the property fundingHints
      //var instance = new SendPersonToMerchant.FundingTransfer118();
      //expect(instance).to.be();
    });
    ...
    it('should have the property languageData (base name: "language_data")', function() {
      // uncomment below and update the code to test the property languageData
      //var instance = new SendPersonToMerchant.FundingTransfer118();
      //expect(instance).to.be();
    });

    it('should have the property languageIdentification (base name: "language_identification")', function() {
      // uncomment below and update the code to test the property languageIdentification
      //var instance = new SendPersonToMerchant.FundingTransfer118();
      //expect(instance).to.be();
    });
