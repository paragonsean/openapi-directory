...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address31();
  });
  ...
  describe('Address31', function() {
    it('should create an instance of Address31', function() {
      // uncomment below and update the code to test Address31
      //var instance = new SendPersonToMerchant.Address31();
      //expect(instance).to.be.a(SendPersonToMerchant.Address31);
    });
