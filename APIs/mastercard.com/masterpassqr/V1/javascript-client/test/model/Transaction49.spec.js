...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Transaction49();
  });
  ...
  describe('Transaction49', function() {
    it('should create an instance of Transaction49', function() {
      // uncomment below and update the code to test Transaction49
      //var instance = new SendPersonToMerchant.Transaction49();
      //expect(instance).to.be.a(SendPersonToMerchant.Transaction49);
    });
