...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory62();
  });
  ...
  describe('TransactionHistory62', function() {
    it('should create an instance of TransactionHistory62', function() {
      // uncomment below and update the code to test TransactionHistory62
      //var instance = new SendPersonToMerchant.TransactionHistory62();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory62);
    });
