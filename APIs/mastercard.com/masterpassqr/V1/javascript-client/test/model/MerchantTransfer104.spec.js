...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfer104();
  });
  ...
  describe('MerchantTransfer104', function() {
    it('should create an instance of MerchantTransfer104', function() {
      // uncomment below and update the code to test MerchantTransfer104
      //var instance = new SendPersonToMerchant.MerchantTransfer104();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfer104);
    });
