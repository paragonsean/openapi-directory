...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Sender30();
  });
  ...
  describe('Sender30', function() {
    it('should create an instance of Sender30', function() {
      // uncomment below and update the code to test Sender30
      //var instance = new SendPersonToMerchant.Sender30();
      //expect(instance).to.be.a(SendPersonToMerchant.Sender30);
    });
