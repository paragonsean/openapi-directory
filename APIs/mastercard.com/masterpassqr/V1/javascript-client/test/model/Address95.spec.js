...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address95();
  });
  ...
  describe('Address95', function() {
    it('should create an instance of Address95', function() {
      // uncomment below and update the code to test Address95
      //var instance = new SendPersonToMerchant.Address95();
      //expect(instance).to.be.a(SendPersonToMerchant.Address95);
    });
