...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.DigitalAccount89();
  });
  ...
  describe('DigitalAccount89', function() {
    it('should create an instance of DigitalAccount89', function() {
      // uncomment below and update the code to test DigitalAccount89
      //var instance = new SendPersonToMerchant.DigitalAccount89();
      //expect(instance).to.be.a(SendPersonToMerchant.DigitalAccount89);
    });
