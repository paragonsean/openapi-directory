...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Transaction64();
  });
  ...
  describe('Transaction64', function() {
    it('should create an instance of Transaction64', function() {
      // uncomment below and update the code to test Transaction64
      //var instance = new SendPersonToMerchant.Transaction64();
      //expect(instance).to.be.a(SendPersonToMerchant.Transaction64);
    });
