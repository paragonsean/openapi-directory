...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Sender41();
  });
  ...
  describe('Sender41', function() {
    it('should create an instance of Sender41', function() {
      // uncomment below and update the code to test Sender41
      //var instance = new SendPersonToMerchant.Sender41();
      //expect(instance).to.be.a(SendPersonToMerchant.Sender41);
    });
