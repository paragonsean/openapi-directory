...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.DigitalAccount87();
  });
  ...
  describe('DigitalAccount87', function() {
    it('should create an instance of DigitalAccount87', function() {
      // uncomment below and update the code to test DigitalAccount87
      //var instance = new SendPersonToMerchant.DigitalAccount87();
      //expect(instance).to.be.a(SendPersonToMerchant.DigitalAccount87);
    });
