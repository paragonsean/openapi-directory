...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address131();
  });
  ...
  describe('Address131', function() {
    it('should create an instance of Address131', function() {
      // uncomment below and update the code to test Address131
      //var instance = new SendPersonToMerchant.Address131();
      //expect(instance).to.be.a(SendPersonToMerchant.Address131);
    });
