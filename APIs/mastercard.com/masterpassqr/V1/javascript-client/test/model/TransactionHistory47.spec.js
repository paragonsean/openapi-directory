...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory47();
  });
  ...
  describe('TransactionHistory47', function() {
    it('should create an instance of TransactionHistory47', function() {
      // uncomment below and update the code to test TransactionHistory47
      //var instance = new SendPersonToMerchant.TransactionHistory47();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory47);
    });
