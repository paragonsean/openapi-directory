...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfer1();
  });
  ...
  describe('MerchantTransfer1', function() {
    it('should create an instance of MerchantTransfer1', function() {
      // uncomment below and update the code to test MerchantTransfer1
      //var instance = new SendPersonToMerchant.MerchantTransfer1();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfer1);
    });
