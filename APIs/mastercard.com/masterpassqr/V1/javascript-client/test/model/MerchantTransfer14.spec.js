...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfer14();
  });
  ...
  describe('MerchantTransfer14', function() {
    it('should create an instance of MerchantTransfer14', function() {
      // uncomment below and update the code to test MerchantTransfer14
      //var instance = new SendPersonToMerchant.MerchantTransfer14();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfer14);
    });
