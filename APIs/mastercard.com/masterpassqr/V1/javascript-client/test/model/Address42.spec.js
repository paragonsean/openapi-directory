...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address42();
  });
  ...
  describe('Address42', function() {
    it('should create an instance of Address42', function() {
      // uncomment below and update the code to test Address42
      //var instance = new SendPersonToMerchant.Address42();
      //expect(instance).to.be.a(SendPersonToMerchant.Address42);
    });
