...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address33();
  });
  ...
  describe('Address33', function() {
    it('should create an instance of Address33', function() {
      // uncomment below and update the code to test Address33
      //var instance = new SendPersonToMerchant.Address33();
      //expect(instance).to.be.a(SendPersonToMerchant.Address33);
    });
