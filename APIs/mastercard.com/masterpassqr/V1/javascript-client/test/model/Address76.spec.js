...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address76();
  });
  ...
  describe('Address76', function() {
    it('should create an instance of Address76', function() {
      // uncomment below and update the code to test Address76
      //var instance = new SendPersonToMerchant.Address76();
      //expect(instance).to.be.a(SendPersonToMerchant.Address76);
    });
