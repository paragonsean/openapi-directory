...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Sender105();
  });
  ...
  describe('Sender105', function() {
    it('should create an instance of Sender105', function() {
      // uncomment below and update the code to test Sender105
      //var instance = new SendPersonToMerchant.Sender105();
      //expect(instance).to.be.a(SendPersonToMerchant.Sender105);
    });
