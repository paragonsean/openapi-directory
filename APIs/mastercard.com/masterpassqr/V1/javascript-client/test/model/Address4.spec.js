...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address4();
  });
  ...
  describe('Address4', function() {
    it('should create an instance of Address4', function() {
      // uncomment below and update the code to test Address4
      //var instance = new SendPersonToMerchant.Address4();
      //expect(instance).to.be.a(SendPersonToMerchant.Address4);
    });
