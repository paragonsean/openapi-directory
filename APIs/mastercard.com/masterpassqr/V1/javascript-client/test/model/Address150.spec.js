...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address150();
  });
  ...
  describe('Address150', function() {
    it('should create an instance of Address150', function() {
      // uncomment below and update the code to test Address150
      //var instance = new SendPersonToMerchant.Address150();
      //expect(instance).to.be.a(SendPersonToMerchant.Address150);
    });
