...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfer71();
  });
  ...
  describe('MerchantTransfer71', function() {
    it('should create an instance of MerchantTransfer71', function() {
      // uncomment below and update the code to test MerchantTransfer71
      //var instance = new SendPersonToMerchant.MerchantTransfer71();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfer71);
    });
