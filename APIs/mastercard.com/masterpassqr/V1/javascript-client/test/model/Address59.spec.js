...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address59();
  });
  ...
  describe('Address59', function() {
    it('should create an instance of Address59', function() {
      // uncomment below and update the code to test Address59
      //var instance = new SendPersonToMerchant.Address59();
      //expect(instance).to.be.a(SendPersonToMerchant.Address59);
    });
