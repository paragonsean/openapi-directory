...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfer54();
  });
  ...
  describe('MerchantTransfer54', function() {
    it('should create an instance of MerchantTransfer54', function() {
      // uncomment below and update the code to test MerchantTransfer54
      //var instance = new SendPersonToMerchant.MerchantTransfer54();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfer54);
    });
