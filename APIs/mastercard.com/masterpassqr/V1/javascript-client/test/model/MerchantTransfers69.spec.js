...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantTransfers69();
  });
  ...
  describe('MerchantTransfers69', function() {
    it('should create an instance of MerchantTransfers69', function() {
      // uncomment below and update the code to test MerchantTransfers69
      //var instance = new SendPersonToMerchant.MerchantTransfers69();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantTransfers69);
    });
