...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory22();
  });
  ...
  describe('TransactionHistory22', function() {
    it('should create an instance of TransactionHistory22', function() {
      // uncomment below and update the code to test TransactionHistory22
      //var instance = new SendPersonToMerchant.TransactionHistory22();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory22);
    });
