...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Transaction24();
  });
  ...
  describe('Transaction24', function() {
    it('should create an instance of Transaction24', function() {
      // uncomment below and update the code to test Transaction24
      //var instance = new SendPersonToMerchant.Transaction24();
      //expect(instance).to.be.a(SendPersonToMerchant.Transaction24);
    });
    ...
    it('should have the property fundsAvailability (base name: "funds_availability")', function() {
