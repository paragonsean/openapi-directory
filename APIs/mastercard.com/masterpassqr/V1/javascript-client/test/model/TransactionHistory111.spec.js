...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory111();
  });
  ...
  describe('TransactionHistory111', function() {
    it('should create an instance of TransactionHistory111', function() {
      // uncomment below and update the code to test TransactionHistory111
      //var instance = new SendPersonToMerchant.TransactionHistory111();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory111);
    });
