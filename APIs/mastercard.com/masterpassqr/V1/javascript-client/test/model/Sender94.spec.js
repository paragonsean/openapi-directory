...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Sender94();
  });
  ...
  describe('Sender94', function() {
    it('should create an instance of Sender94', function() {
      // uncomment below and update the code to test Sender94
      //var instance = new SendPersonToMerchant.Sender94();
      //expect(instance).to.be.a(SendPersonToMerchant.Sender94);
    });
