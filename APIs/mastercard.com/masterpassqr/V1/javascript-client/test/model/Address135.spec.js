...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address135();
  });
  ...
  describe('Address135', function() {
    it('should create an instance of Address135', function() {
      // uncomment below and update the code to test Address135
      //var instance = new SendPersonToMerchant.Address135();
      //expect(instance).to.be.a(SendPersonToMerchant.Address135);
    });
