...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address8();
  });
  ...
  describe('Address8', function() {
    it('should create an instance of Address8', function() {
      // uncomment below and update the code to test Address8
      //var instance = new SendPersonToMerchant.Address8();
      //expect(instance).to.be.a(SendPersonToMerchant.Address8);
    });
