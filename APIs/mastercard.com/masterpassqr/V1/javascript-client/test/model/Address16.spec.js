...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address16();
  });
  ...
  describe('Address16', function() {
    it('should create an instance of Address16', function() {
      // uncomment below and update the code to test Address16
      //var instance = new SendPersonToMerchant.Address16();
      //expect(instance).to.be.a(SendPersonToMerchant.Address16);
    });
