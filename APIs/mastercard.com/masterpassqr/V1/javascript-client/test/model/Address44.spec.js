...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address44();
  });
  ...
  describe('Address44', function() {
    it('should create an instance of Address44', function() {
      // uncomment below and update the code to test Address44
      //var instance = new SendPersonToMerchant.Address44();
      //expect(instance).to.be.a(SendPersonToMerchant.Address44);
    });
