...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address19();
  });
  ...
  describe('Address19', function() {
    it('should create an instance of Address19', function() {
      // uncomment below and update the code to test Address19
      //var instance = new SendPersonToMerchant.Address19();
      //expect(instance).to.be.a(SendPersonToMerchant.Address19);
    });
