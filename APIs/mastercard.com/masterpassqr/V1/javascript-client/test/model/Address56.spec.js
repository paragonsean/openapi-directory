...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address56();
  });
  ...
  describe('Address56', function() {
    it('should create an instance of Address56', function() {
      // uncomment below and update the code to test Address56
      //var instance = new SendPersonToMerchant.Address56();
      //expect(instance).to.be.a(SendPersonToMerchant.Address56);
    });
