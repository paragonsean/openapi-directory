...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.Address120();
  });
  ...
  describe('Address120', function() {
    it('should create an instance of Address120', function() {
      // uncomment below and update the code to test Address120
      //var instance = new SendPersonToMerchant.Address120();
      //expect(instance).to.be.a(SendPersonToMerchant.Address120);
    });
