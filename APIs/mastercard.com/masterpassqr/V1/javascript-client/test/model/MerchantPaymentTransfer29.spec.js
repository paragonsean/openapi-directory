...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.MerchantPaymentTransfer29();
  });
  ...
  describe('MerchantPaymentTransfer29', function() {
    it('should create an instance of MerchantPaymentTransfer29', function() {
      // uncomment below and update the code to test MerchantPaymentTransfer29
      //var instance = new SendPersonToMerchant.MerchantPaymentTransfer29();
      //expect(instance).to.be.a(SendPersonToMerchant.MerchantPaymentTransfer29);
    });
    ...
    it('should have the property fundingTransactionReference (base name: "funding_transaction_reference")', function() {
      // uncomment below and update the code to test the property fundingTransactionReference
      //var instance = new SendPersonToMerchant.MerchantPaymentTransfer29();
      //expect(instance).to.be();
    });
