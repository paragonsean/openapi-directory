...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory153();
  });
  ...
  describe('TransactionHistory153', function() {
    it('should create an instance of TransactionHistory153', function() {
      // uncomment below and update the code to test TransactionHistory153
      //var instance = new SendPersonToMerchant.TransactionHistory153();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory153);
    });
