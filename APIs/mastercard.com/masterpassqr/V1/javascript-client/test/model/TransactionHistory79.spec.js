...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPersonToMerchant.TransactionHistory79();
  });
  ...
  describe('TransactionHistory79', function() {
    it('should create an instance of TransactionHistory79', function() {
      // uncomment below and update the code to test TransactionHistory79
      //var instance = new SendPersonToMerchant.TransactionHistory79();
      //expect(instance).to.be.a(SendPersonToMerchant.TransactionHistory79);
    });
