...
- API version: 1.0
  - Build date: 2024-10-12T10:09:28.327719-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*RppsPaymentValidatorApiApi* | [**isRoutingValidPost**](docs/RppsPaymentValidatorApiApi.md#isRoutingValidPost) | **POST** /isRoutingValid | Bill Payment Validator service returns the processing status for a potential RPPS transaction
