...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillPaymentValidator.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new BillPaymentValidator.ErrorResponse();
      //expect(instance).to.be.a(BillPaymentValidator.ErrorResponse);
    });
