...
/**
 * The Transaction7 model module.
 * @module model/Transaction7
 * @version V2
 */
class Transaction7 {
    /**
     * Constructs a new <code>Transaction7</code>.
     * Information for one transaction
     * @alias module:model/Transaction7
     */
    constructor() { 
        
        Transaction7.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Transaction7</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Transaction7} obj Optional instance to populate.
     * @return {module:model/Transaction7} The populated <code>Transaction7</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Transaction7();
            ...
            if (data.hasOwnProperty('Response')) {
                obj['Response'] = Response8.constructFromObject(data['Response']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Transaction7</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Transaction7</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Response']) { // data not null
          Response8.validateJSON(data['Response']);
        }
        // ensure the json data is a string
 ...
 */
Transaction7.prototype['NetworkReferenceNumber'] = undefined;

/**
 * @member {module:model/Response8} Response
 */
Transaction7.prototype['Response'] = undefined;
 ...
 */
Transaction7.prototype['SettlementDate'] = undefined;
 ...
 */
Transaction7.prototype['SubmitDateTime'] = undefined;
 ...
 */
Transaction7.prototype['SystemTraceAuditNumber'] = undefined;

/**
 * Type of transaction. Details- Alpha
 * @member {String} Type
 */
Transaction7.prototype['Type'] = undefined;
