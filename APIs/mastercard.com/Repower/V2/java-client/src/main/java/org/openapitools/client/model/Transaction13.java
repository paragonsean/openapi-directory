...
public class Transaction13 {
  ...
  public Transaction13() {
  }

  public Transaction13 networkReferenceNumber(String networkReferenceNumber) {
  ...
  public Transaction13 response(Response14 response) {
   ...
   */
  @javax.annotation.Nullable
  public Response14 getResponse() {
    return response;
  }

  public void setResponse(Response14 response) {
    this.response = response;
  }


  public Transaction13 settlementDate(String settlementDate) {
  ...
  public Transaction13 submitDateTime(String submitDateTime) {
  ...
  public Transaction13 systemTraceAuditNumber(String systemTraceAuditNumber) {
  ...
  public Transaction13 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Transaction13 transaction13 = (Transaction13) o;
    return Objects.equals(this.networkReferenceNumber, transaction13.networkReferenceNumber) &&
        Objects.equals(this.response, transaction13.response) &&
        Objects.equals(this.settlementDate, transaction13.settlementDate) &&
        Objects.equals(this.submitDateTime, transaction13.submitDateTime) &&
        Objects.equals(this.systemTraceAuditNumber, transaction13.systemTraceAuditNumber) &&
        Objects.equals(this.type, transaction13.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transaction13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transaction13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transaction13 is not found in the empty JSON string", Transaction13.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transaction13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transaction13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Response") != null && !jsonObj.get("Response").isJsonNull()) {
        Response14.validateJsonElement(jsonObj.get("Response"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transaction13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transaction13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transaction13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transaction13.class));

       return (TypeAdapter<T>) new TypeAdapter<Transaction13>() {
           @Override
           public void write(JsonWriter out, Transaction13 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transaction13 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transaction13 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transaction13
   * @throws IOException if the JSON string is invalid with respect to Transaction13
   */
  public static Transaction13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transaction13.class);
  }

  /**
   * Convert an instance of Transaction13 to an JSON string
   *
   * @return JSON string
   */
