...
OAITransaction_7::OAITransaction_7(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransaction_7::OAITransaction_7() {
    this->initializeModel();
}

OAITransaction_7::~OAITransaction_7() {}

void OAITransaction_7::initializeModel() {
...
void OAITransaction_7::fromJson(QString jsonString) {
...
void OAITransaction_7::fromJsonObject(QJsonObject json) {
...
QString OAITransaction_7::asJson() const {
...
QJsonObject OAITransaction_7::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransaction_7::getNetworkReferenceNumber() const {
    return m_network_reference_number;
}
void OAITransaction_7::setNetworkReferenceNumber(const QString &network_reference_number) {
    m_network_reference_number = network_reference_number;
    m_network_reference_number_isSet = true;
}

bool OAITransaction_7::is_network_reference_number_Set() const{
    return m_network_reference_number_isSet;
}

bool OAITransaction_7::is_network_reference_number_Valid() const{
    return m_network_reference_number_isValid;
}

OAIResponse_8 OAITransaction_7::getResponse() const {
    return m_response;
}
void OAITransaction_7::setResponse(const OAIResponse_8 &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAITransaction_7::is_response_Set() const{
    return m_response_isSet;
}

bool OAITransaction_7::is_response_Valid() const{
    return m_response_isValid;
}

QString OAITransaction_7::getSettlementDate() const {
    return m_settlement_date;
}
void OAITransaction_7::setSettlementDate(const QString &settlement_date) {
    m_settlement_date = settlement_date;
    m_settlement_date_isSet = true;
}

bool OAITransaction_7::is_settlement_date_Set() const{
    return m_settlement_date_isSet;
}

bool OAITransaction_7::is_settlement_date_Valid() const{
    return m_settlement_date_isValid;
}

QString OAITransaction_7::getSubmitDateTime() const {
    return m_submit_date_time;
}
void OAITransaction_7::setSubmitDateTime(const QString &submit_date_time) {
    m_submit_date_time = submit_date_time;
    m_submit_date_time_isSet = true;
}

bool OAITransaction_7::is_submit_date_time_Set() const{
    return m_submit_date_time_isSet;
}

bool OAITransaction_7::is_submit_date_time_Valid() const{
    return m_submit_date_time_isValid;
}

QString OAITransaction_7::getSystemTraceAuditNumber() const {
    return m_system_trace_audit_number;
}
void OAITransaction_7::setSystemTraceAuditNumber(const QString &system_trace_audit_number) {
    m_system_trace_audit_number = system_trace_audit_number;
    m_system_trace_audit_number_isSet = true;
}

bool OAITransaction_7::is_system_trace_audit_number_Set() const{
    return m_system_trace_audit_number_isSet;
}

bool OAITransaction_7::is_system_trace_audit_number_Valid() const{
    return m_system_trace_audit_number_isValid;
}

QString OAITransaction_7::getType() const {
    return m_type;
}
void OAITransaction_7::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITransaction_7::is_type_Set() const{
    return m_type_isSet;
}

bool OAITransaction_7::is_type_Valid() const{
    return m_type_isValid;
}

bool OAITransaction_7::isSet() const {
...
bool OAITransaction_7::isValid() const {
