...
**productLine** | **String** | Product lines available for the consumer ?US Executive Report? and/or ?US Weekly Gasoline Report?. | [optional] 
**publicationCoveragePeriod** | **String** | Publication Coverage Period indicates what period is to be covered by the current report. | [optional] 
