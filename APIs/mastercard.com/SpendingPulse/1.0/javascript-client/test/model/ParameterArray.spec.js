...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpendingPulse.ParameterArray();
  });
  ...
  describe('ParameterArray', function() {
    it('should create an instance of ParameterArray', function() {
      // uncomment below and update the code to test ParameterArray
      //var instance = new SpendingPulse.ParameterArray();
      //expect(instance).to.be.a(SpendingPulse.ParameterArray);
    });
