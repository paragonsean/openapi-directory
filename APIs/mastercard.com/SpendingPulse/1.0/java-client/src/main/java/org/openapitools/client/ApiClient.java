...
public class ApiClient {
    ...
    private String basePath = "https://api.mastercard.com/spendingpulse/v1/spulse.svc";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.mastercard.com/spendingpulse/v1/spulse.svc",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.mastercard.com/spendingpulse/v1/spulse.svc
