...
class PostPaymentsSepaCreditTransfersConsentsParamsBodyPaymentsDebtorAgent(Model):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PostPaymentsSepaCreditTransfersConsentsParamsBodyPaymentsDebtorAgent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The postPaymentsSepaCreditTransfersConsentsParamsBodyPayments_debtorAgent of this PostPaymentsSepaCreditTransfersConsentsParamsBodyPaymentsDebtorAgent.
        """
