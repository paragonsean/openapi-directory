...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBankingPaymentsInitiationService.Merchant();
  });
  ...
  describe('Merchant', function() {
    it('should create an instance of Merchant', function() {
      ...
      //var instance = new OpenBankingPaymentsInitiationService.Merchant();
      //expect(instance).to.be.a(OpenBankingPaymentsInitiationService.Merchant);
    });
