...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBankingPaymentsInitiationService.PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments();
  });
  ...
  describe('PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments', function() {
    it('should create an instance of PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments', function() {
      // uncomment below and update the code to test PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments
      //var instance = new OpenBankingPaymentsInitiationService.PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments();
      //expect(instance).to.be.a(OpenBankingPaymentsInitiationService.PostPaymentsDomesticCreditTransfersConsentsParamsBodyPayments);
    });
