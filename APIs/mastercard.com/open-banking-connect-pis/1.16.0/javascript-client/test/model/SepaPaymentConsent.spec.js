...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBankingPaymentsInitiationService.SepaPaymentConsent();
  });
  ...
  describe('SepaPaymentConsent', function() {
    it('should create an instance of SepaPaymentConsent', function() {
      // uncomment below and update the code to test SepaPaymentConsent
      //var instance = new OpenBankingPaymentsInitiationService.SepaPaymentConsent();
      //expect(instance).to.be.a(OpenBankingPaymentsInitiationService.SepaPaymentConsent);
    });
