...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBankingPaymentsInitiationService.PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments();
  });
  ...
  describe('PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments', function() {
    it('should create an instance of PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments', function() {
      // uncomment below and update the code to test PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments
      //var instance = new OpenBankingPaymentsInitiationService.PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments();
      //expect(instance).to.be.a(OpenBankingPaymentsInitiationService.PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments);
    });

    it('should have the property categoryPurpose (base name: "categoryPurpose")', function() {
      // uncomment below and update the code to test the property categoryPurpose
      //var instance = new OpenBankingPaymentsInitiationService.PostPaymentsSepaCreditTransfersConsentsParamsBodyPayments();
