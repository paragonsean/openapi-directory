...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBankingPaymentsInitiationService.ApiHealth();
  });
  ...
  describe('ApiHealth', function() {
    it('should create an instance of ApiHealth', function() {
      // uncomment below and update the code to test ApiHealth
      //var instance = new OpenBankingPaymentsInitiationService.ApiHealth();
      //expect(instance).to.be.a(OpenBankingPaymentsInitiationService.ApiHealth);
    });
