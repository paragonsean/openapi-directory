...
public class PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress {
  ...
  static {
    ...
    openapiRequiredFields.add("buildingNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress is not found in the empty JSON string", PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("buildingNumber").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress>() {
           @Override
           public void write(JsonWriter out, PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress
   */
  public static PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress.class);
  }

  /**
   * Convert an instance of PostPaymentsDomesticCreditTransfersConsentsParamsBodyPaymentsCreditorAddress to an JSON string
   *
   * @return JSON string
   */
