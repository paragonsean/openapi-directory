...
public class PostPaymentsConsentsRawParamsBodyRequestInfo {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsConsentsRawParamsBodyRequestInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsConsentsRawParamsBodyRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsConsentsRawParamsBodyRequestInfo is not found in the empty JSON string", PostPaymentsConsentsRawParamsBodyRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsConsentsRawParamsBodyRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsConsentsRawParamsBodyRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPaymentsConsentsRawParamsBodyRequestInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsConsentsRawParamsBodyRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsConsentsRawParamsBodyRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsConsentsRawParamsBodyRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsConsentsRawParamsBodyRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsConsentsRawParamsBodyRequestInfo>() {
           @Override
           public void write(JsonWriter out, PostPaymentsConsentsRawParamsBodyRequestInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsConsentsRawParamsBodyRequestInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsConsentsRawParamsBodyRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsConsentsRawParamsBodyRequestInfo
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsConsentsRawParamsBodyRequestInfo
   */
  public static PostPaymentsConsentsRawParamsBodyRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsConsentsRawParamsBodyRequestInfo.class);
  }

  /**
   * Convert an instance of PostPaymentsConsentsRawParamsBodyRequestInfo to an JSON string
   *
   * @return JSON string
   */
