...
public class PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments is not found in the empty JSON string", PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments>() {
           @Override
           public void write(JsonWriter out, PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments
   */
  public static PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments.class);
  }

  /**
   * Convert an instance of PostPaymentsDomesticCreditTransfersPaymentStatusOKBodyPayments to an JSON string
   *
   * @return JSON string
   */
