...
public class PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress {
  ...
  public PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress is not found in the empty JSON string", PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress>() {
           @Override
           public void write(JsonWriter out, PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress
   */
  public static PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress.class);
  }

  /**
   * Convert an instance of PostPaymentsCrossBorderCreditTransfersConsentsParamsBodyPaymentsDebtorAddress to an JSON string
   *
   * @return JSON string
   */
