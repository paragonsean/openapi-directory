...
public class PostPaymentsCrossBorderCreditTransfersConsentsOKBody {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsCrossBorderCreditTransfersConsentsOKBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsCrossBorderCreditTransfersConsentsOKBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsCrossBorderCreditTransfersConsentsOKBody is not found in the empty JSON string", PostPaymentsCrossBorderCreditTransfersConsentsOKBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsCrossBorderCreditTransfersConsentsOKBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsCrossBorderCreditTransfersConsentsOKBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPaymentsCrossBorderCreditTransfersConsentsOKBody.openapiRequiredFields) {
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        PostPaymentsCrossBorderCreditTransfersConsentsOKBodyLinks.validateJsonElement(jsonObj.get("_links"));
      }
      ...
      PostPaymentsCrossBorderCreditTransfersConsentsOKBodyOriginalRequestInfo.validateJsonElement(jsonObj.get("originalRequestInfo"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsCrossBorderCreditTransfersConsentsOKBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsCrossBorderCreditTransfersConsentsOKBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsCrossBorderCreditTransfersConsentsOKBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsCrossBorderCreditTransfersConsentsOKBody.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsCrossBorderCreditTransfersConsentsOKBody>() {
           @Override
           public void write(JsonWriter out, PostPaymentsCrossBorderCreditTransfersConsentsOKBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsCrossBorderCreditTransfersConsentsOKBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsCrossBorderCreditTransfersConsentsOKBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsCrossBorderCreditTransfersConsentsOKBody
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsCrossBorderCreditTransfersConsentsOKBody
   */
  public static PostPaymentsCrossBorderCreditTransfersConsentsOKBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsCrossBorderCreditTransfersConsentsOKBody.class);
  }

  /**
   * Convert an instance of PostPaymentsCrossBorderCreditTransfersConsentsOKBody to an JSON string
   *
   * @return JSON string
   */
