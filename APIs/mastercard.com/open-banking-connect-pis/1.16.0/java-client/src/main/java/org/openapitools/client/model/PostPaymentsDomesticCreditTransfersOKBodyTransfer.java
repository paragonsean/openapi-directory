...
public class PostPaymentsDomesticCreditTransfersOKBodyTransfer {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostPaymentsDomesticCreditTransfersOKBodyTransfer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostPaymentsDomesticCreditTransfersOKBodyTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostPaymentsDomesticCreditTransfersOKBodyTransfer is not found in the empty JSON string", PostPaymentsDomesticCreditTransfersOKBodyTransfer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostPaymentsDomesticCreditTransfersOKBodyTransfer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostPaymentsDomesticCreditTransfersOKBodyTransfer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostPaymentsDomesticCreditTransfersOKBodyTransfer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostPaymentsDomesticCreditTransfersOKBodyTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostPaymentsDomesticCreditTransfersOKBodyTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostPaymentsDomesticCreditTransfersOKBodyTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostPaymentsDomesticCreditTransfersOKBodyTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<PostPaymentsDomesticCreditTransfersOKBodyTransfer>() {
           @Override
           public void write(JsonWriter out, PostPaymentsDomesticCreditTransfersOKBodyTransfer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostPaymentsDomesticCreditTransfersOKBodyTransfer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostPaymentsDomesticCreditTransfersOKBodyTransfer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostPaymentsDomesticCreditTransfersOKBodyTransfer
   * @throws IOException if the JSON string is invalid with respect to PostPaymentsDomesticCreditTransfersOKBodyTransfer
   */
  public static PostPaymentsDomesticCreditTransfersOKBodyTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostPaymentsDomesticCreditTransfersOKBodyTransfer.class);
  }

  /**
   * Convert an instance of PostPaymentsDomesticCreditTransfersOKBodyTransfer to an JSON string
   *
   * @return JSON string
   */
