...
public class ApiClient {
    ...
    private String basePath = "/openbanking/sandbox/connect/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "/openbanking/sandbox/connect/api",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.16.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g /openbanking/sandbox/connect/api
