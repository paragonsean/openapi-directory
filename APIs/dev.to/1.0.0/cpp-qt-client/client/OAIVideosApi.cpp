...
void OAIVideosApi::videos(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideosApi::videosCallback);
...
void OAIVideosApi::videosCallback(OAIHttpRequestWorker *worker) {
