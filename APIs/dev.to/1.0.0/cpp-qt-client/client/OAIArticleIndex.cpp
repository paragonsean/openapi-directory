...
OAIArticleIndex::OAIArticleIndex(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArticleIndex::OAIArticleIndex() {
    this->initializeModel();
}

OAIArticleIndex::~OAIArticleIndex() {}

void OAIArticleIndex::initializeModel() {
    ...
    m_flare_tag_isSet = false;
    m_flare_tag_isValid = false;
...
void OAIArticleIndex::fromJson(QString jsonString) {
...
void OAIArticleIndex::fromJsonObject(QJsonObject json) {
    ...
    m_flare_tag_isValid = ::OpenAPI::fromJsonValue(m_flare_tag, json[QString("flare_tag")]);
    m_flare_tag_isSet = !json[QString("flare_tag")].isNull() && m_flare_tag_isValid;
...
QString OAIArticleIndex::asJson() const {
...
QJsonObject OAIArticleIndex::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_flare_tag.isSet()) {
        obj.insert(QString("flare_tag"), ::OpenAPI::toJsonValue(m_flare_tag));
    }
    if (m_id_isSet) {
...
QString OAIArticleIndex::getCanonicalUrl() const {
    return m_canonical_url;
}
void OAIArticleIndex::setCanonicalUrl(const QString &canonical_url) {
    m_canonical_url = canonical_url;
    m_canonical_url_isSet = true;
}

bool OAIArticleIndex::is_canonical_url_Set() const{
    return m_canonical_url_isSet;
}

bool OAIArticleIndex::is_canonical_url_Valid() const{
    return m_canonical_url_isValid;
}

QString OAIArticleIndex::getCoverImage() const {
    return m_cover_image;
}
void OAIArticleIndex::setCoverImage(const QString &cover_image) {
    m_cover_image = cover_image;
    m_cover_image_isSet = true;
}

bool OAIArticleIndex::is_cover_image_Set() const{
    return m_cover_image_isSet;
}

bool OAIArticleIndex::is_cover_image_Valid() const{
    return m_cover_image_isValid;
}

QDateTime OAIArticleIndex::getCreatedAt() const {
    return m_created_at;
}
void OAIArticleIndex::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIArticleIndex::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIArticleIndex::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIArticleIndex::getCrosspostedAt() const {
    return m_crossposted_at;
}
void OAIArticleIndex::setCrosspostedAt(const QDateTime &crossposted_at) {
    m_crossposted_at = crossposted_at;
    m_crossposted_at_isSet = true;
}

bool OAIArticleIndex::is_crossposted_at_Set() const{
    return m_crossposted_at_isSet;
}

bool OAIArticleIndex::is_crossposted_at_Valid() const{
    return m_crossposted_at_isValid;
}

QString OAIArticleIndex::getDescription() const {
    return m_description;
}
void OAIArticleIndex::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIArticleIndex::is_description_Set() const{
    return m_description_isSet;
}

bool OAIArticleIndex::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIArticleIndex::getEditedAt() const {
    return m_edited_at;
}
void OAIArticleIndex::setEditedAt(const QDateTime &edited_at) {
    m_edited_at = edited_at;
    m_edited_at_isSet = true;
}

bool OAIArticleIndex::is_edited_at_Set() const{
    return m_edited_at_isSet;
}

bool OAIArticleIndex::is_edited_at_Valid() const{
    return m_edited_at_isValid;
}

OAIArticleFlareTag OAIArticleIndex::getFlareTag() const {
    return m_flare_tag;
}
void OAIArticleIndex::setFlareTag(const OAIArticleFlareTag &flare_tag) {
    m_flare_tag = flare_tag;
    m_flare_tag_isSet = true;
}

bool OAIArticleIndex::is_flare_tag_Set() const{
    return m_flare_tag_isSet;
}

bool OAIArticleIndex::is_flare_tag_Valid() const{
    return m_flare_tag_isValid;
}

qint32 OAIArticleIndex::getId() const {
    return m_id;
}
void OAIArticleIndex::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIArticleIndex::is_id_Set() const{
    return m_id_isSet;
}

bool OAIArticleIndex::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIArticleIndex::getLastCommentAt() const {
    return m_last_comment_at;
}
void OAIArticleIndex::setLastCommentAt(const QDateTime &last_comment_at) {
    m_last_comment_at = last_comment_at;
    m_last_comment_at_isSet = true;
}

bool OAIArticleIndex::is_last_comment_at_Set() const{
    return m_last_comment_at_isSet;
}

bool OAIArticleIndex::is_last_comment_at_Valid() const{
    return m_last_comment_at_isValid;
}

OAISharedOrganization OAIArticleIndex::getOrganization() const {
    return m_organization;
}
void OAIArticleIndex::setOrganization(const OAISharedOrganization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIArticleIndex::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIArticleIndex::is_organization_Valid() const{
    return m_organization_isValid;
}

QString OAIArticleIndex::getPath() const {
    return m_path;
}
void OAIArticleIndex::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIArticleIndex::is_path_Set() const{
    return m_path_isSet;
}

bool OAIArticleIndex::is_path_Valid() const{
    return m_path_isValid;
}

qint32 OAIArticleIndex::getPositiveReactionsCount() const {
    return m_positive_reactions_count;
}
void OAIArticleIndex::setPositiveReactionsCount(const qint32 &positive_reactions_count) {
    m_positive_reactions_count = positive_reactions_count;
    m_positive_reactions_count_isSet = true;
}

bool OAIArticleIndex::is_positive_reactions_count_Set() const{
    return m_positive_reactions_count_isSet;
}

bool OAIArticleIndex::is_positive_reactions_count_Valid() const{
    return m_positive_reactions_count_isValid;
}

qint32 OAIArticleIndex::getPublicReactionsCount() const {
    return m_public_reactions_count;
}
void OAIArticleIndex::setPublicReactionsCount(const qint32 &public_reactions_count) {
    m_public_reactions_count = public_reactions_count;
    m_public_reactions_count_isSet = true;
}

bool OAIArticleIndex::is_public_reactions_count_Set() const{
    return m_public_reactions_count_isSet;
}

bool OAIArticleIndex::is_public_reactions_count_Valid() const{
    return m_public_reactions_count_isValid;
}

QDateTime OAIArticleIndex::getPublishedAt() const {
    return m_published_at;
}
void OAIArticleIndex::setPublishedAt(const QDateTime &published_at) {
    m_published_at = published_at;
    m_published_at_isSet = true;
}

bool OAIArticleIndex::is_published_at_Set() const{
    return m_published_at_isSet;
}

bool OAIArticleIndex::is_published_at_Valid() const{
    return m_published_at_isValid;
}

QDateTime OAIArticleIndex::getPublishedTimestamp() const {
    return m_published_timestamp;
}
void OAIArticleIndex::setPublishedTimestamp(const QDateTime &published_timestamp) {
    m_published_timestamp = published_timestamp;
    m_published_timestamp_isSet = true;
}

bool OAIArticleIndex::is_published_timestamp_Set() const{
    return m_published_timestamp_isSet;
}

bool OAIArticleIndex::is_published_timestamp_Valid() const{
    return m_published_timestamp_isValid;
}

QString OAIArticleIndex::getReadablePublishDate() const {
    return m_readable_publish_date;
}
void OAIArticleIndex::setReadablePublishDate(const QString &readable_publish_date) {
    m_readable_publish_date = readable_publish_date;
    m_readable_publish_date_isSet = true;
}

bool OAIArticleIndex::is_readable_publish_date_Set() const{
    return m_readable_publish_date_isSet;
}

bool OAIArticleIndex::is_readable_publish_date_Valid() const{
    return m_readable_publish_date_isValid;
}

qint32 OAIArticleIndex::getReadingTimeMinutes() const {
    return m_reading_time_minutes;
}
void OAIArticleIndex::setReadingTimeMinutes(const qint32 &reading_time_minutes) {
    m_reading_time_minutes = reading_time_minutes;
    m_reading_time_minutes_isSet = true;
}

bool OAIArticleIndex::is_reading_time_minutes_Set() const{
    return m_reading_time_minutes_isSet;
}

bool OAIArticleIndex::is_reading_time_minutes_Valid() const{
    return m_reading_time_minutes_isValid;
}

QString OAIArticleIndex::getSlug() const {
    return m_slug;
}
void OAIArticleIndex::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIArticleIndex::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIArticleIndex::is_slug_Valid() const{
    return m_slug_isValid;
}

QString OAIArticleIndex::getSocialImage() const {
    return m_social_image;
}
void OAIArticleIndex::setSocialImage(const QString &social_image) {
    m_social_image = social_image;
    m_social_image_isSet = true;
}

bool OAIArticleIndex::is_social_image_Set() const{
    return m_social_image_isSet;
}

bool OAIArticleIndex::is_social_image_Valid() const{
    return m_social_image_isValid;
}

QList<QString> OAIArticleIndex::getTagList() const {
    return m_tag_list;
}
void OAIArticleIndex::setTagList(const QList<QString> &tag_list) {
    m_tag_list = tag_list;
    m_tag_list_isSet = true;
}

bool OAIArticleIndex::is_tag_list_Set() const{
    return m_tag_list_isSet;
}

bool OAIArticleIndex::is_tag_list_Valid() const{
    return m_tag_list_isValid;
}

QString OAIArticleIndex::getTags() const {
    return m_tags;
}
void OAIArticleIndex::setTags(const QString &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIArticleIndex::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIArticleIndex::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIArticleIndex::getTitle() const {
    return m_title;
}
void OAIArticleIndex::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIArticleIndex::is_title_Set() const{
    return m_title_isSet;
}

bool OAIArticleIndex::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIArticleIndex::getTypeOf() const {
    return m_type_of;
}
void OAIArticleIndex::setTypeOf(const QString &type_of) {
    m_type_of = type_of;
    m_type_of_isSet = true;
}

bool OAIArticleIndex::is_type_of_Set() const{
    return m_type_of_isSet;
}

bool OAIArticleIndex::is_type_of_Valid() const{
    return m_type_of_isValid;
}

QString OAIArticleIndex::getUrl() const {
    return m_url;
}
void OAIArticleIndex::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIArticleIndex::is_url_Set() const{
    return m_url_isSet;
}

bool OAIArticleIndex::is_url_Valid() const{
    return m_url_isValid;
}

OAISharedUser OAIArticleIndex::getUser() const {
    return m_user;
}
void OAIArticleIndex::setUser(const OAISharedUser &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIArticleIndex::is_user_Set() const{
    return m_user_isSet;
}

bool OAIArticleIndex::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIArticleIndex::isSet() const {
...
bool OAIArticleIndex::isValid() const {
