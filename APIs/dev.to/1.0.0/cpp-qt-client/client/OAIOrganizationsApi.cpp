...
void OAIOrganizationsApi::getOrgArticles(const QString &username, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::getOrgArticlesCallback);
...
void OAIOrganizationsApi::getOrgArticlesCallback(OAIHttpRequestWorker *worker) {
...
void OAIOrganizationsApi::getOrgUsers(const QString &username, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::getOrgUsersCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::getOrgUsersCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIOrganizationsApi::getOrganization(const QString &username) {
    QString fullPath = QString(_serverConfigs["getOrganization"][_serverIndices.value("getOrganization")].URL()+"/api/organizations/{username}");
