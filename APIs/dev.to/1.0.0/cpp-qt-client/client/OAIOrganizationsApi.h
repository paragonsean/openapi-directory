...
public:
    ...
    * @param[in]  username QString [required]
    */
    virtual void getOrganization(const QString &username);
...
Q_SIGNALS:
    ...
    void getOrganizationSignal(QList<OAIOrganization> summary);
    ...
    void getOrganizationSignalFull(OAIHttpRequestWorker *worker, QList<OAIOrganization> summary);
    ...
    void getOrganizationSignalE(QList<OAIOrganization> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationSignalError(QList<OAIOrganization> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
