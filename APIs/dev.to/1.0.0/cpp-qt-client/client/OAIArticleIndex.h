...
#ifndef OAIArticleIndex_H
#define OAIArticleIndex_H
...
namespace OpenAPI {
class OAIArticleFlareTag;
class OAISharedOrganization;
class OAISharedUser;

class OAIArticleIndex : public OAIObject {
public:
    OAIArticleIndex();
    OAIArticleIndex(QString json);
    ~OAIArticleIndex() override;
    ...
    OAIArticleFlareTag getFlareTag() const;
    void setFlareTag(const OAIArticleFlareTag &flare_tag);
    bool is_flare_tag_Set() const;
    bool is_flare_tag_Valid() const;
...
private:
    ...
    OAIArticleFlareTag m_flare_tag;
    bool m_flare_tag_isSet;
    bool m_flare_tag_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticleIndex)

#endif // OAIArticleIndex_H
