...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ForemApiV1.PodcastEpisodeIndex();
  });
  ...
  describe('PodcastEpisodeIndex', function() {
    it('should create an instance of PodcastEpisodeIndex', function() {
      // uncomment below and update the code to test PodcastEpisodeIndex
      //var instance = new ForemApiV1.PodcastEpisodeIndex();
      //expect(instance).to.be.a(ForemApiV1.PodcastEpisodeIndex);
    });
