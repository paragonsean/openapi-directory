...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ForemApiV1.OrganizationsApi();
  });
  ...
  describe('OrganizationsApi', function() {
    describe('getOrgArticles', function() {
      it('should call getOrgArticles successfully', function(done) {
        //uncomment below and update the code to test getOrgArticles
        //instance.getOrgArticles(function(error) {
    ...
    describe('getOrgUsers', function() {
      it('should call getOrgUsers successfully', function(done) {
        //uncomment below and update the code to test getOrgUsers
        //instance.getOrgUsers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
