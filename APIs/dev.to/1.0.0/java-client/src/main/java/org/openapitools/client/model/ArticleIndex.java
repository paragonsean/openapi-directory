...
public class ArticleIndex {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.canonicalUrl, articleIndex.canonicalUrl) &&
        ...
        Objects.equals(this.tags, articleIndex.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canonicalUrl, coverImage, createdAt, crosspostedAt, description, editedAt, flareTag, id, lastCommentAt, organization, path, positiveReactionsCount, publicReactionsCount, publishedAt, publishedTimestamp, readablePublishDate, readingTimeMinutes, slug, socialImage, tagList, tags, title, typeOf, url, user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArticleIndex
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArticleIndex.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArticleIndex.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArticleIndex` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("flare_tag") != null && !jsonObj.get("flare_tag").isJsonNull()) {
        ArticleFlareTag.validateJsonElement(jsonObj.get("flare_tag"));
      }
