...
public class ArticleArticle {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bodyMarkdown, articleArticle.bodyMarkdown) &&
        ...
        Objects.equals(this.tags, articleArticle.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bodyMarkdown, canonicalUrl, description, mainImage, organizationId, published, series, tags, title);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArticleArticle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArticleArticle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArticleArticle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArticleArticle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
