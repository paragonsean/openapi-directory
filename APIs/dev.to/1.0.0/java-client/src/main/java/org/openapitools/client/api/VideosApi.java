...
public class VideosApi {
     ...
     */
    public okhttp3.Call videosCall(Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call videosValidateBeforeCall(Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        return videosCall(page, perPage, _callback);
     ...
     */
    public List<VideoArticle> videos(Integer page, Integer perPage) throws ApiException {
        ApiResponse<List<VideoArticle>> localVarResp = videosWithHttpInfo(page, perPage);
     ...
     */
    public ApiResponse<List<VideoArticle>> videosWithHttpInfo(Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = videosValidateBeforeCall(page, perPage, null);
     ...
     */
    public okhttp3.Call videosAsync(Integer page, Integer perPage, final ApiCallback<List<VideoArticle>> _callback) throws ApiException {

        okhttp3.Call localVarCall = videosValidateBeforeCall(page, perPage, _callback);
        Type localVarReturnType = new TypeToken<List<VideoArticle>>(){}.getType();
