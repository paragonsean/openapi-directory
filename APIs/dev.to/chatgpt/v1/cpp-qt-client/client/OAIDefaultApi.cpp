...
void OAIDefaultApi::getArticles(const ::OpenAPI::OptionalParam<QString> &q, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<QString> &top) {
    QString fullPath = QString(_serverConfigs["getArticles"][_serverIndices.value("getArticles")].URL()+"/api/articles/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getArticlesCallback);
...
void OAIDefaultApi::getArticlesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetArticlesResponse output(QString(worker->response));
    worker->deleteLater();
