...
void OAIAlertsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("apiPublicV1AlertsUuidGet", defaultConf);
    _serverIndices.insert("apiPublicV1AlertsUuidGet", 0);
}
...
void OAIAlertsApi::apiPublicV1AlertsUuidGet(const QString &x_vo_api_id, const QString &x_vo_api_key, const QString &uuid) {
    QString fullPath = QString(_serverConfigs["apiPublicV1AlertsUuidGet"][_serverIndices.value("apiPublicV1AlertsUuidGet")].URL()+"/api-public/v1/alerts/{uuid}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::apiPublicV1AlertsUuidGetCallback);
...
void OAIAlertsApi::apiPublicV1AlertsUuidGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetAlertResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiPublicV1AlertsUuidGetSignal(output);
        Q_EMIT apiPublicV1AlertsUuidGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiPublicV1AlertsUuidGetSignalE(output, error_type, error_str);
        Q_EMIT apiPublicV1AlertsUuidGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiPublicV1AlertsUuidGetSignalError(output, error_type, error_str);
        Q_EMIT apiPublicV1AlertsUuidGetSignalErrorFull(worker, error_type, error_str);
    }
}
