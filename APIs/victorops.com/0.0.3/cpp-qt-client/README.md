...
void Example::exampleFunction1(){
     OAIAlertsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAlertsApi::apiPublicV1AlertsUuidGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAlertsApi::apiPublicV1AlertsUuidGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString x_vo_api_id = create(); // QString | Your API ID
      ...
      QString x_vo_api_key = create(); // QString | Your API Key
      ...
      QString uuid = create(); // QString | The VictorOps uuid of the alert
      apiInstance.apiPublicV1AlertsUuidGet(x_vo_api_idx_vo_api_keyuuid);
