    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('description')) {
                obj['description'] = ContactDescription.constructFromObject(data['description']);
            }
...
/**
 * @member {module:model/ContactDescription} description
 */
ContactObject.prototype['description'] = undefined;

/**
 * @member {module:model/ContactType} type
 */
ContactObject.prototype['type'] = undefined;
