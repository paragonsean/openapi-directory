# VictorOps.ActiveMaintenanceMode
...
**startedAt** | **Number** | millis from epoch marking the start time | [optional] 
**startedBy** | **String** | username of the user that started maintenance mode | [optional] 
**targets** | [**[MaintenanceModeTarget]**](MaintenanceModeTarget.md) |  | [optional] 
