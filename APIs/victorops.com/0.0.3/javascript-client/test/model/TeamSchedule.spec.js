...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.TeamSchedule();
  });
  ...
  describe('TeamSchedule', function() {
    it('should create an instance of TeamSchedule', function() {
      // uncomment below and update the code to test TeamSchedule
      //var instance = new VictorOps.TeamSchedule();
      //expect(instance).to.be.a(VictorOps.TeamSchedule);
    });
