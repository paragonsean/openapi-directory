...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.OnCallAndOverrides();
  });
  ...
  describe('OnCallAndOverrides', function() {
    it('should create an instance of OnCallAndOverrides', function() {
      // uncomment below and update the code to test OnCallAndOverrides
      //var instance = new VictorOps.OnCallAndOverrides();
      //expect(instance).to.be.a(VictorOps.OnCallAndOverrides);
    });
