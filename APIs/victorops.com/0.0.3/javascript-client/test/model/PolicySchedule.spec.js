...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.PolicySchedule();
  });
  ...
  describe('PolicySchedule', function() {
    it('should create an instance of PolicySchedule', function() {
      // uncomment below and update the code to test PolicySchedule
      //var instance = new VictorOps.PolicySchedule();
      //expect(instance).to.be.a(VictorOps.PolicySchedule);
    });
