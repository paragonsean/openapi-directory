...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.TeamScheduleResource();
  });
  ...
  describe('TeamScheduleResource', function() {
    it('should create an instance of TeamScheduleResource', function() {
      // uncomment below and update the code to test TeamScheduleResource
      //var instance = new VictorOps.TeamScheduleResource();
      //expect(instance).to.be.a(VictorOps.TeamScheduleResource);
    });

    it('should have the property oncall (base name: "oncall")', function() {
      // uncomment below and update the code to test the property oncall
      //var instance = new VictorOps.TeamScheduleResource();
      //expect(instance).to.be();
    });

    it('should have the property overrideoncall (base name: "overrideoncall")', function() {
      // uncomment below and update the code to test the property overrideoncall
      //var instance = new VictorOps.TeamScheduleResource();
      //expect(instance).to.be();
    });
