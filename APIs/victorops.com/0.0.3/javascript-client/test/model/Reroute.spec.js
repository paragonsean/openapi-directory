...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.Reroute();
  });
  ...
  describe('Reroute', function() {
    it('should create an instance of Reroute', function() {
      // uncomment below and update the code to test Reroute
      //var instance = new VictorOps.Reroute();
      //expect(instance).to.be.a(VictorOps.Reroute);
    });
