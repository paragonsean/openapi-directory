...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.RerouteStatus();
  });
  ...
  describe('RerouteStatus', function() {
    it('should create an instance of RerouteStatus', function() {
      // uncomment below and update the code to test RerouteStatus
      //var instance = new VictorOps.RerouteStatus();
      //expect(instance).to.be.a(VictorOps.RerouteStatus);
    });
