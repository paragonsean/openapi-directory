...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.RoutingKeyInfo();
  });
  ...
  describe('RoutingKeyInfo', function() {
    it('should create an instance of RoutingKeyInfo', function() {
      // uncomment below and update the code to test RoutingKeyInfo
      //var instance = new VictorOps.RoutingKeyInfo();
      //expect(instance).to.be.a(VictorOps.RoutingKeyInfo);
    });
