...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.AckUser();
  });
  ...
  describe('AckUser', function() {
    it('should create an instance of AckUser', function() {
      // uncomment below and update the code to test AckUser
      //var instance = new VictorOps.AckUser();
      //expect(instance).to.be.a(VictorOps.AckUser);
    });
