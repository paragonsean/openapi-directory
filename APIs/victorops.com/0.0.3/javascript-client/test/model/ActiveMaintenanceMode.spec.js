...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VictorOps.ActiveMaintenanceMode();
  });
  ...
  describe('ActiveMaintenanceMode', function() {
    it('should create an instance of ActiveMaintenanceMode', function() {
      // uncomment below and update the code to test ActiveMaintenanceMode
      //var instance = new VictorOps.ActiveMaintenanceMode();
      //expect(instance).to.be.a(VictorOps.ActiveMaintenanceMode);
    });
