...
import org.openapitools.client.model.PagingPolicy;
...
public class Policies {
  ...
  private List<PagingPolicy> policies = new ArrayList<>();
  ...
  public Policies policies(List<PagingPolicy> policies) {
    this.policies = policies;
    return this;
  }

  public Policies addPoliciesItem(PagingPolicy policiesItem) {
  ...
  public List<PagingPolicy> getPolicies() {
    return policies;
  }

  public void setPolicies(List<PagingPolicy> policies) {
    this.policies = policies;
  }


  public Policies userId(Integer userId) {
    this.userId = userId;
    return this;
  }
  ...
  public Policies username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policies, policies.policies) &&
        Objects.equals(this.userId, policies.userId) &&
        Objects.equals(this.username, policies.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policies, userId, username);
  }
      ...
      if (jsonObj.get("policies") != null && !jsonObj.get("policies").isJsonNull()) {
        ...
        if (jsonArraypolicies != null) {
          ...
          for (int i = 0; i < jsonArraypolicies.size(); i++) {
            PagingPolicy.validateJsonElement(jsonArraypolicies.get(i));
          };
        }
      }
