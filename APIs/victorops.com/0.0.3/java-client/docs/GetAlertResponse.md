...
|**stateStartTime** | **BigDecimal** | The time this entity entered its current state (seconds since epoch). |  [optional] |
|**timestamp** | **BigDecimal** | Timestamp of the alert in seconds since epoch. |  [optional] |
