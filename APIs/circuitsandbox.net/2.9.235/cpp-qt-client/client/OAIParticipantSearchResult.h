...
/*
 * OAIParticipantSearchResult.h
 *
 * 
 */

#ifndef OAIParticipantSearchResult_H
#define OAIParticipantSearchResult_H
...
class OAIParticipantSearchResult : public OAIObject {
public:
    OAIParticipantSearchResult();
    OAIParticipantSearchResult(QString json);
    ~OAIParticipantSearchResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipantSearchResult)

#endif // OAIParticipantSearchResult_H
