...
/*
 * OAIParticipantSearchResultLarge.h
 *
 * 
 */

#ifndef OAIParticipantSearchResultLarge_H
#define OAIParticipantSearchResultLarge_H
...
class OAIParticipantSearchResultLarge : public OAIObject {
public:
    OAIParticipantSearchResultLarge();
    OAIParticipantSearchResultLarge(QString json);
    ~OAIParticipantSearchResultLarge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipantSearchResultLarge)

#endif // OAIParticipantSearchResultLarge_H
