...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApiVersion2.RtcMoved();
  });
  ...
  describe('RtcMoved', function() {
    it('should create an instance of RtcMoved', function() {
      // uncomment below and update the code to test RtcMoved
      //var instance = new RestApiVersion2.RtcMoved();
      //expect(instance).to.be.a(RestApiVersion2.RtcMoved);
    });
