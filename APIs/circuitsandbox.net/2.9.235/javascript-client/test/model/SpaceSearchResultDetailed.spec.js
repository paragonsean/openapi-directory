...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApiVersion2.SpaceSearchResultDetailed();
  });
  ...
  describe('SpaceSearchResultDetailed', function() {
    it('should create an instance of SpaceSearchResultDetailed', function() {
      // uncomment below and update the code to test SpaceSearchResultDetailed
      //var instance = new RestApiVersion2.SpaceSearchResultDetailed();
      //expect(instance).to.be.a(RestApiVersion2.SpaceSearchResultDetailed);
    });
