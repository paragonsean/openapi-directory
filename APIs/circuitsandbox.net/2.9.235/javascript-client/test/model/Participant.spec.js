...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApiVersion2.Participant();
  });
  ...
  describe('Participant', function() {
    it('should create an instance of Participant', function() {
      ...
      //var instance = new RestApiVersion2.Participant();
      //expect(instance).to.be.a(RestApiVersion2.Participant);
    });
    ...
    it('should have the property lastReadTimestamp (base name: "lastReadTimestamp")', function() {
