# RestApiVersion2.WebHook

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**creationTime** | **Number** | The time when this WebHook was created. This does not necessary mean the time when an manifest file was created. | [optional] 
**filter** | **[String]** | An optional list of filter parameters for this webhook. | [optional] 
**id** | **String** | The unique identifier for this webhook. Can be used later to unregister the webhook. | [optional] 
**subscriptionIds** | **[String]** | The optional list of userids for which this webhook is subscribed, i.e. presence events for the user are forwarded to the WebHook callback URL. | [optional] 
