...
public class ApiClient {
    ...
    private String basePath = "https://circuitsandbox.net/rest/v2";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.9.235/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://circuitsandbox.net/rest/v2
