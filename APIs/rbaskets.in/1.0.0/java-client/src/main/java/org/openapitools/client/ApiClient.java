...
public class ApiClient {
    ...
    private String basePath = "https://rbaskets.in";
    ...
    public ApiClient() {
        ...
        authentications.put("basket_token", new ApiKeyAuth("header", "Authorization"));
        authentications.put("service_token", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://rbaskets.in
