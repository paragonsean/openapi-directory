...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RequestBasketsApi.ServiceApi();
  });
  ...
  describe('ServiceApi', function() {
    describe('apiVersionGet', function() {
      it('should call apiVersionGet successfully', function(done) {
        //uncomment below and update the code to test apiVersionGet
        //instance.apiVersionGet(function(error) {
