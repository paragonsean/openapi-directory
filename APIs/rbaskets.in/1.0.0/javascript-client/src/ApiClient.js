...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://rbaskets.in') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://rbaskets.in
         */
        ...
        this.authentications = {
            'basket_token': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
            'service_token': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
