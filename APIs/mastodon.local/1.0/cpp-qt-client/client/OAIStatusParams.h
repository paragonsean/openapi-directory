...
#ifndef OAIStatusParams_H
#define OAIStatusParams_H
...
class OAIStatusParams : public OAIObject {
public:
    OAIStatusParams();
    OAIStatusParams(QString json);
    ~OAIStatusParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusParams)

#endif // OAIStatusParams_H
