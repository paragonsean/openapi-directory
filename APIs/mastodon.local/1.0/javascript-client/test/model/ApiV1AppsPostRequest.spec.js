...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.ApiV1AppsPostRequest();
  });
  ...
  describe('ApiV1AppsPostRequest', function() {
    it('should create an instance of ApiV1AppsPostRequest', function() {
      // uncomment below and update the code to test ApiV1AppsPostRequest
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.ApiV1AppsPostRequest();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.ApiV1AppsPostRequest);
    });
