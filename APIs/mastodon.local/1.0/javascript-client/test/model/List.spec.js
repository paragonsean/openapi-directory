...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.List();
  });
  ...
  describe('List', function() {
    it('should create an instance of List', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.List();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.List);
    });
