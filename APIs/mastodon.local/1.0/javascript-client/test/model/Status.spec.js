...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Status();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.Status);
    });
