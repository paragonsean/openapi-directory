...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.ScheduledStatus();
  });
  ...
  describe('ScheduledStatus', function() {
    it('should create an instance of ScheduledStatus', function() {
      // uncomment below and update the code to test ScheduledStatus
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.ScheduledStatus();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.ScheduledStatus);
    });
