...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Token();
  });
  ...
  describe('Token', function() {
    it('should create an instance of Token', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Token();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.Token);
    });
