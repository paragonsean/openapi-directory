...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.History();
  });
  ...
  describe('History', function() {
    it('should create an instance of History', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.History();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.History);
    });
