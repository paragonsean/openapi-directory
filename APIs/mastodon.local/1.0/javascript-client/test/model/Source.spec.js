...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Source();
  });
  ...
  describe('Source', function() {
    it('should create an instance of Source', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Source();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.Source);
    });
    ...
    it('should have the property followRequestsCount (base name: "follow_requests_count")', function() {
      // uncomment below and update the code to test the property followRequestsCount
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Source();
      //expect(instance).to.be();
    });
