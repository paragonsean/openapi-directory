...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Results();
  });
  ...
  describe('Results', function() {
    it('should create an instance of Results', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Results();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.Results);
    });
