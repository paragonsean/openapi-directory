...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new MastodonApiSpecificationHttpsGithubComMastodonMastodon.Context();
      //expect(instance).to.be.a(MastodonApiSpecificationHttpsGithubComMastodonMastodon.Context);
    });
