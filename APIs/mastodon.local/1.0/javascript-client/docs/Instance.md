# MastodonApiSpecificationHttpsGithubComMastodonMastodon.Instance
...
**languages** | **[String]** | Primary languages of the website and its staff. ISO 639 Part 1-5 language codes. | 
