# MastodonApiSpecificationHttpsGithubComMastodonMastodon.Account
...
**emojis** | [**[Emoji]**](Emoji.md) | Custom emoji entities to be used when rendering the profile. If none, an empty array will be returned. | [optional] 
**fields** | [**[Field]**](Field.md) | Additional metadata attached to a profile as name-value pairs. | [optional] 
**followersCount** | **Number** | The reported followers of this profile. | [optional] 
**followingCount** | **Number** | The reported follows of this profile. | [optional] 
...
**lastStatusAt** | **Date** | When the most recent status was posted. | [optional] 
**locked** | **Boolean** | Whether the account manually approves follow requests. | [optional] 
**moved** | [**Account**](Account.md) |  | [optional] 
**muteExpiresAt** | **Date** | When a timed mute will expire, if applicable. ISO 8601 Datetime. | [optional] 
**note** | **String** | The profile&#39;s bio / description. | [optional] 
**source** | [**Source**](Source.md) |  | [optional] 
**statusesCount** | **Number** | How many statuses are attached to this account. | [optional] 
