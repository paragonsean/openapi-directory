# MastodonApiSpecificationHttpsGithubComMastodonMastodon.ApiV1StatusesPost200Response
...
**mediaAttachments** | [**[Attachment]**](Attachment.md) | Array of attachements | 
...
**scheduledAt** | **Date** | ID of the status in the database. ISO 8601 Datetime. | 
