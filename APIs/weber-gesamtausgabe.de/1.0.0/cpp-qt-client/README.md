...
void Example::exampleFunction1(){
     OAIApplicationApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIApplicationApi::applicationNewIDGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIApplicationApi::applicationNewIDGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QList<QString> doc_type = create(); // QList<QString> | The WeGA document type
      apiInstance.applicationNewIDGet(doc_type);
