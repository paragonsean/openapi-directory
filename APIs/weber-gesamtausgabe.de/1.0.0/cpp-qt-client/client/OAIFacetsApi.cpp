...
void OAIFacetsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("facetsFacetGet", defaultConf);
    _serverIndices.insert("facetsFacetGet", 0);
}
...
void OAIFacetsApi::facetsFacetGet(const QString &facet, const QString &scope, const QList<QString> &doc_type, const ::OpenAPI::OptionalParam<QString> &term, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["facetsFacetGet"][_serverIndices.value("facetsFacetGet")].URL()+"/facets/{facet}");
    
    
    {
        QString facetPathParam("{");
        facetPathParam.append("facet").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "facet", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"facet"+pathSuffix : pathPrefix;
        fullPath.replace(facetPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(facet)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFacetsApi::facetsFacetGetCallback);
...
void OAIFacetsApi::facetsFacetGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT facetsFacetGetSignal(output);
        Q_EMIT facetsFacetGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT facetsFacetGetSignalE(output, error_type, error_str);
        Q_EMIT facetsFacetGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT facetsFacetGetSignalError(output, error_type, error_str);
        Q_EMIT facetsFacetGetSignalErrorFull(worker, error_type, error_str);
    }
}
