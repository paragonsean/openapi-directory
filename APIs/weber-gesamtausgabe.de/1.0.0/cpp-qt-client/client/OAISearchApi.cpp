...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("searchEntityGet", defaultConf);
    _serverIndices.insert("searchEntityGet", 0);
}
...
void OAISearchApi::searchEntityGet(const ::OpenAPI::OptionalParam<QList<QString>> &doc_type, const ::OpenAPI::OptionalParam<QString> &q, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["searchEntityGet"][_serverIndices.value("searchEntityGet")].URL()+"/search/entity");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchEntityGetCallback);
...
void OAISearchApi::searchEntityGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchEntityGetSignal(output);
        Q_EMIT searchEntityGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchEntityGetSignalE(output, error_type, error_str);
        Q_EMIT searchEntityGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchEntityGetSignalError(output, error_type, error_str);
        Q_EMIT searchEntityGetSignalErrorFull(worker, error_type, error_str);
    }
}
