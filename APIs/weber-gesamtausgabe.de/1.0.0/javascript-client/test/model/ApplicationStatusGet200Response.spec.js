...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeGaApi.ApplicationStatusGet200Response();
  });
  ...
  describe('ApplicationStatusGet200Response', function() {
    it('should create an instance of ApplicationStatusGet200Response', function() {
      // uncomment below and update the code to test ApplicationStatusGet200Response
      //var instance = new WeGaApi.ApplicationStatusGet200Response();
      //expect(instance).to.be.a(WeGaApi.ApplicationStatusGet200Response);
    });
