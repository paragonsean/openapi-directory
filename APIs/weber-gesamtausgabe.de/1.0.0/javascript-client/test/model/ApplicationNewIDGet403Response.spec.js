...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeGaApi.ApplicationNewIDGet403Response();
  });
  ...
  describe('ApplicationNewIDGet403Response', function() {
    it('should create an instance of ApplicationNewIDGet403Response', function() {
      // uncomment below and update the code to test ApplicationNewIDGet403Response
      //var instance = new WeGaApi.ApplicationNewIDGet403Response();
      //expect(instance).to.be.a(WeGaApi.ApplicationNewIDGet403Response);
    });
