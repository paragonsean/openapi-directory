...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeGaApi.CodeSample();
  });
  ...
  describe('CodeSample', function() {
    it('should create an instance of CodeSample', function() {
      // uncomment below and update the code to test CodeSample
      //var instance = new WeGaApi.CodeSample();
      //expect(instance).to.be.a(WeGaApi.CodeSample);
    });

    it('should have the property codeSample (base name: "codeSample")', function() {
      // uncomment below and update the code to test the property codeSample
      //var instance = new WeGaApi.CodeSample();
