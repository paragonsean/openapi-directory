...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeGaApi.CodeSamplesApi();
  });
  ...
  describe('CodeSamplesApi', function() {
    describe('codeFindByElementElementGet', function() {
      it('should call codeFindByElementElementGet successfully', function(done) {
        //uncomment below and update the code to test codeFindByElementElementGet
        //instance.codeFindByElementElementGet(function(error) {
