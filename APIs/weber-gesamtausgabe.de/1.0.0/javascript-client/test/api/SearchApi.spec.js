...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeGaApi.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    describe('searchEntityGet', function() {
      it('should call searchEntityGet successfully', function(done) {
        //uncomment below and update the code to test searchEntityGet
        //instance.searchEntityGet(function(error) {
