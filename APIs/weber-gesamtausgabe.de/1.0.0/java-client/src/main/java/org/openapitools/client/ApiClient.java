...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8080/exist/apps/WeGA-WebApp/api/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/exist/apps/WeGA-WebApp/api/v1
