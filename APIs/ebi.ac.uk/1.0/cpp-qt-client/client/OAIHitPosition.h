...
#ifndef OAIHitPosition_H
#define OAIHitPosition_H
...
class OAIHitPosition : public OAIObject {
public:
    OAIHitPosition();
    OAIHitPosition(QString json);
    ~OAIHitPosition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHitPosition)

#endif // OAIHitPosition_H
