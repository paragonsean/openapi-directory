...
#ifndef OAI_OAIMoleculesApi_H
#define OAI_OAIMoleculesApi_H
...
class OAIMoleculesApi : public QObject {
    Q_OBJECT

public:
    OAIMoleculesApi(const int timeOut = 0);
    ~OAIMoleculesApi();
    ...
    * @param[in]  molecule_chembl_id QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    */
    virtual void getMoleculesUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &canonical_smiles = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &inchi_key = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &molecule_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getMoleculesUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getMoleculesUsingGETSignal(OAIMolecules summary);


    void getMoleculesUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIMolecules summary);

    Q_DECL_DEPRECATED_X("Use getMoleculesUsingGETSignalError() instead")
    void getMoleculesUsingGETSignalE(OAIMolecules summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getMoleculesUsingGETSignalError(OAIMolecules summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getMoleculesUsingGETSignalErrorFull() instead")
    void getMoleculesUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getMoleculesUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
