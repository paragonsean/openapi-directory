...
qint32 OAIFragment::getFrom() const {
    return m_from;
}
void OAIFragment::setFrom(const qint32 &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIFragment::is_from_Set() const{
    return m_from_isSet;
}

bool OAIFragment::is_from_Valid() const{
    return m_from_isValid;
}

qint32 OAIFragment::getTo() const {
    return m_to;
}
void OAIFragment::setTo(const qint32 &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIFragment::is_to_Set() const{
    return m_to_isSet;
}

bool OAIFragment::is_to_Valid() const{
    return m_to_isValid;
}

QString OAIFragment::getType() const {
    return m_type;
}
void OAIFragment::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFragment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFragment::is_type_Valid() const{
