...
#ifndef OAI_OAIPubChemBiossaysApi_H
#define OAI_OAIPubChemBiossaysApi_H
...
class OAIPubChemBiossaysApi : public QObject {
    Q_OBJECT

public:
    OAIPubChemBiossaysApi(const int timeOut = 0);
    ~OAIPubChemBiossaysApi();
    ...
    * @param[in]  assay_pubchem_id QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  ncbi_protein_id QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    */
    virtual void getBioassaysUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &assay_pubchem_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &ncbi_protein_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getBioassaysUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getBioassaysUsingGETSignal(OAIBioassays summary);


    void getBioassaysUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIBioassays summary);

    Q_DECL_DEPRECATED_X("Use getBioassaysUsingGETSignalError() instead")
    void getBioassaysUsingGETSignalE(OAIBioassays summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getBioassaysUsingGETSignalError(OAIBioassays summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getBioassaysUsingGETSignalErrorFull() instead")
    void getBioassaysUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getBioassaysUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
