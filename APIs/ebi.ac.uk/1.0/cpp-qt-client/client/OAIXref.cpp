...
void OAIXref::fromJson(QString jsonString) {
...
void OAIXref::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIXref::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIXref::getId() const {
    return m_id;
}
void OAIXref::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIXref::is_id_Set() const{
    return m_id_isSet;
}

bool OAIXref::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIXref::getSource() const {
    return m_source;
}
void OAIXref::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIXref::is_source_Set() const{
    return m_source_isSet;
}

bool OAIXref::is_source_Valid() const{
    return m_source_isValid;
}

bool OAIXref::isSet() const {
