...
void OAIGo::fromJson(QString jsonString) {
...
void OAIGo::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIGo::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIGoEvidence> OAIGo::getEvidences() const {
    return m_evidences;
}
void OAIGo::setEvidences(const QList<OAIGoEvidence> &evidences) {
    m_evidences = evidences;
    m_evidences_isSet = true;
}

bool OAIGo::is_evidences_Set() const{
    return m_evidences_isSet;
}

bool OAIGo::is_evidences_Valid() const{
    return m_evidences_isValid;
}

QString OAIGo::getId() const {
    return m_id;
}
void OAIGo::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGo::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGo::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGo::getTerm() const {
    return m_term;
}
void OAIGo::setTerm(const QString &term) {
    m_term = term;
    m_term_isSet = true;
}

bool OAIGo::is_term_Set() const{
    return m_term_isSet;
}

bool OAIGo::is_term_Valid() const{
    return m_term_isValid;
}

bool OAIGo::isSet() const {
