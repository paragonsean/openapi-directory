...
OAICrossbarTarget::OAICrossbarTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrossbarTarget::OAICrossbarTarget() {
    this->initializeModel();
}

OAICrossbarTarget::~OAICrossbarTarget() {}

void OAICrossbarTarget::initializeModel() {
...
void OAICrossbarTarget::fromJson(QString jsonString) {
...
void OAICrossbarTarget::fromJsonObject(QJsonObject json) {
...
QString OAICrossbarTarget::asJson() const {
...
QJsonObject OAICrossbarTarget::asJsonObject() const {
    QJsonObject obj;
...
QString OAICrossbarTarget::getAccession() const {
    return m_accession;
}
void OAICrossbarTarget::setAccession(const QString &accession) {
    m_accession = accession;
    m_accession_isSet = true;
}

bool OAICrossbarTarget::is_accession_Set() const{
    return m_accession_isSet;
}

bool OAICrossbarTarget::is_accession_Valid() const{
    return m_accession_isValid;
}

QString OAICrossbarTarget::getTargetChemblId() const {
    return m_target_chembl_id;
}
void OAICrossbarTarget::setTargetChemblId(const QString &target_chembl_id) {
    m_target_chembl_id = target_chembl_id;
    m_target_chembl_id_isSet = true;
}

bool OAICrossbarTarget::is_target_chembl_id_Set() const{
    return m_target_chembl_id_isSet;
}

bool OAICrossbarTarget::is_target_chembl_id_Valid() const{
    return m_target_chembl_id_isValid;
}

bool OAICrossbarTarget::isSet() const {
...
bool OAICrossbarTarget::isValid() const {
