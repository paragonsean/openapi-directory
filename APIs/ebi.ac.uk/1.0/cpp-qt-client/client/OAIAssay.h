...
class OAIAssay : public OAIObject {
public:
    OAIAssay();
    OAIAssay(QString json);
    ~OAIAssay() override;
    ...
    QString getAssayId() const;
    void setAssayId(const QString &assay_id);
    bool is_assay_id_Set() const;
    bool is_assay_id_Valid() const;

    QString getAssayOrganism() const;
    void setAssayOrganism(const QString &assay_organism);
    bool is_assay_organism_Set() const;
    bool is_assay_organism_Valid() const;
...
private:
    ...
    QString m_assay_id;
    bool m_assay_id_isSet;
    bool m_assay_id_isValid;

    QString m_assay_organism;
    bool m_assay_organism_isSet;
    bool m_assay_organism_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssay)
