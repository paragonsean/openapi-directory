...
/*
 * OAIIntactInteractions.h
 *
 * 
 */

#ifndef OAIIntactInteractions_H
#define OAIIntactInteractions_H
...
class OAIIntactInteractions : public OAIObject {
public:
    OAIIntactInteractions();
    OAIIntactInteractions(QString json);
    ~OAIIntactInteractions() override;
    ...
    QList<OAIIntact> getInteractions() const;
    void setInteractions(const QList<OAIIntact> &interactions);
...
private:
    ...
    QList<OAIIntact> m_interactions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntactInteractions)

#endif // OAIIntactInteractions_H
