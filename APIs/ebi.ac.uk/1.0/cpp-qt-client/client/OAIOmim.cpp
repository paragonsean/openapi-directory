...
void OAIOmim::fromJson(QString jsonString) {
...
void OAIOmim::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIOmim::asJsonObject() const {
    QJsonObject obj;
    if (m__id_isSet) {
...
QString OAIOmim::getId() const {
    return m__id;
}
void OAIOmim::setId(const QString &_id) {
    m__id = _id;
    m__id_isSet = true;
}

bool OAIOmim::is__id_Set() const{
    return m__id_isSet;
}

bool OAIOmim::is__id_Valid() const{
    return m__id_isValid;
}

QString OAIOmim::getType() const {
    return m_type;
}
void OAIOmim::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIOmim::is_type_Set() const{
    return m_type_isSet;
}

bool OAIOmim::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIOmim::isSet() const {
