...
#ifndef OAISidRelatedData_H
#define OAISidRelatedData_H
...
class OAISidRelatedData : public OAIObject {
public:
    OAISidRelatedData();
    OAISidRelatedData(QString json);
    ~OAISidRelatedData() override;
    ...
    QList<OAIAssayData> getAssayData() const;
    void setAssayData(const QList<OAIAssayData> &assay_data);
    bool is_assay_data_Set() const;
    bool is_assay_data_Valid() const;

    qint32 getAssayPubchemId() const;
    void setAssayPubchemId(const qint32 &assay_pubchem_id);
    bool is_assay_pubchem_id_Set() const;
    bool is_assay_pubchem_id_Valid() const;
...
private:
    ...
    QList<OAIAssayData> m_assay_data;
    bool m_assay_data_isSet;
    bool m_assay_data_isValid;

    qint32 m_assay_pubchem_id;
    bool m_assay_pubchem_id_isSet;
    bool m_assay_pubchem_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISidRelatedData)

#endif // OAISidRelatedData_H
