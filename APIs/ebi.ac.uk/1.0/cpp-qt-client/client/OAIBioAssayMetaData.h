...
/*
 * OAIBioAssayMetaData.h
 *
 * 
 */

#ifndef OAIBioAssayMetaData_H
#define OAIBioAssayMetaData_H
...
namespace OpenAPI {
class OAIBioAssay;
class OAISidRelatedData;

class OAIBioAssayMetaData : public OAIObject {
public:
    OAIBioAssayMetaData();
    OAIBioAssayMetaData(QString json);
    ~OAIBioAssayMetaData() override;
    ...
    OAIBioAssay getBioAssay() const;
    void setBioAssay(const OAIBioAssay &bio_assay);
    bool is_bio_assay_Set() const;
    bool is_bio_assay_Valid() const;

    QList<OAISidRelatedData> getSidRelatedData() const;
    void setSidRelatedData(const QList<OAISidRelatedData> &sid_related_data);
    bool is_sid_related_data_Set() const;
    bool is_sid_related_data_Valid() const;
...
private:
    ...
    OAIBioAssay m_bio_assay;
    bool m_bio_assay_isSet;
    bool m_bio_assay_isValid;

    QList<OAISidRelatedData> m_sid_related_data;
    bool m_sid_related_data_isSet;
    bool m_sid_related_data_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBioAssayMetaData)

#endif // OAIBioAssayMetaData_H
