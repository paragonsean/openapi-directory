...
OAIProteins::OAIProteins(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProteins::OAIProteins() {
    this->initializeModel();
}

OAIProteins::~OAIProteins() {}

void OAIProteins::initializeModel() {

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;

    m_proteins_isSet = false;
    m_proteins_isValid = false;
}

void OAIProteins::fromJson(QString jsonString) {
...
void OAIProteins::fromJsonObject(QJsonObject json) {
    ...
    m_proteins_isValid = ::OpenAPI::fromJsonValue(m_proteins, json[QString("proteins")]);
    m_proteins_isSet = !json[QString("proteins")].isNull() && m_proteins_isValid;
}

QString OAIProteins::asJson() const {
...
QJsonObject OAIProteins::asJsonObject() const {
    QJsonObject obj;
    if (m_page_meta.isSet()) {
        obj.insert(QString("pageMeta"), ::OpenAPI::toJsonValue(m_page_meta));
    }
    if (m_proteins.size() > 0) {
        obj.insert(QString("proteins"), ::OpenAPI::toJsonValue(m_proteins));
    }
    return obj;
}

OAIPageMeta OAIProteins::getPageMeta() const {
    return m_page_meta;
}
void OAIProteins::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIProteins::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIProteins::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

QList<OAIProtein> OAIProteins::getProteins() const {
    return m_proteins;
}
void OAIProteins::setProteins(const QList<OAIProtein> &proteins) {
    m_proteins = proteins;
    m_proteins_isSet = true;
}

bool OAIProteins::is_proteins_Set() const{
    return m_proteins_isSet;
}

bool OAIProteins::is_proteins_Valid() const{
    return m_proteins_isValid;
}

bool OAIProteins::isSet() const {
...
bool OAIProteins::isValid() const {
