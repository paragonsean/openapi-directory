...
OAIHitPosition::OAIHitPosition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHitPosition::OAIHitPosition() {
    this->initializeModel();
}

OAIHitPosition::~OAIHitPosition() {}

void OAIHitPosition::initializeModel() {
...
void OAIHitPosition::fromJson(QString jsonString) {
...
void OAIHitPosition::fromJsonObject(QJsonObject json) {
...
QString OAIHitPosition::asJson() const {
...
QJsonObject OAIHitPosition::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
qint32 OAIHitPosition::getFrom() const {
    return m_from;
}
void OAIHitPosition::setFrom(const qint32 &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIHitPosition::is_from_Set() const{
    return m_from_isSet;
}

bool OAIHitPosition::is_from_Valid() const{
    return m_from_isValid;
}

qint32 OAIHitPosition::getTo() const {
    return m_to;
}
void OAIHitPosition::setTo(const qint32 &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIHitPosition::is_to_Set() const{
    return m_to_isSet;
}

bool OAIHitPosition::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIHitPosition::isSet() const {
...
bool OAIHitPosition::isValid() const {
