...
OAIEFOEntities::OAIEFOEntities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEFOEntities::OAIEFOEntities() {
    this->initializeModel();
}

OAIEFOEntities::~OAIEFOEntities() {}

void OAIEFOEntities::initializeModel() {

    m_diseases_isSet = false;
    m_diseases_isValid = false;

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;
}

void OAIEFOEntities::fromJson(QString jsonString) {
...
void OAIEFOEntities::fromJsonObject(QJsonObject json) {

    m_diseases_isValid = ::OpenAPI::fromJsonValue(m_diseases, json[QString("diseases")]);
    m_diseases_isSet = !json[QString("diseases")].isNull() && m_diseases_isValid;
...
QString OAIEFOEntities::asJson() const {
...
QJsonObject OAIEFOEntities::asJsonObject() const {
    QJsonObject obj;
    if (m_diseases.size() > 0) {
        obj.insert(QString("diseases"), ::OpenAPI::toJsonValue(m_diseases));
    }
...
QList<OAIEFO> OAIEFOEntities::getDiseases() const {
    return m_diseases;
}
void OAIEFOEntities::setDiseases(const QList<OAIEFO> &diseases) {
    m_diseases = diseases;
    m_diseases_isSet = true;
}

bool OAIEFOEntities::is_diseases_Set() const{
    return m_diseases_isSet;
}

bool OAIEFOEntities::is_diseases_Valid() const{
    return m_diseases_isValid;
}

OAIPageMeta OAIEFOEntities::getPageMeta() const {
    return m_page_meta;
}
void OAIEFOEntities::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIEFOEntities::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIEFOEntities::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIEFOEntities::isSet() const {
...
bool OAIEFOEntities::isValid() const {
