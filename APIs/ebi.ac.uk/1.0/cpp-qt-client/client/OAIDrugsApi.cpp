...
OAIDrugsApi::OAIDrugsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIDrugsApi::~OAIDrugsApi() {
}

void OAIDrugsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getDrugsUsingGET", defaultConf);
    _serverIndices.insert("getDrugsUsingGET", 0);
}
...
*/
int OAIDrugsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIDrugsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIDrugsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIDrugsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIDrugsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIDrugsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIDrugsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIDrugsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIDrugsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIDrugsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDrugsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDrugsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIDrugsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIDrugsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIDrugsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIDrugsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIDrugsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIDrugsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIDrugsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIDrugsApi::getDrugsUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession, const ::OpenAPI::OptionalParam<QList<QString>> &chembl_id, const ::OpenAPI::OptionalParam<QList<QString>> &identifier, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QList<QString>> &name, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QList<QString>> &pubchem_cid) {
    QString fullPath = QString(_serverConfigs["getDrugsUsingGET"][_serverIndices.value("getDrugsUsingGET")].URL()+"/drugs");
    ...
    if (chembl_id.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "chemblId", true);
        if (chembl_id.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : chembl_id.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("chemblId=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("chemblId").append(querySuffix);
                qint32 count = 0;
                for (QString t : chembl_id.value()) {
                    if (count > 0) {
                        fullPath.append((true)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    if (pubchem_cid.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "pubchemCid", true);
        if (pubchem_cid.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : pubchem_cid.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("pubchemCid=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("pubchemCid").append(querySuffix);
                qint32 count = 0;
                for (QString t : pubchem_cid.value()) {
                    if (count > 0) {
                        fullPath.append((true)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDrugsApi::getDrugsUsingGETCallback);
    connect(this, &OAIDrugsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIDrugsApi::getDrugsUsingGETCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDrugs output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDrugsUsingGETSignal(output);
        Q_EMIT getDrugsUsingGETSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDrugsUsingGETSignalE(output, error_type, error_str);
        Q_EMIT getDrugsUsingGETSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDrugsUsingGETSignalError(output, error_type, error_str);
        Q_EMIT getDrugsUsingGETSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDrugsApi::tokenAvailable(){
