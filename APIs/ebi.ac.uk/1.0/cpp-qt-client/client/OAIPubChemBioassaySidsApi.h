...
#ifndef OAI_OAIPubChemBioassaySidsApi_H
#define OAI_OAIPubChemBioassaySidsApi_H
...
class OAIPubChemBioassaySidsApi : public QObject {
    Q_OBJECT

public:
    OAIPubChemBioassaySidsApi(const int timeOut = 0);
    ~OAIPubChemBioassaySidsApi();
    ...
    * @param[in]  sids QList<QString> [optional]
    */
    virtual void getBioassaysUsingGET1(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &outcome = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &sids = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getBioassaysUsingGET1Callback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getBioassaysUsingGET1Signal(OAIBioassays summary);


    void getBioassaysUsingGET1SignalFull(OAIHttpRequestWorker *worker, OAIBioassays summary);

    Q_DECL_DEPRECATED_X("Use getBioassaysUsingGET1SignalError() instead")
    void getBioassaysUsingGET1SignalE(OAIBioassays summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getBioassaysUsingGET1SignalError(OAIBioassays summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getBioassaysUsingGET1SignalErrorFull() instead")
    void getBioassaysUsingGET1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getBioassaysUsingGET1SignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
