...
#ifndef OAICrossbarTarget_H
#define OAICrossbarTarget_H
...
class OAICrossbarTarget : public OAIObject {
public:
    OAICrossbarTarget();
    OAICrossbarTarget(QString json);
    ~OAICrossbarTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrossbarTarget)

#endif // OAICrossbarTarget_H
