...
#ifndef OAI_OAIPubChemSubstancesApi_H
#define OAI_OAIPubChemSubstancesApi_H
...
class OAIPubChemSubstancesApi : public QObject {
    Q_OBJECT

public:
    OAIPubChemSubstancesApi(const int timeOut = 0);
    ~OAIPubChemSubstancesApi();
    ...
    */
    virtual void getSubstancesUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &cid = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &sid = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getSubstancesUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getSubstancesUsingGETSignal(OAIPubchemSubstances summary);


    void getSubstancesUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIPubchemSubstances summary);

    Q_DECL_DEPRECATED_X("Use getSubstancesUsingGETSignalError() instead")
    void getSubstancesUsingGETSignalE(OAIPubchemSubstances summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubstancesUsingGETSignalError(OAIPubchemSubstances summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getSubstancesUsingGETSignalErrorFull() instead")
    void getSubstancesUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubstancesUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
