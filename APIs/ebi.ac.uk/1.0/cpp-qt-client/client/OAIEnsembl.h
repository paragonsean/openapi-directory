...
class OAIEnsembl : public OAIObject {
public:
    OAIEnsembl();
    OAIEnsembl(QString json);
    ~OAIEnsembl() override;
    ...
    QString getGeneId() const;
    void setGeneId(const QString &gene_id);
    bool is_gene_id_Set() const;
    bool is_gene_id_Valid() const;
    ...
    QString getIsoform() const;
    void setIsoform(const QString &isoform);
    bool is_isoform_Set() const;
    bool is_isoform_Valid() const;

    QString getProteinSequenceId() const;
    void setProteinSequenceId(const QString &protein_sequence_id);
    bool is_protein_sequence_id_Set() const;
    bool is_protein_sequence_id_Valid() const;
...
private:
    ...
    QString m_gene_id;
    bool m_gene_id_isSet;
    bool m_gene_id_isValid;
    ...
    QString m_isoform;
    bool m_isoform_isSet;
    bool m_isoform_isValid;

    QString m_protein_sequence_id;
    bool m_protein_sequence_id_isSet;
    bool m_protein_sequence_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEnsembl)
