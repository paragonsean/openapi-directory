...
#ifndef OAICrossbarDrug_H
#define OAICrossbarDrug_H
...
class OAICrossbarDrug : public OAIObject {
public:
    OAICrossbarDrug();
    OAICrossbarDrug(QString json);
    ~OAICrossbarDrug() override;
    ...
    QString getChemblId() const;
    void setChemblId(const QString &chembl_id);
    bool is_chembl_id_Set() const;
    bool is_chembl_id_Valid() const;
    ...
    QString getKeggCid() const;
    void setKeggCid(const QString &kegg_cid);
    bool is_kegg_cid_Set() const;
    bool is_kegg_cid_Valid() const;

    QString getMoleculeType() const;
    void setMoleculeType(const QString &molecule_type);
    bool is_molecule_type_Set() const;
    bool is_molecule_type_Valid() const;
    ...
    QList<OAIPathway> getPathway() const;
    void setPathway(const QList<OAIPathway> &pathway);
    bool is_pathway_Set() const;
    bool is_pathway_Valid() const;

    QList<QString> getPbStructures() const;
    void setPbStructures(const QList<QString> &pb_structures);
    bool is_pb_structures_Set() const;
    bool is_pb_structures_Valid() const;
    ...
    QString getPubchemCid() const;
    void setPubchemCid(const QString &pubchem_cid);
    bool is_pubchem_cid_Set() const;
    bool is_pubchem_cid_Valid() const;

    QString getPubchemSid() const;
    void setPubchemSid(const QString &pubchem_sid);
    bool is_pubchem_sid_Set() const;
    bool is_pubchem_sid_Valid() const;
    ...
    QString getUniprotAccession() const;
    void setUniprotAccession(const QString &uniprot_accession);
    bool is_uniprot_accession_Set() const;
    bool is_uniprot_accession_Valid() const;
...
private:
    ...
    QString m_chembl_id;
    bool m_chembl_id_isSet;
    bool m_chembl_id_isValid;
    ...
    QString m_kegg_cid;
    bool m_kegg_cid_isSet;
    bool m_kegg_cid_isValid;

    QString m_molecule_type;
    bool m_molecule_type_isSet;
    bool m_molecule_type_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QList<OAIPathway> m_pathway;
    bool m_pathway_isSet;
    bool m_pathway_isValid;

    QList<QString> m_pb_structures;
    bool m_pb_structures_isSet;
    bool m_pb_structures_isValid;

    double m_polar_surface_area;
    bool m_polar_surface_area_isSet;
    bool m_polar_surface_area_isValid;

    QString m_pubchem_cid;
    bool m_pubchem_cid_isSet;
    bool m_pubchem_cid_isValid;

    QString m_pubchem_sid;
    bool m_pubchem_sid_isSet;
    bool m_pubchem_sid_isValid;
    ...
    QString m_uniprot_accession;
    bool m_uniprot_accession_isSet;
    bool m_uniprot_accession_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrossbarDrug)

#endif // OAICrossbarDrug_H
