...
/*
 * OAIPubchemSubstances.h
 *
 * 
 */

#ifndef OAIPubchemSubstances_H
#define OAIPubchemSubstances_H
...
class OAIPubchemSubstances : public OAIObject {
public:
    OAIPubchemSubstances();
    OAIPubchemSubstances(QString json);
    ~OAIPubchemSubstances() override;
    ...
    QList<OAISubstance> getSubstances() const;
    void setSubstances(const QList<OAISubstance> &substances);
    bool is_substances_Set() const;
    bool is_substances_Valid() const;
...
private:
    ...
    QList<OAISubstance> m_substances;
    bool m_substances_isSet;
    bool m_substances_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPubchemSubstances)

#endif // OAIPubchemSubstances_H
