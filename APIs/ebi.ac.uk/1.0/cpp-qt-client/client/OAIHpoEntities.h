...
#ifndef OAIHpoEntities_H
#define OAIHpoEntities_H
...
class OAIHpoEntities : public OAIObject {
public:
    OAIHpoEntities();
    OAIHpoEntities(QString json);
    ~OAIHpoEntities() override;
    ...
    QList<OAIHPOEntity> getHpo() const;
    void setHpo(const QList<OAIHPOEntity> &hpo);
    bool is_hpo_Set() const;
    bool is_hpo_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHpoEntities)

#endif // OAIHpoEntities_H
