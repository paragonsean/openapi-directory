...
#ifndef OAIAssayOrganism_H
#define OAIAssayOrganism_H
...
class OAIAssayOrganism : public OAIObject {
public:
    OAIAssayOrganism();
    OAIAssayOrganism(QString json);
    ~OAIAssayOrganism() override;
    ...
    qint32 getDbObjectId() const;
    void setDbObjectId(const qint32 &db_object_id);
    bool is_db_object_id_Set() const;
    bool is_db_object_id_Valid() const;
...
private:
    ...
    qint32 m_db_object_id;
    bool m_db_object_id_isSet;
    bool m_db_object_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssayOrganism)

#endif // OAIAssayOrganism_H
