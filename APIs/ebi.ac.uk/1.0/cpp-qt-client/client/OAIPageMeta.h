...
#ifndef OAIPageMeta_H
#define OAIPageMeta_H
...
class OAIPageMeta : public OAIObject {
public:
    OAIPageMeta();
    OAIPageMeta(QString json);
    ~OAIPageMeta() override;
    ...
    qint64 getCurrentElements() const;
    void setCurrentElements(const qint64 &current_elements);
    bool is_current_elements_Set() const;
    bool is_current_elements_Valid() const;
...
private:
    ...
    qint64 m_current_elements;
    bool m_current_elements_isSet;
    bool m_current_elements_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageMeta)
