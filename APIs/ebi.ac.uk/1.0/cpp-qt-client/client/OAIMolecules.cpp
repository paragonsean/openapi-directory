...
OAIMolecules::OAIMolecules(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMolecules::OAIMolecules() {
    this->initializeModel();
}

OAIMolecules::~OAIMolecules() {}

void OAIMolecules::initializeModel() {

    m_molecules_isSet = false;
    m_molecules_isValid = false;

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;
}

void OAIMolecules::fromJson(QString jsonString) {
...
void OAIMolecules::fromJsonObject(QJsonObject json) {

    m_molecules_isValid = ::OpenAPI::fromJsonValue(m_molecules, json[QString("molecules")]);
    m_molecules_isSet = !json[QString("molecules")].isNull() && m_molecules_isValid;
...
QString OAIMolecules::asJson() const {
...
QJsonObject OAIMolecules::asJsonObject() const {
    QJsonObject obj;
    if (m_molecules.size() > 0) {
        obj.insert(QString("molecules"), ::OpenAPI::toJsonValue(m_molecules));
    }
...
QList<OAICrossbarMolecule> OAIMolecules::getMolecules() const {
    return m_molecules;
}
void OAIMolecules::setMolecules(const QList<OAICrossbarMolecule> &molecules) {
    m_molecules = molecules;
    m_molecules_isSet = true;
}

bool OAIMolecules::is_molecules_Set() const{
    return m_molecules_isSet;
}

bool OAIMolecules::is_molecules_Valid() const{
    return m_molecules_isValid;
}

OAIPageMeta OAIMolecules::getPageMeta() const {
    return m_page_meta;
}
void OAIMolecules::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIMolecules::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIMolecules::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIMolecules::isSet() const {
...
bool OAIMolecules::isValid() const {
