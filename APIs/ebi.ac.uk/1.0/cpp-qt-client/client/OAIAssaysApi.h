...
#ifndef OAI_OAIAssaysApi_H
#define OAI_OAIAssaysApi_H
...
class OAIAssaysApi : public QObject {
    Q_OBJECT

public:
    OAIAssaysApi(const int timeOut = 0);
    ~OAIAssaysApi();
    ...
    * @param[in]  assay_org QList<QString> [optional]
    * @param[in]  assay_type QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  target_chembl_id QList<QString> [optional]
    */
    virtual void getAssaysUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &assay_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &assay_org = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &assay_type = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &target_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getAssaysUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAssaysUsingGETSignal(OAIAssays summary);


    void getAssaysUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIAssays summary);

    Q_DECL_DEPRECATED_X("Use getAssaysUsingGETSignalError() instead")
    void getAssaysUsingGETSignalE(OAIAssays summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAssaysUsingGETSignalError(OAIAssays summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAssaysUsingGETSignalErrorFull() instead")
    void getAssaysUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAssaysUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
