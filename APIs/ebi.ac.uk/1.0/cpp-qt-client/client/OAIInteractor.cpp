...
OAIInteractor::OAIInteractor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInteractor::OAIInteractor() {
    this->initializeModel();
}

OAIInteractor::~OAIInteractor() {}

void OAIInteractor::initializeModel() {
...
void OAIInteractor::fromJson(QString jsonString) {
...
void OAIInteractor::fromJsonObject(QJsonObject json) {
...
QString OAIInteractor::asJson() const {
...
QJsonObject OAIInteractor::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInteractor::getAccession() const {
    return m_accession;
}
void OAIInteractor::setAccession(const QString &accession) {
    m_accession = accession;
    m_accession_isSet = true;
}

bool OAIInteractor::is_accession_Set() const{
    return m_accession_isSet;
}

bool OAIInteractor::is_accession_Valid() const{
    return m_accession_isValid;
}

QString OAIInteractor::getGene() const {
    return m_gene;
}
void OAIInteractor::setGene(const QString &gene) {
    m_gene = gene;
    m_gene_isSet = true;
}

bool OAIInteractor::is_gene_Set() const{
    return m_gene_isSet;
}

bool OAIInteractor::is_gene_Valid() const{
    return m_gene_isValid;
}

bool OAIInteractor::isSet() const {
...
bool OAIInteractor::isValid() const {
