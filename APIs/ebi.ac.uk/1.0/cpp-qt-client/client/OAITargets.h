...
namespace OpenAPI {
class OAIPageMeta;
class OAICrossbarTarget;

class OAITargets : public OAIObject {
public:
    OAITargets();
    OAITargets(QString json);
    ~OAITargets() override;
    ...
    QList<OAICrossbarTarget> getTargets() const;
    void setTargets(const QList<OAICrossbarTarget> &targets);
...
private:
    ...
    QList<OAICrossbarTarget> m_targets;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargets)
