...
#ifndef OAIProteins_H
#define OAIProteins_H
...
class OAIProteins : public OAIObject {
public:
    OAIProteins();
    OAIProteins(QString json);
    ~OAIProteins() override;
    ...
    QList<OAIProtein> getProteins() const;
    void setProteins(const QList<OAIProtein> &proteins);
    bool is_proteins_Set() const;
    bool is_proteins_Valid() const;
...
private:
    ...
    QList<OAIProtein> m_proteins;
    bool m_proteins_isSet;
    bool m_proteins_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProteins)
