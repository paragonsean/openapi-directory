...
#ifndef OAITargetInfo_H
#define OAITargetInfo_H
...
class OAITargetInfo : public OAIObject {
public:
    OAITargetInfo();
    OAITargetInfo(QString json);
    ~OAITargetInfo() override;
    ...
    qint32 getNcbiProteinId() const;
    void setNcbiProteinId(const qint32 &ncbi_protein_id);
    bool is_ncbi_protein_id_Set() const;
    bool is_ncbi_protein_id_Valid() const;
...
private:
    ...
    qint32 m_ncbi_protein_id;
    bool m_ncbi_protein_id_isSet;
    bool m_ncbi_protein_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetInfo)

#endif // OAITargetInfo_H
