...
OAIAssays::OAIAssays(QString json) {
...
void OAIAssays::initializeModel() {

    m_assays_isSet = false;
    m_assays_isValid = false;

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;
}

void OAIAssays::fromJson(QString jsonString) {
...
void OAIAssays::fromJsonObject(QJsonObject json) {

    m_assays_isValid = ::OpenAPI::fromJsonValue(m_assays, json[QString("assays")]);
    m_assays_isSet = !json[QString("assays")].isNull() && m_assays_isValid;
...
QString OAIAssays::asJson() const {
...
QJsonObject OAIAssays::asJsonObject() const {
    QJsonObject obj;
    if (m_assays.size() > 0) {
        obj.insert(QString("assays"), ::OpenAPI::toJsonValue(m_assays));
    }
...
QList<OAIAssay> OAIAssays::getAssays() const {
    return m_assays;
}
void OAIAssays::setAssays(const QList<OAIAssay> &assays) {
    m_assays = assays;
    m_assays_isSet = true;
}

bool OAIAssays::is_assays_Set() const{
    return m_assays_isSet;
}

bool OAIAssays::is_assays_Valid() const{
    return m_assays_isValid;
}

OAIPageMeta OAIAssays::getPageMeta() const {
    return m_page_meta;
}
void OAIAssays::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIAssays::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIAssays::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIAssays::isSet() const {
