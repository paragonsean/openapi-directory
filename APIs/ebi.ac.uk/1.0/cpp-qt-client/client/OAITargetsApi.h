...
#ifndef OAI_OAITargetsApi_H
#define OAI_OAITargetsApi_H
...
class OAITargetsApi : public QObject {
    Q_OBJECT

public:
    OAITargetsApi(const int timeOut = 0);
    ~OAITargetsApi();
    ...
    * @param[in]  target_ids QList<QString> [optional]
    */
    virtual void getTargetsUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &target_ids = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getTargetsUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getTargetsUsingGETSignal(OAITargets summary);


    void getTargetsUsingGETSignalFull(OAIHttpRequestWorker *worker, OAITargets summary);

    Q_DECL_DEPRECATED_X("Use getTargetsUsingGETSignalError() instead")
    void getTargetsUsingGETSignalE(OAITargets summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTargetsUsingGETSignalError(OAITargets summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getTargetsUsingGETSignalErrorFull() instead")
    void getTargetsUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getTargetsUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
