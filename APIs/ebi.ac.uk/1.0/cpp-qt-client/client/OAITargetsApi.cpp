...
OAITargetsApi::OAITargetsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITargetsApi::~OAITargetsApi() {
}

void OAITargetsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getTargetsUsingGET", defaultConf);
    _serverIndices.insert("getTargetsUsingGET", 0);
}
...
*/
int OAITargetsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITargetsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITargetsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITargetsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITargetsApi::setUsername(const QString &username) {
    _username = username;
}

void OAITargetsApi::setPassword(const QString &password) {
    _password = password;
}


void OAITargetsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITargetsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITargetsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITargetsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITargetsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITargetsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITargetsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITargetsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITargetsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITargetsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITargetsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITargetsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITargetsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITargetsApi::getTargetsUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QList<QString>> &target_ids) {
    QString fullPath = QString(_serverConfigs["getTargetsUsingGET"][_serverIndices.value("getTargetsUsingGET")].URL()+"/targets");
    ...
    if (target_ids.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "targetIds", true);
        if (target_ids.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : target_ids.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("targetIds=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("targetIds").append(querySuffix);
                qint32 count = 0;
                for (QString t : target_ids.value()) {
                    if (count > 0) {
                        fullPath.append((true)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITargetsApi::getTargetsUsingGETCallback);
    connect(this, &OAITargetsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITargetsApi::getTargetsUsingGETCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITargets output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTargetsUsingGETSignal(output);
        Q_EMIT getTargetsUsingGETSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTargetsUsingGETSignalE(output, error_type, error_str);
        Q_EMIT getTargetsUsingGETSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTargetsUsingGETSignalError(output, error_type, error_str);
        Q_EMIT getTargetsUsingGETSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITargetsApi::tokenAvailable(){
