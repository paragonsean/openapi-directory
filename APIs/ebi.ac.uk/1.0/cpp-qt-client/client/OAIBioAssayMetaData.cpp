...
OAIBioAssayMetaData::OAIBioAssayMetaData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBioAssayMetaData::OAIBioAssayMetaData() {
    this->initializeModel();
}

OAIBioAssayMetaData::~OAIBioAssayMetaData() {}

void OAIBioAssayMetaData::initializeModel() {

    m_bio_assay_isSet = false;
    m_bio_assay_isValid = false;

    m_sid_related_data_isSet = false;
    m_sid_related_data_isValid = false;
}

void OAIBioAssayMetaData::fromJson(QString jsonString) {
...
void OAIBioAssayMetaData::fromJsonObject(QJsonObject json) {

    m_bio_assay_isValid = ::OpenAPI::fromJsonValue(m_bio_assay, json[QString("bioAssay")]);
    m_bio_assay_isSet = !json[QString("bioAssay")].isNull() && m_bio_assay_isValid;

    m_sid_related_data_isValid = ::OpenAPI::fromJsonValue(m_sid_related_data, json[QString("sidRelatedData")]);
    m_sid_related_data_isSet = !json[QString("sidRelatedData")].isNull() && m_sid_related_data_isValid;
}

QString OAIBioAssayMetaData::asJson() const {
...
QJsonObject OAIBioAssayMetaData::asJsonObject() const {
    QJsonObject obj;
    if (m_bio_assay.isSet()) {
        obj.insert(QString("bioAssay"), ::OpenAPI::toJsonValue(m_bio_assay));
    }
    if (m_sid_related_data.size() > 0) {
        obj.insert(QString("sidRelatedData"), ::OpenAPI::toJsonValue(m_sid_related_data));
    }
    return obj;
}

OAIBioAssay OAIBioAssayMetaData::getBioAssay() const {
    return m_bio_assay;
}
void OAIBioAssayMetaData::setBioAssay(const OAIBioAssay &bio_assay) {
    m_bio_assay = bio_assay;
    m_bio_assay_isSet = true;
}

bool OAIBioAssayMetaData::is_bio_assay_Set() const{
    return m_bio_assay_isSet;
}

bool OAIBioAssayMetaData::is_bio_assay_Valid() const{
    return m_bio_assay_isValid;
}

QList<OAISidRelatedData> OAIBioAssayMetaData::getSidRelatedData() const {
    return m_sid_related_data;
}
void OAIBioAssayMetaData::setSidRelatedData(const QList<OAISidRelatedData> &sid_related_data) {
    m_sid_related_data = sid_related_data;
    m_sid_related_data_isSet = true;
}

bool OAIBioAssayMetaData::is_sid_related_data_Set() const{
    return m_sid_related_data_isSet;
}

bool OAIBioAssayMetaData::is_sid_related_data_Valid() const{
    return m_sid_related_data_isValid;
}

bool OAIBioAssayMetaData::isSet() const {
...
bool OAIBioAssayMetaData::isValid() const {
