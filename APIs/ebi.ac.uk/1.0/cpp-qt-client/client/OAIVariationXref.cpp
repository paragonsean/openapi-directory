...
OAIVariationXref::OAIVariationXref(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVariationXref::OAIVariationXref() {
    this->initializeModel();
}

OAIVariationXref::~OAIVariationXref() {}

void OAIVariationXref::initializeModel() {
...
void OAIVariationXref::fromJson(QString jsonString) {
...
void OAIVariationXref::fromJsonObject(QJsonObject json) {
...
QString OAIVariationXref::asJson() const {
...
QJsonObject OAIVariationXref::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIVariationXref::getId() const {
    return m_id;
}
void OAIVariationXref::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVariationXref::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVariationXref::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIVariationXref::getName() const {
    return m_name;
}
void OAIVariationXref::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIVariationXref::is_name_Set() const{
    return m_name_isSet;
}

bool OAIVariationXref::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIVariationXref::isSet() const {
...
bool OAIVariationXref::isValid() const {
