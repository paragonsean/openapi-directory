...
#ifndef OAIMolecules_H
#define OAIMolecules_H
...
namespace OpenAPI {
class OAICrossbarMolecule;
class OAIPageMeta;

class OAIMolecules : public OAIObject {
public:
    OAIMolecules();
    OAIMolecules(QString json);
    ~OAIMolecules() override;
    ...
    QList<OAICrossbarMolecule> getMolecules() const;
    void setMolecules(const QList<OAICrossbarMolecule> &molecules);
    bool is_molecules_Set() const;
    bool is_molecules_Valid() const;
...
private:
    ...
    QList<OAICrossbarMolecule> m_molecules;
    bool m_molecules_isSet;
    bool m_molecules_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMolecules)

#endif // OAIMolecules_H
