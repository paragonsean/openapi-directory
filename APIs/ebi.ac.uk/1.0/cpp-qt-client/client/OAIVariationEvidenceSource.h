...
/*
 * OAIVariationEvidenceSource.h
 *
 * 
 */

#ifndef OAIVariationEvidenceSource_H
#define OAIVariationEvidenceSource_H
...
class OAIVariationEvidenceSource : public OAIObject {
public:
    OAIVariationEvidenceSource();
    OAIVariationEvidenceSource(QString json);
    ~OAIVariationEvidenceSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariationEvidenceSource)

#endif // OAIVariationEvidenceSource_H
