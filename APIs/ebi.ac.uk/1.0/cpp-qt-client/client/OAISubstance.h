...
public:
    ...
    QString getChemblCmpdXref() const;
    void setChemblCmpdXref(const QString &chembl_cmpd_xref);
    bool is_chembl_cmpd_xref_Set() const;
    bool is_chembl_cmpd_xref_Valid() const;

    QList<qint32> getCids() const;
    void setCids(const QList<qint32> &cids);
...
private:
    ...
    QString m_chembl_cmpd_xref;
    bool m_chembl_cmpd_xref_isSet;
    bool m_chembl_cmpd_xref_isValid;
