...
/*
 * OAIVariationEvidence.h
 *
 * 
 */

#ifndef OAIVariationEvidence_H
#define OAIVariationEvidence_H
...
namespace OpenAPI {
class OAIVariationEvidenceSource;

class OAIVariationEvidence : public OAIObject {
public:
    OAIVariationEvidence();
    OAIVariationEvidence(QString json);
    ~OAIVariationEvidence() override;
    ...
    OAIVariationEvidenceSource getSource() const;
    void setSource(const OAIVariationEvidenceSource &source);
...
private:
    ...
    OAIVariationEvidenceSource m_source;
    bool m_source_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariationEvidence)

#endif // OAIVariationEvidence_H
