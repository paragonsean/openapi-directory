...
#ifndef OAIGoEvidence_H
#define OAIGoEvidence_H
...
class OAIGoEvidence : public OAIObject {
public:
    OAIGoEvidence();
    OAIGoEvidence(QString json);
    ~OAIGoEvidence() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoEvidence)

#endif // OAIGoEvidence_H
