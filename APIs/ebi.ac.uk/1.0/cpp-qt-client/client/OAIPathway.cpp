...
QString OAIPathway::getCategory() const {
    return m_category;
}
void OAIPathway::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIPathway::is_category_Set() const{
    return m_category_isSet;
}

bool OAIPathway::is_category_Valid() const{
