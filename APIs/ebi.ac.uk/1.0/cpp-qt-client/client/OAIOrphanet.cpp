...
OAIOrphanet::OAIOrphanet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrphanet::OAIOrphanet() {
    this->initializeModel();
}

OAIOrphanet::~OAIOrphanet() {}

void OAIOrphanet::initializeModel() {

    m_disease_isSet = false;
    m_disease_isValid = false;

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIOrphanet::fromJson(QString jsonString) {
...
void OAIOrphanet::fromJsonObject(QJsonObject json) {

    m_disease_isValid = ::OpenAPI::fromJsonValue(m_disease, json[QString("disease")]);
    m_disease_isSet = !json[QString("disease")].isNull() && m_disease_isValid;

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIOrphanet::asJson() const {
...
QJsonObject OAIOrphanet::asJsonObject() const {
    QJsonObject obj;
    if (m_disease_isSet) {
        obj.insert(QString("disease"), ::OpenAPI::toJsonValue(m_disease));
    }
    if (m_id_isSet) {
...
QString OAIOrphanet::getDisease() const {
    return m_disease;
}
void OAIOrphanet::setDisease(const QString &disease) {
    m_disease = disease;
    m_disease_isSet = true;
}

bool OAIOrphanet::is_disease_Set() const{
    return m_disease_isSet;
}

bool OAIOrphanet::is_disease_Valid() const{
    return m_disease_isValid;
}

QString OAIOrphanet::getId() const {
    return m_id;
}
void OAIOrphanet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrphanet::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrphanet::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOrphanet::isSet() const {
...
bool OAIOrphanet::isValid() const {
