...
OAIOpenTargets::OAIOpenTargets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOpenTargets::OAIOpenTargets() {
    this->initializeModel();
}

OAIOpenTargets::~OAIOpenTargets() {}

void OAIOpenTargets::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIOpenTargets::fromJson(QString jsonString) {
...
void OAIOpenTargets::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIOpenTargets::asJson() const {
...
QJsonObject OAIOpenTargets::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIOpenTargets::getId() const {
    return m_id;
}
void OAIOpenTargets::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOpenTargets::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOpenTargets::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOpenTargets::isSet() const {
...
bool OAIOpenTargets::isValid() const {
