...
/*
 * OAIFeaturePosition.h
 *
 * 
 */

#ifndef OAIFeaturePosition_H
#define OAIFeaturePosition_H
...
class OAIFeaturePosition : public OAIObject {
public:
    OAIFeaturePosition();
    OAIFeaturePosition(QString json);
    ~OAIFeaturePosition() override;
    ...
    qint32 getCeil() const;
    void setCeil(const qint32 &ceil);
    bool is_ceil_Set() const;
    bool is_ceil_Valid() const;
    ...
    void setUncertain(const bool &uncertain);
    bool is_uncertain_Set() const;
    bool is_uncertain_Valid() const;

    QString getUnparsed() const;
    void setUnparsed(const QString &unparsed);
    bool is_unparsed_Set() const;
    bool is_unparsed_Valid() const;
...
private:
    ...
    bool m_uncertain;
    bool m_uncertain_isSet;
    bool m_uncertain_isValid;

    QString m_unparsed;
    bool m_unparsed_isSet;
    bool m_unparsed_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFeaturePosition)

#endif // OAIFeaturePosition_H
