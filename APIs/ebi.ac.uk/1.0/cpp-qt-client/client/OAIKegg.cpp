...
void OAIKegg::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIKegg::fromJson(QString jsonString) {
...
void OAIKegg::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIKegg::asJson() const {
...
QJsonObject OAIKegg::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIKegg::getId() const {
    return m_id;
}
void OAIKegg::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKegg::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKegg::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKegg::isSet() const {
