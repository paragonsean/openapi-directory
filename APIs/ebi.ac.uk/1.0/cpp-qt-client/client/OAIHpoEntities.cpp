...
OAIHpoEntities::OAIHpoEntities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHpoEntities::OAIHpoEntities() {
    this->initializeModel();
}

OAIHpoEntities::~OAIHpoEntities() {}

void OAIHpoEntities::initializeModel() {
...
void OAIHpoEntities::fromJson(QString jsonString) {
...
void OAIHpoEntities::fromJsonObject(QJsonObject json) {

    m_hpo_isValid = ::OpenAPI::fromJsonValue(m_hpo, json[QString("hpo")]);
    m_hpo_isSet = !json[QString("hpo")].isNull() && m_hpo_isValid;
...
QString OAIHpoEntities::asJson() const {
...
QJsonObject OAIHpoEntities::asJsonObject() const {
    QJsonObject obj;
    if (m_hpo.size() > 0) {
        obj.insert(QString("hpo"), ::OpenAPI::toJsonValue(m_hpo));
    }
...
QList<OAIHPOEntity> OAIHpoEntities::getHpo() const {
    return m_hpo;
}
void OAIHpoEntities::setHpo(const QList<OAIHPOEntity> &hpo) {
    m_hpo = hpo;
    m_hpo_isSet = true;
}

bool OAIHpoEntities::is_hpo_Set() const{
    return m_hpo_isSet;
}

bool OAIHpoEntities::is_hpo_Valid() const{
    return m_hpo_isValid;
}

OAIPageMeta OAIHpoEntities::getPageMeta() const {
    return m_page_meta;
}
void OAIHpoEntities::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIHpoEntities::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIHpoEntities::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIHpoEntities::isSet() const {
...
bool OAIHpoEntities::isValid() const {
