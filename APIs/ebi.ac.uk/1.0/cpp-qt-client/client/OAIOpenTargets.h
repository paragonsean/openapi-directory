...
#ifndef OAIOpenTargets_H
#define OAIOpenTargets_H
...
class OAIOpenTargets : public OAIObject {
public:
    OAIOpenTargets();
    OAIOpenTargets(QString json);
    ~OAIOpenTargets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenTargets)

#endif // OAIOpenTargets_H
