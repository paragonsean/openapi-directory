...
#ifndef OAI_OAIIntactApi_H
#define OAI_OAIIntactApi_H
...
#include "OAIIntactInteractions.h"
#include <QString>
...
class OAIIntactApi : public QObject {
    Q_OBJECT

public:
    OAIIntactApi(const int timeOut = 0);
    ~OAIIntactApi();
    ...
    * @param[in]  confidence double [optional]
    * @param[in]  gene QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  page qint32 [optional]
    */
    virtual void getIntactUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<double> &confidence = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QList<QString>> &gene = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getIntactUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getIntactUsingGETSignal(OAIIntactInteractions summary);


    void getIntactUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIIntactInteractions summary);

    Q_DECL_DEPRECATED_X("Use getIntactUsingGETSignalError() instead")
    void getIntactUsingGETSignalE(OAIIntactInteractions summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getIntactUsingGETSignalError(OAIIntactInteractions summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getIntactUsingGETSignalErrorFull() instead")
    void getIntactUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getIntactUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
