...
OAIPubchemCompounds::OAIPubchemCompounds(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPubchemCompounds::OAIPubchemCompounds() {
    this->initializeModel();
}

OAIPubchemCompounds::~OAIPubchemCompounds() {}

void OAIPubchemCompounds::initializeModel() {

    m_compounds_isSet = false;
    m_compounds_isValid = false;

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;
}

void OAIPubchemCompounds::fromJson(QString jsonString) {
...
void OAIPubchemCompounds::fromJsonObject(QJsonObject json) {

    m_compounds_isValid = ::OpenAPI::fromJsonValue(m_compounds, json[QString("compounds")]);
    m_compounds_isSet = !json[QString("compounds")].isNull() && m_compounds_isValid;
...
QString OAIPubchemCompounds::asJson() const {
...
QJsonObject OAIPubchemCompounds::asJsonObject() const {
    QJsonObject obj;
    if (m_compounds.size() > 0) {
        obj.insert(QString("compounds"), ::OpenAPI::toJsonValue(m_compounds));
    }
...
QList<OAICrossbarPCCompound> OAIPubchemCompounds::getCompounds() const {
    return m_compounds;
}
void OAIPubchemCompounds::setCompounds(const QList<OAICrossbarPCCompound> &compounds) {
    m_compounds = compounds;
    m_compounds_isSet = true;
}

bool OAIPubchemCompounds::is_compounds_Set() const{
    return m_compounds_isSet;
}

bool OAIPubchemCompounds::is_compounds_Valid() const{
    return m_compounds_isValid;
}

OAIPageMeta OAIPubchemCompounds::getPageMeta() const {
    return m_page_meta;
}
void OAIPubchemCompounds::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIPubchemCompounds::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIPubchemCompounds::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIPubchemCompounds::isSet() const {
...
bool OAIPubchemCompounds::isValid() const {
