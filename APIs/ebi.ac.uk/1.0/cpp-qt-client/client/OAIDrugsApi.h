...
#ifndef OAI_OAIDrugsApi_H
#define OAI_OAIDrugsApi_H
...
class OAIDrugsApi : public QObject {
    Q_OBJECT

public:
    OAIDrugsApi(const int timeOut = 0);
    ~OAIDrugsApi();
    ...
    * @param[in]  chembl_id QList<QString> [optional]
    * @param[in]  identifier QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  name QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  pubchem_cid QList<QString> [optional]
    */
    virtual void getDrugsUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &chembl_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &identifier = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &name = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &pubchem_cid = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getDrugsUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getDrugsUsingGETSignal(OAIDrugs summary);


    void getDrugsUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIDrugs summary);

    Q_DECL_DEPRECATED_X("Use getDrugsUsingGETSignalError() instead")
    void getDrugsUsingGETSignalE(OAIDrugs summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDrugsUsingGETSignalError(OAIDrugs summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getDrugsUsingGETSignalErrorFull() instead")
    void getDrugsUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getDrugsUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
