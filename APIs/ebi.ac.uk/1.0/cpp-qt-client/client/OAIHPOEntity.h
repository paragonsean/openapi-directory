...
#ifndef OAIHPOEntity_H
#define OAIHPOEntity_H
...
class OAIHPOEntity : public OAIObject {
public:
    OAIHPOEntity();
    OAIHPOEntity(QString json);
    ~OAIHPOEntity() override;
    ...
    QList<QString> getDbReferences() const;
    void setDbReferences(const QList<QString> &db_references);
    bool is_db_references_Set() const;
    bool is_db_references_Valid() const;

    QList<OAIGene> getGene() const;
    void setGene(const QList<OAIGene> &gene);
    bool is_gene_Set() const;
    bool is_gene_Valid() const;

    QString getHpoId() const;
    void setHpoId(const QString &hpo_id);
    bool is_hpo_id_Set() const;
    bool is_hpo_id_Valid() const;
    ...
    void setTermName(const QString &term_name);
    bool is_term_name_Set() const;
    bool is_term_name_Valid() const;
...
private:
    ...
    QList<QString> m_db_references;
    bool m_db_references_isSet;
    bool m_db_references_isValid;

    QList<OAIGene> m_gene;
    bool m_gene_isSet;
    bool m_gene_isValid;

    QString m_hpo_id;
    bool m_hpo_id_isSet;
    bool m_hpo_id_isValid;
    ...
    QString m_term_name;
    bool m_term_name_isSet;
    bool m_term_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIHPOEntity)

#endif // OAIHPOEntity_H
