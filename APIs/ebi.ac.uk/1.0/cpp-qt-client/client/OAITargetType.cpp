...
void OAITargetType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAITargetType::asJsonObject() const {
    QJsonObject obj;
...
QString OAITargetType::getMoleculeType() const {
    return m_molecule_type;
}
void OAITargetType::setMoleculeType(const QString &molecule_type) {
    m_molecule_type = molecule_type;
    m_molecule_type_isSet = true;
}

bool OAITargetType::is_molecule_type_Set() const{
    return m_molecule_type_isSet;
}

bool OAITargetType::is_molecule_type_Valid() const{
    return m_molecule_type_isValid;
}

qint32 OAITargetType::getValue() const {
    return m_value;
}
void OAITargetType::setValue(const qint32 &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAITargetType::is_value_Set() const{
    return m_value_isSet;
}

bool OAITargetType::is_value_Valid() const{
