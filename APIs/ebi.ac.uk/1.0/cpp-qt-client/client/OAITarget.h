...
public:
    ...
    QList<QString> getAccessions() const;
    void setAccessions(const QList<QString> &accessions);
    bool is_accessions_Set() const;
    bool is_accessions_Valid() const;
    ...
    void setOrganism(const QString &organism);
    bool is_organism_Set() const;
    bool is_organism_Valid() const;
...
private:
    ...
    QList<QString> m_accessions;
    bool m_accessions_isSet;
    bool m_accessions_isValid;
    ...
    QString m_organism;
    bool m_organism_isSet;
    bool m_organism_isValid;
};
