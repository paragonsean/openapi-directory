...
public:
    ...
    QList<OAIGoEvidence> getEvidences() const;
    void setEvidences(const QList<OAIGoEvidence> &evidences);
...
private:
    ...
    QList<OAIGoEvidence> m_evidences;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGo)
