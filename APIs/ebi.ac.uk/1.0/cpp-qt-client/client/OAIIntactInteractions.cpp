...
OAIIntactInteractions::OAIIntactInteractions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntactInteractions::OAIIntactInteractions() {
    this->initializeModel();
}

OAIIntactInteractions::~OAIIntactInteractions() {}

void OAIIntactInteractions::initializeModel() {
...
void OAIIntactInteractions::fromJson(QString jsonString) {
...
void OAIIntactInteractions::fromJsonObject(QJsonObject json) {
...
QString OAIIntactInteractions::asJson() const {
...
QJsonObject OAIIntactInteractions::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIIntact> OAIIntactInteractions::getInteractions() const {
    return m_interactions;
}
void OAIIntactInteractions::setInteractions(const QList<OAIIntact> &interactions) {
    m_interactions = interactions;
    m_interactions_isSet = true;
}

bool OAIIntactInteractions::is_interactions_Set() const{
    return m_interactions_isSet;
}

bool OAIIntactInteractions::is_interactions_Valid() const{
    return m_interactions_isValid;
}

OAIPageMeta OAIIntactInteractions::getPageMeta() const {
    return m_page_meta;
}
void OAIIntactInteractions::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIIntactInteractions::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIIntactInteractions::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIIntactInteractions::isSet() const {
...
bool OAIIntactInteractions::isValid() const {
