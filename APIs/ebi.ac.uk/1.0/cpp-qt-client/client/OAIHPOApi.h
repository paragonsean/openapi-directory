...
#ifndef OAI_OAIHPOApi_H
#define OAI_OAIHPOApi_H
...
class OAIHPOApi : public QObject {
    Q_OBJECT

public:
    OAIHPOApi(const int timeOut = 0);
    ~OAIHPOApi();
    ...
    /**
    * @param[in]  genesymbol QList<QString> [optional]
    * @param[in]  hpotermname QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  synonym QList<QString> [optional]
    */
    virtual void getHpoUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &genesymbol = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &hpotermname = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &synonym = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getHpoUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getHpoUsingGETSignal(OAIHpoEntities summary);


    void getHpoUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIHpoEntities summary);

    Q_DECL_DEPRECATED_X("Use getHpoUsingGETSignalError() instead")
    void getHpoUsingGETSignalE(OAIHpoEntities summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getHpoUsingGETSignalError(OAIHpoEntities summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getHpoUsingGETSignalErrorFull() instead")
    void getHpoUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getHpoUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
