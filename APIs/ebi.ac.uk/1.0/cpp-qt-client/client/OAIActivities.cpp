...
QList<OAIActivity> OAIActivities::getActivities() const {
    return m_activities;
}
void OAIActivities::setActivities(const QList<OAIActivity> &activities) {
    m_activities = activities;
    m_activities_isSet = true;
}

bool OAIActivities::is_activities_Set() const{
    return m_activities_isSet;
}

bool OAIActivities::is_activities_Valid() const{
    return m_activities_isValid;
}

OAIPageMeta OAIActivities::getPageMeta() const {
    return m_page_meta;
}
void OAIActivities::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIActivities::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIActivities::is_page_meta_Valid() const{
