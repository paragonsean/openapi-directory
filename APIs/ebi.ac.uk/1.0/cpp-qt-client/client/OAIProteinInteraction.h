...
/*
 * OAIProteinInteraction.h
 *
 * 
 */

#ifndef OAIProteinInteraction_H
#define OAIProteinInteraction_H
...
class OAIProteinInteraction : public OAIObject {
public:
    OAIProteinInteraction();
    OAIProteinInteraction(QString json);
    ~OAIProteinInteraction() override;
    ...
    QList<QString> getInteractors() const;
    void setInteractors(const QList<QString> &interactors);
    bool is_interactors_Set() const;
    bool is_interactors_Valid() const;
...
private:
    ...
    QList<QString> m_interactors;
    bool m_interactors_isSet;
    bool m_interactors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProteinInteraction)

#endif // OAIProteinInteraction_H
