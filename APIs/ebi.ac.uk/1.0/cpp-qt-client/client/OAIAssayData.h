...
#ifndef OAIAssayData_H
#define OAIAssayData_H
...
class OAIAssayData : public OAIObject {
public:
    OAIAssayData();
    OAIAssayData(QString json);
    ~OAIAssayData() override;
    ...
    QString getStandardType() const;
    void setStandardType(const QString &standard_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssayData)

#endif // OAIAssayData_H
