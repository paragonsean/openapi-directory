...
/*
 * OAIPubchemCompounds.h
 *
 * 
 */

#ifndef OAIPubchemCompounds_H
#define OAIPubchemCompounds_H
...
namespace OpenAPI {
class OAICrossbarPCCompound;
class OAIPageMeta;

class OAIPubchemCompounds : public OAIObject {
public:
    OAIPubchemCompounds();
    OAIPubchemCompounds(QString json);
    ~OAIPubchemCompounds() override;
    ...
    QList<OAICrossbarPCCompound> getCompounds() const;
    void setCompounds(const QList<OAICrossbarPCCompound> &compounds);
    bool is_compounds_Set() const;
    bool is_compounds_Valid() const;
...
private:
    ...
    QList<OAICrossbarPCCompound> m_compounds;
    bool m_compounds_isSet;
    bool m_compounds_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPubchemCompounds)

#endif // OAIPubchemCompounds_H
