...
OAIReactome::OAIReactome(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReactome::OAIReactome() {
    this->initializeModel();
}

OAIReactome::~OAIReactome() {}

void OAIReactome::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;

    m_pathway_name_isSet = false;
    m_pathway_name_isValid = false;
}

void OAIReactome::fromJson(QString jsonString) {
...
void OAIReactome::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;

    m_pathway_name_isValid = ::OpenAPI::fromJsonValue(m_pathway_name, json[QString("pathwayName")]);
    m_pathway_name_isSet = !json[QString("pathwayName")].isNull() && m_pathway_name_isValid;
}

QString OAIReactome::asJson() const {
...
QJsonObject OAIReactome::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
        obj.insert(QString("id"), ::OpenAPI::toJsonValue(m_id));
    }
    if (m_pathway_name_isSet) {
        obj.insert(QString("pathwayName"), ::OpenAPI::toJsonValue(m_pathway_name));
    }
    return obj;
}

QString OAIReactome::getId() const {
    return m_id;
}
void OAIReactome::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIReactome::is_id_Set() const{
    return m_id_isSet;
}

bool OAIReactome::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIReactome::getPathwayName() const {
    return m_pathway_name;
}
void OAIReactome::setPathwayName(const QString &pathway_name) {
    m_pathway_name = pathway_name;
    m_pathway_name_isSet = true;
}

bool OAIReactome::is_pathway_name_Set() const{
    return m_pathway_name_isSet;
}

bool OAIReactome::is_pathway_name_Valid() const{
    return m_pathway_name_isValid;
}

bool OAIReactome::isSet() const {
...
bool OAIReactome::isValid() const {
