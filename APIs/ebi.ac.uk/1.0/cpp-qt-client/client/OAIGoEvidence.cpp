...
OAIGoEvidence::OAIGoEvidence(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoEvidence::OAIGoEvidence() {
    this->initializeModel();
}

OAIGoEvidence::~OAIGoEvidence() {}

void OAIGoEvidence::initializeModel() {
...
void OAIGoEvidence::fromJson(QString jsonString) {
...
void OAIGoEvidence::fromJsonObject(QJsonObject json) {
...
QString OAIGoEvidence::asJson() const {
...
QJsonObject OAIGoEvidence::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGoEvidence::getSourceId() const {
    return m_source_id;
}
void OAIGoEvidence::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIGoEvidence::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIGoEvidence::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIGoEvidence::getSourceName() const {
    return m_source_name;
}
void OAIGoEvidence::setSourceName(const QString &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAIGoEvidence::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAIGoEvidence::is_source_name_Valid() const{
    return m_source_name_isValid;
}

bool OAIGoEvidence::isSet() const {
...
bool OAIGoEvidence::isValid() const {
