...
/*
 * OAIVariationAssociation.h
 *
 * 
 */

#ifndef OAIVariationAssociation_H
#define OAIVariationAssociation_H
...
class OAIVariationAssociation : public OAIObject {
public:
    OAIVariationAssociation();
    OAIVariationAssociation(QString json);
    ~OAIVariationAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariationAssociation)

#endif // OAIVariationAssociation_H
