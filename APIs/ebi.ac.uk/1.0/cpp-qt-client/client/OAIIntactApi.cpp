...
OAIIntactApi::OAIIntactApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIIntactApi::~OAIIntactApi() {
}

void OAIIntactApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getIntactUsingGET", defaultConf);
    _serverIndices.insert("getIntactUsingGET", 0);
}
...
*/
int OAIIntactApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIIntactApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIIntactApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIIntactApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIIntactApi::setUsername(const QString &username) {
    _username = username;
}

void OAIIntactApi::setPassword(const QString &password) {
    _password = password;
}


void OAIIntactApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIIntactApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIIntactApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIIntactApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIntactApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIntactApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIIntactApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIIntactApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIIntactApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIIntactApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIIntactApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIIntactApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIIntactApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIIntactApi::getIntactUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession, const ::OpenAPI::OptionalParam<double> &confidence, const ::OpenAPI::OptionalParam<QList<QString>> &gene, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &page) {
    QString fullPath = QString(_serverConfigs["getIntactUsingGET"][_serverIndices.value("getIntactUsingGET")].URL()+"/intact");
    ...
    if (confidence.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "confidence", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntactApi::getIntactUsingGETCallback);
    connect(this, &OAIIntactApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIIntactApi::getIntactUsingGETCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIIntactInteractions output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getIntactUsingGETSignal(output);
        Q_EMIT getIntactUsingGETSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getIntactUsingGETSignalE(output, error_type, error_str);
        Q_EMIT getIntactUsingGETSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getIntactUsingGETSignalError(output, error_type, error_str);
        Q_EMIT getIntactUsingGETSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntactApi::tokenAvailable(){
