...
OAITargets::OAITargets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITargets::OAITargets() {
    this->initializeModel();
}

OAITargets::~OAITargets() {}

void OAITargets::initializeModel() {
...
void OAITargets::fromJson(QString jsonString) {
...
void OAITargets::fromJsonObject(QJsonObject json) {
...
QString OAITargets::asJson() const {
...
QJsonObject OAITargets::asJsonObject() const {
    QJsonObject obj;
...
OAIPageMeta OAITargets::getPageMeta() const {
    return m_page_meta;
}
void OAITargets::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAITargets::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAITargets::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

QList<OAICrossbarTarget> OAITargets::getTargets() const {
    return m_targets;
}
void OAITargets::setTargets(const QList<OAICrossbarTarget> &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAITargets::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAITargets::is_targets_Valid() const{
    return m_targets_isValid;
}

bool OAITargets::isSet() const {
