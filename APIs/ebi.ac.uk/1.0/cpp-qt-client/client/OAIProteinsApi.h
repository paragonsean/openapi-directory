...
#ifndef OAI_OAIProteinsApi_H
#define OAI_OAIProteinsApi_H
...
class OAIProteinsApi : public QObject {
    Q_OBJECT

public:
    OAIProteinsApi(const int timeOut = 0);
    ~OAIProteinsApi();
    ...
    /**
    * @param[in]  accession QList<QString> [optional]
    * @param[in]  ec QList<QString> [optional]
    * @param[in]  full_name QList<QString> [optional]
    * @param[in]  gene QList<QString> [optional]
    * @param[in]  go QList<QString> [optional]
    * @param[in]  interpro QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  omim QList<QString> [optional]
    * @param[in]  orphanet QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  pfam QList<QString> [optional]
    * @param[in]  reactome QList<QString> [optional]
    * @param[in]  tax_id QList<qint32> [optional]
    */
    virtual void getProteinsUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &accession = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &ec = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &full_name = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &gene = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &go = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &interpro = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &omim = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &orphanet = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &pfam = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &reactome = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<qint32>> &tax_id = ::OpenAPI::OptionalParam<QList<qint32>>());
...
private:
    ...
    void getProteinsUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getProteinsUsingGETSignal(OAIProteins summary);


    void getProteinsUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIProteins summary);

    Q_DECL_DEPRECATED_X("Use getProteinsUsingGETSignalError() instead")
    void getProteinsUsingGETSignalE(OAIProteins summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getProteinsUsingGETSignalError(OAIProteins summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getProteinsUsingGETSignalErrorFull() instead")
    void getProteinsUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getProteinsUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
