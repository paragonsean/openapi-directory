...
#ifndef OAIInteractor_H
#define OAIInteractor_H
...
class OAIInteractor : public OAIObject {
public:
    OAIInteractor();
    OAIInteractor(QString json);
    ~OAIInteractor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInteractor)

#endif // OAIInteractor_H
