...
#ifndef OAI_OAIEFODiseaseTermsApi_H
#define OAI_OAIEFODiseaseTermsApi_H
...
class OAIEFODiseaseTermsApi : public QObject {
    Q_OBJECT

public:
    OAIEFODiseaseTermsApi(const int timeOut = 0);
    ~OAIEFODiseaseTermsApi();
    ...
    /**
    * @param[in]  doid QList<QString> [optional]
    * @param[in]  label QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  mesh QList<QString> [optional]
    * @param[in]  obo_id QList<QString> [optional]
    * @param[in]  omim_id QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  synonym QList<QString> [optional]
    */
    virtual void getEFOUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &doid = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &label = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &mesh = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &obo_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &omim_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &synonym = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getEFOUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getEFOUsingGETSignal(OAIEFOEntities summary);


    void getEFOUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIEFOEntities summary);

    Q_DECL_DEPRECATED_X("Use getEFOUsingGETSignalError() instead")
    void getEFOUsingGETSignalE(OAIEFOEntities summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getEFOUsingGETSignalError(OAIEFOEntities summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getEFOUsingGETSignalErrorFull() instead")
    void getEFOUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getEFOUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
