...
public:
    ...
    /**
    * @param[in]  assay_chembl_id QList<QString> [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  molecule_chembl_id QList<QString> [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  pchembl_value double [optional]
    * @param[in]  target_chembl_id QList<QString> [optional]
    */
    virtual void getActivitiesUsingGET(const ::OpenAPI::OptionalParam<QList<QString>> &assay_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &molecule_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<double> &pchembl_value = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QList<QString>> &target_chembl_id = ::OpenAPI::OptionalParam<QList<QString>>());
...
private:
    ...
    void getActivitiesUsingGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getActivitiesUsingGETSignal(OAIActivities summary);


    void getActivitiesUsingGETSignalFull(OAIHttpRequestWorker *worker, OAIActivities summary);

    Q_DECL_DEPRECATED_X("Use getActivitiesUsingGETSignalError() instead")
    void getActivitiesUsingGETSignalE(OAIActivities summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getActivitiesUsingGETSignalError(OAIActivities summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getActivitiesUsingGETSignalErrorFull() instead")
    void getActivitiesUsingGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getActivitiesUsingGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
