...
#include "OAIPubChemBioassaySidsApi.h"
...
OAIPubChemBioassaySidsApi::OAIPubChemBioassaySidsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPubChemBioassaySidsApi::~OAIPubChemBioassaySidsApi() {
}

void OAIPubChemBioassaySidsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getBioassaysUsingGET1", defaultConf);
    _serverIndices.insert("getBioassaysUsingGET1", 0);
}
...
*/
int OAIPubChemBioassaySidsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPubChemBioassaySidsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPubChemBioassaySidsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPubChemBioassaySidsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPubChemBioassaySidsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPubChemBioassaySidsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPubChemBioassaySidsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPubChemBioassaySidsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPubChemBioassaySidsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPubChemBioassaySidsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPubChemBioassaySidsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPubChemBioassaySidsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPubChemBioassaySidsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPubChemBioassaySidsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPubChemBioassaySidsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPubChemBioassaySidsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPubChemBioassaySidsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPubChemBioassaySidsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPubChemBioassaySidsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPubChemBioassaySidsApi::getBioassaysUsingGET1(const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QString> &outcome, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QList<QString>> &sids) {
    QString fullPath = QString(_serverConfigs["getBioassaysUsingGET1"][_serverIndices.value("getBioassaysUsingGET1")].URL()+"/pubchem/bioassays/sids");
    ...
    if (sids.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "sids", true);
        if (sids.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : sids.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("sids=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("sids").append(querySuffix);
                qint32 count = 0;
                for (QString t : sids.value()) {
                    if (count > 0) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPubChemBioassaySidsApi::getBioassaysUsingGET1Callback);
    connect(this, &OAIPubChemBioassaySidsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPubChemBioassaySidsApi::getBioassaysUsingGET1Callback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getBioassaysUsingGET1Signal(output);
        Q_EMIT getBioassaysUsingGET1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getBioassaysUsingGET1SignalE(output, error_type, error_str);
        Q_EMIT getBioassaysUsingGET1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getBioassaysUsingGET1SignalError(output, error_type, error_str);
        Q_EMIT getBioassaysUsingGET1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPubChemBioassaySidsApi::tokenAvailable(){
