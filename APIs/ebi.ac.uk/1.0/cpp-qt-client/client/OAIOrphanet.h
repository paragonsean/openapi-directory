...
#ifndef OAIOrphanet_H
#define OAIOrphanet_H
...
class OAIOrphanet : public OAIObject {
public:
    OAIOrphanet();
    OAIOrphanet(QString json);
    ~OAIOrphanet() override;
    ...
    bool is_disease_Set() const;
    bool is_disease_Valid() const;
...
private:
    ...
    QString m_disease;
    bool m_disease_isSet;
    bool m_disease_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrphanet)
