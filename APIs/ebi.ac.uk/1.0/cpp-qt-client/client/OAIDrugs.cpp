...
OAIDrugs::OAIDrugs(QString json) {
...
void OAIDrugs::initializeModel() {

    m_drugs_isSet = false;
    m_drugs_isValid = false;

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;
}

void OAIDrugs::fromJson(QString jsonString) {
...
void OAIDrugs::fromJsonObject(QJsonObject json) {

    m_drugs_isValid = ::OpenAPI::fromJsonValue(m_drugs, json[QString("drugs")]);
    m_drugs_isSet = !json[QString("drugs")].isNull() && m_drugs_isValid;
...
QJsonObject OAIDrugs::asJsonObject() const {
    QJsonObject obj;
    if (m_drugs.size() > 0) {
        obj.insert(QString("drugs"), ::OpenAPI::toJsonValue(m_drugs));
    }
...
QList<OAICrossbarDrug> OAIDrugs::getDrugs() const {
    return m_drugs;
}
void OAIDrugs::setDrugs(const QList<OAICrossbarDrug> &drugs) {
    m_drugs = drugs;
    m_drugs_isSet = true;
}

bool OAIDrugs::is_drugs_Set() const{
    return m_drugs_isSet;
}

bool OAIDrugs::is_drugs_Valid() const{
    return m_drugs_isValid;
}

OAIPageMeta OAIDrugs::getPageMeta() const {
    return m_page_meta;
}
void OAIDrugs::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIDrugs::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIDrugs::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

bool OAIDrugs::isSet() const {
