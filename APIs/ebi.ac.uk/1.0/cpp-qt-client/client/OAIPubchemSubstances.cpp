...
#include "OAIPubchemSubstances.h"
...
OAIPubchemSubstances::OAIPubchemSubstances(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPubchemSubstances::OAIPubchemSubstances() {
    this->initializeModel();
}

OAIPubchemSubstances::~OAIPubchemSubstances() {}

void OAIPubchemSubstances::initializeModel() {

    m_page_meta_isSet = false;
    m_page_meta_isValid = false;

    m_substances_isSet = false;
    m_substances_isValid = false;
}

void OAIPubchemSubstances::fromJson(QString jsonString) {
...
void OAIPubchemSubstances::fromJsonObject(QJsonObject json) {
    ...
    m_substances_isValid = ::OpenAPI::fromJsonValue(m_substances, json[QString("substances")]);
    m_substances_isSet = !json[QString("substances")].isNull() && m_substances_isValid;
}

QString OAIPubchemSubstances::asJson() const {
...
QJsonObject OAIPubchemSubstances::asJsonObject() const {
    QJsonObject obj;
    if (m_page_meta.isSet()) {
        obj.insert(QString("pageMeta"), ::OpenAPI::toJsonValue(m_page_meta));
    }
    if (m_substances.size() > 0) {
        obj.insert(QString("substances"), ::OpenAPI::toJsonValue(m_substances));
    }
    return obj;
}

OAIPageMeta OAIPubchemSubstances::getPageMeta() const {
    return m_page_meta;
}
void OAIPubchemSubstances::setPageMeta(const OAIPageMeta &page_meta) {
    m_page_meta = page_meta;
    m_page_meta_isSet = true;
}

bool OAIPubchemSubstances::is_page_meta_Set() const{
    return m_page_meta_isSet;
}

bool OAIPubchemSubstances::is_page_meta_Valid() const{
    return m_page_meta_isValid;
}

QList<OAISubstance> OAIPubchemSubstances::getSubstances() const {
    return m_substances;
}
void OAIPubchemSubstances::setSubstances(const QList<OAISubstance> &substances) {
    m_substances = substances;
    m_substances_isSet = true;
}

bool OAIPubchemSubstances::is_substances_Set() const{
    return m_substances_isSet;
}

bool OAIPubchemSubstances::is_substances_Valid() const{
    return m_substances_isValid;
}

bool OAIPubchemSubstances::isSet() const {
...
bool OAIPubchemSubstances::isValid() const {
