...
#ifndef OAIBioassays_H
#define OAIBioassays_H

#include <QJsonObject>

#include "OAIBioAssayMetaData.h"
...
namespace OpenAPI {
class OAIBioAssayMetaData;
class OAIPageMeta;

class OAIBioassays : public OAIObject {
public:
    OAIBioassays();
    OAIBioassays(QString json);
    ~OAIBioassays() override;
    ...
    QList<OAIBioAssayMetaData> getBioassays() const;
    void setBioassays(const QList<OAIBioAssayMetaData> &bioassays);
    bool is_bioassays_Set() const;
    bool is_bioassays_Valid() const;
...
private:
    ...
    QList<OAIBioAssayMetaData> m_bioassays;
    bool m_bioassays_isSet;
    bool m_bioassays_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBioassays)

#endif // OAIBioassays_H
