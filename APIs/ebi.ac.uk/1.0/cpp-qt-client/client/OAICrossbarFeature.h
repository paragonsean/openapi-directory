...
/*
 * OAICrossbarFeature.h
 *
 * 
 */

#ifndef OAICrossbarFeature_H
#define OAICrossbarFeature_H
...
class OAICrossbarFeature : public OAIObject {
public:
    OAICrossbarFeature();
    OAICrossbarFeature(QString json);
    ~OAICrossbarFeature() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrossbarFeature)

#endif // OAICrossbarFeature_H
