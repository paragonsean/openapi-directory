...
class OAIIntact : public OAIObject {
public:
    OAIIntact();
    OAIIntact(QString json);
    ~OAIIntact() override;
    ...
    QList<QString> getInteractionAc() const;
    void setInteractionAc(const QList<QString> &interaction_ac);
    bool is_interaction_ac_Set() const;
    bool is_interaction_ac_Valid() const;

    OAIInteractor getInteractorA() const;
    void setInteractorA(const OAIInteractor &interactor_a);
    bool is_interactor_a_Set() const;
    bool is_interactor_a_Valid() const;

    OAIInteractor getInteractorB() const;
    void setInteractorB(const OAIInteractor &interactor_b);
    bool is_interactor_b_Set() const;
    bool is_interactor_b_Valid() const;
    ...
    QString getSourceDb() const;
    void setSourceDb(const QString &source_db);
    bool is_source_db_Set() const;
    bool is_source_db_Valid() const;
...
private:
    ...
    QList<QString> m_interaction_ac;
    bool m_interaction_ac_isSet;
    bool m_interaction_ac_isValid;

    OAIInteractor m_interactor_a;
    bool m_interactor_a_isSet;
    bool m_interactor_a_isValid;

    OAIInteractor m_interactor_b;
    bool m_interactor_b_isSet;
    bool m_interactor_b_isValid;
    ...
    QString m_source_db;
    bool m_source_db_isSet;
    bool m_source_db_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIIntact)
