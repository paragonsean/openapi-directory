...
namespace OpenAPI {
class OAICrossbarDrug;
class OAIPageMeta;

class OAIDrugs : public OAIObject {
public:
    OAIDrugs();
    OAIDrugs(QString json);
    ~OAIDrugs() override;
    ...
    QList<OAICrossbarDrug> getDrugs() const;
    void setDrugs(const QList<OAICrossbarDrug> &drugs);
    bool is_drugs_Set() const;
    bool is_drugs_Valid() const;
...
private:
    ...
    QList<OAICrossbarDrug> m_drugs;
    bool m_drugs_isSet;
    bool m_drugs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrugs)
