...
OAIVariationEvidence::OAIVariationEvidence(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVariationEvidence::OAIVariationEvidence() {
    this->initializeModel();
}

OAIVariationEvidence::~OAIVariationEvidence() {}

void OAIVariationEvidence::initializeModel() {

    m_source_isSet = false;
    m_source_isValid = false;
}

void OAIVariationEvidence::fromJson(QString jsonString) {
...
void OAIVariationEvidence::fromJsonObject(QJsonObject json) {

    m_source_isValid = ::OpenAPI::fromJsonValue(m_source, json[QString("source")]);
    m_source_isSet = !json[QString("source")].isNull() && m_source_isValid;
}

QString OAIVariationEvidence::asJson() const {
...
QJsonObject OAIVariationEvidence::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIVariationEvidenceSource OAIVariationEvidence::getSource() const {
    return m_source;
}
void OAIVariationEvidence::setSource(const OAIVariationEvidenceSource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIVariationEvidence::is_source_Set() const{
    return m_source_isSet;
}

bool OAIVariationEvidence::is_source_Valid() const{
    return m_source_isValid;
}

bool OAIVariationEvidence::isSet() const {
...
bool OAIVariationEvidence::isValid() const {
