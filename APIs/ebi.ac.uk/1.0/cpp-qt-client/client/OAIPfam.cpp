...
void OAIPfam::fromJson(QString jsonString) {
...
void OAIPfam::fromJsonObject(QJsonObject json) {

    m_entry_name_isValid = ::OpenAPI::fromJsonValue(m_entry_name, json[QString("entryName")]);
    m_entry_name_isSet = !json[QString("entryName")].isNull() && m_entry_name_isValid;

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIPfam::asJson() const {
...
QJsonObject OAIPfam::asJsonObject() const {
    QJsonObject obj;
    if (m_entry_name_isSet) {
        obj.insert(QString("entryName"), ::OpenAPI::toJsonValue(m_entry_name));
    }
    if (m_id_isSet) {
...
QString OAIPfam::getEntryName() const {
    return m_entry_name;
}
void OAIPfam::setEntryName(const QString &entry_name) {
    m_entry_name = entry_name;
    m_entry_name_isSet = true;
}

bool OAIPfam::is_entry_name_Set() const{
    return m_entry_name_isSet;
}

bool OAIPfam::is_entry_name_Valid() const{
    return m_entry_name_isValid;
}

QString OAIPfam::getId() const {
    return m_id;
}
void OAIPfam::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPfam::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPfam::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPfam::isSet() const {
