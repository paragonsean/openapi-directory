...
#ifndef OAIBioAssay_H
#define OAIBioAssay_H
...
namespace OpenAPI {
class OAIAssayOrganism;
class OAITargetInfo;
class OAITargetType;

class OAIBioAssay : public OAIObject {
public:
    OAIBioAssay();
    OAIBioAssay(QString json);
    ~OAIBioAssay() override;
    ...
    QList<OAIAssayOrganism> getAssayOrganisms() const;
    void setAssayOrganisms(const QList<OAIAssayOrganism> &assay_organisms);
    bool is_assay_organisms_Set() const;
    bool is_assay_organisms_Valid() const;
    ...
    QString getAssayType() const;
    void setAssayType(const QString &assay_type);
    bool is_assay_type_Set() const;
    bool is_assay_type_Valid() const;

    QString getChemblXref() const;
    void setChemblXref(const QString &chembl_xref);
    bool is_chembl_xref_Set() const;
    bool is_chembl_xref_Valid() const;

    QString getProteinName() const;
    void setProteinName(const QString &protein_name);
    bool is_protein_name_Set() const;
    bool is_protein_name_Valid() const;
    ...
    QList<OAITargetInfo> getTargetInfo() const;
    void setTargetInfo(const QList<OAITargetInfo> &target_info);
    bool is_target_info_Set() const;
    bool is_target_info_Valid() const;

    QList<OAITargetType> getTargetTypeInfo() const;
    void setTargetTypeInfo(const QList<OAITargetType> &target_type_info);
    bool is_target_type_info_Set() const;
    bool is_target_type_info_Valid() const;
...
private:
    ...
    QList<OAIAssayOrganism> m_assay_organisms;
    bool m_assay_organisms_isSet;
    bool m_assay_organisms_isValid;

    qint32 m_assay_pubchem_id;
    bool m_assay_pubchem_id_isSet;
    bool m_assay_pubchem_id_isValid;

    QString m_assay_type;
    bool m_assay_type_isSet;
    bool m_assay_type_isValid;

    QString m_chembl_xref;
    bool m_chembl_xref_isSet;
    bool m_chembl_xref_isValid;

    QString m_protein_name;
    bool m_protein_name_isSet;
    bool m_protein_name_isValid;

    QString m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    QList<OAITargetInfo> m_target_info;
    bool m_target_info_isSet;
    bool m_target_info_isValid;

    QList<OAITargetType> m_target_type_info;
    bool m_target_type_info_isSet;
    bool m_target_type_info_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBioAssay)
