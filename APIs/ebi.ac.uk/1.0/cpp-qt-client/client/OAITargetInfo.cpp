...
OAITargetInfo::OAITargetInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITargetInfo::OAITargetInfo() {
    this->initializeModel();
}

OAITargetInfo::~OAITargetInfo() {}

void OAITargetInfo::initializeModel() {

    m_ncbi_protein_id_isSet = false;
    m_ncbi_protein_id_isValid = false;
...
void OAITargetInfo::fromJson(QString jsonString) {
...
void OAITargetInfo::fromJsonObject(QJsonObject json) {

    m_ncbi_protein_id_isValid = ::OpenAPI::fromJsonValue(m_ncbi_protein_id, json[QString("ncbi_protein_id")]);
    m_ncbi_protein_id_isSet = !json[QString("ncbi_protein_id")].isNull() && m_ncbi_protein_id_isValid;
...
QString OAITargetInfo::asJson() const {
...
QJsonObject OAITargetInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_ncbi_protein_id_isSet) {
        obj.insert(QString("ncbi_protein_id"), ::OpenAPI::toJsonValue(m_ncbi_protein_id));
    }
...
qint32 OAITargetInfo::getNcbiProteinId() const {
    return m_ncbi_protein_id;
}
void OAITargetInfo::setNcbiProteinId(const qint32 &ncbi_protein_id) {
    m_ncbi_protein_id = ncbi_protein_id;
    m_ncbi_protein_id_isSet = true;
}

bool OAITargetInfo::is_ncbi_protein_id_Set() const{
    return m_ncbi_protein_id_isSet;
}

bool OAITargetInfo::is_ncbi_protein_id_Valid() const{
    return m_ncbi_protein_id_isValid;
}

QString OAITargetInfo::getTargetChemblId() const {
    return m_target_chembl_id;
}
void OAITargetInfo::setTargetChemblId(const QString &target_chembl_id) {
    m_target_chembl_id = target_chembl_id;
    m_target_chembl_id_isSet = true;
}

bool OAITargetInfo::is_target_chembl_id_Set() const{
    return m_target_chembl_id_isSet;
}

bool OAITargetInfo::is_target_chembl_id_Valid() const{
    return m_target_chembl_id_isValid;
}

QString OAITargetInfo::getUniprotAccession() const {
    return m_uniprot_accession;
}
void OAITargetInfo::setUniprotAccession(const QString &uniprot_accession) {
    m_uniprot_accession = uniprot_accession;
    m_uniprot_accession_isSet = true;
}

bool OAITargetInfo::is_uniprot_accession_Set() const{
    return m_uniprot_accession_isSet;
}

bool OAITargetInfo::is_uniprot_accession_Valid() const{
    return m_uniprot_accession_isValid;
}

bool OAITargetInfo::isSet() const {
...
bool OAITargetInfo::isValid() const {
