...
class OAIAssays : public OAIObject {
public:
    OAIAssays();
    OAIAssays(QString json);
    ~OAIAssays() override;
    ...
    QList<OAIAssay> getAssays() const;
    void setAssays(const QList<OAIAssay> &assays);
    bool is_assays_Set() const;
    bool is_assays_Valid() const;
...
private:
    ...
    QList<OAIAssay> m_assays;
    bool m_assays_isSet;
    bool m_assays_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssays)
