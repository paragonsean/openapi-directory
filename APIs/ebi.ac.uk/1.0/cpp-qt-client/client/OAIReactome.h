...
#ifndef OAIReactome_H
#define OAIReactome_H
...
class OAIReactome : public OAIObject {
public:
    OAIReactome();
    OAIReactome(QString json);
    ~OAIReactome() override;
    ...
    QString getPathwayName() const;
    void setPathwayName(const QString &pathway_name);
    bool is_pathway_name_Set() const;
    bool is_pathway_name_Valid() const;
...
private:
    ...
    QString m_pathway_name;
    bool m_pathway_name_isSet;
    bool m_pathway_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIReactome)
