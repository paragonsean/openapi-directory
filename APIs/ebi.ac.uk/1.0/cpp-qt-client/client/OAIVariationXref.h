...
#ifndef OAIVariationXref_H
#define OAIVariationXref_H
...
class OAIVariationXref : public OAIObject {
public:
    OAIVariationXref();
    OAIVariationXref(QString json);
    ~OAIVariationXref() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariationXref)

#endif // OAIVariationXref_H
