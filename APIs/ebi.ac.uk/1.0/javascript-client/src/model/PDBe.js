...
/**
 * The PDBe model module.
 * @module model/PDBe
 * @version 1.0
 */
class PDBe {
    /**
     * Constructs a new <code>PDBe</code>.
     * @alias module:model/PDBe
     */
    constructor() { 
        
        PDBe.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PDBe</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PDBe} obj Optional instance to populate.
     * @return {module:model/PDBe} The populated <code>PDBe</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PDBe</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PDBe</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['chains'] && !(typeof data['chains'] === 'string' || data['chains'] instanceof String)) {
            throw new Error("Expected the field `chains` to be a primitive type in the JSON string but got " + data['chains']);
        }
        // ensure the json data is a string
 ...
 */
PDBe.prototype['chains'] = undefined;

/**
 * @member {String} id
 */
PDBe.prototype['id'] = undefined;

/**
 * @member {String} method
 */
PDBe.prototype['method'] = undefined;

/**
 * @member {String} resolution
 */
PDBe.prototype['resolution'] = undefined;
