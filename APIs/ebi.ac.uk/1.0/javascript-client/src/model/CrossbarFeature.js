...
/**
 * The CrossbarFeature model module.
 * @module model/CrossbarFeature
 * @version 1.0
 */
class CrossbarFeature {
    /**
     * Constructs a new <code>CrossbarFeature</code>.
     * @alias module:model/CrossbarFeature
     */
    constructor() { 
        
        CrossbarFeature.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CrossbarFeature</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrossbarFeature} obj Optional instance to populate.
     * @return {module:model/CrossbarFeature} The populated <code>CrossbarFeature</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrossbarFeature();
    ...
    /**
     * Validates the JSON data with respect to <code>CrossbarFeature</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrossbarFeature</code>.
     */
 ...
 */
CrossbarFeature.prototype['begin'] = undefined;

/**
 * @member {String} category
 */
CrossbarFeature.prototype['category'] = undefined;

/**
 * @member {String} description
 */
CrossbarFeature.prototype['description'] = undefined;

/**
 * @member {module:model/FeaturePosition} end
 */
CrossbarFeature.prototype['end'] = undefined;

/**
 * @member {String} ftId
 */
CrossbarFeature.prototype['ftId'] = undefined;

/**
 * @member {String} type
 */
CrossbarFeature.prototype['type'] = undefined;
...
export default CrossbarFeature;
