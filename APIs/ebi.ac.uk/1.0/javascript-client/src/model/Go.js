...
import GoEvidence from './GoEvidence';
...
class Go {
    /**
     * Constructs a new <code>Go</code>.
     * @alias module:model/Go
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Go</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Go} obj Optional instance to populate.
     * @return {module:model/Go} The populated <code>Go</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('evidences')) {
                obj['evidences'] = ApiClient.convertToType(data['evidences'], [GoEvidence]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Go</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Go</code>.
     */
...
/**
 * @member {Array.<module:model/GoEvidence>} evidences
 */
Go.prototype['evidences'] = undefined;

/**
 * @member {String} id
 */
Go.prototype['id'] = undefined;

/**
 * @member {String} term
 */
Go.prototype['term'] = undefined;
