...
/**
 * The Interactor model module.
 * @module model/Interactor
 * @version 1.0
 */
class Interactor {
    /**
     * Constructs a new <code>Interactor</code>.
     * @alias module:model/Interactor
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Interactor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Interactor} obj Optional instance to populate.
     * @return {module:model/Interactor} The populated <code>Interactor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Interactor();
    ...
    /**
     * Validates the JSON data with respect to <code>Interactor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Interactor</code>.
     */
 ...
 */
Interactor.prototype['accession'] = undefined;

/**
 * @member {String} gene
 */
Interactor.prototype['gene'] = undefined;
