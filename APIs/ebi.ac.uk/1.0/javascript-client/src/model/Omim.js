...
/**
 * The Omim model module.
 * @module model/Omim
 * @version 1.0
 */
class Omim {
    /**
     * Constructs a new <code>Omim</code>.
     * @alias module:model/Omim
     */
    constructor() { 
        
        Omim.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Omim</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Omim} obj Optional instance to populate.
     * @return {module:model/Omim} The populated <code>Omim</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Omim</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Omim</code>.
     */
 ...
 * @member {String} _id
 */
Omim.prototype['_id'] = undefined;

/**
 * @member {String} type
 */
Omim.prototype['type'] = undefined;
