...
/**
 * The GoEvidence model module.
 * @module model/GoEvidence
 * @version 1.0
 */
class GoEvidence {
    /**
     * Constructs a new <code>GoEvidence</code>.
     * @alias module:model/GoEvidence
     */
    constructor() { 
        
        GoEvidence.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoEvidence</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoEvidence} obj Optional instance to populate.
     * @return {module:model/GoEvidence} The populated <code>GoEvidence</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoEvidence();
    ...
    /**
     * Validates the JSON data with respect to <code>GoEvidence</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoEvidence</code>.
     */
 ...
 */
GoEvidence.prototype['source_id'] = undefined;

/**
 * @member {String} source_name
 */
GoEvidence.prototype['source_name'] = undefined;
