...
import CrossbarMolecule from './CrossbarMolecule';
import PageMeta from './PageMeta';

/**
 * The Molecules model module.
 * @module model/Molecules
 * @version 1.0
 */
class Molecules {
    /**
     * Constructs a new <code>Molecules</code>.
     * @alias module:model/Molecules
     */
    constructor() { 
        
        Molecules.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Molecules</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Molecules} obj Optional instance to populate.
     * @return {module:model/Molecules} The populated <code>Molecules</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Molecules();

            if (data.hasOwnProperty('molecules')) {
                obj['molecules'] = ApiClient.convertToType(data['molecules'], [CrossbarMolecule]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Molecules</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Molecules</code>.
     */
    static validateJSON(data) {
        if (data['molecules']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['molecules'])) {
                throw new Error("Expected the field `molecules` to be an array in the JSON data but got " + data['molecules']);
            }
            // validate the optional field `molecules` (array)
            for (const item of data['molecules']) {
                CrossbarMolecule.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/CrossbarMolecule>} molecules
 */
Molecules.prototype['molecules'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
Molecules.prototype['pageMeta'] = undefined;
