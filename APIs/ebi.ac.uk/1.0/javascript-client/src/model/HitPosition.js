...
/**
 * The HitPosition model module.
 * @module model/HitPosition
 * @version 1.0
 */
class HitPosition {
    /**
     * Constructs a new <code>HitPosition</code>.
     * @alias module:model/HitPosition
     */
    constructor() { 
        
        HitPosition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HitPosition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HitPosition} obj Optional instance to populate.
     * @return {module:model/HitPosition} The populated <code>HitPosition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HitPosition();
    ...
    /**
     * Validates the JSON data with respect to <code>HitPosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HitPosition</code>.
     */
 ...
 * @member {Number} from
 */
HitPosition.prototype['from'] = undefined;

/**
 * @member {Number} to
 */
HitPosition.prototype['to'] = undefined;
