...
/**
 * The AssayOrganism model module.
 * @module model/AssayOrganism
 * @version 1.0
 */
class AssayOrganism {
    /**
     * Constructs a new <code>AssayOrganism</code>.
     * @alias module:model/AssayOrganism
     */
    constructor() { 
        
        AssayOrganism.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssayOrganism</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssayOrganism} obj Optional instance to populate.
     * @return {module:model/AssayOrganism} The populated <code>AssayOrganism</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssayOrganism();

            if (data.hasOwnProperty('db_object_id')) {
                obj['db_object_id'] = ApiClient.convertToType(data['db_object_id'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AssayOrganism</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssayOrganism</code>.
     */
...
/**
 * @member {Number} db_object_id
 */
AssayOrganism.prototype['db_object_id'] = undefined;

/**
 * @member {String} tax_name
 */
AssayOrganism.prototype['tax_name'] = undefined;
