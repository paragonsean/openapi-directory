...
/**
 * The Proteins model module.
 * @module model/Proteins
 * @version 1.0
 */
class Proteins {
    /**
     * Constructs a new <code>Proteins</code>.
     * @alias module:model/Proteins
     */
    constructor() { 
        
        Proteins.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Proteins</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Proteins} obj Optional instance to populate.
     * @return {module:model/Proteins} The populated <code>Proteins</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Proteins();

            if (data.hasOwnProperty('pageMeta')) {
                obj['pageMeta'] = PageMeta.constructFromObject(data['pageMeta']);
            }
            if (data.hasOwnProperty('proteins')) {
                obj['proteins'] = ApiClient.convertToType(data['proteins'], [Protein]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Proteins</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Proteins</code>.
     */
    static validateJSON(data) {
        ...
        if (data['proteins']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['proteins'])) {
                throw new Error("Expected the field `proteins` to be an array in the JSON data but got " + data['proteins']);
            }
            // validate the optional field `proteins` (array)
            for (const item of data['proteins']) {
                Protein.validateJSON(item);
            };
        }
 ...
 */
Proteins.prototype['pageMeta'] = undefined;

/**
 * @member {Array.<module:model/Protein>} proteins
 */
Proteins.prototype['proteins'] = undefined;
