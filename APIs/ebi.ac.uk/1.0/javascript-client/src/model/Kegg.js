...
/**
 * The Kegg model module.
 * @module model/Kegg
 * @version 1.0
 */
class Kegg {
    /**
     * Constructs a new <code>Kegg</code>.
     * @alias module:model/Kegg
     */
    constructor() { 
        
        Kegg.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Kegg</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Kegg} obj Optional instance to populate.
     * @return {module:model/Kegg} The populated <code>Kegg</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Kegg</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Kegg</code>.
     */
