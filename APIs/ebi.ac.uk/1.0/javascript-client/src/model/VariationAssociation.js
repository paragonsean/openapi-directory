...
/**
 * The VariationAssociation model module.
 * @module model/VariationAssociation
 * @version 1.0
 */
class VariationAssociation {
    /**
     * Constructs a new <code>VariationAssociation</code>.
     * @alias module:model/VariationAssociation
     */
    constructor() { 
        
        VariationAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VariationAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VariationAssociation} obj Optional instance to populate.
     * @return {module:model/VariationAssociation} The populated <code>VariationAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariationAssociation();
    ...
    /**
     * Validates the JSON data with respect to <code>VariationAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VariationAssociation</code>.
     */
 ...
 */
VariationAssociation.prototype['description'] = undefined;

/**
 * @member {Array.<module:model/VariationEvidence>} evidences
 */
VariationAssociation.prototype['evidences'] = undefined;

/**
 * @member {String} name
 */
VariationAssociation.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/VariationXref>} xrefs
 */
VariationAssociation.prototype['xrefs'] = undefined;
...
export default VariationAssociation;
