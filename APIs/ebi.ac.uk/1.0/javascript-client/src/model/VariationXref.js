...
/**
 * The VariationXref model module.
 * @module model/VariationXref
 * @version 1.0
 */
class VariationXref {
    /**
     * Constructs a new <code>VariationXref</code>.
     * @alias module:model/VariationXref
     */
    constructor() { 
        
        VariationXref.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VariationXref</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VariationXref} obj Optional instance to populate.
     * @return {module:model/VariationXref} The populated <code>VariationXref</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariationXref();
    ...
    /**
     * Validates the JSON data with respect to <code>VariationXref</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VariationXref</code>.
     */
 ...
 * @member {String} id
 */
VariationXref.prototype['id'] = undefined;

/**
 * @member {String} name
 */
VariationXref.prototype['name'] = undefined;
