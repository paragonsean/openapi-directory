...
/**
 * The EFOEntities model module.
 * @module model/EFOEntities
 * @version 1.0
 */
class EFOEntities {
    /**
     * Constructs a new <code>EFOEntities</code>.
     * @alias module:model/EFOEntities
     */
    constructor() { 
        
        EFOEntities.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EFOEntities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EFOEntities} obj Optional instance to populate.
     * @return {module:model/EFOEntities} The populated <code>EFOEntities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EFOEntities();

            if (data.hasOwnProperty('diseases')) {
                obj['diseases'] = ApiClient.convertToType(data['diseases'], [EFO]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EFOEntities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EFOEntities</code>.
     */
...
/**
 * @member {Array.<module:model/EFO>} diseases
 */
EFOEntities.prototype['diseases'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
EFOEntities.prototype['pageMeta'] = undefined;
