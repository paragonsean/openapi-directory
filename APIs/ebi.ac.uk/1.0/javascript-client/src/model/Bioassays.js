...
import BioAssayMetaData from './BioAssayMetaData';
import PageMeta from './PageMeta';

/**
 * The Bioassays model module.
 * @module model/Bioassays
 * @version 1.0
 */
class Bioassays {
    /**
     * Constructs a new <code>Bioassays</code>.
     * @alias module:model/Bioassays
     */
    constructor() { 
        
        Bioassays.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Bioassays</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Bioassays} obj Optional instance to populate.
     * @return {module:model/Bioassays} The populated <code>Bioassays</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Bioassays();

            if (data.hasOwnProperty('bioassays')) {
                obj['bioassays'] = ApiClient.convertToType(data['bioassays'], [BioAssayMetaData]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Bioassays</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Bioassays</code>.
     */
    static validateJSON(data) {
        if (data['bioassays']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['bioassays'])) {
                throw new Error("Expected the field `bioassays` to be an array in the JSON data but got " + data['bioassays']);
            }
            // validate the optional field `bioassays` (array)
            for (const item of data['bioassays']) {
                BioAssayMetaData.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/BioAssayMetaData>} bioassays
 */
Bioassays.prototype['bioassays'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
Bioassays.prototype['pageMeta'] = undefined;
