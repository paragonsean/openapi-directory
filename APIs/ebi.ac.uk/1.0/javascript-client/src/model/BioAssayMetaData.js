...
import SidRelatedData from './SidRelatedData';

/**
 * The BioAssayMetaData model module.
 * @module model/BioAssayMetaData
 * @version 1.0
 */
class BioAssayMetaData {
    /**
     * Constructs a new <code>BioAssayMetaData</code>.
     * @alias module:model/BioAssayMetaData
     */
    constructor() { 
        
        BioAssayMetaData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BioAssayMetaData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BioAssayMetaData} obj Optional instance to populate.
     * @return {module:model/BioAssayMetaData} The populated <code>BioAssayMetaData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BioAssayMetaData();

            if (data.hasOwnProperty('bioAssay')) {
                obj['bioAssay'] = BioAssay.constructFromObject(data['bioAssay']);
            }
            if (data.hasOwnProperty('sidRelatedData')) {
                obj['sidRelatedData'] = ApiClient.convertToType(data['sidRelatedData'], [SidRelatedData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BioAssayMetaData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BioAssayMetaData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `bioAssay`
        if (data['bioAssay']) { // data not null
          BioAssay.validateJSON(data['bioAssay']);
        }
        if (data['sidRelatedData']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['sidRelatedData'])) {
                throw new Error("Expected the field `sidRelatedData` to be an array in the JSON data but got " + data['sidRelatedData']);
            }
            // validate the optional field `sidRelatedData` (array)
            for (const item of data['sidRelatedData']) {
                SidRelatedData.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/BioAssay} bioAssay
 */
BioAssayMetaData.prototype['bioAssay'] = undefined;

/**
 * @member {Array.<module:model/SidRelatedData>} sidRelatedData
 */
BioAssayMetaData.prototype['sidRelatedData'] = undefined;
...
export default BioAssayMetaData;
