...
class Assay {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assay_id')) {
                obj['assay_id'] = ApiClient.convertToType(data['assay_id'], 'String');
            }
            if (data.hasOwnProperty('assay_organism')) {
                obj['assay_organism'] = ApiClient.convertToType(data['assay_organism'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Assay</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Assay</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['assay_id'] && !(typeof data['assay_id'] === 'string' || data['assay_id'] instanceof String)) {
            throw new Error("Expected the field `assay_id` to be a primitive type in the JSON string but got " + data['assay_id']);
        }
        // ensure the json data is a string
        if (data['assay_organism'] && !(typeof data['assay_organism'] === 'string' || data['assay_organism'] instanceof String)) {
            throw new Error("Expected the field `assay_organism` to be a primitive type in the JSON string but got " + data['assay_organism']);
        }
        // ensure the json data is a string
 ...
 */
Assay.prototype['assay_chembl_id'] = undefined;

/**
 * @member {String} assay_id
 */
Assay.prototype['assay_id'] = undefined;

/**
 * @member {String} assay_organism
 */
Assay.prototype['assay_organism'] = undefined;

/**
 * @member {String} assay_type
 */
Assay.prototype['assay_type'] = undefined;

/**
 * @member {Number} confidence_score
 */
Assay.prototype['confidence_score'] = undefined;

/**
 * @member {String} target_chembl_id
 */
Assay.prototype['target_chembl_id'] = undefined;
