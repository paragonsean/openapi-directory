...
class Target {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accessions')) {
                obj['accessions'] = ApiClient.convertToType(data['accessions'], ['String']);
            }
            ...
            if (data.hasOwnProperty('organism')) {
                obj['organism'] = ApiClient.convertToType(data['organism'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['accessions'])) {
            throw new Error("Expected the field `accessions` to be an array in the JSON data but got " + data['accessions']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is a string
        if (data['organism'] && !(typeof data['organism'] === 'string' || data['organism'] instanceof String)) {
            throw new Error("Expected the field `organism` to be a primitive type in the JSON string but got " + data['organism']);
        }
...
/**
 * @member {Array.<String>} accessions
 */
Target.prototype['accessions'] = undefined;

/**
 * @member {Array.<String>} action
 */
Target.prototype['action'] = undefined;
...
/**
 * @member {String} organism
 */
Target.prototype['organism'] = undefined;
