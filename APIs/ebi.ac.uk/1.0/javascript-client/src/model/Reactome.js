...
/**
 * The Reactome model module.
 * @module model/Reactome
 * @version 1.0
 */
class Reactome {
    /**
     * Constructs a new <code>Reactome</code>.
     * @alias module:model/Reactome
     */
    constructor() { 
        
        Reactome.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Reactome</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Reactome} obj Optional instance to populate.
     * @return {module:model/Reactome} The populated <code>Reactome</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Reactome();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('pathwayName')) {
                obj['pathwayName'] = ApiClient.convertToType(data['pathwayName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Reactome</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Reactome</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['pathwayName'] && !(typeof data['pathwayName'] === 'string' || data['pathwayName'] instanceof String)) {
            throw new Error("Expected the field `pathwayName` to be a primitive type in the JSON string but got " + data['pathwayName']);
        }
 ...
 * @member {String} id
 */
Reactome.prototype['id'] = undefined;

/**
 * @member {String} pathwayName
 */
Reactome.prototype['pathwayName'] = undefined;
