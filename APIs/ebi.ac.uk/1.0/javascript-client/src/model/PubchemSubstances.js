...
/**
 * The PubchemSubstances model module.
 * @module model/PubchemSubstances
 * @version 1.0
 */
class PubchemSubstances {
    /**
     * Constructs a new <code>PubchemSubstances</code>.
     * @alias module:model/PubchemSubstances
     */
    constructor() { 
        
        PubchemSubstances.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PubchemSubstances</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PubchemSubstances} obj Optional instance to populate.
     * @return {module:model/PubchemSubstances} The populated <code>PubchemSubstances</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PubchemSubstances();

            if (data.hasOwnProperty('pageMeta')) {
                obj['pageMeta'] = PageMeta.constructFromObject(data['pageMeta']);
            }
            if (data.hasOwnProperty('substances')) {
                obj['substances'] = ApiClient.convertToType(data['substances'], [Substance]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PubchemSubstances</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PubchemSubstances</code>.
     */
    static validateJSON(data) {
        ...
        if (data['substances']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['substances'])) {
                throw new Error("Expected the field `substances` to be an array in the JSON data but got " + data['substances']);
            }
            // validate the optional field `substances` (array)
            for (const item of data['substances']) {
                Substance.validateJSON(item);
            };
        }
 ...
 */
PubchemSubstances.prototype['pageMeta'] = undefined;

/**
 * @member {Array.<module:model/Substance>} substances
 */
PubchemSubstances.prototype['substances'] = undefined;
