...
/**
 * The VariationEvidenceSource model module.
 * @module model/VariationEvidenceSource
 * @version 1.0
 */
class VariationEvidenceSource {
    /**
     * Constructs a new <code>VariationEvidenceSource</code>.
     * @alias module:model/VariationEvidenceSource
     */
    constructor() { 
        
        VariationEvidenceSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VariationEvidenceSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VariationEvidenceSource} obj Optional instance to populate.
     * @return {module:model/VariationEvidenceSource} The populated <code>VariationEvidenceSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariationEvidenceSource();
    ...
    /**
     * Validates the JSON data with respect to <code>VariationEvidenceSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VariationEvidenceSource</code>.
     */
 ...
 * @member {String} id
 */
VariationEvidenceSource.prototype['id'] = undefined;

/**
 * @member {String} name
 */
VariationEvidenceSource.prototype['name'] = undefined;
...
export default VariationEvidenceSource;
