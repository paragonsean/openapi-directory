...
/**
 * The Pfam model module.
 * @module model/Pfam
 * @version 1.0
 */
class Pfam {
    /**
     * Constructs a new <code>Pfam</code>.
     * @alias module:model/Pfam
     */
    constructor() { 
        
        Pfam.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Pfam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pfam} obj Optional instance to populate.
     * @return {module:model/Pfam} The populated <code>Pfam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('entryName')) {
                obj['entryName'] = ApiClient.convertToType(data['entryName'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Pfam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pfam</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['entryName'] && !(typeof data['entryName'] === 'string' || data['entryName'] instanceof String)) {
            throw new Error("Expected the field `entryName` to be a primitive type in the JSON string but got " + data['entryName']);
        }
        // ensure the json data is a string
 ...
 */
Pfam.prototype['entryName'] = undefined;

/**
 * @member {String} id
 */
Pfam.prototype['id'] = undefined;
