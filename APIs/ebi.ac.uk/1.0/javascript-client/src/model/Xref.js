...
/**
 * The Xref model module.
 * @module model/Xref
 * @version 1.0
 */
class Xref {
    /**
     * Constructs a new <code>Xref</code>.
     * @alias module:model/Xref
     */
    constructor() { 
        
        Xref.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Xref</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Xref} obj Optional instance to populate.
     * @return {module:model/Xref} The populated <code>Xref</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Xref</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Xref</code>.
     */
 ...
 * @member {String} id
 */
Xref.prototype['id'] = undefined;

/**
 * @member {String} source
 */
Xref.prototype['source'] = undefined;
