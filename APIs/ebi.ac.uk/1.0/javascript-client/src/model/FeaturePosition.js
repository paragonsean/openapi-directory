...
/**
 * The FeaturePosition model module.
 * @module model/FeaturePosition
 * @version 1.0
 */
class FeaturePosition {
    /**
     * Constructs a new <code>FeaturePosition</code>.
     * @alias module:model/FeaturePosition
     */
    constructor() { 
        
        FeaturePosition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FeaturePosition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeaturePosition} obj Optional instance to populate.
     * @return {module:model/FeaturePosition} The populated <code>FeaturePosition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeaturePosition();

            if (data.hasOwnProperty('ceil')) {
                obj['ceil'] = ApiClient.convertToType(data['ceil'], 'Number');
            }
            if (data.hasOwnProperty('floor')) {
                obj['floor'] = ApiClient.convertToType(data['floor'], 'Number');
            }
            if (data.hasOwnProperty('uncertain')) {
                obj['uncertain'] = ApiClient.convertToType(data['uncertain'], 'Boolean');
            }
            if (data.hasOwnProperty('unparsed')) {
                obj['unparsed'] = ApiClient.convertToType(data['unparsed'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeaturePosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeaturePosition</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['unparsed'] && !(typeof data['unparsed'] === 'string' || data['unparsed'] instanceof String)) {
            throw new Error("Expected the field `unparsed` to be a primitive type in the JSON string but got " + data['unparsed']);
        }
 ...
 * @member {Number} ceil
 */
FeaturePosition.prototype['ceil'] = undefined;

/**
 * @member {Number} floor
 */
FeaturePosition.prototype['floor'] = undefined;

/**
 * @member {Boolean} uncertain
 */
FeaturePosition.prototype['uncertain'] = undefined;

/**
 * @member {String} unparsed
 */
FeaturePosition.prototype['unparsed'] = undefined;
