...
/**
 * The OpenTargets model module.
 * @module model/OpenTargets
 * @version 1.0
 */
class OpenTargets {
    /**
     * Constructs a new <code>OpenTargets</code>.
     * @alias module:model/OpenTargets
     */
    constructor() { 
        
        OpenTargets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenTargets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenTargets} obj Optional instance to populate.
     * @return {module:model/OpenTargets} The populated <code>OpenTargets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenTargets();
    ...
    /**
     * Validates the JSON data with respect to <code>OpenTargets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenTargets</code>.
     */
 ...
 * @member {String} id
 */
OpenTargets.prototype['id'] = undefined;
