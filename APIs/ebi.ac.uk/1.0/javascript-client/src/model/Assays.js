...
/**
 * The Assays model module.
 * @module model/Assays
 * @version 1.0
 */
class Assays {
    /**
     * Constructs a new <code>Assays</code>.
     * @alias module:model/Assays
     */
    constructor() { 
        
        Assays.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Assays</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Assays} obj Optional instance to populate.
     * @return {module:model/Assays} The populated <code>Assays</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assays')) {
                obj['assays'] = ApiClient.convertToType(data['assays'], [Assay]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Assays</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Assays</code>.
     */
    static validateJSON(data) {
        if (data['assays']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['assays'])) {
                throw new Error("Expected the field `assays` to be an array in the JSON data but got " + data['assays']);
            }
            // validate the optional field `assays` (array)
            for (const item of data['assays']) {
                Assay.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/Assay>} assays
 */
Assays.prototype['assays'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
Assays.prototype['pageMeta'] = undefined;
