...
import CrossbarTarget from './CrossbarTarget';
import PageMeta from './PageMeta';

/**
 * The Targets model module.
 * @module model/Targets
 * @version 1.0
 */
class Targets {
    /**
     * Constructs a new <code>Targets</code>.
     * @alias module:model/Targets
     */
    constructor() { 
        
        Targets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Targets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Targets} obj Optional instance to populate.
     * @return {module:model/Targets} The populated <code>Targets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('targets')) {
                obj['targets'] = ApiClient.convertToType(data['targets'], [CrossbarTarget]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Targets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Targets</code>.
     */
    static validateJSON(data) {
        ...
        if (data['targets']) { // data not null
            ...
            for (const item of data['targets']) {
                CrossbarTarget.validateJSON(item);
            };
        }
 ...
 */
Targets.prototype['pageMeta'] = undefined;

/**
 * @member {Array.<module:model/CrossbarTarget>} targets
 */
Targets.prototype['targets'] = undefined;
