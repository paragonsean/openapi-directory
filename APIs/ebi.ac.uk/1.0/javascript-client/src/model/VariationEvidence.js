...
import VariationEvidenceSource from './VariationEvidenceSource';

/**
 * The VariationEvidence model module.
 * @module model/VariationEvidence
 * @version 1.0
 */
class VariationEvidence {
    /**
     * Constructs a new <code>VariationEvidence</code>.
     * @alias module:model/VariationEvidence
     */
    constructor() { 
        
        VariationEvidence.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VariationEvidence</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VariationEvidence} obj Optional instance to populate.
     * @return {module:model/VariationEvidence} The populated <code>VariationEvidence</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariationEvidence();

            if (data.hasOwnProperty('source')) {
                obj['source'] = VariationEvidenceSource.constructFromObject(data['source']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VariationEvidence</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VariationEvidence</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          VariationEvidenceSource.validateJSON(data['source']);
        }
...
/**
 * @member {module:model/VariationEvidenceSource} source
 */
VariationEvidence.prototype['source'] = undefined;
...
export default VariationEvidence;
