...
import CrossbarDrug from './CrossbarDrug';
import PageMeta from './PageMeta';

/**
 * The Drugs model module.
 * @module model/Drugs
 * @version 1.0
 */
class Drugs {
    /**
     * Constructs a new <code>Drugs</code>.
     * @alias module:model/Drugs
     */
    constructor() { 
        
        Drugs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Drugs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Drugs} obj Optional instance to populate.
     * @return {module:model/Drugs} The populated <code>Drugs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('drugs')) {
                obj['drugs'] = ApiClient.convertToType(data['drugs'], [CrossbarDrug]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Drugs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Drugs</code>.
     */
    static validateJSON(data) {
        if (data['drugs']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['drugs'])) {
                throw new Error("Expected the field `drugs` to be an array in the JSON data but got " + data['drugs']);
            }
            // validate the optional field `drugs` (array)
            for (const item of data['drugs']) {
                CrossbarDrug.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/CrossbarDrug>} drugs
 */
Drugs.prototype['drugs'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
Drugs.prototype['pageMeta'] = undefined;
