...
import CrossbarProteinVariation from './CrossbarProteinVariation';
import Features from './Features';
import ProteinInteraction from './ProteinInteraction';

/**
 * The Protein model module.
 * @module model/Protein
 * @version 1.0
 */
class Protein {
    /**
     * Constructs a new <code>Protein</code>.
     * @alias module:model/Protein
     */
    constructor() { 
        
        Protein.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Protein</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Protein} obj Optional instance to populate.
     * @return {module:model/Protein} The populated <code>Protein</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('crossreferences')) {
                obj['crossreferences'] = CrossReferences.constructFromObject(data['crossreferences']);
            }
            if (data.hasOwnProperty('ec_numbers')) {
                obj['ec_numbers'] = ApiClient.convertToType(data['ec_numbers'], ['String']);
            }
            ...
            if (data.hasOwnProperty('interactions')) {
                obj['interactions'] = ApiClient.convertToType(data['interactions'], [ProteinInteraction]);
            }
            ...
            if (data.hasOwnProperty('variations')) {
                obj['variations'] = ApiClient.convertToType(data['variations'], [CrossbarProteinVariation]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Protein</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Protein</code>.
     */
    static validateJSON(data) {
        ...
        if (data['crossreferences']) { // data not null
          CrossReferences.validateJSON(data['crossreferences']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['ec_numbers'])) {
            throw new Error("Expected the field `ec_numbers` to be an array in the JSON data but got " + data['ec_numbers']);
        }
        ...
        if (data['interactions']) { // data not null
            ...
            for (const item of data['interactions']) {
                ProteinInteraction.validateJSON(item);
            };
        }
        if (data['variations']) { // data not null
            ...
            for (const item of data['variations']) {
                CrossbarProteinVariation.validateJSON(item);
            };
        }
 ...
 */
Protein.prototype['accession'] = undefined;

/**
 * @member {String} chromosome
 */
Protein.prototype['chromosome'] = undefined;

/**
 * @member {module:model/CrossReferences} crossreferences
 */
Protein.prototype['crossreferences'] = undefined;

/**
 * @member {Array.<String>} ec_numbers
 */
Protein.prototype['ec_numbers'] = undefined;

/**
 * @member {module:model/Features} features
 */
Protein.prototype['features'] = undefined;

/**
 * @member {String} full_name
 */
Protein.prototype['full_name'] = undefined;

/**
 * @member {Array.<String>} genes
 */
Protein.prototype['genes'] = undefined;

/**
 * @member {Array.<module:model/ProteinInteraction>} interactions
 */
Protein.prototype['interactions'] = undefined;

/**
 * @member {Number} length
 */
Protein.prototype['length'] = undefined;

/**
 * @member {Number} mass
 */
Protein.prototype['mass'] = undefined;

/**
 * @member {Number} tax_id
 */
Protein.prototype['tax_id'] = undefined;

/**
 * @member {Array.<module:model/CrossbarProteinVariation>} variations
 */
Protein.prototype['variations'] = undefined;
