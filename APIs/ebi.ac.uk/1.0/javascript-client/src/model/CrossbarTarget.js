...
/**
 * The CrossbarTarget model module.
 * @module model/CrossbarTarget
 * @version 1.0
 */
class CrossbarTarget {
    /**
     * Constructs a new <code>CrossbarTarget</code>.
     * @alias module:model/CrossbarTarget
     */
    constructor() { 
        
        CrossbarTarget.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CrossbarTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrossbarTarget} obj Optional instance to populate.
     * @return {module:model/CrossbarTarget} The populated <code>CrossbarTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrossbarTarget();
    ...
    /**
     * Validates the JSON data with respect to <code>CrossbarTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrossbarTarget</code>.
     */
 ...
 */
CrossbarTarget.prototype['accession'] = undefined;

/**
 * @member {String} target_chembl_id
 */
CrossbarTarget.prototype['target_chembl_id'] = undefined;
