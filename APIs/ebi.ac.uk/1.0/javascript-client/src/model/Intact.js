...
/**
 * The Intact model module.
 * @module model/Intact
 * @version 1.0
 */
class Intact {
    /**
     * Constructs a new <code>Intact</code>.
     * @alias module:model/Intact
     */
    constructor() { 
        
        Intact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Intact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Intact} obj Optional instance to populate.
     * @return {module:model/Intact} The populated <code>Intact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('interaction_ac')) {
                obj['interaction_ac'] = ApiClient.convertToType(data['interaction_ac'], ['String']);
            }
            if (data.hasOwnProperty('interactor_a')) {
                obj['interactor_a'] = Interactor.constructFromObject(data['interactor_a']);
            }
            if (data.hasOwnProperty('interactor_b')) {
                obj['interactor_b'] = Interactor.constructFromObject(data['interactor_b']);
            }
            if (data.hasOwnProperty('method')) {
                obj['method'] = ApiClient.convertToType(data['method'], 'String');
            }
            if (data.hasOwnProperty('source_db')) {
                obj['source_db'] = ApiClient.convertToType(data['source_db'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Intact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Intact</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['interaction_ac'])) {
            throw new Error("Expected the field `interaction_ac` to be an array in the JSON data but got " + data['interaction_ac']);
        }
        // validate the optional field `interactor_a`
        if (data['interactor_a']) { // data not null
          Interactor.validateJSON(data['interactor_a']);
        }
        // validate the optional field `interactor_b`
        if (data['interactor_b']) { // data not null
          Interactor.validateJSON(data['interactor_b']);
        }
        ...
        // ensure the json data is a string
        if (data['source_db'] && !(typeof data['source_db'] === 'string' || data['source_db'] instanceof String)) {
            throw new Error("Expected the field `source_db` to be a primitive type in the JSON string but got " + data['source_db']);
        }
 ...
 */
Intact.prototype['confidence'] = undefined;

/**
 * @member {Array.<String>} interaction_ac
 */
Intact.prototype['interaction_ac'] = undefined;

/**
 * @member {module:model/Interactor} interactor_a
 */
Intact.prototype['interactor_a'] = undefined;

/**
 * @member {module:model/Interactor} interactor_b
 */
Intact.prototype['interactor_b'] = undefined;

/**
 * @member {String} method
 */
Intact.prototype['method'] = undefined;

/**
 * @member {String} source_db
 */
Intact.prototype['source_db'] = undefined;
