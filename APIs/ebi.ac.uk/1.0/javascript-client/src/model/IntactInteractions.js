...
/**
 * The IntactInteractions model module.
 * @module model/IntactInteractions
 * @version 1.0
 */
class IntactInteractions {
    /**
     * Constructs a new <code>IntactInteractions</code>.
     * @alias module:model/IntactInteractions
     */
    constructor() { 
        
        IntactInteractions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IntactInteractions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IntactInteractions} obj Optional instance to populate.
     * @return {module:model/IntactInteractions} The populated <code>IntactInteractions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IntactInteractions();

            if (data.hasOwnProperty('interactions')) {
                obj['interactions'] = ApiClient.convertToType(data['interactions'], [Intact]);
            }
            if (data.hasOwnProperty('pageMeta')) {
                obj['pageMeta'] = PageMeta.constructFromObject(data['pageMeta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IntactInteractions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntactInteractions</code>.
     */
    static validateJSON(data) {
        if (data['interactions']) { // data not null
            ...
            for (const item of data['interactions']) {
                Intact.validateJSON(item);
            };
        }
        // validate the optional field `pageMeta`
        if (data['pageMeta']) { // data not null
          PageMeta.validateJSON(data['pageMeta']);
        }
...
/**
 * @member {Array.<module:model/Intact>} interactions
 */
IntactInteractions.prototype['interactions'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
IntactInteractions.prototype['pageMeta'] = undefined;
...
export default IntactInteractions;
