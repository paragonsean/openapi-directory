...
/**
 * The Orphanet model module.
 * @module model/Orphanet
 * @version 1.0
 */
class Orphanet {
    /**
     * Constructs a new <code>Orphanet</code>.
     * @alias module:model/Orphanet
     */
    constructor() { 
        
        Orphanet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Orphanet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Orphanet} obj Optional instance to populate.
     * @return {module:model/Orphanet} The populated <code>Orphanet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Orphanet();
    ...
    /**
     * Validates the JSON data with respect to <code>Orphanet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Orphanet</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['disease'] && !(typeof data['disease'] === 'string' || data['disease'] instanceof String)) {
            throw new Error("Expected the field `disease` to be a primitive type in the JSON string but got " + data['disease']);
        }
        // ensure the json data is a string
 ...
 */
Orphanet.prototype['disease'] = undefined;

/**
 * @member {String} id
 */
Orphanet.prototype['id'] = undefined;
