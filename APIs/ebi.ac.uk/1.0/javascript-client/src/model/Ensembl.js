...
/**
 * The Ensembl model module.
 * @module model/Ensembl
 * @version 1.0
 */
class Ensembl {
    /**
     * Constructs a new <code>Ensembl</code>.
     * @alias module:model/Ensembl
     */
    constructor() { 
        
        Ensembl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ensembl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ensembl} obj Optional instance to populate.
     * @return {module:model/Ensembl} The populated <code>Ensembl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isoform')) {
                obj['isoform'] = ApiClient.convertToType(data['isoform'], 'String');
            }
            if (data.hasOwnProperty('proteinSequenceId')) {
                obj['proteinSequenceId'] = ApiClient.convertToType(data['proteinSequenceId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Ensembl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ensembl</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['isoform'] && !(typeof data['isoform'] === 'string' || data['isoform'] instanceof String)) {
            throw new Error("Expected the field `isoform` to be a primitive type in the JSON string but got " + data['isoform']);
        }
        // ensure the json data is a string
        if (data['proteinSequenceId'] && !(typeof data['proteinSequenceId'] === 'string' || data['proteinSequenceId'] instanceof String)) {
            throw new Error("Expected the field `proteinSequenceId` to be a primitive type in the JSON string but got " + data['proteinSequenceId']);
        }
 ...
 */
Ensembl.prototype['geneId'] = undefined;

/**
 * @member {String} id
 */
Ensembl.prototype['id'] = undefined;

/**
 * @member {String} isoform
 */
Ensembl.prototype['isoform'] = undefined;

/**
 * @member {String} proteinSequenceId
 */
Ensembl.prototype['proteinSequenceId'] = undefined;
