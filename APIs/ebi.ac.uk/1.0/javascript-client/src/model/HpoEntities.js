...
import HPOEntity from './HPOEntity';
import PageMeta from './PageMeta';

/**
 * The HpoEntities model module.
 * @module model/HpoEntities
 * @version 1.0
 */
class HpoEntities {
    /**
     * Constructs a new <code>HpoEntities</code>.
     * @alias module:model/HpoEntities
     */
    constructor() { 
        
        HpoEntities.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HpoEntities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HpoEntities} obj Optional instance to populate.
     * @return {module:model/HpoEntities} The populated <code>HpoEntities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HpoEntities();

            if (data.hasOwnProperty('hpo')) {
                obj['hpo'] = ApiClient.convertToType(data['hpo'], [HPOEntity]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>HpoEntities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HpoEntities</code>.
     */
    static validateJSON(data) {
        if (data['hpo']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['hpo'])) {
                throw new Error("Expected the field `hpo` to be an array in the JSON data but got " + data['hpo']);
            }
            // validate the optional field `hpo` (array)
            for (const item of data['hpo']) {
                HPOEntity.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/HPOEntity>} hpo
 */
HpoEntities.prototype['hpo'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
HpoEntities.prototype['pageMeta'] = undefined;
