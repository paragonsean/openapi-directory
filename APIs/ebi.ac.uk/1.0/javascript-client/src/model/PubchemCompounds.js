...
import CrossbarPCCompound from './CrossbarPCCompound';
import PageMeta from './PageMeta';

/**
 * The PubchemCompounds model module.
 * @module model/PubchemCompounds
 * @version 1.0
 */
class PubchemCompounds {
    /**
     * Constructs a new <code>PubchemCompounds</code>.
     * @alias module:model/PubchemCompounds
     */
    constructor() { 
        
        PubchemCompounds.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PubchemCompounds</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PubchemCompounds} obj Optional instance to populate.
     * @return {module:model/PubchemCompounds} The populated <code>PubchemCompounds</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PubchemCompounds();

            if (data.hasOwnProperty('compounds')) {
                obj['compounds'] = ApiClient.convertToType(data['compounds'], [CrossbarPCCompound]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PubchemCompounds</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PubchemCompounds</code>.
     */
    static validateJSON(data) {
        if (data['compounds']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['compounds'])) {
                throw new Error("Expected the field `compounds` to be an array in the JSON data but got " + data['compounds']);
            }
            // validate the optional field `compounds` (array)
            for (const item of data['compounds']) {
                CrossbarPCCompound.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/CrossbarPCCompound>} compounds
 */
PubchemCompounds.prototype['compounds'] = undefined;

/**
 * @member {module:model/PageMeta} pageMeta
 */
PubchemCompounds.prototype['pageMeta'] = undefined;
...
export default PubchemCompounds;
