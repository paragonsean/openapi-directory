...
class PageMeta {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageMeta();

            if (data.hasOwnProperty('currentElements')) {
                obj['currentElements'] = ApiClient.convertToType(data['currentElements'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PageMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageMeta</code>.
     */
...
/**
 * @member {Number} currentElements
 */
PageMeta.prototype['currentElements'] = undefined;

/**
 * @member {Number} currentPage
 */
PageMeta.prototype['currentPage'] = undefined;

/**
 * @member {Number} limit
 */
PageMeta.prototype['limit'] = undefined;

/**
 * @member {Number} totalElements
 */
PageMeta.prototype['totalElements'] = undefined;

/**
 * @member {Number} totalPages
 */
PageMeta.prototype['totalPages'] = undefined;
