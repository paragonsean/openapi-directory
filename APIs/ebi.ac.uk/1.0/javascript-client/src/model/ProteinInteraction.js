...
/**
 * The ProteinInteraction model module.
 * @module model/ProteinInteraction
 * @version 1.0
 */
class ProteinInteraction {
    /**
     * Constructs a new <code>ProteinInteraction</code>.
     * @alias module:model/ProteinInteraction
     */
    constructor() { 
        
        ProteinInteraction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProteinInteraction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProteinInteraction} obj Optional instance to populate.
     * @return {module:model/ProteinInteraction} The populated <code>ProteinInteraction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProteinInteraction();
            ...
            if (data.hasOwnProperty('interactors')) {
                obj['interactors'] = ApiClient.convertToType(data['interactors'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProteinInteraction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProteinInteraction</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['interaction_type'] && !(typeof data['interaction_type'] === 'string' || data['interaction_type'] instanceof String)) {
            throw new Error("Expected the field `interaction_type` to be a primitive type in the JSON string but got " + data['interaction_type']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['interactors'])) {
            throw new Error("Expected the field `interactors` to be an array in the JSON data but got " + data['interactors']);
        }
 ...
 * @member {String} id
 */
ProteinInteraction.prototype['id'] = undefined;

/**
 * @member {String} interaction_type
 */
ProteinInteraction.prototype['interaction_type'] = undefined;

/**
 * @member {Array.<String>} interactors
 */
ProteinInteraction.prototype['interactors'] = undefined;
