...
/**
* PubChemCompounds service.
* @module api/PubChemCompoundsApi
* @version 1.0
*/
export default class PubChemCompoundsApi {

    /**
    * Constructs a new PubChemCompoundsApi. 
    * @alias module:api/PubChemCompoundsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCompoundsUsingGET operation.
     * @callback module:api/PubChemCompoundsApi~getCompoundsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PubchemCompounds} data The data returned by the service call.
     ...
     * @param {Array.<String>} [canonicalSmiles] canonicalSmiles
     * @param {Array.<String>} [cid] cid
     * @param {Array.<String>} [inchiKey] inchiKey
     * @param {Number} [limit = 10)] limit
     * @param {Number} [page = 0)] page
     * @param {module:api/PubChemCompoundsApi~getCompoundsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PubchemCompounds}
     */
    getCompoundsUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'canonicalSmiles': this.apiClient.buildCollectionParam(opts['canonicalSmiles'], 'multi'),
        'cid': this.apiClient.buildCollectionParam(opts['cid'], 'multi'),
        'inchiKey': this.apiClient.buildCollectionParam(opts['inchiKey'], 'multi'),
        'limit': opts['limit'],
        'page': opts['page']
      };
      let headerParams = {
      ...
      let returnType = PubchemCompounds;
      return this.apiClient.callApi(
        '/pubchem/compounds', 'GET',
