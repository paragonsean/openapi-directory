...
/**
* PubChemBiossays service.
* @module api/PubChemBiossaysApi
* @version 1.0
*/
export default class PubChemBiossaysApi {

    /**
    * Constructs a new PubChemBiossaysApi. 
    * @alias module:api/PubChemBiossaysApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getBioassaysUsingGET operation.
     * @callback module:api/PubChemBiossaysApi~getBioassaysUsingGETCallback
     ...
     * @param {Array.<String>} [assayPubchemId] assayPubchemId
     * @param {Number} [limit = 1)] limit
     * @param {Array.<String>} [ncbiProteinId] ncbiProteinId
     * @param {Number} [page = 0)] page
     * @param {module:api/PubChemBiossaysApi~getBioassaysUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Bioassays}
     */
    getBioassaysUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'assayPubchemId': this.apiClient.buildCollectionParam(opts['assayPubchemId'], 'multi'),
        'limit': opts['limit'],
        'ncbiProteinId': this.apiClient.buildCollectionParam(opts['ncbiProteinId'], 'multi'),
        'page': opts['page']
      };
      let headerParams = {
      };
