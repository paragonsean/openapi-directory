...
* @version 1.0
*/
export default class HPOApi {

    /**
    * Constructs a new HPOApi. 
    * @alias module:api/HPOApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getHpoUsingGET operation.
     * @callback module:api/HPOApi~getHpoUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/HpoEntities} data The data returned by the service call.
     ...
     * @param {Array.<String>} [genesymbol] genesymbol
     * @param {Array.<String>} [hpotermname] hpotermname
     * @param {Number} [limit = 10)] limit
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [synonym] synonym
     * @param {module:api/HPOApi~getHpoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HpoEntities}
     */
    getHpoUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'genesymbol': this.apiClient.buildCollectionParam(opts['genesymbol'], 'multi'),
        'hpotermname': this.apiClient.buildCollectionParam(opts['hpotermname'], 'multi'),
        'limit': opts['limit'],
        'page': opts['page'],
