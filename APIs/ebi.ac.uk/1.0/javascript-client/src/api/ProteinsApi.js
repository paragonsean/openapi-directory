...
/**
* Proteins service.
* @module api/ProteinsApi
* @version 1.0
*/
export default class ProteinsApi {

    /**
    * Constructs a new ProteinsApi. 
    * @alias module:api/ProteinsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getProteinsUsingGET operation.
     * @callback module:api/ProteinsApi~getProteinsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Proteins} data The data returned by the service call.
     ...
     * @param {Array.<String>} [accession] accession
     * @param {Array.<String>} [ec] ec
     * @param {Array.<String>} [fullName] fullName
     * @param {Array.<String>} [gene] gene
     * @param {Array.<String>} [go] go
     * @param {Array.<String>} [interpro] interpro
     * @param {Number} [limit = 10)] limit
     * @param {Array.<String>} [omim] omim
     * @param {Array.<String>} [orphanet] orphanet
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [pfam] pfam
     * @param {Array.<String>} [reactome] reactome
     * @param {Array.<Number>} [taxId] taxId
     * @param {module:api/ProteinsApi~getProteinsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Proteins}
     */
    getProteinsUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'ec': this.apiClient.buildCollectionParam(opts['ec'], 'multi'),
        'fullName': this.apiClient.buildCollectionParam(opts['fullName'], 'multi'),
        'gene': this.apiClient.buildCollectionParam(opts['gene'], 'multi'),
        'go': this.apiClient.buildCollectionParam(opts['go'], 'multi'),
        'interpro': this.apiClient.buildCollectionParam(opts['interpro'], 'multi'),
        'limit': opts['limit'],
        'omim': this.apiClient.buildCollectionParam(opts['omim'], 'multi'),
        'orphanet': this.apiClient.buildCollectionParam(opts['orphanet'], 'multi'),
        'page': opts['page'],
        'pfam': this.apiClient.buildCollectionParam(opts['pfam'], 'multi'),
        'reactome': this.apiClient.buildCollectionParam(opts['reactome'], 'multi'),
        'taxId': this.apiClient.buildCollectionParam(opts['taxId'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
