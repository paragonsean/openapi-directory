...
/**
* Intact service.
* @module api/IntactApi
* @version 1.0
*/
export default class IntactApi {

    /**
    * Constructs a new IntactApi. 
    * @alias module:api/IntactApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getIntactUsingGET operation.
     * @callback module:api/IntactApi~getIntactUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntactInteractions} data The data returned by the service call.
     ...
     * @param {module:api/IntactApi~getIntactUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntactInteractions}
     */
    getIntactUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = IntactInteractions;
