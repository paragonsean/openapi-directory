...
export default class ActivitiesApi {
    ...
    */
     ...
     * @param {Array.<String>} [assayChemblId] assayChemblId
     * @param {Number} [limit = 10)] limit
     * @param {Array.<String>} [moleculeChemblId] moleculeChemblId
     * @param {Number} [page = 0)] page
     * @param {Number} [pchemblValue] pchemblValue
     * @param {Array.<String>} [targetChemblId] targetChemblId
     ...
     */
    getActivitiesUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'assayChemblId': this.apiClient.buildCollectionParam(opts['assayChemblId'], 'multi'),
        'limit': opts['limit'],
        'moleculeChemblId': this.apiClient.buildCollectionParam(opts['moleculeChemblId'], 'multi'),
        'page': opts['page'],
        'pchemblValue': opts['pchemblValue'],
        'targetChemblId': this.apiClient.buildCollectionParam(opts['targetChemblId'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
