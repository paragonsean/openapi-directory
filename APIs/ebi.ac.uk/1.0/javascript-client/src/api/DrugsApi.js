...
export default class DrugsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getDrugsUsingGET operation.
     * @callback module:api/DrugsApi~getDrugsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Drugs} data The data returned by the service call.
     ...
     * @param {Array.<String>} [chemblId] chemblId
     * @param {Array.<String>} [identifier] identifier
     * @param {Number} [limit = 10)] limit
     * @param {Array.<String>} [name] name
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [pubchemCid] pubchemCid
     * @param {module:api/DrugsApi~getDrugsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Drugs}
     */
    getDrugsUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'chemblId': this.apiClient.buildCollectionParam(opts['chemblId'], 'multi'),
        ...
        'page': opts['page'],
        'pubchemCid': this.apiClient.buildCollectionParam(opts['pubchemCid'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
