...
/**
* PubChemBioassaySids service.
* @module api/PubChemBioassaySidsApi
* @version 1.0
*/
export default class PubChemBioassaySidsApi {

    /**
    * Constructs a new PubChemBioassaySidsApi. 
    * @alias module:api/PubChemBioassaySidsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getBioassaysUsingGET1 operation.
     * @callback module:api/PubChemBioassaySidsApi~getBioassaysUsingGET1Callback
     * @param {String} error Error message, if any.
     * @param {module:model/Bioassays} data The data returned by the service call.
     ...
     * @param {Array.<String>} [sids] sids
     * @param {module:api/PubChemBioassaySidsApi~getBioassaysUsingGET1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Bioassays}
     */
    getBioassaysUsingGET1(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'page': opts['page'],
        'sids': this.apiClient.buildCollectionParam(opts['sids'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let returnType = Bioassays;
      return this.apiClient.callApi(
        '/pubchem/bioassays/sids', 'GET',
