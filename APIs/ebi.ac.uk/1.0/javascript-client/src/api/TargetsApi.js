...
export default class TargetsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getTargetsUsingGET operation.
     * @callback module:api/TargetsApi~getTargetsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Targets} data The data returned by the service call.
     ...
     * @param {Array.<String>} [targetIds] targetIds
     * @param {module:api/TargetsApi~getTargetsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Targets}
     */
    getTargetsUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'limit': opts['limit'],
        'page': opts['page'],
        'targetIds': this.apiClient.buildCollectionParam(opts['targetIds'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
