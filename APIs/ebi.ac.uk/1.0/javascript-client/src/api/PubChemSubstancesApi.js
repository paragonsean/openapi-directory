...
/**
* PubChemSubstances service.
* @module api/PubChemSubstancesApi
* @version 1.0
*/
export default class PubChemSubstancesApi {

    /**
    * Constructs a new PubChemSubstancesApi. 
    * @alias module:api/PubChemSubstancesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getSubstancesUsingGET operation.
     * @callback module:api/PubChemSubstancesApi~getSubstancesUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PubchemSubstances} data The data returned by the service call.
     ...
     * @param {Array.<String>} [cid] cid
     * @param {Number} [limit = 10)] limit
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [sid] sid
     * @param {module:api/PubChemSubstancesApi~getSubstancesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PubchemSubstances}
     */
    getSubstancesUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'cid': this.apiClient.buildCollectionParam(opts['cid'], 'multi'),
        'limit': opts['limit'],
        'page': opts['page'],
      ...
      let returnType = PubchemSubstances;
      return this.apiClient.callApi(
        '/pubchem/substances', 'GET',
