...
/**
* Molecules service.
* @module api/MoleculesApi
* @version 1.0
*/
export default class MoleculesApi {

    /**
    * Constructs a new MoleculesApi. 
    * @alias module:api/MoleculesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getMoleculesUsingGET operation.
     * @callback module:api/MoleculesApi~getMoleculesUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Molecules} data The data returned by the service call.
     ...
     * @param {module:api/MoleculesApi~getMoleculesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Molecules}
     */
    getMoleculesUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
