...
/**
* EFODiseaseTerms service.
* @module api/EFODiseaseTermsApi
* @version 1.0
*/
export default class EFODiseaseTermsApi {

    /**
    * Constructs a new EFODiseaseTermsApi. 
    * @alias module:api/EFODiseaseTermsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getEFOUsingGET operation.
     * @callback module:api/EFODiseaseTermsApi~getEFOUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EFOEntities} data The data returned by the service call.
     ...
     * @param {Array.<String>} [doid] doid
     * @param {Array.<String>} [label] label
     * @param {Number} [limit = 10)] limit
     * @param {Array.<String>} [mesh] mesh
     * @param {Array.<String>} [oboId] oboId
     * @param {Array.<String>} [omimId] omimId
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [synonym] synonym
     * @param {module:api/EFODiseaseTermsApi~getEFOUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EFOEntities}
     */
    getEFOUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'doid': this.apiClient.buildCollectionParam(opts['doid'], 'multi'),
        'label': this.apiClient.buildCollectionParam(opts['label'], 'multi'),
        'limit': opts['limit'],
        'mesh': this.apiClient.buildCollectionParam(opts['mesh'], 'multi'),
        'oboId': this.apiClient.buildCollectionParam(opts['oboId'], 'multi'),
        'omimId': this.apiClient.buildCollectionParam(opts['omimId'], 'multi'),
        'page': opts['page'],
        'synonym': this.apiClient.buildCollectionParam(opts['synonym'], 'multi')
      };
      let headerParams = {
      };
      let formParams = {
