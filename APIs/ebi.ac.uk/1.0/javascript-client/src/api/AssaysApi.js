...
/**
* Assays service.
* @module api/AssaysApi
* @version 1.0
*/
export default class AssaysApi {

    /**
    * Constructs a new AssaysApi. 
    * @alias module:api/AssaysApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAssaysUsingGET operation.
     * @callback module:api/AssaysApi~getAssaysUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Assays} data The data returned by the service call.
     ...
     * @param {Array.<String>} [assayOrg] assayOrg
     * @param {Array.<String>} [assayType] assayType
     * @param {Number} [limit = 10)] limit
     * @param {Number} [page = 0)] page
     * @param {Array.<String>} [targetChemblId] targetChemblId
     * @param {module:api/AssaysApi~getAssaysUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Assays}
     */
    getAssaysUsingGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'assayOrg': this.apiClient.buildCollectionParam(opts['assayOrg'], 'multi'),
        'assayType': this.apiClient.buildCollectionParam(opts['assayType'], 'multi'),
        'limit': opts['limit'],
        'page': opts['page'],
