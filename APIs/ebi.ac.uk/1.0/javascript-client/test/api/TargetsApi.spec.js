...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.TargetsApi();
  });
  ...
  describe('TargetsApi', function() {
    describe('getTargetsUsingGET', function() {
      it('should call getTargetsUsingGET successfully', function(done) {
        //uncomment below and update the code to test getTargetsUsingGET
        //instance.getTargetsUsingGET(function(error) {
