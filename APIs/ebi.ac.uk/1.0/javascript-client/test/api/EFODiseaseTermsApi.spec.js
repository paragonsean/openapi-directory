...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.EFODiseaseTermsApi();
  });
  ...
  describe('EFODiseaseTermsApi', function() {
    describe('getEFOUsingGET', function() {
      it('should call getEFOUsingGET successfully', function(done) {
        //uncomment below and update the code to test getEFOUsingGET
        //instance.getEFOUsingGET(function(error) {
