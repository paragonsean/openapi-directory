...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubChemBiossaysApi();
  });
  ...
  describe('PubChemBiossaysApi', function() {
    describe('getBioassaysUsingGET', function() {
      it('should call getBioassaysUsingGET successfully', function(done) {
        //uncomment below and update the code to test getBioassaysUsingGET
        //instance.getBioassaysUsingGET(function(error) {
