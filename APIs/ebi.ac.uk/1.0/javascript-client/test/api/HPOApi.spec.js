...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.HPOApi();
  });
  ...
  describe('HPOApi', function() {
    describe('getHpoUsingGET', function() {
      it('should call getHpoUsingGET successfully', function(done) {
        //uncomment below and update the code to test getHpoUsingGET
        //instance.getHpoUsingGET(function(error) {
