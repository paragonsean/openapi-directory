...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.ProteinsApi();
  });
  ...
  describe('ProteinsApi', function() {
    describe('getProteinsUsingGET', function() {
      it('should call getProteinsUsingGET successfully', function(done) {
        //uncomment below and update the code to test getProteinsUsingGET
        //instance.getProteinsUsingGET(function(error) {
