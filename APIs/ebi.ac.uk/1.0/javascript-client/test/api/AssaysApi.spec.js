...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.AssaysApi();
  });
  ...
  describe('AssaysApi', function() {
    describe('getAssaysUsingGET', function() {
      it('should call getAssaysUsingGET successfully', function(done) {
        //uncomment below and update the code to test getAssaysUsingGET
        //instance.getAssaysUsingGET(function(error) {
