...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.DrugsApi();
  });
  ...
  describe('DrugsApi', function() {
    describe('getDrugsUsingGET', function() {
      it('should call getDrugsUsingGET successfully', function(done) {
        //uncomment below and update the code to test getDrugsUsingGET
        //instance.getDrugsUsingGET(function(error) {
