...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.IntactApi();
  });
  ...
  describe('IntactApi', function() {
    describe('getIntactUsingGET', function() {
      it('should call getIntactUsingGET successfully', function(done) {
        //uncomment below and update the code to test getIntactUsingGET
        //instance.getIntactUsingGET(function(error) {
