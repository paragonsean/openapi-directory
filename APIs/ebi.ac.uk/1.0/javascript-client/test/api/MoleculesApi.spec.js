...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.MoleculesApi();
  });
  ...
  describe('MoleculesApi', function() {
    describe('getMoleculesUsingGET', function() {
      it('should call getMoleculesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getMoleculesUsingGET
        //instance.getMoleculesUsingGET(function(error) {
