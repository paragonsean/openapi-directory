...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubChemSubstancesApi();
  });
  ...
  describe('PubChemSubstancesApi', function() {
    describe('getSubstancesUsingGET', function() {
      it('should call getSubstancesUsingGET successfully', function(done) {
        //uncomment below and update the code to test getSubstancesUsingGET
        //instance.getSubstancesUsingGET(function(error) {
