...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubChemCompoundsApi();
  });
  ...
  describe('PubChemCompoundsApi', function() {
    describe('getCompoundsUsingGET', function() {
      it('should call getCompoundsUsingGET successfully', function(done) {
        //uncomment below and update the code to test getCompoundsUsingGET
        //instance.getCompoundsUsingGET(function(error) {
