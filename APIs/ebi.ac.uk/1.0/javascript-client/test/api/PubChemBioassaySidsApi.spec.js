...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubChemBioassaySidsApi();
  });
  ...
  describe('PubChemBioassaySidsApi', function() {
    describe('getBioassaysUsingGET1', function() {
      it('should call getBioassaysUsingGET1 successfully', function(done) {
        //uncomment below and update the code to test getBioassaysUsingGET1
        //instance.getBioassaysUsingGET1(function(error) {
