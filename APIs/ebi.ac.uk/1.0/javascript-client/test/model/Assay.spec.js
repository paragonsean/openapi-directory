...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Assay();
  });
  ...
  describe('Assay', function() {
    it('should create an instance of Assay', function() {
      // uncomment below and update the code to test Assay
      //var instance = new CrOssBarDataApi.Assay();
      //expect(instance).to.be.a(CrOssBarDataApi.Assay);
    });
    ...
    it('should have the property assayId (base name: "assay_id")', function() {
      // uncomment below and update the code to test the property assayId
      //var instance = new CrOssBarDataApi.Assay();
      //expect(instance).to.be();
    });

    it('should have the property assayOrganism (base name: "assay_organism")', function() {
      // uncomment below and update the code to test the property assayOrganism
      //var instance = new CrOssBarDataApi.Assay();
      //expect(instance).to.be();
    });

    it('should have the property assayType (base name: "assay_type")', function() {
      // uncomment below and update the code to test the property assayType
      //var instance = new CrOssBarDataApi.Assay();
      //expect(instance).to.be();
    });
