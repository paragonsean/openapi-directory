...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.AssayData();
  });
  ...
  describe('AssayData', function() {
    it('should create an instance of AssayData', function() {
      // uncomment below and update the code to test AssayData
      //var instance = new CrOssBarDataApi.AssayData();
      //expect(instance).to.be.a(CrOssBarDataApi.AssayData);
    });

    it('should have the property standardType (base name: "standard_type")', function() {
