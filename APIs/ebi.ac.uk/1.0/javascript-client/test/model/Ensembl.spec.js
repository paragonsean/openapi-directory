...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Ensembl();
  });
  ...
  describe('Ensembl', function() {
    it('should create an instance of Ensembl', function() {
      // uncomment below and update the code to test Ensembl
      //var instance = new CrOssBarDataApi.Ensembl();
      //expect(instance).to.be.a(CrOssBarDataApi.Ensembl);
    });
    ...
    it('should have the property isoform (base name: "isoform")', function() {
      // uncomment below and update the code to test the property isoform
      //var instance = new CrOssBarDataApi.Ensembl();
      //expect(instance).to.be();
    });

    it('should have the property proteinSequenceId (base name: "proteinSequenceId")', function() {
      // uncomment below and update the code to test the property proteinSequenceId
      //var instance = new CrOssBarDataApi.Ensembl();
      //expect(instance).to.be();
    });
