...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.BioAssayMetaData();
  });
  ...
  describe('BioAssayMetaData', function() {
    it('should create an instance of BioAssayMetaData', function() {
      // uncomment below and update the code to test BioAssayMetaData
      //var instance = new CrOssBarDataApi.BioAssayMetaData();
      //expect(instance).to.be.a(CrOssBarDataApi.BioAssayMetaData);
    });

    it('should have the property bioAssay (base name: "bioAssay")', function() {
      // uncomment below and update the code to test the property bioAssay
      //var instance = new CrOssBarDataApi.BioAssayMetaData();
      //expect(instance).to.be();
    });

    it('should have the property sidRelatedData (base name: "sidRelatedData")', function() {
      // uncomment below and update the code to test the property sidRelatedData
      //var instance = new CrOssBarDataApi.BioAssayMetaData();
      //expect(instance).to.be();
    });
