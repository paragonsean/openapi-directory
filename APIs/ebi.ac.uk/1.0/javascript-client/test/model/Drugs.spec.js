...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Drugs();
  });
  ...
  describe('Drugs', function() {
    it('should create an instance of Drugs', function() {
      // uncomment below and update the code to test Drugs
      //var instance = new CrOssBarDataApi.Drugs();
      //expect(instance).to.be.a(CrOssBarDataApi.Drugs);
    });
