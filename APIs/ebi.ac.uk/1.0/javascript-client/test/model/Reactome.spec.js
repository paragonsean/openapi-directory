...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Reactome();
  });
  ...
  describe('Reactome', function() {
    it('should create an instance of Reactome', function() {
      // uncomment below and update the code to test Reactome
      //var instance = new CrOssBarDataApi.Reactome();
      //expect(instance).to.be.a(CrOssBarDataApi.Reactome);
    });
    ...
    it('should have the property pathwayName (base name: "pathwayName")', function() {
      // uncomment below and update the code to test the property pathwayName
      //var instance = new CrOssBarDataApi.Reactome();
      //expect(instance).to.be();
    });
