...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.VariationAssociation();
  });
  ...
  describe('VariationAssociation', function() {
    it('should create an instance of VariationAssociation', function() {
      // uncomment below and update the code to test VariationAssociation
      //var instance = new CrOssBarDataApi.VariationAssociation();
      //expect(instance).to.be.a(CrOssBarDataApi.VariationAssociation);
    });
