...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossbarProteinVariation();
  });
  ...
  describe('CrossbarProteinVariation', function() {
    it('should create an instance of CrossbarProteinVariation', function() {
      // uncomment below and update the code to test CrossbarProteinVariation
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossbarProteinVariation);
    });

    it('should have the property alternativeSequence (base name: "alternativeSequence")', function() {
      // uncomment below and update the code to test the property alternativeSequence
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
    ...
    it('should have the property clinicalSignificances (base name: "clinicalSignificances")', function() {
      // uncomment below and update the code to test the property clinicalSignificances
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ftId (base name: "ftId")', function() {
      // uncomment below and update the code to test the property ftId
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
      //expect(instance).to.be();
    });

    it('should have the property somaticStatus (base name: "somaticStatus")', function() {
      // uncomment below and update the code to test the property somaticStatus
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wildType (base name: "wildType")', function() {
      // uncomment below and update the code to test the property wildType
      //var instance = new CrOssBarDataApi.CrossbarProteinVariation();
      //expect(instance).to.be();
    });
