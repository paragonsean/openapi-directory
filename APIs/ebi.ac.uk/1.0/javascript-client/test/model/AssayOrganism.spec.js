...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.AssayOrganism();
  });
  ...
  describe('AssayOrganism', function() {
    it('should create an instance of AssayOrganism', function() {
      // uncomment below and update the code to test AssayOrganism
      //var instance = new CrOssBarDataApi.AssayOrganism();
      //expect(instance).to.be.a(CrOssBarDataApi.AssayOrganism);
    });

    it('should have the property dbObjectId (base name: "db_object_id")', function() {
      // uncomment below and update the code to test the property dbObjectId
      //var instance = new CrOssBarDataApi.AssayOrganism();
