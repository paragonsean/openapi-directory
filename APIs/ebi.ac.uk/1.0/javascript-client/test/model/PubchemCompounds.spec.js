...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubchemCompounds();
  });
  ...
  describe('PubchemCompounds', function() {
    it('should create an instance of PubchemCompounds', function() {
      // uncomment below and update the code to test PubchemCompounds
      //var instance = new CrOssBarDataApi.PubchemCompounds();
      //expect(instance).to.be.a(CrOssBarDataApi.PubchemCompounds);
    });

    it('should have the property compounds (base name: "compounds")', function() {
      // uncomment below and update the code to test the property compounds
      //var instance = new CrOssBarDataApi.PubchemCompounds();
