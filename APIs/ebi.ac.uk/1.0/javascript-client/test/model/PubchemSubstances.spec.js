...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PubchemSubstances();
  });
  ...
  describe('PubchemSubstances', function() {
    it('should create an instance of PubchemSubstances', function() {
      // uncomment below and update the code to test PubchemSubstances
      //var instance = new CrOssBarDataApi.PubchemSubstances();
      //expect(instance).to.be.a(CrOssBarDataApi.PubchemSubstances);
    });
    ...
    it('should have the property substances (base name: "substances")', function() {
      // uncomment below and update the code to test the property substances
      //var instance = new CrOssBarDataApi.PubchemSubstances();
      //expect(instance).to.be();
    });
