...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Intact();
  });
  ...
  describe('Intact', function() {
    it('should create an instance of Intact', function() {
      // uncomment below and update the code to test Intact
      //var instance = new CrOssBarDataApi.Intact();
      //expect(instance).to.be.a(CrOssBarDataApi.Intact);
    });
    ...
    it('should have the property interactionAc (base name: "interaction_ac")', function() {
      // uncomment below and update the code to test the property interactionAc
      //var instance = new CrOssBarDataApi.Intact();
      //expect(instance).to.be();
    });

    it('should have the property interactorA (base name: "interactor_a")', function() {
      // uncomment below and update the code to test the property interactorA
      //var instance = new CrOssBarDataApi.Intact();
      //expect(instance).to.be();
    });

    it('should have the property interactorB (base name: "interactor_b")', function() {
      // uncomment below and update the code to test the property interactorB
      //var instance = new CrOssBarDataApi.Intact();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceDb (base name: "source_db")', function() {
      // uncomment below and update the code to test the property sourceDb
      //var instance = new CrOssBarDataApi.Intact();
      //expect(instance).to.be();
    });
