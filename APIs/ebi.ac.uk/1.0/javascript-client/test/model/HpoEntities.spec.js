...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.HpoEntities();
  });
  ...
  describe('HpoEntities', function() {
    it('should create an instance of HpoEntities', function() {
      // uncomment below and update the code to test HpoEntities
      //var instance = new CrOssBarDataApi.HpoEntities();
      //expect(instance).to.be.a(CrOssBarDataApi.HpoEntities);
    });

    it('should have the property hpo (base name: "hpo")', function() {
      // uncomment below and update the code to test the property hpo
      //var instance = new CrOssBarDataApi.HpoEntities();
      //expect(instance).to.be();
    });

    it('should have the property pageMeta (base name: "pageMeta")', function() {
      // uncomment below and update the code to test the property pageMeta
      //var instance = new CrOssBarDataApi.HpoEntities();
      //expect(instance).to.be();
    });
