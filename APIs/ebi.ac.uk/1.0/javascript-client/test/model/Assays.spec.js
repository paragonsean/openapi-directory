...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Assays();
  });
  ...
  describe('Assays', function() {
    it('should create an instance of Assays', function() {
      // uncomment below and update the code to test Assays
      //var instance = new CrOssBarDataApi.Assays();
      //expect(instance).to.be.a(CrOssBarDataApi.Assays);
    });

    it('should have the property assays (base name: "assays")', function() {
      // uncomment below and update the code to test the property assays
      //var instance = new CrOssBarDataApi.Assays();
