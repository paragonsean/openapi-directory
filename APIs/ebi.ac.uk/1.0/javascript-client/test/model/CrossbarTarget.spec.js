...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossbarTarget();
  });
  ...
  describe('CrossbarTarget', function() {
    it('should create an instance of CrossbarTarget', function() {
      // uncomment below and update the code to test CrossbarTarget
      //var instance = new CrOssBarDataApi.CrossbarTarget();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossbarTarget);
    });
