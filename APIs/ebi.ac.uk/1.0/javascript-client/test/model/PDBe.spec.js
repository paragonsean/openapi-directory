...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PDBe();
  });
  ...
  describe('PDBe', function() {
    it('should create an instance of PDBe', function() {
      // uncomment below and update the code to test PDBe
      //var instance = new CrOssBarDataApi.PDBe();
      //expect(instance).to.be.a(CrOssBarDataApi.PDBe);
    });
