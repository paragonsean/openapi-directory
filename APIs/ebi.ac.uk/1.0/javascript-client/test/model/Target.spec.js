...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Target();
  });
  ...
  describe('Target', function() {
    it('should create an instance of Target', function() {
      ...
      //var instance = new CrOssBarDataApi.Target();
      //expect(instance).to.be.a(CrOssBarDataApi.Target);
    });

    it('should have the property accessions (base name: "accessions")', function() {
      // uncomment below and update the code to test the property accessions
      //var instance = new CrOssBarDataApi.Target();
    ...
    it('should have the property organism (base name: "organism")', function() {
      // uncomment below and update the code to test the property organism
      //var instance = new CrOssBarDataApi.Target();
      //expect(instance).to.be();
    });
