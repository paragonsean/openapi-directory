...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.HitPosition();
  });
  ...
  describe('HitPosition', function() {
    it('should create an instance of HitPosition', function() {
      // uncomment below and update the code to test HitPosition
      //var instance = new CrOssBarDataApi.HitPosition();
      //expect(instance).to.be.a(CrOssBarDataApi.HitPosition);
    });
