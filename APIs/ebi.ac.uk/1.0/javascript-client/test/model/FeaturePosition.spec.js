...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.FeaturePosition();
  });
  ...
  describe('FeaturePosition', function() {
    it('should create an instance of FeaturePosition', function() {
      // uncomment below and update the code to test FeaturePosition
      //var instance = new CrOssBarDataApi.FeaturePosition();
      //expect(instance).to.be.a(CrOssBarDataApi.FeaturePosition);
    });

    it('should have the property ceil (base name: "ceil")', function() {
      // uncomment below and update the code to test the property ceil
      //var instance = new CrOssBarDataApi.FeaturePosition();
    ...
    it('should have the property uncertain (base name: "uncertain")', function() {
      // uncomment below and update the code to test the property uncertain
      //var instance = new CrOssBarDataApi.FeaturePosition();
      //expect(instance).to.be();
    });

    it('should have the property unparsed (base name: "unparsed")', function() {
      // uncomment below and update the code to test the property unparsed
      //var instance = new CrOssBarDataApi.FeaturePosition();
      //expect(instance).to.be();
    });
