...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.VariationEvidenceSource();
  });
  ...
  describe('VariationEvidenceSource', function() {
    it('should create an instance of VariationEvidenceSource', function() {
      // uncomment below and update the code to test VariationEvidenceSource
      //var instance = new CrOssBarDataApi.VariationEvidenceSource();
      //expect(instance).to.be.a(CrOssBarDataApi.VariationEvidenceSource);
    });
