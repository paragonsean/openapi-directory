...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Targets();
  });
  ...
  describe('Targets', function() {
    it('should create an instance of Targets', function() {
      // uncomment below and update the code to test Targets
      //var instance = new CrOssBarDataApi.Targets();
      //expect(instance).to.be.a(CrOssBarDataApi.Targets);
    });
