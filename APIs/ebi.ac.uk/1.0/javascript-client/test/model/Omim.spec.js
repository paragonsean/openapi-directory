...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Omim();
  });
  ...
  describe('Omim', function() {
    it('should create an instance of Omim', function() {
      // uncomment below and update the code to test Omim
      //var instance = new CrOssBarDataApi.Omim();
      //expect(instance).to.be.a(CrOssBarDataApi.Omim);
    });
