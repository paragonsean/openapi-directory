...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossbarMolecule();
  });
  ...
  describe('CrossbarMolecule', function() {
    it('should create an instance of CrossbarMolecule', function() {
      // uncomment below and update the code to test CrossbarMolecule
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossbarMolecule);
    });

    it('should have the property alogp (base name: "alogp")', function() {
      // uncomment below and update the code to test the property alogp
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property canonicalSmiles (base name: "canonical_smiles")', function() {
      // uncomment below and update the code to test the property canonicalSmiles
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property chirality (base name: "chirality")', function() {
      // uncomment below and update the code to test the property chirality
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property fullMwt (base name: "full_mwt")', function() {
      // uncomment below and update the code to test the property fullMwt
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property heavyAtomsCount (base name: "heavy_atoms_count")', function() {
      // uncomment below and update the code to test the property heavyAtomsCount
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property inchiKey (base name: "inchi_key")', function() {
      // uncomment below and update the code to test the property inchiKey
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property maxPhase (base name: "max_phase")', function() {
      // uncomment below and update the code to test the property maxPhase
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property molecularSpecies (base name: "molecular_species")', function() {
      // uncomment below and update the code to test the property molecularSpecies
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property molecularType (base name: "molecular_type")', function() {
      // uncomment below and update the code to test the property molecularType
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property moleculeChemblId (base name: "molecule_chembl_id")', function() {
      // uncomment below and update the code to test the property moleculeChemblId
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property parentChemblId (base name: "parent_chembl_id")', function() {
      // uncomment below and update the code to test the property parentChemblId
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property prefName (base name: "pref_name")', function() {
      // uncomment below and update the code to test the property prefName
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property prodrug (base name: "prodrug")', function() {
      // uncomment below and update the code to test the property prodrug
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });

    it('should have the property standardInchi (base name: "standard_inchi")', function() {
      // uncomment below and update the code to test the property standardInchi
      //var instance = new CrOssBarDataApi.CrossbarMolecule();
      //expect(instance).to.be();
    });
