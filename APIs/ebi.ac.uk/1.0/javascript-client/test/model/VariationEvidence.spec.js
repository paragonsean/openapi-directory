...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.VariationEvidence();
  });
  ...
  describe('VariationEvidence', function() {
    it('should create an instance of VariationEvidence', function() {
      // uncomment below and update the code to test VariationEvidence
      //var instance = new CrOssBarDataApi.VariationEvidence();
      //expect(instance).to.be.a(CrOssBarDataApi.VariationEvidence);
    });
