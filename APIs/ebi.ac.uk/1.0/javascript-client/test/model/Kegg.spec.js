...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Kegg();
  });
  ...
  describe('Kegg', function() {
    it('should create an instance of Kegg', function() {
      // uncomment below and update the code to test Kegg
      //var instance = new CrOssBarDataApi.Kegg();
      //expect(instance).to.be.a(CrOssBarDataApi.Kegg);
    });
