...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Go();
  });
  ...
  describe('Go', function() {
    it('should create an instance of Go', function() {
      // uncomment below and update the code to test Go
      //var instance = new CrOssBarDataApi.Go();
      //expect(instance).to.be.a(CrOssBarDataApi.Go);
    });
