...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.TargetInfo();
  });
  ...
  describe('TargetInfo', function() {
    it('should create an instance of TargetInfo', function() {
      // uncomment below and update the code to test TargetInfo
      //var instance = new CrOssBarDataApi.TargetInfo();
      //expect(instance).to.be.a(CrOssBarDataApi.TargetInfo);
    });

    it('should have the property ncbiProteinId (base name: "ncbi_protein_id")', function() {
      // uncomment below and update the code to test the property ncbiProteinId
      //var instance = new CrOssBarDataApi.TargetInfo();
    ...
    it('should have the property uniprotAccession (base name: "uniprot_accession")', function() {
      // uncomment below and update the code to test the property uniprotAccession
      //var instance = new CrOssBarDataApi.TargetInfo();
      //expect(instance).to.be();
    });
