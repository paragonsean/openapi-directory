...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossReferences();
  });
  ...
  describe('CrossReferences', function() {
    it('should create an instance of CrossReferences', function() {
      // uncomment below and update the code to test CrossReferences
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossReferences);
    });

    it('should have the property ensembl (base name: "ensembl")', function() {
      // uncomment below and update the code to test the property ensembl
      //var instance = new CrOssBarDataApi.CrossReferences();
    ...
    it('should have the property interpro (base name: "interpro")', function() {
      // uncomment below and update the code to test the property interpro
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property kegg (base name: "kegg")', function() {
      // uncomment below and update the code to test the property kegg
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property omim (base name: "omim")', function() {
      // uncomment below and update the code to test the property omim
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property openTargets (base name: "openTargets")', function() {
      // uncomment below and update the code to test the property openTargets
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property orphanet (base name: "orphanet")', function() {
      // uncomment below and update the code to test the property orphanet
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property pdBe (base name: "pdBe")', function() {
      // uncomment below and update the code to test the property pdBe
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property pfam (base name: "pfam")', function() {
      // uncomment below and update the code to test the property pfam
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });

    it('should have the property reactome (base name: "reactome")', function() {
      // uncomment below and update the code to test the property reactome
      //var instance = new CrOssBarDataApi.CrossReferences();
      //expect(instance).to.be();
    });
