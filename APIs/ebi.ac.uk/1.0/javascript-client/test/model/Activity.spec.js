...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Activity();
  });
  ...
  describe('Activity', function() {
    it('should create an instance of Activity', function() {
      ...
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be.a(CrOssBarDataApi.Activity);
    });

    it('should have the property assayChemblId (base name: "assay_chembl_id")', function() {
      // uncomment below and update the code to test the property assayChemblId
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property dataValidityComment (base name: "data_validity_comment")', function() {
      // uncomment below and update the code to test the property dataValidityComment
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pchemblValue (base name: "pchembl_value")', function() {
      // uncomment below and update the code to test the property pchemblValue
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property standardFlag (base name: "standard_flag")', function() {
      // uncomment below and update the code to test the property standardFlag
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property standardRelation (base name: "standard_relation")', function() {
      // uncomment below and update the code to test the property standardRelation
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property standardUnits (base name: "standard_units")', function() {
      // uncomment below and update the code to test the property standardUnits
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property standardValue (base name: "standard_value")', function() {
      // uncomment below and update the code to test the property standardValue
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });

    it('should have the property targetChemblId (base name: "target_chembl_id")', function() {
      // uncomment below and update the code to test the property targetChemblId
      //var instance = new CrOssBarDataApi.Activity();
      //expect(instance).to.be();
    });
