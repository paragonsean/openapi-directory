...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossbarFeature();
  });
  ...
  describe('CrossbarFeature', function() {
    it('should create an instance of CrossbarFeature', function() {
      // uncomment below and update the code to test CrossbarFeature
      //var instance = new CrOssBarDataApi.CrossbarFeature();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossbarFeature);
    });
