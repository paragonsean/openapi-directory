...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.CrossbarDrug();
  });
  ...
  describe('CrossbarDrug', function() {
    it('should create an instance of CrossbarDrug', function() {
      // uncomment below and update the code to test CrossbarDrug
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be.a(CrOssBarDataApi.CrossbarDrug);
    });
    ...
    it('should have the property chemblId (base name: "chembl_id")', function() {
      // uncomment below and update the code to test the property chemblId
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });
    ...
    it('should have the property keggCid (base name: "kegg_cid")', function() {
      // uncomment below and update the code to test the property keggCid
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });

    it('should have the property moleculeType (base name: "molecule_type")', function() {
      // uncomment below and update the code to test the property moleculeType
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pathway (base name: "pathway")', function() {
      // uncomment below and update the code to test the property pathway
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });

    it('should have the property pbStructures (base name: "pb_structures")', function() {
      // uncomment below and update the code to test the property pbStructures
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pubchemCid (base name: "pubchem_cid")', function() {
      // uncomment below and update the code to test the property pubchemCid
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });

    it('should have the property pubchemSid (base name: "pubchem_sid")', function() {
      // uncomment below and update the code to test the property pubchemSid
      //var instance = new CrOssBarDataApi.CrossbarDrug();
      //expect(instance).to.be();
    });
