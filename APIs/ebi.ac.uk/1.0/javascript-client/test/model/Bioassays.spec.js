...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Bioassays();
  });
  ...
  describe('Bioassays', function() {
    it('should create an instance of Bioassays', function() {
      // uncomment below and update the code to test Bioassays
      //var instance = new CrOssBarDataApi.Bioassays();
      //expect(instance).to.be.a(CrOssBarDataApi.Bioassays);
    });

    it('should have the property bioassays (base name: "bioassays")', function() {
      // uncomment below and update the code to test the property bioassays
      //var instance = new CrOssBarDataApi.Bioassays();
