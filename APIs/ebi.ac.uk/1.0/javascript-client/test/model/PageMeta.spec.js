...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.PageMeta();
  });
  ...
  describe('PageMeta', function() {
    it('should create an instance of PageMeta', function() {
      ...
      //var instance = new CrOssBarDataApi.PageMeta();
      //expect(instance).to.be.a(CrOssBarDataApi.PageMeta);
    });

    it('should have the property currentElements (base name: "currentElements")', function() {
      // uncomment below and update the code to test the property currentElements
      //var instance = new CrOssBarDataApi.PageMeta();
