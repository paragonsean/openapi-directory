...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.BioAssay();
  });
  ...
  describe('BioAssay', function() {
    it('should create an instance of BioAssay', function() {
      // uncomment below and update the code to test BioAssay
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be.a(CrOssBarDataApi.BioAssay);
    });
    ...
    it('should have the property assayOrganisms (base name: "assay_organisms")', function() {
      // uncomment below and update the code to test the property assayOrganisms
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be();
    });
    ...
    it('should have the property chemblXref (base name: "chembl_xref")', function() {
      // uncomment below and update the code to test the property chemblXref
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be();
    });

    it('should have the property proteinName (base name: "protein_name")', function() {
      // uncomment below and update the code to test the property proteinName
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetInfo (base name: "target_info")', function() {
      // uncomment below and update the code to test the property targetInfo
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be();
    });

    it('should have the property targetTypeInfo (base name: "target_type_info")', function() {
      // uncomment below and update the code to test the property targetTypeInfo
      //var instance = new CrOssBarDataApi.BioAssay();
      //expect(instance).to.be();
    });
