...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.OpenTargets();
  });
  ...
  describe('OpenTargets', function() {
    it('should create an instance of OpenTargets', function() {
      // uncomment below and update the code to test OpenTargets
      //var instance = new CrOssBarDataApi.OpenTargets();
      //expect(instance).to.be.a(CrOssBarDataApi.OpenTargets);
    });
