...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.EFOEntities();
  });
  ...
  describe('EFOEntities', function() {
    it('should create an instance of EFOEntities', function() {
      // uncomment below and update the code to test EFOEntities
      //var instance = new CrOssBarDataApi.EFOEntities();
      //expect(instance).to.be.a(CrOssBarDataApi.EFOEntities);
    });

    it('should have the property diseases (base name: "diseases")', function() {
      // uncomment below and update the code to test the property diseases
      //var instance = new CrOssBarDataApi.EFOEntities();
