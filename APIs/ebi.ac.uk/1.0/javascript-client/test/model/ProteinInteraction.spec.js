...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.ProteinInteraction();
  });
  ...
  describe('ProteinInteraction', function() {
    it('should create an instance of ProteinInteraction', function() {
      // uncomment below and update the code to test ProteinInteraction
      //var instance = new CrOssBarDataApi.ProteinInteraction();
      //expect(instance).to.be.a(CrOssBarDataApi.ProteinInteraction);
    });
    ...
    it('should have the property interactors (base name: "interactors")', function() {
      // uncomment below and update the code to test the property interactors
      //var instance = new CrOssBarDataApi.ProteinInteraction();
      //expect(instance).to.be();
    });
