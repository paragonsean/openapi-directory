...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Pfam();
  });
  ...
  describe('Pfam', function() {
    it('should create an instance of Pfam', function() {
      // uncomment below and update the code to test Pfam
      //var instance = new CrOssBarDataApi.Pfam();
      //expect(instance).to.be.a(CrOssBarDataApi.Pfam);
    });

    it('should have the property entryName (base name: "entryName")', function() {
