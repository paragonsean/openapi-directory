...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Orphanet();
  });
  ...
  describe('Orphanet', function() {
    it('should create an instance of Orphanet', function() {
      // uncomment below and update the code to test Orphanet
      //var instance = new CrOssBarDataApi.Orphanet();
      //expect(instance).to.be.a(CrOssBarDataApi.Orphanet);
    });
