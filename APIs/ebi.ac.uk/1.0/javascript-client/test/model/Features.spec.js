...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Features();
  });
  ...
  describe('Features', function() {
    it('should create an instance of Features', function() {
      ...
      //var instance = new CrOssBarDataApi.Features();
      //expect(instance).to.be.a(CrOssBarDataApi.Features);
    });

    it('should have the property activeSite (base name: "active_site")', function() {
      // uncomment below and update the code to test the property activeSite
      //var instance = new CrOssBarDataApi.Features();
      //expect(instance).to.be();
    });

    it('should have the property bindingSite (base name: "binding_site")', function() {
      // uncomment below and update the code to test the property bindingSite
      //var instance = new CrOssBarDataApi.Features();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mutagen (base name: "mutagen")', function() {
      // uncomment below and update the code to test the property mutagen
      //var instance = new CrOssBarDataApi.Features();
      //expect(instance).to.be();
    });
    ...
    it('should have the property topDom (base name: "top_dom")', function() {
      // uncomment below and update the code to test the property topDom
      //var instance = new CrOssBarDataApi.Features();
      //expect(instance).to.be();
    });
