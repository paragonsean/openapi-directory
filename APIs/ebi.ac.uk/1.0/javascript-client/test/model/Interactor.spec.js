...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Interactor();
  });
  ...
  describe('Interactor', function() {
    it('should create an instance of Interactor', function() {
      // uncomment below and update the code to test Interactor
      //var instance = new CrOssBarDataApi.Interactor();
      //expect(instance).to.be.a(CrOssBarDataApi.Interactor);
    });
