...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.GoEvidence();
  });
  ...
  describe('GoEvidence', function() {
    it('should create an instance of GoEvidence', function() {
      // uncomment below and update the code to test GoEvidence
      //var instance = new CrOssBarDataApi.GoEvidence();
      //expect(instance).to.be.a(CrOssBarDataApi.GoEvidence);
    });
