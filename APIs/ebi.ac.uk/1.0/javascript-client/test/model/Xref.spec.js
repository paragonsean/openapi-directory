...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Xref();
  });
  ...
  describe('Xref', function() {
    it('should create an instance of Xref', function() {
      // uncomment below and update the code to test Xref
      //var instance = new CrOssBarDataApi.Xref();
      //expect(instance).to.be.a(CrOssBarDataApi.Xref);
    });
