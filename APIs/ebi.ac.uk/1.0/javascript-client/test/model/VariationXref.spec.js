...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.VariationXref();
  });
  ...
  describe('VariationXref', function() {
    it('should create an instance of VariationXref', function() {
      // uncomment below and update the code to test VariationXref
      //var instance = new CrOssBarDataApi.VariationXref();
      //expect(instance).to.be.a(CrOssBarDataApi.VariationXref);
    });
