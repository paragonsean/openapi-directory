...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.IntactInteractions();
  });
  ...
  describe('IntactInteractions', function() {
    it('should create an instance of IntactInteractions', function() {
      // uncomment below and update the code to test IntactInteractions
      //var instance = new CrOssBarDataApi.IntactInteractions();
      //expect(instance).to.be.a(CrOssBarDataApi.IntactInteractions);
    });
