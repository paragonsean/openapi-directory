...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Proteins();
  });
  ...
  describe('Proteins', function() {
    it('should create an instance of Proteins', function() {
      // uncomment below and update the code to test Proteins
      //var instance = new CrOssBarDataApi.Proteins();
      //expect(instance).to.be.a(CrOssBarDataApi.Proteins);
    });
