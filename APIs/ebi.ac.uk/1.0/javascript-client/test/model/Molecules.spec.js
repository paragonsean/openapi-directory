...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Molecules();
  });
  ...
  describe('Molecules', function() {
    it('should create an instance of Molecules', function() {
      // uncomment below and update the code to test Molecules
      //var instance = new CrOssBarDataApi.Molecules();
      //expect(instance).to.be.a(CrOssBarDataApi.Molecules);
    });

    it('should have the property molecules (base name: "molecules")', function() {
      // uncomment below and update the code to test the property molecules
      //var instance = new CrOssBarDataApi.Molecules();
