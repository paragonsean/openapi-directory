...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.SidRelatedData();
  });
  ...
  describe('SidRelatedData', function() {
    it('should create an instance of SidRelatedData', function() {
      // uncomment below and update the code to test SidRelatedData
      //var instance = new CrOssBarDataApi.SidRelatedData();
      //expect(instance).to.be.a(CrOssBarDataApi.SidRelatedData);
    });

    it('should have the property assayData (base name: "assay_data")', function() {
      // uncomment below and update the code to test the property assayData
      //var instance = new CrOssBarDataApi.SidRelatedData();
      //expect(instance).to.be();
    });

    it('should have the property assayPubchemId (base name: "assay_pubchem_id")', function() {
      // uncomment below and update the code to test the property assayPubchemId
      //var instance = new CrOssBarDataApi.SidRelatedData();
      //expect(instance).to.be();
    });
