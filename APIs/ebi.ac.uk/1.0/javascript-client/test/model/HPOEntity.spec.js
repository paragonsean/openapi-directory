...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.HPOEntity();
  });
  ...
  describe('HPOEntity', function() {
    it('should create an instance of HPOEntity', function() {
      // uncomment below and update the code to test HPOEntity
      //var instance = new CrOssBarDataApi.HPOEntity();
      //expect(instance).to.be.a(CrOssBarDataApi.HPOEntity);
    });

    it('should have the property dbReferences (base name: "db_references")', function() {
      // uncomment below and update the code to test the property dbReferences
      //var instance = new CrOssBarDataApi.HPOEntity();
    ...
    it('should have the property hpoId (base name: "hpo_id")', function() {
      // uncomment below and update the code to test the property hpoId
      //var instance = new CrOssBarDataApi.HPOEntity();
      //expect(instance).to.be();
    });
