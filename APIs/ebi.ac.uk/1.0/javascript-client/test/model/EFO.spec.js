...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.EFO();
  });
  ...
  describe('EFO', function() {
    it('should create an instance of EFO', function() {
      // uncomment below and update the code to test EFO
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be.a(CrOssBarDataApi.EFO);
    });
    ...
    it('should have the property doid (base name: "doid")', function() {
      // uncomment below and update the code to test the property doid
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });

    it('should have the property icd9 (base name: "icd9")', function() {
      // uncomment below and update the code to test the property icd9
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ncit (base name: "ncit")', function() {
      // uncomment below and update the code to test the property ncit
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });

    it('should have the property oboId (base name: "obo_id")', function() {
      // uncomment below and update the code to test the property oboId
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property shortForm (base name: "short_form")', function() {
      // uncomment below and update the code to test the property shortForm
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });

    it('should have the property snowmed (base name: "snowmed")', function() {
      // uncomment below and update the code to test the property snowmed
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property umls (base name: "umls")', function() {
      // uncomment below and update the code to test the property umls
      //var instance = new CrOssBarDataApi.EFO();
      //expect(instance).to.be();
    });
