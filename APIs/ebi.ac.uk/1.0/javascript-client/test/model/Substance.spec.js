...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrOssBarDataApi.Substance();
  });
  ...
  describe('Substance', function() {
    it('should create an instance of Substance', function() {
      ...
      //var instance = new CrOssBarDataApi.Substance();
      //expect(instance).to.be.a(CrOssBarDataApi.Substance);
    });

    it('should have the property chemblCmpdXref (base name: "chembl_cmpd_xref")', function() {
      // uncomment below and update the code to test the property chemblCmpdXref
      //var instance = new CrOssBarDataApi.Substance();
