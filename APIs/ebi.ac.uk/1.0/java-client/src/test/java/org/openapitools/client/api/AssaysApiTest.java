...
/**
 * API tests for AssaysApi
 */
@Disabled
public class AssaysApiTest {

    private final AssaysApi api = new AssaysApi();
     ...
     */
    @Test
    public void getAssaysUsingGETTest() throws ApiException {
        List<String> assayChemblId = null;
        List<String> assayOrg = null;
        List<String> assayType = null;
        Integer limit = null;
        Integer page = null;
        List<String> targetChemblId = null;
        Assays response = api.getAssaysUsingGET(assayChemblId, assayOrg, assayType, limit, page, targetChemblId);
