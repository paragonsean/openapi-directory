...
import org.openapitools.client.model.Molecules;
...
/**
 * API tests for MoleculesApi
 */
@Disabled
public class MoleculesApiTest {

    private final MoleculesApi api = new MoleculesApi();
     ...
     */
    @Test
    public void getMoleculesUsingGETTest() throws ApiException {
        List<String> canonicalSmiles = null;
        List<String> inchiKey = null;
        Integer limit = null;
        List<String> moleculeChemblId = null;
        Integer page = null;
        Molecules response = api.getMoleculesUsingGET(canonicalSmiles, inchiKey, limit, moleculeChemblId, page);
