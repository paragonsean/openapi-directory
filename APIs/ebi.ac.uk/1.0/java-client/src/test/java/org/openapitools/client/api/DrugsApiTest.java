...
import org.openapitools.client.model.Drugs;
...
public class DrugsApiTest {
     ...
     */
    @Test
    public void getDrugsUsingGETTest() throws ApiException {
        List<String> accession = null;
        List<String> chemblId = null;
        List<String> identifier = null;
        Integer limit = null;
        List<String> name = null;
        Integer page = null;
        List<String> pubchemCid = null;
        Drugs response = api.getDrugsUsingGET(accession, chemblId, identifier, limit, name, page, pubchemCid);
