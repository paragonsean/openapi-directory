...
/**
 * API tests for PubChemCompoundsApi
 */
@Disabled
public class PubChemCompoundsApiTest {

    private final PubChemCompoundsApi api = new PubChemCompoundsApi();
     ...
     */
    @Test
    public void getCompoundsUsingGETTest() throws ApiException {
        List<String> canonicalSmiles = null;
        List<String> cid = null;
        List<String> inchiKey = null;
        Integer limit = null;
        Integer page = null;
        PubchemCompounds response = api.getCompoundsUsingGET(canonicalSmiles, cid, inchiKey, limit, page);
