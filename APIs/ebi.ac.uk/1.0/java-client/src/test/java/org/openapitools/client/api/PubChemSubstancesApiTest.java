...
/**
 * API tests for PubChemSubstancesApi
 */
@Disabled
public class PubChemSubstancesApiTest {

    private final PubChemSubstancesApi api = new PubChemSubstancesApi();
     ...
     */
    @Test
    public void getSubstancesUsingGETTest() throws ApiException {
        List<String> cid = null;
        Integer limit = null;
        Integer page = null;
        List<String> sid = null;
        PubchemSubstances response = api.getSubstancesUsingGET(cid, limit, page, sid);
