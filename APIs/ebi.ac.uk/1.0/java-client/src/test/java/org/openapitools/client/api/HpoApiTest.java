...
import org.openapitools.client.model.HpoEntities;
...
/**
 * API tests for HpoApi
 */
@Disabled
public class HpoApiTest {

    private final HpoApi api = new HpoApi();
     ...
     */
    @Test
    public void getHpoUsingGETTest() throws ApiException {
        List<String> genesymbol = null;
        List<String> hpotermname = null;
        Integer limit = null;
        Integer page = null;
        List<String> synonym = null;
        HpoEntities response = api.getHpoUsingGET(genesymbol, hpotermname, limit, page, synonym);
