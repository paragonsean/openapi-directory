...
import org.openapitools.client.model.EFOEntities;
...
/**
 * API tests for EfoDiseaseTermsApi
 */
@Disabled
public class EfoDiseaseTermsApiTest {

    private final EfoDiseaseTermsApi api = new EfoDiseaseTermsApi();
     ...
     */
    @Test
    public void getEFOUsingGETTest() throws ApiException {
        List<String> doid = null;
        List<String> label = null;
        Integer limit = null;
        List<String> mesh = null;
        List<String> oboId = null;
        List<String> omimId = null;
        Integer page = null;
        List<String> synonym = null;
        EFOEntities response = api.getEFOUsingGET(doid, label, limit, mesh, oboId, omimId, page, synonym);
