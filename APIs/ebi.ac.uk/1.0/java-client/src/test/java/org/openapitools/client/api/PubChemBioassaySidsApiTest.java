...
/**
 * API tests for PubChemBioassaySidsApi
 */
@Disabled
public class PubChemBioassaySidsApiTest {

    private final PubChemBioassaySidsApi api = new PubChemBioassaySidsApi();
     ...
     */
    @Test
    public void getBioassaysUsingGET1Test() throws ApiException {
        Integer limit = null;
        String outcome = null;
        Integer page = null;
        List<String> sids = null;
        Bioassays response = api.getBioassaysUsingGET1(limit, outcome, page, sids);
