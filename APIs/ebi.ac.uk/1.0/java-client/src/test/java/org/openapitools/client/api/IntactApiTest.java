...
/**
 * API tests for IntactApi
 */
@Disabled
public class IntactApiTest {

    private final IntactApi api = new IntactApi();
     ...
     */
    @Test
    public void getIntactUsingGETTest() throws ApiException {
        List<String> accession = null;
        Double confidence = null;
        List<String> gene = null;
        Integer limit = null;
        Integer page = null;
        IntactInteractions response = api.getIntactUsingGET(accession, confidence, gene, limit, page);
