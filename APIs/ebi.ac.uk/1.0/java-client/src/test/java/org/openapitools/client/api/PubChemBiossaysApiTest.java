...
import org.openapitools.client.model.Bioassays;
...
/**
 * API tests for PubChemBiossaysApi
 */
@Disabled
public class PubChemBiossaysApiTest {

    private final PubChemBiossaysApi api = new PubChemBiossaysApi();
     ...
     */
    @Test
    public void getBioassaysUsingGETTest() throws ApiException {
        List<String> accession = null;
        List<String> assayPubchemId = null;
        Integer limit = null;
        List<String> ncbiProteinId = null;
        Integer page = null;
        Bioassays response = api.getBioassaysUsingGET(accession, assayPubchemId, limit, ncbiProteinId, page);
