...
/**
 * API tests for ProteinsApi
 */
@Disabled
public class ProteinsApiTest {

    private final ProteinsApi api = new ProteinsApi();
     ...
     */
    @Test
    public void getProteinsUsingGETTest() throws ApiException {
        List<String> accession = null;
        List<String> ec = null;
        List<String> fullName = null;
        List<String> gene = null;
        List<String> go = null;
        List<String> interpro = null;
        Integer limit = null;
        List<String> omim = null;
        List<String> orphanet = null;
        Integer page = null;
        List<String> pfam = null;
        List<String> reactome = null;
        List<Integer> taxId = null;
        Proteins response = api.getProteinsUsingGET(accession, ec, fullName, gene, go, interpro, limit, omim, orphanet, page, pfam, reactome, taxId);
