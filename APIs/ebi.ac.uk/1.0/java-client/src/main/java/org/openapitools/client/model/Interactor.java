...
public class Interactor {
  ...
  public Interactor accession(String accession) {
  ...
  public Interactor gene(String gene) {
    this.gene = gene;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accession, interactor.accession) &&
        Objects.equals(this.gene, interactor.gene);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accession, gene);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Interactor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Interactor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Interactor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Interactor is not found in the empty JSON string", Interactor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Interactor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Interactor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("gene") != null && !jsonObj.get("gene").isJsonNull()) && !jsonObj.get("gene").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `gene` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gene").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Interactor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Interactor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Interactor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Interactor.class));

       return (TypeAdapter<T>) new TypeAdapter<Interactor>() {
           @Override
           public void write(JsonWriter out, Interactor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Interactor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Interactor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Interactor
   * @throws IOException if the JSON string is invalid with respect to Interactor
   */
  public static Interactor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Interactor.class);
  }

  /**
   * Convert an instance of Interactor to an JSON string
   *
   * @return JSON string
   */
