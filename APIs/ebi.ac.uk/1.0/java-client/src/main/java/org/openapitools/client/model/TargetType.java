...
public class TargetType {
  ...
  public TargetType moleculeType(String moleculeType) {
  ...
  public TargetType value(Integer value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.moleculeType, targetType.moleculeType) &&
        Objects.equals(this.value, targetType.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(moleculeType, value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetType is not found in the empty JSON string", TargetType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetType.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetType>() {
           @Override
           public void write(JsonWriter out, TargetType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetType
   * @throws IOException if the JSON string is invalid with respect to TargetType
   */
  public static TargetType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetType.class);
  }

  /**
   * Convert an instance of TargetType to an JSON string
   *
   * @return JSON string
   */
