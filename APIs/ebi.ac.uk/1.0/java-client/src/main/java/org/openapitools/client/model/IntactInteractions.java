...
import org.openapitools.client.model.Intact;
...
public class IntactInteractions {
  public static final String SERIALIZED_NAME_INTERACTIONS = "interactions";
  @SerializedName(SERIALIZED_NAME_INTERACTIONS)
  private List<Intact> interactions = new ArrayList<>();

  public static final String SERIALIZED_NAME_PAGE_META = "pageMeta";
  @SerializedName(SERIALIZED_NAME_PAGE_META)
  private PageMeta pageMeta;

  public IntactInteractions() {
  }

  public IntactInteractions interactions(List<Intact> interactions) {
    this.interactions = interactions;
    return this;
  }

  public IntactInteractions addInteractionsItem(Intact interactionsItem) {
  ...
  public List<Intact> getInteractions() {
    return interactions;
  }

  public void setInteractions(List<Intact> interactions) {
    this.interactions = interactions;
  }


  public IntactInteractions pageMeta(PageMeta pageMeta) {
  ...
  public boolean equals(Object o) {
    ...
    IntactInteractions intactInteractions = (IntactInteractions) o;
    return Objects.equals(this.interactions, intactInteractions.interactions) &&
        Objects.equals(this.pageMeta, intactInteractions.pageMeta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(interactions, pageMeta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IntactInteractions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntactInteractions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntactInteractions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntactInteractions is not found in the empty JSON string", IntactInteractions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntactInteractions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntactInteractions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("interactions") != null && !jsonObj.get("interactions").isJsonNull()) {
        ...
        if (jsonArrayinteractions != null) {
          ...
          for (int i = 0; i < jsonArrayinteractions.size(); i++) {
            Intact.validateJsonElement(jsonArrayinteractions.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntactInteractions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntactInteractions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntactInteractions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntactInteractions.class));

       return (TypeAdapter<T>) new TypeAdapter<IntactInteractions>() {
           @Override
           public void write(JsonWriter out, IntactInteractions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntactInteractions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntactInteractions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntactInteractions
   * @throws IOException if the JSON string is invalid with respect to IntactInteractions
   */
  public static IntactInteractions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntactInteractions.class);
  }

  /**
   * Convert an instance of IntactInteractions to an JSON string
   *
   * @return JSON string
   */
