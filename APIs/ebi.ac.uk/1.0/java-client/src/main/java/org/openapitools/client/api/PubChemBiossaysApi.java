...
public class PubChemBiossaysApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PubChemBiossaysApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PubChemBiossaysApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getBioassaysUsingGET
     * @param accession accession (optional)
     * @param assayPubchemId assayPubchemId (optional)
     * @param limit limit (optional, default to 1)
     * @param ncbiProteinId ncbiProteinId (optional)
     ...
     */
    public okhttp3.Call getBioassaysUsingGETCall(List<String> accession, List<String> assayPubchemId, Integer limit, List<String> ncbiProteinId, Integer page, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/pubchem/bioassays";
        ...
        if (assayPubchemId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "assayPubchemId", assayPubchemId));
        }
        ...
        if (ncbiProteinId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "ncbiProteinId", ncbiProteinId));
        }
    ...
    private okhttp3.Call getBioassaysUsingGETValidateBeforeCall(List<String> accession, List<String> assayPubchemId, Integer limit, List<String> ncbiProteinId, Integer page, final ApiCallback _callback) throws ApiException {
        return getBioassaysUsingGETCall(accession, assayPubchemId, limit, ncbiProteinId, page, _callback);
     ...
     */
    public Bioassays getBioassaysUsingGET(List<String> accession, List<String> assayPubchemId, Integer limit, List<String> ncbiProteinId, Integer page) throws ApiException {
        ApiResponse<Bioassays> localVarResp = getBioassaysUsingGETWithHttpInfo(accession, assayPubchemId, limit, ncbiProteinId, page);
     ...
     */
    public ApiResponse<Bioassays> getBioassaysUsingGETWithHttpInfo(List<String> accession, List<String> assayPubchemId, Integer limit, List<String> ncbiProteinId, Integer page) throws ApiException {
        okhttp3.Call localVarCall = getBioassaysUsingGETValidateBeforeCall(accession, assayPubchemId, limit, ncbiProteinId, page, null);
        Type localVarReturnType = new TypeToken<Bioassays>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get pubchem bioassays (asynchronously)
     * 
     * @param accession accession (optional)
     * @param assayPubchemId assayPubchemId (optional)
     * @param limit limit (optional, default to 1)
     ...
     */
    public okhttp3.Call getBioassaysUsingGETAsync(List<String> accession, List<String> assayPubchemId, Integer limit, List<String> ncbiProteinId, Integer page, final ApiCallback<Bioassays> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBioassaysUsingGETValidateBeforeCall(accession, assayPubchemId, limit, ncbiProteinId, page, _callback);
        Type localVarReturnType = new TypeToken<Bioassays>(){}.getType();
