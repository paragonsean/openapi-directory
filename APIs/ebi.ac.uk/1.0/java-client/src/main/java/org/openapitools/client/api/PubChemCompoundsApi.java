...
import org.openapitools.client.model.PubchemCompounds;
...
public class PubChemCompoundsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PubChemCompoundsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PubChemCompoundsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getCompoundsUsingGET
     * @param canonicalSmiles canonicalSmiles (optional)
     * @param cid cid (optional)
     * @param inchiKey inchiKey (optional)
     ...
     */
    public okhttp3.Call getCompoundsUsingGETCall(List<String> canonicalSmiles, List<String> cid, List<String> inchiKey, Integer limit, Integer page, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/pubchem/compounds";
        ...
        if (canonicalSmiles != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "canonicalSmiles", canonicalSmiles));
        }

        if (cid != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "cid", cid));
        }

        if (inchiKey != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "inchiKey", inchiKey));
        }
    ...
    private okhttp3.Call getCompoundsUsingGETValidateBeforeCall(List<String> canonicalSmiles, List<String> cid, List<String> inchiKey, Integer limit, Integer page, final ApiCallback _callback) throws ApiException {
        return getCompoundsUsingGETCall(canonicalSmiles, cid, inchiKey, limit, page, _callback);
     ...
     */
    public PubchemCompounds getCompoundsUsingGET(List<String> canonicalSmiles, List<String> cid, List<String> inchiKey, Integer limit, Integer page) throws ApiException {
        ApiResponse<PubchemCompounds> localVarResp = getCompoundsUsingGETWithHttpInfo(canonicalSmiles, cid, inchiKey, limit, page);
     ...
     * @param limit limit (optional, default to 10)
     * @param page page (optional, default to 0)
     * @return ApiResponse&lt;PubchemCompounds&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PubchemCompounds> getCompoundsUsingGETWithHttpInfo(List<String> canonicalSmiles, List<String> cid, List<String> inchiKey, Integer limit, Integer page) throws ApiException {
        okhttp3.Call localVarCall = getCompoundsUsingGETValidateBeforeCall(canonicalSmiles, cid, inchiKey, limit, page, null);
        Type localVarReturnType = new TypeToken<PubchemCompounds>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get pubchem compounds (asynchronously)
     * 
     * @param canonicalSmiles canonicalSmiles (optional)
     * @param cid cid (optional)
     * @param inchiKey inchiKey (optional)
     ...
     */
    public okhttp3.Call getCompoundsUsingGETAsync(List<String> canonicalSmiles, List<String> cid, List<String> inchiKey, Integer limit, Integer page, final ApiCallback<PubchemCompounds> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompoundsUsingGETValidateBeforeCall(canonicalSmiles, cid, inchiKey, limit, page, _callback);
        Type localVarReturnType = new TypeToken<PubchemCompounds>(){}.getType();
