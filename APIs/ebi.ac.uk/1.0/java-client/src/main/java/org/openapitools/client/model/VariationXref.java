...
public class VariationXref {
  ...
  public VariationXref() {
  }

  public VariationXref id(String id) {
    this.id = id;
    return this;
  }
  ...
  public VariationXref name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VariationXref variationXref = (VariationXref) o;
    return Objects.equals(this.id, variationXref.id) &&
        Objects.equals(this.name, variationXref.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariationXref
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationXref.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariationXref is not found in the empty JSON string", VariationXref.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariationXref.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariationXref` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariationXref.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariationXref' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariationXref> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariationXref.class));

       return (TypeAdapter<T>) new TypeAdapter<VariationXref>() {
           @Override
           public void write(JsonWriter out, VariationXref value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VariationXref read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VariationXref given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariationXref
   * @throws IOException if the JSON string is invalid with respect to VariationXref
   */
  public static VariationXref fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariationXref.class);
  }

  /**
   * Convert an instance of VariationXref to an JSON string
   *
   * @return JSON string
   */
