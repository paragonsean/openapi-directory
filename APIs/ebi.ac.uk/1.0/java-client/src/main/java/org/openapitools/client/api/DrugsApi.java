...
public class DrugsApi {
     ...
     */
    public okhttp3.Call getDrugsUsingGETCall(List<String> accession, List<String> chemblId, List<String> identifier, Integer limit, List<String> name, Integer page, List<String> pubchemCid, final ApiCallback _callback) throws ApiException {
        ...
        if (chemblId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "chemblId", chemblId));
        }
        ...
        if (pubchemCid != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "pubchemCid", pubchemCid));
        }
    ...
    private okhttp3.Call getDrugsUsingGETValidateBeforeCall(List<String> accession, List<String> chemblId, List<String> identifier, Integer limit, List<String> name, Integer page, List<String> pubchemCid, final ApiCallback _callback) throws ApiException {
        return getDrugsUsingGETCall(accession, chemblId, identifier, limit, name, page, pubchemCid, _callback);
     ...
     */
    public Drugs getDrugsUsingGET(List<String> accession, List<String> chemblId, List<String> identifier, Integer limit, List<String> name, Integer page, List<String> pubchemCid) throws ApiException {
        ApiResponse<Drugs> localVarResp = getDrugsUsingGETWithHttpInfo(accession, chemblId, identifier, limit, name, page, pubchemCid);
     ...
     */
    public ApiResponse<Drugs> getDrugsUsingGETWithHttpInfo(List<String> accession, List<String> chemblId, List<String> identifier, Integer limit, List<String> name, Integer page, List<String> pubchemCid) throws ApiException {
        okhttp3.Call localVarCall = getDrugsUsingGETValidateBeforeCall(accession, chemblId, identifier, limit, name, page, pubchemCid, null);
        Type localVarReturnType = new TypeToken<Drugs>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * drugs collected from Drugbank (asynchronously)
     * 
     * @param accession accession (optional)
     * @param chemblId chemblId (optional)
     * @param identifier identifier (optional)
     ...
     */
    public okhttp3.Call getDrugsUsingGETAsync(List<String> accession, List<String> chemblId, List<String> identifier, Integer limit, List<String> name, Integer page, List<String> pubchemCid, final ApiCallback<Drugs> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDrugsUsingGETValidateBeforeCall(accession, chemblId, identifier, limit, name, page, pubchemCid, _callback);
        Type localVarReturnType = new TypeToken<Drugs>(){}.getType();
