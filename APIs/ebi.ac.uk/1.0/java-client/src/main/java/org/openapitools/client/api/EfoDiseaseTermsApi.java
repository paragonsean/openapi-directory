...
public class EfoDiseaseTermsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EfoDiseaseTermsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public EfoDiseaseTermsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getEFOUsingGET
     * @param doid doid (optional)
     * @param label label (optional)
     * @param limit limit (optional, default to 10)
     * @param mesh mesh (optional)
     * @param oboId oboId (optional)
     * @param omimId omimId (optional)
     * @param page page (optional, default to 0)
     * @param synonym synonym (optional)
     ...
     */
    public okhttp3.Call getEFOUsingGETCall(List<String> doid, List<String> label, Integer limit, List<String> mesh, List<String> oboId, List<String> omimId, Integer page, List<String> synonym, final ApiCallback _callback) throws ApiException {
        ...
        if (doid != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "doid", doid));
        }
        ...
        if (mesh != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "mesh", mesh));
        }

        if (oboId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "oboId", oboId));
        }

        if (omimId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "omimId", omimId));
        }
        ...
        if (synonym != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "synonym", synonym));
        }
    ...
    private okhttp3.Call getEFOUsingGETValidateBeforeCall(List<String> doid, List<String> label, Integer limit, List<String> mesh, List<String> oboId, List<String> omimId, Integer page, List<String> synonym, final ApiCallback _callback) throws ApiException {
        return getEFOUsingGETCall(doid, label, limit, mesh, oboId, omimId, page, synonym, _callback);
     ...
     */
    public EFOEntities getEFOUsingGET(List<String> doid, List<String> label, Integer limit, List<String> mesh, List<String> oboId, List<String> omimId, Integer page, List<String> synonym) throws ApiException {
        ApiResponse<EFOEntities> localVarResp = getEFOUsingGETWithHttpInfo(doid, label, limit, mesh, oboId, omimId, page, synonym);
     ...
     * @param page page (optional, default to 0)
     * @param synonym synonym (optional)
     * @return ApiResponse&lt;EFOEntities&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<EFOEntities> getEFOUsingGETWithHttpInfo(List<String> doid, List<String> label, Integer limit, List<String> mesh, List<String> oboId, List<String> omimId, Integer page, List<String> synonym) throws ApiException {
        okhttp3.Call localVarCall = getEFOUsingGETValidateBeforeCall(doid, label, limit, mesh, oboId, omimId, page, synonym, null);
        Type localVarReturnType = new TypeToken<EFOEntities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get EFO diseases data (asynchronously)
     * 
     * @param doid doid (optional)
     * @param label label (optional)
     * @param limit limit (optional, default to 10)
     ...
     */
    public okhttp3.Call getEFOUsingGETAsync(List<String> doid, List<String> label, Integer limit, List<String> mesh, List<String> oboId, List<String> omimId, Integer page, List<String> synonym, final ApiCallback<EFOEntities> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEFOUsingGETValidateBeforeCall(doid, label, limit, mesh, oboId, omimId, page, synonym, _callback);
        Type localVarReturnType = new TypeToken<EFOEntities>(){}.getType();
