...
public class PDBe {
  ...
  public PDBe chains(String chains) {
    this.chains = chains;
    return this;
  }
  ...
  public PDBe method(String method) {
    this.method = method;
    return this;
  }
  ...
  public PDBe resolution(String resolution) {
  ...
  public boolean equals(Object o) {
    ...
    PDBe pdBe = (PDBe) o;
    return Objects.equals(this.chains, pdBe.chains) &&
        Objects.equals(this.id, pdBe.id) &&
        Objects.equals(this.method, pdBe.method) &&
        Objects.equals(this.resolution, pdBe.resolution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chains, id, method, resolution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PDBe {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PDBe
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PDBe.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PDBe is not found in the empty JSON string", PDBe.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PDBe.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PDBe` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("chains") != null && !jsonObj.get("chains").isJsonNull()) && !jsonObj.get("chains").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `chains` to be a primitive type in the JSON string but got `%s`", jsonObj.get("chains").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PDBe.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PDBe' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PDBe> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PDBe.class));

       return (TypeAdapter<T>) new TypeAdapter<PDBe>() {
           @Override
           public void write(JsonWriter out, PDBe value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PDBe read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PDBe given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PDBe
   * @throws IOException if the JSON string is invalid with respect to PDBe
   */
  public static PDBe fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PDBe.class);
  }

  /**
   * Convert an instance of PDBe to an JSON string
   *
   * @return JSON string
   */
