...
public class AssayOrganism {
  public static final String SERIALIZED_NAME_DB_OBJECT_ID = "db_object_id";
  @SerializedName(SERIALIZED_NAME_DB_OBJECT_ID)
  private Integer dbObjectId;

  public static final String SERIALIZED_NAME_TAX_NAME = "tax_name";
  @SerializedName(SERIALIZED_NAME_TAX_NAME)
  private String taxName;

  public AssayOrganism() {
  }

  public AssayOrganism dbObjectId(Integer dbObjectId) {
  ...
  public Integer getDbObjectId() {
    return dbObjectId;
  }

  public void setDbObjectId(Integer dbObjectId) {
    this.dbObjectId = dbObjectId;
  }


  public AssayOrganism taxName(String taxName) {
  ...
  public boolean equals(Object o) {
    ...
    AssayOrganism assayOrganism = (AssayOrganism) o;
    return Objects.equals(this.dbObjectId, assayOrganism.dbObjectId) &&
        Objects.equals(this.taxName, assayOrganism.taxName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dbObjectId, taxName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssayOrganism {\n");
    sb.append("    dbObjectId: ").append(toIndentedString(dbObjectId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("db_object_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssayOrganism
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssayOrganism.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssayOrganism is not found in the empty JSON string", AssayOrganism.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssayOrganism.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssayOrganism` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssayOrganism.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssayOrganism' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssayOrganism> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssayOrganism.class));

       return (TypeAdapter<T>) new TypeAdapter<AssayOrganism>() {
           @Override
           public void write(JsonWriter out, AssayOrganism value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssayOrganism read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssayOrganism given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssayOrganism
   * @throws IOException if the JSON string is invalid with respect to AssayOrganism
   */
  public static AssayOrganism fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssayOrganism.class);
  }

  /**
   * Convert an instance of AssayOrganism to an JSON string
   *
   * @return JSON string
   */
