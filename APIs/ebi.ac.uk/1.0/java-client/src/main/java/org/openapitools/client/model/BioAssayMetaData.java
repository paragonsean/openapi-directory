...
import org.openapitools.client.model.BioAssay;
import org.openapitools.client.model.SidRelatedData;
...
public class BioAssayMetaData {
  public static final String SERIALIZED_NAME_BIO_ASSAY = "bioAssay";
  @SerializedName(SERIALIZED_NAME_BIO_ASSAY)
  private BioAssay bioAssay;

  public static final String SERIALIZED_NAME_SID_RELATED_DATA = "sidRelatedData";
  @SerializedName(SERIALIZED_NAME_SID_RELATED_DATA)
  private List<SidRelatedData> sidRelatedData = new ArrayList<>();

  public BioAssayMetaData() {
  }

  public BioAssayMetaData bioAssay(BioAssay bioAssay) {
  ...
  public BioAssayMetaData sidRelatedData(List<SidRelatedData> sidRelatedData) {
    this.sidRelatedData = sidRelatedData;
    return this;
  }

  public BioAssayMetaData addSidRelatedDataItem(SidRelatedData sidRelatedDataItem) {
    if (this.sidRelatedData == null) {
      this.sidRelatedData = new ArrayList<>();
    }
    this.sidRelatedData.add(sidRelatedDataItem);
    return this;
  }

  /**
   * Get sidRelatedData
   * @return sidRelatedData
   */
  @javax.annotation.Nullable
  public List<SidRelatedData> getSidRelatedData() {
    return sidRelatedData;
  }

  public void setSidRelatedData(List<SidRelatedData> sidRelatedData) {
    this.sidRelatedData = sidRelatedData;
  }
  ...
  public boolean equals(Object o) {
    ...
    BioAssayMetaData bioAssayMetaData = (BioAssayMetaData) o;
    return Objects.equals(this.bioAssay, bioAssayMetaData.bioAssay) &&
        Objects.equals(this.sidRelatedData, bioAssayMetaData.sidRelatedData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bioAssay, sidRelatedData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BioAssayMetaData {\n");
    sb.append("    bioAssay: ").append(toIndentedString(bioAssay)).append("\n");
    sb.append("    sidRelatedData: ").append(toIndentedString(sidRelatedData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("bioAssay");
    openapiFields.add("sidRelatedData");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BioAssayMetaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BioAssayMetaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BioAssayMetaData is not found in the empty JSON string", BioAssayMetaData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BioAssayMetaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BioAssayMetaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `bioAssay`
      if (jsonObj.get("bioAssay") != null && !jsonObj.get("bioAssay").isJsonNull()) {
        BioAssay.validateJsonElement(jsonObj.get("bioAssay"));
      }
      if (jsonObj.get("sidRelatedData") != null && !jsonObj.get("sidRelatedData").isJsonNull()) {
        JsonArray jsonArraysidRelatedData = jsonObj.getAsJsonArray("sidRelatedData");
        if (jsonArraysidRelatedData != null) {
          // ensure the json data is an array
          if (!jsonObj.get("sidRelatedData").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `sidRelatedData` to be an array in the JSON string but got `%s`", jsonObj.get("sidRelatedData").toString()));
          }

          // validate the optional field `sidRelatedData` (array)
          for (int i = 0; i < jsonArraysidRelatedData.size(); i++) {
            SidRelatedData.validateJsonElement(jsonArraysidRelatedData.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BioAssayMetaData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BioAssayMetaData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BioAssayMetaData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BioAssayMetaData.class));

       return (TypeAdapter<T>) new TypeAdapter<BioAssayMetaData>() {
           @Override
           public void write(JsonWriter out, BioAssayMetaData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BioAssayMetaData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BioAssayMetaData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BioAssayMetaData
   * @throws IOException if the JSON string is invalid with respect to BioAssayMetaData
   */
  public static BioAssayMetaData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BioAssayMetaData.class);
  }

  /**
   * Convert an instance of BioAssayMetaData to an JSON string
   *
   * @return JSON string
   */
