...
public class PubchemSubstances {
  public static final String SERIALIZED_NAME_PAGE_META = "pageMeta";
  @SerializedName(SERIALIZED_NAME_PAGE_META)
  private PageMeta pageMeta;

  public static final String SERIALIZED_NAME_SUBSTANCES = "substances";
  @SerializedName(SERIALIZED_NAME_SUBSTANCES)
  private List<Substance> substances = new ArrayList<>();

  public PubchemSubstances() {
  }

  public PubchemSubstances pageMeta(PageMeta pageMeta) {
  ...
  public PubchemSubstances substances(List<Substance> substances) {
    this.substances = substances;
    return this;
  }

  public PubchemSubstances addSubstancesItem(Substance substancesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PubchemSubstances pubchemSubstances = (PubchemSubstances) o;
    return Objects.equals(this.pageMeta, pubchemSubstances.pageMeta) &&
        Objects.equals(this.substances, pubchemSubstances.substances);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pageMeta, substances);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PubchemSubstances {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PubchemSubstances
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PubchemSubstances.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PubchemSubstances is not found in the empty JSON string", PubchemSubstances.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PubchemSubstances.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PubchemSubstances` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("substances") != null && !jsonObj.get("substances").isJsonNull()) {
        JsonArray jsonArraysubstances = jsonObj.getAsJsonArray("substances");
        if (jsonArraysubstances != null) {
          // ensure the json data is an array
          if (!jsonObj.get("substances").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `substances` to be an array in the JSON string but got `%s`", jsonObj.get("substances").toString()));
          }

          // validate the optional field `substances` (array)
          for (int i = 0; i < jsonArraysubstances.size(); i++) {
            Substance.validateJsonElement(jsonArraysubstances.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PubchemSubstances.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PubchemSubstances' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PubchemSubstances> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PubchemSubstances.class));

       return (TypeAdapter<T>) new TypeAdapter<PubchemSubstances>() {
           @Override
           public void write(JsonWriter out, PubchemSubstances value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PubchemSubstances read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PubchemSubstances given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PubchemSubstances
   * @throws IOException if the JSON string is invalid with respect to PubchemSubstances
   */
  public static PubchemSubstances fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PubchemSubstances.class);
  }

  /**
   * Convert an instance of PubchemSubstances to an JSON string
   *
   * @return JSON string
   */
