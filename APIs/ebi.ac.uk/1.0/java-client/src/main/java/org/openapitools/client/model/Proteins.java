...
import org.openapitools.client.model.Protein;
...
public class Proteins {
  ...
  public static final String SERIALIZED_NAME_PROTEINS = "proteins";
  @SerializedName(SERIALIZED_NAME_PROTEINS)
  private List<Protein> proteins = new ArrayList<>();

  public Proteins() {
  }

  public Proteins pageMeta(PageMeta pageMeta) {
  ...
  public Proteins proteins(List<Protein> proteins) {
    this.proteins = proteins;
    return this;
  }

  public Proteins addProteinsItem(Protein proteinsItem) {
    if (this.proteins == null) {
      this.proteins = new ArrayList<>();
    }
    this.proteins.add(proteinsItem);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Proteins proteins = (Proteins) o;
    return Objects.equals(this.pageMeta, proteins.pageMeta) &&
        Objects.equals(this.proteins, proteins.proteins);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pageMeta, proteins);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Proteins {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Proteins
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Proteins.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Proteins is not found in the empty JSON string", Proteins.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Proteins.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Proteins` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("proteins") != null && !jsonObj.get("proteins").isJsonNull()) {
        JsonArray jsonArrayproteins = jsonObj.getAsJsonArray("proteins");
        if (jsonArrayproteins != null) {
          // ensure the json data is an array
          if (!jsonObj.get("proteins").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `proteins` to be an array in the JSON string but got `%s`", jsonObj.get("proteins").toString()));
          }

          // validate the optional field `proteins` (array)
          for (int i = 0; i < jsonArrayproteins.size(); i++) {
            Protein.validateJsonElement(jsonArrayproteins.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Proteins.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Proteins' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Proteins> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Proteins.class));

       return (TypeAdapter<T>) new TypeAdapter<Proteins>() {
           @Override
           public void write(JsonWriter out, Proteins value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Proteins read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Proteins given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Proteins
   * @throws IOException if the JSON string is invalid with respect to Proteins
   */
  public static Proteins fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Proteins.class);
  }

  /**
   * Convert an instance of Proteins to an JSON string
   *
   * @return JSON string
   */
