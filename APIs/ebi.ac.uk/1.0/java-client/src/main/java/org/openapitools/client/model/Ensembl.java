...
public class Ensembl {
  ...
  public static final String SERIALIZED_NAME_ISOFORM = "isoform";
  @SerializedName(SERIALIZED_NAME_ISOFORM)
  private String isoform;

  public static final String SERIALIZED_NAME_PROTEIN_SEQUENCE_ID = "proteinSequenceId";
  @SerializedName(SERIALIZED_NAME_PROTEIN_SEQUENCE_ID)
  private String proteinSequenceId;

  public Ensembl() {
  }

  public Ensembl geneId(String geneId) {
    this.geneId = geneId;
    return this;
  }
  ...
  public Ensembl isoform(String isoform) {
  ...
  public Ensembl proteinSequenceId(String proteinSequenceId) {
    this.proteinSequenceId = proteinSequenceId;
    return this;
  }

  /**
   * Get proteinSequenceId
  ...
  public void setProteinSequenceId(String proteinSequenceId) {
    this.proteinSequenceId = proteinSequenceId;
  }
  ...
  public boolean equals(Object o) {
    ...
    Ensembl ensembl = (Ensembl) o;
    return Objects.equals(this.geneId, ensembl.geneId) &&
        Objects.equals(this.id, ensembl.id) &&
        Objects.equals(this.isoform, ensembl.isoform) &&
        Objects.equals(this.proteinSequenceId, ensembl.proteinSequenceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(geneId, id, isoform, proteinSequenceId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Ensembl {\n");
    sb.append("    geneId: ").append(toIndentedString(geneId)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    isoform: ").append(toIndentedString(isoform)).append("\n");
    sb.append("    proteinSequenceId: ").append(toIndentedString(proteinSequenceId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("isoform");
    openapiFields.add("proteinSequenceId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ensembl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ensembl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ensembl is not found in the empty JSON string", Ensembl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ensembl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ensembl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("isoform") != null && !jsonObj.get("isoform").isJsonNull()) && !jsonObj.get("isoform").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `isoform` to be a primitive type in the JSON string but got `%s`", jsonObj.get("isoform").toString()));
      }
      if ((jsonObj.get("proteinSequenceId") != null && !jsonObj.get("proteinSequenceId").isJsonNull()) && !jsonObj.get("proteinSequenceId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `proteinSequenceId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("proteinSequenceId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ensembl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ensembl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ensembl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ensembl.class));

       return (TypeAdapter<T>) new TypeAdapter<Ensembl>() {
           @Override
           public void write(JsonWriter out, Ensembl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ensembl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ensembl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ensembl
   * @throws IOException if the JSON string is invalid with respect to Ensembl
   */
  public static Ensembl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ensembl.class);
  }

  /**
   * Convert an instance of Ensembl to an JSON string
   *
   * @return JSON string
   */
