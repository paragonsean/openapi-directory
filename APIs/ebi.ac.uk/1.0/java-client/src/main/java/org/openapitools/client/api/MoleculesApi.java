...
public class MoleculesApi {
    ...
    public MoleculesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getMoleculesUsingGET
     ...
     */
    public okhttp3.Call getMoleculesUsingGETCall(List<String> canonicalSmiles, List<String> inchiKey, Integer limit, List<String> moleculeChemblId, Integer page, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getMoleculesUsingGETValidateBeforeCall(List<String> canonicalSmiles, List<String> inchiKey, Integer limit, List<String> moleculeChemblId, Integer page, final ApiCallback _callback) throws ApiException {
        return getMoleculesUsingGETCall(canonicalSmiles, inchiKey, limit, moleculeChemblId, page, _callback);
     ...
     */
    public Molecules getMoleculesUsingGET(List<String> canonicalSmiles, List<String> inchiKey, Integer limit, List<String> moleculeChemblId, Integer page) throws ApiException {
        ApiResponse<Molecules> localVarResp = getMoleculesUsingGETWithHttpInfo(canonicalSmiles, inchiKey, limit, moleculeChemblId, page);
     ...
     */
    public ApiResponse<Molecules> getMoleculesUsingGETWithHttpInfo(List<String> canonicalSmiles, List<String> inchiKey, Integer limit, List<String> moleculeChemblId, Integer page) throws ApiException {
        okhttp3.Call localVarCall = getMoleculesUsingGETValidateBeforeCall(canonicalSmiles, inchiKey, limit, moleculeChemblId, page, null);
        Type localVarReturnType = new TypeToken<Molecules>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get ChEMBL molecules (asynchronously)
     * 
     * @param canonicalSmiles canonicalSmiles (optional)
     * @param inchiKey inchiKey (optional)
     * @param limit limit (optional, default to 10)
     ...
     */
    public okhttp3.Call getMoleculesUsingGETAsync(List<String> canonicalSmiles, List<String> inchiKey, Integer limit, List<String> moleculeChemblId, Integer page, final ApiCallback<Molecules> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMoleculesUsingGETValidateBeforeCall(canonicalSmiles, inchiKey, limit, moleculeChemblId, page, _callback);
        Type localVarReturnType = new TypeToken<Molecules>(){}.getType();
