...
public class VariationEvidenceSource {
  ...
  public VariationEvidenceSource() {
  }

  public VariationEvidenceSource id(String id) {
    this.id = id;
    return this;
  }
  ...
  public VariationEvidenceSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VariationEvidenceSource variationEvidenceSource = (VariationEvidenceSource) o;
    return Objects.equals(this.id, variationEvidenceSource.id) &&
        Objects.equals(this.name, variationEvidenceSource.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class VariationEvidenceSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariationEvidenceSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationEvidenceSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariationEvidenceSource is not found in the empty JSON string", VariationEvidenceSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariationEvidenceSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariationEvidenceSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariationEvidenceSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariationEvidenceSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariationEvidenceSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariationEvidenceSource.class));

       return (TypeAdapter<T>) new TypeAdapter<VariationEvidenceSource>() {
           @Override
           public void write(JsonWriter out, VariationEvidenceSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VariationEvidenceSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VariationEvidenceSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariationEvidenceSource
   * @throws IOException if the JSON string is invalid with respect to VariationEvidenceSource
   */
  public static VariationEvidenceSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariationEvidenceSource.class);
  }

  /**
   * Convert an instance of VariationEvidenceSource to an JSON string
   *
   * @return JSON string
   */
