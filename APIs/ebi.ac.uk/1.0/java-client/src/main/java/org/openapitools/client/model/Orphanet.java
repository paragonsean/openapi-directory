...
public class Orphanet {
  public static final String SERIALIZED_NAME_DISEASE = "disease";
  @SerializedName(SERIALIZED_NAME_DISEASE)
  ...
  public Orphanet disease(String disease) {
  ...
  public boolean equals(Object o) {
    ...
    Orphanet orphanet = (Orphanet) o;
    return Objects.equals(this.disease, orphanet.disease) &&
        Objects.equals(this.id, orphanet.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disease, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Orphanet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Orphanet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Orphanet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Orphanet is not found in the empty JSON string", Orphanet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Orphanet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Orphanet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("disease") != null && !jsonObj.get("disease").isJsonNull()) && !jsonObj.get("disease").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `disease` to be a primitive type in the JSON string but got `%s`", jsonObj.get("disease").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Orphanet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Orphanet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Orphanet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Orphanet.class));

       return (TypeAdapter<T>) new TypeAdapter<Orphanet>() {
           @Override
           public void write(JsonWriter out, Orphanet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Orphanet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Orphanet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Orphanet
   * @throws IOException if the JSON string is invalid with respect to Orphanet
   */
  public static Orphanet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Orphanet.class);
  }

  /**
   * Convert an instance of Orphanet to an JSON string
   *
   * @return JSON string
   */
