...
import org.openapitools.client.model.PubchemSubstances;
...
public class PubChemSubstancesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PubChemSubstancesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PubChemSubstancesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getSubstancesUsingGET
     ...
     */
    public okhttp3.Call getSubstancesUsingGETCall(List<String> cid, Integer limit, Integer page, List<String> sid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/pubchem/substances";
    ...
    private okhttp3.Call getSubstancesUsingGETValidateBeforeCall(List<String> cid, Integer limit, Integer page, List<String> sid, final ApiCallback _callback) throws ApiException {
        return getSubstancesUsingGETCall(cid, limit, page, sid, _callback);
     ...
     */
    public PubchemSubstances getSubstancesUsingGET(List<String> cid, Integer limit, Integer page, List<String> sid) throws ApiException {
        ApiResponse<PubchemSubstances> localVarResp = getSubstancesUsingGETWithHttpInfo(cid, limit, page, sid);
     ...
     * @param page page (optional, default to 0)
     * @param sid sid (optional)
     * @return ApiResponse&lt;PubchemSubstances&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PubchemSubstances> getSubstancesUsingGETWithHttpInfo(List<String> cid, Integer limit, Integer page, List<String> sid) throws ApiException {
        okhttp3.Call localVarCall = getSubstancesUsingGETValidateBeforeCall(cid, limit, page, sid, null);
        Type localVarReturnType = new TypeToken<PubchemSubstances>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get pubchem substances (asynchronously)
     * 
     * @param cid cid (optional)
     * @param limit limit (optional, default to 10)
     * @param page page (optional, default to 0)
     ...
     */
    public okhttp3.Call getSubstancesUsingGETAsync(List<String> cid, Integer limit, Integer page, List<String> sid, final ApiCallback<PubchemSubstances> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSubstancesUsingGETValidateBeforeCall(cid, limit, page, sid, _callback);
        Type localVarReturnType = new TypeToken<PubchemSubstances>(){}.getType();
