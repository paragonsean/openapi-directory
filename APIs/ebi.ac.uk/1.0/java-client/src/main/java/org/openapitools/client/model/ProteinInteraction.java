...
public class ProteinInteraction {
  ...
  public static final String SERIALIZED_NAME_INTERACTORS = "interactors";
  @SerializedName(SERIALIZED_NAME_INTERACTORS)
  private List<String> interactors = new ArrayList<>();

  public ProteinInteraction() {
  }

  public ProteinInteraction id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProteinInteraction interactionType(String interactionType) {
  ...
  public ProteinInteraction interactors(List<String> interactors) {
    this.interactors = interactors;
    return this;
  }

  public ProteinInteraction addInteractorsItem(String interactorsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, proteinInteraction.id) &&
        Objects.equals(this.interactionType, proteinInteraction.interactionType) &&
        Objects.equals(this.interactors, proteinInteraction.interactors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, interactionType, interactors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProteinInteraction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProteinInteraction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProteinInteraction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProteinInteraction is not found in the empty JSON string", ProteinInteraction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProteinInteraction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProteinInteraction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("interactors") != null && !jsonObj.get("interactors").isJsonNull() && !jsonObj.get("interactors").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `interactors` to be an array in the JSON string but got `%s`", jsonObj.get("interactors").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProteinInteraction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProteinInteraction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProteinInteraction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProteinInteraction.class));

       return (TypeAdapter<T>) new TypeAdapter<ProteinInteraction>() {
           @Override
           public void write(JsonWriter out, ProteinInteraction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProteinInteraction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProteinInteraction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProteinInteraction
   * @throws IOException if the JSON string is invalid with respect to ProteinInteraction
   */
  public static ProteinInteraction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProteinInteraction.class);
  }

  /**
   * Convert an instance of ProteinInteraction to an JSON string
   *
   * @return JSON string
   */
