...
import org.openapitools.client.model.CrossbarTarget;
...
public class Targets {
  ...
  private List<CrossbarTarget> targets = new ArrayList<>();

  public Targets() {
  }

  public Targets pageMeta(PageMeta pageMeta) {
  ...
  public Targets targets(List<CrossbarTarget> targets) {
    this.targets = targets;
    return this;
  }

  public Targets addTargetsItem(CrossbarTarget targetsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CrossbarTarget> getTargets() {
    return targets;
  }

  public void setTargets(List<CrossbarTarget> targets) {
    this.targets = targets;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageMeta, targets.pageMeta) &&
        Objects.equals(this.targets, targets.targets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pageMeta, targets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Targets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Targets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Targets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Targets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("targets") != null && !jsonObj.get("targets").isJsonNull()) {
        ...
        if (jsonArraytargets != null) {
          ...
          for (int i = 0; i < jsonArraytargets.size(); i++) {
            CrossbarTarget.validateJsonElement(jsonArraytargets.get(i));
          };
        }
      }
  }
