...
public class Assays {
  ...
  public Assays assays(List<Assay> assays) {
    this.assays = assays;
    return this;
  }

  public Assays addAssaysItem(Assay assaysItem) {
    if (this.assays == null) {
  ...
  public Assays pageMeta(PageMeta pageMeta) {
  ...
  public boolean equals(Object o) {
    ...
    Assays assays = (Assays) o;
    return Objects.equals(this.assays, assays.assays) &&
        Objects.equals(this.pageMeta, assays.pageMeta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assays, pageMeta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Assays {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Assays
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Assays.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Assays is not found in the empty JSON string", Assays.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Assays.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Assays` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("assays") != null && !jsonObj.get("assays").isJsonNull()) {
        JsonArray jsonArrayassays = jsonObj.getAsJsonArray("assays");
        if (jsonArrayassays != null) {
          // ensure the json data is an array
          if (!jsonObj.get("assays").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `assays` to be an array in the JSON string but got `%s`", jsonObj.get("assays").toString()));
          }

          // validate the optional field `assays` (array)
          for (int i = 0; i < jsonArrayassays.size(); i++) {
            Assay.validateJsonElement(jsonArrayassays.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Assays.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Assays' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Assays> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Assays.class));

       return (TypeAdapter<T>) new TypeAdapter<Assays>() {
           @Override
           public void write(JsonWriter out, Assays value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Assays read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Assays given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Assays
   * @throws IOException if the JSON string is invalid with respect to Assays
   */
  public static Assays fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Assays.class);
  }

  /**
   * Convert an instance of Assays to an JSON string
   *
   * @return JSON string
   */
