...
public class Omim {
  ...
  public boolean equals(Object o) {
    ...
    Omim omim = (Omim) o;
    return Objects.equals(this.id, omim.id) &&
        Objects.equals(this.type, omim.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Omim
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Omim.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Omim is not found in the empty JSON string", Omim.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Omim.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Omim` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Omim.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Omim' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Omim> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Omim.class));

       return (TypeAdapter<T>) new TypeAdapter<Omim>() {
           @Override
           public void write(JsonWriter out, Omim value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Omim read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Omim given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Omim
   * @throws IOException if the JSON string is invalid with respect to Omim
   */
  public static Omim fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Omim.class);
  }

  /**
   * Convert an instance of Omim to an JSON string
   *
   * @return JSON string
   */
