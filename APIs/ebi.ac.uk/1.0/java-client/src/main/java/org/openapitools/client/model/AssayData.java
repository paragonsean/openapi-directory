...
public class AssayData {
  ...
  public AssayData standardType(String standardType) {
  ...
  public AssayData standardUnits(String standardUnits) {
  ...
  public AssayData standardValue(Double standardValue) {
  ...
  public boolean equals(Object o) {
    ...
    AssayData assayData = (AssayData) o;
    return Objects.equals(this.standardType, assayData.standardType) &&
        Objects.equals(this.standardUnits, assayData.standardUnits) &&
        Objects.equals(this.standardValue, assayData.standardValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(standardType, standardUnits, standardValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssayData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssayData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssayData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssayData is not found in the empty JSON string", AssayData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssayData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssayData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssayData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssayData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssayData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssayData.class));

       return (TypeAdapter<T>) new TypeAdapter<AssayData>() {
           @Override
           public void write(JsonWriter out, AssayData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssayData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssayData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssayData
   * @throws IOException if the JSON string is invalid with respect to AssayData
   */
  public static AssayData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssayData.class);
  }

  /**
   * Convert an instance of AssayData to an JSON string
   *
   * @return JSON string
   */
