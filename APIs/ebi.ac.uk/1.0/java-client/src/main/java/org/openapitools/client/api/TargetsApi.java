...
import org.openapitools.client.model.Targets;
...
public class TargetsApi {
     ...
     */
    public okhttp3.Call getTargetsUsingGETCall(List<String> accession, Integer limit, Integer page, List<String> targetIds, final ApiCallback _callback) throws ApiException {
        ...
        if (targetIds != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "targetIds", targetIds));
        }
    ...
    private okhttp3.Call getTargetsUsingGETValidateBeforeCall(List<String> accession, Integer limit, Integer page, List<String> targetIds, final ApiCallback _callback) throws ApiException {
        return getTargetsUsingGETCall(accession, limit, page, targetIds, _callback);
     ...
     */
    public Targets getTargetsUsingGET(List<String> accession, Integer limit, Integer page, List<String> targetIds) throws ApiException {
        ApiResponse<Targets> localVarResp = getTargetsUsingGETWithHttpInfo(accession, limit, page, targetIds);
     ...
     */
    public ApiResponse<Targets> getTargetsUsingGETWithHttpInfo(List<String> accession, Integer limit, Integer page, List<String> targetIds) throws ApiException {
        okhttp3.Call localVarCall = getTargetsUsingGETValidateBeforeCall(accession, limit, page, targetIds, null);
        Type localVarReturnType = new TypeToken<Targets>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get ChEMBL targets (asynchronously)
     * 
     * @param accession accession (optional)
     * @param limit limit (optional, default to 10)
     * @param page page (optional, default to 0)
     ...
     */
    public okhttp3.Call getTargetsUsingGETAsync(List<String> accession, Integer limit, Integer page, List<String> targetIds, final ApiCallback<Targets> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTargetsUsingGETValidateBeforeCall(accession, limit, page, targetIds, _callback);
        Type localVarReturnType = new TypeToken<Targets>(){}.getType();
