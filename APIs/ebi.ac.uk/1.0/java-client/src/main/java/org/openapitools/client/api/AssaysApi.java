...
import org.openapitools.client.model.Assays;
...
public class AssaysApi {
    ...
    public AssaysApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAssaysUsingGET
     * @param assayChemblId assayChemblId (optional)
     * @param assayOrg assayOrg (optional)
     * @param assayType assayType (optional)
     ...
     */
    public okhttp3.Call getAssaysUsingGETCall(List<String> assayChemblId, List<String> assayOrg, List<String> assayType, Integer limit, Integer page, List<String> targetChemblId, final ApiCallback _callback) throws ApiException {
        ...
        if (assayOrg != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "assayOrg", assayOrg));
        }

        if (assayType != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "assayType", assayType));
        }
    ...
    private okhttp3.Call getAssaysUsingGETValidateBeforeCall(List<String> assayChemblId, List<String> assayOrg, List<String> assayType, Integer limit, Integer page, List<String> targetChemblId, final ApiCallback _callback) throws ApiException {
        return getAssaysUsingGETCall(assayChemblId, assayOrg, assayType, limit, page, targetChemblId, _callback);
     ...
     */
    public Assays getAssaysUsingGET(List<String> assayChemblId, List<String> assayOrg, List<String> assayType, Integer limit, Integer page, List<String> targetChemblId) throws ApiException {
        ApiResponse<Assays> localVarResp = getAssaysUsingGETWithHttpInfo(assayChemblId, assayOrg, assayType, limit, page, targetChemblId);
     ...
     */
    public ApiResponse<Assays> getAssaysUsingGETWithHttpInfo(List<String> assayChemblId, List<String> assayOrg, List<String> assayType, Integer limit, Integer page, List<String> targetChemblId) throws ApiException {
        okhttp3.Call localVarCall = getAssaysUsingGETValidateBeforeCall(assayChemblId, assayOrg, assayType, limit, page, targetChemblId, null);
        Type localVarReturnType = new TypeToken<Assays>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get ChEMBL assays (asynchronously)
     * 
     * @param assayChemblId assayChemblId (optional)
     * @param assayOrg assayOrg (optional)
     * @param assayType assayType (optional)
     ...
     */
    public okhttp3.Call getAssaysUsingGETAsync(List<String> assayChemblId, List<String> assayOrg, List<String> assayType, Integer limit, Integer page, List<String> targetChemblId, final ApiCallback<Assays> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAssaysUsingGETValidateBeforeCall(assayChemblId, assayOrg, assayType, limit, page, targetChemblId, _callback);
        Type localVarReturnType = new TypeToken<Assays>(){}.getType();
