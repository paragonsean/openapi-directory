...
public class Pfam {
  ...
  public Pfam entryName(String entryName) {
  ...
  public boolean equals(Object o) {
    ...
    Pfam pfam = (Pfam) o;
    return Objects.equals(this.entryName, pfam.entryName) &&
        Objects.equals(this.id, pfam.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entryName, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Pfam {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pfam
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pfam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pfam is not found in the empty JSON string", Pfam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pfam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pfam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("entryName") != null && !jsonObj.get("entryName").isJsonNull()) && !jsonObj.get("entryName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `entryName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("entryName").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pfam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pfam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pfam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pfam.class));

       return (TypeAdapter<T>) new TypeAdapter<Pfam>() {
           @Override
           public void write(JsonWriter out, Pfam value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pfam read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pfam given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pfam
   * @throws IOException if the JSON string is invalid with respect to Pfam
   */
  public static Pfam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pfam.class);
  }

  /**
   * Convert an instance of Pfam to an JSON string
   *
   * @return JSON string
   */
