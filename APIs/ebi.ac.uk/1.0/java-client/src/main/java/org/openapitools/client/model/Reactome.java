...
public class Reactome {
  ...
  public static final String SERIALIZED_NAME_PATHWAY_NAME = "pathwayName";
  @SerializedName(SERIALIZED_NAME_PATHWAY_NAME)
  private String pathwayName;

  public Reactome() {
  }

  public Reactome id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Reactome pathwayName(String pathwayName) {
  ...
  public boolean equals(Object o) {
    ...
    Reactome reactome = (Reactome) o;
    return Objects.equals(this.id, reactome.id) &&
        Objects.equals(this.pathwayName, reactome.pathwayName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, pathwayName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Reactome {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    pathwayName: ").append(toIndentedString(pathwayName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Reactome
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reactome.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Reactome is not found in the empty JSON string", Reactome.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reactome.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Reactome` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("pathwayName") != null && !jsonObj.get("pathwayName").isJsonNull()) && !jsonObj.get("pathwayName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pathwayName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pathwayName").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reactome.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reactome' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reactome> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reactome.class));

       return (TypeAdapter<T>) new TypeAdapter<Reactome>() {
           @Override
           public void write(JsonWriter out, Reactome value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reactome read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Reactome given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Reactome
   * @throws IOException if the JSON string is invalid with respect to Reactome
   */
  public static Reactome fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Reactome.class);
  }

  /**
   * Convert an instance of Reactome to an JSON string
   *
   * @return JSON string
   */
