...
public class Target {
  public static final String SERIALIZED_NAME_ACCESSIONS = "accessions";
  @SerializedName(SERIALIZED_NAME_ACCESSIONS)
  ...
  public Target accessions(List<String> accessions) {
    this.accessions = accessions;
    return this;
  }

  public Target addAccessionsItem(String accessionsItem) {
  ...
  public Target action(List<String> action) {
    this.action = action;
    return this;
  }

  public Target addActionItem(String actionItem) {
    if (this.action == null) {
  ...
  public Target organism(String organism) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessions, target.accessions) &&
        Objects.equals(this.action, target.action) &&
        Objects.equals(this.id, target.id) &&
        Objects.equals(this.name, target.name) &&
        Objects.equals(this.organism, target.organism);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessions, action, id, name, organism);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("accessions") != null && !jsonObj.get("accessions").isJsonNull() && !jsonObj.get("accessions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `accessions` to be an array in the JSON string but got `%s`", jsonObj.get("accessions").toString()));
      }
      // ensure the optional json data is an array if present
