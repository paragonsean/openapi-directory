...
public class HitPosition {
  ...
  public HitPosition from(Integer from) {
    this.from = from;
    return this;
  }
  ...
  public HitPosition to(Integer to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HitPosition hitPosition = (HitPosition) o;
    return Objects.equals(this.from, hitPosition.from) &&
        Objects.equals(this.to, hitPosition.to);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HitPosition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HitPosition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HitPosition is not found in the empty JSON string", HitPosition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HitPosition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HitPosition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HitPosition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HitPosition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HitPosition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HitPosition.class));

       return (TypeAdapter<T>) new TypeAdapter<HitPosition>() {
           @Override
           public void write(JsonWriter out, HitPosition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HitPosition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HitPosition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HitPosition
   * @throws IOException if the JSON string is invalid with respect to HitPosition
   */
  public static HitPosition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HitPosition.class);
  }

  /**
   * Convert an instance of HitPosition to an JSON string
   *
   * @return JSON string
   */
