...
public class EFOEntities {
  ...
  public EFOEntities diseases(List<EFO> diseases) {
    this.diseases = diseases;
    return this;
  }

  public EFOEntities addDiseasesItem(EFO diseasesItem) {
  ...
  public List<EFO> getDiseases() {
    return diseases;
  }

  public void setDiseases(List<EFO> diseases) {
    this.diseases = diseases;
  }


  public EFOEntities pageMeta(PageMeta pageMeta) {
  ...
  public boolean equals(Object o) {
    ...
    EFOEntities efOEntities = (EFOEntities) o;
    return Objects.equals(this.diseases, efOEntities.diseases) &&
        Objects.equals(this.pageMeta, efOEntities.pageMeta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(diseases, pageMeta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EFOEntities {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EFOEntities
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EFOEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EFOEntities is not found in the empty JSON string", EFOEntities.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EFOEntities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EFOEntities` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("diseases") != null && !jsonObj.get("diseases").isJsonNull()) {
        JsonArray jsonArraydiseases = jsonObj.getAsJsonArray("diseases");
        if (jsonArraydiseases != null) {
          // ensure the json data is an array
          if (!jsonObj.get("diseases").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `diseases` to be an array in the JSON string but got `%s`", jsonObj.get("diseases").toString()));
          }

          // validate the optional field `diseases` (array)
          for (int i = 0; i < jsonArraydiseases.size(); i++) {
            EFO.validateJsonElement(jsonArraydiseases.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EFOEntities.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EFOEntities' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EFOEntities> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EFOEntities.class));

       return (TypeAdapter<T>) new TypeAdapter<EFOEntities>() {
           @Override
           public void write(JsonWriter out, EFOEntities value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EFOEntities read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EFOEntities given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EFOEntities
   * @throws IOException if the JSON string is invalid with respect to EFOEntities
   */
  public static EFOEntities fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EFOEntities.class);
  }

  /**
   * Convert an instance of EFOEntities to an JSON string
   *
   * @return JSON string
   */
