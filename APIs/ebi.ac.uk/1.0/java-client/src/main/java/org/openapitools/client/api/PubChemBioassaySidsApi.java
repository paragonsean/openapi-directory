...
public class PubChemBioassaySidsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PubChemBioassaySidsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PubChemBioassaySidsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getBioassaysUsingGET1
     * @param limit limit (optional, default to 10)
     * @param outcome outcome (optional)
     * @param page page (optional, default to 0)
     * @param sids sids (optional)
     ...
     */
    public okhttp3.Call getBioassaysUsingGET1Call(Integer limit, String outcome, Integer page, List<String> sids, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/pubchem/bioassays/sids";
        ...
        if (sids != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "sids", sids));
        }
    ...
    private okhttp3.Call getBioassaysUsingGET1ValidateBeforeCall(Integer limit, String outcome, Integer page, List<String> sids, final ApiCallback _callback) throws ApiException {
        return getBioassaysUsingGET1Call(limit, outcome, page, sids, _callback);
     ...
     */
    public Bioassays getBioassaysUsingGET1(Integer limit, String outcome, Integer page, List<String> sids) throws ApiException {
        ApiResponse<Bioassays> localVarResp = getBioassaysUsingGET1WithHttpInfo(limit, outcome, page, sids);
     ...
     */
    public ApiResponse<Bioassays> getBioassaysUsingGET1WithHttpInfo(Integer limit, String outcome, Integer page, List<String> sids) throws ApiException {
        okhttp3.Call localVarCall = getBioassaysUsingGET1ValidateBeforeCall(limit, outcome, page, sids, null);
        Type localVarReturnType = new TypeToken<Bioassays>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get pubchem bioassays associated to particular substance ids (sid) &amp; outcome (asynchronously)
     * 
     * @param limit limit (optional, default to 10)
     * @param outcome outcome (optional)
     * @param page page (optional, default to 0)
     ...
     */
    public okhttp3.Call getBioassaysUsingGET1Async(Integer limit, String outcome, Integer page, List<String> sids, final ApiCallback<Bioassays> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBioassaysUsingGET1ValidateBeforeCall(limit, outcome, page, sids, _callback);
        Type localVarReturnType = new TypeToken<Bioassays>(){}.getType();
