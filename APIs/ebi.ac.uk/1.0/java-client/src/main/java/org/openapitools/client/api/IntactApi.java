...
import org.openapitools.client.model.IntactInteractions;
...
public class IntactApi {
    ...
    public IntactApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getIntactUsingGET
     * @param accession accession (optional)
     * @param confidence confidence (optional)
     ...
     */
    public okhttp3.Call getIntactUsingGETCall(List<String> accession, Double confidence, List<String> gene, Integer limit, Integer page, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIntactUsingGETValidateBeforeCall(List<String> accession, Double confidence, List<String> gene, Integer limit, Integer page, final ApiCallback _callback) throws ApiException {
        return getIntactUsingGETCall(accession, confidence, gene, limit, page, _callback);
     ...
     */
    public IntactInteractions getIntactUsingGET(List<String> accession, Double confidence, List<String> gene, Integer limit, Integer page) throws ApiException {
        ApiResponse<IntactInteractions> localVarResp = getIntactUsingGETWithHttpInfo(accession, confidence, gene, limit, page);
     ...
     * @param limit limit (optional, default to 10)
     * @param page page (optional, default to 0)
     * @return ApiResponse&lt;IntactInteractions&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IntactInteractions> getIntactUsingGETWithHttpInfo(List<String> accession, Double confidence, List<String> gene, Integer limit, Integer page) throws ApiException {
        okhttp3.Call localVarCall = getIntactUsingGETValidateBeforeCall(accession, confidence, gene, limit, page, null);
        Type localVarReturnType = new TypeToken<IntactInteractions>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Molecular Interactions collected from IntAct (asynchronously)
     * 
     * @param accession accession (optional)
     * @param confidence confidence (optional)
     * @param gene gene (optional)
     ...
     */
    public okhttp3.Call getIntactUsingGETAsync(List<String> accession, Double confidence, List<String> gene, Integer limit, Integer page, final ApiCallback<IntactInteractions> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIntactUsingGETValidateBeforeCall(accession, confidence, gene, limit, page, _callback);
        Type localVarReturnType = new TypeToken<IntactInteractions>(){}.getType();
