...
public class OpenTargets {
  ...
  public OpenTargets id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OpenTargets openTargets = (OpenTargets) o;
    return Objects.equals(this.id, openTargets.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenTargets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenTargets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenTargets is not found in the empty JSON string", OpenTargets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenTargets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenTargets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenTargets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenTargets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenTargets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenTargets.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenTargets>() {
           @Override
           public void write(JsonWriter out, OpenTargets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OpenTargets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OpenTargets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OpenTargets
   * @throws IOException if the JSON string is invalid with respect to OpenTargets
   */
  public static OpenTargets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenTargets.class);
  }

  /**
   * Convert an instance of OpenTargets to an JSON string
   *
   * @return JSON string
   */
