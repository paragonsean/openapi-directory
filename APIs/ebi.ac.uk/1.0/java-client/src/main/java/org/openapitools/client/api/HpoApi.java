...
public class HpoApi {
    ...
    public HpoApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getHpoUsingGET
     * @param genesymbol genesymbol (optional)
     * @param hpotermname hpotermname (optional)
     ...
     */
    public okhttp3.Call getHpoUsingGETCall(List<String> genesymbol, List<String> hpotermname, Integer limit, Integer page, List<String> synonym, final ApiCallback _callback) throws ApiException {
        ...
        if (genesymbol != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "genesymbol", genesymbol));
        }

        if (hpotermname != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "hpotermname", hpotermname));
        }
    ...
    private okhttp3.Call getHpoUsingGETValidateBeforeCall(List<String> genesymbol, List<String> hpotermname, Integer limit, Integer page, List<String> synonym, final ApiCallback _callback) throws ApiException {
        return getHpoUsingGETCall(genesymbol, hpotermname, limit, page, synonym, _callback);
     ...
     */
    public HpoEntities getHpoUsingGET(List<String> genesymbol, List<String> hpotermname, Integer limit, Integer page, List<String> synonym) throws ApiException {
        ApiResponse<HpoEntities> localVarResp = getHpoUsingGETWithHttpInfo(genesymbol, hpotermname, limit, page, synonym);
     ...
     * @param page page (optional, default to 0)
     * @param synonym synonym (optional)
     * @return ApiResponse&lt;HpoEntities&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<HpoEntities> getHpoUsingGETWithHttpInfo(List<String> genesymbol, List<String> hpotermname, Integer limit, Integer page, List<String> synonym) throws ApiException {
        okhttp3.Call localVarCall = getHpoUsingGETValidateBeforeCall(genesymbol, hpotermname, limit, page, synonym, null);
        Type localVarReturnType = new TypeToken<HpoEntities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get HPO phenotypes data (asynchronously)
     * 
     * @param genesymbol genesymbol (optional)
     * @param hpotermname hpotermname (optional)
     * @param limit limit (optional, default to 10)
     ...
     */
    public okhttp3.Call getHpoUsingGETAsync(List<String> genesymbol, List<String> hpotermname, Integer limit, Integer page, List<String> synonym, final ApiCallback<HpoEntities> _callback) throws ApiException {

        okhttp3.Call localVarCall = getHpoUsingGETValidateBeforeCall(genesymbol, hpotermname, limit, page, synonym, _callback);
        Type localVarReturnType = new TypeToken<HpoEntities>(){}.getType();
