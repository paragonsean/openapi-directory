...
public class ApiClient {
    ...
    private String basePath = "http://api.citycontext.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("user_key", new ApiKeyAuth("query", "user_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.citycontext.com/v1
