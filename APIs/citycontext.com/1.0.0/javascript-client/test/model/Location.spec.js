...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CityContext.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new CityContext.Location();
      //expect(instance).to.be.a(CityContext.Location);
    });
    ...
    it('should have the property withinLondonCCZ (base name: "withinLondonCCZ")', function() {
      // uncomment below and update the code to test the property withinLondonCCZ
      //var instance = new CityContext.Location();
      //expect(instance).to.be();
    });
