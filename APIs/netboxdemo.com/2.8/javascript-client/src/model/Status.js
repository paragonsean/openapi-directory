...
class Status {
     ...
     * @param label {module:model/Status.LabelEnum} 
     * @param value {module:model/Status.ValueEnum} 
     */
    constructor(label, value) { 
        
        Status.initialize(this, label, value);
    }
...
Status.RequiredProperties = ["label", "value"];

/**
 * @member {module:model/Status.LabelEnum} label
 */
Status.prototype['label'] = undefined;
