...
(function(root, factory) {
  ...
  describe('DcimApi', function() {
    ...
    describe('dcimDevicesGraphs', function() {
      it('should call dcimDevicesGraphs successfully', function(done) {
        //uncomment below and update the code to test dcimDevicesGraphs
        //instance.dcimDevicesGraphs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dcimFrontPortsTrace', function() {
      it('should call dcimFrontPortsTrace successfully', function(done) {
        //uncomment below and update the code to test dcimFrontPortsTrace
        //instance.dcimFrontPortsTrace(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('dcimRearPortsTrace', function() {
      it('should call dcimRearPortsTrace successfully', function(done) {
        //uncomment below and update the code to test dcimRearPortsTrace
        //instance.dcimRearPortsTrace(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
