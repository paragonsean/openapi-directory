...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.DeviceWithConfigContext();
  });
  ...
  describe('DeviceWithConfigContext', function() {
    it('should create an instance of DeviceWithConfigContext', function() {
      // uncomment below and update the code to test DeviceWithConfigContext
      //var instance = new NetBoxApi.DeviceWithConfigContext();
      //expect(instance).to.be.a(NetBoxApi.DeviceWithConfigContext);
    });
