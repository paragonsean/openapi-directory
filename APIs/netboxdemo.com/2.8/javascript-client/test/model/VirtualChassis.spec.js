...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.VirtualChassis();
  });
  ...
  describe('VirtualChassis', function() {
    it('should create an instance of VirtualChassis', function() {
      // uncomment below and update the code to test VirtualChassis
      //var instance = new NetBoxApi.VirtualChassis();
      //expect(instance).to.be.a(NetBoxApi.VirtualChassis);
    });
