...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableVirtualChassis();
  });
  ...
  describe('WritableVirtualChassis', function() {
    it('should create an instance of WritableVirtualChassis', function() {
      // uncomment below and update the code to test WritableVirtualChassis
      //var instance = new NetBoxApi.WritableVirtualChassis();
      //expect(instance).to.be.a(NetBoxApi.WritableVirtualChassis);
    });
