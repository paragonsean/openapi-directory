...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.AvailableIP();
  });
  ...
  describe('AvailableIP', function() {
    it('should create an instance of AvailableIP', function() {
      // uncomment below and update the code to test AvailableIP
      //var instance = new NetBoxApi.AvailableIP();
      //expect(instance).to.be.a(NetBoxApi.AvailableIP);
    });
