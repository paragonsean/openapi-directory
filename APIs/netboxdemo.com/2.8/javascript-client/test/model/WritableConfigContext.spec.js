...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableConfigContext();
  });
  ...
  describe('WritableConfigContext', function() {
    it('should create an instance of WritableConfigContext', function() {
      // uncomment below and update the code to test WritableConfigContext
      //var instance = new NetBoxApi.WritableConfigContext();
      //expect(instance).to.be.a(NetBoxApi.WritableConfigContext);
    });
