...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableCluster();
  });
  ...
  describe('WritableCluster', function() {
    it('should create an instance of WritableCluster', function() {
      // uncomment below and update the code to test WritableCluster
      //var instance = new NetBoxApi.WritableCluster();
      //expect(instance).to.be.a(NetBoxApi.WritableCluster);
    });
