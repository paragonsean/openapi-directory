...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.RackUnit();
  });
  ...
  describe('RackUnit', function() {
    it('should create an instance of RackUnit', function() {
      // uncomment below and update the code to test RackUnit
      //var instance = new NetBoxApi.RackUnit();
      //expect(instance).to.be.a(NetBoxApi.RackUnit);
    });
