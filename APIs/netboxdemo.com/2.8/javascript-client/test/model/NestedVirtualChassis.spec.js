...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedVirtualChassis();
  });
  ...
  describe('NestedVirtualChassis', function() {
    it('should create an instance of NestedVirtualChassis', function() {
      // uncomment below and update the code to test NestedVirtualChassis
      //var instance = new NetBoxApi.NestedVirtualChassis();
      //expect(instance).to.be.a(NetBoxApi.NestedVirtualChassis);
    });
