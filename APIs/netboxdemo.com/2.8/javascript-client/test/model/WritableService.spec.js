...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableService();
  });
  ...
  describe('WritableService', function() {
    it('should create an instance of WritableService', function() {
      // uncomment below and update the code to test WritableService
      //var instance = new NetBoxApi.WritableService();
      //expect(instance).to.be.a(NetBoxApi.WritableService);
    });
