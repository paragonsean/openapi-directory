...
QString OAIPhase::getLabel() const {
    return m_label;
}
void OAIPhase::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPhase::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPhase::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIPhase::getValue() const {
    return m_value;
}
void OAIPhase::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIPhase::is_value_Set() const{
    return m_value_isSet;
}

bool OAIPhase::is_value_Valid() const{
