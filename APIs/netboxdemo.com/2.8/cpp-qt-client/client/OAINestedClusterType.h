...
/*
 * OAINestedClusterType.h
 *
 * 
 */

#ifndef OAINestedClusterType_H
#define OAINestedClusterType_H
...
class OAINestedClusterType : public OAIObject {
public:
    OAINestedClusterType();
    OAINestedClusterType(QString json);
    ~OAINestedClusterType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedClusterType)

#endif // OAINestedClusterType_H
