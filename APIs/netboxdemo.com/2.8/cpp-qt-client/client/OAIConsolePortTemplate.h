...
/*
 * OAIConsolePortTemplate.h
 *
 * 
 */

#ifndef OAIConsolePortTemplate_H
#define OAIConsolePortTemplate_H
...
class OAIConsolePortTemplate : public OAIObject {
public:
    OAIConsolePortTemplate();
    OAIConsolePortTemplate(QString json);
    ~OAIConsolePortTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsolePortTemplate)

#endif // OAIConsolePortTemplate_H
