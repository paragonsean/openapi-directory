...
/*
 * OAINestedPowerPort.h
 *
 * 
 */

#ifndef OAINestedPowerPort_H
#define OAINestedPowerPort_H
...
class OAINestedPowerPort : public OAIObject {
public:
    OAINestedPowerPort();
    OAINestedPowerPort(QString json);
    ~OAINestedPowerPort() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedPowerPort)

#endif // OAINestedPowerPort_H
