...
/*
 * OAIDeviceBayTemplate.h
 *
 * 
 */

#ifndef OAIDeviceBayTemplate_H
#define OAIDeviceBayTemplate_H
...
class OAIDeviceBayTemplate : public OAIObject {
public:
    OAIDeviceBayTemplate();
    OAIDeviceBayTemplate(QString json);
    ~OAIDeviceBayTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceBayTemplate)

#endif // OAIDeviceBayTemplate_H
