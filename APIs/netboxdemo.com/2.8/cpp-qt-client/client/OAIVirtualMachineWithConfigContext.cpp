...
QMap<QString, QString> OAIVirtualMachineWithConfigContext::getConfigContext() const {
    return m_config_context;
}
void OAIVirtualMachineWithConfigContext::setConfigContext(const QMap<QString, QString> &config_context) {
...
OAIStatus_9 OAIVirtualMachineWithConfigContext::getStatus() const {
    return m_status;
}
void OAIVirtualMachineWithConfigContext::setStatus(const OAIStatus_9 &status) {
    m_status = status;
    m_status_isSet = true;
}
