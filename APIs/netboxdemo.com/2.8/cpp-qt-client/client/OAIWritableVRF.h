...
#ifndef OAIWritableVRF_H
#define OAIWritableVRF_H
...
class OAIWritableVRF : public OAIObject {
public:
    OAIWritableVRF();
    OAIWritableVRF(QString json);
    ~OAIWritableVRF() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableVRF)

#endif // OAIWritableVRF_H
