...
/*
 * OAINestedCircuitType.h
 *
 * 
 */

#ifndef OAINestedCircuitType_H
#define OAINestedCircuitType_H
...
class OAINestedCircuitType : public OAIObject {
public:
    OAINestedCircuitType();
    OAINestedCircuitType(QString json);
    ~OAINestedCircuitType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedCircuitType)

#endif // OAINestedCircuitType_H
