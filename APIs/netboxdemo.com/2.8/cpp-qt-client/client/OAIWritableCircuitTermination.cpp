...
QMap<QString, QString> OAIWritableCircuitTermination::getConnectedEndpoint() const {
    return m_connected_endpoint;
}
void OAIWritableCircuitTermination::setConnectedEndpoint(const QMap<QString, QString> &connected_endpoint) {
    m_connected_endpoint = connected_endpoint;
    m_connected_endpoint_isSet = true;
}

bool OAIWritableCircuitTermination::is_connected_endpoint_Set() const{
    return m_connected_endpoint_isSet;
}

bool OAIWritableCircuitTermination::is_connected_endpoint_Valid() const{
    return m_connected_endpoint_isValid;
}

QString OAIWritableCircuitTermination::getConnectedEndpointType() const {
    return m_connected_endpoint_type;
}
void OAIWritableCircuitTermination::setConnectedEndpointType(const QString &connected_endpoint_type) {
    m_connected_endpoint_type = connected_endpoint_type;
    m_connected_endpoint_type_isSet = true;
}

bool OAIWritableCircuitTermination::is_connected_endpoint_type_Set() const{
    return m_connected_endpoint_type_isSet;
}

bool OAIWritableCircuitTermination::is_connected_endpoint_type_Valid() const{
    return m_connected_endpoint_type_isValid;
}

bool OAIWritableCircuitTermination::isConnectionStatus() const {
    return m_connection_status;
}
void OAIWritableCircuitTermination::setConnectionStatus(const bool &connection_status) {
    m_connection_status = connection_status;
    m_connection_status_isSet = true;
}

bool OAIWritableCircuitTermination::is_connection_status_Set() const{
    return m_connection_status_isSet;
}

bool OAIWritableCircuitTermination::is_connection_status_Valid() const{
