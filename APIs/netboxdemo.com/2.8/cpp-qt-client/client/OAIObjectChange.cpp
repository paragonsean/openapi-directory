...
QMap<QString, QString> OAIObjectChange::getChangedObject() const {
    return m_changed_object;
}
void OAIObjectChange::setChangedObject(const QMap<QString, QString> &changed_object) {
