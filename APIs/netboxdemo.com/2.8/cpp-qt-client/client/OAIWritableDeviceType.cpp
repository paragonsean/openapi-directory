...
QString OAIWritableDeviceType::getDisplayName() const {
    return m_display_name;
}
void OAIWritableDeviceType::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIWritableDeviceType::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIWritableDeviceType::is_display_name_Valid() const{
