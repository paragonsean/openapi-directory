...
#ifndef OAINestedRegion_H
#define OAINestedRegion_H
...
class OAINestedRegion : public OAIObject {
public:
    OAINestedRegion();
    OAINestedRegion(QString json);
    ~OAINestedRegion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedRegion)

#endif // OAINestedRegion_H
