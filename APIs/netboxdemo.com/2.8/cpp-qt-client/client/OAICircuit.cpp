...
QDate OAICircuit::getCreated() const {
    return m_created;
}
void OAICircuit::setCreated(const QDate &created) {
    m_created = created;
...
QList<QString> OAICircuit::getTags() const {
    return m_tags;
}
void OAICircuit::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
