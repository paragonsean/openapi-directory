...
class NestedDeviceType(Model):
    ...
    def __init__(self, device_count: int=None, display_name: str=None, id: int=None, manufacturer: NestedManufacturer=None, model: str=None, slug: str=None, url: str=None):
        """NestedDeviceType - a model defined in OpenAPI

        :param device_count: The device_count of this NestedDeviceType.
        :param display_name: The display_name of this NestedDeviceType.
    ...
    def device_count(self):
        """Gets the device_count of this NestedDeviceType.


        :return: The device_count of this NestedDeviceType.
        :rtype: int
        """
    ...
    def display_name(self):
        """Gets the display_name of this NestedDeviceType.


        :return: The display_name of this NestedDeviceType.
        :rtype: str
        """
