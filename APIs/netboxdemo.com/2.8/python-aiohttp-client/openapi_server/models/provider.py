...
class Provider(Model):
    ...
    def __init__(self, account: str=None, admin_contact: str=None, asn: int=None, circuit_count: int=None, comments: str=None, created: date=None, custom_fields: object=None, id: int=None, last_updated: datetime=None, name: str=None, noc_contact: str=None, portal_url: str=None, slug: str=None, tags: List[str]=None):
