...
class WritablePrefix(Model):
    ...
    def __init__(self, created: date=None, custom_fields: object=None, description: str=None, family: str=None, id: int=None, is_pool: bool=None, last_updated: datetime=None, prefix: str=None, role: int=None, site: int=None, status: str=None, tags: List[str]=None, tenant: int=None, vlan: int=None, vrf: int=None):
