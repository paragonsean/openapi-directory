...
class Graph(Model):
    ...
    def __init__(self, id: int=None, link: str=None, name: str=None, source: str=None, template_language: str=None, type: str=None, weight: int=None):
        ...
        :param template_language: The template_language of this Graph.
    ...
    def template_language(self):
        """Gets the template_language of this Graph.


        :return: The template_language of this Graph.
        :rtype: str
        """
    ...
    def template_language(self, template_language):
        """Sets the template_language of this Graph.
