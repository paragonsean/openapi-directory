...
class ImageAttachment(Model):
    ...
    def __init__(self, content_type: str=None, created: datetime=None, id: int=None, image: str=None, image_height: int=None, image_width: int=None, name: str=None, object_id: int=None, parent: Dict[str, str]=None):
