...
class ObjectChange(Model):
    ...
    def __init__(self, action: Action=None, changed_object: Dict[str, str]=None, changed_object_id: int=None, changed_object_type: str=None, id: int=None, object_data: str=None, request_id: str=None, time: datetime=None, user: NestedUser=None, user_name: str=None):
        ...
        :param object_data: The object_data of this ObjectChange.
    ...
    def changed_object(self, changed_object):
        ...
        :param changed_object: The changed_object of this ObjectChange.
        :type changed_object: Dict[str, str]
        """
    ...
    def changed_object_id(self, changed_object_id):
        ...
        if changed_object_id is not None and changed_object_id > 2147483647:
            raise ValueError("Invalid value for `changed_object_id`, must be a value less than or equal to `2147483647`")
    ...
    def object_data(self):
        """Gets the object_data of this ObjectChange.


        :return: The object_data of this ObjectChange.
        :rtype: str
        """
