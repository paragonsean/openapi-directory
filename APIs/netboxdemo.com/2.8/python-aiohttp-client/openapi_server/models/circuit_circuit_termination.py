...
class CircuitCircuitTermination(Model):
    ...
    def __init__(self, connected_endpoint: NestedInterface=None, id: int=None, port_speed: int=None, site: NestedSite=None, upstream_speed: int=None, url: str=None, xconnect_id: str=None):
        """CircuitCircuitTermination - a model defined in OpenAPI

        :param connected_endpoint: The connected_endpoint of this CircuitCircuitTermination.
    ...
    def connected_endpoint(self):
        """Gets the connected_endpoint of this CircuitCircuitTermination.


        :return: The connected_endpoint of this CircuitCircuitTermination.
    ...
    def connected_endpoint(self, connected_endpoint):
        ...
        :param connected_endpoint: The connected_endpoint of this CircuitCircuitTermination.
        :type connected_endpoint: NestedInterface
        """
        if connected_endpoint is None:
            raise ValueError("Invalid value for `connected_endpoint`, must not be `None`")
