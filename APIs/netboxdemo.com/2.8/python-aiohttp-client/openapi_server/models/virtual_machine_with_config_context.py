...
class VirtualMachineWithConfigContext(Model):
    ...
    def __init__(self, cluster: NestedCluster=None, comments: str=None, config_context: Dict[str, str]=None, created: date=None, custom_fields: object=None, disk: int=None, id: int=None, last_updated: datetime=None, local_context_data: str=None, memory: int=None, name: str=None, platform: NestedPlatform=None, primary_ip: NestedIPAddress=None, primary_ip4: NestedIPAddress=None, primary_ip6: NestedIPAddress=None, role: NestedDeviceRole=None, site: NestedSite=None, status: Status9=None, tags: List[str]=None, tenant: NestedTenant=None, vcpus: int=None):
