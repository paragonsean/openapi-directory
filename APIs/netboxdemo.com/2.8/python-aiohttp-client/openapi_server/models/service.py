...
class Service(Model):
    ...
    def __init__(self, created: date=None, custom_fields: object=None, description: str=None, device: NestedDevice=None, id: int=None, ipaddresses: list[NestedIPAddress]=None, last_updated: datetime=None, name: str=None, port: int=None, protocol: Protocol=None, tags: List[str]=None, virtual_machine: NestedVirtualMachine=None):
