...
class ConfigContext(Model):
    ...
    def __init__(self, cluster_groups: list[NestedClusterGroup]=None, clusters: list[NestedCluster]=None, data: str=None, description: str=None, id: int=None, is_active: bool=None, name: str=None, platforms: list[NestedPlatform]=None, regions: list[NestedRegion]=None, roles: list[NestedDeviceRole]=None, sites: list[NestedSite]=None, tags: list[str]=None, tenant_groups: list[NestedTenantGroup]=None, tenants: list[NestedTenant]=None, weight: int=None):
