...
class Status4(Model):
    ...
    def __init__(self, label: str=None, value: str=None):
        """Status4 - a model defined in OpenAPI

        :param label: The label of this Status4.
        :param value: The value of this Status4.
        """
        self.openapi_types = {
            'label': str,
            'value': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Status4':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Status_4 of this Status4.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def label(self):
        """Gets the label of this Status4.


        :return: The label of this Status4.
        :rtype: str
        """
        return self._label
    ...
    @property
    def value(self):
        """Gets the value of this Status4.


        :return: The value of this Status4.
        :rtype: str
        """
        return self._value
