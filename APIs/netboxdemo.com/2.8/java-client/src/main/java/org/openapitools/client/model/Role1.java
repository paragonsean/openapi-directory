...
public class Role1 {
  ...
  public Role1 label(LabelEnum label) {
    this.label = label;
    return this;
  }
  ...
  public Role1 value(ValueEnum value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Role1 role1 = (Role1) o;
    return Objects.equals(this.label, role1.label) &&
        Objects.equals(this.value, role1.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Role1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role1 is not found in the empty JSON string", Role1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Role1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Role1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Role1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role1.class));
