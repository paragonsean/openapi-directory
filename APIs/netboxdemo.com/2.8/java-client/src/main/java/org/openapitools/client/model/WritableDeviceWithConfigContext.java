...
public class WritableDeviceWithConfigContext {
  ...
  public WritableDeviceWithConfigContext position(Integer position) {
  ...
  public WritableDeviceWithConfigContext tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public WritableDeviceWithConfigContext addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assetTag, writableDeviceWithConfigContext.assetTag) &&
        ...
        Objects.equals(this.displayName, writableDeviceWithConfigContext.displayName) &&
        Objects.equals(this.face, writableDeviceWithConfigContext.face) &&
        Objects.equals(this.id, writableDeviceWithConfigContext.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to WritableDeviceWithConfigContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WritableDeviceWithConfigContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WritableDeviceWithConfigContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableDeviceWithConfigContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
