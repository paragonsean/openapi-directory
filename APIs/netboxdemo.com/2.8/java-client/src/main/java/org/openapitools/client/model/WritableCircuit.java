...
public class WritableCircuit {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("termination_a") != null && !jsonObj.get("termination_a").isJsonNull()) && !jsonObj.get("termination_a").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `termination_a` to be a primitive type in the JSON string but got `%s`", jsonObj.get("termination_a").toString()));
      }
      if ((jsonObj.get("termination_z") != null && !jsonObj.get("termination_z").isJsonNull()) && !jsonObj.get("termination_z").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `termination_z` to be a primitive type in the JSON string but got `%s`", jsonObj.get("termination_z").toString()));
      }
  }
