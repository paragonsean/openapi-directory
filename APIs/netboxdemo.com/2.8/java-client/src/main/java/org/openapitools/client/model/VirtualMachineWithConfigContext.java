...
public class VirtualMachineWithConfigContext {
  ...
  public VirtualMachineWithConfigContext status(Status9 status) {
    this.status = status;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cluster, comments, configContext, created, customFields, disk, id, lastUpdated, localContextData, memory, name, platform, primaryIp, primaryIp4, primaryIp6, role, site, status, tags, tenant, vcpus);
  }
