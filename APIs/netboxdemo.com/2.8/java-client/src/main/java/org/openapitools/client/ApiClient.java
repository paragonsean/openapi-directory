...
public class ApiClient {
    ...
    private String basePath = "https://netboxdemo.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.8/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://netboxdemo.com/api
