...
public class WritableVirtualMachineWithConfigContext {
  ...
  public WritableVirtualMachineWithConfigContext tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public WritableVirtualMachineWithConfigContext addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public WritableVirtualMachineWithConfigContext vcpus(Integer vcpus) {
    this.vcpus = vcpus;
    return this;
  }
