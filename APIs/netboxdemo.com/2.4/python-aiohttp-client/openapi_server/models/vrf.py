...
class VRF(Model):
    ...
    def __init__(self, created: date=None, custom_fields: object=None, description: str=None, display_name: str=None, enforce_unique: bool=None, id: int=None, last_updated: datetime=None, name: str=None, rd: str=None, tags: List[str]=None, tenant: NestedTenant=None):
