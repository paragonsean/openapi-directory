...
class WritableCircuitTermination(Model):
    ...
    def __init__(self, circuit: int=None, id: int=None, interface: int=None, port_speed: int=None, pp_info: str=None, site: int=None, term_side: str=None, upstream_speed: int=None, xconnect_id: str=None):
        ...
        :param interface: The interface of this WritableCircuitTermination.
    ...
    @property
    def interface(self):
        """Gets the interface of this WritableCircuitTermination.


        :return: The interface of this WritableCircuitTermination.
        :rtype: int
        """
    ...
    def interface(self, interface):
        """Sets the interface of this WritableCircuitTermination.
