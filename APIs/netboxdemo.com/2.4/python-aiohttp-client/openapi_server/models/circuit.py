...
class Circuit(Model):
    ...
    def __init__(self, cid: str=None, comments: str=None, commit_rate: int=None, created: date=None, custom_fields: object=None, description: str=None, id: int=None, install_date: date=None, last_updated: datetime=None, provider: NestedProvider=None, status: Status=None, tags: List[str]=None, tenant: NestedTenant=None, type: NestedCircuitType=None):
