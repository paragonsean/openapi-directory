...
class WritableIPAddress(Model):
    ...
    def __init__(self, address: str=None, created: date=None, custom_fields: object=None, description: str=None, family: int=None, id: int=None, interface: int=None, last_updated: datetime=None, nat_inside: int=None, nat_outside: int=None, role: int=None, status: int=None, tags: List[str]=None, tenant: int=None, vrf: int=None):
    ...
    def role(self, role):
        ...
        :type role: int
        """
        allowed_values = [10, 20, 30, 40, 41, 42, 43, 44]  # noqa: E501
    ...
    def status(self, status):
        ...
        :type status: int
        """
        allowed_values = [1, 2, 3, 5]  # noqa: E501
