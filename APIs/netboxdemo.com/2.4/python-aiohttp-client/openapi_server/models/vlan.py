...
class VLAN(Model):
    ...
    def __init__(self, created: date=None, custom_fields: object=None, description: str=None, display_name: str=None, group: NestedVLANGroup=None, id: int=None, last_updated: datetime=None, name: str=None, role: NestedRole=None, site: NestedSite=None, status: Status=None, tags: List[str]=None, tenant: NestedTenant=None, vid: int=None):
