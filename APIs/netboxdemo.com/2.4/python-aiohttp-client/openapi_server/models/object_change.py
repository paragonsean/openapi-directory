...
class ObjectChange(Model):
    ...
    def __init__(self, action: int=None, changed_object: str=None, content_type: str=None, id: int=None, object_data: str=None, request_id: str=None, time: datetime=None, user: NestedUser=None, user_name: str=None):
        ...
        :param content_type: The content_type of this ObjectChange.
    ...
    def content_type(self):
        """Gets the content_type of this ObjectChange.


        :return: The content_type of this ObjectChange.
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this ObjectChange.
