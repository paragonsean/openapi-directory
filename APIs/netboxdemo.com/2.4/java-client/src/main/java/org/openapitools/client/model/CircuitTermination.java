...
public class CircuitTermination {
  ...
  private NestedInterface _interface;
  ...
  public CircuitTermination _interface(NestedInterface _interface) {
   ...
   */
  @javax.annotation.Nullable
  public NestedInterface getInterface() {
    return _interface;
  }

  public void setInterface(NestedInterface _interface) {
    this._interface = _interface;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.circuit, circuitTermination.circuit) &&
        Objects.equals(this.id, circuitTermination.id) &&
        Objects.equals(this._interface, circuitTermination._interface) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("interface") != null && !jsonObj.get("interface").isJsonNull()) {
        NestedInterface.validateJsonElement(jsonObj.get("interface"));
      }
