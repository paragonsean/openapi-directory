...
public class WritableDevice {
  ...
  public enum FaceEnum {
    ...
    public static FaceEnum fromValue(Integer value) {
  ...
  public WritableDevice face(FaceEnum face) {
    this.face = face;
    return this;
  }
  ...
  public WritableDevice status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assetTag, writableDevice.assetTag) &&
        ...
        Objects.equals(this.id, writableDevice.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assetTag, cluster, comments, created, customFields, deviceRole, deviceType, displayName, face, id, lastUpdated, localContextData, name, parentDevice, platform, position, primaryIp, primaryIp4, primaryIp6, rack, serial, site, status, tags, tenant, vcPosition, vcPriority, virtualChassis);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WritableDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WritableDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WritableDevice is not found in the empty JSON string", WritableDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WritableDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WritableDevice.openapiRequiredFields) {
      ...
      if (jsonObj.get("face") != null && !jsonObj.get("face").isJsonNull()) {
        FaceEnum.validateJsonElement(jsonObj.get("face"));
      }
      ...
      if ((jsonObj.get("parent_device") != null && !jsonObj.get("parent_device").isJsonNull()) && !jsonObj.get("parent_device").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `parent_device` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parent_device").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WritableDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WritableDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WritableDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WritableDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<WritableDevice>() {
           @Override
           public void write(JsonWriter out, WritableDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WritableDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WritableDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WritableDevice
   * @throws IOException if the JSON string is invalid with respect to WritableDevice
   */
  public static WritableDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WritableDevice.class);
  }

  /**
   * Convert an instance of WritableDevice to an JSON string
   *
   * @return JSON string
   */
