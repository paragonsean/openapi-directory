...
public class DcimDeviceRolesList200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, dcimDeviceRolesList200Response.count) &&
        Objects.equals(this.next, dcimDeviceRolesList200Response.next) &&
        Objects.equals(this.previous, dcimDeviceRolesList200Response.previous) &&
        Objects.equals(this.results, dcimDeviceRolesList200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DcimDeviceRolesList200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DcimDeviceRolesList200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DcimDeviceRolesList200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DcimDeviceRolesList200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        DeviceRole.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DcimDeviceRolesList200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DcimDeviceRolesList200Response.class));
