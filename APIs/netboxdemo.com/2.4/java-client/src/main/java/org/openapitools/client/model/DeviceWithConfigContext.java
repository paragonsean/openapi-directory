...
public class DeviceWithConfigContext {
  ...
  private DeviceVirtualChassis virtualChassis;
  ...
  public DeviceWithConfigContext primaryIp(DeviceIPAddress primaryIp) {
   ...
   */
  @javax.annotation.Nullable
  public DeviceIPAddress getPrimaryIp() {
    return primaryIp;
  }

  public void setPrimaryIp(DeviceIPAddress primaryIp) {
    this.primaryIp = primaryIp;
  }


  public DeviceWithConfigContext primaryIp4(DeviceIPAddress primaryIp4) {
   ...
   */
  @javax.annotation.Nullable
  public DeviceIPAddress getPrimaryIp4() {
    return primaryIp4;
  }

  public void setPrimaryIp4(DeviceIPAddress primaryIp4) {
    this.primaryIp4 = primaryIp4;
  }


  public DeviceWithConfigContext primaryIp6(DeviceIPAddress primaryIp6) {
   ...
   */
  @javax.annotation.Nullable
  public DeviceIPAddress getPrimaryIp6() {
    return primaryIp6;
  }

  public void setPrimaryIp6(DeviceIPAddress primaryIp6) {
    this.primaryIp6 = primaryIp6;
  }
  ...
  public DeviceWithConfigContext status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public DeviceWithConfigContext virtualChassis(DeviceVirtualChassis virtualChassis) {
   ...
   */
  @javax.annotation.Nullable
  public DeviceVirtualChassis getVirtualChassis() {
    return virtualChassis;
  }

  public void setVirtualChassis(DeviceVirtualChassis virtualChassis) {
    this.virtualChassis = virtualChassis;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("virtual_chassis") != null && !jsonObj.get("virtual_chassis").isJsonNull()) {
        DeviceVirtualChassis.validateJsonElement(jsonObj.get("virtual_chassis"));
      }
  }
