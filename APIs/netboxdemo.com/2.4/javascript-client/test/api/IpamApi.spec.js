...
(function(root, factory) {
  ...
  describe('IpamApi', function() {
    ...
    describe('ipamChoicesList', function() {
      it('should call ipamChoicesList successfully', function(done) {
        //uncomment below and update the code to test ipamChoicesList
        //instance.ipamChoicesList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ipamChoicesRead', function() {
      it('should call ipamChoicesRead successfully', function(done) {
        //uncomment below and update the code to test ipamChoicesRead
        //instance.ipamChoicesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
