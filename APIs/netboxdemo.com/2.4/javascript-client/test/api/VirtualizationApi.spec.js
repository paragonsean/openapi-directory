...
(function(root, factory) {
  ...
  describe('VirtualizationApi', function() {
    describe('virtualizationChoicesList', function() {
      it('should call virtualizationChoicesList successfully', function(done) {
        //uncomment below and update the code to test virtualizationChoicesList
        //instance.virtualizationChoicesList(function(error) {
    ...
    describe('virtualizationChoicesRead', function() {
      it('should call virtualizationChoicesRead successfully', function(done) {
        //uncomment below and update the code to test virtualizationChoicesRead
        //instance.virtualizationChoicesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
