...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedPowerOutlet();
  });
  ...
  describe('NestedPowerOutlet', function() {
    it('should create an instance of NestedPowerOutlet', function() {
      // uncomment below and update the code to test NestedPowerOutlet
      //var instance = new NetBoxApi.NestedPowerOutlet();
      //expect(instance).to.be.a(NetBoxApi.NestedPowerOutlet);
    });
