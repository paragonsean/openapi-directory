...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedConsoleServerPort();
  });
  ...
  describe('NestedConsoleServerPort', function() {
    it('should create an instance of NestedConsoleServerPort', function() {
      // uncomment below and update the code to test NestedConsoleServerPort
      //var instance = new NetBoxApi.NestedConsoleServerPort();
      //expect(instance).to.be.a(NetBoxApi.NestedConsoleServerPort);
    });
