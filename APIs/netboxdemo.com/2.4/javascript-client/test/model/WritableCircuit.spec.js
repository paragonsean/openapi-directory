...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableCircuit();
  });
  ...
  describe('WritableCircuit', function() {
    it('should create an instance of WritableCircuit', function() {
      // uncomment below and update the code to test WritableCircuit
      //var instance = new NetBoxApi.WritableCircuit();
      //expect(instance).to.be.a(NetBoxApi.WritableCircuit);
    });
