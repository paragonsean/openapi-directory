...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableVLAN();
  });
  ...
  describe('WritableVLAN', function() {
    it('should create an instance of WritableVLAN', function() {
      // uncomment below and update the code to test WritableVLAN
      //var instance = new NetBoxApi.WritableVLAN();
      //expect(instance).to.be.a(NetBoxApi.WritableVLAN);
    });
