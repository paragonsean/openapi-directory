...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableDevice();
  });
  ...
  describe('WritableDevice', function() {
    it('should create an instance of WritableDevice', function() {
      // uncomment below and update the code to test WritableDevice
      //var instance = new NetBoxApi.WritableDevice();
      //expect(instance).to.be.a(NetBoxApi.WritableDevice);
    });
