...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableVirtualMachine();
  });
  ...
  describe('WritableVirtualMachine', function() {
    it('should create an instance of WritableVirtualMachine', function() {
      // uncomment below and update the code to test WritableVirtualMachine
      //var instance = new NetBoxApi.WritableVirtualMachine();
      //expect(instance).to.be.a(NetBoxApi.WritableVirtualMachine);
    });
