...
(function(root, factory) {
  ...
  describe('Site', function() {
    ...
    it('should have the property countCircuits (base name: "count_circuits")', function() {
      // uncomment below and update the code to test the property countCircuits
      //var instance = new NetBoxApi.Site();
      //expect(instance).to.be();
    });

    it('should have the property countDevices (base name: "count_devices")', function() {
      // uncomment below and update the code to test the property countDevices
      //var instance = new NetBoxApi.Site();
      //expect(instance).to.be();
    });

    it('should have the property countPrefixes (base name: "count_prefixes")', function() {
      // uncomment below and update the code to test the property countPrefixes
      //var instance = new NetBoxApi.Site();
      //expect(instance).to.be();
    });

    it('should have the property countRacks (base name: "count_racks")', function() {
      // uncomment below and update the code to test the property countRacks
      //var instance = new NetBoxApi.Site();
      //expect(instance).to.be();
    });

    it('should have the property countVlans (base name: "count_vlans")', function() {
      // uncomment below and update the code to test the property countVlans
      //var instance = new NetBoxApi.Site();
      //expect(instance).to.be();
    });
