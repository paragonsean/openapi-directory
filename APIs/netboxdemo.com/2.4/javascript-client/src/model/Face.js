...
class Face {
    ...
    constructor(label, value) { 
        ...
        Face.initialize(this, label, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Face.RequiredProperties) {
...
Face.RequiredProperties = ["label", "value"];

/**
 * @member {String} label
 */
Face.prototype['label'] = undefined;

/**
 * @member {Number} value
 */
Face.prototype['value'] = undefined;
