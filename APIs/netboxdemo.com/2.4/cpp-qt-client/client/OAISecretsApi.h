...
public:
    ...
    virtual void secretsChoicesList();

    /**
    * @param[in]  id QString [required]
    */
    virtual void secretsChoicesRead(const QString &id);
    ...
    */
    virtual void secretsSecretRolesList(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &slug = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  offset qint32 [optional]
    */
    virtual void secretsSecretsList(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &id__in = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &q = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &role_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &role = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tag = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void secretsChoicesListCallback(OAIHttpRequestWorker *worker);
    void secretsChoicesReadCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void secretsChoicesListSignal();
    void secretsChoicesReadSignal();
    ...
    void secretsChoicesListSignalFull(OAIHttpRequestWorker *worker);
    void secretsChoicesReadSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use secretsChoicesListSignalError() instead")
    void secretsChoicesListSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void secretsChoicesListSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use secretsChoicesReadSignalError() instead")
    void secretsChoicesReadSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void secretsChoicesReadSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use secretsChoicesListSignalErrorFull() instead")
    void secretsChoicesListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void secretsChoicesListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use secretsChoicesReadSignalErrorFull() instead")
    void secretsChoicesReadSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void secretsChoicesReadSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
