...
qint32 OAIDeviceType::getInstanceCount() const {
    return m_instance_count;
}
void OAIDeviceType::setInstanceCount(const qint32 &instance_count) {
    m_instance_count = instance_count;
    m_instance_count_isSet = true;
}

bool OAIDeviceType::is_instance_count_Set() const{
    return m_instance_count_isSet;
}

bool OAIDeviceType::is_instance_count_Valid() const{
    return m_instance_count_isValid;
}

OAIInterface_ordering OAIDeviceType::getInterfaceOrdering() const {
    return m_interface_ordering;
}
void OAIDeviceType::setInterfaceOrdering(const OAIInterface_ordering &interface_ordering) {
    m_interface_ordering = interface_ordering;
    m_interface_ordering_isSet = true;
}

bool OAIDeviceType::is_interface_ordering_Set() const{
    return m_interface_ordering_isSet;
}

bool OAIDeviceType::is_interface_ordering_Valid() const{
    return m_interface_ordering_isValid;
}

bool OAIDeviceType::isIsConsoleServer() const {
    return m_is_console_server;
}
void OAIDeviceType::setIsConsoleServer(const bool &is_console_server) {
    m_is_console_server = is_console_server;
    m_is_console_server_isSet = true;
}

bool OAIDeviceType::is_is_console_server_Set() const{
    return m_is_console_server_isSet;
}

bool OAIDeviceType::is_is_console_server_Valid() const{
...
bool OAIDeviceType::isIsNetworkDevice() const {
    return m_is_network_device;
}
void OAIDeviceType::setIsNetworkDevice(const bool &is_network_device) {
    m_is_network_device = is_network_device;
    m_is_network_device_isSet = true;
}

bool OAIDeviceType::is_is_network_device_Set() const{
    return m_is_network_device_isSet;
}

bool OAIDeviceType::is_is_network_device_Valid() const{
    return m_is_network_device_isValid;
}

bool OAIDeviceType::isIsPdu() const {
    return m_is_pdu;
}
void OAIDeviceType::setIsPdu(const bool &is_pdu) {
    m_is_pdu = is_pdu;
    m_is_pdu_isSet = true;
}

bool OAIDeviceType::is_is_pdu_Set() const{
    return m_is_pdu_isSet;
}

bool OAIDeviceType::is_is_pdu_Valid() const{
