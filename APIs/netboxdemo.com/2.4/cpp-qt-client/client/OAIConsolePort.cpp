...
bool OAIConsolePort::isConnectionStatus() const {
    return m_connection_status;
}
void OAIConsolePort::setConnectionStatus(const bool &connection_status) {
...
OAINestedConsoleServerPort OAIConsolePort::getCsPort() const {
    return m_cs_port;
}
void OAIConsolePort::setCsPort(const OAINestedConsoleServerPort &cs_port) {
    m_cs_port = cs_port;
    m_cs_port_isSet = true;
}

bool OAIConsolePort::is_cs_port_Set() const{
    return m_cs_port_isSet;
}

bool OAIConsolePort::is_cs_port_Valid() const{
