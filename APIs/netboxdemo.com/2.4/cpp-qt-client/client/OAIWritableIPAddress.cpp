...
qint32 OAIWritableIPAddress::getFamily() const {
    return m_family;
}
void OAIWritableIPAddress::setFamily(const qint32 &family) {
    m_family = family;
    m_family_isSet = true;
}
...
qint32 OAIWritableIPAddress::getRole() const {
    return m_role;
}
void OAIWritableIPAddress::setRole(const qint32 &role) {
    m_role = role;
    m_role_isSet = true;
}
...
qint32 OAIWritableIPAddress::getStatus() const {
    return m_status;
}
void OAIWritableIPAddress::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}
