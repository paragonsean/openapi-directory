...
/*
 * OAIWritableService.h
 *
 * 
 */

#ifndef OAIWritableService_H
#define OAIWritableService_H
...
class OAIWritableService : public OAIObject {
public:
    OAIWritableService();
    OAIWritableService(QString json);
    ~OAIWritableService() override;
    ...
    QSet<qint32> getIpaddresses() const;
    void setIpaddresses(const QSet<qint32> &ipaddresses);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableService)

#endif // OAIWritableService_H
