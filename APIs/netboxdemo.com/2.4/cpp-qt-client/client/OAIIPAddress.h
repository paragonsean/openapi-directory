...
public:
    ...
    OAIIPAddressInterface getInterface() const;
    void setInterface(const OAIIPAddressInterface &interface);
    ...
    OAINestedIPAddress getNatOutside() const;
    void setNatOutside(const OAINestedIPAddress &nat_outside);
...
private:
    ...
    OAIIPAddressInterface m_interface;
    ...
    OAINestedIPAddress m_nat_outside;
