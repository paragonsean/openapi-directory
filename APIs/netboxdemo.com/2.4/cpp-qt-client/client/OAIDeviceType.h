...
public:
    ...
    OAIInterface_ordering getInterfaceOrdering() const;
    void setInterfaceOrdering(const OAIInterface_ordering &interface_ordering);
...
private:
    ...
    OAIInterface_ordering m_interface_ordering;
