...
/*
 * OAINestedConsoleServerPort.h
 *
 * 
 */

#ifndef OAINestedConsoleServerPort_H
#define OAINestedConsoleServerPort_H
...
class OAINestedConsoleServerPort : public OAIObject {
public:
    OAINestedConsoleServerPort();
    OAINestedConsoleServerPort(QString json);
    ~OAINestedConsoleServerPort() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedConsoleServerPort)

#endif // OAINestedConsoleServerPort_H
