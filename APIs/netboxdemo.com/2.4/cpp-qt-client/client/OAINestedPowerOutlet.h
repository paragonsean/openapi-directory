...
/*
 * OAINestedPowerOutlet.h
 *
 * 
 */

#ifndef OAINestedPowerOutlet_H
#define OAINestedPowerOutlet_H
...
class OAINestedPowerOutlet : public OAIObject {
public:
    OAINestedPowerOutlet();
    OAINestedPowerOutlet(QString json);
    ~OAINestedPowerOutlet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedPowerOutlet)

#endif // OAINestedPowerOutlet_H
