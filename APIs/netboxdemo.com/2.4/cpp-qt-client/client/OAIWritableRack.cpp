...
QDate OAIWritableRack::getCreated() const {
    return m_created;
}
void OAIWritableRack::setCreated(const QDate &created) {
    m_created = created;
...
QString OAIWritableRack::getDisplayName() const {
    return m_display_name;
}
void OAIWritableRack::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIWritableRack::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIWritableRack::is_display_name_Valid() const{
...
qint32 OAIWritableRack::getGroup() const {
    return m_group;
}
void OAIWritableRack::setGroup(const qint32 &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIWritableRack::is_group_Set() const{
    return m_group_isSet;
}

bool OAIWritableRack::is_group_Valid() const{
...
QList<QString> OAIWritableRack::getTags() const {
    return m_tags;
}
void OAIWritableRack::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
qint32 OAIWritableRack::getType() const {
    return m_type;
}
void OAIWritableRack::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}
