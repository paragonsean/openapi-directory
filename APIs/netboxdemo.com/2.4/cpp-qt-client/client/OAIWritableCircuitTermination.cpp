...
qint32 OAIWritableCircuitTermination::getInterface() const {
    return m_interface;
}
void OAIWritableCircuitTermination::setInterface(const qint32 &interface) {
    m_interface = interface;
    m_interface_isSet = true;
}

bool OAIWritableCircuitTermination::is_interface_Set() const{
    return m_interface_isSet;
}

bool OAIWritableCircuitTermination::is_interface_Valid() const{
