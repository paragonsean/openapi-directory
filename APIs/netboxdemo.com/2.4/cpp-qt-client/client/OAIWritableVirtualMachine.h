...
/*
 * OAIWritableVirtualMachine.h
 *
 * 
 */

#ifndef OAIWritableVirtualMachine_H
#define OAIWritableVirtualMachine_H
...
class OAIWritableVirtualMachine : public OAIObject {
public:
    OAIWritableVirtualMachine();
    OAIWritableVirtualMachine(QString json);
    ~OAIWritableVirtualMachine() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableVirtualMachine)

#endif // OAIWritableVirtualMachine_H
