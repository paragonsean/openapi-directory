...
QDate OAIWritableAggregate::getCreated() const {
    return m_created;
}
void OAIWritableAggregate::setCreated(const QDate &created) {
    m_created = created;
...
qint32 OAIWritableAggregate::getFamily() const {
    return m_family;
}
void OAIWritableAggregate::setFamily(const qint32 &family) {
    m_family = family;
    m_family_isSet = true;
}
...
QList<QString> OAIWritableAggregate::getTags() const {
    return m_tags;
}
void OAIWritableAggregate::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
