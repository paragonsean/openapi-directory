...
QDate OAISecret::getCreated() const {
    return m_created;
}
void OAISecret::setCreated(const QDate &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAISecret::is_created_Set() const{
    return m_created_isSet;
}

bool OAISecret::is_created_Valid() const{
    return m_created_isValid;
}

OAIObject OAISecret::getCustomFields() const {
    return m_custom_fields;
}
void OAISecret::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAISecret::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAISecret::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

OAINestedDevice OAISecret::getDevice() const {
    return m_device;
}
void OAISecret::setDevice(const OAINestedDevice &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAISecret::is_device_Set() const{
    return m_device_isSet;
}

bool OAISecret::is_device_Valid() const{
    return m_device_isValid;
}

QString OAISecret::getHash() const {
    return m_hash;
}
void OAISecret::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAISecret::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAISecret::is_hash_Valid() const{
    return m_hash_isValid;
}

qint32 OAISecret::getId() const {
    return m_id;
}
void OAISecret::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QDateTime OAISecret::getLastUpdated() const {
    return m_last_updated;
}
void OAISecret::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAISecret::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAISecret::is_last_updated_Valid() const{
...
QString OAISecret::getPlaintext() const {
    return m_plaintext;
}
void OAISecret::setPlaintext(const QString &plaintext) {
    m_plaintext = plaintext;
    m_plaintext_isSet = true;
}

bool OAISecret::is_plaintext_Set() const{
    return m_plaintext_isSet;
}

bool OAISecret::is_plaintext_Valid() const{
    return m_plaintext_isValid;
}

OAINestedSecretRole OAISecret::getRole() const {
    return m_role;
}
void OAISecret::setRole(const OAINestedSecretRole &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAISecret::is_role_Set() const{
    return m_role_isSet;
}

bool OAISecret::is_role_Valid() const{
    return m_role_isValid;
}

QList<QString> OAISecret::getTags() const {
    return m_tags;
}
void OAISecret::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISecret::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISecret::is_tags_Valid() const{
