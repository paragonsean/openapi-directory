...
QString OAIDevice::getParentDevice() const {
    return m_parent_device;
}
void OAIDevice::setParentDevice(const QString &parent_device) {
...
OAIDeviceIPAddress OAIDevice::getPrimaryIp() const {
    return m_primary_ip;
}
void OAIDevice::setPrimaryIp(const OAIDeviceIPAddress &primary_ip) {
...
OAIDeviceIPAddress OAIDevice::getPrimaryIp4() const {
    return m_primary_ip4;
}
void OAIDevice::setPrimaryIp4(const OAIDeviceIPAddress &primary_ip4) {
...
OAIDeviceIPAddress OAIDevice::getPrimaryIp6() const {
    return m_primary_ip6;
}
void OAIDevice::setPrimaryIp6(const OAIDeviceIPAddress &primary_ip6) {
...
OAIStatus OAIDevice::getStatus() const {
    return m_status;
}
void OAIDevice::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
OAIDeviceVirtualChassis OAIDevice::getVirtualChassis() const {
    return m_virtual_chassis;
}
void OAIDevice::setVirtualChassis(const OAIDeviceVirtualChassis &virtual_chassis) {
