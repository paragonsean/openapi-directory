...
OAIConnection_status OAIInterfaceConnection::getConnectionStatus() const {
    return m_connection_status;
}
void OAIInterfaceConnection::setConnectionStatus(const OAIConnection_status &connection_status) {
...
qint32 OAIInterfaceConnection::getId() const {
    return m_id;
}
void OAIInterfaceConnection::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInterfaceConnection::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInterfaceConnection::is_id_Valid() const{
    return m_id_isValid;
}
