# PandorabotsAIaaS.PandorabotsApiSwagger13Api
...
> atalkBot(appId, botname, input, opts)
...
```javascript
import PandorabotsAIaaS from 'pandorabots_a_iaa_s';
let defaultClient = PandorabotsAIaaS.ApiClient.instance;
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | The name of the bot. Format required is 3-64 characters in length and only numbers or lower-case letters [0-9][a-z]
let input = "input_example"; // String | Message to be sent to the bot. This can contain multiple sentences. Currently the limit is 500 characters.
let opts = {
...
apiInstance.atalkBot(appId, botname, input, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Your bot's name
apiInstance.compileBot(appId, botname, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Must be unique from all the other bots you have created under this app_id. Can only be numbers and lowercase letters, and must be between 3 and 64 characters long.
apiInstance.createBot(appId, botname, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> debugBot(appId, botname, input, opts)
...
let input = "input_example"; // String | Message to be sent to the bot. This can contain multiple sentences. Currently the limit is 500 characters.
let opts = {
  'clientName': "clientName_example", // String | Identifies your application's end user. You can assign each of your end users a unique client_name. This will allow you to set predicates and other variable information that is specific to an individual. Format required is 3-64 characters in length and only numbers or lower-case letters [0-9][a-z]
  'sessionid': "sessionid_example", // String | Session ID generated by Pandorabots. This allows the application to group individual conversations into a collection. While testing your bot, not including this parameter, Pandorabots will issue a new session ID. (4-byte integer type)
  'that': "that_example", // String | For debugging purposes, you can specify a 'that' with the input that supersedes the existing that in bot memory.
  'topic': "topic_example", // String | For debugging purposes, you can specify a 'topic' with the input that supersedes the existing topic in bot memory.
  'extra': "extra_example", // String | Return extra conversation information. If true, input, pattern, that, topic, filename, and template associated with the pattern matched are returned in addition to response and sessionid.
  'reset': "reset_example", // String | Reset the bot memory. If true, all predicate values in the bot will be discarded, and the user can talk to the bot as if it is the first time
  'trace': "trace_example", // String | Include trace data in the response. If true, the system will generate AIML trace information for the input. Trace data includes pattern matched, filename, input, template for all recursion levels. NOTE: for security reasons, trace does not work with client_name.
  'reload': "reload_example", // String | If true, the system will force a reload of the bot into memory. This can be useful if you've recently uploaded an AIML file, recompiled your bot and want access to your bot's latest changes.
  'recent': "recent_example" // String | If true, the system will not signal an error if the bot is uncompiled, and will instead look for a previous version of the bot that is available.
};
apiInstance.debugBot(appId, botname, input, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Name of the bot to delete.
apiInstance.deleteBot(appId, botname, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Name of the bot.
let fileKind = "fileKind_example"; // String | Specify the type of file being deleted: file (for AIML files), map, substitution, set
let filename = "filename_example"; // String | Filename to delete. Note: for non-AIML files, do not include the file extension in the path.
apiInstance.deleteBotFile1(appId, botname, fileKind, filename, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Name of the bot.
let fileKind = "fileKind_example"; // String | Specify the type of file being deleted: pdefaults, properties
apiInstance.deleteBotFile2(appId, botname, fileKind, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Name of the bot.
let fileKind = "fileKind_example"; // String | Specify the type of file being retrieved: file (for AIML files), map, substitution, set
let filename = "filename_example"; // String | Filename to retrieve. Note: for non-AIML files, do not include the file extension in the path.
apiInstance.getBotFile1(appId, botname, fileKind, filename, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Name of the bot.
let fileKind = "fileKind_example"; // String | Specify the type of file being retrieved: pdefaults, properties
apiInstance.getBotFile2(appId, botname, fileKind, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> listBotFiles(appId, botname, opts)
...
let opts = {
  '_return': "_return_example" // String | If set to zip, a zip file with all bot files will be returned.
};
apiInstance.listBotFiles(appId, botname, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new PandorabotsAIaaS.PandorabotsApiSwagger13Api();
let appId = "appId_example"; // String | Your Application ID
apiInstance.listBots(appId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Your bot's name
let fileKind = "fileKind_example"; // String | Specify the type of file being uploaded: file (for AIML files), map, substitution, set
let filename = "filename_example"; // String | Filename to upload, must be named with only lowercase letters and numbers. Note: for non-AIML files, do not include the file extension in the path.
let content = "content_example"; // String | Type or Paste in file contents.
apiInstance.uploadFile1(appId, botname, fileKind, filename, content, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let appId = "appId_example"; // String | Your Application ID
let botname = "botname_example"; // String | Your bot's name
let fileKind = "fileKind_example"; // String | Specify the type of file being uploaded: pdefaults, properties
let content = "content_example"; // String | Type or Paste in file contents.
apiInstance.uploadFile2(appId, botname, fileKind, content, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
