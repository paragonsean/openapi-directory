...
/*
 * OAIServiceBlockInputModel.h
 *
 * 
 */

#ifndef OAIServiceBlockInputModel_H
#define OAIServiceBlockInputModel_H
...
class OAIServiceBlockInputModel : public OAIObject {
public:
    OAIServiceBlockInputModel();
    OAIServiceBlockInputModel(QString json);
    ~OAIServiceBlockInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceBlockInputModel)

#endif // OAIServiceBlockInputModel_H
