...
/*
 * OAIResourceBlockViewModel.h
 *
 * 
 */

#ifndef OAIResourceBlockViewModel_H
#define OAIResourceBlockViewModel_H
...
class OAIResourceBlockViewModel : public OAIObject {
public:
    OAIResourceBlockViewModel();
    OAIResourceBlockViewModel(QString json);
    ~OAIResourceBlockViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceBlockViewModel)

#endif // OAIResourceBlockViewModel_H
