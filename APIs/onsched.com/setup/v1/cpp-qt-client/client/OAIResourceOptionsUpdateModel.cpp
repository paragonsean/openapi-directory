...
OAIResourceOptionsUpdateModel::OAIResourceOptionsUpdateModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceOptionsUpdateModel::OAIResourceOptionsUpdateModel() {
    this->initializeModel();
}

OAIResourceOptionsUpdateModel::~OAIResourceOptionsUpdateModel() {}

void OAIResourceOptionsUpdateModel::initializeModel() {
...
void OAIResourceOptionsUpdateModel::fromJson(QString jsonString) {
...
void OAIResourceOptionsUpdateModel::fromJsonObject(QJsonObject json) {
...
QString OAIResourceOptionsUpdateModel::asJson() const {
...
QJsonObject OAIResourceOptionsUpdateModel::asJsonObject() const {
    QJsonObject obj;
    if (m_bio_link_isSet) {
...
QString OAIResourceOptionsUpdateModel::getBioLink() const {
    return m_bio_link;
}
void OAIResourceOptionsUpdateModel::setBioLink(const QString &bio_link) {
    m_bio_link = bio_link;
    m_bio_link_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_bio_link_Set() const{
    return m_bio_link_isSet;
}

bool OAIResourceOptionsUpdateModel::is_bio_link_Valid() const{
    return m_bio_link_isValid;
}

qint32 OAIResourceOptionsUpdateModel::getBookingNotification() const {
    return m_booking_notification;
}
void OAIResourceOptionsUpdateModel::setBookingNotification(const qint32 &booking_notification) {
    m_booking_notification = booking_notification;
    m_booking_notification_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_booking_notification_Set() const{
    return m_booking_notification_isSet;
}

bool OAIResourceOptionsUpdateModel::is_booking_notification_Valid() const{
    return m_booking_notification_isValid;
}

qint32 OAIResourceOptionsUpdateModel::getCalendarAvailability() const {
    return m_calendar_availability;
}
void OAIResourceOptionsUpdateModel::setCalendarAvailability(const qint32 &calendar_availability) {
    m_calendar_availability = calendar_availability;
    m_calendar_availability_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_calendar_availability_Set() const{
    return m_calendar_availability_isSet;
}

bool OAIResourceOptionsUpdateModel::is_calendar_availability_Valid() const{
    return m_calendar_availability_isValid;
}

QString OAIResourceOptionsUpdateModel::getDisplayColor() const {
    return m_display_color;
}
void OAIResourceOptionsUpdateModel::setDisplayColor(const QString &display_color) {
    m_display_color = display_color;
    m_display_color_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_display_color_Set() const{
    return m_display_color_isSet;
}

bool OAIResourceOptionsUpdateModel::is_display_color_Valid() const{
    return m_display_color_isValid;
}

QDateTime OAIResourceOptionsUpdateModel::getEffectiveDate() const {
    return m_effective_date;
}
void OAIResourceOptionsUpdateModel::setEffectiveDate(const QDateTime &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIResourceOptionsUpdateModel::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

QString OAIResourceOptionsUpdateModel::getGender() const {
    return m_gender;
}
void OAIResourceOptionsUpdateModel::setGender(const QString &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIResourceOptionsUpdateModel::is_gender_Valid() const{
    return m_gender_isValid;
}

QString OAIResourceOptionsUpdateModel::getGoogleCalendarId() const {
    return m_google_calendar_id;
}
void OAIResourceOptionsUpdateModel::setGoogleCalendarId(const QString &google_calendar_id) {
    m_google_calendar_id = google_calendar_id;
    m_google_calendar_id_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_google_calendar_id_Set() const{
    return m_google_calendar_id_isSet;
}

bool OAIResourceOptionsUpdateModel::is_google_calendar_id_Valid() const{
    return m_google_calendar_id_isValid;
}

double OAIResourceOptionsUpdateModel::getHourly() const {
    return m_hourly;
}
void OAIResourceOptionsUpdateModel::setHourly(const double &hourly) {
    m_hourly = hourly;
    m_hourly_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_hourly_Set() const{
    return m_hourly_isSet;
}

bool OAIResourceOptionsUpdateModel::is_hourly_Valid() const{
    return m_hourly_isValid;
}

bool OAIResourceOptionsUpdateModel::isIgnoreBusinessHours() const {
    return m_ignore_business_hours;
}
void OAIResourceOptionsUpdateModel::setIgnoreBusinessHours(const bool &ignore_business_hours) {
    m_ignore_business_hours = ignore_business_hours;
    m_ignore_business_hours_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_ignore_business_hours_Set() const{
    return m_ignore_business_hours_isSet;
}

bool OAIResourceOptionsUpdateModel::is_ignore_business_hours_Valid() const{
    return m_ignore_business_hours_isValid;
}

qint32 OAIResourceOptionsUpdateModel::getNotificationType() const {
    return m_notification_type;
}
void OAIResourceOptionsUpdateModel::setNotificationType(const qint32 &notification_type) {
    m_notification_type = notification_type;
    m_notification_type_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_notification_type_Set() const{
    return m_notification_type_isSet;
}

bool OAIResourceOptionsUpdateModel::is_notification_type_Valid() const{
    return m_notification_type_isValid;
}

QString OAIResourceOptionsUpdateModel::getOutlookCalendarId() const {
    return m_outlook_calendar_id;
}
void OAIResourceOptionsUpdateModel::setOutlookCalendarId(const QString &outlook_calendar_id) {
    m_outlook_calendar_id = outlook_calendar_id;
    m_outlook_calendar_id_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_outlook_calendar_id_Set() const{
    return m_outlook_calendar_id_isSet;
}

bool OAIResourceOptionsUpdateModel::is_outlook_calendar_id_Valid() const{
    return m_outlook_calendar_id_isValid;
}

qint32 OAIResourceOptionsUpdateModel::getSortKey() const {
    return m_sort_key;
}
void OAIResourceOptionsUpdateModel::setSortKey(const qint32 &sort_key) {
    m_sort_key = sort_key;
    m_sort_key_isSet = true;
}

bool OAIResourceOptionsUpdateModel::is_sort_key_Set() const{
    return m_sort_key_isSet;
}

bool OAIResourceOptionsUpdateModel::is_sort_key_Valid() const{
    return m_sort_key_isValid;
}

bool OAIResourceOptionsUpdateModel::isSet() const {
...
bool OAIResourceOptionsUpdateModel::isValid() const {
