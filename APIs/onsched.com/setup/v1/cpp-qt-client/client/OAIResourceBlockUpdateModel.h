...
/*
 * OAIResourceBlockUpdateModel.h
 *
 * 
 */

#ifndef OAIResourceBlockUpdateModel_H
#define OAIResourceBlockUpdateModel_H
...
class OAIResourceBlockUpdateModel : public OAIObject {
public:
    OAIResourceBlockUpdateModel();
    OAIResourceBlockUpdateModel(QString json);
    ~OAIResourceBlockUpdateModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceBlockUpdateModel)

#endif // OAIResourceBlockUpdateModel_H
