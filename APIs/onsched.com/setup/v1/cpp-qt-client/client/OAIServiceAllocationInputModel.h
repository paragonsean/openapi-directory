...
/*
 * OAIServiceAllocationInputModel.h
 *
 * 
 */

#ifndef OAIServiceAllocationInputModel_H
#define OAIServiceAllocationInputModel_H
...
class OAIServiceAllocationInputModel : public OAIObject {
public:
    OAIServiceAllocationInputModel();
    OAIServiceAllocationInputModel(QString json);
    ~OAIServiceAllocationInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceAllocationInputModel)

#endif // OAIServiceAllocationInputModel_H
