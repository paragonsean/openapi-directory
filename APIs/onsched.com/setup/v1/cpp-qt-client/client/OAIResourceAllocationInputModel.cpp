...
qint32 OAIResourceAllocationInputModel::getEndTime() const {
    return m_end_time;
}
void OAIResourceAllocationInputModel::setEndTime(const qint32 &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIResourceAllocationInputModel::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIResourceAllocationInputModel::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIResourceAllocationInputModel::getReason() const {
    return m_reason;
}
void OAIResourceAllocationInputModel::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIResourceAllocationInputModel::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIResourceAllocationInputModel::is_reason_Valid() const{
    return m_reason_isValid;
}

OAIRepeatInputModel OAIResourceAllocationInputModel::getRepeat() const {
    return m_repeat;
}
void OAIResourceAllocationInputModel::setRepeat(const OAIRepeatInputModel &repeat) {
    m_repeat = repeat;
    m_repeat_isSet = true;
}

bool OAIResourceAllocationInputModel::is_repeat_Set() const{
    return m_repeat_isSet;
}

bool OAIResourceAllocationInputModel::is_repeat_Valid() const{
    return m_repeat_isValid;
}

bool OAIResourceAllocationInputModel::isRepeats() const {
    return m_repeats;
}
void OAIResourceAllocationInputModel::setRepeats(const bool &repeats) {
    m_repeats = repeats;
    m_repeats_isSet = true;
}

bool OAIResourceAllocationInputModel::is_repeats_Set() const{
    return m_repeats_isSet;
}

bool OAIResourceAllocationInputModel::is_repeats_Valid() const{
...
qint32 OAIResourceAllocationInputModel::getStartTime() const {
    return m_start_time;
}
void OAIResourceAllocationInputModel::setStartTime(const qint32 &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIResourceAllocationInputModel::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIResourceAllocationInputModel::is_start_time_Valid() const{
