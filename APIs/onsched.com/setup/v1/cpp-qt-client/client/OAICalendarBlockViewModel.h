...
/*
 * OAICalendarBlockViewModel.h
 *
 * 
 */

#ifndef OAICalendarBlockViewModel_H
#define OAICalendarBlockViewModel_H
...
class OAICalendarBlockViewModel : public OAIObject {
public:
    OAICalendarBlockViewModel();
    OAICalendarBlockViewModel(QString json);
    ~OAICalendarBlockViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarBlockViewModel)

#endif // OAICalendarBlockViewModel_H
