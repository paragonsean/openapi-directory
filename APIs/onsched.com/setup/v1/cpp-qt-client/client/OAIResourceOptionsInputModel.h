...
/*
 * OAIResourceOptionsInputModel.h
 *
 * Options for the new resource
 */

#ifndef OAIResourceOptionsInputModel_H
#define OAIResourceOptionsInputModel_H
...
class OAIResourceOptionsInputModel : public OAIObject {
public:
    OAIResourceOptionsInputModel();
    OAIResourceOptionsInputModel(QString json);
    ~OAIResourceOptionsInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceOptionsInputModel)

#endif // OAIResourceOptionsInputModel_H
