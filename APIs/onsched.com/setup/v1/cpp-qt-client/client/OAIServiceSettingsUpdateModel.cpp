...
OAIServiceSettingsUpdateModel::OAIServiceSettingsUpdateModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceSettingsUpdateModel::OAIServiceSettingsUpdateModel() {
    this->initializeModel();
}

OAIServiceSettingsUpdateModel::~OAIServiceSettingsUpdateModel() {}

void OAIServiceSettingsUpdateModel::initializeModel() {
...
void OAIServiceSettingsUpdateModel::fromJson(QString jsonString) {
...
void OAIServiceSettingsUpdateModel::fromJsonObject(QJsonObject json) {
...
QString OAIServiceSettingsUpdateModel::asJson() const {
...
QJsonObject OAIServiceSettingsUpdateModel::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIServiceSettingsUpdateModel::getBookAheadUnit() const {
    return m_book_ahead_unit;
}
void OAIServiceSettingsUpdateModel::setBookAheadUnit(const qint32 &book_ahead_unit) {
    m_book_ahead_unit = book_ahead_unit;
    m_book_ahead_unit_isSet = true;
}

bool OAIServiceSettingsUpdateModel::is_book_ahead_unit_Set() const{
    return m_book_ahead_unit_isSet;
}

bool OAIServiceSettingsUpdateModel::is_book_ahead_unit_Valid() const{
    return m_book_ahead_unit_isValid;
}

qint32 OAIServiceSettingsUpdateModel::getBookAheadValue() const {
    return m_book_ahead_value;
}
void OAIServiceSettingsUpdateModel::setBookAheadValue(const qint32 &book_ahead_value) {
    m_book_ahead_value = book_ahead_value;
    m_book_ahead_value_isSet = true;
}

bool OAIServiceSettingsUpdateModel::is_book_ahead_value_Set() const{
    return m_book_ahead_value_isSet;
}

bool OAIServiceSettingsUpdateModel::is_book_ahead_value_Valid() const{
    return m_book_ahead_value_isValid;
}

qint32 OAIServiceSettingsUpdateModel::getBookInAdvance() const {
    return m_book_in_advance;
}
void OAIServiceSettingsUpdateModel::setBookInAdvance(const qint32 &book_in_advance) {
    m_book_in_advance = book_in_advance;
    m_book_in_advance_isSet = true;
}

bool OAIServiceSettingsUpdateModel::is_book_in_advance_Set() const{
    return m_book_in_advance_isSet;
}

bool OAIServiceSettingsUpdateModel::is_book_in_advance_Valid() const{
    return m_book_in_advance_isValid;
}

bool OAIServiceSettingsUpdateModel::isSet() const {
...
bool OAIServiceSettingsUpdateModel::isValid() const {
