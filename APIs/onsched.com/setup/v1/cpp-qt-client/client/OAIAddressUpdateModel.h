...
/*
 * OAIAddressUpdateModel.h
 *
 * 
 */

#ifndef OAIAddressUpdateModel_H
#define OAIAddressUpdateModel_H
...
class OAIAddressUpdateModel : public OAIObject {
public:
    OAIAddressUpdateModel();
    OAIAddressUpdateModel(QString json);
    ~OAIAddressUpdateModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressUpdateModel)

#endif // OAIAddressUpdateModel_H
