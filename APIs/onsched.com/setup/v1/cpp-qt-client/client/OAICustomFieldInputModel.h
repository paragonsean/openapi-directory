...
/*
 * OAICustomFieldInputModel.h
 *
 * 
 */

#ifndef OAICustomFieldInputModel_H
#define OAICustomFieldInputModel_H
...
class OAICustomFieldInputModel : public OAIObject {
public:
    OAICustomFieldInputModel();
    OAICustomFieldInputModel(QString json);
    ~OAICustomFieldInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldInputModel)

#endif // OAICustomFieldInputModel_H
