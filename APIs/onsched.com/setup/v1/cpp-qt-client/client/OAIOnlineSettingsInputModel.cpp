...
OAIOnlineSettingsInputModel::OAIOnlineSettingsInputModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOnlineSettingsInputModel::OAIOnlineSettingsInputModel() {
    this->initializeModel();
}

OAIOnlineSettingsInputModel::~OAIOnlineSettingsInputModel() {}

void OAIOnlineSettingsInputModel::initializeModel() {
...
void OAIOnlineSettingsInputModel::fromJson(QString jsonString) {
...
void OAIOnlineSettingsInputModel::fromJsonObject(QJsonObject json) {
...
QString OAIOnlineSettingsInputModel::asJson() const {
...
QJsonObject OAIOnlineSettingsInputModel::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIOnlineSettingsInputModel::getBookAheadUnit() const {
    return m_book_ahead_unit;
}
void OAIOnlineSettingsInputModel::setBookAheadUnit(const qint32 &book_ahead_unit) {
    m_book_ahead_unit = book_ahead_unit;
    m_book_ahead_unit_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_book_ahead_unit_Set() const{
    return m_book_ahead_unit_isSet;
}

bool OAIOnlineSettingsInputModel::is_book_ahead_unit_Valid() const{
    return m_book_ahead_unit_isValid;
}

qint32 OAIOnlineSettingsInputModel::getBookAheadValue() const {
    return m_book_ahead_value;
}
void OAIOnlineSettingsInputModel::setBookAheadValue(const qint32 &book_ahead_value) {
    m_book_ahead_value = book_ahead_value;
    m_book_ahead_value_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_book_ahead_value_Set() const{
    return m_book_ahead_value_isSet;
}

bool OAIOnlineSettingsInputModel::is_book_ahead_value_Valid() const{
    return m_book_ahead_value_isValid;
}

qint32 OAIOnlineSettingsInputModel::getBookInAdvance() const {
    return m_book_in_advance;
}
void OAIOnlineSettingsInputModel::setBookInAdvance(const qint32 &book_in_advance) {
    m_book_in_advance = book_in_advance;
    m_book_in_advance_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_book_in_advance_Set() const{
    return m_book_in_advance_isSet;
}

bool OAIOnlineSettingsInputModel::is_book_in_advance_Valid() const{
    return m_book_in_advance_isValid;
}

qint32 OAIOnlineSettingsInputModel::getBookingTimerMins() const {
    return m_booking_timer_mins;
}
void OAIOnlineSettingsInputModel::setBookingTimerMins(const qint32 &booking_timer_mins) {
    m_booking_timer_mins = booking_timer_mins;
    m_booking_timer_mins_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_booking_timer_mins_Set() const{
    return m_booking_timer_mins_isSet;
}

bool OAIOnlineSettingsInputModel::is_booking_timer_mins_Valid() const{
    return m_booking_timer_mins_isValid;
}

qint32 OAIOnlineSettingsInputModel::getCustomerBookingsPerDay() const {
    return m_customer_bookings_per_day;
}
void OAIOnlineSettingsInputModel::setCustomerBookingsPerDay(const qint32 &customer_bookings_per_day) {
    m_customer_bookings_per_day = customer_bookings_per_day;
    m_customer_bookings_per_day_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_customer_bookings_per_day_Set() const{
    return m_customer_bookings_per_day_isSet;
}

bool OAIOnlineSettingsInputModel::is_customer_bookings_per_day_Valid() const{
    return m_customer_bookings_per_day_isValid;
}

bool OAIOnlineSettingsInputModel::isEnableWorldTimezones() const {
    return m_enable_world_timezones;
}
void OAIOnlineSettingsInputModel::setEnableWorldTimezones(const bool &enable_world_timezones) {
    m_enable_world_timezones = enable_world_timezones;
    m_enable_world_timezones_isSet = true;
}

bool OAIOnlineSettingsInputModel::is_enable_world_timezones_Set() const{
    return m_enable_world_timezones_isSet;
}

bool OAIOnlineSettingsInputModel::is_enable_world_timezones_Valid() const{
    return m_enable_world_timezones_isValid;
}

bool OAIOnlineSettingsInputModel::isSet() const {
...
bool OAIOnlineSettingsInputModel::isValid() const {
