...
OAIContactUpdateModel::OAIContactUpdateModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContactUpdateModel::OAIContactUpdateModel() {
    this->initializeModel();
}

OAIContactUpdateModel::~OAIContactUpdateModel() {}

void OAIContactUpdateModel::initializeModel() {
...
void OAIContactUpdateModel::fromJson(QString jsonString) {
...
void OAIContactUpdateModel::fromJsonObject(QJsonObject json) {
...
QString OAIContactUpdateModel::asJson() const {
...
QJsonObject OAIContactUpdateModel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIContactUpdateModel::getBusinessPhone() const {
    return m_business_phone;
}
void OAIContactUpdateModel::setBusinessPhone(const QString &business_phone) {
    m_business_phone = business_phone;
    m_business_phone_isSet = true;
}

bool OAIContactUpdateModel::is_business_phone_Set() const{
    return m_business_phone_isSet;
}

bool OAIContactUpdateModel::is_business_phone_Valid() const{
    return m_business_phone_isValid;
}

QString OAIContactUpdateModel::getBusinessPhoneExt() const {
    return m_business_phone_ext;
}
void OAIContactUpdateModel::setBusinessPhoneExt(const QString &business_phone_ext) {
    m_business_phone_ext = business_phone_ext;
    m_business_phone_ext_isSet = true;
}

bool OAIContactUpdateModel::is_business_phone_ext_Set() const{
    return m_business_phone_ext_isSet;
}

bool OAIContactUpdateModel::is_business_phone_ext_Valid() const{
    return m_business_phone_ext_isValid;
}

QString OAIContactUpdateModel::getConferenceInfo() const {
    return m_conference_info;
}
void OAIContactUpdateModel::setConferenceInfo(const QString &conference_info) {
    m_conference_info = conference_info;
    m_conference_info_isSet = true;
}

bool OAIContactUpdateModel::is_conference_info_Set() const{
    return m_conference_info_isSet;
}

bool OAIContactUpdateModel::is_conference_info_Valid() const{
    return m_conference_info_isValid;
}

QString OAIContactUpdateModel::getHomePhone() const {
    return m_home_phone;
}
void OAIContactUpdateModel::setHomePhone(const QString &home_phone) {
    m_home_phone = home_phone;
    m_home_phone_isSet = true;
}

bool OAIContactUpdateModel::is_home_phone_Set() const{
    return m_home_phone_isSet;
}

bool OAIContactUpdateModel::is_home_phone_Valid() const{
    return m_home_phone_isValid;
}

QString OAIContactUpdateModel::getMobilePhone() const {
    return m_mobile_phone;
}
void OAIContactUpdateModel::setMobilePhone(const QString &mobile_phone) {
    m_mobile_phone = mobile_phone;
    m_mobile_phone_isSet = true;
}

bool OAIContactUpdateModel::is_mobile_phone_Set() const{
    return m_mobile_phone_isSet;
}

bool OAIContactUpdateModel::is_mobile_phone_Valid() const{
    return m_mobile_phone_isValid;
}

QString OAIContactUpdateModel::getPreferredPhoneType() const {
    return m_preferred_phone_type;
}
void OAIContactUpdateModel::setPreferredPhoneType(const QString &preferred_phone_type) {
    m_preferred_phone_type = preferred_phone_type;
    m_preferred_phone_type_isSet = true;
}

bool OAIContactUpdateModel::is_preferred_phone_type_Set() const{
    return m_preferred_phone_type_isSet;
}

bool OAIContactUpdateModel::is_preferred_phone_type_Valid() const{
    return m_preferred_phone_type_isValid;
}

QString OAIContactUpdateModel::getSkypeUsername() const {
    return m_skype_username;
}
void OAIContactUpdateModel::setSkypeUsername(const QString &skype_username) {
    m_skype_username = skype_username;
    m_skype_username_isSet = true;
}

bool OAIContactUpdateModel::is_skype_username_Set() const{
    return m_skype_username_isSet;
}

bool OAIContactUpdateModel::is_skype_username_Valid() const{
    return m_skype_username_isValid;
}

bool OAIContactUpdateModel::isSet() const {
...
bool OAIContactUpdateModel::isValid() const {
