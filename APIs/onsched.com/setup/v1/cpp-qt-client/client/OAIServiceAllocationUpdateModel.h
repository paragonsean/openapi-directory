...
/*
 * OAIServiceAllocationUpdateModel.h
 *
 * 
 */

#ifndef OAIServiceAllocationUpdateModel_H
#define OAIServiceAllocationUpdateModel_H
...
namespace OpenAPI {
class OAIRepeatInputModel;

class OAIServiceAllocationUpdateModel : public OAIObject {
public:
    OAIServiceAllocationUpdateModel();
    OAIServiceAllocationUpdateModel(QString json);
    ~OAIServiceAllocationUpdateModel() override;
    ...
    OAIRepeatInputModel getRepeat() const;
    void setRepeat(const OAIRepeatInputModel &repeat);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceAllocationUpdateModel)

#endif // OAIServiceAllocationUpdateModel_H
