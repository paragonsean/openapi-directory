...
/*
 * OAIResourceBlockInputModel.h
 *
 * 
 */

#ifndef OAIResourceBlockInputModel_H
#define OAIResourceBlockInputModel_H
...
class OAIResourceBlockInputModel : public OAIObject {
public:
    OAIResourceBlockInputModel();
    OAIResourceBlockInputModel(QString json);
    ~OAIResourceBlockInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceBlockInputModel)

#endif // OAIResourceBlockInputModel_H
