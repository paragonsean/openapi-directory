...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.RepeatInputModel();
  });
  ...
  describe('RepeatInputModel', function() {
    it('should create an instance of RepeatInputModel', function() {
      // uncomment below and update the code to test RepeatInputModel
      //var instance = new OnSchedSetupApi.RepeatInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.RepeatInputModel);
    });
    ...
    it('should have the property monthType (base name: "monthType")', function() {
      // uncomment below and update the code to test the property monthType
      //var instance = new OnSchedSetupApi.RepeatInputModel();
      //expect(instance).to.be();
    });
