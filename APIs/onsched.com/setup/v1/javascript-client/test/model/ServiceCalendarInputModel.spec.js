...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceCalendarInputModel();
  });
  ...
  describe('ServiceCalendarInputModel', function() {
    it('should create an instance of ServiceCalendarInputModel', function() {
      // uncomment below and update the code to test ServiceCalendarInputModel
      //var instance = new OnSchedSetupApi.ServiceCalendarInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceCalendarInputModel);
    });
