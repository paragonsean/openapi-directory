...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.RepeatViewModel();
  });
  ...
  describe('RepeatViewModel', function() {
    it('should create an instance of RepeatViewModel', function() {
      // uncomment below and update the code to test RepeatViewModel
      //var instance = new OnSchedSetupApi.RepeatViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.RepeatViewModel);
    });
