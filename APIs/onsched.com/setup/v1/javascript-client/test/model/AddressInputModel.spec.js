...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AddressInputModel();
  });
  ...
  describe('AddressInputModel', function() {
    it('should create an instance of AddressInputModel', function() {
      ...
      //var instance = new OnSchedSetupApi.AddressInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AddressInputModel);
    });
