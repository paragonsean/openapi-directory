...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ResourceBlockViewModel();
  });
  ...
  describe('ResourceBlockViewModel', function() {
    it('should create an instance of ResourceBlockViewModel', function() {
      // uncomment below and update the code to test ResourceBlockViewModel
      //var instance = new OnSchedSetupApi.ResourceBlockViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ResourceBlockViewModel);
    });
