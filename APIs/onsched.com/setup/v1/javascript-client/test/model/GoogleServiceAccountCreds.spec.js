...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.GoogleServiceAccountCreds();
  });
  ...
  describe('GoogleServiceAccountCreds', function() {
    it('should create an instance of GoogleServiceAccountCreds', function() {
      // uncomment below and update the code to test GoogleServiceAccountCreds
      //var instance = new OnSchedSetupApi.GoogleServiceAccountCreds();
      //expect(instance).to.be.a(OnSchedSetupApi.GoogleServiceAccountCreds);
    });
