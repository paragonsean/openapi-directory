...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AvailabilityViewModel2();
  });
  ...
  describe('AvailabilityViewModel2', function() {
    it('should create an instance of AvailabilityViewModel2', function() {
      // uncomment below and update the code to test AvailabilityViewModel2
      //var instance = new OnSchedSetupApi.AvailabilityViewModel2();
      //expect(instance).to.be.a(OnSchedSetupApi.AvailabilityViewModel2);
    });
