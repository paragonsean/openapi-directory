...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ScheduleViewModel();
  });
  ...
  describe('ScheduleViewModel', function() {
    it('should create an instance of ScheduleViewModel', function() {
      // uncomment below and update the code to test ScheduleViewModel
      //var instance = new OnSchedSetupApi.ScheduleViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ScheduleViewModel);
    });
