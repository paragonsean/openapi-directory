...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.RegionListViewModel();
  });
  ...
  describe('RegionListViewModel', function() {
    it('should create an instance of RegionListViewModel', function() {
      // uncomment below and update the code to test RegionListViewModel
      //var instance = new OnSchedSetupApi.RegionListViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.RegionListViewModel);
    });
