...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceListViewModel();
  });
  ...
  describe('ServiceListViewModel', function() {
    it('should create an instance of ServiceListViewModel', function() {
      // uncomment below and update the code to test ServiceListViewModel
      //var instance = new OnSchedSetupApi.ServiceListViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceListViewModel);
    });
