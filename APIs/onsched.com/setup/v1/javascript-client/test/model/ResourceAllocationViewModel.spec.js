...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ResourceAllocationViewModel();
  });
  ...
  describe('ResourceAllocationViewModel', function() {
    it('should create an instance of ResourceAllocationViewModel', function() {
      // uncomment below and update the code to test ResourceAllocationViewModel
      //var instance = new OnSchedSetupApi.ResourceAllocationViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ResourceAllocationViewModel);
    });
