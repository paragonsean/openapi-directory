...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ContactInputModel();
  });
  ...
  describe('ContactInputModel', function() {
    it('should create an instance of ContactInputModel', function() {
      // uncomment below and update the code to test ContactInputModel
      //var instance = new OnSchedSetupApi.ContactInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ContactInputModel);
    });
