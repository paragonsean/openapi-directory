...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ScheduleInputModel();
  });
  ...
  describe('ScheduleInputModel', function() {
    it('should create an instance of ScheduleInputModel', function() {
      // uncomment below and update the code to test ScheduleInputModel
      //var instance = new OnSchedSetupApi.ScheduleInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ScheduleInputModel);
    });
