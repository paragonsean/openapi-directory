...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.LocationUpdateModel();
  });
  ...
  describe('LocationUpdateModel', function() {
    it('should create an instance of LocationUpdateModel', function() {
      // uncomment below and update the code to test LocationUpdateModel
      //var instance = new OnSchedSetupApi.LocationUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.LocationUpdateModel);
    });
