...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ResourceHoursViewModel();
  });
  ...
  describe('ResourceHoursViewModel', function() {
    it('should create an instance of ResourceHoursViewModel', function() {
      // uncomment below and update the code to test ResourceHoursViewModel
      //var instance = new OnSchedSetupApi.ResourceHoursViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ResourceHoursViewModel);
    });
