...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AppointmentResourceViewModel();
  });
  ...
  describe('AppointmentResourceViewModel', function() {
    it('should create an instance of AppointmentResourceViewModel', function() {
      // uncomment below and update the code to test AppointmentResourceViewModel
      //var instance = new OnSchedSetupApi.AppointmentResourceViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AppointmentResourceViewModel);
    });
