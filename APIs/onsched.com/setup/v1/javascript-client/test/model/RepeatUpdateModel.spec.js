...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.RepeatUpdateModel();
  });
  ...
  describe('RepeatUpdateModel', function() {
    it('should create an instance of RepeatUpdateModel', function() {
      // uncomment below and update the code to test RepeatUpdateModel
      //var instance = new OnSchedSetupApi.RepeatUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.RepeatUpdateModel);
    });
