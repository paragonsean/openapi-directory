...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.CalendarHoursViewModel();
  });
  ...
  describe('CalendarHoursViewModel', function() {
    it('should create an instance of CalendarHoursViewModel', function() {
      // uncomment below and update the code to test CalendarHoursViewModel
      //var instance = new OnSchedSetupApi.CalendarHoursViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.CalendarHoursViewModel);
    });
