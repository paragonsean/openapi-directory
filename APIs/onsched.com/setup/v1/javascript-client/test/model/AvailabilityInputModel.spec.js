...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AvailabilityInputModel();
  });
  ...
  describe('AvailabilityInputModel', function() {
    it('should create an instance of AvailabilityInputModel', function() {
      // uncomment below and update the code to test AvailabilityInputModel
      //var instance = new OnSchedSetupApi.AvailabilityInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AvailabilityInputModel);
    });
