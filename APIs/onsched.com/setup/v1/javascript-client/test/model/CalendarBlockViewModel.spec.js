...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.CalendarBlockViewModel();
  });
  ...
  describe('CalendarBlockViewModel', function() {
    it('should create an instance of CalendarBlockViewModel', function() {
      // uncomment below and update the code to test CalendarBlockViewModel
      //var instance = new OnSchedSetupApi.CalendarBlockViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.CalendarBlockViewModel);
    });
