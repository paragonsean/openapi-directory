...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceGroupViewModel();
  });
  ...
  describe('ServiceGroupViewModel', function() {
    it('should create an instance of ServiceGroupViewModel', function() {
      // uncomment below and update the code to test ServiceGroupViewModel
      //var instance = new OnSchedSetupApi.ServiceGroupViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceGroupViewModel);
    });
