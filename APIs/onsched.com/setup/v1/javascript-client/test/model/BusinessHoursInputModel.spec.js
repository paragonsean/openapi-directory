...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.BusinessHoursInputModel();
  });
  ...
  describe('BusinessHoursInputModel', function() {
    it('should create an instance of BusinessHoursInputModel', function() {
      // uncomment below and update the code to test BusinessHoursInputModel
      //var instance = new OnSchedSetupApi.BusinessHoursInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.BusinessHoursInputModel);
    });
