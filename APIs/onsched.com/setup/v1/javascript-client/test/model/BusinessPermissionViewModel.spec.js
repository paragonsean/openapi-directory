...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.BusinessPermissionViewModel();
  });
  ...
  describe('BusinessPermissionViewModel', function() {
    it('should create an instance of BusinessPermissionViewModel', function() {
      // uncomment below and update the code to test BusinessPermissionViewModel
      //var instance = new OnSchedSetupApi.BusinessPermissionViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.BusinessPermissionViewModel);
    });
