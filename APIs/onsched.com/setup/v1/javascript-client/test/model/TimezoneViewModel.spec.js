...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.TimezoneViewModel();
  });
  ...
  describe('TimezoneViewModel', function() {
    it('should create an instance of TimezoneViewModel', function() {
      // uncomment below and update the code to test TimezoneViewModel
      //var instance = new OnSchedSetupApi.TimezoneViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.TimezoneViewModel);
    });
