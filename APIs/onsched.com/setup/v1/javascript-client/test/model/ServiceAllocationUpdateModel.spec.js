...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceAllocationUpdateModel();
  });
  ...
  describe('ServiceAllocationUpdateModel', function() {
    it('should create an instance of ServiceAllocationUpdateModel', function() {
      // uncomment below and update the code to test ServiceAllocationUpdateModel
      //var instance = new OnSchedSetupApi.ServiceAllocationUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceAllocationUpdateModel);
    });
