...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ScheduleUpdateModel();
  });
  ...
  describe('ScheduleUpdateModel', function() {
    it('should create an instance of ScheduleUpdateModel', function() {
      // uncomment below and update the code to test ScheduleUpdateModel
      //var instance = new OnSchedSetupApi.ScheduleUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ScheduleUpdateModel);
    });
    ...
    it('should have the property bookingsPerSlot (base name: "bookingsPerSlot")', function() {
      // uncomment below and update the code to test the property bookingsPerSlot
      //var instance = new OnSchedSetupApi.ScheduleUpdateModel();
      //expect(instance).to.be();
    });
