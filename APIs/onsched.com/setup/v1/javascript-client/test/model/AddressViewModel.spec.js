...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AddressViewModel();
  });
  ...
  describe('AddressViewModel', function() {
    it('should create an instance of AddressViewModel', function() {
      ...
      //var instance = new OnSchedSetupApi.AddressViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AddressViewModel);
    });
