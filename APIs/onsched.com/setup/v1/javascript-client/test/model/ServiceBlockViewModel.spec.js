...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceBlockViewModel();
  });
  ...
  describe('ServiceBlockViewModel', function() {
    it('should create an instance of ServiceBlockViewModel', function() {
      // uncomment below and update the code to test ServiceBlockViewModel
      //var instance = new OnSchedSetupApi.ServiceBlockViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceBlockViewModel);
    });
