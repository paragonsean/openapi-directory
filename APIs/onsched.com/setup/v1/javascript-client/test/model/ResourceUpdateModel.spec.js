...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ResourceUpdateModel();
  });
  ...
  describe('ResourceUpdateModel', function() {
    it('should create an instance of ResourceUpdateModel', function() {
      // uncomment below and update the code to test ResourceUpdateModel
      //var instance = new OnSchedSetupApi.ResourceUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ResourceUpdateModel);
    });
