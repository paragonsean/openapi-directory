...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceCalendarViewModel();
  });
  ...
  describe('ServiceCalendarViewModel', function() {
    it('should create an instance of ServiceCalendarViewModel', function() {
      // uncomment below and update the code to test ServiceCalendarViewModel
      //var instance = new OnSchedSetupApi.ServiceCalendarViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceCalendarViewModel);
    });
