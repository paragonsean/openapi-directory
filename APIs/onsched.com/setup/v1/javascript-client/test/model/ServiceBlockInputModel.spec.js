...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceBlockInputModel();
  });
  ...
  describe('ServiceBlockInputModel', function() {
    it('should create an instance of ServiceBlockInputModel', function() {
      // uncomment below and update the code to test ServiceBlockInputModel
      //var instance = new OnSchedSetupApi.ServiceBlockInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceBlockInputModel);
    });
