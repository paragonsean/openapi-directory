...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ContactViewModel();
  });
  ...
  describe('ContactViewModel', function() {
    it('should create an instance of ContactViewModel', function() {
      // uncomment below and update the code to test ContactViewModel
      //var instance = new OnSchedSetupApi.ContactViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ContactViewModel);
    });
