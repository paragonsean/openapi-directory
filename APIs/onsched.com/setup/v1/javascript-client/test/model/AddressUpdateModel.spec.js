...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AddressUpdateModel();
  });
  ...
  describe('AddressUpdateModel', function() {
    it('should create an instance of AddressUpdateModel', function() {
      // uncomment below and update the code to test AddressUpdateModel
      //var instance = new OnSchedSetupApi.AddressUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AddressUpdateModel);
    });
