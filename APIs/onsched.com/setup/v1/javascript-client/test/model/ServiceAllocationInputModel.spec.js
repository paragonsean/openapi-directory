...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.ServiceAllocationInputModel();
  });
  ...
  describe('ServiceAllocationInputModel', function() {
    it('should create an instance of ServiceAllocationInputModel', function() {
      // uncomment below and update the code to test ServiceAllocationInputModel
      //var instance = new OnSchedSetupApi.ServiceAllocationInputModel();
      //expect(instance).to.be.a(OnSchedSetupApi.ServiceAllocationInputModel);
    });
