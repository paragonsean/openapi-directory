...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.AppointmentAuditViewModel();
  });
  ...
  describe('AppointmentAuditViewModel', function() {
    it('should create an instance of AppointmentAuditViewModel', function() {
      ...
      //var instance = new OnSchedSetupApi.AppointmentAuditViewModel();
      //expect(instance).to.be.a(OnSchedSetupApi.AppointmentAuditViewModel);
    });
