...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedSetupApi.BusinessHoursUpdateModel();
  });
  ...
  describe('BusinessHoursUpdateModel', function() {
    it('should create an instance of BusinessHoursUpdateModel', function() {
      // uncomment below and update the code to test BusinessHoursUpdateModel
      //var instance = new OnSchedSetupApi.BusinessHoursUpdateModel();
      //expect(instance).to.be.a(OnSchedSetupApi.BusinessHoursUpdateModel);
    });
