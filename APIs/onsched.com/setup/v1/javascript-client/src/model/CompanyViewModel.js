...
class CompanyViewModel {
    ...
    /**
     * Validates the JSON data with respect to <code>CompanyViewModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompanyViewModel</code>.
     */
 ...
 */
CompanyViewModel.prototype['addressLine1'] = undefined;

/**
 * @member {String} addressLine2
 */
CompanyViewModel.prototype['addressLine2'] = undefined;

/**
 * @member {String} bookingWebhookUrl
 */
CompanyViewModel.prototype['bookingWebhookUrl'] = undefined;

/**
 * @member {String} city
 */
CompanyViewModel.prototype['city'] = undefined;

/**
 * @member {String} clientId
 */
CompanyViewModel.prototype['clientId'] = undefined;

/**
 * @member {String} clientSecret
 */
CompanyViewModel.prototype['clientSecret'] = undefined;

/**
 * @member {String} country
 */
CompanyViewModel.prototype['country'] = undefined;

/**
 * @member {String} customerWebhookUrl
 */
CompanyViewModel.prototype['customerWebhookUrl'] = undefined;

/**
 * @member {Boolean} deletedStatus
 */
CompanyViewModel.prototype['deletedStatus'] = undefined;

/**
 * @member {String} deletedTime
 */
CompanyViewModel.prototype['deletedTime'] = undefined;

/**
 * @member {Boolean} disableEmailAndSmsNotifications
 */
CompanyViewModel.prototype['disableEmailAndSmsNotifications'] = undefined;

/**
 * @member {String} email
 */
CompanyViewModel.prototype['email'] = undefined;

/**
 * @member {String} fax
 */
CompanyViewModel.prototype['fax'] = undefined;

/**
 * @member {String} id
 */
CompanyViewModel.prototype['id'] = undefined;

/**
 * @member {String} name
 */
CompanyViewModel.prototype['name'] = undefined;

/**
 * @member {String} notificationFromEmailAddress
 */
CompanyViewModel.prototype['notificationFromEmailAddress'] = undefined;

/**
 * @member {String} notificationFromName
 */
CompanyViewModel.prototype['notificationFromName'] = undefined;

/**
 * @member {String} object
 */
CompanyViewModel.prototype['object'] = undefined;

/**
 * @member {String} phone
 */
CompanyViewModel.prototype['phone'] = undefined;

/**
 * @member {String} postalCode
 */
CompanyViewModel.prototype['postalCode'] = undefined;

/**
 * @member {String} registrationDate
 */
CompanyViewModel.prototype['registrationDate'] = undefined;

/**
 * @member {String} registrationEmail
 */
CompanyViewModel.prototype['registrationEmail'] = undefined;

/**
 * @member {String} reminderWebhookUrl
 */
CompanyViewModel.prototype['reminderWebhookUrl'] = undefined;

/**
 * @member {String} resourceWebhookUrl
 */
CompanyViewModel.prototype['resourceWebhookUrl'] = undefined;

/**
 * @member {String} state
 */
CompanyViewModel.prototype['state'] = undefined;

/**
 * @member {String} timezoneId
 */
CompanyViewModel.prototype['timezoneId'] = undefined;

/**
 * @member {String} timezoneName
 */
CompanyViewModel.prototype['timezoneName'] = undefined;

/**
 * @member {String} webhookSignatureHash
 */
CompanyViewModel.prototype['webhookSignatureHash'] = undefined;

/**
 * @member {String} website
 */
CompanyViewModel.prototype['website'] = undefined;
