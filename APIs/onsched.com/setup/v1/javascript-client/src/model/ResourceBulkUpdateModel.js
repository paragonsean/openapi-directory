...
/**
 * The ResourceBulkUpdateModel model module.
 * @module model/ResourceBulkUpdateModel
 * @version v1
 */
class ResourceBulkUpdateModel {
    /**
     * Constructs a new <code>ResourceBulkUpdateModel</code>.
     * @alias module:model/ResourceBulkUpdateModel
     */
    constructor() { 
        
        ResourceBulkUpdateModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResourceBulkUpdateModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceBulkUpdateModel} obj Optional instance to populate.
     * @return {module:model/ResourceBulkUpdateModel} The populated <code>ResourceBulkUpdateModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceBulkUpdateModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceBulkUpdateModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceBulkUpdateModel</code>.
     */
 ...
 */
ResourceBulkUpdateModel.prototype['address'] = undefined;

/**
 * @member {module:model/AvailabilityInputModel} availability
 */
ResourceBulkUpdateModel.prototype['availability'] = undefined;

/**
 * @member {module:model/ContactUpdateModel} contact
 */
ResourceBulkUpdateModel.prototype['contact'] = undefined;

/**
 * @member {module:model/CustomFieldUpdateModel} customFields
 */
ResourceBulkUpdateModel.prototype['customFields'] = undefined;

/**
 * @member {String} description
 */
ResourceBulkUpdateModel.prototype['description'] = undefined;

/**
 * @member {String} email
 */
ResourceBulkUpdateModel.prototype['email'] = undefined;

/**
 * @member {String} groupId
 */
ResourceBulkUpdateModel.prototype['groupId'] = undefined;

/**
 * @member {String} id
 */
ResourceBulkUpdateModel.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ResourceBulkUpdateModel.prototype['name'] = undefined;

/**
 * @member {module:model/ResourceOptionsUpdateModel} options
 */
ResourceBulkUpdateModel.prototype['options'] = undefined;

/**
 * @member {Boolean} recurringAvailability
 */
ResourceBulkUpdateModel.prototype['recurringAvailability'] = undefined;

/**
 * @member {Array.<String>} serviceIds
 */
ResourceBulkUpdateModel.prototype['serviceIds'] = undefined;

/**
 * @member {String} timezoneId
 */
ResourceBulkUpdateModel.prototype['timezoneId'] = undefined;
...
export default ResourceBulkUpdateModel;
