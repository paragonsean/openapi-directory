...
/**
 * The CustomFieldUpdateModel model module.
 * @module model/CustomFieldUpdateModel
 * @version v1
 */
class CustomFieldUpdateModel {
    /**
     * Constructs a new <code>CustomFieldUpdateModel</code>.
     * @alias module:model/CustomFieldUpdateModel
     */
    constructor() { 
        
        CustomFieldUpdateModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomFieldUpdateModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomFieldUpdateModel} obj Optional instance to populate.
     * @return {module:model/CustomFieldUpdateModel} The populated <code>CustomFieldUpdateModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomFieldUpdateModel();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFieldUpdateModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFieldUpdateModel</code>.
     */
 ...
 */
CustomFieldUpdateModel.prototype['field1'] = undefined;

/**
 * @member {String} field10
 */
CustomFieldUpdateModel.prototype['field10'] = undefined;

/**
 * @member {String} field2
 */
CustomFieldUpdateModel.prototype['field2'] = undefined;

/**
 * @member {String} field3
 */
CustomFieldUpdateModel.prototype['field3'] = undefined;

/**
 * @member {String} field4
 */
CustomFieldUpdateModel.prototype['field4'] = undefined;

/**
 * @member {String} field5
 */
CustomFieldUpdateModel.prototype['field5'] = undefined;

/**
 * @member {String} field6
 */
CustomFieldUpdateModel.prototype['field6'] = undefined;

/**
 * @member {String} field7
 */
CustomFieldUpdateModel.prototype['field7'] = undefined;

/**
 * @member {String} field8
 */
CustomFieldUpdateModel.prototype['field8'] = undefined;

/**
 * @member {String} field9
 */
CustomFieldUpdateModel.prototype['field9'] = undefined;
...
export default CustomFieldUpdateModel;
