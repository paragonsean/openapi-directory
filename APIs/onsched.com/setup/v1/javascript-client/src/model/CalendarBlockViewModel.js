...
/**
 * The CalendarBlockViewModel model module.
 * @module model/CalendarBlockViewModel
 * @version v1
 */
class CalendarBlockViewModel {
    /**
     * Constructs a new <code>CalendarBlockViewModel</code>.
     * @alias module:model/CalendarBlockViewModel
     */
    constructor() { 
        
        CalendarBlockViewModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CalendarBlockViewModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CalendarBlockViewModel} obj Optional instance to populate.
     * @return {module:model/CalendarBlockViewModel} The populated <code>CalendarBlockViewModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CalendarBlockViewModel();
    ...
    /**
     * Validates the JSON data with respect to <code>CalendarBlockViewModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CalendarBlockViewModel</code>.
     */
 ...
 */
CalendarBlockViewModel.prototype['calendarId'] = undefined;

/**
 * @member {Boolean} deletedStatus
 */
CalendarBlockViewModel.prototype['deletedStatus'] = undefined;

/**
 * @member {String} deletedTime
 */
CalendarBlockViewModel.prototype['deletedTime'] = undefined;

/**
 * @member {String} endDate
 */
CalendarBlockViewModel.prototype['endDate'] = undefined;

/**
 * @member {Number} endTime
 */
CalendarBlockViewModel.prototype['endTime'] = undefined;

/**
 * @member {String} id
 */
CalendarBlockViewModel.prototype['id'] = undefined;

/**
 * @member {String} locationId
 */
CalendarBlockViewModel.prototype['locationId'] = undefined;

/**
 * @member {String} object
 */
CalendarBlockViewModel.prototype['object'] = undefined;

/**
 * @member {String} reason
 */
CalendarBlockViewModel.prototype['reason'] = undefined;

/**
 * @member {module:model/RepeatViewModel} repeat
 */
CalendarBlockViewModel.prototype['repeat'] = undefined;

/**
 * @member {Boolean} repeats
 */
CalendarBlockViewModel.prototype['repeats'] = undefined;

/**
 * @member {String} startDate
 */
CalendarBlockViewModel.prototype['startDate'] = undefined;

/**
 * @member {Number} startTime
 */
CalendarBlockViewModel.prototype['startTime'] = undefined;
...
export default CalendarBlockViewModel;
