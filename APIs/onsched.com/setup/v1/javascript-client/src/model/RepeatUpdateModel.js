...
/**
 * The RepeatUpdateModel model module.
 * @module model/RepeatUpdateModel
 * @version v1
 */
class RepeatUpdateModel {
    /**
     * Constructs a new <code>RepeatUpdateModel</code>.
     * @alias module:model/RepeatUpdateModel
     */
    constructor() { 
        
        RepeatUpdateModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepeatUpdateModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepeatUpdateModel} obj Optional instance to populate.
     * @return {module:model/RepeatUpdateModel} The populated <code>RepeatUpdateModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepeatUpdateModel();
    ...
    /**
     * Validates the JSON data with respect to <code>RepeatUpdateModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepeatUpdateModel</code>.
     */
 ...
 */
RepeatUpdateModel.prototype['frequency'] = undefined;

/**
 * @member {Number} interval
 */
RepeatUpdateModel.prototype['interval'] = undefined;

/**
 * @member {Number} monthDay
 */
RepeatUpdateModel.prototype['monthDay'] = undefined;

/**
 * @member {String} monthType
 */
RepeatUpdateModel.prototype['monthType'] = undefined;

/**
 * @member {String} weekdays
 */
RepeatUpdateModel.prototype['weekdays'] = undefined;
...
export default RepeatUpdateModel;
