...
/**
 * The CompanyInputModel model module.
 * @module model/CompanyInputModel
 * @version v1
 */
class CompanyInputModel {
    /**
     * Constructs a new <code>CompanyInputModel</code>.
     * @alias module:model/CompanyInputModel
     */
    constructor() { 
        
        CompanyInputModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompanyInputModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompanyInputModel} obj Optional instance to populate.
     * @return {module:model/CompanyInputModel} The populated <code>CompanyInputModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompanyInputModel();
    ...
    /**
     * Validates the JSON data with respect to <code>CompanyInputModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompanyInputModel</code>.
     */
 ...
 */
CompanyInputModel.prototype['addressLine1'] = undefined;

/**
 * @member {String} addressLine2
 */
CompanyInputModel.prototype['addressLine2'] = undefined;

/**
 * @member {String} bookingWebhookUrl
 */
CompanyInputModel.prototype['bookingWebhookUrl'] = undefined;

/**
 * @member {String} city
 */
CompanyInputModel.prototype['city'] = undefined;

/**
 * @member {String} country
 */
CompanyInputModel.prototype['country'] = undefined;

/**
 * @member {String} customerWebhookUrl
 */
CompanyInputModel.prototype['customerWebhookUrl'] = undefined;

/**
 * @member {Boolean} disableEmailAndSmsNotifications
 */
CompanyInputModel.prototype['disableEmailAndSmsNotifications'] = undefined;

/**
 * @member {String} email
 */
CompanyInputModel.prototype['email'] = undefined;

/**
 * @member {String} fax
 */
CompanyInputModel.prototype['fax'] = undefined;

/**
 * @member {String} name
 */
CompanyInputModel.prototype['name'] = undefined;

/**
 * @member {String} notificationFromEmailAddress
 */
CompanyInputModel.prototype['notificationFromEmailAddress'] = undefined;

/**
 * @member {String} notificationFromName
 */
CompanyInputModel.prototype['notificationFromName'] = undefined;

/**
 * @member {String} phone
 */
CompanyInputModel.prototype['phone'] = undefined;

/**
 * @member {String} postalCode
 */
CompanyInputModel.prototype['postalCode'] = undefined;

/**
 * @member {String} registrationEmail
 */
CompanyInputModel.prototype['registrationEmail'] = undefined;

/**
 * @member {String} reminderWebhookUrl
 */
CompanyInputModel.prototype['reminderWebhookUrl'] = undefined;

/**
 * @member {String} resourceWebhookUrl
 */
CompanyInputModel.prototype['resourceWebhookUrl'] = undefined;

/**
 * @member {String} state
 */
CompanyInputModel.prototype['state'] = undefined;

/**
 * @member {String} timezoneName
 */
CompanyInputModel.prototype['timezoneName'] = undefined;

/**
 * @member {String} webhookSignatureHash
 */
CompanyInputModel.prototype['webhookSignatureHash'] = undefined;

/**
 * @member {String} website
 */
CompanyInputModel.prototype['website'] = undefined;
...
export default CompanyInputModel;
