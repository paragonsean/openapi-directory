...
/**
 * The ResourceInputModel model module.
 * @module model/ResourceInputModel
 * @version v1
 */
class ResourceInputModel {
    /**
     * Constructs a new <code>ResourceInputModel</code>.
     * @alias module:model/ResourceInputModel
     */
    constructor() { 
        
        ResourceInputModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResourceInputModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceInputModel} obj Optional instance to populate.
     * @return {module:model/ResourceInputModel} The populated <code>ResourceInputModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceInputModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceInputModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceInputModel</code>.
     */
 ...
 */
ResourceInputModel.prototype['address'] = undefined;

/**
 * @member {module:model/AvailabilityInputModel} availability
 */
ResourceInputModel.prototype['availability'] = undefined;

/**
 * @member {module:model/ContactInputModel} contact
 */
ResourceInputModel.prototype['contact'] = undefined;

/**
 * @member {module:model/CustomFieldInputModel} customFields
 */
ResourceInputModel.prototype['customFields'] = undefined;

/**
 * @member {String} description
 */
ResourceInputModel.prototype['description'] = undefined;

/**
 * @member {String} email
 */
ResourceInputModel.prototype['email'] = undefined;

/**
 * @member {String} groupId
 */
ResourceInputModel.prototype['groupId'] = undefined;

/**
 * @member {String} locationId
 */
ResourceInputModel.prototype['locationId'] = undefined;

/**
 * @member {String} name
 */
ResourceInputModel.prototype['name'] = undefined;

/**
 * @member {module:model/ResourceOptionsInputModel} options
 */
ResourceInputModel.prototype['options'] = undefined;

/**
 * @member {Boolean} recurringAvailability
 */
ResourceInputModel.prototype['recurringAvailability'] = undefined;

/**
 * @member {Array.<String>} serviceIds
 */
ResourceInputModel.prototype['serviceIds'] = undefined;

/**
 * @member {String} timezoneId
 */
ResourceInputModel.prototype['timezoneId'] = undefined;
...
export default ResourceInputModel;
