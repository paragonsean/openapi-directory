...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resourceAllocation object
apiInstance.setupV1ResourcesAllocationsIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resourceAllocation object
apiInstance.setupV1ResourcesAllocationsIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceBlockViewModel setupV1ResourcesAllocationsIdPut(id, opts)
...
let id = "id_example"; // String | id of resourceAllocation object
let opts = {
  'resourceAllocationUpdateModel': new OnSchedSetupApi.ResourceAllocationUpdateModel() // ResourceAllocationUpdateModel | Resource allocation update model
};
apiInstance.setupV1ResourcesAllocationsIdPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resourceBlock object
apiInstance.setupV1ResourcesBlockIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceBlockViewModel setupV1ResourcesBlockIdPut(id, opts)
...
let id = "id_example"; // String | id of resourceBlock object
let opts = {
  'resourceBlockUpdateModel': new OnSchedSetupApi.ResourceBlockUpdateModel() // ResourceBlockUpdateModel | Resource Block update model
};
apiInstance.setupV1ResourcesBlockIdPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resourceBlock object
apiInstance.setupV1ResourcesBlocksIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ResourceViewModel] setupV1ResourcesBulkPost(opts)
...
let opts = {
  ...
  'resourcesInputModel': new OnSchedSetupApi.ResourcesInputModel() // ResourcesInputModel | Resources input model
};
apiInstance.setupV1ResourcesBulkPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ResourceViewModel] setupV1ResourcesBulkPut(opts)
...
let opts = {
  'googleAuthReturnUrl': "googleAuthReturnUrl_example", // String | Google calendar authorization return url
  'outlookAuthReturnUrl': "outlookAuthReturnUrl_example", // String | Outlook calendar authorization return url
  'resourcesUpdateModel': new OnSchedSetupApi.ResourcesUpdateModel() // ResourcesUpdateModel | Resources update model
};
apiInstance.setupV1ResourcesBulkPut(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceListViewModel setupV1ResourcesGet(opts)
...
let opts = {
  ...
  'resourceGroupId': "resourceGroupId_example", // String | Filter by group Id
  'email': "email_example", // String | Filter by email address
  'name': "name_example", // String | Search by name
  'deleted': true, // Boolean | Show by deleted status, default is false
  'googleAuthReturnUrl': "googleAuthReturnUrl_example", // String | Google calendar authorization return url
  'outlookAuthReturnUrl': "outlookAuthReturnUrl_example", // String | Outlook calendar authorization return url
  'offset': 56, // Number | Starting row of page, default 0
  'limit': 56 // Number | Page limit default 20, max is 100
};
apiInstance.setupV1ResourcesGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **limit** | **Number**| Page limit default 20, max is 100 | [optional] 
...
> ResourceAllocationListViewModel setupV1ResourcesIdAllocationsGet(id, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource to list allocations for
let opts = {
  'startDate': new Date("2013-10-20T19:20:30+01:00"), // Date | yyyy-mm-dd, filter allocations on/after startDate
  'endDate': new Date("2013-10-20T19:20:30+01:00"), // Date | yyyy-mm-dd, filter on/before endDate
  'offset': 56, // Number | Starting row of page, default 0
  'limit': 56 // Number | Page limit default 20, max 100
};
apiInstance.setupV1ResourcesIdAllocationsGet(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **startDate** | **Date**| yyyy-mm-dd, filter allocations on/after startDate | [optional] 
 **endDate** | **Date**| yyyy-mm-dd, filter on/before endDate | [optional] 
 **offset** | **Number**| Starting row of page, default 0 | [optional] 
...
> ResourceBlockViewModel setupV1ResourcesIdAllocationsPost(id, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
let opts = {
  'resourceAllocationInputModel': new OnSchedSetupApi.ResourceAllocationInputModel() // ResourceAllocationInputModel | 
};
apiInstance.setupV1ResourcesIdAllocationsPost(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
apiInstance.setupV1ResourcesIdAvailabilityGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceAvailabilityViewModel setupV1ResourcesIdAvailabilityPut(id, opts)
...
let id = "id_example"; // String | id of resource object
let opts = {
  'availabilityInputModel': new OnSchedSetupApi.AvailabilityInputModel() // AvailabilityInputModel | Resource Availability Input Model
};
apiInstance.setupV1ResourcesIdAvailabilityPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceBlockViewModel setupV1ResourcesIdBlockPost(id, opts)
...
let id = "id_example"; // String | id of resource object
let opts = {
  'resourceBlockInputModel': new OnSchedSetupApi.ResourceBlockInputModel() // ResourceBlockInputModel | 
};
apiInstance.setupV1ResourcesIdBlockPost(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceBlockListViewModel setupV1ResourcesIdBlocksGet(id, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource to list blocks for
let opts = {
  'startDate': new Date("2013-10-20T19:20:30+01:00"), // Date | YYYY-MM-DD, filter blocks on/after startDate
  'endDate': new Date("2013-10-20T19:20:30+01:00"), // Date | YYYY-MM-DD, filter on/before endDate
  'offset': 56, // Number | Starting row of page, default 0
  'limit': 56 // Number | Page limit default 20, max 100
};
apiInstance.setupV1ResourcesIdBlocksGet(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **startDate** | **Date**| YYYY-MM-DD, filter blocks on/after startDate | [optional] 
 **endDate** | **Date**| YYYY-MM-DD, filter on/before endDate | [optional] 
 **offset** | **Number**| Starting row of page, default 0 | [optional] 
 **limit** | **Number**| Page limit default 20, max 100 | [optional] 
...
> CalendarAuthViewModel setupV1ResourcesIdCalendarAuthGoogleGoogleEmailAddressGet(id, googleEmailAddress, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
let googleEmailAddress = "googleEmailAddress_example"; // String | Email address of Google Calendar
let opts = {
  'googleAuthReturnUrl': "googleAuthReturnUrl_example" // String | Google calendar authorization return url
};
apiInstance.setupV1ResourcesIdCalendarAuthGoogleGoogleEmailAddressGet(id, googleEmailAddress, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CalendarAuthViewModel setupV1ResourcesIdCalendarAuthOutlookOutlookEmailAddressGet(id, outlookEmailAddress, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
let outlookEmailAddress = "outlookEmailAddress_example"; // String | Email address of Outlook Calendar
let opts = {
  'outlookAuthReturnUrl': "outlookAuthReturnUrl_example" // String | Outlook calendar authorization return url
};
apiInstance.setupV1ResourcesIdCalendarAuthOutlookOutlookEmailAddressGet(id, outlookEmailAddress, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
apiInstance.setupV1ResourcesIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
apiInstance.setupV1ResourcesIdDeleteimageDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesIdGet(id, opts)
...
apiInstance.setupV1ResourcesIdGet(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesIdPut(id, opts)
...
let opts = {
  'googleAuthReturnUrl': "googleAuthReturnUrl_example", // String | Google calendar authorization return url
  'outlookAuthReturnUrl': "outlookAuthReturnUrl_example", // String | Outlook calendar authorization return url
  'resourceUpdateModel': new OnSchedSetupApi.ResourceUpdateModel() // ResourceUpdateModel | Resource Update Model
};
apiInstance.setupV1ResourcesIdPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [AppointmentViewModel] setupV1ResourcesIdReassignAppointmentsResourceIdPut(id, resourceId, opts)
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of the original resource
let resourceId = "resourceId_example"; // String | id of the target resource
let opts = {
  'startDate': new Date("2013-10-20T19:20:30+01:00"), // Date | YYYY-MM-DD, Appt range start date
  'endDate': new Date("2013-10-20T19:20:30+01:00"), // Date | YYYY-MM-DD, Appt range end date
  'calendarId': "calendarId_example" // String | CalendarId of calendar containing appointments
};
apiInstance.setupV1ResourcesIdReassignAppointmentsResourceIdPut(id, resourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **startDate** | **Date**| YYYY-MM-DD, Appt range start date | [optional] 
 **endDate** | **Date**| YYYY-MM-DD, Appt range end date | [optional] 
...
> ResourceViewModel setupV1ResourcesIdRecoverPut(id, opts)
...
apiInstance.setupV1ResourcesIdRecoverPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
let id = "id_example"; // String | id of resource object
apiInstance.setupV1ResourcesIdServicesDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesIdServicesPost(id, opts)
...
apiInstance.setupV1ResourcesIdServicesPost(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesIdServicesPut(id, opts)
...
apiInstance.setupV1ResourcesIdServicesPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesIdUploadimagePost(id, opts)
...
apiInstance.setupV1ResourcesIdUploadimagePost(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResourceViewModel setupV1ResourcesPost(opts)
...
let opts = {
  'googleAuthReturnUrl': "googleAuthReturnUrl_example", // String | Google calendar authorization return url
  'outlookAuthReturnUrl': "outlookAuthReturnUrl_example", // String | Outlook calendar authorization return url
  'resourceInputModel': new OnSchedSetupApi.ResourceInputModel() // ResourceInputModel | Resource input model
};
apiInstance.setupV1ResourcesPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedSetupApi.ResourcesApi();
apiInstance.setupV1ResourcesTimezonesGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
