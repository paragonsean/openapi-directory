...
public class ResourceOptionsInputModel {
  ...
  public ResourceOptionsInputModel bioLink(String bioLink) {
  ...
  public ResourceOptionsInputModel bookingNotification(Integer bookingNotification) {
  ...
  public ResourceOptionsInputModel calendarAvailability(Integer calendarAvailability) {
  ...
  public ResourceOptionsInputModel displayColor(String displayColor) {
  ...
  public ResourceOptionsInputModel effectiveDate(OffsetDateTime effectiveDate) {
  ...
  public ResourceOptionsInputModel gender(String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public ResourceOptionsInputModel googleCalendarId(String googleCalendarId) {
  ...
  public ResourceOptionsInputModel hourly(Double hourly) {
    this.hourly = hourly;
    return this;
  }
  ...
  public ResourceOptionsInputModel ignoreBusinessHours(Boolean ignoreBusinessHours) {
  ...
  public ResourceOptionsInputModel notificationType(Integer notificationType) {
  ...
  public ResourceOptionsInputModel outlookCalendarId(String outlookCalendarId) {
  ...
  public ResourceOptionsInputModel sortKey(Integer sortKey) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceOptionsInputModel resourceOptionsInputModel = (ResourceOptionsInputModel) o;
    return Objects.equals(this.bioLink, resourceOptionsInputModel.bioLink) &&
        Objects.equals(this.bookingNotification, resourceOptionsInputModel.bookingNotification) &&
        Objects.equals(this.calendarAvailability, resourceOptionsInputModel.calendarAvailability) &&
        Objects.equals(this.displayColor, resourceOptionsInputModel.displayColor) &&
        Objects.equals(this.effectiveDate, resourceOptionsInputModel.effectiveDate) &&
        Objects.equals(this.gender, resourceOptionsInputModel.gender) &&
        Objects.equals(this.googleCalendarId, resourceOptionsInputModel.googleCalendarId) &&
        Objects.equals(this.hourly, resourceOptionsInputModel.hourly) &&
        Objects.equals(this.ignoreBusinessHours, resourceOptionsInputModel.ignoreBusinessHours) &&
        Objects.equals(this.notificationType, resourceOptionsInputModel.notificationType) &&
        Objects.equals(this.outlookCalendarId, resourceOptionsInputModel.outlookCalendarId) &&
        Objects.equals(this.sortKey, resourceOptionsInputModel.sortKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceOptionsInputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceOptionsInputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceOptionsInputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceOptionsInputModel is not found in the empty JSON string", ResourceOptionsInputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceOptionsInputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceOptionsInputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceOptionsInputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceOptionsInputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceOptionsInputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceOptionsInputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceOptionsInputModel>() {
           @Override
           public void write(JsonWriter out, ResourceOptionsInputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceOptionsInputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceOptionsInputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceOptionsInputModel
   * @throws IOException if the JSON string is invalid with respect to ResourceOptionsInputModel
   */
  public static ResourceOptionsInputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceOptionsInputModel.class);
  }

  /**
   * Convert an instance of ResourceOptionsInputModel to an JSON string
   *
   * @return JSON string
   */
