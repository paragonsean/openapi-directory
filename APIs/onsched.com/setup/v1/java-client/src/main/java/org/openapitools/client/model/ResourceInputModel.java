...
public class ResourceInputModel {
  ...
  public ResourceInputModel address(AddressInputModel address) {
  ...
  public ResourceInputModel availability(AvailabilityInputModel availability) {
  ...
  public ResourceInputModel contact(ContactInputModel contact) {
  ...
  public ResourceInputModel customFields(CustomFieldInputModel customFields) {
  ...
  public ResourceInputModel description(String description) {
  ...
  public ResourceInputModel email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ResourceInputModel groupId(String groupId) {
  ...
  public ResourceInputModel locationId(String locationId) {
  ...
  public ResourceInputModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceInputModel options(ResourceOptionsInputModel options) {
  ...
  public ResourceInputModel recurringAvailability(Boolean recurringAvailability) {
  ...
  public ResourceInputModel serviceIds(List<String> serviceIds) {
    this.serviceIds = serviceIds;
    return this;
  }

  public ResourceInputModel addServiceIdsItem(String serviceIdsItem) {
  ...
  public ResourceInputModel timezoneId(String timezoneId) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceInputModel resourceInputModel = (ResourceInputModel) o;
    return Objects.equals(this.address, resourceInputModel.address) &&
        Objects.equals(this.availability, resourceInputModel.availability) &&
        Objects.equals(this.contact, resourceInputModel.contact) &&
        Objects.equals(this.customFields, resourceInputModel.customFields) &&
        Objects.equals(this.description, resourceInputModel.description) &&
        Objects.equals(this.email, resourceInputModel.email) &&
        Objects.equals(this.groupId, resourceInputModel.groupId) &&
        Objects.equals(this.locationId, resourceInputModel.locationId) &&
        Objects.equals(this.name, resourceInputModel.name) &&
        Objects.equals(this.options, resourceInputModel.options) &&
        Objects.equals(this.recurringAvailability, resourceInputModel.recurringAvailability) &&
        Objects.equals(this.serviceIds, resourceInputModel.serviceIds) &&
        Objects.equals(this.timezoneId, resourceInputModel.timezoneId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceInputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceInputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceInputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceInputModel is not found in the empty JSON string", ResourceInputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceInputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceInputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceInputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceInputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceInputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceInputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceInputModel>() {
           @Override
           public void write(JsonWriter out, ResourceInputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceInputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceInputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceInputModel
   * @throws IOException if the JSON string is invalid with respect to ResourceInputModel
   */
  public static ResourceInputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceInputModel.class);
  }

  /**
   * Convert an instance of ResourceInputModel to an JSON string
   *
   * @return JSON string
   */
