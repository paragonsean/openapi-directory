...
public class CompanyInputModel {
  ...
  public CompanyInputModel addressLine1(String addressLine1) {
  ...
  public CompanyInputModel addressLine2(String addressLine2) {
  ...
  public CompanyInputModel bookingWebhookUrl(String bookingWebhookUrl) {
  ...
  public CompanyInputModel city(String city) {
    this.city = city;
    return this;
  }
  ...
  public CompanyInputModel country(String country) {
  ...
  public CompanyInputModel customerWebhookUrl(String customerWebhookUrl) {
  ...
  public CompanyInputModel disableEmailAndSmsNotifications(Boolean disableEmailAndSmsNotifications) {
  ...
  public CompanyInputModel email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CompanyInputModel fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public CompanyInputModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CompanyInputModel notificationFromEmailAddress(String notificationFromEmailAddress) {
  ...
  public CompanyInputModel notificationFromName(String notificationFromName) {
  ...
  public CompanyInputModel phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public CompanyInputModel postalCode(String postalCode) {
  ...
  public CompanyInputModel registrationEmail(String registrationEmail) {
  ...
  public CompanyInputModel reminderWebhookUrl(String reminderWebhookUrl) {
  ...
  public CompanyInputModel resourceWebhookUrl(String resourceWebhookUrl) {
  ...
  public CompanyInputModel state(String state) {
    this.state = state;
    return this;
  }
  ...
  public CompanyInputModel timezoneName(String timezoneName) {
  ...
  public CompanyInputModel webhookSignatureHash(String webhookSignatureHash) {
  ...
  public CompanyInputModel website(String website) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyInputModel companyInputModel = (CompanyInputModel) o;
    return Objects.equals(this.addressLine1, companyInputModel.addressLine1) &&
        Objects.equals(this.addressLine2, companyInputModel.addressLine2) &&
        Objects.equals(this.bookingWebhookUrl, companyInputModel.bookingWebhookUrl) &&
        Objects.equals(this.city, companyInputModel.city) &&
        Objects.equals(this.country, companyInputModel.country) &&
        Objects.equals(this.customerWebhookUrl, companyInputModel.customerWebhookUrl) &&
        Objects.equals(this.disableEmailAndSmsNotifications, companyInputModel.disableEmailAndSmsNotifications) &&
        Objects.equals(this.email, companyInputModel.email) &&
        Objects.equals(this.fax, companyInputModel.fax) &&
        Objects.equals(this.name, companyInputModel.name) &&
        Objects.equals(this.notificationFromEmailAddress, companyInputModel.notificationFromEmailAddress) &&
        Objects.equals(this.notificationFromName, companyInputModel.notificationFromName) &&
        Objects.equals(this.phone, companyInputModel.phone) &&
        Objects.equals(this.postalCode, companyInputModel.postalCode) &&
        Objects.equals(this.registrationEmail, companyInputModel.registrationEmail) &&
        Objects.equals(this.reminderWebhookUrl, companyInputModel.reminderWebhookUrl) &&
        Objects.equals(this.resourceWebhookUrl, companyInputModel.resourceWebhookUrl) &&
        Objects.equals(this.state, companyInputModel.state) &&
        Objects.equals(this.timezoneName, companyInputModel.timezoneName) &&
        Objects.equals(this.webhookSignatureHash, companyInputModel.webhookSignatureHash) &&
        Objects.equals(this.website, companyInputModel.website);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyInputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyInputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyInputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyInputModel is not found in the empty JSON string", CompanyInputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyInputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyInputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyInputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyInputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyInputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyInputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyInputModel>() {
           @Override
           public void write(JsonWriter out, CompanyInputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompanyInputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompanyInputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompanyInputModel
   * @throws IOException if the JSON string is invalid with respect to CompanyInputModel
   */
  public static CompanyInputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyInputModel.class);
  }

  /**
   * Convert an instance of CompanyInputModel to an JSON string
   *
   * @return JSON string
   */
