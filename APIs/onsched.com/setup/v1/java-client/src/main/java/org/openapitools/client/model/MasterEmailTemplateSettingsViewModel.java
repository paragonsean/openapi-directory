...
public class MasterEmailTemplateSettingsViewModel {
  ...
  public MasterEmailTemplateSettingsViewModel() {
  }

  public MasterEmailTemplateSettingsViewModel centerEmailContent(Boolean centerEmailContent) {
  ...
  public MasterEmailTemplateSettingsViewModel centerEmailContentPanel(Boolean centerEmailContentPanel) {
  ...
  public MasterEmailTemplateSettingsViewModel centerEmailFooter(Boolean centerEmailFooter) {
  ...
  public MasterEmailTemplateSettingsViewModel contentBackgroundColor(String contentBackgroundColor) {
  ...
  public MasterEmailTemplateSettingsViewModel contentColor(String contentColor) {
  ...
  public MasterEmailTemplateSettingsViewModel contentLinkColor(String contentLinkColor) {
  ...
  public MasterEmailTemplateSettingsViewModel emailBackgroundColor(String emailBackgroundColor) {
  ...
  public MasterEmailTemplateSettingsViewModel emailColor(String emailColor) {
  ...
  public MasterEmailTemplateSettingsViewModel emailLinkColor(String emailLinkColor) {
  ...
  public MasterEmailTemplateSettingsViewModel footerFontSize(String footerFontSize) {
  ...
  public MasterEmailTemplateSettingsViewModel footerLogoHeight(String footerLogoHeight) {
  ...
  public MasterEmailTemplateSettingsViewModel footerLogoPadding(String footerLogoPadding) {
  ...
  public MasterEmailTemplateSettingsViewModel footerPanelEmailContact(Boolean footerPanelEmailContact) {
  ...
  public MasterEmailTemplateSettingsViewModel footerPanelPhoneContact(Boolean footerPanelPhoneContact) {
  ...
  public MasterEmailTemplateSettingsViewModel footerPanelWebsiteContact(Boolean footerPanelWebsiteContact) {
  ...
  public MasterEmailTemplateSettingsViewModel headerLogoHeight(String headerLogoHeight) {
  ...
  public MasterEmailTemplateSettingsViewModel headerLogoPadding(String headerLogoPadding) {
  ...
  public MasterEmailTemplateSettingsViewModel panelBackgroundColor(String panelBackgroundColor) {
  ...
  public MasterEmailTemplateSettingsViewModel panelColor(String panelColor) {
  ...
  public MasterEmailTemplateSettingsViewModel panelLinkColor(String panelLinkColor) {
  ...
  public MasterEmailTemplateSettingsViewModel privacyPolicyLink(String privacyPolicyLink) {
  ...
  public MasterEmailTemplateSettingsViewModel showContentPanel(Boolean showContentPanel) {
  ...
  public MasterEmailTemplateSettingsViewModel showFooterLogo(Boolean showFooterLogo) {
  ...
  public MasterEmailTemplateSettingsViewModel showFooterPanel(Boolean showFooterPanel) {
  ...
  public MasterEmailTemplateSettingsViewModel showHeaderLogo(Boolean showHeaderLogo) {
  ...
  public MasterEmailTemplateSettingsViewModel showHeaderPanel(Boolean showHeaderPanel) {
  ...
  public MasterEmailTemplateSettingsViewModel version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    MasterEmailTemplateSettingsViewModel masterEmailTemplateSettingsViewModel = (MasterEmailTemplateSettingsViewModel) o;
    return Objects.equals(this.centerEmailContent, masterEmailTemplateSettingsViewModel.centerEmailContent) &&
        Objects.equals(this.centerEmailContentPanel, masterEmailTemplateSettingsViewModel.centerEmailContentPanel) &&
        Objects.equals(this.centerEmailFooter, masterEmailTemplateSettingsViewModel.centerEmailFooter) &&
        Objects.equals(this.contentBackgroundColor, masterEmailTemplateSettingsViewModel.contentBackgroundColor) &&
        Objects.equals(this.contentColor, masterEmailTemplateSettingsViewModel.contentColor) &&
        Objects.equals(this.contentLinkColor, masterEmailTemplateSettingsViewModel.contentLinkColor) &&
        Objects.equals(this.emailBackgroundColor, masterEmailTemplateSettingsViewModel.emailBackgroundColor) &&
        Objects.equals(this.emailColor, masterEmailTemplateSettingsViewModel.emailColor) &&
        Objects.equals(this.emailLinkColor, masterEmailTemplateSettingsViewModel.emailLinkColor) &&
        Objects.equals(this.footerFontSize, masterEmailTemplateSettingsViewModel.footerFontSize) &&
        Objects.equals(this.footerLogoHeight, masterEmailTemplateSettingsViewModel.footerLogoHeight) &&
        Objects.equals(this.footerLogoPadding, masterEmailTemplateSettingsViewModel.footerLogoPadding) &&
        Objects.equals(this.footerPanelEmailContact, masterEmailTemplateSettingsViewModel.footerPanelEmailContact) &&
        Objects.equals(this.footerPanelPhoneContact, masterEmailTemplateSettingsViewModel.footerPanelPhoneContact) &&
        Objects.equals(this.footerPanelWebsiteContact, masterEmailTemplateSettingsViewModel.footerPanelWebsiteContact) &&
        Objects.equals(this.headerLogoHeight, masterEmailTemplateSettingsViewModel.headerLogoHeight) &&
        Objects.equals(this.headerLogoPadding, masterEmailTemplateSettingsViewModel.headerLogoPadding) &&
        Objects.equals(this.panelBackgroundColor, masterEmailTemplateSettingsViewModel.panelBackgroundColor) &&
        Objects.equals(this.panelColor, masterEmailTemplateSettingsViewModel.panelColor) &&
        Objects.equals(this.panelLinkColor, masterEmailTemplateSettingsViewModel.panelLinkColor) &&
        Objects.equals(this.privacyPolicyLink, masterEmailTemplateSettingsViewModel.privacyPolicyLink) &&
        Objects.equals(this.showContentPanel, masterEmailTemplateSettingsViewModel.showContentPanel) &&
        Objects.equals(this.showFooterLogo, masterEmailTemplateSettingsViewModel.showFooterLogo) &&
        Objects.equals(this.showFooterPanel, masterEmailTemplateSettingsViewModel.showFooterPanel) &&
        Objects.equals(this.showHeaderLogo, masterEmailTemplateSettingsViewModel.showHeaderLogo) &&
        Objects.equals(this.showHeaderPanel, masterEmailTemplateSettingsViewModel.showHeaderPanel) &&
        Objects.equals(this.version, masterEmailTemplateSettingsViewModel.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class MasterEmailTemplateSettingsViewModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MasterEmailTemplateSettingsViewModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MasterEmailTemplateSettingsViewModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MasterEmailTemplateSettingsViewModel is not found in the empty JSON string", MasterEmailTemplateSettingsViewModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MasterEmailTemplateSettingsViewModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MasterEmailTemplateSettingsViewModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MasterEmailTemplateSettingsViewModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MasterEmailTemplateSettingsViewModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MasterEmailTemplateSettingsViewModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MasterEmailTemplateSettingsViewModel.class));

       return (TypeAdapter<T>) new TypeAdapter<MasterEmailTemplateSettingsViewModel>() {
           @Override
           public void write(JsonWriter out, MasterEmailTemplateSettingsViewModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MasterEmailTemplateSettingsViewModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MasterEmailTemplateSettingsViewModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MasterEmailTemplateSettingsViewModel
   * @throws IOException if the JSON string is invalid with respect to MasterEmailTemplateSettingsViewModel
   */
  public static MasterEmailTemplateSettingsViewModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MasterEmailTemplateSettingsViewModel.class);
  }

  /**
   * Convert an instance of MasterEmailTemplateSettingsViewModel to an JSON string
   *
   * @return JSON string
   */
