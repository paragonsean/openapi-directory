...
<a id="setupV1ServicesAllocationsIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ServiceAllocationViewModel result = apiInstance.setupV1ServicesAllocationsIdDelete(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesAllocationsIdDelete");
...
<a id="setupV1ServicesAllocationsIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | id of serviceAllocation object
    try {
      ServiceAllocationViewModel result = apiInstance.setupV1ServicesAllocationsIdGet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesAllocationsIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesAllocationsIdPut"></a>
# **setupV1ServicesAllocationsIdPut**
> ServiceAllocationViewModel setupV1ServicesAllocationsIdPut(id, serviceAllocationUpdateModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of serviceAllocation object
    ServiceAllocationUpdateModel serviceAllocationUpdateModel = new ServiceAllocationUpdateModel(); // ServiceAllocationUpdateModel | Service allocation update model
    try {
      ServiceAllocationViewModel result = apiInstance.setupV1ServicesAllocationsIdPut(id, serviceAllocationUpdateModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesAllocationsIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesBlockIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of serviceBlock object
    try {
      ResourceBlockViewModel result = apiInstance.setupV1ServicesBlockIdDelete(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesBlockIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesBlockIdPut"></a>
# **setupV1ServicesBlockIdPut**
> ServiceBlockViewModel setupV1ServicesBlockIdPut(id, serviceBlockUpdateModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of serviceBlock object
    ServiceBlockUpdateModel serviceBlockUpdateModel = new ServiceBlockUpdateModel(); // ServiceBlockUpdateModel | Service Block update model
    try {
      ServiceBlockViewModel result = apiInstance.setupV1ServicesBlockIdPut(id, serviceBlockUpdateModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesBlockIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesBlocksIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | id of serviceBlock object
    try {
      ResourceBlockViewModel result = apiInstance.setupV1ServicesBlocksIdGet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesBlocksIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesCalendarIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of calender to delete service links from
    try {
      ServiceCalendarViewModel result = apiInstance.setupV1ServicesCalendarIdDelete(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesCalendarIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesCalendarPost"></a>
# **setupV1ServicesCalendarPost**
> ServiceCalendarViewModel setupV1ServicesCalendarPost(serviceCalendarInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    ServiceCalendarInputModel serviceCalendarInputModel = new ServiceCalendarInputModel(); // ServiceCalendarInputModel | 
    try {
      ServiceCalendarViewModel result = apiInstance.setupV1ServicesCalendarPost(serviceCalendarInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesCalendarPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesGet"></a>
# **setupV1ServicesGet**
> ServiceListViewModel setupV1ServicesGet(locationId, serviceGroupId, deleted, offset, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer serviceGroupId = 56; // Integer | Filter services by groupId
    ...
    try {
      ServiceListViewModel result = apiInstance.setupV1ServicesGet(locationId, serviceGroupId, deleted, offset, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **serviceGroupId** | **Integer**| Filter services by groupId | [optional] |
...
<a id="setupV1ServicesIdAllocationsBulkPost"></a>
# **setupV1ServicesIdAllocationsBulkPost**
> List&lt;ServiceAllocationViewModel&gt; setupV1ServicesIdAllocationsBulkPost(id, serviceAllocationsInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServiceAllocationsInputModel serviceAllocationsInputModel = new ServiceAllocationsInputModel(); // ServiceAllocationsInputModel | 
    try {
      List<ServiceAllocationViewModel> result = apiInstance.setupV1ServicesIdAllocationsBulkPost(id, serviceAllocationsInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdAllocationsBulkPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**List&lt;ServiceAllocationViewModel&gt;**](ServiceAllocationViewModel.md)
...
<a id="setupV1ServicesIdAllocationsGet"></a>
# **setupV1ServicesIdAllocationsGet**
> ServiceAllocationListViewModel setupV1ServicesIdAllocationsGet(id, locationId, resourceId, startDate, endDate, offset, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    String locationId = "locationId_example"; // String | The id of the location. Defaults to the primary location
    String resourceId = "resourceId_example"; // String | The id of the resource to filter on
    ...
    Integer limit = 56; // Integer | Page limit default 20, max 100
    try {
      ServiceAllocationListViewModel result = apiInstance.setupV1ServicesIdAllocationsGet(id, locationId, resourceId, startDate, endDate, offset, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdAllocationsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdAllocationsPost"></a>
# **setupV1ServicesIdAllocationsPost**
> ServiceAllocationViewModel setupV1ServicesIdAllocationsPost(id, serviceAllocationInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of service object
    ServiceAllocationInputModel serviceAllocationInputModel = new ServiceAllocationInputModel(); // ServiceAllocationInputModel | 
    try {
      ServiceAllocationViewModel result = apiInstance.setupV1ServicesIdAllocationsPost(id, serviceAllocationInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdAllocationsPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdAvailabilityGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | id of service object
    try {
      ServiceAvailabilityViewModel result = apiInstance.setupV1ServicesIdAvailabilityGet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdAvailabilityGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdAvailabilityPut"></a>
# **setupV1ServicesIdAvailabilityPut**
> ServiceAvailabilityViewModel setupV1ServicesIdAvailabilityPut(id, availabilityInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of service object
    AvailabilityInputModel availabilityInputModel = new AvailabilityInputModel(); // AvailabilityInputModel | Service Availability Input Model
    try {
      ServiceAvailabilityViewModel result = apiInstance.setupV1ServicesIdAvailabilityPut(id, availabilityInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdAvailabilityPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdBlockPost"></a>
# **setupV1ServicesIdBlockPost**
> ServiceBlockViewModel setupV1ServicesIdBlockPost(id, serviceBlockInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of service object
    ServiceBlockInputModel serviceBlockInputModel = new ServiceBlockInputModel(); // ServiceBlockInputModel | 
    try {
      ServiceBlockViewModel result = apiInstance.setupV1ServicesIdBlockPost(id, serviceBlockInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdBlockPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdBlocksGet"></a>
# **setupV1ServicesIdBlocksGet**
> ServiceBlockListViewModel setupV1ServicesIdBlocksGet(id, startDate, endDate, offset, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of service to list blocks for
    OffsetDateTime startDate = OffsetDateTime.now(); // OffsetDateTime | Format YYYY-MM-DD. Filter blocks on/after startDate
    OffsetDateTime endDate = OffsetDateTime.now(); // OffsetDateTime | Format YYYY-MM-DD. Filter on/before endDate
    Integer offset = 56; // Integer | Starting row of page, default 0
    Integer limit = 56; // Integer | Page limit default 20, max 100
    try {
      ServiceBlockListViewModel result = apiInstance.setupV1ServicesIdBlocksGet(id, startDate, endDate, offset, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdBlocksGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **startDate** | **OffsetDateTime**| Format YYYY-MM-DD. Filter blocks on/after startDate | [optional] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | service block object&#39;s |  -  |
| **400** | Missing or invalid values in the request |  -  |
| **401** | Authorization error. |  -  |
| **404** | Service was not found |  -  |

<a id="setupV1ServicesIdCalendarGet"></a>
# **setupV1ServicesIdCalendarGet**
> ServiceCalendarViewModel setupV1ServicesIdCalendarGet(id, locationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String locationId = "locationId_example"; // String | id of business location, defaults to primary business location
    try {
      ServiceCalendarViewModel result = apiInstance.setupV1ServicesIdCalendarGet(id, locationId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdCalendarGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | id of service object
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdDelete(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdDeleteimageDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | id of service object
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdDeleteimageDelete(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdDeleteimageDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdGet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdPut"></a>
# **setupV1ServicesIdPut**
> ServiceViewModel setupV1ServicesIdPut(id, serviceUpdateModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServiceUpdateModel serviceUpdateModel = new ServiceUpdateModel(); // ServiceUpdateModel | 
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdPut(id, serviceUpdateModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdRecoverPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | 
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdRecoverPut(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdRecoverPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdResourcesGet"></a>
# **setupV1ServicesIdResourcesGet**
> ResourceListViewModel setupV1ServicesIdResourcesGet(id, offset, limit, googleAuthReturnUrl, outlookAuthReturnUrl)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResourceListViewModel result = apiInstance.setupV1ServicesIdResourcesGet(id, offset, limit, googleAuthReturnUrl, outlookAuthReturnUrl);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdResourcesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesIdUploadimagePost"></a>
# **setupV1ServicesIdUploadimagePost**
> ServiceViewModel setupV1ServicesIdUploadimagePost(id, serviceImageInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String id = "id_example"; // String | id of service object
    ServiceImageInputModel serviceImageInputModel = new ServiceImageInputModel(); // ServiceImageInputModel | Input model for image upload
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesIdUploadimagePost(id, serviceImageInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesIdUploadimagePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setupV1ServicesPost"></a>
# **setupV1ServicesPost**
> ServiceViewModel setupV1ServicesPost(serviceInputModel)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    ServiceInputModel serviceInputModel = new ServiceInputModel(); // ServiceInputModel | 
    try {
      ServiceViewModel result = apiInstance.setupV1ServicesPost(serviceInputModel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#setupV1ServicesPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
