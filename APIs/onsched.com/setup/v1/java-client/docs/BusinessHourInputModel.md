...
|------------ | ------------- | ------------- | -------------|
|**endTime** | **Integer** | endTime is entered in military format. e.g. 1800 &#x3D; 6pm end, 2400 &#x3D; midnight end of day.  For 24 hours enter startTime &#x3D; 0 and endTime &#x3D; 2400 |  [optional] |
...
|**startTime** | **Integer** | startTime is entered in military format. e.g. 0 &#x3D; midnight start, 900 &#x3D; 9am start |  [optional] |
