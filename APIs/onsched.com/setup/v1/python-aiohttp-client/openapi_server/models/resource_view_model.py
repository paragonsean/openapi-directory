...
class ResourceViewModel(Model):
    ...
    def __init__(self, address: AddressViewModel=None, availability: ResourceHoursViewModel=None, bio_link: str=None, booking_notification: int=None, calendar_availability: int=None, contact: ContactViewModel=None, custom_fields: CustomFieldInputModel=None, deleted_status: bool=None, deleted_time: datetime=None, description: str=None, effective_date: datetime=None, email: str=None, gender: str=None, google_calendar_auth_url: str=None, google_calendar_authorized: bool=None, google_calendar_id: str=None, group_id: int=None, hourly: float=None, id: str=None, ignore_business_hours: bool=None, image_url: str=None, location_id: str=None, name: str=None, notification_type: int=None, object: str=None, options: ResourceOptionsInputModel=None, outlook_calendar_auth_url: str=None, outlook_calendar_authorized: bool=None, outlook_calendar_id: str=None, phone: PhoneViewModel=None, recurring_availability: bool=None, services: List[ResourceServiceViewModel]=None, skype_name: str=None, sort_key: int=None, timezone_iana: str=None, timezone_id: str=None, timezone_offset: int=None):
        ...
        :param google_calendar_auth_url: The google_calendar_auth_url of this ResourceViewModel.
        :param google_calendar_authorized: The google_calendar_authorized of this ResourceViewModel.
        ...
        :param options: The options of this ResourceViewModel.
        :param outlook_calendar_auth_url: The outlook_calendar_auth_url of this ResourceViewModel.
        :param outlook_calendar_authorized: The outlook_calendar_authorized of this ResourceViewModel.
        :param outlook_calendar_id: The outlook_calendar_id of this ResourceViewModel.
        :param phone: The phone of this ResourceViewModel.
        ...
        self.openapi_types = {
            ...
            'outlook_calendar_auth_url': str,
            'outlook_calendar_authorized': bool,
        ...
        self.attribute_map = {
            ...
            'email': 'email',
            'gender': 'gender',
            'google_calendar_auth_url': 'googleCalendarAuthUrl',
            'google_calendar_authorized': 'googleCalendarAuthorized',
            ...
            'object': 'object',
            'options': 'options',
            'outlook_calendar_auth_url': 'outlookCalendarAuthUrl',
            'outlook_calendar_authorized': 'outlookCalendarAuthorized',
        ...
        self._email = email
        self._gender = gender
        self._google_calendar_auth_url = google_calendar_auth_url
        self._google_calendar_authorized = google_calendar_authorized
        ...
        self._outlook_calendar_auth_url = outlook_calendar_auth_url
        self._outlook_calendar_authorized = outlook_calendar_authorized
    ...
    @property
    def google_calendar_auth_url(self):
        """Gets the google_calendar_auth_url of this ResourceViewModel.


        :return: The google_calendar_auth_url of this ResourceViewModel.
        :rtype: str
        """
        return self._google_calendar_auth_url

    @google_calendar_auth_url.setter
    def google_calendar_auth_url(self, google_calendar_auth_url):
        """Sets the google_calendar_auth_url of this ResourceViewModel.


        :param google_calendar_auth_url: The google_calendar_auth_url of this ResourceViewModel.
        :type google_calendar_auth_url: str
        """

        self._google_calendar_auth_url = google_calendar_auth_url

    @property
    def google_calendar_authorized(self):
        """Gets the google_calendar_authorized of this ResourceViewModel.


        :return: The google_calendar_authorized of this ResourceViewModel.
        :rtype: bool
        """
        return self._google_calendar_authorized

    @google_calendar_authorized.setter
    def google_calendar_authorized(self, google_calendar_authorized):
        """Sets the google_calendar_authorized of this ResourceViewModel.


        :param google_calendar_authorized: The google_calendar_authorized of this ResourceViewModel.
        :type google_calendar_authorized: bool
        """
    ...
    @property
    def options(self):
        """Gets the options of this ResourceViewModel.


        :return: The options of this ResourceViewModel.
    ...
    def options(self, options):
        """Sets the options of this ResourceViewModel.
    ...
    @property
    def outlook_calendar_auth_url(self):
        """Gets the outlook_calendar_auth_url of this ResourceViewModel.


        :return: The outlook_calendar_auth_url of this ResourceViewModel.
        :rtype: str
        """
        return self._outlook_calendar_auth_url

    @outlook_calendar_auth_url.setter
    def outlook_calendar_auth_url(self, outlook_calendar_auth_url):
        """Sets the outlook_calendar_auth_url of this ResourceViewModel.


        :param outlook_calendar_auth_url: The outlook_calendar_auth_url of this ResourceViewModel.
        :type outlook_calendar_auth_url: str
        """

        self._outlook_calendar_auth_url = outlook_calendar_auth_url

    @property
    def outlook_calendar_authorized(self):
        """Gets the outlook_calendar_authorized of this ResourceViewModel.


        :return: The outlook_calendar_authorized of this ResourceViewModel.
        :rtype: bool
        """
        return self._outlook_calendar_authorized

    @outlook_calendar_authorized.setter
    def outlook_calendar_authorized(self, outlook_calendar_authorized):
        """Sets the outlook_calendar_authorized of this ResourceViewModel.


        :param outlook_calendar_authorized: The outlook_calendar_authorized of this ResourceViewModel.
        :type outlook_calendar_authorized: bool
        """
    ...
    @property
    def phone(self):
        """Gets the phone of this ResourceViewModel.


        :return: The phone of this ResourceViewModel.
    ...
    def phone(self, phone):
        """Sets the phone of this ResourceViewModel.


        :param phone: The phone of this ResourceViewModel.
        :type phone: PhoneViewModel
        """
