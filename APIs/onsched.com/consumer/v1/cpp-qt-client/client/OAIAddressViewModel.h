...
/*
 * OAIAddressViewModel.h
 *
 * 
 */

#ifndef OAIAddressViewModel_H
#define OAIAddressViewModel_H
...
class OAIAddressViewModel : public OAIObject {
public:
    OAIAddressViewModel();
    OAIAddressViewModel(QString json);
    ~OAIAddressViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressViewModel)

#endif // OAIAddressViewModel_H
