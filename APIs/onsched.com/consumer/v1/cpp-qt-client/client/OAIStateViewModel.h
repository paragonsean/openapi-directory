...
#ifndef OAIStateViewModel_H
#define OAIStateViewModel_H
...
class OAIStateViewModel : public OAIObject {
public:
    OAIStateViewModel();
    OAIStateViewModel(QString json);
    ~OAIStateViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateViewModel)

#endif // OAIStateViewModel_H
