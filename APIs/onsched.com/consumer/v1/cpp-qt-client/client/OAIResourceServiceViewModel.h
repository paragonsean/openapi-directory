...
/*
 * OAIResourceServiceViewModel.h
 *
 * 
 */

#ifndef OAIResourceServiceViewModel_H
#define OAIResourceServiceViewModel_H
...
class OAIResourceServiceViewModel : public OAIObject {
public:
    OAIResourceServiceViewModel();
    OAIResourceServiceViewModel(QString json);
    ~OAIResourceServiceViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceServiceViewModel)

#endif // OAIResourceServiceViewModel_H
