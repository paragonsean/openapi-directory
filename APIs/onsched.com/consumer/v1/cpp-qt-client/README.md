...
void Example::exampleFunction1(){
     OAIAppointmentsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAppointmentsApi::consumerV1AppointmentsBookingfieldsGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAppointmentsApi::consumerV1AppointmentsBookingfieldsGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString location_id = create(); // QString | id of business location
      apiInstance.consumerV1AppointmentsBookingfieldsGet(location_id);
