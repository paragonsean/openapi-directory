...
import org.openapitools.client.model.AppoinmentBookingFormsViewModel;
...
public class AppointmentInitialViewModel {
  ...
  private List<BookingFieldViewModel> appointmentBookingFields;
  ...
  public static final String SERIALIZED_NAME_BOOKING_FORMS = "bookingForms";
  @SerializedName(SERIALIZED_NAME_BOOKING_FORMS)
  private AppoinmentBookingFormsViewModel bookingForms;
  ...
  private List<BookingFieldViewModel> customerBookingFields;
  ...
  public AppointmentInitialViewModel() {
  }

  public AppointmentInitialViewModel appointmentBookingFields(List<BookingFieldViewModel> appointmentBookingFields) {
    this.appointmentBookingFields = appointmentBookingFields;
    return this;
  }

  public AppointmentInitialViewModel addAppointmentBookingFieldsItem(BookingFieldViewModel appointmentBookingFieldsItem) {
  ...
  public List<BookingFieldViewModel> getAppointmentBookingFields() {
    return appointmentBookingFields;
  }

  public void setAppointmentBookingFields(List<BookingFieldViewModel> appointmentBookingFields) {
    this.appointmentBookingFields = appointmentBookingFields;
  }


  public AppointmentInitialViewModel auditTrail(List<AppointmentAuditViewModel> auditTrail) {
    this.auditTrail = auditTrail;
    return this;
  }

  public AppointmentInitialViewModel addAuditTrailItem(AppointmentAuditViewModel auditTrailItem) {
  ...
  public AppointmentInitialViewModel bookedBy(String bookedBy) {
  ...
  public AppointmentInitialViewModel bookingForms(AppoinmentBookingFormsViewModel bookingForms) {
   ...
   */
  @javax.annotation.Nullable
  public AppoinmentBookingFormsViewModel getBookingForms() {
    return bookingForms;
  }

  public void setBookingForms(AppoinmentBookingFormsViewModel bookingForms) {
    this.bookingForms = bookingForms;
  }


  public AppointmentInitialViewModel businessName(String businessName) {
  ...
  public AppointmentInitialViewModel calendarId(String calendarId) {
  ...
  public AppointmentInitialViewModel confirmationNumber(String confirmationNumber) {
  ...
  public AppointmentInitialViewModel confirmed(Boolean confirmed) {
  ...
  public AppointmentInitialViewModel createDate(String createDate) {
  ...
  public AppointmentInitialViewModel customFields(Map<String, CustomFieldViewModel> customFields) {
    this.customFields = customFields;
    return this;
  }

  public AppointmentInitialViewModel putCustomFieldsItem(String key, CustomFieldViewModel customFieldsItem) {
  ...
  public AppointmentInitialViewModel customerBookingFields(List<BookingFieldViewModel> customerBookingFields) {
    this.customerBookingFields = customerBookingFields;
    return this;
  }

  public AppointmentInitialViewModel addCustomerBookingFieldsItem(BookingFieldViewModel customerBookingFieldsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<BookingFieldViewModel> getCustomerBookingFields() {
    return customerBookingFields;
  }

  public void setCustomerBookingFields(List<BookingFieldViewModel> customerBookingFields) {
    this.customerBookingFields = customerBookingFields;
  }


  public AppointmentInitialViewModel customerId(String customerId) {
  ...
  public AppointmentInitialViewModel customerMessage(String customerMessage) {
  ...
  public AppointmentInitialViewModel customers(List<AppointmentCustomerViewModel> customers) {
    this.customers = customers;
    return this;
  }

  public AppointmentInitialViewModel addCustomersItem(AppointmentCustomerViewModel customersItem) {
  ...
  public AppointmentInitialViewModel date(String date) {
    this.date = date;
    return this;
  }
  ...
  public AppointmentInitialViewModel dateInternational(String dateInternational) {
  ...
  public AppointmentInitialViewModel downloadIcsUrl(String downloadIcsUrl) {
  ...
  public AppointmentInitialViewModel duration(Integer duration) {
  ...
  public AppointmentInitialViewModel email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AppointmentInitialViewModel emailConfirmationSent(String emailConfirmationSent) {
  ...
  public AppointmentInitialViewModel emailReminderSent(String emailReminderSent) {
  ...
  public AppointmentInitialViewModel endDateTime(String endDateTime) {
  ...
  public AppointmentInitialViewModel firstname(String firstname) {
  ...
  public AppointmentInitialViewModel groupSize(Integer groupSize) {
  ...
  public AppointmentInitialViewModel id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AppointmentInitialViewModel ipAddress(String ipAddress) {
  ...
  public AppointmentInitialViewModel lastModifiedBy(String lastModifiedBy) {
  ...
  public AppointmentInitialViewModel lastModifiedOn(String lastModifiedOn) {
  ...
  public AppointmentInitialViewModel lastname(String lastname) {
  ...
  public AppointmentInitialViewModel latitude(String latitude) {
  ...
  public AppointmentInitialViewModel location(String location) {
  ...
  public AppointmentInitialViewModel locationId(String locationId) {
  ...
  public AppointmentInitialViewModel longitude(String longitude) {
  ...
  public AppointmentInitialViewModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppointmentInitialViewModel notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public AppointmentInitialViewModel _object(String _object) {
  ...
  public AppointmentInitialViewModel onlineBooking(Boolean onlineBooking) {
  ...
  public AppointmentInitialViewModel paymentStatus(Integer paymentStatus) {
  ...
  public AppointmentInitialViewModel phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public AppointmentInitialViewModel phoneExt(String phoneExt) {
  ...
  public AppointmentInitialViewModel phoneType(String phoneType) {
  ...
  public AppointmentInitialViewModel rescheduledId(String rescheduledId) {
  ...
  public AppointmentInitialViewModel resourceEmail(String resourceEmail) {
  ...
  public AppointmentInitialViewModel resourceGroupId(String resourceGroupId) {
  ...
  public AppointmentInitialViewModel resourceGroupName(String resourceGroupName) {
  ...
  public AppointmentInitialViewModel resourceId(String resourceId) {
  ...
  public AppointmentInitialViewModel resourceImageUrl(String resourceImageUrl) {
  ...
  public AppointmentInitialViewModel resourceName(String resourceName) {
  ...
  public AppointmentInitialViewModel resources(List<AppointmentResourceViewModel> resources) {
    this.resources = resources;
    return this;
  }

  public AppointmentInitialViewModel addResourcesItem(AppointmentResourceViewModel resourcesItem) {
  ...
  public AppointmentInitialViewModel serviceAllocationId(String serviceAllocationId) {
  ...
  public AppointmentInitialViewModel serviceId(String serviceId) {
  ...
  public AppointmentInitialViewModel serviceImageUrl(String serviceImageUrl) {
  ...
  public AppointmentInitialViewModel serviceName(String serviceName) {
  ...
  public AppointmentInitialViewModel smsConfirmationSent(String smsConfirmationSent) {
  ...
  public AppointmentInitialViewModel smsReminderSent(String smsReminderSent) {
  ...
  public AppointmentInitialViewModel startDateTime(String startDateTime) {
  ...
  public AppointmentInitialViewModel status(String status) {
    this.status = status;
    return this;
  }
  ...
  public AppointmentInitialViewModel stripeChargeId(String stripeChargeId) {
  ...
  public AppointmentInitialViewModel stripeRefundId(String stripeRefundId) {
  ...
  public AppointmentInitialViewModel time(Integer time) {
    this.time = time;
    return this;
  }
  ...
  public AppointmentInitialViewModel timezone(Integer timezone) {
  ...
  public AppointmentInitialViewModel timezoneIana(String timezoneIana) {
  ...
  public AppointmentInitialViewModel timezoneId(String timezoneId) {
  ...
  public boolean equals(Object o) {
    ...
    AppointmentInitialViewModel appointmentInitialViewModel = (AppointmentInitialViewModel) o;
    return Objects.equals(this.appointmentBookingFields, appointmentInitialViewModel.appointmentBookingFields) &&
        Objects.equals(this.auditTrail, appointmentInitialViewModel.auditTrail) &&
        Objects.equals(this.bookedBy, appointmentInitialViewModel.bookedBy) &&
        Objects.equals(this.bookingForms, appointmentInitialViewModel.bookingForms) &&
        Objects.equals(this.businessName, appointmentInitialViewModel.businessName) &&
        Objects.equals(this.calendarId, appointmentInitialViewModel.calendarId) &&
        Objects.equals(this.confirmationNumber, appointmentInitialViewModel.confirmationNumber) &&
        Objects.equals(this.confirmed, appointmentInitialViewModel.confirmed) &&
        Objects.equals(this.createDate, appointmentInitialViewModel.createDate) &&
        Objects.equals(this.customFields, appointmentInitialViewModel.customFields) &&
        Objects.equals(this.customerBookingFields, appointmentInitialViewModel.customerBookingFields) &&
        Objects.equals(this.customerId, appointmentInitialViewModel.customerId) &&
        Objects.equals(this.customerMessage, appointmentInitialViewModel.customerMessage) &&
        Objects.equals(this.customers, appointmentInitialViewModel.customers) &&
        Objects.equals(this.date, appointmentInitialViewModel.date) &&
        Objects.equals(this.dateInternational, appointmentInitialViewModel.dateInternational) &&
        Objects.equals(this.downloadIcsUrl, appointmentInitialViewModel.downloadIcsUrl) &&
        Objects.equals(this.duration, appointmentInitialViewModel.duration) &&
        Objects.equals(this.email, appointmentInitialViewModel.email) &&
        Objects.equals(this.emailConfirmationSent, appointmentInitialViewModel.emailConfirmationSent) &&
        Objects.equals(this.emailReminderSent, appointmentInitialViewModel.emailReminderSent) &&
        Objects.equals(this.endDateTime, appointmentInitialViewModel.endDateTime) &&
        Objects.equals(this.firstname, appointmentInitialViewModel.firstname) &&
        Objects.equals(this.groupSize, appointmentInitialViewModel.groupSize) &&
        Objects.equals(this.id, appointmentInitialViewModel.id) &&
        Objects.equals(this.ipAddress, appointmentInitialViewModel.ipAddress) &&
        Objects.equals(this.lastModifiedBy, appointmentInitialViewModel.lastModifiedBy) &&
        Objects.equals(this.lastModifiedOn, appointmentInitialViewModel.lastModifiedOn) &&
        Objects.equals(this.lastname, appointmentInitialViewModel.lastname) &&
        Objects.equals(this.latitude, appointmentInitialViewModel.latitude) &&
        Objects.equals(this.location, appointmentInitialViewModel.location) &&
        Objects.equals(this.locationId, appointmentInitialViewModel.locationId) &&
        Objects.equals(this.longitude, appointmentInitialViewModel.longitude) &&
        Objects.equals(this.name, appointmentInitialViewModel.name) &&
        Objects.equals(this.notes, appointmentInitialViewModel.notes) &&
        Objects.equals(this._object, appointmentInitialViewModel._object) &&
        Objects.equals(this.onlineBooking, appointmentInitialViewModel.onlineBooking) &&
        Objects.equals(this.paymentStatus, appointmentInitialViewModel.paymentStatus) &&
        Objects.equals(this.phone, appointmentInitialViewModel.phone) &&
        Objects.equals(this.phoneExt, appointmentInitialViewModel.phoneExt) &&
        Objects.equals(this.phoneType, appointmentInitialViewModel.phoneType) &&
        Objects.equals(this.rescheduledId, appointmentInitialViewModel.rescheduledId) &&
        Objects.equals(this.resourceEmail, appointmentInitialViewModel.resourceEmail) &&
        Objects.equals(this.resourceGroupId, appointmentInitialViewModel.resourceGroupId) &&
        Objects.equals(this.resourceGroupName, appointmentInitialViewModel.resourceGroupName) &&
        Objects.equals(this.resourceId, appointmentInitialViewModel.resourceId) &&
        Objects.equals(this.resourceImageUrl, appointmentInitialViewModel.resourceImageUrl) &&
        Objects.equals(this.resourceName, appointmentInitialViewModel.resourceName) &&
        Objects.equals(this.resources, appointmentInitialViewModel.resources) &&
        Objects.equals(this.serviceAllocationId, appointmentInitialViewModel.serviceAllocationId) &&
        Objects.equals(this.serviceId, appointmentInitialViewModel.serviceId) &&
        Objects.equals(this.serviceImageUrl, appointmentInitialViewModel.serviceImageUrl) &&
        Objects.equals(this.serviceName, appointmentInitialViewModel.serviceName) &&
        Objects.equals(this.smsConfirmationSent, appointmentInitialViewModel.smsConfirmationSent) &&
        Objects.equals(this.smsReminderSent, appointmentInitialViewModel.smsReminderSent) &&
        Objects.equals(this.startDateTime, appointmentInitialViewModel.startDateTime) &&
        Objects.equals(this.status, appointmentInitialViewModel.status) &&
        Objects.equals(this.stripeChargeId, appointmentInitialViewModel.stripeChargeId) &&
        Objects.equals(this.stripeRefundId, appointmentInitialViewModel.stripeRefundId) &&
        Objects.equals(this.time, appointmentInitialViewModel.time) &&
        Objects.equals(this.timezone, appointmentInitialViewModel.timezone) &&
        Objects.equals(this.timezoneIana, appointmentInitialViewModel.timezoneIana) &&
        Objects.equals(this.timezoneId, appointmentInitialViewModel.timezoneId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppointmentInitialViewModel {\n");
    ...
    sb.append("    bookingForms: ").append(toIndentedString(bookingForms)).append("\n");
  ...
  static {
    ...
    openapiFields.add("bookingForms");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppointmentInitialViewModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppointmentInitialViewModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppointmentInitialViewModel is not found in the empty JSON string", AppointmentInitialViewModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppointmentInitialViewModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppointmentInitialViewModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("appointmentBookingFields") != null && !jsonObj.get("appointmentBookingFields").isJsonNull()) {
        ...
        if (jsonArrayappointmentBookingFields != null) {
          ...
          for (int i = 0; i < jsonArrayappointmentBookingFields.size(); i++) {
            BookingFieldViewModel.validateJsonElement(jsonArrayappointmentBookingFields.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("bookingForms") != null && !jsonObj.get("bookingForms").isJsonNull()) {
        AppoinmentBookingFormsViewModel.validateJsonElement(jsonObj.get("bookingForms"));
      }
      ...
      if (jsonObj.get("customerBookingFields") != null && !jsonObj.get("customerBookingFields").isJsonNull()) {
        ...
        if (jsonArraycustomerBookingFields != null) {
          ...
          for (int i = 0; i < jsonArraycustomerBookingFields.size(); i++) {
            BookingFieldViewModel.validateJsonElement(jsonArraycustomerBookingFields.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppointmentInitialViewModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppointmentInitialViewModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppointmentInitialViewModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppointmentInitialViewModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AppointmentInitialViewModel>() {
           @Override
           public void write(JsonWriter out, AppointmentInitialViewModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppointmentInitialViewModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppointmentInitialViewModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppointmentInitialViewModel
   * @throws IOException if the JSON string is invalid with respect to AppointmentInitialViewModel
   */
  public static AppointmentInitialViewModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppointmentInitialViewModel.class);
  }

  /**
   * Convert an instance of AppointmentInitialViewModel to an JSON string
   *
   * @return JSON string
   */
