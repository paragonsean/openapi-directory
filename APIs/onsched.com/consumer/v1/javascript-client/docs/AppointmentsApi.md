# OnSchedConsumerApi.AppointmentsApi
...
> BookingFieldListViewModel consumerV1AppointmentsBookingfieldsGet(opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let opts = {
  'locationId': "locationId_example" // String | id of business location
};
apiInstance.consumerV1AppointmentsBookingfieldsGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> CustomFieldDefinitionListViewModel consumerV1AppointmentsCustomfieldsGet(opts)
...
apiInstance.consumerV1AppointmentsCustomfieldsGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> AppointmentListViewModel consumerV1AppointmentsGet(opts)
...
let opts = {
  ...
  'lastname': "lastname_example", // String | Filter by lastname or part of it
  'phone': "phone_example", // String | Filter by phone number or part of it
  'serviceId': "serviceId_example", // String | Filter by service
  'calendarId': "calendarId_example", // String | Filter by calendar
  'resourceId': "resourceId_example", // String | Filter by resource
  'customerId': "customerId_example", // String | Filter by customer
  'serviceAllocationId': "serviceAllocationId_example", // String | Filter by service allocation
  'startDate': new Date("2013-10-20T19:20:30+01:00"), // Date | Format YYYY-MM-DD. Filter by on/after startDate
  'endDate': new Date("2013-10-20T19:20:30+01:00"), // Date | Format YYYY-MM-DD. Filter on/before endDate
  'status': "status_example", // String | Filter by status: IN, BK, CN, RE, RS
  'bookedBy': "bookedBy_example", // String | Filter by the email of who booked
  'offset': 56, // Number | Starting row of page, default 0
  'limit': 56 // Number | Page limit, default 20, max 100
};
apiInstance.consumerV1AppointmentsGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **startDate** | **Date**| Format YYYY-MM-DD. Filter by on/after startDate | [optional] 
...
> AppointmentViewModel consumerV1AppointmentsIdBookPut(id, opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | appointment id to book
let opts = {
  'appointmentBookModel': new OnSchedConsumerApi.AppointmentBookModel() // AppointmentBookModel | 
};
apiInstance.consumerV1AppointmentsIdBookPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | appointment id to cancel
apiInstance.consumerV1AppointmentsIdCancelPut(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> consumerV1AppointmentsIdConfirmPut(id, opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = 56; // Number | appointment id to confirm
let opts = {
  'undo': true // Boolean | Use this parameter to undo the confirmed status
};
apiInstance.consumerV1AppointmentsIdConfirmPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **Number**| appointment id to confirm | 
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | appointment id to delete
apiInstance.consumerV1AppointmentsIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | id of appointment requested
apiInstance.consumerV1AppointmentsIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> consumerV1AppointmentsIdNoshowPut(id, opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = 56; // Number | appointment id to mark as NoShow
let opts = {
  'body': {key: null} // Object | 
};
apiInstance.consumerV1AppointmentsIdNoshowPut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **Number**| appointment id to mark as NoShow | 
...
> AppointmentViewModel consumerV1AppointmentsIdReschedulePut(id, opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | appointment id to reschedule
let opts = {
  'appointmentRescheduleModel': new OnSchedConsumerApi.AppointmentRescheduleModel() // AppointmentRescheduleModel | 
};
apiInstance.consumerV1AppointmentsIdReschedulePut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> consumerV1AppointmentsIdReservePut(id, opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let id = "id_example"; // String | appointment id to reserve
let opts = {
  'sendNotifications': true, // Boolean | 
  'appointmentReserveModel': new OnSchedConsumerApi.AppointmentReserveModel() // AppointmentReserveModel | 
};
apiInstance.consumerV1AppointmentsIdReservePut(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> AppointmentInitialViewModel consumerV1AppointmentsPost(opts)
...
let apiInstance = new OnSchedConsumerApi.AppointmentsApi();
let opts = {
  'completeBooking': "completeBooking_example", // String | Options are \"BK\", \"RS\" or \"IN\"
  'appointmentInitialModel': new OnSchedConsumerApi.AppointmentInitialModel() // AppointmentInitialModel | 
};
apiInstance.consumerV1AppointmentsPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
