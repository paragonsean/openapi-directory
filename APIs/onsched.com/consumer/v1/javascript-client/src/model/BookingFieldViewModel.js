...
/**
 * The BookingFieldViewModel model module.
 * @module model/BookingFieldViewModel
 * @version v1
 */
class BookingFieldViewModel {
    /**
     * Constructs a new <code>BookingFieldViewModel</code>.
     * @alias module:model/BookingFieldViewModel
     */
    constructor() { 
        
        BookingFieldViewModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BookingFieldViewModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BookingFieldViewModel} obj Optional instance to populate.
     * @return {module:model/BookingFieldViewModel} The populated <code>BookingFieldViewModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BookingFieldViewModel();
            ...
            if (data.hasOwnProperty('fieldListItems')) {
                obj['fieldListItems'] = ApiClient.convertToType(data['fieldListItems'], [BookingFieldListItemViewModel]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BookingFieldViewModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BookingFieldViewModel</code>.
     */
    static validateJSON(data) {
        ...
        if (data['fieldListItems']) { // data not null
            ...
            for (const item of data['fieldListItems']) {
                BookingFieldListItemViewModel.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
BookingFieldViewModel.prototype['businessId'] = undefined;

/**
 * @member {String} companyId
 */
BookingFieldViewModel.prototype['companyId'] = undefined;

/**
 * @member {String} fieldLabel
 */
BookingFieldViewModel.prototype['fieldLabel'] = undefined;

/**
 * @member {Number} fieldLength
 */
BookingFieldViewModel.prototype['fieldLength'] = undefined;

/**
 * @member {Array.<module:model/BookingFieldListItemViewModel>} fieldListItems
 */
BookingFieldViewModel.prototype['fieldListItems'] = undefined;

/**
 * @member {String} fieldName
 */
BookingFieldViewModel.prototype['fieldName'] = undefined;

/**
 * @member {Boolean} fieldRequired
 */
BookingFieldViewModel.prototype['fieldRequired'] = undefined;

/**
 * @member {String} fieldType
 */
BookingFieldViewModel.prototype['fieldType'] = undefined;

/**
 * @member {String} id
 */
BookingFieldViewModel.prototype['id'] = undefined;

/**
 * @member {Boolean} leadQuestion
 */
BookingFieldViewModel.prototype['leadQuestion'] = undefined;

/**
 * @member {Number} leadQuestionWeight
 */
BookingFieldViewModel.prototype['leadQuestionWeight'] = undefined;

/**
 * @member {String} object
 */
BookingFieldViewModel.prototype['object'] = undefined;

/**
 * @member {Number} sortKey
 */
BookingFieldViewModel.prototype['sortKey'] = undefined;
...
export default BookingFieldViewModel;
