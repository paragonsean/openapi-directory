...
/**
 * The AppointmentBookModel model module.
 * @module model/AppointmentBookModel
 * @version v1
 */
class AppointmentBookModel {
    /**
     * Constructs a new <code>AppointmentBookModel</code>.
     * @alias module:model/AppointmentBookModel
     */
    constructor() { 
        
        AppointmentBookModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppointmentBookModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppointmentBookModel} obj Optional instance to populate.
     * @return {module:model/AppointmentBookModel} The populated <code>AppointmentBookModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppointmentBookModel();
    ...
    /**
     * Validates the JSON data with respect to <code>AppointmentBookModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppointmentBookModel</code>.
     */
 ...
 */
AppointmentBookModel.prototype['appointmentBookingFields'] = undefined;

/**
 * @member {module:model/CustomFieldInputModel} customFields
 */
AppointmentBookModel.prototype['customFields'] = undefined;

/**
 * @member {Array.<module:model/BookingFieldItem>} customerBookingFields
 */
AppointmentBookModel.prototype['customerBookingFields'] = undefined;

/**
 * @member {String} customerMessage
 */
AppointmentBookModel.prototype['customerMessage'] = undefined;

/**
 * @member {String} email
 */
AppointmentBookModel.prototype['email'] = undefined;

/**
 * @member {Number} groupSize
 */
AppointmentBookModel.prototype['groupSize'] = undefined;

/**
 * @member {String} name
 */
AppointmentBookModel.prototype['name'] = undefined;

/**
 * @member {String} notes
 */
AppointmentBookModel.prototype['notes'] = undefined;

/**
 * @member {String} phone
 */
AppointmentBookModel.prototype['phone'] = undefined;

/**
 * @member {String} phoneExt
 */
AppointmentBookModel.prototype['phoneExt'] = undefined;

/**
 * @member {String} phoneType
 */
AppointmentBookModel.prototype['phoneType'] = undefined;
...
export default AppointmentBookModel;
