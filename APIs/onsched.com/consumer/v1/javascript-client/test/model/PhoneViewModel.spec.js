...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.PhoneViewModel();
  });
  ...
  describe('PhoneViewModel', function() {
    it('should create an instance of PhoneViewModel', function() {
      // uncomment below and update the code to test PhoneViewModel
      //var instance = new OnSchedConsumerApi.PhoneViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.PhoneViewModel);
    });
