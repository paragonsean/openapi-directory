...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AppointmentInitialViewModel();
  });
  ...
  describe('AppointmentInitialViewModel', function() {
    it('should create an instance of AppointmentInitialViewModel', function() {
      // uncomment below and update the code to test AppointmentInitialViewModel
      //var instance = new OnSchedConsumerApi.AppointmentInitialViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AppointmentInitialViewModel);
    });
    ...
    it('should have the property bookingForms (base name: "bookingForms")', function() {
      // uncomment below and update the code to test the property bookingForms
      //var instance = new OnSchedConsumerApi.AppointmentInitialViewModel();
      //expect(instance).to.be();
    });
