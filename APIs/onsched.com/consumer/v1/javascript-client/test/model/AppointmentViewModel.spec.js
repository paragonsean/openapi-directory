...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AppointmentViewModel();
  });
  ...
  describe('AppointmentViewModel', function() {
    it('should create an instance of AppointmentViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.AppointmentViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AppointmentViewModel);
    });
