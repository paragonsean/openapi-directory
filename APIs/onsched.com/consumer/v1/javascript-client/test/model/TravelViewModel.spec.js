...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.TravelViewModel();
  });
  ...
  describe('TravelViewModel', function() {
    it('should create an instance of TravelViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.TravelViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.TravelViewModel);
    });
