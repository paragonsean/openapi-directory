...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AppointmentReminderViewModel();
  });
  ...
  describe('AppointmentReminderViewModel', function() {
    it('should create an instance of AppointmentReminderViewModel', function() {
      // uncomment below and update the code to test AppointmentReminderViewModel
      //var instance = new OnSchedConsumerApi.AppointmentReminderViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AppointmentReminderViewModel);
    });
