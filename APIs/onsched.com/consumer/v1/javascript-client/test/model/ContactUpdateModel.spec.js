...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ContactUpdateModel();
  });
  ...
  describe('ContactUpdateModel', function() {
    it('should create an instance of ContactUpdateModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.ContactUpdateModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ContactUpdateModel);
    });
