...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AddressUpdateModel();
  });
  ...
  describe('AddressUpdateModel', function() {
    it('should create an instance of AddressUpdateModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.AddressUpdateModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AddressUpdateModel);
    });
