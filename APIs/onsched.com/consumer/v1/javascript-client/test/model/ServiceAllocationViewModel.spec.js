...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ServiceAllocationViewModel();
  });
  ...
  describe('ServiceAllocationViewModel', function() {
    it('should create an instance of ServiceAllocationViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.ServiceAllocationViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ServiceAllocationViewModel);
    });
