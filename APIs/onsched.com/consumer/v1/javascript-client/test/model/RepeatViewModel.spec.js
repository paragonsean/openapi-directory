...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.RepeatViewModel();
  });
  ...
  describe('RepeatViewModel', function() {
    it('should create an instance of RepeatViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.RepeatViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.RepeatViewModel);
    });
