...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.CustomerViewModel();
  });
  ...
  describe('CustomerViewModel', function() {
    it('should create an instance of CustomerViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.CustomerViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.CustomerViewModel);
    });
