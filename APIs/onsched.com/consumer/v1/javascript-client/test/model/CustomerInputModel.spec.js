...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.CustomerInputModel();
  });
  ...
  describe('CustomerInputModel', function() {
    it('should create an instance of CustomerInputModel', function() {
      // uncomment below and update the code to test CustomerInputModel
      //var instance = new OnSchedConsumerApi.CustomerInputModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.CustomerInputModel);
    });
    ...
    it('should have the property sendLeadNotification (base name: "sendLeadNotification")', function() {
      // uncomment below and update the code to test the property sendLeadNotification
      //var instance = new OnSchedConsumerApi.CustomerInputModel();
      //expect(instance).to.be();
    });
