...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ServiceHoursViewModel();
  });
  ...
  describe('ServiceHoursViewModel', function() {
    it('should create an instance of ServiceHoursViewModel', function() {
      // uncomment below and update the code to test ServiceHoursViewModel
      //var instance = new OnSchedConsumerApi.ServiceHoursViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ServiceHoursViewModel);
    });
