...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AddressViewModel();
  });
  ...
  describe('AddressViewModel', function() {
    it('should create an instance of AddressViewModel', function() {
      // uncomment below and update the code to test AddressViewModel
      //var instance = new OnSchedConsumerApi.AddressViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AddressViewModel);
    });
