...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AddressInputModel();
  });
  ...
  describe('AddressInputModel', function() {
    it('should create an instance of AddressInputModel', function() {
      // uncomment below and update the code to test AddressInputModel
      //var instance = new OnSchedConsumerApi.AddressInputModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AddressInputModel);
    });
