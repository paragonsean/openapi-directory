...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ResourceGroupViewModel();
  });
  ...
  describe('ResourceGroupViewModel', function() {
    it('should create an instance of ResourceGroupViewModel', function() {
      // uncomment below and update the code to test ResourceGroupViewModel
      //var instance = new OnSchedConsumerApi.ResourceGroupViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ResourceGroupViewModel);
    });
