...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.StateViewModel();
  });
  ...
  describe('StateViewModel', function() {
    it('should create an instance of StateViewModel', function() {
      // uncomment below and update the code to test StateViewModel
      //var instance = new OnSchedConsumerApi.StateViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.StateViewModel);
    });
