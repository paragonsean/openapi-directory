...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ResourceServiceViewModel();
  });
  ...
  describe('ResourceServiceViewModel', function() {
    it('should create an instance of ResourceServiceViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.ResourceServiceViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ResourceServiceViewModel);
    });
