...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.CustomFieldDefinitionViewModel();
  });
  ...
  describe('CustomFieldDefinitionViewModel', function() {
    it('should create an instance of CustomFieldDefinitionViewModel', function() {
      // uncomment below and update the code to test CustomFieldDefinitionViewModel
      //var instance = new OnSchedConsumerApi.CustomFieldDefinitionViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.CustomFieldDefinitionViewModel);
    });
    ...
    it('should have the property fieldPublic (base name: "fieldPublic")', function() {
      // uncomment below and update the code to test the property fieldPublic
      //var instance = new OnSchedConsumerApi.CustomFieldDefinitionViewModel();
      //expect(instance).to.be();
    });
