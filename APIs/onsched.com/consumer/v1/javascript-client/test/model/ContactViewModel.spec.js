...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.ContactViewModel();
  });
  ...
  describe('ContactViewModel', function() {
    it('should create an instance of ContactViewModel', function() {
      ...
      //var instance = new OnSchedConsumerApi.ContactViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.ContactViewModel);
    });
