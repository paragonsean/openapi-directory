...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnSchedConsumerApi.AvailableDayViewModel();
  });
  ...
  describe('AvailableDayViewModel', function() {
    it('should create an instance of AvailableDayViewModel', function() {
      // uncomment below and update the code to test AvailableDayViewModel
      //var instance = new OnSchedConsumerApi.AvailableDayViewModel();
      //expect(instance).to.be.a(OnSchedConsumerApi.AvailableDayViewModel);
    });
