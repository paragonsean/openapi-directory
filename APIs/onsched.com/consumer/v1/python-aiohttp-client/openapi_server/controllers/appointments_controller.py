...
async def consumer_v1_appointments_bookingfields_get(request: web.Request, location_id=None) -> web.Response:
    ...
    :param location_id: id of business location
...
async def consumer_v1_appointments_customfields_get(request: web.Request, location_id=None) -> web.Response:
...
async def consumer_v1_appointments_get(request: web.Request, location_id=None, email=None, lastname=None, phone=None, service_id=None, calendar_id=None, resource_id=None, customer_id=None, service_allocation_id=None, start_date=None, end_date=None, status=None, booked_by=None, offset=None, limit=None) -> web.Response:
    """Get Appointments
    ...
    :type email: str
    :param lastname: Filter by lastname or part of it
    :type lastname: str
    :param phone: Filter by phone number or part of it
    :type phone: str
    :param service_id: Filter by service
    :type service_id: str
    :param calendar_id: Filter by calendar
    :type calendar_id: str
    :param resource_id: Filter by resource
    :type resource_id: str
    :param customer_id: Filter by customer
    :type customer_id: str
    :param service_allocation_id: Filter by service allocation
    :type service_allocation_id: str
    :param start_date: Format YYYY-MM-DD. Filter by on/after startDate
    :type start_date: str
    :param end_date: Format YYYY-MM-DD. Filter on/before endDate
    :type end_date: str
    :param status: Filter by status: IN, BK, CN, RE, RS
    :type status: str
    :param booked_by: Filter by the email of who booked
    :type booked_by: str
...
async def consumer_v1_appointments_id_book_put(request: web.Request, id, body=None) -> web.Response:
    """Book Appointment
    ...
    :param id: appointment id to book
    :type id: str
    :param body: 
    :type body: dict | bytes

    """
    body = AppointmentBookModel.from_dict(body)
    return web.Response(status=200)


async def consumer_v1_appointments_id_cancel_put(request: web.Request, id) -> web.Response:
    """Cancel Appointment
...
async def consumer_v1_appointments_id_confirm_put(request: web.Request, id, undo=None) -> web.Response:
    """Confirm Appointment
    ...
    :param id: appointment id to confirm
    :type id: int
    :param undo: Use this parameter to undo the confirmed status
    :type undo: bool
...
async def consumer_v1_appointments_id_delete(request: web.Request, id) -> web.Response:
    """Delete Appointment
...
async def consumer_v1_appointments_id_get(request: web.Request, id) -> web.Response:
    """Get Appointment
...
async def consumer_v1_appointments_id_noshow_put(request: web.Request, id, body=None) -> web.Response:
    """Set NoShow Status
    ...
    :param id: appointment id to mark as NoShow
    :type id: int
    :param body: 
    :type body: 
...
async def consumer_v1_appointments_id_reschedule_put(request: web.Request, id, body=None) -> web.Response:
    ...
    """
    body = AppointmentRescheduleModel.from_dict(body)
    return web.Response(status=200)


async def consumer_v1_appointments_id_reserve_put(request: web.Request, id, send_notifications=None, body=None) -> web.Response:
    """Reserve Appointment
    ...
    :param id: appointment id to reserve
    :type id: str
    ...
    """
    body = AppointmentReserveModel.from_dict(body)
    return web.Response(status=200)


async def consumer_v1_appointments_post(request: web.Request, complete_booking=None, body=None) -> web.Response:
    """Create Appointment
    ...
    :param complete_booking: Options are \&quot;BK\&quot;, \&quot;RS\&quot; or \&quot;IN\&quot;
    :type complete_booking: str
    :param body: 
    :type body: dict | bytes

    """
    body = AppointmentInitialModel.from_dict(body)
    return web.Response(status=200)
