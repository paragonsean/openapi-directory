...
Swagger Generator
- API version: 2.4.31
  - Build date: 2024-10-12T12:41:27.374963-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.4.31"
  }
```
...
* `target/openapi-java-client-2.4.31.jar`
* `target/lib/*.jar`
...
*ServersApi* | [**downloadFile_0**](docs/ServersApi.md#downloadFile_0) | **GET** /gen/download/{fileId} | Downloads a pre-generated file
