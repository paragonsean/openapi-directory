...
public class ApiClient {
    ...
    private String basePath = "https://generator.swagger.io/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.4.31/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://generator.swagger.io/api
