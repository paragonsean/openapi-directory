...
public class Schema1 {
  ...
  public Schema1 data(List<Data1> data) {
    this.data = data;
    return this;
  }

  public Schema1 addDataItem(Data1 dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, schema1.data);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Data1.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
