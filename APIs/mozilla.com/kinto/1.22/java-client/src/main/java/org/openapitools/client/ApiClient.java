...
public class ApiClient {
    ...
    private String basePath = "https://firefox.settings.services.mozilla.com/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.22/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://firefox.settings.services.mozilla.com/v1
