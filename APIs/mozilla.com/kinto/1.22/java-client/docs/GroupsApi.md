...
<a id="getGroup"></a>
# **getGroup**
> ObjectSchema2 getGroup(bucketId, id, fields, ifMatch, ifNoneMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ObjectSchema2 result = apiInstance.getGroup(bucketId, id, fields, ifMatch, ifNoneMatch);
...
<a id="getGroups"></a>
# **getGroups**
> Schema4 getGroups(bucketId, limit, sort, token, since, to, before, id, lastModified, fields, ifMatch, ifNoneMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ifNoneMatch = "ifNoneMatch_example"; // String | 
    try {
      Schema4 result = apiInstance.getGroups(bucketId, limit, sort, token, since, to, before, id, lastModified, fields, ifMatch, ifNoneMatch);
      System.out.println(result);
    } catch (ApiException e) {
