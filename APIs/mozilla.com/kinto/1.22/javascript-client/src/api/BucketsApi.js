...
export default class BucketsApi {
    ...
    */
     ...
     * @callback module:api/BucketsApi~getBucketCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ObjectSchema3} data The data returned by the service call.
     ...
     * @param {module:api/BucketsApi~getBucketCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ObjectSchema3}
     */
    getBucket(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
