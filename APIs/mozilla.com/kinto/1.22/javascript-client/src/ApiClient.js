...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://firefox.settings.services.mozilla.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://firefox.settings.services.mozilla.com/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.22/Javascript'
        };
