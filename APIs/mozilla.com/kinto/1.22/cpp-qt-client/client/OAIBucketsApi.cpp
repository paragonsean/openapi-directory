...
void OAIBucketsApi::getBucket(const QString &id, const ::OpenAPI::OptionalParam<QList<QString>> &_fields, const ::OpenAPI::OptionalParam<QString> &if_match, const ::OpenAPI::OptionalParam<QString> &if_none_match) {
    QString fullPath = QString(_serverConfigs["getBucket"][_serverIndices.value("getBucket")].URL()+"/buckets/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBucketsApi::getBucketCallback);
...
void OAIBucketsApi::getBucketCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIObjectSchema_3 output(QString(worker->response));
    worker->deleteLater();
