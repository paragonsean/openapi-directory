...
void OAIAttachmentApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("createAttachment", defaultConf);
    _serverIndices.insert("createAttachment", 0);
...
void OAIAttachmentApi::createAttachment(const QString &bucket_id, const QString &collection_id, const QString &id) {
    QString fullPath = QString(_serverConfigs["createAttachment"][_serverIndices.value("createAttachment")].URL()+"/buckets/{bucket_id}/collections/{collection_id}/records/{id}/attachment");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::createAttachmentCallback);
...
void OAIAttachmentApi::createAttachmentCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createAttachmentSignal();
        Q_EMIT createAttachmentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createAttachmentSignalE(error_type, error_str);
        Q_EMIT createAttachmentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createAttachmentSignalError(error_type, error_str);
        Q_EMIT createAttachmentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAttachmentApi::deleteAttachment(const QString &bucket_id, const QString &collection_id, const QString &id) {
    QString fullPath = QString(_serverConfigs["deleteAttachment"][_serverIndices.value("deleteAttachment")].URL()+"/buckets/{bucket_id}/collections/{collection_id}/records/{id}/attachment");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentApi::deleteAttachmentCallback);
    connect(this, &OAIAttachmentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAttachmentApi::deleteAttachmentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
