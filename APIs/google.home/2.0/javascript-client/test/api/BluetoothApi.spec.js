...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.BluetoothApi();
  });
  ...
  describe('BluetoothApi', function() {
    describe('changeDiscoverability', function() {
      it('should call changeDiscoverability successfully', function(done) {
        //uncomment below and update the code to test changeDiscoverability
        //instance.changeDiscoverability(function(error) {
    ...
    describe('forgetpaireddevice', function() {
      it('should call forgetpaireddevice successfully', function(done) {
        //uncomment below and update the code to test forgetpaireddevice
        //instance.forgetpaireddevice(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPairedDevices', function() {
      it('should call getPairedDevices successfully', function(done) {
        //uncomment below and update the code to test getPairedDevices
        //instance.getPairedDevices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getScanResults', function() {
      it('should call getScanResults successfully', function(done) {
        //uncomment below and update the code to test getScanResults
        //instance.getScanResults(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('pairwithSpeaker', function() {
      it('should call pairwithSpeaker successfully', function(done) {
        //uncomment below and update the code to test pairwithSpeaker
        //instance.pairwithSpeaker(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scanfordevices', function() {
      it('should call scanfordevices successfully', function(done) {
        //uncomment below and update the code to test scanfordevices
        //instance.scanfordevices(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
