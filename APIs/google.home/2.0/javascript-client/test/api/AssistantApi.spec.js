...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.AssistantApi();
  });
  ...
  describe('AssistantApi', function() {
    describe('accessibility', function() {
      it('should call accessibility successfully', function(done) {
        //uncomment below and update the code to test accessibility
        //instance.accessibility(function(error) {
    ...
    describe('alarmVolume', function() {
      it('should call alarmVolume successfully', function(done) {
        //uncomment below and update the code to test alarmVolume
        //instance.alarmVolume(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteAlarmsandTimers', function() {
      it('should call deleteAlarmsandTimers successfully', function(done) {
        //uncomment below and update the code to test deleteAlarmsandTimers
        //instance.deleteAlarmsandTimers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('doNotDisturb', function() {
      it('should call doNotDisturb successfully', function(done) {
        //uncomment below and update the code to test doNotDisturb
        //instance.doNotDisturb(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAlarmsandTimers', function() {
      it('should call getAlarmsandTimers successfully', function(done) {
        //uncomment below and update the code to test getAlarmsandTimers
        //instance.getAlarmsandTimers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('setEqualizerValues', function() {
      it('should call setEqualizerValues successfully', function(done) {
        //uncomment below and update the code to test setEqualizerValues
        //instance.setEqualizerValues(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
