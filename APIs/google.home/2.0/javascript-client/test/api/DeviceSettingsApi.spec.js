...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.DeviceSettingsApi();
  });
  ...
  describe('DeviceSettingsApi', function() {
    describe('nightModesettings', function() {
      it('should call nightModesettings successfully', function(done) {
        //uncomment below and update the code to test nightModesettings
        //instance.nightModesettings(function(error) {
    ...
    describe('rebootandFactoryReset', function() {
      it('should call rebootandFactoryReset successfully', function(done) {
        //uncomment below and update the code to test rebootandFactoryReset
        //instance.rebootandFactoryReset(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('setEurekaInfo', function() {
      it('should call setEurekaInfo successfully', function(done) {
        //uncomment below and update the code to test setEurekaInfo
        //instance.setEurekaInfo(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
