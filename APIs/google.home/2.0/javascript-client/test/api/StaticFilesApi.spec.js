...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.StaticFilesApi();
  });
  ...
  describe('StaticFilesApi', function() {
    describe('chromecastIcon', function() {
      it('should call chromecastIcon successfully', function(done) {
        //uncomment below and update the code to test chromecastIcon
        //instance.chromecastIcon(function(error) {
    ...
    describe('legalNotice', function() {
      it('should call legalNotice successfully', function(done) {
        //uncomment below and update the code to test legalNotice
        //instance.legalNotice(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
