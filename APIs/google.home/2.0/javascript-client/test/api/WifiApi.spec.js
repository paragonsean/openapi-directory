...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.WifiApi();
  });
  ...
  describe('WifiApi', function() {
    describe('connecttoWiFiNetwork', function() {
      it('should call connecttoWiFiNetwork successfully', function(done) {
        //uncomment below and update the code to test connecttoWiFiNetwork
        //instance.connecttoWiFiNetwork(function(error) {
    ...
    describe('forgetWiFiNetwork', function() {
      it('should call forgetWiFiNetwork successfully', function(done) {
        //uncomment below and update the code to test forgetWiFiNetwork
        //instance.forgetWiFiNetwork(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSavedNetworks', function() {
      it('should call getSavedNetworks successfully', function(done) {
        //uncomment below and update the code to test getSavedNetworks
        //instance.getSavedNetworks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWiFiScanResults', function() {
      it('should call getWiFiScanResults successfully', function(done) {
        //uncomment below and update the code to test getWiFiScanResults
        //instance.getWiFiScanResults(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('scanforNetworks', function() {
      it('should call scanforNetworks successfully', function(done) {
        //uncomment below and update the code to test scanforNetworks
        //instance.scanforNetworks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
