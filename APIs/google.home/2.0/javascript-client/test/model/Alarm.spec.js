...
(function(root, factory) {
  ...
  describe('Alarm', function() {
    it('should create an instance of Alarm', function() {
      ...
      //var instance = new GoogleHome.Alarm();
      //expect(instance).to.be.a(GoogleHome.Alarm);
    });

    it('should have the property datePattern (base name: "date_pattern")', function() {
      // uncomment below and update the code to test the property datePattern
      //var instance = new GoogleHome.Alarm();
      //expect(instance).to.be();
    });

    it('should have the property fireTime (base name: "fire_time")', function() {
      // uncomment below and update the code to test the property fireTime
      //var instance = new GoogleHome.Alarm();
      //expect(instance).to.be();
    });
    ...
    it('should have the property timePattern (base name: "time_pattern")', function() {
      // uncomment below and update the code to test the property timePattern
      //var instance = new GoogleHome.Alarm();
      //expect(instance).to.be();
    });
