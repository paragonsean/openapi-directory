...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.HighShelf();
  });
  ...
  describe('HighShelf', function() {
    it('should create an instance of HighShelf', function() {
      // uncomment below and update the code to test HighShelf
      //var instance = new GoogleHome.HighShelf();
      //expect(instance).to.be.a(GoogleHome.HighShelf);
    });
    ...
    it('should have the property gainDb (base name: "gain_db")', function() {
