...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ScanfordevicesRequest();
  });
  ...
  describe('ScanfordevicesRequest', function() {
    it('should create an instance of ScanfordevicesRequest', function() {
      // uncomment below and update the code to test ScanfordevicesRequest
      //var instance = new GoogleHome.ScanfordevicesRequest();
      //expect(instance).to.be.a(GoogleHome.ScanfordevicesRequest);
    });

    it('should have the property clearResults (base name: "clear_results")', function() {
      // uncomment below and update the code to test the property clearResults
      //var instance = new GoogleHome.ScanfordevicesRequest();
