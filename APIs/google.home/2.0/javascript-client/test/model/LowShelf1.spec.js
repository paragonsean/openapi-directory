...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.LowShelf1();
  });
  ...
  describe('LowShelf1', function() {
    it('should create an instance of LowShelf1', function() {
      // uncomment below and update the code to test LowShelf1
      //var instance = new GoogleHome.LowShelf1();
      //expect(instance).to.be.a(GoogleHome.LowShelf1);
    });
