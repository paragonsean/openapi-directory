...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.TimePattern();
  });
  ...
  describe('TimePattern', function() {
    it('should create an instance of TimePattern', function() {
      // uncomment below and update the code to test TimePattern
      //var instance = new GoogleHome.TimePattern();
      //expect(instance).to.be.a(GoogleHome.TimePattern);
    });
