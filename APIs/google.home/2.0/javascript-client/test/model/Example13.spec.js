...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example13();
  });
  ...
  describe('Example13', function() {
    it('should create an instance of Example13', function() {
      // uncomment below and update the code to test Example13
      //var instance = new GoogleHome.Example13();
      //expect(instance).to.be.a(GoogleHome.Example13);
    });

    it('should have the property canEnroll (base name: "can_enroll")', function() {
      // uncomment below and update the code to test the property canEnroll
      //var instance = new GoogleHome.Example13();
      //expect(instance).to.be();
    });

    it('should have the property enrollmentState (base name: "enrollment_state")', function() {
