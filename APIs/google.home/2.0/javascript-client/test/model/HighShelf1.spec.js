...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.HighShelf1();
  });
  ...
  describe('HighShelf1', function() {
    it('should create an instance of HighShelf1', function() {
      // uncomment below and update the code to test HighShelf1
      //var instance = new GoogleHome.HighShelf1();
      //expect(instance).to.be.a(GoogleHome.HighShelf1);
    });
