...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example11();
  });
  ...
  describe('Example11', function() {
    it('should create an instance of Example11', function() {
      // uncomment below and update the code to test Example11
      //var instance = new GoogleHome.Example11();
      //expect(instance).to.be.a(GoogleHome.Example11);
    });

    it('should have the property appDeviceId (base name: "app_device_id")', function() {
      // uncomment below and update the code to test the property appDeviceId
      //var instance = new GoogleHome.Example11();
    ...
    it('should have the property signedData (base name: "signed_data")', function() {
      // uncomment below and update the code to test the property signedData
      //var instance = new GoogleHome.Example11();
      //expect(instance).to.be();
    });
