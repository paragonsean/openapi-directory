...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.NightModesettingsRequest();
  });
  ...
  describe('NightModesettingsRequest', function() {
    it('should create an instance of NightModesettingsRequest', function() {
      // uncomment below and update the code to test NightModesettingsRequest
      //var instance = new GoogleHome.NightModesettingsRequest();
      //expect(instance).to.be.a(GoogleHome.NightModesettingsRequest);
    });

    it('should have the property demoToUser (base name: "demo_to_user")', function() {
      // uncomment below and update the code to test the property demoToUser
      //var instance = new GoogleHome.NightModesettingsRequest();
    ...
    it('should have the property ledBrightness (base name: "led_brightness")', function() {
      // uncomment below and update the code to test the property ledBrightness
      //var instance = new GoogleHome.NightModesettingsRequest();
      //expect(instance).to.be();
    });
