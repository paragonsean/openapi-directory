...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.SetEurekaInfoRequest();
  });
  ...
  describe('SetEurekaInfoRequest', function() {
    it('should create an instance of SetEurekaInfoRequest', function() {
      // uncomment below and update the code to test SetEurekaInfoRequest
      //var instance = new GoogleHome.SetEurekaInfoRequest();
      //expect(instance).to.be.a(GoogleHome.SetEurekaInfoRequest);
    });
