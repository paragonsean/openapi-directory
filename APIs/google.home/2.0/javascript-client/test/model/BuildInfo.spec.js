...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.BuildInfo();
  });
  ...
  describe('BuildInfo', function() {
    it('should create an instance of BuildInfo', function() {
      // uncomment below and update the code to test BuildInfo
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be.a(GoogleHome.BuildInfo);
    });

    it('should have the property buildType (base name: "build_type")', function() {
      // uncomment below and update the code to test the property buildType
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });

    it('should have the property castBuildRevision (base name: "cast_build_revision")', function() {
      // uncomment below and update the code to test the property castBuildRevision
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });

    it('should have the property castControlVersion (base name: "cast_control_version")', function() {
      // uncomment below and update the code to test the property castControlVersion
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });

    it('should have the property previewChannelState (base name: "preview_channel_state")', function() {
      // uncomment below and update the code to test the property previewChannelState
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });

    it('should have the property releaseTrack (base name: "release_track")', function() {
      // uncomment below and update the code to test the property releaseTrack
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });

    it('should have the property systemBuildNumber (base name: "system_build_number")', function() {
      // uncomment below and update the code to test the property systemBuildNumber
      //var instance = new GoogleHome.BuildInfo();
      //expect(instance).to.be();
    });
