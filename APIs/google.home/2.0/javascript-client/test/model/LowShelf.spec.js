...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.LowShelf();
  });
  ...
  describe('LowShelf', function() {
    it('should create an instance of LowShelf', function() {
      // uncomment below and update the code to test LowShelf
      //var instance = new GoogleHome.LowShelf();
      //expect(instance).to.be.a(GoogleHome.LowShelf);
    });
