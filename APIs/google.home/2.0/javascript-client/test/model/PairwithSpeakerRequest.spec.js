...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.PairwithSpeakerRequest();
  });
  ...
  describe('PairwithSpeakerRequest', function() {
    it('should create an instance of PairwithSpeakerRequest', function() {
      // uncomment below and update the code to test PairwithSpeakerRequest
      //var instance = new GoogleHome.PairwithSpeakerRequest();
      //expect(instance).to.be.a(GoogleHome.PairwithSpeakerRequest);
    });
