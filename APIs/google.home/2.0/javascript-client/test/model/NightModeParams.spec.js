...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.NightModeParams();
  });
  ...
  describe('NightModeParams', function() {
    it('should create an instance of NightModeParams', function() {
      // uncomment below and update the code to test NightModeParams
      //var instance = new GoogleHome.NightModeParams();
      //expect(instance).to.be.a(GoogleHome.NightModeParams);
    });

    it('should have the property deviceOverrideDoNotDisturb (base name: "device_override_do_not_disturb")', function() {
      // uncomment below and update the code to test the property deviceOverrideDoNotDisturb
      //var instance = new GoogleHome.NightModeParams();
