...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example12();
  });
  ...
  describe('Example12', function() {
    it('should create an instance of Example12', function() {
      // uncomment below and update the code to test Example12
      //var instance = new GoogleHome.Example12();
      //expect(instance).to.be.a(GoogleHome.Example12);
    });
