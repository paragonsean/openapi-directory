...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example110();
  });
  ...
  describe('Example110', function() {
    it('should create an instance of Example110', function() {
      // uncomment below and update the code to test Example110
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be.a(GoogleHome.Example110);
    });

    it('should have the property audioMode (base name: "audio_mode")', function() {
      // uncomment below and update the code to test the property audioMode
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be();
    });

    it('should have the property connectedDevices (base name: "connected_devices")', function() {
      // uncomment below and update the code to test the property connectedDevices
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be();
    });

    it('should have the property connectingDevices (base name: "connecting_devices")', function() {
      // uncomment below and update the code to test the property connectingDevices
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be();
    });

    it('should have the property discoveryEnabled (base name: "discovery_enabled")', function() {
      // uncomment below and update the code to test the property discoveryEnabled
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be();
    });

    it('should have the property remoteSink (base name: "remote_sink")', function() {
      // uncomment below and update the code to test the property remoteSink
      //var instance = new GoogleHome.Example110();
      //expect(instance).to.be();
    });

    it('should have the property scanningEnabled (base name: "scanning_enabled")', function() {
