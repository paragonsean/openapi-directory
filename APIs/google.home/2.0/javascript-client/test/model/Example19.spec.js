...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example19();
  });
  ...
  describe('Example19', function() {
    it('should create an instance of Example19', function() {
      // uncomment below and update the code to test Example19
      //var instance = new GoogleHome.Example19();
      //expect(instance).to.be.a(GoogleHome.Example19);
    });
