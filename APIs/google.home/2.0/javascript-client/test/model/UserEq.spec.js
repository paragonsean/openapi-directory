...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.UserEq();
  });
  ...
  describe('UserEq', function() {
    it('should create an instance of UserEq', function() {
      // uncomment below and update the code to test UserEq
      //var instance = new GoogleHome.UserEq();
      //expect(instance).to.be.a(GoogleHome.UserEq);
    });
    ...
    it('should have the property maxPeakingEqs (base name: "max_peaking_eqs")', function() {
      // uncomment below and update the code to test the property maxPeakingEqs
      //var instance = new GoogleHome.UserEq();
      //expect(instance).to.be();
    });

    it('should have the property peakingEqs (base name: "peaking_eqs")', function() {
      // uncomment below and update the code to test the property peakingEqs
      //var instance = new GoogleHome.UserEq();
      //expect(instance).to.be();
    });
