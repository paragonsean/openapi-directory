...
(function(root, factory) {
  ...
  describe('Net', function() {
    it('should create an instance of Net', function() {
      // uncomment below and update the code to test Net
      //var instance = new GoogleHome.Net();
      //expect(instance).to.be.a(GoogleHome.Net);
    });

    it('should have the property ethernetConnected (base name: "ethernet_connected")', function() {
      // uncomment below and update the code to test the property ethernetConnected
      //var instance = new GoogleHome.Net();
