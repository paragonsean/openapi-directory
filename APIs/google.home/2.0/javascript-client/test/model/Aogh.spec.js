...
(function(root, factory) {
  ...
  describe('Aogh', function() {
    it('should create an instance of Aogh', function() {
      // uncomment below and update the code to test Aogh
      //var instance = new GoogleHome.Aogh();
      //expect(instance).to.be.a(GoogleHome.Aogh);
    });

    it('should have the property aoghApiVersion (base name: "aogh_api_version")', function() {
      // uncomment below and update the code to test the property aoghApiVersion
      //var instance = new GoogleHome.Aogh();
