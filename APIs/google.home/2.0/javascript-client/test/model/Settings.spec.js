...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Settings();
  });
  ...
  describe('Settings', function() {
    it('should create an instance of Settings', function() {
      ...
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be.a(GoogleHome.Settings);
    });

    it('should have the property closedCaption (base name: "closed_caption")', function() {
      // uncomment below and update the code to test the property closedCaption
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be();
    });

    it('should have the property controlNotifications (base name: "control_notifications")', function() {
      // uncomment below and update the code to test the property controlNotifications
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property networkStandby (base name: "network_standby")', function() {
      // uncomment below and update the code to test the property networkStandby
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be();
    });

    it('should have the property systemSoundEffects (base name: "system_sound_effects")', function() {
      // uncomment below and update the code to test the property systemSoundEffects
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be();
    });

    it('should have the property timeFormat (base name: "time_format")', function() {
    ...
    it('should have the property wakeOnCast (base name: "wake_on_cast")', function() {
      // uncomment below and update the code to test the property wakeOnCast
      //var instance = new GoogleHome.Settings();
      //expect(instance).to.be();
    });
