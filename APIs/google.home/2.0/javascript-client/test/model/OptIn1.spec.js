...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.OptIn1();
  });
  ...
  describe('OptIn1', function() {
    it('should create an instance of OptIn1', function() {
      // uncomment below and update the code to test OptIn1
      //var instance = new GoogleHome.OptIn1();
      //expect(instance).to.be.a(GoogleHome.OptIn1);
    });
