...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.AccessibilityRequest();
  });
  ...
  describe('AccessibilityRequest', function() {
    it('should create an instance of AccessibilityRequest', function() {
      // uncomment below and update the code to test AccessibilityRequest
      //var instance = new GoogleHome.AccessibilityRequest();
      //expect(instance).to.be.a(GoogleHome.AccessibilityRequest);
    });

    it('should have the property endpointEnabled (base name: "endpoint_enabled")', function() {
      // uncomment below and update the code to test the property endpointEnabled
      //var instance = new GoogleHome.AccessibilityRequest();
      //expect(instance).to.be();
    });

    it('should have the property hotwordEnabled (base name: "hotword_enabled")', function() {
      // uncomment below and update the code to test the property hotwordEnabled
      //var instance = new GoogleHome.AccessibilityRequest();
      //expect(instance).to.be();
    });
