...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.DeleteAlarmsandTimersRequest();
  });
  ...
  describe('DeleteAlarmsandTimersRequest', function() {
    it('should create an instance of DeleteAlarmsandTimersRequest', function() {
      // uncomment below and update the code to test DeleteAlarmsandTimersRequest
      //var instance = new GoogleHome.DeleteAlarmsandTimersRequest();
      //expect(instance).to.be.a(GoogleHome.DeleteAlarmsandTimersRequest);
    });
