...
(function(root, factory) {
  ...
  describe('Sign', function() {
    it('should create an instance of Sign', function() {
      ...
      //var instance = new GoogleHome.Sign();
      //expect(instance).to.be.a(GoogleHome.Sign);
    });
    ...
    it('should have the property intermediateCerts (base name: "intermediate_certs")', function() {
      // uncomment below and update the code to test the property intermediateCerts
      //var instance = new GoogleHome.Sign();
      //expect(instance).to.be();
    });
