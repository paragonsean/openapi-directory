...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.IconList();
  });
  ...
  describe('IconList', function() {
    it('should create an instance of IconList', function() {
      // uncomment below and update the code to test IconList
      //var instance = new GoogleHome.IconList();
      //expect(instance).to.be.a(GoogleHome.IconList);
    });
