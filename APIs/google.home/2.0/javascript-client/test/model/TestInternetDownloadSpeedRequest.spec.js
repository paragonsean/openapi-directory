...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.TestInternetDownloadSpeedRequest();
  });
  ...
  describe('TestInternetDownloadSpeedRequest', function() {
    it('should create an instance of TestInternetDownloadSpeedRequest', function() {
      // uncomment below and update the code to test TestInternetDownloadSpeedRequest
      //var instance = new GoogleHome.TestInternetDownloadSpeedRequest();
      //expect(instance).to.be.a(GoogleHome.TestInternetDownloadSpeedRequest);
    });
