...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example17();
  });
  ...
  describe('Example17', function() {
    it('should create an instance of Example17', function() {
      // uncomment below and update the code to test Example17
      //var instance = new GoogleHome.Example17();
      //expect(instance).to.be.a(GoogleHome.Example17);
    });
