...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
  });
  ...
  describe('ConnecttoWiFiNetworkRequest', function() {
    it('should create an instance of ConnecttoWiFiNetworkRequest', function() {
      // uncomment below and update the code to test ConnecttoWiFiNetworkRequest
      //var instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
      //expect(instance).to.be.a(GoogleHome.ConnecttoWiFiNetworkRequest);
    });
    ...
    it('should have the property encPasswd (base name: "enc_passwd")', function() {
      // uncomment below and update the code to test the property encPasswd
      //var instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
      //expect(instance).to.be();
    });

    it('should have the property signalLevel (base name: "signal_level")', function() {
      // uncomment below and update the code to test the property signalLevel
      //var instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wpaAuth (base name: "wpa_auth")', function() {
      // uncomment below and update the code to test the property wpaAuth
      //var instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
      //expect(instance).to.be();
    });

    it('should have the property wpaCipher (base name: "wpa_cipher")', function() {
      // uncomment below and update the code to test the property wpaCipher
      //var instance = new GoogleHome.ConnecttoWiFiNetworkRequest();
      //expect(instance).to.be();
    });
