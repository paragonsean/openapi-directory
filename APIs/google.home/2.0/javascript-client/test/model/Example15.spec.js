...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example15();
  });
  ...
  describe('Example15', function() {
    it('should create an instance of Example15', function() {
      // uncomment below and update the code to test Example15
      //var instance = new GoogleHome.Example15();
      //expect(instance).to.be.a(GoogleHome.Example15);
    });
