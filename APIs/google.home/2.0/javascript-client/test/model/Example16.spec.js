...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example16();
  });
  ...
  describe('Example16', function() {
    it('should create an instance of Example16', function() {
      // uncomment below and update the code to test Example16
      //var instance = new GoogleHome.Example16();
      //expect(instance).to.be.a(GoogleHome.Example16);
    });
    ...
    it('should have the property timeForDataFetch (base name: "time_for_data_fetch")', function() {
      // uncomment below and update the code to test the property timeForDataFetch
      //var instance = new GoogleHome.Example16();
      //expect(instance).to.be();
    });

    it('should have the property timeForHttpResponse (base name: "time_for_http_response")', function() {
      // uncomment below and update the code to test the property timeForHttpResponse
      //var instance = new GoogleHome.Example16();
      //expect(instance).to.be();
    });
