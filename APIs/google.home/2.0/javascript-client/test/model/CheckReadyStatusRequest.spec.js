...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.CheckReadyStatusRequest();
  });
  ...
  describe('CheckReadyStatusRequest', function() {
    it('should create an instance of CheckReadyStatusRequest', function() {
      // uncomment below and update the code to test CheckReadyStatusRequest
      //var instance = new GoogleHome.CheckReadyStatusRequest();
      //expect(instance).to.be.a(GoogleHome.CheckReadyStatusRequest);
    });

    it('should have the property playReadyMessage (base name: "play_ready_message")', function() {
      // uncomment below and update the code to test the property playReadyMessage
      //var instance = new GoogleHome.CheckReadyStatusRequest();
