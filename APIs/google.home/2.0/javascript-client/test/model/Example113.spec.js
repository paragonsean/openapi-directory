...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example113();
  });
  ...
  describe('Example113', function() {
    it('should create an instance of Example113', function() {
      // uncomment below and update the code to test Example113
      //var instance = new GoogleHome.Example113();
      //expect(instance).to.be.a(GoogleHome.Example113);
    });
    ...
    it('should have the property wpaId (base name: "wpa_id")', function() {
      // uncomment below and update the code to test the property wpaId
      //var instance = new GoogleHome.Example113();
      //expect(instance).to.be();
    });
