...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.SetEqualizerValuesRequest();
  });
  ...
  describe('SetEqualizerValuesRequest', function() {
    it('should create an instance of SetEqualizerValuesRequest', function() {
      // uncomment below and update the code to test SetEqualizerValuesRequest
      //var instance = new GoogleHome.SetEqualizerValuesRequest();
      //expect(instance).to.be.a(GoogleHome.SetEqualizerValuesRequest);
    });

    it('should have the property highShelf (base name: "high_shelf")', function() {
      // uncomment below and update the code to test the property highShelf
      //var instance = new GoogleHome.SetEqualizerValuesRequest();
      //expect(instance).to.be();
    });

    it('should have the property lowShelf (base name: "low_shelf")', function() {
      // uncomment below and update the code to test the property lowShelf
      //var instance = new GoogleHome.SetEqualizerValuesRequest();
      //expect(instance).to.be();
    });
