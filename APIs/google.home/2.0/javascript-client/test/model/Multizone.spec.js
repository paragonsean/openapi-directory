...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Multizone();
  });
  ...
  describe('Multizone', function() {
    it('should create an instance of Multizone', function() {
      // uncomment below and update the code to test Multizone
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be.a(GoogleHome.Multizone);
    });

    it('should have the property audioOutputDelay (base name: "audio_output_delay")', function() {
      // uncomment below and update the code to test the property audioOutputDelay
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });

    it('should have the property audioOutputDelayHdmi (base name: "audio_output_delay_hdmi")', function() {
      // uncomment below and update the code to test the property audioOutputDelayHdmi
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });

    it('should have the property audioOutputDelayOem (base name: "audio_output_delay_oem")', function() {
      // uncomment below and update the code to test the property audioOutputDelayOem
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });

    it('should have the property auxInGroup (base name: "aux_in_group")', function() {
      // uncomment below and update the code to test the property auxInGroup
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });

    it('should have the property dynamicGroups (base name: "dynamic_groups")', function() {
      // uncomment below and update the code to test the property dynamicGroups
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });
    ...
    it('should have the property multichannelStatus (base name: "multichannel_status")', function() {
      // uncomment below and update the code to test the property multichannelStatus
      //var instance = new GoogleHome.Multizone();
      //expect(instance).to.be();
    });
