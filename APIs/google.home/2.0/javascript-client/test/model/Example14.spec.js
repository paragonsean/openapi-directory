...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example14();
  });
  ...
  describe('Example14', function() {
    it('should create an instance of Example14', function() {
      // uncomment below and update the code to test Example14
      //var instance = new GoogleHome.Example14();
      //expect(instance).to.be.a(GoogleHome.Example14);
    });

    it('should have the property displayString (base name: "display_string")', function() {
