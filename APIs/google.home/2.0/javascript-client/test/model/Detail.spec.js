...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Detail();
  });
  ...
  describe('Detail', function() {
    it('should create an instance of Detail', function() {
      ...
      //var instance = new GoogleHome.Detail();
      //expect(instance).to.be.a(GoogleHome.Detail);
    });

    it('should have the property iconList (base name: "icon_list")', function() {
      // uncomment below and update the code to test the property iconList
      //var instance = new GoogleHome.Detail();
