...
(function(root, factory) {
  ...
  describe('Timer', function() {
    it('should create an instance of Timer', function() {
      ...
      //var instance = new GoogleHome.Timer();
      //expect(instance).to.be.a(GoogleHome.Timer);
    });
    ...
    it('should have the property originalDuration (base name: "original_duration")', function() {
      // uncomment below and update the code to test the property originalDuration
      //var instance = new GoogleHome.Timer();
      //expect(instance).to.be();
    });
