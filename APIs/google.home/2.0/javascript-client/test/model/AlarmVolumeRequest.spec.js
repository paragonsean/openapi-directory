...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.AlarmVolumeRequest();
  });
  ...
  describe('AlarmVolumeRequest', function() {
    it('should create an instance of AlarmVolumeRequest', function() {
      // uncomment below and update the code to test AlarmVolumeRequest
      //var instance = new GoogleHome.AlarmVolumeRequest();
      //expect(instance).to.be.a(GoogleHome.AlarmVolumeRequest);
    });
