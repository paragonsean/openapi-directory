...
(function(root, factory) {
  ...
  describe('Setup', function() {
    it('should create an instance of Setup', function() {
      // uncomment below and update the code to test Setup
      //var instance = new GoogleHome.Setup();
      //expect(instance).to.be.a(GoogleHome.Setup);
    });

    it('should have the property qrSsidSuffix (base name: "qr_ssid_suffix")', function() {
      // uncomment below and update the code to test the property qrSsidSuffix
      //var instance = new GoogleHome.Setup();
      //expect(instance).to.be();
    });

    it('should have the property setupState (base name: "setup_state")', function() {
      // uncomment below and update the code to test the property setupState
      //var instance = new GoogleHome.Setup();
      //expect(instance).to.be();
    });

    it('should have the property ssidSuffix (base name: "ssid_suffix")', function() {
      // uncomment below and update the code to test the property ssidSuffix
      //var instance = new GoogleHome.Setup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tosAccepted (base name: "tos_accepted")', function() {
      // uncomment below and update the code to test the property tosAccepted
      //var instance = new GoogleHome.Setup();
      //expect(instance).to.be();
    });
