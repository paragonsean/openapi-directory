...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.RemoteSink();
  });
  ...
  describe('RemoteSink', function() {
    it('should create an instance of RemoteSink', function() {
      // uncomment below and update the code to test RemoteSink
      //var instance = new GoogleHome.RemoteSink();
      //expect(instance).to.be.a(GoogleHome.RemoteSink);
    });

    it('should have the property bondDate (base name: "bond_date")', function() {
      // uncomment below and update the code to test the property bondDate
      //var instance = new GoogleHome.RemoteSink();
      //expect(instance).to.be();
    });

    it('should have the property deviceClass (base name: "device_class")', function() {
    ...
    it('should have the property lastConnectDate (base name: "last_connect_date")', function() {
      // uncomment below and update the code to test the property lastConnectDate
      //var instance = new GoogleHome.RemoteSink();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serviceUuids (base name: "service_uuids")', function() {
      // uncomment below and update the code to test the property serviceUuids
      //var instance = new GoogleHome.RemoteSink();
      //expect(instance).to.be();
    });
