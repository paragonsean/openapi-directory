...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example18();
  });
  ...
  describe('Example18', function() {
    it('should create an instance of Example18', function() {
      // uncomment below and update the code to test Example18
      //var instance = new GoogleHome.Example18();
      //expect(instance).to.be.a(GoogleHome.Example18);
    });
    ...
    it('should have the property timer (base name: "timer")', function() {
      // uncomment below and update the code to test the property timer
      //var instance = new GoogleHome.Example18();
      //expect(instance).to.be();
    });
