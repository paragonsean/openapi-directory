...
(function(root, factory) {
  ...
  describe('OptIn', function() {
    it('should create an instance of OptIn', function() {
      // uncomment below and update the code to test OptIn
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be.a(GoogleHome.OptIn);
    });

    it('should have the property audioHdr (base name: "audio_hdr")', function() {
      // uncomment below and update the code to test the property audioHdr
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property audioSurroundMode (base name: "audio_surround_mode")', function() {
      // uncomment below and update the code to test the property audioSurroundMode
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property autoplayOnSignal (base name: "autoplay_on_signal")', function() {
      // uncomment below and update the code to test the property autoplayOnSignal
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property cloudIpc (base name: "cloud_ipc")', function() {
      // uncomment below and update the code to test the property cloudIpc
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property hdmiPrefer50hz (base name: "hdmi_prefer_50hz")', function() {
      // uncomment below and update the code to test the property hdmiPrefer50hz
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property hdmiPreferHighFps (base name: "hdmi_prefer_high_fps")', function() {
      // uncomment below and update the code to test the property hdmiPreferHighFps
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property managedMode (base name: "managed_mode")', function() {
      // uncomment below and update the code to test the property managedMode
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });
    ...
    it('should have the property previewChannel (base name: "preview_channel")', function() {
      // uncomment below and update the code to test the property previewChannel
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property remoteDucking (base name: "remote_ducking")', function() {
      // uncomment below and update the code to test the property remoteDucking
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });
    ...
    it('should have the property uiFlipped (base name: "ui_flipped")', function() {
      // uncomment below and update the code to test the property uiFlipped
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });

    it('should have the property wpa3SupportEnabled (base name: "wpa3_support_enabled")', function() {
      // uncomment below and update the code to test the property wpa3SupportEnabled
      //var instance = new GoogleHome.OptIn();
      //expect(instance).to.be();
    });
