...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ForgetpaireddeviceRequest();
  });
  ...
  describe('ForgetpaireddeviceRequest', function() {
    it('should create an instance of ForgetpaireddeviceRequest', function() {
      // uncomment below and update the code to test ForgetpaireddeviceRequest
      //var instance = new GoogleHome.ForgetpaireddeviceRequest();
      //expect(instance).to.be.a(GoogleHome.ForgetpaireddeviceRequest);
    });
