...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ForgetWiFiNetworkRequest();
  });
  ...
  describe('ForgetWiFiNetworkRequest', function() {
    it('should create an instance of ForgetWiFiNetworkRequest', function() {
      // uncomment below and update the code to test ForgetWiFiNetworkRequest
      //var instance = new GoogleHome.ForgetWiFiNetworkRequest();
      //expect(instance).to.be.a(GoogleHome.ForgetWiFiNetworkRequest);
    });
