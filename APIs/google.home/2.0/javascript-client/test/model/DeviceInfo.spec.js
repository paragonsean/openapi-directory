...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.DeviceInfo();
  });
  ...
  describe('DeviceInfo', function() {
    it('should create an instance of DeviceInfo', function() {
      ...
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be.a(GoogleHome.DeviceInfo);
    });

    it('should have the property _4kBlocked (base name: "4k_blocked")', function() {
      // uncomment below and update the code to test the property _4kBlocked
      //var instance = new GoogleHome.DeviceInfo();
    ...
    it('should have the property cloudDeviceId (base name: "cloud_device_id")', function() {
      // uncomment below and update the code to test the property cloudDeviceId
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });

    it('should have the property factoryCountryCode (base name: "factory_country_code")', function() {
      // uncomment below and update the code to test the property factoryCountryCode
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });

    it('should have the property hotspotBssid (base name: "hotspot_bssid")', function() {
      // uncomment below and update the code to test the property hotspotBssid
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });

    it('should have the property localAuthorizationTokenHash (base name: "local_authorization_token_hash")', function() {
      // uncomment below and update the code to test the property localAuthorizationTokenHash
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ssdpUdn (base name: "ssdp_udn")', function() {
      // uncomment below and update the code to test the property ssdpUdn
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });

    it('should have the property umaClientId (base name: "uma_client_id")', function() {
      // uncomment below and update the code to test the property umaClientId
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property weaveDeviceId (base name: "weave_device_id")', function() {
      // uncomment below and update the code to test the property weaveDeviceId
      //var instance = new GoogleHome.DeviceInfo();
      //expect(instance).to.be();
    });
