...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Settings1();
  });
  ...
  describe('Settings1', function() {
    it('should create an instance of Settings1', function() {
      // uncomment below and update the code to test Settings1
      //var instance = new GoogleHome.Settings1();
      //expect(instance).to.be.a(GoogleHome.Settings1);
    });
