...
(function(root, factory) {
  ...
  describe('Wifi', function() {
    it('should create an instance of Wifi', function() {
      // uncomment below and update the code to test Wifi
      //var instance = new GoogleHome.Wifi();
      //expect(instance).to.be.a(GoogleHome.Wifi);
    });
    ...
    it('should have the property hasChanges (base name: "has_changes")', function() {
      // uncomment below and update the code to test the property hasChanges
      //var instance = new GoogleHome.Wifi();
      //expect(instance).to.be();
    });

    it('should have the property noiseLevel (base name: "noise_level")', function() {
      // uncomment below and update the code to test the property noiseLevel
      //var instance = new GoogleHome.Wifi();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wpaConfigured (base name: "wpa_configured")', function() {
      // uncomment below and update the code to test the property wpaConfigured
      //var instance = new GoogleHome.Wifi();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wpaState (base name: "wpa_state")', function() {
      // uncomment below and update the code to test the property wpaState
      //var instance = new GoogleHome.Wifi();
      //expect(instance).to.be();
    });
