...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Opencast();
  });
  ...
  describe('Opencast', function() {
    it('should create an instance of Opencast', function() {
      // uncomment below and update the code to test Opencast
      //var instance = new GoogleHome.Opencast();
      //expect(instance).to.be.a(GoogleHome.Opencast);
    });

    it('should have the property pinCode (base name: "pin_code")', function() {
