...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ConnectedDevice();
  });
  ...
  describe('ConnectedDevice', function() {
    it('should create an instance of ConnectedDevice', function() {
      // uncomment below and update the code to test ConnectedDevice
      //var instance = new GoogleHome.ConnectedDevice();
      //expect(instance).to.be.a(GoogleHome.ConnectedDevice);
    });
    ...
    it('should have the property enabledProfiles (base name: "enabled_profiles")', function() {
      // uncomment below and update the code to test the property enabledProfiles
      //var instance = new GoogleHome.ConnectedDevice();
      //expect(instance).to.be();
    });
