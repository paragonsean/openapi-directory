...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.ChangeDiscoverabilityRequest();
  });
  ...
  describe('ChangeDiscoverabilityRequest', function() {
    it('should create an instance of ChangeDiscoverabilityRequest', function() {
      // uncomment below and update the code to test ChangeDiscoverabilityRequest
      //var instance = new GoogleHome.ChangeDiscoverabilityRequest();
      //expect(instance).to.be.a(GoogleHome.ChangeDiscoverabilityRequest);
    });

    it('should have the property enableDiscovery (base name: "enable_discovery")', function() {
      // uncomment below and update the code to test the property enableDiscovery
      //var instance = new GoogleHome.ChangeDiscoverabilityRequest();
