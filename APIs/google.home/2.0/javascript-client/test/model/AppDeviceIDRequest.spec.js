...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.AppDeviceIDRequest();
  });
  ...
  describe('AppDeviceIDRequest', function() {
    it('should create an instance of AppDeviceIDRequest', function() {
      // uncomment below and update the code to test AppDeviceIDRequest
      //var instance = new GoogleHome.AppDeviceIDRequest();
      //expect(instance).to.be.a(GoogleHome.AppDeviceIDRequest);
    });
