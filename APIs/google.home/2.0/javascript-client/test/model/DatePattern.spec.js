...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.DatePattern();
  });
  ...
  describe('DatePattern', function() {
    it('should create an instance of DatePattern', function() {
      // uncomment below and update the code to test DatePattern
      //var instance = new GoogleHome.DatePattern();
      //expect(instance).to.be.a(GoogleHome.DatePattern);
    });
