...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Getvolume();
  });
  ...
  describe('Getvolume', function() {
    it('should create an instance of Getvolume', function() {
      // uncomment below and update the code to test Getvolume
      //var instance = new GoogleHome.Getvolume();
      //expect(instance).to.be.a(GoogleHome.Getvolume);
    });
