...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.RebootandFactoryResetRequest();
  });
  ...
  describe('RebootandFactoryResetRequest', function() {
    it('should create an instance of RebootandFactoryResetRequest', function() {
      // uncomment below and update the code to test RebootandFactoryResetRequest
      //var instance = new GoogleHome.RebootandFactoryResetRequest();
      //expect(instance).to.be.a(GoogleHome.RebootandFactoryResetRequest);
    });
