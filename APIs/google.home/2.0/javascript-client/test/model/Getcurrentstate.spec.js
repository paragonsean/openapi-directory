...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Getcurrentstate();
  });
  ...
  describe('Getcurrentstate', function() {
    it('should create an instance of Getcurrentstate', function() {
      // uncomment below and update the code to test Getcurrentstate
      //var instance = new GoogleHome.Getcurrentstate();
      //expect(instance).to.be.a(GoogleHome.Getcurrentstate);
    });
