...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Example112();
  });
  ...
  describe('Example112', function() {
    it('should create an instance of Example112', function() {
      // uncomment below and update the code to test Example112
      //var instance = new GoogleHome.Example112();
      //expect(instance).to.be.a(GoogleHome.Example112);
    });
    ...
    it('should have the property expectedProfiles (base name: "expected_profiles")', function() {
      // uncomment below and update the code to test the property expectedProfiles
      //var instance = new GoogleHome.Example112();
      //expect(instance).to.be();
    });
