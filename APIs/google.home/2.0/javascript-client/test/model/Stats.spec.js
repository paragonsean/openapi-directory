...
(function(root, factory) {
  ...
  describe('Stats', function() {
    it('should create an instance of Stats', function() {
      ...
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be.a(GoogleHome.Stats);
    });

    it('should have the property numCheckConnectivity (base name: "num_check_connectivity")', function() {
      // uncomment below and update the code to test the property numCheckConnectivity
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be();
    });

    it('should have the property numConnectWifi (base name: "num_connect_wifi")', function() {
      // uncomment below and update the code to test the property numConnectWifi
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be();
    });

    it('should have the property numConnectedWifiNotSaved (base name: "num_connected_wifi_not_saved")', function() {
      // uncomment below and update the code to test the property numConnectedWifiNotSaved
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be();
    });

    it('should have the property numInitialEurekaInfo (base name: "num_initial_eureka_info")', function() {
      // uncomment below and update the code to test the property numInitialEurekaInfo
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be();
    });

    it('should have the property numObtainIp (base name: "num_obtain_ip")', function() {
      // uncomment below and update the code to test the property numObtainIp
      //var instance = new GoogleHome.Stats();
      //expect(instance).to.be();
    });
