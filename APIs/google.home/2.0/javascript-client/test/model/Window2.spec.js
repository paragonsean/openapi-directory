...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Window2();
  });
  ...
  describe('Window2', function() {
    it('should create an instance of Window2', function() {
      // uncomment below and update the code to test Window2
      //var instance = new GoogleHome.Window2();
      //expect(instance).to.be.a(GoogleHome.Window2);
    });
    ...
    it('should have the property lengthHours (base name: "length_hours")', function() {
      // uncomment below and update the code to test the property lengthHours
      //var instance = new GoogleHome.Window2();
      //expect(instance).to.be();
    });
