...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleHome.Getcurrentvalues();
  });
  ...
  describe('Getcurrentvalues', function() {
    it('should create an instance of Getcurrentvalues', function() {
      // uncomment below and update the code to test Getcurrentvalues
      //var instance = new GoogleHome.Getcurrentvalues();
      //expect(instance).to.be.a(GoogleHome.Getcurrentvalues);
    });
