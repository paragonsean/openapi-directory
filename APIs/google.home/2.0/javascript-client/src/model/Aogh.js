...
/**
 * The Aogh model module.
 * @module model/Aogh
 * @version 2.0
 */
class Aogh {
    /**
     * Constructs a new <code>Aogh</code>.
     * @alias module:model/Aogh
     * @param aoghApiVersion {String} 
     */
    constructor(aoghApiVersion) { 
        
        Aogh.initialize(this, aoghApiVersion);
    }
     ...
     */
    static initialize(obj, aoghApiVersion) { 
        obj['aogh_api_version'] = aoghApiVersion;
    }

    /**
     * Constructs a <code>Aogh</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Aogh} obj Optional instance to populate.
     * @return {module:model/Aogh} The populated <code>Aogh</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Aogh();

            if (data.hasOwnProperty('aogh_api_version')) {
                obj['aogh_api_version'] = ApiClient.convertToType(data['aogh_api_version'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Aogh</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Aogh</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Aogh.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['aogh_api_version'] && !(typeof data['aogh_api_version'] === 'string' || data['aogh_api_version'] instanceof String)) {
            throw new Error("Expected the field `aogh_api_version` to be a primitive type in the JSON string but got " + data['aogh_api_version']);
        }
...
Aogh.RequiredProperties = ["aogh_api_version"];

/**
 * @member {String} aogh_api_version
 */
Aogh.prototype['aogh_api_version'] = undefined;
