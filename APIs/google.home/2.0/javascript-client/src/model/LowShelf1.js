...
/**
 * The LowShelf1 model module.
 * @module model/LowShelf1
 * @version 2.0
 */
class LowShelf1 {
    /**
     * Constructs a new <code>LowShelf1</code>.
     * @alias module:model/LowShelf1
     * @param gainDb {Number} 
     */
    constructor(gainDb) { 
        
        LowShelf1.initialize(this, gainDb);
    }
    ...
    /**
     * Constructs a <code>LowShelf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LowShelf1} obj Optional instance to populate.
     * @return {module:model/LowShelf1} The populated <code>LowShelf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LowShelf1();
    ...
    /**
     * Validates the JSON data with respect to <code>LowShelf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LowShelf1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LowShelf1.RequiredProperties) {
...
LowShelf1.RequiredProperties = ["gain_db"];

/**
 * @member {Number} gain_db
 */
LowShelf1.prototype['gain_db'] = undefined;
