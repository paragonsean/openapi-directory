...
/**
 * The Example111 model module.
 * @module model/Example111
 * @version 2.0
 */
class Example111 {
    /**
     * Constructs a new <code>Example111</code>.
     * @alias module:model/Example111
    ...
    constructor(bondDate, deviceClass, deviceType, lastConnectDate, macAddress, name, rssi, serviceUuids) { 
        ...
        Example111.initialize(this, bondDate, deviceClass, deviceType, lastConnectDate, macAddress, name, rssi, serviceUuids);
    }
    ...
    /**
     * Constructs a <code>Example111</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example111} obj Optional instance to populate.
     * @return {module:model/Example111} The populated <code>Example111</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example111();
    ...
    /**
     * Validates the JSON data with respect to <code>Example111</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example111</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example111.RequiredProperties) {
...
Example111.RequiredProperties = ["bond_date", "device_class", "device_type", "last_connect_date", "mac_address", "name", "rssi", "service_uuids"];

/**
 * @member {Number} bond_date
 */
Example111.prototype['bond_date'] = undefined;

/**
 * @member {Number} device_class
 */
Example111.prototype['device_class'] = undefined;

/**
 * @member {Number} device_type
 */
Example111.prototype['device_type'] = undefined;

/**
 * @member {Number} last_connect_date
 */
Example111.prototype['last_connect_date'] = undefined;

/**
 * @member {String} mac_address
 */
Example111.prototype['mac_address'] = undefined;

/**
 * @member {String} name
 */
Example111.prototype['name'] = undefined;

/**
 * @member {Number} rssi
 */
Example111.prototype['rssi'] = undefined;

/**
 * @member {Array.<String>} service_uuids
 */
Example111.prototype['service_uuids'] = undefined;
