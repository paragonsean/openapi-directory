...
class Alarm {
     ...
     * @param datePattern {module:model/DatePattern} 
     * @param fireTime {Number} 
     * @param id {String} 
     * @param status {Number} 
     * @param timePattern {module:model/TimePattern} 
     */
    constructor(datePattern, fireTime, id, status, timePattern) { 
        
        Alarm.initialize(this, datePattern, fireTime, id, status, timePattern);
    }
     ...
     */
    static initialize(obj, datePattern, fireTime, id, status, timePattern) { 
        obj['date_pattern'] = datePattern;
        obj['fire_time'] = fireTime;
        obj['id'] = id;
        obj['status'] = status;
        obj['time_pattern'] = timePattern;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('date_pattern')) {
                obj['date_pattern'] = DatePattern.constructFromObject(data['date_pattern']);
            }
            if (data.hasOwnProperty('fire_time')) {
                obj['fire_time'] = ApiClient.convertToType(data['fire_time'], 'Number');
            }
            ...
            if (data.hasOwnProperty('time_pattern')) {
                obj['time_pattern'] = TimePattern.constructFromObject(data['time_pattern']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `date_pattern`
        if (data['date_pattern']) { // data not null
          DatePattern.validateJSON(data['date_pattern']);
        }
        // ensure the json data is a string
        if (data['id'] && !(typeof data['id'] === 'string' || data['id'] instanceof String)) {
            throw new Error("Expected the field `id` to be a primitive type in the JSON string but got " + data['id']);
        }
        // validate the optional field `time_pattern`
        if (data['time_pattern']) { // data not null
          TimePattern.validateJSON(data['time_pattern']);
        }
...
Alarm.RequiredProperties = ["date_pattern", "fire_time", "id", "status", "time_pattern"];

/**
 * @member {module:model/DatePattern} date_pattern
 */
Alarm.prototype['date_pattern'] = undefined;

/**
 * @member {Number} fire_time
 */
Alarm.prototype['fire_time'] = undefined;
 ...
 */
Alarm.prototype['status'] = undefined;

/**
 * @member {module:model/TimePattern} time_pattern
 */
Alarm.prototype['time_pattern'] = undefined;
