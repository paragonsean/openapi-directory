...
/**
 * The ConnecttoWiFiNetworkRequest model module.
 * @module model/ConnecttoWiFiNetworkRequest
 * @version 2.0
 */
class ConnecttoWiFiNetworkRequest {
    /**
     * Constructs a new <code>ConnecttoWiFiNetworkRequest</code>.
     * @alias module:model/ConnecttoWiFiNetworkRequest
     * @param bssid {String} 
     ...
     */
    constructor(bssid, encPasswd, signalLevel, ssid, wpaAuth, wpaCipher) { 
        
        ConnecttoWiFiNetworkRequest.initialize(this, bssid, encPasswd, signalLevel, ssid, wpaAuth, wpaCipher);
    }
     ...
     */
    static initialize(obj, bssid, encPasswd, signalLevel, ssid, wpaAuth, wpaCipher) { 
        obj['bssid'] = bssid;
        obj['enc_passwd'] = encPasswd;
    ...
    /**
     * Constructs a <code>ConnecttoWiFiNetworkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnecttoWiFiNetworkRequest} obj Optional instance to populate.
     * @return {module:model/ConnecttoWiFiNetworkRequest} The populated <code>ConnecttoWiFiNetworkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnecttoWiFiNetworkRequest();

            if (data.hasOwnProperty('bssid')) {
                obj['bssid'] = ApiClient.convertToType(data['bssid'], 'String');
            }
            if (data.hasOwnProperty('enc_passwd')) {
                obj['enc_passwd'] = ApiClient.convertToType(data['enc_passwd'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConnecttoWiFiNetworkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnecttoWiFiNetworkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnecttoWiFiNetworkRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['enc_passwd'] && !(typeof data['enc_passwd'] === 'string' || data['enc_passwd'] instanceof String)) {
            throw new Error("Expected the field `enc_passwd` to be a primitive type in the JSON string but got " + data['enc_passwd']);
        }
        // ensure the json data is a string
...
ConnecttoWiFiNetworkRequest.RequiredProperties = ["bssid", "enc_passwd", "signal_level", "ssid", "wpa_auth", "wpa_cipher"];

/**
 * @member {String} bssid
 */
ConnecttoWiFiNetworkRequest.prototype['bssid'] = undefined;

/**
 * @member {String} enc_passwd
 */
ConnecttoWiFiNetworkRequest.prototype['enc_passwd'] = undefined;

/**
 * @member {Number} signal_level
 */
ConnecttoWiFiNetworkRequest.prototype['signal_level'] = undefined;

/**
 * @member {String} ssid
 */
ConnecttoWiFiNetworkRequest.prototype['ssid'] = undefined;

/**
 * @member {Number} wpa_auth
 */
ConnecttoWiFiNetworkRequest.prototype['wpa_auth'] = undefined;

/**
 * @member {Number} wpa_cipher
 */
ConnecttoWiFiNetworkRequest.prototype['wpa_cipher'] = undefined;
...
export default ConnecttoWiFiNetworkRequest;
