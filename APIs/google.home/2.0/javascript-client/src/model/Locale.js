...
class Locale {
    ...
    constructor(displayString) { 
        ...
        Locale.initialize(this, displayString);
    }
     ...
     */
    static initialize(obj, displayString) { 
        obj['display_string'] = displayString;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('display_string')) {
                obj['display_string'] = ApiClient.convertToType(data['display_string'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['display_string'] && !(typeof data['display_string'] === 'string' || data['display_string'] instanceof String)) {
            throw new Error("Expected the field `display_string` to be a primitive type in the JSON string but got " + data['display_string']);
        }
...
Locale.RequiredProperties = ["display_string"];

/**
 * @member {String} display_string
 */
Locale.prototype['display_string'] = undefined;
