...
class Detail {
     ...
     * @param iconList {Array.<module:model/IconList>} 
     * @param locale {module:model/Locale} 
     * @param timezone {module:model/Timezone} 
     */
    constructor(iconList, locale, timezone) { 
        
        Detail.initialize(this, iconList, locale, timezone);
    }
     ...
     */
    static initialize(obj, iconList, locale, timezone) { 
        obj['icon_list'] = iconList;
        obj['locale'] = locale;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('icon_list')) {
                obj['icon_list'] = ApiClient.convertToType(data['icon_list'], [IconList]);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of Detail.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['icon_list']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['icon_list'])) {
                throw new Error("Expected the field `icon_list` to be an array in the JSON data but got " + data['icon_list']);
            }
            // validate the optional field `icon_list` (array)
            for (const item of data['icon_list']) {
                IconList.validateJSON(item);
            };
        }
...
Detail.RequiredProperties = ["icon_list", "locale", "timezone"];

/**
 * @member {Array.<module:model/IconList>} icon_list
 */
Detail.prototype['icon_list'] = undefined;

/**
 * @member {module:model/Locale} locale
 */
Detail.prototype['locale'] = undefined;

/**
 * @member {module:model/Timezone} timezone
 */
Detail.prototype['timezone'] = undefined;
