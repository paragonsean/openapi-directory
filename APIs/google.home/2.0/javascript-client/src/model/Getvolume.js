...
/**
 * The Getvolume model module.
 * @module model/Getvolume
 * @version 2.0
 */
class Getvolume {
    /**
     * Constructs a new <code>Getvolume</code>.
     * @alias module:model/Getvolume
     * @param volume {Number} 
     */
    constructor(volume) { 
        
        Getvolume.initialize(this, volume);
    }
    ...
    /**
     * Constructs a <code>Getvolume</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getvolume} obj Optional instance to populate.
     * @return {module:model/Getvolume} The populated <code>Getvolume</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getvolume();
    ...
    /**
     * Validates the JSON data with respect to <code>Getvolume</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getvolume</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Getvolume.RequiredProperties) {
...
Getvolume.RequiredProperties = ["volume"];

/**
 * @member {Number} volume
 */
Getvolume.prototype['volume'] = undefined;
