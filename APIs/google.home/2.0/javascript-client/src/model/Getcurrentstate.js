...
/**
 * The Getcurrentstate model module.
 * @module model/Getcurrentstate
 * @version 2.0
 */
class Getcurrentstate {
    /**
     * Constructs a new <code>Getcurrentstate</code>.
     * @alias module:model/Getcurrentstate
     * @param notificationsEnabled {Boolean} 
     */
    constructor(notificationsEnabled) { 
        
        Getcurrentstate.initialize(this, notificationsEnabled);
    }
     ...
     */
    static initialize(obj, notificationsEnabled) { 
        obj['notifications_enabled'] = notificationsEnabled;
    }

    /**
     * Constructs a <code>Getcurrentstate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getcurrentstate} obj Optional instance to populate.
     * @return {module:model/Getcurrentstate} The populated <code>Getcurrentstate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getcurrentstate();
    ...
    /**
     * Validates the JSON data with respect to <code>Getcurrentstate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getcurrentstate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Getcurrentstate.RequiredProperties) {
...
Getcurrentstate.RequiredProperties = ["notifications_enabled"];

/**
 * @member {Boolean} notifications_enabled
 */
Getcurrentstate.prototype['notifications_enabled'] = undefined;
