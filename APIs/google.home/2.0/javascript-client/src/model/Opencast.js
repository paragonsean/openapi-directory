...
/**
 * The Opencast model module.
 * @module model/Opencast
 * @version 2.0
 */
class Opencast {
    /**
     * Constructs a new <code>Opencast</code>.
     * @alias module:model/Opencast
     * @param pinCode {String} 
     */
    constructor(pinCode) { 
        
        Opencast.initialize(this, pinCode);
    }
     ...
     */
    static initialize(obj, pinCode) { 
        obj['pin_code'] = pinCode;
    }

    /**
     * Constructs a <code>Opencast</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Opencast} obj Optional instance to populate.
     * @return {module:model/Opencast} The populated <code>Opencast</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Opencast();

            if (data.hasOwnProperty('pin_code')) {
                obj['pin_code'] = ApiClient.convertToType(data['pin_code'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Opencast</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Opencast</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Opencast.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['pin_code'] && !(typeof data['pin_code'] === 'string' || data['pin_code'] instanceof String)) {
            throw new Error("Expected the field `pin_code` to be a primitive type in the JSON string but got " + data['pin_code']);
        }
...
Opencast.RequiredProperties = ["pin_code"];

/**
 * @member {String} pin_code
 */
Opencast.prototype['pin_code'] = undefined;
