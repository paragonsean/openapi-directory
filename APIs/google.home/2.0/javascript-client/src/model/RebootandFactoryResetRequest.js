...
/**
 * The RebootandFactoryResetRequest model module.
 * @module model/RebootandFactoryResetRequest
 * @version 2.0
 */
class RebootandFactoryResetRequest {
    /**
     * Constructs a new <code>RebootandFactoryResetRequest</code>.
     * @alias module:model/RebootandFactoryResetRequest
     * @param params {String} 
     */
    constructor(params) { 
        
        RebootandFactoryResetRequest.initialize(this, params);
    }
    ...
    /**
     * Constructs a <code>RebootandFactoryResetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RebootandFactoryResetRequest} obj Optional instance to populate.
     * @return {module:model/RebootandFactoryResetRequest} The populated <code>RebootandFactoryResetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RebootandFactoryResetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RebootandFactoryResetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RebootandFactoryResetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RebootandFactoryResetRequest.RequiredProperties) {
...
RebootandFactoryResetRequest.RequiredProperties = ["params"];

/**
 * @member {String} params
 */
RebootandFactoryResetRequest.prototype['params'] = undefined;
...
export default RebootandFactoryResetRequest;
