...
/**
 * The IconList model module.
 * @module model/IconList
 * @version 2.0
 */
class IconList {
    /**
     * Constructs a new <code>IconList</code>.
     * @alias module:model/IconList
     * @param depth {Number} 
     * @param height {Number} 
     ...
     * @param width {Number} 
     */
    constructor(depth, height, mimetype, url, width) { 
        
        IconList.initialize(this, depth, height, mimetype, url, width);
    }
     ...
     */
    static initialize(obj, depth, height, mimetype, url, width) { 
        obj['depth'] = depth;
        obj['height'] = height;
    ...
    /**
     * Constructs a <code>IconList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IconList} obj Optional instance to populate.
     * @return {module:model/IconList} The populated <code>IconList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IconList();
    ...
    /**
     * Validates the JSON data with respect to <code>IconList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IconList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IconList.RequiredProperties) {
...
IconList.RequiredProperties = ["depth", "height", "mimetype", "url", "width"];

/**
 * @member {Number} depth
 */
IconList.prototype['depth'] = undefined;

/**
 * @member {Number} height
 */
IconList.prototype['height'] = undefined;

/**
 * @member {String} mimetype
 */
IconList.prototype['mimetype'] = undefined;

/**
 * @member {String} url
 */
IconList.prototype['url'] = undefined;

/**
 * @member {Number} width
 */
IconList.prototype['width'] = undefined;
