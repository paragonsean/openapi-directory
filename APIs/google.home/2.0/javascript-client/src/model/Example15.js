...
/**
 * The Example15 model module.
 * @module model/Example15
 * @version 2.0
 */
class Example15 {
    /**
     * Constructs a new <code>Example15</code>.
     * @alias module:model/Example15
     * @param displayString {String} 
     * @param locale {String} 
     */
    constructor(displayString, locale) { 
        
        Example15.initialize(this, displayString, locale);
    }
     ...
     */
    static initialize(obj, displayString, locale) { 
        obj['display_string'] = displayString;
        obj['locale'] = locale;
    }

    /**
     * Constructs a <code>Example15</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example15} obj Optional instance to populate.
     * @return {module:model/Example15} The populated <code>Example15</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example15();
    ...
    /**
     * Validates the JSON data with respect to <code>Example15</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example15</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example15.RequiredProperties) {
...
Example15.RequiredProperties = ["display_string", "locale"];

/**
 * @member {String} display_string
 */
Example15.prototype['display_string'] = undefined;

/**
 * @member {String} locale
 */
Example15.prototype['locale'] = undefined;
