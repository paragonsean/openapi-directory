...
/**
 * The DatePattern model module.
 * @module model/DatePattern
 * @version 2.0
 */
class DatePattern {
    /**
     * Constructs a new <code>DatePattern</code>.
     * @alias module:model/DatePattern
     * @param day {Number} 
     * @param month {Number} 
     * @param year {Number} 
     */
    constructor(day, month, year) { 
        ...
        DatePattern.initialize(this, day, month, year);
    }
    ...
    /**
     * Constructs a <code>DatePattern</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatePattern} obj Optional instance to populate.
     * @return {module:model/DatePattern} The populated <code>DatePattern</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatePattern();
    ...
    /**
     * Validates the JSON data with respect to <code>DatePattern</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatePattern</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatePattern.RequiredProperties) {
...
DatePattern.RequiredProperties = ["day", "month", "year"];

/**
 * @member {Number} day
 */
DatePattern.prototype['day'] = undefined;

/**
 * @member {Number} month
 */
DatePattern.prototype['month'] = undefined;

/**
 * @member {Number} year
 */
DatePattern.prototype['year'] = undefined;
