...
/**
 * The CheckReadyStatusRequest model module.
 * @module model/CheckReadyStatusRequest
 * @version 2.0
 */
class CheckReadyStatusRequest {
    /**
     * Constructs a new <code>CheckReadyStatusRequest</code>.
     * @alias module:model/CheckReadyStatusRequest
     * @param playReadyMessage {Boolean} 
     * @param userId {String} 
     */
    constructor(playReadyMessage, userId) { 
        
        CheckReadyStatusRequest.initialize(this, playReadyMessage, userId);
    }
     ...
     */
    static initialize(obj, playReadyMessage, userId) { 
        obj['play_ready_message'] = playReadyMessage;
        obj['user_id'] = userId;
    }

    /**
     * Constructs a <code>CheckReadyStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckReadyStatusRequest} obj Optional instance to populate.
     * @return {module:model/CheckReadyStatusRequest} The populated <code>CheckReadyStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckReadyStatusRequest();

            if (data.hasOwnProperty('play_ready_message')) {
                obj['play_ready_message'] = ApiClient.convertToType(data['play_ready_message'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CheckReadyStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckReadyStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CheckReadyStatusRequest.RequiredProperties) {
...
CheckReadyStatusRequest.RequiredProperties = ["play_ready_message", "user_id"];

/**
 * @member {Boolean} play_ready_message
 */
CheckReadyStatusRequest.prototype['play_ready_message'] = undefined;

/**
 * @member {String} user_id
 */
CheckReadyStatusRequest.prototype['user_id'] = undefined;
...
export default CheckReadyStatusRequest;
