...
/**
 * The UserEq model module.
 * @module model/UserEq
 * @version 2.0
 */
class UserEq {
    /**
     * Constructs a new <code>UserEq</code>.
     * @alias module:model/UserEq
     * @param highShelf {module:model/HighShelf} 
     * @param lowShelf {module:model/LowShelf} 
     * @param maxPeakingEqs {Number} 
     * @param peakingEqs {Array.<String>} 
     */
    constructor(highShelf, lowShelf, maxPeakingEqs, peakingEqs) { 
        
        UserEq.initialize(this, highShelf, lowShelf, maxPeakingEqs, peakingEqs);
    }
     ...
     */
    static initialize(obj, highShelf, lowShelf, maxPeakingEqs, peakingEqs) { 
        obj['high_shelf'] = highShelf;
        obj['low_shelf'] = lowShelf;
        obj['max_peaking_eqs'] = maxPeakingEqs;
        obj['peaking_eqs'] = peakingEqs;
    }

    /**
     * Constructs a <code>UserEq</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserEq} obj Optional instance to populate.
     * @return {module:model/UserEq} The populated <code>UserEq</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('high_shelf')) {
                obj['high_shelf'] = HighShelf.constructFromObject(data['high_shelf']);
            }
            if (data.hasOwnProperty('low_shelf')) {
                obj['low_shelf'] = LowShelf.constructFromObject(data['low_shelf']);
            }
            if (data.hasOwnProperty('max_peaking_eqs')) {
                obj['max_peaking_eqs'] = ApiClient.convertToType(data['max_peaking_eqs'], 'Number');
            }
            if (data.hasOwnProperty('peaking_eqs')) {
                obj['peaking_eqs'] = ApiClient.convertToType(data['peaking_eqs'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserEq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserEq</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserEq.RequiredProperties) {
        ...
        if (data['high_shelf']) { // data not null
          HighShelf.validateJSON(data['high_shelf']);
        }
        // validate the optional field `low_shelf`
        if (data['low_shelf']) { // data not null
          LowShelf.validateJSON(data['low_shelf']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['peaking_eqs'])) {
            throw new Error("Expected the field `peaking_eqs` to be an array in the JSON data but got " + data['peaking_eqs']);
        }
...
UserEq.RequiredProperties = ["high_shelf", "low_shelf", "max_peaking_eqs", "peaking_eqs"];

/**
 * @member {module:model/HighShelf} high_shelf
 */
UserEq.prototype['high_shelf'] = undefined;

/**
 * @member {module:model/LowShelf} low_shelf
 */
UserEq.prototype['low_shelf'] = undefined;

/**
 * @member {Number} max_peaking_eqs
 */
UserEq.prototype['max_peaking_eqs'] = undefined;

/**
 * @member {Array.<String>} peaking_eqs
 */
UserEq.prototype['peaking_eqs'] = undefined;
