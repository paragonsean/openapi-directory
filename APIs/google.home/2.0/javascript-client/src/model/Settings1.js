...
/**
 * The Settings1 model module.
 * @module model/Settings1
 * @version 2.0
 */
class Settings1 {
    /**
     * Constructs a new <code>Settings1</code>.
     * @alias module:model/Settings1
     * @param controlNotifications {Number} 
     */
    constructor(controlNotifications) { 
        
        Settings1.initialize(this, controlNotifications);
    }
     ...
     */
    static initialize(obj, controlNotifications) { 
        obj['control_notifications'] = controlNotifications;
    }

    /**
     * Constructs a <code>Settings1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Settings1} obj Optional instance to populate.
     * @return {module:model/Settings1} The populated <code>Settings1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Settings1();
    ...
    /**
     * Validates the JSON data with respect to <code>Settings1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Settings1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Settings1.RequiredProperties) {
...
Settings1.RequiredProperties = ["control_notifications"];

/**
 * @member {Number} control_notifications
 */
Settings1.prototype['control_notifications'] = undefined;
