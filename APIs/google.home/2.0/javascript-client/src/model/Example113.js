...
/**
 * The Example113 model module.
 * @module model/Example113
 * @version 2.0
 */
class Example113 {
    /**
     * Constructs a new <code>Example113</code>.
     * @alias module:model/Example113
     * @param ssid {String} 
     * @param wpaAuth {Number} 
     * @param wpaCipher {Number} 
     * @param wpaId {Number} 
     */
    constructor(ssid, wpaAuth, wpaCipher, wpaId) { 
        
        Example113.initialize(this, ssid, wpaAuth, wpaCipher, wpaId);
    }
     ...
     */
    static initialize(obj, ssid, wpaAuth, wpaCipher, wpaId) { 
        obj['ssid'] = ssid;
    ...
    /**
     * Constructs a <code>Example113</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example113} obj Optional instance to populate.
     * @return {module:model/Example113} The populated <code>Example113</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example113();
    ...
    /**
     * Validates the JSON data with respect to <code>Example113</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example113</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example113.RequiredProperties) {
...
Example113.RequiredProperties = ["ssid", "wpa_auth", "wpa_cipher", "wpa_id"];

/**
 * @member {String} ssid
 */
Example113.prototype['ssid'] = undefined;

/**
 * @member {Number} wpa_auth
 */
Example113.prototype['wpa_auth'] = undefined;

/**
 * @member {Number} wpa_cipher
 */
Example113.prototype['wpa_cipher'] = undefined;

/**
 * @member {Number} wpa_id
 */
Example113.prototype['wpa_id'] = undefined;
