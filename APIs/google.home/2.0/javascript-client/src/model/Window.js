...
class Window {
    ...
    constructor(days, lengthHours, startHour) { 
        ...
        Window.initialize(this, days, lengthHours, startHour);
    }
...
Window.RequiredProperties = ["days", "length_hours", "start_hour"];

/**
 * @member {Array.<Number>} days
 */
Window.prototype['days'] = undefined;

/**
 * @member {Number} length_hours
 */
Window.prototype['length_hours'] = undefined;

/**
 * @member {Number} start_hour
 */
Window.prototype['start_hour'] = undefined;
