...
class Timezone {
     ...
     * @param offset {Number} 
     */
    constructor(displayString, offset) { 
        
        Timezone.initialize(this, displayString, offset);
    }
     ...
     */
    static initialize(obj, displayString, offset) { 
...
Timezone.RequiredProperties = ["display_string", "offset"];

/**
 * @member {String} display_string
 */
Timezone.prototype['display_string'] = undefined;
