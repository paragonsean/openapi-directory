...
/**
 * The ChangeDiscoverabilityRequest model module.
 * @module model/ChangeDiscoverabilityRequest
 * @version 2.0
 */
class ChangeDiscoverabilityRequest {
    /**
     * Constructs a new <code>ChangeDiscoverabilityRequest</code>.
     * @alias module:model/ChangeDiscoverabilityRequest
     * @param enableDiscovery {Boolean} 
     */
    constructor(enableDiscovery) { 
        
        ChangeDiscoverabilityRequest.initialize(this, enableDiscovery);
    }
     ...
     */
    static initialize(obj, enableDiscovery) { 
        obj['enable_discovery'] = enableDiscovery;
    }

    /**
     * Constructs a <code>ChangeDiscoverabilityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeDiscoverabilityRequest} obj Optional instance to populate.
     * @return {module:model/ChangeDiscoverabilityRequest} The populated <code>ChangeDiscoverabilityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeDiscoverabilityRequest();

            if (data.hasOwnProperty('enable_discovery')) {
                obj['enable_discovery'] = ApiClient.convertToType(data['enable_discovery'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeDiscoverabilityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeDiscoverabilityRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeDiscoverabilityRequest.RequiredProperties) {
...
ChangeDiscoverabilityRequest.RequiredProperties = ["enable_discovery"];

/**
 * @member {Boolean} enable_discovery
 */
ChangeDiscoverabilityRequest.prototype['enable_discovery'] = undefined;
...
export default ChangeDiscoverabilityRequest;
