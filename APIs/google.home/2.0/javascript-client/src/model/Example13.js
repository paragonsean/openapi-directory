...
/**
 * The Example13 model module.
 * @module model/Example13
 * @version 2.0
 */
class Example13 {
    /**
     * Constructs a new <code>Example13</code>.
     * @alias module:model/Example13
     * @param canEnroll {Boolean} 
     * @param enrollmentState {Number} 
     * @param errorCode {Number} 
     * @param ready {Boolean} 
     * @param retryable {Boolean} 
     */
    constructor(canEnroll, enrollmentState, errorCode, ready, retryable) { 
        
        Example13.initialize(this, canEnroll, enrollmentState, errorCode, ready, retryable);
    }
     ...
     */
    static initialize(obj, canEnroll, enrollmentState, errorCode, ready, retryable) { 
        obj['can_enroll'] = canEnroll;
        obj['enrollment_state'] = enrollmentState;
    ...
    /**
     * Constructs a <code>Example13</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example13} obj Optional instance to populate.
     * @return {module:model/Example13} The populated <code>Example13</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example13();

            if (data.hasOwnProperty('can_enroll')) {
                obj['can_enroll'] = ApiClient.convertToType(data['can_enroll'], 'Boolean');
            }
            if (data.hasOwnProperty('enrollment_state')) {
                obj['enrollment_state'] = ApiClient.convertToType(data['enrollment_state'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Example13</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example13</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example13.RequiredProperties) {
...
Example13.RequiredProperties = ["can_enroll", "enrollment_state", "error_code", "ready", "retryable"];

/**
 * @member {Boolean} can_enroll
 */
Example13.prototype['can_enroll'] = undefined;

/**
 * @member {Number} enrollment_state
 */
Example13.prototype['enrollment_state'] = undefined;

/**
 * @member {Number} error_code
 */
Example13.prototype['error_code'] = undefined;

/**
 * @member {Boolean} ready
 */
Example13.prototype['ready'] = undefined;

/**
 * @member {Boolean} retryable
 */
Example13.prototype['retryable'] = undefined;
