...
/**
 * The PairwithSpeakerRequest model module.
 * @module model/PairwithSpeakerRequest
 * @version 2.0
 */
class PairwithSpeakerRequest {
    /**
     * Constructs a new <code>PairwithSpeakerRequest</code>.
     * @alias module:model/PairwithSpeakerRequest
     * @param connect {Boolean} 
     * @param macAddress {String} 
     * @param profile {Number} 
     */
    constructor(connect, macAddress, profile) { 
        
        PairwithSpeakerRequest.initialize(this, connect, macAddress, profile);
    }
     ...
     */
    static initialize(obj, connect, macAddress, profile) { 
        obj['connect'] = connect;
    ...
    /**
     * Constructs a <code>PairwithSpeakerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PairwithSpeakerRequest} obj Optional instance to populate.
     * @return {module:model/PairwithSpeakerRequest} The populated <code>PairwithSpeakerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PairwithSpeakerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PairwithSpeakerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PairwithSpeakerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PairwithSpeakerRequest.RequiredProperties) {
...
PairwithSpeakerRequest.RequiredProperties = ["connect", "mac_address", "profile"];

/**
 * @member {Boolean} connect
 */
PairwithSpeakerRequest.prototype['connect'] = undefined;

/**
 * @member {String} mac_address
 */
PairwithSpeakerRequest.prototype['mac_address'] = undefined;

/**
 * @member {Number} profile
 */
PairwithSpeakerRequest.prototype['profile'] = undefined;
...
export default PairwithSpeakerRequest;
