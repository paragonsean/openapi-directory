...
/**
 * The HighShelf1 model module.
 * @module model/HighShelf1
 * @version 2.0
 */
class HighShelf1 {
    /**
     * Constructs a new <code>HighShelf1</code>.
     * @alias module:model/HighShelf1
     * @param gainDb {Number} 
     */
    constructor(gainDb) { 
        
        HighShelf1.initialize(this, gainDb);
    }
     ...
     */
    static initialize(obj, gainDb) { 
        obj['gain_db'] = gainDb;
    }

    /**
     * Constructs a <code>HighShelf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HighShelf1} obj Optional instance to populate.
     * @return {module:model/HighShelf1} The populated <code>HighShelf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HighShelf1();
    ...
    /**
     * Validates the JSON data with respect to <code>HighShelf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HighShelf1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HighShelf1.RequiredProperties) {
...
HighShelf1.RequiredProperties = ["gain_db"];

/**
 * @member {Number} gain_db
 */
HighShelf1.prototype['gain_db'] = undefined;
