...
/**
 * The DeleteAlarmsandTimersRequest model module.
 * @module model/DeleteAlarmsandTimersRequest
 * @version 2.0
 */
class DeleteAlarmsandTimersRequest {
    /**
     * Constructs a new <code>DeleteAlarmsandTimersRequest</code>.
     * @alias module:model/DeleteAlarmsandTimersRequest
     * @param ids {Array.<String>} 
     */
    constructor(ids) { 
        
        DeleteAlarmsandTimersRequest.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>DeleteAlarmsandTimersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAlarmsandTimersRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAlarmsandTimersRequest} The populated <code>DeleteAlarmsandTimersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAlarmsandTimersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAlarmsandTimersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAlarmsandTimersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAlarmsandTimersRequest.RequiredProperties) {
...
DeleteAlarmsandTimersRequest.RequiredProperties = ["ids"];

/**
 * @member {Array.<String>} ids
 */
DeleteAlarmsandTimersRequest.prototype['ids'] = undefined;
...
export default DeleteAlarmsandTimersRequest;
