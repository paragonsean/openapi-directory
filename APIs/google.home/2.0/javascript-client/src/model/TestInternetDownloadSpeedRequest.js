...
/**
 * The TestInternetDownloadSpeedRequest model module.
 * @module model/TestInternetDownloadSpeedRequest
 * @version 2.0
 */
class TestInternetDownloadSpeedRequest {
    /**
     * Constructs a new <code>TestInternetDownloadSpeedRequest</code>.
     * @alias module:model/TestInternetDownloadSpeedRequest
     * @param url {String} 
     */
    constructor(url) { 
        
        TestInternetDownloadSpeedRequest.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>TestInternetDownloadSpeedRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestInternetDownloadSpeedRequest} obj Optional instance to populate.
     * @return {module:model/TestInternetDownloadSpeedRequest} The populated <code>TestInternetDownloadSpeedRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestInternetDownloadSpeedRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TestInternetDownloadSpeedRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestInternetDownloadSpeedRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestInternetDownloadSpeedRequest.RequiredProperties) {
...
TestInternetDownloadSpeedRequest.RequiredProperties = ["url"];

/**
 * @member {String} url
 */
TestInternetDownloadSpeedRequest.prototype['url'] = undefined;
...
export default TestInternetDownloadSpeedRequest;
