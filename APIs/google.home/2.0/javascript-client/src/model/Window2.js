...
/**
 * The Window2 model module.
 * @module model/Window2
 * @version 2.0
 */
class Window2 {
    /**
     * Constructs a new <code>Window2</code>.
     * @alias module:model/Window2
     * @param days {Array.<Number>} 
     * @param lengthHours {Number} 
     * @param startHour {Number} 
     */
    constructor(days, lengthHours, startHour) { 
        
        Window2.initialize(this, days, lengthHours, startHour);
    }
     ...
     */
    static initialize(obj, days, lengthHours, startHour) { 
        obj['days'] = days;
        obj['length_hours'] = lengthHours;
        obj['start_hour'] = startHour;
    }

    /**
     * Constructs a <code>Window2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Window2} obj Optional instance to populate.
     * @return {module:model/Window2} The populated <code>Window2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('length_hours')) {
                obj['length_hours'] = ApiClient.convertToType(data['length_hours'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Window2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Window2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Window2.RequiredProperties) {
...
Window2.RequiredProperties = ["days", "length_hours", "start_hour"];

/**
 * @member {Array.<Number>} days
 */
Window2.prototype['days'] = undefined;

/**
 * @member {Number} length_hours
 */
Window2.prototype['length_hours'] = undefined;

/**
 * @member {Number} start_hour
 */
Window2.prototype['start_hour'] = undefined;
