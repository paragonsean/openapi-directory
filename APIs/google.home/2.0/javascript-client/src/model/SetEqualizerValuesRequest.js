...
/**
 * The SetEqualizerValuesRequest model module.
 * @module model/SetEqualizerValuesRequest
 * @version 2.0
 */
class SetEqualizerValuesRequest {
    /**
     * Constructs a new <code>SetEqualizerValuesRequest</code>.
     * @alias module:model/SetEqualizerValuesRequest
     * @param highShelf {module:model/HighShelf1} 
     * @param lowShelf {module:model/LowShelf1} 
     */
    constructor(highShelf, lowShelf) { 
        
        SetEqualizerValuesRequest.initialize(this, highShelf, lowShelf);
    }
     ...
     */
    static initialize(obj, highShelf, lowShelf) { 
        obj['high_shelf'] = highShelf;
        obj['low_shelf'] = lowShelf;
    }

    /**
     * Constructs a <code>SetEqualizerValuesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetEqualizerValuesRequest} obj Optional instance to populate.
     * @return {module:model/SetEqualizerValuesRequest} The populated <code>SetEqualizerValuesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetEqualizerValuesRequest();

            if (data.hasOwnProperty('high_shelf')) {
                obj['high_shelf'] = HighShelf1.constructFromObject(data['high_shelf']);
            }
            if (data.hasOwnProperty('low_shelf')) {
                obj['low_shelf'] = LowShelf1.constructFromObject(data['low_shelf']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetEqualizerValuesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetEqualizerValuesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetEqualizerValuesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `high_shelf`
        if (data['high_shelf']) { // data not null
          HighShelf1.validateJSON(data['high_shelf']);
        }
        // validate the optional field `low_shelf`
        if (data['low_shelf']) { // data not null
          LowShelf1.validateJSON(data['low_shelf']);
        }
...
SetEqualizerValuesRequest.RequiredProperties = ["high_shelf", "low_shelf"];

/**
 * @member {module:model/HighShelf1} high_shelf
 */
SetEqualizerValuesRequest.prototype['high_shelf'] = undefined;

/**
 * @member {module:model/LowShelf1} low_shelf
 */
SetEqualizerValuesRequest.prototype['low_shelf'] = undefined;
...
export default SetEqualizerValuesRequest;
