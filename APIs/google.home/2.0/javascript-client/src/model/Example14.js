...
/**
 * The Example14 model module.
 * @module model/Example14
 * @version 2.0
 */
class Example14 {
    /**
     * Constructs a new <code>Example14</code>.
     * @alias module:model/Example14
     * @param displayString {String} 
     * @param offset {Number} 
     * @param timezone {String} 
     */
    constructor(displayString, offset, timezone) { 
        
        Example14.initialize(this, displayString, offset, timezone);
    }
     ...
     */
    static initialize(obj, displayString, offset, timezone) { 
    ...
    /**
     * Constructs a <code>Example14</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example14} obj Optional instance to populate.
     * @return {module:model/Example14} The populated <code>Example14</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example14();
    ...
    /**
     * Validates the JSON data with respect to <code>Example14</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example14</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example14.RequiredProperties) {
...
Example14.RequiredProperties = ["display_string", "offset", "timezone"];

/**
 * @member {String} display_string
 */
Example14.prototype['display_string'] = undefined;

/**
 * @member {Number} offset
 */
Example14.prototype['offset'] = undefined;

/**
 * @member {String} timezone
 */
Example14.prototype['timezone'] = undefined;
