...
/**
 * The AppDeviceIDRequest model module.
 * @module model/AppDeviceIDRequest
 * @version 2.0
 */
class AppDeviceIDRequest {
    /**
     * Constructs a new <code>AppDeviceIDRequest</code>.
     * @alias module:model/AppDeviceIDRequest
     * @param appId {String} 
     */
    constructor(appId) { 
        
        AppDeviceIDRequest.initialize(this, appId);
    }
    ...
    /**
     * Constructs a <code>AppDeviceIDRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppDeviceIDRequest} obj Optional instance to populate.
     * @return {module:model/AppDeviceIDRequest} The populated <code>AppDeviceIDRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppDeviceIDRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AppDeviceIDRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppDeviceIDRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AppDeviceIDRequest.RequiredProperties) {
...
AppDeviceIDRequest.RequiredProperties = ["app_id"];

/**
 * @member {String} app_id
 */
AppDeviceIDRequest.prototype['app_id'] = undefined;
...
export default AppDeviceIDRequest;
