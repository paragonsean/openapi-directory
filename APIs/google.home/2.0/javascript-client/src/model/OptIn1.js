...
/**
 * The OptIn1 model module.
 * @module model/OptIn1
 * @version 2.0
 */
class OptIn1 {
    /**
     * Constructs a new <code>OptIn1</code>.
     * @alias module:model/OptIn1
     * @param opencast {Boolean} 
     * @param previewChannel {Boolean} 
     * @param remoteDucking {Boolean} 
     * @param stats {Boolean} 
     */
    constructor(opencast, previewChannel, remoteDucking, stats) { 
        
        OptIn1.initialize(this, opencast, previewChannel, remoteDucking, stats);
    }
     ...
     */
    static initialize(obj, opencast, previewChannel, remoteDucking, stats) { 
    ...
    /**
     * Constructs a <code>OptIn1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptIn1} obj Optional instance to populate.
     * @return {module:model/OptIn1} The populated <code>OptIn1</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>OptIn1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptIn1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OptIn1.RequiredProperties) {
...
OptIn1.RequiredProperties = ["opencast", "preview_channel", "remote_ducking", "stats"];

/**
 * @member {Boolean} opencast
 */
OptIn1.prototype['opencast'] = undefined;

/**
 * @member {Boolean} preview_channel
 */
OptIn1.prototype['preview_channel'] = undefined;

/**
 * @member {Boolean} remote_ducking
 */
OptIn1.prototype['remote_ducking'] = undefined;

/**
 * @member {Boolean} stats
 */
OptIn1.prototype['stats'] = undefined;
