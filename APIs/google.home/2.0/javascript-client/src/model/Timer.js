...
class Timer {
     ...
     * @param id {String} 
     * @param originalDuration {Number} 
     * @param status {Number} 
     */
    constructor(fireTime, id, originalDuration, status) { 
        
        Timer.initialize(this, fireTime, id, originalDuration, status);
    }
     ...
     */
    static initialize(obj, fireTime, id, originalDuration, status) { 
        obj['fire_time'] = fireTime;
        obj['id'] = id;
        obj['original_duration'] = originalDuration;
        obj['status'] = status;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('original_duration')) {
                obj['original_duration'] = ApiClient.convertToType(data['original_duration'], 'Number');
            }
...
Timer.RequiredProperties = ["fire_time", "id", "original_duration", "status"];

/**
 * @member {Number} fire_time
 */
Timer.prototype['fire_time'] = undefined;

/**
 * @member {String} id
 */
Timer.prototype['id'] = undefined;

/**
 * @member {Number} original_duration
 */
Timer.prototype['original_duration'] = undefined;

/**
 * @member {Number} status
 */
Timer.prototype['status'] = undefined;
