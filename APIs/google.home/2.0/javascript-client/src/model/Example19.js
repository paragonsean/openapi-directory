...
/**
 * The Example19 model module.
 * @module model/Example19
 * @version 2.0
 */
class Example19 {
    /**
     * Constructs a new <code>Example19</code>.
     * @alias module:model/Example19
     * @param success {Boolean} 
     */
    constructor(success) { 
        
        Example19.initialize(this, success);
    }
    ...
    /**
     * Constructs a <code>Example19</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example19} obj Optional instance to populate.
     * @return {module:model/Example19} The populated <code>Example19</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example19();
    ...
    /**
     * Validates the JSON data with respect to <code>Example19</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example19</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example19.RequiredProperties) {
...
Example19.RequiredProperties = ["success"];

/**
 * @member {Boolean} success
 */
Example19.prototype['success'] = undefined;
