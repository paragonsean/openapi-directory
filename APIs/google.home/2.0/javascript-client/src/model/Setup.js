...
class Setup {
     ...
     * @param qrSsidSuffix {String} 
     * @param setupState {Number} 
     * @param ssidSuffix {String} 
     * @param stats {module:model/Stats} 
     * @param tosAccepted {Boolean} 
     */
    constructor(qrSsidSuffix, setupState, ssidSuffix, stats, tosAccepted) { 
        
        Setup.initialize(this, qrSsidSuffix, setupState, ssidSuffix, stats, tosAccepted);
    }
     ...
     */
    static initialize(obj, qrSsidSuffix, setupState, ssidSuffix, stats, tosAccepted) { 
        obj['qr_ssid_suffix'] = qrSsidSuffix;
        obj['setup_state'] = setupState;
        obj['ssid_suffix'] = ssidSuffix;
        obj['stats'] = stats;
        obj['tos_accepted'] = tosAccepted;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('qr_ssid_suffix')) {
                obj['qr_ssid_suffix'] = ApiClient.convertToType(data['qr_ssid_suffix'], 'String');
            }
            if (data.hasOwnProperty('setup_state')) {
                obj['setup_state'] = ApiClient.convertToType(data['setup_state'], 'Number');
            }
            if (data.hasOwnProperty('ssid_suffix')) {
                obj['ssid_suffix'] = ApiClient.convertToType(data['ssid_suffix'], 'String');
            }
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = Stats.constructFromObject(data['stats']);
            }
            if (data.hasOwnProperty('tos_accepted')) {
                obj['tos_accepted'] = ApiClient.convertToType(data['tos_accepted'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Setup.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['qr_ssid_suffix'] && !(typeof data['qr_ssid_suffix'] === 'string' || data['qr_ssid_suffix'] instanceof String)) {
            throw new Error("Expected the field `qr_ssid_suffix` to be a primitive type in the JSON string but got " + data['qr_ssid_suffix']);
        }
        // ensure the json data is a string
        if (data['ssid_suffix'] && !(typeof data['ssid_suffix'] === 'string' || data['ssid_suffix'] instanceof String)) {
            throw new Error("Expected the field `ssid_suffix` to be a primitive type in the JSON string but got " + data['ssid_suffix']);
        }
...
Setup.RequiredProperties = ["qr_ssid_suffix", "setup_state", "ssid_suffix", "stats", "tos_accepted"];

/**
 * @member {String} qr_ssid_suffix
 */
Setup.prototype['qr_ssid_suffix'] = undefined;

/**
 * @member {Number} setup_state
 */
Setup.prototype['setup_state'] = undefined;

/**
 * @member {String} ssid_suffix
 */
Setup.prototype['ssid_suffix'] = undefined;

/**
 * @member {module:model/Stats} stats
 */
Setup.prototype['stats'] = undefined;

/**
 * @member {Boolean} tos_accepted
 */
Setup.prototype['tos_accepted'] = undefined;
