...
/**
 * The Example11 model module.
 * @module model/Example11
 * @version 2.0
 */
class Example11 {
    /**
     * Constructs a new <code>Example11</code>.
     * @alias module:model/Example11
     * @param appDeviceId {String} 
     * @param certificate {String} 
     * @param signedData {String} 
     */
    constructor(appDeviceId, certificate, signedData) { 
        
        Example11.initialize(this, appDeviceId, certificate, signedData);
    }
     ...
     */
    static initialize(obj, appDeviceId, certificate, signedData) { 
        obj['app_device_id'] = appDeviceId;
        obj['certificate'] = certificate;
        obj['signed_data'] = signedData;
    }

    /**
     * Constructs a <code>Example11</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example11} obj Optional instance to populate.
     * @return {module:model/Example11} The populated <code>Example11</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example11();

            if (data.hasOwnProperty('app_device_id')) {
                obj['app_device_id'] = ApiClient.convertToType(data['app_device_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Example11</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example11</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example11.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['app_device_id'] && !(typeof data['app_device_id'] === 'string' || data['app_device_id'] instanceof String)) {
            throw new Error("Expected the field `app_device_id` to be a primitive type in the JSON string but got " + data['app_device_id']);
        }
        // ensure the json data is a string
...
Example11.RequiredProperties = ["app_device_id", "certificate", "signed_data"];

/**
 * @member {String} app_device_id
 */
Example11.prototype['app_device_id'] = undefined;

/**
 * @member {String} certificate
 */
Example11.prototype['certificate'] = undefined;

/**
 * @member {String} signed_data
 */
Example11.prototype['signed_data'] = undefined;
