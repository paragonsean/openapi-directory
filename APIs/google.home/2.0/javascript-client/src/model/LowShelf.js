...
/**
 * The LowShelf model module.
 * @module model/LowShelf
 * @version 2.0
 */
class LowShelf {
    /**
     * Constructs a new <code>LowShelf</code>.
     * @alias module:model/LowShelf
     * @param frequency {Number} 
     * @param gainDb {Number} 
     * @param quality {Number} 
     */
    constructor(frequency, gainDb, quality) { 
        
        LowShelf.initialize(this, frequency, gainDb, quality);
    }
     ...
     */
    static initialize(obj, frequency, gainDb, quality) { 
    ...
    /**
     * Constructs a <code>LowShelf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LowShelf} obj Optional instance to populate.
     * @return {module:model/LowShelf} The populated <code>LowShelf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LowShelf();

            if (data.hasOwnProperty('frequency')) {
                obj['frequency'] = ApiClient.convertToType(data['frequency'], 'Number');
            }
            if (data.hasOwnProperty('gain_db')) {
                obj['gain_db'] = ApiClient.convertToType(data['gain_db'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LowShelf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LowShelf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LowShelf.RequiredProperties) {
...
LowShelf.RequiredProperties = ["frequency", "gain_db", "quality"];

/**
 * @member {Number} frequency
 */
LowShelf.prototype['frequency'] = undefined;

/**
 * @member {Number} gain_db
 */
LowShelf.prototype['gain_db'] = undefined;

/**
 * @member {Number} quality
 */
LowShelf.prototype['quality'] = undefined;
