...
/**
 * The HighShelf model module.
 * @module model/HighShelf
 * @version 2.0
 */
class HighShelf {
    /**
     * Constructs a new <code>HighShelf</code>.
     * @alias module:model/HighShelf
    ...
    constructor(frequency, gainDb, quality) { 
        ...
        HighShelf.initialize(this, frequency, gainDb, quality);
    }
    ...
    /**
     * Constructs a <code>HighShelf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HighShelf} obj Optional instance to populate.
     * @return {module:model/HighShelf} The populated <code>HighShelf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HighShelf();
    ...
    /**
     * Validates the JSON data with respect to <code>HighShelf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HighShelf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HighShelf.RequiredProperties) {
...
HighShelf.RequiredProperties = ["frequency", "gain_db", "quality"];

/**
 * @member {Number} frequency
 */
HighShelf.prototype['frequency'] = undefined;

/**
 * @member {Number} gain_db
 */
HighShelf.prototype['gain_db'] = undefined;

/**
 * @member {Number} quality
 */
HighShelf.prototype['quality'] = undefined;
