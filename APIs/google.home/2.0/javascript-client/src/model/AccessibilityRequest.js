...
/**
 * The AccessibilityRequest model module.
 * @module model/AccessibilityRequest
 * @version 2.0
 */
class AccessibilityRequest {
    /**
     * Constructs a new <code>AccessibilityRequest</code>.
     * @alias module:model/AccessibilityRequest
     * @param endpointEnabled {Boolean} 
     * @param hotwordEnabled {Boolean} 
     */
    constructor(endpointEnabled, hotwordEnabled) { 
        
        AccessibilityRequest.initialize(this, endpointEnabled, hotwordEnabled);
    }
     ...
     */
    static initialize(obj, endpointEnabled, hotwordEnabled) { 
        obj['endpoint_enabled'] = endpointEnabled;
        obj['hotword_enabled'] = hotwordEnabled;
    }

    /**
     * Constructs a <code>AccessibilityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessibilityRequest} obj Optional instance to populate.
     * @return {module:model/AccessibilityRequest} The populated <code>AccessibilityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessibilityRequest();

            if (data.hasOwnProperty('endpoint_enabled')) {
                obj['endpoint_enabled'] = ApiClient.convertToType(data['endpoint_enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('hotword_enabled')) {
                obj['hotword_enabled'] = ApiClient.convertToType(data['hotword_enabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccessibilityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessibilityRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccessibilityRequest.RequiredProperties) {
...
AccessibilityRequest.RequiredProperties = ["endpoint_enabled", "hotword_enabled"];

/**
 * @member {Boolean} endpoint_enabled
 */
AccessibilityRequest.prototype['endpoint_enabled'] = undefined;

/**
 * @member {Boolean} hotword_enabled
 */
AccessibilityRequest.prototype['hotword_enabled'] = undefined;
...
export default AccessibilityRequest;
