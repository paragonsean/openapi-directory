...
/**
 * The ScanfordevicesRequest model module.
 * @module model/ScanfordevicesRequest
 * @version 2.0
 */
class ScanfordevicesRequest {
    /**
     * Constructs a new <code>ScanfordevicesRequest</code>.
     * @alias module:model/ScanfordevicesRequest
     * @param clearResults {Boolean} 
     * @param enable {Boolean} 
     * @param timeout {Number} 
     */
    constructor(clearResults, enable, timeout) { 
        
        ScanfordevicesRequest.initialize(this, clearResults, enable, timeout);
    }
     ...
     */
    static initialize(obj, clearResults, enable, timeout) { 
        obj['clear_results'] = clearResults;
        obj['enable'] = enable;
        obj['timeout'] = timeout;
    }

    /**
     * Constructs a <code>ScanfordevicesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScanfordevicesRequest} obj Optional instance to populate.
     * @return {module:model/ScanfordevicesRequest} The populated <code>ScanfordevicesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScanfordevicesRequest();

            if (data.hasOwnProperty('clear_results')) {
                obj['clear_results'] = ApiClient.convertToType(data['clear_results'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScanfordevicesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScanfordevicesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScanfordevicesRequest.RequiredProperties) {
...
ScanfordevicesRequest.RequiredProperties = ["clear_results", "enable", "timeout"];

/**
 * @member {Boolean} clear_results
 */
ScanfordevicesRequest.prototype['clear_results'] = undefined;

/**
 * @member {Boolean} enable
 */
ScanfordevicesRequest.prototype['enable'] = undefined;

/**
 * @member {Number} timeout
 */
ScanfordevicesRequest.prototype['timeout'] = undefined;
...
export default ScanfordevicesRequest;
