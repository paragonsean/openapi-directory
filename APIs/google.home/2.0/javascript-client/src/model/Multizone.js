...
/**
 * The Multizone model module.
 * @module model/Multizone
 * @version 2.0
 */
class Multizone {
    /**
     * Constructs a new <code>Multizone</code>.
     * @alias module:model/Multizone
     * @param audioOutputDelay {Number} 
     * @param audioOutputDelayHdmi {Number} 
     * @param audioOutputDelayOem {Number} 
     * @param auxInGroup {String} 
     * @param dynamicGroups {Array.<String>} 
     * @param groups {Array.<String>} 
     * @param multichannelStatus {Number} 
     */
    constructor(audioOutputDelay, audioOutputDelayHdmi, audioOutputDelayOem, auxInGroup, dynamicGroups, groups, multichannelStatus) { 
        
        Multizone.initialize(this, audioOutputDelay, audioOutputDelayHdmi, audioOutputDelayOem, auxInGroup, dynamicGroups, groups, multichannelStatus);
    }
     ...
     */
    static initialize(obj, audioOutputDelay, audioOutputDelayHdmi, audioOutputDelayOem, auxInGroup, dynamicGroups, groups, multichannelStatus) { 
        obj['audio_output_delay'] = audioOutputDelay;
        obj['audio_output_delay_hdmi'] = audioOutputDelayHdmi;
        obj['audio_output_delay_oem'] = audioOutputDelayOem;
        obj['aux_in_group'] = auxInGroup;
        obj['dynamic_groups'] = dynamicGroups;
        obj['groups'] = groups;
        obj['multichannel_status'] = multichannelStatus;
    }

    /**
     * Constructs a <code>Multizone</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Multizone} obj Optional instance to populate.
     * @return {module:model/Multizone} The populated <code>Multizone</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Multizone();

            if (data.hasOwnProperty('audio_output_delay')) {
                obj['audio_output_delay'] = ApiClient.convertToType(data['audio_output_delay'], 'Number');
            }
            if (data.hasOwnProperty('audio_output_delay_hdmi')) {
                obj['audio_output_delay_hdmi'] = ApiClient.convertToType(data['audio_output_delay_hdmi'], 'Number');
            }
            if (data.hasOwnProperty('audio_output_delay_oem')) {
                obj['audio_output_delay_oem'] = ApiClient.convertToType(data['audio_output_delay_oem'], 'Number');
            }
            if (data.hasOwnProperty('aux_in_group')) {
                obj['aux_in_group'] = ApiClient.convertToType(data['aux_in_group'], 'String');
            }
            if (data.hasOwnProperty('dynamic_groups')) {
                obj['dynamic_groups'] = ApiClient.convertToType(data['dynamic_groups'], ['String']);
            }
            if (data.hasOwnProperty('groups')) {
                obj['groups'] = ApiClient.convertToType(data['groups'], ['String']);
            }
            if (data.hasOwnProperty('multichannel_status')) {
                obj['multichannel_status'] = ApiClient.convertToType(data['multichannel_status'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Multizone</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Multizone</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Multizone.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['aux_in_group'] && !(typeof data['aux_in_group'] === 'string' || data['aux_in_group'] instanceof String)) {
            throw new Error("Expected the field `aux_in_group` to be a primitive type in the JSON string but got " + data['aux_in_group']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['dynamic_groups'])) {
            throw new Error("Expected the field `dynamic_groups` to be an array in the JSON data but got " + data['dynamic_groups']);
        }
        // ensure the json data is an array
...
Multizone.RequiredProperties = ["audio_output_delay", "audio_output_delay_hdmi", "audio_output_delay_oem", "aux_in_group", "dynamic_groups", "groups", "multichannel_status"];

/**
 * @member {Number} audio_output_delay
 */
Multizone.prototype['audio_output_delay'] = undefined;

/**
 * @member {Number} audio_output_delay_hdmi
 */
Multizone.prototype['audio_output_delay_hdmi'] = undefined;

/**
 * @member {Number} audio_output_delay_oem
 */
Multizone.prototype['audio_output_delay_oem'] = undefined;

/**
 * @member {String} aux_in_group
 */
Multizone.prototype['aux_in_group'] = undefined;

/**
 * @member {Array.<String>} dynamic_groups
 */
Multizone.prototype['dynamic_groups'] = undefined;

/**
 * @member {Array.<String>} groups
 */
Multizone.prototype['groups'] = undefined;

/**
 * @member {Number} multichannel_status
 */
Multizone.prototype['multichannel_status'] = undefined;
