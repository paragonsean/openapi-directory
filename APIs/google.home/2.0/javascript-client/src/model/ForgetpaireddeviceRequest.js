...
/**
 * The ForgetpaireddeviceRequest model module.
 * @module model/ForgetpaireddeviceRequest
 * @version 2.0
 */
class ForgetpaireddeviceRequest {
    /**
     * Constructs a new <code>ForgetpaireddeviceRequest</code>.
     * @alias module:model/ForgetpaireddeviceRequest
     * @param bond {Boolean} 
     * @param macAddress {String} 
     */
    constructor(bond, macAddress) { 
        
        ForgetpaireddeviceRequest.initialize(this, bond, macAddress);
    }
     ...
     */
    static initialize(obj, bond, macAddress) { 
        obj['bond'] = bond;
        obj['mac_address'] = macAddress;
    }

    /**
     * Constructs a <code>ForgetpaireddeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForgetpaireddeviceRequest} obj Optional instance to populate.
     * @return {module:model/ForgetpaireddeviceRequest} The populated <code>ForgetpaireddeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForgetpaireddeviceRequest();

            if (data.hasOwnProperty('bond')) {
                obj['bond'] = ApiClient.convertToType(data['bond'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ForgetpaireddeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForgetpaireddeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ForgetpaireddeviceRequest.RequiredProperties) {
...
ForgetpaireddeviceRequest.RequiredProperties = ["bond", "mac_address"];

/**
 * @member {Boolean} bond
 */
ForgetpaireddeviceRequest.prototype['bond'] = undefined;

/**
 * @member {String} mac_address
 */
ForgetpaireddeviceRequest.prototype['mac_address'] = undefined;
...
export default ForgetpaireddeviceRequest;
