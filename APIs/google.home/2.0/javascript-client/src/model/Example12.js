...
/**
 * The Example12 model module.
 * @module model/Example12
 * @version 2.0
 */
class Example12 {
    /**
     * Constructs a new <code>Example12</code>.
     * @alias module:model/Example12
     * @param token {String} 
     */
    constructor(token) { 
        
        Example12.initialize(this, token);
    }
    ...
    /**
     * Constructs a <code>Example12</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example12} obj Optional instance to populate.
     * @return {module:model/Example12} The populated <code>Example12</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example12();
    ...
    /**
     * Validates the JSON data with respect to <code>Example12</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example12</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example12.RequiredProperties) {
...
Example12.RequiredProperties = ["token"];

/**
 * @member {String} token
 */
Example12.prototype['token'] = undefined;
