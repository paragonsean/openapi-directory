...
/**
 * The TimePattern model module.
 * @module model/TimePattern
 * @version 2.0
 */
class TimePattern {
    /**
     * Constructs a new <code>TimePattern</code>.
     * @alias module:model/TimePattern
     * @param hour {Number} 
     * @param minute {Number} 
     * @param second {Number} 
     */
    constructor(hour, minute, second) { 
        ...
        TimePattern.initialize(this, hour, minute, second);
    }
    ...
    /**
     * Constructs a <code>TimePattern</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimePattern} obj Optional instance to populate.
     * @return {module:model/TimePattern} The populated <code>TimePattern</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimePattern();
    ...
    /**
     * Validates the JSON data with respect to <code>TimePattern</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimePattern</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TimePattern.RequiredProperties) {
...
TimePattern.RequiredProperties = ["hour", "minute", "second"];

/**
 * @member {Number} hour
 */
TimePattern.prototype['hour'] = undefined;

/**
 * @member {Number} minute
 */
TimePattern.prototype['minute'] = undefined;

/**
 * @member {Number} second
 */
TimePattern.prototype['second'] = undefined;
