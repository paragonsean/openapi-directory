...
/**
 * The ConnectedDevice model module.
 * @module model/ConnectedDevice
 * @version 2.0
 */
class ConnectedDevice {
    /**
     * Constructs a new <code>ConnectedDevice</code>.
     * @alias module:model/ConnectedDevice
     * @param device {module:model/Device} 
     * @param enabledProfiles {Number} 
     */
    constructor(device, enabledProfiles) { 
        
        ConnectedDevice.initialize(this, device, enabledProfiles);
    }
     ...
     */
    static initialize(obj, device, enabledProfiles) { 
        obj['device'] = device;
        obj['enabled_profiles'] = enabledProfiles;
    }

    /**
     * Constructs a <code>ConnectedDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectedDevice} obj Optional instance to populate.
     * @return {module:model/ConnectedDevice} The populated <code>ConnectedDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectedDevice();

            if (data.hasOwnProperty('device')) {
                obj['device'] = Device.constructFromObject(data['device']);
            }
            if (data.hasOwnProperty('enabled_profiles')) {
                obj['enabled_profiles'] = ApiClient.convertToType(data['enabled_profiles'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectedDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectedDevice</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectedDevice.RequiredProperties) {
...
ConnectedDevice.RequiredProperties = ["device", "enabled_profiles"];

/**
 * @member {module:model/Device} device
 */
ConnectedDevice.prototype['device'] = undefined;

/**
 * @member {Number} enabled_profiles
 */
ConnectedDevice.prototype['enabled_profiles'] = undefined;
