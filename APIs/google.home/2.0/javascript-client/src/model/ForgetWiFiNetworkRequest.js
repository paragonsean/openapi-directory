...
/**
 * The ForgetWiFiNetworkRequest model module.
 * @module model/ForgetWiFiNetworkRequest
 * @version 2.0
 */
class ForgetWiFiNetworkRequest {
    /**
     * Constructs a new <code>ForgetWiFiNetworkRequest</code>.
     * @alias module:model/ForgetWiFiNetworkRequest
     * @param wpaId {Number} 
     */
    constructor(wpaId) { 
        
        ForgetWiFiNetworkRequest.initialize(this, wpaId);
    }
     ...
     */
    static initialize(obj, wpaId) { 
        obj['wpa_id'] = wpaId;
    }

    /**
     * Constructs a <code>ForgetWiFiNetworkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForgetWiFiNetworkRequest} obj Optional instance to populate.
     * @return {module:model/ForgetWiFiNetworkRequest} The populated <code>ForgetWiFiNetworkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForgetWiFiNetworkRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ForgetWiFiNetworkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForgetWiFiNetworkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ForgetWiFiNetworkRequest.RequiredProperties) {
...
ForgetWiFiNetworkRequest.RequiredProperties = ["wpa_id"];

/**
 * @member {Number} wpa_id
 */
ForgetWiFiNetworkRequest.prototype['wpa_id'] = undefined;
...
export default ForgetWiFiNetworkRequest;
