...
/**
 * The Getcurrentvalues model module.
 * @module model/Getcurrentvalues
 * @version 2.0
 */
class Getcurrentvalues {
    /**
     * Constructs a new <code>Getcurrentvalues</code>.
     * @alias module:model/Getcurrentvalues
     * @param endpointEnabled {Boolean} 
     * @param hotwordEnabled {Boolean} 
     */
    constructor(endpointEnabled, hotwordEnabled) { 
        
        Getcurrentvalues.initialize(this, endpointEnabled, hotwordEnabled);
    }
    ...
    /**
     * Constructs a <code>Getcurrentvalues</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Getcurrentvalues} obj Optional instance to populate.
     * @return {module:model/Getcurrentvalues} The populated <code>Getcurrentvalues</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Getcurrentvalues();
    ...
    /**
     * Validates the JSON data with respect to <code>Getcurrentvalues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Getcurrentvalues</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Getcurrentvalues.RequiredProperties) {
...
Getcurrentvalues.RequiredProperties = ["endpoint_enabled", "hotword_enabled"];

/**
 * @member {Boolean} endpoint_enabled
 */
Getcurrentvalues.prototype['endpoint_enabled'] = undefined;

/**
 * @member {Boolean} hotword_enabled
 */
Getcurrentvalues.prototype['hotword_enabled'] = undefined;
