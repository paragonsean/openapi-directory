...
/**
 * The Example16 model module.
 * @module model/Example16
 * @version 2.0
 */
class Example16 {
    /**
     * Constructs a new <code>Example16</code>.
     * @alias module:model/Example16
     * @param bytesReceived {Number} 
     * @param responseCode {Number} 
     * @param timeForDataFetch {Number} 
     * @param timeForHttpResponse {Number} 
     */
    constructor(bytesReceived, responseCode, timeForDataFetch, timeForHttpResponse) { 
        
        Example16.initialize(this, bytesReceived, responseCode, timeForDataFetch, timeForHttpResponse);
    }
     ...
     */
    static initialize(obj, bytesReceived, responseCode, timeForDataFetch, timeForHttpResponse) { 
        obj['bytes_received'] = bytesReceived;
        obj['response_code'] = responseCode;
        obj['time_for_data_fetch'] = timeForDataFetch;
        obj['time_for_http_response'] = timeForHttpResponse;
    }

    /**
     * Constructs a <code>Example16</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Example16} obj Optional instance to populate.
     * @return {module:model/Example16} The populated <code>Example16</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Example16();
            ...
            if (data.hasOwnProperty('time_for_data_fetch')) {
                obj['time_for_data_fetch'] = ApiClient.convertToType(data['time_for_data_fetch'], 'Number');
            }
            if (data.hasOwnProperty('time_for_http_response')) {
                obj['time_for_http_response'] = ApiClient.convertToType(data['time_for_http_response'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Example16</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Example16</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Example16.RequiredProperties) {
...
Example16.RequiredProperties = ["bytes_received", "response_code", "time_for_data_fetch", "time_for_http_response"];

/**
 * @member {Number} bytes_received
 */
Example16.prototype['bytes_received'] = undefined;

/**
 * @member {Number} response_code
 */
Example16.prototype['response_code'] = undefined;

/**
 * @member {Number} time_for_data_fetch
 */
Example16.prototype['time_for_data_fetch'] = undefined;

/**
 * @member {Number} time_for_http_response
 */
Example16.prototype['time_for_http_response'] = undefined;
