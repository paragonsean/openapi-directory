...
/**
 * The NightModeParams model module.
 * @module model/NightModeParams
 * @version 2.0
 */
class NightModeParams {
    /**
     * Constructs a new <code>NightModeParams</code>.
     * @alias module:model/NightModeParams
     * @param deviceOverrideDoNotDisturb {Number} 
     * @param doNotDisturb {Boolean} 
     * @param enabled {Boolean} 
     * @param ledBrightness {Number} 
     * @param volume {Number} 
     * @param windows {Array.<module:model/Window>} 
     */
    constructor(deviceOverrideDoNotDisturb, doNotDisturb, enabled, ledBrightness, volume, windows) { 
        
        NightModeParams.initialize(this, deviceOverrideDoNotDisturb, doNotDisturb, enabled, ledBrightness, volume, windows);
    }
     ...
     */
    static initialize(obj, deviceOverrideDoNotDisturb, doNotDisturb, enabled, ledBrightness, volume, windows) { 
        obj['device_override_do_not_disturb'] = deviceOverrideDoNotDisturb;
    ...
    /**
     * Constructs a <code>NightModeParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NightModeParams} obj Optional instance to populate.
     * @return {module:model/NightModeParams} The populated <code>NightModeParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NightModeParams();

            if (data.hasOwnProperty('device_override_do_not_disturb')) {
                obj['device_override_do_not_disturb'] = ApiClient.convertToType(data['device_override_do_not_disturb'], 'Number');
            }
            ...
            if (data.hasOwnProperty('windows')) {
                obj['windows'] = ApiClient.convertToType(data['windows'], [Window]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NightModeParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NightModeParams</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NightModeParams.RequiredProperties) {
...
NightModeParams.RequiredProperties = ["device_override_do_not_disturb", "do_not_disturb", "enabled", "led_brightness", "volume", "windows"];

/**
 * @member {Number} device_override_do_not_disturb
 */
NightModeParams.prototype['device_override_do_not_disturb'] = undefined;

/**
 * @member {Boolean} do_not_disturb
 */
NightModeParams.prototype['do_not_disturb'] = undefined;

/**
 * @member {Boolean} enabled
 */
NightModeParams.prototype['enabled'] = undefined;

/**
 * @member {Number} led_brightness
 */
NightModeParams.prototype['led_brightness'] = undefined;

/**
 * @member {Number} volume
 */
NightModeParams.prototype['volume'] = undefined;

/**
 * @member {Array.<module:model/Window>} windows
 */
NightModeParams.prototype['windows'] = undefined;
...
export default NightModeParams;
