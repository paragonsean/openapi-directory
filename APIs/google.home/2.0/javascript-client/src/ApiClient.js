...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://example.com/setup') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://example.com/setup
         */
        ...
        this.authentications = {
            'cast-local-authorization-token': {type: 'apiKey', 'in': 'header', name: 'cast-local-authorization-token'}
        }
