...
/**
* StaticFiles service.
* @module api/StaticFilesApi
* @version 2.0
*/
export default class StaticFilesApi {

    /**
    * Constructs a new StaticFilesApi. 
    * @alias module:api/StaticFilesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the chromecastIcon operation.
     * @callback module:api/StaticFilesApi~chromecastIconCallback
     ...
     * @param {module:api/StaticFilesApi~chromecastIconCallback} callback The callback function, accepting three arguments: error, data, response
     */
    chromecastIcon(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the legalNotice operation.
     * @callback module:api/StaticFilesApi~legalNoticeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StaticFilesApi~legalNoticeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    legalNotice(callback) {
      let postBody = null;
