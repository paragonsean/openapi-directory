...
#ifndef OAILowShelf_H
#define OAILowShelf_H
...
class OAILowShelf : public OAIObject {
public:
    OAILowShelf();
    OAILowShelf(QString json);
    ~OAILowShelf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILowShelf)
