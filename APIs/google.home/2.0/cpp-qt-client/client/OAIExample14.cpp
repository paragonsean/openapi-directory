...
OAIExample14::OAIExample14(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample14::OAIExample14() {
    this->initializeModel();
}

OAIExample14::~OAIExample14() {}

void OAIExample14::initializeModel() {
...
void OAIExample14::fromJson(QString jsonString) {
...
void OAIExample14::fromJsonObject(QJsonObject json) {
...
QString OAIExample14::asJson() const {
...
QJsonObject OAIExample14::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExample14::getDisplayString() const {
    return m_display_string;
}
void OAIExample14::setDisplayString(const QString &display_string) {
    m_display_string = display_string;
    m_display_string_isSet = true;
}

bool OAIExample14::is_display_string_Set() const{
    return m_display_string_isSet;
}

bool OAIExample14::is_display_string_Valid() const{
    return m_display_string_isValid;
}

qint32 OAIExample14::getOffset() const {
    return m_offset;
}
void OAIExample14::setOffset(const qint32 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIExample14::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIExample14::is_offset_Valid() const{
    return m_offset_isValid;
}

QString OAIExample14::getTimezone() const {
    return m_timezone;
}
void OAIExample14::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIExample14::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIExample14::is_timezone_Valid() const{
    return m_timezone_isValid;
}

bool OAIExample14::isSet() const {
...
bool OAIExample14::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_display_string_isValid && m_offset_isValid && m_timezone_isValid && true;
}
