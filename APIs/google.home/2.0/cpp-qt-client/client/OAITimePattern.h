...
#ifndef OAITimePattern_H
#define OAITimePattern_H
...
class OAITimePattern : public OAIObject {
public:
    OAITimePattern();
    OAITimePattern(QString json);
    ~OAITimePattern() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimePattern)

#endif // OAITimePattern_H
