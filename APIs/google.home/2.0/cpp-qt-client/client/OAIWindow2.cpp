...
OAIWindow2::OAIWindow2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWindow2::OAIWindow2() {
    this->initializeModel();
}

OAIWindow2::~OAIWindow2() {}

void OAIWindow2::initializeModel() {
...
void OAIWindow2::fromJson(QString jsonString) {
...
void OAIWindow2::fromJsonObject(QJsonObject json) {
...
QString OAIWindow2::asJson() const {
...
QJsonObject OAIWindow2::asJsonObject() const {
    QJsonObject obj;
    if (m_days.size() > 0) {
...
QList<qint32> OAIWindow2::getDays() const {
    return m_days;
}
void OAIWindow2::setDays(const QList<qint32> &days) {
    m_days = days;
    m_days_isSet = true;
}

bool OAIWindow2::is_days_Set() const{
    return m_days_isSet;
}

bool OAIWindow2::is_days_Valid() const{
    return m_days_isValid;
}

double OAIWindow2::getLengthHours() const {
    return m_length_hours;
}
void OAIWindow2::setLengthHours(const double &length_hours) {
    m_length_hours = length_hours;
    m_length_hours_isSet = true;
}

bool OAIWindow2::is_length_hours_Set() const{
    return m_length_hours_isSet;
}

bool OAIWindow2::is_length_hours_Valid() const{
    return m_length_hours_isValid;
}

double OAIWindow2::getStartHour() const {
    return m_start_hour;
}
void OAIWindow2::setStartHour(const double &start_hour) {
    m_start_hour = start_hour;
    m_start_hour_isSet = true;
}

bool OAIWindow2::is_start_hour_Set() const{
    return m_start_hour_isSet;
}

bool OAIWindow2::is_start_hour_Valid() const{
    return m_start_hour_isValid;
}

bool OAIWindow2::isSet() const {
