...
OAIRebootandFactoryResetRequest::OAIRebootandFactoryResetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRebootandFactoryResetRequest::OAIRebootandFactoryResetRequest() {
    this->initializeModel();
}

OAIRebootandFactoryResetRequest::~OAIRebootandFactoryResetRequest() {}

void OAIRebootandFactoryResetRequest::initializeModel() {

    m_params_isSet = false;
    m_params_isValid = false;
}

void OAIRebootandFactoryResetRequest::fromJson(QString jsonString) {
...
void OAIRebootandFactoryResetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRebootandFactoryResetRequest::asJson() const {
...
QJsonObject OAIRebootandFactoryResetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_params_isSet) {
...
QString OAIRebootandFactoryResetRequest::getParams() const {
    return m_params;
}
void OAIRebootandFactoryResetRequest::setParams(const QString &params) {
    m_params = params;
    m_params_isSet = true;
}

bool OAIRebootandFactoryResetRequest::is_params_Set() const{
    return m_params_isSet;
}

bool OAIRebootandFactoryResetRequest::is_params_Valid() const{
    return m_params_isValid;
}

bool OAIRebootandFactoryResetRequest::isSet() const {
...
bool OAIRebootandFactoryResetRequest::isValid() const {
