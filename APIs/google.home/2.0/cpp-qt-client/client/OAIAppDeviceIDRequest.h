...
/*
 * OAIAppDeviceIDRequest.h
 *
 * 
 */

#ifndef OAIAppDeviceIDRequest_H
#define OAIAppDeviceIDRequest_H
...
class OAIAppDeviceIDRequest : public OAIObject {
public:
    OAIAppDeviceIDRequest();
    OAIAppDeviceIDRequest(QString json);
    ~OAIAppDeviceIDRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppDeviceIDRequest)

#endif // OAIAppDeviceIDRequest_H
