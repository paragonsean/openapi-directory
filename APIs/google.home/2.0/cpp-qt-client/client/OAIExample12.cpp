...
OAIExample12::OAIExample12(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample12::OAIExample12() {
    this->initializeModel();
}

OAIExample12::~OAIExample12() {}

void OAIExample12::initializeModel() {

    m_token_isSet = false;
    m_token_isValid = false;
}

void OAIExample12::fromJson(QString jsonString) {
...
void OAIExample12::fromJsonObject(QJsonObject json) {

    m_token_isValid = ::OpenAPI::fromJsonValue(m_token, json[QString("token")]);
    m_token_isSet = !json[QString("token")].isNull() && m_token_isValid;
}

QString OAIExample12::asJson() const {
...
QJsonObject OAIExample12::asJsonObject() const {
    QJsonObject obj;
    if (m_token_isSet) {
...
QString OAIExample12::getToken() const {
    return m_token;
}
void OAIExample12::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIExample12::is_token_Set() const{
    return m_token_isSet;
}

bool OAIExample12::is_token_Valid() const{
    return m_token_isValid;
}

bool OAIExample12::isSet() const {
...
bool OAIExample12::isValid() const {
