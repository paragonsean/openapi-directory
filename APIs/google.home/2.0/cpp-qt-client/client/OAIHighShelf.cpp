...
OAIHighShelf::OAIHighShelf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHighShelf::OAIHighShelf() {
    this->initializeModel();
}

OAIHighShelf::~OAIHighShelf() {}

void OAIHighShelf::initializeModel() {
...
void OAIHighShelf::fromJson(QString jsonString) {
...
void OAIHighShelf::fromJsonObject(QJsonObject json) {
...
QString OAIHighShelf::asJson() const {
...
QJsonObject OAIHighShelf::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIHighShelf::getFrequency() const {
    return m_frequency;
}
void OAIHighShelf::setFrequency(const qint32 &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAIHighShelf::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAIHighShelf::is_frequency_Valid() const{
    return m_frequency_isValid;
}

qint32 OAIHighShelf::getGainDb() const {
    return m_gain_db;
}
void OAIHighShelf::setGainDb(const qint32 &gain_db) {
    m_gain_db = gain_db;
    m_gain_db_isSet = true;
}

bool OAIHighShelf::is_gain_db_Set() const{
    return m_gain_db_isSet;
}

bool OAIHighShelf::is_gain_db_Valid() const{
    return m_gain_db_isValid;
}

double OAIHighShelf::getQuality() const {
    return m_quality;
}
void OAIHighShelf::setQuality(const double &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIHighShelf::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIHighShelf::is_quality_Valid() const{
    return m_quality_isValid;
}

bool OAIHighShelf::isSet() const {
...
bool OAIHighShelf::isValid() const {
