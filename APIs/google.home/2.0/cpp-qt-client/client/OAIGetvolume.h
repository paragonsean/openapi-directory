...
#ifndef OAIGetvolume_H
#define OAIGetvolume_H
...
class OAIGetvolume : public OAIObject {
public:
    OAIGetvolume();
    OAIGetvolume(QString json);
    ~OAIGetvolume() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetvolume)

#endif // OAIGetvolume_H
