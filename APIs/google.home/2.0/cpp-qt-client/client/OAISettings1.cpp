...
OAISettings1::OAISettings1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISettings1::OAISettings1() {
    this->initializeModel();
}

OAISettings1::~OAISettings1() {}

void OAISettings1::initializeModel() {

    m_control_notifications_isSet = false;
    m_control_notifications_isValid = false;
}

void OAISettings1::fromJson(QString jsonString) {
...
void OAISettings1::fromJsonObject(QJsonObject json) {
...
QString OAISettings1::asJson() const {
...
QJsonObject OAISettings1::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISettings1::getControlNotifications() const {
    return m_control_notifications;
}
void OAISettings1::setControlNotifications(const qint32 &control_notifications) {
    m_control_notifications = control_notifications;
    m_control_notifications_isSet = true;
}

bool OAISettings1::is_control_notifications_Set() const{
    return m_control_notifications_isSet;
}

bool OAISettings1::is_control_notifications_Valid() const{
    return m_control_notifications_isValid;
}

bool OAISettings1::isSet() const {
...
bool OAISettings1::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_control_notifications_isValid && true;
}
