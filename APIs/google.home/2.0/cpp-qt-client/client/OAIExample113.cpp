...
OAIExample113::OAIExample113(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample113::OAIExample113() {
    this->initializeModel();
}

OAIExample113::~OAIExample113() {}

void OAIExample113::initializeModel() {
...
void OAIExample113::fromJson(QString jsonString) {
...
void OAIExample113::fromJsonObject(QJsonObject json) {
...
QString OAIExample113::asJson() const {
...
QJsonObject OAIExample113::asJsonObject() const {
    QJsonObject obj;
    if (m_ssid_isSet) {
...
QString OAIExample113::getSsid() const {
    return m_ssid;
}
void OAIExample113::setSsid(const QString &ssid) {
    m_ssid = ssid;
    m_ssid_isSet = true;
}

bool OAIExample113::is_ssid_Set() const{
    return m_ssid_isSet;
}

bool OAIExample113::is_ssid_Valid() const{
    return m_ssid_isValid;
}

qint32 OAIExample113::getWpaAuth() const {
    return m_wpa_auth;
}
void OAIExample113::setWpaAuth(const qint32 &wpa_auth) {
    m_wpa_auth = wpa_auth;
    m_wpa_auth_isSet = true;
}

bool OAIExample113::is_wpa_auth_Set() const{
    return m_wpa_auth_isSet;
}

bool OAIExample113::is_wpa_auth_Valid() const{
    return m_wpa_auth_isValid;
}

qint32 OAIExample113::getWpaCipher() const {
    return m_wpa_cipher;
}
void OAIExample113::setWpaCipher(const qint32 &wpa_cipher) {
    m_wpa_cipher = wpa_cipher;
    m_wpa_cipher_isSet = true;
}

bool OAIExample113::is_wpa_cipher_Set() const{
    return m_wpa_cipher_isSet;
}

bool OAIExample113::is_wpa_cipher_Valid() const{
    return m_wpa_cipher_isValid;
}

qint32 OAIExample113::getWpaId() const {
    return m_wpa_id;
}
void OAIExample113::setWpaId(const qint32 &wpa_id) {
    m_wpa_id = wpa_id;
    m_wpa_id_isSet = true;
}

bool OAIExample113::is_wpa_id_Set() const{
    return m_wpa_id_isSet;
}

bool OAIExample113::is_wpa_id_Valid() const{
    return m_wpa_id_isValid;
}

bool OAIExample113::isSet() const {
...
bool OAIExample113::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ssid_isValid && m_wpa_auth_isValid && m_wpa_cipher_isValid && m_wpa_id_isValid && true;
}
