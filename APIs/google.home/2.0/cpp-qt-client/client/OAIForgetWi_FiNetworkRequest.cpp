...
OAIForgetWi_FiNetworkRequest::OAIForgetWi_FiNetworkRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForgetWi_FiNetworkRequest::OAIForgetWi_FiNetworkRequest() {
    this->initializeModel();
}

OAIForgetWi_FiNetworkRequest::~OAIForgetWi_FiNetworkRequest() {}

void OAIForgetWi_FiNetworkRequest::initializeModel() {

    m_wpa_id_isSet = false;
    m_wpa_id_isValid = false;
}

void OAIForgetWi_FiNetworkRequest::fromJson(QString jsonString) {
...
void OAIForgetWi_FiNetworkRequest::fromJsonObject(QJsonObject json) {
...
QString OAIForgetWi_FiNetworkRequest::asJson() const {
...
QJsonObject OAIForgetWi_FiNetworkRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_wpa_id_isSet) {
...
qint32 OAIForgetWi_FiNetworkRequest::getWpaId() const {
    return m_wpa_id;
}
void OAIForgetWi_FiNetworkRequest::setWpaId(const qint32 &wpa_id) {
    m_wpa_id = wpa_id;
    m_wpa_id_isSet = true;
}

bool OAIForgetWi_FiNetworkRequest::is_wpa_id_Set() const{
    return m_wpa_id_isSet;
}

bool OAIForgetWi_FiNetworkRequest::is_wpa_id_Valid() const{
    return m_wpa_id_isValid;
}

bool OAIForgetWi_FiNetworkRequest::isSet() const {
...
bool OAIForgetWi_FiNetworkRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_wpa_id_isValid && true;
}
