...
void OAISign::initializeModel() {
    ...
    m_intermediate_certs_isSet = false;
    m_intermediate_certs_isValid = false;
...
void OAISign::fromJsonObject(QJsonObject json) {
    ...
    m_intermediate_certs_isValid = ::OpenAPI::fromJsonValue(m_intermediate_certs, json[QString("intermediate_certs")]);
    m_intermediate_certs_isSet = !json[QString("intermediate_certs")].isNull() && m_intermediate_certs_isValid;
...
QJsonObject OAISign::asJsonObject() const {
    ...
    if (m_intermediate_certs.size() > 0) {
        obj.insert(QString("intermediate_certs"), ::OpenAPI::toJsonValue(m_intermediate_certs));
    }
    if (m_nonce_isSet) {
...
QString OAISign::getCertificate() const {
    return m_certificate;
}
void OAISign::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAISign::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAISign::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QList<QString> OAISign::getIntermediateCerts() const {
    return m_intermediate_certs;
}
void OAISign::setIntermediateCerts(const QList<QString> &intermediate_certs) {
    m_intermediate_certs = intermediate_certs;
    m_intermediate_certs_isSet = true;
}

bool OAISign::is_intermediate_certs_Set() const{
    return m_intermediate_certs_isSet;
}

bool OAISign::is_intermediate_certs_Valid() const{
    return m_intermediate_certs_isValid;
}

QString OAISign::getNonce() const {
    return m_nonce;
}
void OAISign::setNonce(const QString &nonce) {
    m_nonce = nonce;
    m_nonce_isSet = true;
}

bool OAISign::is_nonce_Set() const{
    return m_nonce_isSet;
}

bool OAISign::is_nonce_Valid() const{
    return m_nonce_isValid;
}

QString OAISign::getSignedData() const {
    return m_signed_data;
}
void OAISign::setSignedData(const QString &signed_data) {
    m_signed_data = signed_data;
    m_signed_data_isSet = true;
}

bool OAISign::is_signed_data_Set() const{
    return m_signed_data_isSet;
}

bool OAISign::is_signed_data_Valid() const{
...
bool OAISign::isValid() const {
    ...
    return m_certificate_isValid && m_intermediate_certs_isValid && m_nonce_isValid && m_signed_data_isValid && true;
}
