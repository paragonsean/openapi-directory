...
OAIOpencast::OAIOpencast(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOpencast::OAIOpencast() {
    this->initializeModel();
}

OAIOpencast::~OAIOpencast() {}

void OAIOpencast::initializeModel() {

    m_pin_code_isSet = false;
    m_pin_code_isValid = false;
}

void OAIOpencast::fromJson(QString jsonString) {
...
void OAIOpencast::fromJsonObject(QJsonObject json) {

    m_pin_code_isValid = ::OpenAPI::fromJsonValue(m_pin_code, json[QString("pin_code")]);
    m_pin_code_isSet = !json[QString("pin_code")].isNull() && m_pin_code_isValid;
}

QString OAIOpencast::asJson() const {
...
QJsonObject OAIOpencast::asJsonObject() const {
    QJsonObject obj;
    if (m_pin_code_isSet) {
        obj.insert(QString("pin_code"), ::OpenAPI::toJsonValue(m_pin_code));
    }
    return obj;
}

QString OAIOpencast::getPinCode() const {
    return m_pin_code;
}
void OAIOpencast::setPinCode(const QString &pin_code) {
    m_pin_code = pin_code;
    m_pin_code_isSet = true;
}

bool OAIOpencast::is_pin_code_Set() const{
    return m_pin_code_isSet;
}

bool OAIOpencast::is_pin_code_Valid() const{
    return m_pin_code_isValid;
}

bool OAIOpencast::isSet() const {
...
bool OAIOpencast::isValid() const {
