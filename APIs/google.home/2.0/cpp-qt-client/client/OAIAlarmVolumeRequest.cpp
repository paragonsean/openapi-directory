...
OAIAlarmVolumeRequest::OAIAlarmVolumeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlarmVolumeRequest::OAIAlarmVolumeRequest() {
    this->initializeModel();
}

OAIAlarmVolumeRequest::~OAIAlarmVolumeRequest() {}

void OAIAlarmVolumeRequest::initializeModel() {

    m_volume_isSet = false;
    m_volume_isValid = false;
}

void OAIAlarmVolumeRequest::fromJson(QString jsonString) {
...
void OAIAlarmVolumeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAlarmVolumeRequest::asJson() const {
...
QJsonObject OAIAlarmVolumeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_isSet) {
...
qint32 OAIAlarmVolumeRequest::getVolume() const {
    return m_volume;
}
void OAIAlarmVolumeRequest::setVolume(const qint32 &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAIAlarmVolumeRequest::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAIAlarmVolumeRequest::is_volume_Valid() const{
    return m_volume_isValid;
}

bool OAIAlarmVolumeRequest::isSet() const {
...
bool OAIAlarmVolumeRequest::isValid() const {
