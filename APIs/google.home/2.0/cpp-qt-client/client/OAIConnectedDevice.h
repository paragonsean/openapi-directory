...
/*
 * OAIConnectedDevice.h
 *
 * 
 */

#ifndef OAIConnectedDevice_H
#define OAIConnectedDevice_H
...
class OAIConnectedDevice : public OAIObject {
public:
    OAIConnectedDevice();
    OAIConnectedDevice(QString json);
    ~OAIConnectedDevice() override;
    ...
    qint32 getEnabledProfiles() const;
    void setEnabledProfiles(const qint32 &enabled_profiles);
    bool is_enabled_profiles_Set() const;
    bool is_enabled_profiles_Valid() const;
...
private:
    ...
    qint32 m_enabled_profiles;
    bool m_enabled_profiles_isSet;
    bool m_enabled_profiles_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIConnectedDevice)

#endif // OAIConnectedDevice_H
