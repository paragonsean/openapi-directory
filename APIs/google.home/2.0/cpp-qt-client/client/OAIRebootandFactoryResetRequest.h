...
/*
 * OAIRebootandFactoryResetRequest.h
 *
 * 
 */

#ifndef OAIRebootandFactoryResetRequest_H
#define OAIRebootandFactoryResetRequest_H
...
class OAIRebootandFactoryResetRequest : public OAIObject {
public:
    OAIRebootandFactoryResetRequest();
    OAIRebootandFactoryResetRequest(QString json);
    ~OAIRebootandFactoryResetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebootandFactoryResetRequest)

#endif // OAIRebootandFactoryResetRequest_H
