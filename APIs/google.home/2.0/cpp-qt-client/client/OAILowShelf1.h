...
#ifndef OAILowShelf1_H
#define OAILowShelf1_H
...
class OAILowShelf1 : public OAIObject {
public:
    OAILowShelf1();
    OAILowShelf1(QString json);
    ~OAILowShelf1() override;
    ...
    qint32 getGainDb() const;
    void setGainDb(const qint32 &gain_db);
...
Q_DECLARE_METATYPE(OpenAPI::OAILowShelf1)

#endif // OAILowShelf1_H
