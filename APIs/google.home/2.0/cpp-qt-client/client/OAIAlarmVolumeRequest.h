...
/*
 * OAIAlarmVolumeRequest.h
 *
 * 
 */

#ifndef OAIAlarmVolumeRequest_H
#define OAIAlarmVolumeRequest_H
...
class OAIAlarmVolumeRequest : public OAIObject {
public:
    OAIAlarmVolumeRequest();
    OAIAlarmVolumeRequest(QString json);
    ~OAIAlarmVolumeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlarmVolumeRequest)

#endif // OAIAlarmVolumeRequest_H
