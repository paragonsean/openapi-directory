...
#ifndef OAIExample11_H
#define OAIExample11_H
...
class OAIExample11 : public OAIObject {
public:
    OAIExample11();
    OAIExample11(QString json);
    ~OAIExample11() override;
    ...
    QString getAppDeviceId() const;
    void setAppDeviceId(const QString &app_device_id);
    bool is_app_device_id_Set() const;
    bool is_app_device_id_Valid() const;
...
private:
    ...
    QString m_app_device_id;
    bool m_app_device_id_isSet;
    bool m_app_device_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExample11)

#endif // OAIExample11_H
