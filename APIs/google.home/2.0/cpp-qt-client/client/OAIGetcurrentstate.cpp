...
OAIGetcurrentstate::OAIGetcurrentstate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetcurrentstate::OAIGetcurrentstate() {
    this->initializeModel();
}

OAIGetcurrentstate::~OAIGetcurrentstate() {}

void OAIGetcurrentstate::initializeModel() {

    m_notifications_enabled_isSet = false;
    m_notifications_enabled_isValid = false;
}

void OAIGetcurrentstate::fromJson(QString jsonString) {
...
void OAIGetcurrentstate::fromJsonObject(QJsonObject json) {

    m_notifications_enabled_isValid = ::OpenAPI::fromJsonValue(m_notifications_enabled, json[QString("notifications_enabled")]);
    m_notifications_enabled_isSet = !json[QString("notifications_enabled")].isNull() && m_notifications_enabled_isValid;
}

QString OAIGetcurrentstate::asJson() const {
...
QJsonObject OAIGetcurrentstate::asJsonObject() const {
    QJsonObject obj;
    if (m_notifications_enabled_isSet) {
        obj.insert(QString("notifications_enabled"), ::OpenAPI::toJsonValue(m_notifications_enabled));
    }
    return obj;
}

bool OAIGetcurrentstate::isNotificationsEnabled() const {
    return m_notifications_enabled;
}
void OAIGetcurrentstate::setNotificationsEnabled(const bool &notifications_enabled) {
    m_notifications_enabled = notifications_enabled;
    m_notifications_enabled_isSet = true;
}

bool OAIGetcurrentstate::is_notifications_enabled_Set() const{
    return m_notifications_enabled_isSet;
}

bool OAIGetcurrentstate::is_notifications_enabled_Valid() const{
    return m_notifications_enabled_isValid;
}

bool OAIGetcurrentstate::isSet() const {
...
bool OAIGetcurrentstate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_notifications_enabled_isValid && true;
}
