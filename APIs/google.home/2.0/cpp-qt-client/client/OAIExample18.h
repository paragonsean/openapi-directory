...
#ifndef OAIExample18_H
#define OAIExample18_H
...
class OAIExample18 : public OAIObject {
public:
    OAIExample18();
    OAIExample18(QString json);
    ~OAIExample18() override;
    ...
    QList<OAIAlarm> getAlarm() const;
    void setAlarm(const QList<OAIAlarm> &alarm);
    bool is_alarm_Set() const;
    bool is_alarm_Valid() const;

    QList<OAITimer> getTimer() const;
    void setTimer(const QList<OAITimer> &timer);
    bool is_timer_Set() const;
    bool is_timer_Valid() const;
...
private:
    ...
    QList<OAIAlarm> m_alarm;
    bool m_alarm_isSet;
    bool m_alarm_isValid;

    QList<OAITimer> m_timer;
    bool m_timer_isSet;
    bool m_timer_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExample18)

#endif // OAIExample18_H
