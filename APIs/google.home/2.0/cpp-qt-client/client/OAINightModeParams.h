...
/*
 * OAINightModeParams.h
 *
 * 
 */

#ifndef OAINightModeParams_H
#define OAINightModeParams_H
...
class OAINightModeParams : public OAIObject {
public:
    OAINightModeParams();
    OAINightModeParams(QString json);
    ~OAINightModeParams() override;
    ...
    qint32 getDeviceOverrideDoNotDisturb() const;
    void setDeviceOverrideDoNotDisturb(const qint32 &device_override_do_not_disturb);
    bool is_device_override_do_not_disturb_Set() const;
    bool is_device_override_do_not_disturb_Valid() const;
...
private:
    ...
    qint32 m_device_override_do_not_disturb;
    bool m_device_override_do_not_disturb_isSet;
    bool m_device_override_do_not_disturb_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINightModeParams)

#endif // OAINightModeParams_H
