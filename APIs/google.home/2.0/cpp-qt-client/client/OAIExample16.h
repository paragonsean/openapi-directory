...
#ifndef OAIExample16_H
#define OAIExample16_H
...
class OAIExample16 : public OAIObject {
public:
    OAIExample16();
    OAIExample16(QString json);
    ~OAIExample16() override;
    ...
    qint32 getTimeForDataFetch() const;
    void setTimeForDataFetch(const qint32 &time_for_data_fetch);
    bool is_time_for_data_fetch_Set() const;
    bool is_time_for_data_fetch_Valid() const;

    qint32 getTimeForHttpResponse() const;
    void setTimeForHttpResponse(const qint32 &time_for_http_response);
    bool is_time_for_http_response_Set() const;
    bool is_time_for_http_response_Valid() const;
...
private:
    ...
    qint32 m_time_for_data_fetch;
    bool m_time_for_data_fetch_isSet;
    bool m_time_for_data_fetch_isValid;

    qint32 m_time_for_http_response;
    bool m_time_for_http_response_isSet;
    bool m_time_for_http_response_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIExample16)

#endif // OAIExample16_H
