...
#ifndef OAIDatePattern_H
#define OAIDatePattern_H
...
class OAIDatePattern : public OAIObject {
public:
    OAIDatePattern();
    OAIDatePattern(QString json);
    ~OAIDatePattern() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatePattern)

#endif // OAIDatePattern_H
