...
#ifndef OAIExample17_H
#define OAIExample17_H
...
class OAIExample17 : public OAIObject {
public:
    OAIExample17();
    OAIExample17(QString json);
    ~OAIExample17() override;
    ...
    QList<OAIWindow2> getWindows() const;
    void setWindows(const QList<OAIWindow2> &windows);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExample17)

#endif // OAIExample17_H
