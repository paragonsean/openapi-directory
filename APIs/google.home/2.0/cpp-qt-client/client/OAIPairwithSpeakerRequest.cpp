...
#include "OAIPairwithSpeakerRequest.h"
...
OAIPairwithSpeakerRequest::OAIPairwithSpeakerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPairwithSpeakerRequest::OAIPairwithSpeakerRequest() {
    this->initializeModel();
}

OAIPairwithSpeakerRequest::~OAIPairwithSpeakerRequest() {}

void OAIPairwithSpeakerRequest::initializeModel() {
...
void OAIPairwithSpeakerRequest::fromJson(QString jsonString) {
...
void OAIPairwithSpeakerRequest::fromJsonObject(QJsonObject json) {

    m_connect_isValid = ::OpenAPI::fromJsonValue(m_connect, json[QString("connect")]);
...
QString OAIPairwithSpeakerRequest::asJson() const {
...
QJsonObject OAIPairwithSpeakerRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_connect_isSet) {
        obj.insert(QString("connect"), ::OpenAPI::toJsonValue(m_connect));
    }
...
bool OAIPairwithSpeakerRequest::isConnect() const {
    return m_connect;
}
void OAIPairwithSpeakerRequest::setConnect(const bool &connect) {
    m_connect = connect;
    m_connect_isSet = true;
}

bool OAIPairwithSpeakerRequest::is_connect_Set() const{
    return m_connect_isSet;
}

bool OAIPairwithSpeakerRequest::is_connect_Valid() const{
    return m_connect_isValid;
}

QString OAIPairwithSpeakerRequest::getMacAddress() const {
    return m_mac_address;
}
void OAIPairwithSpeakerRequest::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIPairwithSpeakerRequest::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIPairwithSpeakerRequest::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

qint32 OAIPairwithSpeakerRequest::getProfile() const {
    return m_profile;
}
void OAIPairwithSpeakerRequest::setProfile(const qint32 &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIPairwithSpeakerRequest::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIPairwithSpeakerRequest::is_profile_Valid() const{
    return m_profile_isValid;
}

bool OAIPairwithSpeakerRequest::isSet() const {
...
bool OAIPairwithSpeakerRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_connect_isValid && m_mac_address_isValid && m_profile_isValid && true;
}
