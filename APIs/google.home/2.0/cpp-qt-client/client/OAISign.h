...
public:
    ...
    QList<QString> getIntermediateCerts() const;
    void setIntermediateCerts(const QList<QString> &intermediate_certs);
    bool is_intermediate_certs_Set() const;
    bool is_intermediate_certs_Valid() const;
    ...
    QString getSignedData() const;
    void setSignedData(const QString &signed_data);
    bool is_signed_data_Set() const;
    bool is_signed_data_Valid() const;
...
private:
    ...
    QList<QString> m_intermediate_certs;
    bool m_intermediate_certs_isSet;
    bool m_intermediate_certs_isValid;

    QString m_nonce;
    bool m_nonce_isSet;
    bool m_nonce_isValid;

    QString m_signed_data;
    bool m_signed_data_isSet;
    bool m_signed_data_isValid;
};
