...
OAIStaticFilesApi::OAIStaticFilesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIStaticFilesApi::~OAIStaticFilesApi() {
}

void OAIStaticFilesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("chromecastIcon", defaultConf);
    _serverIndices.insert("chromecastIcon", 0);
    _serverConfigs.insert("legalNotice", defaultConf);
    _serverIndices.insert("legalNotice", 0);
}
...
*/
int OAIStaticFilesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIStaticFilesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIStaticFilesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIStaticFilesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIStaticFilesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIStaticFilesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIStaticFilesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIStaticFilesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIStaticFilesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIStaticFilesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStaticFilesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStaticFilesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIStaticFilesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIStaticFilesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIStaticFilesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIStaticFilesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIStaticFilesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIStaticFilesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIStaticFilesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIStaticFilesApi::chromecastIcon() {
    QString fullPath = QString(_serverConfigs["chromecastIcon"][_serverIndices.value("chromecastIcon")].URL()+"/icon.png");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStaticFilesApi::chromecastIconCallback);
    connect(this, &OAIStaticFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIStaticFilesApi::chromecastIconCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT chromecastIconSignal();
        Q_EMIT chromecastIconSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT chromecastIconSignalE(error_type, error_str);
        Q_EMIT chromecastIconSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT chromecastIconSignalError(error_type, error_str);
        Q_EMIT chromecastIconSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStaticFilesApi::legalNotice() {
    QString fullPath = QString(_serverConfigs["legalNotice"][_serverIndices.value("legalNotice")].URL()+"/NOTICE.html.gz");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStaticFilesApi::legalNoticeCallback);
    connect(this, &OAIStaticFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStaticFilesApi::legalNoticeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT legalNoticeSignal(output);
        Q_EMIT legalNoticeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT legalNoticeSignalE(output, error_type, error_str);
        Q_EMIT legalNoticeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT legalNoticeSignalError(output, error_type, error_str);
        Q_EMIT legalNoticeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStaticFilesApi::tokenAvailable(){
