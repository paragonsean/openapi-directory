...
/*
 * OAISetEurekaInfoRequest.h
 *
 * 
 */

#ifndef OAISetEurekaInfoRequest_H
#define OAISetEurekaInfoRequest_H

#include <QJsonObject>

#include "OAIOptIn1.h"
#include "OAISettings1.h"
#include <QString>
...
class OAISetEurekaInfoRequest : public OAIObject {
public:
    OAISetEurekaInfoRequest();
    OAISetEurekaInfoRequest(QString json);
    ~OAISetEurekaInfoRequest() override;
    ...
    OAIOptIn1 getOptIn() const;
    void setOptIn(const OAIOptIn1 &opt_in);
    bool is_opt_in_Set() const;
    bool is_opt_in_Valid() const;

    OAISettings1 getSettings() const;
    void setSettings(const OAISettings1 &settings);
...
Q_DECLARE_METATYPE(OpenAPI::OAISetEurekaInfoRequest)

#endif // OAISetEurekaInfoRequest_H
