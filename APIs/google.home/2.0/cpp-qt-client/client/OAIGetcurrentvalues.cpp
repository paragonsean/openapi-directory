...
OAIGetcurrentvalues::OAIGetcurrentvalues(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetcurrentvalues::OAIGetcurrentvalues() {
    this->initializeModel();
}

OAIGetcurrentvalues::~OAIGetcurrentvalues() {}

void OAIGetcurrentvalues::initializeModel() {
...
void OAIGetcurrentvalues::fromJson(QString jsonString) {
...
void OAIGetcurrentvalues::fromJsonObject(QJsonObject json) {
...
QString OAIGetcurrentvalues::asJson() const {
...
QJsonObject OAIGetcurrentvalues::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGetcurrentvalues::isEndpointEnabled() const {
    return m_endpoint_enabled;
}
void OAIGetcurrentvalues::setEndpointEnabled(const bool &endpoint_enabled) {
    m_endpoint_enabled = endpoint_enabled;
    m_endpoint_enabled_isSet = true;
}

bool OAIGetcurrentvalues::is_endpoint_enabled_Set() const{
    return m_endpoint_enabled_isSet;
}

bool OAIGetcurrentvalues::is_endpoint_enabled_Valid() const{
    return m_endpoint_enabled_isValid;
}

bool OAIGetcurrentvalues::isHotwordEnabled() const {
    return m_hotword_enabled;
}
void OAIGetcurrentvalues::setHotwordEnabled(const bool &hotword_enabled) {
    m_hotword_enabled = hotword_enabled;
    m_hotword_enabled_isSet = true;
}

bool OAIGetcurrentvalues::is_hotword_enabled_Set() const{
    return m_hotword_enabled_isSet;
}

bool OAIGetcurrentvalues::is_hotword_enabled_Valid() const{
    return m_hotword_enabled_isValid;
}

bool OAIGetcurrentvalues::isSet() const {
...
bool OAIGetcurrentvalues::isValid() const {
