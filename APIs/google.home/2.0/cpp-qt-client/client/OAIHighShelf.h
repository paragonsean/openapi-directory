...
#ifndef OAIHighShelf_H
#define OAIHighShelf_H
...
class OAIHighShelf : public OAIObject {
public:
    OAIHighShelf();
    OAIHighShelf(QString json);
    ~OAIHighShelf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHighShelf)

#endif // OAIHighShelf_H
