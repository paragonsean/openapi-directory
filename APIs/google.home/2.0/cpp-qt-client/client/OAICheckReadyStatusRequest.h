...
/*
 * OAICheckReadyStatusRequest.h
 *
 * 
 */

#ifndef OAICheckReadyStatusRequest_H
#define OAICheckReadyStatusRequest_H
...
class OAICheckReadyStatusRequest : public OAIObject {
public:
    OAICheckReadyStatusRequest();
    OAICheckReadyStatusRequest(QString json);
    ~OAICheckReadyStatusRequest() override;
    ...
    bool isPlayReadyMessage() const;
    void setPlayReadyMessage(const bool &play_ready_message);
    bool is_play_ready_message_Set() const;
    bool is_play_ready_message_Valid() const;
...
private:
    ...
    bool m_play_ready_message;
    bool m_play_ready_message_isSet;
    bool m_play_ready_message_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckReadyStatusRequest)

#endif // OAICheckReadyStatusRequest_H
