...
class OAIAogh : public OAIObject {
public:
    OAIAogh();
    OAIAogh(QString json);
    ~OAIAogh() override;
    ...
    QString getAoghApiVersion() const;
    void setAoghApiVersion(const QString &aogh_api_version);
    bool is_aogh_api_version_Set() const;
    bool is_aogh_api_version_Valid() const;
...
private:
    ...
    QString m_aogh_api_version;
    bool m_aogh_api_version_isSet;
    bool m_aogh_api_version_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAogh)
