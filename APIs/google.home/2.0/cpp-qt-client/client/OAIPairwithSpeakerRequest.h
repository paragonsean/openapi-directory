...
/*
 * OAIPairwithSpeakerRequest.h
 *
 * 
 */

#ifndef OAIPairwithSpeakerRequest_H
#define OAIPairwithSpeakerRequest_H
...
class OAIPairwithSpeakerRequest : public OAIObject {
public:
    OAIPairwithSpeakerRequest();
    OAIPairwithSpeakerRequest(QString json);
    ~OAIPairwithSpeakerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPairwithSpeakerRequest)

#endif // OAIPairwithSpeakerRequest_H
