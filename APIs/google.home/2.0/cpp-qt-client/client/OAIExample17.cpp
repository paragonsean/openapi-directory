...
OAIExample17::OAIExample17(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample17::OAIExample17() {
    this->initializeModel();
}

OAIExample17::~OAIExample17() {}

void OAIExample17::initializeModel() {
...
void OAIExample17::fromJson(QString jsonString) {
...
void OAIExample17::fromJsonObject(QJsonObject json) {
...
QString OAIExample17::asJson() const {
...
QJsonObject OAIExample17::asJsonObject() const {
    QJsonObject obj;
...
bool OAIExample17::isDoNotDisturb() const {
    return m_do_not_disturb;
}
void OAIExample17::setDoNotDisturb(const bool &do_not_disturb) {
    m_do_not_disturb = do_not_disturb;
    m_do_not_disturb_isSet = true;
}

bool OAIExample17::is_do_not_disturb_Set() const{
    return m_do_not_disturb_isSet;
}

bool OAIExample17::is_do_not_disturb_Valid() const{
    return m_do_not_disturb_isValid;
}

bool OAIExample17::isEnabled() const {
    return m_enabled;
}
void OAIExample17::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIExample17::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIExample17::is_enabled_Valid() const{
    return m_enabled_isValid;
}

double OAIExample17::getLedBrightness() const {
    return m_led_brightness;
}
void OAIExample17::setLedBrightness(const double &led_brightness) {
    m_led_brightness = led_brightness;
    m_led_brightness_isSet = true;
}

bool OAIExample17::is_led_brightness_Set() const{
    return m_led_brightness_isSet;
}

bool OAIExample17::is_led_brightness_Valid() const{
    return m_led_brightness_isValid;
}

double OAIExample17::getVolume() const {
    return m_volume;
}
void OAIExample17::setVolume(const double &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAIExample17::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAIExample17::is_volume_Valid() const{
    return m_volume_isValid;
}

QList<OAIWindow2> OAIExample17::getWindows() const {
    return m_windows;
}
void OAIExample17::setWindows(const QList<OAIWindow2> &windows) {
    m_windows = windows;
    m_windows_isSet = true;
}

bool OAIExample17::is_windows_Set() const{
    return m_windows_isSet;
}

bool OAIExample17::is_windows_Valid() const{
    return m_windows_isValid;
}

bool OAIExample17::isSet() const {
...
bool OAIExample17::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_do_not_disturb_isValid && m_enabled_isValid && m_led_brightness_isValid && m_volume_isValid && m_windows_isValid && true;
}
