...
class OAIWindow2 : public OAIObject {
public:
    OAIWindow2();
    OAIWindow2(QString json);
    ~OAIWindow2() override;
    ...
    double getLengthHours() const;
    void setLengthHours(const double &length_hours);
    bool is_length_hours_Set() const;
    bool is_length_hours_Valid() const;
...
private:
    ...
    double m_length_hours;
    bool m_length_hours_isSet;
    bool m_length_hours_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWindow2)
