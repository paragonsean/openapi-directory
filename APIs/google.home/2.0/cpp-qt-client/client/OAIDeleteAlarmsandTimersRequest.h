...
/*
 * OAIDeleteAlarmsandTimersRequest.h
 *
 * 
 */

#ifndef OAIDeleteAlarmsandTimersRequest_H
#define OAIDeleteAlarmsandTimersRequest_H
...
class OAIDeleteAlarmsandTimersRequest : public OAIObject {
public:
    OAIDeleteAlarmsandTimersRequest();
    OAIDeleteAlarmsandTimersRequest(QString json);
    ~OAIDeleteAlarmsandTimersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAlarmsandTimersRequest)

#endif // OAIDeleteAlarmsandTimersRequest_H
