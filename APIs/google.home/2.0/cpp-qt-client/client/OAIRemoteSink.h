...
#ifndef OAIRemoteSink_H
#define OAIRemoteSink_H
...
class OAIRemoteSink : public OAIObject {
public:
    OAIRemoteSink();
    OAIRemoteSink(QString json);
    ~OAIRemoteSink() override;
    ...
    double getBondDate() const;
    void setBondDate(const double &bond_date);
    bool is_bond_date_Set() const;
    bool is_bond_date_Valid() const;

    qint32 getDeviceClass() const;
    void setDeviceClass(const qint32 &device_class);
    ...
    qint32 getLastConnectDate() const;
    void setLastConnectDate(const qint32 &last_connect_date);
    bool is_last_connect_date_Set() const;
    bool is_last_connect_date_Valid() const;
    ...
    QList<QString> getServiceUuids() const;
    void setServiceUuids(const QList<QString> &service_uuids);
    bool is_service_uuids_Set() const;
    bool is_service_uuids_Valid() const;
...
private:
    ...
    double m_bond_date;
    bool m_bond_date_isSet;
    bool m_bond_date_isValid;

    qint32 m_device_class;
    ...
    qint32 m_last_connect_date;
    bool m_last_connect_date_isSet;
    bool m_last_connect_date_isValid;
    ...
    QList<QString> m_service_uuids;
    bool m_service_uuids_isSet;
    bool m_service_uuids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRemoteSink)

#endif // OAIRemoteSink_H
