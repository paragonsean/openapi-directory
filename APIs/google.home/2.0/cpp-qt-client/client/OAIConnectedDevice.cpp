...
OAIConnectedDevice::OAIConnectedDevice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectedDevice::OAIConnectedDevice() {
    this->initializeModel();
}

OAIConnectedDevice::~OAIConnectedDevice() {}

void OAIConnectedDevice::initializeModel() {

    m_device_isSet = false;
    m_device_isValid = false;

    m_enabled_profiles_isSet = false;
    m_enabled_profiles_isValid = false;
}

void OAIConnectedDevice::fromJson(QString jsonString) {
...
void OAIConnectedDevice::fromJsonObject(QJsonObject json) {
    ...
    m_enabled_profiles_isValid = ::OpenAPI::fromJsonValue(m_enabled_profiles, json[QString("enabled_profiles")]);
    m_enabled_profiles_isSet = !json[QString("enabled_profiles")].isNull() && m_enabled_profiles_isValid;
}

QString OAIConnectedDevice::asJson() const {
...
QJsonObject OAIConnectedDevice::asJsonObject() const {
    QJsonObject obj;
    if (m_device.isSet()) {
        obj.insert(QString("device"), ::OpenAPI::toJsonValue(m_device));
    }
    if (m_enabled_profiles_isSet) {
        obj.insert(QString("enabled_profiles"), ::OpenAPI::toJsonValue(m_enabled_profiles));
    }
    return obj;
}

OAIDevice OAIConnectedDevice::getDevice() const {
    return m_device;
}
void OAIConnectedDevice::setDevice(const OAIDevice &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIConnectedDevice::is_device_Set() const{
    return m_device_isSet;
}

bool OAIConnectedDevice::is_device_Valid() const{
    return m_device_isValid;
}

qint32 OAIConnectedDevice::getEnabledProfiles() const {
    return m_enabled_profiles;
}
void OAIConnectedDevice::setEnabledProfiles(const qint32 &enabled_profiles) {
    m_enabled_profiles = enabled_profiles;
    m_enabled_profiles_isSet = true;
}

bool OAIConnectedDevice::is_enabled_profiles_Set() const{
    return m_enabled_profiles_isSet;
}

bool OAIConnectedDevice::is_enabled_profiles_Valid() const{
    return m_enabled_profiles_isValid;
}

bool OAIConnectedDevice::isSet() const {
...
bool OAIConnectedDevice::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_isValid && m_enabled_profiles_isValid && true;
}
