...
OAITestInternetDownloadSpeedRequest::OAITestInternetDownloadSpeedRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestInternetDownloadSpeedRequest::OAITestInternetDownloadSpeedRequest() {
    this->initializeModel();
}

OAITestInternetDownloadSpeedRequest::~OAITestInternetDownloadSpeedRequest() {}

void OAITestInternetDownloadSpeedRequest::initializeModel() {

    m_url_isSet = false;
    m_url_isValid = false;
}

void OAITestInternetDownloadSpeedRequest::fromJson(QString jsonString) {
...
void OAITestInternetDownloadSpeedRequest::fromJsonObject(QJsonObject json) {

    m_url_isValid = ::OpenAPI::fromJsonValue(m_url, json[QString("url")]);
    m_url_isSet = !json[QString("url")].isNull() && m_url_isValid;
}

QString OAITestInternetDownloadSpeedRequest::asJson() const {
...
QJsonObject OAITestInternetDownloadSpeedRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAITestInternetDownloadSpeedRequest::getUrl() const {
    return m_url;
}
void OAITestInternetDownloadSpeedRequest::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAITestInternetDownloadSpeedRequest::is_url_Set() const{
    return m_url_isSet;
}

bool OAITestInternetDownloadSpeedRequest::is_url_Valid() const{
    return m_url_isValid;
}

bool OAITestInternetDownloadSpeedRequest::isSet() const {
...
bool OAITestInternetDownloadSpeedRequest::isValid() const {
