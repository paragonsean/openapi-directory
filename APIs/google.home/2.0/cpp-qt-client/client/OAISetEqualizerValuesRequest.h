...
/*
 * OAISetEqualizerValuesRequest.h
 *
 * 
 */

#ifndef OAISetEqualizerValuesRequest_H
#define OAISetEqualizerValuesRequest_H

#include <QJsonObject>

#include "OAIHighShelf1.h"
#include "OAILowShelf1.h"
...
class OAISetEqualizerValuesRequest : public OAIObject {
public:
    OAISetEqualizerValuesRequest();
    OAISetEqualizerValuesRequest(QString json);
    ~OAISetEqualizerValuesRequest() override;
    ...
    OAIHighShelf1 getHighShelf() const;
    void setHighShelf(const OAIHighShelf1 &high_shelf);
    bool is_high_shelf_Set() const;
    bool is_high_shelf_Valid() const;

    OAILowShelf1 getLowShelf() const;
    void setLowShelf(const OAILowShelf1 &low_shelf);
    bool is_low_shelf_Set() const;
    bool is_low_shelf_Valid() const;
...
private:
    ...
    OAIHighShelf1 m_high_shelf;
    bool m_high_shelf_isSet;
    bool m_high_shelf_isValid;

    OAILowShelf1 m_low_shelf;
    bool m_low_shelf_isSet;
    bool m_low_shelf_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetEqualizerValuesRequest)

#endif // OAISetEqualizerValuesRequest_H
