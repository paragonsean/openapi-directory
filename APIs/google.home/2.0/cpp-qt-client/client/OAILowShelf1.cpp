...
OAILowShelf1::OAILowShelf1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILowShelf1::OAILowShelf1() {
    this->initializeModel();
}

OAILowShelf1::~OAILowShelf1() {}

void OAILowShelf1::initializeModel() {

    m_gain_db_isSet = false;
    m_gain_db_isValid = false;
}

void OAILowShelf1::fromJson(QString jsonString) {
...
void OAILowShelf1::fromJsonObject(QJsonObject json) {
...
QString OAILowShelf1::asJson() const {
...
QJsonObject OAILowShelf1::asJsonObject() const {
    QJsonObject obj;
    if (m_gain_db_isSet) {
...
qint32 OAILowShelf1::getGainDb() const {
    return m_gain_db;
}
void OAILowShelf1::setGainDb(const qint32 &gain_db) {
    m_gain_db = gain_db;
    m_gain_db_isSet = true;
}

bool OAILowShelf1::is_gain_db_Set() const{
    return m_gain_db_isSet;
}

bool OAILowShelf1::is_gain_db_Valid() const{
    return m_gain_db_isValid;
}

bool OAILowShelf1::isSet() const {
...
bool OAILowShelf1::isValid() const {
