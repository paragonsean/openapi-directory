...
OAIExample112::OAIExample112(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample112::OAIExample112() {
    this->initializeModel();
}

OAIExample112::~OAIExample112() {}

void OAIExample112::initializeModel() {
    ...
    m_expected_profiles_isSet = false;
    m_expected_profiles_isValid = false;
...
void OAIExample112::fromJson(QString jsonString) {
...
void OAIExample112::fromJsonObject(QJsonObject json) {
    ...
    m_expected_profiles_isValid = ::OpenAPI::fromJsonValue(m_expected_profiles, json[QString("expected_profiles")]);
    m_expected_profiles_isSet = !json[QString("expected_profiles")].isNull() && m_expected_profiles_isValid;
...
QString OAIExample112::asJson() const {
...
QJsonObject OAIExample112::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_expected_profiles_isSet) {
        obj.insert(QString("expected_profiles"), ::OpenAPI::toJsonValue(m_expected_profiles));
    }
...
qint32 OAIExample112::getDeviceClass() const {
    return m_device_class;
}
void OAIExample112::setDeviceClass(const qint32 &device_class) {
    m_device_class = device_class;
    m_device_class_isSet = true;
}

bool OAIExample112::is_device_class_Set() const{
    return m_device_class_isSet;
}

bool OAIExample112::is_device_class_Valid() const{
    return m_device_class_isValid;
}

qint32 OAIExample112::getDeviceType() const {
    return m_device_type;
}
void OAIExample112::setDeviceType(const qint32 &device_type) {
    m_device_type = device_type;
    m_device_type_isSet = true;
}

bool OAIExample112::is_device_type_Set() const{
    return m_device_type_isSet;
}

bool OAIExample112::is_device_type_Valid() const{
    return m_device_type_isValid;
}

qint32 OAIExample112::getExpectedProfiles() const {
    return m_expected_profiles;
}
void OAIExample112::setExpectedProfiles(const qint32 &expected_profiles) {
    m_expected_profiles = expected_profiles;
    m_expected_profiles_isSet = true;
}

bool OAIExample112::is_expected_profiles_Set() const{
    return m_expected_profiles_isSet;
}

bool OAIExample112::is_expected_profiles_Valid() const{
    return m_expected_profiles_isValid;
}

QString OAIExample112::getMacAddress() const {
    return m_mac_address;
}
void OAIExample112::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIExample112::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIExample112::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

QString OAIExample112::getName() const {
    return m_name;
}
void OAIExample112::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIExample112::is_name_Set() const{
    return m_name_isSet;
}

bool OAIExample112::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIExample112::getRssi() const {
    return m_rssi;
}
void OAIExample112::setRssi(const qint32 &rssi) {
    m_rssi = rssi;
    m_rssi_isSet = true;
}

bool OAIExample112::is_rssi_Set() const{
    return m_rssi_isSet;
}

bool OAIExample112::is_rssi_Valid() const{
    return m_rssi_isValid;
}

bool OAIExample112::isSet() const {
...
bool OAIExample112::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_class_isValid && m_device_type_isValid && m_expected_profiles_isValid && m_mac_address_isValid && m_name_isValid && m_rssi_isValid && true;
}
