...
/*
 * OAIConnecttoWi_FiNetworkRequest.h
 *
 * 
 */

#ifndef OAIConnecttoWi_FiNetworkRequest_H
#define OAIConnecttoWi_FiNetworkRequest_H
...
class OAIConnecttoWi_FiNetworkRequest : public OAIObject {
public:
    OAIConnecttoWi_FiNetworkRequest();
    OAIConnecttoWi_FiNetworkRequest(QString json);
    ~OAIConnecttoWi_FiNetworkRequest() override;
    ...
    QString getEncPasswd() const;
    void setEncPasswd(const QString &enc_passwd);
    bool is_enc_passwd_Set() const;
    bool is_enc_passwd_Valid() const;
...
private:
    ...
    QString m_enc_passwd;
    bool m_enc_passwd_isSet;
    bool m_enc_passwd_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnecttoWi_FiNetworkRequest)

#endif // OAIConnecttoWi_FiNetworkRequest_H
