...
bool OAIAudio::isDigital() const {
    return m_digital;
}
void OAIAudio::setDigital(const bool &digital) {
    m_digital = digital;
    m_digital_isSet = true;
}

bool OAIAudio::is_digital_Set() const{
    return m_digital_isSet;
}

bool OAIAudio::is_digital_Valid() const{
