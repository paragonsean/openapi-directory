...
OAIGetvolume::OAIGetvolume(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetvolume::OAIGetvolume() {
    this->initializeModel();
}

OAIGetvolume::~OAIGetvolume() {}

void OAIGetvolume::initializeModel() {

    m_volume_isSet = false;
    m_volume_isValid = false;
}

void OAIGetvolume::fromJson(QString jsonString) {
...
void OAIGetvolume::fromJsonObject(QJsonObject json) {
...
QString OAIGetvolume::asJson() const {
...
QJsonObject OAIGetvolume::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_isSet) {
...
double OAIGetvolume::getVolume() const {
    return m_volume;
}
void OAIGetvolume::setVolume(const double &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAIGetvolume::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAIGetvolume::is_volume_Valid() const{
    return m_volume_isValid;
}

bool OAIGetvolume::isSet() const {
...
bool OAIGetvolume::isValid() const {
