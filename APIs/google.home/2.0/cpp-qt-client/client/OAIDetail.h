...
public:
    ...
    QList<OAIIconList> getIconList() const;
    void setIconList(const QList<OAIIconList> &icon_list);
    bool is_icon_list_Set() const;
    bool is_icon_list_Valid() const;
...
private:
    ...
    QList<OAIIconList> m_icon_list;
    bool m_icon_list_isSet;
    bool m_icon_list_isValid;
