...
OAINightModeParams::OAINightModeParams(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINightModeParams::OAINightModeParams() {
    this->initializeModel();
}

OAINightModeParams::~OAINightModeParams() {}

void OAINightModeParams::initializeModel() {

    m_device_override_do_not_disturb_isSet = false;
    m_device_override_do_not_disturb_isValid = false;
...
void OAINightModeParams::fromJson(QString jsonString) {
...
void OAINightModeParams::fromJsonObject(QJsonObject json) {

    m_device_override_do_not_disturb_isValid = ::OpenAPI::fromJsonValue(m_device_override_do_not_disturb, json[QString("device_override_do_not_disturb")]);
    m_device_override_do_not_disturb_isSet = !json[QString("device_override_do_not_disturb")].isNull() && m_device_override_do_not_disturb_isValid;
...
QString OAINightModeParams::asJson() const {
...
QJsonObject OAINightModeParams::asJsonObject() const {
    QJsonObject obj;
    if (m_device_override_do_not_disturb_isSet) {
        obj.insert(QString("device_override_do_not_disturb"), ::OpenAPI::toJsonValue(m_device_override_do_not_disturb));
    }
...
qint32 OAINightModeParams::getDeviceOverrideDoNotDisturb() const {
    return m_device_override_do_not_disturb;
}
void OAINightModeParams::setDeviceOverrideDoNotDisturb(const qint32 &device_override_do_not_disturb) {
    m_device_override_do_not_disturb = device_override_do_not_disturb;
    m_device_override_do_not_disturb_isSet = true;
}

bool OAINightModeParams::is_device_override_do_not_disturb_Set() const{
    return m_device_override_do_not_disturb_isSet;
}

bool OAINightModeParams::is_device_override_do_not_disturb_Valid() const{
    return m_device_override_do_not_disturb_isValid;
}

bool OAINightModeParams::isDoNotDisturb() const {
    return m_do_not_disturb;
}
void OAINightModeParams::setDoNotDisturb(const bool &do_not_disturb) {
    m_do_not_disturb = do_not_disturb;
    m_do_not_disturb_isSet = true;
}

bool OAINightModeParams::is_do_not_disturb_Set() const{
    return m_do_not_disturb_isSet;
}

bool OAINightModeParams::is_do_not_disturb_Valid() const{
    return m_do_not_disturb_isValid;
}

bool OAINightModeParams::isEnabled() const {
    return m_enabled;
}
void OAINightModeParams::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAINightModeParams::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAINightModeParams::is_enabled_Valid() const{
    return m_enabled_isValid;
}

double OAINightModeParams::getLedBrightness() const {
    return m_led_brightness;
}
void OAINightModeParams::setLedBrightness(const double &led_brightness) {
    m_led_brightness = led_brightness;
    m_led_brightness_isSet = true;
}

bool OAINightModeParams::is_led_brightness_Set() const{
    return m_led_brightness_isSet;
}

bool OAINightModeParams::is_led_brightness_Valid() const{
    return m_led_brightness_isValid;
}

double OAINightModeParams::getVolume() const {
    return m_volume;
}
void OAINightModeParams::setVolume(const double &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAINightModeParams::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAINightModeParams::is_volume_Valid() const{
    return m_volume_isValid;
}

QList<OAIWindow> OAINightModeParams::getWindows() const {
    return m_windows;
}
void OAINightModeParams::setWindows(const QList<OAIWindow> &windows) {
    m_windows = windows;
    m_windows_isSet = true;
}

bool OAINightModeParams::is_windows_Set() const{
    return m_windows_isSet;
}

bool OAINightModeParams::is_windows_Valid() const{
    return m_windows_isValid;
}

bool OAINightModeParams::isSet() const {
...
bool OAINightModeParams::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_override_do_not_disturb_isValid && m_do_not_disturb_isValid && m_enabled_isValid && m_led_brightness_isValid && m_volume_isValid && m_windows_isValid && true;
}
