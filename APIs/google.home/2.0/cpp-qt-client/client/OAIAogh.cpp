...
void OAIAogh::initializeModel() {

    m_aogh_api_version_isSet = false;
    m_aogh_api_version_isValid = false;
}

void OAIAogh::fromJson(QString jsonString) {
...
void OAIAogh::fromJsonObject(QJsonObject json) {

    m_aogh_api_version_isValid = ::OpenAPI::fromJsonValue(m_aogh_api_version, json[QString("aogh_api_version")]);
    m_aogh_api_version_isSet = !json[QString("aogh_api_version")].isNull() && m_aogh_api_version_isValid;
}

QString OAIAogh::asJson() const {
...
QJsonObject OAIAogh::asJsonObject() const {
    QJsonObject obj;
    if (m_aogh_api_version_isSet) {
        obj.insert(QString("aogh_api_version"), ::OpenAPI::toJsonValue(m_aogh_api_version));
    }
    return obj;
}

QString OAIAogh::getAoghApiVersion() const {
    return m_aogh_api_version;
}
void OAIAogh::setAoghApiVersion(const QString &aogh_api_version) {
    m_aogh_api_version = aogh_api_version;
    m_aogh_api_version_isSet = true;
}

bool OAIAogh::is_aogh_api_version_Set() const{
    return m_aogh_api_version_isSet;
}

bool OAIAogh::is_aogh_api_version_Valid() const{
    return m_aogh_api_version_isValid;
}

bool OAIAogh::isSet() const {
...
bool OAIAogh::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_aogh_api_version_isValid && true;
}
