...
#include "OAIExample17.h"
#include "OAINightModesettingsRequest.h"
#include "OAIObject.h"
#include "OAIRebootandFactoryResetRequest.h"
...
public:
    ...
    /**
    * @param[in]  oai_night_modesettings_request OAINightModesettingsRequest [required]
    */
    virtual void nightModesettings(const OAINightModesettingsRequest &oai_night_modesettings_request);

    /**
    * @param[in]  oai_rebootand_factory_reset_request OAIRebootandFactoryResetRequest [required]
    */
    virtual void rebootandFactoryReset(const OAIRebootandFactoryResetRequest &oai_rebootand_factory_reset_request);

    /**
    * @param[in]  oai_set_eureka_info_request OAISetEurekaInfoRequest [required]
    */
    virtual void setEurekaInfo(const OAISetEurekaInfoRequest &oai_set_eureka_info_request);
...
private:
    ...
    void nightModesettingsCallback(OAIHttpRequestWorker *worker);
    void rebootandFactoryResetCallback(OAIHttpRequestWorker *worker);
    void setEurekaInfoCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void nightModesettingsSignal(OAIExample17 summary);
    void rebootandFactoryResetSignal(OAIObject summary);
    void setEurekaInfoSignal(OAIObject summary);


    void nightModesettingsSignalFull(OAIHttpRequestWorker *worker, OAIExample17 summary);
    void rebootandFactoryResetSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void setEurekaInfoSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use nightModesettingsSignalError() instead")
    void nightModesettingsSignalE(OAIExample17 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void nightModesettingsSignalError(OAIExample17 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rebootandFactoryResetSignalError() instead")
    void rebootandFactoryResetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rebootandFactoryResetSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use setEurekaInfoSignalError() instead")
    void setEurekaInfoSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void setEurekaInfoSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use nightModesettingsSignalErrorFull() instead")
    void nightModesettingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void nightModesettingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rebootandFactoryResetSignalErrorFull() instead")
    void rebootandFactoryResetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rebootandFactoryResetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use setEurekaInfoSignalErrorFull() instead")
    void setEurekaInfoSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void setEurekaInfoSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
