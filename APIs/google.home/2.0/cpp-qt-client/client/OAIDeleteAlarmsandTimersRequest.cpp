...
OAIDeleteAlarmsandTimersRequest::OAIDeleteAlarmsandTimersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAlarmsandTimersRequest::OAIDeleteAlarmsandTimersRequest() {
    this->initializeModel();
}

OAIDeleteAlarmsandTimersRequest::~OAIDeleteAlarmsandTimersRequest() {}

void OAIDeleteAlarmsandTimersRequest::initializeModel() {

    m_ids_isSet = false;
    m_ids_isValid = false;
}

void OAIDeleteAlarmsandTimersRequest::fromJson(QString jsonString) {
...
void OAIDeleteAlarmsandTimersRequest::fromJsonObject(QJsonObject json) {

    m_ids_isValid = ::OpenAPI::fromJsonValue(m_ids, json[QString("ids")]);
    m_ids_isSet = !json[QString("ids")].isNull() && m_ids_isValid;
}

QString OAIDeleteAlarmsandTimersRequest::asJson() const {
...
QJsonObject OAIDeleteAlarmsandTimersRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.size() > 0) {
...
QList<QString> OAIDeleteAlarmsandTimersRequest::getIds() const {
    return m_ids;
}
void OAIDeleteAlarmsandTimersRequest::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIDeleteAlarmsandTimersRequest::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIDeleteAlarmsandTimersRequest::is_ids_Valid() const{
    return m_ids_isValid;
}

bool OAIDeleteAlarmsandTimersRequest::isSet() const {
...
bool OAIDeleteAlarmsandTimersRequest::isValid() const {
