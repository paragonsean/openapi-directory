...
#ifndef OAIExample111_H
#define OAIExample111_H
...
class OAIExample111 : public OAIObject {
public:
    OAIExample111();
    OAIExample111(QString json);
    ~OAIExample111() override;
    ...
    double getLastConnectDate() const;
    void setLastConnectDate(const double &last_connect_date);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExample111)

#endif // OAIExample111_H
