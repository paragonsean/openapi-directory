...
/*
 * OAIScanfordevicesRequest.h
 *
 * 
 */

#ifndef OAIScanfordevicesRequest_H
#define OAIScanfordevicesRequest_H
...
class OAIScanfordevicesRequest : public OAIObject {
public:
    OAIScanfordevicesRequest();
    OAIScanfordevicesRequest(QString json);
    ~OAIScanfordevicesRequest() override;
    ...
    bool isClearResults() const;
    void setClearResults(const bool &clear_results);
    bool is_clear_results_Set() const;
    bool is_clear_results_Valid() const;
...
private:
    ...
    bool m_clear_results_isSet;
    bool m_clear_results_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanfordevicesRequest)

#endif // OAIScanfordevicesRequest_H
