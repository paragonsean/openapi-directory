...
public:
    ...
    void setEthernetConnected(const bool &ethernet_connected);
    bool is_ethernet_connected_Set() const;
    bool is_ethernet_connected_Valid() const;
...
private:
    ...
    bool m_ethernet_connected_isSet;
    bool m_ethernet_connected_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINet)
