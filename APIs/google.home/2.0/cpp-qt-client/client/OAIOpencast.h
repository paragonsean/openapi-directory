...
#ifndef OAIOpencast_H
#define OAIOpencast_H
...
class OAIOpencast : public OAIObject {
public:
    OAIOpencast();
    OAIOpencast(QString json);
    ~OAIOpencast() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpencast)
