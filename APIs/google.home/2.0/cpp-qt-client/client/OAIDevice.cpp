...
double OAIDevice::getBondDate() const {
    return m_bond_date;
}
void OAIDevice::setBondDate(const double &bond_date) {
    m_bond_date = bond_date;
    m_bond_date_isSet = true;
}

bool OAIDevice::is_bond_date_Set() const{
    return m_bond_date_isSet;
}

bool OAIDevice::is_bond_date_Valid() const{
    return m_bond_date_isValid;
}

qint32 OAIDevice::getDeviceClass() const {
    return m_device_class;
}
void OAIDevice::setDeviceClass(const qint32 &device_class) {
    m_device_class = device_class;
    m_device_class_isSet = true;
}

bool OAIDevice::is_device_class_Set() const{
    return m_device_class_isSet;
}

bool OAIDevice::is_device_class_Valid() const{
    return m_device_class_isValid;
}

qint32 OAIDevice::getDeviceType() const {
    return m_device_type;
}
void OAIDevice::setDeviceType(const qint32 &device_type) {
...
qint32 OAIDevice::getLastConnectDate() const {
    return m_last_connect_date;
}
void OAIDevice::setLastConnectDate(const qint32 &last_connect_date) {
    m_last_connect_date = last_connect_date;
    m_last_connect_date_isSet = true;
}

bool OAIDevice::is_last_connect_date_Set() const{
    return m_last_connect_date_isSet;
}

bool OAIDevice::is_last_connect_date_Valid() const{
    return m_last_connect_date_isValid;
}

QString OAIDevice::getMacAddress() const {
    return m_mac_address;
}
void OAIDevice::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIDevice::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIDevice::is_mac_address_Valid() const{
...
qint32 OAIDevice::getRssi() const {
    return m_rssi;
}
void OAIDevice::setRssi(const qint32 &rssi) {
    m_rssi = rssi;
    m_rssi_isSet = true;
}

bool OAIDevice::is_rssi_Set() const{
    return m_rssi_isSet;
}

bool OAIDevice::is_rssi_Valid() const{
    return m_rssi_isValid;
}

QList<QString> OAIDevice::getServiceUuids() const {
    return m_service_uuids;
}
void OAIDevice::setServiceUuids(const QList<QString> &service_uuids) {
    m_service_uuids = service_uuids;
    m_service_uuids_isSet = true;
}

bool OAIDevice::is_service_uuids_Set() const{
    return m_service_uuids_isSet;
}

bool OAIDevice::is_service_uuids_Valid() const{
