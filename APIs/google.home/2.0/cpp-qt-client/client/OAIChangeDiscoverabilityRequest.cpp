...
#include "OAIChangeDiscoverabilityRequest.h"
...
OAIChangeDiscoverabilityRequest::OAIChangeDiscoverabilityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeDiscoverabilityRequest::OAIChangeDiscoverabilityRequest() {
    this->initializeModel();
}

OAIChangeDiscoverabilityRequest::~OAIChangeDiscoverabilityRequest() {}

void OAIChangeDiscoverabilityRequest::initializeModel() {

    m_enable_discovery_isSet = false;
    m_enable_discovery_isValid = false;
}

void OAIChangeDiscoverabilityRequest::fromJson(QString jsonString) {
...
void OAIChangeDiscoverabilityRequest::fromJsonObject(QJsonObject json) {

    m_enable_discovery_isValid = ::OpenAPI::fromJsonValue(m_enable_discovery, json[QString("enable_discovery")]);
    m_enable_discovery_isSet = !json[QString("enable_discovery")].isNull() && m_enable_discovery_isValid;
}

QString OAIChangeDiscoverabilityRequest::asJson() const {
...
QJsonObject OAIChangeDiscoverabilityRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_enable_discovery_isSet) {
        obj.insert(QString("enable_discovery"), ::OpenAPI::toJsonValue(m_enable_discovery));
    }
    return obj;
}

bool OAIChangeDiscoverabilityRequest::isEnableDiscovery() const {
    return m_enable_discovery;
}
void OAIChangeDiscoverabilityRequest::setEnableDiscovery(const bool &enable_discovery) {
    m_enable_discovery = enable_discovery;
    m_enable_discovery_isSet = true;
}

bool OAIChangeDiscoverabilityRequest::is_enable_discovery_Set() const{
    return m_enable_discovery_isSet;
}

bool OAIChangeDiscoverabilityRequest::is_enable_discovery_Valid() const{
    return m_enable_discovery_isValid;
}

bool OAIChangeDiscoverabilityRequest::isSet() const {
...
bool OAIChangeDiscoverabilityRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_enable_discovery_isValid && true;
}
