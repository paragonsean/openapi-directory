...
#ifndef OAISettings1_H
#define OAISettings1_H
...
class OAISettings1 : public OAIObject {
public:
    OAISettings1();
    OAISettings1(QString json);
    ~OAISettings1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISettings1)

#endif // OAISettings1_H
