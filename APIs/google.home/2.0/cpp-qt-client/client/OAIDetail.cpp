...
void OAIDetail::initializeModel() {
    ...
    m_icon_list_isSet = false;
    m_icon_list_isValid = false;
...
void OAIDetail::fromJsonObject(QJsonObject json) {
    ...
    m_icon_list_isValid = ::OpenAPI::fromJsonValue(m_icon_list, json[QString("icon_list")]);
    m_icon_list_isSet = !json[QString("icon_list")].isNull() && m_icon_list_isValid;
...
QJsonObject OAIDetail::asJsonObject() const {
    ...
    if (m_icon_list.size() > 0) {
        obj.insert(QString("icon_list"), ::OpenAPI::toJsonValue(m_icon_list));
    }
    if (m_locale.isSet()) {
...
QList<OAIIconList> OAIDetail::getIconList() const {
    return m_icon_list;
}
void OAIDetail::setIconList(const QList<OAIIconList> &icon_list) {
    m_icon_list = icon_list;
    m_icon_list_isSet = true;
}

bool OAIDetail::is_icon_list_Set() const{
    return m_icon_list_isSet;
}

bool OAIDetail::is_icon_list_Valid() const{
    return m_icon_list_isValid;
}

OAILocale OAIDetail::getLocale() const {
    return m_locale;
}
void OAIDetail::setLocale(const OAILocale &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIDetail::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIDetail::is_locale_Valid() const{
    return m_locale_isValid;
}

OAITimezone OAIDetail::getTimezone() const {
    return m_timezone;
}
void OAIDetail::setTimezone(const OAITimezone &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIDetail::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIDetail::is_timezone_Valid() const{
...
bool OAIDetail::isValid() const {
    ...
    return m_icon_list_isValid && m_locale_isValid && m_timezone_isValid && true;
}
