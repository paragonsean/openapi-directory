...
/*
 * OAIAccessibilityRequest.h
 *
 * 
 */

#ifndef OAIAccessibilityRequest_H
#define OAIAccessibilityRequest_H
...
class OAIAccessibilityRequest : public OAIObject {
public:
    OAIAccessibilityRequest();
    OAIAccessibilityRequest(QString json);
    ~OAIAccessibilityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessibilityRequest)

#endif // OAIAccessibilityRequest_H
