...
class OAIUserEq : public OAIObject {
public:
    OAIUserEq();
    OAIUserEq(QString json);
    ~OAIUserEq() override;
    ...
    OAIHighShelf getHighShelf() const;
    void setHighShelf(const OAIHighShelf &high_shelf);
    bool is_high_shelf_Set() const;
    bool is_high_shelf_Valid() const;

    OAILowShelf getLowShelf() const;
    void setLowShelf(const OAILowShelf &low_shelf);
    bool is_low_shelf_Set() const;
    bool is_low_shelf_Valid() const;

    qint32 getMaxPeakingEqs() const;
    void setMaxPeakingEqs(const qint32 &max_peaking_eqs);
    bool is_max_peaking_eqs_Set() const;
    bool is_max_peaking_eqs_Valid() const;

    QList<QString> getPeakingEqs() const;
    void setPeakingEqs(const QList<QString> &peaking_eqs);
    bool is_peaking_eqs_Set() const;
    bool is_peaking_eqs_Valid() const;
...
private:
    ...
    OAIHighShelf m_high_shelf;
    bool m_high_shelf_isSet;
    bool m_high_shelf_isValid;

    OAILowShelf m_low_shelf;
    bool m_low_shelf_isSet;
    bool m_low_shelf_isValid;

    qint32 m_max_peaking_eqs;
    bool m_max_peaking_eqs_isSet;
    bool m_max_peaking_eqs_isValid;

    QList<QString> m_peaking_eqs;
    bool m_peaking_eqs_isSet;
    bool m_peaking_eqs_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUserEq)
