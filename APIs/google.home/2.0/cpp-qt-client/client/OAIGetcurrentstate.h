...
/*
 * OAIGetcurrentstate.h
 *
 * 
 */

#ifndef OAIGetcurrentstate_H
#define OAIGetcurrentstate_H
...
class OAIGetcurrentstate : public OAIObject {
public:
    OAIGetcurrentstate();
    OAIGetcurrentstate(QString json);
    ~OAIGetcurrentstate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetcurrentstate)

#endif // OAIGetcurrentstate_H
