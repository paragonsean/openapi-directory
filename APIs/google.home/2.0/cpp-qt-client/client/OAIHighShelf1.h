...
#ifndef OAIHighShelf1_H
#define OAIHighShelf1_H
...
class OAIHighShelf1 : public OAIObject {
public:
    OAIHighShelf1();
    OAIHighShelf1(QString json);
    ~OAIHighShelf1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHighShelf1)

#endif // OAIHighShelf1_H
