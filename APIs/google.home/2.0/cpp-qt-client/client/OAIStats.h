...
public:
    ...
    qint32 getNumCheckConnectivity() const;
    void setNumCheckConnectivity(const qint32 &num_check_connectivity);
    bool is_num_check_connectivity_Set() const;
    bool is_num_check_connectivity_Valid() const;

    qint32 getNumConnectWifi() const;
    void setNumConnectWifi(const qint32 &num_connect_wifi);
    bool is_num_connect_wifi_Set() const;
    bool is_num_connect_wifi_Valid() const;

    qint32 getNumConnectedWifiNotSaved() const;
    void setNumConnectedWifiNotSaved(const qint32 &num_connected_wifi_not_saved);
    bool is_num_connected_wifi_not_saved_Set() const;
    bool is_num_connected_wifi_not_saved_Valid() const;

    qint32 getNumInitialEurekaInfo() const;
    void setNumInitialEurekaInfo(const qint32 &num_initial_eureka_info);
    bool is_num_initial_eureka_info_Set() const;
    bool is_num_initial_eureka_info_Valid() const;

    qint32 getNumObtainIp() const;
    void setNumObtainIp(const qint32 &num_obtain_ip);
    bool is_num_obtain_ip_Set() const;
    bool is_num_obtain_ip_Valid() const;
...
private:
    ...
    qint32 m_num_check_connectivity;
    bool m_num_check_connectivity_isSet;
    bool m_num_check_connectivity_isValid;

    qint32 m_num_connect_wifi;
    bool m_num_connect_wifi_isSet;
    bool m_num_connect_wifi_isValid;

    qint32 m_num_connected_wifi_not_saved;
    bool m_num_connected_wifi_not_saved_isSet;
    bool m_num_connected_wifi_not_saved_isValid;

    qint32 m_num_initial_eureka_info;
    bool m_num_initial_eureka_info_isSet;
    bool m_num_initial_eureka_info_isValid;

    qint32 m_num_obtain_ip;
    bool m_num_obtain_ip_isSet;
    bool m_num_obtain_ip_isValid;
};
