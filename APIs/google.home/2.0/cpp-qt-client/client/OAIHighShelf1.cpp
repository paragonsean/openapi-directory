...
OAIHighShelf1::OAIHighShelf1(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHighShelf1::OAIHighShelf1() {
    this->initializeModel();
}

OAIHighShelf1::~OAIHighShelf1() {}

void OAIHighShelf1::initializeModel() {

    m_gain_db_isSet = false;
    m_gain_db_isValid = false;
}

void OAIHighShelf1::fromJson(QString jsonString) {
...
void OAIHighShelf1::fromJsonObject(QJsonObject json) {
...
QString OAIHighShelf1::asJson() const {
...
QJsonObject OAIHighShelf1::asJsonObject() const {
    QJsonObject obj;
    if (m_gain_db_isSet) {
...
qint32 OAIHighShelf1::getGainDb() const {
    return m_gain_db;
}
void OAIHighShelf1::setGainDb(const qint32 &gain_db) {
    m_gain_db = gain_db;
    m_gain_db_isSet = true;
}

bool OAIHighShelf1::is_gain_db_Set() const{
    return m_gain_db_isSet;
}

bool OAIHighShelf1::is_gain_db_Valid() const{
    return m_gain_db_isValid;
}

bool OAIHighShelf1::isSet() const {
...
bool OAIHighShelf1::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_gain_db_isValid && true;
}
