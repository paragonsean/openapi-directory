...
/*
 * OAIForgetWi_FiNetworkRequest.h
 *
 * 
 */

#ifndef OAIForgetWi_FiNetworkRequest_H
#define OAIForgetWi_FiNetworkRequest_H
...
class OAIForgetWi_FiNetworkRequest : public OAIObject {
public:
    OAIForgetWi_FiNetworkRequest();
    OAIForgetWi_FiNetworkRequest(QString json);
    ~OAIForgetWi_FiNetworkRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForgetWi_FiNetworkRequest)

#endif // OAIForgetWi_FiNetworkRequest_H
