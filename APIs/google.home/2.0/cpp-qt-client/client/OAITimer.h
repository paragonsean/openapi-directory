...
class OAITimer : public OAIObject {
public:
    OAITimer();
    OAITimer(QString json);
    ~OAITimer() override;
    ...
    qint64 getFireTime() const;
    void setFireTime(const qint64 &fire_time);
    ...
    qint32 getOriginalDuration() const;
    void setOriginalDuration(const qint32 &original_duration);
    bool is_original_duration_Set() const;
    bool is_original_duration_Valid() const;
...
private:
    ...
    qint32 m_original_duration;
    bool m_original_duration_isSet;
    bool m_original_duration_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimer)
