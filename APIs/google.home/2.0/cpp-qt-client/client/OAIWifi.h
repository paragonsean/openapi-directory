...
class OAIWifi : public OAIObject {
public:
    OAIWifi();
    OAIWifi(QString json);
    ~OAIWifi() override;
    ...
    bool isHasChanges() const;
    void setHasChanges(const bool &has_changes);
    bool is_has_changes_Set() const;
    bool is_has_changes_Valid() const;

    qint32 getNoiseLevel() const;
    void setNoiseLevel(const qint32 &noise_level);
    ...
    bool isWpaConfigured() const;
    void setWpaConfigured(const bool &wpa_configured);
    bool is_wpa_configured_Set() const;
    bool is_wpa_configured_Valid() const;
    ...
    qint32 getWpaState() const;
    void setWpaState(const qint32 &wpa_state);
    bool is_wpa_state_Set() const;
    bool is_wpa_state_Valid() const;
...
private:
    ...
    bool m_has_changes;
    bool m_has_changes_isSet;
    bool m_has_changes_isValid;

    qint32 m_noise_level;
    ...
    bool m_wpa_configured;
    bool m_wpa_configured_isSet;
    bool m_wpa_configured_isValid;
    ...
    qint32 m_wpa_state;
    bool m_wpa_state_isSet;
    bool m_wpa_state_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIWifi)
