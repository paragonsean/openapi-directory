...
public:
    ...
    QString getQrSsidSuffix() const;
    void setQrSsidSuffix(const QString &qr_ssid_suffix);
    bool is_qr_ssid_suffix_Set() const;
    bool is_qr_ssid_suffix_Valid() const;

    qint32 getSetupState() const;
    void setSetupState(const qint32 &setup_state);
    bool is_setup_state_Set() const;
    bool is_setup_state_Valid() const;

    QString getSsidSuffix() const;
    void setSsidSuffix(const QString &ssid_suffix);
    bool is_ssid_suffix_Set() const;
    bool is_ssid_suffix_Valid() const;
    ...
    bool isTosAccepted() const;
    void setTosAccepted(const bool &tos_accepted);
    bool is_tos_accepted_Set() const;
    bool is_tos_accepted_Valid() const;
...
private:
    ...
    QString m_qr_ssid_suffix;
    bool m_qr_ssid_suffix_isSet;
    bool m_qr_ssid_suffix_isValid;

    qint32 m_setup_state;
    bool m_setup_state_isSet;
    bool m_setup_state_isValid;

    QString m_ssid_suffix;
    bool m_ssid_suffix_isSet;
    bool m_ssid_suffix_isValid;
    ...
    bool m_tos_accepted;
    bool m_tos_accepted_isSet;
    bool m_tos_accepted_isValid;
};
