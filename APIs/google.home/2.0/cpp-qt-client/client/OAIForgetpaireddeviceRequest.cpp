...
#include "OAIForgetpaireddeviceRequest.h"
...
OAIForgetpaireddeviceRequest::OAIForgetpaireddeviceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForgetpaireddeviceRequest::OAIForgetpaireddeviceRequest() {
    this->initializeModel();
}

OAIForgetpaireddeviceRequest::~OAIForgetpaireddeviceRequest() {}

void OAIForgetpaireddeviceRequest::initializeModel() {
...
void OAIForgetpaireddeviceRequest::fromJson(QString jsonString) {
...
void OAIForgetpaireddeviceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIForgetpaireddeviceRequest::asJson() const {
...
QJsonObject OAIForgetpaireddeviceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_bond_isSet) {
...
bool OAIForgetpaireddeviceRequest::isBond() const {
    return m_bond;
}
void OAIForgetpaireddeviceRequest::setBond(const bool &bond) {
    m_bond = bond;
    m_bond_isSet = true;
}

bool OAIForgetpaireddeviceRequest::is_bond_Set() const{
    return m_bond_isSet;
}

bool OAIForgetpaireddeviceRequest::is_bond_Valid() const{
    return m_bond_isValid;
}

QString OAIForgetpaireddeviceRequest::getMacAddress() const {
    return m_mac_address;
}
void OAIForgetpaireddeviceRequest::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIForgetpaireddeviceRequest::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIForgetpaireddeviceRequest::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

bool OAIForgetpaireddeviceRequest::isSet() const {
...
bool OAIForgetpaireddeviceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_bond_isValid && m_mac_address_isValid && true;
}
