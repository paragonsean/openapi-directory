...
/*
 * OAIChangeDiscoverabilityRequest.h
 *
 * 
 */

#ifndef OAIChangeDiscoverabilityRequest_H
#define OAIChangeDiscoverabilityRequest_H
...
class OAIChangeDiscoverabilityRequest : public OAIObject {
public:
    OAIChangeDiscoverabilityRequest();
    OAIChangeDiscoverabilityRequest(QString json);
    ~OAIChangeDiscoverabilityRequest() override;
    ...
    bool isEnableDiscovery() const;
    void setEnableDiscovery(const bool &enable_discovery);
    bool is_enable_discovery_Set() const;
    bool is_enable_discovery_Valid() const;
...
private:
    ...
    bool m_enable_discovery;
    bool m_enable_discovery_isSet;
    bool m_enable_discovery_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIChangeDiscoverabilityRequest)

#endif // OAIChangeDiscoverabilityRequest_H
