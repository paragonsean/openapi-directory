...
#ifndef OAIExample112_H
#define OAIExample112_H
...
class OAIExample112 : public OAIObject {
public:
    OAIExample112();
    OAIExample112(QString json);
    ~OAIExample112() override;
    ...
    qint32 getExpectedProfiles() const;
    void setExpectedProfiles(const qint32 &expected_profiles);
    bool is_expected_profiles_Set() const;
    bool is_expected_profiles_Valid() const;
...
private:
    ...
    qint32 m_expected_profiles;
    bool m_expected_profiles_isSet;
    bool m_expected_profiles_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExample112)

#endif // OAIExample112_H
