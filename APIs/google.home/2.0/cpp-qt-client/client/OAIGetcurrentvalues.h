...
/*
 * OAIGetcurrentvalues.h
 *
 * 
 */

#ifndef OAIGetcurrentvalues_H
#define OAIGetcurrentvalues_H
...
class OAIGetcurrentvalues : public OAIObject {
public:
    OAIGetcurrentvalues();
    OAIGetcurrentvalues(QString json);
    ~OAIGetcurrentvalues() override;
    ...
    bool isEndpointEnabled() const;
    void setEndpointEnabled(const bool &endpoint_enabled);
    bool is_endpoint_enabled_Set() const;
    bool is_endpoint_enabled_Valid() const;

    bool isHotwordEnabled() const;
    void setHotwordEnabled(const bool &hotword_enabled);
    bool is_hotword_enabled_Set() const;
    bool is_hotword_enabled_Valid() const;
...
private:
    ...
    bool m_endpoint_enabled;
    bool m_endpoint_enabled_isSet;
    bool m_endpoint_enabled_isValid;

    bool m_hotword_enabled;
    bool m_hotword_enabled_isSet;
    bool m_hotword_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetcurrentvalues)

#endif // OAIGetcurrentvalues_H
