...
OAILowShelf::OAILowShelf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILowShelf::OAILowShelf() {
    this->initializeModel();
}

OAILowShelf::~OAILowShelf() {}

void OAILowShelf::initializeModel() {
...
void OAILowShelf::fromJson(QString jsonString) {
...
void OAILowShelf::fromJsonObject(QJsonObject json) {

    m_frequency_isValid = ::OpenAPI::fromJsonValue(m_frequency, json[QString("frequency")]);
    m_frequency_isSet = !json[QString("frequency")].isNull() && m_frequency_isValid;

    m_gain_db_isValid = ::OpenAPI::fromJsonValue(m_gain_db, json[QString("gain_db")]);
    m_gain_db_isSet = !json[QString("gain_db")].isNull() && m_gain_db_isValid;
...
QString OAILowShelf::asJson() const {
...
QJsonObject OAILowShelf::asJsonObject() const {
    QJsonObject obj;
    if (m_frequency_isSet) {
        obj.insert(QString("frequency"), ::OpenAPI::toJsonValue(m_frequency));
    }
    if (m_gain_db_isSet) {
        obj.insert(QString("gain_db"), ::OpenAPI::toJsonValue(m_gain_db));
    }
    if (m_quality_isSet) {
...
qint32 OAILowShelf::getFrequency() const {
    return m_frequency;
}
void OAILowShelf::setFrequency(const qint32 &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAILowShelf::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAILowShelf::is_frequency_Valid() const{
    return m_frequency_isValid;
}

qint32 OAILowShelf::getGainDb() const {
    return m_gain_db;
}
void OAILowShelf::setGainDb(const qint32 &gain_db) {
    m_gain_db = gain_db;
    m_gain_db_isSet = true;
}

bool OAILowShelf::is_gain_db_Set() const{
    return m_gain_db_isSet;
}

bool OAILowShelf::is_gain_db_Valid() const{
    return m_gain_db_isValid;
}

double OAILowShelf::getQuality() const {
    return m_quality;
}
void OAILowShelf::setQuality(const double &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAILowShelf::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAILowShelf::is_quality_Valid() const{
    return m_quality_isValid;
}

bool OAILowShelf::isSet() const {
...
bool OAILowShelf::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_frequency_isValid && m_gain_db_isValid && m_quality_isValid && true;
}
