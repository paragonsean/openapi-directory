...
/*
 * OAITestInternetDownloadSpeedRequest.h
 *
 * 
 */

#ifndef OAITestInternetDownloadSpeedRequest_H
#define OAITestInternetDownloadSpeedRequest_H
...
class OAITestInternetDownloadSpeedRequest : public OAIObject {
public:
    OAITestInternetDownloadSpeedRequest();
    OAITestInternetDownloadSpeedRequest(QString json);
    ~OAITestInternetDownloadSpeedRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestInternetDownloadSpeedRequest)

#endif // OAITestInternetDownloadSpeedRequest_H
