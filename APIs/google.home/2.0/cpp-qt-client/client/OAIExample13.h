...
#ifndef OAIExample13_H
#define OAIExample13_H
...
class OAIExample13 : public OAIObject {
public:
    OAIExample13();
    OAIExample13(QString json);
    ~OAIExample13() override;
    ...
    bool isCanEnroll() const;
    void setCanEnroll(const bool &can_enroll);
    bool is_can_enroll_Set() const;
    bool is_can_enroll_Valid() const;

    qint32 getEnrollmentState() const;
    void setEnrollmentState(const qint32 &enrollment_state);
...
private:
    ...
    bool m_can_enroll;
    bool m_can_enroll_isSet;
    bool m_can_enroll_isValid;

    qint32 m_enrollment_state;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExample13)

#endif // OAIExample13_H
