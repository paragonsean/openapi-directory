...
OAIExample11::OAIExample11(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExample11::OAIExample11() {
    this->initializeModel();
}

OAIExample11::~OAIExample11() {}

void OAIExample11::initializeModel() {

    m_app_device_id_isSet = false;
    m_app_device_id_isValid = false;

    m_certificate_isSet = false;
    m_certificate_isValid = false;

    m_signed_data_isSet = false;
    m_signed_data_isValid = false;
}

void OAIExample11::fromJson(QString jsonString) {
...
void OAIExample11::fromJsonObject(QJsonObject json) {

    m_app_device_id_isValid = ::OpenAPI::fromJsonValue(m_app_device_id, json[QString("app_device_id")]);
    m_app_device_id_isSet = !json[QString("app_device_id")].isNull() && m_app_device_id_isValid;
    ...
    m_signed_data_isValid = ::OpenAPI::fromJsonValue(m_signed_data, json[QString("signed_data")]);
    m_signed_data_isSet = !json[QString("signed_data")].isNull() && m_signed_data_isValid;
}

QString OAIExample11::asJson() const {
...
QJsonObject OAIExample11::asJsonObject() const {
    QJsonObject obj;
    if (m_app_device_id_isSet) {
        obj.insert(QString("app_device_id"), ::OpenAPI::toJsonValue(m_app_device_id));
    }
    if (m_certificate_isSet) {
        obj.insert(QString("certificate"), ::OpenAPI::toJsonValue(m_certificate));
    }
    if (m_signed_data_isSet) {
        obj.insert(QString("signed_data"), ::OpenAPI::toJsonValue(m_signed_data));
    }
    return obj;
}

QString OAIExample11::getAppDeviceId() const {
    return m_app_device_id;
}
void OAIExample11::setAppDeviceId(const QString &app_device_id) {
    m_app_device_id = app_device_id;
    m_app_device_id_isSet = true;
}

bool OAIExample11::is_app_device_id_Set() const{
    return m_app_device_id_isSet;
}

bool OAIExample11::is_app_device_id_Valid() const{
    return m_app_device_id_isValid;
}

QString OAIExample11::getCertificate() const {
    return m_certificate;
}
void OAIExample11::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIExample11::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIExample11::is_certificate_Valid() const{
    return m_certificate_isValid;
}

QString OAIExample11::getSignedData() const {
    return m_signed_data;
}
void OAIExample11::setSignedData(const QString &signed_data) {
    m_signed_data = signed_data;
    m_signed_data_isSet = true;
}

bool OAIExample11::is_signed_data_Set() const{
    return m_signed_data_isSet;
}

bool OAIExample11::is_signed_data_Valid() const{
    return m_signed_data_isValid;
}

bool OAIExample11::isSet() const {
...
bool OAIExample11::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_app_device_id_isValid && m_certificate_isValid && m_signed_data_isValid && true;
}
