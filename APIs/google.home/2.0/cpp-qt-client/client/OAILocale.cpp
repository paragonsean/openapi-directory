...
QString OAILocale::getDisplayString() const {
    return m_display_string;
}
void OAILocale::setDisplayString(const QString &display_string) {
    m_display_string = display_string;
    m_display_string_isSet = true;
}

bool OAILocale::is_display_string_Set() const{
    return m_display_string_isSet;
}

bool OAILocale::is_display_string_Valid() const{
...
bool OAILocale::isValid() const {
    ...
    return m_display_string_isValid && true;
}
