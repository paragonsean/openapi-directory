...
public class Example12 {
  ...
  public Example12 token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example12 example12 = (Example12) o;
    return Objects.equals(this.token, example12.token);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example12 is not found in the empty JSON string", Example12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example12.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example12.class));

       return (TypeAdapter<T>) new TypeAdapter<Example12>() {
           @Override
           public void write(JsonWriter out, Example12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example12 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example12 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example12
   * @throws IOException if the JSON string is invalid with respect to Example12
   */
  public static Example12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example12.class);
  }

  /**
   * Convert an instance of Example12 to an JSON string
   *
   * @return JSON string
   */
