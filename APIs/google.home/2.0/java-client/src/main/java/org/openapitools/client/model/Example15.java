...
public class Example15 {
  ...
  public Example15 displayString(String displayString) {
  ...
  public Example15 locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example15 example15 = (Example15) o;
    return Objects.equals(this.displayString, example15.displayString) &&
        Objects.equals(this.locale, example15.locale);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayString, locale);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example15 {\n");
  ...
  static {
    ...
    openapiFields.add("display_string");
    openapiFields.add("locale");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("display_string");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example15
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example15.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example15 is not found in the empty JSON string", Example15.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example15.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example15` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example15.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("display_string").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `display_string` to be a primitive type in the JSON string but got `%s`", jsonObj.get("display_string").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example15.class));

       return (TypeAdapter<T>) new TypeAdapter<Example15>() {
           @Override
           public void write(JsonWriter out, Example15 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example15 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example15 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example15
   * @throws IOException if the JSON string is invalid with respect to Example15
   */
  public static Example15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example15.class);
  }

  /**
   * Convert an instance of Example15 to an JSON string
   *
   * @return JSON string
   */
