...
public class Example11 {
  public static final String SERIALIZED_NAME_APP_DEVICE_ID = "app_device_id";
  @SerializedName(SERIALIZED_NAME_APP_DEVICE_ID)
  ...
  public Example11 appDeviceId(String appDeviceId) {
  ...
  public Example11 certificate(String certificate) {
  ...
  public Example11 signedData(String signedData) {
  ...
  public boolean equals(Object o) {
    ...
    Example11 example11 = (Example11) o;
    return Objects.equals(this.appDeviceId, example11.appDeviceId) &&
        Objects.equals(this.certificate, example11.certificate) &&
        Objects.equals(this.signedData, example11.signedData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appDeviceId, certificate, signedData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example11 {\n");
  ...
  static {
    ...
    openapiFields.add("app_device_id");
    openapiFields.add("certificate");
    openapiFields.add("signed_data");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("app_device_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example11 is not found in the empty JSON string", Example11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example11.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("app_device_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `app_device_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("app_device_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example11.class));

       return (TypeAdapter<T>) new TypeAdapter<Example11>() {
           @Override
           public void write(JsonWriter out, Example11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example11
   * @throws IOException if the JSON string is invalid with respect to Example11
   */
  public static Example11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example11.class);
  }

  /**
   * Convert an instance of Example11 to an JSON string
   *
   * @return JSON string
   */
