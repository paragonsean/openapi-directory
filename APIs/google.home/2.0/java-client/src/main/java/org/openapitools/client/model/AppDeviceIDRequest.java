...
public class AppDeviceIDRequest {
  ...
  public AppDeviceIDRequest appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AppDeviceIDRequest appDeviceIDRequest = (AppDeviceIDRequest) o;
    return Objects.equals(this.appId, appDeviceIDRequest.appId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppDeviceIDRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppDeviceIDRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppDeviceIDRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDeviceIDRequest is not found in the empty JSON string", AppDeviceIDRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppDeviceIDRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppDeviceIDRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppDeviceIDRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDeviceIDRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDeviceIDRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDeviceIDRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDeviceIDRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDeviceIDRequest>() {
           @Override
           public void write(JsonWriter out, AppDeviceIDRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppDeviceIDRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppDeviceIDRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppDeviceIDRequest
   * @throws IOException if the JSON string is invalid with respect to AppDeviceIDRequest
   */
  public static AppDeviceIDRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDeviceIDRequest.class);
  }

  /**
   * Convert an instance of AppDeviceIDRequest to an JSON string
   *
   * @return JSON string
   */
