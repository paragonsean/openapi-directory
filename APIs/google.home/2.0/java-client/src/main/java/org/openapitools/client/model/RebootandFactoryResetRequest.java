...
public class RebootandFactoryResetRequest {
  ...
  public RebootandFactoryResetRequest() {
  }

  public RebootandFactoryResetRequest params(String params) {
    this.params = params;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RebootandFactoryResetRequest rebootandFactoryResetRequest = (RebootandFactoryResetRequest) o;
    return Objects.equals(this.params, rebootandFactoryResetRequest.params);
  }
  ...
  public String toString() {
    ...
    sb.append("class RebootandFactoryResetRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebootandFactoryResetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebootandFactoryResetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RebootandFactoryResetRequest is not found in the empty JSON string", RebootandFactoryResetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RebootandFactoryResetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RebootandFactoryResetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RebootandFactoryResetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RebootandFactoryResetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RebootandFactoryResetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RebootandFactoryResetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RebootandFactoryResetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RebootandFactoryResetRequest>() {
           @Override
           public void write(JsonWriter out, RebootandFactoryResetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RebootandFactoryResetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RebootandFactoryResetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RebootandFactoryResetRequest
   * @throws IOException if the JSON string is invalid with respect to RebootandFactoryResetRequest
   */
  public static RebootandFactoryResetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RebootandFactoryResetRequest.class);
  }

  /**
   * Convert an instance of RebootandFactoryResetRequest to an JSON string
   *
   * @return JSON string
   */
