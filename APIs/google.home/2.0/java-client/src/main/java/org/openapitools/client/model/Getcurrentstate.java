...
public class Getcurrentstate {
  ...
  public Getcurrentstate notificationsEnabled(Boolean notificationsEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    Getcurrentstate getcurrentstate = (Getcurrentstate) o;
    return Objects.equals(this.notificationsEnabled, getcurrentstate.notificationsEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(notificationsEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Getcurrentstate {\n");
  ...
  static {
    ...
    openapiFields.add("notifications_enabled");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("notifications_enabled");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getcurrentstate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getcurrentstate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getcurrentstate is not found in the empty JSON string", Getcurrentstate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getcurrentstate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getcurrentstate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Getcurrentstate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getcurrentstate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getcurrentstate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getcurrentstate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getcurrentstate.class));

       return (TypeAdapter<T>) new TypeAdapter<Getcurrentstate>() {
           @Override
           public void write(JsonWriter out, Getcurrentstate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getcurrentstate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getcurrentstate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getcurrentstate
   * @throws IOException if the JSON string is invalid with respect to Getcurrentstate
   */
  public static Getcurrentstate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getcurrentstate.class);
  }

  /**
   * Convert an instance of Getcurrentstate to an JSON string
   *
   * @return JSON string
   */
