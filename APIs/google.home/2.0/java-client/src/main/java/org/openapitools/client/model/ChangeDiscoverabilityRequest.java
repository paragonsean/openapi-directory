...
public class ChangeDiscoverabilityRequest {
  public static final String SERIALIZED_NAME_ENABLE_DISCOVERY = "enable_discovery";
  @SerializedName(SERIALIZED_NAME_ENABLE_DISCOVERY)
  private Boolean enableDiscovery;

  public ChangeDiscoverabilityRequest() {
  }

  public ChangeDiscoverabilityRequest enableDiscovery(Boolean enableDiscovery) {
  ...
  public boolean equals(Object o) {
    ...
    ChangeDiscoverabilityRequest changeDiscoverabilityRequest = (ChangeDiscoverabilityRequest) o;
    return Objects.equals(this.enableDiscovery, changeDiscoverabilityRequest.enableDiscovery);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enableDiscovery);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChangeDiscoverabilityRequest {\n");
  ...
  static {
    ...
    openapiFields.add("enable_discovery");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("enable_discovery");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeDiscoverabilityRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeDiscoverabilityRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeDiscoverabilityRequest is not found in the empty JSON string", ChangeDiscoverabilityRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeDiscoverabilityRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeDiscoverabilityRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeDiscoverabilityRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeDiscoverabilityRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeDiscoverabilityRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeDiscoverabilityRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeDiscoverabilityRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeDiscoverabilityRequest>() {
           @Override
           public void write(JsonWriter out, ChangeDiscoverabilityRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeDiscoverabilityRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeDiscoverabilityRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeDiscoverabilityRequest
   * @throws IOException if the JSON string is invalid with respect to ChangeDiscoverabilityRequest
   */
  public static ChangeDiscoverabilityRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeDiscoverabilityRequest.class);
  }

  /**
   * Convert an instance of ChangeDiscoverabilityRequest to an JSON string
   *
   * @return JSON string
   */
