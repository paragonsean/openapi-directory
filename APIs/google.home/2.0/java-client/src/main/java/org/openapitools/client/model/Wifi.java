...
public class Wifi {
  ...
  public static final String SERIALIZED_NAME_HAS_CHANGES = "has_changes";
  @SerializedName(SERIALIZED_NAME_HAS_CHANGES)
  private Boolean hasChanges;

  public static final String SERIALIZED_NAME_NOISE_LEVEL = "noise_level";
  @SerializedName(SERIALIZED_NAME_NOISE_LEVEL)
  private Integer noiseLevel;

  public static final String SERIALIZED_NAME_SIGNAL_LEVEL = "signal_level";
  @SerializedName(SERIALIZED_NAME_SIGNAL_LEVEL)
  ...
  public static final String SERIALIZED_NAME_WPA_CONFIGURED = "wpa_configured";
  @SerializedName(SERIALIZED_NAME_WPA_CONFIGURED)
  ...
  public static final String SERIALIZED_NAME_WPA_STATE = "wpa_state";
  @SerializedName(SERIALIZED_NAME_WPA_STATE)
  private Integer wpaState;

  public Wifi() {
  }

  public Wifi bssid(String bssid) {
    this.bssid = bssid;
    return this;
  }
  ...
  public Wifi hasChanges(Boolean hasChanges) {
  ...
  public Wifi noiseLevel(Integer noiseLevel) {
  ...
  public Wifi signalLevel(Integer signalLevel) {
  ...
  public Wifi wpaConfigured(Boolean wpaConfigured) {
  ...
  public Wifi wpaId(Integer wpaId) {
    this.wpaId = wpaId;
    return this;
  }
  ...
  public Wifi wpaState(Integer wpaState) {
  ...
  public boolean equals(Object o) {
    ...
    Wifi wifi = (Wifi) o;
    return Objects.equals(this.bssid, wifi.bssid) &&
        Objects.equals(this.hasChanges, wifi.hasChanges) &&
        Objects.equals(this.noiseLevel, wifi.noiseLevel) &&
        Objects.equals(this.signalLevel, wifi.signalLevel) &&
        Objects.equals(this.ssid, wifi.ssid) &&
        Objects.equals(this.wpaConfigured, wifi.wpaConfigured) &&
        Objects.equals(this.wpaId, wifi.wpaId) &&
        Objects.equals(this.wpaState, wifi.wpaState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bssid, hasChanges, noiseLevel, signalLevel, ssid, wpaConfigured, wpaId, wpaState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Wifi {\n");
    ...
    sb.append("    wpaConfigured: ").append(toIndentedString(wpaConfigured)).append("\n");
    sb.append("    wpaId: ").append(toIndentedString(wpaId)).append("\n");
    sb.append("    wpaState: ").append(toIndentedString(wpaState)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("has_changes");
    openapiFields.add("noise_level");
    openapiFields.add("signal_level");
    openapiFields.add("ssid");
    openapiFields.add("wpa_configured");
    openapiFields.add("wpa_id");
    openapiFields.add("wpa_state");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("bssid");
    openapiRequiredFields.add("has_changes");
    openapiRequiredFields.add("noise_level");
    openapiRequiredFields.add("signal_level");
    openapiRequiredFields.add("ssid");
    openapiRequiredFields.add("wpa_configured");
    openapiRequiredFields.add("wpa_id");
    openapiRequiredFields.add("wpa_state");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Wifi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Wifi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Wifi is not found in the empty JSON string", Wifi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Wifi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Wifi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Wifi.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("bssid").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Wifi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Wifi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Wifi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Wifi.class));

       return (TypeAdapter<T>) new TypeAdapter<Wifi>() {
           @Override
           public void write(JsonWriter out, Wifi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Wifi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Wifi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Wifi
   * @throws IOException if the JSON string is invalid with respect to Wifi
   */
  public static Wifi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Wifi.class);
  }

  /**
   * Convert an instance of Wifi to an JSON string
   *
   * @return JSON string
   */
