...
public class ForgetWiFiNetworkRequest {
  ...
  public ForgetWiFiNetworkRequest() {
  }

  public ForgetWiFiNetworkRequest wpaId(Integer wpaId) {
    this.wpaId = wpaId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ForgetWiFiNetworkRequest forgetWiFiNetworkRequest = (ForgetWiFiNetworkRequest) o;
    return Objects.equals(this.wpaId, forgetWiFiNetworkRequest.wpaId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(wpaId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ForgetWiFiNetworkRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgetWiFiNetworkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgetWiFiNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForgetWiFiNetworkRequest is not found in the empty JSON string", ForgetWiFiNetworkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgetWiFiNetworkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForgetWiFiNetworkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ForgetWiFiNetworkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForgetWiFiNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForgetWiFiNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForgetWiFiNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForgetWiFiNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ForgetWiFiNetworkRequest>() {
           @Override
           public void write(JsonWriter out, ForgetWiFiNetworkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForgetWiFiNetworkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForgetWiFiNetworkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForgetWiFiNetworkRequest
   * @throws IOException if the JSON string is invalid with respect to ForgetWiFiNetworkRequest
   */
  public static ForgetWiFiNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForgetWiFiNetworkRequest.class);
  }

  /**
   * Convert an instance of ForgetWiFiNetworkRequest to an JSON string
   *
   * @return JSON string
   */
