...
public class DatePattern {
  ...
  public DatePattern day(Integer day) {
    this.day = day;
    return this;
  }
  ...
  public DatePattern month(Integer month) {
    this.month = month;
    return this;
  }
  ...
  public DatePattern year(Integer year) {
    this.year = year;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatePattern datePattern = (DatePattern) o;
    return Objects.equals(this.day, datePattern.day) &&
        Objects.equals(this.month, datePattern.month) &&
        Objects.equals(this.year, datePattern.year);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatePattern
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatePattern.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatePattern is not found in the empty JSON string", DatePattern.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatePattern.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatePattern` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatePattern.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatePattern.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatePattern' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatePattern> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatePattern.class));

       return (TypeAdapter<T>) new TypeAdapter<DatePattern>() {
           @Override
           public void write(JsonWriter out, DatePattern value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatePattern read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatePattern given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatePattern
   * @throws IOException if the JSON string is invalid with respect to DatePattern
   */
  public static DatePattern fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatePattern.class);
  }

  /**
   * Convert an instance of DatePattern to an JSON string
   *
   * @return JSON string
   */
