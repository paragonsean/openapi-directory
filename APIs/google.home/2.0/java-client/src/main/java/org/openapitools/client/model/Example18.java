...
public class Example18 {
  ...
  public Example18 alarm(List<Alarm> alarm) {
    this.alarm = alarm;
    return this;
  }

  public Example18 addAlarmItem(Alarm alarmItem) {
    if (this.alarm == null) {
      this.alarm = new ArrayList<>();
    }
    this.alarm.add(alarmItem);
    return this;
  }
  ...
  public Example18 timer(List<Timer> timer) {
    this.timer = timer;
    return this;
  }

  public Example18 addTimerItem(Timer timerItem) {
    if (this.timer == null) {
      this.timer = new ArrayList<>();
    }
    this.timer.add(timerItem);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example18 example18 = (Example18) o;
    return Objects.equals(this.alarm, example18.alarm) &&
        Objects.equals(this.timer, example18.timer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alarm, timer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example18 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("alarm");
    openapiRequiredFields.add("timer");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example18
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example18.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example18 is not found in the empty JSON string", Example18.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example18.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example18` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example18.openapiRequiredFields) {
      ...
      if (!jsonObj.get("alarm").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `alarm` to be an array in the JSON string but got `%s`", jsonObj.get("alarm").toString()));
      }

      JsonArray jsonArrayalarm = jsonObj.getAsJsonArray("alarm");
      // validate the required field `alarm` (array)
      for (int i = 0; i < jsonArrayalarm.size(); i++) {
        Alarm.validateJsonElement(jsonArrayalarm.get(i));
      };
      // ensure the json data is an array
      if (!jsonObj.get("timer").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `timer` to be an array in the JSON string but got `%s`", jsonObj.get("timer").toString()));
      }

      JsonArray jsonArraytimer = jsonObj.getAsJsonArray("timer");
      // validate the required field `timer` (array)
      for (int i = 0; i < jsonArraytimer.size(); i++) {
        Timer.validateJsonElement(jsonArraytimer.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example18.class));

       return (TypeAdapter<T>) new TypeAdapter<Example18>() {
           @Override
           public void write(JsonWriter out, Example18 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example18 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example18 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example18
   * @throws IOException if the JSON string is invalid with respect to Example18
   */
  public static Example18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example18.class);
  }

  /**
   * Convert an instance of Example18 to an JSON string
   *
   * @return JSON string
   */
