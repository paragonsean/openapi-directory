...
public class Example16 {
  ...
  public static final String SERIALIZED_NAME_TIME_FOR_DATA_FETCH = "time_for_data_fetch";
  @SerializedName(SERIALIZED_NAME_TIME_FOR_DATA_FETCH)
  private Integer timeForDataFetch;

  public static final String SERIALIZED_NAME_TIME_FOR_HTTP_RESPONSE = "time_for_http_response";
  @SerializedName(SERIALIZED_NAME_TIME_FOR_HTTP_RESPONSE)
  private Integer timeForHttpResponse;

  public Example16() {
  }

  public Example16 bytesReceived(Integer bytesReceived) {
  ...
  public Example16 responseCode(Integer responseCode) {
  ...
  public Example16 timeForDataFetch(Integer timeForDataFetch) {
    this.timeForDataFetch = timeForDataFetch;
    return this;
  }

  /**
   * Get timeForDataFetch
   * @return timeForDataFetch
   */
  @javax.annotation.Nonnull
  public Integer getTimeForDataFetch() {
    return timeForDataFetch;
  }

  public void setTimeForDataFetch(Integer timeForDataFetch) {
    this.timeForDataFetch = timeForDataFetch;
  }


  public Example16 timeForHttpResponse(Integer timeForHttpResponse) {
    this.timeForHttpResponse = timeForHttpResponse;
    return this;
  }

  /**
   * Get timeForHttpResponse
   * @return timeForHttpResponse
   */
  @javax.annotation.Nonnull
  public Integer getTimeForHttpResponse() {
    return timeForHttpResponse;
  }

  public void setTimeForHttpResponse(Integer timeForHttpResponse) {
    this.timeForHttpResponse = timeForHttpResponse;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example16 example16 = (Example16) o;
    return Objects.equals(this.bytesReceived, example16.bytesReceived) &&
        Objects.equals(this.responseCode, example16.responseCode) &&
        Objects.equals(this.timeForDataFetch, example16.timeForDataFetch) &&
        Objects.equals(this.timeForHttpResponse, example16.timeForHttpResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bytesReceived, responseCode, timeForDataFetch, timeForHttpResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example16 {\n");
    sb.append("    bytesReceived: ").append(toIndentedString(bytesReceived)).append("\n");
    sb.append("    responseCode: ").append(toIndentedString(responseCode)).append("\n");
    sb.append("    timeForDataFetch: ").append(toIndentedString(timeForDataFetch)).append("\n");
    sb.append("    timeForHttpResponse: ").append(toIndentedString(timeForHttpResponse)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("time_for_data_fetch");
    openapiFields.add("time_for_http_response");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("bytes_received");
    openapiRequiredFields.add("response_code");
    openapiRequiredFields.add("time_for_data_fetch");
    openapiRequiredFields.add("time_for_http_response");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example16
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example16.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example16 is not found in the empty JSON string", Example16.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example16.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example16` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example16.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example16.class));

       return (TypeAdapter<T>) new TypeAdapter<Example16>() {
           @Override
           public void write(JsonWriter out, Example16 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example16 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example16 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example16
   * @throws IOException if the JSON string is invalid with respect to Example16
   */
  public static Example16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example16.class);
  }

  /**
   * Convert an instance of Example16 to an JSON string
   *
   * @return JSON string
   */
