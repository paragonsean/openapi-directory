...
public class TestInternetDownloadSpeedRequest {
  ...
  public TestInternetDownloadSpeedRequest() {
  }

  public TestInternetDownloadSpeedRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestInternetDownloadSpeedRequest testInternetDownloadSpeedRequest = (TestInternetDownloadSpeedRequest) o;
    return Objects.equals(this.url, testInternetDownloadSpeedRequest.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestInternetDownloadSpeedRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestInternetDownloadSpeedRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestInternetDownloadSpeedRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestInternetDownloadSpeedRequest is not found in the empty JSON string", TestInternetDownloadSpeedRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestInternetDownloadSpeedRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestInternetDownloadSpeedRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestInternetDownloadSpeedRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestInternetDownloadSpeedRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestInternetDownloadSpeedRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestInternetDownloadSpeedRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestInternetDownloadSpeedRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestInternetDownloadSpeedRequest>() {
           @Override
           public void write(JsonWriter out, TestInternetDownloadSpeedRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestInternetDownloadSpeedRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestInternetDownloadSpeedRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestInternetDownloadSpeedRequest
   * @throws IOException if the JSON string is invalid with respect to TestInternetDownloadSpeedRequest
   */
  public static TestInternetDownloadSpeedRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestInternetDownloadSpeedRequest.class);
  }

  /**
   * Convert an instance of TestInternetDownloadSpeedRequest to an JSON string
   *
   * @return JSON string
   */
