...
public class DeleteAlarmsandTimersRequest {
  ...
  public DeleteAlarmsandTimersRequest() {
  }

  public DeleteAlarmsandTimersRequest ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public DeleteAlarmsandTimersRequest addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAlarmsandTimersRequest deleteAlarmsandTimersRequest = (DeleteAlarmsandTimersRequest) o;
    return Objects.equals(this.ids, deleteAlarmsandTimersRequest.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAlarmsandTimersRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAlarmsandTimersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAlarmsandTimersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAlarmsandTimersRequest is not found in the empty JSON string", DeleteAlarmsandTimersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAlarmsandTimersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAlarmsandTimersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAlarmsandTimersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAlarmsandTimersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAlarmsandTimersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAlarmsandTimersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAlarmsandTimersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAlarmsandTimersRequest>() {
           @Override
           public void write(JsonWriter out, DeleteAlarmsandTimersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAlarmsandTimersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAlarmsandTimersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAlarmsandTimersRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteAlarmsandTimersRequest
   */
  public static DeleteAlarmsandTimersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAlarmsandTimersRequest.class);
  }

  /**
   * Convert an instance of DeleteAlarmsandTimersRequest to an JSON string
   *
   * @return JSON string
   */
