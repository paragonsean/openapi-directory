...
public class Example112 {
  ...
  public static final String SERIALIZED_NAME_EXPECTED_PROFILES = "expected_profiles";
  @SerializedName(SERIALIZED_NAME_EXPECTED_PROFILES)
  private Integer expectedProfiles;
  ...
  public Example112 deviceClass(Integer deviceClass) {
  ...
  public Example112 deviceType(Integer deviceType) {
  ...
  public Example112 expectedProfiles(Integer expectedProfiles) {
    this.expectedProfiles = expectedProfiles;
    return this;
  }

  /**
   * Get expectedProfiles
   * @return expectedProfiles
   */
  @javax.annotation.Nonnull
  public Integer getExpectedProfiles() {
    return expectedProfiles;
  }

  public void setExpectedProfiles(Integer expectedProfiles) {
    this.expectedProfiles = expectedProfiles;
  }


  public Example112 macAddress(String macAddress) {
  ...
  public Example112 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Example112 rssi(Integer rssi) {
    this.rssi = rssi;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example112 example112 = (Example112) o;
    return Objects.equals(this.deviceClass, example112.deviceClass) &&
        Objects.equals(this.deviceType, example112.deviceType) &&
        Objects.equals(this.expectedProfiles, example112.expectedProfiles) &&
        Objects.equals(this.macAddress, example112.macAddress) &&
        Objects.equals(this.name, example112.name) &&
        Objects.equals(this.rssi, example112.rssi);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceClass, deviceType, expectedProfiles, macAddress, name, rssi);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example112 {\n");
    sb.append("    deviceClass: ").append(toIndentedString(deviceClass)).append("\n");
    sb.append("    deviceType: ").append(toIndentedString(deviceType)).append("\n");
    sb.append("    expectedProfiles: ").append(toIndentedString(expectedProfiles)).append("\n");
  ...
  static {
    ...
    openapiFields.add("expected_profiles");
    ...
    openapiRequiredFields.add("expected_profiles");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example112
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example112.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example112 is not found in the empty JSON string", Example112.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example112.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example112` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example112.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example112.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example112' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example112> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example112.class));

       return (TypeAdapter<T>) new TypeAdapter<Example112>() {
           @Override
           public void write(JsonWriter out, Example112 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example112 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example112 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example112
   * @throws IOException if the JSON string is invalid with respect to Example112
   */
  public static Example112 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example112.class);
  }

  /**
   * Convert an instance of Example112 to an JSON string
   *
   * @return JSON string
   */
