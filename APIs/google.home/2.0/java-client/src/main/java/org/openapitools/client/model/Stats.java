...
public class Stats {
  public static final String SERIALIZED_NAME_NUM_CHECK_CONNECTIVITY = "num_check_connectivity";
  @SerializedName(SERIALIZED_NAME_NUM_CHECK_CONNECTIVITY)
  private Integer numCheckConnectivity;

  public static final String SERIALIZED_NAME_NUM_CONNECT_WIFI = "num_connect_wifi";
  @SerializedName(SERIALIZED_NAME_NUM_CONNECT_WIFI)
  private Integer numConnectWifi;

  public static final String SERIALIZED_NAME_NUM_CONNECTED_WIFI_NOT_SAVED = "num_connected_wifi_not_saved";
  @SerializedName(SERIALIZED_NAME_NUM_CONNECTED_WIFI_NOT_SAVED)
  private Integer numConnectedWifiNotSaved;

  public static final String SERIALIZED_NAME_NUM_INITIAL_EUREKA_INFO = "num_initial_eureka_info";
  @SerializedName(SERIALIZED_NAME_NUM_INITIAL_EUREKA_INFO)
  private Integer numInitialEurekaInfo;

  public static final String SERIALIZED_NAME_NUM_OBTAIN_IP = "num_obtain_ip";
  @SerializedName(SERIALIZED_NAME_NUM_OBTAIN_IP)
  private Integer numObtainIp;

  public Stats() {
  }

  public Stats numCheckConnectivity(Integer numCheckConnectivity) {
    this.numCheckConnectivity = numCheckConnectivity;
    return this;
  }

  /**
   * Get numCheckConnectivity
  ...
  public Stats numConnectWifi(Integer numConnectWifi) {
  ...
  public Stats numConnectedWifiNotSaved(Integer numConnectedWifiNotSaved) {
    this.numConnectedWifiNotSaved = numConnectedWifiNotSaved;
    return this;
  }

  /**
   * Get numConnectedWifiNotSaved
  ...
  public Stats numInitialEurekaInfo(Integer numInitialEurekaInfo) {
    this.numInitialEurekaInfo = numInitialEurekaInfo;
    return this;
  }

  /**
   * Get numInitialEurekaInfo
  ...
  public Stats numObtainIp(Integer numObtainIp) {
  ...
  public boolean equals(Object o) {
    ...
    Stats stats = (Stats) o;
    return Objects.equals(this.numCheckConnectivity, stats.numCheckConnectivity) &&
        Objects.equals(this.numConnectWifi, stats.numConnectWifi) &&
        Objects.equals(this.numConnectedWifiNotSaved, stats.numConnectedWifiNotSaved) &&
        Objects.equals(this.numInitialEurekaInfo, stats.numInitialEurekaInfo) &&
        Objects.equals(this.numObtainIp, stats.numObtainIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numCheckConnectivity, numConnectWifi, numConnectedWifiNotSaved, numInitialEurekaInfo, numObtainIp);
  }
  ...
  public String toString() {
    ...
    sb.append("    numCheckConnectivity: ").append(toIndentedString(numCheckConnectivity)).append("\n");
    sb.append("    numConnectWifi: ").append(toIndentedString(numConnectWifi)).append("\n");
    sb.append("    numConnectedWifiNotSaved: ").append(toIndentedString(numConnectedWifiNotSaved)).append("\n");
    sb.append("    numInitialEurekaInfo: ").append(toIndentedString(numInitialEurekaInfo)).append("\n");
    sb.append("    numObtainIp: ").append(toIndentedString(numObtainIp)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("num_check_connectivity");
    openapiFields.add("num_connect_wifi");
    openapiFields.add("num_connected_wifi_not_saved");
    openapiFields.add("num_initial_eureka_info");
    openapiFields.add("num_obtain_ip");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("num_check_connectivity");
    openapiRequiredFields.add("num_connect_wifi");
    openapiRequiredFields.add("num_connected_wifi_not_saved");
    openapiRequiredFields.add("num_initial_eureka_info");
    openapiRequiredFields.add("num_obtain_ip");
  }
