...
public class Example14 {
  ...
  public Example14 displayString(String displayString) {
  ...
  public Example14 offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public Example14 timezone(String timezone) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayString, example14.displayString) &&
        Objects.equals(this.offset, example14.offset) &&
        Objects.equals(this.timezone, example14.timezone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayString, offset, timezone);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example14 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example14
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example14.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example14 is not found in the empty JSON string", Example14.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example14.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example14` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example14.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example14.class));

       return (TypeAdapter<T>) new TypeAdapter<Example14>() {
           @Override
           public void write(JsonWriter out, Example14 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example14 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example14 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example14
   * @throws IOException if the JSON string is invalid with respect to Example14
   */
  public static Example14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example14.class);
  }

  /**
   * Convert an instance of Example14 to an JSON string
   *
   * @return JSON string
   */
