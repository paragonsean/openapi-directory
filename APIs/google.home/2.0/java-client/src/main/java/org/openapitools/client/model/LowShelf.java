...
public class LowShelf {
  ...
  public LowShelf frequency(Integer frequency) {
  ...
  public LowShelf gainDb(Integer gainDb) {
    this.gainDb = gainDb;
    return this;
  }
  ...
  public LowShelf quality(BigDecimal quality) {
  ...
  public boolean equals(Object o) {
    ...
    LowShelf lowShelf = (LowShelf) o;
    return Objects.equals(this.frequency, lowShelf.frequency) &&
        Objects.equals(this.gainDb, lowShelf.gainDb) &&
        Objects.equals(this.quality, lowShelf.quality);
  }

  @Override
  public int hashCode() {
    return Objects.hash(frequency, gainDb, quality);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LowShelf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LowShelf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LowShelf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LowShelf is not found in the empty JSON string", LowShelf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LowShelf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LowShelf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LowShelf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LowShelf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LowShelf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LowShelf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LowShelf.class));

       return (TypeAdapter<T>) new TypeAdapter<LowShelf>() {
           @Override
           public void write(JsonWriter out, LowShelf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LowShelf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LowShelf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LowShelf
   * @throws IOException if the JSON string is invalid with respect to LowShelf
   */
  public static LowShelf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LowShelf.class);
  }

  /**
   * Convert an instance of LowShelf to an JSON string
   *
   * @return JSON string
   */
