...
public class Example114 {
  ...
  public Example114 bssid(String bssid) {
    this.bssid = bssid;
    return this;
  }
  ...
  public Example114 signalLevel(Integer signalLevel) {
  ...
  public Example114 ssid(String ssid) {
    this.ssid = ssid;
    return this;
  }
  ...
  public Example114 wpaAuth(Integer wpaAuth) {
  ...
  public Example114 wpaCipher(Integer wpaCipher) {
  ...
  public Example114 wpaId(Integer wpaId) {
    this.wpaId = wpaId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Example114 example114 = (Example114) o;
    return Objects.equals(this.bssid, example114.bssid) &&
        Objects.equals(this.signalLevel, example114.signalLevel) &&
        Objects.equals(this.ssid, example114.ssid) &&
        Objects.equals(this.wpaAuth, example114.wpaAuth) &&
        Objects.equals(this.wpaCipher, example114.wpaCipher) &&
        Objects.equals(this.wpaId, example114.wpaId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bssid, signalLevel, ssid, wpaAuth, wpaCipher, wpaId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example114 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example114
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example114.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example114 is not found in the empty JSON string", Example114.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example114.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example114` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example114.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example114.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example114' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example114> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example114.class));

       return (TypeAdapter<T>) new TypeAdapter<Example114>() {
           @Override
           public void write(JsonWriter out, Example114 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example114 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example114 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example114
   * @throws IOException if the JSON string is invalid with respect to Example114
   */
  public static Example114 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example114.class);
  }

  /**
   * Convert an instance of Example114 to an JSON string
   *
   * @return JSON string
   */
