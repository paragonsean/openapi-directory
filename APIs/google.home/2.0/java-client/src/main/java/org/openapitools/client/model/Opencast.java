...
public class Opencast {
  ...
  public Opencast pinCode(String pinCode) {
  ...
  public boolean equals(Object o) {
    ...
    Opencast opencast = (Opencast) o;
    return Objects.equals(this.pinCode, opencast.pinCode);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("pin_code");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Opencast
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Opencast.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Opencast is not found in the empty JSON string", Opencast.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Opencast.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Opencast` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Opencast.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("pin_code").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Opencast.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Opencast' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Opencast> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Opencast.class));

       return (TypeAdapter<T>) new TypeAdapter<Opencast>() {
           @Override
           public void write(JsonWriter out, Opencast value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Opencast read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Opencast given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Opencast
   * @throws IOException if the JSON string is invalid with respect to Opencast
   */
  public static Opencast fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Opencast.class);
  }

  /**
   * Convert an instance of Opencast to an JSON string
   *
   * @return JSON string
   */
