...
public class PairwithSpeakerRequest {
  ...
  public PairwithSpeakerRequest() {
  }

  public PairwithSpeakerRequest connect(Boolean connect) {
  ...
  public PairwithSpeakerRequest macAddress(String macAddress) {
  ...
  public PairwithSpeakerRequest profile(Integer profile) {
  ...
  public boolean equals(Object o) {
    ...
    PairwithSpeakerRequest pairwithSpeakerRequest = (PairwithSpeakerRequest) o;
    return Objects.equals(this.connect, pairwithSpeakerRequest.connect) &&
        Objects.equals(this.macAddress, pairwithSpeakerRequest.macAddress) &&
        Objects.equals(this.profile, pairwithSpeakerRequest.profile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connect, macAddress, profile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PairwithSpeakerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PairwithSpeakerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PairwithSpeakerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PairwithSpeakerRequest is not found in the empty JSON string", PairwithSpeakerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PairwithSpeakerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PairwithSpeakerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PairwithSpeakerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PairwithSpeakerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PairwithSpeakerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PairwithSpeakerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PairwithSpeakerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PairwithSpeakerRequest>() {
           @Override
           public void write(JsonWriter out, PairwithSpeakerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PairwithSpeakerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PairwithSpeakerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PairwithSpeakerRequest
   * @throws IOException if the JSON string is invalid with respect to PairwithSpeakerRequest
   */
  public static PairwithSpeakerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PairwithSpeakerRequest.class);
  }

  /**
   * Convert an instance of PairwithSpeakerRequest to an JSON string
   *
   * @return JSON string
   */
