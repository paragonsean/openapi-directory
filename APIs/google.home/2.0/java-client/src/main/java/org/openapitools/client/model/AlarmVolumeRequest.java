...
public class AlarmVolumeRequest {
  ...
  public AlarmVolumeRequest() {
  }

  public AlarmVolumeRequest volume(Integer volume) {
    this.volume = volume;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AlarmVolumeRequest alarmVolumeRequest = (AlarmVolumeRequest) o;
    return Objects.equals(this.volume, alarmVolumeRequest.volume);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlarmVolumeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlarmVolumeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlarmVolumeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlarmVolumeRequest is not found in the empty JSON string", AlarmVolumeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlarmVolumeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlarmVolumeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlarmVolumeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlarmVolumeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlarmVolumeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlarmVolumeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlarmVolumeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AlarmVolumeRequest>() {
           @Override
           public void write(JsonWriter out, AlarmVolumeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlarmVolumeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlarmVolumeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlarmVolumeRequest
   * @throws IOException if the JSON string is invalid with respect to AlarmVolumeRequest
   */
  public static AlarmVolumeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlarmVolumeRequest.class);
  }

  /**
   * Convert an instance of AlarmVolumeRequest to an JSON string
   *
   * @return JSON string
   */
