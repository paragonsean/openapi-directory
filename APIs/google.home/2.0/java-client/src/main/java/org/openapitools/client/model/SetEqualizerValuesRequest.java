...
import org.openapitools.client.model.HighShelf1;
import org.openapitools.client.model.LowShelf1;
...
public class SetEqualizerValuesRequest {
  ...
  private HighShelf1 highShelf;

  public static final String SERIALIZED_NAME_LOW_SHELF = "low_shelf";
  @SerializedName(SERIALIZED_NAME_LOW_SHELF)
  private LowShelf1 lowShelf;

  public SetEqualizerValuesRequest() {
  }

  public SetEqualizerValuesRequest highShelf(HighShelf1 highShelf) {
  ...
  public HighShelf1 getHighShelf() {
    return highShelf;
  }

  public void setHighShelf(HighShelf1 highShelf) {
    this.highShelf = highShelf;
  }


  public SetEqualizerValuesRequest lowShelf(LowShelf1 lowShelf) {
   ...
   */
  @javax.annotation.Nonnull
  public LowShelf1 getLowShelf() {
    return lowShelf;
  }

  public void setLowShelf(LowShelf1 lowShelf) {
    this.lowShelf = lowShelf;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetEqualizerValuesRequest setEqualizerValuesRequest = (SetEqualizerValuesRequest) o;
    return Objects.equals(this.highShelf, setEqualizerValuesRequest.highShelf) &&
        Objects.equals(this.lowShelf, setEqualizerValuesRequest.lowShelf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(highShelf, lowShelf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetEqualizerValuesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetEqualizerValuesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetEqualizerValuesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetEqualizerValuesRequest is not found in the empty JSON string", SetEqualizerValuesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetEqualizerValuesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetEqualizerValuesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetEqualizerValuesRequest.openapiRequiredFields) {
      ...
      HighShelf1.validateJsonElement(jsonObj.get("high_shelf"));
      // validate the required field `low_shelf`
      LowShelf1.validateJsonElement(jsonObj.get("low_shelf"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetEqualizerValuesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetEqualizerValuesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetEqualizerValuesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetEqualizerValuesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetEqualizerValuesRequest>() {
           @Override
           public void write(JsonWriter out, SetEqualizerValuesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetEqualizerValuesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetEqualizerValuesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetEqualizerValuesRequest
   * @throws IOException if the JSON string is invalid with respect to SetEqualizerValuesRequest
   */
  public static SetEqualizerValuesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetEqualizerValuesRequest.class);
  }

  /**
   * Convert an instance of SetEqualizerValuesRequest to an JSON string
   *
   * @return JSON string
   */
