...
public class Getcurrentvalues {
  public static final String SERIALIZED_NAME_ENDPOINT_ENABLED = "endpoint_enabled";
  @SerializedName(SERIALIZED_NAME_ENDPOINT_ENABLED)
  private Boolean endpointEnabled;

  public static final String SERIALIZED_NAME_HOTWORD_ENABLED = "hotword_enabled";
  @SerializedName(SERIALIZED_NAME_HOTWORD_ENABLED)
  private Boolean hotwordEnabled;

  public Getcurrentvalues() {
  }

  public Getcurrentvalues endpointEnabled(Boolean endpointEnabled) {
  ...
  public Getcurrentvalues hotwordEnabled(Boolean hotwordEnabled) {
  ...
  public void setHotwordEnabled(Boolean hotwordEnabled) {
    this.hotwordEnabled = hotwordEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    Getcurrentvalues getcurrentvalues = (Getcurrentvalues) o;
    return Objects.equals(this.endpointEnabled, getcurrentvalues.endpointEnabled) &&
        Objects.equals(this.hotwordEnabled, getcurrentvalues.hotwordEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpointEnabled, hotwordEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Getcurrentvalues {\n");
    sb.append("    endpointEnabled: ").append(toIndentedString(endpointEnabled)).append("\n");
    sb.append("    hotwordEnabled: ").append(toIndentedString(hotwordEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("endpoint_enabled");
    openapiFields.add("hotword_enabled");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("endpoint_enabled");
    openapiRequiredFields.add("hotword_enabled");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getcurrentvalues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getcurrentvalues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getcurrentvalues is not found in the empty JSON string", Getcurrentvalues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getcurrentvalues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getcurrentvalues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Getcurrentvalues.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getcurrentvalues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getcurrentvalues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getcurrentvalues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getcurrentvalues.class));

       return (TypeAdapter<T>) new TypeAdapter<Getcurrentvalues>() {
           @Override
           public void write(JsonWriter out, Getcurrentvalues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getcurrentvalues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getcurrentvalues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getcurrentvalues
   * @throws IOException if the JSON string is invalid with respect to Getcurrentvalues
   */
  public static Getcurrentvalues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getcurrentvalues.class);
  }

  /**
   * Convert an instance of Getcurrentvalues to an JSON string
   *
   * @return JSON string
   */
