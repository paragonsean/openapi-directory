...
public class Settings1 {
  ...
  public Settings1 controlNotifications(Integer controlNotifications) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.controlNotifications, settings1.controlNotifications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(controlNotifications);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Settings1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Settings1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Settings1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Settings1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Settings1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Settings1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Settings1.class));

       return (TypeAdapter<T>) new TypeAdapter<Settings1>() {
           @Override
