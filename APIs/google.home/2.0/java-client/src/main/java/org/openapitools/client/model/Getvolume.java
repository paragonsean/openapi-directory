...
public class Getvolume {
  ...
  public Getvolume volume(BigDecimal volume) {
    this.volume = volume;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Getvolume getvolume = (Getvolume) o;
    return Objects.equals(this.volume, getvolume.volume);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getvolume
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getvolume.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getvolume is not found in the empty JSON string", Getvolume.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getvolume.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getvolume` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Getvolume.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getvolume.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getvolume' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getvolume> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getvolume.class));

       return (TypeAdapter<T>) new TypeAdapter<Getvolume>() {
           @Override
           public void write(JsonWriter out, Getvolume value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getvolume read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getvolume given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getvolume
   * @throws IOException if the JSON string is invalid with respect to Getvolume
   */
  public static Getvolume fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getvolume.class);
  }

  /**
   * Convert an instance of Getvolume to an JSON string
   *
   * @return JSON string
   */
