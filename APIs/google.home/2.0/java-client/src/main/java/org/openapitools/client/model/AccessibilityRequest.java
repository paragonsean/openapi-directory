...
public class AccessibilityRequest {
  ...
  public AccessibilityRequest endpointEnabled(Boolean endpointEnabled) {
  ...
  public AccessibilityRequest hotwordEnabled(Boolean hotwordEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    AccessibilityRequest accessibilityRequest = (AccessibilityRequest) o;
    return Objects.equals(this.endpointEnabled, accessibilityRequest.endpointEnabled) &&
        Objects.equals(this.hotwordEnabled, accessibilityRequest.hotwordEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessibilityRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessibilityRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessibilityRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessibilityRequest is not found in the empty JSON string", AccessibilityRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessibilityRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessibilityRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessibilityRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessibilityRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessibilityRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessibilityRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessibilityRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessibilityRequest>() {
           @Override
           public void write(JsonWriter out, AccessibilityRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessibilityRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessibilityRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessibilityRequest
   * @throws IOException if the JSON string is invalid with respect to AccessibilityRequest
   */
  public static AccessibilityRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessibilityRequest.class);
  }

  /**
   * Convert an instance of AccessibilityRequest to an JSON string
   *
   * @return JSON string
   */
