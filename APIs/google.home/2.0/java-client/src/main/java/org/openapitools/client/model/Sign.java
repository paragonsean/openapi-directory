...
public class Sign {
  ...
  public static final String SERIALIZED_NAME_INTERMEDIATE_CERTS = "intermediate_certs";
  @SerializedName(SERIALIZED_NAME_INTERMEDIATE_CERTS)
  private List<String> intermediateCerts = new ArrayList<>();

  public static final String SERIALIZED_NAME_NONCE = "nonce";
  @SerializedName(SERIALIZED_NAME_NONCE)
  private String nonce;

  public static final String SERIALIZED_NAME_SIGNED_DATA = "signed_data";
  @SerializedName(SERIALIZED_NAME_SIGNED_DATA)
  private String signedData;

  public Sign() {
  }

  public Sign certificate(String certificate) {
  ...
  public Sign intermediateCerts(List<String> intermediateCerts) {
    this.intermediateCerts = intermediateCerts;
    return this;
  }

  public Sign addIntermediateCertsItem(String intermediateCertsItem) {
    if (this.intermediateCerts == null) {
      this.intermediateCerts = new ArrayList<>();
    }
    this.intermediateCerts.add(intermediateCertsItem);
    return this;
  }

  /**
   * Get intermediateCerts
  ...
  public Sign nonce(String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  public Sign signedData(String signedData) {
  ...
  public boolean equals(Object o) {
    ...
    Sign sign = (Sign) o;
    return Objects.equals(this.certificate, sign.certificate) &&
        Objects.equals(this.intermediateCerts, sign.intermediateCerts) &&
        Objects.equals(this.nonce, sign.nonce) &&
        Objects.equals(this.signedData, sign.signedData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificate, intermediateCerts, nonce, signedData);
  }
  ...
  public String toString() {
    ...
    sb.append("    intermediateCerts: ").append(toIndentedString(intermediateCerts)).append("\n");
  ...
  static {
    ...
    openapiFields.add("intermediate_certs");
    openapiFields.add("nonce");
    openapiFields.add("signed_data");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("certificate");
    openapiRequiredFields.add("intermediate_certs");
    openapiRequiredFields.add("nonce");
    openapiRequiredFields.add("signed_data");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sign is not found in the empty JSON string", Sign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Sign.openapiRequiredFields) {
      ...
      if (jsonObj.get("intermediate_certs") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("intermediate_certs").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `intermediate_certs` to be an array in the JSON string but got `%s`", jsonObj.get("intermediate_certs").toString()));
      }
      if (!jsonObj.get("nonce").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nonce` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nonce").toString()));
      }
      if (!jsonObj.get("signed_data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `signed_data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("signed_data").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sign.class));

       return (TypeAdapter<T>) new TypeAdapter<Sign>() {
           @Override
  ...
  /**
   * Create an instance of Sign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sign
   * @throws IOException if the JSON string is invalid with respect to Sign
   */
  public static Sign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sign.class);
  }

  /**
   * Convert an instance of Sign to an JSON string
   *
   * @return JSON string
   */
