...
public class ConnecttoWiFiNetworkRequest {
  ...
  public static final String SERIALIZED_NAME_ENC_PASSWD = "enc_passwd";
  @SerializedName(SERIALIZED_NAME_ENC_PASSWD)
  ...
  public ConnecttoWiFiNetworkRequest bssid(String bssid) {
    this.bssid = bssid;
    return this;
  }
  ...
  public ConnecttoWiFiNetworkRequest encPasswd(String encPasswd) {
  ...
  public ConnecttoWiFiNetworkRequest signalLevel(Integer signalLevel) {
  ...
  public ConnecttoWiFiNetworkRequest ssid(String ssid) {
    this.ssid = ssid;
    return this;
  }
  ...
  public ConnecttoWiFiNetworkRequest wpaAuth(Integer wpaAuth) {
  ...
  public ConnecttoWiFiNetworkRequest wpaCipher(Integer wpaCipher) {
  ...
  public boolean equals(Object o) {
    ...
    ConnecttoWiFiNetworkRequest connecttoWiFiNetworkRequest = (ConnecttoWiFiNetworkRequest) o;
    return Objects.equals(this.bssid, connecttoWiFiNetworkRequest.bssid) &&
        Objects.equals(this.encPasswd, connecttoWiFiNetworkRequest.encPasswd) &&
        Objects.equals(this.signalLevel, connecttoWiFiNetworkRequest.signalLevel) &&
        Objects.equals(this.ssid, connecttoWiFiNetworkRequest.ssid) &&
        Objects.equals(this.wpaAuth, connecttoWiFiNetworkRequest.wpaAuth) &&
        Objects.equals(this.wpaCipher, connecttoWiFiNetworkRequest.wpaCipher);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bssid, encPasswd, signalLevel, ssid, wpaAuth, wpaCipher);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConnecttoWiFiNetworkRequest {\n");
    sb.append("    bssid: ").append(toIndentedString(bssid)).append("\n");
    sb.append("    encPasswd: ").append(toIndentedString(encPasswd)).append("\n");
  ...
  static {
    ...
    openapiRequiredFields.add("enc_passwd");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnecttoWiFiNetworkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnecttoWiFiNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnecttoWiFiNetworkRequest is not found in the empty JSON string", ConnecttoWiFiNetworkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnecttoWiFiNetworkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnecttoWiFiNetworkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnecttoWiFiNetworkRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("enc_passwd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `enc_passwd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("enc_passwd").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnecttoWiFiNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnecttoWiFiNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnecttoWiFiNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnecttoWiFiNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnecttoWiFiNetworkRequest>() {
           @Override
           public void write(JsonWriter out, ConnecttoWiFiNetworkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnecttoWiFiNetworkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnecttoWiFiNetworkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnecttoWiFiNetworkRequest
   * @throws IOException if the JSON string is invalid with respect to ConnecttoWiFiNetworkRequest
   */
  public static ConnecttoWiFiNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnecttoWiFiNetworkRequest.class);
  }

  /**
   * Convert an instance of ConnecttoWiFiNetworkRequest to an JSON string
   *
   * @return JSON string
   */
