...
public class IconList {
  ...
  public IconList depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public IconList height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  public IconList mimetype(String mimetype) {
  ...
  public IconList url(String url) {
    this.url = url;
    return this;
  }
  ...
  public IconList width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IconList iconList = (IconList) o;
    return Objects.equals(this.depth, iconList.depth) &&
        Objects.equals(this.height, iconList.height) &&
        Objects.equals(this.mimetype, iconList.mimetype) &&
        Objects.equals(this.url, iconList.url) &&
        Objects.equals(this.width, iconList.width);
  }

  @Override
  public int hashCode() {
    return Objects.hash(depth, height, mimetype, url, width);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IconList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IconList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IconList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IconList is not found in the empty JSON string", IconList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IconList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IconList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IconList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IconList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IconList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IconList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IconList.class));

       return (TypeAdapter<T>) new TypeAdapter<IconList>() {
           @Override
           public void write(JsonWriter out, IconList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IconList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IconList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IconList
   * @throws IOException if the JSON string is invalid with respect to IconList
   */
  public static IconList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IconList.class);
  }

  /**
   * Convert an instance of IconList to an JSON string
   *
   * @return JSON string
   */
