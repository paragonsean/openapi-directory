...
public class Example19 {
  ...
  public Example19 success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    Example19 example19 = (Example19) o;
    return Objects.equals(this.success, example19.success);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example19
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example19.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example19 is not found in the empty JSON string", Example19.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example19.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example19` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example19.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example19.class));

       return (TypeAdapter<T>) new TypeAdapter<Example19>() {
           @Override
           public void write(JsonWriter out, Example19 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example19 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example19 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example19
   * @throws IOException if the JSON string is invalid with respect to Example19
   */
  public static Example19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example19.class);
  }

  /**
   * Convert an instance of Example19 to an JSON string
   *
   * @return JSON string
   */
