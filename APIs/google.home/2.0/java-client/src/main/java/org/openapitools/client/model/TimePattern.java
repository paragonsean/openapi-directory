...
public class TimePattern {
  ...
  public TimePattern hour(Integer hour) {
    this.hour = hour;
    return this;
  }
  ...
  public TimePattern minute(Integer minute) {
    this.minute = minute;
    return this;
  }
  ...
  public TimePattern second(Integer second) {
    this.second = second;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimePattern timePattern = (TimePattern) o;
    return Objects.equals(this.hour, timePattern.hour) &&
        Objects.equals(this.minute, timePattern.minute) &&
        Objects.equals(this.second, timePattern.second);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimePattern
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimePattern.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimePattern is not found in the empty JSON string", TimePattern.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimePattern.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimePattern` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimePattern.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimePattern.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimePattern' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimePattern> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimePattern.class));

       return (TypeAdapter<T>) new TypeAdapter<TimePattern>() {
           @Override
           public void write(JsonWriter out, TimePattern value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimePattern read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimePattern given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimePattern
   * @throws IOException if the JSON string is invalid with respect to TimePattern
   */
  public static TimePattern fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimePattern.class);
  }

  /**
   * Convert an instance of TimePattern to an JSON string
   *
   * @return JSON string
   */
