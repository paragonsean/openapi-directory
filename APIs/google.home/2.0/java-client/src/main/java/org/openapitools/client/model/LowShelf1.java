...
public class LowShelf1 {
  ...
  public LowShelf1 gainDb(Integer gainDb) {
    this.gainDb = gainDb;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LowShelf1 lowShelf1 = (LowShelf1) o;
    return Objects.equals(this.gainDb, lowShelf1.gainDb);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LowShelf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LowShelf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LowShelf1 is not found in the empty JSON string", LowShelf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LowShelf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LowShelf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LowShelf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LowShelf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LowShelf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LowShelf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LowShelf1.class));

       return (TypeAdapter<T>) new TypeAdapter<LowShelf1>() {
           @Override
           public void write(JsonWriter out, LowShelf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LowShelf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LowShelf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LowShelf1
   * @throws IOException if the JSON string is invalid with respect to LowShelf1
   */
  public static LowShelf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LowShelf1.class);
  }

  /**
   * Convert an instance of LowShelf1 to an JSON string
   *
   * @return JSON string
   */
