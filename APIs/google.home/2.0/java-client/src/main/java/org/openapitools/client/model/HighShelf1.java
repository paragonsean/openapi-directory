...
public class HighShelf1 {
  public static final String SERIALIZED_NAME_GAIN_DB = "gain_db";
  @SerializedName(SERIALIZED_NAME_GAIN_DB)
  private Integer gainDb;

  public HighShelf1() {
  }

  public HighShelf1 gainDb(Integer gainDb) {
    this.gainDb = gainDb;
    return this;
  }
  ...
  public Integer getGainDb() {
    return gainDb;
  }

  public void setGainDb(Integer gainDb) {
    this.gainDb = gainDb;
  }
  ...
  public boolean equals(Object o) {
    ...
    HighShelf1 highShelf1 = (HighShelf1) o;
    return Objects.equals(this.gainDb, highShelf1.gainDb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gainDb);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HighShelf1 {\n");
  ...
  static {
    ...
    openapiFields.add("gain_db");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("gain_db");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HighShelf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HighShelf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HighShelf1 is not found in the empty JSON string", HighShelf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HighShelf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HighShelf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HighShelf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HighShelf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HighShelf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HighShelf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HighShelf1.class));

       return (TypeAdapter<T>) new TypeAdapter<HighShelf1>() {
           @Override
           public void write(JsonWriter out, HighShelf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HighShelf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HighShelf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HighShelf1
   * @throws IOException if the JSON string is invalid with respect to HighShelf1
   */
  public static HighShelf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HighShelf1.class);
  }

  /**
   * Convert an instance of HighShelf1 to an JSON string
   *
   * @return JSON string
   */
