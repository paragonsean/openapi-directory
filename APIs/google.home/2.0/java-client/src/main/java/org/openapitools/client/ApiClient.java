...
public class ApiClient {
    ...
    private String basePath = "http://example.com/setup";
    ...
    public ApiClient() {
        ...
        authentications.put("cast-local-authorization-token", new ApiKeyAuth("header", "cast-local-authorization-token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://example.com/setup
