...
public class Example13 {
  public static final String SERIALIZED_NAME_CAN_ENROLL = "can_enroll";
  @SerializedName(SERIALIZED_NAME_CAN_ENROLL)
  private Boolean canEnroll;

  public static final String SERIALIZED_NAME_ENROLLMENT_STATE = "enrollment_state";
  @SerializedName(SERIALIZED_NAME_ENROLLMENT_STATE)
  private Integer enrollmentState;
  ...
  public Example13 canEnroll(Boolean canEnroll) {
  ...
  public Example13 enrollmentState(Integer enrollmentState) {
   ...
   */
  @javax.annotation.Nonnull
  public Integer getEnrollmentState() {
    return enrollmentState;
  }

  public void setEnrollmentState(Integer enrollmentState) {
    this.enrollmentState = enrollmentState;
  }


  public Example13 errorCode(Integer errorCode) {
  ...
  public Example13 ready(Boolean ready) {
    this.ready = ready;
    return this;
  }
  ...
  public Example13 retryable(Boolean retryable) {
  ...
  public boolean equals(Object o) {
    ...
    Example13 example13 = (Example13) o;
    return Objects.equals(this.canEnroll, example13.canEnroll) &&
        Objects.equals(this.enrollmentState, example13.enrollmentState) &&
        Objects.equals(this.errorCode, example13.errorCode) &&
        Objects.equals(this.ready, example13.ready) &&
        Objects.equals(this.retryable, example13.retryable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canEnroll, enrollmentState, errorCode, ready, retryable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Example13 {\n");
    sb.append("    canEnroll: ").append(toIndentedString(canEnroll)).append("\n");
  ...
  static {
    ...
    openapiFields.add("can_enroll");
    openapiFields.add("enrollment_state");
    ...
    openapiRequiredFields.add("can_enroll");
    openapiRequiredFields.add("enrollment_state");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Example13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Example13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Example13 is not found in the empty JSON string", Example13.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Example13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Example13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Example13.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Example13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Example13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Example13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Example13.class));

       return (TypeAdapter<T>) new TypeAdapter<Example13>() {
           @Override
           public void write(JsonWriter out, Example13 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Example13 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Example13 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Example13
   * @throws IOException if the JSON string is invalid with respect to Example13
   */
  public static Example13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Example13.class);
  }

  /**
   * Convert an instance of Example13 to an JSON string
   *
   * @return JSON string
   */
