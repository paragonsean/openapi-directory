...
public class ConnectedDevice {
  ...
  public static final String SERIALIZED_NAME_ENABLED_PROFILES = "enabled_profiles";
  @SerializedName(SERIALIZED_NAME_ENABLED_PROFILES)
  private Integer enabledProfiles;

  public ConnectedDevice() {
  }

  public ConnectedDevice device(Device device) {
    this.device = device;
    return this;
  }
  ...
  public ConnectedDevice enabledProfiles(Integer enabledProfiles) {
   ...
   */
  @javax.annotation.Nonnull
  public Integer getEnabledProfiles() {
    return enabledProfiles;
  }

  public void setEnabledProfiles(Integer enabledProfiles) {
    this.enabledProfiles = enabledProfiles;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConnectedDevice connectedDevice = (ConnectedDevice) o;
    return Objects.equals(this.device, connectedDevice.device) &&
        Objects.equals(this.enabledProfiles, connectedDevice.enabledProfiles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(device, enabledProfiles);
  }
  ...
  public String toString() {
    ...
    sb.append("    enabledProfiles: ").append(toIndentedString(enabledProfiles)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("enabled_profiles");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("device");
    openapiRequiredFields.add("enabled_profiles");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectedDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectedDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectedDevice is not found in the empty JSON string", ConnectedDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectedDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectedDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectedDevice.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectedDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectedDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectedDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectedDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectedDevice>() {
           @Override
           public void write(JsonWriter out, ConnectedDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectedDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectedDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectedDevice
   * @throws IOException if the JSON string is invalid with respect to ConnectedDevice
   */
  public static ConnectedDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectedDevice.class);
  }

  /**
   * Convert an instance of ConnectedDevice to an JSON string
   *
   * @return JSON string
   */
