...
public class CheckReadyStatusRequest {
  public static final String SERIALIZED_NAME_PLAY_READY_MESSAGE = "play_ready_message";
  @SerializedName(SERIALIZED_NAME_PLAY_READY_MESSAGE)
  private Boolean playReadyMessage;

  public static final String SERIALIZED_NAME_USER_ID = "user_id";
  @SerializedName(SERIALIZED_NAME_USER_ID)
  private String userId;

  public CheckReadyStatusRequest() {
  }

  public CheckReadyStatusRequest playReadyMessage(Boolean playReadyMessage) {
    this.playReadyMessage = playReadyMessage;
    return this;
  }

  /**
   * Get playReadyMessage
   * @return playReadyMessage
   */
  @javax.annotation.Nonnull
  public Boolean getPlayReadyMessage() {
    return playReadyMessage;
  }

  public void setPlayReadyMessage(Boolean playReadyMessage) {
    this.playReadyMessage = playReadyMessage;
  }


  public CheckReadyStatusRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckReadyStatusRequest checkReadyStatusRequest = (CheckReadyStatusRequest) o;
    return Objects.equals(this.playReadyMessage, checkReadyStatusRequest.playReadyMessage) &&
        Objects.equals(this.userId, checkReadyStatusRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playReadyMessage, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckReadyStatusRequest {\n");
    sb.append("    playReadyMessage: ").append(toIndentedString(playReadyMessage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("play_ready_message");
    openapiFields.add("user_id");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("play_ready_message");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckReadyStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckReadyStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckReadyStatusRequest is not found in the empty JSON string", CheckReadyStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckReadyStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckReadyStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CheckReadyStatusRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckReadyStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckReadyStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckReadyStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckReadyStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckReadyStatusRequest>() {
           @Override
           public void write(JsonWriter out, CheckReadyStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckReadyStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckReadyStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckReadyStatusRequest
   * @throws IOException if the JSON string is invalid with respect to CheckReadyStatusRequest
   */
  public static CheckReadyStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckReadyStatusRequest.class);
  }

  /**
   * Convert an instance of CheckReadyStatusRequest to an JSON string
   *
   * @return JSON string
   */
