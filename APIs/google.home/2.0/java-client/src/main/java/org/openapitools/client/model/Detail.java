...
import org.openapitools.client.model.IconList;
...
public class Detail {
  public static final String SERIALIZED_NAME_ICON_LIST = "icon_list";
  @SerializedName(SERIALIZED_NAME_ICON_LIST)
  ...
  public Detail iconList(List<IconList> iconList) {
    this.iconList = iconList;
    return this;
  }

  public Detail addIconListItem(IconList iconListItem) {
    if (this.iconList == null) {
      this.iconList = new ArrayList<>();
    }
    this.iconList.add(iconListItem);
    return this;
  }
  ...
  public void setIconList(List<IconList> iconList) {
    this.iconList = iconList;
  }


  public Detail locale(Locale locale) {
    this.locale = locale;
    return this;
  }
  ...
  public Detail timezone(Timezone timezone) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.iconList, detail.iconList) &&
        Objects.equals(this.locale, detail.locale) &&
        Objects.equals(this.timezone, detail.timezone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(iconList, locale, timezone);
  }
  ...
  public String toString() {
    ...
    sb.append("    iconList: ").append(toIndentedString(iconList)).append("\n");
  ...
  static {
    ...
    openapiFields.add("icon_list");
    openapiFields.add("locale");
    openapiFields.add("timezone");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("icon_list");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("icon_list").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `icon_list` to be an array in the JSON string but got `%s`", jsonObj.get("icon_list").toString()));
      }

      JsonArray jsonArrayiconList = jsonObj.getAsJsonArray("icon_list");
      // validate the required field `icon_list` (array)
      for (int i = 0; i < jsonArrayiconList.size(); i++) {
        IconList.validateJsonElement(jsonArrayiconList.get(i));
      };
