...
public class Aogh {
  public static final String SERIALIZED_NAME_AOGH_API_VERSION = "aogh_api_version";
  @SerializedName(SERIALIZED_NAME_AOGH_API_VERSION)
  private String aoghApiVersion;

  public Aogh() {
  }

  public Aogh aoghApiVersion(String aoghApiVersion) {
  ...
  /**
   * Get aoghApiVersion
   * @return aoghApiVersion
   */
  @javax.annotation.Nonnull
  public String getAoghApiVersion() {
    return aoghApiVersion;
  }

  public void setAoghApiVersion(String aoghApiVersion) {
    this.aoghApiVersion = aoghApiVersion;
  }
  ...
  public boolean equals(Object o) {
    ...
    Aogh aogh = (Aogh) o;
    return Objects.equals(this.aoghApiVersion, aogh.aoghApiVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aoghApiVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Aogh {\n");
    sb.append("    aoghApiVersion: ").append(toIndentedString(aoghApiVersion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("aogh_api_version");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("aogh_api_version");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aogh
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aogh.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aogh is not found in the empty JSON string", Aogh.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aogh.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aogh` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Aogh.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("aogh_api_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aogh_api_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aogh_api_version").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aogh.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aogh' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aogh> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aogh.class));

       return (TypeAdapter<T>) new TypeAdapter<Aogh>() {
           @Override
           public void write(JsonWriter out, Aogh value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aogh read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aogh given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aogh
   * @throws IOException if the JSON string is invalid with respect to Aogh
   */
  public static Aogh fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aogh.class);
  }

  /**
   * Convert an instance of Aogh to an JSON string
   *
   * @return JSON string
   */
