...
public class HighShelf {
  ...
  public HighShelf frequency(Integer frequency) {
  ...
  public HighShelf gainDb(Integer gainDb) {
    this.gainDb = gainDb;
    return this;
  }
  ...
  public HighShelf quality(BigDecimal quality) {
  ...
  public boolean equals(Object o) {
    ...
    HighShelf highShelf = (HighShelf) o;
    return Objects.equals(this.frequency, highShelf.frequency) &&
        Objects.equals(this.gainDb, highShelf.gainDb) &&
        Objects.equals(this.quality, highShelf.quality);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HighShelf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HighShelf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HighShelf is not found in the empty JSON string", HighShelf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HighShelf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HighShelf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HighShelf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HighShelf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HighShelf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HighShelf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HighShelf.class));

       return (TypeAdapter<T>) new TypeAdapter<HighShelf>() {
           @Override
           public void write(JsonWriter out, HighShelf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HighShelf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HighShelf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HighShelf
   * @throws IOException if the JSON string is invalid with respect to HighShelf
   */
  public static HighShelf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HighShelf.class);
  }

  /**
   * Convert an instance of HighShelf to an JSON string
   *
   * @return JSON string
   */
