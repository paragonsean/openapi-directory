...
public class ApplicationActivityContents {
  ...
  public ApplicationActivityContents() {
  }

  public ApplicationActivityContents body(File body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplicationActivityContents applicationActivityContents = (ApplicationActivityContents) o;
    return Objects.equals(this.body, applicationActivityContents.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationActivityContents {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationActivityContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationActivityContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationActivityContents is not found in the empty JSON string", ApplicationActivityContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationActivityContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationActivityContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicationActivityContents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationActivityContents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationActivityContents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationActivityContents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationActivityContents.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationActivityContents>() {
           @Override
           public void write(JsonWriter out, ApplicationActivityContents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationActivityContents read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationActivityContents given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationActivityContents
   * @throws IOException if the JSON string is invalid with respect to ApplicationActivityContents
   */
  public static ApplicationActivityContents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationActivityContents.class);
  }

  /**
   * Convert an instance of ApplicationActivityContents to an JSON string
   *
   * @return JSON string
   */
