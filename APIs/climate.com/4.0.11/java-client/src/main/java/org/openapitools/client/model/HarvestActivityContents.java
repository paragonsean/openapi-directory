...
public class HarvestActivityContents {
  ...
  public HarvestActivityContents() {
  }

  public HarvestActivityContents body(File body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HarvestActivityContents harvestActivityContents = (HarvestActivityContents) o;
    return Objects.equals(this.body, harvestActivityContents.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class HarvestActivityContents {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HarvestActivityContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HarvestActivityContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HarvestActivityContents is not found in the empty JSON string", HarvestActivityContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HarvestActivityContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HarvestActivityContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HarvestActivityContents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HarvestActivityContents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HarvestActivityContents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HarvestActivityContents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HarvestActivityContents.class));

       return (TypeAdapter<T>) new TypeAdapter<HarvestActivityContents>() {
           @Override
           public void write(JsonWriter out, HarvestActivityContents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HarvestActivityContents read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HarvestActivityContents given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HarvestActivityContents
   * @throws IOException if the JSON string is invalid with respect to HarvestActivityContents
   */
  public static HarvestActivityContents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HarvestActivityContents.class);
  }

  /**
   * Convert an instance of HarvestActivityContents to an JSON string
   *
   * @return JSON string
   */
