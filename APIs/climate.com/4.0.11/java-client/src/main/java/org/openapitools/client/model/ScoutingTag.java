...
public class ScoutingTag {
  ...
  public ScoutingTag code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScoutingTag scoutingTag = (ScoutingTag) o;
    return Objects.equals(this.code, scoutingTag.code);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingTag is not found in the empty JSON string", ScoutingTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingTag.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingTag.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingTag>() {
           @Override
           public void write(JsonWriter out, ScoutingTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingTag
   * @throws IOException if the JSON string is invalid with respect to ScoutingTag
   */
  public static ScoutingTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingTag.class);
  }

  /**
   * Convert an instance of ScoutingTag to an JSON string
   *
   * @return JSON string
   */
