...
public class UploadStatusQuery {
  ...
  public UploadStatusQuery() {
  }

  public UploadStatusQuery ids(List<UUID> ids) {
    this.ids = ids;
    return this;
  }

  public UploadStatusQuery addIdsItem(UUID idsItem) {
    if (this.ids == null) {
  ...
  public boolean equals(Object o) {
    ...
    UploadStatusQuery uploadStatusQuery = (UploadStatusQuery) o;
    return Objects.equals(this.ids, uploadStatusQuery.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadStatusQuery {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UploadStatusQuery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UploadStatusQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadStatusQuery is not found in the empty JSON string", UploadStatusQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UploadStatusQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UploadStatusQuery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UploadStatusQuery.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadStatusQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadStatusQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadStatusQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadStatusQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadStatusQuery>() {
           @Override
           public void write(JsonWriter out, UploadStatusQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UploadStatusQuery read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UploadStatusQuery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UploadStatusQuery
   * @throws IOException if the JSON string is invalid with respect to UploadStatusQuery
   */
  public static UploadStatusQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadStatusQuery.class);
  }

  /**
   * Convert an instance of UploadStatusQuery to an JSON string
   *
   * @return JSON string
   */
