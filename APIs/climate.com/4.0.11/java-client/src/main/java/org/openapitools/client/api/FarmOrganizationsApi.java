...
import org.openapitools.client.model.FarmOrganization;
...
public class FarmOrganizationsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public FarmOrganizationsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public FarmOrganizationsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for fetchFarmOrganizationByTypeAndId
     * @param farmOrganizationType Type of the farm organization. (required)
     * @param farmOrganizationId Unique identifier of the farm organization. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns the requested farm organization. </td><td>  * X-Http-Request-Id - Unique identifier assigned to the request. <br>  </td></tr>
     ...
     */
    public okhttp3.Call fetchFarmOrganizationByTypeAndIdCall(String farmOrganizationType, UUID farmOrganizationId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v4/farmOrganizations/{farmOrganizationType}/{farmOrganizationId}"
            .replace("{" + "farmOrganizationType" + "}", localVarApiClient.escapeString(farmOrganizationType.toString()))
            .replace("{" + "farmOrganizationId" + "}", localVarApiClient.escapeString(farmOrganizationId.toString()));
    ...
    private okhttp3.Call fetchFarmOrganizationByTypeAndIdValidateBeforeCall(String farmOrganizationType, UUID farmOrganizationId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'farmOrganizationType' is set
        if (farmOrganizationType == null) {
            throw new ApiException("Missing the required parameter 'farmOrganizationType' when calling fetchFarmOrganizationByTypeAndId(Async)");
        }

        // verify the required parameter 'farmOrganizationId' is set
        if (farmOrganizationId == null) {
            throw new ApiException("Missing the required parameter 'farmOrganizationId' when calling fetchFarmOrganizationByTypeAndId(Async)");
        }

        return fetchFarmOrganizationByTypeAndIdCall(farmOrganizationType, farmOrganizationId, _callback);
     ...
     */
    public FarmOrganization fetchFarmOrganizationByTypeAndId(String farmOrganizationType, UUID farmOrganizationId) throws ApiException {
        ApiResponse<FarmOrganization> localVarResp = fetchFarmOrganizationByTypeAndIdWithHttpInfo(farmOrganizationType, farmOrganizationId);
     ...
     * @param farmOrganizationType Type of the farm organization. (required)
     * @param farmOrganizationId Unique identifier of the farm organization. (required)
     * @return ApiResponse&lt;FarmOrganization&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FarmOrganization> fetchFarmOrganizationByTypeAndIdWithHttpInfo(String farmOrganizationType, UUID farmOrganizationId) throws ApiException {
        okhttp3.Call localVarCall = fetchFarmOrganizationByTypeAndIdValidateBeforeCall(farmOrganizationType, farmOrganizationId, null);
        Type localVarReturnType = new TypeToken<FarmOrganization>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a specific farm organization by organization type and ID (asynchronously)
     * Retrieve a given **farm organization** by organization type and ID.
     * @param farmOrganizationType Type of the farm organization. (required)
     * @param farmOrganizationId Unique identifier of the farm organization. (required)
     ...
     */
    public okhttp3.Call fetchFarmOrganizationByTypeAndIdAsync(String farmOrganizationType, UUID farmOrganizationId, final ApiCallback<FarmOrganization> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchFarmOrganizationByTypeAndIdValidateBeforeCall(farmOrganizationType, farmOrganizationId, _callback);
        Type localVarReturnType = new TypeToken<FarmOrganization>(){}.getType();
