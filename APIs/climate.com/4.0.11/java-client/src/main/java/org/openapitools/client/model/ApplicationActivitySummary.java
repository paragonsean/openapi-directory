...
public class ApplicationActivitySummary {
  ...
  public ApplicationActivitySummary() {
  }

  public ApplicationActivitySummary createdAt(OffsetDateTime createdAt) {
  ...
  public ApplicationActivitySummary endTime(OffsetDateTime endTime) {
  ...
  public ApplicationActivitySummary fieldIds(List<String> fieldIds) {
    this.fieldIds = fieldIds;
    return this;
  }

  public ApplicationActivitySummary addFieldIdsItem(String fieldIdsItem) {
  ...
  public ApplicationActivitySummary id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationActivitySummary length(Long length) {
    this.length = length;
    return this;
  }
  ...
  public ApplicationActivitySummary startTime(OffsetDateTime startTime) {
  ...
  public ApplicationActivitySummary updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationActivitySummary applicationActivitySummary = (ApplicationActivitySummary) o;
    return Objects.equals(this.createdAt, applicationActivitySummary.createdAt) &&
        Objects.equals(this.endTime, applicationActivitySummary.endTime) &&
        Objects.equals(this.fieldIds, applicationActivitySummary.fieldIds) &&
        Objects.equals(this.id, applicationActivitySummary.id) &&
        Objects.equals(this.length, applicationActivitySummary.length) &&
        Objects.equals(this.startTime, applicationActivitySummary.startTime) &&
        Objects.equals(this.updatedAt, applicationActivitySummary.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationActivitySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationActivitySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationActivitySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationActivitySummary is not found in the empty JSON string", ApplicationActivitySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationActivitySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationActivitySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicationActivitySummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationActivitySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationActivitySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationActivitySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationActivitySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationActivitySummary>() {
           @Override
           public void write(JsonWriter out, ApplicationActivitySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationActivitySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationActivitySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationActivitySummary
   * @throws IOException if the JSON string is invalid with respect to ApplicationActivitySummary
   */
  public static ApplicationActivitySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationActivitySummary.class);
  }

  /**
   * Convert an instance of ApplicationActivitySummary to an JSON string
   *
   * @return JSON string
   */
