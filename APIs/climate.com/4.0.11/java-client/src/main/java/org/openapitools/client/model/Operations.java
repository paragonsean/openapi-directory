...
public class Operations {
  ...
  private List<Operation> results = new ArrayList<>();

  public Operations() {
  }

  public Operations results(List<Operation> results) {
    this.results = results;
    return this;
  }

  public Operations addResultsItem(Operation resultsItem) {
  ...
  public void setResults(List<Operation> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.results, operations.results);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Operations.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        Operation.validateJsonElement(jsonArrayresults.get(i));
      };
  }
