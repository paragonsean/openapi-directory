...
public class PlantingActivityContents {
  ...
  public PlantingActivityContents() {
  }

  public PlantingActivityContents body(File body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlantingActivityContents plantingActivityContents = (PlantingActivityContents) o;
    return Objects.equals(this.body, plantingActivityContents.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlantingActivityContents {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlantingActivityContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlantingActivityContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlantingActivityContents is not found in the empty JSON string", PlantingActivityContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlantingActivityContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlantingActivityContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlantingActivityContents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlantingActivityContents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlantingActivityContents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlantingActivityContents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlantingActivityContents.class));

       return (TypeAdapter<T>) new TypeAdapter<PlantingActivityContents>() {
           @Override
           public void write(JsonWriter out, PlantingActivityContents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlantingActivityContents read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlantingActivityContents given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlantingActivityContents
   * @throws IOException if the JSON string is invalid with respect to PlantingActivityContents
   */
  public static PlantingActivityContents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlantingActivityContents.class);
  }

  /**
   * Convert an instance of PlantingActivityContents to an JSON string
   *
   * @return JSON string
   */
