...
public class OperationsApi {
    ...
    /**
     * Build call for fetchOperations
     * @param resourceOwnerId Optional comma-separated list of resource owner unique identifiers by which to filter results. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns the requested operations. </td><td>  * X-Http-Request-Id - Unique identifier assigned to the request. <br>  </td></tr>
     ...
     */
    public okhttp3.Call fetchOperationsCall(String resourceOwnerId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v4/operations/all";
    ...
    private okhttp3.Call fetchOperationsValidateBeforeCall(String resourceOwnerId, final ApiCallback _callback) throws ApiException {
        return fetchOperationsCall(resourceOwnerId, _callback);
     ...
     */
    public Operations fetchOperations(String resourceOwnerId) throws ApiException {
        ApiResponse<Operations> localVarResp = fetchOperationsWithHttpInfo(resourceOwnerId);
     ...
     */
    public ApiResponse<Operations> fetchOperationsWithHttpInfo(String resourceOwnerId) throws ApiException {
        okhttp3.Call localVarCall = fetchOperationsValidateBeforeCall(resourceOwnerId, null);
        Type localVarReturnType = new TypeToken<Operations>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the operations accessible to a a given user. (asynchronously)
     * Retrieve the **operations** accessible to the authenticated user. Filter the results by resource owner if the &#x60;resourceOwnerId&#x60; query parameter is specified.
     * @param resourceOwnerId Optional comma-separated list of resource owner unique identifiers by which to filter results. (optional)
     ...
     */
    public okhttp3.Call fetchOperationsAsync(String resourceOwnerId, final ApiCallback<Operations> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchOperationsValidateBeforeCall(resourceOwnerId, _callback);
        Type localVarReturnType = new TypeToken<Operations>(){}.getType();
