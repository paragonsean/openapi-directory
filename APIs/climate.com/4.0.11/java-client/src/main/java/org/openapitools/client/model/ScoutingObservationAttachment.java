...
public class ScoutingObservationAttachment {
  ...
  public ScoutingObservationAttachment() {
  }

  public ScoutingObservationAttachment contentType(String contentType) {
  ...
  public ScoutingObservationAttachment id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ScoutingObservationAttachment length(Long length) {
    this.length = length;
    return this;
  }
  ...
  public ScoutingObservationAttachment status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ScoutingObservationAttachment updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ScoutingObservationAttachment scoutingObservationAttachment = (ScoutingObservationAttachment) o;
    return Objects.equals(this.contentType, scoutingObservationAttachment.contentType) &&
        Objects.equals(this.id, scoutingObservationAttachment.id) &&
        Objects.equals(this.length, scoutingObservationAttachment.length) &&
        Objects.equals(this.status, scoutingObservationAttachment.status) &&
        Objects.equals(this.updatedAt, scoutingObservationAttachment.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentType, id, length, status, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScoutingObservationAttachment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingObservationAttachment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingObservationAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingObservationAttachment is not found in the empty JSON string", ScoutingObservationAttachment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingObservationAttachment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingObservationAttachment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingObservationAttachment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingObservationAttachment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingObservationAttachment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingObservationAttachment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingObservationAttachment.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingObservationAttachment>() {
           @Override
           public void write(JsonWriter out, ScoutingObservationAttachment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingObservationAttachment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingObservationAttachment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingObservationAttachment
   * @throws IOException if the JSON string is invalid with respect to ScoutingObservationAttachment
   */
  public static ScoutingObservationAttachment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingObservationAttachment.class);
  }

  /**
   * Convert an instance of ScoutingObservationAttachment to an JSON string
   *
   * @return JSON string
   */
