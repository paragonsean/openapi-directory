...
public class Area {
  ...
  public boolean equals(Object o) {
    ...
    Area area = (Area) o;
    return Objects.equals(this.q, area.q) &&
        Objects.equals(this.u, area.u);
  }

  @Override
  public int hashCode() {
    return Objects.hash(q, u);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("u").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `u` to be a primitive type in the JSON string but got `%s`", jsonObj.get("u").toString()));
      }
  }
