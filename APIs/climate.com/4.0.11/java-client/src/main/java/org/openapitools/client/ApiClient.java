...
public class ApiClient {
    ...
    private String basePath = "https://platform.climate.com";
    ...
    public ApiClient() {
        ...
        authentications.put("oauth2_authorization_code", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.climate.com/api/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://platform.climate.com
