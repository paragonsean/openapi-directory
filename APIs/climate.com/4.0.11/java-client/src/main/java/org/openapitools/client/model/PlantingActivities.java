...
import org.openapitools.client.model.PlantingActivitySummary;
...
public class PlantingActivities {
  ...
  private List<PlantingActivitySummary> results = new ArrayList<>();

  public PlantingActivities() {
  }

  public PlantingActivities results(List<PlantingActivitySummary> results) {
    this.results = results;
    return this;
  }

  public PlantingActivities addResultsItem(PlantingActivitySummary resultsItem) {
  ...
  public List<PlantingActivitySummary> getResults() {
    return results;
  }

  public void setResults(List<PlantingActivitySummary> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlantingActivities plantingActivities = (PlantingActivities) o;
    return Objects.equals(this.results, plantingActivities.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlantingActivities {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlantingActivities
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlantingActivities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlantingActivities is not found in the empty JSON string", PlantingActivities.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlantingActivities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlantingActivities` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlantingActivities.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        PlantingActivitySummary.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlantingActivities.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlantingActivities' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlantingActivities> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlantingActivities.class));

       return (TypeAdapter<T>) new TypeAdapter<PlantingActivities>() {
           @Override
           public void write(JsonWriter out, PlantingActivities value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlantingActivities read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlantingActivities given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlantingActivities
   * @throws IOException if the JSON string is invalid with respect to PlantingActivities
   */
  public static PlantingActivities fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlantingActivities.class);
  }

  /**
   * Convert an instance of PlantingActivities to an JSON string
   *
   * @return JSON string
   */
