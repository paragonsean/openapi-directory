...
public class Fields {
  ...
  private List<Field> results = new ArrayList<>();

  public Fields() {
  }

  public Fields results(List<Field> results) {
    this.results = results;
    return this;
  }

  public Fields addResultsItem(Field resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.results, fields.results);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        Field.validateJsonElement(jsonArrayresults.get(i));
      };
  }
