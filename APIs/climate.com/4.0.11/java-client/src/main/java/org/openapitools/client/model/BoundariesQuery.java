...
public class BoundariesQuery {
  ...
  public BoundariesQuery() {
  }

  public BoundariesQuery ids(List<UUID> ids) {
    this.ids = ids;
    return this;
  }

  public BoundariesQuery addIdsItem(UUID idsItem) {
    if (this.ids == null) {
  ...
  public boolean equals(Object o) {
    ...
    BoundariesQuery boundariesQuery = (BoundariesQuery) o;
    return Objects.equals(this.ids, boundariesQuery.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class BoundariesQuery {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoundariesQuery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoundariesQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoundariesQuery is not found in the empty JSON string", BoundariesQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoundariesQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoundariesQuery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoundariesQuery.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoundariesQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoundariesQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoundariesQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoundariesQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<BoundariesQuery>() {
           @Override
           public void write(JsonWriter out, BoundariesQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoundariesQuery read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoundariesQuery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoundariesQuery
   * @throws IOException if the JSON string is invalid with respect to BoundariesQuery
   */
  public static BoundariesQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoundariesQuery.class);
  }

  /**
   * Convert an instance of BoundariesQuery to an JSON string
   *
   * @return JSON string
   */
