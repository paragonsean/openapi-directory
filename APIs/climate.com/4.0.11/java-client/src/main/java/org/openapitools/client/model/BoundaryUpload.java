...
public class BoundaryUpload {
  ...
  public BoundaryUpload() {
  }

  public BoundaryUpload geometry(Geometry geometry) {
  ...
  public boolean equals(Object o) {
    ...
    BoundaryUpload boundaryUpload = (BoundaryUpload) o;
    return Objects.equals(this.geometry, boundaryUpload.geometry);
  }
  ...
  public String toString() {
    ...
    sb.append("class BoundaryUpload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoundaryUpload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoundaryUpload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoundaryUpload is not found in the empty JSON string", BoundaryUpload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoundaryUpload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoundaryUpload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoundaryUpload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoundaryUpload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoundaryUpload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoundaryUpload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoundaryUpload.class));

       return (TypeAdapter<T>) new TypeAdapter<BoundaryUpload>() {
           @Override
           public void write(JsonWriter out, BoundaryUpload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoundaryUpload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoundaryUpload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoundaryUpload
   * @throws IOException if the JSON string is invalid with respect to BoundaryUpload
   */
  public static BoundaryUpload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoundaryUpload.class);
  }

  /**
   * Convert an instance of BoundaryUpload to an JSON string
   *
   * @return JSON string
   */
