...
public class ResourceOwnersApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ResourceOwnersApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ResourceOwnersApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getResourceOwner
     * @param resourceOwnerId Unique identifier of the resource owner. (required)
     ...
     */
    public okhttp3.Call getResourceOwnerCall(UUID resourceOwnerId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v4/resourceOwners/{resourceOwnerId}"
            .replace("{" + "resourceOwnerId" + "}", localVarApiClient.escapeString(resourceOwnerId.toString()));
    ...
    private okhttp3.Call getResourceOwnerValidateBeforeCall(UUID resourceOwnerId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceOwnerId' is set
        if (resourceOwnerId == null) {
            throw new ApiException("Missing the required parameter 'resourceOwnerId' when calling getResourceOwner(Async)");
        }

        return getResourceOwnerCall(resourceOwnerId, _callback);
     ...
     */
    public ResourceOwner getResourceOwner(UUID resourceOwnerId) throws ApiException {
        ApiResponse<ResourceOwner> localVarResp = getResourceOwnerWithHttpInfo(resourceOwnerId);
     ...
     */
    public ApiResponse<ResourceOwner> getResourceOwnerWithHttpInfo(UUID resourceOwnerId) throws ApiException {
        okhttp3.Call localVarCall = getResourceOwnerValidateBeforeCall(resourceOwnerId, null);
        Type localVarReturnType = new TypeToken<ResourceOwner>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a resource owner by ID (asynchronously)
     * Retrieve a resource owner for the given &#x60;resourceOwnerId&#x60;.
     * @param resourceOwnerId Unique identifier of the resource owner. (required)
     ...
     */
    public okhttp3.Call getResourceOwnerAsync(UUID resourceOwnerId, final ApiCallback<ResourceOwner> _callback) throws ApiException {

        okhttp3.Call localVarCall = getResourceOwnerValidateBeforeCall(resourceOwnerId, _callback);
        Type localVarReturnType = new TypeToken<ResourceOwner>(){}.getType();
