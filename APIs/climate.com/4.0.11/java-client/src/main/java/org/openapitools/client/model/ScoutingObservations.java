...
public class ScoutingObservations {
  ...
  private List<ScoutingObservationSummary> results = new ArrayList<>();

  public ScoutingObservations() {
  }

  public ScoutingObservations results(List<ScoutingObservationSummary> results) {
    this.results = results;
    return this;
  }

  public ScoutingObservations addResultsItem(ScoutingObservationSummary resultsItem) {
  ...
  public List<ScoutingObservationSummary> getResults() {
    return results;
  }

  public void setResults(List<ScoutingObservationSummary> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScoutingObservations scoutingObservations = (ScoutingObservations) o;
    return Objects.equals(this.results, scoutingObservations.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScoutingObservations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingObservations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingObservations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingObservations is not found in the empty JSON string", ScoutingObservations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingObservations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingObservations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingObservations.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        ScoutingObservationSummary.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingObservations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingObservations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingObservations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingObservations.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingObservations>() {
           @Override
           public void write(JsonWriter out, ScoutingObservations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingObservations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingObservations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingObservations
   * @throws IOException if the JSON string is invalid with respect to ScoutingObservations
   */
  public static ScoutingObservations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingObservations.class);
  }

  /**
   * Convert an instance of ScoutingObservations to an JSON string
   *
   * @return JSON string
   */
