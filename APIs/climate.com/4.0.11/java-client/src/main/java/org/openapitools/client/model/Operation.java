...
public class Operation {
  ...
  public Operation resourceOwnerId(UUID resourceOwnerId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, operation.id) &&
        ...
        Objects.equals(this.resourceOwnerId, operation.resourceOwnerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, resourceOwnerId);
  }
