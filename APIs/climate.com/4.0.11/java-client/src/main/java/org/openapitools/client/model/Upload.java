...
public class Upload {
  ...
  public Upload contentType(ContentTypeEnum contentType) {
  ...
  public Upload length(Long length) {
    this.length = length;
    return this;
  }
  ...
  public Upload metadata(Map<String, Object> metadata) {
    this.metadata = metadata;
    return this;
  }

  public Upload putMetadataItem(String key, Object metadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentType, upload.contentType) &&
        Objects.equals(this.length, upload.length) &&
        Objects.equals(this.md5, upload.md5) &&
        Objects.equals(this.metadata, upload.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentType, length, md5, metadata);
  }
