...
public class ScoutingObservationAttachmentContents {
  ...
  public ScoutingObservationAttachmentContents() {
  }

  public ScoutingObservationAttachmentContents body(File body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScoutingObservationAttachmentContents scoutingObservationAttachmentContents = (ScoutingObservationAttachmentContents) o;
    return Objects.equals(this.body, scoutingObservationAttachmentContents.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScoutingObservationAttachmentContents {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingObservationAttachmentContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingObservationAttachmentContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingObservationAttachmentContents is not found in the empty JSON string", ScoutingObservationAttachmentContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingObservationAttachmentContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingObservationAttachmentContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingObservationAttachmentContents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingObservationAttachmentContents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingObservationAttachmentContents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingObservationAttachmentContents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingObservationAttachmentContents.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingObservationAttachmentContents>() {
           @Override
           public void write(JsonWriter out, ScoutingObservationAttachmentContents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingObservationAttachmentContents read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingObservationAttachmentContents given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingObservationAttachmentContents
   * @throws IOException if the JSON string is invalid with respect to ScoutingObservationAttachmentContents
   */
  public static ScoutingObservationAttachmentContents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingObservationAttachmentContents.class);
  }

  /**
   * Convert an instance of ScoutingObservationAttachmentContents to an JSON string
   *
   * @return JSON string
   */
