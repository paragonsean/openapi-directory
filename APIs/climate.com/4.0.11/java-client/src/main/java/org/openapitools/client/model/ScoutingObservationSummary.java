...
public class ScoutingObservationSummary {
  ...
  public ScoutingObservationSummary() {
  }

  public ScoutingObservationSummary endTime(OffsetDateTime endTime) {
  ...
  public ScoutingObservationSummary id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ScoutingObservationSummary startTime(OffsetDateTime startTime) {
  ...
  public ScoutingObservationSummary updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ScoutingObservationSummary scoutingObservationSummary = (ScoutingObservationSummary) o;
    return Objects.equals(this.endTime, scoutingObservationSummary.endTime) &&
        Objects.equals(this.id, scoutingObservationSummary.id) &&
        Objects.equals(this.startTime, scoutingObservationSummary.startTime) &&
        Objects.equals(this.updatedAt, scoutingObservationSummary.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endTime, id, startTime, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScoutingObservationSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingObservationSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingObservationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingObservationSummary is not found in the empty JSON string", ScoutingObservationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingObservationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingObservationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingObservationSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingObservationSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingObservationSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingObservationSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingObservationSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingObservationSummary>() {
           @Override
           public void write(JsonWriter out, ScoutingObservationSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingObservationSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingObservationSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingObservationSummary
   * @throws IOException if the JSON string is invalid with respect to ScoutingObservationSummary
   */
  public static ScoutingObservationSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingObservationSummary.class);
  }

  /**
   * Convert an instance of ScoutingObservationSummary to an JSON string
   *
   * @return JSON string
   */
