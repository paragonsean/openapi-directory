...
public class UploadedBoundaryId {
  ...
  public UploadedBoundaryId() {
  }

  public UploadedBoundaryId id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UploadedBoundaryId uploadedBoundaryId = (UploadedBoundaryId) o;
    return Objects.equals(this.id, uploadedBoundaryId.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadedBoundaryId {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UploadedBoundaryId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UploadedBoundaryId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadedBoundaryId is not found in the empty JSON string", UploadedBoundaryId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UploadedBoundaryId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UploadedBoundaryId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UploadedBoundaryId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadedBoundaryId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadedBoundaryId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadedBoundaryId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadedBoundaryId.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadedBoundaryId>() {
           @Override
           public void write(JsonWriter out, UploadedBoundaryId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UploadedBoundaryId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UploadedBoundaryId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UploadedBoundaryId
   * @throws IOException if the JSON string is invalid with respect to UploadedBoundaryId
   */
  public static UploadedBoundaryId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadedBoundaryId.class);
  }

  /**
   * Convert an instance of UploadedBoundaryId to an JSON string
   *
   * @return JSON string
   */
