...
public class BoundaryProperties {
  ...
  public BoundaryProperties area(Area area) {
    this.area = area;
    return this;
  }
  ...
  public BoundaryProperties centroid(Point centroid) {
  ...
  public boolean equals(Object o) {
    ...
    BoundaryProperties boundaryProperties = (BoundaryProperties) o;
    return Objects.equals(this.area, boundaryProperties.area) &&
        Objects.equals(this.centroid, boundaryProperties.centroid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(area, centroid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BoundaryProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoundaryProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoundaryProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoundaryProperties is not found in the empty JSON string", BoundaryProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoundaryProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoundaryProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BoundaryProperties.openapiRequiredFields) {
      ...
      // validate the required field `centroid`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoundaryProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoundaryProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoundaryProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoundaryProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<BoundaryProperties>() {
           @Override
           public void write(JsonWriter out, BoundaryProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoundaryProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoundaryProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoundaryProperties
   * @throws IOException if the JSON string is invalid with respect to BoundaryProperties
   */
  public static BoundaryProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoundaryProperties.class);
  }

  /**
   * Convert an instance of BoundaryProperties to an JSON string
   *
   * @return JSON string
   */
