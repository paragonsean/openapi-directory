...
public class ExportContents {
  ...
  public ExportContents body(File body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportContents exportContents = (ExportContents) o;
    return Objects.equals(this.body, exportContents.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportContents {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportContents is not found in the empty JSON string", ExportContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportContents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportContents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportContents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportContents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportContents.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportContents>() {
           @Override
           public void write(JsonWriter out, ExportContents value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportContents read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportContents given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportContents
   * @throws IOException if the JSON string is invalid with respect to ExportContents
   */
  public static ExportContents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportContents.class);
  }

  /**
   * Convert an instance of ExportContents to an JSON string
   *
   * @return JSON string
   */
