...
public class ScoutingObservationAttachments {
  ...
  private List<ScoutingObservationAttachment> results = new ArrayList<>();

  public ScoutingObservationAttachments() {
  }

  public ScoutingObservationAttachments results(List<ScoutingObservationAttachment> results) {
    this.results = results;
    return this;
  }

  public ScoutingObservationAttachments addResultsItem(ScoutingObservationAttachment resultsItem) {
  ...
  public List<ScoutingObservationAttachment> getResults() {
    return results;
  }

  public void setResults(List<ScoutingObservationAttachment> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScoutingObservationAttachments scoutingObservationAttachments = (ScoutingObservationAttachments) o;
    return Objects.equals(this.results, scoutingObservationAttachments.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScoutingObservationAttachments {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScoutingObservationAttachments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScoutingObservationAttachments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScoutingObservationAttachments is not found in the empty JSON string", ScoutingObservationAttachments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScoutingObservationAttachments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScoutingObservationAttachments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScoutingObservationAttachments.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        ScoutingObservationAttachment.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScoutingObservationAttachments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScoutingObservationAttachments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScoutingObservationAttachments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScoutingObservationAttachments.class));

       return (TypeAdapter<T>) new TypeAdapter<ScoutingObservationAttachments>() {
           @Override
           public void write(JsonWriter out, ScoutingObservationAttachments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScoutingObservationAttachments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScoutingObservationAttachments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScoutingObservationAttachments
   * @throws IOException if the JSON string is invalid with respect to ScoutingObservationAttachments
   */
  public static ScoutingObservationAttachments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScoutingObservationAttachments.class);
  }

  /**
   * Convert an instance of ScoutingObservationAttachments to an JSON string
   *
   * @return JSON string
   */
