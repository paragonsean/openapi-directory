...
/**
 * API tests for ResourceOwnersApi
 */
@Disabled
public class ResourceOwnersApiTest {

    private final ResourceOwnersApi api = new ResourceOwnersApi();
     ...
     */
    @Test
    public void getResourceOwnerTest() throws ApiException {
        UUID resourceOwnerId = null;
        ResourceOwner response = api.getResourceOwner(resourceOwnerId);
