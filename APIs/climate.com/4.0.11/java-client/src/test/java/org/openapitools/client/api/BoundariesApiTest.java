...
/**
 * API tests for BoundariesApi
 */
@Disabled
public class BoundariesApiTest {

    private final BoundariesApi api = new BoundariesApi();
     ...
     */
    @Test
    public void fetchBoundariesTest() throws ApiException {
        BoundariesQuery boundariesQuery = null;
        Boundaries response = api.fetchBoundaries(boundariesQuery);
     ...
     */
    @Test
    public void fetchBoundaryByIdTest() throws ApiException {
        UUID boundaryId = null;
        Boundary response = api.fetchBoundaryById(boundaryId);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void uploadBoundaryTest() throws ApiException {
        BoundaryUpload boundaryUpload = null;
        UploadedBoundaryId response = api.uploadBoundary(boundaryUpload);
        // TODO: test validations
    }
