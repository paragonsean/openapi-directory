...
/**
 * API tests for FarmOrganizationsApi
 */
@Disabled
public class FarmOrganizationsApiTest {

    private final FarmOrganizationsApi api = new FarmOrganizationsApi();
     ...
     */
    @Test
    public void fetchFarmOrganizationByTypeAndIdTest() throws ApiException {
        String farmOrganizationType = null;
        UUID farmOrganizationId = null;
        FarmOrganization response = api.fetchFarmOrganizationByTypeAndId(farmOrganizationType, farmOrganizationId);
