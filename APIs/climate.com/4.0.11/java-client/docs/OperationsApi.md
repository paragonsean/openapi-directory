...
<a id="fetchOperations"></a>
# **fetchOperations**
> Operations fetchOperations(resourceOwnerId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceOwnerId = "resourceOwnerId_example"; // String | Optional comma-separated list of resource owner unique identifiers by which to filter results.
    try {
      Operations result = apiInstance.fetchOperations(resourceOwnerId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OperationsApi#fetchOperations");
...
|-------------|-------------|------------------|
| **200** | Returns the requested operations. |  * X-Http-Request-Id - Unique identifier assigned to the request. <br>  |
