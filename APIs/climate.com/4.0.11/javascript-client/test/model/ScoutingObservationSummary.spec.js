...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservationSummary();
  });
  ...
  describe('ScoutingObservationSummary', function() {
    it('should create an instance of ScoutingObservationSummary', function() {
      // uncomment below and update the code to test ScoutingObservationSummary
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservationSummary();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservationSummary);
    });
