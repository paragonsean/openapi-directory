...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Upload();
  });
  ...
  describe('Upload', function() {
    it('should create an instance of Upload', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Upload();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Upload);
    });
