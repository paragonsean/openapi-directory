...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Operations();
  });
  ...
  describe('Operations', function() {
    it('should create an instance of Operations', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Operations();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Operations);
    });
