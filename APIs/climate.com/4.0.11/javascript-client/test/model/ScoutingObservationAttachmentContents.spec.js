...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachmentContents();
  });
  ...
  describe('ScoutingObservationAttachmentContents', function() {
    it('should create an instance of ScoutingObservationAttachmentContents', function() {
      // uncomment below and update the code to test ScoutingObservationAttachmentContents
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachmentContents();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservationAttachmentContents);
    });
