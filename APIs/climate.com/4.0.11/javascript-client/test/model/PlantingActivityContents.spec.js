...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.PlantingActivityContents();
  });
  ...
  describe('PlantingActivityContents', function() {
    it('should create an instance of PlantingActivityContents', function() {
      // uncomment below and update the code to test PlantingActivityContents
      //var instance = new ClimateFieldViewPlatformApis.PlantingActivityContents();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.PlantingActivityContents);
    });
