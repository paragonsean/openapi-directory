...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.UploadStatus();
  });
  ...
  describe('UploadStatus', function() {
    it('should create an instance of UploadStatus', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.UploadStatus();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.UploadStatus);
    });
