...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Geometry();
  });
  ...
  describe('Geometry', function() {
    it('should create an instance of Geometry', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Geometry();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Geometry);
    });
