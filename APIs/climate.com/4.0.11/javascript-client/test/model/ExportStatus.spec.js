...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ExportStatus();
  });
  ...
  describe('ExportStatus', function() {
    it('should create an instance of ExportStatus', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.ExportStatus();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ExportStatus);
    });
    ...
    it('should have the property xNextToken (base name: "xNextToken")', function() {
      // uncomment below and update the code to test the property xNextToken
      //var instance = new ClimateFieldViewPlatformApis.ExportStatus();
      //expect(instance).to.be();
    });
