...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ResourceOwner();
  });
  ...
  describe('ResourceOwner', function() {
    it('should create an instance of ResourceOwner', function() {
      // uncomment below and update the code to test ResourceOwner
      //var instance = new ClimateFieldViewPlatformApis.ResourceOwner();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ResourceOwner);
    });
