...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.HarvestActivitySummary();
  });
  ...
  describe('HarvestActivitySummary', function() {
    it('should create an instance of HarvestActivitySummary', function() {
      // uncomment below and update the code to test HarvestActivitySummary
      //var instance = new ClimateFieldViewPlatformApis.HarvestActivitySummary();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.HarvestActivitySummary);
    });
