...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.BoundaryProperties();
  });
  ...
  describe('BoundaryProperties', function() {
    it('should create an instance of BoundaryProperties', function() {
      // uncomment below and update the code to test BoundaryProperties
      //var instance = new ClimateFieldViewPlatformApis.BoundaryProperties();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.BoundaryProperties);
    });
