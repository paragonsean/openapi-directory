...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Area();
  });
  ...
  describe('Area', function() {
    it('should create an instance of Area', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Area();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Area);
    });
