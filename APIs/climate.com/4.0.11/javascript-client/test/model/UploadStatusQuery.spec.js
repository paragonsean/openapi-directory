...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.UploadStatusQuery();
  });
  ...
  describe('UploadStatusQuery', function() {
    it('should create an instance of UploadStatusQuery', function() {
      // uncomment below and update the code to test UploadStatusQuery
      //var instance = new ClimateFieldViewPlatformApis.UploadStatusQuery();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.UploadStatusQuery);
    });
