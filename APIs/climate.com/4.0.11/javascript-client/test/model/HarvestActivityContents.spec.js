...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.HarvestActivityContents();
  });
  ...
  describe('HarvestActivityContents', function() {
    it('should create an instance of HarvestActivityContents', function() {
      // uncomment below and update the code to test HarvestActivityContents
      //var instance = new ClimateFieldViewPlatformApis.HarvestActivityContents();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.HarvestActivityContents);
    });
