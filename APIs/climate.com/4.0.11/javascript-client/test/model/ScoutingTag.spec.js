...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingTag();
  });
  ...
  describe('ScoutingTag', function() {
    it('should create an instance of ScoutingTag', function() {
      // uncomment below and update the code to test ScoutingTag
      //var instance = new ClimateFieldViewPlatformApis.ScoutingTag();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingTag);
    });
