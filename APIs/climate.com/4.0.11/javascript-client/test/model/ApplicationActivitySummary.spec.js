...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ApplicationActivitySummary();
  });
  ...
  describe('ApplicationActivitySummary', function() {
    it('should create an instance of ApplicationActivitySummary', function() {
      // uncomment below and update the code to test ApplicationActivitySummary
      //var instance = new ClimateFieldViewPlatformApis.ApplicationActivitySummary();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ApplicationActivitySummary);
    });
