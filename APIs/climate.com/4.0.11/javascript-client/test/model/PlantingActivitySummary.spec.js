...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.PlantingActivitySummary();
  });
  ...
  describe('PlantingActivitySummary', function() {
    it('should create an instance of PlantingActivitySummary', function() {
      // uncomment below and update the code to test PlantingActivitySummary
      //var instance = new ClimateFieldViewPlatformApis.PlantingActivitySummary();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.PlantingActivitySummary);
    });
