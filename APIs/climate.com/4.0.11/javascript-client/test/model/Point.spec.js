...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Point();
  });
  ...
  describe('Point', function() {
    it('should create an instance of Point', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Point();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Point);
    });
