...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.BoundariesQuery();
  });
  ...
  describe('BoundariesQuery', function() {
    it('should create an instance of BoundariesQuery', function() {
      // uncomment below and update the code to test BoundariesQuery
      //var instance = new ClimateFieldViewPlatformApis.BoundariesQuery();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.BoundariesQuery);
    });
