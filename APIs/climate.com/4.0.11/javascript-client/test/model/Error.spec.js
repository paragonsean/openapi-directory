...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Error();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Error);
    });
