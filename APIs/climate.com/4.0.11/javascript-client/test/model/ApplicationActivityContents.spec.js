...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ApplicationActivityContents();
  });
  ...
  describe('ApplicationActivityContents', function() {
    it('should create an instance of ApplicationActivityContents', function() {
      // uncomment below and update the code to test ApplicationActivityContents
      //var instance = new ClimateFieldViewPlatformApis.ApplicationActivityContents();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ApplicationActivityContents);
    });
