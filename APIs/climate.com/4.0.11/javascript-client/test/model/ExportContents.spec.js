...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ExportContents();
  });
  ...
  describe('ExportContents', function() {
    it('should create an instance of ExportContents', function() {
      // uncomment below and update the code to test ExportContents
      //var instance = new ClimateFieldViewPlatformApis.ExportContents();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ExportContents);
    });
