...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Boundary();
  });
  ...
  describe('Boundary', function() {
    it('should create an instance of Boundary', function() {
      // uncomment below and update the code to test Boundary
      //var instance = new ClimateFieldViewPlatformApis.Boundary();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Boundary);
    });
