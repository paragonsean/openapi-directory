...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Operation();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Operation);
    });
