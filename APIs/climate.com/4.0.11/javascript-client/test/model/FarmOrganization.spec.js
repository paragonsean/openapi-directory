...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.FarmOrganization();
  });
  ...
  describe('FarmOrganization', function() {
    it('should create an instance of FarmOrganization', function() {
      // uncomment below and update the code to test FarmOrganization
      //var instance = new ClimateFieldViewPlatformApis.FarmOrganization();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.FarmOrganization);
    });
