...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachments();
  });
  ...
  describe('ScoutingObservationAttachments', function() {
    it('should create an instance of ScoutingObservationAttachments', function() {
      // uncomment below and update the code to test ScoutingObservationAttachments
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachments();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservationAttachments);
    });
