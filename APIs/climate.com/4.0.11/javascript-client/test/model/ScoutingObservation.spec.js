...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservation();
  });
  ...
  describe('ScoutingObservation', function() {
    it('should create an instance of ScoutingObservation', function() {
      // uncomment below and update the code to test ScoutingObservation
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservation();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservation);
    });
    ...
    it('should have the property locationDisplayColor (base name: "locationDisplayColor")', function() {
      // uncomment below and update the code to test the property locationDisplayColor
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservation();
      //expect(instance).to.be();
    });
