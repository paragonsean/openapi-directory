...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservations();
  });
  ...
  describe('ScoutingObservations', function() {
    it('should create an instance of ScoutingObservations', function() {
      // uncomment below and update the code to test ScoutingObservations
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservations();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservations);
    });
