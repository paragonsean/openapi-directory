...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Parent();
  });
  ...
  describe('Parent', function() {
    it('should create an instance of Parent', function() {
      // uncomment below and update the code to test Parent
      //var instance = new ClimateFieldViewPlatformApis.Parent();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Parent);
    });
