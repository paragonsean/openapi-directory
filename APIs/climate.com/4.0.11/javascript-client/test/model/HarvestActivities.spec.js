...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.HarvestActivities();
  });
  ...
  describe('HarvestActivities', function() {
    it('should create an instance of HarvestActivities', function() {
      // uncomment below and update the code to test HarvestActivities
      //var instance = new ClimateFieldViewPlatformApis.HarvestActivities();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.HarvestActivities);
    });
