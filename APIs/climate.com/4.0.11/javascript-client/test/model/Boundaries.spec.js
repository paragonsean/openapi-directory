...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Boundaries();
  });
  ...
  describe('Boundaries', function() {
    it('should create an instance of Boundaries', function() {
      // uncomment below and update the code to test Boundaries
      //var instance = new ClimateFieldViewPlatformApis.Boundaries();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Boundaries);
    });
