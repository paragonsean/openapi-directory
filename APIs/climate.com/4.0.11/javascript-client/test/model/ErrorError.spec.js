...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ErrorError();
  });
  ...
  describe('ErrorError', function() {
    it('should create an instance of ErrorError', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.ErrorError();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ErrorError);
    });
