...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Export();
  });
  ...
  describe('Export', function() {
    it('should create an instance of Export', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Export();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Export);
    });
