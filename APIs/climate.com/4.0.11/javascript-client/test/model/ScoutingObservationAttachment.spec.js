...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachment();
  });
  ...
  describe('ScoutingObservationAttachment', function() {
    it('should create an instance of ScoutingObservationAttachment', function() {
      // uncomment below and update the code to test ScoutingObservationAttachment
      //var instance = new ClimateFieldViewPlatformApis.ScoutingObservationAttachment();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ScoutingObservationAttachment);
    });
