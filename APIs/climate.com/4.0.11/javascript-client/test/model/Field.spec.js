...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Field();
  });
  ...
  describe('Field', function() {
    it('should create an instance of Field', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Field();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Field);
    });

    it('should have the property boundaryId (base name: "boundaryId")', function() {
      // uncomment below and update the code to test the property boundaryId
      //var instance = new ClimateFieldViewPlatformApis.Field();
