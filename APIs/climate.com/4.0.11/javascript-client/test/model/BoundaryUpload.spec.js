...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.BoundaryUpload();
  });
  ...
  describe('BoundaryUpload', function() {
    it('should create an instance of BoundaryUpload', function() {
      // uncomment below and update the code to test BoundaryUpload
      //var instance = new ClimateFieldViewPlatformApis.BoundaryUpload();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.BoundaryUpload);
    });
