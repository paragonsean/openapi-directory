...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.Fields();
  });
  ...
  describe('Fields', function() {
    it('should create an instance of Fields', function() {
      ...
      //var instance = new ClimateFieldViewPlatformApis.Fields();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.Fields);
    });
