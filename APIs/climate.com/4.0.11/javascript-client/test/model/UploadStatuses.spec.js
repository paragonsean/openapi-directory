...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.UploadStatuses();
  });
  ...
  describe('UploadStatuses', function() {
    it('should create an instance of UploadStatuses', function() {
      // uncomment below and update the code to test UploadStatuses
      //var instance = new ClimateFieldViewPlatformApis.UploadStatuses();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.UploadStatuses);
    });
