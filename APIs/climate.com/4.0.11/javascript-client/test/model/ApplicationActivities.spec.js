...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ApplicationActivities();
  });
  ...
  describe('ApplicationActivities', function() {
    it('should create an instance of ApplicationActivities', function() {
      // uncomment below and update the code to test ApplicationActivities
      //var instance = new ClimateFieldViewPlatformApis.ApplicationActivities();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.ApplicationActivities);
    });
