...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.CreatedExport();
  });
  ...
  describe('CreatedExport', function() {
    it('should create an instance of CreatedExport', function() {
      // uncomment below and update the code to test CreatedExport
      //var instance = new ClimateFieldViewPlatformApis.CreatedExport();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.CreatedExport);
    });
