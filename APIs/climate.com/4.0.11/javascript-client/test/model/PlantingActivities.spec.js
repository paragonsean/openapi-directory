...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.PlantingActivities();
  });
  ...
  describe('PlantingActivities', function() {
    it('should create an instance of PlantingActivities', function() {
      // uncomment below and update the code to test PlantingActivities
      //var instance = new ClimateFieldViewPlatformApis.PlantingActivities();
      //expect(instance).to.be.a(ClimateFieldViewPlatformApis.PlantingActivities);
    });
