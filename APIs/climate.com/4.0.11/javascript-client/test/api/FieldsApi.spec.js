...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.FieldsApi();
  });
  ...
  describe('FieldsApi', function() {
    describe('fetchAllFields', function() {
      it('should call fetchAllFields successfully', function(done) {
        //uncomment below and update the code to test fetchAllFields
        //instance.fetchAllFields(function(error) {
    ...
    describe('fetchFieldById', function() {
      it('should call fetchFieldById successfully', function(done) {
        //uncomment below and update the code to test fetchFieldById
        //instance.fetchFieldById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchFields', function() {
      it('should call fetchFields successfully', function(done) {
        //uncomment below and update the code to test fetchFields
        //instance.fetchFields(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
