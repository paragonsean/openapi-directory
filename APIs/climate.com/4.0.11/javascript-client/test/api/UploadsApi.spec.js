...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.UploadsApi();
  });
  ...
  describe('UploadsApi', function() {
    describe('chunkedUpload', function() {
      it('should call chunkedUpload successfully', function(done) {
        //uncomment below and update the code to test chunkedUpload
        //instance.chunkedUpload(function(error) {
    ...
    describe('fetchUploadStatusById', function() {
      it('should call fetchUploadStatusById successfully', function(done) {
        //uncomment below and update the code to test fetchUploadStatusById
        //instance.fetchUploadStatusById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchUploadStatuses', function() {
      it('should call fetchUploadStatuses successfully', function(done) {
        //uncomment below and update the code to test fetchUploadStatuses
        //instance.fetchUploadStatuses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postUpload', function() {
      it('should call postUpload successfully', function(done) {
        //uncomment below and update the code to test postUpload
        //instance.postUpload(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
