...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ResourceOwnersApi();
  });
  ...
  describe('ResourceOwnersApi', function() {
    describe('getResourceOwner', function() {
      it('should call getResourceOwner successfully', function(done) {
        //uncomment below and update the code to test getResourceOwner
        //instance.getResourceOwner(function(error) {
