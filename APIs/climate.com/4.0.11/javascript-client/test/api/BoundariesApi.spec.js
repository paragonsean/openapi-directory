...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.BoundariesApi();
  });
  ...
  describe('BoundariesApi', function() {
    describe('fetchBoundaries', function() {
      it('should call fetchBoundaries successfully', function(done) {
        //uncomment below and update the code to test fetchBoundaries
        //instance.fetchBoundaries(function(error) {
    ...
    describe('fetchBoundaryById', function() {
      it('should call fetchBoundaryById successfully', function(done) {
        //uncomment below and update the code to test fetchBoundaryById
        //instance.fetchBoundaryById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadBoundary', function() {
      it('should call uploadBoundary successfully', function(done) {
        //uncomment below and update the code to test uploadBoundary
        //instance.uploadBoundary(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
