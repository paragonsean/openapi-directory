...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.ExportsApi();
  });
  ...
  describe('ExportsApi', function() {
    describe('fetchExportContentsById', function() {
      it('should call fetchExportContentsById successfully', function(done) {
        //uncomment below and update the code to test fetchExportContentsById
        //instance.fetchExportContentsById(function(error) {
    ...
    describe('fetchExportStatusById', function() {
      it('should call fetchExportStatusById successfully', function(done) {
        //uncomment below and update the code to test fetchExportStatusById
        //instance.fetchExportStatusById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postExport', function() {
      it('should call postExport successfully', function(done) {
        //uncomment below and update the code to test postExport
        //instance.postExport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
