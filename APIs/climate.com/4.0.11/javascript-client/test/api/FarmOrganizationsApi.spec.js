...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.FarmOrganizationsApi();
  });
  ...
  describe('FarmOrganizationsApi', function() {
    describe('fetchFarmOrganizationByTypeAndId', function() {
      it('should call fetchFarmOrganizationByTypeAndId successfully', function(done) {
        //uncomment below and update the code to test fetchFarmOrganizationByTypeAndId
        //instance.fetchFarmOrganizationByTypeAndId(function(error) {
