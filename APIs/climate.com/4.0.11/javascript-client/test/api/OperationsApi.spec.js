...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClimateFieldViewPlatformApis.OperationsApi();
  });
  ...
  describe('OperationsApi', function() {
    describe('fetchOperations', function() {
      it('should call fetchOperations successfully', function(done) {
        //uncomment below and update the code to test fetchOperations
        //instance.fetchOperations(function(error) {
