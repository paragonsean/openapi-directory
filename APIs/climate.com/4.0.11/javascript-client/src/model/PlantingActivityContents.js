...
/**
 * The PlantingActivityContents model module.
 * @module model/PlantingActivityContents
 * @version 4.0.11
 */
class PlantingActivityContents {
    /**
     * Constructs a new <code>PlantingActivityContents</code>.
     * @alias module:model/PlantingActivityContents
     * @param body {File} Binary contents
     */
    constructor(body) { 
        
        PlantingActivityContents.initialize(this, body);
    }
    ...
    /**
     * Constructs a <code>PlantingActivityContents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlantingActivityContents} obj Optional instance to populate.
     * @return {module:model/PlantingActivityContents} The populated <code>PlantingActivityContents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlantingActivityContents();
    ...
    /**
     * Validates the JSON data with respect to <code>PlantingActivityContents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlantingActivityContents</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlantingActivityContents.RequiredProperties) {
...
PlantingActivityContents.RequiredProperties = ["body"];

/**
 * Binary contents
 * @member {File} body
 */
PlantingActivityContents.prototype['body'] = undefined;
...
export default PlantingActivityContents;
