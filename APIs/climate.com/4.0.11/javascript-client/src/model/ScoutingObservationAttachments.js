...
/**
 * The ScoutingObservationAttachments model module.
 * @module model/ScoutingObservationAttachments
 * @version 4.0.11
 */
class ScoutingObservationAttachments {
    /**
     * Constructs a new <code>ScoutingObservationAttachments</code>.
     * A batch of scouting attachments
     * @alias module:model/ScoutingObservationAttachments
     * @param results {Array.<module:model/ScoutingObservationAttachment>} 
     */
    constructor(results) { 
        
        ScoutingObservationAttachments.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>ScoutingObservationAttachments</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingObservationAttachments} obj Optional instance to populate.
     * @return {module:model/ScoutingObservationAttachments} The populated <code>ScoutingObservationAttachments</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingObservationAttachments();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ScoutingObservationAttachment]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingObservationAttachments</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingObservationAttachments</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingObservationAttachments.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ScoutingObservationAttachment.validateJSON(item);
            };
        }
...
ScoutingObservationAttachments.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/ScoutingObservationAttachment>} results
 */
ScoutingObservationAttachments.prototype['results'] = undefined;
...
export default ScoutingObservationAttachments;
