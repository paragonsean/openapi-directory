...
/**
 * The ScoutingObservationSummary model module.
 * @module model/ScoutingObservationSummary
 * @version 4.0.11
 */
class ScoutingObservationSummary {
    /**
     * Constructs a new <code>ScoutingObservationSummary</code>.
     * @alias module:model/ScoutingObservationSummary
     ...
     */
    constructor(endTime, id, startTime, updatedAt) { 
        
        ScoutingObservationSummary.initialize(this, endTime, id, startTime, updatedAt);
    }
     ...
     */
    static initialize(obj, endTime, id, startTime, updatedAt) { 
        obj['endTime'] = endTime;
        obj['id'] = id;
    ...
    /**
     * Constructs a <code>ScoutingObservationSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingObservationSummary} obj Optional instance to populate.
     * @return {module:model/ScoutingObservationSummary} The populated <code>ScoutingObservationSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingObservationSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingObservationSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingObservationSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingObservationSummary.RequiredProperties) {
...
ScoutingObservationSummary.RequiredProperties = ["endTime", "id", "startTime", "updatedAt"];
 ...
 * @member {Date} endTime
 */
ScoutingObservationSummary.prototype['endTime'] = undefined;

/**
 * The id of a scouting observation.
 * @member {String} id
 */
ScoutingObservationSummary.prototype['id'] = undefined;

/**
 * The start time of the scouting observation. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
 * @member {Date} startTime
 */
ScoutingObservationSummary.prototype['startTime'] = undefined;
 ...
 */
ScoutingObservationSummary.prototype['updatedAt'] = undefined;
...
export default ScoutingObservationSummary;
