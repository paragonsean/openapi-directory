...
class Export {
     ...
     * @param contentType {module:model/Export.ContentTypeEnum} Content type representing data being exported (e.g. application/vnd.climate.acrsi.geojson).
     */
    constructor(contentType) { 
        
        Export.initialize(this, contentType);
    }
...
Export['ContentTypeEnum'] = {
    ...
    /**
     * value: "application/vnd.climate.acrsi.geojson"
     * @const
     */
    "acrsi.geojson": "application/vnd.climate.acrsi.geojson",

    /**
     * value: "application/vnd.climate.harvest.geojson"
     * @const
     */
    "harvest.geojson": "application/vnd.climate.harvest.geojson"
};
