...
class UploadStatus {
    ...
    /**
     * Constructs a <code>UploadStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadStatus} obj Optional instance to populate.
     * @return {module:model/UploadStatus} The populated <code>UploadStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UploadStatus.RequiredProperties) {
...
UploadStatus.RequiredProperties = ["id", "status"];

/**
 * Unique identifier for the upload.
 * @member {String} id
 */
UploadStatus.prototype['id'] = undefined;

/**
 * Current status of the upload:   * `UPLOADING` - Uploading has started, parts are still coming in.   * `INVALID` - Upload has failed validity check.   * `PENDING` - Upload has been received by Climate and is being processed.   * `INBOX` - The upload is awaiting user acceptance in their Data Inbox.   * `DECLINED` - The user has declined the upload in their Data Inbox.   * `IMPORTING` - The user has accepted the upload and it is being imported into their account.   * `SUCCESS` - The upload has been successfully imported. 
 * @member {module:model/UploadStatus.StatusEnum} status
 */
UploadStatus.prototype['status'] = undefined;
