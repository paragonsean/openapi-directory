...
/**
 * The ApplicationActivities model module.
 * @module model/ApplicationActivities
 * @version 4.0.11
 */
class ApplicationActivities {
    /**
     * Constructs a new <code>ApplicationActivities</code>.
     * A batch of application activities
     * @alias module:model/ApplicationActivities
     * @param results {Array.<module:model/ApplicationActivitySummary>} 
     */
    constructor(results) { 
        
        ApplicationActivities.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>ApplicationActivities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationActivities} obj Optional instance to populate.
     * @return {module:model/ApplicationActivities} The populated <code>ApplicationActivities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationActivities();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ApplicationActivitySummary]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationActivities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationActivities</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationActivities.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ApplicationActivitySummary.validateJSON(item);
            };
        }
...
ApplicationActivities.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/ApplicationActivitySummary>} results
 */
ApplicationActivities.prototype['results'] = undefined;
