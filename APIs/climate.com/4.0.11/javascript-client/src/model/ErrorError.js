...
class ErrorError {
     ...
     * @param code {String} 
     * @param id {String} 
     * @param message {String} Description of the error encountered.
     */
    constructor(code, id, message) { 
        
        ErrorError.initialize(this, code, id, message);
    }
...
ErrorError.RequiredProperties = ["code", "id", "message"];
 ...
 * @member {String} id
 */
ErrorError.prototype['id'] = undefined;
