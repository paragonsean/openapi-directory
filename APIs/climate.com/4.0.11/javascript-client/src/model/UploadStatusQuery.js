...
/**
 * The UploadStatusQuery model module.
 * @module model/UploadStatusQuery
 * @version 4.0.11
 */
class UploadStatusQuery {
    /**
     * Constructs a new <code>UploadStatusQuery</code>.
     * @alias module:model/UploadStatusQuery
     * @param ids {Array.<String>} 
     */
    constructor(ids) { 
        
        UploadStatusQuery.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>UploadStatusQuery</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadStatusQuery} obj Optional instance to populate.
     * @return {module:model/UploadStatusQuery} The populated <code>UploadStatusQuery</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadStatusQuery();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadStatusQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadStatusQuery</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UploadStatusQuery.RequiredProperties) {
...
UploadStatusQuery.RequiredProperties = ["ids"];

/**
 * @member {Array.<String>} ids
 */
UploadStatusQuery.prototype['ids'] = undefined;
...
export default UploadStatusQuery;
