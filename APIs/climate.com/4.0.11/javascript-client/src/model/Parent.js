...
class Parent {
     ...
     * @param id {String} Unique identifier for the parent of a farm organization.
     * @param type {module:model/Parent.TypeEnum} Type of the parent of a farm organization.
     */
    constructor(id, type) { 
        
        Parent.initialize(this, id, type);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Parent.RequiredProperties) {
...
Parent.RequiredProperties = ["id", "type"];
 ...
 * @member {module:model/Parent.TypeEnum} type
 */
Parent.prototype['type'] = undefined;
