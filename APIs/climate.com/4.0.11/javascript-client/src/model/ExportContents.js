...
/**
 * The ExportContents model module.
 * @module model/ExportContents
 * @version 4.0.11
 */
class ExportContents {
    /**
     * Constructs a new <code>ExportContents</code>.
     * @alias module:model/ExportContents
     * @param body {File} Binary contents
     */
    constructor(body) { 
        
        ExportContents.initialize(this, body);
    }
    ...
    /**
     * Constructs a <code>ExportContents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExportContents} obj Optional instance to populate.
     * @return {module:model/ExportContents} The populated <code>ExportContents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExportContents();

            if (data.hasOwnProperty('body')) {
                obj['body'] = ApiClient.convertToType(data['body'], File);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExportContents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportContents</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExportContents.RequiredProperties) {
...
ExportContents.RequiredProperties = ["body"];

/**
 * Binary contents
 * @member {File} body
 */
ExportContents.prototype['body'] = undefined;
