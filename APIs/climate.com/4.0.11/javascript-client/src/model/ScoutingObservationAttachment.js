...
/**
 * The ScoutingObservationAttachment model module.
 * @module model/ScoutingObservationAttachment
 * @version 4.0.11
 */
class ScoutingObservationAttachment {
    /**
     * Constructs a new <code>ScoutingObservationAttachment</code>.
     * @alias module:model/ScoutingObservationAttachment
     * @param contentType {String} The content type of the attachment, e.g. image/png.
     * @param id {String} id of the attachment
     * @param length {Number} The number of bytes in the attachment.
     * @param status {module:model/ScoutingObservationAttachment.StatusEnum} The status of the attachment. For example : ACTIVE, DELETED
     * @param updatedAt {Date} The time the attachment was last updated. Time in ISO 8601 format with UTC timezone, 3 fractional seconds. (https://tools.ietf.org/html/rfc3339) 
     */
    constructor(contentType, id, length, status, updatedAt) { 
        
        ScoutingObservationAttachment.initialize(this, contentType, id, length, status, updatedAt);
    }
     ...
     */
    static initialize(obj, contentType, id, length, status, updatedAt) { 
    ...
    /**
     * Constructs a <code>ScoutingObservationAttachment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingObservationAttachment} obj Optional instance to populate.
     * @return {module:model/ScoutingObservationAttachment} The populated <code>ScoutingObservationAttachment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingObservationAttachment();
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingObservationAttachment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingObservationAttachment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingObservationAttachment.RequiredProperties) {
...
ScoutingObservationAttachment.RequiredProperties = ["contentType", "id", "length", "status", "updatedAt"];

/**
 * The content type of the attachment, e.g. image/png.
 * @member {String} contentType
 */
ScoutingObservationAttachment.prototype['contentType'] = undefined;

/**
 * id of the attachment
 * @member {String} id
 */
ScoutingObservationAttachment.prototype['id'] = undefined;

/**
 * The number of bytes in the attachment.
 * @member {Number} length
 */
ScoutingObservationAttachment.prototype['length'] = undefined;

/**
 * The status of the attachment. For example : ACTIVE, DELETED
 * @member {module:model/ScoutingObservationAttachment.StatusEnum} status
 */
ScoutingObservationAttachment.prototype['status'] = undefined;
 ...
 */
ScoutingObservationAttachment.prototype['updatedAt'] = undefined;
 ...
 * @readonly
 */
ScoutingObservationAttachment['StatusEnum'] = {
...
export default ScoutingObservationAttachment;
