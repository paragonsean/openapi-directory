...
/**
 * The ScoutingObservationAttachmentContents model module.
 * @module model/ScoutingObservationAttachmentContents
 * @version 4.0.11
 */
class ScoutingObservationAttachmentContents {
    /**
     * Constructs a new <code>ScoutingObservationAttachmentContents</code>.
     * @alias module:model/ScoutingObservationAttachmentContents
     * @param body {File} Binary contents
     */
    constructor(body) { 
        
        ScoutingObservationAttachmentContents.initialize(this, body);
    }
    ...
    /**
     * Constructs a <code>ScoutingObservationAttachmentContents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingObservationAttachmentContents} obj Optional instance to populate.
     * @return {module:model/ScoutingObservationAttachmentContents} The populated <code>ScoutingObservationAttachmentContents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingObservationAttachmentContents();
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingObservationAttachmentContents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingObservationAttachmentContents</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingObservationAttachmentContents.RequiredProperties) {
...
ScoutingObservationAttachmentContents.RequiredProperties = ["body"];

/**
 * Binary contents
 * @member {File} body
 */
ScoutingObservationAttachmentContents.prototype['body'] = undefined;
...
export default ScoutingObservationAttachmentContents;
