...
class ExportStatus {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('xNextToken')) {
                obj['xNextToken'] = ApiClient.convertToType(data['xNextToken'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ExportStatus.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['xNextToken'] && !(typeof data['xNextToken'] === 'string' || data['xNextToken'] instanceof String)) {
            throw new Error("Expected the field `xNextToken` to be a primitive type in the JSON string but got " + data['xNextToken']);
        }
...
ExportStatus.RequiredProperties = ["status"];

/**
 * Base64 encoded MD5 hash of the export's contents.
 * @member {String} checksum
 */
ExportStatus.prototype['checksum'] = undefined;

/**
 * Message indicating reason for validation failure.
 * @member {String} error
 */
ExportStatus.prototype['error'] = undefined;

/**
 * Size of the export's contents in bytes.
 * @member {Number} size
 */
ExportStatus.prototype['size'] = undefined;

/**
 * Current status of the export request:   * `PROCESSING` - Export request has been received by Climate and is being processed.   * `INVALID` - Export request has failed validity check.   * `EXPIRED` - Export contents have expired, and are no longer available for retrieval.   * `COMPLETED` - The export request has been successfully processed, and its contents are available for retrieval.   * `NO_DATA` - The export request completed successfully but generated no data. 
 * @member {module:model/ExportStatus.StatusEnum} status
 */
ExportStatus.prototype['status'] = undefined;
 ...
 * @member {String} xNextToken
 */
ExportStatus.prototype['xNextToken'] = undefined;
