...
/**
 * The HarvestActivityContents model module.
 * @module model/HarvestActivityContents
 * @version 4.0.11
 */
class HarvestActivityContents {
    /**
     * Constructs a new <code>HarvestActivityContents</code>.
     * @alias module:model/HarvestActivityContents
     * @param body {File} Binary contents
     */
    constructor(body) { 
        
        HarvestActivityContents.initialize(this, body);
    }
    ...
    /**
     * Constructs a <code>HarvestActivityContents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HarvestActivityContents} obj Optional instance to populate.
     * @return {module:model/HarvestActivityContents} The populated <code>HarvestActivityContents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HarvestActivityContents();
    ...
    /**
     * Validates the JSON data with respect to <code>HarvestActivityContents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HarvestActivityContents</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HarvestActivityContents.RequiredProperties) {
...
HarvestActivityContents.RequiredProperties = ["body"];

/**
 * Binary contents
 * @member {File} body
 */
HarvestActivityContents.prototype['body'] = undefined;
...
export default HarvestActivityContents;
