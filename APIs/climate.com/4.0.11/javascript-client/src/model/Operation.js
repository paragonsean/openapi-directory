...
class Operation {
     ...
     * @param resourceOwnerId {String} Unique identifier of the resource owner that owns the Operation.
     */
    constructor(id, name, resourceOwnerId) { 
        
        Operation.initialize(this, id, name, resourceOwnerId);
    }
     ...
     */
    static initialize(obj, id, name, resourceOwnerId) { 
        obj['id'] = id;
        obj['name'] = name;
...
Operation.RequiredProperties = ["id", "name", "resourceOwnerId"];
 ...
 */
Operation.prototype['resourceOwnerId'] = undefined;
