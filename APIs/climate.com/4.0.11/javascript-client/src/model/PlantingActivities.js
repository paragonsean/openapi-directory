...
/**
 * The PlantingActivities model module.
 * @module model/PlantingActivities
 * @version 4.0.11
 */
class PlantingActivities {
    /**
     * Constructs a new <code>PlantingActivities</code>.
     * A batch of planting activities
     * @alias module:model/PlantingActivities
     * @param results {Array.<module:model/PlantingActivitySummary>} 
     */
    constructor(results) { 
        
        PlantingActivities.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>PlantingActivities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlantingActivities} obj Optional instance to populate.
     * @return {module:model/PlantingActivities} The populated <code>PlantingActivities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlantingActivities();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [PlantingActivitySummary]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PlantingActivities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlantingActivities</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PlantingActivities.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                PlantingActivitySummary.validateJSON(item);
            };
        }
...
PlantingActivities.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/PlantingActivitySummary>} results
 */
PlantingActivities.prototype['results'] = undefined;
