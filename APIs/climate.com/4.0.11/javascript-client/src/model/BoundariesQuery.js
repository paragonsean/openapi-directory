...
/**
 * The BoundariesQuery model module.
 * @module model/BoundariesQuery
 * @version 4.0.11
 */
class BoundariesQuery {
    /**
     * Constructs a new <code>BoundariesQuery</code>.
     * @alias module:model/BoundariesQuery
     * @param ids {Array.<String>} 
     */
    constructor(ids) { 
        
        BoundariesQuery.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>BoundariesQuery</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BoundariesQuery} obj Optional instance to populate.
     * @return {module:model/BoundariesQuery} The populated <code>BoundariesQuery</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BoundariesQuery();
    ...
    /**
     * Validates the JSON data with respect to <code>BoundariesQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoundariesQuery</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BoundariesQuery.RequiredProperties) {
...
BoundariesQuery.RequiredProperties = ["ids"];

/**
 * @member {Array.<String>} ids
 */
BoundariesQuery.prototype['ids'] = undefined;
...
export default BoundariesQuery;
