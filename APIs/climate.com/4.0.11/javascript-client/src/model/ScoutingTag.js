...
/**
 * The ScoutingTag model module.
 * @module model/ScoutingTag
 * @version 4.0.11
 */
class ScoutingTag {
    /**
     * Constructs a new <code>ScoutingTag</code>.
     * @alias module:model/ScoutingTag
     * @param code {String} 
     */
    constructor(code) { 
        
        ScoutingTag.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>ScoutingTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingTag} obj Optional instance to populate.
     * @return {module:model/ScoutingTag} The populated <code>ScoutingTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingTag();
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingTag</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingTag.RequiredProperties) {
...
ScoutingTag.RequiredProperties = ["code"];

/**
 * @member {String} code
 */
ScoutingTag.prototype['code'] = undefined;
