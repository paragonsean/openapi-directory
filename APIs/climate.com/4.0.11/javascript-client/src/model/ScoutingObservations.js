...
/**
 * The ScoutingObservations model module.
 * @module model/ScoutingObservations
 * @version 4.0.11
 */
class ScoutingObservations {
    /**
     * Constructs a new <code>ScoutingObservations</code>.
     * A batch of scouting observations
     * @alias module:model/ScoutingObservations
     * @param results {Array.<module:model/ScoutingObservationSummary>} 
     */
    constructor(results) { 
        
        ScoutingObservations.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>ScoutingObservations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoutingObservations} obj Optional instance to populate.
     * @return {module:model/ScoutingObservations} The populated <code>ScoutingObservations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoutingObservations();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ScoutingObservationSummary]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScoutingObservations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoutingObservations</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoutingObservations.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ScoutingObservationSummary.validateJSON(item);
            };
        }
...
ScoutingObservations.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/ScoutingObservationSummary>} results
 */
ScoutingObservations.prototype['results'] = undefined;
...
export default ScoutingObservations;
