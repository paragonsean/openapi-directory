...
/**
 * The BoundaryUpload model module.
 * @module model/BoundaryUpload
 * @version 4.0.11
 */
class BoundaryUpload {
    /**
     * Constructs a new <code>BoundaryUpload</code>.
     * Arbitrary boundary in a geometry map
     * @alias module:model/BoundaryUpload
     * @param geometry {module:model/Geometry} 
     */
    constructor(geometry) { 
        
        BoundaryUpload.initialize(this, geometry);
    }
    ...
    /**
     * Constructs a <code>BoundaryUpload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BoundaryUpload} obj Optional instance to populate.
     * @return {module:model/BoundaryUpload} The populated <code>BoundaryUpload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BoundaryUpload();
    ...
    /**
     * Validates the JSON data with respect to <code>BoundaryUpload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoundaryUpload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BoundaryUpload.RequiredProperties) {
...
BoundaryUpload.RequiredProperties = ["geometry"];

/**
 * @member {module:model/Geometry} geometry
 */
BoundaryUpload.prototype['geometry'] = undefined;
