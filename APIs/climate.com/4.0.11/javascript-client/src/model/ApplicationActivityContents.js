...
/**
 * The ApplicationActivityContents model module.
 * @module model/ApplicationActivityContents
 * @version 4.0.11
 */
class ApplicationActivityContents {
    /**
     * Constructs a new <code>ApplicationActivityContents</code>.
     * @alias module:model/ApplicationActivityContents
     * @param body {File} Binary contents
     */
    constructor(body) { 
        
        ApplicationActivityContents.initialize(this, body);
    }
    ...
    /**
     * Constructs a <code>ApplicationActivityContents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationActivityContents} obj Optional instance to populate.
     * @return {module:model/ApplicationActivityContents} The populated <code>ApplicationActivityContents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationActivityContents();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationActivityContents</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationActivityContents</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationActivityContents.RequiredProperties) {
...
ApplicationActivityContents.RequiredProperties = ["body"];

/**
 * Binary contents
 * @member {File} body
 */
ApplicationActivityContents.prototype['body'] = undefined;
...
export default ApplicationActivityContents;
