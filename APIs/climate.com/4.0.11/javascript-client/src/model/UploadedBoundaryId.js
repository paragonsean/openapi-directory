...
/**
 * The UploadedBoundaryId model module.
 * @module model/UploadedBoundaryId
 * @version 4.0.11
 */
class UploadedBoundaryId {
    /**
     * Constructs a new <code>UploadedBoundaryId</code>.
     * Unique identifier of a successfully uploaded boundary
     * @alias module:model/UploadedBoundaryId
     * @param id {String} 
     */
    constructor(id) { 
        
        UploadedBoundaryId.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>UploadedBoundaryId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadedBoundaryId} obj Optional instance to populate.
     * @return {module:model/UploadedBoundaryId} The populated <code>UploadedBoundaryId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadedBoundaryId();
    ...
    /**
     * Validates the JSON data with respect to <code>UploadedBoundaryId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadedBoundaryId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UploadedBoundaryId.RequiredProperties) {
...
UploadedBoundaryId.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
UploadedBoundaryId.prototype['id'] = undefined;
...
export default UploadedBoundaryId;
