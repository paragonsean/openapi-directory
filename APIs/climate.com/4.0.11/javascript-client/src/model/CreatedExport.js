...
/**
 * The CreatedExport model module.
 * @module model/CreatedExport
 * @version 4.0.11
 */
class CreatedExport {
    /**
     * Constructs a new <code>CreatedExport</code>.
     * @alias module:model/CreatedExport
     * @param id {String} Unique identifier for the export.
     */
    constructor(id) { 
        
        CreatedExport.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>CreatedExport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatedExport} obj Optional instance to populate.
     * @return {module:model/CreatedExport} The populated <code>CreatedExport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatedExport();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatedExport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatedExport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatedExport.RequiredProperties) {
...
CreatedExport.RequiredProperties = ["id"];

/**
 * Unique identifier for the export.
 * @member {String} id
 */
CreatedExport.prototype['id'] = undefined;
