...
class Area {
    ...
    static validateJSON(data) {
        ...
        if (data['u'] && !(typeof data['u'] === 'string' || data['u'] instanceof String)) {
            throw new Error("Expected the field `u` to be a primitive type in the JSON string but got " + data['u']);
        }
...
Area.RequiredProperties = ["q", "u"];

/**
 * @member {Number} q
 */
Area.prototype['q'] = undefined;

/**
 * @member {String} u
 */
Area.prototype['u'] = undefined;
