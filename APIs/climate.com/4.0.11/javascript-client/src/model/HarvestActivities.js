...
/**
 * The HarvestActivities model module.
 * @module model/HarvestActivities
 * @version 4.0.11
 */
class HarvestActivities {
    /**
     * Constructs a new <code>HarvestActivities</code>.
     * A batch of harvest activities
     * @alias module:model/HarvestActivities
     * @param results {Array.<module:model/HarvestActivitySummary>} 
     */
    constructor(results) { 
        
        HarvestActivities.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>HarvestActivities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HarvestActivities} obj Optional instance to populate.
     * @return {module:model/HarvestActivities} The populated <code>HarvestActivities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HarvestActivities();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [HarvestActivitySummary]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HarvestActivities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HarvestActivities</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HarvestActivities.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                HarvestActivitySummary.validateJSON(item);
            };
        }
...
HarvestActivities.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/HarvestActivitySummary>} results
 */
HarvestActivities.prototype['results'] = undefined;
