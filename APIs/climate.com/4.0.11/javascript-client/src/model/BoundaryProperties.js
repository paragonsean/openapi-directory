...
/**
 * The BoundaryProperties model module.
 * @module model/BoundaryProperties
 * @version 4.0.11
 */
class BoundaryProperties {
    /**
     * Constructs a new <code>BoundaryProperties</code>.
     * Properties map.
     * @alias module:model/BoundaryProperties
     * @param area {module:model/Area} 
     * @param centroid {module:model/Point} 
     */
    constructor(area, centroid) { 
        
        BoundaryProperties.initialize(this, area, centroid);
    }
     ...
     */
    static initialize(obj, area, centroid) { 
        obj['area'] = area;
        obj['centroid'] = centroid;
    }

    /**
     * Constructs a <code>BoundaryProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BoundaryProperties} obj Optional instance to populate.
     * @return {module:model/BoundaryProperties} The populated <code>BoundaryProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BoundaryProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>BoundaryProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BoundaryProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BoundaryProperties.RequiredProperties) {
...
BoundaryProperties.RequiredProperties = ["area", "centroid"];

/**
 * @member {module:model/Area} area
 */
BoundaryProperties.prototype['area'] = undefined;

/**
 * @member {module:model/Point} centroid
 */
BoundaryProperties.prototype['centroid'] = undefined;
