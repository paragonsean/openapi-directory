...
/**
 * The HarvestActivitySummary model module.
 * @module model/HarvestActivitySummary
 * @version 4.0.11
 */
class HarvestActivitySummary {
    /**
     * Constructs a new <code>HarvestActivitySummary</code>.
     * @alias module:model/HarvestActivitySummary
     * @param createdAt {Date} The time the harvest activity was created. Time in ISO 8601 format with UTC timezone, 3 fractional seconds. (https://tools.ietf.org/html/rfc3339).
     * @param endTime {Date} The start time of the harvest activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
     * @param fieldIds {Array.<String>} Array of field ids associated the harvest activity.
     * @param id {String} The id of a harvest activity.
     * @param length {Number} The size in bytes of the raw harvest activity file.
     * @param startTime {Date} The start time of the harvest activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
     * @param updatedAt {Date} The time the harvest activity was last updated. Time in ISO 8601 format with UTC timezone, 3 fractional seconds. (https://tools.ietf.org/html/rfc3339).
     */
    constructor(createdAt, endTime, fieldIds, id, length, startTime, updatedAt) { 
        
        HarvestActivitySummary.initialize(this, createdAt, endTime, fieldIds, id, length, startTime, updatedAt);
    }
    ...
    /**
     * Constructs a <code>HarvestActivitySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HarvestActivitySummary} obj Optional instance to populate.
     * @return {module:model/HarvestActivitySummary} The populated <code>HarvestActivitySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HarvestActivitySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>HarvestActivitySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HarvestActivitySummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HarvestActivitySummary.RequiredProperties) {
...
HarvestActivitySummary.RequiredProperties = ["createdAt", "endTime", "fieldIds", "id", "length", "startTime", "updatedAt"];
 ...
 */
HarvestActivitySummary.prototype['createdAt'] = undefined;
 ...
 * @member {Date} endTime
 */
HarvestActivitySummary.prototype['endTime'] = undefined;

/**
 * Array of field ids associated the harvest activity.
 * @member {Array.<String>} fieldIds
 */
HarvestActivitySummary.prototype['fieldIds'] = undefined;

/**
 * The id of a harvest activity.
 * @member {String} id
 */
HarvestActivitySummary.prototype['id'] = undefined;

/**
 * The size in bytes of the raw harvest activity file.
 * @member {Number} length
 */
HarvestActivitySummary.prototype['length'] = undefined;

/**
 * The start time of the harvest activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
 * @member {Date} startTime
 */
HarvestActivitySummary.prototype['startTime'] = undefined;
 ...
 */
HarvestActivitySummary.prototype['updatedAt'] = undefined;
...
export default HarvestActivitySummary;
