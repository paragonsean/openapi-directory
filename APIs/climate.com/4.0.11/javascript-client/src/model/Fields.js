...
class Fields {
     ...
     * @param results {Array.<module:model/Field>} 
     */
    constructor(results) { 
        
        Fields.initialize(this, results);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Field]);
            }
        }
        return obj;
    }
...
Fields.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/Field>} results
 */
Fields.prototype['results'] = undefined;
