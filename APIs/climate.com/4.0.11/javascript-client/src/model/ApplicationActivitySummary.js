...
/**
 * The ApplicationActivitySummary model module.
 * @module model/ApplicationActivitySummary
 * @version 4.0.11
 */
class ApplicationActivitySummary {
    /**
     * Constructs a new <code>ApplicationActivitySummary</code>.
     * @alias module:model/ApplicationActivitySummary
     * @param createdAt {Date} The time the application activity was created. Time in ISO 8601 format with UTC timezone, 3 fractional seconds. (https://tools.ietf.org/html/rfc3339).
     * @param endTime {Date} The start time of the application activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
     * @param fieldIds {Array.<String>} Array of field ids associated the application activity.
     * @param id {String} The id of an application activity.
     * @param length {Number} The size in bytes of the raw application activity file.
     * @param startTime {Date} The start time of the application activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
     * @param updatedAt {Date} The time the application activity was last updated. Time in ISO 8601 format with UTC timezone, 3 fractional seconds. (https://tools.ietf.org/html/rfc3339).
     */
    constructor(createdAt, endTime, fieldIds, id, length, startTime, updatedAt) { 
        
        ApplicationActivitySummary.initialize(this, createdAt, endTime, fieldIds, id, length, startTime, updatedAt);
    }
    ...
    /**
     * Constructs a <code>ApplicationActivitySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationActivitySummary} obj Optional instance to populate.
     * @return {module:model/ApplicationActivitySummary} The populated <code>ApplicationActivitySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationActivitySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationActivitySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationActivitySummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationActivitySummary.RequiredProperties) {
...
ApplicationActivitySummary.RequiredProperties = ["createdAt", "endTime", "fieldIds", "id", "length", "startTime", "updatedAt"];
 ...
 */
ApplicationActivitySummary.prototype['createdAt'] = undefined;
 ...
 * @member {Date} endTime
 */
ApplicationActivitySummary.prototype['endTime'] = undefined;

/**
 * Array of field ids associated the application activity.
 * @member {Array.<String>} fieldIds
 */
ApplicationActivitySummary.prototype['fieldIds'] = undefined;

/**
 * The id of an application activity.
 * @member {String} id
 */
ApplicationActivitySummary.prototype['id'] = undefined;

/**
 * The size in bytes of the raw application activity file.
 * @member {Number} length
 */
ApplicationActivitySummary.prototype['length'] = undefined;

/**
 * The start time of the application activity. Time in ISO 8601 format with UTC timezone, 3 fractional seconds (https://tools.ietf.org/html/rfc3339).
 * @member {Date} startTime
 */
ApplicationActivitySummary.prototype['startTime'] = undefined;
 ...
 */
ApplicationActivitySummary.prototype['updatedAt'] = undefined;
...
export default ApplicationActivitySummary;
