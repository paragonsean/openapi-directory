...
/**
 * The FarmOrganization model module.
 * @module model/FarmOrganization
 * @version 4.0.11
 */
class FarmOrganization {
    /**
     * Constructs a new <code>FarmOrganization</code>.
     * Logical representation of a farm organization with a name and type.
     * @alias module:model/FarmOrganization
     * @param id {String} Unique identifier for a farm organization.
     * @param name {String} Name of the farm organization.
     * @param type {module:model/FarmOrganization.TypeEnum} Type of the farm organization.
     */
    constructor(id, name, type) { 
        
        FarmOrganization.initialize(this, id, name, type);
    }
    ...
    /**
     * Constructs a <code>FarmOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FarmOrganization} obj Optional instance to populate.
     * @return {module:model/FarmOrganization} The populated <code>FarmOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FarmOrganization();
    ...
    /**
     * Validates the JSON data with respect to <code>FarmOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FarmOrganization</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FarmOrganization.RequiredProperties) {
...
FarmOrganization.RequiredProperties = ["id", "name", "type"];

/**
 * Unique identifier for a farm organization.
 * @member {String} id
 */
FarmOrganization.prototype['id'] = undefined;

/**
 * Name of the farm organization.
 * @member {String} name
 */
FarmOrganization.prototype['name'] = undefined;

/**
 * Type of the farm organization.
 * @member {module:model/FarmOrganization.TypeEnum} type
 */
FarmOrganization.prototype['type'] = undefined;
