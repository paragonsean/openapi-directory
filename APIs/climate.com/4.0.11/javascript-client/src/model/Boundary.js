...
/**
 * The Boundary model module.
 * @module model/Boundary
 * @version 4.0.11
 */
class Boundary {
    /**
     * Constructs a new <code>Boundary</code>.
     * Arbitrary boundary.  GeoJSON Feature.
     * @alias module:model/Boundary
     * @param geometry {module:model/Geometry} 
     * @param id {String} 
     * @param properties {module:model/BoundaryProperties} 
     * @param type {module:model/Boundary.TypeEnum} 
     */
    constructor(geometry, id, properties, type) { 
        
        Boundary.initialize(this, geometry, id, properties, type);
    }
     ...
     */
    static initialize(obj, geometry, id, properties, type) { 
    ...
    /**
     * Constructs a <code>Boundary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Boundary} obj Optional instance to populate.
     * @return {module:model/Boundary} The populated <code>Boundary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Boundary();
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = BoundaryProperties.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Boundary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Boundary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Boundary.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          BoundaryProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
...
Boundary.RequiredProperties = ["geometry", "id", "properties", "type"];

/**
 * @member {module:model/Geometry} geometry
 */
Boundary.prototype['geometry'] = undefined;

/**
 * @member {String} id
 */
Boundary.prototype['id'] = undefined;

/**
 * @member {module:model/BoundaryProperties} properties
 */
Boundary.prototype['properties'] = undefined;

/**
 * @member {module:model/Boundary.TypeEnum} type
 */
Boundary.prototype['type'] = undefined;
