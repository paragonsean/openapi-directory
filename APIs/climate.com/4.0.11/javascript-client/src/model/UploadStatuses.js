...
/**
 * The UploadStatuses model module.
 * @module model/UploadStatuses
 * @version 4.0.11
 */
class UploadStatuses {
    /**
     * Constructs a new <code>UploadStatuses</code>.
     * @alias module:model/UploadStatuses
     * @param results {Array.<module:model/UploadStatus>} 
     */
    constructor(results) { 
        
        UploadStatuses.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>UploadStatuses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UploadStatuses} obj Optional instance to populate.
     * @return {module:model/UploadStatuses} The populated <code>UploadStatuses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UploadStatuses();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [UploadStatus]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UploadStatuses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UploadStatuses</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UploadStatuses.RequiredProperties) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                UploadStatus.validateJSON(item);
            };
        }
...
UploadStatuses.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/UploadStatus>} results
 */
UploadStatuses.prototype['results'] = undefined;
