...
class Operations {
    ...
    constructor(results) { 
        ...
        Operations.initialize(this, results);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Operations.RequiredProperties) {
...
Operations.RequiredProperties = ["results"];

/**
 * @member {Array.<module:model/Operation>} results
 */
Operations.prototype['results'] = undefined;
