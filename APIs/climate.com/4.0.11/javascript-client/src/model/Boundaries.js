...
/**
 * The Boundaries model module.
 * @module model/Boundaries
 * @version 4.0.11
 */
class Boundaries {
    /**
     * Constructs a new <code>Boundaries</code>.
     * A batch of boundary results
     * @alias module:model/Boundaries
     * @param features {Array.<module:model/Boundary>} 
     * @param type {module:model/Boundaries.TypeEnum} 
     */
    constructor(features, type) { 
        
        Boundaries.initialize(this, features, type);
    }
    ...
    /**
     * Constructs a <code>Boundaries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Boundaries} obj Optional instance to populate.
     * @return {module:model/Boundaries} The populated <code>Boundaries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Boundaries();

            if (data.hasOwnProperty('features')) {
                obj['features'] = ApiClient.convertToType(data['features'], [Boundary]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Boundaries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Boundaries</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Boundaries.RequiredProperties) {
...
Boundaries.RequiredProperties = ["features", "type"];

/**
 * @member {Array.<module:model/Boundary>} features
 */
Boundaries.prototype['features'] = undefined;

/**
 * @member {module:model/Boundaries.TypeEnum} type
 */
Boundaries.prototype['type'] = undefined;
