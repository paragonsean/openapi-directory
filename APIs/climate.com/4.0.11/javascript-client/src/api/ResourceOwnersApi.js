...
/**
* ResourceOwners service.
* @module api/ResourceOwnersApi
* @version 4.0.11
*/
export default class ResourceOwnersApi {

    /**
    * Constructs a new ResourceOwnersApi. 
    * @alias module:api/ResourceOwnersApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getResourceOwner operation.
     * @callback module:api/ResourceOwnersApi~getResourceOwnerCallback
     ...
     * @param {module:api/ResourceOwnersApi~getResourceOwnerCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResourceOwner}
     */
    getResourceOwner(resourceOwnerId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceOwnerId' is set
      if (resourceOwnerId === undefined || resourceOwnerId === null) {
        throw new Error("Missing the required parameter 'resourceOwnerId' when calling getResourceOwner");
      }
      ...
      return this.apiClient.callApi(
        '/v4/resourceOwners/{resourceOwnerId}', 'GET',
