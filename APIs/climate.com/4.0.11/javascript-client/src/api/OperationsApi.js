...
export default class OperationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchOperations operation.
     * @callback module:api/OperationsApi~fetchOperationsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Operations} data The data returned by the service call.
     ...
     * @param {module:api/OperationsApi~fetchOperationsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Operations}
     */
    fetchOperations(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = Operations;
      return this.apiClient.callApi(
        '/v4/operations/all', 'GET',
