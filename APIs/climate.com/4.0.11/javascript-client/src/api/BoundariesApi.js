...
/**
* Boundaries service.
* @module api/BoundariesApi
* @version 4.0.11
*/
export default class BoundariesApi {

    /**
    * Constructs a new BoundariesApi. 
    * @alias module:api/BoundariesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchBoundaries operation.
     * @callback module:api/BoundariesApi~fetchBoundariesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Boundaries} data The data returned by the service call.
     ...
     * @param {module:model/BoundariesQuery} [boundariesQuery] 
     * @param {module:api/BoundariesApi~fetchBoundariesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Boundaries}
     */
    fetchBoundaries(opts, callback) {
      opts = opts || {};
      let postBody = opts['boundariesQuery'];
      ...
      let returnType = Boundaries;
      return this.apiClient.callApi(
        '/v4/boundaries/query', 'POST',
    ...
    /**
     * Callback function to receive the result of the fetchBoundaryById operation.
     * @callback module:api/BoundariesApi~fetchBoundaryByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Boundary} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BoundariesApi~fetchBoundaryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Boundary}
     */
    fetchBoundaryById(boundaryId, callback) {
      let postBody = null;
      // verify the required parameter 'boundaryId' is set
      if (boundaryId === undefined || boundaryId === null) {
        throw new Error("Missing the required parameter 'boundaryId' when calling fetchBoundaryById");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = Boundary;
      return this.apiClient.callApi(
        '/v4/boundaries/{boundaryId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the uploadBoundary operation.
     * @callback module:api/BoundariesApi~uploadBoundaryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UploadedBoundaryId} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/BoundaryUpload} [boundaryUpload] 
     * @param {module:api/BoundariesApi~uploadBoundaryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UploadedBoundaryId}
     */
    uploadBoundary(opts, callback) {
      opts = opts || {};
      let postBody = opts['boundaryUpload'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = UploadedBoundaryId;
      return this.apiClient.callApi(
        '/v4/boundaries', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
