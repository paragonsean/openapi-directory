...
export default class FieldsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllFields operation.
     * @callback module:api/FieldsApi~fetchAllFieldsCallback
     ...
     * @param {module:api/FieldsApi~fetchAllFieldsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Fields}
     */
    fetchAllFields(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the fetchFieldById operation.
     * @callback module:api/FieldsApi~fetchFieldByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FieldsApi~fetchFieldByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Field}
     */
    fetchFieldById(fieldId, callback) {
      let postBody = null;
      // verify the required parameter 'fieldId' is set
      if (fieldId === undefined || fieldId === null) {
        throw new Error("Missing the required parameter 'fieldId' when calling fetchFieldById");
      }
    ...
    /**
     * Callback function to receive the result of the fetchFields operation.
     * @callback module:api/FieldsApi~fetchFieldsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Fields} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [xLimit] Max number of results to return per batch.  Must be between 1 and 100 inclusive.  Defaults to 100.
     * @param {String} [fieldName] Optional prefix filter for field name. Must be at least 3 characters.
     * @param {module:api/FieldsApi~fetchFieldsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Fields}
     */
    fetchFields(opts, callback) {
      opts = opts || {};
      let postBody = null;
