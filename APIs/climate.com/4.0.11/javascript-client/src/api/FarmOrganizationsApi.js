...
/**
* FarmOrganizations service.
* @module api/FarmOrganizationsApi
* @version 4.0.11
*/
export default class FarmOrganizationsApi {

    /**
    * Constructs a new FarmOrganizationsApi. 
    * @alias module:api/FarmOrganizationsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchFarmOrganizationByTypeAndId operation.
     * @callback module:api/FarmOrganizationsApi~fetchFarmOrganizationByTypeAndIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FarmOrganization} data The data returned by the service call.
     ...
     * @param {module:model/String} farmOrganizationType Type of the farm organization.
     * @param {String} farmOrganizationId Unique identifier of the farm organization.
     * @param {module:api/FarmOrganizationsApi~fetchFarmOrganizationByTypeAndIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FarmOrganization}
     */
    fetchFarmOrganizationByTypeAndId(farmOrganizationType, farmOrganizationId, callback) {
      let postBody = null;
      // verify the required parameter 'farmOrganizationType' is set
      if (farmOrganizationType === undefined || farmOrganizationType === null) {
        throw new Error("Missing the required parameter 'farmOrganizationType' when calling fetchFarmOrganizationByTypeAndId");
      }
      // verify the required parameter 'farmOrganizationId' is set
      if (farmOrganizationId === undefined || farmOrganizationId === null) {
        throw new Error("Missing the required parameter 'farmOrganizationId' when calling fetchFarmOrganizationByTypeAndId");
      }

      let pathParams = {
        'farmOrganizationType': farmOrganizationType,
      ...
      let returnType = FarmOrganization;
      return this.apiClient.callApi(
        '/v4/farmOrganizations/{farmOrganizationType}/{farmOrganizationId}', 'GET',
