...
def info_from_oauth2_authorization_code(token: str) -> dict:
    """
...
def validate_scope_oauth2_authorization_code(required_scopes: List[str], token_scopes: List[str]) -> bool:
