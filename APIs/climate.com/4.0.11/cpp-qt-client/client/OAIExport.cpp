...
QString OAIExport::getContentType() const {
    return m_content_type;
}
void OAIExport::setContentType(const QString &content_type) {
    m_content_type = content_type;
    m_content_type_isSet = true;
}

bool OAIExport::is_content_type_Set() const{
    return m_content_type_isSet;
}

bool OAIExport::is_content_type_Valid() const{
    return m_content_type_isValid;
}

OAIObject OAIExport::getDefinition() const {
    return m_definition;
}
void OAIExport::setDefinition(const OAIObject &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIExport::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIExport::is_definition_Valid() const{
