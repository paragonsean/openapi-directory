...
void OAIOperationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchOperations", defaultConf);
    _serverIndices.insert("fetchOperations", 0);
}
...
void OAIOperationsApi::fetchOperations(const ::OpenAPI::OptionalParam<QString> &resource_owner_id) {
    QString fullPath = QString(_serverConfigs["fetchOperations"][_serverIndices.value("fetchOperations")].URL()+"/v4/operations/all");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::fetchOperationsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::fetchOperationsCallback);
...
void OAIOperationsApi::fetchOperationsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOperations output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOperationsSignal(output);
        Q_EMIT fetchOperationsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOperationsSignalE(output, error_type, error_str);
        Q_EMIT fetchOperationsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOperationsSignalError(output, error_type, error_str);
        Q_EMIT fetchOperationsSignalErrorFull(worker, error_type, error_str);
    }
}
