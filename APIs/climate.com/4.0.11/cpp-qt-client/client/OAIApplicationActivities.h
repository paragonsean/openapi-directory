...
/*
 * OAIApplicationActivities.h
 *
 * A batch of application activities
 */

#ifndef OAIApplicationActivities_H
#define OAIApplicationActivities_H
...
namespace OpenAPI {
class OAIApplicationActivitySummary;

class OAIApplicationActivities : public OAIObject {
public:
    OAIApplicationActivities();
    OAIApplicationActivities(QString json);
    ~OAIApplicationActivities() override;
    ...
    QList<OAIApplicationActivitySummary> getResults() const;
    void setResults(const QList<OAIApplicationActivitySummary> &results);
...
private:
    ...
    QList<OAIApplicationActivitySummary> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationActivities)

#endif // OAIApplicationActivities_H
