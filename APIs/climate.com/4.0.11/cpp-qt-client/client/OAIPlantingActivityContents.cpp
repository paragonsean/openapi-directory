...
OAIPlantingActivityContents::OAIPlantingActivityContents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlantingActivityContents::OAIPlantingActivityContents() {
    this->initializeModel();
}

OAIPlantingActivityContents::~OAIPlantingActivityContents() {}

void OAIPlantingActivityContents::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIPlantingActivityContents::fromJson(QString jsonString) {
...
void OAIPlantingActivityContents::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIPlantingActivityContents::asJson() const {
...
QJsonObject OAIPlantingActivityContents::asJsonObject() const {
    QJsonObject obj;
    if (m_body.isSet()) {
...
OAIHttpFileElement OAIPlantingActivityContents::getBody() const {
    return m_body;
}
void OAIPlantingActivityContents::setBody(const OAIHttpFileElement &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIPlantingActivityContents::is_body_Set() const{
    return m_body_isSet;
}

bool OAIPlantingActivityContents::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIPlantingActivityContents::isSet() const {
...
bool OAIPlantingActivityContents::isValid() const {
