...
/*
 * OAIPlantingActivities.h
 *
 * A batch of planting activities
 */

#ifndef OAIPlantingActivities_H
#define OAIPlantingActivities_H
...
namespace OpenAPI {
class OAIPlantingActivitySummary;

class OAIPlantingActivities : public OAIObject {
public:
    OAIPlantingActivities();
    OAIPlantingActivities(QString json);
    ~OAIPlantingActivities() override;
    ...
    QList<OAIPlantingActivitySummary> getResults() const;
    void setResults(const QList<OAIPlantingActivitySummary> &results);
...
private:
    ...
    QList<OAIPlantingActivitySummary> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlantingActivities)

#endif // OAIPlantingActivities_H
