...
/*
 * OAIPlantingActivityContents.h
 *
 * 
 */

#ifndef OAIPlantingActivityContents_H
#define OAIPlantingActivityContents_H
...
class OAIPlantingActivityContents : public OAIObject {
public:
    OAIPlantingActivityContents();
    OAIPlantingActivityContents(QString json);
    ~OAIPlantingActivityContents() override;
    ...
    OAIHttpFileElement getBody() const;
    void setBody(const OAIHttpFileElement &body);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlantingActivityContents)

#endif // OAIPlantingActivityContents_H
