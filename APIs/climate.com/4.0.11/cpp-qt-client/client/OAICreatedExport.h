...
#ifndef OAICreatedExport_H
#define OAICreatedExport_H
...
class OAICreatedExport : public OAIObject {
public:
    OAICreatedExport();
    OAICreatedExport(QString json);
    ~OAICreatedExport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatedExport)

#endif // OAICreatedExport_H
