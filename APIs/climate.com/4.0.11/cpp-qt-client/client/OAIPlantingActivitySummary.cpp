...
#include "OAIPlantingActivitySummary.h"
...
OAIPlantingActivitySummary::OAIPlantingActivitySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlantingActivitySummary::OAIPlantingActivitySummary() {
    this->initializeModel();
}

OAIPlantingActivitySummary::~OAIPlantingActivitySummary() {}

void OAIPlantingActivitySummary::initializeModel() {
...
void OAIPlantingActivitySummary::fromJson(QString jsonString) {
...
void OAIPlantingActivitySummary::fromJsonObject(QJsonObject json) {
...
QString OAIPlantingActivitySummary::asJson() const {
...
QJsonObject OAIPlantingActivitySummary::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIPlantingActivitySummary::getCreatedAt() const {
    return m_created_at;
}
void OAIPlantingActivitySummary::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPlantingActivitySummary::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPlantingActivitySummary::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIPlantingActivitySummary::getEndTime() const {
    return m_end_time;
}
void OAIPlantingActivitySummary::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIPlantingActivitySummary::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIPlantingActivitySummary::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QList<QString> OAIPlantingActivitySummary::getFieldIds() const {
    return m_field_ids;
}
void OAIPlantingActivitySummary::setFieldIds(const QList<QString> &field_ids) {
    m_field_ids = field_ids;
    m_field_ids_isSet = true;
}

bool OAIPlantingActivitySummary::is_field_ids_Set() const{
    return m_field_ids_isSet;
}

bool OAIPlantingActivitySummary::is_field_ids_Valid() const{
    return m_field_ids_isValid;
}

QString OAIPlantingActivitySummary::getId() const {
    return m_id;
}
void OAIPlantingActivitySummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPlantingActivitySummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPlantingActivitySummary::is_id_Valid() const{
    return m_id_isValid;
}

qint64 OAIPlantingActivitySummary::getLength() const {
    return m_length;
}
void OAIPlantingActivitySummary::setLength(const qint64 &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIPlantingActivitySummary::is_length_Set() const{
    return m_length_isSet;
}

bool OAIPlantingActivitySummary::is_length_Valid() const{
    return m_length_isValid;
}

QDateTime OAIPlantingActivitySummary::getStartTime() const {
    return m_start_time;
}
void OAIPlantingActivitySummary::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIPlantingActivitySummary::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIPlantingActivitySummary::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIPlantingActivitySummary::getUpdatedAt() const {
    return m_updated_at;
}
void OAIPlantingActivitySummary::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIPlantingActivitySummary::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIPlantingActivitySummary::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIPlantingActivitySummary::isSet() const {
...
bool OAIPlantingActivitySummary::isValid() const {
