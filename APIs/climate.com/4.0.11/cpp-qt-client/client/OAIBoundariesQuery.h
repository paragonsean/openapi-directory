...
/*
 * OAIBoundariesQuery.h
 *
 * 
 */

#ifndef OAIBoundariesQuery_H
#define OAIBoundariesQuery_H
...
class OAIBoundariesQuery : public OAIObject {
public:
    OAIBoundariesQuery();
    OAIBoundariesQuery(QString json);
    ~OAIBoundariesQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoundariesQuery)

#endif // OAIBoundariesQuery_H
