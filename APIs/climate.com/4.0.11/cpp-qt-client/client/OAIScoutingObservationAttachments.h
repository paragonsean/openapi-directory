...
/*
 * OAIScoutingObservationAttachments.h
 *
 * A batch of scouting attachments
 */

#ifndef OAIScoutingObservationAttachments_H
#define OAIScoutingObservationAttachments_H
...
namespace OpenAPI {
class OAIScoutingObservationAttachment;

class OAIScoutingObservationAttachments : public OAIObject {
public:
    OAIScoutingObservationAttachments();
    OAIScoutingObservationAttachments(QString json);
    ~OAIScoutingObservationAttachments() override;
    ...
    QList<OAIScoutingObservationAttachment> getResults() const;
    void setResults(const QList<OAIScoutingObservationAttachment> &results);
...
private:
    ...
    QList<OAIScoutingObservationAttachment> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingObservationAttachments)

#endif // OAIScoutingObservationAttachments_H
