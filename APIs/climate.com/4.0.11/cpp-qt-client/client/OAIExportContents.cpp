...
OAIExportContents::OAIExportContents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportContents::OAIExportContents() {
    this->initializeModel();
}

OAIExportContents::~OAIExportContents() {}

void OAIExportContents::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIExportContents::fromJson(QString jsonString) {
...
void OAIExportContents::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIExportContents::asJson() const {
...
QJsonObject OAIExportContents::asJsonObject() const {
    QJsonObject obj;
    if (m_body.isSet()) {
...
OAIHttpFileElement OAIExportContents::getBody() const {
    return m_body;
}
void OAIExportContents::setBody(const OAIHttpFileElement &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIExportContents::is_body_Set() const{
    return m_body_isSet;
}

bool OAIExportContents::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIExportContents::isSet() const {
...
bool OAIExportContents::isValid() const {
