...
OAIFarmOrganization::OAIFarmOrganization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFarmOrganization::OAIFarmOrganization() {
    this->initializeModel();
}

OAIFarmOrganization::~OAIFarmOrganization() {}

void OAIFarmOrganization::initializeModel() {
...
void OAIFarmOrganization::fromJson(QString jsonString) {
...
void OAIFarmOrganization::fromJsonObject(QJsonObject json) {
...
QString OAIFarmOrganization::asJson() const {
...
QJsonObject OAIFarmOrganization::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIFarmOrganization::getId() const {
    return m_id;
}
void OAIFarmOrganization::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFarmOrganization::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFarmOrganization::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFarmOrganization::getName() const {
    return m_name;
}
void OAIFarmOrganization::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFarmOrganization::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFarmOrganization::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIFarmOrganization::getType() const {
    return m_type;
}
void OAIFarmOrganization::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFarmOrganization::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFarmOrganization::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFarmOrganization::isSet() const {
...
bool OAIFarmOrganization::isValid() const {
