...
#ifndef OAIUploadStatuses_H
#define OAIUploadStatuses_H
...
namespace OpenAPI {
class OAIUploadStatus;

class OAIUploadStatuses : public OAIObject {
public:
    OAIUploadStatuses();
    OAIUploadStatuses(QString json);
    ~OAIUploadStatuses() override;
    ...
    QList<OAIUploadStatus> getResults() const;
    void setResults(const QList<OAIUploadStatus> &results);
...
private:
    ...
    QList<OAIUploadStatus> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadStatuses)

#endif // OAIUploadStatuses_H
