...
QString OAIError_error::getCode() const {
    return m_code;
}
void OAIError_error::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIError_error::is_code_Set() const{
    return m_code_isSet;
}

bool OAIError_error::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIError_error::getId() const {
    return m_id;
}
void OAIError_error::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIError_error::is_id_Set() const{
    return m_id_isSet;
}

bool OAIError_error::is_id_Valid() const{
    return m_id_isValid;
}
