...
/*
 * OAIScoutingObservationSummary.h
 *
 * 
 */

#ifndef OAIScoutingObservationSummary_H
#define OAIScoutingObservationSummary_H
...
class OAIScoutingObservationSummary : public OAIObject {
public:
    OAIScoutingObservationSummary();
    OAIScoutingObservationSummary(QString json);
    ~OAIScoutingObservationSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingObservationSummary)

#endif // OAIScoutingObservationSummary_H
