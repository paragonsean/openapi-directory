...
OAIBoundariesQuery::OAIBoundariesQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoundariesQuery::OAIBoundariesQuery() {
    this->initializeModel();
}

OAIBoundariesQuery::~OAIBoundariesQuery() {}

void OAIBoundariesQuery::initializeModel() {

    m_ids_isSet = false;
    m_ids_isValid = false;
}

void OAIBoundariesQuery::fromJson(QString jsonString) {
...
QJsonObject OAIBoundariesQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.size() > 0) {
...
QList<QString> OAIBoundariesQuery::getIds() const {
    return m_ids;
}
void OAIBoundariesQuery::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIBoundariesQuery::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIBoundariesQuery::is_ids_Valid() const{
    return m_ids_isValid;
}

bool OAIBoundariesQuery::isSet() const {
...
bool OAIBoundariesQuery::isValid() const {
