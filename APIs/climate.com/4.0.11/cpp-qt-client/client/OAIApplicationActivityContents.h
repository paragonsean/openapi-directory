...
/*
 * OAIApplicationActivityContents.h
 *
 * 
 */

#ifndef OAIApplicationActivityContents_H
#define OAIApplicationActivityContents_H
...
class OAIApplicationActivityContents : public OAIObject {
public:
    OAIApplicationActivityContents();
    OAIApplicationActivityContents(QString json);
    ~OAIApplicationActivityContents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationActivityContents)

#endif // OAIApplicationActivityContents_H
