...
QList<OAIField> OAIFields::getResults() const {
    return m_results;
}
void OAIFields::setResults(const QList<OAIField> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIFields::is_results_Set() const{
    return m_results_isSet;
}

bool OAIFields::is_results_Valid() const{
