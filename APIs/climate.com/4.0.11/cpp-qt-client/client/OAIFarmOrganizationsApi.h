...
#ifndef OAI_OAIFarmOrganizationsApi_H
#define OAI_OAIFarmOrganizationsApi_H
...
class OAIFarmOrganizationsApi : public QObject {
    Q_OBJECT

public:
    OAIFarmOrganizationsApi(const int timeOut = 0);
    ~OAIFarmOrganizationsApi();
    ...
    /**
    * @param[in]  farm_organization_type QString [required]
    * @param[in]  farm_organization_id QString [required]
    */
    virtual void fetchFarmOrganizationByTypeAndId(const QString &farm_organization_type, const QString &farm_organization_id);
...
private:
    ...
    void fetchFarmOrganizationByTypeAndIdCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchFarmOrganizationByTypeAndIdSignal(OAIFarmOrganization summary);


    void fetchFarmOrganizationByTypeAndIdSignalFull(OAIHttpRequestWorker *worker, OAIFarmOrganization summary);

    Q_DECL_DEPRECATED_X("Use fetchFarmOrganizationByTypeAndIdSignalError() instead")
    void fetchFarmOrganizationByTypeAndIdSignalE(OAIFarmOrganization summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFarmOrganizationByTypeAndIdSignalError(OAIFarmOrganization summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchFarmOrganizationByTypeAndIdSignalErrorFull() instead")
    void fetchFarmOrganizationByTypeAndIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFarmOrganizationByTypeAndIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
