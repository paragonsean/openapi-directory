...
OAIUploadedBoundaryId::OAIUploadedBoundaryId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUploadedBoundaryId::OAIUploadedBoundaryId() {
    this->initializeModel();
}

OAIUploadedBoundaryId::~OAIUploadedBoundaryId() {}

void OAIUploadedBoundaryId::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIUploadedBoundaryId::fromJson(QString jsonString) {
...
void OAIUploadedBoundaryId::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIUploadedBoundaryId::asJson() const {
...
QJsonObject OAIUploadedBoundaryId::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIUploadedBoundaryId::getId() const {
    return m_id;
}
void OAIUploadedBoundaryId::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUploadedBoundaryId::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUploadedBoundaryId::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUploadedBoundaryId::isSet() const {
...
bool OAIUploadedBoundaryId::isValid() const {
