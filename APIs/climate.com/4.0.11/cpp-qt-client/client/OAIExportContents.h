...
#ifndef OAIExportContents_H
#define OAIExportContents_H
...
class OAIExportContents : public OAIObject {
public:
    OAIExportContents();
    OAIExportContents(QString json);
    ~OAIExportContents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportContents)

#endif // OAIExportContents_H
