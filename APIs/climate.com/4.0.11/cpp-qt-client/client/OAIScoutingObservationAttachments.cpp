...
OAIScoutingObservationAttachments::OAIScoutingObservationAttachments(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingObservationAttachments::OAIScoutingObservationAttachments() {
    this->initializeModel();
}

OAIScoutingObservationAttachments::~OAIScoutingObservationAttachments() {}

void OAIScoutingObservationAttachments::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIScoutingObservationAttachments::fromJson(QString jsonString) {
...
void OAIScoutingObservationAttachments::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIScoutingObservationAttachments::asJson() const {
...
QJsonObject OAIScoutingObservationAttachments::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIScoutingObservationAttachment> OAIScoutingObservationAttachments::getResults() const {
    return m_results;
}
void OAIScoutingObservationAttachments::setResults(const QList<OAIScoutingObservationAttachment> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIScoutingObservationAttachments::is_results_Set() const{
    return m_results_isSet;
}

bool OAIScoutingObservationAttachments::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIScoutingObservationAttachments::isSet() const {
...
bool OAIScoutingObservationAttachments::isValid() const {
