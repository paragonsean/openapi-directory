...
/*
 * OAIFarmOrganization.h
 *
 * Logical representation of a farm organization with a name and type.
 */

#ifndef OAIFarmOrganization_H
#define OAIFarmOrganization_H
...
class OAIFarmOrganization : public OAIObject {
public:
    OAIFarmOrganization();
    OAIFarmOrganization(QString json);
    ~OAIFarmOrganization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFarmOrganization)

#endif // OAIFarmOrganization_H
