...
#include "OAIUploadStatusQuery.h"
#include "OAIUploadStatuses.h"
#include <QString>
...
public:
    ...
    */
    virtual void chunkedUpload(const QString &content_range, const QString &upload_id, const QString &content_type);

    /**
    * @param[in]  upload_id QString [required]
    */
    virtual void fetchUploadStatusById(const QString &upload_id);

    /**
    * @param[in]  oai_upload_status_query OAIUploadStatusQuery [optional]
    */
    virtual void fetchUploadStatuses(const ::OpenAPI::OptionalParam<OAIUploadStatusQuery> &oai_upload_status_query = ::OpenAPI::OptionalParam<OAIUploadStatusQuery>());

    /**
    * @param[in]  x_recipient_email QString [optional]
    * @param[in]  oai_upload OAIUpload [optional]
    */
    virtual void postUpload(const ::OpenAPI::OptionalParam<QString> &x_recipient_email = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIUpload> &oai_upload = ::OpenAPI::OptionalParam<OAIUpload>());
...
private:
    ...
    void chunkedUploadCallback(OAIHttpRequestWorker *worker);
    void fetchUploadStatusByIdCallback(OAIHttpRequestWorker *worker);
    void fetchUploadStatusesCallback(OAIHttpRequestWorker *worker);
    void postUploadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void chunkedUploadSignal();
    void fetchUploadStatusByIdSignal(OAIUploadStatus summary);
    void fetchUploadStatusesSignal(OAIUploadStatuses summary);
    void postUploadSignal(QString summary);


    void chunkedUploadSignalFull(OAIHttpRequestWorker *worker);
    void fetchUploadStatusByIdSignalFull(OAIHttpRequestWorker *worker, OAIUploadStatus summary);
    void fetchUploadStatusesSignalFull(OAIHttpRequestWorker *worker, OAIUploadStatuses summary);
    void postUploadSignalFull(OAIHttpRequestWorker *worker, QString summary);

    Q_DECL_DEPRECATED_X("Use chunkedUploadSignalError() instead")
    void chunkedUploadSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void chunkedUploadSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchUploadStatusByIdSignalError() instead")
    void fetchUploadStatusByIdSignalE(OAIUploadStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUploadStatusByIdSignalError(OAIUploadStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchUploadStatusesSignalError() instead")
    void fetchUploadStatusesSignalE(OAIUploadStatuses summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUploadStatusesSignalError(OAIUploadStatuses summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postUploadSignalError() instead")
    void postUploadSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postUploadSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use chunkedUploadSignalErrorFull() instead")
    void chunkedUploadSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void chunkedUploadSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchUploadStatusByIdSignalErrorFull() instead")
    void fetchUploadStatusByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUploadStatusByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchUploadStatusesSignalErrorFull() instead")
    void fetchUploadStatusesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUploadStatusesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
