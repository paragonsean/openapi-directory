...
public:
    ...
    QString getXNextToken() const;
    void setXNextToken(const QString &x_next_token);
    bool is_x_next_token_Set() const;
    bool is_x_next_token_Valid() const;
...
private:
    ...
    QString m_x_next_token;
    bool m_x_next_token_isSet;
    bool m_x_next_token_isValid;
};
