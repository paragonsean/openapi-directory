...
#include "OAIResourceOwnersApi.h"
...
OAIResourceOwnersApi::OAIResourceOwnersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIResourceOwnersApi::~OAIResourceOwnersApi() {
}

void OAIResourceOwnersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getResourceOwner", defaultConf);
    _serverIndices.insert("getResourceOwner", 0);
}
...
*/
int OAIResourceOwnersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIResourceOwnersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIResourceOwnersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIResourceOwnersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIResourceOwnersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIResourceOwnersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIResourceOwnersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIResourceOwnersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIResourceOwnersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIResourceOwnersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIResourceOwnersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIResourceOwnersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIResourceOwnersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIResourceOwnersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIResourceOwnersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIResourceOwnersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIResourceOwnersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIResourceOwnersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIResourceOwnersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIResourceOwnersApi::getResourceOwner(const QString &resource_owner_id) {
    QString fullPath = QString(_serverConfigs["getResourceOwner"][_serverIndices.value("getResourceOwner")].URL()+"/v4/resourceOwners/{resourceOwnerId}");
    ...
    {
        QString resource_owner_idPathParam("{");
        resource_owner_idPathParam.append("resourceOwnerId").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "resourceOwnerId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"resourceOwnerId"+pathSuffix : pathPrefix;
        fullPath.replace(resource_owner_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(resource_owner_id)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourceOwnersApi::getResourceOwnerCallback);
    connect(this, &OAIResourceOwnersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    scope.append("resourceOwners:read");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourceOwnersApi::getResourceOwnerCallback);
    connect(this, &OAIResourceOwnersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIResourceOwnersApi::getResourceOwnerCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getResourceOwnerSignal(output);
        Q_EMIT getResourceOwnerSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getResourceOwnerSignalE(output, error_type, error_str);
        Q_EMIT getResourceOwnerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getResourceOwnerSignalError(output, error_type, error_str);
        Q_EMIT getResourceOwnerSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIResourceOwnersApi::tokenAvailable(){
