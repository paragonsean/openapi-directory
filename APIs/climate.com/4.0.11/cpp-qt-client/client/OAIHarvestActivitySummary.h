...
/*
 * OAIHarvestActivitySummary.h
 *
 * 
 */

#ifndef OAIHarvestActivitySummary_H
#define OAIHarvestActivitySummary_H
...
class OAIHarvestActivitySummary : public OAIObject {
public:
    OAIHarvestActivitySummary();
    OAIHarvestActivitySummary(QString json);
    ~OAIHarvestActivitySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHarvestActivitySummary)

#endif // OAIHarvestActivitySummary_H
