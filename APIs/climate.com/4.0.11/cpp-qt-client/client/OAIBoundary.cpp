...
OAIBoundary::OAIBoundary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoundary::OAIBoundary() {
    this->initializeModel();
}

OAIBoundary::~OAIBoundary() {}

void OAIBoundary::initializeModel() {
...
void OAIBoundary::fromJson(QString jsonString) {
...
void OAIBoundary::fromJsonObject(QJsonObject json) {
...
QString OAIBoundary::asJson() const {
...
QJsonObject OAIBoundary::asJsonObject() const {
    QJsonObject obj;
    if (m_geometry.isSet()) {
...
OAIGeometry OAIBoundary::getGeometry() const {
    return m_geometry;
}
void OAIBoundary::setGeometry(const OAIGeometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIBoundary::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIBoundary::is_geometry_Valid() const{
    return m_geometry_isValid;
}

QString OAIBoundary::getId() const {
    return m_id;
}
void OAIBoundary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBoundary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBoundary::is_id_Valid() const{
    return m_id_isValid;
}

OAIBoundaryProperties OAIBoundary::getProperties() const {
    return m_properties;
}
void OAIBoundary::setProperties(const OAIBoundaryProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIBoundary::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIBoundary::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIBoundary::getType() const {
    return m_type;
}
void OAIBoundary::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBoundary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBoundary::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBoundary::isSet() const {
...
bool OAIBoundary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_geometry_isValid && m_id_isValid && m_properties_isValid && m_type_isValid && true;
}
