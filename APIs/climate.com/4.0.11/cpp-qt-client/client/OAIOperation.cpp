...
QString OAIOperation::getResourceOwnerId() const {
    return m_resource_owner_id;
}
void OAIOperation::setResourceOwnerId(const QString &resource_owner_id) {
    m_resource_owner_id = resource_owner_id;
    m_resource_owner_id_isSet = true;
}

bool OAIOperation::is_resource_owner_id_Set() const{
    return m_resource_owner_id_isSet;
}

bool OAIOperation::is_resource_owner_id_Valid() const{
...
bool OAIOperation::isValid() const {
    ...
    return m_id_isValid && m_name_isValid && m_resource_owner_id_isValid && true;
}
