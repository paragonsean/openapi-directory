...
OAIApplicationActivityContents::OAIApplicationActivityContents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplicationActivityContents::OAIApplicationActivityContents() {
    this->initializeModel();
}

OAIApplicationActivityContents::~OAIApplicationActivityContents() {}

void OAIApplicationActivityContents::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIApplicationActivityContents::fromJson(QString jsonString) {
...
void OAIApplicationActivityContents::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIApplicationActivityContents::asJson() const {
...
QJsonObject OAIApplicationActivityContents::asJsonObject() const {
    QJsonObject obj;
    if (m_body.isSet()) {
...
OAIHttpFileElement OAIApplicationActivityContents::getBody() const {
    return m_body;
}
void OAIApplicationActivityContents::setBody(const OAIHttpFileElement &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIApplicationActivityContents::is_body_Set() const{
    return m_body_isSet;
}

bool OAIApplicationActivityContents::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIApplicationActivityContents::isSet() const {
...
bool OAIApplicationActivityContents::isValid() const {
