...
/*
 * OAIHarvestActivityContents.h
 *
 * 
 */

#ifndef OAIHarvestActivityContents_H
#define OAIHarvestActivityContents_H
...
class OAIHarvestActivityContents : public OAIObject {
public:
    OAIHarvestActivityContents();
    OAIHarvestActivityContents(QString json);
    ~OAIHarvestActivityContents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHarvestActivityContents)

#endif // OAIHarvestActivityContents_H
