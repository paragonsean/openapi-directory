...
#ifndef OAI_OAIBoundariesApi_H
#define OAI_OAIBoundariesApi_H
...
#include "OAIError.h"
#include "OAIUploadedBoundaryId.h"
#include <QString>
...
class OAIBoundariesApi : public QObject {
    Q_OBJECT

public:
    OAIBoundariesApi(const int timeOut = 0);
    ~OAIBoundariesApi();
    ...
    /**
    * @param[in]  oai_boundaries_query OAIBoundariesQuery [optional]
    */
    virtual void fetchBoundaries(const ::OpenAPI::OptionalParam<OAIBoundariesQuery> &oai_boundaries_query = ::OpenAPI::OptionalParam<OAIBoundariesQuery>());

    /**
    * @param[in]  boundary_id QString [required]
    */
    virtual void fetchBoundaryById(const QString &boundary_id);

    /**
    * @param[in]  oai_boundary_upload OAIBoundaryUpload [optional]
    */
    virtual void uploadBoundary(const ::OpenAPI::OptionalParam<OAIBoundaryUpload> &oai_boundary_upload = ::OpenAPI::OptionalParam<OAIBoundaryUpload>());
...
private:
    ...
    void fetchBoundariesCallback(OAIHttpRequestWorker *worker);
    void fetchBoundaryByIdCallback(OAIHttpRequestWorker *worker);
    void uploadBoundaryCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchBoundariesSignal(OAIBoundaries summary);
    void fetchBoundaryByIdSignal(OAIBoundary summary);
    void uploadBoundarySignal(OAIUploadedBoundaryId summary);


    void fetchBoundariesSignalFull(OAIHttpRequestWorker *worker, OAIBoundaries summary);
    void fetchBoundaryByIdSignalFull(OAIHttpRequestWorker *worker, OAIBoundary summary);
    void uploadBoundarySignalFull(OAIHttpRequestWorker *worker, OAIUploadedBoundaryId summary);

    Q_DECL_DEPRECATED_X("Use fetchBoundariesSignalError() instead")
    void fetchBoundariesSignalE(OAIBoundaries summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBoundariesSignalError(OAIBoundaries summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchBoundaryByIdSignalError() instead")
    void fetchBoundaryByIdSignalE(OAIBoundary summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBoundaryByIdSignalError(OAIBoundary summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use uploadBoundarySignalError() instead")
    void uploadBoundarySignalE(OAIUploadedBoundaryId summary, QNetworkReply::NetworkError error_type, QString error_str);
    void uploadBoundarySignalError(OAIUploadedBoundaryId summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchBoundariesSignalErrorFull() instead")
    void fetchBoundariesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBoundariesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchBoundaryByIdSignalErrorFull() instead")
    void fetchBoundaryByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBoundaryByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use uploadBoundarySignalErrorFull() instead")
    void uploadBoundarySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void uploadBoundarySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
