...
float OAIArea::getQ() const {
    return m_q;
}
void OAIArea::setQ(const float &q) {
    m_q = q;
    m_q_isSet = true;
}

bool OAIArea::is_q_Set() const{
    return m_q_isSet;
}

bool OAIArea::is_q_Valid() const{
    return m_q_isValid;
}

QString OAIArea::getU() const {
    return m_u;
}
void OAIArea::setU(const QString &u) {
    m_u = u;
    m_u_isSet = true;
}

bool OAIArea::is_u_Set() const{
    return m_u_isSet;
}

bool OAIArea::is_u_Valid() const{
    return m_u_isValid;
}
...
bool OAIArea::isValid() const {
    ...
    return m_q_isValid && m_u_isValid && true;
}
