...
void OAIExportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchExportContentsById", defaultConf);
    _serverIndices.insert("fetchExportContentsById", 0);
    _serverConfigs.insert("fetchExportStatusById", defaultConf);
    _serverIndices.insert("fetchExportStatusById", 0);
    _serverConfigs.insert("postExport", defaultConf);
    _serverIndices.insert("postExport", 0);
}
...
void OAIExportsApi::fetchExportContentsById(const QString &accept, const QString &export_id, const QString &range) {
    QString fullPath = QString(_serverConfigs["fetchExportContentsById"][_serverIndices.value("fetchExportContentsById")].URL()+"/v4/exports/{exportId}/contents");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::fetchExportContentsByIdCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::fetchExportContentsByIdCallback);
...
void OAIExportsApi::fetchExportContentsByIdCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchExportContentsByIdSignal();
        Q_EMIT fetchExportContentsByIdSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchExportContentsByIdSignalE(error_type, error_str);
        Q_EMIT fetchExportContentsByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchExportContentsByIdSignalError(error_type, error_str);
        Q_EMIT fetchExportContentsByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIExportsApi::fetchExportStatusById(const QString &export_id) {
    QString fullPath = QString(_serverConfigs["fetchExportStatusById"][_serverIndices.value("fetchExportStatusById")].URL()+"/v4/exports/{exportId}/status");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::fetchExportStatusByIdCallback);
    connect(this, &OAIExportsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::fetchExportStatusByIdCallback);
    connect(this, &OAIExportsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIExportsApi::fetchExportStatusByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIExportStatus output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchExportStatusByIdSignal(output);
        Q_EMIT fetchExportStatusByIdSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("exports:read");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchExportStatusByIdSignalE(output, error_type, error_str);
        Q_EMIT fetchExportStatusByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchExportStatusByIdSignalError(output, error_type, error_str);
        Q_EMIT fetchExportStatusByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIExportsApi::postExport(const ::OpenAPI::OptionalParam<OAIExport> &oai_export) {
    QString fullPath = QString(_serverConfigs["postExport"][_serverIndices.value("postExport")].URL()+"/v4/exports");
    ...
    if (oai_export.hasValue()){

        
        QByteArray output = oai_export.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::postExportCallback);
    connect(this, &OAIExportsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportsApi::postExportCallback);
    connect(this, &OAIExportsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIExportsApi::postExportCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICreatedExport output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postExportSignal(output);
        Q_EMIT postExportSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("exports:read");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postExportSignalE(output, error_type, error_str);
        Q_EMIT postExportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postExportSignalError(output, error_type, error_str);
        Q_EMIT postExportSignalErrorFull(worker, error_type, error_str);
    }
}
