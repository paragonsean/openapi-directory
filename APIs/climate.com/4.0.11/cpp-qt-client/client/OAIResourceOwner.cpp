...
QString OAIResourceOwner::getEmail() const {
    return m_email;
}
void OAIResourceOwner::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIResourceOwner::is_email_Set() const{
    return m_email_isSet;
}

bool OAIResourceOwner::is_email_Valid() const{
