...
OAICreatedExport::OAICreatedExport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatedExport::OAICreatedExport() {
    this->initializeModel();
}

OAICreatedExport::~OAICreatedExport() {}

void OAICreatedExport::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAICreatedExport::fromJson(QString jsonString) {
...
void OAICreatedExport::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAICreatedExport::asJson() const {
...
QJsonObject OAICreatedExport::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICreatedExport::getId() const {
    return m_id;
}
void OAICreatedExport::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreatedExport::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreatedExport::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICreatedExport::isSet() const {
...
bool OAICreatedExport::isValid() const {
