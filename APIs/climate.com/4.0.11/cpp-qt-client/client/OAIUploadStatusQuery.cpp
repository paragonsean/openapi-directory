...
OAIUploadStatusQuery::OAIUploadStatusQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUploadStatusQuery::OAIUploadStatusQuery() {
    this->initializeModel();
}

OAIUploadStatusQuery::~OAIUploadStatusQuery() {}

void OAIUploadStatusQuery::initializeModel() {

    m_ids_isSet = false;
    m_ids_isValid = false;
}

void OAIUploadStatusQuery::fromJson(QString jsonString) {
...
QJsonObject OAIUploadStatusQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.size() > 0) {
...
QList<QString> OAIUploadStatusQuery::getIds() const {
    return m_ids;
}
void OAIUploadStatusQuery::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIUploadStatusQuery::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIUploadStatusQuery::is_ids_Valid() const{
    return m_ids_isValid;
}

bool OAIUploadStatusQuery::isSet() const {
...
bool OAIUploadStatusQuery::isValid() const {
