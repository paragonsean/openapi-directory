...
OAIUploadStatuses::OAIUploadStatuses(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUploadStatuses::OAIUploadStatuses() {
    this->initializeModel();
}

OAIUploadStatuses::~OAIUploadStatuses() {}

void OAIUploadStatuses::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIUploadStatuses::fromJson(QString jsonString) {
...
void OAIUploadStatuses::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIUploadStatuses::asJson() const {
...
QJsonObject OAIUploadStatuses::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIUploadStatus> OAIUploadStatuses::getResults() const {
    return m_results;
}
void OAIUploadStatuses::setResults(const QList<OAIUploadStatus> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIUploadStatuses::is_results_Set() const{
    return m_results_isSet;
}

bool OAIUploadStatuses::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIUploadStatuses::isSet() const {
...
bool OAIUploadStatuses::isValid() const {
