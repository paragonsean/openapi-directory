...
public:
    ...
    void setBoundaryId(const QString &boundary_id);
    bool is_boundary_id_Set() const;
    bool is_boundary_id_Valid() const;
...
private:
    ...
    QString m_boundary_id;
    bool m_boundary_id_isSet;
    bool m_boundary_id_isValid;
