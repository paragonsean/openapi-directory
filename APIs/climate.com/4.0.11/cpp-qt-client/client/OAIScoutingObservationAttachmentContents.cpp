...
OAIScoutingObservationAttachmentContents::OAIScoutingObservationAttachmentContents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingObservationAttachmentContents::OAIScoutingObservationAttachmentContents() {
    this->initializeModel();
}

OAIScoutingObservationAttachmentContents::~OAIScoutingObservationAttachmentContents() {}

void OAIScoutingObservationAttachmentContents::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIScoutingObservationAttachmentContents::fromJson(QString jsonString) {
...
void OAIScoutingObservationAttachmentContents::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIScoutingObservationAttachmentContents::asJson() const {
...
QJsonObject OAIScoutingObservationAttachmentContents::asJsonObject() const {
    QJsonObject obj;
    if (m_body.isSet()) {
...
OAIHttpFileElement OAIScoutingObservationAttachmentContents::getBody() const {
    return m_body;
}
void OAIScoutingObservationAttachmentContents::setBody(const OAIHttpFileElement &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIScoutingObservationAttachmentContents::is_body_Set() const{
    return m_body_isSet;
}

bool OAIScoutingObservationAttachmentContents::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIScoutingObservationAttachmentContents::isSet() const {
...
bool OAIScoutingObservationAttachmentContents::isValid() const {
