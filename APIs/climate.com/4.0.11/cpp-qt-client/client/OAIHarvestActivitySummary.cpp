...
#include "OAIHarvestActivitySummary.h"
...
OAIHarvestActivitySummary::OAIHarvestActivitySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHarvestActivitySummary::OAIHarvestActivitySummary() {
    this->initializeModel();
}

OAIHarvestActivitySummary::~OAIHarvestActivitySummary() {}

void OAIHarvestActivitySummary::initializeModel() {
...
void OAIHarvestActivitySummary::fromJson(QString jsonString) {
...
void OAIHarvestActivitySummary::fromJsonObject(QJsonObject json) {
...
QString OAIHarvestActivitySummary::asJson() const {
...
QJsonObject OAIHarvestActivitySummary::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIHarvestActivitySummary::getCreatedAt() const {
    return m_created_at;
}
void OAIHarvestActivitySummary::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIHarvestActivitySummary::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIHarvestActivitySummary::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIHarvestActivitySummary::getEndTime() const {
    return m_end_time;
}
void OAIHarvestActivitySummary::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIHarvestActivitySummary::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIHarvestActivitySummary::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QList<QString> OAIHarvestActivitySummary::getFieldIds() const {
    return m_field_ids;
}
void OAIHarvestActivitySummary::setFieldIds(const QList<QString> &field_ids) {
    m_field_ids = field_ids;
    m_field_ids_isSet = true;
}

bool OAIHarvestActivitySummary::is_field_ids_Set() const{
    return m_field_ids_isSet;
}

bool OAIHarvestActivitySummary::is_field_ids_Valid() const{
    return m_field_ids_isValid;
}

QString OAIHarvestActivitySummary::getId() const {
    return m_id;
}
void OAIHarvestActivitySummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIHarvestActivitySummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIHarvestActivitySummary::is_id_Valid() const{
    return m_id_isValid;
}

qint64 OAIHarvestActivitySummary::getLength() const {
    return m_length;
}
void OAIHarvestActivitySummary::setLength(const qint64 &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIHarvestActivitySummary::is_length_Set() const{
    return m_length_isSet;
}

bool OAIHarvestActivitySummary::is_length_Valid() const{
    return m_length_isValid;
}

QDateTime OAIHarvestActivitySummary::getStartTime() const {
    return m_start_time;
}
void OAIHarvestActivitySummary::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIHarvestActivitySummary::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIHarvestActivitySummary::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIHarvestActivitySummary::getUpdatedAt() const {
    return m_updated_at;
}
void OAIHarvestActivitySummary::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIHarvestActivitySummary::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIHarvestActivitySummary::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIHarvestActivitySummary::isSet() const {
...
bool OAIHarvestActivitySummary::isValid() const {
