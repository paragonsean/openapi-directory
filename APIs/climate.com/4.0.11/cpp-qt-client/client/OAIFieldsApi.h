...
#ifndef OAI_OAIFieldsApi_H
#define OAI_OAIFieldsApi_H
...
class OAIFieldsApi : public QObject {
    Q_OBJECT

public:
    OAIFieldsApi(const int timeOut = 0);
    ~OAIFieldsApi();
    ...
    */
    virtual void fetchAllFields(const ::OpenAPI::OptionalParam<QString> &x_next_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &x_limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &field_name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  field_id QString [required]
    */
    virtual void fetchFieldById(const QString &field_id);
    ...
    * @param[in]  field_name QString [optional]
    */
    virtual void fetchFields(const ::OpenAPI::OptionalParam<QString> &x_next_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &x_limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &field_name = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllFieldsCallback(OAIHttpRequestWorker *worker);
    void fetchFieldByIdCallback(OAIHttpRequestWorker *worker);
    void fetchFieldsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllFieldsSignal(OAIFields summary);
    void fetchFieldByIdSignal(OAIField summary);
    void fetchFieldsSignal(OAIFields summary);


    void fetchAllFieldsSignalFull(OAIHttpRequestWorker *worker, OAIFields summary);
    void fetchFieldByIdSignalFull(OAIHttpRequestWorker *worker, OAIField summary);
    void fetchFieldsSignalFull(OAIHttpRequestWorker *worker, OAIFields summary);

    Q_DECL_DEPRECATED_X("Use fetchAllFieldsSignalError() instead")
    void fetchAllFieldsSignalE(OAIFields summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllFieldsSignalError(OAIFields summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchFieldByIdSignalError() instead")
    void fetchFieldByIdSignalE(OAIField summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFieldByIdSignalError(OAIField summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchFieldsSignalError() instead")
    void fetchFieldsSignalE(OAIFields summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFieldsSignalError(OAIFields summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllFieldsSignalErrorFull() instead")
    void fetchAllFieldsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllFieldsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchFieldByIdSignalErrorFull() instead")
    void fetchFieldByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFieldByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchFieldsSignalErrorFull() instead")
    void fetchFieldsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchFieldsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
