...
OAIApplicationActivities::OAIApplicationActivities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplicationActivities::OAIApplicationActivities() {
    this->initializeModel();
}

OAIApplicationActivities::~OAIApplicationActivities() {}

void OAIApplicationActivities::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIApplicationActivities::fromJson(QString jsonString) {
...
void OAIApplicationActivities::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIApplicationActivities::asJson() const {
...
QJsonObject OAIApplicationActivities::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIApplicationActivitySummary> OAIApplicationActivities::getResults() const {
    return m_results;
}
void OAIApplicationActivities::setResults(const QList<OAIApplicationActivitySummary> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIApplicationActivities::is_results_Set() const{
    return m_results_isSet;
}

bool OAIApplicationActivities::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIApplicationActivities::isSet() const {
...
bool OAIApplicationActivities::isValid() const {
