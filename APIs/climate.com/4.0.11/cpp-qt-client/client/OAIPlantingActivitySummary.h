...
/*
 * OAIPlantingActivitySummary.h
 *
 * 
 */

#ifndef OAIPlantingActivitySummary_H
#define OAIPlantingActivitySummary_H
...
class OAIPlantingActivitySummary : public OAIObject {
public:
    OAIPlantingActivitySummary();
    OAIPlantingActivitySummary(QString json);
    ~OAIPlantingActivitySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlantingActivitySummary)

#endif // OAIPlantingActivitySummary_H
