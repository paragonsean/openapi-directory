...
OAIFieldsApi::OAIFieldsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIFieldsApi::~OAIFieldsApi() {
}

void OAIFieldsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("fetchAllFields", defaultConf);
    _serverIndices.insert("fetchAllFields", 0);
    _serverConfigs.insert("fetchFieldById", defaultConf);
    _serverIndices.insert("fetchFieldById", 0);
    _serverConfigs.insert("fetchFields", defaultConf);
    _serverIndices.insert("fetchFields", 0);
}
...
*/
int OAIFieldsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIFieldsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIFieldsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIFieldsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIFieldsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIFieldsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIFieldsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIFieldsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIFieldsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIFieldsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIFieldsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIFieldsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIFieldsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIFieldsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIFieldsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIFieldsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIFieldsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIFieldsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIFieldsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIFieldsApi::fetchAllFields(const ::OpenAPI::OptionalParam<QString> &x_next_token, const ::OpenAPI::OptionalParam<qint32> &x_limit, const ::OpenAPI::OptionalParam<QString> &field_name) {
    QString fullPath = QString(_serverConfigs["fetchAllFields"][_serverIndices.value("fetchAllFields")].URL()+"/v4/fields/all");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchAllFieldsCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchAllFieldsCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIFieldsApi::fetchAllFieldsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIFields output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllFieldsSignal(output);
        Q_EMIT fetchAllFieldsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllFieldsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllFieldsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllFieldsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllFieldsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFieldsApi::fetchFieldById(const QString &field_id) {
    QString fullPath = QString(_serverConfigs["fetchFieldById"][_serverIndices.value("fetchFieldById")].URL()+"/v4/fields/{fieldId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchFieldByIdCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchFieldByIdCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFieldsApi::fetchFieldByIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIField output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchFieldByIdSignal(output);
        Q_EMIT fetchFieldByIdSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchFieldByIdSignalE(output, error_type, error_str);
        Q_EMIT fetchFieldByIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchFieldByIdSignalError(output, error_type, error_str);
        Q_EMIT fetchFieldByIdSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFieldsApi::fetchFields(const ::OpenAPI::OptionalParam<QString> &x_next_token, const ::OpenAPI::OptionalParam<qint32> &x_limit, const ::OpenAPI::OptionalParam<QString> &field_name) {
    QString fullPath = QString(_serverConfigs["fetchFields"][_serverIndices.value("fetchFields")].URL()+"/v4/fields");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchFieldsCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFieldsApi::fetchFieldsCallback);
    connect(this, &OAIFieldsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFieldsApi::fetchFieldsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchFieldsSignal(output);
        Q_EMIT fetchFieldsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchFieldsSignalE(output, error_type, error_str);
        Q_EMIT fetchFieldsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchFieldsSignalError(output, error_type, error_str);
        Q_EMIT fetchFieldsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFieldsApi::tokenAvailable(){
