...
public:
    ...
    */
    virtual void fetchExportContentsById(const QString &accept, const QString &export_id, const QString &range);

    /**
    * @param[in]  export_id QString [required]
    */
    virtual void fetchExportStatusById(const QString &export_id);

    /**
    * @param[in]  oai_export OAIExport [optional]
    */
    virtual void postExport(const ::OpenAPI::OptionalParam<OAIExport> &oai_export = ::OpenAPI::OptionalParam<OAIExport>());
...
private:
    ...
    void fetchExportContentsByIdCallback(OAIHttpRequestWorker *worker);
    void fetchExportStatusByIdCallback(OAIHttpRequestWorker *worker);
    void postExportCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchExportContentsByIdSignal();
    void fetchExportStatusByIdSignal(OAIExportStatus summary);
    void postExportSignal(OAICreatedExport summary);


    void fetchExportContentsByIdSignalFull(OAIHttpRequestWorker *worker);
    void fetchExportStatusByIdSignalFull(OAIHttpRequestWorker *worker, OAIExportStatus summary);
    void postExportSignalFull(OAIHttpRequestWorker *worker, OAICreatedExport summary);

    Q_DECL_DEPRECATED_X("Use fetchExportContentsByIdSignalError() instead")
    void fetchExportContentsByIdSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void fetchExportContentsByIdSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchExportStatusByIdSignalError() instead")
    void fetchExportStatusByIdSignalE(OAIExportStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchExportStatusByIdSignalError(OAIExportStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postExportSignalError() instead")
    void postExportSignalE(OAICreatedExport summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postExportSignalError(OAICreatedExport summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchExportContentsByIdSignalErrorFull() instead")
    void fetchExportContentsByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchExportContentsByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchExportStatusByIdSignalErrorFull() instead")
    void fetchExportStatusByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchExportStatusByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postExportSignalErrorFull() instead")
    void postExportSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postExportSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
