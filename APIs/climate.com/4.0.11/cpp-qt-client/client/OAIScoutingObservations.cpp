...
OAIScoutingObservations::OAIScoutingObservations(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingObservations::OAIScoutingObservations() {
    this->initializeModel();
}

OAIScoutingObservations::~OAIScoutingObservations() {}

void OAIScoutingObservations::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIScoutingObservations::fromJson(QString jsonString) {
...
void OAIScoutingObservations::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIScoutingObservations::asJson() const {
...
QJsonObject OAIScoutingObservations::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIScoutingObservationSummary> OAIScoutingObservations::getResults() const {
    return m_results;
}
void OAIScoutingObservations::setResults(const QList<OAIScoutingObservationSummary> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIScoutingObservations::is_results_Set() const{
    return m_results_isSet;
}

bool OAIScoutingObservations::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIScoutingObservations::isSet() const {
...
bool OAIScoutingObservations::isValid() const {
