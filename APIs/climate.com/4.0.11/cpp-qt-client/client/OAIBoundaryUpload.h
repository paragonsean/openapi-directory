...
#ifndef OAIBoundaryUpload_H
#define OAIBoundaryUpload_H
...
class OAIBoundaryUpload : public OAIObject {
public:
    OAIBoundaryUpload();
    OAIBoundaryUpload(QString json);
    ~OAIBoundaryUpload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoundaryUpload)

#endif // OAIBoundaryUpload_H
