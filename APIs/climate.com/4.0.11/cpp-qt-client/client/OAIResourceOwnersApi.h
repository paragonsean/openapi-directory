...
#ifndef OAI_OAIResourceOwnersApi_H
#define OAI_OAIResourceOwnersApi_H
...
class OAIResourceOwnersApi : public QObject {
    Q_OBJECT

public:
    OAIResourceOwnersApi(const int timeOut = 0);
    ~OAIResourceOwnersApi();
    ...
    /**
    * @param[in]  resource_owner_id QString [required]
    */
    virtual void getResourceOwner(const QString &resource_owner_id);
...
private:
    ...
    void getResourceOwnerCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getResourceOwnerSignal(OAIResourceOwner summary);


    void getResourceOwnerSignalFull(OAIHttpRequestWorker *worker, OAIResourceOwner summary);

    Q_DECL_DEPRECATED_X("Use getResourceOwnerSignalError() instead")
    void getResourceOwnerSignalE(OAIResourceOwner summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getResourceOwnerSignalError(OAIResourceOwner summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getResourceOwnerSignalErrorFull() instead")
    void getResourceOwnerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getResourceOwnerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
