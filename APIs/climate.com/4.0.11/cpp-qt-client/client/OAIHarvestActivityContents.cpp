...
OAIHarvestActivityContents::OAIHarvestActivityContents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHarvestActivityContents::OAIHarvestActivityContents() {
    this->initializeModel();
}

OAIHarvestActivityContents::~OAIHarvestActivityContents() {}

void OAIHarvestActivityContents::initializeModel() {

    m_body_isSet = false;
    m_body_isValid = false;
}

void OAIHarvestActivityContents::fromJson(QString jsonString) {
...
void OAIHarvestActivityContents::fromJsonObject(QJsonObject json) {

    m_body_isValid = ::OpenAPI::fromJsonValue(m_body, json[QString("body")]);
    m_body_isSet = !json[QString("body")].isNull() && m_body_isValid;
}

QString OAIHarvestActivityContents::asJson() const {
...
QJsonObject OAIHarvestActivityContents::asJsonObject() const {
    QJsonObject obj;
    if (m_body.isSet()) {
...
OAIHttpFileElement OAIHarvestActivityContents::getBody() const {
    return m_body;
}
void OAIHarvestActivityContents::setBody(const OAIHttpFileElement &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIHarvestActivityContents::is_body_Set() const{
    return m_body_isSet;
}

bool OAIHarvestActivityContents::is_body_Valid() const{
    return m_body_isValid;
}

bool OAIHarvestActivityContents::isSet() const {
...
bool OAIHarvestActivityContents::isValid() const {
