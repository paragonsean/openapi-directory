...
OAIBoundaries::OAIBoundaries(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoundaries::OAIBoundaries() {
    this->initializeModel();
}

OAIBoundaries::~OAIBoundaries() {}

void OAIBoundaries::initializeModel() {
...
void OAIBoundaries::fromJson(QString jsonString) {
...
void OAIBoundaries::fromJsonObject(QJsonObject json) {
...
QString OAIBoundaries::asJson() const {
...
QJsonObject OAIBoundaries::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIBoundary> OAIBoundaries::getFeatures() const {
    return m_features;
}
void OAIBoundaries::setFeatures(const QList<OAIBoundary> &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIBoundaries::is_features_Set() const{
    return m_features_isSet;
}

bool OAIBoundaries::is_features_Valid() const{
    return m_features_isValid;
}

QString OAIBoundaries::getType() const {
    return m_type;
}
void OAIBoundaries::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBoundaries::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBoundaries::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBoundaries::isSet() const {
...
bool OAIBoundaries::isValid() const {
