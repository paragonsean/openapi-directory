...
/*
 * OAIScoutingObservationAttachment.h
 *
 * 
 */

#ifndef OAIScoutingObservationAttachment_H
#define OAIScoutingObservationAttachment_H
...
class OAIScoutingObservationAttachment : public OAIObject {
public:
    OAIScoutingObservationAttachment();
    OAIScoutingObservationAttachment(QString json);
    ~OAIScoutingObservationAttachment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingObservationAttachment)

#endif // OAIScoutingObservationAttachment_H
