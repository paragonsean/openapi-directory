...
QList<OAIOperation> OAIOperations::getResults() const {
    return m_results;
}
void OAIOperations::setResults(const QList<OAIOperation> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIOperations::is_results_Set() const{
    return m_results_isSet;
}

bool OAIOperations::is_results_Valid() const{
