...
/*
 * OAIApplicationActivitySummary.h
 *
 * 
 */

#ifndef OAIApplicationActivitySummary_H
#define OAIApplicationActivitySummary_H
...
class OAIApplicationActivitySummary : public OAIObject {
public:
    OAIApplicationActivitySummary();
    OAIApplicationActivitySummary(QString json);
    ~OAIApplicationActivitySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationActivitySummary)

#endif // OAIApplicationActivitySummary_H
