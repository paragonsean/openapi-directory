...
/*
 * OAIUploadedBoundaryId.h
 *
 * Unique identifier of a successfully uploaded boundary
 */

#ifndef OAIUploadedBoundaryId_H
#define OAIUploadedBoundaryId_H
...
class OAIUploadedBoundaryId : public OAIObject {
public:
    OAIUploadedBoundaryId();
    OAIUploadedBoundaryId(QString json);
    ~OAIUploadedBoundaryId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadedBoundaryId)

#endif // OAIUploadedBoundaryId_H
