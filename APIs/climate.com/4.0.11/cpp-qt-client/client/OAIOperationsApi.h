...
public:
    ...
    */
    virtual void fetchOperations(const ::OpenAPI::OptionalParam<QString> &resource_owner_id = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchOperationsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchOperationsSignal(OAIOperations summary);


    void fetchOperationsSignalFull(OAIHttpRequestWorker *worker, OAIOperations summary);

    Q_DECL_DEPRECATED_X("Use fetchOperationsSignalError() instead")
    void fetchOperationsSignalE(OAIOperations summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOperationsSignalError(OAIOperations summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchOperationsSignalErrorFull() instead")
    void fetchOperationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOperationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
