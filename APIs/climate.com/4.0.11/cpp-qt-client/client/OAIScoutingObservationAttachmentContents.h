...
/*
 * OAIScoutingObservationAttachmentContents.h
 *
 * 
 */

#ifndef OAIScoutingObservationAttachmentContents_H
#define OAIScoutingObservationAttachmentContents_H
...
class OAIScoutingObservationAttachmentContents : public OAIObject {
public:
    OAIScoutingObservationAttachmentContents();
    OAIScoutingObservationAttachmentContents(QString json);
    ~OAIScoutingObservationAttachmentContents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingObservationAttachmentContents)

#endif // OAIScoutingObservationAttachmentContents_H
