...
/*
 * OAIScoutingObservations.h
 *
 * A batch of scouting observations
 */

#ifndef OAIScoutingObservations_H
#define OAIScoutingObservations_H
...
namespace OpenAPI {
class OAIScoutingObservationSummary;

class OAIScoutingObservations : public OAIObject {
public:
    OAIScoutingObservations();
    OAIScoutingObservations(QString json);
    ~OAIScoutingObservations() override;
    ...
    QList<OAIScoutingObservationSummary> getResults() const;
    void setResults(const QList<OAIScoutingObservationSummary> &results);
...
private:
    ...
    QList<OAIScoutingObservationSummary> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingObservations)

#endif // OAIScoutingObservations_H
