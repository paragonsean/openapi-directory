...
OAIBoundaryUpload::OAIBoundaryUpload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoundaryUpload::OAIBoundaryUpload() {
    this->initializeModel();
}

OAIBoundaryUpload::~OAIBoundaryUpload() {}

void OAIBoundaryUpload::initializeModel() {

    m_geometry_isSet = false;
    m_geometry_isValid = false;
}

void OAIBoundaryUpload::fromJson(QString jsonString) {
...
void OAIBoundaryUpload::fromJsonObject(QJsonObject json) {
...
QString OAIBoundaryUpload::asJson() const {
...
QJsonObject OAIBoundaryUpload::asJsonObject() const {
    QJsonObject obj;
    if (m_geometry.isSet()) {
...
OAIGeometry OAIBoundaryUpload::getGeometry() const {
    return m_geometry;
}
void OAIBoundaryUpload::setGeometry(const OAIGeometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIBoundaryUpload::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIBoundaryUpload::is_geometry_Valid() const{
    return m_geometry_isValid;
}

bool OAIBoundaryUpload::isSet() const {
...
bool OAIBoundaryUpload::isValid() const {
