...
#include "OAIScoutingObservationAttachment.h"
...
OAIScoutingObservationAttachment::OAIScoutingObservationAttachment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingObservationAttachment::OAIScoutingObservationAttachment() {
    this->initializeModel();
}

OAIScoutingObservationAttachment::~OAIScoutingObservationAttachment() {}

void OAIScoutingObservationAttachment::initializeModel() {
...
void OAIScoutingObservationAttachment::fromJson(QString jsonString) {
...
void OAIScoutingObservationAttachment::fromJsonObject(QJsonObject json) {
...
QString OAIScoutingObservationAttachment::asJson() const {
...
QJsonObject OAIScoutingObservationAttachment::asJsonObject() const {
    QJsonObject obj;
...
QString OAIScoutingObservationAttachment::getContentType() const {
    return m_content_type;
}
void OAIScoutingObservationAttachment::setContentType(const QString &content_type) {
    m_content_type = content_type;
    m_content_type_isSet = true;
}

bool OAIScoutingObservationAttachment::is_content_type_Set() const{
    return m_content_type_isSet;
}

bool OAIScoutingObservationAttachment::is_content_type_Valid() const{
    return m_content_type_isValid;
}

QString OAIScoutingObservationAttachment::getId() const {
    return m_id;
}
void OAIScoutingObservationAttachment::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIScoutingObservationAttachment::is_id_Set() const{
    return m_id_isSet;
}

bool OAIScoutingObservationAttachment::is_id_Valid() const{
    return m_id_isValid;
}

qint64 OAIScoutingObservationAttachment::getLength() const {
    return m_length;
}
void OAIScoutingObservationAttachment::setLength(const qint64 &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAIScoutingObservationAttachment::is_length_Set() const{
    return m_length_isSet;
}

bool OAIScoutingObservationAttachment::is_length_Valid() const{
    return m_length_isValid;
}

QString OAIScoutingObservationAttachment::getStatus() const {
    return m_status;
}
void OAIScoutingObservationAttachment::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIScoutingObservationAttachment::is_status_Set() const{
    return m_status_isSet;
}

bool OAIScoutingObservationAttachment::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIScoutingObservationAttachment::getUpdatedAt() const {
    return m_updated_at;
}
void OAIScoutingObservationAttachment::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIScoutingObservationAttachment::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIScoutingObservationAttachment::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIScoutingObservationAttachment::isSet() const {
...
bool OAIScoutingObservationAttachment::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_content_type_isValid && m_id_isValid && m_length_isValid && m_status_isValid && m_updated_at_isValid && true;
}
