...
#ifndef OAIBoundary_H
#define OAIBoundary_H
...
namespace OpenAPI {
class OAIGeometry;
class OAIBoundaryProperties;

class OAIBoundary : public OAIObject {
public:
    OAIBoundary();
    OAIBoundary(QString json);
    ~OAIBoundary() override;
    ...
    OAIBoundaryProperties getProperties() const;
    void setProperties(const OAIBoundaryProperties &properties);
...
private:
    ...
    OAIBoundaryProperties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoundary)
