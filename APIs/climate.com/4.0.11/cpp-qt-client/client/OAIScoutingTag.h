...
#ifndef OAIScoutingTag_H
#define OAIScoutingTag_H
...
class OAIScoutingTag : public OAIObject {
public:
    OAIScoutingTag();
    OAIScoutingTag(QString json);
    ~OAIScoutingTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoutingTag)

#endif // OAIScoutingTag_H
