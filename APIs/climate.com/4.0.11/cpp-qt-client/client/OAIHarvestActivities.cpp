...
OAIHarvestActivities::OAIHarvestActivities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHarvestActivities::OAIHarvestActivities() {
    this->initializeModel();
}

OAIHarvestActivities::~OAIHarvestActivities() {}

void OAIHarvestActivities::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIHarvestActivities::fromJson(QString jsonString) {
...
void OAIHarvestActivities::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIHarvestActivities::asJson() const {
...
QJsonObject OAIHarvestActivities::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIHarvestActivitySummary> OAIHarvestActivities::getResults() const {
    return m_results;
}
void OAIHarvestActivities::setResults(const QList<OAIHarvestActivitySummary> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIHarvestActivities::is_results_Set() const{
    return m_results_isSet;
}

bool OAIHarvestActivities::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIHarvestActivities::isSet() const {
...
bool OAIHarvestActivities::isValid() const {
