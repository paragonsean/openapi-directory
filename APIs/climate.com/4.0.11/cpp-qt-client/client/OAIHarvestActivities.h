...
/*
 * OAIHarvestActivities.h
 *
 * A batch of harvest activities
 */

#ifndef OAIHarvestActivities_H
#define OAIHarvestActivities_H
...
namespace OpenAPI {
class OAIHarvestActivitySummary;

class OAIHarvestActivities : public OAIObject {
public:
    OAIHarvestActivities();
    OAIHarvestActivities(QString json);
    ~OAIHarvestActivities() override;
    ...
    QList<OAIHarvestActivitySummary> getResults() const;
    void setResults(const QList<OAIHarvestActivitySummary> &results);
...
private:
    ...
    QList<OAIHarvestActivitySummary> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHarvestActivities)

#endif // OAIHarvestActivities_H
