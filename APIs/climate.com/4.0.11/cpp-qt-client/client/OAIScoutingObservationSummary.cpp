...
#include "OAIScoutingObservationSummary.h"
...
OAIScoutingObservationSummary::OAIScoutingObservationSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingObservationSummary::OAIScoutingObservationSummary() {
    this->initializeModel();
}

OAIScoutingObservationSummary::~OAIScoutingObservationSummary() {}

void OAIScoutingObservationSummary::initializeModel() {
...
void OAIScoutingObservationSummary::fromJson(QString jsonString) {
...
void OAIScoutingObservationSummary::fromJsonObject(QJsonObject json) {
...
QString OAIScoutingObservationSummary::asJson() const {
...
QJsonObject OAIScoutingObservationSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_end_time_isSet) {
...
QDateTime OAIScoutingObservationSummary::getEndTime() const {
    return m_end_time;
}
void OAIScoutingObservationSummary::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIScoutingObservationSummary::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIScoutingObservationSummary::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIScoutingObservationSummary::getId() const {
    return m_id;
}
void OAIScoutingObservationSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIScoutingObservationSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIScoutingObservationSummary::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIScoutingObservationSummary::getStartTime() const {
    return m_start_time;
}
void OAIScoutingObservationSummary::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIScoutingObservationSummary::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIScoutingObservationSummary::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIScoutingObservationSummary::getUpdatedAt() const {
    return m_updated_at;
}
void OAIScoutingObservationSummary::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIScoutingObservationSummary::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIScoutingObservationSummary::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIScoutingObservationSummary::isSet() const {
...
bool OAIScoutingObservationSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_end_time_isValid && m_id_isValid && m_start_time_isValid && m_updated_at_isValid && true;
}
