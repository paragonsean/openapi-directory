...
#include "OAIBoundaryProperties.h"
...
OAIBoundaryProperties::OAIBoundaryProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoundaryProperties::OAIBoundaryProperties() {
    this->initializeModel();
}

OAIBoundaryProperties::~OAIBoundaryProperties() {}

void OAIBoundaryProperties::initializeModel() {
...
void OAIBoundaryProperties::fromJson(QString jsonString) {
...
void OAIBoundaryProperties::fromJsonObject(QJsonObject json) {
...
QString OAIBoundaryProperties::asJson() const {
...
QJsonObject OAIBoundaryProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_area.isSet()) {
...
OAIArea OAIBoundaryProperties::getArea() const {
    return m_area;
}
void OAIBoundaryProperties::setArea(const OAIArea &area) {
    m_area = area;
    m_area_isSet = true;
}

bool OAIBoundaryProperties::is_area_Set() const{
    return m_area_isSet;
}

bool OAIBoundaryProperties::is_area_Valid() const{
    return m_area_isValid;
}

OAIPoint OAIBoundaryProperties::getCentroid() const {
    return m_centroid;
}
void OAIBoundaryProperties::setCentroid(const OAIPoint &centroid) {
    m_centroid = centroid;
    m_centroid_isSet = true;
}

bool OAIBoundaryProperties::is_centroid_Set() const{
    return m_centroid_isSet;
}

bool OAIBoundaryProperties::is_centroid_Valid() const{
    return m_centroid_isValid;
}

bool OAIBoundaryProperties::isSet() const {
...
bool OAIBoundaryProperties::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_area_isValid && m_centroid_isValid && true;
}
