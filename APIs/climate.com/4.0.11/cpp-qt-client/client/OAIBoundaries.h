...
#ifndef OAIBoundaries_H
#define OAIBoundaries_H

#include <QJsonObject>

#include "OAIBoundary.h"
#include <QList>
#include <QString>
...
class OAIBoundaries : public OAIObject {
public:
    OAIBoundaries();
    OAIBoundaries(QString json);
    ~OAIBoundaries() override;
    ...
    QList<OAIBoundary> getFeatures() const;
    void setFeatures(const QList<OAIBoundary> &features);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoundaries)

#endif // OAIBoundaries_H
