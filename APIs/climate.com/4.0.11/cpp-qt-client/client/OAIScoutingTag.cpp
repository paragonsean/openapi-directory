...
OAIScoutingTag::OAIScoutingTag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScoutingTag::OAIScoutingTag() {
    this->initializeModel();
}

OAIScoutingTag::~OAIScoutingTag() {}

void OAIScoutingTag::initializeModel() {

    m_code_isSet = false;
    m_code_isValid = false;
}

void OAIScoutingTag::fromJson(QString jsonString) {
...
void OAIScoutingTag::fromJsonObject(QJsonObject json) {

    m_code_isValid = ::OpenAPI::fromJsonValue(m_code, json[QString("code")]);
    m_code_isSet = !json[QString("code")].isNull() && m_code_isValid;
}

QString OAIScoutingTag::asJson() const {
...
QJsonObject OAIScoutingTag::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIScoutingTag::getCode() const {
    return m_code;
}
void OAIScoutingTag::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIScoutingTag::is_code_Set() const{
    return m_code_isSet;
}

bool OAIScoutingTag::is_code_Valid() const{
    return m_code_isValid;
}

bool OAIScoutingTag::isSet() const {
...
bool OAIScoutingTag::isValid() const {
