...
OAIPlantingActivities::OAIPlantingActivities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlantingActivities::OAIPlantingActivities() {
    this->initializeModel();
}

OAIPlantingActivities::~OAIPlantingActivities() {}

void OAIPlantingActivities::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIPlantingActivities::fromJson(QString jsonString) {
...
void OAIPlantingActivities::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("results")]);
    m_results_isSet = !json[QString("results")].isNull() && m_results_isValid;
}

QString OAIPlantingActivities::asJson() const {
...
QJsonObject OAIPlantingActivities::asJsonObject() const {
    QJsonObject obj;
    if (m_results.size() > 0) {
...
QList<OAIPlantingActivitySummary> OAIPlantingActivities::getResults() const {
    return m_results;
}
void OAIPlantingActivities::setResults(const QList<OAIPlantingActivitySummary> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIPlantingActivities::is_results_Set() const{
    return m_results_isSet;
}

bool OAIPlantingActivities::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIPlantingActivities::isSet() const {
...
bool OAIPlantingActivities::isValid() const {
