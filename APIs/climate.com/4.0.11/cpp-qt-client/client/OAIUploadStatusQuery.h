...
/*
 * OAIUploadStatusQuery.h
 *
 * 
 */

#ifndef OAIUploadStatusQuery_H
#define OAIUploadStatusQuery_H
...
class OAIUploadStatusQuery : public OAIObject {
public:
    OAIUploadStatusQuery();
    OAIUploadStatusQuery(QString json);
    ~OAIUploadStatusQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadStatusQuery)

#endif // OAIUploadStatusQuery_H
