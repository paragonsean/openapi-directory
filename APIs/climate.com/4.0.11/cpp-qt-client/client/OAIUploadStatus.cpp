...
void OAIUploadStatus::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIUploadStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIUploadStatus::getId() const {
    return m_id;
}
void OAIUploadStatus::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUploadStatus::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUploadStatus::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUploadStatus::getStatus() const {
    return m_status;
}
void OAIUploadStatus::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUploadStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUploadStatus::is_status_Valid() const{
