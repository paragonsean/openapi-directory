...
/*
 * OAIBoundaryProperties.h
 *
 * Properties map.
 */

#ifndef OAIBoundaryProperties_H
#define OAIBoundaryProperties_H
...
class OAIBoundaryProperties : public OAIObject {
public:
    OAIBoundaryProperties();
    OAIBoundaryProperties(QString json);
    ~OAIBoundaryProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoundaryProperties)

#endif // OAIBoundaryProperties_H
