...
#include <iostream>
#include "../client/OAICountriesApi.h"
...
void Example::exampleFunction1(){
     OAICountriesApi apiInstance;
     
      //OAuth Authentication supported right now
      apiInstance.listPaymentChannelRulesV1();
...
Apache License 2.0 for more information visit [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0.html)