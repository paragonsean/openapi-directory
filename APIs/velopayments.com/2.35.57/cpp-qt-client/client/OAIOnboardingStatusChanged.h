...
/*
 * OAIOnboardingStatusChanged.h
 *
 * Base type for all onboarding status changed events
 */

#ifndef OAIOnboardingStatusChanged_H
#define OAIOnboardingStatusChanged_H
...
class OAIOnboardingStatusChanged : public OAIObject {
public:
    OAIOnboardingStatusChanged();
    OAIOnboardingStatusChanged(QString json);
    ~OAIOnboardingStatusChanged() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOnboardingStatusChanged)

#endif // OAIOnboardingStatusChanged_H
