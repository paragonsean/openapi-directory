...
/*
 * OAIPaymentStatusChanged.h
 *
 * Base type for all payment status changed events
 */

#ifndef OAIPaymentStatusChanged_H
#define OAIPaymentStatusChanged_H
...
class OAIPaymentStatusChanged : public OAIObject {
public:
    OAIPaymentStatusChanged();
    OAIPaymentStatusChanged(QString json);
    ~OAIPaymentStatusChanged() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentStatusChanged)

#endif // OAIPaymentStatusChanged_H
