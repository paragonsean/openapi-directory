...
OAIPayorAddress::OAIPayorAddress(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayorAddress::OAIPayorAddress() {
    this->initializeModel();
}

OAIPayorAddress::~OAIPayorAddress() {}

void OAIPayorAddress::initializeModel() {
...
void OAIPayorAddress::fromJson(QString jsonString) {
...
void OAIPayorAddress::fromJsonObject(QJsonObject json) {
...
QString OAIPayorAddress::asJson() const {
...
QJsonObject OAIPayorAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_city_isSet) {
...
QString OAIPayorAddress::getCity() const {
    return m_city;
}
void OAIPayorAddress::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIPayorAddress::is_city_Set() const{
    return m_city_isSet;
}

bool OAIPayorAddress::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIPayorAddress::getCountry() const {
    return m_country;
}
void OAIPayorAddress::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIPayorAddress::is_country_Set() const{
    return m_country_isSet;
}

bool OAIPayorAddress::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIPayorAddress::getCountyOrProvince() const {
    return m_county_or_province;
}
void OAIPayorAddress::setCountyOrProvince(const QString &county_or_province) {
    m_county_or_province = county_or_province;
    m_county_or_province_isSet = true;
}

bool OAIPayorAddress::is_county_or_province_Set() const{
    return m_county_or_province_isSet;
}

bool OAIPayorAddress::is_county_or_province_Valid() const{
    return m_county_or_province_isValid;
}

QString OAIPayorAddress::getLine1() const {
    return m_line1;
}
void OAIPayorAddress::setLine1(const QString &line1) {
    m_line1 = line1;
    m_line1_isSet = true;
}

bool OAIPayorAddress::is_line1_Set() const{
    return m_line1_isSet;
}

bool OAIPayorAddress::is_line1_Valid() const{
    return m_line1_isValid;
}

QString OAIPayorAddress::getLine2() const {
    return m_line2;
}
void OAIPayorAddress::setLine2(const QString &line2) {
    m_line2 = line2;
    m_line2_isSet = true;
}

bool OAIPayorAddress::is_line2_Set() const{
    return m_line2_isSet;
}

bool OAIPayorAddress::is_line2_Valid() const{
    return m_line2_isValid;
}

QString OAIPayorAddress::getLine3() const {
    return m_line3;
}
void OAIPayorAddress::setLine3(const QString &line3) {
    m_line3 = line3;
    m_line3_isSet = true;
}

bool OAIPayorAddress::is_line3_Set() const{
    return m_line3_isSet;
}

bool OAIPayorAddress::is_line3_Valid() const{
    return m_line3_isValid;
}

QString OAIPayorAddress::getLine4() const {
    return m_line4;
}
void OAIPayorAddress::setLine4(const QString &line4) {
    m_line4 = line4;
    m_line4_isSet = true;
}

bool OAIPayorAddress::is_line4_Set() const{
    return m_line4_isSet;
}

bool OAIPayorAddress::is_line4_Valid() const{
    return m_line4_isValid;
}

QString OAIPayorAddress::getZipOrPostcode() const {
    return m_zip_or_postcode;
}
void OAIPayorAddress::setZipOrPostcode(const QString &zip_or_postcode) {
    m_zip_or_postcode = zip_or_postcode;
    m_zip_or_postcode_isSet = true;
}

bool OAIPayorAddress::is_zip_or_postcode_Set() const{
    return m_zip_or_postcode_isSet;
}

bool OAIPayorAddress::is_zip_or_postcode_Valid() const{
    return m_zip_or_postcode_isValid;
}

bool OAIPayorAddress::isSet() const {
...
bool OAIPayorAddress::isValid() const {
