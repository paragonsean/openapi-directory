...
#ifndef OAIFundingEvent_H
#define OAIFundingEvent_H
...
class OAIFundingEvent : public OAIObject {
public:
    OAIFundingEvent();
    OAIFundingEvent(QString json);
    ~OAIFundingEvent() override;
    ...
    QString getFundingEventType() const;
    void setFundingEventType(const QString &funding_event_type);
    bool is_funding_event_type_Set() const;
    bool is_funding_event_type_Valid() const;
...
private:
    ...
    QString m_funding_event_type;
    bool m_funding_event_type_isSet;
    bool m_funding_event_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFundingEvent)

#endif // OAIFundingEvent_H
