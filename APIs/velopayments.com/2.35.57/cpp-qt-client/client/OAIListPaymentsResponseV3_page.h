...
/*
 * OAIListPaymentsResponseV3_page.h
 *
 * 
 */

#ifndef OAIListPaymentsResponseV3_page_H
#define OAIListPaymentsResponseV3_page_H
...
class OAIListPaymentsResponseV3_page : public OAIObject {
public:
    OAIListPaymentsResponseV3_page();
    OAIListPaymentsResponseV3_page(QString json);
    ~OAIListPaymentsResponseV3_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPaymentsResponseV3_page)

#endif // OAIListPaymentsResponseV3_page_H
