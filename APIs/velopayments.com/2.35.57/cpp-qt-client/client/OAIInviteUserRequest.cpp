...
QString OAIInviteUserRequest::getEntityId() const {
    return m_entity_id;
}
void OAIInviteUserRequest::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIInviteUserRequest::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIInviteUserRequest::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

QString OAIInviteUserRequest::getFirstName() const {
    return m_first_name;
}
void OAIInviteUserRequest::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIInviteUserRequest::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIInviteUserRequest::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIInviteUserRequest::getLastName() const {
    return m_last_name;
}
void OAIInviteUserRequest::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIInviteUserRequest::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIInviteUserRequest::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIInviteUserRequest::getMfaType() const {
    return m_mfa_type;
}
void OAIInviteUserRequest::setMfaType(const QString &mfa_type) {
    m_mfa_type = mfa_type;
    m_mfa_type_isSet = true;
}

bool OAIInviteUserRequest::is_mfa_type_Set() const{
    return m_mfa_type_isSet;
}

bool OAIInviteUserRequest::is_mfa_type_Valid() const{
    return m_mfa_type_isValid;
}

QString OAIInviteUserRequest::getPrimaryContactNumber() const {
    return m_primary_contact_number;
}
void OAIInviteUserRequest::setPrimaryContactNumber(const QString &primary_contact_number) {
    m_primary_contact_number = primary_contact_number;
    m_primary_contact_number_isSet = true;
}

bool OAIInviteUserRequest::is_primary_contact_number_Set() const{
    return m_primary_contact_number_isSet;
}

bool OAIInviteUserRequest::is_primary_contact_number_Valid() const{
    return m_primary_contact_number_isValid;
}

QList<QString> OAIInviteUserRequest::getRoles() const {
    return m_roles;
}
void OAIInviteUserRequest::setRoles(const QList<QString> &roles) {
    m_roles = roles;
    m_roles_isSet = true;
}

bool OAIInviteUserRequest::is_roles_Set() const{
    return m_roles_isSet;
}

bool OAIInviteUserRequest::is_roles_Valid() const{
    return m_roles_isValid;
}

QString OAIInviteUserRequest::getSecondaryContactNumber() const {
    return m_secondary_contact_number;
}
void OAIInviteUserRequest::setSecondaryContactNumber(const QString &secondary_contact_number) {
    m_secondary_contact_number = secondary_contact_number;
    m_secondary_contact_number_isSet = true;
}

bool OAIInviteUserRequest::is_secondary_contact_number_Set() const{
    return m_secondary_contact_number_isSet;
}

bool OAIInviteUserRequest::is_secondary_contact_number_Valid() const{
    return m_secondary_contact_number_isValid;
}

QString OAIInviteUserRequest::getSmsNumber() const {
    return m_sms_number;
}
void OAIInviteUserRequest::setSmsNumber(const QString &sms_number) {
    m_sms_number = sms_number;
    m_sms_number_isSet = true;
}

bool OAIInviteUserRequest::is_sms_number_Set() const{
    return m_sms_number_isSet;
}

bool OAIInviteUserRequest::is_sms_number_Valid() const{
    return m_sms_number_isValid;
}

QString OAIInviteUserRequest::getUserType() const {
    return m_user_type;
}
void OAIInviteUserRequest::setUserType(const QString &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIInviteUserRequest::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIInviteUserRequest::is_user_type_Valid() const{
    return m_user_type_isValid;
}

QString OAIInviteUserRequest::getVerificationCode() const {
    return m_verification_code;
}
void OAIInviteUserRequest::setVerificationCode(const QString &verification_code) {
    m_verification_code = verification_code;
    m_verification_code_isSet = true;
}

bool OAIInviteUserRequest::is_verification_code_Set() const{
    return m_verification_code_isSet;
}

bool OAIInviteUserRequest::is_verification_code_Valid() const{
...
bool OAIInviteUserRequest::isValid() const {
    ...
    return m_email_isValid && m_mfa_type_isValid && m_primary_contact_number_isValid && m_roles_isValid && m_sms_number_isValid && true;
}
