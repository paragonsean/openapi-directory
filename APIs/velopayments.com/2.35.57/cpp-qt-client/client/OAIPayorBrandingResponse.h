...
/*
 * OAIPayorBrandingResponse.h
 *
 * 
 */

#ifndef OAIPayorBrandingResponse_H
#define OAIPayorBrandingResponse_H
...
class OAIPayorBrandingResponse : public OAIObject {
public:
    OAIPayorBrandingResponse();
    OAIPayorBrandingResponse(QString json);
    ~OAIPayorBrandingResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayorBrandingResponse)

#endif // OAIPayorBrandingResponse_H
