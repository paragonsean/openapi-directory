...
/*
 * OAIPayeeDetailsChanged.h
 *
 * Base type for all payee details changed events
 */

#ifndef OAIPayeeDetailsChanged_H
#define OAIPayeeDetailsChanged_H
...
class OAIPayeeDetailsChanged : public OAIObject {
public:
    OAIPayeeDetailsChanged();
    OAIPayeeDetailsChanged(QString json);
    ~OAIPayeeDetailsChanged() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayeeDetailsChanged)

#endif // OAIPayeeDetailsChanged_H
