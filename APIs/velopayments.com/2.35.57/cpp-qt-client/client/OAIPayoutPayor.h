...
#ifndef OAIPayoutPayor_H
#define OAIPayoutPayor_H
...
class OAIPayoutPayor : public OAIObject {
public:
    OAIPayoutPayor();
    OAIPayoutPayor(QString json);
    ~OAIPayoutPayor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutPayor)

#endif // OAIPayoutPayor_H
