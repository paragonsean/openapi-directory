...
QString OAIErrorResponse::getCorrelationId() const {
    return m_correlation_id;
}
void OAIErrorResponse::setCorrelationId(const QString &correlation_id) {
    m_correlation_id = correlation_id;
    m_correlation_id_isSet = true;
}

bool OAIErrorResponse::is_correlation_id_Set() const{
    return m_correlation_id_isSet;
}

bool OAIErrorResponse::is_correlation_id_Valid() const{
