...
/*
 * OAIPagedPayeeResponseV3_page.h
 *
 * 
 */

#ifndef OAIPagedPayeeResponseV3_page_H
#define OAIPagedPayeeResponseV3_page_H
...
class OAIPagedPayeeResponseV3_page : public OAIObject {
public:
    OAIPagedPayeeResponseV3_page();
    OAIPagedPayeeResponseV3_page(QString json);
    ~OAIPagedPayeeResponseV3_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedPayeeResponseV3_page)

#endif // OAIPagedPayeeResponseV3_page_H
