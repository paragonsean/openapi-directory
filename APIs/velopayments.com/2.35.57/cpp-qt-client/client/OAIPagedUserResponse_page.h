...
/*
 * OAIPagedUserResponse_page.h
 *
 * 
 */

#ifndef OAIPagedUserResponse_page_H
#define OAIPagedUserResponse_page_H
...
class OAIPagedUserResponse_page : public OAIObject {
public:
    OAIPagedUserResponse_page();
    OAIPagedUserResponse_page(QString json);
    ~OAIPagedUserResponse_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedUserResponse_page)

#endif // OAIPagedUserResponse_page_H
