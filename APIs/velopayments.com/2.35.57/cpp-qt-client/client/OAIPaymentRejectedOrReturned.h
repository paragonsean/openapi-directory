...
/*
 * OAIPaymentRejectedOrReturned.h
 *
 * Base type for all rejection or return payment events
 */

#ifndef OAIPaymentRejectedOrReturned_H
#define OAIPaymentRejectedOrReturned_H
...
class OAIPaymentRejectedOrReturned : public OAIObject {
public:
    OAIPaymentRejectedOrReturned();
    OAIPaymentRejectedOrReturned(QString json);
    ~OAIPaymentRejectedOrReturned() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentRejectedOrReturned)

#endif // OAIPaymentRejectedOrReturned_H
