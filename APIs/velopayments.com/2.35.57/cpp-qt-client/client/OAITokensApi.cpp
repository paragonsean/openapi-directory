...
void OAITokensApi::resendToken(const QString &user_id, const OAIResendTokenRequest &oai_resend_token_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITokensApi::resendTokenCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITokensApi::resendTokenCallback);
...
void OAITokensApi::resendTokenCallback(OAIHttpRequestWorker *worker) {
