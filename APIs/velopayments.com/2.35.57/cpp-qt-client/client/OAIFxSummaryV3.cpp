...
OAIFxSummaryV3::OAIFxSummaryV3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFxSummaryV3::OAIFxSummaryV3() {
    this->initializeModel();
}

OAIFxSummaryV3::~OAIFxSummaryV3() {}

void OAIFxSummaryV3::initializeModel() {
...
void OAIFxSummaryV3::fromJson(QString jsonString) {
...
void OAIFxSummaryV3::fromJsonObject(QJsonObject json) {
...
QString OAIFxSummaryV3::asJson() const {
...
QJsonObject OAIFxSummaryV3::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIFxSummaryV3::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIFxSummaryV3::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIFxSummaryV3::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIFxSummaryV3::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

QString OAIFxSummaryV3::getFundingStatus() const {
    return m_funding_status;
}
void OAIFxSummaryV3::setFundingStatus(const QString &funding_status) {
    m_funding_status = funding_status;
    m_funding_status_isSet = true;
}

bool OAIFxSummaryV3::is_funding_status_Set() const{
    return m_funding_status_isSet;
}

bool OAIFxSummaryV3::is_funding_status_Valid() const{
    return m_funding_status_isValid;
}

float OAIFxSummaryV3::getInvertedRate() const {
    return m_inverted_rate;
}
void OAIFxSummaryV3::setInvertedRate(const float &inverted_rate) {
    m_inverted_rate = inverted_rate;
    m_inverted_rate_isSet = true;
}

bool OAIFxSummaryV3::is_inverted_rate_Set() const{
    return m_inverted_rate_isSet;
}

bool OAIFxSummaryV3::is_inverted_rate_Valid() const{
    return m_inverted_rate_isValid;
}

QString OAIFxSummaryV3::getPaymentCurrency() const {
    return m_payment_currency;
}
void OAIFxSummaryV3::setPaymentCurrency(const QString &payment_currency) {
    m_payment_currency = payment_currency;
    m_payment_currency_isSet = true;
}

bool OAIFxSummaryV3::is_payment_currency_Set() const{
    return m_payment_currency_isSet;
}

bool OAIFxSummaryV3::is_payment_currency_Valid() const{
    return m_payment_currency_isValid;
}

QString OAIFxSummaryV3::getQuoteId() const {
    return m_quote_id;
}
void OAIFxSummaryV3::setQuoteId(const QString &quote_id) {
    m_quote_id = quote_id;
    m_quote_id_isSet = true;
}

bool OAIFxSummaryV3::is_quote_id_Set() const{
    return m_quote_id_isSet;
}

bool OAIFxSummaryV3::is_quote_id_Valid() const{
    return m_quote_id_isValid;
}

float OAIFxSummaryV3::getRate() const {
    return m_rate;
}
void OAIFxSummaryV3::setRate(const float &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIFxSummaryV3::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIFxSummaryV3::is_rate_Valid() const{
    return m_rate_isValid;
}

QString OAIFxSummaryV3::getSourceCurrency() const {
    return m_source_currency;
}
void OAIFxSummaryV3::setSourceCurrency(const QString &source_currency) {
    m_source_currency = source_currency;
    m_source_currency_isSet = true;
}

bool OAIFxSummaryV3::is_source_currency_Set() const{
    return m_source_currency_isSet;
}

bool OAIFxSummaryV3::is_source_currency_Valid() const{
    return m_source_currency_isValid;
}

QString OAIFxSummaryV3::getStatus() const {
    return m_status;
}
void OAIFxSummaryV3::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFxSummaryV3::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFxSummaryV3::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIFxSummaryV3::getTotalCost() const {
    return m_total_cost;
}
void OAIFxSummaryV3::setTotalCost(const qint32 &total_cost) {
    m_total_cost = total_cost;
    m_total_cost_isSet = true;
}

bool OAIFxSummaryV3::is_total_cost_Set() const{
    return m_total_cost_isSet;
}

bool OAIFxSummaryV3::is_total_cost_Valid() const{
    return m_total_cost_isValid;
}

qint32 OAIFxSummaryV3::getTotalPaymentAmount() const {
    return m_total_payment_amount;
}
void OAIFxSummaryV3::setTotalPaymentAmount(const qint32 &total_payment_amount) {
    m_total_payment_amount = total_payment_amount;
    m_total_payment_amount_isSet = true;
}

bool OAIFxSummaryV3::is_total_payment_amount_Set() const{
    return m_total_payment_amount_isSet;
}

bool OAIFxSummaryV3::is_total_payment_amount_Valid() const{
    return m_total_payment_amount_isValid;
}

bool OAIFxSummaryV3::isSet() const {
...
bool OAIFxSummaryV3::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_creation_date_time_isValid && m_funding_status_isValid && m_inverted_rate_isValid && m_quote_id_isValid && m_rate_isValid && m_status_isValid && m_total_cost_isValid && m_total_payment_amount_isValid && true;
}
