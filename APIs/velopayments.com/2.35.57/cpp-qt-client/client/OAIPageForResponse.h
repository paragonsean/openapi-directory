...
/*
 * OAIPageForResponse.h
 *
 * 
 */

#ifndef OAIPageForResponse_H
#define OAIPageForResponse_H
...
class OAIPageForResponse : public OAIObject {
public:
    OAIPageForResponse();
    OAIPageForResponse(QString json);
    ~OAIPageForResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageForResponse)

#endif // OAIPageForResponse_H
