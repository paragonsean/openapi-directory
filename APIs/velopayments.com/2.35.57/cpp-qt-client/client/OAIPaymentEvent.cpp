...
QDateTime OAIPaymentEvent::getCreatedAt() const {
    return m_created_at;
}
void OAIPaymentEvent::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPaymentEvent::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPaymentEvent::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIPaymentEvent::getEventId() const {
    return m_event_id;
}
void OAIPaymentEvent::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIPaymentEvent::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIPaymentEvent::is_event_id_Valid() const{
    return m_event_id_isValid;
}

QString OAIPaymentEvent::getSourceType() const {
    return m_source_type;
}
void OAIPaymentEvent::setSourceType(const QString &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAIPaymentEvent::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAIPaymentEvent::is_source_type_Valid() const{
...
QString OAIPaymentEvent::getPayorPaymentId() const {
    return m_payor_payment_id;
}
void OAIPaymentEvent::setPayorPaymentId(const QString &payor_payment_id) {
    m_payor_payment_id = payor_payment_id;
    m_payor_payment_id_isSet = true;
}

bool OAIPaymentEvent::is_payor_payment_id_Set() const{
    return m_payor_payment_id_isSet;
}

bool OAIPaymentEvent::is_payor_payment_id_Valid() const{
    return m_payor_payment_id_isValid;
}

OAIPayoutPayorIds OAIPaymentEvent::getPayoutPayorIds() const {
    return m_payout_payor_ids;
}
void OAIPaymentEvent::setPayoutPayorIds(const OAIPayoutPayorIds &payout_payor_ids) {
    m_payout_payor_ids = payout_payor_ids;
    m_payout_payor_ids_isSet = true;
}

bool OAIPaymentEvent::is_payout_payor_ids_Set() const{
    return m_payout_payor_ids_isSet;
}

bool OAIPaymentEvent::is_payout_payor_ids_Valid() const{
...
bool OAIPaymentEvent::isValid() const {
    ...
    return m_created_at_isValid && m_event_id_isValid && m_source_type_isValid && m_payment_id_isValid && true;
}
