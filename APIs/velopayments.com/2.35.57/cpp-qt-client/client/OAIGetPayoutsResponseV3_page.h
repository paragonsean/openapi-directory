...
/*
 * OAIGetPayoutsResponseV3_page.h
 *
 * 
 */

#ifndef OAIGetPayoutsResponseV3_page_H
#define OAIGetPayoutsResponseV3_page_H
...
class OAIGetPayoutsResponseV3_page : public OAIObject {
public:
    OAIGetPayoutsResponseV3_page();
    OAIGetPayoutsResponseV3_page(QString json);
    ~OAIGetPayoutsResponseV3_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPayoutsResponseV3_page)

#endif // OAIGetPayoutsResponseV3_page_H
