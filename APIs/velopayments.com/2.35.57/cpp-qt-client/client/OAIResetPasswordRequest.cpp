...
QString OAIResetPasswordRequest::getEmail() const {
    return m_email;
}
void OAIResetPasswordRequest::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIResetPasswordRequest::is_email_Set() const{
    return m_email_isSet;
}

bool OAIResetPasswordRequest::is_email_Valid() const{
