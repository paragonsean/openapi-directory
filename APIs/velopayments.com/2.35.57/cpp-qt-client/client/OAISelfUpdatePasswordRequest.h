...
/*
 * OAISelfUpdatePasswordRequest.h
 *
 * 
 */

#ifndef OAISelfUpdatePasswordRequest_H
#define OAISelfUpdatePasswordRequest_H
...
class OAISelfUpdatePasswordRequest : public OAIObject {
public:
    OAISelfUpdatePasswordRequest();
    OAISelfUpdatePasswordRequest(QString json);
    ~OAISelfUpdatePasswordRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelfUpdatePasswordRequest)

#endif // OAISelfUpdatePasswordRequest_H
