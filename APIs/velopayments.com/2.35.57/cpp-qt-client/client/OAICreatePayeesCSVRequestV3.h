...
/*
 * OAICreatePayeesCSVRequestV3.h
 *
 * 
 */

#ifndef OAICreatePayeesCSVRequestV3_H
#define OAICreatePayeesCSVRequestV3_H
...
class OAICreatePayeesCSVRequestV3 : public OAIObject {
public:
    OAICreatePayeesCSVRequestV3();
    OAICreatePayeesCSVRequestV3(QString json);
    ~OAICreatePayeesCSVRequestV3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePayeesCSVRequestV3)

#endif // OAICreatePayeesCSVRequestV3_H
