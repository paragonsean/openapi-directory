...
/*
 * OAISourceAccountV3.h
 *
 * 
 */

#ifndef OAISourceAccountV3_H
#define OAISourceAccountV3_H
...
class OAISourceAccountV3 : public OAIObject {
public:
    OAISourceAccountV3();
    OAISourceAccountV3(QString json);
    ~OAISourceAccountV3() override;
    ...
    qint32 getTotalPayoutCost() const;
    void setTotalPayoutCost(const qint32 &total_payout_cost);
    bool is_total_payout_cost_Set() const;
    bool is_total_payout_cost_Valid() const;
...
private:
    ...
    qint32 m_total_payout_cost;
    bool m_total_payout_cost_isSet;
    bool m_total_payout_cost_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISourceAccountV3)

#endif // OAISourceAccountV3_H
