...
/*
 * OAIPayoutPrincipal.h
 *
 * Details of principal participating in a payout.
 */

#ifndef OAIPayoutPrincipal_H
#define OAIPayoutPrincipal_H
...
class OAIPayoutPrincipal : public OAIObject {
public:
    OAIPayoutPrincipal();
    OAIPayoutPrincipal(QString json);
    ~OAIPayoutPrincipal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutPrincipal)

#endif // OAIPayoutPrincipal_H
