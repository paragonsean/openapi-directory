...
/*
 * OAIValidatePasswordResponse.h
 *
 * 
 */

#ifndef OAIValidatePasswordResponse_H
#define OAIValidatePasswordResponse_H
...
class OAIValidatePasswordResponse : public OAIObject {
public:
    OAIValidatePasswordResponse();
    OAIValidatePasswordResponse(QString json);
    ~OAIValidatePasswordResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidatePasswordResponse)

#endif // OAIValidatePasswordResponse_H
