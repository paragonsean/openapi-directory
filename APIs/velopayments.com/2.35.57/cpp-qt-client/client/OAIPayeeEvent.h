...
#ifndef OAIPayeeEvent_H
#define OAIPayeeEvent_H
...
class OAIPayeeEvent : public OAIObject {
public:
    OAIPayeeEvent();
    OAIPayeeEvent(QString json);
    ~OAIPayeeEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayeeEvent)

#endif // OAIPayeeEvent_H
