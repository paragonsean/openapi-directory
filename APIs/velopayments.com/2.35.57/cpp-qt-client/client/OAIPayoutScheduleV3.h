...
class OAIPayoutScheduleV3 : public OAIObject {
public:
    OAIPayoutScheduleV3();
    OAIPayoutScheduleV3(QString json);
    ~OAIPayoutScheduleV3() override;
    ...
    QString getScheduledByPrincipalId() const;
    void setScheduledByPrincipalId(const QString &scheduled_by_principal_id);
    bool is_scheduled_by_principal_id_Set() const;
    bool is_scheduled_by_principal_id_Valid() const;
...
private:
    ...
    QString m_scheduled_by_principal_id;
    bool m_scheduled_by_principal_id_isSet;
    bool m_scheduled_by_principal_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutScheduleV3)

#endif // OAIPayoutScheduleV3_H
