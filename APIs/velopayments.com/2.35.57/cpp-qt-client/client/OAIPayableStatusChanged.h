...
/*
 * OAIPayableStatusChanged.h
 *
 * Base type for all payable status changed events
 */

#ifndef OAIPayableStatusChanged_H
#define OAIPayableStatusChanged_H
...
class OAIPayableStatusChanged : public OAIObject {
public:
    OAIPayableStatusChanged();
    OAIPayableStatusChanged(QString json);
    ~OAIPayableStatusChanged() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayableStatusChanged)

#endif // OAIPayableStatusChanged_H
