...
/*
 * OAIGetPaymentsForPayoutResponseV3_summary.h
 *
 * 
 */

#ifndef OAIGetPaymentsForPayoutResponseV3_summary_H
#define OAIGetPaymentsForPayoutResponseV3_summary_H
...
class OAIGetPaymentsForPayoutResponseV3_summary : public OAIObject {
public:
    OAIGetPaymentsForPayoutResponseV3_summary();
    OAIGetPaymentsForPayoutResponseV3_summary(QString json);
    ~OAIGetPaymentsForPayoutResponseV3_summary() override;
    ...
    qint32 getFailedPayments() const;
    void setFailedPayments(const qint32 &failed_payments);
    bool is_failed_payments_Set() const;
    bool is_failed_payments_Valid() const;
...
private:
    ...
    qint32 m_failed_payments;
    bool m_failed_payments_isSet;
    bool m_failed_payments_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPaymentsForPayoutResponseV3_summary)

#endif // OAIGetPaymentsForPayoutResponseV3_summary_H
