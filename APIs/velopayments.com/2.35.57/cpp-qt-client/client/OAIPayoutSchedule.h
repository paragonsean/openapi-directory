...
#ifndef OAIPayoutSchedule_H
#define OAIPayoutSchedule_H
...
class OAIPayoutSchedule : public OAIObject {
public:
    OAIPayoutSchedule();
    OAIPayoutSchedule(QString json);
    ~OAIPayoutSchedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayoutSchedule)

#endif // OAIPayoutSchedule_H
