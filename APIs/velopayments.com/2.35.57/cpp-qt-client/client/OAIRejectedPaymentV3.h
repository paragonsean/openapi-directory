...
/*
 * OAIRejectedPaymentV3.h
 *
 * 
 */

#ifndef OAIRejectedPaymentV3_H
#define OAIRejectedPaymentV3_H
...
class OAIRejectedPaymentV3 : public OAIObject {
public:
    OAIRejectedPaymentV3();
    OAIRejectedPaymentV3(QString json);
    ~OAIRejectedPaymentV3() override;
    ...
    QString getCurrencyType() const;
    void setCurrencyType(const QString &currency_type);
    bool is_currency_type_Set() const;
    bool is_currency_type_Valid() const;
...
private:
    ...
    QString m_currency_type;
    bool m_currency_type_isSet;
    bool m_currency_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRejectedPaymentV3)

#endif // OAIRejectedPaymentV3_H
