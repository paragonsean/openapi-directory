...
/*
 * OAIRoleUpdateRequest.h
 *
 * 
 */

#ifndef OAIRoleUpdateRequest_H
#define OAIRoleUpdateRequest_H
...
class OAIRoleUpdateRequest : public OAIObject {
public:
    OAIRoleUpdateRequest();
    OAIRoleUpdateRequest(QString json);
    ~OAIRoleUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleUpdateRequest)

#endif // OAIRoleUpdateRequest_H
