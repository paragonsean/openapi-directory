...
#ifndef OAIFxSummary_H
#define OAIFxSummary_H
...
class OAIFxSummary : public OAIObject {
public:
    OAIFxSummary();
    OAIFxSummary(QString json);
    ~OAIFxSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFxSummary)

#endif // OAIFxSummary_H
