...
#include "OAIAcceptedPaymentV3.h"
...
OAIAcceptedPaymentV3::OAIAcceptedPaymentV3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptedPaymentV3::OAIAcceptedPaymentV3() {
    this->initializeModel();
}

OAIAcceptedPaymentV3::~OAIAcceptedPaymentV3() {}

void OAIAcceptedPaymentV3::initializeModel() {
...
void OAIAcceptedPaymentV3::fromJson(QString jsonString) {
...
void OAIAcceptedPaymentV3::fromJsonObject(QJsonObject json) {
...
QString OAIAcceptedPaymentV3::asJson() const {
...
QJsonObject OAIAcceptedPaymentV3::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
qint32 OAIAcceptedPaymentV3::getAmount() const {
    return m_amount;
}
void OAIAcceptedPaymentV3::setAmount(const qint32 &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIAcceptedPaymentV3::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIAcceptedPaymentV3::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIAcceptedPaymentV3::getCurrencyType() const {
    return m_currency_type;
}
void OAIAcceptedPaymentV3::setCurrencyType(const QString &currency_type) {
    m_currency_type = currency_type;
    m_currency_type_isSet = true;
}

bool OAIAcceptedPaymentV3::is_currency_type_Set() const{
    return m_currency_type_isSet;
}

bool OAIAcceptedPaymentV3::is_currency_type_Valid() const{
    return m_currency_type_isValid;
}

QString OAIAcceptedPaymentV3::getPaymentMemo() const {
    return m_payment_memo;
}
void OAIAcceptedPaymentV3::setPaymentMemo(const QString &payment_memo) {
    m_payment_memo = payment_memo;
    m_payment_memo_isSet = true;
}

bool OAIAcceptedPaymentV3::is_payment_memo_Set() const{
    return m_payment_memo_isSet;
}

bool OAIAcceptedPaymentV3::is_payment_memo_Valid() const{
    return m_payment_memo_isValid;
}

QString OAIAcceptedPaymentV3::getPaymentMetadata() const {
    return m_payment_metadata;
}
void OAIAcceptedPaymentV3::setPaymentMetadata(const QString &payment_metadata) {
    m_payment_metadata = payment_metadata;
    m_payment_metadata_isSet = true;
}

bool OAIAcceptedPaymentV3::is_payment_metadata_Set() const{
    return m_payment_metadata_isSet;
}

bool OAIAcceptedPaymentV3::is_payment_metadata_Valid() const{
    return m_payment_metadata_isValid;
}

QString OAIAcceptedPaymentV3::getPayorPaymentId() const {
    return m_payor_payment_id;
}
void OAIAcceptedPaymentV3::setPayorPaymentId(const QString &payor_payment_id) {
    m_payor_payment_id = payor_payment_id;
    m_payor_payment_id_isSet = true;
}

bool OAIAcceptedPaymentV3::is_payor_payment_id_Set() const{
    return m_payor_payment_id_isSet;
}

bool OAIAcceptedPaymentV3::is_payor_payment_id_Valid() const{
    return m_payor_payment_id_isValid;
}

QString OAIAcceptedPaymentV3::getRailsId() const {
    return m_rails_id;
}
void OAIAcceptedPaymentV3::setRailsId(const QString &rails_id) {
    m_rails_id = rails_id;
    m_rails_id_isSet = true;
}

bool OAIAcceptedPaymentV3::is_rails_id_Set() const{
    return m_rails_id_isSet;
}

bool OAIAcceptedPaymentV3::is_rails_id_Valid() const{
    return m_rails_id_isValid;
}

QString OAIAcceptedPaymentV3::getRemoteId() const {
    return m_remote_id;
}
void OAIAcceptedPaymentV3::setRemoteId(const QString &remote_id) {
    m_remote_id = remote_id;
    m_remote_id_isSet = true;
}

bool OAIAcceptedPaymentV3::is_remote_id_Set() const{
    return m_remote_id_isSet;
}

bool OAIAcceptedPaymentV3::is_remote_id_Valid() const{
    return m_remote_id_isValid;
}

QString OAIAcceptedPaymentV3::getRemoteSystemId() const {
    return m_remote_system_id;
}
void OAIAcceptedPaymentV3::setRemoteSystemId(const QString &remote_system_id) {
    m_remote_system_id = remote_system_id;
    m_remote_system_id_isSet = true;
}

bool OAIAcceptedPaymentV3::is_remote_system_id_Set() const{
    return m_remote_system_id_isSet;
}

bool OAIAcceptedPaymentV3::is_remote_system_id_Valid() const{
    return m_remote_system_id_isValid;
}

QString OAIAcceptedPaymentV3::getSourceAccountName() const {
    return m_source_account_name;
}
void OAIAcceptedPaymentV3::setSourceAccountName(const QString &source_account_name) {
    m_source_account_name = source_account_name;
    m_source_account_name_isSet = true;
}

bool OAIAcceptedPaymentV3::is_source_account_name_Set() const{
    return m_source_account_name_isSet;
}

bool OAIAcceptedPaymentV3::is_source_account_name_Valid() const{
    return m_source_account_name_isValid;
}

bool OAIAcceptedPaymentV3::isSet() const {
...
bool OAIAcceptedPaymentV3::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_amount_isValid && m_currency_type_isValid && m_payor_payment_id_isValid && m_rails_id_isValid && m_remote_id_isValid && m_source_account_name_isValid && true;
}
