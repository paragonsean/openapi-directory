...
/*
 * OAIListFundingAccountsResponseV2_page.h
 *
 * 
 */

#ifndef OAIListFundingAccountsResponseV2_page_H
#define OAIListFundingAccountsResponseV2_page_H
...
class OAIListFundingAccountsResponseV2_page : public OAIObject {
public:
    OAIListFundingAccountsResponseV2_page();
    OAIListFundingAccountsResponseV2_page(QString json);
    ~OAIListFundingAccountsResponseV2_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFundingAccountsResponseV2_page)

#endif // OAIListFundingAccountsResponseV2_page_H
