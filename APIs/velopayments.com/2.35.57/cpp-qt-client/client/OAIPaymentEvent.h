...
public:
    ...
    OAIPayoutPayorIds getPayoutPayorIds() const;
    void setPayoutPayorIds(const OAIPayoutPayorIds &payout_payor_ids);
    bool is_payout_payor_ids_Set() const;
    bool is_payout_payor_ids_Valid() const;
...
private:
    ...
    OAIPayoutPayorIds m_payout_payor_ids;
    bool m_payout_payor_ids_isSet;
    bool m_payout_payor_ids_isValid;
};
