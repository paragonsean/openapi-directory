...
OAIPayoutSchedule::OAIPayoutSchedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayoutSchedule::OAIPayoutSchedule() {
    this->initializeModel();
}

OAIPayoutSchedule::~OAIPayoutSchedule() {}

void OAIPayoutSchedule::initializeModel() {
...
void OAIPayoutSchedule::fromJson(QString jsonString) {
...
void OAIPayoutSchedule::fromJsonObject(QJsonObject json) {
...
QString OAIPayoutSchedule::asJson() const {
...
QJsonObject OAIPayoutSchedule::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPayoutSchedule::isNotificationsEnabled() const {
    return m_notifications_enabled;
}
void OAIPayoutSchedule::setNotificationsEnabled(const bool &notifications_enabled) {
    m_notifications_enabled = notifications_enabled;
    m_notifications_enabled_isSet = true;
}

bool OAIPayoutSchedule::is_notifications_enabled_Set() const{
    return m_notifications_enabled_isSet;
}

bool OAIPayoutSchedule::is_notifications_enabled_Valid() const{
    return m_notifications_enabled_isValid;
}

QString OAIPayoutSchedule::getScheduleStatus() const {
    return m_schedule_status;
}
void OAIPayoutSchedule::setScheduleStatus(const QString &schedule_status) {
    m_schedule_status = schedule_status;
    m_schedule_status_isSet = true;
}

bool OAIPayoutSchedule::is_schedule_status_Set() const{
    return m_schedule_status_isSet;
}

bool OAIPayoutSchedule::is_schedule_status_Valid() const{
    return m_schedule_status_isValid;
}

QDateTime OAIPayoutSchedule::getScheduledAt() const {
    return m_scheduled_at;
}
void OAIPayoutSchedule::setScheduledAt(const QDateTime &scheduled_at) {
    m_scheduled_at = scheduled_at;
    m_scheduled_at_isSet = true;
}

bool OAIPayoutSchedule::is_scheduled_at_Set() const{
    return m_scheduled_at_isSet;
}

bool OAIPayoutSchedule::is_scheduled_at_Valid() const{
    return m_scheduled_at_isValid;
}

QString OAIPayoutSchedule::getScheduledBy() const {
    return m_scheduled_by;
}
void OAIPayoutSchedule::setScheduledBy(const QString &scheduled_by) {
    m_scheduled_by = scheduled_by;
    m_scheduled_by_isSet = true;
}

bool OAIPayoutSchedule::is_scheduled_by_Set() const{
    return m_scheduled_by_isSet;
}

bool OAIPayoutSchedule::is_scheduled_by_Valid() const{
    return m_scheduled_by_isValid;
}

QString OAIPayoutSchedule::getScheduledByPrincipalId() const {
    return m_scheduled_by_principal_id;
}
void OAIPayoutSchedule::setScheduledByPrincipalId(const QString &scheduled_by_principal_id) {
    m_scheduled_by_principal_id = scheduled_by_principal_id;
    m_scheduled_by_principal_id_isSet = true;
}

bool OAIPayoutSchedule::is_scheduled_by_principal_id_Set() const{
    return m_scheduled_by_principal_id_isSet;
}

bool OAIPayoutSchedule::is_scheduled_by_principal_id_Valid() const{
    return m_scheduled_by_principal_id_isValid;
}

QDateTime OAIPayoutSchedule::getScheduledFor() const {
    return m_scheduled_for;
}
void OAIPayoutSchedule::setScheduledFor(const QDateTime &scheduled_for) {
    m_scheduled_for = scheduled_for;
    m_scheduled_for_isSet = true;
}

bool OAIPayoutSchedule::is_scheduled_for_Set() const{
    return m_scheduled_for_isSet;
}

bool OAIPayoutSchedule::is_scheduled_for_Valid() const{
    return m_scheduled_for_isValid;
}

bool OAIPayoutSchedule::isSet() const {
...
bool OAIPayoutSchedule::isValid() const {
