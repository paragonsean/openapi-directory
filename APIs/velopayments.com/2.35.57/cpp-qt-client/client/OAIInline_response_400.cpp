...
QString OAIInline_response_400::getCorrelationId() const {
    return m_correlation_id;
}
void OAIInline_response_400::setCorrelationId(const QString &correlation_id) {
    m_correlation_id = correlation_id;
    m_correlation_id_isSet = true;
}

bool OAIInline_response_400::is_correlation_id_Set() const{
    return m_correlation_id_isSet;
}

bool OAIInline_response_400::is_correlation_id_Valid() const{
    return m_correlation_id_isValid;
}

QList<OAIError> OAIInline_response_400::getErrors() const {
    return m_errors;
}
void OAIInline_response_400::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIInline_response_400::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIInline_response_400::is_errors_Valid() const{
    return m_errors_isValid;
}

qint32 OAIInline_response_400::getHttpStatusCode() const {
    return m_http_status_code;
}
void OAIInline_response_400::setHttpStatusCode(const qint32 &http_status_code) {
    m_http_status_code = http_status_code;
    m_http_status_code_isSet = true;
}

bool OAIInline_response_400::is_http_status_code_Set() const{
    return m_http_status_code_isSet;
}

bool OAIInline_response_400::is_http_status_code_Valid() const{
