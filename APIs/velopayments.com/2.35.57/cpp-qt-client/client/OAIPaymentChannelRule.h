...
class OAIPaymentChannelRule : public OAIObject {
public:
    OAIPaymentChannelRule();
    OAIPaymentChannelRule(QString json);
    ~OAIPaymentChannelRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentChannelRule)

#endif // OAIPaymentChannelRule_H
