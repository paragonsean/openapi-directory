...
#ifndef OAIPaymentV3_H
#define OAIPaymentV3_H
...
namespace OpenAPI {
class OAIPayoutPayeeV3;

class OAIPaymentV3 : public OAIObject {
public:
    OAIPaymentV3();
    OAIPaymentV3(QString json);
    ~OAIPaymentV3() override;
    ...
    OAIPayoutPayeeV3 getPayee() const;
    void setPayee(const OAIPayoutPayeeV3 &payee);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentV3)

#endif // OAIPaymentV3_H
