...
/*
 * OAIResendTokenRequest.h
 *
 * 
 */

#ifndef OAIResendTokenRequest_H
#define OAIResendTokenRequest_H
...
class OAIResendTokenRequest : public OAIObject {
public:
    OAIResendTokenRequest();
    OAIResendTokenRequest(QString json);
    ~OAIResendTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResendTokenRequest)

#endif // OAIResendTokenRequest_H
