...
#ifndef OAIPaymentDeltaV1_H
#define OAIPaymentDeltaV1_H
...
class OAIPaymentDeltaV1 : public OAIObject {
public:
    OAIPaymentDeltaV1();
    OAIPaymentDeltaV1(QString json);
    ~OAIPaymentDeltaV1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentDeltaV1)

#endif // OAIPaymentDeltaV1_H
