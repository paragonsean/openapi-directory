...
/*
 * OAIPayorLinksResponse_payors.h
 *
 * 
 */

#ifndef OAIPayorLinksResponse_payors_H
#define OAIPayorLinksResponse_payors_H
...
class OAIPayorLinksResponse_payors : public OAIObject {
public:
    OAIPayorLinksResponse_payors();
    OAIPayorLinksResponse_payors(QString json);
    ~OAIPayorLinksResponse_payors() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayorLinksResponse_payors)

#endif // OAIPayorLinksResponse_payors_H
