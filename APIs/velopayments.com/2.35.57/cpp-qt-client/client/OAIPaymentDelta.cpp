...
OAIPaymentDelta::OAIPaymentDelta(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentDelta::OAIPaymentDelta() {
    this->initializeModel();
}

OAIPaymentDelta::~OAIPaymentDelta() {}

void OAIPaymentDelta::initializeModel() {
...
void OAIPaymentDelta::fromJson(QString jsonString) {
...
void OAIPaymentDelta::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentDelta::asJson() const {
...
QJsonObject OAIPaymentDelta::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPaymentDelta::getPaymentAmount() const {
    return m_payment_amount;
}
void OAIPaymentDelta::setPaymentAmount(const qint32 &payment_amount) {
    m_payment_amount = payment_amount;
    m_payment_amount_isSet = true;
}

bool OAIPaymentDelta::is_payment_amount_Set() const{
    return m_payment_amount_isSet;
}

bool OAIPaymentDelta::is_payment_amount_Valid() const{
    return m_payment_amount_isValid;
}

QString OAIPaymentDelta::getPaymentCurrency() const {
    return m_payment_currency;
}
void OAIPaymentDelta::setPaymentCurrency(const QString &payment_currency) {
    m_payment_currency = payment_currency;
    m_payment_currency_isSet = true;
}

bool OAIPaymentDelta::is_payment_currency_Set() const{
    return m_payment_currency_isSet;
}

bool OAIPaymentDelta::is_payment_currency_Valid() const{
    return m_payment_currency_isValid;
}

QString OAIPaymentDelta::getPaymentId() const {
    return m_payment_id;
}
void OAIPaymentDelta::setPaymentId(const QString &payment_id) {
    m_payment_id = payment_id;
    m_payment_id_isSet = true;
}

bool OAIPaymentDelta::is_payment_id_Set() const{
    return m_payment_id_isSet;
}

bool OAIPaymentDelta::is_payment_id_Valid() const{
    return m_payment_id_isValid;
}

QString OAIPaymentDelta::getPayorPaymentId() const {
    return m_payor_payment_id;
}
void OAIPaymentDelta::setPayorPaymentId(const QString &payor_payment_id) {
    m_payor_payment_id = payor_payment_id;
    m_payor_payment_id_isSet = true;
}

bool OAIPaymentDelta::is_payor_payment_id_Set() const{
    return m_payor_payment_id_isSet;
}

bool OAIPaymentDelta::is_payor_payment_id_Valid() const{
    return m_payor_payment_id_isValid;
}

QString OAIPaymentDelta::getPayoutId() const {
    return m_payout_id;
}
void OAIPaymentDelta::setPayoutId(const QString &payout_id) {
    m_payout_id = payout_id;
    m_payout_id_isSet = true;
}

bool OAIPaymentDelta::is_payout_id_Set() const{
    return m_payout_id_isSet;
}

bool OAIPaymentDelta::is_payout_id_Valid() const{
    return m_payout_id_isValid;
}

qint32 OAIPaymentDelta::getSourceAmount() const {
    return m_source_amount;
}
void OAIPaymentDelta::setSourceAmount(const qint32 &source_amount) {
    m_source_amount = source_amount;
    m_source_amount_isSet = true;
}

bool OAIPaymentDelta::is_source_amount_Set() const{
    return m_source_amount_isSet;
}

bool OAIPaymentDelta::is_source_amount_Valid() const{
    return m_source_amount_isValid;
}

QString OAIPaymentDelta::getSourceCurrency() const {
    return m_source_currency;
}
void OAIPaymentDelta::setSourceCurrency(const QString &source_currency) {
    m_source_currency = source_currency;
    m_source_currency_isSet = true;
}

bool OAIPaymentDelta::is_source_currency_Set() const{
    return m_source_currency_isSet;
}

bool OAIPaymentDelta::is_source_currency_Valid() const{
    return m_source_currency_isValid;
}

QString OAIPaymentDelta::getStatus() const {
    return m_status;
}
void OAIPaymentDelta::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentDelta::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentDelta::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPaymentDelta::isSet() const {
...
bool OAIPaymentDelta::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_payment_id_isValid && m_payout_id_isValid && true;
}
