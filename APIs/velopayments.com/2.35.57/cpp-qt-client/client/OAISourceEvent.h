...
#ifndef OAISourceEvent_H
#define OAISourceEvent_H
...
class OAISourceEvent : public OAIObject {
public:
    OAISourceEvent();
    OAISourceEvent(QString json);
    ~OAISourceEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceEvent)

#endif // OAISourceEvent_H
