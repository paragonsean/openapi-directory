...
#ifndef OAIRegionV2_H
#define OAIRegionV2_H
...
class OAIRegionV2 : public OAIObject {
public:
    OAIRegionV2();
    OAIRegionV2(QString json);
    ~OAIRegionV2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionV2)
