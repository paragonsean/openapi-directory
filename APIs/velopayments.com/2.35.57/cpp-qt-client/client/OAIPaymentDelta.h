...
#ifndef OAIPaymentDelta_H
#define OAIPaymentDelta_H
...
class OAIPaymentDelta : public OAIObject {
public:
    OAIPaymentDelta();
    OAIPaymentDelta(QString json);
    ~OAIPaymentDelta() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentDelta)

#endif // OAIPaymentDelta_H
