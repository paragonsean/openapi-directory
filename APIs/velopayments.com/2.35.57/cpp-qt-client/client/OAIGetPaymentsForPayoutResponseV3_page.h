...
/*
 * OAIGetPaymentsForPayoutResponseV3_page.h
 *
 * 
 */

#ifndef OAIGetPaymentsForPayoutResponseV3_page_H
#define OAIGetPaymentsForPayoutResponseV3_page_H
...
class OAIGetPaymentsForPayoutResponseV3_page : public OAIObject {
public:
    OAIGetPaymentsForPayoutResponseV3_page();
    OAIGetPaymentsForPayoutResponseV3_page(QString json);
    ~OAIGetPaymentsForPayoutResponseV3_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPaymentsForPayoutResponseV3_page)

#endif // OAIGetPaymentsForPayoutResponseV3_page_H
