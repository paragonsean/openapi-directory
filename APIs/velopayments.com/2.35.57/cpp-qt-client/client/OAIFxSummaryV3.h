...
#ifndef OAIFxSummaryV3_H
#define OAIFxSummaryV3_H
...
class OAIFxSummaryV3 : public OAIObject {
public:
    OAIFxSummaryV3();
    OAIFxSummaryV3(QString json);
    ~OAIFxSummaryV3() override;
    ...
    qint32 getTotalPaymentAmount() const;
    void setTotalPaymentAmount(const qint32 &total_payment_amount);
    bool is_total_payment_amount_Set() const;
    bool is_total_payment_amount_Valid() const;
...
private:
    ...
    qint32 m_total_payment_amount;
    bool m_total_payment_amount_isSet;
    bool m_total_payment_amount_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFxSummaryV3)

#endif // OAIFxSummaryV3_H
