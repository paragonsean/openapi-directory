...
OAIPayorLinksResponse_payors::OAIPayorLinksResponse_payors(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayorLinksResponse_payors::OAIPayorLinksResponse_payors() {
    this->initializeModel();
}

OAIPayorLinksResponse_payors::~OAIPayorLinksResponse_payors() {}

void OAIPayorLinksResponse_payors::initializeModel() {
...
void OAIPayorLinksResponse_payors::fromJson(QString jsonString) {
...
void OAIPayorLinksResponse_payors::fromJsonObject(QJsonObject json) {
...
QString OAIPayorLinksResponse_payors::asJson() const {
...
QJsonObject OAIPayorLinksResponse_payors::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPayorLinksResponse_payors::getKycState() const {
    return m_kyc_state;
}
void OAIPayorLinksResponse_payors::setKycState(const QString &kyc_state) {
    m_kyc_state = kyc_state;
    m_kyc_state_isSet = true;
}

bool OAIPayorLinksResponse_payors::is_kyc_state_Set() const{
    return m_kyc_state_isSet;
}

bool OAIPayorLinksResponse_payors::is_kyc_state_Valid() const{
    return m_kyc_state_isValid;
}

QString OAIPayorLinksResponse_payors::getPayorId() const {
    return m_payor_id;
}
void OAIPayorLinksResponse_payors::setPayorId(const QString &payor_id) {
    m_payor_id = payor_id;
    m_payor_id_isSet = true;
}

bool OAIPayorLinksResponse_payors::is_payor_id_Set() const{
    return m_payor_id_isSet;
}

bool OAIPayorLinksResponse_payors::is_payor_id_Valid() const{
    return m_payor_id_isValid;
}

QString OAIPayorLinksResponse_payors::getPayorName() const {
    return m_payor_name;
}
void OAIPayorLinksResponse_payors::setPayorName(const QString &payor_name) {
    m_payor_name = payor_name;
    m_payor_name_isSet = true;
}

bool OAIPayorLinksResponse_payors::is_payor_name_Set() const{
    return m_payor_name_isSet;
}

bool OAIPayorLinksResponse_payors::is_payor_name_Valid() const{
    return m_payor_name_isValid;
}

QString OAIPayorLinksResponse_payors::getPrimaryContactEmail() const {
    return m_primary_contact_email;
}
void OAIPayorLinksResponse_payors::setPrimaryContactEmail(const QString &primary_contact_email) {
    m_primary_contact_email = primary_contact_email;
    m_primary_contact_email_isSet = true;
}

bool OAIPayorLinksResponse_payors::is_primary_contact_email_Set() const{
    return m_primary_contact_email_isSet;
}

bool OAIPayorLinksResponse_payors::is_primary_contact_email_Valid() const{
    return m_primary_contact_email_isValid;
}

bool OAIPayorLinksResponse_payors::isSet() const {
...
bool OAIPayorLinksResponse_payors::isValid() const {
