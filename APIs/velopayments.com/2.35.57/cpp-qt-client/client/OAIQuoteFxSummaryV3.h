...
/*
 * OAIQuoteFxSummaryV3.h
 *
 * 
 */

#ifndef OAIQuoteFxSummaryV3_H
#define OAIQuoteFxSummaryV3_H
...
class OAIQuoteFxSummaryV3 : public OAIObject {
public:
    OAIQuoteFxSummaryV3();
    OAIQuoteFxSummaryV3(QString json);
    ~OAIQuoteFxSummaryV3() override;
    ...
    qint32 getTotalSourceAmount() const;
    void setTotalSourceAmount(const qint32 &total_source_amount);
    bool is_total_source_amount_Set() const;
    bool is_total_source_amount_Valid() const;
...
private:
    ...
    qint32 m_total_source_amount;
    bool m_total_source_amount_isSet;
    bool m_total_source_amount_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIQuoteFxSummaryV3)

#endif // OAIQuoteFxSummaryV3_H
