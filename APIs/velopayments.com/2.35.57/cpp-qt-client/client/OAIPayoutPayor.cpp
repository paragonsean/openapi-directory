...
OAIPayoutPayor::OAIPayoutPayor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayoutPayor::OAIPayoutPayor() {
    this->initializeModel();
}

OAIPayoutPayor::~OAIPayoutPayor() {}

void OAIPayoutPayor::initializeModel() {
...
void OAIPayoutPayor::fromJson(QString jsonString) {
...
void OAIPayoutPayor::fromJsonObject(QJsonObject json) {
...
QString OAIPayoutPayor::asJson() const {
...
QJsonObject OAIPayoutPayor::asJsonObject() const {
    QJsonObject obj;
    if (m_dba_name_isSet) {
...
QString OAIPayoutPayor::getDbaName() const {
    return m_dba_name;
}
void OAIPayoutPayor::setDbaName(const QString &dba_name) {
    m_dba_name = dba_name;
    m_dba_name_isSet = true;
}

bool OAIPayoutPayor::is_dba_name_Set() const{
    return m_dba_name_isSet;
}

bool OAIPayoutPayor::is_dba_name_Valid() const{
    return m_dba_name_isValid;
}

QString OAIPayoutPayor::getPayorId() const {
    return m_payor_id;
}
void OAIPayoutPayor::setPayorId(const QString &payor_id) {
    m_payor_id = payor_id;
    m_payor_id_isSet = true;
}

bool OAIPayoutPayor::is_payor_id_Set() const{
    return m_payor_id_isSet;
}

bool OAIPayoutPayor::is_payor_id_Valid() const{
    return m_payor_id_isValid;
}

QString OAIPayoutPayor::getPayorName() const {
    return m_payor_name;
}
void OAIPayoutPayor::setPayorName(const QString &payor_name) {
    m_payor_name = payor_name;
    m_payor_name_isSet = true;
}

bool OAIPayoutPayor::is_payor_name_Set() const{
    return m_payor_name_isSet;
}

bool OAIPayoutPayor::is_payor_name_Valid() const{
    return m_payor_name_isValid;
}

QString OAIPayoutPayor::getPrincipal() const {
    return m_principal;
}
void OAIPayoutPayor::setPrincipal(const QString &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIPayoutPayor::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIPayoutPayor::is_principal_Valid() const{
    return m_principal_isValid;
}

QString OAIPayoutPayor::getPrincipalId() const {
    return m_principal_id;
}
void OAIPayoutPayor::setPrincipalId(const QString &principal_id) {
    m_principal_id = principal_id;
    m_principal_id_isSet = true;
}

bool OAIPayoutPayor::is_principal_id_Set() const{
    return m_principal_id_isSet;
}

bool OAIPayoutPayor::is_principal_id_Valid() const{
    return m_principal_id_isValid;
}

bool OAIPayoutPayor::isSet() const {
...
bool OAIPayoutPayor::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dba_name_isValid && m_payor_id_isValid && m_payor_name_isValid && m_principal_isValid && m_principal_id_isValid && true;
}
