...
#ifndef OAICreatePayeeV3_H
#define OAICreatePayeeV3_H
...
class OAICreatePayeeV3 : public OAIObject {
public:
    OAICreatePayeeV3();
    OAICreatePayeeV3(QString json);
    ~OAICreatePayeeV3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePayeeV3)

#endif // OAICreatePayeeV3_H
