...
/*
 * OAIAccessTokenResponse.h
 *
 * 
 */

#ifndef OAIAccessTokenResponse_H
#define OAIAccessTokenResponse_H
...
class OAIAccessTokenResponse : public OAIObject {
public:
    OAIAccessTokenResponse();
    OAIAccessTokenResponse(QString json);
    ~OAIAccessTokenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessTokenResponse)

#endif // OAIAccessTokenResponse_H
