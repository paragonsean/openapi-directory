...
class PaymentEvent {
     ...
     */
    constructor(createdAt, eventId, sourceType, paymentId) { 
        SourceEvent.initialize(this, createdAt, eventId, sourceType);PaymentEventAllOf.initialize(this, paymentId);
        PaymentEvent.initialize(this, createdAt, eventId, sourceType, paymentId);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, paymentId) { 
...
PaymentEvent.RequiredProperties = ["createdAt", "eventId", "sourceType", "paymentId"];
