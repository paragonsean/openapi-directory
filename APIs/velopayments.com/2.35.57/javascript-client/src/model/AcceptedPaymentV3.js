...
class AcceptedPaymentV3 {
     ...
     * @param railsId {String} Indicates the 3rd party system involved in making this payment
     ...
     */
    constructor(amount, currencyType, payorPaymentId, railsId, remoteId, sourceAccountName) { 
        
        AcceptedPaymentV3.initialize(this, amount, currencyType, payorPaymentId, railsId, remoteId, sourceAccountName);
    }
     ...
     */
    static initialize(obj, amount, currencyType, payorPaymentId, railsId, remoteId, sourceAccountName) { 
        obj['amount'] = amount;
    ...
    /**
     * Validates the JSON data with respect to <code>AcceptedPaymentV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcceptedPaymentV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AcceptedPaymentV3.RequiredProperties) {
...
AcceptedPaymentV3.RequiredProperties = ["amount", "currencyType", "payorPaymentId", "railsId", "remoteId", "sourceAccountName"];
 ...
 */
AcceptedPaymentV3.prototype['railsId'] = undefined;
