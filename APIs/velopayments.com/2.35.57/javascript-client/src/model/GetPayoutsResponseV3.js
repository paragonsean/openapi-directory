...
class GetPayoutsResponseV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PayoutSummaryAuditV3]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [GetPayoutsResponseV3Links]);
            }
            if (data.hasOwnProperty('page')) {
                obj['page'] = GetPayoutsResponseV3Page.constructFromObject(data['page']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPayoutsResponseV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPayoutsResponseV3</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PayoutSummaryAuditV3.validateJSON(item);
            };
        }
        ...
        if (data['page']) { // data not null
          GetPayoutsResponseV3Page.validateJSON(data['page']);
        }
...
export default GetPayoutsResponseV3;
