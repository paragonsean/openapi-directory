...
class PagedUserResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [PagedUserResponseLinks]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PagedUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PagedUserResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                PagedUserResponseLinks.validateJSON(item);
            };
        }
...
export default PagedUserResponse;
