...
class PayorCreateApplicationRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>PayorCreateApplicationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorCreateApplicationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorCreateApplicationRequest.RequiredProperties) {
...
PayorCreateApplicationRequest.RequiredProperties = ["name"];
...
export default PayorCreateApplicationRequest;
