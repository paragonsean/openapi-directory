...
import UserType2 from './UserType2';
...
class UserInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mfa_details')) {
                obj['mfa_details'] = MFADetails.constructFromObject(data['mfa_details']);
            }
            if (data.hasOwnProperty('userType')) {
                obj['userType'] = UserType2.constructFromObject(data['userType']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['mfa_details']) { // data not null
          MFADetails.validateJSON(data['mfa_details']);
        }
