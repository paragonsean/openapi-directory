...
class DebitEvent {
     ...
     */
    constructor(createdAt, eventId, sourceType, debitTransactionId) { 
        SourceEvent.initialize(this, createdAt, eventId, sourceType);DebitEventAllOf.initialize(this, debitTransactionId);
        DebitEvent.initialize(this, createdAt, eventId, sourceType, debitTransactionId);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, debitTransactionId) { 
...
DebitEvent.RequiredProperties = ["createdAt", "eventId", "sourceType", "debitTransactionId"];
