...
class CreatePayeeAddressV3 {
     ...
     * @param city {String} 
     * @param country {String} 2 letter ISO 3166-1 country code
     * @param line1 {String} 
     */
    constructor(city, country, line1) { 
        
        CreatePayeeAddressV3.initialize(this, city, country, line1);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePayeeAddressV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePayeeAddressV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePayeeAddressV3.RequiredProperties) {
...
CreatePayeeAddressV3.RequiredProperties = ["city", "country", "line1"];
