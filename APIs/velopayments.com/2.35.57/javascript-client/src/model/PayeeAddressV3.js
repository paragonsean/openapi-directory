...
/**
 * The PayeeAddressV3 model module.
 * @module model/PayeeAddressV3
 * @version 2.35.57
 */
class PayeeAddressV3 {
    /**
     * Constructs a new <code>PayeeAddressV3</code>.
     * @alias module:model/PayeeAddressV3
     * @param city {String} 
     * @param country {String} Valid ISO 3166 2 character country code. See the <a href=\"https://www.iso.org/iso-3166-country-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
     * @param line1 {String} 
     */
    constructor(city, country, line1) { 
        
        PayeeAddressV3.initialize(this, city, country, line1);
    }
    ...
    /**
     * Constructs a <code>PayeeAddressV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayeeAddressV3} obj Optional instance to populate.
     * @return {module:model/PayeeAddressV3} The populated <code>PayeeAddressV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayeeAddressV3();
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeAddressV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeAddressV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeAddressV3.RequiredProperties) {
...
PayeeAddressV3.RequiredProperties = ["city", "country", "line1"];

/**
 * @member {String} city
 */
PayeeAddressV3.prototype['city'] = undefined;
 ...
 */
PayeeAddressV3.prototype['country'] = undefined;

/**
 * @member {String} countyOrProvince
 */
PayeeAddressV3.prototype['countyOrProvince'] = undefined;

/**
 * @member {String} line1
 */
PayeeAddressV3.prototype['line1'] = undefined;

/**
 * @member {String} line2
 */
PayeeAddressV3.prototype['line2'] = undefined;

/**
 * @member {String} line3
 */
PayeeAddressV3.prototype['line3'] = undefined;

/**
 * @member {String} line4
 */
PayeeAddressV3.prototype['line4'] = undefined;

/**
 * @member {String} zipOrPostcode
 */
PayeeAddressV3.prototype['zipOrPostcode'] = undefined;
