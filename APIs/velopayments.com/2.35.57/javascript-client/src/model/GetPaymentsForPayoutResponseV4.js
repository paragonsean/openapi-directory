...
class GetPaymentsForPayoutResponseV4 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PaymentResponseV4]);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = GetPaymentsForPayoutResponseV4Summary.constructFromObject(data['summary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPaymentsForPayoutResponseV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPaymentsForPayoutResponseV4</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PaymentResponseV4.validateJSON(item);
            };
        }
        ...
        if (data['summary']) { // data not null
          GetPaymentsForPayoutResponseV4Summary.validateJSON(data['summary']);
        }
...
export default GetPaymentsForPayoutResponseV4;
