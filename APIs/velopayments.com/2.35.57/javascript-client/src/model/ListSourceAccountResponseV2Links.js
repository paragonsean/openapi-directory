...
class ListSourceAccountResponseV2Links {
    ...
    /**
     * Validates the JSON data with respect to <code>ListSourceAccountResponseV2Links</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSourceAccountResponseV2Links</code>.
     */
...
export default ListSourceAccountResponseV2Links;
