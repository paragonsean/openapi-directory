...
class FxSummary {
    ...
    constructor(creationDateTime, fundingStatus, invertedRate, quoteId, rate, status, totalCost, totalPaymentAmount) { 
        ...
        FxSummary.initialize(this, creationDateTime, fundingStatus, invertedRate, quoteId, rate, status, totalCost, totalPaymentAmount);
    }
...
FxSummary.RequiredProperties = ["creationDateTime", "fundingStatus", "invertedRate", "quoteId", "rate", "status", "totalCost", "totalPaymentAmount"];
