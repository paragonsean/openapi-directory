...
class SupportedCountriesResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('countries')) {
                obj['countries'] = ApiClient.convertToType(data['countries'], [SupportedCountry]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedCountriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedCountriesResponse</code>.
     */
    static validateJSON(data) {
        if (data['countries']) { // data not null
            ...
            for (const item of data['countries']) {
                SupportedCountry.validateJSON(item);
            };
        }
...
export default SupportedCountriesResponse;
