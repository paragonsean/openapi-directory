...
class CreatePayeesCSVRequestV3 {
     ...
     */
    constructor(addressCity, addressCountry, addressLine1, addressZipOrPostcode, email, remoteId, type) { 
        
        CreatePayeesCSVRequestV3.initialize(this, addressCity, addressCountry, addressLine1, addressZipOrPostcode, email, remoteId, type);
    }
     ...
     */
    static initialize(obj, addressCity, addressCountry, addressLine1, addressZipOrPostcode, email, remoteId, type) { 
...
CreatePayeesCSVRequestV3.RequiredProperties = ["addressCity", "addressCountry", "addressLine1", "addressZipOrPostcode", "email", "remoteId", "type"];
