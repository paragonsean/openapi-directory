...
class SourceAccountV3 {
     ...
     * @param sourceAccountId {String} The id of the payout
     * @param sourceAccountName {String} The name of the source account as referencec in the payout
     * @param totalPayoutCost {Number} The total amount (in mnor units) that will be debited from the source account for the payout
     */
    constructor(currency, sourceAccountId, sourceAccountName, totalPayoutCost) { 
        
        SourceAccountV3.initialize(this, currency, sourceAccountId, sourceAccountName, totalPayoutCost);
    }
     ...
     */
    static initialize(obj, currency, sourceAccountId, sourceAccountName, totalPayoutCost) { 
    ...
    /**
     * Validates the JSON data with respect to <code>SourceAccountV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceAccountV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SourceAccountV3.RequiredProperties) {
...
SourceAccountV3.RequiredProperties = ["currency", "sourceAccountId", "sourceAccountName", "totalPayoutCost"];
