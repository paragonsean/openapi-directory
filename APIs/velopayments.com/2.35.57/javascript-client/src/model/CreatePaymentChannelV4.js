...
/**
 * The CreatePaymentChannelV4 model module.
 * @module model/CreatePaymentChannelV4
 * @version 2.35.57
 */
class CreatePaymentChannelV4 {
    /**
     * Constructs a new <code>CreatePaymentChannelV4</code>.
     * @alias module:model/CreatePaymentChannelV4
     ...
     */
    constructor(accountName, countryCode, currency) { 
        
        CreatePaymentChannelV4.initialize(this, accountName, countryCode, currency);
    }
     ...
     */
    static initialize(obj, accountName, countryCode, currency) { 
    ...
    /**
     * Constructs a <code>CreatePaymentChannelV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePaymentChannelV4} obj Optional instance to populate.
     * @return {module:model/CreatePaymentChannelV4} The populated <code>CreatePaymentChannelV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePaymentChannelV4();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePaymentChannelV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePaymentChannelV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePaymentChannelV4.RequiredProperties) {
...
CreatePaymentChannelV4.RequiredProperties = ["accountName", "countryCode", "currency"];

/**
 * @member {String} accountName
 */
CreatePaymentChannelV4.prototype['accountName'] = undefined;

/**
 * Either routing number and account number or only iban must be set
 * @member {String} accountNumber
 */
CreatePaymentChannelV4.prototype['accountNumber'] = undefined;
 ...
 */
CreatePaymentChannelV4.prototype['countryCode'] = undefined;

/**
 * Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
 * @member {String} currency
 */
CreatePaymentChannelV4.prototype['currency'] = undefined;

/**
 * Must match the regular expression ```^[A-Za-z0-9]+$```.
 * @member {String} iban
 */
CreatePaymentChannelV4.prototype['iban'] = undefined;

/**
 * @member {String} paymentChannelName
 */
CreatePaymentChannelV4.prototype['paymentChannelName'] = undefined;

/**
 * Either routing number and account number or only iban must be set
 * @member {String} routingNumber
 */
CreatePaymentChannelV4.prototype['routingNumber'] = undefined;
...
export default CreatePaymentChannelV4;
