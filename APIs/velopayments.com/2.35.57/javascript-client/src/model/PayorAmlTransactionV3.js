...
class PayorAmlTransactionV3 {
    ...
    /**
     * Validates the JSON data with respect to <code>PayorAmlTransactionV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorAmlTransactionV3</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['creditCurrency'] && !(typeof data['creditCurrency'] === 'string' || data['creditCurrency'] instanceof String)) {
            throw new Error("Expected the field `creditCurrency` to be a primitive type in the JSON string but got " + data['creditCurrency']);
        }
        // ensure the json data is a string
        if (data['dateFundingRequested'] && !(typeof data['dateFundingRequested'] === 'string' || data['dateFundingRequested'] instanceof String)) {
            throw new Error("Expected the field `dateFundingRequested` to be a primitive type in the JSON string but got " + data['dateFundingRequested']);
        }
        // ensure the json data is a string
        if (data['debitCurrency'] && !(typeof data['debitCurrency'] === 'string' || data['debitCurrency'] instanceof String)) {
            throw new Error("Expected the field `debitCurrency` to be a primitive type in the JSON string but got " + data['debitCurrency']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['reportTransactionType'] && !(typeof data['reportTransactionType'] === 'string' || data['reportTransactionType'] instanceof String)) {
            throw new Error("Expected the field `reportTransactionType` to be a primitive type in the JSON string but got " + data['reportTransactionType']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['returnDescription'] && !(typeof data['returnDescription'] === 'string' || data['returnDescription'] instanceof String)) {
            throw new Error("Expected the field `returnDescription` to be a primitive type in the JSON string but got " + data['returnDescription']);
        }
        // ensure the json data is a string
        if (data['returnFee'] && !(typeof data['returnFee'] === 'string' || data['returnFee'] instanceof String)) {
            throw new Error("Expected the field `returnFee` to be a primitive type in the JSON string but got " + data['returnFee']);
        }
        // ensure the json data is a string
        if (data['returnFeeCurrency'] && !(typeof data['returnFeeCurrency'] === 'string' || data['returnFeeCurrency'] instanceof String)) {
            throw new Error("Expected the field `returnFeeCurrency` to be a primitive type in the JSON string but got " + data['returnFeeCurrency']);
        }
        // ensure the json data is a string
        if (data['returnFeeDescription'] && !(typeof data['returnFeeDescription'] === 'string' || data['returnFeeDescription'] instanceof String)) {
            throw new Error("Expected the field `returnFeeDescription` to be a primitive type in the JSON string but got " + data['returnFeeDescription']);
        }
        // ensure the json data is a string
