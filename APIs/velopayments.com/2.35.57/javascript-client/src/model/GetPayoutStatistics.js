...
class GetPayoutStatistics {
     ...
     */
    constructor(thisMonthFailedPaymentsCount, thisMonthPayoutsCount) { 
        
        GetPayoutStatistics.initialize(this, thisMonthFailedPaymentsCount, thisMonthPayoutsCount);
    }
     ...
     */
    static initialize(obj, thisMonthFailedPaymentsCount, thisMonthPayoutsCount) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('thisMonthFailedPaymentsCount')) {
                obj['thisMonthFailedPaymentsCount'] = ApiClient.convertToType(data['thisMonthFailedPaymentsCount'], 'Number');
            }
            if (data.hasOwnProperty('thisMonthPayoutsCount')) {
                obj['thisMonthPayoutsCount'] = ApiClient.convertToType(data['thisMonthPayoutsCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPayoutStatistics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPayoutStatistics</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPayoutStatistics.RequiredProperties) {
...
GetPayoutStatistics.RequiredProperties = ["thisMonthFailedPaymentsCount", "thisMonthPayoutsCount"];
...
export default GetPayoutStatistics;
