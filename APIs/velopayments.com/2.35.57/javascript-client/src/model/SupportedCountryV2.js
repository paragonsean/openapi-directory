...
class SupportedCountryV2 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('regions')) {
                obj['regions'] = ApiClient.convertToType(data['regions'], [RegionV2]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedCountryV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedCountryV2</code>.
     */
...
export default SupportedCountryV2;
