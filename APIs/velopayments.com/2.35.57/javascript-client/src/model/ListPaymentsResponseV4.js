...
class ListPaymentsResponseV4 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('page')) {
                obj['page'] = ListPaymentsResponseV3Page.constructFromObject(data['page']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPaymentsResponseV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPaymentsResponseV4</code>.
     */
    static validateJSON(data) {
        ...
        if (data['page']) { // data not null
          ListPaymentsResponseV3Page.validateJSON(data['page']);
        }
...
export default ListPaymentsResponseV4;
