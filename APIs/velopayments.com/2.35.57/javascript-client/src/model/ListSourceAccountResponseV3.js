...
class ListSourceAccountResponseV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [SourceAccountResponseV3]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [ListSourceAccountResponseV3Links]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSourceAccountResponseV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSourceAccountResponseV3</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                SourceAccountResponseV3.validateJSON(item);
            };
        }
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                ListSourceAccountResponseV3Links.validateJSON(item);
            };
        }
...
export default ListSourceAccountResponseV3;
