...
class FundingEvent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fundingEventType')) {
                obj['fundingEventType'] = ApiClient.convertToType(data['fundingEventType'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FundingEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundingEvent</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['fundingEventType'] && !(typeof data['fundingEventType'] === 'string' || data['fundingEventType'] instanceof String)) {
            throw new Error("Expected the field `fundingEventType` to be a primitive type in the JSON string but got " + data['fundingEventType']);
        }
        // ensure the json data is a string
 ...
 * @member {String} fundingEventType
 */
