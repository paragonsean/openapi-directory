...
class PaymentChannelRule {
     ...
     */
    constructor(displayName, element, required, validation) { 
        
        PaymentChannelRule.initialize(this, displayName, element, required, validation);
    }
     ...
     */
    static initialize(obj, displayName, element, required, validation) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentChannelRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentChannelRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentChannelRule.RequiredProperties) {
...
PaymentChannelRule.RequiredProperties = ["displayName", "element", "required", "validation"];

/**
 * An optional description, or hint, as to how the user should enter the field value.
 * @member {String} description
 */
PaymentChannelRule.prototype['description'] = undefined;
...
export default PaymentChannelRule;
