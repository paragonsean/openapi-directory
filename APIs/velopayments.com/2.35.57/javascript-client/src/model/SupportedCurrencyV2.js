...
class SupportedCurrencyV2 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maxPaymentAmount')) {
                obj['maxPaymentAmount'] = ApiClient.convertToType(data['maxPaymentAmount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedCurrencyV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedCurrencyV2</code>.
     */
...
export default SupportedCurrencyV2;
