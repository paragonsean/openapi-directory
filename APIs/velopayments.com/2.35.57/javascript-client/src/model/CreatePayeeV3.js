...
class CreatePayeeV3 {
     ...
     */
    constructor(address, email, remoteId, type) { 
        
        CreatePayeeV3.initialize(this, address, email, remoteId, type);
    }
     ...
     */
    static initialize(obj, address, email, remoteId, type) { 
        obj['address'] = address;
        obj['email'] = email;
...
CreatePayeeV3.RequiredProperties = ["address", "email", "remoteId", "type"];
