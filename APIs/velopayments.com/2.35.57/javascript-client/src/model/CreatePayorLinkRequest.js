...
class CreatePayorLinkRequest {
     ...
     */
    constructor(fromPayorId, linkType, toPayorId) { 
     ...
     */
    static initialize(obj, fromPayorId, linkType, toPayorId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fromPayorId')) {
                obj['fromPayorId'] = ApiClient.convertToType(data['fromPayorId'], 'String');
            }
            if (data.hasOwnProperty('linkType')) {
                obj['linkType'] = ApiClient.convertToType(data['linkType'], 'String');
            }
            if (data.hasOwnProperty('toPayorId')) {
                obj['toPayorId'] = ApiClient.convertToType(data['toPayorId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePayorLinkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePayorLinkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePayorLinkRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['fromPayorId'] && !(typeof data['fromPayorId'] === 'string' || data['fromPayorId'] instanceof String)) {
            throw new Error("Expected the field `fromPayorId` to be a primitive type in the JSON string but got " + data['fromPayorId']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['toPayorId'] && !(typeof data['toPayorId'] === 'string' || data['toPayorId'] instanceof String)) {
            throw new Error("Expected the field `toPayorId` to be a primitive type in the JSON string but got " + data['toPayorId']);
        }
...
CreatePayorLinkRequest.RequiredProperties = ["fromPayorId", "linkType", "toPayorId"];
...
export default CreatePayorLinkRequest;
