...
class PaymentResponseV4 {
     ...
     * @param fundingStatus {String} Current funding status of the payment. One of the following values: FUNDED, INSTRUCTED, UNFUNDED
     ...
     * @param status {String} Current status of the payment. One of the following values: ACCEPTED, AWAITING_FUNDS, FUNDED, UNFUNDED, BANK_PAYMENT_REQUESTED, REJECTED, ACCEPTED_BY_RAILS, CONFIRMED, RETURNED, WITHDRAWN
     * @param submittedDateTime {Date} 
     */
    constructor(events, fundingStatus, payeeId, paymentAmount, paymentId, payorId, quoteId, railsId, sourceAccountId, status, submittedDateTime) { 
        
        PaymentResponseV4.initialize(this, events, fundingStatus, payeeId, paymentAmount, paymentId, payorId, quoteId, railsId, sourceAccountId, status, submittedDateTime);
    }
     ...
     */
    static initialize(obj, events, fundingStatus, payeeId, paymentAmount, paymentId, payorId, quoteId, railsId, sourceAccountId, status, submittedDateTime) { 
        obj['events'] = events;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('events')) {
                obj['events'] = ApiClient.convertToType(data['events'], [PaymentEventResponse]);
            }
            ...
            if (data.hasOwnProperty('payeeAddressCountryCode')) {
                obj['payeeAddressCountryCode'] = ApiClient.convertToType(data['payeeAddressCountryCode'], 'String');
            }
            ...
            if (data.hasOwnProperty('postInstructFxInfo')) {
                obj['postInstructFxInfo'] = PostInstructFxInfo.constructFromObject(data['postInstructFxInfo']);
            }
            ...
            if (data.hasOwnProperty('remoteSystemPaymentId')) {
                obj['remoteSystemPaymentId'] = ApiClient.convertToType(data['remoteSystemPaymentId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentResponseV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentResponseV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentResponseV4.RequiredProperties) {
        ...
        if (data['events']) { // data not null
            ...
            for (const item of data['events']) {
                PaymentEventResponse.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['payeeAddressCountryCode'] && !(typeof data['payeeAddressCountryCode'] === 'string' || data['payeeAddressCountryCode'] instanceof String)) {
            throw new Error("Expected the field `payeeAddressCountryCode` to be a primitive type in the JSON string but got " + data['payeeAddressCountryCode']);
        }
        // ensure the json data is a string
        ...
        if (data['payout']) { // data not null
          PaymentResponseV4Payout.validateJSON(data['payout']);
        }
        // validate the optional field `postInstructFxInfo`
        if (data['postInstructFxInfo']) { // data not null
          PostInstructFxInfo.validateJSON(data['postInstructFxInfo']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['remoteSystemPaymentId'] && !(typeof data['remoteSystemPaymentId'] === 'string' || data['remoteSystemPaymentId'] instanceof String)) {
            throw new Error("Expected the field `remoteSystemPaymentId` to be a primitive type in the JSON string but got " + data['remoteSystemPaymentId']);
        }
        // ensure the json data is a string
        ...
        if (data['withdrawnReason'] && !(typeof data['withdrawnReason'] === 'string' || data['withdrawnReason'] instanceof String)) {
            throw new Error("Expected the field `withdrawnReason` to be a primitive type in the JSON string but got " + data['withdrawnReason']);
        }
...
PaymentResponseV4.RequiredProperties = ["events", "fundingStatus", "payeeId", "paymentAmount", "paymentId", "payorId", "quoteId", "railsId", "sourceAccountId", "status", "submittedDateTime"];
 ...
 * @member {String} payeeAddressCountryCode
 */
PaymentResponseV4.prototype['payeeAddressCountryCode'] = undefined;
...
/**
 * @member {module:model/PostInstructFxInfo} postInstructFxInfo
 */
PaymentResponseV4.prototype['postInstructFxInfo'] = undefined;
