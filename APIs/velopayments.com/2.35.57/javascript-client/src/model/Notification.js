...
class Notification {
     ...
     */
    constructor(apiVersion, category, eventName, sequenceNumber) { 
        
        Notification.initialize(this, apiVersion, category, eventName, sequenceNumber);
    }
     ...
     */
    static initialize(obj, apiVersion, category, eventName, sequenceNumber) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('source')) {
                obj['source'] = NotificationSource.constructFromObject(data['source']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['source']) { // data not null
          NotificationSource.validateJSON(data['source']);
        }
...
Notification.RequiredProperties = ["apiVersion", "category", "eventName", "sequenceNumber"];
...
/**
 * @member {module:model/NotificationSource} source
 */
