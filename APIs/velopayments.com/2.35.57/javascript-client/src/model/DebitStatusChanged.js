...
import DebitEvent from './DebitEvent';
import DebitStatusChangedAllOf from './DebitStatusChangedAllOf';
...
class DebitStatusChanged {
     ...
     */
    constructor(createdAt, eventId, sourceType, debitTransactionId, status) { 
        DebitEvent.initialize(this, createdAt, eventId, sourceType, debitTransactionId);DebitStatusChangedAllOf.initialize(this, status);
        DebitStatusChanged.initialize(this, createdAt, eventId, sourceType, debitTransactionId, status);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, debitTransactionId, status) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            DebitEvent.constructFromObject(data, obj);
            DebitStatusChangedAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DebitStatusChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DebitStatusChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DebitStatusChanged.RequiredProperties) {
...
DebitStatusChanged.RequiredProperties = ["createdAt", "eventId", "sourceType", "debitTransactionId", "status"];
 ...
 */
DebitStatusChanged.prototype['status'] = undefined;


// Implement DebitEvent interface:
/**
 * ISO8601 timestamp indicating when the source event was created
 * @member {Date} createdAt
 */
 ...
 * @member {String} debitTransactionId
 */
DebitEvent.prototype['debitTransactionId'] = undefined;
// Implement DebitStatusChangedAllOf interface:
/**
 * The new status of the debit. One of \"PENDING\" \"PROCESSING\" \"REJECTED\" \"RELEASED\"
 * @member {String} status
 */
DebitStatusChangedAllOf.prototype['status'] = undefined;




export default DebitStatusChanged;
