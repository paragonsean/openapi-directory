...
class PayoutNameV3 {
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutNameV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutNameV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutNameV3.RequiredProperties) {
...
PayoutNameV3.RequiredProperties = ["firstName", "lastName"];
