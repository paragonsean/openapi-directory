...
class CreateWebhookRequest {
     ...
     */
    constructor(enabled, payorId, webhookUrl) { 
        
        CreateWebhookRequest.initialize(this, enabled, payorId, webhookUrl);
    }
     ...
     */
    static initialize(obj, enabled, payorId, webhookUrl) { 
        obj['enabled'] = enabled;
        obj['payorId'] = payorId;
...
CreateWebhookRequest.RequiredProperties = ["enabled", "payorId", "webhookUrl"];
