...
import PayeeEvent from './PayeeEvent';
...
class PayableStatusChanged {
     ...
     */
    constructor(createdAt, eventId, sourceType, payeeId) { 
        PayeeEvent.initialize(this, createdAt, eventId, sourceType, payeeId);
        PayableStatusChanged.initialize(this, createdAt, eventId, sourceType, payeeId);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, payeeId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PayeeEvent.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('reasons')) {
                obj['reasons'] = ApiClient.convertToType(data['reasons'], [PayeeEventAllOfReasons]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayableStatusChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayableStatusChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayableStatusChanged.RequiredProperties) {
        ...
        if (data['reasons']) { // data not null
            ...
            for (const item of data['reasons']) {
                PayeeEventAllOfReasons.validateJSON(item);
            };
        }
...
PayableStatusChanged.RequiredProperties = ["createdAt", "eventId", "sourceType", "payeeId"];
 ...
 */
PayableStatusChanged.prototype['reasons'] = undefined;


// Implement PayeeEvent interface:
/**
 * ISO8601 timestamp indicating when the source event was created
 * @member {Date} createdAt
 */
 ...
 * @member {Array.<module:model/PayeeEventAllOfReasons>} reasons
 */
PayeeEvent.prototype['reasons'] = undefined;




export default PayableStatusChanged;
