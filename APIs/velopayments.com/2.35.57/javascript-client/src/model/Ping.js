...
class Ping {
    ...
    constructor(createdAt, eventId, sourceType) { 
        ...
        Ping.initialize(this, createdAt, eventId, sourceType);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ping();
            SourceEvent.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of Ping.RequiredProperties) {
...
Ping.RequiredProperties = ["createdAt", "eventId", "sourceType"];

/**
 * ISO8601 timestamp indicating when the source event was created
 * @member {Date} createdAt
 */
Ping.prototype['createdAt'] = undefined;
...
// Implement SourceEvent interface:
/**
 * ISO8601 timestamp indicating when the source event was created
 * @member {Date} createdAt
 */
