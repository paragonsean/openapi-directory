...
class PayorLinksResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [PayorLinksResponseLinks]);
            }
            if (data.hasOwnProperty('payors')) {
                obj['payors'] = ApiClient.convertToType(data['payors'], [PayorLinksResponsePayors]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayorLinksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorLinksResponse</code>.
     */
    static validateJSON(data) {
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                PayorLinksResponseLinks.validateJSON(item);
            };
        }
        if (data['payors']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['payors'])) {
                throw new Error("Expected the field `payors` to be an array in the JSON data but got " + data['payors']);
            }
            // validate the optional field `payors` (array)
            for (const item of data['payors']) {
                PayorLinksResponsePayors.validateJSON(item);
            };
        }
...
export default PayorLinksResponse;
