...
class FailedPayeeV3 {
    /**
     * Constructs a new <code>FailedPayeeV3</code>.
     * @alias module:model/FailedPayeeV3
     */
    constructor() { 
        
        FailedPayeeV3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FailedPayeeV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FailedPayeeV3} obj Optional instance to populate.
     * @return {module:model/FailedPayeeV3} The populated <code>FailedPayeeV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FailedPayeeV3();
    ...
    /**
     * Validates the JSON data with respect to <code>FailedPayeeV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FailedPayeeV3</code>.
     */
 ...
 */
FailedPayeeV3.prototype['address'] = undefined;

/**
 * @member {module:model/ChallengeV3} challenge
 */
FailedPayeeV3.prototype['challenge'] = undefined;

/**
 * @member {module:model/CompanyV3} company
 */
FailedPayeeV3.prototype['company'] = undefined;

/**
 * @member {String} email
 */
FailedPayeeV3.prototype['email'] = undefined;

/**
 * @member {module:model/CreateIndividualV3} individual
 */
FailedPayeeV3.prototype['individual'] = undefined;
 ...
 */
FailedPayeeV3.prototype['language'] = undefined;

/**
 * @member {String} payeeId
 */
FailedPayeeV3.prototype['payeeId'] = undefined;

/**
 * @member {module:model/CreatePaymentChannelV3} paymentChannel
 */
FailedPayeeV3.prototype['paymentChannel'] = undefined;

/**
 * @member {Array.<module:model/PayeePayorRefV3>} payorRefs
 */
FailedPayeeV3.prototype['payorRefs'] = undefined;

/**
 * @member {String} remoteId
 */
FailedPayeeV3.prototype['remoteId'] = undefined;

/**
 * Type of Payee. One of the following values: Individual, Company
 * @member {String} type
 */
FailedPayeeV3.prototype['type'] = undefined;
