...
class FundingRequestV3 {
     ...
     */
    constructor(amount, fundingAccountId) { 
        
        FundingRequestV3.initialize(this, amount, fundingAccountId);
    }
     ...
     */
    static initialize(obj, amount, fundingAccountId) { 
        obj['amount'] = amount;
...
FundingRequestV3.RequiredProperties = ["amount", "fundingAccountId"];
