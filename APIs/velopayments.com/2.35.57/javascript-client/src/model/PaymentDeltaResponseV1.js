...
class PaymentDeltaResponseV1 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PaymentDeltaV1]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentDeltaResponseV1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentDeltaResponseV1</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PaymentDeltaV1.validateJSON(item);
            };
        }
...
export default PaymentDeltaResponseV1;
