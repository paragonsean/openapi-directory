...
class PayorAddress {
    ...
    constructor(city, country, line1) { 
        ...
        PayorAddress.initialize(this, city, country, line1);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayorAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorAddress.RequiredProperties) {
...
PayorAddress.RequiredProperties = ["city", "country", "line1"];
