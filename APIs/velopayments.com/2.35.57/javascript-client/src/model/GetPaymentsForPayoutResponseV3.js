...
class GetPaymentsForPayoutResponseV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PaymentResponseV3]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [GetPayoutsResponseV3Links]);
            }
            if (data.hasOwnProperty('page')) {
                obj['page'] = GetPaymentsForPayoutResponseV3Page.constructFromObject(data['page']);
            }
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = GetPaymentsForPayoutResponseV3Summary.constructFromObject(data['summary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPaymentsForPayoutResponseV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPaymentsForPayoutResponseV3</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PaymentResponseV3.validateJSON(item);
            };
        }
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                GetPayoutsResponseV3Links.validateJSON(item);
            };
        }
        // validate the optional field `page`
        if (data['page']) { // data not null
          GetPaymentsForPayoutResponseV3Page.validateJSON(data['page']);
        }
        // validate the optional field `summary`
        if (data['summary']) { // data not null
          GetPaymentsForPayoutResponseV3Summary.validateJSON(data['summary']);
        }
...
export default GetPaymentsForPayoutResponseV3;
