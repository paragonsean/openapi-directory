...
class PayoutSchedule {
     ...
     * @param scheduleStatus {String} Current status of the payout schedule. One of the following values: SCHEDULED, EXECUTED, FAILED
    ...
    constructor(notificationsEnabled, scheduleStatus, scheduledAt, scheduledByPrincipalId, scheduledFor) { 
        ...
        PayoutSchedule.initialize(this, notificationsEnabled, scheduleStatus, scheduledAt, scheduledByPrincipalId, scheduledFor);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutSchedule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutSchedule.RequiredProperties) {
...
PayoutSchedule.RequiredProperties = ["notificationsEnabled", "scheduleStatus", "scheduledAt", "scheduledByPrincipalId", "scheduledFor"];
