...
class PayorV1 {
    ...
    /**
     * Validates the JSON data with respect to <code>PayorV1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorV1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorV1.RequiredProperties) {
        ...
        if (data['address']) { // data not null
          PayorAddress.validateJSON(data['address']);
        }
        ...
        // ensure the json data is a string
        if (data['fundingAccountAccountName'] && !(typeof data['fundingAccountAccountName'] === 'string' || data['fundingAccountAccountName'] instanceof String)) {
            throw new Error("Expected the field `fundingAccountAccountName` to be a primitive type in the JSON string but got " + data['fundingAccountAccountName']);
        }
        // ensure the json data is a string
        if (data['fundingAccountAccountNumber'] && !(typeof data['fundingAccountAccountNumber'] === 'string' || data['fundingAccountAccountNumber'] instanceof String)) {
            throw new Error("Expected the field `fundingAccountAccountNumber` to be a primitive type in the JSON string but got " + data['fundingAccountAccountNumber']);
        }
        // ensure the json data is a string
        if (data['fundingAccountRoutingNumber'] && !(typeof data['fundingAccountRoutingNumber'] === 'string' || data['fundingAccountRoutingNumber'] instanceof String)) {
            throw new Error("Expected the field `fundingAccountRoutingNumber` to be a primitive type in the JSON string but got " + data['fundingAccountRoutingNumber']);
        }
        // ensure the json data is a string
        ...
        if (data['transmissionTypes']) { // data not null
          TransmissionTypes.validateJSON(data['transmissionTypes']);
        }
...
PayorV1.RequiredProperties = ["payorName"];
