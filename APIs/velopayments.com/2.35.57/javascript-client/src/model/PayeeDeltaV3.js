...
class PayeeDeltaV3 {
    /**
     * Constructs a new <code>PayeeDeltaV3</code>.
     * @alias module:model/PayeeDeltaV3
     * @param payeeId {String} 
     * @param remoteId {String} 
     */
    constructor(payeeId, remoteId) { 
        
        PayeeDeltaV3.initialize(this, payeeId, remoteId);
    }
     ...
     */
    static initialize(obj, payeeId, remoteId) { 
        obj['payeeId'] = payeeId;
        obj['remoteId'] = remoteId;
    }

    /**
     * Constructs a <code>PayeeDeltaV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayeeDeltaV3} obj Optional instance to populate.
     * @return {module:model/PayeeDeltaV3} The populated <code>PayeeDeltaV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayeeDeltaV3();
            ...
            if (data.hasOwnProperty('payeeCountry')) {
                obj['payeeCountry'] = ApiClient.convertToType(data['payeeCountry'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeDeltaV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeDeltaV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeDeltaV3.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['payeeCountry'] && !(typeof data['payeeCountry'] === 'string' || data['payeeCountry'] instanceof String)) {
            throw new Error("Expected the field `payeeCountry` to be a primitive type in the JSON string but got " + data['payeeCountry']);
        }
        // ensure the json data is a string
...
PayeeDeltaV3.RequiredProperties = ["payeeId", "remoteId"];

/**
 * @member {String} dbaName
 */
PayeeDeltaV3.prototype['dbaName'] = undefined;

/**
 * @member {String} displayName
 */
PayeeDeltaV3.prototype['displayName'] = undefined;

/**
 * @member {String} email
 */
PayeeDeltaV3.prototype['email'] = undefined;

/**
 * Onboarded status. One of the following values: CREATED, INVITED, REGISTERED, ONBOARDED
 * @member {String} onboardedStatus
 */
PayeeDeltaV3.prototype['onboardedStatus'] = undefined;

/**
 * @member {String} payeeCountry
 */
PayeeDeltaV3.prototype['payeeCountry'] = undefined;

/**
 * @member {String} payeeId
 */
PayeeDeltaV3.prototype['payeeId'] = undefined;

/**
 * @member {String} remoteId
 */
PayeeDeltaV3.prototype['remoteId'] = undefined;
