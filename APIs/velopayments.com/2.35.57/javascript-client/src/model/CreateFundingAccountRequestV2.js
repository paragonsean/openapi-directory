...
class CreateFundingAccountRequestV2 {
     ...
     */
    constructor(name, payorId, type) { 
        
        CreateFundingAccountRequestV2.initialize(this, name, payorId, type);
    }
     ...
     */
    static initialize(obj, name, payorId, type) { 
        obj['name'] = name;
        obj['payorId'] = payorId;
        obj['type'] = type;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFundingAccountRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFundingAccountRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFundingAccountRequestV2.RequiredProperties) {
...
CreateFundingAccountRequestV2.RequiredProperties = ["name", "payorId", "type"];
...
export default CreateFundingAccountRequestV2;
