...
class UserDetailsUpdateRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mfaType')) {
                obj['mfaType'] = MFAType.constructFromObject(data['mfaType']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserDetailsUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserDetailsUpdateRequest</code>.
     */
...
export default UserDetailsUpdateRequest;
