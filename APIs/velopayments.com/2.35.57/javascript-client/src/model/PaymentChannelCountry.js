...
class PaymentChannelCountry {
     ...
     */
    constructor(isoCountryCode, rules) { 
     ...
     */
    static initialize(obj, isoCountryCode, rules) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [PaymentChannelRule]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentChannelCountry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentChannelCountry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentChannelCountry.RequiredProperties) {
        ...
        if (data['rules']) { // data not null
            ...
            for (const item of data['rules']) {
                PaymentChannelRule.validateJSON(item);
            };
        }
...
PaymentChannelCountry.RequiredProperties = ["isoCountryCode", "rules"];
...
export default PaymentChannelCountry;
