...
class InviteUserRequest {
     ...
     */
    constructor(email, mfaType, primaryContactNumber, roles, smsNumber) { 
        
        InviteUserRequest.initialize(this, email, mfaType, primaryContactNumber, roles, smsNumber);
    }
     ...
     */
    static initialize(obj, email, mfaType, primaryContactNumber, roles, smsNumber) { 
        obj['email'] = email;
        obj['mfaType'] = mfaType;
    ...
    /**
     * Validates the JSON data with respect to <code>InviteUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InviteUserRequest.RequiredProperties) {
...
InviteUserRequest.RequiredProperties = ["email", "mfaType", "primaryContactNumber", "roles", "smsNumber"];
