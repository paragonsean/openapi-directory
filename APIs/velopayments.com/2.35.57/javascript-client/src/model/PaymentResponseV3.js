...
class PaymentResponseV3 {
    ...
    constructor(events, fundingStatus, payeeId, paymentAmount, paymentId, payorId, quoteId, railsId, sourceAccountId, status, submittedDateTime) { 
        ...
        PaymentResponseV3.initialize(this, events, fundingStatus, payeeId, paymentAmount, paymentId, payorId, quoteId, railsId, sourceAccountId, status, submittedDateTime);
    }
...
PaymentResponseV3.RequiredProperties = ["events", "fundingStatus", "payeeId", "paymentAmount", "paymentId", "payorId", "quoteId", "railsId", "sourceAccountId", "status", "submittedDateTime"];
