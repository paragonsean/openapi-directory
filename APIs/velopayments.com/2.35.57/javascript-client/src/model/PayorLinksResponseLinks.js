...
class PayorLinksResponseLinks {
     ...
     * @param linkId {String} 
     * @param linkType {String} The type of the link. One of the following values: PARENT_OF
     * @param toPayorId {String} 
     */
    constructor(fromPayorId, linkId, linkType, toPayorId) { 
        
        PayorLinksResponseLinks.initialize(this, fromPayorId, linkId, linkType, toPayorId);
    }
     ...
     */
    static initialize(obj, fromPayorId, linkId, linkType, toPayorId) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PayorLinksResponseLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorLinksResponseLinks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorLinksResponseLinks.RequiredProperties) {
...
PayorLinksResponseLinks.RequiredProperties = ["fromPayorId", "linkId", "linkType", "toPayorId"];
...
export default PayorLinksResponseLinks;
