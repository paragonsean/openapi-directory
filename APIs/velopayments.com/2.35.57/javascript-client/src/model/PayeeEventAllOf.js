...
class PayeeEventAllOf {
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeEventAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeEventAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeEventAllOf.RequiredProperties) {
...
PayeeEventAllOf.RequiredProperties = ["payeeId"];
...
export default PayeeEventAllOf;
