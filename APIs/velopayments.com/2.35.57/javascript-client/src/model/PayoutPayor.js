...
class PayoutPayor {
     ...
     */
    constructor(dbaName, payorId, payorName, principal, principalId) { 
        
        PayoutPayor.initialize(this, dbaName, payorId, payorName, principal, principalId);
    }
     ...
     */
    static initialize(obj, dbaName, payorId, payorName, principal, principalId) { 
        obj['dbaName'] = dbaName;
        obj['payorId'] = payorId;
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutPayor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutPayor</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutPayor.RequiredProperties) {
...
PayoutPayor.RequiredProperties = ["dbaName", "payorId", "payorName", "principal", "principalId"];
