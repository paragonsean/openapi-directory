...
class GetPaymentsForPayoutResponseV4Summary {
    ...
    /**
     * Validates the JSON data with respect to <code>GetPaymentsForPayoutResponseV4Summary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPaymentsForPayoutResponseV4Summary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `instructed`
        if (data['instructed']) { // data not null
          PayoutPrincipal.validateJSON(data['instructed']);
        }
        // validate the optional field `payoutFrom`
        if (data['payoutFrom']) { // data not null
          PayoutPayor.validateJSON(data['payoutFrom']);
        }
        // ensure the json data is a string
        if (data['payoutMemo'] && !(typeof data['payoutMemo'] === 'string' || data['payoutMemo'] instanceof String)) {
            throw new Error("Expected the field `payoutMemo` to be a primitive type in the JSON string but got " + data['payoutMemo']);
        }
        // ensure the json data is a string
        if (data['payoutStatus'] && !(typeof data['payoutStatus'] === 'string' || data['payoutStatus'] instanceof String)) {
            throw new Error("Expected the field `payoutStatus` to be a primitive type in the JSON string but got " + data['payoutStatus']);
        }
        // validate the optional field `payoutTo`
        if (data['payoutTo']) { // data not null
          PayoutPayor.validateJSON(data['payoutTo']);
        }
        // ensure the json data is a string
        if (data['payoutType'] && !(typeof data['payoutType'] === 'string' || data['payoutType'] instanceof String)) {
            throw new Error("Expected the field `payoutType` to be a primitive type in the JSON string but got " + data['payoutType']);
        }
        // validate the optional field `quoted`
        if (data['quoted']) { // data not null
          PayoutPrincipal.validateJSON(data['quoted']);
        }
        // validate the optional field `schedule`
        if (data['schedule']) { // data not null
          PayoutSchedule.validateJSON(data['schedule']);
        }
        // validate the optional field `submitting`
        if (data['submitting']) { // data not null
          PayoutPayor.validateJSON(data['submitting']);
        }
        // validate the optional field `withdrawn`
        if (data['withdrawn']) { // data not null
          PayoutPrincipal.validateJSON(data['withdrawn']);
        }
