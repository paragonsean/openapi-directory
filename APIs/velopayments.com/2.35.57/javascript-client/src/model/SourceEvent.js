...
class SourceEvent {
     ...
     */
    constructor(createdAt, eventId, sourceType) { 
        
        SourceEvent.initialize(this, createdAt, eventId, sourceType);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType) { 
    ...
    /**
     * Validates the JSON data with respect to <code>SourceEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SourceEvent.RequiredProperties) {
...
SourceEvent.RequiredProperties = ["createdAt", "eventId", "sourceType"];
