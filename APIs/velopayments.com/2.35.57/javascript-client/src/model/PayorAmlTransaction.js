...
class PayorAmlTransaction {
    ...
    /**
     * Validates the JSON data with respect to <code>PayorAmlTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorAmlTransaction</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['payeeEmail'] && !(typeof data['payeeEmail'] === 'string' || data['payeeEmail'] instanceof String)) {
            throw new Error("Expected the field `payeeEmail` to be a primitive type in the JSON string but got " + data['payeeEmail']);
        }
        // ensure the json data is a string
