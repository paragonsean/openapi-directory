...
class PaymentDeltaV1 {
     ...
     */
    constructor(paymentId, payoutId) { 
     ...
     */
    static initialize(obj, paymentId, payoutId) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentDeltaV1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentDeltaV1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentDeltaV1.RequiredProperties) {
...
PaymentDeltaV1.RequiredProperties = ["paymentId", "payoutId"];
