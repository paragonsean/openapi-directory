...
class PaymentInstructionV3 {
     ...
     */
    constructor(amount, currency, remoteId, sourceAccountName) { 
        
        PaymentInstructionV3.initialize(this, amount, currency, remoteId, sourceAccountName);
    }
     ...
     */
    static initialize(obj, amount, currency, remoteId, sourceAccountName) { 
        obj['amount'] = amount;
...
PaymentInstructionV3.RequiredProperties = ["amount", "currency", "remoteId", "sourceAccountName"];
