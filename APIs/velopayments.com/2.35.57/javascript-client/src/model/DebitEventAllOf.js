...
class DebitEventAllOf {
     ...
     */
    constructor(debitTransactionId) { 
     ...
     */
    static initialize(obj, debitTransactionId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('debitTransactionId')) {
                obj['debitTransactionId'] = ApiClient.convertToType(data['debitTransactionId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DebitEventAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DebitEventAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DebitEventAllOf.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['debitTransactionId'] && !(typeof data['debitTransactionId'] === 'string' || data['debitTransactionId'] instanceof String)) {
            throw new Error("Expected the field `debitTransactionId` to be a primitive type in the JSON string but got " + data['debitTransactionId']);
        }
...
DebitEventAllOf.RequiredProperties = ["debitTransactionId"];
...
export default DebitEventAllOf;
