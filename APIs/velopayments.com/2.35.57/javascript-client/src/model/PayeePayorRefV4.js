...
class PayeePayorRefV4 {
    /**
     * Constructs a new <code>PayeePayorRefV4</code>.
     * @alias module:model/PayeePayorRefV4
     */
    constructor() { 
        
        PayeePayorRefV4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PayeePayorRefV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayeePayorRefV4} obj Optional instance to populate.
     * @return {module:model/PayeePayorRefV4} The populated <code>PayeePayorRefV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayeePayorRefV4();
            ...
            if (data.hasOwnProperty('invitationStatusTimestamp')) {
                obj['invitationStatusTimestamp'] = ApiClient.convertToType(data['invitationStatusTimestamp'], 'Date');
            }
            if (data.hasOwnProperty('payableIssues')) {
                obj['payableIssues'] = ApiClient.convertToType(data['payableIssues'], [PayableIssueV4]);
            }
            if (data.hasOwnProperty('payableStatus')) {
                obj['payableStatus'] = ApiClient.convertToType(data['payableStatus'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PayeePayorRefV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeePayorRefV4</code>.
     */
    static validateJSON(data) {
        ...
        if (data['payableIssues']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['payableIssues'])) {
                throw new Error("Expected the field `payableIssues` to be an array in the JSON data but got " + data['payableIssues']);
            }
            // validate the optional field `payableIssues` (array)
            for (const item of data['payableIssues']) {
                PayableIssueV4.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
PayeePayorRefV4.prototype['invitationStatus'] = undefined;

/**
 * The timestamp when the invitation status is updated
 * @member {Date} invitationStatusTimestamp
 */
PayeePayorRefV4.prototype['invitationStatusTimestamp'] = undefined;

/**
 * Indicates any conditions which prevent the payee from being payable for this payor
 * @member {Array.<module:model/PayableIssueV4>} payableIssues
 */
PayeePayorRefV4.prototype['payableIssues'] = undefined;

/**
 * Indicates if the payee is payable for this payor
 * @member {Boolean} payableStatus
 */
PayeePayorRefV4.prototype['payableStatus'] = undefined;

/**
 * @member {String} paymentChannelId
 */
PayeePayorRefV4.prototype['paymentChannelId'] = undefined;

/**
 * @member {String} payorId
 */
PayeePayorRefV4.prototype['payorId'] = undefined;

/**
 * @member {String} remoteId
 */
PayeePayorRefV4.prototype['remoteId'] = undefined;
...
export default PayeePayorRefV4;
