...
class PaymentChannelRulesResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bank')) {
                obj['bank'] = ApiClient.convertToType(data['bank'], [PaymentChannelCountry]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentChannelRulesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentChannelRulesResponse</code>.
     */
    static validateJSON(data) {
        if (data['bank']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['bank'])) {
                throw new Error("Expected the field `bank` to be an array in the JSON data but got " + data['bank']);
            }
            // validate the optional field `bank` (array)
            for (const item of data['bank']) {
                PaymentChannelCountry.validateJSON(item);
            };
        }
...
export default PaymentChannelRulesResponse;
