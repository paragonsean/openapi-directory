...
/**
 * The PayorBrandingResponse model module.
 * @module model/PayorBrandingResponse
 * @version 2.35.57
 */
class PayorBrandingResponse {
    /**
     * Constructs a new <code>PayorBrandingResponse</code>.
     * @alias module:model/PayorBrandingResponse
     * @param logoUrl {String} <p>The URL to use for this payor’s logo</p> <p>This will be an immutable system-generated URL</p> 
     * @param payorName {String} The name of the payor
     */
    constructor(logoUrl, payorName) { 
        
        PayorBrandingResponse.initialize(this, logoUrl, payorName);
    }
     ...
     */
    static initialize(obj, logoUrl, payorName) { 
        obj['logoUrl'] = logoUrl;
        obj['payorName'] = payorName;
    }

    /**
     * Constructs a <code>PayorBrandingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayorBrandingResponse} obj Optional instance to populate.
     * @return {module:model/PayorBrandingResponse} The populated <code>PayorBrandingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayorBrandingResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PayorBrandingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorBrandingResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorBrandingResponse.RequiredProperties) {
...
export default PayorBrandingResponse;
