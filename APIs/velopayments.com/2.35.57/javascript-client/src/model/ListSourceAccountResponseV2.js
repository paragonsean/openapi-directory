...
class ListSourceAccountResponseV2 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [SourceAccountResponseV2]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [ListSourceAccountResponseV2Links]);
            }
            if (data.hasOwnProperty('page')) {
                obj['page'] = PagedUserResponsePage.constructFromObject(data['page']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSourceAccountResponseV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSourceAccountResponseV2</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                SourceAccountResponseV2.validateJSON(item);
            };
        }
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                ListSourceAccountResponseV2Links.validateJSON(item);
            };
        }
        // validate the optional field `page`
        if (data['page']) { // data not null
          PagedUserResponsePage.validateJSON(data['page']);
        }
...
export default ListSourceAccountResponseV2;
