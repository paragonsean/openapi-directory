...
class GetPayeeListResponseV4 {
    /**
     * Constructs a new <code>GetPayeeListResponseV4</code>.
     * @alias module:model/GetPayeeListResponseV4
     */
    constructor() { 
        
        GetPayeeListResponseV4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPayeeListResponseV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPayeeListResponseV4} obj Optional instance to populate.
     * @return {module:model/GetPayeeListResponseV4} The populated <code>GetPayeeListResponseV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPayeeListResponseV4();

            if (data.hasOwnProperty('company')) {
                obj['company'] = GetPayeeListResponseCompanyV4.constructFromObject(data['company']);
            }
            ...
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = GetPayeeListResponseIndividualV4.constructFromObject(data['individual']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPayeeListResponseV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPayeeListResponseV4</code>.
     */
    static validateJSON(data) {
        // validate the optional field `company`
        if (data['company']) { // data not null
          GetPayeeListResponseCompanyV4.validateJSON(data['company']);
        }
        ...
        if (data['individual']) { // data not null
          GetPayeeListResponseIndividualV4.validateJSON(data['individual']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/GetPayeeListResponseCompanyV4} company
 */
GetPayeeListResponseV4.prototype['company'] = undefined;
 ...
 */
GetPayeeListResponseV4.prototype['country'] = undefined;

/**
 * @member {Date} created
 */
GetPayeeListResponseV4.prototype['created'] = undefined;

/**
 * @member {Boolean} disabled
 */
GetPayeeListResponseV4.prototype['disabled'] = undefined;

/**
 * @member {String} disabledComment
 */
GetPayeeListResponseV4.prototype['disabledComment'] = undefined;

/**
 * @member {Date} disabledUpdatedTimestamp
 */
GetPayeeListResponseV4.prototype['disabledUpdatedTimestamp'] = undefined;

/**
 * @member {String} displayName
 */
GetPayeeListResponseV4.prototype['displayName'] = undefined;

/**
 * @member {String} email
 */
GetPayeeListResponseV4.prototype['email'] = undefined;

/**
 * @member {module:model/GetPayeeListResponseIndividualV4} individual
 */
GetPayeeListResponseV4.prototype['individual'] = undefined;
...
export default GetPayeeListResponseV4;
