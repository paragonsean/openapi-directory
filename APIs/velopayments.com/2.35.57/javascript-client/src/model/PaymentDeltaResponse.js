...
class PaymentDeltaResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PaymentDelta]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentDeltaResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentDeltaResponse</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PaymentDelta.validateJSON(item);
            };
        }
...
export default PaymentDeltaResponse;
