...
class SelfUpdatePasswordRequest {
    ...
    constructor(newPassword, oldPassword) { 
        ...
        SelfUpdatePasswordRequest.initialize(this, newPassword, oldPassword);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SelfUpdatePasswordRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SelfUpdatePasswordRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SelfUpdatePasswordRequest.RequiredProperties) {
...
SelfUpdatePasswordRequest.RequiredProperties = ["newPassword", "oldPassword"];
...
export default SelfUpdatePasswordRequest;
