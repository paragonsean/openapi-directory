...
class GetFundingsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [FundingAudit]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [GetFundingsResponseLinks]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFundingsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFundingsResponse</code>.
     */
    static validateJSON(data) {
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                FundingAudit.validateJSON(item);
            };
        }
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                GetFundingsResponseLinks.validateJSON(item);
            };
        }
...
export default GetFundingsResponse;
