...
class TransmissionTypes2 {
     ...
     */
    constructor(ACH, SAME_DAY_ACH, WIRE) { 
     ...
     */
    static initialize(obj, ACH, SAME_DAY_ACH, WIRE) { 
        obj['ACH'] = ACH;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ACH')) {
                obj['ACH'] = ApiClient.convertToType(data['ACH'], 'Boolean');
            }
            if (data.hasOwnProperty('SAME_DAY_ACH')) {
                obj['SAME_DAY_ACH'] = ApiClient.convertToType(data['SAME_DAY_ACH'], 'Boolean');
            }
            if (data.hasOwnProperty('WIRE')) {
                obj['WIRE'] = ApiClient.convertToType(data['WIRE'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransmissionTypes2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransmissionTypes2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransmissionTypes2.RequiredProperties) {
...
TransmissionTypes2.RequiredProperties = ["ACH", "SAME_DAY_ACH", "WIRE"];
...
export default TransmissionTypes2;
