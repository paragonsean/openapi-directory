...
class PayoutCompanyV3 {
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutCompanyV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutCompanyV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutCompanyV3.RequiredProperties) {
...
PayoutCompanyV3.RequiredProperties = ["companyName"];
...
export default PayoutCompanyV3;
