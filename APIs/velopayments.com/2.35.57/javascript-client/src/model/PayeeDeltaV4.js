...
class PayeeDeltaV4 {
    /**
     * Constructs a new <code>PayeeDeltaV4</code>.
     * @alias module:model/PayeeDeltaV4
     * @param payeeId {String} 
     * @param remoteId {String} 
     */
    constructor(payeeId, remoteId) { 
        
        PayeeDeltaV4.initialize(this, payeeId, remoteId);
    }
    ...
    /**
     * Constructs a <code>PayeeDeltaV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayeeDeltaV4} obj Optional instance to populate.
     * @return {module:model/PayeeDeltaV4} The populated <code>PayeeDeltaV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayeeDeltaV4();
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeDeltaV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeDeltaV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeDeltaV4.RequiredProperties) {
...
PayeeDeltaV4.RequiredProperties = ["payeeId", "remoteId"];

/**
 * @member {String} dbaName
 */
PayeeDeltaV4.prototype['dbaName'] = undefined;

/**
 * @member {String} displayName
 */
PayeeDeltaV4.prototype['displayName'] = undefined;

/**
 * @member {String} email
 */
PayeeDeltaV4.prototype['email'] = undefined;

/**
 * Payee onboarded status. One of the following value: CREATED, INVITED, REGISTERED, ONBOARDED
 * @member {String} onboardedStatus
 */
PayeeDeltaV4.prototype['onboardedStatus'] = undefined;
 ...
 */
PayeeDeltaV4.prototype['payeeCountry'] = undefined;

/**
 * @member {String} payeeId
 */
PayeeDeltaV4.prototype['payeeId'] = undefined;

/**
 * @member {String} remoteId
 */
PayeeDeltaV4.prototype['remoteId'] = undefined;
