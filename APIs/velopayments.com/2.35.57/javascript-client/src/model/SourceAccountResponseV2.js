...
class SourceAccountResponseV2 {
     ...
     */
    constructor(accountType, balanceVisible, fundingRef, id, physicalAccountName, pooled, railsId) { 
        
        SourceAccountResponseV2.initialize(this, accountType, balanceVisible, fundingRef, id, physicalAccountName, pooled, railsId);
    }
     ...
     */
    static initialize(obj, accountType, balanceVisible, fundingRef, id, physicalAccountName, pooled, railsId) { 
...
SourceAccountResponseV2.RequiredProperties = ["accountType", "balanceVisible", "fundingRef", "id", "physicalAccountName", "pooled", "railsId"];
