...
class PayoutPayeeV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('company')) {
                obj['company'] = PayoutCompanyV3.constructFromObject(data['company']);
            }
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = PayoutIndividualV3.constructFromObject(data['individual']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutPayeeV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutPayeeV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutPayeeV3.RequiredProperties) {
        ...
        if (data['company']) { // data not null
          PayoutCompanyV3.validateJSON(data['company']);
        }
        // validate the optional field `individual`
        if (data['individual']) { // data not null
          PayoutIndividualV3.validateJSON(data['individual']);
        }
...
PayoutPayeeV3.RequiredProperties = ["payeeId"];
