...
class PaymentStatusChanged {
     ...
     */
    constructor(createdAt, eventId, sourceType, paymentId, status) { 
        PaymentEvent.initialize(this, createdAt, eventId, sourceType, paymentId);PaymentStatusChangedAllOf.initialize(this, status);
        PaymentStatusChanged.initialize(this, createdAt, eventId, sourceType, paymentId, status);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, paymentId, status) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentStatusChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentStatusChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentStatusChanged.RequiredProperties) {
        ...
        if (data['payoutPayorIds']) { // data not null
          PayoutPayorIds.validateJSON(data['payoutPayorIds']);
        }
        // ensure the json data is a string
...
PaymentStatusChanged.RequiredProperties = ["createdAt", "eventId", "sourceType", "paymentId", "status"];
