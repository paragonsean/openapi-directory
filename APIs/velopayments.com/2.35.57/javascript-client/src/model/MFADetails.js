...
class MFADetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mfa_type')) {
                obj['mfa_type'] = MFAType.constructFromObject(data['mfa_type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MFADetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MFADetails</code>.
     */
