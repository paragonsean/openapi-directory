...
class RejectedPaymentV3 {
     ...
     */
    constructor(amount, currencyType, payorPaymentId, reason, remoteId, sourceAccountName) { 
        
        RejectedPaymentV3.initialize(this, amount, currencyType, payorPaymentId, reason, remoteId, sourceAccountName);
    }
     ...
     */
    static initialize(obj, amount, currencyType, payorPaymentId, reason, remoteId, sourceAccountName) { 
        obj['amount'] = amount;
...
RejectedPaymentV3.RequiredProperties = ["amount", "currencyType", "payorPaymentId", "reason", "remoteId", "sourceAccountName"];
