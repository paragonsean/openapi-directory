...
import PayeeEventAllOf from './PayeeEventAllOf';
...
class PayeeEvent {
    ...
    constructor(createdAt, eventId, sourceType, payeeId) { 
        SourceEvent.initialize(this, createdAt, eventId, sourceType);PayeeEventAllOf.initialize(this, payeeId);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PayeeEventAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeEvent.RequiredProperties) {
...
PayeeEvent.RequiredProperties = ["createdAt", "eventId", "sourceType", "payeeId"];
...
// Implement PayeeEventAllOf interface:
/**
 * ID of this payee within the Velo platform
 * @member {String} payeeId
 */
