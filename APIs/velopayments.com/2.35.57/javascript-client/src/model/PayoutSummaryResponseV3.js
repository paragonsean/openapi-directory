...
class PayoutSummaryResponseV3 {
     ...
     */
    constructor(acceptedPayments, accounts, fxSummaries, paymentsWithdrawn, rejectedPayments) { 
        
        PayoutSummaryResponseV3.initialize(this, acceptedPayments, accounts, fxSummaries, paymentsWithdrawn, rejectedPayments);
    }
     ...
     */
    static initialize(obj, acceptedPayments, accounts, fxSummaries, paymentsWithdrawn, rejectedPayments) { 
...
PayoutSummaryResponseV3.RequiredProperties = ["acceptedPayments", "accounts", "fxSummaries", "paymentsWithdrawn", "rejectedPayments"];
