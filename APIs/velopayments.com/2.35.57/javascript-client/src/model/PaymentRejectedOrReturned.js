...
import PaymentRejectedOrReturnedAllOf from './PaymentRejectedOrReturnedAllOf';
...
class PaymentRejectedOrReturned {
     ...
     */
    constructor(createdAt, eventId, sourceType, paymentId, status, reasonCode, reasonMessage) { 
        PaymentStatusChanged.initialize(this, createdAt, eventId, sourceType, paymentId, status);PaymentRejectedOrReturnedAllOf.initialize(this, reasonCode, reasonMessage);
        PaymentRejectedOrReturned.initialize(this, createdAt, eventId, sourceType, paymentId, status, reasonCode, reasonMessage);
    }
     ...
     */
    static initialize(obj, createdAt, eventId, sourceType, paymentId, status, reasonCode, reasonMessage) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PaymentStatusChanged.constructFromObject(data, obj);
            PaymentRejectedOrReturnedAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentRejectedOrReturned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentRejectedOrReturned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentRejectedOrReturned.RequiredProperties) {
...
PaymentRejectedOrReturned.RequiredProperties = ["createdAt", "eventId", "sourceType", "paymentId", "status", "reasonCode", "reasonMessage"];
 ...
 */
PaymentRejectedOrReturned.prototype['reasonMessage'] = undefined;


// Implement PaymentStatusChanged interface:
/**
 * ISO8601 timestamp indicating when the source event was created
 * @member {Date} createdAt
 */
...
// Implement PaymentRejectedOrReturnedAllOf interface:
/**
 * The Velo code that indicates why the payment was rejected or returned
 * @member {String} reasonCode
 */
...
export default PaymentRejectedOrReturned;
