...
class FxSummaryV3 {
     ...
     * @param fundingStatus {String} Current status of the funding. One of the following values: FUNDED, INSTRUCTED, UNFUNDED
     * @param invertedRate {Number} 
     * @param quoteId {String} 
     * @param rate {Number} 
     * @param status {String} Current status of the FX Summary. One of the following values: UNQUOTED, QUOTED, EXPIRED, EXECUTED
     * @param totalCost {Number} 
     * @param totalPaymentAmount {Number} 
     */
    constructor(creationDateTime, fundingStatus, invertedRate, quoteId, rate, status, totalCost, totalPaymentAmount) { 
        
        FxSummaryV3.initialize(this, creationDateTime, fundingStatus, invertedRate, quoteId, rate, status, totalCost, totalPaymentAmount);
    }
     ...
     */
    static initialize(obj, creationDateTime, fundingStatus, invertedRate, quoteId, rate, status, totalCost, totalPaymentAmount) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('totalPaymentAmount')) {
                obj['totalPaymentAmount'] = ApiClient.convertToType(data['totalPaymentAmount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FxSummaryV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FxSummaryV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FxSummaryV3.RequiredProperties) {
...
FxSummaryV3.RequiredProperties = ["creationDateTime", "fundingStatus", "invertedRate", "quoteId", "rate", "status", "totalCost", "totalPaymentAmount"];
