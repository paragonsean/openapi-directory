...
export default class PayorHierarchyApi {
    ...
    /**
    * Constructs a new PayorHierarchyApi. 
    * @alias module:api/PayorHierarchyApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the payorLinksV1 operation.
     * @callback module:api/PayorHierarchyApi~payorLinksV1Callback
