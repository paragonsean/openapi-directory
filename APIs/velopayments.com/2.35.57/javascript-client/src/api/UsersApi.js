...
export default class UsersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resendToken_0 operation.
     * @callback module:api/UsersApi~resendToken_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersApi~resendToken_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    resendToken_0(userId, resendTokenRequest, callback) {
      let postBody = resendTokenRequest;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling resendToken_0");
      }
      // verify the required parameter 'resendTokenRequest' is set
      if (resendTokenRequest === undefined || resendTokenRequest === null) {
        throw new Error("Missing the required parameter 'resendTokenRequest' when calling resendToken_0");
      }
