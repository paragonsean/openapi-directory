...
export default class FundingManagerPrivateApi {
    ...
    */
    ...
    createFundingAccountV2(opts, callback) {
      opts = opts || {};
      let postBody = opts['createFundingAccountRequestV2'];
     ...
     */
    deleteSourceAccountV3(sourceAccountId, callback) {
      let postBody = null;
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v3/sourceAccounts/{sourceAccountId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
