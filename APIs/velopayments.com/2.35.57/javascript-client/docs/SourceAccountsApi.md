# VeloPaymentsApis.SourceAccountsApi
...
let apiInstance = new VeloPaymentsApis.SourceAccountsApi();
...
let apiInstance = new VeloPaymentsApis.SourceAccountsApi();
let sourceAccountId = "sourceAccountId_example"; // String | Source account id
let setNotificationsRequest2 = new VeloPaymentsApis.SetNotificationsRequest2(); // SetNotificationsRequest2 | Body to included minimum balance to set
...
let transferRequestV2 = new VeloPaymentsApis.TransferRequestV2(); // TransferRequestV2 | Body
...
let apiInstance = new VeloPaymentsApis.SourceAccountsApi();
let sourceAccountId = "sourceAccountId_example"; // String | The 'from' source account id, which will be debited
let transferRequestV3 = new VeloPaymentsApis.TransferRequestV3(); // TransferRequestV3 | Body
