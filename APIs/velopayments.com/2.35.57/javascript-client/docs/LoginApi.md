...
let apiInstance = new VeloPaymentsApis.LoginApi();
...
let apiInstance = new VeloPaymentsApis.LoginApi();
let resetPasswordRequest = new VeloPaymentsApis.ResetPasswordRequest(); // ResetPasswordRequest | An Email address to send the reset password link to
...
let apiInstance = new VeloPaymentsApis.LoginApi();
let accessTokenValidationRequest = new VeloPaymentsApis.AccessTokenValidationRequest(); // AccessTokenValidationRequest | An OTP from the user's registered MFA Device 
let opts = {
