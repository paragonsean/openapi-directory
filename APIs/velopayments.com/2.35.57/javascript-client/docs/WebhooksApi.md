...
let apiInstance = new VeloPaymentsApis.WebhooksApi();
let opts = {
  'createWebhookRequest': new VeloPaymentsApis.CreateWebhookRequest() // CreateWebhookRequest | 
};
...
let webhookId = "webhookId_example"; // String | Webhook id
let opts = {
  'updateWebhookRequest': new VeloPaymentsApis.UpdateWebhookRequest() // UpdateWebhookRequest | 
};
