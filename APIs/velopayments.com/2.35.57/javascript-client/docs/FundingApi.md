...
let apiInstance = new VeloPaymentsApis.FundingApi();
let sourceAccountId = "sourceAccountId_example"; // String | Source account id
let fundingRequestV2 = new VeloPaymentsApis.FundingRequestV2(); // FundingRequestV2 | Body to included amount to be funded
...
let apiInstance = new VeloPaymentsApis.FundingApi();
let sourceAccountId = "sourceAccountId_example"; // String | Source account id
let fundingRequestV3 = new VeloPaymentsApis.FundingRequestV3(); // FundingRequestV3 | Body to included amount to be funded
