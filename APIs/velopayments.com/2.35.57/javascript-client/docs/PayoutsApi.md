...
let apiInstance = new VeloPaymentsApis.PayoutsApi();
...
let payoutId = "payoutId_example"; // String | Id of the payout
let opts = {
  'instructPayoutRequestV3': new VeloPaymentsApis.InstructPayoutRequestV3() // InstructPayoutRequestV3 | Additional instruct payout parameters
};
...
let payoutId = "payoutId_example"; // String | Id of the payout
let opts = {
  'schedulePayoutRequestV3': new VeloPaymentsApis.SchedulePayoutRequestV3() // SchedulePayoutRequestV3 | schedule payout parameters
};
...
let apiInstance = new VeloPaymentsApis.PayoutsApi();
let createPayoutRequestV3 = new VeloPaymentsApis.CreatePayoutRequestV3(); // CreatePayoutRequestV3 | Post amount to transfer using stored funding account details.
...
let withdrawPaymentRequest = new VeloPaymentsApis.WithdrawPaymentRequest(); // WithdrawPaymentRequest | details for withdrawal
