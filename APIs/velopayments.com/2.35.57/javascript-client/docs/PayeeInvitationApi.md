...
let opts = {
  'createPayeesRequestV3': new VeloPaymentsApis.CreatePayeesRequestV3() // CreatePayeesRequestV3 | Post payees to create.
};
...
let invitePayeeRequestV3 = new VeloPaymentsApis.InvitePayeeRequestV3(); // InvitePayeeRequestV3 | Provide Payor Id in body of request
...
let apiInstance = new VeloPaymentsApis.PayeeInvitationApi();
let payeeId = "2aa5d7e0-2ecb-403f-8494-1865ed0454e9"; // String | The UUID of the payee.
let invitePayeeRequestV4 = new VeloPaymentsApis.InvitePayeeRequestV4(); // InvitePayeeRequestV4 | Provide Payor Id in body of request
...
let apiInstance = new VeloPaymentsApis.PayeeInvitationApi();
let opts = {
  'createPayeesRequestV4': new VeloPaymentsApis.CreatePayeesRequestV4() // CreatePayeesRequestV4 | Post payees to create.
};
