# VeloPaymentsApis.PayorsPrivateApi
...
let apiInstance = new VeloPaymentsApis.PayorsPrivateApi();
let createPayorLinkRequest = new VeloPaymentsApis.CreatePayorLinkRequest(); // CreatePayorLinkRequest | Request to create a payor link
