...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PagedUserResponsePage();
  });
  ...
  describe('PagedUserResponsePage', function() {
    it('should create an instance of PagedUserResponsePage', function() {
      // uncomment below and update the code to test PagedUserResponsePage
      //var instance = new VeloPaymentsApis.PagedUserResponsePage();
      //expect(instance).to.be.a(VeloPaymentsApis.PagedUserResponsePage);
    });
