...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PaymentEventResponse();
  });
  ...
  describe('PaymentEventResponse', function() {
    it('should create an instance of PaymentEventResponse', function() {
      // uncomment below and update the code to test PaymentEventResponse
      //var instance = new VeloPaymentsApis.PaymentEventResponse();
      //expect(instance).to.be.a(VeloPaymentsApis.PaymentEventResponse);
    });
