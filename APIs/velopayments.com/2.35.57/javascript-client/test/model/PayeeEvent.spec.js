...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PayeeEvent();
  });
  ...
  describe('PayeeEvent', function() {
    it('should create an instance of PayeeEvent', function() {
      // uncomment below and update the code to test PayeeEvent
      //var instance = new VeloPaymentsApis.PayeeEvent();
      //expect(instance).to.be.a(VeloPaymentsApis.PayeeEvent);
    });
