...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.SupportedCountryV2();
  });
  ...
  describe('SupportedCountryV2', function() {
    it('should create an instance of SupportedCountryV2', function() {
      // uncomment below and update the code to test SupportedCountryV2
      //var instance = new VeloPaymentsApis.SupportedCountryV2();
      //expect(instance).to.be.a(VeloPaymentsApis.SupportedCountryV2);
    });
