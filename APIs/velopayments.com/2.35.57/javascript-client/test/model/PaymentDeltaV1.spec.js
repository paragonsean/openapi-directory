...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PaymentDeltaV1();
  });
  ...
  describe('PaymentDeltaV1', function() {
    it('should create an instance of PaymentDeltaV1', function() {
      // uncomment below and update the code to test PaymentDeltaV1
      //var instance = new VeloPaymentsApis.PaymentDeltaV1();
      //expect(instance).to.be.a(VeloPaymentsApis.PaymentDeltaV1);
    });
