...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.QueryBatchResponseV3();
  });
  ...
  describe('QueryBatchResponseV3', function() {
    it('should create an instance of QueryBatchResponseV3', function() {
      // uncomment below and update the code to test QueryBatchResponseV3
      //var instance = new VeloPaymentsApis.QueryBatchResponseV3();
      //expect(instance).to.be.a(VeloPaymentsApis.QueryBatchResponseV3);
    });
