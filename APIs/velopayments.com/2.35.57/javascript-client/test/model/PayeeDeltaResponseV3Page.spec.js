...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PayeeDeltaResponseV3Page();
  });
  ...
  describe('PayeeDeltaResponseV3Page', function() {
    it('should create an instance of PayeeDeltaResponseV3Page', function() {
      // uncomment below and update the code to test PayeeDeltaResponseV3Page
      //var instance = new VeloPaymentsApis.PayeeDeltaResponseV3Page();
      //expect(instance).to.be.a(VeloPaymentsApis.PayeeDeltaResponseV3Page);
    });
