...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.QuoteFxSummaryV3();
  });
  ...
  describe('QuoteFxSummaryV3', function() {
    it('should create an instance of QuoteFxSummaryV3', function() {
      // uncomment below and update the code to test QuoteFxSummaryV3
      //var instance = new VeloPaymentsApis.QuoteFxSummaryV3();
      //expect(instance).to.be.a(VeloPaymentsApis.QuoteFxSummaryV3);
    });
    ...
    it('should have the property totalSourceAmount (base name: "totalSourceAmount")', function() {
      // uncomment below and update the code to test the property totalSourceAmount
      //var instance = new VeloPaymentsApis.QuoteFxSummaryV3();
      //expect(instance).to.be();
    });
