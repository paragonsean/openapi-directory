...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.GetPayoutsResponseV3Page();
  });
  ...
  describe('GetPayoutsResponseV3Page', function() {
    it('should create an instance of GetPayoutsResponseV3Page', function() {
      // uncomment below and update the code to test GetPayoutsResponseV3Page
      //var instance = new VeloPaymentsApis.GetPayoutsResponseV3Page();
      //expect(instance).to.be.a(VeloPaymentsApis.GetPayoutsResponseV3Page);
    });
