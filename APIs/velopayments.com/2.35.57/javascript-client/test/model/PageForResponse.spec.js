...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PageForResponse();
  });
  ...
  describe('PageForResponse', function() {
    it('should create an instance of PageForResponse', function() {
      // uncomment below and update the code to test PageForResponse
      //var instance = new VeloPaymentsApis.PageForResponse();
      //expect(instance).to.be.a(VeloPaymentsApis.PageForResponse);
    });
