...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.ListPaymentsResponseV3Page();
  });
  ...
  describe('ListPaymentsResponseV3Page', function() {
    it('should create an instance of ListPaymentsResponseV3Page', function() {
      // uncomment below and update the code to test ListPaymentsResponseV3Page
      //var instance = new VeloPaymentsApis.ListPaymentsResponseV3Page();
      //expect(instance).to.be.a(VeloPaymentsApis.ListPaymentsResponseV3Page);
    });
