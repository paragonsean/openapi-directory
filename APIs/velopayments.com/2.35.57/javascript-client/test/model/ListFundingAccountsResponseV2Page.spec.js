...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.ListFundingAccountsResponseV2Page();
  });
  ...
  describe('ListFundingAccountsResponseV2Page', function() {
    it('should create an instance of ListFundingAccountsResponseV2Page', function() {
      // uncomment below and update the code to test ListFundingAccountsResponseV2Page
      //var instance = new VeloPaymentsApis.ListFundingAccountsResponseV2Page();
      //expect(instance).to.be.a(VeloPaymentsApis.ListFundingAccountsResponseV2Page);
    });
