...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PaymentChannelRule();
  });
  ...
  describe('PaymentChannelRule', function() {
    it('should create an instance of PaymentChannelRule', function() {
      // uncomment below and update the code to test PaymentChannelRule
      //var instance = new VeloPaymentsApis.PaymentChannelRule();
      //expect(instance).to.be.a(VeloPaymentsApis.PaymentChannelRule);
    });
