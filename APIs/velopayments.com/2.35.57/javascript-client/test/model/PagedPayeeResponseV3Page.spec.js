...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PagedPayeeResponseV3Page();
  });
  ...
  describe('PagedPayeeResponseV3Page', function() {
    it('should create an instance of PagedPayeeResponseV3Page', function() {
      // uncomment below and update the code to test PagedPayeeResponseV3Page
      //var instance = new VeloPaymentsApis.PagedPayeeResponseV3Page();
      //expect(instance).to.be.a(VeloPaymentsApis.PagedPayeeResponseV3Page);
    });
