...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.GetPaymentsForPayoutResponseV3Page();
  });
  ...
  describe('GetPaymentsForPayoutResponseV3Page', function() {
    it('should create an instance of GetPaymentsForPayoutResponseV3Page', function() {
      // uncomment below and update the code to test GetPaymentsForPayoutResponseV3Page
      //var instance = new VeloPaymentsApis.GetPaymentsForPayoutResponseV3Page();
      //expect(instance).to.be.a(VeloPaymentsApis.GetPaymentsForPayoutResponseV3Page);
    });
