...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.QueryBatchResponseV4();
  });
  ...
  describe('QueryBatchResponseV4', function() {
    it('should create an instance of QueryBatchResponseV4', function() {
      // uncomment below and update the code to test QueryBatchResponseV4
      //var instance = new VeloPaymentsApis.QueryBatchResponseV4();
      //expect(instance).to.be.a(VeloPaymentsApis.QueryBatchResponseV4);
    });
