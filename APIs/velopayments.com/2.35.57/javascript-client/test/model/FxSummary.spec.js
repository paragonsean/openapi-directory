...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.FxSummary();
  });
  ...
  describe('FxSummary', function() {
    it('should create an instance of FxSummary', function() {
      // uncomment below and update the code to test FxSummary
      //var instance = new VeloPaymentsApis.FxSummary();
      //expect(instance).to.be.a(VeloPaymentsApis.FxSummary);
    });
