...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.PaymentDelta();
  });
  ...
  describe('PaymentDelta', function() {
    it('should create an instance of PaymentDelta', function() {
      // uncomment below and update the code to test PaymentDelta
      //var instance = new VeloPaymentsApis.PaymentDelta();
      //expect(instance).to.be.a(VeloPaymentsApis.PaymentDelta);
    });
