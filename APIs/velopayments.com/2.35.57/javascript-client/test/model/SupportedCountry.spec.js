...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApis.SupportedCountry();
  });
  ...
  describe('SupportedCountry', function() {
    it('should create an instance of SupportedCountry', function() {
      ...
      //var instance = new VeloPaymentsApis.SupportedCountry();
      //expect(instance).to.be.a(VeloPaymentsApis.SupportedCountry);
    });
