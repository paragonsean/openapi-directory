...
|**eventDateTime** | **OffsetDateTime** | The date/time at which the event occurred. |  |
...
|**paymentAmount** | **Long** | The destination amount exposed by the event. |  [optional] |
...
|**sourceAmount** | **Long** | The source amount exposed by the event. |  [optional] |
