...
|**entityIds** | **List&lt;String&gt;** | If the user is a payee then the payeeId&lt;P&gt; If the user is a payor then the payorId  |  [optional] |
|**expiresIn** | **Integer** | The lifetime in seconds of the access token |  [optional] |
|**refreshToken** | **String** | can be used to obtain a new access token |  [optional] |
|**scope** | **String** | the scope of the access token |  [optional] |
|**tokenType** | **String** | the type of the token |  [optional] |
