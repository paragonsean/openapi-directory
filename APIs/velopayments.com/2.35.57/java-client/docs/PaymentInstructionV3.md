...
|------------ | ------------- | ------------- | -------------|
|**amount** | **Long** | &lt;p&gt;Amount to send to Payee&lt;/p&gt; &lt;p&gt;The maximum payment amount is dependent on the currency&lt;/p&gt;  |  |
...
|**transmissionType** | [**TransmissionTypeEnum**](#TransmissionTypeEnum) | Optionally choose a specific transmission method for the payment |  [optional] |
