...
|**balance** | **Long** | Decimal implied |  [optional] |
...
|**deletedAt** | **OffsetDateTime** | An optional timestamp when the source account has been deleted. Only present in the response if deleted. |  [optional] |
|**fundingRef** | **String** | The funding reference (will not be set for DECOUPLED accounts). |  [optional] |
|**id** | **UUID** | Source Account Id |  |
|**name** | **String** |  |  [optional] |
|**notifications** | [**NotificationsV3**](NotificationsV3.md) |  |  [optional] |
|**payorId** | **UUID** |  |  [optional] |
|**physicalAccountId** | **UUID** | The physical account id (will not be set for DECOUPLED accounts). |  [optional] |
