...
public class PayoutPayor {
  ...
  public PayoutPayor dbaName(String dbaName) {
  ...
  public PayoutPayor payorId(UUID payorId) {
  ...
  public PayoutPayor payorName(String payorName) {
  ...
  public PayoutPayor principal(String principal) {
  ...
  public PayoutPayor principalId(UUID principalId) {
  ...
  public boolean equals(Object o) {
    ...
    PayoutPayor payoutPayor = (PayoutPayor) o;
    return Objects.equals(this.dbaName, payoutPayor.dbaName) &&
        Objects.equals(this.payorId, payoutPayor.payorId) &&
        Objects.equals(this.payorName, payoutPayor.payorName) &&
        Objects.equals(this.principal, payoutPayor.principal) &&
        Objects.equals(this.principalId, payoutPayor.principalId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dbaName, payorId, payorName, principal, principalId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayoutPayor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayoutPayor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayoutPayor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayoutPayor is not found in the empty JSON string", PayoutPayor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayoutPayor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayoutPayor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayoutPayor.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayoutPayor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayoutPayor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayoutPayor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayoutPayor.class));

       return (TypeAdapter<T>) new TypeAdapter<PayoutPayor>() {
           @Override
           public void write(JsonWriter out, PayoutPayor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayoutPayor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayoutPayor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayoutPayor
   * @throws IOException if the JSON string is invalid with respect to PayoutPayor
   */
  public static PayoutPayor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayoutPayor.class);
  }

  /**
   * Convert an instance of PayoutPayor to an JSON string
   *
   * @return JSON string
   */
