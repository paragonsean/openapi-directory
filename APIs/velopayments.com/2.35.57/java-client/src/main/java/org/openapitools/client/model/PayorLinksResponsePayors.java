...
public class PayorLinksResponsePayors {
  ...
  public PayorLinksResponsePayors() {
  }

  public PayorLinksResponsePayors kycState(String kycState) {
  ...
  public PayorLinksResponsePayors payorId(UUID payorId) {
  ...
  public PayorLinksResponsePayors payorName(String payorName) {
  ...
  public PayorLinksResponsePayors primaryContactEmail(String primaryContactEmail) {
  ...
  public boolean equals(Object o) {
    ...
    PayorLinksResponsePayors payorLinksResponsePayors = (PayorLinksResponsePayors) o;
    return Objects.equals(this.kycState, payorLinksResponsePayors.kycState) &&
        Objects.equals(this.payorId, payorLinksResponsePayors.payorId) &&
        Objects.equals(this.payorName, payorLinksResponsePayors.payorName) &&
        Objects.equals(this.primaryContactEmail, payorLinksResponsePayors.primaryContactEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kycState, payorId, payorName, primaryContactEmail);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayorLinksResponsePayors
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayorLinksResponsePayors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayorLinksResponsePayors is not found in the empty JSON string", PayorLinksResponsePayors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayorLinksResponsePayors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayorLinksResponsePayors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayorLinksResponsePayors.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayorLinksResponsePayors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayorLinksResponsePayors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayorLinksResponsePayors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayorLinksResponsePayors.class));

       return (TypeAdapter<T>) new TypeAdapter<PayorLinksResponsePayors>() {
           @Override
           public void write(JsonWriter out, PayorLinksResponsePayors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayorLinksResponsePayors read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayorLinksResponsePayors given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayorLinksResponsePayors
   * @throws IOException if the JSON string is invalid with respect to PayorLinksResponsePayors
   */
  public static PayorLinksResponsePayors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayorLinksResponsePayors.class);
  }

  /**
   * Convert an instance of PayorLinksResponsePayors to an JSON string
   *
   * @return JSON string
   */
