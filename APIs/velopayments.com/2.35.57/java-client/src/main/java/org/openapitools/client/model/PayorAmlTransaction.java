...
public class PayorAmlTransaction {
  ...
  public PayorAmlTransaction credit(Long credit) {
    this.credit = credit;
    return this;
  }
  ...
  public PayorAmlTransaction creditCurrency(String creditCurrency) {
  ...
  public PayorAmlTransaction dateFundingRequested(String dateFundingRequested) {
  ...
  public PayorAmlTransaction debit(Long debit) {
    this.debit = debit;
    return this;
  }
  ...
  public PayorAmlTransaction debitCurrency(String debitCurrency) {
  ...
  public PayorAmlTransaction fundingType(String fundingType) {
  ...
  public PayorAmlTransaction fxApplied(Double fxApplied) {
  ...
  public PayorAmlTransaction payeeEmail(String payeeEmail) {
  ...
  public PayorAmlTransaction payeeName(String payeeName) {
  ...
  public PayorAmlTransaction payeeType(String payeeType) {
  ...
  public PayorAmlTransaction paymentAmount(Long paymentAmount) {
  ...
  public PayorAmlTransaction paymentCurrency(String paymentCurrency) {
  ...
  public PayorAmlTransaction paymentMemo(String paymentMemo) {
  ...
  public PayorAmlTransaction paymentRails(String paymentRails) {
  ...
  public PayorAmlTransaction paymentStatus(String paymentStatus) {
  ...
  public PayorAmlTransaction payorPaymentId(String payorPaymentId) {
  ...
  public PayorAmlTransaction rejectReason(String rejectReason) {
  ...
  public PayorAmlTransaction remoteId(String remoteId) {
  ...
  public PayorAmlTransaction reportTransactionType(String reportTransactionType) {
  ...
  public PayorAmlTransaction returnCode(String returnCode) {
  ...
  public PayorAmlTransaction returnDescription(String returnDescription) {
  ...
  public PayorAmlTransaction returnFee(String returnFee) {
  ...
  public PayorAmlTransaction returnFeeCurrency(String returnFeeCurrency) {
  ...
  public PayorAmlTransaction returnFeeDescription(String returnFeeDescription) {
  ...
  public PayorAmlTransaction sourceAccount(String sourceAccount) {
  ...
  public PayorAmlTransaction transactionDate(LocalDate transactionDate) {
  ...
  public PayorAmlTransaction transactionTime(String transactionTime) {
  ...
  public boolean equals(Object o) {
    ...
    PayorAmlTransaction payorAmlTransaction = (PayorAmlTransaction) o;
    return Objects.equals(this.credit, payorAmlTransaction.credit) &&
        Objects.equals(this.creditCurrency, payorAmlTransaction.creditCurrency) &&
        Objects.equals(this.dateFundingRequested, payorAmlTransaction.dateFundingRequested) &&
        Objects.equals(this.debit, payorAmlTransaction.debit) &&
        Objects.equals(this.debitCurrency, payorAmlTransaction.debitCurrency) &&
        Objects.equals(this.fundingType, payorAmlTransaction.fundingType) &&
        Objects.equals(this.fxApplied, payorAmlTransaction.fxApplied) &&
        Objects.equals(this.payeeEmail, payorAmlTransaction.payeeEmail) &&
        Objects.equals(this.payeeName, payorAmlTransaction.payeeName) &&
        Objects.equals(this.payeeType, payorAmlTransaction.payeeType) &&
        Objects.equals(this.paymentAmount, payorAmlTransaction.paymentAmount) &&
        Objects.equals(this.paymentCurrency, payorAmlTransaction.paymentCurrency) &&
        Objects.equals(this.paymentMemo, payorAmlTransaction.paymentMemo) &&
        Objects.equals(this.paymentRails, payorAmlTransaction.paymentRails) &&
        Objects.equals(this.paymentStatus, payorAmlTransaction.paymentStatus) &&
        Objects.equals(this.payorPaymentId, payorAmlTransaction.payorPaymentId) &&
        Objects.equals(this.rejectReason, payorAmlTransaction.rejectReason) &&
        Objects.equals(this.remoteId, payorAmlTransaction.remoteId) &&
        Objects.equals(this.reportTransactionType, payorAmlTransaction.reportTransactionType) &&
        Objects.equals(this.returnCode, payorAmlTransaction.returnCode) &&
        Objects.equals(this.returnDescription, payorAmlTransaction.returnDescription) &&
        Objects.equals(this.returnFee, payorAmlTransaction.returnFee) &&
        Objects.equals(this.returnFeeCurrency, payorAmlTransaction.returnFeeCurrency) &&
        Objects.equals(this.returnFeeDescription, payorAmlTransaction.returnFeeDescription) &&
        Objects.equals(this.sourceAccount, payorAmlTransaction.sourceAccount) &&
        Objects.equals(this.transactionDate, payorAmlTransaction.transactionDate) &&
        Objects.equals(this.transactionTime, payorAmlTransaction.transactionTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credit, creditCurrency, dateFundingRequested, debit, debitCurrency, fundingType, fxApplied, payeeEmail, payeeName, payeeType, paymentAmount, paymentCurrency, paymentMemo, paymentRails, paymentStatus, payorPaymentId, rejectReason, remoteId, reportTransactionType, returnCode, returnDescription, returnFee, returnFeeCurrency, returnFeeDescription, sourceAccount, transactionDate, transactionTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayorAmlTransaction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayorAmlTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayorAmlTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayorAmlTransaction is not found in the empty JSON string", PayorAmlTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayorAmlTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayorAmlTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayorAmlTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayorAmlTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayorAmlTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayorAmlTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<PayorAmlTransaction>() {
           @Override
           public void write(JsonWriter out, PayorAmlTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayorAmlTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayorAmlTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayorAmlTransaction
   * @throws IOException if the JSON string is invalid with respect to PayorAmlTransaction
   */
  public static PayorAmlTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayorAmlTransaction.class);
  }

  /**
   * Convert an instance of PayorAmlTransaction to an JSON string
   *
   * @return JSON string
   */
