...
public class UserDetailsUpdateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, userDetailsUpdateRequest.email) &&
        ...
        Objects.equals(this.primaryContactNumber, userDetailsUpdateRequest.primaryContactNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, mfaType, primaryContactNumber, secondaryContactNumber, smsNumber, verificationCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserDetailsUpdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserDetailsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDetailsUpdateRequest is not found in the empty JSON string", UserDetailsUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserDetailsUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserDetailsUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `mfaType`
      if (jsonObj.get("mfaType") != null && !jsonObj.get("mfaType").isJsonNull()) {
        MFAType.validateJsonElement(jsonObj.get("mfaType"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDetailsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDetailsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDetailsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDetailsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDetailsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, UserDetailsUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDetailsUpdateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserDetailsUpdateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserDetailsUpdateRequest
   * @throws IOException if the JSON string is invalid with respect to UserDetailsUpdateRequest
   */
  public static UserDetailsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDetailsUpdateRequest.class);
  }

  /**
   * Convert an instance of UserDetailsUpdateRequest to an JSON string
   *
   * @return JSON string
   */
