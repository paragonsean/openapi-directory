...
public class PayeeEvent {
  ...
  public PayeeEvent createdAt(OffsetDateTime createdAt) {
  ...
  public PayeeEvent eventId(UUID eventId) {
  ...
  public PayeeEvent sourceType(String sourceType) {
  ...
  public PayeeEvent payeeId(UUID payeeId) {
  ...
  public PayeeEvent reasons(List<PayeeEventAllOfReasons> reasons) {
    this.reasons = reasons;
    return this;
  }

  public PayeeEvent addReasonsItem(PayeeEventAllOfReasons reasonsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PayeeEvent payeeEvent = (PayeeEvent) o;
    return Objects.equals(this.createdAt, payeeEvent.createdAt) &&
        Objects.equals(this.eventId, payeeEvent.eventId) &&
        Objects.equals(this.sourceType, payeeEvent.sourceType) &&
        Objects.equals(this.payeeId, payeeEvent.payeeId) &&
        Objects.equals(this.reasons, payeeEvent.reasons);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayeeEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayeeEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeeEvent is not found in the empty JSON string", PayeeEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayeeEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayeeEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeeEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeeEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeeEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeeEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeeEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeeEvent>() {
           @Override
           public void write(JsonWriter out, PayeeEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayeeEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayeeEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayeeEvent
   * @throws IOException if the JSON string is invalid with respect to PayeeEvent
   */
  public static PayeeEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeeEvent.class);
  }

  /**
   * Convert an instance of PayeeEvent to an JSON string
   *
   * @return JSON string
   */
