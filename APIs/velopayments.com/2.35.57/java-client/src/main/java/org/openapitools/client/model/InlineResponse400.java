...
public class InlineResponse400 {
  ...
  public InlineResponse400 correlationId(UUID correlationId) {
  ...
  public InlineResponse400 errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public InlineResponse400 addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public InlineResponse400 httpStatusCode(Integer httpStatusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.correlationId, inlineResponse400.correlationId) &&
        Objects.equals(this.errors, inlineResponse400.errors) &&
        Objects.equals(this.httpStatusCode, inlineResponse400.httpStatusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineResponse400
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineResponse400.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineResponse400.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineResponse400` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
