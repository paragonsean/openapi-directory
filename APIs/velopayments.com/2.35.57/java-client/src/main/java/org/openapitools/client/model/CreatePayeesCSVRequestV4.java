...
public class CreatePayeesCSVRequestV4 {
  ...
  public CreatePayeesCSVRequestV4 addressCity(String addressCity) {
  ...
  public CreatePayeesCSVRequestV4 addressCountry(String addressCountry) {
  ...
  public CreatePayeesCSVRequestV4 addressCountyOrProvince(String addressCountyOrProvince) {
  ...
  public CreatePayeesCSVRequestV4 addressLine1(String addressLine1) {
  ...
  public CreatePayeesCSVRequestV4 addressLine2(String addressLine2) {
  ...
  public CreatePayeesCSVRequestV4 addressLine3(String addressLine3) {
  ...
  public CreatePayeesCSVRequestV4 addressLine4(String addressLine4) {
  ...
  public CreatePayeesCSVRequestV4 addressZipOrPostcode(String addressZipOrPostcode) {
  ...
  public CreatePayeesCSVRequestV4 challengeDescription(String challengeDescription) {
  ...
  public CreatePayeesCSVRequestV4 challengeValue(String challengeValue) {
  ...
  public CreatePayeesCSVRequestV4 companyEIN(String companyEIN) {
  ...
  public CreatePayeesCSVRequestV4 companyName(String companyName) {
  ...
  public CreatePayeesCSVRequestV4 companyOperatingName(String companyOperatingName) {
  ...
  public CreatePayeesCSVRequestV4 email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreatePayeesCSVRequestV4 individualDateOfBirth(LocalDate individualDateOfBirth) {
  ...
  public CreatePayeesCSVRequestV4 individualFirstName(String individualFirstName) {
  ...
  public CreatePayeesCSVRequestV4 individualLastName(String individualLastName) {
  ...
  public CreatePayeesCSVRequestV4 individualNationalIdentification(String individualNationalIdentification) {
  ...
  public CreatePayeesCSVRequestV4 individualOtherNames(String individualOtherNames) {
  ...
  public CreatePayeesCSVRequestV4 individualTitle(String individualTitle) {
  ...
  public CreatePayeesCSVRequestV4 payeeLanguage(String payeeLanguage) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelAccountName(String paymentChannelAccountName) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelAccountNumber(String paymentChannelAccountNumber) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelCountryCode(String paymentChannelCountryCode) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelCurrency(String paymentChannelCurrency) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelIban(String paymentChannelIban) {
  ...
  public CreatePayeesCSVRequestV4 paymentChannelRoutingNumber(String paymentChannelRoutingNumber) {
  ...
  public CreatePayeesCSVRequestV4 remoteId(String remoteId) {
  ...
  public CreatePayeesCSVRequestV4 type(PayeeTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePayeesCSVRequestV4 createPayeesCSVRequestV4 = (CreatePayeesCSVRequestV4) o;
    return Objects.equals(this.addressCity, createPayeesCSVRequestV4.addressCity) &&
        Objects.equals(this.addressCountry, createPayeesCSVRequestV4.addressCountry) &&
        Objects.equals(this.addressCountyOrProvince, createPayeesCSVRequestV4.addressCountyOrProvince) &&
        Objects.equals(this.addressLine1, createPayeesCSVRequestV4.addressLine1) &&
        Objects.equals(this.addressLine2, createPayeesCSVRequestV4.addressLine2) &&
        Objects.equals(this.addressLine3, createPayeesCSVRequestV4.addressLine3) &&
        Objects.equals(this.addressLine4, createPayeesCSVRequestV4.addressLine4) &&
        Objects.equals(this.addressZipOrPostcode, createPayeesCSVRequestV4.addressZipOrPostcode) &&
        Objects.equals(this.challengeDescription, createPayeesCSVRequestV4.challengeDescription) &&
        Objects.equals(this.challengeValue, createPayeesCSVRequestV4.challengeValue) &&
        Objects.equals(this.companyEIN, createPayeesCSVRequestV4.companyEIN) &&
        Objects.equals(this.companyName, createPayeesCSVRequestV4.companyName) &&
        Objects.equals(this.companyOperatingName, createPayeesCSVRequestV4.companyOperatingName) &&
        Objects.equals(this.email, createPayeesCSVRequestV4.email) &&
        Objects.equals(this.individualDateOfBirth, createPayeesCSVRequestV4.individualDateOfBirth) &&
        Objects.equals(this.individualFirstName, createPayeesCSVRequestV4.individualFirstName) &&
        Objects.equals(this.individualLastName, createPayeesCSVRequestV4.individualLastName) &&
        Objects.equals(this.individualNationalIdentification, createPayeesCSVRequestV4.individualNationalIdentification) &&
        Objects.equals(this.individualOtherNames, createPayeesCSVRequestV4.individualOtherNames) &&
        Objects.equals(this.individualTitle, createPayeesCSVRequestV4.individualTitle) &&
        Objects.equals(this.payeeLanguage, createPayeesCSVRequestV4.payeeLanguage) &&
        Objects.equals(this.paymentChannelAccountName, createPayeesCSVRequestV4.paymentChannelAccountName) &&
        Objects.equals(this.paymentChannelAccountNumber, createPayeesCSVRequestV4.paymentChannelAccountNumber) &&
        Objects.equals(this.paymentChannelCountryCode, createPayeesCSVRequestV4.paymentChannelCountryCode) &&
        Objects.equals(this.paymentChannelCurrency, createPayeesCSVRequestV4.paymentChannelCurrency) &&
        Objects.equals(this.paymentChannelIban, createPayeesCSVRequestV4.paymentChannelIban) &&
        Objects.equals(this.paymentChannelRoutingNumber, createPayeesCSVRequestV4.paymentChannelRoutingNumber) &&
        Objects.equals(this.remoteId, createPayeesCSVRequestV4.remoteId) &&
        Objects.equals(this.type, createPayeesCSVRequestV4.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePayeesCSVRequestV4 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePayeesCSVRequestV4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePayeesCSVRequestV4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePayeesCSVRequestV4 is not found in the empty JSON string", CreatePayeesCSVRequestV4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePayeesCSVRequestV4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePayeesCSVRequestV4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePayeesCSVRequestV4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePayeesCSVRequestV4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePayeesCSVRequestV4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePayeesCSVRequestV4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePayeesCSVRequestV4.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePayeesCSVRequestV4>() {
           @Override
           public void write(JsonWriter out, CreatePayeesCSVRequestV4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePayeesCSVRequestV4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePayeesCSVRequestV4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePayeesCSVRequestV4
   * @throws IOException if the JSON string is invalid with respect to CreatePayeesCSVRequestV4
   */
  public static CreatePayeesCSVRequestV4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePayeesCSVRequestV4.class);
  }

  /**
   * Convert an instance of CreatePayeesCSVRequestV4 to an JSON string
   *
   * @return JSON string
   */
