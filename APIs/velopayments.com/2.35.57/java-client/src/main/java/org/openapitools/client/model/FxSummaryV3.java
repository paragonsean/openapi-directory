...
public class FxSummaryV3 {
  ...
  public FxSummaryV3 fundingStatus(String fundingStatus) {
  ...
  public FxSummaryV3 paymentCurrency(String paymentCurrency) {
  ...
  public FxSummaryV3 sourceCurrency(String sourceCurrency) {
  ...
  public FxSummaryV3 status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationDateTime, fxSummaryV3.creationDateTime) &&
        Objects.equals(this.fundingStatus, fxSummaryV3.fundingStatus) &&
        Objects.equals(this.invertedRate, fxSummaryV3.invertedRate) &&
        Objects.equals(this.paymentCurrency, fxSummaryV3.paymentCurrency) &&
        Objects.equals(this.quoteId, fxSummaryV3.quoteId) &&
        Objects.equals(this.rate, fxSummaryV3.rate) &&
        Objects.equals(this.sourceCurrency, fxSummaryV3.sourceCurrency) &&
        Objects.equals(this.status, fxSummaryV3.status) &&
        Objects.equals(this.totalCost, fxSummaryV3.totalCost) &&
        Objects.equals(this.totalPaymentAmount, fxSummaryV3.totalPaymentAmount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FxSummaryV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FxSummaryV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FxSummaryV3 is not found in the empty JSON string", FxSummaryV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FxSummaryV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FxSummaryV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FxSummaryV3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FxSummaryV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FxSummaryV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FxSummaryV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FxSummaryV3.class));

       return (TypeAdapter<T>) new TypeAdapter<FxSummaryV3>() {
           @Override
           public void write(JsonWriter out, FxSummaryV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FxSummaryV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FxSummaryV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FxSummaryV3
   * @throws IOException if the JSON string is invalid with respect to FxSummaryV3
   */
  public static FxSummaryV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FxSummaryV3.class);
  }

  /**
   * Convert an instance of FxSummaryV3 to an JSON string
   *
   * @return JSON string
   */
