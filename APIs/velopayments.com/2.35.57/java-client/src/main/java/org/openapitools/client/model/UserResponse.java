...
public class UserResponse {
  ...
  public static final String SERIALIZED_NAME_LOCKED_OUT_TIMESTAMP = "lockedOutTimestamp";
  @SerializedName(SERIALIZED_NAME_LOCKED_OUT_TIMESTAMP)
  private OffsetDateTime lockedOutTimestamp;
  ...
  public enum MfaStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<MfaStatusEnum> {
      ...
      public MfaStatusEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return MfaStatusEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      MfaStatusEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_MFA_STATUS = "mfaStatus";
  @SerializedName(SERIALIZED_NAME_MFA_STATUS)
  ...
  public UserResponse companyName(String companyName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.companyName, userResponse.companyName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyName, email, entityId, firstName, id, lastName, lockedOut, lockedOutTimestamp, mfaStatus, mfaType, primaryContactNumber, roles, secondaryContactNumber, smsNumber, status, userType);
  }
  ...
  static {
    ...
    openapiFields.add("lockedOut");
    openapiFields.add("lockedOutTimestamp");
    openapiFields.add("mfaStatus");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("mfaStatus") != null && !jsonObj.get("mfaStatus").isJsonNull()) && !jsonObj.get("mfaStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `mfaStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mfaStatus").toString()));
      }
      // validate the optional field `mfaStatus`
      if (jsonObj.get("mfaStatus") != null && !jsonObj.get("mfaStatus").isJsonNull()) {
        MfaStatusEnum.validateJsonElement(jsonObj.get("mfaStatus"));
      }
