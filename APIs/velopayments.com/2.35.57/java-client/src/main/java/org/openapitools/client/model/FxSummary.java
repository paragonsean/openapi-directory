...
public class FxSummary {
  ...
  public FxSummary creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public FxSummary fundingStatus(String fundingStatus) {
  ...
  public FxSummary invertedRate(Double invertedRate) {
  ...
  public FxSummary paymentCurrency(String paymentCurrency) {
  ...
  public FxSummary quoteId(UUID quoteId) {
  ...
  public FxSummary rate(Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public FxSummary sourceCurrency(String sourceCurrency) {
  ...
  public FxSummary status(String status) {
    this.status = status;
    return this;
  }
  ...
  public FxSummary totalCost(Integer totalCost) {
  ...
  public FxSummary totalPaymentAmount(Integer totalPaymentAmount) {
  ...
  public boolean equals(Object o) {
    ...
    FxSummary fxSummary = (FxSummary) o;
    return Objects.equals(this.creationDateTime, fxSummary.creationDateTime) &&
        Objects.equals(this.fundingStatus, fxSummary.fundingStatus) &&
        Objects.equals(this.invertedRate, fxSummary.invertedRate) &&
        Objects.equals(this.paymentCurrency, fxSummary.paymentCurrency) &&
        Objects.equals(this.quoteId, fxSummary.quoteId) &&
        Objects.equals(this.rate, fxSummary.rate) &&
        Objects.equals(this.sourceCurrency, fxSummary.sourceCurrency) &&
        Objects.equals(this.status, fxSummary.status) &&
        Objects.equals(this.totalCost, fxSummary.totalCost) &&
        Objects.equals(this.totalPaymentAmount, fxSummary.totalPaymentAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationDateTime, fundingStatus, invertedRate, paymentCurrency, quoteId, rate, sourceCurrency, status, totalCost, totalPaymentAmount);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("invertedRate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FxSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FxSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FxSummary is not found in the empty JSON string", FxSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FxSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FxSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FxSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FxSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FxSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FxSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FxSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<FxSummary>() {
           @Override
           public void write(JsonWriter out, FxSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FxSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FxSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FxSummary
   * @throws IOException if the JSON string is invalid with respect to FxSummary
   */
  public static FxSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FxSummary.class);
  }

  /**
   * Convert an instance of FxSummary to an JSON string
   *
   * @return JSON string
   */
