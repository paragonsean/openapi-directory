...
public class PingResponse {
  ...
  public PingResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public PingResponse webhookId(UUID webhookId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, pingResponse.id) &&
        Objects.equals(this.webhookId, pingResponse.webhookId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, webhookId);
  }
