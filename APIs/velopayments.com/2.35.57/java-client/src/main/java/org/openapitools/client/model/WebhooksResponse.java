...
public class WebhooksResponse {
  ...
  private List<WebhookResponse> content = new ArrayList<>();
  ...
  public WebhooksResponse content(List<WebhookResponse> content) {
    this.content = content;
    return this;
  }

  public WebhooksResponse addContentItem(WebhookResponse contentItem) {
  ...
  public WebhooksResponse links(List<PagedPayeeResponseV3Links> links) {
    this.links = links;
    return this;
  }

  public WebhooksResponse addLinksItem(PagedPayeeResponseV3Links linksItem) {
    if (this.links == null) {
  ...
  public WebhooksResponse page(PagedPayeeInvitationStatusResponseV3Page page) {
    this.page = page;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, webhooksResponse.content) &&
        Objects.equals(this.links, webhooksResponse.links) &&
        Objects.equals(this.page, webhooksResponse.page);
  }
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            WebhookResponse.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
