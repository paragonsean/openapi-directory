...
public class PaymentDelta {
  ...
  public PaymentDelta paymentAmount(Integer paymentAmount) {
  ...
  public PaymentDelta paymentCurrency(String paymentCurrency) {
  ...
  public PaymentDelta payorPaymentId(String payorPaymentId) {
  ...
  public PaymentDelta sourceAmount(Integer sourceAmount) {
  ...
  public PaymentDelta sourceCurrency(String sourceCurrency) {
  ...
  public PaymentDelta status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentDelta paymentDelta = (PaymentDelta) o;
    return Objects.equals(this.paymentAmount, paymentDelta.paymentAmount) &&
        Objects.equals(this.paymentCurrency, paymentDelta.paymentCurrency) &&
        Objects.equals(this.paymentId, paymentDelta.paymentId) &&
        Objects.equals(this.payorPaymentId, paymentDelta.payorPaymentId) &&
        Objects.equals(this.payoutId, paymentDelta.payoutId) &&
        Objects.equals(this.sourceAmount, paymentDelta.sourceAmount) &&
        Objects.equals(this.sourceCurrency, paymentDelta.sourceCurrency) &&
        Objects.equals(this.status, paymentDelta.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentDelta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentDelta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentDelta is not found in the empty JSON string", PaymentDelta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentDelta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentDelta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentDelta.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentDelta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentDelta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentDelta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentDelta.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentDelta>() {
           @Override
           public void write(JsonWriter out, PaymentDelta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentDelta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentDelta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentDelta
   * @throws IOException if the JSON string is invalid with respect to PaymentDelta
   */
  public static PaymentDelta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentDelta.class);
  }

  /**
   * Convert an instance of PaymentDelta to an JSON string
   *
   * @return JSON string
   */
