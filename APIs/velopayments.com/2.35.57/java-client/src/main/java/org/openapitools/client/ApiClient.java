...
public class ApiClient {
    ...
    private String basePath = "https://api.sandbox.velopayments.com";
    ...
    public ApiClient() {
        ...
        authentications.put("oAuthVeloBackOffice", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.sandbox.velopayments.com/v1/login";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.35.57/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sandbox.velopayments.com
