...
import org.openapitools.client.model.MFADetails;
import org.openapitools.client.model.UserType2;
...
public class UserInfo {
  public static final String SERIALIZED_NAME_MFA_DETAILS = "mfa_details";
  @SerializedName(SERIALIZED_NAME_MFA_DETAILS)
  private MFADetails mfaDetails;

  public static final String SERIALIZED_NAME_USER_TYPE = "userType";
  @SerializedName(SERIALIZED_NAME_USER_TYPE)
  private UserType2 userType;
  ...
  public UserInfo mfaDetails(MFADetails mfaDetails) {
  ...
  public MFADetails getMfaDetails() {
    return mfaDetails;
  }

  public void setMfaDetails(MFADetails mfaDetails) {
    this.mfaDetails = mfaDetails;
  }


  public UserInfo userType(UserType2 userType) {
   ...
   */
  @javax.annotation.Nullable
  public UserType2 getUserType() {
    return userType;
  }

  public void setUserType(UserType2 userType) {
    this.userType = userType;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mfaDetails, userInfo.mfaDetails) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mfaDetails, userType, userId);
  }
  ...
  public String toString() {
    ...
    sb.append("    mfaDetails: ").append(toIndentedString(mfaDetails)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `mfa_details`
      if (jsonObj.get("mfa_details") != null && !jsonObj.get("mfa_details").isJsonNull()) {
        MFADetails.validateJsonElement(jsonObj.get("mfa_details"));
      }
      // validate the optional field `userType`
      if (jsonObj.get("userType") != null && !jsonObj.get("userType").isJsonNull()) {
        UserType2.validateJsonElement(jsonObj.get("userType"));
      }
