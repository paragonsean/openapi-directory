...
public class PaymentInstructionV3 {
  ...
  public PaymentInstructionV3() {
  }

  public PaymentInstructionV3 amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public PaymentInstructionV3 currency(String currency) {
  ...
  public PaymentInstructionV3 paymentMemo(String paymentMemo) {
  ...
  public PaymentInstructionV3 paymentMetadata(String paymentMetadata) {
  ...
  public PaymentInstructionV3 payorPaymentId(String payorPaymentId) {
  ...
  public PaymentInstructionV3 remoteId(String remoteId) {
  ...
  public PaymentInstructionV3 remoteSystemId(String remoteSystemId) {
  ...
  public PaymentInstructionV3 sourceAccountName(String sourceAccountName) {
  ...
  public PaymentInstructionV3 transmissionType(TransmissionTypeEnum transmissionType) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentInstructionV3 paymentInstructionV3 = (PaymentInstructionV3) o;
    return Objects.equals(this.amount, paymentInstructionV3.amount) &&
        Objects.equals(this.currency, paymentInstructionV3.currency) &&
        Objects.equals(this.paymentMemo, paymentInstructionV3.paymentMemo) &&
        Objects.equals(this.paymentMetadata, paymentInstructionV3.paymentMetadata) &&
        Objects.equals(this.payorPaymentId, paymentInstructionV3.payorPaymentId) &&
        Objects.equals(this.remoteId, paymentInstructionV3.remoteId) &&
        Objects.equals(this.remoteSystemId, paymentInstructionV3.remoteSystemId) &&
        Objects.equals(this.sourceAccountName, paymentInstructionV3.sourceAccountName) &&
        Objects.equals(this.transmissionType, paymentInstructionV3.transmissionType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, paymentMemo, paymentMetadata, payorPaymentId, remoteId, remoteSystemId, sourceAccountName, transmissionType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentInstructionV3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentInstructionV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentInstructionV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentInstructionV3 is not found in the empty JSON string", PaymentInstructionV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentInstructionV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentInstructionV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentInstructionV3.openapiRequiredFields) {
      ...
      if (jsonObj.get("transmissionType") != null && !jsonObj.get("transmissionType").isJsonNull()) {
        TransmissionTypeEnum.validateJsonElement(jsonObj.get("transmissionType"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentInstructionV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentInstructionV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentInstructionV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentInstructionV3.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentInstructionV3>() {
           @Override
           public void write(JsonWriter out, PaymentInstructionV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentInstructionV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentInstructionV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentInstructionV3
   * @throws IOException if the JSON string is invalid with respect to PaymentInstructionV3
   */
  public static PaymentInstructionV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentInstructionV3.class);
  }

  /**
   * Convert an instance of PaymentInstructionV3 to an JSON string
   *
   * @return JSON string
   */
