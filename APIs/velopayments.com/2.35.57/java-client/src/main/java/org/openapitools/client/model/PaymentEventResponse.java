...
public class PaymentEventResponse {
  ...
  public PaymentEventResponse accountName(String accountName) {
  ...
  public PaymentEventResponse accountNumber(String accountNumber) {
  ...
  public PaymentEventResponse eventDateTime(OffsetDateTime eventDateTime) {
  ...
  public PaymentEventResponse eventId(UUID eventId) {
  ...
  public PaymentEventResponse eventType(String eventType) {
  ...
  public PaymentEventResponse iban(String iban) {
    this.iban = iban;
    return this;
  }
  ...
  public PaymentEventResponse paymentAmount(Long paymentAmount) {
  ...
  public PaymentEventResponse paymentCurrency(String paymentCurrency) {
  ...
  public PaymentEventResponse principal(String principal) {
  ...
  public PaymentEventResponse routingNumber(String routingNumber) {
  ...
  public PaymentEventResponse scheduledAt(OffsetDateTime scheduledAt) {
  ...
  public PaymentEventResponse scheduledBy(String scheduledBy) {
  ...
  public PaymentEventResponse scheduledFor(OffsetDateTime scheduledFor) {
  ...
  public PaymentEventResponse sourceAmount(Long sourceAmount) {
  ...
  public PaymentEventResponse sourceCurrency(String sourceCurrency) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentEventResponse paymentEventResponse = (PaymentEventResponse) o;
    return Objects.equals(this.accountName, paymentEventResponse.accountName) &&
        Objects.equals(this.accountNumber, paymentEventResponse.accountNumber) &&
        Objects.equals(this.eventDateTime, paymentEventResponse.eventDateTime) &&
        Objects.equals(this.eventId, paymentEventResponse.eventId) &&
        Objects.equals(this.eventType, paymentEventResponse.eventType) &&
        Objects.equals(this.iban, paymentEventResponse.iban) &&
        Objects.equals(this.paymentAmount, paymentEventResponse.paymentAmount) &&
        Objects.equals(this.paymentCurrency, paymentEventResponse.paymentCurrency) &&
        Objects.equals(this.principal, paymentEventResponse.principal) &&
        Objects.equals(this.routingNumber, paymentEventResponse.routingNumber) &&
        Objects.equals(this.scheduledAt, paymentEventResponse.scheduledAt) &&
        Objects.equals(this.scheduledBy, paymentEventResponse.scheduledBy) &&
        Objects.equals(this.scheduledFor, paymentEventResponse.scheduledFor) &&
        Objects.equals(this.sourceAmount, paymentEventResponse.sourceAmount) &&
        Objects.equals(this.sourceCurrency, paymentEventResponse.sourceCurrency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountName, accountNumber, eventDateTime, eventId, eventType, iban, paymentAmount, paymentCurrency, principal, routingNumber, scheduledAt, scheduledBy, scheduledFor, sourceAmount, sourceCurrency);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentEventResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentEventResponse is not found in the empty JSON string", PaymentEventResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentEventResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentEventResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentEventResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentEventResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentEventResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentEventResponse>() {
           @Override
           public void write(JsonWriter out, PaymentEventResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentEventResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentEventResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentEventResponse
   * @throws IOException if the JSON string is invalid with respect to PaymentEventResponse
   */
  public static PaymentEventResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentEventResponse.class);
  }

  /**
   * Convert an instance of PaymentEventResponse to an JSON string
   *
   * @return JSON string
   */
