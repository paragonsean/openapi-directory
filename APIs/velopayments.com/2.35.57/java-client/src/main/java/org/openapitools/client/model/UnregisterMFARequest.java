...
public class UnregisterMFARequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mfaType, unregisterMFARequest.mfaType) &&
        Objects.equals(this.verificationCode, unregisterMFARequest.verificationCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mfaType, verificationCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnregisterMFARequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnregisterMFARequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnregisterMFARequest is not found in the empty JSON string", UnregisterMFARequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnregisterMFARequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnregisterMFARequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnregisterMFARequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnregisterMFARequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnregisterMFARequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnregisterMFARequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnregisterMFARequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UnregisterMFARequest>() {
           @Override
           public void write(JsonWriter out, UnregisterMFARequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnregisterMFARequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnregisterMFARequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnregisterMFARequest
   * @throws IOException if the JSON string is invalid with respect to UnregisterMFARequest
   */
  public static UnregisterMFARequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnregisterMFARequest.class);
  }

  /**
   * Convert an instance of UnregisterMFARequest to an JSON string
   *
   * @return JSON string
   */
