...
public class ResendTokenRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tokenType, resendTokenRequest.tokenType) &&
        Objects.equals(this.verificationCode, resendTokenRequest.verificationCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tokenType, verificationCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResendTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResendTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResendTokenRequest is not found in the empty JSON string", ResendTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResendTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResendTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResendTokenRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResendTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResendTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResendTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResendTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResendTokenRequest>() {
           @Override
           public void write(JsonWriter out, ResendTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResendTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResendTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResendTokenRequest
   * @throws IOException if the JSON string is invalid with respect to ResendTokenRequest
   */
  public static ResendTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResendTokenRequest.class);
  }

  /**
   * Convert an instance of ResendTokenRequest to an JSON string
   *
   * @return JSON string
   */
