...
/**
 * API tests for PayorHierarchyApi
 */
@Disabled
public class PayorHierarchyApiTest {

    private final PayorHierarchyApi api = new PayorHierarchyApi();
     ...
     */
    @Test
    public void payorLinksV1Test() throws ApiException {
        UUID descendantsOfPayor = null;
        UUID parentOfPayor = null;
        String fields = null;
        PayorLinksResponse response = api.payorLinksV1(descendantsOfPayor, parentOfPayor, fields);
