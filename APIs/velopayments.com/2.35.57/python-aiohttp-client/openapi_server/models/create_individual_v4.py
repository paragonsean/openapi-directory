...
class CreateIndividualV4(Model):
    ...
    def __init__(self, date_of_birth: date=None, name: CreateIndividualV3Name=None, national_identification: str=None):
        """CreateIndividualV4 - a model defined in OpenAPI

        :param date_of_birth: The date_of_birth of this CreateIndividualV4.
        :param name: The name of this CreateIndividualV4.
        :param national_identification: The national_identification of this CreateIndividualV4.
        """
        self.openapi_types = {
            'date_of_birth': date,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateIndividualV4':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateIndividualV4 of this CreateIndividualV4.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def date_of_birth(self):
        """Gets the date_of_birth of this CreateIndividualV4.

        Must not be date in future. Example - 1970-05-20

        :return: The date_of_birth of this CreateIndividualV4.
        :rtype: date
        """
    ...
    def date_of_birth(self, date_of_birth):
        """Sets the date_of_birth of this CreateIndividualV4.
    ...
    @property
    def name(self):
        """Gets the name of this CreateIndividualV4.


        :return: The name of this CreateIndividualV4.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateIndividualV4.
    ...
    def national_identification(self):
        """Gets the national_identification of this CreateIndividualV4.


        :return: The national_identification of this CreateIndividualV4.
        :rtype: str
        """
    ...
    def national_identification(self, national_identification):
        """Sets the national_identification of this CreateIndividualV4.
