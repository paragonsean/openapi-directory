...
class InlineResponse401(Model):
    ...
    def __init__(self, correlation_id: str=None, errors: List[Error]=None, http_status_code: int=None):
        ...
        :param errors: The errors of this InlineResponse401.
        :param http_status_code: The http_status_code of this InlineResponse401.
        """
        self.openapi_types = {
            'correlation_id': str,
            'errors': List[Error],
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InlineResponse401':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The inline_response_401 of this InlineResponse401.
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this InlineResponse401.

        one or more errors

        :return: The errors of this InlineResponse401.
        :rtype: List[Error]
        """
        return self._errors
    ...
    def http_status_code(self, http_status_code):
        """Sets the http_status_code of this InlineResponse401.
