...
class CreatePaymentChannelV4(Model):
    ...
    def __init__(self, account_name: str=None, account_number: str=None, country_code: str=None, currency: str=None, iban: str=None, payment_channel_name: str=None, routing_number: str=None):
        """CreatePaymentChannelV4 - a model defined in OpenAPI

        :param account_name: The account_name of this CreatePaymentChannelV4.
        :param account_number: The account_number of this CreatePaymentChannelV4.
        :param country_code: The country_code of this CreatePaymentChannelV4.
        :param currency: The currency of this CreatePaymentChannelV4.
        :param iban: The iban of this CreatePaymentChannelV4.
        :param payment_channel_name: The payment_channel_name of this CreatePaymentChannelV4.
        :param routing_number: The routing_number of this CreatePaymentChannelV4.
        """
        self.openapi_types = {
            'account_name': str,
            'account_number': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreatePaymentChannelV4':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreatePaymentChannelV4 of this CreatePaymentChannelV4.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_name(self):
        """Gets the account_name of this CreatePaymentChannelV4.


        :return: The account_name of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def account_name(self, account_name):
        """Sets the account_name of this CreatePaymentChannelV4.
    ...
    def account_number(self):
        """Gets the account_number of this CreatePaymentChannelV4.

        Either routing number and account number or only iban must be set

        :return: The account_number of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """Sets the account_number of this CreatePaymentChannelV4.
    ...
    def country_code(self):
        """Gets the country_code of this CreatePaymentChannelV4.
        ...
        :return: The country_code of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this CreatePaymentChannelV4.
    ...
    @property
    def currency(self):
        """Gets the currency of this CreatePaymentChannelV4.

        Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.

        :return: The currency of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this CreatePaymentChannelV4.
    ...
    @property
    def iban(self):
        """Gets the iban of this CreatePaymentChannelV4.

        Must match the regular expression ```^[A-Za-z0-9]+$```.

        :return: The iban of this CreatePaymentChannelV4.
        :rtype: str
        """
        return self._iban
    ...
    @iban.setter
    def iban(self, iban):
        """Sets the iban of this CreatePaymentChannelV4.
    ...
    def payment_channel_name(self):
        """Gets the payment_channel_name of this CreatePaymentChannelV4.


        :return: The payment_channel_name of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def payment_channel_name(self, payment_channel_name):
        """Sets the payment_channel_name of this CreatePaymentChannelV4.
    ...
    def routing_number(self):
        """Gets the routing_number of this CreatePaymentChannelV4.

        Either routing number and account number or only iban must be set

        :return: The routing_number of this CreatePaymentChannelV4.
        :rtype: str
        """
    ...
    def routing_number(self, routing_number):
        """Sets the routing_number of this CreatePaymentChannelV4.
