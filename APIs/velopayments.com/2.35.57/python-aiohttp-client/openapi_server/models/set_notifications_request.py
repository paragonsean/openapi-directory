...
class SetNotificationsRequest(Model):
    ...
    def __init__(self, minimum_balance: int=None):
        """SetNotificationsRequest - a model defined in OpenAPI

        :param minimum_balance: The minimum_balance of this SetNotificationsRequest.
        """
        self.openapi_types = {
            'minimum_balance': int
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SetNotificationsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SetNotificationsRequest of this SetNotificationsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def minimum_balance(self):
        """Gets the minimum_balance of this SetNotificationsRequest.

        Amount to set as minimum balance in minor units

        :return: The minimum_balance of this SetNotificationsRequest.
        :rtype: int
        """
    ...
    def minimum_balance(self, minimum_balance):
        """Sets the minimum_balance of this SetNotificationsRequest.
