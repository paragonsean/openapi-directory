...
class TransferRequestV3(Model):
    ...
    def __init__(self, amount: int=None, currency: str=None, to_source_account_id: str=None):
        """TransferRequestV3 - a model defined in OpenAPI

        :param amount: The amount of this TransferRequestV3.
        :param currency: The currency of this TransferRequestV3.
        :param to_source_account_id: The to_source_account_id of this TransferRequestV3.
        """
        self.openapi_types = {
            'amount': int,
            'currency': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransferRequestV3':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransferRequestV3 of this TransferRequestV3.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def amount(self):
        """Gets the amount of this TransferRequestV3.

        Amount to transfer, in minor units

        :return: The amount of this TransferRequestV3.
        :rtype: int
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this TransferRequestV3.
    ...
    @property
    def currency(self):
        """Gets the currency of this TransferRequestV3.

        Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.

        :return: The currency of this TransferRequestV3.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this TransferRequestV3.
    ...
    def to_source_account_id(self):
        """Gets the to_source_account_id of this TransferRequestV3.

        The 'to' source account id, which will be credited

        :return: The to_source_account_id of this TransferRequestV3.
        :rtype: str
        """
    ...
    def to_source_account_id(self, to_source_account_id):
        """Sets the to_source_account_id of this TransferRequestV3.
