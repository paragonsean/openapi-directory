...
|------------ | ------------- | ------------- | -------------|
|**data** | [**ContactData**](ContactData.md) | &#x60;data&#x60; property allows you to specify personal information stored as electronic business card in the QR Code. The number and type of supported properties may depend on the QR Code reader software support. |  |
