...
public class CellPhone extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CellPhone.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CellPhone.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CellPhone' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CellPhone>() {
                @Override
                public void write(JsonWriter out, CellPhone value) throws IOException {
                ...
                @Override
                public CellPhone read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for CellPhone: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CellPhone
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CellPhone with anyOf schemas: List<String>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CellPhone given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CellPhone
     * @throws IOException if the JSON string is invalid with respect to CellPhone
     */
    public static CellPhone fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CellPhone.class);
    }

    /**
     * Convert an instance of CellPhone to an JSON string
     *
     * @return JSON string
     */
