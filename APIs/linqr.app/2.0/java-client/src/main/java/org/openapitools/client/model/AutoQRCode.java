...
public class AutoQRCode {
  ...
  public AutoQRCode data(AutoData data) {
    this.data = data;
    return this;
  }
  ...
  public AutoQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public AutoQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public AutoQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public AutoQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AutoQRCode autoQRCode = (AutoQRCode) o;
    return Objects.equals(this.data, autoQRCode.data) &&
        Objects.equals(this.image, autoQRCode.image) &&
        Objects.equals(this.output, autoQRCode.output) &&
        Objects.equals(this.size, autoQRCode.size) &&
        Objects.equals(this.style, autoQRCode.style);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoQRCode is not found in the empty JSON string", AutoQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AutoQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoQRCode>() {
           @Override
           public void write(JsonWriter out, AutoQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoQRCode
   * @throws IOException if the JSON string is invalid with respect to AutoQRCode
   */
  public static AutoQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoQRCode.class);
  }

  /**
   * Convert an instance of AutoQRCode to an JSON string
   *
   * @return JSON string
   */
