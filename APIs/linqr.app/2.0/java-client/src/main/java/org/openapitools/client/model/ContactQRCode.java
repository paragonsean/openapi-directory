...
public class ContactQRCode {
  ...
  public ContactQRCode() {
  }

  public ContactQRCode data(ContactData data) {
    this.data = data;
    return this;
  }
  ...
  public ContactQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public ContactQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public ContactQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public ContactQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContactQRCode contactQRCode = (ContactQRCode) o;
    return Objects.equals(this.data, contactQRCode.data) &&
        Objects.equals(this.image, contactQRCode.image) &&
        Objects.equals(this.output, contactQRCode.output) &&
        Objects.equals(this.size, contactQRCode.size) &&
        Objects.equals(this.style, contactQRCode.style);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactQRCode is not found in the empty JSON string", ContactQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactQRCode>() {
           @Override
           public void write(JsonWriter out, ContactQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactQRCode
   * @throws IOException if the JSON string is invalid with respect to ContactQRCode
   */
  public static ContactQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactQRCode.class);
  }

  /**
   * Convert an instance of ContactQRCode to an JSON string
   *
   * @return JSON string
   */
