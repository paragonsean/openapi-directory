...
public class EmailQRCode {
  ...
  public EmailQRCode data(EmailData data) {
    this.data = data;
    return this;
  }
  ...
  public EmailQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public EmailQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public EmailQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public EmailQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailQRCode emailQRCode = (EmailQRCode) o;
    return Objects.equals(this.data, emailQRCode.data) &&
        Objects.equals(this.image, emailQRCode.image) &&
        Objects.equals(this.output, emailQRCode.output) &&
        Objects.equals(this.size, emailQRCode.size) &&
        Objects.equals(this.style, emailQRCode.style);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailQRCode is not found in the empty JSON string", EmailQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailQRCode>() {
           @Override
           public void write(JsonWriter out, EmailQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailQRCode
   * @throws IOException if the JSON string is invalid with respect to EmailQRCode
   */
  public static EmailQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailQRCode.class);
  }

  /**
   * Convert an instance of EmailQRCode to an JSON string
   *
   * @return JSON string
   */
