...
public class SMSQRCode {
  ...
  public SMSQRCode data(SMSData data) {
    this.data = data;
    return this;
  }
  ...
  public SMSQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public SMSQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public SMSQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public SMSQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SMSQRCode smSQRCode = (SMSQRCode) o;
    return Objects.equals(this.data, smSQRCode.data) &&
        Objects.equals(this.image, smSQRCode.image) &&
        Objects.equals(this.output, smSQRCode.output) &&
        Objects.equals(this.size, smSQRCode.size) &&
        Objects.equals(this.style, smSQRCode.style);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SMSQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SMSQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SMSQRCode is not found in the empty JSON string", SMSQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SMSQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SMSQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SMSQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SMSQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SMSQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SMSQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SMSQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<SMSQRCode>() {
           @Override
           public void write(JsonWriter out, SMSQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SMSQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SMSQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SMSQRCode
   * @throws IOException if the JSON string is invalid with respect to SMSQRCode
   */
  public static SMSQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SMSQRCode.class);
  }

  /**
   * Convert an instance of SMSQRCode to an JSON string
   *
   * @return JSON string
   */
