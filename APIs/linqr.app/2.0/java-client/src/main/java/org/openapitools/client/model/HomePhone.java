...
public class HomePhone extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(HomePhone.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!HomePhone.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'HomePhone' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<HomePhone>() {
                @Override
                public void write(JsonWriter out, HomePhone value) throws IOException {
                ...
                @Override
                public HomePhone read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for HomePhone: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to HomePhone
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for HomePhone with anyOf schemas: List<String>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of HomePhone given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of HomePhone
     * @throws IOException if the JSON string is invalid with respect to HomePhone
     */
    public static HomePhone fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, HomePhone.class);
    }

    /**
     * Convert an instance of HomePhone to an JSON string
     *
     * @return JSON string
     */
