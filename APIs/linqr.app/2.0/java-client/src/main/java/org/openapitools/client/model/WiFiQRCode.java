...
public class WiFiQRCode {
  ...
  public WiFiQRCode data(WiFiData data) {
    this.data = data;
    return this;
  }
  ...
  public WiFiQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public WiFiQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public WiFiQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public WiFiQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WiFiQRCode wiFiQRCode = (WiFiQRCode) o;
    return Objects.equals(this.data, wiFiQRCode.data) &&
        Objects.equals(this.image, wiFiQRCode.image) &&
        Objects.equals(this.output, wiFiQRCode.output) &&
        Objects.equals(this.size, wiFiQRCode.size) &&
        Objects.equals(this.style, wiFiQRCode.style);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WiFiQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WiFiQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WiFiQRCode is not found in the empty JSON string", WiFiQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WiFiQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WiFiQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WiFiQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WiFiQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WiFiQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WiFiQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WiFiQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<WiFiQRCode>() {
           @Override
           public void write(JsonWriter out, WiFiQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WiFiQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WiFiQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WiFiQRCode
   * @throws IOException if the JSON string is invalid with respect to WiFiQRCode
   */
  public static WiFiQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WiFiQRCode.class);
  }

  /**
   * Convert an instance of WiFiQRCode to an JSON string
   *
   * @return JSON string
   */
