...
public class ApiClient {
    ...
    private String basePath = "https://run.byvalue.org";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://run.byvalue.org",
      "Byvalue proxy",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://qrcode3.p.rapidapi.com",
      "RapidAPI proxy",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    public ApiClient() {
        ...
        authentications.put("Byvalue", new ApiKeyAuth("header", "Byvalue-Token"));
        authentications.put("RapidAPI", new ApiKeyAuth("header", "X-RapidAPI-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://run.byvalue.org
