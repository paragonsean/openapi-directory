...
public class ContactQRCodeMetadata {
  ...
  public ContactQRCodeMetadata() {
  }

  public ContactQRCodeMetadata data(ContactData data) {
    this.data = data;
    return this;
  }
  ...
  public ContactQRCodeMetadata image(EmbeddedImageMultipart image) {
    this.image = image;
    return this;
  }
  ...
  public ContactQRCodeMetadata output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public ContactQRCodeMetadata size(SizeMultipart size) {
    this.size = size;
    return this;
  }
  ...
  public ContactQRCodeMetadata style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContactQRCodeMetadata contactQRCodeMetadata = (ContactQRCodeMetadata) o;
    return Objects.equals(this.data, contactQRCodeMetadata.data) &&
        Objects.equals(this.image, contactQRCodeMetadata.image) &&
        Objects.equals(this.output, contactQRCodeMetadata.output) &&
        Objects.equals(this.size, contactQRCodeMetadata.size) &&
        Objects.equals(this.style, contactQRCodeMetadata.style);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactQRCodeMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactQRCodeMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactQRCodeMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactQRCodeMetadata is not found in the empty JSON string", ContactQRCodeMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactQRCodeMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactQRCodeMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactQRCodeMetadata.openapiRequiredFields) {
      ...
      ContactData.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactQRCodeMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactQRCodeMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactQRCodeMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactQRCodeMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactQRCodeMetadata>() {
           @Override
           public void write(JsonWriter out, ContactQRCodeMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactQRCodeMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactQRCodeMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactQRCodeMetadata
   * @throws IOException if the JSON string is invalid with respect to ContactQRCodeMetadata
   */
  public static ContactQRCodeMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactQRCodeMetadata.class);
  }

  /**
   * Convert an instance of ContactQRCodeMetadata to an JSON string
   *
   * @return JSON string
   */
