...
public class TextQRCodeMetadata {
  ...
  public TextQRCodeMetadata() {
  }

  public TextQRCodeMetadata data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public TextQRCodeMetadata image(EmbeddedImageMultipart image) {
    this.image = image;
    return this;
  }
  ...
  public TextQRCodeMetadata output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public TextQRCodeMetadata size(SizeMultipart size) {
    this.size = size;
    return this;
  }
  ...
  public TextQRCodeMetadata style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TextQRCodeMetadata textQRCodeMetadata = (TextQRCodeMetadata) o;
    return Objects.equals(this.data, textQRCodeMetadata.data) &&
        Objects.equals(this.image, textQRCodeMetadata.image) &&
        Objects.equals(this.output, textQRCodeMetadata.output) &&
        Objects.equals(this.size, textQRCodeMetadata.size) &&
        Objects.equals(this.style, textQRCodeMetadata.style);
  }
  ...
  public String toString() {
    ...
    sb.append("class TextQRCodeMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextQRCodeMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextQRCodeMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextQRCodeMetadata is not found in the empty JSON string", TextQRCodeMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextQRCodeMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextQRCodeMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TextQRCodeMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextQRCodeMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextQRCodeMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextQRCodeMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextQRCodeMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<TextQRCodeMetadata>() {
           @Override
           public void write(JsonWriter out, TextQRCodeMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextQRCodeMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextQRCodeMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextQRCodeMetadata
   * @throws IOException if the JSON string is invalid with respect to TextQRCodeMetadata
   */
  public static TextQRCodeMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextQRCodeMetadata.class);
  }

  /**
   * Convert an instance of TextQRCodeMetadata to an JSON string
   *
   * @return JSON string
   */
