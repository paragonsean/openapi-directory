...
public class Bcc extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Bcc.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Bcc.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Bcc' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Bcc>() {
                @Override
                public void write(JsonWriter out, Bcc value) throws IOException {
                ...
                @Override
                public Bcc read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Bcc: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Bcc
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Bcc with anyOf schemas: List<Object>, Object. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Bcc given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Bcc
     * @throws IOException if the JSON string is invalid with respect to Bcc
     */
    public static Bcc fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Bcc.class);
    }

    /**
     * Convert an instance of Bcc to an JSON string
     *
     * @return JSON string
     */
