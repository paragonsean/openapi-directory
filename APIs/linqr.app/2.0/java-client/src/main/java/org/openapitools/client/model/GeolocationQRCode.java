...
public class GeolocationQRCode {
  ...
  public GeolocationQRCode() {
  }

  public GeolocationQRCode data(GeolocationData data) {
    this.data = data;
    return this;
  }
  ...
  public GeolocationQRCode image(EmbeddedImage image) {
    this.image = image;
    return this;
  }
  ...
  public GeolocationQRCode output(OutputFile output) {
    this.output = output;
    return this;
  }
  ...
  public GeolocationQRCode size(Size size) {
    this.size = size;
    return this;
  }
  ...
  public GeolocationQRCode style(Style style) {
    this.style = style;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GeolocationQRCode geolocationQRCode = (GeolocationQRCode) o;
    return Objects.equals(this.data, geolocationQRCode.data) &&
        Objects.equals(this.image, geolocationQRCode.image) &&
        Objects.equals(this.output, geolocationQRCode.output) &&
        Objects.equals(this.size, geolocationQRCode.size) &&
        Objects.equals(this.style, geolocationQRCode.style);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeolocationQRCode {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GeolocationQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GeolocationQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeolocationQRCode is not found in the empty JSON string", GeolocationQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GeolocationQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GeolocationQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GeolocationQRCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeolocationQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeolocationQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeolocationQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeolocationQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<GeolocationQRCode>() {
           @Override
           public void write(JsonWriter out, GeolocationQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GeolocationQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GeolocationQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GeolocationQRCode
   * @throws IOException if the JSON string is invalid with respect to GeolocationQRCode
   */
  public static GeolocationQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeolocationQRCode.class);
  }

  /**
   * Convert an instance of GeolocationQRCode to an JSON string
   *
   * @return JSON string
   */
