...
public class To1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(To1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!To1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'To1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<To1>() {
                @Override
                public void write(JsonWriter out, To1 value) throws IOException {
                ...
                @Override
                public To1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for To1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to To1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for To1 with anyOf schemas: List<String>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of To1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of To1
     * @throws IOException if the JSON string is invalid with respect to To1
     */
    public static To1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, To1.class);
    }

    /**
     * Convert an instance of To1 to an JSON string
     *
     * @return JSON string
     */
