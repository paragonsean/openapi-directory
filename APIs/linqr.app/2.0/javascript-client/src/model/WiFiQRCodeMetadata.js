...
/**
 * The WiFiQRCodeMetadata model module.
 * @module model/WiFiQRCodeMetadata
 * @version 2.0
 */
class WiFiQRCodeMetadata {
    /**
     * Constructs a new <code>WiFiQRCodeMetadata</code>.
     * @alias module:model/WiFiQRCodeMetadata
    ...
    constructor(data) { 
        ...
        WiFiQRCodeMetadata.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>WiFiQRCodeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WiFiQRCodeMetadata} obj Optional instance to populate.
     * @return {module:model/WiFiQRCodeMetadata} The populated <code>WiFiQRCodeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WiFiQRCodeMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>WiFiQRCodeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WiFiQRCodeMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WiFiQRCodeMetadata.RequiredProperties) {
...
WiFiQRCodeMetadata.RequiredProperties = ["data"];
 ...
 */
WiFiQRCodeMetadata.prototype['data'] = undefined;
 ...
 */
WiFiQRCodeMetadata.prototype['image'] = undefined;
 ...
 */
WiFiQRCodeMetadata.prototype['output'] = undefined;
 ...
 */
WiFiQRCodeMetadata.prototype['size'] = undefined;
 ...
 */
WiFiQRCodeMetadata.prototype['style'] = undefined;
...
export default WiFiQRCodeMetadata;
