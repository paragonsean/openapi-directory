...
/**
 * The ContactQRCode model module.
 * @module model/ContactQRCode
 * @version 2.0
 */
class ContactQRCode {
    /**
     * Constructs a new <code>ContactQRCode</code>.
     * @alias module:model/ContactQRCode
    ...
    constructor(data) { 
        ...
        ContactQRCode.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ContactQRCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactQRCode} obj Optional instance to populate.
     * @return {module:model/ContactQRCode} The populated <code>ContactQRCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactQRCode();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactQRCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactQRCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactQRCode.RequiredProperties) {
...
ContactQRCode.RequiredProperties = ["data"];
 ...
 */
ContactQRCode.prototype['data'] = undefined;
 ...
 */
ContactQRCode.prototype['image'] = undefined;
 ...
 */
ContactQRCode.prototype['style'] = undefined;
