...
/**
 * The EmailQRCodeMetadata model module.
 * @module model/EmailQRCodeMetadata
 * @version 2.0
 */
class EmailQRCodeMetadata {
    /**
     * Constructs a new <code>EmailQRCodeMetadata</code>.
     * @alias module:model/EmailQRCodeMetadata
     * @param data {module:model/EmailData} `data` property allows you to specify the e-mail template stored in the QR Code.
     */
    constructor(data) { 
        
        EmailQRCodeMetadata.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>EmailQRCodeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmailQRCodeMetadata} obj Optional instance to populate.
     * @return {module:model/EmailQRCodeMetadata} The populated <code>EmailQRCodeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailQRCodeMetadata();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], EmailData);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmailQRCodeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailQRCodeMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailQRCodeMetadata.RequiredProperties) {
 ...
 */
EmailQRCodeMetadata.prototype['image'] = undefined;
 ...
 */
EmailQRCodeMetadata.prototype['output'] = undefined;
 ...
 */
EmailQRCodeMetadata.prototype['size'] = undefined;
 ...
 */
EmailQRCodeMetadata.prototype['style'] = undefined;
...
export default EmailQRCodeMetadata;
