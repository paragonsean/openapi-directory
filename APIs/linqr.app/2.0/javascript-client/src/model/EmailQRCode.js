...
/**
 * The EmailQRCode model module.
 * @module model/EmailQRCode
 * @version 2.0
 */
class EmailQRCode {
    /**
     * Constructs a new <code>EmailQRCode</code>.
     * @alias module:model/EmailQRCode
     * @param data {module:model/EmailData} `data` property allows you to specify the e-mail template stored in the QR Code.
     */
    constructor(data) { 
        
        EmailQRCode.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>EmailQRCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmailQRCode} obj Optional instance to populate.
     * @return {module:model/EmailQRCode} The populated <code>EmailQRCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailQRCode();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailQRCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailQRCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailQRCode.RequiredProperties) {
 ...
 */
EmailQRCode.prototype['image'] = undefined;
 ...
 */
EmailQRCode.prototype['style'] = undefined;
