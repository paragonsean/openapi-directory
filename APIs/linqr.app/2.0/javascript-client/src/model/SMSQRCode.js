...
/**
 * The SMSQRCode model module.
 * @module model/SMSQRCode
 * @version 2.0
 */
class SMSQRCode {
    /**
     * Constructs a new <code>SMSQRCode</code>.
     * @alias module:model/SMSQRCode
     * @param data {module:model/SMSData} `data` property allows you to specify SMS template.
     */
    constructor(data) { 
        
        SMSQRCode.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>SMSQRCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMSQRCode} obj Optional instance to populate.
     * @return {module:model/SMSQRCode} The populated <code>SMSQRCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMSQRCode();
    ...
    /**
     * Validates the JSON data with respect to <code>SMSQRCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMSQRCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SMSQRCode.RequiredProperties) {
 ...
 */
SMSQRCode.prototype['image'] = undefined;
 ...
 */
SMSQRCode.prototype['style'] = undefined;
