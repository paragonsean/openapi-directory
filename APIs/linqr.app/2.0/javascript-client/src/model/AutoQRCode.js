...
/**
 * The AutoQRCode model module.
 * @module model/AutoQRCode
 * @version 2.0
 */
class AutoQRCode {
    /**
     * Constructs a new <code>AutoQRCode</code>.
     * @alias module:model/AutoQRCode
     * @param data {module:model/AutoData} 
     */
    constructor(data) { 
        
        AutoQRCode.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>AutoQRCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoQRCode} obj Optional instance to populate.
     * @return {module:model/AutoQRCode} The populated <code>AutoQRCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoQRCode();

            if (data.hasOwnProperty('data')) {
                obj['data'] = AutoData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AutoQRCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoQRCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AutoQRCode.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          AutoData.validateJSON(data['data']);
        }
...
AutoQRCode.RequiredProperties = ["data"];

/**
 * @member {module:model/AutoData} data
 */
AutoQRCode.prototype['data'] = undefined;
 ...
 */
AutoQRCode.prototype['image'] = undefined;
 ...
 */
AutoQRCode.prototype['style'] = undefined;
