...
/**
 * The GeolocationQRCodeMetadata model module.
 * @module model/GeolocationQRCodeMetadata
 * @version 2.0
 */
class GeolocationQRCodeMetadata {
    /**
     * Constructs a new <code>GeolocationQRCodeMetadata</code>.
     * @alias module:model/GeolocationQRCodeMetadata
     * @param data {module:model/GeolocationData} `data` property allows you to specify geographic location (map pin).
     */
    constructor(data) { 
        
        GeolocationQRCodeMetadata.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>GeolocationQRCodeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeolocationQRCodeMetadata} obj Optional instance to populate.
     * @return {module:model/GeolocationQRCodeMetadata} The populated <code>GeolocationQRCodeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeolocationQRCodeMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GeolocationQRCodeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeolocationQRCodeMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GeolocationQRCodeMetadata.RequiredProperties) {
 ...
 */
GeolocationQRCodeMetadata.prototype['image'] = undefined;
 ...
 */
GeolocationQRCodeMetadata.prototype['output'] = undefined;
 ...
 */
GeolocationQRCodeMetadata.prototype['size'] = undefined;
 ...
 */
GeolocationQRCodeMetadata.prototype['style'] = undefined;
...
export default GeolocationQRCodeMetadata;
