...
/**
 * The AutoQRCodeMetadata model module.
 * @module model/AutoQRCodeMetadata
 * @version 2.0
 */
class AutoQRCodeMetadata {
    /**
     * Constructs a new <code>AutoQRCodeMetadata</code>.
     * @alias module:model/AutoQRCodeMetadata
     * @param data {module:model/AutoData} 
     */
    constructor(data) { 
        
        AutoQRCodeMetadata.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>AutoQRCodeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoQRCodeMetadata} obj Optional instance to populate.
     * @return {module:model/AutoQRCodeMetadata} The populated <code>AutoQRCodeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoQRCodeMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>AutoQRCodeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoQRCodeMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AutoQRCodeMetadata.RequiredProperties) {
...
AutoQRCodeMetadata.RequiredProperties = ["data"];

/**
 * @member {module:model/AutoData} data
 */
AutoQRCodeMetadata.prototype['data'] = undefined;
 ...
 */
AutoQRCodeMetadata.prototype['image'] = undefined;
 ...
 */
AutoQRCodeMetadata.prototype['output'] = undefined;
 ...
 */
AutoQRCodeMetadata.prototype['size'] = undefined;
 ...
 */
AutoQRCodeMetadata.prototype['style'] = undefined;
...
export default AutoQRCodeMetadata;
