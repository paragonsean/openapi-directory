...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.GeolocationQRCode();
  });
  ...
  describe('GeolocationQRCode', function() {
    it('should create an instance of GeolocationQRCode', function() {
      // uncomment below and update the code to test GeolocationQRCode
      //var instance = new LinQr.GeolocationQRCode();
      //expect(instance).to.be.a(LinQr.GeolocationQRCode);
    });
