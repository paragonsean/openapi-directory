...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.PhoneQRCodeMetadata();
  });
  ...
  describe('PhoneQRCodeMetadata', function() {
    it('should create an instance of PhoneQRCodeMetadata', function() {
      // uncomment below and update the code to test PhoneQRCodeMetadata
      //var instance = new LinQr.PhoneQRCodeMetadata();
      //expect(instance).to.be.a(LinQr.PhoneQRCodeMetadata);
    });
