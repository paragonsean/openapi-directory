...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.WiFiQRCodeMetadata();
  });
  ...
  describe('WiFiQRCodeMetadata', function() {
    it('should create an instance of WiFiQRCodeMetadata', function() {
      // uncomment below and update the code to test WiFiQRCodeMetadata
      //var instance = new LinQr.WiFiQRCodeMetadata();
      //expect(instance).to.be.a(LinQr.WiFiQRCodeMetadata);
    });
