...
(function(root, factory) {
  ...
  describe('WiFiQRCode', function() {
    it('should create an instance of WiFiQRCode', function() {
      // uncomment below and update the code to test WiFiQRCode
      //var instance = new LinQr.WiFiQRCode();
      //expect(instance).to.be.a(LinQr.WiFiQRCode);
    });
