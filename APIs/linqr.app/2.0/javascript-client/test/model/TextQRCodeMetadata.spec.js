...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.TextQRCodeMetadata();
  });
  ...
  describe('TextQRCodeMetadata', function() {
    it('should create an instance of TextQRCodeMetadata', function() {
      // uncomment below and update the code to test TextQRCodeMetadata
      //var instance = new LinQr.TextQRCodeMetadata();
      //expect(instance).to.be.a(LinQr.TextQRCodeMetadata);
    });
