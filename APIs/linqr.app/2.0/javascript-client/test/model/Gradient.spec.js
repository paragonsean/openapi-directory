...
(function(root, factory) {
  ...
  describe('Gradient', function() {
    it('should create an instance of Gradient', function() {
      // uncomment below and update the code to test Gradient
      //var instance = new LinQr.Gradient();
      //expect(instance).to.be.a(LinQr.Gradient);
    });
