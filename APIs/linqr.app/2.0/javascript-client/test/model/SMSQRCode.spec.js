...
(function(root, factory) {
  ...
  describe('SMSQRCode', function() {
    it('should create an instance of SMSQRCode', function() {
      // uncomment below and update the code to test SMSQRCode
      //var instance = new LinQr.SMSQRCode();
      //expect(instance).to.be.a(LinQr.SMSQRCode);
    });
