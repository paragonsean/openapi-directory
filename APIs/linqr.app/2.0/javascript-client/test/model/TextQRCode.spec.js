...
(function(root, factory) {
  ...
  describe('TextQRCode', function() {
    it('should create an instance of TextQRCode', function() {
      // uncomment below and update the code to test TextQRCode
      //var instance = new LinQr.TextQRCode();
      //expect(instance).to.be.a(LinQr.TextQRCode);
    });
