...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.EmailQRCodeMetadata();
  });
  ...
  describe('EmailQRCodeMetadata', function() {
    it('should create an instance of EmailQRCodeMetadata', function() {
      // uncomment below and update the code to test EmailQRCodeMetadata
      //var instance = new LinQr.EmailQRCodeMetadata();
      //expect(instance).to.be.a(LinQr.EmailQRCodeMetadata);
    });
