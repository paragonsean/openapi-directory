...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.EmbeddedImage();
  });
  ...
  describe('EmbeddedImage', function() {
    it('should create an instance of EmbeddedImage', function() {
      // uncomment below and update the code to test EmbeddedImage
      //var instance = new LinQr.EmbeddedImage();
      //expect(instance).to.be.a(LinQr.EmbeddedImage);
    });
