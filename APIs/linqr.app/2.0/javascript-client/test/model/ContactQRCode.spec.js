...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.ContactQRCode();
  });
  ...
  describe('ContactQRCode', function() {
    it('should create an instance of ContactQRCode', function() {
      // uncomment below and update the code to test ContactQRCode
      //var instance = new LinQr.ContactQRCode();
      //expect(instance).to.be.a(LinQr.ContactQRCode);
    });
