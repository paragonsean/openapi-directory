...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.LinearGradient();
  });
  ...
  describe('LinearGradient', function() {
    it('should create an instance of LinearGradient', function() {
      // uncomment below and update the code to test LinearGradient
      //var instance = new LinQr.LinearGradient();
      //expect(instance).to.be.a(LinQr.LinearGradient);
    });
