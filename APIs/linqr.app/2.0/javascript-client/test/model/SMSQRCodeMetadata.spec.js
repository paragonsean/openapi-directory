...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.SMSQRCodeMetadata();
  });
  ...
  describe('SMSQRCodeMetadata', function() {
    it('should create an instance of SMSQRCodeMetadata', function() {
      // uncomment below and update the code to test SMSQRCodeMetadata
      //var instance = new LinQr.SMSQRCodeMetadata();
      //expect(instance).to.be.a(LinQr.SMSQRCodeMetadata);
    });
