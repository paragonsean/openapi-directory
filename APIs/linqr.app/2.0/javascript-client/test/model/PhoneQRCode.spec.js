...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.PhoneQRCode();
  });
  ...
  describe('PhoneQRCode', function() {
    it('should create an instance of PhoneQRCode', function() {
      // uncomment below and update the code to test PhoneQRCode
      //var instance = new LinQr.PhoneQRCode();
      //expect(instance).to.be.a(LinQr.PhoneQRCode);
    });
