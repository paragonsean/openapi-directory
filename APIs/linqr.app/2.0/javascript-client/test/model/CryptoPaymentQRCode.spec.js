...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.CryptoPaymentQRCode();
  });
  ...
  describe('CryptoPaymentQRCode', function() {
    it('should create an instance of CryptoPaymentQRCode', function() {
      // uncomment below and update the code to test CryptoPaymentQRCode
      //var instance = new LinQr.CryptoPaymentQRCode();
      //expect(instance).to.be.a(LinQr.CryptoPaymentQRCode);
    });
