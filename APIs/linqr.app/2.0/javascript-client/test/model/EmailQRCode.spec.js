...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinQr.EmailQRCode();
  });
  ...
  describe('EmailQRCode', function() {
    it('should create an instance of EmailQRCode', function() {
      // uncomment below and update the code to test EmailQRCode
      //var instance = new LinQr.EmailQRCode();
      //expect(instance).to.be.a(LinQr.EmailQRCode);
    });
