...
(function(root, factory) {
  ...
  describe('AutoQRCode', function() {
    it('should create an instance of AutoQRCode', function() {
      // uncomment below and update the code to test AutoQRCode
      //var instance = new LinQr.AutoQRCode();
      //expect(instance).to.be.a(LinQr.AutoQRCode);
    });
