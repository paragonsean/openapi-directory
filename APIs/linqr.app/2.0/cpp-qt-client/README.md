...
#include <iostream>
#include "../client/OAIImageManagementApi.h"
...
void Example::exampleFunction1(){
     OAIImageManagementApi apiInstance;
     
      // Configure API key authorization: RapidAPI
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIImageManagementApi::imageDeleteImagesIdDeleteSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIImageManagementApi::imageDeleteImagesIdDeleteSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
