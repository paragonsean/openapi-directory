...
/*
 * OAIEmailQRCodeMetadata.h
 *
 * 
 */

#ifndef OAIEmailQRCodeMetadata_H
#define OAIEmailQRCodeMetadata_H
...
class OAIEmailQRCodeMetadata : public OAIObject {
public:
    OAIEmailQRCodeMetadata();
    OAIEmailQRCodeMetadata(QString json);
    ~OAIEmailQRCodeMetadata() override;
    ...
    OAIEmailData getData() const;
    void setData(const OAIEmailData &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailQRCodeMetadata)

#endif // OAIEmailQRCodeMetadata_H
