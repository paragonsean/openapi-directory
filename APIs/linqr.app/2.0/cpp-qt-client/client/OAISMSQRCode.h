...
#ifndef OAISMSQRCode_H
#define OAISMSQRCode_H
...
class OAISMSQRCode : public OAIObject {
public:
    OAISMSQRCode();
    OAISMSQRCode(QString json);
    ~OAISMSQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMSQRCode)

#endif // OAISMSQRCode_H
