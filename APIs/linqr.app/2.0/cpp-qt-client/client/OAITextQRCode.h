...
#ifndef OAITextQRCode_H
#define OAITextQRCode_H
...
class OAITextQRCode : public OAIObject {
public:
    OAITextQRCode();
    OAITextQRCode(QString json);
    ~OAITextQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextQRCode)

#endif // OAITextQRCode_H
