...
#ifndef OAIPhoneQRCode_H
#define OAIPhoneQRCode_H
...
class OAIPhoneQRCode : public OAIObject {
public:
    OAIPhoneQRCode();
    OAIPhoneQRCode(QString json);
    ~OAIPhoneQRCode() override;
    ...
    OAIPhoneData getData() const;
    void setData(const OAIPhoneData &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneQRCode)

#endif // OAIPhoneQRCode_H
