...
/*
 * OAIPhoneQRCodeMetadata.h
 *
 * 
 */

#ifndef OAIPhoneQRCodeMetadata_H
#define OAIPhoneQRCodeMetadata_H
...
class OAIPhoneQRCodeMetadata : public OAIObject {
public:
    OAIPhoneQRCodeMetadata();
    OAIPhoneQRCodeMetadata(QString json);
    ~OAIPhoneQRCodeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneQRCodeMetadata)

#endif // OAIPhoneQRCodeMetadata_H
