...
/*
 * OAITextQRCodeMetadata.h
 *
 * 
 */

#ifndef OAITextQRCodeMetadata_H
#define OAITextQRCodeMetadata_H
...
class OAITextQRCodeMetadata : public OAIObject {
public:
    OAITextQRCodeMetadata();
    OAITextQRCodeMetadata(QString json);
    ~OAITextQRCodeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextQRCodeMetadata)

#endif // OAITextQRCodeMetadata_H
