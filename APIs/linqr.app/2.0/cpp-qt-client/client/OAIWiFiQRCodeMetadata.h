...
/*
 * OAIWiFiQRCodeMetadata.h
 *
 * 
 */

#ifndef OAIWiFiQRCodeMetadata_H
#define OAIWiFiQRCodeMetadata_H
...
class OAIWiFiQRCodeMetadata : public OAIObject {
public:
    OAIWiFiQRCodeMetadata();
    OAIWiFiQRCodeMetadata(QString json);
    ~OAIWiFiQRCodeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWiFiQRCodeMetadata)

#endif // OAIWiFiQRCodeMetadata_H
