...
/*
 * OAICryptoPaymentQRCodeMetadata.h
 *
 * 
 */

#ifndef OAICryptoPaymentQRCodeMetadata_H
#define OAICryptoPaymentQRCodeMetadata_H
...
namespace OpenAPI {
class OAICryptoPaymentData;
class OAIEmbeddedImageMultipart;
class OAIOutputFile;
class OAISizeMultipart;
class OAIStyle;

class OAICryptoPaymentQRCodeMetadata : public OAIObject {
public:
    OAICryptoPaymentQRCodeMetadata();
    OAICryptoPaymentQRCodeMetadata(QString json);
    ~OAICryptoPaymentQRCodeMetadata() override;
    ...
    OAICryptoPaymentData getData() const;
    void setData(const OAICryptoPaymentData &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICryptoPaymentQRCodeMetadata)

#endif // OAICryptoPaymentQRCodeMetadata_H
