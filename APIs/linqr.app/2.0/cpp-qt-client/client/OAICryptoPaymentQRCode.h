...
/*
 * OAICryptoPaymentQRCode.h
 *
 * 
 */

#ifndef OAICryptoPaymentQRCode_H
#define OAICryptoPaymentQRCode_H
...
class OAICryptoPaymentQRCode : public OAIObject {
public:
    OAICryptoPaymentQRCode();
    OAICryptoPaymentQRCode(QString json);
    ~OAICryptoPaymentQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICryptoPaymentQRCode)

#endif // OAICryptoPaymentQRCode_H
