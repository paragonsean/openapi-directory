...
/*
 * OAIGeolocationQRCodeMetadata.h
 *
 * 
 */

#ifndef OAIGeolocationQRCodeMetadata_H
#define OAIGeolocationQRCodeMetadata_H
...
namespace OpenAPI {
class OAIGeolocationData;
class OAIEmbeddedImageMultipart;
class OAIOutputFile;
class OAISizeMultipart;
class OAIStyle;

class OAIGeolocationQRCodeMetadata : public OAIObject {
public:
    OAIGeolocationQRCodeMetadata();
    OAIGeolocationQRCodeMetadata(QString json);
    ~OAIGeolocationQRCodeMetadata() override;
    ...
    OAIGeolocationData getData() const;
    void setData(const OAIGeolocationData &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeolocationQRCodeMetadata)

#endif // OAIGeolocationQRCodeMetadata_H
