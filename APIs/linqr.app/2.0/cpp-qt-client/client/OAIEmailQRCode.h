...
#ifndef OAIEmailQRCode_H
#define OAIEmailQRCode_H
...
class OAIEmailQRCode : public OAIObject {
public:
    OAIEmailQRCode();
    OAIEmailQRCode(QString json);
    ~OAIEmailQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailQRCode)

#endif // OAIEmailQRCode_H
