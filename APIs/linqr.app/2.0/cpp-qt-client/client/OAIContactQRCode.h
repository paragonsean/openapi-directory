...
#ifndef OAIContactQRCode_H
#define OAIContactQRCode_H
...
class OAIContactQRCode : public OAIObject {
public:
    OAIContactQRCode();
    OAIContactQRCode(QString json);
    ~OAIContactQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactQRCode)

#endif // OAIContactQRCode_H
