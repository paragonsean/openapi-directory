...
#ifndef OAIGradient_H
#define OAIGradient_H
...
class OAIGradient : public OAIObject {
public:
    OAIGradient();
    OAIGradient(QString json);
    ~OAIGradient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGradient)
