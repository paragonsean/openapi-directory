...
/*
 * OAIGeolocationQRCode.h
 *
 * 
 */

#ifndef OAIGeolocationQRCode_H
#define OAIGeolocationQRCode_H
...
class OAIGeolocationQRCode : public OAIObject {
public:
    OAIGeolocationQRCode();
    OAIGeolocationQRCode(QString json);
    ~OAIGeolocationQRCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeolocationQRCode)

#endif // OAIGeolocationQRCode_H
