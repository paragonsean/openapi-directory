...
#ifndef OAIVCardData_H
#define OAIVCardData_H
...
class OAIVCardData : public OAIObject {
public:
    OAIVCardData();
    OAIVCardData(QString json);
    ~OAIVCardData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVCardData)

#endif // OAIVCardData_H
