...
/*
 * OAIAutoQRCodeMetadata.h
 *
 * 
 */

#ifndef OAIAutoQRCodeMetadata_H
#define OAIAutoQRCodeMetadata_H
...
class OAIAutoQRCodeMetadata : public OAIObject {
public:
    OAIAutoQRCodeMetadata();
    OAIAutoQRCodeMetadata(QString json);
    ~OAIAutoQRCodeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoQRCodeMetadata)

#endif // OAIAutoQRCodeMetadata_H
