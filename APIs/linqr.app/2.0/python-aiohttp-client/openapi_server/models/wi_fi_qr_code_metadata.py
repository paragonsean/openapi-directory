...
class WiFiQRCodeMetadata(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data: WiFiData=None, image: EmbeddedImageMultipart=None, output: OutputFile=None, size: SizeMultipart=None, style: Style=None):
        """WiFiQRCodeMetadata - a model defined in OpenAPI

        :param data: The data of this WiFiQRCodeMetadata.
        :param image: The image of this WiFiQRCodeMetadata.
        :param output: The output of this WiFiQRCodeMetadata.
        :param size: The size of this WiFiQRCodeMetadata.
        :param style: The style of this WiFiQRCodeMetadata.
        """
        self.openapi_types = {
            'data': WiFiData,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WiFiQRCodeMetadata':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WiFiQRCodeMetadata of this WiFiQRCodeMetadata.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data(self):
        """Gets the data of this WiFiQRCodeMetadata.

        `data` property allows you to specify specify the WiFi access point credentials stored in the QR Code.

        :return: The data of this WiFiQRCodeMetadata.
        :rtype: WiFiData
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this WiFiQRCodeMetadata.
    ...
    @property
    def image(self):
        """Gets the image of this WiFiQRCodeMetadata.
        ...
        :return: The image of this WiFiQRCodeMetadata.
    ...
    def image(self, image):
        """Sets the image of this WiFiQRCodeMetadata.
    ...
    def output(self, output):
        """Sets the output of this WiFiQRCodeMetadata.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this WiFiQRCodeMetadata.
    ...
    @property
    def style(self):
        """Gets the style of this WiFiQRCodeMetadata.
        ...
        :return: The style of this WiFiQRCodeMetadata.
        :rtype: Style
        """
        return self._style
    ...
    def style(self, style):
        """Sets the style of this WiFiQRCodeMetadata.
