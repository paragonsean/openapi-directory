...
class SMSQRCodeMetadata(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data: SMSData=None, image: EmbeddedImageMultipart=None, output: OutputFile=None, size: SizeMultipart=None, style: Style=None):
        """SMSQRCodeMetadata - a model defined in OpenAPI

        :param data: The data of this SMSQRCodeMetadata.
        :param image: The image of this SMSQRCodeMetadata.
        :param output: The output of this SMSQRCodeMetadata.
        :param size: The size of this SMSQRCodeMetadata.
        :param style: The style of this SMSQRCodeMetadata.
        """
        self.openapi_types = {
            'data': SMSData,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SMSQRCodeMetadata':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SMSQRCodeMetadata of this SMSQRCodeMetadata.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data(self):
        """Gets the data of this SMSQRCodeMetadata.

        `data` property allows you to specify SMS template.

        :return: The data of this SMSQRCodeMetadata.
        :rtype: SMSData
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SMSQRCodeMetadata.
    ...
    @property
    def image(self):
        """Gets the image of this SMSQRCodeMetadata.
        ...
        :return: The image of this SMSQRCodeMetadata.
    ...
    def image(self, image):
        """Sets the image of this SMSQRCodeMetadata.
    ...
    def output(self, output):
        """Sets the output of this SMSQRCodeMetadata.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this SMSQRCodeMetadata.
    ...
    @property
    def style(self):
        """Gets the style of this SMSQRCodeMetadata.
        ...
        :return: The style of this SMSQRCodeMetadata.
        :rtype: Style
        """
        return self._style
    ...
    def style(self, style):
        """Sets the style of this SMSQRCodeMetadata.
