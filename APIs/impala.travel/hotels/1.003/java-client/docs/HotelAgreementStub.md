...
|------------ | ------------- | ------------- | -------------|
|**conditions** | **List&lt;String&gt;** | A deal may have conditions set to it. For example, the deal may only apply for a closed user group (PRIVATE_RATE) or sold along with another component e.g flights (PACKAGED) |  [optional] |
