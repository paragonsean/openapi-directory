...
public class RateComponent {
  ...
  public RateComponent formatted(String formatted) {
  ...
  public RateComponent includedInRate(Boolean includedInRate) {
  ...
  public RateComponent type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RateComponent rateComponent = (RateComponent) o;
    return Objects.equals(this.formatted, rateComponent.formatted) &&
        Objects.equals(this.includedInRate, rateComponent.includedInRate) &&
        Objects.equals(this.type, rateComponent.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formatted, includedInRate, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RateComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RateComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RateComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RateComponent is not found in the empty JSON string", RateComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RateComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RateComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RateComponent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RateComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RateComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RateComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RateComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<RateComponent>() {
           @Override
           public void write(JsonWriter out, RateComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RateComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RateComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RateComponent
   * @throws IOException if the JSON string is invalid with respect to RateComponent
   */
  public static RateComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RateComponent.class);
  }

  /**
   * Convert an instance of RateComponent to an JSON string
   *
   * @return JSON string
   */
