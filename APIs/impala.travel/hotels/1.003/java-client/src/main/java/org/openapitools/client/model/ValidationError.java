...
public class ValidationError {
  ...
  public ValidationError validations(List<ValidationResult> validations) {
    this.validations = validations;
    return this;
  }

  public ValidationError addValidationsItem(ValidationResult validationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, validationError.code) &&
        ...
        Objects.equals(this.validations, validationError.validations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, validations);
  }
      ...
      if (jsonObj.get("validations") != null && !jsonObj.get("validations").isJsonNull()) {
        ...
        if (jsonArrayvalidations != null) {
          ...
          for (int i = 0; i < jsonArrayvalidations.size(); i++) {
            ValidationResult.validateJsonElement(jsonArrayvalidations.get(i));
          };
        }
      }
  }
