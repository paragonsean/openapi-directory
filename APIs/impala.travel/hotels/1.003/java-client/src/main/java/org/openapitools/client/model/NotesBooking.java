...
public class NotesBooking {
  ...
  public NotesBooking fromGuest(String fromGuest) {
  ...
  public NotesBooking fromSeller(String fromSeller) {
  ...
  public boolean equals(Object o) {
    ...
    NotesBooking notesBooking = (NotesBooking) o;
    return Objects.equals(this.fromGuest, notesBooking.fromGuest) &&
        Objects.equals(this.fromSeller, notesBooking.fromSeller);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotesBooking
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotesBooking.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotesBooking is not found in the empty JSON string", NotesBooking.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotesBooking.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotesBooking` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotesBooking.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotesBooking' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotesBooking> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotesBooking.class));

       return (TypeAdapter<T>) new TypeAdapter<NotesBooking>() {
           @Override
           public void write(JsonWriter out, NotesBooking value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotesBooking read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotesBooking given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotesBooking
   * @throws IOException if the JSON string is invalid with respect to NotesBooking
   */
  public static NotesBooking fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotesBooking.class);
  }

  /**
   * Convert an instance of NotesBooking to an JSON string
   *
   * @return JSON string
   */
