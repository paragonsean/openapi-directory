...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.impala.travel/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("API_Key_Authentication", new ApiKeyAuth("header", "x-api-key"));
        authentications.put("paymentAuth", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.003/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.impala.travel/v1
