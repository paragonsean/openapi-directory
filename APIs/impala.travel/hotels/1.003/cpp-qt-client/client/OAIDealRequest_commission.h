...
#ifndef OAIDealRequest_commission_H
#define OAIDealRequest_commission_H
...
class OAIDealRequest_commission : public OAIObject {
public:
    OAIDealRequest_commission();
    OAIDealRequest_commission(QString json);
    ~OAIDealRequest_commission() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_commission)

#endif // OAIDealRequest_commission_H
