...
public:
    ...
    double getCancellationDeadline() const;
    void setCancellationDeadline(const double &cancellation_deadline);
    bool is_cancellation_deadline_Set() const;
    bool is_cancellation_deadline_Valid() const;
...
private:
    ...
    double m_cancellation_deadline;
    bool m_cancellation_deadline_isSet;
    bool m_cancellation_deadline_isValid;
