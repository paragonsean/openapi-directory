...
/*
 * OAIHotelAgreement_lengthOfStay.h
 *
 * You&#39;re agreeing with the hotel that any booking made will have a minimum and/or maximum amount of nights.
 */

#ifndef OAIHotelAgreement_lengthOfStay_H
#define OAIHotelAgreement_lengthOfStay_H
...
class OAIHotelAgreement_lengthOfStay : public OAIObject {
public:
    OAIHotelAgreement_lengthOfStay();
    OAIHotelAgreement_lengthOfStay(QString json);
    ~OAIHotelAgreement_lengthOfStay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelAgreement_lengthOfStay)

#endif // OAIHotelAgreement_lengthOfStay_H
