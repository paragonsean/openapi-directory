...
/*
 * OAIHotelAgreementStub_dealsSellable.h
 *
 * There is a limit to the number of deals that can be sold. 
 */

#ifndef OAIHotelAgreementStub_dealsSellable_H
#define OAIHotelAgreementStub_dealsSellable_H
...
class OAIHotelAgreementStub_dealsSellable : public OAIObject {
public:
    OAIHotelAgreementStub_dealsSellable();
    OAIHotelAgreementStub_dealsSellable(QString json);
    ~OAIHotelAgreementStub_dealsSellable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelAgreementStub_dealsSellable)

#endif // OAIHotelAgreementStub_dealsSellable_H
