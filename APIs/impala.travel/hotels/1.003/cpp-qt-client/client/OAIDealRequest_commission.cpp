...
OAIDealRequest_commission::OAIDealRequest_commission(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDealRequest_commission::OAIDealRequest_commission() {
    this->initializeModel();
}

OAIDealRequest_commission::~OAIDealRequest_commission() {}

void OAIDealRequest_commission::initializeModel() {
...
void OAIDealRequest_commission::fromJson(QString jsonString) {
...
void OAIDealRequest_commission::fromJsonObject(QJsonObject json) {
...
QString OAIDealRequest_commission::asJson() const {
...
QJsonObject OAIDealRequest_commission::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIDealRequest_commission::getCount() const {
    return m_count;
}
void OAIDealRequest_commission::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIDealRequest_commission::is_count_Set() const{
    return m_count_isSet;
}

bool OAIDealRequest_commission::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIDealRequest_commission::getType() const {
    return m_type;
}
void OAIDealRequest_commission::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDealRequest_commission::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDealRequest_commission::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDealRequest_commission::isSet() const {
...
bool OAIDealRequest_commission::isValid() const {
