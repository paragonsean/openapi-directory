...
/*
 * OAIHotelAgreement_dealsSellable.h
 *
 * 
 */

#ifndef OAIHotelAgreement_dealsSellable_H
#define OAIHotelAgreement_dealsSellable_H
...
class OAIHotelAgreement_dealsSellable : public OAIObject {
public:
    OAIHotelAgreement_dealsSellable();
    OAIHotelAgreement_dealsSellable(QString json);
    ~OAIHotelAgreement_dealsSellable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelAgreement_dealsSellable)

#endif // OAIHotelAgreement_dealsSellable_H
