...
OAIPersonInfo OAIUpdateBookingRequest::getBookingContact() const {
    return m_booking_contact;
}
void OAIUpdateBookingRequest::setBookingContact(const OAIPersonInfo &booking_contact) {
    m_booking_contact = booking_contact;
    m_booking_contact_isSet = true;
}

bool OAIUpdateBookingRequest::is_booking_contact_Set() const{
    return m_booking_contact_isSet;
}

bool OAIUpdateBookingRequest::is_booking_contact_Valid() const{
    return m_booking_contact_isValid;
}

QDate OAIUpdateBookingRequest::getEnd() const {
    return m_end;
}
void OAIUpdateBookingRequest::setEnd(const QDate &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAIUpdateBookingRequest::is_end_Set() const{
    return m_end_isSet;
}

bool OAIUpdateBookingRequest::is_end_Valid() const{
    return m_end_isValid;
}

OAINotesBooking OAIUpdateBookingRequest::getNotes() const {
    return m_notes;
}
void OAIUpdateBookingRequest::setNotes(const OAINotesBooking &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIUpdateBookingRequest::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIUpdateBookingRequest::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIUpdateBookingRequest::getPaymentType() const {
    return m_payment_type;
}
void OAIUpdateBookingRequest::setPaymentType(const QString &payment_type) {
    m_payment_type = payment_type;
    m_payment_type_isSet = true;
}

bool OAIUpdateBookingRequest::is_payment_type_Set() const{
    return m_payment_type_isSet;
}

bool OAIUpdateBookingRequest::is_payment_type_Valid() const{
    return m_payment_type_isValid;
}

QList<OAIBookingRequest_rooms_inner> OAIUpdateBookingRequest::getRooms() const {
    return m_rooms;
}
void OAIUpdateBookingRequest::setRooms(const QList<OAIBookingRequest_rooms_inner> &rooms) {
    m_rooms = rooms;
    m_rooms_isSet = true;
}

bool OAIUpdateBookingRequest::is_rooms_Set() const{
    return m_rooms_isSet;
}

bool OAIUpdateBookingRequest::is_rooms_Valid() const{
    return m_rooms_isValid;
}

QDate OAIUpdateBookingRequest::getStart() const {
    return m_start;
}
void OAIUpdateBookingRequest::setStart(const QDate &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIUpdateBookingRequest::is_start_Set() const{
    return m_start_isSet;
}

bool OAIUpdateBookingRequest::is_start_Valid() const{
    return m_start_isValid;
}

QDateTime OAIUpdateBookingRequest::getUpdateBookingVersionAtTimestamp() const {
    return m_update_booking_version_at_timestamp;
}
void OAIUpdateBookingRequest::setUpdateBookingVersionAtTimestamp(const QDateTime &update_booking_version_at_timestamp) {
...
bool OAIUpdateBookingRequest::is_update_booking_version_at_timestamp_Set() const{
    return m_update_booking_version_at_timestamp_isSet;
}

bool OAIUpdateBookingRequest::is_update_booking_version_at_timestamp_Valid() const{
