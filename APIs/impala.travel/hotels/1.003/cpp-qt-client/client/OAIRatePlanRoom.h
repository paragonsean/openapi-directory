...
#ifndef OAIRatePlanRoom_H
#define OAIRatePlanRoom_H
...
class OAIRatePlanRoom_price;

class OAIRatePlanRoom : public OAIObject {
public:
    OAIRatePlanRoom();
    OAIRatePlanRoom(QString json);
    ~OAIRatePlanRoom() override;
    ...
    OAIRatePlanRoom_price getPrice() const;
    void setPrice(const OAIRatePlanRoom_price &price);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatePlanRoom)

#endif // OAIRatePlanRoom_H
