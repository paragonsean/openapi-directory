...
class OAIBooking_cancellation : public OAIObject {
public:
    OAIBooking_cancellation();
    OAIBooking_cancellation(QString json);
    ~OAIBooking_cancellation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBooking_cancellation)

#endif // OAIBooking_cancellation_H
