...
OAIListRatePlansForHotel_200_response::OAIListRatePlansForHotel_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRatePlansForHotel_200_response::OAIListRatePlansForHotel_200_response() {
    this->initializeModel();
}

OAIListRatePlansForHotel_200_response::~OAIListRatePlansForHotel_200_response() {}

void OAIListRatePlansForHotel_200_response::initializeModel() {
...
void OAIListRatePlansForHotel_200_response::fromJson(QString jsonString) {
...
void OAIListRatePlansForHotel_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIListRatePlansForHotel_200_response::asJson() const {
...
QJsonObject OAIListRatePlansForHotel_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QSet<OAIRatePlan> OAIListRatePlansForHotel_200_response::getData() const {
    return m_data;
}
void OAIListRatePlansForHotel_200_response::setData(const QSet<OAIRatePlan> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIListRatePlansForHotel_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIListRatePlansForHotel_200_response::is_data_Valid() const{
    return m_data_isValid;
}

OAIPagination OAIListRatePlansForHotel_200_response::getPagination() const {
    return m_pagination;
}
void OAIListRatePlansForHotel_200_response::setPagination(const OAIPagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIListRatePlansForHotel_200_response::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIListRatePlansForHotel_200_response::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIListRatePlansForHotel_200_response::isSet() const {
...
bool OAIListRatePlansForHotel_200_response::isValid() const {
