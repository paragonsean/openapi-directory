...
#ifndef OAIBookedRate_retailRate_H
#define OAIBookedRate_retailRate_H
...
namespace OpenAPI {
class OAIBookedRate_retailRate_taxesAndFees;
class OAIMoney;

class OAIBookedRate_retailRate : public OAIObject {
public:
    OAIBookedRate_retailRate();
    OAIBookedRate_retailRate(QString json);
    ~OAIBookedRate_retailRate() override;
    ...
    OAIBookedRate_retailRate_taxesAndFees getTaxesAndFees() const;
    void setTaxesAndFees(const OAIBookedRate_retailRate_taxesAndFees &taxes_and_fees);
    bool is_taxes_and_fees_Set() const;
    bool is_taxes_and_fees_Valid() const;

    OAIMoney getTotal() const;
    void setTotal(const OAIMoney &total);
...
private:
    ...
    OAIBookedRate_retailRate_taxesAndFees m_taxes_and_fees;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBookedRate_retailRate)

#endif // OAIBookedRate_retailRate_H
