...
QString OAIValidationError::getCode() const {
    return m_code;
}
void OAIValidationError::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIValidationError::is_code_Set() const{
    return m_code_isSet;
}

bool OAIValidationError::is_code_Valid() const{
...
QList<OAIValidationResult> OAIValidationError::getValidations() const {
    return m_validations;
}
void OAIValidationError::setValidations(const QList<OAIValidationResult> &validations) {
    m_validations = validations;
    m_validations_isSet = true;
}

bool OAIValidationError::is_validations_Set() const{
    return m_validations_isSet;
}

bool OAIValidationError::is_validations_Valid() const{
