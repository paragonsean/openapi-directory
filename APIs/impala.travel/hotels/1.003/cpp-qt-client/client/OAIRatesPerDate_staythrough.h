...
class OAIRatesPerDate_staythrough : public OAIObject {
public:
    OAIRatesPerDate_staythrough();
    OAIRatesPerDate_staythrough(QString json);
    ~OAIRatesPerDate_staythrough() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatesPerDate_staythrough)

#endif // OAIRatesPerDate_staythrough_H
