...
#ifndef OAIDealRequest_discount_H
#define OAIDealRequest_discount_H
...
class OAIDealRequest_discount : public OAIObject {
public:
    OAIDealRequest_discount();
    OAIDealRequest_discount(QString json);
    ~OAIDealRequest_discount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_discount)

#endif // OAIDealRequest_discount_H
