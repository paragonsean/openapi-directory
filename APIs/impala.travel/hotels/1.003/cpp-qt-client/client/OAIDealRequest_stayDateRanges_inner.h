...
/*
 * OAIDealRequest_stayDateRanges_inner.h
 *
 * 
 */

#ifndef OAIDealRequest_stayDateRanges_inner_H
#define OAIDealRequest_stayDateRanges_inner_H
...
class OAIDealRequest_stayDateRanges_inner : public OAIObject {
public:
    OAIDealRequest_stayDateRanges_inner();
    OAIDealRequest_stayDateRanges_inner(QString json);
    ~OAIDealRequest_stayDateRanges_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_stayDateRanges_inner)

#endif // OAIDealRequest_stayDateRanges_inner_H
