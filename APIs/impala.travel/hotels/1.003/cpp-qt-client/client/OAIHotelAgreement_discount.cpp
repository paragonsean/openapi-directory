...
OAIHotelAgreement_discount::OAIHotelAgreement_discount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHotelAgreement_discount::OAIHotelAgreement_discount() {
    this->initializeModel();
}

OAIHotelAgreement_discount::~OAIHotelAgreement_discount() {}

void OAIHotelAgreement_discount::initializeModel() {
...
void OAIHotelAgreement_discount::fromJson(QString jsonString) {
...
void OAIHotelAgreement_discount::fromJsonObject(QJsonObject json) {
...
QString OAIHotelAgreement_discount::asJson() const {
...
QJsonObject OAIHotelAgreement_discount::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIHotelAgreement_discount::getCount() const {
    return m_count;
}
void OAIHotelAgreement_discount::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIHotelAgreement_discount::is_count_Set() const{
    return m_count_isSet;
}

bool OAIHotelAgreement_discount::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIHotelAgreement_discount::getType() const {
    return m_type;
}
void OAIHotelAgreement_discount::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIHotelAgreement_discount::is_type_Set() const{
    return m_type_isSet;
}

bool OAIHotelAgreement_discount::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIHotelAgreement_discount::isSet() const {
...
bool OAIHotelAgreement_discount::isValid() const {
