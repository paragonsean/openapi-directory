...
OAIDealRequest_lengthOfStay::OAIDealRequest_lengthOfStay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDealRequest_lengthOfStay::OAIDealRequest_lengthOfStay() {
    this->initializeModel();
}

OAIDealRequest_lengthOfStay::~OAIDealRequest_lengthOfStay() {}

void OAIDealRequest_lengthOfStay::initializeModel() {
...
void OAIDealRequest_lengthOfStay::fromJson(QString jsonString) {
...
void OAIDealRequest_lengthOfStay::fromJsonObject(QJsonObject json) {
...
QString OAIDealRequest_lengthOfStay::asJson() const {
...
QJsonObject OAIDealRequest_lengthOfStay::asJsonObject() const {
    QJsonObject obj;
    if (m_max_isSet) {
...
qint32 OAIDealRequest_lengthOfStay::getMax() const {
    return m_max;
}
void OAIDealRequest_lengthOfStay::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIDealRequest_lengthOfStay::is_max_Set() const{
    return m_max_isSet;
}

bool OAIDealRequest_lengthOfStay::is_max_Valid() const{
    return m_max_isValid;
}

qint32 OAIDealRequest_lengthOfStay::getMin() const {
    return m_min;
}
void OAIDealRequest_lengthOfStay::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIDealRequest_lengthOfStay::is_min_Set() const{
    return m_min_isSet;
}

bool OAIDealRequest_lengthOfStay::is_min_Valid() const{
    return m_min_isValid;
}

bool OAIDealRequest_lengthOfStay::isSet() const {
...
bool OAIDealRequest_lengthOfStay::isValid() const {
