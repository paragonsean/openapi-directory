...
/*
 * OAIRatePlanRoom_price.h
 *
 * 
 */

#ifndef OAIRatePlanRoom_price_H
#define OAIRatePlanRoom_price_H

#include <QJsonObject>

#include "OAICurrencyDetails.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICurrencyDetails;

class OAIRatePlanRoom_price : public OAIObject {
public:
    OAIRatePlanRoom_price();
    OAIRatePlanRoom_price(QString json);
    ~OAIRatePlanRoom_price() override;
    ...
    OAICurrencyDetails getCurrency() const;
    void setCurrency(const OAICurrencyDetails &currency);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatePlanRoom_price)

#endif // OAIRatePlanRoom_price_H
