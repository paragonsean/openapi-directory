...
/*
 * OAIGuestPaymentStub.h
 *
 * 
 */

#ifndef OAIGuestPaymentStub_H
#define OAIGuestPaymentStub_H
...
class OAIGuestPaymentStub : public OAIObject {
public:
    OAIGuestPaymentStub();
    OAIGuestPaymentStub(QString json);
    ~OAIGuestPaymentStub() override;
    ...
    QString getAuthorisationRedirectUrl() const;
    void setAuthorisationRedirectUrl(const QString &authorisation_redirect_url);
    bool is_authorisation_redirect_url_Set() const;
    bool is_authorisation_redirect_url_Valid() const;
...
private:
    ...
    QString m_authorisation_redirect_url;
    bool m_authorisation_redirect_url_isSet;
    bool m_authorisation_redirect_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGuestPaymentStub)

#endif // OAIGuestPaymentStub_H
