...
QString OAIGenericError::getCode() const {
    return m_code;
}
void OAIGenericError::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIGenericError::is_code_Set() const{
    return m_code_isSet;
}

bool OAIGenericError::is_code_Valid() const{
