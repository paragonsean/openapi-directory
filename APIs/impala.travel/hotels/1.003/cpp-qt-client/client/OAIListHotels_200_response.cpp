...
OAIListHotels_200_response::OAIListHotels_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListHotels_200_response::OAIListHotels_200_response() {
    this->initializeModel();
}

OAIListHotels_200_response::~OAIListHotels_200_response() {}

void OAIListHotels_200_response::initializeModel() {
...
void OAIListHotels_200_response::fromJson(QString jsonString) {
...
void OAIListHotels_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIListHotels_200_response::asJson() const {
...
QJsonObject OAIListHotels_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIHotelFullDetail> OAIListHotels_200_response::getData() const {
    return m_data;
}
void OAIListHotels_200_response::setData(const QList<OAIHotelFullDetail> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIListHotels_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIListHotels_200_response::is_data_Valid() const{
    return m_data_isValid;
}

OAIPagination OAIListHotels_200_response::getPagination() const {
    return m_pagination;
}
void OAIListHotels_200_response::setPagination(const OAIPagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIListHotels_200_response::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIListHotels_200_response::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIListHotels_200_response::isSet() const {
...
bool OAIListHotels_200_response::isValid() const {
