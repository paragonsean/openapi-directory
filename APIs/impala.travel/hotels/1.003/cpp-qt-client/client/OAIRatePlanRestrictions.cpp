...
OAIRatePlanRestrictions::OAIRatePlanRestrictions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRatePlanRestrictions::OAIRatePlanRestrictions() {
    this->initializeModel();
}

OAIRatePlanRestrictions::~OAIRatePlanRestrictions() {}

void OAIRatePlanRestrictions::initializeModel() {

    m_length_of_stay_isSet = false;
    m_length_of_stay_isValid = false;
}

void OAIRatePlanRestrictions::fromJson(QString jsonString) {
...
void OAIRatePlanRestrictions::fromJsonObject(QJsonObject json) {
...
QString OAIRatePlanRestrictions::asJson() const {
...
QJsonObject OAIRatePlanRestrictions::asJsonObject() const {
    QJsonObject obj;
...
OAIRatePlanRestrictions_lengthOfStay OAIRatePlanRestrictions::getLengthOfStay() const {
    return m_length_of_stay;
}
void OAIRatePlanRestrictions::setLengthOfStay(const OAIRatePlanRestrictions_lengthOfStay &length_of_stay) {
    m_length_of_stay = length_of_stay;
    m_length_of_stay_isSet = true;
}

bool OAIRatePlanRestrictions::is_length_of_stay_Set() const{
    return m_length_of_stay_isSet;
}

bool OAIRatePlanRestrictions::is_length_of_stay_Valid() const{
    return m_length_of_stay_isValid;
}

bool OAIRatePlanRestrictions::isSet() const {
...
bool OAIRatePlanRestrictions::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_length_of_stay_isValid && true;
}
