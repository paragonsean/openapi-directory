...
/*
 * OAIHotelAgreement_cancellationPolicy.h
 *
...
#ifndef OAIHotelAgreement_cancellationPolicy_H
#define OAIHotelAgreement_cancellationPolicy_H
...
class OAIHotelAgreement_cancellationPolicy : public OAIObject {
public:
    OAIHotelAgreement_cancellationPolicy();
    OAIHotelAgreement_cancellationPolicy(QString json);
    ~OAIHotelAgreement_cancellationPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelAgreement_cancellationPolicy)

#endif // OAIHotelAgreement_cancellationPolicy_H
