...
/*
 * OAIRatePlanRestrictions_lengthOfStay.h
 *
 * Determines the length of stay in nights for which this rate plan can be booked.
 */

#ifndef OAIRatePlanRestrictions_lengthOfStay_H
#define OAIRatePlanRestrictions_lengthOfStay_H
...
class OAIRatePlanRestrictions_lengthOfStay : public OAIObject {
public:
    OAIRatePlanRestrictions_lengthOfStay();
    OAIRatePlanRestrictions_lengthOfStay(QString json);
    ~OAIRatePlanRestrictions_lengthOfStay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatePlanRestrictions_lengthOfStay)

#endif // OAIRatePlanRestrictions_lengthOfStay_H
