...
/*
 * OAIAdjustmentConditionLengthOfStayRule.h
 *
 * 
 */

#ifndef OAIAdjustmentConditionLengthOfStayRule_H
#define OAIAdjustmentConditionLengthOfStayRule_H
...
namespace OpenAPI {
class OAIAdjustmentConditionLengthOfStayRule_rules;

class OAIAdjustmentConditionLengthOfStayRule : public OAIObject {
public:
    OAIAdjustmentConditionLengthOfStayRule();
    OAIAdjustmentConditionLengthOfStayRule(QString json);
    ~OAIAdjustmentConditionLengthOfStayRule() override;
    ...
    OAIAdjustmentConditionLengthOfStayRule_rules getRules() const;
    void setRules(const OAIAdjustmentConditionLengthOfStayRule_rules &rules);
...
private:
    ...
    OAIAdjustmentConditionLengthOfStayRule_rules m_rules;
    bool m_rules_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdjustmentConditionLengthOfStayRule)

#endif // OAIAdjustmentConditionLengthOfStayRule_H
