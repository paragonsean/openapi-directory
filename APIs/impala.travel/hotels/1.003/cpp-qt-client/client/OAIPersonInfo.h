...
#ifndef OAIPersonInfo_H
#define OAIPersonInfo_H
...
class OAIPersonInfo : public OAIObject {
public:
    OAIPersonInfo();
    OAIPersonInfo(QString json);
    ~OAIPersonInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonInfo)

#endif // OAIPersonInfo_H
