...
OAIRatePlanRestrictions_lengthOfStay::OAIRatePlanRestrictions_lengthOfStay(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRatePlanRestrictions_lengthOfStay::OAIRatePlanRestrictions_lengthOfStay() {
    this->initializeModel();
}

OAIRatePlanRestrictions_lengthOfStay::~OAIRatePlanRestrictions_lengthOfStay() {}

void OAIRatePlanRestrictions_lengthOfStay::initializeModel() {
...
void OAIRatePlanRestrictions_lengthOfStay::fromJson(QString jsonString) {
...
void OAIRatePlanRestrictions_lengthOfStay::fromJsonObject(QJsonObject json) {
...
QString OAIRatePlanRestrictions_lengthOfStay::asJson() const {
...
QJsonObject OAIRatePlanRestrictions_lengthOfStay::asJsonObject() const {
    QJsonObject obj;
    if (m_max_isSet) {
...
double OAIRatePlanRestrictions_lengthOfStay::getMax() const {
    return m_max;
}
void OAIRatePlanRestrictions_lengthOfStay::setMax(const double &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIRatePlanRestrictions_lengthOfStay::is_max_Set() const{
    return m_max_isSet;
}

bool OAIRatePlanRestrictions_lengthOfStay::is_max_Valid() const{
    return m_max_isValid;
}

double OAIRatePlanRestrictions_lengthOfStay::getMin() const {
    return m_min;
}
void OAIRatePlanRestrictions_lengthOfStay::setMin(const double &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIRatePlanRestrictions_lengthOfStay::is_min_Set() const{
    return m_min_isSet;
}

bool OAIRatePlanRestrictions_lengthOfStay::is_min_Valid() const{
    return m_min_isValid;
}

bool OAIRatePlanRestrictions_lengthOfStay::isSet() const {
...
bool OAIRatePlanRestrictions_lengthOfStay::isValid() const {
