...
OAIHotelAgreement_dealsSellable::OAIHotelAgreement_dealsSellable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHotelAgreement_dealsSellable::OAIHotelAgreement_dealsSellable() {
    this->initializeModel();
}

OAIHotelAgreement_dealsSellable::~OAIHotelAgreement_dealsSellable() {}

void OAIHotelAgreement_dealsSellable::initializeModel() {

    m_max_isSet = false;
    m_max_isValid = false;
}

void OAIHotelAgreement_dealsSellable::fromJson(QString jsonString) {
...
void OAIHotelAgreement_dealsSellable::fromJsonObject(QJsonObject json) {

    m_max_isValid = ::OpenAPI::fromJsonValue(m_max, json[QString("max")]);
    m_max_isSet = !json[QString("max")].isNull() && m_max_isValid;
}

QString OAIHotelAgreement_dealsSellable::asJson() const {
...
QJsonObject OAIHotelAgreement_dealsSellable::asJsonObject() const {
    QJsonObject obj;
    if (m_max_isSet) {
...
double OAIHotelAgreement_dealsSellable::getMax() const {
    return m_max;
}
void OAIHotelAgreement_dealsSellable::setMax(const double &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIHotelAgreement_dealsSellable::is_max_Set() const{
    return m_max_isSet;
}

bool OAIHotelAgreement_dealsSellable::is_max_Valid() const{
    return m_max_isValid;
}

bool OAIHotelAgreement_dealsSellable::isSet() const {
...
bool OAIHotelAgreement_dealsSellable::isValid() const {
