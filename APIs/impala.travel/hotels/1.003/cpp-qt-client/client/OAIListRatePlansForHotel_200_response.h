...
/*
 * OAIListRatePlansForHotel_200_response.h
 *
 * 
 */

#ifndef OAIListRatePlansForHotel_200_response_H
#define OAIListRatePlansForHotel_200_response_H
...
class OAIListRatePlansForHotel_200_response : public OAIObject {
public:
    OAIListRatePlansForHotel_200_response();
    OAIListRatePlansForHotel_200_response(QString json);
    ~OAIListRatePlansForHotel_200_response() override;
    ...
    QSet<OAIRatePlan> getData() const;
    void setData(const QSet<OAIRatePlan> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRatePlansForHotel_200_response)

#endif // OAIListRatePlansForHotel_200_response_H
