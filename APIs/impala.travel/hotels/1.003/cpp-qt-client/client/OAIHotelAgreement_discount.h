...
#ifndef OAIHotelAgreement_discount_H
#define OAIHotelAgreement_discount_H
...
class OAIHotelAgreement_discount : public OAIObject {
public:
    OAIHotelAgreement_discount();
    OAIHotelAgreement_discount(QString json);
    ~OAIHotelAgreement_discount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelAgreement_discount)

#endif // OAIHotelAgreement_discount_H
