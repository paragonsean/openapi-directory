...
#ifndef OAIRatePlanRate_H
#define OAIRatePlanRate_H
...
class OAIRatePlanRate : public OAIObject {
public:
    OAIRatePlanRate();
    OAIRatePlanRate(QString json);
    ~OAIRatePlanRate() override;
    ...
    OAIMoney getRetailRate() const;
    void setRetailRate(const OAIMoney &retail_rate);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatePlanRate)

#endif // OAIRatePlanRate_H
