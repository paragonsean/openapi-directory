...
class OAICancellationFee : public OAIObject {
public:
    OAICancellationFee();
    OAICancellationFee(QString json);
    ~OAICancellationFee() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancellationFee)

#endif // OAICancellationFee_H
