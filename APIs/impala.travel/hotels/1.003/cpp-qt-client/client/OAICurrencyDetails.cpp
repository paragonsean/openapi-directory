...
OAICurrencyDetails::OAICurrencyDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyDetails::OAICurrencyDetails() {
    this->initializeModel();
}

OAICurrencyDetails::~OAICurrencyDetails() {}

void OAICurrencyDetails::initializeModel() {

    m_code_isSet = false;
    m_code_isValid = false;
}

void OAICurrencyDetails::fromJson(QString jsonString) {
...
void OAICurrencyDetails::fromJsonObject(QJsonObject json) {

    m_code_isValid = ::OpenAPI::fromJsonValue(m_code, json[QString("code")]);
    m_code_isSet = !json[QString("code")].isNull() && m_code_isValid;
}

QString OAICurrencyDetails::asJson() const {
...
QJsonObject OAICurrencyDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAICurrencyDetails::getCode() const {
    return m_code;
}
void OAICurrencyDetails::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAICurrencyDetails::is_code_Set() const{
    return m_code_isSet;
}

bool OAICurrencyDetails::is_code_Valid() const{
    return m_code_isValid;
}

bool OAICurrencyDetails::isSet() const {
...
bool OAICurrencyDetails::isValid() const {
