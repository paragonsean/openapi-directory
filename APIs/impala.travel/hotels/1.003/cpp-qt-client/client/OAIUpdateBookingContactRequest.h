...
/*
 * OAIUpdateBookingContactRequest.h
 *
 * Request body for update contact booking
 */

#ifndef OAIUpdateBookingContactRequest_H
#define OAIUpdateBookingContactRequest_H
...
class OAIUpdateBookingContactRequest : public OAIObject {
public:
    OAIUpdateBookingContactRequest();
    OAIUpdateBookingContactRequest(QString json);
    ~OAIUpdateBookingContactRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBookingContactRequest)

#endif // OAIUpdateBookingContactRequest_H
