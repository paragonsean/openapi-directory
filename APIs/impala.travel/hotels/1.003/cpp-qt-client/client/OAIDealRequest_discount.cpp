...
OAIDealRequest_discount::OAIDealRequest_discount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDealRequest_discount::OAIDealRequest_discount() {
    this->initializeModel();
}

OAIDealRequest_discount::~OAIDealRequest_discount() {}

void OAIDealRequest_discount::initializeModel() {
...
void OAIDealRequest_discount::fromJson(QString jsonString) {
...
void OAIDealRequest_discount::fromJsonObject(QJsonObject json) {
...
QString OAIDealRequest_discount::asJson() const {
...
QJsonObject OAIDealRequest_discount::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIDealRequest_discount::getCount() const {
    return m_count;
}
void OAIDealRequest_discount::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIDealRequest_discount::is_count_Set() const{
    return m_count_isSet;
}

bool OAIDealRequest_discount::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIDealRequest_discount::getType() const {
    return m_type;
}
void OAIDealRequest_discount::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDealRequest_discount::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDealRequest_discount::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDealRequest_discount::isSet() const {
...
bool OAIDealRequest_discount::isValid() const {
