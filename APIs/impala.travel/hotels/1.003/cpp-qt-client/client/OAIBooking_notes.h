...
#ifndef OAIBooking_notes_H
#define OAIBooking_notes_H
...
class OAIBooking_notes : public OAIObject {
public:
    OAIBooking_notes();
    OAIBooking_notes(QString json);
    ~OAIBooking_notes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBooking_notes)

#endif // OAIBooking_notes_H
