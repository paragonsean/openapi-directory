...
/*
 * OAIGuestPaymentErrorStub.h
 *
 * 
 */

#ifndef OAIGuestPaymentErrorStub_H
#define OAIGuestPaymentErrorStub_H
...
class OAIGuestPaymentErrorStub : public OAIObject {
public:
    OAIGuestPaymentErrorStub();
    OAIGuestPaymentErrorStub(QString json);
    ~OAIGuestPaymentErrorStub() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGuestPaymentErrorStub)

#endif // OAIGuestPaymentErrorStub_H
