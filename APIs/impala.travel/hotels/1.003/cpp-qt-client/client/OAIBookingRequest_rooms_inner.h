...
/*
 * OAIBookingRequest_rooms_inner.h
 *
 * 
 */

#ifndef OAIBookingRequest_rooms_inner_H
#define OAIBookingRequest_rooms_inner_H
...
class OAIBookingRequest_rooms_inner : public OAIObject {
public:
    OAIBookingRequest_rooms_inner();
    OAIBookingRequest_rooms_inner(QString json);
    ~OAIBookingRequest_rooms_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBookingRequest_rooms_inner)

#endif // OAIBookingRequest_rooms_inner_H
