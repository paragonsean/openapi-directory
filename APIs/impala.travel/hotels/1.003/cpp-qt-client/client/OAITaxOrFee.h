...
#ifndef OAITaxOrFee_H
#define OAITaxOrFee_H
...
class OAITaxOrFee : public OAIObject {
public:
    OAITaxOrFee();
    OAITaxOrFee(QString json);
    ~OAITaxOrFee() override;
    ...
    OAIMoney getCharges() const;
    void setCharges(const OAIMoney &charges);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxOrFee)
