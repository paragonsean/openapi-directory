...
OAIBookedRoom_roomType::OAIBookedRoom_roomType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBookedRoom_roomType::OAIBookedRoom_roomType() {
    this->initializeModel();
}

OAIBookedRoom_roomType::~OAIBookedRoom_roomType() {}

void OAIBookedRoom_roomType::initializeModel() {
...
void OAIBookedRoom_roomType::fromJson(QString jsonString) {
...
void OAIBookedRoom_roomType::fromJsonObject(QJsonObject json) {
...
QString OAIBookedRoom_roomType::asJson() const {
...
QJsonObject OAIBookedRoom_roomType::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIBookedRoom_roomType::getName() const {
    return m_name;
}
void OAIBookedRoom_roomType::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBookedRoom_roomType::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBookedRoom_roomType::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIBookedRoom_roomType::getRoomTypeId() const {
    return m_room_type_id;
}
void OAIBookedRoom_roomType::setRoomTypeId(const QString &room_type_id) {
    m_room_type_id = room_type_id;
    m_room_type_id_isSet = true;
}

bool OAIBookedRoom_roomType::is_room_type_id_Set() const{
    return m_room_type_id_isSet;
}

bool OAIBookedRoom_roomType::is_room_type_id_Valid() const{
    return m_room_type_id_isValid;
}

bool OAIBookedRoom_roomType::isSet() const {
...
bool OAIBookedRoom_roomType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_room_type_id_isValid && true;
}
