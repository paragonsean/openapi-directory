...
/*
 * OAIDealRequest_sellableInDateRanges_inner.h
 *
 * 
 */

#ifndef OAIDealRequest_sellableInDateRanges_inner_H
#define OAIDealRequest_sellableInDateRanges_inner_H
...
class OAIDealRequest_sellableInDateRanges_inner : public OAIObject {
public:
    OAIDealRequest_sellableInDateRanges_inner();
    OAIDealRequest_sellableInDateRanges_inner(QString json);
    ~OAIDealRequest_sellableInDateRanges_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_sellableInDateRanges_inner)

#endif // OAIDealRequest_sellableInDateRanges_inner_H
