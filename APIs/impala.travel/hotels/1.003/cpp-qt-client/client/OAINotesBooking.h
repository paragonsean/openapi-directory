...
#ifndef OAINotesBooking_H
#define OAINotesBooking_H
...
class OAINotesBooking : public OAIObject {
public:
    OAINotesBooking();
    OAINotesBooking(QString json);
    ~OAINotesBooking() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotesBooking)

#endif // OAINotesBooking_H
