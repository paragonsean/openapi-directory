...
class OAIDealRequest_lengthOfStay : public OAIObject {
public:
    OAIDealRequest_lengthOfStay();
    OAIDealRequest_lengthOfStay(QString json);
    ~OAIDealRequest_lengthOfStay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_lengthOfStay)

#endif // OAIDealRequest_lengthOfStay_H
