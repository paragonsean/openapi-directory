...
/*
 * OAICurrencyDetails.h
 *
 * Details of the currency.
 */

#ifndef OAICurrencyDetails_H
#define OAICurrencyDetails_H
...
class OAICurrencyDetails : public OAIObject {
public:
    OAICurrencyDetails();
    OAICurrencyDetails(QString json);
    ~OAICurrencyDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyDetails)

#endif // OAICurrencyDetails_H
