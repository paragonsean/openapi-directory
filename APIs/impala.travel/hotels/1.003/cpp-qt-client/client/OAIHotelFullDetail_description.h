...
/*
 * OAIHotelFullDetail_description.h
 *
 * 
 */

#ifndef OAIHotelFullDetail_description_H
#define OAIHotelFullDetail_description_H
...
class OAIHotelFullDetail_description : public OAIObject {
public:
    OAIHotelFullDetail_description();
    OAIHotelFullDetail_description(QString json);
    ~OAIHotelFullDetail_description() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHotelFullDetail_description)

#endif // OAIHotelFullDetail_description_H
