...
/*
 * OAIBookedRoom_roomType.h
 *
 * Booked room
 */

#ifndef OAIBookedRoom_roomType_H
#define OAIBookedRoom_roomType_H
...
class OAIBookedRoom_roomType : public OAIObject {
public:
    OAIBookedRoom_roomType();
    OAIBookedRoom_roomType(QString json);
    ~OAIBookedRoom_roomType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBookedRoom_roomType)

#endif // OAIBookedRoom_roomType_H
