...
#ifndef OAIBookingRequest_H
#define OAIBookingRequest_H
...
class OAIBookingRequest : public OAIObject {
public:
    OAIBookingRequest();
    OAIBookingRequest(QString json);
    ~OAIBookingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBookingRequest)

#endif // OAIBookingRequest_H
