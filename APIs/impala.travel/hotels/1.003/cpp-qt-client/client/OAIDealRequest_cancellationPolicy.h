...
/*
 * OAIDealRequest_cancellationPolicy.h
 *
...
#ifndef OAIDealRequest_cancellationPolicy_H
#define OAIDealRequest_cancellationPolicy_H
...
class OAIDealRequest_cancellationPolicy : public OAIObject {
public:
    OAIDealRequest_cancellationPolicy();
    OAIDealRequest_cancellationPolicy(QString json);
    ~OAIDealRequest_cancellationPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDealRequest_cancellationPolicy)

#endif // OAIDealRequest_cancellationPolicy_H
