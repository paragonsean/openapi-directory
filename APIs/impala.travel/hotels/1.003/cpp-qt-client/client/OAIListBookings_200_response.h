...
/*
 * OAIListBookings_200_response.h
 *
 * 
 */

#ifndef OAIListBookings_200_response_H
#define OAIListBookings_200_response_H
...
class OAIListBookings_200_response : public OAIObject {
public:
    OAIListBookings_200_response();
    OAIListBookings_200_response(QString json);
    ~OAIListBookings_200_response() override;
    ...
    QList<OAIBooking> getData() const;
    void setData(const QList<OAIBooking> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBookings_200_response)

#endif // OAIListBookings_200_response_H
