...
/*
 * OAIUpdateBookingRequestWithRatePlans.h
 *
 * 
 */

#ifndef OAIUpdateBookingRequestWithRatePlans_H
#define OAIUpdateBookingRequestWithRatePlans_H
...
class OAIUpdateBookingRequestWithRatePlans : public OAIObject {
public:
    OAIUpdateBookingRequestWithRatePlans();
    OAIUpdateBookingRequestWithRatePlans(QString json);
    ~OAIUpdateBookingRequestWithRatePlans() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBookingRequestWithRatePlans)

#endif // OAIUpdateBookingRequestWithRatePlans_H
