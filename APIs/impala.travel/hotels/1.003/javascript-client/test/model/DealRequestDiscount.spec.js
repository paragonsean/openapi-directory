...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestDiscount();
  });
  ...
  describe('DealRequestDiscount', function() {
    it('should create an instance of DealRequestDiscount', function() {
      // uncomment below and update the code to test DealRequestDiscount
      //var instance = new ImpalaHotelBookingApi.DealRequestDiscount();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestDiscount);
    });
