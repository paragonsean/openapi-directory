...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementStubDiscount();
  });
  ...
  describe('HotelAgreementStubDiscount', function() {
    it('should create an instance of HotelAgreementStubDiscount', function() {
      // uncomment below and update the code to test HotelAgreementStubDiscount
      //var instance = new ImpalaHotelBookingApi.HotelAgreementStubDiscount();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementStubDiscount);
    });
