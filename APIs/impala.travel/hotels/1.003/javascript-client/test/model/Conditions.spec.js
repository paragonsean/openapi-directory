...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.Conditions();
  });
  ...
  describe('Conditions', function() {
    it('should create an instance of Conditions', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.Conditions();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.Conditions);
    });

    it('should have the property cancellationDeadline (base name: "cancellationDeadline")', function() {
      // uncomment below and update the code to test the property cancellationDeadline
      //var instance = new ImpalaHotelBookingApi.Conditions();
