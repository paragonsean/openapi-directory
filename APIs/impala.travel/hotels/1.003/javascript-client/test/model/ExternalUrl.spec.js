...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.ExternalUrl();
  });
  ...
  describe('ExternalUrl', function() {
    it('should create an instance of ExternalUrl', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.ExternalUrl();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.ExternalUrl);
    });
