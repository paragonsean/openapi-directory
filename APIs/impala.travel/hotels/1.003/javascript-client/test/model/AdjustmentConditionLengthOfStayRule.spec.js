...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRule();
  });
  ...
  describe('AdjustmentConditionLengthOfStayRule', function() {
    it('should create an instance of AdjustmentConditionLengthOfStayRule', function() {
      // uncomment below and update the code to test AdjustmentConditionLengthOfStayRule
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRule();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRule);
    });
