...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestStayDateRangesInner();
  });
  ...
  describe('DealRequestStayDateRangesInner', function() {
    it('should create an instance of DealRequestStayDateRangesInner', function() {
      // uncomment below and update the code to test DealRequestStayDateRangesInner
      //var instance = new ImpalaHotelBookingApi.DealRequestStayDateRangesInner();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestStayDateRangesInner);
    });
