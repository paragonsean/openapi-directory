...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.ValidationResult();
  });
  ...
  describe('ValidationResult', function() {
    it('should create an instance of ValidationResult', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.ValidationResult();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.ValidationResult);
    });
