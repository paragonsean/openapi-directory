...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.TaxOrFee();
  });
  ...
  describe('TaxOrFee', function() {
    it('should create an instance of TaxOrFee', function() {
      // uncomment below and update the code to test TaxOrFee
      //var instance = new ImpalaHotelBookingApi.TaxOrFee();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.TaxOrFee);
    });
