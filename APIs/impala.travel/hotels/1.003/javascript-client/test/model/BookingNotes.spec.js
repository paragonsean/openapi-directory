...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingNotes();
  });
  ...
  describe('BookingNotes', function() {
    it('should create an instance of BookingNotes', function() {
      // uncomment below and update the code to test BookingNotes
      //var instance = new ImpalaHotelBookingApi.BookingNotes();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingNotes);
    });
