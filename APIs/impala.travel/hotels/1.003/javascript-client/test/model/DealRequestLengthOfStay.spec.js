...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestLengthOfStay();
  });
  ...
  describe('DealRequestLengthOfStay', function() {
    it('should create an instance of DealRequestLengthOfStay', function() {
      // uncomment below and update the code to test DealRequestLengthOfStay
      //var instance = new ImpalaHotelBookingApi.DealRequestLengthOfStay();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestLengthOfStay);
    });
