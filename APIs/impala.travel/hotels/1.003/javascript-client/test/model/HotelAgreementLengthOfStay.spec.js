...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementLengthOfStay();
  });
  ...
  describe('HotelAgreementLengthOfStay', function() {
    it('should create an instance of HotelAgreementLengthOfStay', function() {
      // uncomment below and update the code to test HotelAgreementLengthOfStay
      //var instance = new ImpalaHotelBookingApi.HotelAgreementLengthOfStay();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementLengthOfStay);
    });
