...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatesPerDateStaythrough();
  });
  ...
  describe('RatesPerDateStaythrough', function() {
    it('should create an instance of RatesPerDateStaythrough', function() {
      // uncomment below and update the code to test RatesPerDateStaythrough
      //var instance = new ImpalaHotelBookingApi.RatesPerDateStaythrough();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatesPerDateStaythrough);
    });
