...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRoomPrice();
  });
  ...
  describe('RatePlanRoomPrice', function() {
    it('should create an instance of RatePlanRoomPrice', function() {
      // uncomment below and update the code to test RatePlanRoomPrice
      //var instance = new ImpalaHotelBookingApi.RatePlanRoomPrice();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRoomPrice);
    });
