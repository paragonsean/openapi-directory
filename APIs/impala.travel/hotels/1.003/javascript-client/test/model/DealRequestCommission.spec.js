...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestCommission();
  });
  ...
  describe('DealRequestCommission', function() {
    it('should create an instance of DealRequestCommission', function() {
      // uncomment below and update the code to test DealRequestCommission
      //var instance = new ImpalaHotelBookingApi.DealRequestCommission();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestCommission);
    });
