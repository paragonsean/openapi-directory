...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequest();
  });
  ...
  describe('DealRequest', function() {
    it('should create an instance of DealRequest', function() {
      // uncomment below and update the code to test DealRequest
      //var instance = new ImpalaHotelBookingApi.DealRequest();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequest);
    });

    it('should have the property bookingWindowRestriction (base name: "bookingWindowRestriction")', function() {
      // uncomment below and update the code to test the property bookingWindowRestriction
      //var instance = new ImpalaHotelBookingApi.DealRequest();
    ...
    it('should have the property dealRequestId (base name: "dealRequestId")', function() {
      // uncomment below and update the code to test the property dealRequestId
      //var instance = new ImpalaHotelBookingApi.DealRequest();
      //expect(instance).to.be();
    });

    it('should have the property dealRequestStatus (base name: "dealRequestStatus")', function() {
      // uncomment below and update the code to test the property dealRequestStatus
      //var instance = new ImpalaHotelBookingApi.DealRequest();
      //expect(instance).to.be();
    });
