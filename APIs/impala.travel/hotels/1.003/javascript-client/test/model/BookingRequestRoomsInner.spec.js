...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingRequestRoomsInner();
  });
  ...
  describe('BookingRequestRoomsInner', function() {
    it('should create an instance of BookingRequestRoomsInner', function() {
      // uncomment below and update the code to test BookingRequestRoomsInner
      //var instance = new ImpalaHotelBookingApi.BookingRequestRoomsInner();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingRequestRoomsInner);
    });
