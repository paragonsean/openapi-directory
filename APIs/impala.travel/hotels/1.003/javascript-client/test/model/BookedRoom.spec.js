...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookedRoom();
  });
  ...
  describe('BookedRoom', function() {
    it('should create an instance of BookedRoom', function() {
      // uncomment below and update the code to test BookedRoom
      //var instance = new ImpalaHotelBookingApi.BookedRoom();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookedRoom);
    });
