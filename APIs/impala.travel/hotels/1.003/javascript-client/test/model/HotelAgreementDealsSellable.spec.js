...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementDealsSellable();
  });
  ...
  describe('HotelAgreementDealsSellable', function() {
    it('should create an instance of HotelAgreementDealsSellable', function() {
      // uncomment below and update the code to test HotelAgreementDealsSellable
      //var instance = new ImpalaHotelBookingApi.HotelAgreementDealsSellable();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementDealsSellable);
    });
