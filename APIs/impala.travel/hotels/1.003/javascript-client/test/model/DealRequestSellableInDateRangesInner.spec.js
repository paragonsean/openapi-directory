...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestSellableInDateRangesInner();
  });
  ...
  describe('DealRequestSellableInDateRangesInner', function() {
    it('should create an instance of DealRequestSellableInDateRangesInner', function() {
      // uncomment below and update the code to test DealRequestSellableInDateRangesInner
      //var instance = new ImpalaHotelBookingApi.DealRequestSellableInDateRangesInner();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestSellableInDateRangesInner);
    });
