...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlan();
  });
  ...
  describe('RatePlan', function() {
    it('should create an instance of RatePlan', function() {
      // uncomment below and update the code to test RatePlan
      //var instance = new ImpalaHotelBookingApi.RatePlan();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlan);
    });
    ...
    it('should have the property ratePlanId (base name: "ratePlanId")', function() {
      // uncomment below and update the code to test the property ratePlanId
      //var instance = new ImpalaHotelBookingApi.RatePlan();
      //expect(instance).to.be();
    });
