...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.Pagination();
  });
  ...
  describe('Pagination', function() {
    it('should create an instance of Pagination', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.Pagination();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.Pagination);
    });
