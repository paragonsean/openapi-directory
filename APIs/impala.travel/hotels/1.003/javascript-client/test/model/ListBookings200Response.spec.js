...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.ListBookings200Response();
  });
  ...
  describe('ListBookings200Response', function() {
    it('should create an instance of ListBookings200Response', function() {
      // uncomment below and update the code to test ListBookings200Response
      //var instance = new ImpalaHotelBookingApi.ListBookings200Response();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.ListBookings200Response);
    });
