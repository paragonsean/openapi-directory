...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesBookableDateRange();
  });
  ...
  describe('AdjustmentConditionLengthOfStayRuleRulesBookableDateRange', function() {
    it('should create an instance of AdjustmentConditionLengthOfStayRuleRulesBookableDateRange', function() {
      // uncomment below and update the code to test AdjustmentConditionLengthOfStayRuleRulesBookableDateRange
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesBookableDateRange();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesBookableDateRange);
    });
