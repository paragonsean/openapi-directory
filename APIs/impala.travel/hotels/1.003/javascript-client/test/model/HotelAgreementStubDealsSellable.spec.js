...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementStubDealsSellable();
  });
  ...
  describe('HotelAgreementStubDealsSellable', function() {
    it('should create an instance of HotelAgreementStubDealsSellable', function() {
      // uncomment below and update the code to test HotelAgreementStubDealsSellable
      //var instance = new ImpalaHotelBookingApi.HotelAgreementStubDealsSellable();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementStubDealsSellable);
    });
