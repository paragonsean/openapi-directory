...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingRequest();
  });
  ...
  describe('BookingRequest', function() {
    it('should create an instance of BookingRequest', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.BookingRequest();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingRequest);
    });
