...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.UpdateBookingRequestWithRatePlans();
  });
  ...
  describe('UpdateBookingRequestWithRatePlans', function() {
    it('should create an instance of UpdateBookingRequestWithRatePlans', function() {
      // uncomment below and update the code to test UpdateBookingRequestWithRatePlans
      //var instance = new ImpalaHotelBookingApi.UpdateBookingRequestWithRatePlans();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.UpdateBookingRequestWithRatePlans);
    });
    ...
    it('should have the property updateBookingVersionAtTimestamp (base name: "updateBookingVersionAtTimestamp")', function() {
      // uncomment below and update the code to test the property updateBookingVersionAtTimestamp
      //var instance = new ImpalaHotelBookingApi.UpdateBookingRequestWithRatePlans();
      //expect(instance).to.be();
    });
