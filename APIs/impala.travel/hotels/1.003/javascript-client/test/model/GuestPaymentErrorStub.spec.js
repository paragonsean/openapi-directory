...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.GuestPaymentErrorStub();
  });
  ...
  describe('GuestPaymentErrorStub', function() {
    it('should create an instance of GuestPaymentErrorStub', function() {
      // uncomment below and update the code to test GuestPaymentErrorStub
      //var instance = new ImpalaHotelBookingApi.GuestPaymentErrorStub();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.GuestPaymentErrorStub);
    });
