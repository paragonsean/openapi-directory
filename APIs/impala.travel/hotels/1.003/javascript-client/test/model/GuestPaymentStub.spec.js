...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.GuestPaymentStub();
  });
  ...
  describe('GuestPaymentStub', function() {
    it('should create an instance of GuestPaymentStub', function() {
      // uncomment below and update the code to test GuestPaymentStub
      //var instance = new ImpalaHotelBookingApi.GuestPaymentStub();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.GuestPaymentStub);
    });

    it('should have the property authorisationRedirectUrl (base name: "authorisationRedirectUrl")', function() {
      // uncomment below and update the code to test the property authorisationRedirectUrl
      //var instance = new ImpalaHotelBookingApi.GuestPaymentStub();
