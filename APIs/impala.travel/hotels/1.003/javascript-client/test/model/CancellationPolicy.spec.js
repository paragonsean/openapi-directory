...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.CancellationPolicy();
  });
  ...
  describe('CancellationPolicy', function() {
    it('should create an instance of CancellationPolicy', function() {
      // uncomment below and update the code to test CancellationPolicy
      //var instance = new ImpalaHotelBookingApi.CancellationPolicy();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.CancellationPolicy);
    });
