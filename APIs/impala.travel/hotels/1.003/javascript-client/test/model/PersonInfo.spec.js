...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.PersonInfo();
  });
  ...
  describe('PersonInfo', function() {
    it('should create an instance of PersonInfo', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.PersonInfo();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.PersonInfo);
    });
