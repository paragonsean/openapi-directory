...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRules();
  });
  ...
  describe('AdjustmentConditionLengthOfStayRuleRules', function() {
    it('should create an instance of AdjustmentConditionLengthOfStayRuleRules', function() {
      // uncomment below and update the code to test AdjustmentConditionLengthOfStayRuleRules
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRules();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRules);
    });

    it('should have the property bookableDateRange (base name: "bookableDateRange")', function() {
      // uncomment below and update the code to test the property bookableDateRange
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRules();
      //expect(instance).to.be();
    });

    it('should have the property nightsRange (base name: "nightsRange")', function() {
      // uncomment below and update the code to test the property nightsRange
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRules();
      //expect(instance).to.be();
    });
