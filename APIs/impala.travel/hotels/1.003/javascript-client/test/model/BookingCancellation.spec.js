...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingCancellation();
  });
  ...
  describe('BookingCancellation', function() {
    it('should create an instance of BookingCancellation', function() {
      // uncomment below and update the code to test BookingCancellation
      //var instance = new ImpalaHotelBookingApi.BookingCancellation();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingCancellation);
    });
