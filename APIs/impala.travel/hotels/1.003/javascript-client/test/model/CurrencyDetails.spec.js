...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.CurrencyDetails();
  });
  ...
  describe('CurrencyDetails', function() {
    it('should create an instance of CurrencyDetails', function() {
      // uncomment below and update the code to test CurrencyDetails
      //var instance = new ImpalaHotelBookingApi.CurrencyDetails();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.CurrencyDetails);
    });
