...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRestrictionsLengthOfStay();
  });
  ...
  describe('RatePlanRestrictionsLengthOfStay', function() {
    it('should create an instance of RatePlanRestrictionsLengthOfStay', function() {
      // uncomment below and update the code to test RatePlanRestrictionsLengthOfStay
      //var instance = new ImpalaHotelBookingApi.RatePlanRestrictionsLengthOfStay();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRestrictionsLengthOfStay);
    });
