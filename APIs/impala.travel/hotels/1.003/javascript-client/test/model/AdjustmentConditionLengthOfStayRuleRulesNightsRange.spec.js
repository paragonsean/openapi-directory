...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesNightsRange();
  });
  ...
  describe('AdjustmentConditionLengthOfStayRuleRulesNightsRange', function() {
    it('should create an instance of AdjustmentConditionLengthOfStayRuleRulesNightsRange', function() {
      // uncomment below and update the code to test AdjustmentConditionLengthOfStayRuleRulesNightsRange
      //var instance = new ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesNightsRange();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.AdjustmentConditionLengthOfStayRuleRulesNightsRange);
    });
