...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookedRoomRoomType();
  });
  ...
  describe('BookedRoomRoomType', function() {
    it('should create an instance of BookedRoomRoomType', function() {
      // uncomment below and update the code to test BookedRoomRoomType
      //var instance = new ImpalaHotelBookingApi.BookedRoomRoomType();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookedRoomRoomType);
    });
