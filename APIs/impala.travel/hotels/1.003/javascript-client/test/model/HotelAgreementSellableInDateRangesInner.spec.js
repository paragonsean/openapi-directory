...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementSellableInDateRangesInner();
  });
  ...
  describe('HotelAgreementSellableInDateRangesInner', function() {
    it('should create an instance of HotelAgreementSellableInDateRangesInner', function() {
      // uncomment below and update the code to test HotelAgreementSellableInDateRangesInner
      //var instance = new ImpalaHotelBookingApi.HotelAgreementSellableInDateRangesInner();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementSellableInDateRangesInner);
    });
