...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookedRate();
  });
  ...
  describe('BookedRate', function() {
    it('should create an instance of BookedRate', function() {
      // uncomment below and update the code to test BookedRate
      //var instance = new ImpalaHotelBookingApi.BookedRate();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookedRate);
    });

    it('should have the property cancellationPolicies (base name: "cancellationPolicies")', function() {
    ...
    it('should have the property hotelAgreement (base name: "hotelAgreement")', function() {
      // uncomment below and update the code to test the property hotelAgreement
      //var instance = new ImpalaHotelBookingApi.BookedRate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property retailRate (base name: "retailRate")', function() {
      // uncomment below and update the code to test the property retailRate
      //var instance = new ImpalaHotelBookingApi.BookedRate();
      //expect(instance).to.be();
    });

    it('should have the property sellerCommissionPercentage (base name: "sellerCommissionPercentage")', function() {
      // uncomment below and update the code to test the property sellerCommissionPercentage
      //var instance = new ImpalaHotelBookingApi.BookedRate();
      //expect(instance).to.be();
    });
