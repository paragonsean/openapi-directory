...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRoom();
  });
  ...
  describe('RatePlanRoom', function() {
    it('should create an instance of RatePlanRoom', function() {
      // uncomment below and update the code to test RatePlanRoom
      //var instance = new ImpalaHotelBookingApi.RatePlanRoom();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRoom);
    });
    ...
    it('should have the property roomTypeId (base name: "roomTypeId")', function() {
      // uncomment below and update the code to test the property roomTypeId
      //var instance = new ImpalaHotelBookingApi.RatePlanRoom();
      //expect(instance).to.be();
    });
