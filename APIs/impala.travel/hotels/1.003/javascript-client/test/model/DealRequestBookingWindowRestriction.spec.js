...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestBookingWindowRestriction();
  });
  ...
  describe('DealRequestBookingWindowRestriction', function() {
    it('should create an instance of DealRequestBookingWindowRestriction', function() {
      // uncomment below and update the code to test DealRequestBookingWindowRestriction
      //var instance = new ImpalaHotelBookingApi.DealRequestBookingWindowRestriction();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestBookingWindowRestriction);
    });

    it('should have the property maxDaysBeforeCheckIn (base name: "maxDaysBeforeCheckIn")', function() {
      // uncomment below and update the code to test the property maxDaysBeforeCheckIn
      //var instance = new ImpalaHotelBookingApi.DealRequestBookingWindowRestriction();
      //expect(instance).to.be();
    });

    it('should have the property minDaysBeforeCheckIn (base name: "minDaysBeforeCheckIn")', function() {
      // uncomment below and update the code to test the property minDaysBeforeCheckIn
      //var instance = new ImpalaHotelBookingApi.DealRequestBookingWindowRestriction();
      //expect(instance).to.be();
    });
