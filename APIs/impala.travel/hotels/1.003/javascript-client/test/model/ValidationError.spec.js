...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.ValidationError();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.ValidationError);
    });
