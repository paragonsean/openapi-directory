...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookedRateRetailRate();
  });
  ...
  describe('BookedRateRetailRate', function() {
    it('should create an instance of BookedRateRetailRate', function() {
      // uncomment below and update the code to test BookedRateRetailRate
      //var instance = new ImpalaHotelBookingApi.BookedRateRetailRate();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookedRateRetailRate);
    });
