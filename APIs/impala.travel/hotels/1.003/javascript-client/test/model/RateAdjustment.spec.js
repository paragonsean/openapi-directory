...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RateAdjustment();
  });
  ...
  describe('RateAdjustment', function() {
    it('should create an instance of RateAdjustment', function() {
      // uncomment below and update the code to test RateAdjustment
      //var instance = new ImpalaHotelBookingApi.RateAdjustment();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RateAdjustment);
    });
