...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementCancellationPolicy();
  });
  ...
  describe('HotelAgreementCancellationPolicy', function() {
    it('should create an instance of HotelAgreementCancellationPolicy', function() {
      // uncomment below and update the code to test HotelAgreementCancellationPolicy
      //var instance = new ImpalaHotelBookingApi.HotelAgreementCancellationPolicy();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementCancellationPolicy);
    });
