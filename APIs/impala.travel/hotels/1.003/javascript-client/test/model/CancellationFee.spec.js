...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.CancellationFee();
  });
  ...
  describe('CancellationFee', function() {
    it('should create an instance of CancellationFee', function() {
      // uncomment below and update the code to test CancellationFee
      //var instance = new ImpalaHotelBookingApi.CancellationFee();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.CancellationFee);
    });
