...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRate();
  });
  ...
  describe('RatePlanRate', function() {
    it('should create an instance of RatePlanRate', function() {
      // uncomment below and update the code to test RatePlanRate
      //var instance = new ImpalaHotelBookingApi.RatePlanRate();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRate);
    });
