...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookedRateRetailRateTaxesAndFees();
  });
  ...
  describe('BookedRateRetailRateTaxesAndFees', function() {
    it('should create an instance of BookedRateRetailRateTaxesAndFees', function() {
      // uncomment below and update the code to test BookedRateRetailRateTaxesAndFees
      //var instance = new ImpalaHotelBookingApi.BookedRateRetailRateTaxesAndFees();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookedRateRetailRateTaxesAndFees);
    });
    ...
    it('should have the property payAtHotel (base name: "payAtHotel")', function() {
      // uncomment below and update the code to test the property payAtHotel
      //var instance = new ImpalaHotelBookingApi.BookedRateRetailRateTaxesAndFees();
      //expect(instance).to.be();
    });
