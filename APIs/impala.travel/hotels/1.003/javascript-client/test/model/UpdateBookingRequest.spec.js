...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.UpdateBookingRequest();
  });
  ...
  describe('UpdateBookingRequest', function() {
    it('should create an instance of UpdateBookingRequest', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.UpdateBookingRequest();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.UpdateBookingRequest);
    });
