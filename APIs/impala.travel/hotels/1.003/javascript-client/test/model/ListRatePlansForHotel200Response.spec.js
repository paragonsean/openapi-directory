...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.ListRatePlansForHotel200Response();
  });
  ...
  describe('ListRatePlansForHotel200Response', function() {
    it('should create an instance of ListRatePlansForHotel200Response', function() {
      // uncomment below and update the code to test ListRatePlansForHotel200Response
      //var instance = new ImpalaHotelBookingApi.ListRatePlansForHotel200Response();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.ListRatePlansForHotel200Response);
    });
