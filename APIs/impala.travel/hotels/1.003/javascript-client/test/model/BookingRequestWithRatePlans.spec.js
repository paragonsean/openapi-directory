...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingRequestWithRatePlans();
  });
  ...
  describe('BookingRequestWithRatePlans', function() {
    it('should create an instance of BookingRequestWithRatePlans', function() {
      // uncomment below and update the code to test BookingRequestWithRatePlans
      //var instance = new ImpalaHotelBookingApi.BookingRequestWithRatePlans();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingRequestWithRatePlans);
    });

    it('should have the property bookingContact (base name: "bookingContact")', function() {
      // uncomment below and update the code to test the property bookingContact
      //var instance = new ImpalaHotelBookingApi.BookingRequestWithRatePlans();
