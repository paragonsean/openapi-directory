...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.UpdateBookingContactRequest();
  });
  ...
  describe('UpdateBookingContactRequest', function() {
    it('should create an instance of UpdateBookingContactRequest', function() {
      // uncomment below and update the code to test UpdateBookingContactRequest
      //var instance = new ImpalaHotelBookingApi.UpdateBookingContactRequest();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.UpdateBookingContactRequest);
    });
