...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.GenericError();
  });
  ...
  describe('GenericError', function() {
    it('should create an instance of GenericError', function() {
      ...
      //var instance = new ImpalaHotelBookingApi.GenericError();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.GenericError);
    });
