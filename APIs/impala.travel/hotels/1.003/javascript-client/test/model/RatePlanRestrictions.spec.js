...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRestrictions();
  });
  ...
  describe('RatePlanRestrictions', function() {
    it('should create an instance of RatePlanRestrictions', function() {
      // uncomment below and update the code to test RatePlanRestrictions
      //var instance = new ImpalaHotelBookingApi.RatePlanRestrictions();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRestrictions);
    });
