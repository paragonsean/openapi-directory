...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingContact();
  });
  ...
  describe('BookingContact', function() {
    it('should create an instance of BookingContact', function() {
      // uncomment below and update the code to test BookingContact
      //var instance = new ImpalaHotelBookingApi.BookingContact();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.BookingContact);
    });
