...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatesPerDate();
  });
  ...
  describe('RatesPerDate', function() {
    it('should create an instance of RatesPerDate', function() {
      // uncomment below and update the code to test RatesPerDate
      //var instance = new ImpalaHotelBookingApi.RatesPerDate();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatesPerDate);
    });
    ...
    it('should have the property closedToArrival (base name: "closedToArrival")', function() {
      // uncomment below and update the code to test the property closedToArrival
      //var instance = new ImpalaHotelBookingApi.RatesPerDate();
      //expect(instance).to.be();
    });

    it('should have the property closedToDeparture (base name: "closedToDeparture")', function() {
    ...
    it('should have the property staythrough (base name: "staythrough")', function() {
      // uncomment below and update the code to test the property staythrough
      //var instance = new ImpalaHotelBookingApi.RatesPerDate();
      //expect(instance).to.be();
    });
