...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementDiscount();
  });
  ...
  describe('HotelAgreementDiscount', function() {
    it('should create an instance of HotelAgreementDiscount', function() {
      // uncomment below and update the code to test HotelAgreementDiscount
      //var instance = new ImpalaHotelBookingApi.HotelAgreementDiscount();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementDiscount);
    });
