...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementCommission();
  });
  ...
  describe('HotelAgreementCommission', function() {
    it('should create an instance of HotelAgreementCommission', function() {
      // uncomment below and update the code to test HotelAgreementCommission
      //var instance = new ImpalaHotelBookingApi.HotelAgreementCommission();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementCommission);
    });
