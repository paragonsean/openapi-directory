...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelFullDetailDescription();
  });
  ...
  describe('HotelFullDetailDescription', function() {
    it('should create an instance of HotelFullDetailDescription', function() {
      // uncomment below and update the code to test HotelFullDetailDescription
      //var instance = new ImpalaHotelBookingApi.HotelFullDetailDescription();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelFullDetailDescription);
    });
