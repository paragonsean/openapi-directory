...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.NotesBookedRoom();
  });
  ...
  describe('NotesBookedRoom', function() {
    it('should create an instance of NotesBookedRoom', function() {
      // uncomment below and update the code to test NotesBookedRoom
      //var instance = new ImpalaHotelBookingApi.NotesBookedRoom();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.NotesBookedRoom);
    });
