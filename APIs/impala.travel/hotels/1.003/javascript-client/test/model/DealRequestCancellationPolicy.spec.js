...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.DealRequestCancellationPolicy();
  });
  ...
  describe('DealRequestCancellationPolicy', function() {
    it('should create an instance of DealRequestCancellationPolicy', function() {
      // uncomment below and update the code to test DealRequestCancellationPolicy
      //var instance = new ImpalaHotelBookingApi.DealRequestCancellationPolicy();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.DealRequestCancellationPolicy);
    });
