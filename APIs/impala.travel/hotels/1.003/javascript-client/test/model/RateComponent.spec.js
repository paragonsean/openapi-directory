...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RateComponent();
  });
  ...
  describe('RateComponent', function() {
    it('should create an instance of RateComponent', function() {
      // uncomment below and update the code to test RateComponent
      //var instance = new ImpalaHotelBookingApi.RateComponent();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RateComponent);
    });
    ...
    it('should have the property includedInRate (base name: "includedInRate")', function() {
      // uncomment below and update the code to test the property includedInRate
      //var instance = new ImpalaHotelBookingApi.RateComponent();
      //expect(instance).to.be();
    });
