...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RatePlanRoomType();
  });
  ...
  describe('RatePlanRoomType', function() {
    it('should create an instance of RatePlanRoomType', function() {
      // uncomment below and update the code to test RatePlanRoomType
      //var instance = new ImpalaHotelBookingApi.RatePlanRoomType();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.RatePlanRoomType);
    });
