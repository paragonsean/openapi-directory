...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelAgreementStub();
  });
  ...
  describe('HotelAgreementStub', function() {
    it('should create an instance of HotelAgreementStub', function() {
      // uncomment below and update the code to test HotelAgreementStub
      //var instance = new ImpalaHotelBookingApi.HotelAgreementStub();
      //expect(instance).to.be.a(ImpalaHotelBookingApi.HotelAgreementStub);
    });
