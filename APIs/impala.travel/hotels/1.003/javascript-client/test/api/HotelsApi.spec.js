...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.HotelsApi();
  });
  ...
  describe('HotelsApi', function() {
    describe('listHotels', function() {
      it('should call listHotels successfully', function(done) {
        //uncomment below and update the code to test listHotels
        //instance.listHotels(function(error) {
    ...
    describe('retrieveHotel', function() {
      it('should call retrieveHotel successfully', function(done) {
        //uncomment below and update the code to test retrieveHotel
        //instance.retrieveHotel(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
