...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.BookingsApi();
  });
  ...
  describe('BookingsApi', function() {
    ...
    describe('listBookings', function() {
      it('should call listBookings successfully', function(done) {
        //uncomment below and update the code to test listBookings
        //instance.listBookings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateBookingContact', function() {
      it('should call updateBookingContact successfully', function(done) {
        //uncomment below and update the code to test updateBookingContact
        //instance.updateBookingContact(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
