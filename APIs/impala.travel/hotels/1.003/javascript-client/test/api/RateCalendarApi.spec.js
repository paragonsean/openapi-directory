...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ImpalaHotelBookingApi.RateCalendarApi();
  });
  ...
  describe('RateCalendarApi', function() {
    describe('listRatePlanForHotelForRatePlanId', function() {
      it('should call listRatePlanForHotelForRatePlanId successfully', function(done) {
        //uncomment below and update the code to test listRatePlanForHotelForRatePlanId
        //instance.listRatePlanForHotelForRatePlanId(function(error) {
    ...
    describe('listRatePlansForHotel', function() {
      it('should call listRatePlansForHotel successfully', function(done) {
        //uncomment below and update the code to test listRatePlansForHotel
        //instance.listRatePlansForHotel(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
