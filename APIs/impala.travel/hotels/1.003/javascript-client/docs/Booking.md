# ImpalaHotelBookingApi.Booking

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**bookedRooms** | [**[BookedRoom]**](BookedRoom.md) | List of rooms booked | 
...
**createdAt** | **Date** | Date and time (in UTC and ISO 8601 format) when the booking was created. | 
**end** | **Date** | The departure date of the booking. | 
...
**start** | **Date** | The arrival date of the booking. | 
**status** | **String** | Status of this booking within the Impala platform. When you make a booking, it&#39;ll first appear as &#x60;PENDING&#x60; until we receive the hotel&#39;s confirmation details. At this point your booking will move to &#x60;ACCEPTED&#x60;. | 
**updatedAt** | **Date** | Date and time (in UTC and ISO 8601 format) when the booking was last updated. | 
...
* `PAYMENT_ABANDONED` (value: `"PAYMENT_ABANDONED"`)
