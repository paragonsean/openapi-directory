...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://sandbox.impala.travel/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://sandbox.impala.travel/v1
         */
        ...
        this.authentications = {
            'API_Key_Authentication': {type: 'apiKey', 'in': 'header', name: 'x-api-key'},
            'paymentAuth': {type: 'bearer'} // JWT
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.003/Javascript'
        };
