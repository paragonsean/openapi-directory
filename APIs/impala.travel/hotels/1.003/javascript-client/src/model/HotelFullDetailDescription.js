...
/**
 * The HotelFullDetailDescription model module.
 * @module model/HotelFullDetailDescription
 * @version 1.003
 */
class HotelFullDetailDescription {
    /**
     * Constructs a new <code>HotelFullDetailDescription</code>.
     * @alias module:model/HotelFullDetailDescription
     */
    constructor() { 
        
        HotelFullDetailDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HotelFullDetailDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HotelFullDetailDescription} obj Optional instance to populate.
     * @return {module:model/HotelFullDetailDescription} The populated <code>HotelFullDetailDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HotelFullDetailDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>HotelFullDetailDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HotelFullDetailDescription</code>.
     */
 ...
 * @member {String} short
 */
HotelFullDetailDescription.prototype['short'] = undefined;
...
export default HotelFullDetailDescription;
