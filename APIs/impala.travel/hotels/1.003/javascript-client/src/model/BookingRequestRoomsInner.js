...
/**
 * The BookingRequestRoomsInner model module.
 * @module model/BookingRequestRoomsInner
 * @version 1.003
 */
class BookingRequestRoomsInner {
    /**
     * Constructs a new <code>BookingRequestRoomsInner</code>.
     * @alias module:model/BookingRequestRoomsInner
     * @param adults {Number} The number of adult guests staying in the room.
     * @param rateId {String} The unique identifier of this rate within Impala. Every rate returned in the `roomTypes[].rates[]` array when retrieving hotel availability includes this id.
     */
    constructor(adults, rateId) { 
        
        BookingRequestRoomsInner.initialize(this, adults, rateId);
    }
     ...
     */
    static initialize(obj, adults, rateId) { 
        obj['adults'] = adults;
        obj['rateId'] = rateId;
    }

    /**
     * Constructs a <code>BookingRequestRoomsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BookingRequestRoomsInner} obj Optional instance to populate.
     * @return {module:model/BookingRequestRoomsInner} The populated <code>BookingRequestRoomsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BookingRequestRoomsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>BookingRequestRoomsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BookingRequestRoomsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BookingRequestRoomsInner.RequiredProperties) {
...
BookingRequestRoomsInner.RequiredProperties = ["adults", "rateId"];

/**
 * The number of adult guests staying in the room.
 * @member {Number} adults
 */
BookingRequestRoomsInner.prototype['adults'] = undefined;

/**
 * @member {module:model/NotesBookedRoom} notes
 */
BookingRequestRoomsInner.prototype['notes'] = undefined;
 ...
 */
BookingRequestRoomsInner.prototype['rateId'] = undefined;
...
export default BookingRequestRoomsInner;
