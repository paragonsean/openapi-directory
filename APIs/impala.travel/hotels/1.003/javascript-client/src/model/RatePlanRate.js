...
/**
 * The RatePlanRate model module.
 * @module model/RatePlanRate
 * @version 1.003
 */
class RatePlanRate {
    /**
     * Constructs a new <code>RatePlanRate</code>.
     * @alias module:model/RatePlanRate
     * @param adults {Number} The number of adults in the room for which this price applies.
     * @param retailRate {module:model/Money} 
     * @param roomsSellable {Number} Amount of room which can be sold for this occupancy level and room type at this rate price.
     */
    constructor(adults, retailRate, roomsSellable) { 
        
        RatePlanRate.initialize(this, adults, retailRate, roomsSellable);
    }
     ...
     */
    static initialize(obj, adults, retailRate, roomsSellable) { 
        obj['adults'] = adults;
        obj['retailRate'] = retailRate;
        obj['roomsSellable'] = roomsSellable;
    }

    /**
     * Constructs a <code>RatePlanRate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RatePlanRate} obj Optional instance to populate.
     * @return {module:model/RatePlanRate} The populated <code>RatePlanRate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RatePlanRate();

            if (data.hasOwnProperty('adults')) {
                obj['adults'] = ApiClient.convertToType(data['adults'], 'Number');
            }
            if (data.hasOwnProperty('retailRate')) {
                obj['retailRate'] = Money.constructFromObject(data['retailRate']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RatePlanRate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RatePlanRate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RatePlanRate.RequiredProperties) {
        ...
        if (data['retailRate']) { // data not null
          Money.validateJSON(data['retailRate']);
        }
...
RatePlanRate.RequiredProperties = ["adults", "retailRate", "roomsSellable"];

/**
 * The number of adults in the room for which this price applies.
 * @member {Number} adults
 */
RatePlanRate.prototype['adults'] = undefined;

/**
 * @member {module:model/Money} retailRate
 */
RatePlanRate.prototype['retailRate'] = undefined;

/**
 * Amount of room which can be sold for this occupancy level and room type at this rate price.
 * @member {Number} roomsSellable
 */
RatePlanRate.prototype['roomsSellable'] = undefined;
