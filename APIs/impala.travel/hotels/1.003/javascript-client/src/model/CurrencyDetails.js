...
/**
 * The CurrencyDetails model module.
 * @module model/CurrencyDetails
 * @version 1.003
 */
class CurrencyDetails {
    /**
     * Constructs a new <code>CurrencyDetails</code>.
     * Details of the currency.
     * @alias module:model/CurrencyDetails
     * @param code {String} Three-character currency code in ISO 4217 notation.
     */
    constructor(code) { 
        
        CurrencyDetails.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>CurrencyDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyDetails} obj Optional instance to populate.
     * @return {module:model/CurrencyDetails} The populated <code>CurrencyDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CurrencyDetails.RequiredProperties) {
...
CurrencyDetails.RequiredProperties = ["code"];

/**
 * Three-character currency code in ISO 4217 notation.
 * @member {String} code
 */
CurrencyDetails.prototype['code'] = undefined;
