...
/**
 * The RatesPerDateStaythrough model module.
 * @module model/RatesPerDateStaythrough
 * @version 1.003
 */
class RatesPerDateStaythrough {
    /**
     * Constructs a new <code>RatesPerDateStaythrough</code>.
     * The minimum number of nights (inclusive) that the guest has to book which include the date to be eligible for this rate.
     * @alias module:model/RatesPerDateStaythrough
     * @param min {Number} Expressed in minimum value.
     */
    constructor(min) { 
        
        RatesPerDateStaythrough.initialize(this, min);
    }
    ...
    /**
     * Constructs a <code>RatesPerDateStaythrough</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RatesPerDateStaythrough} obj Optional instance to populate.
     * @return {module:model/RatesPerDateStaythrough} The populated <code>RatesPerDateStaythrough</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RatesPerDateStaythrough();
    ...
    /**
     * Validates the JSON data with respect to <code>RatesPerDateStaythrough</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RatesPerDateStaythrough</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RatesPerDateStaythrough.RequiredProperties) {
...
RatesPerDateStaythrough.RequiredProperties = ["min"];

/**
 * Expressed in minimum value.
 * @member {Number} min
 */
RatesPerDateStaythrough.prototype['min'] = undefined;
...
export default RatesPerDateStaythrough;
