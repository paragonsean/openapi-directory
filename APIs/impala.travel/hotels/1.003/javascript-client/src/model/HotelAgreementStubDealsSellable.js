...
/**
 * The HotelAgreementStubDealsSellable model module.
 * @module model/HotelAgreementStubDealsSellable
 * @version 1.003
 */
class HotelAgreementStubDealsSellable {
    /**
     * Constructs a new <code>HotelAgreementStubDealsSellable</code>.
     * There is a limit to the number of deals that can be sold. 
     * @alias module:model/HotelAgreementStubDealsSellable
     */
    constructor() { 
        
        HotelAgreementStubDealsSellable.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HotelAgreementStubDealsSellable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HotelAgreementStubDealsSellable} obj Optional instance to populate.
     * @return {module:model/HotelAgreementStubDealsSellable} The populated <code>HotelAgreementStubDealsSellable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HotelAgreementStubDealsSellable();
    ...
    /**
     * Validates the JSON data with respect to <code>HotelAgreementStubDealsSellable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HotelAgreementStubDealsSellable</code>.
     */
 ...
 */
HotelAgreementStubDealsSellable.prototype['remaining'] = undefined;
...
export default HotelAgreementStubDealsSellable;
