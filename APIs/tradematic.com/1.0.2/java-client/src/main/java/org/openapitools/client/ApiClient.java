...
public class ApiClient {
    ...
    private String basePath = "https://api.tradematic.com";
    ...
    public ApiClient() {
        ...
        authentications.put("Secured", new ApiKeyAuth("header", "X-API-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.tradematic.com
