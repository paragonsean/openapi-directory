...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TradematicCloudApi.EquityItem();
  });
  ...
  describe('EquityItem', function() {
    it('should create an instance of EquityItem', function() {
      // uncomment below and update the code to test EquityItem
      //var instance = new TradematicCloudApi.EquityItem();
      //expect(instance).to.be.a(TradematicCloudApi.EquityItem);
    });
