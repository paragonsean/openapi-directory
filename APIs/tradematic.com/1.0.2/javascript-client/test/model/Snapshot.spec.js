...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TradematicCloudApi.Snapshot();
  });
  ...
  describe('Snapshot', function() {
    it('should create an instance of Snapshot', function() {
      ...
      //var instance = new TradematicCloudApi.Snapshot();
      //expect(instance).to.be.a(TradematicCloudApi.Snapshot);
    });
    ...
    it('should have the property daynum (base name: "daynum")', function() {
      // uncomment below and update the code to test the property daynum
      //var instance = new TradematicCloudApi.Snapshot();
      //expect(instance).to.be();
    });
