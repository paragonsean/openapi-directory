...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TradematicCloudApi.NewSignal();
  });
  ...
  describe('NewSignal', function() {
    it('should create an instance of NewSignal', function() {
      // uncomment below and update the code to test NewSignal
      //var instance = new TradematicCloudApi.NewSignal();
      //expect(instance).to.be.a(TradematicCloudApi.NewSignal);
    });
