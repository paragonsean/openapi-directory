...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TradematicCloudApi.StatusAPIApi();
  });
  ...
  describe('StatusAPIApi', function() {
    ...
    describe('timeGet', function() {
      it('should call timeGet successfully', function(done) {
        //uncomment below and update the code to test timeGet
        //instance.timeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
