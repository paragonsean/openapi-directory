...
/**
 * The Longexit model module.
 * @module model/Longexit
 * @version 1.0.2
 */
class Longexit {
    /**
     * Constructs a new <code>Longexit</code>.
     * @alias module:model/Longexit
     */
    constructor() { 
        
        Longexit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Longexit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Longexit} obj Optional instance to populate.
     * @return {module:model/Longexit} The populated <code>Longexit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Longexit();
    ...
    /**
     * Validates the JSON data with respect to <code>Longexit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Longexit</code>.
     */
 ...
 * @member {String} id
 */
Longexit.prototype['id'] = undefined;

/**
 * @member {String} name
 */
Longexit.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/Parameter>} parameters
 */
Longexit.prototype['parameters'] = undefined;

/**
 * @member {String} validnot
 */
Longexit.prototype['validnot'] = undefined;

/**
 * @member {String} validor
 */
Longexit.prototype['validor'] = undefined;
