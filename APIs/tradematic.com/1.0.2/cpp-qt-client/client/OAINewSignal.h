...
#ifndef OAINewSignal_H
#define OAINewSignal_H
...
class OAINewSignal : public OAIObject {
public:
    OAINewSignal();
    OAINewSignal(QString json);
    ~OAINewSignal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewSignal)

#endif // OAINewSignal_H
