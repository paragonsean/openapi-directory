...
QString OAITaskresult::getApr() const {
    return m_apr;
}
void OAITaskresult::setApr(const QString &apr) {
    m_apr = apr;
    m_apr_isSet = true;
}

bool OAITaskresult::is_apr_Set() const{
    return m_apr_isSet;
}

bool OAITaskresult::is_apr_Valid() const{
    return m_apr_isValid;
}

QString OAITaskresult::getCurMonthProfit() const {
    return m_cur_month_profit;
}
void OAITaskresult::setCurMonthProfit(const QString &cur_month_profit) {
...
bool OAITaskresult::is_cur_month_profit_Valid() const{
    return m_cur_month_profit_isValid;
}

QString OAITaskresult::getCurYearProfit() const {
    return m_cur_year_profit;
}
void OAITaskresult::setCurYearProfit(const QString &cur_year_profit) {
    m_cur_year_profit = cur_year_profit;
    m_cur_year_profit_isSet = true;
}

bool OAITaskresult::is_cur_year_profit_Set() const{
    return m_cur_year_profit_isSet;
}

bool OAITaskresult::is_cur_year_profit_Valid() const{
    return m_cur_year_profit_isValid;
}

QString OAITaskresult::getDrawdown() const {
    return m_drawdown;
}
void OAITaskresult::setDrawdown(const QString &drawdown) {
    m_drawdown = drawdown;
    m_drawdown_isSet = true;
}

bool OAITaskresult::is_drawdown_Set() const{
    return m_drawdown_isSet;
}

bool OAITaskresult::is_drawdown_Valid() const{
    return m_drawdown_isValid;
}

QString OAITaskresult::getHalfYearProfit() const {
    return m_half_year_profit;
}
void OAITaskresult::setHalfYearProfit(const QString &half_year_profit) {
    m_half_year_profit = half_year_profit;
    m_half_year_profit_isSet = true;
}

bool OAITaskresult::is_half_year_profit_Set() const{
    return m_half_year_profit_isSet;
}

bool OAITaskresult::is_half_year_profit_Valid() const{
    return m_half_year_profit_isValid;
}

QString OAITaskresult::getMonthProfit() const {
    return m_month_profit;
}
void OAITaskresult::setMonthProfit(const QString &month_profit) {
    m_month_profit = month_profit;
    m_month_profit_isSet = true;
}

bool OAITaskresult::is_month_profit_Set() const{
    return m_month_profit_isSet;
}

bool OAITaskresult::is_month_profit_Valid() const{
    return m_month_profit_isValid;
}

QString OAITaskresult::getPrevMonthProfit() const {
    return m_prev_month_profit;
}
void OAITaskresult::setPrevMonthProfit(const QString &prev_month_profit) {
    m_prev_month_profit = prev_month_profit;
    m_prev_month_profit_isSet = true;
}

bool OAITaskresult::is_prev_month_profit_Set() const{
    return m_prev_month_profit_isSet;
}

bool OAITaskresult::is_prev_month_profit_Valid() const{
    return m_prev_month_profit_isValid;
}

QString OAITaskresult::getTotalProfit() const {
    return m_total_profit;
}
void OAITaskresult::setTotalProfit(const QString &total_profit) {
    m_total_profit = total_profit;
    m_total_profit_isSet = true;
}

bool OAITaskresult::is_total_profit_Set() const{
    return m_total_profit_isSet;
}

bool OAITaskresult::is_total_profit_Valid() const{
    return m_total_profit_isValid;
}

QString OAITaskresult::getWeekProfit() const {
    return m_week_profit;
}
void OAITaskresult::setWeekProfit(const QString &week_profit) {
    m_week_profit = week_profit;
    m_week_profit_isSet = true;
}

bool OAITaskresult::is_week_profit_Set() const{
    return m_week_profit_isSet;
}

bool OAITaskresult::is_week_profit_Valid() const{
    return m_week_profit_isValid;
}

QString OAITaskresult::getYearProfit() const {
    return m_year_profit;
}
void OAITaskresult::setYearProfit(const QString &year_profit) {
    m_year_profit = year_profit;
    m_year_profit_isSet = true;
}

bool OAITaskresult::is_year_profit_Set() const{
    return m_year_profit_isSet;
}

bool OAITaskresult::is_year_profit_Valid() const{
