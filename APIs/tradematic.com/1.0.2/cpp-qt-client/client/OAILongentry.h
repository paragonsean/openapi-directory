...
#ifndef OAILongentry_H
#define OAILongentry_H
...
class OAILongentry : public OAIObject {
public:
    OAILongentry();
    OAILongentry(QString json);
    ~OAILongentry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILongentry)

#endif // OAILongentry_H
