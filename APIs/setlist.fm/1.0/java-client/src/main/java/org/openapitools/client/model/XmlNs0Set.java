...
public class XmlNs0Set {
  ...
  private XmlNs0Song song;

  public XmlNs0Set() {
  }

  public XmlNs0Set encore(BigDecimal encore) {
    this.encore = encore;
    return this;
  }
  ...
  public XmlNs0Set name(String name) {
    this.name = name;
    return this;
  }
  ...
  public XmlNs0Set song(XmlNs0Song song) {
    this.song = song;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public XmlNs0Song getSong() {
    return song;
  }

  public void setSong(XmlNs0Song song) {
    this.song = song;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Set xmlNs0Set = (XmlNs0Set) o;
    return Objects.equals(this.encore, xmlNs0Set.encore) &&
        Objects.equals(this.name, xmlNs0Set.name) &&
        Objects.equals(this.song, xmlNs0Set.song);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Set
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Set.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Set is not found in the empty JSON string", XmlNs0Set.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Set.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Set` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("song") != null && !jsonObj.get("song").isJsonNull()) {
        XmlNs0Song.validateJsonElement(jsonObj.get("song"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Set.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Set' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Set> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Set.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Set>() {
           @Override
           public void write(JsonWriter out, XmlNs0Set value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Set read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Set given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Set
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Set
   */
  public static XmlNs0Set fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Set.class);
  }

  /**
   * Convert an instance of XmlNs0Set to an JSON string
   *
   * @return JSON string
   */
