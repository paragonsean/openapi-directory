...
public class XmlNs0Setlists {
  ...
  public XmlNs0Setlists() {
  }

  public XmlNs0Setlists itemsPerPage(BigDecimal itemsPerPage) {
  ...
  public XmlNs0Setlists page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public XmlNs0Setlists total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Setlists xmlNs0Setlists = (XmlNs0Setlists) o;
    return Objects.equals(this.itemsPerPage, xmlNs0Setlists.itemsPerPage) &&
        Objects.equals(this.page, xmlNs0Setlists.page) &&
        Objects.equals(this.total, xmlNs0Setlists.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class XmlNs0Setlists {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Setlists
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Setlists.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Setlists is not found in the empty JSON string", XmlNs0Setlists.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Setlists.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Setlists` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Setlists.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Setlists' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Setlists> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Setlists.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Setlists>() {
           @Override
           public void write(JsonWriter out, XmlNs0Setlists value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Setlists read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Setlists given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Setlists
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Setlists
   */
  public static XmlNs0Setlists fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Setlists.class);
  }

  /**
   * Convert an instance of XmlNs0Setlists to an JSON string
   *
   * @return JSON string
   */
