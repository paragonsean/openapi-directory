...
public class XmlNs0Country {
  ...
  public XmlNs0Country() {
  }

  public XmlNs0Country code(String code) {
    this.code = code;
    return this;
  }
  ...
  public XmlNs0Country name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Country xmlNs0Country = (XmlNs0Country) o;
    return Objects.equals(this.code, xmlNs0Country.code) &&
        Objects.equals(this.name, xmlNs0Country.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Country
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Country.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Country is not found in the empty JSON string", XmlNs0Country.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Country.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Country` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Country.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Country' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Country> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Country.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Country>() {
           @Override
           public void write(JsonWriter out, XmlNs0Country value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Country read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Country given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Country
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Country
   */
  public static XmlNs0Country fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Country.class);
  }

  /**
   * Convert an instance of XmlNs0Country to an JSON string
   *
   * @return JSON string
   */
