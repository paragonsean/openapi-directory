...
public class Class10SearchCountriesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10SearchCountriesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10SearchCountriesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10SearchCountriesGetCountriesGET
     ...
     */
    public okhttp3.Call resource10SearchCountriesGetCountriesGETCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/search/countries";
    ...
    private okhttp3.Call resource10SearchCountriesGetCountriesGETValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return resource10SearchCountriesGetCountriesGETCall(_callback);
     ...
     */
    public JsonCountries resource10SearchCountriesGetCountriesGET() throws ApiException {
        ApiResponse<JsonCountries> localVarResp = resource10SearchCountriesGetCountriesGETWithHttpInfo();
     ...
     * Get a complete list of all supported countries.
     * Get a complete list of all supported countries.
     * @return ApiResponse&lt;JsonCountries&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<JsonCountries> resource10SearchCountriesGetCountriesGETWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = resource10SearchCountriesGetCountriesGETValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<JsonCountries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a complete list of all supported countries. (asynchronously)
     * Get a complete list of all supported countries.
     ...
     */
    public okhttp3.Call resource10SearchCountriesGetCountriesGETAsync(final ApiCallback<JsonCountries> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10SearchCountriesGetCountriesGETValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<JsonCountries>(){}.getType();
