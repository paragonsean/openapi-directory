...
public class XmlNs0Venues {
  ...
  public XmlNs0Venues itemsPerPage(BigDecimal itemsPerPage) {
  ...
  public XmlNs0Venues page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public XmlNs0Venues total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Venues xmlNs0Venues = (XmlNs0Venues) o;
    return Objects.equals(this.itemsPerPage, xmlNs0Venues.itemsPerPage) &&
        Objects.equals(this.page, xmlNs0Venues.page) &&
        Objects.equals(this.total, xmlNs0Venues.total);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Venues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Venues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Venues is not found in the empty JSON string", XmlNs0Venues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Venues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Venues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Venues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Venues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Venues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Venues.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Venues>() {
           @Override
           public void write(JsonWriter out, XmlNs0Venues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Venues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Venues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Venues
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Venues
   */
  public static XmlNs0Venues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Venues.class);
  }

  /**
   * Convert an instance of XmlNs0Venues to an JSON string
   *
   * @return JSON string
   */
