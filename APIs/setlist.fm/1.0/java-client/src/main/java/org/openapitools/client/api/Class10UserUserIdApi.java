...
public class Class10UserUserIdApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10UserUserIdApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10UserUserIdApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10UserUserIdGetUserGET
     ...
     */
    public okhttp3.Call resource10UserUserIdGetUserGETCall(String userId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/user/{userId}"
    ...
    private okhttp3.Call resource10UserUserIdGetUserGETValidateBeforeCall(String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling resource10UserUserIdGetUserGET(Async)");
        }

        return resource10UserUserIdGetUserGETCall(userId, _callback);
     ...
     */
    public JsonUser resource10UserUserIdGetUserGET(String userId) throws ApiException {
        ApiResponse<JsonUser> localVarResp = resource10UserUserIdGetUserGETWithHttpInfo(userId);
     ...
     */
    public ApiResponse<JsonUser> resource10UserUserIdGetUserGETWithHttpInfo(String userId) throws ApiException {
        okhttp3.Call localVarCall = resource10UserUserIdGetUserGETValidateBeforeCall(userId, null);
        Type localVarReturnType = new TypeToken<JsonUser>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a user by userId. (asynchronously)
     * Get a user by userId. (deprecated)  Note: This endpoint always returns a result, even if the user doesn&#39;t exist
     * @param userId the user&#39;s userId (required)
     ...
     */
    public okhttp3.Call resource10UserUserIdGetUserGETAsync(String userId, final ApiCallback<JsonUser> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10UserUserIdGetUserGETValidateBeforeCall(userId, _callback);
        Type localVarReturnType = new TypeToken<JsonUser>(){}.getType();
