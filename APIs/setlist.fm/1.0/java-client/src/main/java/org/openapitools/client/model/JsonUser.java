...
public class JsonUser {
  ...
  public JsonUser about(String about) {
    this.about = about;
    return this;
  }
  ...
  public JsonUser flickr(String flickr) {
    this.flickr = flickr;
    return this;
  }
  ...
  public JsonUser fullname(String fullname) {
  ...
  public JsonUser lastFm(String lastFm) {
    this.lastFm = lastFm;
    return this;
  }
  ...
  public JsonUser mySpace(String mySpace) {
  ...
  public JsonUser twitter(String twitter) {
  ...
  public JsonUser url(String url) {
    this.url = url;
    return this;
  }
  ...
  public JsonUser userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public JsonUser website(String website) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.about, jsonUser.about) &&
        Objects.equals(this.flickr, jsonUser.flickr) &&
        Objects.equals(this.fullname, jsonUser.fullname) &&
        Objects.equals(this.lastFm, jsonUser.lastFm) &&
        Objects.equals(this.mySpace, jsonUser.mySpace) &&
        Objects.equals(this.twitter, jsonUser.twitter) &&
        Objects.equals(this.url, jsonUser.url) &&
        Objects.equals(this.userId, jsonUser.userId) &&
        Objects.equals(this.website, jsonUser.website);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JsonUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonUser is not found in the empty JSON string", JsonUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JsonUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonUser.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonUser>() {
           @Override
  ...
  /**
   * Create an instance of JsonUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JsonUser
   * @throws IOException if the JSON string is invalid with respect to JsonUser
   */
  public static JsonUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonUser.class);
  }

  /**
   * Convert an instance of JsonUser to an JSON string
   *
   * @return JSON string
   */
