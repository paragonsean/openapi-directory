...
public class XmlNs0City {
  ...
  public XmlNs0City coords(XmlNs0Coords coords) {
    this.coords = coords;
    return this;
  }
  ...
  public XmlNs0Coords getCoords() {
    return coords;
  }

  public void setCoords(XmlNs0Coords coords) {
    this.coords = coords;
  }


  public XmlNs0City country(XmlNs0Country country) {
   ...
   */
  @javax.annotation.Nullable
  public XmlNs0Country getCountry() {
    return country;
  }

  public void setCountry(XmlNs0Country country) {
    this.country = country;
  }


  public XmlNs0City id(String id) {
    this.id = id;
    return this;
  }
  ...
  public XmlNs0City name(String name) {
    this.name = name;
    return this;
  }
  ...
  public XmlNs0City state(String state) {
    this.state = state;
    return this;
  }
  ...
  public XmlNs0City stateCode(String stateCode) {
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0City xmlNs0City = (XmlNs0City) o;
    return Objects.equals(this.coords, xmlNs0City.coords) &&
        Objects.equals(this.country, xmlNs0City.country) &&
        Objects.equals(this.id, xmlNs0City.id) &&
        Objects.equals(this.name, xmlNs0City.name) &&
        Objects.equals(this.state, xmlNs0City.state) &&
        Objects.equals(this.stateCode, xmlNs0City.stateCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0City
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0City.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0City is not found in the empty JSON string", XmlNs0City.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0City.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0City` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `coords`
      if (jsonObj.get("coords") != null && !jsonObj.get("coords").isJsonNull()) {
        XmlNs0Coords.validateJsonElement(jsonObj.get("coords"));
      }
      // validate the optional field `country`
      if (jsonObj.get("country") != null && !jsonObj.get("country").isJsonNull()) {
        XmlNs0Country.validateJsonElement(jsonObj.get("country"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0City.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0City' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0City> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0City.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0City>() {
           @Override
           public void write(JsonWriter out, XmlNs0City value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0City read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0City given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0City
   * @throws IOException if the JSON string is invalid with respect to XmlNs0City
   */
  public static XmlNs0City fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0City.class);
  }

  /**
   * Convert an instance of XmlNs0City to an JSON string
   *
   * @return JSON string
   */
