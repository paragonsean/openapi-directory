...
public class Class10VenueVenueIdApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10VenueVenueIdApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10VenueVenueIdApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10VenueVenueIdGetVenueGET
     * @param venueId the venue&#39;s id (required)
     ...
     */
    public okhttp3.Call resource10VenueVenueIdGetVenueGETCall(String venueId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/venue/{venueId}"
    ...
    private okhttp3.Call resource10VenueVenueIdGetVenueGETValidateBeforeCall(String venueId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'venueId' is set
        if (venueId == null) {
            throw new ApiException("Missing the required parameter 'venueId' when calling resource10VenueVenueIdGetVenueGET(Async)");
        }

        return resource10VenueVenueIdGetVenueGETCall(venueId, _callback);
     ...
     */
    public JsonVenue resource10VenueVenueIdGetVenueGET(String venueId) throws ApiException {
        ApiResponse<JsonVenue> localVarResp = resource10VenueVenueIdGetVenueGETWithHttpInfo(venueId);
     ...
     */
    public ApiResponse<JsonVenue> resource10VenueVenueIdGetVenueGETWithHttpInfo(String venueId) throws ApiException {
        okhttp3.Call localVarCall = resource10VenueVenueIdGetVenueGETValidateBeforeCall(venueId, null);
        Type localVarReturnType = new TypeToken<JsonVenue>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a venue by its unique id. (asynchronously)
     * Get a venue by its unique id.
     * @param venueId the venue&#39;s id (required)
     ...
     */
    public okhttp3.Call resource10VenueVenueIdGetVenueGETAsync(String venueId, final ApiCallback<JsonVenue> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10VenueVenueIdGetVenueGETValidateBeforeCall(venueId, _callback);
        Type localVarReturnType = new TypeToken<JsonVenue>(){}.getType();
