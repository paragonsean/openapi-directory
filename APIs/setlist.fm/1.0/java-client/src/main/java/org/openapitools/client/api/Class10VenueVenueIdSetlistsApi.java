...
public class Class10VenueVenueIdSetlistsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10VenueVenueIdSetlistsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10VenueVenueIdSetlistsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10VenueVenueIdSetlistsGetVenueSetlistsGET
     * @param venueId the id of the venue (required)
     ...
     */
    public okhttp3.Call resource10VenueVenueIdSetlistsGetVenueSetlistsGETCall(String venueId, Integer p, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/venue/{venueId}/setlists"
            .replace("{" + "venueId" + "}", localVarApiClient.escapeString(venueId.toString()));
    ...
    private okhttp3.Call resource10VenueVenueIdSetlistsGetVenueSetlistsGETValidateBeforeCall(String venueId, Integer p, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'venueId' is set
        if (venueId == null) {
            throw new ApiException("Missing the required parameter 'venueId' when calling resource10VenueVenueIdSetlistsGetVenueSetlistsGET(Async)");
        }

        return resource10VenueVenueIdSetlistsGetVenueSetlistsGETCall(venueId, p, _callback);
     ...
     */
    public JsonSetlists resource10VenueVenueIdSetlistsGetVenueSetlistsGET(String venueId, Integer p) throws ApiException {
        ApiResponse<JsonSetlists> localVarResp = resource10VenueVenueIdSetlistsGetVenueSetlistsGETWithHttpInfo(venueId, p);
     ...
     */
    public ApiResponse<JsonSetlists> resource10VenueVenueIdSetlistsGetVenueSetlistsGETWithHttpInfo(String venueId, Integer p) throws ApiException {
        okhttp3.Call localVarCall = resource10VenueVenueIdSetlistsGetVenueSetlistsGETValidateBeforeCall(venueId, p, null);
     ...
     */
    public okhttp3.Call resource10VenueVenueIdSetlistsGetVenueSetlistsGETAsync(String venueId, Integer p, final ApiCallback<JsonSetlists> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10VenueVenueIdSetlistsGetVenueSetlistsGETValidateBeforeCall(venueId, p, _callback);
        Type localVarReturnType = new TypeToken<JsonSetlists>(){}.getType();
