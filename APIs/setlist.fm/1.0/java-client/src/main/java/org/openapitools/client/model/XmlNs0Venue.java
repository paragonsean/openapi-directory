...
public class XmlNs0Venue {
  public static final String SERIALIZED_NAME_CITY = "city";
  @SerializedName(SERIALIZED_NAME_CITY)
  private XmlNs0City city;
  ...
  public XmlNs0Venue city(XmlNs0City city) {
    this.city = city;
    return this;
  }
  ...
  public XmlNs0City getCity() {
    return city;
  }

  public void setCity(XmlNs0City city) {
    this.city = city;
  }


  public XmlNs0Venue id(String id) {
    this.id = id;
    return this;
  }
  ...
  public XmlNs0Venue name(String name) {
    this.name = name;
    return this;
  }
  ...
  public XmlNs0Venue url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Venue xmlNs0Venue = (XmlNs0Venue) o;
    return Objects.equals(this.city, xmlNs0Venue.city) &&
        Objects.equals(this.id, xmlNs0Venue.id) &&
        Objects.equals(this.name, xmlNs0Venue.name) &&
        Objects.equals(this.url, xmlNs0Venue.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Venue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Venue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Venue is not found in the empty JSON string", XmlNs0Venue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Venue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Venue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `city`
      if (jsonObj.get("city") != null && !jsonObj.get("city").isJsonNull()) {
        XmlNs0City.validateJsonElement(jsonObj.get("city"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Venue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Venue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Venue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Venue.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Venue>() {
           @Override
           public void write(JsonWriter out, XmlNs0Venue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Venue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Venue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Venue
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Venue
   */
  public static XmlNs0Venue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Venue.class);
  }

  /**
   * Convert an instance of XmlNs0Venue to an JSON string
   *
   * @return JSON string
   */
