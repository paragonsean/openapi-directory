...
public class JsonCountry {
  ...
  public JsonCountry code(String code) {
    this.code = code;
    return this;
  }
  ...
  public JsonCountry name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JsonCountry jsonCountry = (JsonCountry) o;
    return Objects.equals(this.code, jsonCountry.code) &&
        Objects.equals(this.name, jsonCountry.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JsonCountry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonCountry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonCountry is not found in the empty JSON string", JsonCountry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JsonCountry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonCountry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonCountry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonCountry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonCountry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonCountry.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonCountry>() {
           @Override
           public void write(JsonWriter out, JsonCountry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JsonCountry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JsonCountry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JsonCountry
   * @throws IOException if the JSON string is invalid with respect to JsonCountry
   */
  public static JsonCountry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonCountry.class);
  }

  /**
   * Convert an instance of JsonCountry to an JSON string
   *
   * @return JSON string
   */
