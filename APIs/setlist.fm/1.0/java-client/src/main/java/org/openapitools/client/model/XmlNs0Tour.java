...
public class XmlNs0Tour {
  ...
  public XmlNs0Tour name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Tour xmlNs0Tour = (XmlNs0Tour) o;
    return Objects.equals(this.name, xmlNs0Tour.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Tour
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Tour.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Tour is not found in the empty JSON string", XmlNs0Tour.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Tour.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Tour` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Tour.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Tour' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Tour> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Tour.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Tour>() {
           @Override
           public void write(JsonWriter out, XmlNs0Tour value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Tour read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Tour given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Tour
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Tour
   */
  public static XmlNs0Tour fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Tour.class);
  }

  /**
   * Convert an instance of XmlNs0Tour to an JSON string
   *
   * @return JSON string
   */
