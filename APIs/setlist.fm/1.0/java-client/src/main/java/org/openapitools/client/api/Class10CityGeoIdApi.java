...
public class Class10CityGeoIdApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10CityGeoIdApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10CityGeoIdApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10CityGeoIdGetCityGET
     * @param geoId the city&#39;s geoId (required)
     ...
     */
    public okhttp3.Call resource10CityGeoIdGetCityGETCall(String geoId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/city/{geoId}"
            .replace("{" + "geoId" + "}", localVarApiClient.escapeString(geoId.toString()));
    ...
    private okhttp3.Call resource10CityGeoIdGetCityGETValidateBeforeCall(String geoId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'geoId' is set
        if (geoId == null) {
            throw new ApiException("Missing the required parameter 'geoId' when calling resource10CityGeoIdGetCityGET(Async)");
        }

        return resource10CityGeoIdGetCityGETCall(geoId, _callback);
     ...
     */
    public JsonCity resource10CityGeoIdGetCityGET(String geoId) throws ApiException {
        ApiResponse<JsonCity> localVarResp = resource10CityGeoIdGetCityGETWithHttpInfo(geoId);
     ...
     */
    public ApiResponse<JsonCity> resource10CityGeoIdGetCityGETWithHttpInfo(String geoId) throws ApiException {
        okhttp3.Call localVarCall = resource10CityGeoIdGetCityGETValidateBeforeCall(geoId, null);
        Type localVarReturnType = new TypeToken<JsonCity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a city by its unique geoId. (asynchronously)
     * Get a city by its unique geoId.
     * @param geoId the city&#39;s geoId (required)
     ...
     */
    public okhttp3.Call resource10CityGeoIdGetCityGETAsync(String geoId, final ApiCallback<JsonCity> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10CityGeoIdGetCityGETValidateBeforeCall(geoId, _callback);
        Type localVarReturnType = new TypeToken<JsonCity>(){}.getType();
