...
public class Class10SearchArtistsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10SearchArtistsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10SearchArtistsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10SearchArtistsGetArtistsGET
     ...
     * @param sort the sort of the result, either sortName (default) or relevance (optional, default to sortName)
     ...
     */
    public okhttp3.Call resource10SearchArtistsGetArtistsGETCall(String artistMbid, String artistName, Integer artistTmid, Integer p, String sort, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/search/artists";
    ...
    private okhttp3.Call resource10SearchArtistsGetArtistsGETValidateBeforeCall(String artistMbid, String artistName, Integer artistTmid, Integer p, String sort, final ApiCallback _callback) throws ApiException {
        return resource10SearchArtistsGetArtistsGETCall(artistMbid, artistName, artistTmid, p, sort, _callback);
     ...
     */
    public JsonArtists resource10SearchArtistsGetArtistsGET(String artistMbid, String artistName, Integer artistTmid, Integer p, String sort) throws ApiException {
        ApiResponse<JsonArtists> localVarResp = resource10SearchArtistsGetArtistsGETWithHttpInfo(artistMbid, artistName, artistTmid, p, sort);
     ...
     * @param p the number of the result page you&#39;d like to have (optional, default to 1)
     * @param sort the sort of the result, either sortName (default) or relevance (optional, default to sortName)
     * @return ApiResponse&lt;JsonArtists&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<JsonArtists> resource10SearchArtistsGetArtistsGETWithHttpInfo(String artistMbid, String artistName, Integer artistTmid, Integer p, String sort) throws ApiException {
        okhttp3.Call localVarCall = resource10SearchArtistsGetArtistsGETValidateBeforeCall(artistMbid, artistName, artistTmid, p, sort, null);
        Type localVarReturnType = new TypeToken<JsonArtists>(){}.getType();
     ...
     */
    public okhttp3.Call resource10SearchArtistsGetArtistsGETAsync(String artistMbid, String artistName, Integer artistTmid, Integer p, String sort, final ApiCallback<JsonArtists> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10SearchArtistsGetArtistsGETValidateBeforeCall(artistMbid, artistName, artistTmid, p, sort, _callback);
        Type localVarReturnType = new TypeToken<JsonArtists>(){}.getType();
