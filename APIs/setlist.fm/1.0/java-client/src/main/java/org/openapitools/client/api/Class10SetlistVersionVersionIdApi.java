...
public class Class10SetlistVersionVersionIdApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10SetlistVersionVersionIdApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10SetlistVersionVersionIdApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10SetlistVersionVersionIdGetSetlistVersionGET
     ...
     */
    public okhttp3.Call resource10SetlistVersionVersionIdGetSetlistVersionGETCall(String versionId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/setlist/version/{versionId}"
    ...
    private okhttp3.Call resource10SetlistVersionVersionIdGetSetlistVersionGETValidateBeforeCall(String versionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'versionId' is set
        if (versionId == null) {
            throw new ApiException("Missing the required parameter 'versionId' when calling resource10SetlistVersionVersionIdGetSetlistVersionGET(Async)");
        }

        return resource10SetlistVersionVersionIdGetSetlistVersionGETCall(versionId, _callback);
     ...
     */
    public JsonSetlist resource10SetlistVersionVersionIdGetSetlistVersionGET(String versionId) throws ApiException {
        ApiResponse<JsonSetlist> localVarResp = resource10SetlistVersionVersionIdGetSetlistVersionGETWithHttpInfo(versionId);
     ...
     */
    public ApiResponse<JsonSetlist> resource10SetlistVersionVersionIdGetSetlistVersionGETWithHttpInfo(String versionId) throws ApiException {
        okhttp3.Call localVarCall = resource10SetlistVersionVersionIdGetSetlistVersionGETValidateBeforeCall(versionId, null);
     ...
     */
    public okhttp3.Call resource10SetlistVersionVersionIdGetSetlistVersionGETAsync(String versionId, final ApiCallback<JsonSetlist> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10SetlistVersionVersionIdGetSetlistVersionGETValidateBeforeCall(versionId, _callback);
        Type localVarReturnType = new TypeToken<JsonSetlist>(){}.getType();
