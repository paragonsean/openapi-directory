...
public class XmlNs0Countries {
  ...
  public XmlNs0Countries() {
  }

  public XmlNs0Countries itemsPerPage(BigDecimal itemsPerPage) {
  ...
  public XmlNs0Countries page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public XmlNs0Countries total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Countries xmlNs0Countries = (XmlNs0Countries) o;
    return Objects.equals(this.itemsPerPage, xmlNs0Countries.itemsPerPage) &&
        Objects.equals(this.page, xmlNs0Countries.page) &&
        Objects.equals(this.total, xmlNs0Countries.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class XmlNs0Countries {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Countries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Countries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Countries is not found in the empty JSON string", XmlNs0Countries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Countries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Countries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Countries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Countries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Countries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Countries.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Countries>() {
           @Override
           public void write(JsonWriter out, XmlNs0Countries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Countries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Countries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Countries
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Countries
   */
  public static XmlNs0Countries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Countries.class);
  }

  /**
   * Convert an instance of XmlNs0Countries to an JSON string
   *
   * @return JSON string
   */
