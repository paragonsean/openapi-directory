...
public class XmlNs0Artists {
  ...
  public XmlNs0Artists() {
  }

  public XmlNs0Artists itemsPerPage(BigDecimal itemsPerPage) {
  ...
  public XmlNs0Artists page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public XmlNs0Artists total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Artists xmlNs0Artists = (XmlNs0Artists) o;
    return Objects.equals(this.itemsPerPage, xmlNs0Artists.itemsPerPage) &&
        Objects.equals(this.page, xmlNs0Artists.page) &&
        Objects.equals(this.total, xmlNs0Artists.total);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Artists
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Artists.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Artists is not found in the empty JSON string", XmlNs0Artists.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Artists.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Artists` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Artists.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Artists' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Artists> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Artists.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Artists>() {
           @Override
           public void write(JsonWriter out, XmlNs0Artists value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Artists read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Artists given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Artists
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Artists
   */
  public static XmlNs0Artists fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Artists.class);
  }

  /**
   * Convert an instance of XmlNs0Artists to an JSON string
   *
   * @return JSON string
   */
