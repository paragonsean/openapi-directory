...
public class XmlNs0Error {
  ...
  public XmlNs0Error code(BigDecimal code) {
    this.code = code;
    return this;
  }
  ...
  public XmlNs0Error message(String message) {
  ...
  public XmlNs0Error status(String status) {
    this.status = status;
    return this;
  }
  ...
  public XmlNs0Error timestamp(String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Error xmlNs0Error = (XmlNs0Error) o;
    return Objects.equals(this.code, xmlNs0Error.code) &&
        Objects.equals(this.message, xmlNs0Error.message) &&
        Objects.equals(this.status, xmlNs0Error.status) &&
        Objects.equals(this.timestamp, xmlNs0Error.timestamp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Error
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Error is not found in the empty JSON string", XmlNs0Error.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Error.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Error` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Error.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Error>() {
           @Override
           public void write(JsonWriter out, XmlNs0Error value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Error read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Error given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Error
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Error
   */
  public static XmlNs0Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Error.class);
  }

  /**
   * Convert an instance of XmlNs0Error to an JSON string
   *
   * @return JSON string
   */
