...
public class XmlNs0Result {
  ...
  public XmlNs0Result itemsPerPage(BigDecimal itemsPerPage) {
  ...
  public XmlNs0Result page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public XmlNs0Result total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XmlNs0Result xmlNs0Result = (XmlNs0Result) o;
    return Objects.equals(this.itemsPerPage, xmlNs0Result.itemsPerPage) &&
        Objects.equals(this.page, xmlNs0Result.page) &&
        Objects.equals(this.total, xmlNs0Result.total);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to XmlNs0Result
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XmlNs0Result.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XmlNs0Result is not found in the empty JSON string", XmlNs0Result.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XmlNs0Result.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XmlNs0Result` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XmlNs0Result.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XmlNs0Result' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XmlNs0Result> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XmlNs0Result.class));

       return (TypeAdapter<T>) new TypeAdapter<XmlNs0Result>() {
           @Override
           public void write(JsonWriter out, XmlNs0Result value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XmlNs0Result read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XmlNs0Result given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XmlNs0Result
   * @throws IOException if the JSON string is invalid with respect to XmlNs0Result
   */
  public static XmlNs0Result fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XmlNs0Result.class);
  }

  /**
   * Convert an instance of XmlNs0Result to an JSON string
   *
   * @return JSON string
   */
