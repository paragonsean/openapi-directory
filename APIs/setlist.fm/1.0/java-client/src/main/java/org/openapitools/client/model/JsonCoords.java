...
public class JsonCoords {
  ...
  public JsonCoords lat(BigDecimal lat) {
    this.lat = lat;
    return this;
  }
  ...
  public JsonCoords _long(BigDecimal _long) {
    this._long = _long;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JsonCoords jsonCoords = (JsonCoords) o;
    return Objects.equals(this.lat, jsonCoords.lat) &&
        Objects.equals(this._long, jsonCoords._long);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JsonCoords
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonCoords.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonCoords is not found in the empty JSON string", JsonCoords.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JsonCoords.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonCoords` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonCoords.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonCoords' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonCoords> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonCoords.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonCoords>() {
           @Override
           public void write(JsonWriter out, JsonCoords value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JsonCoords read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JsonCoords given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JsonCoords
   * @throws IOException if the JSON string is invalid with respect to JsonCoords
   */
  public static JsonCoords fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonCoords.class);
  }

  /**
   * Convert an instance of JsonCoords to an JSON string
   *
   * @return JSON string
   */
