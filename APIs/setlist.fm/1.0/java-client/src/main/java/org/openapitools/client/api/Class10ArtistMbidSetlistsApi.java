...
public class Class10ArtistMbidSetlistsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10ArtistMbidSetlistsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10ArtistMbidSetlistsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10ArtistMbidSetlistsGetArtistSetlistsGET
     * @param mbid the Musicbrainz MBID of the artist (required)
     ...
     */
    public okhttp3.Call resource10ArtistMbidSetlistsGetArtistSetlistsGETCall(String mbid, Integer p, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/artist/{mbid}/setlists"
    ...
    private okhttp3.Call resource10ArtistMbidSetlistsGetArtistSetlistsGETValidateBeforeCall(String mbid, Integer p, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mbid' is set
        if (mbid == null) {
            throw new ApiException("Missing the required parameter 'mbid' when calling resource10ArtistMbidSetlistsGetArtistSetlistsGET(Async)");
        }

        return resource10ArtistMbidSetlistsGetArtistSetlistsGETCall(mbid, p, _callback);
     ...
     */
    public JsonSetlists resource10ArtistMbidSetlistsGetArtistSetlistsGET(String mbid, Integer p) throws ApiException {
        ApiResponse<JsonSetlists> localVarResp = resource10ArtistMbidSetlistsGetArtistSetlistsGETWithHttpInfo(mbid, p);
     ...
     */
    public ApiResponse<JsonSetlists> resource10ArtistMbidSetlistsGetArtistSetlistsGETWithHttpInfo(String mbid, Integer p) throws ApiException {
        okhttp3.Call localVarCall = resource10ArtistMbidSetlistsGetArtistSetlistsGETValidateBeforeCall(mbid, p, null);
     ...
     */
    public okhttp3.Call resource10ArtistMbidSetlistsGetArtistSetlistsGETAsync(String mbid, Integer p, final ApiCallback<JsonSetlists> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10ArtistMbidSetlistsGetArtistSetlistsGETValidateBeforeCall(mbid, p, _callback);
        Type localVarReturnType = new TypeToken<JsonSetlists>(){}.getType();
