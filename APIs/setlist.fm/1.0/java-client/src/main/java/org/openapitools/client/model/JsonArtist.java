...
public class JsonArtist {
  ...
  public JsonArtist disambiguation(String disambiguation) {
  ...
  public JsonArtist mbid(String mbid) {
    this.mbid = mbid;
    return this;
  }
  ...
  public JsonArtist name(String name) {
    this.name = name;
    return this;
  }
  ...
  public JsonArtist sortName(String sortName) {
  ...
  public JsonArtist tmid(BigDecimal tmid) {
    this.tmid = tmid;
    return this;
  }
  ...
  public JsonArtist url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JsonArtist jsonArtist = (JsonArtist) o;
    return Objects.equals(this.disambiguation, jsonArtist.disambiguation) &&
        Objects.equals(this.mbid, jsonArtist.mbid) &&
        Objects.equals(this.name, jsonArtist.name) &&
        Objects.equals(this.sortName, jsonArtist.sortName) &&
        Objects.equals(this.tmid, jsonArtist.tmid) &&
        Objects.equals(this.url, jsonArtist.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JsonArtist
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonArtist.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonArtist is not found in the empty JSON string", JsonArtist.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JsonArtist.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonArtist` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonArtist.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonArtist' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonArtist> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonArtist.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonArtist>() {
           @Override
           public void write(JsonWriter out, JsonArtist value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JsonArtist read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JsonArtist given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JsonArtist
   * @throws IOException if the JSON string is invalid with respect to JsonArtist
   */
  public static JsonArtist fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonArtist.class);
  }

  /**
   * Convert an instance of JsonArtist to an JSON string
   *
   * @return JSON string
   */
