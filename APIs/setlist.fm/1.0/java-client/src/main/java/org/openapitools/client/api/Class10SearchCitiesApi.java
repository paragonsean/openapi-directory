...
import org.openapitools.client.model.JsonCities;
...
public class Class10SearchCitiesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10SearchCitiesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10SearchCitiesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10SearchCitiesGetCitiesGET
     ...
     * @param state state the city lies in (optional)
     * @param stateCode state code the city lies in (optional)
     ...
     */
    public okhttp3.Call resource10SearchCitiesGetCitiesGETCall(String country, String name, Integer p, String state, String stateCode, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/search/cities";
    ...
    private okhttp3.Call resource10SearchCitiesGetCitiesGETValidateBeforeCall(String country, String name, Integer p, String state, String stateCode, final ApiCallback _callback) throws ApiException {
        return resource10SearchCitiesGetCitiesGETCall(country, name, p, state, stateCode, _callback);
     ...
     */
    public JsonCities resource10SearchCitiesGetCitiesGET(String country, String name, Integer p, String state, String stateCode) throws ApiException {
        ApiResponse<JsonCities> localVarResp = resource10SearchCitiesGetCitiesGETWithHttpInfo(country, name, p, state, stateCode);
     ...
     */
    public ApiResponse<JsonCities> resource10SearchCitiesGetCitiesGETWithHttpInfo(String country, String name, Integer p, String state, String stateCode) throws ApiException {
        okhttp3.Call localVarCall = resource10SearchCitiesGetCitiesGETValidateBeforeCall(country, name, p, state, stateCode, null);
        Type localVarReturnType = new TypeToken<JsonCities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search for a city. (asynchronously)
     * Search for a city.
     * @param country the city&#39;s country (optional)
     * @param name name of the city (optional)
     * @param p the number of the result page you&#39;d like to have (optional, default to 1)
     ...
     */
    public okhttp3.Call resource10SearchCitiesGetCitiesGETAsync(String country, String name, Integer p, String state, String stateCode, final ApiCallback<JsonCities> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10SearchCitiesGetCitiesGETValidateBeforeCall(country, name, p, state, stateCode, _callback);
        Type localVarReturnType = new TypeToken<JsonCities>(){}.getType();
