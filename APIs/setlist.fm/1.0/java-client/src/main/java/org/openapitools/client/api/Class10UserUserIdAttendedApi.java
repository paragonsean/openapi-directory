...
public class Class10UserUserIdAttendedApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10UserUserIdAttendedApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10UserUserIdAttendedApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10UserUserIdAttendedGetUserAttendedSetlistsGET
     ...
     */
    public okhttp3.Call resource10UserUserIdAttendedGetUserAttendedSetlistsGETCall(String userId, Integer p, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/user/{userId}/attended"
    ...
    private okhttp3.Call resource10UserUserIdAttendedGetUserAttendedSetlistsGETValidateBeforeCall(String userId, Integer p, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling resource10UserUserIdAttendedGetUserAttendedSetlistsGET(Async)");
        }

        return resource10UserUserIdAttendedGetUserAttendedSetlistsGETCall(userId, p, _callback);
     ...
     */
    public JsonSetlists resource10UserUserIdAttendedGetUserAttendedSetlistsGET(String userId, Integer p) throws ApiException {
        ApiResponse<JsonSetlists> localVarResp = resource10UserUserIdAttendedGetUserAttendedSetlistsGETWithHttpInfo(userId, p);
     ...
     */
    public ApiResponse<JsonSetlists> resource10UserUserIdAttendedGetUserAttendedSetlistsGETWithHttpInfo(String userId, Integer p) throws ApiException {
        okhttp3.Call localVarCall = resource10UserUserIdAttendedGetUserAttendedSetlistsGETValidateBeforeCall(userId, p, null);
     ...
     */
    public okhttp3.Call resource10UserUserIdAttendedGetUserAttendedSetlistsGETAsync(String userId, Integer p, final ApiCallback<JsonSetlists> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10UserUserIdAttendedGetUserAttendedSetlistsGETValidateBeforeCall(userId, p, _callback);
        Type localVarReturnType = new TypeToken<JsonSetlists>(){}.getType();
