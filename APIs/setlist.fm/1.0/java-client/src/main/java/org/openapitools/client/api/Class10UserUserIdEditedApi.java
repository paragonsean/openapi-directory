...
public class Class10UserUserIdEditedApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10UserUserIdEditedApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10UserUserIdEditedApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10UserUserIdEditedGetUserEditedSetlistsGET
     ...
     */
    public okhttp3.Call resource10UserUserIdEditedGetUserEditedSetlistsGETCall(String userId, Integer p, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/user/{userId}/edited"
    ...
    private okhttp3.Call resource10UserUserIdEditedGetUserEditedSetlistsGETValidateBeforeCall(String userId, Integer p, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling resource10UserUserIdEditedGetUserEditedSetlistsGET(Async)");
        }

        return resource10UserUserIdEditedGetUserEditedSetlistsGETCall(userId, p, _callback);
     ...
     */
    public JsonSetlists resource10UserUserIdEditedGetUserEditedSetlistsGET(String userId, Integer p) throws ApiException {
        ApiResponse<JsonSetlists> localVarResp = resource10UserUserIdEditedGetUserEditedSetlistsGETWithHttpInfo(userId, p);
     ...
     */
    public ApiResponse<JsonSetlists> resource10UserUserIdEditedGetUserEditedSetlistsGETWithHttpInfo(String userId, Integer p) throws ApiException {
        okhttp3.Call localVarCall = resource10UserUserIdEditedGetUserEditedSetlistsGETValidateBeforeCall(userId, p, null);
     ...
     */
    public okhttp3.Call resource10UserUserIdEditedGetUserEditedSetlistsGETAsync(String userId, Integer p, final ApiCallback<JsonSetlists> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10UserUserIdEditedGetUserEditedSetlistsGETValidateBeforeCall(userId, p, _callback);
        Type localVarReturnType = new TypeToken<JsonSetlists>(){}.getType();
