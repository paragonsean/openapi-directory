...
public class Class10ArtistMbidApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Class10ArtistMbidApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Class10ArtistMbidApi(ApiClient apiClient) {
    ...
    /**
     * Build call for resource10ArtistMbidGetArtistGET
     * @param mbid a Musicbrainz MBID, e.g. 0bfba3d3-6a04-4779-bb0a-df07df5b0558 (required)
     ...
     */
    public okhttp3.Call resource10ArtistMbidGetArtistGETCall(String mbid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1.0/artist/{mbid}"
    ...
    private okhttp3.Call resource10ArtistMbidGetArtistGETValidateBeforeCall(String mbid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mbid' is set
        if (mbid == null) {
            throw new ApiException("Missing the required parameter 'mbid' when calling resource10ArtistMbidGetArtistGET(Async)");
        }

        return resource10ArtistMbidGetArtistGETCall(mbid, _callback);
     ...
     */
    public JsonArtist resource10ArtistMbidGetArtistGET(String mbid) throws ApiException {
        ApiResponse<JsonArtist> localVarResp = resource10ArtistMbidGetArtistGETWithHttpInfo(mbid);
     ...
     */
    public ApiResponse<JsonArtist> resource10ArtistMbidGetArtistGETWithHttpInfo(String mbid) throws ApiException {
        okhttp3.Call localVarCall = resource10ArtistMbidGetArtistGETValidateBeforeCall(mbid, null);
        Type localVarReturnType = new TypeToken<JsonArtist>(){}.getType();
     ...
     */
    public okhttp3.Call resource10ArtistMbidGetArtistGETAsync(String mbid, final ApiCallback<JsonArtist> _callback) throws ApiException {

        okhttp3.Call localVarCall = resource10ArtistMbidGetArtistGETValidateBeforeCall(mbid, _callback);
        Type localVarReturnType = new TypeToken<JsonArtist>(){}.getType();
