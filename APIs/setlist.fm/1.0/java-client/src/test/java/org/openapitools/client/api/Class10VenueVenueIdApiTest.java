...
/**
 * API tests for Class10VenueVenueIdApi
 */
@Disabled
public class Class10VenueVenueIdApiTest {

    private final Class10VenueVenueIdApi api = new Class10VenueVenueIdApi();
     ...
     */
    @Test
    public void resource10VenueVenueIdGetVenueGETTest() throws ApiException {
        String venueId = null;
        JsonVenue response = api.resource10VenueVenueIdGetVenueGET(venueId);
