...
import org.openapitools.client.model.JsonUser;
...
/**
 * API tests for Class10UserUserIdApi
 */
@Disabled
public class Class10UserUserIdApiTest {

    private final Class10UserUserIdApi api = new Class10UserUserIdApi();
     ...
     */
    @Test
    public void resource10UserUserIdGetUserGETTest() throws ApiException {
        String userId = null;
        JsonUser response = api.resource10UserUserIdGetUserGET(userId);
