...
/**
 * API tests for Class10SearchSetlistsApi
 */
@Disabled
public class Class10SearchSetlistsApiTest {

    private final Class10SearchSetlistsApi api = new Class10SearchSetlistsApi();
     ...
     */
    @Test
    public void resource10SearchSetlistsGetSetlistsGETTest() throws ApiException {
        String artistMbid = null;
        String artistName = null;
        Integer artistTmid = null;
        String cityId = null;
        ...
        String year = null;
        JsonSetlists response = api.resource10SearchSetlistsGetSetlistsGET(artistMbid, artistName, artistTmid, cityId, cityName, countryCode, date, lastFm, lastUpdated, p, state, stateCode, tourName, venueId, venueName, year);
