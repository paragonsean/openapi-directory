...
/**
 * API tests for Class10ArtistMbidApi
 */
@Disabled
public class Class10ArtistMbidApiTest {

    private final Class10ArtistMbidApi api = new Class10ArtistMbidApi();
     ...
     */
    @Test
    public void resource10ArtistMbidGetArtistGETTest() throws ApiException {
        String mbid = null;
        JsonArtist response = api.resource10ArtistMbidGetArtistGET(mbid);
