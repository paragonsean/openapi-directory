...
/**
 * API tests for Class10SetlistVersionVersionIdApi
 */
@Disabled
public class Class10SetlistVersionVersionIdApiTest {

    private final Class10SetlistVersionVersionIdApi api = new Class10SetlistVersionVersionIdApi();
     ...
     */
    @Test
    public void resource10SetlistVersionVersionIdGetSetlistVersionGETTest() throws ApiException {
        String versionId = null;
        JsonSetlist response = api.resource10SetlistVersionVersionIdGetSetlistVersionGET(versionId);
