...
/**
 * API tests for Class10SearchVenuesApi
 */
@Disabled
public class Class10SearchVenuesApiTest {

    private final Class10SearchVenuesApi api = new Class10SearchVenuesApi();
     ...
     */
    @Test
    public void resource10SearchVenuesGetVenuesGETTest() throws ApiException {
        String cityId = null;
        ...
        JsonVenues response = api.resource10SearchVenuesGetVenuesGET(cityId, cityName, country, name, p, state, stateCode);
