...
/**
 * API tests for Class10UserUserIdEditedApi
 */
@Disabled
public class Class10UserUserIdEditedApiTest {

    private final Class10UserUserIdEditedApi api = new Class10UserUserIdEditedApi();
     ...
     */
    @Test
    public void resource10UserUserIdEditedGetUserEditedSetlistsGETTest() throws ApiException {
        String userId = null;
        Integer p = null;
        JsonSetlists response = api.resource10UserUserIdEditedGetUserEditedSetlistsGET(userId, p);
