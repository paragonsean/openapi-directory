...
/**
 * API tests for Class10ArtistMbidSetlistsApi
 */
@Disabled
public class Class10ArtistMbidSetlistsApiTest {

    private final Class10ArtistMbidSetlistsApi api = new Class10ArtistMbidSetlistsApi();
     ...
     */
    @Test
    public void resource10ArtistMbidSetlistsGetArtistSetlistsGETTest() throws ApiException {
        String mbid = null;
        Integer p = null;
        JsonSetlists response = api.resource10ArtistMbidSetlistsGetArtistSetlistsGET(mbid, p);
