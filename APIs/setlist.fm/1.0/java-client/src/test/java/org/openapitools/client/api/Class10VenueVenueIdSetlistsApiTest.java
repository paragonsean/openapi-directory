...
/**
 * API tests for Class10VenueVenueIdSetlistsApi
 */
@Disabled
public class Class10VenueVenueIdSetlistsApiTest {

    private final Class10VenueVenueIdSetlistsApi api = new Class10VenueVenueIdSetlistsApi();
     ...
     */
    @Test
    public void resource10VenueVenueIdSetlistsGetVenueSetlistsGETTest() throws ApiException {
        String venueId = null;
        Integer p = null;
        JsonSetlists response = api.resource10VenueVenueIdSetlistsGetVenueSetlistsGET(venueId, p);
