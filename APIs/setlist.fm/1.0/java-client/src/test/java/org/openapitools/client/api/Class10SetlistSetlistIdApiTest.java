...
/**
 * API tests for Class10SetlistSetlistIdApi
 */
@Disabled
public class Class10SetlistSetlistIdApiTest {

    private final Class10SetlistSetlistIdApi api = new Class10SetlistSetlistIdApi();
     ...
     */
    @Test
    public void resource10SetlistSetlistIdGetSetlistGETTest() throws ApiException {
        String setlistId = null;
        JsonSetlist response = api.resource10SetlistSetlistIdGetSetlistGET(setlistId);
