...
import org.openapitools.client.model.JsonArtists;
...
/**
 * API tests for Class10SearchArtistsApi
 */
@Disabled
public class Class10SearchArtistsApiTest {

    private final Class10SearchArtistsApi api = new Class10SearchArtistsApi();
     ...
     */
    @Test
    public void resource10SearchArtistsGetArtistsGETTest() throws ApiException {
        String artistMbid = null;
        String artistName = null;
        Integer artistTmid = null;
        Integer p = null;
        String sort = null;
        JsonArtists response = api.resource10SearchArtistsGetArtistsGET(artistMbid, artistName, artistTmid, p, sort);
