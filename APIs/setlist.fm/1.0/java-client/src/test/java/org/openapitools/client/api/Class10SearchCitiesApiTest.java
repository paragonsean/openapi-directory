...
/**
 * API tests for Class10SearchCitiesApi
 */
@Disabled
public class Class10SearchCitiesApiTest {

    private final Class10SearchCitiesApi api = new Class10SearchCitiesApi();
     ...
     */
    @Test
    public void resource10SearchCitiesGetCitiesGETTest() throws ApiException {
        String country = null;
        String name = null;
        Integer p = null;
        String state = null;
        String stateCode = null;
        JsonCities response = api.resource10SearchCitiesGetCitiesGET(country, name, p, state, stateCode);
