...
/**
 * API tests for Class10UserUserIdAttendedApi
 */
@Disabled
public class Class10UserUserIdAttendedApiTest {

    private final Class10UserUserIdAttendedApi api = new Class10UserUserIdAttendedApi();
     ...
     */
    @Test
    public void resource10UserUserIdAttendedGetUserAttendedSetlistsGETTest() throws ApiException {
        String userId = null;
        Integer p = null;
        JsonSetlists response = api.resource10UserUserIdAttendedGetUserAttendedSetlistsGET(userId, p);
