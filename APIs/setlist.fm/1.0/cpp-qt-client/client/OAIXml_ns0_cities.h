...
#ifndef OAIXml_ns0_cities_H
#define OAIXml_ns0_cities_H
...
class OAIXml_ns0_cities : public OAIObject {
public:
    OAIXml_ns0_cities();
    OAIXml_ns0_cities(QString json);
    ~OAIXml_ns0_cities() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_cities)

#endif // OAIXml_ns0_cities_H
