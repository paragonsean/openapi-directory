...
#ifndef OAI_OAIClass10SetlistVersionVersionIdApi_H
#define OAI_OAIClass10SetlistVersionVersionIdApi_H
...
class OAIClass10SetlistVersionVersionIdApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SetlistVersionVersionIdApi(const int timeOut = 0);
    ~OAIClass10SetlistVersionVersionIdApi();
    ...
    */
    virtual void resource1_0SetlistVersionVersionIdGetSetlistVersionGET(const QString &version_id);
...
private:
    ...
    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignal(OAIJson_Setlist summary);


    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlist summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalError() instead")
    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalE(OAIJson_Setlist summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalError(OAIJson_Setlist summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalErrorFull() instead")
    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SetlistVersionVersionIdGetSetlistVersionGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
