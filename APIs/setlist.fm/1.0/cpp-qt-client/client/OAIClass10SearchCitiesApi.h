...
#ifndef OAI_OAIClass10SearchCitiesApi_H
#define OAI_OAIClass10SearchCitiesApi_H
...
class OAIClass10SearchCitiesApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SearchCitiesApi(const int timeOut = 0);
    ~OAIClass10SearchCitiesApi();
    ...
    */
    virtual void resource1_0SearchCitiesGetCitiesGET(const ::OpenAPI::OptionalParam<QString> &country = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &state = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &state_code = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void resource1_0SearchCitiesGetCitiesGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SearchCitiesGetCitiesGETSignal(OAIJson_Cities summary);


    void resource1_0SearchCitiesGetCitiesGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Cities summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchCitiesGetCitiesGETSignalError() instead")
    void resource1_0SearchCitiesGetCitiesGETSignalE(OAIJson_Cities summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchCitiesGetCitiesGETSignalError(OAIJson_Cities summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchCitiesGetCitiesGETSignalErrorFull() instead")
    void resource1_0SearchCitiesGetCitiesGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchCitiesGetCitiesGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
