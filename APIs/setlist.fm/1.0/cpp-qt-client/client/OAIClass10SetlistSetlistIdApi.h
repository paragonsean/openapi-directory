...
#ifndef OAI_OAIClass10SetlistSetlistIdApi_H
#define OAI_OAIClass10SetlistSetlistIdApi_H
...
class OAIClass10SetlistSetlistIdApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SetlistSetlistIdApi(const int timeOut = 0);
    ~OAIClass10SetlistSetlistIdApi();
    ...
    /**
    * @param[in]  setlist_id QString [required]
    */
    virtual void resource1_0SetlistSetlistIdGetSetlistGET(const QString &setlist_id);
...
private:
    ...
    void resource1_0SetlistSetlistIdGetSetlistGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SetlistSetlistIdGetSetlistGETSignal(OAIJson_Setlist summary);


    void resource1_0SetlistSetlistIdGetSetlistGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlist summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SetlistSetlistIdGetSetlistGETSignalError() instead")
    void resource1_0SetlistSetlistIdGetSetlistGETSignalE(OAIJson_Setlist summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SetlistSetlistIdGetSetlistGETSignalError(OAIJson_Setlist summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SetlistSetlistIdGetSetlistGETSignalErrorFull() instead")
    void resource1_0SetlistSetlistIdGetSetlistGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SetlistSetlistIdGetSetlistGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
