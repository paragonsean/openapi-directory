...
/*
 * OAIXml_ns0_country.h
 *
 * This class represents a country on earth.
 */

#ifndef OAIXml_ns0_country_H
#define OAIXml_ns0_country_H
...
class OAIXml_ns0_country : public OAIObject {
public:
    OAIXml_ns0_country();
    OAIXml_ns0_country(QString json);
    ~OAIXml_ns0_country() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_country)

#endif // OAIXml_ns0_country_H
