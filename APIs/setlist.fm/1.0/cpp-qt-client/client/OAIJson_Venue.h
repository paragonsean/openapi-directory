...
#ifndef OAIJson_Venue_H
#define OAIJson_Venue_H
...
class OAIJson_Venue : public OAIObject {
public:
    OAIJson_Venue();
    OAIJson_Venue(QString json);
    ~OAIJson_Venue() override;
    ...
    OAIJson_City getCity() const;
    void setCity(const OAIJson_City &city);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Venue)

#endif // OAIJson_Venue_H
