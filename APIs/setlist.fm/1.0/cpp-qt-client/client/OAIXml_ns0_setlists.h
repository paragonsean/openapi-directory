...
/*
 * OAIXml_ns0_setlists.h
 *
 * A Result consisting of a list of setlists.
 */

#ifndef OAIXml_ns0_setlists_H
#define OAIXml_ns0_setlists_H
...
class OAIXml_ns0_setlists : public OAIObject {
public:
    OAIXml_ns0_setlists();
    OAIXml_ns0_setlists(QString json);
    ~OAIXml_ns0_setlists() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_setlists)

#endif // OAIXml_ns0_setlists_H
