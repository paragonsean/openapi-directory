...
#ifndef OAIJson_Song_H
#define OAIJson_Song_H
...
class OAIJson_Song : public OAIObject {
public:
    OAIJson_Song();
    OAIJson_Song(QString json);
    ~OAIJson_Song() override;
    ...
    OAIJson_Artist getCover() const;
    void setCover(const OAIJson_Artist &cover);
    ...
    OAIJson_Artist getWith() const;
    void setWith(const OAIJson_Artist &with);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Song)

#endif // OAIJson_Song_H
