...
#ifndef OAIJson_Coords_H
#define OAIJson_Coords_H
...
class OAIJson_Coords : public OAIObject {
public:
    OAIJson_Coords();
    OAIJson_Coords(QString json);
    ~OAIJson_Coords() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Coords)

#endif // OAIJson_Coords_H
