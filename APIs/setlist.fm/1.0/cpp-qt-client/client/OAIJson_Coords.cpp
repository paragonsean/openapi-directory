...
OAIJson_Coords::OAIJson_Coords(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Coords::OAIJson_Coords() {
    this->initializeModel();
}

OAIJson_Coords::~OAIJson_Coords() {}

void OAIJson_Coords::initializeModel() {
...
void OAIJson_Coords::fromJson(QString jsonString) {
...
void OAIJson_Coords::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Coords::asJson() const {
...
QJsonObject OAIJson_Coords::asJsonObject() const {
    QJsonObject obj;
    if (m_lat_isSet) {
...
double OAIJson_Coords::getLat() const {
    return m_lat;
}
void OAIJson_Coords::setLat(const double &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAIJson_Coords::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAIJson_Coords::is_lat_Valid() const{
    return m_lat_isValid;
}

double OAIJson_Coords::getRLong() const {
    return m_r_long;
}
void OAIJson_Coords::setRLong(const double &r_long) {
    m_r_long = r_long;
    m_r_long_isSet = true;
}

bool OAIJson_Coords::is_r_long_Set() const{
    return m_r_long_isSet;
}

bool OAIJson_Coords::is_r_long_Valid() const{
    return m_r_long_isValid;
}

bool OAIJson_Coords::isSet() const {
...
bool OAIJson_Coords::isValid() const {
