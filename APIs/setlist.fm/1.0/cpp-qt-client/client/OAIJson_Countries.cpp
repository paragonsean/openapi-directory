...
OAIJson_Countries::OAIJson_Countries(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Countries::OAIJson_Countries() {
    this->initializeModel();
}

OAIJson_Countries::~OAIJson_Countries() {}

void OAIJson_Countries::initializeModel() {
...
void OAIJson_Countries::fromJson(QString jsonString) {
...
void OAIJson_Countries::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Countries::asJson() const {
...
QJsonObject OAIJson_Countries::asJsonObject() const {
    QJsonObject obj;
    if (m_country.size() > 0) {
...
QList<OAIJson_Country> OAIJson_Countries::getCountry() const {
    return m_country;
}
void OAIJson_Countries::setCountry(const QList<OAIJson_Country> &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIJson_Countries::is_country_Set() const{
    return m_country_isSet;
}

bool OAIJson_Countries::is_country_Valid() const{
    return m_country_isValid;
}

double OAIJson_Countries::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIJson_Countries::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIJson_Countries::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIJson_Countries::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIJson_Countries::getPage() const {
    return m_page;
}
void OAIJson_Countries::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIJson_Countries::is_page_Set() const{
    return m_page_isSet;
}

bool OAIJson_Countries::is_page_Valid() const{
    return m_page_isValid;
}

double OAIJson_Countries::getTotal() const {
    return m_total;
}
void OAIJson_Countries::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIJson_Countries::is_total_Set() const{
    return m_total_isSet;
}

bool OAIJson_Countries::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIJson_Countries::isSet() const {
...
bool OAIJson_Countries::isValid() const {
