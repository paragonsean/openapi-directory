...
OAIXml_ns0_venues::OAIXml_ns0_venues(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_venues::OAIXml_ns0_venues() {
    this->initializeModel();
}

OAIXml_ns0_venues::~OAIXml_ns0_venues() {}

void OAIXml_ns0_venues::initializeModel() {
...
void OAIXml_ns0_venues::fromJson(QString jsonString) {
...
void OAIXml_ns0_venues::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_venues::asJson() const {
...
QJsonObject OAIXml_ns0_venues::asJsonObject() const {
    QJsonObject obj;
...
double OAIXml_ns0_venues::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIXml_ns0_venues::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIXml_ns0_venues::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIXml_ns0_venues::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIXml_ns0_venues::getPage() const {
    return m_page;
}
void OAIXml_ns0_venues::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIXml_ns0_venues::is_page_Set() const{
    return m_page_isSet;
}

bool OAIXml_ns0_venues::is_page_Valid() const{
    return m_page_isValid;
}

double OAIXml_ns0_venues::getTotal() const {
    return m_total;
}
void OAIXml_ns0_venues::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIXml_ns0_venues::is_total_Set() const{
    return m_total_isSet;
}

bool OAIXml_ns0_venues::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIXml_ns0_venues::isSet() const {
...
bool OAIXml_ns0_venues::isValid() const {
