...
#ifndef OAI_OAIClass10SearchVenuesApi_H
#define OAI_OAIClass10SearchVenuesApi_H
...
class OAIClass10SearchVenuesApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SearchVenuesApi(const int timeOut = 0);
    ~OAIClass10SearchVenuesApi();
    ...
    */
    virtual void resource1_0SearchVenuesGetVenuesGET(const ::OpenAPI::OptionalParam<QString> &city_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &city_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &country = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &state = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &state_code = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void resource1_0SearchVenuesGetVenuesGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SearchVenuesGetVenuesGETSignal(OAIJson_Venues summary);


    void resource1_0SearchVenuesGetVenuesGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Venues summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchVenuesGetVenuesGETSignalError() instead")
    void resource1_0SearchVenuesGetVenuesGETSignalE(OAIJson_Venues summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchVenuesGetVenuesGETSignalError(OAIJson_Venues summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchVenuesGetVenuesGETSignalErrorFull() instead")
    void resource1_0SearchVenuesGetVenuesGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchVenuesGetVenuesGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
