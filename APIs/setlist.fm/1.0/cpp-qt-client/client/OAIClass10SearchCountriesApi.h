...
#ifndef OAI_OAIClass10SearchCountriesApi_H
#define OAI_OAIClass10SearchCountriesApi_H
...
class OAIClass10SearchCountriesApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SearchCountriesApi(const int timeOut = 0);
    ~OAIClass10SearchCountriesApi();
    ...
    virtual void resource1_0SearchCountriesGetCountriesGET();
...
private:
    ...
    void resource1_0SearchCountriesGetCountriesGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SearchCountriesGetCountriesGETSignal(OAIJson_Countries summary);


    void resource1_0SearchCountriesGetCountriesGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Countries summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchCountriesGetCountriesGETSignalError() instead")
    void resource1_0SearchCountriesGetCountriesGETSignalE(OAIJson_Countries summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchCountriesGetCountriesGETSignalError(OAIJson_Countries summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchCountriesGetCountriesGETSignalErrorFull() instead")
    void resource1_0SearchCountriesGetCountriesGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchCountriesGetCountriesGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
