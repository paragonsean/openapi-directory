...
OAIXml_ns0_venue::OAIXml_ns0_venue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_venue::OAIXml_ns0_venue() {
    this->initializeModel();
}

OAIXml_ns0_venue::~OAIXml_ns0_venue() {}

void OAIXml_ns0_venue::initializeModel() {
...
void OAIXml_ns0_venue::fromJson(QString jsonString) {
...
void OAIXml_ns0_venue::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_venue::asJson() const {
...
QJsonObject OAIXml_ns0_venue::asJsonObject() const {
    QJsonObject obj;
    if (m_city.isSet()) {
...
OAIXml_ns0_city OAIXml_ns0_venue::getCity() const {
    return m_city;
}
void OAIXml_ns0_venue::setCity(const OAIXml_ns0_city &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIXml_ns0_venue::is_city_Set() const{
    return m_city_isSet;
}

bool OAIXml_ns0_venue::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIXml_ns0_venue::getId() const {
    return m_id;
}
void OAIXml_ns0_venue::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIXml_ns0_venue::is_id_Set() const{
    return m_id_isSet;
}

bool OAIXml_ns0_venue::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIXml_ns0_venue::getName() const {
    return m_name;
}
void OAIXml_ns0_venue::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_venue::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_venue::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIXml_ns0_venue::getUrl() const {
    return m_url;
}
void OAIXml_ns0_venue::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIXml_ns0_venue::is_url_Set() const{
    return m_url_isSet;
}

bool OAIXml_ns0_venue::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIXml_ns0_venue::isSet() const {
...
bool OAIXml_ns0_venue::isValid() const {
