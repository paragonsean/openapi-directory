...
#ifndef OAIXml_ns0_set_H
#define OAIXml_ns0_set_H
...
namespace OpenAPI {
class OAIXml_ns0_song;

class OAIXml_ns0_set : public OAIObject {
public:
    OAIXml_ns0_set();
    OAIXml_ns0_set(QString json);
    ~OAIXml_ns0_set() override;
    ...
    OAIXml_ns0_song getSong() const;
    void setSong(const OAIXml_ns0_song &song);
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_set)

#endif // OAIXml_ns0_set_H
