...
#ifndef OAI_OAIClass10UserUserIdEditedApi_H
#define OAI_OAIClass10UserUserIdEditedApi_H
...
class OAIClass10UserUserIdEditedApi : public QObject {
    Q_OBJECT

public:
    OAIClass10UserUserIdEditedApi(const int timeOut = 0);
    ~OAIClass10UserUserIdEditedApi();
    ...
    */
    virtual void resource1_0UserUserIdEditedGetUserEditedSetlistsGET(const QString &user_id, const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignal(OAIJson_Setlists summary);


    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalError() instead")
    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalE(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalError(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalErrorFull() instead")
    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdEditedGetUserEditedSetlistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
