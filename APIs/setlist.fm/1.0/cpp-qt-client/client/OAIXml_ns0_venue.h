...
#ifndef OAIXml_ns0_venue_H
#define OAIXml_ns0_venue_H

#include <QJsonObject>

#include "OAIXml_ns0_city.h"
#include <QString>
...
namespace OpenAPI {
class OAIXml_ns0_city;

class OAIXml_ns0_venue : public OAIObject {
public:
    OAIXml_ns0_venue();
    OAIXml_ns0_venue(QString json);
    ~OAIXml_ns0_venue() override;
    ...
    OAIXml_ns0_city getCity() const;
    void setCity(const OAIXml_ns0_city &city);
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_venue)

#endif // OAIXml_ns0_venue_H
