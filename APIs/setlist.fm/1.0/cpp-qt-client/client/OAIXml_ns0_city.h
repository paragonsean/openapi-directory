...
#ifndef OAIXml_ns0_city_H
#define OAIXml_ns0_city_H
...
namespace OpenAPI {
class OAIXml_ns0_coords;
class OAIXml_ns0_country;

class OAIXml_ns0_city : public OAIObject {
public:
    OAIXml_ns0_city();
    OAIXml_ns0_city(QString json);
    ~OAIXml_ns0_city() override;
    ...
    OAIXml_ns0_coords getCoords() const;
    void setCoords(const OAIXml_ns0_coords &coords);
    bool is_coords_Set() const;
    bool is_coords_Valid() const;

    OAIXml_ns0_country getCountry() const;
    void setCountry(const OAIXml_ns0_country &country);
...
private:
    ...
    OAIXml_ns0_coords m_coords;
    bool m_coords_isSet;
    bool m_coords_isValid;

    OAIXml_ns0_country m_country;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_city)

#endif // OAIXml_ns0_city_H
