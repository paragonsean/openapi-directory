...
#ifndef OAIJson_Error_H
#define OAIJson_Error_H
...
class OAIJson_Error : public OAIObject {
public:
    OAIJson_Error();
    OAIJson_Error(QString json);
    ~OAIJson_Error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Error)

#endif // OAIJson_Error_H
