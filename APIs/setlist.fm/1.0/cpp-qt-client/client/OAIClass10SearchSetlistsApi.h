...
#ifndef OAI_OAIClass10SearchSetlistsApi_H
#define OAI_OAIClass10SearchSetlistsApi_H
...
class OAIClass10SearchSetlistsApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SearchSetlistsApi(const int timeOut = 0);
    ~OAIClass10SearchSetlistsApi();
    ...
    * @param[in]  city_id QString [optional]
    * @param[in]  city_name QString [optional]
    * @param[in]  country_code QString [optional]
    * @param[in]  date QString [optional]
    * @param[in]  last_fm qint32 [optional]
    ...
    * @param[in]  tour_name QString [optional]
    * @param[in]  venue_id QString [optional]
    * @param[in]  venue_name QString [optional]
    * @param[in]  year QString [optional]
    */
    virtual void resource1_0SearchSetlistsGetSetlistsGET(const ::OpenAPI::OptionalParam<QString> &artist_mbid = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &artist_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &artist_tmid = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &city_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &city_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &country_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &last_fm = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &last_updated = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &state = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &state_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tour_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &venue_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &venue_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &year = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void resource1_0SearchSetlistsGetSetlistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SearchSetlistsGetSetlistsGETSignal(OAIJson_Setlists summary);


    void resource1_0SearchSetlistsGetSetlistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchSetlistsGetSetlistsGETSignalError() instead")
    void resource1_0SearchSetlistsGetSetlistsGETSignalE(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchSetlistsGetSetlistsGETSignalError(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchSetlistsGetSetlistsGETSignalErrorFull() instead")
    void resource1_0SearchSetlistsGetSetlistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchSetlistsGetSetlistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
