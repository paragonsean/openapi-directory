...
#ifndef OAI_OAIClass10UserUserIdAttendedApi_H
#define OAI_OAIClass10UserUserIdAttendedApi_H
...
class OAIClass10UserUserIdAttendedApi : public QObject {
    Q_OBJECT

public:
    OAIClass10UserUserIdAttendedApi(const int timeOut = 0);
    ~OAIClass10UserUserIdAttendedApi();
    ...
    */
    virtual void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGET(const QString &user_id, const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignal(OAIJson_Setlists summary);


    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalError() instead")
    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalE(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalError(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalErrorFull() instead")
    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdAttendedGetUserAttendedSetlistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
