...
#ifndef OAIXml_ns0_error_H
#define OAIXml_ns0_error_H
...
class OAIXml_ns0_error : public OAIObject {
public:
    OAIXml_ns0_error();
    OAIXml_ns0_error(QString json);
    ~OAIXml_ns0_error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_error)

#endif // OAIXml_ns0_error_H
