...
OAIJson_User::OAIJson_User(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_User::OAIJson_User() {
    this->initializeModel();
}

OAIJson_User::~OAIJson_User() {}

void OAIJson_User::initializeModel() {
...
void OAIJson_User::fromJson(QString jsonString) {
...
void OAIJson_User::fromJsonObject(QJsonObject json) {
...
QString OAIJson_User::asJson() const {
...
QJsonObject OAIJson_User::asJsonObject() const {
    QJsonObject obj;
    if (m_about_isSet) {
...
QString OAIJson_User::getAbout() const {
    return m_about;
}
void OAIJson_User::setAbout(const QString &about) {
    m_about = about;
    m_about_isSet = true;
}

bool OAIJson_User::is_about_Set() const{
    return m_about_isSet;
}

bool OAIJson_User::is_about_Valid() const{
    return m_about_isValid;
}

QString OAIJson_User::getFlickr() const {
    return m_flickr;
}
void OAIJson_User::setFlickr(const QString &flickr) {
    m_flickr = flickr;
    m_flickr_isSet = true;
}

bool OAIJson_User::is_flickr_Set() const{
    return m_flickr_isSet;
}

bool OAIJson_User::is_flickr_Valid() const{
    return m_flickr_isValid;
}

QString OAIJson_User::getFullname() const {
    return m_fullname;
}
void OAIJson_User::setFullname(const QString &fullname) {
    m_fullname = fullname;
    m_fullname_isSet = true;
}

bool OAIJson_User::is_fullname_Set() const{
    return m_fullname_isSet;
}

bool OAIJson_User::is_fullname_Valid() const{
    return m_fullname_isValid;
}

QString OAIJson_User::getLastFm() const {
    return m_last_fm;
}
void OAIJson_User::setLastFm(const QString &last_fm) {
    m_last_fm = last_fm;
    m_last_fm_isSet = true;
}

bool OAIJson_User::is_last_fm_Set() const{
    return m_last_fm_isSet;
}

bool OAIJson_User::is_last_fm_Valid() const{
    return m_last_fm_isValid;
}

QString OAIJson_User::getMySpace() const {
    return m_my_space;
}
void OAIJson_User::setMySpace(const QString &my_space) {
    m_my_space = my_space;
    m_my_space_isSet = true;
}

bool OAIJson_User::is_my_space_Set() const{
    return m_my_space_isSet;
}

bool OAIJson_User::is_my_space_Valid() const{
    return m_my_space_isValid;
}

QString OAIJson_User::getTwitter() const {
    return m_twitter;
}
void OAIJson_User::setTwitter(const QString &twitter) {
    m_twitter = twitter;
    m_twitter_isSet = true;
}

bool OAIJson_User::is_twitter_Set() const{
    return m_twitter_isSet;
}

bool OAIJson_User::is_twitter_Valid() const{
    return m_twitter_isValid;
}

QString OAIJson_User::getUrl() const {
    return m_url;
}
void OAIJson_User::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIJson_User::is_url_Set() const{
    return m_url_isSet;
}

bool OAIJson_User::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIJson_User::getUserId() const {
    return m_user_id;
}
void OAIJson_User::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIJson_User::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIJson_User::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIJson_User::getWebsite() const {
    return m_website;
}
void OAIJson_User::setWebsite(const QString &website) {
    m_website = website;
    m_website_isSet = true;
}

bool OAIJson_User::is_website_Set() const{
    return m_website_isSet;
}

bool OAIJson_User::is_website_Valid() const{
    return m_website_isValid;
}

bool OAIJson_User::isSet() const {
...
bool OAIJson_User::isValid() const {
