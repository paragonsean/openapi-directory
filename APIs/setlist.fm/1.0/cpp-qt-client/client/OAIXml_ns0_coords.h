...
#ifndef OAIXml_ns0_coords_H
#define OAIXml_ns0_coords_H
...
class OAIXml_ns0_coords : public OAIObject {
public:
    OAIXml_ns0_coords();
    OAIXml_ns0_coords(QString json);
    ~OAIXml_ns0_coords() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_coords)

#endif // OAIXml_ns0_coords_H
