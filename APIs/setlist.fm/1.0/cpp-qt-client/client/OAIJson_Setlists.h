...
#ifndef OAIJson_Setlists_H
#define OAIJson_Setlists_H
...
namespace OpenAPI {
class OAIJson_Setlist;

class OAIJson_Setlists : public OAIObject {
public:
    OAIJson_Setlists();
    OAIJson_Setlists(QString json);
    ~OAIJson_Setlists() override;
    ...
    double getItemsPerPage() const;
    void setItemsPerPage(const double &items_per_page);
    ...
    QList<OAIJson_Setlist> getSetlist() const;
    void setSetlist(const QList<OAIJson_Setlist> &setlist);
    bool is_setlist_Set() const;
    bool is_setlist_Valid() const;
...
private:
    ...
    QList<OAIJson_Setlist> m_setlist;
    bool m_setlist_isSet;
    bool m_setlist_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Setlists)

#endif // OAIJson_Setlists_H
