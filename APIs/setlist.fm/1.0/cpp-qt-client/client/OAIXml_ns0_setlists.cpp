...
OAIXml_ns0_setlists::OAIXml_ns0_setlists(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_setlists::OAIXml_ns0_setlists() {
    this->initializeModel();
}

OAIXml_ns0_setlists::~OAIXml_ns0_setlists() {}

void OAIXml_ns0_setlists::initializeModel() {
...
void OAIXml_ns0_setlists::fromJson(QString jsonString) {
...
void OAIXml_ns0_setlists::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_setlists::asJson() const {
...
QJsonObject OAIXml_ns0_setlists::asJsonObject() const {
    QJsonObject obj;
...
double OAIXml_ns0_setlists::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIXml_ns0_setlists::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIXml_ns0_setlists::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIXml_ns0_setlists::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIXml_ns0_setlists::getPage() const {
    return m_page;
}
void OAIXml_ns0_setlists::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIXml_ns0_setlists::is_page_Set() const{
    return m_page_isSet;
}

bool OAIXml_ns0_setlists::is_page_Valid() const{
    return m_page_isValid;
}

double OAIXml_ns0_setlists::getTotal() const {
    return m_total;
}
void OAIXml_ns0_setlists::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIXml_ns0_setlists::is_total_Set() const{
    return m_total_isSet;
}

bool OAIXml_ns0_setlists::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIXml_ns0_setlists::isSet() const {
...
bool OAIXml_ns0_setlists::isValid() const {
