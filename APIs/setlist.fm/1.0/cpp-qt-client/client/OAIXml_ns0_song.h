...
#ifndef OAIXml_ns0_song_H
#define OAIXml_ns0_song_H
...
class OAIXml_ns0_song : public OAIObject {
public:
    OAIXml_ns0_song();
    OAIXml_ns0_song(QString json);
    ~OAIXml_ns0_song() override;
    ...
    OAIXml_ns0_artist getCover() const;
    void setCover(const OAIXml_ns0_artist &cover);
    ...
    bool isTape() const;
    void setTape(const bool &tape);
    bool is_tape_Set() const;
    bool is_tape_Valid() const;

    OAIXml_ns0_artist getWith() const;
    void setWith(const OAIXml_ns0_artist &with);
    bool is_with_Set() const;
    bool is_with_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_song)

#endif // OAIXml_ns0_song_H
