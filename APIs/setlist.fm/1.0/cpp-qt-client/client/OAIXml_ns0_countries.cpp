...
#include "OAIXml_ns0_countries.h"
...
OAIXml_ns0_countries::OAIXml_ns0_countries(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_countries::OAIXml_ns0_countries() {
    this->initializeModel();
}

OAIXml_ns0_countries::~OAIXml_ns0_countries() {}

void OAIXml_ns0_countries::initializeModel() {
...
void OAIXml_ns0_countries::fromJson(QString jsonString) {
...
void OAIXml_ns0_countries::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_countries::asJson() const {
...
QJsonObject OAIXml_ns0_countries::asJsonObject() const {
    QJsonObject obj;
...
double OAIXml_ns0_countries::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIXml_ns0_countries::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIXml_ns0_countries::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIXml_ns0_countries::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIXml_ns0_countries::getPage() const {
    return m_page;
}
void OAIXml_ns0_countries::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIXml_ns0_countries::is_page_Set() const{
    return m_page_isSet;
}

bool OAIXml_ns0_countries::is_page_Valid() const{
    return m_page_isValid;
}

double OAIXml_ns0_countries::getTotal() const {
    return m_total;
}
void OAIXml_ns0_countries::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIXml_ns0_countries::is_total_Set() const{
    return m_total_isSet;
}

bool OAIXml_ns0_countries::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIXml_ns0_countries::isSet() const {
...
bool OAIXml_ns0_countries::isValid() const {
