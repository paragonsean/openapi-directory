...
OAIXml_ns0_city::OAIXml_ns0_city(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_city::OAIXml_ns0_city() {
    this->initializeModel();
}

OAIXml_ns0_city::~OAIXml_ns0_city() {}

void OAIXml_ns0_city::initializeModel() {
...
void OAIXml_ns0_city::fromJson(QString jsonString) {
...
void OAIXml_ns0_city::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_city::asJson() const {
...
QJsonObject OAIXml_ns0_city::asJsonObject() const {
    QJsonObject obj;
    if (m_coords.isSet()) {
...
OAIXml_ns0_coords OAIXml_ns0_city::getCoords() const {
    return m_coords;
}
void OAIXml_ns0_city::setCoords(const OAIXml_ns0_coords &coords) {
    m_coords = coords;
    m_coords_isSet = true;
}

bool OAIXml_ns0_city::is_coords_Set() const{
    return m_coords_isSet;
}

bool OAIXml_ns0_city::is_coords_Valid() const{
    return m_coords_isValid;
}

OAIXml_ns0_country OAIXml_ns0_city::getCountry() const {
    return m_country;
}
void OAIXml_ns0_city::setCountry(const OAIXml_ns0_country &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIXml_ns0_city::is_country_Set() const{
    return m_country_isSet;
}

bool OAIXml_ns0_city::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIXml_ns0_city::getId() const {
    return m_id;
}
void OAIXml_ns0_city::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIXml_ns0_city::is_id_Set() const{
    return m_id_isSet;
}

bool OAIXml_ns0_city::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIXml_ns0_city::getName() const {
    return m_name;
}
void OAIXml_ns0_city::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_city::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_city::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIXml_ns0_city::getState() const {
    return m_state;
}
void OAIXml_ns0_city::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIXml_ns0_city::is_state_Set() const{
    return m_state_isSet;
}

bool OAIXml_ns0_city::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIXml_ns0_city::getStateCode() const {
    return m_state_code;
}
void OAIXml_ns0_city::setStateCode(const QString &state_code) {
    m_state_code = state_code;
    m_state_code_isSet = true;
}

bool OAIXml_ns0_city::is_state_code_Set() const{
    return m_state_code_isSet;
}

bool OAIXml_ns0_city::is_state_code_Valid() const{
    return m_state_code_isValid;
}

bool OAIXml_ns0_city::isSet() const {
...
bool OAIXml_ns0_city::isValid() const {
