...
#ifndef OAIXml_ns0_venues_H
#define OAIXml_ns0_venues_H
...
class OAIXml_ns0_venues : public OAIObject {
public:
    OAIXml_ns0_venues();
    OAIXml_ns0_venues(QString json);
    ~OAIXml_ns0_venues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_venues)

#endif // OAIXml_ns0_venues_H
