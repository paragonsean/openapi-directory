...
#ifndef OAI_OAIClass10ArtistMbidApi_H
#define OAI_OAIClass10ArtistMbidApi_H
...
class OAIClass10ArtistMbidApi : public QObject {
    Q_OBJECT

public:
    OAIClass10ArtistMbidApi(const int timeOut = 0);
    ~OAIClass10ArtistMbidApi();
    ...
    */
    virtual void resource1_0ArtistMbidGetArtistGET(const QString &mbid);
...
private:
    ...
    void resource1_0ArtistMbidGetArtistGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0ArtistMbidGetArtistGETSignal(OAIJson_Artist summary);


    void resource1_0ArtistMbidGetArtistGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Artist summary);

    Q_DECL_DEPRECATED_X("Use resource1_0ArtistMbidGetArtistGETSignalError() instead")
    void resource1_0ArtistMbidGetArtistGETSignalE(OAIJson_Artist summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0ArtistMbidGetArtistGETSignalError(OAIJson_Artist summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0ArtistMbidGetArtistGETSignalErrorFull() instead")
    void resource1_0ArtistMbidGetArtistGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0ArtistMbidGetArtistGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
