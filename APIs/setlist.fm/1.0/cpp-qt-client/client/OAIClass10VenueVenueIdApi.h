...
#ifndef OAI_OAIClass10VenueVenueIdApi_H
#define OAI_OAIClass10VenueVenueIdApi_H
...
class OAIClass10VenueVenueIdApi : public QObject {
    Q_OBJECT

public:
    OAIClass10VenueVenueIdApi(const int timeOut = 0);
    ~OAIClass10VenueVenueIdApi();
    ...
    */
    virtual void resource1_0VenueVenueIdGetVenueGET(const QString &venue_id);
...
private:
    ...
    void resource1_0VenueVenueIdGetVenueGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0VenueVenueIdGetVenueGETSignal(OAIJson_Venue summary);


    void resource1_0VenueVenueIdGetVenueGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Venue summary);

    Q_DECL_DEPRECATED_X("Use resource1_0VenueVenueIdGetVenueGETSignalError() instead")
    void resource1_0VenueVenueIdGetVenueGETSignalE(OAIJson_Venue summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0VenueVenueIdGetVenueGETSignalError(OAIJson_Venue summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0VenueVenueIdGetVenueGETSignalErrorFull() instead")
    void resource1_0VenueVenueIdGetVenueGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0VenueVenueIdGetVenueGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
