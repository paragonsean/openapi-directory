...
#ifndef OAIJson_Country_H
#define OAIJson_Country_H
...
class OAIJson_Country : public OAIObject {
public:
    OAIJson_Country();
    OAIJson_Country(QString json);
    ~OAIJson_Country() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Country)

#endif // OAIJson_Country_H
