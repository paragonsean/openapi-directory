...
#ifndef OAI_OAIClass10UserUserIdApi_H
#define OAI_OAIClass10UserUserIdApi_H
...
class OAIClass10UserUserIdApi : public QObject {
    Q_OBJECT

public:
    OAIClass10UserUserIdApi(const int timeOut = 0);
    ~OAIClass10UserUserIdApi();
    ...
    */
    virtual void resource1_0UserUserIdGetUserGET(const QString &user_id);
...
private:
    ...
    void resource1_0UserUserIdGetUserGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0UserUserIdGetUserGETSignal(OAIJson_User summary);


    void resource1_0UserUserIdGetUserGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_User summary);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdGetUserGETSignalError() instead")
    void resource1_0UserUserIdGetUserGETSignalE(OAIJson_User summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdGetUserGETSignalError(OAIJson_User summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0UserUserIdGetUserGETSignalErrorFull() instead")
    void resource1_0UserUserIdGetUserGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0UserUserIdGetUserGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
