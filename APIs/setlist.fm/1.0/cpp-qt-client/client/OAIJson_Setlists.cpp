...
OAIJson_Setlists::OAIJson_Setlists(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Setlists::OAIJson_Setlists() {
    this->initializeModel();
}

OAIJson_Setlists::~OAIJson_Setlists() {}

void OAIJson_Setlists::initializeModel() {
    ...
    m_setlist_isSet = false;
    m_setlist_isValid = false;

    m_total_isSet = false;
    m_total_isValid = false;
}

void OAIJson_Setlists::fromJson(QString jsonString) {
...
void OAIJson_Setlists::fromJsonObject(QJsonObject json) {
    ...
    m_setlist_isValid = ::OpenAPI::fromJsonValue(m_setlist, json[QString("setlist")]);
    m_setlist_isSet = !json[QString("setlist")].isNull() && m_setlist_isValid;

    m_total_isValid = ::OpenAPI::fromJsonValue(m_total, json[QString("total")]);
    m_total_isSet = !json[QString("total")].isNull() && m_total_isValid;
}

QString OAIJson_Setlists::asJson() const {
...
QJsonObject OAIJson_Setlists::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_setlist.size() > 0) {
        obj.insert(QString("setlist"), ::OpenAPI::toJsonValue(m_setlist));
    }
    if (m_total_isSet) {
...
double OAIJson_Setlists::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIJson_Setlists::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIJson_Setlists::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIJson_Setlists::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIJson_Setlists::getPage() const {
    return m_page;
}
void OAIJson_Setlists::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIJson_Setlists::is_page_Set() const{
    return m_page_isSet;
}

bool OAIJson_Setlists::is_page_Valid() const{
    return m_page_isValid;
}

QList<OAIJson_Setlist> OAIJson_Setlists::getSetlist() const {
    return m_setlist;
}
void OAIJson_Setlists::setSetlist(const QList<OAIJson_Setlist> &setlist) {
    m_setlist = setlist;
    m_setlist_isSet = true;
}

bool OAIJson_Setlists::is_setlist_Set() const{
    return m_setlist_isSet;
}

bool OAIJson_Setlists::is_setlist_Valid() const{
    return m_setlist_isValid;
}

double OAIJson_Setlists::getTotal() const {
    return m_total;
}
void OAIJson_Setlists::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIJson_Setlists::is_total_Set() const{
    return m_total_isSet;
}

bool OAIJson_Setlists::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIJson_Setlists::isSet() const {
...
bool OAIJson_Setlists::isValid() const {
