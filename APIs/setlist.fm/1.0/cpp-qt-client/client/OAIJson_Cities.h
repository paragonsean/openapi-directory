...
#ifndef OAIJson_Cities_H
#define OAIJson_Cities_H
...
class OAIJson_Cities : public OAIObject {
public:
    OAIJson_Cities();
    OAIJson_Cities(QString json);
    ~OAIJson_Cities() override;
    ...
    QList<OAIJson_City> getCities() const;
    void setCities(const QList<OAIJson_City> &cities);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Cities)

#endif // OAIJson_Cities_H
