...
#ifndef OAIJson_Countries_H
#define OAIJson_Countries_H
...
class OAIJson_Countries : public OAIObject {
public:
    OAIJson_Countries();
    OAIJson_Countries(QString json);
    ~OAIJson_Countries() override;
    ...
    QList<OAIJson_Country> getCountry() const;
    void setCountry(const QList<OAIJson_Country> &country);
...
private:
    ...
    QList<OAIJson_Country> m_country;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Countries)

#endif // OAIJson_Countries_H
