...
OAIJson_Cities::OAIJson_Cities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Cities::OAIJson_Cities() {
    this->initializeModel();
}

OAIJson_Cities::~OAIJson_Cities() {}

void OAIJson_Cities::initializeModel() {
...
void OAIJson_Cities::fromJson(QString jsonString) {
...
void OAIJson_Cities::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Cities::asJson() const {
...
QJsonObject OAIJson_Cities::asJsonObject() const {
    QJsonObject obj;
    if (m_cities.size() > 0) {
...
QList<OAIJson_City> OAIJson_Cities::getCities() const {
    return m_cities;
}
void OAIJson_Cities::setCities(const QList<OAIJson_City> &cities) {
    m_cities = cities;
    m_cities_isSet = true;
}

bool OAIJson_Cities::is_cities_Set() const{
    return m_cities_isSet;
}

bool OAIJson_Cities::is_cities_Valid() const{
    return m_cities_isValid;
}

double OAIJson_Cities::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIJson_Cities::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIJson_Cities::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIJson_Cities::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIJson_Cities::getPage() const {
    return m_page;
}
void OAIJson_Cities::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIJson_Cities::is_page_Set() const{
    return m_page_isSet;
}

bool OAIJson_Cities::is_page_Valid() const{
    return m_page_isValid;
}

double OAIJson_Cities::getTotal() const {
    return m_total;
}
void OAIJson_Cities::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIJson_Cities::is_total_Set() const{
    return m_total_isSet;
}

bool OAIJson_Cities::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIJson_Cities::isSet() const {
...
bool OAIJson_Cities::isValid() const {
