...
OAIXml_ns0_country::OAIXml_ns0_country(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_country::OAIXml_ns0_country() {
    this->initializeModel();
}

OAIXml_ns0_country::~OAIXml_ns0_country() {}

void OAIXml_ns0_country::initializeModel() {
...
void OAIXml_ns0_country::fromJson(QString jsonString) {
...
void OAIXml_ns0_country::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_country::asJson() const {
...
QJsonObject OAIXml_ns0_country::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIXml_ns0_country::getCode() const {
    return m_code;
}
void OAIXml_ns0_country::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIXml_ns0_country::is_code_Set() const{
    return m_code_isSet;
}

bool OAIXml_ns0_country::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIXml_ns0_country::getName() const {
    return m_name;
}
void OAIXml_ns0_country::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_country::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_country::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIXml_ns0_country::isSet() const {
...
bool OAIXml_ns0_country::isValid() const {
