...
#ifndef OAI_OAIClass10ArtistMbidSetlistsApi_H
#define OAI_OAIClass10ArtistMbidSetlistsApi_H
...
class OAIClass10ArtistMbidSetlistsApi : public QObject {
    Q_OBJECT

public:
    OAIClass10ArtistMbidSetlistsApi(const int timeOut = 0);
    ~OAIClass10ArtistMbidSetlistsApi();
    ...
    */
    virtual void resource1_0ArtistMbidSetlistsGetArtistSetlistsGET(const QString &mbid, const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignal(OAIJson_Setlists summary);


    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalError() instead")
    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalE(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalError(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalErrorFull() instead")
    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0ArtistMbidSetlistsGetArtistSetlistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
