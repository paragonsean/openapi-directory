...
OAIXml_ns0_coords::OAIXml_ns0_coords(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_coords::OAIXml_ns0_coords() {
    this->initializeModel();
}

OAIXml_ns0_coords::~OAIXml_ns0_coords() {}

void OAIXml_ns0_coords::initializeModel() {
...
void OAIXml_ns0_coords::fromJson(QString jsonString) {
...
void OAIXml_ns0_coords::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_coords::asJson() const {
...
QJsonObject OAIXml_ns0_coords::asJsonObject() const {
    QJsonObject obj;
    if (m_lat_isSet) {
...
double OAIXml_ns0_coords::getLat() const {
    return m_lat;
}
void OAIXml_ns0_coords::setLat(const double &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAIXml_ns0_coords::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAIXml_ns0_coords::is_lat_Valid() const{
    return m_lat_isValid;
}

double OAIXml_ns0_coords::getRLong() const {
    return m_r_long;
}
void OAIXml_ns0_coords::setRLong(const double &r_long) {
    m_r_long = r_long;
    m_r_long_isSet = true;
}

bool OAIXml_ns0_coords::is_r_long_Set() const{
    return m_r_long_isSet;
}

bool OAIXml_ns0_coords::is_r_long_Valid() const{
    return m_r_long_isValid;
}

bool OAIXml_ns0_coords::isSet() const {
...
bool OAIXml_ns0_coords::isValid() const {
