...
OAIXml_ns0_tour::OAIXml_ns0_tour(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_tour::OAIXml_ns0_tour() {
    this->initializeModel();
}

OAIXml_ns0_tour::~OAIXml_ns0_tour() {}

void OAIXml_ns0_tour::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIXml_ns0_tour::fromJson(QString jsonString) {
...
void OAIXml_ns0_tour::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIXml_ns0_tour::asJson() const {
...
QJsonObject OAIXml_ns0_tour::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIXml_ns0_tour::getName() const {
    return m_name;
}
void OAIXml_ns0_tour::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_tour::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_tour::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIXml_ns0_tour::isSet() const {
...
bool OAIXml_ns0_tour::isValid() const {
