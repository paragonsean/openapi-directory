...
#ifndef OAI_OAIClass10SearchArtistsApi_H
#define OAI_OAIClass10SearchArtistsApi_H
...
class OAIClass10SearchArtistsApi : public QObject {
    Q_OBJECT

public:
    OAIClass10SearchArtistsApi(const int timeOut = 0);
    ~OAIClass10SearchArtistsApi();
    ...
    /**
    * @param[in]  artist_mbid QString [optional]
    * @param[in]  artist_name QString [optional]
    * @param[in]  artist_tmid qint32 [optional]
    * @param[in]  p qint32 [optional]
    * @param[in]  sort QString [optional]
    */
    virtual void resource1_0SearchArtistsGetArtistsGET(const ::OpenAPI::OptionalParam<QString> &artist_mbid = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &artist_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &artist_tmid = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void resource1_0SearchArtistsGetArtistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0SearchArtistsGetArtistsGETSignal(OAIJson_Artists summary);


    void resource1_0SearchArtistsGetArtistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Artists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchArtistsGetArtistsGETSignalError() instead")
    void resource1_0SearchArtistsGetArtistsGETSignalE(OAIJson_Artists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchArtistsGetArtistsGETSignalError(OAIJson_Artists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0SearchArtistsGetArtistsGETSignalErrorFull() instead")
    void resource1_0SearchArtistsGetArtistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0SearchArtistsGetArtistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
