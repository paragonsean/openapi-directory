...
OAIXml_ns0_result::OAIXml_ns0_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_result::OAIXml_ns0_result() {
    this->initializeModel();
}

OAIXml_ns0_result::~OAIXml_ns0_result() {}

void OAIXml_ns0_result::initializeModel() {
...
void OAIXml_ns0_result::fromJson(QString jsonString) {
...
void OAIXml_ns0_result::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_result::asJson() const {
...
QJsonObject OAIXml_ns0_result::asJsonObject() const {
    QJsonObject obj;
...
double OAIXml_ns0_result::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIXml_ns0_result::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIXml_ns0_result::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIXml_ns0_result::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIXml_ns0_result::getPage() const {
    return m_page;
}
void OAIXml_ns0_result::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIXml_ns0_result::is_page_Set() const{
    return m_page_isSet;
}

bool OAIXml_ns0_result::is_page_Valid() const{
    return m_page_isValid;
}

double OAIXml_ns0_result::getTotal() const {
    return m_total;
}
void OAIXml_ns0_result::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIXml_ns0_result::is_total_Set() const{
    return m_total_isSet;
}

bool OAIXml_ns0_result::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIXml_ns0_result::isSet() const {
...
bool OAIXml_ns0_result::isValid() const {
