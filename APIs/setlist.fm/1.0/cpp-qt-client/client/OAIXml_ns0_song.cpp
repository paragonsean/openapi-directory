...
OAIXml_ns0_song::OAIXml_ns0_song(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_song::OAIXml_ns0_song() {
    this->initializeModel();
}

OAIXml_ns0_song::~OAIXml_ns0_song() {}

void OAIXml_ns0_song::initializeModel() {
...
void OAIXml_ns0_song::fromJson(QString jsonString) {
...
void OAIXml_ns0_song::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_song::asJson() const {
...
QJsonObject OAIXml_ns0_song::asJsonObject() const {
    QJsonObject obj;
    if (m_cover.isSet()) {
...
OAIXml_ns0_artist OAIXml_ns0_song::getCover() const {
    return m_cover;
}
void OAIXml_ns0_song::setCover(const OAIXml_ns0_artist &cover) {
    m_cover = cover;
    m_cover_isSet = true;
}

bool OAIXml_ns0_song::is_cover_Set() const{
    return m_cover_isSet;
}

bool OAIXml_ns0_song::is_cover_Valid() const{
    return m_cover_isValid;
}

QString OAIXml_ns0_song::getInfo() const {
    return m_info;
}
void OAIXml_ns0_song::setInfo(const QString &info) {
    m_info = info;
    m_info_isSet = true;
}

bool OAIXml_ns0_song::is_info_Set() const{
    return m_info_isSet;
}

bool OAIXml_ns0_song::is_info_Valid() const{
    return m_info_isValid;
}

QString OAIXml_ns0_song::getName() const {
    return m_name;
}
void OAIXml_ns0_song::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_song::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_song::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIXml_ns0_song::isTape() const {
    return m_tape;
}
void OAIXml_ns0_song::setTape(const bool &tape) {
    m_tape = tape;
    m_tape_isSet = true;
}

bool OAIXml_ns0_song::is_tape_Set() const{
    return m_tape_isSet;
}

bool OAIXml_ns0_song::is_tape_Valid() const{
    return m_tape_isValid;
}

OAIXml_ns0_artist OAIXml_ns0_song::getWith() const {
    return m_with;
}
void OAIXml_ns0_song::setWith(const OAIXml_ns0_artist &with) {
    m_with = with;
    m_with_isSet = true;
}

bool OAIXml_ns0_song::is_with_Set() const{
    return m_with_isSet;
}

bool OAIXml_ns0_song::is_with_Valid() const{
    return m_with_isValid;
}

bool OAIXml_ns0_song::isSet() const {
...
bool OAIXml_ns0_song::isValid() const {
