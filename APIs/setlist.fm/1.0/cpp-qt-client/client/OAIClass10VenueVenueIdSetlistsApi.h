...
#ifndef OAI_OAIClass10VenueVenueIdSetlistsApi_H
#define OAI_OAIClass10VenueVenueIdSetlistsApi_H
...
class OAIClass10VenueVenueIdSetlistsApi : public QObject {
    Q_OBJECT

public:
    OAIClass10VenueVenueIdSetlistsApi(const int timeOut = 0);
    ~OAIClass10VenueVenueIdSetlistsApi();
    ...
    /**
    * @param[in]  venue_id QString [required]
    * @param[in]  p qint32 [optional]
    */
    virtual void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGET(const QString &venue_id, const ::OpenAPI::OptionalParam<qint32> &p = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignal(OAIJson_Setlists summary);


    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalFull(OAIHttpRequestWorker *worker, OAIJson_Setlists summary);

    Q_DECL_DEPRECATED_X("Use resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalError() instead")
    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalE(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalError(OAIJson_Setlists summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalErrorFull() instead")
    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resource1_0VenueVenueIdSetlistsGetVenueSetlistsGETSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
