...
#ifndef OAIJson_Artists_H
#define OAIJson_Artists_H
...
class OAIJson_Artists : public OAIObject {
public:
    OAIJson_Artists();
    OAIJson_Artists(QString json);
    ~OAIJson_Artists() override;
    ...
    QList<OAIJson_Artist> getArtist() const;
    void setArtist(const QList<OAIJson_Artist> &artist);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Artists)

#endif // OAIJson_Artists_H
