...
#ifndef OAIXml_ns0_result_H
#define OAIXml_ns0_result_H
...
class OAIXml_ns0_result : public OAIObject {
public:
    OAIXml_ns0_result();
    OAIXml_ns0_result(QString json);
    ~OAIXml_ns0_result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_result)

#endif // OAIXml_ns0_result_H
