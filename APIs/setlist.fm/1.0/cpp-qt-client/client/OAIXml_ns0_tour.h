...
#ifndef OAIXml_ns0_tour_H
#define OAIXml_ns0_tour_H
...
class OAIXml_ns0_tour : public OAIObject {
public:
    OAIXml_ns0_tour();
    OAIXml_ns0_tour(QString json);
    ~OAIXml_ns0_tour() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_tour)

#endif // OAIXml_ns0_tour_H
