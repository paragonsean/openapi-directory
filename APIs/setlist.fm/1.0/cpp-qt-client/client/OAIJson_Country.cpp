...
OAIJson_Country::OAIJson_Country(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Country::OAIJson_Country() {
    this->initializeModel();
}

OAIJson_Country::~OAIJson_Country() {}

void OAIJson_Country::initializeModel() {
...
void OAIJson_Country::fromJson(QString jsonString) {
...
void OAIJson_Country::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Country::asJson() const {
...
QJsonObject OAIJson_Country::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIJson_Country::getCode() const {
    return m_code;
}
void OAIJson_Country::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIJson_Country::is_code_Set() const{
    return m_code_isSet;
}

bool OAIJson_Country::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIJson_Country::getName() const {
    return m_name;
}
void OAIJson_Country::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIJson_Country::is_name_Set() const{
    return m_name_isSet;
}

bool OAIJson_Country::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIJson_Country::isSet() const {
...
bool OAIJson_Country::isValid() const {
