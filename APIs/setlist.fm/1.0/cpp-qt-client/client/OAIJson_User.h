...
#ifndef OAIJson_User_H
#define OAIJson_User_H
...
class OAIJson_User : public OAIObject {
public:
    OAIJson_User();
    OAIJson_User(QString json);
    ~OAIJson_User() override;
    ...
    QString getFlickr() const;
    void setFlickr(const QString &flickr);
    bool is_flickr_Set() const;
    bool is_flickr_Valid() const;
    ...
    QString getLastFm() const;
    void setLastFm(const QString &last_fm);
    bool is_last_fm_Set() const;
    bool is_last_fm_Valid() const;

    QString getMySpace() const;
    void setMySpace(const QString &my_space);
    bool is_my_space_Set() const;
    bool is_my_space_Valid() const;
...
private:
    ...
    QString m_last_fm;
    bool m_last_fm_isSet;
    bool m_last_fm_isValid;

    QString m_my_space;
    bool m_my_space_isSet;
    bool m_my_space_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_User)

#endif // OAIJson_User_H
