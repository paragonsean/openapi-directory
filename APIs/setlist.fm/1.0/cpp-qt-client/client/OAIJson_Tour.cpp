...
OAIJson_Tour::OAIJson_Tour(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Tour::OAIJson_Tour() {
    this->initializeModel();
}

OAIJson_Tour::~OAIJson_Tour() {}

void OAIJson_Tour::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIJson_Tour::fromJson(QString jsonString) {
...
void OAIJson_Tour::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIJson_Tour::asJson() const {
...
QJsonObject OAIJson_Tour::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIJson_Tour::getName() const {
    return m_name;
}
void OAIJson_Tour::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIJson_Tour::is_name_Set() const{
    return m_name_isSet;
}

bool OAIJson_Tour::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIJson_Tour::isSet() const {
...
bool OAIJson_Tour::isValid() const {
