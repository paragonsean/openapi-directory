...
/*
 * OAIXml_ns0_artists.h
 *
 * A Result consisting of a list of artists.
 */

#ifndef OAIXml_ns0_artists_H
#define OAIXml_ns0_artists_H
...
class OAIXml_ns0_artists : public OAIObject {
public:
    OAIXml_ns0_artists();
    OAIXml_ns0_artists(QString json);
    ~OAIXml_ns0_artists() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_artists)

#endif // OAIXml_ns0_artists_H
