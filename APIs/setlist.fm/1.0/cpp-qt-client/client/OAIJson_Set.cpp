...
OAIJson_Set::OAIJson_Set(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Set::OAIJson_Set() {
    this->initializeModel();
}

OAIJson_Set::~OAIJson_Set() {}

void OAIJson_Set::initializeModel() {
...
void OAIJson_Set::fromJson(QString jsonString) {
...
void OAIJson_Set::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Set::asJson() const {
...
QJsonObject OAIJson_Set::asJsonObject() const {
    QJsonObject obj;
    if (m_encore_isSet) {
...
double OAIJson_Set::getEncore() const {
    return m_encore;
}
void OAIJson_Set::setEncore(const double &encore) {
    m_encore = encore;
    m_encore_isSet = true;
}

bool OAIJson_Set::is_encore_Set() const{
    return m_encore_isSet;
}

bool OAIJson_Set::is_encore_Valid() const{
    return m_encore_isValid;
}

QString OAIJson_Set::getName() const {
    return m_name;
}
void OAIJson_Set::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIJson_Set::is_name_Set() const{
    return m_name_isSet;
}

bool OAIJson_Set::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIJson_Song> OAIJson_Set::getSong() const {
    return m_song;
}
void OAIJson_Set::setSong(const QList<OAIJson_Song> &song) {
    m_song = song;
    m_song_isSet = true;
}

bool OAIJson_Set::is_song_Set() const{
    return m_song_isSet;
}

bool OAIJson_Set::is_song_Valid() const{
    return m_song_isValid;
}

bool OAIJson_Set::isSet() const {
...
bool OAIJson_Set::isValid() const {
