...
OAIXml_ns0_cities::OAIXml_ns0_cities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_cities::OAIXml_ns0_cities() {
    this->initializeModel();
}

OAIXml_ns0_cities::~OAIXml_ns0_cities() {}

void OAIXml_ns0_cities::initializeModel() {
...
void OAIXml_ns0_cities::fromJson(QString jsonString) {
...
void OAIXml_ns0_cities::fromJsonObject(QJsonObject json) {
...
QString OAIXml_ns0_cities::asJson() const {
...
QJsonObject OAIXml_ns0_cities::asJsonObject() const {
    QJsonObject obj;
...
double OAIXml_ns0_cities::getItemsPerPage() const {
    return m_items_per_page;
}
void OAIXml_ns0_cities::setItemsPerPage(const double &items_per_page) {
    m_items_per_page = items_per_page;
    m_items_per_page_isSet = true;
}

bool OAIXml_ns0_cities::is_items_per_page_Set() const{
    return m_items_per_page_isSet;
}

bool OAIXml_ns0_cities::is_items_per_page_Valid() const{
    return m_items_per_page_isValid;
}

double OAIXml_ns0_cities::getPage() const {
    return m_page;
}
void OAIXml_ns0_cities::setPage(const double &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIXml_ns0_cities::is_page_Set() const{
    return m_page_isSet;
}

bool OAIXml_ns0_cities::is_page_Valid() const{
    return m_page_isValid;
}

double OAIXml_ns0_cities::getTotal() const {
    return m_total;
}
void OAIXml_ns0_cities::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIXml_ns0_cities::is_total_Set() const{
    return m_total_isSet;
}

bool OAIXml_ns0_cities::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIXml_ns0_cities::isSet() const {
...
bool OAIXml_ns0_cities::isValid() const {
