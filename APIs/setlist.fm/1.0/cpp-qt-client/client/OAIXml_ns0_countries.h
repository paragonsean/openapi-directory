...
/*
 * OAIXml_ns0_countries.h
 *
 * A Result consisting of a list of countries.
 */

#ifndef OAIXml_ns0_countries_H
#define OAIXml_ns0_countries_H
...
class OAIXml_ns0_countries : public OAIObject {
public:
    OAIXml_ns0_countries();
    OAIXml_ns0_countries(QString json);
    ~OAIXml_ns0_countries() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_countries)

#endif // OAIXml_ns0_countries_H
