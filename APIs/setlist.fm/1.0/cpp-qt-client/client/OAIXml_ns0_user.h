...
#ifndef OAIXml_ns0_user_H
#define OAIXml_ns0_user_H
...
class OAIXml_ns0_user : public OAIObject {
public:
    OAIXml_ns0_user();
    OAIXml_ns0_user(QString json);
    ~OAIXml_ns0_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXml_ns0_user)

#endif // OAIXml_ns0_user_H
