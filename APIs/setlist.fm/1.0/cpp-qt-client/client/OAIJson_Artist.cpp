...
OAIJson_Artist::OAIJson_Artist(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJson_Artist::OAIJson_Artist() {
    this->initializeModel();
}

OAIJson_Artist::~OAIJson_Artist() {}

void OAIJson_Artist::initializeModel() {
...
void OAIJson_Artist::fromJson(QString jsonString) {
...
void OAIJson_Artist::fromJsonObject(QJsonObject json) {
...
QString OAIJson_Artist::asJson() const {
...
QJsonObject OAIJson_Artist::asJsonObject() const {
    QJsonObject obj;
...
QString OAIJson_Artist::getDisambiguation() const {
    return m_disambiguation;
}
void OAIJson_Artist::setDisambiguation(const QString &disambiguation) {
    m_disambiguation = disambiguation;
    m_disambiguation_isSet = true;
}

bool OAIJson_Artist::is_disambiguation_Set() const{
    return m_disambiguation_isSet;
}

bool OAIJson_Artist::is_disambiguation_Valid() const{
    return m_disambiguation_isValid;
}

QString OAIJson_Artist::getMbid() const {
    return m_mbid;
}
void OAIJson_Artist::setMbid(const QString &mbid) {
    m_mbid = mbid;
    m_mbid_isSet = true;
}

bool OAIJson_Artist::is_mbid_Set() const{
    return m_mbid_isSet;
}

bool OAIJson_Artist::is_mbid_Valid() const{
    return m_mbid_isValid;
}

QString OAIJson_Artist::getName() const {
    return m_name;
}
void OAIJson_Artist::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIJson_Artist::is_name_Set() const{
    return m_name_isSet;
}

bool OAIJson_Artist::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIJson_Artist::getSortName() const {
    return m_sort_name;
}
void OAIJson_Artist::setSortName(const QString &sort_name) {
    m_sort_name = sort_name;
    m_sort_name_isSet = true;
}

bool OAIJson_Artist::is_sort_name_Set() const{
    return m_sort_name_isSet;
}

bool OAIJson_Artist::is_sort_name_Valid() const{
    return m_sort_name_isValid;
}

double OAIJson_Artist::getTmid() const {
    return m_tmid;
}
void OAIJson_Artist::setTmid(const double &tmid) {
    m_tmid = tmid;
    m_tmid_isSet = true;
}

bool OAIJson_Artist::is_tmid_Set() const{
    return m_tmid_isSet;
}

bool OAIJson_Artist::is_tmid_Valid() const{
    return m_tmid_isValid;
}

QString OAIJson_Artist::getUrl() const {
    return m_url;
}
void OAIJson_Artist::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIJson_Artist::is_url_Set() const{
    return m_url_isSet;
}

bool OAIJson_Artist::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIJson_Artist::isSet() const {
...
bool OAIJson_Artist::isValid() const {
