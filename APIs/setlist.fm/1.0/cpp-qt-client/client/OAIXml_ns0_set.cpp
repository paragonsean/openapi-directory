...
OAIXml_ns0_set::OAIXml_ns0_set(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXml_ns0_set::OAIXml_ns0_set() {
    this->initializeModel();
}

OAIXml_ns0_set::~OAIXml_ns0_set() {}

void OAIXml_ns0_set::initializeModel() {

    m_encore_isSet = false;
    m_encore_isValid = false;
...
void OAIXml_ns0_set::fromJson(QString jsonString) {
...
void OAIXml_ns0_set::fromJsonObject(QJsonObject json) {

    m_encore_isValid = ::OpenAPI::fromJsonValue(m_encore, json[QString("encore")]);
    m_encore_isSet = !json[QString("encore")].isNull() && m_encore_isValid;
...
QString OAIXml_ns0_set::asJson() const {
...
QJsonObject OAIXml_ns0_set::asJsonObject() const {
    QJsonObject obj;
    if (m_encore_isSet) {
        obj.insert(QString("encore"), ::OpenAPI::toJsonValue(m_encore));
    }
    if (m_name_isSet) {
...
double OAIXml_ns0_set::getEncore() const {
    return m_encore;
}
void OAIXml_ns0_set::setEncore(const double &encore) {
    m_encore = encore;
    m_encore_isSet = true;
}

bool OAIXml_ns0_set::is_encore_Set() const{
    return m_encore_isSet;
}

bool OAIXml_ns0_set::is_encore_Valid() const{
    return m_encore_isValid;
}

QString OAIXml_ns0_set::getName() const {
    return m_name;
}
void OAIXml_ns0_set::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIXml_ns0_set::is_name_Set() const{
    return m_name_isSet;
}

bool OAIXml_ns0_set::is_name_Valid() const{
    return m_name_isValid;
}

OAIXml_ns0_song OAIXml_ns0_set::getSong() const {
    return m_song;
}
void OAIXml_ns0_set::setSong(const OAIXml_ns0_song &song) {
    m_song = song;
    m_song_isSet = true;
}

bool OAIXml_ns0_set::is_song_Set() const{
    return m_song_isSet;
}

bool OAIXml_ns0_set::is_song_Valid() const{
    return m_song_isValid;
}

bool OAIXml_ns0_set::isSet() const {
...
bool OAIXml_ns0_set::isValid() const {
