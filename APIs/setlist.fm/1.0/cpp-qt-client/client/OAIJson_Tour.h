...
#ifndef OAIJson_Tour_H
#define OAIJson_Tour_H
...
class OAIJson_Tour : public OAIObject {
public:
    OAIJson_Tour();
    OAIJson_Tour(QString json);
    ~OAIJson_Tour() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Tour)

#endif // OAIJson_Tour_H
