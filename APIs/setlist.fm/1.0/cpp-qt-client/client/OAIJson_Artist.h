...
#ifndef OAIJson_Artist_H
#define OAIJson_Artist_H
...
class OAIJson_Artist : public OAIObject {
public:
    OAIJson_Artist();
    OAIJson_Artist(QString json);
    ~OAIJson_Artist() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Artist)

#endif // OAIJson_Artist_H
