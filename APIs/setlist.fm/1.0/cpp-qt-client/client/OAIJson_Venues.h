...
#ifndef OAIJson_Venues_H
#define OAIJson_Venues_H
...
class OAIJson_Venues : public OAIObject {
public:
    OAIJson_Venues();
    OAIJson_Venues(QString json);
    ~OAIJson_Venues() override;
    ...
    QList<OAIJson_Venue> getVenue() const;
    void setVenue(const QList<OAIJson_Venue> &venue);
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_Venues)

#endif // OAIJson_Venues_H
