...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Venues();
  });
  ...
  describe('XmlNs0Venues', function() {
    it('should create an instance of XmlNs0Venues', function() {
      // uncomment below and update the code to test XmlNs0Venues
      //var instance = new SetlistFmApi.XmlNs0Venues();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Venues);
    });
