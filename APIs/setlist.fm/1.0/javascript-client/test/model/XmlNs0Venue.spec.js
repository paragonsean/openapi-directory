...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Venue();
  });
  ...
  describe('XmlNs0Venue', function() {
    it('should create an instance of XmlNs0Venue', function() {
      // uncomment below and update the code to test XmlNs0Venue
      //var instance = new SetlistFmApi.XmlNs0Venue();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Venue);
    });
