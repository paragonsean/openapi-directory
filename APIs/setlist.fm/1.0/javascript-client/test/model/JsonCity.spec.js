...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonCity();
  });
  ...
  describe('JsonCity', function() {
    it('should create an instance of JsonCity', function() {
      // uncomment below and update the code to test JsonCity
      //var instance = new SetlistFmApi.JsonCity();
      //expect(instance).to.be.a(SetlistFmApi.JsonCity);
    });
