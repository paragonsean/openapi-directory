...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Cities();
  });
  ...
  describe('XmlNs0Cities', function() {
    it('should create an instance of XmlNs0Cities', function() {
      // uncomment below and update the code to test XmlNs0Cities
      //var instance = new SetlistFmApi.XmlNs0Cities();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Cities);
    });
