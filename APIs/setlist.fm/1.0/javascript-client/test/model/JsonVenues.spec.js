...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonVenues();
  });
  ...
  describe('JsonVenues', function() {
    it('should create an instance of JsonVenues', function() {
      // uncomment below and update the code to test JsonVenues
      //var instance = new SetlistFmApi.JsonVenues();
      //expect(instance).to.be.a(SetlistFmApi.JsonVenues);
    });
