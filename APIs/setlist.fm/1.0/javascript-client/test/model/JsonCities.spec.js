...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonCities();
  });
  ...
  describe('JsonCities', function() {
    it('should create an instance of JsonCities', function() {
      // uncomment below and update the code to test JsonCities
      //var instance = new SetlistFmApi.JsonCities();
      //expect(instance).to.be.a(SetlistFmApi.JsonCities);
    });
