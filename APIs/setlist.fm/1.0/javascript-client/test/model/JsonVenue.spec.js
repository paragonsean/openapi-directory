...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonVenue();
  });
  ...
  describe('JsonVenue', function() {
    it('should create an instance of JsonVenue', function() {
      // uncomment below and update the code to test JsonVenue
      //var instance = new SetlistFmApi.JsonVenue();
      //expect(instance).to.be.a(SetlistFmApi.JsonVenue);
    });
