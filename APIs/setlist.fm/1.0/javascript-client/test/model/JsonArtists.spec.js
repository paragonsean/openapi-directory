...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonArtists();
  });
  ...
  describe('JsonArtists', function() {
    it('should create an instance of JsonArtists', function() {
      // uncomment below and update the code to test JsonArtists
      //var instance = new SetlistFmApi.JsonArtists();
      //expect(instance).to.be.a(SetlistFmApi.JsonArtists);
    });
