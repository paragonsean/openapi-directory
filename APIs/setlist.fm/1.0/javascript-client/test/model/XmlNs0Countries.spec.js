...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Countries();
  });
  ...
  describe('XmlNs0Countries', function() {
    it('should create an instance of XmlNs0Countries', function() {
      // uncomment below and update the code to test XmlNs0Countries
      //var instance = new SetlistFmApi.XmlNs0Countries();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Countries);
    });
