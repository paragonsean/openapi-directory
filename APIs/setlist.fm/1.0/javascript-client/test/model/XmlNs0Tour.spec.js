...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Tour();
  });
  ...
  describe('XmlNs0Tour', function() {
    it('should create an instance of XmlNs0Tour', function() {
      // uncomment below and update the code to test XmlNs0Tour
      //var instance = new SetlistFmApi.XmlNs0Tour();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Tour);
    });
