...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Country();
  });
  ...
  describe('XmlNs0Country', function() {
    it('should create an instance of XmlNs0Country', function() {
      // uncomment below and update the code to test XmlNs0Country
      //var instance = new SetlistFmApi.XmlNs0Country();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Country);
    });
