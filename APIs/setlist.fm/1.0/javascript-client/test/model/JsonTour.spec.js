...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonTour();
  });
  ...
  describe('JsonTour', function() {
    it('should create an instance of JsonTour', function() {
      // uncomment below and update the code to test JsonTour
      //var instance = new SetlistFmApi.JsonTour();
      //expect(instance).to.be.a(SetlistFmApi.JsonTour);
    });
