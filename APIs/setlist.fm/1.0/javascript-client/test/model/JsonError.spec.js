...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonError();
  });
  ...
  describe('JsonError', function() {
    it('should create an instance of JsonError', function() {
      // uncomment below and update the code to test JsonError
      //var instance = new SetlistFmApi.JsonError();
      //expect(instance).to.be.a(SetlistFmApi.JsonError);
    });
