...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Set();
  });
  ...
  describe('XmlNs0Set', function() {
    it('should create an instance of XmlNs0Set', function() {
      // uncomment below and update the code to test XmlNs0Set
      //var instance = new SetlistFmApi.XmlNs0Set();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Set);
    });

    it('should have the property encore (base name: "encore")', function() {
      // uncomment below and update the code to test the property encore
      //var instance = new SetlistFmApi.XmlNs0Set();
