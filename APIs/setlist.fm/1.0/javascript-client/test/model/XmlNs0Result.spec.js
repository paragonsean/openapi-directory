...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Result();
  });
  ...
  describe('XmlNs0Result', function() {
    it('should create an instance of XmlNs0Result', function() {
      // uncomment below and update the code to test XmlNs0Result
      //var instance = new SetlistFmApi.XmlNs0Result();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Result);
    });
