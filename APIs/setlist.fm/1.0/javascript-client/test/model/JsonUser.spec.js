...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonUser();
  });
  ...
  describe('JsonUser', function() {
    it('should create an instance of JsonUser', function() {
      // uncomment below and update the code to test JsonUser
      //var instance = new SetlistFmApi.JsonUser();
      //expect(instance).to.be.a(SetlistFmApi.JsonUser);
    });
