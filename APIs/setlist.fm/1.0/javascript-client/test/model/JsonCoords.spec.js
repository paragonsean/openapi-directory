...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonCoords();
  });
  ...
  describe('JsonCoords', function() {
    it('should create an instance of JsonCoords', function() {
      // uncomment below and update the code to test JsonCoords
      //var instance = new SetlistFmApi.JsonCoords();
      //expect(instance).to.be.a(SetlistFmApi.JsonCoords);
    });
