...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0City();
  });
  ...
  describe('XmlNs0City', function() {
    it('should create an instance of XmlNs0City', function() {
      // uncomment below and update the code to test XmlNs0City
      //var instance = new SetlistFmApi.XmlNs0City();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0City);
    });
