...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Artists();
  });
  ...
  describe('XmlNs0Artists', function() {
    it('should create an instance of XmlNs0Artists', function() {
      // uncomment below and update the code to test XmlNs0Artists
      //var instance = new SetlistFmApi.XmlNs0Artists();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Artists);
    });
