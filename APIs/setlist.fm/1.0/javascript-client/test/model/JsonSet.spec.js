...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonSet();
  });
  ...
  describe('JsonSet', function() {
    it('should create an instance of JsonSet', function() {
      // uncomment below and update the code to test JsonSet
      //var instance = new SetlistFmApi.JsonSet();
      //expect(instance).to.be.a(SetlistFmApi.JsonSet);
    });
