...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonCountry();
  });
  ...
  describe('JsonCountry', function() {
    it('should create an instance of JsonCountry', function() {
      // uncomment below and update the code to test JsonCountry
      //var instance = new SetlistFmApi.JsonCountry();
      //expect(instance).to.be.a(SetlistFmApi.JsonCountry);
    });
