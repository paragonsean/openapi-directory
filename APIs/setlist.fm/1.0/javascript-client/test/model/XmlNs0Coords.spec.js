...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Coords();
  });
  ...
  describe('XmlNs0Coords', function() {
    it('should create an instance of XmlNs0Coords', function() {
      // uncomment below and update the code to test XmlNs0Coords
      //var instance = new SetlistFmApi.XmlNs0Coords();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Coords);
    });
