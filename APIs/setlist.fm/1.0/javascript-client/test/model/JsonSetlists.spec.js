...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonSetlists();
  });
  ...
  describe('JsonSetlists', function() {
    it('should create an instance of JsonSetlists', function() {
      // uncomment below and update the code to test JsonSetlists
      //var instance = new SetlistFmApi.JsonSetlists();
      //expect(instance).to.be.a(SetlistFmApi.JsonSetlists);
    });
    ...
    it('should have the property setlist (base name: "setlist")', function() {
      // uncomment below and update the code to test the property setlist
      //var instance = new SetlistFmApi.JsonSetlists();
      //expect(instance).to.be();
    });
