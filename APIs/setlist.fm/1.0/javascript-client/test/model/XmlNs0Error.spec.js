...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Error();
  });
  ...
  describe('XmlNs0Error', function() {
    it('should create an instance of XmlNs0Error', function() {
      // uncomment below and update the code to test XmlNs0Error
      //var instance = new SetlistFmApi.XmlNs0Error();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Error);
    });
