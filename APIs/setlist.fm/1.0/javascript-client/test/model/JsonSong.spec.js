...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonSong();
  });
  ...
  describe('JsonSong', function() {
    it('should create an instance of JsonSong', function() {
      // uncomment below and update the code to test JsonSong
      //var instance = new SetlistFmApi.JsonSong();
      //expect(instance).to.be.a(SetlistFmApi.JsonSong);
    });
    ...
    it('should have the property _with (base name: "with")', function() {
      // uncomment below and update the code to test the property _with
      //var instance = new SetlistFmApi.JsonSong();
      //expect(instance).to.be();
    });
