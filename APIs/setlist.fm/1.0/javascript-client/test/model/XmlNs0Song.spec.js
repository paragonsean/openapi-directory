...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Song();
  });
  ...
  describe('XmlNs0Song', function() {
    it('should create an instance of XmlNs0Song', function() {
      // uncomment below and update the code to test XmlNs0Song
      //var instance = new SetlistFmApi.XmlNs0Song();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Song);
    });
