...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Setlist();
  });
  ...
  describe('XmlNs0Setlist', function() {
    it('should create an instance of XmlNs0Setlist', function() {
      // uncomment below and update the code to test XmlNs0Setlist
      //var instance = new SetlistFmApi.XmlNs0Setlist();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Setlist);
    });
    ...
    it('should have the property lastFmEventId (base name: "lastFmEventId")', function() {
      // uncomment below and update the code to test the property lastFmEventId
      //var instance = new SetlistFmApi.XmlNs0Setlist();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tour (base name: "tour")', function() {
      // uncomment below and update the code to test the property tour
      //var instance = new SetlistFmApi.XmlNs0Setlist();
      //expect(instance).to.be();
    });
