...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Artist();
  });
  ...
  describe('XmlNs0Artist', function() {
    it('should create an instance of XmlNs0Artist', function() {
      // uncomment below and update the code to test XmlNs0Artist
      //var instance = new SetlistFmApi.XmlNs0Artist();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Artist);
    });
    ...
    it('should have the property tmid (base name: "tmid")', function() {
      // uncomment below and update the code to test the property tmid
      //var instance = new SetlistFmApi.XmlNs0Artist();
      //expect(instance).to.be();
    });
