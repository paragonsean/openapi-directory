...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonArtist();
  });
  ...
  describe('JsonArtist', function() {
    it('should create an instance of JsonArtist', function() {
      // uncomment below and update the code to test JsonArtist
      //var instance = new SetlistFmApi.JsonArtist();
      //expect(instance).to.be.a(SetlistFmApi.JsonArtist);
    });
