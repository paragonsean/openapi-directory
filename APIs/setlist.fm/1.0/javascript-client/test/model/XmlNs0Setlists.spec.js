...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.XmlNs0Setlists();
  });
  ...
  describe('XmlNs0Setlists', function() {
    it('should create an instance of XmlNs0Setlists', function() {
      // uncomment below and update the code to test XmlNs0Setlists
      //var instance = new SetlistFmApi.XmlNs0Setlists();
      //expect(instance).to.be.a(SetlistFmApi.XmlNs0Setlists);
    });
