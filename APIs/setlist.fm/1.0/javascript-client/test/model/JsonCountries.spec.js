...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonCountries();
  });
  ...
  describe('JsonCountries', function() {
    it('should create an instance of JsonCountries', function() {
      // uncomment below and update the code to test JsonCountries
      //var instance = new SetlistFmApi.JsonCountries();
      //expect(instance).to.be.a(SetlistFmApi.JsonCountries);
    });
