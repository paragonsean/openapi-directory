...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.JsonSetlist();
  });
  ...
  describe('JsonSetlist', function() {
    it('should create an instance of JsonSetlist', function() {
      // uncomment below and update the code to test JsonSetlist
      //var instance = new SetlistFmApi.JsonSetlist();
      //expect(instance).to.be.a(SetlistFmApi.JsonSetlist);
    });
