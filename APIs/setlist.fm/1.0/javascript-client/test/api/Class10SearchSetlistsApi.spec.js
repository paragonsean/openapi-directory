...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SearchSetlistsApi();
  });
  ...
  describe('Class10SearchSetlistsApi', function() {
    describe('resource10SearchSetlistsGetSetlistsGET', function() {
      it('should call resource10SearchSetlistsGetSetlistsGET successfully', function(done) {
        //uncomment below and update the code to test resource10SearchSetlistsGetSetlistsGET
        //instance.resource10SearchSetlistsGetSetlistsGET(function(error) {
