...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10UserUserIdApi();
  });
  ...
  describe('Class10UserUserIdApi', function() {
    describe('resource10UserUserIdGetUserGET', function() {
      it('should call resource10UserUserIdGetUserGET successfully', function(done) {
        //uncomment below and update the code to test resource10UserUserIdGetUserGET
        //instance.resource10UserUserIdGetUserGET(function(error) {
