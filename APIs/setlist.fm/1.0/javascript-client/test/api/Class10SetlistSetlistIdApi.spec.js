...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SetlistSetlistIdApi();
  });
  ...
  describe('Class10SetlistSetlistIdApi', function() {
    describe('resource10SetlistSetlistIdGetSetlistGET', function() {
      it('should call resource10SetlistSetlistIdGetSetlistGET successfully', function(done) {
        //uncomment below and update the code to test resource10SetlistSetlistIdGetSetlistGET
        //instance.resource10SetlistSetlistIdGetSetlistGET(function(error) {
