...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SearchVenuesApi();
  });
  ...
  describe('Class10SearchVenuesApi', function() {
    describe('resource10SearchVenuesGetVenuesGET', function() {
      it('should call resource10SearchVenuesGetVenuesGET successfully', function(done) {
        //uncomment below and update the code to test resource10SearchVenuesGetVenuesGET
        //instance.resource10SearchVenuesGetVenuesGET(function(error) {
