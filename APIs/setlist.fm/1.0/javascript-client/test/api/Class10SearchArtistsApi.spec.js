...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SearchArtistsApi();
  });
  ...
  describe('Class10SearchArtistsApi', function() {
    describe('resource10SearchArtistsGetArtistsGET', function() {
      it('should call resource10SearchArtistsGetArtistsGET successfully', function(done) {
        //uncomment below and update the code to test resource10SearchArtistsGetArtistsGET
        //instance.resource10SearchArtistsGetArtistsGET(function(error) {
