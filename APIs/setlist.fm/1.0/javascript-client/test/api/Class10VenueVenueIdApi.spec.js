...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10VenueVenueIdApi();
  });
  ...
  describe('Class10VenueVenueIdApi', function() {
    describe('resource10VenueVenueIdGetVenueGET', function() {
      it('should call resource10VenueVenueIdGetVenueGET successfully', function(done) {
        //uncomment below and update the code to test resource10VenueVenueIdGetVenueGET
        //instance.resource10VenueVenueIdGetVenueGET(function(error) {
