...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10CityGeoIdApi();
  });
  ...
  describe('Class10CityGeoIdApi', function() {
    describe('resource10CityGeoIdGetCityGET', function() {
      it('should call resource10CityGeoIdGetCityGET successfully', function(done) {
        //uncomment below and update the code to test resource10CityGeoIdGetCityGET
        //instance.resource10CityGeoIdGetCityGET(function(error) {
