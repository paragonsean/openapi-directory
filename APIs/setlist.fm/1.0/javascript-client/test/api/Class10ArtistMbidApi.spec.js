...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10ArtistMbidApi();
  });
  ...
  describe('Class10ArtistMbidApi', function() {
    describe('resource10ArtistMbidGetArtistGET', function() {
      it('should call resource10ArtistMbidGetArtistGET successfully', function(done) {
        //uncomment below and update the code to test resource10ArtistMbidGetArtistGET
        //instance.resource10ArtistMbidGetArtistGET(function(error) {
