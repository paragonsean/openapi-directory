...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SearchCitiesApi();
  });
  ...
  describe('Class10SearchCitiesApi', function() {
    describe('resource10SearchCitiesGetCitiesGET', function() {
      it('should call resource10SearchCitiesGetCitiesGET successfully', function(done) {
        //uncomment below and update the code to test resource10SearchCitiesGetCitiesGET
        //instance.resource10SearchCitiesGetCitiesGET(function(error) {
