...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SearchCountriesApi();
  });
  ...
  describe('Class10SearchCountriesApi', function() {
    describe('resource10SearchCountriesGetCountriesGET', function() {
      it('should call resource10SearchCountriesGetCountriesGET successfully', function(done) {
        //uncomment below and update the code to test resource10SearchCountriesGetCountriesGET
        //instance.resource10SearchCountriesGetCountriesGET(function(error) {
