...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10ArtistMbidSetlistsApi();
  });
  ...
  describe('Class10ArtistMbidSetlistsApi', function() {
    describe('resource10ArtistMbidSetlistsGetArtistSetlistsGET', function() {
      it('should call resource10ArtistMbidSetlistsGetArtistSetlistsGET successfully', function(done) {
        //uncomment below and update the code to test resource10ArtistMbidSetlistsGetArtistSetlistsGET
        //instance.resource10ArtistMbidSetlistsGetArtistSetlistsGET(function(error) {
