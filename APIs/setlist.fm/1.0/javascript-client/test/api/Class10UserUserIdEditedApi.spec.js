...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10UserUserIdEditedApi();
  });
  ...
  describe('Class10UserUserIdEditedApi', function() {
    describe('resource10UserUserIdEditedGetUserEditedSetlistsGET', function() {
      it('should call resource10UserUserIdEditedGetUserEditedSetlistsGET successfully', function(done) {
        //uncomment below and update the code to test resource10UserUserIdEditedGetUserEditedSetlistsGET
        //instance.resource10UserUserIdEditedGetUserEditedSetlistsGET(function(error) {
