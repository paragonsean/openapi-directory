...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10SetlistVersionVersionIdApi();
  });
  ...
  describe('Class10SetlistVersionVersionIdApi', function() {
    describe('resource10SetlistVersionVersionIdGetSetlistVersionGET', function() {
      it('should call resource10SetlistVersionVersionIdGetSetlistVersionGET successfully', function(done) {
        //uncomment below and update the code to test resource10SetlistVersionVersionIdGetSetlistVersionGET
        //instance.resource10SetlistVersionVersionIdGetSetlistVersionGET(function(error) {
