...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SetlistFmApi.Class10VenueVenueIdSetlistsApi();
  });
  ...
  describe('Class10VenueVenueIdSetlistsApi', function() {
    describe('resource10VenueVenueIdSetlistsGetVenueSetlistsGET', function() {
      it('should call resource10VenueVenueIdSetlistsGetVenueSetlistsGET successfully', function(done) {
        //uncomment below and update the code to test resource10VenueVenueIdSetlistsGetVenueSetlistsGET
        //instance.resource10VenueVenueIdSetlistsGetVenueSetlistsGET(function(error) {
