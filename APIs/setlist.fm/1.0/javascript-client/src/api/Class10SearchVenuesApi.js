...
/**
* Class10SearchVenues service.
* @module api/Class10SearchVenuesApi
* @version 1.0
*/
export default class Class10SearchVenuesApi {

    /**
    * Constructs a new Class10SearchVenuesApi. 
    * @alias module:api/Class10SearchVenuesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SearchVenuesGetVenuesGET operation.
     * @callback module:api/Class10SearchVenuesApi~resource10SearchVenuesGetVenuesGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonVenues} data The data returned by the service call.
     ...
     * @param {String} [cityName] name of the city where the venue is located
     ...
     * @param {String} [state] the city's state
     * @param {String} [stateCode] the city's state code
     * @param {module:api/Class10SearchVenuesApi~resource10SearchVenuesGetVenuesGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonVenues}
     */
    resource10SearchVenuesGetVenuesGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = JsonVenues;
      return this.apiClient.callApi(
        '/1.0/search/venues', 'GET',
