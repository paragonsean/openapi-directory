...
/**
* Class10ArtistMbid service.
* @module api/Class10ArtistMbidApi
* @version 1.0
*/
export default class Class10ArtistMbidApi {

    /**
    * Constructs a new Class10ArtistMbidApi. 
    * @alias module:api/Class10ArtistMbidApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10ArtistMbidGetArtistGET operation.
     * @callback module:api/Class10ArtistMbidApi~resource10ArtistMbidGetArtistGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonArtist} data The data returned by the service call.
     ...
     * @param {String} mbid a Musicbrainz MBID, e.g. 0bfba3d3-6a04-4779-bb0a-df07df5b0558
     * @param {module:api/Class10ArtistMbidApi~resource10ArtistMbidGetArtistGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonArtist}
     */
    resource10ArtistMbidGetArtistGET(mbid, callback) {
      let postBody = null;
      // verify the required parameter 'mbid' is set
      if (mbid === undefined || mbid === null) {
        throw new Error("Missing the required parameter 'mbid' when calling resource10ArtistMbidGetArtistGET");
      }
