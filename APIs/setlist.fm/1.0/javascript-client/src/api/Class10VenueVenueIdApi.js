...
/**
* Class10VenueVenueId service.
* @module api/Class10VenueVenueIdApi
* @version 1.0
*/
export default class Class10VenueVenueIdApi {

    /**
    * Constructs a new Class10VenueVenueIdApi. 
    * @alias module:api/Class10VenueVenueIdApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10VenueVenueIdGetVenueGET operation.
     * @callback module:api/Class10VenueVenueIdApi~resource10VenueVenueIdGetVenueGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonVenue} data The data returned by the service call.
     ...
     * @param {module:api/Class10VenueVenueIdApi~resource10VenueVenueIdGetVenueGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonVenue}
     */
    resource10VenueVenueIdGetVenueGET(venueId, callback) {
      let postBody = null;
      // verify the required parameter 'venueId' is set
      if (venueId === undefined || venueId === null) {
        throw new Error("Missing the required parameter 'venueId' when calling resource10VenueVenueIdGetVenueGET");
      }
