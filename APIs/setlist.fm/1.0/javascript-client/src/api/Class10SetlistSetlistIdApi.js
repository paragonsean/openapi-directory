...
/**
* Class10SetlistSetlistId service.
* @module api/Class10SetlistSetlistIdApi
* @version 1.0
*/
export default class Class10SetlistSetlistIdApi {

    /**
    * Constructs a new Class10SetlistSetlistIdApi. 
    * @alias module:api/Class10SetlistSetlistIdApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SetlistSetlistIdGetSetlistGET operation.
     * @callback module:api/Class10SetlistSetlistIdApi~resource10SetlistSetlistIdGetSetlistGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonSetlist} data The data returned by the service call.
     ...
     * @param {module:api/Class10SetlistSetlistIdApi~resource10SetlistSetlistIdGetSetlistGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlist}
     */
    resource10SetlistSetlistIdGetSetlistGET(setlistId, callback) {
      let postBody = null;
      // verify the required parameter 'setlistId' is set
      if (setlistId === undefined || setlistId === null) {
        throw new Error("Missing the required parameter 'setlistId' when calling resource10SetlistSetlistIdGetSetlistGET");
      }
