...
/**
* Class10CityGeoId service.
* @module api/Class10CityGeoIdApi
* @version 1.0
*/
export default class Class10CityGeoIdApi {

    /**
    * Constructs a new Class10CityGeoIdApi. 
    * @alias module:api/Class10CityGeoIdApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10CityGeoIdGetCityGET operation.
     * @callback module:api/Class10CityGeoIdApi~resource10CityGeoIdGetCityGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonCity} data The data returned by the service call.
     ...
     * @param {module:api/Class10CityGeoIdApi~resource10CityGeoIdGetCityGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonCity}
     */
    resource10CityGeoIdGetCityGET(geoId, callback) {
      let postBody = null;
      // verify the required parameter 'geoId' is set
      if (geoId === undefined || geoId === null) {
        throw new Error("Missing the required parameter 'geoId' when calling resource10CityGeoIdGetCityGET");
      }
