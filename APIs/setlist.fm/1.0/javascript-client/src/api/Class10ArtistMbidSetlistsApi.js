...
/**
* Class10ArtistMbidSetlists service.
* @module api/Class10ArtistMbidSetlistsApi
* @version 1.0
*/
export default class Class10ArtistMbidSetlistsApi {

    /**
    * Constructs a new Class10ArtistMbidSetlistsApi. 
    * @alias module:api/Class10ArtistMbidSetlistsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10ArtistMbidSetlistsGetArtistSetlistsGET operation.
     * @callback module:api/Class10ArtistMbidSetlistsApi~resource10ArtistMbidSetlistsGetArtistSetlistsGETCallback
     ...
     * @param {String} mbid the Musicbrainz MBID of the artist
     * @param {Object} opts Optional parameters
     * @param {Number} [p = 1)] the number of the result page
     * @param {module:api/Class10ArtistMbidSetlistsApi~resource10ArtistMbidSetlistsGetArtistSetlistsGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlists}
     */
    resource10ArtistMbidSetlistsGetArtistSetlistsGET(mbid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'mbid' is set
      if (mbid === undefined || mbid === null) {
        throw new Error("Missing the required parameter 'mbid' when calling resource10ArtistMbidSetlistsGetArtistSetlistsGET");
      }
