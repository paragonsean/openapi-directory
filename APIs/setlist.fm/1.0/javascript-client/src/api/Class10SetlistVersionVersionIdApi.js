...
/**
* Class10SetlistVersionVersionId service.
* @module api/Class10SetlistVersionVersionIdApi
* @version 1.0
*/
export default class Class10SetlistVersionVersionIdApi {

    /**
    * Constructs a new Class10SetlistVersionVersionIdApi. 
    * @alias module:api/Class10SetlistVersionVersionIdApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SetlistVersionVersionIdGetSetlistVersionGET operation.
     * @callback module:api/Class10SetlistVersionVersionIdApi~resource10SetlistVersionVersionIdGetSetlistVersionGETCallback
     ...
     * @param {module:api/Class10SetlistVersionVersionIdApi~resource10SetlistVersionVersionIdGetSetlistVersionGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlist}
     */
    resource10SetlistVersionVersionIdGetSetlistVersionGET(versionId, callback) {
      let postBody = null;
      // verify the required parameter 'versionId' is set
      if (versionId === undefined || versionId === null) {
        throw new Error("Missing the required parameter 'versionId' when calling resource10SetlistVersionVersionIdGetSetlistVersionGET");
      }
      ...
      return this.apiClient.callApi(
        '/1.0/setlist/version/{versionId}', 'GET',
