...
/**
* Class10SearchCountries service.
* @module api/Class10SearchCountriesApi
* @version 1.0
*/
export default class Class10SearchCountriesApi {

    /**
    * Constructs a new Class10SearchCountriesApi. 
    * @alias module:api/Class10SearchCountriesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SearchCountriesGetCountriesGET operation.
     * @callback module:api/Class10SearchCountriesApi~resource10SearchCountriesGetCountriesGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonCountries} data The data returned by the service call.
     ...
     * Get a complete list of all supported countries.
     * @param {module:api/Class10SearchCountriesApi~resource10SearchCountriesGetCountriesGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonCountries}
     */
    resource10SearchCountriesGetCountriesGET(callback) {
      let postBody = null;
      ...
      let returnType = JsonCountries;
      return this.apiClient.callApi(
        '/1.0/search/countries', 'GET',
