...
/**
* Class10SearchArtists service.
* @module api/Class10SearchArtistsApi
* @version 1.0
*/
export default class Class10SearchArtistsApi {

    /**
    * Constructs a new Class10SearchArtistsApi. 
    * @alias module:api/Class10SearchArtistsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SearchArtistsGetArtistsGET operation.
     * @callback module:api/Class10SearchArtistsApi~resource10SearchArtistsGetArtistsGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonArtists} data The data returned by the service call.
     ...
     * @param {Number} [p = 1)] the number of the result page you'd like to have
     * @param {String} [sort = 'sortName')] the sort of the result, either sortName (default) or relevance
     * @param {module:api/Class10SearchArtistsApi~resource10SearchArtistsGetArtistsGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonArtists}
     */
    resource10SearchArtistsGetArtistsGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = JsonArtists;
      return this.apiClient.callApi(
        '/1.0/search/artists', 'GET',
