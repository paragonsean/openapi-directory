...
/**
* Class10UserUserId service.
* @module api/Class10UserUserIdApi
* @version 1.0
*/
export default class Class10UserUserIdApi {

    /**
    * Constructs a new Class10UserUserIdApi. 
    * @alias module:api/Class10UserUserIdApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10UserUserIdGetUserGET operation.
     * @callback module:api/Class10UserUserIdApi~resource10UserUserIdGetUserGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonUser} data The data returned by the service call.
     ...
     * @param {module:api/Class10UserUserIdApi~resource10UserUserIdGetUserGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonUser}
     */
    resource10UserUserIdGetUserGET(userId, callback) {
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling resource10UserUserIdGetUserGET");
      }
