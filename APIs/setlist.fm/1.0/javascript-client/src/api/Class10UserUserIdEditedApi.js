...
/**
* Class10UserUserIdEdited service.
* @module api/Class10UserUserIdEditedApi
* @version 1.0
*/
export default class Class10UserUserIdEditedApi {

    /**
    * Constructs a new Class10UserUserIdEditedApi. 
    * @alias module:api/Class10UserUserIdEditedApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10UserUserIdEditedGetUserEditedSetlistsGET operation.
     * @callback module:api/Class10UserUserIdEditedApi~resource10UserUserIdEditedGetUserEditedSetlistsGETCallback
     ...
     * @param {module:api/Class10UserUserIdEditedApi~resource10UserUserIdEditedGetUserEditedSetlistsGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlists}
     */
    resource10UserUserIdEditedGetUserEditedSetlistsGET(userId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling resource10UserUserIdEditedGetUserEditedSetlistsGET");
      }
