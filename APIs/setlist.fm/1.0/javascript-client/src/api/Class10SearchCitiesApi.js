...
/**
* Class10SearchCities service.
* @module api/Class10SearchCitiesApi
* @version 1.0
*/
export default class Class10SearchCitiesApi {

    /**
    * Constructs a new Class10SearchCitiesApi. 
    * @alias module:api/Class10SearchCitiesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10SearchCitiesGetCitiesGET operation.
     * @callback module:api/Class10SearchCitiesApi~resource10SearchCitiesGetCitiesGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JsonCities} data The data returned by the service call.
     ...
     * @param {String} [country] the city's country
     * @param {String} [name] name of the city
     * @param {Number} [p = 1)] the number of the result page you'd like to have
     * @param {String} [state] state the city lies in
     * @param {String} [stateCode] state code the city lies in
     * @param {module:api/Class10SearchCitiesApi~resource10SearchCitiesGetCitiesGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonCities}
     */
    resource10SearchCitiesGetCitiesGET(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = JsonCities;
      return this.apiClient.callApi(
        '/1.0/search/cities', 'GET',
