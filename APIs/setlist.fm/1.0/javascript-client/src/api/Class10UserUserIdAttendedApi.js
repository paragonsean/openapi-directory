...
/**
* Class10UserUserIdAttended service.
* @module api/Class10UserUserIdAttendedApi
* @version 1.0
*/
export default class Class10UserUserIdAttendedApi {

    /**
    * Constructs a new Class10UserUserIdAttendedApi. 
    * @alias module:api/Class10UserUserIdAttendedApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10UserUserIdAttendedGetUserAttendedSetlistsGET operation.
     * @callback module:api/Class10UserUserIdAttendedApi~resource10UserUserIdAttendedGetUserAttendedSetlistsGETCallback
     ...
     * @param {module:api/Class10UserUserIdAttendedApi~resource10UserUserIdAttendedGetUserAttendedSetlistsGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlists}
     */
    resource10UserUserIdAttendedGetUserAttendedSetlistsGET(userId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling resource10UserUserIdAttendedGetUserAttendedSetlistsGET");
      }
