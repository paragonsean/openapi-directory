...
/**
* Class10VenueVenueIdSetlists service.
* @module api/Class10VenueVenueIdSetlistsApi
* @version 1.0
*/
export default class Class10VenueVenueIdSetlistsApi {

    /**
    * Constructs a new Class10VenueVenueIdSetlistsApi. 
    * @alias module:api/Class10VenueVenueIdSetlistsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resource10VenueVenueIdSetlistsGetVenueSetlistsGET operation.
     * @callback module:api/Class10VenueVenueIdSetlistsApi~resource10VenueVenueIdSetlistsGetVenueSetlistsGETCallback
     ...
     * @param {module:api/Class10VenueVenueIdSetlistsApi~resource10VenueVenueIdSetlistsGetVenueSetlistsGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JsonSetlists}
     */
    resource10VenueVenueIdSetlistsGetVenueSetlistsGET(venueId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'venueId' is set
      if (venueId === undefined || venueId === null) {
        throw new Error("Missing the required parameter 'venueId' when calling resource10VenueVenueIdSetlistsGetVenueSetlistsGET");
      }
