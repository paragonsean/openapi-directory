...
/**
 * The XmlNs0Cities model module.
 * @module model/XmlNs0Cities
 * @version 1.0
 */
class XmlNs0Cities {
    /**
     * Constructs a new <code>XmlNs0Cities</code>.
     * A Result consisting of a list of cities.
     * @alias module:model/XmlNs0Cities
     * @implements module:model/XmlNs0Result
     */
    constructor() { 
        XmlNs0Result.initialize(this);
        XmlNs0Cities.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Cities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Cities} obj Optional instance to populate.
     * @return {module:model/XmlNs0Cities} The populated <code>XmlNs0Cities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Cities();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Cities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Cities</code>.
     */
 ...
 */
XmlNs0Cities.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Cities.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Cities.prototype['total'] = undefined;
