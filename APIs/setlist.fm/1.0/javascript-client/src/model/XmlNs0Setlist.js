...
import XmlNs0Artist from './XmlNs0Artist';
import XmlNs0Set from './XmlNs0Set';
import XmlNs0Tour from './XmlNs0Tour';
import XmlNs0Venue from './XmlNs0Venue';

/**
 * The XmlNs0Setlist model module.
 * @module model/XmlNs0Setlist
 * @version 1.0
 */
class XmlNs0Setlist {
    /**
     * Constructs a new <code>XmlNs0Setlist</code>.
     ...
     * @alias module:model/XmlNs0Setlist
     */
    constructor() { 
        
        XmlNs0Setlist.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Setlist</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Setlist} obj Optional instance to populate.
     * @return {module:model/XmlNs0Setlist} The populated <code>XmlNs0Setlist</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Setlist();

            if (data.hasOwnProperty('artist')) {
                obj['artist'] = XmlNs0Artist.constructFromObject(data['artist']);
            }
            ...
            if (data.hasOwnProperty('set')) {
                obj['set'] = XmlNs0Set.constructFromObject(data['set']);
            }
            if (data.hasOwnProperty('tour')) {
                obj['tour'] = XmlNs0Tour.constructFromObject(data['tour']);
            }
            if (data.hasOwnProperty('url')) {
                obj['url'] = ApiClient.convertToType(data['url'], 'String');
            }
            if (data.hasOwnProperty('venue')) {
                obj['venue'] = XmlNs0Venue.constructFromObject(data['venue']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Setlist</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Setlist</code>.
     */
    static validateJSON(data) {
        // validate the optional field `artist`
        if (data['artist']) { // data not null
          XmlNs0Artist.validateJSON(data['artist']);
        }
        ...
        if (data['set']) { // data not null
          XmlNs0Set.validateJSON(data['set']);
        }
        // validate the optional field `tour`
        if (data['tour']) { // data not null
          XmlNs0Tour.validateJSON(data['tour']);
        }
        // ensure the json data is a string
        ...
        if (data['venue']) { // data not null
          XmlNs0Venue.validateJSON(data['venue']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/XmlNs0Artist} artist
 */
XmlNs0Setlist.prototype['artist'] = undefined;

/**
 * date of the concert in the format &quot;dd-MM-yyyy&quot;
 * @member {String} eventDate
 */
XmlNs0Setlist.prototype['eventDate'] = undefined;

/**
 * unique identifier
 * @member {String} id
 */
XmlNs0Setlist.prototype['id'] = undefined;
 ...
 */
XmlNs0Setlist.prototype['lastUpdated'] = undefined;

/**
 * @member {module:model/XmlNs0Set} set
 */
XmlNs0Setlist.prototype['set'] = undefined;

/**
 * @member {module:model/XmlNs0Tour} tour
 */
XmlNs0Setlist.prototype['tour'] = undefined;

/**
 * the attribution url to which you have to link to wherever you use data from this setlist in your application
 * @member {String} url
 */
XmlNs0Setlist.prototype['url'] = undefined;

/**
 * @member {module:model/XmlNs0Venue} venue
 */
XmlNs0Setlist.prototype['venue'] = undefined;

/**
 * unique identifier of the version
 * @member {String} versionId
 */
XmlNs0Setlist.prototype['versionId'] = undefined;
