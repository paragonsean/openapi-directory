...
import JsonCoords from './JsonCoords';
import JsonCountry from './JsonCountry';

/**
 * The JsonCity model module.
 * @module model/JsonCity
 * @version 1.0
 */
class JsonCity {
    /**
     * Constructs a new <code>JsonCity</code>.
     ...
     * @alias module:model/JsonCity
     */
    constructor() { 
        
        JsonCity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCity} obj Optional instance to populate.
     * @return {module:model/JsonCity} The populated <code>JsonCity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCity();

            if (data.hasOwnProperty('coords')) {
                obj['coords'] = JsonCoords.constructFromObject(data['coords']);
            }
            if (data.hasOwnProperty('country')) {
                obj['country'] = JsonCountry.constructFromObject(data['country']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCity</code>.
     */
    static validateJSON(data) {
        // validate the optional field `coords`
        if (data['coords']) { // data not null
          JsonCoords.validateJSON(data['coords']);
        }
        // validate the optional field `country`
        if (data['country']) { // data not null
          JsonCountry.validateJSON(data['country']);
        }
...
/**
 * @member {module:model/JsonCoords} coords
 */
JsonCity.prototype['coords'] = undefined;

/**
 * @member {module:model/JsonCountry} country
 */
JsonCity.prototype['country'] = undefined;

/**
 * unique identifier
 * @member {String} id
 */
JsonCity.prototype['id'] = undefined;

/**
 * the city's name, depending on the language valid values are e.g. <em>&quot;M&uuml;chen&quot;</em> or <em>Munich</em>
 * @member {String} name
 */
JsonCity.prototype['name'] = undefined;

/**
 * The name of city's state, e.g. <em>&quot;Bavaria&quot;</em> or <em>&quot;Florida&quot;</em>
 * @member {String} state
 */
JsonCity.prototype['state'] = undefined;
 ...
 */
JsonCity.prototype['stateCode'] = undefined;
