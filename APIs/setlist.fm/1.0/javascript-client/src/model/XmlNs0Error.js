...
/**
 * The XmlNs0Error model module.
 * @module model/XmlNs0Error
 * @version 1.0
 */
class XmlNs0Error {
    /**
     * Constructs a new <code>XmlNs0Error</code>.
     * Returned in case of an error.
     * @alias module:model/XmlNs0Error
     */
    constructor() { 
        
        XmlNs0Error.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Error</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Error} obj Optional instance to populate.
     * @return {module:model/XmlNs0Error} The populated <code>XmlNs0Error</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Error();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Error</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Error</code>.
     */
 ...
 * @member {Number} code
 */
XmlNs0Error.prototype['code'] = undefined;

/**
 * an additional error message
 * @member {String} message
 */
XmlNs0Error.prototype['message'] = undefined;

/**
 * the HTTP status message
 * @member {String} status
 */
XmlNs0Error.prototype['status'] = undefined;

/**
 * current timestamp
 * @member {String} timestamp
 */
XmlNs0Error.prototype['timestamp'] = undefined;
