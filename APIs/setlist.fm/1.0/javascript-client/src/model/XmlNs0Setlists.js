...
/**
 * The XmlNs0Setlists model module.
 * @module model/XmlNs0Setlists
 * @version 1.0
 */
class XmlNs0Setlists {
    /**
     * Constructs a new <code>XmlNs0Setlists</code>.
     * A Result consisting of a list of setlists.
     * @alias module:model/XmlNs0Setlists
     * @implements module:model/XmlNs0Result
     */
    constructor() { 
        XmlNs0Result.initialize(this);
        XmlNs0Setlists.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Setlists</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Setlists} obj Optional instance to populate.
     * @return {module:model/XmlNs0Setlists} The populated <code>XmlNs0Setlists</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Setlists();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Setlists</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Setlists</code>.
     */
 ...
 */
XmlNs0Setlists.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Setlists.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Setlists.prototype['total'] = undefined;
