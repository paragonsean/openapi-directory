...
class JsonError {
    ...
    /**
     * Validates the JSON data with respect to <code>JsonError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonError</code>.
     */
 ...
 * @member {Number} code
 */
JsonError.prototype['code'] = undefined;

/**
 * an additional error message
 * @member {String} message
 */
JsonError.prototype['message'] = undefined;

/**
 * the HTTP status message
 * @member {String} status
 */
JsonError.prototype['status'] = undefined;

/**
 * current timestamp
 * @member {String} timestamp
 */
JsonError.prototype['timestamp'] = undefined;
