...
/**
 * The JsonSong model module.
 * @module model/JsonSong
 * @version 1.0
 */
class JsonSong {
    /**
     * Constructs a new <code>JsonSong</code>.
     * This class represents a song that is part of a Set.
     * @alias module:model/JsonSong
     */
    constructor() { 
        
        JsonSong.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonSong</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonSong} obj Optional instance to populate.
     * @return {module:model/JsonSong} The populated <code>JsonSong</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonSong();

            if (data.hasOwnProperty('cover')) {
                obj['cover'] = JsonArtist.constructFromObject(data['cover']);
            }
            ...
            if (data.hasOwnProperty('with')) {
                obj['with'] = JsonArtist.constructFromObject(data['with']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonSong</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonSong</code>.
     */
    static validateJSON(data) {
        // validate the optional field `cover`
        if (data['cover']) { // data not null
          JsonArtist.validateJSON(data['cover']);
        }
        ...
        if (data['with']) { // data not null
          JsonArtist.validateJSON(data['with']);
        }
...
/**
 * @member {module:model/JsonArtist} cover
 */
JsonSong.prototype['cover'] = undefined;
 ...
 * @member {Boolean} tape
 */
JsonSong.prototype['tape'] = undefined;

/**
 * @member {module:model/JsonArtist} with
 */
JsonSong.prototype['with'] = undefined;
