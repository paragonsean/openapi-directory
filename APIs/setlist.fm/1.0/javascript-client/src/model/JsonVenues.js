...
/**
 * The JsonVenues model module.
 * @module model/JsonVenues
 * @version 1.0
 */
class JsonVenues {
    /**
     * Constructs a new <code>JsonVenues</code>.
     * A Result consisting of a list of venues.
     * @alias module:model/JsonVenues
     */
    constructor() { 
        
        JsonVenues.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonVenues</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonVenues} obj Optional instance to populate.
     * @return {module:model/JsonVenues} The populated <code>JsonVenues</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonVenues();
            ...
            if (data.hasOwnProperty('venue')) {
                obj['venue'] = ApiClient.convertToType(data['venue'], [JsonVenue]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonVenues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonVenues</code>.
     */
    static validateJSON(data) {
        if (data['venue']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['venue'])) {
                throw new Error("Expected the field `venue` to be an array in the JSON data but got " + data['venue']);
            }
            // validate the optional field `venue` (array)
            for (const item of data['venue']) {
                JsonVenue.validateJSON(item);
            };
        }
 ...
 */
JsonVenues.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
JsonVenues.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
JsonVenues.prototype['total'] = undefined;

/**
 * result list of venues
 * @member {Array.<module:model/JsonVenue>} venue
 */
JsonVenues.prototype['venue'] = undefined;
