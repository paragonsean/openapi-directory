...
import XmlNs0Result from './XmlNs0Result';

/**
 * The XmlNs0Countries model module.
 * @module model/XmlNs0Countries
 * @version 1.0
 */
class XmlNs0Countries {
    /**
     * Constructs a new <code>XmlNs0Countries</code>.
     * A Result consisting of a list of countries.
     * @alias module:model/XmlNs0Countries
     * @implements module:model/XmlNs0Result
     */
    constructor() { 
        XmlNs0Result.initialize(this);
        XmlNs0Countries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Countries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Countries} obj Optional instance to populate.
     * @return {module:model/XmlNs0Countries} The populated <code>XmlNs0Countries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Countries();
            XmlNs0Result.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Countries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Countries</code>.
     */
 ...
 */
XmlNs0Countries.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Countries.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Countries.prototype['total'] = undefined;


// Implement XmlNs0Result interface:
/**
 * the amount of items you get per page
 * @member {Number} itemsPerPage
 */
XmlNs0Result.prototype['itemsPerPage'] = undefined;
/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Result.prototype['page'] = undefined;
/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Result.prototype['total'] = undefined;




export default XmlNs0Countries;
