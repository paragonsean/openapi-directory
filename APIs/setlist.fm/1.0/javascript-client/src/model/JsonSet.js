...
import JsonSong from './JsonSong';

/**
 * The JsonSet model module.
 * @module model/JsonSet
 * @version 1.0
 */
class JsonSet {
    /**
     * Constructs a new <code>JsonSet</code>.
     ...
     * @alias module:model/JsonSet
     */
    constructor() { 
        
        JsonSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonSet} obj Optional instance to populate.
     * @return {module:model/JsonSet} The populated <code>JsonSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('song')) {
                obj['song'] = ApiClient.convertToType(data['song'], [JsonSong]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonSet</code>.
     */
    static validateJSON(data) {
        ...
        if (data['song']) { // data not null
            ...
            if (!Array.isArray(data['song'])) {
                throw new Error("Expected the field `song` to be an array in the JSON data but got " + data['song']);
            }
            // validate the optional field `song` (array)
            for (const item of data['song']) {
                JsonSong.validateJSON(item);
            };
        }
 ...
 */
JsonSet.prototype['encore'] = undefined;

/**
 * the description/name of the set. E.g. <em>&quot;Acoustic set&quot;</em> or <em>&quot;Paul McCartney solo&quot;</em>
 * @member {String} name
 */
JsonSet.prototype['name'] = undefined;

/**
 * this set's songs
 * @member {Array.<module:model/JsonSong>} song
 */
JsonSet.prototype['song'] = undefined;
