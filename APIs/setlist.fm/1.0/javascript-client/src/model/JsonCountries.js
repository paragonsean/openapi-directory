...
import JsonCountry from './JsonCountry';

/**
 * The JsonCountries model module.
 * @module model/JsonCountries
 * @version 1.0
 */
class JsonCountries {
    /**
     * Constructs a new <code>JsonCountries</code>.
     * A Result consisting of a list of countries.
     * @alias module:model/JsonCountries
     */
    constructor() { 
        
        JsonCountries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCountries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCountries} obj Optional instance to populate.
     * @return {module:model/JsonCountries} The populated <code>JsonCountries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCountries();

            if (data.hasOwnProperty('country')) {
                obj['country'] = ApiClient.convertToType(data['country'], [JsonCountry]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCountries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCountries</code>.
     */
 ...
 * @member {Array.<module:model/JsonCountry>} country
 */
JsonCountries.prototype['country'] = undefined;

/**
 * the amount of items you get per page
 * @member {Number} itemsPerPage
 */
JsonCountries.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
JsonCountries.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
JsonCountries.prototype['total'] = undefined;
