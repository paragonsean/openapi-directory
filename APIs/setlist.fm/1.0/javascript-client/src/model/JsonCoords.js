...
/**
 * The JsonCoords model module.
 * @module model/JsonCoords
 * @version 1.0
 */
class JsonCoords {
    /**
     * Constructs a new <code>JsonCoords</code>.
     * Coordinates of a point on the globe. Mostly used for Cities.
     * @alias module:model/JsonCoords
     */
    constructor() { 
        
        JsonCoords.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCoords</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCoords} obj Optional instance to populate.
     * @return {module:model/JsonCoords} The populated <code>JsonCoords</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCoords();
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCoords</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCoords</code>.
     */
 ...
 * @member {Number} lat
 */
JsonCoords.prototype['lat'] = undefined;

/**
 * The longitude part of the coordinates.
 * @member {Number} long
 */
JsonCoords.prototype['long'] = undefined;
