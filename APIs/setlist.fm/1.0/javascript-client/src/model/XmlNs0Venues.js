...
/**
 * The XmlNs0Venues model module.
 * @module model/XmlNs0Venues
 * @version 1.0
 */
class XmlNs0Venues {
    /**
     * Constructs a new <code>XmlNs0Venues</code>.
     * A Result consisting of a list of venues.
     * @alias module:model/XmlNs0Venues
     * @implements module:model/XmlNs0Result
     */
    constructor() { 
        XmlNs0Result.initialize(this);
        XmlNs0Venues.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Venues</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Venues} obj Optional instance to populate.
     * @return {module:model/XmlNs0Venues} The populated <code>XmlNs0Venues</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Venues();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Venues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Venues</code>.
     */
 ...
 */
XmlNs0Venues.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Venues.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Venues.prototype['total'] = undefined;
