...
/**
 * The JsonArtist model module.
 * @module model/JsonArtist
 * @version 1.0
 */
class JsonArtist {
    /**
     * Constructs a new <code>JsonArtist</code>.
     ...
     * @alias module:model/JsonArtist
     */
    constructor() { 
        
        JsonArtist.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonArtist</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonArtist} obj Optional instance to populate.
     * @return {module:model/JsonArtist} The populated <code>JsonArtist</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonArtist();
    ...
    /**
     * Validates the JSON data with respect to <code>JsonArtist</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonArtist</code>.
     */
