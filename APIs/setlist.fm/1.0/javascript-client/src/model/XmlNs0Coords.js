...
/**
 * The XmlNs0Coords model module.
 * @module model/XmlNs0Coords
 * @version 1.0
 */
class XmlNs0Coords {
    /**
     * Constructs a new <code>XmlNs0Coords</code>.
     * Coordinates of a point on the globe. Mostly used for Cities.
     * @alias module:model/XmlNs0Coords
     */
    constructor() { 
        
        XmlNs0Coords.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Coords</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Coords} obj Optional instance to populate.
     * @return {module:model/XmlNs0Coords} The populated <code>XmlNs0Coords</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Coords();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Coords</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Coords</code>.
     */
 ...
 * @member {Number} lat
 */
XmlNs0Coords.prototype['lat'] = undefined;

/**
 * The longitude part of the coordinates.
 * @member {Number} long
 */
XmlNs0Coords.prototype['long'] = undefined;
