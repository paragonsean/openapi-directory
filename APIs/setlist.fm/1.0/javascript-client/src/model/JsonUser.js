...
/**
 * The JsonUser model module.
 * @module model/JsonUser
 * @version 1.0
 */
class JsonUser {
    /**
     * Constructs a new <code>JsonUser</code>.
     * This class represents a user.
     * @alias module:model/JsonUser
     */
    constructor() { 
        
        JsonUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonUser} obj Optional instance to populate.
     * @return {module:model/JsonUser} The populated <code>JsonUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonUser();
    ...
    /**
     * Validates the JSON data with respect to <code>JsonUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonUser</code>.
     */
 ...
 * @member {String} about
 */
JsonUser.prototype['about'] = undefined;

/**
 * never set (deprecated)
 * @member {String} flickr
 */
JsonUser.prototype['flickr'] = undefined;

/**
 * never set (deprecated)
 * @member {String} fullname
 */
JsonUser.prototype['fullname'] = undefined;

/**
 * never set (deprecated)
 * @member {String} lastFm
 */
JsonUser.prototype['lastFm'] = undefined;

/**
 * never set (deprecated)
 * @member {String} mySpace
 */
JsonUser.prototype['mySpace'] = undefined;

/**
 * never set (deprecated)
 * @member {String} twitter
 */
JsonUser.prototype['twitter'] = undefined;

/**
 * 
 * @member {String} url
 */
JsonUser.prototype['url'] = undefined;

/**
 * 
 * @member {String} userId
 */
JsonUser.prototype['userId'] = undefined;

/**
 * never set (deprecated)
 * @member {String} website
 */
JsonUser.prototype['website'] = undefined;
