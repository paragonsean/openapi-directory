...
/**
 * The JsonArtists model module.
 * @module model/JsonArtists
 * @version 1.0
 */
class JsonArtists {
    /**
     * Constructs a new <code>JsonArtists</code>.
     * A Result consisting of a list of artists.
     * @alias module:model/JsonArtists
     */
    constructor() { 
        
        JsonArtists.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonArtists</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonArtists} obj Optional instance to populate.
     * @return {module:model/JsonArtists} The populated <code>JsonArtists</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonArtists();

            if (data.hasOwnProperty('artist')) {
                obj['artist'] = ApiClient.convertToType(data['artist'], [JsonArtist]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonArtists</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonArtists</code>.
     */
    static validateJSON(data) {
        if (data['artist']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['artist'])) {
                throw new Error("Expected the field `artist` to be an array in the JSON data but got " + data['artist']);
            }
            // validate the optional field `artist` (array)
            for (const item of data['artist']) {
                JsonArtist.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/JsonArtist>} artist
 */
JsonArtists.prototype['artist'] = undefined;

/**
 * the amount of items you get per page
 * @member {Number} itemsPerPage
 */
JsonArtists.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
JsonArtists.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
JsonArtists.prototype['total'] = undefined;
