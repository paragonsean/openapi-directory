...
/**
 * The XmlNs0Result model module.
 * @module model/XmlNs0Result
 * @version 1.0
 */
class XmlNs0Result {
    /**
     * Constructs a new <code>XmlNs0Result</code>.
     ...
     * @alias module:model/XmlNs0Result
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>XmlNs0Result</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Result} obj Optional instance to populate.
     * @return {module:model/XmlNs0Result} The populated <code>XmlNs0Result</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Result();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Result</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Result</code>.
     */
