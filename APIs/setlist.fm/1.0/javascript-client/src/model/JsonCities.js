...
import JsonCity from './JsonCity';

/**
 * The JsonCities model module.
 * @module model/JsonCities
 * @version 1.0
 */
class JsonCities {
    /**
     * Constructs a new <code>JsonCities</code>.
     * A Result consisting of a list of cities.
     * @alias module:model/JsonCities
     */
    constructor() { 
        
        JsonCities.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCities} obj Optional instance to populate.
     * @return {module:model/JsonCities} The populated <code>JsonCities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCities();

            if (data.hasOwnProperty('cities')) {
                obj['cities'] = ApiClient.convertToType(data['cities'], [JsonCity]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCities</code>.
     */
 ...
 * @member {Array.<module:model/JsonCity>} cities
 */
JsonCities.prototype['cities'] = undefined;

/**
 * the amount of items you get per page
 * @member {Number} itemsPerPage
 */
JsonCities.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
JsonCities.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
JsonCities.prototype['total'] = undefined;
