...
/**
 * The XmlNs0Artists model module.
 * @module model/XmlNs0Artists
 * @version 1.0
 */
class XmlNs0Artists {
    /**
     * Constructs a new <code>XmlNs0Artists</code>.
     * A Result consisting of a list of artists.
     * @alias module:model/XmlNs0Artists
     * @implements module:model/XmlNs0Result
     */
    constructor() { 
        XmlNs0Result.initialize(this);
        XmlNs0Artists.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Artists</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Artists} obj Optional instance to populate.
     * @return {module:model/XmlNs0Artists} The populated <code>XmlNs0Artists</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Artists();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Artists</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Artists</code>.
     */
 ...
 */
XmlNs0Artists.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
XmlNs0Artists.prototype['page'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
XmlNs0Artists.prototype['total'] = undefined;
