...
/**
 * The JsonTour model module.
 * @module model/JsonTour
 * @version 1.0
 */
class JsonTour {
    /**
     * Constructs a new <code>JsonTour</code>.
     * The tour a setlist was a part of.
     * @alias module:model/JsonTour
     */
    constructor() { 
        
        JsonTour.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonTour</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonTour} obj Optional instance to populate.
     * @return {module:model/JsonTour} The populated <code>JsonTour</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonTour();
    ...
    /**
     * Validates the JSON data with respect to <code>JsonTour</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonTour</code>.
     */
 ...
 * @member {String} name
 */
JsonTour.prototype['name'] = undefined;
