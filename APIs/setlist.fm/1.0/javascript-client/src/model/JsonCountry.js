...
/**
 * The JsonCountry model module.
 * @module model/JsonCountry
 * @version 1.0
 */
class JsonCountry {
    /**
     * Constructs a new <code>JsonCountry</code>.
     * This class represents a country on earth.
     * @alias module:model/JsonCountry
     */
    constructor() { 
        
        JsonCountry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonCountry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonCountry} obj Optional instance to populate.
     * @return {module:model/JsonCountry} The populated <code>JsonCountry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonCountry();
    ...
    /**
     * Validates the JSON data with respect to <code>JsonCountry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonCountry</code>.
     */
 ...
 * @member {String} code
 */
JsonCountry.prototype['code'] = undefined;
 ...
 * @member {String} name
 */
JsonCountry.prototype['name'] = undefined;
