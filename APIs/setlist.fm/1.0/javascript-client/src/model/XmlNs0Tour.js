...
/**
 * The XmlNs0Tour model module.
 * @module model/XmlNs0Tour
 * @version 1.0
 */
class XmlNs0Tour {
    /**
     * Constructs a new <code>XmlNs0Tour</code>.
     * The tour a setlist was a part of.
     * @alias module:model/XmlNs0Tour
     */
    constructor() { 
        
        XmlNs0Tour.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Tour</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Tour} obj Optional instance to populate.
     * @return {module:model/XmlNs0Tour} The populated <code>XmlNs0Tour</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Tour();
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Tour</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Tour</code>.
     */
 ...
 * @member {String} name
 */
XmlNs0Tour.prototype['name'] = undefined;
