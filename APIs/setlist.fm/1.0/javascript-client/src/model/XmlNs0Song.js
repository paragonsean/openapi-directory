...
/**
 * The XmlNs0Song model module.
 * @module model/XmlNs0Song
 * @version 1.0
 */
class XmlNs0Song {
    /**
     * Constructs a new <code>XmlNs0Song</code>.
     * This class represents a song that is part of a Set.
     * @alias module:model/XmlNs0Song
     */
    constructor() { 
        
        XmlNs0Song.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XmlNs0Song</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0Song} obj Optional instance to populate.
     * @return {module:model/XmlNs0Song} The populated <code>XmlNs0Song</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0Song();

            if (data.hasOwnProperty('cover')) {
                obj['cover'] = XmlNs0Artist.constructFromObject(data['cover']);
            }
            ...
            if (data.hasOwnProperty('tape')) {
                obj['tape'] = ApiClient.convertToType(data['tape'], 'Boolean');
            }
            if (data.hasOwnProperty('with')) {
                obj['with'] = XmlNs0Artist.constructFromObject(data['with']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>XmlNs0Song</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XmlNs0Song</code>.
     */
    static validateJSON(data) {
        // validate the optional field `cover`
        if (data['cover']) { // data not null
          XmlNs0Artist.validateJSON(data['cover']);
        }
        ...
        if (data['with']) { // data not null
          XmlNs0Artist.validateJSON(data['with']);
        }
...
/**
 * @member {module:model/XmlNs0Artist} cover
 */
XmlNs0Song.prototype['cover'] = undefined;
 ...
 * @member {String} info
 */
XmlNs0Song.prototype['info'] = undefined;

/**
 * The name of the song. E.g. <em>Yesterday</em> or <em>&quot;Wish You Were Here&quot;</em>
 * @member {String} name
 */
XmlNs0Song.prototype['name'] = undefined;
 ...
 * @member {Boolean} tape
 */
XmlNs0Song.prototype['tape'] = undefined;

/**
 * @member {module:model/XmlNs0Artist} with
 */
XmlNs0Song.prototype['with'] = undefined;
