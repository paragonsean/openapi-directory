...
import JsonSetlist from './JsonSetlist';

/**
 * The JsonSetlists model module.
 * @module model/JsonSetlists
 * @version 1.0
 */
class JsonSetlists {
    /**
     * Constructs a new <code>JsonSetlists</code>.
     * A Result consisting of a list of setlists.
     * @alias module:model/JsonSetlists
     */
    constructor() { 
        
        JsonSetlists.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonSetlists</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonSetlists} obj Optional instance to populate.
     * @return {module:model/JsonSetlists} The populated <code>JsonSetlists</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonSetlists();
            ...
            if (data.hasOwnProperty('setlist')) {
                obj['setlist'] = ApiClient.convertToType(data['setlist'], [JsonSetlist]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonSetlists</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonSetlists</code>.
     */
    static validateJSON(data) {
        if (data['setlist']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['setlist'])) {
                throw new Error("Expected the field `setlist` to be an array in the JSON data but got " + data['setlist']);
            }
            // validate the optional field `setlist` (array)
            for (const item of data['setlist']) {
                JsonSetlist.validateJSON(item);
            };
        }
 ...
 */
JsonSetlists.prototype['itemsPerPage'] = undefined;

/**
 * the current page. starts at 1
 * @member {Number} page
 */
JsonSetlists.prototype['page'] = undefined;

/**
 * result list of setlists
 * @member {Array.<module:model/JsonSetlist>} setlist
 */
JsonSetlists.prototype['setlist'] = undefined;

/**
 * the total amount of items matching the query
 * @member {Number} total
 */
JsonSetlists.prototype['total'] = undefined;
