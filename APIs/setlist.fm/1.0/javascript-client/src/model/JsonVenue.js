...
/**
 * The JsonVenue model module.
 * @module model/JsonVenue
 * @version 1.0
 */
class JsonVenue {
    /**
     * Constructs a new <code>JsonVenue</code>.
     ...
     * @alias module:model/JsonVenue
     */
    constructor() { 
        
        JsonVenue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JsonVenue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JsonVenue} obj Optional instance to populate.
     * @return {module:model/JsonVenue} The populated <code>JsonVenue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JsonVenue();

            if (data.hasOwnProperty('city')) {
                obj['city'] = JsonCity.constructFromObject(data['city']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>JsonVenue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JsonVenue</code>.
     */
    static validateJSON(data) {
        // validate the optional field `city`
        if (data['city']) { // data not null
          JsonCity.validateJSON(data['city']);
        }
...
/**
 * @member {module:model/JsonCity} city
 */
JsonVenue.prototype['city'] = undefined;

/**
 * unique identifier
 * @member {String} id
 */
JsonVenue.prototype['id'] = undefined;

/**
 * the name of the venue, usually without city and country. E.g. <em>&quot;Madison Square Garden&quot;</em> or <em>&quot;Royal Albert Hall&quot;</em>
 * @member {String} name
 */
JsonVenue.prototype['name'] = undefined;

/**
 * the attribution url
 * @member {String} url
 */
JsonVenue.prototype['url'] = undefined;
