...
<a id="searchUsers"></a>
# **searchUsers**
> List&lt;User&gt; searchUsers(direction, page, perPage, query, sort)
...
import org.openapitools.client.api.UsersInternalApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersInternalApi apiInstance = new UsersInternalApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling UsersInternalApi#searchUsers");
...
| **sort** | **String**| The way to sort the results. | [optional] [enum: alphabetical, date, followers, relevant, videos] |
