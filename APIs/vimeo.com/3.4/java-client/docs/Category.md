...
|**subcategories** | [**List&lt;CategorySubcategoriesInner&gt;**](CategorySubcategoriesInner.md) | All the subcategories that belong to this category, if the current category is a top-level parent. |  [optional] |
