...
|**duration** | **BigDecimal** | The duration of the video version in seconds. |  |
|**filename** | **String** | The file name of the video version. |  |
|**filesize** | **BigDecimal** | The size in byes of the video version file. |  |
...
|**play** | [**Play**](Play.md) | The Play representation. |  |
