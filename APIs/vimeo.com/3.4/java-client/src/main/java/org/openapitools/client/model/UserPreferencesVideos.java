...
public class UserPreferencesVideos {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.privacy, userPreferencesVideos.privacy);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPreferencesVideos
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPreferencesVideos.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPreferencesVideos.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPreferencesVideos` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `privacy`
      if (jsonObj.get("privacy") != null && !jsonObj.get("privacy").isJsonNull()) {
        UserPreferencesVideosPrivacy.validateJsonElement(jsonObj.get("privacy"));
      }
  }
