...
public class ApiApp {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, apiApp.name) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiApp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiApp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiApp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiApp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
