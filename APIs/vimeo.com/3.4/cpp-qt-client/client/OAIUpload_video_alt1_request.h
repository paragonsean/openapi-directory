...
/*
 * OAIUpload_video_alt1_request.h
 *
 * 
 */

#ifndef OAIUpload_video_alt1_request_H
#define OAIUpload_video_alt1_request_H
...
class OAIUpload_video_alt1_request_privacy;
...
class OAIUpload_video_alt1_request_upload;

class OAIUpload_video_alt1_request : public OAIObject {
public:
    OAIUpload_video_alt1_request();
    OAIUpload_video_alt1_request(QString json);
    ~OAIUpload_video_alt1_request() override;
    ...
    OAIUpload_video_alt1_request_privacy getPrivacy() const;
    void setPrivacy(const OAIUpload_video_alt1_request_privacy &privacy);
    ...
    OAIUpload_video_alt1_request_upload getUpload() const;
    void setUpload(const OAIUpload_video_alt1_request_upload &upload);
...
private:
    ...
    OAIUpload_video_alt1_request_privacy m_privacy;
    ...
    OAIUpload_video_alt1_request_upload m_upload;
    bool m_upload_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpload_video_alt1_request)

#endif // OAIUpload_video_alt1_request_H
