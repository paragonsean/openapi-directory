...
#ifndef OAIAuth_error_H
#define OAIAuth_error_H
...
class OAIAuth_error : public OAIObject {
public:
    OAIAuth_error();
    OAIAuth_error(QString json);
    ~OAIAuth_error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuth_error)

#endif // OAIAuth_error_H
