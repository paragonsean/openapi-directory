...
/*
 * OAIVideo_metadata_connections_trailer.h
 *
 * Information about this video&#39;s VOD trailer.
 */

#ifndef OAIVideo_metadata_connections_trailer_H
#define OAIVideo_metadata_connections_trailer_H
...
class OAIVideo_metadata_connections_trailer : public OAIObject {
public:
    OAIVideo_metadata_connections_trailer();
    OAIVideo_metadata_connections_trailer(QString json);
    ~OAIVideo_metadata_connections_trailer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideo_metadata_connections_trailer)

#endif // OAIVideo_metadata_connections_trailer_H
