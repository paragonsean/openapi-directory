...
/*
 * OAIAdd_video_to_vod_request_rent_price.h
 *
 * 
 */

#ifndef OAIAdd_video_to_vod_request_rent_price_H
#define OAIAdd_video_to_vod_request_rent_price_H
...
class OAIAdd_video_to_vod_request_rent_price : public OAIObject {
public:
    OAIAdd_video_to_vod_request_rent_price();
    OAIAdd_video_to_vod_request_rent_price(QString json);
    ~OAIAdd_video_to_vod_request_rent_price() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdd_video_to_vod_request_rent_price)

#endif // OAIAdd_video_to_vod_request_rent_price_H
