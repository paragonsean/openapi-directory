...
/*
 * OAIAdd_video_to_vod_request_buy_price.h
 *
 * 
 */

#ifndef OAIAdd_video_to_vod_request_buy_price_H
#define OAIAdd_video_to_vod_request_buy_price_H
...
class OAIAdd_video_to_vod_request_buy_price : public OAIObject {
public:
    OAIAdd_video_to_vod_request_buy_price();
    OAIAdd_video_to_vod_request_buy_price(QString json);
    ~OAIAdd_video_to_vod_request_buy_price() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdd_video_to_vod_request_buy_price)

#endif // OAIAdd_video_to_vod_request_buy_price_H
