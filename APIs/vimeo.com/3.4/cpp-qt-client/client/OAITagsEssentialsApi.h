...
#ifndef OAI_OAITagsEssentialsApi_H
#define OAI_OAITagsEssentialsApi_H
...
class OAITagsEssentialsApi : public QObject {
    Q_OBJECT

public:
    OAITagsEssentialsApi(const int timeOut = 0);
    ~OAITagsEssentialsApi();
    ...
    */
    virtual void getTag(const QString &word);
