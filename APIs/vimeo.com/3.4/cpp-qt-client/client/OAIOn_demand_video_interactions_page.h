...
/*
 * OAIOn_demand_video_interactions_page.h
 *
 * Information about how the authenticated user can interact with the connection to the video&#39;s On Demand page.
 */

#ifndef OAIOn_demand_video_interactions_page_H
#define OAIOn_demand_video_interactions_page_H
...
class OAIOn_demand_video_interactions_page : public OAIObject {
public:
    OAIOn_demand_video_interactions_page();
    OAIOn_demand_video_interactions_page(QString json);
    ~OAIOn_demand_video_interactions_page() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOn_demand_video_interactions_page)

#endif // OAIOn_demand_video_interactions_page_H
