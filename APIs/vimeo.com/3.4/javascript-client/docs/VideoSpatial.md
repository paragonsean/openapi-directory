...
------------ | ------------- | ------------- | -------------
**directorTimeline** | [**[VideoSpatialDirectorTimelineInner]**](VideoSpatialDirectorTimelineInner.md) | 360 director timeline. | 
**fieldOfView** | **Number** | The 360 field of view, from 30 (minimum) to 90 (maximum). The default is 50. | 
...
* `cubical` (value: `"cubical"`)

* `cylindrical` (value: `"cylindrical"`)

* `dome` (value: `"dome"`)

* `equirectangular` (value: `"equirectangular"`)
