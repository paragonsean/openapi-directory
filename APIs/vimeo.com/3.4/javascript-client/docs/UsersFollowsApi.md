...
let apiInstance = new Vimeo.UsersFollowsApi();
let followUserId = 3766357; // Number | The ID of the following user.
let userId = 152184; // Number | The ID of the user.
apiInstance.checkIfUserIsFollowing(followUserId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **followUserId** | **Number**| The ID of the following user. | 
...
let apiInstance = new Vimeo.UsersFollowsApi();
let followUserId = 3766357; // Number | The ID of the following user.
apiInstance.checkIfUserIsFollowingAlt1(followUserId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let followUserId = 3766357; // Number | The ID of the following user.
let userId = 152184; // Number | The ID of the user.
apiInstance.followUser(followUserId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new Vimeo.UsersFollowsApi();
let followUserId = 3766357; // Number | The ID of the following user.
apiInstance.followUserAlt1(followUserId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new Vimeo.UsersFollowsApi();
let userId = 152184; // Number | The ID of the user.
let followUsersAlt1Request = new Vimeo.FollowUsersAlt1Request(); // FollowUsersAlt1Request | 
apiInstance.followUsers(userId, followUsersAlt1Request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new Vimeo.UsersFollowsApi();
let followUsersAlt1Request = new Vimeo.FollowUsersAlt1Request(); // FollowUsersAlt1Request | 
apiInstance.followUsersAlt1(followUsersAlt1Request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.getFollowers(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.getFollowersAlt1(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [User] getUserFollowing(userId, opts)
...
apiInstance.getUserFollowing(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [User] getUserFollowingAlt1(opts)
...
apiInstance.getUserFollowingAlt1(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let followUserId = 3766357; // Number | The ID of the following user.
let userId = 152184; // Number | The ID of the user.
apiInstance.unfollowUser(followUserId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new Vimeo.UsersFollowsApi();
let followUserId = 3766357; // Number | The ID of the following user.
apiInstance.unfollowUserAlt1(followUserId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
