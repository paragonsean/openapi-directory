...
let apiInstance = new Vimeo.PortfoliosEssentialsApi();
let portfolioId = 12345; // Number | The ID of the portfolio.
let userId = 152184; // Number | The ID of the user.
apiInstance.getPortfolio(portfolioId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new Vimeo.PortfoliosEssentialsApi();
let portfolioId = 12345; // Number | The ID of the portfolio.
apiInstance.getPortfolioAlt1(portfolioId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Portfolio] getPortfolios(userId, opts)
...
apiInstance.getPortfolios(userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Portfolio] getPortfoliosAlt1(opts)
...
apiInstance.getPortfoliosAlt1(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
