...
/**
 * The VideoUpload model module.
 * @module model/VideoUpload
 * @version 3.4
 */
class VideoUpload {
    /**
     * Constructs a new <code>VideoUpload</code>.
     * The upload information for this video.
     * @alias module:model/VideoUpload
     * @param status {module:model/VideoUpload.StatusEnum} The status code for the availability of the uploaded video:  Option descriptions:  * `complete` - The upload is complete.  * `error` - The upload ended with an error.  * `in_progress` - The upload is underway. 
     */
    constructor(status) { 
        
        VideoUpload.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>VideoUpload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoUpload} obj Optional instance to populate.
     * @return {module:model/VideoUpload} The populated <code>VideoUpload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoUpload();
    ...
    /**
     * Validates the JSON data with respect to <code>VideoUpload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoUpload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VideoUpload.RequiredProperties) {
...
VideoUpload.RequiredProperties = ["status"];

/**
 * The approach for uploading the video.
 * @member {module:model/VideoUpload.ApproachEnum} approach
 */
VideoUpload.prototype['approach'] = undefined;

/**
 * The URI for completing the upload.
 * @member {String} complete_uri
 */
VideoUpload.prototype['complete_uri'] = undefined;

/**
 * The HTML form for uploading a video through the post approach.
 * @member {String} form
 */
VideoUpload.prototype['form'] = undefined;

/**
 * The link of the video to capture through the pull approach.
 * @member {String} link
 */
VideoUpload.prototype['link'] = undefined;

/**
 * The redirect URL for the upload app.
 * @member {String} redirect_url
 */
VideoUpload.prototype['redirect_url'] = undefined;

/**
 * The file size in bytes of the uploaded video.
 * @member {Number} size
 */
VideoUpload.prototype['size'] = undefined;
 ...
 * @member {module:model/VideoUpload.StatusEnum} status
 */
VideoUpload.prototype['status'] = undefined;

/**
 * The link for sending video file data.
 * @member {String} upload_link
 */
VideoUpload.prototype['upload_link'] = undefined;
