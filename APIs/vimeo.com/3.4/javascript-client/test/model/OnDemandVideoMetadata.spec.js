...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.OnDemandVideoMetadata();
  });
  ...
  describe('OnDemandVideoMetadata', function() {
    it('should create an instance of OnDemandVideoMetadata', function() {
      // uncomment below and update the code to test OnDemandVideoMetadata
      //var instance = new Vimeo.OnDemandVideoMetadata();
      //expect(instance).to.be.a(Vimeo.OnDemandVideoMetadata);
    });
