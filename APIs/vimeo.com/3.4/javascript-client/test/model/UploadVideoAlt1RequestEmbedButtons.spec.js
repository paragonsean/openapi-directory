...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UploadVideoAlt1RequestEmbedButtons();
  });
  ...
  describe('UploadVideoAlt1RequestEmbedButtons', function() {
    it('should create an instance of UploadVideoAlt1RequestEmbedButtons', function() {
      // uncomment below and update the code to test UploadVideoAlt1RequestEmbedButtons
      //var instance = new Vimeo.UploadVideoAlt1RequestEmbedButtons();
      //expect(instance).to.be.a(Vimeo.UploadVideoAlt1RequestEmbedButtons);
    });
