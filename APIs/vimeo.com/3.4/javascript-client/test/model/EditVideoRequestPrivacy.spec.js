...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.EditVideoRequestPrivacy();
  });
  ...
  describe('EditVideoRequestPrivacy', function() {
    it('should create an instance of EditVideoRequestPrivacy', function() {
      // uncomment below and update the code to test EditVideoRequestPrivacy
      //var instance = new Vimeo.EditVideoRequestPrivacy();
      //expect(instance).to.be.a(Vimeo.EditVideoRequestPrivacy);
    });
