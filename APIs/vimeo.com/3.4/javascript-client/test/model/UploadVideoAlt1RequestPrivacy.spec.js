...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UploadVideoAlt1RequestPrivacy();
  });
  ...
  describe('UploadVideoAlt1RequestPrivacy', function() {
    it('should create an instance of UploadVideoAlt1RequestPrivacy', function() {
      // uncomment below and update the code to test UploadVideoAlt1RequestPrivacy
      //var instance = new Vimeo.UploadVideoAlt1RequestPrivacy();
      //expect(instance).to.be.a(Vimeo.UploadVideoAlt1RequestPrivacy);
    });
