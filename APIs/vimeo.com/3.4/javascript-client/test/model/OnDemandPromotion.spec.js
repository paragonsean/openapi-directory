...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.OnDemandPromotion();
  });
  ...
  describe('OnDemandPromotion', function() {
    it('should create an instance of OnDemandPromotion', function() {
      // uncomment below and update the code to test OnDemandPromotion
      //var instance = new Vimeo.OnDemandPromotion();
      //expect(instance).to.be.a(Vimeo.OnDemandPromotion);
    });
