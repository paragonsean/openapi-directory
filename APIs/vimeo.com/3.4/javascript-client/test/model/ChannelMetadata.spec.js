...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.ChannelMetadata();
  });
  ...
  describe('ChannelMetadata', function() {
    it('should create an instance of ChannelMetadata', function() {
      // uncomment below and update the code to test ChannelMetadata
      //var instance = new Vimeo.ChannelMetadata();
      //expect(instance).to.be.a(Vimeo.ChannelMetadata);
    });
