...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.OnDemandRegion();
  });
  ...
  describe('OnDemandRegion', function() {
    it('should create an instance of OnDemandRegion', function() {
      // uncomment below and update the code to test OnDemandRegion
      //var instance = new Vimeo.OnDemandRegion();
      //expect(instance).to.be.a(Vimeo.OnDemandRegion);
    });
