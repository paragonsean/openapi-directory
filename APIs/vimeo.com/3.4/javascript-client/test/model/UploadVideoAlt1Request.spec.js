...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UploadVideoAlt1Request();
  });
  ...
  describe('UploadVideoAlt1Request', function() {
    it('should create an instance of UploadVideoAlt1Request', function() {
      // uncomment below and update the code to test UploadVideoAlt1Request
      //var instance = new Vimeo.UploadVideoAlt1Request();
      //expect(instance).to.be.a(Vimeo.UploadVideoAlt1Request);
    });
