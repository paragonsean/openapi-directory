...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.OnDemandPageMetadata();
  });
  ...
  describe('OnDemandPageMetadata', function() {
    it('should create an instance of OnDemandPageMetadata', function() {
      // uncomment below and update the code to test OnDemandPageMetadata
      //var instance = new Vimeo.OnDemandPageMetadata();
      //expect(instance).to.be.a(Vimeo.OnDemandPageMetadata);
    });
