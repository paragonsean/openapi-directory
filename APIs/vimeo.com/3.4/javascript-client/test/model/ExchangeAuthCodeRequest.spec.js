...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.ExchangeAuthCodeRequest();
  });
  ...
  describe('ExchangeAuthCodeRequest', function() {
    it('should create an instance of ExchangeAuthCodeRequest', function() {
      // uncomment below and update the code to test ExchangeAuthCodeRequest
      //var instance = new Vimeo.ExchangeAuthCodeRequest();
      //expect(instance).to.be.a(Vimeo.ExchangeAuthCodeRequest);
    });
