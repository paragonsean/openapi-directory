...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UserUploadQuotaPeriodic();
  });
  ...
  describe('UserUploadQuotaPeriodic', function() {
    it('should create an instance of UserUploadQuotaPeriodic', function() {
      // uncomment below and update the code to test UserUploadQuotaPeriodic
      //var instance = new Vimeo.UserUploadQuotaPeriodic();
      //expect(instance).to.be.a(Vimeo.UserUploadQuotaPeriodic);
    });
