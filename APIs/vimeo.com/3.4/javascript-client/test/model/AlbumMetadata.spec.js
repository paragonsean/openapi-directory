...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.AlbumMetadata();
  });
  ...
  describe('AlbumMetadata', function() {
    it('should create an instance of AlbumMetadata', function() {
      // uncomment below and update the code to test AlbumMetadata
      //var instance = new Vimeo.AlbumMetadata();
      //expect(instance).to.be.a(Vimeo.AlbumMetadata);
    });
