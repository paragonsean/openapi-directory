...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.VideoPrivacy();
  });
  ...
  describe('VideoPrivacy', function() {
    it('should create an instance of VideoPrivacy', function() {
      // uncomment below and update the code to test VideoPrivacy
      //var instance = new Vimeo.VideoPrivacy();
      //expect(instance).to.be.a(Vimeo.VideoPrivacy);
    });
