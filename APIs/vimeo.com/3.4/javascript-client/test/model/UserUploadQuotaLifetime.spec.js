...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UserUploadQuotaLifetime();
  });
  ...
  describe('UserUploadQuotaLifetime', function() {
    it('should create an instance of UserUploadQuotaLifetime', function() {
      // uncomment below and update the code to test UserUploadQuotaLifetime
      //var instance = new Vimeo.UserUploadQuotaLifetime();
      //expect(instance).to.be.a(Vimeo.UserUploadQuotaLifetime);
    });
