...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.CategoryMetadata();
  });
  ...
  describe('CategoryMetadata', function() {
    it('should create an instance of CategoryMetadata', function() {
      // uncomment below and update the code to test CategoryMetadata
      //var instance = new Vimeo.CategoryMetadata();
      //expect(instance).to.be.a(Vimeo.CategoryMetadata);
    });
