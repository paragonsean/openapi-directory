...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.UserPreferencesVideosPrivacy();
  });
  ...
  describe('UserPreferencesVideosPrivacy', function() {
    it('should create an instance of UserPreferencesVideosPrivacy', function() {
      // uncomment below and update the code to test UserPreferencesVideosPrivacy
      //var instance = new Vimeo.UserPreferencesVideosPrivacy();
      //expect(instance).to.be.a(Vimeo.UserPreferencesVideosPrivacy);
    });
