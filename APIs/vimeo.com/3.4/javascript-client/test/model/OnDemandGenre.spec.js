...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.OnDemandGenre();
  });
  ...
  describe('OnDemandGenre', function() {
    it('should create an instance of OnDemandGenre', function() {
      // uncomment below and update the code to test OnDemandGenre
      //var instance = new Vimeo.OnDemandGenre();
      //expect(instance).to.be.a(Vimeo.OnDemandGenre);
    });
