...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.PresetsSettingsButtons();
  });
  ...
  describe('PresetsSettingsButtons', function() {
    it('should create an instance of PresetsSettingsButtons', function() {
      // uncomment below and update the code to test PresetsSettingsButtons
      //var instance = new Vimeo.PresetsSettingsButtons();
      //expect(instance).to.be.a(Vimeo.PresetsSettingsButtons);
    });
