...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Vimeo.EditUserAlt1RequestVideosPrivacy();
  });
  ...
  describe('EditUserAlt1RequestVideosPrivacy', function() {
    it('should create an instance of EditUserAlt1RequestVideosPrivacy', function() {
      // uncomment below and update the code to test EditUserAlt1RequestVideosPrivacy
      //var instance = new Vimeo.EditUserAlt1RequestVideosPrivacy();
      //expect(instance).to.be.a(Vimeo.EditUserAlt1RequestVideosPrivacy);
    });
