...
public class Programme {
  ...
  public Programme images(List<Image> images) {
    this.images = images;
    return this;
  }
  ...
  public Programme latestAvailableEpisodes(List<EpisodeSummary> latestAvailableEpisodes) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("latest_available_episodes") != null && !jsonObj.get("latest_available_episodes").isJsonNull()) {
        JsonArray jsonArraylatestAvailableEpisodes = jsonObj.getAsJsonArray("latest_available_episodes");
        if (jsonArraylatestAvailableEpisodes != null) {
          // ensure the json data is an array
