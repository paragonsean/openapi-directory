...
import org.openapitools.client.model.PersonalisedRadioActivity;
...
public class PersonalisedRadioResponse {
  ...
  private List<PersonalisedRadioActivity> results = new ArrayList<>();
  ...
  public PersonalisedRadioResponse results(List<PersonalisedRadioActivity> results) {
   ...
   */
  @javax.annotation.Nonnull
  public List<PersonalisedRadioActivity> getResults() {
    return results;
  }

  public void setResults(List<PersonalisedRadioActivity> results) {
    this.results = results;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonalisedRadioResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonalisedRadioResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonalisedRadioResponse is not found in the empty JSON string", PersonalisedRadioResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalisedRadioResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalisedRadioResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PersonalisedRadioResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        PersonalisedRadioActivity.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonalisedRadioResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonalisedRadioResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonalisedRadioResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonalisedRadioResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonalisedRadioResponse>() {
           @Override
           public void write(JsonWriter out, PersonalisedRadioResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonalisedRadioResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PersonalisedRadioResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonalisedRadioResponse
   * @throws IOException if the JSON string is invalid with respect to PersonalisedRadioResponse
   */
  public static PersonalisedRadioResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonalisedRadioResponse.class);
  }

  /**
   * Convert an instance of PersonalisedRadioResponse to an JSON string
   *
   * @return JSON string
   */
