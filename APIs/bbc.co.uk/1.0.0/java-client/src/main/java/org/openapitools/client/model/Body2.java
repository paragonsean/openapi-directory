...
public class Body2 {
  ...
  public Body2 platform(PlatformEnum platform) {
  ...
  public Body2 serviceId(String serviceId) {
  ...
  public boolean equals(Object o) {
    ...
    Body2 body2 = (Body2) o;
    return Objects.equals(this.platform, body2.platform) &&
        Objects.equals(this.serviceId, body2.serviceId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Body2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Body2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Body2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Body2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
