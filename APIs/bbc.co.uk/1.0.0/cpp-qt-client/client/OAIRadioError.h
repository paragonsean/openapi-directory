...
#ifndef OAIRadioError_H
#define OAIRadioError_H
...
class OAIRadioError : public OAIObject {
public:
    OAIRadioError();
    OAIRadioError(QString json);
    ~OAIRadioError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRadioError)

#endif // OAIRadioError_H
