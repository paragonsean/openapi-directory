...
#ifndef OAIClipSummary_H
#define OAIClipSummary_H
...
class OAIClipSummary : public OAIObject {
public:
    OAIClipSummary();
    OAIClipSummary(QString json);
    ~OAIClipSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClipSummary)

#endif // OAIClipSummary_H
