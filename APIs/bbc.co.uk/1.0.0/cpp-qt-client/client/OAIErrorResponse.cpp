...
QString OAIErrorResponse::getSchema() const {
    return m_schema;
}
void OAIErrorResponse::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAIErrorResponse::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAIErrorResponse::is_schema_Valid() const{
