...
void OAICategoriesApi::categoriesGet(const QString &x_api_key, const ::OpenAPI::OptionalParam<QString> &kind) {
...
void OAICategoriesApi::categoriesIdGet(const QString &x_api_key, const QString &id) {
