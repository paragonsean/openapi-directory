...
/*
 * OAIPodcastEpisodeSummary.h
 *
 * 
 */

#ifndef OAIPodcastEpisodeSummary_H
#define OAIPodcastEpisodeSummary_H
...
class OAIPodcastEpisodeSummary : public OAIObject {
public:
    OAIPodcastEpisodeSummary();
    OAIPodcastEpisodeSummary(QString json);
    ~OAIPodcastEpisodeSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPodcastEpisodeSummary)

#endif // OAIPodcastEpisodeSummary_H
