...
QString OAIDateRange::getEnd() const {
    return m_end;
}
void OAIDateRange::setEnd(const QString &end) {
    m_end = end;
    m_end_isSet = true;
}
...
QString OAIDateRange::getStart() const {
    return m_start;
}
void OAIDateRange::setStart(const QString &start) {
    m_start = start;
    m_start_isSet = true;
}
