...
OAISeriesSummary::OAISeriesSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeriesSummary::OAISeriesSummary() {
    this->initializeModel();
}

OAISeriesSummary::~OAISeriesSummary() {}

void OAISeriesSummary::initializeModel() {
...
void OAISeriesSummary::fromJson(QString jsonString) {
...
void OAISeriesSummary::fromJsonObject(QJsonObject json) {
...
QString OAISeriesSummary::asJson() const {
...
QJsonObject OAISeriesSummary::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAncestorSummary> OAISeriesSummary::getAncestors() const {
    return m_ancestors;
}
void OAISeriesSummary::setAncestors(const QList<OAIAncestorSummary> &ancestors) {
    m_ancestors = ancestors;
    m_ancestors_isSet = true;
}

bool OAISeriesSummary::is_ancestors_Set() const{
    return m_ancestors_isSet;
}

bool OAISeriesSummary::is_ancestors_Valid() const{
    return m_ancestors_isValid;
}

QList<OAIImage> OAISeriesSummary::getImages() const {
    return m_images;
}
void OAISeriesSummary::setImages(const QList<OAIImage> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAISeriesSummary::is_images_Set() const{
    return m_images_isSet;
}

bool OAISeriesSummary::is_images_Valid() const{
    return m_images_isValid;
}

QList<OAIEpisodeSummary> OAISeriesSummary::getLatestAvailableEpisodes() const {
    return m_latest_available_episodes;
}
void OAISeriesSummary::setLatestAvailableEpisodes(const QList<OAIEpisodeSummary> &latest_available_episodes) {
    m_latest_available_episodes = latest_available_episodes;
    m_latest_available_episodes_isSet = true;
}

bool OAISeriesSummary::is_latest_available_episodes_Set() const{
    return m_latest_available_episodes_isSet;
}

bool OAISeriesSummary::is_latest_available_episodes_Valid() const{
    return m_latest_available_episodes_isValid;
}

OAINetworkSummary OAISeriesSummary::getNetworkSummary() const {
    return m_network_summary;
}
void OAISeriesSummary::setNetworkSummary(const OAINetworkSummary &network_summary) {
    m_network_summary = network_summary;
    m_network_summary_isSet = true;
}

bool OAISeriesSummary::is_network_summary_Set() const{
    return m_network_summary_isSet;
}

bool OAISeriesSummary::is_network_summary_Valid() const{
    return m_network_summary_isValid;
}

QString OAISeriesSummary::getPid() const {
    return m_pid;
}
void OAISeriesSummary::setPid(const QString &pid) {
    m_pid = pid;
    m_pid_isSet = true;
}

bool OAISeriesSummary::is_pid_Set() const{
    return m_pid_isSet;
}

bool OAISeriesSummary::is_pid_Valid() const{
    return m_pid_isValid;
}

QString OAISeriesSummary::getShortSynopsis() const {
    return m_short_synopsis;
}
void OAISeriesSummary::setShortSynopsis(const QString &short_synopsis) {
    m_short_synopsis = short_synopsis;
    m_short_synopsis_isSet = true;
}

bool OAISeriesSummary::is_short_synopsis_Set() const{
    return m_short_synopsis_isSet;
}

bool OAISeriesSummary::is_short_synopsis_Valid() const{
    return m_short_synopsis_isValid;
}

OAIProgrammeTitles OAISeriesSummary::getTitles() const {
    return m_titles;
}
void OAISeriesSummary::setTitles(const OAIProgrammeTitles &titles) {
    m_titles = titles;
    m_titles_isSet = true;
}

bool OAISeriesSummary::is_titles_Set() const{
    return m_titles_isSet;
}

bool OAISeriesSummary::is_titles_Valid() const{
    return m_titles_isValid;
}

qint32 OAISeriesSummary::getTotalAvailableEpisodes() const {
    return m_total_available_episodes;
}
void OAISeriesSummary::setTotalAvailableEpisodes(const qint32 &total_available_episodes) {
    m_total_available_episodes = total_available_episodes;
    m_total_available_episodes_isSet = true;
}

bool OAISeriesSummary::is_total_available_episodes_Set() const{
    return m_total_available_episodes_isSet;
}

bool OAISeriesSummary::is_total_available_episodes_Valid() const{
    return m_total_available_episodes_isValid;
}

QString OAISeriesSummary::getType() const {
    return m_type;
}
void OAISeriesSummary::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISeriesSummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAISeriesSummary::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISeriesSummary::isSet() const {
...
bool OAISeriesSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ancestors_isValid && m_images_isValid && m_latest_available_episodes_isValid && m_network_summary_isValid && m_pid_isValid && m_short_synopsis_isValid && m_titles_isValid && m_total_available_episodes_isValid && m_type_isValid && true;
}
