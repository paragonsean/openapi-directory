...
OAIPodcastEpisodeSummary::OAIPodcastEpisodeSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPodcastEpisodeSummary::OAIPodcastEpisodeSummary() {
    this->initializeModel();
}

OAIPodcastEpisodeSummary::~OAIPodcastEpisodeSummary() {}

void OAIPodcastEpisodeSummary::initializeModel() {
...
void OAIPodcastEpisodeSummary::fromJson(QString jsonString) {
...
void OAIPodcastEpisodeSummary::fromJsonObject(QJsonObject json) {
...
QString OAIPodcastEpisodeSummary::asJson() const {
...
QJsonObject OAIPodcastEpisodeSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPodcastEpisodeSummary::getAssetUrl() const {
    return m_asset_url;
}
void OAIPodcastEpisodeSummary::setAssetUrl(const QString &asset_url) {
    m_asset_url = asset_url;
    m_asset_url_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_asset_url_Set() const{
    return m_asset_url_isSet;
}

bool OAIPodcastEpisodeSummary::is_asset_url_Valid() const{
    return m_asset_url_isValid;
}

QList<OAIAvailableVersions> OAIPodcastEpisodeSummary::getAvailableVersions() const {
    return m_available_versions;
}
void OAIPodcastEpisodeSummary::setAvailableVersions(const QList<OAIAvailableVersions> &available_versions) {
    m_available_versions = available_versions;
    m_available_versions_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_available_versions_Set() const{
    return m_available_versions_isSet;
}

bool OAIPodcastEpisodeSummary::is_available_versions_Valid() const{
    return m_available_versions_isValid;
}

QList<OAIImage> OAIPodcastEpisodeSummary::getImages() const {
    return m_images;
}
void OAIPodcastEpisodeSummary::setImages(const QList<OAIImage> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_images_Set() const{
    return m_images_isSet;
}

bool OAIPodcastEpisodeSummary::is_images_Valid() const{
    return m_images_isValid;
}

QString OAIPodcastEpisodeSummary::getMediaType() const {
    return m_media_type;
}
void OAIPodcastEpisodeSummary::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIPodcastEpisodeSummary::is_media_type_Valid() const{
    return m_media_type_isValid;
}

OAINetworkSummary OAIPodcastEpisodeSummary::getNetworkSummary() const {
    return m_network_summary;
}
void OAIPodcastEpisodeSummary::setNetworkSummary(const OAINetworkSummary &network_summary) {
    m_network_summary = network_summary;
    m_network_summary_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_network_summary_Set() const{
    return m_network_summary_isSet;
}

bool OAIPodcastEpisodeSummary::is_network_summary_Valid() const{
    return m_network_summary_isValid;
}

QString OAIPodcastEpisodeSummary::getPid() const {
    return m_pid;
}
void OAIPodcastEpisodeSummary::setPid(const QString &pid) {
    m_pid = pid;
    m_pid_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_pid_Set() const{
    return m_pid_isSet;
}

bool OAIPodcastEpisodeSummary::is_pid_Valid() const{
    return m_pid_isValid;
}

QString OAIPodcastEpisodeSummary::getReleaseDate() const {
    return m_release_date;
}
void OAIPodcastEpisodeSummary::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAIPodcastEpisodeSummary::is_release_date_Valid() const{
    return m_release_date_isValid;
}

QString OAIPodcastEpisodeSummary::getShortSynopsis() const {
    return m_short_synopsis;
}
void OAIPodcastEpisodeSummary::setShortSynopsis(const QString &short_synopsis) {
    m_short_synopsis = short_synopsis;
    m_short_synopsis_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_short_synopsis_Set() const{
    return m_short_synopsis_isSet;
}

bool OAIPodcastEpisodeSummary::is_short_synopsis_Valid() const{
    return m_short_synopsis_isValid;
}

OAIProgrammeTitles OAIPodcastEpisodeSummary::getTitles() const {
    return m_titles;
}
void OAIPodcastEpisodeSummary::setTitles(const OAIProgrammeTitles &titles) {
    m_titles = titles;
    m_titles_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_titles_Set() const{
    return m_titles_isSet;
}

bool OAIPodcastEpisodeSummary::is_titles_Valid() const{
    return m_titles_isValid;
}

QString OAIPodcastEpisodeSummary::getType() const {
    return m_type;
}
void OAIPodcastEpisodeSummary::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPodcastEpisodeSummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPodcastEpisodeSummary::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPodcastEpisodeSummary::isSet() const {
...
bool OAIPodcastEpisodeSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_asset_url_isValid && m_available_versions_isValid && m_images_isValid && m_media_type_isValid && m_network_summary_isValid && m_pid_isValid && m_release_date_isValid && m_short_synopsis_isValid && m_titles_isValid && m_type_isValid && true;
}
