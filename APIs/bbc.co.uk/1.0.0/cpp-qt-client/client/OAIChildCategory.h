...
#ifndef OAIChildCategory_H
#define OAIChildCategory_H
...
class OAIChildCategory : public OAIObject {
public:
    OAIChildCategory();
    OAIChildCategory(QString json);
    ~OAIChildCategory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChildCategory)

#endif // OAIChildCategory_H
