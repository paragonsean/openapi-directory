...
class PersonalisedMusicActivity(Model):
    ...
    def __init__(self, action: str=None, activity: str=None, added_at: str=None, data: List[PersonalisedMusicData]=None, domain: str=None, id: str=None, meta_data: PersonalisedMusicMetaData=None, type: str=None, urn: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PersonalisedMusicActivity':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PersonalisedMusicActivity of this PersonalisedMusicActivity.
        """
    ...
    def meta_data(self, meta_data):
        ...
        if meta_data is None:
            raise ValueError("Invalid value for `meta_data`, must not be `None`")
