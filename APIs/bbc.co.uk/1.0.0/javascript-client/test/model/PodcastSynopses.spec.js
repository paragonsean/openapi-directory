...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RadioMusicServices.PodcastSynopses();
  });
  ...
  describe('PodcastSynopses', function() {
    it('should create an instance of PodcastSynopses', function() {
      // uncomment below and update the code to test PodcastSynopses
      //var instance = new RadioMusicServices.PodcastSynopses();
      //expect(instance).to.be.a(RadioMusicServices.PodcastSynopses);
    });
