...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RadioMusicServices.PersonalisedMusicTrack();
  });
  ...
  describe('PersonalisedMusicTrack', function() {
    it('should create an instance of PersonalisedMusicTrack', function() {
      // uncomment below and update the code to test PersonalisedMusicTrack
      //var instance = new RadioMusicServices.PersonalisedMusicTrack();
      //expect(instance).to.be.a(RadioMusicServices.PersonalisedMusicTrack);
    });
