...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RadioMusicServices.PersonalisedMusicPlaylistVersion();
  });
  ...
  describe('PersonalisedMusicPlaylistVersion', function() {
    it('should create an instance of PersonalisedMusicPlaylistVersion', function() {
      // uncomment below and update the code to test PersonalisedMusicPlaylistVersion
      //var instance = new RadioMusicServices.PersonalisedMusicPlaylistVersion();
      //expect(instance).to.be.a(RadioMusicServices.PersonalisedMusicPlaylistVersion);
    });
