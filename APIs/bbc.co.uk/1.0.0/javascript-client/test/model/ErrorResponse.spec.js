...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RadioMusicServices.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new RadioMusicServices.ErrorResponse();
      //expect(instance).to.be.a(RadioMusicServices.ErrorResponse);
    });
