...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RadioMusicServices.PersonalisedMusicActivity();
  });
  ...
  describe('PersonalisedMusicActivity', function() {
    it('should create an instance of PersonalisedMusicActivity', function() {
      // uncomment below and update the code to test PersonalisedMusicActivity
      //var instance = new RadioMusicServices.PersonalisedMusicActivity();
      //expect(instance).to.be.a(RadioMusicServices.PersonalisedMusicActivity);
    });
