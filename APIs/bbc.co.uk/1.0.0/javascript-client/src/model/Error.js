...
class Error {
     ...
     */
    constructor(href, id, message, repliedAt) { 
        
        Error.initialize(this, href, id, message, repliedAt);
    }
     ...
     */
    static initialize(obj, href, id, message, repliedAt) { 
        obj['href'] = href;
        obj['id'] = id;
        obj['message'] = message;
...
Error.RequiredProperties = ["href", "id", "message", "replied_at"];
 ...
 */
Error.prototype['replied_at'] = undefined;
