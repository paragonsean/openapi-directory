...
class Body1 {
     ...
     * @param platform {module:model/Body1.PlatformEnum} 
     */
    constructor(categoryId, platform) { 
        
        Body1.initialize(this, categoryId, platform);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Body1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Body1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Body1.RequiredProperties) {
...
Body1.RequiredProperties = ["category_id", "platform"];

/**
 * @member {String} category_id
 */
Body1.prototype['category_id'] = undefined;

/**
 * @member {module:model/Body1.PlatformEnum} platform
 */
Body1.prototype['platform'] = undefined;
