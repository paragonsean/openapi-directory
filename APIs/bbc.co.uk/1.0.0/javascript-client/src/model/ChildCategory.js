...
/**
 * The ChildCategory model module.
 * @module model/ChildCategory
 * @version 1.0.0
 */
class ChildCategory {
    /**
     * Constructs a new <code>ChildCategory</code>.
     * @alias module:model/ChildCategory
    ...
    constructor(categoryType, childCategories, depth, id, pipId, title, type, urlKey) { 
        ...
        ChildCategory.initialize(this, categoryType, childCategories, depth, id, pipId, title, type, urlKey);
    }
    ...
    /**
     * Constructs a <code>ChildCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChildCategory} obj Optional instance to populate.
     * @return {module:model/ChildCategory} The populated <code>ChildCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChildCategory();
    ...
    /**
     * Validates the JSON data with respect to <code>ChildCategory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChildCategory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChildCategory.RequiredProperties) {
...
ChildCategory.RequiredProperties = ["category_type", "child_categories", "depth", "id", "pip_id", "title", "type", "url_key"];

/**
 * @member {String} category_type
 */
ChildCategory.prototype['category_type'] = undefined;

/**
 * @member {Array.<module:model/ChildCategory>} child_categories
 */
ChildCategory.prototype['child_categories'] = undefined;

/**
 * @member {Number} depth
 */
ChildCategory.prototype['depth'] = undefined;

/**
 * @member {String} id
 */
ChildCategory.prototype['id'] = undefined;

/**
 * @member {String} pip_id
 */
ChildCategory.prototype['pip_id'] = undefined;

/**
 * @member {String} title
 */
ChildCategory.prototype['title'] = undefined;

/**
 * @member {String} type
 */
ChildCategory.prototype['type'] = undefined;

/**
 * @member {String} url_key
 */
ChildCategory.prototype['url_key'] = undefined;
