...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("addDeed", defaultConf);
    _serverIndices.insert("addDeed", 0);
}
...
void OAIDefaultApi::addDeed(const OAIDeed_Application &body) {
    QString fullPath = QString(_serverConfigs["addDeed"][_serverIndices.value("addDeed")].URL()+"/deed/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::addDeedCallback);
...
void OAIDefaultApi::addDeedCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT addDeedSignal(output);
        Q_EMIT addDeedSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT addDeedSignalE(output, error_type, error_str);
        Q_EMIT addDeedSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT addDeedSignalError(output, error_type, error_str);
        Q_EMIT addDeedSignalErrorFull(worker, error_type, error_str);
    }
}
