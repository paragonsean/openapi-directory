...
Deed API
- API version: 1.0.0
  - Build date: 2024-10-12T12:32:38.816082-04:00[America/New_York]
...
## Documentation for Models
 ...
 - [AdditionalProvisionsInner](docs/AdditionalProvisionsInner.md)
 - [Borrower](docs/Borrower.md)
 - [ChargeClause](docs/ChargeClause.md)
 - [DeedApplication](docs/DeedApplication.md)
 - [Error](docs/Error.md)
 - [Lender](docs/Lender.md)
 - [OperativeDeed](docs/OperativeDeed.md)
 - [OperativeDeedDeed](docs/OperativeDeedDeed.md)
 - [PrivateIndividualName](docs/PrivateIndividualName.md)
