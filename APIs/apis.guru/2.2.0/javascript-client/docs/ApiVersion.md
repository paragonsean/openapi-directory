...
------------ | ------------- | ------------- | -------------
**added** | **Date** | Timestamp when the version was added | 
**externalDocs** | **Object** | Copy of &#x60;externalDocs&#x60; section from OpenAPI definition | [optional] 
**info** | **Object** | Copy of &#x60;info&#x60; section from OpenAPI definition | 
**link** | **String** | Link to the individual API entry for this API | [optional] 
...
**updated** | **Date** | Timestamp when the version was updated | 
