...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApisGuru.MetricsThisWeek();
  });
  ...
  describe('MetricsThisWeek', function() {
    it('should create an instance of MetricsThisWeek', function() {
      // uncomment below and update the code to test MetricsThisWeek
      //var instance = new ApisGuru.MetricsThisWeek();
      //expect(instance).to.be.a(ApisGuru.MetricsThisWeek);
    });
