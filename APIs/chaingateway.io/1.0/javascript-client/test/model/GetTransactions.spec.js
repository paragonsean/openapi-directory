...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetTransactions();
  });
  ...
  describe('GetTransactions', function() {
    it('should create an instance of GetTransactions', function() {
      // uncomment below and update the code to test GetTransactions
      //var instance = new ChaingatewayIo.GetTransactions();
      //expect(instance).to.be.a(ChaingatewayIo.GetTransactions);
    });
