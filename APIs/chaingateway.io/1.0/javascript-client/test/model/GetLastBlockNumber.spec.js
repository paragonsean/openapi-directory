...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetLastBlockNumber();
  });
  ...
  describe('GetLastBlockNumber', function() {
    it('should create an instance of GetLastBlockNumber', function() {
      // uncomment below and update the code to test GetLastBlockNumber
      //var instance = new ChaingatewayIo.GetLastBlockNumber();
      //expect(instance).to.be.a(ChaingatewayIo.GetLastBlockNumber);
    });
