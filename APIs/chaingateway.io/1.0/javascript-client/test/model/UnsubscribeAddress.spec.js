...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.UnsubscribeAddress();
  });
  ...
  describe('UnsubscribeAddress', function() {
    it('should create an instance of UnsubscribeAddress', function() {
      // uncomment below and update the code to test UnsubscribeAddress
      //var instance = new ChaingatewayIo.UnsubscribeAddress();
      //expect(instance).to.be.a(ChaingatewayIo.UnsubscribeAddress);
    });
