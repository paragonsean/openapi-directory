...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetGasPrice();
  });
  ...
  describe('GetGasPrice', function() {
    it('should create an instance of GetGasPrice', function() {
      // uncomment below and update the code to test GetGasPrice
      //var instance = new ChaingatewayIo.GetGasPrice();
      //expect(instance).to.be.a(ChaingatewayIo.GetGasPrice);
    });
