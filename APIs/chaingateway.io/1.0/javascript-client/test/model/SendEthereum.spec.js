...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.SendEthereum();
  });
  ...
  describe('SendEthereum', function() {
    it('should create an instance of SendEthereum', function() {
      // uncomment below and update the code to test SendEthereum
      //var instance = new ChaingatewayIo.SendEthereum();
      //expect(instance).to.be.a(ChaingatewayIo.SendEthereum);
    });
