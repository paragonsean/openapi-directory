...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.ImportAddress();
  });
  ...
  describe('ImportAddress', function() {
    it('should create an instance of ImportAddress', function() {
      // uncomment below and update the code to test ImportAddress
      //var instance = new ChaingatewayIo.ImportAddress();
      //expect(instance).to.be.a(ChaingatewayIo.ImportAddress);
    });
