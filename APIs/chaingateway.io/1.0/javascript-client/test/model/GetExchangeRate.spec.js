...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetExchangeRate();
  });
  ...
  describe('GetExchangeRate', function() {
    it('should create an instance of GetExchangeRate', function() {
      // uncomment below and update the code to test GetExchangeRate
      //var instance = new ChaingatewayIo.GetExchangeRate();
      //expect(instance).to.be.a(ChaingatewayIo.GetExchangeRate);
    });
