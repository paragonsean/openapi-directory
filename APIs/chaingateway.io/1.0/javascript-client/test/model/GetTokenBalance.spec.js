...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetTokenBalance();
  });
  ...
  describe('GetTokenBalance', function() {
    it('should create an instance of GetTokenBalance', function() {
      // uncomment below and update the code to test GetTokenBalance
      //var instance = new ChaingatewayIo.GetTokenBalance();
      //expect(instance).to.be.a(ChaingatewayIo.GetTokenBalance);
    });
