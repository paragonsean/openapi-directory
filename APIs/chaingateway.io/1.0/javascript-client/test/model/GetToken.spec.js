...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.GetToken();
  });
  ...
  describe('GetToken', function() {
    it('should create an instance of GetToken', function() {
      // uncomment below and update the code to test GetToken
      //var instance = new ChaingatewayIo.GetToken();
      //expect(instance).to.be.a(ChaingatewayIo.GetToken);
    });
