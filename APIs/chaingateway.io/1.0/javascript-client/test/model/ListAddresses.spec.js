...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.ListAddresses();
  });
  ...
  describe('ListAddresses', function() {
    it('should create an instance of ListAddresses', function() {
      // uncomment below and update the code to test ListAddresses
      //var instance = new ChaingatewayIo.ListAddresses();
      //expect(instance).to.be.a(ChaingatewayIo.ListAddresses);
    });
