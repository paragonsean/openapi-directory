...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.ResendFailedIPN();
  });
  ...
  describe('ResendFailedIPN', function() {
    it('should create an instance of ResendFailedIPN', function() {
      // uncomment below and update the code to test ResendFailedIPN
      //var instance = new ChaingatewayIo.ResendFailedIPN();
      //expect(instance).to.be.a(ChaingatewayIo.ResendFailedIPN);
    });
