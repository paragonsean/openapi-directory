...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.SendToken();
  });
  ...
  describe('SendToken', function() {
    it('should create an instance of SendToken', function() {
      // uncomment below and update the code to test SendToken
      //var instance = new ChaingatewayIo.SendToken();
      //expect(instance).to.be.a(ChaingatewayIo.SendToken);
    });
