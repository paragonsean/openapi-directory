...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChaingatewayIo.AddressRequestsApi();
  });
  ...
  describe('AddressRequestsApi', function() {
    ...
    describe('exportAddress', function() {
      it('should call exportAddress successfully', function(done) {
        //uncomment below and update the code to test exportAddress
        //instance.exportAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importAddress', function() {
      it('should call importAddress successfully', function(done) {
        //uncomment below and update the code to test importAddress
        //instance.importAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
