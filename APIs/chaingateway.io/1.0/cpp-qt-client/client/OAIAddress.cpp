...
QString OAIAddress::getEthereumaddress() const {
    return m_ethereumaddress;
}
void OAIAddress::setEthereumaddress(const QString &ethereumaddress) {
    m_ethereumaddress = ethereumaddress;
    m_ethereumaddress_isSet = true;
}

bool OAIAddress::is_ethereumaddress_Set() const{
    return m_ethereumaddress_isSet;
}

bool OAIAddress::is_ethereumaddress_Valid() const{
