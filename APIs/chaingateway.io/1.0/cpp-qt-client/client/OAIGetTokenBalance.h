...
/*
 * OAIGetTokenBalance.h
 *
 * 
 */

#ifndef OAIGetTokenBalance_H
#define OAIGetTokenBalance_H
...
class OAIGetTokenBalance : public OAIObject {
public:
    OAIGetTokenBalance();
    OAIGetTokenBalance(QString json);
    ~OAIGetTokenBalance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTokenBalance)

#endif // OAIGetTokenBalance_H
