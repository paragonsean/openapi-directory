...
/*
 * OAIUnsubscribeAddress.h
 *
 * 
 */

#ifndef OAIUnsubscribeAddress_H
#define OAIUnsubscribeAddress_H
...
class OAIUnsubscribeAddress : public OAIObject {
public:
    OAIUnsubscribeAddress();
    OAIUnsubscribeAddress(QString json);
    ~OAIUnsubscribeAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribeAddress)

#endif // OAIUnsubscribeAddress_H
