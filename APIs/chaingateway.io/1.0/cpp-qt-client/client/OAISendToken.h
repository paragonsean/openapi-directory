...
#ifndef OAISendToken_H
#define OAISendToken_H
...
class OAISendToken : public OAIObject {
public:
    OAISendToken();
    OAISendToken(QString json);
    ~OAISendToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendToken)

#endif // OAISendToken_H
