...
#ifndef OAIDeleteAddress_H
#define OAIDeleteAddress_H
...
class OAIDeleteAddress : public OAIObject {
public:
    OAIDeleteAddress();
    OAIDeleteAddress(QString json);
    ~OAIDeleteAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAddress)

#endif // OAIDeleteAddress_H
