...
/*
 * OAISubscribeAddress.h
 *
 * 
 */

#ifndef OAISubscribeAddress_H
#define OAISubscribeAddress_H
...
class OAISubscribeAddress : public OAIObject {
public:
    OAISubscribeAddress();
    OAISubscribeAddress(QString json);
    ~OAISubscribeAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribeAddress)

#endif // OAISubscribeAddress_H
