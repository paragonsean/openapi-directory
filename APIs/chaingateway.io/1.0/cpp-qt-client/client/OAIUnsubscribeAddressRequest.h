...
/*
 * OAIUnsubscribeAddressRequest.h
 *
 * 
 */

#ifndef OAIUnsubscribeAddressRequest_H
#define OAIUnsubscribeAddressRequest_H
...
class OAIUnsubscribeAddressRequest : public OAIObject {
public:
    OAIUnsubscribeAddressRequest();
    OAIUnsubscribeAddressRequest(QString json);
    ~OAIUnsubscribeAddressRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsubscribeAddressRequest)

#endif // OAIUnsubscribeAddressRequest_H
