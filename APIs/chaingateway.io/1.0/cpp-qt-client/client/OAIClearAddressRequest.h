...
/*
 * OAIClearAddressRequest.h
 *
 * 
 */

#ifndef OAIClearAddressRequest_H
#define OAIClearAddressRequest_H
...
class OAIClearAddressRequest : public OAIObject {
public:
    OAIClearAddressRequest();
    OAIClearAddressRequest(QString json);
    ~OAIClearAddressRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClearAddressRequest)

#endif // OAIClearAddressRequest_H
