...
OAIPGApiExpireTokenRequest::OAIPGApiExpireTokenRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPGApiExpireTokenRequest::OAIPGApiExpireTokenRequest() {
    this->initializeModel();
}

OAIPGApiExpireTokenRequest::~OAIPGApiExpireTokenRequest() {}

void OAIPGApiExpireTokenRequest::initializeModel() {
...
void OAIPGApiExpireTokenRequest::fromJson(QString jsonString) {
...
void OAIPGApiExpireTokenRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPGApiExpireTokenRequest::asJson() const {
...
QJsonObject OAIPGApiExpireTokenRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_card_id_isSet) {
...
QString OAIPGApiExpireTokenRequest::getCardId() const {
    return m_card_id;
}
void OAIPGApiExpireTokenRequest::setCardId(const QString &card_id) {
    m_card_id = card_id;
    m_card_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_card_id_Set() const{
    return m_card_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_card_id_Valid() const{
    return m_card_id_isValid;
}

QString OAIPGApiExpireTokenRequest::getDeveloperId() const {
    return m_developer_id;
}
void OAIPGApiExpireTokenRequest::setDeveloperId(const QString &developer_id) {
    m_developer_id = developer_id;
    m_developer_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_developer_id_Set() const{
    return m_developer_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_developer_id_Valid() const{
    return m_developer_id_isValid;
}

QString OAIPGApiExpireTokenRequest::getEchoFields() const {
    return m_echo_fields;
}
void OAIPGApiExpireTokenRequest::setEchoFields(const QString &echo_fields) {
    m_echo_fields = echo_fields;
    m_echo_fields_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_echo_fields_Set() const{
    return m_echo_fields_isSet;
}

bool OAIPGApiExpireTokenRequest::is_echo_fields_Valid() const{
    return m_echo_fields_isValid;
}

QString OAIPGApiExpireTokenRequest::getLocId() const {
    return m_loc_id;
}
void OAIPGApiExpireTokenRequest::setLocId(const QString &loc_id) {
    m_loc_id = loc_id;
    m_loc_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_loc_id_Set() const{
    return m_loc_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_loc_id_Valid() const{
    return m_loc_id_isValid;
}

qint64 OAIPGApiExpireTokenRequest::getMerchantId() const {
    return m_merchant_id;
}
void OAIPGApiExpireTokenRequest::setMerchantId(const qint64 &merchant_id) {
    m_merchant_id = merchant_id;
    m_merchant_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_merchant_id_Set() const{
    return m_merchant_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_merchant_id_Valid() const{
    return m_merchant_id_isValid;
}

QString OAIPGApiExpireTokenRequest::getProfileId() const {
    return m_profile_id;
}
void OAIPGApiExpireTokenRequest::setProfileId(const QString &profile_id) {
    m_profile_id = profile_id;
    m_profile_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_profile_id_Set() const{
    return m_profile_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_profile_id_Valid() const{
    return m_profile_id_isValid;
}

QString OAIPGApiExpireTokenRequest::getReportData() const {
    return m_report_data;
}
void OAIPGApiExpireTokenRequest::setReportData(const QString &report_data) {
    m_report_data = report_data;
    m_report_data_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_report_data_Set() const{
    return m_report_data_isSet;
}

bool OAIPGApiExpireTokenRequest::is_report_data_Valid() const{
    return m_report_data_isValid;
}

qint64 OAIPGApiExpireTokenRequest::getRetryAttempt() const {
    return m_retry_attempt;
}
void OAIPGApiExpireTokenRequest::setRetryAttempt(const qint64 &retry_attempt) {
    m_retry_attempt = retry_attempt;
    m_retry_attempt_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_retry_attempt_Set() const{
    return m_retry_attempt_isSet;
}

bool OAIPGApiExpireTokenRequest::is_retry_attempt_Valid() const{
    return m_retry_attempt_isValid;
}

qint64 OAIPGApiExpireTokenRequest::getRetryId() const {
    return m_retry_id;
}
void OAIPGApiExpireTokenRequest::setRetryId(const qint64 &retry_id) {
    m_retry_id = retry_id;
    m_retry_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_retry_id_Set() const{
    return m_retry_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_retry_id_Valid() const{
    return m_retry_id_isValid;
}

QString OAIPGApiExpireTokenRequest::getSessionId() const {
    return m_session_id;
}
void OAIPGApiExpireTokenRequest::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_session_id_Valid() const{
    return m_session_id_isValid;
}

qint64 OAIPGApiExpireTokenRequest::getUserId() const {
    return m_user_id;
}
void OAIPGApiExpireTokenRequest::setUserId(const qint64 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

qint64 OAIPGApiExpireTokenRequest::getVendorId() const {
    return m_vendor_id;
}
void OAIPGApiExpireTokenRequest::setVendorId(const qint64 &vendor_id) {
    m_vendor_id = vendor_id;
    m_vendor_id_isSet = true;
}

bool OAIPGApiExpireTokenRequest::is_vendor_id_Set() const{
    return m_vendor_id_isSet;
}

bool OAIPGApiExpireTokenRequest::is_vendor_id_Valid() const{
    return m_vendor_id_isValid;
}

bool OAIPGApiExpireTokenRequest::isSet() const {
...
bool OAIPGApiExpireTokenRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_card_id_isValid && m_merchant_id_isValid && true;
}
