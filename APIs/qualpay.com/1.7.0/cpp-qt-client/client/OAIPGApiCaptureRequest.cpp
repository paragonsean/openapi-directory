...
OAIPGApiCaptureRequest::OAIPGApiCaptureRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPGApiCaptureRequest::OAIPGApiCaptureRequest() {
    this->initializeModel();
}

OAIPGApiCaptureRequest::~OAIPGApiCaptureRequest() {}

void OAIPGApiCaptureRequest::initializeModel() {
...
void OAIPGApiCaptureRequest::fromJson(QString jsonString) {
...
void OAIPGApiCaptureRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPGApiCaptureRequest::asJson() const {
...
QJsonObject OAIPGApiCaptureRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_amt_tran_isSet) {
...
double OAIPGApiCaptureRequest::getAmtTran() const {
    return m_amt_tran;
}
void OAIPGApiCaptureRequest::setAmtTran(const double &amt_tran) {
    m_amt_tran = amt_tran;
    m_amt_tran_isSet = true;
}

bool OAIPGApiCaptureRequest::is_amt_tran_Set() const{
    return m_amt_tran_isSet;
}

bool OAIPGApiCaptureRequest::is_amt_tran_Valid() const{
    return m_amt_tran_isValid;
}

QString OAIPGApiCaptureRequest::getDeveloperId() const {
    return m_developer_id;
}
void OAIPGApiCaptureRequest::setDeveloperId(const QString &developer_id) {
    m_developer_id = developer_id;
    m_developer_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_developer_id_Set() const{
    return m_developer_id_isSet;
}

bool OAIPGApiCaptureRequest::is_developer_id_Valid() const{
    return m_developer_id_isValid;
}

QString OAIPGApiCaptureRequest::getEchoFields() const {
    return m_echo_fields;
}
void OAIPGApiCaptureRequest::setEchoFields(const QString &echo_fields) {
    m_echo_fields = echo_fields;
    m_echo_fields_isSet = true;
}

bool OAIPGApiCaptureRequest::is_echo_fields_Set() const{
    return m_echo_fields_isSet;
}

bool OAIPGApiCaptureRequest::is_echo_fields_Valid() const{
    return m_echo_fields_isValid;
}

QString OAIPGApiCaptureRequest::getLocId() const {
    return m_loc_id;
}
void OAIPGApiCaptureRequest::setLocId(const QString &loc_id) {
    m_loc_id = loc_id;
    m_loc_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_loc_id_Set() const{
    return m_loc_id_isSet;
}

bool OAIPGApiCaptureRequest::is_loc_id_Valid() const{
    return m_loc_id_isValid;
}

qint64 OAIPGApiCaptureRequest::getMerchantId() const {
    return m_merchant_id;
}
void OAIPGApiCaptureRequest::setMerchantId(const qint64 &merchant_id) {
    m_merchant_id = merchant_id;
    m_merchant_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_merchant_id_Set() const{
    return m_merchant_id_isSet;
}

bool OAIPGApiCaptureRequest::is_merchant_id_Valid() const{
    return m_merchant_id_isValid;
}

QString OAIPGApiCaptureRequest::getProfileId() const {
    return m_profile_id;
}
void OAIPGApiCaptureRequest::setProfileId(const QString &profile_id) {
    m_profile_id = profile_id;
    m_profile_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_profile_id_Set() const{
    return m_profile_id_isSet;
}

bool OAIPGApiCaptureRequest::is_profile_id_Valid() const{
    return m_profile_id_isValid;
}

QString OAIPGApiCaptureRequest::getReportData() const {
    return m_report_data;
}
void OAIPGApiCaptureRequest::setReportData(const QString &report_data) {
    m_report_data = report_data;
    m_report_data_isSet = true;
}

bool OAIPGApiCaptureRequest::is_report_data_Set() const{
    return m_report_data_isSet;
}

bool OAIPGApiCaptureRequest::is_report_data_Valid() const{
    return m_report_data_isValid;
}

qint64 OAIPGApiCaptureRequest::getRetryAttempt() const {
    return m_retry_attempt;
}
void OAIPGApiCaptureRequest::setRetryAttempt(const qint64 &retry_attempt) {
    m_retry_attempt = retry_attempt;
    m_retry_attempt_isSet = true;
}

bool OAIPGApiCaptureRequest::is_retry_attempt_Set() const{
    return m_retry_attempt_isSet;
}

bool OAIPGApiCaptureRequest::is_retry_attempt_Valid() const{
    return m_retry_attempt_isValid;
}

qint64 OAIPGApiCaptureRequest::getRetryId() const {
    return m_retry_id;
}
void OAIPGApiCaptureRequest::setRetryId(const qint64 &retry_id) {
    m_retry_id = retry_id;
    m_retry_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_retry_id_Set() const{
    return m_retry_id_isSet;
}

bool OAIPGApiCaptureRequest::is_retry_id_Valid() const{
    return m_retry_id_isValid;
}

QString OAIPGApiCaptureRequest::getSessionId() const {
    return m_session_id;
}
void OAIPGApiCaptureRequest::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIPGApiCaptureRequest::is_session_id_Valid() const{
    return m_session_id_isValid;
}

qint64 OAIPGApiCaptureRequest::getUserId() const {
    return m_user_id;
}
void OAIPGApiCaptureRequest::setUserId(const qint64 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPGApiCaptureRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

qint64 OAIPGApiCaptureRequest::getVendorId() const {
    return m_vendor_id;
}
void OAIPGApiCaptureRequest::setVendorId(const qint64 &vendor_id) {
    m_vendor_id = vendor_id;
    m_vendor_id_isSet = true;
}

bool OAIPGApiCaptureRequest::is_vendor_id_Set() const{
    return m_vendor_id_isSet;
}

bool OAIPGApiCaptureRequest::is_vendor_id_Valid() const{
    return m_vendor_id_isValid;
}

bool OAIPGApiCaptureRequest::isSet() const {
...
bool OAIPGApiCaptureRequest::isValid() const {
