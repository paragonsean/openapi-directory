...
OAIPGApiResponse::OAIPGApiResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPGApiResponse::OAIPGApiResponse() {
    this->initializeModel();
}

OAIPGApiResponse::~OAIPGApiResponse() {}

void OAIPGApiResponse::initializeModel() {
...
void OAIPGApiResponse::fromJson(QString jsonString) {
...
void OAIPGApiResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPGApiResponse::asJson() const {
...
QJsonObject OAIPGApiResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPGApiResponse::getEchoFields() const {
    return m_echo_fields;
}
void OAIPGApiResponse::setEchoFields(const QString &echo_fields) {
    m_echo_fields = echo_fields;
    m_echo_fields_isSet = true;
}

bool OAIPGApiResponse::is_echo_fields_Set() const{
    return m_echo_fields_isSet;
}

bool OAIPGApiResponse::is_echo_fields_Valid() const{
    return m_echo_fields_isValid;
}

QString OAIPGApiResponse::getPgId() const {
    return m_pg_id;
}
void OAIPGApiResponse::setPgId(const QString &pg_id) {
    m_pg_id = pg_id;
    m_pg_id_isSet = true;
}

bool OAIPGApiResponse::is_pg_id_Set() const{
    return m_pg_id_isSet;
}

bool OAIPGApiResponse::is_pg_id_Valid() const{
    return m_pg_id_isValid;
}

QString OAIPGApiResponse::getRcode() const {
    return m_rcode;
}
void OAIPGApiResponse::setRcode(const QString &rcode) {
    m_rcode = rcode;
    m_rcode_isSet = true;
}

bool OAIPGApiResponse::is_rcode_Set() const{
    return m_rcode_isSet;
}

bool OAIPGApiResponse::is_rcode_Valid() const{
    return m_rcode_isValid;
}

QString OAIPGApiResponse::getRmsg() const {
    return m_rmsg;
}
void OAIPGApiResponse::setRmsg(const QString &rmsg) {
    m_rmsg = rmsg;
    m_rmsg_isSet = true;
}

bool OAIPGApiResponse::is_rmsg_Set() const{
    return m_rmsg_isSet;
}

bool OAIPGApiResponse::is_rmsg_Valid() const{
    return m_rmsg_isValid;
}

bool OAIPGApiResponse::isSet() const {
...
bool OAIPGApiResponse::isValid() const {
