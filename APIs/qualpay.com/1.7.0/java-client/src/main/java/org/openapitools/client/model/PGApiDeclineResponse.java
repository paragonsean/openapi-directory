...
public class PGApiDeclineResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiDeclineResponse pgApiDeclineResponse = (PGApiDeclineResponse) o;
    return Objects.equals(this.echoFields, pgApiDeclineResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiDeclineResponse.pgId) &&
        Objects.equals(this.rcode, pgApiDeclineResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiDeclineResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiDeclineResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiDeclineResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiDeclineResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiDeclineResponse is not found in the empty JSON string", PGApiDeclineResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiDeclineResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiDeclineResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiDeclineResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiDeclineResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiDeclineResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiDeclineResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiDeclineResponse>() {
           @Override
           public void write(JsonWriter out, PGApiDeclineResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiDeclineResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiDeclineResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiDeclineResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiDeclineResponse
   */
  public static PGApiDeclineResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiDeclineResponse.class);
  }

  /**
   * Convert an instance of PGApiDeclineResponse to an JSON string
   *
   * @return JSON string
   */
