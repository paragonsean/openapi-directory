...
public class PGApiTimeoutResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiTimeoutResponse pgApiTimeoutResponse = (PGApiTimeoutResponse) o;
    return Objects.equals(this.echoFields, pgApiTimeoutResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiTimeoutResponse.pgId) &&
        Objects.equals(this.rcode, pgApiTimeoutResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiTimeoutResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiTimeoutResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiTimeoutResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiTimeoutResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiTimeoutResponse is not found in the empty JSON string", PGApiTimeoutResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiTimeoutResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiTimeoutResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiTimeoutResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiTimeoutResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiTimeoutResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiTimeoutResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiTimeoutResponse>() {
           @Override
           public void write(JsonWriter out, PGApiTimeoutResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiTimeoutResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiTimeoutResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiTimeoutResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiTimeoutResponse
   */
  public static PGApiTimeoutResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiTimeoutResponse.class);
  }

  /**
   * Convert an instance of PGApiTimeoutResponse to an JSON string
   *
   * @return JSON string
   */
