...
public class PGApiExpireTokenResponse {
  ...
  public PGApiExpireTokenResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    PGApiExpireTokenResponse pgApiExpireTokenResponse = (PGApiExpireTokenResponse) o;
    return Objects.equals(this.echoFields, pgApiExpireTokenResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiExpireTokenResponse.pgId) &&
        Objects.equals(this.rcode, pgApiExpireTokenResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiExpireTokenResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiExpireTokenResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiExpireTokenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiExpireTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiExpireTokenResponse is not found in the empty JSON string", PGApiExpireTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiExpireTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiExpireTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiExpireTokenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiExpireTokenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiExpireTokenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiExpireTokenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiExpireTokenResponse>() {
           @Override
           public void write(JsonWriter out, PGApiExpireTokenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiExpireTokenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiExpireTokenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiExpireTokenResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiExpireTokenResponse
   */
  public static PGApiExpireTokenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiExpireTokenResponse.class);
  }

  /**
   * Convert an instance of PGApiExpireTokenResponse to an JSON string
   *
   * @return JSON string
   */
