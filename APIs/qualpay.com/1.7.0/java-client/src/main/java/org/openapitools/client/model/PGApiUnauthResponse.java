...
public class PGApiUnauthResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiUnauthResponse pgApiUnauthResponse = (PGApiUnauthResponse) o;
    return Objects.equals(this.echoFields, pgApiUnauthResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiUnauthResponse.pgId) &&
        Objects.equals(this.rcode, pgApiUnauthResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiUnauthResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiUnauthResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiUnauthResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiUnauthResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiUnauthResponse is not found in the empty JSON string", PGApiUnauthResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiUnauthResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiUnauthResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiUnauthResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiUnauthResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiUnauthResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiUnauthResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiUnauthResponse>() {
           @Override
           public void write(JsonWriter out, PGApiUnauthResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiUnauthResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiUnauthResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiUnauthResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiUnauthResponse
   */
  public static PGApiUnauthResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiUnauthResponse.class);
  }

  /**
   * Convert an instance of PGApiUnauthResponse to an JSON string
   *
   * @return JSON string
   */
