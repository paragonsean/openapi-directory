...
public class PGApiCaptureResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiCaptureResponse pgApiCaptureResponse = (PGApiCaptureResponse) o;
    return Objects.equals(this.echoFields, pgApiCaptureResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiCaptureResponse.pgId) &&
        Objects.equals(this.rcode, pgApiCaptureResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiCaptureResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiCaptureResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiCaptureResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiCaptureResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiCaptureResponse is not found in the empty JSON string", PGApiCaptureResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiCaptureResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiCaptureResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiCaptureResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiCaptureResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiCaptureResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiCaptureResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiCaptureResponse>() {
           @Override
           public void write(JsonWriter out, PGApiCaptureResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiCaptureResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiCaptureResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiCaptureResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiCaptureResponse
   */
  public static PGApiCaptureResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiCaptureResponse.class);
  }

  /**
   * Convert an instance of PGApiCaptureResponse to an JSON string
   *
   * @return JSON string
   */
