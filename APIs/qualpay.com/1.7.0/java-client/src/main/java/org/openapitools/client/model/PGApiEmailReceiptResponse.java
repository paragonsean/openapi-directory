...
public class PGApiEmailReceiptResponse {
  ...
  public PGApiEmailReceiptResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    PGApiEmailReceiptResponse pgApiEmailReceiptResponse = (PGApiEmailReceiptResponse) o;
    return Objects.equals(this.pgId, pgApiEmailReceiptResponse.pgId) &&
        Objects.equals(this.rcode, pgApiEmailReceiptResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiEmailReceiptResponse.rmsg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pgId, rcode, rmsg);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PGApiEmailReceiptResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiEmailReceiptResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiEmailReceiptResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiEmailReceiptResponse is not found in the empty JSON string", PGApiEmailReceiptResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiEmailReceiptResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiEmailReceiptResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiEmailReceiptResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiEmailReceiptResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiEmailReceiptResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiEmailReceiptResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiEmailReceiptResponse>() {
           @Override
           public void write(JsonWriter out, PGApiEmailReceiptResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiEmailReceiptResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiEmailReceiptResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiEmailReceiptResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiEmailReceiptResponse
   */
  public static PGApiEmailReceiptResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiEmailReceiptResponse.class);
  }

  /**
   * Convert an instance of PGApiEmailReceiptResponse to an JSON string
   *
   * @return JSON string
   */
