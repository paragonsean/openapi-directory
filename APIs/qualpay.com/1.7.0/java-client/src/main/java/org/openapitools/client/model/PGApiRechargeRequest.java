...
public class PGApiRechargeRequest {
  ...
  public PGApiRechargeRequest() {
  }

  public PGApiRechargeRequest amtTran(Double amtTran) {
  ...
  public PGApiRechargeRequest developerId(String developerId) {
  ...
  public PGApiRechargeRequest echoFields(String echoFields) {
  ...
  public PGApiRechargeRequest locId(String locId) {
    this.locId = locId;
    return this;
  }
  ...
  public PGApiRechargeRequest merchantId(Long merchantId) {
  ...
  public PGApiRechargeRequest profileId(String profileId) {
  ...
  public PGApiRechargeRequest reportData(String reportData) {
  ...
  public PGApiRechargeRequest retryAttempt(Long retryAttempt) {
  ...
  public PGApiRechargeRequest retryId(Long retryId) {
  ...
  public PGApiRechargeRequest sessionId(String sessionId) {
  ...
  public PGApiRechargeRequest userId(Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PGApiRechargeRequest pgApiRechargeRequest = (PGApiRechargeRequest) o;
    return Objects.equals(this.amtTran, pgApiRechargeRequest.amtTran) &&
        Objects.equals(this.developerId, pgApiRechargeRequest.developerId) &&
        Objects.equals(this.echoFields, pgApiRechargeRequest.echoFields) &&
        Objects.equals(this.locId, pgApiRechargeRequest.locId) &&
        Objects.equals(this.merchantId, pgApiRechargeRequest.merchantId) &&
        Objects.equals(this.profileId, pgApiRechargeRequest.profileId) &&
        Objects.equals(this.reportData, pgApiRechargeRequest.reportData) &&
        Objects.equals(this.retryAttempt, pgApiRechargeRequest.retryAttempt) &&
        Objects.equals(this.retryId, pgApiRechargeRequest.retryId) &&
        Objects.equals(this.sessionId, pgApiRechargeRequest.sessionId) &&
        Objects.equals(this.userId, pgApiRechargeRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amtTran, developerId, echoFields, locId, merchantId, profileId, reportData, retryAttempt, retryId, sessionId, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PGApiRechargeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiRechargeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiRechargeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiRechargeRequest is not found in the empty JSON string", PGApiRechargeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiRechargeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiRechargeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PGApiRechargeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiRechargeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiRechargeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiRechargeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiRechargeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiRechargeRequest>() {
           @Override
           public void write(JsonWriter out, PGApiRechargeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiRechargeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiRechargeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiRechargeRequest
   * @throws IOException if the JSON string is invalid with respect to PGApiRechargeRequest
   */
  public static PGApiRechargeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiRechargeRequest.class);
  }

  /**
   * Convert an instance of PGApiRechargeRequest to an JSON string
   *
   * @return JSON string
   */
