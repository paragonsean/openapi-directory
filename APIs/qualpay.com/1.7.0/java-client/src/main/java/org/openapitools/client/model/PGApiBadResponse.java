...
public class PGApiBadResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiBadResponse pgApiBadResponse = (PGApiBadResponse) o;
    return Objects.equals(this.echoFields, pgApiBadResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiBadResponse.pgId) &&
        Objects.equals(this.rcode, pgApiBadResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiBadResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiBadResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiBadResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiBadResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiBadResponse is not found in the empty JSON string", PGApiBadResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiBadResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiBadResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiBadResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiBadResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiBadResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiBadResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiBadResponse>() {
           @Override
           public void write(JsonWriter out, PGApiBadResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiBadResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiBadResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiBadResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiBadResponse
   */
  public static PGApiBadResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiBadResponse.class);
  }

  /**
   * Convert an instance of PGApiBadResponse to an JSON string
   *
   * @return JSON string
   */
