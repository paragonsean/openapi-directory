...
public class PGApiTokenizeResponse {
  ...
  public PGApiTokenizeResponse cardNumber(String cardNumber) {
  ...
  public boolean equals(Object o) {
    ...
    PGApiTokenizeResponse pgApiTokenizeResponse = (PGApiTokenizeResponse) o;
    return Objects.equals(this.cardId, pgApiTokenizeResponse.cardId) &&
        Objects.equals(this.cardNumber, pgApiTokenizeResponse.cardNumber) &&
        Objects.equals(this.echoFields, pgApiTokenizeResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiTokenizeResponse.pgId) &&
        Objects.equals(this.rcode, pgApiTokenizeResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiTokenizeResponse.rmsg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardId, cardNumber, echoFields, pgId, rcode, rmsg);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PGApiTokenizeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiTokenizeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiTokenizeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiTokenizeResponse is not found in the empty JSON string", PGApiTokenizeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiTokenizeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiTokenizeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiTokenizeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiTokenizeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiTokenizeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiTokenizeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiTokenizeResponse>() {
           @Override
           public void write(JsonWriter out, PGApiTokenizeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiTokenizeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiTokenizeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiTokenizeResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiTokenizeResponse
   */
  public static PGApiTokenizeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiTokenizeResponse.class);
  }

  /**
   * Convert an instance of PGApiTokenizeResponse to an JSON string
   *
   * @return JSON string
   */
