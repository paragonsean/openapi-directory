...
public class PGApiRefundRequest {
  ...
  public PGApiRefundRequest() {
  }

  public PGApiRefundRequest amtTran(Double amtTran) {
  ...
  public PGApiRefundRequest developerId(String developerId) {
  ...
  public PGApiRefundRequest echoFields(String echoFields) {
  ...
  public PGApiRefundRequest locId(String locId) {
    this.locId = locId;
    return this;
  }
  ...
  public PGApiRefundRequest merchantId(Long merchantId) {
  ...
  public PGApiRefundRequest profileId(String profileId) {
  ...
  public PGApiRefundRequest reportData(String reportData) {
  ...
  public PGApiRefundRequest retryAttempt(Long retryAttempt) {
  ...
  public PGApiRefundRequest retryId(Long retryId) {
  ...
  public PGApiRefundRequest sessionId(String sessionId) {
  ...
  public PGApiRefundRequest userId(Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  public PGApiRefundRequest vendorId(Long vendorId) {
  ...
  public boolean equals(Object o) {
    ...
    PGApiRefundRequest pgApiRefundRequest = (PGApiRefundRequest) o;
    return Objects.equals(this.amtTran, pgApiRefundRequest.amtTran) &&
        Objects.equals(this.developerId, pgApiRefundRequest.developerId) &&
        Objects.equals(this.echoFields, pgApiRefundRequest.echoFields) &&
        Objects.equals(this.locId, pgApiRefundRequest.locId) &&
        Objects.equals(this.merchantId, pgApiRefundRequest.merchantId) &&
        Objects.equals(this.profileId, pgApiRefundRequest.profileId) &&
        Objects.equals(this.reportData, pgApiRefundRequest.reportData) &&
        Objects.equals(this.retryAttempt, pgApiRefundRequest.retryAttempt) &&
        Objects.equals(this.retryId, pgApiRefundRequest.retryId) &&
        Objects.equals(this.sessionId, pgApiRefundRequest.sessionId) &&
        Objects.equals(this.userId, pgApiRefundRequest.userId) &&
        Objects.equals(this.vendorId, pgApiRefundRequest.vendorId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiRefundRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiRefundRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiRefundRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiRefundRequest is not found in the empty JSON string", PGApiRefundRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiRefundRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiRefundRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PGApiRefundRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiRefundRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiRefundRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiRefundRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiRefundRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiRefundRequest>() {
           @Override
           public void write(JsonWriter out, PGApiRefundRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiRefundRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiRefundRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiRefundRequest
   * @throws IOException if the JSON string is invalid with respect to PGApiRefundRequest
   */
  public static PGApiRefundRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiRefundRequest.class);
  }

  /**
   * Convert an instance of PGApiRefundRequest to an JSON string
   *
   * @return JSON string
   */
