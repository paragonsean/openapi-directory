...
public class PGApiResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiResponse pgApiResponse = (PGApiResponse) o;
    return Objects.equals(this.echoFields, pgApiResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiResponse.pgId) &&
        Objects.equals(this.rcode, pgApiResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiResponse.rmsg);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiResponse is not found in the empty JSON string", PGApiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiResponse>() {
           @Override
           public void write(JsonWriter out, PGApiResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiResponse
   */
  public static PGApiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiResponse.class);
  }

  /**
   * Convert an instance of PGApiResponse to an JSON string
   *
   * @return JSON string
   */
