...
public class PGApiVoidResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiVoidResponse pgApiVoidResponse = (PGApiVoidResponse) o;
    return Objects.equals(this.echoFields, pgApiVoidResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiVoidResponse.pgId) &&
        Objects.equals(this.rcode, pgApiVoidResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiVoidResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiVoidResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiVoidResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiVoidResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiVoidResponse is not found in the empty JSON string", PGApiVoidResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiVoidResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiVoidResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiVoidResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiVoidResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiVoidResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiVoidResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiVoidResponse>() {
           @Override
           public void write(JsonWriter out, PGApiVoidResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiVoidResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiVoidResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiVoidResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiVoidResponse
   */
  public static PGApiVoidResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiVoidResponse.class);
  }

  /**
   * Convert an instance of PGApiVoidResponse to an JSON string
   *
   * @return JSON string
   */
