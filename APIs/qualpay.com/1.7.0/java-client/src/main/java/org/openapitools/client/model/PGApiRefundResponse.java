...
public class PGApiRefundResponse {
  ...
  public boolean equals(Object o) {
    ...
    PGApiRefundResponse pgApiRefundResponse = (PGApiRefundResponse) o;
    return Objects.equals(this.echoFields, pgApiRefundResponse.echoFields) &&
        Objects.equals(this.pgId, pgApiRefundResponse.pgId) &&
        Objects.equals(this.rcode, pgApiRefundResponse.rcode) &&
        Objects.equals(this.rmsg, pgApiRefundResponse.rmsg);
  }
  ...
  public String toString() {
    ...
    sb.append("class PGApiRefundResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiRefundResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiRefundResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiRefundResponse is not found in the empty JSON string", PGApiRefundResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiRefundResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiRefundResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiRefundResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiRefundResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiRefundResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiRefundResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiRefundResponse>() {
           @Override
           public void write(JsonWriter out, PGApiRefundResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiRefundResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiRefundResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiRefundResponse
   * @throws IOException if the JSON string is invalid with respect to PGApiRefundResponse
   */
  public static PGApiRefundResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiRefundResponse.class);
  }

  /**
   * Convert an instance of PGApiRefundResponse to an JSON string
   *
   * @return JSON string
   */
