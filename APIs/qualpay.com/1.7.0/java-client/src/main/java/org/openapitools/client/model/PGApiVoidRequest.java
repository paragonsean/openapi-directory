...
public class PGApiVoidRequest {
  ...
  public PGApiVoidRequest() {
  }

  public PGApiVoidRequest developerId(String developerId) {
  ...
  public PGApiVoidRequest echoFields(String echoFields) {
  ...
  public PGApiVoidRequest locId(String locId) {
    this.locId = locId;
    return this;
  }
  ...
  public PGApiVoidRequest merchantId(Long merchantId) {
  ...
  public PGApiVoidRequest profileId(String profileId) {
  ...
  public PGApiVoidRequest reportData(String reportData) {
  ...
  public PGApiVoidRequest retryAttempt(Long retryAttempt) {
  ...
  public PGApiVoidRequest retryId(Long retryId) {
  ...
  public PGApiVoidRequest sessionId(String sessionId) {
  ...
  public PGApiVoidRequest userId(Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  public PGApiVoidRequest vendorId(Long vendorId) {
  ...
  public boolean equals(Object o) {
    ...
    PGApiVoidRequest pgApiVoidRequest = (PGApiVoidRequest) o;
    return Objects.equals(this.developerId, pgApiVoidRequest.developerId) &&
        Objects.equals(this.echoFields, pgApiVoidRequest.echoFields) &&
        Objects.equals(this.locId, pgApiVoidRequest.locId) &&
        Objects.equals(this.merchantId, pgApiVoidRequest.merchantId) &&
        Objects.equals(this.profileId, pgApiVoidRequest.profileId) &&
        Objects.equals(this.reportData, pgApiVoidRequest.reportData) &&
        Objects.equals(this.retryAttempt, pgApiVoidRequest.retryAttempt) &&
        Objects.equals(this.retryId, pgApiVoidRequest.retryId) &&
        Objects.equals(this.sessionId, pgApiVoidRequest.sessionId) &&
        Objects.equals(this.userId, pgApiVoidRequest.userId) &&
        Objects.equals(this.vendorId, pgApiVoidRequest.vendorId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(developerId, echoFields, locId, merchantId, profileId, reportData, retryAttempt, retryId, sessionId, userId, vendorId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PGApiVoidRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiVoidRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiVoidRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiVoidRequest is not found in the empty JSON string", PGApiVoidRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiVoidRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiVoidRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PGApiVoidRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiVoidRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiVoidRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiVoidRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiVoidRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiVoidRequest>() {
           @Override
           public void write(JsonWriter out, PGApiVoidRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiVoidRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiVoidRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiVoidRequest
   * @throws IOException if the JSON string is invalid with respect to PGApiVoidRequest
   */
  public static PGApiVoidRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiVoidRequest.class);
  }

  /**
   * Convert an instance of PGApiVoidRequest to an JSON string
   *
   * @return JSON string
   */
