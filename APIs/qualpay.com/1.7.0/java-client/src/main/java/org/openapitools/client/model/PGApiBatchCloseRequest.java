...
public class PGApiBatchCloseRequest {
  ...
  public PGApiBatchCloseRequest() {
  }

  public PGApiBatchCloseRequest developerId(String developerId) {
  ...
  public PGApiBatchCloseRequest echoFields(String echoFields) {
  ...
  public PGApiBatchCloseRequest locId(String locId) {
    this.locId = locId;
    return this;
  }
  ...
  public PGApiBatchCloseRequest merchantId(Long merchantId) {
  ...
  public PGApiBatchCloseRequest profileId(String profileId) {
  ...
  public PGApiBatchCloseRequest reportData(String reportData) {
  ...
  public PGApiBatchCloseRequest retryAttempt(Long retryAttempt) {
  ...
  public PGApiBatchCloseRequest retryId(Long retryId) {
  ...
  public PGApiBatchCloseRequest sessionId(String sessionId) {
  ...
  public PGApiBatchCloseRequest tranCurrency(Integer tranCurrency) {
  ...
  public PGApiBatchCloseRequest userId(Long userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PGApiBatchCloseRequest pgApiBatchCloseRequest = (PGApiBatchCloseRequest) o;
    return Objects.equals(this.developerId, pgApiBatchCloseRequest.developerId) &&
        Objects.equals(this.echoFields, pgApiBatchCloseRequest.echoFields) &&
        Objects.equals(this.locId, pgApiBatchCloseRequest.locId) &&
        Objects.equals(this.merchantId, pgApiBatchCloseRequest.merchantId) &&
        Objects.equals(this.profileId, pgApiBatchCloseRequest.profileId) &&
        Objects.equals(this.reportData, pgApiBatchCloseRequest.reportData) &&
        Objects.equals(this.retryAttempt, pgApiBatchCloseRequest.retryAttempt) &&
        Objects.equals(this.retryId, pgApiBatchCloseRequest.retryId) &&
        Objects.equals(this.sessionId, pgApiBatchCloseRequest.sessionId) &&
        Objects.equals(this.tranCurrency, pgApiBatchCloseRequest.tranCurrency) &&
        Objects.equals(this.userId, pgApiBatchCloseRequest.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(developerId, echoFields, locId, merchantId, profileId, reportData, retryAttempt, retryId, sessionId, tranCurrency, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PGApiBatchCloseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PGApiBatchCloseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PGApiBatchCloseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PGApiBatchCloseRequest is not found in the empty JSON string", PGApiBatchCloseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PGApiBatchCloseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PGApiBatchCloseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PGApiBatchCloseRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PGApiBatchCloseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PGApiBatchCloseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PGApiBatchCloseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PGApiBatchCloseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PGApiBatchCloseRequest>() {
           @Override
           public void write(JsonWriter out, PGApiBatchCloseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PGApiBatchCloseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PGApiBatchCloseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PGApiBatchCloseRequest
   * @throws IOException if the JSON string is invalid with respect to PGApiBatchCloseRequest
   */
  public static PGApiBatchCloseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PGApiBatchCloseRequest.class);
  }

  /**
   * Convert an instance of PGApiBatchCloseRequest to an JSON string
   *
   * @return JSON string
   */
