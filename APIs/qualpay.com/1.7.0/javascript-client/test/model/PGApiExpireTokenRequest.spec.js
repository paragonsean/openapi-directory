...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QualpayPaymentGatewayApi.PGApiExpireTokenRequest();
  });
  ...
  describe('PGApiExpireTokenRequest', function() {
    it('should create an instance of PGApiExpireTokenRequest', function() {
      // uncomment below and update the code to test PGApiExpireTokenRequest
      //var instance = new QualpayPaymentGatewayApi.PGApiExpireTokenRequest();
      //expect(instance).to.be.a(QualpayPaymentGatewayApi.PGApiExpireTokenRequest);
    });
