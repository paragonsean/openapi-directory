...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QualpayPaymentGatewayApi.PGApiRechargeRequest();
  });
  ...
  describe('PGApiRechargeRequest', function() {
    it('should create an instance of PGApiRechargeRequest', function() {
      // uncomment below and update the code to test PGApiRechargeRequest
      //var instance = new QualpayPaymentGatewayApi.PGApiRechargeRequest();
      //expect(instance).to.be.a(QualpayPaymentGatewayApi.PGApiRechargeRequest);
    });
