...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QualpayPaymentGatewayApi.PGApiCaptureRequest();
  });
  ...
  describe('PGApiCaptureRequest', function() {
    it('should create an instance of PGApiCaptureRequest', function() {
      // uncomment below and update the code to test PGApiCaptureRequest
      //var instance = new QualpayPaymentGatewayApi.PGApiCaptureRequest();
      //expect(instance).to.be.a(QualpayPaymentGatewayApi.PGApiCaptureRequest);
    });
