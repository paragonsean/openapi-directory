...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QualpayPaymentGatewayApi.PGApiRefundRequest();
  });
  ...
  describe('PGApiRefundRequest', function() {
    it('should create an instance of PGApiRefundRequest', function() {
      // uncomment below and update the code to test PGApiRefundRequest
      //var instance = new QualpayPaymentGatewayApi.PGApiRefundRequest();
      //expect(instance).to.be.a(QualpayPaymentGatewayApi.PGApiRefundRequest);
    });
