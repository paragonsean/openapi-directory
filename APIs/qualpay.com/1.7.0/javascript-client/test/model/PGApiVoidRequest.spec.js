...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QualpayPaymentGatewayApi.PGApiVoidRequest();
  });
  ...
  describe('PGApiVoidRequest', function() {
    it('should create an instance of PGApiVoidRequest', function() {
      // uncomment below and update the code to test PGApiVoidRequest
      //var instance = new QualpayPaymentGatewayApi.PGApiVoidRequest();
      //expect(instance).to.be.a(QualpayPaymentGatewayApi.PGApiVoidRequest);
    });
