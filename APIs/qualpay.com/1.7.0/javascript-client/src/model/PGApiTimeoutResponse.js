...
/**
 * The PGApiTimeoutResponse model module.
 * @module model/PGApiTimeoutResponse
 * @version 1.7.0
 */
class PGApiTimeoutResponse {
    /**
     * Constructs a new <code>PGApiTimeoutResponse</code>.
     * @alias module:model/PGApiTimeoutResponse
     */
    constructor() { 
        
        PGApiTimeoutResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiTimeoutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiTimeoutResponse} obj Optional instance to populate.
     * @return {module:model/PGApiTimeoutResponse} The populated <code>PGApiTimeoutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiTimeoutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiTimeoutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiTimeoutResponse</code>.
     */
 ...
 */
PGApiTimeoutResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiTimeoutResponse.prototype['pg_id'] = undefined;
...
export default PGApiTimeoutResponse;
