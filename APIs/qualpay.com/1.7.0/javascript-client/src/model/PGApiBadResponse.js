...
/**
 * The PGApiBadResponse model module.
 * @module model/PGApiBadResponse
 * @version 1.7.0
 */
class PGApiBadResponse {
    /**
     * Constructs a new <code>PGApiBadResponse</code>.
     * @alias module:model/PGApiBadResponse
     */
    constructor() { 
        
        PGApiBadResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiBadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiBadResponse} obj Optional instance to populate.
     * @return {module:model/PGApiBadResponse} The populated <code>PGApiBadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiBadResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiBadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiBadResponse</code>.
     */
 ...
 */
PGApiBadResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiBadResponse.prototype['pg_id'] = undefined;
...
export default PGApiBadResponse;
