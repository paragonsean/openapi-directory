...
/**
 * The PGApiBatchCloseRequest model module.
 * @module model/PGApiBatchCloseRequest
 * @version 1.7.0
 */
class PGApiBatchCloseRequest {
    /**
     * Constructs a new <code>PGApiBatchCloseRequest</code>.
     * @alias module:model/PGApiBatchCloseRequest
    ...
    constructor(merchantId) { 
        ...
        PGApiBatchCloseRequest.initialize(this, merchantId);
    }
    ...
    /**
     * Constructs a <code>PGApiBatchCloseRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiBatchCloseRequest} obj Optional instance to populate.
     * @return {module:model/PGApiBatchCloseRequest} The populated <code>PGApiBatchCloseRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiBatchCloseRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiBatchCloseRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiBatchCloseRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PGApiBatchCloseRequest.RequiredProperties) {
...
PGApiBatchCloseRequest.RequiredProperties = ["merchant_id"];
 ...
 */
PGApiBatchCloseRequest.prototype['developer_id'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['echo_fields'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['loc_id'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['merchant_id'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['profile_id'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['report_data'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['retry_attempt'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['retry_id'] = undefined;

/**
 * INTERNAL USE ONLY.
 * @member {String} session_id
 */
PGApiBatchCloseRequest.prototype['session_id'] = undefined;
 ...
 */
PGApiBatchCloseRequest.prototype['tran_currency'] = undefined;

/**
 * INTERNAL USE ONLY.
 * @member {Number} user_id
 */
PGApiBatchCloseRequest.prototype['user_id'] = undefined;
...
export default PGApiBatchCloseRequest;
