...
/**
 * The PGApiResponse model module.
 * @module model/PGApiResponse
 * @version 1.7.0
 */
class PGApiResponse {
    /**
     * Constructs a new <code>PGApiResponse</code>.
     * @alias module:model/PGApiResponse
     */
    constructor() { 
        
        PGApiResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiResponse} obj Optional instance to populate.
     * @return {module:model/PGApiResponse} The populated <code>PGApiResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiResponse</code>.
     */
 ...
 */
PGApiResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiResponse.prototype['pg_id'] = undefined;
