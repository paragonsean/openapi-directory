...
/**
 * The PGApiDeclineResponse model module.
 * @module model/PGApiDeclineResponse
 * @version 1.7.0
 */
class PGApiDeclineResponse {
    /**
     * Constructs a new <code>PGApiDeclineResponse</code>.
     * @alias module:model/PGApiDeclineResponse
     */
    constructor() { 
        
        PGApiDeclineResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiDeclineResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiDeclineResponse} obj Optional instance to populate.
     * @return {module:model/PGApiDeclineResponse} The populated <code>PGApiDeclineResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiDeclineResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiDeclineResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiDeclineResponse</code>.
     */
 ...
 */
PGApiDeclineResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiDeclineResponse.prototype['pg_id'] = undefined;
...
export default PGApiDeclineResponse;
