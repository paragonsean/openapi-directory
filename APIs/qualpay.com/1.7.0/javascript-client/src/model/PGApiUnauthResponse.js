...
/**
 * The PGApiUnauthResponse model module.
 * @module model/PGApiUnauthResponse
 * @version 1.7.0
 */
class PGApiUnauthResponse {
    /**
     * Constructs a new <code>PGApiUnauthResponse</code>.
     * @alias module:model/PGApiUnauthResponse
     */
    constructor() { 
        
        PGApiUnauthResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiUnauthResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiUnauthResponse} obj Optional instance to populate.
     * @return {module:model/PGApiUnauthResponse} The populated <code>PGApiUnauthResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiUnauthResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiUnauthResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiUnauthResponse</code>.
     */
 ...
 */
PGApiUnauthResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiUnauthResponse.prototype['pg_id'] = undefined;
...
export default PGApiUnauthResponse;
