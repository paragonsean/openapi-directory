...
/**
 * The PGApiCaptureResponse model module.
 * @module model/PGApiCaptureResponse
 * @version 1.7.0
 */
class PGApiCaptureResponse {
    /**
     * Constructs a new <code>PGApiCaptureResponse</code>.
     * @alias module:model/PGApiCaptureResponse
     */
    constructor() { 
        
        PGApiCaptureResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiCaptureResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiCaptureResponse} obj Optional instance to populate.
     * @return {module:model/PGApiCaptureResponse} The populated <code>PGApiCaptureResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiCaptureResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiCaptureResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiCaptureResponse</code>.
     */
 ...
 */
PGApiCaptureResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiCaptureResponse.prototype['pg_id'] = undefined;
...
export default PGApiCaptureResponse;
