...
/**
 * The PGApiRefundResponse model module.
 * @module model/PGApiRefundResponse
 * @version 1.7.0
 */
class PGApiRefundResponse {
    /**
     * Constructs a new <code>PGApiRefundResponse</code>.
     * @alias module:model/PGApiRefundResponse
     */
    constructor() { 
        
        PGApiRefundResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiRefundResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiRefundResponse} obj Optional instance to populate.
     * @return {module:model/PGApiRefundResponse} The populated <code>PGApiRefundResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiRefundResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiRefundResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiRefundResponse</code>.
     */
 ...
 */
PGApiRefundResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiRefundResponse.prototype['pg_id'] = undefined;
...
export default PGApiRefundResponse;
