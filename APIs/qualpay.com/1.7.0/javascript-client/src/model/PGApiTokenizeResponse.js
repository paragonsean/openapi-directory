...
/**
 * The PGApiTokenizeResponse model module.
 * @module model/PGApiTokenizeResponse
 * @version 1.7.0
 */
class PGApiTokenizeResponse {
    /**
     * Constructs a new <code>PGApiTokenizeResponse</code>.
     * @alias module:model/PGApiTokenizeResponse
     */
    constructor() { 
        
        PGApiTokenizeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PGApiTokenizeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiTokenizeResponse} obj Optional instance to populate.
     * @return {module:model/PGApiTokenizeResponse} The populated <code>PGApiTokenizeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiTokenizeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiTokenizeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiTokenizeResponse</code>.
     */
 ...
 */
PGApiTokenizeResponse.prototype['card_id'] = undefined;
 ...
 */
PGApiTokenizeResponse.prototype['card_number'] = undefined;
 ...
 */
PGApiTokenizeResponse.prototype['echo_fields'] = undefined;
 ...
 * @member {String} pg_id
 */
PGApiTokenizeResponse.prototype['pg_id'] = undefined;
...
export default PGApiTokenizeResponse;
