...
/**
 * The PGApiVoidRequest model module.
 * @module model/PGApiVoidRequest
 * @version 1.7.0
 */
class PGApiVoidRequest {
    /**
     * Constructs a new <code>PGApiVoidRequest</code>.
     * @alias module:model/PGApiVoidRequest
    ...
    constructor(merchantId) { 
        ...
        PGApiVoidRequest.initialize(this, merchantId);
    }
    ...
    /**
     * Constructs a <code>PGApiVoidRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PGApiVoidRequest} obj Optional instance to populate.
     * @return {module:model/PGApiVoidRequest} The populated <code>PGApiVoidRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PGApiVoidRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PGApiVoidRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PGApiVoidRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PGApiVoidRequest.RequiredProperties) {
...
PGApiVoidRequest.RequiredProperties = ["merchant_id"];
 ...
 */
PGApiVoidRequest.prototype['developer_id'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['echo_fields'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['loc_id'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['merchant_id'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['profile_id'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['report_data'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['retry_attempt'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['retry_id'] = undefined;

/**
 * INTERNAL USE ONLY.
 * @member {String} session_id
 */
PGApiVoidRequest.prototype['session_id'] = undefined;

/**
 * INTERNAL USE ONLY.
 * @member {Number} user_id
 */
PGApiVoidRequest.prototype['user_id'] = undefined;
 ...
 */
PGApiVoidRequest.prototype['vendor_id'] = undefined;
...
export default PGApiVoidRequest;
