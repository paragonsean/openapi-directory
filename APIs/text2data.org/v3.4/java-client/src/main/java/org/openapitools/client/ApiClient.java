...
public class ApiClient {
    ...
    private String basePath = "http://api.text2data.org";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://api.text2data.org",
    ...
    public ApiClient() {
        ...
        authentications.put("PrivateKey", new ApiKeyAuth("query", "PrivateKey"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v3.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.text2data.org
