# TextAnalyticsSentimentAnalysisApiApiText2dataCom.ExtractApi
...
let apiInstance = new TextAnalyticsSentimentAnalysisApiApiText2dataCom.ExtractApi();
apiInstance.extractGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.extractPost(requestDoc, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
