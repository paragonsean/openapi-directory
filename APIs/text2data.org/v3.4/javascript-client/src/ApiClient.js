...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.text2data.org') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.text2data.org
         */
        ...
        this.authentications = {
            'PrivateKey': {type: 'apiKey', 'in': 'query', name: 'PrivateKey'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v3.4/Javascript'
        };
