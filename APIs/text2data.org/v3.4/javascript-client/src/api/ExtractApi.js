...
* @version v3.4
*/
export default class ExtractApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the extractGet operation.
     * @callback module:api/ExtractApi~extractGetCallback
     ...
     * @param {module:api/ExtractApi~extractGetCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the extractPost operation.
     * @callback module:api/ExtractApi~extractPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DocumentResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ExtractApi~extractPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentResult}
     */
    extractPost(requestDoc, callback) {
      let postBody = requestDoc;
      // verify the required parameter 'requestDoc' is set
      if (requestDoc === undefined || requestDoc === null) {
        throw new Error("Missing the required parameter 'requestDoc' when calling extractPost");
      }
