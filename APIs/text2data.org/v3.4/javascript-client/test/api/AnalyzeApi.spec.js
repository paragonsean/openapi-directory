...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsSentimentAnalysisApiApiText2dataCom.AnalyzeApi();
  });
  ...
  describe('AnalyzeApi', function() {
    describe('analyzeGet', function() {
      it('should call analyzeGet successfully', function(done) {
        //uncomment below and update the code to test analyzeGet
        //instance.analyzeGet(function(error) {
    ...
    describe('analyzePost', function() {
      it('should call analyzePost successfully', function(done) {
        //uncomment below and update the code to test analyzePost
        //instance.analyzePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
