...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsSentimentAnalysisApiApiText2dataCom.ExtractApi();
  });
  ...
  describe('ExtractApi', function() {
    describe('extractGet', function() {
      it('should call extractGet successfully', function(done) {
        //uncomment below and update the code to test extractGet
        //instance.extractGet(function(error) {
    ...
    describe('extractPost', function() {
      it('should call extractPost successfully', function(done) {
        //uncomment below and update the code to test extractPost
        //instance.extractPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
