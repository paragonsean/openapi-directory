...
#include <iostream>
#include "../client/OAIAnalyzeApi.h"
...
void Example::exampleFunction1(){
     OAIAnalyzeApi apiInstance;
           apiInstance.analyzeGet();
...
See license for more information visit [See license](https://text2data.com/License)