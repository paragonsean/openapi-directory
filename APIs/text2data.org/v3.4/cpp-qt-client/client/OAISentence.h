...
public:
    ...
    qint32 getSentenceNumber() const;
    void setSentenceNumber(const qint32 &sentence_number);
    bool is_sentence_number_Set() const;
    bool is_sentence_number_Valid() const;
    ...
    QString getSentimentResultString() const;
    void setSentimentResultString(const QString &sentiment_result_string);
    bool is_sentiment_result_string_Set() const;
    bool is_sentiment_result_string_Valid() const;
...
private:
    ...
    qint32 m_sentence_number;
    bool m_sentence_number_isSet;
    bool m_sentence_number_isValid;

    QString m_sentiment_polarity;
    bool m_sentiment_polarity_isSet;
    bool m_sentiment_polarity_isValid;

    QString m_sentiment_result_string;
    bool m_sentiment_result_string_isSet;
    bool m_sentiment_result_string_isValid;
