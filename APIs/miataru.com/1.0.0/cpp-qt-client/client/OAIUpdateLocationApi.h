...
#ifndef OAI_OAIUpdateLocationApi_H
#define OAI_OAIUpdateLocationApi_H
...
class OAIUpdateLocationApi : public QObject {
    Q_OBJECT

public:
    OAIUpdateLocationApi(const int timeOut = 0);
    ~OAIUpdateLocationApi();
    ...
    /**
    * @param[in]  body OAIMiataruUpdateLocationRequest [required]
    */
    virtual void updateLocation(const OAIMiataruUpdateLocationRequest &body);
...
Q_SIGNALS:
    ...
    void updateLocationSignal(OAIACK summary);


    void updateLocationSignalFull(OAIHttpRequestWorker *worker, OAIACK summary);

    Q_DECL_DEPRECATED_X("Use updateLocationSignalError() instead")
    void updateLocationSignalE(OAIACK summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateLocationSignalError(OAIACK summary, QNetworkReply::NetworkError error_type, const QString &error_str);
