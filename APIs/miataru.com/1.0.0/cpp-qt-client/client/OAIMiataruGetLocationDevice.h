...
/*
 * OAIMiataruGetLocationDevice.h
 *
 * 
 */

#ifndef OAIMiataruGetLocationDevice_H
#define OAIMiataruGetLocationDevice_H
...
class OAIMiataruGetLocationDevice : public OAIObject {
public:
    OAIMiataruGetLocationDevice();
    OAIMiataruGetLocationDevice(QString json);
    ~OAIMiataruGetLocationDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMiataruGetLocationDevice)

#endif // OAIMiataruGetLocationDevice_H
