...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Miataru.GetVisitorHistoryApi();
  });
  ...
  describe('GetVisitorHistoryApi', function() {
    describe('getVisitorHistory', function() {
      it('should call getVisitorHistory successfully', function(done) {
        //uncomment below and update the code to test getVisitorHistory
        //instance.getVisitorHistory(function(error) {
