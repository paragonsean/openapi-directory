...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Miataru.MiataruVisitors();
  });
  ...
  describe('MiataruVisitors', function() {
    it('should create an instance of MiataruVisitors', function() {
      // uncomment below and update the code to test MiataruVisitors
      //var instance = new Miataru.MiataruVisitors();
      //expect(instance).to.be.a(Miataru.MiataruVisitors);
    });
