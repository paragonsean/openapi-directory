...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Miataru.MiataruGetLocationGeoJSONResponseGeometry();
  });
  ...
  describe('MiataruGetLocationGeoJSONResponseGeometry', function() {
    it('should create an instance of MiataruGetLocationGeoJSONResponseGeometry', function() {
      // uncomment below and update the code to test MiataruGetLocationGeoJSONResponseGeometry
      //var instance = new Miataru.MiataruGetLocationGeoJSONResponseGeometry();
      //expect(instance).to.be.a(Miataru.MiataruGetLocationGeoJSONResponseGeometry);
    });
