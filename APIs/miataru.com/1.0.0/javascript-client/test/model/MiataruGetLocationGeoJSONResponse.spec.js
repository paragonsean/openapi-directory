...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Miataru.MiataruGetLocationGeoJSONResponse();
  });
  ...
  describe('MiataruGetLocationGeoJSONResponse', function() {
    it('should create an instance of MiataruGetLocationGeoJSONResponse', function() {
      // uncomment below and update the code to test MiataruGetLocationGeoJSONResponse
      //var instance = new Miataru.MiataruGetLocationGeoJSONResponse();
      //expect(instance).to.be.a(Miataru.MiataruGetLocationGeoJSONResponse);
    });
