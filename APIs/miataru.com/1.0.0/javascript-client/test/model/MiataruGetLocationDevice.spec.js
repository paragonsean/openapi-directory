...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Miataru.MiataruGetLocationDevice();
  });
  ...
  describe('MiataruGetLocationDevice', function() {
    it('should create an instance of MiataruGetLocationDevice', function() {
      // uncomment below and update the code to test MiataruGetLocationDevice
      //var instance = new Miataru.MiataruGetLocationDevice();
      //expect(instance).to.be.a(Miataru.MiataruGetLocationDevice);
    });
