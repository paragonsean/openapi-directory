...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("apiPluginsGet", defaultConf);
    _serverIndices.insert("apiPluginsGet", 0);
}
...
void OAIDefaultApi::apiPluginsGet() {
    QString fullPath = QString(_serverConfigs["apiPluginsGet"][_serverIndices.value("apiPluginsGet")].URL()+"/api/plugins");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::apiPluginsGetCallback);
...
void OAIDefaultApi::apiPluginsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiPluginsGetSignal();
        Q_EMIT apiPluginsGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiPluginsGetSignalE(error_type, error_str);
        Q_EMIT apiPluginsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiPluginsGetSignalError(error_type, error_str);
        Q_EMIT apiPluginsGetSignalErrorFull(worker, error_type, error_str);
    }
}
