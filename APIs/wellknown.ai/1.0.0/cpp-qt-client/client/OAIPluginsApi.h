...
Q_SIGNALS:
    ...
    void getProviderSignal();


    void getProviderSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use getProviderSignalError() instead")
    void getProviderSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void getProviderSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
