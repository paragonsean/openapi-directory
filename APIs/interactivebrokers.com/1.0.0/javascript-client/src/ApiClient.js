...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.interactivebrokers.com/tradingapi/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://www.interactivebrokers.com/tradingapi/v1
         */
        ...
        this.authentications = {
            'cookieAuth': {type: 'apiKey', 'in': 'header', name: 'portal'}
        }
