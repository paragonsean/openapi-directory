...
/**
 * The OauthAccessTokenPostRequest model module.
 * @module model/OauthAccessTokenPostRequest
 * @version 1.0.0
 */
class OauthAccessTokenPostRequest {
    /**
     * Constructs a new <code>OauthAccessTokenPostRequest</code>.
     * @alias module:model/OauthAccessTokenPostRequest
     */
    constructor() { 
        
        OauthAccessTokenPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OauthAccessTokenPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OauthAccessTokenPostRequest} obj Optional instance to populate.
     * @return {module:model/OauthAccessTokenPostRequest} The populated <code>OauthAccessTokenPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OauthAccessTokenPostRequest();
            ...
            if (data.hasOwnProperty('oauth_verifier')) {
                obj['oauth_verifier'] = ApiClient.convertToType(data['oauth_verifier'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OauthAccessTokenPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OauthAccessTokenPostRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['oauth_verifier'] && !(typeof data['oauth_verifier'] === 'string' || data['oauth_verifier'] instanceof String)) {
            throw new Error("Expected the field `oauth_verifier` to be a primitive type in the JSON string but got " + data['oauth_verifier']);
        }
 ...
 */
OauthAccessTokenPostRequest.prototype['oauth_consumer_key'] = undefined;

/**
 * A random string uniquely generated for each request.
 * @member {String} oauth_nonce
 */
OauthAccessTokenPostRequest.prototype['oauth_nonce'] = undefined;
 ...
 */
OauthAccessTokenPostRequest.prototype['oauth_signature'] = undefined;

/**
 * The signature method used to sign the request. Currently only 'RSA-SHA256' is supported.
 * @member {String} oauth_signature_method
 */
OauthAccessTokenPostRequest.prototype['oauth_signature_method'] = undefined;
 ...
 */
OauthAccessTokenPostRequest.prototype['oauth_timestamp'] = undefined;

/**
 * The request token obtained from IB via /request_token.
 * @member {String} oauth_token
 */
OauthAccessTokenPostRequest.prototype['oauth_token'] = undefined;

/**
 * The verification code received from IB after the user has granted authorization.
 * @member {String} oauth_verifier
 */
OauthAccessTokenPostRequest.prototype['oauth_verifier'] = undefined;
...
export default OauthAccessTokenPostRequest;
