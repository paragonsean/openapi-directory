...
/*
 * OAI_oauth_request_token_post_request.h
 *
 * 
 */

#ifndef OAI_oauth_request_token_post_request_H
#define OAI_oauth_request_token_post_request_H
...
class OAI_oauth_request_token_post_request : public OAIObject {
public:
    OAI_oauth_request_token_post_request();
    OAI_oauth_request_token_post_request(QString json);
    ~OAI_oauth_request_token_post_request() override;
    ...
    QString getOauthCallback() const;
    void setOauthCallback(const QString &oauth_callback);
    bool is_oauth_callback_Set() const;
    bool is_oauth_callback_Valid() const;
...
private:
    ...
    QString m_oauth_callback;
    bool m_oauth_callback_isSet;
    bool m_oauth_callback_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_oauth_request_token_post_request)

#endif // OAI_oauth_request_token_post_request_H
