...
/*
 * OAI_oauth_live_session_token_post_request.h
 *
 * 
 */

#ifndef OAI_oauth_live_session_token_post_request_H
#define OAI_oauth_live_session_token_post_request_H
...
class OAI_oauth_live_session_token_post_request : public OAIObject {
public:
    OAI_oauth_live_session_token_post_request();
    OAI_oauth_live_session_token_post_request(QString json);
    ~OAI_oauth_live_session_token_post_request() override;
    ...
    QString getDiffieHellmanChallenge() const;
    void setDiffieHellmanChallenge(const QString &diffie_hellman_challenge);
    bool is_diffie_hellman_challenge_Set() const;
    bool is_diffie_hellman_challenge_Valid() const;
...
private:
    ...
    QString m_diffie_hellman_challenge;
    bool m_diffie_hellman_challenge_isSet;
    bool m_diffie_hellman_challenge_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_oauth_live_session_token_post_request)

#endif // OAI_oauth_live_session_token_post_request_H
