...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.OfferPriceTax();
  });
  ...
  describe('OfferPriceTax', function() {
    it('should create an instance of OfferPriceTax', function() {
      // uncomment below and update the code to test OfferPriceTax
      //var instance = new CommerceApi.OfferPriceTax();
      //expect(instance).to.be.a(CommerceApi.OfferPriceTax);
    });
