...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.OfferedPriceRelationships();
  });
  ...
  describe('OfferedPriceRelationships', function() {
    it('should create an instance of OfferedPriceRelationships', function() {
      // uncomment below and update the code to test OfferedPriceRelationships
      //var instance = new CommerceApi.OfferedPriceRelationships();
      //expect(instance).to.be.a(CommerceApi.OfferedPriceRelationships);
    });
