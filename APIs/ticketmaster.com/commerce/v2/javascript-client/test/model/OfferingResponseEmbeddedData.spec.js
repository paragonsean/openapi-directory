...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.OfferingResponseEmbeddedData();
  });
  ...
  describe('OfferingResponseEmbeddedData', function() {
    it('should create an instance of OfferingResponseEmbeddedData', function() {
      // uncomment below and update the code to test OfferingResponseEmbeddedData
      //var instance = new CommerceApi.OfferingResponseEmbeddedData();
      //expect(instance).to.be.a(CommerceApi.OfferingResponseEmbeddedData);
    });
    ...
    it('should have the property attributesRefs (base name: "attributesRefs")', function() {
      // uncomment below and update the code to test the property attributesRefs
      //var instance = new CommerceApi.OfferingResponseEmbeddedData();
      //expect(instance).to.be();
    });
