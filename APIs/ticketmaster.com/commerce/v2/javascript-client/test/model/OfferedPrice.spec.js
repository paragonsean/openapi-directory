...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.OfferedPrice();
  });
  ...
  describe('OfferedPrice', function() {
    it('should create an instance of OfferedPrice', function() {
      // uncomment below and update the code to test OfferedPrice
      //var instance = new CommerceApi.OfferedPrice();
      //expect(instance).to.be.a(CommerceApi.OfferedPrice);
    });
