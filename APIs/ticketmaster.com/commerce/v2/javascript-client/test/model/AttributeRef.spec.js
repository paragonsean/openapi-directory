...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.AttributeRef();
  });
  ...
  describe('AttributeRef', function() {
    it('should create an instance of AttributeRef', function() {
      // uncomment below and update the code to test AttributeRef
      //var instance = new CommerceApi.AttributeRef();
      //expect(instance).to.be.a(CommerceApi.AttributeRef);
    });
