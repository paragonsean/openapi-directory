...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.HoldRef();
  });
  ...
  describe('HoldRef', function() {
    it('should create an instance of HoldRef', function() {
      // uncomment below and update the code to test HoldRef
      //var instance = new CommerceApi.HoldRef();
      //expect(instance).to.be.a(CommerceApi.HoldRef);
    });
