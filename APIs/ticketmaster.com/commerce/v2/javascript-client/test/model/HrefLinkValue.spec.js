...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.HrefLinkValue();
  });
  ...
  describe('HrefLinkValue', function() {
    it('should create an instance of HrefLinkValue', function() {
      // uncomment below and update the code to test HrefLinkValue
      //var instance = new CommerceApi.HrefLinkValue();
      //expect(instance).to.be.a(CommerceApi.HrefLinkValue);
    });
