...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.AreaRelationships();
  });
  ...
  describe('AreaRelationships', function() {
    it('should create an instance of AreaRelationships', function() {
      // uncomment below and update the code to test AreaRelationships
      //var instance = new CommerceApi.AreaRelationships();
      //expect(instance).to.be.a(CommerceApi.AreaRelationships);
    });
