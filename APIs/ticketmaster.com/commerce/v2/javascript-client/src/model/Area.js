...
import AreaAttributes from './AreaAttributes';
...
class Area {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = AreaAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = AreaRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          AreaAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          AreaRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
 ...
 */
Area.prototype['_links'] = undefined;

/**
 * @member {module:model/AreaAttributes} attributes
 */
Area.prototype['attributes'] = undefined;
...
/**
 * @member {module:model/AreaRelationships} relationships
 */
Area.prototype['relationships'] = undefined;
