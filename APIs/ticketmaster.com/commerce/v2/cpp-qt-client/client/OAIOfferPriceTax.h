...
#ifndef OAIOfferPriceTax_H
#define OAIOfferPriceTax_H
...
class OAIOfferPriceTax : public OAIObject {
public:
    OAIOfferPriceTax();
    OAIOfferPriceTax(QString json);
    ~OAIOfferPriceTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferPriceTax)

#endif // OAIOfferPriceTax_H
