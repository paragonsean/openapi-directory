...
OAISimpleLinks OAIArea::getLinks() const {
    return m__links;
}
void OAIArea::setLinks(const OAISimpleLinks &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIArea::is__links_Set() const{
    return m__links_isSet;
}

bool OAIArea::is__links_Valid() const{
    return m__links_isValid;
}

OAIAreaAttributes OAIArea::getAttributes() const {
    return m_attributes;
}
void OAIArea::setAttributes(const OAIAreaAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIArea::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIArea::is_attributes_Valid() const{
...
OAIAreaRelationships OAIArea::getRelationships() const {
    return m_relationships;
}
void OAIArea::setRelationships(const OAIAreaRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIArea::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIArea::is_relationships_Valid() const{
