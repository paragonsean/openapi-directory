...
class OAIAreaAttributes;
class OAIAreaRelationships;
...
public:
    ...
    OAIAreaAttributes getAttributes() const;
    void setAttributes(const OAIAreaAttributes &attributes);
    ...
    OAIAreaRelationships getRelationships() const;
    void setRelationships(const OAIAreaRelationships &relationships);
...
private:
    ...
    OAIAreaAttributes m_attributes;
    ...
    OAIAreaRelationships m_relationships;
