...
import org.openapitools.client.model.OfferAttributes;
import org.openapitools.client.model.OfferRelationships;
...
public class Offer {
  ...
  private OfferRelationships relationships;
  ...
  public Offer links(SimpleLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Offer attributes(OfferAttributes attributes) {
  ...
  public Offer relationships(OfferRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public OfferRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(OfferRelationships relationships) {
    this.relationships = relationships;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, offer.links) &&
        Objects.equals(this.attributes, offer.attributes) &&
        Objects.equals(this.id, offer.id) &&
        Objects.equals(this.relationships, offer.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        OfferAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        OfferRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
