...
QMap<QString, QString> OAISegment::getNames() const {
    return m_names;
}
void OAISegment::setNames(const QMap<QString, QString> &names) {
    m_names = names;
    m_names_isSet = true;
}

bool OAISegment::is_names_Set() const{
    return m_names_isSet;
}

bool OAISegment::is_names_Valid() const{
