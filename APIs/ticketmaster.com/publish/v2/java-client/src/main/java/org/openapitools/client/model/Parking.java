...
public class Parking {
  ...
  public Parking names(Map<String, String> names) {
    this.names = names;
    return this;
  }

  public Parking putNamesItem(String key, String namesItem) {
    if (this.names == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.names, parking.names) &&
        Objects.equals(this.url, parking.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(names, url);
  }
