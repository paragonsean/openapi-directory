...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicketmasterPublishApi.PublicVisibility();
  });
  ...
  describe('PublicVisibility', function() {
    it('should create an instance of PublicVisibility', function() {
      // uncomment below and update the code to test PublicVisibility
      //var instance = new TicketmasterPublishApi.PublicVisibility();
      //expect(instance).to.be.a(TicketmasterPublishApi.PublicVisibility);
    });
