...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicketmasterPublishApi.Twitter();
  });
  ...
  describe('Twitter', function() {
    it('should create an instance of Twitter', function() {
      // uncomment below and update the code to test Twitter
      //var instance = new TicketmasterPublishApi.Twitter();
      //expect(instance).to.be.a(TicketmasterPublishApi.Twitter);
    });
