...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicketmasterPublishApi.PriceRange();
  });
  ...
  describe('PriceRange', function() {
    it('should create an instance of PriceRange', function() {
      ...
      //var instance = new TicketmasterPublishApi.PriceRange();
      //expect(instance).to.be.a(TicketmasterPublishApi.PriceRange);
    });
