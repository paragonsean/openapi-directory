...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TicketmasterPublishApi.Video();
  });
  ...
  describe('Video', function() {
    it('should create an instance of Video', function() {
      ...
      //var instance = new TicketmasterPublishApi.Video();
      //expect(instance).to.be.a(TicketmasterPublishApi.Video);
    });
    ...
    it('should have the property licensingInformation (base name: "licensingInformation")', function() {
      // uncomment below and update the code to test the property licensingInformation
      //var instance = new TicketmasterPublishApi.Video();
      //expect(instance).to.be();
    });
