...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://ioe2api.ijenko.net') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://ioe2api.ijenko.net
         */
        ...
        this.authentications = {
            'Token in Access-Token header': {type: 'apiKey', 'in': 'header', name: 'Access-Token'},
            'Token in query': {type: 'apiKey', 'in': 'query', name: 'token'}
        }
