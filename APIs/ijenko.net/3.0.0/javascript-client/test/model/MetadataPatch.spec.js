...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.MetadataPatch();
  });
  ...
  describe('MetadataPatch', function() {
    it('should create an instance of MetadataPatch', function() {
      // uncomment below and update the code to test MetadataPatch
      //var instance = new IoEIoTApiToCreateEndUserApplications.MetadataPatch();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.MetadataPatch);
    });
