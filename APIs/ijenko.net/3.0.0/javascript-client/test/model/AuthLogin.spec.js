...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.AuthLogin();
  });
  ...
  describe('AuthLogin', function() {
    it('should create an instance of AuthLogin', function() {
      ...
      //var instance = new IoEIoTApiToCreateEndUserApplications.AuthLogin();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.AuthLogin);
    });
