...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.UserResource();
  });
  ...
  describe('UserResource', function() {
    it('should create an instance of UserResource', function() {
      ...
      //var instance = new IoEIoTApiToCreateEndUserApplications.UserResource();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.UserResource);
    });
