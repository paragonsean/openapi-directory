...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.UserCreated();
  });
  ...
  describe('UserCreated', function() {
    it('should create an instance of UserCreated', function() {
      // uncomment below and update the code to test UserCreated
      //var instance = new IoEIoTApiToCreateEndUserApplications.UserCreated();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.UserCreated);
    });
