...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.FunctionalityNew();
  });
  ...
  describe('FunctionalityNew', function() {
    it('should create an instance of FunctionalityNew', function() {
      // uncomment below and update the code to test FunctionalityNew
      //var instance = new IoEIoTApiToCreateEndUserApplications.FunctionalityNew();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.FunctionalityNew);
    });
