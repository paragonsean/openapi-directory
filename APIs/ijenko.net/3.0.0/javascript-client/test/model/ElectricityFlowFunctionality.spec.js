...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.ElectricityFlowFunctionality();
  });
  ...
  describe('ElectricityFlowFunctionality', function() {
    it('should create an instance of ElectricityFlowFunctionality', function() {
      // uncomment below and update the code to test ElectricityFlowFunctionality
      //var instance = new IoEIoTApiToCreateEndUserApplications.ElectricityFlowFunctionality();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.ElectricityFlowFunctionality);
    });
