...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.PlaceResource();
  });
  ...
  describe('PlaceResource', function() {
    it('should create an instance of PlaceResource', function() {
      // uncomment below and update the code to test PlaceResource
      //var instance = new IoEIoTApiToCreateEndUserApplications.PlaceResource();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.PlaceResource);
    });
