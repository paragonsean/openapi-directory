...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.FunctionalityItem();
  });
  ...
  describe('FunctionalityItem', function() {
    it('should create an instance of FunctionalityItem', function() {
      // uncomment below and update the code to test FunctionalityItem
      //var instance = new IoEIoTApiToCreateEndUserApplications.FunctionalityItem();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.FunctionalityItem);
    });
