...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.AuthRefresh();
  });
  ...
  describe('AuthRefresh', function() {
    it('should create an instance of AuthRefresh', function() {
      // uncomment below and update the code to test AuthRefresh
      //var instance = new IoEIoTApiToCreateEndUserApplications.AuthRefresh();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.AuthRefresh);
    });
