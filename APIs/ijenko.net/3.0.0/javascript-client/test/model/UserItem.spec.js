...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.UserItem();
  });
  ...
  describe('UserItem', function() {
    it('should create an instance of UserItem', function() {
      ...
      //var instance = new IoEIoTApiToCreateEndUserApplications.UserItem();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.UserItem);
    });
