...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.DeviceItem();
  });
  ...
  describe('DeviceItem', function() {
    it('should create an instance of DeviceItem', function() {
      // uncomment below and update the code to test DeviceItem
      //var instance = new IoEIoTApiToCreateEndUserApplications.DeviceItem();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.DeviceItem);
    });
