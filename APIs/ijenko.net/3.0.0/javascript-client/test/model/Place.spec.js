...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.Place();
  });
  ...
  describe('Place', function() {
    it('should create an instance of Place', function() {
      ...
      //var instance = new IoEIoTApiToCreateEndUserApplications.Place();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.Place);
    });
