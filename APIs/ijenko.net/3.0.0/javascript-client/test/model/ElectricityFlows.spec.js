...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.ElectricityFlows();
  });
  ...
  describe('ElectricityFlows', function() {
    it('should create an instance of ElectricityFlows', function() {
      // uncomment below and update the code to test ElectricityFlows
      //var instance = new IoEIoTApiToCreateEndUserApplications.ElectricityFlows();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.ElectricityFlows);
    });
