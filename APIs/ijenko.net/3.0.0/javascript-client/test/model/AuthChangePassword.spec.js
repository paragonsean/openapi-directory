...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.AuthChangePassword();
  });
  ...
  describe('AuthChangePassword', function() {
    it('should create an instance of AuthChangePassword', function() {
      // uncomment below and update the code to test AuthChangePassword
      //var instance = new IoEIoTApiToCreateEndUserApplications.AuthChangePassword();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.AuthChangePassword);
    });
