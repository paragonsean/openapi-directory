...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.ProgramLog();
  });
  ...
  describe('ProgramLog', function() {
    it('should create an instance of ProgramLog', function() {
      // uncomment below and update the code to test ProgramLog
      //var instance = new IoEIoTApiToCreateEndUserApplications.ProgramLog();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.ProgramLog);
    });
