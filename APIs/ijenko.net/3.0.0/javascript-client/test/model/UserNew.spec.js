...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoEIoTApiToCreateEndUserApplications.UserNew();
  });
  ...
  describe('UserNew', function() {
    it('should create an instance of UserNew', function() {
      ...
      //var instance = new IoEIoTApiToCreateEndUserApplications.UserNew();
      //expect(instance).to.be.a(IoEIoTApiToCreateEndUserApplications.UserNew);
    });
