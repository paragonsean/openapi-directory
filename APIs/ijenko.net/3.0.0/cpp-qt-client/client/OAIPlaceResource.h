...
#ifndef OAIPlaceResource_H
#define OAIPlaceResource_H
...
class OAIPlaceResource : public OAIObject {
public:
    OAIPlaceResource();
    OAIPlaceResource(QString json);
    ~OAIPlaceResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaceResource)

#endif // OAIPlaceResource_H
