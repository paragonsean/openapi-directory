...
#ifndef OAIUserResource_H
#define OAIUserResource_H
...
class OAIUserResource : public OAIObject {
public:
    OAIUserResource();
    OAIUserResource(QString json);
    ~OAIUserResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserResource)

#endif // OAIUserResource_H
