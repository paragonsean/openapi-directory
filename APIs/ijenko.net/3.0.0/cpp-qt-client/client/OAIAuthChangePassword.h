...
/*
 * OAIAuthChangePassword.h
 *
 * 
 */

#ifndef OAIAuthChangePassword_H
#define OAIAuthChangePassword_H
...
class OAIAuthChangePassword : public OAIObject {
public:
    OAIAuthChangePassword();
    OAIAuthChangePassword(QString json);
    ~OAIAuthChangePassword() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthChangePassword)

#endif // OAIAuthChangePassword_H
