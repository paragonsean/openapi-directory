...
#ifndef OAIResourceRef_H
#define OAIResourceRef_H
...
class OAIResourceRef : public OAIObject {
public:
    OAIResourceRef();
    OAIResourceRef(QString json);
    ~OAIResourceRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceRef)

#endif // OAIResourceRef_H
