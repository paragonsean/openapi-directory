...
public class ApiClient {
    ...
    private String basePath = "https://ioe2api.ijenko.net";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://ioe2api.ijenko.net",
    ...
    public ApiClient() {
        ...
        authentications.put("Token in Access-Token header", new ApiKeyAuth("header", "Access-Token"));
        authentications.put("Token in query", new ApiKeyAuth("query", "token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://ioe2api.ijenko.net
