...
/*
 * OAI_records__record_id__more_like_this__format__get_200_response.h
 *
 * 
 */

#ifndef OAI_records__record_id__more_like_this__format__get_200_response_H
#define OAI_records__record_id__more_like_this__format__get_200_response_H
...
class OAI_records__record_id__more_like_this__format__get_200_response : public OAIObject {
public:
    OAI_records__record_id__more_like_this__format__get_200_response();
    OAI_records__record_id__more_like_this__format__get_200_response(QString json);
    ~OAI_records__record_id__more_like_this__format__get_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_records__record_id__more_like_this__format__get_200_response)

#endif // OAI_records__record_id__more_like_this__format__get_200_response_H
