...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductLibraryApi.ProductCreateRequest();
  });
  ...
  describe('ProductCreateRequest', function() {
    it('should create an instance of ProductCreateRequest', function() {
      // uncomment below and update the code to test ProductCreateRequest
      //var instance = new ProductLibraryApi.ProductCreateRequest();
      //expect(instance).to.be.a(ProductLibraryApi.ProductCreateRequest);
    });
    ...
    it('should have the property createWithDefaultTax (base name: "createWithDefaultTax")', function() {
      // uncomment below and update the code to test the property createWithDefaultTax
      //var instance = new ProductLibraryApi.ProductCreateRequest();
      //expect(instance).to.be();
    });
