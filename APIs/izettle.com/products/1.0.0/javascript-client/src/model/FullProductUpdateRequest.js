...
/**
 * The FullProductUpdateRequest model module.
 * @module model/FullProductUpdateRequest
 * @version 1.0.0
 */
class FullProductUpdateRequest {
    /**
     * Constructs a new <code>FullProductUpdateRequest</code>.
     * @alias module:model/FullProductUpdateRequest
     * @param name {String} 
     * @param uuid {String} 
     */
    constructor(name, uuid) { 
        
        FullProductUpdateRequest.initialize(this, name, uuid);
    }
    ...
    /**
     * Constructs a <code>FullProductUpdateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FullProductUpdateRequest} obj Optional instance to populate.
     * @return {module:model/FullProductUpdateRequest} The populated <code>FullProductUpdateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FullProductUpdateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>FullProductUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FullProductUpdateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FullProductUpdateRequest.RequiredProperties) {
...
FullProductUpdateRequest.RequiredProperties = ["name", "uuid"];

/**
 * @member {Array.<String>} categories
 */
FullProductUpdateRequest.prototype['categories'] = undefined;

/**
 * @member {module:model/CategoryDTO} category
 */
FullProductUpdateRequest.prototype['category'] = undefined;

/**
 * @member {String} description
 */
FullProductUpdateRequest.prototype['description'] = undefined;

/**
 * @member {String} externalReference
 */
FullProductUpdateRequest.prototype['externalReference'] = undefined;

/**
 * @member {Array.<String>} imageLookupKeys
 */
FullProductUpdateRequest.prototype['imageLookupKeys'] = undefined;

/**
 * @member {module:model/MetadataDTO} metadata
 */
FullProductUpdateRequest.prototype['metadata'] = undefined;

/**
 * @member {String} name
 */
FullProductUpdateRequest.prototype['name'] = undefined;

/**
 * @member {module:model/OnlineProperties} online
 */
FullProductUpdateRequest.prototype['online'] = undefined;

/**
 * @member {module:model/PresentationDTO} presentation
 */
FullProductUpdateRequest.prototype['presentation'] = undefined;

/**
 * @member {String} taxCode
 */
FullProductUpdateRequest.prototype['taxCode'] = undefined;

/**
 * @member {Boolean} taxExempt
 */
FullProductUpdateRequest.prototype['taxExempt'] = undefined;

/**
 * @member {Array.<String>} taxRates
 */
FullProductUpdateRequest.prototype['taxRates'] = undefined;

/**
 * @member {String} unitName
 */
FullProductUpdateRequest.prototype['unitName'] = undefined;

/**
 * @member {String} uuid
 */
FullProductUpdateRequest.prototype['uuid'] = undefined;

/**
 * @member {module:model/VariantOptionDefinitions} variantOptionDefinitions
 */
FullProductUpdateRequest.prototype['variantOptionDefinitions'] = undefined;

/**
 * @member {Array.<module:model/VariantDTO>} variants
 */
FullProductUpdateRequest.prototype['variants'] = undefined;

/**
 * @member {Number} vatPercentage
 */
FullProductUpdateRequest.prototype['vatPercentage'] = undefined;
...
export default FullProductUpdateRequest;
