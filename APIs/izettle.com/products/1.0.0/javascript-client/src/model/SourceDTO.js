...
class SourceDTO {
    ...
    /**
     * Validates the JSON data with respect to <code>SourceDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceDTO</code>.
     */
 ...
 */
SourceDTO.prototype['external'] = undefined;

/**
 * @member {String} name
 */
SourceDTO.prototype['name'] = undefined;
