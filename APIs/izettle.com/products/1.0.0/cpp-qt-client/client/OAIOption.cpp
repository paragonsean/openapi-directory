...
QList<QString> OAIOption::getValues() const {
    return m_values;
}
void OAIOption::setValues(const QList<QString> &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIOption::is_values_Set() const{
    return m_values_isSet;
}

bool OAIOption::is_values_Valid() const{
