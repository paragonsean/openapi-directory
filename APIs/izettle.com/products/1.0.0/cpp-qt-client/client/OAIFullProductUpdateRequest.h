...
/*
 * OAIFullProductUpdateRequest.h
 *
 * 
 */

#ifndef OAIFullProductUpdateRequest_H
#define OAIFullProductUpdateRequest_H
...
class OAIFullProductUpdateRequest : public OAIObject {
public:
    OAIFullProductUpdateRequest();
    OAIFullProductUpdateRequest(QString json);
    ~OAIFullProductUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFullProductUpdateRequest)

#endif // OAIFullProductUpdateRequest_H
