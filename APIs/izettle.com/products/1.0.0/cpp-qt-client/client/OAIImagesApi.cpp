...
void OAIImagesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getAllImageUrls", defaultConf);
    _serverIndices.insert("getAllImageUrls", 0);
}
...
void OAIImagesApi::getAllImageUrls(const QString &organization_uuid) {
    QString fullPath = QString(_serverConfigs["getAllImageUrls"][_serverIndices.value("getAllImageUrls")].URL()+"/organizations/{organizationUuid}/images");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::getAllImageUrlsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::getAllImageUrlsCallback);
...
void OAIImagesApi::getAllImageUrlsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAILibraryImagesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllImageUrlsSignal(output);
        Q_EMIT getAllImageUrlsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllImageUrlsSignalE(output, error_type, error_str);
        Q_EMIT getAllImageUrlsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllImageUrlsSignalError(output, error_type, error_str);
        Q_EMIT getAllImageUrlsSignalErrorFull(worker, error_type, error_str);
    }
}
