...
/*
 * OAIProductResponse.h
 *
 * 
 */

#ifndef OAIProductResponse_H
#define OAIProductResponse_H
...
class OAIProductResponse : public OAIObject {
public:
    OAIProductResponse();
    OAIProductResponse(QString json);
    ~OAIProductResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductResponse)

#endif // OAIProductResponse_H
