...
/**
* Strainsversion service.
* @module api/StrainsversionApi
* @version v2.0
*/
export default class StrainsversionApi {

    /**
    * Constructs a new StrainsversionApi. 
    * @alias module:api/StrainsversionApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV20DatabaseStrainsversionGet operation.
     * @callback module:api/StrainsversionApi~apiV20DatabaseStrainsversionGetCallback
     ...
     * @param {String} [city] 
     * @param {module:api/StrainsversionApi~apiV20DatabaseStrainsversionGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    apiV20DatabaseStrainsversionGet(database, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'database' is set
      if (database === undefined || database === null) {
        throw new Error("Missing the required parameter 'database' when calling apiV20DatabaseStrainsversionGet");
      }
