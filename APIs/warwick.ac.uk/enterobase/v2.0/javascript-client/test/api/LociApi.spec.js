...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.LociApi();
  });
  ...
  describe('LociApi', function() {
    describe('apiV20DatabaseSchemeLociGet', function() {
      it('should call apiV20DatabaseSchemeLociGet successfully', function(done) {
        //uncomment below and update the code to test apiV20DatabaseSchemeLociGet
        //instance.apiV20DatabaseSchemeLociGet(function(error) {
