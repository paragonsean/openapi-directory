...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.AllelesApi();
  });
  ...
  describe('AllelesApi', function() {
    describe('apiV20DatabaseSchemeAllelesGet', function() {
      it('should call apiV20DatabaseSchemeAllelesGet successfully', function(done) {
        //uncomment below and update the code to test apiV20DatabaseSchemeAllelesGet
        //instance.apiV20DatabaseSchemeAllelesGet(function(error) {
