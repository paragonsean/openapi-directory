...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.StrainsversionApi();
  });
  ...
  describe('StrainsversionApi', function() {
    describe('apiV20DatabaseStrainsversionGet', function() {
      it('should call apiV20DatabaseStrainsversionGet successfully', function(done) {
        //uncomment below and update the code to test apiV20DatabaseStrainsversionGet
        //instance.apiV20DatabaseStrainsversionGet(function(error) {
