...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.StsApi();
  });
  ...
  describe('StsApi', function() {
    describe('apiV20DatabaseSchemeStsGet', function() {
      it('should call apiV20DatabaseSchemeStsGet successfully', function(done) {
        //uncomment below and update the code to test apiV20DatabaseSchemeStsGet
        //instance.apiV20DatabaseSchemeStsGet(function(error) {
