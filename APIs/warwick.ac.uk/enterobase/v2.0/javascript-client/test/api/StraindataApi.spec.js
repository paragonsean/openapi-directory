...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.StraindataApi();
  });
  ...
  describe('StraindataApi', function() {
    describe('apiV20DatabaseStraindataGet', function() {
      it('should call apiV20DatabaseStraindataGet successfully', function(done) {
        //uncomment below and update the code to test apiV20DatabaseStraindataGet
        //instance.apiV20DatabaseStraindataGet(function(error) {
