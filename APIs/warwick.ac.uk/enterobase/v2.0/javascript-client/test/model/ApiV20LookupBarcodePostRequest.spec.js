...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterobaseApi.ApiV20LookupBarcodePostRequest();
  });
  ...
  describe('ApiV20LookupBarcodePostRequest', function() {
    it('should create an instance of ApiV20LookupBarcodePostRequest', function() {
      // uncomment below and update the code to test ApiV20LookupBarcodePostRequest
      //var instance = new EnterobaseApi.ApiV20LookupBarcodePostRequest();
      //expect(instance).to.be.a(EnterobaseApi.ApiV20LookupBarcodePostRequest);
    });
