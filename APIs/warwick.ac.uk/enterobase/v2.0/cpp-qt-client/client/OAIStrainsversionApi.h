...
#ifndef OAI_OAIStrainsversionApi_H
#define OAI_OAIStrainsversionApi_H
...
class OAIStrainsversionApi : public QObject {
    Q_OBJECT

public:
    OAIStrainsversionApi(const int timeOut = 0);
    ~OAIStrainsversionApi();
...
private:
    ...
    void apiV20DatabaseStrainsversionGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV20DatabaseStrainsversionGetSignal();


    void apiV20DatabaseStrainsversionGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use apiV20DatabaseStrainsversionGetSignalError() instead")
    void apiV20DatabaseStrainsversionGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apiV20DatabaseStrainsversionGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV20DatabaseStrainsversionGetSignalErrorFull() instead")
    void apiV20DatabaseStrainsversionGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV20DatabaseStrainsversionGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
