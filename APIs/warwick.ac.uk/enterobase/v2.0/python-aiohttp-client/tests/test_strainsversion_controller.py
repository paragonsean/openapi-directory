...
async def test_api_v20_database_strainsversion_get(client):
    """Test case for api_v20_database_strainsversion_get
    ...
    response = await client.request(
        method='GET',
        path='/api/v2.0/{database}/strainsversion'.format(database='database_example'),
        headers=headers,
        params=params,
        )
