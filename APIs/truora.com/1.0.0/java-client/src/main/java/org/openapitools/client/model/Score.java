...
public class Score {
  public static final String SERIALIZED_NAME_BY_ID = "by_id";
  @SerializedName(SERIALIZED_NAME_BY_ID)
  private ScoreDetail byId;

  public static final String SERIALIZED_NAME_BY_NAME = "by_name";
  @SerializedName(SERIALIZED_NAME_BY_NAME)
  private ScoreDetail byName;
  ...
  public Score byId(ScoreDetail byId) {
    this.byId = byId;
    return this;
  }
  ...
  public ScoreDetail getById() {
    return byId;
  }

  public void setById(ScoreDetail byId) {
    this.byId = byId;
  }


  public Score byName(ScoreDetail byName) {
    this.byName = byName;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ScoreDetail getByName() {
    return byName;
  }

  public void setByName(ScoreDetail byName) {
    this.byName = byName;
  }


  public Score dataSet(DataSetEnum dataSet) {
  ...
  public Score result(ResultEnum result) {
    this.result = result;
    return this;
  }
  ...
  public Score score(Float score) {
    this.score = score;
    return this;
  }
  ...
  public Score severity(SeverityEnum severity) {
  ...
  public boolean equals(Object o) {
    ...
    Score score = (Score) o;
    return Objects.equals(this.byId, score.byId) &&
        Objects.equals(this.byName, score.byName) &&
        Objects.equals(this.dataSet, score.dataSet) &&
        Objects.equals(this.result, score.result) &&
        Objects.equals(this.score, score.score) &&
        Objects.equals(this.severity, score.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(byId, byName, dataSet, result, score, severity);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("by_id");
    openapiRequiredFields.add("by_name");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `by_id`
      ScoreDetail.validateJsonElement(jsonObj.get("by_id"));
      // validate the required field `by_name`
      ScoreDetail.validateJsonElement(jsonObj.get("by_name"));
      ...
      // validate the required field `data_set`
