...
public class User {
  ...
  public static final String SERIALIZED_NAME_USER_CREATION_DATE = "user_creation_date";
  @SerializedName(SERIALIZED_NAME_USER_CREATION_DATE)
  ...
  public User userCreationDate(String userCreationDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, user.email) &&
        ...
        Objects.equals(this.userCreationDate, user.userCreationDate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, enabled, userCreationDate, userStatus, username);
  }
  ...
  public String toString() {
    ...
    sb.append("    userCreationDate: ").append(toIndentedString(userCreationDate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("user_creation_date");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("user_creation_date") != null && !jsonObj.get("user_creation_date").isJsonNull()) && !jsonObj.get("user_creation_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `user_creation_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("user_creation_date").toString()));
      }
      ...
      // validate the optional field `user_status`
      if (jsonObj.get("user_status") != null && !jsonObj.get("user_status").isJsonNull()) {
        UserStatusEnum.validateJsonElement(jsonObj.get("user_status"));
      }
