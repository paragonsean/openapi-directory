...
public class Rule {
  ...
  public static final String SERIALIZED_NAME_OUTCOME_LABEL = "outcome_label";
  @SerializedName(SERIALIZED_NAME_OUTCOME_LABEL)
  ...
  public Rule level(LevelEnum level) {
    this.level = level;
    return this;
  }
  ...
  public Rule outcomeLabel(String outcomeLabel) {
  ...
  public Rule value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Rule rule = (Rule) o;
    return Objects.equals(this.level, rule.level) &&
        Objects.equals(this.operation, rule.operation) &&
        Objects.equals(this.outcomeLabel, rule.outcomeLabel) &&
        Objects.equals(this.value, rule.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(level, operation, outcomeLabel, value);
  }
  ...
  public String toString() {
    ...
    sb.append("    outcomeLabel: ").append(toIndentedString(outcomeLabel)).append("\n");
  ...
  static {
    ...
    openapiFields.add("outcome_label");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("outcome_label") != null && !jsonObj.get("outcome_label").isJsonNull()) && !jsonObj.get("outcome_label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `outcome_label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("outcome_label").toString()));
      }
  }
