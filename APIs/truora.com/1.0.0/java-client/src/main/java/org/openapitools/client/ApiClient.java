...
public class ApiClient {
    ...
    private String basePath = "https://api.truora.com";
    ...
    public ApiClient() {
        ...
        authentications.put("api-key", new ApiKeyAuth("header", "Truora-API-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.truora.com
