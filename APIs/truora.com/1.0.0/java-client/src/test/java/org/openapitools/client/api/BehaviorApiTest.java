...
public class BehaviorApiTest {
     ...
     */
    @Test
    public void reportBehaviorTest() throws ApiException {
        OffsetDateTime birthDate = null;
        String country = null;
        String documentId = null;
        String documentType = null;
        String email = null;
        OffsetDateTime feedbackDate = null;
        String firstName = null;
        String lastName = null;
        String reason = null;
        String phoneNumber = null;
        BehaviourOutput response = api.reportBehavior(birthDate, country, documentId, documentType, email, feedbackDate, firstName, lastName, reason, phoneNumber);
