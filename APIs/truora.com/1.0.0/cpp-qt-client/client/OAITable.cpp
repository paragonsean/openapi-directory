...
QList<OAITableRow> OAITable::getRows() const {
    return m_rows;
}
void OAITable::setRows(const QList<OAITableRow> &rows) {
    m_rows = rows;
    m_rows_isSet = true;
}
...
QString OAITable::getTitle() const {
    return m_title;
}
void OAITable::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAITable::is_title_Set() const{
    return m_title_isSet;
}

bool OAITable::is_title_Valid() const{
...
bool OAITable::isValid() const {
    ...
    return m_rows_isValid && m_title_isValid && true;
}
