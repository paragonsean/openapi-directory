...
/*
 * OAIUpdateAPIKeyInput.h
 *
 * Represents the input required to update an API key
 */

#ifndef OAIUpdateAPIKeyInput_H
#define OAIUpdateAPIKeyInput_H
...
class OAIUpdateAPIKeyInput : public OAIObject {
public:
    OAIUpdateAPIKeyInput();
    OAIUpdateAPIKeyInput(QString json);
    ~OAIUpdateAPIKeyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAPIKeyInput)

#endif // OAIUpdateAPIKeyInput_H
