...
#ifndef OAIScoreDetail_H
#define OAIScoreDetail_H
...
class OAIScoreDetail : public OAIObject {
public:
    OAIScoreDetail();
    OAIScoreDetail(QString json);
    ~OAIScoreDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreDetail)

#endif // OAIScoreDetail_H
