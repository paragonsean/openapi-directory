...
public:
    ...
    QString getOutcomeLabel() const;
    void setOutcomeLabel(const QString &outcome_label);
    bool is_outcome_label_Set() const;
    bool is_outcome_label_Valid() const;
...
private:
    ...
    QString m_outcome_label;
    bool m_outcome_label_isSet;
    bool m_outcome_label_isValid;
