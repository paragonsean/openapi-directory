...
QString OAITableCell::getLabel() const {
    return m_label;
}
void OAITableCell::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAITableCell::is_label_Set() const{
    return m_label_isSet;
}

bool OAITableCell::is_label_Valid() const{
