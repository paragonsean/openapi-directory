...
#ifndef OAICommentsOutput_H
#define OAICommentsOutput_H
...
class OAICommentsOutput : public OAIObject {
public:
    OAICommentsOutput();
    OAICommentsOutput(QString json);
    ~OAICommentsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentsOutput)

#endif // OAICommentsOutput_H
