...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("batchUpload", defaultConf);
    _serverIndices.insert("batchUpload", 0);
    _serverConfigs.insert("createReport", defaultConf);
    _serverIndices.insert("createReport", 0);
...
void OAIReportsApi::batchUpload(const QString &report_id, const QList<OAIHttpFileElement> &file) {
    QString fullPath = QString(_serverConfigs["batchUpload"][_serverIndices.value("batchUpload")].URL()+"/v1/reports/{report_id}/upload");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::batchUploadCallback);
...
void OAIReportsApi::batchUploadCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIReportOutput output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT batchUploadSignal(output);
        Q_EMIT batchUploadSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT batchUploadSignalE(output, error_type, error_str);
        Q_EMIT batchUploadSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT batchUploadSignalError(output, error_type, error_str);
        Q_EMIT batchUploadSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportsApi::createReport(const QString &name) {
    QString fullPath = QString(_serverConfigs["createReport"][_serverIndices.value("createReport")].URL()+"/v1/reports");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::createReportCallback);
    connect(this, &OAIReportsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportsApi::createReportCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createReportSignal(output);
        Q_EMIT createReportSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createReportSignalE(output, error_type, error_str);
        Q_EMIT createReportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createReportSignalError(output, error_type, error_str);
        Q_EMIT createReportSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportsApi::getReport(const QString &report_id) {
    QString fullPath = QString(_serverConfigs["getReport"][_serverIndices.value("getReport")].URL()+"/v1/reports/{report_id}");
...
void OAIReportsApi::listReports(const ::OpenAPI::OptionalParam<QString> &start_key, const ::OpenAPI::OptionalParam<QString> &username) {
    QString fullPath = QString(_serverConfigs["listReports"][_serverIndices.value("listReports")].URL()+"/v1/reports");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::listReportsCallback);
    connect(this, &OAIReportsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportsApi::listReportsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIReportsOutput output(QString(worker->response));
    worker->deleteLater();
