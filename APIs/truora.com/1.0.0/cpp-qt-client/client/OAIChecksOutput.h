...
#ifndef OAIChecksOutput_H
#define OAIChecksOutput_H
...
class OAIChecksOutput : public OAIObject {
public:
    OAIChecksOutput();
    OAIChecksOutput(QString json);
    ~OAIChecksOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChecksOutput)

#endif // OAIChecksOutput_H
