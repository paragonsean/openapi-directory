...
#ifndef OAICheckDetails_H
#define OAICheckDetails_H
...
class OAICheckDetails : public OAIObject {
public:
    OAICheckDetails();
    OAICheckDetails(QString json);
    ~OAICheckDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckDetails)

#endif // OAICheckDetails_H
