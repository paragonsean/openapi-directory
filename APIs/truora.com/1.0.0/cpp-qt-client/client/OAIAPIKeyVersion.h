...
#ifndef OAIAPIKeyVersion_H
#define OAIAPIKeyVersion_H
...
namespace OpenAPI {
class OAIAPIKeyVersionChangelog;

class OAIAPIKeyVersion : public OAIObject {
public:
    OAIAPIKeyVersion();
    OAIAPIKeyVersion(QString json);
    ~OAIAPIKeyVersion() override;
    ...
    OAIAPIKeyVersionChangelog getChangelog() const;
    void setChangelog(const OAIAPIKeyVersionChangelog &changelog);
...
private:
    ...
    OAIAPIKeyVersionChangelog m_changelog;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIKeyVersion)

#endif // OAIAPIKeyVersion_H
