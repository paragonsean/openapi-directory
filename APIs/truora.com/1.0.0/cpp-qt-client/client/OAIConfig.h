...
public:
    ...
    OAIScoreConfig getScoreConfig() const;
    void setScoreConfig(const OAIScoreConfig &score_config);
    bool is_score_config_Set() const;
    bool is_score_config_Valid() const;
...
private:
    ...
    OAIScoreConfig m_score_config;
    bool m_score_config_isSet;
    bool m_score_config_isValid;
};
