...
QList<OAITableCell> OAITableRow::getCells() const {
    return m_cells;
}
void OAITableRow::setCells(const QList<OAITableCell> &cells) {
    m_cells = cells;
    m_cells_isSet = true;
}

bool OAITableRow::is_cells_Set() const{
    return m_cells_isSet;
}

bool OAITableRow::is_cells_Valid() const{
