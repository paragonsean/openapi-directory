...
#ifndef OAIScoreConfig_H
#define OAIScoreConfig_H
...
class OAIScoreConfig : public OAIObject {
public:
    OAIScoreConfig();
    OAIScoreConfig(QString json);
    ~OAIScoreConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreConfig)

#endif // OAIScoreConfig_H
