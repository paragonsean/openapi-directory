...
#ifndef OAIReportOutput_H
#define OAIReportOutput_H
...
class OAIReportOutput : public OAIObject {
public:
    OAIReportOutput();
    OAIReportOutput(QString json);
    ~OAIReportOutput() override;
    ...
    OAIReport getReport() const;
    void setReport(const OAIReport &report);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportOutput)

#endif // OAIReportOutput_H
