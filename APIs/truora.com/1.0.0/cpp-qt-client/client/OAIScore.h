...
public:
    ...
    OAIScoreDetail getById() const;
    void setById(const OAIScoreDetail &by_id);
    bool is_by_id_Set() const;
    bool is_by_id_Valid() const;

    OAIScoreDetail getByName() const;
    void setByName(const OAIScoreDetail &by_name);
    bool is_by_name_Set() const;
    bool is_by_name_Valid() const;
...
private:
    ...
    OAIScoreDetail m_by_id;
    bool m_by_id_isSet;
    bool m_by_id_isValid;

    OAIScoreDetail m_by_name;
    bool m_by_name_isSet;
    bool m_by_name_isValid;
