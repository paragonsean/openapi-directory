...
/*
 * OAICreateUserInput.h
 *
 * Represents the inputs required to create a user for an API-key version
 */

#ifndef OAICreateUserInput_H
#define OAICreateUserInput_H
...
class OAICreateUserInput : public OAIObject {
public:
    OAICreateUserInput();
    OAICreateUserInput(QString json);
    ~OAICreateUserInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserInput)

#endif // OAICreateUserInput_H
