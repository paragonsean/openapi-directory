...
#ifndef OAIBehavior_H
#define OAIBehavior_H
...
class OAIBehavior : public OAIObject {
public:
    OAIBehavior();
    OAIBehavior(QString json);
    ~OAIBehavior() override;
    ...
    QDate getFeedbackDate() const;
    void setFeedbackDate(const QDate &feedback_date);
    bool is_feedback_date_Set() const;
    bool is_feedback_date_Valid() const;
...
private:
    ...
    QDate m_feedback_date;
    bool m_feedback_date_isSet;
    bool m_feedback_date_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBehavior)
