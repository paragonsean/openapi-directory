...
#ifndef OAICheckOutput_H
#define OAICheckOutput_H
...
class OAICheckOutput : public OAIObject {
public:
    OAICheckOutput();
    OAICheckOutput(QString json);
    ~OAICheckOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckOutput)

#endif // OAICheckOutput_H
