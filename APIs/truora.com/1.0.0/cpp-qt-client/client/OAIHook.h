...
public:
    ...
    QString getSubscriberType() const;
    void setSubscriberType(const QString &subscriber_type);
    bool is_subscriber_type_Set() const;
    bool is_subscriber_type_Valid() const;

    QString getSubscriberUrl() const;
    void setSubscriberUrl(const QString &subscriber_url);
    bool is_subscriber_url_Set() const;
    bool is_subscriber_url_Valid() const;
...
private:
    ...
    QString m_subscriber_type;
    bool m_subscriber_type_isSet;
    bool m_subscriber_type_isValid;

    QString m_subscriber_url;
    bool m_subscriber_url_isSet;
    bool m_subscriber_url_isValid;
};
