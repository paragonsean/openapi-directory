...
public:
    ...
    QList<QString> getInvalidInputs() const;
    void setInvalidInputs(const QList<QString> &invalid_inputs);
    bool is_invalid_inputs_Set() const;
    bool is_invalid_inputs_Valid() const;
...
private:
    ...
    QList<QString> m_invalid_inputs;
    bool m_invalid_inputs_isSet;
    bool m_invalid_inputs_isValid;
