...
void OAIDatabase::initializeModel() {
    ...
    m_hourly_status_isSet = false;
    m_hourly_status_isValid = false;
}
...
void OAIDatabase::fromJsonObject(QJsonObject json) {
    ...
    m_data_sets_isValid = ::OpenAPI::fromJsonValue(m_data_sets, json[QString("data_sets")]);
    m_data_sets_isSet = !json[QString("data_sets")].isNull() && m_data_sets_isValid;
    ...
    m_hourly_status_isValid = ::OpenAPI::fromJsonValue(m_hourly_status, json[QString("hourly_status")]);
    m_hourly_status_isSet = !json[QString("hourly_status")].isNull() && m_hourly_status_isValid;
}
...
QJsonObject OAIDatabase::asJsonObject() const {
    ...
    if (m_data_sets.size() > 0) {
        obj.insert(QString("data_sets"), ::OpenAPI::toJsonValue(m_data_sets));
    }
    ...
    if (m_hourly_status.size() > 0) {
        obj.insert(QString("hourly_status"), ::OpenAPI::toJsonValue(m_hourly_status));
    }
    return obj;
}

QList<QString> OAIDatabase::getDataSets() const {
    return m_data_sets;
}
void OAIDatabase::setDataSets(const QList<QString> &data_sets) {
    m_data_sets = data_sets;
    m_data_sets_isSet = true;
}

bool OAIDatabase::is_data_sets_Set() const{
    return m_data_sets_isSet;
}

bool OAIDatabase::is_data_sets_Valid() const{
...
QList<QString> OAIDatabase::getHourlyStatus() const {
    return m_hourly_status;
}
void OAIDatabase::setHourlyStatus(const QList<QString> &hourly_status) {
    m_hourly_status = hourly_status;
    m_hourly_status_isSet = true;
}

bool OAIDatabase::is_hourly_status_Set() const{
    return m_hourly_status_isSet;
}

bool OAIDatabase::is_hourly_status_Valid() const{
    return m_hourly_status_isValid;
}
