...
#ifndef OAIHookOutput_H
#define OAIHookOutput_H
...
class OAIHookOutput : public OAIObject {
public:
    OAIHookOutput();
    OAIHookOutput(QString json);
    ~OAIHookOutput() override;
    ...
    QList<OAIHook> getHooks() const;
    void setHooks(const QList<OAIHook> &hooks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHookOutput)

#endif // OAIHookOutput_H
