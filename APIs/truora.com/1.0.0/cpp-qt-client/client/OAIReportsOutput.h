...
#ifndef OAIReportsOutput_H
#define OAIReportsOutput_H
...
class OAIReportsOutput : public OAIObject {
public:
    OAIReportsOutput();
    OAIReportsOutput(QString json);
    ~OAIReportsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportsOutput)

#endif // OAIReportsOutput_H
