...
public:
    ...
    QString getApiKeyPreviousVersion() const;
    void setApiKeyPreviousVersion(const QString &api_key_previous_version);
    bool is_api_key_previous_version_Set() const;
    bool is_api_key_previous_version_Valid() const;
    ...
    QString getUserKeyName() const;
    void setUserKeyName(const QString &user_key_name);
    bool is_user_key_name_Set() const;
    bool is_user_key_name_Valid() const;
...
private:
    ...
    QString m_api_key_previous_version;
    bool m_api_key_previous_version_isSet;
    bool m_api_key_previous_version_isValid;
    ...
    QString m_user_key_name;
    bool m_user_key_name_isSet;
    bool m_user_key_name_isValid;
};
