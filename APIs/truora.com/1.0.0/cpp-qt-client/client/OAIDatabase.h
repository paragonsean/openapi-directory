...
public:
    ...
    void setDataSets(const QList<QString> &data_sets);
    ...
    QList<QString> getHourlyStatus() const;
    void setHourlyStatus(const QList<QString> &hourly_status);
    bool is_hourly_status_Set() const;
    bool is_hourly_status_Valid() const;
...
private:
    ...
    QList<QString> m_hourly_status;
    bool m_hourly_status_isSet;
    bool m_hourly_status_isValid;
};
