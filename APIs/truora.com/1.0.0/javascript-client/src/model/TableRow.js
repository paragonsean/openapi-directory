...
class TableRow {
     ...
     * @param cells {Array.<module:model/TableCell>} Row cells
     */
    constructor(cells) { 
        
        TableRow.initialize(this, cells);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cells')) {
                obj['cells'] = ApiClient.convertToType(data['cells'], [TableCell]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TableRow.RequiredProperties) {
...
TableRow.RequiredProperties = ["cells"];

/**
 * Row cells
 * @member {Array.<module:model/TableCell>} cells
 */
