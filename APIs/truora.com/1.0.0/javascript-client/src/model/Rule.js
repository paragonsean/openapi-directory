...
class Rule {
     ...
     * @param level {module:model/Rule.LevelEnum} Rule nature
     * @param operation {module:model/Rule.OperationEnum} Comparison between the rule and score values
     * @param value {Number} Rule value
     */
    constructor(level, operation, value) { 
        
        Rule.initialize(this, level, operation, value);
    }
     ...
     */
    static initialize(obj, level, operation, value) { 
        obj['level'] = level;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('outcome_label')) {
                obj['outcome_label'] = ApiClient.convertToType(data['outcome_label'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['outcome_label'] && !(typeof data['outcome_label'] === 'string' || data['outcome_label'] instanceof String)) {
            throw new Error("Expected the field `outcome_label` to be a primitive type in the JSON string but got " + data['outcome_label']);
        }
...
Rule.RequiredProperties = ["level", "operation", "value"];

/**
 * Rule nature
 * @member {module:model/Rule.LevelEnum} level
 */
Rule.prototype['level'] = undefined;
 ...
 * @member {String} outcome_label
 */
Rule.prototype['outcome_label'] = undefined;
