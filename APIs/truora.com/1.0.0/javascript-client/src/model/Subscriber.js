...
class Subscriber {
     ...
     * @param url {String} Link where notification requests will be sent in case subscriber_type is web
     */
    constructor(url) { 
        
        Subscriber.initialize(this, url);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Subscriber.RequiredProperties) {
