...
class TableCell {
     ...
     * @param label {String} Cell label
     * @param value {String} Cell value
     */
    constructor(label, value) { 
        
        TableCell.initialize(this, label, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TableCell.RequiredProperties) {
...
TableCell.RequiredProperties = ["label", "value"];

/**
 * Cell label
 * @member {String} label
 */
TableCell.prototype['label'] = undefined;
