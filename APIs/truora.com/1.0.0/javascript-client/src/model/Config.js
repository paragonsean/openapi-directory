...
class Config {
     ...
     * @param scoreConfig {module:model/ScoreConfig} 
     */
    constructor(clientId, configId, scoreConfig) { 
        
        Config.initialize(this, clientId, configId, scoreConfig);
    }
     ...
     */
    static initialize(obj, clientId, configId, scoreConfig) { 
        obj['client_id'] = clientId;
        obj['config_id'] = configId;
        obj['score_config'] = scoreConfig;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('score_config')) {
                obj['score_config'] = ScoreConfig.constructFromObject(data['score_config']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `score_config`
        if (data['score_config']) { // data not null
          ScoreConfig.validateJSON(data['score_config']);
        }
...
Config.RequiredProperties = ["client_id", "config_id", "score_config"];

/**
 * Client ID
 * @member {String} client_id
 */
Config.prototype['client_id'] = undefined;

/**
 * Configuration ID
 * @member {String} config_id
 */
Config.prototype['config_id'] = undefined;

/**
 * @member {module:model/ScoreConfig} score_config
 */
Config.prototype['score_config'] = undefined;
