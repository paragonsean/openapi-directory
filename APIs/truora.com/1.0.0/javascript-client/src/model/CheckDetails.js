...
/**
 * The CheckDetails model module.
 * @module model/CheckDetails
 * @version 1.0.0
 */
class CheckDetails {
    /**
     * Constructs a new <code>CheckDetails</code>.
     * Represents background check details
     * @alias module:model/CheckDetails
     * @param checkId {String} Associated background check ID
     * @param dataSet {String} Details dataset
     * @param databaseName {String} Database name. Do not use this field to identify the database as its value may vary as the check is completed
     * @param group {module:model/CheckDetails.GroupEnum} table group type
     * @param id {String} Detail ID
     * @param result {module:model/CheckDetails.ResultEnum} Database result
     * @param score {Number} Partial detail score. Scores are aggregated later in the background check
     * @param tables {Array.<module:model/Table>} Query detailed information
     */
    constructor(checkId, dataSet, databaseName, group, id, result, score, tables) { 
        
        CheckDetails.initialize(this, checkId, dataSet, databaseName, group, id, result, score, tables);
    }
     ...
     */
    static initialize(obj, checkId, dataSet, databaseName, group, id, result, score, tables) { 
    ...
    /**
     * Constructs a <code>CheckDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CheckDetails} obj Optional instance to populate.
     * @return {module:model/CheckDetails} The populated <code>CheckDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CheckDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>CheckDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CheckDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CheckDetails.RequiredProperties) {
...
CheckDetails.RequiredProperties = ["check_id", "data_set", "database_name", "group", "id", "result", "score", "tables"];

/**
 * Associated background check ID
 * @member {String} check_id
 */
CheckDetails.prototype['check_id'] = undefined;

/**
 * Details dataset
 * @member {String} data_set
 */
CheckDetails.prototype['data_set'] = undefined;
 ...
 */
CheckDetails.prototype['database_name'] = undefined;

/**
 * table group type
 * @member {module:model/CheckDetails.GroupEnum} group
 */
CheckDetails.prototype['group'] = undefined;

/**
 * Detail ID
 * @member {String} id
 */
CheckDetails.prototype['id'] = undefined;

/**
 * Database result
 * @member {module:model/CheckDetails.ResultEnum} result
 */
CheckDetails.prototype['result'] = undefined;

/**
 * Partial detail score. Scores are aggregated later in the background check
 * @member {Number} score
 */
CheckDetails.prototype['score'] = undefined;

/**
 * Query detailed information
 * @member {Array.<module:model/Table>} tables
 */
CheckDetails.prototype['tables'] = undefined;
