...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChecksApi.APIKeyVersion();
  });
  ...
  describe('APIKeyVersion', function() {
    it('should create an instance of APIKeyVersion', function() {
      // uncomment below and update the code to test APIKeyVersion
      //var instance = new ChecksApi.APIKeyVersion();
      //expect(instance).to.be.a(ChecksApi.APIKeyVersion);
    });
