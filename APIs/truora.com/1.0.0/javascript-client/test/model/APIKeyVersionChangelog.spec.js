...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChecksApi.APIKeyVersionChangelog();
  });
  ...
  describe('APIKeyVersionChangelog', function() {
    it('should create an instance of APIKeyVersionChangelog', function() {
      // uncomment below and update the code to test APIKeyVersionChangelog
      //var instance = new ChecksApi.APIKeyVersionChangelog();
      //expect(instance).to.be.a(ChecksApi.APIKeyVersionChangelog);
    });
