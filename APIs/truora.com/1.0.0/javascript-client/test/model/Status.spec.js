...
(function(root, factory) {
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new ChecksApi.Status();
      //expect(instance).to.be.a(ChecksApi.Status);
    });
    ...
    it('should have the property invalidInputs (base name: "invalid_inputs")', function() {
      // uncomment below and update the code to test the property invalidInputs
      //var instance = new ChecksApi.Status();
      //expect(instance).to.be();
    });
