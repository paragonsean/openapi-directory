...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChecksApi.ReportsApi();
  });
  ...
  describe('ReportsApi', function() {
    describe('batchUpload', function() {
      it('should call batchUpload successfully', function(done) {
        //uncomment below and update the code to test batchUpload
        //instance.batchUpload(function(error) {
