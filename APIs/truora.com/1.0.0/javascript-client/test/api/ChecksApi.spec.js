...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChecksApi.ChecksApi();
  });
  ...
  describe('ChecksApi', function() {
    ...
    describe('getCheck', function() {
      it('should call getCheck successfully', function(done) {
        //uncomment below and update the code to test getCheck
        //instance.getCheck(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getHealthDashboard', function() {
      it('should call getHealthDashboard successfully', function(done) {
        //uncomment below and update the code to test getHealthDashboard
        //instance.getHealthDashboard(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
