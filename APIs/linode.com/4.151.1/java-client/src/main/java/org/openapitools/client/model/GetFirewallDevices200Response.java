...
public class GetFirewallDevices200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<FirewallDevices> data = new ArrayList<>();
  ...
  public GetFirewallDevices200Response() {
  }
  ...
  public GetFirewallDevices200Response data(List<FirewallDevices> data) {
    this.data = data;
    return this;
  }

  public GetFirewallDevices200Response addDataItem(FirewallDevices dataItem) {
    if (this.data == null) {
  ...
  public List<FirewallDevices> getData() {
    return data;
  }

  public void setData(List<FirewallDevices> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetFirewallDevices200Response getFirewallDevices200Response = (GetFirewallDevices200Response) o;
    return Objects.equals(this.data, getFirewallDevices200Response.data) &&
        Objects.equals(this.page, getFirewallDevices200Response.page) &&
        Objects.equals(this.pages, getFirewallDevices200Response.pages) &&
        Objects.equals(this.results, getFirewallDevices200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFirewallDevices200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFirewallDevices200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFirewallDevices200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFirewallDevices200Response is not found in the empty JSON string", GetFirewallDevices200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFirewallDevices200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFirewallDevices200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            FirewallDevices.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFirewallDevices200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFirewallDevices200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFirewallDevices200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFirewallDevices200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFirewallDevices200Response>() {
           @Override
           public void write(JsonWriter out, GetFirewallDevices200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFirewallDevices200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFirewallDevices200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFirewallDevices200Response
   * @throws IOException if the JSON string is invalid with respect to GetFirewallDevices200Response
   */
  public static GetFirewallDevices200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFirewallDevices200Response.class);
  }

  /**
   * Convert an instance of GetFirewallDevices200Response to an JSON string
   *
   * @return JSON string
   */
