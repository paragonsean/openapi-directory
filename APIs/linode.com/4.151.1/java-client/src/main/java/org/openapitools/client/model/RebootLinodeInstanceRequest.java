...
public class RebootLinodeInstanceRequest {
  public static final String SERIALIZED_NAME_CONFIG_ID = "config_id";
  @SerializedName(SERIALIZED_NAME_CONFIG_ID)
  private Integer configId;

  public RebootLinodeInstanceRequest() {
  }

  public RebootLinodeInstanceRequest configId(Integer configId) {
  ...
  public boolean equals(Object o) {
    ...
    RebootLinodeInstanceRequest rebootLinodeInstanceRequest = (RebootLinodeInstanceRequest) o;
    return Objects.equals(this.configId, rebootLinodeInstanceRequest.configId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RebootLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebootLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebootLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RebootLinodeInstanceRequest is not found in the empty JSON string", RebootLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RebootLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RebootLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RebootLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RebootLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RebootLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RebootLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RebootLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, RebootLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RebootLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RebootLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RebootLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to RebootLinodeInstanceRequest
   */
  public static RebootLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RebootLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of RebootLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
