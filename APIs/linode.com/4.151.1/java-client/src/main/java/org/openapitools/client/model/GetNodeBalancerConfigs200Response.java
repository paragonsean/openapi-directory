...
public class GetNodeBalancerConfigs200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<NodeBalancerConfig> data = new ArrayList<>();
  ...
  public GetNodeBalancerConfigs200Response() {
  }
  ...
  public GetNodeBalancerConfigs200Response data(List<NodeBalancerConfig> data) {
    this.data = data;
    return this;
  }

  public GetNodeBalancerConfigs200Response addDataItem(NodeBalancerConfig dataItem) {
    if (this.data == null) {
  ...
  public List<NodeBalancerConfig> getData() {
    return data;
  }

  public void setData(List<NodeBalancerConfig> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetNodeBalancerConfigs200Response getNodeBalancerConfigs200Response = (GetNodeBalancerConfigs200Response) o;
    return Objects.equals(this.data, getNodeBalancerConfigs200Response.data) &&
        Objects.equals(this.page, getNodeBalancerConfigs200Response.page) &&
        Objects.equals(this.pages, getNodeBalancerConfigs200Response.pages) &&
        Objects.equals(this.results, getNodeBalancerConfigs200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetNodeBalancerConfigs200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetNodeBalancerConfigs200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetNodeBalancerConfigs200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNodeBalancerConfigs200Response is not found in the empty JSON string", GetNodeBalancerConfigs200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetNodeBalancerConfigs200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetNodeBalancerConfigs200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            NodeBalancerConfig.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNodeBalancerConfigs200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNodeBalancerConfigs200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetNodeBalancerConfigs200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetNodeBalancerConfigs200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetNodeBalancerConfigs200Response>() {
           @Override
           public void write(JsonWriter out, GetNodeBalancerConfigs200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetNodeBalancerConfigs200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetNodeBalancerConfigs200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetNodeBalancerConfigs200Response
   * @throws IOException if the JSON string is invalid with respect to GetNodeBalancerConfigs200Response
   */
  public static GetNodeBalancerConfigs200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNodeBalancerConfigs200Response.class);
  }

  /**
   * Convert an instance of GetNodeBalancerConfigs200Response to an JSON string
   *
   * @return JSON string
   */
