...
public class Vlans {
  ...
  /**
   * This VLAN&#39;s data center region.  **Note:** Currently, a VLAN can only be assigned to a Linode within the same data center region. 
   * @return region
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    Vlans vlans = (Vlans) o;
    return Objects.equals(this.created, vlans.created) &&
        Objects.equals(this.label, vlans.label) &&
        Objects.equals(this.linodes, vlans.linodes) &&
        Objects.equals(this.region, vlans.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, label, linodes, region);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Vlans {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vlans
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vlans.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vlans is not found in the empty JSON string", Vlans.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vlans.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vlans` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vlans.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vlans' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vlans> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vlans.class));

       return (TypeAdapter<T>) new TypeAdapter<Vlans>() {
           @Override
           public void write(JsonWriter out, Vlans value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vlans read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vlans given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vlans
   * @throws IOException if the JSON string is invalid with respect to Vlans
   */
  public static Vlans fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vlans.class);
  }

  /**
   * Convert an instance of Vlans to an JSON string
   *
   * @return JSON string
   */
