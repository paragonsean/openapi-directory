...
public class GetDatabasesMySQLInstances200Response {
  ...
  private List<DatabaseMySQL> data = new ArrayList<>();

  public GetDatabasesMySQLInstances200Response() {
  }
  ...
  public GetDatabasesMySQLInstances200Response data(List<DatabaseMySQL> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesMySQLInstances200Response addDataItem(DatabaseMySQL dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseMySQL> getData() {
    return data;
  }

  public void setData(List<DatabaseMySQL> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesMySQLInstances200Response getDatabasesMySQLInstances200Response = (GetDatabasesMySQLInstances200Response) o;
    return Objects.equals(this.page, getDatabasesMySQLInstances200Response.page) &&
        Objects.equals(this.pages, getDatabasesMySQLInstances200Response.pages) &&
        Objects.equals(this.results, getDatabasesMySQLInstances200Response.results) &&
        Objects.equals(this.data, getDatabasesMySQLInstances200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesMySQLInstances200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesMySQLInstances200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesMySQLInstances200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesMySQLInstances200Response is not found in the empty JSON string", GetDatabasesMySQLInstances200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesMySQLInstances200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesMySQLInstances200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabaseMySQL.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesMySQLInstances200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesMySQLInstances200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesMySQLInstances200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesMySQLInstances200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesMySQLInstances200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesMySQLInstances200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesMySQLInstances200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesMySQLInstances200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesMySQLInstances200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesMySQLInstances200Response
   */
  public static GetDatabasesMySQLInstances200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesMySQLInstances200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesMySQLInstances200Response to an JSON string
   *
   * @return JSON string
   */
