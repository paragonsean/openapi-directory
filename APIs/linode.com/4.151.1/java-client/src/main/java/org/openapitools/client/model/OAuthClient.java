...
public class OAuthClient {
  ...
  public OAuthClient label(String label) {
    this.label = label;
    return this;
  }
  ...
  public OAuthClient _public(Boolean _public) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, oauthClient.id) &&
        Objects.equals(this.label, oauthClient.label) &&
        Objects.equals(this._public, oauthClient._public) &&
        ...
        Objects.equals(this.thumbnailUrl, oauthClient.thumbnailUrl);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, label, _public, redirectUri, secret, status, thumbnailUrl);
  }
