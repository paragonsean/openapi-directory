...
import org.openapitools.client.model.LongviewSubscriptionPrice;
...
public class LongviewSubscription {
  public static final String SERIALIZED_NAME_CLIENTS_INCLUDED = "clients_included";
  @SerializedName(SERIALIZED_NAME_CLIENTS_INCLUDED)
  private Integer clientsIncluded;
  ...
  private LongviewSubscriptionPrice price;

  public LongviewSubscription() {
  }

  public LongviewSubscription(
     Integer clientsIncluded, 
     IdEnum id, 
     String label
  ) {
    this();
  ...
  public Integer getClientsIncluded() {
    return clientsIncluded;
  }
  ...
  public LongviewSubscription price(LongviewSubscriptionPrice price) {
    this.price = price;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LongviewSubscriptionPrice getPrice() {
    return price;
  }

  public void setPrice(LongviewSubscriptionPrice price) {
    this.price = price;
  }
  ...
  public boolean equals(Object o) {
    ...
    LongviewSubscription longviewSubscription = (LongviewSubscription) o;
    return Objects.equals(this.clientsIncluded, longviewSubscription.clientsIncluded) &&
        Objects.equals(this.id, longviewSubscription.id) &&
        Objects.equals(this.label, longviewSubscription.label) &&
        Objects.equals(this.price, longviewSubscription.price);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientsIncluded, id, label, price);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LongviewSubscription {\n");
    sb.append("    clientsIncluded: ").append(toIndentedString(clientsIncluded)).append("\n");
  ...
  static {
    ...
    openapiFields.add("clients_included");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongviewSubscription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongviewSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongviewSubscription is not found in the empty JSON string", LongviewSubscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongviewSubscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongviewSubscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("price") != null && !jsonObj.get("price").isJsonNull()) {
        LongviewSubscriptionPrice.validateJsonElement(jsonObj.get("price"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongviewSubscription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongviewSubscription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongviewSubscription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongviewSubscription.class));

       return (TypeAdapter<T>) new TypeAdapter<LongviewSubscription>() {
           @Override
           public void write(JsonWriter out, LongviewSubscription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongviewSubscription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongviewSubscription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongviewSubscription
   * @throws IOException if the JSON string is invalid with respect to LongviewSubscription
   */
  public static LongviewSubscription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongviewSubscription.class);
  }

  /**
   * Convert an instance of LongviewSubscription to an JSON string
   *
   * @return JSON string
   */
