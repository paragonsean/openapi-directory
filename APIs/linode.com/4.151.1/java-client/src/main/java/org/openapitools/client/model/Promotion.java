...
public class Promotion {
  public static final String SERIALIZED_NAME_CREDIT_MONTHLY_CAP = "credit_monthly_cap";
  @SerializedName(SERIALIZED_NAME_CREDIT_MONTHLY_CAP)
  private String creditMonthlyCap;

  public static final String SERIALIZED_NAME_CREDIT_REMAINING = "credit_remaining";
  @SerializedName(SERIALIZED_NAME_CREDIT_REMAINING)
  private String creditRemaining;

  public static final String SERIALIZED_NAME_DESCRIPTION = "description";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION)
  private String description;

  public static final String SERIALIZED_NAME_EXPIRE_DT = "expire_dt";
  @SerializedName(SERIALIZED_NAME_EXPIRE_DT)
  ...
  public static final String SERIALIZED_NAME_THIS_MONTH_CREDIT_REMAINING = "this_month_credit_remaining";
  @SerializedName(SERIALIZED_NAME_THIS_MONTH_CREDIT_REMAINING)
  private String thisMonthCreditRemaining;

  public Promotion() {
  }

  public Promotion creditMonthlyCap(String creditMonthlyCap) {
    this.creditMonthlyCap = creditMonthlyCap;
    return this;
  }

  /**
   * The amount available to spend per month. 
   * @return creditMonthlyCap
   */
  @javax.annotation.Nullable
  public String getCreditMonthlyCap() {
    return creditMonthlyCap;
  }

  public void setCreditMonthlyCap(String creditMonthlyCap) {
    this.creditMonthlyCap = creditMonthlyCap;
  }


  public Promotion creditRemaining(String creditRemaining) {
  ...
  public void setCreditRemaining(String creditRemaining) {
    this.creditRemaining = creditRemaining;
  }
  ...
  public Promotion expireDt(String expireDt) {
  ...
  public Promotion serviceType(ServiceTypeEnum serviceType) {
  ...
  public Promotion summary(String summary) {
  ...
  public Promotion thisMonthCreditRemaining(String thisMonthCreditRemaining) {
    this.thisMonthCreditRemaining = thisMonthCreditRemaining;
    return this;
  }

  /**
   * The amount of credit left for this month for this promotion. 
   * @return thisMonthCreditRemaining
   */
  @javax.annotation.Nullable
  public String getThisMonthCreditRemaining() {
    return thisMonthCreditRemaining;
  }

  public void setThisMonthCreditRemaining(String thisMonthCreditRemaining) {
    this.thisMonthCreditRemaining = thisMonthCreditRemaining;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creditMonthlyCap, promotion.creditMonthlyCap) &&
        Objects.equals(this.creditRemaining, promotion.creditRemaining) &&
        Objects.equals(this.description, promotion.description) &&
        Objects.equals(this.expireDt, promotion.expireDt) &&
        Objects.equals(this.imageUrl, promotion.imageUrl) &&
        Objects.equals(this.serviceType, promotion.serviceType) &&
        Objects.equals(this.summary, promotion.summary) &&
        Objects.equals(this.thisMonthCreditRemaining, promotion.thisMonthCreditRemaining);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creditMonthlyCap, creditRemaining, description, expireDt, imageUrl, serviceType, summary, thisMonthCreditRemaining);
  }
  ...
  public String toString() {
    ...
    sb.append("    creditMonthlyCap: ").append(toIndentedString(creditMonthlyCap)).append("\n");
    sb.append("    creditRemaining: ").append(toIndentedString(creditRemaining)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    expireDt: ").append(toIndentedString(expireDt)).append("\n");
    sb.append("    imageUrl: ").append(toIndentedString(imageUrl)).append("\n");
    sb.append("    serviceType: ").append(toIndentedString(serviceType)).append("\n");
    sb.append("    summary: ").append(toIndentedString(summary)).append("\n");
    sb.append("    thisMonthCreditRemaining: ").append(toIndentedString(thisMonthCreditRemaining)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("credit_monthly_cap");
    openapiFields.add("credit_remaining");
    openapiFields.add("description");
    openapiFields.add("expire_dt");
    openapiFields.add("image_url");
    openapiFields.add("service_type");
    openapiFields.add("summary");
    openapiFields.add("this_month_credit_remaining");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("credit_monthly_cap") != null && !jsonObj.get("credit_monthly_cap").isJsonNull()) && !jsonObj.get("credit_monthly_cap").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `credit_monthly_cap` to be a primitive type in the JSON string but got `%s`", jsonObj.get("credit_monthly_cap").toString()));
      }
      if ((jsonObj.get("credit_remaining") != null && !jsonObj.get("credit_remaining").isJsonNull()) && !jsonObj.get("credit_remaining").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `credit_remaining` to be a primitive type in the JSON string but got `%s`", jsonObj.get("credit_remaining").toString()));
      }
      if ((jsonObj.get("description") != null && !jsonObj.get("description").isJsonNull()) && !jsonObj.get("description").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `description` to be a primitive type in the JSON string but got `%s`", jsonObj.get("description").toString()));
      }
      if ((jsonObj.get("expire_dt") != null && !jsonObj.get("expire_dt").isJsonNull()) && !jsonObj.get("expire_dt").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `expire_dt` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expire_dt").toString()));
      }
      ...
      // validate the optional field `service_type`
      if (jsonObj.get("service_type") != null && !jsonObj.get("service_type").isJsonNull()) {
        ServiceTypeEnum.validateJsonElement(jsonObj.get("service_type"));
      }
      if ((jsonObj.get("summary") != null && !jsonObj.get("summary").isJsonNull()) && !jsonObj.get("summary").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `summary` to be a primitive type in the JSON string but got `%s`", jsonObj.get("summary").toString()));
      }
      if ((jsonObj.get("this_month_credit_remaining") != null && !jsonObj.get("this_month_credit_remaining").isJsonNull()) && !jsonObj.get("this_month_credit_remaining").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `this_month_credit_remaining` to be a primitive type in the JSON string but got `%s`", jsonObj.get("this_month_credit_remaining").toString()));
      }
  }
