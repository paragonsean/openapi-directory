...
public class GetImages200Response {
  ...
  public GetImages200Response data(List<Image> data) {
    this.data = data;
    return this;
  }

  public GetImages200Response addDataItem(Image dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetImages200Response getImages200Response = (GetImages200Response) o;
    return Objects.equals(this.data, getImages200Response.data) &&
        Objects.equals(this.page, getImages200Response.page) &&
        Objects.equals(this.pages, getImages200Response.pages) &&
        Objects.equals(this.results, getImages200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetImages200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImages200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImages200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImages200Response is not found in the empty JSON string", GetImages200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImages200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImages200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImages200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImages200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImages200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImages200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImages200Response>() {
           @Override
           public void write(JsonWriter out, GetImages200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImages200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImages200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImages200Response
   * @throws IOException if the JSON string is invalid with respect to GetImages200Response
   */
  public static GetImages200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImages200Response.class);
  }

  /**
   * Convert an instance of GetImages200Response to an JSON string
   *
   * @return JSON string
   */
