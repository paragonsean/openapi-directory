...
public class EntityTransferEntities {
  ...
  public EntityTransferEntities() {
  }

  public EntityTransferEntities linodes(List<Integer> linodes) {
    this.linodes = linodes;
    return this;
  }

  public EntityTransferEntities addLinodesItem(Integer linodesItem) {
  ...
  public boolean equals(Object o) {
    ...
    EntityTransferEntities entityTransferEntities = (EntityTransferEntities) o;
    return Objects.equals(this.linodes, entityTransferEntities.linodes);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityTransferEntities {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityTransferEntities
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityTransferEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityTransferEntities is not found in the empty JSON string", EntityTransferEntities.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityTransferEntities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityTransferEntities` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityTransferEntities.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityTransferEntities' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityTransferEntities> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityTransferEntities.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityTransferEntities>() {
           @Override
           public void write(JsonWriter out, EntityTransferEntities value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityTransferEntities read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityTransferEntities given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityTransferEntities
   * @throws IOException if the JSON string is invalid with respect to EntityTransferEntities
   */
  public static EntityTransferEntities fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityTransferEntities.class);
  }

  /**
   * Convert an instance of EntityTransferEntities to an JSON string
   *
   * @return JSON string
   */
