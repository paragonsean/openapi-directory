...
public class LongviewClientApps {
  public static final String SERIALIZED_NAME_APACHE = "apache";
  @SerializedName(SERIALIZED_NAME_APACHE)
  ...
  public boolean equals(Object o) {
    ...
    LongviewClientApps longviewClientApps = (LongviewClientApps) o;
    return Objects.equals(this.apache, longviewClientApps.apache) &&
        Objects.equals(this.mysql, longviewClientApps.mysql) &&
        Objects.equals(this.nginx, longviewClientApps.nginx);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apache, mysql, nginx);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LongviewClientApps {\n");
    sb.append("    apache: ").append(toIndentedString(apache)).append("\n");
  ...
  static {
    ...
    openapiFields.add("apache");
    openapiFields.add("mysql");
    openapiFields.add("nginx");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongviewClientApps
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongviewClientApps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongviewClientApps is not found in the empty JSON string", LongviewClientApps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongviewClientApps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongviewClientApps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongviewClientApps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongviewClientApps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongviewClientApps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongviewClientApps.class));

       return (TypeAdapter<T>) new TypeAdapter<LongviewClientApps>() {
           @Override
           public void write(JsonWriter out, LongviewClientApps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongviewClientApps read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongviewClientApps given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongviewClientApps
   * @throws IOException if the JSON string is invalid with respect to LongviewClientApps
   */
  public static LongviewClientApps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongviewClientApps.class);
  }

  /**
   * Convert an instance of LongviewClientApps to an JSON string
   *
   * @return JSON string
   */
