...
import org.openapitools.client.model.LKEClusterControlPlane;
...
public class LKECluster {
  ...
  private LKEClusterControlPlane controlPlane;
  ...
  public LKECluster controlPlane(LKEClusterControlPlane controlPlane) {
  ...
  public LKEClusterControlPlane getControlPlane() {
    return controlPlane;
  }

  public void setControlPlane(LKEClusterControlPlane controlPlane) {
    this.controlPlane = controlPlane;
  }
  ...
  public LKECluster k8sVersion(String k8sVersion) {
  ...
  public LKECluster label(String label) {
    this.label = label;
    return this;
  }
  ...
  public LKECluster region(String region) {
    this.region = region;
    return this;
  }
  ...
  public LKECluster tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public LKECluster addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    LKECluster lkECluster = (LKECluster) o;
    return Objects.equals(this.controlPlane, lkECluster.controlPlane) &&
        Objects.equals(this.created, lkECluster.created) &&
        Objects.equals(this.id, lkECluster.id) &&
        Objects.equals(this.k8sVersion, lkECluster.k8sVersion) &&
        Objects.equals(this.label, lkECluster.label) &&
        Objects.equals(this.region, lkECluster.region) &&
        Objects.equals(this.tags, lkECluster.tags) &&
        Objects.equals(this.updated, lkECluster.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(controlPlane, created, id, k8sVersion, label, region, tags, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LKECluster {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKECluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKECluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKECluster is not found in the empty JSON string", LKECluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKECluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKECluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `control_plane`
      if (jsonObj.get("control_plane") != null && !jsonObj.get("control_plane").isJsonNull()) {
        LKEClusterControlPlane.validateJsonElement(jsonObj.get("control_plane"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKECluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKECluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKECluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKECluster.class));

       return (TypeAdapter<T>) new TypeAdapter<LKECluster>() {
           @Override
           public void write(JsonWriter out, LKECluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKECluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKECluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKECluster
   * @throws IOException if the JSON string is invalid with respect to LKECluster
   */
  public static LKECluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKECluster.class);
  }

  /**
   * Convert an instance of LKECluster to an JSON string
   *
   * @return JSON string
   */
