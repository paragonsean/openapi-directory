...
import org.openapitools.client.model.GetTaggedObjects200ResponseDataInner;
...
public class GetTaggedObjects200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<GetTaggedObjects200ResponseDataInner> data = new ArrayList<>();
  ...
  public GetTaggedObjects200Response() {
  }
  ...
  public GetTaggedObjects200Response data(List<GetTaggedObjects200ResponseDataInner> data) {
    this.data = data;
    return this;
  }

  public GetTaggedObjects200Response addDataItem(GetTaggedObjects200ResponseDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<GetTaggedObjects200ResponseDataInner> getData() {
    return data;
  }

  public void setData(List<GetTaggedObjects200ResponseDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTaggedObjects200Response getTaggedObjects200Response = (GetTaggedObjects200Response) o;
    return Objects.equals(this.data, getTaggedObjects200Response.data) &&
        Objects.equals(this.page, getTaggedObjects200Response.page) &&
        Objects.equals(this.pages, getTaggedObjects200Response.pages) &&
        Objects.equals(this.results, getTaggedObjects200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTaggedObjects200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTaggedObjects200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTaggedObjects200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTaggedObjects200Response is not found in the empty JSON string", GetTaggedObjects200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTaggedObjects200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTaggedObjects200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            GetTaggedObjects200ResponseDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTaggedObjects200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTaggedObjects200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTaggedObjects200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTaggedObjects200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTaggedObjects200Response>() {
           @Override
           public void write(JsonWriter out, GetTaggedObjects200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTaggedObjects200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTaggedObjects200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTaggedObjects200Response
   * @throws IOException if the JSON string is invalid with respect to GetTaggedObjects200Response
   */
  public static GetTaggedObjects200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTaggedObjects200Response.class);
  }

  /**
   * Convert an instance of GetTaggedObjects200Response to an JSON string
   *
   * @return JSON string
   */
