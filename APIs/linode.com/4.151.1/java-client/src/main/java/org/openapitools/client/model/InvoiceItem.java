...
public class InvoiceItem {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, invoiceItem.amount) &&
        Objects.equals(this.from, invoiceItem.from) &&
        Objects.equals(this.label, invoiceItem.label) &&
        Objects.equals(this.quantity, invoiceItem.quantity) &&
        Objects.equals(this.tax, invoiceItem.tax) &&
        Objects.equals(this.to, invoiceItem.to) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, from, label, quantity, tax, to, total, type, unitPrice);
  }
