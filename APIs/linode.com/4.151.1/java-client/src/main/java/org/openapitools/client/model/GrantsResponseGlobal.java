...
public class GrantsResponseGlobal {
   ...
   */
  @JsonAdapter(AccountAccessEnum.Adapter.class)
  public enum AccountAccessEnum {
    ...
    AccountAccessEnum(String value) {
      this.value = value;
    }
    ...
    public static AccountAccessEnum fromValue(String value) {
      for (AccountAccessEnum b : AccountAccessEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AccountAccessEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AccountAccessEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AccountAccessEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AccountAccessEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AccountAccessEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_ACCOUNT_ACCESS = "account_access";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_ACCESS)
  private AccountAccessEnum accountAccess;

  public static final String SERIALIZED_NAME_ADD_DATABASES = "add_databases";
  @SerializedName(SERIALIZED_NAME_ADD_DATABASES)
  private Boolean addDatabases;

  public static final String SERIALIZED_NAME_ADD_DOMAINS = "add_domains";
  @SerializedName(SERIALIZED_NAME_ADD_DOMAINS)
  private Boolean addDomains;

  public static final String SERIALIZED_NAME_ADD_FIREWALLS = "add_firewalls";
  @SerializedName(SERIALIZED_NAME_ADD_FIREWALLS)
  private Boolean addFirewalls;

  public static final String SERIALIZED_NAME_ADD_IMAGES = "add_images";
  @SerializedName(SERIALIZED_NAME_ADD_IMAGES)
  private Boolean addImages;

  public static final String SERIALIZED_NAME_ADD_LINODES = "add_linodes";
  @SerializedName(SERIALIZED_NAME_ADD_LINODES)
  private Boolean addLinodes;

  public static final String SERIALIZED_NAME_ADD_LONGVIEW = "add_longview";
  @SerializedName(SERIALIZED_NAME_ADD_LONGVIEW)
  private Boolean addLongview;

  public static final String SERIALIZED_NAME_ADD_NODEBALANCERS = "add_nodebalancers";
  @SerializedName(SERIALIZED_NAME_ADD_NODEBALANCERS)
  private Boolean addNodebalancers;

  public static final String SERIALIZED_NAME_ADD_STACKSCRIPTS = "add_stackscripts";
  @SerializedName(SERIALIZED_NAME_ADD_STACKSCRIPTS)
  private Boolean addStackscripts;

  public static final String SERIALIZED_NAME_ADD_VOLUMES = "add_volumes";
  @SerializedName(SERIALIZED_NAME_ADD_VOLUMES)
  private Boolean addVolumes;

  public static final String SERIALIZED_NAME_CANCEL_ACCOUNT = "cancel_account";
  @SerializedName(SERIALIZED_NAME_CANCEL_ACCOUNT)
  ...
  public GrantsResponseGlobal() {
  }

  public GrantsResponseGlobal accountAccess(AccountAccessEnum accountAccess) {
  ...
  public AccountAccessEnum getAccountAccess() {
    return accountAccess;
  }

  public void setAccountAccess(AccountAccessEnum accountAccess) {
    this.accountAccess = accountAccess;
  }


  public GrantsResponseGlobal addDatabases(Boolean addDatabases) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getAddDatabases() {
    return addDatabases;
  }

  public void setAddDatabases(Boolean addDatabases) {
    this.addDatabases = addDatabases;
  }


  public GrantsResponseGlobal addDomains(Boolean addDomains) {
  ...
  public void setAddDomains(Boolean addDomains) {
    this.addDomains = addDomains;
  }


  public GrantsResponseGlobal addFirewalls(Boolean addFirewalls) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getAddFirewalls() {
    return addFirewalls;
  }

  public void setAddFirewalls(Boolean addFirewalls) {
    this.addFirewalls = addFirewalls;
  }


  public GrantsResponseGlobal addImages(Boolean addImages) {
  ...
  public void setAddImages(Boolean addImages) {
    this.addImages = addImages;
  }


  public GrantsResponseGlobal addLinodes(Boolean addLinodes) {
  ...
  public void setAddLinodes(Boolean addLinodes) {
    this.addLinodes = addLinodes;
  }


  public GrantsResponseGlobal addLongview(Boolean addLongview) {
  ...
  public void setAddLongview(Boolean addLongview) {
    this.addLongview = addLongview;
  }


  public GrantsResponseGlobal addNodebalancers(Boolean addNodebalancers) {
  ...
  public void setAddNodebalancers(Boolean addNodebalancers) {
    this.addNodebalancers = addNodebalancers;
  }


  public GrantsResponseGlobal addStackscripts(Boolean addStackscripts) {
  ...
  public void setAddStackscripts(Boolean addStackscripts) {
    this.addStackscripts = addStackscripts;
  }


  public GrantsResponseGlobal addVolumes(Boolean addVolumes) {
  ...
  public GrantsResponseGlobal cancelAccount(Boolean cancelAccount) {
  ...
  public GrantsResponseGlobal longviewSubscription(Boolean longviewSubscription) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getLongviewSubscription() {
    return longviewSubscription;
  }

  public void setLongviewSubscription(Boolean longviewSubscription) {
    this.longviewSubscription = longviewSubscription;
  }
  ...
  public boolean equals(Object o) {
    ...
    GrantsResponseGlobal grantsResponseGlobal = (GrantsResponseGlobal) o;
    return Objects.equals(this.accountAccess, grantsResponseGlobal.accountAccess) &&
        Objects.equals(this.addDatabases, grantsResponseGlobal.addDatabases) &&
        Objects.equals(this.addDomains, grantsResponseGlobal.addDomains) &&
        Objects.equals(this.addFirewalls, grantsResponseGlobal.addFirewalls) &&
        Objects.equals(this.addImages, grantsResponseGlobal.addImages) &&
        Objects.equals(this.addLinodes, grantsResponseGlobal.addLinodes) &&
        Objects.equals(this.addLongview, grantsResponseGlobal.addLongview) &&
        Objects.equals(this.addNodebalancers, grantsResponseGlobal.addNodebalancers) &&
        Objects.equals(this.addStackscripts, grantsResponseGlobal.addStackscripts) &&
        Objects.equals(this.addVolumes, grantsResponseGlobal.addVolumes) &&
        Objects.equals(this.cancelAccount, grantsResponseGlobal.cancelAccount) &&
        Objects.equals(this.longviewSubscription, grantsResponseGlobal.longviewSubscription);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountAccess, addDatabases, addDomains, addFirewalls, addImages, addLinodes, addLongview, addNodebalancers, addStackscripts, addVolumes, cancelAccount, longviewSubscription);
  }
  ...
  public String toString() {
    ...
    sb.append("class GrantsResponseGlobal {\n");
    sb.append("    accountAccess: ").append(toIndentedString(accountAccess)).append("\n");
    sb.append("    addDatabases: ").append(toIndentedString(addDatabases)).append("\n");
    sb.append("    addDomains: ").append(toIndentedString(addDomains)).append("\n");
    sb.append("    addFirewalls: ").append(toIndentedString(addFirewalls)).append("\n");
    sb.append("    addImages: ").append(toIndentedString(addImages)).append("\n");
    sb.append("    addLinodes: ").append(toIndentedString(addLinodes)).append("\n");
    sb.append("    addLongview: ").append(toIndentedString(addLongview)).append("\n");
    sb.append("    addNodebalancers: ").append(toIndentedString(addNodebalancers)).append("\n");
    sb.append("    addStackscripts: ").append(toIndentedString(addStackscripts)).append("\n");
    sb.append("    addVolumes: ").append(toIndentedString(addVolumes)).append("\n");
    sb.append("    cancelAccount: ").append(toIndentedString(cancelAccount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("account_access");
    openapiFields.add("add_databases");
    openapiFields.add("add_domains");
    openapiFields.add("add_firewalls");
    openapiFields.add("add_images");
    openapiFields.add("add_linodes");
    openapiFields.add("add_longview");
    openapiFields.add("add_nodebalancers");
    openapiFields.add("add_stackscripts");
    openapiFields.add("add_volumes");
    openapiFields.add("cancel_account");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GrantsResponseGlobal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GrantsResponseGlobal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GrantsResponseGlobal is not found in the empty JSON string", GrantsResponseGlobal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GrantsResponseGlobal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GrantsResponseGlobal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("account_access") != null && !jsonObj.get("account_access").isJsonNull()) && !jsonObj.get("account_access").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `account_access` to be a primitive type in the JSON string but got `%s`", jsonObj.get("account_access").toString()));
      }
      // validate the optional field `account_access`
      if (jsonObj.get("account_access") != null && !jsonObj.get("account_access").isJsonNull()) {
        AccountAccessEnum.validateJsonElement(jsonObj.get("account_access"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GrantsResponseGlobal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GrantsResponseGlobal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GrantsResponseGlobal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GrantsResponseGlobal.class));

       return (TypeAdapter<T>) new TypeAdapter<GrantsResponseGlobal>() {
           @Override
           public void write(JsonWriter out, GrantsResponseGlobal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GrantsResponseGlobal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GrantsResponseGlobal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GrantsResponseGlobal
   * @throws IOException if the JSON string is invalid with respect to GrantsResponseGlobal
   */
  public static GrantsResponseGlobal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GrantsResponseGlobal.class);
  }

  /**
   * Convert an instance of GrantsResponseGlobal to an JSON string
   *
   * @return JSON string
   */
