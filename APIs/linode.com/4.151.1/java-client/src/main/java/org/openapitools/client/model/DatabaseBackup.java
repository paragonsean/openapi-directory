...
public class DatabaseBackup {
  ...
  public DatabaseBackup created(String created) {
  ...
  public DatabaseBackup id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DatabaseBackup label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabaseBackup type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, databaseBackup.created) &&
        Objects.equals(this.id, databaseBackup.id) &&
        Objects.equals(this.label, databaseBackup.label) &&
        Objects.equals(this.type, databaseBackup.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, label, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseBackup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseBackup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseBackup is not found in the empty JSON string", DatabaseBackup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseBackup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseBackup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseBackup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseBackup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseBackup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseBackup.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseBackup>() {
           @Override
           public void write(JsonWriter out, DatabaseBackup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseBackup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseBackup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseBackup
   * @throws IOException if the JSON string is invalid with respect to DatabaseBackup
   */
  public static DatabaseBackup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseBackup.class);
  }

  /**
   * Convert an instance of DatabaseBackup to an JSON string
   *
   * @return JSON string
   */
