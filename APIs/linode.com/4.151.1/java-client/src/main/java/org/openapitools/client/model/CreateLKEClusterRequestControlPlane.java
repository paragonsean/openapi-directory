...
public class CreateLKEClusterRequestControlPlane {
  public static final String SERIALIZED_NAME_HIGH_AVAILABILITY = "high_availability";
  @SerializedName(SERIALIZED_NAME_HIGH_AVAILABILITY)
  private Boolean highAvailability;

  public CreateLKEClusterRequestControlPlane() {
  }

  public CreateLKEClusterRequestControlPlane highAvailability(Boolean highAvailability) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLKEClusterRequestControlPlane createLKEClusterRequestControlPlane = (CreateLKEClusterRequestControlPlane) o;
    return Objects.equals(this.highAvailability, createLKEClusterRequestControlPlane.highAvailability);
  }

  @Override
  public int hashCode() {
    return Objects.hash(highAvailability);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateLKEClusterRequestControlPlane {\n");
  ...
  static {
    ...
    openapiFields.add("high_availability");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLKEClusterRequestControlPlane
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLKEClusterRequestControlPlane.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLKEClusterRequestControlPlane is not found in the empty JSON string", CreateLKEClusterRequestControlPlane.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLKEClusterRequestControlPlane.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLKEClusterRequestControlPlane` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLKEClusterRequestControlPlane.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLKEClusterRequestControlPlane' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLKEClusterRequestControlPlane> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLKEClusterRequestControlPlane.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLKEClusterRequestControlPlane>() {
           @Override
           public void write(JsonWriter out, CreateLKEClusterRequestControlPlane value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLKEClusterRequestControlPlane read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLKEClusterRequestControlPlane given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLKEClusterRequestControlPlane
   * @throws IOException if the JSON string is invalid with respect to CreateLKEClusterRequestControlPlane
   */
  public static CreateLKEClusterRequestControlPlane fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLKEClusterRequestControlPlane.class);
  }

  /**
   * Convert an instance of CreateLKEClusterRequestControlPlane to an JSON string
   *
   * @return JSON string
   */
