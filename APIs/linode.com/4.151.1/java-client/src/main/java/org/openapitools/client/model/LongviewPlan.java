...
public class LongviewPlan {
   ...
   */
  @JsonAdapter(LongviewSubscriptionEnum.Adapter.class)
  public enum LongviewSubscriptionEnum {
    _3("longview-3"),
    ...
    LongviewSubscriptionEnum(String value) {
      this.value = value;
    }
    ...
    public static LongviewSubscriptionEnum fromValue(String value) {
      for (LongviewSubscriptionEnum b : LongviewSubscriptionEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<LongviewSubscriptionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LongviewSubscriptionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LongviewSubscriptionEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return LongviewSubscriptionEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      LongviewSubscriptionEnum.fromValue(value);
    }
  }
  ...
  private LongviewSubscriptionEnum longviewSubscription;

  public LongviewPlan() {
  }

  public LongviewPlan longviewSubscription(LongviewSubscriptionEnum longviewSubscription) {
  ...
  public LongviewSubscriptionEnum getLongviewSubscription() {
    return longviewSubscription;
  }

  public void setLongviewSubscription(LongviewSubscriptionEnum longviewSubscription) {
    this.longviewSubscription = longviewSubscription;
  }
  ...
  public boolean equals(Object o) {
    ...
    LongviewPlan longviewPlan = (LongviewPlan) o;
    return Objects.equals(this.longviewSubscription, longviewPlan.longviewSubscription);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(longviewSubscription);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongviewPlan
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongviewPlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongviewPlan is not found in the empty JSON string", LongviewPlan.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongviewPlan.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongviewPlan` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `longview_subscription`
      if (jsonObj.get("longview_subscription") != null && !jsonObj.get("longview_subscription").isJsonNull()) {
        LongviewSubscriptionEnum.validateJsonElement(jsonObj.get("longview_subscription"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongviewPlan.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongviewPlan' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongviewPlan> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongviewPlan.class));

       return (TypeAdapter<T>) new TypeAdapter<LongviewPlan>() {
           @Override
           public void write(JsonWriter out, LongviewPlan value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongviewPlan read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongviewPlan given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongviewPlan
   * @throws IOException if the JSON string is invalid with respect to LongviewPlan
   */
  public static LongviewPlan fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongviewPlan.class);
  }

  /**
   * Convert an instance of LongviewPlan to an JSON string
   *
   * @return JSON string
   */
