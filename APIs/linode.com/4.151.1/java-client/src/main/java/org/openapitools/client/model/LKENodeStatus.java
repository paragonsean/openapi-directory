...
public class LKENodeStatus {
  ...
  public LKENodeStatus() {
  }

  public LKENodeStatus id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LKENodeStatus instanceId(String instanceId) {
  ...
  public LKENodeStatus status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodeStatus lkENodeStatus = (LKENodeStatus) o;
    return Objects.equals(this.id, lkENodeStatus.id) &&
        Objects.equals(this.instanceId, lkENodeStatus.instanceId) &&
        Objects.equals(this.status, lkENodeStatus.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodeStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodeStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodeStatus is not found in the empty JSON string", LKENodeStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodeStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodeStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodeStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodeStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodeStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodeStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodeStatus>() {
           @Override
           public void write(JsonWriter out, LKENodeStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodeStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodeStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodeStatus
   * @throws IOException if the JSON string is invalid with respect to LKENodeStatus
   */
  public static LKENodeStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodeStatus.class);
  }

  /**
   * Convert an instance of LKENodeStatus to an JSON string
   *
   * @return JSON string
   */
