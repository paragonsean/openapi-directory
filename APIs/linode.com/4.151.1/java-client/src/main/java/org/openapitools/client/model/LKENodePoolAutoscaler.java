...
public class LKENodePoolAutoscaler {
  ...
  public LKENodePoolAutoscaler() {
  }

  public LKENodePoolAutoscaler enabled(Boolean enabled) {
  ...
  public LKENodePoolAutoscaler max(Integer max) {
    this.max = max;
    return this;
  }
  ...
  public LKENodePoolAutoscaler min(Integer min) {
    this.min = min;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodePoolAutoscaler lkENodePoolAutoscaler = (LKENodePoolAutoscaler) o;
    return Objects.equals(this.enabled, lkENodePoolAutoscaler.enabled) &&
        Objects.equals(this.max, lkENodePoolAutoscaler.max) &&
        Objects.equals(this.min, lkENodePoolAutoscaler.min);
  }
  ...
  public String toString() {
    ...
    sb.append("class LKENodePoolAutoscaler {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodePoolAutoscaler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodePoolAutoscaler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodePoolAutoscaler is not found in the empty JSON string", LKENodePoolAutoscaler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodePoolAutoscaler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodePoolAutoscaler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodePoolAutoscaler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodePoolAutoscaler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodePoolAutoscaler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodePoolAutoscaler.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodePoolAutoscaler>() {
           @Override
           public void write(JsonWriter out, LKENodePoolAutoscaler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodePoolAutoscaler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodePoolAutoscaler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodePoolAutoscaler
   * @throws IOException if the JSON string is invalid with respect to LKENodePoolAutoscaler
   */
  public static LKENodePoolAutoscaler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodePoolAutoscaler.class);
  }

  /**
   * Convert an instance of LKENodePoolAutoscaler to an JSON string
   *
   * @return JSON string
   */
