...
import org.openapitools.client.model.StatsDataAvailable;
...
public class GetManagedStats200ResponseData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetManagedStats200ResponseData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetManagedStats200ResponseData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetManagedStats200ResponseData' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<StatsDataAvailable> adapterStatsDataAvailable = gson.getDelegateAdapter(this, TypeToken.get(StatsDataAvailable.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetManagedStats200ResponseData>() {
                @Override
                public void write(JsonWriter out, GetManagedStats200ResponseData value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `StatsDataAvailable`
                    if (value.getActualInstance() instanceof StatsDataAvailable) {
                        JsonElement element = adapterStatsDataAvailable.toJsonTree((StatsDataAvailable)value.getActualInstance());
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: List<String>, StatsDataAvailable");
                }

                @Override
                public GetManagedStats200ResponseData read(JsonReader in) throws IOException {
                    ...
                    // deserialize StatsDataAvailable
                    try {
                        // validate the JSON object to see if any exception is thrown
                        StatsDataAvailable.validateJsonElement(jsonElement);
                        actualAdapter = adapterStatsDataAvailable;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'StatsDataAvailable'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for StatsDataAvailable failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'StatsDataAvailable'", e);
                    }
                    ...
                    if (match == 1) {
                        GetManagedStats200ResponseData ret = new GetManagedStats200ResponseData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetManagedStats200ResponseData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetManagedStats200ResponseData() {
        super("oneOf", Boolean.FALSE);
    }

    public GetManagedStats200ResponseData(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("StatsDataAvailable", StatsDataAvailable.class);
        schemas.put("List<String>", List.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GetManagedStats200ResponseData.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * List<String>, StatsDataAvailable
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof StatsDataAvailable) {
        ...
        throw new RuntimeException("Invalid instance type. Must be List<String>, StatsDataAvailable");
    }
     ...
     * List<String>, StatsDataAvailable
     *
     * @return The actual instance (List<String>, StatsDataAvailable)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `StatsDataAvailable`. If the actual instance is not `StatsDataAvailable`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `StatsDataAvailable`
     * @throws ClassCastException if the instance is not `StatsDataAvailable`
     */
    public StatsDataAvailable getStatsDataAvailable() throws ClassCastException {
        return (StatsDataAvailable)super.getActualInstance();
    }
    /**
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetManagedStats200ResponseData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with StatsDataAvailable
        try {
            StatsDataAvailable.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetManagedStats200ResponseData with oneOf schemas: List<String>, StatsDataAvailable. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetManagedStats200ResponseData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetManagedStats200ResponseData
     * @throws IOException if the JSON string is invalid with respect to GetManagedStats200ResponseData
     */
    public static GetManagedStats200ResponseData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetManagedStats200ResponseData.class);
    }

    /**
     * Convert an instance of GetManagedStats200ResponseData to an JSON string
     *
     * @return JSON string
     */
