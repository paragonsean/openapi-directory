...
public class GetLinodeConfigs200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LinodeConfig> data = new ArrayList<>();
  ...
  public GetLinodeConfigs200Response() {
  }
  ...
  public GetLinodeConfigs200Response data(List<LinodeConfig> data) {
    this.data = data;
    return this;
  }

  public GetLinodeConfigs200Response addDataItem(LinodeConfig dataItem) {
    if (this.data == null) {
  ...
  public List<LinodeConfig> getData() {
    return data;
  }

  public void setData(List<LinodeConfig> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeConfigs200Response getLinodeConfigs200Response = (GetLinodeConfigs200Response) o;
    return Objects.equals(this.data, getLinodeConfigs200Response.data) &&
        Objects.equals(this.page, getLinodeConfigs200Response.page) &&
        Objects.equals(this.pages, getLinodeConfigs200Response.pages) &&
        Objects.equals(this.results, getLinodeConfigs200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeConfigs200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeConfigs200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeConfigs200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeConfigs200Response is not found in the empty JSON string", GetLinodeConfigs200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeConfigs200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeConfigs200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LinodeConfig.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeConfigs200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeConfigs200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeConfigs200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeConfigs200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeConfigs200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeConfigs200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeConfigs200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeConfigs200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeConfigs200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeConfigs200Response
   */
  public static GetLinodeConfigs200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeConfigs200Response.class);
  }

  /**
   * Convert an instance of GetLinodeConfigs200Response to an JSON string
   *
   * @return JSON string
   */
