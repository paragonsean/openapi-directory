...
public class RegionResolvers {
  ...
  public boolean equals(Object o) {
    ...
    RegionResolvers regionResolvers = (RegionResolvers) o;
    return Objects.equals(this.ipv4, regionResolvers.ipv4) &&
        Objects.equals(this.ipv6, regionResolvers.ipv6);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegionResolvers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegionResolvers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegionResolvers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegionResolvers is not found in the empty JSON string", RegionResolvers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegionResolvers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegionResolvers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegionResolvers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegionResolvers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegionResolvers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegionResolvers.class));

       return (TypeAdapter<T>) new TypeAdapter<RegionResolvers>() {
           @Override
           public void write(JsonWriter out, RegionResolvers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegionResolvers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegionResolvers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegionResolvers
   * @throws IOException if the JSON string is invalid with respect to RegionResolvers
   */
  public static RegionResolvers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegionResolvers.class);
  }

  /**
   * Convert an instance of RegionResolvers to an JSON string
   *
   * @return JSON string
   */
