...
import org.openapitools.client.model.GetTaggedObjects200ResponseDataInnerData;
...
public class GetTaggedObjects200ResponseDataInner {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private GetTaggedObjects200ResponseDataInnerData data;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public GetTaggedObjects200ResponseDataInner() {
  }

  public GetTaggedObjects200ResponseDataInner data(GetTaggedObjects200ResponseDataInnerData data) {
    this.data = data;
    return this;
  }
  ...
  public GetTaggedObjects200ResponseDataInnerData getData() {
    return data;
  }

  public void setData(GetTaggedObjects200ResponseDataInnerData data) {
    this.data = data;
  }


  public GetTaggedObjects200ResponseDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTaggedObjects200ResponseDataInner getTaggedObjects200ResponseDataInner = (GetTaggedObjects200ResponseDataInner) o;
    return Objects.equals(this.data, getTaggedObjects200ResponseDataInner.data) &&
        Objects.equals(this.type, getTaggedObjects200ResponseDataInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTaggedObjects200ResponseDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTaggedObjects200ResponseDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTaggedObjects200ResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTaggedObjects200ResponseDataInner is not found in the empty JSON string", GetTaggedObjects200ResponseDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTaggedObjects200ResponseDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTaggedObjects200ResponseDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GetTaggedObjects200ResponseDataInnerData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTaggedObjects200ResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTaggedObjects200ResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTaggedObjects200ResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTaggedObjects200ResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTaggedObjects200ResponseDataInner>() {
           @Override
           public void write(JsonWriter out, GetTaggedObjects200ResponseDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTaggedObjects200ResponseDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTaggedObjects200ResponseDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTaggedObjects200ResponseDataInner
   * @throws IOException if the JSON string is invalid with respect to GetTaggedObjects200ResponseDataInner
   */
  public static GetTaggedObjects200ResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTaggedObjects200ResponseDataInner.class);
  }

  /**
   * Convert an instance of GetTaggedObjects200ResponseDataInner to an JSON string
   *
   * @return JSON string
   */
