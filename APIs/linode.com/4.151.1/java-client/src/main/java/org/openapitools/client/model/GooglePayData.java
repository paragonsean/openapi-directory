...
public class GooglePayData {
  ...
  public boolean equals(Object o) {
    ...
    GooglePayData googlePayData = (GooglePayData) o;
    return Objects.equals(this.cardType, googlePayData.cardType) &&
        Objects.equals(this.expiry, googlePayData.expiry) &&
        Objects.equals(this.lastFour, googlePayData.lastFour);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GooglePayData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GooglePayData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GooglePayData is not found in the empty JSON string", GooglePayData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GooglePayData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GooglePayData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GooglePayData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GooglePayData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GooglePayData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GooglePayData.class));

       return (TypeAdapter<T>) new TypeAdapter<GooglePayData>() {
           @Override
           public void write(JsonWriter out, GooglePayData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GooglePayData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GooglePayData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GooglePayData
   * @throws IOException if the JSON string is invalid with respect to GooglePayData
   */
  public static GooglePayData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GooglePayData.class);
  }

  /**
   * Convert an instance of GooglePayData to an JSON string
   *
   * @return JSON string
   */
