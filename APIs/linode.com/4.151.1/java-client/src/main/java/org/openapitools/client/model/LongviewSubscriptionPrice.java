...
public class LongviewSubscriptionPrice {
  ...
  public LongviewSubscriptionPrice() {
  }
  ...
  public boolean equals(Object o) {
    ...
    LongviewSubscriptionPrice longviewSubscriptionPrice = (LongviewSubscriptionPrice) o;
    return Objects.equals(this.hourly, longviewSubscriptionPrice.hourly) &&
        Objects.equals(this.monthly, longviewSubscriptionPrice.monthly);
  }
  ...
  public String toString() {
    ...
    sb.append("class LongviewSubscriptionPrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongviewSubscriptionPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongviewSubscriptionPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongviewSubscriptionPrice is not found in the empty JSON string", LongviewSubscriptionPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongviewSubscriptionPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongviewSubscriptionPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongviewSubscriptionPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongviewSubscriptionPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongviewSubscriptionPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongviewSubscriptionPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<LongviewSubscriptionPrice>() {
           @Override
           public void write(JsonWriter out, LongviewSubscriptionPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongviewSubscriptionPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongviewSubscriptionPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongviewSubscriptionPrice
   * @throws IOException if the JSON string is invalid with respect to LongviewSubscriptionPrice
   */
  public static LongviewSubscriptionPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongviewSubscriptionPrice.class);
  }

  /**
   * Convert an instance of LongviewSubscriptionPrice to an JSON string
   *
   * @return JSON string
   */
