...
public class ApiClient {
    ...
    private String basePath = "https://api.linode.com/v4";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://login.linode.com/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.151.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.linode.com/v4
