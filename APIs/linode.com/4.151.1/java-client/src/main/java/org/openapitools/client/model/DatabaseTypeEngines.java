...
import org.openapitools.client.model.DatabaseTypeEngine;
...
public class DatabaseTypeEngines {
  ...
  private List<DatabaseTypeEngine> mongodb = new ArrayList<>();

  public static final String SERIALIZED_NAME_MYSQL = "mysql";
  @SerializedName(SERIALIZED_NAME_MYSQL)
  private List<DatabaseTypeEngine> mysql = new ArrayList<>();

  public static final String SERIALIZED_NAME_POSTGRESQL = "postgresql";
  @SerializedName(SERIALIZED_NAME_POSTGRESQL)
  private List<DatabaseTypeEngine> postgresql = new ArrayList<>();

  public DatabaseTypeEngines() {
  }

  public DatabaseTypeEngines mongodb(List<DatabaseTypeEngine> mongodb) {
    this.mongodb = mongodb;
    return this;
  }

  public DatabaseTypeEngines addMongodbItem(DatabaseTypeEngine mongodbItem) {
  ...
  public List<DatabaseTypeEngine> getMongodb() {
    return mongodb;
  }

  public void setMongodb(List<DatabaseTypeEngine> mongodb) {
    this.mongodb = mongodb;
  }


  public DatabaseTypeEngines mysql(List<DatabaseTypeEngine> mysql) {
    this.mysql = mysql;
    return this;
  }

  public DatabaseTypeEngines addMysqlItem(DatabaseTypeEngine mysqlItem) {
    if (this.mysql == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseTypeEngine> getMysql() {
    return mysql;
  }

  public void setMysql(List<DatabaseTypeEngine> mysql) {
    this.mysql = mysql;
  }


  public DatabaseTypeEngines postgresql(List<DatabaseTypeEngine> postgresql) {
    this.postgresql = postgresql;
    return this;
  }

  public DatabaseTypeEngines addPostgresqlItem(DatabaseTypeEngine postgresqlItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseTypeEngine> getPostgresql() {
    return postgresql;
  }

  public void setPostgresql(List<DatabaseTypeEngine> postgresql) {
    this.postgresql = postgresql;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabaseTypeEngines databaseTypeEngines = (DatabaseTypeEngines) o;
    return Objects.equals(this.mongodb, databaseTypeEngines.mongodb) &&
        Objects.equals(this.mysql, databaseTypeEngines.mysql) &&
        Objects.equals(this.postgresql, databaseTypeEngines.postgresql);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mongodb, mysql, postgresql);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseTypeEngines {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseTypeEngines
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseTypeEngines.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseTypeEngines is not found in the empty JSON string", DatabaseTypeEngines.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseTypeEngines.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseTypeEngines` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("mongodb") != null && !jsonObj.get("mongodb").isJsonNull()) {
        JsonArray jsonArraymongodb = jsonObj.getAsJsonArray("mongodb");
        if (jsonArraymongodb != null) {
          // ensure the json data is an array
          if (!jsonObj.get("mongodb").isJsonArray()) {
          ...
          // validate the optional field `mongodb` (array)
          for (int i = 0; i < jsonArraymongodb.size(); i++) {
            DatabaseTypeEngine.validateJsonElement(jsonArraymongodb.get(i));
          };
        }
      }
      if (jsonObj.get("mysql") != null && !jsonObj.get("mysql").isJsonNull()) {
        JsonArray jsonArraymysql = jsonObj.getAsJsonArray("mysql");
        if (jsonArraymysql != null) {
          // ensure the json data is an array
          if (!jsonObj.get("mysql").isJsonArray()) {
          ...
          // validate the optional field `mysql` (array)
          for (int i = 0; i < jsonArraymysql.size(); i++) {
            DatabaseTypeEngine.validateJsonElement(jsonArraymysql.get(i));
          };
        }
      }
      if (jsonObj.get("postgresql") != null && !jsonObj.get("postgresql").isJsonNull()) {
        JsonArray jsonArraypostgresql = jsonObj.getAsJsonArray("postgresql");
        if (jsonArraypostgresql != null) {
          // ensure the json data is an array
          if (!jsonObj.get("postgresql").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `postgresql` to be an array in the JSON string but got `%s`", jsonObj.get("postgresql").toString()));
          }

          // validate the optional field `postgresql` (array)
          for (int i = 0; i < jsonArraypostgresql.size(); i++) {
            DatabaseTypeEngine.validateJsonElement(jsonArraypostgresql.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseTypeEngines.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseTypeEngines' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseTypeEngines> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseTypeEngines.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseTypeEngines>() {
           @Override
           public void write(JsonWriter out, DatabaseTypeEngines value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseTypeEngines read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseTypeEngines given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseTypeEngines
   * @throws IOException if the JSON string is invalid with respect to DatabaseTypeEngines
   */
  public static DatabaseTypeEngines fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseTypeEngines.class);
  }

  /**
   * Convert an instance of DatabaseTypeEngines to an JSON string
   *
   * @return JSON string
   */
