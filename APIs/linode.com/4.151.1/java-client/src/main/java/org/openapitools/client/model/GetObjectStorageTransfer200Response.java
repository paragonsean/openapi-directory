...
public class GetObjectStorageTransfer200Response {
  public static final String SERIALIZED_NAME_USED = "used";
  @SerializedName(SERIALIZED_NAME_USED)
  private Integer used;

  public GetObjectStorageTransfer200Response() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GetObjectStorageTransfer200Response getObjectStorageTransfer200Response = (GetObjectStorageTransfer200Response) o;
    return Objects.equals(this.used, getObjectStorageTransfer200Response.used);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetObjectStorageTransfer200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetObjectStorageTransfer200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetObjectStorageTransfer200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetObjectStorageTransfer200Response is not found in the empty JSON string", GetObjectStorageTransfer200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetObjectStorageTransfer200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetObjectStorageTransfer200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetObjectStorageTransfer200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetObjectStorageTransfer200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetObjectStorageTransfer200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetObjectStorageTransfer200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetObjectStorageTransfer200Response>() {
           @Override
           public void write(JsonWriter out, GetObjectStorageTransfer200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetObjectStorageTransfer200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetObjectStorageTransfer200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetObjectStorageTransfer200Response
   * @throws IOException if the JSON string is invalid with respect to GetObjectStorageTransfer200Response
   */
  public static GetObjectStorageTransfer200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetObjectStorageTransfer200Response.class);
  }

  /**
   * Convert an instance of GetObjectStorageTransfer200Response to an JSON string
   *
   * @return JSON string
   */
