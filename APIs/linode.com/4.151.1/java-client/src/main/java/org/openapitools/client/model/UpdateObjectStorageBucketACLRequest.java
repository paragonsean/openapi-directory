...
public class UpdateObjectStorageBucketACLRequest {
  /**
  ...
  public UpdateObjectStorageBucketACLRequest() {
  }

  public UpdateObjectStorageBucketACLRequest acl(AclEnum acl) {
    this.acl = acl;
    return this;
  }
  ...
  public UpdateObjectStorageBucketACLRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateObjectStorageBucketACLRequest updateObjectStorageBucketACLRequest = (UpdateObjectStorageBucketACLRequest) o;
    return Objects.equals(this.acl, updateObjectStorageBucketACLRequest.acl) &&
        Objects.equals(this.name, updateObjectStorageBucketACLRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acl, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateObjectStorageBucketACLRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateObjectStorageBucketACLRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateObjectStorageBucketACLRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateObjectStorageBucketACLRequest is not found in the empty JSON string", UpdateObjectStorageBucketACLRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateObjectStorageBucketACLRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateObjectStorageBucketACLRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateObjectStorageBucketACLRequest.openapiRequiredFields) {
      ...
      // validate the required field `acl`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateObjectStorageBucketACLRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateObjectStorageBucketACLRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateObjectStorageBucketACLRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateObjectStorageBucketACLRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateObjectStorageBucketACLRequest>() {
           @Override
           public void write(JsonWriter out, UpdateObjectStorageBucketACLRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateObjectStorageBucketACLRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateObjectStorageBucketACLRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateObjectStorageBucketACLRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateObjectStorageBucketACLRequest
   */
  public static UpdateObjectStorageBucketACLRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateObjectStorageBucketACLRequest.class);
  }

  /**
   * Convert an instance of UpdateObjectStorageBucketACLRequest to an JSON string
   *
   * @return JSON string
   */
