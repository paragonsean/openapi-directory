...
import org.openapitools.client.model.CancelAccount409ResponseErrorsInner;
...
public class CancelAccount409Response {
  public static final String SERIALIZED_NAME_ERRORS = "errors";
  @SerializedName(SERIALIZED_NAME_ERRORS)
  private List<CancelAccount409ResponseErrorsInner> errors = new ArrayList<>();

  public CancelAccount409Response() {
  }

  public CancelAccount409Response errors(List<CancelAccount409ResponseErrorsInner> errors) {
    this.errors = errors;
    return this;
  }

  public CancelAccount409Response addErrorsItem(CancelAccount409ResponseErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public List<CancelAccount409ResponseErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<CancelAccount409ResponseErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelAccount409Response cancelAccount409Response = (CancelAccount409Response) o;
    return Objects.equals(this.errors, cancelAccount409Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelAccount409Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelAccount409Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelAccount409Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelAccount409Response is not found in the empty JSON string", CancelAccount409Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelAccount409Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelAccount409Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            CancelAccount409ResponseErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelAccount409Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelAccount409Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelAccount409Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelAccount409Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelAccount409Response>() {
           @Override
           public void write(JsonWriter out, CancelAccount409Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelAccount409Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelAccount409Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelAccount409Response
   * @throws IOException if the JSON string is invalid with respect to CancelAccount409Response
   */
  public static CancelAccount409Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelAccount409Response.class);
  }

  /**
   * Convert an instance of CancelAccount409Response to an JSON string
   *
   * @return JSON string
   */
