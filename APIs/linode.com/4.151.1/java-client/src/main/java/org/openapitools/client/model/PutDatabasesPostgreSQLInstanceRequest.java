...
public class PutDatabasesPostgreSQLInstanceRequest {
  ...
  public PutDatabasesPostgreSQLInstanceRequest() {
  }

  public PutDatabasesPostgreSQLInstanceRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public PutDatabasesPostgreSQLInstanceRequest addAllowListItem(String allowListItem) {
  ...
  public PutDatabasesPostgreSQLInstanceRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PutDatabasesPostgreSQLInstanceRequest updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    PutDatabasesPostgreSQLInstanceRequest putDatabasesPostgreSQLInstanceRequest = (PutDatabasesPostgreSQLInstanceRequest) o;
    return Objects.equals(this.allowList, putDatabasesPostgreSQLInstanceRequest.allowList) &&
        Objects.equals(this.label, putDatabasesPostgreSQLInstanceRequest.label) &&
        Objects.equals(this.updates, putDatabasesPostgreSQLInstanceRequest.updates);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDatabasesPostgreSQLInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDatabasesPostgreSQLInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDatabasesPostgreSQLInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDatabasesPostgreSQLInstanceRequest is not found in the empty JSON string", PutDatabasesPostgreSQLInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDatabasesPostgreSQLInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDatabasesPostgreSQLInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDatabasesPostgreSQLInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDatabasesPostgreSQLInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDatabasesPostgreSQLInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDatabasesPostgreSQLInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDatabasesPostgreSQLInstanceRequest>() {
           @Override
           public void write(JsonWriter out, PutDatabasesPostgreSQLInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDatabasesPostgreSQLInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDatabasesPostgreSQLInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDatabasesPostgreSQLInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to PutDatabasesPostgreSQLInstanceRequest
   */
  public static PutDatabasesPostgreSQLInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDatabasesPostgreSQLInstanceRequest.class);
  }

  /**
   * Convert an instance of PutDatabasesPostgreSQLInstanceRequest to an JSON string
   *
   * @return JSON string
   */
