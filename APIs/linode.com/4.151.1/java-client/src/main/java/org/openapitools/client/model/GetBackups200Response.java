...
import org.openapitools.client.model.GetBackups200ResponseAutomaticInner;
import org.openapitools.client.model.GetBackups200ResponseSnapshot;
...
public class GetBackups200Response {
  public static final String SERIALIZED_NAME_AUTOMATIC = "automatic";
  @SerializedName(SERIALIZED_NAME_AUTOMATIC)
  private List<GetBackups200ResponseAutomaticInner> automatic = new ArrayList<>();

  public static final String SERIALIZED_NAME_SNAPSHOT = "snapshot";
  @SerializedName(SERIALIZED_NAME_SNAPSHOT)
  private GetBackups200ResponseSnapshot snapshot;

  public GetBackups200Response() {
  }

  public GetBackups200Response automatic(List<GetBackups200ResponseAutomaticInner> automatic) {
    this.automatic = automatic;
    return this;
  }

  public GetBackups200Response addAutomaticItem(GetBackups200ResponseAutomaticInner automaticItem) {
    if (this.automatic == null) {
      this.automatic = new ArrayList<>();
    }
    this.automatic.add(automaticItem);
    return this;
  }
  ...
  public List<GetBackups200ResponseAutomaticInner> getAutomatic() {
    return automatic;
  }

  public void setAutomatic(List<GetBackups200ResponseAutomaticInner> automatic) {
    this.automatic = automatic;
  }


  public GetBackups200Response snapshot(GetBackups200ResponseSnapshot snapshot) {
   ...
   */
  @javax.annotation.Nullable
  public GetBackups200ResponseSnapshot getSnapshot() {
    return snapshot;
  }

  public void setSnapshot(GetBackups200ResponseSnapshot snapshot) {
    this.snapshot = snapshot;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBackups200Response getBackups200Response = (GetBackups200Response) o;
    return Objects.equals(this.automatic, getBackups200Response.automatic) &&
        Objects.equals(this.snapshot, getBackups200Response.snapshot);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automatic, snapshot);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetBackups200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBackups200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBackups200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBackups200Response is not found in the empty JSON string", GetBackups200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBackups200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBackups200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("automatic") != null && !jsonObj.get("automatic").isJsonNull()) {
        JsonArray jsonArrayautomatic = jsonObj.getAsJsonArray("automatic");
        if (jsonArrayautomatic != null) {
          // ensure the json data is an array
          if (!jsonObj.get("automatic").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `automatic` to be an array in the JSON string but got `%s`", jsonObj.get("automatic").toString()));
          }

          // validate the optional field `automatic` (array)
          for (int i = 0; i < jsonArrayautomatic.size(); i++) {
            GetBackups200ResponseAutomaticInner.validateJsonElement(jsonArrayautomatic.get(i));
          };
        }
      }
      // validate the optional field `snapshot`
      if (jsonObj.get("snapshot") != null && !jsonObj.get("snapshot").isJsonNull()) {
        GetBackups200ResponseSnapshot.validateJsonElement(jsonObj.get("snapshot"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBackups200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBackups200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBackups200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBackups200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBackups200Response>() {
           @Override
           public void write(JsonWriter out, GetBackups200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBackups200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBackups200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBackups200Response
   * @throws IOException if the JSON string is invalid with respect to GetBackups200Response
   */
  public static GetBackups200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBackups200Response.class);
  }

  /**
   * Convert an instance of GetBackups200Response to an JSON string
   *
   * @return JSON string
   */
