...
public class IPv6Pool {
  ...
  public IPv6Pool prefix(Integer prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public IPv6Pool routeTarget(String routeTarget) {
  ...
  public boolean equals(Object o) {
    ...
    IPv6Pool ipv6Pool = (IPv6Pool) o;
    return Objects.equals(this.prefix, ipv6Pool.prefix) &&
        Objects.equals(this.range, ipv6Pool.range) &&
        Objects.equals(this.region, ipv6Pool.region) &&
        Objects.equals(this.routeTarget, ipv6Pool.routeTarget);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(prefix, range, region, routeTarget);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPv6Pool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPv6Pool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPv6Pool is not found in the empty JSON string", IPv6Pool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPv6Pool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPv6Pool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPv6Pool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPv6Pool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPv6Pool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPv6Pool.class));

       return (TypeAdapter<T>) new TypeAdapter<IPv6Pool>() {
           @Override
           public void write(JsonWriter out, IPv6Pool value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPv6Pool read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPv6Pool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPv6Pool
   * @throws IOException if the JSON string is invalid with respect to IPv6Pool
   */
  public static IPv6Pool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPv6Pool.class);
  }

  /**
   * Convert an instance of IPv6Pool to an JSON string
   *
   * @return JSON string
   */
