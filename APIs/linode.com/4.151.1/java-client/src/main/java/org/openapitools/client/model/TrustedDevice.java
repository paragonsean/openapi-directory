...
public class TrustedDevice {
  ...
  public static final String SERIALIZED_NAME_LAST_REMOTE_ADDR = "last_remote_addr";
  @SerializedName(SERIALIZED_NAME_LAST_REMOTE_ADDR)
  ...
  public TrustedDevice(
     ...
     Integer id, 
     OffsetDateTime lastAuthenticated, 
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, trustedDevice.created) &&
        Objects.equals(this.expiry, trustedDevice.expiry) &&
        Objects.equals(this.id, trustedDevice.id) &&
        Objects.equals(this.lastAuthenticated, trustedDevice.lastAuthenticated) &&
        Objects.equals(this.lastRemoteAddr, trustedDevice.lastRemoteAddr) &&
        Objects.equals(this.userAgent, trustedDevice.userAgent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, expiry, id, lastAuthenticated, lastRemoteAddr, userAgent);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastRemoteAddr: ").append(toIndentedString(lastRemoteAddr)).append("\n");
  ...
  static {
    ...
    openapiFields.add("last_remote_addr");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrustedDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrustedDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrustedDevice is not found in the empty JSON string", TrustedDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrustedDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrustedDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("last_remote_addr") != null && !jsonObj.get("last_remote_addr").isJsonNull()) && !jsonObj.get("last_remote_addr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `last_remote_addr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_remote_addr").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrustedDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrustedDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrustedDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrustedDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<TrustedDevice>() {
           @Override
           public void write(JsonWriter out, TrustedDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrustedDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrustedDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrustedDevice
   * @throws IOException if the JSON string is invalid with respect to TrustedDevice
   */
  public static TrustedDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrustedDevice.class);
  }

  /**
   * Convert an instance of TrustedDevice to an JSON string
   *
   * @return JSON string
   */
