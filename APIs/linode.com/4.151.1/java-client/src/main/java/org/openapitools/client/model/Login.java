...
public class Login {
  ...
  public boolean equals(Object o) {
    ...
    Login login = (Login) o;
    return Objects.equals(this.datetime, login.datetime) &&
        Objects.equals(this.id, login.id) &&
        Objects.equals(this.ip, login.ip) &&
        Objects.equals(this.restricted, login.restricted) &&
        Objects.equals(this.status, login.status) &&
        Objects.equals(this.username, login.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datetime, id, ip, restricted, status, username);
  }
