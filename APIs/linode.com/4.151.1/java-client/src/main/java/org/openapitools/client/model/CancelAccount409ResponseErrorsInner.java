...
public class CancelAccount409ResponseErrorsInner {
  public static final String SERIALIZED_NAME_REASON = "reason";
  @SerializedName(SERIALIZED_NAME_REASON)
  private String reason;

  public CancelAccount409ResponseErrorsInner() {
  }

  public CancelAccount409ResponseErrorsInner reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelAccount409ResponseErrorsInner cancelAccount409ResponseErrorsInner = (CancelAccount409ResponseErrorsInner) o;
    return Objects.equals(this.reason, cancelAccount409ResponseErrorsInner.reason);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelAccount409ResponseErrorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelAccount409ResponseErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelAccount409ResponseErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelAccount409ResponseErrorsInner is not found in the empty JSON string", CancelAccount409ResponseErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelAccount409ResponseErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelAccount409ResponseErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelAccount409ResponseErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelAccount409ResponseErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelAccount409ResponseErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelAccount409ResponseErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelAccount409ResponseErrorsInner>() {
           @Override
           public void write(JsonWriter out, CancelAccount409ResponseErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelAccount409ResponseErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelAccount409ResponseErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelAccount409ResponseErrorsInner
   * @throws IOException if the JSON string is invalid with respect to CancelAccount409ResponseErrorsInner
   */
  public static CancelAccount409ResponseErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelAccount409ResponseErrorsInner.class);
  }

  /**
   * Convert an instance of CancelAccount409ResponseErrorsInner to an JSON string
   *
   * @return JSON string
   */
