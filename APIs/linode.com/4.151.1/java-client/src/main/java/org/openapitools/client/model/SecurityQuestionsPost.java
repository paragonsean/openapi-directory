...
import org.openapitools.client.model.SecurityQuestionsPostSecurityQuestionsInner;
...
public class SecurityQuestionsPost {
  ...
  private List<SecurityQuestionsPostSecurityQuestionsInner> securityQuestions = new ArrayList<>();

  public SecurityQuestionsPost() {
  }

  public SecurityQuestionsPost securityQuestions(List<SecurityQuestionsPostSecurityQuestionsInner> securityQuestions) {
    this.securityQuestions = securityQuestions;
    return this;
  }

  public SecurityQuestionsPost addSecurityQuestionsItem(SecurityQuestionsPostSecurityQuestionsInner securityQuestionsItem) {
  ...
  public List<SecurityQuestionsPostSecurityQuestionsInner> getSecurityQuestions() {
    return securityQuestions;
  }

  public void setSecurityQuestions(List<SecurityQuestionsPostSecurityQuestionsInner> securityQuestions) {
    this.securityQuestions = securityQuestions;
  }
  ...
  public boolean equals(Object o) {
    ...
    SecurityQuestionsPost securityQuestionsPost = (SecurityQuestionsPost) o;
    return Objects.equals(this.securityQuestions, securityQuestionsPost.securityQuestions);
  }
  ...
  public String toString() {
    ...
    sb.append("class SecurityQuestionsPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityQuestionsPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityQuestionsPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityQuestionsPost is not found in the empty JSON string", SecurityQuestionsPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityQuestionsPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityQuestionsPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("security_questions") != null && !jsonObj.get("security_questions").isJsonNull()) {
        ...
        if (jsonArraysecurityQuestions != null) {
          ...
          for (int i = 0; i < jsonArraysecurityQuestions.size(); i++) {
            SecurityQuestionsPostSecurityQuestionsInner.validateJsonElement(jsonArraysecurityQuestions.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecurityQuestionsPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecurityQuestionsPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecurityQuestionsPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecurityQuestionsPost.class));

       return (TypeAdapter<T>) new TypeAdapter<SecurityQuestionsPost>() {
           @Override
           public void write(JsonWriter out, SecurityQuestionsPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecurityQuestionsPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecurityQuestionsPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecurityQuestionsPost
   * @throws IOException if the JSON string is invalid with respect to SecurityQuestionsPost
   */
  public static SecurityQuestionsPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecurityQuestionsPost.class);
  }

  /**
   * Convert an instance of SecurityQuestionsPost to an JSON string
   *
   * @return JSON string
   */
