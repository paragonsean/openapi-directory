...
public class GetLKEClusterPools200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LKENodePool> data = new ArrayList<>();
  ...
  public GetLKEClusterPools200Response() {
  }
  ...
  public GetLKEClusterPools200Response data(List<LKENodePool> data) {
    this.data = data;
    return this;
  }

  public GetLKEClusterPools200Response addDataItem(LKENodePool dataItem) {
    if (this.data == null) {
  ...
  public List<LKENodePool> getData() {
    return data;
  }

  public void setData(List<LKENodePool> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterPools200Response getLKEClusterPools200Response = (GetLKEClusterPools200Response) o;
    return Objects.equals(this.data, getLKEClusterPools200Response.data) &&
        Objects.equals(this.page, getLKEClusterPools200Response.page) &&
        Objects.equals(this.pages, getLKEClusterPools200Response.pages) &&
        Objects.equals(this.results, getLKEClusterPools200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusterPools200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterPools200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterPools200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterPools200Response is not found in the empty JSON string", GetLKEClusterPools200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterPools200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterPools200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LKENodePool.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterPools200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterPools200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterPools200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterPools200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterPools200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterPools200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterPools200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterPools200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterPools200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterPools200Response
   */
  public static GetLKEClusterPools200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterPools200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusterPools200Response to an JSON string
   *
   * @return JSON string
   */
