...
import org.openapitools.client.model.ServiceTransferEntities;
...
public class CreateServiceTransferRequest {
  public static final String SERIALIZED_NAME_ENTITIES = "entities";
  @SerializedName(SERIALIZED_NAME_ENTITIES)
  private ServiceTransferEntities entities;

  public CreateServiceTransferRequest() {
  }

  public CreateServiceTransferRequest entities(ServiceTransferEntities entities) {
  ...
  public ServiceTransferEntities getEntities() {
    return entities;
  }

  public void setEntities(ServiceTransferEntities entities) {
    this.entities = entities;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateServiceTransferRequest createServiceTransferRequest = (CreateServiceTransferRequest) o;
    return Objects.equals(this.entities, createServiceTransferRequest.entities);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateServiceTransferRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServiceTransferRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServiceTransferRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServiceTransferRequest is not found in the empty JSON string", CreateServiceTransferRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServiceTransferRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServiceTransferRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateServiceTransferRequest.openapiRequiredFields) {
      ...
      ServiceTransferEntities.validateJsonElement(jsonObj.get("entities"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServiceTransferRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServiceTransferRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServiceTransferRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServiceTransferRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServiceTransferRequest>() {
           @Override
           public void write(JsonWriter out, CreateServiceTransferRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServiceTransferRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServiceTransferRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServiceTransferRequest
   * @throws IOException if the JSON string is invalid with respect to CreateServiceTransferRequest
   */
  public static CreateServiceTransferRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServiceTransferRequest.class);
  }

  /**
   * Convert an instance of CreateServiceTransferRequest to an JSON string
   *
   * @return JSON string
   */
