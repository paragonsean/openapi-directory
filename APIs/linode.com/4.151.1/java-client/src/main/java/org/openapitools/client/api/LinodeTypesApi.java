...
import org.openapitools.client.model.GetLinodeTypes200Response;
...
public class LinodeTypesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LinodeTypesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LinodeTypesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getLinodeType
     * @param typeId The ID of the Linode Type to look up. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A single Linode Type. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getLinodeTypeCall(String typeId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/linode/types/{typeId}"
    ...
    private okhttp3.Call getLinodeTypeValidateBeforeCall(String typeId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'typeId' is set
        if (typeId == null) {
            throw new ApiException("Missing the required parameter 'typeId' when calling getLinodeType(Async)");
        }

        return getLinodeTypeCall(typeId, _callback);
     ...
     */
    public LinodeType getLinodeType(String typeId) throws ApiException {
        ApiResponse<LinodeType> localVarResp = getLinodeTypeWithHttpInfo(typeId);
     ...
     */
    public ApiResponse<LinodeType> getLinodeTypeWithHttpInfo(String typeId) throws ApiException {
        okhttp3.Call localVarCall = getLinodeTypeValidateBeforeCall(typeId, null);
        Type localVarReturnType = new TypeToken<LinodeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Type View (asynchronously)
     * Returns information about a specific Linode Type, including pricing and specifications. This is used when [creating](/docs/api/linode-instances/#linode-create) or [resizing](/docs/api/linode-instances/#linode-resize) Linodes. 
     * @param typeId The ID of the Linode Type to look up. (required)
     ...
     */
    public okhttp3.Call getLinodeTypeAsync(String typeId, final ApiCallback<LinodeType> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLinodeTypeValidateBeforeCall(typeId, _callback);
        Type localVarReturnType = new TypeToken<LinodeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getLinodeTypes
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A collection of Linode Types. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getLinodeTypesCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/linode/types";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLinodeTypesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getLinodeTypesCall(_callback);
     ...
     */
    public GetLinodeTypes200Response getLinodeTypes() throws ApiException {
        ApiResponse<GetLinodeTypes200Response> localVarResp = getLinodeTypesWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Types List
     * Returns collection of Linode Types, including pricing and specifications for each Type. These are used when [creating](/docs/api/linode-instances/#linode-create) or [resizing](/docs/api/linode-instances/#linode-resize) Linodes. 
     * @return ApiResponse&lt;GetLinodeTypes200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetLinodeTypes200Response> getLinodeTypesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getLinodeTypesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetLinodeTypes200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Types List (asynchronously)
     * Returns collection of Linode Types, including pricing and specifications for each Type. These are used when [creating](/docs/api/linode-instances/#linode-create) or [resizing](/docs/api/linode-instances/#linode-resize) Linodes. 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getLinodeTypesAsync(final ApiCallback<GetLinodeTypes200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLinodeTypesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetLinodeTypes200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
