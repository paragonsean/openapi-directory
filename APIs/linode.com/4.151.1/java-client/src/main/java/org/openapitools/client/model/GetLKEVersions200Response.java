...
public class GetLKEVersions200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LKEVersion> data = new ArrayList<>();
  ...
  public GetLKEVersions200Response() {
  }
  ...
  public GetLKEVersions200Response data(List<LKEVersion> data) {
    this.data = data;
    return this;
  }

  public GetLKEVersions200Response addDataItem(LKEVersion dataItem) {
    if (this.data == null) {
  ...
  public List<LKEVersion> getData() {
    return data;
  }

  public void setData(List<LKEVersion> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEVersions200Response getLKEVersions200Response = (GetLKEVersions200Response) o;
    return Objects.equals(this.data, getLKEVersions200Response.data) &&
        Objects.equals(this.page, getLKEVersions200Response.page) &&
        Objects.equals(this.pages, getLKEVersions200Response.pages) &&
        Objects.equals(this.results, getLKEVersions200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEVersions200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEVersions200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEVersions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEVersions200Response is not found in the empty JSON string", GetLKEVersions200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEVersions200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEVersions200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LKEVersion.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEVersions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEVersions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEVersions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEVersions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEVersions200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEVersions200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEVersions200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEVersions200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEVersions200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEVersions200Response
   */
  public static GetLKEVersions200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEVersions200Response.class);
  }

  /**
   * Convert an instance of GetLKEVersions200Response to an JSON string
   *
   * @return JSON string
   */
