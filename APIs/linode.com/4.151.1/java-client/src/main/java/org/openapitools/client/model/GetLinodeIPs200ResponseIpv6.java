...
import org.openapitools.client.model.IPAddressV6LinkLocal;
import org.openapitools.client.model.IPAddressV6Slaac;
...
public class GetLinodeIPs200ResponseIpv6 {
  public static final String SERIALIZED_NAME_GLOBAL = "global";
  @SerializedName(SERIALIZED_NAME_GLOBAL)
  private IPv6Pool global;

  public static final String SERIALIZED_NAME_LINK_LOCAL = "link_local";
  @SerializedName(SERIALIZED_NAME_LINK_LOCAL)
  private IPAddressV6LinkLocal linkLocal;

  public static final String SERIALIZED_NAME_SLAAC = "slaac";
  @SerializedName(SERIALIZED_NAME_SLAAC)
  private IPAddressV6Slaac slaac;

  public GetLinodeIPs200ResponseIpv6() {
  }

  public GetLinodeIPs200ResponseIpv6 global(IPv6Pool global) {
    this.global = global;
    return this;
  }
  ...
  public void setGlobal(IPv6Pool global) {
    this.global = global;
  }


  public GetLinodeIPs200ResponseIpv6 linkLocal(IPAddressV6LinkLocal linkLocal) {
   ...
   */
  @javax.annotation.Nullable
  public IPAddressV6LinkLocal getLinkLocal() {
    return linkLocal;
  }

  public void setLinkLocal(IPAddressV6LinkLocal linkLocal) {
    this.linkLocal = linkLocal;
  }


  public GetLinodeIPs200ResponseIpv6 slaac(IPAddressV6Slaac slaac) {
    this.slaac = slaac;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public IPAddressV6Slaac getSlaac() {
    return slaac;
  }

  public void setSlaac(IPAddressV6Slaac slaac) {
    this.slaac = slaac;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeIPs200ResponseIpv6 getLinodeIPs200ResponseIpv6 = (GetLinodeIPs200ResponseIpv6) o;
    return Objects.equals(this.global, getLinodeIPs200ResponseIpv6.global) &&
        Objects.equals(this.linkLocal, getLinodeIPs200ResponseIpv6.linkLocal) &&
        Objects.equals(this.slaac, getLinodeIPs200ResponseIpv6.slaac);
  }

  @Override
  public int hashCode() {
    return Objects.hash(global, linkLocal, slaac);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLinodeIPs200ResponseIpv6 {\n");
  ...
  static {
    ...
    openapiFields.add("link_local");
    openapiFields.add("slaac");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeIPs200ResponseIpv6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeIPs200ResponseIpv6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeIPs200ResponseIpv6 is not found in the empty JSON string", GetLinodeIPs200ResponseIpv6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeIPs200ResponseIpv6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeIPs200ResponseIpv6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `global`
      if (jsonObj.get("global") != null && !jsonObj.get("global").isJsonNull()) {
        IPv6Pool.validateJsonElement(jsonObj.get("global"));
      }
      // validate the optional field `link_local`
      if (jsonObj.get("link_local") != null && !jsonObj.get("link_local").isJsonNull()) {
        IPAddressV6LinkLocal.validateJsonElement(jsonObj.get("link_local"));
      }
      // validate the optional field `slaac`
      if (jsonObj.get("slaac") != null && !jsonObj.get("slaac").isJsonNull()) {
        IPAddressV6Slaac.validateJsonElement(jsonObj.get("slaac"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeIPs200ResponseIpv6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeIPs200ResponseIpv6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeIPs200ResponseIpv6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeIPs200ResponseIpv6.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeIPs200ResponseIpv6>() {
           @Override
           public void write(JsonWriter out, GetLinodeIPs200ResponseIpv6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeIPs200ResponseIpv6 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeIPs200ResponseIpv6 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeIPs200ResponseIpv6
   * @throws IOException if the JSON string is invalid with respect to GetLinodeIPs200ResponseIpv6
   */
  public static GetLinodeIPs200ResponseIpv6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeIPs200ResponseIpv6.class);
  }

  /**
   * Convert an instance of GetLinodeIPs200ResponseIpv6 to an JSON string
   *
   * @return JSON string
   */
