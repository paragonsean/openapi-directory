...
public class CreateTicketReplyRequest {
  ...
  public CreateTicketReplyRequest() {
  }

  public CreateTicketReplyRequest description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTicketReplyRequest createTicketReplyRequest = (CreateTicketReplyRequest) o;
    return Objects.equals(this.description, createTicketReplyRequest.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTicketReplyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTicketReplyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTicketReplyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTicketReplyRequest is not found in the empty JSON string", CreateTicketReplyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTicketReplyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTicketReplyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateTicketReplyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTicketReplyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTicketReplyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTicketReplyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTicketReplyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTicketReplyRequest>() {
           @Override
           public void write(JsonWriter out, CreateTicketReplyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTicketReplyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTicketReplyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTicketReplyRequest
   * @throws IOException if the JSON string is invalid with respect to CreateTicketReplyRequest
   */
  public static CreateTicketReplyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTicketReplyRequest.class);
  }

  /**
   * Convert an instance of CreateTicketReplyRequest to an JSON string
   *
   * @return JSON string
   */
