...
public class AllocateIPRequest {
  ...
  public AllocateIPRequest() {
  }

  public AllocateIPRequest linodeId(Integer linodeId) {
  ...
  public AllocateIPRequest _public(Boolean _public) {
  ...
  public AllocateIPRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllocateIPRequest allocateIPRequest = (AllocateIPRequest) o;
    return Objects.equals(this.linodeId, allocateIPRequest.linodeId) &&
        Objects.equals(this._public, allocateIPRequest._public) &&
        Objects.equals(this.type, allocateIPRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(linodeId, _public, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AllocateIPRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("linode_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllocateIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllocateIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllocateIPRequest is not found in the empty JSON string", AllocateIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllocateIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllocateIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllocateIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllocateIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllocateIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllocateIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllocateIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AllocateIPRequest>() {
           @Override
           public void write(JsonWriter out, AllocateIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllocateIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllocateIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllocateIPRequest
   * @throws IOException if the JSON string is invalid with respect to AllocateIPRequest
   */
  public static AllocateIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllocateIPRequest.class);
  }

  /**
   * Convert an instance of AllocateIPRequest to an JSON string
   *
   * @return JSON string
   */
