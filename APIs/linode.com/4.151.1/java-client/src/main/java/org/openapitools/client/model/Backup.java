...
public class Backup {
  ...
  public Backup label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.available, backup.available) &&
        Objects.equals(this.configs, backup.configs) &&
        Objects.equals(this.created, backup.created) &&
        Objects.equals(this.disks, backup.disks) &&
        Objects.equals(this.finished, backup.finished) &&
        Objects.equals(this.id, backup.id) &&
        Objects.equals(this.label, backup.label) &&
        Objects.equals(this.status, backup.status) &&
        Objects.equals(this.type, backup.type) &&
        Objects.equals(this.updated, backup.updated);
  }
