...
public class CloneLinodeInstanceRequest {
  ...
  public CloneLinodeInstanceRequest() {
  }

  public CloneLinodeInstanceRequest backupsEnabled(Boolean backupsEnabled) {
  ...
  public CloneLinodeInstanceRequest configs(List<Integer> configs) {
    this.configs = configs;
    return this;
  }

  public CloneLinodeInstanceRequest addConfigsItem(Integer configsItem) {
  ...
  public CloneLinodeInstanceRequest disks(List<Integer> disks) {
    this.disks = disks;
    return this;
  }

  public CloneLinodeInstanceRequest addDisksItem(Integer disksItem) {
    if (this.disks == null) {
  ...
  @Deprecated
  public CloneLinodeInstanceRequest group(String group) {
    this.group = group;
    return this;
  }
  ...
  public CloneLinodeInstanceRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CloneLinodeInstanceRequest linodeId(Integer linodeId) {
  ...
  public CloneLinodeInstanceRequest privateIp(Boolean privateIp) {
  ...
  public CloneLinodeInstanceRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public CloneLinodeInstanceRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloneLinodeInstanceRequest cloneLinodeInstanceRequest = (CloneLinodeInstanceRequest) o;
    return Objects.equals(this.backupsEnabled, cloneLinodeInstanceRequest.backupsEnabled) &&
        Objects.equals(this.configs, cloneLinodeInstanceRequest.configs) &&
        Objects.equals(this.disks, cloneLinodeInstanceRequest.disks) &&
        Objects.equals(this.group, cloneLinodeInstanceRequest.group) &&
        Objects.equals(this.label, cloneLinodeInstanceRequest.label) &&
        Objects.equals(this.linodeId, cloneLinodeInstanceRequest.linodeId) &&
        Objects.equals(this.privateIp, cloneLinodeInstanceRequest.privateIp) &&
        Objects.equals(this.region, cloneLinodeInstanceRequest.region) &&
        Objects.equals(this.type, cloneLinodeInstanceRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backupsEnabled, configs, disks, group, label, linodeId, privateIp, region, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CloneLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloneLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloneLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloneLinodeInstanceRequest is not found in the empty JSON string", CloneLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloneLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloneLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloneLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloneLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloneLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloneLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloneLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, CloneLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloneLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloneLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloneLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to CloneLinodeInstanceRequest
   */
  public static CloneLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloneLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of CloneLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
