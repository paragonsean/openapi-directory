...
public class GetLinodeVolumes200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Volume> data = new ArrayList<>();
  ...
  public GetLinodeVolumes200Response() {
  }
  ...
  public GetLinodeVolumes200Response data(List<Volume> data) {
    this.data = data;
    return this;
  }

  public GetLinodeVolumes200Response addDataItem(Volume dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeVolumes200Response getLinodeVolumes200Response = (GetLinodeVolumes200Response) o;
    return Objects.equals(this.data, getLinodeVolumes200Response.data) &&
        Objects.equals(this.page, getLinodeVolumes200Response.page) &&
        Objects.equals(this.pages, getLinodeVolumes200Response.pages) &&
        Objects.equals(this.results, getLinodeVolumes200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeVolumes200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeVolumes200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeVolumes200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeVolumes200Response is not found in the empty JSON string", GetLinodeVolumes200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeVolumes200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeVolumes200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Volume.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeVolumes200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeVolumes200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeVolumes200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeVolumes200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeVolumes200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeVolumes200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeVolumes200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeVolumes200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeVolumes200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeVolumes200Response
   */
  public static GetLinodeVolumes200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeVolumes200Response.class);
  }

  /**
   * Convert an instance of GetLinodeVolumes200Response to an JSON string
   *
   * @return JSON string
   */
