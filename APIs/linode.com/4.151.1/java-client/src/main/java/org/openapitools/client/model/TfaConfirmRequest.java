...
public class TfaConfirmRequest {
  public static final String SERIALIZED_NAME_TFA_CODE = "tfa_code";
  @SerializedName(SERIALIZED_NAME_TFA_CODE)
  private String tfaCode;

  public TfaConfirmRequest() {
  }

  public TfaConfirmRequest tfaCode(String tfaCode) {
  ...
  public boolean equals(Object o) {
    ...
    TfaConfirmRequest tfaConfirmRequest = (TfaConfirmRequest) o;
    return Objects.equals(this.tfaCode, tfaConfirmRequest.tfaCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tfaCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TfaConfirmRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TfaConfirmRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TfaConfirmRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TfaConfirmRequest is not found in the empty JSON string", TfaConfirmRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TfaConfirmRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TfaConfirmRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("tfa_code") != null && !jsonObj.get("tfa_code").isJsonNull()) && !jsonObj.get("tfa_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tfa_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tfa_code").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TfaConfirmRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TfaConfirmRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TfaConfirmRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TfaConfirmRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TfaConfirmRequest>() {
           @Override
           public void write(JsonWriter out, TfaConfirmRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TfaConfirmRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TfaConfirmRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TfaConfirmRequest
   * @throws IOException if the JSON string is invalid with respect to TfaConfirmRequest
   */
  public static TfaConfirmRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TfaConfirmRequest.class);
  }

  /**
   * Convert an instance of TfaConfirmRequest to an JSON string
   *
   * @return JSON string
   */
