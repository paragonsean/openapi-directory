...
public class GetLinodeTransfer200Response {
  ...
  public GetLinodeTransfer200Response() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeTransfer200Response getLinodeTransfer200Response = (GetLinodeTransfer200Response) o;
    return Objects.equals(this.billable, getLinodeTransfer200Response.billable) &&
        Objects.equals(this.quota, getLinodeTransfer200Response.quota) &&
        Objects.equals(this.used, getLinodeTransfer200Response.used);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billable, quota, used);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLinodeTransfer200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeTransfer200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeTransfer200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeTransfer200Response is not found in the empty JSON string", GetLinodeTransfer200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeTransfer200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeTransfer200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeTransfer200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeTransfer200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeTransfer200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeTransfer200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeTransfer200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeTransfer200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeTransfer200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeTransfer200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeTransfer200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeTransfer200Response
   */
  public static GetLinodeTransfer200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeTransfer200Response.class);
  }

  /**
   * Convert an instance of GetLinodeTransfer200Response to an JSON string
   *
   * @return JSON string
   */
