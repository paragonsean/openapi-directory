...
public class LKENodePoolRequestBodyAutoscaler {
  ...
  public LKENodePoolRequestBodyAutoscaler() {
  }

  public LKENodePoolRequestBodyAutoscaler enabled(Boolean enabled) {
  ...
  public LKENodePoolRequestBodyAutoscaler max(Integer max) {
    this.max = max;
    return this;
  }
  ...
  public LKENodePoolRequestBodyAutoscaler min(Integer min) {
    this.min = min;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodePoolRequestBodyAutoscaler lkENodePoolRequestBodyAutoscaler = (LKENodePoolRequestBodyAutoscaler) o;
    return Objects.equals(this.enabled, lkENodePoolRequestBodyAutoscaler.enabled) &&
        Objects.equals(this.max, lkENodePoolRequestBodyAutoscaler.max) &&
        Objects.equals(this.min, lkENodePoolRequestBodyAutoscaler.min);
  }
  ...
  public String toString() {
    ...
    sb.append("class LKENodePoolRequestBodyAutoscaler {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodePoolRequestBodyAutoscaler
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodePoolRequestBodyAutoscaler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodePoolRequestBodyAutoscaler is not found in the empty JSON string", LKENodePoolRequestBodyAutoscaler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodePoolRequestBodyAutoscaler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodePoolRequestBodyAutoscaler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodePoolRequestBodyAutoscaler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodePoolRequestBodyAutoscaler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodePoolRequestBodyAutoscaler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodePoolRequestBodyAutoscaler.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodePoolRequestBodyAutoscaler>() {
           @Override
           public void write(JsonWriter out, LKENodePoolRequestBodyAutoscaler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodePoolRequestBodyAutoscaler read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodePoolRequestBodyAutoscaler given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodePoolRequestBodyAutoscaler
   * @throws IOException if the JSON string is invalid with respect to LKENodePoolRequestBodyAutoscaler
   */
  public static LKENodePoolRequestBodyAutoscaler fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodePoolRequestBodyAutoscaler.class);
  }

  /**
   * Convert an instance of LKENodePoolRequestBodyAutoscaler to an JSON string
   *
   * @return JSON string
   */
