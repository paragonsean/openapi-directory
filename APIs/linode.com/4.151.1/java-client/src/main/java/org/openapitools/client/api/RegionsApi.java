...
public class RegionsApi {
     ...
     * @param regionId ID of the Region to look up. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A single Region object. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getRegionCall(String regionId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getRegionValidateBeforeCall(String regionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'regionId' is set
        if (regionId == null) {
            throw new ApiException("Missing the required parameter 'regionId' when calling getRegion(Async)");
        }

        return getRegionCall(regionId, _callback);
     ...
     */
    public ApiResponse<Region> getRegionWithHttpInfo(String regionId) throws ApiException {
     ...
     */
    public okhttp3.Call getRegionAsync(String regionId, final ApiCallback<Region> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns an array of Regions. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public GetRegions200Response getRegions() throws ApiException {
        ApiResponse<GetRegions200Response> localVarResp = getRegionsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetRegions200Response> getRegionsWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getRegionsAsync(final ApiCallback<GetRegions200Response> _callback) throws ApiException {
