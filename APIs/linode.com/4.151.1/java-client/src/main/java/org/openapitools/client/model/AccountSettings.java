...
public class AccountSettings {
  ...
  public static final String SERIALIZED_NAME_LONGVIEW_SUBSCRIPTION = "longview_subscription";
  @SerializedName(SERIALIZED_NAME_LONGVIEW_SUBSCRIPTION)
  ...
  public static final String SERIALIZED_NAME_NETWORK_HELPER = "network_helper";
  @SerializedName(SERIALIZED_NAME_NETWORK_HELPER)
  private Boolean networkHelper;

  /**
   * A string describing the status of this account&#39;s Object Storage service enrollment. 
   */
  @JsonAdapter(ObjectStorageEnum.Adapter.class)
  public enum ObjectStorageEnum {
    ...
    ObjectStorageEnum(String value) {
      this.value = value;
    }
    ...
    public static ObjectStorageEnum fromValue(String value) {
      for (ObjectStorageEnum b : ObjectStorageEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ObjectStorageEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ObjectStorageEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ObjectStorageEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ObjectStorageEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ObjectStorageEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_OBJECT_STORAGE = "object_storage";
  @SerializedName(SERIALIZED_NAME_OBJECT_STORAGE)
  private ObjectStorageEnum objectStorage = ObjectStorageEnum.DISABLED;
  ...
  public AccountSettings(
     ...
     Boolean managed, 
     ObjectStorageEnum objectStorage
  ) {
    this();
  ...
  public AccountSettings backupsEnabled(Boolean backupsEnabled) {
   ...
   */
  @javax.annotation.Nullable
  public String getLongviewSubscription() {
    return longviewSubscription;
  }
  ...
  public AccountSettings networkHelper(Boolean networkHelper) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getNetworkHelper() {
    return networkHelper;
  }

  public void setNetworkHelper(Boolean networkHelper) {
    this.networkHelper = networkHelper;
  }
   ...
   */
  @javax.annotation.Nullable
  public ObjectStorageEnum getObjectStorage() {
    return objectStorage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backupsEnabled, accountSettings.backupsEnabled) &&
        Objects.equals(this.longviewSubscription, accountSettings.longviewSubscription) &&
        Objects.equals(this.managed, accountSettings.managed) &&
        Objects.equals(this.networkHelper, accountSettings.networkHelper) &&
        Objects.equals(this.objectStorage, accountSettings.objectStorage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backupsEnabled, longviewSubscription, managed, networkHelper, objectStorage);
  }
  ...
  public String toString() {
    ...
    sb.append("    longviewSubscription: ").append(toIndentedString(longviewSubscription)).append("\n");
    sb.append("    managed: ").append(toIndentedString(managed)).append("\n");
    sb.append("    networkHelper: ").append(toIndentedString(networkHelper)).append("\n");
  ...
  static {
    ...
    openapiFields.add("longview_subscription");
    openapiFields.add("managed");
    openapiFields.add("network_helper");
    openapiFields.add("object_storage");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("longview_subscription") != null && !jsonObj.get("longview_subscription").isJsonNull()) && !jsonObj.get("longview_subscription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `longview_subscription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("longview_subscription").toString()));
      }
      if ((jsonObj.get("object_storage") != null && !jsonObj.get("object_storage").isJsonNull()) && !jsonObj.get("object_storage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `object_storage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("object_storage").toString()));
      }
      // validate the optional field `object_storage`
      if (jsonObj.get("object_storage") != null && !jsonObj.get("object_storage").isJsonNull()) {
        ObjectStorageEnum.validateJsonElement(jsonObj.get("object_storage"));
      }
  }
