...
public class GetDomains200Response {
  ...
  public GetDomains200Response data(List<Domain> data) {
    this.data = data;
    return this;
  }

  public GetDomains200Response addDataItem(Domain dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetDomains200Response getDomains200Response = (GetDomains200Response) o;
    return Objects.equals(this.data, getDomains200Response.data) &&
        Objects.equals(this.page, getDomains200Response.page) &&
        Objects.equals(this.pages, getDomains200Response.pages) &&
        Objects.equals(this.results, getDomains200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDomains200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomains200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomains200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDomains200Response is not found in the empty JSON string", GetDomains200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomains200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDomains200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomains200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomains200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomains200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomains200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomains200Response>() {
           @Override
           public void write(JsonWriter out, GetDomains200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomains200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomains200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomains200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomains200Response
   */
  public static GetDomains200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomains200Response.class);
  }

  /**
   * Convert an instance of GetDomains200Response to an JSON string
   *
   * @return JSON string
   */
