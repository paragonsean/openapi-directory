...
public class MutateLinodeInstanceRequest {
  ...
  public MutateLinodeInstanceRequest() {
  }

  public MutateLinodeInstanceRequest allowAutoDiskResize(Boolean allowAutoDiskResize) {
  ...
  public boolean equals(Object o) {
    ...
    MutateLinodeInstanceRequest mutateLinodeInstanceRequest = (MutateLinodeInstanceRequest) o;
    return Objects.equals(this.allowAutoDiskResize, mutateLinodeInstanceRequest.allowAutoDiskResize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowAutoDiskResize);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MutateLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MutateLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MutateLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MutateLinodeInstanceRequest is not found in the empty JSON string", MutateLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MutateLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MutateLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MutateLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MutateLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MutateLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MutateLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MutateLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, MutateLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MutateLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MutateLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MutateLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to MutateLinodeInstanceRequest
   */
  public static MutateLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MutateLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of MutateLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
