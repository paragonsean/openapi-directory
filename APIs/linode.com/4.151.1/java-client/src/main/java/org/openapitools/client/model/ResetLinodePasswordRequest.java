...
public class ResetLinodePasswordRequest {
  public static final String SERIALIZED_NAME_ROOT_PASS = "root_pass";
  @SerializedName(SERIALIZED_NAME_ROOT_PASS)
  private String rootPass;

  public ResetLinodePasswordRequest() {
  }

  public ResetLinodePasswordRequest rootPass(String rootPass) {
  ...
  public boolean equals(Object o) {
    ...
    ResetLinodePasswordRequest resetLinodePasswordRequest = (ResetLinodePasswordRequest) o;
    return Objects.equals(this.rootPass, resetLinodePasswordRequest.rootPass);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rootPass);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResetLinodePasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResetLinodePasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetLinodePasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResetLinodePasswordRequest is not found in the empty JSON string", ResetLinodePasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResetLinodePasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResetLinodePasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResetLinodePasswordRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("root_pass").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResetLinodePasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResetLinodePasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResetLinodePasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResetLinodePasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResetLinodePasswordRequest>() {
           @Override
           public void write(JsonWriter out, ResetLinodePasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResetLinodePasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResetLinodePasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResetLinodePasswordRequest
   * @throws IOException if the JSON string is invalid with respect to ResetLinodePasswordRequest
   */
  public static ResetLinodePasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResetLinodePasswordRequest.class);
  }

  /**
   * Convert an instance of ResetLinodePasswordRequest to an JSON string
   *
   * @return JSON string
   */
