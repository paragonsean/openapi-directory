...
public class BackupDisksInner {
  ...
  public enum FilesystemEnum {
    ...
    public static FilesystemEnum fromValue(String value) {
    ...
    public static class Adapter extends TypeAdapter<FilesystemEnum> {
      ...
      public FilesystemEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return FilesystemEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      FilesystemEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_FILESYSTEM = "filesystem";
  @SerializedName(SERIALIZED_NAME_FILESYSTEM)
  private FilesystemEnum filesystem;
  ...
  public BackupDisksInner() {
  }

  public BackupDisksInner filesystem(FilesystemEnum filesystem) {
  ...
  public BackupDisksInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public BackupDisksInner size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BackupDisksInner backupDisksInner = (BackupDisksInner) o;
    return Objects.equals(this.filesystem, backupDisksInner.filesystem) &&
        Objects.equals(this.label, backupDisksInner.label) &&
        Objects.equals(this.size, backupDisksInner.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filesystem, label, size);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BackupDisksInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BackupDisksInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BackupDisksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackupDisksInner is not found in the empty JSON string", BackupDisksInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BackupDisksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BackupDisksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("filesystem") != null && !jsonObj.get("filesystem").isJsonNull()) {
        FilesystemEnum.validateJsonElement(jsonObj.get("filesystem"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackupDisksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackupDisksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackupDisksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackupDisksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BackupDisksInner>() {
           @Override
           public void write(JsonWriter out, BackupDisksInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BackupDisksInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BackupDisksInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BackupDisksInner
   * @throws IOException if the JSON string is invalid with respect to BackupDisksInner
   */
  public static BackupDisksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackupDisksInner.class);
  }

  /**
   * Convert an instance of BackupDisksInner to an JSON string
   *
   * @return JSON string
   */
