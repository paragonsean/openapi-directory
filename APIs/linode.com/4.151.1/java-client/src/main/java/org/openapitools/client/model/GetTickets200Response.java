...
public class GetTickets200Response {
  ...
  public GetTickets200Response data(List<SupportTicket> data) {
    this.data = data;
    return this;
  }

  public GetTickets200Response addDataItem(SupportTicket dataItem) {
    if (this.data == null) {
  ...
  public List<SupportTicket> getData() {
    return data;
  }

  public void setData(List<SupportTicket> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTickets200Response getTickets200Response = (GetTickets200Response) o;
    return Objects.equals(this.data, getTickets200Response.data) &&
        Objects.equals(this.page, getTickets200Response.page) &&
        Objects.equals(this.pages, getTickets200Response.pages) &&
        Objects.equals(this.results, getTickets200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTickets200Response {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTickets200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTickets200Response is not found in the empty JSON string", GetTickets200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTickets200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTickets200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SupportTicket.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<GetTickets200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTickets200Response.class));
