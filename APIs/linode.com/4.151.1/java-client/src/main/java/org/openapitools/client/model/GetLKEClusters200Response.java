...
public class GetLKEClusters200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LKECluster> data = new ArrayList<>();
  ...
  public GetLKEClusters200Response() {
  }
  ...
  public GetLKEClusters200Response data(List<LKECluster> data) {
    this.data = data;
    return this;
  }

  public GetLKEClusters200Response addDataItem(LKECluster dataItem) {
    if (this.data == null) {
  ...
  public List<LKECluster> getData() {
    return data;
  }

  public void setData(List<LKECluster> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusters200Response getLKEClusters200Response = (GetLKEClusters200Response) o;
    return Objects.equals(this.data, getLKEClusters200Response.data) &&
        Objects.equals(this.page, getLKEClusters200Response.page) &&
        Objects.equals(this.pages, getLKEClusters200Response.pages) &&
        Objects.equals(this.results, getLKEClusters200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusters200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusters200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusters200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusters200Response is not found in the empty JSON string", GetLKEClusters200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusters200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusters200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LKECluster.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusters200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusters200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusters200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusters200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusters200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusters200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusters200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusters200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusters200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusters200Response
   */
  public static GetLKEClusters200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusters200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusters200Response to an JSON string
   *
   * @return JSON string
   */
