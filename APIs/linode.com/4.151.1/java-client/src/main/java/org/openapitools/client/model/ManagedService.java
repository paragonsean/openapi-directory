...
public class ManagedService {
  ...
  public static final String SERIALIZED_NAME_CONSULTATION_GROUP = "consultation_group";
  @SerializedName(SERIALIZED_NAME_CONSULTATION_GROUP)
  ...
  public ManagedService address(String address) {
  ...
  public ManagedService body(String body) {
    this.body = body;
    return this;
  }
  ...
  public ManagedService consultationGroup(String consultationGroup) {
    this.consultationGroup = consultationGroup;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getConsultationGroup() {
    return consultationGroup;
  }

  public void setConsultationGroup(String consultationGroup) {
    this.consultationGroup = consultationGroup;
  }
  ...
  public ManagedService credentials(List<Integer> credentials) {
    this.credentials = credentials;
    return this;
  }

  public ManagedService addCredentialsItem(Integer credentialsItem) {
  ...
  public ManagedService label(String label) {
    this.label = label;
    return this;
  }
  ...
  public ManagedService notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public ManagedService region(String region) {
    this.region = region;
    return this;
  }
  ...
  public ManagedService serviceType(ServiceTypeEnum serviceType) {
  ...
  public ManagedService timeout(Integer timeout) {
  ...
  public boolean equals(Object o) {
    ...
    ManagedService managedService = (ManagedService) o;
    return Objects.equals(this.address, managedService.address) &&
        Objects.equals(this.body, managedService.body) &&
        Objects.equals(this.consultationGroup, managedService.consultationGroup) &&
        Objects.equals(this.created, managedService.created) &&
        Objects.equals(this.credentials, managedService.credentials) &&
        Objects.equals(this.id, managedService.id) &&
        Objects.equals(this.label, managedService.label) &&
        Objects.equals(this.notes, managedService.notes) &&
        Objects.equals(this.region, managedService.region) &&
        Objects.equals(this.serviceType, managedService.serviceType) &&
        Objects.equals(this.status, managedService.status) &&
        Objects.equals(this.timeout, managedService.timeout) &&
        Objects.equals(this.updated, managedService.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, body, consultationGroup, created, credentials, id, label, notes, region, serviceType, status, timeout, updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagedService {\n");
    sb.append("    address: ").append(toIndentedString(address)).append("\n");
    sb.append("    body: ").append(toIndentedString(body)).append("\n");
    sb.append("    consultationGroup: ").append(toIndentedString(consultationGroup)).append("\n");
  ...
  static {
    ...
    openapiFields.add("consultation_group");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedService is not found in the empty JSON string", ManagedService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("consultation_group") != null && !jsonObj.get("consultation_group").isJsonNull()) && !jsonObj.get("consultation_group").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `consultation_group` to be a primitive type in the JSON string but got `%s`", jsonObj.get("consultation_group").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedService.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedService>() {
           @Override
           public void write(JsonWriter out, ManagedService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedService
   * @throws IOException if the JSON string is invalid with respect to ManagedService
   */
  public static ManagedService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedService.class);
  }

  /**
   * Convert an instance of ManagedService to an JSON string
   *
   * @return JSON string
   */
