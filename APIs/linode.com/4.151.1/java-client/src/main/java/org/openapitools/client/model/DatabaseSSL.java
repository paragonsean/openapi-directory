...
public class DatabaseSSL {
  ...
  public DatabaseSSL caCertificate(String caCertificate) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseSSL databaseSSL = (DatabaseSSL) o;
    return Objects.equals(this.caCertificate, databaseSSL.caCertificate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caCertificate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseSSL {\n");
  ...
  static {
    ...
    openapiFields.add("ca_certificate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseSSL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseSSL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseSSL is not found in the empty JSON string", DatabaseSSL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseSSL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseSSL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("ca_certificate") != null && !jsonObj.get("ca_certificate").isJsonNull()) && !jsonObj.get("ca_certificate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ca_certificate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ca_certificate").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseSSL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseSSL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseSSL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseSSL.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseSSL>() {
           @Override
           public void write(JsonWriter out, DatabaseSSL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseSSL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseSSL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseSSL
   * @throws IOException if the JSON string is invalid with respect to DatabaseSSL
   */
  public static DatabaseSSL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseSSL.class);
  }

  /**
   * Convert an instance of DatabaseSSL to an JSON string
   *
   * @return JSON string
   */
