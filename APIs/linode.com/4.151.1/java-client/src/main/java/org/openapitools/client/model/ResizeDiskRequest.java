...
public class ResizeDiskRequest {
  ...
  public ResizeDiskRequest size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResizeDiskRequest resizeDiskRequest = (ResizeDiskRequest) o;
    return Objects.equals(this.size, resizeDiskRequest.size);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResizeDiskRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResizeDiskRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResizeDiskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResizeDiskRequest is not found in the empty JSON string", ResizeDiskRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResizeDiskRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResizeDiskRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResizeDiskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResizeDiskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResizeDiskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResizeDiskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResizeDiskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResizeDiskRequest>() {
           @Override
           public void write(JsonWriter out, ResizeDiskRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResizeDiskRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResizeDiskRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResizeDiskRequest
   * @throws IOException if the JSON string is invalid with respect to ResizeDiskRequest
   */
  public static ResizeDiskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResizeDiskRequest.class);
  }

  /**
   * Convert an instance of ResizeDiskRequest to an JSON string
   *
   * @return JSON string
   */
