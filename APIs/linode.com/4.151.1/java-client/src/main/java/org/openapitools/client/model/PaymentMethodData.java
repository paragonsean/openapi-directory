...
import org.openapitools.client.model.CreditCardData;
import org.openapitools.client.model.GooglePayData;
import org.openapitools.client.model.PayPalData;
...
public class PaymentMethodData extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CreditCardData> adapterCreditCardData = gson.getDelegateAdapter(this, TypeToken.get(CreditCardData.class));
            final TypeAdapter<GooglePayData> adapterGooglePayData = gson.getDelegateAdapter(this, TypeToken.get(GooglePayData.class));
            final TypeAdapter<PayPalData> adapterPayPalData = gson.getDelegateAdapter(this, TypeToken.get(PayPalData.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<PaymentMethodData>() {
                ...
                public void write(JsonWriter out, PaymentMethodData value) throws IOException {
                    ...
                    // check if the actual instance is of the type `CreditCardData`
                    if (value.getActualInstance() instanceof CreditCardData) {
                        JsonElement element = adapterCreditCardData.toJsonTree((CreditCardData)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `GooglePayData`
                    if (value.getActualInstance() instanceof GooglePayData) {
                        JsonElement element = adapterGooglePayData.toJsonTree((GooglePayData)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `PayPalData`
                    if (value.getActualInstance() instanceof PayPalData) {
                        JsonElement element = adapterPayPalData.toJsonTree((PayPalData)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: CreditCardData, GooglePayData, PayPalData");
                }
                ...
                public PaymentMethodData read(JsonReader in) throws IOException {
                    ...
                    // deserialize CreditCardData
                    try {
                        // validate the JSON object to see if any exception is thrown
                        CreditCardData.validateJsonElement(jsonElement);
                        actualAdapter = adapterCreditCardData;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'CreditCardData'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for CreditCardData failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CreditCardData'", e);
                    }
                    // deserialize GooglePayData
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GooglePayData.validateJsonElement(jsonElement);
                        actualAdapter = adapterGooglePayData;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GooglePayData'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GooglePayData failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GooglePayData'", e);
                    }
                    // deserialize PayPalData
                    try {
                        // validate the JSON object to see if any exception is thrown
                        PayPalData.validateJsonElement(jsonElement);
                        actualAdapter = adapterPayPalData;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'PayPalData'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for PayPalData failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'PayPalData'", e);
                    }
                    ...
                    throw new IOException(String.format("Failed deserialization for PaymentMethodData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PaymentMethodData(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("CreditCardData", CreditCardData.class);
        schemas.put("GooglePayData", GooglePayData.class);
        schemas.put("PayPalData", PayPalData.class);
    }
     ...
     * CreditCardData, GooglePayData, PayPalData
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof CreditCardData) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof GooglePayData) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof PayPalData) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be CreditCardData, GooglePayData, PayPalData");
    }
     ...
     * CreditCardData, GooglePayData, PayPalData
     *
     * @return The actual instance (CreditCardData, GooglePayData, PayPalData)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `CreditCardData`. If the actual instance is not `CreditCardData`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CreditCardData`
     * @throws ClassCastException if the instance is not `CreditCardData`
     */
    public CreditCardData getCreditCardData() throws ClassCastException {
        return (CreditCardData)super.getActualInstance();
    }
    /**
     * Get the actual instance of `GooglePayData`. If the actual instance is not `GooglePayData`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GooglePayData`
     * @throws ClassCastException if the instance is not `GooglePayData`
     */
    public GooglePayData getGooglePayData() throws ClassCastException {
        return (GooglePayData)super.getActualInstance();
    }
    /**
     * Get the actual instance of `PayPalData`. If the actual instance is not `PayPalData`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `PayPalData`
     * @throws ClassCastException if the instance is not `PayPalData`
     */
    public PayPalData getPayPalData() throws ClassCastException {
        return (PayPalData)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with CreditCardData
        try {
            CreditCardData.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with GooglePayData
        try {
            GooglePayData.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with PayPalData
        try {
            PayPalData.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for PaymentMethodData with oneOf schemas: CreditCardData, GooglePayData, PayPalData. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
