...
public class CreateObjectStorageObjectURLRequest {
  ...
  public CreateObjectStorageObjectURLRequest() {
  }

  public CreateObjectStorageObjectURLRequest contentType(String contentType) {
  ...
  public CreateObjectStorageObjectURLRequest expiresIn(Integer expiresIn) {
  ...
  public CreateObjectStorageObjectURLRequest method(String method) {
    this.method = method;
    return this;
  }
  ...
  public CreateObjectStorageObjectURLRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateObjectStorageObjectURLRequest createObjectStorageObjectURLRequest = (CreateObjectStorageObjectURLRequest) o;
    return Objects.equals(this.contentType, createObjectStorageObjectURLRequest.contentType) &&
        Objects.equals(this.expiresIn, createObjectStorageObjectURLRequest.expiresIn) &&
        Objects.equals(this.method, createObjectStorageObjectURLRequest.method) &&
        Objects.equals(this.name, createObjectStorageObjectURLRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentType, expiresIn, method, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateObjectStorageObjectURLRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateObjectStorageObjectURLRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateObjectStorageObjectURLRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateObjectStorageObjectURLRequest is not found in the empty JSON string", CreateObjectStorageObjectURLRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateObjectStorageObjectURLRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateObjectStorageObjectURLRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateObjectStorageObjectURLRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateObjectStorageObjectURLRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateObjectStorageObjectURLRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateObjectStorageObjectURLRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateObjectStorageObjectURLRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateObjectStorageObjectURLRequest>() {
           @Override
           public void write(JsonWriter out, CreateObjectStorageObjectURLRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateObjectStorageObjectURLRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateObjectStorageObjectURLRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateObjectStorageObjectURLRequest
   * @throws IOException if the JSON string is invalid with respect to CreateObjectStorageObjectURLRequest
   */
  public static CreateObjectStorageObjectURLRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateObjectStorageObjectURLRequest.class);
  }

  /**
   * Convert an instance of CreateObjectStorageObjectURLRequest to an JSON string
   *
   * @return JSON string
   */
