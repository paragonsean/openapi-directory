...
public class RebuildNodeBalancerConfigRequest {
  /**
  ...
  private List<RebuildNodeBalancerConfigRequestAllOfNodesInner> nodes = new ArrayList<>();

  public RebuildNodeBalancerConfigRequest() {
  }
  ...
  public RebuildNodeBalancerConfigRequest algorithm(AlgorithmEnum algorithm) {
  ...
  public RebuildNodeBalancerConfigRequest check(CheckEnum check) {
    this.check = check;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequest checkAttempts(Integer checkAttempts) {
  ...
  public RebuildNodeBalancerConfigRequest checkBody(String checkBody) {
  ...
  public RebuildNodeBalancerConfigRequest checkInterval(Integer checkInterval) {
  ...
  public RebuildNodeBalancerConfigRequest checkPassive(Boolean checkPassive) {
  ...
  public RebuildNodeBalancerConfigRequest checkPath(String checkPath) {
  ...
  public RebuildNodeBalancerConfigRequest checkTimeout(Integer checkTimeout) {
  ...
  public RebuildNodeBalancerConfigRequest cipherSuite(CipherSuiteEnum cipherSuite) {
  ...
  public RebuildNodeBalancerConfigRequest nodesStatus(NodeBalancerConfigNodesStatus nodesStatus) {
  ...
  public RebuildNodeBalancerConfigRequest port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequest protocol(ProtocolEnum protocol) {
  ...
  public RebuildNodeBalancerConfigRequest proxyProtocol(ProxyProtocolEnum proxyProtocol) {
  ...
  public RebuildNodeBalancerConfigRequest sslCert(String sslCert) {
  ...
  public RebuildNodeBalancerConfigRequest sslKey(String sslKey) {
    this.sslKey = sslKey;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequest stickiness(StickinessEnum stickiness) {
  ...
  public RebuildNodeBalancerConfigRequest nodes(List<RebuildNodeBalancerConfigRequestAllOfNodesInner> nodes) {
    this.nodes = nodes;
    return this;
  }

  public RebuildNodeBalancerConfigRequest addNodesItem(RebuildNodeBalancerConfigRequestAllOfNodesInner nodesItem) {
    if (this.nodes == null) {
  ...
  public List<RebuildNodeBalancerConfigRequestAllOfNodesInner> getNodes() {
    return nodes;
  }

  public void setNodes(List<RebuildNodeBalancerConfigRequestAllOfNodesInner> nodes) {
    this.nodes = nodes;
  }
  ...
  public boolean equals(Object o) {
    ...
    RebuildNodeBalancerConfigRequest rebuildNodeBalancerConfigRequest = (RebuildNodeBalancerConfigRequest) o;
    return Objects.equals(this.algorithm, rebuildNodeBalancerConfigRequest.algorithm) &&
        Objects.equals(this.check, rebuildNodeBalancerConfigRequest.check) &&
        Objects.equals(this.checkAttempts, rebuildNodeBalancerConfigRequest.checkAttempts) &&
        Objects.equals(this.checkBody, rebuildNodeBalancerConfigRequest.checkBody) &&
        Objects.equals(this.checkInterval, rebuildNodeBalancerConfigRequest.checkInterval) &&
        Objects.equals(this.checkPassive, rebuildNodeBalancerConfigRequest.checkPassive) &&
        Objects.equals(this.checkPath, rebuildNodeBalancerConfigRequest.checkPath) &&
        Objects.equals(this.checkTimeout, rebuildNodeBalancerConfigRequest.checkTimeout) &&
        Objects.equals(this.cipherSuite, rebuildNodeBalancerConfigRequest.cipherSuite) &&
        Objects.equals(this.id, rebuildNodeBalancerConfigRequest.id) &&
        Objects.equals(this.nodebalancerId, rebuildNodeBalancerConfigRequest.nodebalancerId) &&
        Objects.equals(this.nodesStatus, rebuildNodeBalancerConfigRequest.nodesStatus) &&
        Objects.equals(this.port, rebuildNodeBalancerConfigRequest.port) &&
        Objects.equals(this.protocol, rebuildNodeBalancerConfigRequest.protocol) &&
        Objects.equals(this.proxyProtocol, rebuildNodeBalancerConfigRequest.proxyProtocol) &&
        Objects.equals(this.sslCert, rebuildNodeBalancerConfigRequest.sslCert) &&
        Objects.equals(this.sslCommonname, rebuildNodeBalancerConfigRequest.sslCommonname) &&
        Objects.equals(this.sslFingerprint, rebuildNodeBalancerConfigRequest.sslFingerprint) &&
        Objects.equals(this.sslKey, rebuildNodeBalancerConfigRequest.sslKey) &&
        Objects.equals(this.stickiness, rebuildNodeBalancerConfigRequest.stickiness) &&
        Objects.equals(this.nodes, rebuildNodeBalancerConfigRequest.nodes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(algorithm, check, checkAttempts, checkBody, checkInterval, checkPassive, checkPath, checkTimeout, cipherSuite, id, nodebalancerId, nodesStatus, port, protocol, proxyProtocol, sslCert, sslCommonname, sslFingerprint, sslKey, stickiness, nodes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RebuildNodeBalancerConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebuildNodeBalancerConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebuildNodeBalancerConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RebuildNodeBalancerConfigRequest is not found in the empty JSON string", RebuildNodeBalancerConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RebuildNodeBalancerConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RebuildNodeBalancerConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RebuildNodeBalancerConfigRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraynodes.size(); i++) {
        RebuildNodeBalancerConfigRequestAllOfNodesInner.validateJsonElement(jsonArraynodes.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RebuildNodeBalancerConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RebuildNodeBalancerConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RebuildNodeBalancerConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RebuildNodeBalancerConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RebuildNodeBalancerConfigRequest>() {
           @Override
           public void write(JsonWriter out, RebuildNodeBalancerConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RebuildNodeBalancerConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RebuildNodeBalancerConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RebuildNodeBalancerConfigRequest
   * @throws IOException if the JSON string is invalid with respect to RebuildNodeBalancerConfigRequest
   */
  public static RebuildNodeBalancerConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RebuildNodeBalancerConfigRequest.class);
  }

  /**
   * Convert an instance of RebuildNodeBalancerConfigRequest to an JSON string
   *
   * @return JSON string
   */
