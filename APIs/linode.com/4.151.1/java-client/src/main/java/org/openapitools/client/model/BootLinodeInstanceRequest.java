...
public class BootLinodeInstanceRequest {
  public static final String SERIALIZED_NAME_CONFIG_ID = "config_id";
  @SerializedName(SERIALIZED_NAME_CONFIG_ID)
  private Integer configId;

  public BootLinodeInstanceRequest() {
  }

  public BootLinodeInstanceRequest configId(Integer configId) {
  ...
  public boolean equals(Object o) {
    ...
    BootLinodeInstanceRequest bootLinodeInstanceRequest = (BootLinodeInstanceRequest) o;
    return Objects.equals(this.configId, bootLinodeInstanceRequest.configId);
  }
  ...
  public String toString() {
    ...
    sb.append("class BootLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BootLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BootLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BootLinodeInstanceRequest is not found in the empty JSON string", BootLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BootLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BootLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BootLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BootLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BootLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BootLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BootLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, BootLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BootLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BootLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BootLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to BootLinodeInstanceRequest
   */
  public static BootLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BootLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of BootLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
