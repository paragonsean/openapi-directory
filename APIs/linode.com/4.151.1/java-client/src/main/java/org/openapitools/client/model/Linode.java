...
public class Linode {
   ...
   */
  @JsonAdapter(HypervisorEnum.Adapter.class)
  public enum HypervisorEnum {
    ...
    public static class Adapter extends TypeAdapter<HypervisorEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final HypervisorEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public HypervisorEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return HypervisorEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      HypervisorEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_HYPERVISOR = "hypervisor";
  @SerializedName(SERIALIZED_NAME_HYPERVISOR)
  private HypervisorEnum hypervisor;
  ...
  public static final String SERIALIZED_NAME_WATCHDOG_ENABLED = "watchdog_enabled";
  @SerializedName(SERIALIZED_NAME_WATCHDOG_ENABLED)
  ...
  public Linode alerts(LinodeAlerts alerts) {
    this.alerts = alerts;
    return this;
  }
  ...
  public LinodeAlerts getAlerts() {
    return alerts;
  }

  public void setAlerts(LinodeAlerts alerts) {
    this.alerts = alerts;
  }


  public Linode backups(LinodeBackups backups) {
   ...
   */
  @javax.annotation.Nullable
  public LinodeBackups getBackups() {
    return backups;
  }

  public void setBackups(LinodeBackups backups) {
    this.backups = backups;
  }
  ...
  @Deprecated
  public Linode group(String group) {
    this.group = group;
    return this;
  }
  ...
  public Linode label(String label) {
    this.label = label;
    return this;
  }
  ...
  public Linode specs(LinodeSpecs specs) {
    this.specs = specs;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LinodeSpecs getSpecs() {
    return specs;
  }

  public void setSpecs(LinodeSpecs specs) {
    this.specs = specs;
  }
  ...
  public Linode tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public Linode addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public Linode watchdogEnabled(Boolean watchdogEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alerts, linode.alerts) &&
        Objects.equals(this.backups, linode.backups) &&
        Objects.equals(this.created, linode.created) &&
        Objects.equals(this.group, linode.group) &&
        Objects.equals(this.hostUuid, linode.hostUuid) &&
        Objects.equals(this.hypervisor, linode.hypervisor) &&
        Objects.equals(this.id, linode.id) &&
        Objects.equals(this.image, linode.image) &&
        Objects.equals(this.ipv4, linode.ipv4) &&
        Objects.equals(this.ipv6, linode.ipv6) &&
        Objects.equals(this.label, linode.label) &&
        Objects.equals(this.region, linode.region) &&
        Objects.equals(this.specs, linode.specs) &&
        Objects.equals(this.status, linode.status) &&
        Objects.equals(this.tags, linode.tags) &&
        Objects.equals(this.type, linode.type) &&
        Objects.equals(this.updated, linode.updated) &&
        Objects.equals(this.watchdogEnabled, linode.watchdogEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alerts, backups, created, group, hostUuid, hypervisor, id, image, ipv4, ipv6, label, region, specs, status, tags, type, updated, watchdogEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("    watchdogEnabled: ").append(toIndentedString(watchdogEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("watchdog_enabled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Linode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Linode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Linode is not found in the empty JSON string", Linode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Linode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Linode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `alerts`
      if (jsonObj.get("alerts") != null && !jsonObj.get("alerts").isJsonNull()) {
        LinodeAlerts.validateJsonElement(jsonObj.get("alerts"));
      }
      // validate the optional field `backups`
      if (jsonObj.get("backups") != null && !jsonObj.get("backups").isJsonNull()) {
        LinodeBackups.validateJsonElement(jsonObj.get("backups"));
      }
      if ((jsonObj.get("group") != null && !jsonObj.get("group").isJsonNull()) && !jsonObj.get("group").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `group` to be a primitive type in the JSON string but got `%s`", jsonObj.get("group").toString()));
      }
      if ((jsonObj.get("host_uuid") != null && !jsonObj.get("host_uuid").isJsonNull()) && !jsonObj.get("host_uuid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `host_uuid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("host_uuid").toString()));
      }
      ...
      // validate the optional field `hypervisor`
      if (jsonObj.get("hypervisor") != null && !jsonObj.get("hypervisor").isJsonNull()) {
        HypervisorEnum.validateJsonElement(jsonObj.get("hypervisor"));
      }
      ...
      if (jsonObj.get("specs") != null && !jsonObj.get("specs").isJsonNull()) {
        LinodeSpecs.validateJsonElement(jsonObj.get("specs"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Linode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Linode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Linode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Linode.class));

       return (TypeAdapter<T>) new TypeAdapter<Linode>() {
           @Override
           public void write(JsonWriter out, Linode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Linode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Linode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Linode
   * @throws IOException if the JSON string is invalid with respect to Linode
   */
  public static Linode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Linode.class);
  }

  /**
   * Convert an instance of Linode to an JSON string
   *
   * @return JSON string
   */
