...
public class SupportTicketEntity {
  ...
  public boolean equals(Object o) {
    ...
    SupportTicketEntity supportTicketEntity = (SupportTicketEntity) o;
    return Objects.equals(this.id, supportTicketEntity.id) &&
        Objects.equals(this.label, supportTicketEntity.label) &&
        Objects.equals(this.type, supportTicketEntity.type) &&
        Objects.equals(this.url, supportTicketEntity.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupportTicketEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportTicketEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportTicketEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportTicketEntity is not found in the empty JSON string", SupportTicketEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportTicketEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportTicketEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportTicketEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportTicketEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportTicketEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportTicketEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportTicketEntity>() {
           @Override
           public void write(JsonWriter out, SupportTicketEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportTicketEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportTicketEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportTicketEntity
   * @throws IOException if the JSON string is invalid with respect to SupportTicketEntity
   */
  public static SupportTicketEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportTicketEntity.class);
  }

  /**
   * Convert an instance of SupportTicketEntity to an JSON string
   *
   * @return JSON string
   */
