...
public class IPAddressPrivate {
  ...
  public IPAddressPrivate rdns(String rdns) {
    this.rdns = rdns;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPAddressPrivate ipAddressPrivate = (IPAddressPrivate) o;
    return Objects.equals(this.address, ipAddressPrivate.address) &&
        Objects.equals(this.gateway, ipAddressPrivate.gateway) &&
        Objects.equals(this.linodeId, ipAddressPrivate.linodeId) &&
        Objects.equals(this.prefix, ipAddressPrivate.prefix) &&
        Objects.equals(this._public, ipAddressPrivate._public) &&
        Objects.equals(this.rdns, ipAddressPrivate.rdns) &&
        Objects.equals(this.region, ipAddressPrivate.region) &&
        Objects.equals(this.subnetMask, ipAddressPrivate.subnetMask) &&
        Objects.equals(this.type, ipAddressPrivate.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPAddressPrivate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressPrivate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressPrivate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressPrivate is not found in the empty JSON string", IPAddressPrivate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressPrivate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressPrivate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressPrivate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressPrivate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressPrivate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressPrivate.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressPrivate>() {
           @Override
           public void write(JsonWriter out, IPAddressPrivate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressPrivate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressPrivate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressPrivate
   * @throws IOException if the JSON string is invalid with respect to IPAddressPrivate
   */
  public static IPAddressPrivate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressPrivate.class);
  }

  /**
   * Convert an instance of IPAddressPrivate to an JSON string
   *
   * @return JSON string
   */
