...
public class ServiceTransfer {
  ...
  public ServiceTransfer created(OffsetDateTime created) {
  ...
  public ServiceTransfer entities(ServiceTransferEntities entities) {
  ...
  public ServiceTransfer expiry(OffsetDateTime expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public ServiceTransfer isSender(Boolean isSender) {
  ...
  public ServiceTransfer status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ServiceTransfer token(UUID token) {
    this.token = token;
    return this;
  }
  ...
  public ServiceTransfer updated(OffsetDateTime updated) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceTransfer serviceTransfer = (ServiceTransfer) o;
    return Objects.equals(this.created, serviceTransfer.created) &&
        Objects.equals(this.entities, serviceTransfer.entities) &&
        Objects.equals(this.expiry, serviceTransfer.expiry) &&
        Objects.equals(this.isSender, serviceTransfer.isSender) &&
        Objects.equals(this.status, serviceTransfer.status) &&
        Objects.equals(this.token, serviceTransfer.token) &&
        Objects.equals(this.updated, serviceTransfer.updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTransfer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceTransfer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceTransfer is not found in the empty JSON string", ServiceTransfer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceTransfer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceTransfer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceTransfer>() {
           @Override
           public void write(JsonWriter out, ServiceTransfer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceTransfer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceTransfer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceTransfer
   * @throws IOException if the JSON string is invalid with respect to ServiceTransfer
   */
  public static ServiceTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceTransfer.class);
  }

  /**
   * Convert an instance of ServiceTransfer to an JSON string
   *
   * @return JSON string
   */
