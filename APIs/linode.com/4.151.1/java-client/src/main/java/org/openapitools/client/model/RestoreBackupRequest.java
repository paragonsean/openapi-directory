...
public class RestoreBackupRequest {
  ...
  public RestoreBackupRequest linodeId(Integer linodeId) {
  ...
  public RestoreBackupRequest overwrite(Boolean overwrite) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linodeId, restoreBackupRequest.linodeId) &&
        Objects.equals(this.overwrite, restoreBackupRequest.overwrite);
  }

  @Override
  public int hashCode() {
    return Objects.hash(linodeId, overwrite);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestoreBackupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestoreBackupRequest is not found in the empty JSON string", RestoreBackupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RestoreBackupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestoreBackupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
