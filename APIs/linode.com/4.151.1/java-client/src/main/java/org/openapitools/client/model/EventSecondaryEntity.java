...
public class EventSecondaryEntity {
  ...
  public EventSecondaryEntity id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EventSecondaryEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EventSecondaryEntity url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventSecondaryEntity eventSecondaryEntity = (EventSecondaryEntity) o;
    return Objects.equals(this.id, eventSecondaryEntity.id) &&
        Objects.equals(this.label, eventSecondaryEntity.label) &&
        Objects.equals(this.type, eventSecondaryEntity.type) &&
        Objects.equals(this.url, eventSecondaryEntity.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventSecondaryEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventSecondaryEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventSecondaryEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventSecondaryEntity is not found in the empty JSON string", EventSecondaryEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventSecondaryEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventSecondaryEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventSecondaryEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventSecondaryEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventSecondaryEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventSecondaryEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<EventSecondaryEntity>() {
           @Override
           public void write(JsonWriter out, EventSecondaryEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventSecondaryEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventSecondaryEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventSecondaryEntity
   * @throws IOException if the JSON string is invalid with respect to EventSecondaryEntity
   */
  public static EventSecondaryEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventSecondaryEntity.class);
  }

  /**
   * Convert an instance of EventSecondaryEntity to an JSON string
   *
   * @return JSON string
   */
