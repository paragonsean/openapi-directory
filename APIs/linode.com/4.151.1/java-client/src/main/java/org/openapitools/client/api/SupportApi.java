...
import org.openapitools.client.model.CreateTicketReplyRequest;
import org.openapitools.client.model.GetAccountDefaultResponse;
import org.openapitools.client.model.GetTicketReplies200Response;
import org.openapitools.client.model.GetTickets200Response;
import org.openapitools.client.model.SupportTicket;
import org.openapitools.client.model.SupportTicketReply;
import org.openapitools.client.model.SupportTicketRequest;
...
public class SupportApi {
     ...
     * @param ticketId The ID of the Support Ticket. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Support Ticket closed successfully. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call closeTicketCall(Integer ticketId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/support/tickets/{ticketId}/close"
    ...
    private okhttp3.Call closeTicketValidateBeforeCall(Integer ticketId, final ApiCallback _callback) throws ApiException {
        ...
        return closeTicketCall(ticketId, _callback);
     ...
     */
    public Object closeTicket(Integer ticketId) throws ApiException {
        ApiResponse<Object> localVarResp = closeTicketWithHttpInfo(ticketId);
     ...
     */
    public ApiResponse<Object> closeTicketWithHttpInfo(Integer ticketId) throws ApiException {
        okhttp3.Call localVarCall = closeTicketValidateBeforeCall(ticketId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Support Ticket Close (asynchronously)
     * Closes a Support Ticket you have access to modify. 
     * @param ticketId The ID of the Support Ticket. (required)
     ...
     */
    public okhttp3.Call closeTicketAsync(Integer ticketId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = closeTicketValidateBeforeCall(ticketId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
     ...
     * @param supportTicketRequest Open a Support Ticket. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Support Ticket opened. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createTicketCall(SupportTicketRequest supportTicketRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/support/tickets";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTicketValidateBeforeCall(SupportTicketRequest supportTicketRequest, final ApiCallback _callback) throws ApiException {
        return createTicketCall(supportTicketRequest, _callback);
     ...
     */
    public SupportTicket createTicket(SupportTicketRequest supportTicketRequest) throws ApiException {
        ApiResponse<SupportTicket> localVarResp = createTicketWithHttpInfo(supportTicketRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SupportTicket> createTicketWithHttpInfo(SupportTicketRequest supportTicketRequest) throws ApiException {
        okhttp3.Call localVarCall = createTicketValidateBeforeCall(supportTicketRequest, null);
        Type localVarReturnType = new TypeToken<SupportTicket>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Support Ticket Open (asynchronously)
     * Open a Support Ticket. Only one of the ID attributes (&#x60;linode_id&#x60;, &#x60;domain_id&#x60;, etc.) can be set on a single Support Ticket. 
     * @param supportTicketRequest Open a Support Ticket. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call createTicketAsync(SupportTicketRequest supportTicketRequest, final ApiCallback<SupportTicket> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTicketValidateBeforeCall(supportTicketRequest, _callback);
        Type localVarReturnType = new TypeToken<SupportTicket>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createTicketAttachment
     * @param ticketId The ID of the Support Ticket. (required)
     * @param _file The local, absolute path to the file you want to attach to your Support Ticket.  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Attachment created. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createTicketAttachmentCall(Integer ticketId, String _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/support/tickets/{ticketId}/attachments"
            .replace("{" + "ticketId" + "}", localVarApiClient.escapeString(ticketId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTicketAttachmentValidateBeforeCall(Integer ticketId, String _file, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ticketId' is set
        if (ticketId == null) {
            throw new ApiException("Missing the required parameter 'ticketId' when calling createTicketAttachment(Async)");
        }

        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling createTicketAttachment(Async)");
        }

        return createTicketAttachmentCall(ticketId, _file, _callback);
     ...
     */
    public Object createTicketAttachment(Integer ticketId, String _file) throws ApiException {
        ApiResponse<Object> localVarResp = createTicketAttachmentWithHttpInfo(ticketId, _file);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> createTicketAttachmentWithHttpInfo(Integer ticketId, String _file) throws ApiException {
        okhttp3.Call localVarCall = createTicketAttachmentValidateBeforeCall(ticketId, _file, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Support Ticket Attachment Create (asynchronously)
     * Adds a file attachment to an existing Support Ticket on your Account. File attachments are used to assist our Support team in resolving your Ticket. Examples of attachments are screen shots and text files that provide additional information.  The file attachment is submitted in the request as multipart/form-data.  **Note**: Accepted file extensions include: .gif, .jpg, .jpeg, .pjpg, .pjpeg, .tif, .tiff, .png, .pdf, or .txt. 
     * @param ticketId The ID of the Support Ticket. (required)
     * @param _file The local, absolute path to the file you want to attach to your Support Ticket.  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createTicketAttachmentAsync(Integer ticketId, String _file, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTicketAttachmentValidateBeforeCall(ticketId, _file, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param ticketId The ID of the Support Ticket. (required)
     * @param createTicketReplyRequest Add a reply. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Reply created. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createTicketReplyCall(Integer ticketId, CreateTicketReplyRequest createTicketReplyRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createTicketReplyRequest;

        // create path and map variables
        String localVarPath = "/support/tickets/{ticketId}/replies"
            .replace("{" + "ticketId" + "}", localVarApiClient.escapeString(ticketId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTicketReplyValidateBeforeCall(Integer ticketId, CreateTicketReplyRequest createTicketReplyRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ticketId' is set
        if (ticketId == null) {
        ...
        if (createTicketReplyRequest == null) {
            throw new ApiException("Missing the required parameter 'createTicketReplyRequest' when calling createTicketReply(Async)");
        }

        return createTicketReplyCall(ticketId, createTicketReplyRequest, _callback);
     ...
     */
    public SupportTicketReply createTicketReply(Integer ticketId, CreateTicketReplyRequest createTicketReplyRequest) throws ApiException {
        ApiResponse<SupportTicketReply> localVarResp = createTicketReplyWithHttpInfo(ticketId, createTicketReplyRequest);
        return localVarResp.getData();
    }
     ...
     * @param ticketId The ID of the Support Ticket. (required)
     * @param createTicketReplyRequest Add a reply. (required)
     * @return ApiResponse&lt;SupportTicketReply&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SupportTicketReply> createTicketReplyWithHttpInfo(Integer ticketId, CreateTicketReplyRequest createTicketReplyRequest) throws ApiException {
        okhttp3.Call localVarCall = createTicketReplyValidateBeforeCall(ticketId, createTicketReplyRequest, null);
        Type localVarReturnType = new TypeToken<SupportTicketReply>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reply Create (asynchronously)
     * Adds a reply to an existing Support Ticket. 
     * @param ticketId The ID of the Support Ticket. (required)
     * @param createTicketReplyRequest Add a reply. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createTicketReplyAsync(Integer ticketId, CreateTicketReplyRequest createTicketReplyRequest, final ApiCallback<SupportTicketReply> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTicketReplyValidateBeforeCall(ticketId, createTicketReplyRequest, _callback);
        Type localVarReturnType = new TypeToken<SupportTicketReply>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a single SupportTicket object. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTicketCall(Integer ticketId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/support/tickets/{ticketId}"
            .replace("{" + "ticketId" + "}", localVarApiClient.escapeString(ticketId.toString()));
    ...
    private okhttp3.Call getTicketValidateBeforeCall(Integer ticketId, final ApiCallback _callback) throws ApiException {
        ...
        return getTicketCall(ticketId, _callback);
     ...
     */
    public SupportTicket getTicket(Integer ticketId) throws ApiException {
        ApiResponse<SupportTicket> localVarResp = getTicketWithHttpInfo(ticketId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SupportTicket> getTicketWithHttpInfo(Integer ticketId) throws ApiException {
    ...
    /**
     * Support Ticket View (asynchronously)
     * Returns a Support Ticket under your Account. 
     * @param ticketId The ID of the Support Ticket. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getTicketAsync(Integer ticketId, final ApiCallback<SupportTicket> _callback) throws ApiException {
    ...
    /**
     * Build call for getTicketReplies
     * @param ticketId The ID of the Support Ticket. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a paginated list of SupportTicketReply objects. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTicketRepliesCall(Integer ticketId, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTicketRepliesValidateBeforeCall(Integer ticketId, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ticketId' is set
        if (ticketId == null) {
            throw new ApiException("Missing the required parameter 'ticketId' when calling getTicketReplies(Async)");
        }

        return getTicketRepliesCall(ticketId, page, pageSize, _callback);
     ...
     */
    public GetTicketReplies200Response getTicketReplies(Integer ticketId, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetTicketReplies200Response> localVarResp = getTicketRepliesWithHttpInfo(ticketId, page, pageSize);
        return localVarResp.getData();
    }
     ...
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @return ApiResponse&lt;GetTicketReplies200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetTicketReplies200Response> getTicketRepliesWithHttpInfo(Integer ticketId, Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getTicketRepliesValidateBeforeCall(ticketId, page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetTicketReplies200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Replies List (asynchronously)
     * Returns a collection of replies to a Support Ticket on your Account. 
     * @param ticketId The ID of the Support Ticket. (required)
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     ...
     */
    public okhttp3.Call getTicketRepliesAsync(Integer ticketId, Integer page, Integer pageSize, final ApiCallback<GetTicketReplies200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTicketRepliesValidateBeforeCall(ticketId, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetTicketReplies200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns a paginated list of SupportTicket objects. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTicketsCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTicketsValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return getTicketsCall(page, pageSize, _callback);
     ...
     */
    public GetTickets200Response getTickets(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetTickets200Response> localVarResp = getTicketsWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetTickets200Response> getTicketsWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getTicketsValidateBeforeCall(page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetTickets200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Support Tickets List (asynchronously)
     * Returns a collection of Support Tickets on your Account. Support Tickets can be both tickets you open with Linode for support, as well as tickets generated by Linode regarding your Account. This collection includes all Support Tickets generated on your Account, with open tickets returned first. 
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getTicketsAsync(Integer page, Integer pageSize, final ApiCallback<GetTickets200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTicketsValidateBeforeCall(page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetTickets200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
