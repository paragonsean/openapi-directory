...
public class DatabaseMongoDBRequest {
  public static final String SERIALIZED_NAME_ALLOW_LIST = "allow_list";
   ...
   */
  @JsonAdapter(ClusterSizeEnum.Adapter.class)
  public enum ClusterSizeEnum {
    ...
    public static ClusterSizeEnum fromValue(Integer value) {
      for (ClusterSizeEnum b : ClusterSizeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ClusterSizeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ClusterSizeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ClusterSizeEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
        return ClusterSizeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      Integer value = jsonElement.getAsInt();
      ClusterSizeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_CLUSTER_SIZE = "cluster_size";
  @SerializedName(SERIALIZED_NAME_CLUSTER_SIZE)
  private ClusterSizeEnum clusterSize = ClusterSizeEnum.NUMBER_1;

  /**
   * The type of data compression for this Database.  Snappy has a lower comparative compression ratio and resource consumption rate.  Zlip has a higher comparative compression ratio and resource consumption rate. 
   */
  ...
  private CompressionTypeEnum compressionType = CompressionTypeEnum.NONE;
  ...
  public static final String SERIALIZED_NAME_REPLICA_SET = "replica_set";
  @SerializedName(SERIALIZED_NAME_REPLICA_SET)
  private String replicaSet;

  public static final String SERIALIZED_NAME_SSL_CONNECTION = "ssl_connection";
  @SerializedName(SERIALIZED_NAME_SSL_CONNECTION)
  private Boolean sslConnection = true;

  /**
   * The type of storage engine for this Database.  **Note:** MMAPV1 is not available for MongoDB versions 4.0 and above. 
   */
  @JsonAdapter(StorageEngineEnum.Adapter.class)
  public enum StorageEngineEnum {
    ...
    public static StorageEngineEnum fromValue(String value) {
      for (StorageEngineEnum b : StorageEngineEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<StorageEngineEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StorageEngineEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StorageEngineEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return StorageEngineEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      StorageEngineEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_STORAGE_ENGINE = "storage_engine";
  @SerializedName(SERIALIZED_NAME_STORAGE_ENGINE)
  private StorageEngineEnum storageEngine = StorageEngineEnum.WIREDTIGER;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public DatabaseMongoDBRequest() {
  }

  public DatabaseMongoDBRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabaseMongoDBRequest addAllowListItem(String allowListItem) {
  ...
  public DatabaseMongoDBRequest clusterSize(ClusterSizeEnum clusterSize) {
   ...
   */
  @javax.annotation.Nullable
  public ClusterSizeEnum getClusterSize() {
    return clusterSize;
  }

  public void setClusterSize(ClusterSizeEnum clusterSize) {
    this.clusterSize = clusterSize;
  }


  public DatabaseMongoDBRequest compressionType(CompressionTypeEnum compressionType) {
  ...
  public DatabaseMongoDBRequest encrypted(Boolean encrypted) {
  ...
  public DatabaseMongoDBRequest engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DatabaseMongoDBRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabaseMongoDBRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabaseMongoDBRequest replicaSet(String replicaSet) {
    this.replicaSet = replicaSet;
    return this;
  }

  /**
   * Label for configuring a MongoDB [replica set](https://www.mongodb.com/docs/manual/replication/). Choose the same label on multiple Databases to include them in the same replica set.  If &#x60;null&#x60;, the Database is not included in any replica set. 
   * @return replicaSet
   */
  @javax.annotation.Nullable
  ...
  public DatabaseMongoDBRequest sslConnection(Boolean sslConnection) {
    this.sslConnection = sslConnection;
    return this;
  }

  /**
   * Whether to require SSL credentials to establish a connection to the Managed Database.  Use the **Managed MongoDB Database Credentials View** ([GET /databases/mongodb/instances/{instanceId}/credentials](/docs/api/databases/#managed-mongodb-database-credentials-view)) command for access information. 
  ...
  public DatabaseMongoDBRequest storageEngine(StorageEngineEnum storageEngine) {
  ...
  public DatabaseMongoDBRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMongoDBRequest databaseMongoDBRequest = (DatabaseMongoDBRequest) o;
    return Objects.equals(this.allowList, databaseMongoDBRequest.allowList) &&
        Objects.equals(this.clusterSize, databaseMongoDBRequest.clusterSize) &&
        Objects.equals(this.compressionType, databaseMongoDBRequest.compressionType) &&
        Objects.equals(this.encrypted, databaseMongoDBRequest.encrypted) &&
        Objects.equals(this.engine, databaseMongoDBRequest.engine) &&
        Objects.equals(this.label, databaseMongoDBRequest.label) &&
        Objects.equals(this.region, databaseMongoDBRequest.region) &&
        Objects.equals(this.replicaSet, databaseMongoDBRequest.replicaSet) &&
        Objects.equals(this.sslConnection, databaseMongoDBRequest.sslConnection) &&
        Objects.equals(this.storageEngine, databaseMongoDBRequest.storageEngine) &&
        Objects.equals(this.type, databaseMongoDBRequest.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, compressionType, encrypted, engine, label, region, replicaSet, sslConnection, storageEngine, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseMongoDBRequest {\n");
    ...
    sb.append("    sslConnection: ").append(toIndentedString(sslConnection)).append("\n");
  ...
  static {
    ...
    openapiFields.add("allow_list");
    openapiFields.add("cluster_size");
    openapiFields.add("compression_type");
    openapiFields.add("encrypted");
    openapiFields.add("engine");
    openapiFields.add("label");
    openapiFields.add("region");
    openapiFields.add("replica_set");
    openapiFields.add("ssl_connection");
    openapiFields.add("storage_engine");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseMongoDBRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseMongoDBRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMongoDBRequest is not found in the empty JSON string", DatabaseMongoDBRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseMongoDBRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseMongoDBRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseMongoDBRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("allow_list") != null && !jsonObj.get("allow_list").isJsonNull() && !jsonObj.get("allow_list").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `allow_list` to be an array in the JSON string but got `%s`", jsonObj.get("allow_list").toString()));
      }
      // validate the optional field `cluster_size`
      if (jsonObj.get("cluster_size") != null && !jsonObj.get("cluster_size").isJsonNull()) {
        ClusterSizeEnum.validateJsonElement(jsonObj.get("cluster_size"));
      }
      ...
      if ((jsonObj.get("replica_set") != null && !jsonObj.get("replica_set").isJsonNull()) && !jsonObj.get("replica_set").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `replica_set` to be a primitive type in the JSON string but got `%s`", jsonObj.get("replica_set").toString()));
      }
      if ((jsonObj.get("storage_engine") != null && !jsonObj.get("storage_engine").isJsonNull()) && !jsonObj.get("storage_engine").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `storage_engine` to be a primitive type in the JSON string but got `%s`", jsonObj.get("storage_engine").toString()));
      }
      // validate the optional field `storage_engine`
      if (jsonObj.get("storage_engine") != null && !jsonObj.get("storage_engine").isJsonNull()) {
        StorageEngineEnum.validateJsonElement(jsonObj.get("storage_engine"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMongoDBRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMongoDBRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMongoDBRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMongoDBRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMongoDBRequest>() {
           @Override
           public void write(JsonWriter out, DatabaseMongoDBRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseMongoDBRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseMongoDBRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseMongoDBRequest
   * @throws IOException if the JSON string is invalid with respect to DatabaseMongoDBRequest
   */
  public static DatabaseMongoDBRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMongoDBRequest.class);
  }

  /**
   * Convert an instance of DatabaseMongoDBRequest to an JSON string
   *
   * @return JSON string
   */
