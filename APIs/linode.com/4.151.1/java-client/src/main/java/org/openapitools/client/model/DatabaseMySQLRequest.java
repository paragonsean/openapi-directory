...
public class DatabaseMySQLRequest {
  ...
  public static final String SERIALIZED_NAME_REPLICATION_TYPE = "replication_type";
  ...
  public DatabaseMySQLRequest() {
  }

  public DatabaseMySQLRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabaseMySQLRequest addAllowListItem(String allowListItem) {
  ...
  public DatabaseMySQLRequest clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public DatabaseMySQLRequest encrypted(Boolean encrypted) {
  ...
  public DatabaseMySQLRequest engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DatabaseMySQLRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabaseMySQLRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabaseMySQLRequest replicationType(ReplicationTypeEnum replicationType) {
  ...
  public DatabaseMySQLRequest sslConnection(Boolean sslConnection) {
    this.sslConnection = sslConnection;
    return this;
  }

  /**
   * Whether to require SSL credentials to establish a connection to the Managed Database.  Use the **Managed MySQL Database Credentials View** ([GET /databases/mysql/instances/{instanceId}/credentials](/docs/api/databases/#managed-mysql-database-credentials-view)) command for access information. 
  ...
  public DatabaseMySQLRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMySQLRequest databaseMySQLRequest = (DatabaseMySQLRequest) o;
    return Objects.equals(this.allowList, databaseMySQLRequest.allowList) &&
        Objects.equals(this.clusterSize, databaseMySQLRequest.clusterSize) &&
        Objects.equals(this.encrypted, databaseMySQLRequest.encrypted) &&
        Objects.equals(this.engine, databaseMySQLRequest.engine) &&
        Objects.equals(this.label, databaseMySQLRequest.label) &&
        Objects.equals(this.region, databaseMySQLRequest.region) &&
        Objects.equals(this.replicationType, databaseMySQLRequest.replicationType) &&
        Objects.equals(this.sslConnection, databaseMySQLRequest.sslConnection) &&
        Objects.equals(this.type, databaseMySQLRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, encrypted, engine, label, region, replicationType, sslConnection, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseMySQLRequest {\n");
  ...
  static {
    ...
    openapiFields.add("replication_type");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseMySQLRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseMySQLRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMySQLRequest is not found in the empty JSON string", DatabaseMySQLRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseMySQLRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseMySQLRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseMySQLRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("replication_type") != null && !jsonObj.get("replication_type").isJsonNull()) && !jsonObj.get("replication_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `replication_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("replication_type").toString()));
      }
      // validate the optional field `replication_type`
      if (jsonObj.get("replication_type") != null && !jsonObj.get("replication_type").isJsonNull()) {
        ReplicationTypeEnum.validateJsonElement(jsonObj.get("replication_type"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMySQLRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMySQLRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMySQLRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMySQLRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMySQLRequest>() {
           @Override
           public void write(JsonWriter out, DatabaseMySQLRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseMySQLRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseMySQLRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseMySQLRequest
   * @throws IOException if the JSON string is invalid with respect to DatabaseMySQLRequest
   */
  public static DatabaseMySQLRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMySQLRequest.class);
  }

  /**
   * Convert an instance of DatabaseMySQLRequest to an JSON string
   *
   * @return JSON string
   */
