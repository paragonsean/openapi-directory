...
public class ManagedCredential {
  ...
  public ManagedCredential label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManagedCredential managedCredential = (ManagedCredential) o;
    return Objects.equals(this.id, managedCredential.id) &&
        Objects.equals(this.label, managedCredential.label) &&
        Objects.equals(this.lastDecrypted, managedCredential.lastDecrypted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, label, lastDecrypted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ManagedCredential {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedCredential
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedCredential.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedCredential is not found in the empty JSON string", ManagedCredential.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedCredential.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedCredential` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedCredential.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedCredential' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedCredential> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedCredential.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedCredential>() {
           @Override
           public void write(JsonWriter out, ManagedCredential value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedCredential read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedCredential given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedCredential
   * @throws IOException if the JSON string is invalid with respect to ManagedCredential
   */
  public static ManagedCredential fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedCredential.class);
  }

  /**
   * Convert an instance of ManagedCredential to an JSON string
   *
   * @return JSON string
   */
