...
public class NotificationEntity {
  ...
  public NotificationEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public NotificationEntity type(String type) {
    this.type = type;
    return this;
  }
  ...
  public NotificationEntity url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notificationEntity.id) &&
        Objects.equals(this.label, notificationEntity.label) &&
        Objects.equals(this.type, notificationEntity.type) &&
        Objects.equals(this.url, notificationEntity.url);
  }
