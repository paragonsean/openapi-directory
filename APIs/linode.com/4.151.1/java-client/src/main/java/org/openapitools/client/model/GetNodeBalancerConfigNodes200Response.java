...
public class GetNodeBalancerConfigNodes200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<NodeBalancerNode> data = new ArrayList<>();
  ...
  public GetNodeBalancerConfigNodes200Response() {
  }
  ...
  public GetNodeBalancerConfigNodes200Response data(List<NodeBalancerNode> data) {
    this.data = data;
    return this;
  }

  public GetNodeBalancerConfigNodes200Response addDataItem(NodeBalancerNode dataItem) {
    if (this.data == null) {
  ...
  public List<NodeBalancerNode> getData() {
    return data;
  }

  public void setData(List<NodeBalancerNode> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetNodeBalancerConfigNodes200Response getNodeBalancerConfigNodes200Response = (GetNodeBalancerConfigNodes200Response) o;
    return Objects.equals(this.data, getNodeBalancerConfigNodes200Response.data) &&
        Objects.equals(this.page, getNodeBalancerConfigNodes200Response.page) &&
        Objects.equals(this.pages, getNodeBalancerConfigNodes200Response.pages) &&
        Objects.equals(this.results, getNodeBalancerConfigNodes200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetNodeBalancerConfigNodes200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetNodeBalancerConfigNodes200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetNodeBalancerConfigNodes200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNodeBalancerConfigNodes200Response is not found in the empty JSON string", GetNodeBalancerConfigNodes200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetNodeBalancerConfigNodes200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetNodeBalancerConfigNodes200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            NodeBalancerNode.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNodeBalancerConfigNodes200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNodeBalancerConfigNodes200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetNodeBalancerConfigNodes200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetNodeBalancerConfigNodes200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetNodeBalancerConfigNodes200Response>() {
           @Override
           public void write(JsonWriter out, GetNodeBalancerConfigNodes200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetNodeBalancerConfigNodes200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetNodeBalancerConfigNodes200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetNodeBalancerConfigNodes200Response
   * @throws IOException if the JSON string is invalid with respect to GetNodeBalancerConfigNodes200Response
   */
  public static GetNodeBalancerConfigNodes200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNodeBalancerConfigNodes200Response.class);
  }

  /**
   * Convert an instance of GetNodeBalancerConfigNodes200Response to an JSON string
   *
   * @return JSON string
   */
