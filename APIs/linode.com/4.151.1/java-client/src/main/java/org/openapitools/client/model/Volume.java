...
public class Volume {
  ...
  public static final String SERIALIZED_NAME_FILESYSTEM_PATH = "filesystem_path";
  @SerializedName(SERIALIZED_NAME_FILESYSTEM_PATH)
  ...
  public static final String SERIALIZED_NAME_HARDWARE_TYPE = "hardware_type";
  ...
  public static final String SERIALIZED_NAME_LINODE_LABEL = "linode_label";
  @SerializedName(SERIALIZED_NAME_LINODE_LABEL)
  private String linodeLabel;
  ...
  public Volume linodeId(Integer linodeId) {
  ...
  public Volume tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public Volume addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, volume.created) &&
        Objects.equals(this.filesystemPath, volume.filesystemPath) &&
        Objects.equals(this.hardwareType, volume.hardwareType) &&
        Objects.equals(this.id, volume.id) &&
        Objects.equals(this.label, volume.label) &&
        Objects.equals(this.linodeId, volume.linodeId) &&
        Objects.equals(this.linodeLabel, volume.linodeLabel) &&
        ...
        Objects.equals(this.updated, volume.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, filesystemPath, hardwareType, id, label, linodeId, linodeLabel, region, size, status, tags, updated);
  }
  ...
  public String toString() {
    ...
    sb.append("    linodeLabel: ").append(toIndentedString(linodeLabel)).append("\n");
  ...
  static {
    ...
    openapiFields.add("filesystem_path");
    openapiFields.add("hardware_type");
    openapiFields.add("id");
    openapiFields.add("label");
    openapiFields.add("linode_id");
    openapiFields.add("linode_label");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("filesystem_path") != null && !jsonObj.get("filesystem_path").isJsonNull()) && !jsonObj.get("filesystem_path").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `filesystem_path` to be a primitive type in the JSON string but got `%s`", jsonObj.get("filesystem_path").toString()));
      }
      if ((jsonObj.get("hardware_type") != null && !jsonObj.get("hardware_type").isJsonNull()) && !jsonObj.get("hardware_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hardware_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hardware_type").toString()));
      }
      // validate the optional field `hardware_type`
      if (jsonObj.get("hardware_type") != null && !jsonObj.get("hardware_type").isJsonNull()) {
        HardwareTypeEnum.validateJsonElement(jsonObj.get("hardware_type"));
      }
      if ((jsonObj.get("label") != null && !jsonObj.get("label").isJsonNull()) && !jsonObj.get("label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("label").toString()));
      }
      if ((jsonObj.get("linode_label") != null && !jsonObj.get("linode_label").isJsonNull()) && !jsonObj.get("linode_label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `linode_label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("linode_label").toString()));
      }
