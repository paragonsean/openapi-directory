...
public class Devices {
  ...
  public static final String SERIALIZED_NAME_SDH = "sdh";
  @SerializedName(SERIALIZED_NAME_SDH)
  private Device sdh;

  public Devices() {
  }

  public Devices sda(Device sda) {
    this.sda = sda;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdh() {
    return sdh;
  }

  public void setSdh(Device sdh) {
    this.sdh = sdh;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sda, devices.sda) &&
        Objects.equals(this.sdb, devices.sdb) &&
        Objects.equals(this.sdc, devices.sdc) &&
        Objects.equals(this.sdd, devices.sdd) &&
        Objects.equals(this.sde, devices.sde) &&
        Objects.equals(this.sdf, devices.sdf) &&
        Objects.equals(this.sdg, devices.sdg) &&
        Objects.equals(this.sdh, devices.sdh);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sda, sdb, sdc, sdd, sde, sdf, sdg, sdh);
  }
  ...
  public String toString() {
    ...
    sb.append("    sdh: ").append(toIndentedString(sdh)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Devices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Devices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Devices is not found in the empty JSON string", Devices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Devices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Devices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `sdh`
      if (jsonObj.get("sdh") != null && !jsonObj.get("sdh").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdh"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Devices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Devices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Devices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Devices.class));

       return (TypeAdapter<T>) new TypeAdapter<Devices>() {
           @Override
           public void write(JsonWriter out, Devices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Devices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Devices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Devices
   * @throws IOException if the JSON string is invalid with respect to Devices
   */
  public static Devices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Devices.class);
  }

  /**
   * Convert an instance of Devices to an JSON string
   *
   * @return JSON string
   */
