...
import org.openapitools.client.model.DatabaseTypeEnginePrice;
...
public class DatabaseTypeEngine {
  ...
  private DatabaseTypeEnginePrice price;
  ...
  public DatabaseTypeEngine() {
  }

  public DatabaseTypeEngine price(DatabaseTypeEnginePrice price) {
    this.price = price;
    return this;
  }
  ...
  public DatabaseTypeEnginePrice getPrice() {
    return price;
  }

  public void setPrice(DatabaseTypeEnginePrice price) {
    this.price = price;
  }


  public DatabaseTypeEngine quantity(QuantityEnum quantity) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseTypeEngine databaseTypeEngine = (DatabaseTypeEngine) o;
    return Objects.equals(this.price, databaseTypeEngine.price) &&
        Objects.equals(this.quantity, databaseTypeEngine.quantity);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseTypeEngine {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseTypeEngine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseTypeEngine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseTypeEngine is not found in the empty JSON string", DatabaseTypeEngine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseTypeEngine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseTypeEngine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `price`
      if (jsonObj.get("price") != null && !jsonObj.get("price").isJsonNull()) {
        DatabaseTypeEnginePrice.validateJsonElement(jsonObj.get("price"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseTypeEngine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseTypeEngine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseTypeEngine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseTypeEngine.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseTypeEngine>() {
           @Override
           public void write(JsonWriter out, DatabaseTypeEngine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseTypeEngine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseTypeEngine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseTypeEngine
   * @throws IOException if the JSON string is invalid with respect to DatabaseTypeEngine
   */
  public static DatabaseTypeEngine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseTypeEngine.class);
  }

  /**
   * Convert an instance of DatabaseTypeEngine to an JSON string
   *
   * @return JSON string
   */
