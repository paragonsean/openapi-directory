...
public class SupportTicketReply {
  ...
  public static final String SERIALIZED_NAME_FROM_LINODE = "from_linode";
  @SerializedName(SERIALIZED_NAME_FROM_LINODE)
  private Boolean fromLinode;
  ...
  public boolean equals(Object o) {
    ...
    SupportTicketReply supportTicketReply = (SupportTicketReply) o;
    return Objects.equals(this.created, supportTicketReply.created) &&
        Objects.equals(this.createdBy, supportTicketReply.createdBy) &&
        Objects.equals(this.description, supportTicketReply.description) &&
        Objects.equals(this.fromLinode, supportTicketReply.fromLinode) &&
        Objects.equals(this.gravatarId, supportTicketReply.gravatarId) &&
        Objects.equals(this.id, supportTicketReply.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, createdBy, description, fromLinode, gravatarId, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SupportTicketReply {\n");
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    createdBy: ").append(toIndentedString(createdBy)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    fromLinode: ").append(toIndentedString(fromLinode)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportTicketReply
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportTicketReply.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportTicketReply is not found in the empty JSON string", SupportTicketReply.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportTicketReply.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportTicketReply` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportTicketReply.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportTicketReply' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportTicketReply> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportTicketReply.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportTicketReply>() {
           @Override
           public void write(JsonWriter out, SupportTicketReply value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportTicketReply read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportTicketReply given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportTicketReply
   * @throws IOException if the JSON string is invalid with respect to SupportTicketReply
   */
  public static SupportTicketReply fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportTicketReply.class);
  }

  /**
   * Convert an instance of SupportTicketReply to an JSON string
   *
   * @return JSON string
   */
