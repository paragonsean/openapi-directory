...
public class DatabaseMySQL {
  ...
  public DatabaseMySQL allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabaseMySQL addAllowListItem(String allowListItem) {
  ...
  public DatabaseMySQL clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public DatabaseMySQL encrypted(Boolean encrypted) {
  ...
  public DatabaseMySQL hosts(DatabaseHosts hosts) {
    this.hosts = hosts;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DatabaseHosts getHosts() {
    return hosts;
  }

  public void setHosts(DatabaseHosts hosts) {
    this.hosts = hosts;
  }
  ...
  public DatabaseMySQL label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabaseMySQL port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DatabaseMySQL region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabaseMySQL replicationType(ReplicationTypeEnum replicationType) {
  ...
  public DatabaseMySQL sslConnection(Boolean sslConnection) {
  ...
  public DatabaseMySQL type(String type) {
    this.type = type;
    return this;
  }
  ...
  public DatabaseMySQL updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMySQL databaseMySQL = (DatabaseMySQL) o;
    return Objects.equals(this.allowList, databaseMySQL.allowList) &&
        Objects.equals(this.clusterSize, databaseMySQL.clusterSize) &&
        Objects.equals(this.created, databaseMySQL.created) &&
        Objects.equals(this.encrypted, databaseMySQL.encrypted) &&
        Objects.equals(this.engine, databaseMySQL.engine) &&
        Objects.equals(this.hosts, databaseMySQL.hosts) &&
        Objects.equals(this.id, databaseMySQL.id) &&
        Objects.equals(this.label, databaseMySQL.label) &&
        Objects.equals(this.port, databaseMySQL.port) &&
        Objects.equals(this.region, databaseMySQL.region) &&
        Objects.equals(this.replicationType, databaseMySQL.replicationType) &&
        Objects.equals(this.sslConnection, databaseMySQL.sslConnection) &&
        Objects.equals(this.status, databaseMySQL.status) &&
        Objects.equals(this.type, databaseMySQL.type) &&
        Objects.equals(this.updated, databaseMySQL.updated) &&
        Objects.equals(this.updates, databaseMySQL.updates) &&
        Objects.equals(this.version, databaseMySQL.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, created, encrypted, engine, hosts, id, label, port, region, replicationType, sslConnection, status, type, updated, updates, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseMySQL {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseMySQL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseMySQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMySQL is not found in the empty JSON string", DatabaseMySQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseMySQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseMySQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("hosts") != null && !jsonObj.get("hosts").isJsonNull()) {
        DatabaseHosts.validateJsonElement(jsonObj.get("hosts"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMySQL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMySQL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMySQL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMySQL.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMySQL>() {
           @Override
           public void write(JsonWriter out, DatabaseMySQL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseMySQL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseMySQL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseMySQL
   * @throws IOException if the JSON string is invalid with respect to DatabaseMySQL
   */
  public static DatabaseMySQL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMySQL.class);
  }

  /**
   * Convert an instance of DatabaseMySQL to an JSON string
   *
   * @return JSON string
   */
