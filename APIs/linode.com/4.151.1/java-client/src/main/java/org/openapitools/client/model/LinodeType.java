...
import org.openapitools.client.model.LinodeTypeAddons;
import org.openapitools.client.model.LinodeTypePrice;
...
public class LinodeType {
  ...
  private LinodeTypeAddons addons;
  ...
  public static final String SERIALIZED_NAME_NETWORK_OUT = "network_out";
  @SerializedName(SERIALIZED_NAME_NETWORK_OUT)
  private Integer networkOut;

  public static final String SERIALIZED_NAME_PRICE = "price";
  @SerializedName(SERIALIZED_NAME_PRICE)
  private LinodeTypePrice price;
  ...
  public LinodeType addons(LinodeTypeAddons addons) {
    this.addons = addons;
    return this;
  }
  ...
  public LinodeTypeAddons getAddons() {
    return addons;
  }

  public void setAddons(LinodeTypeAddons addons) {
    this.addons = addons;
  }
  ...
  public LinodeType price(LinodeTypePrice price) {
    this.price = price;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LinodeTypePrice getPrice() {
    return price;
  }

  public void setPrice(LinodeTypePrice price) {
    this.price = price;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeType linodeType = (LinodeType) o;
    return Objects.equals(this.addons, linodeType.addons) &&
        Objects.equals(this.propertyClass, linodeType.propertyClass) &&
        Objects.equals(this.disk, linodeType.disk) &&
        Objects.equals(this.gpus, linodeType.gpus) &&
        Objects.equals(this.id, linodeType.id) &&
        Objects.equals(this.label, linodeType.label) &&
        Objects.equals(this.memory, linodeType.memory) &&
        Objects.equals(this.networkOut, linodeType.networkOut) &&
        Objects.equals(this.price, linodeType.price) &&
        Objects.equals(this.successor, linodeType.successor) &&
        Objects.equals(this.transfer, linodeType.transfer) &&
        Objects.equals(this.vcpus, linodeType.vcpus);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addons, propertyClass, disk, gpus, id, label, memory, networkOut, price, successor, transfer, vcpus);
  }
  ...
  public String toString() {
    ...
    sb.append("    networkOut: ").append(toIndentedString(networkOut)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeType is not found in the empty JSON string", LinodeType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `addons`
      if (jsonObj.get("addons") != null && !jsonObj.get("addons").isJsonNull()) {
        LinodeTypeAddons.validateJsonElement(jsonObj.get("addons"));
      }
      ...
      if (jsonObj.get("price") != null && !jsonObj.get("price").isJsonNull()) {
        LinodeTypePrice.validateJsonElement(jsonObj.get("price"));
      }
      if ((jsonObj.get("successor") != null && !jsonObj.get("successor").isJsonNull()) && !jsonObj.get("successor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `successor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("successor").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeType.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeType>() {
           @Override
           public void write(JsonWriter out, LinodeType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeType
   * @throws IOException if the JSON string is invalid with respect to LinodeType
   */
  public static LinodeType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeType.class);
  }

  /**
   * Convert an instance of LinodeType to an JSON string
   *
   * @return JSON string
   */
