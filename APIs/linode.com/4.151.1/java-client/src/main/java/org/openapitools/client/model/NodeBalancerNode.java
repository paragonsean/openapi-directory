...
public class NodeBalancerNode {
  ...
  public NodeBalancerNode address(String address) {
  ...
  public NodeBalancerNode label(String label) {
    this.label = label;
    return this;
  }
  ...
  public NodeBalancerNode mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public NodeBalancerNode weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NodeBalancerNode nodeBalancerNode = (NodeBalancerNode) o;
    return Objects.equals(this.address, nodeBalancerNode.address) &&
        Objects.equals(this.configId, nodeBalancerNode.configId) &&
        Objects.equals(this.id, nodeBalancerNode.id) &&
        Objects.equals(this.label, nodeBalancerNode.label) &&
        Objects.equals(this.mode, nodeBalancerNode.mode) &&
        Objects.equals(this.nodebalancerId, nodeBalancerNode.nodebalancerId) &&
        Objects.equals(this.status, nodeBalancerNode.status) &&
        Objects.equals(this.weight, nodeBalancerNode.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, configId, id, label, mode, nodebalancerId, status, weight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NodeBalancerNode {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeBalancerNode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeBalancerNode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeBalancerNode is not found in the empty JSON string", NodeBalancerNode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeBalancerNode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeBalancerNode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeBalancerNode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeBalancerNode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeBalancerNode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancerNode.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeBalancerNode>() {
           @Override
           public void write(JsonWriter out, NodeBalancerNode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeBalancerNode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeBalancerNode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeBalancerNode
   * @throws IOException if the JSON string is invalid with respect to NodeBalancerNode
   */
  public static NodeBalancerNode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeBalancerNode.class);
  }

  /**
   * Convert an instance of NodeBalancerNode to an JSON string
   *
   * @return JSON string
   */
