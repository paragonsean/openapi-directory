...
public class DatabaseUpdates {
  ...
  private FrequencyEnum frequency = FrequencyEnum.WEEKLY;

  public static final String SERIALIZED_NAME_HOUR_OF_DAY = "hour_of_day";
  @SerializedName(SERIALIZED_NAME_HOUR_OF_DAY)
  private Integer hourOfDay;

  public static final String SERIALIZED_NAME_WEEK_OF_MONTH = "week_of_month";
  ...
  public DatabaseUpdates dayOfWeek(Integer dayOfWeek) {
  ...
  public DatabaseUpdates duration(Integer duration) {
  ...
  public DatabaseUpdates frequency(FrequencyEnum frequency) {
  ...
  public DatabaseUpdates hourOfDay(Integer hourOfDay) {
  ...
  public DatabaseUpdates weekOfMonth(Integer weekOfMonth) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseUpdates databaseUpdates = (DatabaseUpdates) o;
    return Objects.equals(this.dayOfWeek, databaseUpdates.dayOfWeek) &&
        Objects.equals(this.duration, databaseUpdates.duration) &&
        Objects.equals(this.frequency, databaseUpdates.frequency) &&
        Objects.equals(this.hourOfDay, databaseUpdates.hourOfDay) &&
        Objects.equals(this.weekOfMonth, databaseUpdates.weekOfMonth);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dayOfWeek, duration, frequency, hourOfDay, weekOfMonth);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseUpdates {\n");
  ...
  static {
    ...
    openapiFields.add("hour_of_day");
    openapiFields.add("week_of_month");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseUpdates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseUpdates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseUpdates is not found in the empty JSON string", DatabaseUpdates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseUpdates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseUpdates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseUpdates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseUpdates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseUpdates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseUpdates.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseUpdates>() {
           @Override
           public void write(JsonWriter out, DatabaseUpdates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseUpdates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseUpdates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseUpdates
   * @throws IOException if the JSON string is invalid with respect to DatabaseUpdates
   */
  public static DatabaseUpdates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseUpdates.class);
  }

  /**
   * Convert an instance of DatabaseUpdates to an JSON string
   *
   * @return JSON string
   */
