...
import org.openapitools.client.model.LongviewClient;
...
public class GetLongviewClients200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LongviewClient> data = new ArrayList<>();
  ...
  public GetLongviewClients200Response() {
  }
  ...
  public GetLongviewClients200Response data(List<LongviewClient> data) {
    this.data = data;
    return this;
  }

  public GetLongviewClients200Response addDataItem(LongviewClient dataItem) {
    if (this.data == null) {
  ...
  public List<LongviewClient> getData() {
    return data;
  }

  public void setData(List<LongviewClient> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLongviewClients200Response getLongviewClients200Response = (GetLongviewClients200Response) o;
    return Objects.equals(this.data, getLongviewClients200Response.data) &&
        Objects.equals(this.page, getLongviewClients200Response.page) &&
        Objects.equals(this.pages, getLongviewClients200Response.pages) &&
        Objects.equals(this.results, getLongviewClients200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLongviewClients200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLongviewClients200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLongviewClients200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLongviewClients200Response is not found in the empty JSON string", GetLongviewClients200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLongviewClients200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLongviewClients200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LongviewClient.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLongviewClients200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLongviewClients200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLongviewClients200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLongviewClients200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLongviewClients200Response>() {
           @Override
           public void write(JsonWriter out, GetLongviewClients200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLongviewClients200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLongviewClients200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLongviewClients200Response
   * @throws IOException if the JSON string is invalid with respect to GetLongviewClients200Response
   */
  public static GetLongviewClients200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLongviewClients200Response.class);
  }

  /**
   * Convert an instance of GetLongviewClients200Response to an JSON string
   *
   * @return JSON string
   */
