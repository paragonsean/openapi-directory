...
public class PayPalData {
  ...
  public static final String SERIALIZED_NAME_PAYPAL_ID = "paypal_id";
  @SerializedName(SERIALIZED_NAME_PAYPAL_ID)
  ...
  public boolean equals(Object o) {
    ...
    PayPalData payPalData = (PayPalData) o;
    return Objects.equals(this.email, payPalData.email) &&
        Objects.equals(this.paypalId, payPalData.paypalId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, paypalId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayPalData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayPalData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayPalData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayPalData is not found in the empty JSON string", PayPalData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayPalData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayPalData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("paypal_id") != null && !jsonObj.get("paypal_id").isJsonNull()) && !jsonObj.get("paypal_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `paypal_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paypal_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayPalData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayPalData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayPalData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayPalData.class));

       return (TypeAdapter<T>) new TypeAdapter<PayPalData>() {
           @Override
           public void write(JsonWriter out, PayPalData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayPalData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayPalData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayPalData
   * @throws IOException if the JSON string is invalid with respect to PayPalData
   */
  public static PayPalData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayPalData.class);
  }

  /**
   * Convert an instance of PayPalData to an JSON string
   *
   * @return JSON string
   */
