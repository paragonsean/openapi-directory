...
public class GetObjectStorageKeys200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ObjectStorageKey> data = new ArrayList<>();
  ...
  public GetObjectStorageKeys200Response() {
  }
  ...
  public GetObjectStorageKeys200Response data(List<ObjectStorageKey> data) {
    this.data = data;
    return this;
  }

  public GetObjectStorageKeys200Response addDataItem(ObjectStorageKey dataItem) {
    if (this.data == null) {
  ...
  public List<ObjectStorageKey> getData() {
    return data;
  }

  public void setData(List<ObjectStorageKey> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetObjectStorageKeys200Response getObjectStorageKeys200Response = (GetObjectStorageKeys200Response) o;
    return Objects.equals(this.data, getObjectStorageKeys200Response.data) &&
        Objects.equals(this.page, getObjectStorageKeys200Response.page) &&
        Objects.equals(this.pages, getObjectStorageKeys200Response.pages) &&
        Objects.equals(this.results, getObjectStorageKeys200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetObjectStorageKeys200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetObjectStorageKeys200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetObjectStorageKeys200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetObjectStorageKeys200Response is not found in the empty JSON string", GetObjectStorageKeys200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetObjectStorageKeys200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetObjectStorageKeys200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectStorageKey.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetObjectStorageKeys200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetObjectStorageKeys200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetObjectStorageKeys200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetObjectStorageKeys200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetObjectStorageKeys200Response>() {
           @Override
           public void write(JsonWriter out, GetObjectStorageKeys200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetObjectStorageKeys200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetObjectStorageKeys200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetObjectStorageKeys200Response
   * @throws IOException if the JSON string is invalid with respect to GetObjectStorageKeys200Response
   */
  public static GetObjectStorageKeys200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetObjectStorageKeys200Response.class);
  }

  /**
   * Convert an instance of GetObjectStorageKeys200Response to an JSON string
   *
   * @return JSON string
   */
