...
public class PostLKEClusterRegenerateRequest {
  public static final String SERIALIZED_NAME_KUBECONFIG = "kubeconfig";
  @SerializedName(SERIALIZED_NAME_KUBECONFIG)
  private Boolean kubeconfig = false;

  public static final String SERIALIZED_NAME_SERVICETOKEN = "servicetoken";
  @SerializedName(SERIALIZED_NAME_SERVICETOKEN)
  private Boolean servicetoken = false;

  public PostLKEClusterRegenerateRequest() {
  }

  public PostLKEClusterRegenerateRequest kubeconfig(Boolean kubeconfig) {
  ...
  public Boolean getKubeconfig() {
    return kubeconfig;
  }

  public void setKubeconfig(Boolean kubeconfig) {
    this.kubeconfig = kubeconfig;
  }


  public PostLKEClusterRegenerateRequest servicetoken(Boolean servicetoken) {
  ...
  public boolean equals(Object o) {
    ...
    PostLKEClusterRegenerateRequest postLKEClusterRegenerateRequest = (PostLKEClusterRegenerateRequest) o;
    return Objects.equals(this.kubeconfig, postLKEClusterRegenerateRequest.kubeconfig) &&
        Objects.equals(this.servicetoken, postLKEClusterRegenerateRequest.servicetoken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kubeconfig, servicetoken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostLKEClusterRegenerateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostLKEClusterRegenerateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostLKEClusterRegenerateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostLKEClusterRegenerateRequest is not found in the empty JSON string", PostLKEClusterRegenerateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostLKEClusterRegenerateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostLKEClusterRegenerateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostLKEClusterRegenerateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostLKEClusterRegenerateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostLKEClusterRegenerateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostLKEClusterRegenerateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostLKEClusterRegenerateRequest>() {
           @Override
           public void write(JsonWriter out, PostLKEClusterRegenerateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostLKEClusterRegenerateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostLKEClusterRegenerateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostLKEClusterRegenerateRequest
   * @throws IOException if the JSON string is invalid with respect to PostLKEClusterRegenerateRequest
   */
  public static PostLKEClusterRegenerateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostLKEClusterRegenerateRequest.class);
  }

  /**
   * Convert an instance of PostLKEClusterRegenerateRequest to an JSON string
   *
   * @return JSON string
   */
