...
public class PaymentRequest {
  ...
  public PaymentRequest paymentMethodId(Integer paymentMethodId) {
  ...
  public PaymentRequest usd(String usd) {
    this.usd = usd;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cvv, paymentRequest.cvv) &&
        Objects.equals(this.paymentMethodId, paymentRequest.paymentMethodId) &&
        Objects.equals(this.usd, paymentRequest.usd);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cvv, paymentMethodId, usd);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("usd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `usd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("usd").toString()));
      }
  }
