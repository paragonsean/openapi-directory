...
public class GetManagedLinodeSettings200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ManagedLinodeSettings> data = new ArrayList<>();
  ...
  public GetManagedLinodeSettings200Response() {
  }
  ...
  public GetManagedLinodeSettings200Response data(List<ManagedLinodeSettings> data) {
    this.data = data;
    return this;
  }

  public GetManagedLinodeSettings200Response addDataItem(ManagedLinodeSettings dataItem) {
    if (this.data == null) {
  ...
  public List<ManagedLinodeSettings> getData() {
    return data;
  }

  public void setData(List<ManagedLinodeSettings> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedLinodeSettings200Response getManagedLinodeSettings200Response = (GetManagedLinodeSettings200Response) o;
    return Objects.equals(this.data, getManagedLinodeSettings200Response.data) &&
        Objects.equals(this.page, getManagedLinodeSettings200Response.page) &&
        Objects.equals(this.pages, getManagedLinodeSettings200Response.pages) &&
        Objects.equals(this.results, getManagedLinodeSettings200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedLinodeSettings200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedLinodeSettings200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedLinodeSettings200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedLinodeSettings200Response is not found in the empty JSON string", GetManagedLinodeSettings200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedLinodeSettings200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedLinodeSettings200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ManagedLinodeSettings.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedLinodeSettings200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedLinodeSettings200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedLinodeSettings200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedLinodeSettings200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedLinodeSettings200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedLinodeSettings200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedLinodeSettings200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedLinodeSettings200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedLinodeSettings200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedLinodeSettings200Response
   */
  public static GetManagedLinodeSettings200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedLinodeSettings200Response.class);
  }

  /**
   * Convert an instance of GetManagedLinodeSettings200Response to an JSON string
   *
   * @return JSON string
   */
