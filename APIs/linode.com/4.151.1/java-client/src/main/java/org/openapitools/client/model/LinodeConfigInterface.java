...
public class LinodeConfigInterface {
  public static final String SERIALIZED_NAME_IPAM_ADDRESS = "ipam_address";
  @SerializedName(SERIALIZED_NAME_IPAM_ADDRESS)
  ...
  public LinodeConfigInterface() {
  }

  public LinodeConfigInterface ipamAddress(String ipamAddress) {
    this.ipamAddress = ipamAddress;
    return this;
  }

  /**
   * This Network Interface&#39;s private IP address in Classless Inter-Domain Routing (CIDR) notation.  Only used for &#x60;vlan&#x60; purpose interfaces. Must be an empty string or &#x60;null&#x60; for &#x60;public&#x60; purpose interfaces.  The Linode is configured to use this address for the associated interface upon reboot if Network Helper is enabled. If Network Helper is disabled, the address can be enabled with [manual static IP configuration](/docs/guides/manual-network-configuration/).  Must be unique among the Linode&#39;s interfaces. 
   * @return ipamAddress
   */
  @javax.annotation.Nullable
  public String getIpamAddress() {
    return ipamAddress;
  }

  public void setIpamAddress(String ipamAddress) {
    this.ipamAddress = ipamAddress;
  }


  public LinodeConfigInterface label(String label) {
    this.label = label;
    return this;
  }

  /**
   * The name of this interface.  Required for &#x60;vlan&#x60; purpose interfaces. Must be an empty string or &#x60;null&#x60; for &#x60;public&#x60; purpose interfaces.  If the VLAN label is new, a VLAN is created. Up to 10 VLANs can be created in each data center region. To view your active VLANs, use the [VLANs List](/docs/api/networking/#vlans-list) endpoint.  May only consist of ASCII letters, numbers, and dashes (&#x60;-&#x60;).  Must be unique among the Linode&#39;s interfaces. 
   * @return label
   */
  @javax.annotation.Nullable
  ...
  public LinodeConfigInterface purpose(PurposeEnum purpose) {
  ...
  public boolean equals(Object o) {
    ...
    LinodeConfigInterface linodeConfigInterface = (LinodeConfigInterface) o;
    return Objects.equals(this.ipamAddress, linodeConfigInterface.ipamAddress) &&
        Objects.equals(this.label, linodeConfigInterface.label) &&
        Objects.equals(this.purpose, linodeConfigInterface.purpose);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ipamAddress, label, purpose);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinodeConfigInterface {\n");
    sb.append("    ipamAddress: ").append(toIndentedString(ipamAddress)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ipam_address");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeConfigInterface
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeConfigInterface.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeConfigInterface is not found in the empty JSON string", LinodeConfigInterface.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeConfigInterface.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeConfigInterface` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("ipam_address") != null && !jsonObj.get("ipam_address").isJsonNull()) && !jsonObj.get("ipam_address").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ipam_address` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ipam_address").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeConfigInterface.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeConfigInterface' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeConfigInterface> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeConfigInterface.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeConfigInterface>() {
           @Override
           public void write(JsonWriter out, LinodeConfigInterface value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeConfigInterface read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeConfigInterface given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeConfigInterface
   * @throws IOException if the JSON string is invalid with respect to LinodeConfigInterface
   */
  public static LinodeConfigInterface fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeConfigInterface.class);
  }

  /**
   * Convert an instance of LinodeConfigInterface to an JSON string
   *
   * @return JSON string
   */
