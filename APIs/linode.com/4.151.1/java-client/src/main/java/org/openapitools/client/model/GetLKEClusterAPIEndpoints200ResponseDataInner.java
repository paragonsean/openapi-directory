...
public class GetLKEClusterAPIEndpoints200ResponseDataInner {
  public static final String SERIALIZED_NAME_ENDPOINT = "endpoint";
  @SerializedName(SERIALIZED_NAME_ENDPOINT)
  private String endpoint;

  public GetLKEClusterAPIEndpoints200ResponseDataInner() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterAPIEndpoints200ResponseDataInner getLKEClusterAPIEndpoints200ResponseDataInner = (GetLKEClusterAPIEndpoints200ResponseDataInner) o;
    return Objects.equals(this.endpoint, getLKEClusterAPIEndpoints200ResponseDataInner.endpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusterAPIEndpoints200ResponseDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterAPIEndpoints200ResponseDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterAPIEndpoints200ResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterAPIEndpoints200ResponseDataInner is not found in the empty JSON string", GetLKEClusterAPIEndpoints200ResponseDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterAPIEndpoints200ResponseDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterAPIEndpoints200ResponseDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterAPIEndpoints200ResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterAPIEndpoints200ResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterAPIEndpoints200ResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterAPIEndpoints200ResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterAPIEndpoints200ResponseDataInner>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterAPIEndpoints200ResponseDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterAPIEndpoints200ResponseDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterAPIEndpoints200ResponseDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterAPIEndpoints200ResponseDataInner
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterAPIEndpoints200ResponseDataInner
   */
  public static GetLKEClusterAPIEndpoints200ResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterAPIEndpoints200ResponseDataInner.class);
  }

  /**
   * Convert an instance of GetLKEClusterAPIEndpoints200ResponseDataInner to an JSON string
   *
   * @return JSON string
   */
