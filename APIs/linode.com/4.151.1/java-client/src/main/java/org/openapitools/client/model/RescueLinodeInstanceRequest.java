...
import org.openapitools.client.model.RescueDevices;
...
public class RescueLinodeInstanceRequest {
  public static final String SERIALIZED_NAME_DEVICES = "devices";
  @SerializedName(SERIALIZED_NAME_DEVICES)
  private RescueDevices devices;

  public RescueLinodeInstanceRequest() {
  }

  public RescueLinodeInstanceRequest devices(RescueDevices devices) {
  ...
  public RescueDevices getDevices() {
    return devices;
  }

  public void setDevices(RescueDevices devices) {
    this.devices = devices;
  }
  ...
  public boolean equals(Object o) {
    ...
    RescueLinodeInstanceRequest rescueLinodeInstanceRequest = (RescueLinodeInstanceRequest) o;
    return Objects.equals(this.devices, rescueLinodeInstanceRequest.devices);
  }
  ...
  public String toString() {
    ...
    sb.append("class RescueLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RescueLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RescueLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RescueLinodeInstanceRequest is not found in the empty JSON string", RescueLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RescueLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RescueLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `devices`
      if (jsonObj.get("devices") != null && !jsonObj.get("devices").isJsonNull()) {
        RescueDevices.validateJsonElement(jsonObj.get("devices"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RescueLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RescueLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RescueLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RescueLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RescueLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, RescueLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RescueLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RescueLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RescueLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to RescueLinodeInstanceRequest
   */
  public static RescueLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RescueLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of RescueLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
