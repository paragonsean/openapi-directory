...
import org.openapitools.client.model.IPv6Range;
...
public class GetIPv6Ranges200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<IPv6Range> data = new ArrayList<>();
  ...
  public GetIPv6Ranges200Response() {
  }
  ...
  public GetIPv6Ranges200Response data(List<IPv6Range> data) {
    this.data = data;
    return this;
  }

  public GetIPv6Ranges200Response addDataItem(IPv6Range dataItem) {
    if (this.data == null) {
  ...
  public List<IPv6Range> getData() {
    return data;
  }

  public void setData(List<IPv6Range> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIPv6Ranges200Response getIPv6Ranges200Response = (GetIPv6Ranges200Response) o;
    return Objects.equals(this.data, getIPv6Ranges200Response.data) &&
        Objects.equals(this.page, getIPv6Ranges200Response.page) &&
        Objects.equals(this.pages, getIPv6Ranges200Response.pages) &&
        Objects.equals(this.results, getIPv6Ranges200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIPv6Ranges200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIPv6Ranges200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIPv6Ranges200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIPv6Ranges200Response is not found in the empty JSON string", GetIPv6Ranges200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIPv6Ranges200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIPv6Ranges200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            IPv6Range.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIPv6Ranges200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIPv6Ranges200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIPv6Ranges200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIPv6Ranges200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIPv6Ranges200Response>() {
           @Override
           public void write(JsonWriter out, GetIPv6Ranges200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIPv6Ranges200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIPv6Ranges200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIPv6Ranges200Response
   * @throws IOException if the JSON string is invalid with respect to GetIPv6Ranges200Response
   */
  public static GetIPv6Ranges200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIPv6Ranges200Response.class);
  }

  /**
   * Convert an instance of GetIPv6Ranges200Response to an JSON string
   *
   * @return JSON string
   */
