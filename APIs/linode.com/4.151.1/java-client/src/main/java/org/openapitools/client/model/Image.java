...
public class Image {
  ...
  public Image label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, image.created) &&
        ...
        Objects.equals(this.deprecated, image.deprecated) &&
        Objects.equals(this.description, image.description) &&
        Objects.equals(this.eol, image.eol) &&
        Objects.equals(this.expiry, image.expiry) &&
        Objects.equals(this.id, image.id) &&
        Objects.equals(this.isPublic, image.isPublic) &&
        Objects.equals(this.label, image.label) &&
        ...
        Objects.equals(this.vendor, image.vendor);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, createdBy, deprecated, description, eol, expiry, id, isPublic, label, size, status, type, updated, vendor);
  }
