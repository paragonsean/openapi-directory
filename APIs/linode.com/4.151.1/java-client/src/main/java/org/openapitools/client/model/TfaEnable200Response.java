...
public class TfaEnable200Response {
  ...
  public TfaEnable200Response() {
  }

  public TfaEnable200Response expiry(OffsetDateTime expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public TfaEnable200Response secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TfaEnable200Response tfaEnable200Response = (TfaEnable200Response) o;
    return Objects.equals(this.expiry, tfaEnable200Response.expiry) &&
        Objects.equals(this.secret, tfaEnable200Response.secret);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiry, secret);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TfaEnable200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TfaEnable200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TfaEnable200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TfaEnable200Response is not found in the empty JSON string", TfaEnable200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TfaEnable200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TfaEnable200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TfaEnable200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TfaEnable200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TfaEnable200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TfaEnable200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TfaEnable200Response>() {
           @Override
           public void write(JsonWriter out, TfaEnable200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TfaEnable200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TfaEnable200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TfaEnable200Response
   * @throws IOException if the JSON string is invalid with respect to TfaEnable200Response
   */
  public static TfaEnable200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TfaEnable200Response.class);
  }

  /**
   * Convert an instance of TfaEnable200Response to an JSON string
   *
   * @return JSON string
   */
