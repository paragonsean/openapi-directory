...
import org.openapitools.client.model.GetStackScripts200Response;
import org.openapitools.client.model.StackScript;
...
public class StackScriptsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public StackScriptsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public StackScriptsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addStackScript
     * @param stackScript The properties to set for the new StackScript. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> StackScript successfully created. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call addStackScriptCall(StackScript stackScript, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = stackScript;

        // create path and map variables
        String localVarPath = "/linode/stackscripts";
    ...
    private okhttp3.Call addStackScriptValidateBeforeCall(StackScript stackScript, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'stackScript' is set
        if (stackScript == null) {
            throw new ApiException("Missing the required parameter 'stackScript' when calling addStackScript(Async)");
        }

        return addStackScriptCall(stackScript, _callback);
     ...
     */
    public StackScript addStackScript(StackScript stackScript) throws ApiException {
        ApiResponse<StackScript> localVarResp = addStackScriptWithHttpInfo(stackScript);
     ...
     * Creates a StackScript in your Account. 
     * @param stackScript The properties to set for the new StackScript. (required)
     * @return ApiResponse&lt;StackScript&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<StackScript> addStackScriptWithHttpInfo(StackScript stackScript) throws ApiException {
        okhttp3.Call localVarCall = addStackScriptValidateBeforeCall(stackScript, null);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StackScript Create (asynchronously)
     * Creates a StackScript in your Account. 
     * @param stackScript The properties to set for the new StackScript. (required)
     ...
     */
    public okhttp3.Call addStackScriptAsync(StackScript stackScript, final ApiCallback<StackScript> _callback) throws ApiException {

        okhttp3.Call localVarCall = addStackScriptValidateBeforeCall(stackScript, _callback);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteStackScript
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> StackScript was deleted. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteStackScriptCall(String stackscriptId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/linode/stackscripts/{stackscriptId}"
            .replace("{" + "stackscriptId" + "}", localVarApiClient.escapeString(stackscriptId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteStackScriptValidateBeforeCall(String stackscriptId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'stackscriptId' is set
        if (stackscriptId == null) {
            throw new ApiException("Missing the required parameter 'stackscriptId' when calling deleteStackScript(Async)");
        }

        return deleteStackScriptCall(stackscriptId, _callback);
     ...
     */
    public Object deleteStackScript(String stackscriptId) throws ApiException {
        ApiResponse<Object> localVarResp = deleteStackScriptWithHttpInfo(stackscriptId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteStackScriptWithHttpInfo(String stackscriptId) throws ApiException {
        okhttp3.Call localVarCall = deleteStackScriptValidateBeforeCall(stackscriptId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StackScript Delete (asynchronously)
     * Deletes a private StackScript you have permission to &#x60;read_write&#x60;. You cannot delete a public StackScript. 
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteStackScriptAsync(String stackscriptId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteStackScriptValidateBeforeCall(stackscriptId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getStackScript
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A single StackScript. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getStackScriptCall(String stackscriptId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStackScriptValidateBeforeCall(String stackscriptId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'stackscriptId' is set
        if (stackscriptId == null) {
            throw new ApiException("Missing the required parameter 'stackscriptId' when calling getStackScript(Async)");
        }

        return getStackScriptCall(stackscriptId, _callback);
     ...
     */
    public StackScript getStackScript(String stackscriptId) throws ApiException {
        ApiResponse<StackScript> localVarResp = getStackScriptWithHttpInfo(stackscriptId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StackScript> getStackScriptWithHttpInfo(String stackscriptId) throws ApiException {
        okhttp3.Call localVarCall = getStackScriptValidateBeforeCall(stackscriptId, null);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StackScript View (asynchronously)
     * Returns all of the information about a specified StackScript, including the contents of the script. 
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getStackScriptAsync(String stackscriptId, final ApiCallback<StackScript> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStackScriptValidateBeforeCall(stackscriptId, _callback);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getStackScripts
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of StackScripts available to the User, including private StackScripts owned by the User if the request is authenticated.  </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getStackScriptsCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStackScriptsValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return getStackScriptsCall(page, pageSize, _callback);
     ...
     */
    public GetStackScripts200Response getStackScripts(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetStackScripts200Response> localVarResp = getStackScriptsWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @return ApiResponse&lt;GetStackScripts200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetStackScripts200Response> getStackScriptsWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getStackScriptsValidateBeforeCall(page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetStackScripts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StackScripts List (asynchronously)
     * If the request is not authenticated, only public StackScripts are returned.  For more information on StackScripts, please read our [StackScripts documentation](/docs/products/tools/stackscripts/). 
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getStackScriptsAsync(Integer page, Integer pageSize, final ApiCallback<GetStackScripts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStackScriptsValidateBeforeCall(page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetStackScripts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateStackScript
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param stackScript The fields to update. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> StackScript was successfully modified. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateStackScriptCall(String stackscriptId, StackScript stackScript, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateStackScriptValidateBeforeCall(String stackscriptId, StackScript stackScript, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'stackscriptId' is set
        if (stackscriptId == null) {
            throw new ApiException("Missing the required parameter 'stackscriptId' when calling updateStackScript(Async)");
        }

        return updateStackScriptCall(stackscriptId, stackScript, _callback);
     ...
     */
    public StackScript updateStackScript(String stackscriptId, StackScript stackScript) throws ApiException {
        ApiResponse<StackScript> localVarResp = updateStackScriptWithHttpInfo(stackscriptId, stackScript);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StackScript> updateStackScriptWithHttpInfo(String stackscriptId, StackScript stackScript) throws ApiException {
        okhttp3.Call localVarCall = updateStackScriptValidateBeforeCall(stackscriptId, stackScript, null);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StackScript Update (asynchronously)
     * Updates a StackScript.  **Once a StackScript is made public, it cannot be made private.** 
     * @param stackscriptId The ID of the StackScript to look up. (required)
     * @param stackScript The fields to update. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateStackScriptAsync(String stackscriptId, StackScript stackScript, final ApiCallback<StackScript> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateStackScriptValidateBeforeCall(stackscriptId, stackScript, _callback);
        Type localVarReturnType = new TypeToken<StackScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
