...
public class UpdateVolumeRequest {
  ...
  public UpdateVolumeRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public UpdateVolumeRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateVolumeRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, updateVolumeRequest.created) &&
        Objects.equals(this.filesystemPath, updateVolumeRequest.filesystemPath) &&
        Objects.equals(this.hardwareType, updateVolumeRequest.hardwareType) &&
        Objects.equals(this.id, updateVolumeRequest.id) &&
        Objects.equals(this.label, updateVolumeRequest.label) &&
        Objects.equals(this.linodeId, updateVolumeRequest.linodeId) &&
        Objects.equals(this.linodeLabel, updateVolumeRequest.linodeLabel) &&
        Objects.equals(this.region, updateVolumeRequest.region) &&
        Objects.equals(this.size, updateVolumeRequest.size) &&
        Objects.equals(this.status, updateVolumeRequest.status) &&
        Objects.equals(this.tags, updateVolumeRequest.tags) &&
        Objects.equals(this.updated, updateVolumeRequest.updated);
  }
