...
import org.openapitools.client.model.PutLKEClusterRequestControlPlane;
...
public class PutLKEClusterRequest {
  public static final String SERIALIZED_NAME_CONTROL_PLANE = "control_plane";
  @SerializedName(SERIALIZED_NAME_CONTROL_PLANE)
  private PutLKEClusterRequestControlPlane controlPlane;
  ...
  public PutLKEClusterRequest() {
  }

  public PutLKEClusterRequest controlPlane(PutLKEClusterRequestControlPlane controlPlane) {
  ...
  public PutLKEClusterRequestControlPlane getControlPlane() {
    return controlPlane;
  }

  public void setControlPlane(PutLKEClusterRequestControlPlane controlPlane) {
    this.controlPlane = controlPlane;
  }


  public PutLKEClusterRequest k8sVersion(String k8sVersion) {
  ...
  public PutLKEClusterRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PutLKEClusterRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PutLKEClusterRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    PutLKEClusterRequest putLKEClusterRequest = (PutLKEClusterRequest) o;
    return Objects.equals(this.controlPlane, putLKEClusterRequest.controlPlane) &&
        Objects.equals(this.k8sVersion, putLKEClusterRequest.k8sVersion) &&
        Objects.equals(this.label, putLKEClusterRequest.label) &&
        Objects.equals(this.tags, putLKEClusterRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(controlPlane, k8sVersion, label, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutLKEClusterRequest {\n");
  ...
  static {
    ...
    openapiFields.add("control_plane");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutLKEClusterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutLKEClusterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutLKEClusterRequest is not found in the empty JSON string", PutLKEClusterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutLKEClusterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutLKEClusterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `control_plane`
      if (jsonObj.get("control_plane") != null && !jsonObj.get("control_plane").isJsonNull()) {
        PutLKEClusterRequestControlPlane.validateJsonElement(jsonObj.get("control_plane"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutLKEClusterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutLKEClusterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutLKEClusterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutLKEClusterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutLKEClusterRequest>() {
           @Override
           public void write(JsonWriter out, PutLKEClusterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutLKEClusterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutLKEClusterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutLKEClusterRequest
   * @throws IOException if the JSON string is invalid with respect to PutLKEClusterRequest
   */
  public static PutLKEClusterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutLKEClusterRequest.class);
  }

  /**
   * Convert an instance of PutLKEClusterRequest to an JSON string
   *
   * @return JSON string
   */
