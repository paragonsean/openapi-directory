...
public class IPAddressesAssignRequestAssignmentsInner {
  ...
  public IPAddressesAssignRequestAssignmentsInner() {
  }

  public IPAddressesAssignRequestAssignmentsInner address(String address) {
  ...
  public IPAddressesAssignRequestAssignmentsInner linodeId(Integer linodeId) {
  ...
  public boolean equals(Object o) {
    ...
    IPAddressesAssignRequestAssignmentsInner ipAddressesAssignRequestAssignmentsInner = (IPAddressesAssignRequestAssignmentsInner) o;
    return Objects.equals(this.address, ipAddressesAssignRequestAssignmentsInner.address) &&
        Objects.equals(this.linodeId, ipAddressesAssignRequestAssignmentsInner.linodeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, linodeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPAddressesAssignRequestAssignmentsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressesAssignRequestAssignmentsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressesAssignRequestAssignmentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressesAssignRequestAssignmentsInner is not found in the empty JSON string", IPAddressesAssignRequestAssignmentsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressesAssignRequestAssignmentsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressesAssignRequestAssignmentsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressesAssignRequestAssignmentsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressesAssignRequestAssignmentsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressesAssignRequestAssignmentsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressesAssignRequestAssignmentsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressesAssignRequestAssignmentsInner>() {
           @Override
           public void write(JsonWriter out, IPAddressesAssignRequestAssignmentsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressesAssignRequestAssignmentsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressesAssignRequestAssignmentsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressesAssignRequestAssignmentsInner
   * @throws IOException if the JSON string is invalid with respect to IPAddressesAssignRequestAssignmentsInner
   */
  public static IPAddressesAssignRequestAssignmentsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressesAssignRequestAssignmentsInner.class);
  }

  /**
   * Convert an instance of IPAddressesAssignRequestAssignmentsInner to an JSON string
   *
   * @return JSON string
   */
