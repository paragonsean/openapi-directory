...
public class LKEVersion {
  ...
  public LKEVersion id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKEVersion lkEVersion = (LKEVersion) o;
    return Objects.equals(this.id, lkEVersion.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKEVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKEVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKEVersion is not found in the empty JSON string", LKEVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKEVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKEVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKEVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKEVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKEVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKEVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<LKEVersion>() {
           @Override
           public void write(JsonWriter out, LKEVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKEVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKEVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKEVersion
   * @throws IOException if the JSON string is invalid with respect to LKEVersion
   */
  public static LKEVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKEVersion.class);
  }

  /**
   * Convert an instance of LKEVersion to an JSON string
   *
   * @return JSON string
   */
