...
public class GetStackScripts200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<StackScript> data = new ArrayList<>();
  ...
  public GetStackScripts200Response() {
  }
  ...
  public GetStackScripts200Response data(List<StackScript> data) {
    this.data = data;
    return this;
  }

  public GetStackScripts200Response addDataItem(StackScript dataItem) {
    if (this.data == null) {
  ...
  public List<StackScript> getData() {
    return data;
  }

  public void setData(List<StackScript> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStackScripts200Response getStackScripts200Response = (GetStackScripts200Response) o;
    return Objects.equals(this.data, getStackScripts200Response.data) &&
        Objects.equals(this.page, getStackScripts200Response.page) &&
        Objects.equals(this.pages, getStackScripts200Response.pages) &&
        Objects.equals(this.results, getStackScripts200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStackScripts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStackScripts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStackScripts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStackScripts200Response is not found in the empty JSON string", GetStackScripts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStackScripts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStackScripts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            StackScript.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStackScripts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStackScripts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStackScripts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStackScripts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStackScripts200Response>() {
           @Override
           public void write(JsonWriter out, GetStackScripts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStackScripts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStackScripts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStackScripts200Response
   * @throws IOException if the JSON string is invalid with respect to GetStackScripts200Response
   */
  public static GetStackScripts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStackScripts200Response.class);
  }

  /**
   * Convert an instance of GetStackScripts200Response to an JSON string
   *
   * @return JSON string
   */
