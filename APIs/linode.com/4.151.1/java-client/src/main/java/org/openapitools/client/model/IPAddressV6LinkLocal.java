...
public class IPAddressV6LinkLocal {
  ...
  public IPAddressV6LinkLocal rdns(String rdns) {
    this.rdns = rdns;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPAddressV6LinkLocal ipAddressV6LinkLocal = (IPAddressV6LinkLocal) o;
    return Objects.equals(this.address, ipAddressV6LinkLocal.address) &&
        Objects.equals(this.gateway, ipAddressV6LinkLocal.gateway) &&
        Objects.equals(this.linodeId, ipAddressV6LinkLocal.linodeId) &&
        Objects.equals(this.prefix, ipAddressV6LinkLocal.prefix) &&
        Objects.equals(this._public, ipAddressV6LinkLocal._public) &&
        Objects.equals(this.rdns, ipAddressV6LinkLocal.rdns) &&
        Objects.equals(this.region, ipAddressV6LinkLocal.region) &&
        Objects.equals(this.subnetMask, ipAddressV6LinkLocal.subnetMask) &&
        Objects.equals(this.type, ipAddressV6LinkLocal.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPAddressV6LinkLocal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressV6LinkLocal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressV6LinkLocal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressV6LinkLocal is not found in the empty JSON string", IPAddressV6LinkLocal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressV6LinkLocal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressV6LinkLocal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressV6LinkLocal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressV6LinkLocal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressV6LinkLocal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressV6LinkLocal.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressV6LinkLocal>() {
           @Override
           public void write(JsonWriter out, IPAddressV6LinkLocal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressV6LinkLocal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressV6LinkLocal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressV6LinkLocal
   * @throws IOException if the JSON string is invalid with respect to IPAddressV6LinkLocal
   */
  public static IPAddressV6LinkLocal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressV6LinkLocal.class);
  }

  /**
   * Convert an instance of IPAddressV6LinkLocal to an JSON string
   *
   * @return JSON string
   */
