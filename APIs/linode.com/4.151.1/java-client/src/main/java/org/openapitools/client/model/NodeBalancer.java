...
import org.openapitools.client.model.NodeBalancerTransfer;
...
public class NodeBalancer {
  ...
  private NodeBalancerTransfer transfer;
  ...
  public NodeBalancer clientConnThrottle(Integer clientConnThrottle) {
  ...
  public NodeBalancer label(String label) {
    this.label = label;
    return this;
  }
  ...
  public NodeBalancer tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public NodeBalancer addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public NodeBalancer transfer(NodeBalancerTransfer transfer) {
   ...
   */
  @javax.annotation.Nullable
  public NodeBalancerTransfer getTransfer() {
    return transfer;
  }

  public void setTransfer(NodeBalancerTransfer transfer) {
    this.transfer = transfer;
  }
  ...
  public boolean equals(Object o) {
    ...
    NodeBalancer nodeBalancer = (NodeBalancer) o;
    return Objects.equals(this.clientConnThrottle, nodeBalancer.clientConnThrottle) &&
        Objects.equals(this.created, nodeBalancer.created) &&
        Objects.equals(this.hostname, nodeBalancer.hostname) &&
        Objects.equals(this.id, nodeBalancer.id) &&
        Objects.equals(this.ipv4, nodeBalancer.ipv4) &&
        Objects.equals(this.ipv6, nodeBalancer.ipv6) &&
        Objects.equals(this.label, nodeBalancer.label) &&
        Objects.equals(this.region, nodeBalancer.region) &&
        Objects.equals(this.tags, nodeBalancer.tags) &&
        Objects.equals(this.transfer, nodeBalancer.transfer) &&
        Objects.equals(this.updated, nodeBalancer.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientConnThrottle, created, hostname, id, ipv4, ipv6, label, region, tags, transfer, updated);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeBalancer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeBalancer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeBalancer is not found in the empty JSON string", NodeBalancer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeBalancer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeBalancer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("transfer") != null && !jsonObj.get("transfer").isJsonNull()) {
        NodeBalancerTransfer.validateJsonElement(jsonObj.get("transfer"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeBalancer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeBalancer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeBalancer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancer.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeBalancer>() {
           @Override
           public void write(JsonWriter out, NodeBalancer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeBalancer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeBalancer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeBalancer
   * @throws IOException if the JSON string is invalid with respect to NodeBalancer
   */
  public static NodeBalancer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeBalancer.class);
  }

  /**
   * Convert an instance of NodeBalancer to an JSON string
   *
   * @return JSON string
   */
