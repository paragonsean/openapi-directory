...
public class EventEntity {
  ...
  public EventEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EventEntity url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eventEntity.id) &&
        Objects.equals(this.label, eventEntity.label) &&
        Objects.equals(this.type, eventEntity.type) &&
        Objects.equals(this.url, eventEntity.url);
  }
