...
public class RebuildNodeBalancerConfigRequestAllOfNodesInner {
  ...
  public RebuildNodeBalancerConfigRequestAllOfNodesInner() {
  }

  public RebuildNodeBalancerConfigRequestAllOfNodesInner address(String address) {
  ...
  public RebuildNodeBalancerConfigRequestAllOfNodesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequestAllOfNodesInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequestAllOfNodesInner mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public RebuildNodeBalancerConfigRequestAllOfNodesInner weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RebuildNodeBalancerConfigRequestAllOfNodesInner rebuildNodeBalancerConfigRequestAllOfNodesInner = (RebuildNodeBalancerConfigRequestAllOfNodesInner) o;
    return Objects.equals(this.address, rebuildNodeBalancerConfigRequestAllOfNodesInner.address) &&
        Objects.equals(this.id, rebuildNodeBalancerConfigRequestAllOfNodesInner.id) &&
        Objects.equals(this.label, rebuildNodeBalancerConfigRequestAllOfNodesInner.label) &&
        Objects.equals(this.mode, rebuildNodeBalancerConfigRequestAllOfNodesInner.mode) &&
        Objects.equals(this.weight, rebuildNodeBalancerConfigRequestAllOfNodesInner.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, id, label, mode, weight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RebuildNodeBalancerConfigRequestAllOfNodesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebuildNodeBalancerConfigRequestAllOfNodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebuildNodeBalancerConfigRequestAllOfNodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RebuildNodeBalancerConfigRequestAllOfNodesInner is not found in the empty JSON string", RebuildNodeBalancerConfigRequestAllOfNodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RebuildNodeBalancerConfigRequestAllOfNodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RebuildNodeBalancerConfigRequestAllOfNodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RebuildNodeBalancerConfigRequestAllOfNodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RebuildNodeBalancerConfigRequestAllOfNodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RebuildNodeBalancerConfigRequestAllOfNodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RebuildNodeBalancerConfigRequestAllOfNodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RebuildNodeBalancerConfigRequestAllOfNodesInner>() {
           @Override
           public void write(JsonWriter out, RebuildNodeBalancerConfigRequestAllOfNodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RebuildNodeBalancerConfigRequestAllOfNodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RebuildNodeBalancerConfigRequestAllOfNodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RebuildNodeBalancerConfigRequestAllOfNodesInner
   * @throws IOException if the JSON string is invalid with respect to RebuildNodeBalancerConfigRequestAllOfNodesInner
   */
  public static RebuildNodeBalancerConfigRequestAllOfNodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RebuildNodeBalancerConfigRequestAllOfNodesInner.class);
  }

  /**
   * Convert an instance of RebuildNodeBalancerConfigRequestAllOfNodesInner to an JSON string
   *
   * @return JSON string
   */
