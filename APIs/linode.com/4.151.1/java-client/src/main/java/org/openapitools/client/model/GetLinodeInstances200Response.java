...
public class GetLinodeInstances200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Linode> data = new ArrayList<>();
  ...
  public GetLinodeInstances200Response() {
  }
  ...
  public GetLinodeInstances200Response data(List<Linode> data) {
    this.data = data;
    return this;
  }

  public GetLinodeInstances200Response addDataItem(Linode dataItem) {
    if (this.data == null) {
  ...
  public List<Linode> getData() {
    return data;
  }

  public void setData(List<Linode> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeInstances200Response getLinodeInstances200Response = (GetLinodeInstances200Response) o;
    return Objects.equals(this.data, getLinodeInstances200Response.data) &&
        Objects.equals(this.page, getLinodeInstances200Response.page) &&
        Objects.equals(this.pages, getLinodeInstances200Response.pages) &&
        Objects.equals(this.results, getLinodeInstances200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeInstances200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeInstances200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeInstances200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeInstances200Response is not found in the empty JSON string", GetLinodeInstances200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeInstances200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeInstances200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Linode.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeInstances200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeInstances200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeInstances200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeInstances200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeInstances200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeInstances200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeInstances200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeInstances200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeInstances200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeInstances200Response
   */
  public static GetLinodeInstances200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeInstances200Response.class);
  }

  /**
   * Convert an instance of GetLinodeInstances200Response to an JSON string
   *
   * @return JSON string
   */
