...
import org.openapitools.client.model.LinodeType;
...
public class GetLinodeTypes200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LinodeType> data = new ArrayList<>();
  ...
  public GetLinodeTypes200Response() {
  }
  ...
  public GetLinodeTypes200Response data(List<LinodeType> data) {
    this.data = data;
    return this;
  }

  public GetLinodeTypes200Response addDataItem(LinodeType dataItem) {
    if (this.data == null) {
  ...
  public List<LinodeType> getData() {
    return data;
  }

  public void setData(List<LinodeType> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeTypes200Response getLinodeTypes200Response = (GetLinodeTypes200Response) o;
    return Objects.equals(this.data, getLinodeTypes200Response.data) &&
        Objects.equals(this.page, getLinodeTypes200Response.page) &&
        Objects.equals(this.pages, getLinodeTypes200Response.pages) &&
        Objects.equals(this.results, getLinodeTypes200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeTypes200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeTypes200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeTypes200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeTypes200Response is not found in the empty JSON string", GetLinodeTypes200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeTypes200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeTypes200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LinodeType.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeTypes200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeTypes200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeTypes200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeTypes200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeTypes200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeTypes200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeTypes200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeTypes200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeTypes200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeTypes200Response
   */
  public static GetLinodeTypes200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeTypes200Response.class);
  }

  /**
   * Convert an instance of GetLinodeTypes200Response to an JSON string
   *
   * @return JSON string
   */
