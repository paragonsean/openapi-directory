...
public class GetTicketReplies200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<SupportTicketReply> data = new ArrayList<>();
  ...
  public GetTicketReplies200Response() {
  }
  ...
  public GetTicketReplies200Response data(List<SupportTicketReply> data) {
    this.data = data;
    return this;
  }

  public GetTicketReplies200Response addDataItem(SupportTicketReply dataItem) {
    if (this.data == null) {
  ...
  public List<SupportTicketReply> getData() {
    return data;
  }

  public void setData(List<SupportTicketReply> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTicketReplies200Response getTicketReplies200Response = (GetTicketReplies200Response) o;
    return Objects.equals(this.data, getTicketReplies200Response.data) &&
        Objects.equals(this.page, getTicketReplies200Response.page) &&
        Objects.equals(this.pages, getTicketReplies200Response.pages) &&
        Objects.equals(this.results, getTicketReplies200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTicketReplies200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTicketReplies200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTicketReplies200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTicketReplies200Response is not found in the empty JSON string", GetTicketReplies200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTicketReplies200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTicketReplies200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SupportTicketReply.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTicketReplies200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTicketReplies200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTicketReplies200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTicketReplies200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTicketReplies200Response>() {
           @Override
           public void write(JsonWriter out, GetTicketReplies200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTicketReplies200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTicketReplies200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTicketReplies200Response
   * @throws IOException if the JSON string is invalid with respect to GetTicketReplies200Response
   */
  public static GetTicketReplies200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTicketReplies200Response.class);
  }

  /**
   * Convert an instance of GetTicketReplies200Response to an JSON string
   *
   * @return JSON string
   */
