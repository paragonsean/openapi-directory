...
public class PostProfilePhoneNumberRequest {
  ...
  public PostProfilePhoneNumberRequest() {
  }

  public PostProfilePhoneNumberRequest isoCode(String isoCode) {
  ...
  public PostProfilePhoneNumberRequest phoneNumber(String phoneNumber) {
  ...
  public boolean equals(Object o) {
    ...
    PostProfilePhoneNumberRequest postProfilePhoneNumberRequest = (PostProfilePhoneNumberRequest) o;
    return Objects.equals(this.isoCode, postProfilePhoneNumberRequest.isoCode) &&
        Objects.equals(this.phoneNumber, postProfilePhoneNumberRequest.phoneNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isoCode, phoneNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostProfilePhoneNumberRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostProfilePhoneNumberRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostProfilePhoneNumberRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostProfilePhoneNumberRequest is not found in the empty JSON string", PostProfilePhoneNumberRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostProfilePhoneNumberRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostProfilePhoneNumberRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostProfilePhoneNumberRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostProfilePhoneNumberRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostProfilePhoneNumberRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostProfilePhoneNumberRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostProfilePhoneNumberRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostProfilePhoneNumberRequest>() {
           @Override
           public void write(JsonWriter out, PostProfilePhoneNumberRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostProfilePhoneNumberRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostProfilePhoneNumberRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostProfilePhoneNumberRequest
   * @throws IOException if the JSON string is invalid with respect to PostProfilePhoneNumberRequest
   */
  public static PostProfilePhoneNumberRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostProfilePhoneNumberRequest.class);
  }

  /**
   * Convert an instance of PostProfilePhoneNumberRequest to an JSON string
   *
   * @return JSON string
   */
