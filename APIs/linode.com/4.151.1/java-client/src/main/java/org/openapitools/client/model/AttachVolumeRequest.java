...
public class AttachVolumeRequest {
  ...
  public static final String SERIALIZED_NAME_PERSIST_ACROSS_BOOTS = "persist_across_boots";
  @SerializedName(SERIALIZED_NAME_PERSIST_ACROSS_BOOTS)
  private Boolean persistAcrossBoots;

  public AttachVolumeRequest() {
  }

  public AttachVolumeRequest configId(Integer configId) {
  ...
  public AttachVolumeRequest linodeId(Integer linodeId) {
  ...
  public AttachVolumeRequest persistAcrossBoots(Boolean persistAcrossBoots) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configId, attachVolumeRequest.configId) &&
        Objects.equals(this.linodeId, attachVolumeRequest.linodeId) &&
        Objects.equals(this.persistAcrossBoots, attachVolumeRequest.persistAcrossBoots);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configId, linodeId, persistAcrossBoots);
  }
  ...
  public String toString() {
    ...
    sb.append("    persistAcrossBoots: ").append(toIndentedString(persistAcrossBoots)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("persist_across_boots");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachVolumeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachVolumeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachVolumeRequest is not found in the empty JSON string", AttachVolumeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachVolumeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachVolumeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachVolumeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachVolumeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachVolumeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachVolumeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachVolumeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachVolumeRequest>() {
           @Override
           public void write(JsonWriter out, AttachVolumeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachVolumeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachVolumeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachVolumeRequest
   * @throws IOException if the JSON string is invalid with respect to AttachVolumeRequest
   */
  public static AttachVolumeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachVolumeRequest.class);
  }

  /**
   * Convert an instance of AttachVolumeRequest to an JSON string
   *
   * @return JSON string
   */
