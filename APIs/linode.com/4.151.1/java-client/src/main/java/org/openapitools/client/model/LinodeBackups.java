...
import org.openapitools.client.model.LinodeBackupsSchedule;
...
public class LinodeBackups {
  ...
  public static final String SERIALIZED_NAME_LAST_SUCCESSFUL = "last_successful";
  @SerializedName(SERIALIZED_NAME_LAST_SUCCESSFUL)
  private OffsetDateTime lastSuccessful;

  public static final String SERIALIZED_NAME_SCHEDULE = "schedule";
  @SerializedName(SERIALIZED_NAME_SCHEDULE)
  private LinodeBackupsSchedule schedule;

  public LinodeBackups() {
  }

  public LinodeBackups(
     Boolean available, 
     Boolean enabled, 
     OffsetDateTime lastSuccessful
  ) {
    this();
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getLastSuccessful() {
    return lastSuccessful;
  }



  public LinodeBackups schedule(LinodeBackupsSchedule schedule) {
   ...
   */
  @javax.annotation.Nullable
  public LinodeBackupsSchedule getSchedule() {
    return schedule;
  }

  public void setSchedule(LinodeBackupsSchedule schedule) {
    this.schedule = schedule;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeBackups linodeBackups = (LinodeBackups) o;
    return Objects.equals(this.available, linodeBackups.available) &&
        Objects.equals(this.enabled, linodeBackups.enabled) &&
        Objects.equals(this.lastSuccessful, linodeBackups.lastSuccessful) &&
        Objects.equals(this.schedule, linodeBackups.schedule);
  }

  @Override
  public int hashCode() {
    return Objects.hash(available, enabled, lastSuccessful, schedule);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinodeBackups {\n");
    sb.append("    available: ").append(toIndentedString(available)).append("\n");
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    lastSuccessful: ").append(toIndentedString(lastSuccessful)).append("\n");
  ...
  static {
    ...
    openapiFields.add("last_successful");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeBackups
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeBackups.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeBackups is not found in the empty JSON string", LinodeBackups.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeBackups.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeBackups` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `schedule`
      if (jsonObj.get("schedule") != null && !jsonObj.get("schedule").isJsonNull()) {
        LinodeBackupsSchedule.validateJsonElement(jsonObj.get("schedule"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeBackups.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeBackups' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeBackups> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeBackups.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeBackups>() {
           @Override
           public void write(JsonWriter out, LinodeBackups value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeBackups read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeBackups given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeBackups
   * @throws IOException if the JSON string is invalid with respect to LinodeBackups
   */
  public static LinodeBackups fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeBackups.class);
  }

  /**
   * Convert an instance of LinodeBackups to an JSON string
   *
   * @return JSON string
   */
