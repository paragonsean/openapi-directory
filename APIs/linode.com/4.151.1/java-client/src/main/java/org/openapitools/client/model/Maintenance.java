...
import org.openapitools.client.model.MaintenanceEntity;
...
public class Maintenance {
  ...
  public Maintenance entity(MaintenanceEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public Maintenance reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public Maintenance status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public Maintenance type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Maintenance when(OffsetDateTime when) {
    this.when = when;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entity, maintenance.entity) &&
        ...
        Objects.equals(this.when, maintenance.when);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entity, reason, status, type, when);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        MaintenanceEntity.validateJsonElement(jsonObj.get("entity"));
      }
