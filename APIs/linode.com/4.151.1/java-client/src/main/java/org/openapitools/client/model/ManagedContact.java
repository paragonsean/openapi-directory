...
import org.openapitools.client.model.ManagedContactPhone;
...
public class ManagedContact {
  ...
  private ManagedContactPhone phone;

  public static final String SERIALIZED_NAME_UPDATED = "updated";
  @SerializedName(SERIALIZED_NAME_UPDATED)
  private OffsetDateTime updated;

  public ManagedContact() {
  }
  ...
  public ManagedContact email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ManagedContact group(String group) {
    this.group = group;
    return this;
  }
  ...
  public ManagedContact name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ManagedContact phone(ManagedContactPhone phone) {
    this.phone = phone;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ManagedContactPhone getPhone() {
    return phone;
  }

  public void setPhone(ManagedContactPhone phone) {
    this.phone = phone;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManagedContact managedContact = (ManagedContact) o;
    return Objects.equals(this.email, managedContact.email) &&
        Objects.equals(this.group, managedContact.group) &&
        Objects.equals(this.id, managedContact.id) &&
        Objects.equals(this.name, managedContact.name) &&
        Objects.equals(this.phone, managedContact.phone) &&
        Objects.equals(this.updated, managedContact.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, group, id, name, phone, updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagedContact {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedContact is not found in the empty JSON string", ManagedContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("phone") != null && !jsonObj.get("phone").isJsonNull()) {
        ManagedContactPhone.validateJsonElement(jsonObj.get("phone"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedContact.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedContact>() {
           @Override
           public void write(JsonWriter out, ManagedContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedContact
   * @throws IOException if the JSON string is invalid with respect to ManagedContact
   */
  public static ManagedContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedContact.class);
  }

  /**
   * Convert an instance of ManagedContact to an JSON string
   *
   * @return JSON string
   */
