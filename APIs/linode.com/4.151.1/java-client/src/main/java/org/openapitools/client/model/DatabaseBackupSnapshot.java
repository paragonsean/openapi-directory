...
public class DatabaseBackupSnapshot {
  ...
  private TargetEnum target = TargetEnum.PRIMARY;

  public DatabaseBackupSnapshot() {
  }

  public DatabaseBackupSnapshot label(String label) {
    this.label = label;
    return this;
  }

  /**
   * The label for the Database snapshot backup.  * Must include only ASCII letters or numbers. * Must be unique among other backup labels for this Database. 
   * @return label
   */
  ...
  public DatabaseBackupSnapshot target(TargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabaseBackupSnapshot databaseBackupSnapshot = (DatabaseBackupSnapshot) o;
    return Objects.equals(this.label, databaseBackupSnapshot.label) &&
        Objects.equals(this.target, databaseBackupSnapshot.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseBackupSnapshot {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseBackupSnapshot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseBackupSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseBackupSnapshot is not found in the empty JSON string", DatabaseBackupSnapshot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseBackupSnapshot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseBackupSnapshot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseBackupSnapshot.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseBackupSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseBackupSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseBackupSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseBackupSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseBackupSnapshot>() {
           @Override
           public void write(JsonWriter out, DatabaseBackupSnapshot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseBackupSnapshot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseBackupSnapshot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseBackupSnapshot
   * @throws IOException if the JSON string is invalid with respect to DatabaseBackupSnapshot
   */
  public static DatabaseBackupSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseBackupSnapshot.class);
  }

  /**
   * Convert an instance of DatabaseBackupSnapshot to an JSON string
   *
   * @return JSON string
   */
