...
public class GetLKEClusterDashboard200Response {
  public static final String SERIALIZED_NAME_URL = "url";
  @SerializedName(SERIALIZED_NAME_URL)
  private String url;

  public GetLKEClusterDashboard200Response() {
  }

  public GetLKEClusterDashboard200Response url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterDashboard200Response getLKEClusterDashboard200Response = (GetLKEClusterDashboard200Response) o;
    return Objects.equals(this.url, getLKEClusterDashboard200Response.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusterDashboard200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterDashboard200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterDashboard200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterDashboard200Response is not found in the empty JSON string", GetLKEClusterDashboard200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterDashboard200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterDashboard200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterDashboard200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterDashboard200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterDashboard200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterDashboard200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterDashboard200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterDashboard200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterDashboard200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterDashboard200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterDashboard200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterDashboard200Response
   */
  public static GetLKEClusterDashboard200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterDashboard200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusterDashboard200Response to an JSON string
   *
   * @return JSON string
   */
