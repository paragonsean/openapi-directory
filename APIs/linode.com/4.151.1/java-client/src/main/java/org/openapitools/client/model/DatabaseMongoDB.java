...
import org.openapitools.client.model.DatabaseMongoDBHosts;
...
public class DatabaseMongoDB {
  ...
  private DatabaseMongoDBHosts hosts;
  ...
  public DatabaseMongoDB allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabaseMongoDB addAllowListItem(String allowListItem) {
  ...
  public DatabaseMongoDB clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public DatabaseMongoDB compressionType(CompressionTypeEnum compressionType) {
  ...
  public DatabaseMongoDB encrypted(Boolean encrypted) {
  ...
  public DatabaseMongoDB hosts(DatabaseMongoDBHosts hosts) {
    this.hosts = hosts;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DatabaseMongoDBHosts getHosts() {
    return hosts;
  }

  public void setHosts(DatabaseMongoDBHosts hosts) {
    this.hosts = hosts;
  }
  ...
  public DatabaseMongoDB label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabaseMongoDB peers(List<String> peers) {
    this.peers = peers;
    return this;
  }

  public DatabaseMongoDB addPeersItem(String peersItem) {
    if (this.peers == null) {
  ...
  public DatabaseMongoDB port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DatabaseMongoDB region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabaseMongoDB replicaSet(String replicaSet) {
  ...
  public DatabaseMongoDB sslConnection(Boolean sslConnection) {
  ...
  public DatabaseMongoDB storageEngine(StorageEngineEnum storageEngine) {
  ...
  public DatabaseMongoDB type(String type) {
    this.type = type;
    return this;
  }
  ...
  public DatabaseMongoDB updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMongoDB databaseMongoDB = (DatabaseMongoDB) o;
    return Objects.equals(this.allowList, databaseMongoDB.allowList) &&
        Objects.equals(this.clusterSize, databaseMongoDB.clusterSize) &&
        Objects.equals(this.compressionType, databaseMongoDB.compressionType) &&
        Objects.equals(this.created, databaseMongoDB.created) &&
        Objects.equals(this.encrypted, databaseMongoDB.encrypted) &&
        Objects.equals(this.engine, databaseMongoDB.engine) &&
        Objects.equals(this.hosts, databaseMongoDB.hosts) &&
        Objects.equals(this.id, databaseMongoDB.id) &&
        Objects.equals(this.label, databaseMongoDB.label) &&
        Objects.equals(this.peers, databaseMongoDB.peers) &&
        Objects.equals(this.port, databaseMongoDB.port) &&
        Objects.equals(this.region, databaseMongoDB.region) &&
        Objects.equals(this.replicaSet, databaseMongoDB.replicaSet) &&
        Objects.equals(this.sslConnection, databaseMongoDB.sslConnection) &&
        Objects.equals(this.status, databaseMongoDB.status) &&
        Objects.equals(this.storageEngine, databaseMongoDB.storageEngine) &&
        Objects.equals(this.type, databaseMongoDB.type) &&
        Objects.equals(this.updated, databaseMongoDB.updated) &&
        Objects.equals(this.updates, databaseMongoDB.updates) &&
        Objects.equals(this.version, databaseMongoDB.version);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, compressionType, created, encrypted, engine, hosts, id, label, peers, port, region, replicaSet, sslConnection, status, storageEngine, type, updated, updates, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseMongoDB {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseMongoDB
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseMongoDB.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMongoDB is not found in the empty JSON string", DatabaseMongoDB.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseMongoDB.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseMongoDB` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("hosts") != null && !jsonObj.get("hosts").isJsonNull()) {
        DatabaseMongoDBHosts.validateJsonElement(jsonObj.get("hosts"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMongoDB.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMongoDB' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMongoDB> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMongoDB.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMongoDB>() {
           @Override
           public void write(JsonWriter out, DatabaseMongoDB value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseMongoDB read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseMongoDB given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseMongoDB
   * @throws IOException if the JSON string is invalid with respect to DatabaseMongoDB
   */
  public static DatabaseMongoDB fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMongoDB.class);
  }

  /**
   * Convert an instance of DatabaseMongoDB to an JSON string
   *
   * @return JSON string
   */
