...
import org.openapitools.client.model.RegionResolvers;
...
public class Region {
  ...
  private RegionResolvers resolvers;
  ...
  public Region resolvers(RegionResolvers resolvers) {
   ...
   */
  @javax.annotation.Nullable
  public RegionResolvers getResolvers() {
    return resolvers;
  }

  public void setResolvers(RegionResolvers resolvers) {
    this.resolvers = resolvers;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.capabilities, region.capabilities) &&
        Objects.equals(this.country, region.country) &&
        Objects.equals(this.id, region.id) &&
        Objects.equals(this.label, region.label) &&
        Objects.equals(this.resolvers, region.resolvers) &&
        Objects.equals(this.status, region.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capabilities, country, id, label, resolvers, status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("resolvers") != null && !jsonObj.get("resolvers").isJsonNull()) {
        RegionResolvers.validateJsonElement(jsonObj.get("resolvers"));
      }
