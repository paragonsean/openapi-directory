...
import org.openapitools.client.model.SecurityQuestionsGetSecurityQuestionsInner;
...
public class SecurityQuestionsGet {
  public static final String SERIALIZED_NAME_SECURITY_QUESTIONS = "security_questions";
  @SerializedName(SERIALIZED_NAME_SECURITY_QUESTIONS)
  private List<SecurityQuestionsGetSecurityQuestionsInner> securityQuestions = new ArrayList<>();

  public SecurityQuestionsGet() {
  }

  public SecurityQuestionsGet securityQuestions(List<SecurityQuestionsGetSecurityQuestionsInner> securityQuestions) {
    this.securityQuestions = securityQuestions;
    return this;
  }

  public SecurityQuestionsGet addSecurityQuestionsItem(SecurityQuestionsGetSecurityQuestionsInner securityQuestionsItem) {
  ...
  public List<SecurityQuestionsGetSecurityQuestionsInner> getSecurityQuestions() {
    return securityQuestions;
  }

  public void setSecurityQuestions(List<SecurityQuestionsGetSecurityQuestionsInner> securityQuestions) {
    this.securityQuestions = securityQuestions;
  }
  ...
  public boolean equals(Object o) {
    ...
    SecurityQuestionsGet securityQuestionsGet = (SecurityQuestionsGet) o;
    return Objects.equals(this.securityQuestions, securityQuestionsGet.securityQuestions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(securityQuestions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SecurityQuestionsGet {\n");
  ...
  static {
    ...
    openapiFields.add("security_questions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityQuestionsGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityQuestionsGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityQuestionsGet is not found in the empty JSON string", SecurityQuestionsGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityQuestionsGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityQuestionsGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("security_questions") != null && !jsonObj.get("security_questions").isJsonNull()) {
        JsonArray jsonArraysecurityQuestions = jsonObj.getAsJsonArray("security_questions");
        if (jsonArraysecurityQuestions != null) {
          // ensure the json data is an array
          if (!jsonObj.get("security_questions").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `security_questions` to be an array in the JSON string but got `%s`", jsonObj.get("security_questions").toString()));
          }

          // validate the optional field `security_questions` (array)
          for (int i = 0; i < jsonArraysecurityQuestions.size(); i++) {
            SecurityQuestionsGetSecurityQuestionsInner.validateJsonElement(jsonArraysecurityQuestions.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecurityQuestionsGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecurityQuestionsGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecurityQuestionsGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecurityQuestionsGet.class));

       return (TypeAdapter<T>) new TypeAdapter<SecurityQuestionsGet>() {
           @Override
           public void write(JsonWriter out, SecurityQuestionsGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecurityQuestionsGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecurityQuestionsGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecurityQuestionsGet
   * @throws IOException if the JSON string is invalid with respect to SecurityQuestionsGet
   */
  public static SecurityQuestionsGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecurityQuestionsGet.class);
  }

  /**
   * Convert an instance of SecurityQuestionsGet to an JSON string
   *
   * @return JSON string
   */
