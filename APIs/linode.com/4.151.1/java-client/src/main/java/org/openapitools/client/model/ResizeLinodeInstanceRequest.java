...
public class ResizeLinodeInstanceRequest {
  public static final String SERIALIZED_NAME_ALLOW_AUTO_DISK_RESIZE = "allow_auto_disk_resize";
  @SerializedName(SERIALIZED_NAME_ALLOW_AUTO_DISK_RESIZE)
  private Boolean allowAutoDiskResize = true;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public ResizeLinodeInstanceRequest() {
  }

  public ResizeLinodeInstanceRequest allowAutoDiskResize(Boolean allowAutoDiskResize) {
   ...
   * @return allowAutoDiskResize
   */
  @javax.annotation.Nullable
  public Boolean getAllowAutoDiskResize() {
    return allowAutoDiskResize;
  }

  public void setAllowAutoDiskResize(Boolean allowAutoDiskResize) {
    this.allowAutoDiskResize = allowAutoDiskResize;
  }


  public ResizeLinodeInstanceRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResizeLinodeInstanceRequest resizeLinodeInstanceRequest = (ResizeLinodeInstanceRequest) o;
    return Objects.equals(this.allowAutoDiskResize, resizeLinodeInstanceRequest.allowAutoDiskResize) &&
        Objects.equals(this.type, resizeLinodeInstanceRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowAutoDiskResize, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResizeLinodeInstanceRequest {\n");
    sb.append("    allowAutoDiskResize: ").append(toIndentedString(allowAutoDiskResize)).append("\n");
  ...
  static {
    ...
    openapiFields.add("allow_auto_disk_resize");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResizeLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResizeLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResizeLinodeInstanceRequest is not found in the empty JSON string", ResizeLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResizeLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResizeLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResizeLinodeInstanceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResizeLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResizeLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResizeLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResizeLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResizeLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, ResizeLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResizeLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResizeLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResizeLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to ResizeLinodeInstanceRequest
   */
  public static ResizeLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResizeLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of ResizeLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
