...
public class GetMaintenance200Response {
  ...
  public GetMaintenance200Response() {
  }
  ...
  public GetMaintenance200Response data(List<Maintenance> data) {
    this.data = data;
    return this;
  }

  public GetMaintenance200Response addDataItem(Maintenance dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetMaintenance200Response getMaintenance200Response = (GetMaintenance200Response) o;
    return Objects.equals(this.data, getMaintenance200Response.data) &&
        Objects.equals(this.page, getMaintenance200Response.page) &&
        Objects.equals(this.pages, getMaintenance200Response.pages) &&
        Objects.equals(this.results, getMaintenance200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMaintenance200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMaintenance200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMaintenance200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMaintenance200Response is not found in the empty JSON string", GetMaintenance200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMaintenance200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMaintenance200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Maintenance.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMaintenance200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMaintenance200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMaintenance200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMaintenance200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMaintenance200Response>() {
           @Override
           public void write(JsonWriter out, GetMaintenance200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMaintenance200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMaintenance200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMaintenance200Response
   * @throws IOException if the JSON string is invalid with respect to GetMaintenance200Response
   */
  public static GetMaintenance200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMaintenance200Response.class);
  }

  /**
   * Convert an instance of GetMaintenance200Response to an JSON string
   *
   * @return JSON string
   */
