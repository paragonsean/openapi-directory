...
public class AddLinodeIPRequest {
  ...
  public AddLinodeIPRequest() {
  }

  public AddLinodeIPRequest _public(Boolean _public) {
  ...
  public AddLinodeIPRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddLinodeIPRequest addLinodeIPRequest = (AddLinodeIPRequest) o;
    return Objects.equals(this._public, addLinodeIPRequest._public) &&
        Objects.equals(this.type, addLinodeIPRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_public, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddLinodeIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddLinodeIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddLinodeIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLinodeIPRequest is not found in the empty JSON string", AddLinodeIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddLinodeIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddLinodeIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLinodeIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLinodeIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLinodeIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLinodeIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLinodeIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLinodeIPRequest>() {
           @Override
           public void write(JsonWriter out, AddLinodeIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddLinodeIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddLinodeIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddLinodeIPRequest
   * @throws IOException if the JSON string is invalid with respect to AddLinodeIPRequest
   */
  public static AddLinodeIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLinodeIPRequest.class);
  }

  /**
   * Convert an instance of AddLinodeIPRequest to an JSON string
   *
   * @return JSON string
   */
