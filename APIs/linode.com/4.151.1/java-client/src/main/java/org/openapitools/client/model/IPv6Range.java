...
public class IPv6Range {
  ...
  public IPv6Range prefix(Integer prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public IPv6Range routeTarget(String routeTarget) {
  ...
  public boolean equals(Object o) {
    ...
    IPv6Range ipv6Range = (IPv6Range) o;
    return Objects.equals(this.prefix, ipv6Range.prefix) &&
        Objects.equals(this.range, ipv6Range.range) &&
        Objects.equals(this.region, ipv6Range.region) &&
        Objects.equals(this.routeTarget, ipv6Range.routeTarget);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPv6Range
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPv6Range.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPv6Range is not found in the empty JSON string", IPv6Range.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPv6Range.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPv6Range` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPv6Range.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPv6Range' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPv6Range> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPv6Range.class));

       return (TypeAdapter<T>) new TypeAdapter<IPv6Range>() {
           @Override
           public void write(JsonWriter out, IPv6Range value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPv6Range read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPv6Range given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPv6Range
   * @throws IOException if the JSON string is invalid with respect to IPv6Range
   */
  public static IPv6Range fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPv6Range.class);
  }

  /**
   * Convert an instance of IPv6Range to an JSON string
   *
   * @return JSON string
   */
