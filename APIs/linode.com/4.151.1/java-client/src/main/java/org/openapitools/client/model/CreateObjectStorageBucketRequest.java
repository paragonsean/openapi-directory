...
public class CreateObjectStorageBucketRequest {
  /**
  ...
  private AclEnum acl = AclEnum.PRIVATE;
  ...
  public CreateObjectStorageBucketRequest() {
  }

  public CreateObjectStorageBucketRequest acl(AclEnum acl) {
    this.acl = acl;
    return this;
  }
  ...
  public CreateObjectStorageBucketRequest cluster(String cluster) {
  ...
  public CreateObjectStorageBucketRequest corsEnabled(Boolean corsEnabled) {
  ...
  public CreateObjectStorageBucketRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateObjectStorageBucketRequest createObjectStorageBucketRequest = (CreateObjectStorageBucketRequest) o;
    return Objects.equals(this.acl, createObjectStorageBucketRequest.acl) &&
        Objects.equals(this.cluster, createObjectStorageBucketRequest.cluster) &&
        Objects.equals(this.corsEnabled, createObjectStorageBucketRequest.corsEnabled) &&
        Objects.equals(this.label, createObjectStorageBucketRequest.label);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acl, cluster, corsEnabled, label);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateObjectStorageBucketRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateObjectStorageBucketRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateObjectStorageBucketRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateObjectStorageBucketRequest is not found in the empty JSON string", CreateObjectStorageBucketRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateObjectStorageBucketRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateObjectStorageBucketRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateObjectStorageBucketRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateObjectStorageBucketRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateObjectStorageBucketRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateObjectStorageBucketRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateObjectStorageBucketRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateObjectStorageBucketRequest>() {
           @Override
           public void write(JsonWriter out, CreateObjectStorageBucketRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateObjectStorageBucketRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateObjectStorageBucketRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateObjectStorageBucketRequest
   * @throws IOException if the JSON string is invalid with respect to CreateObjectStorageBucketRequest
   */
  public static CreateObjectStorageBucketRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateObjectStorageBucketRequest.class);
  }

  /**
   * Convert an instance of CreateObjectStorageBucketRequest to an JSON string
   *
   * @return JSON string
   */
