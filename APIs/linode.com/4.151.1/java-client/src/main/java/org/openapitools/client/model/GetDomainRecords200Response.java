...
public class GetDomainRecords200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<DomainRecord> data = new ArrayList<>();
  ...
  public GetDomainRecords200Response() {
  }
  ...
  public GetDomainRecords200Response data(List<DomainRecord> data) {
    this.data = data;
    return this;
  }

  public GetDomainRecords200Response addDataItem(DomainRecord dataItem) {
    if (this.data == null) {
  ...
  public List<DomainRecord> getData() {
    return data;
  }

  public void setData(List<DomainRecord> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainRecords200Response getDomainRecords200Response = (GetDomainRecords200Response) o;
    return Objects.equals(this.data, getDomainRecords200Response.data) &&
        Objects.equals(this.page, getDomainRecords200Response.page) &&
        Objects.equals(this.pages, getDomainRecords200Response.pages) &&
        Objects.equals(this.results, getDomainRecords200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDomainRecords200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainRecords200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainRecords200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDomainRecords200Response is not found in the empty JSON string", GetDomainRecords200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainRecords200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDomainRecords200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DomainRecord.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainRecords200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainRecords200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainRecords200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainRecords200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainRecords200Response>() {
           @Override
           public void write(JsonWriter out, GetDomainRecords200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainRecords200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainRecords200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainRecords200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomainRecords200Response
   */
  public static GetDomainRecords200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainRecords200Response.class);
  }

  /**
   * Convert an instance of GetDomainRecords200Response to an JSON string
   *
   * @return JSON string
   */
