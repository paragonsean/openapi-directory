...
public class User {
  ...
  public static final String SERIALIZED_NAME_TFA_ENABLED = "tfa_enabled";
  @SerializedName(SERIALIZED_NAME_TFA_ENABLED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, user.email) &&
        ...
        Objects.equals(this.sshKeys, user.sshKeys) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, restricted, sshKeys, tfaEnabled, username);
  }
