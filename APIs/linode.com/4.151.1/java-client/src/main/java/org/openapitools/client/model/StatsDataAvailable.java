...
import org.openapitools.client.model.StatsData;
...
public class StatsDataAvailable {
  ...
  private List<StatsData> cpu = new ArrayList<>();

  public static final String SERIALIZED_NAME_DISK = "disk";
  @SerializedName(SERIALIZED_NAME_DISK)
  private List<StatsData> disk = new ArrayList<>();

  public static final String SERIALIZED_NAME_NET_IN = "net_in";
  @SerializedName(SERIALIZED_NAME_NET_IN)
  private List<StatsData> netIn = new ArrayList<>();

  public static final String SERIALIZED_NAME_NET_OUT = "net_out";
  @SerializedName(SERIALIZED_NAME_NET_OUT)
  private List<StatsData> netOut = new ArrayList<>();

  public static final String SERIALIZED_NAME_SWAP = "swap";
  @SerializedName(SERIALIZED_NAME_SWAP)
  private List<StatsData> swap = new ArrayList<>();

  public StatsDataAvailable() {
  }

  public StatsDataAvailable cpu(List<StatsData> cpu) {
    this.cpu = cpu;
    return this;
  }

  public StatsDataAvailable addCpuItem(StatsData cpuItem) {
    if (this.cpu == null) {
  ...
  public List<StatsData> getCpu() {
    return cpu;
  }

  public void setCpu(List<StatsData> cpu) {
    this.cpu = cpu;
  }


  public StatsDataAvailable disk(List<StatsData> disk) {
    this.disk = disk;
    return this;
  }

  public StatsDataAvailable addDiskItem(StatsData diskItem) {
    if (this.disk == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<StatsData> getDisk() {
    return disk;
  }

  public void setDisk(List<StatsData> disk) {
    this.disk = disk;
  }


  public StatsDataAvailable netIn(List<StatsData> netIn) {
    this.netIn = netIn;
    return this;
  }

  public StatsDataAvailable addNetInItem(StatsData netInItem) {
    if (this.netIn == null) {
      this.netIn = new ArrayList<>();
    }
    this.netIn.add(netInItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<StatsData> getNetIn() {
    return netIn;
  }

  public void setNetIn(List<StatsData> netIn) {
    this.netIn = netIn;
  }


  public StatsDataAvailable netOut(List<StatsData> netOut) {
    this.netOut = netOut;
    return this;
  }

  public StatsDataAvailable addNetOutItem(StatsData netOutItem) {
    if (this.netOut == null) {
      this.netOut = new ArrayList<>();
    }
    this.netOut.add(netOutItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<StatsData> getNetOut() {
    return netOut;
  }

  public void setNetOut(List<StatsData> netOut) {
    this.netOut = netOut;
  }


  public StatsDataAvailable swap(List<StatsData> swap) {
    this.swap = swap;
    return this;
  }

  public StatsDataAvailable addSwapItem(StatsData swapItem) {
    if (this.swap == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<StatsData> getSwap() {
    return swap;
  }

  public void setSwap(List<StatsData> swap) {
    this.swap = swap;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatsDataAvailable statsDataAvailable = (StatsDataAvailable) o;
    return Objects.equals(this.cpu, statsDataAvailable.cpu) &&
        Objects.equals(this.disk, statsDataAvailable.disk) &&
        Objects.equals(this.netIn, statsDataAvailable.netIn) &&
        Objects.equals(this.netOut, statsDataAvailable.netOut) &&
        Objects.equals(this.swap, statsDataAvailable.swap);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cpu, disk, netIn, netOut, swap);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatsDataAvailable {\n");
  ...
  static {
    ...
    openapiFields.add("net_in");
    openapiFields.add("net_out");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatsDataAvailable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatsDataAvailable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatsDataAvailable is not found in the empty JSON string", StatsDataAvailable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatsDataAvailable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatsDataAvailable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("cpu") != null && !jsonObj.get("cpu").isJsonNull()) {
        ...
        if (jsonArraycpu != null) {
          ...
          for (int i = 0; i < jsonArraycpu.size(); i++) {
            StatsData.validateJsonElement(jsonArraycpu.get(i));
          };
        }
      }
      if (jsonObj.get("disk") != null && !jsonObj.get("disk").isJsonNull()) {
        ...
        if (jsonArraydisk != null) {
          ...
          for (int i = 0; i < jsonArraydisk.size(); i++) {
            StatsData.validateJsonElement(jsonArraydisk.get(i));
          };
        }
      }
      if (jsonObj.get("net_in") != null && !jsonObj.get("net_in").isJsonNull()) {
        JsonArray jsonArraynetIn = jsonObj.getAsJsonArray("net_in");
        if (jsonArraynetIn != null) {
          // ensure the json data is an array
          if (!jsonObj.get("net_in").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `net_in` to be an array in the JSON string but got `%s`", jsonObj.get("net_in").toString()));
          }

          // validate the optional field `net_in` (array)
          for (int i = 0; i < jsonArraynetIn.size(); i++) {
            StatsData.validateJsonElement(jsonArraynetIn.get(i));
          };
        }
      }
      if (jsonObj.get("net_out") != null && !jsonObj.get("net_out").isJsonNull()) {
        JsonArray jsonArraynetOut = jsonObj.getAsJsonArray("net_out");
        if (jsonArraynetOut != null) {
          // ensure the json data is an array
          if (!jsonObj.get("net_out").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `net_out` to be an array in the JSON string but got `%s`", jsonObj.get("net_out").toString()));
          }

          // validate the optional field `net_out` (array)
          for (int i = 0; i < jsonArraynetOut.size(); i++) {
            StatsData.validateJsonElement(jsonArraynetOut.get(i));
          };
        }
      }
      if (jsonObj.get("swap") != null && !jsonObj.get("swap").isJsonNull()) {
        JsonArray jsonArrayswap = jsonObj.getAsJsonArray("swap");
        if (jsonArrayswap != null) {
          // ensure the json data is an array
          if (!jsonObj.get("swap").isJsonArray()) {
          ...
          for (int i = 0; i < jsonArrayswap.size(); i++) {
            StatsData.validateJsonElement(jsonArrayswap.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatsDataAvailable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatsDataAvailable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatsDataAvailable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatsDataAvailable.class));

       return (TypeAdapter<T>) new TypeAdapter<StatsDataAvailable>() {
           @Override
           public void write(JsonWriter out, StatsDataAvailable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatsDataAvailable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatsDataAvailable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatsDataAvailable
   * @throws IOException if the JSON string is invalid with respect to StatsDataAvailable
   */
  public static StatsDataAvailable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatsDataAvailable.class);
  }

  /**
   * Convert an instance of StatsDataAvailable to an JSON string
   *
   * @return JSON string
   */
