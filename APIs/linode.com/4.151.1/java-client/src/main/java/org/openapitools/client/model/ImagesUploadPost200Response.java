...
public class ImagesUploadPost200Response {
  ...
  public ImagesUploadPost200Response() {
  }

  public ImagesUploadPost200Response image(Image image) {
    this.image = image;
    return this;
  }
  ...
  public ImagesUploadPost200Response uploadTo(String uploadTo) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesUploadPost200Response imagesUploadPost200Response = (ImagesUploadPost200Response) o;
    return Objects.equals(this.image, imagesUploadPost200Response.image) &&
        Objects.equals(this.uploadTo, imagesUploadPost200Response.uploadTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, uploadTo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImagesUploadPost200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesUploadPost200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesUploadPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUploadPost200Response is not found in the empty JSON string", ImagesUploadPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesUploadPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesUploadPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("upload_to") != null && !jsonObj.get("upload_to").isJsonNull()) && !jsonObj.get("upload_to").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `upload_to` to be a primitive type in the JSON string but got `%s`", jsonObj.get("upload_to").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUploadPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUploadPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUploadPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUploadPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUploadPost200Response>() {
           @Override
           public void write(JsonWriter out, ImagesUploadPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesUploadPost200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesUploadPost200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesUploadPost200Response
   * @throws IOException if the JSON string is invalid with respect to ImagesUploadPost200Response
   */
  public static ImagesUploadPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUploadPost200Response.class);
  }

  /**
   * Convert an instance of ImagesUploadPost200Response to an JSON string
   *
   * @return JSON string
   */
