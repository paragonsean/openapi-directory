...
public class ServiceTransferEntities {
  ...
  public ServiceTransferEntities() {
  }

  public ServiceTransferEntities linodes(List<Integer> linodes) {
    this.linodes = linodes;
    return this;
  }

  public ServiceTransferEntities addLinodesItem(Integer linodesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceTransferEntities serviceTransferEntities = (ServiceTransferEntities) o;
    return Objects.equals(this.linodes, serviceTransferEntities.linodes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceTransferEntities {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceTransferEntities
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceTransferEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceTransferEntities is not found in the empty JSON string", ServiceTransferEntities.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceTransferEntities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceTransferEntities` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceTransferEntities.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceTransferEntities' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceTransferEntities> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceTransferEntities.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceTransferEntities>() {
           @Override
           public void write(JsonWriter out, ServiceTransferEntities value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceTransferEntities read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceTransferEntities given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceTransferEntities
   * @throws IOException if the JSON string is invalid with respect to ServiceTransferEntities
   */
  public static ServiceTransferEntities fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceTransferEntities.class);
  }

  /**
   * Convert an instance of ServiceTransferEntities to an JSON string
   *
   * @return JSON string
   */
