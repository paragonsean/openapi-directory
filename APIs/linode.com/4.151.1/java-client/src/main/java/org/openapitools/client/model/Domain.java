...
public class Domain {
  public static final String SERIALIZED_NAME_AXFR_IPS = "axfr_ips";
  @SerializedName(SERIALIZED_NAME_AXFR_IPS)
  private List<String> axfrIps = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_EXPIRE_SEC = "expire_sec";
  @SerializedName(SERIALIZED_NAME_EXPIRE_SEC)
  private Integer expireSec = 0;
  ...
  public static final String SERIALIZED_NAME_MASTER_IPS = "master_ips";
  @SerializedName(SERIALIZED_NAME_MASTER_IPS)
  private List<String> masterIps = new ArrayList<>();

  public static final String SERIALIZED_NAME_REFRESH_SEC = "refresh_sec";
  @SerializedName(SERIALIZED_NAME_REFRESH_SEC)
  private Integer refreshSec = 0;

  public static final String SERIALIZED_NAME_RETRY_SEC = "retry_sec";
  @SerializedName(SERIALIZED_NAME_RETRY_SEC)
  private Integer retrySec = 0;

  public static final String SERIALIZED_NAME_SOA_EMAIL = "soa_email";
  @SerializedName(SERIALIZED_NAME_SOA_EMAIL)
  ...
  public Domain axfrIps(List<String> axfrIps) {
    this.axfrIps = axfrIps;
    return this;
  }

  public Domain addAxfrIpsItem(String axfrIpsItem) {
    if (this.axfrIps == null) {
      this.axfrIps = new ArrayList<>();
    }
    this.axfrIps.add(axfrIpsItem);
    return this;
  }
  ...
  public List<String> getAxfrIps() {
    return axfrIps;
  }

  public void setAxfrIps(List<String> axfrIps) {
    this.axfrIps = axfrIps;
  }
  ...
  public Domain expireSec(Integer expireSec) {
  ...
  @Deprecated
  public Domain group(String group) {
    this.group = group;
    return this;
  }
  ...
  public Domain masterIps(List<String> masterIps) {
    this.masterIps = masterIps;
    return this;
  }

  public Domain addMasterIpsItem(String masterIpsItem) {
    if (this.masterIps == null) {
      this.masterIps = new ArrayList<>();
    }
    this.masterIps.add(masterIpsItem);
    return this;
  }
  ...
  public Domain refreshSec(Integer refreshSec) {
  ...
  public Domain retrySec(Integer retrySec) {
  ...
  public Domain soaEmail(String soaEmail) {
  ...
  public Domain tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public Domain addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public Domain ttlSec(Integer ttlSec) {
    this.ttlSec = ttlSec;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.axfrIps, domain.axfrIps) &&
        Objects.equals(this.description, domain.description) &&
        Objects.equals(this.domain, domain.domain) &&
        Objects.equals(this.expireSec, domain.expireSec) &&
        Objects.equals(this.group, domain.group) &&
        Objects.equals(this.id, domain.id) &&
        Objects.equals(this.masterIps, domain.masterIps) &&
        Objects.equals(this.refreshSec, domain.refreshSec) &&
        Objects.equals(this.retrySec, domain.retrySec) &&
        Objects.equals(this.soaEmail, domain.soaEmail) &&
        Objects.equals(this.status, domain.status) &&
        Objects.equals(this.tags, domain.tags) &&
        Objects.equals(this.ttlSec, domain.ttlSec) &&
        Objects.equals(this.type, domain.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(axfrIps, description, domain, expireSec, group, id, masterIps, refreshSec, retrySec, soaEmail, status, tags, ttlSec, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    axfrIps: ").append(toIndentedString(axfrIps)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    domain: ").append(toIndentedString(domain)).append("\n");
    sb.append("    expireSec: ").append(toIndentedString(expireSec)).append("\n");
    sb.append("    group: ").append(toIndentedString(group)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    masterIps: ").append(toIndentedString(masterIps)).append("\n");
    sb.append("    refreshSec: ").append(toIndentedString(refreshSec)).append("\n");
    sb.append("    retrySec: ").append(toIndentedString(retrySec)).append("\n");
    sb.append("    soaEmail: ").append(toIndentedString(soaEmail)).append("\n");
  ...
  static {
    ...
    openapiFields.add("axfr_ips");
    openapiFields.add("description");
    openapiFields.add("domain");
    openapiFields.add("expire_sec");
    openapiFields.add("group");
    openapiFields.add("id");
    openapiFields.add("master_ips");
    openapiFields.add("refresh_sec");
    openapiFields.add("retry_sec");
    openapiFields.add("soa_email");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("axfr_ips") != null && !jsonObj.get("axfr_ips").isJsonNull() && !jsonObj.get("axfr_ips").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `axfr_ips` to be an array in the JSON string but got `%s`", jsonObj.get("axfr_ips").toString()));
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("master_ips") != null && !jsonObj.get("master_ips").isJsonNull() && !jsonObj.get("master_ips").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `master_ips` to be an array in the JSON string but got `%s`", jsonObj.get("master_ips").toString()));
      }
      if ((jsonObj.get("soa_email") != null && !jsonObj.get("soa_email").isJsonNull()) && !jsonObj.get("soa_email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `soa_email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("soa_email").toString()));
      }
