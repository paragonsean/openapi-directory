...
public class PutLKECluster200Response {
  ...
  public PutLKECluster200Response() {
  }
  ...
  public PutLKECluster200Response k8sVersion(String k8sVersion) {
  ...
  public PutLKECluster200Response label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PutLKECluster200Response region(String region) {
    this.region = region;
    return this;
  }
  ...
  public PutLKECluster200Response tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PutLKECluster200Response addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    PutLKECluster200Response putLKECluster200Response = (PutLKECluster200Response) o;
    return Objects.equals(this.created, putLKECluster200Response.created) &&
        Objects.equals(this.k8sVersion, putLKECluster200Response.k8sVersion) &&
        Objects.equals(this.label, putLKECluster200Response.label) &&
        Objects.equals(this.region, putLKECluster200Response.region) &&
        Objects.equals(this.tags, putLKECluster200Response.tags) &&
        Objects.equals(this.updated, putLKECluster200Response.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, k8sVersion, label, region, tags, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutLKECluster200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutLKECluster200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutLKECluster200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutLKECluster200Response is not found in the empty JSON string", PutLKECluster200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutLKECluster200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutLKECluster200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("k8s_version") != null && !jsonObj.get("k8s_version").isJsonNull()) && !jsonObj.get("k8s_version").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutLKECluster200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutLKECluster200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutLKECluster200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutLKECluster200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PutLKECluster200Response>() {
           @Override
           public void write(JsonWriter out, PutLKECluster200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutLKECluster200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutLKECluster200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutLKECluster200Response
   * @throws IOException if the JSON string is invalid with respect to PutLKECluster200Response
   */
  public static PutLKECluster200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutLKECluster200Response.class);
  }

  /**
   * Convert an instance of PutLKECluster200Response to an JSON string
   *
   * @return JSON string
   */
