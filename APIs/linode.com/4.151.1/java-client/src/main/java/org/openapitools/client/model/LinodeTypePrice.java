...
public class LinodeTypePrice {
  ...
  public LinodeTypePrice() {
  }

  public LinodeTypePrice hourly(BigDecimal hourly) {
    this.hourly = hourly;
    return this;
  }
  ...
  public LinodeTypePrice monthly(BigDecimal monthly) {
  ...
  public boolean equals(Object o) {
    ...
    LinodeTypePrice linodeTypePrice = (LinodeTypePrice) o;
    return Objects.equals(this.hourly, linodeTypePrice.hourly) &&
        Objects.equals(this.monthly, linodeTypePrice.monthly);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinodeTypePrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeTypePrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeTypePrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeTypePrice is not found in the empty JSON string", LinodeTypePrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeTypePrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeTypePrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeTypePrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeTypePrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeTypePrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeTypePrice.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeTypePrice>() {
           @Override
           public void write(JsonWriter out, LinodeTypePrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeTypePrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeTypePrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeTypePrice
   * @throws IOException if the JSON string is invalid with respect to LinodeTypePrice
   */
  public static LinodeTypePrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeTypePrice.class);
  }

  /**
   * Convert an instance of LinodeTypePrice to an JSON string
   *
   * @return JSON string
   */
