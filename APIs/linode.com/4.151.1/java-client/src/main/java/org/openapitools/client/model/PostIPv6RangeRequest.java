...
public class PostIPv6RangeRequest {
   ...
   */
  @JsonAdapter(PrefixLengthEnum.Adapter.class)
  public enum PrefixLengthEnum {
    NUMBER_56(56),
    ...
    PrefixLengthEnum(Integer value) {
      this.value = value;
    }
    ...
    public static PrefixLengthEnum fromValue(Integer value) {
      for (PrefixLengthEnum b : PrefixLengthEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<PrefixLengthEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PrefixLengthEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PrefixLengthEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
        return PrefixLengthEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      Integer value = jsonElement.getAsInt();
      PrefixLengthEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_PREFIX_LENGTH = "prefix_length";
  @SerializedName(SERIALIZED_NAME_PREFIX_LENGTH)
  private PrefixLengthEnum prefixLength;

  public static final String SERIALIZED_NAME_ROUTE_TARGET = "route_target";
  @SerializedName(SERIALIZED_NAME_ROUTE_TARGET)
  private String routeTarget;

  public PostIPv6RangeRequest() {
  }

  public PostIPv6RangeRequest linodeId(Integer linodeId) {
    this.linodeId = linodeId;
    return this;
  }

  /**
   * The ID of the Linode to assign this range to. The SLAAC address for the provided Linode is used as the range&#39;s &#x60;route_target&#x60;.  * **Required** if &#x60;route_target&#x60; is omitted from the request.  * Mutually exclusive with &#x60;route_target&#x60;. Submitting values for both properties in a request results in an error. 
   * @return linodeId
   */
  ...
  public PostIPv6RangeRequest prefixLength(PrefixLengthEnum prefixLength) {
  ...
  public PrefixLengthEnum getPrefixLength() {
    return prefixLength;
  }

  public void setPrefixLength(PrefixLengthEnum prefixLength) {
    this.prefixLength = prefixLength;
  }


  public PostIPv6RangeRequest routeTarget(String routeTarget) {
    this.routeTarget = routeTarget;
    return this;
  }

  /**
   * The IPv6 SLAAC address to assign this range to.  * **Required** if &#x60;linode_id&#x60; is omitted from the request.  * Mutually exclusive with &#x60;linode_id&#x60;. Submitting values for both properties in a request results in an error.  * **Note**: Omit the &#x60;/128&#x60; prefix length of the SLAAC address when using this property. 
   * @return routeTarget
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    PostIPv6RangeRequest postIPv6RangeRequest = (PostIPv6RangeRequest) o;
    return Objects.equals(this.linodeId, postIPv6RangeRequest.linodeId) &&
        Objects.equals(this.prefixLength, postIPv6RangeRequest.prefixLength) &&
        Objects.equals(this.routeTarget, postIPv6RangeRequest.routeTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(linodeId, prefixLength, routeTarget);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostIPv6RangeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostIPv6RangeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostIPv6RangeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostIPv6RangeRequest is not found in the empty JSON string", PostIPv6RangeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostIPv6RangeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostIPv6RangeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostIPv6RangeRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `prefix_length`
      PrefixLengthEnum.validateJsonElement(jsonObj.get("prefix_length"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostIPv6RangeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostIPv6RangeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostIPv6RangeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostIPv6RangeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostIPv6RangeRequest>() {
           @Override
           public void write(JsonWriter out, PostIPv6RangeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostIPv6RangeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostIPv6RangeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostIPv6RangeRequest
   * @throws IOException if the JSON string is invalid with respect to PostIPv6RangeRequest
   */
  public static PostIPv6RangeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostIPv6RangeRequest.class);
  }

  /**
   * Convert an instance of PostIPv6RangeRequest to an JSON string
   *
   * @return JSON string
   */
