...
public class GetDatabasesMongoDBInstanceBackups200Response {
  ...
  private List<DatabaseBackup> data = new ArrayList<>();

  public GetDatabasesMongoDBInstanceBackups200Response() {
  }
  ...
  public GetDatabasesMongoDBInstanceBackups200Response data(List<DatabaseBackup> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesMongoDBInstanceBackups200Response addDataItem(DatabaseBackup dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseBackup> getData() {
    return data;
  }

  public void setData(List<DatabaseBackup> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesMongoDBInstanceBackups200Response getDatabasesMongoDBInstanceBackups200Response = (GetDatabasesMongoDBInstanceBackups200Response) o;
    return Objects.equals(this.page, getDatabasesMongoDBInstanceBackups200Response.page) &&
        Objects.equals(this.pages, getDatabasesMongoDBInstanceBackups200Response.pages) &&
        Objects.equals(this.results, getDatabasesMongoDBInstanceBackups200Response.results) &&
        Objects.equals(this.data, getDatabasesMongoDBInstanceBackups200Response.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(page, pages, results, data);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDatabasesMongoDBInstanceBackups200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesMongoDBInstanceBackups200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesMongoDBInstanceBackups200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesMongoDBInstanceBackups200Response is not found in the empty JSON string", GetDatabasesMongoDBInstanceBackups200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesMongoDBInstanceBackups200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesMongoDBInstanceBackups200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabaseBackup.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesMongoDBInstanceBackups200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesMongoDBInstanceBackups200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesMongoDBInstanceBackups200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesMongoDBInstanceBackups200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesMongoDBInstanceBackups200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesMongoDBInstanceBackups200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesMongoDBInstanceBackups200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesMongoDBInstanceBackups200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesMongoDBInstanceBackups200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesMongoDBInstanceBackups200Response
   */
  public static GetDatabasesMongoDBInstanceBackups200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesMongoDBInstanceBackups200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesMongoDBInstanceBackups200Response to an JSON string
   *
   * @return JSON string
   */
