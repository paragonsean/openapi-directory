...
import org.openapitools.client.model.CreateFirewallsRequestDevices;
import org.openapitools.client.model.CreateFirewallsRequestRules;
...
public class CreateFirewallsRequest {
  public static final String SERIALIZED_NAME_DEVICES = "devices";
  @SerializedName(SERIALIZED_NAME_DEVICES)
  private CreateFirewallsRequestDevices devices;

  public static final String SERIALIZED_NAME_RULES = "rules";
  @SerializedName(SERIALIZED_NAME_RULES)
  private CreateFirewallsRequestRules rules;
  ...
  public CreateFirewallsRequest devices(CreateFirewallsRequestDevices devices) {
  ...
  public CreateFirewallsRequestDevices getDevices() {
    return devices;
  }

  public void setDevices(CreateFirewallsRequestDevices devices) {
    this.devices = devices;
  }


  public CreateFirewallsRequest rules(CreateFirewallsRequestRules rules) {
    this.rules = rules;
    return this;
  }
  ...
  public CreateFirewallsRequestRules getRules() {
    return rules;
  }

  public void setRules(CreateFirewallsRequestRules rules) {
    this.rules = rules;
  }
  ...
  public CreateFirewallsRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CreateFirewallsRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateFirewallsRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallsRequest createFirewallsRequest = (CreateFirewallsRequest) o;
    return Objects.equals(this.devices, createFirewallsRequest.devices) &&
        Objects.equals(this.rules, createFirewallsRequest.rules) &&
        Objects.equals(this.created, createFirewallsRequest.created) &&
        Objects.equals(this.id, createFirewallsRequest.id) &&
        Objects.equals(this.label, createFirewallsRequest.label) &&
        Objects.equals(this.status, createFirewallsRequest.status) &&
        Objects.equals(this.tags, createFirewallsRequest.tags) &&
        Objects.equals(this.updated, createFirewallsRequest.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(devices, rules, created, id, label, status, tags, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFirewallsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallsRequest is not found in the empty JSON string", CreateFirewallsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallsRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("devices") != null && !jsonObj.get("devices").isJsonNull()) {
        CreateFirewallsRequestDevices.validateJsonElement(jsonObj.get("devices"));
      }
      // validate the required field `rules`
      CreateFirewallsRequestRules.validateJsonElement(jsonObj.get("rules"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallsRequest>() {
           @Override
           public void write(JsonWriter out, CreateFirewallsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallsRequest
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallsRequest
   */
  public static CreateFirewallsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallsRequest.class);
  }

  /**
   * Convert an instance of CreateFirewallsRequest to an JSON string
   *
   * @return JSON string
   */
