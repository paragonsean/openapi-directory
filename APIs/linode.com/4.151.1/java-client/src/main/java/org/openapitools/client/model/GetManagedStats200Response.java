...
import org.openapitools.client.model.GetManagedStats200ResponseData;
...
public class GetManagedStats200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private GetManagedStats200ResponseData data;

  public GetManagedStats200Response() {
  }

  public GetManagedStats200Response data(GetManagedStats200ResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public GetManagedStats200ResponseData getData() {
    return data;
  }

  public void setData(GetManagedStats200ResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedStats200Response getManagedStats200Response = (GetManagedStats200Response) o;
    return Objects.equals(this.data, getManagedStats200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedStats200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedStats200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedStats200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedStats200Response is not found in the empty JSON string", GetManagedStats200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedStats200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedStats200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GetManagedStats200ResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedStats200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedStats200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedStats200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedStats200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedStats200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedStats200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedStats200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedStats200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedStats200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedStats200Response
   */
  public static GetManagedStats200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedStats200Response.class);
  }

  /**
   * Convert an instance of GetManagedStats200Response to an JSON string
   *
   * @return JSON string
   */
