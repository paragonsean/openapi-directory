...
public class GetClients200Response {
  ...
  private List<OAuthClient> data = new ArrayList<>();
  ...
  public GetClients200Response data(List<OAuthClient> data) {
    this.data = data;
    return this;
  }

  public GetClients200Response addDataItem(OAuthClient dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getClients200Response.data) &&
        Objects.equals(this.page, getClients200Response.page) &&
        Objects.equals(this.pages, getClients200Response.pages) &&
        Objects.equals(this.results, getClients200Response.results);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            OAuthClient.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
