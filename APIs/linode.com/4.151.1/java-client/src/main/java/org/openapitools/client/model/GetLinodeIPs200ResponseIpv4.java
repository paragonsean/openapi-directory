...
import org.openapitools.client.model.IPAddressPrivate;
...
public class GetLinodeIPs200ResponseIpv4 {
  public static final String SERIALIZED_NAME_PRIVATE = "private";
  @SerializedName(SERIALIZED_NAME_PRIVATE)
  private List<IPAddressPrivate> _private = new ArrayList<>();

  public static final String SERIALIZED_NAME_PUBLIC = "public";
  @SerializedName(SERIALIZED_NAME_PUBLIC)
  private List<IPAddress> _public = new ArrayList<>();

  public static final String SERIALIZED_NAME_RESERVED = "reserved";
  @SerializedName(SERIALIZED_NAME_RESERVED)
  private List<IPAddress> reserved = new ArrayList<>();

  public static final String SERIALIZED_NAME_SHARED = "shared";
  @SerializedName(SERIALIZED_NAME_SHARED)
  private List<IPAddress> shared = new ArrayList<>();

  public GetLinodeIPs200ResponseIpv4() {
  }

  public GetLinodeIPs200ResponseIpv4(
     List<IPAddressPrivate> _private, 
     List<IPAddress> _public, 
     List<IPAddress> reserved, 
     List<IPAddress> shared
  ) {
    this();
  ...
  public List<IPAddressPrivate> getPrivate() {
    return _private;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<IPAddress> getPublic() {
    return _public;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<IPAddress> getShared() {
    return shared;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeIPs200ResponseIpv4 getLinodeIPs200ResponseIpv4 = (GetLinodeIPs200ResponseIpv4) o;
    return Objects.equals(this._private, getLinodeIPs200ResponseIpv4._private) &&
        Objects.equals(this._public, getLinodeIPs200ResponseIpv4._public) &&
        Objects.equals(this.reserved, getLinodeIPs200ResponseIpv4.reserved) &&
        Objects.equals(this.shared, getLinodeIPs200ResponseIpv4.shared);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_private, _public, reserved, shared);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLinodeIPs200ResponseIpv4 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeIPs200ResponseIpv4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeIPs200ResponseIpv4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeIPs200ResponseIpv4 is not found in the empty JSON string", GetLinodeIPs200ResponseIpv4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeIPs200ResponseIpv4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeIPs200ResponseIpv4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("private") != null && !jsonObj.get("private").isJsonNull()) {
        ...
        if (jsonArray_private != null) {
          ...
          for (int i = 0; i < jsonArray_private.size(); i++) {
            IPAddressPrivate.validateJsonElement(jsonArray_private.get(i));
          };
        }
      }
      if (jsonObj.get("public") != null && !jsonObj.get("public").isJsonNull()) {
        ...
        if (jsonArray_public != null) {
          ...
          for (int i = 0; i < jsonArray_public.size(); i++) {
            IPAddress.validateJsonElement(jsonArray_public.get(i));
          };
        }
      }
      if (jsonObj.get("reserved") != null && !jsonObj.get("reserved").isJsonNull()) {
        JsonArray jsonArrayreserved = jsonObj.getAsJsonArray("reserved");
        if (jsonArrayreserved != null) {
          // ensure the json data is an array
          if (!jsonObj.get("reserved").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `reserved` to be an array in the JSON string but got `%s`", jsonObj.get("reserved").toString()));
          }

          // validate the optional field `reserved` (array)
          for (int i = 0; i < jsonArrayreserved.size(); i++) {
            IPAddress.validateJsonElement(jsonArrayreserved.get(i));
          };
        }
      }
      if (jsonObj.get("shared") != null && !jsonObj.get("shared").isJsonNull()) {
        ...
        if (jsonArrayshared != null) {
          ...
          for (int i = 0; i < jsonArrayshared.size(); i++) {
            IPAddress.validateJsonElement(jsonArrayshared.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeIPs200ResponseIpv4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeIPs200ResponseIpv4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeIPs200ResponseIpv4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeIPs200ResponseIpv4.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeIPs200ResponseIpv4>() {
           @Override
           public void write(JsonWriter out, GetLinodeIPs200ResponseIpv4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeIPs200ResponseIpv4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeIPs200ResponseIpv4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeIPs200ResponseIpv4
   * @throws IOException if the JSON string is invalid with respect to GetLinodeIPs200ResponseIpv4
   */
  public static GetLinodeIPs200ResponseIpv4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeIPs200ResponseIpv4.class);
  }

  /**
   * Convert an instance of GetLinodeIPs200ResponseIpv4 to an JSON string
   *
   * @return JSON string
   */
