...
public class ObjectStorageKeyBucketAccessInner {
  ...
  public ObjectStorageKeyBucketAccessInner() {
  }

  public ObjectStorageKeyBucketAccessInner bucketName(String bucketName) {
  ...
  public ObjectStorageKeyBucketAccessInner cluster(String cluster) {
  ...
  public ObjectStorageKeyBucketAccessInner permissions(PermissionsEnum permissions) {
  ...
  public boolean equals(Object o) {
    ...
    ObjectStorageKeyBucketAccessInner objectStorageKeyBucketAccessInner = (ObjectStorageKeyBucketAccessInner) o;
    return Objects.equals(this.bucketName, objectStorageKeyBucketAccessInner.bucketName) &&
        Objects.equals(this.cluster, objectStorageKeyBucketAccessInner.cluster) &&
        Objects.equals(this.permissions, objectStorageKeyBucketAccessInner.permissions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bucketName, cluster, permissions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjectStorageKeyBucketAccessInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageKeyBucketAccessInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageKeyBucketAccessInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageKeyBucketAccessInner is not found in the empty JSON string", ObjectStorageKeyBucketAccessInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageKeyBucketAccessInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageKeyBucketAccessInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageKeyBucketAccessInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageKeyBucketAccessInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageKeyBucketAccessInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageKeyBucketAccessInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageKeyBucketAccessInner>() {
           @Override
           public void write(JsonWriter out, ObjectStorageKeyBucketAccessInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageKeyBucketAccessInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageKeyBucketAccessInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageKeyBucketAccessInner
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageKeyBucketAccessInner
   */
  public static ObjectStorageKeyBucketAccessInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageKeyBucketAccessInner.class);
  }

  /**
   * Convert an instance of ObjectStorageKeyBucketAccessInner to an JSON string
   *
   * @return JSON string
   */
