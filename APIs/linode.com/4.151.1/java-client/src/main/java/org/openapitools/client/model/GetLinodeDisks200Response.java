...
public class GetLinodeDisks200Response {
  ...
  public GetLinodeDisks200Response() {
  }
  ...
  public GetLinodeDisks200Response data(List<Disk> data) {
    this.data = data;
    return this;
  }

  public GetLinodeDisks200Response addDataItem(Disk dataItem) {
    if (this.data == null) {
  ...
  public List<Disk> getData() {
    return data;
  }

  public void setData(List<Disk> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeDisks200Response getLinodeDisks200Response = (GetLinodeDisks200Response) o;
    return Objects.equals(this.data, getLinodeDisks200Response.data) &&
        Objects.equals(this.page, getLinodeDisks200Response.page) &&
        Objects.equals(this.pages, getLinodeDisks200Response.pages) &&
        Objects.equals(this.results, getLinodeDisks200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeDisks200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeDisks200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeDisks200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeDisks200Response is not found in the empty JSON string", GetLinodeDisks200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeDisks200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeDisks200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Disk.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeDisks200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeDisks200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeDisks200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeDisks200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeDisks200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeDisks200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeDisks200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeDisks200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeDisks200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeDisks200Response
   */
  public static GetLinodeDisks200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeDisks200Response.class);
  }

  /**
   * Convert an instance of GetLinodeDisks200Response to an JSON string
   *
   * @return JSON string
   */
