...
public class ObjectStorageSSL {
  ...
  public ObjectStorageSSL() {
  }

  public ObjectStorageSSL certificate(String certificate) {
  ...
  public ObjectStorageSSL privateKey(String privateKey) {
  ...
  public boolean equals(Object o) {
    ...
    ObjectStorageSSL objectStorageSSL = (ObjectStorageSSL) o;
    return Objects.equals(this.certificate, objectStorageSSL.certificate) &&
        Objects.equals(this.privateKey, objectStorageSSL.privateKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectStorageSSL {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageSSL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageSSL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageSSL is not found in the empty JSON string", ObjectStorageSSL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageSSL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageSSL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ObjectStorageSSL.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageSSL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageSSL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageSSL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageSSL.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageSSL>() {
           @Override
           public void write(JsonWriter out, ObjectStorageSSL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageSSL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageSSL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageSSL
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageSSL
   */
  public static ObjectStorageSSL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageSSL.class);
  }

  /**
   * Convert an instance of ObjectStorageSSL to an JSON string
   *
   * @return JSON string
   */
