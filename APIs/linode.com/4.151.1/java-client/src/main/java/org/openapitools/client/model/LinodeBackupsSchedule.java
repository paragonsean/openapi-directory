...
public class LinodeBackupsSchedule {
  ...
  public LinodeBackupsSchedule() {
  }

  public LinodeBackupsSchedule day(DayEnum day) {
    this.day = day;
    return this;
  }
  ...
  public LinodeBackupsSchedule window(WindowEnum window) {
    this.window = window;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeBackupsSchedule linodeBackupsSchedule = (LinodeBackupsSchedule) o;
    return Objects.equals(this.day, linodeBackupsSchedule.day) &&
        Objects.equals(this.window, linodeBackupsSchedule.window);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(day, window);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinodeBackupsSchedule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeBackupsSchedule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeBackupsSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeBackupsSchedule is not found in the empty JSON string", LinodeBackupsSchedule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeBackupsSchedule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeBackupsSchedule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeBackupsSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeBackupsSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeBackupsSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeBackupsSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeBackupsSchedule>() {
           @Override
           public void write(JsonWriter out, LinodeBackupsSchedule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeBackupsSchedule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeBackupsSchedule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeBackupsSchedule
   * @throws IOException if the JSON string is invalid with respect to LinodeBackupsSchedule
   */
  public static LinodeBackupsSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeBackupsSchedule.class);
  }

  /**
   * Convert an instance of LinodeBackupsSchedule to an JSON string
   *
   * @return JSON string
   */
