...
public class UpdateLinodeIPRequest {
  public static final String SERIALIZED_NAME_RDNS = "rdns";
  @SerializedName(SERIALIZED_NAME_RDNS)
  private String rdns;

  public UpdateLinodeIPRequest() {
  }

  public UpdateLinodeIPRequest rdns(String rdns) {
    this.rdns = rdns;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateLinodeIPRequest updateLinodeIPRequest = (UpdateLinodeIPRequest) o;
    return Objects.equals(this.rdns, updateLinodeIPRequest.rdns);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateLinodeIPRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateLinodeIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLinodeIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateLinodeIPRequest is not found in the empty JSON string", UpdateLinodeIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateLinodeIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateLinodeIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateLinodeIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateLinodeIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateLinodeIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateLinodeIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateLinodeIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateLinodeIPRequest>() {
           @Override
           public void write(JsonWriter out, UpdateLinodeIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateLinodeIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateLinodeIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateLinodeIPRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateLinodeIPRequest
   */
  public static UpdateLinodeIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateLinodeIPRequest.class);
  }

  /**
   * Convert an instance of UpdateLinodeIPRequest to an JSON string
   *
   * @return JSON string
   */
