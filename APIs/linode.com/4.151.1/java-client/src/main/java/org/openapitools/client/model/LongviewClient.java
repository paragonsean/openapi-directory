...
import org.openapitools.client.model.LongviewClientApps;
...
public class LongviewClient {
  ...
  private LongviewClientApps apps;
  ...
  public static final String SERIALIZED_NAME_INSTALL_CODE = "install_code";
  @SerializedName(SERIALIZED_NAME_INSTALL_CODE)
  ...
  public LongviewClient apps(LongviewClientApps apps) {
    this.apps = apps;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LongviewClientApps getApps() {
    return apps;
  }

  public void setApps(LongviewClientApps apps) {
    this.apps = apps;
  }
  ...
  public LongviewClient label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LongviewClient longviewClient = (LongviewClient) o;
    return Objects.equals(this.apiKey, longviewClient.apiKey) &&
        Objects.equals(this.apps, longviewClient.apps) &&
        Objects.equals(this.created, longviewClient.created) &&
        Objects.equals(this.id, longviewClient.id) &&
        Objects.equals(this.installCode, longviewClient.installCode) &&
        Objects.equals(this.label, longviewClient.label) &&
        Objects.equals(this.updated, longviewClient.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKey, apps, created, id, installCode, label, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LongviewClient {\n");
    sb.append("    apiKey: ").append(toIndentedString(apiKey)).append("\n");
    sb.append("    apps: ").append(toIndentedString(apps)).append("\n");
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    installCode: ").append(toIndentedString(installCode)).append("\n");
  ...
  static {
    ...
    openapiFields.add("install_code");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongviewClient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongviewClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongviewClient is not found in the empty JSON string", LongviewClient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongviewClient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongviewClient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("apps") != null && !jsonObj.get("apps").isJsonNull()) {
        LongviewClientApps.validateJsonElement(jsonObj.get("apps"));
      }
      if ((jsonObj.get("install_code") != null && !jsonObj.get("install_code").isJsonNull()) && !jsonObj.get("install_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `install_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("install_code").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongviewClient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongviewClient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongviewClient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongviewClient.class));

       return (TypeAdapter<T>) new TypeAdapter<LongviewClient>() {
           @Override
           public void write(JsonWriter out, LongviewClient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongviewClient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongviewClient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongviewClient
   * @throws IOException if the JSON string is invalid with respect to LongviewClient
   */
  public static LongviewClient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongviewClient.class);
  }

  /**
   * Convert an instance of LongviewClient to an JSON string
   *
   * @return JSON string
   */
