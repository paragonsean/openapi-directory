...
public class GetPaymentMethods200Response {
  ...
  public GetPaymentMethods200Response() {
  }
  ...
  public GetPaymentMethods200Response data(List<PaymentMethod> data) {
    this.data = data;
    return this;
  }

  public GetPaymentMethods200Response addDataItem(PaymentMethod dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetPaymentMethods200Response getPaymentMethods200Response = (GetPaymentMethods200Response) o;
    return Objects.equals(this.data, getPaymentMethods200Response.data) &&
        Objects.equals(this.page, getPaymentMethods200Response.page) &&
        Objects.equals(this.pages, getPaymentMethods200Response.pages) &&
        Objects.equals(this.results, getPaymentMethods200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPaymentMethods200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPaymentMethods200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPaymentMethods200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPaymentMethods200Response is not found in the empty JSON string", GetPaymentMethods200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPaymentMethods200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPaymentMethods200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPaymentMethods200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPaymentMethods200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPaymentMethods200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPaymentMethods200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPaymentMethods200Response>() {
           @Override
           public void write(JsonWriter out, GetPaymentMethods200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPaymentMethods200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPaymentMethods200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPaymentMethods200Response
   * @throws IOException if the JSON string is invalid with respect to GetPaymentMethods200Response
   */
  public static GetPaymentMethods200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPaymentMethods200Response.class);
  }

  /**
   * Convert an instance of GetPaymentMethods200Response to an JSON string
   *
   * @return JSON string
   */
