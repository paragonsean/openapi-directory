...
public class Disk {
  ...
  public Disk filesystem(FilesystemEnum filesystem) {
  ...
  public Disk label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Disk disk = (Disk) o;
    return Objects.equals(this.created, disk.created) &&
        Objects.equals(this.filesystem, disk.filesystem) &&
        Objects.equals(this.id, disk.id) &&
        Objects.equals(this.label, disk.label) &&
        Objects.equals(this.size, disk.size) &&
        Objects.equals(this.status, disk.status) &&
        Objects.equals(this.updated, disk.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, filesystem, id, label, size, status, updated);
  }
