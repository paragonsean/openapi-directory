...
public class DatabasePostgreSQLRequest {
  ...
  public DatabasePostgreSQLRequest() {
  }

  public DatabasePostgreSQLRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabasePostgreSQLRequest addAllowListItem(String allowListItem) {
  ...
  public DatabasePostgreSQLRequest clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public DatabasePostgreSQLRequest encrypted(Boolean encrypted) {
  ...
  public DatabasePostgreSQLRequest engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DatabasePostgreSQLRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabasePostgreSQLRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabasePostgreSQLRequest replicationCommitType(ReplicationCommitTypeEnum replicationCommitType) {
  ...
  public DatabasePostgreSQLRequest replicationType(ReplicationTypeEnum replicationType) {
  ...
  public DatabasePostgreSQLRequest sslConnection(Boolean sslConnection) {
  ...
  public DatabasePostgreSQLRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatabasePostgreSQLRequest databasePostgreSQLRequest = (DatabasePostgreSQLRequest) o;
    return Objects.equals(this.allowList, databasePostgreSQLRequest.allowList) &&
        Objects.equals(this.clusterSize, databasePostgreSQLRequest.clusterSize) &&
        Objects.equals(this.encrypted, databasePostgreSQLRequest.encrypted) &&
        Objects.equals(this.engine, databasePostgreSQLRequest.engine) &&
        Objects.equals(this.label, databasePostgreSQLRequest.label) &&
        Objects.equals(this.region, databasePostgreSQLRequest.region) &&
        Objects.equals(this.replicationCommitType, databasePostgreSQLRequest.replicationCommitType) &&
        Objects.equals(this.replicationType, databasePostgreSQLRequest.replicationType) &&
        Objects.equals(this.sslConnection, databasePostgreSQLRequest.sslConnection) &&
        Objects.equals(this.type, databasePostgreSQLRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, encrypted, engine, label, region, replicationCommitType, replicationType, sslConnection, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabasePostgreSQLRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabasePostgreSQLRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabasePostgreSQLRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasePostgreSQLRequest is not found in the empty JSON string", DatabasePostgreSQLRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabasePostgreSQLRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabasePostgreSQLRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabasePostgreSQLRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasePostgreSQLRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasePostgreSQLRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasePostgreSQLRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasePostgreSQLRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasePostgreSQLRequest>() {
           @Override
           public void write(JsonWriter out, DatabasePostgreSQLRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabasePostgreSQLRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabasePostgreSQLRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabasePostgreSQLRequest
   * @throws IOException if the JSON string is invalid with respect to DatabasePostgreSQLRequest
   */
  public static DatabasePostgreSQLRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasePostgreSQLRequest.class);
  }

  /**
   * Convert an instance of DatabasePostgreSQLRequest to an JSON string
   *
   * @return JSON string
   */
