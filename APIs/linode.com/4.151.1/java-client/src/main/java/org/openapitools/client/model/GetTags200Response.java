...
public class GetTags200Response {
  ...
  public GetTags200Response data(List<Tag> data) {
    this.data = data;
    return this;
  }

  public GetTags200Response addDataItem(Tag dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getTags200Response.data) &&
        Objects.equals(this.page, getTags200Response.page) &&
        Objects.equals(this.pages, getTags200Response.pages) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTags200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTags200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTags200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTags200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
