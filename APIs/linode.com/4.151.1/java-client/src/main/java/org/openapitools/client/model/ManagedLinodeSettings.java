...
import org.openapitools.client.model.ManagedLinodeSettingsSsh;
...
public class ManagedLinodeSettings {
  ...
  private ManagedLinodeSettingsSsh ssh;

  public ManagedLinodeSettings() {
  }
  ...
  public ManagedLinodeSettings ssh(ManagedLinodeSettingsSsh ssh) {
    this.ssh = ssh;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ManagedLinodeSettingsSsh getSsh() {
    return ssh;
  }

  public void setSsh(ManagedLinodeSettingsSsh ssh) {
    this.ssh = ssh;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManagedLinodeSettings managedLinodeSettings = (ManagedLinodeSettings) o;
    return Objects.equals(this.group, managedLinodeSettings.group) &&
        Objects.equals(this.id, managedLinodeSettings.id) &&
        Objects.equals(this.label, managedLinodeSettings.label) &&
        Objects.equals(this.ssh, managedLinodeSettings.ssh);
  }

  @Override
  public int hashCode() {
    return Objects.hash(group, id, label, ssh);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ManagedLinodeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedLinodeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedLinodeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedLinodeSettings is not found in the empty JSON string", ManagedLinodeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedLinodeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedLinodeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ssh") != null && !jsonObj.get("ssh").isJsonNull()) {
        ManagedLinodeSettingsSsh.validateJsonElement(jsonObj.get("ssh"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedLinodeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedLinodeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedLinodeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedLinodeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedLinodeSettings>() {
           @Override
           public void write(JsonWriter out, ManagedLinodeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedLinodeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedLinodeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedLinodeSettings
   * @throws IOException if the JSON string is invalid with respect to ManagedLinodeSettings
   */
  public static ManagedLinodeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedLinodeSettings.class);
  }

  /**
   * Convert an instance of ManagedLinodeSettings to an JSON string
   *
   * @return JSON string
   */
