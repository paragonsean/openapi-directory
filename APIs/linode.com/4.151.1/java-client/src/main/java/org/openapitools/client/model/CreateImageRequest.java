...
public class CreateImageRequest {
  ...
  public CreateImageRequest diskId(Integer diskId) {
    this.diskId = diskId;
    return this;
  }
  ...
  public CreateImageRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createImageRequest.description) &&
        Objects.equals(this.diskId, createImageRequest.diskId) &&
        Objects.equals(this.label, createImageRequest.label);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, diskId, label);
  }
