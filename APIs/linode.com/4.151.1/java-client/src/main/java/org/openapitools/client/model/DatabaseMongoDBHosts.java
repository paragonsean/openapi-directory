...
public class DatabaseMongoDBHosts {
  ...
  public DatabaseMongoDBHosts() {
  }

  public DatabaseMongoDBHosts primary(String primary) {
  ...
  public DatabaseMongoDBHosts secondary(String secondary) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMongoDBHosts databaseMongoDBHosts = (DatabaseMongoDBHosts) o;
    return Objects.equals(this.primary, databaseMongoDBHosts.primary) &&
        Objects.equals(this.secondary, databaseMongoDBHosts.secondary);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseMongoDBHosts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseMongoDBHosts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseMongoDBHosts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMongoDBHosts is not found in the empty JSON string", DatabaseMongoDBHosts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseMongoDBHosts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseMongoDBHosts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMongoDBHosts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMongoDBHosts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMongoDBHosts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMongoDBHosts.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMongoDBHosts>() {
           @Override
           public void write(JsonWriter out, DatabaseMongoDBHosts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseMongoDBHosts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseMongoDBHosts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseMongoDBHosts
   * @throws IOException if the JSON string is invalid with respect to DatabaseMongoDBHosts
   */
  public static DatabaseMongoDBHosts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMongoDBHosts.class);
  }

  /**
   * Convert an instance of DatabaseMongoDBHosts to an JSON string
   *
   * @return JSON string
   */
