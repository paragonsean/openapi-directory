...
public class GetManagedIssues200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ManagedIssue> data = new ArrayList<>();
  ...
  public GetManagedIssues200Response() {
  }
  ...
  public GetManagedIssues200Response data(List<ManagedIssue> data) {
    this.data = data;
    return this;
  }

  public GetManagedIssues200Response addDataItem(ManagedIssue dataItem) {
    if (this.data == null) {
  ...
  public List<ManagedIssue> getData() {
    return data;
  }

  public void setData(List<ManagedIssue> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedIssues200Response getManagedIssues200Response = (GetManagedIssues200Response) o;
    return Objects.equals(this.data, getManagedIssues200Response.data) &&
        Objects.equals(this.page, getManagedIssues200Response.page) &&
        Objects.equals(this.pages, getManagedIssues200Response.pages) &&
        Objects.equals(this.results, getManagedIssues200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedIssues200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedIssues200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedIssues200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedIssues200Response is not found in the empty JSON string", GetManagedIssues200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedIssues200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedIssues200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ManagedIssue.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedIssues200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedIssues200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedIssues200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedIssues200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedIssues200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedIssues200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedIssues200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedIssues200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedIssues200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedIssues200Response
   */
  public static GetManagedIssues200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedIssues200Response.class);
  }

  /**
   * Convert an instance of GetManagedIssues200Response to an JSON string
   *
   * @return JSON string
   */
