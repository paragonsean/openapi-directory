...
public class RescueDevices {
  public static final String SERIALIZED_NAME_SDA = "sda";
  @SerializedName(SERIALIZED_NAME_SDA)
  private Device sda;

  public static final String SERIALIZED_NAME_SDB = "sdb";
  @SerializedName(SERIALIZED_NAME_SDB)
  private Device sdb;

  public static final String SERIALIZED_NAME_SDC = "sdc";
  @SerializedName(SERIALIZED_NAME_SDC)
  private Device sdc;

  public static final String SERIALIZED_NAME_SDD = "sdd";
  @SerializedName(SERIALIZED_NAME_SDD)
  private Device sdd;

  public static final String SERIALIZED_NAME_SDE = "sde";
  @SerializedName(SERIALIZED_NAME_SDE)
  private Device sde;

  public static final String SERIALIZED_NAME_SDF = "sdf";
  @SerializedName(SERIALIZED_NAME_SDF)
  private Device sdf;

  public static final String SERIALIZED_NAME_SDG = "sdg";
  @SerializedName(SERIALIZED_NAME_SDG)
  private Device sdg;

  public RescueDevices() {
  }

  public RescueDevices sda(Device sda) {
    this.sda = sda;
    return this;
  }
  ...
  public Device getSda() {
    return sda;
  }

  public void setSda(Device sda) {
    this.sda = sda;
  }


  public RescueDevices sdb(Device sdb) {
    this.sdb = sdb;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdb() {
    return sdb;
  }

  public void setSdb(Device sdb) {
    this.sdb = sdb;
  }


  public RescueDevices sdc(Device sdc) {
    this.sdc = sdc;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdc() {
    return sdc;
  }

  public void setSdc(Device sdc) {
    this.sdc = sdc;
  }


  public RescueDevices sdd(Device sdd) {
    this.sdd = sdd;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdd() {
    return sdd;
  }

  public void setSdd(Device sdd) {
    this.sdd = sdd;
  }


  public RescueDevices sde(Device sde) {
    this.sde = sde;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSde() {
    return sde;
  }

  public void setSde(Device sde) {
    this.sde = sde;
  }


  public RescueDevices sdf(Device sdf) {
    this.sdf = sdf;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdf() {
    return sdf;
  }

  public void setSdf(Device sdf) {
    this.sdf = sdf;
  }


  public RescueDevices sdg(Device sdg) {
    this.sdg = sdg;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Device getSdg() {
    return sdg;
  }

  public void setSdg(Device sdg) {
    this.sdg = sdg;
  }
  ...
  public boolean equals(Object o) {
    ...
    RescueDevices rescueDevices = (RescueDevices) o;
    return Objects.equals(this.sda, rescueDevices.sda) &&
        Objects.equals(this.sdb, rescueDevices.sdb) &&
        Objects.equals(this.sdc, rescueDevices.sdc) &&
        Objects.equals(this.sdd, rescueDevices.sdd) &&
        Objects.equals(this.sde, rescueDevices.sde) &&
        Objects.equals(this.sdf, rescueDevices.sdf) &&
        Objects.equals(this.sdg, rescueDevices.sdg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sda, sdb, sdc, sdd, sde, sdf, sdg);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RescueDevices {\n");
    sb.append("    sda: ").append(toIndentedString(sda)).append("\n");
    sb.append("    sdb: ").append(toIndentedString(sdb)).append("\n");
    sb.append("    sdc: ").append(toIndentedString(sdc)).append("\n");
    sb.append("    sdd: ").append(toIndentedString(sdd)).append("\n");
    sb.append("    sde: ").append(toIndentedString(sde)).append("\n");
    sb.append("    sdf: ").append(toIndentedString(sdf)).append("\n");
    sb.append("    sdg: ").append(toIndentedString(sdg)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("sda");
    openapiFields.add("sdb");
    openapiFields.add("sdc");
    openapiFields.add("sdd");
    openapiFields.add("sde");
    openapiFields.add("sdf");
    openapiFields.add("sdg");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RescueDevices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RescueDevices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RescueDevices is not found in the empty JSON string", RescueDevices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RescueDevices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RescueDevices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `sda`
      if (jsonObj.get("sda") != null && !jsonObj.get("sda").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sda"));
      }
      // validate the optional field `sdb`
      if (jsonObj.get("sdb") != null && !jsonObj.get("sdb").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdb"));
      }
      // validate the optional field `sdc`
      if (jsonObj.get("sdc") != null && !jsonObj.get("sdc").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdc"));
      }
      // validate the optional field `sdd`
      if (jsonObj.get("sdd") != null && !jsonObj.get("sdd").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdd"));
      }
      // validate the optional field `sde`
      if (jsonObj.get("sde") != null && !jsonObj.get("sde").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sde"));
      }
      // validate the optional field `sdf`
      if (jsonObj.get("sdf") != null && !jsonObj.get("sdf").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdf"));
      }
      // validate the optional field `sdg`
      if (jsonObj.get("sdg") != null && !jsonObj.get("sdg").isJsonNull()) {
        Device.validateJsonElement(jsonObj.get("sdg"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RescueDevices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RescueDevices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RescueDevices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RescueDevices.class));

       return (TypeAdapter<T>) new TypeAdapter<RescueDevices>() {
           @Override
           public void write(JsonWriter out, RescueDevices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RescueDevices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RescueDevices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RescueDevices
   * @throws IOException if the JSON string is invalid with respect to RescueDevices
   */
  public static RescueDevices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RescueDevices.class);
  }

  /**
   * Convert an instance of RescueDevices to an JSON string
   *
   * @return JSON string
   */
