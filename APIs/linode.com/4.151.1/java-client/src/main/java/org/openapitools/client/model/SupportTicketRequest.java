...
public class SupportTicketRequest {
  ...
  public static final String SERIALIZED_NAME_LINODE_ID = "linode_id";
  @SerializedName(SERIALIZED_NAME_LINODE_ID)
  private Integer linodeId;

  public static final String SERIALIZED_NAME_LKECLUSTER_ID = "lkecluster_id";
  @SerializedName(SERIALIZED_NAME_LKECLUSTER_ID)
  private Integer lkeclusterId;

  public static final String SERIALIZED_NAME_LONGVIEWCLIENT_ID = "longviewclient_id";
  @SerializedName(SERIALIZED_NAME_LONGVIEWCLIENT_ID)
  private Integer longviewclientId;

  public static final String SERIALIZED_NAME_MANAGED_ISSUE = "managed_issue";
  @SerializedName(SERIALIZED_NAME_MANAGED_ISSUE)
  ...
  public SupportTicketRequest databaseId(Integer databaseId) {
  ...
  public SupportTicketRequest description(String description) {
  ...
  public SupportTicketRequest domainId(Integer domainId) {
  ...
  public SupportTicketRequest firewallId(Integer firewallId) {
  ...
  public SupportTicketRequest linodeId(Integer linodeId) {
  ...
  public SupportTicketRequest lkeclusterId(Integer lkeclusterId) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getLkeclusterId() {
    return lkeclusterId;
  }

  public void setLkeclusterId(Integer lkeclusterId) {
    this.lkeclusterId = lkeclusterId;
  }


  public SupportTicketRequest longviewclientId(Integer longviewclientId) {
    this.longviewclientId = longviewclientId;
    return this;
  }

  /**
   * The ID of the Longview client this ticket is regarding, if relevant. 
   * @return longviewclientId
   */
  @javax.annotation.Nullable
  public Integer getLongviewclientId() {
    return longviewclientId;
  }

  public void setLongviewclientId(Integer longviewclientId) {
    this.longviewclientId = longviewclientId;
  }


  public SupportTicketRequest managedIssue(Boolean managedIssue) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getManagedIssue() {
    return managedIssue;
  }

  public void setManagedIssue(Boolean managedIssue) {
    this.managedIssue = managedIssue;
  }


  public SupportTicketRequest nodebalancerId(Integer nodebalancerId) {
  ...
  public void setNodebalancerId(Integer nodebalancerId) {
    this.nodebalancerId = nodebalancerId;
  }


  public SupportTicketRequest region(String region) {
    this.region = region;
    return this;
  }

  /**
   * The [Region](/docs/api/regions/) ID for the associated VLAN this ticket is regarding.  Only allowed when submitting a VLAN ticket. 
   * @return region
   */
  @javax.annotation.Nullable
  ...
  public SupportTicketRequest summary(String summary) {
  ...
  public SupportTicketRequest vlan(String vlan) {
    this.vlan = vlan;
    return this;
  }

  /**
   * The label of the VLAN this ticket is regarding, if relevant. To view your VLANs, use the VLANs List ([GET /networking/vlans](/docs/api/networking/#vlans-list)) endpoint.  Requires a specified &#x60;region&#x60; to identify the VLAN. 
   * @return vlan
   */
  @javax.annotation.Nullable
  ...
  public SupportTicketRequest volumeId(Integer volumeId) {
  ...
  public boolean equals(Object o) {
    ...
    SupportTicketRequest supportTicketRequest = (SupportTicketRequest) o;
    return Objects.equals(this.databaseId, supportTicketRequest.databaseId) &&
        Objects.equals(this.description, supportTicketRequest.description) &&
        Objects.equals(this.domainId, supportTicketRequest.domainId) &&
        Objects.equals(this.firewallId, supportTicketRequest.firewallId) &&
        Objects.equals(this.linodeId, supportTicketRequest.linodeId) &&
        Objects.equals(this.lkeclusterId, supportTicketRequest.lkeclusterId) &&
        Objects.equals(this.longviewclientId, supportTicketRequest.longviewclientId) &&
        Objects.equals(this.managedIssue, supportTicketRequest.managedIssue) &&
        Objects.equals(this.nodebalancerId, supportTicketRequest.nodebalancerId) &&
        Objects.equals(this.region, supportTicketRequest.region) &&
        Objects.equals(this.summary, supportTicketRequest.summary) &&
        Objects.equals(this.vlan, supportTicketRequest.vlan) &&
        Objects.equals(this.volumeId, supportTicketRequest.volumeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(databaseId, description, domainId, firewallId, linodeId, lkeclusterId, longviewclientId, managedIssue, nodebalancerId, region, summary, vlan, volumeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SupportTicketRequest {\n");
    sb.append("    databaseId: ").append(toIndentedString(databaseId)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    domainId: ").append(toIndentedString(domainId)).append("\n");
    sb.append("    firewallId: ").append(toIndentedString(firewallId)).append("\n");
    sb.append("    linodeId: ").append(toIndentedString(linodeId)).append("\n");
    sb.append("    lkeclusterId: ").append(toIndentedString(lkeclusterId)).append("\n");
    sb.append("    longviewclientId: ").append(toIndentedString(longviewclientId)).append("\n");
    sb.append("    managedIssue: ").append(toIndentedString(managedIssue)).append("\n");
  ...
  static {
    ...
    openapiFields.add("linode_id");
    openapiFields.add("lkecluster_id");
    openapiFields.add("longviewclient_id");
    openapiFields.add("managed_issue");
    openapiFields.add("nodebalancer_id");
    openapiFields.add("region");
    openapiFields.add("summary");
    openapiFields.add("vlan");
    openapiFields.add("volume_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportTicketRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportTicketRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportTicketRequest is not found in the empty JSON string", SupportTicketRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportTicketRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportTicketRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SupportTicketRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportTicketRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportTicketRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportTicketRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportTicketRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportTicketRequest>() {
           @Override
           public void write(JsonWriter out, SupportTicketRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportTicketRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportTicketRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportTicketRequest
   * @throws IOException if the JSON string is invalid with respect to SupportTicketRequest
   */
  public static SupportTicketRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportTicketRequest.class);
  }

  /**
   * Convert an instance of SupportTicketRequest to an JSON string
   *
   * @return JSON string
   */
