...
public class Database {
  ...
  public static final String SERIALIZED_NAME_INSTANCE_URI = "instance_uri";
  ...
  public Database allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public Database addAllowListItem(String allowListItem) {
  ...
  public Database clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public Database encrypted(Boolean encrypted) {
  ...
  public Database hosts(DatabaseHosts hosts) {
    this.hosts = hosts;
    return this;
  }
  ...
  public Database updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowList, database.allowList) &&
        Objects.equals(this.clusterSize, database.clusterSize) &&
        Objects.equals(this.created, database.created) &&
        Objects.equals(this.encrypted, database.encrypted) &&
        Objects.equals(this.engine, database.engine) &&
        Objects.equals(this.hosts, database.hosts) &&
        Objects.equals(this.id, database.id) &&
        Objects.equals(this.instanceUri, database.instanceUri) &&
        ...
        Objects.equals(this.updated, database.updated) &&
        Objects.equals(this.updates, database.updates) &&
        Objects.equals(this.version, database.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, created, encrypted, engine, hosts, id, instanceUri, label, region, status, type, updated, updates, version);
  }
  ...
  static {
    ...
    openapiFields.add("instance_uri");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("instance_uri") != null && !jsonObj.get("instance_uri").isJsonNull()) && !jsonObj.get("instance_uri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `instance_uri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("instance_uri").toString()));
      }
