...
import org.openapitools.client.model.WarningObject;
...
public class CreatePayment202Response {
  public static final String SERIALIZED_NAME_WARNINGS = "warnings";
  @SerializedName(SERIALIZED_NAME_WARNINGS)
  private List<WarningObject> warnings = new ArrayList<>();

  public CreatePayment202Response() {
  }

  public CreatePayment202Response warnings(List<WarningObject> warnings) {
    this.warnings = warnings;
    return this;
  }

  public CreatePayment202Response addWarningsItem(WarningObject warningsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePayment202Response createPayment202Response = (CreatePayment202Response) o;
    return Objects.equals(this.warnings, createPayment202Response.warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePayment202Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePayment202Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePayment202Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePayment202Response is not found in the empty JSON string", CreatePayment202Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePayment202Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePayment202Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("warnings") != null && !jsonObj.get("warnings").isJsonNull()) {
        ...
        if (jsonArraywarnings != null) {
          ...
          for (int i = 0; i < jsonArraywarnings.size(); i++) {
            WarningObject.validateJsonElement(jsonArraywarnings.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePayment202Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePayment202Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePayment202Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePayment202Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePayment202Response>() {
           @Override
           public void write(JsonWriter out, CreatePayment202Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePayment202Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePayment202Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePayment202Response
   * @throws IOException if the JSON string is invalid with respect to CreatePayment202Response
   */
  public static CreatePayment202Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePayment202Response.class);
  }

  /**
   * Convert an instance of CreatePayment202Response to an JSON string
   *
   * @return JSON string
   */
