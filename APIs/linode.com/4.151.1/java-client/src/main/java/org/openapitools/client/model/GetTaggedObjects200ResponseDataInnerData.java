...
public class GetTaggedObjects200ResponseDataInnerData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetTaggedObjects200ResponseDataInnerData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetTaggedObjects200ResponseDataInnerData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetTaggedObjects200ResponseDataInnerData' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Linode> adapterLinode = gson.getDelegateAdapter(this, TypeToken.get(Linode.class));
            final TypeAdapter<Domain> adapterDomain = gson.getDelegateAdapter(this, TypeToken.get(Domain.class));
            final TypeAdapter<Volume> adapterVolume = gson.getDelegateAdapter(this, TypeToken.get(Volume.class));
            final TypeAdapter<NodeBalancer> adapterNodeBalancer = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancer.class));

            return (TypeAdapter<T>) new TypeAdapter<GetTaggedObjects200ResponseDataInnerData>() {
                @Override
                public void write(JsonWriter out, GetTaggedObjects200ResponseDataInnerData value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `Linode`
                    if (value.getActualInstance() instanceof Linode) {
                        JsonElement element = adapterLinode.toJsonTree((Linode)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `Domain`
                    if (value.getActualInstance() instanceof Domain) {
                        JsonElement element = adapterDomain.toJsonTree((Domain)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `Volume`
                    if (value.getActualInstance() instanceof Volume) {
                        JsonElement element = adapterVolume.toJsonTree((Volume)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `NodeBalancer`
                    if (value.getActualInstance() instanceof NodeBalancer) {
                        JsonElement element = adapterNodeBalancer.toJsonTree((NodeBalancer)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Domain, Linode, NodeBalancer, Volume");
                }

                @Override
                public GetTaggedObjects200ResponseDataInnerData read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        Linode.validateJsonElement(jsonElement);
                        actualAdapter = adapterLinode;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'Linode'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Linode failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Linode'", e);
                    }
                    // deserialize Domain
                    try {
                        // validate the JSON object to see if any exception is thrown
                        Domain.validateJsonElement(jsonElement);
                        actualAdapter = adapterDomain;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'Domain'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Domain failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Domain'", e);
                    }
                    // deserialize Volume
                    try {
                        // validate the JSON object to see if any exception is thrown
                        Volume.validateJsonElement(jsonElement);
                        actualAdapter = adapterVolume;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'Volume'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for Volume failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'Volume'", e);
                    }
                    // deserialize NodeBalancer
                    try {
                        // validate the JSON object to see if any exception is thrown
                        NodeBalancer.validateJsonElement(jsonElement);
                        actualAdapter = adapterNodeBalancer;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'NodeBalancer'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for NodeBalancer failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'NodeBalancer'", e);
                    }

                    if (match == 1) {
                        GetTaggedObjects200ResponseDataInnerData ret = new GetTaggedObjects200ResponseDataInnerData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetTaggedObjects200ResponseDataInnerData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetTaggedObjects200ResponseDataInnerData() {
        super("oneOf", Boolean.FALSE);
    }

    public GetTaggedObjects200ResponseDataInnerData(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("Linode", Linode.class);
        schemas.put("Domain", Domain.class);
        schemas.put("Volume", Volume.class);
        schemas.put("NodeBalancer", NodeBalancer.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GetTaggedObjects200ResponseDataInnerData.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Domain, Linode, NodeBalancer, Volume
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof Linode) {
        ...
        if (instance instanceof NodeBalancer) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Domain, Linode, NodeBalancer, Volume");
    }
     ...
     * Domain, Linode, NodeBalancer, Volume
     *
     * @return The actual instance (Domain, Linode, NodeBalancer, Volume)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `Linode`. If the actual instance is not `Linode`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Linode`
     * @throws ClassCastException if the instance is not `Linode`
     */
    public Linode getLinode() throws ClassCastException {
        return (Linode)super.getActualInstance();
    }
    /**
     * Get the actual instance of `Domain`. If the actual instance is not `Domain`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Domain`
     * @throws ClassCastException if the instance is not `Domain`
     */
    public Domain getDomain() throws ClassCastException {
        return (Domain)super.getActualInstance();
    }
    /**
     * Get the actual instance of `Volume`. If the actual instance is not `Volume`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Volume`
     * @throws ClassCastException if the instance is not `Volume`
     */
    public Volume getVolume() throws ClassCastException {
        return (Volume)super.getActualInstance();
    }
    /**
     * Get the actual instance of `NodeBalancer`. If the actual instance is not `NodeBalancer`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `NodeBalancer`
     * @throws ClassCastException if the instance is not `NodeBalancer`
     */
    public NodeBalancer getNodeBalancer() throws ClassCastException {
        return (NodeBalancer)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetTaggedObjects200ResponseDataInnerData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with Linode
        try {
            Linode.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with Domain
        try {
            Domain.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with Volume
        try {
            Volume.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with NodeBalancer
        try {
            NodeBalancer.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetTaggedObjects200ResponseDataInnerData with oneOf schemas: Domain, Linode, NodeBalancer, Volume. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetTaggedObjects200ResponseDataInnerData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetTaggedObjects200ResponseDataInnerData
     * @throws IOException if the JSON string is invalid with respect to GetTaggedObjects200ResponseDataInnerData
     */
    public static GetTaggedObjects200ResponseDataInnerData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetTaggedObjects200ResponseDataInnerData.class);
    }

    /**
     * Convert an instance of GetTaggedObjects200ResponseDataInnerData to an JSON string
     *
     * @return JSON string
     */
