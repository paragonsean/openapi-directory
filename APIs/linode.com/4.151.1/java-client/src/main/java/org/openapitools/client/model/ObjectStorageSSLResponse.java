...
public class ObjectStorageSSLResponse {
  ...
  public ObjectStorageSSLResponse() {
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjectStorageSSLResponse objectStorageSSLResponse = (ObjectStorageSSLResponse) o;
    return Objects.equals(this.ssl, objectStorageSSLResponse.ssl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectStorageSSLResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageSSLResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageSSLResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageSSLResponse is not found in the empty JSON string", ObjectStorageSSLResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageSSLResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageSSLResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageSSLResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageSSLResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageSSLResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageSSLResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageSSLResponse>() {
           @Override
           public void write(JsonWriter out, ObjectStorageSSLResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageSSLResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageSSLResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageSSLResponse
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageSSLResponse
   */
  public static ObjectStorageSSLResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageSSLResponse.class);
  }

  /**
   * Convert an instance of ObjectStorageSSLResponse to an JSON string
   *
   * @return JSON string
   */
