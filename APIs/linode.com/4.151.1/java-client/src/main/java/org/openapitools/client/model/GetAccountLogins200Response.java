...
public class GetAccountLogins200Response {
  ...
  public GetAccountLogins200Response() {
  }
  ...
  public GetAccountLogins200Response data(List<Login> data) {
    this.data = data;
    return this;
  }

  public GetAccountLogins200Response addDataItem(Login dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetAccountLogins200Response getAccountLogins200Response = (GetAccountLogins200Response) o;
    return Objects.equals(this.data, getAccountLogins200Response.data) &&
        Objects.equals(this.page, getAccountLogins200Response.page) &&
        Objects.equals(this.pages, getAccountLogins200Response.pages) &&
        Objects.equals(this.results, getAccountLogins200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountLogins200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountLogins200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountLogins200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountLogins200Response is not found in the empty JSON string", GetAccountLogins200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountLogins200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountLogins200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Login.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountLogins200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountLogins200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountLogins200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountLogins200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountLogins200Response>() {
           @Override
           public void write(JsonWriter out, GetAccountLogins200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountLogins200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountLogins200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountLogins200Response
   * @throws IOException if the JSON string is invalid with respect to GetAccountLogins200Response
   */
  public static GetAccountLogins200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountLogins200Response.class);
  }

  /**
   * Convert an instance of GetAccountLogins200Response to an JSON string
   *
   * @return JSON string
   */
