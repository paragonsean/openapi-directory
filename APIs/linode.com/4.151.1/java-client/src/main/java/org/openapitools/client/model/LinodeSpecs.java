...
public class LinodeSpecs {
  ...
  /**
   * The amount of RAM, in MB, this Linode has access to.  Typically, a Linode boots with all of its available RAM, but this can be configured in a Config profile. See the [/linode/instances/{linodeId}/configs](/docs/api/linode-instances/#configuration-profiles-list) endpoints and the LinodeConfig object for more information. 
   * @return memory
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    LinodeSpecs linodeSpecs = (LinodeSpecs) o;
    return Objects.equals(this.disk, linodeSpecs.disk) &&
        Objects.equals(this.gpus, linodeSpecs.gpus) &&
        Objects.equals(this.memory, linodeSpecs.memory) &&
        Objects.equals(this.transfer, linodeSpecs.transfer) &&
        Objects.equals(this.vcpus, linodeSpecs.vcpus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disk, gpus, memory, transfer, vcpus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinodeSpecs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeSpecs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeSpecs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeSpecs is not found in the empty JSON string", LinodeSpecs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeSpecs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeSpecs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeSpecs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeSpecs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeSpecs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeSpecs.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeSpecs>() {
           @Override
           public void write(JsonWriter out, LinodeSpecs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeSpecs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeSpecs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeSpecs
   * @throws IOException if the JSON string is invalid with respect to LinodeSpecs
   */
  public static LinodeSpecs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeSpecs.class);
  }

  /**
   * Convert an instance of LinodeSpecs to an JSON string
   *
   * @return JSON string
   */
