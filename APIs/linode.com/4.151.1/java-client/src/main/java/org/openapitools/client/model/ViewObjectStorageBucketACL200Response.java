...
public class ViewObjectStorageBucketACL200Response {
  /**
  ...
  public static final String SERIALIZED_NAME_ACL_XML = "acl_xml";
  @SerializedName(SERIALIZED_NAME_ACL_XML)
  private String aclXml;

  public ViewObjectStorageBucketACL200Response() {
  }

  public ViewObjectStorageBucketACL200Response acl(AclEnum acl) {
    this.acl = acl;
    return this;
  }
  ...
  public ViewObjectStorageBucketACL200Response aclXml(String aclXml) {
    this.aclXml = aclXml;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getAclXml() {
    return aclXml;
  }

  public void setAclXml(String aclXml) {
    this.aclXml = aclXml;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewObjectStorageBucketACL200Response viewObjectStorageBucketACL200Response = (ViewObjectStorageBucketACL200Response) o;
    return Objects.equals(this.acl, viewObjectStorageBucketACL200Response.acl) &&
        Objects.equals(this.aclXml, viewObjectStorageBucketACL200Response.aclXml);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acl, aclXml);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewObjectStorageBucketACL200Response {\n");
    sb.append("    acl: ").append(toIndentedString(acl)).append("\n");
    sb.append("    aclXml: ").append(toIndentedString(aclXml)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewObjectStorageBucketACL200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewObjectStorageBucketACL200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewObjectStorageBucketACL200Response is not found in the empty JSON string", ViewObjectStorageBucketACL200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewObjectStorageBucketACL200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewObjectStorageBucketACL200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("acl_xml") != null && !jsonObj.get("acl_xml").isJsonNull()) && !jsonObj.get("acl_xml").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `acl_xml` to be a primitive type in the JSON string but got `%s`", jsonObj.get("acl_xml").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewObjectStorageBucketACL200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewObjectStorageBucketACL200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewObjectStorageBucketACL200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewObjectStorageBucketACL200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewObjectStorageBucketACL200Response>() {
           @Override
           public void write(JsonWriter out, ViewObjectStorageBucketACL200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewObjectStorageBucketACL200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewObjectStorageBucketACL200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewObjectStorageBucketACL200Response
   * @throws IOException if the JSON string is invalid with respect to ViewObjectStorageBucketACL200Response
   */
  public static ViewObjectStorageBucketACL200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewObjectStorageBucketACL200Response.class);
  }

  /**
   * Convert an instance of ViewObjectStorageBucketACL200Response to an JSON string
   *
   * @return JSON string
   */
