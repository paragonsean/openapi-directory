...
public class GetObjectStorageClusters200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ObjectStorageCluster> data = new ArrayList<>();
  ...
  public GetObjectStorageClusters200Response() {
  }
  ...
  public GetObjectStorageClusters200Response data(List<ObjectStorageCluster> data) {
    this.data = data;
    return this;
  }

  public GetObjectStorageClusters200Response addDataItem(ObjectStorageCluster dataItem) {
    if (this.data == null) {
  ...
  public List<ObjectStorageCluster> getData() {
    return data;
  }

  public void setData(List<ObjectStorageCluster> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetObjectStorageClusters200Response getObjectStorageClusters200Response = (GetObjectStorageClusters200Response) o;
    return Objects.equals(this.data, getObjectStorageClusters200Response.data) &&
        Objects.equals(this.page, getObjectStorageClusters200Response.page) &&
        Objects.equals(this.pages, getObjectStorageClusters200Response.pages) &&
        Objects.equals(this.results, getObjectStorageClusters200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetObjectStorageClusters200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetObjectStorageClusters200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetObjectStorageClusters200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetObjectStorageClusters200Response is not found in the empty JSON string", GetObjectStorageClusters200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetObjectStorageClusters200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetObjectStorageClusters200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectStorageCluster.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetObjectStorageClusters200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetObjectStorageClusters200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetObjectStorageClusters200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetObjectStorageClusters200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetObjectStorageClusters200Response>() {
           @Override
           public void write(JsonWriter out, GetObjectStorageClusters200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetObjectStorageClusters200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetObjectStorageClusters200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetObjectStorageClusters200Response
   * @throws IOException if the JSON string is invalid with respect to GetObjectStorageClusters200Response
   */
  public static GetObjectStorageClusters200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetObjectStorageClusters200Response.class);
  }

  /**
   * Convert an instance of GetObjectStorageClusters200Response to an JSON string
   *
   * @return JSON string
   */
