...
public class GetPayments200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getPayments200Response.data) &&
        Objects.equals(this.page, getPayments200Response.page) &&
        Objects.equals(this.pages, getPayments200Response.pages) &&
        Objects.equals(this.results, getPayments200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPayments200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPayments200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPayments200Response is not found in the empty JSON string", GetPayments200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPayments200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPayments200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPayments200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPayments200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPayments200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPayments200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPayments200Response>() {
           @Override
           public void write(JsonWriter out, GetPayments200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPayments200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPayments200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPayments200Response
   * @throws IOException if the JSON string is invalid with respect to GetPayments200Response
   */
  public static GetPayments200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPayments200Response.class);
  }

  /**
   * Convert an instance of GetPayments200Response to an JSON string
   *
   * @return JSON string
   */
