...
import org.openapitools.client.model.ManagedIssueEntity;
...
public class ManagedIssue {
  ...
  private ManagedIssueEntity entity;
  ...
  public ManagedIssue entity(ManagedIssueEntity entity) {
    this.entity = entity;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ManagedIssueEntity getEntity() {
    return entity;
  }

  public void setEntity(ManagedIssueEntity entity) {
    this.entity = entity;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManagedIssue managedIssue = (ManagedIssue) o;
    return Objects.equals(this.created, managedIssue.created) &&
        Objects.equals(this.entity, managedIssue.entity) &&
        Objects.equals(this.id, managedIssue.id) &&
        Objects.equals(this.services, managedIssue.services);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, entity, id, services);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ManagedIssue {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedIssue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedIssue is not found in the empty JSON string", ManagedIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedIssue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `entity`
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        ManagedIssueEntity.validateJsonElement(jsonObj.get("entity"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedIssue>() {
           @Override
           public void write(JsonWriter out, ManagedIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedIssue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedIssue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedIssue
   * @throws IOException if the JSON string is invalid with respect to ManagedIssue
   */
  public static ManagedIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedIssue.class);
  }

  /**
   * Convert an instance of ManagedIssue to an JSON string
   *
   * @return JSON string
   */
