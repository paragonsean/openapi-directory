...
public class GetRegions200Response {
  ...
  public GetRegions200Response data(List<Region> data) {
    this.data = data;
    return this;
  }

  public GetRegions200Response addDataItem(Region dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetRegions200Response getRegions200Response = (GetRegions200Response) o;
    return Objects.equals(this.data, getRegions200Response.data) &&
        Objects.equals(this.page, getRegions200Response.page) &&
        Objects.equals(this.pages, getRegions200Response.pages) &&
        Objects.equals(this.results, getRegions200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRegions200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRegions200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRegions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRegions200Response is not found in the empty JSON string", GetRegions200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRegions200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRegions200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Region.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRegions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRegions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRegions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRegions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRegions200Response>() {
           @Override
           public void write(JsonWriter out, GetRegions200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRegions200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRegions200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRegions200Response
   * @throws IOException if the JSON string is invalid with respect to GetRegions200Response
   */
  public static GetRegions200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRegions200Response.class);
  }

  /**
   * Convert an instance of GetRegions200Response to an JSON string
   *
   * @return JSON string
   */
