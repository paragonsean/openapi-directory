...
public class GetManagedCredentials200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ManagedCredential> data = new ArrayList<>();
  ...
  public GetManagedCredentials200Response() {
  }
  ...
  public GetManagedCredentials200Response data(List<ManagedCredential> data) {
    this.data = data;
    return this;
  }

  public GetManagedCredentials200Response addDataItem(ManagedCredential dataItem) {
    if (this.data == null) {
  ...
  public List<ManagedCredential> getData() {
    return data;
  }

  public void setData(List<ManagedCredential> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedCredentials200Response getManagedCredentials200Response = (GetManagedCredentials200Response) o;
    return Objects.equals(this.data, getManagedCredentials200Response.data) &&
        Objects.equals(this.page, getManagedCredentials200Response.page) &&
        Objects.equals(this.pages, getManagedCredentials200Response.pages) &&
        Objects.equals(this.results, getManagedCredentials200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedCredentials200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedCredentials200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedCredentials200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedCredentials200Response is not found in the empty JSON string", GetManagedCredentials200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedCredentials200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedCredentials200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ManagedCredential.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedCredentials200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedCredentials200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedCredentials200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedCredentials200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedCredentials200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedCredentials200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedCredentials200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedCredentials200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedCredentials200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedCredentials200Response
   */
  public static GetManagedCredentials200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedCredentials200Response.class);
  }

  /**
   * Convert an instance of GetManagedCredentials200Response to an JSON string
   *
   * @return JSON string
   */
