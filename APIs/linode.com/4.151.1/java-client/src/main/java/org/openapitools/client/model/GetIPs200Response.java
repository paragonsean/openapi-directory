...
public class GetIPs200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<IPAddress> data = new ArrayList<>();
  ...
  public GetIPs200Response data(List<IPAddress> data) {
    this.data = data;
    return this;
  }

  public GetIPs200Response addDataItem(IPAddress dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetIPs200Response getIPs200Response = (GetIPs200Response) o;
    return Objects.equals(this.data, getIPs200Response.data) &&
        Objects.equals(this.page, getIPs200Response.page) &&
        Objects.equals(this.pages, getIPs200Response.pages) &&
        Objects.equals(this.results, getIPs200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIPs200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIPs200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIPs200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIPs200Response is not found in the empty JSON string", GetIPs200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIPs200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIPs200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            IPAddress.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIPs200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIPs200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIPs200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIPs200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIPs200Response>() {
           @Override
           public void write(JsonWriter out, GetIPs200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIPs200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIPs200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIPs200Response
   * @throws IOException if the JSON string is invalid with respect to GetIPs200Response
   */
  public static GetIPs200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIPs200Response.class);
  }

  /**
   * Convert an instance of GetIPs200Response to an JSON string
   *
   * @return JSON string
   */
