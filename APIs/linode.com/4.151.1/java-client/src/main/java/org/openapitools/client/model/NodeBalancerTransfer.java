...
public class NodeBalancerTransfer {
  ...
  public boolean equals(Object o) {
    ...
    NodeBalancerTransfer nodeBalancerTransfer = (NodeBalancerTransfer) o;
    return Objects.equals(this.in, nodeBalancerTransfer.in) &&
        Objects.equals(this.out, nodeBalancerTransfer.out) &&
        Objects.equals(this.total, nodeBalancerTransfer.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeBalancerTransfer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeBalancerTransfer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeBalancerTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeBalancerTransfer is not found in the empty JSON string", NodeBalancerTransfer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeBalancerTransfer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeBalancerTransfer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeBalancerTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeBalancerTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeBalancerTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancerTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeBalancerTransfer>() {
           @Override
           public void write(JsonWriter out, NodeBalancerTransfer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeBalancerTransfer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeBalancerTransfer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeBalancerTransfer
   * @throws IOException if the JSON string is invalid with respect to NodeBalancerTransfer
   */
  public static NodeBalancerTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeBalancerTransfer.class);
  }

  /**
   * Convert an instance of NodeBalancerTransfer to an JSON string
   *
   * @return JSON string
   */
