...
public class CloneDomainRequest {
  public static final String SERIALIZED_NAME_DOMAIN = "domain";
  @SerializedName(SERIALIZED_NAME_DOMAIN)
  private String domain;

  public CloneDomainRequest() {
  }

  public CloneDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloneDomainRequest cloneDomainRequest = (CloneDomainRequest) o;
    return Objects.equals(this.domain, cloneDomainRequest.domain);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloneDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloneDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloneDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloneDomainRequest is not found in the empty JSON string", CloneDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloneDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloneDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloneDomainRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloneDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloneDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloneDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloneDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloneDomainRequest>() {
           @Override
           public void write(JsonWriter out, CloneDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloneDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloneDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloneDomainRequest
   * @throws IOException if the JSON string is invalid with respect to CloneDomainRequest
   */
  public static CloneDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloneDomainRequest.class);
  }

  /**
   * Convert an instance of CloneDomainRequest to an JSON string
   *
   * @return JSON string
   */
