...
public class GetAccountDefaultResponse {
  public static final String SERIALIZED_NAME_ERRORS = "errors";
  @SerializedName(SERIALIZED_NAME_ERRORS)
  private List<ErrorObject> errors = new ArrayList<>();

  public GetAccountDefaultResponse() {
  }

  public GetAccountDefaultResponse errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public GetAccountDefaultResponse addErrorsItem(ErrorObject errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetAccountDefaultResponse getAccountDefaultResponse = (GetAccountDefaultResponse) o;
    return Objects.equals(this.errors, getAccountDefaultResponse.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountDefaultResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountDefaultResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountDefaultResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountDefaultResponse is not found in the empty JSON string", GetAccountDefaultResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountDefaultResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountDefaultResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountDefaultResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountDefaultResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountDefaultResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountDefaultResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountDefaultResponse>() {
           @Override
           public void write(JsonWriter out, GetAccountDefaultResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountDefaultResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountDefaultResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountDefaultResponse
   * @throws IOException if the JSON string is invalid with respect to GetAccountDefaultResponse
   */
  public static GetAccountDefaultResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountDefaultResponse.class);
  }

  /**
   * Convert an instance of GetAccountDefaultResponse to an JSON string
   *
   * @return JSON string
   */
