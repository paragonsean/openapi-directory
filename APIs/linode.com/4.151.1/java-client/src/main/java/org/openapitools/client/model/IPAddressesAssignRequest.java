...
import org.openapitools.client.model.IPAddressesAssignRequestAssignmentsInner;
...
public class IPAddressesAssignRequest {
  ...
  private List<IPAddressesAssignRequestAssignmentsInner> assignments = new ArrayList<>();

  public static final String SERIALIZED_NAME_REGION = "region";
  @SerializedName(SERIALIZED_NAME_REGION)
  private String region;

  public IPAddressesAssignRequest() {
  }

  public IPAddressesAssignRequest assignments(List<IPAddressesAssignRequestAssignmentsInner> assignments) {
    this.assignments = assignments;
    return this;
  }

  public IPAddressesAssignRequest addAssignmentsItem(IPAddressesAssignRequestAssignmentsInner assignmentsItem) {
  ...
  public List<IPAddressesAssignRequestAssignmentsInner> getAssignments() {
    return assignments;
  }

  public void setAssignments(List<IPAddressesAssignRequestAssignmentsInner> assignments) {
    this.assignments = assignments;
  }


  public IPAddressesAssignRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPAddressesAssignRequest ipAddressesAssignRequest = (IPAddressesAssignRequest) o;
    return Objects.equals(this.assignments, ipAddressesAssignRequest.assignments) &&
        Objects.equals(this.region, ipAddressesAssignRequest.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignments, region);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPAddressesAssignRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressesAssignRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressesAssignRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressesAssignRequest is not found in the empty JSON string", IPAddressesAssignRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressesAssignRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressesAssignRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IPAddressesAssignRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayassignments.size(); i++) {
        IPAddressesAssignRequestAssignmentsInner.validateJsonElement(jsonArrayassignments.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressesAssignRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressesAssignRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressesAssignRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressesAssignRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressesAssignRequest>() {
           @Override
           public void write(JsonWriter out, IPAddressesAssignRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressesAssignRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressesAssignRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressesAssignRequest
   * @throws IOException if the JSON string is invalid with respect to IPAddressesAssignRequest
   */
  public static IPAddressesAssignRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressesAssignRequest.class);
  }

  /**
   * Convert an instance of IPAddressesAssignRequest to an JSON string
   *
   * @return JSON string
   */
