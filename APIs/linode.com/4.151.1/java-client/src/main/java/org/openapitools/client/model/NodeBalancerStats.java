...
import org.openapitools.client.model.NodeBalancerStatsData;
...
public class NodeBalancerStats {
  ...
  private NodeBalancerStatsData data;

  public static final String SERIALIZED_NAME_TITLE = "title";
  @SerializedName(SERIALIZED_NAME_TITLE)
  private String title;

  public NodeBalancerStats() {
  }

  public NodeBalancerStats data(NodeBalancerStatsData data) {
    this.data = data;
    return this;
  }
  ...
  public NodeBalancerStatsData getData() {
    return data;
  }

  public void setData(NodeBalancerStatsData data) {
    this.data = data;
  }


  public NodeBalancerStats title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NodeBalancerStats nodeBalancerStats = (NodeBalancerStats) o;
    return Objects.equals(this.data, nodeBalancerStats.data) &&
        Objects.equals(this.title, nodeBalancerStats.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeBalancerStats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeBalancerStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeBalancerStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeBalancerStats is not found in the empty JSON string", NodeBalancerStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeBalancerStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeBalancerStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        NodeBalancerStatsData.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeBalancerStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeBalancerStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeBalancerStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancerStats.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeBalancerStats>() {
           @Override
           public void write(JsonWriter out, NodeBalancerStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeBalancerStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeBalancerStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeBalancerStats
   * @throws IOException if the JSON string is invalid with respect to NodeBalancerStats
   */
  public static NodeBalancerStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeBalancerStats.class);
  }

  /**
   * Convert an instance of NodeBalancerStats to an JSON string
   *
   * @return JSON string
   */
