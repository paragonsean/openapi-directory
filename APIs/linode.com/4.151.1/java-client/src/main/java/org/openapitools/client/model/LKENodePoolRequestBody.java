...
import org.openapitools.client.model.LKENodePoolRequestBodyAutoscaler;
...
public class LKENodePoolRequestBody {
  public static final String SERIALIZED_NAME_AUTOSCALER = "autoscaler";
  @SerializedName(SERIALIZED_NAME_AUTOSCALER)
  private LKENodePoolRequestBodyAutoscaler autoscaler;
  ...
  private List<Items> disks = new ArrayList<>();
  ...
  public LKENodePoolRequestBody() {
  }

  public LKENodePoolRequestBody autoscaler(LKENodePoolRequestBodyAutoscaler autoscaler) {
  ...
  public LKENodePoolRequestBodyAutoscaler getAutoscaler() {
    return autoscaler;
  }

  public void setAutoscaler(LKENodePoolRequestBodyAutoscaler autoscaler) {
    this.autoscaler = autoscaler;
  }


  public LKENodePoolRequestBody count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public LKENodePoolRequestBody disks(List<Items> disks) {
    this.disks = disks;
    return this;
  }

  public LKENodePoolRequestBody addDisksItem(Items disksItem) {
    if (this.disks == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<Items> getDisks() {
    return disks;
  }

  public void setDisks(List<Items> disks) {
    this.disks = disks;
  }


  public LKENodePoolRequestBody tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public LKENodePoolRequestBody addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public LKENodePoolRequestBody type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodePoolRequestBody lkENodePoolRequestBody = (LKENodePoolRequestBody) o;
    return Objects.equals(this.autoscaler, lkENodePoolRequestBody.autoscaler) &&
        Objects.equals(this.count, lkENodePoolRequestBody.count) &&
        Objects.equals(this.disks, lkENodePoolRequestBody.disks) &&
        Objects.equals(this.tags, lkENodePoolRequestBody.tags) &&
        Objects.equals(this.type, lkENodePoolRequestBody.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoscaler, count, disks, tags, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LKENodePoolRequestBody {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodePoolRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodePoolRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodePoolRequestBody is not found in the empty JSON string", LKENodePoolRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodePoolRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodePoolRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `autoscaler`
      if (jsonObj.get("autoscaler") != null && !jsonObj.get("autoscaler").isJsonNull()) {
        LKENodePoolRequestBodyAutoscaler.validateJsonElement(jsonObj.get("autoscaler"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("disks") != null && !jsonObj.get("disks").isJsonNull() && !jsonObj.get("disks").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodePoolRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodePoolRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodePoolRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodePoolRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodePoolRequestBody>() {
           @Override
           public void write(JsonWriter out, LKENodePoolRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodePoolRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodePoolRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodePoolRequestBody
   * @throws IOException if the JSON string is invalid with respect to LKENodePoolRequestBody
   */
  public static LKENodePoolRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodePoolRequestBody.class);
  }

  /**
   * Convert an instance of LKENodePoolRequestBody to an JSON string
   *
   * @return JSON string
   */
