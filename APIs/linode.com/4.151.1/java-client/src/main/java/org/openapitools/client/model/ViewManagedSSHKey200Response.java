...
public class ViewManagedSSHKey200Response {
  ...
  public boolean equals(Object o) {
    ...
    ViewManagedSSHKey200Response viewManagedSSHKey200Response = (ViewManagedSSHKey200Response) o;
    return Objects.equals(this.sshKey, viewManagedSSHKey200Response.sshKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewManagedSSHKey200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewManagedSSHKey200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewManagedSSHKey200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewManagedSSHKey200Response is not found in the empty JSON string", ViewManagedSSHKey200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewManagedSSHKey200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewManagedSSHKey200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewManagedSSHKey200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewManagedSSHKey200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewManagedSSHKey200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewManagedSSHKey200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewManagedSSHKey200Response>() {
           @Override
           public void write(JsonWriter out, ViewManagedSSHKey200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewManagedSSHKey200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewManagedSSHKey200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewManagedSSHKey200Response
   * @throws IOException if the JSON string is invalid with respect to ViewManagedSSHKey200Response
   */
  public static ViewManagedSSHKey200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewManagedSSHKey200Response.class);
  }

  /**
   * Convert an instance of ViewManagedSSHKey200Response to an JSON string
   *
   * @return JSON string
   */
