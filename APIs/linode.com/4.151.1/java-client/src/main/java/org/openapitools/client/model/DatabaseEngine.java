...
public class DatabaseEngine {
  ...
  public DatabaseEngine engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DatabaseEngine id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DatabaseEngine version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseEngine databaseEngine = (DatabaseEngine) o;
    return Objects.equals(this.engine, databaseEngine.engine) &&
        Objects.equals(this.id, databaseEngine.id) &&
        Objects.equals(this.version, databaseEngine.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(engine, id, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseEngine {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseEngine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseEngine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseEngine is not found in the empty JSON string", DatabaseEngine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseEngine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseEngine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseEngine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseEngine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseEngine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseEngine.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseEngine>() {
           @Override
           public void write(JsonWriter out, DatabaseEngine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseEngine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseEngine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseEngine
   * @throws IOException if the JSON string is invalid with respect to DatabaseEngine
   */
  public static DatabaseEngine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseEngine.class);
  }

  /**
   * Convert an instance of DatabaseEngine to an JSON string
   *
   * @return JSON string
   */
