...
public class SSHKey {
  ...
  public SSHKey sshKey(String sshKey) {
    this.sshKey = sshKey;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, ssHKey.created) &&
        Objects.equals(this.id, ssHKey.id) &&
        Objects.equals(this.label, ssHKey.label) &&
        Objects.equals(this.sshKey, ssHKey.sshKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, label, sshKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("ssh_key") != null && !jsonObj.get("ssh_key").isJsonNull()) && !jsonObj.get("ssh_key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ssh_key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ssh_key").toString()));
      }
  }
