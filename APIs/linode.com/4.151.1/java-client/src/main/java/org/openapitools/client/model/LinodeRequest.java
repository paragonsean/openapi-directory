...
public class LinodeRequest {
  ...
  public LinodeRequest authorizedKeys(List<String> authorizedKeys) {
    this.authorizedKeys = authorizedKeys;
    return this;
  }

  public LinodeRequest addAuthorizedKeysItem(String authorizedKeysItem) {
  ...
  public LinodeRequest authorizedUsers(List<String> authorizedUsers) {
    this.authorizedUsers = authorizedUsers;
    return this;
  }

  public LinodeRequest addAuthorizedUsersItem(String authorizedUsersItem) {
  ...
  public LinodeRequest booted(Boolean booted) {
    this.booted = booted;
    return this;
  }
  ...
  public LinodeRequest image(String image) {
    this.image = image;
    return this;
  }
  ...
  public LinodeRequest rootPass(String rootPass) {
  ...
  public LinodeRequest stackscriptData(Object stackscriptData) {
  ...
  public LinodeRequest stackscriptId(Integer stackscriptId) {
  ...
  public boolean equals(Object o) {
    ...
    LinodeRequest linodeRequest = (LinodeRequest) o;
    return Objects.equals(this.authorizedKeys, linodeRequest.authorizedKeys) &&
        Objects.equals(this.authorizedUsers, linodeRequest.authorizedUsers) &&
        Objects.equals(this.booted, linodeRequest.booted) &&
        Objects.equals(this.image, linodeRequest.image) &&
        Objects.equals(this.rootPass, linodeRequest.rootPass) &&
        Objects.equals(this.stackscriptData, linodeRequest.stackscriptData) &&
        Objects.equals(this.stackscriptId, linodeRequest.stackscriptId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizedKeys, authorizedUsers, booted, image, rootPass, stackscriptData, stackscriptId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinodeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeRequest is not found in the empty JSON string", LinodeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeRequest>() {
           @Override
           public void write(JsonWriter out, LinodeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeRequest
   * @throws IOException if the JSON string is invalid with respect to LinodeRequest
   */
  public static LinodeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeRequest.class);
  }

  /**
   * Convert an instance of LinodeRequest to an JSON string
   *
   * @return JSON string
   */
