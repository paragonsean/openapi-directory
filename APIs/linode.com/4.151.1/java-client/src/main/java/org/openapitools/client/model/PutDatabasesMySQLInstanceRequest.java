...
public class PutDatabasesMySQLInstanceRequest {
  ...
  public PutDatabasesMySQLInstanceRequest() {
  }

  public PutDatabasesMySQLInstanceRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public PutDatabasesMySQLInstanceRequest addAllowListItem(String allowListItem) {
  ...
  public PutDatabasesMySQLInstanceRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PutDatabasesMySQLInstanceRequest updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    PutDatabasesMySQLInstanceRequest putDatabasesMySQLInstanceRequest = (PutDatabasesMySQLInstanceRequest) o;
    return Objects.equals(this.allowList, putDatabasesMySQLInstanceRequest.allowList) &&
        Objects.equals(this.label, putDatabasesMySQLInstanceRequest.label) &&
        Objects.equals(this.updates, putDatabasesMySQLInstanceRequest.updates);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDatabasesMySQLInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDatabasesMySQLInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDatabasesMySQLInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDatabasesMySQLInstanceRequest is not found in the empty JSON string", PutDatabasesMySQLInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDatabasesMySQLInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDatabasesMySQLInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDatabasesMySQLInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDatabasesMySQLInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDatabasesMySQLInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDatabasesMySQLInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDatabasesMySQLInstanceRequest>() {
           @Override
           public void write(JsonWriter out, PutDatabasesMySQLInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDatabasesMySQLInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDatabasesMySQLInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDatabasesMySQLInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to PutDatabasesMySQLInstanceRequest
   */
  public static PutDatabasesMySQLInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDatabasesMySQLInstanceRequest.class);
  }

  /**
   * Convert an instance of PutDatabasesMySQLInstanceRequest to an JSON string
   *
   * @return JSON string
   */
