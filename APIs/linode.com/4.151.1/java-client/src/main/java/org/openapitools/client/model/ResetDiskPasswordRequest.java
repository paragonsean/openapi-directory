...
public class ResetDiskPasswordRequest {
  public static final String SERIALIZED_NAME_PASSWORD = "password";
  @SerializedName(SERIALIZED_NAME_PASSWORD)
  private String password;

  public ResetDiskPasswordRequest() {
  }

  public ResetDiskPasswordRequest password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    ResetDiskPasswordRequest resetDiskPasswordRequest = (ResetDiskPasswordRequest) o;
    return Objects.equals(this.password, resetDiskPasswordRequest.password);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResetDiskPasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResetDiskPasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetDiskPasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResetDiskPasswordRequest is not found in the empty JSON string", ResetDiskPasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResetDiskPasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResetDiskPasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResetDiskPasswordRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResetDiskPasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResetDiskPasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResetDiskPasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResetDiskPasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ResetDiskPasswordRequest>() {
           @Override
           public void write(JsonWriter out, ResetDiskPasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResetDiskPasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResetDiskPasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResetDiskPasswordRequest
   * @throws IOException if the JSON string is invalid with respect to ResetDiskPasswordRequest
   */
  public static ResetDiskPasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResetDiskPasswordRequest.class);
  }

  /**
   * Convert an instance of ResetDiskPasswordRequest to an JSON string
   *
   * @return JSON string
   */
