...
import org.openapitools.client.model.GetLKEClusterAPIEndpoints200ResponseDataInner;
...
public class GetLKEClusterAPIEndpoints200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<GetLKEClusterAPIEndpoints200ResponseDataInner> data = new ArrayList<>();
  ...
  public GetLKEClusterAPIEndpoints200Response() {
  }
  ...
  public GetLKEClusterAPIEndpoints200Response data(List<GetLKEClusterAPIEndpoints200ResponseDataInner> data) {
    this.data = data;
    return this;
  }

  public GetLKEClusterAPIEndpoints200Response addDataItem(GetLKEClusterAPIEndpoints200ResponseDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<GetLKEClusterAPIEndpoints200ResponseDataInner> getData() {
    return data;
  }

  public void setData(List<GetLKEClusterAPIEndpoints200ResponseDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterAPIEndpoints200Response getLKEClusterAPIEndpoints200Response = (GetLKEClusterAPIEndpoints200Response) o;
    return Objects.equals(this.data, getLKEClusterAPIEndpoints200Response.data) &&
        Objects.equals(this.page, getLKEClusterAPIEndpoints200Response.page) &&
        Objects.equals(this.pages, getLKEClusterAPIEndpoints200Response.pages) &&
        Objects.equals(this.results, getLKEClusterAPIEndpoints200Response.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, page, pages, results);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLKEClusterAPIEndpoints200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterAPIEndpoints200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterAPIEndpoints200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterAPIEndpoints200Response is not found in the empty JSON string", GetLKEClusterAPIEndpoints200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterAPIEndpoints200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterAPIEndpoints200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            GetLKEClusterAPIEndpoints200ResponseDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterAPIEndpoints200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterAPIEndpoints200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterAPIEndpoints200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterAPIEndpoints200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterAPIEndpoints200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterAPIEndpoints200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterAPIEndpoints200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterAPIEndpoints200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterAPIEndpoints200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterAPIEndpoints200Response
   */
  public static GetLKEClusterAPIEndpoints200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterAPIEndpoints200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusterAPIEndpoints200Response to an JSON string
   *
   * @return JSON string
   */
