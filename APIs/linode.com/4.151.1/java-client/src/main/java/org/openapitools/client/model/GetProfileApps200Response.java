...
public class GetProfileApps200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<AuthorizedApp> data = new ArrayList<>();
  ...
  public GetProfileApps200Response() {
  }
  ...
  public GetProfileApps200Response data(List<AuthorizedApp> data) {
    this.data = data;
    return this;
  }

  public GetProfileApps200Response addDataItem(AuthorizedApp dataItem) {
    if (this.data == null) {
  ...
  public List<AuthorizedApp> getData() {
    return data;
  }

  public void setData(List<AuthorizedApp> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProfileApps200Response getProfileApps200Response = (GetProfileApps200Response) o;
    return Objects.equals(this.data, getProfileApps200Response.data) &&
        Objects.equals(this.page, getProfileApps200Response.page) &&
        Objects.equals(this.pages, getProfileApps200Response.pages) &&
        Objects.equals(this.results, getProfileApps200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProfileApps200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProfileApps200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProfileApps200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProfileApps200Response is not found in the empty JSON string", GetProfileApps200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProfileApps200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProfileApps200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            AuthorizedApp.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProfileApps200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProfileApps200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProfileApps200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProfileApps200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProfileApps200Response>() {
           @Override
           public void write(JsonWriter out, GetProfileApps200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProfileApps200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProfileApps200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProfileApps200Response
   * @throws IOException if the JSON string is invalid with respect to GetProfileApps200Response
   */
  public static GetProfileApps200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProfileApps200Response.class);
  }

  /**
   * Convert an instance of GetProfileApps200Response to an JSON string
   *
   * @return JSON string
   */
