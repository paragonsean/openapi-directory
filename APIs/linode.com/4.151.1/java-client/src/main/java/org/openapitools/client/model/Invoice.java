...
import org.openapitools.client.model.InvoiceTaxSummaryInner;
...
public class Invoice {
  ...
  public static final String SERIALIZED_NAME_TAX_SUMMARY = "tax_summary";
  @SerializedName(SERIALIZED_NAME_TAX_SUMMARY)
  private List<InvoiceTaxSummaryInner> taxSummary = new ArrayList<>();
  ...
  public Invoice(
     ...
     BigDecimal subtotal, 
     BigDecimal tax, 
     List<InvoiceTaxSummaryInner> taxSummary, 
     BigDecimal total
  ) {
    this();
    this.date = date;
   ...
   */
  @javax.annotation.Nullable
  public List<InvoiceTaxSummaryInner> getTaxSummary() {
    return taxSummary;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, invoice.date) &&
        ...
        Objects.equals(this.taxSummary, invoice.taxSummary) &&
        Objects.equals(this.total, invoice.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, id, label, subtotal, tax, taxSummary, total);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("tax_summary") != null && !jsonObj.get("tax_summary").isJsonNull()) {
        JsonArray jsonArraytaxSummary = jsonObj.getAsJsonArray("tax_summary");
        if (jsonArraytaxSummary != null) {
          // ensure the json data is an array
          if (!jsonObj.get("tax_summary").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `tax_summary` to be an array in the JSON string but got `%s`", jsonObj.get("tax_summary").toString()));
          }

          // validate the optional field `tax_summary` (array)
          for (int i = 0; i < jsonArraytaxSummary.size(); i++) {
            InvoiceTaxSummaryInner.validateJsonElement(jsonArraytaxSummary.get(i));
          };
        }
      }
  }
