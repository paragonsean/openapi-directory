...
public class CreateEntityTransferRequest {
  public static final String SERIALIZED_NAME_ENTITIES = "entities";
  @SerializedName(SERIALIZED_NAME_ENTITIES)
  private EntityTransferEntities entities;

  public CreateEntityTransferRequest() {
  }

  public CreateEntityTransferRequest entities(EntityTransferEntities entities) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEntityTransferRequest createEntityTransferRequest = (CreateEntityTransferRequest) o;
    return Objects.equals(this.entities, createEntityTransferRequest.entities);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEntityTransferRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEntityTransferRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEntityTransferRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEntityTransferRequest is not found in the empty JSON string", CreateEntityTransferRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEntityTransferRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEntityTransferRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateEntityTransferRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEntityTransferRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEntityTransferRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEntityTransferRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEntityTransferRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEntityTransferRequest>() {
           @Override
           public void write(JsonWriter out, CreateEntityTransferRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEntityTransferRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEntityTransferRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEntityTransferRequest
   * @throws IOException if the JSON string is invalid with respect to CreateEntityTransferRequest
   */
  public static CreateEntityTransferRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEntityTransferRequest.class);
  }

  /**
   * Convert an instance of CreateEntityTransferRequest to an JSON string
   *
   * @return JSON string
   */
