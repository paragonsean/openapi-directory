...
public class Notification {
  ...
  public Notification entity(NotificationEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.body, notification.body) &&
        ...
        Objects.equals(this.until, notification.until) &&
        Objects.equals(this.when, notification.when);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(body, entity, label, message, severity, type, until, when);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        NotificationEntity.validateJsonElement(jsonObj.get("entity"));
      }
