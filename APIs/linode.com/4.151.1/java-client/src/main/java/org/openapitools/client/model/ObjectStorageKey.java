...
import org.openapitools.client.model.ObjectStorageKeyBucketAccessInner;
...
public class ObjectStorageKey {
  ...
  public static final String SERIALIZED_NAME_BUCKET_ACCESS = "bucket_access";
  @SerializedName(SERIALIZED_NAME_BUCKET_ACCESS)
  private List<ObjectStorageKeyBucketAccessInner> bucketAccess = new ArrayList<>();
  ...
  public ObjectStorageKey bucketAccess(List<ObjectStorageKeyBucketAccessInner> bucketAccess) {
    this.bucketAccess = bucketAccess;
    return this;
  }

  public ObjectStorageKey addBucketAccessItem(ObjectStorageKeyBucketAccessInner bucketAccessItem) {
    if (this.bucketAccess == null) {
      this.bucketAccess = new ArrayList<>();
    }
    this.bucketAccess.add(bucketAccessItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<ObjectStorageKeyBucketAccessInner> getBucketAccess() {
    return bucketAccess;
  }

  public void setBucketAccess(List<ObjectStorageKeyBucketAccessInner> bucketAccess) {
    this.bucketAccess = bucketAccess;
  }
  ...
  public ObjectStorageKey label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, objectStorageKey.accessKey) &&
        Objects.equals(this.bucketAccess, objectStorageKey.bucketAccess) &&
        Objects.equals(this.id, objectStorageKey.id) &&
        Objects.equals(this.label, objectStorageKey.label) &&
        Objects.equals(this.limited, objectStorageKey.limited) &&
        Objects.equals(this.secretKey, objectStorageKey.secretKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessKey, bucketAccess, id, label, limited, secretKey);
  }
  ...
  public String toString() {
    ...
    sb.append("    bucketAccess: ").append(toIndentedString(bucketAccess)).append("\n");
  ...
  static {
    ...
    openapiFields.add("bucket_access");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageKey is not found in the empty JSON string", ObjectStorageKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bucket_access") != null && !jsonObj.get("bucket_access").isJsonNull()) {
        JsonArray jsonArraybucketAccess = jsonObj.getAsJsonArray("bucket_access");
        if (jsonArraybucketAccess != null) {
          // ensure the json data is an array
          if (!jsonObj.get("bucket_access").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `bucket_access` to be an array in the JSON string but got `%s`", jsonObj.get("bucket_access").toString()));
          }

          // validate the optional field `bucket_access` (array)
          for (int i = 0; i < jsonArraybucketAccess.size(); i++) {
            ObjectStorageKeyBucketAccessInner.validateJsonElement(jsonArraybucketAccess.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageKey.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageKey>() {
           @Override
           public void write(JsonWriter out, ObjectStorageKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageKey
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageKey
   */
  public static ObjectStorageKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageKey.class);
  }

  /**
   * Convert an instance of ObjectStorageKey to an JSON string
   *
   * @return JSON string
   */
