...
public class UpdateObjectStorageKeyRequest {
  public static final String SERIALIZED_NAME_LABEL = "label";
  @SerializedName(SERIALIZED_NAME_LABEL)
  private String label;

  public UpdateObjectStorageKeyRequest() {
  }

  public UpdateObjectStorageKeyRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateObjectStorageKeyRequest updateObjectStorageKeyRequest = (UpdateObjectStorageKeyRequest) o;
    return Objects.equals(this.label, updateObjectStorageKeyRequest.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateObjectStorageKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateObjectStorageKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateObjectStorageKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateObjectStorageKeyRequest is not found in the empty JSON string", UpdateObjectStorageKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateObjectStorageKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateObjectStorageKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateObjectStorageKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateObjectStorageKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateObjectStorageKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateObjectStorageKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateObjectStorageKeyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateObjectStorageKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateObjectStorageKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateObjectStorageKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateObjectStorageKeyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateObjectStorageKeyRequest
   */
  public static UpdateObjectStorageKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateObjectStorageKeyRequest.class);
  }

  /**
   * Convert an instance of UpdateObjectStorageKeyRequest to an JSON string
   *
   * @return JSON string
   */
