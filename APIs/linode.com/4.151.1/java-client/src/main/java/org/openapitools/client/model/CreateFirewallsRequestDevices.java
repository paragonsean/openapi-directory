...
public class CreateFirewallsRequestDevices {
  public static final String SERIALIZED_NAME_LINODES = "linodes";
  @SerializedName(SERIALIZED_NAME_LINODES)
  private List<Integer> linodes = new ArrayList<>();

  public CreateFirewallsRequestDevices() {
  }

  public CreateFirewallsRequestDevices linodes(List<Integer> linodes) {
    this.linodes = linodes;
    return this;
  }

  public CreateFirewallsRequestDevices addLinodesItem(Integer linodesItem) {
    if (this.linodes == null) {
      this.linodes = new ArrayList<>();
    }
    this.linodes.add(linodesItem);
    return this;
  }
  ...
  public List<Integer> getLinodes() {
    return linodes;
  }

  public void setLinodes(List<Integer> linodes) {
    this.linodes = linodes;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallsRequestDevices createFirewallsRequestDevices = (CreateFirewallsRequestDevices) o;
    return Objects.equals(this.linodes, createFirewallsRequestDevices.linodes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(linodes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFirewallsRequestDevices {\n");
    sb.append("    linodes: ").append(toIndentedString(linodes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallsRequestDevices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallsRequestDevices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallsRequestDevices is not found in the empty JSON string", CreateFirewallsRequestDevices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallsRequestDevices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallsRequestDevices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("linodes") != null && !jsonObj.get("linodes").isJsonNull() && !jsonObj.get("linodes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `linodes` to be an array in the JSON string but got `%s`", jsonObj.get("linodes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallsRequestDevices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallsRequestDevices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallsRequestDevices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallsRequestDevices.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallsRequestDevices>() {
           @Override
           public void write(JsonWriter out, CreateFirewallsRequestDevices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallsRequestDevices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallsRequestDevices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallsRequestDevices
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallsRequestDevices
   */
  public static CreateFirewallsRequestDevices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallsRequestDevices.class);
  }

  /**
   * Convert an instance of CreateFirewallsRequestDevices to an JSON string
   *
   * @return JSON string
   */
