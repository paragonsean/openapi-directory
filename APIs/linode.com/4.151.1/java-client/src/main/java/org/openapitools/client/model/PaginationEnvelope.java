...
public class PaginationEnvelope {
  ...
  public boolean equals(Object o) {
    ...
    PaginationEnvelope paginationEnvelope = (PaginationEnvelope) o;
    return Objects.equals(this.page, paginationEnvelope.page) &&
        Objects.equals(this.pages, paginationEnvelope.pages) &&
        Objects.equals(this.results, paginationEnvelope.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(page, pages, results);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaginationEnvelope {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaginationEnvelope
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginationEnvelope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginationEnvelope is not found in the empty JSON string", PaginationEnvelope.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaginationEnvelope.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginationEnvelope` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginationEnvelope.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginationEnvelope' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginationEnvelope> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginationEnvelope.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginationEnvelope>() {
           @Override
           public void write(JsonWriter out, PaginationEnvelope value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginationEnvelope read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaginationEnvelope given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaginationEnvelope
   * @throws IOException if the JSON string is invalid with respect to PaginationEnvelope
   */
  public static PaginationEnvelope fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginationEnvelope.class);
  }

  /**
   * Convert an instance of PaginationEnvelope to an JSON string
   *
   * @return JSON string
   */
