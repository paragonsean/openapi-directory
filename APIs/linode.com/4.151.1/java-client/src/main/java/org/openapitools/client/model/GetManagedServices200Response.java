...
public class GetManagedServices200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ManagedService> data = new ArrayList<>();
  ...
  public GetManagedServices200Response() {
  }
  ...
  public GetManagedServices200Response data(List<ManagedService> data) {
    this.data = data;
    return this;
  }

  public GetManagedServices200Response addDataItem(ManagedService dataItem) {
    if (this.data == null) {
  ...
  public List<ManagedService> getData() {
    return data;
  }

  public void setData(List<ManagedService> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedServices200Response getManagedServices200Response = (GetManagedServices200Response) o;
    return Objects.equals(this.data, getManagedServices200Response.data) &&
        Objects.equals(this.page, getManagedServices200Response.page) &&
        Objects.equals(this.pages, getManagedServices200Response.pages) &&
        Objects.equals(this.results, getManagedServices200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedServices200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedServices200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedServices200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedServices200Response is not found in the empty JSON string", GetManagedServices200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedServices200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedServices200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ManagedService.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedServices200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedServices200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedServices200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedServices200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedServices200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedServices200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedServices200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedServices200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedServices200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedServices200Response
   */
  public static GetManagedServices200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedServices200Response.class);
  }

  /**
   * Convert an instance of GetManagedServices200Response to an JSON string
   *
   * @return JSON string
   */
