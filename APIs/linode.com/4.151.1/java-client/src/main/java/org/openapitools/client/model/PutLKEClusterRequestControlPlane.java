...
public class PutLKEClusterRequestControlPlane {
  ...
  public PutLKEClusterRequestControlPlane() {
  }

  public PutLKEClusterRequestControlPlane highAvailability(Boolean highAvailability) {
  ...
  public boolean equals(Object o) {
    ...
    PutLKEClusterRequestControlPlane putLKEClusterRequestControlPlane = (PutLKEClusterRequestControlPlane) o;
    return Objects.equals(this.highAvailability, putLKEClusterRequestControlPlane.highAvailability);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutLKEClusterRequestControlPlane {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutLKEClusterRequestControlPlane
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutLKEClusterRequestControlPlane.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutLKEClusterRequestControlPlane is not found in the empty JSON string", PutLKEClusterRequestControlPlane.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutLKEClusterRequestControlPlane.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutLKEClusterRequestControlPlane` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutLKEClusterRequestControlPlane.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutLKEClusterRequestControlPlane' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutLKEClusterRequestControlPlane> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutLKEClusterRequestControlPlane.class));

       return (TypeAdapter<T>) new TypeAdapter<PutLKEClusterRequestControlPlane>() {
           @Override
           public void write(JsonWriter out, PutLKEClusterRequestControlPlane value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutLKEClusterRequestControlPlane read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutLKEClusterRequestControlPlane given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutLKEClusterRequestControlPlane
   * @throws IOException if the JSON string is invalid with respect to PutLKEClusterRequestControlPlane
   */
  public static PutLKEClusterRequestControlPlane fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutLKEClusterRequestControlPlane.class);
  }

  /**
   * Convert an instance of PutLKEClusterRequestControlPlane to an JSON string
   *
   * @return JSON string
   */
