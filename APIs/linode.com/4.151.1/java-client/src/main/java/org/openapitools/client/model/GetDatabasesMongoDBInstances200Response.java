...
public class GetDatabasesMongoDBInstances200Response {
  ...
  private List<DatabaseMongoDB> data = new ArrayList<>();

  public GetDatabasesMongoDBInstances200Response() {
  }
  ...
  public GetDatabasesMongoDBInstances200Response data(List<DatabaseMongoDB> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesMongoDBInstances200Response addDataItem(DatabaseMongoDB dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseMongoDB> getData() {
    return data;
  }

  public void setData(List<DatabaseMongoDB> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesMongoDBInstances200Response getDatabasesMongoDBInstances200Response = (GetDatabasesMongoDBInstances200Response) o;
    return Objects.equals(this.page, getDatabasesMongoDBInstances200Response.page) &&
        Objects.equals(this.pages, getDatabasesMongoDBInstances200Response.pages) &&
        Objects.equals(this.results, getDatabasesMongoDBInstances200Response.results) &&
        Objects.equals(this.data, getDatabasesMongoDBInstances200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesMongoDBInstances200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesMongoDBInstances200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesMongoDBInstances200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesMongoDBInstances200Response is not found in the empty JSON string", GetDatabasesMongoDBInstances200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesMongoDBInstances200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesMongoDBInstances200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabaseMongoDB.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesMongoDBInstances200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesMongoDBInstances200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesMongoDBInstances200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesMongoDBInstances200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesMongoDBInstances200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesMongoDBInstances200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesMongoDBInstances200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesMongoDBInstances200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesMongoDBInstances200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesMongoDBInstances200Response
   */
  public static GetDatabasesMongoDBInstances200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesMongoDBInstances200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesMongoDBInstances200Response to an JSON string
   *
   * @return JSON string
   */
