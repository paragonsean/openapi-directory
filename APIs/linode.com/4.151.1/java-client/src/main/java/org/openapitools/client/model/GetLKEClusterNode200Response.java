...
public class GetLKEClusterNode200Response {
  ...
  public GetLKEClusterNode200Response() {
  }
  ...
  public GetLKEClusterNode200Response instanceId(Integer instanceId) {
  ...
  public GetLKEClusterNode200Response status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterNode200Response getLKEClusterNode200Response = (GetLKEClusterNode200Response) o;
    return Objects.equals(this.id, getLKEClusterNode200Response.id) &&
        Objects.equals(this.instanceId, getLKEClusterNode200Response.instanceId) &&
        Objects.equals(this.status, getLKEClusterNode200Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusterNode200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterNode200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterNode200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterNode200Response is not found in the empty JSON string", GetLKEClusterNode200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterNode200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterNode200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterNode200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterNode200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterNode200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterNode200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterNode200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterNode200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterNode200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterNode200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterNode200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterNode200Response
   */
  public static GetLKEClusterNode200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterNode200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusterNode200Response to an JSON string
   *
   * @return JSON string
   */
