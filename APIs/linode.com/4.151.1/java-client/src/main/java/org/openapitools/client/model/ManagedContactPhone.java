...
public class ManagedContactPhone {
  ...
  public ManagedContactPhone() {
  }

  public ManagedContactPhone primary(String primary) {
  ...
  public ManagedContactPhone secondary(String secondary) {
  ...
  public boolean equals(Object o) {
    ...
    ManagedContactPhone managedContactPhone = (ManagedContactPhone) o;
    return Objects.equals(this.primary, managedContactPhone.primary) &&
        Objects.equals(this.secondary, managedContactPhone.secondary);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagedContactPhone {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedContactPhone
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedContactPhone.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedContactPhone is not found in the empty JSON string", ManagedContactPhone.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedContactPhone.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedContactPhone` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedContactPhone.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedContactPhone' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedContactPhone> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedContactPhone.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedContactPhone>() {
           @Override
           public void write(JsonWriter out, ManagedContactPhone value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedContactPhone read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedContactPhone given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedContactPhone
   * @throws IOException if the JSON string is invalid with respect to ManagedContactPhone
   */
  public static ManagedContactPhone fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedContactPhone.class);
  }

  /**
   * Convert an instance of ManagedContactPhone to an JSON string
   *
   * @return JSON string
   */
