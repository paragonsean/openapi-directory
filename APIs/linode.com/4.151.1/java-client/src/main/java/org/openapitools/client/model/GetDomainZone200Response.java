...
public class GetDomainZone200Response {
  public static final String SERIALIZED_NAME_ZONE_FILE = "zone_file";
  @SerializedName(SERIALIZED_NAME_ZONE_FILE)
  private List<String> zoneFile = new ArrayList<>();

  public GetDomainZone200Response() {
  }

  public GetDomainZone200Response zoneFile(List<String> zoneFile) {
    this.zoneFile = zoneFile;
    return this;
  }

  public GetDomainZone200Response addZoneFileItem(String zoneFileItem) {
    if (this.zoneFile == null) {
      this.zoneFile = new ArrayList<>();
    }
    this.zoneFile.add(zoneFileItem);
    return this;
  }
  ...
  public List<String> getZoneFile() {
    return zoneFile;
  }

  public void setZoneFile(List<String> zoneFile) {
    this.zoneFile = zoneFile;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainZone200Response getDomainZone200Response = (GetDomainZone200Response) o;
    return Objects.equals(this.zoneFile, getDomainZone200Response.zoneFile);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDomainZone200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainZone200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainZone200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDomainZone200Response is not found in the empty JSON string", GetDomainZone200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainZone200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDomainZone200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("zone_file") != null && !jsonObj.get("zone_file").isJsonNull() && !jsonObj.get("zone_file").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `zone_file` to be an array in the JSON string but got `%s`", jsonObj.get("zone_file").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainZone200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainZone200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainZone200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainZone200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainZone200Response>() {
           @Override
           public void write(JsonWriter out, GetDomainZone200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainZone200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainZone200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainZone200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomainZone200Response
   */
  public static GetDomainZone200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainZone200Response.class);
  }

  /**
   * Convert an instance of GetDomainZone200Response to an JSON string
   *
   * @return JSON string
   */
