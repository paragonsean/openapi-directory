...
import org.openapitools.client.model.GetTaggedObjects200Response;
...
public class TagsApi {
     ...
     * @param createTagRequest The tag to create, and optionally the objects to tag.  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The new Tag. </td><td>  -  </td></tr>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Tag deleted. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteTagCall(String label, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/tags/{label}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTagValidateBeforeCall(String label, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'label' is set
        if (label == null) {
            throw new ApiException("Missing the required parameter 'label' when calling deleteTag(Async)");
        }

        return deleteTagCall(label, _callback);
     ...
     */
    public Object deleteTag(String label) throws ApiException {
        ApiResponse<Object> localVarResp = deleteTagWithHttpInfo(label);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteTagWithHttpInfo(String label) throws ApiException {
        okhttp3.Call localVarCall = deleteTagValidateBeforeCall(label, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Tag Delete (asynchronously)
     * Remove a Tag from all objects and delete it.  **Important**: You must be an unrestricted User in order to add or modify Tags. 
     * @param label  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteTagAsync(String label, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteTagValidateBeforeCall(label, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getTaggedObjects
     * @param label  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A paginated list of objects, organized by type, that have been tagged with the requested Tag.  </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTaggedObjectsCall(String label, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTaggedObjectsValidateBeforeCall(String label, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'label' is set
        if (label == null) {
            throw new ApiException("Missing the required parameter 'label' when calling getTaggedObjects(Async)");
        }

        return getTaggedObjectsCall(label, page, pageSize, _callback);
     ...
     */
    public GetTaggedObjects200Response getTaggedObjects(String label, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetTaggedObjects200Response> localVarResp = getTaggedObjectsWithHttpInfo(label, page, pageSize);
        return localVarResp.getData();
    }
     ...
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @return ApiResponse&lt;GetTaggedObjects200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetTaggedObjects200Response> getTaggedObjectsWithHttpInfo(String label, Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getTaggedObjectsValidateBeforeCall(label, page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetTaggedObjects200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Tagged Objects List (asynchronously)
     * Returns a paginated list of all objects you&#39;ve tagged with the requested Tag. This is a mixed collection of all object types. 
     * @param label  (required)
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     ...
     */
    public okhttp3.Call getTaggedObjectsAsync(String label, Integer page, Integer pageSize, final ApiCallback<GetTaggedObjects200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTaggedObjectsValidateBeforeCall(label, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetTaggedObjects200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A paginated list of Tags </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getTagsCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTagsValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return getTagsCall(page, pageSize, _callback);
     ...
     */
    public GetTags200Response getTags(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetTags200Response> localVarResp = getTagsWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetTags200Response> getTagsWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getTagsValidateBeforeCall(page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetTags200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Tags List (asynchronously)
     * Tags are User-defined labels attached to objects in your Account, such as Linodes. They are used for specifying and grouping attributes of objects that are relevant to the User.  This endpoint returns a paginated list of Tags on your account. 
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getTagsAsync(Integer page, Integer pageSize, final ApiCallback<GetTags200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTagsValidateBeforeCall(page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetTags200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
