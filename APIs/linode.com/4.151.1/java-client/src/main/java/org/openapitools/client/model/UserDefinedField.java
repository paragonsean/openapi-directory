...
public class UserDefinedField {
  ...
  public static final String SERIALIZED_NAME_MANY_OF = "manyOf";
  @SerializedName(SERIALIZED_NAME_MANY_OF)
  ...
  public boolean equals(Object o) {
    ...
    UserDefinedField userDefinedField = (UserDefinedField) o;
    return Objects.equals(this._default, userDefinedField._default) &&
        Objects.equals(this.example, userDefinedField.example) &&
        Objects.equals(this.label, userDefinedField.label) &&
        Objects.equals(this.manyOf, userDefinedField.manyOf) &&
        Objects.equals(this.name, userDefinedField.name) &&
        Objects.equals(this.oneOf, userDefinedField.oneOf);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_default, example, label, manyOf, name, oneOf);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserDefinedField {\n");
    sb.append("    _default: ").append(toIndentedString(_default)).append("\n");
    sb.append("    example: ").append(toIndentedString(example)).append("\n");
    sb.append("    label: ").append(toIndentedString(label)).append("\n");
    sb.append("    manyOf: ").append(toIndentedString(manyOf)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserDefinedField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserDefinedField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDefinedField is not found in the empty JSON string", UserDefinedField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserDefinedField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserDefinedField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserDefinedField.openapiRequiredFields) {
      ...
      if ((jsonObj.get("manyOf") != null && !jsonObj.get("manyOf").isJsonNull()) && !jsonObj.get("manyOf").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `manyOf` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manyOf").toString()));
      }
      if (!jsonObj.get("name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("name").toString()));
      }
      if ((jsonObj.get("oneOf") != null && !jsonObj.get("oneOf").isJsonNull()) && !jsonObj.get("oneOf").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `oneOf` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oneOf").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDefinedField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDefinedField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDefinedField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDefinedField.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDefinedField>() {
           @Override
           public void write(JsonWriter out, UserDefinedField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDefinedField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserDefinedField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserDefinedField
   * @throws IOException if the JSON string is invalid with respect to UserDefinedField
   */
  public static UserDefinedField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDefinedField.class);
  }

  /**
   * Convert an instance of UserDefinedField to an JSON string
   *
   * @return JSON string
   */
