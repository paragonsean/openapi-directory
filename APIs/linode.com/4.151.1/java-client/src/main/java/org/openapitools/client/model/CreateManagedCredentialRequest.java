...
public class CreateManagedCredentialRequest {
  ...
  public static final String SERIALIZED_NAME_LAST_DECRYPTED = "last_decrypted";
  @SerializedName(SERIALIZED_NAME_LAST_DECRYPTED)
  private OffsetDateTime lastDecrypted;
  ...
  public CreateManagedCredentialRequest() {
  }

  public CreateManagedCredentialRequest(
     Integer id, 
     OffsetDateTime lastDecrypted
  ) {
    this();
    this.id = id;
    this.lastDecrypted = lastDecrypted;
  }
  ...
  public CreateManagedCredentialRequest label(String label) {
    this.label = label;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getLastDecrypted() {
    return lastDecrypted;
  }



  public CreateManagedCredentialRequest password(String password) {
  ...
  public CreateManagedCredentialRequest username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    CreateManagedCredentialRequest createManagedCredentialRequest = (CreateManagedCredentialRequest) o;
    return Objects.equals(this.id, createManagedCredentialRequest.id) &&
        Objects.equals(this.label, createManagedCredentialRequest.label) &&
        Objects.equals(this.lastDecrypted, createManagedCredentialRequest.lastDecrypted) &&
        Objects.equals(this.password, createManagedCredentialRequest.password) &&
        Objects.equals(this.username, createManagedCredentialRequest.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, label, lastDecrypted, password, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateManagedCredentialRequest {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    label: ").append(toIndentedString(label)).append("\n");
    sb.append("    lastDecrypted: ").append(toIndentedString(lastDecrypted)).append("\n");
  ...
  static {
    ...
    openapiFields.add("last_decrypted");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateManagedCredentialRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateManagedCredentialRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateManagedCredentialRequest is not found in the empty JSON string", CreateManagedCredentialRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateManagedCredentialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateManagedCredentialRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateManagedCredentialRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateManagedCredentialRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateManagedCredentialRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateManagedCredentialRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateManagedCredentialRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateManagedCredentialRequest>() {
           @Override
           public void write(JsonWriter out, CreateManagedCredentialRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateManagedCredentialRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateManagedCredentialRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateManagedCredentialRequest
   * @throws IOException if the JSON string is invalid with respect to CreateManagedCredentialRequest
   */
  public static CreateManagedCredentialRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateManagedCredentialRequest.class);
  }

  /**
   * Convert an instance of CreateManagedCredentialRequest to an JSON string
   *
   * @return JSON string
   */
