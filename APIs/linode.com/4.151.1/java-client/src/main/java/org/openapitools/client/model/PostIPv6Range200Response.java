...
public class PostIPv6Range200Response {
  public static final String SERIALIZED_NAME_RANGE = "range";
  @SerializedName(SERIALIZED_NAME_RANGE)
  private String range;

  public static final String SERIALIZED_NAME_ROUTE_TARGET = "route_target";
  @SerializedName(SERIALIZED_NAME_ROUTE_TARGET)
  private String routeTarget;

  public PostIPv6Range200Response() {
  }

  public PostIPv6Range200Response range(String range) {
    this.range = range;
    return this;
  }
  ...
  public PostIPv6Range200Response routeTarget(String routeTarget) {
  ...
  public boolean equals(Object o) {
    ...
    PostIPv6Range200Response postIPv6Range200Response = (PostIPv6Range200Response) o;
    return Objects.equals(this.range, postIPv6Range200Response.range) &&
        Objects.equals(this.routeTarget, postIPv6Range200Response.routeTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(range, routeTarget);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostIPv6Range200Response {\n");
    sb.append("    range: ").append(toIndentedString(range)).append("\n");
    sb.append("    routeTarget: ").append(toIndentedString(routeTarget)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("route_target");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostIPv6Range200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostIPv6Range200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostIPv6Range200Response is not found in the empty JSON string", PostIPv6Range200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostIPv6Range200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostIPv6Range200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("route_target") != null && !jsonObj.get("route_target").isJsonNull()) && !jsonObj.get("route_target").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `route_target` to be a primitive type in the JSON string but got `%s`", jsonObj.get("route_target").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostIPv6Range200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostIPv6Range200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostIPv6Range200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostIPv6Range200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostIPv6Range200Response>() {
           @Override
           public void write(JsonWriter out, PostIPv6Range200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostIPv6Range200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostIPv6Range200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostIPv6Range200Response
   * @throws IOException if the JSON string is invalid with respect to PostIPv6Range200Response
   */
  public static PostIPv6Range200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostIPv6Range200Response.class);
  }

  /**
   * Convert an instance of PostIPv6Range200Response to an JSON string
   *
   * @return JSON string
   */
