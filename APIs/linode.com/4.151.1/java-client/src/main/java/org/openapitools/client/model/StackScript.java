...
import org.openapitools.client.model.UserDefinedField;
...
public class StackScript {
  ...
  public static final String SERIALIZED_NAME_DEPLOYMENTS_ACTIVE = "deployments_active";
  @SerializedName(SERIALIZED_NAME_DEPLOYMENTS_ACTIVE)
  private Integer deploymentsActive;

  public static final String SERIALIZED_NAME_DEPLOYMENTS_TOTAL = "deployments_total";
  @SerializedName(SERIALIZED_NAME_DEPLOYMENTS_TOTAL)
  ...
  public static final String SERIALIZED_NAME_REV_NOTE = "rev_note";
  @SerializedName(SERIALIZED_NAME_REV_NOTE)
  ...
  public static final String SERIALIZED_NAME_USER_DEFINED_FIELDS = "user_defined_fields";
  @SerializedName(SERIALIZED_NAME_USER_DEFINED_FIELDS)
  private List<UserDefinedField> userDefinedFields = new ArrayList<>();

  public static final String SERIALIZED_NAME_USER_GRAVATAR_ID = "user_gravatar_id";
  @SerializedName(SERIALIZED_NAME_USER_GRAVATAR_ID)
  ...
  public StackScript(
     ...
     Integer deploymentsActive, 
     Integer deploymentsTotal, 
     Integer id, 
     Boolean mine, 
  ...
  public StackScript description(String description) {
  ...
  public StackScript images(List<String> images) {
    this.images = images;
    return this;
  }

  public StackScript addImagesItem(String imagesItem) {
    if (this.images == null) {
  ...
  public StackScript isPublic(Boolean isPublic) {
  ...
  public StackScript label(String label) {
    this.label = label;
    return this;
  }
  ...
  public StackScript revNote(String revNote) {
  ...
  public StackScript script(String script) {
    this.script = script;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StackScript stackScript = (StackScript) o;
    return Objects.equals(this.created, stackScript.created) &&
        Objects.equals(this.deploymentsActive, stackScript.deploymentsActive) &&
        Objects.equals(this.deploymentsTotal, stackScript.deploymentsTotal) &&
        Objects.equals(this.description, stackScript.description) &&
        Objects.equals(this.id, stackScript.id) &&
        Objects.equals(this.images, stackScript.images) &&
        Objects.equals(this.isPublic, stackScript.isPublic) &&
        Objects.equals(this.label, stackScript.label) &&
        Objects.equals(this.mine, stackScript.mine) &&
        Objects.equals(this.revNote, stackScript.revNote) &&
        Objects.equals(this.script, stackScript.script) &&
        Objects.equals(this.updated, stackScript.updated) &&
        Objects.equals(this.userDefinedFields, stackScript.userDefinedFields) &&
        Objects.equals(this.userGravatarId, stackScript.userGravatarId) &&
        Objects.equals(this.username, stackScript.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, deploymentsActive, deploymentsTotal, description, id, images, isPublic, label, mine, revNote, script, updated, userDefinedFields, userGravatarId, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StackScript {\n");
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    deploymentsActive: ").append(toIndentedString(deploymentsActive)).append("\n");
    sb.append("    deploymentsTotal: ").append(toIndentedString(deploymentsTotal)).append("\n");
    ...
    sb.append("    revNote: ").append(toIndentedString(revNote)).append("\n");
    sb.append("    script: ").append(toIndentedString(script)).append("\n");
    sb.append("    updated: ").append(toIndentedString(updated)).append("\n");
    sb.append("    userDefinedFields: ").append(toIndentedString(userDefinedFields)).append("\n");
    sb.append("    userGravatarId: ").append(toIndentedString(userGravatarId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("deployments_active");
    openapiFields.add("deployments_total");
    ...
    openapiFields.add("rev_note");
    openapiFields.add("script");
    openapiFields.add("updated");
    openapiFields.add("user_defined_fields");
    openapiFields.add("user_gravatar_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackScript
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackScript.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackScript is not found in the empty JSON string", StackScript.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackScript.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackScript` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("rev_note") != null && !jsonObj.get("rev_note").isJsonNull()) && !jsonObj.get("rev_note").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rev_note` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rev_note").toString()));
      }
      ...
      if (jsonObj.get("user_defined_fields") != null && !jsonObj.get("user_defined_fields").isJsonNull()) {
        JsonArray jsonArrayuserDefinedFields = jsonObj.getAsJsonArray("user_defined_fields");
        if (jsonArrayuserDefinedFields != null) {
          // ensure the json data is an array
          if (!jsonObj.get("user_defined_fields").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `user_defined_fields` to be an array in the JSON string but got `%s`", jsonObj.get("user_defined_fields").toString()));
          }

          // validate the optional field `user_defined_fields` (array)
          for (int i = 0; i < jsonArrayuserDefinedFields.size(); i++) {
            UserDefinedField.validateJsonElement(jsonArrayuserDefinedFields.get(i));
          };
        }
      }
      if ((jsonObj.get("user_gravatar_id") != null && !jsonObj.get("user_gravatar_id").isJsonNull()) && !jsonObj.get("user_gravatar_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `user_gravatar_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("user_gravatar_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackScript.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackScript' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackScript> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackScript.class));

       return (TypeAdapter<T>) new TypeAdapter<StackScript>() {
           @Override
           public void write(JsonWriter out, StackScript value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackScript read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackScript given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackScript
   * @throws IOException if the JSON string is invalid with respect to StackScript
   */
  public static StackScript fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackScript.class);
  }

  /**
   * Convert an instance of StackScript to an JSON string
   *
   * @return JSON string
   */
