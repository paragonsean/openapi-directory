...
public class DatabasePostgreSQLHosts {
  ...
  public DatabasePostgreSQLHosts() {
  }

  public DatabasePostgreSQLHosts primary(String primary) {
  ...
  public DatabasePostgreSQLHosts secondary(String secondary) {
  ...
  public boolean equals(Object o) {
    ...
    DatabasePostgreSQLHosts databasePostgreSQLHosts = (DatabasePostgreSQLHosts) o;
    return Objects.equals(this.primary, databasePostgreSQLHosts.primary) &&
        Objects.equals(this.secondary, databasePostgreSQLHosts.secondary);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabasePostgreSQLHosts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabasePostgreSQLHosts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabasePostgreSQLHosts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasePostgreSQLHosts is not found in the empty JSON string", DatabasePostgreSQLHosts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabasePostgreSQLHosts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabasePostgreSQLHosts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasePostgreSQLHosts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasePostgreSQLHosts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasePostgreSQLHosts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasePostgreSQLHosts.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasePostgreSQLHosts>() {
           @Override
           public void write(JsonWriter out, DatabasePostgreSQLHosts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabasePostgreSQLHosts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabasePostgreSQLHosts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabasePostgreSQLHosts
   * @throws IOException if the JSON string is invalid with respect to DatabasePostgreSQLHosts
   */
  public static DatabasePostgreSQLHosts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasePostgreSQLHosts.class);
  }

  /**
   * Convert an instance of DatabasePostgreSQLHosts to an JSON string
   *
   * @return JSON string
   */
