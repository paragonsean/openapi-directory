...
public class DatabaseHosts {
  ...
  public DatabaseHosts() {
  }

  public DatabaseHosts primary(String primary) {
  ...
  public DatabaseHosts secondary(String secondary) {
    this.secondary = secondary;
    return this;
  }

  /**
   * The secondary/private network host for the Managed Database.  A private network host and a private IP can only be used to access a Database Cluster from Linodes in the same data center and will not incur transfer costs.  **Note**: The secondary hostname is publicly viewable and accessible. 
   * @return secondary
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    DatabaseHosts databaseHosts = (DatabaseHosts) o;
    return Objects.equals(this.primary, databaseHosts.primary) &&
        Objects.equals(this.secondary, databaseHosts.secondary);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseHosts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseHosts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseHosts is not found in the empty JSON string", DatabaseHosts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseHosts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseHosts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseHosts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseHosts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseHosts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseHosts.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseHosts>() {
           @Override
           public void write(JsonWriter out, DatabaseHosts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseHosts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseHosts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseHosts
   * @throws IOException if the JSON string is invalid with respect to DatabaseHosts
   */
  public static DatabaseHosts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseHosts.class);
  }

  /**
   * Convert an instance of DatabaseHosts to an JSON string
   *
   * @return JSON string
   */
