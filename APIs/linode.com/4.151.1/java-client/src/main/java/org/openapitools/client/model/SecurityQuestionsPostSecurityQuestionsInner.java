...
public class SecurityQuestionsPostSecurityQuestionsInner {
  ...
  public static final String SERIALIZED_NAME_SECURITY_QUESTION = "security_question";
  @SerializedName(SERIALIZED_NAME_SECURITY_QUESTION)
  private String securityQuestion;

  public SecurityQuestionsPostSecurityQuestionsInner() {
  }
  ...
  public SecurityQuestionsPostSecurityQuestionsInner questionId(Integer questionId) {
  ...
  public SecurityQuestionsPostSecurityQuestionsInner response(String response) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityQuestionsPostSecurityQuestionsInner securityQuestionsPostSecurityQuestionsInner = (SecurityQuestionsPostSecurityQuestionsInner) o;
    return Objects.equals(this.questionId, securityQuestionsPostSecurityQuestionsInner.questionId) &&
        Objects.equals(this.response, securityQuestionsPostSecurityQuestionsInner.response) &&
        Objects.equals(this.securityQuestion, securityQuestionsPostSecurityQuestionsInner.securityQuestion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(questionId, response, securityQuestion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SecurityQuestionsPostSecurityQuestionsInner {\n");
  ...
  static {
    ...
    openapiFields.add("security_question");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityQuestionsPostSecurityQuestionsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityQuestionsPostSecurityQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityQuestionsPostSecurityQuestionsInner is not found in the empty JSON string", SecurityQuestionsPostSecurityQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityQuestionsPostSecurityQuestionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityQuestionsPostSecurityQuestionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("security_question") != null && !jsonObj.get("security_question").isJsonNull()) && !jsonObj.get("security_question").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `security_question` to be a primitive type in the JSON string but got `%s`", jsonObj.get("security_question").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecurityQuestionsPostSecurityQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecurityQuestionsPostSecurityQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecurityQuestionsPostSecurityQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecurityQuestionsPostSecurityQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SecurityQuestionsPostSecurityQuestionsInner>() {
           @Override
           public void write(JsonWriter out, SecurityQuestionsPostSecurityQuestionsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecurityQuestionsPostSecurityQuestionsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecurityQuestionsPostSecurityQuestionsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecurityQuestionsPostSecurityQuestionsInner
   * @throws IOException if the JSON string is invalid with respect to SecurityQuestionsPostSecurityQuestionsInner
   */
  public static SecurityQuestionsPostSecurityQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecurityQuestionsPostSecurityQuestionsInner.class);
  }

  /**
   * Convert an instance of SecurityQuestionsPostSecurityQuestionsInner to an JSON string
   *
   * @return JSON string
   */
