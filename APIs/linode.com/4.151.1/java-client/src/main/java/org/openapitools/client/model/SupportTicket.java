...
import org.openapitools.client.model.SupportTicketEntity;
...
public class SupportTicket {
  ...
  public static final String SERIALIZED_NAME_CLOSABLE = "closable";
  @SerializedName(SERIALIZED_NAME_CLOSABLE)
  ...
  private SupportTicketEntity entity;
  ...
  public static final String SERIALIZED_NAME_OPENED_BY = "opened_by";
  @SerializedName(SERIALIZED_NAME_OPENED_BY)
  ...
  public SupportTicket closable(Boolean closable) {
  ...
  public SupportTicket entity(SupportTicketEntity entity) {
    this.entity = entity;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SupportTicketEntity getEntity() {
    return entity;
  }

  public void setEntity(SupportTicketEntity entity) {
    this.entity = entity;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attachments, supportTicket.attachments) &&
        Objects.equals(this.closable, supportTicket.closable) &&
        Objects.equals(this.closed, supportTicket.closed) &&
        Objects.equals(this.description, supportTicket.description) &&
        Objects.equals(this.entity, supportTicket.entity) &&
        Objects.equals(this.gravatarId, supportTicket.gravatarId) &&
        Objects.equals(this.id, supportTicket.id) &&
        Objects.equals(this.opened, supportTicket.opened) &&
        Objects.equals(this.openedBy, supportTicket.openedBy) &&
        Objects.equals(this.status, supportTicket.status) &&
        Objects.equals(this.summary, supportTicket.summary) &&
        Objects.equals(this.updated, supportTicket.updated) &&
        Objects.equals(this.updatedBy, supportTicket.updatedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attachments, closable, closed, description, entity, gravatarId, id, opened, openedBy, status, summary, updated, updatedBy);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        SupportTicketEntity.validateJsonElement(jsonObj.get("entity"));
      }
      ...
      if ((jsonObj.get("opened_by") != null && !jsonObj.get("opened_by").isJsonNull()) && !jsonObj.get("opened_by").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `opened_by` to be a primitive type in the JSON string but got `%s`", jsonObj.get("opened_by").toString()));
      }
