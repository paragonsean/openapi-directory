...
public class CreateObjectStorageObjectURL200Response {
  public static final String SERIALIZED_NAME_URL = "url";
  @SerializedName(SERIALIZED_NAME_URL)
  private String url;

  public CreateObjectStorageObjectURL200Response() {
  }

  public CreateObjectStorageObjectURL200Response url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateObjectStorageObjectURL200Response createObjectStorageObjectURL200Response = (CreateObjectStorageObjectURL200Response) o;
    return Objects.equals(this.url, createObjectStorageObjectURL200Response.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateObjectStorageObjectURL200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateObjectStorageObjectURL200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateObjectStorageObjectURL200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateObjectStorageObjectURL200Response is not found in the empty JSON string", CreateObjectStorageObjectURL200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateObjectStorageObjectURL200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateObjectStorageObjectURL200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateObjectStorageObjectURL200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateObjectStorageObjectURL200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateObjectStorageObjectURL200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateObjectStorageObjectURL200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateObjectStorageObjectURL200Response>() {
           @Override
           public void write(JsonWriter out, CreateObjectStorageObjectURL200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateObjectStorageObjectURL200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateObjectStorageObjectURL200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateObjectStorageObjectURL200Response
   * @throws IOException if the JSON string is invalid with respect to CreateObjectStorageObjectURL200Response
   */
  public static CreateObjectStorageObjectURL200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateObjectStorageObjectURL200Response.class);
  }

  /**
   * Convert an instance of CreateObjectStorageObjectURL200Response to an JSON string
   *
   * @return JSON string
   */
