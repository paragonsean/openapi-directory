...
public class Grant {
  ...
  public Grant permissions(PermissionsEnum permissions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, grant.id) &&
        Objects.equals(this.label, grant.label) &&
        Objects.equals(this.permissions, grant.permissions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, label, permissions);
  }
