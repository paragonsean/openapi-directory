...
public class GetLinodeFirewalls200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Firewall> data = new ArrayList<>();
  ...
  public GetLinodeFirewalls200Response() {
  }
  ...
  public GetLinodeFirewalls200Response data(List<Firewall> data) {
    this.data = data;
    return this;
  }

  public GetLinodeFirewalls200Response addDataItem(Firewall dataItem) {
    if (this.data == null) {
  ...
  public void setData(List<Firewall> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeFirewalls200Response getLinodeFirewalls200Response = (GetLinodeFirewalls200Response) o;
    return Objects.equals(this.data, getLinodeFirewalls200Response.data) &&
        Objects.equals(this.page, getLinodeFirewalls200Response.page) &&
        Objects.equals(this.pages, getLinodeFirewalls200Response.pages) &&
        Objects.equals(this.results, getLinodeFirewalls200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeFirewalls200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeFirewalls200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeFirewalls200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeFirewalls200Response is not found in the empty JSON string", GetLinodeFirewalls200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeFirewalls200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeFirewalls200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Firewall.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeFirewalls200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeFirewalls200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeFirewalls200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeFirewalls200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeFirewalls200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeFirewalls200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeFirewalls200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeFirewalls200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeFirewalls200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeFirewalls200Response
   */
  public static GetLinodeFirewalls200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeFirewalls200Response.class);
  }

  /**
   * Convert an instance of GetLinodeFirewalls200Response to an JSON string
   *
   * @return JSON string
   */
