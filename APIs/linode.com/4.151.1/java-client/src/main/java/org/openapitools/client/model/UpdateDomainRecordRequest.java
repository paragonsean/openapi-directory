...
public class UpdateDomainRecordRequest {
  ...
  public UpdateDomainRecordRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateDomainRecordRequest port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public UpdateDomainRecordRequest priority(Integer priority) {
  ...
  public UpdateDomainRecordRequest protocol(String protocol) {
  ...
  public UpdateDomainRecordRequest service(String service) {
  ...
  public UpdateDomainRecordRequest tag(TagEnum tag) {
    this.tag = tag;
    return this;
  }
  ...
  public UpdateDomainRecordRequest target(String target) {
    this.target = target;
    return this;
  }
  ...
  public UpdateDomainRecordRequest ttlSec(Integer ttlSec) {
    this.ttlSec = ttlSec;
    return this;
  }
  ...
  public UpdateDomainRecordRequest weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateDomainRecordRequest.name) &&
        Objects.equals(this.port, updateDomainRecordRequest.port) &&
        Objects.equals(this.priority, updateDomainRecordRequest.priority) &&
        Objects.equals(this.protocol, updateDomainRecordRequest.protocol) &&
        Objects.equals(this.service, updateDomainRecordRequest.service) &&
        Objects.equals(this.tag, updateDomainRecordRequest.tag) &&
        Objects.equals(this.target, updateDomainRecordRequest.target) &&
        Objects.equals(this.ttlSec, updateDomainRecordRequest.ttlSec) &&
        Objects.equals(this.weight, updateDomainRecordRequest.weight);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, port, priority, protocol, service, tag, target, ttlSec, weight);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDomainRecordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDomainRecordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDomainRecordRequest is not found in the empty JSON string", UpdateDomainRecordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDomainRecordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDomainRecordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDomainRecordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDomainRecordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDomainRecordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDomainRecordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDomainRecordRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDomainRecordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDomainRecordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDomainRecordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDomainRecordRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateDomainRecordRequest
   */
  public static UpdateDomainRecordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDomainRecordRequest.class);
  }

  /**
   * Convert an instance of UpdateDomainRecordRequest to an JSON string
   *
   * @return JSON string
   */
