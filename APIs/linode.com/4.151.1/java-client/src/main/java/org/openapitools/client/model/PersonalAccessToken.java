...
public class PersonalAccessToken {
  ...
  public PersonalAccessToken label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, personalAccessToken.created) &&
        Objects.equals(this.expiry, personalAccessToken.expiry) &&
        Objects.equals(this.id, personalAccessToken.id) &&
        Objects.equals(this.label, personalAccessToken.label) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, expiry, id, label, scopes, token);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalAccessToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalAccessToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
