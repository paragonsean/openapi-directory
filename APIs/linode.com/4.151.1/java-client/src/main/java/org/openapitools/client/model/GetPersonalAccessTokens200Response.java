...
public class GetPersonalAccessTokens200Response {
  ...
  public GetPersonalAccessTokens200Response() {
  }
  ...
  public GetPersonalAccessTokens200Response data(List<PersonalAccessToken> data) {
    this.data = data;
    return this;
  }

  public GetPersonalAccessTokens200Response addDataItem(PersonalAccessToken dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetPersonalAccessTokens200Response getPersonalAccessTokens200Response = (GetPersonalAccessTokens200Response) o;
    return Objects.equals(this.data, getPersonalAccessTokens200Response.data) &&
        Objects.equals(this.page, getPersonalAccessTokens200Response.page) &&
        Objects.equals(this.pages, getPersonalAccessTokens200Response.pages) &&
        Objects.equals(this.results, getPersonalAccessTokens200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPersonalAccessTokens200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPersonalAccessTokens200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPersonalAccessTokens200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPersonalAccessTokens200Response is not found in the empty JSON string", GetPersonalAccessTokens200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPersonalAccessTokens200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPersonalAccessTokens200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PersonalAccessToken.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPersonalAccessTokens200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPersonalAccessTokens200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPersonalAccessTokens200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPersonalAccessTokens200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPersonalAccessTokens200Response>() {
           @Override
           public void write(JsonWriter out, GetPersonalAccessTokens200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPersonalAccessTokens200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPersonalAccessTokens200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPersonalAccessTokens200Response
   * @throws IOException if the JSON string is invalid with respect to GetPersonalAccessTokens200Response
   */
  public static GetPersonalAccessTokens200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPersonalAccessTokens200Response.class);
  }

  /**
   * Convert an instance of GetPersonalAccessTokens200Response to an JSON string
   *
   * @return JSON string
   */
