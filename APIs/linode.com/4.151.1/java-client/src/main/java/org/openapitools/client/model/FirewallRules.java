...
import org.openapitools.client.model.FirewallRuleConfig;
...
public class FirewallRules {
  ...
  private List<FirewallRuleConfig> inbound = new ArrayList<>();
   ...
   */
  @JsonAdapter(InboundPolicyEnum.Adapter.class)
  public enum InboundPolicyEnum {
    ACCEPT("ACCEPT"),
    ...
    InboundPolicyEnum(String value) {
      this.value = value;
    }
    ...
    public static InboundPolicyEnum fromValue(String value) {
      for (InboundPolicyEnum b : InboundPolicyEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<InboundPolicyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final InboundPolicyEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public InboundPolicyEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return InboundPolicyEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      InboundPolicyEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_INBOUND_POLICY = "inbound_policy";
  @SerializedName(SERIALIZED_NAME_INBOUND_POLICY)
  private InboundPolicyEnum inboundPolicy;

  public static final String SERIALIZED_NAME_OUTBOUND = "outbound";
  @SerializedName(SERIALIZED_NAME_OUTBOUND)
  private List<FirewallRuleConfig> outbound = new ArrayList<>();
   ...
   */
  @JsonAdapter(OutboundPolicyEnum.Adapter.class)
  public enum OutboundPolicyEnum {
    ACCEPT("ACCEPT"),
    ...
    OutboundPolicyEnum(String value) {
      this.value = value;
    }
    ...
    public static OutboundPolicyEnum fromValue(String value) {
      for (OutboundPolicyEnum b : OutboundPolicyEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<OutboundPolicyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OutboundPolicyEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OutboundPolicyEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return OutboundPolicyEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      OutboundPolicyEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_OUTBOUND_POLICY = "outbound_policy";
  @SerializedName(SERIALIZED_NAME_OUTBOUND_POLICY)
  private OutboundPolicyEnum outboundPolicy;

  public FirewallRules() {
  }

  public FirewallRules inbound(List<FirewallRuleConfig> inbound) {
    this.inbound = inbound;
    return this;
  }

  public FirewallRules addInboundItem(FirewallRuleConfig inboundItem) {
  ...
  public List<FirewallRuleConfig> getInbound() {
    return inbound;
  }

  public void setInbound(List<FirewallRuleConfig> inbound) {
    this.inbound = inbound;
  }


  public FirewallRules inboundPolicy(InboundPolicyEnum inboundPolicy) {
   ...
   */
  @javax.annotation.Nullable
  public InboundPolicyEnum getInboundPolicy() {
    return inboundPolicy;
  }

  public void setInboundPolicy(InboundPolicyEnum inboundPolicy) {
    this.inboundPolicy = inboundPolicy;
  }


  public FirewallRules outbound(List<FirewallRuleConfig> outbound) {
    this.outbound = outbound;
    return this;
  }

  public FirewallRules addOutboundItem(FirewallRuleConfig outboundItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<FirewallRuleConfig> getOutbound() {
    return outbound;
  }

  public void setOutbound(List<FirewallRuleConfig> outbound) {
    this.outbound = outbound;
  }


  public FirewallRules outboundPolicy(OutboundPolicyEnum outboundPolicy) {
   ...
   */
  @javax.annotation.Nullable
  public OutboundPolicyEnum getOutboundPolicy() {
    return outboundPolicy;
  }

  public void setOutboundPolicy(OutboundPolicyEnum outboundPolicy) {
    this.outboundPolicy = outboundPolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inbound, firewallRules.inbound) &&
        Objects.equals(this.inboundPolicy, firewallRules.inboundPolicy) &&
        Objects.equals(this.outbound, firewallRules.outbound) &&
        Objects.equals(this.outboundPolicy, firewallRules.outboundPolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inbound, inboundPolicy, outbound, outboundPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("    inboundPolicy: ").append(toIndentedString(inboundPolicy)).append("\n");
  ...
  static {
    ...
    openapiFields.add("inbound_policy");
    openapiFields.add("outbound");
    openapiFields.add("outbound_policy");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallRules
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRules is not found in the empty JSON string", FirewallRules.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallRules.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallRules` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("inbound") != null && !jsonObj.get("inbound").isJsonNull()) {
        JsonArray jsonArrayinbound = jsonObj.getAsJsonArray("inbound");
        if (jsonArrayinbound != null) {
          // ensure the json data is an array
          if (!jsonObj.get("inbound").isJsonArray()) {
          ...
          for (int i = 0; i < jsonArrayinbound.size(); i++) {
            FirewallRuleConfig.validateJsonElement(jsonArrayinbound.get(i));
          };
        }
      }
      if ((jsonObj.get("inbound_policy") != null && !jsonObj.get("inbound_policy").isJsonNull()) && !jsonObj.get("inbound_policy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `inbound_policy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("inbound_policy").toString()));
      }
      // validate the optional field `inbound_policy`
      if (jsonObj.get("inbound_policy") != null && !jsonObj.get("inbound_policy").isJsonNull()) {
        InboundPolicyEnum.validateJsonElement(jsonObj.get("inbound_policy"));
      }
      if (jsonObj.get("outbound") != null && !jsonObj.get("outbound").isJsonNull()) {
        JsonArray jsonArrayoutbound = jsonObj.getAsJsonArray("outbound");
        if (jsonArrayoutbound != null) {
          // ensure the json data is an array
          if (!jsonObj.get("outbound").isJsonArray()) {
          ...
          for (int i = 0; i < jsonArrayoutbound.size(); i++) {
            FirewallRuleConfig.validateJsonElement(jsonArrayoutbound.get(i));
          };
        }
      }
      if ((jsonObj.get("outbound_policy") != null && !jsonObj.get("outbound_policy").isJsonNull()) && !jsonObj.get("outbound_policy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `outbound_policy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("outbound_policy").toString()));
      }
      // validate the optional field `outbound_policy`
      if (jsonObj.get("outbound_policy") != null && !jsonObj.get("outbound_policy").isJsonNull()) {
        OutboundPolicyEnum.validateJsonElement(jsonObj.get("outbound_policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRules.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRules' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRules> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRules.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRules>() {
           @Override
           public void write(JsonWriter out, FirewallRules value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallRules read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallRules given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallRules
   * @throws IOException if the JSON string is invalid with respect to FirewallRules
   */
  public static FirewallRules fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRules.class);
  }

  /**
   * Convert an instance of FirewallRules to an JSON string
   *
   * @return JSON string
   */
