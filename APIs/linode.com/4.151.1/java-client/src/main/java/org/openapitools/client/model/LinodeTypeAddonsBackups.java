...
import org.openapitools.client.model.LinodeTypeAddonsBackupsPrice;
...
public class LinodeTypeAddonsBackups {
  ...
  private LinodeTypeAddonsBackupsPrice price;

  public LinodeTypeAddonsBackups() {
  }

  public LinodeTypeAddonsBackups price(LinodeTypeAddonsBackupsPrice price) {
    this.price = price;
    return this;
  }
  ...
  public LinodeTypeAddonsBackupsPrice getPrice() {
    return price;
  }

  public void setPrice(LinodeTypeAddonsBackupsPrice price) {
    this.price = price;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeTypeAddonsBackups linodeTypeAddonsBackups = (LinodeTypeAddonsBackups) o;
    return Objects.equals(this.price, linodeTypeAddonsBackups.price);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinodeTypeAddonsBackups {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeTypeAddonsBackups
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeTypeAddonsBackups.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeTypeAddonsBackups is not found in the empty JSON string", LinodeTypeAddonsBackups.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeTypeAddonsBackups.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeTypeAddonsBackups` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `price`
      if (jsonObj.get("price") != null && !jsonObj.get("price").isJsonNull()) {
        LinodeTypeAddonsBackupsPrice.validateJsonElement(jsonObj.get("price"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeTypeAddonsBackups.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeTypeAddonsBackups' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeTypeAddonsBackups> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeTypeAddonsBackups.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeTypeAddonsBackups>() {
           @Override
           public void write(JsonWriter out, LinodeTypeAddonsBackups value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeTypeAddonsBackups read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeTypeAddonsBackups given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeTypeAddonsBackups
   * @throws IOException if the JSON string is invalid with respect to LinodeTypeAddonsBackups
   */
  public static LinodeTypeAddonsBackups fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeTypeAddonsBackups.class);
  }

  /**
   * Convert an instance of LinodeTypeAddonsBackups to an JSON string
   *
   * @return JSON string
   */
