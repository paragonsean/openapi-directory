...
public class FirewallDevicesEntity {
  ...
  public FirewallDevicesEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public FirewallDevicesEntity type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallDevicesEntity firewallDevicesEntity = (FirewallDevicesEntity) o;
    return Objects.equals(this.id, firewallDevicesEntity.id) &&
        Objects.equals(this.label, firewallDevicesEntity.label) &&
        Objects.equals(this.type, firewallDevicesEntity.type) &&
        Objects.equals(this.url, firewallDevicesEntity.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallDevicesEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallDevicesEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallDevicesEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallDevicesEntity is not found in the empty JSON string", FirewallDevicesEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallDevicesEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallDevicesEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallDevicesEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallDevicesEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallDevicesEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallDevicesEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallDevicesEntity>() {
           @Override
           public void write(JsonWriter out, FirewallDevicesEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallDevicesEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallDevicesEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallDevicesEntity
   * @throws IOException if the JSON string is invalid with respect to FirewallDevicesEntity
   */
  public static FirewallDevicesEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallDevicesEntity.class);
  }

  /**
   * Convert an instance of FirewallDevicesEntity to an JSON string
   *
   * @return JSON string
   */
