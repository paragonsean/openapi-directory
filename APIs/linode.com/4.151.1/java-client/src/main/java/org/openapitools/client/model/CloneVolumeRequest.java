...
public class CloneVolumeRequest {
  ...
  public CloneVolumeRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloneVolumeRequest cloneVolumeRequest = (CloneVolumeRequest) o;
    return Objects.equals(this.label, cloneVolumeRequest.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloneVolumeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloneVolumeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloneVolumeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloneVolumeRequest is not found in the empty JSON string", CloneVolumeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloneVolumeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloneVolumeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloneVolumeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloneVolumeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloneVolumeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloneVolumeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloneVolumeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloneVolumeRequest>() {
           @Override
           public void write(JsonWriter out, CloneVolumeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloneVolumeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloneVolumeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloneVolumeRequest
   * @throws IOException if the JSON string is invalid with respect to CloneVolumeRequest
   */
  public static CloneVolumeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloneVolumeRequest.class);
  }

  /**
   * Convert an instance of CloneVolumeRequest to an JSON string
   *
   * @return JSON string
   */
