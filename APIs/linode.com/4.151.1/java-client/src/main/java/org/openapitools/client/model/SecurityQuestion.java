...
public class SecurityQuestion {
  ...
  public SecurityQuestion response(String response) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, securityQuestion.id) &&
        ...
        Objects.equals(this.response, securityQuestion.response);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityQuestion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityQuestion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityQuestion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityQuestion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
