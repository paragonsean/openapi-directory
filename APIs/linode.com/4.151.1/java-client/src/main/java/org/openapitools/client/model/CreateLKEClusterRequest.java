...
import org.openapitools.client.model.CreateLKEClusterRequestControlPlane;
...
public class CreateLKEClusterRequest {
  ...
  private List<LKENodePoolRequestBody> nodePools = new ArrayList<>();
  ...
  public CreateLKEClusterRequest() {
  }

  public CreateLKEClusterRequest controlPlane(CreateLKEClusterRequestControlPlane controlPlane) {
  ...
  public CreateLKEClusterRequestControlPlane getControlPlane() {
    return controlPlane;
  }

  public void setControlPlane(CreateLKEClusterRequestControlPlane controlPlane) {
    this.controlPlane = controlPlane;
  }


  public CreateLKEClusterRequest k8sVersion(String k8sVersion) {
  ...
  public CreateLKEClusterRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CreateLKEClusterRequest nodePools(List<LKENodePoolRequestBody> nodePools) {
    this.nodePools = nodePools;
    return this;
  }

  public CreateLKEClusterRequest addNodePoolsItem(LKENodePoolRequestBody nodePoolsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<LKENodePoolRequestBody> getNodePools() {
    return nodePools;
  }

  public void setNodePools(List<LKENodePoolRequestBody> nodePools) {
    this.nodePools = nodePools;
  }


  public CreateLKEClusterRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public CreateLKEClusterRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateLKEClusterRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLKEClusterRequest createLKEClusterRequest = (CreateLKEClusterRequest) o;
    return Objects.equals(this.controlPlane, createLKEClusterRequest.controlPlane) &&
        Objects.equals(this.k8sVersion, createLKEClusterRequest.k8sVersion) &&
        Objects.equals(this.label, createLKEClusterRequest.label) &&
        Objects.equals(this.nodePools, createLKEClusterRequest.nodePools) &&
        Objects.equals(this.region, createLKEClusterRequest.region) &&
        Objects.equals(this.tags, createLKEClusterRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(controlPlane, k8sVersion, label, nodePools, region, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateLKEClusterRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLKEClusterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLKEClusterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLKEClusterRequest is not found in the empty JSON string", CreateLKEClusterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLKEClusterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLKEClusterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLKEClusterRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("control_plane") != null && !jsonObj.get("control_plane").isJsonNull()) {
        CreateLKEClusterRequestControlPlane.validateJsonElement(jsonObj.get("control_plane"));
      }
      ...
      for (int i = 0; i < jsonArraynodePools.size(); i++) {
        LKENodePoolRequestBody.validateJsonElement(jsonArraynodePools.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLKEClusterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLKEClusterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLKEClusterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLKEClusterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLKEClusterRequest>() {
           @Override
           public void write(JsonWriter out, CreateLKEClusterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLKEClusterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLKEClusterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLKEClusterRequest
   * @throws IOException if the JSON string is invalid with respect to CreateLKEClusterRequest
   */
  public static CreateLKEClusterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLKEClusterRequest.class);
  }

  /**
   * Convert an instance of CreateLKEClusterRequest to an JSON string
   *
   * @return JSON string
   */
