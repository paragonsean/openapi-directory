...
import org.openapitools.client.model.DatabaseUpdates;
...
public class PutDatabasesMongoDBInstanceRequest {
  ...
  public PutDatabasesMongoDBInstanceRequest() {
  }

  public PutDatabasesMongoDBInstanceRequest allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public PutDatabasesMongoDBInstanceRequest addAllowListItem(String allowListItem) {
  ...
  public PutDatabasesMongoDBInstanceRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PutDatabasesMongoDBInstanceRequest updates(DatabaseUpdates updates) {
   ...
   */
  @javax.annotation.Nullable
  public DatabaseUpdates getUpdates() {
    return updates;
  }

  public void setUpdates(DatabaseUpdates updates) {
    this.updates = updates;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutDatabasesMongoDBInstanceRequest putDatabasesMongoDBInstanceRequest = (PutDatabasesMongoDBInstanceRequest) o;
    return Objects.equals(this.allowList, putDatabasesMongoDBInstanceRequest.allowList) &&
        Objects.equals(this.label, putDatabasesMongoDBInstanceRequest.label) &&
        Objects.equals(this.updates, putDatabasesMongoDBInstanceRequest.updates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, label, updates);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutDatabasesMongoDBInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDatabasesMongoDBInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDatabasesMongoDBInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDatabasesMongoDBInstanceRequest is not found in the empty JSON string", PutDatabasesMongoDBInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDatabasesMongoDBInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDatabasesMongoDBInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("updates") != null && !jsonObj.get("updates").isJsonNull()) {
        DatabaseUpdates.validateJsonElement(jsonObj.get("updates"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDatabasesMongoDBInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDatabasesMongoDBInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDatabasesMongoDBInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDatabasesMongoDBInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDatabasesMongoDBInstanceRequest>() {
           @Override
           public void write(JsonWriter out, PutDatabasesMongoDBInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDatabasesMongoDBInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDatabasesMongoDBInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDatabasesMongoDBInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to PutDatabasesMongoDBInstanceRequest
   */
  public static PutDatabasesMongoDBInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDatabasesMongoDBInstanceRequest.class);
  }

  /**
   * Convert an instance of PutDatabasesMongoDBInstanceRequest to an JSON string
   *
   * @return JSON string
   */
