...
public class IPAddressesShareRequest {
  ...
  public IPAddressesShareRequest() {
  }

  public IPAddressesShareRequest ips(List<String> ips) {
    this.ips = ips;
    return this;
  }

  public IPAddressesShareRequest addIpsItem(String ipsItem) {
    if (this.ips == null) {
  ...
  public IPAddressesShareRequest linodeId(Integer linodeId) {
  ...
  public boolean equals(Object o) {
    ...
    IPAddressesShareRequest ipAddressesShareRequest = (IPAddressesShareRequest) o;
    return Objects.equals(this.ips, ipAddressesShareRequest.ips) &&
        Objects.equals(this.linodeId, ipAddressesShareRequest.linodeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ips, linodeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPAddressesShareRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressesShareRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressesShareRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressesShareRequest is not found in the empty JSON string", IPAddressesShareRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressesShareRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressesShareRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IPAddressesShareRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressesShareRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressesShareRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressesShareRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressesShareRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressesShareRequest>() {
           @Override
           public void write(JsonWriter out, IPAddressesShareRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressesShareRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressesShareRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressesShareRequest
   * @throws IOException if the JSON string is invalid with respect to IPAddressesShareRequest
   */
  public static IPAddressesShareRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressesShareRequest.class);
  }

  /**
   * Convert an instance of IPAddressesShareRequest to an JSON string
   *
   * @return JSON string
   */
