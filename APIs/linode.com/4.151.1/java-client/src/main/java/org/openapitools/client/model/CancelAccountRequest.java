...
public class CancelAccountRequest {
  ...
  public CancelAccountRequest comments(String comments) {
  ...
  public boolean equals(Object o) {
    ...
    CancelAccountRequest cancelAccountRequest = (CancelAccountRequest) o;
    return Objects.equals(this.comments, cancelAccountRequest.comments);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelAccountRequest is not found in the empty JSON string", CancelAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelAccountRequest>() {
           @Override
           public void write(JsonWriter out, CancelAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelAccountRequest
   * @throws IOException if the JSON string is invalid with respect to CancelAccountRequest
   */
  public static CancelAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelAccountRequest.class);
  }

  /**
   * Convert an instance of CancelAccountRequest to an JSON string
   *
   * @return JSON string
   */
