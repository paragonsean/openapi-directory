...
public class AuthorizedApp {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizedApp authorizedApp = (AuthorizedApp) o;
    return Objects.equals(this.created, authorizedApp.created) &&
        Objects.equals(this.expiry, authorizedApp.expiry) &&
        Objects.equals(this.id, authorizedApp.id) &&
        Objects.equals(this.label, authorizedApp.label) &&
        Objects.equals(this.scopes, authorizedApp.scopes) &&
        Objects.equals(this.thumbnailUrl, authorizedApp.thumbnailUrl) &&
        Objects.equals(this.website, authorizedApp.website);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, expiry, id, label, scopes, thumbnailUrl, website);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizedApp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizedApp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizedApp is not found in the empty JSON string", AuthorizedApp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizedApp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizedApp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizedApp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizedApp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizedApp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizedApp.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizedApp>() {
           @Override
           public void write(JsonWriter out, AuthorizedApp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizedApp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizedApp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizedApp
   * @throws IOException if the JSON string is invalid with respect to AuthorizedApp
   */
  public static AuthorizedApp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizedApp.class);
  }

  /**
   * Convert an instance of AuthorizedApp to an JSON string
   *
   * @return JSON string
   */
