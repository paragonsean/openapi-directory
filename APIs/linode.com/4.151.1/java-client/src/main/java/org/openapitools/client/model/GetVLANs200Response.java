...
import org.openapitools.client.model.Vlans;
...
public class GetVLANs200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Vlans> data = new ArrayList<>();
  ...
  public GetVLANs200Response data(List<Vlans> data) {
    this.data = data;
    return this;
  }

  public GetVLANs200Response addDataItem(Vlans dataItem) {
    if (this.data == null) {
  ...
  public List<Vlans> getData() {
    return data;
  }

  public void setData(List<Vlans> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetVLANs200Response getVLANs200Response = (GetVLANs200Response) o;
    return Objects.equals(this.data, getVLANs200Response.data) &&
        Objects.equals(this.page, getVLANs200Response.page) &&
        Objects.equals(this.pages, getVLANs200Response.pages) &&
        Objects.equals(this.results, getVLANs200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetVLANs200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetVLANs200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetVLANs200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetVLANs200Response is not found in the empty JSON string", GetVLANs200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetVLANs200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetVLANs200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Vlans.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetVLANs200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetVLANs200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetVLANs200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetVLANs200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetVLANs200Response>() {
           @Override
           public void write(JsonWriter out, GetVLANs200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetVLANs200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetVLANs200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetVLANs200Response
   * @throws IOException if the JSON string is invalid with respect to GetVLANs200Response
   */
  public static GetVLANs200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetVLANs200Response.class);
  }

  /**
   * Convert an instance of GetVLANs200Response to an JSON string
   *
   * @return JSON string
   */
