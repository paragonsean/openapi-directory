...
import org.openapitools.client.model.EntityTransferEntities;
...
public class EntityTransfer {
  ...
  private EntityTransferEntities entities;

  public static final String SERIALIZED_NAME_EXPIRY = "expiry";
  @SerializedName(SERIALIZED_NAME_EXPIRY)
  private OffsetDateTime expiry;

  public static final String SERIALIZED_NAME_IS_SENDER = "is_sender";
  @SerializedName(SERIALIZED_NAME_IS_SENDER)
  ...
  public EntityTransfer created(OffsetDateTime created) {
  ...
  public EntityTransfer entities(EntityTransferEntities entities) {
   ...
   */
  @javax.annotation.Nullable
  public EntityTransferEntities getEntities() {
    return entities;
  }

  public void setEntities(EntityTransferEntities entities) {
    this.entities = entities;
  }


  public EntityTransfer expiry(OffsetDateTime expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public EntityTransfer isSender(Boolean isSender) {
  ...
  public EntityTransfer status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public EntityTransfer token(UUID token) {
    this.token = token;
    return this;
  }
  ...
  public EntityTransfer updated(OffsetDateTime updated) {
  ...
  public boolean equals(Object o) {
    ...
    EntityTransfer entityTransfer = (EntityTransfer) o;
    return Objects.equals(this.created, entityTransfer.created) &&
        Objects.equals(this.entities, entityTransfer.entities) &&
        Objects.equals(this.expiry, entityTransfer.expiry) &&
        Objects.equals(this.isSender, entityTransfer.isSender) &&
        Objects.equals(this.status, entityTransfer.status) &&
        Objects.equals(this.token, entityTransfer.token) &&
        Objects.equals(this.updated, entityTransfer.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, entities, expiry, isSender, status, token, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntityTransfer {\n");
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    entities: ").append(toIndentedString(entities)).append("\n");
    sb.append("    expiry: ").append(toIndentedString(expiry)).append("\n");
    sb.append("    isSender: ").append(toIndentedString(isSender)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityTransfer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityTransfer is not found in the empty JSON string", EntityTransfer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityTransfer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityTransfer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `entities`
      if (jsonObj.get("entities") != null && !jsonObj.get("entities").isJsonNull()) {
        EntityTransferEntities.validateJsonElement(jsonObj.get("entities"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityTransfer>() {
           @Override
           public void write(JsonWriter out, EntityTransfer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityTransfer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityTransfer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityTransfer
   * @throws IOException if the JSON string is invalid with respect to EntityTransfer
   */
  public static EntityTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityTransfer.class);
  }

  /**
   * Convert an instance of EntityTransfer to an JSON string
   *
   * @return JSON string
   */
