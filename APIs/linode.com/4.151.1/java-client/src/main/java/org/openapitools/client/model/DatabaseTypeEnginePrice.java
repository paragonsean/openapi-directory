...
public class DatabaseTypeEnginePrice {
  ...
  public DatabaseTypeEnginePrice() {
  }

  public DatabaseTypeEnginePrice hourly(BigDecimal hourly) {
    this.hourly = hourly;
    return this;
  }
  ...
  public DatabaseTypeEnginePrice monthly(BigDecimal monthly) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseTypeEnginePrice databaseTypeEnginePrice = (DatabaseTypeEnginePrice) o;
    return Objects.equals(this.hourly, databaseTypeEnginePrice.hourly) &&
        Objects.equals(this.monthly, databaseTypeEnginePrice.monthly);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseTypeEnginePrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseTypeEnginePrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseTypeEnginePrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseTypeEnginePrice is not found in the empty JSON string", DatabaseTypeEnginePrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseTypeEnginePrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseTypeEnginePrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseTypeEnginePrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseTypeEnginePrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseTypeEnginePrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseTypeEnginePrice.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseTypeEnginePrice>() {
           @Override
           public void write(JsonWriter out, DatabaseTypeEnginePrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseTypeEnginePrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseTypeEnginePrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseTypeEnginePrice
   * @throws IOException if the JSON string is invalid with respect to DatabaseTypeEnginePrice
   */
  public static DatabaseTypeEnginePrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseTypeEnginePrice.class);
  }

  /**
   * Convert an instance of DatabaseTypeEnginePrice to an JSON string
   *
   * @return JSON string
   */
