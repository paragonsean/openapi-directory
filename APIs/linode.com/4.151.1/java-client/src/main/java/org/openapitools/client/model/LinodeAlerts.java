...
public class LinodeAlerts {
  ...
  public static final String SERIALIZED_NAME_TRANSFER_QUOTA = "transfer_quota";
  @SerializedName(SERIALIZED_NAME_TRANSFER_QUOTA)
  private Integer transferQuota;

  public LinodeAlerts() {
  }

  public LinodeAlerts cpu(Integer cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public LinodeAlerts io(Integer io) {
    this.io = io;
    return this;
  }
  ...
  public LinodeAlerts networkIn(Integer networkIn) {
  ...
  public LinodeAlerts networkOut(Integer networkOut) {
  ...
  public LinodeAlerts transferQuota(Integer transferQuota) {
  ...
  public void setTransferQuota(Integer transferQuota) {
    this.transferQuota = transferQuota;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeAlerts linodeAlerts = (LinodeAlerts) o;
    return Objects.equals(this.cpu, linodeAlerts.cpu) &&
        Objects.equals(this.io, linodeAlerts.io) &&
        Objects.equals(this.networkIn, linodeAlerts.networkIn) &&
        Objects.equals(this.networkOut, linodeAlerts.networkOut) &&
        Objects.equals(this.transferQuota, linodeAlerts.transferQuota);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cpu, io, networkIn, networkOut, transferQuota);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinodeAlerts {\n");
    ...
    sb.append("    transferQuota: ").append(toIndentedString(transferQuota)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("network_in");
    openapiFields.add("network_out");
    openapiFields.add("transfer_quota");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeAlerts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeAlerts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeAlerts is not found in the empty JSON string", LinodeAlerts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeAlerts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeAlerts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeAlerts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeAlerts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeAlerts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeAlerts.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeAlerts>() {
           @Override
           public void write(JsonWriter out, LinodeAlerts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeAlerts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeAlerts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeAlerts
   * @throws IOException if the JSON string is invalid with respect to LinodeAlerts
   */
  public static LinodeAlerts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeAlerts.class);
  }

  /**
   * Convert an instance of LinodeAlerts to an JSON string
   *
   * @return JSON string
   */
