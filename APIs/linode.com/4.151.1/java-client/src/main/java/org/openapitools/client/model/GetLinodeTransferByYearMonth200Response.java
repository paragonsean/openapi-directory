...
public class GetLinodeTransferByYearMonth200Response {
  ...
  public GetLinodeTransferByYearMonth200Response() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeTransferByYearMonth200Response getLinodeTransferByYearMonth200Response = (GetLinodeTransferByYearMonth200Response) o;
    return Objects.equals(this.bytesIn, getLinodeTransferByYearMonth200Response.bytesIn) &&
        Objects.equals(this.bytesOut, getLinodeTransferByYearMonth200Response.bytesOut) &&
        Objects.equals(this.bytesTotal, getLinodeTransferByYearMonth200Response.bytesTotal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bytesIn, bytesOut, bytesTotal);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLinodeTransferByYearMonth200Response {\n");
  ...
  static {
    ...
    openapiFields.add("bytes_in");
    openapiFields.add("bytes_out");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeTransferByYearMonth200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeTransferByYearMonth200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeTransferByYearMonth200Response is not found in the empty JSON string", GetLinodeTransferByYearMonth200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeTransferByYearMonth200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeTransferByYearMonth200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeTransferByYearMonth200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeTransferByYearMonth200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeTransferByYearMonth200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeTransferByYearMonth200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeTransferByYearMonth200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeTransferByYearMonth200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeTransferByYearMonth200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeTransferByYearMonth200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeTransferByYearMonth200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeTransferByYearMonth200Response
   */
  public static GetLinodeTransferByYearMonth200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeTransferByYearMonth200Response.class);
  }

  /**
   * Convert an instance of GetLinodeTransferByYearMonth200Response to an JSON string
   *
   * @return JSON string
   */
