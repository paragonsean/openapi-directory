...
public class CreateNodeBalancerRequestConfigsInner {
  /**
  ...
  private List<NodeBalancerNode> nodes = new ArrayList<>();
  ...
  public CreateNodeBalancerRequestConfigsInner() {
  }

  public CreateNodeBalancerRequestConfigsInner algorithm(AlgorithmEnum algorithm) {
  ...
  public CreateNodeBalancerRequestConfigsInner check(CheckEnum check) {
    this.check = check;
    return this;
  }
  ...
  public CreateNodeBalancerRequestConfigsInner checkAttempts(Integer checkAttempts) {
  ...
  public CreateNodeBalancerRequestConfigsInner checkBody(String checkBody) {
  ...
  public CreateNodeBalancerRequestConfigsInner checkInterval(Integer checkInterval) {
  ...
  public CreateNodeBalancerRequestConfigsInner checkPassive(Boolean checkPassive) {
  ...
  public CreateNodeBalancerRequestConfigsInner checkPath(String checkPath) {
  ...
  public CreateNodeBalancerRequestConfigsInner checkTimeout(Integer checkTimeout) {
  ...
  public CreateNodeBalancerRequestConfigsInner cipherSuite(CipherSuiteEnum cipherSuite) {
  ...
  public CreateNodeBalancerRequestConfigsInner nodes(List<NodeBalancerNode> nodes) {
    this.nodes = nodes;
    return this;
  }

  public CreateNodeBalancerRequestConfigsInner addNodesItem(NodeBalancerNode nodesItem) {
    if (this.nodes == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<NodeBalancerNode> getNodes() {
    return nodes;
  }

  public void setNodes(List<NodeBalancerNode> nodes) {
    this.nodes = nodes;
  }


  public CreateNodeBalancerRequestConfigsInner port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateNodeBalancerRequestConfigsInner protocol(ProtocolEnum protocol) {
  ...
  public CreateNodeBalancerRequestConfigsInner proxyProtocol(ProxyProtocolEnum proxyProtocol) {
  ...
  public CreateNodeBalancerRequestConfigsInner sslCert(String sslCert) {
  ...
  public CreateNodeBalancerRequestConfigsInner sslKey(String sslKey) {
    this.sslKey = sslKey;
    return this;
  }
  ...
  public CreateNodeBalancerRequestConfigsInner stickiness(StickinessEnum stickiness) {
  ...
  public boolean equals(Object o) {
    ...
    CreateNodeBalancerRequestConfigsInner createNodeBalancerRequestConfigsInner = (CreateNodeBalancerRequestConfigsInner) o;
    return Objects.equals(this.algorithm, createNodeBalancerRequestConfigsInner.algorithm) &&
        Objects.equals(this.check, createNodeBalancerRequestConfigsInner.check) &&
        Objects.equals(this.checkAttempts, createNodeBalancerRequestConfigsInner.checkAttempts) &&
        Objects.equals(this.checkBody, createNodeBalancerRequestConfigsInner.checkBody) &&
        Objects.equals(this.checkInterval, createNodeBalancerRequestConfigsInner.checkInterval) &&
        Objects.equals(this.checkPassive, createNodeBalancerRequestConfigsInner.checkPassive) &&
        Objects.equals(this.checkPath, createNodeBalancerRequestConfigsInner.checkPath) &&
        Objects.equals(this.checkTimeout, createNodeBalancerRequestConfigsInner.checkTimeout) &&
        Objects.equals(this.cipherSuite, createNodeBalancerRequestConfigsInner.cipherSuite) &&
        Objects.equals(this.nodes, createNodeBalancerRequestConfigsInner.nodes) &&
        Objects.equals(this.port, createNodeBalancerRequestConfigsInner.port) &&
        Objects.equals(this.protocol, createNodeBalancerRequestConfigsInner.protocol) &&
        Objects.equals(this.proxyProtocol, createNodeBalancerRequestConfigsInner.proxyProtocol) &&
        Objects.equals(this.sslCert, createNodeBalancerRequestConfigsInner.sslCert) &&
        Objects.equals(this.sslKey, createNodeBalancerRequestConfigsInner.sslKey) &&
        Objects.equals(this.stickiness, createNodeBalancerRequestConfigsInner.stickiness);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(algorithm, check, checkAttempts, checkBody, checkInterval, checkPassive, checkPath, checkTimeout, cipherSuite, nodes, port, protocol, proxyProtocol, sslCert, sslKey, stickiness);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNodeBalancerRequestConfigsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNodeBalancerRequestConfigsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNodeBalancerRequestConfigsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNodeBalancerRequestConfigsInner is not found in the empty JSON string", CreateNodeBalancerRequestConfigsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNodeBalancerRequestConfigsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNodeBalancerRequestConfigsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("nodes") != null && !jsonObj.get("nodes").isJsonNull()) {
        ...
        if (jsonArraynodes != null) {
          ...
          for (int i = 0; i < jsonArraynodes.size(); i++) {
            NodeBalancerNode.validateJsonElement(jsonArraynodes.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNodeBalancerRequestConfigsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNodeBalancerRequestConfigsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNodeBalancerRequestConfigsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNodeBalancerRequestConfigsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNodeBalancerRequestConfigsInner>() {
           @Override
           public void write(JsonWriter out, CreateNodeBalancerRequestConfigsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNodeBalancerRequestConfigsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNodeBalancerRequestConfigsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNodeBalancerRequestConfigsInner
   * @throws IOException if the JSON string is invalid with respect to CreateNodeBalancerRequestConfigsInner
   */
  public static CreateNodeBalancerRequestConfigsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNodeBalancerRequestConfigsInner.class);
  }

  /**
   * Convert an instance of CreateNodeBalancerRequestConfigsInner to an JSON string
   *
   * @return JSON string
   */
