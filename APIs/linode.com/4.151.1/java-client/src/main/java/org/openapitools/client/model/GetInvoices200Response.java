...
public class GetInvoices200Response {
  ...
  public GetInvoices200Response data(List<Invoice> data) {
    this.data = data;
    return this;
  }

  public GetInvoices200Response addDataItem(Invoice dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getInvoices200Response.data) &&
        Objects.equals(this.page, getInvoices200Response.page) &&
        Objects.equals(this.pages, getInvoices200Response.pages) &&
        Objects.equals(this.results, getInvoices200Response.results);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInvoices200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInvoices200Response is not found in the empty JSON string", GetInvoices200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInvoices200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetInvoices200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
