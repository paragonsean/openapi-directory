...
public class ManagedLinodeSettingsSsh {
  ...
  public ManagedLinodeSettingsSsh() {
  }

  public ManagedLinodeSettingsSsh access(Boolean access) {
    this.access = access;
    return this;
  }
  ...
  public ManagedLinodeSettingsSsh ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public ManagedLinodeSettingsSsh port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ManagedLinodeSettingsSsh user(String user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManagedLinodeSettingsSsh managedLinodeSettingsSsh = (ManagedLinodeSettingsSsh) o;
    return Objects.equals(this.access, managedLinodeSettingsSsh.access) &&
        Objects.equals(this.ip, managedLinodeSettingsSsh.ip) &&
        Objects.equals(this.port, managedLinodeSettingsSsh.port) &&
        Objects.equals(this.user, managedLinodeSettingsSsh.user);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, ip, port, user);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagedLinodeSettingsSsh {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedLinodeSettingsSsh
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedLinodeSettingsSsh.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedLinodeSettingsSsh is not found in the empty JSON string", ManagedLinodeSettingsSsh.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedLinodeSettingsSsh.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedLinodeSettingsSsh` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedLinodeSettingsSsh.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedLinodeSettingsSsh' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedLinodeSettingsSsh> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedLinodeSettingsSsh.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedLinodeSettingsSsh>() {
           @Override
           public void write(JsonWriter out, ManagedLinodeSettingsSsh value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedLinodeSettingsSsh read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedLinodeSettingsSsh given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedLinodeSettingsSsh
   * @throws IOException if the JSON string is invalid with respect to ManagedLinodeSettingsSsh
   */
  public static ManagedLinodeSettingsSsh fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedLinodeSettingsSsh.class);
  }

  /**
   * Convert an instance of ManagedLinodeSettingsSsh to an JSON string
   *
   * @return JSON string
   */
