...
public class GetKernels200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Kernel> data = new ArrayList<>();
  ...
  public GetKernels200Response data(List<Kernel> data) {
    this.data = data;
    return this;
  }

  public GetKernels200Response addDataItem(Kernel dataItem) {
    if (this.data == null) {
  ...
  public List<Kernel> getData() {
    return data;
  }

  public void setData(List<Kernel> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetKernels200Response getKernels200Response = (GetKernels200Response) o;
    return Objects.equals(this.data, getKernels200Response.data) &&
        Objects.equals(this.page, getKernels200Response.page) &&
        Objects.equals(this.pages, getKernels200Response.pages) &&
        Objects.equals(this.results, getKernels200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetKernels200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKernels200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKernels200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKernels200Response is not found in the empty JSON string", GetKernels200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKernels200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKernels200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Kernel.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKernels200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKernels200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKernels200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKernels200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKernels200Response>() {
           @Override
           public void write(JsonWriter out, GetKernels200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKernels200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKernels200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKernels200Response
   * @throws IOException if the JSON string is invalid with respect to GetKernels200Response
   */
  public static GetKernels200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKernels200Response.class);
  }

  /**
   * Convert an instance of GetKernels200Response to an JSON string
   *
   * @return JSON string
   */
