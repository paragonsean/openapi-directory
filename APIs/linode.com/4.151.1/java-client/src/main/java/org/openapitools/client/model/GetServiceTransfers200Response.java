...
public class GetServiceTransfers200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ServiceTransfer> data = new ArrayList<>();
  ...
  public GetServiceTransfers200Response() {
  }
  ...
  public GetServiceTransfers200Response data(List<ServiceTransfer> data) {
    this.data = data;
    return this;
  }

  public GetServiceTransfers200Response addDataItem(ServiceTransfer dataItem) {
    if (this.data == null) {
  ...
  public List<ServiceTransfer> getData() {
    return data;
  }

  public void setData(List<ServiceTransfer> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetServiceTransfers200Response getServiceTransfers200Response = (GetServiceTransfers200Response) o;
    return Objects.equals(this.data, getServiceTransfers200Response.data) &&
        Objects.equals(this.page, getServiceTransfers200Response.page) &&
        Objects.equals(this.pages, getServiceTransfers200Response.pages) &&
        Objects.equals(this.results, getServiceTransfers200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetServiceTransfers200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetServiceTransfers200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetServiceTransfers200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetServiceTransfers200Response is not found in the empty JSON string", GetServiceTransfers200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetServiceTransfers200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetServiceTransfers200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ServiceTransfer.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetServiceTransfers200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetServiceTransfers200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetServiceTransfers200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetServiceTransfers200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetServiceTransfers200Response>() {
           @Override
           public void write(JsonWriter out, GetServiceTransfers200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetServiceTransfers200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetServiceTransfers200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetServiceTransfers200Response
   * @throws IOException if the JSON string is invalid with respect to GetServiceTransfers200Response
   */
  public static GetServiceTransfers200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetServiceTransfers200Response.class);
  }

  /**
   * Convert an instance of GetServiceTransfers200Response to an JSON string
   *
   * @return JSON string
   */
