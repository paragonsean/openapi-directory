...
public class CreatePayPalPayment200Response {
  public static final String SERIALIZED_NAME_CHECKOUT_TOKEN = "checkout_token";
  ...
  public CreatePayPalPayment200Response() {
  }
  ...
  public CreatePayPalPayment200Response paymentId(String paymentId) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePayPalPayment200Response createPayPalPayment200Response = (CreatePayPalPayment200Response) o;
    return Objects.equals(this.checkoutToken, createPayPalPayment200Response.checkoutToken) &&
        Objects.equals(this.paymentId, createPayPalPayment200Response.paymentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkoutToken, paymentId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePayPalPayment200Response {\n");
  ...
  static {
    ...
    openapiFields.add("checkout_token");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePayPalPayment200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePayPalPayment200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePayPalPayment200Response is not found in the empty JSON string", CreatePayPalPayment200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePayPalPayment200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePayPalPayment200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("checkout_token") != null && !jsonObj.get("checkout_token").isJsonNull()) && !jsonObj.get("checkout_token").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `checkout_token` to be a primitive type in the JSON string but got `%s`", jsonObj.get("checkout_token").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePayPalPayment200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePayPalPayment200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePayPalPayment200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePayPalPayment200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePayPalPayment200Response>() {
           @Override
           public void write(JsonWriter out, CreatePayPalPayment200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePayPalPayment200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePayPalPayment200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePayPalPayment200Response
   * @throws IOException if the JSON string is invalid with respect to CreatePayPalPayment200Response
   */
  public static CreatePayPalPayment200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePayPalPayment200Response.class);
  }

  /**
   * Convert an instance of CreatePayPalPayment200Response to an JSON string
   *
   * @return JSON string
   */
