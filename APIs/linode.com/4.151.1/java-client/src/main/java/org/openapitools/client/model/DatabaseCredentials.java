...
public class DatabaseCredentials {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseCredentials databaseCredentials = (DatabaseCredentials) o;
    return Objects.equals(this.password, databaseCredentials.password) &&
        Objects.equals(this.username, databaseCredentials.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseCredentials is not found in the empty JSON string", DatabaseCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseCredentials>() {
           @Override
           public void write(JsonWriter out, DatabaseCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseCredentials
   * @throws IOException if the JSON string is invalid with respect to DatabaseCredentials
   */
  public static DatabaseCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseCredentials.class);
  }

  /**
   * Convert an instance of DatabaseCredentials to an JSON string
   *
   * @return JSON string
   */
