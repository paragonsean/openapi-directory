...
public class CreatePersonalAccessTokenRequest {
  ...
  public CreatePersonalAccessTokenRequest expiry(OffsetDateTime expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public CreatePersonalAccessTokenRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePersonalAccessTokenRequest createPersonalAccessTokenRequest = (CreatePersonalAccessTokenRequest) o;
    return Objects.equals(this.expiry, createPersonalAccessTokenRequest.expiry) &&
        Objects.equals(this.label, createPersonalAccessTokenRequest.label) &&
        Objects.equals(this.scopes, createPersonalAccessTokenRequest.scopes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiry, label, scopes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePersonalAccessTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePersonalAccessTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePersonalAccessTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePersonalAccessTokenRequest is not found in the empty JSON string", CreatePersonalAccessTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePersonalAccessTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePersonalAccessTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePersonalAccessTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePersonalAccessTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePersonalAccessTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePersonalAccessTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePersonalAccessTokenRequest>() {
           @Override
           public void write(JsonWriter out, CreatePersonalAccessTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePersonalAccessTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePersonalAccessTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePersonalAccessTokenRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePersonalAccessTokenRequest
   */
  public static CreatePersonalAccessTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePersonalAccessTokenRequest.class);
  }

  /**
   * Convert an instance of CreatePersonalAccessTokenRequest to an JSON string
   *
   * @return JSON string
   */
