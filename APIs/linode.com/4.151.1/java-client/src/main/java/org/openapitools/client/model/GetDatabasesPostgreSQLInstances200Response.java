...
public class GetDatabasesPostgreSQLInstances200Response {
  ...
  private List<DatabasePostgreSQL> data = new ArrayList<>();

  public GetDatabasesPostgreSQLInstances200Response() {
  }
  ...
  public GetDatabasesPostgreSQLInstances200Response data(List<DatabasePostgreSQL> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesPostgreSQLInstances200Response addDataItem(DatabasePostgreSQL dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabasePostgreSQL> getData() {
    return data;
  }

  public void setData(List<DatabasePostgreSQL> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesPostgreSQLInstances200Response getDatabasesPostgreSQLInstances200Response = (GetDatabasesPostgreSQLInstances200Response) o;
    return Objects.equals(this.page, getDatabasesPostgreSQLInstances200Response.page) &&
        Objects.equals(this.pages, getDatabasesPostgreSQLInstances200Response.pages) &&
        Objects.equals(this.results, getDatabasesPostgreSQLInstances200Response.results) &&
        Objects.equals(this.data, getDatabasesPostgreSQLInstances200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesPostgreSQLInstances200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesPostgreSQLInstances200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesPostgreSQLInstances200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesPostgreSQLInstances200Response is not found in the empty JSON string", GetDatabasesPostgreSQLInstances200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesPostgreSQLInstances200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesPostgreSQLInstances200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabasePostgreSQL.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesPostgreSQLInstances200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesPostgreSQLInstances200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesPostgreSQLInstances200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesPostgreSQLInstances200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesPostgreSQLInstances200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesPostgreSQLInstances200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesPostgreSQLInstances200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesPostgreSQLInstances200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesPostgreSQLInstances200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesPostgreSQLInstances200Response
   */
  public static GetDatabasesPostgreSQLInstances200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesPostgreSQLInstances200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesPostgreSQLInstances200Response to an JSON string
   *
   * @return JSON string
   */
