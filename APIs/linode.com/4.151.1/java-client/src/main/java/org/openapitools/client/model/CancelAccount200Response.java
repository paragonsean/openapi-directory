...
public class CancelAccount200Response {
  public static final String SERIALIZED_NAME_SURVEY_LINK = "survey_link";
  @SerializedName(SERIALIZED_NAME_SURVEY_LINK)
  private String surveyLink;

  public CancelAccount200Response() {
  }

  public CancelAccount200Response surveyLink(String surveyLink) {
  ...
  public boolean equals(Object o) {
    ...
    CancelAccount200Response cancelAccount200Response = (CancelAccount200Response) o;
    return Objects.equals(this.surveyLink, cancelAccount200Response.surveyLink);
  }

  @Override
  public int hashCode() {
    return Objects.hash(surveyLink);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelAccount200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelAccount200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelAccount200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelAccount200Response is not found in the empty JSON string", CancelAccount200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelAccount200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelAccount200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelAccount200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelAccount200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelAccount200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelAccount200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelAccount200Response>() {
           @Override
           public void write(JsonWriter out, CancelAccount200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelAccount200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelAccount200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelAccount200Response
   * @throws IOException if the JSON string is invalid with respect to CancelAccount200Response
   */
  public static CancelAccount200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelAccount200Response.class);
  }

  /**
   * Convert an instance of CancelAccount200Response to an JSON string
   *
   * @return JSON string
   */
