...
import org.openapitools.client.model.CreateNodeBalancerRequestConfigsInner;
...
public class CreateNodeBalancerRequest {
  public static final String SERIALIZED_NAME_CLIENT_CONN_THROTTLE = "client_conn_throttle";
  @SerializedName(SERIALIZED_NAME_CLIENT_CONN_THROTTLE)
  ...
  private List<CreateNodeBalancerRequestConfigsInner> configs = new ArrayList<>();
  ...
  public CreateNodeBalancerRequest() {
  }

  public CreateNodeBalancerRequest clientConnThrottle(Integer clientConnThrottle) {
  ...
  public void setClientConnThrottle(Integer clientConnThrottle) {
    this.clientConnThrottle = clientConnThrottle;
  }


  public CreateNodeBalancerRequest configs(List<CreateNodeBalancerRequestConfigsInner> configs) {
    this.configs = configs;
    return this;
  }

  public CreateNodeBalancerRequest addConfigsItem(CreateNodeBalancerRequestConfigsInner configsItem) {
  ...
  /**
   * The port Config(s) to create for this NodeBalancer.  Each Config must have a unique port and at least one Node. 
   * @return configs
   */
  @javax.annotation.Nullable
  public List<CreateNodeBalancerRequestConfigsInner> getConfigs() {
    return configs;
  }

  public void setConfigs(List<CreateNodeBalancerRequestConfigsInner> configs) {
    this.configs = configs;
  }


  public CreateNodeBalancerRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CreateNodeBalancerRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateNodeBalancerRequest createNodeBalancerRequest = (CreateNodeBalancerRequest) o;
    return Objects.equals(this.clientConnThrottle, createNodeBalancerRequest.clientConnThrottle) &&
        Objects.equals(this.configs, createNodeBalancerRequest.configs) &&
        Objects.equals(this.label, createNodeBalancerRequest.label) &&
        Objects.equals(this.region, createNodeBalancerRequest.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientConnThrottle, configs, label, region);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateNodeBalancerRequest {\n");
    sb.append("    clientConnThrottle: ").append(toIndentedString(clientConnThrottle)).append("\n");
  ...
  static {
    ...
    openapiFields.add("client_conn_throttle");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNodeBalancerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNodeBalancerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNodeBalancerRequest is not found in the empty JSON string", CreateNodeBalancerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNodeBalancerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNodeBalancerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateNodeBalancerRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("configs") != null && !jsonObj.get("configs").isJsonNull()) {
        ...
        if (jsonArrayconfigs != null) {
          ...
          for (int i = 0; i < jsonArrayconfigs.size(); i++) {
            CreateNodeBalancerRequestConfigsInner.validateJsonElement(jsonArrayconfigs.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNodeBalancerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNodeBalancerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNodeBalancerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNodeBalancerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNodeBalancerRequest>() {
           @Override
           public void write(JsonWriter out, CreateNodeBalancerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNodeBalancerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNodeBalancerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNodeBalancerRequest
   * @throws IOException if the JSON string is invalid with respect to CreateNodeBalancerRequest
   */
  public static CreateNodeBalancerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNodeBalancerRequest.class);
  }

  /**
   * Convert an instance of CreateNodeBalancerRequest to an JSON string
   *
   * @return JSON string
   */
