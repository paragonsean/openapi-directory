...
public class GetEntityTransfers200Response {
  ...
  private List<EntityTransfer> data = new ArrayList<>();

  public GetEntityTransfers200Response() {
  }
  ...
  public GetEntityTransfers200Response data(List<EntityTransfer> data) {
    this.data = data;
    return this;
  }

  public GetEntityTransfers200Response addDataItem(EntityTransfer dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EntityTransfer> getData() {
    return data;
  }

  public void setData(List<EntityTransfer> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetEntityTransfers200Response getEntityTransfers200Response = (GetEntityTransfers200Response) o;
    return Objects.equals(this.page, getEntityTransfers200Response.page) &&
        Objects.equals(this.pages, getEntityTransfers200Response.pages) &&
        Objects.equals(this.results, getEntityTransfers200Response.results) &&
        Objects.equals(this.data, getEntityTransfers200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEntityTransfers200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEntityTransfers200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEntityTransfers200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEntityTransfers200Response is not found in the empty JSON string", GetEntityTransfers200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEntityTransfers200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEntityTransfers200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            EntityTransfer.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEntityTransfers200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEntityTransfers200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEntityTransfers200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEntityTransfers200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEntityTransfers200Response>() {
           @Override
           public void write(JsonWriter out, GetEntityTransfers200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEntityTransfers200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEntityTransfers200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEntityTransfers200Response
   * @throws IOException if the JSON string is invalid with respect to GetEntityTransfers200Response
   */
  public static GetEntityTransfers200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEntityTransfers200Response.class);
  }

  /**
   * Convert an instance of GetEntityTransfers200Response to an JSON string
   *
   * @return JSON string
   */
