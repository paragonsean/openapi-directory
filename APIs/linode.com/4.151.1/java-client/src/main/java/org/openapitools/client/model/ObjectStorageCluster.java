...
public class ObjectStorageCluster {
  ...
  public static final String SERIALIZED_NAME_STATIC_SITE_DOMAIN = "static_site_domain";
  @SerializedName(SERIALIZED_NAME_STATIC_SITE_DOMAIN)
  ...
  public ObjectStorageCluster() {
  }

  public ObjectStorageCluster domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ObjectStorageCluster id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ObjectStorageCluster region(String region) {
    this.region = region;
    return this;
  }
  ...
  public ObjectStorageCluster staticSiteDomain(String staticSiteDomain) {
   ...
   * @return staticSiteDomain
   */
  @javax.annotation.Nullable
  public String getStaticSiteDomain() {
    return staticSiteDomain;
  }

  public void setStaticSiteDomain(String staticSiteDomain) {
    this.staticSiteDomain = staticSiteDomain;
  }


  public ObjectStorageCluster status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjectStorageCluster objectStorageCluster = (ObjectStorageCluster) o;
    return Objects.equals(this.domain, objectStorageCluster.domain) &&
        Objects.equals(this.id, objectStorageCluster.id) &&
        Objects.equals(this.region, objectStorageCluster.region) &&
        Objects.equals(this.staticSiteDomain, objectStorageCluster.staticSiteDomain) &&
        Objects.equals(this.status, objectStorageCluster.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, id, region, staticSiteDomain, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjectStorageCluster {\n");
    sb.append("    domain: ").append(toIndentedString(domain)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    region: ").append(toIndentedString(region)).append("\n");
    sb.append("    staticSiteDomain: ").append(toIndentedString(staticSiteDomain)).append("\n");
  ...
  static {
    ...
    openapiFields.add("static_site_domain");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageCluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageCluster is not found in the empty JSON string", ObjectStorageCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("static_site_domain") != null && !jsonObj.get("static_site_domain").isJsonNull()) && !jsonObj.get("static_site_domain").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `static_site_domain` to be a primitive type in the JSON string but got `%s`", jsonObj.get("static_site_domain").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageCluster>() {
           @Override
           public void write(JsonWriter out, ObjectStorageCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageCluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageCluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageCluster
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageCluster
   */
  public static ObjectStorageCluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageCluster.class);
  }

  /**
   * Convert an instance of ObjectStorageCluster to an JSON string
   *
   * @return JSON string
   */
