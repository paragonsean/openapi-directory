...
public class CreditCardData {
  ...
  public boolean equals(Object o) {
    ...
    CreditCardData creditCardData = (CreditCardData) o;
    return Objects.equals(this.cardType, creditCardData.cardType) &&
        Objects.equals(this.expiry, creditCardData.expiry) &&
        Objects.equals(this.lastFour, creditCardData.lastFour);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardType, expiry, lastFour);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreditCardData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreditCardData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreditCardData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditCardData is not found in the empty JSON string", CreditCardData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreditCardData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditCardData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditCardData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditCardData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditCardData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditCardData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditCardData>() {
           @Override
           public void write(JsonWriter out, CreditCardData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreditCardData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreditCardData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreditCardData
   * @throws IOException if the JSON string is invalid with respect to CreditCardData
   */
  public static CreditCardData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditCardData.class);
  }

  /**
   * Convert an instance of CreditCardData to an JSON string
   *
   * @return JSON string
   */
