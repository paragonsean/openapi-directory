...
public class AccountCreditCard {
  ...
  public AccountCreditCard expiry(String expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public AccountCreditCard lastFour(String lastFour) {
  ...
  public boolean equals(Object o) {
    ...
    AccountCreditCard accountCreditCard = (AccountCreditCard) o;
    return Objects.equals(this.expiry, accountCreditCard.expiry) &&
        Objects.equals(this.lastFour, accountCreditCard.lastFour);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiry, lastFour);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountCreditCard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountCreditCard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountCreditCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountCreditCard is not found in the empty JSON string", AccountCreditCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountCreditCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountCreditCard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountCreditCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountCreditCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountCreditCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountCreditCard.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountCreditCard>() {
           @Override
           public void write(JsonWriter out, AccountCreditCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountCreditCard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountCreditCard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountCreditCard
   * @throws IOException if the JSON string is invalid with respect to AccountCreditCard
   */
  public static AccountCreditCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountCreditCard.class);
  }

  /**
   * Convert an instance of AccountCreditCard to an JSON string
   *
   * @return JSON string
   */
