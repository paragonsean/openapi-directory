...
public class IPAddressV6Slaac {
  ...
  public IPAddressV6Slaac rdns(String rdns) {
    this.rdns = rdns;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPAddressV6Slaac ipAddressV6Slaac = (IPAddressV6Slaac) o;
    return Objects.equals(this.address, ipAddressV6Slaac.address) &&
        Objects.equals(this.gateway, ipAddressV6Slaac.gateway) &&
        Objects.equals(this.linodeId, ipAddressV6Slaac.linodeId) &&
        Objects.equals(this.prefix, ipAddressV6Slaac.prefix) &&
        Objects.equals(this._public, ipAddressV6Slaac._public) &&
        Objects.equals(this.rdns, ipAddressV6Slaac.rdns) &&
        Objects.equals(this.region, ipAddressV6Slaac.region) &&
        Objects.equals(this.subnetMask, ipAddressV6Slaac.subnetMask) &&
        Objects.equals(this.type, ipAddressV6Slaac.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, gateway, linodeId, prefix, _public, rdns, region, subnetMask, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPAddressV6Slaac {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPAddressV6Slaac
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAddressV6Slaac.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPAddressV6Slaac is not found in the empty JSON string", IPAddressV6Slaac.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPAddressV6Slaac.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPAddressV6Slaac` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("subnet_mask") != null && !jsonObj.get("subnet_mask").isJsonNull()) && !jsonObj.get("subnet_mask").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `subnet_mask` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subnet_mask").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAddressV6Slaac.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAddressV6Slaac' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAddressV6Slaac> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAddressV6Slaac.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAddressV6Slaac>() {
           @Override
           public void write(JsonWriter out, IPAddressV6Slaac value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPAddressV6Slaac read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPAddressV6Slaac given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPAddressV6Slaac
   * @throws IOException if the JSON string is invalid with respect to IPAddressV6Slaac
   */
  public static IPAddressV6Slaac fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAddressV6Slaac.class);
  }

  /**
   * Convert an instance of IPAddressV6Slaac to an JSON string
   *
   * @return JSON string
   */
