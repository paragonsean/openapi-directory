...
public class LKEClusterControlPlane {
  ...
  public LKEClusterControlPlane() {
  }

  public LKEClusterControlPlane highAvailability(Boolean highAvailability) {
  ...
  public boolean equals(Object o) {
    ...
    LKEClusterControlPlane lkEClusterControlPlane = (LKEClusterControlPlane) o;
    return Objects.equals(this.highAvailability, lkEClusterControlPlane.highAvailability);
  }
  ...
  public String toString() {
    ...
    sb.append("class LKEClusterControlPlane {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKEClusterControlPlane
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKEClusterControlPlane.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKEClusterControlPlane is not found in the empty JSON string", LKEClusterControlPlane.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKEClusterControlPlane.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKEClusterControlPlane` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKEClusterControlPlane.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKEClusterControlPlane' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKEClusterControlPlane> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKEClusterControlPlane.class));

       return (TypeAdapter<T>) new TypeAdapter<LKEClusterControlPlane>() {
           @Override
           public void write(JsonWriter out, LKEClusterControlPlane value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKEClusterControlPlane read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKEClusterControlPlane given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKEClusterControlPlane
   * @throws IOException if the JSON string is invalid with respect to LKEClusterControlPlane
   */
  public static LKEClusterControlPlane fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKEClusterControlPlane.class);
  }

  /**
   * Convert an instance of LKEClusterControlPlane to an JSON string
   *
   * @return JSON string
   */
