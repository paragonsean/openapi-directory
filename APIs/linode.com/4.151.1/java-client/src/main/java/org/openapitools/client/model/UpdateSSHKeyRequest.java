...
public class UpdateSSHKeyRequest {
  ...
  public UpdateSSHKeyRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, updateSSHKeyRequest.label);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSSHKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSSHKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSSHKeyRequest is not found in the empty JSON string", UpdateSSHKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSSHKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSSHKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSSHKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSSHKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSSHKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSSHKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSSHKeyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSSHKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSSHKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSSHKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSSHKeyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateSSHKeyRequest
   */
  public static UpdateSSHKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSSHKeyRequest.class);
  }

  /**
   * Convert an instance of UpdateSSHKeyRequest to an JSON string
   *
   * @return JSON string
   */
