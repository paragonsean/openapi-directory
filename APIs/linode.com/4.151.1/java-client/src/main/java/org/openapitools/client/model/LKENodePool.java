...
import org.openapitools.client.model.LKENodePoolAutoscaler;
import org.openapitools.client.model.LKENodePoolDisksInner;
import org.openapitools.client.model.LKENodeStatus;
...
public class LKENodePool {
  ...
  private LKENodePoolAutoscaler autoscaler;
  ...
  private List<LKENodePoolDisksInner> disks = new ArrayList<>();
  ...
  private List<LKENodeStatus> nodes = new ArrayList<>();
  ...
  public LKENodePool autoscaler(LKENodePoolAutoscaler autoscaler) {
  ...
  public LKENodePoolAutoscaler getAutoscaler() {
    return autoscaler;
  }

  public void setAutoscaler(LKENodePoolAutoscaler autoscaler) {
    this.autoscaler = autoscaler;
  }


  public LKENodePool count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public LKENodePool disks(List<LKENodePoolDisksInner> disks) {
    this.disks = disks;
    return this;
  }

  public LKENodePool addDisksItem(LKENodePoolDisksInner disksItem) {
    if (this.disks == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<LKENodePoolDisksInner> getDisks() {
    return disks;
  }

  public void setDisks(List<LKENodePoolDisksInner> disks) {
    this.disks = disks;
  }


  public LKENodePool id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LKENodePool nodes(List<LKENodeStatus> nodes) {
    this.nodes = nodes;
    return this;
  }

  public LKENodePool addNodesItem(LKENodeStatus nodesItem) {
    if (this.nodes == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<LKENodeStatus> getNodes() {
    return nodes;
  }

  public void setNodes(List<LKENodeStatus> nodes) {
    this.nodes = nodes;
  }


  public LKENodePool tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public LKENodePool addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public LKENodePool type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodePool lkENodePool = (LKENodePool) o;
    return Objects.equals(this.autoscaler, lkENodePool.autoscaler) &&
        Objects.equals(this.count, lkENodePool.count) &&
        Objects.equals(this.disks, lkENodePool.disks) &&
        Objects.equals(this.id, lkENodePool.id) &&
        Objects.equals(this.nodes, lkENodePool.nodes) &&
        Objects.equals(this.tags, lkENodePool.tags) &&
        Objects.equals(this.type, lkENodePool.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoscaler, count, disks, id, nodes, tags, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LKENodePool {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodePool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodePool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodePool is not found in the empty JSON string", LKENodePool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodePool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodePool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `autoscaler`
      if (jsonObj.get("autoscaler") != null && !jsonObj.get("autoscaler").isJsonNull()) {
        LKENodePoolAutoscaler.validateJsonElement(jsonObj.get("autoscaler"));
      }
      if (jsonObj.get("disks") != null && !jsonObj.get("disks").isJsonNull()) {
        ...
        if (jsonArraydisks != null) {
          ...
          for (int i = 0; i < jsonArraydisks.size(); i++) {
            LKENodePoolDisksInner.validateJsonElement(jsonArraydisks.get(i));
          };
        }
      }
      if (jsonObj.get("nodes") != null && !jsonObj.get("nodes").isJsonNull()) {
        ...
        if (jsonArraynodes != null) {
          ...
          for (int i = 0; i < jsonArraynodes.size(); i++) {
            LKENodeStatus.validateJsonElement(jsonArraynodes.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodePool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodePool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodePool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodePool.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodePool>() {
           @Override
           public void write(JsonWriter out, LKENodePool value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodePool read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodePool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodePool
   * @throws IOException if the JSON string is invalid with respect to LKENodePool
   */
  public static LKENodePool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodePool.class);
  }

  /**
   * Convert an instance of LKENodePool to an JSON string
   *
   * @return JSON string
   */
