...
public class NodeBalancerConfigNodesStatus {
  ...
  public NodeBalancerConfigNodesStatus() {
  }
  ...
  public boolean equals(Object o) {
    ...
    NodeBalancerConfigNodesStatus nodeBalancerConfigNodesStatus = (NodeBalancerConfigNodesStatus) o;
    return Objects.equals(this.down, nodeBalancerConfigNodesStatus.down) &&
        Objects.equals(this.up, nodeBalancerConfigNodesStatus.up);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeBalancerConfigNodesStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeBalancerConfigNodesStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeBalancerConfigNodesStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeBalancerConfigNodesStatus is not found in the empty JSON string", NodeBalancerConfigNodesStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeBalancerConfigNodesStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeBalancerConfigNodesStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeBalancerConfigNodesStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeBalancerConfigNodesStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeBalancerConfigNodesStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeBalancerConfigNodesStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeBalancerConfigNodesStatus>() {
           @Override
           public void write(JsonWriter out, NodeBalancerConfigNodesStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeBalancerConfigNodesStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeBalancerConfigNodesStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeBalancerConfigNodesStatus
   * @throws IOException if the JSON string is invalid with respect to NodeBalancerConfigNodesStatus
   */
  public static NodeBalancerConfigNodesStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeBalancerConfigNodesStatus.class);
  }

  /**
   * Convert an instance of NodeBalancerConfigNodesStatus to an JSON string
   *
   * @return JSON string
   */
