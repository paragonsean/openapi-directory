...
public class CreateTagRequest {
  ...
  public static final String SERIALIZED_NAME_NODEBALANCERS = "nodebalancers";
  @SerializedName(SERIALIZED_NAME_NODEBALANCERS)
  private List<Integer> nodebalancers = new ArrayList<>();
  ...
  public CreateTagRequest domains(List<Integer> domains) {
    this.domains = domains;
    return this;
  }

  public CreateTagRequest addDomainsItem(Integer domainsItem) {
  ...
  public CreateTagRequest linodes(List<Integer> linodes) {
    this.linodes = linodes;
    return this;
  }

  public CreateTagRequest addLinodesItem(Integer linodesItem) {
  ...
  public CreateTagRequest nodebalancers(List<Integer> nodebalancers) {
    this.nodebalancers = nodebalancers;
    return this;
  }

  public CreateTagRequest addNodebalancersItem(Integer nodebalancersItem) {
    if (this.nodebalancers == null) {
      this.nodebalancers = new ArrayList<>();
    }
    this.nodebalancers.add(nodebalancersItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Integer> getNodebalancers() {
    return nodebalancers;
  }

  public void setNodebalancers(List<Integer> nodebalancers) {
    this.nodebalancers = nodebalancers;
  }


  public CreateTagRequest volumes(List<Integer> volumes) {
    this.volumes = volumes;
    return this;
  }

  public CreateTagRequest addVolumesItem(Integer volumesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domains, createTagRequest.domains) &&
        Objects.equals(this.label, createTagRequest.label) &&
        Objects.equals(this.linodes, createTagRequest.linodes) &&
        Objects.equals(this.nodebalancers, createTagRequest.nodebalancers) &&
        Objects.equals(this.volumes, createTagRequest.volumes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domains, label, linodes, nodebalancers, volumes);
  }
  ...
  public String toString() {
    ...
    sb.append("    nodebalancers: ").append(toIndentedString(nodebalancers)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nodebalancers");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("nodebalancers") != null && !jsonObj.get("nodebalancers").isJsonNull() && !jsonObj.get("nodebalancers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `nodebalancers` to be an array in the JSON string but got `%s`", jsonObj.get("nodebalancers").toString()));
      }
      // ensure the optional json data is an array if present
