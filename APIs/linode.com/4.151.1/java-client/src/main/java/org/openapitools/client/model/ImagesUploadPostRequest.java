...
public class ImagesUploadPostRequest {
  ...
  public ImagesUploadPostRequest() {
  }

  public ImagesUploadPostRequest description(String description) {
  ...
  public ImagesUploadPostRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public ImagesUploadPostRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImagesUploadPostRequest imagesUploadPostRequest = (ImagesUploadPostRequest) o;
    return Objects.equals(this.description, imagesUploadPostRequest.description) &&
        Objects.equals(this.label, imagesUploadPostRequest.label) &&
        Objects.equals(this.region, imagesUploadPostRequest.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, label, region);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImagesUploadPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImagesUploadPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImagesUploadPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUploadPostRequest is not found in the empty JSON string", ImagesUploadPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImagesUploadPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImagesUploadPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesUploadPostRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUploadPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUploadPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUploadPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUploadPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUploadPostRequest>() {
           @Override
           public void write(JsonWriter out, ImagesUploadPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImagesUploadPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImagesUploadPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImagesUploadPostRequest
   * @throws IOException if the JSON string is invalid with respect to ImagesUploadPostRequest
   */
  public static ImagesUploadPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUploadPostRequest.class);
  }

  /**
   * Convert an instance of ImagesUploadPostRequest to an JSON string
   *
   * @return JSON string
   */
