...
public class PostProfilePhoneNumberVerifyRequest {
  public static final String SERIALIZED_NAME_OTP_CODE = "otp_code";
  @SerializedName(SERIALIZED_NAME_OTP_CODE)
  private String otpCode;

  public PostProfilePhoneNumberVerifyRequest() {
  }

  public PostProfilePhoneNumberVerifyRequest otpCode(String otpCode) {
  ...
  public boolean equals(Object o) {
    ...
    PostProfilePhoneNumberVerifyRequest postProfilePhoneNumberVerifyRequest = (PostProfilePhoneNumberVerifyRequest) o;
    return Objects.equals(this.otpCode, postProfilePhoneNumberVerifyRequest.otpCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostProfilePhoneNumberVerifyRequest {\n");
  ...
  static {
    ...
    openapiFields.add("otp_code");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("otp_code");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostProfilePhoneNumberVerifyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostProfilePhoneNumberVerifyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostProfilePhoneNumberVerifyRequest is not found in the empty JSON string", PostProfilePhoneNumberVerifyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostProfilePhoneNumberVerifyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostProfilePhoneNumberVerifyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostProfilePhoneNumberVerifyRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("otp_code").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostProfilePhoneNumberVerifyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostProfilePhoneNumberVerifyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostProfilePhoneNumberVerifyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostProfilePhoneNumberVerifyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostProfilePhoneNumberVerifyRequest>() {
           @Override
           public void write(JsonWriter out, PostProfilePhoneNumberVerifyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostProfilePhoneNumberVerifyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostProfilePhoneNumberVerifyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostProfilePhoneNumberVerifyRequest
   * @throws IOException if the JSON string is invalid with respect to PostProfilePhoneNumberVerifyRequest
   */
  public static PostProfilePhoneNumberVerifyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostProfilePhoneNumberVerifyRequest.class);
  }

  /**
   * Convert an instance of PostProfilePhoneNumberVerifyRequest to an JSON string
   *
   * @return JSON string
   */
