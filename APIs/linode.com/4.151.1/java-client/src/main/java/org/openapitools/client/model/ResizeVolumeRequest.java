...
public class ResizeVolumeRequest {
  ...
  public ResizeVolumeRequest size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, resizeVolumeRequest.size);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ResizeVolumeRequest.openapiRequiredFields) {
