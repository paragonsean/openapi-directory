...
public class GetDatabasesTypes200Response {
  ...
  private List<DatabaseType> data = new ArrayList<>();

  public GetDatabasesTypes200Response() {
  }
  ...
  public GetDatabasesTypes200Response data(List<DatabaseType> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesTypes200Response addDataItem(DatabaseType dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseType> getData() {
    return data;
  }

  public void setData(List<DatabaseType> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesTypes200Response getDatabasesTypes200Response = (GetDatabasesTypes200Response) o;
    return Objects.equals(this.page, getDatabasesTypes200Response.page) &&
        Objects.equals(this.pages, getDatabasesTypes200Response.pages) &&
        Objects.equals(this.results, getDatabasesTypes200Response.results) &&
        Objects.equals(this.data, getDatabasesTypes200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesTypes200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesTypes200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesTypes200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesTypes200Response is not found in the empty JSON string", GetDatabasesTypes200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesTypes200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesTypes200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabaseType.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesTypes200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesTypes200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesTypes200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesTypes200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesTypes200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesTypes200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesTypes200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesTypes200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesTypes200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesTypes200Response
   */
  public static GetDatabasesTypes200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesTypes200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesTypes200Response to an JSON string
   *
   * @return JSON string
   */
