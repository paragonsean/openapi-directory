...
import org.openapitools.client.model.FirewallRuleConfigAddresses;
...
public class FirewallRuleConfig {
  ...
  private FirewallRuleConfigAddresses addresses;
  ...
  public FirewallRuleConfig() {
  }

  public FirewallRuleConfig action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public FirewallRuleConfig addresses(FirewallRuleConfigAddresses addresses) {
   ...
   */
  @javax.annotation.Nullable
  public FirewallRuleConfigAddresses getAddresses() {
    return addresses;
  }

  public void setAddresses(FirewallRuleConfigAddresses addresses) {
    this.addresses = addresses;
  }


  public FirewallRuleConfig description(String description) {
  ...
  public FirewallRuleConfig label(String label) {
    this.label = label;
    return this;
  }
  ...
  public FirewallRuleConfig ports(String ports) {
    this.ports = ports;
    return this;
  }
  ...
  public FirewallRuleConfig protocol(ProtocolEnum protocol) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallRuleConfig firewallRuleConfig = (FirewallRuleConfig) o;
    return Objects.equals(this.action, firewallRuleConfig.action) &&
        Objects.equals(this.addresses, firewallRuleConfig.addresses) &&
        Objects.equals(this.description, firewallRuleConfig.description) &&
        Objects.equals(this.label, firewallRuleConfig.label) &&
        Objects.equals(this.ports, firewallRuleConfig.ports) &&
        Objects.equals(this.protocol, firewallRuleConfig.protocol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, addresses, description, label, ports, protocol);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallRuleConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallRuleConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallRuleConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRuleConfig is not found in the empty JSON string", FirewallRuleConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallRuleConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallRuleConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("addresses") != null && !jsonObj.get("addresses").isJsonNull()) {
        FirewallRuleConfigAddresses.validateJsonElement(jsonObj.get("addresses"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRuleConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRuleConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRuleConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRuleConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRuleConfig>() {
           @Override
           public void write(JsonWriter out, FirewallRuleConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallRuleConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallRuleConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallRuleConfig
   * @throws IOException if the JSON string is invalid with respect to FirewallRuleConfig
   */
  public static FirewallRuleConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRuleConfig.class);
  }

  /**
   * Convert an instance of FirewallRuleConfig to an JSON string
   *
   * @return JSON string
   */
