...
public class InvoiceTaxSummaryInner {
  ...
  public InvoiceTaxSummaryInner() {
  }

  public InvoiceTaxSummaryInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public InvoiceTaxSummaryInner tax(BigDecimal tax) {
    this.tax = tax;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InvoiceTaxSummaryInner invoiceTaxSummaryInner = (InvoiceTaxSummaryInner) o;
    return Objects.equals(this.name, invoiceTaxSummaryInner.name) &&
        Objects.equals(this.tax, invoiceTaxSummaryInner.tax);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceTaxSummaryInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceTaxSummaryInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceTaxSummaryInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceTaxSummaryInner is not found in the empty JSON string", InvoiceTaxSummaryInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceTaxSummaryInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceTaxSummaryInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceTaxSummaryInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceTaxSummaryInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceTaxSummaryInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceTaxSummaryInner.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceTaxSummaryInner>() {
           @Override
           public void write(JsonWriter out, InvoiceTaxSummaryInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceTaxSummaryInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceTaxSummaryInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceTaxSummaryInner
   * @throws IOException if the JSON string is invalid with respect to InvoiceTaxSummaryInner
   */
  public static InvoiceTaxSummaryInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceTaxSummaryInner.class);
  }

  /**
   * Convert an instance of InvoiceTaxSummaryInner to an JSON string
   *
   * @return JSON string
   */
