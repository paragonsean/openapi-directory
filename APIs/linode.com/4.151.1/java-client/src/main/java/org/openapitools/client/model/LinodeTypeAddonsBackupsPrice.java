...
public class LinodeTypeAddonsBackupsPrice {
  ...
  public LinodeTypeAddonsBackupsPrice() {
  }

  public LinodeTypeAddonsBackupsPrice hourly(BigDecimal hourly) {
    this.hourly = hourly;
    return this;
  }
  ...
  public LinodeTypeAddonsBackupsPrice monthly(BigDecimal monthly) {
  ...
  public boolean equals(Object o) {
    ...
    LinodeTypeAddonsBackupsPrice linodeTypeAddonsBackupsPrice = (LinodeTypeAddonsBackupsPrice) o;
    return Objects.equals(this.hourly, linodeTypeAddonsBackupsPrice.hourly) &&
        Objects.equals(this.monthly, linodeTypeAddonsBackupsPrice.monthly);
  }
  ...
  public String toString() {
    ...
    sb.append("class LinodeTypeAddonsBackupsPrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeTypeAddonsBackupsPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeTypeAddonsBackupsPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeTypeAddonsBackupsPrice is not found in the empty JSON string", LinodeTypeAddonsBackupsPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeTypeAddonsBackupsPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeTypeAddonsBackupsPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeTypeAddonsBackupsPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeTypeAddonsBackupsPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeTypeAddonsBackupsPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeTypeAddonsBackupsPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeTypeAddonsBackupsPrice>() {
           @Override
           public void write(JsonWriter out, LinodeTypeAddonsBackupsPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeTypeAddonsBackupsPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeTypeAddonsBackupsPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeTypeAddonsBackupsPrice
   * @throws IOException if the JSON string is invalid with respect to LinodeTypeAddonsBackupsPrice
   */
  public static LinodeTypeAddonsBackupsPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeTypeAddonsBackupsPrice.class);
  }

  /**
   * Convert an instance of LinodeTypeAddonsBackupsPrice to an JSON string
   *
   * @return JSON string
   */
