...
public class UpdateFirewallRequest {
  ...
  /**
   * The status to be applied to this Firewall.    * When a Firewall is first created its status is &#x60;enabled&#x60;.  * Use the [Delete Firewall](/docs/api/networking/#firewall-delete) endpoint to delete a Firewall. 
   */
  ...
  public UpdateFirewallRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public UpdateFirewallRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateFirewallRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateFirewallRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, updateFirewallRequest.label) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(label, status, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallRequest is not found in the empty JSON string", UpdateFirewallRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallRequest
   */
  public static UpdateFirewallRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallRequest.class);
  }

  /**
   * Convert an instance of UpdateFirewallRequest to an JSON string
   *
   * @return JSON string
   */
