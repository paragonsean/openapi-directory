...
public class UpdateObjectStorageBucketAccessRequest {
  /**
  ...
  public UpdateObjectStorageBucketAccessRequest() {
  }

  public UpdateObjectStorageBucketAccessRequest acl(AclEnum acl) {
    this.acl = acl;
    return this;
  }
  ...
  public UpdateObjectStorageBucketAccessRequest corsEnabled(Boolean corsEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateObjectStorageBucketAccessRequest updateObjectStorageBucketAccessRequest = (UpdateObjectStorageBucketAccessRequest) o;
    return Objects.equals(this.acl, updateObjectStorageBucketAccessRequest.acl) &&
        Objects.equals(this.corsEnabled, updateObjectStorageBucketAccessRequest.corsEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acl, corsEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateObjectStorageBucketAccessRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateObjectStorageBucketAccessRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateObjectStorageBucketAccessRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateObjectStorageBucketAccessRequest is not found in the empty JSON string", UpdateObjectStorageBucketAccessRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateObjectStorageBucketAccessRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateObjectStorageBucketAccessRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateObjectStorageBucketAccessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateObjectStorageBucketAccessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateObjectStorageBucketAccessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateObjectStorageBucketAccessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateObjectStorageBucketAccessRequest>() {
           @Override
           public void write(JsonWriter out, UpdateObjectStorageBucketAccessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateObjectStorageBucketAccessRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateObjectStorageBucketAccessRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateObjectStorageBucketAccessRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateObjectStorageBucketAccessRequest
   */
  public static UpdateObjectStorageBucketAccessRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateObjectStorageBucketAccessRequest.class);
  }

  /**
   * Convert an instance of UpdateObjectStorageBucketAccessRequest to an JSON string
   *
   * @return JSON string
   */
