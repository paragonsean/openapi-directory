...
public class GetDevices200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<TrustedDevice> data = new ArrayList<>();
  ...
  public GetDevices200Response data(List<TrustedDevice> data) {
    this.data = data;
    return this;
  }

  public GetDevices200Response addDataItem(TrustedDevice dataItem) {
    if (this.data == null) {
  ...
  public List<TrustedDevice> getData() {
    return data;
  }

  public void setData(List<TrustedDevice> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDevices200Response getDevices200Response = (GetDevices200Response) o;
    return Objects.equals(this.data, getDevices200Response.data) &&
        Objects.equals(this.page, getDevices200Response.page) &&
        Objects.equals(this.pages, getDevices200Response.pages) &&
        Objects.equals(this.results, getDevices200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDevices200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDevices200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDevices200Response is not found in the empty JSON string", GetDevices200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDevices200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDevices200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            TrustedDevice.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDevices200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDevices200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDevices200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDevices200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDevices200Response>() {
           @Override
           public void write(JsonWriter out, GetDevices200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDevices200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDevices200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDevices200Response
   * @throws IOException if the JSON string is invalid with respect to GetDevices200Response
   */
  public static GetDevices200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDevices200Response.class);
  }

  /**
   * Convert an instance of GetDevices200Response to an JSON string
   *
   * @return JSON string
   */
