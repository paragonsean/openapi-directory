...
public class FirewallRuleConfigAddresses {
  ...
  public FirewallRuleConfigAddresses() {
  }

  public FirewallRuleConfigAddresses ipv4(List<String> ipv4) {
    this.ipv4 = ipv4;
    return this;
  }

  public FirewallRuleConfigAddresses addIpv4Item(String ipv4Item) {
    if (this.ipv4 == null) {
  ...
  public FirewallRuleConfigAddresses ipv6(List<String> ipv6) {
    this.ipv6 = ipv6;
    return this;
  }

  public FirewallRuleConfigAddresses addIpv6Item(String ipv6Item) {
    if (this.ipv6 == null) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallRuleConfigAddresses firewallRuleConfigAddresses = (FirewallRuleConfigAddresses) o;
    return Objects.equals(this.ipv4, firewallRuleConfigAddresses.ipv4) &&
        Objects.equals(this.ipv6, firewallRuleConfigAddresses.ipv6);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallRuleConfigAddresses {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallRuleConfigAddresses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallRuleConfigAddresses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRuleConfigAddresses is not found in the empty JSON string", FirewallRuleConfigAddresses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallRuleConfigAddresses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallRuleConfigAddresses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("ipv4") != null && !jsonObj.get("ipv4").isJsonNull() && !jsonObj.get("ipv4").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("ipv6") != null && !jsonObj.get("ipv6").isJsonNull() && !jsonObj.get("ipv6").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRuleConfigAddresses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRuleConfigAddresses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRuleConfigAddresses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRuleConfigAddresses.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRuleConfigAddresses>() {
           @Override
           public void write(JsonWriter out, FirewallRuleConfigAddresses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallRuleConfigAddresses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallRuleConfigAddresses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallRuleConfigAddresses
   * @throws IOException if the JSON string is invalid with respect to FirewallRuleConfigAddresses
   */
  public static FirewallRuleConfigAddresses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRuleConfigAddresses.class);
  }

  /**
   * Convert an instance of FirewallRuleConfigAddresses to an JSON string
   *
   * @return JSON string
   */
