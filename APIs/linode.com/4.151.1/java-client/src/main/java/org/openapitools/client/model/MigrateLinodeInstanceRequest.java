...
public class MigrateLinodeInstanceRequest {
  ...
  public MigrateLinodeInstanceRequest() {
  }

  public MigrateLinodeInstanceRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  public MigrateLinodeInstanceRequest upgrade(Boolean upgrade) {
  ...
  public boolean equals(Object o) {
    ...
    MigrateLinodeInstanceRequest migrateLinodeInstanceRequest = (MigrateLinodeInstanceRequest) o;
    return Objects.equals(this.region, migrateLinodeInstanceRequest.region) &&
        Objects.equals(this.upgrade, migrateLinodeInstanceRequest.upgrade);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, upgrade);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MigrateLinodeInstanceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MigrateLinodeInstanceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MigrateLinodeInstanceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MigrateLinodeInstanceRequest is not found in the empty JSON string", MigrateLinodeInstanceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MigrateLinodeInstanceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MigrateLinodeInstanceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MigrateLinodeInstanceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MigrateLinodeInstanceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MigrateLinodeInstanceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MigrateLinodeInstanceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MigrateLinodeInstanceRequest>() {
           @Override
           public void write(JsonWriter out, MigrateLinodeInstanceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MigrateLinodeInstanceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MigrateLinodeInstanceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MigrateLinodeInstanceRequest
   * @throws IOException if the JSON string is invalid with respect to MigrateLinodeInstanceRequest
   */
  public static MigrateLinodeInstanceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MigrateLinodeInstanceRequest.class);
  }

  /**
   * Convert an instance of MigrateLinodeInstanceRequest to an JSON string
   *
   * @return JSON string
   */
