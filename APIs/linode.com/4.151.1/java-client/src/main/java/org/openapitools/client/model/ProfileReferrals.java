...
public class ProfileReferrals {
  ...
  public boolean equals(Object o) {
    ...
    ProfileReferrals profileReferrals = (ProfileReferrals) o;
    return Objects.equals(this.code, profileReferrals.code) &&
        Objects.equals(this.completed, profileReferrals.completed) &&
        Objects.equals(this.credit, profileReferrals.credit) &&
        Objects.equals(this.pending, profileReferrals.pending) &&
        Objects.equals(this.total, profileReferrals.total) &&
        Objects.equals(this.url, profileReferrals.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, completed, credit, pending, total, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProfileReferrals {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileReferrals
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileReferrals.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileReferrals is not found in the empty JSON string", ProfileReferrals.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileReferrals.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileReferrals` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileReferrals.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileReferrals' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileReferrals> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileReferrals.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileReferrals>() {
           @Override
           public void write(JsonWriter out, ProfileReferrals value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileReferrals read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileReferrals given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileReferrals
   * @throws IOException if the JSON string is invalid with respect to ProfileReferrals
   */
  public static ProfileReferrals fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileReferrals.class);
  }

  /**
   * Convert an instance of ProfileReferrals to an JSON string
   *
   * @return JSON string
   */
