...
import org.openapitools.client.model.BackupDisksInner;
...
public class GetBackups200ResponseAutomaticInner {
  ...
  private List<BackupDisksInner> disks = new ArrayList<>();
  ...
  public GetBackups200ResponseAutomaticInner() {
  }
   ...
   */
  @javax.annotation.Nullable
  public List<BackupDisksInner> getDisks() {
    return disks;
  }
  ...
  public GetBackups200ResponseAutomaticInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public GetBackups200ResponseAutomaticInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBackups200ResponseAutomaticInner getBackups200ResponseAutomaticInner = (GetBackups200ResponseAutomaticInner) o;
    return Objects.equals(this.available, getBackups200ResponseAutomaticInner.available) &&
        Objects.equals(this.configs, getBackups200ResponseAutomaticInner.configs) &&
        Objects.equals(this.created, getBackups200ResponseAutomaticInner.created) &&
        Objects.equals(this.disks, getBackups200ResponseAutomaticInner.disks) &&
        Objects.equals(this.finished, getBackups200ResponseAutomaticInner.finished) &&
        Objects.equals(this.id, getBackups200ResponseAutomaticInner.id) &&
        Objects.equals(this.label, getBackups200ResponseAutomaticInner.label) &&
        Objects.equals(this.status, getBackups200ResponseAutomaticInner.status) &&
        Objects.equals(this.type, getBackups200ResponseAutomaticInner.type) &&
        Objects.equals(this.updated, getBackups200ResponseAutomaticInner.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(available, configs, created, disks, finished, id, label, status, type, updated);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBackups200ResponseAutomaticInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBackups200ResponseAutomaticInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBackups200ResponseAutomaticInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBackups200ResponseAutomaticInner is not found in the empty JSON string", GetBackups200ResponseAutomaticInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBackups200ResponseAutomaticInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBackups200ResponseAutomaticInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("disks") != null && !jsonObj.get("disks").isJsonNull()) {
        ...
        if (jsonArraydisks != null) {
          ...
          for (int i = 0; i < jsonArraydisks.size(); i++) {
            BackupDisksInner.validateJsonElement(jsonArraydisks.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBackups200ResponseAutomaticInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBackups200ResponseAutomaticInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBackups200ResponseAutomaticInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBackups200ResponseAutomaticInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBackups200ResponseAutomaticInner>() {
           @Override
           public void write(JsonWriter out, GetBackups200ResponseAutomaticInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBackups200ResponseAutomaticInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBackups200ResponseAutomaticInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBackups200ResponseAutomaticInner
   * @throws IOException if the JSON string is invalid with respect to GetBackups200ResponseAutomaticInner
   */
  public static GetBackups200ResponseAutomaticInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBackups200ResponseAutomaticInner.class);
  }

  /**
   * Convert an instance of GetBackups200ResponseAutomaticInner to an JSON string
   *
   * @return JSON string
   */
