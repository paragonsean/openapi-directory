...
public class MaintenanceEntity {
  ...
  public MaintenanceEntity id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public MaintenanceEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public MaintenanceEntity type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MaintenanceEntity url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MaintenanceEntity maintenanceEntity = (MaintenanceEntity) o;
    return Objects.equals(this.id, maintenanceEntity.id) &&
        Objects.equals(this.label, maintenanceEntity.label) &&
        Objects.equals(this.type, maintenanceEntity.type) &&
        Objects.equals(this.url, maintenanceEntity.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, label, type, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MaintenanceEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaintenanceEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaintenanceEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MaintenanceEntity is not found in the empty JSON string", MaintenanceEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MaintenanceEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MaintenanceEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaintenanceEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaintenanceEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaintenanceEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaintenanceEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<MaintenanceEntity>() {
           @Override
           public void write(JsonWriter out, MaintenanceEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MaintenanceEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MaintenanceEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MaintenanceEntity
   * @throws IOException if the JSON string is invalid with respect to MaintenanceEntity
   */
  public static MaintenanceEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MaintenanceEntity.class);
  }

  /**
   * Convert an instance of MaintenanceEntity to an JSON string
   *
   * @return JSON string
   */
