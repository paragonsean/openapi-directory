...
public class ManagedIssueEntity {
  ...
  public boolean equals(Object o) {
    ...
    ManagedIssueEntity managedIssueEntity = (ManagedIssueEntity) o;
    return Objects.equals(this.id, managedIssueEntity.id) &&
        Objects.equals(this.label, managedIssueEntity.label) &&
        Objects.equals(this.type, managedIssueEntity.type) &&
        Objects.equals(this.url, managedIssueEntity.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagedIssueEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ManagedIssueEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedIssueEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ManagedIssueEntity is not found in the empty JSON string", ManagedIssueEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ManagedIssueEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManagedIssueEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagedIssueEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagedIssueEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagedIssueEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagedIssueEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagedIssueEntity>() {
           @Override
           public void write(JsonWriter out, ManagedIssueEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ManagedIssueEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ManagedIssueEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ManagedIssueEntity
   * @throws IOException if the JSON string is invalid with respect to ManagedIssueEntity
   */
  public static ManagedIssueEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagedIssueEntity.class);
  }

  /**
   * Convert an instance of ManagedIssueEntity to an JSON string
   *
   * @return JSON string
   */
