...
public class CreateFirewallsRequestRules {
  ...
  public CreateFirewallsRequestRules outbound(Object outbound) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallsRequestRules createFirewallsRequestRules = (CreateFirewallsRequestRules) o;
    return Objects.equals(this.inbound, createFirewallsRequestRules.inbound) &&
        Objects.equals(this.outbound, createFirewallsRequestRules.outbound);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallsRequestRules {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallsRequestRules
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallsRequestRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallsRequestRules is not found in the empty JSON string", CreateFirewallsRequestRules.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallsRequestRules.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallsRequestRules` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallsRequestRules.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallsRequestRules' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallsRequestRules> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallsRequestRules.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallsRequestRules>() {
           @Override
           public void write(JsonWriter out, CreateFirewallsRequestRules value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallsRequestRules read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallsRequestRules given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallsRequestRules
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallsRequestRules
   */
  public static CreateFirewallsRequestRules fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallsRequestRules.class);
  }

  /**
   * Convert an instance of CreateFirewallsRequestRules to an JSON string
   *
   * @return JSON string
   */
