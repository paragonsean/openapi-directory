...
import org.openapitools.client.model.DatabasePostgreSQLHosts;
...
public class DatabasePostgreSQL {
  ...
  private DatabasePostgreSQLHosts hosts;
   ...
   */
  @JsonAdapter(ReplicationCommitTypeEnum.Adapter.class)
  public enum ReplicationCommitTypeEnum {
    TRUE("true"),
    ...
    ReplicationCommitTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static ReplicationCommitTypeEnum fromValue(String value) {
      for (ReplicationCommitTypeEnum b : ReplicationCommitTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ReplicationCommitTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReplicationCommitTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ReplicationCommitTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ReplicationCommitTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ReplicationCommitTypeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_REPLICATION_COMMIT_TYPE = "replication_commit_type";
  @SerializedName(SERIALIZED_NAME_REPLICATION_COMMIT_TYPE)
  private ReplicationCommitTypeEnum replicationCommitType = ReplicationCommitTypeEnum.LOCAL;
  ...
  public DatabasePostgreSQL allowList(List<String> allowList) {
    this.allowList = allowList;
    return this;
  }

  public DatabasePostgreSQL addAllowListItem(String allowListItem) {
  ...
  public DatabasePostgreSQL clusterSize(ClusterSizeEnum clusterSize) {
  ...
  public DatabasePostgreSQL encrypted(Boolean encrypted) {
  ...
  public DatabasePostgreSQL hosts(DatabasePostgreSQLHosts hosts) {
    this.hosts = hosts;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DatabasePostgreSQLHosts getHosts() {
    return hosts;
  }

  public void setHosts(DatabasePostgreSQLHosts hosts) {
    this.hosts = hosts;
  }
  ...
  public DatabasePostgreSQL label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DatabasePostgreSQL port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DatabasePostgreSQL region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DatabasePostgreSQL replicationCommitType(ReplicationCommitTypeEnum replicationCommitType) {
  ...
  /**
   * The synchronization level of the replicating server.  Must be &#x60;local&#x60; or &#x60;off&#x60; for the &#x60;asynch&#x60; replication type.  Must be &#x60;on&#x60;, &#x60;remote_write&#x60;, or &#x60;remote_apply&#x60; for the &#x60;semi_synch&#x60; replication type. 
   * @return replicationCommitType
   */
  @javax.annotation.Nullable
  public ReplicationCommitTypeEnum getReplicationCommitType() {
    return replicationCommitType;
  }

  public void setReplicationCommitType(ReplicationCommitTypeEnum replicationCommitType) {
    this.replicationCommitType = replicationCommitType;
  }


  public DatabasePostgreSQL replicationType(ReplicationTypeEnum replicationType) {
  ...
  public DatabasePostgreSQL sslConnection(Boolean sslConnection) {
  ...
  public DatabasePostgreSQL type(String type) {
    this.type = type;
    return this;
  }
  ...
  public DatabasePostgreSQL updates(DatabaseUpdates updates) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowList, databasePostgreSQL.allowList) &&
        Objects.equals(this.clusterSize, databasePostgreSQL.clusterSize) &&
        Objects.equals(this.created, databasePostgreSQL.created) &&
        Objects.equals(this.encrypted, databasePostgreSQL.encrypted) &&
        Objects.equals(this.engine, databasePostgreSQL.engine) &&
        Objects.equals(this.hosts, databasePostgreSQL.hosts) &&
        Objects.equals(this.id, databasePostgreSQL.id) &&
        Objects.equals(this.label, databasePostgreSQL.label) &&
        Objects.equals(this.port, databasePostgreSQL.port) &&
        Objects.equals(this.region, databasePostgreSQL.region) &&
        Objects.equals(this.replicationCommitType, databasePostgreSQL.replicationCommitType) &&
        Objects.equals(this.replicationType, databasePostgreSQL.replicationType) &&
        Objects.equals(this.sslConnection, databasePostgreSQL.sslConnection) &&
        Objects.equals(this.status, databasePostgreSQL.status) &&
        Objects.equals(this.type, databasePostgreSQL.type) &&
        Objects.equals(this.updated, databasePostgreSQL.updated) &&
        Objects.equals(this.updates, databasePostgreSQL.updates) &&
        Objects.equals(this.version, databasePostgreSQL.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowList, clusterSize, created, encrypted, engine, hosts, id, label, port, region, replicationCommitType, replicationType, sslConnection, status, type, updated, updates, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabasePostgreSQL {\n");
    ...
    sb.append("    replicationCommitType: ").append(toIndentedString(replicationCommitType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("replication_commit_type");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabasePostgreSQL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabasePostgreSQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasePostgreSQL is not found in the empty JSON string", DatabasePostgreSQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabasePostgreSQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabasePostgreSQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("hosts") != null && !jsonObj.get("hosts").isJsonNull()) {
        DatabasePostgreSQLHosts.validateJsonElement(jsonObj.get("hosts"));
      }
      ...
      if ((jsonObj.get("replication_commit_type") != null && !jsonObj.get("replication_commit_type").isJsonNull()) && !jsonObj.get("replication_commit_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `replication_commit_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("replication_commit_type").toString()));
      }
      // validate the optional field `replication_commit_type`
      if (jsonObj.get("replication_commit_type") != null && !jsonObj.get("replication_commit_type").isJsonNull()) {
        ReplicationCommitTypeEnum.validateJsonElement(jsonObj.get("replication_commit_type"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasePostgreSQL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasePostgreSQL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasePostgreSQL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasePostgreSQL.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasePostgreSQL>() {
           @Override
           public void write(JsonWriter out, DatabasePostgreSQL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabasePostgreSQL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabasePostgreSQL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabasePostgreSQL
   * @throws IOException if the JSON string is invalid with respect to DatabasePostgreSQL
   */
  public static DatabasePostgreSQL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasePostgreSQL.class);
  }

  /**
   * Convert an instance of DatabasePostgreSQL to an JSON string
   *
   * @return JSON string
   */
