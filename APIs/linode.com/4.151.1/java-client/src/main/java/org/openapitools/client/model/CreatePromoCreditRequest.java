...
public class CreatePromoCreditRequest {
  public static final String SERIALIZED_NAME_PROMO_CODE = "promo_code";
  @SerializedName(SERIALIZED_NAME_PROMO_CODE)
  private String promoCode;

  public CreatePromoCreditRequest() {
  }

  public CreatePromoCreditRequest promoCode(String promoCode) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePromoCreditRequest createPromoCreditRequest = (CreatePromoCreditRequest) o;
    return Objects.equals(this.promoCode, createPromoCreditRequest.promoCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(promoCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePromoCreditRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePromoCreditRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePromoCreditRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePromoCreditRequest is not found in the empty JSON string", CreatePromoCreditRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePromoCreditRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePromoCreditRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePromoCreditRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("promo_code").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePromoCreditRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePromoCreditRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePromoCreditRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePromoCreditRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePromoCreditRequest>() {
           @Override
           public void write(JsonWriter out, CreatePromoCreditRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePromoCreditRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePromoCreditRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePromoCreditRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePromoCreditRequest
   */
  public static CreatePromoCreditRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePromoCreditRequest.class);
  }

  /**
   * Convert an instance of CreatePromoCreditRequest to an JSON string
   *
   * @return JSON string
   */
