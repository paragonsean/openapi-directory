...
public class WarningObject {
  ...
  public WarningObject details(String details) {
  ...
  public WarningObject title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WarningObject warningObject = (WarningObject) o;
    return Objects.equals(this.details, warningObject.details) &&
        Objects.equals(this.title, warningObject.title);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WarningObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WarningObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WarningObject is not found in the empty JSON string", WarningObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WarningObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WarningObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WarningObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WarningObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WarningObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WarningObject.class));

       return (TypeAdapter<T>) new TypeAdapter<WarningObject>() {
           @Override
           public void write(JsonWriter out, WarningObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WarningObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WarningObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WarningObject
   * @throws IOException if the JSON string is invalid with respect to WarningObject
   */
  public static WarningObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WarningObject.class);
  }

  /**
   * Convert an instance of WarningObject to an JSON string
   *
   * @return JSON string
   */
