...
public class Device {
  ...
  public Device diskId(Integer diskId) {
    this.diskId = diskId;
    return this;
  }
  ...
  public Device volumeId(Integer volumeId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.diskId, device.diskId) &&
        Objects.equals(this.volumeId, device.volumeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(diskId, volumeId);
  }
