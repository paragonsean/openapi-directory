...
public class DiskRequest {
  ...
  public DiskRequest authorizedKeys(List<String> authorizedKeys) {
    this.authorizedKeys = authorizedKeys;
    return this;
  }

  public DiskRequest addAuthorizedKeysItem(String authorizedKeysItem) {
  ...
  public DiskRequest authorizedUsers(List<String> authorizedUsers) {
    this.authorizedUsers = authorizedUsers;
    return this;
  }

  public DiskRequest addAuthorizedUsersItem(String authorizedUsersItem) {
  ...
  public DiskRequest filesystem(FilesystemEnum filesystem) {
  ...
  public DiskRequest image(String image) {
    this.image = image;
    return this;
  }
  ...
  public DiskRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  public DiskRequest rootPass(String rootPass) {
  ...
  public DiskRequest size(Integer size) {
    this.size = size;
    return this;
  }

  /**
   * The size of the Disk in MB.  Images require a minimum size. Access the Image View ([GET /images/{imageID}](/docs/api/images/#image-view)) endpoint to view its size. 
   * @return size
   */
  @javax.annotation.Nullable
  ...
  public DiskRequest stackscriptData(Object stackscriptData) {
  ...
  public DiskRequest stackscriptId(Integer stackscriptId) {
  ...
  public boolean equals(Object o) {
    ...
    DiskRequest diskRequest = (DiskRequest) o;
    return Objects.equals(this.authorizedKeys, diskRequest.authorizedKeys) &&
        Objects.equals(this.authorizedUsers, diskRequest.authorizedUsers) &&
        Objects.equals(this.filesystem, diskRequest.filesystem) &&
        Objects.equals(this.image, diskRequest.image) &&
        Objects.equals(this.label, diskRequest.label) &&
        Objects.equals(this.rootPass, diskRequest.rootPass) &&
        Objects.equals(this.size, diskRequest.size) &&
        Objects.equals(this.stackscriptData, diskRequest.stackscriptData) &&
        Objects.equals(this.stackscriptId, diskRequest.stackscriptId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizedKeys, authorizedUsers, filesystem, image, label, rootPass, size, stackscriptData, stackscriptId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiskRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiskRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiskRequest is not found in the empty JSON string", DiskRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiskRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiskRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DiskRequest>() {
           @Override
           public void write(JsonWriter out, DiskRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiskRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiskRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiskRequest
   * @throws IOException if the JSON string is invalid with respect to DiskRequest
   */
  public static DiskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiskRequest.class);
  }

  /**
   * Convert an instance of DiskRequest to an JSON string
   *
   * @return JSON string
   */
