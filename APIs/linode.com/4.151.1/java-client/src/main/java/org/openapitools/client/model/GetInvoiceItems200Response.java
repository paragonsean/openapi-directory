...
public class GetInvoiceItems200Response {
  ...
  public GetInvoiceItems200Response data(List<InvoiceItem> data) {
    this.data = data;
    return this;
  }

  public GetInvoiceItems200Response addDataItem(InvoiceItem dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getInvoiceItems200Response.data) &&
        Objects.equals(this.page, getInvoiceItems200Response.page) &&
        Objects.equals(this.pages, getInvoiceItems200Response.pages) &&
        Objects.equals(this.results, getInvoiceItems200Response.results);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            InvoiceItem.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
