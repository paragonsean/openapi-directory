...
public class PayPalExecute {
  ...
  public PayPalExecute() {
  }

  public PayPalExecute payerId(String payerId) {
  ...
  public PayPalExecute paymentId(String paymentId) {
  ...
  public boolean equals(Object o) {
    ...
    PayPalExecute payPalExecute = (PayPalExecute) o;
    return Objects.equals(this.payerId, payPalExecute.payerId) &&
        Objects.equals(this.paymentId, payPalExecute.paymentId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PayPalExecute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PayPalExecute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayPalExecute is not found in the empty JSON string", PayPalExecute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PayPalExecute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PayPalExecute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayPalExecute.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayPalExecute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayPalExecute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayPalExecute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayPalExecute.class));

       return (TypeAdapter<T>) new TypeAdapter<PayPalExecute>() {
           @Override
           public void write(JsonWriter out, PayPalExecute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PayPalExecute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PayPalExecute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PayPalExecute
   * @throws IOException if the JSON string is invalid with respect to PayPalExecute
   */
  public static PayPalExecute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayPalExecute.class);
  }

  /**
   * Convert an instance of PayPalExecute to an JSON string
   *
   * @return JSON string
   */
