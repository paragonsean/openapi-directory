...
public class SecurityQuestionsGetSecurityQuestionsInner {
  ...
  public SecurityQuestionsGetSecurityQuestionsInner() {
  }
  ...
  public SecurityQuestionsGetSecurityQuestionsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SecurityQuestionsGetSecurityQuestionsInner response(String response) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityQuestionsGetSecurityQuestionsInner securityQuestionsGetSecurityQuestionsInner = (SecurityQuestionsGetSecurityQuestionsInner) o;
    return Objects.equals(this.id, securityQuestionsGetSecurityQuestionsInner.id) &&
        Objects.equals(this.question, securityQuestionsGetSecurityQuestionsInner.question) &&
        Objects.equals(this.response, securityQuestionsGetSecurityQuestionsInner.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class SecurityQuestionsGetSecurityQuestionsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityQuestionsGetSecurityQuestionsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityQuestionsGetSecurityQuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityQuestionsGetSecurityQuestionsInner is not found in the empty JSON string", SecurityQuestionsGetSecurityQuestionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityQuestionsGetSecurityQuestionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityQuestionsGetSecurityQuestionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecurityQuestionsGetSecurityQuestionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecurityQuestionsGetSecurityQuestionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecurityQuestionsGetSecurityQuestionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecurityQuestionsGetSecurityQuestionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SecurityQuestionsGetSecurityQuestionsInner>() {
           @Override
           public void write(JsonWriter out, SecurityQuestionsGetSecurityQuestionsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecurityQuestionsGetSecurityQuestionsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecurityQuestionsGetSecurityQuestionsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecurityQuestionsGetSecurityQuestionsInner
   * @throws IOException if the JSON string is invalid with respect to SecurityQuestionsGetSecurityQuestionsInner
   */
  public static SecurityQuestionsGetSecurityQuestionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecurityQuestionsGetSecurityQuestionsInner.class);
  }

  /**
   * Convert an instance of SecurityQuestionsGetSecurityQuestionsInner to an JSON string
   *
   * @return JSON string
   */
