...
public class LinodeConfigHelpers {
  public static final String SERIALIZED_NAME_DEVTMPFS_AUTOMOUNT = "devtmpfs_automount";
  @SerializedName(SERIALIZED_NAME_DEVTMPFS_AUTOMOUNT)
  ...
  public static final String SERIALIZED_NAME_MODULES_DEP = "modules_dep";
  @SerializedName(SERIALIZED_NAME_MODULES_DEP)
  ...
  public static final String SERIALIZED_NAME_UPDATEDB_DISABLED = "updatedb_disabled";
  @SerializedName(SERIALIZED_NAME_UPDATEDB_DISABLED)
  private Boolean updatedbDisabled;

  public LinodeConfigHelpers() {
  }

  public LinodeConfigHelpers devtmpfsAutomount(Boolean devtmpfsAutomount) {
  ...
  public LinodeConfigHelpers distro(Boolean distro) {
    this.distro = distro;
    return this;
  }
  ...
  public void setDistro(Boolean distro) {
    this.distro = distro;
  }


  public LinodeConfigHelpers modulesDep(Boolean modulesDep) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getModulesDep() {
    return modulesDep;
  }

  public void setModulesDep(Boolean modulesDep) {
    this.modulesDep = modulesDep;
  }


  public LinodeConfigHelpers network(Boolean network) {
  ...
  public LinodeConfigHelpers updatedbDisabled(Boolean updatedbDisabled) {
   ...
   * @return updatedbDisabled
   */
  @javax.annotation.Nullable
  public Boolean getUpdatedbDisabled() {
    return updatedbDisabled;
  }

  public void setUpdatedbDisabled(Boolean updatedbDisabled) {
    this.updatedbDisabled = updatedbDisabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    LinodeConfigHelpers linodeConfigHelpers = (LinodeConfigHelpers) o;
    return Objects.equals(this.devtmpfsAutomount, linodeConfigHelpers.devtmpfsAutomount) &&
        Objects.equals(this.distro, linodeConfigHelpers.distro) &&
        Objects.equals(this.modulesDep, linodeConfigHelpers.modulesDep) &&
        Objects.equals(this.network, linodeConfigHelpers.network) &&
        Objects.equals(this.updatedbDisabled, linodeConfigHelpers.updatedbDisabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(devtmpfsAutomount, distro, modulesDep, network, updatedbDisabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinodeConfigHelpers {\n");
    sb.append("    devtmpfsAutomount: ").append(toIndentedString(devtmpfsAutomount)).append("\n");
    sb.append("    distro: ").append(toIndentedString(distro)).append("\n");
    sb.append("    modulesDep: ").append(toIndentedString(modulesDep)).append("\n");
    sb.append("    network: ").append(toIndentedString(network)).append("\n");
    sb.append("    updatedbDisabled: ").append(toIndentedString(updatedbDisabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("devtmpfs_automount");
    openapiFields.add("distro");
    openapiFields.add("modules_dep");
    openapiFields.add("network");
    openapiFields.add("updatedb_disabled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinodeConfigHelpers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinodeConfigHelpers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinodeConfigHelpers is not found in the empty JSON string", LinodeConfigHelpers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinodeConfigHelpers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinodeConfigHelpers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinodeConfigHelpers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinodeConfigHelpers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinodeConfigHelpers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinodeConfigHelpers.class));

       return (TypeAdapter<T>) new TypeAdapter<LinodeConfigHelpers>() {
           @Override
           public void write(JsonWriter out, LinodeConfigHelpers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinodeConfigHelpers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinodeConfigHelpers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinodeConfigHelpers
   * @throws IOException if the JSON string is invalid with respect to LinodeConfigHelpers
   */
  public static LinodeConfigHelpers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinodeConfigHelpers.class);
  }

  /**
   * Convert an instance of LinodeConfigHelpers to an JSON string
   *
   * @return JSON string
   */
