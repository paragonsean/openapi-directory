...
public class Kernel {
  ...
  public static final String SERIALIZED_NAME_PVOPS = "pvops";
  @SerializedName(SERIALIZED_NAME_PVOPS)
  ...
  public static final String SERIALIZED_NAME_XEN = "xen";
  @SerializedName(SERIALIZED_NAME_XEN)
  private Boolean xen;
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getBuilt() {
    return built;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.architecture, kernel.architecture) &&
        Objects.equals(this.built, kernel.built) &&
        Objects.equals(this.deprecated, kernel.deprecated) &&
        Objects.equals(this.id, kernel.id) &&
        Objects.equals(this.kvm, kernel.kvm) &&
        Objects.equals(this.label, kernel.label) &&
        Objects.equals(this.pvops, kernel.pvops) &&
        Objects.equals(this.version, kernel.version) &&
        Objects.equals(this.xen, kernel.xen);
  }

  @Override
  public int hashCode() {
    return Objects.hash(architecture, built, deprecated, id, kvm, label, pvops, version, xen);
  }
  ...
  public String toString() {
    ...
    sb.append("    pvops: ").append(toIndentedString(pvops)).append("\n");
    sb.append("    version: ").append(toIndentedString(version)).append("\n");
    sb.append("    xen: ").append(toIndentedString(xen)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("pvops");
    openapiFields.add("version");
    openapiFields.add("xen");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Kernel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Kernel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Kernel is not found in the empty JSON string", Kernel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Kernel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Kernel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Kernel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Kernel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Kernel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Kernel.class));

       return (TypeAdapter<T>) new TypeAdapter<Kernel>() {
           @Override
           public void write(JsonWriter out, Kernel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Kernel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Kernel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Kernel
   * @throws IOException if the JSON string is invalid with respect to Kernel
   */
  public static Kernel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Kernel.class);
  }

  /**
   * Convert an instance of Kernel to an JSON string
   *
   * @return JSON string
   */
