...
public class GetLKEClusterKubeconfig200Response {
  ...
  public boolean equals(Object o) {
    ...
    GetLKEClusterKubeconfig200Response getLKEClusterKubeconfig200Response = (GetLKEClusterKubeconfig200Response) o;
    return Objects.equals(this.kubeconfig, getLKEClusterKubeconfig200Response.kubeconfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLKEClusterKubeconfig200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLKEClusterKubeconfig200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLKEClusterKubeconfig200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLKEClusterKubeconfig200Response is not found in the empty JSON string", GetLKEClusterKubeconfig200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLKEClusterKubeconfig200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLKEClusterKubeconfig200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLKEClusterKubeconfig200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLKEClusterKubeconfig200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLKEClusterKubeconfig200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLKEClusterKubeconfig200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLKEClusterKubeconfig200Response>() {
           @Override
           public void write(JsonWriter out, GetLKEClusterKubeconfig200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLKEClusterKubeconfig200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLKEClusterKubeconfig200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLKEClusterKubeconfig200Response
   * @throws IOException if the JSON string is invalid with respect to GetLKEClusterKubeconfig200Response
   */
  public static GetLKEClusterKubeconfig200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLKEClusterKubeconfig200Response.class);
  }

  /**
   * Convert an instance of GetLKEClusterKubeconfig200Response to an JSON string
   *
   * @return JSON string
   */
