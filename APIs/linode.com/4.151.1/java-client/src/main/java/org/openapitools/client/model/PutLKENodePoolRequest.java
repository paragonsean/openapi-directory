...
public class PutLKENodePoolRequest {
  ...
  public PutLKENodePoolRequest() {
  }

  public PutLKENodePoolRequest autoscaler(LKENodePoolRequestBodyAutoscaler autoscaler) {
  ...
  public PutLKENodePoolRequest count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutLKENodePoolRequest putLKENodePoolRequest = (PutLKENodePoolRequest) o;
    return Objects.equals(this.autoscaler, putLKENodePoolRequest.autoscaler) &&
        Objects.equals(this.count, putLKENodePoolRequest.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoscaler, count);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutLKENodePoolRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutLKENodePoolRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutLKENodePoolRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutLKENodePoolRequest is not found in the empty JSON string", PutLKENodePoolRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutLKENodePoolRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutLKENodePoolRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutLKENodePoolRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutLKENodePoolRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutLKENodePoolRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutLKENodePoolRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutLKENodePoolRequest>() {
           @Override
           public void write(JsonWriter out, PutLKENodePoolRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutLKENodePoolRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutLKENodePoolRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutLKENodePoolRequest
   * @throws IOException if the JSON string is invalid with respect to PutLKENodePoolRequest
   */
  public static PutLKENodePoolRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutLKENodePoolRequest.class);
  }

  /**
   * Convert an instance of PutLKENodePoolRequest to an JSON string
   *
   * @return JSON string
   */
