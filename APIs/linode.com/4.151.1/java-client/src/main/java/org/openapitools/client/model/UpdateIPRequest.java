...
public class UpdateIPRequest {
  ...
  public UpdateIPRequest rdns(String rdns) {
    this.rdns = rdns;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rdns, updateIPRequest.rdns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rdns);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("rdns");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateIPRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateIPRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateIPRequest is not found in the empty JSON string", UpdateIPRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateIPRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateIPRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateIPRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateIPRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateIPRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateIPRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateIPRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateIPRequest>() {
           @Override
           public void write(JsonWriter out, UpdateIPRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateIPRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateIPRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateIPRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateIPRequest
   */
  public static UpdateIPRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateIPRequest.class);
  }

  /**
   * Convert an instance of UpdateIPRequest to an JSON string
   *
   * @return JSON string
   */
