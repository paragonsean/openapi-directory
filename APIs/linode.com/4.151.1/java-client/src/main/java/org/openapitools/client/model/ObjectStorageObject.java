...
public class ObjectStorageObject {
  ...
  public ObjectStorageObject etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public ObjectStorageObject isTruncated(Boolean isTruncated) {
  ...
  public ObjectStorageObject lastModified(OffsetDateTime lastModified) {
  ...
  public ObjectStorageObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ObjectStorageObject nextMarker(String nextMarker) {
  ...
  public ObjectStorageObject owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ObjectStorageObject size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjectStorageObject objectStorageObject = (ObjectStorageObject) o;
    return Objects.equals(this.etag, objectStorageObject.etag) &&
        Objects.equals(this.isTruncated, objectStorageObject.isTruncated) &&
        Objects.equals(this.lastModified, objectStorageObject.lastModified) &&
        Objects.equals(this.name, objectStorageObject.name) &&
        Objects.equals(this.nextMarker, objectStorageObject.nextMarker) &&
        Objects.equals(this.owner, objectStorageObject.owner) &&
        Objects.equals(this.size, objectStorageObject.size);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(etag, isTruncated, lastModified, name, nextMarker, owner, size);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectStorageObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectStorageObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectStorageObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectStorageObject is not found in the empty JSON string", ObjectStorageObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectStorageObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectStorageObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStorageObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStorageObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStorageObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStorageObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStorageObject>() {
           @Override
           public void write(JsonWriter out, ObjectStorageObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectStorageObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectStorageObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectStorageObject
   * @throws IOException if the JSON string is invalid with respect to ObjectStorageObject
   */
  public static ObjectStorageObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectStorageObject.class);
  }

  /**
   * Convert an instance of ObjectStorageObject to an JSON string
   *
   * @return JSON string
   */
