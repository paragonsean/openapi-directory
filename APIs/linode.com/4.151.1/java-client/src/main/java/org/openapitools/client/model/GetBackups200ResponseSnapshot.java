...
public class GetBackups200ResponseSnapshot {
  ...
  public GetBackups200ResponseSnapshot() {
  }

  public GetBackups200ResponseSnapshot current(Backup current) {
  ...
  public void setCurrent(Backup current) {
    this.current = current;
  }


  public GetBackups200ResponseSnapshot inProgress(Backup inProgress) {
  ...
  public void setInProgress(Backup inProgress) {
    this.inProgress = inProgress;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBackups200ResponseSnapshot getBackups200ResponseSnapshot = (GetBackups200ResponseSnapshot) o;
    return Objects.equals(this.current, getBackups200ResponseSnapshot.current) &&
        Objects.equals(this.inProgress, getBackups200ResponseSnapshot.inProgress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(current, inProgress);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetBackups200ResponseSnapshot {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBackups200ResponseSnapshot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBackups200ResponseSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBackups200ResponseSnapshot is not found in the empty JSON string", GetBackups200ResponseSnapshot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBackups200ResponseSnapshot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBackups200ResponseSnapshot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `current`
      if (jsonObj.get("current") != null && !jsonObj.get("current").isJsonNull()) {
        Backup.validateJsonElement(jsonObj.get("current"));
      }
      // validate the optional field `in_progress`
      if (jsonObj.get("in_progress") != null && !jsonObj.get("in_progress").isJsonNull()) {
        Backup.validateJsonElement(jsonObj.get("in_progress"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBackups200ResponseSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBackups200ResponseSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBackups200ResponseSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBackups200ResponseSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBackups200ResponseSnapshot>() {
           @Override
           public void write(JsonWriter out, GetBackups200ResponseSnapshot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBackups200ResponseSnapshot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBackups200ResponseSnapshot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBackups200ResponseSnapshot
   * @throws IOException if the JSON string is invalid with respect to GetBackups200ResponseSnapshot
   */
  public static GetBackups200ResponseSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBackups200ResponseSnapshot.class);
  }

  /**
   * Convert an instance of GetBackups200ResponseSnapshot to an JSON string
   *
   * @return JSON string
   */
