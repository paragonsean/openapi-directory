...
public class UpdateManagedCredentialUsernamePasswordRequest {
  ...
  public UpdateManagedCredentialUsernamePasswordRequest() {
  }

  public UpdateManagedCredentialUsernamePasswordRequest password(String password) {
  ...
  public UpdateManagedCredentialUsernamePasswordRequest username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateManagedCredentialUsernamePasswordRequest updateManagedCredentialUsernamePasswordRequest = (UpdateManagedCredentialUsernamePasswordRequest) o;
    return Objects.equals(this.password, updateManagedCredentialUsernamePasswordRequest.password) &&
        Objects.equals(this.username, updateManagedCredentialUsernamePasswordRequest.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateManagedCredentialUsernamePasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateManagedCredentialUsernamePasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateManagedCredentialUsernamePasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateManagedCredentialUsernamePasswordRequest is not found in the empty JSON string", UpdateManagedCredentialUsernamePasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateManagedCredentialUsernamePasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateManagedCredentialUsernamePasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateManagedCredentialUsernamePasswordRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateManagedCredentialUsernamePasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateManagedCredentialUsernamePasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateManagedCredentialUsernamePasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateManagedCredentialUsernamePasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateManagedCredentialUsernamePasswordRequest>() {
           @Override
           public void write(JsonWriter out, UpdateManagedCredentialUsernamePasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateManagedCredentialUsernamePasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateManagedCredentialUsernamePasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateManagedCredentialUsernamePasswordRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateManagedCredentialUsernamePasswordRequest
   */
  public static UpdateManagedCredentialUsernamePasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateManagedCredentialUsernamePasswordRequest.class);
  }

  /**
   * Convert an instance of UpdateManagedCredentialUsernamePasswordRequest to an JSON string
   *
   * @return JSON string
   */
