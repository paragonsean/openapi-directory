...
public class GetManagedContacts200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ManagedContact> data = new ArrayList<>();
  ...
  public GetManagedContacts200Response() {
  }
  ...
  public GetManagedContacts200Response data(List<ManagedContact> data) {
    this.data = data;
    return this;
  }

  public GetManagedContacts200Response addDataItem(ManagedContact dataItem) {
    if (this.data == null) {
  ...
  public List<ManagedContact> getData() {
    return data;
  }

  public void setData(List<ManagedContact> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetManagedContacts200Response getManagedContacts200Response = (GetManagedContacts200Response) o;
    return Objects.equals(this.data, getManagedContacts200Response.data) &&
        Objects.equals(this.page, getManagedContacts200Response.page) &&
        Objects.equals(this.pages, getManagedContacts200Response.pages) &&
        Objects.equals(this.results, getManagedContacts200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetManagedContacts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManagedContacts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManagedContacts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManagedContacts200Response is not found in the empty JSON string", GetManagedContacts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManagedContacts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManagedContacts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ManagedContact.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManagedContacts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManagedContacts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManagedContacts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManagedContacts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManagedContacts200Response>() {
           @Override
           public void write(JsonWriter out, GetManagedContacts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManagedContacts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManagedContacts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManagedContacts200Response
   * @throws IOException if the JSON string is invalid with respect to GetManagedContacts200Response
   */
  public static GetManagedContacts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManagedContacts200Response.class);
  }

  /**
   * Convert an instance of GetManagedContacts200Response to an JSON string
   *
   * @return JSON string
   */
