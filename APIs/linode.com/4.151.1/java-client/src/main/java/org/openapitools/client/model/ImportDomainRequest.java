...
public class ImportDomainRequest {
  ...
  public static final String SERIALIZED_NAME_REMOTE_NAMESERVER = "remote_nameserver";
  @SerializedName(SERIALIZED_NAME_REMOTE_NAMESERVER)
  private String remoteNameserver;

  public ImportDomainRequest() {
  }

  public ImportDomainRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ImportDomainRequest remoteNameserver(String remoteNameserver) {
   ...
   * @return remoteNameserver
   */
  @javax.annotation.Nonnull
  public String getRemoteNameserver() {
    return remoteNameserver;
  }

  public void setRemoteNameserver(String remoteNameserver) {
    this.remoteNameserver = remoteNameserver;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportDomainRequest importDomainRequest = (ImportDomainRequest) o;
    return Objects.equals(this.domain, importDomainRequest.domain) &&
        Objects.equals(this.remoteNameserver, importDomainRequest.remoteNameserver);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, remoteNameserver);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportDomainRequest {\n");
    sb.append("    domain: ").append(toIndentedString(domain)).append("\n");
    sb.append("    remoteNameserver: ").append(toIndentedString(remoteNameserver)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("remote_nameserver");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("domain");
    openapiRequiredFields.add("remote_nameserver");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportDomainRequest is not found in the empty JSON string", ImportDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportDomainRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("remote_nameserver").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `remote_nameserver` to be a primitive type in the JSON string but got `%s`", jsonObj.get("remote_nameserver").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportDomainRequest>() {
           @Override
           public void write(JsonWriter out, ImportDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportDomainRequest
   * @throws IOException if the JSON string is invalid with respect to ImportDomainRequest
   */
  public static ImportDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportDomainRequest.class);
  }

  /**
   * Convert an instance of ImportDomainRequest to an JSON string
   *
   * @return JSON string
   */
