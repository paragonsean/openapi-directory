...
public class GetDatabasesInstances200Response {
  ...
  public GetDatabasesInstances200Response() {
  }
  ...
  public GetDatabasesInstances200Response data(List<Database> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesInstances200Response addDataItem(Database dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesInstances200Response getDatabasesInstances200Response = (GetDatabasesInstances200Response) o;
    return Objects.equals(this.page, getDatabasesInstances200Response.page) &&
        Objects.equals(this.pages, getDatabasesInstances200Response.pages) &&
        Objects.equals(this.results, getDatabasesInstances200Response.results) &&
        Objects.equals(this.data, getDatabasesInstances200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesInstances200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesInstances200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesInstances200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesInstances200Response is not found in the empty JSON string", GetDatabasesInstances200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesInstances200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesInstances200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Database.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesInstances200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesInstances200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesInstances200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesInstances200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesInstances200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesInstances200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesInstances200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesInstances200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesInstances200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesInstances200Response
   */
  public static GetDatabasesInstances200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesInstances200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesInstances200Response to an JSON string
   *
   * @return JSON string
   */
