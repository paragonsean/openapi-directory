...
import org.openapitools.client.model.GetLinodeIPs200ResponseIpv4;
import org.openapitools.client.model.GetLinodeIPs200ResponseIpv6;
...
public class GetLinodeIPs200Response {
  public static final String SERIALIZED_NAME_IPV4 = "ipv4";
  @SerializedName(SERIALIZED_NAME_IPV4)
  private GetLinodeIPs200ResponseIpv4 ipv4;

  public static final String SERIALIZED_NAME_IPV6 = "ipv6";
  @SerializedName(SERIALIZED_NAME_IPV6)
  private GetLinodeIPs200ResponseIpv6 ipv6;

  public GetLinodeIPs200Response() {
  }

  public GetLinodeIPs200Response ipv4(GetLinodeIPs200ResponseIpv4 ipv4) {
    this.ipv4 = ipv4;
    return this;
  }
  ...
  public GetLinodeIPs200ResponseIpv4 getIpv4() {
    return ipv4;
  }

  public void setIpv4(GetLinodeIPs200ResponseIpv4 ipv4) {
    this.ipv4 = ipv4;
  }


  public GetLinodeIPs200Response ipv6(GetLinodeIPs200ResponseIpv6 ipv6) {
    this.ipv6 = ipv6;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetLinodeIPs200ResponseIpv6 getIpv6() {
    return ipv6;
  }

  public void setIpv6(GetLinodeIPs200ResponseIpv6 ipv6) {
    this.ipv6 = ipv6;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeIPs200Response getLinodeIPs200Response = (GetLinodeIPs200Response) o;
    return Objects.equals(this.ipv4, getLinodeIPs200Response.ipv4) &&
        Objects.equals(this.ipv6, getLinodeIPs200Response.ipv6);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeIPs200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeIPs200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeIPs200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeIPs200Response is not found in the empty JSON string", GetLinodeIPs200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeIPs200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeIPs200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ipv4`
      if (jsonObj.get("ipv4") != null && !jsonObj.get("ipv4").isJsonNull()) {
        GetLinodeIPs200ResponseIpv4.validateJsonElement(jsonObj.get("ipv4"));
      }
      // validate the optional field `ipv6`
      if (jsonObj.get("ipv6") != null && !jsonObj.get("ipv6").isJsonNull()) {
        GetLinodeIPs200ResponseIpv6.validateJsonElement(jsonObj.get("ipv6"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeIPs200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeIPs200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeIPs200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeIPs200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeIPs200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeIPs200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeIPs200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeIPs200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeIPs200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeIPs200Response
   */
  public static GetLinodeIPs200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeIPs200Response.class);
  }

  /**
   * Convert an instance of GetLinodeIPs200Response to an JSON string
   *
   * @return JSON string
   */
