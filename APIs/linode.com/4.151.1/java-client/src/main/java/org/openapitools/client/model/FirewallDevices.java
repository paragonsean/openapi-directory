...
public class FirewallDevices {
  ...
  private FirewallDevicesEntity entity;
  ...
  public FirewallDevices entity(FirewallDevicesEntity entity) {
    this.entity = entity;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FirewallDevicesEntity getEntity() {
    return entity;
  }

  public void setEntity(FirewallDevicesEntity entity) {
    this.entity = entity;
  }


  public FirewallDevices id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallDevices firewallDevices = (FirewallDevices) o;
    return Objects.equals(this.created, firewallDevices.created) &&
        Objects.equals(this.entity, firewallDevices.entity) &&
        Objects.equals(this.id, firewallDevices.id) &&
        Objects.equals(this.updated, firewallDevices.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, entity, id, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallDevices {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallDevices
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallDevices.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallDevices is not found in the empty JSON string", FirewallDevices.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallDevices.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallDevices` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `entity`
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        FirewallDevicesEntity.validateJsonElement(jsonObj.get("entity"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallDevices.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallDevices' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallDevices> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallDevices.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallDevices>() {
           @Override
           public void write(JsonWriter out, FirewallDevices value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallDevices read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallDevices given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallDevices
   * @throws IOException if the JSON string is invalid with respect to FirewallDevices
   */
  public static FirewallDevices fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallDevices.class);
  }

  /**
   * Convert an instance of FirewallDevices to an JSON string
   *
   * @return JSON string
   */
