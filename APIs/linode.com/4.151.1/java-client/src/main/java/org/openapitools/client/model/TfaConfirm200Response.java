...
public class TfaConfirm200Response {
  public static final String SERIALIZED_NAME_SCRATCH = "scratch";
  @SerializedName(SERIALIZED_NAME_SCRATCH)
  private String scratch;

  public TfaConfirm200Response() {
  }

  public TfaConfirm200Response scratch(String scratch) {
  ...
  public boolean equals(Object o) {
    ...
    TfaConfirm200Response tfaConfirm200Response = (TfaConfirm200Response) o;
    return Objects.equals(this.scratch, tfaConfirm200Response.scratch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scratch);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TfaConfirm200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TfaConfirm200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TfaConfirm200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TfaConfirm200Response is not found in the empty JSON string", TfaConfirm200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TfaConfirm200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TfaConfirm200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("scratch") != null && !jsonObj.get("scratch").isJsonNull()) && !jsonObj.get("scratch").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `scratch` to be a primitive type in the JSON string but got `%s`", jsonObj.get("scratch").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TfaConfirm200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TfaConfirm200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TfaConfirm200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TfaConfirm200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TfaConfirm200Response>() {
           @Override
           public void write(JsonWriter out, TfaConfirm200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TfaConfirm200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TfaConfirm200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TfaConfirm200Response
   * @throws IOException if the JSON string is invalid with respect to TfaConfirm200Response
   */
  public static TfaConfirm200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TfaConfirm200Response.class);
  }

  /**
   * Convert an instance of TfaConfirm200Response to an JSON string
   *
   * @return JSON string
   */
