...
public class GetDatabasesEngines200Response {
  ...
  private List<DatabaseEngine> data = new ArrayList<>();

  public GetDatabasesEngines200Response() {
  }
  ...
  public GetDatabasesEngines200Response data(List<DatabaseEngine> data) {
    this.data = data;
    return this;
  }

  public GetDatabasesEngines200Response addDataItem(DatabaseEngine dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DatabaseEngine> getData() {
    return data;
  }

  public void setData(List<DatabaseEngine> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatabasesEngines200Response getDatabasesEngines200Response = (GetDatabasesEngines200Response) o;
    return Objects.equals(this.page, getDatabasesEngines200Response.page) &&
        Objects.equals(this.pages, getDatabasesEngines200Response.pages) &&
        Objects.equals(this.results, getDatabasesEngines200Response.results) &&
        Objects.equals(this.data, getDatabasesEngines200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDatabasesEngines200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatabasesEngines200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabasesEngines200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabasesEngines200Response is not found in the empty JSON string", GetDatabasesEngines200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatabasesEngines200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabasesEngines200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DatabaseEngine.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabasesEngines200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabasesEngines200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabasesEngines200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabasesEngines200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabasesEngines200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabasesEngines200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabasesEngines200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatabasesEngines200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatabasesEngines200Response
   * @throws IOException if the JSON string is invalid with respect to GetDatabasesEngines200Response
   */
  public static GetDatabasesEngines200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabasesEngines200Response.class);
  }

  /**
   * Convert an instance of GetDatabasesEngines200Response to an JSON string
   *
   * @return JSON string
   */
