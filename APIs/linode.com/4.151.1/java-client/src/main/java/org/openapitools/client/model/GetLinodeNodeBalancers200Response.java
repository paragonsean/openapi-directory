...
public class GetLinodeNodeBalancers200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<NodeBalancer> data = new ArrayList<>();
  ...
  public GetLinodeNodeBalancers200Response() {
  }
  ...
  public GetLinodeNodeBalancers200Response data(List<NodeBalancer> data) {
    this.data = data;
    return this;
  }

  public GetLinodeNodeBalancers200Response addDataItem(NodeBalancer dataItem) {
    if (this.data == null) {
  ...
  public List<NodeBalancer> getData() {
    return data;
  }

  public void setData(List<NodeBalancer> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinodeNodeBalancers200Response getLinodeNodeBalancers200Response = (GetLinodeNodeBalancers200Response) o;
    return Objects.equals(this.data, getLinodeNodeBalancers200Response.data) &&
        Objects.equals(this.page, getLinodeNodeBalancers200Response.page) &&
        Objects.equals(this.pages, getLinodeNodeBalancers200Response.pages) &&
        Objects.equals(this.results, getLinodeNodeBalancers200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLinodeNodeBalancers200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinodeNodeBalancers200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinodeNodeBalancers200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinodeNodeBalancers200Response is not found in the empty JSON string", GetLinodeNodeBalancers200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinodeNodeBalancers200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinodeNodeBalancers200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            NodeBalancer.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinodeNodeBalancers200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinodeNodeBalancers200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinodeNodeBalancers200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinodeNodeBalancers200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinodeNodeBalancers200Response>() {
           @Override
           public void write(JsonWriter out, GetLinodeNodeBalancers200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinodeNodeBalancers200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinodeNodeBalancers200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinodeNodeBalancers200Response
   * @throws IOException if the JSON string is invalid with respect to GetLinodeNodeBalancers200Response
   */
  public static GetLinodeNodeBalancers200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinodeNodeBalancers200Response.class);
  }

  /**
   * Convert an instance of GetLinodeNodeBalancers200Response to an JSON string
   *
   * @return JSON string
   */
