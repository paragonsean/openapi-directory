...
import org.openapitools.client.model.ObjectStorageObject;
...
public class GetObjectStorageBucketContent200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ObjectStorageObject> data = new ArrayList<>();

  public GetObjectStorageBucketContent200Response() {
  }

  public GetObjectStorageBucketContent200Response data(List<ObjectStorageObject> data) {
    this.data = data;
    return this;
  }

  public GetObjectStorageBucketContent200Response addDataItem(ObjectStorageObject dataItem) {
    if (this.data == null) {
  ...
  public List<ObjectStorageObject> getData() {
    return data;
  }

  public void setData(List<ObjectStorageObject> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetObjectStorageBucketContent200Response getObjectStorageBucketContent200Response = (GetObjectStorageBucketContent200Response) o;
    return Objects.equals(this.data, getObjectStorageBucketContent200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetObjectStorageBucketContent200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetObjectStorageBucketContent200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetObjectStorageBucketContent200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetObjectStorageBucketContent200Response is not found in the empty JSON string", GetObjectStorageBucketContent200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetObjectStorageBucketContent200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetObjectStorageBucketContent200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectStorageObject.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetObjectStorageBucketContent200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetObjectStorageBucketContent200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetObjectStorageBucketContent200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetObjectStorageBucketContent200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetObjectStorageBucketContent200Response>() {
           @Override
           public void write(JsonWriter out, GetObjectStorageBucketContent200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetObjectStorageBucketContent200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetObjectStorageBucketContent200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetObjectStorageBucketContent200Response
   * @throws IOException if the JSON string is invalid with respect to GetObjectStorageBucketContent200Response
   */
  public static GetObjectStorageBucketContent200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetObjectStorageBucketContent200Response.class);
  }

  /**
   * Convert an instance of GetObjectStorageBucketContent200Response to an JSON string
   *
   * @return JSON string
   */
