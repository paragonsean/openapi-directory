...
import org.openapitools.client.model.ImagesUploadPost200Response;
import org.openapitools.client.model.ImagesUploadPostRequest;
...
public class ImagesApi {
     ...
     * @param createImageRequest Information about the Image to create. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> New private Image created successfully. </td><td>  -  </td></tr>
     ...
     */
    public Image createImage(CreateImageRequest createImageRequest) throws ApiException {
        ApiResponse<Image> localVarResp = createImageWithHttpInfo(createImageRequest);
     ...
     */
    public ApiResponse<Image> createImageWithHttpInfo(CreateImageRequest createImageRequest) throws ApiException {
     ...
     */
    public okhttp3.Call createImageAsync(CreateImageRequest createImageRequest, final ApiCallback<Image> _callback) throws ApiException {
     ...
     * @param imageId ID of the Image to look up. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public Object deleteImage(String imageId) throws ApiException {
        ApiResponse<Object> localVarResp = deleteImageWithHttpInfo(imageId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteImageWithHttpInfo(String imageId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteImageAsync(String imageId, final ApiCallback<Object> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A single Image object. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public Image getImage(String imageId) throws ApiException {
        ApiResponse<Image> localVarResp = getImageWithHttpInfo(imageId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Image> getImageWithHttpInfo(String imageId) throws ApiException {
     ...
     */
    public okhttp3.Call getImageAsync(String imageId, final ApiCallback<Image> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A paginated list of Images. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getImagesCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getImagesValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        return getImagesCall(page, pageSize, _callback);
     ...
     */
    public GetImages200Response getImages(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<GetImages200Response> localVarResp = getImagesWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetImages200Response> getImagesWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getImagesValidateBeforeCall(page, pageSize, null);
        Type localVarReturnType = new TypeToken<GetImages200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Images List (asynchronously)
     * Returns a paginated list of Images.  * **Public** Images have IDs that begin with \&quot;linode/\&quot;. These distribution images are generally available to all users.  * **Private** Images have IDs that begin with \&quot;private/\&quot;. These Images are Account-specific and only accessible to Users with appropriate [Grants](/docs/api/account/#users-grants-view).  * To view only public Images, call this endpoint with or without authentication. To view private Images as well, call this endpoint with authentication. 
     * @param page The page of a collection to return. (optional, default to 1)
     * @param pageSize The number of items to return per page. (optional, default to 100)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getImagesAsync(Integer page, Integer pageSize, final ApiCallback<GetImages200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getImagesValidateBeforeCall(page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<GetImages200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for imagesUploadPost
     * @param imagesUploadPostRequest The uploaded Image details. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Image Upload object including the upload URL and Image object. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call imagesUploadPostCall(ImagesUploadPostRequest imagesUploadPostRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        ...
        Object localVarPostBody = imagesUploadPostRequest;

        // create path and map variables
        String localVarPath = "/images/upload";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call imagesUploadPostValidateBeforeCall(ImagesUploadPostRequest imagesUploadPostRequest, final ApiCallback _callback) throws ApiException {
        return imagesUploadPostCall(imagesUploadPostRequest, _callback);
     ...
     * @param imagesUploadPostRequest The uploaded Image details. (optional)
     * @return ImagesUploadPost200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ImagesUploadPost200Response imagesUploadPost(ImagesUploadPostRequest imagesUploadPostRequest) throws ApiException {
        ApiResponse<ImagesUploadPost200Response> localVarResp = imagesUploadPostWithHttpInfo(imagesUploadPostRequest);
        return localVarResp.getData();
    }
     ...
     * Initiates an Image upload.  This endpoint creates a new private Image object and returns it along with the URL to which image data can be uploaded.  - Image data must be uploaded within 24 hours of creation or the upload will be cancelled and the image deleted.  - Image uploads should be made as an HTTP PUT request to the URL returned in the &#x60;upload_to&#x60; response parameter, with a &#x60;Content-type: application/octet-stream&#x60; header included in the request. For example:        curl -v \\         -H \&quot;Content-Type: application/octet-stream\&quot; \\         --upload-file example.img.gz \\         $UPLOAD_URL \\         --progress-bar \\         --output /dev/null  - Uploaded image data should be compressed in gzip (&#x60;.gz&#x60;) format. The uncompressed disk should be in raw disk image (&#x60;.img&#x60;) format. A maximum compressed file size of 5GB is supported for upload at this time.  **Note:** To initiate and complete an Image upload in a single step, see our guide on how to [Upload an Image](/docs/products/tools/images/guides/upload-an-image/) using Cloud Manager or the Linode CLI &#x60;image-upload&#x60; plugin. 
     * @param imagesUploadPostRequest The uploaded Image details. (optional)
     * @return ApiResponse&lt;ImagesUploadPost200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ImagesUploadPost200Response> imagesUploadPostWithHttpInfo(ImagesUploadPostRequest imagesUploadPostRequest) throws ApiException {
        okhttp3.Call localVarCall = imagesUploadPostValidateBeforeCall(imagesUploadPostRequest, null);
        Type localVarReturnType = new TypeToken<ImagesUploadPost200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Image Upload (asynchronously)
     * Initiates an Image upload.  This endpoint creates a new private Image object and returns it along with the URL to which image data can be uploaded.  - Image data must be uploaded within 24 hours of creation or the upload will be cancelled and the image deleted.  - Image uploads should be made as an HTTP PUT request to the URL returned in the &#x60;upload_to&#x60; response parameter, with a &#x60;Content-type: application/octet-stream&#x60; header included in the request. For example:        curl -v \\         -H \&quot;Content-Type: application/octet-stream\&quot; \\         --upload-file example.img.gz \\         $UPLOAD_URL \\         --progress-bar \\         --output /dev/null  - Uploaded image data should be compressed in gzip (&#x60;.gz&#x60;) format. The uncompressed disk should be in raw disk image (&#x60;.img&#x60;) format. A maximum compressed file size of 5GB is supported for upload at this time.  **Note:** To initiate and complete an Image upload in a single step, see our guide on how to [Upload an Image](/docs/products/tools/images/guides/upload-an-image/) using Cloud Manager or the Linode CLI &#x60;image-upload&#x60; plugin. 
     * @param imagesUploadPostRequest The uploaded Image details. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call imagesUploadPostAsync(ImagesUploadPostRequest imagesUploadPostRequest, final ApiCallback<ImagesUploadPost200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = imagesUploadPostValidateBeforeCall(imagesUploadPostRequest, _callback);
        Type localVarReturnType = new TypeToken<ImagesUploadPost200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param imageId ID of the Image to look up. (required)
     * @param image The fields to update.  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The updated image. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateImageCall(String imageId, Image image, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateImageValidateBeforeCall(String imageId, Image image, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageId' is set
        if (imageId == null) {
        ...
        return updateImageCall(imageId, image, _callback);
     ...
     */
    public Image updateImage(String imageId, Image image) throws ApiException {
        ApiResponse<Image> localVarResp = updateImageWithHttpInfo(imageId, image);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Image> updateImageWithHttpInfo(String imageId, Image image) throws ApiException {
        okhttp3.Call localVarCall = updateImageValidateBeforeCall(imageId, image, null);
        Type localVarReturnType = new TypeToken<Image>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Image Update (asynchronously)
     * Updates a private Image that you have permission to &#x60;read_write&#x60;. 
     * @param imageId ID of the Image to look up. (required)
     * @param image The fields to update.  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateImageAsync(String imageId, Image image, final ApiCallback<Image> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateImageValidateBeforeCall(imageId, image, _callback);
        Type localVarReturnType = new TypeToken<Image>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
