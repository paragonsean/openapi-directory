...
import org.openapitools.client.model.LongviewSubscription;
...
public class GetLongviewSubscriptions200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<LongviewSubscription> data = new ArrayList<>();
  ...
  public GetLongviewSubscriptions200Response() {
  }
  ...
  public GetLongviewSubscriptions200Response data(List<LongviewSubscription> data) {
    this.data = data;
    return this;
  }

  public GetLongviewSubscriptions200Response addDataItem(LongviewSubscription dataItem) {
    if (this.data == null) {
  ...
  public List<LongviewSubscription> getData() {
    return data;
  }

  public void setData(List<LongviewSubscription> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLongviewSubscriptions200Response getLongviewSubscriptions200Response = (GetLongviewSubscriptions200Response) o;
    return Objects.equals(this.data, getLongviewSubscriptions200Response.data) &&
        Objects.equals(this.page, getLongviewSubscriptions200Response.page) &&
        Objects.equals(this.pages, getLongviewSubscriptions200Response.pages) &&
        Objects.equals(this.results, getLongviewSubscriptions200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLongviewSubscriptions200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLongviewSubscriptions200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLongviewSubscriptions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLongviewSubscriptions200Response is not found in the empty JSON string", GetLongviewSubscriptions200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLongviewSubscriptions200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLongviewSubscriptions200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            LongviewSubscription.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLongviewSubscriptions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLongviewSubscriptions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLongviewSubscriptions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLongviewSubscriptions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLongviewSubscriptions200Response>() {
           @Override
           public void write(JsonWriter out, GetLongviewSubscriptions200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLongviewSubscriptions200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLongviewSubscriptions200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLongviewSubscriptions200Response
   * @throws IOException if the JSON string is invalid with respect to GetLongviewSubscriptions200Response
   */
  public static GetLongviewSubscriptions200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLongviewSubscriptions200Response.class);
  }

  /**
   * Convert an instance of GetLongviewSubscriptions200Response to an JSON string
   *
   * @return JSON string
   */
