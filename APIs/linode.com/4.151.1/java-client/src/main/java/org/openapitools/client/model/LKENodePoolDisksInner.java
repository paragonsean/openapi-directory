...
public class LKENodePoolDisksInner {
  ...
  public LKENodePoolDisksInner() {
  }

  public LKENodePoolDisksInner size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public LKENodePoolDisksInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LKENodePoolDisksInner lkENodePoolDisksInner = (LKENodePoolDisksInner) o;
    return Objects.equals(this.size, lkENodePoolDisksInner.size) &&
        Objects.equals(this.type, lkENodePoolDisksInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class LKENodePoolDisksInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LKENodePoolDisksInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LKENodePoolDisksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LKENodePoolDisksInner is not found in the empty JSON string", LKENodePoolDisksInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LKENodePoolDisksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LKENodePoolDisksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LKENodePoolDisksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LKENodePoolDisksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LKENodePoolDisksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LKENodePoolDisksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LKENodePoolDisksInner>() {
           @Override
           public void write(JsonWriter out, LKENodePoolDisksInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LKENodePoolDisksInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LKENodePoolDisksInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LKENodePoolDisksInner
   * @throws IOException if the JSON string is invalid with respect to LKENodePoolDisksInner
   */
  public static LKENodePoolDisksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LKENodePoolDisksInner.class);
  }

  /**
   * Convert an instance of LKENodePoolDisksInner to an JSON string
   *
   * @return JSON string
   */
