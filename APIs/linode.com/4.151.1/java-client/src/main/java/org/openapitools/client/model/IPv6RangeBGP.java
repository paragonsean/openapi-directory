...
public class IPv6RangeBGP {
  public static final String SERIALIZED_NAME_IS_BGP = "is_bgp";
  @SerializedName(SERIALIZED_NAME_IS_BGP)
  ...
  public IPv6RangeBGP prefix(Integer prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPv6RangeBGP ipv6RangeBGP = (IPv6RangeBGP) o;
    return Objects.equals(this.isBgp, ipv6RangeBGP.isBgp) &&
        Objects.equals(this.linodes, ipv6RangeBGP.linodes) &&
        Objects.equals(this.prefix, ipv6RangeBGP.prefix) &&
        Objects.equals(this.range, ipv6RangeBGP.range) &&
        Objects.equals(this.region, ipv6RangeBGP.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isBgp, linodes, prefix, range, region);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPv6RangeBGP {\n");
    sb.append("    isBgp: ").append(toIndentedString(isBgp)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPv6RangeBGP
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPv6RangeBGP.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPv6RangeBGP is not found in the empty JSON string", IPv6RangeBGP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPv6RangeBGP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPv6RangeBGP` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPv6RangeBGP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPv6RangeBGP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPv6RangeBGP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPv6RangeBGP.class));

       return (TypeAdapter<T>) new TypeAdapter<IPv6RangeBGP>() {
           @Override
           public void write(JsonWriter out, IPv6RangeBGP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPv6RangeBGP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPv6RangeBGP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPv6RangeBGP
   * @throws IOException if the JSON string is invalid with respect to IPv6RangeBGP
   */
  public static IPv6RangeBGP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPv6RangeBGP.class);
  }

  /**
   * Convert an instance of IPv6RangeBGP to an JSON string
   *
   * @return JSON string
   */
