...
public class GetObjectStorageBuckets200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ObjectStorageBucket> data = new ArrayList<>();
  ...
  public GetObjectStorageBuckets200Response() {
  }
  ...
  public GetObjectStorageBuckets200Response data(List<ObjectStorageBucket> data) {
    this.data = data;
    return this;
  }

  public GetObjectStorageBuckets200Response addDataItem(ObjectStorageBucket dataItem) {
    if (this.data == null) {
  ...
  public List<ObjectStorageBucket> getData() {
    return data;
  }

  public void setData(List<ObjectStorageBucket> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetObjectStorageBuckets200Response getObjectStorageBuckets200Response = (GetObjectStorageBuckets200Response) o;
    return Objects.equals(this.data, getObjectStorageBuckets200Response.data) &&
        Objects.equals(this.page, getObjectStorageBuckets200Response.page) &&
        Objects.equals(this.pages, getObjectStorageBuckets200Response.pages) &&
        Objects.equals(this.results, getObjectStorageBuckets200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetObjectStorageBuckets200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetObjectStorageBuckets200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetObjectStorageBuckets200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetObjectStorageBuckets200Response is not found in the empty JSON string", GetObjectStorageBuckets200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetObjectStorageBuckets200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetObjectStorageBuckets200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectStorageBucket.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetObjectStorageBuckets200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetObjectStorageBuckets200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetObjectStorageBuckets200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetObjectStorageBuckets200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetObjectStorageBuckets200Response>() {
           @Override
           public void write(JsonWriter out, GetObjectStorageBuckets200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetObjectStorageBuckets200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetObjectStorageBuckets200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetObjectStorageBuckets200Response
   * @throws IOException if the JSON string is invalid with respect to GetObjectStorageBuckets200Response
   */
  public static GetObjectStorageBuckets200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetObjectStorageBuckets200Response.class);
  }

  /**
   * Convert an instance of GetObjectStorageBuckets200Response to an JSON string
   *
   * @return JSON string
   */
