...
|------------ | ------------- | ------------- | -------------|
|**created** | **OffsetDateTime** | When this Domain Record was created. |  [optional] [readonly] |
|**id** | **Integer** | This Record&#39;s unique ID. |  [optional] [readonly] |
...
|**type** | [**TypeEnum**](#TypeEnum) | The type of Record this is in the DNS system. For example, A records associate a domain name with an IPv4 address, and AAAA records associate a domain name with an IPv6 address. For more information, see the guides on [DNS Record Types](/docs/products/networking/dns-manager/guides/#dns-record-types).  |  [optional] |
|**updated** | **OffsetDateTime** | When this Domain Record was last updated. |  [optional] [readonly] |
