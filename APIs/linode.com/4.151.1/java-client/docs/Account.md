...
|------------ | ------------- | ------------- | -------------|
|**activePromotions** | [**List&lt;Promotion&gt;**](Promotion.md) |  |  [optional] [readonly] |
|**activeSince** | **OffsetDateTime** | The datetime of when the account was activated. |  [optional] [readonly] |
...
|**balance** | **BigDecimal** | This Account&#39;s balance, in US dollars. |  [optional] [readonly] |
|**balanceUninvoiced** | **BigDecimal** | This Account&#39;s current estimated invoice in US dollars. This is not your final invoice balance. Transfer charges are not included in the estimate.  |  [optional] [readonly] |
|**billingSource** | [**BillingSourceEnum**](#BillingSourceEnum) | The source of service charges for this Account, as determined by its relationship with Akamai. Accounts that are associated with Akamai-specific customers return a value of &#x60;akamai&#x60;. All other Accounts return a value of &#x60;linode&#x60;.  |  [optional] [readonly] |
|**capabilities** | **List&lt;String&gt;** | A list of capabilities your account supports.  |  [optional] [readonly] |
...
|**euuid** | **UUID** | An external unique identifier for this account.  |  [optional] [readonly] |
