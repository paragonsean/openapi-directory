...
|**created** | **OffsetDateTime** | When this Linode was created. |  [optional] [readonly] |
...
|**status** | [**StatusEnum**](#StatusEnum) | A brief description of this Linode&#39;s current state. This field may change without direct action from you. For example, when a Linode goes into maintenance mode its status will display \&quot;stopped\&quot;.  |  [optional] [readonly] |
...
|**updated** | **OffsetDateTime** | When this Linode was last updated. |  [optional] [readonly] |
