...
|------------ | ------------- | ------------- | -------------|
|**created** | **OffsetDateTime** | The date and time this token was created.  |  [optional] [readonly] |
|**expiry** | **OffsetDateTime** | When this token will expire.  Personal Access Tokens cannot be renewed, so after this time the token will be completely unusable and a new token will need to be generated.  Tokens may be created with \&quot;null\&quot; as their expiry and will never expire unless revoked.  |  [optional] [readonly] |
|**id** | **Integer** | This token&#39;s unique ID, which can be used to revoke it.  |  [optional] [readonly] |
