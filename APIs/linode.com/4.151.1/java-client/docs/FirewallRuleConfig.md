...
|------------ | ------------- | ------------- | -------------|
|**action** | [**ActionEnum**](#ActionEnum) | Controls whether traffic is accepted or dropped by this rule. Overrides the Firewall&#39;s &#x60;inbound_policy&#x60; if this is an inbound rule, or the &#x60;outbound_policy&#x60; if this is an outbound rule.  |  [optional] |
|**addresses** | [**FirewallRuleConfigAddresses**](FirewallRuleConfigAddresses.md) |  |  [optional] |
...
|**protocol** | [**ProtocolEnum**](#ProtocolEnum) | The type of network traffic to allow.  |  [optional] |
