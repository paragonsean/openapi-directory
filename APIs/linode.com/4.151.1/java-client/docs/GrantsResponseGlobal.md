...
|------------ | ------------- | ------------- | -------------|
|**accountAccess** | [**AccountAccessEnum**](#AccountAccessEnum) | The level of access this User has to Account-level actions, like billing information. A restricted User will never be able to manage users.  |  [optional] |
