# LinodeApi.LKECluster

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**controlPlane** | [**LKEClusterControlPlane**](LKEClusterControlPlane.md) |  | [optional] 
**created** | **Date** | When this Kubernetes cluster was created. | [optional] [readonly] 
**id** | **Number** | This Kubernetes cluster&#39;s unique ID. | [optional] [readonly] 
