# LinodeApi.CreateObjectStorageObjectURLRequest
...
**expiresIn** | **Number** | How long this signed URL will be valid for, in seconds.  If omitted, the URL will be valid for 3600 seconds (1 hour).  | [optional] [default to 3600]
