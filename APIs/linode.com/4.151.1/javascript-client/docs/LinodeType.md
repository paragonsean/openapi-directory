...
**memory** | **Number** | Amount of RAM included in this Linode Type.  | [optional] [readonly] 
**networkOut** | **Number** | The Mbits outbound bandwidth allocation.  | [optional] [readonly] 
...
**transfer** | **Number** | The monthly outbound transfer amount, in MB.  | [optional] [readonly] 
**vcpus** | **Number** | The number of VCPU cores this Linode Type offers.  | [optional] [readonly] 
