...
**linodeId** | **Number** | The ID of the Linode this address currently belongs to.  | [optional] [readonly] 
**prefix** | **Number** | The network prefix.  | [optional] [readonly] 
