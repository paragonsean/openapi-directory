# LinodeApi.CreateNodeBalancerRequest
...
**configs** | [**[CreateNodeBalancerRequestConfigsInner]**](CreateNodeBalancerRequestConfigsInner.md) | The port Config(s) to create for this NodeBalancer.  Each Config must have a unique port and at least one Node.  | [optional] 
