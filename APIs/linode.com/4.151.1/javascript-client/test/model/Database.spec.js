...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.Database();
  });
  ...
  describe('Database', function() {
    it('should create an instance of Database', function() {
      ...
      //var instance = new LinodeApi.Database();
      //expect(instance).to.be.a(LinodeApi.Database);
    });
    ...
    it('should have the property instanceUri (base name: "instance_uri")', function() {
