...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.DatabasePostgreSQL();
  });
  ...
  describe('DatabasePostgreSQL', function() {
    it('should create an instance of DatabasePostgreSQL', function() {
      // uncomment below and update the code to test DatabasePostgreSQL
      //var instance = new LinodeApi.DatabasePostgreSQL();
      //expect(instance).to.be.a(LinodeApi.DatabasePostgreSQL);
    });
    ...
    it('should have the property replicationCommitType (base name: "replication_commit_type")', function() {
      // uncomment below and update the code to test the property replicationCommitType
      //var instance = new LinodeApi.DatabasePostgreSQL();
      //expect(instance).to.be();
    });
