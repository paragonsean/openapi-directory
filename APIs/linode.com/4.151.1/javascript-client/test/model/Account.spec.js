...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be.a(LinodeApi.Account);
    });

    it('should have the property activePromotions (base name: "active_promotions")', function() {
      // uncomment below and update the code to test the property activePromotions
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property activeSince (base name: "active_since")', function() {
      // uncomment below and update the code to test the property activeSince
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property balanceUninvoiced (base name: "balance_uninvoiced")', function() {
      // uncomment below and update the code to test the property balanceUninvoiced
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property billingSource (base name: "billing_source")', function() {
      // uncomment below and update the code to test the property billingSource
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property euuid (base name: "euuid")', function() {
      // uncomment below and update the code to test the property euuid
      //var instance = new LinodeApi.Account();
      //expect(instance).to.be();
    });
