...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.DatabaseMongoDB();
  });
  ...
  describe('DatabaseMongoDB', function() {
    it('should create an instance of DatabaseMongoDB', function() {
      // uncomment below and update the code to test DatabaseMongoDB
      //var instance = new LinodeApi.DatabaseMongoDB();
      //expect(instance).to.be.a(LinodeApi.DatabaseMongoDB);
    });
    ...
    it('should have the property compressionType (base name: "compression_type")', function() {
    ...
    it('should have the property replicaSet (base name: "replica_set")', function() {
    ...
    it('should have the property storageEngine (base name: "storage_engine")', function() {
      // uncomment below and update the code to test the property storageEngine
      //var instance = new LinodeApi.DatabaseMongoDB();
      //expect(instance).to.be();
    });
