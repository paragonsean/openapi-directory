...
(function(root, factory) {
  ...
  describe('Linode', function() {
    it('should create an instance of Linode', function() {
      // uncomment below and update the code to test Linode
      //var instance = new LinodeApi.Linode();
      //expect(instance).to.be.a(LinodeApi.Linode);
    });
    ...
    it('should have the property hostUuid (base name: "host_uuid")', function() {
      // uncomment below and update the code to test the property hostUuid
      //var instance = new LinodeApi.Linode();
      //expect(instance).to.be();
    });
    ...
    it('should have the property watchdogEnabled (base name: "watchdog_enabled")', function() {
      // uncomment below and update the code to test the property watchdogEnabled
      //var instance = new LinodeApi.Linode();
      //expect(instance).to.be();
    });
