...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.RebuildNodeBalancerConfigRequest();
  });
  ...
  describe('RebuildNodeBalancerConfigRequest', function() {
    it('should create an instance of RebuildNodeBalancerConfigRequest', function() {
      // uncomment below and update the code to test RebuildNodeBalancerConfigRequest
      //var instance = new LinodeApi.RebuildNodeBalancerConfigRequest();
      //expect(instance).to.be.a(LinodeApi.RebuildNodeBalancerConfigRequest);
    });
