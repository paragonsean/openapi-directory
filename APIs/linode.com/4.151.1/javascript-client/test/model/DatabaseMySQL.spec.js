...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.DatabaseMySQL();
  });
  ...
  describe('DatabaseMySQL', function() {
    it('should create an instance of DatabaseMySQL', function() {
      // uncomment below and update the code to test DatabaseMySQL
      //var instance = new LinodeApi.DatabaseMySQL();
      //expect(instance).to.be.a(LinodeApi.DatabaseMySQL);
    });

    it('should have the property allowList (base name: "allow_list")', function() {
      // uncomment below and update the code to test the property allowList
      //var instance = new LinodeApi.DatabaseMySQL();
      //expect(instance).to.be();
    });

    it('should have the property clusterSize (base name: "cluster_size")', function() {
      // uncomment below and update the code to test the property clusterSize
      //var instance = new LinodeApi.DatabaseMySQL();
      //expect(instance).to.be();
    });
    ...
    it('should have the property replicationType (base name: "replication_type")', function() {
      // uncomment below and update the code to test the property replicationType
      //var instance = new LinodeApi.DatabaseMySQL();
      //expect(instance).to.be();
    });

    it('should have the property sslConnection (base name: "ssl_connection")', function() {
      // uncomment below and update the code to test the property sslConnection
      //var instance = new LinodeApi.DatabaseMySQL();
      //expect(instance).to.be();
    });
