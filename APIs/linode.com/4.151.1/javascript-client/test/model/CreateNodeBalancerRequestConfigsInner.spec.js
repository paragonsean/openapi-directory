...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.CreateNodeBalancerRequestConfigsInner();
  });
  ...
  describe('CreateNodeBalancerRequestConfigsInner', function() {
    it('should create an instance of CreateNodeBalancerRequestConfigsInner', function() {
      // uncomment below and update the code to test CreateNodeBalancerRequestConfigsInner
      //var instance = new LinodeApi.CreateNodeBalancerRequestConfigsInner();
      //expect(instance).to.be.a(LinodeApi.CreateNodeBalancerRequestConfigsInner);
    });
