...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
  });
  ...
  describe('GetTaggedObjects200ResponseDataInnerData', function() {
    it('should create an instance of GetTaggedObjects200ResponseDataInnerData', function() {
      // uncomment below and update the code to test GetTaggedObjects200ResponseDataInnerData
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be.a(LinodeApi.GetTaggedObjects200ResponseDataInnerData);
    });
    ...
    it('should have the property axfrIps (base name: "axfr_ips")', function() {
      // uncomment below and update the code to test the property axfrIps
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property expireSec (base name: "expire_sec")', function() {
      // uncomment below and update the code to test the property expireSec
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property masterIps (base name: "master_ips")', function() {
      // uncomment below and update the code to test the property masterIps
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property refreshSec (base name: "refresh_sec")', function() {
      // uncomment below and update the code to test the property refreshSec
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property retrySec (base name: "retry_sec")', function() {
      // uncomment below and update the code to test the property retrySec
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property soaEmail (base name: "soa_email")', function() {
      // uncomment below and update the code to test the property soaEmail
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property ttlSec (base name: "ttl_sec")', function() {
      // uncomment below and update the code to test the property ttlSec
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property filesystemPath (base name: "filesystem_path")', function() {
      // uncomment below and update the code to test the property filesystemPath
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property hardwareType (base name: "hardware_type")', function() {
      // uncomment below and update the code to test the property hardwareType
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property linodeId (base name: "linode_id")', function() {
      // uncomment below and update the code to test the property linodeId
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });

    it('should have the property linodeLabel (base name: "linode_label")', function() {
      // uncomment below and update the code to test the property linodeLabel
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property clientConnThrottle (base name: "client_conn_throttle")', function() {
      // uncomment below and update the code to test the property clientConnThrottle
      //var instance = new LinodeApi.GetTaggedObjects200ResponseDataInnerData();
      //expect(instance).to.be();
    });
