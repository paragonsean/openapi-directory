...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.CreateLinodeInstanceRequest();
  });
  ...
  describe('CreateLinodeInstanceRequest', function() {
    it('should create an instance of CreateLinodeInstanceRequest', function() {
      // uncomment below and update the code to test CreateLinodeInstanceRequest
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be.a(LinodeApi.CreateLinodeInstanceRequest);
    });

    it('should have the property authorizedKeys (base name: "authorized_keys")', function() {
      // uncomment below and update the code to test the property authorizedKeys
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });

    it('should have the property authorizedUsers (base name: "authorized_users")', function() {
      // uncomment below and update the code to test the property authorizedUsers
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });

    it('should have the property booted (base name: "booted")', function() {
      // uncomment below and update the code to test the property booted
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stackscriptData (base name: "stackscript_data")', function() {
      // uncomment below and update the code to test the property stackscriptData
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });

    it('should have the property stackscriptId (base name: "stackscript_id")', function() {
      // uncomment below and update the code to test the property stackscriptId
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property backupsEnabled (base name: "backups_enabled")', function() {
    ...
    it('should have the property privateIp (base name: "private_ip")', function() {
    ...
    it('should have the property swapSize (base name: "swap_size")', function() {
      // uncomment below and update the code to test the property swapSize
      //var instance = new LinodeApi.CreateLinodeInstanceRequest();
      //expect(instance).to.be();
    });
