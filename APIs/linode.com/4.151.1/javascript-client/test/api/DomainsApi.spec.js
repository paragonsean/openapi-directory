...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinodeApi.DomainsApi();
  });
  ...
  describe('DomainsApi', function() {
    ...
    describe('createDomainRecord', function() {
      it('should call createDomainRecord successfully', function(done) {
        //uncomment below and update the code to test createDomainRecord
        //instance.createDomainRecord(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteDomainRecord', function() {
      it('should call deleteDomainRecord successfully', function(done) {
        //uncomment below and update the code to test deleteDomainRecord
        //instance.deleteDomainRecord(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDomainRecord', function() {
      it('should call getDomainRecord successfully', function(done) {
        //uncomment below and update the code to test getDomainRecord
        //instance.getDomainRecord(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDomainRecords', function() {
      it('should call getDomainRecords successfully', function(done) {
        //uncomment below and update the code to test getDomainRecords
        //instance.getDomainRecords(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDomainZone', function() {
      it('should call getDomainZone successfully', function(done) {
        //uncomment below and update the code to test getDomainZone
        //instance.getDomainZone(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importDomain', function() {
      it('should call importDomain successfully', function(done) {
        //uncomment below and update the code to test importDomain
        //instance.importDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateDomainRecord', function() {
      it('should call updateDomainRecord successfully', function(done) {
        //uncomment below and update the code to test updateDomainRecord
        //instance.updateDomainRecord(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
