...
export default class SupportApi {
    ...
    */
     ...
     * @callback module:api/SupportApi~closeTicketCallback
     ...
     * @param {module:api/SupportApi~closeTicketCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    closeTicket(ticketId, callback) {
      let postBody = null;
      // verify the required parameter 'ticketId' is set
      if (ticketId === undefined || ticketId === null) {
        throw new Error("Missing the required parameter 'ticketId' when calling closeTicket");
      }
      ...
      return this.apiClient.callApi(
        '/support/tickets/{ticketId}/close', 'POST',
     ...
     * @callback module:api/SupportApi~createTicketCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/SupportTicketRequest} [supportTicketRequest] Open a Support Ticket.
     * @param {module:api/SupportApi~createTicketCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SupportTicket}
     */
    createTicket(opts, callback) {
      opts = opts || {};
      let postBody = opts['supportTicketRequest'];
    ...
    /**
     * Callback function to receive the result of the createTicketAttachment operation.
     * @callback module:api/SupportApi~createTicketAttachmentCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SupportApi~createTicketAttachmentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    createTicketAttachment(ticketId, file, callback) {
      let postBody = null;
      // verify the required parameter 'ticketId' is set
      if (ticketId === undefined || ticketId === null) {
        throw new Error("Missing the required parameter 'ticketId' when calling createTicketAttachment");
      }
      // verify the required parameter 'file' is set
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling createTicketAttachment");
      }
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/support/tickets/{ticketId}/attachments', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the createTicketReply operation.
     * @callback module:api/SupportApi~createTicketReplyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SupportTicketReply} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ticketId The ID of the Support Ticket.
     * @param {module:model/CreateTicketReplyRequest} createTicketReplyRequest Add a reply.
     * @param {module:api/SupportApi~createTicketReplyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SupportTicketReply}
     */
    createTicketReply(ticketId, createTicketReplyRequest, callback) {
      let postBody = createTicketReplyRequest;
      // verify the required parameter 'ticketId' is set
      if (ticketId === undefined || ticketId === null) {
        throw new Error("Missing the required parameter 'ticketId' when calling createTicketReply");
      }
      // verify the required parameter 'createTicketReplyRequest' is set
      if (createTicketReplyRequest === undefined || createTicketReplyRequest === null) {
        throw new Error("Missing the required parameter 'createTicketReplyRequest' when calling createTicketReply");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = SupportTicketReply;
      return this.apiClient.callApi(
        '/support/tickets/{ticketId}/replies', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/SupportApi~getTicketCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SupportTicket} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} ticketId The ID of the Support Ticket.
     * @param {module:api/SupportApi~getTicketCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SupportTicket}
     */
    ...
    /**
     * Callback function to receive the result of the getTicketReplies operation.
     * @callback module:api/SupportApi~getTicketRepliesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTicketReplies200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SupportApi~getTicketRepliesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTicketReplies200Response}
     */
    getTicketReplies(ticketId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ticketId' is set
      if (ticketId === undefined || ticketId === null) {
        throw new Error("Missing the required parameter 'ticketId' when calling getTicketReplies");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetTicketReplies200Response;
      return this.apiClient.callApi(
        '/support/tickets/{ticketId}/replies', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/SupportApi~getTicketsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTickets200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [page = 1)] The page of a collection to return.
     * @param {Number} [pageSize = 100)] The number of items to return per page.
     * @param {module:api/SupportApi~getTicketsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTickets200Response}
     */
    getTickets(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetTickets200Response;
      return this.apiClient.callApi(
        '/support/tickets', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
