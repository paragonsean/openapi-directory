...
/**
* StackScripts service.
* @module api/StackScriptsApi
* @version 4.151.1
*/
export default class StackScriptsApi {

    /**
    * Constructs a new StackScriptsApi. 
    * @alias module:api/StackScriptsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addStackScript operation.
     * @callback module:api/StackScriptsApi~addStackScriptCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StackScript} data The data returned by the service call.
     ...
     * @param {module:model/StackScript} stackScript The properties to set for the new StackScript.
     * @param {module:api/StackScriptsApi~addStackScriptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StackScript}
     */
    addStackScript(stackScript, callback) {
      let postBody = stackScript;
      // verify the required parameter 'stackScript' is set
      if (stackScript === undefined || stackScript === null) {
        throw new Error("Missing the required parameter 'stackScript' when calling addStackScript");
      }
      ...
      let returnType = StackScript;
      return this.apiClient.callApi(
        '/linode/stackscripts', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteStackScript operation.
     * @callback module:api/StackScriptsApi~deleteStackScriptCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} stackscriptId The ID of the StackScript to look up.
     * @param {module:api/StackScriptsApi~deleteStackScriptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    deleteStackScript(stackscriptId, callback) {
      let postBody = null;
      // verify the required parameter 'stackscriptId' is set
      if (stackscriptId === undefined || stackscriptId === null) {
        throw new Error("Missing the required parameter 'stackscriptId' when calling deleteStackScript");
      }
      ...
      return this.apiClient.callApi(
        '/linode/stackscripts/{stackscriptId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getStackScript operation.
     * @callback module:api/StackScriptsApi~getStackScriptCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StackScript} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} stackscriptId The ID of the StackScript to look up.
     * @param {module:api/StackScriptsApi~getStackScriptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StackScript}
     */
    getStackScript(stackscriptId, callback) {
      let postBody = null;
      // verify the required parameter 'stackscriptId' is set
      if (stackscriptId === undefined || stackscriptId === null) {
        throw new Error("Missing the required parameter 'stackscriptId' when calling getStackScript");
      }
      ...
      let returnType = StackScript;
      return this.apiClient.callApi(
        '/linode/stackscripts/{stackscriptId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getStackScripts operation.
     * @callback module:api/StackScriptsApi~getStackScriptsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetStackScripts200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/StackScriptsApi~getStackScriptsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetStackScripts200Response}
     */
    getStackScripts(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetStackScripts200Response;
      return this.apiClient.callApi(
        '/linode/stackscripts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateStackScript operation.
     * @callback module:api/StackScriptsApi~updateStackScriptCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StackScript} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} stackscriptId The ID of the StackScript to look up.
     * @param {Object} opts Optional parameters
     * @param {module:model/StackScript} [stackScript] The fields to update.
     * @param {module:api/StackScriptsApi~updateStackScriptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StackScript}
     */
    updateStackScript(stackscriptId, opts, callback) {
      opts = opts || {};
      let postBody = opts['stackScript'];
      // verify the required parameter 'stackscriptId' is set
      if (stackscriptId === undefined || stackscriptId === null) {
        throw new Error("Missing the required parameter 'stackscriptId' when calling updateStackScript");
      }
      ...
      let returnType = StackScript;
      return this.apiClient.callApi(
        '/linode/stackscripts/{stackscriptId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
