...
export default class TagsApi {
    ...
    */
     ...
     * @param {module:model/CreateTagRequest} [createTagRequest] The tag to create, and optionally the objects to tag. 
     ...
     */
    deleteTag(label, callback) {
      let postBody = null;
      // verify the required parameter 'label' is set
      if (label === undefined || label === null) {
        throw new Error("Missing the required parameter 'label' when calling deleteTag");
      }
    ...
    /**
     * Callback function to receive the result of the getTaggedObjects operation.
     * @callback module:api/TagsApi~getTaggedObjectsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTaggedObjects200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TagsApi~getTaggedObjectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTaggedObjects200Response}
     */
    getTaggedObjects(label, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'label' is set
      if (label === undefined || label === null) {
        throw new Error("Missing the required parameter 'label' when calling getTaggedObjects");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetTaggedObjects200Response;
      return this.apiClient.callApi(
        '/tags/{label}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
