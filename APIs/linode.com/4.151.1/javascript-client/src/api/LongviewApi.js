...
/**
* Longview service.
* @module api/LongviewApi
* @version 4.151.1
*/
export default class LongviewApi {

    /**
    * Constructs a new LongviewApi. 
    * @alias module:api/LongviewApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createLongviewClient operation.
     * @callback module:api/LongviewApi~createLongviewClientCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewClient} data The data returned by the service call.
     ...
     * @param {module:model/LongviewClient} longviewClient Information about the LongviewClient to create.
     * @param {module:api/LongviewApi~createLongviewClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewClient}
     */
    createLongviewClient(longviewClient, callback) {
      let postBody = longviewClient;
      // verify the required parameter 'longviewClient' is set
      if (longviewClient === undefined || longviewClient === null) {
        throw new Error("Missing the required parameter 'longviewClient' when calling createLongviewClient");
      }
      ...
      let returnType = LongviewClient;
      return this.apiClient.callApi(
        '/longview/clients', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteLongviewClient operation.
     * @callback module:api/LongviewApi~deleteLongviewClientCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} clientId The Longview Client ID to access.
     * @param {module:api/LongviewApi~deleteLongviewClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    deleteLongviewClient(clientId, callback) {
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling deleteLongviewClient");
      }
      ...
      return this.apiClient.callApi(
        '/longview/clients/{clientId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLongviewClient operation.
     * @callback module:api/LongviewApi~getLongviewClientCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewClient} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} clientId The Longview Client ID to access.
     * @param {module:api/LongviewApi~getLongviewClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewClient}
     */
    getLongviewClient(clientId, callback) {
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getLongviewClient");
      }
    ...
    /**
     * Callback function to receive the result of the getLongviewClients operation.
     * @callback module:api/LongviewApi~getLongviewClientsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetLongviewClients200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LongviewApi~getLongviewClientsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetLongviewClients200Response}
     */
    getLongviewClients(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetLongviewClients200Response;
      return this.apiClient.callApi(
        '/longview/clients', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLongviewPlan operation.
     * @callback module:api/LongviewApi~getLongviewPlanCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewSubscription} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LongviewApi~getLongviewPlanCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewSubscription}
     */
    getLongviewPlan(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = LongviewSubscription;
      return this.apiClient.callApi(
        '/longview/plan', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getLongviewSubscription operation.
     * @callback module:api/LongviewApi~getLongviewSubscriptionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewSubscription} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The Longview Subscription to look up.
     * @param {module:api/LongviewApi~getLongviewSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewSubscription}
     */
    getLongviewSubscription(subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling getLongviewSubscription");
      }
      ...
      let returnType = LongviewSubscription;
      return this.apiClient.callApi(
        '/longview/subscriptions/{subscriptionId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLongviewSubscriptions operation.
     * @callback module:api/LongviewApi~getLongviewSubscriptionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetLongviewSubscriptions200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [page = 1)] The page of a collection to return.
     * @param {Number} [pageSize = 100)] The number of items to return per page.
     * @param {module:api/LongviewApi~getLongviewSubscriptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetLongviewSubscriptions200Response}
     */
    getLongviewSubscriptions(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetLongviewSubscriptions200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the updateLongviewClient operation.
     * @callback module:api/LongviewApi~updateLongviewClientCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewClient} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} clientId The Longview Client ID to access.
     * @param {module:model/LongviewClient} longviewClient The fields to update.
     * @param {module:api/LongviewApi~updateLongviewClientCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewClient}
     */
    updateLongviewClient(clientId, longviewClient, callback) {
      let postBody = longviewClient;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling updateLongviewClient");
      }
      // verify the required parameter 'longviewClient' is set
      if (longviewClient === undefined || longviewClient === null) {
        throw new Error("Missing the required parameter 'longviewClient' when calling updateLongviewClient");
      }
    ...
    /**
     * Callback function to receive the result of the updateLongviewPlan operation.
     * @callback module:api/LongviewApi~updateLongviewPlanCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LongviewSubscription} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/LongviewPlan} longviewPlan Update your Longview subscription plan.
     * @param {module:api/LongviewApi~updateLongviewPlanCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LongviewSubscription}
     */
    updateLongviewPlan(longviewPlan, callback) {
      let postBody = longviewPlan;
      // verify the required parameter 'longviewPlan' is set
      if (longviewPlan === undefined || longviewPlan === null) {
        throw new Error("Missing the required parameter 'longviewPlan' when calling updateLongviewPlan");
      }
