...
export default class VolumesApi {
    ...
    */
     ...
     * @callback module:api/VolumesApi~attachVolumeCallback
     ...
     * @param {Number} volumeId ID of the Volume to attach.
     * @param {module:model/AttachVolumeRequest} attachVolumeRequest Volume to attach to a Linode.
     * @param {module:api/VolumesApi~attachVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Volume}
     */
    attachVolume(volumeId, attachVolumeRequest, callback) {
      let postBody = attachVolumeRequest;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling attachVolume");
      }
      // verify the required parameter 'attachVolumeRequest' is set
      if (attachVolumeRequest === undefined || attachVolumeRequest === null) {
        throw new Error("Missing the required parameter 'attachVolumeRequest' when calling attachVolume");
      }
    ...
    /**
     * Callback function to receive the result of the cloneVolume operation.
     * @callback module:api/VolumesApi~cloneVolumeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Volume} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} volumeId ID of the Volume to clone.
     * @param {module:model/CloneVolumeRequest} cloneVolumeRequest The requested state your Volume will be cloned into.
     * @param {module:api/VolumesApi~cloneVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Volume}
     */
    cloneVolume(volumeId, cloneVolumeRequest, callback) {
      let postBody = cloneVolumeRequest;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling cloneVolume");
      }
      // verify the required parameter 'cloneVolumeRequest' is set
      if (cloneVolumeRequest === undefined || cloneVolumeRequest === null) {
        throw new Error("Missing the required parameter 'cloneVolumeRequest' when calling cloneVolume");
      }
     ...
     * @param {module:model/CreateVolumeRequest} createVolumeRequest The requested initial state of a new Volume.
     ...
     * data is of type: {@link module:model/Volume}
     */
    createVolume(createVolumeRequest, callback) {
     ...
     * @callback module:api/VolumesApi~deleteVolumeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} volumeId ID of the Volume to look up.
     * @param {module:api/VolumesApi~deleteVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/VolumesApi~detachVolumeCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} volumeId ID of the Volume to detach.
     * @param {module:api/VolumesApi~detachVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    detachVolume(volumeId, callback) {
      let postBody = null;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling detachVolume");
      }
    ...
    /**
     * Callback function to receive the result of the resizeVolume operation.
     * @callback module:api/VolumesApi~resizeVolumeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Volume} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} volumeId ID of the Volume to resize.
     * @param {module:model/ResizeVolumeRequest} resizeVolumeRequest The requested size to increase your Volume to.
     * @param {module:api/VolumesApi~resizeVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Volume}
     */
    resizeVolume(volumeId, resizeVolumeRequest, callback) {
      let postBody = resizeVolumeRequest;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
        throw new Error("Missing the required parameter 'volumeId' when calling resizeVolume");
      }
      // verify the required parameter 'resizeVolumeRequest' is set
      if (resizeVolumeRequest === undefined || resizeVolumeRequest === null) {
        throw new Error("Missing the required parameter 'resizeVolumeRequest' when calling resizeVolume");
      }
     ...
     * @callback module:api/VolumesApi~updateVolumeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Volume} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} volumeId ID of the Volume to look up.
     * @param {module:model/UpdateVolumeRequest} updateVolumeRequest If any updated field fails to pass validation, the Volume will not be updated. 
     * @param {module:api/VolumesApi~updateVolumeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Volume}
     */
    updateVolume(volumeId, updateVolumeRequest, callback) {
