...
export default class ImagesApi {
    ...
    */
     ...
     * @param {module:model/CreateImageRequest} [createImageRequest] Information about the Image to create.
    ...
    /**
     * Callback function to receive the result of the imagesUploadPost operation.
     * @callback module:api/ImagesApi~imagesUploadPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ImagesUploadPost200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ImagesUploadPostRequest} [imagesUploadPostRequest] The uploaded Image details.
     * @param {module:api/ImagesApi~imagesUploadPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ImagesUploadPost200Response}
     */
    imagesUploadPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['imagesUploadPostRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ImagesUploadPost200Response;
     ...
     * @param {String} imageId ID of the Image to look up.
     * @param {module:model/Image} image The fields to update. 
     ...
     * data is of type: {@link module:model/Image}
     */
    updateImage(imageId, image, callback) {
      let postBody = image;
      // verify the required parameter 'imageId' is set
      if (imageId === undefined || imageId === null) {
      ...
      if (image === undefined || image === null) {
        throw new Error("Missing the required parameter 'image' when calling updateImage");
      }
