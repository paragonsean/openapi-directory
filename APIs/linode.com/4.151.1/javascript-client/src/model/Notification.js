...
class Notification {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('entity')) {
                obj['entity'] = NotificationEntity.constructFromObject(data['entity']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['entity']) { // data not null
          NotificationEntity.validateJSON(data['entity']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/NotificationEntity} entity
 */
Notification.prototype['entity'] = undefined;

/**
 * A short description of this Notification. 
 * @member {String} label
 */
Notification.prototype['label'] = undefined;
 ...
 * @member {module:model/Notification.SeverityEnum} severity
 */
Notification.prototype['severity'] = undefined;
 ...
 * @member {Date} until
 */
Notification.prototype['until'] = undefined;
 ...
 * @member {Date} when
 */
Notification.prototype['when'] = undefined;
...
Notification['TypeEnum'] = {
    ...
    /**
     * value: "migration_scheduled"
     * @const
     */
    "migration_scheduled": "migration_scheduled",

    /**
     * value: "migration_imminent"
     * @const
     */
