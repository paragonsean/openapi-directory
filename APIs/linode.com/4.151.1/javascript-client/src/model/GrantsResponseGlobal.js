...
/**
 * The GrantsResponseGlobal model module.
 * @module model/GrantsResponseGlobal
 * @version 4.151.1
 */
class GrantsResponseGlobal {
    /**
     * Constructs a new <code>GrantsResponseGlobal</code>.
     * A structure containing the Account-level grants a User has. 
     * @alias module:model/GrantsResponseGlobal
     */
    constructor() { 
        
        GrantsResponseGlobal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GrantsResponseGlobal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GrantsResponseGlobal} obj Optional instance to populate.
     * @return {module:model/GrantsResponseGlobal} The populated <code>GrantsResponseGlobal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GrantsResponseGlobal();

            if (data.hasOwnProperty('account_access')) {
                obj['account_access'] = ApiClient.convertToType(data['account_access'], 'String');
            }
            if (data.hasOwnProperty('add_databases')) {
                obj['add_databases'] = ApiClient.convertToType(data['add_databases'], 'Boolean');
            }
            if (data.hasOwnProperty('add_domains')) {
                obj['add_domains'] = ApiClient.convertToType(data['add_domains'], 'Boolean');
            }
            if (data.hasOwnProperty('add_firewalls')) {
                obj['add_firewalls'] = ApiClient.convertToType(data['add_firewalls'], 'Boolean');
            }
            if (data.hasOwnProperty('add_images')) {
                obj['add_images'] = ApiClient.convertToType(data['add_images'], 'Boolean');
            }
            if (data.hasOwnProperty('add_linodes')) {
                obj['add_linodes'] = ApiClient.convertToType(data['add_linodes'], 'Boolean');
            }
            if (data.hasOwnProperty('add_longview')) {
                obj['add_longview'] = ApiClient.convertToType(data['add_longview'], 'Boolean');
            }
            if (data.hasOwnProperty('add_nodebalancers')) {
                obj['add_nodebalancers'] = ApiClient.convertToType(data['add_nodebalancers'], 'Boolean');
            }
            if (data.hasOwnProperty('add_stackscripts')) {
                obj['add_stackscripts'] = ApiClient.convertToType(data['add_stackscripts'], 'Boolean');
            }
            if (data.hasOwnProperty('add_volumes')) {
                obj['add_volumes'] = ApiClient.convertToType(data['add_volumes'], 'Boolean');
            }
            if (data.hasOwnProperty('cancel_account')) {
                obj['cancel_account'] = ApiClient.convertToType(data['cancel_account'], 'Boolean');
            }
            if (data.hasOwnProperty('longview_subscription')) {
                obj['longview_subscription'] = ApiClient.convertToType(data['longview_subscription'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GrantsResponseGlobal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GrantsResponseGlobal</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['account_access'] && !(typeof data['account_access'] === 'string' || data['account_access'] instanceof String)) {
            throw new Error("Expected the field `account_access` to be a primitive type in the JSON string but got " + data['account_access']);
        }
 ...
 * @member {module:model/GrantsResponseGlobal.AccountAccessEnum} account_access
 */
GrantsResponseGlobal.prototype['account_access'] = undefined;

/**
 * if true, this User may add Managed Databases.
 * @member {Boolean} add_databases
 */
GrantsResponseGlobal.prototype['add_databases'] = undefined;

/**
 * If true, this User may add Domains.
 * @member {Boolean} add_domains
 */
GrantsResponseGlobal.prototype['add_domains'] = undefined;

/**
 * If true, this User may add Firewalls.
 * @member {Boolean} add_firewalls
 */
GrantsResponseGlobal.prototype['add_firewalls'] = undefined;

/**
 * If true, this User may add Images.
 * @member {Boolean} add_images
 */
GrantsResponseGlobal.prototype['add_images'] = undefined;

/**
 * If true, this User may create Linodes.
 * @member {Boolean} add_linodes
 */
GrantsResponseGlobal.prototype['add_linodes'] = undefined;

/**
 * If true, this User may create Longview clients and view the current plan.
 * @member {Boolean} add_longview
 */
GrantsResponseGlobal.prototype['add_longview'] = undefined;

/**
 * If true, this User may add NodeBalancers.
 * @member {Boolean} add_nodebalancers
 */
GrantsResponseGlobal.prototype['add_nodebalancers'] = undefined;

/**
 * If true, this User may add StackScripts.
 * @member {Boolean} add_stackscripts
 */
GrantsResponseGlobal.prototype['add_stackscripts'] = undefined;

/**
 * If true, this User may add Volumes.
 * @member {Boolean} add_volumes
 */
GrantsResponseGlobal.prototype['add_volumes'] = undefined;

/**
 * If true, this User may cancel the entire Account.
 * @member {Boolean} cancel_account
 */
GrantsResponseGlobal.prototype['cancel_account'] = undefined;

/**
 * If true, this User may manage the Account's Longview subscription.
 * @member {Boolean} longview_subscription
 */
GrantsResponseGlobal.prototype['longview_subscription'] = undefined;
...
/**
 * Allowed values for the <code>account_access</code> property.
 * @enum {String}
 * @readonly
 */
GrantsResponseGlobal['AccountAccessEnum'] = {
...
export default GrantsResponseGlobal;
