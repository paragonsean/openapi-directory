...
import InvoiceTaxSummaryInner from './InvoiceTaxSummaryInner';
...
class Invoice {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tax_summary')) {
                obj['tax_summary'] = ApiClient.convertToType(data['tax_summary'], [InvoiceTaxSummaryInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tax_summary']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['tax_summary'])) {
                throw new Error("Expected the field `tax_summary` to be an array in the JSON data but got " + data['tax_summary']);
            }
            // validate the optional field `tax_summary` (array)
            for (const item of data['tax_summary']) {
                InvoiceTaxSummaryInner.validateJSON(item);
            };
        }
 ...
 * @member {String} label
 */
Invoice.prototype['label'] = undefined;
 ...
 * @member {Array.<module:model/InvoiceTaxSummaryInner>} tax_summary
 */
Invoice.prototype['tax_summary'] = undefined;
