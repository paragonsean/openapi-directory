...
import SupportTicketEntity from './SupportTicketEntity';
...
class SupportTicket {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('entity')) {
                obj['entity'] = SupportTicketEntity.constructFromObject(data['entity']);
            }
            ...
            if (data.hasOwnProperty('opened')) {
                obj['opened'] = ApiClient.convertToType(data['opened'], 'Date');
            }
            if (data.hasOwnProperty('opened_by')) {
                obj['opened_by'] = ApiClient.convertToType(data['opened_by'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['entity']) { // data not null
          SupportTicketEntity.validateJSON(data['entity']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['opened_by'] && !(typeof data['opened_by'] === 'string' || data['opened_by'] instanceof String)) {
            throw new Error("Expected the field `opened_by` to be a primitive type in the JSON string but got " + data['opened_by']);
        }
        // ensure the json data is a string
 ...
 */
SupportTicket.prototype['attachments'] = undefined;

/**
 * Whether the Support Ticket may be closed. 
 * @member {Boolean} closable
 */
SupportTicket.prototype['closable'] = undefined;

/**
 * The date and time this Ticket was closed. 
 * @member {Date} closed
 */
SupportTicket.prototype['closed'] = undefined;

/**
 * The full details of the issue or question. 
 * @member {String} description
 */
SupportTicket.prototype['description'] = undefined;

/**
 * @member {module:model/SupportTicketEntity} entity
 */
SupportTicket.prototype['entity'] = undefined;

/**
 * The Gravatar ID of the User who opened this Ticket. 
 * @member {String} gravatar_id
 */
SupportTicket.prototype['gravatar_id'] = undefined;

/**
 * The ID of the Support Ticket. 
 * @member {Number} id
 */
SupportTicket.prototype['id'] = undefined;

/**
 * The date and time this Ticket was created. 
 * @member {Date} opened
 */
SupportTicket.prototype['opened'] = undefined;

/**
 * The User who opened this Ticket. 
 * @member {String} opened_by
 */
SupportTicket.prototype['opened_by'] = undefined;

/**
 * The current status of this Ticket.
 * @member {module:model/SupportTicket.StatusEnum} status
 */
SupportTicket.prototype['status'] = undefined;

/**
 * The summary or title for this Ticket. 
 * @member {String} summary
 */
SupportTicket.prototype['summary'] = undefined;

/**
 * The date and time this Ticket was last updated. 
 * @member {Date} updated
 */
SupportTicket.prototype['updated'] = undefined;

/**
 * The User who last updated this Ticket. 
 * @member {String} updated_by
 */
SupportTicket.prototype['updated_by'] = undefined;
