...
import ManagedCredential from './ManagedCredential';

/**
 * The CreateManagedCredentialRequest model module.
 * @module model/CreateManagedCredentialRequest
 * @version 4.151.1
 */
class CreateManagedCredentialRequest {
    /**
     * Constructs a new <code>CreateManagedCredentialRequest</code>.
     * @alias module:model/CreateManagedCredentialRequest
     * @implements module:model/ManagedCredential
     * @param label {String} The unique label for this Credential. This is for display purposes only. 
     * @param password {String} The password to use when accessing the Managed Service. 
     */
    constructor(label, password) { 
        ManagedCredential.initialize(this);
        CreateManagedCredentialRequest.initialize(this, label, password);
    }
     ...
     */
    static initialize(obj, label, password) { 
        obj['label'] = label;
        obj['password'] = password;
    }

    /**
     * Constructs a <code>CreateManagedCredentialRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateManagedCredentialRequest} obj Optional instance to populate.
     * @return {module:model/CreateManagedCredentialRequest} The populated <code>CreateManagedCredentialRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateManagedCredentialRequest();
            ManagedCredential.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('last_decrypted')) {
                obj['last_decrypted'] = ApiClient.convertToType(data['last_decrypted'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateManagedCredentialRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateManagedCredentialRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateManagedCredentialRequest.RequiredProperties) {
...
CreateManagedCredentialRequest.RequiredProperties = ["label", "password"];

/**
 * This Credential's unique ID. 
 * @member {Number} id
 */
CreateManagedCredentialRequest.prototype['id'] = undefined;

/**
 * The unique label for this Credential. This is for display purposes only. 
 * @member {String} label
 */
CreateManagedCredentialRequest.prototype['label'] = undefined;

/**
 * The date this Credential was last decrypted by a member of Linode special forces. 
 * @member {Date} last_decrypted
 */
CreateManagedCredentialRequest.prototype['last_decrypted'] = undefined;

/**
 * The password to use when accessing the Managed Service. 
 * @member {String} password
 */
CreateManagedCredentialRequest.prototype['password'] = undefined;

/**
 * The username to use when accessing the Managed Service. 
 * @member {String} username
 */
CreateManagedCredentialRequest.prototype['username'] = undefined;


// Implement ManagedCredential interface:
/**
 * This Credential's unique ID. 
 * @member {Number} id
 */
ManagedCredential.prototype['id'] = undefined;
/**
 * The unique label for this Credential. This is for display purposes only. 
 * @member {String} label
 */
ManagedCredential.prototype['label'] = undefined;
/**
 * The date this Credential was last decrypted by a member of Linode special forces. 
 * @member {Date} last_decrypted
 */
ManagedCredential.prototype['last_decrypted'] = undefined;




export default CreateManagedCredentialRequest;
