...
class DomainRecord {
    ...
    /**
     * Validates the JSON data with respect to <code>DomainRecord</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainRecord</code>.
     */
 ...
 * @member {Date} created
 */
DomainRecord.prototype['created'] = undefined;
 ...
 */
DomainRecord.prototype['protocol'] = undefined;
 ...
 */
DomainRecord.prototype['service'] = undefined;

/**
 * The tag portion of a CAA record. Only valid and required for CAA record requests. 
 * @member {module:model/DomainRecord.TagEnum} tag
 */
 ...
 */
DomainRecord.prototype['target'] = undefined;

/**
 * \"Time to Live\" - the amount of time in seconds that this Domain's records may be cached by resolvers or other domain servers. Valid values are 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the nearest valid value. 
 * @member {Number} ttl_sec
 */
DomainRecord.prototype['ttl_sec'] = undefined;
 ...
 * @member {module:model/DomainRecord.TypeEnum} type
 */
 ...
 * @member {Date} updated
 */
DomainRecord.prototype['updated'] = undefined;
