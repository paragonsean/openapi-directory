...
import ServiceTransferEntities from './ServiceTransferEntities';
...
class ServiceTransfer {
    ...
    constructor() { 
        ...
        ServiceTransfer.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceTransfer();

            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('entities')) {
                obj['entities'] = ServiceTransferEntities.constructFromObject(data['entities']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceTransfer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceTransfer</code>.
     */
    static validateJSON(data) {
        // validate the optional field `entities`
        if (data['entities']) { // data not null
          ServiceTransferEntities.validateJSON(data['entities']);
        }
 ...
 * @member {Date} created
 */
ServiceTransfer.prototype['created'] = undefined;

/**
 * @member {module:model/ServiceTransferEntities} entities
 */
ServiceTransfer.prototype['entities'] = undefined;

/**
 * When this transfer expires. Transfers will automatically expire 24 hours after creation. 
 * @member {Date} expiry
 */
ServiceTransfer.prototype['expiry'] = undefined;

/**
 * If the requesting account created this transfer. 
 * @member {Boolean} is_sender
 */
ServiceTransfer.prototype['is_sender'] = undefined;
 ...
 * @member {module:model/ServiceTransfer.StatusEnum} status
 */
ServiceTransfer.prototype['status'] = undefined;

/**
 * The token used to identify and accept or cancel this transfer. 
 * @member {String} token
 */
ServiceTransfer.prototype['token'] = undefined;

/**
 * When this transfer was last updated. 
 * @member {Date} updated
 */
ServiceTransfer.prototype['updated'] = undefined;
