...
class Devices {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sdh')) {
                obj['sdh'] = Device.constructFromObject(data['sdh']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Devices</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Devices</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sdh']) { // data not null
          Device.validateJSON(data['sdh']);
        }
 ...
 */
Devices.prototype['sda'] = undefined;

/**
 * @member {module:model/Device} sdb
 */
Devices.prototype['sdb'] = undefined;

/**
 * @member {module:model/Device} sdc
 */
Devices.prototype['sdc'] = undefined;

/**
 * @member {module:model/Device} sdd
 */
Devices.prototype['sdd'] = undefined;

/**
 * @member {module:model/Device} sde
 */
Devices.prototype['sde'] = undefined;

/**
 * @member {module:model/Device} sdf
 */
Devices.prototype['sdf'] = undefined;

/**
 * @member {module:model/Device} sdg
 */
Devices.prototype['sdg'] = undefined;

/**
 * @member {module:model/Device} sdh
 */
Devices.prototype['sdh'] = undefined;
