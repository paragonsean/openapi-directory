...
/**
 * The DatabaseMongoDBRequest model module.
 * @module model/DatabaseMongoDBRequest
 * @version 4.151.1
 */
class DatabaseMongoDBRequest {
    /**
     * Constructs a new <code>DatabaseMongoDBRequest</code>.
     * Managed MongoDB Database request object.
     * @alias module:model/DatabaseMongoDBRequest
    ...
    constructor(engine, label, region, type) { 
        ...
        DatabaseMongoDBRequest.initialize(this, engine, label, region, type);
    }
    ...
    /**
     * Constructs a <code>DatabaseMongoDBRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseMongoDBRequest} obj Optional instance to populate.
     * @return {module:model/DatabaseMongoDBRequest} The populated <code>DatabaseMongoDBRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseMongoDBRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseMongoDBRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseMongoDBRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatabaseMongoDBRequest.RequiredProperties) {
...
DatabaseMongoDBRequest.RequiredProperties = ["engine", "label", "region", "type"];
 ...
 */
DatabaseMongoDBRequest.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabaseMongoDBRequest.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabaseMongoDBRequest.prototype['cluster_size'] = ClusterSizeEnum.1;
 ...
 * @member {module:model/DatabaseMongoDBRequest.CompressionTypeEnum} compression_type
 * @default 'none'
 */
DatabaseMongoDBRequest.prototype['compression_type'] = 'none';
 ...
 * @default false
 */
DatabaseMongoDBRequest.prototype['encrypted'] = false;

/**
 * The Managed Database engine in engine/version format.
 * @member {String} engine
 */
DatabaseMongoDBRequest.prototype['engine'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabaseMongoDBRequest.prototype['label'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabaseMongoDBRequest.prototype['region'] = undefined;
 ...
 */
DatabaseMongoDBRequest.prototype['replica_set'] = undefined;
 ...
 * @default true
 */
DatabaseMongoDBRequest.prototype['ssl_connection'] = true;

/**
 * The type of storage engine for this Database.  **Note:** MMAPV1 is not available for MongoDB versions 4.0 and above. 
 * @member {module:model/DatabaseMongoDBRequest.StorageEngineEnum} storage_engine
 * @default 'wiredtiger'
 */
DatabaseMongoDBRequest.prototype['storage_engine'] = 'wiredtiger';

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabaseMongoDBRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
DatabaseMongoDBRequest['ClusterSizeEnum'] = {
 ...
 * @readonly
 */
DatabaseMongoDBRequest['CompressionTypeEnum'] = {
 ...
 * @readonly
 */
DatabaseMongoDBRequest['StorageEngineEnum'] = {
...
export default DatabaseMongoDBRequest;
