 ...
 * @member {Number} id
 */
EventEntity.prototype['id'] = undefined;

/**
 * The current label of this object. The label may reflect changes that occur with this Event. 
 * @member {String} label
 */
EventEntity.prototype['label'] = undefined;

/**
 * The type of entity that is being referenced by the Event. 
 * @member {module:model/EventEntity.TypeEnum} type
 */
EventEntity.prototype['type'] = undefined;
 ...
 * @member {String} url
 */
EventEntity.prototype['url'] = undefined;
