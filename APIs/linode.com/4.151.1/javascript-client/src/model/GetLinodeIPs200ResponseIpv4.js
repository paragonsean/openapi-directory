...
import IPAddressPrivate from './IPAddressPrivate';

/**
 * The GetLinodeIPs200ResponseIpv4 model module.
 * @module model/GetLinodeIPs200ResponseIpv4
 * @version 4.151.1
 */
class GetLinodeIPs200ResponseIpv4 {
    /**
     * Constructs a new <code>GetLinodeIPs200ResponseIpv4</code>.
     * Information about this Linode&#39;s IPv4 addresses. 
     * @alias module:model/GetLinodeIPs200ResponseIpv4
     */
    constructor() { 
        
        GetLinodeIPs200ResponseIpv4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLinodeIPs200ResponseIpv4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLinodeIPs200ResponseIpv4} obj Optional instance to populate.
     * @return {module:model/GetLinodeIPs200ResponseIpv4} The populated <code>GetLinodeIPs200ResponseIpv4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLinodeIPs200ResponseIpv4();

            if (data.hasOwnProperty('private')) {
                obj['private'] = ApiClient.convertToType(data['private'], [IPAddressPrivate]);
            }
            if (data.hasOwnProperty('public')) {
                obj['public'] = ApiClient.convertToType(data['public'], [IPAddress]);
            }
            if (data.hasOwnProperty('reserved')) {
                obj['reserved'] = ApiClient.convertToType(data['reserved'], [IPAddress]);
            }
            if (data.hasOwnProperty('shared')) {
                obj['shared'] = ApiClient.convertToType(data['shared'], [IPAddress]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLinodeIPs200ResponseIpv4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLinodeIPs200ResponseIpv4</code>.
     */
    static validateJSON(data) {
        if (data['private']) { // data not null
            ...
            for (const item of data['private']) {
                IPAddressPrivate.validateJSON(item);
            };
        }
        ...
        if (data['reserved']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['reserved'])) {
                throw new Error("Expected the field `reserved` to be an array in the JSON data but got " + data['reserved']);
            }
            // validate the optional field `reserved` (array)
            for (const item of data['reserved']) {
                IPAddress.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/IPAddressPrivate>} private
 */
GetLinodeIPs200ResponseIpv4.prototype['private'] = undefined;

/**
 * A list of public IP Address objects belonging to this Linode. 
 * @member {Array.<module:model/IPAddress>} public
 */
GetLinodeIPs200ResponseIpv4.prototype['public'] = undefined;

/**
 * A list of reserved IP Address objects belonging to this Linode. 
 * @member {Array.<module:model/IPAddress>} reserved
 */
GetLinodeIPs200ResponseIpv4.prototype['reserved'] = undefined;

/**
 * A list of shared IP Address objects assigned to this Linode. 
 * @member {Array.<module:model/IPAddress>} shared
 */
GetLinodeIPs200ResponseIpv4.prototype['shared'] = undefined;
...
export default GetLinodeIPs200ResponseIpv4;
