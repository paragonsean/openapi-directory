...
import ManagedContactPhone from './ManagedContactPhone';

/**
 * The ManagedContact model module.
 * @module model/ManagedContact
 * @version 4.151.1
 */
class ManagedContact {
    /**
     * Constructs a new <code>ManagedContact</code>.
     * Information about someone Linode&#39;s special forces may contact in case an issue is detected with a manager service. 
     * @alias module:model/ManagedContact
     */
    constructor() { 
        
        ManagedContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ManagedContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ManagedContact} obj Optional instance to populate.
     * @return {module:model/ManagedContact} The populated <code>ManagedContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagedContact();
            ...
            if (data.hasOwnProperty('phone')) {
                obj['phone'] = ManagedContactPhone.constructFromObject(data['phone']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ManagedContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagedContact</code>.
     */
    static validateJSON(data) {
        ...
        if (data['phone']) { // data not null
          ManagedContactPhone.validateJSON(data['phone']);
        }
 ...
 * @member {String} email
 */
ManagedContact.prototype['email'] = undefined;

/**
 * A grouping for this Contact. This is for display purposes only. 
 * @member {String} group
 */
ManagedContact.prototype['group'] = undefined;

/**
 * This Contact's unique ID. 
 * @member {Number} id
 */
ManagedContact.prototype['id'] = undefined;

/**
 * The name of this Contact. 
 * @member {String} name
 */
ManagedContact.prototype['name'] = undefined;

/**
 * @member {module:model/ManagedContactPhone} phone
 */
ManagedContact.prototype['phone'] = undefined;

/**
 * When this Contact was last updated. 
 * @member {Date} updated
 */
ManagedContact.prototype['updated'] = undefined;
