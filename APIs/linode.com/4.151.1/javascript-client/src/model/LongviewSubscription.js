...
import LongviewSubscriptionPrice from './LongviewSubscriptionPrice';

/**
 * The LongviewSubscription model module.
 * @module model/LongviewSubscription
 * @version 4.151.1
 */
class LongviewSubscription {
    /**
     * Constructs a new <code>LongviewSubscription</code>.
     * A Longview Subscription represents a tier of Longview service you can subscribe to. 
     * @alias module:model/LongviewSubscription
     */
    constructor() { 
        
        LongviewSubscription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LongviewSubscription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LongviewSubscription} obj Optional instance to populate.
     * @return {module:model/LongviewSubscription} The populated <code>LongviewSubscription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LongviewSubscription();

            if (data.hasOwnProperty('clients_included')) {
                obj['clients_included'] = ApiClient.convertToType(data['clients_included'], 'Number');
            }
            ...
            if (data.hasOwnProperty('price')) {
                obj['price'] = LongviewSubscriptionPrice.constructFromObject(data['price']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LongviewSubscription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LongviewSubscription</code>.
     */
    static validateJSON(data) {
        ...
        if (data['price']) { // data not null
          LongviewSubscriptionPrice.validateJSON(data['price']);
        }
 ...
 * @member {Number} clients_included
 */
LongviewSubscription.prototype['clients_included'] = undefined;

/**
 * The unique ID of this Subscription tier. 
 * @member {module:model/LongviewSubscription.IdEnum} id
 */
LongviewSubscription.prototype['id'] = undefined;

/**
 * A display name for this Subscription tier. 
 * @member {String} label
 */
LongviewSubscription.prototype['label'] = undefined;

/**
 * @member {module:model/LongviewSubscriptionPrice} price
 */
LongviewSubscription.prototype['price'] = undefined;
...
export default LongviewSubscription;
