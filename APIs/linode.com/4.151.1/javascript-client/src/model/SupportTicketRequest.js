...
/**
 * The SupportTicketRequest model module.
 * @module model/SupportTicketRequest
 * @version 4.151.1
 */
class SupportTicketRequest {
    /**
     * Constructs a new <code>SupportTicketRequest</code>.
     ...
     * @alias module:model/SupportTicketRequest
     * @param description {String} The full details of the issue or question. 
     * @param summary {String} The summary or title for this SupportTicket. 
     */
    constructor(description, summary) { 
        
        SupportTicketRequest.initialize(this, description, summary);
    }
    ...
    /**
     * Constructs a <code>SupportTicketRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupportTicketRequest} obj Optional instance to populate.
     * @return {module:model/SupportTicketRequest} The populated <code>SupportTicketRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupportTicketRequest();
            ...
            if (data.hasOwnProperty('firewall_id')) {
                obj['firewall_id'] = ApiClient.convertToType(data['firewall_id'], 'Number');
            }
            if (data.hasOwnProperty('linode_id')) {
                obj['linode_id'] = ApiClient.convertToType(data['linode_id'], 'Number');
            }
            if (data.hasOwnProperty('lkecluster_id')) {
                obj['lkecluster_id'] = ApiClient.convertToType(data['lkecluster_id'], 'Number');
            }
            if (data.hasOwnProperty('longviewclient_id')) {
                obj['longviewclient_id'] = ApiClient.convertToType(data['longviewclient_id'], 'Number');
            }
            if (data.hasOwnProperty('managed_issue')) {
                obj['managed_issue'] = ApiClient.convertToType(data['managed_issue'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportTicketRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportTicketRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SupportTicketRequest.RequiredProperties) {
...
SupportTicketRequest.RequiredProperties = ["description", "summary"];

/**
 * The ID of the Managed Database this ticket is regarding, if relevant. 
 * @member {Number} database_id
 */
SupportTicketRequest.prototype['database_id'] = undefined;

/**
 * The full details of the issue or question. 
 * @member {String} description
 */
SupportTicketRequest.prototype['description'] = undefined;

/**
 * The ID of the Domain this ticket is regarding, if relevant. 
 * @member {Number} domain_id
 */
SupportTicketRequest.prototype['domain_id'] = undefined;

/**
 * The ID of the Firewall this ticket is regarding, if relevant. 
 * @member {Number} firewall_id
 */
SupportTicketRequest.prototype['firewall_id'] = undefined;

/**
 * The ID of the Linode this ticket is regarding, if relevant. 
 * @member {Number} linode_id
 */
SupportTicketRequest.prototype['linode_id'] = undefined;

/**
 * The ID of the Kubernetes cluster this ticket is regarding, if relevant. 
 * @member {Number} lkecluster_id
 */
SupportTicketRequest.prototype['lkecluster_id'] = undefined;

/**
 * The ID of the Longview client this ticket is regarding, if relevant. 
 * @member {Number} longviewclient_id
 */
SupportTicketRequest.prototype['longviewclient_id'] = undefined;
 ...
 * @member {Boolean} managed_issue
 */
SupportTicketRequest.prototype['managed_issue'] = undefined;

/**
 * The ID of the NodeBalancer this ticket is regarding, if relevant. 
 * @member {Number} nodebalancer_id
 */
SupportTicketRequest.prototype['nodebalancer_id'] = undefined;
 ...
 */
SupportTicketRequest.prototype['region'] = undefined;

/**
 * The summary or title for this SupportTicket. 
 * @member {String} summary
 */
SupportTicketRequest.prototype['summary'] = undefined;
 ...
 * @member {String} vlan
 */
SupportTicketRequest.prototype['vlan'] = undefined;

/**
 * The ID of the Volume this ticket is regarding, if relevant. 
 * @member {Number} volume_id
 */
SupportTicketRequest.prototype['volume_id'] = undefined;
