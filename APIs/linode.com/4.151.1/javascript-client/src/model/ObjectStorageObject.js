...
/**
 * The ObjectStorageObject model module.
 * @module model/ObjectStorageObject
 * @version 4.151.1
 */
class ObjectStorageObject {
    /**
     * Constructs a new <code>ObjectStorageObject</code>.
     * An Object in Object Storage, or a \&quot;prefix\&quot; that contains one or more objects when a &#x60;delimiter&#x60; is used. 
     * @alias module:model/ObjectStorageObject
     */
    constructor() { 
        
        ObjectStorageObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ObjectStorageObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectStorageObject} obj Optional instance to populate.
     * @return {module:model/ObjectStorageObject} The populated <code>ObjectStorageObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectStorageObject();

            if (data.hasOwnProperty('etag')) {
                obj['etag'] = ApiClient.convertToType(data['etag'], 'String');
            }
            if (data.hasOwnProperty('is_truncated')) {
                obj['is_truncated'] = ApiClient.convertToType(data['is_truncated'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('next_marker')) {
                obj['next_marker'] = ApiClient.convertToType(data['next_marker'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectStorageObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectStorageObject</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['next_marker'] && !(typeof data['next_marker'] === 'string' || data['next_marker'] instanceof String)) {
            throw new Error("Expected the field `next_marker` to be a primitive type in the JSON string but got " + data['next_marker']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
ObjectStorageObject.prototype['etag'] = undefined;

/**
 * Designates if there is another page of bucket objects.
 * @member {Boolean} is_truncated
 */
ObjectStorageObject.prototype['is_truncated'] = undefined;

/**
 * The date and time this object was last modified. `null` if this object represents a prefix. 
 * @member {Date} last_modified
 */
ObjectStorageObject.prototype['last_modified'] = undefined;

/**
 * The name of this object or prefix. 
 * @member {String} name
 */
ObjectStorageObject.prototype['name'] = undefined;
 ...
 * @member {String} next_marker
 */
ObjectStorageObject.prototype['next_marker'] = undefined;

/**
 * The owner of this object, as a UUID. `null` if this object represents a prefix. 
 * @member {String} owner
 */
ObjectStorageObject.prototype['owner'] = undefined;

/**
 * The size of this object, in bytes. `null` if this object represents a prefix. 
 * @member {Number} size
 */
ObjectStorageObject.prototype['size'] = undefined;
...
export default ObjectStorageObject;
