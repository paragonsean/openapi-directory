...
/**
 * The ObjectStorageCluster model module.
 * @module model/ObjectStorageCluster
 * @version 4.151.1
 */
class ObjectStorageCluster {
    /**
     * Constructs a new <code>ObjectStorageCluster</code>.
     * An Object Storage Cluster
     * @alias module:model/ObjectStorageCluster
     */
    constructor() { 
        
        ObjectStorageCluster.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ObjectStorageCluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectStorageCluster} obj Optional instance to populate.
     * @return {module:model/ObjectStorageCluster} The populated <code>ObjectStorageCluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectStorageCluster();
            ...
            if (data.hasOwnProperty('static_site_domain')) {
                obj['static_site_domain'] = ApiClient.convertToType(data['static_site_domain'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectStorageCluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectStorageCluster</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['static_site_domain'] && !(typeof data['static_site_domain'] === 'string' || data['static_site_domain'] instanceof String)) {
            throw new Error("Expected the field `static_site_domain` to be a primitive type in the JSON string but got " + data['static_site_domain']);
        }
        // ensure the json data is a string
 ...
 */
ObjectStorageCluster.prototype['domain'] = undefined;

/**
 * The unique ID for this cluster.
 * @member {String} id
 */
ObjectStorageCluster.prototype['id'] = undefined;

/**
 * The region where this cluster is located.
 * @member {String} region
 */
ObjectStorageCluster.prototype['region'] = undefined;

/**
 * The base URL for this cluster used when hosting static sites.
 * @member {String} static_site_domain
 */
ObjectStorageCluster.prototype['static_site_domain'] = undefined;

/**
 * This cluster's status.
 * @member {module:model/ObjectStorageCluster.StatusEnum} status
 */
ObjectStorageCluster.prototype['status'] = undefined;
 ...
 * @readonly
 */
ObjectStorageCluster['StatusEnum'] = {
...
export default ObjectStorageCluster;
