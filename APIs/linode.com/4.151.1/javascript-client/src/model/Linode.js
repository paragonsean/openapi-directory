...
/**
 * The Linode model module.
 * @module model/Linode
 * @version 4.151.1
 */
class Linode {
    /**
     * Constructs a new <code>Linode</code>.
     * @alias module:model/Linode
     */
    constructor() { 
        
        Linode.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Linode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Linode} obj Optional instance to populate.
     * @return {module:model/Linode} The populated <code>Linode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('alerts')) {
                obj['alerts'] = LinodeAlerts.constructFromObject(data['alerts']);
            }
            if (data.hasOwnProperty('backups')) {
                obj['backups'] = LinodeBackups.constructFromObject(data['backups']);
            }
            ...
            if (data.hasOwnProperty('host_uuid')) {
                obj['host_uuid'] = ApiClient.convertToType(data['host_uuid'], 'String');
            }
            ...
            if (data.hasOwnProperty('specs')) {
                obj['specs'] = LinodeSpecs.constructFromObject(data['specs']);
            }
            ...
            if (data.hasOwnProperty('watchdog_enabled')) {
                obj['watchdog_enabled'] = ApiClient.convertToType(data['watchdog_enabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Linode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Linode</code>.
     */
    static validateJSON(data) {
        // validate the optional field `alerts`
        if (data['alerts']) { // data not null
          LinodeAlerts.validateJSON(data['alerts']);
        }
        // validate the optional field `backups`
        if (data['backups']) { // data not null
          LinodeBackups.validateJSON(data['backups']);
        }
        ...
        // ensure the json data is a string
        if (data['host_uuid'] && !(typeof data['host_uuid'] === 'string' || data['host_uuid'] instanceof String)) {
            throw new Error("Expected the field `host_uuid` to be a primitive type in the JSON string but got " + data['host_uuid']);
        }
        // ensure the json data is a string
        if (data['hypervisor'] && !(typeof data['hypervisor'] === 'string' || data['hypervisor'] instanceof String)) {
            throw new Error("Expected the field `hypervisor` to be a primitive type in the JSON string but got " + data['hypervisor']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['ipv4'])) {
            throw new Error("Expected the field `ipv4` to be an array in the JSON data but got " + data['ipv4']);
        }
        // ensure the json data is a string
        ...
        if (data['specs']) { // data not null
          LinodeSpecs.validateJSON(data['specs']);
        }
        // ensure the json data is a string
 ...
 */
Linode.prototype['alerts'] = undefined;

/**
 * @member {module:model/LinodeBackups} backups
 */
Linode.prototype['backups'] = undefined;

/**
 * When this Linode was created.
 * @member {Date} created
 */
Linode.prototype['created'] = undefined;

/**
 * A deprecated property denoting a group label for this Linode. 
 * @member {String} group
 */
Linode.prototype['group'] = undefined;

/**
 * The Linode's host machine, as a UUID.
 * @member {String} host_uuid
 */
Linode.prototype['host_uuid'] = undefined;

/**
 * The virtualization software powering this Linode. 
 * @member {module:model/Linode.HypervisorEnum} hypervisor
 */
Linode.prototype['hypervisor'] = undefined;

/**
 * This Linode's ID which must be provided for all operations impacting this Linode. 
 * @member {Number} id
 */
Linode.prototype['id'] = undefined;

/**
 * @member {String} image
 */
Linode.prototype['image'] = undefined;
 ...
 * @member {Array.<String>} ipv4
 */
Linode.prototype['ipv4'] = undefined;
 ...
 * @member {String} ipv6
 */
Linode.prototype['ipv6'] = undefined;
 ...
 * @member {String} label
 */
Linode.prototype['label'] = undefined;
 ...
 */
Linode.prototype['region'] = undefined;

/**
 * @member {module:model/LinodeSpecs} specs
 */
Linode.prototype['specs'] = undefined;
 ...
 * @member {module:model/Linode.StatusEnum} status
 */
Linode.prototype['status'] = undefined;

/**
 * An array of tags applied to this object.  Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
Linode.prototype['tags'] = undefined;
...
/**
 * Allowed values for the <code>hypervisor</code> property.
 * @enum {String}
 * @readonly
 */
Linode['HypervisorEnum'] = {
