...
/**
 * The NodeBalancerNode model module.
 * @module model/NodeBalancerNode
 * @version 4.151.1
 */
class NodeBalancerNode {
    /**
     * Constructs a new <code>NodeBalancerNode</code>.
     ...
     * @alias module:model/NodeBalancerNode
     */
    constructor() { 
        
        NodeBalancerNode.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NodeBalancerNode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeBalancerNode} obj Optional instance to populate.
     * @return {module:model/NodeBalancerNode} The populated <code>NodeBalancerNode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeBalancerNode();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeBalancerNode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeBalancerNode</code>.
     */
 ...
 */
NodeBalancerNode.prototype['address'] = undefined;

/**
 * The NodeBalancer Config ID that this Node belongs to. 
 * @member {Number} config_id
 */
NodeBalancerNode.prototype['config_id'] = undefined;

/**
 * This node's unique ID.
 * @member {Number} id
 */
NodeBalancerNode.prototype['id'] = undefined;

/**
 * The label for this node.  This is for display purposes only. 
 * @member {String} label
 */
NodeBalancerNode.prototype['label'] = undefined;
 ...
 * @member {module:model/NodeBalancerNode.ModeEnum} mode
 */
NodeBalancerNode.prototype['mode'] = undefined;

/**
 * The NodeBalancer ID that this Node belongs to. 
 * @member {Number} nodebalancer_id
 */
NodeBalancerNode.prototype['nodebalancer_id'] = undefined;

/**
 * The current status of this node, based on the configured checks of its NodeBalancer Config. 
 * @member {module:model/NodeBalancerNode.StatusEnum} status
 */
NodeBalancerNode.prototype['status'] = undefined;
 ...
 */
NodeBalancerNode.prototype['weight'] = undefined;
...
export default NodeBalancerNode;
