...
import GrantsResponseGlobal from './GrantsResponseGlobal';

/**
 * The GrantsResponse model module.
 * @module model/GrantsResponse
 * @version 4.151.1
 */
class GrantsResponse {
    /**
     * Constructs a new <code>GrantsResponse</code>.
     ...
     * @alias module:model/GrantsResponse
     */
    constructor() { 
        
        GrantsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GrantsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GrantsResponse} obj Optional instance to populate.
     * @return {module:model/GrantsResponse} The populated <code>GrantsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GrantsResponse();

            if (data.hasOwnProperty('database')) {
                obj['database'] = ApiClient.convertToType(data['database'], [Grant]);
            }
            if (data.hasOwnProperty('domain')) {
                obj['domain'] = ApiClient.convertToType(data['domain'], [Grant]);
            }
            if (data.hasOwnProperty('global')) {
                obj['global'] = GrantsResponseGlobal.constructFromObject(data['global']);
            }
            if (data.hasOwnProperty('image')) {
                obj['image'] = ApiClient.convertToType(data['image'], [Grant]);
            }
            if (data.hasOwnProperty('linode')) {
                obj['linode'] = ApiClient.convertToType(data['linode'], [Grant]);
            }
            if (data.hasOwnProperty('longview')) {
                obj['longview'] = ApiClient.convertToType(data['longview'], [Grant]);
            }
            if (data.hasOwnProperty('nodebalancer')) {
                obj['nodebalancer'] = ApiClient.convertToType(data['nodebalancer'], [Grant]);
            }
            if (data.hasOwnProperty('stackscript')) {
                obj['stackscript'] = ApiClient.convertToType(data['stackscript'], [Grant]);
            }
            if (data.hasOwnProperty('volume')) {
                obj['volume'] = ApiClient.convertToType(data['volume'], [Grant]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GrantsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GrantsResponse</code>.
     */
    static validateJSON(data) {
        if (data['database']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['database'])) {
                throw new Error("Expected the field `database` to be an array in the JSON data but got " + data['database']);
            }
        ...
        if (data['global']) { // data not null
          GrantsResponseGlobal.validateJSON(data['global']);
        }
        ...
        if (data['linode']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['linode'])) {
                throw new Error("Expected the field `linode` to be an array in the JSON data but got " + data['linode']);
            }
            // validate the optional field `linode` (array)
            for (const item of data['linode']) {
                Grant.validateJSON(item);
            };
        }
        if (data['longview']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['longview'])) {
                throw new Error("Expected the field `longview` to be an array in the JSON data but got " + data['longview']);
            }
            // validate the optional field `longview` (array)
            for (const item of data['longview']) {
                Grant.validateJSON(item);
            };
        }
        if (data['nodebalancer']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['nodebalancer'])) {
                throw new Error("Expected the field `nodebalancer` to be an array in the JSON data but got " + data['nodebalancer']);
            }
            // validate the optional field `nodebalancer` (array)
            for (const item of data['nodebalancer']) {
                Grant.validateJSON(item);
            };
        }
        if (data['stackscript']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['stackscript'])) {
                throw new Error("Expected the field `stackscript` to be an array in the JSON data but got " + data['stackscript']);
            }
            // validate the optional field `stackscript` (array)
            for (const item of data['stackscript']) {
                Grant.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/Grant>} database
 */
GrantsResponse.prototype['database'] = undefined;

/**
 * The grants this User has for each Domain that is owned by this Account. 
 * @member {Array.<module:model/Grant>} domain
 */
GrantsResponse.prototype['domain'] = undefined;

/**
 * @member {module:model/GrantsResponseGlobal} global
 */
GrantsResponse.prototype['global'] = undefined;

/**
 * The grants this User has for each Image that is owned by this Account. 
 * @member {Array.<module:model/Grant>} image
 */
GrantsResponse.prototype['image'] = undefined;

/**
 * The grants this User has for each Linode that is owned by this Account. 
 * @member {Array.<module:model/Grant>} linode
 */
GrantsResponse.prototype['linode'] = undefined;

/**
 * The grants this User has for each Longview Client that is owned by this Account. 
 * @member {Array.<module:model/Grant>} longview
 */
GrantsResponse.prototype['longview'] = undefined;

/**
 * The grants this User has for each NodeBalancer that is owned by this Account. 
 * @member {Array.<module:model/Grant>} nodebalancer
 */
GrantsResponse.prototype['nodebalancer'] = undefined;

/**
 * The grants this User has for each StackScript that is owned by this Account. 
 * @member {Array.<module:model/Grant>} stackscript
 */
GrantsResponse.prototype['stackscript'] = undefined;

/**
 * The grants this User has for each Block Storage Volume that is owned by this Account. 
 * @member {Array.<module:model/Grant>} volume
 */
GrantsResponse.prototype['volume'] = undefined;
