...
import LinodeTypeAddons from './LinodeTypeAddons';
import LinodeTypePrice from './LinodeTypePrice';

/**
 * The LinodeType model module.
 * @module model/LinodeType
 * @version 4.151.1
 */
class LinodeType {
    /**
     * Constructs a new <code>LinodeType</code>.
     ...
     * @alias module:model/LinodeType
     */
    constructor() { 
        
        LinodeType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinodeType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinodeType} obj Optional instance to populate.
     * @return {module:model/LinodeType} The populated <code>LinodeType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinodeType();

            if (data.hasOwnProperty('addons')) {
                obj['addons'] = LinodeTypeAddons.constructFromObject(data['addons']);
            }
            ...
            if (data.hasOwnProperty('network_out')) {
                obj['network_out'] = ApiClient.convertToType(data['network_out'], 'Number');
            }
            if (data.hasOwnProperty('price')) {
                obj['price'] = LinodeTypePrice.constructFromObject(data['price']);
            }
            if (data.hasOwnProperty('successor')) {
                obj['successor'] = ApiClient.convertToType(data['successor'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LinodeType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinodeType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `addons`
        if (data['addons']) { // data not null
          LinodeTypeAddons.validateJSON(data['addons']);
        }
        ...
        if (data['price']) { // data not null
          LinodeTypePrice.validateJSON(data['price']);
        }
        // ensure the json data is a string
        if (data['successor'] && !(typeof data['successor'] === 'string' || data['successor'] instanceof String)) {
            throw new Error("Expected the field `successor` to be a primitive type in the JSON string but got " + data['successor']);
        }
...
/**
 * @member {module:model/LinodeTypeAddons} addons
 */
LinodeType.prototype['addons'] = undefined;
 ...
 * @member {module:model/LinodeType.ClassEnum} class
 */
LinodeType.prototype['class'] = undefined;

/**
 * The Disk size, in MB, of the Linode Type. 
 * @member {Number} disk
 */
LinodeType.prototype['disk'] = undefined;

/**
 * The number of GPUs this Linode Type offers. 
 * @member {Number} gpus
 */
LinodeType.prototype['gpus'] = undefined;

/**
 * The ID representing the Linode Type.
 * @member {String} id
 */
LinodeType.prototype['id'] = undefined;

/**
 * The Linode Type's label is for display purposes only. 
 * @member {String} label
 */
LinodeType.prototype['label'] = undefined;

/**
 * Amount of RAM included in this Linode Type. 
 * @member {Number} memory
 */
LinodeType.prototype['memory'] = undefined;

/**
 * The Mbits outbound bandwidth allocation. 
 * @member {Number} network_out
 */
LinodeType.prototype['network_out'] = undefined;

/**
 * @member {module:model/LinodeTypePrice} price
 */
LinodeType.prototype['price'] = undefined;
 ...
 * @member {String} successor
 */
LinodeType.prototype['successor'] = undefined;

/**
 * The monthly outbound transfer amount, in MB. 
 * @member {Number} transfer
 */
LinodeType.prototype['transfer'] = undefined;

/**
 * The number of VCPU cores this Linode Type offers. 
 * @member {Number} vcpus
 */
LinodeType.prototype['vcpus'] = undefined;
