...
/**
 * The StatsDataAvailable model module.
 * @module model/StatsDataAvailable
 * @version 4.151.1
 */
class StatsDataAvailable {
    /**
     * Constructs a new <code>StatsDataAvailable</code>.
     * A collection of graph data returned for managed stats. 
     * @alias module:model/StatsDataAvailable
     */
    constructor() { 
        
        StatsDataAvailable.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatsDataAvailable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatsDataAvailable} obj Optional instance to populate.
     * @return {module:model/StatsDataAvailable} The populated <code>StatsDataAvailable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatsDataAvailable();

            if (data.hasOwnProperty('cpu')) {
                obj['cpu'] = ApiClient.convertToType(data['cpu'], [StatsData]);
            }
            if (data.hasOwnProperty('disk')) {
                obj['disk'] = ApiClient.convertToType(data['disk'], [StatsData]);
            }
            if (data.hasOwnProperty('net_in')) {
                obj['net_in'] = ApiClient.convertToType(data['net_in'], [StatsData]);
            }
            if (data.hasOwnProperty('net_out')) {
                obj['net_out'] = ApiClient.convertToType(data['net_out'], [StatsData]);
            }
            if (data.hasOwnProperty('swap')) {
                obj['swap'] = ApiClient.convertToType(data['swap'], [StatsData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatsDataAvailable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatsDataAvailable</code>.
     */
    static validateJSON(data) {
        ...
        if (data['net_in']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['net_in'])) {
                throw new Error("Expected the field `net_in` to be an array in the JSON data but got " + data['net_in']);
            }
            // validate the optional field `net_in` (array)
            for (const item of data['net_in']) {
                StatsData.validateJSON(item);
            };
        }
        if (data['net_out']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['net_out'])) {
                throw new Error("Expected the field `net_out` to be an array in the JSON data but got " + data['net_out']);
            }
            // validate the optional field `net_out` (array)
            for (const item of data['net_out']) {
                StatsData.validateJSON(item);
            };
        }
        if (data['swap']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['swap'])) {
                throw new Error("Expected the field `swap` to be an array in the JSON data but got " + data['swap']);
            }
            // validate the optional field `swap` (array)
            for (const item of data['swap']) {
                StatsData.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/StatsData>} cpu
 */
StatsDataAvailable.prototype['cpu'] = undefined;

/**
 * Disk usage stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} disk
 */
StatsDataAvailable.prototype['disk'] = undefined;

/**
 * Inbound network traffic stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} net_in
 */
StatsDataAvailable.prototype['net_in'] = undefined;

/**
 * Outbound network traffic stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} net_out
 */
StatsDataAvailable.prototype['net_out'] = undefined;

/**
 * Swap usage stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} swap
 */
StatsDataAvailable.prototype['swap'] = undefined;
...
export default StatsDataAvailable;
