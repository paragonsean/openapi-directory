...
import EntityTransferEntities from './EntityTransferEntities';

/**
 * The EntityTransfer model module.
 * @module model/EntityTransfer
 * @version 4.151.1
 */
class EntityTransfer {
    /**
     * Constructs a new <code>EntityTransfer</code>.
     * An object representing an Entity Transfer. 
     * @alias module:model/EntityTransfer
     */
    constructor() { 
        
        EntityTransfer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EntityTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntityTransfer} obj Optional instance to populate.
     * @return {module:model/EntityTransfer} The populated <code>EntityTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntityTransfer();

            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('entities')) {
                obj['entities'] = EntityTransferEntities.constructFromObject(data['entities']);
            }
            if (data.hasOwnProperty('expiry')) {
                obj['expiry'] = ApiClient.convertToType(data['expiry'], 'Date');
            }
            if (data.hasOwnProperty('is_sender')) {
                obj['is_sender'] = ApiClient.convertToType(data['is_sender'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EntityTransfer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityTransfer</code>.
     */
    static validateJSON(data) {
        // validate the optional field `entities`
        if (data['entities']) { // data not null
          EntityTransferEntities.validateJSON(data['entities']);
        }
 ...
 * @member {Date} created
 */
EntityTransfer.prototype['created'] = undefined;

/**
 * @member {module:model/EntityTransferEntities} entities
 */
EntityTransfer.prototype['entities'] = undefined;

/**
 * When this transfer expires. Transfers will automatically expire 24 hours after creation. 
 * @member {Date} expiry
 */
EntityTransfer.prototype['expiry'] = undefined;

/**
 * If the requesting account created this transfer. 
 * @member {Boolean} is_sender
 */
EntityTransfer.prototype['is_sender'] = undefined;
 ...
 * @member {module:model/EntityTransfer.StatusEnum} status
 */
EntityTransfer.prototype['status'] = undefined;

/**
 * The token used to identify and accept or cancel this transfer. 
 * @member {String} token
 */
EntityTransfer.prototype['token'] = undefined;

/**
 * When this transfer was last updated. 
 * @member {Date} updated
 */
EntityTransfer.prototype['updated'] = undefined;
