...
import CreateLKEClusterRequestControlPlane from './CreateLKEClusterRequestControlPlane';
import LKENodePoolRequestBody from './LKENodePoolRequestBody';

/**
 * The CreateLKEClusterRequest model module.
 * @module model/CreateLKEClusterRequest
 * @version 4.151.1
 */
class CreateLKEClusterRequest {
    /**
     * Constructs a new <code>CreateLKEClusterRequest</code>.
     * @alias module:model/CreateLKEClusterRequest
     * @param k8sVersion {String} The desired Kubernetes version for this Kubernetes cluster in the format of &lt;major&gt;.&lt;minor&gt;, and the latest supported patch version will be deployed. 
     * @param label {String} This Kubernetes cluster's unique label for display purposes only. Labels have the following constraints:    * UTF-8 characters will be returned by the API using escape     sequences of their Unicode code points. For example, the     Japanese character *か* is 3 bytes in UTF-8 (`0xE382AB`). Its     Unicode code point is 2 bytes (`0x30AB`). APIv4 supports this     character and the API will return it as the escape sequence     using six 1 byte characters which represent 2 bytes of Unicode     code point (`\"\\u30ab\"`).   * 4 byte UTF-8 characters are not supported.   * If the label is entirely composed of UTF-8 characters, the API     response will return the code points using up to 193 1 byte     characters. 
     * @param nodePools {Array.<module:model/LKENodePoolRequestBody>} 
     * @param region {String} This Kubernetes cluster's location.
     */
    constructor(k8sVersion, label, nodePools, region) { 
        
        CreateLKEClusterRequest.initialize(this, k8sVersion, label, nodePools, region);
    }
     ...
     */
    static initialize(obj, k8sVersion, label, nodePools, region) { 
        obj['k8s_version'] = k8sVersion;
        obj['label'] = label;
        obj['node_pools'] = nodePools;
        obj['region'] = region;
    }

    /**
     * Constructs a <code>CreateLKEClusterRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLKEClusterRequest} obj Optional instance to populate.
     * @return {module:model/CreateLKEClusterRequest} The populated <code>CreateLKEClusterRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLKEClusterRequest();

            if (data.hasOwnProperty('control_plane')) {
                obj['control_plane'] = CreateLKEClusterRequestControlPlane.constructFromObject(data['control_plane']);
            }
            ...
            if (data.hasOwnProperty('node_pools')) {
                obj['node_pools'] = ApiClient.convertToType(data['node_pools'], [LKENodePoolRequestBody]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLKEClusterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLKEClusterRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLKEClusterRequest.RequiredProperties) {
        ...
        if (data['control_plane']) { // data not null
          CreateLKEClusterRequestControlPlane.validateJSON(data['control_plane']);
        }
        ...
        if (data['node_pools']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['node_pools'])) {
                throw new Error("Expected the field `node_pools` to be an array in the JSON data but got " + data['node_pools']);
            }
            // validate the optional field `node_pools` (array)
            for (const item of data['node_pools']) {
                LKENodePoolRequestBody.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
CreateLKEClusterRequest.RequiredProperties = ["k8s_version", "label", "node_pools", "region"];

/**
 * @member {module:model/CreateLKEClusterRequestControlPlane} control_plane
 */
CreateLKEClusterRequest.prototype['control_plane'] = undefined;
 ...
 */
CreateLKEClusterRequest.prototype['k8s_version'] = undefined;

/**
 * This Kubernetes cluster's unique label for display purposes only. Labels have the following constraints:    * UTF-8 characters will be returned by the API using escape     sequences of their Unicode code points. For example, the     Japanese character *か* is 3 bytes in UTF-8 (`0xE382AB`). Its     Unicode code point is 2 bytes (`0x30AB`). APIv4 supports this     character and the API will return it as the escape sequence     using six 1 byte characters which represent 2 bytes of Unicode     code point (`\"\\u30ab\"`).   * 4 byte UTF-8 characters are not supported.   * If the label is entirely composed of UTF-8 characters, the API     response will return the code points using up to 193 1 byte     characters. 
 * @member {String} label
 */
CreateLKEClusterRequest.prototype['label'] = undefined;

/**
 * @member {Array.<module:model/LKENodePoolRequestBody>} node_pools
 */
CreateLKEClusterRequest.prototype['node_pools'] = undefined;

/**
 * This Kubernetes cluster's location.
 * @member {String} region
 */
CreateLKEClusterRequest.prototype['region'] = undefined;

/**
 * An array of tags applied to the Kubernetes cluster. Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
CreateLKEClusterRequest.prototype['tags'] = undefined;
...
export default CreateLKEClusterRequest;
