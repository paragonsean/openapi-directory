...
class DatabaseBackup {
    ...
    constructor() { 
        ...
        DatabaseBackup.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseBackup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseBackup</code>.
     */
 ...
 */
DatabaseBackup.prototype['created'] = undefined;

/**
 * The ID of the database backup object.
 * @member {Number} id
 */
DatabaseBackup.prototype['id'] = undefined;

/**
 * The database backup's label, for display purposes only.  Must include only ASCII letters or numbers. 
 * @member {String} label
 */
DatabaseBackup.prototype['label'] = undefined;

/**
 * The type of database backup, determined by how the backup was created.
 * @member {module:model/DatabaseBackup.TypeEnum} type
 */
DatabaseBackup.prototype['type'] = undefined;
