...
import CreateFirewallsRequestDevices from './CreateFirewallsRequestDevices';
import CreateFirewallsRequestRules from './CreateFirewallsRequestRules';
import Firewall from './Firewall';
import FirewallRules from './FirewallRules';

/**
 * The CreateFirewallsRequest model module.
 * @module model/CreateFirewallsRequest
 * @version 4.151.1
 */
class CreateFirewallsRequest {
    /**
     * Constructs a new <code>CreateFirewallsRequest</code>.
     * @alias module:model/CreateFirewallsRequest
     * @implements module:model/Firewall
     * @param label {String} The Firewall's label, for display purposes only.  Firewall labels have the following constraints:    * Must begin and end with an alphanumeric character.   * May only consist of alphanumeric characters, dashes (`-`), underscores (`_`) or periods (`.`).   * Cannot have two dashes (`--`), underscores (`__`) or periods (`..`) in a row.   * Must be between 3 and 32 characters.   * Must be unique. 
     * @param rules {module:model/FirewallRules} 
     */
    constructor(label, rules) { 
        Firewall.initialize(this);
        CreateFirewallsRequest.initialize(this, label, rules);
    }
     ...
     */
    static initialize(obj, label, rules) { 
        obj['rules'] = rules;
        obj['label'] = label;
    }

    /**
     * Constructs a <code>CreateFirewallsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallsRequest} obj Optional instance to populate.
     * @return {module:model/CreateFirewallsRequest} The populated <code>CreateFirewallsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallsRequest();
            Firewall.constructFromObject(data, obj);

            if (data.hasOwnProperty('devices')) {
                obj['devices'] = CreateFirewallsRequestDevices.constructFromObject(data['devices']);
            }
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = CreateFirewallsRequestRules.constructFromObject(data['rules']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallsRequest.RequiredProperties) {
        ...
        if (data['devices']) { // data not null
          CreateFirewallsRequestDevices.validateJSON(data['devices']);
        }
        // validate the optional field `rules`
        if (data['rules']) { // data not null
          CreateFirewallsRequestRules.validateJSON(data['rules']);
        }
...
CreateFirewallsRequest.RequiredProperties = ["rules", "label"];

/**
 * @member {module:model/CreateFirewallsRequestDevices} devices
 */
CreateFirewallsRequest.prototype['devices'] = undefined;

/**
 * @member {module:model/CreateFirewallsRequestRules} rules
 */
CreateFirewallsRequest.prototype['rules'] = undefined;

/**
 * When this Firewall was created. 
 * @member {Date} created
 */
CreateFirewallsRequest.prototype['created'] = undefined;

/**
 * The Firewall's unique ID. 
 * @member {Number} id
 */
CreateFirewallsRequest.prototype['id'] = undefined;

/**
 * The Firewall's label, for display purposes only.  Firewall labels have the following constraints:    * Must begin and end with an alphanumeric character.   * May only consist of alphanumeric characters, dashes (`-`), underscores (`_`) or periods (`.`).   * Cannot have two dashes (`--`), underscores (`__`) or periods (`..`) in a row.   * Must be between 3 and 32 characters.   * Must be unique. 
 * @member {String} label
 */
CreateFirewallsRequest.prototype['label'] = undefined;
 ...
 * @member {module:model/CreateFirewallsRequest.StatusEnum} status
 */
CreateFirewallsRequest.prototype['status'] = undefined;

/**
 * An array of tags applied to this object. Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
CreateFirewallsRequest.prototype['tags'] = undefined;

/**
 * When this Firewall was last updated. 
 * @member {Date} updated
 */
CreateFirewallsRequest.prototype['updated'] = undefined;
 ...
 * @member {String} label
 */
Firewall.prototype['label'] = undefined;
/**
 * @member {module:model/FirewallRules} rules
 */
Firewall.prototype['rules'] = undefined;
/**
 * The status of this Firewall.    * When a Firewall is first created its status is `enabled`.   * Use the [Update Firewall](/docs/api/networking/#firewall-update) endpoint to set a Firewall's status to `enabled` or `disabled`.   * Use the [Delete Firewall](/docs/api/networking/#firewall-delete) endpoint to delete a Firewall. 
 * @member {module:model/Firewall.StatusEnum} status
 */
Firewall.prototype['status'] = undefined;
/**
 * An array of tags applied to this object. Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
Firewall.prototype['tags'] = undefined;
/**
 * When this Firewall was last updated. 
 * @member {Date} updated
 */
Firewall.prototype['updated'] = undefined;
 ...
 * @readonly
 */
CreateFirewallsRequest['StatusEnum'] = {
...
export default CreateFirewallsRequest;
