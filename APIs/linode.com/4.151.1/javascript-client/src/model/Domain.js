...
class Domain {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('axfr_ips')) {
                obj['axfr_ips'] = ApiClient.convertToType(data['axfr_ips'], ['String']);
            }
            ...
            if (data.hasOwnProperty('expire_sec')) {
                obj['expire_sec'] = ApiClient.convertToType(data['expire_sec'], 'Number');
            }
            ...
            if (data.hasOwnProperty('master_ips')) {
                obj['master_ips'] = ApiClient.convertToType(data['master_ips'], ['String']);
            }
            if (data.hasOwnProperty('refresh_sec')) {
                obj['refresh_sec'] = ApiClient.convertToType(data['refresh_sec'], 'Number');
            }
            if (data.hasOwnProperty('retry_sec')) {
                obj['retry_sec'] = ApiClient.convertToType(data['retry_sec'], 'Number');
            }
            if (data.hasOwnProperty('soa_email')) {
                obj['soa_email'] = ApiClient.convertToType(data['soa_email'], 'String');
            }
            ...
            if (data.hasOwnProperty('ttl_sec')) {
                obj['ttl_sec'] = ApiClient.convertToType(data['ttl_sec'], 'Number');
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['axfr_ips'])) {
            throw new Error("Expected the field `axfr_ips` to be an array in the JSON data but got " + data['axfr_ips']);
        }
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['master_ips'])) {
            throw new Error("Expected the field `master_ips` to be an array in the JSON data but got " + data['master_ips']);
        }
        // ensure the json data is a string
        if (data['soa_email'] && !(typeof data['soa_email'] === 'string' || data['soa_email'] instanceof String)) {
            throw new Error("Expected the field `soa_email` to be a primitive type in the JSON string but got " + data['soa_email']);
        }
        // ensure the json data is a string
 ...
 */
Domain.prototype['axfr_ips'] = undefined;
 ...
 * @default 0
 */
Domain.prototype['expire_sec'] = 0;

/**
 * The group this Domain belongs to.  This is for display purposes only. 
 * @member {String} group
 */
Domain.prototype['group'] = undefined;
 ...
 */
Domain.prototype['master_ips'] = undefined;
 ...
 * @default 0
 */
Domain.prototype['refresh_sec'] = 0;
 ...
 * @default 'active'
 */
Domain.prototype['status'] = 'active';
