...
import GooglePayData from './GooglePayData';
...
class PaymentMethodData {
     ...
     * @param {(module:model/CreditCardData|module:model/GooglePayData|module:model/PayPalData)} instance The actual instance to initialize PaymentMethodData.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "CreditCardData") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                CreditCardData.validateJSON(instance); // throw an exception if no match
                // create CreditCardData from JS object
                this.actualInstance = CreditCardData.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into CreditCardData
            errorMessages.push("Failed to construct CreditCardData: " + err)
        }

        try {
            if (typeof instance === "GooglePayData") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                GooglePayData.validateJSON(instance); // throw an exception if no match
                // create GooglePayData from JS object
                this.actualInstance = GooglePayData.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into GooglePayData
            errorMessages.push("Failed to construct GooglePayData: " + err)
        }

        try {
            if (typeof instance === "PayPalData") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                PayPalData.validateJSON(instance); // throw an exception if no match
                // create PayPalData from JS object
                this.actualInstance = PayPalData.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into PayPalData
            errorMessages.push("Failed to construct PayPalData: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `PaymentMethodData` with oneOf schemas CreditCardData, GooglePayData, PayPalData. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `PaymentMethodData` with oneOf schemas CreditCardData, GooglePayData, PayPalData. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    static constructFromObject(data, obj) {
        return new PaymentMethodData(data);
    }

    /**
     * Gets the actual instance, which can be <code>CreditCardData</code>, <code>GooglePayData</code>, <code>PayPalData</code>.
     * @return {(module:model/CreditCardData|module:model/GooglePayData|module:model/PayPalData)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>CreditCardData</code>, <code>GooglePayData</code>, <code>PayPalData</code>.
     * @param {(module:model/CreditCardData|module:model/GooglePayData|module:model/PayPalData)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = PaymentMethodData.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/PaymentMethodData} An instance of PaymentMethodData.
     */
    static fromJSON = function(json_string){
        return PaymentMethodData.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
PaymentMethodData.prototype['expiry'] = undefined;

/**
 * The last four digits of the credit card number.
 * @member {String} last_four
 */
PaymentMethodData.prototype['last_four'] = undefined;
 ...
 */
PaymentMethodData.prototype['paypal_id'] = undefined;


PaymentMethodData.OneOf = ["CreditCardData", "GooglePayData", "PayPalData"];
