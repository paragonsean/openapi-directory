...
/**
 * The UpdateObjectStorageBucketACLRequest model module.
 * @module model/UpdateObjectStorageBucketACLRequest
 * @version 4.151.1
 */
class UpdateObjectStorageBucketACLRequest {
    /**
     * Constructs a new <code>UpdateObjectStorageBucketACLRequest</code>.
     * @alias module:model/UpdateObjectStorageBucketACLRequest
     * @param acl {module:model/UpdateObjectStorageBucketACLRequest.AclEnum} The Access Control Level of the bucket, as a canned ACL string. For more fine-grained control of ACLs, use the S3 API directly. 
     * @param name {String} The `name` of the object for which to update its Access Control List (ACL). Use the [Object Storage Bucket Contents List](/docs/api/object-storage/#object-storage-bucket-contents-list) endpoint to access all object names in a bucket. 
     */
    constructor(acl, name) { 
        
        UpdateObjectStorageBucketACLRequest.initialize(this, acl, name);
    }
     ...
     */
    static initialize(obj, acl, name) { 
        obj['acl'] = acl;
        obj['name'] = name;
    }

    /**
     * Constructs a <code>UpdateObjectStorageBucketACLRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateObjectStorageBucketACLRequest} obj Optional instance to populate.
     * @return {module:model/UpdateObjectStorageBucketACLRequest} The populated <code>UpdateObjectStorageBucketACLRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateObjectStorageBucketACLRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateObjectStorageBucketACLRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateObjectStorageBucketACLRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateObjectStorageBucketACLRequest.RequiredProperties) {
...
UpdateObjectStorageBucketACLRequest.RequiredProperties = ["acl", "name"];
 ...
 * @member {module:model/UpdateObjectStorageBucketACLRequest.AclEnum} acl
 */
UpdateObjectStorageBucketACLRequest.prototype['acl'] = undefined;
 ...
 * @member {String} name
 */
UpdateObjectStorageBucketACLRequest.prototype['name'] = undefined;
 ...
 * @readonly
 */
UpdateObjectStorageBucketACLRequest['AclEnum'] = {
...
export default UpdateObjectStorageBucketACLRequest;
