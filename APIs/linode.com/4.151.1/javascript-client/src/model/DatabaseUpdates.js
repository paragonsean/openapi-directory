...
/**
 * The DatabaseUpdates model module.
 * @module model/DatabaseUpdates
 * @version 4.151.1
 */
class DatabaseUpdates {
    /**
     * Constructs a new <code>DatabaseUpdates</code>.
     * Configuration settings for automated patch update maintenance for the Managed Database.
     * @alias module:model/DatabaseUpdates
     */
    constructor() { 
        
        DatabaseUpdates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatabaseUpdates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseUpdates} obj Optional instance to populate.
     * @return {module:model/DatabaseUpdates} The populated <code>DatabaseUpdates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseUpdates();
            ...
            if (data.hasOwnProperty('hour_of_day')) {
                obj['hour_of_day'] = ApiClient.convertToType(data['hour_of_day'], 'Number');
            }
            if (data.hasOwnProperty('week_of_month')) {
                obj['week_of_month'] = ApiClient.convertToType(data['week_of_month'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseUpdates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseUpdates</code>.
     */
 ...
 */
DatabaseUpdates.prototype['day_of_week'] = undefined;

/**
 * The maximum maintenance window time in hours.
 * @member {Number} duration
 */
DatabaseUpdates.prototype['duration'] = undefined;

/**
 * Whether maintenance occurs on a weekly or monthly basis.
 * @member {module:model/DatabaseUpdates.FrequencyEnum} frequency
 * @default 'weekly'
 */
DatabaseUpdates.prototype['frequency'] = 'weekly';

/**
 * The hour to begin maintenance based in UTC time.
 * @member {Number} hour_of_day
 */
DatabaseUpdates.prototype['hour_of_day'] = undefined;
 ...
 * @member {Number} week_of_month
 */
DatabaseUpdates.prototype['week_of_month'] = undefined;
