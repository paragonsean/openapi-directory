...
class Database {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('instance_uri')) {
                obj['instance_uri'] = ApiClient.convertToType(data['instance_uri'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['instance_uri'] && !(typeof data['instance_uri'] === 'string' || data['instance_uri'] instanceof String)) {
            throw new Error("Expected the field `instance_uri` to be a primitive type in the JSON string but got " + data['instance_uri']);
        }
        // ensure the json data is a string
 ...
 */
Database.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/Database.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
Database.prototype['cluster_size'] = ClusterSizeEnum.1;
 ...
 * @default false
 */
Database.prototype['encrypted'] = false;

/**
 * The Managed Database engine type.
 * @member {module:model/Database.EngineEnum} engine
 */
Database.prototype['engine'] = undefined;

/**
 * @member {module:model/DatabaseHosts} hosts
 */
Database.prototype['hosts'] = undefined;
 ...
 * @member {String} instance_uri
 */
Database.prototype['instance_uri'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
Database.prototype['label'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
Database.prototype['region'] = undefined;

/**
 * The operating status of the Managed Database.
 * @member {module:model/Database.StatusEnum} status
 */
 ...
 * @member {Date} updated
 */
Database.prototype['updated'] = undefined;

/**
 * @member {module:model/DatabaseUpdates} updates
 */
Database.prototype['updates'] = undefined;
