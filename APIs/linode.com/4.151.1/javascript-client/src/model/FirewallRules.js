...
class FirewallRules {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallRules();

            if (data.hasOwnProperty('inbound')) {
                obj['inbound'] = ApiClient.convertToType(data['inbound'], [FirewallRuleConfig]);
            }
            if (data.hasOwnProperty('inbound_policy')) {
                obj['inbound_policy'] = ApiClient.convertToType(data['inbound_policy'], 'String');
            }
            if (data.hasOwnProperty('outbound')) {
                obj['outbound'] = ApiClient.convertToType(data['outbound'], [FirewallRuleConfig]);
            }
            if (data.hasOwnProperty('outbound_policy')) {
                obj['outbound_policy'] = ApiClient.convertToType(data['outbound_policy'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallRules</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallRules</code>.
     */
    static validateJSON(data) {
        if (data['inbound']) { // data not null
            ...
            // validate the optional field `inbound` (array)
            for (const item of data['inbound']) {
                FirewallRuleConfig.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['inbound_policy'] && !(typeof data['inbound_policy'] === 'string' || data['inbound_policy'] instanceof String)) {
            throw new Error("Expected the field `inbound_policy` to be a primitive type in the JSON string but got " + data['inbound_policy']);
        }
        if (data['outbound']) { // data not null
            ...
            // validate the optional field `outbound` (array)
            for (const item of data['outbound']) {
                FirewallRuleConfig.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['outbound_policy'] && !(typeof data['outbound_policy'] === 'string' || data['outbound_policy'] instanceof String)) {
            throw new Error("Expected the field `outbound_policy` to be a primitive type in the JSON string but got " + data['outbound_policy']);
        }
 ...
 * @member {Array.<module:model/FirewallRuleConfig>} inbound
 */
FirewallRules.prototype['inbound'] = undefined;
 ...
 * @member {module:model/FirewallRules.InboundPolicyEnum} inbound_policy
 */
FirewallRules.prototype['inbound_policy'] = undefined;

/**
 * The outbound rules for the firewall, as a JSON array. 
 * @member {Array.<module:model/FirewallRuleConfig>} outbound
 */
FirewallRules.prototype['outbound'] = undefined;
 ...
 * @member {module:model/FirewallRules.OutboundPolicyEnum} outbound_policy
 */
FirewallRules.prototype['outbound_policy'] = undefined;
...
/**
 * Allowed values for the <code>inbound_policy</code> property.
 * @enum {String}
 * @readonly
 */
FirewallRules['InboundPolicyEnum'] = {
...
/**
 * Allowed values for the <code>outbound_policy</code> property.
 * @enum {String}
 * @readonly
 */
FirewallRules['OutboundPolicyEnum'] = {
