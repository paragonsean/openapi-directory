...
/**
 * The AuthorizedApp model module.
 * @module model/AuthorizedApp
 * @version 4.151.1
 */
class AuthorizedApp {
    /**
     * Constructs a new <code>AuthorizedApp</code>.
     * An application you have authorized access to your Account through OAuth. 
     * @alias module:model/AuthorizedApp
     */
    constructor() { 
        
        AuthorizedApp.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthorizedApp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthorizedApp} obj Optional instance to populate.
     * @return {module:model/AuthorizedApp} The populated <code>AuthorizedApp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorizedApp();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthorizedApp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthorizedApp</code>.
     */
