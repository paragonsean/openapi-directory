...
/**
 * The NodeBalancer model module.
 * @module model/NodeBalancer
 * @version 4.151.1
 */
class NodeBalancer {
    /**
     * Constructs a new <code>NodeBalancer</code>.
     ...
     * @alias module:model/NodeBalancer
     */
    constructor() { 
        
        NodeBalancer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NodeBalancer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeBalancer} obj Optional instance to populate.
     * @return {module:model/NodeBalancer} The populated <code>NodeBalancer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeBalancer();

            if (data.hasOwnProperty('client_conn_throttle')) {
                obj['client_conn_throttle'] = ApiClient.convertToType(data['client_conn_throttle'], 'Number');
            }
            ...
            if (data.hasOwnProperty('transfer')) {
                obj['transfer'] = NodeBalancerTransfer.constructFromObject(data['transfer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NodeBalancer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeBalancer</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ipv4'] && !(typeof data['ipv4'] === 'string' || data['ipv4'] instanceof String)) {
            throw new Error("Expected the field `ipv4` to be a primitive type in the JSON string but got " + data['ipv4']);
        }
        // ensure the json data is a string
        ...
        if (data['transfer']) { // data not null
          NodeBalancerTransfer.validateJSON(data['transfer']);
        }
 ...
 */
NodeBalancer.prototype['client_conn_throttle'] = undefined;

/**
 * When this NodeBalancer was created. 
 * @member {Date} created
 */
NodeBalancer.prototype['created'] = undefined;

/**
 * This NodeBalancer's hostname, beginning with its IP address and ending with _.ip.linodeusercontent.com_. 
 * @member {String} hostname
 */
NodeBalancer.prototype['hostname'] = undefined;

/**
 * This NodeBalancer's unique ID. 
 * @member {Number} id
 */
NodeBalancer.prototype['id'] = undefined;

/**
 * This NodeBalancer's public IPv4 address. 
 * @member {String} ipv4
 */
NodeBalancer.prototype['ipv4'] = undefined;

/**
 * This NodeBalancer's public IPv6 address. 
 * @member {String} ipv6
 */
NodeBalancer.prototype['ipv6'] = undefined;

/**
 * This NodeBalancer's label. These must be unique on your Account. 
 * @member {String} label
 */
NodeBalancer.prototype['label'] = undefined;

/**
 * The Region where this NodeBalancer is located. NodeBalancers only support backends in the same Region. 
 * @member {String} region
 */
NodeBalancer.prototype['region'] = undefined;

/**
 * An array of Tags applied to this object.  Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
NodeBalancer.prototype['tags'] = undefined;

/**
 * @member {module:model/NodeBalancerTransfer} transfer
 */
NodeBalancer.prototype['transfer'] = undefined;

/**
 * When this NodeBalancer was last updated. 
 * @member {Date} updated
 */
NodeBalancer.prototype['updated'] = undefined;
