...
/**
 * The CreateObjectStorageBucketRequest model module.
 * @module model/CreateObjectStorageBucketRequest
 * @version 4.151.1
 */
class CreateObjectStorageBucketRequest {
    /**
     * Constructs a new <code>CreateObjectStorageBucketRequest</code>.
     * @alias module:model/CreateObjectStorageBucketRequest
     * @param cluster {String} The ID of the Object Storage Cluster where this bucket should be created. 
     * @param label {String} The name for this bucket. Must be unique in the cluster you are creating the bucket in, or an error will be returned. Labels will be reserved only for the cluster that active buckets are created and stored in. If you want to reserve this bucket's label in another cluster, you must create a new bucket with the same label in the new cluster. 
     */
    constructor(cluster, label) { 
        
        CreateObjectStorageBucketRequest.initialize(this, cluster, label);
    }
     ...
     */
    static initialize(obj, cluster, label) { 
        obj['acl'] = 'private';
        obj['cluster'] = cluster;
        obj['cors_enabled'] = false;
        obj['label'] = label;
    }

    /**
     * Constructs a <code>CreateObjectStorageBucketRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateObjectStorageBucketRequest} obj Optional instance to populate.
     * @return {module:model/CreateObjectStorageBucketRequest} The populated <code>CreateObjectStorageBucketRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateObjectStorageBucketRequest();
            ...
            if (data.hasOwnProperty('cors_enabled')) {
                obj['cors_enabled'] = ApiClient.convertToType(data['cors_enabled'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateObjectStorageBucketRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateObjectStorageBucketRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateObjectStorageBucketRequest.RequiredProperties) {
...
CreateObjectStorageBucketRequest.RequiredProperties = ["cluster", "label"];
 ...
 * @member {module:model/CreateObjectStorageBucketRequest.AclEnum} acl
 * @default 'private'
 */
CreateObjectStorageBucketRequest.prototype['acl'] = 'private';

/**
 * The ID of the Object Storage Cluster where this bucket should be created. 
 * @member {String} cluster
 */
CreateObjectStorageBucketRequest.prototype['cluster'] = undefined;
 ...
 * @member {Boolean} cors_enabled
 * @default false
 */
CreateObjectStorageBucketRequest.prototype['cors_enabled'] = false;

/**
 * The name for this bucket. Must be unique in the cluster you are creating the bucket in, or an error will be returned. Labels will be reserved only for the cluster that active buckets are created and stored in. If you want to reserve this bucket's label in another cluster, you must create a new bucket with the same label in the new cluster. 
 * @member {String} label
 */
CreateObjectStorageBucketRequest.prototype['label'] = undefined;
 ...
 * @readonly
 */
CreateObjectStorageBucketRequest['AclEnum'] = {
...
export default CreateObjectStorageBucketRequest;
