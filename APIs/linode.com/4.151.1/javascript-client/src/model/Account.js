...
class Account {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('active_promotions')) {
                obj['active_promotions'] = ApiClient.convertToType(data['active_promotions'], [Promotion]);
            }
            if (data.hasOwnProperty('active_since')) {
                obj['active_since'] = ApiClient.convertToType(data['active_since'], 'Date');
            }
            ...
            if (data.hasOwnProperty('balance_uninvoiced')) {
                obj['balance_uninvoiced'] = ApiClient.convertToType(data['balance_uninvoiced'], 'Number');
            }
            if (data.hasOwnProperty('billing_source')) {
                obj['billing_source'] = ApiClient.convertToType(data['billing_source'], 'String');
            }
            ...
            if (data.hasOwnProperty('credit_card')) {
                obj['credit_card'] = AccountCreditCard.constructFromObject(data['credit_card']);
            }
            if (data.hasOwnProperty('email')) {
                obj['email'] = ApiClient.convertToType(data['email'], 'String');
            }
            if (data.hasOwnProperty('euuid')) {
                obj['euuid'] = ApiClient.convertToType(data['euuid'], 'String');
            }
    ...
    static validateJSON(data) {
        if (data['active_promotions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['active_promotions'])) {
                throw new Error("Expected the field `active_promotions` to be an array in the JSON data but got " + data['active_promotions']);
            }
            // validate the optional field `active_promotions` (array)
            for (const item of data['active_promotions']) {
        ...
        // ensure the json data is a string
        if (data['billing_source'] && !(typeof data['billing_source'] === 'string' || data['billing_source'] instanceof String)) {
            throw new Error("Expected the field `billing_source` to be a primitive type in the JSON string but got " + data['billing_source']);
        }
        // ensure the json data is an array
        ...
        if (data['credit_card']) { // data not null
          AccountCreditCard.validateJSON(data['credit_card']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['euuid'] && !(typeof data['euuid'] === 'string' || data['euuid'] instanceof String)) {
            throw new Error("Expected the field `euuid` to be a primitive type in the JSON string but got " + data['euuid']);
        }
        // ensure the json data is a string
...
/**
 * @member {Array.<module:model/Promotion>} active_promotions
 */
Account.prototype['active_promotions'] = undefined;

/**
 * The datetime of when the account was activated.
 * @member {Date} active_since
 */
Account.prototype['active_since'] = undefined;

/**
 * First line of this Account's billing address.
 * @member {String} address_1
 */
Account.prototype['address_1'] = undefined;

/**
 * Second line of this Account's billing address.
 * @member {String} address_2
 */
Account.prototype['address_2'] = undefined;
 ...
 * @member {Number} balance_uninvoiced
 */
Account.prototype['balance_uninvoiced'] = undefined;
 ...
 * @member {module:model/Account.BillingSourceEnum} billing_source
 */
Account.prototype['billing_source'] = undefined;

/**
 * A list of capabilities your account supports. 
 * @member {Array.<String>} capabilities
 */
Account.prototype['capabilities'] = undefined;
 ...
 */
Account.prototype['company'] = undefined;
...
/**
 * @member {module:model/AccountCreditCard} credit_card
 */
Account.prototype['credit_card'] = undefined;
 ...
 * @member {String} euuid
 */
Account.prototype['euuid'] = undefined;
 ...
 */
Account.prototype['tax_id'] = undefined;
 ...
 * @member {String} zip
 */
Account.prototype['zip'] = undefined;
...
/**
 * Allowed values for the <code>billing_source</code> property.
 * @enum {String}
 * @readonly
 */
Account['BillingSourceEnum'] = {
