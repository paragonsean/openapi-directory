...
/**
 * The StackScript model module.
 * @module model/StackScript
 * @version 4.151.1
 */
class StackScript {
    /**
     * Constructs a new <code>StackScript</code>.
     * A StackScript enables you to quickly deploy a fully-configured application in an automated manner. 
     * @alias module:model/StackScript
     */
    constructor() { 
        
        StackScript.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StackScript</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StackScript} obj Optional instance to populate.
     * @return {module:model/StackScript} The populated <code>StackScript</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StackScript();

            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('deployments_active')) {
                obj['deployments_active'] = ApiClient.convertToType(data['deployments_active'], 'Number');
            }
            if (data.hasOwnProperty('deployments_total')) {
                obj['deployments_total'] = ApiClient.convertToType(data['deployments_total'], 'Number');
            }
            ...
            if (data.hasOwnProperty('rev_note')) {
                obj['rev_note'] = ApiClient.convertToType(data['rev_note'], 'String');
            }
            ...
            if (data.hasOwnProperty('user_defined_fields')) {
                obj['user_defined_fields'] = ApiClient.convertToType(data['user_defined_fields'], [UserDefinedField]);
            }
            if (data.hasOwnProperty('user_gravatar_id')) {
                obj['user_gravatar_id'] = ApiClient.convertToType(data['user_gravatar_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StackScript</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StackScript</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['rev_note'] && !(typeof data['rev_note'] === 'string' || data['rev_note'] instanceof String)) {
            throw new Error("Expected the field `rev_note` to be a primitive type in the JSON string but got " + data['rev_note']);
        }
        // ensure the json data is a string
        ...
        if (data['user_defined_fields']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['user_defined_fields'])) {
                throw new Error("Expected the field `user_defined_fields` to be an array in the JSON data but got " + data['user_defined_fields']);
            }
            // validate the optional field `user_defined_fields` (array)
            for (const item of data['user_defined_fields']) {
                UserDefinedField.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['user_gravatar_id'] && !(typeof data['user_gravatar_id'] === 'string' || data['user_gravatar_id'] instanceof String)) {
            throw new Error("Expected the field `user_gravatar_id` to be a primitive type in the JSON string but got " + data['user_gravatar_id']);
        }
        // ensure the json data is a string
 ...
 * @member {Date} created
 */
StackScript.prototype['created'] = undefined;

/**
 * Count of currently active, deployed Linodes created from this StackScript. 
 * @member {Number} deployments_active
 */
StackScript.prototype['deployments_active'] = undefined;

/**
 * The total number of times this StackScript has been deployed. 
 * @member {Number} deployments_total
 */
StackScript.prototype['deployments_total'] = undefined;

/**
 * A description for the StackScript. 
 * @member {String} description
 */
StackScript.prototype['description'] = undefined;

/**
 * The unique ID of this StackScript.
 * @member {Number} id
 */
StackScript.prototype['id'] = undefined;
 ...
 */
StackScript.prototype['images'] = undefined;

/**
 * This determines whether other users can use your StackScript. **Once a StackScript is made public, it cannot be made private.** 
 * @member {Boolean} is_public
 */
StackScript.prototype['is_public'] = undefined;

/**
 * The StackScript's label is for display purposes only. 
 * @member {String} label
 */
StackScript.prototype['label'] = undefined;
 ...
 * @member {Boolean} mine
 */
StackScript.prototype['mine'] = undefined;

/**
 * This field allows you to add notes for the set of revisions made to this StackScript. 
 * @member {String} rev_note
 */
StackScript.prototype['rev_note'] = undefined;

/**
 * The script to execute when provisioning a new Linode with this StackScript. 
 * @member {String} script
 */
StackScript.prototype['script'] = undefined;

/**
 * The date this StackScript was last updated. 
 * @member {Date} updated
 */
StackScript.prototype['updated'] = undefined;
 ...
 * @member {Array.<module:model/UserDefinedField>} user_defined_fields
 */
StackScript.prototype['user_defined_fields'] = undefined;

/**
 * The Gravatar ID for the User who created the StackScript. 
 * @member {String} user_gravatar_id
 */
StackScript.prototype['user_gravatar_id'] = undefined;

/**
 * The User who created the StackScript. 
 * @member {String} username
 */
StackScript.prototype['username'] = undefined;
