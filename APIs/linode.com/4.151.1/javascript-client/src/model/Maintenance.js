...
class Maintenance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('entity')) {
                obj['entity'] = MaintenanceEntity.constructFromObject(data['entity']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['entity']) { // data not null
          MaintenanceEntity.validateJSON(data['entity']);
        }
...
/**
 * @member {module:model/MaintenanceEntity} entity
 */
Maintenance.prototype['entity'] = undefined;
 ...
 * @member {module:model/Maintenance.StatusEnum} status
 */
Maintenance.prototype['status'] = undefined;

/**
 * The type of maintenance. 
 * @member {module:model/Maintenance.TypeEnum} type
 */
 ...
 * @member {Date} when
 */
Maintenance.prototype['when'] = undefined;
...
Maintenance['TypeEnum'] = {
    ...
    /**
     * value: "cold_migration"
     * @const
     */
    "cold_migration": "cold_migration",

    /**
     * value: "live_migration"
     * @const
     */
