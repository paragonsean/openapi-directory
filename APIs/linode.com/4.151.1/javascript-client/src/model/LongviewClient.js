...
import LongviewClientApps from './LongviewClientApps';

/**
 * The LongviewClient model module.
 * @module model/LongviewClient
 * @version 4.151.1
 */
class LongviewClient {
    /**
     * Constructs a new <code>LongviewClient</code>.
     * A LongviewClient is a single monitor set up to track statistics about one of your servers. 
     * @alias module:model/LongviewClient
     */
    constructor() { 
        
        LongviewClient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LongviewClient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LongviewClient} obj Optional instance to populate.
     * @return {module:model/LongviewClient} The populated <code>LongviewClient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LongviewClient();

            if (data.hasOwnProperty('api_key')) {
                obj['api_key'] = ApiClient.convertToType(data['api_key'], 'String');
            }
            if (data.hasOwnProperty('apps')) {
                obj['apps'] = LongviewClientApps.constructFromObject(data['apps']);
            }
            ...
            if (data.hasOwnProperty('install_code')) {
                obj['install_code'] = ApiClient.convertToType(data['install_code'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LongviewClient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LongviewClient</code>.
     */
    static validateJSON(data) {
        ...
        if (data['apps']) { // data not null
          LongviewClientApps.validateJSON(data['apps']);
        }
        // ensure the json data is a string
        if (data['install_code'] && !(typeof data['install_code'] === 'string' || data['install_code'] instanceof String)) {
            throw new Error("Expected the field `install_code` to be a primitive type in the JSON string but got " + data['install_code']);
        }
        // ensure the json data is a string
 ...
 */
LongviewClient.prototype['api_key'] = undefined;

/**
 * @member {module:model/LongviewClientApps} apps
 */
LongviewClient.prototype['apps'] = undefined;

/**
 * When this Longview Client was created. 
 * @member {Date} created
 */
LongviewClient.prototype['created'] = undefined;

/**
 * This Client's unique ID. 
 * @member {Number} id
 */
LongviewClient.prototype['id'] = undefined;
 ...
 * @member {String} install_code
 */
LongviewClient.prototype['install_code'] = undefined;

/**
 * This Client's unique label. This is for display purposes only. 
 * @member {String} label
 */
LongviewClient.prototype['label'] = undefined;

/**
 * When this Longview Client was last updated. 
 * @member {Date} updated
 */
LongviewClient.prototype['updated'] = undefined;
