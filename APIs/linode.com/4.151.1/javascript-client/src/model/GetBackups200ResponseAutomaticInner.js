...
import BackupDisksInner from './BackupDisksInner';

/**
 * The GetBackups200ResponseAutomaticInner model module.
 * @module model/GetBackups200ResponseAutomaticInner
 * @version 4.151.1
 */
class GetBackups200ResponseAutomaticInner {
    /**
     * Constructs a new <code>GetBackups200ResponseAutomaticInner</code>.
     * @alias module:model/GetBackups200ResponseAutomaticInner
     * @implements module:model/Backup
     */
    constructor() { 
        Backup.initialize(this);
        GetBackups200ResponseAutomaticInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBackups200ResponseAutomaticInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBackups200ResponseAutomaticInner} obj Optional instance to populate.
     * @return {module:model/GetBackups200ResponseAutomaticInner} The populated <code>GetBackups200ResponseAutomaticInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBackups200ResponseAutomaticInner();
            ...
            if (data.hasOwnProperty('disks')) {
                obj['disks'] = ApiClient.convertToType(data['disks'], [BackupDisksInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBackups200ResponseAutomaticInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBackups200ResponseAutomaticInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['disks']) { // data not null
            ...
            for (const item of data['disks']) {
                BackupDisksInner.validateJSON(item);
            };
        }
 ...
 */
GetBackups200ResponseAutomaticInner.prototype['available'] = undefined;

/**
 * A list of the labels of the Configuration profiles that are part of the Backup. 
 * @member {Array.<String>} configs
 */
GetBackups200ResponseAutomaticInner.prototype['configs'] = undefined;

/**
 * The date the Backup was taken.
 * @member {Date} created
 */
GetBackups200ResponseAutomaticInner.prototype['created'] = undefined;

/**
 * A list of the disks that are part of the Backup. 
 * @member {Array.<module:model/BackupDisksInner>} disks
 */
GetBackups200ResponseAutomaticInner.prototype['disks'] = undefined;

/**
 * The date the Backup completed.
 * @member {Date} finished
 */
GetBackups200ResponseAutomaticInner.prototype['finished'] = undefined;

/**
 * The unique ID of this Backup.
 * @member {Number} id
 */
GetBackups200ResponseAutomaticInner.prototype['id'] = undefined;

/**
 * A label for Backups that are of type `snapshot`.
 * @member {String} label
 */
GetBackups200ResponseAutomaticInner.prototype['label'] = undefined;

/**
 * The current state of a specific Backup.
 * @member {module:model/GetBackups200ResponseAutomaticInner.StatusEnum} status
 */
GetBackups200ResponseAutomaticInner.prototype['status'] = undefined;

/**
 * @member {String} type
 */
GetBackups200ResponseAutomaticInner.prototype['type'] = undefined;

/**
 * The date the Backup was most recently updated.
 * @member {Date} updated
 */
GetBackups200ResponseAutomaticInner.prototype['updated'] = undefined;
 ...
 * @member {Boolean} available
 */
Backup.prototype['available'] = undefined;
/**
 * A list of the labels of the Configuration profiles that are part of the Backup. 
 * @member {Array.<String>} configs
 */
Backup.prototype['configs'] = undefined;
/**
 * The date the Backup was taken.
 * @member {Date} created
 */
 ...
 * @member {Array.<module:model/BackupDisksInner>} disks
 */
Backup.prototype['disks'] = undefined;
/**
 * The date the Backup completed.
 * @member {Date} finished
 */
Backup.prototype['finished'] = undefined;
/**
 * The unique ID of this Backup.
 * @member {Number} id
 */
 ...
 * @member {String} label
 */
Backup.prototype['label'] = undefined;
/**
 * The current state of a specific Backup.
 * @member {module:model/Backup.StatusEnum} status
 */
 ...
 * @member {Date} updated
 */
Backup.prototype['updated'] = undefined;
 ...
 * @readonly
 */
GetBackups200ResponseAutomaticInner['StatusEnum'] = {
...
export default GetBackups200ResponseAutomaticInner;
