...
class Profile {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ip_whitelist_enabled')) {
                obj['ip_whitelist_enabled'] = ApiClient.convertToType(data['ip_whitelist_enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('lish_auth_method')) {
                obj['lish_auth_method'] = ApiClient.convertToType(data['lish_auth_method'], 'String');
            }
            if (data.hasOwnProperty('referrals')) {
                obj['referrals'] = ProfileReferrals.constructFromObject(data['referrals']);
            }
            ...
            if (data.hasOwnProperty('two_factor_auth')) {
                obj['two_factor_auth'] = ApiClient.convertToType(data['two_factor_auth'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('verified_phone_number')) {
                obj['verified_phone_number'] = ApiClient.convertToType(data['verified_phone_number'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['lish_auth_method'] && !(typeof data['lish_auth_method'] === 'string' || data['lish_auth_method'] instanceof String)) {
            throw new Error("Expected the field `lish_auth_method` to be a primitive type in the JSON string but got " + data['lish_auth_method']);
        }
        // validate the optional field `referrals`
        if (data['referrals']) { // data not null
          ProfileReferrals.validateJSON(data['referrals']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['verified_phone_number'] && !(typeof data['verified_phone_number'] === 'string' || data['verified_phone_number'] instanceof String)) {
            throw new Error("Expected the field `verified_phone_number` to be a primitive type in the JSON string but got " + data['verified_phone_number']);
        }
 ...
 * @member {module:model/Profile.AuthenticationTypeEnum} authentication_type
 */
Profile.prototype['authentication_type'] = undefined;
 ...
 */
Profile.prototype['authorized_keys'] = undefined;
 ...
 */
Profile.prototype['email_notifications'] = undefined;
 ...
 * @member {Boolean} ip_whitelist_enabled
 */
Profile.prototype['ip_whitelist_enabled'] = undefined;
 ...
 * @member {module:model/Profile.LishAuthMethodEnum} lish_auth_method
 */
Profile.prototype['lish_auth_method'] = undefined;

/**
 * @member {module:model/ProfileReferrals} referrals
 */
Profile.prototype['referrals'] = undefined;
 ...
 */
Profile.prototype['restricted'] = undefined;
 ...
 * @member {Boolean} two_factor_auth
 */
Profile.prototype['two_factor_auth'] = undefined;

/**
 * Your unique ID in our system. This value will never change, and can safely be used to identify your User. 
 * @member {Number} uid
 */
Profile.prototype['uid'] = undefined;
 ...
 * @member {String} verified_phone_number
 */
Profile.prototype['verified_phone_number'] = undefined;
 ...
 * @readonly
 */
Profile['AuthenticationTypeEnum'] = {
...
/**
 * Allowed values for the <code>lish_auth_method</code> property.
 * @enum {String}
 * @readonly
 */
Profile['LishAuthMethodEnum'] = {
