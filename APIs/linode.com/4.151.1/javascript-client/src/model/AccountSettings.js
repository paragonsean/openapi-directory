...
class AccountSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('longview_subscription')) {
                obj['longview_subscription'] = ApiClient.convertToType(data['longview_subscription'], 'String');
            }
            if (data.hasOwnProperty('managed')) {
                obj['managed'] = ApiClient.convertToType(data['managed'], 'Boolean');
            }
            if (data.hasOwnProperty('network_helper')) {
                obj['network_helper'] = ApiClient.convertToType(data['network_helper'], 'Boolean');
            }
            if (data.hasOwnProperty('object_storage')) {
                obj['object_storage'] = ApiClient.convertToType(data['object_storage'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['longview_subscription'] && !(typeof data['longview_subscription'] === 'string' || data['longview_subscription'] instanceof String)) {
            throw new Error("Expected the field `longview_subscription` to be a primitive type in the JSON string but got " + data['longview_subscription']);
        }
        // ensure the json data is a string
        if (data['object_storage'] && !(typeof data['object_storage'] === 'string' || data['object_storage'] instanceof String)) {
            throw new Error("Expected the field `object_storage` to be a primitive type in the JSON string but got " + data['object_storage']);
        }
 ...
 */
AccountSettings.prototype['backups_enabled'] = undefined;
 ...
 * @member {String} longview_subscription
 */
AccountSettings.prototype['longview_subscription'] = undefined;
 ...
 */
AccountSettings.prototype['managed'] = undefined;

/**
 * Enables network helper across all users by default for new Linodes and Linode Configs. 
 * @member {Boolean} network_helper
 */
AccountSettings.prototype['network_helper'] = undefined;

/**
 * A string describing the status of this account's Object Storage service enrollment. 
 * @member {module:model/AccountSettings.ObjectStorageEnum} object_storage
 * @default 'disabled'
 */
AccountSettings.prototype['object_storage'] = 'disabled';
...
/**
 * Allowed values for the <code>object_storage</code> property.
 * @enum {String}
 * @readonly
 */
AccountSettings['ObjectStorageEnum'] = {
