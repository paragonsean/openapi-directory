...
/**
 * The BackupDisksInner model module.
 * @module model/BackupDisksInner
 * @version 4.151.1
 */
class BackupDisksInner {
    /**
     * Constructs a new <code>BackupDisksInner</code>.
     * @alias module:model/BackupDisksInner
     */
    constructor() { 
        
        BackupDisksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BackupDisksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BackupDisksInner} obj Optional instance to populate.
     * @return {module:model/BackupDisksInner} The populated <code>BackupDisksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BackupDisksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>BackupDisksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BackupDisksInner</code>.
     */
 ...
 * @member {module:model/BackupDisksInner.FilesystemEnum} filesystem
 */
BackupDisksInner.prototype['filesystem'] = undefined;

/**
 * @member {String} label
 */
BackupDisksInner.prototype['label'] = undefined;

/**
 * @member {Number} size
 */
BackupDisksInner.prototype['size'] = undefined;
...
/**
 * Allowed values for the <code>filesystem</code> property.
 * @enum {String}
 * @readonly
 */
BackupDisksInner['FilesystemEnum'] = {
...
export default BackupDisksInner;
