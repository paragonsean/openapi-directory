...
import FirewallRuleConfigAddresses from './FirewallRuleConfigAddresses';

/**
 * The FirewallRuleConfig model module.
 * @module model/FirewallRuleConfig
 * @version 4.151.1
 */
class FirewallRuleConfig {
    /**
     * Constructs a new <code>FirewallRuleConfig</code>.
     ...
     * @alias module:model/FirewallRuleConfig
     */
    constructor() { 
        
        FirewallRuleConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallRuleConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallRuleConfig} obj Optional instance to populate.
     * @return {module:model/FirewallRuleConfig} The populated <code>FirewallRuleConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallRuleConfig();

            if (data.hasOwnProperty('action')) {
                obj['action'] = ApiClient.convertToType(data['action'], 'String');
            }
            if (data.hasOwnProperty('addresses')) {
                obj['addresses'] = FirewallRuleConfigAddresses.constructFromObject(data['addresses']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallRuleConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallRuleConfig</code>.
     */
    static validateJSON(data) {
        ...
        if (data['addresses']) { // data not null
          FirewallRuleConfigAddresses.validateJSON(data['addresses']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['ports'] && !(typeof data['ports'] === 'string' || data['ports'] instanceof String)) {
            throw new Error("Expected the field `ports` to be a primitive type in the JSON string but got " + data['ports']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/FirewallRuleConfig.ActionEnum} action
 */
FirewallRuleConfig.prototype['action'] = undefined;

/**
 * @member {module:model/FirewallRuleConfigAddresses} addresses
 */
FirewallRuleConfig.prototype['addresses'] = undefined;

/**
 * Used to describe this rule. For display purposes only. 
 * @member {String} description
 */
FirewallRuleConfig.prototype['description'] = undefined;

/**
 * Used to identify this rule. For display purposes only. 
 * @member {String} label
 */
FirewallRuleConfig.prototype['label'] = undefined;
 ...
 * @member {String} ports
 */
FirewallRuleConfig.prototype['ports'] = undefined;

/**
 * The type of network traffic to allow. 
 * @member {module:model/FirewallRuleConfig.ProtocolEnum} protocol
 */
FirewallRuleConfig.prototype['protocol'] = undefined;
 ...
 * @readonly
 */
FirewallRuleConfig['ProtocolEnum'] = {
