...
import DatabaseTypeEngines from './DatabaseTypeEngines';
...
class DatabaseType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('engines')) {
                obj['engines'] = DatabaseTypeEngines.constructFromObject(data['engines']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['engines']) { // data not null
          DatabaseTypeEngines.validateJSON(data['engines']);
        }
        // ensure the json data is a string
