...
class Kernel {
    /**
     * Constructs a new <code>Kernel</code>.
     * Linux kernel object
     * @alias module:model/Kernel
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('built')) {
                obj['built'] = ApiClient.convertToType(data['built'], 'Date');
            }
            ...
            if (data.hasOwnProperty('kvm')) {
                obj['kvm'] = ApiClient.convertToType(data['kvm'], 'Boolean');
            }
            if (data.hasOwnProperty('label')) {
                obj['label'] = ApiClient.convertToType(data['label'], 'String');
            }
            if (data.hasOwnProperty('pvops')) {
                obj['pvops'] = ApiClient.convertToType(data['pvops'], 'Boolean');
            }
            if (data.hasOwnProperty('version')) {
                obj['version'] = ApiClient.convertToType(data['version'], 'String');
            }
            if (data.hasOwnProperty('xen')) {
                obj['xen'] = ApiClient.convertToType(data['xen'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Kernel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Kernel</code>.
     */
 ...
 * @member {module:model/Kernel.ArchitectureEnum} architecture
 */
Kernel.prototype['architecture'] = undefined;

/**
 * The date on which this Kernel was built.
 * @member {Date} built
 */
Kernel.prototype['built'] = undefined;

/**
 * If this Kernel is marked as deprecated, this field has a value of true; otherwise, this field is false.
 * @member {Boolean} deprecated
 */
Kernel.prototype['deprecated'] = undefined;

/**
 * The unique ID of this Kernel.
 * @member {String} id
 */
Kernel.prototype['id'] = undefined;

/**
 * If this Kernel is suitable for KVM Linodes.
 * @member {Boolean} kvm
 */
Kernel.prototype['kvm'] = undefined;

/**
 * The friendly name of this Kernel.
 * @member {String} label
 */
Kernel.prototype['label'] = undefined;

/**
 * If this Kernel is suitable for paravirtualized operations.
 * @member {Boolean} pvops
 */
Kernel.prototype['pvops'] = undefined;

/**
 * Linux Kernel version.
 * @member {String} version
 */
Kernel.prototype['version'] = undefined;

/**
 * If this Kernel is suitable for Xen Linodes.
 * @member {Boolean} xen
 */
Kernel.prototype['xen'] = undefined;
