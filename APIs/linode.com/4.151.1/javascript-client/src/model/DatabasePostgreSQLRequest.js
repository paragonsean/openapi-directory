...
/**
 * The DatabasePostgreSQLRequest model module.
 * @module model/DatabasePostgreSQLRequest
 * @version 4.151.1
 */
class DatabasePostgreSQLRequest {
    /**
     * Constructs a new <code>DatabasePostgreSQLRequest</code>.
     * Managed PostgreSQL Database request object.
     * @alias module:model/DatabasePostgreSQLRequest
     * @param engine {String} The Managed Database engine in engine/version format.
     * @param label {String} A unique, user-defined string referring to the Managed Database.
     * @param region {String} The [Region](/docs/api/regions/) ID for the Managed Database.
     * @param type {String} The Linode Instance type used by the Managed Database for its nodes.
     */
    constructor(engine, label, region, type) { 
        
        DatabasePostgreSQLRequest.initialize(this, engine, label, region, type);
    }
     ...
     */
    static initialize(obj, engine, label, region, type) { 
        obj['cluster_size'] = ClusterSizeEnum.1;
        obj['encrypted'] = false;
        obj['engine'] = engine;
        obj['label'] = label;
        obj['region'] = region;
        obj['replication_commit_type'] = 'local';
        obj['ssl_connection'] = true;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>DatabasePostgreSQLRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabasePostgreSQLRequest} obj Optional instance to populate.
     * @return {module:model/DatabasePostgreSQLRequest} The populated <code>DatabasePostgreSQLRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabasePostgreSQLRequest();

            if (data.hasOwnProperty('allow_list')) {
                obj['allow_list'] = ApiClient.convertToType(data['allow_list'], ['String']);
            }
            if (data.hasOwnProperty('cluster_size')) {
                obj['cluster_size'] = ApiClient.convertToType(data['cluster_size'], 'Number');
            }
            ...
            if (data.hasOwnProperty('replication_commit_type')) {
                obj['replication_commit_type'] = ApiClient.convertToType(data['replication_commit_type'], 'String');
            }
            if (data.hasOwnProperty('replication_type')) {
                obj['replication_type'] = ApiClient.convertToType(data['replication_type'], 'String');
            }
            if (data.hasOwnProperty('ssl_connection')) {
                obj['ssl_connection'] = ApiClient.convertToType(data['ssl_connection'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabasePostgreSQLRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabasePostgreSQLRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatabasePostgreSQLRequest.RequiredProperties) {
        ...
        if (!Array.isArray(data['allow_list'])) {
            throw new Error("Expected the field `allow_list` to be an array in the JSON data but got " + data['allow_list']);
        }
        ...
        // ensure the json data is a string
        if (data['replication_commit_type'] && !(typeof data['replication_commit_type'] === 'string' || data['replication_commit_type'] instanceof String)) {
            throw new Error("Expected the field `replication_commit_type` to be a primitive type in the JSON string but got " + data['replication_commit_type']);
        }
        // ensure the json data is a string
        if (data['replication_type'] && !(typeof data['replication_type'] === 'string' || data['replication_type'] instanceof String)) {
            throw new Error("Expected the field `replication_type` to be a primitive type in the JSON string but got " + data['replication_type']);
        }
        // ensure the json data is a string
...
DatabasePostgreSQLRequest.RequiredProperties = ["engine", "label", "region", "type"];
 ...
 * @member {Array.<String>} allow_list
 */
DatabasePostgreSQLRequest.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabasePostgreSQLRequest.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabasePostgreSQLRequest.prototype['cluster_size'] = ClusterSizeEnum.1;
 ...
 * @default false
 */
DatabasePostgreSQLRequest.prototype['encrypted'] = false;

/**
 * The Managed Database engine in engine/version format.
 * @member {String} engine
 */
DatabasePostgreSQLRequest.prototype['engine'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabasePostgreSQLRequest.prototype['label'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabasePostgreSQLRequest.prototype['region'] = undefined;
 ...
 * @member {module:model/DatabasePostgreSQLRequest.ReplicationCommitTypeEnum} replication_commit_type
 * @default 'local'
 */
DatabasePostgreSQLRequest.prototype['replication_commit_type'] = 'local';
 ...
 * @member {module:model/DatabasePostgreSQLRequest.ReplicationTypeEnum} replication_type
 */
DatabasePostgreSQLRequest.prototype['replication_type'] = undefined;

/**
 * Whether to require SSL credentials to establish a connection to the Managed Database.  Use the **Managed PostgreSQL Database Credentials View** ([GET /databases/postgresql/instances/{instanceId}/credentials](/docs/api/databases/#managed-postgresql-database-credentials-view)) command for access information. 
 * @member {Boolean} ssl_connection
 * @default true
 */
DatabasePostgreSQLRequest.prototype['ssl_connection'] = true;

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabasePostgreSQLRequest.prototype['type'] = undefined;
...
/**
 * Allowed values for the <code>cluster_size</code> property.
 * @enum {Number}
 * @readonly
 */
DatabasePostgreSQLRequest['ClusterSizeEnum'] = {
...
/**
 * Allowed values for the <code>replication_commit_type</code> property.
 * @enum {String}
 * @readonly
 */
DatabasePostgreSQLRequest['ReplicationCommitTypeEnum'] = {
...
/**
 * Allowed values for the <code>replication_type</code> property.
 * @enum {String}
 * @readonly
 */
DatabasePostgreSQLRequest['ReplicationTypeEnum'] = {
...
export default DatabasePostgreSQLRequest;
