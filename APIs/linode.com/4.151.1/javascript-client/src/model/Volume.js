...
class Volume {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('filesystem_path')) {
                obj['filesystem_path'] = ApiClient.convertToType(data['filesystem_path'], 'String');
            }
            if (data.hasOwnProperty('hardware_type')) {
                obj['hardware_type'] = ApiClient.convertToType(data['hardware_type'], 'String');
            }
            ...
            if (data.hasOwnProperty('linode_label')) {
                obj['linode_label'] = ApiClient.convertToType(data['linode_label'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['filesystem_path'] && !(typeof data['filesystem_path'] === 'string' || data['filesystem_path'] instanceof String)) {
            throw new Error("Expected the field `filesystem_path` to be a primitive type in the JSON string but got " + data['filesystem_path']);
        }
        // ensure the json data is a string
        if (data['hardware_type'] && !(typeof data['hardware_type'] === 'string' || data['hardware_type'] instanceof String)) {
            throw new Error("Expected the field `hardware_type` to be a primitive type in the JSON string but got " + data['hardware_type']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['linode_label'] && !(typeof data['linode_label'] === 'string' || data['linode_label'] instanceof String)) {
            throw new Error("Expected the field `linode_label` to be a primitive type in the JSON string but got " + data['linode_label']);
        }
        // ensure the json data is a string
 ...
 */
Volume.prototype['filesystem_path'] = undefined;

/**
 * The storage type of this Volume.
 * @member {module:model/Volume.HardwareTypeEnum} hardware_type
 */
Volume.prototype['hardware_type'] = undefined;
 ...
 * @member {module:model/Volume.StatusEnum} status
 */
 ...
 * @member {Date} updated
 */
Volume.prototype['updated'] = undefined;
...
/**
 * Allowed values for the <code>hardware_type</code> property.
 * @enum {String}
 * @readonly
 */
Volume['HardwareTypeEnum'] = {
