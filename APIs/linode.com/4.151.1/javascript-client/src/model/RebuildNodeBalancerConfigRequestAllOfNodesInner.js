...
/**
 * The RebuildNodeBalancerConfigRequestAllOfNodesInner model module.
 * @module model/RebuildNodeBalancerConfigRequestAllOfNodesInner
 * @version 4.151.1
 */
class RebuildNodeBalancerConfigRequestAllOfNodesInner {
    /**
     * Constructs a new <code>RebuildNodeBalancerConfigRequestAllOfNodesInner</code>.
     * NodeBalancer Node request object including ID.
     * @alias module:model/RebuildNodeBalancerConfigRequestAllOfNodesInner
     */
    constructor() { 
        
        RebuildNodeBalancerConfigRequestAllOfNodesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RebuildNodeBalancerConfigRequestAllOfNodesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RebuildNodeBalancerConfigRequestAllOfNodesInner} obj Optional instance to populate.
     * @return {module:model/RebuildNodeBalancerConfigRequestAllOfNodesInner} The populated <code>RebuildNodeBalancerConfigRequestAllOfNodesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RebuildNodeBalancerConfigRequestAllOfNodesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RebuildNodeBalancerConfigRequestAllOfNodesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RebuildNodeBalancerConfigRequestAllOfNodesInner</code>.
     */
 ...
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner.prototype['address'] = undefined;

/**
 * The unique ID of the Node to update.
 * @member {Number} id
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner.prototype['id'] = undefined;

/**
 * The label for this node.  This is for display purposes only. 
 * @member {String} label
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner.prototype['label'] = undefined;
 ...
 * @member {module:model/RebuildNodeBalancerConfigRequestAllOfNodesInner.ModeEnum} mode
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner.prototype['mode'] = undefined;
 ...
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner.prototype['weight'] = undefined;
 ...
 * @readonly
 */
RebuildNodeBalancerConfigRequestAllOfNodesInner['ModeEnum'] = {
...
export default RebuildNodeBalancerConfigRequestAllOfNodesInner;
