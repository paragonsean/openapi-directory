...
import LinodeRequest from './LinodeRequest';

/**
 * The CreateLinodeInstanceRequest model module.
 * @module model/CreateLinodeInstanceRequest
 * @version 4.151.1
 */
class CreateLinodeInstanceRequest {
    /**
     * Constructs a new <code>CreateLinodeInstanceRequest</code>.
     * @alias module:model/CreateLinodeInstanceRequest
     * @implements module:model/LinodeRequest
     * @param region {String} The [Region](/docs/api/regions/#regions-list) where the Linode will be located. 
     * @param type {String} The [Linode Type](/docs/api/linode-types/#types-list) of the Linode you are creating. 
     */
    constructor(region, type) { 
        LinodeRequest.initialize(this);
        CreateLinodeInstanceRequest.initialize(this, region, type);
    }
     ...
     */
    static initialize(obj, region, type) { 
        obj['booted'] = true;
        obj['region'] = region;
        obj['swap_size'] = 512;
        obj['type'] = type;
    ...
    /**
     * Constructs a <code>CreateLinodeInstanceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLinodeInstanceRequest} obj Optional instance to populate.
     * @return {module:model/CreateLinodeInstanceRequest} The populated <code>CreateLinodeInstanceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLinodeInstanceRequest();
            LinodeRequest.constructFromObject(data, obj);

            if (data.hasOwnProperty('authorized_keys')) {
                obj['authorized_keys'] = ApiClient.convertToType(data['authorized_keys'], ['String']);
            }
            if (data.hasOwnProperty('authorized_users')) {
                obj['authorized_users'] = ApiClient.convertToType(data['authorized_users'], ['String']);
            }
            if (data.hasOwnProperty('booted')) {
                obj['booted'] = ApiClient.convertToType(data['booted'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('stackscript_data')) {
                obj['stackscript_data'] = ApiClient.convertToType(data['stackscript_data'], Object);
            }
            if (data.hasOwnProperty('stackscript_id')) {
                obj['stackscript_id'] = ApiClient.convertToType(data['stackscript_id'], 'Number');
            }
            ...
            if (data.hasOwnProperty('interfaces')) {
                obj['interfaces'] = ApiClient.convertToType(data['interfaces'], [LinodeConfigInterface]);
            }
            ...
            if (data.hasOwnProperty('swap_size')) {
                obj['swap_size'] = ApiClient.convertToType(data['swap_size'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLinodeInstanceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLinodeInstanceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLinodeInstanceRequest.RequiredProperties) {
        ...
        if (!Array.isArray(data['authorized_keys'])) {
            throw new Error("Expected the field `authorized_keys` to be an array in the JSON data but got " + data['authorized_keys']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['authorized_users'])) {
            throw new Error("Expected the field `authorized_users` to be an array in the JSON data but got " + data['authorized_users']);
        }
        ...
        if (data['interfaces']) { // data not null
            ...
            for (const item of data['interfaces']) {
                LinodeConfigInterface.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
CreateLinodeInstanceRequest.RequiredProperties = ["region", "type"];
 ...
 */
CreateLinodeInstanceRequest.prototype['authorized_keys'] = undefined;
 ...
 * @member {Array.<String>} authorized_users
 */
CreateLinodeInstanceRequest.prototype['authorized_users'] = undefined;
 ...
 * @member {Boolean} booted
 * @default true
 */
CreateLinodeInstanceRequest.prototype['booted'] = true;
 ...
 * @member {String} image
 */
CreateLinodeInstanceRequest.prototype['image'] = undefined;
 ...
 */
CreateLinodeInstanceRequest.prototype['root_pass'] = undefined;
 ...
 * @member {Object} stackscript_data
 */
CreateLinodeInstanceRequest.prototype['stackscript_data'] = undefined;
 ...
 * @member {Number} stackscript_id
 */
CreateLinodeInstanceRequest.prototype['stackscript_id'] = undefined;
 ...
 */
CreateLinodeInstanceRequest.prototype['backup_id'] = undefined;
 ...
 */
CreateLinodeInstanceRequest.prototype['backups_enabled'] = undefined;

/**
 * A deprecated property denoting a group label for this Linode. 
 * @member {String} group
 */
CreateLinodeInstanceRequest.prototype['group'] = undefined;
 ...
 * @member {Array.<module:model/LinodeConfigInterface>} interfaces
 */
CreateLinodeInstanceRequest.prototype['interfaces'] = undefined;
 ...
 * @member {String} label
 */
CreateLinodeInstanceRequest.prototype['label'] = undefined;
 ...
 */
CreateLinodeInstanceRequest.prototype['private_ip'] = undefined;

/**
 * The [Region](/docs/api/regions/#regions-list) where the Linode will be located. 
 * @member {String} region
 */
CreateLinodeInstanceRequest.prototype['region'] = undefined;
 ...
 * @member {Number} swap_size
 * @default 512
 */
CreateLinodeInstanceRequest.prototype['swap_size'] = 512;

/**
 * An array of tags applied to this object.  Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
CreateLinodeInstanceRequest.prototype['tags'] = undefined;

/**
 * The [Linode Type](/docs/api/linode-types/#types-list) of the Linode you are creating. 
 * @member {String} type
 */
CreateLinodeInstanceRequest.prototype['type'] = undefined;


// Implement LinodeRequest interface:
/**
 * A list of public SSH keys that will be automatically appended to the root user's `~/.ssh/authorized_keys` file when deploying from an Image. 
 * @member {Array.<String>} authorized_keys
 */
LinodeRequest.prototype['authorized_keys'] = undefined;
/**
 * A list of usernames. If the usernames have associated SSH keys, the keys will be appended to the root users `~/.ssh/authorized_keys` file automatically when deploying from an Image. 
 * @member {Array.<String>} authorized_users
 */
LinodeRequest.prototype['authorized_users'] = undefined;
/**
 * This field defaults to `true` if the Linode is created with an Image or from a Backup. If it is deployed from an Image or a Backup and you wish it to remain `offline` after deployment, set this to `false`. 
 * @member {Boolean} booted
 * @default true
 */
LinodeRequest.prototype['booted'] = true;
/**
 * An Image ID to deploy the Linode Disk from.  Access the Images List ([GET /images](/docs/api/images/#images-list)) endpoint with authentication to view all available Images. Official Linode Images start with `linode/`, while your Account's Images start with `private/`. Creating a disk from a Private Image requires `read_only` or `read_write` permissions for that Image. Access the User's Grant Update ([PUT /account/users/{username}/grants](/docs/api/account/#users-grants-update)) endpoint to adjust permissions for an Account Image. 
 * @member {String} image
 */
LinodeRequest.prototype['image'] = undefined;
/**
 * This sets the root user's password on a newly-created Linode Disk when deploying from an Image.  * **Required** when creating a Linode Disk from an Image, including when using a StackScript.  * Must meet a password strength score requirement that is calculated internally by the API. If the strength requirement is not met, you will receive a `Password does not meet strength requirement` error. 
 * @member {String} root_pass
 */
LinodeRequest.prototype['root_pass'] = undefined;
/**
 * This field is required only if the StackScript being deployed requires input data from the User for successful completion. See [User Defined Fields (UDFs)](/docs/guides/writing-scripts-for-use-with-linode-stackscripts-a-tutorial/#user-defined-fields-udfs) for more details.  This field is required to be valid JSON.  Total length cannot exceed 65,535 characters. 
 * @member {Object} stackscript_data
 */
LinodeRequest.prototype['stackscript_data'] = undefined;
/**
 * A StackScript ID that will cause the referenced StackScript to be run during deployment of this Linode. A compatible `image` is required to use a StackScript. To get a list of available StackScript and their permitted Images see [/stackscripts](/docs/api/stackscripts/#stackscripts-list). This field cannot be used when deploying from a Backup or a Private Image. 
 * @member {Number} stackscript_id
 */
LinodeRequest.prototype['stackscript_id'] = undefined;




export default CreateLinodeInstanceRequest;
