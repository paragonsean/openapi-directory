...
/**
 * The DatabaseMySQL model module.
 * @module model/DatabaseMySQL
 * @version 4.151.1
 */
class DatabaseMySQL {
    /**
     * Constructs a new <code>DatabaseMySQL</code>.
     * Managed MySQL Databases object.
     * @alias module:model/DatabaseMySQL
     */
    constructor() { 
        
        DatabaseMySQL.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatabaseMySQL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseMySQL} obj Optional instance to populate.
     * @return {module:model/DatabaseMySQL} The populated <code>DatabaseMySQL</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseMySQL();
            ...
            if (data.hasOwnProperty('hosts')) {
                obj['hosts'] = DatabaseHosts.constructFromObject(data['hosts']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseMySQL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseMySQL</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hosts']) { // data not null
          DatabaseHosts.validateJSON(data['hosts']);
        }
        // ensure the json data is a string
 ...
 */
DatabaseMySQL.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabaseMySQL.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabaseMySQL.prototype['cluster_size'] = ClusterSizeEnum.1;

/**
 * When this Managed Database was created.
 * @member {Date} created
 */
DatabaseMySQL.prototype['created'] = undefined;
 ...
 * @default false
 */
DatabaseMySQL.prototype['encrypted'] = false;

/**
 * The Managed Database engine type.
 * @member {String} engine
 */
DatabaseMySQL.prototype['engine'] = undefined;

/**
 * @member {module:model/DatabaseHosts} hosts
 */
DatabaseMySQL.prototype['hosts'] = undefined;

/**
 * A unique ID that can be used to identify and reference the Managed Database.
 * @member {Number} id
 */
DatabaseMySQL.prototype['id'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabaseMySQL.prototype['label'] = undefined;

/**
 * The access port for this Managed Database.
 * @member {Number} port
 */
DatabaseMySQL.prototype['port'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabaseMySQL.prototype['region'] = undefined;
 ...
 * @member {module:model/DatabaseMySQL.ReplicationTypeEnum} replication_type
 */
DatabaseMySQL.prototype['replication_type'] = undefined;
 ...
 * @default true
 */
DatabaseMySQL.prototype['ssl_connection'] = true;

/**
 * The operating status of the Managed Database.
 * @member {module:model/DatabaseMySQL.StatusEnum} status
 */
DatabaseMySQL.prototype['status'] = undefined;

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabaseMySQL.prototype['type'] = undefined;

/**
 * When this Managed Database was last updated.
 * @member {Date} updated
 */
DatabaseMySQL.prototype['updated'] = undefined;

/**
 * @member {module:model/DatabaseUpdates} updates
 */
DatabaseMySQL.prototype['updates'] = undefined;

/**
 * The Managed Database engine version.
 * @member {String} version
 */
DatabaseMySQL.prototype['version'] = undefined;
 ...
 * @readonly
 */
DatabaseMySQL['ReplicationTypeEnum'] = {
