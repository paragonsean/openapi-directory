...
import StatsDataAvailable from './StatsDataAvailable';

/**
 * The GetManagedStats200ResponseData model module.
 * @module model/GetManagedStats200ResponseData
 * @version 4.151.1
 */
class GetManagedStats200ResponseData {
    /**
     * Constructs a new <code>GetManagedStats200ResponseData</code>.
     * @alias module:model/GetManagedStats200ResponseData
     * @param {(module:model/StatsDataAvailable|module:model/[String])} instance The actual instance to initialize GetManagedStats200ResponseData.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "StatsDataAvailable") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                StatsDataAvailable.validateJSON(instance); // throw an exception if no match
                // create StatsDataAvailable from JS object
                this.actualInstance = StatsDataAvailable.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into StatsDataAvailable
            errorMessages.push("Failed to construct StatsDataAvailable: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GetManagedStats200ResponseData` with oneOf schemas StatsDataAvailable, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GetManagedStats200ResponseData` with oneOf schemas StatsDataAvailable, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GetManagedStats200ResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManagedStats200ResponseData} obj Optional instance to populate.
     * @return {module:model/GetManagedStats200ResponseData} The populated <code>GetManagedStats200ResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GetManagedStats200ResponseData(data);
    }

    /**
     * Gets the actual instance, which can be <code>StatsDataAvailable</code>, <code>[String]</code>.
     * @return {(module:model/StatsDataAvailable|module:model/[String])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>StatsDataAvailable</code>, <code>[String]</code>.
     * @param {(module:model/StatsDataAvailable|module:model/[String])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GetManagedStats200ResponseData.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/GetManagedStats200ResponseData} An instance of GetManagedStats200ResponseData.
     */
    static fromJSON = function(json_string){
        return GetManagedStats200ResponseData.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
GetManagedStats200ResponseData.prototype['cpu'] = undefined;

/**
 * Disk usage stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} disk
 */
GetManagedStats200ResponseData.prototype['disk'] = undefined;

/**
 * Inbound network traffic stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} net_in
 */
GetManagedStats200ResponseData.prototype['net_in'] = undefined;

/**
 * Outbound network traffic stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} net_out
 */
GetManagedStats200ResponseData.prototype['net_out'] = undefined;

/**
 * Swap usage stats from the last 24 hours.
 * @member {Array.<module:model/StatsData>} swap
 */
GetManagedStats200ResponseData.prototype['swap'] = undefined;


GetManagedStats200ResponseData.OneOf = ["StatsDataAvailable", "[String]"];

export default GetManagedStats200ResponseData;
