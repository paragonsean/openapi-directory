...
class ManagedService {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('consultation_group')) {
                obj['consultation_group'] = ApiClient.convertToType(data['consultation_group'], 'String');
            }
            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ApiClient.convertToType(data['credentials'], ['Number']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['consultation_group'] && !(typeof data['consultation_group'] === 'string' || data['consultation_group'] instanceof String)) {
            throw new Error("Expected the field `consultation_group` to be a primitive type in the JSON string but got " + data['consultation_group']);
        }
 ...
 * @readonly
 */
ManagedService['ServiceTypeEnum'] = {
