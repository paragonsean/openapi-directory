 ...
 */
Login.prototype['datetime'] = undefined;

/**
 * The unique ID of this login object. 
 * @member {Number} id
 */
Login.prototype['id'] = undefined;

/**
 * The remote IP address that requested the login. 
 * @member {String} ip
 */
Login.prototype['ip'] = undefined;

/**
 * True if the User that attempted the login was a restricted User, false otherwise. 
 * @member {Boolean} restricted
 */
Login.prototype['restricted'] = undefined;

/**
 * Whether the login attempt succeeded or failed. 
 * @member {module:model/Login.StatusEnum} status
 */
Login.prototype['status'] = undefined;
