...
class CreateVolumeRequest {
     ...
     * @param label {String} The Volume's label, which is also used in the `filesystem_path` of the resulting volume. 
     */
    constructor(label) { 
        
        CreateVolumeRequest.initialize(this, label);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('config_id')) {
                obj['config_id'] = ApiClient.convertToType(data['config_id'], 'Number');
            }
...
CreateVolumeRequest.RequiredProperties = ["label"];
 ...
 */
CreateVolumeRequest.prototype['config_id'] = undefined;

/**
 * The Volume's label, which is also used in the `filesystem_path` of the resulting volume. 
 * @member {String} label
 */
CreateVolumeRequest.prototype['label'] = undefined;
 ...
 */
CreateVolumeRequest.prototype['linode_id'] = undefined;

/**
 * The Region to deploy this Volume in. This is only required if a linode_id is not given. 
 * @member {String} region
 */
CreateVolumeRequest.prototype['region'] = undefined;
 ...
 * @default 20
 */
CreateVolumeRequest.prototype['size'] = 20;
