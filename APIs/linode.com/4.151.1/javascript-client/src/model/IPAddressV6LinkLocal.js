...
/**
 * The IPAddressV6LinkLocal model module.
 * @module model/IPAddressV6LinkLocal
 * @version 4.151.1
 */
class IPAddressV6LinkLocal {
    /**
     * Constructs a new <code>IPAddressV6LinkLocal</code>.
     * A link-local IPv6 address that exists in Linode&#39;s system,. 
     * @alias module:model/IPAddressV6LinkLocal
     */
    constructor() { 
        
        IPAddressV6LinkLocal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPAddressV6LinkLocal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IPAddressV6LinkLocal} obj Optional instance to populate.
     * @return {module:model/IPAddressV6LinkLocal} The populated <code>IPAddressV6LinkLocal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPAddressV6LinkLocal();
            ...
            if (data.hasOwnProperty('linode_id')) {
                obj['linode_id'] = ApiClient.convertToType(data['linode_id'], 'Number');
            }
            ...
            if (data.hasOwnProperty('rdns')) {
                obj['rdns'] = ApiClient.convertToType(data['rdns'], 'String');
            }
            if (data.hasOwnProperty('region')) {
                obj['region'] = ApiClient.convertToType(data['region'], 'String');
            }
            if (data.hasOwnProperty('subnet_mask')) {
                obj['subnet_mask'] = ApiClient.convertToType(data['subnet_mask'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IPAddressV6LinkLocal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPAddressV6LinkLocal</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['rdns'] && !(typeof data['rdns'] === 'string' || data['rdns'] instanceof String)) {
            throw new Error("Expected the field `rdns` to be a primitive type in the JSON string but got " + data['rdns']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['subnet_mask'] && !(typeof data['subnet_mask'] === 'string' || data['subnet_mask'] instanceof String)) {
            throw new Error("Expected the field `subnet_mask` to be a primitive type in the JSON string but got " + data['subnet_mask']);
        }
        // ensure the json data is a string
 ...
 */
IPAddressV6LinkLocal.prototype['address'] = undefined;

/**
 * The default gateway for this address. 
 * @member {String} gateway
 */
IPAddressV6LinkLocal.prototype['gateway'] = undefined;

/**
 * The ID of the Linode this address currently belongs to. 
 * @member {Number} linode_id
 */
IPAddressV6LinkLocal.prototype['linode_id'] = undefined;

/**
 * The network prefix. 
 * @member {Number} prefix
 */
IPAddressV6LinkLocal.prototype['prefix'] = undefined;

/**
 * Whether this is a public or private IP address. 
 * @member {Boolean} public
 */
IPAddressV6LinkLocal.prototype['public'] = undefined;

/**
 * The reverse DNS assigned to this address. 
 * @member {String} rdns
 */
IPAddressV6LinkLocal.prototype['rdns'] = undefined;

/**
 * The Region this address resides in. 
 * @member {String} region
 */
IPAddressV6LinkLocal.prototype['region'] = undefined;

/**
 * The subnet mask. 
 * @member {String} subnet_mask
 */
IPAddressV6LinkLocal.prototype['subnet_mask'] = undefined;

/**
 * The type of address this is. 
 * @member {String} type
 */
IPAddressV6LinkLocal.prototype['type'] = undefined;
...
export default IPAddressV6LinkLocal;
