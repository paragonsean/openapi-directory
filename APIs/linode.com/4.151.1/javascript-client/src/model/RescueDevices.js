...
/**
 * The RescueDevices model module.
 * @module model/RescueDevices
 * @version 4.151.1
 */
class RescueDevices {
    /**
     * Constructs a new <code>RescueDevices</code>.
     * @alias module:model/RescueDevices
     */
    constructor() { 
        
        RescueDevices.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RescueDevices</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RescueDevices} obj Optional instance to populate.
     * @return {module:model/RescueDevices} The populated <code>RescueDevices</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RescueDevices();

            if (data.hasOwnProperty('sda')) {
                obj['sda'] = Device.constructFromObject(data['sda']);
            }
            if (data.hasOwnProperty('sdb')) {
                obj['sdb'] = Device.constructFromObject(data['sdb']);
            }
            if (data.hasOwnProperty('sdc')) {
                obj['sdc'] = Device.constructFromObject(data['sdc']);
            }
            if (data.hasOwnProperty('sdd')) {
                obj['sdd'] = Device.constructFromObject(data['sdd']);
            }
            if (data.hasOwnProperty('sde')) {
                obj['sde'] = Device.constructFromObject(data['sde']);
            }
            if (data.hasOwnProperty('sdf')) {
                obj['sdf'] = Device.constructFromObject(data['sdf']);
            }
            if (data.hasOwnProperty('sdg')) {
                obj['sdg'] = Device.constructFromObject(data['sdg']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RescueDevices</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RescueDevices</code>.
     */
    static validateJSON(data) {
        // validate the optional field `sda`
        if (data['sda']) { // data not null
          Device.validateJSON(data['sda']);
        }
        // validate the optional field `sdb`
        if (data['sdb']) { // data not null
          Device.validateJSON(data['sdb']);
        }
        // validate the optional field `sdc`
        if (data['sdc']) { // data not null
          Device.validateJSON(data['sdc']);
        }
        // validate the optional field `sdd`
        if (data['sdd']) { // data not null
          Device.validateJSON(data['sdd']);
        }
        // validate the optional field `sde`
        if (data['sde']) { // data not null
          Device.validateJSON(data['sde']);
        }
        // validate the optional field `sdf`
        if (data['sdf']) { // data not null
          Device.validateJSON(data['sdf']);
        }
        // validate the optional field `sdg`
        if (data['sdg']) { // data not null
          Device.validateJSON(data['sdg']);
        }
...
/**
 * @member {module:model/Device} sda
 */
RescueDevices.prototype['sda'] = undefined;

/**
 * @member {module:model/Device} sdb
 */
RescueDevices.prototype['sdb'] = undefined;

/**
 * @member {module:model/Device} sdc
 */
RescueDevices.prototype['sdc'] = undefined;

/**
 * @member {module:model/Device} sdd
 */
RescueDevices.prototype['sdd'] = undefined;

/**
 * @member {module:model/Device} sde
 */
RescueDevices.prototype['sde'] = undefined;

/**
 * @member {module:model/Device} sdf
 */
RescueDevices.prototype['sdf'] = undefined;

/**
 * @member {module:model/Device} sdg
 */
RescueDevices.prototype['sdg'] = undefined;
