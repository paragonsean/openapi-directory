...
import LKENodePoolAutoscaler from './LKENodePoolAutoscaler';
import LKENodePoolDisksInner from './LKENodePoolDisksInner';
import LKENodeStatus from './LKENodeStatus';

/**
 * The LKENodePool model module.
 * @module model/LKENodePool
 * @version 4.151.1
 */
class LKENodePool {
    /**
     * Constructs a new <code>LKENodePool</code>.
     ...
     * @alias module:model/LKENodePool
     */
    constructor() { 
        
        LKENodePool.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LKENodePool</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LKENodePool} obj Optional instance to populate.
     * @return {module:model/LKENodePool} The populated <code>LKENodePool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LKENodePool();

            if (data.hasOwnProperty('autoscaler')) {
                obj['autoscaler'] = LKENodePoolAutoscaler.constructFromObject(data['autoscaler']);
            }
            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('disks')) {
                obj['disks'] = ApiClient.convertToType(data['disks'], [LKENodePoolDisksInner]);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('nodes')) {
                obj['nodes'] = ApiClient.convertToType(data['nodes'], [LKENodeStatus]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LKENodePool</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LKENodePool</code>.
     */
    static validateJSON(data) {
        // validate the optional field `autoscaler`
        if (data['autoscaler']) { // data not null
          LKENodePoolAutoscaler.validateJSON(data['autoscaler']);
        }
        if (data['disks']) { // data not null
            ...
            for (const item of data['disks']) {
                LKENodePoolDisksInner.validateJSON(item);
            };
        }
        if (data['nodes']) { // data not null
            ...
            for (const item of data['nodes']) {
                LKENodeStatus.validateJSON(item);
            };
        }
        // ensure the json data is an array
...
/**
 * @member {module:model/LKENodePoolAutoscaler} autoscaler
 */
LKENodePool.prototype['autoscaler'] = undefined;

/**
 * The number of nodes in the Node Pool.
 * @member {Number} count
 */
LKENodePool.prototype['count'] = undefined;

/**
 * This Node Pool's custom disk layout. 
 * @member {Array.<module:model/LKENodePoolDisksInner>} disks
 */
LKENodePool.prototype['disks'] = undefined;

/**
 * This Node Pool's unique ID. 
 * @member {Number} id
 */
LKENodePool.prototype['id'] = undefined;
 ...
 * @member {Array.<module:model/LKENodeStatus>} nodes
 */
LKENodePool.prototype['nodes'] = undefined;

/**
 * An array of tags applied to this object. Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
LKENodePool.prototype['tags'] = undefined;

/**
 * The Linode Type for all of the nodes in the Node Pool.
 * @member {String} type
 */
LKENodePool.prototype['type'] = undefined;
