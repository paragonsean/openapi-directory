...
import DatabasePostgreSQLHosts from './DatabasePostgreSQLHosts';
import DatabaseUpdates from './DatabaseUpdates';

/**
 * The DatabasePostgreSQL model module.
 * @module model/DatabasePostgreSQL
 * @version 4.151.1
 */
class DatabasePostgreSQL {
    /**
     * Constructs a new <code>DatabasePostgreSQL</code>.
     * Managed PostgreSQL Databases object.
     * @alias module:model/DatabasePostgreSQL
     */
    constructor() { 
        
        DatabasePostgreSQL.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatabasePostgreSQL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabasePostgreSQL} obj Optional instance to populate.
     * @return {module:model/DatabasePostgreSQL} The populated <code>DatabasePostgreSQL</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabasePostgreSQL();
            ...
            if (data.hasOwnProperty('hosts')) {
                obj['hosts'] = DatabasePostgreSQLHosts.constructFromObject(data['hosts']);
            }
            ...
            if (data.hasOwnProperty('updates')) {
                obj['updates'] = DatabaseUpdates.constructFromObject(data['updates']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabasePostgreSQL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabasePostgreSQL</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hosts']) { // data not null
          DatabasePostgreSQLHosts.validateJSON(data['hosts']);
        }
        // ensure the json data is a string
        ...
        if (data['updates']) { // data not null
          DatabaseUpdates.validateJSON(data['updates']);
        }
        // ensure the json data is a string
 ...
 */
DatabasePostgreSQL.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabasePostgreSQL.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabasePostgreSQL.prototype['cluster_size'] = ClusterSizeEnum.1;

/**
 * When this Managed Database was created.
 * @member {Date} created
 */
DatabasePostgreSQL.prototype['created'] = undefined;
 ...
 * @default false
 */
DatabasePostgreSQL.prototype['encrypted'] = false;

/**
 * The Managed Database engine type.
 * @member {String} engine
 */
DatabasePostgreSQL.prototype['engine'] = undefined;

/**
 * @member {module:model/DatabasePostgreSQLHosts} hosts
 */
DatabasePostgreSQL.prototype['hosts'] = undefined;

/**
 * A unique ID that can be used to identify and reference the Managed Database.
 * @member {Number} id
 */
DatabasePostgreSQL.prototype['id'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabasePostgreSQL.prototype['label'] = undefined;

/**
 * The access port for this Managed Database.
 * @member {Number} port
 */
DatabasePostgreSQL.prototype['port'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabasePostgreSQL.prototype['region'] = undefined;
 ...
 * @member {module:model/DatabasePostgreSQL.ReplicationCommitTypeEnum} replication_commit_type
 * @default 'local'
 */
DatabasePostgreSQL.prototype['replication_commit_type'] = 'local';
 ...
 * @member {module:model/DatabasePostgreSQL.ReplicationTypeEnum} replication_type
 */
DatabasePostgreSQL.prototype['replication_type'] = undefined;
 ...
 * @default true
 */
DatabasePostgreSQL.prototype['ssl_connection'] = true;

/**
 * The operating status of the Managed Database.
 * @member {module:model/DatabasePostgreSQL.StatusEnum} status
 */
DatabasePostgreSQL.prototype['status'] = undefined;

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabasePostgreSQL.prototype['type'] = undefined;

/**
 * When this Managed Database was last updated.
 * @member {Date} updated
 */
DatabasePostgreSQL.prototype['updated'] = undefined;

/**
 * @member {module:model/DatabaseUpdates} updates
 */
DatabasePostgreSQL.prototype['updates'] = undefined;

/**
 * The Managed Database engine version.
 * @member {String} version
 */
DatabasePostgreSQL.prototype['version'] = undefined;
 ...
 * @readonly
 */
DatabasePostgreSQL['ClusterSizeEnum'] = {
 ...
 * @readonly
 */
DatabasePostgreSQL['ReplicationCommitTypeEnum'] = {
 ...
 * @readonly
 */
DatabasePostgreSQL['ReplicationTypeEnum'] = {
