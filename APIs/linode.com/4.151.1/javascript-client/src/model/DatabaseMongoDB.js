...
import DatabaseMongoDBHosts from './DatabaseMongoDBHosts';
import DatabaseUpdates from './DatabaseUpdates';

/**
 * The DatabaseMongoDB model module.
 * @module model/DatabaseMongoDB
 * @version 4.151.1
 */
class DatabaseMongoDB {
    /**
     * Constructs a new <code>DatabaseMongoDB</code>.
     * Managed MongoDB Databases object.
     * @alias module:model/DatabaseMongoDB
     */
    constructor() { 
        
        DatabaseMongoDB.initialize(this);
    }
    ...
    static initialize(obj) { 
        ...
        obj['storage_engine'] = 'wiredtiger';
    }

    /**
     * Constructs a <code>DatabaseMongoDB</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseMongoDB} obj Optional instance to populate.
     * @return {module:model/DatabaseMongoDB} The populated <code>DatabaseMongoDB</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseMongoDB();
            ...
            if (data.hasOwnProperty('hosts')) {
                obj['hosts'] = DatabaseMongoDBHosts.constructFromObject(data['hosts']);
            }
            ...
            if (data.hasOwnProperty('replica_set')) {
                obj['replica_set'] = ApiClient.convertToType(data['replica_set'], 'String');
            }
            ...
            if (data.hasOwnProperty('storage_engine')) {
                obj['storage_engine'] = ApiClient.convertToType(data['storage_engine'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseMongoDB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseMongoDB</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hosts']) { // data not null
          DatabaseMongoDBHosts.validateJSON(data['hosts']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['replica_set'] && !(typeof data['replica_set'] === 'string' || data['replica_set'] instanceof String)) {
            throw new Error("Expected the field `replica_set` to be a primitive type in the JSON string but got " + data['replica_set']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['storage_engine'] && !(typeof data['storage_engine'] === 'string' || data['storage_engine'] instanceof String)) {
            throw new Error("Expected the field `storage_engine` to be a primitive type in the JSON string but got " + data['storage_engine']);
        }
        // ensure the json data is a string
 ...
 */
DatabaseMongoDB.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabaseMongoDB.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabaseMongoDB.prototype['cluster_size'] = ClusterSizeEnum.1;
 ...
 * @member {module:model/DatabaseMongoDB.CompressionTypeEnum} compression_type
 * @default 'none'
 */
DatabaseMongoDB.prototype['compression_type'] = 'none';

/**
 * When this Managed Database was created.
 * @member {Date} created
 */
DatabaseMongoDB.prototype['created'] = undefined;
 ...
 * @default false
 */
DatabaseMongoDB.prototype['encrypted'] = false;

/**
 * The Managed Database engine type.
 * @member {String} engine
 */
DatabaseMongoDB.prototype['engine'] = undefined;

/**
 * @member {module:model/DatabaseMongoDBHosts} hosts
 */
DatabaseMongoDB.prototype['hosts'] = undefined;

/**
 * A unique ID that can be used to identify and reference the Managed Database.
 * @member {Number} id
 */
DatabaseMongoDB.prototype['id'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabaseMongoDB.prototype['label'] = undefined;

/**
 * An array of peer addresses for this Database. 
 * @member {Array.<String>} peers
 */
DatabaseMongoDB.prototype['peers'] = undefined;

/**
 * The access port for this Managed Database.
 * @member {Number} port
 */
DatabaseMongoDB.prototype['port'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabaseMongoDB.prototype['region'] = undefined;
 ...
 * @member {String} replica_set
 */
DatabaseMongoDB.prototype['replica_set'] = undefined;
 ...
 * @default true
 */
DatabaseMongoDB.prototype['ssl_connection'] = true;

/**
 * The operating status of the Managed Database.
 * @member {module:model/DatabaseMongoDB.StatusEnum} status
 */
DatabaseMongoDB.prototype['status'] = undefined;

/**
 * The type of storage engine for this Database.  **Note:** MMAPV1 is not available for MongoDB versions 4.0 and above. 
 * @member {module:model/DatabaseMongoDB.StorageEngineEnum} storage_engine
 * @default 'wiredtiger'
 */
DatabaseMongoDB.prototype['storage_engine'] = 'wiredtiger';

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabaseMongoDB.prototype['type'] = undefined;

/**
 * When this Managed Database was last updated.
 * @member {Date} updated
 */
DatabaseMongoDB.prototype['updated'] = undefined;

/**
 * @member {module:model/DatabaseUpdates} updates
 */
DatabaseMongoDB.prototype['updates'] = undefined;

/**
 * The Managed Database engine version.
 * @member {String} version
 */
DatabaseMongoDB.prototype['version'] = undefined;
 ...
 * @readonly
 */
DatabaseMongoDB['ClusterSizeEnum'] = {
 ...
 * @readonly
 */
DatabaseMongoDB['CompressionTypeEnum'] = {
...
/**
 * Allowed values for the <code>storage_engine</code> property.
 * @enum {String}
 * @readonly
 */
DatabaseMongoDB['StorageEngineEnum'] = {
