...
/**
 * The CloneLinodeInstanceRequest model module.
 * @module model/CloneLinodeInstanceRequest
 * @version 4.151.1
 */
class CloneLinodeInstanceRequest {
    /**
     * Constructs a new <code>CloneLinodeInstanceRequest</code>.
     * @alias module:model/CloneLinodeInstanceRequest
     */
    constructor() { 
        
        CloneLinodeInstanceRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CloneLinodeInstanceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloneLinodeInstanceRequest} obj Optional instance to populate.
     * @return {module:model/CloneLinodeInstanceRequest} The populated <code>CloneLinodeInstanceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloneLinodeInstanceRequest();

            if (data.hasOwnProperty('backups_enabled')) {
                obj['backups_enabled'] = ApiClient.convertToType(data['backups_enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('configs')) {
                obj['configs'] = ApiClient.convertToType(data['configs'], ['Number']);
            }
            if (data.hasOwnProperty('disks')) {
                obj['disks'] = ApiClient.convertToType(data['disks'], ['Number']);
            }
            ...
            if (data.hasOwnProperty('private_ip')) {
                obj['private_ip'] = ApiClient.convertToType(data['private_ip'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CloneLinodeInstanceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloneLinodeInstanceRequest</code>.
     */
 ...
 * @member {Boolean} backups_enabled
 */
CloneLinodeInstanceRequest.prototype['backups_enabled'] = undefined;
 ...
 * @member {Array.<Number>} configs
 */
CloneLinodeInstanceRequest.prototype['configs'] = undefined;
 ...
 * @member {Array.<Number>} disks
 */
CloneLinodeInstanceRequest.prototype['disks'] = undefined;

/**
 * A label used to group Linodes for display. Linodes are not required to have a group. 
 * @member {String} group
 */
CloneLinodeInstanceRequest.prototype['group'] = undefined;
 ...
 * @member {String} label
 */
CloneLinodeInstanceRequest.prototype['label'] = undefined;
 ...
 */
CloneLinodeInstanceRequest.prototype['linode_id'] = undefined;
 ...
 * @member {Boolean} private_ip
 */
CloneLinodeInstanceRequest.prototype['private_ip'] = undefined;

/**
 * This is the Region where the Linode will be deployed. To view all available Regions you can deploy to see [/regions](/docs/api/regions/#regions-list). * Region can only be provided and is required when cloning to a new Linode. 
 * @member {String} region
 */
CloneLinodeInstanceRequest.prototype['region'] = undefined;

/**
 * A Linode's Type determines what resources are available to it, including disk space, memory, and virtual cpus. The amounts available to a specific Linode are returned as `specs` on the Linode object.  To view all available Linode Types you can deploy with see [/linode/types](/docs/api/linode-types/#types-list).  * Type can only be provided and is required when cloning to a new Linode. 
 * @member {String} type
 */
CloneLinodeInstanceRequest.prototype['type'] = undefined;
...
export default CloneLinodeInstanceRequest;
