...
import ObjectStorageKeyBucketAccessInner from './ObjectStorageKeyBucketAccessInner';

/**
 * The ObjectStorageKey model module.
 * @module model/ObjectStorageKey
 * @version 4.151.1
 */
class ObjectStorageKey {
    /**
     * Constructs a new <code>ObjectStorageKey</code>.
     * A keypair used to communicate with the Object Storage S3 API.
     * @alias module:model/ObjectStorageKey
     */
    constructor() { 
        
        ObjectStorageKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ObjectStorageKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectStorageKey} obj Optional instance to populate.
     * @return {module:model/ObjectStorageKey} The populated <code>ObjectStorageKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectStorageKey();

            if (data.hasOwnProperty('access_key')) {
                obj['access_key'] = ApiClient.convertToType(data['access_key'], 'String');
            }
            if (data.hasOwnProperty('bucket_access')) {
                obj['bucket_access'] = ApiClient.convertToType(data['bucket_access'], [ObjectStorageKeyBucketAccessInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectStorageKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectStorageKey</code>.
     */
    static validateJSON(data) {
        ...
        if (data['bucket_access']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['bucket_access'])) {
                throw new Error("Expected the field `bucket_access` to be an array in the JSON data but got " + data['bucket_access']);
            }
            // validate the optional field `bucket_access` (array)
            for (const item of data['bucket_access']) {
                ObjectStorageKeyBucketAccessInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
ObjectStorageKey.prototype['access_key'] = undefined;
 ...
 * @member {Array.<module:model/ObjectStorageKeyBucketAccessInner>} bucket_access
 */
ObjectStorageKey.prototype['bucket_access'] = undefined;

/**
 * This keypair's unique ID
 * @member {Number} id
 */
ObjectStorageKey.prototype['id'] = undefined;

/**
 * The label given to this key. For display purposes only.
 * @member {String} label
 */
ObjectStorageKey.prototype['label'] = undefined;
 ...
 */
ObjectStorageKey.prototype['limited'] = undefined;

/**
 * This keypair's secret key. Only returned on key creation.
 * @member {String} secret_key
 */
ObjectStorageKey.prototype['secret_key'] = undefined;
...
export default ObjectStorageKey;
