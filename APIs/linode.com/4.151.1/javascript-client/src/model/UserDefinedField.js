...
/**
 * The UserDefinedField model module.
 * @module model/UserDefinedField
 * @version 4.151.1
 */
class UserDefinedField {
    /**
     * Constructs a new <code>UserDefinedField</code>.
     * A custom field defined by the User with a special syntax within a StackScript. Derived from the contents of the script. 
     * @alias module:model/UserDefinedField
     * @param example {String} An example value for the field. 
     * @param label {String} A human-readable label for the field that will serve as the input prompt for entering the value during deployment. 
     * @param name {String} The name of the field. 
     */
    constructor(example, label, name) { 
        
        UserDefinedField.initialize(this, example, label, name);
    }
     ...
     */
    static initialize(obj, example, label, name) { 
        obj['example'] = example;
        obj['label'] = label;
        obj['name'] = name;
    }
    ...
    /**
     * Constructs a <code>UserDefinedField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserDefinedField} obj Optional instance to populate.
     * @return {module:model/UserDefinedField} The populated <code>UserDefinedField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserDefinedField();
            ...
            if (data.hasOwnProperty('manyOf')) {
                obj['manyOf'] = ApiClient.convertToType(data['manyOf'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserDefinedField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserDefinedField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserDefinedField.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['manyOf'] && !(typeof data['manyOf'] === 'string' || data['manyOf'] instanceof String)) {
            throw new Error("Expected the field `manyOf` to be a primitive type in the JSON string but got " + data['manyOf']);
        }
        // ensure the json data is a string
...
UserDefinedField.RequiredProperties = ["example", "label", "name"];

/**
 * The default value.  If not specified, this value will be used. 
 * @member {String} default
 */
UserDefinedField.prototype['default'] = undefined;

/**
 * An example value for the field. 
 * @member {String} example
 */
UserDefinedField.prototype['example'] = undefined;

/**
 * A human-readable label for the field that will serve as the input prompt for entering the value during deployment. 
 * @member {String} label
 */
UserDefinedField.prototype['label'] = undefined;

/**
 * A list of acceptable values for the field in any quantity, combination or order. 
 * @member {String} manyOf
 */
UserDefinedField.prototype['manyOf'] = undefined;

/**
 * The name of the field. 
 * @member {String} name
 */
UserDefinedField.prototype['name'] = undefined;

/**
 * A list of acceptable single values for the field. 
 * @member {String} oneOf
 */
UserDefinedField.prototype['oneOf'] = undefined;
