...
/**
 * The LinodeBackupsSchedule model module.
 * @module model/LinodeBackupsSchedule
 * @version 4.151.1
 */
class LinodeBackupsSchedule {
    /**
     * Constructs a new <code>LinodeBackupsSchedule</code>.
     * @alias module:model/LinodeBackupsSchedule
     */
    constructor() { 
        
        LinodeBackupsSchedule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinodeBackupsSchedule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinodeBackupsSchedule} obj Optional instance to populate.
     * @return {module:model/LinodeBackupsSchedule} The populated <code>LinodeBackupsSchedule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinodeBackupsSchedule();
    ...
    /**
     * Validates the JSON data with respect to <code>LinodeBackupsSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinodeBackupsSchedule</code>.
     */
 ...
 * @member {module:model/LinodeBackupsSchedule.DayEnum} day
 */
LinodeBackupsSchedule.prototype['day'] = undefined;
 ...
 * @member {module:model/LinodeBackupsSchedule.WindowEnum} window
 */
LinodeBackupsSchedule.prototype['window'] = undefined;
 ...
 * @readonly
 */
LinodeBackupsSchedule['WindowEnum'] = {
...
export default LinodeBackupsSchedule;
