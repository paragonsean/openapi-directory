...
class Region {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resolvers')) {
                obj['resolvers'] = RegionResolvers.constructFromObject(data['resolvers']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['resolvers']) { // data not null
          RegionResolvers.validateJSON(data['resolvers']);
        }
        // ensure the json data is a string
 ...
 */
Region.prototype['capabilities'] = undefined;
 ...
 * @member {String} label
 */
Region.prototype['label'] = undefined;

/**
 * @member {module:model/RegionResolvers} resolvers
 */
Region.prototype['resolvers'] = undefined;

/**
 * This region's current operational status. 
 * @member {module:model/Region.StatusEnum} status
 */
Region.prototype['status'] = undefined;
