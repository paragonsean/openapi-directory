...
import LKEClusterControlPlane from './LKEClusterControlPlane';

/**
 * The LKECluster model module.
 * @module model/LKECluster
 * @version 4.151.1
 */
class LKECluster {
    /**
     * Constructs a new <code>LKECluster</code>.
     * A Kubernetes cluster.
     * @alias module:model/LKECluster
     */
    constructor() { 
        
        LKECluster.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LKECluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LKECluster} obj Optional instance to populate.
     * @return {module:model/LKECluster} The populated <code>LKECluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LKECluster();

            if (data.hasOwnProperty('control_plane')) {
                obj['control_plane'] = LKEClusterControlPlane.constructFromObject(data['control_plane']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LKECluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LKECluster</code>.
     */
    static validateJSON(data) {
        // validate the optional field `control_plane`
        if (data['control_plane']) { // data not null
          LKEClusterControlPlane.validateJSON(data['control_plane']);
        }
...
/**
 * @member {module:model/LKEClusterControlPlane} control_plane
 */
LKECluster.prototype['control_plane'] = undefined;

/**
 * When this Kubernetes cluster was created.
 * @member {Date} created
 */
LKECluster.prototype['created'] = undefined;

/**
 * This Kubernetes cluster's unique ID.
 * @member {Number} id
 */
LKECluster.prototype['id'] = undefined;
 ...
 */
LKECluster.prototype['k8s_version'] = undefined;
 ...
 * @member {String} label
 */
LKECluster.prototype['label'] = undefined;

/**
 * This Kubernetes cluster's location.
 * @member {String} region
 */
LKECluster.prototype['region'] = undefined;

/**
 * An array of tags applied to the Kubernetes cluster. Tags are for organizational purposes only. 
 * @member {Array.<String>} tags
 */
LKECluster.prototype['tags'] = undefined;

/**
 * When this Kubernetes cluster was updated.
 * @member {Date} updated
 */
LKECluster.prototype['updated'] = undefined;
