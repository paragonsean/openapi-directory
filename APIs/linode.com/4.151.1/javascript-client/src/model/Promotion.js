...
class Promotion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('credit_monthly_cap')) {
                obj['credit_monthly_cap'] = ApiClient.convertToType(data['credit_monthly_cap'], 'String');
            }
            if (data.hasOwnProperty('credit_remaining')) {
                obj['credit_remaining'] = ApiClient.convertToType(data['credit_remaining'], 'String');
            }
            if (data.hasOwnProperty('description')) {
                obj['description'] = ApiClient.convertToType(data['description'], 'String');
            }
            if (data.hasOwnProperty('expire_dt')) {
                obj['expire_dt'] = ApiClient.convertToType(data['expire_dt'], 'String');
            }
            ...
            if (data.hasOwnProperty('this_month_credit_remaining')) {
                obj['this_month_credit_remaining'] = ApiClient.convertToType(data['this_month_credit_remaining'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['credit_monthly_cap'] && !(typeof data['credit_monthly_cap'] === 'string' || data['credit_monthly_cap'] instanceof String)) {
            throw new Error("Expected the field `credit_monthly_cap` to be a primitive type in the JSON string but got " + data['credit_monthly_cap']);
        }
        // ensure the json data is a string
        if (data['credit_remaining'] && !(typeof data['credit_remaining'] === 'string' || data['credit_remaining'] instanceof String)) {
            throw new Error("Expected the field `credit_remaining` to be a primitive type in the JSON string but got " + data['credit_remaining']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['expire_dt'] && !(typeof data['expire_dt'] === 'string' || data['expire_dt'] instanceof String)) {
            throw new Error("Expected the field `expire_dt` to be a primitive type in the JSON string but got " + data['expire_dt']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['this_month_credit_remaining'] && !(typeof data['this_month_credit_remaining'] === 'string' || data['this_month_credit_remaining'] instanceof String)) {
            throw new Error("Expected the field `this_month_credit_remaining` to be a primitive type in the JSON string but got " + data['this_month_credit_remaining']);
        }
 ...
 * @member {String} credit_monthly_cap
 */
Promotion.prototype['credit_monthly_cap'] = undefined;

/**
 * The total amount of credit left for this promotion. 
 * @member {String} credit_remaining
 */
Promotion.prototype['credit_remaining'] = undefined;

/**
 * A detailed description of this promotion. 
 * @member {String} description
 */
Promotion.prototype['description'] = undefined;

/**
 * When this promotion's credits expire. 
 * @member {String} expire_dt
 */
Promotion.prototype['expire_dt'] = undefined;
 ...
 * @member {module:model/Promotion.ServiceTypeEnum} service_type
 */
Promotion.prototype['service_type'] = undefined;

/**
 * Short details of this promotion. 
 * @member {String} summary
 */
Promotion.prototype['summary'] = undefined;

/**
 * The amount of credit left for this month for this promotion. 
 * @member {String} this_month_credit_remaining
 */
Promotion.prototype['this_month_credit_remaining'] = undefined;
