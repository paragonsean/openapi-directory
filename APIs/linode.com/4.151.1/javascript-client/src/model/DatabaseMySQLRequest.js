...
/**
 * The DatabaseMySQLRequest model module.
 * @module model/DatabaseMySQLRequest
 * @version 4.151.1
 */
class DatabaseMySQLRequest {
    /**
     * Constructs a new <code>DatabaseMySQLRequest</code>.
     * Managed MySQL Database request object.
     * @alias module:model/DatabaseMySQLRequest
    ...
    constructor(engine, label, region, type) { 
        ...
        DatabaseMySQLRequest.initialize(this, engine, label, region, type);
    }
    ...
    /**
     * Constructs a <code>DatabaseMySQLRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseMySQLRequest} obj Optional instance to populate.
     * @return {module:model/DatabaseMySQLRequest} The populated <code>DatabaseMySQLRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseMySQLRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseMySQLRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseMySQLRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatabaseMySQLRequest.RequiredProperties) {
...
DatabaseMySQLRequest.RequiredProperties = ["engine", "label", "region", "type"];
 ...
 */
DatabaseMySQLRequest.prototype['allow_list'] = undefined;
 ...
 * @member {module:model/DatabaseMySQLRequest.ClusterSizeEnum} cluster_size
 * @default ClusterSizeEnum.1
 */
DatabaseMySQLRequest.prototype['cluster_size'] = ClusterSizeEnum.1;
 ...
 * @default false
 */
DatabaseMySQLRequest.prototype['encrypted'] = false;

/**
 * The Managed Database engine in engine/version format.
 * @member {String} engine
 */
DatabaseMySQLRequest.prototype['engine'] = undefined;

/**
 * A unique, user-defined string referring to the Managed Database.
 * @member {String} label
 */
DatabaseMySQLRequest.prototype['label'] = undefined;

/**
 * The [Region](/docs/api/regions/) ID for the Managed Database.
 * @member {String} region
 */
DatabaseMySQLRequest.prototype['region'] = undefined;
 ...
 * @member {module:model/DatabaseMySQLRequest.ReplicationTypeEnum} replication_type
 */
DatabaseMySQLRequest.prototype['replication_type'] = undefined;
 ...
 * @default true
 */
DatabaseMySQLRequest.prototype['ssl_connection'] = true;

/**
 * The Linode Instance type used by the Managed Database for its nodes.
 * @member {String} type
 */
DatabaseMySQLRequest.prototype['type'] = undefined;
 ...
 * @readonly
 */
DatabaseMySQLRequest['ClusterSizeEnum'] = {
 ...
 * @readonly
 */
DatabaseMySQLRequest['ReplicationTypeEnum'] = {
...
export default DatabaseMySQLRequest;
