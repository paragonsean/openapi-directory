...
import LinodeConfigHelpers from './LinodeConfigHelpers';
import LinodeConfigInterface from './LinodeConfigInterface';

/**
 * The LinodeConfig model module.
 * @module model/LinodeConfig
 * @version 4.151.1
 */
class LinodeConfig {
    /**
     * Constructs a new <code>LinodeConfig</code>.
     * @alias module:model/LinodeConfig
     */
    constructor() { 
        
        LinodeConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinodeConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinodeConfig} obj Optional instance to populate.
     * @return {module:model/LinodeConfig} The populated <code>LinodeConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinodeConfig();

            if (data.hasOwnProperty('comments')) {
                obj['comments'] = ApiClient.convertToType(data['comments'], 'String');
            }
            if (data.hasOwnProperty('devices')) {
                obj['devices'] = Devices.constructFromObject(data['devices']);
            }
            if (data.hasOwnProperty('helpers')) {
                obj['helpers'] = LinodeConfigHelpers.constructFromObject(data['helpers']);
            }
            ...
            if (data.hasOwnProperty('root_device')) {
                obj['root_device'] = ApiClient.convertToType(data['root_device'], 'String');
            }
            if (data.hasOwnProperty('run_level')) {
                obj['run_level'] = ApiClient.convertToType(data['run_level'], 'String');
            }
            if (data.hasOwnProperty('virt_mode')) {
                obj['virt_mode'] = ApiClient.convertToType(data['virt_mode'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LinodeConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinodeConfig</code>.
     */
    static validateJSON(data) {
        ...
        if (data['devices']) { // data not null
          Devices.validateJSON(data['devices']);
        }
        // validate the optional field `helpers`
        if (data['helpers']) { // data not null
          LinodeConfigHelpers.validateJSON(data['helpers']);
        }
        ...
        // ensure the json data is a string
        if (data['root_device'] && !(typeof data['root_device'] === 'string' || data['root_device'] instanceof String)) {
            throw new Error("Expected the field `root_device` to be a primitive type in the JSON string but got " + data['root_device']);
        }
        // ensure the json data is a string
        if (data['run_level'] && !(typeof data['run_level'] === 'string' || data['run_level'] instanceof String)) {
            throw new Error("Expected the field `run_level` to be a primitive type in the JSON string but got " + data['run_level']);
        }
        // ensure the json data is a string
        if (data['virt_mode'] && !(typeof data['virt_mode'] === 'string' || data['virt_mode'] instanceof String)) {
            throw new Error("Expected the field `virt_mode` to be a primitive type in the JSON string but got " + data['virt_mode']);
        }
 ...
 */
LinodeConfig.prototype['comments'] = undefined;

/**
 * @member {module:model/Devices} devices
 */
LinodeConfig.prototype['devices'] = undefined;

/**
 * @member {module:model/LinodeConfigHelpers} helpers
 */
LinodeConfig.prototype['helpers'] = undefined;

/**
 * The ID of this Config.
 * @member {Number} id
 */
LinodeConfig.prototype['id'] = undefined;
 ...
 */
LinodeConfig.prototype['interfaces'] = undefined;

/**
 * A Kernel ID to boot a Linode with. Defaults to \"linode/latest-64bit\".
 * @member {String} kernel
 */
LinodeConfig.prototype['kernel'] = undefined;

/**
 * The Config's label is for display purposes only. 
 * @member {String} label
 */
LinodeConfig.prototype['label'] = undefined;

/**
 * Defaults to the total RAM of the Linode. 
 * @member {Number} memory_limit
 */
LinodeConfig.prototype['memory_limit'] = undefined;
 ...
 * @member {String} root_device
 */
LinodeConfig.prototype['root_device'] = undefined;

/**
 * Defines the state of your Linode after booting. Defaults to `default`. 
 * @member {module:model/LinodeConfig.RunLevelEnum} run_level
 */
LinodeConfig.prototype['run_level'] = undefined;
 ...
 * @member {module:model/LinodeConfig.VirtModeEnum} virt_mode
 */
LinodeConfig.prototype['virt_mode'] = undefined;
...
/**
 * Allowed values for the <code>run_level</code> property.
 * @enum {String}
 * @readonly
 */
LinodeConfig['RunLevelEnum'] = {
...
/**
 * Allowed values for the <code>virt_mode</code> property.
 * @enum {String}
 * @readonly
 */
LinodeConfig['VirtModeEnum'] = {
