...
#include "OAIStatsDataAvailable.h"
...
OAIStatsDataAvailable::OAIStatsDataAvailable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatsDataAvailable::OAIStatsDataAvailable() {
    this->initializeModel();
}

OAIStatsDataAvailable::~OAIStatsDataAvailable() {}

void OAIStatsDataAvailable::initializeModel() {
    ...
    m_net_in_isSet = false;
    m_net_in_isValid = false;

    m_net_out_isSet = false;
    m_net_out_isValid = false;

    m_swap_isSet = false;
    m_swap_isValid = false;
}

void OAIStatsDataAvailable::fromJson(QString jsonString) {
...
void OAIStatsDataAvailable::fromJsonObject(QJsonObject json) {
    ...
    m_net_in_isValid = ::OpenAPI::fromJsonValue(m_net_in, json[QString("net_in")]);
    m_net_in_isSet = !json[QString("net_in")].isNull() && m_net_in_isValid;

    m_net_out_isValid = ::OpenAPI::fromJsonValue(m_net_out, json[QString("net_out")]);
    m_net_out_isSet = !json[QString("net_out")].isNull() && m_net_out_isValid;

    m_swap_isValid = ::OpenAPI::fromJsonValue(m_swap, json[QString("swap")]);
    m_swap_isSet = !json[QString("swap")].isNull() && m_swap_isValid;
}

QString OAIStatsDataAvailable::asJson() const {
...
QJsonObject OAIStatsDataAvailable::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu.size() > 0) {
    ...
    if (m_net_in.size() > 0) {
        obj.insert(QString("net_in"), ::OpenAPI::toJsonValue(m_net_in));
    }
    if (m_net_out.size() > 0) {
        obj.insert(QString("net_out"), ::OpenAPI::toJsonValue(m_net_out));
    }
    if (m_swap.size() > 0) {
        obj.insert(QString("swap"), ::OpenAPI::toJsonValue(m_swap));
    }
    return obj;
}

QList<OAIStatsData> OAIStatsDataAvailable::getCpu() const {
    return m_cpu;
}
void OAIStatsDataAvailable::setCpu(const QList<OAIStatsData> &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIStatsDataAvailable::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIStatsDataAvailable::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QList<OAIStatsData> OAIStatsDataAvailable::getDisk() const {
    return m_disk;
}
void OAIStatsDataAvailable::setDisk(const QList<OAIStatsData> &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIStatsDataAvailable::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIStatsDataAvailable::is_disk_Valid() const{
    return m_disk_isValid;
}

QList<OAIStatsData> OAIStatsDataAvailable::getNetIn() const {
    return m_net_in;
}
void OAIStatsDataAvailable::setNetIn(const QList<OAIStatsData> &net_in) {
    m_net_in = net_in;
    m_net_in_isSet = true;
}

bool OAIStatsDataAvailable::is_net_in_Set() const{
    return m_net_in_isSet;
}

bool OAIStatsDataAvailable::is_net_in_Valid() const{
    return m_net_in_isValid;
}

QList<OAIStatsData> OAIStatsDataAvailable::getNetOut() const {
    return m_net_out;
}
void OAIStatsDataAvailable::setNetOut(const QList<OAIStatsData> &net_out) {
    m_net_out = net_out;
    m_net_out_isSet = true;
}

bool OAIStatsDataAvailable::is_net_out_Set() const{
    return m_net_out_isSet;
}

bool OAIStatsDataAvailable::is_net_out_Valid() const{
    return m_net_out_isValid;
}

QList<OAIStatsData> OAIStatsDataAvailable::getSwap() const {
    return m_swap;
}
void OAIStatsDataAvailable::setSwap(const QList<OAIStatsData> &swap) {
    m_swap = swap;
    m_swap_isSet = true;
}

bool OAIStatsDataAvailable::is_swap_Set() const{
    return m_swap_isSet;
}

bool OAIStatsDataAvailable::is_swap_Valid() const{
    return m_swap_isValid;
}

bool OAIStatsDataAvailable::isSet() const {
...
bool OAIStatsDataAvailable::isValid() const {
