...
OAILinode_alerts::OAILinode_alerts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinode_alerts::OAILinode_alerts() {
    this->initializeModel();
}

OAILinode_alerts::~OAILinode_alerts() {}

void OAILinode_alerts::initializeModel() {
    ...
    m_network_in_isSet = false;
    m_network_in_isValid = false;

    m_network_out_isSet = false;
    m_network_out_isValid = false;

    m_transfer_quota_isSet = false;
    m_transfer_quota_isValid = false;
}

void OAILinode_alerts::fromJson(QString jsonString) {
...
void OAILinode_alerts::fromJsonObject(QJsonObject json) {

    m_cpu_isValid = ::OpenAPI::fromJsonValue(m_cpu, json[QString("cpu")]);
    m_cpu_isSet = !json[QString("cpu")].isNull() && m_cpu_isValid;

    m_io_isValid = ::OpenAPI::fromJsonValue(m_io, json[QString("io")]);
    m_io_isSet = !json[QString("io")].isNull() && m_io_isValid;

    m_network_in_isValid = ::OpenAPI::fromJsonValue(m_network_in, json[QString("network_in")]);
    m_network_in_isSet = !json[QString("network_in")].isNull() && m_network_in_isValid;
    ...
    m_transfer_quota_isValid = ::OpenAPI::fromJsonValue(m_transfer_quota, json[QString("transfer_quota")]);
    m_transfer_quota_isSet = !json[QString("transfer_quota")].isNull() && m_transfer_quota_isValid;
}

QString OAILinode_alerts::asJson() const {
...
QJsonObject OAILinode_alerts::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu_isSet) {
        obj.insert(QString("cpu"), ::OpenAPI::toJsonValue(m_cpu));
    }
    if (m_io_isSet) {
        obj.insert(QString("io"), ::OpenAPI::toJsonValue(m_io));
    }
    if (m_network_in_isSet) {
        obj.insert(QString("network_in"), ::OpenAPI::toJsonValue(m_network_in));
    }
    if (m_network_out_isSet) {
        obj.insert(QString("network_out"), ::OpenAPI::toJsonValue(m_network_out));
    }
    if (m_transfer_quota_isSet) {
        obj.insert(QString("transfer_quota"), ::OpenAPI::toJsonValue(m_transfer_quota));
    }
    return obj;
}

qint32 OAILinode_alerts::getCpu() const {
    return m_cpu;
}
void OAILinode_alerts::setCpu(const qint32 &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAILinode_alerts::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAILinode_alerts::is_cpu_Valid() const{
    return m_cpu_isValid;
}

qint32 OAILinode_alerts::getIo() const {
    return m_io;
}
void OAILinode_alerts::setIo(const qint32 &io) {
    m_io = io;
    m_io_isSet = true;
}

bool OAILinode_alerts::is_io_Set() const{
    return m_io_isSet;
}

bool OAILinode_alerts::is_io_Valid() const{
    return m_io_isValid;
}

qint32 OAILinode_alerts::getNetworkIn() const {
    return m_network_in;
}
void OAILinode_alerts::setNetworkIn(const qint32 &network_in) {
    m_network_in = network_in;
    m_network_in_isSet = true;
}

bool OAILinode_alerts::is_network_in_Set() const{
    return m_network_in_isSet;
}

bool OAILinode_alerts::is_network_in_Valid() const{
    return m_network_in_isValid;
}

qint32 OAILinode_alerts::getNetworkOut() const {
    return m_network_out;
}
void OAILinode_alerts::setNetworkOut(const qint32 &network_out) {
    m_network_out = network_out;
    m_network_out_isSet = true;
}

bool OAILinode_alerts::is_network_out_Set() const{
    return m_network_out_isSet;
}

bool OAILinode_alerts::is_network_out_Valid() const{
    return m_network_out_isValid;
}

qint32 OAILinode_alerts::getTransferQuota() const {
    return m_transfer_quota;
}
void OAILinode_alerts::setTransferQuota(const qint32 &transfer_quota) {
    m_transfer_quota = transfer_quota;
    m_transfer_quota_isSet = true;
}

bool OAILinode_alerts::is_transfer_quota_Set() const{
    return m_transfer_quota_isSet;
}

bool OAILinode_alerts::is_transfer_quota_Valid() const{
    return m_transfer_quota_isValid;
}

bool OAILinode_alerts::isSet() const {
...
bool OAILinode_alerts::isValid() const {
