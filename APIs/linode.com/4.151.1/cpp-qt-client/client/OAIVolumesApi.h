...
#include "OAICloneVolume_request.h"
#include "OAICreateVolume_request.h"
#include "OAIGetAccount_default_response.h"
#include "OAIGetLinodeVolumes_200_response.h"
#include "OAIObject.h"
#include "OAIResizeVolume_request.h"
...
public:
    ...
    /**
    * @param[in]  volume_id qint32 [required]
    * @param[in]  oai_attach_volume_request OAIAttachVolume_request [required]
    */
    virtual void attachVolume(const qint32 &volume_id, const OAIAttachVolume_request &oai_attach_volume_request);

    /**
    * @param[in]  volume_id qint32 [required]
    * @param[in]  oai_clone_volume_request OAICloneVolume_request [required]
    */
    virtual void cloneVolume(const qint32 &volume_id, const OAICloneVolume_request &oai_clone_volume_request);

    /**
    * @param[in]  oai_create_volume_request OAICreateVolume_request [required]
    */
    virtual void createVolume(const OAICreateVolume_request &oai_create_volume_request);

    /**
    * @param[in]  volume_id qint32 [required]
    */
    virtual void deleteVolume(const qint32 &volume_id);

    /**
    * @param[in]  volume_id qint32 [required]
    */
    virtual void detachVolume(const qint32 &volume_id);
    ...
    */
    virtual void getVolume(const qint32 &volume_id, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getVolumes(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  volume_id qint32 [required]
    * @param[in]  oai_resize_volume_request OAIResizeVolume_request [required]
    */
    virtual void resizeVolume(const qint32 &volume_id, const OAIResizeVolume_request &oai_resize_volume_request);

    /**
    * @param[in]  volume_id qint32 [required]
    * @param[in]  oai_update_volume_request OAIUpdateVolume_request [required]
    */
    virtual void updateVolume(const qint32 &volume_id, const OAIUpdateVolume_request &oai_update_volume_request);
...
private:
    ...
    void cloneVolumeCallback(OAIHttpRequestWorker *worker);
    ...
    void getVolumeCallback(OAIHttpRequestWorker *worker);
    void getVolumesCallback(OAIHttpRequestWorker *worker);
    void resizeVolumeCallback(OAIHttpRequestWorker *worker);
    void updateVolumeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void attachVolumeSignal(OAIVolume summary);
    void cloneVolumeSignal(OAIVolume summary);
    void createVolumeSignal(OAIVolume summary);
    void deleteVolumeSignal(OAIObject summary);
    void detachVolumeSignal(OAIObject summary);
    void getVolumeSignal(OAIVolume summary);
    void getVolumesSignal(OAIGetLinodeVolumes_200_response summary);
    void resizeVolumeSignal(OAIVolume summary);
    void updateVolumeSignal(OAIVolume summary);


    void attachVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);
    void cloneVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);
    void createVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);
    void deleteVolumeSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void detachVolumeSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);
    void getVolumesSignalFull(OAIHttpRequestWorker *worker, OAIGetLinodeVolumes_200_response summary);
    void resizeVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);
    void updateVolumeSignalFull(OAIHttpRequestWorker *worker, OAIVolume summary);

    Q_DECL_DEPRECATED_X("Use attachVolumeSignalError() instead")
    void attachVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void attachVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use cloneVolumeSignalError() instead")
    void cloneVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void cloneVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createVolumeSignalError() instead")
    void createVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteVolumeSignalError() instead")
    void deleteVolumeSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteVolumeSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use detachVolumeSignalError() instead")
    void detachVolumeSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void detachVolumeSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getVolumeSignalError() instead")
    void getVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getVolumesSignalError() instead")
    void getVolumesSignalE(OAIGetLinodeVolumes_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getVolumesSignalError(OAIGetLinodeVolumes_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use resizeVolumeSignalError() instead")
    void resizeVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resizeVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateVolumeSignalError() instead")
    void updateVolumeSignalE(OAIVolume summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateVolumeSignalError(OAIVolume summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use cloneVolumeSignalErrorFull() instead")
    void cloneVolumeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void cloneVolumeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getVolumeSignalErrorFull() instead")
    void getVolumeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getVolumeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getVolumesSignalErrorFull() instead")
    void getVolumesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getVolumesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use resizeVolumeSignalErrorFull() instead")
    void resizeVolumeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resizeVolumeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
