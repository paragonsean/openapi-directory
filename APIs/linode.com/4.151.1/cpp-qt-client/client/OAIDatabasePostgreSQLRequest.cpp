...
OAIDatabasePostgreSQLRequest::OAIDatabasePostgreSQLRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabasePostgreSQLRequest::OAIDatabasePostgreSQLRequest() {
    this->initializeModel();
}

OAIDatabasePostgreSQLRequest::~OAIDatabasePostgreSQLRequest() {}

void OAIDatabasePostgreSQLRequest::initializeModel() {
...
void OAIDatabasePostgreSQLRequest::fromJson(QString jsonString) {
...
void OAIDatabasePostgreSQLRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDatabasePostgreSQLRequest::asJson() const {
...
QJsonObject OAIDatabasePostgreSQLRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDatabasePostgreSQLRequest::getAllowList() const {
    return m_allow_list;
}
void OAIDatabasePostgreSQLRequest::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabasePostgreSQLRequest::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabasePostgreSQLRequest::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

bool OAIDatabasePostgreSQLRequest::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabasePostgreSQLRequest::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabasePostgreSQLRequest::getEngine() const {
    return m_engine;
}
void OAIDatabasePostgreSQLRequest::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIDatabasePostgreSQLRequest::getLabel() const {
    return m_label;
}
void OAIDatabasePostgreSQLRequest::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDatabasePostgreSQLRequest::getRegion() const {
    return m_region;
}
void OAIDatabasePostgreSQLRequest::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabasePostgreSQLRequest::getReplicationCommitType() const {
    return m_replication_commit_type;
}
void OAIDatabasePostgreSQLRequest::setReplicationCommitType(const QString &replication_commit_type) {
    m_replication_commit_type = replication_commit_type;
    m_replication_commit_type_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_replication_commit_type_Set() const{
    return m_replication_commit_type_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_replication_commit_type_Valid() const{
    return m_replication_commit_type_isValid;
}

QString OAIDatabasePostgreSQLRequest::getReplicationType() const {
    return m_replication_type;
}
void OAIDatabasePostgreSQLRequest::setReplicationType(const QString &replication_type) {
    m_replication_type = replication_type;
    m_replication_type_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_replication_type_Set() const{
    return m_replication_type_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_replication_type_Valid() const{
    return m_replication_type_isValid;
}

bool OAIDatabasePostgreSQLRequest::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabasePostgreSQLRequest::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabasePostgreSQLRequest::getType() const {
    return m_type;
}
void OAIDatabasePostgreSQLRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabasePostgreSQLRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabasePostgreSQLRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDatabasePostgreSQLRequest::isSet() const {
...
bool OAIDatabasePostgreSQLRequest::isValid() const {
