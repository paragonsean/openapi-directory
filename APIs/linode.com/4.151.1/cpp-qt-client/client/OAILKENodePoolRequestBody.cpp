...
OAILKENodePoolRequestBody::OAILKENodePoolRequestBody(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILKENodePoolRequestBody::OAILKENodePoolRequestBody() {
    this->initializeModel();
}

OAILKENodePoolRequestBody::~OAILKENodePoolRequestBody() {}

void OAILKENodePoolRequestBody::initializeModel() {

    m_autoscaler_isSet = false;
    m_autoscaler_isValid = false;
...
void OAILKENodePoolRequestBody::fromJson(QString jsonString) {
...
void OAILKENodePoolRequestBody::fromJsonObject(QJsonObject json) {

    m_autoscaler_isValid = ::OpenAPI::fromJsonValue(m_autoscaler, json[QString("autoscaler")]);
    m_autoscaler_isSet = !json[QString("autoscaler")].isNull() && m_autoscaler_isValid;
...
QString OAILKENodePoolRequestBody::asJson() const {
...
QJsonObject OAILKENodePoolRequestBody::asJsonObject() const {
    QJsonObject obj;
    if (m_autoscaler.isSet()) {
        obj.insert(QString("autoscaler"), ::OpenAPI::toJsonValue(m_autoscaler));
    }
    if (m_count_isSet) {
...
OAILKENodePoolRequestBody_autoscaler OAILKENodePoolRequestBody::getAutoscaler() const {
    return m_autoscaler;
}
void OAILKENodePoolRequestBody::setAutoscaler(const OAILKENodePoolRequestBody_autoscaler &autoscaler) {
    m_autoscaler = autoscaler;
    m_autoscaler_isSet = true;
}

bool OAILKENodePoolRequestBody::is_autoscaler_Set() const{
    return m_autoscaler_isSet;
}

bool OAILKENodePoolRequestBody::is_autoscaler_Valid() const{
    return m_autoscaler_isValid;
}

qint32 OAILKENodePoolRequestBody::getCount() const {
    return m_count;
}
void OAILKENodePoolRequestBody::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAILKENodePoolRequestBody::is_count_Set() const{
    return m_count_isSet;
}

bool OAILKENodePoolRequestBody::is_count_Valid() const{
    return m_count_isValid;
}

QList<OAIItems> OAILKENodePoolRequestBody::getDisks() const {
    return m_disks;
}
void OAILKENodePoolRequestBody::setDisks(const QList<OAIItems> &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAILKENodePoolRequestBody::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAILKENodePoolRequestBody::is_disks_Valid() const{
    return m_disks_isValid;
}

QList<QString> OAILKENodePoolRequestBody::getTags() const {
    return m_tags;
}
void OAILKENodePoolRequestBody::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILKENodePoolRequestBody::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILKENodePoolRequestBody::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAILKENodePoolRequestBody::getType() const {
    return m_type;
}
void OAILKENodePoolRequestBody::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILKENodePoolRequestBody::is_type_Set() const{
    return m_type_isSet;
}

bool OAILKENodePoolRequestBody::is_type_Valid() const{
    return m_type_isValid;
}

bool OAILKENodePoolRequestBody::isSet() const {
...
bool OAILKENodePoolRequestBody::isValid() const {
