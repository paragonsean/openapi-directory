...
void OAISupportTicket::initializeModel() {
    ...
    m_opened_by_isSet = false;
    m_opened_by_isValid = false;
...
void OAISupportTicket::fromJsonObject(QJsonObject json) {
    ...
    m_closable_isValid = ::OpenAPI::fromJsonValue(m_closable, json[QString("closable")]);
    m_closable_isSet = !json[QString("closable")].isNull() && m_closable_isValid;
    ...
    m_opened_by_isValid = ::OpenAPI::fromJsonValue(m_opened_by, json[QString("opened_by")]);
    m_opened_by_isSet = !json[QString("opened_by")].isNull() && m_opened_by_isValid;
...
QJsonObject OAISupportTicket::asJsonObject() const {
    ...
    if (m_closable_isSet) {
        obj.insert(QString("closable"), ::OpenAPI::toJsonValue(m_closable));
    }
    if (m_closed_isSet) {
    ...
    if (m_opened_by_isSet) {
        obj.insert(QString("opened_by"), ::OpenAPI::toJsonValue(m_opened_by));
    }
    if (m_status_isSet) {
...
QList<QString> OAISupportTicket::getAttachments() const {
    return m_attachments;
}
void OAISupportTicket::setAttachments(const QList<QString> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAISupportTicket::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAISupportTicket::is_attachments_Valid() const{
    return m_attachments_isValid;
}

bool OAISupportTicket::isClosable() const {
    return m_closable;
}
void OAISupportTicket::setClosable(const bool &closable) {
    m_closable = closable;
    m_closable_isSet = true;
}

bool OAISupportTicket::is_closable_Set() const{
    return m_closable_isSet;
}

bool OAISupportTicket::is_closable_Valid() const{
    return m_closable_isValid;
}

QDateTime OAISupportTicket::getClosed() const {
    return m_closed;
}
void OAISupportTicket::setClosed(const QDateTime &closed) {
    m_closed = closed;
    m_closed_isSet = true;
}

bool OAISupportTicket::is_closed_Set() const{
    return m_closed_isSet;
}

bool OAISupportTicket::is_closed_Valid() const{
    return m_closed_isValid;
}

QString OAISupportTicket::getDescription() const {
    return m_description;
}
void OAISupportTicket::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISupportTicket::is_description_Set() const{
    return m_description_isSet;
}

bool OAISupportTicket::is_description_Valid() const{
    return m_description_isValid;
}

OAISupportTicket_entity OAISupportTicket::getEntity() const {
    return m_entity;
}
void OAISupportTicket::setEntity(const OAISupportTicket_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAISupportTicket::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAISupportTicket::is_entity_Valid() const{
    return m_entity_isValid;
}

QString OAISupportTicket::getGravatarId() const {
    return m_gravatar_id;
}
void OAISupportTicket::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAISupportTicket::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAISupportTicket::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

qint32 OAISupportTicket::getId() const {
    return m_id;
}
void OAISupportTicket::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISupportTicket::is_id_Set() const{
    return m_id_isSet;
}

bool OAISupportTicket::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAISupportTicket::getOpened() const {
    return m_opened;
}
void OAISupportTicket::setOpened(const QDateTime &opened) {
    m_opened = opened;
    m_opened_isSet = true;
}

bool OAISupportTicket::is_opened_Set() const{
    return m_opened_isSet;
}

bool OAISupportTicket::is_opened_Valid() const{
    return m_opened_isValid;
}

QString OAISupportTicket::getOpenedBy() const {
    return m_opened_by;
}
void OAISupportTicket::setOpenedBy(const QString &opened_by) {
    m_opened_by = opened_by;
    m_opened_by_isSet = true;
}

bool OAISupportTicket::is_opened_by_Set() const{
    return m_opened_by_isSet;
}

bool OAISupportTicket::is_opened_by_Valid() const{
    return m_opened_by_isValid;
}

QString OAISupportTicket::getStatus() const {
    return m_status;
}
void OAISupportTicket::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISupportTicket::is_status_Set() const{
    return m_status_isSet;
}

bool OAISupportTicket::is_status_Valid() const{
    return m_status_isValid;
}

QString OAISupportTicket::getSummary() const {
    return m_summary;
}
void OAISupportTicket::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAISupportTicket::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAISupportTicket::is_summary_Valid() const{
    return m_summary_isValid;
}

QDateTime OAISupportTicket::getUpdated() const {
    return m_updated;
}
void OAISupportTicket::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAISupportTicket::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAISupportTicket::is_updated_Valid() const{
    return m_updated_isValid;
}

QString OAISupportTicket::getUpdatedBy() const {
    return m_updated_by;
}
void OAISupportTicket::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAISupportTicket::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAISupportTicket::is_updated_by_Valid() const{
