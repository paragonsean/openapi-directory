...
OAILinodeType::OAILinodeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeType::OAILinodeType() {
    this->initializeModel();
}

OAILinodeType::~OAILinodeType() {}

void OAILinodeType::initializeModel() {
    ...
    m_network_out_isSet = false;
    m_network_out_isValid = false;

    m_price_isSet = false;
    m_price_isValid = false;

    m_successor_isSet = false;
    m_successor_isValid = false;
...
void OAILinodeType::fromJson(QString jsonString) {
...
void OAILinodeType::fromJsonObject(QJsonObject json) {
    ...
    m_network_out_isValid = ::OpenAPI::fromJsonValue(m_network_out, json[QString("network_out")]);
    m_network_out_isSet = !json[QString("network_out")].isNull() && m_network_out_isValid;

    m_price_isValid = ::OpenAPI::fromJsonValue(m_price, json[QString("price")]);
    m_price_isSet = !json[QString("price")].isNull() && m_price_isValid;

    m_successor_isValid = ::OpenAPI::fromJsonValue(m_successor, json[QString("successor")]);
    m_successor_isSet = !json[QString("successor")].isNull() && m_successor_isValid;
...
QString OAILinodeType::asJson() const {
...
QJsonObject OAILinodeType::asJsonObject() const {
    QJsonObject obj;
    if (m_addons.isSet()) {
    ...
    if (m_network_out_isSet) {
        obj.insert(QString("network_out"), ::OpenAPI::toJsonValue(m_network_out));
    }
    if (m_price.isSet()) {
        obj.insert(QString("price"), ::OpenAPI::toJsonValue(m_price));
    }
    if (m_successor_isSet) {
        obj.insert(QString("successor"), ::OpenAPI::toJsonValue(m_successor));
    }
    if (m_transfer_isSet) {
...
OAILinodeType_addons OAILinodeType::getAddons() const {
    return m_addons;
}
void OAILinodeType::setAddons(const OAILinodeType_addons &addons) {
    m_addons = addons;
    m_addons_isSet = true;
}

bool OAILinodeType::is_addons_Set() const{
    return m_addons_isSet;
}

bool OAILinodeType::is_addons_Valid() const{
    return m_addons_isValid;
}

QString OAILinodeType::getRClass() const {
    return m_r_class;
}
void OAILinodeType::setRClass(const QString &r_class) {
    m_r_class = r_class;
    m_r_class_isSet = true;
}

bool OAILinodeType::is_r_class_Set() const{
    return m_r_class_isSet;
}

bool OAILinodeType::is_r_class_Valid() const{
    return m_r_class_isValid;
}

qint32 OAILinodeType::getDisk() const {
    return m_disk;
}
void OAILinodeType::setDisk(const qint32 &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAILinodeType::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAILinodeType::is_disk_Valid() const{
    return m_disk_isValid;
}

qint32 OAILinodeType::getGpus() const {
    return m_gpus;
}
void OAILinodeType::setGpus(const qint32 &gpus) {
    m_gpus = gpus;
    m_gpus_isSet = true;
}

bool OAILinodeType::is_gpus_Set() const{
    return m_gpus_isSet;
}

bool OAILinodeType::is_gpus_Valid() const{
    return m_gpus_isValid;
}

QString OAILinodeType::getId() const {
    return m_id;
}
void OAILinodeType::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILinodeType::is_id_Set() const{
    return m_id_isSet;
}

bool OAILinodeType::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILinodeType::getLabel() const {
    return m_label;
}
void OAILinodeType::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILinodeType::is_label_Set() const{
    return m_label_isSet;
}

bool OAILinodeType::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAILinodeType::getMemory() const {
    return m_memory;
}
void OAILinodeType::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAILinodeType::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAILinodeType::is_memory_Valid() const{
    return m_memory_isValid;
}

qint32 OAILinodeType::getNetworkOut() const {
    return m_network_out;
}
void OAILinodeType::setNetworkOut(const qint32 &network_out) {
    m_network_out = network_out;
    m_network_out_isSet = true;
}

bool OAILinodeType::is_network_out_Set() const{
    return m_network_out_isSet;
}

bool OAILinodeType::is_network_out_Valid() const{
    return m_network_out_isValid;
}

OAILinodeType_price OAILinodeType::getPrice() const {
    return m_price;
}
void OAILinodeType::setPrice(const OAILinodeType_price &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAILinodeType::is_price_Set() const{
    return m_price_isSet;
}

bool OAILinodeType::is_price_Valid() const{
    return m_price_isValid;
}

QString OAILinodeType::getSuccessor() const {
    return m_successor;
}
void OAILinodeType::setSuccessor(const QString &successor) {
    m_successor = successor;
    m_successor_isSet = true;
}

bool OAILinodeType::is_successor_Set() const{
    return m_successor_isSet;
}

bool OAILinodeType::is_successor_Valid() const{
    return m_successor_isValid;
}

qint32 OAILinodeType::getTransfer() const {
    return m_transfer;
}
void OAILinodeType::setTransfer(const qint32 &transfer) {
    m_transfer = transfer;
    m_transfer_isSet = true;
}

bool OAILinodeType::is_transfer_Set() const{
    return m_transfer_isSet;
}

bool OAILinodeType::is_transfer_Valid() const{
    return m_transfer_isValid;
}

qint32 OAILinodeType::getVcpus() const {
    return m_vcpus;
}
void OAILinodeType::setVcpus(const qint32 &vcpus) {
    m_vcpus = vcpus;
    m_vcpus_isSet = true;
}

bool OAILinodeType::is_vcpus_Set() const{
    return m_vcpus_isSet;
}

bool OAILinodeType::is_vcpus_Valid() const{
    return m_vcpus_isValid;
}

bool OAILinodeType::isSet() const {
...
bool OAILinodeType::isValid() const {
