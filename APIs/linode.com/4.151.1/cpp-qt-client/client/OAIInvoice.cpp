...
void OAIInvoice::initializeModel() {
    ...
    m_tax_summary_isSet = false;
    m_tax_summary_isValid = false;
...
void OAIInvoice::fromJsonObject(QJsonObject json) {
    ...
    m_tax_summary_isValid = ::OpenAPI::fromJsonValue(m_tax_summary, json[QString("tax_summary")]);
    m_tax_summary_isSet = !json[QString("tax_summary")].isNull() && m_tax_summary_isValid;
...
QJsonObject OAIInvoice::asJsonObject() const {
    ...
    if (m_tax_summary.size() > 0) {
        obj.insert(QString("tax_summary"), ::OpenAPI::toJsonValue(m_tax_summary));
    }
    if (m_total_isSet) {
...
QDateTime OAIInvoice::getDate() const {
    return m_date;
}
void OAIInvoice::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}
...
QString OAIInvoice::getLabel() const {
    return m_label;
}
void OAIInvoice::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIInvoice::is_label_Set() const{
    return m_label_isSet;
}

bool OAIInvoice::is_label_Valid() const{
...
void OAIInvoice::setSubtotal(const double &subtotal) {
    m_subtotal = subtotal;
...
double OAIInvoice::getTax() const {
    return m_tax;
}
void OAIInvoice::setTax(const double &tax) {
    m_tax = tax;
    m_tax_isSet = true;
}
...
QList<OAIInvoice_tax_summary_inner> OAIInvoice::getTaxSummary() const {
    return m_tax_summary;
}
void OAIInvoice::setTaxSummary(const QList<OAIInvoice_tax_summary_inner> &tax_summary) {
    m_tax_summary = tax_summary;
    m_tax_summary_isSet = true;
}

bool OAIInvoice::is_tax_summary_Set() const{
    return m_tax_summary_isSet;
}

bool OAIInvoice::is_tax_summary_Valid() const{
    return m_tax_summary_isValid;
}
