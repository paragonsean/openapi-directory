...
/*
 * OAICreateLinodeInstance_request.h
 *
 * 
 */

#ifndef OAICreateLinodeInstance_request_H
#define OAICreateLinodeInstance_request_H
...
namespace OpenAPI {
class OAILinodeConfigInterface;

class OAICreateLinodeInstance_request : public OAIObject {
public:
    OAICreateLinodeInstance_request();
    OAICreateLinodeInstance_request(QString json);
    ~OAICreateLinodeInstance_request() override;
    ...
    QList<QString> getAuthorizedKeys() const;
    void setAuthorizedKeys(const QList<QString> &authorized_keys);
    bool is_authorized_keys_Set() const;
    bool is_authorized_keys_Valid() const;

    QList<QString> getAuthorizedUsers() const;
    void setAuthorizedUsers(const QList<QString> &authorized_users);
    bool is_authorized_users_Set() const;
    bool is_authorized_users_Valid() const;

    bool isBooted() const;
    void setBooted(const bool &booted);
    bool is_booted_Set() const;
    bool is_booted_Valid() const;
    ...
    void setRootPass(const QString &root_pass);
    bool is_root_pass_Set() const;
    bool is_root_pass_Valid() const;

    OAIObject getStackscriptData() const;
    void setStackscriptData(const OAIObject &stackscript_data);
    bool is_stackscript_data_Set() const;
    bool is_stackscript_data_Valid() const;

    qint32 getStackscriptId() const;
    void setStackscriptId(const qint32 &stackscript_id);
    bool is_stackscript_id_Set() const;
    bool is_stackscript_id_Valid() const;
    ...
    bool isBackupsEnabled() const;
    void setBackupsEnabled(const bool &backups_enabled);
    bool is_backups_enabled_Set() const;
    bool is_backups_enabled_Valid() const;

    Q_DECL_DEPRECATED QString getGroup() const;
    Q_DECL_DEPRECATED void setGroup(const QString &group);
    Q_DECL_DEPRECATED bool is_group_Set() const;
    Q_DECL_DEPRECATED bool is_group_Valid() const;

    QList<OAILinodeConfigInterface> getInterfaces() const;
    void setInterfaces(const QList<OAILinodeConfigInterface> &interfaces);
    ...
    void setPrivateIp(const bool &private_ip);
    ...
    qint32 getSwapSize() const;
    void setSwapSize(const qint32 &swap_size);
    bool is_swap_size_Set() const;
    bool is_swap_size_Valid() const;
...
private:
    ...
    QList<QString> m_authorized_keys;
    bool m_authorized_keys_isSet;
    bool m_authorized_keys_isValid;

    QList<QString> m_authorized_users;
    bool m_authorized_users_isSet;
    bool m_authorized_users_isValid;

    bool m_booted;
    bool m_booted_isSet;
    bool m_booted_isValid;
    ...
    QString m_root_pass;
    bool m_root_pass_isSet;
    bool m_root_pass_isValid;

    OAIObject m_stackscript_data;
    bool m_stackscript_data_isSet;
    bool m_stackscript_data_isValid;

    qint32 m_stackscript_id;
    bool m_stackscript_id_isSet;
    bool m_stackscript_id_isValid;
    ...
    bool m_backups_enabled_isSet;
    bool m_backups_enabled_isValid;

    QString m_group;
    bool m_group_isSet;
    bool m_group_isValid;

    QList<OAILinodeConfigInterface> m_interfaces;
    ...
    qint32 m_swap_size;
    bool m_swap_size_isSet;
    bool m_swap_size_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLinodeInstance_request)

#endif // OAICreateLinodeInstance_request_H
