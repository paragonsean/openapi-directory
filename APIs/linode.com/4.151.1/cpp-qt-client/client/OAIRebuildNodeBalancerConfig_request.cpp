...
#include "OAIRebuildNodeBalancerConfig_request.h"
...
OAIRebuildNodeBalancerConfig_request::OAIRebuildNodeBalancerConfig_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRebuildNodeBalancerConfig_request::OAIRebuildNodeBalancerConfig_request() {
    this->initializeModel();
}

OAIRebuildNodeBalancerConfig_request::~OAIRebuildNodeBalancerConfig_request() {}

void OAIRebuildNodeBalancerConfig_request::initializeModel() {
    ...
    m_nodebalancer_id_isSet = false;
    m_nodebalancer_id_isValid = false;

    m_nodes_status_isSet = false;
    m_nodes_status_isValid = false;
    ...
    m_ssl_commonname_isSet = false;
    m_ssl_commonname_isValid = false;

    m_ssl_fingerprint_isSet = false;
    m_ssl_fingerprint_isValid = false;
...
void OAIRebuildNodeBalancerConfig_request::fromJson(QString jsonString) {
...
void OAIRebuildNodeBalancerConfig_request::fromJsonObject(QJsonObject json) {
    ...
    m_nodebalancer_id_isValid = ::OpenAPI::fromJsonValue(m_nodebalancer_id, json[QString("nodebalancer_id")]);
    m_nodebalancer_id_isSet = !json[QString("nodebalancer_id")].isNull() && m_nodebalancer_id_isValid;

    m_nodes_status_isValid = ::OpenAPI::fromJsonValue(m_nodes_status, json[QString("nodes_status")]);
    m_nodes_status_isSet = !json[QString("nodes_status")].isNull() && m_nodes_status_isValid;
    ...
    m_ssl_commonname_isValid = ::OpenAPI::fromJsonValue(m_ssl_commonname, json[QString("ssl_commonname")]);
    m_ssl_commonname_isSet = !json[QString("ssl_commonname")].isNull() && m_ssl_commonname_isValid;

    m_ssl_fingerprint_isValid = ::OpenAPI::fromJsonValue(m_ssl_fingerprint, json[QString("ssl_fingerprint")]);
    m_ssl_fingerprint_isSet = !json[QString("ssl_fingerprint")].isNull() && m_ssl_fingerprint_isValid;
...
QString OAIRebuildNodeBalancerConfig_request::asJson() const {
...
QJsonObject OAIRebuildNodeBalancerConfig_request::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_nodebalancer_id_isSet) {
        obj.insert(QString("nodebalancer_id"), ::OpenAPI::toJsonValue(m_nodebalancer_id));
    }
    if (m_nodes_status.isSet()) {
        obj.insert(QString("nodes_status"), ::OpenAPI::toJsonValue(m_nodes_status));
    }
    if (m_port_isSet) {
    ...
    if (m_ssl_commonname_isSet) {
        obj.insert(QString("ssl_commonname"), ::OpenAPI::toJsonValue(m_ssl_commonname));
    }
    if (m_ssl_fingerprint_isSet) {
        obj.insert(QString("ssl_fingerprint"), ::OpenAPI::toJsonValue(m_ssl_fingerprint));
    }
    if (m_ssl_key_isSet) {
...
QString OAIRebuildNodeBalancerConfig_request::getAlgorithm() const {
    return m_algorithm;
}
void OAIRebuildNodeBalancerConfig_request::setAlgorithm(const QString &algorithm) {
    m_algorithm = algorithm;
    m_algorithm_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_algorithm_Set() const{
    return m_algorithm_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_algorithm_Valid() const{
    return m_algorithm_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getCheck() const {
    return m_check;
}
void OAIRebuildNodeBalancerConfig_request::setCheck(const QString &check) {
    m_check = check;
    m_check_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_Set() const{
    return m_check_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_Valid() const{
    return m_check_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getCheckAttempts() const {
    return m_check_attempts;
}
void OAIRebuildNodeBalancerConfig_request::setCheckAttempts(const qint32 &check_attempts) {
    m_check_attempts = check_attempts;
    m_check_attempts_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_attempts_Set() const{
    return m_check_attempts_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_attempts_Valid() const{
    return m_check_attempts_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getCheckBody() const {
    return m_check_body;
}
void OAIRebuildNodeBalancerConfig_request::setCheckBody(const QString &check_body) {
    m_check_body = check_body;
    m_check_body_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_body_Set() const{
    return m_check_body_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_body_Valid() const{
    return m_check_body_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getCheckInterval() const {
    return m_check_interval;
}
void OAIRebuildNodeBalancerConfig_request::setCheckInterval(const qint32 &check_interval) {
    m_check_interval = check_interval;
    m_check_interval_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_interval_Set() const{
    return m_check_interval_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_interval_Valid() const{
    return m_check_interval_isValid;
}

bool OAIRebuildNodeBalancerConfig_request::isCheckPassive() const {
    return m_check_passive;
}
void OAIRebuildNodeBalancerConfig_request::setCheckPassive(const bool &check_passive) {
    m_check_passive = check_passive;
    m_check_passive_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_passive_Set() const{
    return m_check_passive_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_passive_Valid() const{
    return m_check_passive_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getCheckPath() const {
    return m_check_path;
}
void OAIRebuildNodeBalancerConfig_request::setCheckPath(const QString &check_path) {
    m_check_path = check_path;
    m_check_path_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_path_Set() const{
    return m_check_path_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_path_Valid() const{
    return m_check_path_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getCheckTimeout() const {
    return m_check_timeout;
}
void OAIRebuildNodeBalancerConfig_request::setCheckTimeout(const qint32 &check_timeout) {
    m_check_timeout = check_timeout;
    m_check_timeout_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_timeout_Set() const{
    return m_check_timeout_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_check_timeout_Valid() const{
    return m_check_timeout_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getCipherSuite() const {
    return m_cipher_suite;
}
void OAIRebuildNodeBalancerConfig_request::setCipherSuite(const QString &cipher_suite) {
    m_cipher_suite = cipher_suite;
    m_cipher_suite_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_cipher_suite_Set() const{
    return m_cipher_suite_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_cipher_suite_Valid() const{
    return m_cipher_suite_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getId() const {
    return m_id;
}
void OAIRebuildNodeBalancerConfig_request::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getNodebalancerId() const {
    return m_nodebalancer_id;
}
void OAIRebuildNodeBalancerConfig_request::setNodebalancerId(const qint32 &nodebalancer_id) {
    m_nodebalancer_id = nodebalancer_id;
    m_nodebalancer_id_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodebalancer_id_Set() const{
    return m_nodebalancer_id_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodebalancer_id_Valid() const{
    return m_nodebalancer_id_isValid;
}

OAINodeBalancerConfig_nodes_status OAIRebuildNodeBalancerConfig_request::getNodesStatus() const {
    return m_nodes_status;
}
void OAIRebuildNodeBalancerConfig_request::setNodesStatus(const OAINodeBalancerConfig_nodes_status &nodes_status) {
    m_nodes_status = nodes_status;
    m_nodes_status_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodes_status_Set() const{
    return m_nodes_status_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodes_status_Valid() const{
    return m_nodes_status_isValid;
}

qint32 OAIRebuildNodeBalancerConfig_request::getPort() const {
    return m_port;
}
void OAIRebuildNodeBalancerConfig_request::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_port_Set() const{
    return m_port_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getProtocol() const {
    return m_protocol;
}
void OAIRebuildNodeBalancerConfig_request::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getProxyProtocol() const {
    return m_proxy_protocol;
}
void OAIRebuildNodeBalancerConfig_request::setProxyProtocol(const QString &proxy_protocol) {
    m_proxy_protocol = proxy_protocol;
    m_proxy_protocol_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_proxy_protocol_Set() const{
    return m_proxy_protocol_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_proxy_protocol_Valid() const{
    return m_proxy_protocol_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getSslCert() const {
    return m_ssl_cert;
}
void OAIRebuildNodeBalancerConfig_request::setSslCert(const QString &ssl_cert) {
    m_ssl_cert = ssl_cert;
    m_ssl_cert_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_cert_Set() const{
    return m_ssl_cert_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_cert_Valid() const{
    return m_ssl_cert_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getSslCommonname() const {
    return m_ssl_commonname;
}
void OAIRebuildNodeBalancerConfig_request::setSslCommonname(const QString &ssl_commonname) {
    m_ssl_commonname = ssl_commonname;
    m_ssl_commonname_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_commonname_Set() const{
    return m_ssl_commonname_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_commonname_Valid() const{
    return m_ssl_commonname_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getSslFingerprint() const {
    return m_ssl_fingerprint;
}
void OAIRebuildNodeBalancerConfig_request::setSslFingerprint(const QString &ssl_fingerprint) {
    m_ssl_fingerprint = ssl_fingerprint;
    m_ssl_fingerprint_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_fingerprint_Set() const{
    return m_ssl_fingerprint_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_fingerprint_Valid() const{
    return m_ssl_fingerprint_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getSslKey() const {
    return m_ssl_key;
}
void OAIRebuildNodeBalancerConfig_request::setSslKey(const QString &ssl_key) {
    m_ssl_key = ssl_key;
    m_ssl_key_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_key_Set() const{
    return m_ssl_key_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_ssl_key_Valid() const{
    return m_ssl_key_isValid;
}

QString OAIRebuildNodeBalancerConfig_request::getStickiness() const {
    return m_stickiness;
}
void OAIRebuildNodeBalancerConfig_request::setStickiness(const QString &stickiness) {
    m_stickiness = stickiness;
    m_stickiness_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_stickiness_Set() const{
    return m_stickiness_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_stickiness_Valid() const{
    return m_stickiness_isValid;
}

QList<OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner> OAIRebuildNodeBalancerConfig_request::getNodes() const {
    return m_nodes;
}
void OAIRebuildNodeBalancerConfig_request::setNodes(const QList<OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner> &nodes) {
    m_nodes = nodes;
    m_nodes_isSet = true;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodes_Set() const{
    return m_nodes_isSet;
}

bool OAIRebuildNodeBalancerConfig_request::is_nodes_Valid() const{
    return m_nodes_isValid;
}

bool OAIRebuildNodeBalancerConfig_request::isSet() const {
...
bool OAIRebuildNodeBalancerConfig_request::isValid() const {
