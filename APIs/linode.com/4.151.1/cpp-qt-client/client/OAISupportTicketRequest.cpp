...
OAISupportTicketRequest::OAISupportTicketRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportTicketRequest::OAISupportTicketRequest() {
    this->initializeModel();
}

OAISupportTicketRequest::~OAISupportTicketRequest() {}

void OAISupportTicketRequest::initializeModel() {
    ...
    m_lkecluster_id_isSet = false;
    m_lkecluster_id_isValid = false;

    m_longviewclient_id_isSet = false;
    m_longviewclient_id_isValid = false;

    m_managed_issue_isSet = false;
    m_managed_issue_isValid = false;
...
void OAISupportTicketRequest::fromJson(QString jsonString) {
...
void OAISupportTicketRequest::fromJsonObject(QJsonObject json) {
    ...
    m_firewall_id_isValid = ::OpenAPI::fromJsonValue(m_firewall_id, json[QString("firewall_id")]);
    m_firewall_id_isSet = !json[QString("firewall_id")].isNull() && m_firewall_id_isValid;
    ...
    m_lkecluster_id_isValid = ::OpenAPI::fromJsonValue(m_lkecluster_id, json[QString("lkecluster_id")]);
    m_lkecluster_id_isSet = !json[QString("lkecluster_id")].isNull() && m_lkecluster_id_isValid;

    m_longviewclient_id_isValid = ::OpenAPI::fromJsonValue(m_longviewclient_id, json[QString("longviewclient_id")]);
    m_longviewclient_id_isSet = !json[QString("longviewclient_id")].isNull() && m_longviewclient_id_isValid;

    m_managed_issue_isValid = ::OpenAPI::fromJsonValue(m_managed_issue, json[QString("managed_issue")]);
    m_managed_issue_isSet = !json[QString("managed_issue")].isNull() && m_managed_issue_isValid;
    ...
    m_volume_id_isValid = ::OpenAPI::fromJsonValue(m_volume_id, json[QString("volume_id")]);
    m_volume_id_isSet = !json[QString("volume_id")].isNull() && m_volume_id_isValid;
}

QString OAISupportTicketRequest::asJson() const {
...
QJsonObject OAISupportTicketRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_firewall_id_isSet) {
        obj.insert(QString("firewall_id"), ::OpenAPI::toJsonValue(m_firewall_id));
    }
    if (m_linode_id_isSet) {
        obj.insert(QString("linode_id"), ::OpenAPI::toJsonValue(m_linode_id));
    }
    if (m_lkecluster_id_isSet) {
        obj.insert(QString("lkecluster_id"), ::OpenAPI::toJsonValue(m_lkecluster_id));
    }
    if (m_longviewclient_id_isSet) {
        obj.insert(QString("longviewclient_id"), ::OpenAPI::toJsonValue(m_longviewclient_id));
    }
    if (m_managed_issue_isSet) {
        obj.insert(QString("managed_issue"), ::OpenAPI::toJsonValue(m_managed_issue));
    }
    ...
    if (m_volume_id_isSet) {
        obj.insert(QString("volume_id"), ::OpenAPI::toJsonValue(m_volume_id));
    }
    return obj;
}

qint32 OAISupportTicketRequest::getDatabaseId() const {
    return m_database_id;
}
void OAISupportTicketRequest::setDatabaseId(const qint32 &database_id) {
    m_database_id = database_id;
    m_database_id_isSet = true;
}

bool OAISupportTicketRequest::is_database_id_Set() const{
    return m_database_id_isSet;
}

bool OAISupportTicketRequest::is_database_id_Valid() const{
    return m_database_id_isValid;
}

QString OAISupportTicketRequest::getDescription() const {
    return m_description;
}
void OAISupportTicketRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISupportTicketRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAISupportTicketRequest::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAISupportTicketRequest::getDomainId() const {
    return m_domain_id;
}
void OAISupportTicketRequest::setDomainId(const qint32 &domain_id) {
    m_domain_id = domain_id;
    m_domain_id_isSet = true;
}

bool OAISupportTicketRequest::is_domain_id_Set() const{
    return m_domain_id_isSet;
}

bool OAISupportTicketRequest::is_domain_id_Valid() const{
    return m_domain_id_isValid;
}

qint32 OAISupportTicketRequest::getFirewallId() const {
    return m_firewall_id;
}
void OAISupportTicketRequest::setFirewallId(const qint32 &firewall_id) {
    m_firewall_id = firewall_id;
    m_firewall_id_isSet = true;
}

bool OAISupportTicketRequest::is_firewall_id_Set() const{
    return m_firewall_id_isSet;
}

bool OAISupportTicketRequest::is_firewall_id_Valid() const{
    return m_firewall_id_isValid;
}

qint32 OAISupportTicketRequest::getLinodeId() const {
    return m_linode_id;
}
void OAISupportTicketRequest::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAISupportTicketRequest::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAISupportTicketRequest::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAISupportTicketRequest::getLkeclusterId() const {
    return m_lkecluster_id;
}
void OAISupportTicketRequest::setLkeclusterId(const qint32 &lkecluster_id) {
    m_lkecluster_id = lkecluster_id;
    m_lkecluster_id_isSet = true;
}

bool OAISupportTicketRequest::is_lkecluster_id_Set() const{
    return m_lkecluster_id_isSet;
}

bool OAISupportTicketRequest::is_lkecluster_id_Valid() const{
    return m_lkecluster_id_isValid;
}

qint32 OAISupportTicketRequest::getLongviewclientId() const {
    return m_longviewclient_id;
}
void OAISupportTicketRequest::setLongviewclientId(const qint32 &longviewclient_id) {
    m_longviewclient_id = longviewclient_id;
    m_longviewclient_id_isSet = true;
}

bool OAISupportTicketRequest::is_longviewclient_id_Set() const{
    return m_longviewclient_id_isSet;
}

bool OAISupportTicketRequest::is_longviewclient_id_Valid() const{
    return m_longviewclient_id_isValid;
}

bool OAISupportTicketRequest::isManagedIssue() const {
    return m_managed_issue;
}
void OAISupportTicketRequest::setManagedIssue(const bool &managed_issue) {
    m_managed_issue = managed_issue;
    m_managed_issue_isSet = true;
}

bool OAISupportTicketRequest::is_managed_issue_Set() const{
    return m_managed_issue_isSet;
}

bool OAISupportTicketRequest::is_managed_issue_Valid() const{
    return m_managed_issue_isValid;
}

qint32 OAISupportTicketRequest::getNodebalancerId() const {
    return m_nodebalancer_id;
}
void OAISupportTicketRequest::setNodebalancerId(const qint32 &nodebalancer_id) {
    m_nodebalancer_id = nodebalancer_id;
    m_nodebalancer_id_isSet = true;
}

bool OAISupportTicketRequest::is_nodebalancer_id_Set() const{
    return m_nodebalancer_id_isSet;
}

bool OAISupportTicketRequest::is_nodebalancer_id_Valid() const{
    return m_nodebalancer_id_isValid;
}

QString OAISupportTicketRequest::getRegion() const {
    return m_region;
}
void OAISupportTicketRequest::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAISupportTicketRequest::is_region_Set() const{
    return m_region_isSet;
}

bool OAISupportTicketRequest::is_region_Valid() const{
    return m_region_isValid;
}

QString OAISupportTicketRequest::getSummary() const {
    return m_summary;
}
void OAISupportTicketRequest::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAISupportTicketRequest::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAISupportTicketRequest::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAISupportTicketRequest::getVlan() const {
    return m_vlan;
}
void OAISupportTicketRequest::setVlan(const QString &vlan) {
    m_vlan = vlan;
    m_vlan_isSet = true;
}

bool OAISupportTicketRequest::is_vlan_Set() const{
    return m_vlan_isSet;
}

bool OAISupportTicketRequest::is_vlan_Valid() const{
    return m_vlan_isValid;
}

qint32 OAISupportTicketRequest::getVolumeId() const {
    return m_volume_id;
}
void OAISupportTicketRequest::setVolumeId(const qint32 &volume_id) {
    m_volume_id = volume_id;
    m_volume_id_isSet = true;
}

bool OAISupportTicketRequest::is_volume_id_Set() const{
    return m_volume_id_isSet;
}

bool OAISupportTicketRequest::is_volume_id_Valid() const{
    return m_volume_id_isValid;
}

bool OAISupportTicketRequest::isSet() const {
...
bool OAISupportTicketRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_description_isValid && m_summary_isValid && true;
}
