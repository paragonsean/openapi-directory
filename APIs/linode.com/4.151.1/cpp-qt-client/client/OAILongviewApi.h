...
#ifndef OAI_OAILongviewApi_H
#define OAI_OAILongviewApi_H
...
#include "OAIGetLongviewClients_200_response.h"
#include "OAIGetLongviewSubscriptions_200_response.h"
#include "OAILongviewClient.h"
#include "OAILongviewPlan.h"
#include "OAILongviewSubscription.h"
#include "OAIObject.h"
#include <QString>
...
class OAILongviewApi : public QObject {
    Q_OBJECT

public:
    OAILongviewApi(const int timeOut = 0);
    ~OAILongviewApi();
    ...
    /**
    * @param[in]  oai_longview_client OAILongviewClient [required]
    */
    virtual void createLongviewClient(const OAILongviewClient &oai_longview_client);

    /**
    * @param[in]  client_id qint32 [required]
    */
    virtual void deleteLongviewClient(const qint32 &client_id);

    /**
    * @param[in]  client_id qint32 [required]
    */
    virtual void getLongviewClient(const qint32 &client_id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getLongviewClients(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());


    virtual void getLongviewPlan();

    /**
    * @param[in]  subscription_id QString [required]
    */
    virtual void getLongviewSubscription(const QString &subscription_id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getLongviewSubscriptions(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  client_id qint32 [required]
    * @param[in]  oai_longview_client OAILongviewClient [required]
    */
    virtual void updateLongviewClient(const qint32 &client_id, const OAILongviewClient &oai_longview_client);

    /**
    * @param[in]  oai_longview_plan OAILongviewPlan [required]
    */
    virtual void updateLongviewPlan(const OAILongviewPlan &oai_longview_plan);
...
private:
    ...
    void createLongviewClientCallback(OAIHttpRequestWorker *worker);
    void deleteLongviewClientCallback(OAIHttpRequestWorker *worker);
    void getLongviewClientCallback(OAIHttpRequestWorker *worker);
    void getLongviewClientsCallback(OAIHttpRequestWorker *worker);
    void getLongviewPlanCallback(OAIHttpRequestWorker *worker);
    void getLongviewSubscriptionCallback(OAIHttpRequestWorker *worker);
    void getLongviewSubscriptionsCallback(OAIHttpRequestWorker *worker);
    void updateLongviewClientCallback(OAIHttpRequestWorker *worker);
    void updateLongviewPlanCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createLongviewClientSignal(OAILongviewClient summary);
    void deleteLongviewClientSignal(OAIObject summary);
    void getLongviewClientSignal(OAILongviewClient summary);
    void getLongviewClientsSignal(OAIGetLongviewClients_200_response summary);
    void getLongviewPlanSignal(OAILongviewSubscription summary);
    void getLongviewSubscriptionSignal(OAILongviewSubscription summary);
    void getLongviewSubscriptionsSignal(OAIGetLongviewSubscriptions_200_response summary);
    void updateLongviewClientSignal(OAILongviewClient summary);
    void updateLongviewPlanSignal(OAILongviewSubscription summary);


    void createLongviewClientSignalFull(OAIHttpRequestWorker *worker, OAILongviewClient summary);
    void deleteLongviewClientSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getLongviewClientSignalFull(OAIHttpRequestWorker *worker, OAILongviewClient summary);
    void getLongviewClientsSignalFull(OAIHttpRequestWorker *worker, OAIGetLongviewClients_200_response summary);
    void getLongviewPlanSignalFull(OAIHttpRequestWorker *worker, OAILongviewSubscription summary);
    void getLongviewSubscriptionSignalFull(OAIHttpRequestWorker *worker, OAILongviewSubscription summary);
    void getLongviewSubscriptionsSignalFull(OAIHttpRequestWorker *worker, OAIGetLongviewSubscriptions_200_response summary);
    void updateLongviewClientSignalFull(OAIHttpRequestWorker *worker, OAILongviewClient summary);
    void updateLongviewPlanSignalFull(OAIHttpRequestWorker *worker, OAILongviewSubscription summary);

    Q_DECL_DEPRECATED_X("Use createLongviewClientSignalError() instead")
    void createLongviewClientSignalE(OAILongviewClient summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createLongviewClientSignalError(OAILongviewClient summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteLongviewClientSignalError() instead")
    void deleteLongviewClientSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteLongviewClientSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewClientSignalError() instead")
    void getLongviewClientSignalE(OAILongviewClient summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewClientSignalError(OAILongviewClient summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewClientsSignalError() instead")
    void getLongviewClientsSignalE(OAIGetLongviewClients_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewClientsSignalError(OAIGetLongviewClients_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewPlanSignalError() instead")
    void getLongviewPlanSignalE(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewPlanSignalError(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewSubscriptionSignalError() instead")
    void getLongviewSubscriptionSignalE(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewSubscriptionSignalError(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewSubscriptionsSignalError() instead")
    void getLongviewSubscriptionsSignalE(OAIGetLongviewSubscriptions_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewSubscriptionsSignalError(OAIGetLongviewSubscriptions_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateLongviewClientSignalError() instead")
    void updateLongviewClientSignalE(OAILongviewClient summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateLongviewClientSignalError(OAILongviewClient summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateLongviewPlanSignalError() instead")
    void updateLongviewPlanSignalE(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateLongviewPlanSignalError(OAILongviewSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use createLongviewClientSignalErrorFull() instead")
    void createLongviewClientSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createLongviewClientSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteLongviewClientSignalErrorFull() instead")
    void deleteLongviewClientSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteLongviewClientSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewClientSignalErrorFull() instead")
    void getLongviewClientSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewClientSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewClientsSignalErrorFull() instead")
    void getLongviewClientsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewClientsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewPlanSignalErrorFull() instead")
    void getLongviewPlanSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewPlanSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewSubscriptionSignalErrorFull() instead")
    void getLongviewSubscriptionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewSubscriptionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getLongviewSubscriptionsSignalErrorFull() instead")
    void getLongviewSubscriptionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getLongviewSubscriptionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateLongviewClientSignalErrorFull() instead")
    void updateLongviewClientSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateLongviewClientSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateLongviewPlanSignalErrorFull() instead")
    void updateLongviewPlanSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateLongviewPlanSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
