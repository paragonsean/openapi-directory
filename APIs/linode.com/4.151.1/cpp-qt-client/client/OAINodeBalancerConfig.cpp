...
OAINodeBalancerConfig::OAINodeBalancerConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeBalancerConfig::OAINodeBalancerConfig() {
    this->initializeModel();
}

OAINodeBalancerConfig::~OAINodeBalancerConfig() {}

void OAINodeBalancerConfig::initializeModel() {
...
void OAINodeBalancerConfig::fromJson(QString jsonString) {
...
void OAINodeBalancerConfig::fromJsonObject(QJsonObject json) {
...
QString OAINodeBalancerConfig::asJson() const {
...
QJsonObject OAINodeBalancerConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeBalancerConfig::getAlgorithm() const {
    return m_algorithm;
}
void OAINodeBalancerConfig::setAlgorithm(const QString &algorithm) {
    m_algorithm = algorithm;
    m_algorithm_isSet = true;
}

bool OAINodeBalancerConfig::is_algorithm_Set() const{
    return m_algorithm_isSet;
}

bool OAINodeBalancerConfig::is_algorithm_Valid() const{
    return m_algorithm_isValid;
}

QString OAINodeBalancerConfig::getCheck() const {
    return m_check;
}
void OAINodeBalancerConfig::setCheck(const QString &check) {
    m_check = check;
    m_check_isSet = true;
}

bool OAINodeBalancerConfig::is_check_Set() const{
    return m_check_isSet;
}

bool OAINodeBalancerConfig::is_check_Valid() const{
    return m_check_isValid;
}

qint32 OAINodeBalancerConfig::getCheckAttempts() const {
    return m_check_attempts;
}
void OAINodeBalancerConfig::setCheckAttempts(const qint32 &check_attempts) {
    m_check_attempts = check_attempts;
    m_check_attempts_isSet = true;
}

bool OAINodeBalancerConfig::is_check_attempts_Set() const{
    return m_check_attempts_isSet;
}

bool OAINodeBalancerConfig::is_check_attempts_Valid() const{
    return m_check_attempts_isValid;
}

QString OAINodeBalancerConfig::getCheckBody() const {
    return m_check_body;
}
void OAINodeBalancerConfig::setCheckBody(const QString &check_body) {
    m_check_body = check_body;
    m_check_body_isSet = true;
}

bool OAINodeBalancerConfig::is_check_body_Set() const{
    return m_check_body_isSet;
}

bool OAINodeBalancerConfig::is_check_body_Valid() const{
    return m_check_body_isValid;
}

qint32 OAINodeBalancerConfig::getCheckInterval() const {
    return m_check_interval;
}
void OAINodeBalancerConfig::setCheckInterval(const qint32 &check_interval) {
    m_check_interval = check_interval;
    m_check_interval_isSet = true;
}

bool OAINodeBalancerConfig::is_check_interval_Set() const{
    return m_check_interval_isSet;
}

bool OAINodeBalancerConfig::is_check_interval_Valid() const{
    return m_check_interval_isValid;
}

bool OAINodeBalancerConfig::isCheckPassive() const {
    return m_check_passive;
}
void OAINodeBalancerConfig::setCheckPassive(const bool &check_passive) {
    m_check_passive = check_passive;
    m_check_passive_isSet = true;
}

bool OAINodeBalancerConfig::is_check_passive_Set() const{
    return m_check_passive_isSet;
}

bool OAINodeBalancerConfig::is_check_passive_Valid() const{
    return m_check_passive_isValid;
}

QString OAINodeBalancerConfig::getCheckPath() const {
    return m_check_path;
}
void OAINodeBalancerConfig::setCheckPath(const QString &check_path) {
    m_check_path = check_path;
    m_check_path_isSet = true;
}

bool OAINodeBalancerConfig::is_check_path_Set() const{
    return m_check_path_isSet;
}

bool OAINodeBalancerConfig::is_check_path_Valid() const{
    return m_check_path_isValid;
}

qint32 OAINodeBalancerConfig::getCheckTimeout() const {
    return m_check_timeout;
}
void OAINodeBalancerConfig::setCheckTimeout(const qint32 &check_timeout) {
    m_check_timeout = check_timeout;
    m_check_timeout_isSet = true;
}

bool OAINodeBalancerConfig::is_check_timeout_Set() const{
    return m_check_timeout_isSet;
}

bool OAINodeBalancerConfig::is_check_timeout_Valid() const{
    return m_check_timeout_isValid;
}

QString OAINodeBalancerConfig::getCipherSuite() const {
    return m_cipher_suite;
}
void OAINodeBalancerConfig::setCipherSuite(const QString &cipher_suite) {
    m_cipher_suite = cipher_suite;
    m_cipher_suite_isSet = true;
}

bool OAINodeBalancerConfig::is_cipher_suite_Set() const{
    return m_cipher_suite_isSet;
}

bool OAINodeBalancerConfig::is_cipher_suite_Valid() const{
    return m_cipher_suite_isValid;
}

qint32 OAINodeBalancerConfig::getId() const {
    return m_id;
}
void OAINodeBalancerConfig::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINodeBalancerConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAINodeBalancerConfig::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAINodeBalancerConfig::getNodebalancerId() const {
    return m_nodebalancer_id;
}
void OAINodeBalancerConfig::setNodebalancerId(const qint32 &nodebalancer_id) {
    m_nodebalancer_id = nodebalancer_id;
    m_nodebalancer_id_isSet = true;
}

bool OAINodeBalancerConfig::is_nodebalancer_id_Set() const{
    return m_nodebalancer_id_isSet;
}

bool OAINodeBalancerConfig::is_nodebalancer_id_Valid() const{
    return m_nodebalancer_id_isValid;
}

OAINodeBalancerConfig_nodes_status OAINodeBalancerConfig::getNodesStatus() const {
    return m_nodes_status;
}
void OAINodeBalancerConfig::setNodesStatus(const OAINodeBalancerConfig_nodes_status &nodes_status) {
    m_nodes_status = nodes_status;
    m_nodes_status_isSet = true;
}

bool OAINodeBalancerConfig::is_nodes_status_Set() const{
    return m_nodes_status_isSet;
}

bool OAINodeBalancerConfig::is_nodes_status_Valid() const{
    return m_nodes_status_isValid;
}

qint32 OAINodeBalancerConfig::getPort() const {
    return m_port;
}
void OAINodeBalancerConfig::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAINodeBalancerConfig::is_port_Set() const{
    return m_port_isSet;
}

bool OAINodeBalancerConfig::is_port_Valid() const{
    return m_port_isValid;
}

QString OAINodeBalancerConfig::getProtocol() const {
    return m_protocol;
}
void OAINodeBalancerConfig::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAINodeBalancerConfig::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAINodeBalancerConfig::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAINodeBalancerConfig::getProxyProtocol() const {
    return m_proxy_protocol;
}
void OAINodeBalancerConfig::setProxyProtocol(const QString &proxy_protocol) {
    m_proxy_protocol = proxy_protocol;
    m_proxy_protocol_isSet = true;
}

bool OAINodeBalancerConfig::is_proxy_protocol_Set() const{
    return m_proxy_protocol_isSet;
}

bool OAINodeBalancerConfig::is_proxy_protocol_Valid() const{
    return m_proxy_protocol_isValid;
}

QString OAINodeBalancerConfig::getSslCert() const {
    return m_ssl_cert;
}
void OAINodeBalancerConfig::setSslCert(const QString &ssl_cert) {
    m_ssl_cert = ssl_cert;
    m_ssl_cert_isSet = true;
}

bool OAINodeBalancerConfig::is_ssl_cert_Set() const{
    return m_ssl_cert_isSet;
}

bool OAINodeBalancerConfig::is_ssl_cert_Valid() const{
    return m_ssl_cert_isValid;
}

QString OAINodeBalancerConfig::getSslCommonname() const {
    return m_ssl_commonname;
}
void OAINodeBalancerConfig::setSslCommonname(const QString &ssl_commonname) {
    m_ssl_commonname = ssl_commonname;
    m_ssl_commonname_isSet = true;
}

bool OAINodeBalancerConfig::is_ssl_commonname_Set() const{
    return m_ssl_commonname_isSet;
}

bool OAINodeBalancerConfig::is_ssl_commonname_Valid() const{
    return m_ssl_commonname_isValid;
}

QString OAINodeBalancerConfig::getSslFingerprint() const {
    return m_ssl_fingerprint;
}
void OAINodeBalancerConfig::setSslFingerprint(const QString &ssl_fingerprint) {
    m_ssl_fingerprint = ssl_fingerprint;
    m_ssl_fingerprint_isSet = true;
}

bool OAINodeBalancerConfig::is_ssl_fingerprint_Set() const{
    return m_ssl_fingerprint_isSet;
}

bool OAINodeBalancerConfig::is_ssl_fingerprint_Valid() const{
    return m_ssl_fingerprint_isValid;
}

QString OAINodeBalancerConfig::getSslKey() const {
    return m_ssl_key;
}
void OAINodeBalancerConfig::setSslKey(const QString &ssl_key) {
    m_ssl_key = ssl_key;
    m_ssl_key_isSet = true;
}

bool OAINodeBalancerConfig::is_ssl_key_Set() const{
    return m_ssl_key_isSet;
}

bool OAINodeBalancerConfig::is_ssl_key_Valid() const{
    return m_ssl_key_isValid;
}

QString OAINodeBalancerConfig::getStickiness() const {
    return m_stickiness;
}
void OAINodeBalancerConfig::setStickiness(const QString &stickiness) {
    m_stickiness = stickiness;
    m_stickiness_isSet = true;
}

bool OAINodeBalancerConfig::is_stickiness_Set() const{
    return m_stickiness_isSet;
}

bool OAINodeBalancerConfig::is_stickiness_Valid() const{
    return m_stickiness_isValid;
}

bool OAINodeBalancerConfig::isSet() const {
...
bool OAINodeBalancerConfig::isValid() const {
