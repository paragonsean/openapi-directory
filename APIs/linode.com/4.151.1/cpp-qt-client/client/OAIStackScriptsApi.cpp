...
OAIStackScriptsApi::OAIStackScriptsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIStackScriptsApi::~OAIStackScriptsApi() {
}

void OAIStackScriptsApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("addStackScript", defaultConf);
    _serverIndices.insert("addStackScript", 0);
    _serverConfigs.insert("deleteStackScript", defaultConf);
    _serverIndices.insert("deleteStackScript", 0);
    _serverConfigs.insert("getStackScript", defaultConf);
    _serverIndices.insert("getStackScript", 0);
    _serverConfigs.insert("getStackScripts", defaultConf);
    _serverIndices.insert("getStackScripts", 0);
    _serverConfigs.insert("updateStackScript", defaultConf);
    _serverIndices.insert("updateStackScript", 0);
}
...
*/
int OAIStackScriptsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIStackScriptsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIStackScriptsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIStackScriptsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIStackScriptsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIStackScriptsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIStackScriptsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIStackScriptsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIStackScriptsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIStackScriptsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStackScriptsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStackScriptsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIStackScriptsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIStackScriptsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIStackScriptsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIStackScriptsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIStackScriptsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIStackScriptsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIStackScriptsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIStackScriptsApi::addStackScript(const OAIStackScript &oai_stack_script) {
    QString fullPath = QString(_serverConfigs["addStackScript"][_serverIndices.value("addStackScript")].URL()+"/linode/stackscripts");
...

    {
        ...
        QByteArray output = oai_stack_script.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::addStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("stackscripts:read_write");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::addStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIStackScriptsApi::addStackScriptCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIStackScript output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT addStackScriptSignal(output);
        Q_EMIT addStackScriptSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT addStackScriptSignalE(output, error_type, error_str);
        Q_EMIT addStackScriptSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT addStackScriptSignalError(output, error_type, error_str);
        Q_EMIT addStackScriptSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStackScriptsApi::deleteStackScript(const QString &stackscript_id) {
    QString fullPath = QString(_serverConfigs["deleteStackScript"][_serverIndices.value("deleteStackScript")].URL()+"/linode/stackscripts/{stackscriptId}");
    ...
    {
        QString stackscript_idPathParam("{");
        stackscript_idPathParam.append("stackscriptId").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "stackscriptId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"stackscriptId"+pathSuffix : pathPrefix;
        fullPath.replace(stackscript_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(stackscript_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::deleteStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::deleteStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStackScriptsApi::deleteStackScriptCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteStackScriptSignal(output);
        Q_EMIT deleteStackScriptSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("stackscripts:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteStackScriptSignalE(output, error_type, error_str);
        Q_EMIT deleteStackScriptSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteStackScriptSignalError(output, error_type, error_str);
        Q_EMIT deleteStackScriptSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStackScriptsApi::getStackScript(const QString &stackscript_id) {
    QString fullPath = QString(_serverConfigs["getStackScript"][_serverIndices.value("getStackScript")].URL()+"/linode/stackscripts/{stackscriptId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::getStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("stackscripts:read_only");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::getStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStackScriptsApi::getStackScriptCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getStackScriptSignal(output);
        Q_EMIT getStackScriptSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("stackscripts:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getStackScriptSignalE(output, error_type, error_str);
        Q_EMIT getStackScriptSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getStackScriptSignalError(output, error_type, error_str);
        Q_EMIT getStackScriptSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStackScriptsApi::getStackScripts(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getStackScripts"][_serverIndices.value("getStackScripts")].URL()+"/linode/stackscripts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::getStackScriptsCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::getStackScriptsCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStackScriptsApi::getStackScriptsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetStackScripts_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getStackScriptsSignal(output);
        Q_EMIT getStackScriptsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("stackscripts:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getStackScriptsSignalE(output, error_type, error_str);
        Q_EMIT getStackScriptsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getStackScriptsSignalError(output, error_type, error_str);
        Q_EMIT getStackScriptsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStackScriptsApi::updateStackScript(const QString &stackscript_id, const ::OpenAPI::OptionalParam<OAIStackScript> &oai_stack_script) {
    QString fullPath = QString(_serverConfigs["updateStackScript"][_serverIndices.value("updateStackScript")].URL()+"/linode/stackscripts/{stackscriptId}");
    ...
    if (oai_stack_script.hasValue()){

        
        QByteArray output = oai_stack_script.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::updateStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStackScriptsApi::updateStackScriptCallback);
    connect(this, &OAIStackScriptsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStackScriptsApi::updateStackScriptCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateStackScriptSignal(output);
        Q_EMIT updateStackScriptSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("stackscripts:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateStackScriptSignalE(output, error_type, error_str);
        Q_EMIT updateStackScriptSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateStackScriptSignalError(output, error_type, error_str);
        Q_EMIT updateStackScriptSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStackScriptsApi::tokenAvailable(){
