...
OAIDatabaseMySQL::OAIDatabaseMySQL(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseMySQL::OAIDatabaseMySQL() {
    this->initializeModel();
}

OAIDatabaseMySQL::~OAIDatabaseMySQL() {}

void OAIDatabaseMySQL::initializeModel() {
...
void OAIDatabaseMySQL::fromJson(QString jsonString) {
...
void OAIDatabaseMySQL::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseMySQL::asJson() const {
...
QJsonObject OAIDatabaseMySQL::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDatabaseMySQL::getAllowList() const {
    return m_allow_list;
}
void OAIDatabaseMySQL::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabaseMySQL::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabaseMySQL::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabaseMySQL::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabaseMySQL::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabaseMySQL::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabaseMySQL::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

QDateTime OAIDatabaseMySQL::getCreated() const {
    return m_created;
}
void OAIDatabaseMySQL::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDatabaseMySQL::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDatabaseMySQL::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIDatabaseMySQL::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabaseMySQL::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabaseMySQL::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabaseMySQL::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabaseMySQL::getEngine() const {
    return m_engine;
}
void OAIDatabaseMySQL::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseMySQL::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseMySQL::is_engine_Valid() const{
    return m_engine_isValid;
}

OAIDatabase_hosts OAIDatabaseMySQL::getHosts() const {
    return m_hosts;
}
void OAIDatabaseMySQL::setHosts(const OAIDatabase_hosts &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAIDatabaseMySQL::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAIDatabaseMySQL::is_hosts_Valid() const{
    return m_hosts_isValid;
}

qint32 OAIDatabaseMySQL::getId() const {
    return m_id;
}
void OAIDatabaseMySQL::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseMySQL::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseMySQL::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseMySQL::getLabel() const {
    return m_label;
}
void OAIDatabaseMySQL::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseMySQL::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseMySQL::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIDatabaseMySQL::getPort() const {
    return m_port;
}
void OAIDatabaseMySQL::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDatabaseMySQL::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDatabaseMySQL::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIDatabaseMySQL::getRegion() const {
    return m_region;
}
void OAIDatabaseMySQL::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabaseMySQL::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabaseMySQL::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabaseMySQL::getReplicationType() const {
    return m_replication_type;
}
void OAIDatabaseMySQL::setReplicationType(const QString &replication_type) {
    m_replication_type = replication_type;
    m_replication_type_isSet = true;
}

bool OAIDatabaseMySQL::is_replication_type_Set() const{
    return m_replication_type_isSet;
}

bool OAIDatabaseMySQL::is_replication_type_Valid() const{
    return m_replication_type_isValid;
}

bool OAIDatabaseMySQL::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabaseMySQL::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabaseMySQL::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabaseMySQL::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabaseMySQL::getStatus() const {
    return m_status;
}
void OAIDatabaseMySQL::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatabaseMySQL::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatabaseMySQL::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatabaseMySQL::getType() const {
    return m_type;
}
void OAIDatabaseMySQL::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseMySQL::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseMySQL::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIDatabaseMySQL::getUpdated() const {
    return m_updated;
}
void OAIDatabaseMySQL::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDatabaseMySQL::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDatabaseMySQL::is_updated_Valid() const{
    return m_updated_isValid;
}

OAIDatabase_updates OAIDatabaseMySQL::getUpdates() const {
    return m_updates;
}
void OAIDatabaseMySQL::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIDatabaseMySQL::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIDatabaseMySQL::is_updates_Valid() const{
    return m_updates_isValid;
}

QString OAIDatabaseMySQL::getVersion() const {
    return m_version;
}
void OAIDatabaseMySQL::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDatabaseMySQL::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDatabaseMySQL::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIDatabaseMySQL::isSet() const {
...
bool OAIDatabaseMySQL::isValid() const {
