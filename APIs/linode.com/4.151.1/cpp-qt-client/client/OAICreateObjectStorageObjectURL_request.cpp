...
#include "OAICreateObjectStorageObjectURL_request.h"
...
OAICreateObjectStorageObjectURL_request::OAICreateObjectStorageObjectURL_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateObjectStorageObjectURL_request::OAICreateObjectStorageObjectURL_request() {
    this->initializeModel();
}

OAICreateObjectStorageObjectURL_request::~OAICreateObjectStorageObjectURL_request() {}

void OAICreateObjectStorageObjectURL_request::initializeModel() {
...
void OAICreateObjectStorageObjectURL_request::fromJson(QString jsonString) {
...
void OAICreateObjectStorageObjectURL_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateObjectStorageObjectURL_request::asJson() const {
...
QJsonObject OAICreateObjectStorageObjectURL_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateObjectStorageObjectURL_request::getContentType() const {
    return m_content_type;
}
void OAICreateObjectStorageObjectURL_request::setContentType(const QString &content_type) {
    m_content_type = content_type;
    m_content_type_isSet = true;
}

bool OAICreateObjectStorageObjectURL_request::is_content_type_Set() const{
    return m_content_type_isSet;
}

bool OAICreateObjectStorageObjectURL_request::is_content_type_Valid() const{
    return m_content_type_isValid;
}

qint32 OAICreateObjectStorageObjectURL_request::getExpiresIn() const {
    return m_expires_in;
}
void OAICreateObjectStorageObjectURL_request::setExpiresIn(const qint32 &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAICreateObjectStorageObjectURL_request::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAICreateObjectStorageObjectURL_request::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAICreateObjectStorageObjectURL_request::getMethod() const {
    return m_method;
}
void OAICreateObjectStorageObjectURL_request::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAICreateObjectStorageObjectURL_request::is_method_Set() const{
    return m_method_isSet;
}

bool OAICreateObjectStorageObjectURL_request::is_method_Valid() const{
    return m_method_isValid;
}

QString OAICreateObjectStorageObjectURL_request::getName() const {
    return m_name;
}
void OAICreateObjectStorageObjectURL_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateObjectStorageObjectURL_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateObjectStorageObjectURL_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAICreateObjectStorageObjectURL_request::isSet() const {
...
bool OAICreateObjectStorageObjectURL_request::isValid() const {
