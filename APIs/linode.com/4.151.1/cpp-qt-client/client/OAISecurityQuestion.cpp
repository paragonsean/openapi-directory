...
void OAISecurityQuestion::initializeModel() {
...
void OAISecurityQuestion::fromJson(QString jsonString) {
...
void OAISecurityQuestion::fromJsonObject(QJsonObject json) {
...
QString OAISecurityQuestion::asJson() const {
...
QJsonObject OAISecurityQuestion::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAISecurityQuestion::getId() const {
    return m_id;
}
void OAISecurityQuestion::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISecurityQuestion::is_id_Set() const{
    return m_id_isSet;
}

bool OAISecurityQuestion::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISecurityQuestion::getQuestion() const {
    return m_question;
}
void OAISecurityQuestion::setQuestion(const QString &question) {
    m_question = question;
    m_question_isSet = true;
}

bool OAISecurityQuestion::is_question_Set() const{
    return m_question_isSet;
}

bool OAISecurityQuestion::is_question_Valid() const{
    return m_question_isValid;
}

QString OAISecurityQuestion::getResponse() const {
    return m_response;
}
void OAISecurityQuestion::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAISecurityQuestion::is_response_Set() const{
    return m_response_isSet;
}

bool OAISecurityQuestion::is_response_Valid() const{
    return m_response_isValid;
}

bool OAISecurityQuestion::isSet() const {
...
bool OAISecurityQuestion::isValid() const {
