...
OAIPutDatabasesPostgreSQLInstance_request::OAIPutDatabasesPostgreSQLInstance_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDatabasesPostgreSQLInstance_request::OAIPutDatabasesPostgreSQLInstance_request() {
    this->initializeModel();
}

OAIPutDatabasesPostgreSQLInstance_request::~OAIPutDatabasesPostgreSQLInstance_request() {}

void OAIPutDatabasesPostgreSQLInstance_request::initializeModel() {
...
void OAIPutDatabasesPostgreSQLInstance_request::fromJson(QString jsonString) {
...
void OAIPutDatabasesPostgreSQLInstance_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutDatabasesPostgreSQLInstance_request::asJson() const {
...
QJsonObject OAIPutDatabasesPostgreSQLInstance_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIPutDatabasesPostgreSQLInstance_request::getAllowList() const {
    return m_allow_list;
}
void OAIPutDatabasesPostgreSQLInstance_request::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

QString OAIPutDatabasesPostgreSQLInstance_request::getLabel() const {
    return m_label;
}
void OAIPutDatabasesPostgreSQLInstance_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_label_Valid() const{
    return m_label_isValid;
}

OAIDatabase_updates OAIPutDatabasesPostgreSQLInstance_request::getUpdates() const {
    return m_updates;
}
void OAIPutDatabasesPostgreSQLInstance_request::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIPutDatabasesPostgreSQLInstance_request::is_updates_Valid() const{
    return m_updates_isValid;
}

bool OAIPutDatabasesPostgreSQLInstance_request::isSet() const {
...
bool OAIPutDatabasesPostgreSQLInstance_request::isValid() const {
