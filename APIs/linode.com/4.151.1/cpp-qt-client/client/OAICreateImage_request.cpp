...
OAICreateImage_request::OAICreateImage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateImage_request::OAICreateImage_request() {
    this->initializeModel();
}

OAICreateImage_request::~OAICreateImage_request() {}

void OAICreateImage_request::initializeModel() {
...
void OAICreateImage_request::fromJson(QString jsonString) {
...
void OAICreateImage_request::fromJsonObject(QJsonObject json) {

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;

    m_disk_id_isValid = ::OpenAPI::fromJsonValue(m_disk_id, json[QString("disk_id")]);
    m_disk_id_isSet = !json[QString("disk_id")].isNull() && m_disk_id_isValid;

    m_label_isValid = ::OpenAPI::fromJsonValue(m_label, json[QString("label")]);
    m_label_isSet = !json[QString("label")].isNull() && m_label_isValid;
}

QString OAICreateImage_request::asJson() const {
...
QJsonObject OAICreateImage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_description_isSet) {
        obj.insert(QString("description"), ::OpenAPI::toJsonValue(m_description));
    }
    if (m_disk_id_isSet) {
        obj.insert(QString("disk_id"), ::OpenAPI::toJsonValue(m_disk_id));
    }
    if (m_label_isSet) {
...
QString OAICreateImage_request::getDescription() const {
    return m_description;
}
void OAICreateImage_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateImage_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateImage_request::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAICreateImage_request::getDiskId() const {
    return m_disk_id;
}
void OAICreateImage_request::setDiskId(const qint32 &disk_id) {
    m_disk_id = disk_id;
    m_disk_id_isSet = true;
}

bool OAICreateImage_request::is_disk_id_Set() const{
    return m_disk_id_isSet;
}

bool OAICreateImage_request::is_disk_id_Valid() const{
    return m_disk_id_isValid;
}

QString OAICreateImage_request::getLabel() const {
    return m_label;
}
void OAICreateImage_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateImage_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateImage_request::is_label_Valid() const{
    return m_label_isValid;
}

bool OAICreateImage_request::isSet() const {
...
bool OAICreateImage_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_disk_id_isValid && true;
}
