...
void OAIManagedService::initializeModel() {
    ...
    m_consultation_group_isSet = false;
    m_consultation_group_isValid = false;
...
void OAIManagedService::fromJsonObject(QJsonObject json) {
    ...
    m_consultation_group_isValid = ::OpenAPI::fromJsonValue(m_consultation_group, json[QString("consultation_group")]);
    m_consultation_group_isSet = !json[QString("consultation_group")].isNull() && m_consultation_group_isValid;
...
QJsonObject OAIManagedService::asJsonObject() const {
    ...
    if (m_consultation_group_isSet) {
        obj.insert(QString("consultation_group"), ::OpenAPI::toJsonValue(m_consultation_group));
    }
    if (m_created_isSet) {
...
QString OAIManagedService::getAddress() const {
    return m_address;
}
void OAIManagedService::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIManagedService::is_address_Set() const{
    return m_address_isSet;
}

bool OAIManagedService::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIManagedService::getBody() const {
    return m_body;
}
void OAIManagedService::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIManagedService::is_body_Set() const{
    return m_body_isSet;
}

bool OAIManagedService::is_body_Valid() const{
    return m_body_isValid;
}

QString OAIManagedService::getConsultationGroup() const {
    return m_consultation_group;
}
void OAIManagedService::setConsultationGroup(const QString &consultation_group) {
    m_consultation_group = consultation_group;
    m_consultation_group_isSet = true;
}

bool OAIManagedService::is_consultation_group_Set() const{
    return m_consultation_group_isSet;
}

bool OAIManagedService::is_consultation_group_Valid() const{
    return m_consultation_group_isValid;
}

QDateTime OAIManagedService::getCreated() const {
    return m_created;
}
void OAIManagedService::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIManagedService::is_created_Set() const{
    return m_created_isSet;
}

bool OAIManagedService::is_created_Valid() const{
    return m_created_isValid;
}

QList<qint32> OAIManagedService::getCredentials() const {
    return m_credentials;
}
void OAIManagedService::setCredentials(const QList<qint32> &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIManagedService::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIManagedService::is_credentials_Valid() const{
    return m_credentials_isValid;
}

qint32 OAIManagedService::getId() const {
    return m_id;
}
void OAIManagedService::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedService::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedService::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagedService::getLabel() const {
    return m_label;
}
void OAIManagedService::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIManagedService::is_label_Set() const{
    return m_label_isSet;
}

bool OAIManagedService::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIManagedService::getNotes() const {
    return m_notes;
}
void OAIManagedService::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIManagedService::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIManagedService::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIManagedService::getRegion() const {
    return m_region;
}
void OAIManagedService::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIManagedService::is_region_Set() const{
    return m_region_isSet;
}

bool OAIManagedService::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIManagedService::getServiceType() const {
    return m_service_type;
}
void OAIManagedService::setServiceType(const QString &service_type) {
    m_service_type = service_type;
    m_service_type_isSet = true;
}

bool OAIManagedService::is_service_type_Set() const{
    return m_service_type_isSet;
}

bool OAIManagedService::is_service_type_Valid() const{
    return m_service_type_isValid;
}

QString OAIManagedService::getStatus() const {
    return m_status;
}
void OAIManagedService::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIManagedService::is_status_Set() const{
    return m_status_isSet;
}

bool OAIManagedService::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIManagedService::getTimeout() const {
    return m_timeout;
}
void OAIManagedService::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIManagedService::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIManagedService::is_timeout_Valid() const{
    return m_timeout_isValid;
}

QDateTime OAIManagedService::getUpdated() const {
    return m_updated;
}
void OAIManagedService::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIManagedService::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIManagedService::is_updated_Valid() const{
