...
OAICreateFirewalls_request::OAICreateFirewalls_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewalls_request::OAICreateFirewalls_request() {
    this->initializeModel();
}

OAICreateFirewalls_request::~OAICreateFirewalls_request() {}

void OAICreateFirewalls_request::initializeModel() {
...
void OAICreateFirewalls_request::fromJson(QString jsonString) {
...
void OAICreateFirewalls_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewalls_request::asJson() const {
...
QJsonObject OAICreateFirewalls_request::asJsonObject() const {
    QJsonObject obj;
    if (m_devices.isSet()) {
...
OAICreateFirewalls_request_devices OAICreateFirewalls_request::getDevices() const {
    return m_devices;
}
void OAICreateFirewalls_request::setDevices(const OAICreateFirewalls_request_devices &devices) {
    m_devices = devices;
    m_devices_isSet = true;
}

bool OAICreateFirewalls_request::is_devices_Set() const{
    return m_devices_isSet;
}

bool OAICreateFirewalls_request::is_devices_Valid() const{
    return m_devices_isValid;
}

OAICreateFirewalls_request_rules OAICreateFirewalls_request::getRules() const {
    return m_rules;
}
void OAICreateFirewalls_request::setRules(const OAICreateFirewalls_request_rules &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAICreateFirewalls_request::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAICreateFirewalls_request::is_rules_Valid() const{
    return m_rules_isValid;
}

QDateTime OAICreateFirewalls_request::getCreated() const {
    return m_created;
}
void OAICreateFirewalls_request::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAICreateFirewalls_request::is_created_Set() const{
    return m_created_isSet;
}

bool OAICreateFirewalls_request::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAICreateFirewalls_request::getId() const {
    return m_id;
}
void OAICreateFirewalls_request::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateFirewalls_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateFirewalls_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateFirewalls_request::getLabel() const {
    return m_label;
}
void OAICreateFirewalls_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateFirewalls_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateFirewalls_request::is_label_Valid() const{
    return m_label_isValid;
}

QString OAICreateFirewalls_request::getStatus() const {
    return m_status;
}
void OAICreateFirewalls_request::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateFirewalls_request::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateFirewalls_request::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAICreateFirewalls_request::getTags() const {
    return m_tags;
}
void OAICreateFirewalls_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateFirewalls_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateFirewalls_request::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAICreateFirewalls_request::getUpdated() const {
    return m_updated;
}
void OAICreateFirewalls_request::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAICreateFirewalls_request::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAICreateFirewalls_request::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAICreateFirewalls_request::isSet() const {
...
bool OAICreateFirewalls_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_rules_isValid && m_label_isValid && true;
}
