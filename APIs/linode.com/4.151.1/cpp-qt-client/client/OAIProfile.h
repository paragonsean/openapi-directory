...
public:
    ...
    Q_DECL_DEPRECATED bool isIpWhitelistEnabled() const;
    Q_DECL_DEPRECATED void setIpWhitelistEnabled(const bool &ip_whitelist_enabled);
    Q_DECL_DEPRECATED bool is_ip_whitelist_enabled_Set() const;
    Q_DECL_DEPRECATED bool is_ip_whitelist_enabled_Valid() const;

    QString getLishAuthMethod() const;
    void setLishAuthMethod(const QString &lish_auth_method);
    bool is_lish_auth_method_Set() const;
    bool is_lish_auth_method_Valid() const;

    OAIProfile_referrals getReferrals() const;
    void setReferrals(const OAIProfile_referrals &referrals);
    bool is_referrals_Set() const;
    bool is_referrals_Valid() const;
    ...
    bool isTwoFactorAuth() const;
    void setTwoFactorAuth(const bool &two_factor_auth);
    bool is_two_factor_auth_Set() const;
    bool is_two_factor_auth_Valid() const;
...
private:
    ...
    bool m_ip_whitelist_enabled;
    bool m_ip_whitelist_enabled_isSet;
    bool m_ip_whitelist_enabled_isValid;

    QString m_lish_auth_method;
    bool m_lish_auth_method_isSet;
    bool m_lish_auth_method_isValid;

    OAIProfile_referrals m_referrals;
    bool m_referrals_isSet;
    bool m_referrals_isValid;
    ...
    bool m_two_factor_auth;
    bool m_two_factor_auth_isSet;
    bool m_two_factor_auth_isValid;
