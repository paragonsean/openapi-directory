...
OAIFirewall_rules::OAIFirewall_rules(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewall_rules::OAIFirewall_rules() {
    this->initializeModel();
}

OAIFirewall_rules::~OAIFirewall_rules() {}

void OAIFirewall_rules::initializeModel() {

    m_inbound_isSet = false;
    m_inbound_isValid = false;

    m_inbound_policy_isSet = false;
    m_inbound_policy_isValid = false;

    m_outbound_isSet = false;
    m_outbound_isValid = false;

    m_outbound_policy_isSet = false;
    m_outbound_policy_isValid = false;
}

void OAIFirewall_rules::fromJson(QString jsonString) {
...
void OAIFirewall_rules::fromJsonObject(QJsonObject json) {
    ...
    m_inbound_policy_isValid = ::OpenAPI::fromJsonValue(m_inbound_policy, json[QString("inbound_policy")]);
    m_inbound_policy_isSet = !json[QString("inbound_policy")].isNull() && m_inbound_policy_isValid;
    ...
    m_outbound_policy_isValid = ::OpenAPI::fromJsonValue(m_outbound_policy, json[QString("outbound_policy")]);
    m_outbound_policy_isSet = !json[QString("outbound_policy")].isNull() && m_outbound_policy_isValid;
}

QString OAIFirewall_rules::asJson() const {
...
QJsonObject OAIFirewall_rules::asJsonObject() const {
    QJsonObject obj;
    if (m_inbound.size() > 0) {
        obj.insert(QString("inbound"), ::OpenAPI::toJsonValue(m_inbound));
    }
    if (m_inbound_policy_isSet) {
        obj.insert(QString("inbound_policy"), ::OpenAPI::toJsonValue(m_inbound_policy));
    }
    if (m_outbound.size() > 0) {
        obj.insert(QString("outbound"), ::OpenAPI::toJsonValue(m_outbound));
    }
    if (m_outbound_policy_isSet) {
        obj.insert(QString("outbound_policy"), ::OpenAPI::toJsonValue(m_outbound_policy));
    }
    return obj;
}

QList<OAIFirewallRuleConfig> OAIFirewall_rules::getInbound() const {
    return m_inbound;
}
void OAIFirewall_rules::setInbound(const QList<OAIFirewallRuleConfig> &inbound) {
    m_inbound = inbound;
    m_inbound_isSet = true;
}

bool OAIFirewall_rules::is_inbound_Set() const{
    return m_inbound_isSet;
}

bool OAIFirewall_rules::is_inbound_Valid() const{
    return m_inbound_isValid;
}

QString OAIFirewall_rules::getInboundPolicy() const {
    return m_inbound_policy;
}
void OAIFirewall_rules::setInboundPolicy(const QString &inbound_policy) {
    m_inbound_policy = inbound_policy;
    m_inbound_policy_isSet = true;
}

bool OAIFirewall_rules::is_inbound_policy_Set() const{
    return m_inbound_policy_isSet;
}

bool OAIFirewall_rules::is_inbound_policy_Valid() const{
    return m_inbound_policy_isValid;
}

QList<OAIFirewallRuleConfig> OAIFirewall_rules::getOutbound() const {
    return m_outbound;
}
void OAIFirewall_rules::setOutbound(const QList<OAIFirewallRuleConfig> &outbound) {
    m_outbound = outbound;
    m_outbound_isSet = true;
}

bool OAIFirewall_rules::is_outbound_Set() const{
    return m_outbound_isSet;
}

bool OAIFirewall_rules::is_outbound_Valid() const{
    return m_outbound_isValid;
}

QString OAIFirewall_rules::getOutboundPolicy() const {
    return m_outbound_policy;
}
void OAIFirewall_rules::setOutboundPolicy(const QString &outbound_policy) {
    m_outbound_policy = outbound_policy;
    m_outbound_policy_isSet = true;
}

bool OAIFirewall_rules::is_outbound_policy_Set() const{
    return m_outbound_policy_isSet;
}

bool OAIFirewall_rules::is_outbound_policy_Valid() const{
    return m_outbound_policy_isValid;
}

bool OAIFirewall_rules::isSet() const {
...
bool OAIFirewall_rules::isValid() const {
