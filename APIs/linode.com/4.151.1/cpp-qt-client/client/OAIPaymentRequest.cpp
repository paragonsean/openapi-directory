...
QString OAIPaymentRequest::getCvv() const {
    return m_cvv;
}
void OAIPaymentRequest::setCvv(const QString &cvv) {
    m_cvv = cvv;
    m_cvv_isSet = true;
}

bool OAIPaymentRequest::is_cvv_Set() const{
    return m_cvv_isSet;
}

bool OAIPaymentRequest::is_cvv_Valid() const{
    return m_cvv_isValid;
}

qint32 OAIPaymentRequest::getPaymentMethodId() const {
    return m_payment_method_id;
}
void OAIPaymentRequest::setPaymentMethodId(const qint32 &payment_method_id) {
    m_payment_method_id = payment_method_id;
    m_payment_method_id_isSet = true;
}

bool OAIPaymentRequest::is_payment_method_id_Set() const{
    return m_payment_method_id_isSet;
}

bool OAIPaymentRequest::is_payment_method_id_Valid() const{
    return m_payment_method_id_isValid;
}

QString OAIPaymentRequest::getUsd() const {
    return m_usd;
}
void OAIPaymentRequest::setUsd(const QString &usd) {
    m_usd = usd;
    m_usd_isSet = true;
}

bool OAIPaymentRequest::is_usd_Set() const{
    return m_usd_isSet;
}

bool OAIPaymentRequest::is_usd_Valid() const{
