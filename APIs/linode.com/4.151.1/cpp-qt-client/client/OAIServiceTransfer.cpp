...
OAIServiceTransfer::OAIServiceTransfer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceTransfer::OAIServiceTransfer() {
    this->initializeModel();
}

OAIServiceTransfer::~OAIServiceTransfer() {}

void OAIServiceTransfer::initializeModel() {
    ...
    m_is_sender_isSet = false;
    m_is_sender_isValid = false;
...
void OAIServiceTransfer::fromJson(QString jsonString) {
...
void OAIServiceTransfer::fromJsonObject(QJsonObject json) {
    ...
    m_is_sender_isValid = ::OpenAPI::fromJsonValue(m_is_sender, json[QString("is_sender")]);
    m_is_sender_isSet = !json[QString("is_sender")].isNull() && m_is_sender_isValid;
...
QString OAIServiceTransfer::asJson() const {
...
QJsonObject OAIServiceTransfer::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
    ...
    if (m_is_sender_isSet) {
        obj.insert(QString("is_sender"), ::OpenAPI::toJsonValue(m_is_sender));
    }
    if (m_status_isSet) {
...
QDateTime OAIServiceTransfer::getCreated() const {
    return m_created;
}
void OAIServiceTransfer::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIServiceTransfer::is_created_Set() const{
    return m_created_isSet;
}

bool OAIServiceTransfer::is_created_Valid() const{
    return m_created_isValid;
}

OAIServiceTransfer_entities OAIServiceTransfer::getEntities() const {
    return m_entities;
}
void OAIServiceTransfer::setEntities(const OAIServiceTransfer_entities &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIServiceTransfer::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIServiceTransfer::is_entities_Valid() const{
    return m_entities_isValid;
}

QDateTime OAIServiceTransfer::getExpiry() const {
    return m_expiry;
}
void OAIServiceTransfer::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIServiceTransfer::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIServiceTransfer::is_expiry_Valid() const{
    return m_expiry_isValid;
}

bool OAIServiceTransfer::isIsSender() const {
    return m_is_sender;
}
void OAIServiceTransfer::setIsSender(const bool &is_sender) {
    m_is_sender = is_sender;
    m_is_sender_isSet = true;
}

bool OAIServiceTransfer::is_is_sender_Set() const{
    return m_is_sender_isSet;
}

bool OAIServiceTransfer::is_is_sender_Valid() const{
    return m_is_sender_isValid;
}

QString OAIServiceTransfer::getStatus() const {
    return m_status;
}
void OAIServiceTransfer::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIServiceTransfer::is_status_Set() const{
    return m_status_isSet;
}

bool OAIServiceTransfer::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIServiceTransfer::getToken() const {
    return m_token;
}
void OAIServiceTransfer::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIServiceTransfer::is_token_Set() const{
    return m_token_isSet;
}

bool OAIServiceTransfer::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIServiceTransfer::getUpdated() const {
    return m_updated;
}
void OAIServiceTransfer::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIServiceTransfer::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIServiceTransfer::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIServiceTransfer::isSet() const {
...
bool OAIServiceTransfer::isValid() const {
