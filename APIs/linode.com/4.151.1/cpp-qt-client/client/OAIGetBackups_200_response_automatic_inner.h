...
/*
 * OAIGetBackups_200_response_automatic_inner.h
 *
 * 
 */

#ifndef OAIGetBackups_200_response_automatic_inner_H
#define OAIGetBackups_200_response_automatic_inner_H

#include <QJsonObject>

#include "OAIBackup_disks_inner.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIBackup_disks_inner;

class OAIGetBackups_200_response_automatic_inner : public OAIObject {
public:
    OAIGetBackups_200_response_automatic_inner();
    OAIGetBackups_200_response_automatic_inner(QString json);
    ~OAIGetBackups_200_response_automatic_inner() override;
    ...
    QList<OAIBackup_disks_inner> getDisks() const;
    void setDisks(const QList<OAIBackup_disks_inner> &disks);
...
private:
    ...
    QList<OAIBackup_disks_inner> m_disks;
    bool m_disks_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBackups_200_response_automatic_inner)

#endif // OAIGetBackups_200_response_automatic_inner_H
