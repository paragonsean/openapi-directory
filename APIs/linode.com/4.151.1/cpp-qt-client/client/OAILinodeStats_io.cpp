...
OAILinodeStats_io::OAILinodeStats_io(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeStats_io::OAILinodeStats_io() {
    this->initializeModel();
}

OAILinodeStats_io::~OAILinodeStats_io() {}

void OAILinodeStats_io::initializeModel() {
...
void OAILinodeStats_io::fromJson(QString jsonString) {
...
void OAILinodeStats_io::fromJsonObject(QJsonObject json) {

    if(json["io"].isArray()){
        auto arr = json["io"].toArray();
        m_io_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_io_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_io_isSet = !jval.isNull() && m_io_isValid;
                m_io.push_back(item);
            }
        }
    }

    if(json["swap"].isArray()){
        auto arr = json["swap"].toArray();
        m_swap_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_swap_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_swap_isSet = !jval.isNull() && m_swap_isValid;
                m_swap.push_back(item);
            }
        }
    }
}

QString OAILinodeStats_io::asJson() const {
...
QJsonObject OAILinodeStats_io::asJsonObject() const {
    QJsonObject obj;
    if (m_io.size() > 0) {
        
        obj.insert(QString("io"), toJsonValue(m_io));
    }
    if (m_swap.size() > 0) {
        
        obj.insert(QString("swap"), toJsonValue(m_swap));
    }
    return obj;
}

QList<QList<double>> OAILinodeStats_io::getIo() const {
    return m_io;
}
void OAILinodeStats_io::setIo(const QList<QList<double>> &io) {
    m_io = io;
    m_io_isSet = true;
}

bool OAILinodeStats_io::is_io_Set() const{
    return m_io_isSet;
}

bool OAILinodeStats_io::is_io_Valid() const{
    return m_io_isValid;
}

QList<QList<double>> OAILinodeStats_io::getSwap() const {
    return m_swap;
}
void OAILinodeStats_io::setSwap(const QList<QList<double>> &swap) {
    m_swap = swap;
    m_swap_isSet = true;
}

bool OAILinodeStats_io::is_swap_Set() const{
    return m_swap_isSet;
}

bool OAILinodeStats_io::is_swap_Valid() const{
    return m_swap_isValid;
}

bool OAILinodeStats_io::isSet() const {
...
bool OAILinodeStats_io::isValid() const {
