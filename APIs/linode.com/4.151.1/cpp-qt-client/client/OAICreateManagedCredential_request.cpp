...
#include "OAICreateManagedCredential_request.h"
...
OAICreateManagedCredential_request::OAICreateManagedCredential_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateManagedCredential_request::OAICreateManagedCredential_request() {
    this->initializeModel();
}

OAICreateManagedCredential_request::~OAICreateManagedCredential_request() {}

void OAICreateManagedCredential_request::initializeModel() {
    ...
    m_last_decrypted_isSet = false;
    m_last_decrypted_isValid = false;
...
void OAICreateManagedCredential_request::fromJson(QString jsonString) {
...
void OAICreateManagedCredential_request::fromJsonObject(QJsonObject json) {
    ...
    m_last_decrypted_isValid = ::OpenAPI::fromJsonValue(m_last_decrypted, json[QString("last_decrypted")]);
    m_last_decrypted_isSet = !json[QString("last_decrypted")].isNull() && m_last_decrypted_isValid;
...
QString OAICreateManagedCredential_request::asJson() const {
...
QJsonObject OAICreateManagedCredential_request::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
    ...
    if (m_last_decrypted_isSet) {
        obj.insert(QString("last_decrypted"), ::OpenAPI::toJsonValue(m_last_decrypted));
    }
    if (m_password_isSet) {
...
qint32 OAICreateManagedCredential_request::getId() const {
    return m_id;
}
void OAICreateManagedCredential_request::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateManagedCredential_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateManagedCredential_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateManagedCredential_request::getLabel() const {
    return m_label;
}
void OAICreateManagedCredential_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateManagedCredential_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateManagedCredential_request::is_label_Valid() const{
    return m_label_isValid;
}

QDateTime OAICreateManagedCredential_request::getLastDecrypted() const {
    return m_last_decrypted;
}
void OAICreateManagedCredential_request::setLastDecrypted(const QDateTime &last_decrypted) {
    m_last_decrypted = last_decrypted;
    m_last_decrypted_isSet = true;
}

bool OAICreateManagedCredential_request::is_last_decrypted_Set() const{
    return m_last_decrypted_isSet;
}

bool OAICreateManagedCredential_request::is_last_decrypted_Valid() const{
    return m_last_decrypted_isValid;
}

QString OAICreateManagedCredential_request::getPassword() const {
    return m_password;
}
void OAICreateManagedCredential_request::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAICreateManagedCredential_request::is_password_Set() const{
    return m_password_isSet;
}

bool OAICreateManagedCredential_request::is_password_Valid() const{
    return m_password_isValid;
}

QString OAICreateManagedCredential_request::getUsername() const {
    return m_username;
}
void OAICreateManagedCredential_request::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAICreateManagedCredential_request::is_username_Set() const{
    return m_username_isSet;
}

bool OAICreateManagedCredential_request::is_username_Valid() const{
    return m_username_isValid;
}

bool OAICreateManagedCredential_request::isSet() const {
...
bool OAICreateManagedCredential_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_label_isValid && m_password_isValid && true;
}
