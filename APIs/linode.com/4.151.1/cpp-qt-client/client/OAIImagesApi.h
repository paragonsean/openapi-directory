...
#include "OAICreateImage_request.h"
#include "OAIGetAccount_default_response.h"
#include "OAIGetImages_200_response.h"
#include "OAIImage.h"
#include "OAIObject.h"
#include "OAI_images_upload_post_200_response.h"
...
public:
    ...
    /**
    * @param[in]  oai_create_image_request OAICreateImage_request [optional]
    */
    virtual void createImage(const ::OpenAPI::OptionalParam<OAICreateImage_request> &oai_create_image_request = ::OpenAPI::OptionalParam<OAICreateImage_request>());

    /**
    * @param[in]  image_id QString [required]
    */
    virtual void deleteImage(const QString &image_id);

    /**
    * @param[in]  image_id QString [required]
    */
    virtual void getImage(const QString &image_id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getImages(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  oai_images_upload_post_request OAI_images_upload_post_request [optional]
    */
    virtual void imagesUploadPost(const ::OpenAPI::OptionalParam<OAI_images_upload_post_request> &oai_images_upload_post_request = ::OpenAPI::OptionalParam<OAI_images_upload_post_request>());

    /**
    * @param[in]  image_id QString [required]
    * @param[in]  oai_image OAIImage [required]
    */
    virtual void updateImage(const QString &image_id, const OAIImage &oai_image);
...
private:
    ...
    void imagesUploadPostCallback(OAIHttpRequestWorker *worker);
    void updateImageCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createImageSignal(OAIImage summary);
    void deleteImageSignal(OAIObject summary);
    void getImageSignal(OAIImage summary);
    void getImagesSignal(OAIGetImages_200_response summary);
    void imagesUploadPostSignal(OAI_images_upload_post_200_response summary);
    void updateImageSignal(OAIImage summary);


    void createImageSignalFull(OAIHttpRequestWorker *worker, OAIImage summary);
    ...
    void getImagesSignalFull(OAIHttpRequestWorker *worker, OAIGetImages_200_response summary);
    void imagesUploadPostSignalFull(OAIHttpRequestWorker *worker, OAI_images_upload_post_200_response summary);
    void updateImageSignalFull(OAIHttpRequestWorker *worker, OAIImage summary);

    Q_DECL_DEPRECATED_X("Use createImageSignalError() instead")
    void createImageSignalE(OAIImage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createImageSignalError(OAIImage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void getImagesSignalE(OAIGetImages_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getImagesSignalError(OAIGetImages_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use imagesUploadPostSignalError() instead")
    void imagesUploadPostSignalE(OAI_images_upload_post_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesUploadPostSignalError(OAI_images_upload_post_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateImageSignalError() instead")
    void updateImageSignalE(OAIImage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateImageSignalError(OAIImage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use imagesUploadPostSignalErrorFull() instead")
    void imagesUploadPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesUploadPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
