...
#include "OAIPostIPv6Range_request.h"
...
OAIPostIPv6Range_request::OAIPostIPv6Range_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostIPv6Range_request::OAIPostIPv6Range_request() {
    this->initializeModel();
}

OAIPostIPv6Range_request::~OAIPostIPv6Range_request() {}

void OAIPostIPv6Range_request::initializeModel() {
...
void OAIPostIPv6Range_request::fromJson(QString jsonString) {
...
void OAIPostIPv6Range_request::fromJsonObject(QJsonObject json) {
...
QString OAIPostIPv6Range_request::asJson() const {
...
QJsonObject OAIPostIPv6Range_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPostIPv6Range_request::getLinodeId() const {
    return m_linode_id;
}
void OAIPostIPv6Range_request::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIPostIPv6Range_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIPostIPv6Range_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAIPostIPv6Range_request::getPrefixLength() const {
    return m_prefix_length;
}
void OAIPostIPv6Range_request::setPrefixLength(const qint32 &prefix_length) {
    m_prefix_length = prefix_length;
    m_prefix_length_isSet = true;
}

bool OAIPostIPv6Range_request::is_prefix_length_Set() const{
    return m_prefix_length_isSet;
}

bool OAIPostIPv6Range_request::is_prefix_length_Valid() const{
    return m_prefix_length_isValid;
}

QString OAIPostIPv6Range_request::getRouteTarget() const {
    return m_route_target;
}
void OAIPostIPv6Range_request::setRouteTarget(const QString &route_target) {
    m_route_target = route_target;
    m_route_target_isSet = true;
}

bool OAIPostIPv6Range_request::is_route_target_Set() const{
    return m_route_target_isSet;
}

bool OAIPostIPv6Range_request::is_route_target_Valid() const{
    return m_route_target_isValid;
}

bool OAIPostIPv6Range_request::isSet() const {
...
bool OAIPostIPv6Range_request::isValid() const {
