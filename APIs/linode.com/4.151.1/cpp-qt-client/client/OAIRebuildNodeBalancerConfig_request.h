...
/*
 * OAIRebuildNodeBalancerConfig_request.h
 *
 * 
 */

#ifndef OAIRebuildNodeBalancerConfig_request_H
#define OAIRebuildNodeBalancerConfig_request_H

#include <QJsonObject>

#include "OAINodeBalancerConfig_nodes_status.h"
...
namespace OpenAPI {
class OAINodeBalancerConfig_nodes_status;
class OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner;

class OAIRebuildNodeBalancerConfig_request : public OAIObject {
public:
    OAIRebuildNodeBalancerConfig_request();
    OAIRebuildNodeBalancerConfig_request(QString json);
    ~OAIRebuildNodeBalancerConfig_request() override;
    ...
    qint32 getCheckAttempts() const;
    void setCheckAttempts(const qint32 &check_attempts);
    bool is_check_attempts_Set() const;
    bool is_check_attempts_Valid() const;

    QString getCheckBody() const;
    void setCheckBody(const QString &check_body);
    bool is_check_body_Set() const;
    bool is_check_body_Valid() const;

    qint32 getCheckInterval() const;
    void setCheckInterval(const qint32 &check_interval);
    bool is_check_interval_Set() const;
    bool is_check_interval_Valid() const;

    bool isCheckPassive() const;
    void setCheckPassive(const bool &check_passive);
    bool is_check_passive_Set() const;
    bool is_check_passive_Valid() const;

    QString getCheckPath() const;
    void setCheckPath(const QString &check_path);
    bool is_check_path_Set() const;
    bool is_check_path_Valid() const;

    qint32 getCheckTimeout() const;
    void setCheckTimeout(const qint32 &check_timeout);
    bool is_check_timeout_Set() const;
    bool is_check_timeout_Valid() const;

    QString getCipherSuite() const;
    void setCipherSuite(const QString &cipher_suite);
    bool is_cipher_suite_Set() const;
    bool is_cipher_suite_Valid() const;
    ...
    OAINodeBalancerConfig_nodes_status getNodesStatus() const;
    void setNodesStatus(const OAINodeBalancerConfig_nodes_status &nodes_status);
    bool is_nodes_status_Set() const;
    bool is_nodes_status_Valid() const;
    ...
    QString getProxyProtocol() const;
    void setProxyProtocol(const QString &proxy_protocol);
    bool is_proxy_protocol_Set() const;
    bool is_proxy_protocol_Valid() const;

    QString getSslCert() const;
    void setSslCert(const QString &ssl_cert);
    bool is_ssl_cert_Set() const;
    bool is_ssl_cert_Valid() const;

    QString getSslCommonname() const;
    void setSslCommonname(const QString &ssl_commonname);
    bool is_ssl_commonname_Set() const;
    bool is_ssl_commonname_Valid() const;

    QString getSslFingerprint() const;
    void setSslFingerprint(const QString &ssl_fingerprint);
    bool is_ssl_fingerprint_Set() const;
    bool is_ssl_fingerprint_Valid() const;
    ...
    QString getStickiness() const;
    void setStickiness(const QString &stickiness);
    bool is_stickiness_Set() const;
    bool is_stickiness_Valid() const;

    QList<OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner> getNodes() const;
    void setNodes(const QList<OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner> &nodes);
...
private:
    ...
    qint32 m_check_attempts;
    bool m_check_attempts_isSet;
    bool m_check_attempts_isValid;

    QString m_check_body;
    bool m_check_body_isSet;
    bool m_check_body_isValid;

    qint32 m_check_interval;
    bool m_check_interval_isSet;
    bool m_check_interval_isValid;

    bool m_check_passive;
    bool m_check_passive_isSet;
    bool m_check_passive_isValid;

    QString m_check_path;
    bool m_check_path_isSet;
    bool m_check_path_isValid;

    qint32 m_check_timeout;
    bool m_check_timeout_isSet;
    bool m_check_timeout_isValid;

    QString m_cipher_suite;
    bool m_cipher_suite_isSet;
    bool m_cipher_suite_isValid;
    ...
    OAINodeBalancerConfig_nodes_status m_nodes_status;
    bool m_nodes_status_isSet;
    bool m_nodes_status_isValid;
    ...
    QString m_proxy_protocol;
    bool m_proxy_protocol_isSet;
    bool m_proxy_protocol_isValid;

    QString m_ssl_cert;
    bool m_ssl_cert_isSet;
    bool m_ssl_cert_isValid;

    QString m_ssl_commonname;
    bool m_ssl_commonname_isSet;
    bool m_ssl_commonname_isValid;

    QString m_ssl_fingerprint;
    bool m_ssl_fingerprint_isSet;
    bool m_ssl_fingerprint_isValid;

    QString m_ssl_key;
    bool m_ssl_key_isSet;
    bool m_ssl_key_isValid;

    QString m_stickiness;
    bool m_stickiness_isSet;
    bool m_stickiness_isValid;

    QList<OAIRebuildNodeBalancerConfig_request_allOf_nodes_inner> m_nodes;
    bool m_nodes_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebuildNodeBalancerConfig_request)

#endif // OAIRebuildNodeBalancerConfig_request_H
