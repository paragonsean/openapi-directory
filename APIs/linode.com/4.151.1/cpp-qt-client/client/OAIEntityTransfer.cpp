...
OAIEntityTransfer::OAIEntityTransfer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityTransfer::OAIEntityTransfer() {
    this->initializeModel();
}

OAIEntityTransfer::~OAIEntityTransfer() {}

void OAIEntityTransfer::initializeModel() {
...
void OAIEntityTransfer::fromJson(QString jsonString) {
...
void OAIEntityTransfer::fromJsonObject(QJsonObject json) {
...
QString OAIEntityTransfer::asJson() const {
...
QJsonObject OAIEntityTransfer::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIEntityTransfer::getCreated() const {
    return m_created;
}
void OAIEntityTransfer::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIEntityTransfer::is_created_Set() const{
    return m_created_isSet;
}

bool OAIEntityTransfer::is_created_Valid() const{
    return m_created_isValid;
}

OAIEntityTransfer_entities OAIEntityTransfer::getEntities() const {
    return m_entities;
}
void OAIEntityTransfer::setEntities(const OAIEntityTransfer_entities &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIEntityTransfer::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIEntityTransfer::is_entities_Valid() const{
    return m_entities_isValid;
}

QDateTime OAIEntityTransfer::getExpiry() const {
    return m_expiry;
}
void OAIEntityTransfer::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIEntityTransfer::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIEntityTransfer::is_expiry_Valid() const{
    return m_expiry_isValid;
}

bool OAIEntityTransfer::isIsSender() const {
    return m_is_sender;
}
void OAIEntityTransfer::setIsSender(const bool &is_sender) {
    m_is_sender = is_sender;
    m_is_sender_isSet = true;
}

bool OAIEntityTransfer::is_is_sender_Set() const{
    return m_is_sender_isSet;
}

bool OAIEntityTransfer::is_is_sender_Valid() const{
    return m_is_sender_isValid;
}

QString OAIEntityTransfer::getStatus() const {
    return m_status;
}
void OAIEntityTransfer::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEntityTransfer::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEntityTransfer::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIEntityTransfer::getToken() const {
    return m_token;
}
void OAIEntityTransfer::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIEntityTransfer::is_token_Set() const{
    return m_token_isSet;
}

bool OAIEntityTransfer::is_token_Valid() const{
    return m_token_isValid;
}

QDateTime OAIEntityTransfer::getUpdated() const {
    return m_updated;
}
void OAIEntityTransfer::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIEntityTransfer::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIEntityTransfer::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIEntityTransfer::isSet() const {
...
bool OAIEntityTransfer::isValid() const {
