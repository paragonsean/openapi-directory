...
#include "OAILKENodePool_autoscaler.h"
...
OAILKENodePool_autoscaler::OAILKENodePool_autoscaler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILKENodePool_autoscaler::OAILKENodePool_autoscaler() {
    this->initializeModel();
}

OAILKENodePool_autoscaler::~OAILKENodePool_autoscaler() {}

void OAILKENodePool_autoscaler::initializeModel() {
...
void OAILKENodePool_autoscaler::fromJson(QString jsonString) {
...
void OAILKENodePool_autoscaler::fromJsonObject(QJsonObject json) {
...
QString OAILKENodePool_autoscaler::asJson() const {
...
QJsonObject OAILKENodePool_autoscaler::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAILKENodePool_autoscaler::isEnabled() const {
    return m_enabled;
}
void OAILKENodePool_autoscaler::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILKENodePool_autoscaler::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILKENodePool_autoscaler::is_enabled_Valid() const{
    return m_enabled_isValid;
}

qint32 OAILKENodePool_autoscaler::getMax() const {
    return m_max;
}
void OAILKENodePool_autoscaler::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAILKENodePool_autoscaler::is_max_Set() const{
    return m_max_isSet;
}

bool OAILKENodePool_autoscaler::is_max_Valid() const{
    return m_max_isValid;
}

qint32 OAILKENodePool_autoscaler::getMin() const {
    return m_min;
}
void OAILKENodePool_autoscaler::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAILKENodePool_autoscaler::is_min_Set() const{
    return m_min_isSet;
}

bool OAILKENodePool_autoscaler::is_min_Valid() const{
    return m_min_isValid;
}

bool OAILKENodePool_autoscaler::isSet() const {
...
bool OAILKENodePool_autoscaler::isValid() const {
