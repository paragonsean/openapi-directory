...
void OAIAccountSettings::initializeModel() {
    ...
    m_longview_subscription_isSet = false;
    m_longview_subscription_isValid = false;

    m_managed_isSet = false;
    m_managed_isValid = false;

    m_network_helper_isSet = false;
    m_network_helper_isValid = false;

    m_object_storage_isSet = false;
    m_object_storage_isValid = false;
}
...
void OAIAccountSettings::fromJsonObject(QJsonObject json) {
    ...
    m_longview_subscription_isValid = ::OpenAPI::fromJsonValue(m_longview_subscription, json[QString("longview_subscription")]);
    m_longview_subscription_isSet = !json[QString("longview_subscription")].isNull() && m_longview_subscription_isValid;
    ...
    m_network_helper_isValid = ::OpenAPI::fromJsonValue(m_network_helper, json[QString("network_helper")]);
    m_network_helper_isSet = !json[QString("network_helper")].isNull() && m_network_helper_isValid;

    m_object_storage_isValid = ::OpenAPI::fromJsonValue(m_object_storage, json[QString("object_storage")]);
    m_object_storage_isSet = !json[QString("object_storage")].isNull() && m_object_storage_isValid;
}
...
QJsonObject OAIAccountSettings::asJsonObject() const {
    ...
    if (m_longview_subscription_isSet) {
        obj.insert(QString("longview_subscription"), ::OpenAPI::toJsonValue(m_longview_subscription));
    }
    if (m_managed_isSet) {
        obj.insert(QString("managed"), ::OpenAPI::toJsonValue(m_managed));
    }
    if (m_network_helper_isSet) {
        obj.insert(QString("network_helper"), ::OpenAPI::toJsonValue(m_network_helper));
    }
    if (m_object_storage_isSet) {
        obj.insert(QString("object_storage"), ::OpenAPI::toJsonValue(m_object_storage));
    }
    return obj;
}

bool OAIAccountSettings::isBackupsEnabled() const {
    return m_backups_enabled;
}
void OAIAccountSettings::setBackupsEnabled(const bool &backups_enabled) {
    m_backups_enabled = backups_enabled;
    m_backups_enabled_isSet = true;
}

bool OAIAccountSettings::is_backups_enabled_Set() const{
    return m_backups_enabled_isSet;
}

bool OAIAccountSettings::is_backups_enabled_Valid() const{
    return m_backups_enabled_isValid;
}

QString OAIAccountSettings::getLongviewSubscription() const {
    return m_longview_subscription;
}
void OAIAccountSettings::setLongviewSubscription(const QString &longview_subscription) {
    m_longview_subscription = longview_subscription;
    m_longview_subscription_isSet = true;
}

bool OAIAccountSettings::is_longview_subscription_Set() const{
    return m_longview_subscription_isSet;
}

bool OAIAccountSettings::is_longview_subscription_Valid() const{
    return m_longview_subscription_isValid;
}

bool OAIAccountSettings::isManaged() const {
    return m_managed;
}
void OAIAccountSettings::setManaged(const bool &managed) {
    m_managed = managed;
    m_managed_isSet = true;
}

bool OAIAccountSettings::is_managed_Set() const{
    return m_managed_isSet;
}

bool OAIAccountSettings::is_managed_Valid() const{
    return m_managed_isValid;
}

bool OAIAccountSettings::isNetworkHelper() const {
    return m_network_helper;
}
void OAIAccountSettings::setNetworkHelper(const bool &network_helper) {
    m_network_helper = network_helper;
    m_network_helper_isSet = true;
}

bool OAIAccountSettings::is_network_helper_Set() const{
    return m_network_helper_isSet;
}

bool OAIAccountSettings::is_network_helper_Valid() const{
    return m_network_helper_isValid;
}

QString OAIAccountSettings::getObjectStorage() const {
    return m_object_storage;
}
void OAIAccountSettings::setObjectStorage(const QString &object_storage) {
    m_object_storage = object_storage;
    m_object_storage_isSet = true;
}

bool OAIAccountSettings::is_object_storage_Set() const{
    return m_object_storage_isSet;
}

bool OAIAccountSettings::is_object_storage_Valid() const{
    return m_object_storage_isValid;
}
