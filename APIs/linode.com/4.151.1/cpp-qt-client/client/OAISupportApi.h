...
#include "OAICreateTicketReply_request.h"
#include "OAIGetAccount_default_response.h"
#include "OAIGetTicketReplies_200_response.h"
#include "OAIGetTickets_200_response.h"
#include "OAIObject.h"
#include "OAISupportTicket.h"
#include "OAISupportTicketReply.h"
#include "OAISupportTicketRequest.h"
#include <QString>
...
public:
    ...
    /**
    * @param[in]  ticket_id qint32 [required]
    */
    virtual void closeTicket(const qint32 &ticket_id);

    /**
    * @param[in]  oai_support_ticket_request OAISupportTicketRequest [optional]
    */
    virtual void createTicket(const ::OpenAPI::OptionalParam<OAISupportTicketRequest> &oai_support_ticket_request = ::OpenAPI::OptionalParam<OAISupportTicketRequest>());

    /**
    * @param[in]  ticket_id qint32 [required]
    * @param[in]  file QString [required]
    */
    virtual void createTicketAttachment(const qint32 &ticket_id, const QString &file);

    /**
    * @param[in]  ticket_id qint32 [required]
    * @param[in]  oai_create_ticket_reply_request OAICreateTicketReply_request [required]
    */
    virtual void createTicketReply(const qint32 &ticket_id, const OAICreateTicketReply_request &oai_create_ticket_reply_request);

    /**
    * @param[in]  ticket_id qint32 [required]
    */
    virtual void getTicket(const qint32 &ticket_id);
    ...
    */
    virtual void getTicketReplies(const qint32 &ticket_id, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getTickets(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void createTicketAttachmentCallback(OAIHttpRequestWorker *worker);
    void createTicketReplyCallback(OAIHttpRequestWorker *worker);
    void getTicketCallback(OAIHttpRequestWorker *worker);
    void getTicketRepliesCallback(OAIHttpRequestWorker *worker);
    void getTicketsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void closeTicketSignal(OAIObject summary);
    void createTicketSignal(OAISupportTicket summary);
    void createTicketAttachmentSignal(OAIObject summary);
    void createTicketReplySignal(OAISupportTicketReply summary);
    void getTicketSignal(OAISupportTicket summary);
    void getTicketRepliesSignal(OAIGetTicketReplies_200_response summary);
    void getTicketsSignal(OAIGetTickets_200_response summary);


    void closeTicketSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void createTicketSignalFull(OAIHttpRequestWorker *worker, OAISupportTicket summary);
    void createTicketAttachmentSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void createTicketReplySignalFull(OAIHttpRequestWorker *worker, OAISupportTicketReply summary);
    void getTicketSignalFull(OAIHttpRequestWorker *worker, OAISupportTicket summary);
    void getTicketRepliesSignalFull(OAIHttpRequestWorker *worker, OAIGetTicketReplies_200_response summary);
    void getTicketsSignalFull(OAIHttpRequestWorker *worker, OAIGetTickets_200_response summary);

    Q_DECL_DEPRECATED_X("Use closeTicketSignalError() instead")
    void closeTicketSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void closeTicketSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createTicketSignalError() instead")
    void createTicketSignalE(OAISupportTicket summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createTicketSignalError(OAISupportTicket summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createTicketAttachmentSignalError() instead")
    void createTicketAttachmentSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createTicketAttachmentSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createTicketReplySignalError() instead")
    void createTicketReplySignalE(OAISupportTicketReply summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createTicketReplySignalError(OAISupportTicketReply summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTicketSignalError() instead")
    void getTicketSignalE(OAISupportTicket summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTicketSignalError(OAISupportTicket summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTicketRepliesSignalError() instead")
    void getTicketRepliesSignalE(OAIGetTicketReplies_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTicketRepliesSignalError(OAIGetTicketReplies_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTicketsSignalError() instead")
    void getTicketsSignalE(OAIGetTickets_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTicketsSignalError(OAIGetTickets_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use createTicketAttachmentSignalErrorFull() instead")
    void createTicketAttachmentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createTicketAttachmentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createTicketReplySignalErrorFull() instead")
    void createTicketReplySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createTicketReplySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTicketSignalErrorFull() instead")
    void getTicketSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getTicketSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTicketRepliesSignalErrorFull() instead")
    void getTicketRepliesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getTicketRepliesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
