...
OAIIPAddressV6Slaac::OAIIPAddressV6Slaac(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPAddressV6Slaac::OAIIPAddressV6Slaac() {
    this->initializeModel();
}

OAIIPAddressV6Slaac::~OAIIPAddressV6Slaac() {}

void OAIIPAddressV6Slaac::initializeModel() {
...
void OAIIPAddressV6Slaac::fromJson(QString jsonString) {
...
void OAIIPAddressV6Slaac::fromJsonObject(QJsonObject json) {
...
QString OAIIPAddressV6Slaac::asJson() const {
...
QJsonObject OAIIPAddressV6Slaac::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIIPAddressV6Slaac::getAddress() const {
    return m_address;
}
void OAIIPAddressV6Slaac::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIPAddressV6Slaac::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIPAddressV6Slaac::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIPAddressV6Slaac::getGateway() const {
    return m_gateway;
}
void OAIIPAddressV6Slaac::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAIIPAddressV6Slaac::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAIIPAddressV6Slaac::is_gateway_Valid() const{
    return m_gateway_isValid;
}

qint32 OAIIPAddressV6Slaac::getLinodeId() const {
    return m_linode_id;
}
void OAIIPAddressV6Slaac::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIIPAddressV6Slaac::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIIPAddressV6Slaac::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAIIPAddressV6Slaac::getPrefix() const {
    return m_prefix;
}
void OAIIPAddressV6Slaac::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPAddressV6Slaac::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPAddressV6Slaac::is_prefix_Valid() const{
    return m_prefix_isValid;
}

bool OAIIPAddressV6Slaac::isRPublic() const {
    return m_r_public;
}
void OAIIPAddressV6Slaac::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIIPAddressV6Slaac::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIIPAddressV6Slaac::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIIPAddressV6Slaac::getRdns() const {
    return m_rdns;
}
void OAIIPAddressV6Slaac::setRdns(const QString &rdns) {
    m_rdns = rdns;
    m_rdns_isSet = true;
}

bool OAIIPAddressV6Slaac::is_rdns_Set() const{
    return m_rdns_isSet;
}

bool OAIIPAddressV6Slaac::is_rdns_Valid() const{
    return m_rdns_isValid;
}

QString OAIIPAddressV6Slaac::getRegion() const {
    return m_region;
}
void OAIIPAddressV6Slaac::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPAddressV6Slaac::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPAddressV6Slaac::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIIPAddressV6Slaac::getSubnetMask() const {
    return m_subnet_mask;
}
void OAIIPAddressV6Slaac::setSubnetMask(const QString &subnet_mask) {
    m_subnet_mask = subnet_mask;
    m_subnet_mask_isSet = true;
}

bool OAIIPAddressV6Slaac::is_subnet_mask_Set() const{
    return m_subnet_mask_isSet;
}

bool OAIIPAddressV6Slaac::is_subnet_mask_Valid() const{
    return m_subnet_mask_isValid;
}

QString OAIIPAddressV6Slaac::getType() const {
    return m_type;
}
void OAIIPAddressV6Slaac::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIPAddressV6Slaac::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIPAddressV6Slaac::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIIPAddressV6Slaac::isSet() const {
...
bool OAIIPAddressV6Slaac::isValid() const {
