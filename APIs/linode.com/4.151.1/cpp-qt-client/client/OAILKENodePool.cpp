...
OAILKENodePool::OAILKENodePool(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILKENodePool::OAILKENodePool() {
    this->initializeModel();
}

OAILKENodePool::~OAILKENodePool() {}

void OAILKENodePool::initializeModel() {
...
void OAILKENodePool::fromJson(QString jsonString) {
...
void OAILKENodePool::fromJsonObject(QJsonObject json) {
...
QString OAILKENodePool::asJson() const {
...
QJsonObject OAILKENodePool::asJsonObject() const {
    QJsonObject obj;
...
OAILKENodePool_autoscaler OAILKENodePool::getAutoscaler() const {
    return m_autoscaler;
}
void OAILKENodePool::setAutoscaler(const OAILKENodePool_autoscaler &autoscaler) {
    m_autoscaler = autoscaler;
    m_autoscaler_isSet = true;
}

bool OAILKENodePool::is_autoscaler_Set() const{
    return m_autoscaler_isSet;
}

bool OAILKENodePool::is_autoscaler_Valid() const{
    return m_autoscaler_isValid;
}

qint32 OAILKENodePool::getCount() const {
    return m_count;
}
void OAILKENodePool::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAILKENodePool::is_count_Set() const{
    return m_count_isSet;
}

bool OAILKENodePool::is_count_Valid() const{
    return m_count_isValid;
}

QList<OAILKENodePool_disks_inner> OAILKENodePool::getDisks() const {
    return m_disks;
}
void OAILKENodePool::setDisks(const QList<OAILKENodePool_disks_inner> &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAILKENodePool::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAILKENodePool::is_disks_Valid() const{
    return m_disks_isValid;
}

qint32 OAILKENodePool::getId() const {
    return m_id;
}
void OAILKENodePool::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILKENodePool::is_id_Set() const{
    return m_id_isSet;
}

bool OAILKENodePool::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAILKENodeStatus> OAILKENodePool::getNodes() const {
    return m_nodes;
}
void OAILKENodePool::setNodes(const QList<OAILKENodeStatus> &nodes) {
    m_nodes = nodes;
    m_nodes_isSet = true;
}

bool OAILKENodePool::is_nodes_Set() const{
    return m_nodes_isSet;
}

bool OAILKENodePool::is_nodes_Valid() const{
    return m_nodes_isValid;
}

QList<QString> OAILKENodePool::getTags() const {
    return m_tags;
}
void OAILKENodePool::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILKENodePool::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILKENodePool::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAILKENodePool::getType() const {
    return m_type;
}
void OAILKENodePool::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILKENodePool::is_type_Set() const{
    return m_type_isSet;
}

bool OAILKENodePool::is_type_Valid() const{
    return m_type_isValid;
}

bool OAILKENodePool::isSet() const {
...
bool OAILKENodePool::isValid() const {
