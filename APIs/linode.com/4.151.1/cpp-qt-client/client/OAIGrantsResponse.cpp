...
OAIGrantsResponse::OAIGrantsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGrantsResponse::OAIGrantsResponse() {
    this->initializeModel();
}

OAIGrantsResponse::~OAIGrantsResponse() {}

void OAIGrantsResponse::initializeModel() {
    ...
    m_linode_isSet = false;
    m_linode_isValid = false;

    m_longview_isSet = false;
    m_longview_isValid = false;

    m_nodebalancer_isSet = false;
    m_nodebalancer_isValid = false;

    m_stackscript_isSet = false;
    m_stackscript_isValid = false;

    m_volume_isSet = false;
    m_volume_isValid = false;
}

void OAIGrantsResponse::fromJson(QString jsonString) {
...
void OAIGrantsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_linode_isValid = ::OpenAPI::fromJsonValue(m_linode, json[QString("linode")]);
    m_linode_isSet = !json[QString("linode")].isNull() && m_linode_isValid;

    m_longview_isValid = ::OpenAPI::fromJsonValue(m_longview, json[QString("longview")]);
    m_longview_isSet = !json[QString("longview")].isNull() && m_longview_isValid;

    m_nodebalancer_isValid = ::OpenAPI::fromJsonValue(m_nodebalancer, json[QString("nodebalancer")]);
    m_nodebalancer_isSet = !json[QString("nodebalancer")].isNull() && m_nodebalancer_isValid;

    m_stackscript_isValid = ::OpenAPI::fromJsonValue(m_stackscript, json[QString("stackscript")]);
    m_stackscript_isSet = !json[QString("stackscript")].isNull() && m_stackscript_isValid;
...
QString OAIGrantsResponse::asJson() const {
...
QJsonObject OAIGrantsResponse::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_linode.size() > 0) {
        obj.insert(QString("linode"), ::OpenAPI::toJsonValue(m_linode));
    }
    if (m_longview.size() > 0) {
        obj.insert(QString("longview"), ::OpenAPI::toJsonValue(m_longview));
    }
    if (m_nodebalancer.size() > 0) {
        obj.insert(QString("nodebalancer"), ::OpenAPI::toJsonValue(m_nodebalancer));
    }
    if (m_stackscript.size() > 0) {
        obj.insert(QString("stackscript"), ::OpenAPI::toJsonValue(m_stackscript));
    }
    if (m_volume.size() > 0) {
...
QList<OAIGrant> OAIGrantsResponse::getDatabase() const {
    return m_database;
}
void OAIGrantsResponse::setDatabase(const QList<OAIGrant> &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAIGrantsResponse::is_database_Set() const{
    return m_database_isSet;
}

bool OAIGrantsResponse::is_database_Valid() const{
    return m_database_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getDomain() const {
    return m_domain;
}
void OAIGrantsResponse::setDomain(const QList<OAIGrant> &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIGrantsResponse::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIGrantsResponse::is_domain_Valid() const{
    return m_domain_isValid;
}

OAIGrantsResponse_global OAIGrantsResponse::getGlobal() const {
    return m_global;
}
void OAIGrantsResponse::setGlobal(const OAIGrantsResponse_global &global) {
    m_global = global;
    m_global_isSet = true;
}

bool OAIGrantsResponse::is_global_Set() const{
    return m_global_isSet;
}

bool OAIGrantsResponse::is_global_Valid() const{
    return m_global_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getImage() const {
    return m_image;
}
void OAIGrantsResponse::setImage(const QList<OAIGrant> &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIGrantsResponse::is_image_Set() const{
    return m_image_isSet;
}

bool OAIGrantsResponse::is_image_Valid() const{
    return m_image_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getLinode() const {
    return m_linode;
}
void OAIGrantsResponse::setLinode(const QList<OAIGrant> &linode) {
    m_linode = linode;
    m_linode_isSet = true;
}

bool OAIGrantsResponse::is_linode_Set() const{
    return m_linode_isSet;
}

bool OAIGrantsResponse::is_linode_Valid() const{
    return m_linode_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getLongview() const {
    return m_longview;
}
void OAIGrantsResponse::setLongview(const QList<OAIGrant> &longview) {
    m_longview = longview;
    m_longview_isSet = true;
}

bool OAIGrantsResponse::is_longview_Set() const{
    return m_longview_isSet;
}

bool OAIGrantsResponse::is_longview_Valid() const{
    return m_longview_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getNodebalancer() const {
    return m_nodebalancer;
}
void OAIGrantsResponse::setNodebalancer(const QList<OAIGrant> &nodebalancer) {
    m_nodebalancer = nodebalancer;
    m_nodebalancer_isSet = true;
}

bool OAIGrantsResponse::is_nodebalancer_Set() const{
    return m_nodebalancer_isSet;
}

bool OAIGrantsResponse::is_nodebalancer_Valid() const{
    return m_nodebalancer_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getStackscript() const {
    return m_stackscript;
}
void OAIGrantsResponse::setStackscript(const QList<OAIGrant> &stackscript) {
    m_stackscript = stackscript;
    m_stackscript_isSet = true;
}

bool OAIGrantsResponse::is_stackscript_Set() const{
    return m_stackscript_isSet;
}

bool OAIGrantsResponse::is_stackscript_Valid() const{
    return m_stackscript_isValid;
}

QList<OAIGrant> OAIGrantsResponse::getVolume() const {
    return m_volume;
}
void OAIGrantsResponse::setVolume(const QList<OAIGrant> &volume) {
    m_volume = volume;
    m_volume_isSet = true;
}

bool OAIGrantsResponse::is_volume_Set() const{
    return m_volume_isSet;
}

bool OAIGrantsResponse::is_volume_Valid() const{
    return m_volume_isValid;
}

bool OAIGrantsResponse::isSet() const {
...
bool OAIGrantsResponse::isValid() const {
