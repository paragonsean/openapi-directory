...
OAITrustedDevice::OAITrustedDevice(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrustedDevice::OAITrustedDevice() {
    this->initializeModel();
}

OAITrustedDevice::~OAITrustedDevice() {}

void OAITrustedDevice::initializeModel() {
    ...
    m_last_authenticated_isSet = false;
    m_last_authenticated_isValid = false;

    m_last_remote_addr_isSet = false;
    m_last_remote_addr_isValid = false;

    m_user_agent_isSet = false;
    m_user_agent_isValid = false;
}

void OAITrustedDevice::fromJson(QString jsonString) {
...
void OAITrustedDevice::fromJsonObject(QJsonObject json) {
    ...
    m_last_authenticated_isValid = ::OpenAPI::fromJsonValue(m_last_authenticated, json[QString("last_authenticated")]);
    m_last_authenticated_isSet = !json[QString("last_authenticated")].isNull() && m_last_authenticated_isValid;

    m_last_remote_addr_isValid = ::OpenAPI::fromJsonValue(m_last_remote_addr, json[QString("last_remote_addr")]);
    m_last_remote_addr_isSet = !json[QString("last_remote_addr")].isNull() && m_last_remote_addr_isValid;
...
QString OAITrustedDevice::asJson() const {
...
QJsonObject OAITrustedDevice::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
    ...
    if (m_last_authenticated_isSet) {
        obj.insert(QString("last_authenticated"), ::OpenAPI::toJsonValue(m_last_authenticated));
    }
    if (m_last_remote_addr_isSet) {
        obj.insert(QString("last_remote_addr"), ::OpenAPI::toJsonValue(m_last_remote_addr));
    }
...
QDateTime OAITrustedDevice::getCreated() const {
    return m_created;
}
void OAITrustedDevice::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAITrustedDevice::is_created_Set() const{
    return m_created_isSet;
}

bool OAITrustedDevice::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAITrustedDevice::getExpiry() const {
    return m_expiry;
}
void OAITrustedDevice::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAITrustedDevice::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAITrustedDevice::is_expiry_Valid() const{
    return m_expiry_isValid;
}

qint32 OAITrustedDevice::getId() const {
    return m_id;
}
void OAITrustedDevice::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITrustedDevice::is_id_Set() const{
    return m_id_isSet;
}

bool OAITrustedDevice::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAITrustedDevice::getLastAuthenticated() const {
    return m_last_authenticated;
}
void OAITrustedDevice::setLastAuthenticated(const QDateTime &last_authenticated) {
    m_last_authenticated = last_authenticated;
    m_last_authenticated_isSet = true;
}

bool OAITrustedDevice::is_last_authenticated_Set() const{
    return m_last_authenticated_isSet;
}

bool OAITrustedDevice::is_last_authenticated_Valid() const{
    return m_last_authenticated_isValid;
}

QString OAITrustedDevice::getLastRemoteAddr() const {
    return m_last_remote_addr;
}
void OAITrustedDevice::setLastRemoteAddr(const QString &last_remote_addr) {
    m_last_remote_addr = last_remote_addr;
    m_last_remote_addr_isSet = true;
}

bool OAITrustedDevice::is_last_remote_addr_Set() const{
    return m_last_remote_addr_isSet;
}

bool OAITrustedDevice::is_last_remote_addr_Valid() const{
    return m_last_remote_addr_isValid;
}

QString OAITrustedDevice::getUserAgent() const {
    return m_user_agent;
}
void OAITrustedDevice::setUserAgent(const QString &user_agent) {
    m_user_agent = user_agent;
    m_user_agent_isSet = true;
}

bool OAITrustedDevice::is_user_agent_Set() const{
    return m_user_agent_isSet;
}

bool OAITrustedDevice::is_user_agent_Valid() const{
    return m_user_agent_isValid;
}

bool OAITrustedDevice::isSet() const {
...
bool OAITrustedDevice::isValid() const {
