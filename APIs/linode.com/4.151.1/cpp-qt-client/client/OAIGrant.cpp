...
qint32 OAIGrant::getId() const {
    return m_id;
}
void OAIGrant::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGrant::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGrant::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGrant::getLabel() const {
    return m_label;
}
void OAIGrant::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIGrant::is_label_Set() const{
    return m_label_isSet;
}

bool OAIGrant::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIGrant::getPermissions() const {
    return m_permissions;
}
void OAIGrant::setPermissions(const QString &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIGrant::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIGrant::is_permissions_Valid() const{
