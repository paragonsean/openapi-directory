...
OAIDatabase_updates::OAIDatabase_updates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabase_updates::OAIDatabase_updates() {
    this->initializeModel();
}

OAIDatabase_updates::~OAIDatabase_updates() {}

void OAIDatabase_updates::initializeModel() {
    ...
    m_week_of_month_isSet = false;
    m_week_of_month_isValid = false;
}

void OAIDatabase_updates::fromJson(QString jsonString) {
...
void OAIDatabase_updates::fromJsonObject(QJsonObject json) {
    ...
    m_hour_of_day_isValid = ::OpenAPI::fromJsonValue(m_hour_of_day, json[QString("hour_of_day")]);
    m_hour_of_day_isSet = !json[QString("hour_of_day")].isNull() && m_hour_of_day_isValid;

    m_week_of_month_isValid = ::OpenAPI::fromJsonValue(m_week_of_month, json[QString("week_of_month")]);
    m_week_of_month_isSet = !json[QString("week_of_month")].isNull() && m_week_of_month_isValid;
}

QString OAIDatabase_updates::asJson() const {
...
QJsonObject OAIDatabase_updates::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_hour_of_day_isSet) {
        obj.insert(QString("hour_of_day"), ::OpenAPI::toJsonValue(m_hour_of_day));
    }
    if (m_week_of_month_isSet) {
        obj.insert(QString("week_of_month"), ::OpenAPI::toJsonValue(m_week_of_month));
    }
    return obj;
}

qint32 OAIDatabase_updates::getDayOfWeek() const {
    return m_day_of_week;
}
void OAIDatabase_updates::setDayOfWeek(const qint32 &day_of_week) {
    m_day_of_week = day_of_week;
    m_day_of_week_isSet = true;
}

bool OAIDatabase_updates::is_day_of_week_Set() const{
    return m_day_of_week_isSet;
}

bool OAIDatabase_updates::is_day_of_week_Valid() const{
    return m_day_of_week_isValid;
}

qint32 OAIDatabase_updates::getDuration() const {
    return m_duration;
}
void OAIDatabase_updates::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIDatabase_updates::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIDatabase_updates::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIDatabase_updates::getFrequency() const {
    return m_frequency;
}
void OAIDatabase_updates::setFrequency(const QString &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAIDatabase_updates::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAIDatabase_updates::is_frequency_Valid() const{
    return m_frequency_isValid;
}

qint32 OAIDatabase_updates::getHourOfDay() const {
    return m_hour_of_day;
}
void OAIDatabase_updates::setHourOfDay(const qint32 &hour_of_day) {
    m_hour_of_day = hour_of_day;
    m_hour_of_day_isSet = true;
}

bool OAIDatabase_updates::is_hour_of_day_Set() const{
    return m_hour_of_day_isSet;
}

bool OAIDatabase_updates::is_hour_of_day_Valid() const{
    return m_hour_of_day_isValid;
}

qint32 OAIDatabase_updates::getWeekOfMonth() const {
    return m_week_of_month;
}
void OAIDatabase_updates::setWeekOfMonth(const qint32 &week_of_month) {
    m_week_of_month = week_of_month;
    m_week_of_month_isSet = true;
}

bool OAIDatabase_updates::is_week_of_month_Set() const{
    return m_week_of_month_isSet;
}

bool OAIDatabase_updates::is_week_of_month_Valid() const{
    return m_week_of_month_isValid;
}

bool OAIDatabase_updates::isSet() const {
...
bool OAIDatabase_updates::isValid() const {
