...
OAIManagedIssue::OAIManagedIssue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedIssue::OAIManagedIssue() {
    this->initializeModel();
}

OAIManagedIssue::~OAIManagedIssue() {}

void OAIManagedIssue::initializeModel() {
...
void OAIManagedIssue::fromJson(QString jsonString) {
...
void OAIManagedIssue::fromJsonObject(QJsonObject json) {
...
QString OAIManagedIssue::asJson() const {
...
QJsonObject OAIManagedIssue::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIManagedIssue::getCreated() const {
    return m_created;
}
void OAIManagedIssue::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIManagedIssue::is_created_Set() const{
    return m_created_isSet;
}

bool OAIManagedIssue::is_created_Valid() const{
    return m_created_isValid;
}

OAIManagedIssue_entity OAIManagedIssue::getEntity() const {
    return m_entity;
}
void OAIManagedIssue::setEntity(const OAIManagedIssue_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIManagedIssue::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIManagedIssue::is_entity_Valid() const{
    return m_entity_isValid;
}

qint32 OAIManagedIssue::getId() const {
    return m_id;
}
void OAIManagedIssue::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedIssue::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedIssue::is_id_Valid() const{
    return m_id_isValid;
}

QList<qint32> OAIManagedIssue::getServices() const {
    return m_services;
}
void OAIManagedIssue::setServices(const QList<qint32> &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIManagedIssue::is_services_Set() const{
    return m_services_isSet;
}

bool OAIManagedIssue::is_services_Valid() const{
    return m_services_isValid;
}

bool OAIManagedIssue::isSet() const {
...
bool OAIManagedIssue::isValid() const {
