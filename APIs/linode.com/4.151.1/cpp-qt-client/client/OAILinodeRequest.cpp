...
OAILinodeRequest::OAILinodeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeRequest::OAILinodeRequest() {
    this->initializeModel();
}

OAILinodeRequest::~OAILinodeRequest() {}

void OAILinodeRequest::initializeModel() {
...
void OAILinodeRequest::fromJson(QString jsonString) {
...
void OAILinodeRequest::fromJsonObject(QJsonObject json) {
...
QString OAILinodeRequest::asJson() const {
...
QJsonObject OAILinodeRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAILinodeRequest::getAuthorizedKeys() const {
    return m_authorized_keys;
}
void OAILinodeRequest::setAuthorizedKeys(const QList<QString> &authorized_keys) {
    m_authorized_keys = authorized_keys;
    m_authorized_keys_isSet = true;
}

bool OAILinodeRequest::is_authorized_keys_Set() const{
    return m_authorized_keys_isSet;
}

bool OAILinodeRequest::is_authorized_keys_Valid() const{
    return m_authorized_keys_isValid;
}

QList<QString> OAILinodeRequest::getAuthorizedUsers() const {
    return m_authorized_users;
}
void OAILinodeRequest::setAuthorizedUsers(const QList<QString> &authorized_users) {
    m_authorized_users = authorized_users;
    m_authorized_users_isSet = true;
}

bool OAILinodeRequest::is_authorized_users_Set() const{
    return m_authorized_users_isSet;
}

bool OAILinodeRequest::is_authorized_users_Valid() const{
    return m_authorized_users_isValid;
}

bool OAILinodeRequest::isBooted() const {
    return m_booted;
}
void OAILinodeRequest::setBooted(const bool &booted) {
    m_booted = booted;
    m_booted_isSet = true;
}

bool OAILinodeRequest::is_booted_Set() const{
    return m_booted_isSet;
}

bool OAILinodeRequest::is_booted_Valid() const{
    return m_booted_isValid;
}

QString OAILinodeRequest::getImage() const {
    return m_image;
}
void OAILinodeRequest::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAILinodeRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAILinodeRequest::is_image_Valid() const{
    return m_image_isValid;
}

QString OAILinodeRequest::getRootPass() const {
    return m_root_pass;
}
void OAILinodeRequest::setRootPass(const QString &root_pass) {
    m_root_pass = root_pass;
    m_root_pass_isSet = true;
}

bool OAILinodeRequest::is_root_pass_Set() const{
    return m_root_pass_isSet;
}

bool OAILinodeRequest::is_root_pass_Valid() const{
    return m_root_pass_isValid;
}

OAIObject OAILinodeRequest::getStackscriptData() const {
    return m_stackscript_data;
}
void OAILinodeRequest::setStackscriptData(const OAIObject &stackscript_data) {
    m_stackscript_data = stackscript_data;
    m_stackscript_data_isSet = true;
}

bool OAILinodeRequest::is_stackscript_data_Set() const{
    return m_stackscript_data_isSet;
}

bool OAILinodeRequest::is_stackscript_data_Valid() const{
    return m_stackscript_data_isValid;
}

qint32 OAILinodeRequest::getStackscriptId() const {
    return m_stackscript_id;
}
void OAILinodeRequest::setStackscriptId(const qint32 &stackscript_id) {
    m_stackscript_id = stackscript_id;
    m_stackscript_id_isSet = true;
}

bool OAILinodeRequest::is_stackscript_id_Set() const{
    return m_stackscript_id_isSet;
}

bool OAILinodeRequest::is_stackscript_id_Valid() const{
    return m_stackscript_id_isValid;
}

bool OAILinodeRequest::isSet() const {
...
bool OAILinodeRequest::isValid() const {
