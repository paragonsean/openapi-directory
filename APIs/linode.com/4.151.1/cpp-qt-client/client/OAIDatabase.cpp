...
void OAIDatabase::fromJsonObject(QJsonObject json) {
    ...
    m_instance_uri_isValid = ::OpenAPI::fromJsonValue(m_instance_uri, json[QString("instance_uri")]);
    m_instance_uri_isSet = !json[QString("instance_uri")].isNull() && m_instance_uri_isValid;
...
QJsonObject OAIDatabase::asJsonObject() const {
    ...
    if (m_instance_uri_isSet) {
        obj.insert(QString("instance_uri"), ::OpenAPI::toJsonValue(m_instance_uri));
    }
    if (m_label_isSet) {
...
QList<QString> OAIDatabase::getAllowList() const {
    return m_allow_list;
}
void OAIDatabase::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabase::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabase::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabase::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabase::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabase::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabase::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

QDateTime OAIDatabase::getCreated() const {
    return m_created;
}
void OAIDatabase::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDatabase::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDatabase::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIDatabase::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabase::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabase::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabase::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabase::getEngine() const {
    return m_engine;
}
void OAIDatabase::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabase::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabase::is_engine_Valid() const{
    return m_engine_isValid;
}

OAIDatabase_hosts OAIDatabase::getHosts() const {
    return m_hosts;
}
void OAIDatabase::setHosts(const OAIDatabase_hosts &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAIDatabase::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAIDatabase::is_hosts_Valid() const{
...
QString OAIDatabase::getInstanceUri() const {
    return m_instance_uri;
}
void OAIDatabase::setInstanceUri(const QString &instance_uri) {
    m_instance_uri = instance_uri;
    m_instance_uri_isSet = true;
}

bool OAIDatabase::is_instance_uri_Set() const{
    return m_instance_uri_isSet;
}

bool OAIDatabase::is_instance_uri_Valid() const{
    return m_instance_uri_isValid;
}

QString OAIDatabase::getLabel() const {
    return m_label;
}
void OAIDatabase::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabase::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabase::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDatabase::getRegion() const {
    return m_region;
}
void OAIDatabase::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabase::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabase::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabase::getStatus() const {
    return m_status;
}
void OAIDatabase::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QDateTime OAIDatabase::getUpdated() const {
    return m_updated;
}
void OAIDatabase::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDatabase::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDatabase::is_updated_Valid() const{
    return m_updated_isValid;
}

OAIDatabase_updates OAIDatabase::getUpdates() const {
    return m_updates;
}
void OAIDatabase::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIDatabase::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIDatabase::is_updates_Valid() const{
    return m_updates_isValid;
}

QString OAIDatabase::getVersion() const {
    return m_version;
}
void OAIDatabase::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDatabase::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDatabase::is_version_Valid() const{
