...
OAIIPv6RangeBGP::OAIIPv6RangeBGP(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPv6RangeBGP::OAIIPv6RangeBGP() {
    this->initializeModel();
}

OAIIPv6RangeBGP::~OAIIPv6RangeBGP() {}

void OAIIPv6RangeBGP::initializeModel() {

    m_is_bgp_isSet = false;
    m_is_bgp_isValid = false;
...
void OAIIPv6RangeBGP::fromJson(QString jsonString) {
...
void OAIIPv6RangeBGP::fromJsonObject(QJsonObject json) {

    m_is_bgp_isValid = ::OpenAPI::fromJsonValue(m_is_bgp, json[QString("is_bgp")]);
    m_is_bgp_isSet = !json[QString("is_bgp")].isNull() && m_is_bgp_isValid;
...
QString OAIIPv6RangeBGP::asJson() const {
...
QJsonObject OAIIPv6RangeBGP::asJsonObject() const {
    QJsonObject obj;
    if (m_is_bgp_isSet) {
        obj.insert(QString("is_bgp"), ::OpenAPI::toJsonValue(m_is_bgp));
    }
    if (m_linodes.size() > 0) {
...
bool OAIIPv6RangeBGP::isIsBgp() const {
    return m_is_bgp;
}
void OAIIPv6RangeBGP::setIsBgp(const bool &is_bgp) {
    m_is_bgp = is_bgp;
    m_is_bgp_isSet = true;
}

bool OAIIPv6RangeBGP::is_is_bgp_Set() const{
    return m_is_bgp_isSet;
}

bool OAIIPv6RangeBGP::is_is_bgp_Valid() const{
    return m_is_bgp_isValid;
}

QList<qint32> OAIIPv6RangeBGP::getLinodes() const {
    return m_linodes;
}
void OAIIPv6RangeBGP::setLinodes(const QList<qint32> &linodes) {
    m_linodes = linodes;
    m_linodes_isSet = true;
}

bool OAIIPv6RangeBGP::is_linodes_Set() const{
    return m_linodes_isSet;
}

bool OAIIPv6RangeBGP::is_linodes_Valid() const{
    return m_linodes_isValid;
}

qint32 OAIIPv6RangeBGP::getPrefix() const {
    return m_prefix;
}
void OAIIPv6RangeBGP::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPv6RangeBGP::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPv6RangeBGP::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIIPv6RangeBGP::getRange() const {
    return m_range;
}
void OAIIPv6RangeBGP::setRange(const QString &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAIIPv6RangeBGP::is_range_Set() const{
    return m_range_isSet;
}

bool OAIIPv6RangeBGP::is_range_Valid() const{
    return m_range_isValid;
}

QString OAIIPv6RangeBGP::getRegion() const {
    return m_region;
}
void OAIIPv6RangeBGP::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPv6RangeBGP::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPv6RangeBGP::is_region_Valid() const{
    return m_region_isValid;
}

bool OAIIPv6RangeBGP::isSet() const {
...
bool OAIIPv6RangeBGP::isValid() const {
