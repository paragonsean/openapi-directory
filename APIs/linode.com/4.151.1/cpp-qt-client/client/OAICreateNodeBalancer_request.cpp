...
OAICreateNodeBalancer_request::OAICreateNodeBalancer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNodeBalancer_request::OAICreateNodeBalancer_request() {
    this->initializeModel();
}

OAICreateNodeBalancer_request::~OAICreateNodeBalancer_request() {}

void OAICreateNodeBalancer_request::initializeModel() {
...
void OAICreateNodeBalancer_request::fromJson(QString jsonString) {
...
void OAICreateNodeBalancer_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateNodeBalancer_request::asJson() const {
...
QJsonObject OAICreateNodeBalancer_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateNodeBalancer_request::getClientConnThrottle() const {
    return m_client_conn_throttle;
}
void OAICreateNodeBalancer_request::setClientConnThrottle(const qint32 &client_conn_throttle) {
    m_client_conn_throttle = client_conn_throttle;
    m_client_conn_throttle_isSet = true;
}

bool OAICreateNodeBalancer_request::is_client_conn_throttle_Set() const{
    return m_client_conn_throttle_isSet;
}

bool OAICreateNodeBalancer_request::is_client_conn_throttle_Valid() const{
    return m_client_conn_throttle_isValid;
}

QList<OAICreateNodeBalancer_request_configs_inner> OAICreateNodeBalancer_request::getConfigs() const {
    return m_configs;
}
void OAICreateNodeBalancer_request::setConfigs(const QList<OAICreateNodeBalancer_request_configs_inner> &configs) {
    m_configs = configs;
    m_configs_isSet = true;
}

bool OAICreateNodeBalancer_request::is_configs_Set() const{
    return m_configs_isSet;
}

bool OAICreateNodeBalancer_request::is_configs_Valid() const{
    return m_configs_isValid;
}

QString OAICreateNodeBalancer_request::getLabel() const {
    return m_label;
}
void OAICreateNodeBalancer_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateNodeBalancer_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateNodeBalancer_request::is_label_Valid() const{
    return m_label_isValid;
}

QString OAICreateNodeBalancer_request::getRegion() const {
    return m_region;
}
void OAICreateNodeBalancer_request::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAICreateNodeBalancer_request::is_region_Set() const{
    return m_region_isSet;
}

bool OAICreateNodeBalancer_request::is_region_Valid() const{
    return m_region_isValid;
}

bool OAICreateNodeBalancer_request::isSet() const {
...
bool OAICreateNodeBalancer_request::isValid() const {
