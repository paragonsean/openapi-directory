...
#include "OAIObjectStorageKey_bucket_access_inner.h"
...
OAIObjectStorageKey_bucket_access_inner::OAIObjectStorageKey_bucket_access_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectStorageKey_bucket_access_inner::OAIObjectStorageKey_bucket_access_inner() {
    this->initializeModel();
}

OAIObjectStorageKey_bucket_access_inner::~OAIObjectStorageKey_bucket_access_inner() {}

void OAIObjectStorageKey_bucket_access_inner::initializeModel() {
...
void OAIObjectStorageKey_bucket_access_inner::fromJson(QString jsonString) {
...
void OAIObjectStorageKey_bucket_access_inner::fromJsonObject(QJsonObject json) {

    m_bucket_name_isValid = ::OpenAPI::fromJsonValue(m_bucket_name, json[QString("bucket_name")]);
    m_bucket_name_isSet = !json[QString("bucket_name")].isNull() && m_bucket_name_isValid;
...
QString OAIObjectStorageKey_bucket_access_inner::asJson() const {
...
QJsonObject OAIObjectStorageKey_bucket_access_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_name_isSet) {
        obj.insert(QString("bucket_name"), ::OpenAPI::toJsonValue(m_bucket_name));
    }
    if (m_cluster_isSet) {
...
QString OAIObjectStorageKey_bucket_access_inner::getBucketName() const {
    return m_bucket_name;
}
void OAIObjectStorageKey_bucket_access_inner::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIObjectStorageKey_bucket_access_inner::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIObjectStorageKey_bucket_access_inner::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIObjectStorageKey_bucket_access_inner::getCluster() const {
    return m_cluster;
}
void OAIObjectStorageKey_bucket_access_inner::setCluster(const QString &cluster) {
    m_cluster = cluster;
    m_cluster_isSet = true;
}

bool OAIObjectStorageKey_bucket_access_inner::is_cluster_Set() const{
    return m_cluster_isSet;
}

bool OAIObjectStorageKey_bucket_access_inner::is_cluster_Valid() const{
    return m_cluster_isValid;
}

QString OAIObjectStorageKey_bucket_access_inner::getPermissions() const {
    return m_permissions;
}
void OAIObjectStorageKey_bucket_access_inner::setPermissions(const QString &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIObjectStorageKey_bucket_access_inner::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIObjectStorageKey_bucket_access_inner::is_permissions_Valid() const{
    return m_permissions_isValid;
}

bool OAIObjectStorageKey_bucket_access_inner::isSet() const {
...
bool OAIObjectStorageKey_bucket_access_inner::isValid() const {
