...
#include "OAILinodeConfig_helpers.h"
...
OAILinodeConfig_helpers::OAILinodeConfig_helpers(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeConfig_helpers::OAILinodeConfig_helpers() {
    this->initializeModel();
}

OAILinodeConfig_helpers::~OAILinodeConfig_helpers() {}

void OAILinodeConfig_helpers::initializeModel() {

    m_devtmpfs_automount_isSet = false;
    m_devtmpfs_automount_isValid = false;

    m_distro_isSet = false;
    m_distro_isValid = false;

    m_modules_dep_isSet = false;
    m_modules_dep_isValid = false;

    m_network_isSet = false;
    m_network_isValid = false;

    m_updatedb_disabled_isSet = false;
    m_updatedb_disabled_isValid = false;
}

void OAILinodeConfig_helpers::fromJson(QString jsonString) {
...
void OAILinodeConfig_helpers::fromJsonObject(QJsonObject json) {

    m_devtmpfs_automount_isValid = ::OpenAPI::fromJsonValue(m_devtmpfs_automount, json[QString("devtmpfs_automount")]);
    m_devtmpfs_automount_isSet = !json[QString("devtmpfs_automount")].isNull() && m_devtmpfs_automount_isValid;
    ...
    m_modules_dep_isValid = ::OpenAPI::fromJsonValue(m_modules_dep, json[QString("modules_dep")]);
    m_modules_dep_isSet = !json[QString("modules_dep")].isNull() && m_modules_dep_isValid;

    m_network_isValid = ::OpenAPI::fromJsonValue(m_network, json[QString("network")]);
    m_network_isSet = !json[QString("network")].isNull() && m_network_isValid;

    m_updatedb_disabled_isValid = ::OpenAPI::fromJsonValue(m_updatedb_disabled, json[QString("updatedb_disabled")]);
    m_updatedb_disabled_isSet = !json[QString("updatedb_disabled")].isNull() && m_updatedb_disabled_isValid;
}

QString OAILinodeConfig_helpers::asJson() const {
...
QJsonObject OAILinodeConfig_helpers::asJsonObject() const {
    QJsonObject obj;
    if (m_devtmpfs_automount_isSet) {
        obj.insert(QString("devtmpfs_automount"), ::OpenAPI::toJsonValue(m_devtmpfs_automount));
    }
    if (m_distro_isSet) {
        obj.insert(QString("distro"), ::OpenAPI::toJsonValue(m_distro));
    }
    if (m_modules_dep_isSet) {
        obj.insert(QString("modules_dep"), ::OpenAPI::toJsonValue(m_modules_dep));
    }
    if (m_network_isSet) {
        obj.insert(QString("network"), ::OpenAPI::toJsonValue(m_network));
    }
    if (m_updatedb_disabled_isSet) {
        obj.insert(QString("updatedb_disabled"), ::OpenAPI::toJsonValue(m_updatedb_disabled));
    }
    return obj;
}

bool OAILinodeConfig_helpers::isDevtmpfsAutomount() const {
    return m_devtmpfs_automount;
}
void OAILinodeConfig_helpers::setDevtmpfsAutomount(const bool &devtmpfs_automount) {
    m_devtmpfs_automount = devtmpfs_automount;
    m_devtmpfs_automount_isSet = true;
}

bool OAILinodeConfig_helpers::is_devtmpfs_automount_Set() const{
    return m_devtmpfs_automount_isSet;
}

bool OAILinodeConfig_helpers::is_devtmpfs_automount_Valid() const{
    return m_devtmpfs_automount_isValid;
}

bool OAILinodeConfig_helpers::isDistro() const {
    return m_distro;
}
void OAILinodeConfig_helpers::setDistro(const bool &distro) {
    m_distro = distro;
    m_distro_isSet = true;
}

bool OAILinodeConfig_helpers::is_distro_Set() const{
    return m_distro_isSet;
}

bool OAILinodeConfig_helpers::is_distro_Valid() const{
    return m_distro_isValid;
}

bool OAILinodeConfig_helpers::isModulesDep() const {
    return m_modules_dep;
}
void OAILinodeConfig_helpers::setModulesDep(const bool &modules_dep) {
    m_modules_dep = modules_dep;
    m_modules_dep_isSet = true;
}

bool OAILinodeConfig_helpers::is_modules_dep_Set() const{
    return m_modules_dep_isSet;
}

bool OAILinodeConfig_helpers::is_modules_dep_Valid() const{
    return m_modules_dep_isValid;
}

bool OAILinodeConfig_helpers::isNetwork() const {
    return m_network;
}
void OAILinodeConfig_helpers::setNetwork(const bool &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAILinodeConfig_helpers::is_network_Set() const{
    return m_network_isSet;
}

bool OAILinodeConfig_helpers::is_network_Valid() const{
    return m_network_isValid;
}

bool OAILinodeConfig_helpers::isUpdatedbDisabled() const {
    return m_updatedb_disabled;
}
void OAILinodeConfig_helpers::setUpdatedbDisabled(const bool &updatedb_disabled) {
    m_updatedb_disabled = updatedb_disabled;
    m_updatedb_disabled_isSet = true;
}

bool OAILinodeConfig_helpers::is_updatedb_disabled_Set() const{
    return m_updatedb_disabled_isSet;
}

bool OAILinodeConfig_helpers::is_updatedb_disabled_Valid() const{
    return m_updatedb_disabled_isValid;
}

bool OAILinodeConfig_helpers::isSet() const {
...
bool OAILinodeConfig_helpers::isValid() const {
