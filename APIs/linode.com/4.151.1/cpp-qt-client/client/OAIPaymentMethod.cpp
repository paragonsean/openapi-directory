...
QDateTime OAIPaymentMethod::getCreated() const {
    return m_created;
}
void OAIPaymentMethod::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPaymentMethod::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPaymentMethod::is_created_Valid() const{
    return m_created_isValid;
}

OAIPaymentMethod_data OAIPaymentMethod::getData() const {
    return m_data;
}
void OAIPaymentMethod::setData(const OAIPaymentMethod_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentMethod::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentMethod::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIPaymentMethod::getId() const {
    return m_id;
}
void OAIPaymentMethod::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
bool OAIPaymentMethod::isIsDefault() const {
    return m_is_default;
}
void OAIPaymentMethod::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAIPaymentMethod::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAIPaymentMethod::is_is_default_Valid() const{
