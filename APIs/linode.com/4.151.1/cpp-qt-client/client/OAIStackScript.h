...
#ifndef OAIStackScript_H
#define OAIStackScript_H
...
namespace OpenAPI {
class OAIUserDefinedField;

class OAIStackScript : public OAIObject {
public:
    OAIStackScript();
    OAIStackScript(QString json);
    ~OAIStackScript() override;
    ...
    qint32 getDeploymentsActive() const;
    void setDeploymentsActive(const qint32 &deployments_active);
    bool is_deployments_active_Set() const;
    bool is_deployments_active_Valid() const;

    qint32 getDeploymentsTotal() const;
    void setDeploymentsTotal(const qint32 &deployments_total);
    bool is_deployments_total_Set() const;
    bool is_deployments_total_Valid() const;
    ...
    QString getRevNote() const;
    void setRevNote(const QString &rev_note);
    bool is_rev_note_Set() const;
    bool is_rev_note_Valid() const;
    ...
    QList<OAIUserDefinedField> getUserDefinedFields() const;
    void setUserDefinedFields(const QList<OAIUserDefinedField> &user_defined_fields);
    bool is_user_defined_fields_Set() const;
    bool is_user_defined_fields_Valid() const;

    QString getUserGravatarId() const;
    void setUserGravatarId(const QString &user_gravatar_id);
    bool is_user_gravatar_id_Set() const;
    bool is_user_gravatar_id_Valid() const;
...
private:
    ...
    qint32 m_deployments_active;
    bool m_deployments_active_isSet;
    bool m_deployments_active_isValid;

    qint32 m_deployments_total;
    bool m_deployments_total_isSet;
    bool m_deployments_total_isValid;
    ...
    QString m_rev_note;
    bool m_rev_note_isSet;
    bool m_rev_note_isValid;
    ...
    QList<OAIUserDefinedField> m_user_defined_fields;
    bool m_user_defined_fields_isSet;
    bool m_user_defined_fields_isValid;

    QString m_user_gravatar_id;
    bool m_user_gravatar_id_isSet;
    bool m_user_gravatar_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackScript)

#endif // OAIStackScript_H
