...
#include "OAISecurityQuestionsGet_security_questions_inner.h"
...
OAISecurityQuestionsGet_security_questions_inner::OAISecurityQuestionsGet_security_questions_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISecurityQuestionsGet_security_questions_inner::OAISecurityQuestionsGet_security_questions_inner() {
    this->initializeModel();
}

OAISecurityQuestionsGet_security_questions_inner::~OAISecurityQuestionsGet_security_questions_inner() {}

void OAISecurityQuestionsGet_security_questions_inner::initializeModel() {
...
void OAISecurityQuestionsGet_security_questions_inner::fromJson(QString jsonString) {
...
void OAISecurityQuestionsGet_security_questions_inner::fromJsonObject(QJsonObject json) {
...
QString OAISecurityQuestionsGet_security_questions_inner::asJson() const {
...
QJsonObject OAISecurityQuestionsGet_security_questions_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAISecurityQuestionsGet_security_questions_inner::getId() const {
    return m_id;
}
void OAISecurityQuestionsGet_security_questions_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISecurityQuestionsGet_security_questions_inner::getQuestion() const {
    return m_question;
}
void OAISecurityQuestionsGet_security_questions_inner::setQuestion(const QString &question) {
    m_question = question;
    m_question_isSet = true;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_question_Set() const{
    return m_question_isSet;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_question_Valid() const{
    return m_question_isValid;
}

QString OAISecurityQuestionsGet_security_questions_inner::getResponse() const {
    return m_response;
}
void OAISecurityQuestionsGet_security_questions_inner::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_response_Set() const{
    return m_response_isSet;
}

bool OAISecurityQuestionsGet_security_questions_inner::is_response_Valid() const{
    return m_response_isValid;
}

bool OAISecurityQuestionsGet_security_questions_inner::isSet() const {
...
bool OAISecurityQuestionsGet_security_questions_inner::isValid() const {
