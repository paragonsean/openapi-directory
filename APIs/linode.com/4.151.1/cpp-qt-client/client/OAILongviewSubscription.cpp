...
OAILongviewSubscription::OAILongviewSubscription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILongviewSubscription::OAILongviewSubscription() {
    this->initializeModel();
}

OAILongviewSubscription::~OAILongviewSubscription() {}

void OAILongviewSubscription::initializeModel() {

    m_clients_included_isSet = false;
    m_clients_included_isValid = false;
...
void OAILongviewSubscription::fromJson(QString jsonString) {
...
void OAILongviewSubscription::fromJsonObject(QJsonObject json) {

    m_clients_included_isValid = ::OpenAPI::fromJsonValue(m_clients_included, json[QString("clients_included")]);
    m_clients_included_isSet = !json[QString("clients_included")].isNull() && m_clients_included_isValid;
...
QString OAILongviewSubscription::asJson() const {
...
QJsonObject OAILongviewSubscription::asJsonObject() const {
    QJsonObject obj;
    if (m_clients_included_isSet) {
        obj.insert(QString("clients_included"), ::OpenAPI::toJsonValue(m_clients_included));
    }
    if (m_id_isSet) {
...
qint32 OAILongviewSubscription::getClientsIncluded() const {
    return m_clients_included;
}
void OAILongviewSubscription::setClientsIncluded(const qint32 &clients_included) {
    m_clients_included = clients_included;
    m_clients_included_isSet = true;
}

bool OAILongviewSubscription::is_clients_included_Set() const{
    return m_clients_included_isSet;
}

bool OAILongviewSubscription::is_clients_included_Valid() const{
    return m_clients_included_isValid;
}

QString OAILongviewSubscription::getId() const {
    return m_id;
}
void OAILongviewSubscription::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILongviewSubscription::is_id_Set() const{
    return m_id_isSet;
}

bool OAILongviewSubscription::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILongviewSubscription::getLabel() const {
    return m_label;
}
void OAILongviewSubscription::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILongviewSubscription::is_label_Set() const{
    return m_label_isSet;
}

bool OAILongviewSubscription::is_label_Valid() const{
    return m_label_isValid;
}

OAILongviewSubscription_price OAILongviewSubscription::getPrice() const {
    return m_price;
}
void OAILongviewSubscription::setPrice(const OAILongviewSubscription_price &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAILongviewSubscription::is_price_Set() const{
    return m_price_isSet;
}

bool OAILongviewSubscription::is_price_Valid() const{
    return m_price_isValid;
}

bool OAILongviewSubscription::isSet() const {
...
bool OAILongviewSubscription::isValid() const {
