...
#include "OAIIPAddressV6LinkLocal.h"
...
OAIIPAddressV6LinkLocal::OAIIPAddressV6LinkLocal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPAddressV6LinkLocal::OAIIPAddressV6LinkLocal() {
    this->initializeModel();
}

OAIIPAddressV6LinkLocal::~OAIIPAddressV6LinkLocal() {}

void OAIIPAddressV6LinkLocal::initializeModel() {
...
void OAIIPAddressV6LinkLocal::fromJson(QString jsonString) {
...
void OAIIPAddressV6LinkLocal::fromJsonObject(QJsonObject json) {
...
QString OAIIPAddressV6LinkLocal::asJson() const {
...
QJsonObject OAIIPAddressV6LinkLocal::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIIPAddressV6LinkLocal::getAddress() const {
    return m_address;
}
void OAIIPAddressV6LinkLocal::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIPAddressV6LinkLocal::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIPAddressV6LinkLocal::getGateway() const {
    return m_gateway;
}
void OAIIPAddressV6LinkLocal::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAIIPAddressV6LinkLocal::is_gateway_Valid() const{
    return m_gateway_isValid;
}

qint32 OAIIPAddressV6LinkLocal::getLinodeId() const {
    return m_linode_id;
}
void OAIIPAddressV6LinkLocal::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIIPAddressV6LinkLocal::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAIIPAddressV6LinkLocal::getPrefix() const {
    return m_prefix;
}
void OAIIPAddressV6LinkLocal::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPAddressV6LinkLocal::is_prefix_Valid() const{
    return m_prefix_isValid;
}

bool OAIIPAddressV6LinkLocal::isRPublic() const {
    return m_r_public;
}
void OAIIPAddressV6LinkLocal::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIIPAddressV6LinkLocal::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIIPAddressV6LinkLocal::getRdns() const {
    return m_rdns;
}
void OAIIPAddressV6LinkLocal::setRdns(const QString &rdns) {
    m_rdns = rdns;
    m_rdns_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_rdns_Set() const{
    return m_rdns_isSet;
}

bool OAIIPAddressV6LinkLocal::is_rdns_Valid() const{
    return m_rdns_isValid;
}

QString OAIIPAddressV6LinkLocal::getRegion() const {
    return m_region;
}
void OAIIPAddressV6LinkLocal::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPAddressV6LinkLocal::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIIPAddressV6LinkLocal::getSubnetMask() const {
    return m_subnet_mask;
}
void OAIIPAddressV6LinkLocal::setSubnetMask(const QString &subnet_mask) {
    m_subnet_mask = subnet_mask;
    m_subnet_mask_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_subnet_mask_Set() const{
    return m_subnet_mask_isSet;
}

bool OAIIPAddressV6LinkLocal::is_subnet_mask_Valid() const{
    return m_subnet_mask_isValid;
}

QString OAIIPAddressV6LinkLocal::getType() const {
    return m_type;
}
void OAIIPAddressV6LinkLocal::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIPAddressV6LinkLocal::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIPAddressV6LinkLocal::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIIPAddressV6LinkLocal::isSet() const {
...
bool OAIIPAddressV6LinkLocal::isValid() const {
