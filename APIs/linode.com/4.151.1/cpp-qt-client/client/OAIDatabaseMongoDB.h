...
/*
 * OAIDatabaseMongoDB.h
 *
 * Managed MongoDB Databases object.
 */

#ifndef OAIDatabaseMongoDB_H
#define OAIDatabaseMongoDB_H

#include <QJsonObject>

#include "OAIDatabaseMongoDB_hosts.h"
#include "OAIDatabase_updates.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIDatabaseMongoDB_hosts;
class OAIDatabase_updates;

class OAIDatabaseMongoDB : public OAIObject {
public:
    OAIDatabaseMongoDB();
    OAIDatabaseMongoDB(QString json);
    ~OAIDatabaseMongoDB() override;
    ...
    qint32 getClusterSize() const;
    void setClusterSize(const qint32 &cluster_size);
    bool is_cluster_size_Set() const;
    bool is_cluster_size_Valid() const;

    QString getCompressionType() const;
    void setCompressionType(const QString &compression_type);
    ...
    OAIDatabaseMongoDB_hosts getHosts() const;
    void setHosts(const OAIDatabaseMongoDB_hosts &hosts);
    ...
    QList<QString> getPeers() const;
    void setPeers(const QList<QString> &peers);
    ...
    QString getReplicaSet() const;
    void setReplicaSet(const QString &replica_set);
    bool is_replica_set_Set() const;
    bool is_replica_set_Valid() const;

    bool isSslConnection() const;
    void setSslConnection(const bool &ssl_connection);
    bool is_ssl_connection_Set() const;
    bool is_ssl_connection_Valid() const;
    ...
    QString getStorageEngine() const;
    void setStorageEngine(const QString &storage_engine);
    bool is_storage_engine_Set() const;
    bool is_storage_engine_Valid() const;
    ...
    OAIDatabase_updates getUpdates() const;
    void setUpdates(const OAIDatabase_updates &updates);
...
private:
    ...
    OAIDatabaseMongoDB_hosts m_hosts;
    bool m_hosts_isSet;
    ...
    QString m_replica_set;
    bool m_replica_set_isSet;
    bool m_replica_set_isValid;

    bool m_ssl_connection;
    bool m_ssl_connection_isSet;
    bool m_ssl_connection_isValid;

    QString m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    QString m_storage_engine;
    bool m_storage_engine_isSet;
    bool m_storage_engine_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseMongoDB)

#endif // OAIDatabaseMongoDB_H
