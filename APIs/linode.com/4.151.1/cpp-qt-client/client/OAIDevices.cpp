...
OAIDevices::OAIDevices(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDevices::OAIDevices() {
    this->initializeModel();
}

OAIDevices::~OAIDevices() {}

void OAIDevices::initializeModel() {
...
void OAIDevices::fromJson(QString jsonString) {
...
void OAIDevices::fromJsonObject(QJsonObject json) {
    ...
    m_sdh_isValid = ::OpenAPI::fromJsonValue(m_sdh, json[QString("sdh")]);
    m_sdh_isSet = !json[QString("sdh")].isNull() && m_sdh_isValid;
}

QString OAIDevices::asJson() const {
...
QJsonObject OAIDevices::asJsonObject() const {
    QJsonObject obj;
    if (m_sda.isSet()) {
    ...
    if (m_sdh.isSet()) {
        obj.insert(QString("sdh"), ::OpenAPI::toJsonValue(m_sdh));
    }
    return obj;
}

OAIDevice OAIDevices::getSda() const {
    return m_sda;
}
void OAIDevices::setSda(const OAIDevice &sda) {
    m_sda = sda;
    m_sda_isSet = true;
}

bool OAIDevices::is_sda_Set() const{
    return m_sda_isSet;
}

bool OAIDevices::is_sda_Valid() const{
    return m_sda_isValid;
}

OAIDevice OAIDevices::getSdb() const {
    return m_sdb;
}
void OAIDevices::setSdb(const OAIDevice &sdb) {
    m_sdb = sdb;
    m_sdb_isSet = true;
}

bool OAIDevices::is_sdb_Set() const{
    return m_sdb_isSet;
}

bool OAIDevices::is_sdb_Valid() const{
    return m_sdb_isValid;
}

OAIDevice OAIDevices::getSdc() const {
    return m_sdc;
}
void OAIDevices::setSdc(const OAIDevice &sdc) {
    m_sdc = sdc;
    m_sdc_isSet = true;
}

bool OAIDevices::is_sdc_Set() const{
    return m_sdc_isSet;
}

bool OAIDevices::is_sdc_Valid() const{
    return m_sdc_isValid;
}

OAIDevice OAIDevices::getSdd() const {
    return m_sdd;
}
void OAIDevices::setSdd(const OAIDevice &sdd) {
    m_sdd = sdd;
    m_sdd_isSet = true;
}

bool OAIDevices::is_sdd_Set() const{
    return m_sdd_isSet;
}

bool OAIDevices::is_sdd_Valid() const{
    return m_sdd_isValid;
}

OAIDevice OAIDevices::getSde() const {
    return m_sde;
}
void OAIDevices::setSde(const OAIDevice &sde) {
    m_sde = sde;
    m_sde_isSet = true;
}

bool OAIDevices::is_sde_Set() const{
    return m_sde_isSet;
}

bool OAIDevices::is_sde_Valid() const{
    return m_sde_isValid;
}

OAIDevice OAIDevices::getSdf() const {
    return m_sdf;
}
void OAIDevices::setSdf(const OAIDevice &sdf) {
    m_sdf = sdf;
    m_sdf_isSet = true;
}

bool OAIDevices::is_sdf_Set() const{
    return m_sdf_isSet;
}

bool OAIDevices::is_sdf_Valid() const{
    return m_sdf_isValid;
}

OAIDevice OAIDevices::getSdg() const {
    return m_sdg;
}
void OAIDevices::setSdg(const OAIDevice &sdg) {
    m_sdg = sdg;
    m_sdg_isSet = true;
}

bool OAIDevices::is_sdg_Set() const{
    return m_sdg_isSet;
}

bool OAIDevices::is_sdg_Valid() const{
    return m_sdg_isValid;
}

OAIDevice OAIDevices::getSdh() const {
    return m_sdh;
}
void OAIDevices::setSdh(const OAIDevice &sdh) {
    m_sdh = sdh;
    m_sdh_isSet = true;
}

bool OAIDevices::is_sdh_Set() const{
    return m_sdh_isSet;
}

bool OAIDevices::is_sdh_Valid() const{
    return m_sdh_isValid;
}

bool OAIDevices::isSet() const {
