...
OAIFirewall::OAIFirewall(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewall::OAIFirewall() {
    this->initializeModel();
}

OAIFirewall::~OAIFirewall() {}

void OAIFirewall::initializeModel() {
...
void OAIFirewall::fromJson(QString jsonString) {
...
void OAIFirewall::fromJsonObject(QJsonObject json) {
...
QString OAIFirewall::asJson() const {
...
QJsonObject OAIFirewall::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIFirewall::getCreated() const {
    return m_created;
}
void OAIFirewall::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIFirewall::is_created_Set() const{
    return m_created_isSet;
}

bool OAIFirewall::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIFirewall::getId() const {
    return m_id;
}
void OAIFirewall::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFirewall::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFirewall::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFirewall::getLabel() const {
    return m_label;
}
void OAIFirewall::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIFirewall::is_label_Set() const{
    return m_label_isSet;
}

bool OAIFirewall::is_label_Valid() const{
    return m_label_isValid;
}

OAIFirewall_rules OAIFirewall::getRules() const {
    return m_rules;
}
void OAIFirewall::setRules(const OAIFirewall_rules &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIFirewall::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIFirewall::is_rules_Valid() const{
    return m_rules_isValid;
}

QString OAIFirewall::getStatus() const {
    return m_status;
}
void OAIFirewall::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFirewall::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFirewall::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAIFirewall::getTags() const {
    return m_tags;
}
void OAIFirewall::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIFirewall::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIFirewall::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIFirewall::getUpdated() const {
    return m_updated;
}
void OAIFirewall::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIFirewall::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIFirewall::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIFirewall::isSet() const {
...
bool OAIFirewall::isValid() const {
