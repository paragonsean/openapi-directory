...
OAIManagedLinodeSettings::OAIManagedLinodeSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedLinodeSettings::OAIManagedLinodeSettings() {
    this->initializeModel();
}

OAIManagedLinodeSettings::~OAIManagedLinodeSettings() {}

void OAIManagedLinodeSettings::initializeModel() {
...
void OAIManagedLinodeSettings::fromJson(QString jsonString) {
...
void OAIManagedLinodeSettings::fromJsonObject(QJsonObject json) {
...
QString OAIManagedLinodeSettings::asJson() const {
...
QJsonObject OAIManagedLinodeSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIManagedLinodeSettings::getGroup() const {
    return m_group;
}
void OAIManagedLinodeSettings::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIManagedLinodeSettings::is_group_Set() const{
    return m_group_isSet;
}

bool OAIManagedLinodeSettings::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAIManagedLinodeSettings::getId() const {
    return m_id;
}
void OAIManagedLinodeSettings::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedLinodeSettings::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedLinodeSettings::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagedLinodeSettings::getLabel() const {
    return m_label;
}
void OAIManagedLinodeSettings::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIManagedLinodeSettings::is_label_Set() const{
    return m_label_isSet;
}

bool OAIManagedLinodeSettings::is_label_Valid() const{
    return m_label_isValid;
}

OAIManagedLinodeSettings_ssh OAIManagedLinodeSettings::getSsh() const {
    return m_ssh;
}
void OAIManagedLinodeSettings::setSsh(const OAIManagedLinodeSettings_ssh &ssh) {
    m_ssh = ssh;
    m_ssh_isSet = true;
}

bool OAIManagedLinodeSettings::is_ssh_Set() const{
    return m_ssh_isSet;
}

bool OAIManagedLinodeSettings::is_ssh_Valid() const{
    return m_ssh_isValid;
}

bool OAIManagedLinodeSettings::isSet() const {
...
bool OAIManagedLinodeSettings::isValid() const {
