...
OAIDatabaseMongoDB::OAIDatabaseMongoDB(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseMongoDB::OAIDatabaseMongoDB() {
    this->initializeModel();
}

OAIDatabaseMongoDB::~OAIDatabaseMongoDB() {}

void OAIDatabaseMongoDB::initializeModel() {
    ...
    m_replica_set_isSet = false;
    m_replica_set_isValid = false;
    ...
    m_storage_engine_isSet = false;
    m_storage_engine_isValid = false;
...
void OAIDatabaseMongoDB::fromJson(QString jsonString) {
...
void OAIDatabaseMongoDB::fromJsonObject(QJsonObject json) {
    ...
    m_compression_type_isValid = ::OpenAPI::fromJsonValue(m_compression_type, json[QString("compression_type")]);
    m_compression_type_isSet = !json[QString("compression_type")].isNull() && m_compression_type_isValid;
    ...
    m_replica_set_isValid = ::OpenAPI::fromJsonValue(m_replica_set, json[QString("replica_set")]);
    m_replica_set_isSet = !json[QString("replica_set")].isNull() && m_replica_set_isValid;
    ...
    m_storage_engine_isValid = ::OpenAPI::fromJsonValue(m_storage_engine, json[QString("storage_engine")]);
    m_storage_engine_isSet = !json[QString("storage_engine")].isNull() && m_storage_engine_isValid;
...
QString OAIDatabaseMongoDB::asJson() const {
...
QJsonObject OAIDatabaseMongoDB::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_compression_type_isSet) {
        obj.insert(QString("compression_type"), ::OpenAPI::toJsonValue(m_compression_type));
    }
    if (m_created_isSet) {
    ...
    if (m_replica_set_isSet) {
        obj.insert(QString("replica_set"), ::OpenAPI::toJsonValue(m_replica_set));
    }
    ...
    if (m_storage_engine_isSet) {
        obj.insert(QString("storage_engine"), ::OpenAPI::toJsonValue(m_storage_engine));
    }
    if (m_type_isSet) {
...
QList<QString> OAIDatabaseMongoDB::getAllowList() const {
    return m_allow_list;
}
void OAIDatabaseMongoDB::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabaseMongoDB::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabaseMongoDB::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabaseMongoDB::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabaseMongoDB::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabaseMongoDB::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabaseMongoDB::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

QString OAIDatabaseMongoDB::getCompressionType() const {
    return m_compression_type;
}
void OAIDatabaseMongoDB::setCompressionType(const QString &compression_type) {
    m_compression_type = compression_type;
    m_compression_type_isSet = true;
}

bool OAIDatabaseMongoDB::is_compression_type_Set() const{
    return m_compression_type_isSet;
}

bool OAIDatabaseMongoDB::is_compression_type_Valid() const{
    return m_compression_type_isValid;
}

QDateTime OAIDatabaseMongoDB::getCreated() const {
    return m_created;
}
void OAIDatabaseMongoDB::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDatabaseMongoDB::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDatabaseMongoDB::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIDatabaseMongoDB::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabaseMongoDB::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabaseMongoDB::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabaseMongoDB::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabaseMongoDB::getEngine() const {
    return m_engine;
}
void OAIDatabaseMongoDB::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseMongoDB::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseMongoDB::is_engine_Valid() const{
    return m_engine_isValid;
}

OAIDatabaseMongoDB_hosts OAIDatabaseMongoDB::getHosts() const {
    return m_hosts;
}
void OAIDatabaseMongoDB::setHosts(const OAIDatabaseMongoDB_hosts &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAIDatabaseMongoDB::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAIDatabaseMongoDB::is_hosts_Valid() const{
    return m_hosts_isValid;
}

qint32 OAIDatabaseMongoDB::getId() const {
    return m_id;
}
void OAIDatabaseMongoDB::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseMongoDB::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseMongoDB::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseMongoDB::getLabel() const {
    return m_label;
}
void OAIDatabaseMongoDB::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseMongoDB::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseMongoDB::is_label_Valid() const{
    return m_label_isValid;
}

QList<QString> OAIDatabaseMongoDB::getPeers() const {
    return m_peers;
}
void OAIDatabaseMongoDB::setPeers(const QList<QString> &peers) {
    m_peers = peers;
    m_peers_isSet = true;
}

bool OAIDatabaseMongoDB::is_peers_Set() const{
    return m_peers_isSet;
}

bool OAIDatabaseMongoDB::is_peers_Valid() const{
    return m_peers_isValid;
}

qint32 OAIDatabaseMongoDB::getPort() const {
    return m_port;
}
void OAIDatabaseMongoDB::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDatabaseMongoDB::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDatabaseMongoDB::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIDatabaseMongoDB::getRegion() const {
    return m_region;
}
void OAIDatabaseMongoDB::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabaseMongoDB::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabaseMongoDB::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabaseMongoDB::getReplicaSet() const {
    return m_replica_set;
}
void OAIDatabaseMongoDB::setReplicaSet(const QString &replica_set) {
    m_replica_set = replica_set;
    m_replica_set_isSet = true;
}

bool OAIDatabaseMongoDB::is_replica_set_Set() const{
    return m_replica_set_isSet;
}

bool OAIDatabaseMongoDB::is_replica_set_Valid() const{
    return m_replica_set_isValid;
}

bool OAIDatabaseMongoDB::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabaseMongoDB::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabaseMongoDB::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabaseMongoDB::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabaseMongoDB::getStatus() const {
    return m_status;
}
void OAIDatabaseMongoDB::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatabaseMongoDB::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatabaseMongoDB::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatabaseMongoDB::getStorageEngine() const {
    return m_storage_engine;
}
void OAIDatabaseMongoDB::setStorageEngine(const QString &storage_engine) {
    m_storage_engine = storage_engine;
    m_storage_engine_isSet = true;
}

bool OAIDatabaseMongoDB::is_storage_engine_Set() const{
    return m_storage_engine_isSet;
}

bool OAIDatabaseMongoDB::is_storage_engine_Valid() const{
    return m_storage_engine_isValid;
}

QString OAIDatabaseMongoDB::getType() const {
    return m_type;
}
void OAIDatabaseMongoDB::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseMongoDB::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseMongoDB::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIDatabaseMongoDB::getUpdated() const {
    return m_updated;
}
void OAIDatabaseMongoDB::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDatabaseMongoDB::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDatabaseMongoDB::is_updated_Valid() const{
    return m_updated_isValid;
}

OAIDatabase_updates OAIDatabaseMongoDB::getUpdates() const {
    return m_updates;
}
void OAIDatabaseMongoDB::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIDatabaseMongoDB::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIDatabaseMongoDB::is_updates_Valid() const{
    return m_updates_isValid;
}

QString OAIDatabaseMongoDB::getVersion() const {
    return m_version;
}
void OAIDatabaseMongoDB::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDatabaseMongoDB::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDatabaseMongoDB::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIDatabaseMongoDB::isSet() const {
...
bool OAIDatabaseMongoDB::isValid() const {
