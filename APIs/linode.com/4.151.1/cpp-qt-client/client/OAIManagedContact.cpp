...
OAIManagedContact::OAIManagedContact(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedContact::OAIManagedContact() {
    this->initializeModel();
}

OAIManagedContact::~OAIManagedContact() {}

void OAIManagedContact::initializeModel() {
...
void OAIManagedContact::fromJson(QString jsonString) {
...
void OAIManagedContact::fromJsonObject(QJsonObject json) {
...
QString OAIManagedContact::asJson() const {
...
QJsonObject OAIManagedContact::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIManagedContact::getEmail() const {
    return m_email;
}
void OAIManagedContact::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIManagedContact::is_email_Set() const{
    return m_email_isSet;
}

bool OAIManagedContact::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIManagedContact::getGroup() const {
    return m_group;
}
void OAIManagedContact::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIManagedContact::is_group_Set() const{
    return m_group_isSet;
}

bool OAIManagedContact::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAIManagedContact::getId() const {
    return m_id;
}
void OAIManagedContact::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedContact::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedContact::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagedContact::getName() const {
    return m_name;
}
void OAIManagedContact::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIManagedContact::is_name_Set() const{
    return m_name_isSet;
}

bool OAIManagedContact::is_name_Valid() const{
    return m_name_isValid;
}

OAIManagedContact_phone OAIManagedContact::getPhone() const {
    return m_phone;
}
void OAIManagedContact::setPhone(const OAIManagedContact_phone &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIManagedContact::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIManagedContact::is_phone_Valid() const{
    return m_phone_isValid;
}

QDateTime OAIManagedContact::getUpdated() const {
    return m_updated;
}
void OAIManagedContact::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIManagedContact::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIManagedContact::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIManagedContact::isSet() const {
...
bool OAIManagedContact::isValid() const {
