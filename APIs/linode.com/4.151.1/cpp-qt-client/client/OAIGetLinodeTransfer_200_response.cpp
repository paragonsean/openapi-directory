...
OAIGetLinodeTransfer_200_response::OAIGetLinodeTransfer_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinodeTransfer_200_response::OAIGetLinodeTransfer_200_response() {
    this->initializeModel();
}

OAIGetLinodeTransfer_200_response::~OAIGetLinodeTransfer_200_response() {}

void OAIGetLinodeTransfer_200_response::initializeModel() {
...
void OAIGetLinodeTransfer_200_response::fromJson(QString jsonString) {
...
void OAIGetLinodeTransfer_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetLinodeTransfer_200_response::asJson() const {
...
QJsonObject OAIGetLinodeTransfer_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_billable_isSet) {
...
qint32 OAIGetLinodeTransfer_200_response::getBillable() const {
    return m_billable;
}
void OAIGetLinodeTransfer_200_response::setBillable(const qint32 &billable) {
    m_billable = billable;
    m_billable_isSet = true;
}

bool OAIGetLinodeTransfer_200_response::is_billable_Set() const{
    return m_billable_isSet;
}

bool OAIGetLinodeTransfer_200_response::is_billable_Valid() const{
    return m_billable_isValid;
}

qint32 OAIGetLinodeTransfer_200_response::getQuota() const {
    return m_quota;
}
void OAIGetLinodeTransfer_200_response::setQuota(const qint32 &quota) {
    m_quota = quota;
    m_quota_isSet = true;
}

bool OAIGetLinodeTransfer_200_response::is_quota_Set() const{
    return m_quota_isSet;
}

bool OAIGetLinodeTransfer_200_response::is_quota_Valid() const{
    return m_quota_isValid;
}

qint32 OAIGetLinodeTransfer_200_response::getUsed() const {
    return m_used;
}
void OAIGetLinodeTransfer_200_response::setUsed(const qint32 &used) {
    m_used = used;
    m_used_isSet = true;
}

bool OAIGetLinodeTransfer_200_response::is_used_Set() const{
    return m_used_isSet;
}

bool OAIGetLinodeTransfer_200_response::is_used_Valid() const{
    return m_used_isValid;
}

bool OAIGetLinodeTransfer_200_response::isSet() const {
...
bool OAIGetLinodeTransfer_200_response::isValid() const {
