...
OAIIPv6Pool::OAIIPv6Pool(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPv6Pool::OAIIPv6Pool() {
    this->initializeModel();
}

OAIIPv6Pool::~OAIIPv6Pool() {}

void OAIIPv6Pool::initializeModel() {
    ...
    m_route_target_isSet = false;
    m_route_target_isValid = false;
}

void OAIIPv6Pool::fromJson(QString jsonString) {
...
void OAIIPv6Pool::fromJsonObject(QJsonObject json) {
    ...
    m_route_target_isValid = ::OpenAPI::fromJsonValue(m_route_target, json[QString("route_target")]);
    m_route_target_isSet = !json[QString("route_target")].isNull() && m_route_target_isValid;
}

QString OAIIPv6Pool::asJson() const {
...
QJsonObject OAIIPv6Pool::asJsonObject() const {
    QJsonObject obj;
    if (m_prefix_isSet) {
    ...
    if (m_route_target_isSet) {
        obj.insert(QString("route_target"), ::OpenAPI::toJsonValue(m_route_target));
    }
    return obj;
}

qint32 OAIIPv6Pool::getPrefix() const {
    return m_prefix;
}
void OAIIPv6Pool::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPv6Pool::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPv6Pool::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAIIPv6Pool::getRange() const {
    return m_range;
}
void OAIIPv6Pool::setRange(const QString &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAIIPv6Pool::is_range_Set() const{
    return m_range_isSet;
}

bool OAIIPv6Pool::is_range_Valid() const{
    return m_range_isValid;
}

QString OAIIPv6Pool::getRegion() const {
    return m_region;
}
void OAIIPv6Pool::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPv6Pool::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPv6Pool::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIIPv6Pool::getRouteTarget() const {
    return m_route_target;
}
void OAIIPv6Pool::setRouteTarget(const QString &route_target) {
    m_route_target = route_target;
    m_route_target_isSet = true;
}

bool OAIIPv6Pool::is_route_target_Set() const{
    return m_route_target_isSet;
}

bool OAIIPv6Pool::is_route_target_Valid() const{
    return m_route_target_isValid;
}

bool OAIIPv6Pool::isSet() const {
...
bool OAIIPv6Pool::isValid() const {
