...
OAINodeBalancerNode::OAINodeBalancerNode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeBalancerNode::OAINodeBalancerNode() {
    this->initializeModel();
}

OAINodeBalancerNode::~OAINodeBalancerNode() {}

void OAINodeBalancerNode::initializeModel() {
...
void OAINodeBalancerNode::fromJson(QString jsonString) {
...
void OAINodeBalancerNode::fromJsonObject(QJsonObject json) {
...
QString OAINodeBalancerNode::asJson() const {
...
QJsonObject OAINodeBalancerNode::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAINodeBalancerNode::getAddress() const {
    return m_address;
}
void OAINodeBalancerNode::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAINodeBalancerNode::is_address_Set() const{
    return m_address_isSet;
}

bool OAINodeBalancerNode::is_address_Valid() const{
    return m_address_isValid;
}

qint32 OAINodeBalancerNode::getConfigId() const {
    return m_config_id;
}
void OAINodeBalancerNode::setConfigId(const qint32 &config_id) {
    m_config_id = config_id;
    m_config_id_isSet = true;
}

bool OAINodeBalancerNode::is_config_id_Set() const{
    return m_config_id_isSet;
}

bool OAINodeBalancerNode::is_config_id_Valid() const{
    return m_config_id_isValid;
}

qint32 OAINodeBalancerNode::getId() const {
    return m_id;
}
void OAINodeBalancerNode::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINodeBalancerNode::is_id_Set() const{
    return m_id_isSet;
}

bool OAINodeBalancerNode::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINodeBalancerNode::getLabel() const {
    return m_label;
}
void OAINodeBalancerNode::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAINodeBalancerNode::is_label_Set() const{
    return m_label_isSet;
}

bool OAINodeBalancerNode::is_label_Valid() const{
    return m_label_isValid;
}

QString OAINodeBalancerNode::getMode() const {
    return m_mode;
}
void OAINodeBalancerNode::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAINodeBalancerNode::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAINodeBalancerNode::is_mode_Valid() const{
    return m_mode_isValid;
}

qint32 OAINodeBalancerNode::getNodebalancerId() const {
    return m_nodebalancer_id;
}
void OAINodeBalancerNode::setNodebalancerId(const qint32 &nodebalancer_id) {
    m_nodebalancer_id = nodebalancer_id;
    m_nodebalancer_id_isSet = true;
}

bool OAINodeBalancerNode::is_nodebalancer_id_Set() const{
    return m_nodebalancer_id_isSet;
}

bool OAINodeBalancerNode::is_nodebalancer_id_Valid() const{
    return m_nodebalancer_id_isValid;
}

QString OAINodeBalancerNode::getStatus() const {
    return m_status;
}
void OAINodeBalancerNode::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINodeBalancerNode::is_status_Set() const{
    return m_status_isSet;
}

bool OAINodeBalancerNode::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAINodeBalancerNode::getWeight() const {
    return m_weight;
}
void OAINodeBalancerNode::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAINodeBalancerNode::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAINodeBalancerNode::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAINodeBalancerNode::isSet() const {
...
bool OAINodeBalancerNode::isValid() const {
