...
QDateTime OAILogin::getDatetime() const {
    return m_datetime;
}
void OAILogin::setDatetime(const QDateTime &datetime) {
    m_datetime = datetime;
    m_datetime_isSet = true;
}

bool OAILogin::is_datetime_Set() const{
    return m_datetime_isSet;
}

bool OAILogin::is_datetime_Valid() const{
    return m_datetime_isValid;
}

qint32 OAILogin::getId() const {
    return m_id;
}
void OAILogin::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILogin::is_id_Set() const{
    return m_id_isSet;
}

bool OAILogin::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILogin::getIp() const {
    return m_ip;
}
void OAILogin::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAILogin::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAILogin::is_ip_Valid() const{
    return m_ip_isValid;
}

bool OAILogin::isRestricted() const {
    return m_restricted;
}
void OAILogin::setRestricted(const bool &restricted) {
    m_restricted = restricted;
    m_restricted_isSet = true;
}

bool OAILogin::is_restricted_Set() const{
    return m_restricted_isSet;
}

bool OAILogin::is_restricted_Valid() const{
    return m_restricted_isValid;
}

QString OAILogin::getStatus() const {
    return m_status;
}
void OAILogin::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILogin::is_status_Set() const{
    return m_status_isSet;
}

bool OAILogin::is_status_Valid() const{
