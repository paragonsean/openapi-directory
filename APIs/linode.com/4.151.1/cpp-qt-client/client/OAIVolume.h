...
public:
    ...
    void setFilesystemPath(const QString &filesystem_path);
    bool is_filesystem_path_Set() const;
    bool is_filesystem_path_Valid() const;
    ...
    QString getLinodeLabel() const;
    void setLinodeLabel(const QString &linode_label);
    bool is_linode_label_Set() const;
    bool is_linode_label_Valid() const;
...
private:
    ...
    QString m_filesystem_path;
    bool m_filesystem_path_isSet;
    bool m_filesystem_path_isValid;
    ...
    QString m_linode_label;
    bool m_linode_label_isSet;
    bool m_linode_label_isValid;
