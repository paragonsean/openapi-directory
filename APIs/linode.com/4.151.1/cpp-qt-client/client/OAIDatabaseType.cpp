...
QString OAIDatabaseType::getRClass() const {
    return m_r_class;
}
void OAIDatabaseType::setRClass(const QString &r_class) {
    m_r_class = r_class;
    m_r_class_isSet = true;
}

bool OAIDatabaseType::is_r_class_Set() const{
    return m_r_class_isSet;
}

bool OAIDatabaseType::is_r_class_Valid() const{
    return m_r_class_isValid;
}

bool OAIDatabaseType::isDeprecated() const {
    return m_deprecated;
}
void OAIDatabaseType::setDeprecated(const bool &deprecated) {
    m_deprecated = deprecated;
    m_deprecated_isSet = true;
}

bool OAIDatabaseType::is_deprecated_Set() const{
    return m_deprecated_isSet;
}

bool OAIDatabaseType::is_deprecated_Valid() const{
    return m_deprecated_isValid;
}

qint32 OAIDatabaseType::getDisk() const {
    return m_disk;
}
void OAIDatabaseType::setDisk(const qint32 &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIDatabaseType::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIDatabaseType::is_disk_Valid() const{
    return m_disk_isValid;
}

OAIDatabaseType_engines OAIDatabaseType::getEngines() const {
    return m_engines;
}
void OAIDatabaseType::setEngines(const OAIDatabaseType_engines &engines) {
    m_engines = engines;
    m_engines_isSet = true;
}

bool OAIDatabaseType::is_engines_Set() const{
    return m_engines_isSet;
}

bool OAIDatabaseType::is_engines_Valid() const{
    return m_engines_isValid;
}

QString OAIDatabaseType::getId() const {
    return m_id;
}
void OAIDatabaseType::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseType::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseType::getLabel() const {
    return m_label;
}
void OAIDatabaseType::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseType::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseType::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIDatabaseType::getMemory() const {
    return m_memory;
}
void OAIDatabaseType::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIDatabaseType::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIDatabaseType::is_memory_Valid() const{
    return m_memory_isValid;
}

qint32 OAIDatabaseType::getVcpus() const {
    return m_vcpus;
}
void OAIDatabaseType::setVcpus(const qint32 &vcpus) {
    m_vcpus = vcpus;
    m_vcpus_isSet = true;
}

bool OAIDatabaseType::is_vcpus_Set() const{
    return m_vcpus_isSet;
}

bool OAIDatabaseType::is_vcpus_Valid() const{
