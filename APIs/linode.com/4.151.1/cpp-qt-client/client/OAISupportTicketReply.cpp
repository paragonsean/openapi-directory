...
OAISupportTicketReply::OAISupportTicketReply(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportTicketReply::OAISupportTicketReply() {
    this->initializeModel();
}

OAISupportTicketReply::~OAISupportTicketReply() {}

void OAISupportTicketReply::initializeModel() {
    ...
    m_from_linode_isSet = false;
    m_from_linode_isValid = false;
...
void OAISupportTicketReply::fromJson(QString jsonString) {
...
void OAISupportTicketReply::fromJsonObject(QJsonObject json) {
    ...
    m_from_linode_isValid = ::OpenAPI::fromJsonValue(m_from_linode, json[QString("from_linode")]);
    m_from_linode_isSet = !json[QString("from_linode")].isNull() && m_from_linode_isValid;
...
QString OAISupportTicketReply::asJson() const {
...
QJsonObject OAISupportTicketReply::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
    ...
    if (m_from_linode_isSet) {
        obj.insert(QString("from_linode"), ::OpenAPI::toJsonValue(m_from_linode));
    }
...
QDateTime OAISupportTicketReply::getCreated() const {
    return m_created;
}
void OAISupportTicketReply::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAISupportTicketReply::is_created_Set() const{
    return m_created_isSet;
}

bool OAISupportTicketReply::is_created_Valid() const{
    return m_created_isValid;
}

QString OAISupportTicketReply::getCreatedBy() const {
    return m_created_by;
}
void OAISupportTicketReply::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAISupportTicketReply::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAISupportTicketReply::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAISupportTicketReply::getDescription() const {
    return m_description;
}
void OAISupportTicketReply::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISupportTicketReply::is_description_Set() const{
    return m_description_isSet;
}

bool OAISupportTicketReply::is_description_Valid() const{
    return m_description_isValid;
}

bool OAISupportTicketReply::isFromLinode() const {
    return m_from_linode;
}
void OAISupportTicketReply::setFromLinode(const bool &from_linode) {
    m_from_linode = from_linode;
    m_from_linode_isSet = true;
}

bool OAISupportTicketReply::is_from_linode_Set() const{
    return m_from_linode_isSet;
}

bool OAISupportTicketReply::is_from_linode_Valid() const{
    return m_from_linode_isValid;
}

QString OAISupportTicketReply::getGravatarId() const {
    return m_gravatar_id;
}
void OAISupportTicketReply::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAISupportTicketReply::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAISupportTicketReply::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

qint32 OAISupportTicketReply::getId() const {
    return m_id;
}
void OAISupportTicketReply::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISupportTicketReply::is_id_Set() const{
    return m_id_isSet;
}

bool OAISupportTicketReply::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISupportTicketReply::isSet() const {
...
bool OAISupportTicketReply::isValid() const {
