...
void OAISupportApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("createTicketAttachment", defaultConf);
    _serverIndices.insert("createTicketAttachment", 0);
    _serverConfigs.insert("createTicketReply", defaultConf);
    _serverIndices.insert("createTicketReply", 0);
    _serverConfigs.insert("getTicket", defaultConf);
    _serverIndices.insert("getTicket", 0);
    _serverConfigs.insert("getTicketReplies", defaultConf);
    _serverIndices.insert("getTicketReplies", 0);
...
void OAISupportApi::closeTicket(const qint32 &ticket_id) {
    QString fullPath = QString(_serverConfigs["closeTicket"][_serverIndices.value("closeTicket")].URL()+"/support/tickets/{ticketId}/close");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::closeTicketCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::closeTicketCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAISupportApi::closeTicketCallback(OAIHttpRequestWorker *worker) {
...
void OAISupportApi::createTicket(const ::OpenAPI::OptionalParam<OAISupportTicketRequest> &oai_support_ticket_request) {
    QString fullPath = QString(_serverConfigs["createTicket"][_serverIndices.value("createTicket")].URL()+"/support/tickets");
    ...
    if (oai_support_ticket_request.hasValue()){

        
        QByteArray output = oai_support_ticket_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::createTicketCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISupportTicket output(QString(worker->response));
    worker->deleteLater();
...
void OAISupportApi::createTicketAttachment(const qint32 &ticket_id, const QString &file) {
    QString fullPath = QString(_serverConfigs["createTicketAttachment"][_serverIndices.value("createTicketAttachment")].URL()+"/support/tickets/{ticketId}/attachments");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketAttachmentCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketAttachmentCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::createTicketAttachmentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createTicketAttachmentSignal(output);
        Q_EMIT createTicketAttachmentSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("account:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createTicketAttachmentSignalE(output, error_type, error_str);
        Q_EMIT createTicketAttachmentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createTicketAttachmentSignalError(output, error_type, error_str);
        Q_EMIT createTicketAttachmentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISupportApi::createTicketReply(const qint32 &ticket_id, const OAICreateTicketReply_request &oai_create_ticket_reply_request) {
    QString fullPath = QString(_serverConfigs["createTicketReply"][_serverIndices.value("createTicketReply")].URL()+"/support/tickets/{ticketId}/replies");
...

    {
        ...
        QByteArray output = oai_create_ticket_reply_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketReplyCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::createTicketReplyCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::createTicketReplyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISupportTicketReply output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createTicketReplySignal(output);
        Q_EMIT createTicketReplySignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("account:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createTicketReplySignalE(output, error_type, error_str);
        Q_EMIT createTicketReplySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createTicketReplySignalError(output, error_type, error_str);
        Q_EMIT createTicketReplySignalErrorFull(worker, error_type, error_str);
    }
}

void OAISupportApi::getTicket(const qint32 &ticket_id) {
    QString fullPath = QString(_serverConfigs["getTicket"][_serverIndices.value("getTicket")].URL()+"/support/tickets/{ticketId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::getTicketCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTicketSignal(output);
        Q_EMIT getTicketSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("account:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTicketSignalE(output, error_type, error_str);
        Q_EMIT getTicketSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTicketSignalError(output, error_type, error_str);
        Q_EMIT getTicketSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISupportApi::getTicketReplies(const qint32 &ticket_id, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getTicketReplies"][_serverIndices.value("getTicketReplies")].URL()+"/support/tickets/{ticketId}/replies");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketRepliesCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketRepliesCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::getTicketRepliesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetTicketReplies_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTicketRepliesSignal(output);
        Q_EMIT getTicketRepliesSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("account:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTicketRepliesSignalE(output, error_type, error_str);
        Q_EMIT getTicketRepliesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTicketRepliesSignalError(output, error_type, error_str);
        Q_EMIT getTicketRepliesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISupportApi::getTickets(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getTickets"][_serverIndices.value("getTickets")].URL()+"/support/tickets");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketsCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISupportApi::getTicketsCallback);
    connect(this, &OAISupportApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISupportApi::getTicketsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetTickets_200_response output(QString(worker->response));
    worker->deleteLater();
