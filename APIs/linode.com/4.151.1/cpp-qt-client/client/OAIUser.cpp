...
void OAIUser::fromJsonObject(QJsonObject json) {
    ...
    m_tfa_enabled_isValid = ::OpenAPI::fromJsonValue(m_tfa_enabled, json[QString("tfa_enabled")]);
    m_tfa_enabled_isSet = !json[QString("tfa_enabled")].isNull() && m_tfa_enabled_isValid;
...
QJsonObject OAIUser::asJsonObject() const {
    ...
    if (m_tfa_enabled_isSet) {
        obj.insert(QString("tfa_enabled"), ::OpenAPI::toJsonValue(m_tfa_enabled));
    }
    if (m_username_isSet) {
...
QList<QString> OAIUser::getSshKeys() const {
    return m_ssh_keys;
}
void OAIUser::setSshKeys(const QList<QString> &ssh_keys) {
    m_ssh_keys = ssh_keys;
    m_ssh_keys_isSet = true;
}

bool OAIUser::is_ssh_keys_Set() const{
    return m_ssh_keys_isSet;
}

bool OAIUser::is_ssh_keys_Valid() const{
    return m_ssh_keys_isValid;
}

bool OAIUser::isTfaEnabled() const {
    return m_tfa_enabled;
}
void OAIUser::setTfaEnabled(const bool &tfa_enabled) {
    m_tfa_enabled = tfa_enabled;
    m_tfa_enabled_isSet = true;
}

bool OAIUser::is_tfa_enabled_Set() const{
    return m_tfa_enabled_isSet;
}

bool OAIUser::is_tfa_enabled_Valid() const{
    return m_tfa_enabled_isValid;
}
