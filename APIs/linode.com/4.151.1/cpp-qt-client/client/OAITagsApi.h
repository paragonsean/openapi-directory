...
public:
    ...
    /**
    * @param[in]  oai_create_tag_request OAICreateTag_request [optional]
    */
    virtual void createTag(const ::OpenAPI::OptionalParam<OAICreateTag_request> &oai_create_tag_request = ::OpenAPI::OptionalParam<OAICreateTag_request>());

    /**
    * @param[in]  label QString [required]
    */
    virtual void deleteTag(const QString &label);
    ...
    */
    virtual void getTaggedObjects(const QString &label, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getTags(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void getTaggedObjectsCallback(OAIHttpRequestWorker *worker);
    void getTagsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createTagSignal(OAITag summary);
    void deleteTagSignal(OAIObject summary);
    void getTaggedObjectsSignal(OAIGetTaggedObjects_200_response summary);
    void getTagsSignal(OAIGetTags_200_response summary);


    void createTagSignalFull(OAIHttpRequestWorker *worker, OAITag summary);
    void deleteTagSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getTaggedObjectsSignalFull(OAIHttpRequestWorker *worker, OAIGetTaggedObjects_200_response summary);
    ...
    void deleteTagSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteTagSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTaggedObjectsSignalError() instead")
    void getTaggedObjectsSignalE(OAIGetTaggedObjects_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTaggedObjectsSignalError(OAIGetTaggedObjects_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getTaggedObjectsSignalErrorFull() instead")
    void getTaggedObjectsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getTaggedObjectsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
