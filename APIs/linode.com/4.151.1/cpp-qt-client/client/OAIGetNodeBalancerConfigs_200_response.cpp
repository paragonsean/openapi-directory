...
OAIGetNodeBalancerConfigs_200_response::OAIGetNodeBalancerConfigs_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetNodeBalancerConfigs_200_response::OAIGetNodeBalancerConfigs_200_response() {
    this->initializeModel();
}

OAIGetNodeBalancerConfigs_200_response::~OAIGetNodeBalancerConfigs_200_response() {}

void OAIGetNodeBalancerConfigs_200_response::initializeModel() {
...
void OAIGetNodeBalancerConfigs_200_response::fromJson(QString jsonString) {
...
void OAIGetNodeBalancerConfigs_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetNodeBalancerConfigs_200_response::asJson() const {
...
QJsonObject OAIGetNodeBalancerConfigs_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAINodeBalancerConfig> OAIGetNodeBalancerConfigs_200_response::getData() const {
    return m_data;
}
void OAIGetNodeBalancerConfigs_200_response::setData(const QList<OAINodeBalancerConfig> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetNodeBalancerConfigs_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetNodeBalancerConfigs_200_response::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIGetNodeBalancerConfigs_200_response::getPage() const {
    return m_page;
}
void OAIGetNodeBalancerConfigs_200_response::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIGetNodeBalancerConfigs_200_response::is_page_Set() const{
    return m_page_isSet;
}

bool OAIGetNodeBalancerConfigs_200_response::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIGetNodeBalancerConfigs_200_response::getPages() const {
    return m_pages;
}
void OAIGetNodeBalancerConfigs_200_response::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIGetNodeBalancerConfigs_200_response::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIGetNodeBalancerConfigs_200_response::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIGetNodeBalancerConfigs_200_response::getResults() const {
    return m_results;
}
void OAIGetNodeBalancerConfigs_200_response::setResults(const qint32 &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIGetNodeBalancerConfigs_200_response::is_results_Set() const{
    return m_results_isSet;
}

bool OAIGetNodeBalancerConfigs_200_response::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIGetNodeBalancerConfigs_200_response::isSet() const {
...
bool OAIGetNodeBalancerConfigs_200_response::isValid() const {
