...
#include "OAIDatabaseType_engines.h"
...
OAIDatabaseType_engines::OAIDatabaseType_engines(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseType_engines::OAIDatabaseType_engines() {
    this->initializeModel();
}

OAIDatabaseType_engines::~OAIDatabaseType_engines() {}

void OAIDatabaseType_engines::initializeModel() {

    m_mongodb_isSet = false;
    m_mongodb_isValid = false;
...
void OAIDatabaseType_engines::fromJson(QString jsonString) {
...
void OAIDatabaseType_engines::fromJsonObject(QJsonObject json) {

    m_mongodb_isValid = ::OpenAPI::fromJsonValue(m_mongodb, json[QString("mongodb")]);
    m_mongodb_isSet = !json[QString("mongodb")].isNull() && m_mongodb_isValid;
...
QString OAIDatabaseType_engines::asJson() const {
...
QJsonObject OAIDatabaseType_engines::asJsonObject() const {
    QJsonObject obj;
    if (m_mongodb.size() > 0) {
        obj.insert(QString("mongodb"), ::OpenAPI::toJsonValue(m_mongodb));
    }
    if (m_mysql.size() > 0) {
        obj.insert(QString("mysql"), ::OpenAPI::toJsonValue(m_mysql));
    }
    if (m_postgresql.size() > 0) {
        obj.insert(QString("postgresql"), ::OpenAPI::toJsonValue(m_postgresql));
    }
    return obj;
}

QList<OAIDatabaseTypeEngine> OAIDatabaseType_engines::getMongodb() const {
    return m_mongodb;
}
void OAIDatabaseType_engines::setMongodb(const QList<OAIDatabaseTypeEngine> &mongodb) {
    m_mongodb = mongodb;
    m_mongodb_isSet = true;
}

bool OAIDatabaseType_engines::is_mongodb_Set() const{
    return m_mongodb_isSet;
}

bool OAIDatabaseType_engines::is_mongodb_Valid() const{
    return m_mongodb_isValid;
}

QList<OAIDatabaseTypeEngine> OAIDatabaseType_engines::getMysql() const {
    return m_mysql;
}
void OAIDatabaseType_engines::setMysql(const QList<OAIDatabaseTypeEngine> &mysql) {
    m_mysql = mysql;
    m_mysql_isSet = true;
}

bool OAIDatabaseType_engines::is_mysql_Set() const{
    return m_mysql_isSet;
}

bool OAIDatabaseType_engines::is_mysql_Valid() const{
    return m_mysql_isValid;
}

QList<OAIDatabaseTypeEngine> OAIDatabaseType_engines::getPostgresql() const {
    return m_postgresql;
}
void OAIDatabaseType_engines::setPostgresql(const QList<OAIDatabaseTypeEngine> &postgresql) {
    m_postgresql = postgresql;
    m_postgresql_isSet = true;
}

bool OAIDatabaseType_engines::is_postgresql_Set() const{
    return m_postgresql_isSet;
}

bool OAIDatabaseType_engines::is_postgresql_Valid() const{
    return m_postgresql_isValid;
}

bool OAIDatabaseType_engines::isSet() const {
...
bool OAIDatabaseType_engines::isValid() const {
