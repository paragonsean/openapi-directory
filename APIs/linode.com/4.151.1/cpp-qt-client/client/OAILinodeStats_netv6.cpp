...
#include "OAILinodeStats_netv6.h"
...
OAILinodeStats_netv6::OAILinodeStats_netv6(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeStats_netv6::OAILinodeStats_netv6() {
    this->initializeModel();
}

OAILinodeStats_netv6::~OAILinodeStats_netv6() {}

void OAILinodeStats_netv6::initializeModel() {
    ...
    m_private_in_isSet = false;
    m_private_in_isValid = false;

    m_private_out_isSet = false;
    m_private_out_isValid = false;
}

void OAILinodeStats_netv6::fromJson(QString jsonString) {
...
void OAILinodeStats_netv6::fromJsonObject(QJsonObject json) {

    if(json["in"].isArray()){
        auto arr = json["in"].toArray();
        m_in_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_in_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_in_isSet = !jval.isNull() && m_in_isValid;
                m_in.push_back(item);
            }
        }
    }
    ...
    if(json["out"].isArray()){
        auto arr = json["out"].toArray();
        m_out_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_out_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_out_isSet = !jval.isNull() && m_out_isValid;
                m_out.push_back(item);
            }
        }
    }

    if(json["private_in"].isArray()){
        auto arr = json["private_in"].toArray();
        m_private_in_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_private_in_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_private_in_isSet = !jval.isNull() && m_private_in_isValid;
                m_private_in.push_back(item);
            }
        }
    }

    if(json["private_out"].isArray()){
        auto arr = json["private_out"].toArray();
        m_private_out_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_private_out_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_private_out_isSet = !jval.isNull() && m_private_out_isValid;
                m_private_out.push_back(item);
            }
        }
    }
}

QString OAILinodeStats_netv6::asJson() const {
...
QJsonObject OAILinodeStats_netv6::asJsonObject() const {
    QJsonObject obj;
    if (m_in.size() > 0) {
        
        obj.insert(QString("in"), toJsonValue(m_in));
    }
    if (m_out.size() > 0) {
        
        obj.insert(QString("out"), toJsonValue(m_out));
    }
    if (m_private_in.size() > 0) {
        
        obj.insert(QString("private_in"), toJsonValue(m_private_in));
    }
    if (m_private_out.size() > 0) {
        
        obj.insert(QString("private_out"), toJsonValue(m_private_out));
    }
    return obj;
}

QList<QList<double>> OAILinodeStats_netv6::getIn() const {
    return m_in;
}
void OAILinodeStats_netv6::setIn(const QList<QList<double>> &in) {
    m_in = in;
    m_in_isSet = true;
}

bool OAILinodeStats_netv6::is_in_Set() const{
    return m_in_isSet;
}

bool OAILinodeStats_netv6::is_in_Valid() const{
    return m_in_isValid;
}

QList<QList<double>> OAILinodeStats_netv6::getOut() const {
    return m_out;
}
void OAILinodeStats_netv6::setOut(const QList<QList<double>> &out) {
    m_out = out;
    m_out_isSet = true;
}

bool OAILinodeStats_netv6::is_out_Set() const{
    return m_out_isSet;
}

bool OAILinodeStats_netv6::is_out_Valid() const{
    return m_out_isValid;
}

QList<QList<double>> OAILinodeStats_netv6::getPrivateIn() const {
    return m_private_in;
}
void OAILinodeStats_netv6::setPrivateIn(const QList<QList<double>> &private_in) {
    m_private_in = private_in;
    m_private_in_isSet = true;
}

bool OAILinodeStats_netv6::is_private_in_Set() const{
    return m_private_in_isSet;
}

bool OAILinodeStats_netv6::is_private_in_Valid() const{
    return m_private_in_isValid;
}

QList<QList<double>> OAILinodeStats_netv6::getPrivateOut() const {
    return m_private_out;
}
void OAILinodeStats_netv6::setPrivateOut(const QList<QList<double>> &private_out) {
    m_private_out = private_out;
    m_private_out_isSet = true;
}

bool OAILinodeStats_netv6::is_private_out_Set() const{
    return m_private_out_isSet;
}

bool OAILinodeStats_netv6::is_private_out_Valid() const{
    return m_private_out_isValid;
}

bool OAILinodeStats_netv6::isSet() const {
...
bool OAILinodeStats_netv6::isValid() const {
