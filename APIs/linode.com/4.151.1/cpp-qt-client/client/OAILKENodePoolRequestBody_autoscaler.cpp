...
#include "OAILKENodePoolRequestBody_autoscaler.h"
...
OAILKENodePoolRequestBody_autoscaler::OAILKENodePoolRequestBody_autoscaler(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILKENodePoolRequestBody_autoscaler::OAILKENodePoolRequestBody_autoscaler() {
    this->initializeModel();
}

OAILKENodePoolRequestBody_autoscaler::~OAILKENodePoolRequestBody_autoscaler() {}

void OAILKENodePoolRequestBody_autoscaler::initializeModel() {
...
void OAILKENodePoolRequestBody_autoscaler::fromJson(QString jsonString) {
...
void OAILKENodePoolRequestBody_autoscaler::fromJsonObject(QJsonObject json) {
...
QString OAILKENodePoolRequestBody_autoscaler::asJson() const {
...
QJsonObject OAILKENodePoolRequestBody_autoscaler::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAILKENodePoolRequestBody_autoscaler::isEnabled() const {
    return m_enabled;
}
void OAILKENodePoolRequestBody_autoscaler::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILKENodePoolRequestBody_autoscaler::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILKENodePoolRequestBody_autoscaler::is_enabled_Valid() const{
    return m_enabled_isValid;
}

qint32 OAILKENodePoolRequestBody_autoscaler::getMax() const {
    return m_max;
}
void OAILKENodePoolRequestBody_autoscaler::setMax(const qint32 &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAILKENodePoolRequestBody_autoscaler::is_max_Set() const{
    return m_max_isSet;
}

bool OAILKENodePoolRequestBody_autoscaler::is_max_Valid() const{
    return m_max_isValid;
}

qint32 OAILKENodePoolRequestBody_autoscaler::getMin() const {
    return m_min;
}
void OAILKENodePoolRequestBody_autoscaler::setMin(const qint32 &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAILKENodePoolRequestBody_autoscaler::is_min_Set() const{
    return m_min_isSet;
}

bool OAILKENodePoolRequestBody_autoscaler::is_min_Valid() const{
    return m_min_isValid;
}

bool OAILKENodePoolRequestBody_autoscaler::isSet() const {
...
bool OAILKENodePoolRequestBody_autoscaler::isValid() const {
