...
OAILinodeConfig::OAILinodeConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeConfig::OAILinodeConfig() {
    this->initializeModel();
}

OAILinodeConfig::~OAILinodeConfig() {}

void OAILinodeConfig::initializeModel() {
    ...
    m_helpers_isSet = false;
    m_helpers_isValid = false;
    ...
    m_root_device_isSet = false;
    m_root_device_isValid = false;

    m_run_level_isSet = false;
    m_run_level_isValid = false;

    m_virt_mode_isSet = false;
    m_virt_mode_isValid = false;
}

void OAILinodeConfig::fromJson(QString jsonString) {
...
void OAILinodeConfig::fromJsonObject(QJsonObject json) {
    ...
    m_helpers_isValid = ::OpenAPI::fromJsonValue(m_helpers, json[QString("helpers")]);
    m_helpers_isSet = !json[QString("helpers")].isNull() && m_helpers_isValid;
    ...
    m_root_device_isValid = ::OpenAPI::fromJsonValue(m_root_device, json[QString("root_device")]);
    m_root_device_isSet = !json[QString("root_device")].isNull() && m_root_device_isValid;

    m_run_level_isValid = ::OpenAPI::fromJsonValue(m_run_level, json[QString("run_level")]);
    m_run_level_isSet = !json[QString("run_level")].isNull() && m_run_level_isValid;

    m_virt_mode_isValid = ::OpenAPI::fromJsonValue(m_virt_mode, json[QString("virt_mode")]);
    m_virt_mode_isSet = !json[QString("virt_mode")].isNull() && m_virt_mode_isValid;
}

QString OAILinodeConfig::asJson() const {
...
QJsonObject OAILinodeConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_comments_isSet) {
    ...
    if (m_helpers.isSet()) {
        obj.insert(QString("helpers"), ::OpenAPI::toJsonValue(m_helpers));
    }
    if (m_id_isSet) {
    ...
    if (m_root_device_isSet) {
        obj.insert(QString("root_device"), ::OpenAPI::toJsonValue(m_root_device));
    }
    if (m_run_level_isSet) {
        obj.insert(QString("run_level"), ::OpenAPI::toJsonValue(m_run_level));
    }
    if (m_virt_mode_isSet) {
        obj.insert(QString("virt_mode"), ::OpenAPI::toJsonValue(m_virt_mode));
    }
    return obj;
}

QString OAILinodeConfig::getComments() const {
    return m_comments;
}
void OAILinodeConfig::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAILinodeConfig::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAILinodeConfig::is_comments_Valid() const{
    return m_comments_isValid;
}

OAIDevices OAILinodeConfig::getDevices() const {
    return m_devices;
}
void OAILinodeConfig::setDevices(const OAIDevices &devices) {
    m_devices = devices;
    m_devices_isSet = true;
}

bool OAILinodeConfig::is_devices_Set() const{
    return m_devices_isSet;
}

bool OAILinodeConfig::is_devices_Valid() const{
    return m_devices_isValid;
}

OAILinodeConfig_helpers OAILinodeConfig::getHelpers() const {
    return m_helpers;
}
void OAILinodeConfig::setHelpers(const OAILinodeConfig_helpers &helpers) {
    m_helpers = helpers;
    m_helpers_isSet = true;
}

bool OAILinodeConfig::is_helpers_Set() const{
    return m_helpers_isSet;
}

bool OAILinodeConfig::is_helpers_Valid() const{
    return m_helpers_isValid;
}

qint32 OAILinodeConfig::getId() const {
    return m_id;
}
void OAILinodeConfig::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILinodeConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAILinodeConfig::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAILinodeConfigInterface> OAILinodeConfig::getInterfaces() const {
    return m_interfaces;
}
void OAILinodeConfig::setInterfaces(const QList<OAILinodeConfigInterface> &interfaces) {
    m_interfaces = interfaces;
    m_interfaces_isSet = true;
}

bool OAILinodeConfig::is_interfaces_Set() const{
    return m_interfaces_isSet;
}

bool OAILinodeConfig::is_interfaces_Valid() const{
    return m_interfaces_isValid;
}

QString OAILinodeConfig::getKernel() const {
    return m_kernel;
}
void OAILinodeConfig::setKernel(const QString &kernel) {
    m_kernel = kernel;
    m_kernel_isSet = true;
}

bool OAILinodeConfig::is_kernel_Set() const{
    return m_kernel_isSet;
}

bool OAILinodeConfig::is_kernel_Valid() const{
    return m_kernel_isValid;
}

QString OAILinodeConfig::getLabel() const {
    return m_label;
}
void OAILinodeConfig::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILinodeConfig::is_label_Set() const{
    return m_label_isSet;
}

bool OAILinodeConfig::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAILinodeConfig::getMemoryLimit() const {
    return m_memory_limit;
}
void OAILinodeConfig::setMemoryLimit(const qint32 &memory_limit) {
    m_memory_limit = memory_limit;
    m_memory_limit_isSet = true;
}

bool OAILinodeConfig::is_memory_limit_Set() const{
    return m_memory_limit_isSet;
}

bool OAILinodeConfig::is_memory_limit_Valid() const{
    return m_memory_limit_isValid;
}

QString OAILinodeConfig::getRootDevice() const {
    return m_root_device;
}
void OAILinodeConfig::setRootDevice(const QString &root_device) {
    m_root_device = root_device;
    m_root_device_isSet = true;
}

bool OAILinodeConfig::is_root_device_Set() const{
    return m_root_device_isSet;
}

bool OAILinodeConfig::is_root_device_Valid() const{
    return m_root_device_isValid;
}

QString OAILinodeConfig::getRunLevel() const {
    return m_run_level;
}
void OAILinodeConfig::setRunLevel(const QString &run_level) {
    m_run_level = run_level;
    m_run_level_isSet = true;
}

bool OAILinodeConfig::is_run_level_Set() const{
    return m_run_level_isSet;
}

bool OAILinodeConfig::is_run_level_Valid() const{
    return m_run_level_isValid;
}

QString OAILinodeConfig::getVirtMode() const {
    return m_virt_mode;
}
void OAILinodeConfig::setVirtMode(const QString &virt_mode) {
    m_virt_mode = virt_mode;
    m_virt_mode_isSet = true;
}

bool OAILinodeConfig::is_virt_mode_Set() const{
    return m_virt_mode_isSet;
}

bool OAILinodeConfig::is_virt_mode_Valid() const{
    return m_virt_mode_isValid;
}

bool OAILinodeConfig::isSet() const {
...
bool OAILinodeConfig::isValid() const {
