...
/*
 * OAIDatabasePostgreSQLRequest.h
 *
 * Managed PostgreSQL Database request object.
 */

#ifndef OAIDatabasePostgreSQLRequest_H
#define OAIDatabasePostgreSQLRequest_H
...
class OAIDatabasePostgreSQLRequest : public OAIObject {
public:
    OAIDatabasePostgreSQLRequest();
    OAIDatabasePostgreSQLRequest(QString json);
    ~OAIDatabasePostgreSQLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabasePostgreSQLRequest)

#endif // OAIDatabasePostgreSQLRequest_H
