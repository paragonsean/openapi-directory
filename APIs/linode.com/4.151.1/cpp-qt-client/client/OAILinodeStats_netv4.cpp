...
#include "OAILinodeStats_netv4.h"
...
OAILinodeStats_netv4::OAILinodeStats_netv4(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeStats_netv4::OAILinodeStats_netv4() {
    this->initializeModel();
}

OAILinodeStats_netv4::~OAILinodeStats_netv4() {}

void OAILinodeStats_netv4::initializeModel() {
...
void OAILinodeStats_netv4::fromJson(QString jsonString) {
...
void OAILinodeStats_netv4::fromJsonObject(QJsonObject json) {
...
QString OAILinodeStats_netv4::asJson() const {
...
QJsonObject OAILinodeStats_netv4::asJsonObject() const {
    QJsonObject obj;
    if (m_in.size() > 0) {
...
QList<QList<double>> OAILinodeStats_netv4::getIn() const {
    return m_in;
}
void OAILinodeStats_netv4::setIn(const QList<QList<double>> &in) {
    m_in = in;
    m_in_isSet = true;
}

bool OAILinodeStats_netv4::is_in_Set() const{
    return m_in_isSet;
}

bool OAILinodeStats_netv4::is_in_Valid() const{
    return m_in_isValid;
}

QList<QList<double>> OAILinodeStats_netv4::getOut() const {
    return m_out;
}
void OAILinodeStats_netv4::setOut(const QList<QList<double>> &out) {
    m_out = out;
    m_out_isSet = true;
}

bool OAILinodeStats_netv4::is_out_Set() const{
    return m_out_isSet;
}

bool OAILinodeStats_netv4::is_out_Valid() const{
    return m_out_isValid;
}

QList<QList<double>> OAILinodeStats_netv4::getPrivateIn() const {
    return m_private_in;
}
void OAILinodeStats_netv4::setPrivateIn(const QList<QList<double>> &private_in) {
    m_private_in = private_in;
    m_private_in_isSet = true;
}

bool OAILinodeStats_netv4::is_private_in_Set() const{
    return m_private_in_isSet;
}

bool OAILinodeStats_netv4::is_private_in_Valid() const{
    return m_private_in_isValid;
}

QList<QList<double>> OAILinodeStats_netv4::getPrivateOut() const {
    return m_private_out;
}
void OAILinodeStats_netv4::setPrivateOut(const QList<QList<double>> &private_out) {
    m_private_out = private_out;
    m_private_out_isSet = true;
}

bool OAILinodeStats_netv4::is_private_out_Set() const{
    return m_private_out_isSet;
}

bool OAILinodeStats_netv4::is_private_out_Valid() const{
    return m_private_out_isValid;
}

bool OAILinodeStats_netv4::isSet() const {
...
bool OAILinodeStats_netv4::isValid() const {
