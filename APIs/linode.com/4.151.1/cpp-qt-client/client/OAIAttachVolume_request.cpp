...
#include "OAIAttachVolume_request.h"
...
OAIAttachVolume_request::OAIAttachVolume_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachVolume_request::OAIAttachVolume_request() {
    this->initializeModel();
}

OAIAttachVolume_request::~OAIAttachVolume_request() {}

void OAIAttachVolume_request::initializeModel() {
    ...
    m_persist_across_boots_isSet = false;
    m_persist_across_boots_isValid = false;
}

void OAIAttachVolume_request::fromJson(QString jsonString) {
...
void OAIAttachVolume_request::fromJsonObject(QJsonObject json) {
    ...
    m_persist_across_boots_isValid = ::OpenAPI::fromJsonValue(m_persist_across_boots, json[QString("persist_across_boots")]);
    m_persist_across_boots_isSet = !json[QString("persist_across_boots")].isNull() && m_persist_across_boots_isValid;
}

QString OAIAttachVolume_request::asJson() const {
...
QJsonObject OAIAttachVolume_request::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_persist_across_boots_isSet) {
        obj.insert(QString("persist_across_boots"), ::OpenAPI::toJsonValue(m_persist_across_boots));
    }
    return obj;
}

qint32 OAIAttachVolume_request::getConfigId() const {
    return m_config_id;
}
void OAIAttachVolume_request::setConfigId(const qint32 &config_id) {
    m_config_id = config_id;
    m_config_id_isSet = true;
}

bool OAIAttachVolume_request::is_config_id_Set() const{
    return m_config_id_isSet;
}

bool OAIAttachVolume_request::is_config_id_Valid() const{
    return m_config_id_isValid;
}

qint32 OAIAttachVolume_request::getLinodeId() const {
    return m_linode_id;
}
void OAIAttachVolume_request::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIAttachVolume_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIAttachVolume_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

bool OAIAttachVolume_request::isPersistAcrossBoots() const {
    return m_persist_across_boots;
}
void OAIAttachVolume_request::setPersistAcrossBoots(const bool &persist_across_boots) {
    m_persist_across_boots = persist_across_boots;
    m_persist_across_boots_isSet = true;
}

bool OAIAttachVolume_request::is_persist_across_boots_Set() const{
    return m_persist_across_boots_isSet;
}

bool OAIAttachVolume_request::is_persist_across_boots_Valid() const{
    return m_persist_across_boots_isValid;
}

bool OAIAttachVolume_request::isSet() const {
...
bool OAIAttachVolume_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_linode_id_isValid && true;
}
