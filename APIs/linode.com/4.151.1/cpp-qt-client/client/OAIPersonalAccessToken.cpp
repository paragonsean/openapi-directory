...
OAIPersonalAccessToken::OAIPersonalAccessToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonalAccessToken::OAIPersonalAccessToken() {
    this->initializeModel();
}

OAIPersonalAccessToken::~OAIPersonalAccessToken() {}

void OAIPersonalAccessToken::initializeModel() {
...
void OAIPersonalAccessToken::fromJson(QString jsonString) {
...
void OAIPersonalAccessToken::fromJsonObject(QJsonObject json) {
...
QString OAIPersonalAccessToken::asJson() const {
...
QJsonObject OAIPersonalAccessToken::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIPersonalAccessToken::getCreated() const {
    return m_created;
}
void OAIPersonalAccessToken::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIPersonalAccessToken::is_created_Set() const{
    return m_created_isSet;
}

bool OAIPersonalAccessToken::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIPersonalAccessToken::getExpiry() const {
    return m_expiry;
}
void OAIPersonalAccessToken::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIPersonalAccessToken::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIPersonalAccessToken::is_expiry_Valid() const{
    return m_expiry_isValid;
}

qint32 OAIPersonalAccessToken::getId() const {
    return m_id;
}
void OAIPersonalAccessToken::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPersonalAccessToken::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPersonalAccessToken::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPersonalAccessToken::getLabel() const {
    return m_label;
}
void OAIPersonalAccessToken::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPersonalAccessToken::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPersonalAccessToken::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIPersonalAccessToken::getScopes() const {
    return m_scopes;
}
void OAIPersonalAccessToken::setScopes(const QString &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIPersonalAccessToken::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIPersonalAccessToken::is_scopes_Valid() const{
    return m_scopes_isValid;
}

QString OAIPersonalAccessToken::getToken() const {
    return m_token;
}
void OAIPersonalAccessToken::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIPersonalAccessToken::is_token_Set() const{
    return m_token_isSet;
}

bool OAIPersonalAccessToken::is_token_Valid() const{
    return m_token_isValid;
}

bool OAIPersonalAccessToken::isSet() const {
...
bool OAIPersonalAccessToken::isValid() const {
