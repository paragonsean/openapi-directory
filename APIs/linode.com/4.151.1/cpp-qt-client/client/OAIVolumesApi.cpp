...
void OAIVolumesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloneVolume", defaultConf);
    _serverIndices.insert("cloneVolume", 0);
    ...
    _serverConfigs.insert("getVolume", defaultConf);
    _serverIndices.insert("getVolume", 0);
    _serverConfigs.insert("getVolumes", defaultConf);
    _serverIndices.insert("getVolumes", 0);
    _serverConfigs.insert("resizeVolume", defaultConf);
    _serverIndices.insert("resizeVolume", 0);
...
void OAIVolumesApi::attachVolume(const qint32 &volume_id, const OAIAttachVolume_request &oai_attach_volume_request) {
    QString fullPath = QString(_serverConfigs["attachVolume"][_serverIndices.value("attachVolume")].URL()+"/volumes/{volumeId}/attach");
...

    {
        ...
        QByteArray output = oai_attach_volume_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::attachVolumeCallback);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("volumes:read_write");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::attachVolumeCallback);
...
void OAIVolumesApi::attachVolumeCallback(OAIHttpRequestWorker *worker) {
...
void OAIVolumesApi::cloneVolume(const qint32 &volume_id, const OAICloneVolume_request &oai_clone_volume_request) {
    QString fullPath = QString(_serverConfigs["cloneVolume"][_serverIndices.value("cloneVolume")].URL()+"/volumes/{volumeId}/clone");
...

    {
        ...
        QByteArray output = oai_clone_volume_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::cloneVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::cloneVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::cloneVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloneVolumeSignal(output);
        Q_EMIT cloneVolumeSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("volumes:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloneVolumeSignalE(output, error_type, error_str);
        Q_EMIT cloneVolumeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloneVolumeSignalError(output, error_type, error_str);
        Q_EMIT cloneVolumeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVolumesApi::createVolume(const OAICreateVolume_request &oai_create_volume_request) {
    QString fullPath = QString(_serverConfigs["createVolume"][_serverIndices.value("createVolume")].URL()+"/volumes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::createVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::createVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::createVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVolumesApi::deleteVolume(const qint32 &volume_id) {
    QString fullPath = QString(_serverConfigs["deleteVolume"][_serverIndices.value("deleteVolume")].URL()+"/volumes/{volumeId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::deleteVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::deleteVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::deleteVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVolumesApi::detachVolume(const qint32 &volume_id) {
    QString fullPath = QString(_serverConfigs["detachVolume"][_serverIndices.value("detachVolume")].URL()+"/volumes/{volumeId}/detach");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::detachVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::detachVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::detachVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVolumesApi::getVolume(const qint32 &volume_id, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getVolume"][_serverIndices.value("getVolume")].URL()+"/volumes/{volumeId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::getVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("volumes:read_only");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::getVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::getVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVolumeSignal(output);
        Q_EMIT getVolumeSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("volumes:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVolumeSignalE(output, error_type, error_str);
        Q_EMIT getVolumeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVolumeSignalError(output, error_type, error_str);
        Q_EMIT getVolumeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVolumesApi::getVolumes(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getVolumes"][_serverIndices.value("getVolumes")].URL()+"/volumes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::getVolumesCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::getVolumesCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::getVolumesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetLinodeVolumes_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVolumesSignal(output);
        Q_EMIT getVolumesSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("volumes:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVolumesSignalE(output, error_type, error_str);
        Q_EMIT getVolumesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVolumesSignalError(output, error_type, error_str);
        Q_EMIT getVolumesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVolumesApi::resizeVolume(const qint32 &volume_id, const OAIResizeVolume_request &oai_resize_volume_request) {
    QString fullPath = QString(_serverConfigs["resizeVolume"][_serverIndices.value("resizeVolume")].URL()+"/volumes/{volumeId}/resize");
...

    {
        ...
        QByteArray output = oai_resize_volume_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::resizeVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::resizeVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::resizeVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resizeVolumeSignal(output);
        Q_EMIT resizeVolumeSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("volumes:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resizeVolumeSignalE(output, error_type, error_str);
        Q_EMIT resizeVolumeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resizeVolumeSignalError(output, error_type, error_str);
        Q_EMIT resizeVolumeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVolumesApi::updateVolume(const qint32 &volume_id, const OAIUpdateVolume_request &oai_update_volume_request) {
    QString fullPath = QString(_serverConfigs["updateVolume"][_serverIndices.value("updateVolume")].URL()+"/volumes/{volumeId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::updateVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVolumesApi::updateVolumeCallback);
    connect(this, &OAIVolumesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVolumesApi::updateVolumeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
