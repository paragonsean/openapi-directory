...
OAIPutDatabasesMongoDBInstance_request::OAIPutDatabasesMongoDBInstance_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDatabasesMongoDBInstance_request::OAIPutDatabasesMongoDBInstance_request() {
    this->initializeModel();
}

OAIPutDatabasesMongoDBInstance_request::~OAIPutDatabasesMongoDBInstance_request() {}

void OAIPutDatabasesMongoDBInstance_request::initializeModel() {
...
void OAIPutDatabasesMongoDBInstance_request::fromJson(QString jsonString) {
...
void OAIPutDatabasesMongoDBInstance_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutDatabasesMongoDBInstance_request::asJson() const {
...
QJsonObject OAIPutDatabasesMongoDBInstance_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIPutDatabasesMongoDBInstance_request::getAllowList() const {
    return m_allow_list;
}
void OAIPutDatabasesMongoDBInstance_request::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIPutDatabasesMongoDBInstance_request::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIPutDatabasesMongoDBInstance_request::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

QString OAIPutDatabasesMongoDBInstance_request::getLabel() const {
    return m_label;
}
void OAIPutDatabasesMongoDBInstance_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPutDatabasesMongoDBInstance_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPutDatabasesMongoDBInstance_request::is_label_Valid() const{
    return m_label_isValid;
}

OAIDatabase_updates OAIPutDatabasesMongoDBInstance_request::getUpdates() const {
    return m_updates;
}
void OAIPutDatabasesMongoDBInstance_request::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIPutDatabasesMongoDBInstance_request::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIPutDatabasesMongoDBInstance_request::is_updates_Valid() const{
    return m_updates_isValid;
}

bool OAIPutDatabasesMongoDBInstance_request::isSet() const {
...
bool OAIPutDatabasesMongoDBInstance_request::isValid() const {
