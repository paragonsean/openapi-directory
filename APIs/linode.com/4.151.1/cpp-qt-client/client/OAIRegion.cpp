...
void OAIRegion::initializeModel() {
    ...
    m_resolvers_isSet = false;
    m_resolvers_isValid = false;
...
void OAIRegion::fromJsonObject(QJsonObject json) {
    ...
    m_resolvers_isValid = ::OpenAPI::fromJsonValue(m_resolvers, json[QString("resolvers")]);
    m_resolvers_isSet = !json[QString("resolvers")].isNull() && m_resolvers_isValid;
...
QJsonObject OAIRegion::asJsonObject() const {
    ...
    if (m_resolvers.isSet()) {
        obj.insert(QString("resolvers"), ::OpenAPI::toJsonValue(m_resolvers));
    }
    if (m_status_isSet) {
...
QList<QString> OAIRegion::getCapabilities() const {
    return m_capabilities;
}
void OAIRegion::setCapabilities(const QList<QString> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIRegion::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIRegion::is_capabilities_Valid() const{
...
QString OAIRegion::getLabel() const {
    return m_label;
}
void OAIRegion::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIRegion::is_label_Set() const{
    return m_label_isSet;
}

bool OAIRegion::is_label_Valid() const{
    return m_label_isValid;
}

OAIRegion_resolvers OAIRegion::getResolvers() const {
    return m_resolvers;
}
void OAIRegion::setResolvers(const OAIRegion_resolvers &resolvers) {
    m_resolvers = resolvers;
    m_resolvers_isSet = true;
}

bool OAIRegion::is_resolvers_Set() const{
    return m_resolvers_isSet;
}

bool OAIRegion::is_resolvers_Valid() const{
    return m_resolvers_isValid;
}

QString OAIRegion::getStatus() const {
    return m_status;
}
void OAIRegion::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRegion::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRegion::is_status_Valid() const{
