...
void OAIPromotion::initializeModel() {
    ...
    m_credit_monthly_cap_isSet = false;
    m_credit_monthly_cap_isValid = false;

    m_credit_remaining_isSet = false;
    m_credit_remaining_isValid = false;

    m_description_isSet = false;
    m_description_isValid = false;

    m_expire_dt_isSet = false;
    m_expire_dt_isValid = false;
    ...
    m_this_month_credit_remaining_isSet = false;
    m_this_month_credit_remaining_isValid = false;
}
...
void OAIPromotion::fromJsonObject(QJsonObject json) {
    ...
    m_credit_monthly_cap_isValid = ::OpenAPI::fromJsonValue(m_credit_monthly_cap, json[QString("credit_monthly_cap")]);
    m_credit_monthly_cap_isSet = !json[QString("credit_monthly_cap")].isNull() && m_credit_monthly_cap_isValid;

    m_credit_remaining_isValid = ::OpenAPI::fromJsonValue(m_credit_remaining, json[QString("credit_remaining")]);
    m_credit_remaining_isSet = !json[QString("credit_remaining")].isNull() && m_credit_remaining_isValid;

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;

    m_expire_dt_isValid = ::OpenAPI::fromJsonValue(m_expire_dt, json[QString("expire_dt")]);
    m_expire_dt_isSet = !json[QString("expire_dt")].isNull() && m_expire_dt_isValid;
    ...
    m_this_month_credit_remaining_isValid = ::OpenAPI::fromJsonValue(m_this_month_credit_remaining, json[QString("this_month_credit_remaining")]);
    m_this_month_credit_remaining_isSet = !json[QString("this_month_credit_remaining")].isNull() && m_this_month_credit_remaining_isValid;
}
...
QJsonObject OAIPromotion::asJsonObject() const {
    QJsonObject obj;
    if (m_credit_monthly_cap_isSet) {
        obj.insert(QString("credit_monthly_cap"), ::OpenAPI::toJsonValue(m_credit_monthly_cap));
    }
    if (m_credit_remaining_isSet) {
        obj.insert(QString("credit_remaining"), ::OpenAPI::toJsonValue(m_credit_remaining));
    }
    if (m_description_isSet) {
        obj.insert(QString("description"), ::OpenAPI::toJsonValue(m_description));
    }
    if (m_expire_dt_isSet) {
        obj.insert(QString("expire_dt"), ::OpenAPI::toJsonValue(m_expire_dt));
    }
    ...
    if (m_this_month_credit_remaining_isSet) {
        obj.insert(QString("this_month_credit_remaining"), ::OpenAPI::toJsonValue(m_this_month_credit_remaining));
    }
    return obj;
}

QString OAIPromotion::getCreditMonthlyCap() const {
    return m_credit_monthly_cap;
}
void OAIPromotion::setCreditMonthlyCap(const QString &credit_monthly_cap) {
    m_credit_monthly_cap = credit_monthly_cap;
    m_credit_monthly_cap_isSet = true;
}

bool OAIPromotion::is_credit_monthly_cap_Set() const{
    return m_credit_monthly_cap_isSet;
}

bool OAIPromotion::is_credit_monthly_cap_Valid() const{
    return m_credit_monthly_cap_isValid;
}

QString OAIPromotion::getCreditRemaining() const {
    return m_credit_remaining;
}
void OAIPromotion::setCreditRemaining(const QString &credit_remaining) {
    m_credit_remaining = credit_remaining;
    m_credit_remaining_isSet = true;
}

bool OAIPromotion::is_credit_remaining_Set() const{
    return m_credit_remaining_isSet;
}

bool OAIPromotion::is_credit_remaining_Valid() const{
    return m_credit_remaining_isValid;
}

QString OAIPromotion::getDescription() const {
    return m_description;
}
void OAIPromotion::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPromotion::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPromotion::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPromotion::getExpireDt() const {
    return m_expire_dt;
}
void OAIPromotion::setExpireDt(const QString &expire_dt) {
    m_expire_dt = expire_dt;
    m_expire_dt_isSet = true;
}

bool OAIPromotion::is_expire_dt_Set() const{
    return m_expire_dt_isSet;
}

bool OAIPromotion::is_expire_dt_Valid() const{
    return m_expire_dt_isValid;
}

QString OAIPromotion::getImageUrl() const {
    return m_image_url;
}
void OAIPromotion::setImageUrl(const QString &image_url) {
    m_image_url = image_url;
    m_image_url_isSet = true;
}

bool OAIPromotion::is_image_url_Set() const{
    return m_image_url_isSet;
}

bool OAIPromotion::is_image_url_Valid() const{
    return m_image_url_isValid;
}

QString OAIPromotion::getServiceType() const {
    return m_service_type;
}
void OAIPromotion::setServiceType(const QString &service_type) {
    m_service_type = service_type;
    m_service_type_isSet = true;
}

bool OAIPromotion::is_service_type_Set() const{
    return m_service_type_isSet;
}

bool OAIPromotion::is_service_type_Valid() const{
    return m_service_type_isValid;
}

QString OAIPromotion::getSummary() const {
    return m_summary;
}
void OAIPromotion::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPromotion::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPromotion::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAIPromotion::getThisMonthCreditRemaining() const {
    return m_this_month_credit_remaining;
}
void OAIPromotion::setThisMonthCreditRemaining(const QString &this_month_credit_remaining) {
    m_this_month_credit_remaining = this_month_credit_remaining;
    m_this_month_credit_remaining_isSet = true;
}

bool OAIPromotion::is_this_month_credit_remaining_Set() const{
    return m_this_month_credit_remaining_isSet;
}

bool OAIPromotion::is_this_month_credit_remaining_Valid() const{
    return m_this_month_credit_remaining_isValid;
}
