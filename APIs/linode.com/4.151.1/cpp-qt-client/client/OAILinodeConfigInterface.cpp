...
#include "OAILinodeConfigInterface.h"
...
OAILinodeConfigInterface::OAILinodeConfigInterface(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeConfigInterface::OAILinodeConfigInterface() {
    this->initializeModel();
}

OAILinodeConfigInterface::~OAILinodeConfigInterface() {}

void OAILinodeConfigInterface::initializeModel() {

    m_ipam_address_isSet = false;
    m_ipam_address_isValid = false;
...
void OAILinodeConfigInterface::fromJson(QString jsonString) {
...
void OAILinodeConfigInterface::fromJsonObject(QJsonObject json) {

    m_ipam_address_isValid = ::OpenAPI::fromJsonValue(m_ipam_address, json[QString("ipam_address")]);
    m_ipam_address_isSet = !json[QString("ipam_address")].isNull() && m_ipam_address_isValid;
...
QString OAILinodeConfigInterface::asJson() const {
...
QJsonObject OAILinodeConfigInterface::asJsonObject() const {
    QJsonObject obj;
    if (m_ipam_address_isSet) {
        obj.insert(QString("ipam_address"), ::OpenAPI::toJsonValue(m_ipam_address));
    }
    if (m_label_isSet) {
...
QString OAILinodeConfigInterface::getIpamAddress() const {
    return m_ipam_address;
}
void OAILinodeConfigInterface::setIpamAddress(const QString &ipam_address) {
    m_ipam_address = ipam_address;
    m_ipam_address_isSet = true;
}

bool OAILinodeConfigInterface::is_ipam_address_Set() const{
    return m_ipam_address_isSet;
}

bool OAILinodeConfigInterface::is_ipam_address_Valid() const{
    return m_ipam_address_isValid;
}

QString OAILinodeConfigInterface::getLabel() const {
    return m_label;
}
void OAILinodeConfigInterface::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILinodeConfigInterface::is_label_Set() const{
    return m_label_isSet;
}

bool OAILinodeConfigInterface::is_label_Valid() const{
    return m_label_isValid;
}

QString OAILinodeConfigInterface::getPurpose() const {
    return m_purpose;
}
void OAILinodeConfigInterface::setPurpose(const QString &purpose) {
    m_purpose = purpose;
    m_purpose_isSet = true;
}

bool OAILinodeConfigInterface::is_purpose_Set() const{
    return m_purpose_isSet;
}

bool OAILinodeConfigInterface::is_purpose_Valid() const{
    return m_purpose_isValid;
}

bool OAILinodeConfigInterface::isSet() const {
...
bool OAILinodeConfigInterface::isValid() const {
