...
OAILinode::OAILinode(QString json) {
...
void OAILinode::initializeModel() {
...
void OAILinode::fromJson(QString jsonString) {
...
void OAILinode::fromJsonObject(QJsonObject json) {
...
QString OAILinode::asJson() const {
...
QJsonObject OAILinode::asJsonObject() const {
    QJsonObject obj;
    if (m_alerts.isSet()) {
...
OAILinode_alerts OAILinode::getAlerts() const {
    return m_alerts;
}
void OAILinode::setAlerts(const OAILinode_alerts &alerts) {
    m_alerts = alerts;
    m_alerts_isSet = true;
}

bool OAILinode::is_alerts_Set() const{
    return m_alerts_isSet;
}

bool OAILinode::is_alerts_Valid() const{
    return m_alerts_isValid;
}

OAILinode_backups OAILinode::getBackups() const {
    return m_backups;
}
void OAILinode::setBackups(const OAILinode_backups &backups) {
    m_backups = backups;
    m_backups_isSet = true;
}

bool OAILinode::is_backups_Set() const{
    return m_backups_isSet;
}

bool OAILinode::is_backups_Valid() const{
    return m_backups_isValid;
}

QDateTime OAILinode::getCreated() const {
    return m_created;
}
void OAILinode::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAILinode::is_created_Set() const{
    return m_created_isSet;
}

bool OAILinode::is_created_Valid() const{
    return m_created_isValid;
}

QString OAILinode::getGroup() const {
    return m_group;
}
void OAILinode::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAILinode::is_group_Set() const{
    return m_group_isSet;
}

bool OAILinode::is_group_Valid() const{
    return m_group_isValid;
}

QString OAILinode::getHostUuid() const {
    return m_host_uuid;
}
void OAILinode::setHostUuid(const QString &host_uuid) {
    m_host_uuid = host_uuid;
    m_host_uuid_isSet = true;
}

bool OAILinode::is_host_uuid_Set() const{
    return m_host_uuid_isSet;
}

bool OAILinode::is_host_uuid_Valid() const{
    return m_host_uuid_isValid;
}

QString OAILinode::getHypervisor() const {
    return m_hypervisor;
}
void OAILinode::setHypervisor(const QString &hypervisor) {
    m_hypervisor = hypervisor;
    m_hypervisor_isSet = true;
}

bool OAILinode::is_hypervisor_Set() const{
    return m_hypervisor_isSet;
}

bool OAILinode::is_hypervisor_Valid() const{
    return m_hypervisor_isValid;
}

qint32 OAILinode::getId() const {
    return m_id;
}
void OAILinode::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILinode::is_id_Set() const{
    return m_id_isSet;
}

bool OAILinode::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILinode::getImage() const {
    return m_image;
}
void OAILinode::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAILinode::is_image_Set() const{
    return m_image_isSet;
}

bool OAILinode::is_image_Valid() const{
    return m_image_isValid;
}

QList<QString> OAILinode::getIpv4() const {
    return m_ipv4;
}
void OAILinode::setIpv4(const QList<QString> &ipv4) {
    m_ipv4 = ipv4;
    m_ipv4_isSet = true;
}

bool OAILinode::is_ipv4_Set() const{
    return m_ipv4_isSet;
}

bool OAILinode::is_ipv4_Valid() const{
    return m_ipv4_isValid;
}

QString OAILinode::getIpv6() const {
    return m_ipv6;
}
void OAILinode::setIpv6(const QString &ipv6) {
    m_ipv6 = ipv6;
    m_ipv6_isSet = true;
}

bool OAILinode::is_ipv6_Set() const{
    return m_ipv6_isSet;
}

bool OAILinode::is_ipv6_Valid() const{
    return m_ipv6_isValid;
}

QString OAILinode::getLabel() const {
    return m_label;
}
void OAILinode::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILinode::is_label_Set() const{
    return m_label_isSet;
}

bool OAILinode::is_label_Valid() const{
    return m_label_isValid;
}

QString OAILinode::getRegion() const {
    return m_region;
}
void OAILinode::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAILinode::is_region_Set() const{
    return m_region_isSet;
}

bool OAILinode::is_region_Valid() const{
    return m_region_isValid;
}

OAILinode_specs OAILinode::getSpecs() const {
    return m_specs;
}
void OAILinode::setSpecs(const OAILinode_specs &specs) {
    m_specs = specs;
    m_specs_isSet = true;
}

bool OAILinode::is_specs_Set() const{
    return m_specs_isSet;
}

bool OAILinode::is_specs_Valid() const{
    return m_specs_isValid;
}

QString OAILinode::getStatus() const {
    return m_status;
}
void OAILinode::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILinode::is_status_Set() const{
    return m_status_isSet;
}

bool OAILinode::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAILinode::getTags() const {
    return m_tags;
}
void OAILinode::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILinode::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILinode::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAILinode::getType() const {
    return m_type;
}
void OAILinode::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILinode::is_type_Set() const{
    return m_type_isSet;
}

bool OAILinode::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAILinode::getUpdated() const {
    return m_updated;
}
void OAILinode::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAILinode::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAILinode::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAILinode::isWatchdogEnabled() const {
    return m_watchdog_enabled;
}
void OAILinode::setWatchdogEnabled(const bool &watchdog_enabled) {
    m_watchdog_enabled = watchdog_enabled;
    m_watchdog_enabled_isSet = true;
}

bool OAILinode::is_watchdog_enabled_Set() const{
    return m_watchdog_enabled_isSet;
}

bool OAILinode::is_watchdog_enabled_Valid() const{
    return m_watchdog_enabled_isValid;
}

bool OAILinode::isSet() const {
