...
/*
 * OAIGrantsResponse_global.h
 *
 * A structure containing the Account-level grants a User has. 
 */

#ifndef OAIGrantsResponse_global_H
#define OAIGrantsResponse_global_H
...
class OAIGrantsResponse_global : public OAIObject {
public:
    OAIGrantsResponse_global();
    OAIGrantsResponse_global(QString json);
    ~OAIGrantsResponse_global() override;
    ...
    QString getAccountAccess() const;
    void setAccountAccess(const QString &account_access);
    bool is_account_access_Set() const;
    bool is_account_access_Valid() const;

    bool isAddDatabases() const;
    void setAddDatabases(const bool &add_databases);
    bool is_add_databases_Set() const;
    bool is_add_databases_Valid() const;

    bool isAddDomains() const;
    void setAddDomains(const bool &add_domains);
    bool is_add_domains_Set() const;
    bool is_add_domains_Valid() const;

    bool isAddFirewalls() const;
    void setAddFirewalls(const bool &add_firewalls);
    bool is_add_firewalls_Set() const;
    bool is_add_firewalls_Valid() const;

    bool isAddImages() const;
    void setAddImages(const bool &add_images);
    bool is_add_images_Set() const;
    bool is_add_images_Valid() const;

    bool isAddLinodes() const;
    void setAddLinodes(const bool &add_linodes);
    bool is_add_linodes_Set() const;
    bool is_add_linodes_Valid() const;

    bool isAddLongview() const;
    void setAddLongview(const bool &add_longview);
    bool is_add_longview_Set() const;
    bool is_add_longview_Valid() const;

    bool isAddNodebalancers() const;
    void setAddNodebalancers(const bool &add_nodebalancers);
    bool is_add_nodebalancers_Set() const;
    bool is_add_nodebalancers_Valid() const;

    bool isAddStackscripts() const;
    void setAddStackscripts(const bool &add_stackscripts);
    bool is_add_stackscripts_Set() const;
    bool is_add_stackscripts_Valid() const;

    bool isAddVolumes() const;
    void setAddVolumes(const bool &add_volumes);
    bool is_add_volumes_Set() const;
    bool is_add_volumes_Valid() const;

    bool isCancelAccount() const;
    void setCancelAccount(const bool &cancel_account);
    bool is_cancel_account_Set() const;
    bool is_cancel_account_Valid() const;

    bool isLongviewSubscription() const;
    void setLongviewSubscription(const bool &longview_subscription);
    bool is_longview_subscription_Set() const;
    bool is_longview_subscription_Valid() const;
...
private:
    ...
    QString m_account_access;
    bool m_account_access_isSet;
    bool m_account_access_isValid;

    bool m_add_databases;
    bool m_add_databases_isSet;
    bool m_add_databases_isValid;

    bool m_add_domains;
    bool m_add_domains_isSet;
    bool m_add_domains_isValid;

    bool m_add_firewalls;
    bool m_add_firewalls_isSet;
    bool m_add_firewalls_isValid;

    bool m_add_images;
    bool m_add_images_isSet;
    bool m_add_images_isValid;

    bool m_add_linodes;
    bool m_add_linodes_isSet;
    bool m_add_linodes_isValid;

    bool m_add_longview;
    bool m_add_longview_isSet;
    bool m_add_longview_isValid;

    bool m_add_nodebalancers;
    bool m_add_nodebalancers_isSet;
    bool m_add_nodebalancers_isValid;

    bool m_add_stackscripts;
    bool m_add_stackscripts_isSet;
    bool m_add_stackscripts_isValid;

    bool m_add_volumes;
    bool m_add_volumes_isSet;
    bool m_add_volumes_isValid;

    bool m_cancel_account;
    bool m_cancel_account_isSet;
    bool m_cancel_account_isValid;

    bool m_longview_subscription;
    bool m_longview_subscription_isSet;
    bool m_longview_subscription_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGrantsResponse_global)

#endif // OAIGrantsResponse_global_H
