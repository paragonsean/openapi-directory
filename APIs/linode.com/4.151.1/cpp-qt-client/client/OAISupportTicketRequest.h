...
#ifndef OAISupportTicketRequest_H
#define OAISupportTicketRequest_H
...
class OAISupportTicketRequest : public OAIObject {
public:
    OAISupportTicketRequest();
    OAISupportTicketRequest(QString json);
    ~OAISupportTicketRequest() override;
    ...
    qint32 getFirewallId() const;
    void setFirewallId(const qint32 &firewall_id);
    bool is_firewall_id_Set() const;
    bool is_firewall_id_Valid() const;

    qint32 getLinodeId() const;
    void setLinodeId(const qint32 &linode_id);
    bool is_linode_id_Set() const;
    bool is_linode_id_Valid() const;

    qint32 getLkeclusterId() const;
    void setLkeclusterId(const qint32 &lkecluster_id);
    bool is_lkecluster_id_Set() const;
    bool is_lkecluster_id_Valid() const;

    qint32 getLongviewclientId() const;
    void setLongviewclientId(const qint32 &longviewclient_id);
    bool is_longviewclient_id_Set() const;
    bool is_longviewclient_id_Valid() const;

    bool isManagedIssue() const;
    void setManagedIssue(const bool &managed_issue);
    bool is_managed_issue_Set() const;
    bool is_managed_issue_Valid() const;

    qint32 getNodebalancerId() const;
    void setNodebalancerId(const qint32 &nodebalancer_id);
    bool is_nodebalancer_id_Set() const;
    bool is_nodebalancer_id_Valid() const;
    ...
    qint32 getVolumeId() const;
    void setVolumeId(const qint32 &volume_id);
...
private:
    ...
    qint32 m_firewall_id;
    bool m_firewall_id_isSet;
    bool m_firewall_id_isValid;

    qint32 m_linode_id;
    bool m_linode_id_isSet;
    bool m_linode_id_isValid;

    qint32 m_lkecluster_id;
    bool m_lkecluster_id_isSet;
    bool m_lkecluster_id_isValid;

    qint32 m_longviewclient_id;
    bool m_longviewclient_id_isSet;
    bool m_longviewclient_id_isValid;

    bool m_managed_issue;
    bool m_managed_issue_isSet;
    bool m_managed_issue_isValid;

    qint32 m_nodebalancer_id;
    bool m_nodebalancer_id_isSet;
    bool m_nodebalancer_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportTicketRequest)

#endif // OAISupportTicketRequest_H
