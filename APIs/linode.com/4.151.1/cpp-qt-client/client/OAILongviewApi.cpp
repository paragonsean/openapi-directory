...
OAILongviewApi::OAILongviewApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILongviewApi::~OAILongviewApi() {
}

void OAILongviewApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("createLongviewClient", defaultConf);
    _serverIndices.insert("createLongviewClient", 0);
    _serverConfigs.insert("deleteLongviewClient", defaultConf);
    _serverIndices.insert("deleteLongviewClient", 0);
    _serverConfigs.insert("getLongviewClient", defaultConf);
    _serverIndices.insert("getLongviewClient", 0);
    _serverConfigs.insert("getLongviewClients", defaultConf);
    _serverIndices.insert("getLongviewClients", 0);
    _serverConfigs.insert("getLongviewPlan", defaultConf);
    _serverIndices.insert("getLongviewPlan", 0);
    _serverConfigs.insert("getLongviewSubscription", defaultConf);
    _serverIndices.insert("getLongviewSubscription", 0);
    _serverConfigs.insert("getLongviewSubscriptions", defaultConf);
    _serverIndices.insert("getLongviewSubscriptions", 0);
    _serverConfigs.insert("updateLongviewClient", defaultConf);
    _serverIndices.insert("updateLongviewClient", 0);
    _serverConfigs.insert("updateLongviewPlan", defaultConf);
    _serverIndices.insert("updateLongviewPlan", 0);
}
...
*/
int OAILongviewApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILongviewApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILongviewApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILongviewApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILongviewApi::setUsername(const QString &username) {
    _username = username;
}

void OAILongviewApi::setPassword(const QString &password) {
    _password = password;
}


void OAILongviewApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILongviewApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILongviewApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILongviewApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILongviewApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILongviewApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILongviewApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILongviewApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILongviewApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILongviewApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILongviewApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILongviewApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILongviewApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILongviewApi::createLongviewClient(const OAILongviewClient &oai_longview_client) {
    QString fullPath = QString(_serverConfigs["createLongviewClient"][_serverIndices.value("createLongviewClient")].URL()+"/longview/clients");
...

    {
        ...
        QByteArray output = oai_longview_client.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::createLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("longview:read_write");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::createLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAILongviewApi::createLongviewClientCallback(OAIHttpRequestWorker *worker) {
    ...
    OAILongviewClient output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createLongviewClientSignal(output);
        Q_EMIT createLongviewClientSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createLongviewClientSignalE(output, error_type, error_str);
        Q_EMIT createLongviewClientSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createLongviewClientSignalError(output, error_type, error_str);
        Q_EMIT createLongviewClientSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::deleteLongviewClient(const qint32 &client_id) {
    QString fullPath = QString(_serverConfigs["deleteLongviewClient"][_serverIndices.value("deleteLongviewClient")].URL()+"/longview/clients/{clientId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::deleteLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::deleteLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::deleteLongviewClientCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteLongviewClientSignal(output);
        Q_EMIT deleteLongviewClientSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteLongviewClientSignalE(output, error_type, error_str);
        Q_EMIT deleteLongviewClientSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteLongviewClientSignalError(output, error_type, error_str);
        Q_EMIT deleteLongviewClientSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::getLongviewClient(const qint32 &client_id) {
    QString fullPath = QString(_serverConfigs["getLongviewClient"][_serverIndices.value("getLongviewClient")].URL()+"/longview/clients/{clientId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("longview:read_only");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::getLongviewClientCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLongviewClientSignal(output);
        Q_EMIT getLongviewClientSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLongviewClientSignalE(output, error_type, error_str);
        Q_EMIT getLongviewClientSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLongviewClientSignalError(output, error_type, error_str);
        Q_EMIT getLongviewClientSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::getLongviewClients(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getLongviewClients"][_serverIndices.value("getLongviewClients")].URL()+"/longview/clients");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewClientsCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewClientsCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::getLongviewClientsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetLongviewClients_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLongviewClientsSignal(output);
        Q_EMIT getLongviewClientsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLongviewClientsSignalE(output, error_type, error_str);
        Q_EMIT getLongviewClientsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLongviewClientsSignalError(output, error_type, error_str);
        Q_EMIT getLongviewClientsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::getLongviewPlan() {
    QString fullPath = QString(_serverConfigs["getLongviewPlan"][_serverIndices.value("getLongviewPlan")].URL()+"/longview/plan");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewPlanCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewPlanCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::getLongviewPlanCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAILongviewSubscription output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLongviewPlanSignal(output);
        Q_EMIT getLongviewPlanSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLongviewPlanSignalE(output, error_type, error_str);
        Q_EMIT getLongviewPlanSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLongviewPlanSignalError(output, error_type, error_str);
        Q_EMIT getLongviewPlanSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::getLongviewSubscription(const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["getLongviewSubscription"][_serverIndices.value("getLongviewSubscription")].URL()+"/longview/subscriptions/{subscriptionId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewSubscriptionCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::getLongviewSubscriptionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLongviewSubscriptionSignal(output);
        Q_EMIT getLongviewSubscriptionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLongviewSubscriptionSignalE(output, error_type, error_str);
        Q_EMIT getLongviewSubscriptionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLongviewSubscriptionSignalError(output, error_type, error_str);
        Q_EMIT getLongviewSubscriptionSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::getLongviewSubscriptions(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getLongviewSubscriptions"][_serverIndices.value("getLongviewSubscriptions")].URL()+"/longview/subscriptions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::getLongviewSubscriptionsCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::getLongviewSubscriptionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetLongviewSubscriptions_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLongviewSubscriptionsSignal(output);
        Q_EMIT getLongviewSubscriptionsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLongviewSubscriptionsSignalE(output, error_type, error_str);
        Q_EMIT getLongviewSubscriptionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLongviewSubscriptionsSignalError(output, error_type, error_str);
        Q_EMIT getLongviewSubscriptionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::updateLongviewClient(const qint32 &client_id, const OAILongviewClient &oai_longview_client) {
    QString fullPath = QString(_serverConfigs["updateLongviewClient"][_serverIndices.value("updateLongviewClient")].URL()+"/longview/clients/{clientId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::updateLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::updateLongviewClientCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::updateLongviewClientCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateLongviewClientSignal(output);
        Q_EMIT updateLongviewClientSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateLongviewClientSignalE(output, error_type, error_str);
        Q_EMIT updateLongviewClientSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateLongviewClientSignalError(output, error_type, error_str);
        Q_EMIT updateLongviewClientSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::updateLongviewPlan(const OAILongviewPlan &oai_longview_plan) {
    QString fullPath = QString(_serverConfigs["updateLongviewPlan"][_serverIndices.value("updateLongviewPlan")].URL()+"/longview/plan");
...

    {
        ...
        QByteArray output = oai_longview_plan.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::updateLongviewPlanCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILongviewApi::updateLongviewPlanCallback);
    connect(this, &OAILongviewApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAILongviewApi::updateLongviewPlanCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateLongviewPlanSignal(output);
        Q_EMIT updateLongviewPlanSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("longview:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateLongviewPlanSignalE(output, error_type, error_str);
        Q_EMIT updateLongviewPlanSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateLongviewPlanSignalError(output, error_type, error_str);
        Q_EMIT updateLongviewPlanSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILongviewApi::tokenAvailable(){
