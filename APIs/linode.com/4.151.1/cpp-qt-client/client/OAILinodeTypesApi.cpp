...
OAILinodeTypesApi::OAILinodeTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILinodeTypesApi::~OAILinodeTypesApi() {
}

void OAILinodeTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getLinodeType", defaultConf);
    _serverIndices.insert("getLinodeType", 0);
    _serverConfigs.insert("getLinodeTypes", defaultConf);
    _serverIndices.insert("getLinodeTypes", 0);
}
...
*/
int OAILinodeTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILinodeTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILinodeTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILinodeTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILinodeTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAILinodeTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAILinodeTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILinodeTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILinodeTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILinodeTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILinodeTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILinodeTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILinodeTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILinodeTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILinodeTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILinodeTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILinodeTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILinodeTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILinodeTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILinodeTypesApi::getLinodeType(const QString &type_id) {
    QString fullPath = QString(_serverConfigs["getLinodeType"][_serverIndices.value("getLinodeType")].URL()+"/linode/types/{typeId}");
    
    
    {
        QString type_idPathParam("{");
        type_idPathParam.append("typeId").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "typeId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"typeId"+pathSuffix : pathPrefix;
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILinodeTypesApi::getLinodeTypeCallback);
    connect(this, &OAILinodeTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAILinodeTypesApi::getLinodeTypeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAILinodeType output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLinodeTypeSignal(output);
        Q_EMIT getLinodeTypeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLinodeTypeSignalE(output, error_type, error_str);
        Q_EMIT getLinodeTypeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLinodeTypeSignalError(output, error_type, error_str);
        Q_EMIT getLinodeTypeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILinodeTypesApi::getLinodeTypes() {
    QString fullPath = QString(_serverConfigs["getLinodeTypes"][_serverIndices.value("getLinodeTypes")].URL()+"/linode/types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILinodeTypesApi::getLinodeTypesCallback);
    connect(this, &OAILinodeTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILinodeTypesApi::getLinodeTypesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetLinodeTypes_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLinodeTypesSignal(output);
        Q_EMIT getLinodeTypesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLinodeTypesSignalE(output, error_type, error_str);
        Q_EMIT getLinodeTypesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLinodeTypesSignalError(output, error_type, error_str);
        Q_EMIT getLinodeTypesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILinodeTypesApi::tokenAvailable(){
