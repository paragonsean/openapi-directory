...
void OAIEvent::initializeModel() {
    ...
    m_secondary_entity_isSet = false;
    m_secondary_entity_isValid = false;
...
void OAIEvent::fromJsonObject(QJsonObject json) {
    ...
    m_secondary_entity_isValid = ::OpenAPI::fromJsonValue(m_secondary_entity, json[QString("secondary_entity")]);
    m_secondary_entity_isSet = !json[QString("secondary_entity")].isNull() && m_secondary_entity_isValid;
...
QJsonObject OAIEvent::asJsonObject() const {
    ...
    if (m_secondary_entity.isSet()) {
        obj.insert(QString("secondary_entity"), ::OpenAPI::toJsonValue(m_secondary_entity));
    }
    if (m_seen_isSet) {
...
QString OAIEvent::getAction() const {
    return m_action;
}
void OAIEvent::setAction(const QString &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIEvent::is_action_Set() const{
    return m_action_isSet;
}

bool OAIEvent::is_action_Valid() const{
...
double OAIEvent::getDuration() const {
    return m_duration;
}
void OAIEvent::setDuration(const double &duration) {
    m_duration = duration;
...
OAIEvent_entity OAIEvent::getEntity() const {
    return m_entity;
}
void OAIEvent::setEntity(const OAIEvent_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIEvent::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIEvent::is_entity_Valid() const{
...
qint32 OAIEvent::getPercentComplete() const {
    return m_percent_complete;
}
void OAIEvent::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIEvent::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIEvent::is_percent_complete_Valid() const{
    return m_percent_complete_isValid;
}

QString OAIEvent::getRate() const {
    return m_rate;
}
void OAIEvent::setRate(const QString &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIEvent::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIEvent::is_rate_Valid() const{
    return m_rate_isValid;
}

bool OAIEvent::isRead() const {
    return m_read;
}
void OAIEvent::setRead(const bool &read) {
    m_read = read;
    m_read_isSet = true;
}

bool OAIEvent::is_read_Set() const{
    return m_read_isSet;
}

bool OAIEvent::is_read_Valid() const{
    return m_read_isValid;
}

OAIEvent_secondary_entity OAIEvent::getSecondaryEntity() const {
    return m_secondary_entity;
}
void OAIEvent::setSecondaryEntity(const OAIEvent_secondary_entity &secondary_entity) {
    m_secondary_entity = secondary_entity;
    m_secondary_entity_isSet = true;
}

bool OAIEvent::is_secondary_entity_Set() const{
    return m_secondary_entity_isSet;
}

bool OAIEvent::is_secondary_entity_Valid() const{
    return m_secondary_entity_isValid;
}

bool OAIEvent::isSeen() const {
    return m_seen;
}
void OAIEvent::setSeen(const bool &seen) {
    m_seen = seen;
    m_seen_isSet = true;
}

bool OAIEvent::is_seen_Set() const{
    return m_seen_isSet;
}

bool OAIEvent::is_seen_Valid() const{
...
QString OAIEvent::getTimeRemaining() const {
    return m_time_remaining;
}
void OAIEvent::setTimeRemaining(const QString &time_remaining) {
    m_time_remaining = time_remaining;
    m_time_remaining_isSet = true;
}

bool OAIEvent::is_time_remaining_Set() const{
    return m_time_remaining_isSet;
}

bool OAIEvent::is_time_remaining_Valid() const{
