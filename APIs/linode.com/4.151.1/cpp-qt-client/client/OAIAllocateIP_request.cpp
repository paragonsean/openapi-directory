...
OAIAllocateIP_request::OAIAllocateIP_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllocateIP_request::OAIAllocateIP_request() {
    this->initializeModel();
}

OAIAllocateIP_request::~OAIAllocateIP_request() {}

void OAIAllocateIP_request::initializeModel() {
...
void OAIAllocateIP_request::fromJson(QString jsonString) {
...
void OAIAllocateIP_request::fromJsonObject(QJsonObject json) {
...
QString OAIAllocateIP_request::asJson() const {
...
QJsonObject OAIAllocateIP_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAllocateIP_request::getLinodeId() const {
    return m_linode_id;
}
void OAIAllocateIP_request::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIAllocateIP_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIAllocateIP_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

bool OAIAllocateIP_request::isRPublic() const {
    return m_r_public;
}
void OAIAllocateIP_request::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIAllocateIP_request::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIAllocateIP_request::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIAllocateIP_request::getType() const {
    return m_type;
}
void OAIAllocateIP_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAllocateIP_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAllocateIP_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAllocateIP_request::isSet() const {
...
bool OAIAllocateIP_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_linode_id_isValid && m_r_public_isValid && m_type_isValid && true;
}
