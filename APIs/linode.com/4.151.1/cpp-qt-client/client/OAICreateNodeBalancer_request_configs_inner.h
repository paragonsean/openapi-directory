...
/*
 * OAICreateNodeBalancer_request_configs_inner.h
 *
 * A request object representing a NodeBalancer Config, including Nodes.
 */

#ifndef OAICreateNodeBalancer_request_configs_inner_H
#define OAICreateNodeBalancer_request_configs_inner_H
...
namespace OpenAPI {
class OAINodeBalancerNode;

class OAICreateNodeBalancer_request_configs_inner : public OAIObject {
public:
    OAICreateNodeBalancer_request_configs_inner();
    OAICreateNodeBalancer_request_configs_inner(QString json);
    ~OAICreateNodeBalancer_request_configs_inner() override;
    ...
    QList<OAINodeBalancerNode> getNodes() const;
    void setNodes(const QList<OAINodeBalancerNode> &nodes);
...
private:
    ...
    QList<OAINodeBalancerNode> m_nodes;
    bool m_nodes_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNodeBalancer_request_configs_inner)

#endif // OAICreateNodeBalancer_request_configs_inner_H
