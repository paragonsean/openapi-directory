...
OAISupportTicket_entity::OAISupportTicket_entity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportTicket_entity::OAISupportTicket_entity() {
    this->initializeModel();
}

OAISupportTicket_entity::~OAISupportTicket_entity() {}

void OAISupportTicket_entity::initializeModel() {
...
void OAISupportTicket_entity::fromJson(QString jsonString) {
...
void OAISupportTicket_entity::fromJsonObject(QJsonObject json) {
...
QString OAISupportTicket_entity::asJson() const {
...
QJsonObject OAISupportTicket_entity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAISupportTicket_entity::getId() const {
    return m_id;
}
void OAISupportTicket_entity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISupportTicket_entity::is_id_Set() const{
    return m_id_isSet;
}

bool OAISupportTicket_entity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISupportTicket_entity::getLabel() const {
    return m_label;
}
void OAISupportTicket_entity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISupportTicket_entity::is_label_Set() const{
    return m_label_isSet;
}

bool OAISupportTicket_entity::is_label_Valid() const{
    return m_label_isValid;
}

QString OAISupportTicket_entity::getType() const {
    return m_type;
}
void OAISupportTicket_entity::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISupportTicket_entity::is_type_Set() const{
    return m_type_isSet;
}

bool OAISupportTicket_entity::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISupportTicket_entity::getUrl() const {
    return m_url;
}
void OAISupportTicket_entity::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAISupportTicket_entity::is_url_Set() const{
    return m_url_isSet;
}

bool OAISupportTicket_entity::is_url_Valid() const{
    return m_url_isValid;
}

bool OAISupportTicket_entity::isSet() const {
...
bool OAISupportTicket_entity::isValid() const {
