...
OAILinodeStats::OAILinodeStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinodeStats::OAILinodeStats() {
    this->initializeModel();
}

OAILinodeStats::~OAILinodeStats() {}

void OAILinodeStats::initializeModel() {
    ...
    m_netv4_isSet = false;
    m_netv4_isValid = false;

    m_netv6_isSet = false;
    m_netv6_isValid = false;

    m_title_isSet = false;
    m_title_isValid = false;
}

void OAILinodeStats::fromJson(QString jsonString) {
...
void OAILinodeStats::fromJsonObject(QJsonObject json) {

    if(json["cpu"].isArray()){
        auto arr = json["cpu"].toArray();
        m_cpu_isValid = true;
        if(arr.count() > 0) {
            for (const QJsonValue jval : arr) {
                QList<double> item;
                m_cpu_isValid &= ::OpenAPI::fromJsonValue(item, jval);
                m_cpu_isSet = !jval.isNull() && m_cpu_isValid;
    ...
    m_netv4_isValid = ::OpenAPI::fromJsonValue(m_netv4, json[QString("netv4")]);
    m_netv4_isSet = !json[QString("netv4")].isNull() && m_netv4_isValid;

    m_netv6_isValid = ::OpenAPI::fromJsonValue(m_netv6, json[QString("netv6")]);
    m_netv6_isSet = !json[QString("netv6")].isNull() && m_netv6_isValid;

    m_title_isValid = ::OpenAPI::fromJsonValue(m_title, json[QString("title")]);
    m_title_isSet = !json[QString("title")].isNull() && m_title_isValid;
}

QString OAILinodeStats::asJson() const {
...
QJsonObject OAILinodeStats::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu.size() > 0) {
        
        obj.insert(QString("cpu"), toJsonValue(m_cpu));
    }
    if (m_io.isSet()) {
        obj.insert(QString("io"), ::OpenAPI::toJsonValue(m_io));
    }
    if (m_netv4.isSet()) {
        obj.insert(QString("netv4"), ::OpenAPI::toJsonValue(m_netv4));
    }
    if (m_netv6.isSet()) {
        obj.insert(QString("netv6"), ::OpenAPI::toJsonValue(m_netv6));
    }
    if (m_title_isSet) {
...
QList<QList<double>> OAILinodeStats::getCpu() const {
    return m_cpu;
}
void OAILinodeStats::setCpu(const QList<QList<double>> &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAILinodeStats::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAILinodeStats::is_cpu_Valid() const{
    return m_cpu_isValid;
}

OAILinodeStats_io OAILinodeStats::getIo() const {
    return m_io;
}
void OAILinodeStats::setIo(const OAILinodeStats_io &io) {
    m_io = io;
    m_io_isSet = true;
}

bool OAILinodeStats::is_io_Set() const{
    return m_io_isSet;
}

bool OAILinodeStats::is_io_Valid() const{
    return m_io_isValid;
}

OAILinodeStats_netv4 OAILinodeStats::getNetv4() const {
    return m_netv4;
}
void OAILinodeStats::setNetv4(const OAILinodeStats_netv4 &netv4) {
    m_netv4 = netv4;
    m_netv4_isSet = true;
}

bool OAILinodeStats::is_netv4_Set() const{
    return m_netv4_isSet;
}

bool OAILinodeStats::is_netv4_Valid() const{
    return m_netv4_isValid;
}

OAILinodeStats_netv6 OAILinodeStats::getNetv6() const {
    return m_netv6;
}
void OAILinodeStats::setNetv6(const OAILinodeStats_netv6 &netv6) {
    m_netv6 = netv6;
    m_netv6_isSet = true;
}

bool OAILinodeStats::is_netv6_Set() const{
    return m_netv6_isSet;
}

bool OAILinodeStats::is_netv6_Valid() const{
    return m_netv6_isValid;
}

QString OAILinodeStats::getTitle() const {
    return m_title;
}
void OAILinodeStats::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAILinodeStats::is_title_Set() const{
    return m_title_isSet;
}

bool OAILinodeStats::is_title_Valid() const{
    return m_title_isValid;
}

bool OAILinodeStats::isSet() const {
...
bool OAILinodeStats::isValid() const {
