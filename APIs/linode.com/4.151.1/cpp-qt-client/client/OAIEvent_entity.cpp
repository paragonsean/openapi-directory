...
OAIEvent_entity::OAIEvent_entity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvent_entity::OAIEvent_entity() {
    this->initializeModel();
}

OAIEvent_entity::~OAIEvent_entity() {}

void OAIEvent_entity::initializeModel() {
...
void OAIEvent_entity::fromJson(QString jsonString) {
...
void OAIEvent_entity::fromJsonObject(QJsonObject json) {
...
QString OAIEvent_entity::asJson() const {
...
QJsonObject OAIEvent_entity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIEvent_entity::getId() const {
    return m_id;
}
void OAIEvent_entity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEvent_entity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEvent_entity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIEvent_entity::getLabel() const {
    return m_label;
}
void OAIEvent_entity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEvent_entity::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEvent_entity::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIEvent_entity::getType() const {
    return m_type;
}
void OAIEvent_entity::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEvent_entity::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEvent_entity::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIEvent_entity::getUrl() const {
    return m_url;
}
void OAIEvent_entity::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIEvent_entity::is_url_Set() const{
    return m_url_isSet;
}

bool OAIEvent_entity::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIEvent_entity::isSet() const {
...
bool OAIEvent_entity::isValid() const {
