...
#include "OAINodeBalancer_transfer.h"
...
OAINodeBalancer_transfer::OAINodeBalancer_transfer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeBalancer_transfer::OAINodeBalancer_transfer() {
    this->initializeModel();
}

OAINodeBalancer_transfer::~OAINodeBalancer_transfer() {}

void OAINodeBalancer_transfer::initializeModel() {
...
void OAINodeBalancer_transfer::fromJson(QString jsonString) {
...
void OAINodeBalancer_transfer::fromJsonObject(QJsonObject json) {
...
QString OAINodeBalancer_transfer::asJson() const {
...
QJsonObject OAINodeBalancer_transfer::asJsonObject() const {
    QJsonObject obj;
    if (m_in_isSet) {
...
double OAINodeBalancer_transfer::getIn() const {
    return m_in;
}
void OAINodeBalancer_transfer::setIn(const double &in) {
    m_in = in;
    m_in_isSet = true;
}

bool OAINodeBalancer_transfer::is_in_Set() const{
    return m_in_isSet;
}

bool OAINodeBalancer_transfer::is_in_Valid() const{
    return m_in_isValid;
}

double OAINodeBalancer_transfer::getOut() const {
    return m_out;
}
void OAINodeBalancer_transfer::setOut(const double &out) {
    m_out = out;
    m_out_isSet = true;
}

bool OAINodeBalancer_transfer::is_out_Set() const{
    return m_out_isSet;
}

bool OAINodeBalancer_transfer::is_out_Valid() const{
    return m_out_isValid;
}

double OAINodeBalancer_transfer::getTotal() const {
    return m_total;
}
void OAINodeBalancer_transfer::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAINodeBalancer_transfer::is_total_Set() const{
    return m_total_isSet;
}

bool OAINodeBalancer_transfer::is_total_Valid() const{
    return m_total_isValid;
}

bool OAINodeBalancer_transfer::isSet() const {
...
bool OAINodeBalancer_transfer::isValid() const {
