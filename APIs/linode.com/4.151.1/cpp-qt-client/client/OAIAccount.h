...
#include "OAIAccount_credit_card.h"
...
public:
    ...
    QList<OAIPromotion> getActivePromotions() const;
    void setActivePromotions(const QList<OAIPromotion> &active_promotions);
    bool is_active_promotions_Set() const;
    bool is_active_promotions_Valid() const;

    QDateTime getActiveSince() const;
    void setActiveSince(const QDateTime &active_since);
    bool is_active_since_Set() const;
    bool is_active_since_Valid() const;
    ...
    double getBalanceUninvoiced() const;
    void setBalanceUninvoiced(const double &balance_uninvoiced);
    bool is_balance_uninvoiced_Set() const;
    bool is_balance_uninvoiced_Valid() const;

    QString getBillingSource() const;
    void setBillingSource(const QString &billing_source);
    bool is_billing_source_Set() const;
    bool is_billing_source_Valid() const;
    ...
    OAIAccount_credit_card getCreditCard() const;
    void setCreditCard(const OAIAccount_credit_card &credit_card);
    ...
    QString getEuuid() const;
    void setEuuid(const QString &euuid);
    bool is_euuid_Set() const;
    bool is_euuid_Valid() const;
...
private:
    ...
    QList<OAIPromotion> m_active_promotions;
    bool m_active_promotions_isSet;
    bool m_active_promotions_isValid;

    QDateTime m_active_since;
    bool m_active_since_isSet;
    bool m_active_since_isValid;
    ...
    double m_balance_uninvoiced;
    bool m_balance_uninvoiced_isSet;
    bool m_balance_uninvoiced_isValid;

    QString m_billing_source;
    bool m_billing_source_isSet;
    bool m_billing_source_isValid;
    ...
    OAIAccount_credit_card m_credit_card;
