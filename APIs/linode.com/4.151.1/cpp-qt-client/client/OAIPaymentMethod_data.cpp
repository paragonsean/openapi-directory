...
void OAIPaymentMethod_data::initializeModel() {
    ...
    m_paypal_id_isSet = false;
    m_paypal_id_isValid = false;
}
...
void OAIPaymentMethod_data::fromJsonObject(QJsonObject json) {
    ...
    m_paypal_id_isValid = ::OpenAPI::fromJsonValue(m_paypal_id, json[QString("paypal_id")]);
    m_paypal_id_isSet = !json[QString("paypal_id")].isNull() && m_paypal_id_isValid;
}
...
QJsonObject OAIPaymentMethod_data::asJsonObject() const {
    ...
    if (m_paypal_id_isSet) {
        obj.insert(QString("paypal_id"), ::OpenAPI::toJsonValue(m_paypal_id));
    }
    return obj;
}
...
QString OAIPaymentMethod_data::getExpiry() const {
    return m_expiry;
}
void OAIPaymentMethod_data::setExpiry(const QString &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIPaymentMethod_data::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIPaymentMethod_data::is_expiry_Valid() const{
    return m_expiry_isValid;
}

QString OAIPaymentMethod_data::getLastFour() const {
    return m_last_four;
}
void OAIPaymentMethod_data::setLastFour(const QString &last_four) {
    m_last_four = last_four;
    m_last_four_isSet = true;
}

bool OAIPaymentMethod_data::is_last_four_Set() const{
    return m_last_four_isSet;
}

bool OAIPaymentMethod_data::is_last_four_Valid() const{
...
QString OAIPaymentMethod_data::getPaypalId() const {
    return m_paypal_id;
}
void OAIPaymentMethod_data::setPaypalId(const QString &paypal_id) {
    m_paypal_id = paypal_id;
    m_paypal_id_isSet = true;
}

bool OAIPaymentMethod_data::is_paypal_id_Set() const{
    return m_paypal_id_isSet;
}

bool OAIPaymentMethod_data::is_paypal_id_Valid() const{
    return m_paypal_id_isValid;
}
