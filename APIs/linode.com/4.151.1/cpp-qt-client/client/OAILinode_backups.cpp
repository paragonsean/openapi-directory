...
OAILinode_backups::OAILinode_backups(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinode_backups::OAILinode_backups() {
    this->initializeModel();
}

OAILinode_backups::~OAILinode_backups() {}

void OAILinode_backups::initializeModel() {
    ...
    m_last_successful_isSet = false;
    m_last_successful_isValid = false;

    m_schedule_isSet = false;
    m_schedule_isValid = false;
}

void OAILinode_backups::fromJson(QString jsonString) {
...
void OAILinode_backups::fromJsonObject(QJsonObject json) {
    ...
    m_last_successful_isValid = ::OpenAPI::fromJsonValue(m_last_successful, json[QString("last_successful")]);
    m_last_successful_isSet = !json[QString("last_successful")].isNull() && m_last_successful_isValid;

    m_schedule_isValid = ::OpenAPI::fromJsonValue(m_schedule, json[QString("schedule")]);
    m_schedule_isSet = !json[QString("schedule")].isNull() && m_schedule_isValid;
}

QString OAILinode_backups::asJson() const {
...
QJsonObject OAILinode_backups::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_last_successful_isSet) {
        obj.insert(QString("last_successful"), ::OpenAPI::toJsonValue(m_last_successful));
    }
    if (m_schedule.isSet()) {
...
bool OAILinode_backups::isAvailable() const {
    return m_available;
}
void OAILinode_backups::setAvailable(const bool &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAILinode_backups::is_available_Set() const{
    return m_available_isSet;
}

bool OAILinode_backups::is_available_Valid() const{
    return m_available_isValid;
}

bool OAILinode_backups::isEnabled() const {
    return m_enabled;
}
void OAILinode_backups::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAILinode_backups::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAILinode_backups::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QDateTime OAILinode_backups::getLastSuccessful() const {
    return m_last_successful;
}
void OAILinode_backups::setLastSuccessful(const QDateTime &last_successful) {
    m_last_successful = last_successful;
    m_last_successful_isSet = true;
}

bool OAILinode_backups::is_last_successful_Set() const{
    return m_last_successful_isSet;
}

bool OAILinode_backups::is_last_successful_Valid() const{
    return m_last_successful_isValid;
}

OAILinode_backups_schedule OAILinode_backups::getSchedule() const {
    return m_schedule;
}
void OAILinode_backups::setSchedule(const OAILinode_backups_schedule &schedule) {
    m_schedule = schedule;
    m_schedule_isSet = true;
}

bool OAILinode_backups::is_schedule_Set() const{
    return m_schedule_isSet;
}

bool OAILinode_backups::is_schedule_Valid() const{
    return m_schedule_isValid;
}

bool OAILinode_backups::isSet() const {
...
bool OAILinode_backups::isValid() const {
