...
QString OAIOAuthClient::getId() const {
    return m_id;
}
void OAIOAuthClient::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOAuthClient::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOAuthClient::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOAuthClient::getLabel() const {
    return m_label;
}
void OAIOAuthClient::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIOAuthClient::is_label_Set() const{
    return m_label_isSet;
}

bool OAIOAuthClient::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIOAuthClient::isRPublic() const {
    return m_r_public;
}
void OAIOAuthClient::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIOAuthClient::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIOAuthClient::is_r_public_Valid() const{
...
QString OAIOAuthClient::getStatus() const {
    return m_status;
}
void OAIOAuthClient::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOAuthClient::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOAuthClient::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIOAuthClient::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIOAuthClient::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIOAuthClient::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIOAuthClient::is_thumbnail_url_Valid() const{
