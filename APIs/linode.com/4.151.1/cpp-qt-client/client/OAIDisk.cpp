...
QDateTime OAIDisk::getCreated() const {
    return m_created;
}
void OAIDisk::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDisk::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDisk::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIDisk::getFilesystem() const {
    return m_filesystem;
}
void OAIDisk::setFilesystem(const QString &filesystem) {
    m_filesystem = filesystem;
    m_filesystem_isSet = true;
}

bool OAIDisk::is_filesystem_Set() const{
    return m_filesystem_isSet;
}

bool OAIDisk::is_filesystem_Valid() const{
    return m_filesystem_isValid;
}

qint32 OAIDisk::getId() const {
    return m_id;
}
void OAIDisk::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIDisk::getLabel() const {
    return m_label;
}
void OAIDisk::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDisk::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDisk::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIDisk::getSize() const {
    return m_size;
}
void OAIDisk::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIDisk::is_size_Set() const{
    return m_size_isSet;
}

bool OAIDisk::is_size_Valid() const{
    return m_size_isValid;
}

QString OAIDisk::getStatus() const {
    return m_status;
}
void OAIDisk::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDisk::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDisk::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDisk::getUpdated() const {
    return m_updated;
}
void OAIDisk::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDisk::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDisk::is_updated_Valid() const{
