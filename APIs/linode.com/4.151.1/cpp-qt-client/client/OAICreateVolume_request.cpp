...
OAICreateVolume_request::OAICreateVolume_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateVolume_request::OAICreateVolume_request() {
    this->initializeModel();
}

OAICreateVolume_request::~OAICreateVolume_request() {}

void OAICreateVolume_request::initializeModel() {
...
void OAICreateVolume_request::fromJson(QString jsonString) {
...
void OAICreateVolume_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateVolume_request::asJson() const {
...
QJsonObject OAICreateVolume_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateVolume_request::getConfigId() const {
    return m_config_id;
}
void OAICreateVolume_request::setConfigId(const qint32 &config_id) {
    m_config_id = config_id;
    m_config_id_isSet = true;
}

bool OAICreateVolume_request::is_config_id_Set() const{
    return m_config_id_isSet;
}

bool OAICreateVolume_request::is_config_id_Valid() const{
    return m_config_id_isValid;
}

QString OAICreateVolume_request::getLabel() const {
    return m_label;
}
void OAICreateVolume_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateVolume_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateVolume_request::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAICreateVolume_request::getLinodeId() const {
    return m_linode_id;
}
void OAICreateVolume_request::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAICreateVolume_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAICreateVolume_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

QString OAICreateVolume_request::getRegion() const {
    return m_region;
}
void OAICreateVolume_request::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAICreateVolume_request::is_region_Set() const{
    return m_region_isSet;
}

bool OAICreateVolume_request::is_region_Valid() const{
    return m_region_isValid;
}

qint32 OAICreateVolume_request::getSize() const {
    return m_size;
}
void OAICreateVolume_request::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAICreateVolume_request::is_size_Set() const{
    return m_size_isSet;
}

bool OAICreateVolume_request::is_size_Valid() const{
    return m_size_isValid;
}

QList<QString> OAICreateVolume_request::getTags() const {
    return m_tags;
}
void OAICreateVolume_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateVolume_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateVolume_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateVolume_request::isSet() const {
...
bool OAICreateVolume_request::isValid() const {
