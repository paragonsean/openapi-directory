...
OAIObjectStorageKey::OAIObjectStorageKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectStorageKey::OAIObjectStorageKey() {
    this->initializeModel();
}

OAIObjectStorageKey::~OAIObjectStorageKey() {}

void OAIObjectStorageKey::initializeModel() {

    m_access_key_isSet = false;
    m_access_key_isValid = false;

    m_bucket_access_isSet = false;
    m_bucket_access_isValid = false;
    ...
    m_limited_isSet = false;
    m_limited_isValid = false;

    m_secret_key_isSet = false;
    m_secret_key_isValid = false;
}

void OAIObjectStorageKey::fromJson(QString jsonString) {
...
void OAIObjectStorageKey::fromJsonObject(QJsonObject json) {
    ...
    m_bucket_access_isValid = ::OpenAPI::fromJsonValue(m_bucket_access, json[QString("bucket_access")]);
    m_bucket_access_isSet = !json[QString("bucket_access")].isNull() && m_bucket_access_isValid;
    ...
    m_limited_isValid = ::OpenAPI::fromJsonValue(m_limited, json[QString("limited")]);
    m_limited_isSet = !json[QString("limited")].isNull() && m_limited_isValid;
...
QString OAIObjectStorageKey::asJson() const {
...
QJsonObject OAIObjectStorageKey::asJsonObject() const {
    QJsonObject obj;
    if (m_access_key_isSet) {
        obj.insert(QString("access_key"), ::OpenAPI::toJsonValue(m_access_key));
    }
    if (m_bucket_access.size() > 0) {
        obj.insert(QString("bucket_access"), ::OpenAPI::toJsonValue(m_bucket_access));
    }
    if (m_id_isSet) {
    ...
    if (m_limited_isSet) {
        obj.insert(QString("limited"), ::OpenAPI::toJsonValue(m_limited));
    }
...
QString OAIObjectStorageKey::getAccessKey() const {
    return m_access_key;
}
void OAIObjectStorageKey::setAccessKey(const QString &access_key) {
    m_access_key = access_key;
    m_access_key_isSet = true;
}

bool OAIObjectStorageKey::is_access_key_Set() const{
    return m_access_key_isSet;
}

bool OAIObjectStorageKey::is_access_key_Valid() const{
    return m_access_key_isValid;
}

QList<OAIObjectStorageKey_bucket_access_inner> OAIObjectStorageKey::getBucketAccess() const {
    return m_bucket_access;
}
void OAIObjectStorageKey::setBucketAccess(const QList<OAIObjectStorageKey_bucket_access_inner> &bucket_access) {
    m_bucket_access = bucket_access;
    m_bucket_access_isSet = true;
}

bool OAIObjectStorageKey::is_bucket_access_Set() const{
    return m_bucket_access_isSet;
}

bool OAIObjectStorageKey::is_bucket_access_Valid() const{
    return m_bucket_access_isValid;
}

qint32 OAIObjectStorageKey::getId() const {
    return m_id;
}
void OAIObjectStorageKey::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIObjectStorageKey::is_id_Set() const{
    return m_id_isSet;
}

bool OAIObjectStorageKey::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIObjectStorageKey::getLabel() const {
    return m_label;
}
void OAIObjectStorageKey::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIObjectStorageKey::is_label_Set() const{
    return m_label_isSet;
}

bool OAIObjectStorageKey::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIObjectStorageKey::isLimited() const {
    return m_limited;
}
void OAIObjectStorageKey::setLimited(const bool &limited) {
    m_limited = limited;
    m_limited_isSet = true;
}

bool OAIObjectStorageKey::is_limited_Set() const{
    return m_limited_isSet;
}

bool OAIObjectStorageKey::is_limited_Valid() const{
    return m_limited_isValid;
}

QString OAIObjectStorageKey::getSecretKey() const {
    return m_secret_key;
}
void OAIObjectStorageKey::setSecretKey(const QString &secret_key) {
    m_secret_key = secret_key;
    m_secret_key_isSet = true;
}

bool OAIObjectStorageKey::is_secret_key_Set() const{
    return m_secret_key_isSet;
}

bool OAIObjectStorageKey::is_secret_key_Valid() const{
    return m_secret_key_isValid;
}

bool OAIObjectStorageKey::isSet() const {
...
bool OAIObjectStorageKey::isValid() const {
