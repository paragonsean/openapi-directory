...
OAIIPAddressPrivate::OAIIPAddressPrivate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPAddressPrivate::OAIIPAddressPrivate() {
    this->initializeModel();
}

OAIIPAddressPrivate::~OAIIPAddressPrivate() {}

void OAIIPAddressPrivate::initializeModel() {
...
void OAIIPAddressPrivate::fromJson(QString jsonString) {
...
void OAIIPAddressPrivate::fromJsonObject(QJsonObject json) {
...
QString OAIIPAddressPrivate::asJson() const {
...
QJsonObject OAIIPAddressPrivate::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIIPAddressPrivate::getAddress() const {
    return m_address;
}
void OAIIPAddressPrivate::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIPAddressPrivate::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIPAddressPrivate::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIPAddressPrivate::getGateway() const {
    return m_gateway;
}
void OAIIPAddressPrivate::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAIIPAddressPrivate::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAIIPAddressPrivate::is_gateway_Valid() const{
    return m_gateway_isValid;
}

qint32 OAIIPAddressPrivate::getLinodeId() const {
    return m_linode_id;
}
void OAIIPAddressPrivate::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIIPAddressPrivate::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIIPAddressPrivate::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAIIPAddressPrivate::getPrefix() const {
    return m_prefix;
}
void OAIIPAddressPrivate::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPAddressPrivate::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPAddressPrivate::is_prefix_Valid() const{
    return m_prefix_isValid;
}

bool OAIIPAddressPrivate::isRPublic() const {
    return m_r_public;
}
void OAIIPAddressPrivate::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIIPAddressPrivate::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIIPAddressPrivate::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIIPAddressPrivate::getRdns() const {
    return m_rdns;
}
void OAIIPAddressPrivate::setRdns(const QString &rdns) {
    m_rdns = rdns;
    m_rdns_isSet = true;
}

bool OAIIPAddressPrivate::is_rdns_Set() const{
    return m_rdns_isSet;
}

bool OAIIPAddressPrivate::is_rdns_Valid() const{
    return m_rdns_isValid;
}

QString OAIIPAddressPrivate::getRegion() const {
    return m_region;
}
void OAIIPAddressPrivate::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPAddressPrivate::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPAddressPrivate::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIIPAddressPrivate::getSubnetMask() const {
    return m_subnet_mask;
}
void OAIIPAddressPrivate::setSubnetMask(const QString &subnet_mask) {
    m_subnet_mask = subnet_mask;
    m_subnet_mask_isSet = true;
}

bool OAIIPAddressPrivate::is_subnet_mask_Set() const{
    return m_subnet_mask_isSet;
}

bool OAIIPAddressPrivate::is_subnet_mask_Valid() const{
    return m_subnet_mask_isValid;
}

QString OAIIPAddressPrivate::getType() const {
    return m_type;
}
void OAIIPAddressPrivate::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIIPAddressPrivate::is_type_Set() const{
    return m_type_isSet;
}

bool OAIIPAddressPrivate::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIIPAddressPrivate::isSet() const {
...
bool OAIIPAddressPrivate::isValid() const {
