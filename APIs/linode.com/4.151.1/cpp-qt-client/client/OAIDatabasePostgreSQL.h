...
/*
 * OAIDatabasePostgreSQL.h
 *
 * Managed PostgreSQL Databases object.
 */

#ifndef OAIDatabasePostgreSQL_H
#define OAIDatabasePostgreSQL_H

#include <QJsonObject>

#include "OAIDatabasePostgreSQL_hosts.h"
...
namespace OpenAPI {
class OAIDatabasePostgreSQL_hosts;
class OAIDatabase_updates;

class OAIDatabasePostgreSQL : public OAIObject {
public:
    OAIDatabasePostgreSQL();
    OAIDatabasePostgreSQL(QString json);
    ~OAIDatabasePostgreSQL() override;
    ...
    OAIDatabasePostgreSQL_hosts getHosts() const;
    void setHosts(const OAIDatabasePostgreSQL_hosts &hosts);
    ...
    QString getReplicationCommitType() const;
    void setReplicationCommitType(const QString &replication_commit_type);
    bool is_replication_commit_type_Set() const;
    bool is_replication_commit_type_Valid() const;

    QString getReplicationType() const;
    void setReplicationType(const QString &replication_type);
...
private:
    ...
    OAIDatabasePostgreSQL_hosts m_hosts;
    bool m_hosts_isSet;
    ...
    QString m_replication_commit_type;
    bool m_replication_commit_type_isSet;
    bool m_replication_commit_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabasePostgreSQL)

#endif // OAIDatabasePostgreSQL_H
