...
OAINodeBalancer::OAINodeBalancer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeBalancer::OAINodeBalancer() {
    this->initializeModel();
}

OAINodeBalancer::~OAINodeBalancer() {}

void OAINodeBalancer::initializeModel() {
...
void OAINodeBalancer::fromJson(QString jsonString) {
...
void OAINodeBalancer::fromJsonObject(QJsonObject json) {
...
QString OAINodeBalancer::asJson() const {
...
QJsonObject OAINodeBalancer::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAINodeBalancer::getClientConnThrottle() const {
    return m_client_conn_throttle;
}
void OAINodeBalancer::setClientConnThrottle(const qint32 &client_conn_throttle) {
    m_client_conn_throttle = client_conn_throttle;
    m_client_conn_throttle_isSet = true;
}

bool OAINodeBalancer::is_client_conn_throttle_Set() const{
    return m_client_conn_throttle_isSet;
}

bool OAINodeBalancer::is_client_conn_throttle_Valid() const{
    return m_client_conn_throttle_isValid;
}

QDateTime OAINodeBalancer::getCreated() const {
    return m_created;
}
void OAINodeBalancer::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAINodeBalancer::is_created_Set() const{
    return m_created_isSet;
}

bool OAINodeBalancer::is_created_Valid() const{
    return m_created_isValid;
}

QString OAINodeBalancer::getHostname() const {
    return m_hostname;
}
void OAINodeBalancer::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAINodeBalancer::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAINodeBalancer::is_hostname_Valid() const{
    return m_hostname_isValid;
}

qint32 OAINodeBalancer::getId() const {
    return m_id;
}
void OAINodeBalancer::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINodeBalancer::is_id_Set() const{
    return m_id_isSet;
}

bool OAINodeBalancer::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINodeBalancer::getIpv4() const {
    return m_ipv4;
}
void OAINodeBalancer::setIpv4(const QString &ipv4) {
    m_ipv4 = ipv4;
    m_ipv4_isSet = true;
}

bool OAINodeBalancer::is_ipv4_Set() const{
    return m_ipv4_isSet;
}

bool OAINodeBalancer::is_ipv4_Valid() const{
    return m_ipv4_isValid;
}

QString OAINodeBalancer::getIpv6() const {
    return m_ipv6;
}
void OAINodeBalancer::setIpv6(const QString &ipv6) {
    m_ipv6 = ipv6;
    m_ipv6_isSet = true;
}

bool OAINodeBalancer::is_ipv6_Set() const{
    return m_ipv6_isSet;
}

bool OAINodeBalancer::is_ipv6_Valid() const{
    return m_ipv6_isValid;
}

QString OAINodeBalancer::getLabel() const {
    return m_label;
}
void OAINodeBalancer::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAINodeBalancer::is_label_Set() const{
    return m_label_isSet;
}

bool OAINodeBalancer::is_label_Valid() const{
    return m_label_isValid;
}

QString OAINodeBalancer::getRegion() const {
    return m_region;
}
void OAINodeBalancer::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAINodeBalancer::is_region_Set() const{
    return m_region_isSet;
}

bool OAINodeBalancer::is_region_Valid() const{
    return m_region_isValid;
}

QList<QString> OAINodeBalancer::getTags() const {
    return m_tags;
}
void OAINodeBalancer::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAINodeBalancer::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAINodeBalancer::is_tags_Valid() const{
    return m_tags_isValid;
}

OAINodeBalancer_transfer OAINodeBalancer::getTransfer() const {
    return m_transfer;
}
void OAINodeBalancer::setTransfer(const OAINodeBalancer_transfer &transfer) {
    m_transfer = transfer;
    m_transfer_isSet = true;
}

bool OAINodeBalancer::is_transfer_Set() const{
    return m_transfer_isSet;
}

bool OAINodeBalancer::is_transfer_Valid() const{
    return m_transfer_isValid;
}

QDateTime OAINodeBalancer::getUpdated() const {
    return m_updated;
}
void OAINodeBalancer::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAINodeBalancer::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAINodeBalancer::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAINodeBalancer::isSet() const {
...
bool OAINodeBalancer::isValid() const {
