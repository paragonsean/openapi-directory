...
void OAIDomainsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("createDomainRecord", defaultConf);
    _serverIndices.insert("createDomainRecord", 0);
    _serverConfigs.insert("deleteDomain", defaultConf);
    _serverIndices.insert("deleteDomain", 0);
    _serverConfigs.insert("deleteDomainRecord", defaultConf);
    _serverIndices.insert("deleteDomainRecord", 0);
    _serverConfigs.insert("getDomain", defaultConf);
    _serverIndices.insert("getDomain", 0);
    _serverConfigs.insert("getDomainRecord", defaultConf);
    _serverIndices.insert("getDomainRecord", 0);
    _serverConfigs.insert("getDomainRecords", defaultConf);
    _serverIndices.insert("getDomainRecords", 0);
    _serverConfigs.insert("getDomainZone", defaultConf);
    _serverIndices.insert("getDomainZone", 0);
    _serverConfigs.insert("getDomains", defaultConf);
    _serverIndices.insert("getDomains", 0);
    _serverConfigs.insert("importDomain", defaultConf);
    _serverIndices.insert("importDomain", 0);
    _serverConfigs.insert("updateDomain", defaultConf);
    _serverIndices.insert("updateDomain", 0);
    _serverConfigs.insert("updateDomainRecord", defaultConf);
    _serverIndices.insert("updateDomainRecord", 0);
}
...
void OAIDomainsApi::cloneDomain(const QString &domain_id, const OAICloneDomain_request &oai_clone_domain_request) {
    QString fullPath = QString(_serverConfigs["cloneDomain"][_serverIndices.value("cloneDomain")].URL()+"/domains/{domainId}/clone");
...

    {
        ...
        QByteArray output = oai_clone_domain_request.asJson().toUtf8();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("domains:read_write");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::cloneDomainCallback);
...
void OAIDomainsApi::cloneDomainCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloneDomainSignal(output);
        Q_EMIT cloneDomainSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloneDomainSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloneDomainSignalError(output, error_type, error_str);
        Q_EMIT cloneDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::createDomain(const OAIDomain &oai_domain) {
...

    {
        ...
        QByteArray output = oai_domain.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::createDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::createDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::createDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIDomainsApi::createDomainRecord(const qint32 &domain_id, const OAIDomainRecord &oai_domain_record) {
    QString fullPath = QString(_serverConfigs["createDomainRecord"][_serverIndices.value("createDomainRecord")].URL()+"/domains/{domainId}/records");
...

    {
        ...
        QByteArray output = oai_domain_record.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::createDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::createDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::createDomainRecordCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIDomainRecord output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createDomainRecordSignal(output);
        Q_EMIT createDomainRecordSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createDomainRecordSignalE(output, error_type, error_str);
        Q_EMIT createDomainRecordSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createDomainRecordSignalError(output, error_type, error_str);
        Q_EMIT createDomainRecordSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::deleteDomain(const qint32 &domain_id) {
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::deleteDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::deleteDomainRecord(const qint32 &domain_id, const qint32 &record_id) {
    QString fullPath = QString(_serverConfigs["deleteDomainRecord"][_serverIndices.value("deleteDomainRecord")].URL()+"/domains/{domainId}/records/{recordId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::deleteDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::deleteDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::deleteDomainRecordCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteDomainRecordSignal(output);
        Q_EMIT deleteDomainRecordSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteDomainRecordSignalE(output, error_type, error_str);
        Q_EMIT deleteDomainRecordSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteDomainRecordSignalError(output, error_type, error_str);
        Q_EMIT deleteDomainRecordSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::getDomain(const qint32 &domain_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("domains:read_only");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::getDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIDomainsApi::getDomainRecord(const qint32 &domain_id, const qint32 &record_id) {
    QString fullPath = QString(_serverConfigs["getDomainRecord"][_serverIndices.value("getDomainRecord")].URL()+"/domains/{domainId}/records/{recordId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::getDomainRecordCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDomainRecordSignal(output);
        Q_EMIT getDomainRecordSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDomainRecordSignalE(output, error_type, error_str);
        Q_EMIT getDomainRecordSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDomainRecordSignalError(output, error_type, error_str);
        Q_EMIT getDomainRecordSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::getDomainRecords(const qint32 &domain_id, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getDomainRecords"][_serverIndices.value("getDomainRecords")].URL()+"/domains/{domainId}/records");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainRecordsCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainRecordsCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::getDomainRecordsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetDomainRecords_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDomainRecordsSignal(output);
        Q_EMIT getDomainRecordsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDomainRecordsSignalE(output, error_type, error_str);
        Q_EMIT getDomainRecordsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDomainRecordsSignalError(output, error_type, error_str);
        Q_EMIT getDomainRecordsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::getDomainZone(const QString &domain_id) {
    QString fullPath = QString(_serverConfigs["getDomainZone"][_serverIndices.value("getDomainZone")].URL()+"/domains/{domainId}/zone-file");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainZoneCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainZoneCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::getDomainZoneCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetDomainZone_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDomainZoneSignal(output);
        Q_EMIT getDomainZoneSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDomainZoneSignalE(output, error_type, error_str);
        Q_EMIT getDomainZoneSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDomainZoneSignalError(output, error_type, error_str);
        Q_EMIT getDomainZoneSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::getDomains(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getDomains"][_serverIndices.value("getDomains")].URL()+"/domains");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainsCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::getDomainsCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::getDomainsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetDomains_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDomainsSignal(output);
        Q_EMIT getDomainsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDomainsSignalE(output, error_type, error_str);
        Q_EMIT getDomainsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDomainsSignalError(output, error_type, error_str);
        Q_EMIT getDomainsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::importDomain(const ::OpenAPI::OptionalParam<OAIImportDomain_request> &oai_import_domain_request) {
    QString fullPath = QString(_serverConfigs["importDomain"][_serverIndices.value("importDomain")].URL()+"/domains/import");
    ...
    if (oai_import_domain_request.hasValue()){

        
        QByteArray output = oai_import_domain_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::importDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::importDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::importDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT importDomainSignal(output);
        Q_EMIT importDomainSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT importDomainSignalE(output, error_type, error_str);
        Q_EMIT importDomainSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT importDomainSignalError(output, error_type, error_str);
        Q_EMIT importDomainSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDomainsApi::updateDomain(const qint32 &domain_id, const OAIDomain &oai_domain) {
    QString fullPath = QString(_serverConfigs["updateDomain"][_serverIndices.value("updateDomain")].URL()+"/domains/{domainId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::updateDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::updateDomainCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::updateDomainCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIDomainsApi::updateDomainRecord(const qint32 &domain_id, const qint32 &record_id, const OAIUpdateDomainRecord_request &oai_update_domain_record_request) {
    QString fullPath = QString(_serverConfigs["updateDomainRecord"][_serverIndices.value("updateDomainRecord")].URL()+"/domains/{domainId}/records/{recordId}");
...

    {
        ...
        QByteArray output = oai_update_domain_record_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::updateDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDomainsApi::updateDomainRecordCallback);
    connect(this, &OAIDomainsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDomainsApi::updateDomainRecordCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateDomainRecordSignal(output);
        Q_EMIT updateDomainRecordSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("domains:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateDomainRecordSignalE(output, error_type, error_str);
        Q_EMIT updateDomainRecordSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateDomainRecordSignalError(output, error_type, error_str);
        Q_EMIT updateDomainRecordSignalErrorFull(worker, error_type, error_str);
    }
}
