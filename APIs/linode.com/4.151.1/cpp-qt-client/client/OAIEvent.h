...
namespace OpenAPI {
class OAIEvent_entity;
class OAIEvent_secondary_entity;
...
public:
    ...
    OAIEvent_entity getEntity() const;
    void setEntity(const OAIEvent_entity &entity);
    ...
    OAIEvent_secondary_entity getSecondaryEntity() const;
    void setSecondaryEntity(const OAIEvent_secondary_entity &secondary_entity);
    bool is_secondary_entity_Set() const;
    bool is_secondary_entity_Valid() const;

    bool isSeen() const;
    void setSeen(const bool &seen);
...
private:
    ...
    OAIEvent_secondary_entity m_secondary_entity;
    bool m_secondary_entity_isSet;
    bool m_secondary_entity_isValid;
