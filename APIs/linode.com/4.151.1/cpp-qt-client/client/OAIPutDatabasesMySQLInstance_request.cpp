...
OAIPutDatabasesMySQLInstance_request::OAIPutDatabasesMySQLInstance_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDatabasesMySQLInstance_request::OAIPutDatabasesMySQLInstance_request() {
    this->initializeModel();
}

OAIPutDatabasesMySQLInstance_request::~OAIPutDatabasesMySQLInstance_request() {}

void OAIPutDatabasesMySQLInstance_request::initializeModel() {
...
void OAIPutDatabasesMySQLInstance_request::fromJson(QString jsonString) {
...
void OAIPutDatabasesMySQLInstance_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutDatabasesMySQLInstance_request::asJson() const {
...
QJsonObject OAIPutDatabasesMySQLInstance_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIPutDatabasesMySQLInstance_request::getAllowList() const {
    return m_allow_list;
}
void OAIPutDatabasesMySQLInstance_request::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIPutDatabasesMySQLInstance_request::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIPutDatabasesMySQLInstance_request::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

QString OAIPutDatabasesMySQLInstance_request::getLabel() const {
    return m_label;
}
void OAIPutDatabasesMySQLInstance_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPutDatabasesMySQLInstance_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPutDatabasesMySQLInstance_request::is_label_Valid() const{
    return m_label_isValid;
}

OAIDatabase_updates OAIPutDatabasesMySQLInstance_request::getUpdates() const {
    return m_updates;
}
void OAIPutDatabasesMySQLInstance_request::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIPutDatabasesMySQLInstance_request::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIPutDatabasesMySQLInstance_request::is_updates_Valid() const{
    return m_updates_isValid;
}

bool OAIPutDatabasesMySQLInstance_request::isSet() const {
...
bool OAIPutDatabasesMySQLInstance_request::isValid() const {
