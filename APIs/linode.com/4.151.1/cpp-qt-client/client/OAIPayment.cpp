...
QDateTime OAIPayment::getDate() const {
    return m_date;
}
void OAIPayment::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}
...
qint32 OAIPayment::getUsd() const {
    return m_usd;
}
void OAIPayment::setUsd(const qint32 &usd) {
    m_usd = usd;
    m_usd_isSet = true;
}

bool OAIPayment::is_usd_Set() const{
    return m_usd_isSet;
}

bool OAIPayment::is_usd_Valid() const{
