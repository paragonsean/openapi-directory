...
OAICreateLKECluster_request::OAICreateLKECluster_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLKECluster_request::OAICreateLKECluster_request() {
    this->initializeModel();
}

OAICreateLKECluster_request::~OAICreateLKECluster_request() {}

void OAICreateLKECluster_request::initializeModel() {
...
void OAICreateLKECluster_request::fromJson(QString jsonString) {
...
void OAICreateLKECluster_request::fromJsonObject(QJsonObject json) {

    m_control_plane_isValid = ::OpenAPI::fromJsonValue(m_control_plane, json[QString("control_plane")]);
    m_control_plane_isSet = !json[QString("control_plane")].isNull() && m_control_plane_isValid;

    m_k8s_version_isValid = ::OpenAPI::fromJsonValue(m_k8s_version, json[QString("k8s_version")]);
    m_k8s_version_isSet = !json[QString("k8s_version")].isNull() && m_k8s_version_isValid;

    m_label_isValid = ::OpenAPI::fromJsonValue(m_label, json[QString("label")]);
    m_label_isSet = !json[QString("label")].isNull() && m_label_isValid;

    m_node_pools_isValid = ::OpenAPI::fromJsonValue(m_node_pools, json[QString("node_pools")]);
    m_node_pools_isSet = !json[QString("node_pools")].isNull() && m_node_pools_isValid;
...
QString OAICreateLKECluster_request::asJson() const {
...
QJsonObject OAICreateLKECluster_request::asJsonObject() const {
    QJsonObject obj;
    if (m_control_plane.isSet()) {
        obj.insert(QString("control_plane"), ::OpenAPI::toJsonValue(m_control_plane));
    }
    if (m_k8s_version_isSet) {
        obj.insert(QString("k8s_version"), ::OpenAPI::toJsonValue(m_k8s_version));
    }
    if (m_label_isSet) {
        obj.insert(QString("label"), ::OpenAPI::toJsonValue(m_label));
    }
    if (m_node_pools.size() > 0) {
        obj.insert(QString("node_pools"), ::OpenAPI::toJsonValue(m_node_pools));
    }
    if (m_region_isSet) {
...
OAICreateLKECluster_request_control_plane OAICreateLKECluster_request::getControlPlane() const {
    return m_control_plane;
}
void OAICreateLKECluster_request::setControlPlane(const OAICreateLKECluster_request_control_plane &control_plane) {
    m_control_plane = control_plane;
    m_control_plane_isSet = true;
}

bool OAICreateLKECluster_request::is_control_plane_Set() const{
    return m_control_plane_isSet;
}

bool OAICreateLKECluster_request::is_control_plane_Valid() const{
    return m_control_plane_isValid;
}

QString OAICreateLKECluster_request::getK8sVersion() const {
    return m_k8s_version;
}
void OAICreateLKECluster_request::setK8sVersion(const QString &k8s_version) {
    m_k8s_version = k8s_version;
    m_k8s_version_isSet = true;
}

bool OAICreateLKECluster_request::is_k8s_version_Set() const{
    return m_k8s_version_isSet;
}

bool OAICreateLKECluster_request::is_k8s_version_Valid() const{
    return m_k8s_version_isValid;
}

QString OAICreateLKECluster_request::getLabel() const {
    return m_label;
}
void OAICreateLKECluster_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateLKECluster_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateLKECluster_request::is_label_Valid() const{
    return m_label_isValid;
}

QList<OAILKENodePoolRequestBody> OAICreateLKECluster_request::getNodePools() const {
    return m_node_pools;
}
void OAICreateLKECluster_request::setNodePools(const QList<OAILKENodePoolRequestBody> &node_pools) {
    m_node_pools = node_pools;
    m_node_pools_isSet = true;
}

bool OAICreateLKECluster_request::is_node_pools_Set() const{
    return m_node_pools_isSet;
}

bool OAICreateLKECluster_request::is_node_pools_Valid() const{
    return m_node_pools_isValid;
}

QString OAICreateLKECluster_request::getRegion() const {
    return m_region;
}
void OAICreateLKECluster_request::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAICreateLKECluster_request::is_region_Set() const{
    return m_region_isSet;
}

bool OAICreateLKECluster_request::is_region_Valid() const{
    return m_region_isValid;
}

QList<QString> OAICreateLKECluster_request::getTags() const {
    return m_tags;
}
void OAICreateLKECluster_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateLKECluster_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateLKECluster_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateLKECluster_request::isSet() const {
...
bool OAICreateLKECluster_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_k8s_version_isValid && m_label_isValid && m_node_pools_isValid && m_region_isValid && true;
}
