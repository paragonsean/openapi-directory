...
#include "OAIGetManagedStats_200_response_data.h"
...
OAIGetManagedStats_200_response_data::OAIGetManagedStats_200_response_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetManagedStats_200_response_data::OAIGetManagedStats_200_response_data() {
    this->initializeModel();
}

OAIGetManagedStats_200_response_data::~OAIGetManagedStats_200_response_data() {}

void OAIGetManagedStats_200_response_data::initializeModel() {
...
void OAIGetManagedStats_200_response_data::fromJson(QString jsonString) {
...
void OAIGetManagedStats_200_response_data::fromJsonObject(QJsonObject json) {
...
QString OAIGetManagedStats_200_response_data::asJson() const {
...
QJsonObject OAIGetManagedStats_200_response_data::asJsonObject() const {
    QJsonObject obj;
    if (m_cpu.size() > 0) {
...
QList<OAIStatsData> OAIGetManagedStats_200_response_data::getCpu() const {
    return m_cpu;
}
void OAIGetManagedStats_200_response_data::setCpu(const QList<OAIStatsData> &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIGetManagedStats_200_response_data::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIGetManagedStats_200_response_data::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QList<OAIStatsData> OAIGetManagedStats_200_response_data::getDisk() const {
    return m_disk;
}
void OAIGetManagedStats_200_response_data::setDisk(const QList<OAIStatsData> &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAIGetManagedStats_200_response_data::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAIGetManagedStats_200_response_data::is_disk_Valid() const{
    return m_disk_isValid;
}

QList<OAIStatsData> OAIGetManagedStats_200_response_data::getNetIn() const {
    return m_net_in;
}
void OAIGetManagedStats_200_response_data::setNetIn(const QList<OAIStatsData> &net_in) {
    m_net_in = net_in;
    m_net_in_isSet = true;
}

bool OAIGetManagedStats_200_response_data::is_net_in_Set() const{
    return m_net_in_isSet;
}

bool OAIGetManagedStats_200_response_data::is_net_in_Valid() const{
    return m_net_in_isValid;
}

QList<OAIStatsData> OAIGetManagedStats_200_response_data::getNetOut() const {
    return m_net_out;
}
void OAIGetManagedStats_200_response_data::setNetOut(const QList<OAIStatsData> &net_out) {
    m_net_out = net_out;
    m_net_out_isSet = true;
}

bool OAIGetManagedStats_200_response_data::is_net_out_Set() const{
    return m_net_out_isSet;
}

bool OAIGetManagedStats_200_response_data::is_net_out_Valid() const{
    return m_net_out_isValid;
}

QList<OAIStatsData> OAIGetManagedStats_200_response_data::getSwap() const {
    return m_swap;
}
void OAIGetManagedStats_200_response_data::setSwap(const QList<OAIStatsData> &swap) {
    m_swap = swap;
    m_swap_isSet = true;
}

bool OAIGetManagedStats_200_response_data::is_swap_Set() const{
    return m_swap_isSet;
}

bool OAIGetManagedStats_200_response_data::is_swap_Valid() const{
    return m_swap_isValid;
}

bool OAIGetManagedStats_200_response_data::isSet() const {
...
bool OAIGetManagedStats_200_response_data::isValid() const {
