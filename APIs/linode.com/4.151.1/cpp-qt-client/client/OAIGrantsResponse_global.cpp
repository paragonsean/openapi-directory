...
#include "OAIGrantsResponse_global.h"
...
OAIGrantsResponse_global::OAIGrantsResponse_global(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGrantsResponse_global::OAIGrantsResponse_global() {
    this->initializeModel();
}

OAIGrantsResponse_global::~OAIGrantsResponse_global() {}

void OAIGrantsResponse_global::initializeModel() {

    m_account_access_isSet = false;
    m_account_access_isValid = false;

    m_add_databases_isSet = false;
    m_add_databases_isValid = false;

    m_add_domains_isSet = false;
    m_add_domains_isValid = false;

    m_add_firewalls_isSet = false;
    m_add_firewalls_isValid = false;

    m_add_images_isSet = false;
    m_add_images_isValid = false;

    m_add_linodes_isSet = false;
    m_add_linodes_isValid = false;

    m_add_longview_isSet = false;
    m_add_longview_isValid = false;

    m_add_nodebalancers_isSet = false;
    m_add_nodebalancers_isValid = false;

    m_add_stackscripts_isSet = false;
    m_add_stackscripts_isValid = false;

    m_add_volumes_isSet = false;
    m_add_volumes_isValid = false;

    m_cancel_account_isSet = false;
    m_cancel_account_isValid = false;

    m_longview_subscription_isSet = false;
    m_longview_subscription_isValid = false;
}

void OAIGrantsResponse_global::fromJson(QString jsonString) {
...
void OAIGrantsResponse_global::fromJsonObject(QJsonObject json) {

    m_account_access_isValid = ::OpenAPI::fromJsonValue(m_account_access, json[QString("account_access")]);
    m_account_access_isSet = !json[QString("account_access")].isNull() && m_account_access_isValid;

    m_add_databases_isValid = ::OpenAPI::fromJsonValue(m_add_databases, json[QString("add_databases")]);
    m_add_databases_isSet = !json[QString("add_databases")].isNull() && m_add_databases_isValid;

    m_add_domains_isValid = ::OpenAPI::fromJsonValue(m_add_domains, json[QString("add_domains")]);
    m_add_domains_isSet = !json[QString("add_domains")].isNull() && m_add_domains_isValid;

    m_add_firewalls_isValid = ::OpenAPI::fromJsonValue(m_add_firewalls, json[QString("add_firewalls")]);
    m_add_firewalls_isSet = !json[QString("add_firewalls")].isNull() && m_add_firewalls_isValid;

    m_add_images_isValid = ::OpenAPI::fromJsonValue(m_add_images, json[QString("add_images")]);
    m_add_images_isSet = !json[QString("add_images")].isNull() && m_add_images_isValid;

    m_add_linodes_isValid = ::OpenAPI::fromJsonValue(m_add_linodes, json[QString("add_linodes")]);
    m_add_linodes_isSet = !json[QString("add_linodes")].isNull() && m_add_linodes_isValid;

    m_add_longview_isValid = ::OpenAPI::fromJsonValue(m_add_longview, json[QString("add_longview")]);
    m_add_longview_isSet = !json[QString("add_longview")].isNull() && m_add_longview_isValid;

    m_add_nodebalancers_isValid = ::OpenAPI::fromJsonValue(m_add_nodebalancers, json[QString("add_nodebalancers")]);
    m_add_nodebalancers_isSet = !json[QString("add_nodebalancers")].isNull() && m_add_nodebalancers_isValid;

    m_add_stackscripts_isValid = ::OpenAPI::fromJsonValue(m_add_stackscripts, json[QString("add_stackscripts")]);
    m_add_stackscripts_isSet = !json[QString("add_stackscripts")].isNull() && m_add_stackscripts_isValid;

    m_add_volumes_isValid = ::OpenAPI::fromJsonValue(m_add_volumes, json[QString("add_volumes")]);
    m_add_volumes_isSet = !json[QString("add_volumes")].isNull() && m_add_volumes_isValid;

    m_cancel_account_isValid = ::OpenAPI::fromJsonValue(m_cancel_account, json[QString("cancel_account")]);
    m_cancel_account_isSet = !json[QString("cancel_account")].isNull() && m_cancel_account_isValid;
...
QString OAIGrantsResponse_global::asJson() const {
...
QJsonObject OAIGrantsResponse_global::asJsonObject() const {
    QJsonObject obj;
    if (m_account_access_isSet) {
        obj.insert(QString("account_access"), ::OpenAPI::toJsonValue(m_account_access));
    }
    if (m_add_databases_isSet) {
        obj.insert(QString("add_databases"), ::OpenAPI::toJsonValue(m_add_databases));
    }
    if (m_add_domains_isSet) {
        obj.insert(QString("add_domains"), ::OpenAPI::toJsonValue(m_add_domains));
    }
    if (m_add_firewalls_isSet) {
        obj.insert(QString("add_firewalls"), ::OpenAPI::toJsonValue(m_add_firewalls));
    }
    if (m_add_images_isSet) {
        obj.insert(QString("add_images"), ::OpenAPI::toJsonValue(m_add_images));
    }
    if (m_add_linodes_isSet) {
        obj.insert(QString("add_linodes"), ::OpenAPI::toJsonValue(m_add_linodes));
    }
    if (m_add_longview_isSet) {
        obj.insert(QString("add_longview"), ::OpenAPI::toJsonValue(m_add_longview));
    }
    if (m_add_nodebalancers_isSet) {
        obj.insert(QString("add_nodebalancers"), ::OpenAPI::toJsonValue(m_add_nodebalancers));
    }
    if (m_add_stackscripts_isSet) {
        obj.insert(QString("add_stackscripts"), ::OpenAPI::toJsonValue(m_add_stackscripts));
    }
    if (m_add_volumes_isSet) {
        obj.insert(QString("add_volumes"), ::OpenAPI::toJsonValue(m_add_volumes));
    }
    if (m_cancel_account_isSet) {
        obj.insert(QString("cancel_account"), ::OpenAPI::toJsonValue(m_cancel_account));
    }
...
QString OAIGrantsResponse_global::getAccountAccess() const {
    return m_account_access;
}
void OAIGrantsResponse_global::setAccountAccess(const QString &account_access) {
    m_account_access = account_access;
    m_account_access_isSet = true;
}

bool OAIGrantsResponse_global::is_account_access_Set() const{
    return m_account_access_isSet;
}

bool OAIGrantsResponse_global::is_account_access_Valid() const{
    return m_account_access_isValid;
}

bool OAIGrantsResponse_global::isAddDatabases() const {
    return m_add_databases;
}
void OAIGrantsResponse_global::setAddDatabases(const bool &add_databases) {
    m_add_databases = add_databases;
    m_add_databases_isSet = true;
}

bool OAIGrantsResponse_global::is_add_databases_Set() const{
    return m_add_databases_isSet;
}

bool OAIGrantsResponse_global::is_add_databases_Valid() const{
    return m_add_databases_isValid;
}

bool OAIGrantsResponse_global::isAddDomains() const {
    return m_add_domains;
}
void OAIGrantsResponse_global::setAddDomains(const bool &add_domains) {
    m_add_domains = add_domains;
    m_add_domains_isSet = true;
}

bool OAIGrantsResponse_global::is_add_domains_Set() const{
    return m_add_domains_isSet;
}

bool OAIGrantsResponse_global::is_add_domains_Valid() const{
    return m_add_domains_isValid;
}

bool OAIGrantsResponse_global::isAddFirewalls() const {
    return m_add_firewalls;
}
void OAIGrantsResponse_global::setAddFirewalls(const bool &add_firewalls) {
    m_add_firewalls = add_firewalls;
    m_add_firewalls_isSet = true;
}

bool OAIGrantsResponse_global::is_add_firewalls_Set() const{
    return m_add_firewalls_isSet;
}

bool OAIGrantsResponse_global::is_add_firewalls_Valid() const{
    return m_add_firewalls_isValid;
}

bool OAIGrantsResponse_global::isAddImages() const {
    return m_add_images;
}
void OAIGrantsResponse_global::setAddImages(const bool &add_images) {
    m_add_images = add_images;
    m_add_images_isSet = true;
}

bool OAIGrantsResponse_global::is_add_images_Set() const{
    return m_add_images_isSet;
}

bool OAIGrantsResponse_global::is_add_images_Valid() const{
    return m_add_images_isValid;
}

bool OAIGrantsResponse_global::isAddLinodes() const {
    return m_add_linodes;
}
void OAIGrantsResponse_global::setAddLinodes(const bool &add_linodes) {
    m_add_linodes = add_linodes;
    m_add_linodes_isSet = true;
}

bool OAIGrantsResponse_global::is_add_linodes_Set() const{
    return m_add_linodes_isSet;
}

bool OAIGrantsResponse_global::is_add_linodes_Valid() const{
    return m_add_linodes_isValid;
}

bool OAIGrantsResponse_global::isAddLongview() const {
    return m_add_longview;
}
void OAIGrantsResponse_global::setAddLongview(const bool &add_longview) {
    m_add_longview = add_longview;
    m_add_longview_isSet = true;
}

bool OAIGrantsResponse_global::is_add_longview_Set() const{
    return m_add_longview_isSet;
}

bool OAIGrantsResponse_global::is_add_longview_Valid() const{
    return m_add_longview_isValid;
}

bool OAIGrantsResponse_global::isAddNodebalancers() const {
    return m_add_nodebalancers;
}
void OAIGrantsResponse_global::setAddNodebalancers(const bool &add_nodebalancers) {
    m_add_nodebalancers = add_nodebalancers;
    m_add_nodebalancers_isSet = true;
}

bool OAIGrantsResponse_global::is_add_nodebalancers_Set() const{
    return m_add_nodebalancers_isSet;
}

bool OAIGrantsResponse_global::is_add_nodebalancers_Valid() const{
    return m_add_nodebalancers_isValid;
}

bool OAIGrantsResponse_global::isAddStackscripts() const {
    return m_add_stackscripts;
}
void OAIGrantsResponse_global::setAddStackscripts(const bool &add_stackscripts) {
    m_add_stackscripts = add_stackscripts;
    m_add_stackscripts_isSet = true;
}

bool OAIGrantsResponse_global::is_add_stackscripts_Set() const{
    return m_add_stackscripts_isSet;
}

bool OAIGrantsResponse_global::is_add_stackscripts_Valid() const{
    return m_add_stackscripts_isValid;
}

bool OAIGrantsResponse_global::isAddVolumes() const {
    return m_add_volumes;
}
void OAIGrantsResponse_global::setAddVolumes(const bool &add_volumes) {
    m_add_volumes = add_volumes;
    m_add_volumes_isSet = true;
}

bool OAIGrantsResponse_global::is_add_volumes_Set() const{
    return m_add_volumes_isSet;
}

bool OAIGrantsResponse_global::is_add_volumes_Valid() const{
    return m_add_volumes_isValid;
}

bool OAIGrantsResponse_global::isCancelAccount() const {
    return m_cancel_account;
}
void OAIGrantsResponse_global::setCancelAccount(const bool &cancel_account) {
    m_cancel_account = cancel_account;
    m_cancel_account_isSet = true;
}

bool OAIGrantsResponse_global::is_cancel_account_Set() const{
    return m_cancel_account_isSet;
}

bool OAIGrantsResponse_global::is_cancel_account_Valid() const{
    return m_cancel_account_isValid;
}

bool OAIGrantsResponse_global::isLongviewSubscription() const {
    return m_longview_subscription;
}
void OAIGrantsResponse_global::setLongviewSubscription(const bool &longview_subscription) {
    m_longview_subscription = longview_subscription;
    m_longview_subscription_isSet = true;
}

bool OAIGrantsResponse_global::is_longview_subscription_Set() const{
    return m_longview_subscription_isSet;
}

bool OAIGrantsResponse_global::is_longview_subscription_Valid() const{
    return m_longview_subscription_isValid;
}

bool OAIGrantsResponse_global::isSet() const {
...
bool OAIGrantsResponse_global::isValid() const {
