...
OAIStackScript::OAIStackScript(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStackScript::OAIStackScript() {
    this->initializeModel();
}

OAIStackScript::~OAIStackScript() {}

void OAIStackScript::initializeModel() {

    m_created_isSet = false;
    m_created_isValid = false;

    m_deployments_active_isSet = false;
    m_deployments_active_isValid = false;

    m_deployments_total_isSet = false;
    m_deployments_total_isValid = false;
    ...
    m_rev_note_isSet = false;
    m_rev_note_isValid = false;
    ...
    m_user_defined_fields_isSet = false;
    m_user_defined_fields_isValid = false;

    m_user_gravatar_id_isSet = false;
    m_user_gravatar_id_isValid = false;

    m_username_isSet = false;
    m_username_isValid = false;
}

void OAIStackScript::fromJson(QString jsonString) {
...
void OAIStackScript::fromJsonObject(QJsonObject json) {

    m_created_isValid = ::OpenAPI::fromJsonValue(m_created, json[QString("created")]);
    m_created_isSet = !json[QString("created")].isNull() && m_created_isValid;

    m_deployments_active_isValid = ::OpenAPI::fromJsonValue(m_deployments_active, json[QString("deployments_active")]);
    m_deployments_active_isSet = !json[QString("deployments_active")].isNull() && m_deployments_active_isValid;

    m_deployments_total_isValid = ::OpenAPI::fromJsonValue(m_deployments_total, json[QString("deployments_total")]);
    m_deployments_total_isSet = !json[QString("deployments_total")].isNull() && m_deployments_total_isValid;
    ...
    m_rev_note_isValid = ::OpenAPI::fromJsonValue(m_rev_note, json[QString("rev_note")]);
    m_rev_note_isSet = !json[QString("rev_note")].isNull() && m_rev_note_isValid;
    ...
    m_user_defined_fields_isValid = ::OpenAPI::fromJsonValue(m_user_defined_fields, json[QString("user_defined_fields")]);
    m_user_defined_fields_isSet = !json[QString("user_defined_fields")].isNull() && m_user_defined_fields_isValid;

    m_user_gravatar_id_isValid = ::OpenAPI::fromJsonValue(m_user_gravatar_id, json[QString("user_gravatar_id")]);
    m_user_gravatar_id_isSet = !json[QString("user_gravatar_id")].isNull() && m_user_gravatar_id_isValid;

    m_username_isValid = ::OpenAPI::fromJsonValue(m_username, json[QString("username")]);
    m_username_isSet = !json[QString("username")].isNull() && m_username_isValid;
}

QString OAIStackScript::asJson() const {
...
QJsonObject OAIStackScript::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
        obj.insert(QString("created"), ::OpenAPI::toJsonValue(m_created));
    }
    if (m_deployments_active_isSet) {
        obj.insert(QString("deployments_active"), ::OpenAPI::toJsonValue(m_deployments_active));
    }
    if (m_deployments_total_isSet) {
        obj.insert(QString("deployments_total"), ::OpenAPI::toJsonValue(m_deployments_total));
    }
    ...
    if (m_rev_note_isSet) {
        obj.insert(QString("rev_note"), ::OpenAPI::toJsonValue(m_rev_note));
    }
    if (m_script_isSet) {
    ...
    if (m_user_defined_fields.size() > 0) {
        obj.insert(QString("user_defined_fields"), ::OpenAPI::toJsonValue(m_user_defined_fields));
    }
    if (m_user_gravatar_id_isSet) {
        obj.insert(QString("user_gravatar_id"), ::OpenAPI::toJsonValue(m_user_gravatar_id));
    }
    if (m_username_isSet) {
...
QDateTime OAIStackScript::getCreated() const {
    return m_created;
}
void OAIStackScript::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIStackScript::is_created_Set() const{
    return m_created_isSet;
}

bool OAIStackScript::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIStackScript::getDeploymentsActive() const {
    return m_deployments_active;
}
void OAIStackScript::setDeploymentsActive(const qint32 &deployments_active) {
    m_deployments_active = deployments_active;
    m_deployments_active_isSet = true;
}

bool OAIStackScript::is_deployments_active_Set() const{
    return m_deployments_active_isSet;
}

bool OAIStackScript::is_deployments_active_Valid() const{
    return m_deployments_active_isValid;
}

qint32 OAIStackScript::getDeploymentsTotal() const {
    return m_deployments_total;
}
void OAIStackScript::setDeploymentsTotal(const qint32 &deployments_total) {
    m_deployments_total = deployments_total;
    m_deployments_total_isSet = true;
}

bool OAIStackScript::is_deployments_total_Set() const{
    return m_deployments_total_isSet;
}

bool OAIStackScript::is_deployments_total_Valid() const{
    return m_deployments_total_isValid;
}

QString OAIStackScript::getDescription() const {
    return m_description;
}
void OAIStackScript::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStackScript::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStackScript::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIStackScript::getId() const {
    return m_id;
}
void OAIStackScript::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStackScript::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStackScript::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIStackScript::getImages() const {
    return m_images;
}
void OAIStackScript::setImages(const QList<QString> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIStackScript::is_images_Set() const{
    return m_images_isSet;
}

bool OAIStackScript::is_images_Valid() const{
    return m_images_isValid;
}

bool OAIStackScript::isIsPublic() const {
    return m_is_public;
}
void OAIStackScript::setIsPublic(const bool &is_public) {
    m_is_public = is_public;
    m_is_public_isSet = true;
}

bool OAIStackScript::is_is_public_Set() const{
    return m_is_public_isSet;
}

bool OAIStackScript::is_is_public_Valid() const{
    return m_is_public_isValid;
}

QString OAIStackScript::getLabel() const {
    return m_label;
}
void OAIStackScript::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIStackScript::is_label_Set() const{
    return m_label_isSet;
}

bool OAIStackScript::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIStackScript::isMine() const {
    return m_mine;
}
void OAIStackScript::setMine(const bool &mine) {
    m_mine = mine;
    m_mine_isSet = true;
}

bool OAIStackScript::is_mine_Set() const{
    return m_mine_isSet;
}

bool OAIStackScript::is_mine_Valid() const{
    return m_mine_isValid;
}

QString OAIStackScript::getRevNote() const {
    return m_rev_note;
}
void OAIStackScript::setRevNote(const QString &rev_note) {
    m_rev_note = rev_note;
    m_rev_note_isSet = true;
}

bool OAIStackScript::is_rev_note_Set() const{
    return m_rev_note_isSet;
}

bool OAIStackScript::is_rev_note_Valid() const{
    return m_rev_note_isValid;
}

QString OAIStackScript::getScript() const {
    return m_script;
}
void OAIStackScript::setScript(const QString &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAIStackScript::is_script_Set() const{
    return m_script_isSet;
}

bool OAIStackScript::is_script_Valid() const{
    return m_script_isValid;
}

QDateTime OAIStackScript::getUpdated() const {
    return m_updated;
}
void OAIStackScript::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIStackScript::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIStackScript::is_updated_Valid() const{
    return m_updated_isValid;
}

QList<OAIUserDefinedField> OAIStackScript::getUserDefinedFields() const {
    return m_user_defined_fields;
}
void OAIStackScript::setUserDefinedFields(const QList<OAIUserDefinedField> &user_defined_fields) {
    m_user_defined_fields = user_defined_fields;
    m_user_defined_fields_isSet = true;
}

bool OAIStackScript::is_user_defined_fields_Set() const{
    return m_user_defined_fields_isSet;
}

bool OAIStackScript::is_user_defined_fields_Valid() const{
    return m_user_defined_fields_isValid;
}

QString OAIStackScript::getUserGravatarId() const {
    return m_user_gravatar_id;
}
void OAIStackScript::setUserGravatarId(const QString &user_gravatar_id) {
    m_user_gravatar_id = user_gravatar_id;
    m_user_gravatar_id_isSet = true;
}

bool OAIStackScript::is_user_gravatar_id_Set() const{
    return m_user_gravatar_id_isSet;
}

bool OAIStackScript::is_user_gravatar_id_Valid() const{
    return m_user_gravatar_id_isValid;
}

QString OAIStackScript::getUsername() const {
    return m_username;
}
void OAIStackScript::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIStackScript::is_username_Set() const{
    return m_username_isSet;
}

bool OAIStackScript::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIStackScript::isSet() const {
...
bool OAIStackScript::isValid() const {
