...
void OAIAccount::initializeModel() {
    ...
    m_active_promotions_isSet = false;
    m_active_promotions_isValid = false;

    m_active_since_isSet = false;
    m_active_since_isValid = false;
    ...
    m_balance_uninvoiced_isSet = false;
    m_balance_uninvoiced_isValid = false;

    m_billing_source_isSet = false;
    m_billing_source_isValid = false;
...
void OAIAccount::fromJsonObject(QJsonObject json) {
    ...
    m_active_promotions_isValid = ::OpenAPI::fromJsonValue(m_active_promotions, json[QString("active_promotions")]);
    m_active_promotions_isSet = !json[QString("active_promotions")].isNull() && m_active_promotions_isValid;

    m_active_since_isValid = ::OpenAPI::fromJsonValue(m_active_since, json[QString("active_since")]);
    m_active_since_isSet = !json[QString("active_since")].isNull() && m_active_since_isValid;
    ...
    m_balance_uninvoiced_isValid = ::OpenAPI::fromJsonValue(m_balance_uninvoiced, json[QString("balance_uninvoiced")]);
    m_balance_uninvoiced_isSet = !json[QString("balance_uninvoiced")].isNull() && m_balance_uninvoiced_isValid;

    m_billing_source_isValid = ::OpenAPI::fromJsonValue(m_billing_source, json[QString("billing_source")]);
    m_billing_source_isSet = !json[QString("billing_source")].isNull() && m_billing_source_isValid;
    ...
    m_credit_card_isValid = ::OpenAPI::fromJsonValue(m_credit_card, json[QString("credit_card")]);
    m_credit_card_isSet = !json[QString("credit_card")].isNull() && m_credit_card_isValid;

    m_email_isValid = ::OpenAPI::fromJsonValue(m_email, json[QString("email")]);
    m_email_isSet = !json[QString("email")].isNull() && m_email_isValid;

    m_euuid_isValid = ::OpenAPI::fromJsonValue(m_euuid, json[QString("euuid")]);
    m_euuid_isSet = !json[QString("euuid")].isNull() && m_euuid_isValid;
...
QJsonObject OAIAccount::asJsonObject() const {
    QJsonObject obj;
    if (m_active_promotions.size() > 0) {
        obj.insert(QString("active_promotions"), ::OpenAPI::toJsonValue(m_active_promotions));
    }
    if (m_active_since_isSet) {
        obj.insert(QString("active_since"), ::OpenAPI::toJsonValue(m_active_since));
    }
    ...
    if (m_balance_uninvoiced_isSet) {
        obj.insert(QString("balance_uninvoiced"), ::OpenAPI::toJsonValue(m_balance_uninvoiced));
    }
    if (m_billing_source_isSet) {
        obj.insert(QString("billing_source"), ::OpenAPI::toJsonValue(m_billing_source));
    }
    ...
    if (m_credit_card.isSet()) {
        obj.insert(QString("credit_card"), ::OpenAPI::toJsonValue(m_credit_card));
    }
    if (m_email_isSet) {
        obj.insert(QString("email"), ::OpenAPI::toJsonValue(m_email));
    }
    if (m_euuid_isSet) {
        obj.insert(QString("euuid"), ::OpenAPI::toJsonValue(m_euuid));
    }
...
QList<OAIPromotion> OAIAccount::getActivePromotions() const {
    return m_active_promotions;
}
void OAIAccount::setActivePromotions(const QList<OAIPromotion> &active_promotions) {
    m_active_promotions = active_promotions;
    m_active_promotions_isSet = true;
}

bool OAIAccount::is_active_promotions_Set() const{
    return m_active_promotions_isSet;
}

bool OAIAccount::is_active_promotions_Valid() const{
    return m_active_promotions_isValid;
}

QDateTime OAIAccount::getActiveSince() const {
    return m_active_since;
}
void OAIAccount::setActiveSince(const QDateTime &active_since) {
    m_active_since = active_since;
    m_active_since_isSet = true;
}

bool OAIAccount::is_active_since_Set() const{
    return m_active_since_isSet;
}

bool OAIAccount::is_active_since_Valid() const{
    return m_active_since_isValid;
}

QString OAIAccount::getAddress1() const {
    return m_address_1;
}
void OAIAccount::setAddress1(const QString &address_1) {
    m_address_1 = address_1;
    m_address_1_isSet = true;
}

bool OAIAccount::is_address_1_Set() const{
    return m_address_1_isSet;
}

bool OAIAccount::is_address_1_Valid() const{
    return m_address_1_isValid;
}

QString OAIAccount::getAddress2() const {
    return m_address_2;
}
void OAIAccount::setAddress2(const QString &address_2) {
    m_address_2 = address_2;
    m_address_2_isSet = true;
}

bool OAIAccount::is_address_2_Set() const{
    return m_address_2_isSet;
}

bool OAIAccount::is_address_2_Valid() const{
    return m_address_2_isValid;
}

double OAIAccount::getBalance() const {
    return m_balance;
}
void OAIAccount::setBalance(const double &balance) {
    m_balance = balance;
...
double OAIAccount::getBalanceUninvoiced() const {
    return m_balance_uninvoiced;
}
void OAIAccount::setBalanceUninvoiced(const double &balance_uninvoiced) {
    m_balance_uninvoiced = balance_uninvoiced;
    m_balance_uninvoiced_isSet = true;
}

bool OAIAccount::is_balance_uninvoiced_Set() const{
    return m_balance_uninvoiced_isSet;
}

bool OAIAccount::is_balance_uninvoiced_Valid() const{
    return m_balance_uninvoiced_isValid;
}

QString OAIAccount::getBillingSource() const {
    return m_billing_source;
}
void OAIAccount::setBillingSource(const QString &billing_source) {
    m_billing_source = billing_source;
    m_billing_source_isSet = true;
}

bool OAIAccount::is_billing_source_Set() const{
    return m_billing_source_isSet;
}

bool OAIAccount::is_billing_source_Valid() const{
    return m_billing_source_isValid;
}

QList<QString> OAIAccount::getCapabilities() const {
    return m_capabilities;
}
void OAIAccount::setCapabilities(const QList<QString> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIAccount::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIAccount::is_capabilities_Valid() const{
...
QString OAIAccount::getCompany() const {
    return m_company;
}
void OAIAccount::setCompany(const QString &company) {
    m_company = company;
    m_company_isSet = true;
}

bool OAIAccount::is_company_Set() const{
    return m_company_isSet;
}

bool OAIAccount::is_company_Valid() const{
...
OAIAccount_credit_card OAIAccount::getCreditCard() const {
    return m_credit_card;
}
void OAIAccount::setCreditCard(const OAIAccount_credit_card &credit_card) {
    m_credit_card = credit_card;
    m_credit_card_isSet = true;
}

bool OAIAccount::is_credit_card_Set() const{
    return m_credit_card_isSet;
}

bool OAIAccount::is_credit_card_Valid() const{
...
QString OAIAccount::getEuuid() const {
    return m_euuid;
}
void OAIAccount::setEuuid(const QString &euuid) {
    m_euuid = euuid;
    m_euuid_isSet = true;
}

bool OAIAccount::is_euuid_Set() const{
    return m_euuid_isSet;
}

bool OAIAccount::is_euuid_Valid() const{
    return m_euuid_isValid;
}
...
QString OAIAccount::getTaxId() const {
    return m_tax_id;
}
void OAIAccount::setTaxId(const QString &tax_id) {
    m_tax_id = tax_id;
    m_tax_id_isSet = true;
}

bool OAIAccount::is_tax_id_Set() const{
    return m_tax_id_isSet;
}

bool OAIAccount::is_tax_id_Valid() const{
    return m_tax_id_isValid;
}

QString OAIAccount::getZip() const {
    return m_zip;
}
void OAIAccount::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIAccount::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIAccount::is_zip_Valid() const{
