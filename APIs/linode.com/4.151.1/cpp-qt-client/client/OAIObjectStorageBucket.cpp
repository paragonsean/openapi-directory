...
#include "OAIObjectStorageBucket.h"
...
OAIObjectStorageBucket::OAIObjectStorageBucket(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectStorageBucket::OAIObjectStorageBucket() {
    this->initializeModel();
}

OAIObjectStorageBucket::~OAIObjectStorageBucket() {}

void OAIObjectStorageBucket::initializeModel() {
...
void OAIObjectStorageBucket::fromJson(QString jsonString) {
...
void OAIObjectStorageBucket::fromJsonObject(QJsonObject json) {
...
QString OAIObjectStorageBucket::asJson() const {
...
QJsonObject OAIObjectStorageBucket::asJsonObject() const {
    QJsonObject obj;
    if (m_cluster_isSet) {
...
QString OAIObjectStorageBucket::getCluster() const {
    return m_cluster;
}
void OAIObjectStorageBucket::setCluster(const QString &cluster) {
    m_cluster = cluster;
    m_cluster_isSet = true;
}

bool OAIObjectStorageBucket::is_cluster_Set() const{
    return m_cluster_isSet;
}

bool OAIObjectStorageBucket::is_cluster_Valid() const{
    return m_cluster_isValid;
}

QDateTime OAIObjectStorageBucket::getCreated() const {
    return m_created;
}
void OAIObjectStorageBucket::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIObjectStorageBucket::is_created_Set() const{
    return m_created_isSet;
}

bool OAIObjectStorageBucket::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIObjectStorageBucket::getHostname() const {
    return m_hostname;
}
void OAIObjectStorageBucket::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAIObjectStorageBucket::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAIObjectStorageBucket::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAIObjectStorageBucket::getLabel() const {
    return m_label;
}
void OAIObjectStorageBucket::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIObjectStorageBucket::is_label_Set() const{
    return m_label_isSet;
}

bool OAIObjectStorageBucket::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIObjectStorageBucket::getObjects() const {
    return m_objects;
}
void OAIObjectStorageBucket::setObjects(const qint32 &objects) {
    m_objects = objects;
    m_objects_isSet = true;
}

bool OAIObjectStorageBucket::is_objects_Set() const{
    return m_objects_isSet;
}

bool OAIObjectStorageBucket::is_objects_Valid() const{
    return m_objects_isValid;
}

qint32 OAIObjectStorageBucket::getSize() const {
    return m_size;
}
void OAIObjectStorageBucket::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIObjectStorageBucket::is_size_Set() const{
    return m_size_isSet;
}

bool OAIObjectStorageBucket::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIObjectStorageBucket::isSet() const {
...
bool OAIObjectStorageBucket::isValid() const {
