...
#include "OAIGetBackups_200_response_automatic_inner.h"
...
OAIGetBackups_200_response_automatic_inner::OAIGetBackups_200_response_automatic_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBackups_200_response_automatic_inner::OAIGetBackups_200_response_automatic_inner() {
    this->initializeModel();
}

OAIGetBackups_200_response_automatic_inner::~OAIGetBackups_200_response_automatic_inner() {}

void OAIGetBackups_200_response_automatic_inner::initializeModel() {
...
void OAIGetBackups_200_response_automatic_inner::fromJson(QString jsonString) {
...
void OAIGetBackups_200_response_automatic_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetBackups_200_response_automatic_inner::asJson() const {
...
QJsonObject OAIGetBackups_200_response_automatic_inner::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGetBackups_200_response_automatic_inner::isAvailable() const {
    return m_available;
}
void OAIGetBackups_200_response_automatic_inner::setAvailable(const bool &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_available_Set() const{
    return m_available_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_available_Valid() const{
    return m_available_isValid;
}

QList<QString> OAIGetBackups_200_response_automatic_inner::getConfigs() const {
    return m_configs;
}
void OAIGetBackups_200_response_automatic_inner::setConfigs(const QList<QString> &configs) {
    m_configs = configs;
    m_configs_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_configs_Set() const{
    return m_configs_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_configs_Valid() const{
    return m_configs_isValid;
}

QDateTime OAIGetBackups_200_response_automatic_inner::getCreated() const {
    return m_created;
}
void OAIGetBackups_200_response_automatic_inner::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_created_Set() const{
    return m_created_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_created_Valid() const{
    return m_created_isValid;
}

QList<OAIBackup_disks_inner> OAIGetBackups_200_response_automatic_inner::getDisks() const {
    return m_disks;
}
void OAIGetBackups_200_response_automatic_inner::setDisks(const QList<OAIBackup_disks_inner> &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_disks_Valid() const{
    return m_disks_isValid;
}

QDateTime OAIGetBackups_200_response_automatic_inner::getFinished() const {
    return m_finished;
}
void OAIGetBackups_200_response_automatic_inner::setFinished(const QDateTime &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_finished_Valid() const{
    return m_finished_isValid;
}

qint32 OAIGetBackups_200_response_automatic_inner::getId() const {
    return m_id;
}
void OAIGetBackups_200_response_automatic_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetBackups_200_response_automatic_inner::getLabel() const {
    return m_label;
}
void OAIGetBackups_200_response_automatic_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIGetBackups_200_response_automatic_inner::getStatus() const {
    return m_status;
}
void OAIGetBackups_200_response_automatic_inner::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetBackups_200_response_automatic_inner::getType() const {
    return m_type;
}
void OAIGetBackups_200_response_automatic_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIGetBackups_200_response_automatic_inner::getUpdated() const {
    return m_updated;
}
void OAIGetBackups_200_response_automatic_inner::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIGetBackups_200_response_automatic_inner::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIGetBackups_200_response_automatic_inner::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIGetBackups_200_response_automatic_inner::isSet() const {
...
bool OAIGetBackups_200_response_automatic_inner::isValid() const {
