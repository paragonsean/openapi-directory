...
OAIGetLinodeTransferByYearMonth_200_response::OAIGetLinodeTransferByYearMonth_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinodeTransferByYearMonth_200_response::OAIGetLinodeTransferByYearMonth_200_response() {
    this->initializeModel();
}

OAIGetLinodeTransferByYearMonth_200_response::~OAIGetLinodeTransferByYearMonth_200_response() {}

void OAIGetLinodeTransferByYearMonth_200_response::initializeModel() {
...
void OAIGetLinodeTransferByYearMonth_200_response::fromJson(QString jsonString) {
...
void OAIGetLinodeTransferByYearMonth_200_response::fromJsonObject(QJsonObject json) {

    m_bytes_in_isValid = ::OpenAPI::fromJsonValue(m_bytes_in, json[QString("bytes_in")]);
    m_bytes_in_isSet = !json[QString("bytes_in")].isNull() && m_bytes_in_isValid;

    m_bytes_out_isValid = ::OpenAPI::fromJsonValue(m_bytes_out, json[QString("bytes_out")]);
    m_bytes_out_isSet = !json[QString("bytes_out")].isNull() && m_bytes_out_isValid;
...
QString OAIGetLinodeTransferByYearMonth_200_response::asJson() const {
...
QJsonObject OAIGetLinodeTransferByYearMonth_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_in_isSet) {
        obj.insert(QString("bytes_in"), ::OpenAPI::toJsonValue(m_bytes_in));
    }
    if (m_bytes_out_isSet) {
        obj.insert(QString("bytes_out"), ::OpenAPI::toJsonValue(m_bytes_out));
    }
...
qint32 OAIGetLinodeTransferByYearMonth_200_response::getBytesIn() const {
    return m_bytes_in;
}
void OAIGetLinodeTransferByYearMonth_200_response::setBytesIn(const qint32 &bytes_in) {
    m_bytes_in = bytes_in;
    m_bytes_in_isSet = true;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_in_Set() const{
    return m_bytes_in_isSet;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_in_Valid() const{
    return m_bytes_in_isValid;
}

qint32 OAIGetLinodeTransferByYearMonth_200_response::getBytesOut() const {
    return m_bytes_out;
}
void OAIGetLinodeTransferByYearMonth_200_response::setBytesOut(const qint32 &bytes_out) {
    m_bytes_out = bytes_out;
    m_bytes_out_isSet = true;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_out_Set() const{
    return m_bytes_out_isSet;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_out_Valid() const{
    return m_bytes_out_isValid;
}

qint32 OAIGetLinodeTransferByYearMonth_200_response::getBytesTotal() const {
    return m_bytes_total;
}
void OAIGetLinodeTransferByYearMonth_200_response::setBytesTotal(const qint32 &bytes_total) {
    m_bytes_total = bytes_total;
    m_bytes_total_isSet = true;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_total_Set() const{
    return m_bytes_total_isSet;
}

bool OAIGetLinodeTransferByYearMonth_200_response::is_bytes_total_Valid() const{
    return m_bytes_total_isValid;
}

bool OAIGetLinodeTransferByYearMonth_200_response::isSet() const {
...
bool OAIGetLinodeTransferByYearMonth_200_response::isValid() const {
