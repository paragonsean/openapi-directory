...
OAICreateTag_request::OAICreateTag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTag_request::OAICreateTag_request() {
    this->initializeModel();
}

OAICreateTag_request::~OAICreateTag_request() {}

void OAICreateTag_request::initializeModel() {
    ...
    m_linodes_isSet = false;
    m_linodes_isValid = false;

    m_nodebalancers_isSet = false;
    m_nodebalancers_isValid = false;

    m_volumes_isSet = false;
    m_volumes_isValid = false;
}

void OAICreateTag_request::fromJson(QString jsonString) {
...
void OAICreateTag_request::fromJsonObject(QJsonObject json) {
    ...
    m_linodes_isValid = ::OpenAPI::fromJsonValue(m_linodes, json[QString("linodes")]);
    m_linodes_isSet = !json[QString("linodes")].isNull() && m_linodes_isValid;

    m_nodebalancers_isValid = ::OpenAPI::fromJsonValue(m_nodebalancers, json[QString("nodebalancers")]);
    m_nodebalancers_isSet = !json[QString("nodebalancers")].isNull() && m_nodebalancers_isValid;
...
QString OAICreateTag_request::asJson() const {
...
QJsonObject OAICreateTag_request::asJsonObject() const {
    QJsonObject obj;
    if (m_domains.size() > 0) {
    ...
    if (m_linodes.size() > 0) {
        obj.insert(QString("linodes"), ::OpenAPI::toJsonValue(m_linodes));
    }
    if (m_nodebalancers.size() > 0) {
        obj.insert(QString("nodebalancers"), ::OpenAPI::toJsonValue(m_nodebalancers));
    }
    if (m_volumes.size() > 0) {
...
QList<qint32> OAICreateTag_request::getDomains() const {
    return m_domains;
}
void OAICreateTag_request::setDomains(const QList<qint32> &domains) {
    m_domains = domains;
    m_domains_isSet = true;
}

bool OAICreateTag_request::is_domains_Set() const{
    return m_domains_isSet;
}

bool OAICreateTag_request::is_domains_Valid() const{
    return m_domains_isValid;
}

QString OAICreateTag_request::getLabel() const {
    return m_label;
}
void OAICreateTag_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateTag_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateTag_request::is_label_Valid() const{
    return m_label_isValid;
}

QList<qint32> OAICreateTag_request::getLinodes() const {
    return m_linodes;
}
void OAICreateTag_request::setLinodes(const QList<qint32> &linodes) {
    m_linodes = linodes;
    m_linodes_isSet = true;
}

bool OAICreateTag_request::is_linodes_Set() const{
    return m_linodes_isSet;
}

bool OAICreateTag_request::is_linodes_Valid() const{
    return m_linodes_isValid;
}

QList<qint32> OAICreateTag_request::getNodebalancers() const {
    return m_nodebalancers;
}
void OAICreateTag_request::setNodebalancers(const QList<qint32> &nodebalancers) {
    m_nodebalancers = nodebalancers;
    m_nodebalancers_isSet = true;
}

bool OAICreateTag_request::is_nodebalancers_Set() const{
    return m_nodebalancers_isSet;
}

bool OAICreateTag_request::is_nodebalancers_Valid() const{
    return m_nodebalancers_isValid;
}

QList<qint32> OAICreateTag_request::getVolumes() const {
    return m_volumes;
}
void OAICreateTag_request::setVolumes(const QList<qint32> &volumes) {
    m_volumes = volumes;
    m_volumes_isSet = true;
}

bool OAICreateTag_request::is_volumes_Set() const{
    return m_volumes_isSet;
}

bool OAICreateTag_request::is_volumes_Valid() const{
    return m_volumes_isValid;
}

bool OAICreateTag_request::isSet() const {
...
bool OAICreateTag_request::isValid() const {
