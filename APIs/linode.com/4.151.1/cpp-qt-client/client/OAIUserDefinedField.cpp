...
OAIUserDefinedField::OAIUserDefinedField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserDefinedField::OAIUserDefinedField() {
    this->initializeModel();
}

OAIUserDefinedField::~OAIUserDefinedField() {}

void OAIUserDefinedField::initializeModel() {
    ...
    m_many_of_isSet = false;
    m_many_of_isValid = false;
...
void OAIUserDefinedField::fromJson(QString jsonString) {
...
void OAIUserDefinedField::fromJsonObject(QJsonObject json) {
    ...
    m_many_of_isValid = ::OpenAPI::fromJsonValue(m_many_of, json[QString("manyOf")]);
    m_many_of_isSet = !json[QString("manyOf")].isNull() && m_many_of_isValid;
...
QString OAIUserDefinedField::asJson() const {
...
QJsonObject OAIUserDefinedField::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_many_of_isSet) {
        obj.insert(QString("manyOf"), ::OpenAPI::toJsonValue(m_many_of));
    }
    if (m_name_isSet) {
...
QString OAIUserDefinedField::getRDefault() const {
    return m_r_default;
}
void OAIUserDefinedField::setRDefault(const QString &r_default) {
    m_r_default = r_default;
    m_r_default_isSet = true;
}

bool OAIUserDefinedField::is_r_default_Set() const{
    return m_r_default_isSet;
}

bool OAIUserDefinedField::is_r_default_Valid() const{
    return m_r_default_isValid;
}

QString OAIUserDefinedField::getExample() const {
    return m_example;
}
void OAIUserDefinedField::setExample(const QString &example) {
    m_example = example;
    m_example_isSet = true;
}

bool OAIUserDefinedField::is_example_Set() const{
    return m_example_isSet;
}

bool OAIUserDefinedField::is_example_Valid() const{
    return m_example_isValid;
}

QString OAIUserDefinedField::getLabel() const {
    return m_label;
}
void OAIUserDefinedField::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIUserDefinedField::is_label_Set() const{
    return m_label_isSet;
}

bool OAIUserDefinedField::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIUserDefinedField::getManyOf() const {
    return m_many_of;
}
void OAIUserDefinedField::setManyOf(const QString &many_of) {
    m_many_of = many_of;
    m_many_of_isSet = true;
}

bool OAIUserDefinedField::is_many_of_Set() const{
    return m_many_of_isSet;
}

bool OAIUserDefinedField::is_many_of_Valid() const{
    return m_many_of_isValid;
}

QString OAIUserDefinedField::getName() const {
    return m_name;
}
void OAIUserDefinedField::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUserDefinedField::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUserDefinedField::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUserDefinedField::getOneOf() const {
    return m_one_of;
}
void OAIUserDefinedField::setOneOf(const QString &one_of) {
    m_one_of = one_of;
    m_one_of_isSet = true;
}

bool OAIUserDefinedField::is_one_of_Set() const{
    return m_one_of_isSet;
}

bool OAIUserDefinedField::is_one_of_Valid() const{
    return m_one_of_isValid;
}

bool OAIUserDefinedField::isSet() const {
...
bool OAIUserDefinedField::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_example_isValid && m_label_isValid && m_name_isValid && true;
}
