...
OAIKernel::OAIKernel(QString json) {
...
void OAIKernel::initializeModel() {
...
void OAIKernel::fromJson(QString jsonString) {
...
void OAIKernel::fromJsonObject(QJsonObject json) {
    ...
    m_pvops_isValid = ::OpenAPI::fromJsonValue(m_pvops, json[QString("pvops")]);
    m_pvops_isSet = !json[QString("pvops")].isNull() && m_pvops_isValid;

    m_version_isValid = ::OpenAPI::fromJsonValue(m_version, json[QString("version")]);
    m_version_isSet = !json[QString("version")].isNull() && m_version_isValid;

    m_xen_isValid = ::OpenAPI::fromJsonValue(m_xen, json[QString("xen")]);
    m_xen_isSet = !json[QString("xen")].isNull() && m_xen_isValid;
}

QString OAIKernel::asJson() const {
...
QJsonObject OAIKernel::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_pvops_isSet) {
        obj.insert(QString("pvops"), ::OpenAPI::toJsonValue(m_pvops));
    }
    if (m_version_isSet) {
        obj.insert(QString("version"), ::OpenAPI::toJsonValue(m_version));
    }
    if (m_xen_isSet) {
        obj.insert(QString("xen"), ::OpenAPI::toJsonValue(m_xen));
    }
    return obj;
}

QString OAIKernel::getArchitecture() const {
    return m_architecture;
}
void OAIKernel::setArchitecture(const QString &architecture) {
    m_architecture = architecture;
    m_architecture_isSet = true;
}

bool OAIKernel::is_architecture_Set() const{
    return m_architecture_isSet;
}

bool OAIKernel::is_architecture_Valid() const{
    return m_architecture_isValid;
}

QDateTime OAIKernel::getBuilt() const {
    return m_built;
}
void OAIKernel::setBuilt(const QDateTime &built) {
    m_built = built;
    m_built_isSet = true;
}

bool OAIKernel::is_built_Set() const{
    return m_built_isSet;
}

bool OAIKernel::is_built_Valid() const{
    return m_built_isValid;
}

bool OAIKernel::isDeprecated() const {
    return m_deprecated;
}
void OAIKernel::setDeprecated(const bool &deprecated) {
    m_deprecated = deprecated;
    m_deprecated_isSet = true;
}

bool OAIKernel::is_deprecated_Set() const{
    return m_deprecated_isSet;
}

bool OAIKernel::is_deprecated_Valid() const{
    return m_deprecated_isValid;
}

QString OAIKernel::getId() const {
    return m_id;
}
void OAIKernel::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKernel::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKernel::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKernel::isKvm() const {
    return m_kvm;
}
void OAIKernel::setKvm(const bool &kvm) {
    m_kvm = kvm;
    m_kvm_isSet = true;
}

bool OAIKernel::is_kvm_Set() const{
    return m_kvm_isSet;
}

bool OAIKernel::is_kvm_Valid() const{
    return m_kvm_isValid;
}

QString OAIKernel::getLabel() const {
    return m_label;
}
void OAIKernel::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIKernel::is_label_Set() const{
    return m_label_isSet;
}

bool OAIKernel::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIKernel::isPvops() const {
    return m_pvops;
}
void OAIKernel::setPvops(const bool &pvops) {
    m_pvops = pvops;
    m_pvops_isSet = true;
}

bool OAIKernel::is_pvops_Set() const{
    return m_pvops_isSet;
}

bool OAIKernel::is_pvops_Valid() const{
    return m_pvops_isValid;
}

QString OAIKernel::getVersion() const {
    return m_version;
}
void OAIKernel::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIKernel::is_version_Set() const{
    return m_version_isSet;
}

bool OAIKernel::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIKernel::isXen() const {
    return m_xen;
}
void OAIKernel::setXen(const bool &xen) {
    m_xen = xen;
    m_xen_isSet = true;
}

bool OAIKernel::is_xen_Set() const{
    return m_xen_isSet;
}

bool OAIKernel::is_xen_Valid() const{
    return m_xen_isValid;
}

bool OAIKernel::isSet() const {
