...
OAIDomainRecord::OAIDomainRecord(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainRecord::OAIDomainRecord() {
    this->initializeModel();
}

OAIDomainRecord::~OAIDomainRecord() {}

void OAIDomainRecord::initializeModel() {
...
void OAIDomainRecord::fromJson(QString jsonString) {
...
void OAIDomainRecord::fromJsonObject(QJsonObject json) {
...
QString OAIDomainRecord::asJson() const {
...
QJsonObject OAIDomainRecord::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIDomainRecord::getCreated() const {
    return m_created;
}
void OAIDomainRecord::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDomainRecord::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDomainRecord::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIDomainRecord::getId() const {
    return m_id;
}
void OAIDomainRecord::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDomainRecord::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDomainRecord::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDomainRecord::getName() const {
    return m_name;
}
void OAIDomainRecord::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDomainRecord::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDomainRecord::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIDomainRecord::getPort() const {
    return m_port;
}
void OAIDomainRecord::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDomainRecord::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDomainRecord::is_port_Valid() const{
    return m_port_isValid;
}

qint32 OAIDomainRecord::getPriority() const {
    return m_priority;
}
void OAIDomainRecord::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIDomainRecord::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIDomainRecord::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIDomainRecord::getProtocol() const {
    return m_protocol;
}
void OAIDomainRecord::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIDomainRecord::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIDomainRecord::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIDomainRecord::getService() const {
    return m_service;
}
void OAIDomainRecord::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIDomainRecord::is_service_Set() const{
    return m_service_isSet;
}

bool OAIDomainRecord::is_service_Valid() const{
    return m_service_isValid;
}

QString OAIDomainRecord::getTag() const {
    return m_tag;
}
void OAIDomainRecord::setTag(const QString &tag) {
    m_tag = tag;
    m_tag_isSet = true;
}

bool OAIDomainRecord::is_tag_Set() const{
    return m_tag_isSet;
}

bool OAIDomainRecord::is_tag_Valid() const{
    return m_tag_isValid;
}

QString OAIDomainRecord::getTarget() const {
    return m_target;
}
void OAIDomainRecord::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIDomainRecord::is_target_Set() const{
    return m_target_isSet;
}

bool OAIDomainRecord::is_target_Valid() const{
    return m_target_isValid;
}

qint32 OAIDomainRecord::getTtlSec() const {
    return m_ttl_sec;
}
void OAIDomainRecord::setTtlSec(const qint32 &ttl_sec) {
    m_ttl_sec = ttl_sec;
    m_ttl_sec_isSet = true;
}

bool OAIDomainRecord::is_ttl_sec_Set() const{
    return m_ttl_sec_isSet;
}

bool OAIDomainRecord::is_ttl_sec_Valid() const{
    return m_ttl_sec_isValid;
}

QString OAIDomainRecord::getType() const {
    return m_type;
}
void OAIDomainRecord::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDomainRecord::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDomainRecord::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIDomainRecord::getUpdated() const {
    return m_updated;
}
void OAIDomainRecord::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDomainRecord::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDomainRecord::is_updated_Valid() const{
    return m_updated_isValid;
}

qint32 OAIDomainRecord::getWeight() const {
    return m_weight;
}
void OAIDomainRecord::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIDomainRecord::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIDomainRecord::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAIDomainRecord::isSet() const {
...
bool OAIDomainRecord::isValid() const {
