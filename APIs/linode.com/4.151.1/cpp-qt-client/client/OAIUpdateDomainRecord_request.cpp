...
OAIUpdateDomainRecord_request::OAIUpdateDomainRecord_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDomainRecord_request::OAIUpdateDomainRecord_request() {
    this->initializeModel();
}

OAIUpdateDomainRecord_request::~OAIUpdateDomainRecord_request() {}

void OAIUpdateDomainRecord_request::initializeModel() {
...
void OAIUpdateDomainRecord_request::fromJson(QString jsonString) {
...
void OAIUpdateDomainRecord_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDomainRecord_request::asJson() const {
...
QJsonObject OAIUpdateDomainRecord_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateDomainRecord_request::getName() const {
    return m_name;
}
void OAIUpdateDomainRecord_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateDomainRecord_request::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIUpdateDomainRecord_request::getPort() const {
    return m_port;
}
void OAIUpdateDomainRecord_request::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_port_Set() const{
    return m_port_isSet;
}

bool OAIUpdateDomainRecord_request::is_port_Valid() const{
    return m_port_isValid;
}

qint32 OAIUpdateDomainRecord_request::getPriority() const {
    return m_priority;
}
void OAIUpdateDomainRecord_request::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIUpdateDomainRecord_request::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIUpdateDomainRecord_request::getProtocol() const {
    return m_protocol;
}
void OAIUpdateDomainRecord_request::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIUpdateDomainRecord_request::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIUpdateDomainRecord_request::getService() const {
    return m_service;
}
void OAIUpdateDomainRecord_request::setService(const QString &service) {
    m_service = service;
    m_service_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_service_Set() const{
    return m_service_isSet;
}

bool OAIUpdateDomainRecord_request::is_service_Valid() const{
    return m_service_isValid;
}

QString OAIUpdateDomainRecord_request::getTag() const {
    return m_tag;
}
void OAIUpdateDomainRecord_request::setTag(const QString &tag) {
    m_tag = tag;
    m_tag_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_tag_Set() const{
    return m_tag_isSet;
}

bool OAIUpdateDomainRecord_request::is_tag_Valid() const{
    return m_tag_isValid;
}

QString OAIUpdateDomainRecord_request::getTarget() const {
    return m_target;
}
void OAIUpdateDomainRecord_request::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_target_Set() const{
    return m_target_isSet;
}

bool OAIUpdateDomainRecord_request::is_target_Valid() const{
    return m_target_isValid;
}

qint32 OAIUpdateDomainRecord_request::getTtlSec() const {
    return m_ttl_sec;
}
void OAIUpdateDomainRecord_request::setTtlSec(const qint32 &ttl_sec) {
    m_ttl_sec = ttl_sec;
    m_ttl_sec_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_ttl_sec_Set() const{
    return m_ttl_sec_isSet;
}

bool OAIUpdateDomainRecord_request::is_ttl_sec_Valid() const{
    return m_ttl_sec_isValid;
}

qint32 OAIUpdateDomainRecord_request::getWeight() const {
    return m_weight;
}
void OAIUpdateDomainRecord_request::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIUpdateDomainRecord_request::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIUpdateDomainRecord_request::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAIUpdateDomainRecord_request::isSet() const {
...
bool OAIUpdateDomainRecord_request::isValid() const {
