...
OAIDatabasePostgreSQL::OAIDatabasePostgreSQL(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabasePostgreSQL::OAIDatabasePostgreSQL() {
    this->initializeModel();
}

OAIDatabasePostgreSQL::~OAIDatabasePostgreSQL() {}

void OAIDatabasePostgreSQL::initializeModel() {
    ...
    m_replication_commit_type_isSet = false;
    m_replication_commit_type_isValid = false;
...
void OAIDatabasePostgreSQL::fromJson(QString jsonString) {
...
void OAIDatabasePostgreSQL::fromJsonObject(QJsonObject json) {
    ...
    m_replication_commit_type_isValid = ::OpenAPI::fromJsonValue(m_replication_commit_type, json[QString("replication_commit_type")]);
    m_replication_commit_type_isSet = !json[QString("replication_commit_type")].isNull() && m_replication_commit_type_isValid;
...
QString OAIDatabasePostgreSQL::asJson() const {
...
QJsonObject OAIDatabasePostgreSQL::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_replication_commit_type_isSet) {
        obj.insert(QString("replication_commit_type"), ::OpenAPI::toJsonValue(m_replication_commit_type));
    }
...
QList<QString> OAIDatabasePostgreSQL::getAllowList() const {
    return m_allow_list;
}
void OAIDatabasePostgreSQL::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabasePostgreSQL::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabasePostgreSQL::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabasePostgreSQL::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabasePostgreSQL::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabasePostgreSQL::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabasePostgreSQL::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

QDateTime OAIDatabasePostgreSQL::getCreated() const {
    return m_created;
}
void OAIDatabasePostgreSQL::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDatabasePostgreSQL::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDatabasePostgreSQL::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIDatabasePostgreSQL::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabasePostgreSQL::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabasePostgreSQL::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabasePostgreSQL::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabasePostgreSQL::getEngine() const {
    return m_engine;
}
void OAIDatabasePostgreSQL::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabasePostgreSQL::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabasePostgreSQL::is_engine_Valid() const{
    return m_engine_isValid;
}

OAIDatabasePostgreSQL_hosts OAIDatabasePostgreSQL::getHosts() const {
    return m_hosts;
}
void OAIDatabasePostgreSQL::setHosts(const OAIDatabasePostgreSQL_hosts &hosts) {
    m_hosts = hosts;
    m_hosts_isSet = true;
}

bool OAIDatabasePostgreSQL::is_hosts_Set() const{
    return m_hosts_isSet;
}

bool OAIDatabasePostgreSQL::is_hosts_Valid() const{
    return m_hosts_isValid;
}

qint32 OAIDatabasePostgreSQL::getId() const {
    return m_id;
}
void OAIDatabasePostgreSQL::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabasePostgreSQL::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabasePostgreSQL::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabasePostgreSQL::getLabel() const {
    return m_label;
}
void OAIDatabasePostgreSQL::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabasePostgreSQL::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabasePostgreSQL::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIDatabasePostgreSQL::getPort() const {
    return m_port;
}
void OAIDatabasePostgreSQL::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDatabasePostgreSQL::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDatabasePostgreSQL::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIDatabasePostgreSQL::getRegion() const {
    return m_region;
}
void OAIDatabasePostgreSQL::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabasePostgreSQL::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabasePostgreSQL::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabasePostgreSQL::getReplicationCommitType() const {
    return m_replication_commit_type;
}
void OAIDatabasePostgreSQL::setReplicationCommitType(const QString &replication_commit_type) {
    m_replication_commit_type = replication_commit_type;
    m_replication_commit_type_isSet = true;
}

bool OAIDatabasePostgreSQL::is_replication_commit_type_Set() const{
    return m_replication_commit_type_isSet;
}

bool OAIDatabasePostgreSQL::is_replication_commit_type_Valid() const{
    return m_replication_commit_type_isValid;
}

QString OAIDatabasePostgreSQL::getReplicationType() const {
    return m_replication_type;
}
void OAIDatabasePostgreSQL::setReplicationType(const QString &replication_type) {
    m_replication_type = replication_type;
    m_replication_type_isSet = true;
}

bool OAIDatabasePostgreSQL::is_replication_type_Set() const{
    return m_replication_type_isSet;
}

bool OAIDatabasePostgreSQL::is_replication_type_Valid() const{
    return m_replication_type_isValid;
}

bool OAIDatabasePostgreSQL::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabasePostgreSQL::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabasePostgreSQL::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabasePostgreSQL::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabasePostgreSQL::getStatus() const {
    return m_status;
}
void OAIDatabasePostgreSQL::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatabasePostgreSQL::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatabasePostgreSQL::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatabasePostgreSQL::getType() const {
    return m_type;
}
void OAIDatabasePostgreSQL::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabasePostgreSQL::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabasePostgreSQL::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIDatabasePostgreSQL::getUpdated() const {
    return m_updated;
}
void OAIDatabasePostgreSQL::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIDatabasePostgreSQL::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIDatabasePostgreSQL::is_updated_Valid() const{
    return m_updated_isValid;
}

OAIDatabase_updates OAIDatabasePostgreSQL::getUpdates() const {
    return m_updates;
}
void OAIDatabasePostgreSQL::setUpdates(const OAIDatabase_updates &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIDatabasePostgreSQL::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIDatabasePostgreSQL::is_updates_Valid() const{
    return m_updates_isValid;
}

QString OAIDatabasePostgreSQL::getVersion() const {
    return m_version;
}
void OAIDatabasePostgreSQL::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDatabasePostgreSQL::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDatabasePostgreSQL::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIDatabasePostgreSQL::isSet() const {
...
bool OAIDatabasePostgreSQL::isValid() const {
