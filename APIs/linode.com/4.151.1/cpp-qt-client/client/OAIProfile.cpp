...
void OAIProfile::initializeModel() {
    ...
    m_ip_whitelist_enabled_isSet = false;
    m_ip_whitelist_enabled_isValid = false;

    m_lish_auth_method_isSet = false;
    m_lish_auth_method_isValid = false;

    m_referrals_isSet = false;
    m_referrals_isValid = false;
    ...
    m_two_factor_auth_isSet = false;
    m_two_factor_auth_isValid = false;
...
void OAIProfile::fromJsonObject(QJsonObject json) {
    ...
    m_email_notifications_isValid = ::OpenAPI::fromJsonValue(m_email_notifications, json[QString("email_notifications")]);
    m_email_notifications_isSet = !json[QString("email_notifications")].isNull() && m_email_notifications_isValid;

    m_ip_whitelist_enabled_isValid = ::OpenAPI::fromJsonValue(m_ip_whitelist_enabled, json[QString("ip_whitelist_enabled")]);
    m_ip_whitelist_enabled_isSet = !json[QString("ip_whitelist_enabled")].isNull() && m_ip_whitelist_enabled_isValid;

    m_lish_auth_method_isValid = ::OpenAPI::fromJsonValue(m_lish_auth_method, json[QString("lish_auth_method")]);
    m_lish_auth_method_isSet = !json[QString("lish_auth_method")].isNull() && m_lish_auth_method_isValid;

    m_referrals_isValid = ::OpenAPI::fromJsonValue(m_referrals, json[QString("referrals")]);
    m_referrals_isSet = !json[QString("referrals")].isNull() && m_referrals_isValid;
    ...
    m_two_factor_auth_isValid = ::OpenAPI::fromJsonValue(m_two_factor_auth, json[QString("two_factor_auth")]);
    m_two_factor_auth_isSet = !json[QString("two_factor_auth")].isNull() && m_two_factor_auth_isValid;
    ...
    m_verified_phone_number_isValid = ::OpenAPI::fromJsonValue(m_verified_phone_number, json[QString("verified_phone_number")]);
    m_verified_phone_number_isSet = !json[QString("verified_phone_number")].isNull() && m_verified_phone_number_isValid;
}
...
QJsonObject OAIProfile::asJsonObject() const {
    ...
    if (m_email_notifications_isSet) {
        obj.insert(QString("email_notifications"), ::OpenAPI::toJsonValue(m_email_notifications));
    }
    if (m_ip_whitelist_enabled_isSet) {
        obj.insert(QString("ip_whitelist_enabled"), ::OpenAPI::toJsonValue(m_ip_whitelist_enabled));
    }
    if (m_lish_auth_method_isSet) {
        obj.insert(QString("lish_auth_method"), ::OpenAPI::toJsonValue(m_lish_auth_method));
    }
    if (m_referrals.isSet()) {
        obj.insert(QString("referrals"), ::OpenAPI::toJsonValue(m_referrals));
    }
    ...
    if (m_two_factor_auth_isSet) {
        obj.insert(QString("two_factor_auth"), ::OpenAPI::toJsonValue(m_two_factor_auth));
    }
    if (m_uid_isSet) {
    ...
    if (m_verified_phone_number_isSet) {
        obj.insert(QString("verified_phone_number"), ::OpenAPI::toJsonValue(m_verified_phone_number));
    }
    return obj;
}

QString OAIProfile::getAuthenticationType() const {
    return m_authentication_type;
}
void OAIProfile::setAuthenticationType(const QString &authentication_type) {
    m_authentication_type = authentication_type;
    m_authentication_type_isSet = true;
}

bool OAIProfile::is_authentication_type_Set() const{
    return m_authentication_type_isSet;
}

bool OAIProfile::is_authentication_type_Valid() const{
    return m_authentication_type_isValid;
}

QList<QString> OAIProfile::getAuthorizedKeys() const {
    return m_authorized_keys;
}
void OAIProfile::setAuthorizedKeys(const QList<QString> &authorized_keys) {
    m_authorized_keys = authorized_keys;
    m_authorized_keys_isSet = true;
}

bool OAIProfile::is_authorized_keys_Set() const{
    return m_authorized_keys_isSet;
}

bool OAIProfile::is_authorized_keys_Valid() const{
...
bool OAIProfile::isEmailNotifications() const {
    return m_email_notifications;
}
void OAIProfile::setEmailNotifications(const bool &email_notifications) {
    m_email_notifications = email_notifications;
    m_email_notifications_isSet = true;
}

bool OAIProfile::is_email_notifications_Set() const{
    return m_email_notifications_isSet;
}

bool OAIProfile::is_email_notifications_Valid() const{
    return m_email_notifications_isValid;
}

bool OAIProfile::isIpWhitelistEnabled() const {
    return m_ip_whitelist_enabled;
}
void OAIProfile::setIpWhitelistEnabled(const bool &ip_whitelist_enabled) {
    m_ip_whitelist_enabled = ip_whitelist_enabled;
    m_ip_whitelist_enabled_isSet = true;
}

bool OAIProfile::is_ip_whitelist_enabled_Set() const{
    return m_ip_whitelist_enabled_isSet;
}

bool OAIProfile::is_ip_whitelist_enabled_Valid() const{
    return m_ip_whitelist_enabled_isValid;
}

QString OAIProfile::getLishAuthMethod() const {
    return m_lish_auth_method;
}
void OAIProfile::setLishAuthMethod(const QString &lish_auth_method) {
    m_lish_auth_method = lish_auth_method;
    m_lish_auth_method_isSet = true;
}

bool OAIProfile::is_lish_auth_method_Set() const{
    return m_lish_auth_method_isSet;
}

bool OAIProfile::is_lish_auth_method_Valid() const{
    return m_lish_auth_method_isValid;
}

OAIProfile_referrals OAIProfile::getReferrals() const {
    return m_referrals;
}
void OAIProfile::setReferrals(const OAIProfile_referrals &referrals) {
    m_referrals = referrals;
    m_referrals_isSet = true;
}

bool OAIProfile::is_referrals_Set() const{
    return m_referrals_isSet;
}

bool OAIProfile::is_referrals_Valid() const{
    return m_referrals_isValid;
}

bool OAIProfile::isRestricted() const {
    return m_restricted;
}
void OAIProfile::setRestricted(const bool &restricted) {
    m_restricted = restricted;
    m_restricted_isSet = true;
}

bool OAIProfile::is_restricted_Set() const{
    return m_restricted_isSet;
}

bool OAIProfile::is_restricted_Valid() const{
...
bool OAIProfile::isTwoFactorAuth() const {
    return m_two_factor_auth;
}
void OAIProfile::setTwoFactorAuth(const bool &two_factor_auth) {
    m_two_factor_auth = two_factor_auth;
    m_two_factor_auth_isSet = true;
}

bool OAIProfile::is_two_factor_auth_Set() const{
    return m_two_factor_auth_isSet;
}

bool OAIProfile::is_two_factor_auth_Valid() const{
    return m_two_factor_auth_isValid;
}

qint32 OAIProfile::getUid() const {
    return m_uid;
}
void OAIProfile::setUid(const qint32 &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAIProfile::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAIProfile::is_uid_Valid() const{
...
QString OAIProfile::getVerifiedPhoneNumber() const {
    return m_verified_phone_number;
}
void OAIProfile::setVerifiedPhoneNumber(const QString &verified_phone_number) {
    m_verified_phone_number = verified_phone_number;
    m_verified_phone_number_isSet = true;
}

bool OAIProfile::is_verified_phone_number_Set() const{
    return m_verified_phone_number_isSet;
}

bool OAIProfile::is_verified_phone_number_Valid() const{
