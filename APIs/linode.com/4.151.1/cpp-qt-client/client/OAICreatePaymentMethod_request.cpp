...
OAICreatePaymentMethod_request::OAICreatePaymentMethod_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePaymentMethod_request::OAICreatePaymentMethod_request() {
    this->initializeModel();
}

OAICreatePaymentMethod_request::~OAICreatePaymentMethod_request() {}

void OAICreatePaymentMethod_request::initializeModel() {
...
void OAICreatePaymentMethod_request::fromJson(QString jsonString) {
...
void OAICreatePaymentMethod_request::fromJsonObject(QJsonObject json) {
...
QString OAICreatePaymentMethod_request::asJson() const {
...
QJsonObject OAICreatePaymentMethod_request::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICreditCard OAICreatePaymentMethod_request::getData() const {
    return m_data;
}
void OAICreatePaymentMethod_request::setData(const OAICreditCard &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreatePaymentMethod_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreatePaymentMethod_request::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICreatePaymentMethod_request::isIsDefault() const {
    return m_is_default;
}
void OAICreatePaymentMethod_request::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAICreatePaymentMethod_request::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAICreatePaymentMethod_request::is_is_default_Valid() const{
    return m_is_default_isValid;
}

QString OAICreatePaymentMethod_request::getType() const {
    return m_type;
}
void OAICreatePaymentMethod_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreatePaymentMethod_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreatePaymentMethod_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreatePaymentMethod_request::isSet() const {
...
bool OAICreatePaymentMethod_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_data_isValid && m_is_default_isValid && m_type_isValid && true;
}
