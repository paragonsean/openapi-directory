...
QString OAIPayPal::getCancelUrl() const {
    return m_cancel_url;
}
void OAIPayPal::setCancelUrl(const QString &cancel_url) {
    m_cancel_url = cancel_url;
    m_cancel_url_isSet = true;
}

bool OAIPayPal::is_cancel_url_Set() const{
    return m_cancel_url_isSet;
}

bool OAIPayPal::is_cancel_url_Valid() const{
    return m_cancel_url_isValid;
}

QString OAIPayPal::getRedirectUrl() const {
    return m_redirect_url;
}
void OAIPayPal::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAIPayPal::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAIPayPal::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAIPayPal::getUsd() const {
    return m_usd;
}
void OAIPayPal::setUsd(const QString &usd) {
    m_usd = usd;
    m_usd_isSet = true;
}

bool OAIPayPal::is_usd_Set() const{
    return m_usd_isSet;
}

bool OAIPayPal::is_usd_Valid() const{
...
bool OAIPayPal::isValid() const {
    ...
    return m_cancel_url_isValid && m_redirect_url_isValid && m_usd_isValid && true;
}
