...
OAICloneLinodeInstance_request::OAICloneLinodeInstance_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloneLinodeInstance_request::OAICloneLinodeInstance_request() {
    this->initializeModel();
}

OAICloneLinodeInstance_request::~OAICloneLinodeInstance_request() {}

void OAICloneLinodeInstance_request::initializeModel() {
...
void OAICloneLinodeInstance_request::fromJson(QString jsonString) {
...
void OAICloneLinodeInstance_request::fromJsonObject(QJsonObject json) {
...
QString OAICloneLinodeInstance_request::asJson() const {
...
QJsonObject OAICloneLinodeInstance_request::asJsonObject() const {
    QJsonObject obj;
...
bool OAICloneLinodeInstance_request::isBackupsEnabled() const {
    return m_backups_enabled;
}
void OAICloneLinodeInstance_request::setBackupsEnabled(const bool &backups_enabled) {
    m_backups_enabled = backups_enabled;
    m_backups_enabled_isSet = true;
}

bool OAICloneLinodeInstance_request::is_backups_enabled_Set() const{
    return m_backups_enabled_isSet;
}

bool OAICloneLinodeInstance_request::is_backups_enabled_Valid() const{
    return m_backups_enabled_isValid;
}

QList<qint32> OAICloneLinodeInstance_request::getConfigs() const {
    return m_configs;
}
void OAICloneLinodeInstance_request::setConfigs(const QList<qint32> &configs) {
    m_configs = configs;
    m_configs_isSet = true;
}

bool OAICloneLinodeInstance_request::is_configs_Set() const{
    return m_configs_isSet;
}

bool OAICloneLinodeInstance_request::is_configs_Valid() const{
    return m_configs_isValid;
}

QList<qint32> OAICloneLinodeInstance_request::getDisks() const {
    return m_disks;
}
void OAICloneLinodeInstance_request::setDisks(const QList<qint32> &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAICloneLinodeInstance_request::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAICloneLinodeInstance_request::is_disks_Valid() const{
    return m_disks_isValid;
}

QString OAICloneLinodeInstance_request::getGroup() const {
    return m_group;
}
void OAICloneLinodeInstance_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAICloneLinodeInstance_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAICloneLinodeInstance_request::is_group_Valid() const{
    return m_group_isValid;
}

QString OAICloneLinodeInstance_request::getLabel() const {
    return m_label;
}
void OAICloneLinodeInstance_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICloneLinodeInstance_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICloneLinodeInstance_request::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAICloneLinodeInstance_request::getLinodeId() const {
    return m_linode_id;
}
void OAICloneLinodeInstance_request::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAICloneLinodeInstance_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAICloneLinodeInstance_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

bool OAICloneLinodeInstance_request::isPrivateIp() const {
    return m_private_ip;
}
void OAICloneLinodeInstance_request::setPrivateIp(const bool &private_ip) {
    m_private_ip = private_ip;
    m_private_ip_isSet = true;
}

bool OAICloneLinodeInstance_request::is_private_ip_Set() const{
    return m_private_ip_isSet;
}

bool OAICloneLinodeInstance_request::is_private_ip_Valid() const{
    return m_private_ip_isValid;
}

QString OAICloneLinodeInstance_request::getRegion() const {
    return m_region;
}
void OAICloneLinodeInstance_request::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAICloneLinodeInstance_request::is_region_Set() const{
    return m_region_isSet;
}

bool OAICloneLinodeInstance_request::is_region_Valid() const{
    return m_region_isValid;
}

QString OAICloneLinodeInstance_request::getType() const {
    return m_type;
}
void OAICloneLinodeInstance_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICloneLinodeInstance_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAICloneLinodeInstance_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICloneLinodeInstance_request::isSet() const {
...
bool OAICloneLinodeInstance_request::isValid() const {
