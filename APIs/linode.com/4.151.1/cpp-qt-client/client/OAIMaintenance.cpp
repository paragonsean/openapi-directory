...
OAIMaintenance_entity OAIMaintenance::getEntity() const {
    return m_entity;
}
void OAIMaintenance::setEntity(const OAIMaintenance_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIMaintenance::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIMaintenance::is_entity_Valid() const{
    return m_entity_isValid;
}

QString OAIMaintenance::getReason() const {
    return m_reason;
}
void OAIMaintenance::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIMaintenance::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIMaintenance::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIMaintenance::getStatus() const {
    return m_status;
}
void OAIMaintenance::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMaintenance::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMaintenance::is_status_Valid() const{
...
QDateTime OAIMaintenance::getWhen() const {
    return m_when;
}
void OAIMaintenance::setWhen(const QDateTime &when) {
    m_when = when;
    m_when_isSet = true;
}

bool OAIMaintenance::is_when_Set() const{
    return m_when_isSet;
}

bool OAIMaintenance::is_when_Valid() const{
