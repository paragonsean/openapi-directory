...
#ifndef OAILinodeConfig_H
#define OAILinodeConfig_H
...
namespace OpenAPI {
class OAIDevices;
class OAILinodeConfig_helpers;
class OAILinodeConfigInterface;

class OAILinodeConfig : public OAIObject {
public:
    OAILinodeConfig();
    OAILinodeConfig(QString json);
    ~OAILinodeConfig() override;
    ...
    OAIDevices getDevices() const;
    void setDevices(const OAIDevices &devices);
    bool is_devices_Set() const;
    bool is_devices_Valid() const;

    OAILinodeConfig_helpers getHelpers() const;
    void setHelpers(const OAILinodeConfig_helpers &helpers);
    bool is_helpers_Set() const;
    bool is_helpers_Valid() const;
    ...
    void setMemoryLimit(const qint32 &memory_limit);
    bool is_memory_limit_Set() const;
    bool is_memory_limit_Valid() const;

    QString getRootDevice() const;
    void setRootDevice(const QString &root_device);
    bool is_root_device_Set() const;
    bool is_root_device_Valid() const;

    QString getRunLevel() const;
    void setRunLevel(const QString &run_level);
    bool is_run_level_Set() const;
    bool is_run_level_Valid() const;

    QString getVirtMode() const;
    void setVirtMode(const QString &virt_mode);
    bool is_virt_mode_Set() const;
    bool is_virt_mode_Valid() const;
...
private:
    ...
    OAIDevices m_devices;
    bool m_devices_isSet;
    bool m_devices_isValid;

    OAILinodeConfig_helpers m_helpers;
    bool m_helpers_isSet;
    bool m_helpers_isValid;
    ...
    qint32 m_memory_limit;
    bool m_memory_limit_isSet;
    bool m_memory_limit_isValid;

    QString m_root_device;
    bool m_root_device_isSet;
    bool m_root_device_isValid;

    QString m_run_level;
    bool m_run_level_isSet;
    bool m_run_level_isValid;

    QString m_virt_mode;
    bool m_virt_mode_isSet;
    bool m_virt_mode_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILinodeConfig)

#endif // OAILinodeConfig_H
