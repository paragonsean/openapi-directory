...
QList<OAITag> OAIGetTags_200_response::getData() const {
    return m_data;
}
void OAIGetTags_200_response::setData(const QList<OAITag> &data) {
    m_data = data;
    m_data_isSet = true;
}
...
qint32 OAIGetTags_200_response::getPage() const {
    return m_page;
}
void OAIGetTags_200_response::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIGetTags_200_response::is_page_Set() const{
    return m_page_isSet;
}

bool OAIGetTags_200_response::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIGetTags_200_response::getPages() const {
    return m_pages;
}
void OAIGetTags_200_response::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIGetTags_200_response::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIGetTags_200_response::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIGetTags_200_response::getResults() const {
    return m_results;
}
void OAIGetTags_200_response::setResults(const qint32 &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIGetTags_200_response::is_results_Set() const{
    return m_results_isSet;
}

bool OAIGetTags_200_response::is_results_Valid() const{
