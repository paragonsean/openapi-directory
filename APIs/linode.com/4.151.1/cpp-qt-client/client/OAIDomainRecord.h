...
#ifndef OAIDomainRecord_H
#define OAIDomainRecord_H
...
class OAIDomainRecord : public OAIObject {
public:
    OAIDomainRecord();
    OAIDomainRecord(QString json);
    ~OAIDomainRecord() override;
    ...
    qint32 getTtlSec() const;
    void setTtlSec(const qint32 &ttl_sec);
    bool is_ttl_sec_Set() const;
    bool is_ttl_sec_Valid() const;
...
private:
    ...
    qint32 m_ttl_sec;
    bool m_ttl_sec_isSet;
    bool m_ttl_sec_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainRecord)

#endif // OAIDomainRecord_H
