...
#include "OAILongviewClient_apps.h"
...
OAILongviewClient_apps::OAILongviewClient_apps(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILongviewClient_apps::OAILongviewClient_apps() {
    this->initializeModel();
}

OAILongviewClient_apps::~OAILongviewClient_apps() {}

void OAILongviewClient_apps::initializeModel() {

    m_apache_isSet = false;
    m_apache_isValid = false;

    m_mysql_isSet = false;
    m_mysql_isValid = false;

    m_nginx_isSet = false;
    m_nginx_isValid = false;
}

void OAILongviewClient_apps::fromJson(QString jsonString) {
...
void OAILongviewClient_apps::fromJsonObject(QJsonObject json) {

    m_apache_isValid = ::OpenAPI::fromJsonValue(m_apache, json[QString("apache")]);
    m_apache_isSet = !json[QString("apache")].isNull() && m_apache_isValid;

    m_mysql_isValid = ::OpenAPI::fromJsonValue(m_mysql, json[QString("mysql")]);
    m_mysql_isSet = !json[QString("mysql")].isNull() && m_mysql_isValid;

    m_nginx_isValid = ::OpenAPI::fromJsonValue(m_nginx, json[QString("nginx")]);
    m_nginx_isSet = !json[QString("nginx")].isNull() && m_nginx_isValid;
}

QString OAILongviewClient_apps::asJson() const {
...
QJsonObject OAILongviewClient_apps::asJsonObject() const {
    QJsonObject obj;
    if (m_apache_isSet) {
        obj.insert(QString("apache"), ::OpenAPI::toJsonValue(m_apache));
    }
    if (m_mysql_isSet) {
        obj.insert(QString("mysql"), ::OpenAPI::toJsonValue(m_mysql));
    }
    if (m_nginx_isSet) {
        obj.insert(QString("nginx"), ::OpenAPI::toJsonValue(m_nginx));
    }
    return obj;
}

bool OAILongviewClient_apps::isApache() const {
    return m_apache;
}
void OAILongviewClient_apps::setApache(const bool &apache) {
    m_apache = apache;
    m_apache_isSet = true;
}

bool OAILongviewClient_apps::is_apache_Set() const{
    return m_apache_isSet;
}

bool OAILongviewClient_apps::is_apache_Valid() const{
    return m_apache_isValid;
}

bool OAILongviewClient_apps::isMysql() const {
    return m_mysql;
}
void OAILongviewClient_apps::setMysql(const bool &mysql) {
    m_mysql = mysql;
    m_mysql_isSet = true;
}

bool OAILongviewClient_apps::is_mysql_Set() const{
    return m_mysql_isSet;
}

bool OAILongviewClient_apps::is_mysql_Valid() const{
    return m_mysql_isValid;
}

bool OAILongviewClient_apps::isNginx() const {
    return m_nginx;
}
void OAILongviewClient_apps::setNginx(const bool &nginx) {
    m_nginx = nginx;
    m_nginx_isSet = true;
}

bool OAILongviewClient_apps::is_nginx_Set() const{
    return m_nginx_isSet;
}

bool OAILongviewClient_apps::is_nginx_Valid() const{
    return m_nginx_isValid;
}

bool OAILongviewClient_apps::isSet() const {
...
bool OAILongviewClient_apps::isValid() const {
