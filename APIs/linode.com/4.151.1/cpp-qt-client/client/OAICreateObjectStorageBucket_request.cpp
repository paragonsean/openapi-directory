...
#include "OAICreateObjectStorageBucket_request.h"
...
OAICreateObjectStorageBucket_request::OAICreateObjectStorageBucket_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateObjectStorageBucket_request::OAICreateObjectStorageBucket_request() {
    this->initializeModel();
}

OAICreateObjectStorageBucket_request::~OAICreateObjectStorageBucket_request() {}

void OAICreateObjectStorageBucket_request::initializeModel() {
    ...
    m_cors_enabled_isSet = false;
    m_cors_enabled_isValid = false;

    m_label_isSet = false;
    m_label_isValid = false;
}

void OAICreateObjectStorageBucket_request::fromJson(QString jsonString) {
...
void OAICreateObjectStorageBucket_request::fromJsonObject(QJsonObject json) {
    ...
    m_cors_enabled_isValid = ::OpenAPI::fromJsonValue(m_cors_enabled, json[QString("cors_enabled")]);
    m_cors_enabled_isSet = !json[QString("cors_enabled")].isNull() && m_cors_enabled_isValid;

    m_label_isValid = ::OpenAPI::fromJsonValue(m_label, json[QString("label")]);
    m_label_isSet = !json[QString("label")].isNull() && m_label_isValid;
}

QString OAICreateObjectStorageBucket_request::asJson() const {
...
QJsonObject OAICreateObjectStorageBucket_request::asJsonObject() const {
    QJsonObject obj;
    if (m_acl_isSet) {
    ...
    if (m_cors_enabled_isSet) {
        obj.insert(QString("cors_enabled"), ::OpenAPI::toJsonValue(m_cors_enabled));
    }
    if (m_label_isSet) {
...
QString OAICreateObjectStorageBucket_request::getAcl() const {
    return m_acl;
}
void OAICreateObjectStorageBucket_request::setAcl(const QString &acl) {
    m_acl = acl;
    m_acl_isSet = true;
}

bool OAICreateObjectStorageBucket_request::is_acl_Set() const{
    return m_acl_isSet;
}

bool OAICreateObjectStorageBucket_request::is_acl_Valid() const{
    return m_acl_isValid;
}

QString OAICreateObjectStorageBucket_request::getCluster() const {
    return m_cluster;
}
void OAICreateObjectStorageBucket_request::setCluster(const QString &cluster) {
    m_cluster = cluster;
    m_cluster_isSet = true;
}

bool OAICreateObjectStorageBucket_request::is_cluster_Set() const{
    return m_cluster_isSet;
}

bool OAICreateObjectStorageBucket_request::is_cluster_Valid() const{
    return m_cluster_isValid;
}

bool OAICreateObjectStorageBucket_request::isCorsEnabled() const {
    return m_cors_enabled;
}
void OAICreateObjectStorageBucket_request::setCorsEnabled(const bool &cors_enabled) {
    m_cors_enabled = cors_enabled;
    m_cors_enabled_isSet = true;
}

bool OAICreateObjectStorageBucket_request::is_cors_enabled_Set() const{
    return m_cors_enabled_isSet;
}

bool OAICreateObjectStorageBucket_request::is_cors_enabled_Valid() const{
    return m_cors_enabled_isValid;
}

QString OAICreateObjectStorageBucket_request::getLabel() const {
    return m_label;
}
void OAICreateObjectStorageBucket_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreateObjectStorageBucket_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreateObjectStorageBucket_request::is_label_Valid() const{
    return m_label_isValid;
}

bool OAICreateObjectStorageBucket_request::isSet() const {
...
bool OAICreateObjectStorageBucket_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_cluster_isValid && m_label_isValid && true;
}
