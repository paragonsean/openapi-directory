...
OAIGooglePayData::OAIGooglePayData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGooglePayData::OAIGooglePayData() {
    this->initializeModel();
}

OAIGooglePayData::~OAIGooglePayData() {}

void OAIGooglePayData::initializeModel() {
...
void OAIGooglePayData::fromJson(QString jsonString) {
...
void OAIGooglePayData::fromJsonObject(QJsonObject json) {
...
QString OAIGooglePayData::asJson() const {
...
QJsonObject OAIGooglePayData::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGooglePayData::getCardType() const {
    return m_card_type;
}
void OAIGooglePayData::setCardType(const QString &card_type) {
    m_card_type = card_type;
    m_card_type_isSet = true;
}

bool OAIGooglePayData::is_card_type_Set() const{
    return m_card_type_isSet;
}

bool OAIGooglePayData::is_card_type_Valid() const{
    return m_card_type_isValid;
}

QString OAIGooglePayData::getExpiry() const {
    return m_expiry;
}
void OAIGooglePayData::setExpiry(const QString &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIGooglePayData::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIGooglePayData::is_expiry_Valid() const{
    return m_expiry_isValid;
}

QString OAIGooglePayData::getLastFour() const {
    return m_last_four;
}
void OAIGooglePayData::setLastFour(const QString &last_four) {
    m_last_four = last_four;
    m_last_four_isSet = true;
}

bool OAIGooglePayData::is_last_four_Set() const{
    return m_last_four_isSet;
}

bool OAIGooglePayData::is_last_four_Valid() const{
    return m_last_four_isValid;
}

bool OAIGooglePayData::isSet() const {
...
bool OAIGooglePayData::isValid() const {
