...
#include "OAIObjectStorageCluster.h"
...
OAIObjectStorageCluster::OAIObjectStorageCluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectStorageCluster::OAIObjectStorageCluster() {
    this->initializeModel();
}

OAIObjectStorageCluster::~OAIObjectStorageCluster() {}

void OAIObjectStorageCluster::initializeModel() {
    ...
    m_static_site_domain_isSet = false;
    m_static_site_domain_isValid = false;

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIObjectStorageCluster::fromJson(QString jsonString) {
...
void OAIObjectStorageCluster::fromJsonObject(QJsonObject json) {
    ...
    m_static_site_domain_isValid = ::OpenAPI::fromJsonValue(m_static_site_domain, json[QString("static_site_domain")]);
    m_static_site_domain_isSet = !json[QString("static_site_domain")].isNull() && m_static_site_domain_isValid;

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIObjectStorageCluster::asJson() const {
...
QJsonObject OAIObjectStorageCluster::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
    ...
    if (m_static_site_domain_isSet) {
        obj.insert(QString("static_site_domain"), ::OpenAPI::toJsonValue(m_static_site_domain));
    }
    if (m_status_isSet) {
...
QString OAIObjectStorageCluster::getDomain() const {
    return m_domain;
}
void OAIObjectStorageCluster::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIObjectStorageCluster::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIObjectStorageCluster::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIObjectStorageCluster::getId() const {
    return m_id;
}
void OAIObjectStorageCluster::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIObjectStorageCluster::is_id_Set() const{
    return m_id_isSet;
}

bool OAIObjectStorageCluster::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIObjectStorageCluster::getRegion() const {
    return m_region;
}
void OAIObjectStorageCluster::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIObjectStorageCluster::is_region_Set() const{
    return m_region_isSet;
}

bool OAIObjectStorageCluster::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIObjectStorageCluster::getStaticSiteDomain() const {
    return m_static_site_domain;
}
void OAIObjectStorageCluster::setStaticSiteDomain(const QString &static_site_domain) {
    m_static_site_domain = static_site_domain;
    m_static_site_domain_isSet = true;
}

bool OAIObjectStorageCluster::is_static_site_domain_Set() const{
    return m_static_site_domain_isSet;
}

bool OAIObjectStorageCluster::is_static_site_domain_Valid() const{
    return m_static_site_domain_isValid;
}

QString OAIObjectStorageCluster::getStatus() const {
    return m_status;
}
void OAIObjectStorageCluster::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIObjectStorageCluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAIObjectStorageCluster::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIObjectStorageCluster::isSet() const {
...
bool OAIObjectStorageCluster::isValid() const {
