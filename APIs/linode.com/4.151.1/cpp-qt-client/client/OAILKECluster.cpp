...
OAILKECluster::OAILKECluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILKECluster::OAILKECluster() {
    this->initializeModel();
}

OAILKECluster::~OAILKECluster() {}

void OAILKECluster::initializeModel() {
...
void OAILKECluster::fromJson(QString jsonString) {
...
void OAILKECluster::fromJsonObject(QJsonObject json) {
...
QString OAILKECluster::asJson() const {
...
QJsonObject OAILKECluster::asJsonObject() const {
    QJsonObject obj;
...
OAILKECluster_control_plane OAILKECluster::getControlPlane() const {
    return m_control_plane;
}
void OAILKECluster::setControlPlane(const OAILKECluster_control_plane &control_plane) {
    m_control_plane = control_plane;
    m_control_plane_isSet = true;
}

bool OAILKECluster::is_control_plane_Set() const{
    return m_control_plane_isSet;
}

bool OAILKECluster::is_control_plane_Valid() const{
    return m_control_plane_isValid;
}

QDateTime OAILKECluster::getCreated() const {
    return m_created;
}
void OAILKECluster::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAILKECluster::is_created_Set() const{
    return m_created_isSet;
}

bool OAILKECluster::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAILKECluster::getId() const {
    return m_id;
}
void OAILKECluster::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILKECluster::is_id_Set() const{
    return m_id_isSet;
}

bool OAILKECluster::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILKECluster::getK8sVersion() const {
    return m_k8s_version;
}
void OAILKECluster::setK8sVersion(const QString &k8s_version) {
    m_k8s_version = k8s_version;
    m_k8s_version_isSet = true;
}

bool OAILKECluster::is_k8s_version_Set() const{
    return m_k8s_version_isSet;
}

bool OAILKECluster::is_k8s_version_Valid() const{
    return m_k8s_version_isValid;
}

QString OAILKECluster::getLabel() const {
    return m_label;
}
void OAILKECluster::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILKECluster::is_label_Set() const{
    return m_label_isSet;
}

bool OAILKECluster::is_label_Valid() const{
    return m_label_isValid;
}

QString OAILKECluster::getRegion() const {
    return m_region;
}
void OAILKECluster::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAILKECluster::is_region_Set() const{
    return m_region_isSet;
}

bool OAILKECluster::is_region_Valid() const{
    return m_region_isValid;
}

QList<QString> OAILKECluster::getTags() const {
    return m_tags;
}
void OAILKECluster::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILKECluster::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILKECluster::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAILKECluster::getUpdated() const {
    return m_updated;
}
void OAILKECluster::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAILKECluster::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAILKECluster::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAILKECluster::isSet() const {
...
bool OAILKECluster::isValid() const {
