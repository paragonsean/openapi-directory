...
#ifndef OAILinodeType_H
#define OAILinodeType_H

#include <QJsonObject>

#include "OAILinodeType_addons.h"
#include "OAILinodeType_price.h"
#include <QString>
...
namespace OpenAPI {
class OAILinodeType_addons;
class OAILinodeType_price;

class OAILinodeType : public OAIObject {
public:
    OAILinodeType();
    OAILinodeType(QString json);
    ~OAILinodeType() override;
    ...
    OAILinodeType_addons getAddons() const;
    void setAddons(const OAILinodeType_addons &addons);
    ...
    qint32 getNetworkOut() const;
    void setNetworkOut(const qint32 &network_out);
    bool is_network_out_Set() const;
    bool is_network_out_Valid() const;

    OAILinodeType_price getPrice() const;
    void setPrice(const OAILinodeType_price &price);
    bool is_price_Set() const;
    bool is_price_Valid() const;

    QString getSuccessor() const;
    void setSuccessor(const QString &successor);
    bool is_successor_Set() const;
    bool is_successor_Valid() const;

    qint32 getTransfer() const;
    void setTransfer(const qint32 &transfer);
...
private:
    ...
    qint32 m_network_out;
    bool m_network_out_isSet;
    bool m_network_out_isValid;

    OAILinodeType_price m_price;
    bool m_price_isSet;
    bool m_price_isValid;

    QString m_successor;
    bool m_successor_isSet;
    bool m_successor_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinodeType)

#endif // OAILinodeType_H
