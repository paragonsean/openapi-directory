...
namespace OpenAPI {
class OAILinode_alerts;
class OAILinode_backups;
class OAILinode_specs;

class OAILinode : public OAIObject {
public:
    OAILinode();
    OAILinode(QString json);
    ~OAILinode() override;
    ...
    OAILinode_alerts getAlerts() const;
    void setAlerts(const OAILinode_alerts &alerts);
    bool is_alerts_Set() const;
    bool is_alerts_Valid() const;

    OAILinode_backups getBackups() const;
    void setBackups(const OAILinode_backups &backups);
    ...
    QString getHostUuid() const;
    void setHostUuid(const QString &host_uuid);
    bool is_host_uuid_Set() const;
    bool is_host_uuid_Valid() const;

    QString getHypervisor() const;
    void setHypervisor(const QString &hypervisor);
    bool is_hypervisor_Set() const;
    bool is_hypervisor_Valid() const;
    ...
    QList<QString> getIpv4() const;
    void setIpv4(const QList<QString> &ipv4);
    ...
    OAILinode_specs getSpecs() const;
    void setSpecs(const OAILinode_specs &specs);
    ...
    void setWatchdogEnabled(const bool &watchdog_enabled);
    bool is_watchdog_enabled_Set() const;
    bool is_watchdog_enabled_Valid() const;
...
private:
    ...
    OAILinode_alerts m_alerts;
    bool m_alerts_isSet;
    bool m_alerts_isValid;

    OAILinode_backups m_backups;
    ...
    QString m_host_uuid;
    bool m_host_uuid_isSet;
    bool m_host_uuid_isValid;

    QString m_hypervisor;
    bool m_hypervisor_isSet;
    bool m_hypervisor_isValid;
    ...
    bool m_watchdog_enabled_isSet;
    bool m_watchdog_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILinode)
