...
#ifndef OAINodeBalancer_H
#define OAINodeBalancer_H
...
class OAINodeBalancer : public OAIObject {
public:
    OAINodeBalancer();
    OAINodeBalancer(QString json);
    ~OAINodeBalancer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeBalancer)

#endif // OAINodeBalancer_H
