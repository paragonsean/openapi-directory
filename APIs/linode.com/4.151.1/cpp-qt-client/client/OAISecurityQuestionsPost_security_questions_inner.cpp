...
#include "OAISecurityQuestionsPost_security_questions_inner.h"
...
OAISecurityQuestionsPost_security_questions_inner::OAISecurityQuestionsPost_security_questions_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISecurityQuestionsPost_security_questions_inner::OAISecurityQuestionsPost_security_questions_inner() {
    this->initializeModel();
}

OAISecurityQuestionsPost_security_questions_inner::~OAISecurityQuestionsPost_security_questions_inner() {}

void OAISecurityQuestionsPost_security_questions_inner::initializeModel() {
    ...
    m_security_question_isSet = false;
    m_security_question_isValid = false;
}

void OAISecurityQuestionsPost_security_questions_inner::fromJson(QString jsonString) {
...
void OAISecurityQuestionsPost_security_questions_inner::fromJsonObject(QJsonObject json) {
    ...
    m_security_question_isValid = ::OpenAPI::fromJsonValue(m_security_question, json[QString("security_question")]);
    m_security_question_isSet = !json[QString("security_question")].isNull() && m_security_question_isValid;
}

QString OAISecurityQuestionsPost_security_questions_inner::asJson() const {
...
QJsonObject OAISecurityQuestionsPost_security_questions_inner::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_security_question_isSet) {
        obj.insert(QString("security_question"), ::OpenAPI::toJsonValue(m_security_question));
    }
    return obj;
}

qint32 OAISecurityQuestionsPost_security_questions_inner::getQuestionId() const {
    return m_question_id;
}
void OAISecurityQuestionsPost_security_questions_inner::setQuestionId(const qint32 &question_id) {
    m_question_id = question_id;
    m_question_id_isSet = true;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_question_id_Set() const{
    return m_question_id_isSet;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_question_id_Valid() const{
    return m_question_id_isValid;
}

QString OAISecurityQuestionsPost_security_questions_inner::getResponse() const {
    return m_response;
}
void OAISecurityQuestionsPost_security_questions_inner::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_response_Set() const{
    return m_response_isSet;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_response_Valid() const{
    return m_response_isValid;
}

QString OAISecurityQuestionsPost_security_questions_inner::getSecurityQuestion() const {
    return m_security_question;
}
void OAISecurityQuestionsPost_security_questions_inner::setSecurityQuestion(const QString &security_question) {
    m_security_question = security_question;
    m_security_question_isSet = true;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_security_question_Set() const{
    return m_security_question_isSet;
}

bool OAISecurityQuestionsPost_security_questions_inner::is_security_question_Valid() const{
    return m_security_question_isValid;
}

bool OAISecurityQuestionsPost_security_questions_inner::isSet() const {
...
bool OAISecurityQuestionsPost_security_questions_inner::isValid() const {
