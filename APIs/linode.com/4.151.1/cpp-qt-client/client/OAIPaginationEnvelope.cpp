...
#include "OAIPaginationEnvelope.h"
...
OAIPaginationEnvelope::OAIPaginationEnvelope(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaginationEnvelope::OAIPaginationEnvelope() {
    this->initializeModel();
}

OAIPaginationEnvelope::~OAIPaginationEnvelope() {}

void OAIPaginationEnvelope::initializeModel() {
...
void OAIPaginationEnvelope::fromJson(QString jsonString) {
...
void OAIPaginationEnvelope::fromJsonObject(QJsonObject json) {
...
QString OAIPaginationEnvelope::asJson() const {
...
QJsonObject OAIPaginationEnvelope::asJsonObject() const {
    QJsonObject obj;
    if (m_page_isSet) {
...
qint32 OAIPaginationEnvelope::getPage() const {
    return m_page;
}
void OAIPaginationEnvelope::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIPaginationEnvelope::is_page_Set() const{
    return m_page_isSet;
}

bool OAIPaginationEnvelope::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIPaginationEnvelope::getPages() const {
    return m_pages;
}
void OAIPaginationEnvelope::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIPaginationEnvelope::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIPaginationEnvelope::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIPaginationEnvelope::getResults() const {
    return m_results;
}
void OAIPaginationEnvelope::setResults(const qint32 &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIPaginationEnvelope::is_results_Set() const{
    return m_results_isSet;
}

bool OAIPaginationEnvelope::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIPaginationEnvelope::isSet() const {
...
bool OAIPaginationEnvelope::isValid() const {
