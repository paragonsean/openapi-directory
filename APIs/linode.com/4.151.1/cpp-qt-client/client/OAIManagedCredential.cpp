...
#include "OAIManagedCredential.h"
...
OAIManagedCredential::OAIManagedCredential(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedCredential::OAIManagedCredential() {
    this->initializeModel();
}

OAIManagedCredential::~OAIManagedCredential() {}

void OAIManagedCredential::initializeModel() {
...
void OAIManagedCredential::fromJson(QString jsonString) {
...
void OAIManagedCredential::fromJsonObject(QJsonObject json) {
...
QString OAIManagedCredential::asJson() const {
...
QJsonObject OAIManagedCredential::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIManagedCredential::getId() const {
    return m_id;
}
void OAIManagedCredential::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedCredential::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedCredential::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagedCredential::getLabel() const {
    return m_label;
}
void OAIManagedCredential::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIManagedCredential::is_label_Set() const{
    return m_label_isSet;
}

bool OAIManagedCredential::is_label_Valid() const{
    return m_label_isValid;
}

QDateTime OAIManagedCredential::getLastDecrypted() const {
    return m_last_decrypted;
}
void OAIManagedCredential::setLastDecrypted(const QDateTime &last_decrypted) {
    m_last_decrypted = last_decrypted;
    m_last_decrypted_isSet = true;
}

bool OAIManagedCredential::is_last_decrypted_Set() const{
    return m_last_decrypted_isSet;
}

bool OAIManagedCredential::is_last_decrypted_Valid() const{
    return m_last_decrypted_isValid;
}

bool OAIManagedCredential::isSet() const {
...
bool OAIManagedCredential::isValid() const {
