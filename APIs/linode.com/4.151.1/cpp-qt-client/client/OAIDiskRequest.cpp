...
OAIDiskRequest::OAIDiskRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDiskRequest::OAIDiskRequest() {
    this->initializeModel();
}

OAIDiskRequest::~OAIDiskRequest() {}

void OAIDiskRequest::initializeModel() {
    ...
    m_filesystem_isSet = false;
    m_filesystem_isValid = false;
...
void OAIDiskRequest::fromJson(QString jsonString) {
...
void OAIDiskRequest::fromJsonObject(QJsonObject json) {
    ...
    m_filesystem_isValid = ::OpenAPI::fromJsonValue(m_filesystem, json[QString("filesystem")]);
    m_filesystem_isSet = !json[QString("filesystem")].isNull() && m_filesystem_isValid;
...
QString OAIDiskRequest::asJson() const {
...
QJsonObject OAIDiskRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_filesystem_isSet) {
        obj.insert(QString("filesystem"), ::OpenAPI::toJsonValue(m_filesystem));
    }
    if (m_image_isSet) {
...
QList<QString> OAIDiskRequest::getAuthorizedKeys() const {
    return m_authorized_keys;
}
void OAIDiskRequest::setAuthorizedKeys(const QList<QString> &authorized_keys) {
    m_authorized_keys = authorized_keys;
    m_authorized_keys_isSet = true;
}

bool OAIDiskRequest::is_authorized_keys_Set() const{
    return m_authorized_keys_isSet;
}

bool OAIDiskRequest::is_authorized_keys_Valid() const{
    return m_authorized_keys_isValid;
}

QList<QString> OAIDiskRequest::getAuthorizedUsers() const {
    return m_authorized_users;
}
void OAIDiskRequest::setAuthorizedUsers(const QList<QString> &authorized_users) {
    m_authorized_users = authorized_users;
    m_authorized_users_isSet = true;
}

bool OAIDiskRequest::is_authorized_users_Set() const{
    return m_authorized_users_isSet;
}

bool OAIDiskRequest::is_authorized_users_Valid() const{
    return m_authorized_users_isValid;
}

QString OAIDiskRequest::getFilesystem() const {
    return m_filesystem;
}
void OAIDiskRequest::setFilesystem(const QString &filesystem) {
    m_filesystem = filesystem;
    m_filesystem_isSet = true;
}

bool OAIDiskRequest::is_filesystem_Set() const{
    return m_filesystem_isSet;
}

bool OAIDiskRequest::is_filesystem_Valid() const{
    return m_filesystem_isValid;
}

QString OAIDiskRequest::getImage() const {
    return m_image;
}
void OAIDiskRequest::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDiskRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDiskRequest::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIDiskRequest::getLabel() const {
    return m_label;
}
void OAIDiskRequest::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDiskRequest::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDiskRequest::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDiskRequest::getRootPass() const {
    return m_root_pass;
}
void OAIDiskRequest::setRootPass(const QString &root_pass) {
    m_root_pass = root_pass;
    m_root_pass_isSet = true;
}

bool OAIDiskRequest::is_root_pass_Set() const{
    return m_root_pass_isSet;
}

bool OAIDiskRequest::is_root_pass_Valid() const{
    return m_root_pass_isValid;
}

qint32 OAIDiskRequest::getSize() const {
    return m_size;
}
void OAIDiskRequest::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIDiskRequest::is_size_Set() const{
    return m_size_isSet;
}

bool OAIDiskRequest::is_size_Valid() const{
    return m_size_isValid;
}

OAIObject OAIDiskRequest::getStackscriptData() const {
    return m_stackscript_data;
}
void OAIDiskRequest::setStackscriptData(const OAIObject &stackscript_data) {
    m_stackscript_data = stackscript_data;
    m_stackscript_data_isSet = true;
}

bool OAIDiskRequest::is_stackscript_data_Set() const{
    return m_stackscript_data_isSet;
}

bool OAIDiskRequest::is_stackscript_data_Valid() const{
    return m_stackscript_data_isValid;
}

qint32 OAIDiskRequest::getStackscriptId() const {
    return m_stackscript_id;
}
void OAIDiskRequest::setStackscriptId(const qint32 &stackscript_id) {
    m_stackscript_id = stackscript_id;
    m_stackscript_id_isSet = true;
}

bool OAIDiskRequest::is_stackscript_id_Set() const{
    return m_stackscript_id_isSet;
}

bool OAIDiskRequest::is_stackscript_id_Valid() const{
    return m_stackscript_id_isValid;
}

bool OAIDiskRequest::isSet() const {
...
bool OAIDiskRequest::isValid() const {
