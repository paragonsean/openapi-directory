...
bool OAIBackup::isAvailable() const {
    return m_available;
}
void OAIBackup::setAvailable(const bool &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAIBackup::is_available_Set() const{
    return m_available_isSet;
}

bool OAIBackup::is_available_Valid() const{
    return m_available_isValid;
}

QList<QString> OAIBackup::getConfigs() const {
    return m_configs;
}
void OAIBackup::setConfigs(const QList<QString> &configs) {
    m_configs = configs;
    m_configs_isSet = true;
}

bool OAIBackup::is_configs_Set() const{
    return m_configs_isSet;
}

bool OAIBackup::is_configs_Valid() const{
    return m_configs_isValid;
}

QDateTime OAIBackup::getCreated() const {
    return m_created;
}
void OAIBackup::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIBackup::is_created_Set() const{
    return m_created_isSet;
}

bool OAIBackup::is_created_Valid() const{
    return m_created_isValid;
}

QList<OAIBackup_disks_inner> OAIBackup::getDisks() const {
    return m_disks;
}
void OAIBackup::setDisks(const QList<OAIBackup_disks_inner> &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAIBackup::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAIBackup::is_disks_Valid() const{
    return m_disks_isValid;
}

QDateTime OAIBackup::getFinished() const {
    return m_finished;
}
void OAIBackup::setFinished(const QDateTime &finished) {
    m_finished = finished;
    m_finished_isSet = true;
}

bool OAIBackup::is_finished_Set() const{
    return m_finished_isSet;
}

bool OAIBackup::is_finished_Valid() const{
    return m_finished_isValid;
}

qint32 OAIBackup::getId() const {
    return m_id;
}
void OAIBackup::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBackup::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBackup::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBackup::getLabel() const {
    return m_label;
}
void OAIBackup::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIBackup::is_label_Set() const{
    return m_label_isSet;
}

bool OAIBackup::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIBackup::getStatus() const {
    return m_status;
}
void OAIBackup::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QDateTime OAIBackup::getUpdated() const {
    return m_updated;
}
void OAIBackup::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIBackup::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIBackup::is_updated_Valid() const{
