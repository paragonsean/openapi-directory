...
#include "OAIUpdateVolume_request.h"
...
OAIUpdateVolume_request::OAIUpdateVolume_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateVolume_request::OAIUpdateVolume_request() {
    this->initializeModel();
}

OAIUpdateVolume_request::~OAIUpdateVolume_request() {}

void OAIUpdateVolume_request::initializeModel() {
...
void OAIUpdateVolume_request::fromJson(QString jsonString) {
...
void OAIUpdateVolume_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateVolume_request::asJson() const {
...
QJsonObject OAIUpdateVolume_request::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIUpdateVolume_request::getCreated() const {
    return m_created;
}
void OAIUpdateVolume_request::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIUpdateVolume_request::is_created_Set() const{
    return m_created_isSet;
}

bool OAIUpdateVolume_request::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIUpdateVolume_request::getFilesystemPath() const {
    return m_filesystem_path;
}
void OAIUpdateVolume_request::setFilesystemPath(const QString &filesystem_path) {
    m_filesystem_path = filesystem_path;
    m_filesystem_path_isSet = true;
}

bool OAIUpdateVolume_request::is_filesystem_path_Set() const{
    return m_filesystem_path_isSet;
}

bool OAIUpdateVolume_request::is_filesystem_path_Valid() const{
    return m_filesystem_path_isValid;
}

QString OAIUpdateVolume_request::getHardwareType() const {
    return m_hardware_type;
}
void OAIUpdateVolume_request::setHardwareType(const QString &hardware_type) {
    m_hardware_type = hardware_type;
    m_hardware_type_isSet = true;
}

bool OAIUpdateVolume_request::is_hardware_type_Set() const{
    return m_hardware_type_isSet;
}

bool OAIUpdateVolume_request::is_hardware_type_Valid() const{
    return m_hardware_type_isValid;
}

qint32 OAIUpdateVolume_request::getId() const {
    return m_id;
}
void OAIUpdateVolume_request::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateVolume_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateVolume_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdateVolume_request::getLabel() const {
    return m_label;
}
void OAIUpdateVolume_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIUpdateVolume_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAIUpdateVolume_request::is_label_Valid() const{
    return m_label_isValid;
}

QJsonValue OAIUpdateVolume_request::getLinodeId() const {
    return m_linode_id;
}
void OAIUpdateVolume_request::setLinodeId(const QJsonValue &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIUpdateVolume_request::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIUpdateVolume_request::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

QString OAIUpdateVolume_request::getLinodeLabel() const {
    return m_linode_label;
}
void OAIUpdateVolume_request::setLinodeLabel(const QString &linode_label) {
    m_linode_label = linode_label;
    m_linode_label_isSet = true;
}

bool OAIUpdateVolume_request::is_linode_label_Set() const{
    return m_linode_label_isSet;
}

bool OAIUpdateVolume_request::is_linode_label_Valid() const{
    return m_linode_label_isValid;
}

QString OAIUpdateVolume_request::getRegion() const {
    return m_region;
}
void OAIUpdateVolume_request::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIUpdateVolume_request::is_region_Set() const{
    return m_region_isSet;
}

bool OAIUpdateVolume_request::is_region_Valid() const{
    return m_region_isValid;
}

QJsonValue OAIUpdateVolume_request::getSize() const {
    return m_size;
}
void OAIUpdateVolume_request::setSize(const QJsonValue &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIUpdateVolume_request::is_size_Set() const{
    return m_size_isSet;
}

bool OAIUpdateVolume_request::is_size_Valid() const{
    return m_size_isValid;
}

QString OAIUpdateVolume_request::getStatus() const {
    return m_status;
}
void OAIUpdateVolume_request::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateVolume_request::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateVolume_request::is_status_Valid() const{
    return m_status_isValid;
}

QList<QString> OAIUpdateVolume_request::getTags() const {
    return m_tags;
}
void OAIUpdateVolume_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateVolume_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateVolume_request::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIUpdateVolume_request::getUpdated() const {
    return m_updated;
}
void OAIUpdateVolume_request::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIUpdateVolume_request::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIUpdateVolume_request::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIUpdateVolume_request::isSet() const {
...
bool OAIUpdateVolume_request::isValid() const {
