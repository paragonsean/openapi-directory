...
#include "OAISupportTicket_entity.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
public:
    ...
    bool is_closable_Set() const;
    bool is_closable_Valid() const;
    ...
    OAISupportTicket_entity getEntity() const;
    void setEntity(const OAISupportTicket_entity &entity);
    ...
    void setOpened(const QDateTime &opened);
    bool is_opened_Set() const;
    bool is_opened_Valid() const;

    QString getOpenedBy() const;
    void setOpenedBy(const QString &opened_by);
    bool is_opened_by_Set() const;
    bool is_opened_by_Valid() const;
...
private:
    ...
    OAISupportTicket_entity m_entity;
    bool m_entity_isSet;
    ...
    QString m_opened_by;
    bool m_opened_by_isSet;
    bool m_opened_by_isValid;
