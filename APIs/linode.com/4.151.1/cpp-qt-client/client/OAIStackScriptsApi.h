...
#ifndef OAI_OAIStackScriptsApi_H
#define OAI_OAIStackScriptsApi_H
...
#include "OAIGetStackScripts_200_response.h"
#include "OAIObject.h"
#include "OAIStackScript.h"
#include <QString>
...
class OAIStackScriptsApi : public QObject {
    Q_OBJECT

public:
    OAIStackScriptsApi(const int timeOut = 0);
    ~OAIStackScriptsApi();
    ...
    /**
    * @param[in]  oai_stack_script OAIStackScript [required]
    */
    virtual void addStackScript(const OAIStackScript &oai_stack_script);

    /**
    * @param[in]  stackscript_id QString [required]
    */
    virtual void deleteStackScript(const QString &stackscript_id);

    /**
    * @param[in]  stackscript_id QString [required]
    */
    virtual void getStackScript(const QString &stackscript_id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getStackScripts(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  stackscript_id QString [required]
    * @param[in]  oai_stack_script OAIStackScript [optional]
    */
    virtual void updateStackScript(const QString &stackscript_id, const ::OpenAPI::OptionalParam<OAIStackScript> &oai_stack_script = ::OpenAPI::OptionalParam<OAIStackScript>());
...
private:
    ...
    void addStackScriptCallback(OAIHttpRequestWorker *worker);
    void deleteStackScriptCallback(OAIHttpRequestWorker *worker);
    void getStackScriptCallback(OAIHttpRequestWorker *worker);
    void getStackScriptsCallback(OAIHttpRequestWorker *worker);
    void updateStackScriptCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void addStackScriptSignal(OAIStackScript summary);
    void deleteStackScriptSignal(OAIObject summary);
    void getStackScriptSignal(OAIStackScript summary);
    void getStackScriptsSignal(OAIGetStackScripts_200_response summary);
    void updateStackScriptSignal(OAIStackScript summary);


    void addStackScriptSignalFull(OAIHttpRequestWorker *worker, OAIStackScript summary);
    void deleteStackScriptSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getStackScriptSignalFull(OAIHttpRequestWorker *worker, OAIStackScript summary);
    void getStackScriptsSignalFull(OAIHttpRequestWorker *worker, OAIGetStackScripts_200_response summary);
    void updateStackScriptSignalFull(OAIHttpRequestWorker *worker, OAIStackScript summary);

    Q_DECL_DEPRECATED_X("Use addStackScriptSignalError() instead")
    void addStackScriptSignalE(OAIStackScript summary, QNetworkReply::NetworkError error_type, QString error_str);
    void addStackScriptSignalError(OAIStackScript summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteStackScriptSignalError() instead")
    void deleteStackScriptSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteStackScriptSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStackScriptSignalError() instead")
    void getStackScriptSignalE(OAIStackScript summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStackScriptSignalError(OAIStackScript summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStackScriptsSignalError() instead")
    void getStackScriptsSignalE(OAIGetStackScripts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStackScriptsSignalError(OAIGetStackScripts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateStackScriptSignalError() instead")
    void updateStackScriptSignalE(OAIStackScript summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateStackScriptSignalError(OAIStackScript summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use addStackScriptSignalErrorFull() instead")
    void addStackScriptSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void addStackScriptSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteStackScriptSignalErrorFull() instead")
    void deleteStackScriptSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteStackScriptSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStackScriptSignalErrorFull() instead")
    void getStackScriptSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getStackScriptSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStackScriptsSignalErrorFull() instead")
    void getStackScriptsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getStackScriptsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateStackScriptSignalErrorFull() instead")
    void updateStackScriptSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateStackScriptSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
