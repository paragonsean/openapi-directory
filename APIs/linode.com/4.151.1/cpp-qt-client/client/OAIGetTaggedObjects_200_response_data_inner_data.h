...
/*
 * OAIGetTaggedObjects_200_response_data_inner_data.h
 *
 * 
 */

#ifndef OAIGetTaggedObjects_200_response_data_inner_data_H
#define OAIGetTaggedObjects_200_response_data_inner_data_H
...
class OAINodeBalancer_transfer;

class OAIGetTaggedObjects_200_response_data_inner_data : public OAIObject {
public:
    OAIGetTaggedObjects_200_response_data_inner_data();
    OAIGetTaggedObjects_200_response_data_inner_data(QString json);
    ~OAIGetTaggedObjects_200_response_data_inner_data() override;
    ...
    QList<QString> getAxfrIps() const;
    void setAxfrIps(const QList<QString> &axfr_ips);
    bool is_axfr_ips_Set() const;
    bool is_axfr_ips_Valid() const;
    ...
    qint32 getExpireSec() const;
    void setExpireSec(const qint32 &expire_sec);
    bool is_expire_sec_Set() const;
    bool is_expire_sec_Valid() const;

    QList<QString> getMasterIps() const;
    void setMasterIps(const QList<QString> &master_ips);
    bool is_master_ips_Set() const;
    bool is_master_ips_Valid() const;

    qint32 getRefreshSec() const;
    void setRefreshSec(const qint32 &refresh_sec);
    bool is_refresh_sec_Set() const;
    bool is_refresh_sec_Valid() const;

    qint32 getRetrySec() const;
    void setRetrySec(const qint32 &retry_sec);
    bool is_retry_sec_Set() const;
    bool is_retry_sec_Valid() const;

    QString getSoaEmail() const;
    void setSoaEmail(const QString &soa_email);
    bool is_soa_email_Set() const;
    bool is_soa_email_Valid() const;
    ...
    qint32 getClientConnThrottle() const;
    void setClientConnThrottle(const qint32 &client_conn_throttle);
    bool is_client_conn_throttle_Set() const;
    bool is_client_conn_throttle_Valid() const;
    ...
    OAINodeBalancer_transfer getTransfer() const;
    void setTransfer(const OAINodeBalancer_transfer &transfer);
...
private:
    ...
    QList<QString> m_axfr_ips;
    bool m_axfr_ips_isSet;
    bool m_axfr_ips_isValid;
    ...
    qint32 m_expire_sec;
    bool m_expire_sec_isSet;
    bool m_expire_sec_isValid;

    QList<QString> m_master_ips;
    bool m_master_ips_isSet;
    bool m_master_ips_isValid;

    qint32 m_refresh_sec;
    bool m_refresh_sec_isSet;
    bool m_refresh_sec_isValid;

    qint32 m_retry_sec;
    bool m_retry_sec_isSet;
    bool m_retry_sec_isValid;

    QString m_soa_email;
    bool m_soa_email_isSet;
    bool m_soa_email_isValid;
    ...
    qint32 m_client_conn_throttle;
    bool m_client_conn_throttle_isSet;
    bool m_client_conn_throttle_isValid;

    QString m_hostname;
    bool m_hostname_isSet;
    bool m_hostname_isValid;

    OAINodeBalancer_transfer m_transfer;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTaggedObjects_200_response_data_inner_data)

#endif // OAIGetTaggedObjects_200_response_data_inner_data_H
