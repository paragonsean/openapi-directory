...
OAIBackup_disks_inner::OAIBackup_disks_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackup_disks_inner::OAIBackup_disks_inner() {
    this->initializeModel();
}

OAIBackup_disks_inner::~OAIBackup_disks_inner() {}

void OAIBackup_disks_inner::initializeModel() {
...
void OAIBackup_disks_inner::fromJson(QString jsonString) {
...
void OAIBackup_disks_inner::fromJsonObject(QJsonObject json) {
...
QString OAIBackup_disks_inner::asJson() const {
...
QJsonObject OAIBackup_disks_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBackup_disks_inner::getFilesystem() const {
    return m_filesystem;
}
void OAIBackup_disks_inner::setFilesystem(const QString &filesystem) {
    m_filesystem = filesystem;
    m_filesystem_isSet = true;
}

bool OAIBackup_disks_inner::is_filesystem_Set() const{
    return m_filesystem_isSet;
}

bool OAIBackup_disks_inner::is_filesystem_Valid() const{
    return m_filesystem_isValid;
}

QString OAIBackup_disks_inner::getLabel() const {
    return m_label;
}
void OAIBackup_disks_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIBackup_disks_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIBackup_disks_inner::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIBackup_disks_inner::getSize() const {
    return m_size;
}
void OAIBackup_disks_inner::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIBackup_disks_inner::is_size_Set() const{
    return m_size_isSet;
}

bool OAIBackup_disks_inner::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIBackup_disks_inner::isSet() const {
...
bool OAIBackup_disks_inner::isValid() const {
