...
#include "OAIGetLinodeIPs_200_response_ipv4.h"
...
OAIGetLinodeIPs_200_response_ipv4::OAIGetLinodeIPs_200_response_ipv4(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinodeIPs_200_response_ipv4::OAIGetLinodeIPs_200_response_ipv4() {
    this->initializeModel();
}

OAIGetLinodeIPs_200_response_ipv4::~OAIGetLinodeIPs_200_response_ipv4() {}

void OAIGetLinodeIPs_200_response_ipv4::initializeModel() {
...
void OAIGetLinodeIPs_200_response_ipv4::fromJson(QString jsonString) {
...
void OAIGetLinodeIPs_200_response_ipv4::fromJsonObject(QJsonObject json) {
...
QString OAIGetLinodeIPs_200_response_ipv4::asJson() const {
...
QJsonObject OAIGetLinodeIPs_200_response_ipv4::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIIPAddressPrivate> OAIGetLinodeIPs_200_response_ipv4::getRPrivate() const {
    return m_r_private;
}
void OAIGetLinodeIPs_200_response_ipv4::setRPrivate(const QList<OAIIPAddressPrivate> &r_private) {
    m_r_private = r_private;
    m_r_private_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_r_private_Set() const{
    return m_r_private_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_r_private_Valid() const{
    return m_r_private_isValid;
}

QList<OAIIPAddress> OAIGetLinodeIPs_200_response_ipv4::getRPublic() const {
    return m_r_public;
}
void OAIGetLinodeIPs_200_response_ipv4::setRPublic(const QList<OAIIPAddress> &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QList<OAIIPAddress> OAIGetLinodeIPs_200_response_ipv4::getReserved() const {
    return m_reserved;
}
void OAIGetLinodeIPs_200_response_ipv4::setReserved(const QList<OAIIPAddress> &reserved) {
    m_reserved = reserved;
    m_reserved_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_reserved_Set() const{
    return m_reserved_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_reserved_Valid() const{
    return m_reserved_isValid;
}

QList<OAIIPAddress> OAIGetLinodeIPs_200_response_ipv4::getShared() const {
    return m_shared;
}
void OAIGetLinodeIPs_200_response_ipv4::setShared(const QList<OAIIPAddress> &shared) {
    m_shared = shared;
    m_shared_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_shared_Set() const{
    return m_shared_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv4::is_shared_Valid() const{
    return m_shared_isValid;
}

bool OAIGetLinodeIPs_200_response_ipv4::isSet() const {
...
bool OAIGetLinodeIPs_200_response_ipv4::isValid() const {
