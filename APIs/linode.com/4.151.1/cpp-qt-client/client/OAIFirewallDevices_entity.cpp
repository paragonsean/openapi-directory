...
OAIFirewallDevices_entity::OAIFirewallDevices_entity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallDevices_entity::OAIFirewallDevices_entity() {
    this->initializeModel();
}

OAIFirewallDevices_entity::~OAIFirewallDevices_entity() {}

void OAIFirewallDevices_entity::initializeModel() {
...
void OAIFirewallDevices_entity::fromJson(QString jsonString) {
...
void OAIFirewallDevices_entity::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallDevices_entity::asJson() const {
...
QJsonObject OAIFirewallDevices_entity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIFirewallDevices_entity::getId() const {
    return m_id;
}
void OAIFirewallDevices_entity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFirewallDevices_entity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFirewallDevices_entity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFirewallDevices_entity::getLabel() const {
    return m_label;
}
void OAIFirewallDevices_entity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIFirewallDevices_entity::is_label_Set() const{
    return m_label_isSet;
}

bool OAIFirewallDevices_entity::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIFirewallDevices_entity::getType() const {
    return m_type;
}
void OAIFirewallDevices_entity::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFirewallDevices_entity::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFirewallDevices_entity::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIFirewallDevices_entity::getUrl() const {
    return m_url;
}
void OAIFirewallDevices_entity::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIFirewallDevices_entity::is_url_Set() const{
    return m_url_isSet;
}

bool OAIFirewallDevices_entity::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIFirewallDevices_entity::isSet() const {
...
bool OAIFirewallDevices_entity::isValid() const {
