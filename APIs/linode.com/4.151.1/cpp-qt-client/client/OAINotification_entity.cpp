...
#include "OAINotification_entity.h"
...
OAINotification_entity::OAINotification_entity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotification_entity::OAINotification_entity() {
    this->initializeModel();
}

OAINotification_entity::~OAINotification_entity() {}

void OAINotification_entity::initializeModel() {
...
void OAINotification_entity::fromJson(QString jsonString) {
...
void OAINotification_entity::fromJsonObject(QJsonObject json) {
...
QString OAINotification_entity::asJson() const {
...
QJsonObject OAINotification_entity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAINotification_entity::getId() const {
    return m_id;
}
void OAINotification_entity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINotification_entity::is_id_Set() const{
    return m_id_isSet;
}

bool OAINotification_entity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINotification_entity::getLabel() const {
    return m_label;
}
void OAINotification_entity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAINotification_entity::is_label_Set() const{
    return m_label_isSet;
}

bool OAINotification_entity::is_label_Valid() const{
    return m_label_isValid;
}

QString OAINotification_entity::getType() const {
    return m_type;
}
void OAINotification_entity::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINotification_entity::is_type_Set() const{
    return m_type_isSet;
}

bool OAINotification_entity::is_type_Valid() const{
    return m_type_isValid;
}

QString OAINotification_entity::getUrl() const {
    return m_url;
}
void OAINotification_entity::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAINotification_entity::is_url_Set() const{
    return m_url_isSet;
}

bool OAINotification_entity::is_url_Valid() const{
    return m_url_isValid;
}

bool OAINotification_entity::isSet() const {
...
bool OAINotification_entity::isValid() const {
