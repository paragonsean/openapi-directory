...
OAILongviewClient::OAILongviewClient(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILongviewClient::OAILongviewClient() {
    this->initializeModel();
}

OAILongviewClient::~OAILongviewClient() {}

void OAILongviewClient::initializeModel() {
    ...
    m_install_code_isSet = false;
    m_install_code_isValid = false;
...
void OAILongviewClient::fromJson(QString jsonString) {
...
void OAILongviewClient::fromJsonObject(QJsonObject json) {
    ...
    m_install_code_isValid = ::OpenAPI::fromJsonValue(m_install_code, json[QString("install_code")]);
    m_install_code_isSet = !json[QString("install_code")].isNull() && m_install_code_isValid;
...
QString OAILongviewClient::asJson() const {
...
QJsonObject OAILongviewClient::asJsonObject() const {
    QJsonObject obj;
    if (m_api_key_isSet) {
    ...
    if (m_install_code_isSet) {
        obj.insert(QString("install_code"), ::OpenAPI::toJsonValue(m_install_code));
    }
    if (m_label_isSet) {
...
QString OAILongviewClient::getApiKey() const {
    return m_api_key;
}
void OAILongviewClient::setApiKey(const QString &api_key) {
    m_api_key = api_key;
    m_api_key_isSet = true;
}

bool OAILongviewClient::is_api_key_Set() const{
    return m_api_key_isSet;
}

bool OAILongviewClient::is_api_key_Valid() const{
    return m_api_key_isValid;
}

OAILongviewClient_apps OAILongviewClient::getApps() const {
    return m_apps;
}
void OAILongviewClient::setApps(const OAILongviewClient_apps &apps) {
    m_apps = apps;
    m_apps_isSet = true;
}

bool OAILongviewClient::is_apps_Set() const{
    return m_apps_isSet;
}

bool OAILongviewClient::is_apps_Valid() const{
    return m_apps_isValid;
}

QDateTime OAILongviewClient::getCreated() const {
    return m_created;
}
void OAILongviewClient::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAILongviewClient::is_created_Set() const{
    return m_created_isSet;
}

bool OAILongviewClient::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAILongviewClient::getId() const {
    return m_id;
}
void OAILongviewClient::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILongviewClient::is_id_Set() const{
    return m_id_isSet;
}

bool OAILongviewClient::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILongviewClient::getInstallCode() const {
    return m_install_code;
}
void OAILongviewClient::setInstallCode(const QString &install_code) {
    m_install_code = install_code;
    m_install_code_isSet = true;
}

bool OAILongviewClient::is_install_code_Set() const{
    return m_install_code_isSet;
}

bool OAILongviewClient::is_install_code_Valid() const{
    return m_install_code_isValid;
}

QString OAILongviewClient::getLabel() const {
    return m_label;
}
void OAILongviewClient::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILongviewClient::is_label_Set() const{
    return m_label_isSet;
}

bool OAILongviewClient::is_label_Valid() const{
    return m_label_isValid;
}

QDateTime OAILongviewClient::getUpdated() const {
    return m_updated;
}
void OAILongviewClient::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAILongviewClient::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAILongviewClient::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAILongviewClient::isSet() const {
...
bool OAILongviewClient::isValid() const {
