...
OAIDatabaseEngine::OAIDatabaseEngine(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseEngine::OAIDatabaseEngine() {
    this->initializeModel();
}

OAIDatabaseEngine::~OAIDatabaseEngine() {}

void OAIDatabaseEngine::initializeModel() {
...
void OAIDatabaseEngine::fromJson(QString jsonString) {
...
void OAIDatabaseEngine::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseEngine::asJson() const {
...
QJsonObject OAIDatabaseEngine::asJsonObject() const {
    QJsonObject obj;
    if (m_engine_isSet) {
...
QString OAIDatabaseEngine::getEngine() const {
    return m_engine;
}
void OAIDatabaseEngine::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseEngine::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseEngine::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIDatabaseEngine::getId() const {
    return m_id;
}
void OAIDatabaseEngine::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseEngine::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseEngine::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseEngine::getVersion() const {
    return m_version;
}
void OAIDatabaseEngine::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDatabaseEngine::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDatabaseEngine::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIDatabaseEngine::isSet() const {
...
bool OAIDatabaseEngine::isValid() const {
