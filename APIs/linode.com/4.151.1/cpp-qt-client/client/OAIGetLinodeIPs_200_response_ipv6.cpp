...
#include "OAIGetLinodeIPs_200_response_ipv6.h"
...
OAIGetLinodeIPs_200_response_ipv6::OAIGetLinodeIPs_200_response_ipv6(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinodeIPs_200_response_ipv6::OAIGetLinodeIPs_200_response_ipv6() {
    this->initializeModel();
}

OAIGetLinodeIPs_200_response_ipv6::~OAIGetLinodeIPs_200_response_ipv6() {}

void OAIGetLinodeIPs_200_response_ipv6::initializeModel() {

    m_global_isSet = false;
    m_global_isValid = false;

    m_link_local_isSet = false;
    m_link_local_isValid = false;

    m_slaac_isSet = false;
    m_slaac_isValid = false;
}

void OAIGetLinodeIPs_200_response_ipv6::fromJson(QString jsonString) {
...
void OAIGetLinodeIPs_200_response_ipv6::fromJsonObject(QJsonObject json) {
    ...
    m_link_local_isValid = ::OpenAPI::fromJsonValue(m_link_local, json[QString("link_local")]);
    m_link_local_isSet = !json[QString("link_local")].isNull() && m_link_local_isValid;

    m_slaac_isValid = ::OpenAPI::fromJsonValue(m_slaac, json[QString("slaac")]);
    m_slaac_isSet = !json[QString("slaac")].isNull() && m_slaac_isValid;
}

QString OAIGetLinodeIPs_200_response_ipv6::asJson() const {
...
QJsonObject OAIGetLinodeIPs_200_response_ipv6::asJsonObject() const {
    QJsonObject obj;
    if (m_global.isSet()) {
        obj.insert(QString("global"), ::OpenAPI::toJsonValue(m_global));
    }
    if (m_link_local.isSet()) {
        obj.insert(QString("link_local"), ::OpenAPI::toJsonValue(m_link_local));
    }
    if (m_slaac.isSet()) {
        obj.insert(QString("slaac"), ::OpenAPI::toJsonValue(m_slaac));
    }
    return obj;
}

OAIIPv6Pool OAIGetLinodeIPs_200_response_ipv6::getGlobal() const {
    return m_global;
}
void OAIGetLinodeIPs_200_response_ipv6::setGlobal(const OAIIPv6Pool &global) {
    m_global = global;
    m_global_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_global_Set() const{
    return m_global_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_global_Valid() const{
    return m_global_isValid;
}

OAIIPAddressV6LinkLocal OAIGetLinodeIPs_200_response_ipv6::getLinkLocal() const {
    return m_link_local;
}
void OAIGetLinodeIPs_200_response_ipv6::setLinkLocal(const OAIIPAddressV6LinkLocal &link_local) {
    m_link_local = link_local;
    m_link_local_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_link_local_Set() const{
    return m_link_local_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_link_local_Valid() const{
    return m_link_local_isValid;
}

OAIIPAddressV6Slaac OAIGetLinodeIPs_200_response_ipv6::getSlaac() const {
    return m_slaac;
}
void OAIGetLinodeIPs_200_response_ipv6::setSlaac(const OAIIPAddressV6Slaac &slaac) {
    m_slaac = slaac;
    m_slaac_isSet = true;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_slaac_Set() const{
    return m_slaac_isSet;
}

bool OAIGetLinodeIPs_200_response_ipv6::is_slaac_Valid() const{
    return m_slaac_isValid;
}

bool OAIGetLinodeIPs_200_response_ipv6::isSet() const {
...
bool OAIGetLinodeIPs_200_response_ipv6::isValid() const {
