...
#include "OAIDatabaseMongoDBRequest.h"
...
OAIDatabaseMongoDBRequest::OAIDatabaseMongoDBRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseMongoDBRequest::OAIDatabaseMongoDBRequest() {
    this->initializeModel();
}

OAIDatabaseMongoDBRequest::~OAIDatabaseMongoDBRequest() {}

void OAIDatabaseMongoDBRequest::initializeModel() {
...
void OAIDatabaseMongoDBRequest::fromJson(QString jsonString) {
...
void OAIDatabaseMongoDBRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseMongoDBRequest::asJson() const {
...
QJsonObject OAIDatabaseMongoDBRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDatabaseMongoDBRequest::getAllowList() const {
    return m_allow_list;
}
void OAIDatabaseMongoDBRequest::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabaseMongoDBRequest::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabaseMongoDBRequest::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabaseMongoDBRequest::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabaseMongoDBRequest::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

QString OAIDatabaseMongoDBRequest::getCompressionType() const {
    return m_compression_type;
}
void OAIDatabaseMongoDBRequest::setCompressionType(const QString &compression_type) {
    m_compression_type = compression_type;
    m_compression_type_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_compression_type_Set() const{
    return m_compression_type_isSet;
}

bool OAIDatabaseMongoDBRequest::is_compression_type_Valid() const{
    return m_compression_type_isValid;
}

bool OAIDatabaseMongoDBRequest::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabaseMongoDBRequest::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabaseMongoDBRequest::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabaseMongoDBRequest::getEngine() const {
    return m_engine;
}
void OAIDatabaseMongoDBRequest::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseMongoDBRequest::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIDatabaseMongoDBRequest::getLabel() const {
    return m_label;
}
void OAIDatabaseMongoDBRequest::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseMongoDBRequest::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDatabaseMongoDBRequest::getRegion() const {
    return m_region;
}
void OAIDatabaseMongoDBRequest::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabaseMongoDBRequest::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabaseMongoDBRequest::getReplicaSet() const {
    return m_replica_set;
}
void OAIDatabaseMongoDBRequest::setReplicaSet(const QString &replica_set) {
    m_replica_set = replica_set;
    m_replica_set_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_replica_set_Set() const{
    return m_replica_set_isSet;
}

bool OAIDatabaseMongoDBRequest::is_replica_set_Valid() const{
    return m_replica_set_isValid;
}

bool OAIDatabaseMongoDBRequest::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabaseMongoDBRequest::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabaseMongoDBRequest::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabaseMongoDBRequest::getStorageEngine() const {
    return m_storage_engine;
}
void OAIDatabaseMongoDBRequest::setStorageEngine(const QString &storage_engine) {
    m_storage_engine = storage_engine;
    m_storage_engine_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_storage_engine_Set() const{
    return m_storage_engine_isSet;
}

bool OAIDatabaseMongoDBRequest::is_storage_engine_Valid() const{
    return m_storage_engine_isValid;
}

QString OAIDatabaseMongoDBRequest::getType() const {
    return m_type;
}
void OAIDatabaseMongoDBRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseMongoDBRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseMongoDBRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDatabaseMongoDBRequest::isSet() const {
...
bool OAIDatabaseMongoDBRequest::isValid() const {
