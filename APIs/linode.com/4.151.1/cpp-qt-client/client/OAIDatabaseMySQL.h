...
#ifndef OAIDatabaseMySQL_H
#define OAIDatabaseMySQL_H
...
class OAIDatabaseMySQL : public OAIObject {
public:
    OAIDatabaseMySQL();
    OAIDatabaseMySQL(QString json);
    ~OAIDatabaseMySQL() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseMySQL)

#endif // OAIDatabaseMySQL_H
