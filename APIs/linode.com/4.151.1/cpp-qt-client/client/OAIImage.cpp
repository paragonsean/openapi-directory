...
bool OAIImage::isDeprecated() const {
    return m_deprecated;
}
void OAIImage::setDeprecated(const bool &deprecated) {
    m_deprecated = deprecated;
    m_deprecated_isSet = true;
}

bool OAIImage::is_deprecated_Set() const{
    return m_deprecated_isSet;
}

bool OAIImage::is_deprecated_Valid() const{
...
QDateTime OAIImage::getEol() const {
    return m_eol;
}
void OAIImage::setEol(const QDateTime &eol) {
    m_eol = eol;
    m_eol_isSet = true;
}

bool OAIImage::is_eol_Set() const{
    return m_eol_isSet;
}

bool OAIImage::is_eol_Valid() const{
    return m_eol_isValid;
}

QDateTime OAIImage::getExpiry() const {
    return m_expiry;
}
void OAIImage::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIImage::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIImage::is_expiry_Valid() const{
...
bool OAIImage::isIsPublic() const {
    return m_is_public;
}
void OAIImage::setIsPublic(const bool &is_public) {
    m_is_public = is_public;
    m_is_public_isSet = true;
}

bool OAIImage::is_is_public_Set() const{
    return m_is_public_isSet;
}

bool OAIImage::is_is_public_Valid() const{
...
QDateTime OAIImage::getUpdated() const {
    return m_updated;
}
void OAIImage::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIImage::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIImage::is_updated_Valid() const{
    return m_updated_isValid;
}

QString OAIImage::getVendor() const {
    return m_vendor;
}
void OAIImage::setVendor(const QString &vendor) {
    m_vendor = vendor;
    m_vendor_isSet = true;
}

bool OAIImage::is_vendor_Set() const{
    return m_vendor_isSet;
}

bool OAIImage::is_vendor_Valid() const{
