...
OAILinode_specs::OAILinode_specs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILinode_specs::OAILinode_specs() {
    this->initializeModel();
}

OAILinode_specs::~OAILinode_specs() {}

void OAILinode_specs::initializeModel() {
...
void OAILinode_specs::fromJson(QString jsonString) {
...
void OAILinode_specs::fromJsonObject(QJsonObject json) {
...
QString OAILinode_specs::asJson() const {
...
QJsonObject OAILinode_specs::asJsonObject() const {
    QJsonObject obj;
    if (m_disk_isSet) {
...
qint32 OAILinode_specs::getDisk() const {
    return m_disk;
}
void OAILinode_specs::setDisk(const qint32 &disk) {
    m_disk = disk;
    m_disk_isSet = true;
}

bool OAILinode_specs::is_disk_Set() const{
    return m_disk_isSet;
}

bool OAILinode_specs::is_disk_Valid() const{
    return m_disk_isValid;
}

qint32 OAILinode_specs::getGpus() const {
    return m_gpus;
}
void OAILinode_specs::setGpus(const qint32 &gpus) {
    m_gpus = gpus;
    m_gpus_isSet = true;
}

bool OAILinode_specs::is_gpus_Set() const{
    return m_gpus_isSet;
}

bool OAILinode_specs::is_gpus_Valid() const{
    return m_gpus_isValid;
}

qint32 OAILinode_specs::getMemory() const {
    return m_memory;
}
void OAILinode_specs::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAILinode_specs::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAILinode_specs::is_memory_Valid() const{
    return m_memory_isValid;
}

qint32 OAILinode_specs::getTransfer() const {
    return m_transfer;
}
void OAILinode_specs::setTransfer(const qint32 &transfer) {
    m_transfer = transfer;
    m_transfer_isSet = true;
}

bool OAILinode_specs::is_transfer_Set() const{
    return m_transfer_isSet;
}

bool OAILinode_specs::is_transfer_Valid() const{
    return m_transfer_isValid;
}

qint32 OAILinode_specs::getVcpus() const {
    return m_vcpus;
}
void OAILinode_specs::setVcpus(const qint32 &vcpus) {
    m_vcpus = vcpus;
    m_vcpus_isSet = true;
}

bool OAILinode_specs::is_vcpus_Set() const{
    return m_vcpus_isSet;
}

bool OAILinode_specs::is_vcpus_Valid() const{
    return m_vcpus_isValid;
}

bool OAILinode_specs::isSet() const {
...
bool OAILinode_specs::isValid() const {
