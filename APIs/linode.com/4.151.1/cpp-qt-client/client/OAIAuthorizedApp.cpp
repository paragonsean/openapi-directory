...
OAIAuthorizedApp::OAIAuthorizedApp(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthorizedApp::OAIAuthorizedApp() {
    this->initializeModel();
}

OAIAuthorizedApp::~OAIAuthorizedApp() {}

void OAIAuthorizedApp::initializeModel() {
...
void OAIAuthorizedApp::fromJson(QString jsonString) {
...
void OAIAuthorizedApp::fromJsonObject(QJsonObject json) {
...
QString OAIAuthorizedApp::asJson() const {
...
QJsonObject OAIAuthorizedApp::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIAuthorizedApp::getCreated() const {
    return m_created;
}
void OAIAuthorizedApp::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIAuthorizedApp::is_created_Set() const{
    return m_created_isSet;
}

bool OAIAuthorizedApp::is_created_Valid() const{
    return m_created_isValid;
}

QDateTime OAIAuthorizedApp::getExpiry() const {
    return m_expiry;
}
void OAIAuthorizedApp::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIAuthorizedApp::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIAuthorizedApp::is_expiry_Valid() const{
    return m_expiry_isValid;
}

qint32 OAIAuthorizedApp::getId() const {
    return m_id;
}
void OAIAuthorizedApp::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAuthorizedApp::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAuthorizedApp::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAuthorizedApp::getLabel() const {
    return m_label;
}
void OAIAuthorizedApp::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIAuthorizedApp::is_label_Set() const{
    return m_label_isSet;
}

bool OAIAuthorizedApp::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIAuthorizedApp::getScopes() const {
    return m_scopes;
}
void OAIAuthorizedApp::setScopes(const QString &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIAuthorizedApp::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIAuthorizedApp::is_scopes_Valid() const{
    return m_scopes_isValid;
}

QString OAIAuthorizedApp::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIAuthorizedApp::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIAuthorizedApp::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIAuthorizedApp::is_thumbnail_url_Valid() const{
    return m_thumbnail_url_isValid;
}

QString OAIAuthorizedApp::getWebsite() const {
    return m_website;
}
void OAIAuthorizedApp::setWebsite(const QString &website) {
    m_website = website;
    m_website_isSet = true;
}

bool OAIAuthorizedApp::is_website_Set() const{
    return m_website_isSet;
}

bool OAIAuthorizedApp::is_website_Valid() const{
    return m_website_isValid;
}

bool OAIAuthorizedApp::isSet() const {
...
bool OAIAuthorizedApp::isValid() const {
