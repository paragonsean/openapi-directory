...
OAIPutLKECluster_request::OAIPutLKECluster_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutLKECluster_request::OAIPutLKECluster_request() {
    this->initializeModel();
}

OAIPutLKECluster_request::~OAIPutLKECluster_request() {}

void OAIPutLKECluster_request::initializeModel() {
...
void OAIPutLKECluster_request::fromJson(QString jsonString) {
...
void OAIPutLKECluster_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutLKECluster_request::asJson() const {
...
QJsonObject OAIPutLKECluster_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPutLKECluster_request_control_plane OAIPutLKECluster_request::getControlPlane() const {
    return m_control_plane;
}
void OAIPutLKECluster_request::setControlPlane(const OAIPutLKECluster_request_control_plane &control_plane) {
    m_control_plane = control_plane;
    m_control_plane_isSet = true;
}

bool OAIPutLKECluster_request::is_control_plane_Set() const{
    return m_control_plane_isSet;
}

bool OAIPutLKECluster_request::is_control_plane_Valid() const{
    return m_control_plane_isValid;
}

QString OAIPutLKECluster_request::getK8sVersion() const {
    return m_k8s_version;
}
void OAIPutLKECluster_request::setK8sVersion(const QString &k8s_version) {
    m_k8s_version = k8s_version;
    m_k8s_version_isSet = true;
}

bool OAIPutLKECluster_request::is_k8s_version_Set() const{
    return m_k8s_version_isSet;
}

bool OAIPutLKECluster_request::is_k8s_version_Valid() const{
    return m_k8s_version_isValid;
}

QString OAIPutLKECluster_request::getLabel() const {
    return m_label;
}
void OAIPutLKECluster_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPutLKECluster_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPutLKECluster_request::is_label_Valid() const{
    return m_label_isValid;
}

QList<QString> OAIPutLKECluster_request::getTags() const {
    return m_tags;
}
void OAIPutLKECluster_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPutLKECluster_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPutLKECluster_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIPutLKECluster_request::isSet() const {
...
bool OAIPutLKECluster_request::isValid() const {
