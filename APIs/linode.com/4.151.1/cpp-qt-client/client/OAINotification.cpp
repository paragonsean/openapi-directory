...
OAINotification_entity OAINotification::getEntity() const {
    return m_entity;
}
void OAINotification::setEntity(const OAINotification_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAINotification::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAINotification::is_entity_Valid() const{
    return m_entity_isValid;
}

QString OAINotification::getLabel() const {
    return m_label;
}
void OAINotification::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAINotification::is_label_Set() const{
    return m_label_isSet;
}

bool OAINotification::is_label_Valid() const{
...
QString OAINotification::getSeverity() const {
    return m_severity;
}
void OAINotification::setSeverity(const QString &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAINotification::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAINotification::is_severity_Valid() const{
...
QDateTime OAINotification::getUntil() const {
    return m_until;
}
void OAINotification::setUntil(const QDateTime &until) {
    m_until = until;
    m_until_isSet = true;
}

bool OAINotification::is_until_Set() const{
    return m_until_isSet;
}

bool OAINotification::is_until_Valid() const{
    return m_until_isValid;
}

QDateTime OAINotification::getWhen() const {
    return m_when;
}
void OAINotification::setWhen(const QDateTime &when) {
    m_when = when;
    m_when_isSet = true;
}

bool OAINotification::is_when_Set() const{
    return m_when_isSet;
}

bool OAINotification::is_when_Valid() const{
