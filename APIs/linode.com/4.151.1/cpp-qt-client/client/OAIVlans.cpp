...
OAIVlans::OAIVlans(QString json) {
...
void OAIVlans::fromJson(QString jsonString) {
...
void OAIVlans::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIVlans::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIVlans::getCreated() const {
    return m_created;
}
void OAIVlans::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIVlans::is_created_Set() const{
    return m_created_isSet;
}

bool OAIVlans::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIVlans::getLabel() const {
    return m_label;
}
void OAIVlans::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIVlans::is_label_Set() const{
    return m_label_isSet;
}

bool OAIVlans::is_label_Valid() const{
    return m_label_isValid;
}

QList<qint32> OAIVlans::getLinodes() const {
    return m_linodes;
}
void OAIVlans::setLinodes(const QList<qint32> &linodes) {
    m_linodes = linodes;
    m_linodes_isSet = true;
}

bool OAIVlans::is_linodes_Set() const{
    return m_linodes_isSet;
}

bool OAIVlans::is_linodes_Valid() const{
    return m_linodes_isValid;
}

QString OAIVlans::getRegion() const {
    return m_region;
}
void OAIVlans::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIVlans::is_region_Set() const{
    return m_region_isSet;
}

bool OAIVlans::is_region_Valid() const{
    return m_region_isValid;
}

bool OAIVlans::isSet() const {
