...
#include "OAICloneDomain_request.h"
#include "OAIDomain.h"
#include "OAIDomainRecord.h"
#include "OAIGetAccount_default_response.h"
#include "OAIGetDomainRecords_200_response.h"
#include "OAIGetDomainZone_200_response.h"
#include "OAIGetDomains_200_response.h"
#include "OAIImportDomain_request.h"
#include "OAIObject.h"
#include "OAIUpdateDomainRecord_request.h"
#include <QString>
...
public:
    ...
    * @param[in]  oai_clone_domain_request OAICloneDomain_request [required]
    */
    virtual void cloneDomain(const QString &domain_id, const OAICloneDomain_request &oai_clone_domain_request);

    /**
    * @param[in]  oai_domain OAIDomain [required]
    */
    virtual void createDomain(const OAIDomain &oai_domain);

    /**
    * @param[in]  domain_id qint32 [required]
    * @param[in]  oai_domain_record OAIDomainRecord [required]
    */
    virtual void createDomainRecord(const qint32 &domain_id, const OAIDomainRecord &oai_domain_record);

    /**
    * @param[in]  domain_id qint32 [required]
    */
    virtual void deleteDomain(const qint32 &domain_id);

    /**
    * @param[in]  domain_id qint32 [required]
    * @param[in]  record_id qint32 [required]
    */
    virtual void deleteDomainRecord(const qint32 &domain_id, const qint32 &record_id);

    /**
    * @param[in]  domain_id qint32 [required]
    */
    virtual void getDomain(const qint32 &domain_id);

    /**
    * @param[in]  domain_id qint32 [required]
    * @param[in]  record_id qint32 [required]
    */
    virtual void getDomainRecord(const qint32 &domain_id, const qint32 &record_id);
    ...
    */
    virtual void getDomainRecords(const qint32 &domain_id, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  domain_id QString [required]
    */
    virtual void getDomainZone(const QString &domain_id);

    /**
    * @param[in]  page qint32 [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void getDomains(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  oai_import_domain_request OAIImportDomain_request [optional]
    */
    virtual void importDomain(const ::OpenAPI::OptionalParam<OAIImportDomain_request> &oai_import_domain_request = ::OpenAPI::OptionalParam<OAIImportDomain_request>());

    /**
    * @param[in]  domain_id qint32 [required]
    * @param[in]  oai_domain OAIDomain [required]
    */
    virtual void updateDomain(const qint32 &domain_id, const OAIDomain &oai_domain);

    /**
    * @param[in]  domain_id qint32 [required]
    * @param[in]  record_id qint32 [required]
    * @param[in]  oai_update_domain_record_request OAIUpdateDomainRecord_request [required]
    */
    virtual void updateDomainRecord(const qint32 &domain_id, const qint32 &record_id, const OAIUpdateDomainRecord_request &oai_update_domain_record_request);
...
private:
    ...
    void createDomainRecordCallback(OAIHttpRequestWorker *worker);
    void deleteDomainCallback(OAIHttpRequestWorker *worker);
    void deleteDomainRecordCallback(OAIHttpRequestWorker *worker);
    void getDomainCallback(OAIHttpRequestWorker *worker);
    void getDomainRecordCallback(OAIHttpRequestWorker *worker);
    void getDomainRecordsCallback(OAIHttpRequestWorker *worker);
    void getDomainZoneCallback(OAIHttpRequestWorker *worker);
    void getDomainsCallback(OAIHttpRequestWorker *worker);
    void importDomainCallback(OAIHttpRequestWorker *worker);
    void updateDomainCallback(OAIHttpRequestWorker *worker);
    void updateDomainRecordCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void cloneDomainSignal(OAIDomain summary);
    void createDomainSignal(OAIDomain summary);
    void createDomainRecordSignal(OAIDomainRecord summary);
    void deleteDomainSignal(OAIObject summary);
    void deleteDomainRecordSignal(OAIObject summary);
    void getDomainSignal(OAIDomain summary);
    void getDomainRecordSignal(OAIDomainRecord summary);
    void getDomainRecordsSignal(OAIGetDomainRecords_200_response summary);
    void getDomainZoneSignal(OAIGetDomainZone_200_response summary);
    void getDomainsSignal(OAIGetDomains_200_response summary);
    void importDomainSignal(OAIDomain summary);
    void updateDomainSignal(OAIDomain summary);
    void updateDomainRecordSignal(OAIDomainRecord summary);


    void cloneDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomain summary);
    void createDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomain summary);
    void createDomainRecordSignalFull(OAIHttpRequestWorker *worker, OAIDomainRecord summary);
    void deleteDomainSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void deleteDomainRecordSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomain summary);
    void getDomainRecordSignalFull(OAIHttpRequestWorker *worker, OAIDomainRecord summary);
    void getDomainRecordsSignalFull(OAIHttpRequestWorker *worker, OAIGetDomainRecords_200_response summary);
    void getDomainZoneSignalFull(OAIHttpRequestWorker *worker, OAIGetDomainZone_200_response summary);
    void getDomainsSignalFull(OAIHttpRequestWorker *worker, OAIGetDomains_200_response summary);
    void importDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomain summary);
    void updateDomainSignalFull(OAIHttpRequestWorker *worker, OAIDomain summary);
    void updateDomainRecordSignalFull(OAIHttpRequestWorker *worker, OAIDomainRecord summary);

    Q_DECL_DEPRECATED_X("Use cloneDomainSignalError() instead")
    void cloneDomainSignalE(OAIDomain summary, QNetworkReply::NetworkError error_type, QString error_str);
    void cloneDomainSignalError(OAIDomain summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createDomainSignalError() instead")
    void createDomainSignalE(OAIDomain summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createDomainSignalError(OAIDomain summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createDomainRecordSignalError() instead")
    void createDomainRecordSignalE(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createDomainRecordSignalError(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteDomainSignalError() instead")
    void deleteDomainSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteDomainSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteDomainRecordSignalError() instead")
    void deleteDomainRecordSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteDomainRecordSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainSignalError() instead")
    void getDomainSignalE(OAIDomain summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainSignalError(OAIDomain summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainRecordSignalError() instead")
    void getDomainRecordSignalE(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainRecordSignalError(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainRecordsSignalError() instead")
    void getDomainRecordsSignalE(OAIGetDomainRecords_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainRecordsSignalError(OAIGetDomainRecords_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainZoneSignalError() instead")
    void getDomainZoneSignalE(OAIGetDomainZone_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainZoneSignalError(OAIGetDomainZone_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainsSignalError() instead")
    void getDomainsSignalE(OAIGetDomains_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainsSignalError(OAIGetDomains_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use importDomainSignalError() instead")
    void importDomainSignalE(OAIDomain summary, QNetworkReply::NetworkError error_type, QString error_str);
    void importDomainSignalError(OAIDomain summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateDomainSignalError() instead")
    void updateDomainSignalE(OAIDomain summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateDomainSignalError(OAIDomain summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateDomainRecordSignalError() instead")
    void updateDomainRecordSignalE(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateDomainRecordSignalError(OAIDomainRecord summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use createDomainRecordSignalErrorFull() instead")
    void createDomainRecordSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createDomainRecordSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deleteDomainRecordSignalErrorFull() instead")
    void deleteDomainRecordSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteDomainRecordSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getDomainRecordSignalErrorFull() instead")
    void getDomainRecordSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainRecordSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainRecordsSignalErrorFull() instead")
    void getDomainRecordsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainRecordsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainZoneSignalErrorFull() instead")
    void getDomainZoneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainZoneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getDomainsSignalErrorFull() instead")
    void getDomainsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getDomainsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use importDomainSignalErrorFull() instead")
    void importDomainSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void importDomainSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use updateDomainRecordSignalErrorFull() instead")
    void updateDomainRecordSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateDomainRecordSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
