...
void OAIImagesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getImages", defaultConf);
    _serverIndices.insert("getImages", 0);
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("imagesUploadPost", serverConf);
    _serverIndices.insert("imagesUploadPost", 0);
    _serverConfigs.insert("updateImage", defaultConf);
    _serverIndices.insert("updateImage", 0);
}
...
void OAIImagesApi::createImage(const ::OpenAPI::OptionalParam<OAICreateImage_request> &oai_create_image_request) {
    QString fullPath = QString(_serverConfigs["createImage"][_serverIndices.value("createImage")].URL()+"/images");
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("images:read_write");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::createImageCallback);
...
void OAIImagesApi::deleteImage(const QString &image_id) {
    QString fullPath = QString(_serverConfigs["deleteImage"][_serverIndices.value("deleteImage")].URL()+"/images/{imageId}");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::deleteImageCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIImagesApi::getImage(const QString &image_id) {
    QString fullPath = QString(_serverConfigs["getImage"][_serverIndices.value("getImage")].URL()+"/images/{imageId}");
...
void OAIImagesApi::getImages(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getImages"][_serverIndices.value("getImages")].URL()+"/images");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::getImagesCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::getImagesCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIImagesApi::getImagesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetImages_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getImagesSignal(output);
        Q_EMIT getImagesSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("images:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getImagesSignalE(output, error_type, error_str);
        Q_EMIT getImagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getImagesSignalError(output, error_type, error_str);
        Q_EMIT getImagesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIImagesApi::imagesUploadPost(const ::OpenAPI::OptionalParam<OAI_images_upload_post_request> &oai_images_upload_post_request) {
    QString fullPath = QString(_serverConfigs["imagesUploadPost"][_serverIndices.value("imagesUploadPost")].URL()+"/images/upload");
    ...
    if (oai_images_upload_post_request.hasValue()){

        
        QByteArray output = oai_images_upload_post_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::imagesUploadPostCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::imagesUploadPostCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIImagesApi::imagesUploadPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAI_images_upload_post_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT imagesUploadPostSignal(output);
        Q_EMIT imagesUploadPostSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("images:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT imagesUploadPostSignalE(output, error_type, error_str);
        Q_EMIT imagesUploadPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT imagesUploadPostSignalError(output, error_type, error_str);
        Q_EMIT imagesUploadPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIImagesApi::updateImage(const QString &image_id, const OAIImage &oai_image) {
    QString fullPath = QString(_serverConfigs["updateImage"][_serverIndices.value("updateImage")].URL()+"/images/{imageId}");
...

    {
        ...
        QByteArray output = oai_image.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::updateImageCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImagesApi::updateImageCallback);
    connect(this, &OAIImagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIImagesApi::updateImageCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateImageSignal(output);
        Q_EMIT updateImageSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("images:read_write");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateImageSignalE(output, error_type, error_str);
        Q_EMIT updateImageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateImageSignalError(output, error_type, error_str);
        Q_EMIT updateImageSignalErrorFull(worker, error_type, error_str);
    }
}
