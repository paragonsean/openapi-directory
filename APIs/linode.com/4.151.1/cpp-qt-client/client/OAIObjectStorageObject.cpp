...
#include "OAIObjectStorageObject.h"
...
OAIObjectStorageObject::OAIObjectStorageObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectStorageObject::OAIObjectStorageObject() {
    this->initializeModel();
}

OAIObjectStorageObject::~OAIObjectStorageObject() {}

void OAIObjectStorageObject::initializeModel() {
...
void OAIObjectStorageObject::fromJson(QString jsonString) {
...
void OAIObjectStorageObject::fromJsonObject(QJsonObject json) {

    m_etag_isValid = ::OpenAPI::fromJsonValue(m_etag, json[QString("etag")]);
    m_etag_isSet = !json[QString("etag")].isNull() && m_etag_isValid;

    m_is_truncated_isValid = ::OpenAPI::fromJsonValue(m_is_truncated, json[QString("is_truncated")]);
    m_is_truncated_isSet = !json[QString("is_truncated")].isNull() && m_is_truncated_isValid;
    ...
    m_next_marker_isValid = ::OpenAPI::fromJsonValue(m_next_marker, json[QString("next_marker")]);
    m_next_marker_isSet = !json[QString("next_marker")].isNull() && m_next_marker_isValid;
...
QString OAIObjectStorageObject::asJson() const {
...
QJsonObject OAIObjectStorageObject::asJsonObject() const {
    QJsonObject obj;
    if (m_etag_isSet) {
        obj.insert(QString("etag"), ::OpenAPI::toJsonValue(m_etag));
    }
    if (m_is_truncated_isSet) {
        obj.insert(QString("is_truncated"), ::OpenAPI::toJsonValue(m_is_truncated));
    }
    ...
    if (m_next_marker_isSet) {
        obj.insert(QString("next_marker"), ::OpenAPI::toJsonValue(m_next_marker));
    }
    if (m_owner_isSet) {
...
QString OAIObjectStorageObject::getEtag() const {
    return m_etag;
}
void OAIObjectStorageObject::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIObjectStorageObject::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIObjectStorageObject::is_etag_Valid() const{
    return m_etag_isValid;
}

bool OAIObjectStorageObject::isIsTruncated() const {
    return m_is_truncated;
}
void OAIObjectStorageObject::setIsTruncated(const bool &is_truncated) {
    m_is_truncated = is_truncated;
    m_is_truncated_isSet = true;
}

bool OAIObjectStorageObject::is_is_truncated_Set() const{
    return m_is_truncated_isSet;
}

bool OAIObjectStorageObject::is_is_truncated_Valid() const{
    return m_is_truncated_isValid;
}

QDateTime OAIObjectStorageObject::getLastModified() const {
    return m_last_modified;
}
void OAIObjectStorageObject::setLastModified(const QDateTime &last_modified) {
    m_last_modified = last_modified;
    m_last_modified_isSet = true;
}

bool OAIObjectStorageObject::is_last_modified_Set() const{
    return m_last_modified_isSet;
}

bool OAIObjectStorageObject::is_last_modified_Valid() const{
    return m_last_modified_isValid;
}

QString OAIObjectStorageObject::getName() const {
    return m_name;
}
void OAIObjectStorageObject::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIObjectStorageObject::is_name_Set() const{
    return m_name_isSet;
}

bool OAIObjectStorageObject::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIObjectStorageObject::getNextMarker() const {
    return m_next_marker;
}
void OAIObjectStorageObject::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIObjectStorageObject::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIObjectStorageObject::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

QString OAIObjectStorageObject::getOwner() const {
    return m_owner;
}
void OAIObjectStorageObject::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIObjectStorageObject::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIObjectStorageObject::is_owner_Valid() const{
    return m_owner_isValid;
}

qint32 OAIObjectStorageObject::getSize() const {
    return m_size;
}
void OAIObjectStorageObject::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIObjectStorageObject::is_size_Set() const{
    return m_size_isSet;
}

bool OAIObjectStorageObject::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIObjectStorageObject::isSet() const {
...
bool OAIObjectStorageObject::isValid() const {
