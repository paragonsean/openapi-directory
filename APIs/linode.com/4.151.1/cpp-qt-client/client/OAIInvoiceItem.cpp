...
double OAIInvoiceItem::getAmount() const {
    return m_amount;
}
void OAIInvoiceItem::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}
...
QDateTime OAIInvoiceItem::getFrom() const {
    return m_from;
}
void OAIInvoiceItem::setFrom(const QDateTime &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIInvoiceItem::is_from_Set() const{
    return m_from_isSet;
}

bool OAIInvoiceItem::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIInvoiceItem::getLabel() const {
    return m_label;
}
void OAIInvoiceItem::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIInvoiceItem::is_label_Set() const{
    return m_label_isSet;
}

bool OAIInvoiceItem::is_label_Valid() const{
...
double OAIInvoiceItem::getTax() const {
    return m_tax;
}
void OAIInvoiceItem::setTax(const double &tax) {
    m_tax = tax;
    m_tax_isSet = true;
}

bool OAIInvoiceItem::is_tax_Set() const{
    return m_tax_isSet;
}

bool OAIInvoiceItem::is_tax_Valid() const{
    return m_tax_isValid;
}

QDateTime OAIInvoiceItem::getTo() const {
    return m_to;
}
void OAIInvoiceItem::setTo(const QDateTime &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIInvoiceItem::is_to_Set() const{
    return m_to_isSet;
}

bool OAIInvoiceItem::is_to_Valid() const{
    return m_to_isValid;
}

double OAIInvoiceItem::getTotal() const {
    return m_total;
}
void OAIInvoiceItem::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIInvoiceItem::is_total_Set() const{
    return m_total_isSet;
}

bool OAIInvoiceItem::is_total_Valid() const{
...
QString OAIInvoiceItem::getUnitPrice() const {
    return m_unit_price;
}
void OAIInvoiceItem::setUnitPrice(const QString &unit_price) {
