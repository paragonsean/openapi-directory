...
QString OAICreditCard::getCardNumber() const {
    return m_card_number;
}
void OAICreditCard::setCardNumber(const QString &card_number) {
    m_card_number = card_number;
    m_card_number_isSet = true;
}

bool OAICreditCard::is_card_number_Set() const{
    return m_card_number_isSet;
}

bool OAICreditCard::is_card_number_Valid() const{
    return m_card_number_isValid;
}

QString OAICreditCard::getCvv() const {
    return m_cvv;
}
void OAICreditCard::setCvv(const QString &cvv) {
    m_cvv = cvv;
    m_cvv_isSet = true;
}

bool OAICreditCard::is_cvv_Set() const{
    return m_cvv_isSet;
}

bool OAICreditCard::is_cvv_Valid() const{
    return m_cvv_isValid;
}

qint32 OAICreditCard::getExpiryMonth() const {
    return m_expiry_month;
}
void OAICreditCard::setExpiryMonth(const qint32 &expiry_month) {
    m_expiry_month = expiry_month;
    m_expiry_month_isSet = true;
}

bool OAICreditCard::is_expiry_month_Set() const{
    return m_expiry_month_isSet;
}

bool OAICreditCard::is_expiry_month_Valid() const{
    return m_expiry_month_isValid;
}

qint32 OAICreditCard::getExpiryYear() const {
    return m_expiry_year;
}
void OAICreditCard::setExpiryYear(const qint32 &expiry_year) {
    m_expiry_year = expiry_year;
    m_expiry_year_isSet = true;
}

bool OAICreditCard::is_expiry_year_Set() const{
    return m_expiry_year_isSet;
}

bool OAICreditCard::is_expiry_year_Valid() const{
...
bool OAICreditCard::isValid() const {
    ...
    return m_card_number_isValid && m_cvv_isValid && m_expiry_month_isValid && m_expiry_year_isValid && true;
}
