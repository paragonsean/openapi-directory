...
public:
    ...
    QString getConsultationGroup() const;
    void setConsultationGroup(const QString &consultation_group);
    bool is_consultation_group_Set() const;
    bool is_consultation_group_Valid() const;
    ...
    QList<qint32> getCredentials() const;
    void setCredentials(const QList<qint32> &credentials);
...
private:
    ...
    QString m_consultation_group;
    bool m_consultation_group_isSet;
    bool m_consultation_group_isValid;

    QDateTime m_created;
    bool m_created_isSet;
    bool m_created_isValid;

    QList<qint32> m_credentials;
