...
#include "OAIGetLongviewSubscriptions_200_response.h"
...
OAIGetLongviewSubscriptions_200_response::OAIGetLongviewSubscriptions_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLongviewSubscriptions_200_response::OAIGetLongviewSubscriptions_200_response() {
    this->initializeModel();
}

OAIGetLongviewSubscriptions_200_response::~OAIGetLongviewSubscriptions_200_response() {}

void OAIGetLongviewSubscriptions_200_response::initializeModel() {
...
void OAIGetLongviewSubscriptions_200_response::fromJson(QString jsonString) {
...
void OAIGetLongviewSubscriptions_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetLongviewSubscriptions_200_response::asJson() const {
...
QJsonObject OAIGetLongviewSubscriptions_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAILongviewSubscription> OAIGetLongviewSubscriptions_200_response::getData() const {
    return m_data;
}
void OAIGetLongviewSubscriptions_200_response::setData(const QList<OAILongviewSubscription> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetLongviewSubscriptions_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetLongviewSubscriptions_200_response::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIGetLongviewSubscriptions_200_response::getPage() const {
    return m_page;
}
void OAIGetLongviewSubscriptions_200_response::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIGetLongviewSubscriptions_200_response::is_page_Set() const{
    return m_page_isSet;
}

bool OAIGetLongviewSubscriptions_200_response::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIGetLongviewSubscriptions_200_response::getPages() const {
    return m_pages;
}
void OAIGetLongviewSubscriptions_200_response::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIGetLongviewSubscriptions_200_response::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIGetLongviewSubscriptions_200_response::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIGetLongviewSubscriptions_200_response::getResults() const {
    return m_results;
}
void OAIGetLongviewSubscriptions_200_response::setResults(const qint32 &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIGetLongviewSubscriptions_200_response::is_results_Set() const{
    return m_results_isSet;
}

bool OAIGetLongviewSubscriptions_200_response::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIGetLongviewSubscriptions_200_response::isSet() const {
...
bool OAIGetLongviewSubscriptions_200_response::isValid() const {
