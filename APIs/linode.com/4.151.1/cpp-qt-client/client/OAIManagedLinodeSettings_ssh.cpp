...
#include "OAIManagedLinodeSettings_ssh.h"
...
OAIManagedLinodeSettings_ssh::OAIManagedLinodeSettings_ssh(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedLinodeSettings_ssh::OAIManagedLinodeSettings_ssh() {
    this->initializeModel();
}

OAIManagedLinodeSettings_ssh::~OAIManagedLinodeSettings_ssh() {}

void OAIManagedLinodeSettings_ssh::initializeModel() {
...
void OAIManagedLinodeSettings_ssh::fromJson(QString jsonString) {
...
void OAIManagedLinodeSettings_ssh::fromJsonObject(QJsonObject json) {
...
QString OAIManagedLinodeSettings_ssh::asJson() const {
...
QJsonObject OAIManagedLinodeSettings_ssh::asJsonObject() const {
    QJsonObject obj;
    if (m_access_isSet) {
...
bool OAIManagedLinodeSettings_ssh::isAccess() const {
    return m_access;
}
void OAIManagedLinodeSettings_ssh::setAccess(const bool &access) {
    m_access = access;
    m_access_isSet = true;
}

bool OAIManagedLinodeSettings_ssh::is_access_Set() const{
    return m_access_isSet;
}

bool OAIManagedLinodeSettings_ssh::is_access_Valid() const{
    return m_access_isValid;
}

QString OAIManagedLinodeSettings_ssh::getIp() const {
    return m_ip;
}
void OAIManagedLinodeSettings_ssh::setIp(const QString &ip) {
    m_ip = ip;
    m_ip_isSet = true;
}

bool OAIManagedLinodeSettings_ssh::is_ip_Set() const{
    return m_ip_isSet;
}

bool OAIManagedLinodeSettings_ssh::is_ip_Valid() const{
    return m_ip_isValid;
}

qint32 OAIManagedLinodeSettings_ssh::getPort() const {
    return m_port;
}
void OAIManagedLinodeSettings_ssh::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIManagedLinodeSettings_ssh::is_port_Set() const{
    return m_port_isSet;
}

bool OAIManagedLinodeSettings_ssh::is_port_Valid() const{
    return m_port_isValid;
}

QString OAIManagedLinodeSettings_ssh::getUser() const {
    return m_user;
}
void OAIManagedLinodeSettings_ssh::setUser(const QString &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIManagedLinodeSettings_ssh::is_user_Set() const{
    return m_user_isSet;
}

bool OAIManagedLinodeSettings_ssh::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIManagedLinodeSettings_ssh::isSet() const {
...
bool OAIManagedLinodeSettings_ssh::isValid() const {
