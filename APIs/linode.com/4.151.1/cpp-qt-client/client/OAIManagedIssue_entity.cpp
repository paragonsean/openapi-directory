...
#include "OAIManagedIssue_entity.h"
...
OAIManagedIssue_entity::OAIManagedIssue_entity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedIssue_entity::OAIManagedIssue_entity() {
    this->initializeModel();
}

OAIManagedIssue_entity::~OAIManagedIssue_entity() {}

void OAIManagedIssue_entity::initializeModel() {
...
void OAIManagedIssue_entity::fromJson(QString jsonString) {
...
void OAIManagedIssue_entity::fromJsonObject(QJsonObject json) {
...
QString OAIManagedIssue_entity::asJson() const {
...
QJsonObject OAIManagedIssue_entity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIManagedIssue_entity::getId() const {
    return m_id;
}
void OAIManagedIssue_entity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagedIssue_entity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagedIssue_entity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagedIssue_entity::getLabel() const {
    return m_label;
}
void OAIManagedIssue_entity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIManagedIssue_entity::is_label_Set() const{
    return m_label_isSet;
}

bool OAIManagedIssue_entity::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIManagedIssue_entity::getType() const {
    return m_type;
}
void OAIManagedIssue_entity::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIManagedIssue_entity::is_type_Set() const{
    return m_type_isSet;
}

bool OAIManagedIssue_entity::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIManagedIssue_entity::getUrl() const {
    return m_url;
}
void OAIManagedIssue_entity::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIManagedIssue_entity::is_url_Set() const{
    return m_url_isSet;
}

bool OAIManagedIssue_entity::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIManagedIssue_entity::isSet() const {
...
bool OAIManagedIssue_entity::isValid() const {
