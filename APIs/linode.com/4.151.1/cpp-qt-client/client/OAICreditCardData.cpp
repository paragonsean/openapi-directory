...
OAICreditCardData::OAICreditCardData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreditCardData::OAICreditCardData() {
    this->initializeModel();
}

OAICreditCardData::~OAICreditCardData() {}

void OAICreditCardData::initializeModel() {
...
void OAICreditCardData::fromJson(QString jsonString) {
...
void OAICreditCardData::fromJsonObject(QJsonObject json) {
...
QString OAICreditCardData::asJson() const {
...
QJsonObject OAICreditCardData::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreditCardData::getCardType() const {
    return m_card_type;
}
void OAICreditCardData::setCardType(const QString &card_type) {
    m_card_type = card_type;
    m_card_type_isSet = true;
}

bool OAICreditCardData::is_card_type_Set() const{
    return m_card_type_isSet;
}

bool OAICreditCardData::is_card_type_Valid() const{
    return m_card_type_isValid;
}

QString OAICreditCardData::getExpiry() const {
    return m_expiry;
}
void OAICreditCardData::setExpiry(const QString &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAICreditCardData::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAICreditCardData::is_expiry_Valid() const{
    return m_expiry_isValid;
}

QString OAICreditCardData::getLastFour() const {
    return m_last_four;
}
void OAICreditCardData::setLastFour(const QString &last_four) {
    m_last_four = last_four;
    m_last_four_isSet = true;
}

bool OAICreditCardData::is_last_four_Set() const{
    return m_last_four_isSet;
}

bool OAICreditCardData::is_last_four_Valid() const{
    return m_last_four_isValid;
}

bool OAICreditCardData::isSet() const {
...
bool OAICreditCardData::isValid() const {
