...
#ifndef OAINodeBalancerConfig_H
#define OAINodeBalancerConfig_H
...
class OAINodeBalancerConfig : public OAIObject {
public:
    OAINodeBalancerConfig();
    OAINodeBalancerConfig(QString json);
    ~OAINodeBalancerConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeBalancerConfig)

#endif // OAINodeBalancerConfig_H
