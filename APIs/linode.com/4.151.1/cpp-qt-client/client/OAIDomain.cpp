...
QList<QString> OAIDomain::getAxfrIps() const {
    return m_axfr_ips;
}
void OAIDomain::setAxfrIps(const QList<QString> &axfr_ips) {
    m_axfr_ips = axfr_ips;
    m_axfr_ips_isSet = true;
}

bool OAIDomain::is_axfr_ips_Set() const{
    return m_axfr_ips_isSet;
}

bool OAIDomain::is_axfr_ips_Valid() const{
...
qint32 OAIDomain::getExpireSec() const {
    return m_expire_sec;
}
void OAIDomain::setExpireSec(const qint32 &expire_sec) {
    m_expire_sec = expire_sec;
    m_expire_sec_isSet = true;
}

bool OAIDomain::is_expire_sec_Set() const{
    return m_expire_sec_isSet;
}

bool OAIDomain::is_expire_sec_Valid() const{
    return m_expire_sec_isValid;
}

QString OAIDomain::getGroup() const {
    return m_group;
}
void OAIDomain::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIDomain::is_group_Set() const{
    return m_group_isSet;
}

bool OAIDomain::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAIDomain::getId() const {
    return m_id;
}
void OAIDomain::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QList<QString> OAIDomain::getMasterIps() const {
    return m_master_ips;
}
void OAIDomain::setMasterIps(const QList<QString> &master_ips) {
    m_master_ips = master_ips;
    m_master_ips_isSet = true;
}

bool OAIDomain::is_master_ips_Set() const{
    return m_master_ips_isSet;
}

bool OAIDomain::is_master_ips_Valid() const{
    return m_master_ips_isValid;
}

qint32 OAIDomain::getRefreshSec() const {
    return m_refresh_sec;
}
void OAIDomain::setRefreshSec(const qint32 &refresh_sec) {
    m_refresh_sec = refresh_sec;
    m_refresh_sec_isSet = true;
}

bool OAIDomain::is_refresh_sec_Set() const{
    return m_refresh_sec_isSet;
}

bool OAIDomain::is_refresh_sec_Valid() const{
    return m_refresh_sec_isValid;
}

qint32 OAIDomain::getRetrySec() const {
    return m_retry_sec;
}
void OAIDomain::setRetrySec(const qint32 &retry_sec) {
    m_retry_sec = retry_sec;
    m_retry_sec_isSet = true;
}

bool OAIDomain::is_retry_sec_Set() const{
    return m_retry_sec_isSet;
}

bool OAIDomain::is_retry_sec_Valid() const{
    return m_retry_sec_isValid;
}

QString OAIDomain::getSoaEmail() const {
    return m_soa_email;
}
void OAIDomain::setSoaEmail(const QString &soa_email) {
    m_soa_email = soa_email;
    m_soa_email_isSet = true;
}

bool OAIDomain::is_soa_email_Set() const{
    return m_soa_email_isSet;
}

bool OAIDomain::is_soa_email_Valid() const{
...
QList<QString> OAIDomain::getTags() const {
    return m_tags;
}
void OAIDomain::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
qint32 OAIDomain::getTtlSec() const {
    return m_ttl_sec;
}
void OAIDomain::setTtlSec(const qint32 &ttl_sec) {
    m_ttl_sec = ttl_sec;
    m_ttl_sec_isSet = true;
}

bool OAIDomain::is_ttl_sec_Set() const{
    return m_ttl_sec_isSet;
}

bool OAIDomain::is_ttl_sec_Valid() const{
