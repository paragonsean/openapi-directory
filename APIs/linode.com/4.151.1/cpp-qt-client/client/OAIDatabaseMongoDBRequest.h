...
/*
 * OAIDatabaseMongoDBRequest.h
 *
 * Managed MongoDB Database request object.
 */

#ifndef OAIDatabaseMongoDBRequest_H
#define OAIDatabaseMongoDBRequest_H
...
class OAIDatabaseMongoDBRequest : public OAIObject {
public:
    OAIDatabaseMongoDBRequest();
    OAIDatabaseMongoDBRequest(QString json);
    ~OAIDatabaseMongoDBRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseMongoDBRequest)

#endif // OAIDatabaseMongoDBRequest_H
