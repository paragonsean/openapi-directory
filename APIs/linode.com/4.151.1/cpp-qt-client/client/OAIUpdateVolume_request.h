...
/*
 * OAIUpdateVolume_request.h
 *
 * 
 */

#ifndef OAIUpdateVolume_request_H
#define OAIUpdateVolume_request_H
...
class OAIUpdateVolume_request : public OAIObject {
public:
    OAIUpdateVolume_request();
    OAIUpdateVolume_request(QString json);
    ~OAIUpdateVolume_request() override;
    ...
    QJsonValue getLinodeId() const;
    void setLinodeId(const QJsonValue &linode_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVolume_request)

#endif // OAIUpdateVolume_request_H
