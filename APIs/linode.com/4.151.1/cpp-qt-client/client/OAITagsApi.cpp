...
void OAITagsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getTaggedObjects", defaultConf);
    _serverIndices.insert("getTaggedObjects", 0);
...
void OAITagsApi::createTag(const ::OpenAPI::OptionalParam<OAICreateTag_request> &oai_create_tag_request) {
    ...
    if (oai_create_tag_request.hasValue()){

        
        QByteArray output = oai_create_tag_request.value().asJson().toUtf8();
...
void OAITagsApi::deleteTag(const QString &label) {
    QString fullPath = QString(_serverConfigs["deleteTag"][_serverIndices.value("deleteTag")].URL()+"/tags/{label}");
...
void OAITagsApi::getTaggedObjects(const QString &label, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getTaggedObjects"][_serverIndices.value("getTaggedObjects")].URL()+"/tags/{label}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITagsApi::getTaggedObjectsCallback);
    connect(this, &OAITagsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITagsApi::getTaggedObjectsCallback);
    connect(this, &OAITagsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAITagsApi::getTaggedObjectsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetTaggedObjects_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTaggedObjectsSignal(output);
        Q_EMIT getTaggedObjectsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("account:read_only");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTaggedObjectsSignalE(output, error_type, error_str);
        Q_EMIT getTaggedObjectsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTaggedObjectsSignalError(output, error_type, error_str);
        Q_EMIT getTaggedObjectsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITagsApi::getTags(const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &page_size) {
