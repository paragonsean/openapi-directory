...
OAIDatabaseMySQLRequest::OAIDatabaseMySQLRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseMySQLRequest::OAIDatabaseMySQLRequest() {
    this->initializeModel();
}

OAIDatabaseMySQLRequest::~OAIDatabaseMySQLRequest() {}

void OAIDatabaseMySQLRequest::initializeModel() {
    ...
    m_ssl_connection_isSet = false;
    m_ssl_connection_isValid = false;

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIDatabaseMySQLRequest::fromJson(QString jsonString) {
...
void OAIDatabaseMySQLRequest::fromJsonObject(QJsonObject json) {

    m_allow_list_isValid = ::OpenAPI::fromJsonValue(m_allow_list, json[QString("allow_list")]);
    m_allow_list_isSet = !json[QString("allow_list")].isNull() && m_allow_list_isValid;

    m_cluster_size_isValid = ::OpenAPI::fromJsonValue(m_cluster_size, json[QString("cluster_size")]);
    m_cluster_size_isSet = !json[QString("cluster_size")].isNull() && m_cluster_size_isValid;
    ...
    m_replication_type_isValid = ::OpenAPI::fromJsonValue(m_replication_type, json[QString("replication_type")]);
    m_replication_type_isSet = !json[QString("replication_type")].isNull() && m_replication_type_isValid;

    m_ssl_connection_isValid = ::OpenAPI::fromJsonValue(m_ssl_connection, json[QString("ssl_connection")]);
    m_ssl_connection_isSet = !json[QString("ssl_connection")].isNull() && m_ssl_connection_isValid;

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAIDatabaseMySQLRequest::asJson() const {
...
QJsonObject OAIDatabaseMySQLRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_allow_list.size() > 0) {
        obj.insert(QString("allow_list"), ::OpenAPI::toJsonValue(m_allow_list));
    }
    if (m_cluster_size_isSet) {
        obj.insert(QString("cluster_size"), ::OpenAPI::toJsonValue(m_cluster_size));
    }
    ...
    if (m_replication_type_isSet) {
        obj.insert(QString("replication_type"), ::OpenAPI::toJsonValue(m_replication_type));
    }
    if (m_ssl_connection_isSet) {
        obj.insert(QString("ssl_connection"), ::OpenAPI::toJsonValue(m_ssl_connection));
    }
    if (m_type_isSet) {
...
QList<QString> OAIDatabaseMySQLRequest::getAllowList() const {
    return m_allow_list;
}
void OAIDatabaseMySQLRequest::setAllowList(const QList<QString> &allow_list) {
    m_allow_list = allow_list;
    m_allow_list_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_allow_list_Set() const{
    return m_allow_list_isSet;
}

bool OAIDatabaseMySQLRequest::is_allow_list_Valid() const{
    return m_allow_list_isValid;
}

qint32 OAIDatabaseMySQLRequest::getClusterSize() const {
    return m_cluster_size;
}
void OAIDatabaseMySQLRequest::setClusterSize(const qint32 &cluster_size) {
    m_cluster_size = cluster_size;
    m_cluster_size_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_cluster_size_Set() const{
    return m_cluster_size_isSet;
}

bool OAIDatabaseMySQLRequest::is_cluster_size_Valid() const{
    return m_cluster_size_isValid;
}

bool OAIDatabaseMySQLRequest::isEncrypted() const {
    return m_encrypted;
}
void OAIDatabaseMySQLRequest::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIDatabaseMySQLRequest::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

QString OAIDatabaseMySQLRequest::getEngine() const {
    return m_engine;
}
void OAIDatabaseMySQLRequest::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseMySQLRequest::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIDatabaseMySQLRequest::getLabel() const {
    return m_label;
}
void OAIDatabaseMySQLRequest::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseMySQLRequest::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDatabaseMySQLRequest::getRegion() const {
    return m_region;
}
void OAIDatabaseMySQLRequest::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_region_Set() const{
    return m_region_isSet;
}

bool OAIDatabaseMySQLRequest::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIDatabaseMySQLRequest::getReplicationType() const {
    return m_replication_type;
}
void OAIDatabaseMySQLRequest::setReplicationType(const QString &replication_type) {
    m_replication_type = replication_type;
    m_replication_type_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_replication_type_Set() const{
    return m_replication_type_isSet;
}

bool OAIDatabaseMySQLRequest::is_replication_type_Valid() const{
    return m_replication_type_isValid;
}

bool OAIDatabaseMySQLRequest::isSslConnection() const {
    return m_ssl_connection;
}
void OAIDatabaseMySQLRequest::setSslConnection(const bool &ssl_connection) {
    m_ssl_connection = ssl_connection;
    m_ssl_connection_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_ssl_connection_Set() const{
    return m_ssl_connection_isSet;
}

bool OAIDatabaseMySQLRequest::is_ssl_connection_Valid() const{
    return m_ssl_connection_isValid;
}

QString OAIDatabaseMySQLRequest::getType() const {
    return m_type;
}
void OAIDatabaseMySQLRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseMySQLRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseMySQLRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDatabaseMySQLRequest::isSet() const {
...
bool OAIDatabaseMySQLRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_engine_isValid && m_label_isValid && m_region_isValid && m_type_isValid && true;
}
