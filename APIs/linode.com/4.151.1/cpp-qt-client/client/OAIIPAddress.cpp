...
void OAIIPAddress::fromJsonObject(QJsonObject json) {
    ...
    m_rdns_isValid = ::OpenAPI::fromJsonValue(m_rdns, json[QString("rdns")]);
    m_rdns_isSet = !json[QString("rdns")].isNull() && m_rdns_isValid;

    m_region_isValid = ::OpenAPI::fromJsonValue(m_region, json[QString("region")]);
    m_region_isSet = !json[QString("region")].isNull() && m_region_isValid;

    m_subnet_mask_isValid = ::OpenAPI::fromJsonValue(m_subnet_mask, json[QString("subnet_mask")]);
    m_subnet_mask_isSet = !json[QString("subnet_mask")].isNull() && m_subnet_mask_isValid;
...
QJsonObject OAIIPAddress::asJsonObject() const {
    ...
    if (m_rdns_isSet) {
        obj.insert(QString("rdns"), ::OpenAPI::toJsonValue(m_rdns));
    }
    if (m_region_isSet) {
        obj.insert(QString("region"), ::OpenAPI::toJsonValue(m_region));
    }
    if (m_subnet_mask_isSet) {
        obj.insert(QString("subnet_mask"), ::OpenAPI::toJsonValue(m_subnet_mask));
    }
    if (m_type_isSet) {
...
QString OAIIPAddress::getGateway() const {
    return m_gateway;
}
void OAIIPAddress::setGateway(const QString &gateway) {
    m_gateway = gateway;
    m_gateway_isSet = true;
}

bool OAIIPAddress::is_gateway_Set() const{
    return m_gateway_isSet;
}

bool OAIIPAddress::is_gateway_Valid() const{
    return m_gateway_isValid;
}

qint32 OAIIPAddress::getLinodeId() const {
    return m_linode_id;
}
void OAIIPAddress::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIIPAddress::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIIPAddress::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

qint32 OAIIPAddress::getPrefix() const {
    return m_prefix;
}
void OAIIPAddress::setPrefix(const qint32 &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIIPAddress::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIIPAddress::is_prefix_Valid() const{
    return m_prefix_isValid;
}

bool OAIIPAddress::isRPublic() const {
    return m_r_public;
}
void OAIIPAddress::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIIPAddress::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIIPAddress::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIIPAddress::getRdns() const {
    return m_rdns;
}
void OAIIPAddress::setRdns(const QString &rdns) {
    m_rdns = rdns;
    m_rdns_isSet = true;
}

bool OAIIPAddress::is_rdns_Set() const{
    return m_rdns_isSet;
}

bool OAIIPAddress::is_rdns_Valid() const{
    return m_rdns_isValid;
}

QString OAIIPAddress::getRegion() const {
    return m_region;
}
void OAIIPAddress::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIIPAddress::is_region_Set() const{
    return m_region_isSet;
}

bool OAIIPAddress::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIIPAddress::getSubnetMask() const {
    return m_subnet_mask;
}
void OAIIPAddress::setSubnetMask(const QString &subnet_mask) {
    m_subnet_mask = subnet_mask;
    m_subnet_mask_isSet = true;
}

bool OAIIPAddress::is_subnet_mask_Set() const{
    return m_subnet_mask_isSet;
}

bool OAIIPAddress::is_subnet_mask_Valid() const{
