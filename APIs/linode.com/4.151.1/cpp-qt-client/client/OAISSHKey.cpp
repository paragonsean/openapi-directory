...
QDateTime OAISSHKey::getCreated() const {
    return m_created;
}
void OAISSHKey::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAISSHKey::is_created_Set() const{
    return m_created_isSet;
}

bool OAISSHKey::is_created_Valid() const{
...
QString OAISSHKey::getLabel() const {
    return m_label;
}
void OAISSHKey::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISSHKey::is_label_Set() const{
    return m_label_isSet;
}

bool OAISSHKey::is_label_Valid() const{
    return m_label_isValid;
}

QString OAISSHKey::getSshKey() const {
    return m_ssh_key;
}
void OAISSHKey::setSshKey(const QString &ssh_key) {
    m_ssh_key = ssh_key;
    m_ssh_key_isSet = true;
}

bool OAISSHKey::is_ssh_key_Set() const{
    return m_ssh_key_isSet;
}

bool OAISSHKey::is_ssh_key_Valid() const{
