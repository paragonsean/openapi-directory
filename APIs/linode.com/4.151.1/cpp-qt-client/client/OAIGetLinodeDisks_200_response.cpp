...
OAIGetLinodeDisks_200_response::OAIGetLinodeDisks_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinodeDisks_200_response::OAIGetLinodeDisks_200_response() {
    this->initializeModel();
}

OAIGetLinodeDisks_200_response::~OAIGetLinodeDisks_200_response() {}

void OAIGetLinodeDisks_200_response::initializeModel() {
...
void OAIGetLinodeDisks_200_response::fromJson(QString jsonString) {
...
void OAIGetLinodeDisks_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetLinodeDisks_200_response::asJson() const {
...
QJsonObject OAIGetLinodeDisks_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDisk> OAIGetLinodeDisks_200_response::getData() const {
    return m_data;
}
void OAIGetLinodeDisks_200_response::setData(const QList<OAIDisk> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetLinodeDisks_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetLinodeDisks_200_response::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIGetLinodeDisks_200_response::getPage() const {
    return m_page;
}
void OAIGetLinodeDisks_200_response::setPage(const qint32 &page) {
    m_page = page;
    m_page_isSet = true;
}

bool OAIGetLinodeDisks_200_response::is_page_Set() const{
    return m_page_isSet;
}

bool OAIGetLinodeDisks_200_response::is_page_Valid() const{
    return m_page_isValid;
}

qint32 OAIGetLinodeDisks_200_response::getPages() const {
    return m_pages;
}
void OAIGetLinodeDisks_200_response::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIGetLinodeDisks_200_response::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIGetLinodeDisks_200_response::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIGetLinodeDisks_200_response::getResults() const {
    return m_results;
}
void OAIGetLinodeDisks_200_response::setResults(const qint32 &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIGetLinodeDisks_200_response::is_results_Set() const{
    return m_results_isSet;
}

bool OAIGetLinodeDisks_200_response::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIGetLinodeDisks_200_response::isSet() const {
...
bool OAIGetLinodeDisks_200_response::isValid() const {
