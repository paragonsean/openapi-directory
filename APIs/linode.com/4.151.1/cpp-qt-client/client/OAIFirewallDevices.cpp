...
OAIFirewallDevices::OAIFirewallDevices(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallDevices::OAIFirewallDevices() {
    this->initializeModel();
}

OAIFirewallDevices::~OAIFirewallDevices() {}

void OAIFirewallDevices::initializeModel() {
...
void OAIFirewallDevices::fromJson(QString jsonString) {
...
void OAIFirewallDevices::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallDevices::asJson() const {
...
QJsonObject OAIFirewallDevices::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QDateTime OAIFirewallDevices::getCreated() const {
    return m_created;
}
void OAIFirewallDevices::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIFirewallDevices::is_created_Set() const{
    return m_created_isSet;
}

bool OAIFirewallDevices::is_created_Valid() const{
    return m_created_isValid;
}

OAIFirewallDevices_entity OAIFirewallDevices::getEntity() const {
    return m_entity;
}
void OAIFirewallDevices::setEntity(const OAIFirewallDevices_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIFirewallDevices::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIFirewallDevices::is_entity_Valid() const{
    return m_entity_isValid;
}

qint32 OAIFirewallDevices::getId() const {
    return m_id;
}
void OAIFirewallDevices::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFirewallDevices::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFirewallDevices::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIFirewallDevices::getUpdated() const {
    return m_updated;
}
void OAIFirewallDevices::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIFirewallDevices::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIFirewallDevices::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIFirewallDevices::isSet() const {
...
bool OAIFirewallDevices::isValid() const {
