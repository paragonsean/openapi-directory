...
OAIDatabaseBackup::OAIDatabaseBackup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseBackup::OAIDatabaseBackup() {
    this->initializeModel();
}

OAIDatabaseBackup::~OAIDatabaseBackup() {}

void OAIDatabaseBackup::initializeModel() {
...
void OAIDatabaseBackup::fromJson(QString jsonString) {
...
void OAIDatabaseBackup::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseBackup::asJson() const {
...
QJsonObject OAIDatabaseBackup::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
...
QString OAIDatabaseBackup::getCreated() const {
    return m_created;
}
void OAIDatabaseBackup::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIDatabaseBackup::is_created_Set() const{
    return m_created_isSet;
}

bool OAIDatabaseBackup::is_created_Valid() const{
    return m_created_isValid;
}

qint32 OAIDatabaseBackup::getId() const {
    return m_id;
}
void OAIDatabaseBackup::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatabaseBackup::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatabaseBackup::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDatabaseBackup::getLabel() const {
    return m_label;
}
void OAIDatabaseBackup::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDatabaseBackup::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDatabaseBackup::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIDatabaseBackup::getType() const {
    return m_type;
}
void OAIDatabaseBackup::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDatabaseBackup::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDatabaseBackup::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDatabaseBackup::isSet() const {
...
bool OAIDatabaseBackup::isValid() const {
