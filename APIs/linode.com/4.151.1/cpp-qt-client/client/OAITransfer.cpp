...
qint32 OAITransfer::getBillable() const {
    return m_billable;
}
void OAITransfer::setBillable(const qint32 &billable) {
    m_billable = billable;
    m_billable_isSet = true;
}

bool OAITransfer::is_billable_Set() const{
    return m_billable_isSet;
}

bool OAITransfer::is_billable_Valid() const{
    return m_billable_isValid;
}

qint32 OAITransfer::getQuota() const {
    return m_quota;
}
void OAITransfer::setQuota(const qint32 &quota) {
    m_quota = quota;
    m_quota_isSet = true;
}

bool OAITransfer::is_quota_Set() const{
    return m_quota_isSet;
}

bool OAITransfer::is_quota_Valid() const{
    return m_quota_isValid;
}

qint32 OAITransfer::getUsed() const {
    return m_used;
}
void OAITransfer::setUsed(const qint32 &used) {
    m_used = used;
    m_used_isSet = true;
}

bool OAITransfer::is_used_Set() const{
    return m_used_isSet;
}

bool OAITransfer::is_used_Valid() const{
