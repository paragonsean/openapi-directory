...
OAICreatePersonalAccessToken_request::OAICreatePersonalAccessToken_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePersonalAccessToken_request::OAICreatePersonalAccessToken_request() {
    this->initializeModel();
}

OAICreatePersonalAccessToken_request::~OAICreatePersonalAccessToken_request() {}

void OAICreatePersonalAccessToken_request::initializeModel() {
...
void OAICreatePersonalAccessToken_request::fromJson(QString jsonString) {
...
void OAICreatePersonalAccessToken_request::fromJsonObject(QJsonObject json) {
...
QString OAICreatePersonalAccessToken_request::asJson() const {
...
QJsonObject OAICreatePersonalAccessToken_request::asJsonObject() const {
    QJsonObject obj;
    if (m_expiry_isSet) {
...
QDateTime OAICreatePersonalAccessToken_request::getExpiry() const {
    return m_expiry;
}
void OAICreatePersonalAccessToken_request::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAICreatePersonalAccessToken_request::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAICreatePersonalAccessToken_request::is_expiry_Valid() const{
    return m_expiry_isValid;
}

QString OAICreatePersonalAccessToken_request::getLabel() const {
    return m_label;
}
void OAICreatePersonalAccessToken_request::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICreatePersonalAccessToken_request::is_label_Set() const{
    return m_label_isSet;
}

bool OAICreatePersonalAccessToken_request::is_label_Valid() const{
    return m_label_isValid;
}

QString OAICreatePersonalAccessToken_request::getScopes() const {
    return m_scopes;
}
void OAICreatePersonalAccessToken_request::setScopes(const QString &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAICreatePersonalAccessToken_request::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAICreatePersonalAccessToken_request::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAICreatePersonalAccessToken_request::isSet() const {
...
bool OAICreatePersonalAccessToken_request::isValid() const {
