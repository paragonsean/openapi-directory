...
OAIRescueDevices::OAIRescueDevices(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRescueDevices::OAIRescueDevices() {
    this->initializeModel();
}

OAIRescueDevices::~OAIRescueDevices() {}

void OAIRescueDevices::initializeModel() {
...
void OAIRescueDevices::fromJson(QString jsonString) {
...
void OAIRescueDevices::fromJsonObject(QJsonObject json) {

    m_sda_isValid = ::OpenAPI::fromJsonValue(m_sda, json[QString("sda")]);
    m_sda_isSet = !json[QString("sda")].isNull() && m_sda_isValid;

    m_sdb_isValid = ::OpenAPI::fromJsonValue(m_sdb, json[QString("sdb")]);
    m_sdb_isSet = !json[QString("sdb")].isNull() && m_sdb_isValid;

    m_sdc_isValid = ::OpenAPI::fromJsonValue(m_sdc, json[QString("sdc")]);
    m_sdc_isSet = !json[QString("sdc")].isNull() && m_sdc_isValid;

    m_sdd_isValid = ::OpenAPI::fromJsonValue(m_sdd, json[QString("sdd")]);
    m_sdd_isSet = !json[QString("sdd")].isNull() && m_sdd_isValid;

    m_sde_isValid = ::OpenAPI::fromJsonValue(m_sde, json[QString("sde")]);
    m_sde_isSet = !json[QString("sde")].isNull() && m_sde_isValid;

    m_sdf_isValid = ::OpenAPI::fromJsonValue(m_sdf, json[QString("sdf")]);
    m_sdf_isSet = !json[QString("sdf")].isNull() && m_sdf_isValid;

    m_sdg_isValid = ::OpenAPI::fromJsonValue(m_sdg, json[QString("sdg")]);
    m_sdg_isSet = !json[QString("sdg")].isNull() && m_sdg_isValid;
}

QString OAIRescueDevices::asJson() const {
...
QJsonObject OAIRescueDevices::asJsonObject() const {
    QJsonObject obj;
    if (m_sda.isSet()) {
        obj.insert(QString("sda"), ::OpenAPI::toJsonValue(m_sda));
    }
    if (m_sdb.isSet()) {
        obj.insert(QString("sdb"), ::OpenAPI::toJsonValue(m_sdb));
    }
    if (m_sdc.isSet()) {
        obj.insert(QString("sdc"), ::OpenAPI::toJsonValue(m_sdc));
    }
    if (m_sdd.isSet()) {
        obj.insert(QString("sdd"), ::OpenAPI::toJsonValue(m_sdd));
    }
    if (m_sde.isSet()) {
        obj.insert(QString("sde"), ::OpenAPI::toJsonValue(m_sde));
    }
    if (m_sdf.isSet()) {
        obj.insert(QString("sdf"), ::OpenAPI::toJsonValue(m_sdf));
    }
    if (m_sdg.isSet()) {
        obj.insert(QString("sdg"), ::OpenAPI::toJsonValue(m_sdg));
    }
    return obj;
}

OAIDevice OAIRescueDevices::getSda() const {
    return m_sda;
}
void OAIRescueDevices::setSda(const OAIDevice &sda) {
    m_sda = sda;
    m_sda_isSet = true;
}

bool OAIRescueDevices::is_sda_Set() const{
    return m_sda_isSet;
}

bool OAIRescueDevices::is_sda_Valid() const{
    return m_sda_isValid;
}

OAIDevice OAIRescueDevices::getSdb() const {
    return m_sdb;
}
void OAIRescueDevices::setSdb(const OAIDevice &sdb) {
    m_sdb = sdb;
    m_sdb_isSet = true;
}

bool OAIRescueDevices::is_sdb_Set() const{
    return m_sdb_isSet;
}

bool OAIRescueDevices::is_sdb_Valid() const{
    return m_sdb_isValid;
}

OAIDevice OAIRescueDevices::getSdc() const {
    return m_sdc;
}
void OAIRescueDevices::setSdc(const OAIDevice &sdc) {
    m_sdc = sdc;
    m_sdc_isSet = true;
}

bool OAIRescueDevices::is_sdc_Set() const{
    return m_sdc_isSet;
}

bool OAIRescueDevices::is_sdc_Valid() const{
    return m_sdc_isValid;
}

OAIDevice OAIRescueDevices::getSdd() const {
    return m_sdd;
}
void OAIRescueDevices::setSdd(const OAIDevice &sdd) {
    m_sdd = sdd;
    m_sdd_isSet = true;
}

bool OAIRescueDevices::is_sdd_Set() const{
    return m_sdd_isSet;
}

bool OAIRescueDevices::is_sdd_Valid() const{
    return m_sdd_isValid;
}

OAIDevice OAIRescueDevices::getSde() const {
    return m_sde;
}
void OAIRescueDevices::setSde(const OAIDevice &sde) {
    m_sde = sde;
    m_sde_isSet = true;
}

bool OAIRescueDevices::is_sde_Set() const{
    return m_sde_isSet;
}

bool OAIRescueDevices::is_sde_Valid() const{
    return m_sde_isValid;
}

OAIDevice OAIRescueDevices::getSdf() const {
    return m_sdf;
}
void OAIRescueDevices::setSdf(const OAIDevice &sdf) {
    m_sdf = sdf;
    m_sdf_isSet = true;
}

bool OAIRescueDevices::is_sdf_Set() const{
    return m_sdf_isSet;
}

bool OAIRescueDevices::is_sdf_Valid() const{
    return m_sdf_isValid;
}

OAIDevice OAIRescueDevices::getSdg() const {
    return m_sdg;
}
void OAIRescueDevices::setSdg(const OAIDevice &sdg) {
    m_sdg = sdg;
    m_sdg_isSet = true;
}

bool OAIRescueDevices::is_sdg_Set() const{
    return m_sdg_isSet;
}

bool OAIRescueDevices::is_sdg_Valid() const{
    return m_sdg_isValid;
}

bool OAIRescueDevices::isSet() const {
...
bool OAIRescueDevices::isValid() const {
