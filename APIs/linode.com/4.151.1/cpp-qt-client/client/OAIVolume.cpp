...
QDateTime OAIVolume::getCreated() const {
    return m_created;
}
void OAIVolume::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIVolume::is_created_Set() const{
    return m_created_isSet;
}

bool OAIVolume::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIVolume::getFilesystemPath() const {
    return m_filesystem_path;
}
void OAIVolume::setFilesystemPath(const QString &filesystem_path) {
    m_filesystem_path = filesystem_path;
    m_filesystem_path_isSet = true;
}

bool OAIVolume::is_filesystem_path_Set() const{
    return m_filesystem_path_isSet;
}

bool OAIVolume::is_filesystem_path_Valid() const{
    return m_filesystem_path_isValid;
}

QString OAIVolume::getHardwareType() const {
    return m_hardware_type;
}
void OAIVolume::setHardwareType(const QString &hardware_type) {
    m_hardware_type = hardware_type;
    m_hardware_type_isSet = true;
}

bool OAIVolume::is_hardware_type_Set() const{
    return m_hardware_type_isSet;
}

bool OAIVolume::is_hardware_type_Valid() const{
    return m_hardware_type_isValid;
}

qint32 OAIVolume::getId() const {
    return m_id;
}
void OAIVolume::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIVolume::getLabel() const {
    return m_label;
}
void OAIVolume::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIVolume::is_label_Set() const{
    return m_label_isSet;
}

bool OAIVolume::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIVolume::getLinodeId() const {
    return m_linode_id;
}
void OAIVolume::setLinodeId(const qint32 &linode_id) {
    m_linode_id = linode_id;
    m_linode_id_isSet = true;
}

bool OAIVolume::is_linode_id_Set() const{
    return m_linode_id_isSet;
}

bool OAIVolume::is_linode_id_Valid() const{
    return m_linode_id_isValid;
}

QString OAIVolume::getLinodeLabel() const {
    return m_linode_label;
}
void OAIVolume::setLinodeLabel(const QString &linode_label) {
    m_linode_label = linode_label;
    m_linode_label_isSet = true;
}

bool OAIVolume::is_linode_label_Set() const{
    return m_linode_label_isSet;
}

bool OAIVolume::is_linode_label_Valid() const{
    return m_linode_label_isValid;
}

QString OAIVolume::getRegion() const {
    return m_region;
}
void OAIVolume::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIVolume::is_region_Set() const{
    return m_region_isSet;
}

bool OAIVolume::is_region_Valid() const{
    return m_region_isValid;
}

qint32 OAIVolume::getSize() const {
    return m_size;
}
void OAIVolume::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIVolume::is_size_Set() const{
    return m_size_isSet;
}

bool OAIVolume::is_size_Valid() const{
    return m_size_isValid;
}

QString OAIVolume::getStatus() const {
    return m_status;
}
void OAIVolume::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<QString> OAIVolume::getTags() const {
    return m_tags;
}
void OAIVolume::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QDateTime OAIVolume::getUpdated() const {
    return m_updated;
}
void OAIVolume::setUpdated(const QDateTime &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIVolume::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIVolume::is_updated_Valid() const{
