...
void Example::exampleFunction1(){
     OAIAccountApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountApi::acceptEntityTransferSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountApi::acceptEntityTransferSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString token = create(); // QString | The UUID of the Entity Transfer.
      apiInstance.acceptEntityTransfer(token);
