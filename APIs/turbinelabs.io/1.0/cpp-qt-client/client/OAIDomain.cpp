...
QList<QString> OAIDomain::getAliases() const {
    return m_aliases;
}
void OAIDomain::setAliases(const QList<QString> &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAIDomain::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAIDomain::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QString OAIDomain::getChecksum() const {
    return m_checksum;
}
void OAIDomain::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAIDomain::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAIDomain::is_checksum_Valid() const{
    return m_checksum_isValid;
}

OAICORSConfig OAIDomain::getCorsConfig() const {
    return m_cors_config;
}
void OAIDomain::setCorsConfig(const OAICORSConfig &cors_config) {
    m_cors_config = cors_config;
    m_cors_config_isSet = true;
}

bool OAIDomain::is_cors_config_Set() const{
    return m_cors_config_isSet;
}

bool OAIDomain::is_cors_config_Valid() const{
    return m_cors_config_isValid;
}

QString OAIDomain::getDomainKey() const {
    return m_domain_key;
}
void OAIDomain::setDomainKey(const QString &domain_key) {
    m_domain_key = domain_key;
    m_domain_key_isSet = true;
}

bool OAIDomain::is_domain_key_Set() const{
    return m_domain_key_isSet;
}

bool OAIDomain::is_domain_key_Valid() const{
    return m_domain_key_isValid;
}

bool OAIDomain::isForceHttps() const {
    return m_force_https;
}
void OAIDomain::setForceHttps(const bool &force_https) {
    m_force_https = force_https;
    m_force_https_isSet = true;
}

bool OAIDomain::is_force_https_Set() const{
    return m_force_https_isSet;
}

bool OAIDomain::is_force_https_Valid() const{
    return m_force_https_isValid;
}

bool OAIDomain::isGzipEnabled() const {
    return m_gzip_enabled;
}
void OAIDomain::setGzipEnabled(const bool &gzip_enabled) {
    m_gzip_enabled = gzip_enabled;
    m_gzip_enabled_isSet = true;
}

bool OAIDomain::is_gzip_enabled_Set() const{
    return m_gzip_enabled_isSet;
}

bool OAIDomain::is_gzip_enabled_Valid() const{
...
qint32 OAIDomain::getPort() const {
    return m_port;
}
void OAIDomain::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIDomain::is_port_Set() const{
    return m_port_isSet;
}

bool OAIDomain::is_port_Valid() const{
    return m_port_isValid;
}

QList<OAIRedirect> OAIDomain::getRedirects() const {
    return m_redirects;
}
void OAIDomain::setRedirects(const QList<OAIRedirect> &redirects) {
    m_redirects = redirects;
    m_redirects_isSet = true;
}

bool OAIDomain::is_redirects_Set() const{
    return m_redirects_isSet;
}

bool OAIDomain::is_redirects_Valid() const{
    return m_redirects_isValid;
}

OAISSLConfig OAIDomain::getSslConfig() const {
    return m_ssl_config;
}
void OAIDomain::setSslConfig(const OAISSLConfig &ssl_config) {
    m_ssl_config = ssl_config;
    m_ssl_config_isSet = true;
}

bool OAIDomain::is_ssl_config_Set() const{
    return m_ssl_config_isSet;
}

bool OAIDomain::is_ssl_config_Valid() const{
    return m_ssl_config_isValid;
}

QString OAIDomain::getZoneKey() const {
    return m_zone_key;
}
void OAIDomain::setZoneKey(const QString &zone_key) {
    m_zone_key = zone_key;
    m_zone_key_isSet = true;
}

bool OAIDomain::is_zone_key_Set() const{
    return m_zone_key_isSet;
}

bool OAIDomain::is_zone_key_Valid() const{
...
bool OAIDomain::isValid() const {
    ...
    return m_checksum_isValid && m_domain_key_isValid && m_name_isValid && m_port_isValid && m_zone_key_isValid && true;
}
