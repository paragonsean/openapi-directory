...
OAIRouteCreate::OAIRouteCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRouteCreate::OAIRouteCreate() {
    this->initializeModel();
}

OAIRouteCreate::~OAIRouteCreate() {}

void OAIRouteCreate::initializeModel() {
...
void OAIRouteCreate::fromJson(QString jsonString) {
...
void OAIRouteCreate::fromJsonObject(QJsonObject json) {
...
QString OAIRouteCreate::asJson() const {
...
QJsonObject OAIRouteCreate::asJsonObject() const {
    QJsonObject obj;
    if (m_checksum_isSet) {
...
QString OAIRouteCreate::getChecksum() const {
    return m_checksum;
}
void OAIRouteCreate::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAIRouteCreate::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAIRouteCreate::is_checksum_Valid() const{
    return m_checksum_isValid;
}

OAICohortSeed OAIRouteCreate::getCohortSeed() const {
    return m_cohort_seed;
}
void OAIRouteCreate::setCohortSeed(const OAICohortSeed &cohort_seed) {
    m_cohort_seed = cohort_seed;
    m_cohort_seed_isSet = true;
}

bool OAIRouteCreate::is_cohort_seed_Set() const{
    return m_cohort_seed_isSet;
}

bool OAIRouteCreate::is_cohort_seed_Valid() const{
    return m_cohort_seed_isValid;
}

QString OAIRouteCreate::getDomainKey() const {
    return m_domain_key;
}
void OAIRouteCreate::setDomainKey(const QString &domain_key) {
    m_domain_key = domain_key;
    m_domain_key_isSet = true;
}

bool OAIRouteCreate::is_domain_key_Set() const{
    return m_domain_key_isSet;
}

bool OAIRouteCreate::is_domain_key_Valid() const{
    return m_domain_key_isValid;
}

QString OAIRouteCreate::getPath() const {
    return m_path;
}
void OAIRouteCreate::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIRouteCreate::is_path_Set() const{
    return m_path_isSet;
}

bool OAIRouteCreate::is_path_Valid() const{
    return m_path_isValid;
}

OAIResponseData OAIRouteCreate::getResponseData() const {
    return m_response_data;
}
void OAIRouteCreate::setResponseData(const OAIResponseData &response_data) {
    m_response_data = response_data;
    m_response_data_isSet = true;
}

bool OAIRouteCreate::is_response_data_Set() const{
    return m_response_data_isSet;
}

bool OAIRouteCreate::is_response_data_Valid() const{
    return m_response_data_isValid;
}

OAIRetryPolicy OAIRouteCreate::getRetryPolicy() const {
    return m_retry_policy;
}
void OAIRouteCreate::setRetryPolicy(const OAIRetryPolicy &retry_policy) {
    m_retry_policy = retry_policy;
    m_retry_policy_isSet = true;
}

bool OAIRouteCreate::is_retry_policy_Set() const{
    return m_retry_policy_isSet;
}

bool OAIRouteCreate::is_retry_policy_Valid() const{
    return m_retry_policy_isValid;
}

QString OAIRouteCreate::getRouteKey() const {
    return m_route_key;
}
void OAIRouteCreate::setRouteKey(const QString &route_key) {
    m_route_key = route_key;
    m_route_key_isSet = true;
}

bool OAIRouteCreate::is_route_key_Set() const{
    return m_route_key_isSet;
}

bool OAIRouteCreate::is_route_key_Valid() const{
    return m_route_key_isValid;
}

QList<OAIRule> OAIRouteCreate::getRules() const {
    return m_rules;
}
void OAIRouteCreate::setRules(const QList<OAIRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIRouteCreate::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIRouteCreate::is_rules_Valid() const{
    return m_rules_isValid;
}

QString OAIRouteCreate::getSharedRulesKey() const {
    return m_shared_rules_key;
}
void OAIRouteCreate::setSharedRulesKey(const QString &shared_rules_key) {
    m_shared_rules_key = shared_rules_key;
    m_shared_rules_key_isSet = true;
}

bool OAIRouteCreate::is_shared_rules_key_Set() const{
    return m_shared_rules_key_isSet;
}

bool OAIRouteCreate::is_shared_rules_key_Valid() const{
    return m_shared_rules_key_isValid;
}

QString OAIRouteCreate::getZoneKey() const {
    return m_zone_key;
}
void OAIRouteCreate::setZoneKey(const QString &zone_key) {
    m_zone_key = zone_key;
    m_zone_key_isSet = true;
}

bool OAIRouteCreate::is_zone_key_Set() const{
    return m_zone_key_isSet;
}

bool OAIRouteCreate::is_zone_key_Valid() const{
    return m_zone_key_isValid;
}

bool OAIRouteCreate::isSet() const {
...
bool OAIRouteCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_domain_key_isValid && m_path_isValid && m_shared_rules_key_isValid && m_zone_key_isValid && true;
}
