...
/*
 * OAISharedRulesFilter.h
 *
 * 
 */

#ifndef OAISharedRulesFilter_H
#define OAISharedRulesFilter_H
...
class OAISharedRulesFilter : public OAIObject {
public:
    OAISharedRulesFilter();
    OAISharedRulesFilter(QString json);
    ~OAISharedRulesFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedRulesFilter)

#endif // OAISharedRulesFilter_H
