...
#ifndef OAIRouteCreate_H
#define OAIRouteCreate_H
...
class OAIRouteCreate : public OAIObject {
public:
    OAIRouteCreate();
    OAIRouteCreate(QString json);
    ~OAIRouteCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteCreate)

#endif // OAIRouteCreate_H
