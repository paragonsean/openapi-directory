...
/*
 * OAISharedRulesCreate.h
 *
 * 
 */

#ifndef OAISharedRulesCreate_H
#define OAISharedRulesCreate_H
...
class OAISharedRulesCreate : public OAIObject {
public:
    OAISharedRulesCreate();
    OAISharedRulesCreate(QString json);
    ~OAISharedRulesCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedRulesCreate)

#endif // OAISharedRulesCreate_H
