...
#ifndef OAIClusterFilter_H
#define OAIClusterFilter_H
...
class OAIClusterFilter : public OAIObject {
public:
    OAIClusterFilter();
    OAIClusterFilter(QString json);
    ~OAIClusterFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterFilter)

#endif // OAIClusterFilter_H
