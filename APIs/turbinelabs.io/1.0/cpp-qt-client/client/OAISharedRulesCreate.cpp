...
OAISharedRulesCreate::OAISharedRulesCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISharedRulesCreate::OAISharedRulesCreate() {
    this->initializeModel();
}

OAISharedRulesCreate::~OAISharedRulesCreate() {}

void OAISharedRulesCreate::initializeModel() {
...
void OAISharedRulesCreate::fromJson(QString jsonString) {
...
void OAISharedRulesCreate::fromJsonObject(QJsonObject json) {
...
QString OAISharedRulesCreate::asJson() const {
...
QJsonObject OAISharedRulesCreate::asJsonObject() const {
    QJsonObject obj;
    if (m_checksum_isSet) {
...
QString OAISharedRulesCreate::getChecksum() const {
    return m_checksum;
}
void OAISharedRulesCreate::setChecksum(const QString &checksum) {
    m_checksum = checksum;
    m_checksum_isSet = true;
}

bool OAISharedRulesCreate::is_checksum_Set() const{
    return m_checksum_isSet;
}

bool OAISharedRulesCreate::is_checksum_Valid() const{
    return m_checksum_isValid;
}

OAICohortSeed OAISharedRulesCreate::getCohortSeed() const {
    return m_cohort_seed;
}
void OAISharedRulesCreate::setCohortSeed(const OAICohortSeed &cohort_seed) {
    m_cohort_seed = cohort_seed;
    m_cohort_seed_isSet = true;
}

bool OAISharedRulesCreate::is_cohort_seed_Set() const{
    return m_cohort_seed_isSet;
}

bool OAISharedRulesCreate::is_cohort_seed_Valid() const{
    return m_cohort_seed_isValid;
}

OAIAllConstraints OAISharedRulesCreate::getRDefault() const {
    return m_r_default;
}
void OAISharedRulesCreate::setRDefault(const OAIAllConstraints &r_default) {
    m_r_default = r_default;
    m_r_default_isSet = true;
}

bool OAISharedRulesCreate::is_r_default_Set() const{
    return m_r_default_isSet;
}

bool OAISharedRulesCreate::is_r_default_Valid() const{
    return m_r_default_isValid;
}

QList<OAIMetadatum> OAISharedRulesCreate::getProperties() const {
    return m_properties;
}
void OAISharedRulesCreate::setProperties(const QList<OAIMetadatum> &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAISharedRulesCreate::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAISharedRulesCreate::is_properties_Valid() const{
    return m_properties_isValid;
}

OAIResponseData OAISharedRulesCreate::getResponseData() const {
    return m_response_data;
}
void OAISharedRulesCreate::setResponseData(const OAIResponseData &response_data) {
    m_response_data = response_data;
    m_response_data_isSet = true;
}

bool OAISharedRulesCreate::is_response_data_Set() const{
    return m_response_data_isSet;
}

bool OAISharedRulesCreate::is_response_data_Valid() const{
    return m_response_data_isValid;
}

OAIRetryPolicy OAISharedRulesCreate::getRetryPolicy() const {
    return m_retry_policy;
}
void OAISharedRulesCreate::setRetryPolicy(const OAIRetryPolicy &retry_policy) {
    m_retry_policy = retry_policy;
    m_retry_policy_isSet = true;
}

bool OAISharedRulesCreate::is_retry_policy_Set() const{
    return m_retry_policy_isSet;
}

bool OAISharedRulesCreate::is_retry_policy_Valid() const{
    return m_retry_policy_isValid;
}

QList<OAIRule> OAISharedRulesCreate::getRules() const {
    return m_rules;
}
void OAISharedRulesCreate::setRules(const QList<OAIRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAISharedRulesCreate::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAISharedRulesCreate::is_rules_Valid() const{
    return m_rules_isValid;
}

QString OAISharedRulesCreate::getSharedRulesKey() const {
    return m_shared_rules_key;
}
void OAISharedRulesCreate::setSharedRulesKey(const QString &shared_rules_key) {
    m_shared_rules_key = shared_rules_key;
    m_shared_rules_key_isSet = true;
}

bool OAISharedRulesCreate::is_shared_rules_key_Set() const{
    return m_shared_rules_key_isSet;
}

bool OAISharedRulesCreate::is_shared_rules_key_Valid() const{
    return m_shared_rules_key_isValid;
}

QString OAISharedRulesCreate::getZoneKey() const {
    return m_zone_key;
}
void OAISharedRulesCreate::setZoneKey(const QString &zone_key) {
    m_zone_key = zone_key;
    m_zone_key_isSet = true;
}

bool OAISharedRulesCreate::is_zone_key_Set() const{
    return m_zone_key_isSet;
}

bool OAISharedRulesCreate::is_zone_key_Valid() const{
    return m_zone_key_isValid;
}

bool OAISharedRulesCreate::isSet() const {
...
bool OAISharedRulesCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_r_default_isValid && m_zone_key_isValid && true;
}
