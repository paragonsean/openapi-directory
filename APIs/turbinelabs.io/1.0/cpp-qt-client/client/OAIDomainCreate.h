...
#ifndef OAIDomainCreate_H
#define OAIDomainCreate_H
...
class OAIDomainCreate : public OAIObject {
public:
    OAIDomainCreate();
    OAIDomainCreate(QString json);
    ~OAIDomainCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainCreate)

#endif // OAIDomainCreate_H
