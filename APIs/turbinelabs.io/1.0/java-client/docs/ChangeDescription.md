...
|**at** | **BigDecimal** | When the change took place in milliseconds since the Unix epoch. |  [optional] |
|**comment** | **String** | A description of the change. |  [optional] |
|**diffs** | [**List&lt;ChangeEntry&gt;**](ChangeEntry.md) | A collection of attribute updates that compose this change. |  [optional] |
