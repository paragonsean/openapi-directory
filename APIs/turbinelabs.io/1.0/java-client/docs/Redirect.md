...
|**headerConstraints** | [**List&lt;HeaderConstraint&gt;**](HeaderConstraint.md) |  |  [optional] |
|**name** | **String** | A unique (to this Domain) name for the Redirect. Must match the regexp \&quot;^[0-9a-zA-Z-]+$\&quot; |  |
|**redirectType** | [**RedirectTypeEnum**](#RedirectTypeEnum) | How this redirect should be presented via HTTP response code. |  |
