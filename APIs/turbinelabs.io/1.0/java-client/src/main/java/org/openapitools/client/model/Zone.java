...
public class Zone {
  ...
  public Zone checksum(String checksum) {
  ...
  public Zone zoneKey(String zoneKey) {
  ...
  public boolean equals(Object o) {
    ...
    Zone zone = (Zone) o;
    return Objects.equals(this.checksum, zone.checksum) &&
        Objects.equals(this.name, zone.name) &&
        Objects.equals(this.zoneKey, zone.zoneKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checksum, name, zoneKey);
  }
