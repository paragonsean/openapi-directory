...
public class SharedRules {
  ...
  public SharedRules checksum(String checksum) {
  ...
  public SharedRules cohortSeed(CohortSeed cohortSeed) {
  ...
  public SharedRules _default(AllConstraints _default) {
  ...
  public SharedRules properties(List<Metadatum> properties) {
    this.properties = properties;
    return this;
  }

  public SharedRules addPropertiesItem(Metadatum propertiesItem) {
  ...
  public SharedRules responseData(ResponseData responseData) {
  ...
  public SharedRules retryPolicy(RetryPolicy retryPolicy) {
  ...
  public SharedRules rules(List<Rule> rules) {
    this.rules = rules;
    return this;
  }

  public SharedRules addRulesItem(Rule rulesItem) {
    if (this.rules == null) {
  ...
  public SharedRules sharedRulesKey(String sharedRulesKey) {
  ...
  public SharedRules zoneKey(String zoneKey) {
  ...
  public boolean equals(Object o) {
    ...
    SharedRules sharedRules = (SharedRules) o;
    return Objects.equals(this.checksum, sharedRules.checksum) &&
        Objects.equals(this.cohortSeed, sharedRules.cohortSeed) &&
        Objects.equals(this._default, sharedRules._default) &&
        Objects.equals(this.properties, sharedRules.properties) &&
        Objects.equals(this.responseData, sharedRules.responseData) &&
        Objects.equals(this.retryPolicy, sharedRules.retryPolicy) &&
        Objects.equals(this.rules, sharedRules.rules) &&
        Objects.equals(this.sharedRulesKey, sharedRules.sharedRulesKey) &&
        Objects.equals(this.zoneKey, sharedRules.zoneKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SharedRules
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedRules is not found in the empty JSON string", SharedRules.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SharedRules.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SharedRules` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SharedRules.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedRules.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedRules' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedRules> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedRules.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedRules>() {
           @Override
           public void write(JsonWriter out, SharedRules value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SharedRules read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SharedRules given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SharedRules
   * @throws IOException if the JSON string is invalid with respect to SharedRules
   */
  public static SharedRules fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SharedRules.class);
  }

  /**
   * Convert an instance of SharedRules to an JSON string
   *
   * @return JSON string
   */
