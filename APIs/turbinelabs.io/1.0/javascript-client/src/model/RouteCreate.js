...
/**
 * The RouteCreate model module.
 * @module model/RouteCreate
 * @version 1.0
 */
class RouteCreate {
    /**
     * Constructs a new <code>RouteCreate</code>.
     * @alias module:model/RouteCreate
     * @param domainKey {String} 
     * @param path {String} 
     * @param sharedRulesKey {String} 
     * @param zoneKey {String} 
     */
    constructor(domainKey, path, sharedRulesKey, zoneKey) { 
     ...
     */
    static initialize(obj, domainKey, path, sharedRulesKey, zoneKey) { 
    ...
    /**
     * Constructs a <code>RouteCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteCreate} obj Optional instance to populate.
     * @return {module:model/RouteCreate} The populated <code>RouteCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>RouteCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RouteCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RouteCreate.RequiredProperties) {
...
RouteCreate.RequiredProperties = ["domain_key", "path", "shared_rules_key", "zone_key"];
