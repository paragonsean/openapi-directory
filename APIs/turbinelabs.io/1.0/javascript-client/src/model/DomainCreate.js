...
/**
 * The DomainCreate model module.
 * @module model/DomainCreate
 * @version 1.0
 */
class DomainCreate {
    /**
     * Constructs a new <code>DomainCreate</code>.
     * @alias module:model/DomainCreate
     * @param name {String} 
     * @param port {Number} 
     * @param zoneKey {String} 
     */
    constructor(name, port, zoneKey) { 
     ...
     */
    static initialize(obj, name, port, zoneKey) { 
        obj['name'] = name;
        obj['port'] = port;
    ...
    /**
     * Constructs a <code>DomainCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainCreate} obj Optional instance to populate.
     * @return {module:model/DomainCreate} The populated <code>DomainCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DomainCreate.RequiredProperties) {
...
DomainCreate.RequiredProperties = ["name", "port", "zone_key"];
