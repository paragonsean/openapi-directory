...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurbineLabsApi.ChangeEntry();
  });
  ...
  describe('ChangeEntry', function() {
    it('should create an instance of ChangeEntry', function() {
      // uncomment below and update the code to test ChangeEntry
      //var instance = new TurbineLabsApi.ChangeEntry();
      //expect(instance).to.be.a(TurbineLabsApi.ChangeEntry);
    });
