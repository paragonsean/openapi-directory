...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurbineLabsApi.DomainCreate();
  });
  ...
  describe('DomainCreate', function() {
    it('should create an instance of DomainCreate', function() {
      // uncomment below and update the code to test DomainCreate
      //var instance = new TurbineLabsApi.DomainCreate();
      //expect(instance).to.be.a(TurbineLabsApi.DomainCreate);
    });
