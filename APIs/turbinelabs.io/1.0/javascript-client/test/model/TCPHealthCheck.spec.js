...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurbineLabsApi.TCPHealthCheck();
  });
  ...
  describe('TCPHealthCheck', function() {
    it('should create an instance of TCPHealthCheck', function() {
      // uncomment below and update the code to test TCPHealthCheck
      //var instance = new TurbineLabsApi.TCPHealthCheck();
      //expect(instance).to.be.a(TurbineLabsApi.TCPHealthCheck);
    });
