# TurbineLabsApi.HTTPHealthCheck
...
**requestHeadersToAdd** | [**[Metadatum]**](Metadatum.md) | Specifies a list of HTTP headers that should be added to each request sent to the health checked cluster.  | [optional] 
