...
class SharedRules(Model):
    ...
    def __init__(self, checksum: str=None, cohort_seed: CohortSeed=None, default: AllConstraints=None, properties: List[Metadatum]=None, response_data: ResponseData=None, retry_policy: RetryPolicy=None, rules: List[Rule]=None, shared_rules_key: str=None, zone_key: str=None):
        """SharedRules - a model defined in OpenAPI

        :param checksum: The checksum of this SharedRules.
        :param cohort_seed: The cohort_seed of this SharedRules.
        :param default: The default of this SharedRules.
        :param properties: The properties of this SharedRules.
        :param response_data: The response_data of this SharedRules.
        :param retry_policy: The retry_policy of this SharedRules.
        :param rules: The rules of this SharedRules.
        :param shared_rules_key: The shared_rules_key of this SharedRules.
        :param zone_key: The zone_key of this SharedRules.
        """
        self.openapi_types = {
            'checksum': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SharedRules':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SharedRules of this SharedRules.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def checksum(self):
        """Gets the checksum of this SharedRules.


        :return: The checksum of this SharedRules.
        :rtype: str
        """
    ...
    def checksum(self, checksum):
        """Sets the checksum of this SharedRules.
    ...
    def cohort_seed(self):
        """Gets the cohort_seed of this SharedRules.


        :return: The cohort_seed of this SharedRules.
        :rtype: CohortSeed
        """
    ...
    def cohort_seed(self, cohort_seed):
        """Sets the cohort_seed of this SharedRules.
    ...
    @property
    def default(self):
        """Gets the default of this SharedRules.


        :return: The default of this SharedRules.
    ...
    def default(self, default):
        """Sets the default of this SharedRules.
    ...
    @property
    def properties(self):
        """Gets the properties of this SharedRules.


        :return: The properties of this SharedRules.
    ...
    def properties(self, properties):
        """Sets the properties of this SharedRules.
    ...
    def response_data(self):
        """Gets the response_data of this SharedRules.
        ...
        :return: The response_data of this SharedRules.
        :rtype: ResponseData
        """
    ...
    def response_data(self, response_data):
        """Sets the response_data of this SharedRules.
    ...
    def retry_policy(self):
        """Gets the retry_policy of this SharedRules.


        :return: The retry_policy of this SharedRules.
        :rtype: RetryPolicy
        """
    ...
    def retry_policy(self, retry_policy):
        """Sets the retry_policy of this SharedRules.
    ...
    @property
    def rules(self):
        """Gets the rules of this SharedRules.


        :return: The rules of this SharedRules.
        :rtype: List[Rule]
        """
        return self._rules
    ...
    def rules(self, rules):
        """Sets the rules of this SharedRules.
    ...
    def shared_rules_key(self):
        """Gets the shared_rules_key of this SharedRules.


        :return: The shared_rules_key of this SharedRules.
        :rtype: str
        """
    ...
    def shared_rules_key(self, shared_rules_key):
        """Sets the shared_rules_key of this SharedRules.
    ...
    @property
    def zone_key(self):
        """Gets the zone_key of this SharedRules.


        :return: The zone_key of this SharedRules.
        :rtype: str
        """
    ...
    def zone_key(self, zone_key):
        """Sets the zone_key of this SharedRules.
