...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreRevisionStatistics();
  });
  ...
  describe('ScoreRevisionStatistics', function() {
    it('should create an instance of ScoreRevisionStatistics', function() {
      // uncomment below and update the code to test ScoreRevisionStatistics
      //var instance = new FlatApi.ScoreRevisionStatistics();
      //expect(instance).to.be.a(FlatApi.ScoreRevisionStatistics);
    });
