...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.AssignmentSubmissionComment();
  });
  ...
  describe('AssignmentSubmissionComment', function() {
    it('should create an instance of AssignmentSubmissionComment', function() {
      // uncomment below and update the code to test AssignmentSubmissionComment
      //var instance = new FlatApi.AssignmentSubmissionComment();
      //expect(instance).to.be.a(FlatApi.AssignmentSubmissionComment);
    });
