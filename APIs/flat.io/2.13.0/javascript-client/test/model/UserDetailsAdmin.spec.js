...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.UserDetailsAdmin();
  });
  ...
  describe('UserDetailsAdmin', function() {
    it('should create an instance of UserDetailsAdmin', function() {
      // uncomment below and update the code to test UserDetailsAdmin
      //var instance = new FlatApi.UserDetailsAdmin();
      //expect(instance).to.be.a(FlatApi.UserDetailsAdmin);
    });
