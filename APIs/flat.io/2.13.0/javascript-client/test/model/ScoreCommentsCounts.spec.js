...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCommentsCounts();
  });
  ...
  describe('ScoreCommentsCounts', function() {
    it('should create an instance of ScoreCommentsCounts', function() {
      // uncomment below and update the code to test ScoreCommentsCounts
      //var instance = new FlatApi.ScoreCommentsCounts();
      //expect(instance).to.be.a(FlatApi.ScoreCommentsCounts);
    });
