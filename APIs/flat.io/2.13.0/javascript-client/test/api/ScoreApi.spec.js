...
(function(root, factory) {
  ...
  describe('ScoreApi', function() {
    ...
    describe('gerUserLikes_0', function() {
      it('should call gerUserLikes_0 successfully', function(done) {
        //uncomment below and update the code to test gerUserLikes_0
        //instance.gerUserLikes_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getGroupScores_0', function() {
      it('should call getGroupScores_0 successfully', function(done) {
        //uncomment below and update the code to test getGroupScores_0
        //instance.getGroupScores_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUserScores_0', function() {
      it('should call getUserScores_0 successfully', function(done) {
        //uncomment below and update the code to test getUserScores_0
        //instance.getUserScores_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
