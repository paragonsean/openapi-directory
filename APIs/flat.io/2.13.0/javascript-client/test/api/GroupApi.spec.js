...
(function(root, factory) {
  ...
  describe('GroupApi', function() {
    describe('getGroupDetails', function() {
      it('should call getGroupDetails successfully', function(done) {
        //uncomment below and update the code to test getGroupDetails
        //instance.getGroupDetails(function(error) {
