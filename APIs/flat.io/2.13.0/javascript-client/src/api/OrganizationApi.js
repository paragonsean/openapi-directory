...
export default class OrganizationApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the countOrgaUsers operation.
     * @callback module:api/OrganizationApi~countOrgaUsersCallback
     ...
     * @param {Array.<module:model/String>} [role] Filter users by role
     ...
     * @param {module:api/OrganizationApi~countOrgaUsersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/UserDetailsAdmin>}
     */
    countOrgaUsers(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'q': opts['q'],
        'group': this.apiClient.buildCollectionParam(opts['group'], 'multi'),
        'noActiveLicense': opts['noActiveLicense']
      };
      let headerParams = {
      };
      let formParams = {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/OrganizationInvitationCreation} [body] 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UserCreation} [body] 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [role] Filter users by role
     * @param {Number} [limit = 50)] This is the maximum number of objects that may be returned
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/String>} [sort] The order to sort the user list
    ...
    listOrganizationUsers(opts, callback) {
      ...
      let queryParams = {
        ...
        'group': this.apiClient.buildCollectionParam(opts['group'], 'multi'),
        'noActiveLicense': opts['noActiveLicense'],
        'licenseExpirationDate': this.apiClient.buildCollectionParam(opts['licenseExpirationDate'], 'multi'),
