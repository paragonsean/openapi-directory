...
class ClassDetailsGoogleDrive {
    ...
    constructor() { 
        ...
        ClassDetailsGoogleDrive.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClassDetailsGoogleDrive();
    ...
    /**
     * Validates the JSON data with respect to <code>ClassDetailsGoogleDrive</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClassDetailsGoogleDrive</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['teacherFolderAlternateLink'] && !(typeof data['teacherFolderAlternateLink'] === 'string' || data['teacherFolderAlternateLink'] instanceof String)) {
            throw new Error("Expected the field `teacherFolderAlternateLink` to be a primitive type in the JSON string but got " + data['teacherFolderAlternateLink']);
        }
        // ensure the json data is a string
        if (data['teacherFolderId'] && !(typeof data['teacherFolderId'] === 'string' || data['teacherFolderId'] instanceof String)) {
            throw new Error("Expected the field `teacherFolderId` to be a primitive type in the JSON string but got " + data['teacherFolderId']);
        }
 ...
 */
ClassDetailsGoogleDrive.prototype['teacherFolderAlternateLink'] = undefined;

/**
 * [Teachers only] The Drive directory identifier of the teachers' folder 
 * @member {String} teacherFolderId
 */
ClassDetailsGoogleDrive.prototype['teacherFolderId'] = undefined;
...
export default ClassDetailsGoogleDrive;
