...
class OrganizationInvitation {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['invitedBy'] && !(typeof data['invitedBy'] === 'string' || data['invitedBy'] instanceof String)) {
            throw new Error("Expected the field `invitedBy` to be a primitive type in the JSON string but got " + data['invitedBy']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['usedBy'] && !(typeof data['usedBy'] === 'string' || data['usedBy'] instanceof String)) {
            throw new Error("Expected the field `usedBy` to be a primitive type in the JSON string but got " + data['usedBy']);
        }
