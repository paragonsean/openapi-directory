...
class UserPublic {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('coverPicture')) {
                obj['coverPicture'] = ApiClient.convertToType(data['coverPicture'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['coverPicture'] && !(typeof data['coverPicture'] === 'string' || data['coverPicture'] instanceof String)) {
            throw new Error("Expected the field `coverPicture` to be a primitive type in the JSON string but got " + data['coverPicture']);
        }
        ...
        // ensure the json data is a string
        if (data['profileTheme'] && !(typeof data['profileTheme'] === 'string' || data['profileTheme'] instanceof String)) {
            throw new Error("Expected the field `profileTheme` to be a primitive type in the JSON string but got " + data['profileTheme']);
        }
