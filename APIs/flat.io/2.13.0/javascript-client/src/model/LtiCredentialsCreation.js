...
class LtiCredentialsCreation {
     ...
     */
    constructor(lms, name) { 
        
        LtiCredentialsCreation.initialize(this, lms, name);
    }
     ...
     */
    static initialize(obj, lms, name) { 
        obj['lms'] = lms;
        obj['name'] = name;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LtiCredentialsCreation();
    ...
    /**
     * Validates the JSON data with respect to <code>LtiCredentialsCreation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LtiCredentialsCreation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LtiCredentialsCreation.RequiredProperties) {
...
LtiCredentialsCreation.RequiredProperties = ["lms", "name"];

/**
 * @member {module:model/LmsName} lms
 */
LtiCredentialsCreation.prototype['lms'] = undefined;

/**
 * Name of the couple of credentials
 * @member {String} name
 */
LtiCredentialsCreation.prototype['name'] = undefined;
...
export default LtiCredentialsCreation;
