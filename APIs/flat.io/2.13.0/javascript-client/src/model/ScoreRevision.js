...
class ScoreRevision {
    ...
    /**
     * Validates the JSON data with respect to <code>ScoreRevision</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoreRevision</code>.
     */
    static validateJSON(data) {
        ...
        if (data['statistics']) { // data not null
          ScoreRevisionStatistics.validateJSON(data['statistics']);
        }
        // ensure the json data is a string
