...
class FlatErrorResponse {
    ...
    constructor() { 
        ...
        FlatErrorResponse.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FlatErrorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FlatErrorResponse</code>.
     */
 ...
 * @member {String} code
 */
FlatErrorResponse.prototype['code'] = undefined;

/**
 * An unique error identifier generated for the request
 * @member {String} id
 */
FlatErrorResponse.prototype['id'] = undefined;

/**
 * A printable message for this message
 * @member {String} message
 */
FlatErrorResponse.prototype['message'] = undefined;

/**
 * The related parameter that caused the error
 * @member {String} param
 */
FlatErrorResponse.prototype['param'] = undefined;
...
export default FlatErrorResponse;
