...
class ScoreRevisionCreation {
    ...
    /**
     * Validates the JSON data with respect to <code>ScoreRevisionCreation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoreRevisionCreation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoreRevisionCreation.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['dataEncoding'] && !(typeof data['dataEncoding'] === 'string' || data['dataEncoding'] instanceof String)) {
            throw new Error("Expected the field `dataEncoding` to be a primitive type in the JSON string but got " + data['dataEncoding']);
        }
        // ensure the json data is a string
...
ScoreRevisionCreation.RequiredProperties = ["data"];
