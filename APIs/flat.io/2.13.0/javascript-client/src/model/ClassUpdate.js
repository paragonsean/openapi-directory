...
class ClassUpdate {
    ...
    /**
     * Validates the JSON data with respect to <code>ClassUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClassUpdate</code>.
     */
 ...
 * @member {String} name
 */
ClassUpdate.prototype['name'] = undefined;

/**
 * The section of the class
 * @member {String} section
 */
ClassUpdate.prototype['section'] = undefined;
