...
class AssignmentCopy {
    ...
    constructor() { 
        ...
        AssignmentCopy.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AssignmentCopy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssignmentCopy</code>.
     */
 ...
 */
AssignmentCopy.prototype['assignment'] = undefined;
 ...
 */
AssignmentCopy.prototype['scheduledDate'] = undefined;
