...
class ScoreSource {
    ...
    /**
     * Validates the JSON data with respect to <code>ScoreSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoreSource</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['googleDrive'] && !(typeof data['googleDrive'] === 'string' || data['googleDrive'] instanceof String)) {
            throw new Error("Expected the field `googleDrive` to be a primitive type in the JSON string but got " + data['googleDrive']);
        }
