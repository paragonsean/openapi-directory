...
> [UserDetailsAdmin] countOrgaUsers(opts)
...
let opts = {
  'role': ["null"], // [String] | Filter users by role
  'q': "q_example", // String | The query to search
  'group': ["null"], // [String] | Filter users by group
  'noActiveLicense': true // Boolean | Filter users who don't have an active license
};
apiInstance.countOrgaUsers(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **role** | [**[String]**](String.md)| Filter users by role | [optional] 
 **q** | **String**| The query to search | [optional] 
 **group** | [**[String]**](String.md)| Filter users by group | [optional] 
...
let apiInstance = new FlatApi.OrganizationApi();
let opts = {
  'sort': ["null"], // [String] | The order to sort the user list
  ...
  'group': ["null"], // [String] | Filter users by group
  'noActiveLicense': true, // Boolean | Filter users who don't have an active license
  'licenseExpirationDate': ["null"], // [String] | Filter users by license expiration date or `active` / `notActive`
  'onlyIds': true, // Boolean | Return only user ids
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sort** | [**[String]**](String.md)| The order to sort the user list | [optional] 
 ...
 **group** | [**[String]**](String.md)| Filter users by group | [optional] 
 **noActiveLicense** | **Boolean**| Filter users who don&#39;t have an active license | [optional] 
 **licenseExpirationDate** | [**[String]**](String.md)| Filter users by license expiration date or &#x60;active&#x60; / &#x60;notActive&#x60; | [optional] 
