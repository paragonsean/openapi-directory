...
> [ScoreDetails] gerUserLikes_0(user, opts)
...
apiInstance.gerUserLikes_0(user, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ScoreDetails] getGroupScores_0(group, opts)
...
apiInstance.getGroupScores_0(group, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ScoreDetails] getUserScores_0(user, opts)
...
apiInstance.getUserScores_0(user, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  ...
  'listAutoTrack': true // Boolean | If true, and if available, return last automatically synchronized Flat's mp3 export as an additional track 
};
