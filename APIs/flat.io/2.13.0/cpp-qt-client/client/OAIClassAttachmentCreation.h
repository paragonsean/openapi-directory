...
#ifndef OAIClassAttachmentCreation_H
#define OAIClassAttachmentCreation_H
...
class OAIClassAttachmentCreation : public OAIObject {
public:
    OAIClassAttachmentCreation();
    OAIClassAttachmentCreation(QString json);
    ~OAIClassAttachmentCreation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClassAttachmentCreation)

#endif // OAIClassAttachmentCreation_H
