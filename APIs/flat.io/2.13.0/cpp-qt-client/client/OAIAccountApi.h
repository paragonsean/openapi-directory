...
public:
    ...
    /**
    * @param[in]  only_id bool [optional]
    */
    virtual void getAuthenticatedUser(const ::OpenAPI::OptionalParam<bool> &only_id = ::OpenAPI::OptionalParam<bool>());
...
Q_SIGNALS:
    ...
    void getAuthenticatedUserSignal(OAIUserDetails summary);


    void getAuthenticatedUserSignalFull(OAIHttpRequestWorker *worker, OAIUserDetails summary);

    Q_DECL_DEPRECATED_X("Use getAuthenticatedUserSignalError() instead")
    void getAuthenticatedUserSignalE(OAIUserDetails summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAuthenticatedUserSignalError(OAIUserDetails summary, QNetworkReply::NetworkError error_type, const QString &error_str);
