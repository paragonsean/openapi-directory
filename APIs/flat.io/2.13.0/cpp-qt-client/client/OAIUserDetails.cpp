...
void OAIUserDetails::initializeModel() {
    ...
    m_cover_picture_file_isSet = false;
    m_cover_picture_file_isValid = false;

    m_locale_isSet = false;
    m_locale_isValid = false;

    m_picture_file_isSet = false;
    m_picture_file_isValid = false;

    m_private_profile_isSet = false;
    m_private_profile_isValid = false;
}
...
void OAIUserDetails::fromJsonObject(QJsonObject json) {
    ...
    m_cover_picture_file_isValid = ::OpenAPI::fromJsonValue(m_cover_picture_file, json[QString("coverPictureFile")]);
    m_cover_picture_file_isSet = !json[QString("coverPictureFile")].isNull() && m_cover_picture_file_isValid;

    m_locale_isValid = ::OpenAPI::fromJsonValue(m_locale, json[QString("locale")]);
    m_locale_isSet = !json[QString("locale")].isNull() && m_locale_isValid;

    m_picture_file_isValid = ::OpenAPI::fromJsonValue(m_picture_file, json[QString("pictureFile")]);
    m_picture_file_isSet = !json[QString("pictureFile")].isNull() && m_picture_file_isValid;

    m_private_profile_isValid = ::OpenAPI::fromJsonValue(m_private_profile, json[QString("privateProfile")]);
    m_private_profile_isSet = !json[QString("privateProfile")].isNull() && m_private_profile_isValid;
}
...
QJsonObject OAIUserDetails::asJsonObject() const {
    ...
    if (m_cover_picture_file_isSet) {
        obj.insert(QString("coverPictureFile"), ::OpenAPI::toJsonValue(m_cover_picture_file));
    }
    if (m_locale.isSet()) {
        obj.insert(QString("locale"), ::OpenAPI::toJsonValue(m_locale));
    }
    if (m_picture_file_isSet) {
        obj.insert(QString("pictureFile"), ::OpenAPI::toJsonValue(m_picture_file));
    }
    if (m_private_profile_isSet) {
        obj.insert(QString("privateProfile"), ::OpenAPI::toJsonValue(m_private_profile));
    }
    return obj;
}
...
bool OAIUserDetails::isIsFlatTeam() const {
    return m_is_flat_team;
}
void OAIUserDetails::setIsFlatTeam(const bool &is_flat_team) {
    m_is_flat_team = is_flat_team;
    m_is_flat_team_isSet = true;
}

bool OAIUserDetails::is_is_flat_team_Set() const{
    return m_is_flat_team_isSet;
}

bool OAIUserDetails::is_is_flat_team_Valid() const{
    return m_is_flat_team_isValid;
}

bool OAIUserDetails::isIsPowerUser() const {
    return m_is_power_user;
}
void OAIUserDetails::setIsPowerUser(const bool &is_power_user) {
    m_is_power_user = is_power_user;
    m_is_power_user_isSet = true;
}

bool OAIUserDetails::is_is_power_user_Set() const{
    return m_is_power_user_isSet;
}

bool OAIUserDetails::is_is_power_user_Valid() const{
...
QString OAIUserDetails::getPicture() const {
    return m_picture;
}
void OAIUserDetails::setPicture(const QString &picture) {
    m_picture = picture;
    m_picture_isSet = true;
}

bool OAIUserDetails::is_picture_Set() const{
    return m_picture_isSet;
}

bool OAIUserDetails::is_picture_Valid() const{
    return m_picture_isValid;
}

QString OAIUserDetails::getPrintableName() const {
    return m_printable_name;
}
void OAIUserDetails::setPrintableName(const QString &printable_name) {
    m_printable_name = printable_name;
    m_printable_name_isSet = true;
}

bool OAIUserDetails::is_printable_name_Set() const{
    return m_printable_name_isSet;
}

bool OAIUserDetails::is_printable_name_Valid() const{
    return m_printable_name_isValid;
}

QString OAIUserDetails::getType() const {
    return m_type;
}
void OAIUserDetails::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUserDetails::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUserDetails::is_type_Valid() const{
...
OAIClassRoles OAIUserDetails::getClassRole() const {
    return m_class_role;
}
void OAIUserDetails::setClassRole(const OAIClassRoles &class_role) {
    m_class_role = class_role;
    m_class_role_isSet = true;
}

bool OAIUserDetails::is_class_role_Set() const{
    return m_class_role_isSet;
}

bool OAIUserDetails::is_class_role_Valid() const{
    return m_class_role_isValid;
}

QString OAIUserDetails::getHtmlUrl() const {
    return m_html_url;
}
void OAIUserDetails::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIUserDetails::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIUserDetails::is_html_url_Valid() const{
    return m_html_url_isValid;
}

QString OAIUserDetails::getOrganization() const {
    return m_organization;
}
void OAIUserDetails::setOrganization(const QString &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIUserDetails::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIUserDetails::is_organization_Valid() const{
    return m_organization_isValid;
}

OAIOrganizationRoles OAIUserDetails::getOrganizationRole() const {
    return m_organization_role;
}
void OAIUserDetails::setOrganizationRole(const OAIOrganizationRoles &organization_role) {
    m_organization_role = organization_role;
    m_organization_role_isSet = true;
}

bool OAIUserDetails::is_organization_role_Set() const{
    return m_organization_role_isSet;
}

bool OAIUserDetails::is_organization_role_Valid() const{
    return m_organization_role_isValid;
}

QString OAIUserDetails::getBio() const {
    return m_bio;
}
void OAIUserDetails::setBio(const QString &bio) {
    m_bio = bio;
    m_bio_isSet = true;
}

bool OAIUserDetails::is_bio_Set() const{
    return m_bio_isSet;
}

bool OAIUserDetails::is_bio_Valid() const{
    return m_bio_isValid;
}

QString OAIUserDetails::getCoverPicture() const {
    return m_cover_picture;
}
void OAIUserDetails::setCoverPicture(const QString &cover_picture) {
    m_cover_picture = cover_picture;
    m_cover_picture_isSet = true;
}

bool OAIUserDetails::is_cover_picture_Set() const{
    return m_cover_picture_isSet;
}

bool OAIUserDetails::is_cover_picture_Valid() const{
    return m_cover_picture_isValid;
}

qint32 OAIUserDetails::getFollowersCount() const {
    return m_followers_count;
}
void OAIUserDetails::setFollowersCount(const qint32 &followers_count) {
    m_followers_count = followers_count;
    m_followers_count_isSet = true;
}

bool OAIUserDetails::is_followers_count_Set() const{
    return m_followers_count_isSet;
}

bool OAIUserDetails::is_followers_count_Valid() const{
    return m_followers_count_isValid;
}

qint32 OAIUserDetails::getFollowingCount() const {
    return m_following_count;
}
void OAIUserDetails::setFollowingCount(const qint32 &following_count) {
    m_following_count = following_count;
    m_following_count_isSet = true;
}

bool OAIUserDetails::is_following_count_Set() const{
    return m_following_count_isSet;
}

bool OAIUserDetails::is_following_count_Valid() const{
    return m_following_count_isValid;
}

QList<QString> OAIUserDetails::getInstruments() const {
    return m_instruments;
}
void OAIUserDetails::setInstruments(const QList<QString> &instruments) {
    m_instruments = instruments;
    m_instruments_isSet = true;
}

bool OAIUserDetails::is_instruments_Set() const{
    return m_instruments_isSet;
}

bool OAIUserDetails::is_instruments_Valid() const{
    return m_instruments_isValid;
}

qint32 OAIUserDetails::getLikedScoresCount() const {
    return m_liked_scores_count;
}
void OAIUserDetails::setLikedScoresCount(const qint32 &liked_scores_count) {
    m_liked_scores_count = liked_scores_count;
    m_liked_scores_count_isSet = true;
}

bool OAIUserDetails::is_liked_scores_count_Set() const{
    return m_liked_scores_count_isSet;
}

bool OAIUserDetails::is_liked_scores_count_Valid() const{
    return m_liked_scores_count_isValid;
}

qint32 OAIUserDetails::getOwnedPublicScoresCount() const {
    return m_owned_public_scores_count;
}
void OAIUserDetails::setOwnedPublicScoresCount(const qint32 &owned_public_scores_count) {
    m_owned_public_scores_count = owned_public_scores_count;
    m_owned_public_scores_count_isSet = true;
}

bool OAIUserDetails::is_owned_public_scores_count_Set() const{
    return m_owned_public_scores_count_isSet;
}

bool OAIUserDetails::is_owned_public_scores_count_Valid() const{
    return m_owned_public_scores_count_isValid;
}

QString OAIUserDetails::getProfileTheme() const {
    return m_profile_theme;
}
void OAIUserDetails::setProfileTheme(const QString &profile_theme) {
    m_profile_theme = profile_theme;
    m_profile_theme_isSet = true;
}

bool OAIUserDetails::is_profile_theme_Set() const{
    return m_profile_theme_isSet;
}

bool OAIUserDetails::is_profile_theme_Valid() const{
    return m_profile_theme_isValid;
}

QDateTime OAIUserDetails::getRegistrationDate() const {
    return m_registration_date;
}
void OAIUserDetails::setRegistrationDate(const QDateTime &registration_date) {
    m_registration_date = registration_date;
    m_registration_date_isSet = true;
}

bool OAIUserDetails::is_registration_date_Set() const{
    return m_registration_date_isSet;
}

bool OAIUserDetails::is_registration_date_Valid() const{
    return m_registration_date_isValid;
}

QString OAIUserDetails::getCoverPictureFile() const {
    return m_cover_picture_file;
}
void OAIUserDetails::setCoverPictureFile(const QString &cover_picture_file) {
    m_cover_picture_file = cover_picture_file;
    m_cover_picture_file_isSet = true;
}

bool OAIUserDetails::is_cover_picture_file_Set() const{
    return m_cover_picture_file_isSet;
}

bool OAIUserDetails::is_cover_picture_file_Valid() const{
    return m_cover_picture_file_isValid;
}

OAIFlatLocales OAIUserDetails::getLocale() const {
    return m_locale;
}
void OAIUserDetails::setLocale(const OAIFlatLocales &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIUserDetails::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIUserDetails::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAIUserDetails::getPictureFile() const {
    return m_picture_file;
}
void OAIUserDetails::setPictureFile(const QString &picture_file) {
    m_picture_file = picture_file;
    m_picture_file_isSet = true;
}

bool OAIUserDetails::is_picture_file_Set() const{
    return m_picture_file_isSet;
}

bool OAIUserDetails::is_picture_file_Valid() const{
    return m_picture_file_isValid;
}

bool OAIUserDetails::isPrivateProfile() const {
    return m_private_profile;
}
void OAIUserDetails::setPrivateProfile(const bool &private_profile) {
    m_private_profile = private_profile;
    m_private_profile_isSet = true;
}

bool OAIUserDetails::is_private_profile_Set() const{
    return m_private_profile_isSet;
}

bool OAIUserDetails::is_private_profile_Valid() const{
    return m_private_profile_isValid;
}
