...
/*
 * OAIScoreCommentUpdate.h
 *
 * Update of a comment
 */

#ifndef OAIScoreCommentUpdate_H
#define OAIScoreCommentUpdate_H
...
class OAIScoreCommentUpdate : public OAIObject {
public:
    OAIScoreCommentUpdate();
    OAIScoreCommentUpdate(QString json);
    ~OAIScoreCommentUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreCommentUpdate)

#endif // OAIScoreCommentUpdate_H
