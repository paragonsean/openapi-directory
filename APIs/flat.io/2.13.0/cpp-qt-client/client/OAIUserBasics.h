...
#ifndef OAIUserBasics_H
#define OAIUserBasics_H
...
class OAIUserBasics : public OAIObject {
public:
    OAIUserBasics();
    OAIUserBasics(QString json);
    ~OAIUserBasics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserBasics)

#endif // OAIUserBasics_H
