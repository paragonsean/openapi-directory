...
class OAIScoreViewsCounts : public OAIObject {
public:
    OAIScoreViewsCounts();
    OAIScoreViewsCounts(QString json);
    ~OAIScoreViewsCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreViewsCounts)

#endif // OAIScoreViewsCounts_H
