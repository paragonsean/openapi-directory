...
#ifndef OAIScoreTrack_H
#define OAIScoreTrack_H
...
class OAIScoreTrack : public OAIObject {
public:
    OAIScoreTrack();
    OAIScoreTrack(QString json);
    ~OAIScoreTrack() override;
    ...
    OAIScoreTrackType getType() const;
    void setType(const OAIScoreTrackType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreTrack)

#endif // OAIScoreTrack_H
