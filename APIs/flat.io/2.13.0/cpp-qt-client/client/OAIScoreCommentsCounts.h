...
#ifndef OAIScoreCommentsCounts_H
#define OAIScoreCommentsCounts_H
...
class OAIScoreCommentsCounts : public OAIObject {
public:
    OAIScoreCommentsCounts();
    OAIScoreCommentsCounts(QString json);
    ~OAIScoreCommentsCounts() override;
    ...
    void setUnique(const double &unique);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreCommentsCounts)

#endif // OAIScoreCommentsCounts_H
