...
/*
 * OAIUserAdminUpdate.h
 *
 * User update as an organization admin
 */

#ifndef OAIUserAdminUpdate_H
#define OAIUserAdminUpdate_H
...
class OAIUserAdminUpdate : public OAIObject {
public:
    OAIUserAdminUpdate();
    OAIUserAdminUpdate(QString json);
    ~OAIUserAdminUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserAdminUpdate)

#endif // OAIUserAdminUpdate_H
