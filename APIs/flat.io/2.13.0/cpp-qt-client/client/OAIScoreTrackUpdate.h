...
/*
 * OAIScoreTrackUpdate.h
 *
 * Update an existing track. 
 */

#ifndef OAIScoreTrackUpdate_H
#define OAIScoreTrackUpdate_H
...
class OAIScoreTrackUpdate : public OAIObject {
public:
    OAIScoreTrackUpdate();
    OAIScoreTrackUpdate(QString json);
    ~OAIScoreTrackUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreTrackUpdate)

#endif // OAIScoreTrackUpdate_H
