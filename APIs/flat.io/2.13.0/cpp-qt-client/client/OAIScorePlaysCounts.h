...
class OAIScorePlaysCounts : public OAIObject {
public:
    OAIScorePlaysCounts();
    OAIScorePlaysCounts(QString json);
    ~OAIScorePlaysCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScorePlaysCounts)

#endif // OAIScorePlaysCounts_H
