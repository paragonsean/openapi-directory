...
/*
 * OAIAssignmentSubmissionComment.h
 *
 * Feedback comment added to an assignment submission
 */

#ifndef OAIAssignmentSubmissionComment_H
#define OAIAssignmentSubmissionComment_H
...
class OAIAssignmentSubmissionComment : public OAIObject {
public:
    OAIAssignmentSubmissionComment();
    OAIAssignmentSubmissionComment(QString json);
    ~OAIAssignmentSubmissionComment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssignmentSubmissionComment)

#endif // OAIAssignmentSubmissionComment_H
