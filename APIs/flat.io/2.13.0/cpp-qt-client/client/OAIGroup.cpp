...
QDateTime OAIGroup::getCreationDate() const {
    return m_creation_date;
}
void OAIGroup::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIGroup::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIGroup::is_creation_date_Valid() const{
...
QString OAIGroup::getOrganization() const {
    return m_organization;
}
void OAIGroup::setOrganization(const QString &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIGroup::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIGroup::is_organization_Valid() const{
    return m_organization_isValid;
}

bool OAIGroup::isReadOnly() const {
    return m_read_only;
}
void OAIGroup::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAIGroup::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAIGroup::is_read_only_Valid() const{
...
double OAIGroup::getUsersCount() const {
    return m_users_count;
}
void OAIGroup::setUsersCount(const double &users_count) {
    m_users_count = users_count;
    m_users_count_isSet = true;
}

bool OAIGroup::is_users_count_Set() const{
    return m_users_count_isSet;
}

bool OAIGroup::is_users_count_Valid() const{
