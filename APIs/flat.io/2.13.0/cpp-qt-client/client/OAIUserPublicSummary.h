...
/*
 * OAIUserPublicSummary.h
 *
 * Public User details summary
 */

#ifndef OAIUserPublicSummary_H
#define OAIUserPublicSummary_H
...
class OAIUserPublicSummary : public OAIObject {
public:
    OAIUserPublicSummary();
    OAIUserPublicSummary(QString json);
    ~OAIUserPublicSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPublicSummary)

#endif // OAIUserPublicSummary_H
