...
/**
 * Model tests for ScoreModification
 */
public class ScoreModificationTest {
    private final ScoreModification model = new ScoreModification();
