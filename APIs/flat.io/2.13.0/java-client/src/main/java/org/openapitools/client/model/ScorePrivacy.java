 ...
 */
@JsonAdapter(ScorePrivacy.Adapter.class)
public enum ScorePrivacy {
  ...
  public static ScorePrivacy fromValue(String value) {
    for (ScorePrivacy b : ScorePrivacy.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScorePrivacy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScorePrivacy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScorePrivacy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScorePrivacy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScorePrivacy.fromValue(value);
  }
}
