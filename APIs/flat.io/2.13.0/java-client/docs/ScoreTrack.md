...
|------------ | ------------- | ------------- | -------------|
|**creationDate** | **OffsetDateTime** | The creation date of the track |  [optional] |
...
|**modificationDate** | **OffsetDateTime** | The modification date of the track |  [optional] |
|**score** | **String** | The unique identifier of the score |  [optional] |
|**state** | **ScoreTrackState** |  |  [optional] |
|**synchronizationPoints** | [**List&lt;ScoreTrackPoint&gt;**](ScoreTrackPoint.md) |  |  [optional] |
