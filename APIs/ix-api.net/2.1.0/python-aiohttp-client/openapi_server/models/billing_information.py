...
class BillingInformation(Model):
    ...
    def __init__(self, address: Address=None, name: str=None, vat_number: str=None):
        ...
        :param address: The address of this BillingInformation.
        :param name: The name of this BillingInformation.
        :param vat_number: The vat_number of this BillingInformation.
        """
        self.openapi_types = {
            'address': Address,
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BillingInformation':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BillingInformation of this BillingInformation.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address(self):
        """Gets the address of this BillingInformation.


        :return: The address of this BillingInformation.
        :rtype: Address
        """
    ...
    def address(self, address):
        """Sets the address of this BillingInformation.
    ...
    @property
    def name(self):
        """Gets the name of this BillingInformation.

        Name of the organisation receiving invoices. 

        :return: The name of this BillingInformation.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BillingInformation.
    ...
    @property
    def vat_number(self):
        """Gets the vat_number of this BillingInformation.

        Value-added tax number, required for european reverse charge system. 

        :return: The vat_number of this BillingInformation.
        :rtype: str
        """
    ...
    def vat_number(self, vat_number):
        """Sets the vat_number of this BillingInformation.
