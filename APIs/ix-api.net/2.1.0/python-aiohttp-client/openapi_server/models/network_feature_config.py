...
class NetworkFeatureConfig(Model):
    ...
    def __init__(self, as_set_v4: str=None, as_set_v6: str=None, asn: int=None, bgp_session_type: str=None, billing_account: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, id: str=None, insert_ixp_asn: bool=True, ip: str=None, managing_account: str=None, max_prefix_v4: int=None, max_prefix_v6: int=None, network_feature: str=None, network_service_config: str=None, password: str='', purchase_order: str='', role_assignments: List[str]=None, session_mode: str=None, state: str=None, status: List[Status]=None, type: str=None):
        """NetworkFeatureConfig - a model defined in OpenAPI

        :param as_set_v4: The as_set_v4 of this NetworkFeatureConfig.
        :param as_set_v6: The as_set_v6 of this NetworkFeatureConfig.
        :param asn: The asn of this NetworkFeatureConfig.
        :param bgp_session_type: The bgp_session_type of this NetworkFeatureConfig.
        :param billing_account: The billing_account of this NetworkFeatureConfig.
        :param consuming_account: The consuming_account of this NetworkFeatureConfig.
        :param contract_ref: The contract_ref of this NetworkFeatureConfig.
        :param external_ref: The external_ref of this NetworkFeatureConfig.
        :param id: The id of this NetworkFeatureConfig.
        :param insert_ixp_asn: The insert_ixp_asn of this NetworkFeatureConfig.
        :param ip: The ip of this NetworkFeatureConfig.
        :param managing_account: The managing_account of this NetworkFeatureConfig.
        :param max_prefix_v4: The max_prefix_v4 of this NetworkFeatureConfig.
        :param max_prefix_v6: The max_prefix_v6 of this NetworkFeatureConfig.
        :param network_feature: The network_feature of this NetworkFeatureConfig.
        :param network_service_config: The network_service_config of this NetworkFeatureConfig.
        :param password: The password of this NetworkFeatureConfig.
        :param purchase_order: The purchase_order of this NetworkFeatureConfig.
        :param role_assignments: The role_assignments of this NetworkFeatureConfig.
        :param session_mode: The session_mode of this NetworkFeatureConfig.
        :param state: The state of this NetworkFeatureConfig.
        :param status: The status of this NetworkFeatureConfig.
        :param type: The type of this NetworkFeatureConfig.
        """
        self.openapi_types = {
            'as_set_v4': str,
            'as_set_v6': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NetworkFeatureConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NetworkFeatureConfig of this NetworkFeatureConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def as_set_v4(self):
        """Gets the as_set_v4 of this NetworkFeatureConfig.
        ...
        :return: The as_set_v4 of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def as_set_v4(self, as_set_v4):
        """Sets the as_set_v4 of this NetworkFeatureConfig.
    ...
    @property
    def as_set_v6(self):
        """Gets the as_set_v6 of this NetworkFeatureConfig.
        ...
        :return: The as_set_v6 of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def as_set_v6(self, as_set_v6):
        """Sets the as_set_v6 of this NetworkFeatureConfig.
    ...
    @property
    def asn(self):
        """Gets the asn of this NetworkFeatureConfig.

        The ASN of the peer. 

        :return: The asn of this NetworkFeatureConfig.
        :rtype: int
        """
        return self._asn
    ...
    @asn.setter
    def asn(self, asn):
        """Sets the asn of this NetworkFeatureConfig.
    ...
    def bgp_session_type(self):
        """Gets the bgp_session_type of this NetworkFeatureConfig.
        ...
        :return: The bgp_session_type of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def bgp_session_type(self, bgp_session_type):
        """Sets the bgp_session_type of this NetworkFeatureConfig.
    ...
    def billing_account(self):
        """Gets the billing_account of this NetworkFeatureConfig.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this NetworkFeatureConfig.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this NetworkFeatureConfig.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this NetworkFeatureConfig.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this NetworkFeatureConfig.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this NetworkFeatureConfig.
    ...
    def external_ref(self):
        """Gets the external_ref of this NetworkFeatureConfig.

        Reference field, free to use for the API user.

        :return: The external_ref of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this NetworkFeatureConfig.
    ...
    @property
    def id(self):
        """Gets the id of this NetworkFeatureConfig.


        :return: The id of this NetworkFeatureConfig.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this NetworkFeatureConfig.
    ...
    def insert_ixp_asn(self):
        """Gets the insert_ixp_asn of this NetworkFeatureConfig.
        ...
        :return: The insert_ixp_asn of this NetworkFeatureConfig.
        :rtype: bool
        """
    ...
    def insert_ixp_asn(self, insert_ixp_asn):
        """Sets the insert_ixp_asn of this NetworkFeatureConfig.
    ...
    @property
    def ip(self):
        """Gets the ip of this NetworkFeatureConfig.
        ...
        :return: The ip of this NetworkFeatureConfig.
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        """Sets the ip of this NetworkFeatureConfig.
    ...
    def managing_account(self):
        """Gets the managing_account of this NetworkFeatureConfig.
        ...
        :return: The managing_account of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this NetworkFeatureConfig.
    ...
    def max_prefix_v4(self):
        """Gets the max_prefix_v4 of this NetworkFeatureConfig.

        Announcing more than `max_prefix` IPv4 prefixes the bgp session will be droped. 

        :return: The max_prefix_v4 of this NetworkFeatureConfig.
        :rtype: int
        """
    ...
    def max_prefix_v4(self, max_prefix_v4):
        """Sets the max_prefix_v4 of this NetworkFeatureConfig.
    ...
    def max_prefix_v6(self):
        """Gets the max_prefix_v6 of this NetworkFeatureConfig.

        Announcing more than `max_prefix` IPv6 prefixes the bgp session will be droped. 

        :return: The max_prefix_v6 of this NetworkFeatureConfig.
        :rtype: int
        """
    ...
    def max_prefix_v6(self, max_prefix_v6):
        """Sets the max_prefix_v6 of this NetworkFeatureConfig.
    ...
    def network_feature(self):
        """Gets the network_feature of this NetworkFeatureConfig.


        :return: The network_feature of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def network_feature(self, network_feature):
        """Sets the network_feature of this NetworkFeatureConfig.
    ...
    def network_service_config(self):
        """Gets the network_service_config of this NetworkFeatureConfig.


        :return: The network_service_config of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def network_service_config(self, network_service_config):
        """Sets the network_service_config of this NetworkFeatureConfig.
    ...
    @property
    def password(self):
        """Gets the password of this NetworkFeatureConfig.

        The cleartext BGP session password

        :return: The password of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this NetworkFeatureConfig.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this NetworkFeatureConfig.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this NetworkFeatureConfig.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this NetworkFeatureConfig.
        ...
        :return: The role_assignments of this NetworkFeatureConfig.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this NetworkFeatureConfig.
    ...
    def session_mode(self):
        """Gets the session_mode of this NetworkFeatureConfig.

        Set the session mode with the routeserver. 

        :return: The session_mode of this NetworkFeatureConfig.
        :rtype: str
        """
    ...
    def session_mode(self, session_mode):
        """Sets the session_mode of this NetworkFeatureConfig.
    ...
    @property
    def state(self):
        """Gets the state of this NetworkFeatureConfig.


        :return: The state of this NetworkFeatureConfig.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this NetworkFeatureConfig.
    ...
    @property
    def status(self):
        """Gets the status of this NetworkFeatureConfig.


        :return: The status of this NetworkFeatureConfig.
        :rtype: List[Status]
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this NetworkFeatureConfig.
    ...
    @property
    def type(self):
        """Gets the type of this NetworkFeatureConfig.


        :return: The type of this NetworkFeatureConfig.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NetworkFeatureConfig.
