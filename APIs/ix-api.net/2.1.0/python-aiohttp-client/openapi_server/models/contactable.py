...
class Contactable(Model):
    ...
    def __init__(self, role_assignments: List[str]=None):
        """Contactable - a model defined in OpenAPI

        :param role_assignments: The role_assignments of this Contactable.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Contactable':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Contactable of this Contactable.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def role_assignments(self):
        """Gets the role_assignments of this Contactable.
        ...
        :return: The role_assignments of this Contactable.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this Contactable.
