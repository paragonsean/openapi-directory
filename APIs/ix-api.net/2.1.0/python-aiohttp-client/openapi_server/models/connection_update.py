...
class ConnectionUpdate(Model):
    ...
    def __init__(self, billing_account: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, lacp_timeout: str=None, managing_account: str=None, mode: str=None, purchase_order: str='', role_assignments: List[str]=None, speed: int=None):
        ...
        :param billing_account: The billing_account of this ConnectionUpdate.
        :param consuming_account: The consuming_account of this ConnectionUpdate.
        :param contract_ref: The contract_ref of this ConnectionUpdate.
        :param external_ref: The external_ref of this ConnectionUpdate.
        :param lacp_timeout: The lacp_timeout of this ConnectionUpdate.
        :param managing_account: The managing_account of this ConnectionUpdate.
        :param mode: The mode of this ConnectionUpdate.
        :param purchase_order: The purchase_order of this ConnectionUpdate.
        :param role_assignments: The role_assignments of this ConnectionUpdate.
        :param speed: The speed of this ConnectionUpdate.
        """
        self.openapi_types = {
            'billing_account': str,
    ...
    def billing_account(self):
        """Gets the billing_account of this ConnectionUpdate.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this ConnectionUpdate.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this ConnectionUpdate.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this ConnectionUpdate.
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this ConnectionUpdate.
    ...
    def external_ref(self):
        """Gets the external_ref of this ConnectionUpdate.

        Reference field, free to use for the API user.

        :return: The external_ref of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this ConnectionUpdate.
    ...
    def lacp_timeout(self):
        """Gets the lacp_timeout of this ConnectionUpdate.

        This sets the LACP Timeout mode. Both ends of the connections need to be configured the same. 

        :return: The lacp_timeout of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def lacp_timeout(self, lacp_timeout):
        """Sets the lacp_timeout of this ConnectionUpdate.
    ...
    def managing_account(self):
        """Gets the managing_account of this ConnectionUpdate.
        ...
        :return: The managing_account of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this ConnectionUpdate.
    ...
    @property
    def mode(self):
        """Gets the mode of this ConnectionUpdate.
        ...
        :return: The mode of this ConnectionUpdate.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this ConnectionUpdate.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this ConnectionUpdate.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this ConnectionUpdate.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this ConnectionUpdate.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this ConnectionUpdate.
        ...
        :return: The role_assignments of this ConnectionUpdate.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this ConnectionUpdate.
    ...
    @property
    def speed(self):
        """Gets the speed of this ConnectionUpdate.

        Shows the total bandwidth of the connection in Mbit/s. 

        :return: The speed of this ConnectionUpdate.
        :rtype: int
        """
        return self._speed
    ...
    def speed(self, speed):
        """Sets the speed of this ConnectionUpdate.
