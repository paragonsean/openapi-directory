...
class Contact(Model):
    ...
    def __init__(self, consuming_account: str=None, email: str=None, external_ref: str=None, id: str=None, managing_account: str=None, name: str=None, telephone: str=None):
        ...
        :param consuming_account: The consuming_account of this Contact.
        :param email: The email of this Contact.
        :param external_ref: The external_ref of this Contact.
        :param id: The id of this Contact.
        :param managing_account: The managing_account of this Contact.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this Contact.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this Contact.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this Contact.
    ...
    def external_ref(self):
        """Gets the external_ref of this Contact.

        Reference field, free to use for the API user.

        :return: The external_ref of this Contact.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this Contact.
    ...
    def managing_account(self):
        """Gets the managing_account of this Contact.
        ...
        :return: The managing_account of this Contact.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this Contact.
    ...
    @property
    def telephone(self):
        """Gets the telephone of this Contact.
