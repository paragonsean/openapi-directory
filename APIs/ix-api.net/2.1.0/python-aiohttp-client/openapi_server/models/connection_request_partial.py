...
class ConnectionRequestPartial(Model):
    ...
    def __init__(self, billing_account: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, lacp_timeout: str=None, managing_account: str=None, mode: str=None, purchase_order: str='', role_assignments: List[str]=None, speed: int=None):
        """ConnectionRequestPartial - a model defined in OpenAPI

        :param billing_account: The billing_account of this ConnectionRequestPartial.
        :param consuming_account: The consuming_account of this ConnectionRequestPartial.
        :param contract_ref: The contract_ref of this ConnectionRequestPartial.
        :param external_ref: The external_ref of this ConnectionRequestPartial.
        :param lacp_timeout: The lacp_timeout of this ConnectionRequestPartial.
        :param managing_account: The managing_account of this ConnectionRequestPartial.
        :param mode: The mode of this ConnectionRequestPartial.
        :param purchase_order: The purchase_order of this ConnectionRequestPartial.
        :param role_assignments: The role_assignments of this ConnectionRequestPartial.
        :param speed: The speed of this ConnectionRequestPartial.
        """
        self.openapi_types = {
            'billing_account': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ConnectionRequestPartial':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ConnectionRequestPartial of this ConnectionRequestPartial.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this ConnectionRequestPartial.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this ConnectionRequestPartial.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this ConnectionRequestPartial.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this ConnectionRequestPartial.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this ConnectionRequestPartial.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this ConnectionRequestPartial.
    ...
    def external_ref(self):
        """Gets the external_ref of this ConnectionRequestPartial.

        Reference field, free to use for the API user.

        :return: The external_ref of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this ConnectionRequestPartial.
    ...
    def lacp_timeout(self):
        """Gets the lacp_timeout of this ConnectionRequestPartial.

        This sets the LACP Timeout mode. Both ends of the connections need to be configured the same. 

        :return: The lacp_timeout of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def lacp_timeout(self, lacp_timeout):
        """Sets the lacp_timeout of this ConnectionRequestPartial.
    ...
    def managing_account(self):
        """Gets the managing_account of this ConnectionRequestPartial.
        ...
        :return: The managing_account of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this ConnectionRequestPartial.
    ...
    @property
    def mode(self):
        """Gets the mode of this ConnectionRequestPartial.
        ...
        :return: The mode of this ConnectionRequestPartial.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this ConnectionRequestPartial.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this ConnectionRequestPartial.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this ConnectionRequestPartial.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this ConnectionRequestPartial.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this ConnectionRequestPartial.
        ...
        :return: The role_assignments of this ConnectionRequestPartial.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this ConnectionRequestPartial.
    ...
    @property
    def speed(self):
        """Gets the speed of this ConnectionRequestPartial.

        Shows the total bandwidth of the connection in Mbit/s. 

        :return: The speed of this ConnectionRequestPartial.
        :rtype: int
        """
        return self._speed
    ...
    def speed(self, speed):
        """Sets the speed of this ConnectionRequestPartial.
