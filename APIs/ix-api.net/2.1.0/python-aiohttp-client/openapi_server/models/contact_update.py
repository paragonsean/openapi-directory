...
class ContactUpdate(Model):
    ...
    def __init__(self, consuming_account: str=None, email: str=None, external_ref: str=None, managing_account: str=None, name: str=None, telephone: str=None):
        ...
        :param consuming_account: The consuming_account of this ContactUpdate.
        :param email: The email of this ContactUpdate.
        :param external_ref: The external_ref of this ContactUpdate.
        :param managing_account: The managing_account of this ContactUpdate.
        :param name: The name of this ContactUpdate.
        :param telephone: The telephone of this ContactUpdate.
        """
        self.openapi_types = {
    ...
    def consuming_account(self):
        """Gets the consuming_account of this ContactUpdate.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this ContactUpdate.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this ContactUpdate.
    ...
    def external_ref(self):
        """Gets the external_ref of this ContactUpdate.

        Reference field, free to use for the API user.

        :return: The external_ref of this ContactUpdate.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this ContactUpdate.
    ...
    def managing_account(self):
        """Gets the managing_account of this ContactUpdate.
        ...
        :return: The managing_account of this ContactUpdate.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this ContactUpdate.
    ...
    @property
    def name(self):
        """Gets the name of this ContactUpdate.

        A name of a person or an organisation

        :return: The name of this ContactUpdate.
        :rtype: str
        """
        return self._name
    ...
    @property
    def telephone(self):
        """Gets the telephone of this ContactUpdate.

        The telephone number in E.164 Phone Number Formatting

        :return: The telephone of this ContactUpdate.
        :rtype: str
        """
    ...
    def telephone(self, telephone):
        """Sets the telephone of this ContactUpdate.
