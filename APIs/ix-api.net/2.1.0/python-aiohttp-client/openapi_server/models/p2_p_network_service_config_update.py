...
class P2PNetworkServiceConfigUpdate(Model):
    ...
    def __init__(self, billing_account: str=None, capacity: int=None, connection: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, managing_account: str=None, network_feature_configs: List[str]=None, purchase_order: str='', role_assignments: List[str]=None, type: str=None, vlan_config: VlanConfig=None):
        """P2PNetworkServiceConfigUpdate - a model defined in OpenAPI

        :param billing_account: The billing_account of this P2PNetworkServiceConfigUpdate.
        :param capacity: The capacity of this P2PNetworkServiceConfigUpdate.
        :param connection: The connection of this P2PNetworkServiceConfigUpdate.
        :param consuming_account: The consuming_account of this P2PNetworkServiceConfigUpdate.
        :param contract_ref: The contract_ref of this P2PNetworkServiceConfigUpdate.
        :param external_ref: The external_ref of this P2PNetworkServiceConfigUpdate.
        :param managing_account: The managing_account of this P2PNetworkServiceConfigUpdate.
        :param network_feature_configs: The network_feature_configs of this P2PNetworkServiceConfigUpdate.
        :param purchase_order: The purchase_order of this P2PNetworkServiceConfigUpdate.
        :param role_assignments: The role_assignments of this P2PNetworkServiceConfigUpdate.
        :param type: The type of this P2PNetworkServiceConfigUpdate.
        :param vlan_config: The vlan_config of this P2PNetworkServiceConfigUpdate.
        """
        self.openapi_types = {
            'billing_account': str,
            'capacity': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'P2PNetworkServiceConfigUpdate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The P2PNetworkServiceConfigUpdate of this P2PNetworkServiceConfigUpdate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this P2PNetworkServiceConfigUpdate.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this P2PNetworkServiceConfigUpdate.
    ...
    @property
    def capacity(self):
        """Gets the capacity of this P2PNetworkServiceConfigUpdate.
        ...
        :return: The capacity of this P2PNetworkServiceConfigUpdate.
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this P2PNetworkServiceConfigUpdate.
    ...
    @property
    def connection(self):
        """Gets the connection of this P2PNetworkServiceConfigUpdate.

        The id of the connection to use for this `NetworkServiceConfig`.

        :return: The connection of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def connection(self, connection):
        """Sets the connection of this P2PNetworkServiceConfigUpdate.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this P2PNetworkServiceConfigUpdate.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this P2PNetworkServiceConfigUpdate.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this P2PNetworkServiceConfigUpdate.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this P2PNetworkServiceConfigUpdate.
    ...
    def external_ref(self):
        """Gets the external_ref of this P2PNetworkServiceConfigUpdate.

        Reference field, free to use for the API user.

        :return: The external_ref of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this P2PNetworkServiceConfigUpdate.
    ...
    def managing_account(self):
        """Gets the managing_account of this P2PNetworkServiceConfigUpdate.
        ...
        :return: The managing_account of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this P2PNetworkServiceConfigUpdate.
    ...
    def network_feature_configs(self):
        """Gets the network_feature_configs of this P2PNetworkServiceConfigUpdate.

        A list of ids of `NetworkFeatureConfig`s. 

        :return: The network_feature_configs of this P2PNetworkServiceConfigUpdate.
        :rtype: List[str]
        """
    ...
    def network_feature_configs(self, network_feature_configs):
        """Sets the network_feature_configs of this P2PNetworkServiceConfigUpdate.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this P2PNetworkServiceConfigUpdate.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this P2PNetworkServiceConfigUpdate.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this P2PNetworkServiceConfigUpdate.
        ...
        :return: The role_assignments of this P2PNetworkServiceConfigUpdate.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this P2PNetworkServiceConfigUpdate.
    ...
    @property
    def type(self):
        """Gets the type of this P2PNetworkServiceConfigUpdate.


        :return: The type of this P2PNetworkServiceConfigUpdate.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this P2PNetworkServiceConfigUpdate.
    ...
    def vlan_config(self):
        """Gets the vlan_config of this P2PNetworkServiceConfigUpdate.


        :return: The vlan_config of this P2PNetworkServiceConfigUpdate.
        :rtype: VlanConfig
        """
    ...
    def vlan_config(self, vlan_config):
        """Sets the vlan_config of this P2PNetworkServiceConfigUpdate.
