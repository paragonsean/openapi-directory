...
class IpAddressRequest(Model):
    ...
    def __init__(self, address: str=None, consuming_account: str=None, external_ref: str=None, fqdn: str=None, managing_account: str=None, prefix_length: int=None, valid_not_after: datetime=None, valid_not_before: datetime=None, version: int=None):
        ...
        :param address: The address of this IpAddressRequest.
        :param consuming_account: The consuming_account of this IpAddressRequest.
        :param external_ref: The external_ref of this IpAddressRequest.
        :param fqdn: The fqdn of this IpAddressRequest.
        :param managing_account: The managing_account of this IpAddressRequest.
        :param prefix_length: The prefix_length of this IpAddressRequest.
        :param valid_not_after: The valid_not_after of this IpAddressRequest.
        :param valid_not_before: The valid_not_before of this IpAddressRequest.
        :param version: The version of this IpAddressRequest.
        """
        self.openapi_types = {
            'address': str,
    ...
    @property
    def address(self):
        """Gets the address of this IpAddressRequest.
        ...
        :return: The address of this IpAddressRequest.
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this IpAddressRequest.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this IpAddressRequest.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this IpAddressRequest.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this IpAddressRequest.
    ...
    def external_ref(self):
        """Gets the external_ref of this IpAddressRequest.

        Reference field, free to use for the API user.

        :return: The external_ref of this IpAddressRequest.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this IpAddressRequest.
    ...
    @property
    def fqdn(self):
        """Gets the fqdn of this IpAddressRequest.


        :return: The fqdn of this IpAddressRequest.
        :rtype: str
        """
        return self._fqdn
    ...
    @fqdn.setter
    def fqdn(self, fqdn):
        """Sets the fqdn of this IpAddressRequest.
    ...
    def managing_account(self):
        """Gets the managing_account of this IpAddressRequest.
        ...
        :return: The managing_account of this IpAddressRequest.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this IpAddressRequest.
    ...
    def prefix_length(self):
        """Gets the prefix_length of this IpAddressRequest.

        The CIDR ip prefix length 

        :return: The prefix_length of this IpAddressRequest.
        :rtype: int
        """
    ...
    def prefix_length(self, prefix_length):
        """Sets the prefix_length of this IpAddressRequest.
    ...
    def valid_not_after(self):
        """Gets the valid_not_after of this IpAddressRequest.


        :return: The valid_not_after of this IpAddressRequest.
        :rtype: datetime
        """
    ...
    def valid_not_after(self, valid_not_after):
        """Sets the valid_not_after of this IpAddressRequest.
    ...
    def valid_not_before(self):
        """Gets the valid_not_before of this IpAddressRequest.


        :return: The valid_not_before of this IpAddressRequest.
        :rtype: datetime
        """
    ...
    def valid_not_before(self, valid_not_before):
        """Sets the valid_not_before of this IpAddressRequest.
    ...
    @property
    def version(self):
        """Gets the version of this IpAddressRequest.

        The version of the internet protocol. 

        :return: The version of this IpAddressRequest.
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this IpAddressRequest.
