...
class RouteServerNetworkFeature(Model):
    ...
    def __init__(self, address_families: List[str]=None, asn: int=None, available_bgp_session_types: List[str]=None, flags: List[IXPSpecificFeatureFlag]=None, fqdn: str=None, id: str=None, ip_v4: str=None, ip_v6: str=None, looking_glass_url: str=None, name: str=None, network_service: str=None, nfc_required_contact_roles: List[str]=None, required: bool=None, session_mode: str=None, type: str=None):
        """RouteServerNetworkFeature - a model defined in OpenAPI

        :param address_families: The address_families of this RouteServerNetworkFeature.
        :param asn: The asn of this RouteServerNetworkFeature.
        :param available_bgp_session_types: The available_bgp_session_types of this RouteServerNetworkFeature.
        :param flags: The flags of this RouteServerNetworkFeature.
        :param fqdn: The fqdn of this RouteServerNetworkFeature.
        :param id: The id of this RouteServerNetworkFeature.
        :param ip_v4: The ip_v4 of this RouteServerNetworkFeature.
        :param ip_v6: The ip_v6 of this RouteServerNetworkFeature.
        :param looking_glass_url: The looking_glass_url of this RouteServerNetworkFeature.
        :param name: The name of this RouteServerNetworkFeature.
        :param network_service: The network_service of this RouteServerNetworkFeature.
        :param nfc_required_contact_roles: The nfc_required_contact_roles of this RouteServerNetworkFeature.
        :param required: The required of this RouteServerNetworkFeature.
        :param session_mode: The session_mode of this RouteServerNetworkFeature.
        :param type: The type of this RouteServerNetworkFeature.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RouteServerNetworkFeature':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RouteServerNetworkFeature of this RouteServerNetworkFeature.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address_families(self):
        """Gets the address_families of this RouteServerNetworkFeature.
        ...
        :return: The address_families of this RouteServerNetworkFeature.
        :rtype: List[str]
        """
    ...
    def address_families(self, address_families):
        """Sets the address_families of this RouteServerNetworkFeature.
    ...
    @property
    def asn(self):
        """Gets the asn of this RouteServerNetworkFeature.


        :return: The asn of this RouteServerNetworkFeature.
        :rtype: int
        """
        return self._asn
    ...
    @asn.setter
    def asn(self, asn):
        """Sets the asn of this RouteServerNetworkFeature.
    ...
    def available_bgp_session_types(self):
        """Gets the available_bgp_session_types of this RouteServerNetworkFeature.

        The route server provides the following session modes. 

        :return: The available_bgp_session_types of this RouteServerNetworkFeature.
        :rtype: List[str]
        """
    ...
    def available_bgp_session_types(self, available_bgp_session_types):
        """Sets the available_bgp_session_types of this RouteServerNetworkFeature.
    ...
    def flags(self, flags):
        """Sets the flags of this RouteServerNetworkFeature.
    ...
    @property
    def fqdn(self):
        """Gets the fqdn of this RouteServerNetworkFeature.

        The FQDN of the route server. 

        :return: The fqdn of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._fqdn
    ...
    @fqdn.setter
    def fqdn(self, fqdn):
        """Sets the fqdn of this RouteServerNetworkFeature.
    ...
    @property
    def id(self):
        """Gets the id of this RouteServerNetworkFeature.


        :return: The id of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RouteServerNetworkFeature.
    ...
    @property
    def ip_v4(self):
        """Gets the ip_v4 of this RouteServerNetworkFeature.

        IPv4 address in [dot-decimal notation](https://en.wikipedia.org/wiki/Dot-decimal_notation) notation. 

        :return: The ip_v4 of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._ip_v4
    ...
    def ip_v4(self, ip_v4):
        """Sets the ip_v4 of this RouteServerNetworkFeature.
    ...
    @property
    def ip_v6(self):
        """Gets the ip_v6 of this RouteServerNetworkFeature.

        IPv6 address in hexadecimal colon separated notation. 

        :return: The ip_v6 of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._ip_v6
    ...
    def ip_v6(self, ip_v6):
        """Sets the ip_v6 of this RouteServerNetworkFeature.
    ...
    def looking_glass_url(self):
        """Gets the looking_glass_url of this RouteServerNetworkFeature.

        The url of the looking glass. 

        :return: The looking_glass_url of this RouteServerNetworkFeature.
        :rtype: str
        """
    ...
    def looking_glass_url(self, looking_glass_url):
        """Sets the looking_glass_url of this RouteServerNetworkFeature.
    ...
    @property
    def name(self):
        """Gets the name of this RouteServerNetworkFeature.


        :return: The name of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RouteServerNetworkFeature.
    ...
    def network_service(self):
        """Gets the network_service of this RouteServerNetworkFeature.


        :return: The network_service of this RouteServerNetworkFeature.
        :rtype: str
        """
    ...
    def network_service(self, network_service):
        """Sets the network_service of this RouteServerNetworkFeature.
    ...
    def nfc_required_contact_roles(self):
        """Gets the nfc_required_contact_roles of this RouteServerNetworkFeature.
        ...
        :return: The nfc_required_contact_roles of this RouteServerNetworkFeature.
        :rtype: List[str]
        """
    ...
    def nfc_required_contact_roles(self, nfc_required_contact_roles):
        """Sets the nfc_required_contact_roles of this RouteServerNetworkFeature.
    ...
    @property
    def required(self):
        """Gets the required of this RouteServerNetworkFeature.


        :return: The required of this RouteServerNetworkFeature.
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this RouteServerNetworkFeature.
    ...
    def session_mode(self):
        """Gets the session_mode of this RouteServerNetworkFeature.

        When creating a route server feature config, remember to specify the same session_mode as the route server. 

        :return: The session_mode of this RouteServerNetworkFeature.
        :rtype: str
        """
    ...
    def session_mode(self, session_mode):
        """Sets the session_mode of this RouteServerNetworkFeature.
    ...
    @property
    def type(self):
        """Gets the type of this RouteServerNetworkFeature.


        :return: The type of this RouteServerNetworkFeature.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this RouteServerNetworkFeature.
