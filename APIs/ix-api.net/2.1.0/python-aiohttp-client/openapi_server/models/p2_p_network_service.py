...
class P2PNetworkService(Model):
    ...
    def __init__(self, billing_account: str=None, capacity: int=None, charged_until: date=None, consuming_account: str=None, contract_ref: str=None, decommission_at: date=None, external_ref: str=None, id: str=None, joining_member_account: str=None, managing_account: str=None, nsc_required_contact_roles: List[str]=None, product_offering: str=None, purchase_order: str='', state: str=None, status: List[Status]=None, type: str=None):
        """P2PNetworkService - a model defined in OpenAPI

        :param billing_account: The billing_account of this P2PNetworkService.
        :param capacity: The capacity of this P2PNetworkService.
        :param charged_until: The charged_until of this P2PNetworkService.
        :param consuming_account: The consuming_account of this P2PNetworkService.
        :param contract_ref: The contract_ref of this P2PNetworkService.
        :param decommission_at: The decommission_at of this P2PNetworkService.
        :param external_ref: The external_ref of this P2PNetworkService.
        :param id: The id of this P2PNetworkService.
        :param joining_member_account: The joining_member_account of this P2PNetworkService.
        :param managing_account: The managing_account of this P2PNetworkService.
        :param nsc_required_contact_roles: The nsc_required_contact_roles of this P2PNetworkService.
        :param product_offering: The product_offering of this P2PNetworkService.
        :param purchase_order: The purchase_order of this P2PNetworkService.
        :param state: The state of this P2PNetworkService.
        :param status: The status of this P2PNetworkService.
        :param type: The type of this P2PNetworkService.
        """
        self.openapi_types = {
            'billing_account': str,
            'capacity': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'P2PNetworkService':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The P2PNetworkService of this P2PNetworkService.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this P2PNetworkService.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this P2PNetworkService.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this P2PNetworkService.
    ...
    @property
    def capacity(self):
        """Gets the capacity of this P2PNetworkService.

        The capacity of the service in Mbps. When null, the maximum capacity will be used.

        :return: The capacity of this P2PNetworkService.
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this P2PNetworkService.
    ...
    def charged_until(self):
        """Gets the charged_until of this P2PNetworkService.
        ...
        :return: The charged_until of this P2PNetworkService.
        :rtype: date
        """
    ...
    def charged_until(self, charged_until):
        """Sets the charged_until of this P2PNetworkService.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this P2PNetworkService.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this P2PNetworkService.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this P2PNetworkService.
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this P2PNetworkService.
    ...
    def decommission_at(self):
        """Gets the decommission_at of this P2PNetworkService.
        ...
        :return: The decommission_at of this P2PNetworkService.
        :rtype: date
        """
    ...
    def decommission_at(self, decommission_at):
        """Sets the decommission_at of this P2PNetworkService.
    ...
    def external_ref(self):
        """Gets the external_ref of this P2PNetworkService.

        Reference field, free to use for the API user.

        :return: The external_ref of this P2PNetworkService.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this P2PNetworkService.
    ...
    @property
    def id(self):
        """Gets the id of this P2PNetworkService.


        :return: The id of this P2PNetworkService.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this P2PNetworkService.
    ...
    def joining_member_account(self):
        """Gets the joining_member_account of this P2PNetworkService.

        The account of the B-side member joining the virtual circuit. 

        :return: The joining_member_account of this P2PNetworkService.
        :rtype: str
        """
    ...
    def joining_member_account(self, joining_member_account):
        """Sets the joining_member_account of this P2PNetworkService.
    ...
    def managing_account(self):
        """Gets the managing_account of this P2PNetworkService.
        ...
        :return: The managing_account of this P2PNetworkService.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this P2PNetworkService.
    ...
    def nsc_required_contact_roles(self):
        """Gets the nsc_required_contact_roles of this P2PNetworkService.
        ...
        :return: The nsc_required_contact_roles of this P2PNetworkService.
        :rtype: List[str]
        """
    ...
    def nsc_required_contact_roles(self, nsc_required_contact_roles):
        """Sets the nsc_required_contact_roles of this P2PNetworkService.
    ...
    def product_offering(self):
        """Gets the product_offering of this P2PNetworkService.


        :return: The product_offering of this P2PNetworkService.
        :rtype: str
        """
    ...
    def product_offering(self, product_offering):
        """Sets the product_offering of this P2PNetworkService.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this P2PNetworkService.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this P2PNetworkService.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this P2PNetworkService.
    ...
    @property
    def state(self):
        """Gets the state of this P2PNetworkService.


        :return: The state of this P2PNetworkService.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this P2PNetworkService.
    ...
    @property
    def status(self):
        """Gets the status of this P2PNetworkService.


        :return: The status of this P2PNetworkService.
        :rtype: List[Status]
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this P2PNetworkService.
    ...
    @property
    def type(self):
        """Gets the type of this P2PNetworkService.


        :return: The type of this P2PNetworkService.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this P2PNetworkService.
