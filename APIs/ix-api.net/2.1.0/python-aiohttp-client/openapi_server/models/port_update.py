...
class PortUpdate(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, billing_account: str=None, connection: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, managing_account: str=None, purchase_order: str='', role_assignments: List[str]=None, speed: int=None):
        """PortUpdate - a model defined in OpenAPI

        :param billing_account: The billing_account of this PortUpdate.
        :param connection: The connection of this PortUpdate.
        :param consuming_account: The consuming_account of this PortUpdate.
        :param contract_ref: The contract_ref of this PortUpdate.
        :param external_ref: The external_ref of this PortUpdate.
        :param managing_account: The managing_account of this PortUpdate.
        :param purchase_order: The purchase_order of this PortUpdate.
        :param role_assignments: The role_assignments of this PortUpdate.
        :param speed: The speed of this PortUpdate.
        """
        self.openapi_types = {
            'billing_account': str,
            'connection': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PortUpdate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PortUpdate of this PortUpdate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this PortUpdate.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this PortUpdate.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this PortUpdate.
    ...
    @property
    def connection(self):
        """Gets the connection of this PortUpdate.


        :return: The connection of this PortUpdate.
        :rtype: str
        """
    ...
    def connection(self, connection):
        """Sets the connection of this PortUpdate.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this PortUpdate.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this PortUpdate.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this PortUpdate.
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this PortUpdate.
    ...
    def external_ref(self):
        """Gets the external_ref of this PortUpdate.

        Reference field, free to use for the API user.

        :return: The external_ref of this PortUpdate.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this PortUpdate.
    ...
    def managing_account(self):
        """Gets the managing_account of this PortUpdate.
        ...
        :return: The managing_account of this PortUpdate.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this PortUpdate.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this PortUpdate.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this PortUpdate.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this PortUpdate.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this PortUpdate.
        ...
        :return: The role_assignments of this PortUpdate.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this PortUpdate.
    ...
    @property
    def speed(self):
        """Gets the speed of this PortUpdate.


        :return: The speed of this PortUpdate.
        :rtype: int
        """
        return self._speed
    ...
    def speed(self, speed):
        """Sets the speed of this PortUpdate.
