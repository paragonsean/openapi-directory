...
class P2MPNetworkServiceRequest(Model):
    ...
    def __init__(self, billing_account: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, managing_account: str=None, name: str=None, product_offering: str=None, public: bool=False, purchase_order: str='', type: str=None):
        """P2MPNetworkServiceRequest - a model defined in OpenAPI

        :param billing_account: The billing_account of this P2MPNetworkServiceRequest.
        :param consuming_account: The consuming_account of this P2MPNetworkServiceRequest.
        :param contract_ref: The contract_ref of this P2MPNetworkServiceRequest.
        :param external_ref: The external_ref of this P2MPNetworkServiceRequest.
        :param managing_account: The managing_account of this P2MPNetworkServiceRequest.
        :param name: The name of this P2MPNetworkServiceRequest.
        :param product_offering: The product_offering of this P2MPNetworkServiceRequest.
        :param public: The public of this P2MPNetworkServiceRequest.
        :param purchase_order: The purchase_order of this P2MPNetworkServiceRequest.
        :param type: The type of this P2MPNetworkServiceRequest.
        """
        self.openapi_types = {
            'billing_account': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'P2MPNetworkServiceRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The P2MPNetworkServiceRequest of this P2MPNetworkServiceRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this P2MPNetworkServiceRequest.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this P2MPNetworkServiceRequest.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this P2MPNetworkServiceRequest.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this P2MPNetworkServiceRequest.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this P2MPNetworkServiceRequest.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this P2MPNetworkServiceRequest.
    ...
    def external_ref(self):
        """Gets the external_ref of this P2MPNetworkServiceRequest.

        Reference field, free to use for the API user.

        :return: The external_ref of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this P2MPNetworkServiceRequest.
    ...
    def managing_account(self):
        """Gets the managing_account of this P2MPNetworkServiceRequest.
        ...
        :return: The managing_account of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this P2MPNetworkServiceRequest.
    ...
    @property
    def name(self):
        """Gets the name of this P2MPNetworkServiceRequest.

        Name of the point to multi-point virtual circuit.

        :return: The name of this P2MPNetworkServiceRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this P2MPNetworkServiceRequest.
    ...
    def product_offering(self):
        """Gets the product_offering of this P2MPNetworkServiceRequest.


        :return: The product_offering of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def product_offering(self, product_offering):
        """Sets the product_offering of this P2MPNetworkServiceRequest.
    ...
    @property
    def public(self):
        """Gets the public of this P2MPNetworkServiceRequest.
        ...
        :return: The public of this P2MPNetworkServiceRequest.
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this P2MPNetworkServiceRequest.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this P2MPNetworkServiceRequest.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this P2MPNetworkServiceRequest.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this P2MPNetworkServiceRequest.
    ...
    @property
    def type(self):
        """Gets the type of this P2MPNetworkServiceRequest.


        :return: The type of this P2MPNetworkServiceRequest.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this P2MPNetworkServiceRequest.
