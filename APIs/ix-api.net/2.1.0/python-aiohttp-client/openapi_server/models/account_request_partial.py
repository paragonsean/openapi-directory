...
class AccountRequestPartial(Model):
    ...
    def __init__(self, address: Address=None, billing_information: BillingInformation=None, discoverable: bool=False, external_ref: str=None, legal_name: str=None, managing_account: str=None, metro_area_network_presence: List[str]=[], name: str=None):
        """AccountRequestPartial - a model defined in OpenAPI

        :param address: The address of this AccountRequestPartial.
        :param billing_information: The billing_information of this AccountRequestPartial.
        :param discoverable: The discoverable of this AccountRequestPartial.
        :param external_ref: The external_ref of this AccountRequestPartial.
        :param legal_name: The legal_name of this AccountRequestPartial.
        :param managing_account: The managing_account of this AccountRequestPartial.
        :param metro_area_network_presence: The metro_area_network_presence of this AccountRequestPartial.
        :param name: The name of this AccountRequestPartial.
        """
        self.openapi_types = {
            'address': Address,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AccountRequestPartial':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AccountRequestPartial of this AccountRequestPartial.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address(self):
        """Gets the address of this AccountRequestPartial.


        :return: The address of this AccountRequestPartial.
        :rtype: Address
        """
    ...
    def address(self, address):
        """Sets the address of this AccountRequestPartial.
    ...
    def billing_information(self):
        """Gets the billing_information of this AccountRequestPartial.


        :return: The billing_information of this AccountRequestPartial.
    ...
    def billing_information(self, billing_information):
        """Sets the billing_information of this AccountRequestPartial.
    ...
    def discoverable(self):
        """Gets the discoverable of this AccountRequestPartial.
        ...
        :return: The discoverable of this AccountRequestPartial.
        :rtype: bool
        """
    ...
    def discoverable(self, discoverable):
        """Sets the discoverable of this AccountRequestPartial.
    ...
    def external_ref(self):
        """Gets the external_ref of this AccountRequestPartial.

        Reference field, free to use for the API user.

        :return: The external_ref of this AccountRequestPartial.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this AccountRequestPartial.
    ...
    @property
    def legal_name(self):
        """Gets the legal_name of this AccountRequestPartial.

        Legal name of the organisation. Only required when it's different from the account name. 

        :return: The legal_name of this AccountRequestPartial.
        :rtype: str
        """
    ...
    def legal_name(self, legal_name):
        """Sets the legal_name of this AccountRequestPartial.
    ...
    def managing_account(self):
        """Gets the managing_account of this AccountRequestPartial.

        The `id` of a managing account. Can be used for creating a customer hierachy. 

        :return: The managing_account of this AccountRequestPartial.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this AccountRequestPartial.
    ...
    def metro_area_network_presence(self):
        """Gets the metro_area_network_presence of this AccountRequestPartial.
        ...
        :return: The metro_area_network_presence of this AccountRequestPartial.
        :rtype: List[str]
        """
    ...
    def metro_area_network_presence(self, metro_area_network_presence):
        """Sets the metro_area_network_presence of this AccountRequestPartial.
    ...
    @property
    def name(self):
        """Gets the name of this AccountRequestPartial.

        Name of the account, how it gets represented in e.g. a \"customers list\". 

        :return: The name of this AccountRequestPartial.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AccountRequestPartial.
