...
class P2PNetworkServiceConfig(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, billing_account: str=None, capacity: int=None, charged_until: date=None, connection: str=None, consuming_account: str=None, contract_ref: str=None, decommission_at: date=None, external_ref: str=None, id: str=None, managing_account: str=None, network_feature_configs: List[str]=None, network_service: str=None, purchase_order: str='', role_assignments: List[str]=None, state: str=None, status: List[Status]=None, type: str=None, vlan_config: VlanConfig=None):
        """P2PNetworkServiceConfig - a model defined in OpenAPI

        :param billing_account: The billing_account of this P2PNetworkServiceConfig.
        :param capacity: The capacity of this P2PNetworkServiceConfig.
        :param charged_until: The charged_until of this P2PNetworkServiceConfig.
        :param connection: The connection of this P2PNetworkServiceConfig.
        :param consuming_account: The consuming_account of this P2PNetworkServiceConfig.
        :param contract_ref: The contract_ref of this P2PNetworkServiceConfig.
        :param decommission_at: The decommission_at of this P2PNetworkServiceConfig.
        :param external_ref: The external_ref of this P2PNetworkServiceConfig.
        :param id: The id of this P2PNetworkServiceConfig.
        :param managing_account: The managing_account of this P2PNetworkServiceConfig.
        :param network_feature_configs: The network_feature_configs of this P2PNetworkServiceConfig.
        :param network_service: The network_service of this P2PNetworkServiceConfig.
        :param purchase_order: The purchase_order of this P2PNetworkServiceConfig.
        :param role_assignments: The role_assignments of this P2PNetworkServiceConfig.
        :param state: The state of this P2PNetworkServiceConfig.
        :param status: The status of this P2PNetworkServiceConfig.
        :param type: The type of this P2PNetworkServiceConfig.
        :param vlan_config: The vlan_config of this P2PNetworkServiceConfig.
        """
        self.openapi_types = {
            'billing_account': str,
            'capacity': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'P2PNetworkServiceConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The P2PNetworkServiceConfig of this P2PNetworkServiceConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this P2PNetworkServiceConfig.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this P2PNetworkServiceConfig.
    ...
    @property
    def capacity(self):
        """Gets the capacity of this P2PNetworkServiceConfig.
        ...
        :return: The capacity of this P2PNetworkServiceConfig.
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this P2PNetworkServiceConfig.
    ...
    def charged_until(self):
        """Gets the charged_until of this P2PNetworkServiceConfig.
        ...
        :return: The charged_until of this P2PNetworkServiceConfig.
        :rtype: date
        """
    ...
    def charged_until(self, charged_until):
        """Sets the charged_until of this P2PNetworkServiceConfig.
    ...
    @property
    def connection(self):
        """Gets the connection of this P2PNetworkServiceConfig.

        The id of the connection to use for this `NetworkServiceConfig`.

        :return: The connection of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def connection(self, connection):
        """Sets the connection of this P2PNetworkServiceConfig.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this P2PNetworkServiceConfig.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this P2PNetworkServiceConfig.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this P2PNetworkServiceConfig.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this P2PNetworkServiceConfig.
    ...
    def decommission_at(self):
        """Gets the decommission_at of this P2PNetworkServiceConfig.
        ...
        :return: The decommission_at of this P2PNetworkServiceConfig.
        :rtype: date
        """
    ...
    def decommission_at(self, decommission_at):
        """Sets the decommission_at of this P2PNetworkServiceConfig.
    ...
    def external_ref(self):
        """Gets the external_ref of this P2PNetworkServiceConfig.

        Reference field, free to use for the API user.

        :return: The external_ref of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this P2PNetworkServiceConfig.
    ...
    @property
    def id(self):
        """Gets the id of this P2PNetworkServiceConfig.


        :return: The id of this P2PNetworkServiceConfig.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this P2PNetworkServiceConfig.
    ...
    def managing_account(self):
        """Gets the managing_account of this P2PNetworkServiceConfig.
        ...
        :return: The managing_account of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this P2PNetworkServiceConfig.
    ...
    def network_feature_configs(self):
        """Gets the network_feature_configs of this P2PNetworkServiceConfig.

        A list of ids of `NetworkFeatureConfig`s. 

        :return: The network_feature_configs of this P2PNetworkServiceConfig.
        :rtype: List[str]
        """
    ...
    def network_feature_configs(self, network_feature_configs):
        """Sets the network_feature_configs of this P2PNetworkServiceConfig.
    ...
    def network_service(self):
        """Gets the network_service of this P2PNetworkServiceConfig.

        The id of the configured network service.

        :return: The network_service of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def network_service(self, network_service):
        """Sets the network_service of this P2PNetworkServiceConfig.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this P2PNetworkServiceConfig.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this P2PNetworkServiceConfig.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this P2PNetworkServiceConfig.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this P2PNetworkServiceConfig.
        ...
        :return: The role_assignments of this P2PNetworkServiceConfig.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this P2PNetworkServiceConfig.
    ...
    @property
    def state(self):
        """Gets the state of this P2PNetworkServiceConfig.


        :return: The state of this P2PNetworkServiceConfig.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this P2PNetworkServiceConfig.
    ...
    @property
    def status(self):
        """Gets the status of this P2PNetworkServiceConfig.


        :return: The status of this P2PNetworkServiceConfig.
        :rtype: List[Status]
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this P2PNetworkServiceConfig.
    ...
    @property
    def type(self):
        """Gets the type of this P2PNetworkServiceConfig.


        :return: The type of this P2PNetworkServiceConfig.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this P2PNetworkServiceConfig.
    ...
    def vlan_config(self):
        """Gets the vlan_config of this P2PNetworkServiceConfig.


        :return: The vlan_config of this P2PNetworkServiceConfig.
        :rtype: VlanConfig
        """
    ...
    def vlan_config(self, vlan_config):
        """Sets the vlan_config of this P2PNetworkServiceConfig.
