...
class IpAddress(Model):
    ...
    def __init__(self, address: str=None, consuming_account: str=None, external_ref: str=None, fqdn: str=None, id: str=None, managing_account: str=None, prefix_length: int=None, valid_not_after: datetime=None, valid_not_before: datetime=None, version: int=None):
        ...
        :param consuming_account: The consuming_account of this IpAddress.
        :param external_ref: The external_ref of this IpAddress.
        :param fqdn: The fqdn of this IpAddress.
        :param id: The id of this IpAddress.
        :param managing_account: The managing_account of this IpAddress.
        :param prefix_length: The prefix_length of this IpAddress.
        :param valid_not_after: The valid_not_after of this IpAddress.
        :param valid_not_before: The valid_not_before of this IpAddress.
        :param version: The version of this IpAddress.
        """
        self.openapi_types = {
            'address': str,
    ...
    def consuming_account(self):
        """Gets the consuming_account of this IpAddress.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this IpAddress.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this IpAddress.
    ...
    def external_ref(self):
        """Gets the external_ref of this IpAddress.

        Reference field, free to use for the API user.

        :return: The external_ref of this IpAddress.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this IpAddress.
    ...
    def managing_account(self):
        """Gets the managing_account of this IpAddress.
        ...
        :return: The managing_account of this IpAddress.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this IpAddress.
    ...
    def prefix_length(self):
        """Gets the prefix_length of this IpAddress.

        The CIDR ip prefix length 

        :return: The prefix_length of this IpAddress.
        :rtype: int
        """
    ...
    def prefix_length(self, prefix_length):
        """Sets the prefix_length of this IpAddress.
    ...
    def valid_not_after(self):
        """Gets the valid_not_after of this IpAddress.


        :return: The valid_not_after of this IpAddress.
        :rtype: datetime
        """
    ...
    def valid_not_after(self, valid_not_after):
        """Sets the valid_not_after of this IpAddress.
    ...
    def valid_not_before(self):
        """Gets the valid_not_before of this IpAddress.


        :return: The valid_not_before of this IpAddress.
        :rtype: datetime
        """
    ...
    def valid_not_before(self, valid_not_before):
        """Sets the valid_not_before of this IpAddress.
    ...
    @property
    def version(self):
        """Gets the version of this IpAddress.

        The version of the internet protocol. 

        :return: The version of this IpAddress.
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this IpAddress.
