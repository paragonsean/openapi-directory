...
class MP2MPNetworkServiceConfig(Model):
    ...
    def __init__(self, billing_account: str=None, capacity: int=None, charged_until: date=None, connection: str=None, consuming_account: str=None, contract_ref: str=None, decommission_at: date=None, external_ref: str=None, id: str=None, macs: List[str]=None, managing_account: str=None, network_feature_configs: List[str]=None, network_service: str=None, purchase_order: str='', role_assignments: List[str]=None, state: str=None, status: List[Status]=None, type: str=None, vlan_config: VlanConfig=None):
        """MP2MPNetworkServiceConfig - a model defined in OpenAPI

        :param billing_account: The billing_account of this MP2MPNetworkServiceConfig.
        :param capacity: The capacity of this MP2MPNetworkServiceConfig.
        :param charged_until: The charged_until of this MP2MPNetworkServiceConfig.
        :param connection: The connection of this MP2MPNetworkServiceConfig.
        :param consuming_account: The consuming_account of this MP2MPNetworkServiceConfig.
        :param contract_ref: The contract_ref of this MP2MPNetworkServiceConfig.
        :param decommission_at: The decommission_at of this MP2MPNetworkServiceConfig.
        :param external_ref: The external_ref of this MP2MPNetworkServiceConfig.
        :param id: The id of this MP2MPNetworkServiceConfig.
        :param macs: The macs of this MP2MPNetworkServiceConfig.
        :param managing_account: The managing_account of this MP2MPNetworkServiceConfig.
        :param network_feature_configs: The network_feature_configs of this MP2MPNetworkServiceConfig.
        :param network_service: The network_service of this MP2MPNetworkServiceConfig.
        :param purchase_order: The purchase_order of this MP2MPNetworkServiceConfig.
        :param role_assignments: The role_assignments of this MP2MPNetworkServiceConfig.
        :param state: The state of this MP2MPNetworkServiceConfig.
        :param status: The status of this MP2MPNetworkServiceConfig.
        :param type: The type of this MP2MPNetworkServiceConfig.
        :param vlan_config: The vlan_config of this MP2MPNetworkServiceConfig.
        """
        self.openapi_types = {
            'billing_account': str,
            'capacity': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MP2MPNetworkServiceConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MP2MPNetworkServiceConfig of this MP2MPNetworkServiceConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this MP2MPNetworkServiceConfig.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this MP2MPNetworkServiceConfig.
    ...
    @property
    def capacity(self):
        """Gets the capacity of this MP2MPNetworkServiceConfig.
        ...
        :return: The capacity of this MP2MPNetworkServiceConfig.
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this MP2MPNetworkServiceConfig.
    ...
    def charged_until(self):
        """Gets the charged_until of this MP2MPNetworkServiceConfig.
        ...
        :return: The charged_until of this MP2MPNetworkServiceConfig.
        :rtype: date
        """
    ...
    def charged_until(self, charged_until):
        """Sets the charged_until of this MP2MPNetworkServiceConfig.
    ...
    @property
    def connection(self):
        """Gets the connection of this MP2MPNetworkServiceConfig.

        The id of the connection to use for this `NetworkServiceConfig`.

        :return: The connection of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def connection(self, connection):
        """Sets the connection of this MP2MPNetworkServiceConfig.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this MP2MPNetworkServiceConfig.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this MP2MPNetworkServiceConfig.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this MP2MPNetworkServiceConfig.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this MP2MPNetworkServiceConfig.
    ...
    def decommission_at(self):
        """Gets the decommission_at of this MP2MPNetworkServiceConfig.
        ...
        :return: The decommission_at of this MP2MPNetworkServiceConfig.
        :rtype: date
        """
    ...
    def decommission_at(self, decommission_at):
        """Sets the decommission_at of this MP2MPNetworkServiceConfig.
    ...
    def external_ref(self):
        """Gets the external_ref of this MP2MPNetworkServiceConfig.

        Reference field, free to use for the API user.

        :return: The external_ref of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this MP2MPNetworkServiceConfig.
    ...
    @property
    def id(self):
        """Gets the id of this MP2MPNetworkServiceConfig.


        :return: The id of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MP2MPNetworkServiceConfig.
    ...
    @property
    def macs(self):
        """Gets the macs of this MP2MPNetworkServiceConfig.


        :return: The macs of this MP2MPNetworkServiceConfig.
        :rtype: List[str]
        """
        return self._macs
    ...
    @macs.setter
    def macs(self, macs):
        """Sets the macs of this MP2MPNetworkServiceConfig.
    ...
    def managing_account(self):
        """Gets the managing_account of this MP2MPNetworkServiceConfig.
        ...
        :return: The managing_account of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this MP2MPNetworkServiceConfig.
    ...
    def network_feature_configs(self):
        """Gets the network_feature_configs of this MP2MPNetworkServiceConfig.

        A list of ids of `NetworkFeatureConfig`s. 

        :return: The network_feature_configs of this MP2MPNetworkServiceConfig.
        :rtype: List[str]
        """
    ...
    def network_feature_configs(self, network_feature_configs):
        """Sets the network_feature_configs of this MP2MPNetworkServiceConfig.
    ...
    def network_service(self):
        """Gets the network_service of this MP2MPNetworkServiceConfig.

        The id of the configured network service.

        :return: The network_service of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def network_service(self, network_service):
        """Sets the network_service of this MP2MPNetworkServiceConfig.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this MP2MPNetworkServiceConfig.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this MP2MPNetworkServiceConfig.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this MP2MPNetworkServiceConfig.
        ...
        :return: The role_assignments of this MP2MPNetworkServiceConfig.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this MP2MPNetworkServiceConfig.
    ...
    @property
    def state(self):
        """Gets the state of this MP2MPNetworkServiceConfig.


        :return: The state of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this MP2MPNetworkServiceConfig.
    ...
    @property
    def status(self):
        """Gets the status of this MP2MPNetworkServiceConfig.


        :return: The status of this MP2MPNetworkServiceConfig.
        :rtype: List[Status]
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this MP2MPNetworkServiceConfig.
    ...
    @property
    def type(self):
        """Gets the type of this MP2MPNetworkServiceConfig.


        :return: The type of this MP2MPNetworkServiceConfig.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this MP2MPNetworkServiceConfig.
    ...
    def vlan_config(self):
        """Gets the vlan_config of this MP2MPNetworkServiceConfig.


        :return: The vlan_config of this MP2MPNetworkServiceConfig.
        :rtype: VlanConfig
        """
    ...
    def vlan_config(self, vlan_config):
        """Sets the vlan_config of this MP2MPNetworkServiceConfig.
