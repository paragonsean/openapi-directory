...
class Facility(Model):
    ...
    def __init__(self, address_country: str=None, address_locality: str=None, address_region: str=None, id: str=None, metro_area: str=None, name: str=None, organisation_name: str=None, peeringdb_facility_id: int=None, pops: List[str]=None, postal_code: str=None, street_address: str=None):
        ...
        :param address_country: The address_country of this Facility.
        :param address_locality: The address_locality of this Facility.
        :param address_region: The address_region of this Facility.
        :param id: The id of this Facility.
        :param metro_area: The metro_area of this Facility.
        :param name: The name of this Facility.
        :param organisation_name: The organisation_name of this Facility.
        :param peeringdb_facility_id: The peeringdb_facility_id of this Facility.
        :param pops: The pops of this Facility.
        :param postal_code: The postal_code of this Facility.
        :param street_address: The street_address of this Facility.
        """
        self.openapi_types = {
            'address_country': str,
    ...
    def address_country(self):
        """Gets the address_country of this Facility.

        ISO 3166-1 alpha-2 country code, for example DE 

        :return: The address_country of this Facility.
        :rtype: str
        """
    ...
    def address_country(self, address_country):
        """Sets the address_country of this Facility.
    ...
    def address_locality(self):
        """Gets the address_locality of this Facility.

        The locality/city. For example, Mountain View.

        :return: The address_locality of this Facility.
        :rtype: str
        """
    ...
    def address_locality(self, address_locality):
        """Sets the address_locality of this Facility.
        ...
        if address_locality is None:
            raise ValueError("Invalid value for `address_locality`, must not be `None`")
    ...
    def address_region(self):
        """Gets the address_region of this Facility.

        The region. For example, CA

        :return: The address_region of this Facility.
        :rtype: str
        """
    ...
    def address_region(self, address_region):
        """Sets the address_region of this Facility.
        ...
        if address_region is None:
            raise ValueError("Invalid value for `address_region`, must not be `None`")
    ...
    @property
    def metro_area(self):
        """Gets the metro_area of this Facility.

        Id of the `MetroArea` the DC is located in. 

        :return: The metro_area of this Facility.
        :rtype: str
        """
    ...
    def metro_area(self, metro_area):
        """Sets the metro_area of this Facility.
    ...
    def organisation_name(self):
        """Gets the organisation_name of this Facility.

        Name of Datacenter operator 

        :return: The organisation_name of this Facility.
        :rtype: str
        """
    ...
    def organisation_name(self, organisation_name):
        """Sets the organisation_name of this Facility.
        ...
        if organisation_name is None:
            raise ValueError("Invalid value for `organisation_name`, must not be `None`")
    ...
    def peeringdb_facility_id(self, peeringdb_facility_id):
        """Sets the peeringdb_facility_id of this Facility.
    ...
    @property
    def pops(self):
        """Gets the pops of this Facility.

        List of pops in the `Facility`.

        :return: The pops of this Facility.
        :rtype: List[str]
        """
        return self._pops
    ...
    @pops.setter
    def pops(self, pops):
        """Sets the pops of this Facility.
    ...
    def postal_code(self):
        """Gets the postal_code of this Facility.

        A postal code. For example, 9404

        :return: The postal_code of this Facility.
        :rtype: str
        """
    ...
    def postal_code(self, postal_code):
        """Sets the postal_code of this Facility.
    ...
    def street_address(self):
        """Gets the street_address of this Facility.

        The street address. For example, 1600 Amphitheatre Pkwy.

        :return: The street_address of this Facility.
        :rtype: str
        """
    ...
    def street_address(self, street_address):
        """Sets the street_address of this Facility.
