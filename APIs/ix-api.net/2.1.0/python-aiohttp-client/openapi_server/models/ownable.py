...
class Ownable(Model):
    ...
    def __init__(self, consuming_account: str=None, external_ref: str=None, managing_account: str=None):
        """Ownable - a model defined in OpenAPI

        :param consuming_account: The consuming_account of this Ownable.
        :param external_ref: The external_ref of this Ownable.
        :param managing_account: The managing_account of this Ownable.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Ownable':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Ownable of this Ownable.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def consuming_account(self):
        """Gets the consuming_account of this Ownable.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this Ownable.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this Ownable.
    ...
    def external_ref(self):
        """Gets the external_ref of this Ownable.

        Reference field, free to use for the API user.

        :return: The external_ref of this Ownable.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this Ownable.
    ...
    def managing_account(self):
        """Gets the managing_account of this Ownable.
        ...
        :return: The managing_account of this Ownable.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this Ownable.
