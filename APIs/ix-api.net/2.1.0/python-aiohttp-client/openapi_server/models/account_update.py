...
class AccountUpdate(Model):
    ...
    def __init__(self, address: Address=None, billing_information: BillingInformation=None, discoverable: bool=False, external_ref: str=None, legal_name: str=None, managing_account: str=None, metro_area_network_presence: List[str]=None, name: str=None):
        ...
        :param address: The address of this AccountUpdate.
        :param billing_information: The billing_information of this AccountUpdate.
        :param discoverable: The discoverable of this AccountUpdate.
        :param external_ref: The external_ref of this AccountUpdate.
        :param legal_name: The legal_name of this AccountUpdate.
        :param managing_account: The managing_account of this AccountUpdate.
        :param metro_area_network_presence: The metro_area_network_presence of this AccountUpdate.
        :param name: The name of this AccountUpdate.
        """
        self.openapi_types = {
            'address': Address,
    ...
    @property
    def address(self):
        """Gets the address of this AccountUpdate.


        :return: The address of this AccountUpdate.
        :rtype: Address
        """
    ...
    def address(self, address):
        """Sets the address of this AccountUpdate.
    ...
    def billing_information(self):
        """Gets the billing_information of this AccountUpdate.


        :return: The billing_information of this AccountUpdate.
    ...
    def billing_information(self, billing_information):
        """Sets the billing_information of this AccountUpdate.
    ...
    def discoverable(self):
        """Gets the discoverable of this AccountUpdate.
        ...
        :return: The discoverable of this AccountUpdate.
        :rtype: bool
        """
    ...
    def discoverable(self, discoverable):
        """Sets the discoverable of this AccountUpdate.
    ...
    def external_ref(self):
        """Gets the external_ref of this AccountUpdate.

        Reference field, free to use for the API user.

        :return: The external_ref of this AccountUpdate.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this AccountUpdate.
    ...
    def legal_name(self, legal_name):
        """Sets the legal_name of this AccountUpdate.
    ...
    def managing_account(self):
        """Gets the managing_account of this AccountUpdate.

        The `id` of a managing account. Can be used for creating a customer hierachy. 

        :return: The managing_account of this AccountUpdate.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this AccountUpdate.
    ...
    def metro_area_network_presence(self):
        """Gets the metro_area_network_presence of this AccountUpdate.
        ...
        :return: The metro_area_network_presence of this AccountUpdate.
        :rtype: List[str]
        """
    ...
    def metro_area_network_presence(self, metro_area_network_presence):
        """Sets the metro_area_network_presence of this AccountUpdate.
    ...
    @property
    def name(self):
        """Gets the name of this AccountUpdate.

        Name of the account, how it gets represented in e.g. a \"customers list\". 

        :return: The name of this AccountUpdate.
        :rtype: str
        """
        return self._name
