...
class PortRequest(Model):
    ...
    def __init__(self, billing_account: str=None, connection: str=None, consuming_account: str=None, contract_ref: str=None, external_ref: str=None, managing_account: str=None, media_type: str=None, pop: str=None, purchase_order: str='', role_assignments: List[str]=None, speed: int=None):
        """PortRequest - a model defined in OpenAPI

        :param billing_account: The billing_account of this PortRequest.
        :param connection: The connection of this PortRequest.
        :param consuming_account: The consuming_account of this PortRequest.
        :param contract_ref: The contract_ref of this PortRequest.
        :param external_ref: The external_ref of this PortRequest.
        :param managing_account: The managing_account of this PortRequest.
        :param media_type: The media_type of this PortRequest.
        :param pop: The pop of this PortRequest.
        :param purchase_order: The purchase_order of this PortRequest.
        :param role_assignments: The role_assignments of this PortRequest.
        :param speed: The speed of this PortRequest.
        """
        self.openapi_types = {
            'billing_account': str,
            'connection': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PortRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PortRequest of this PortRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this PortRequest.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this PortRequest.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this PortRequest.
    ...
    @property
    def connection(self):
        """Gets the connection of this PortRequest.


        :return: The connection of this PortRequest.
        :rtype: str
        """
    ...
    def connection(self, connection):
        """Sets the connection of this PortRequest.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this PortRequest.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this PortRequest.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this PortRequest.
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this PortRequest.
    ...
    def external_ref(self):
        """Gets the external_ref of this PortRequest.

        Reference field, free to use for the API user.

        :return: The external_ref of this PortRequest.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this PortRequest.
    ...
    def managing_account(self):
        """Gets the managing_account of this PortRequest.
        ...
        :return: The managing_account of this PortRequest.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this PortRequest.
    ...
    def media_type(self, media_type):
        """Sets the media_type of this PortRequest.
    ...
    @property
    def pop(self):
        """Gets the pop of this PortRequest.

        Same as the `pop` of the `device`. 

        :return: The pop of this PortRequest.
        :rtype: str
        """
        return self._pop
    ...
    @pop.setter
    def pop(self, pop):
        """Sets the pop of this PortRequest.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this PortRequest.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this PortRequest.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this PortRequest.
    ...
    def role_assignments(self):
        """Gets the role_assignments of this PortRequest.
        ...
        :return: The role_assignments of this PortRequest.
        :rtype: List[str]
        """
    ...
    def role_assignments(self, role_assignments):
        """Sets the role_assignments of this PortRequest.
    ...
    @property
    def speed(self):
        """Gets the speed of this PortRequest.


        :return: The speed of this PortRequest.
        :rtype: int
        """
        return self._speed
    ...
    def speed(self, speed):
        """Sets the speed of this PortRequest.
