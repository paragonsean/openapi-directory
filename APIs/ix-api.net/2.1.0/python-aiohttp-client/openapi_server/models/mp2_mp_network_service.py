...
class MP2MPNetworkService(Model):
    ...
    def __init__(self, billing_account: str=None, charged_until: date=None, consuming_account: str=None, contract_ref: str=None, decommission_at: date=None, external_ref: str=None, id: str=None, managing_account: str=None, member_joining_rules: List[str]=None, name: str=None, network_features: List[str]=None, nsc_required_contact_roles: List[str]=None, product_offering: str=None, public: bool=False, purchase_order: str='', state: str=None, status: List[Status]=None, type: str=None):
        """MP2MPNetworkService - a model defined in OpenAPI

        :param billing_account: The billing_account of this MP2MPNetworkService.
        :param charged_until: The charged_until of this MP2MPNetworkService.
        :param consuming_account: The consuming_account of this MP2MPNetworkService.
        :param contract_ref: The contract_ref of this MP2MPNetworkService.
        :param decommission_at: The decommission_at of this MP2MPNetworkService.
        :param external_ref: The external_ref of this MP2MPNetworkService.
        :param id: The id of this MP2MPNetworkService.
        :param managing_account: The managing_account of this MP2MPNetworkService.
        :param member_joining_rules: The member_joining_rules of this MP2MPNetworkService.
        :param name: The name of this MP2MPNetworkService.
        :param network_features: The network_features of this MP2MPNetworkService.
        :param nsc_required_contact_roles: The nsc_required_contact_roles of this MP2MPNetworkService.
        :param product_offering: The product_offering of this MP2MPNetworkService.
        :param public: The public of this MP2MPNetworkService.
        :param purchase_order: The purchase_order of this MP2MPNetworkService.
        :param state: The state of this MP2MPNetworkService.
        :param status: The status of this MP2MPNetworkService.
        :param type: The type of this MP2MPNetworkService.
        """
        self.openapi_types = {
            'billing_account': str,
            'charged_until': date,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MP2MPNetworkService':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MP2MPNetworkService of this MP2MPNetworkService.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def billing_account(self):
        """Gets the billing_account of this MP2MPNetworkService.

        An account requires billing_information to be used as a `billing_account`.

        :return: The billing_account of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def billing_account(self, billing_account):
        """Sets the billing_account of this MP2MPNetworkService.
    ...
    def charged_until(self):
        """Gets the charged_until of this MP2MPNetworkService.
        ...
        :return: The charged_until of this MP2MPNetworkService.
        :rtype: date
        """
    ...
    def charged_until(self, charged_until):
        """Sets the charged_until of this MP2MPNetworkService.
    ...
    def consuming_account(self):
        """Gets the consuming_account of this MP2MPNetworkService.

        The `id` of the account consuming a service.  Used to be `owning_customer`. 

        :return: The consuming_account of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def consuming_account(self, consuming_account):
        """Sets the consuming_account of this MP2MPNetworkService.
    ...
    def contract_ref(self):
        """Gets the contract_ref of this MP2MPNetworkService.

        A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 

        :return: The contract_ref of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def contract_ref(self, contract_ref):
        """Sets the contract_ref of this MP2MPNetworkService.
    ...
    def decommission_at(self):
        """Gets the decommission_at of this MP2MPNetworkService.
        ...
        :return: The decommission_at of this MP2MPNetworkService.
        :rtype: date
        """
    ...
    def decommission_at(self, decommission_at):
        """Sets the decommission_at of this MP2MPNetworkService.
    ...
    def external_ref(self):
        """Gets the external_ref of this MP2MPNetworkService.

        Reference field, free to use for the API user.

        :return: The external_ref of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def external_ref(self, external_ref):
        """Sets the external_ref of this MP2MPNetworkService.
    ...
    @property
    def id(self):
        """Gets the id of this MP2MPNetworkService.


        :return: The id of this MP2MPNetworkService.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MP2MPNetworkService.
    ...
    def managing_account(self):
        """Gets the managing_account of this MP2MPNetworkService.
        ...
        :return: The managing_account of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this MP2MPNetworkService.
    ...
    def member_joining_rules(self):
        """Gets the member_joining_rules of this MP2MPNetworkService.


        :return: The member_joining_rules of this MP2MPNetworkService.
        :rtype: List[str]
        """
    ...
    def member_joining_rules(self, member_joining_rules):
        """Sets the member_joining_rules of this MP2MPNetworkService.
    ...
    @property
    def name(self):
        """Gets the name of this MP2MPNetworkService.

        Name of the multi-point to multi-point virtual circuit.

        :return: The name of this MP2MPNetworkService.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MP2MPNetworkService.
    ...
    def network_features(self):
        """Gets the network_features of this MP2MPNetworkService.


        :return: The network_features of this MP2MPNetworkService.
        :rtype: List[str]
        """
    ...
    def network_features(self, network_features):
        """Sets the network_features of this MP2MPNetworkService.
    ...
    def nsc_required_contact_roles(self):
        """Gets the nsc_required_contact_roles of this MP2MPNetworkService.
        ...
        :return: The nsc_required_contact_roles of this MP2MPNetworkService.
        :rtype: List[str]
        """
    ...
    def nsc_required_contact_roles(self, nsc_required_contact_roles):
        """Sets the nsc_required_contact_roles of this MP2MPNetworkService.
    ...
    def product_offering(self):
        """Gets the product_offering of this MP2MPNetworkService.


        :return: The product_offering of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def product_offering(self, product_offering):
        """Sets the product_offering of this MP2MPNetworkService.
    ...
    @property
    def public(self):
        """Gets the public of this MP2MPNetworkService.
        ...
        :return: The public of this MP2MPNetworkService.
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this MP2MPNetworkService.
    ...
    def purchase_order(self):
        """Gets the purchase_order of this MP2MPNetworkService.

        Purchase Order ID which will be displayed on the invoice. 

        :return: The purchase_order of this MP2MPNetworkService.
        :rtype: str
        """
    ...
    def purchase_order(self, purchase_order):
        """Sets the purchase_order of this MP2MPNetworkService.
    ...
    @property
    def state(self):
        """Gets the state of this MP2MPNetworkService.


        :return: The state of this MP2MPNetworkService.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this MP2MPNetworkService.
    ...
    @property
    def status(self):
        """Gets the status of this MP2MPNetworkService.


        :return: The status of this MP2MPNetworkService.
        :rtype: List[Status]
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this MP2MPNetworkService.
    ...
    @property
    def type(self):
        """Gets the type of this MP2MPNetworkService.


        :return: The type of this MP2MPNetworkService.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this MP2MPNetworkService.
