...
class Manageable(Model):
    ...
    def __init__(self, managing_account: str=None):
        """Manageable - a model defined in OpenAPI

        :param managing_account: The managing_account of this Manageable.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Manageable':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Manageable of this Manageable.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def managing_account(self):
        """Gets the managing_account of this Manageable.
        ...
        :return: The managing_account of this Manageable.
        :rtype: str
        """
    ...
    def managing_account(self, managing_account):
        """Sets the managing_account of this Manageable.
