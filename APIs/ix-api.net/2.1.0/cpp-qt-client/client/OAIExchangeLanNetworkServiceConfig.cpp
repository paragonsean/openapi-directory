...
#include "OAIExchangeLanNetworkServiceConfig.h"
...
OAIExchangeLanNetworkServiceConfig::OAIExchangeLanNetworkServiceConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangeLanNetworkServiceConfig::OAIExchangeLanNetworkServiceConfig() {
    this->initializeModel();
}

OAIExchangeLanNetworkServiceConfig::~OAIExchangeLanNetworkServiceConfig() {}

void OAIExchangeLanNetworkServiceConfig::initializeModel() {
...
void OAIExchangeLanNetworkServiceConfig::fromJson(QString jsonString) {
...
void OAIExchangeLanNetworkServiceConfig::fromJsonObject(QJsonObject json) {
...
QString OAIExchangeLanNetworkServiceConfig::asJson() const {
...
QJsonObject OAIExchangeLanNetworkServiceConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_asns.size() > 0) {
...
QList<qint64> OAIExchangeLanNetworkServiceConfig::getAsns() const {
    return m_asns;
}
void OAIExchangeLanNetworkServiceConfig::setAsns(const QList<qint64> &asns) {
    m_asns = asns;
    m_asns_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_asns_Set() const{
    return m_asns_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_asns_Valid() const{
    return m_asns_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getBillingAccount() const {
    return m_billing_account;
}
void OAIExchangeLanNetworkServiceConfig::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIExchangeLanNetworkServiceConfig::getCapacity() const {
    return m_capacity;
}
void OAIExchangeLanNetworkServiceConfig::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAIExchangeLanNetworkServiceConfig::getChargedUntil() const {
    return m_charged_until;
}
void OAIExchangeLanNetworkServiceConfig::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getConnection() const {
    return m_connection;
}
void OAIExchangeLanNetworkServiceConfig::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIExchangeLanNetworkServiceConfig::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getContractRef() const {
    return m_contract_ref;
}
void OAIExchangeLanNetworkServiceConfig::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAIExchangeLanNetworkServiceConfig::getDecommissionAt() const {
    return m_decommission_at;
}
void OAIExchangeLanNetworkServiceConfig::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getExternalRef() const {
    return m_external_ref;
}
void OAIExchangeLanNetworkServiceConfig::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getId() const {
    return m_id;
}
void OAIExchangeLanNetworkServiceConfig::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIExchangeLanNetworkServiceConfig::getIps() const {
    return m_ips;
}
void OAIExchangeLanNetworkServiceConfig::setIps(const QList<QString> &ips) {
    m_ips = ips;
    m_ips_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_ips_Set() const{
    return m_ips_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_ips_Valid() const{
    return m_ips_isValid;
}

bool OAIExchangeLanNetworkServiceConfig::isListed() const {
    return m_listed;
}
void OAIExchangeLanNetworkServiceConfig::setListed(const bool &listed) {
    m_listed = listed;
    m_listed_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_listed_Set() const{
    return m_listed_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_listed_Valid() const{
    return m_listed_isValid;
}

QList<QString> OAIExchangeLanNetworkServiceConfig::getMacs() const {
    return m_macs;
}
void OAIExchangeLanNetworkServiceConfig::setMacs(const QList<QString> &macs) {
    m_macs = macs;
    m_macs_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_macs_Set() const{
    return m_macs_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_macs_Valid() const{
    return m_macs_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getManagingAccount() const {
    return m_managing_account;
}
void OAIExchangeLanNetworkServiceConfig::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIExchangeLanNetworkServiceConfig::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIExchangeLanNetworkServiceConfig::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getNetworkService() const {
    return m_network_service;
}
void OAIExchangeLanNetworkServiceConfig::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getProductOffering() const {
    return m_product_offering;
}
void OAIExchangeLanNetworkServiceConfig::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIExchangeLanNetworkServiceConfig::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIExchangeLanNetworkServiceConfig::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIExchangeLanNetworkServiceConfig::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getState() const {
    return m_state;
}
void OAIExchangeLanNetworkServiceConfig::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_state_Set() const{
    return m_state_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIExchangeLanNetworkServiceConfig::getStatus() const {
    return m_status;
}
void OAIExchangeLanNetworkServiceConfig::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIExchangeLanNetworkServiceConfig::getType() const {
    return m_type;
}
void OAIExchangeLanNetworkServiceConfig::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIExchangeLanNetworkServiceConfig::getVlanConfig() const {
    return m_vlan_config;
}
void OAIExchangeLanNetworkServiceConfig::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIExchangeLanNetworkServiceConfig::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIExchangeLanNetworkServiceConfig::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIExchangeLanNetworkServiceConfig::isSet() const {
...
bool OAIExchangeLanNetworkServiceConfig::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_asns_isValid && m_billing_account_isValid && m_connection_isValid && m_consuming_account_isValid && m_id_isValid && m_listed_isValid && m_managing_account_isValid && m_network_service_isValid && m_product_offering_isValid && m_role_assignments_isValid && m_state_isValid && m_type_isValid && m_vlan_config_isValid && true;
}
