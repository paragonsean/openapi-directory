...
/*
 * OAIIpAddressUpdatePartial.h
 *
 * IP-Address Update
 */

#ifndef OAIIpAddressUpdatePartial_H
#define OAIIpAddressUpdatePartial_H
...
class OAIIpAddressUpdatePartial : public OAIObject {
public:
    OAIIpAddressUpdatePartial();
    OAIIpAddressUpdatePartial(QString json);
    ~OAIIpAddressUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressUpdatePartial)

#endif // OAIIpAddressUpdatePartial_H
