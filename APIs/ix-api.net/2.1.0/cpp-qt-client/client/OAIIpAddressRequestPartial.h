...
/*
 * OAIIpAddressRequestPartial.h
 *
 * IP-Address / Prefix allocation Request
 */

#ifndef OAIIpAddressRequestPartial_H
#define OAIIpAddressRequestPartial_H
...
class OAIIpAddressRequestPartial : public OAIObject {
public:
    OAIIpAddressRequestPartial();
    OAIIpAddressRequestPartial(QString json);
    ~OAIIpAddressRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressRequestPartial)

#endif // OAIIpAddressRequestPartial_H
