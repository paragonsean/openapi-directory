...
/*
 * OAIConnectionPartial.h
 *
 * Connection
 */

#ifndef OAIConnectionPartial_H
#define OAIConnectionPartial_H
...
class OAIConnectionPartial : public OAIObject {
public:
    OAIConnectionPartial();
    OAIConnectionPartial(QString json);
    ~OAIConnectionPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionPartial)

#endif // OAIConnectionPartial_H
