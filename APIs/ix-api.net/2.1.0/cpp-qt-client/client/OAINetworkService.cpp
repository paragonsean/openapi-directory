...
QString OAINetworkService::getConsumingAccount() const {
    return m_consuming_account;
}
void OAINetworkService::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAINetworkService::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAINetworkService::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAINetworkService::getExternalRef() const {
    return m_external_ref;
}
void OAINetworkService::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAINetworkService::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAINetworkService::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAINetworkService::getId() const {
    return m_id;
}
void OAINetworkService::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINetworkService::is_id_Set() const{
    return m_id_isSet;
}

bool OAINetworkService::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAINetworkService::getIxfdbIxid() const {
    return m_ixfdb_ixid;
}
void OAINetworkService::setIxfdbIxid(const qint32 &ixfdb_ixid) {
    m_ixfdb_ixid = ixfdb_ixid;
    m_ixfdb_ixid_isSet = true;
}

bool OAINetworkService::is_ixfdb_ixid_Set() const{
    return m_ixfdb_ixid_isSet;
}

bool OAINetworkService::is_ixfdb_ixid_Valid() const{
    return m_ixfdb_ixid_isValid;
}

QString OAINetworkService::getManagingAccount() const {
    return m_managing_account;
}
void OAINetworkService::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAINetworkService::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAINetworkService::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAINetworkService::getMetroAreaNetwork() const {
    return m_metro_area_network;
}
void OAINetworkService::setMetroAreaNetwork(const QString &metro_area_network) {
    m_metro_area_network = metro_area_network;
    m_metro_area_network_isSet = true;
}

bool OAINetworkService::is_metro_area_network_Set() const{
    return m_metro_area_network_isSet;
}

bool OAINetworkService::is_metro_area_network_Valid() const{
    return m_metro_area_network_isValid;
}

QString OAINetworkService::getName() const {
    return m_name;
}
void OAINetworkService::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAINetworkService::is_name_Set() const{
    return m_name_isSet;
}

bool OAINetworkService::is_name_Valid() const{
    return m_name_isValid;
}

QList<QString> OAINetworkService::getNetworkFeatures() const {
    return m_network_features;
}
void OAINetworkService::setNetworkFeatures(const QList<QString> &network_features) {
    m_network_features = network_features;
    m_network_features_isSet = true;
}

bool OAINetworkService::is_network_features_Set() const{
    return m_network_features_isSet;
}

bool OAINetworkService::is_network_features_Valid() const{
    return m_network_features_isValid;
}

QList<QString> OAINetworkService::getNscRequiredContactRoles() const {
    return m_nsc_required_contact_roles;
}
void OAINetworkService::setNscRequiredContactRoles(const QList<QString> &nsc_required_contact_roles) {
    m_nsc_required_contact_roles = nsc_required_contact_roles;
    m_nsc_required_contact_roles_isSet = true;
}

bool OAINetworkService::is_nsc_required_contact_roles_Set() const{
    return m_nsc_required_contact_roles_isSet;
}

bool OAINetworkService::is_nsc_required_contact_roles_Valid() const{
    return m_nsc_required_contact_roles_isValid;
}

qint32 OAINetworkService::getPeeringdbIxid() const {
    return m_peeringdb_ixid;
}
void OAINetworkService::setPeeringdbIxid(const qint32 &peeringdb_ixid) {
    m_peeringdb_ixid = peeringdb_ixid;
    m_peeringdb_ixid_isSet = true;
}

bool OAINetworkService::is_peeringdb_ixid_Set() const{
    return m_peeringdb_ixid_isSet;
}

bool OAINetworkService::is_peeringdb_ixid_Valid() const{
    return m_peeringdb_ixid_isValid;
}

QString OAINetworkService::getProductOffering() const {
    return m_product_offering;
}
void OAINetworkService::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAINetworkService::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAINetworkService::is_product_offering_Valid() const{
...
QList<OAIStatus> OAINetworkService::getStatus() const {
    return m_status;
}
void OAINetworkService::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAINetworkService::is_status_Set() const{
    return m_status_isSet;
}

bool OAINetworkService::is_status_Valid() const{
    return m_status_isValid;
}

QString OAINetworkService::getSubnetV4() const {
    return m_subnet_v4;
}
void OAINetworkService::setSubnetV4(const QString &subnet_v4) {
    m_subnet_v4 = subnet_v4;
    m_subnet_v4_isSet = true;
}

bool OAINetworkService::is_subnet_v4_Set() const{
    return m_subnet_v4_isSet;
}

bool OAINetworkService::is_subnet_v4_Valid() const{
    return m_subnet_v4_isValid;
}

QString OAINetworkService::getSubnetV6() const {
    return m_subnet_v6;
}
void OAINetworkService::setSubnetV6(const QString &subnet_v6) {
    m_subnet_v6 = subnet_v6;
    m_subnet_v6_isSet = true;
}

bool OAINetworkService::is_subnet_v6_Set() const{
    return m_subnet_v6_isSet;
}

bool OAINetworkService::is_subnet_v6_Valid() const{
    return m_subnet_v6_isValid;
}

QString OAINetworkService::getType() const {
    return m_type;
}
void OAINetworkService::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINetworkService::is_type_Set() const{
    return m_type_isSet;
}

bool OAINetworkService::is_type_Valid() const{
    return m_type_isValid;
}

QString OAINetworkService::getBillingAccount() const {
    return m_billing_account;
}
void OAINetworkService::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAINetworkService::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAINetworkService::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAINetworkService::getCapacity() const {
    return m_capacity;
}
void OAINetworkService::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAINetworkService::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAINetworkService::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAINetworkService::getChargedUntil() const {
    return m_charged_until;
}
void OAINetworkService::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAINetworkService::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAINetworkService::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAINetworkService::getContractRef() const {
    return m_contract_ref;
}
void OAINetworkService::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAINetworkService::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAINetworkService::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAINetworkService::getDecommissionAt() const {
    return m_decommission_at;
}
void OAINetworkService::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAINetworkService::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAINetworkService::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAINetworkService::getJoiningMemberAccount() const {
    return m_joining_member_account;
}
void OAINetworkService::setJoiningMemberAccount(const QString &joining_member_account) {
    m_joining_member_account = joining_member_account;
    m_joining_member_account_isSet = true;
}

bool OAINetworkService::is_joining_member_account_Set() const{
    return m_joining_member_account_isSet;
}

bool OAINetworkService::is_joining_member_account_Valid() const{
    return m_joining_member_account_isValid;
}

QString OAINetworkService::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAINetworkService::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAINetworkService::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAINetworkService::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAINetworkService::getMemberJoiningRules() const {
    return m_member_joining_rules;
}
void OAINetworkService::setMemberJoiningRules(const QList<QString> &member_joining_rules) {
    m_member_joining_rules = member_joining_rules;
    m_member_joining_rules_isSet = true;
}

bool OAINetworkService::is_member_joining_rules_Set() const{
    return m_member_joining_rules_isSet;
}

bool OAINetworkService::is_member_joining_rules_Valid() const{
    return m_member_joining_rules_isValid;
}

bool OAINetworkService::isRPublic() const {
    return m_r_public;
}
void OAINetworkService::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAINetworkService::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAINetworkService::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAINetworkService::getCloudKey() const {
    return m_cloud_key;
}
void OAINetworkService::setCloudKey(const QString &cloud_key) {
    m_cloud_key = cloud_key;
    m_cloud_key_isSet = true;
}

bool OAINetworkService::is_cloud_key_Set() const{
    return m_cloud_key_isSet;
}

bool OAINetworkService::is_cloud_key_Valid() const{
    return m_cloud_key_isValid;
}

qint32 OAINetworkService::getDiversity() const {
    return m_diversity;
}
void OAINetworkService::setDiversity(const qint32 &diversity) {
    m_diversity = diversity;
    m_diversity_isSet = true;
}

bool OAINetworkService::is_diversity_Set() const{
    return m_diversity_isSet;
}

bool OAINetworkService::is_diversity_Valid() const{
    return m_diversity_isValid;
}

QString OAINetworkService::getProviderRef() const {
    return m_provider_ref;
}
void OAINetworkService::setProviderRef(const QString &provider_ref) {
    m_provider_ref = provider_ref;
    m_provider_ref_isSet = true;
}

bool OAINetworkService::is_provider_ref_Set() const{
    return m_provider_ref_isSet;
}

bool OAINetworkService::is_provider_ref_Valid() const{
...
bool OAINetworkService::isValid() const {
    ...
    return m_consuming_account_isValid && m_id_isValid && m_managing_account_isValid && m_metro_area_network_isValid && m_name_isValid && m_network_features_isValid && m_product_offering_isValid && m_state_isValid && m_subnet_v4_isValid && m_subnet_v6_isValid && m_type_isValid && m_billing_account_isValid && m_joining_member_account_isValid && m_member_joining_rules_isValid && m_cloud_key_isValid && m_diversity_isValid && m_provider_ref_isValid && true;
}
