...
#include "OAIMP2MPNetworkServiceRequest.h"
...
OAIMP2MPNetworkServiceRequest::OAIMP2MPNetworkServiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMP2MPNetworkServiceRequest::OAIMP2MPNetworkServiceRequest() {
    this->initializeModel();
}

OAIMP2MPNetworkServiceRequest::~OAIMP2MPNetworkServiceRequest() {}

void OAIMP2MPNetworkServiceRequest::initializeModel() {
...
void OAIMP2MPNetworkServiceRequest::fromJson(QString jsonString) {
...
void OAIMP2MPNetworkServiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIMP2MPNetworkServiceRequest::asJson() const {
...
QJsonObject OAIMP2MPNetworkServiceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMP2MPNetworkServiceRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIMP2MPNetworkServiceRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMP2MPNetworkServiceRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIMP2MPNetworkServiceRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIMP2MPNetworkServiceRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIMP2MPNetworkServiceRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getName() const {
    return m_name;
}
void OAIMP2MPNetworkServiceRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getProductOffering() const {
    return m_product_offering;
}
void OAIMP2MPNetworkServiceRequest::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

bool OAIMP2MPNetworkServiceRequest::isRPublic() const {
    return m_r_public;
}
void OAIMP2MPNetworkServiceRequest::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIMP2MPNetworkServiceRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAIMP2MPNetworkServiceRequest::getType() const {
    return m_type;
}
void OAIMP2MPNetworkServiceRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMP2MPNetworkServiceRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMP2MPNetworkServiceRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMP2MPNetworkServiceRequest::isSet() const {
...
bool OAIMP2MPNetworkServiceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_name_isValid && m_product_offering_isValid && m_type_isValid && true;
}
