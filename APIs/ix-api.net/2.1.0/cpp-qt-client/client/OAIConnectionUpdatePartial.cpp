...
#include "OAIConnectionUpdatePartial.h"
...
OAIConnectionUpdatePartial::OAIConnectionUpdatePartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectionUpdatePartial::OAIConnectionUpdatePartial() {
    this->initializeModel();
}

OAIConnectionUpdatePartial::~OAIConnectionUpdatePartial() {}

void OAIConnectionUpdatePartial::initializeModel() {
...
void OAIConnectionUpdatePartial::fromJson(QString jsonString) {
...
void OAIConnectionUpdatePartial::fromJsonObject(QJsonObject json) {
...
QString OAIConnectionUpdatePartial::asJson() const {
...
QJsonObject OAIConnectionUpdatePartial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConnectionUpdatePartial::getBillingAccount() const {
    return m_billing_account;
}
void OAIConnectionUpdatePartial::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIConnectionUpdatePartial::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIConnectionUpdatePartial::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIConnectionUpdatePartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIConnectionUpdatePartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIConnectionUpdatePartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIConnectionUpdatePartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIConnectionUpdatePartial::getContractRef() const {
    return m_contract_ref;
}
void OAIConnectionUpdatePartial::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIConnectionUpdatePartial::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIConnectionUpdatePartial::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIConnectionUpdatePartial::getExternalRef() const {
    return m_external_ref;
}
void OAIConnectionUpdatePartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIConnectionUpdatePartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIConnectionUpdatePartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIConnectionUpdatePartial::getLacpTimeout() const {
    return m_lacp_timeout;
}
void OAIConnectionUpdatePartial::setLacpTimeout(const QString &lacp_timeout) {
    m_lacp_timeout = lacp_timeout;
    m_lacp_timeout_isSet = true;
}

bool OAIConnectionUpdatePartial::is_lacp_timeout_Set() const{
    return m_lacp_timeout_isSet;
}

bool OAIConnectionUpdatePartial::is_lacp_timeout_Valid() const{
    return m_lacp_timeout_isValid;
}

QString OAIConnectionUpdatePartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIConnectionUpdatePartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIConnectionUpdatePartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIConnectionUpdatePartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIConnectionUpdatePartial::getMode() const {
    return m_mode;
}
void OAIConnectionUpdatePartial::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIConnectionUpdatePartial::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIConnectionUpdatePartial::is_mode_Valid() const{
    return m_mode_isValid;
}

QString OAIConnectionUpdatePartial::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIConnectionUpdatePartial::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIConnectionUpdatePartial::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIConnectionUpdatePartial::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIConnectionUpdatePartial::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIConnectionUpdatePartial::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIConnectionUpdatePartial::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIConnectionUpdatePartial::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIConnectionUpdatePartial::getSpeed() const {
    return m_speed;
}
void OAIConnectionUpdatePartial::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIConnectionUpdatePartial::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIConnectionUpdatePartial::is_speed_Valid() const{
    return m_speed_isValid;
}

bool OAIConnectionUpdatePartial::isSet() const {
...
bool OAIConnectionUpdatePartial::isValid() const {
