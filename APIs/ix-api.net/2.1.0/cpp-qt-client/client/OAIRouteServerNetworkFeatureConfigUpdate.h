...
/*
 * OAIRouteServerNetworkFeatureConfigUpdate.h
 *
 * 
 */

#ifndef OAIRouteServerNetworkFeatureConfigUpdate_H
#define OAIRouteServerNetworkFeatureConfigUpdate_H
...
class OAIRouteServerNetworkFeatureConfigUpdate : public OAIObject {
public:
    OAIRouteServerNetworkFeatureConfigUpdate();
    OAIRouteServerNetworkFeatureConfigUpdate(QString json);
    ~OAIRouteServerNetworkFeatureConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeatureConfigUpdate)

#endif // OAIRouteServerNetworkFeatureConfigUpdate_H
