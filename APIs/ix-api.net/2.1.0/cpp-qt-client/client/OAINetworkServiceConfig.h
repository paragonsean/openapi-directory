...
/*
 * OAINetworkServiceConfig.h
 *
 * Polymorphic Network Service Config
 */

#ifndef OAINetworkServiceConfig_H
#define OAINetworkServiceConfig_H
...
class OAINetworkServiceConfig : public OAIObject {
public:
    OAINetworkServiceConfig();
    OAINetworkServiceConfig(QString json);
    ~OAINetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceConfig)

#endif // OAINetworkServiceConfig_H
