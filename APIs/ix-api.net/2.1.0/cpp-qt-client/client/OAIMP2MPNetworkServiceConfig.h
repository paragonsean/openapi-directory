...
/*
 * OAIMP2MPNetworkServiceConfig.h
 *
 * 
 */

#ifndef OAIMP2MPNetworkServiceConfig_H
#define OAIMP2MPNetworkServiceConfig_H
...
class OAIMP2MPNetworkServiceConfig : public OAIObject {
public:
    OAIMP2MPNetworkServiceConfig();
    OAIMP2MPNetworkServiceConfig(QString json);
    ~OAIMP2MPNetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkServiceConfig)

#endif // OAIMP2MPNetworkServiceConfig_H
