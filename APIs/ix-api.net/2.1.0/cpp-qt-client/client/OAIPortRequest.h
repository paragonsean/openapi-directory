...
#ifndef OAIPortRequest_H
#define OAIPortRequest_H
...
class OAIPortRequest : public OAIObject {
public:
    OAIPortRequest();
    OAIPortRequest(QString json);
    ~OAIPortRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortRequest)

#endif // OAIPortRequest_H
