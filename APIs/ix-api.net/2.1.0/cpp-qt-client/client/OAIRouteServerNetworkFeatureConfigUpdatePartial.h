...
/*
 * OAIRouteServerNetworkFeatureConfigUpdatePartial.h
 *
 * Route Server Network Feature Config Update
 */

#ifndef OAIRouteServerNetworkFeatureConfigUpdatePartial_H
#define OAIRouteServerNetworkFeatureConfigUpdatePartial_H
...
class OAIRouteServerNetworkFeatureConfigUpdatePartial : public OAIObject {
public:
    OAIRouteServerNetworkFeatureConfigUpdatePartial();
    OAIRouteServerNetworkFeatureConfigUpdatePartial(QString json);
    ~OAIRouteServerNetworkFeatureConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeatureConfigUpdatePartial)

#endif // OAIRouteServerNetworkFeatureConfigUpdatePartial_H
