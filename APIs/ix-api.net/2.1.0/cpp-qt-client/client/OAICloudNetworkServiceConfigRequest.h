...
/*
 * OAICloudNetworkServiceConfigRequest.h
 *
 * 
 */

#ifndef OAICloudNetworkServiceConfigRequest_H
#define OAICloudNetworkServiceConfigRequest_H
...
class OAICloudNetworkServiceConfigRequest : public OAIObject {
public:
    OAICloudNetworkServiceConfigRequest();
    OAICloudNetworkServiceConfigRequest(QString json);
    ~OAICloudNetworkServiceConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceConfigRequest)

#endif // OAICloudNetworkServiceConfigRequest_H
