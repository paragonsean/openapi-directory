...
#include "OAIP2PNetworkServiceConfigRequest.h"
...
OAIP2PNetworkServiceConfigRequest::OAIP2PNetworkServiceConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2PNetworkServiceConfigRequest::OAIP2PNetworkServiceConfigRequest() {
    this->initializeModel();
}

OAIP2PNetworkServiceConfigRequest::~OAIP2PNetworkServiceConfigRequest() {}

void OAIP2PNetworkServiceConfigRequest::initializeModel() {
...
void OAIP2PNetworkServiceConfigRequest::fromJson(QString jsonString) {
...
void OAIP2PNetworkServiceConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAIP2PNetworkServiceConfigRequest::asJson() const {
...
QJsonObject OAIP2PNetworkServiceConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2PNetworkServiceConfigRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2PNetworkServiceConfigRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIP2PNetworkServiceConfigRequest::getCapacity() const {
    return m_capacity;
}
void OAIP2PNetworkServiceConfigRequest::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getConnection() const {
    return m_connection;
}
void OAIP2PNetworkServiceConfigRequest::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2PNetworkServiceConfigRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIP2PNetworkServiceConfigRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIP2PNetworkServiceConfigRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2PNetworkServiceConfigRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIP2PNetworkServiceConfigRequest::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIP2PNetworkServiceConfigRequest::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getNetworkService() const {
    return m_network_service;
}
void OAIP2PNetworkServiceConfigRequest::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2PNetworkServiceConfigRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIP2PNetworkServiceConfigRequest::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIP2PNetworkServiceConfigRequest::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIP2PNetworkServiceConfigRequest::getType() const {
    return m_type;
}
void OAIP2PNetworkServiceConfigRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIP2PNetworkServiceConfigRequest::getVlanConfig() const {
    return m_vlan_config;
}
void OAIP2PNetworkServiceConfigRequest::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIP2PNetworkServiceConfigRequest::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIP2PNetworkServiceConfigRequest::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIP2PNetworkServiceConfigRequest::isSet() const {
...
bool OAIP2PNetworkServiceConfigRequest::isValid() const {
