...
/*
 * OAIP2PNetworkServiceConfigRequest.h
 *
 * 
 */

#ifndef OAIP2PNetworkServiceConfigRequest_H
#define OAIP2PNetworkServiceConfigRequest_H
...
class OAIP2PNetworkServiceConfigRequest : public OAIObject {
public:
    OAIP2PNetworkServiceConfigRequest();
    OAIP2PNetworkServiceConfigRequest(QString json);
    ~OAIP2PNetworkServiceConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceConfigRequest)

#endif // OAIP2PNetworkServiceConfigRequest_H
