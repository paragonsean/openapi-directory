...
/*
 * OAIIpAddressPartial.h
 *
 * IP-Address
 */

#ifndef OAIIpAddressPartial_H
#define OAIIpAddressPartial_H
...
class OAIIpAddressPartial : public OAIObject {
public:
    OAIIpAddressPartial();
    OAIIpAddressPartial(QString json);
    ~OAIIpAddressPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressPartial)

#endif // OAIIpAddressPartial_H
