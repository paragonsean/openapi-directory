...
/*
 * OAIExchangeLanNetworkServiceConfigUpdatePartial.h
 *
 * Exchange Lan Network Service Config Update
 */

#ifndef OAIExchangeLanNetworkServiceConfigUpdatePartial_H
#define OAIExchangeLanNetworkServiceConfigUpdatePartial_H
...
class OAIExchangeLanNetworkServiceConfigUpdatePartial : public OAIObject {
public:
    OAIExchangeLanNetworkServiceConfigUpdatePartial();
    OAIExchangeLanNetworkServiceConfigUpdatePartial(QString json);
    ~OAIExchangeLanNetworkServiceConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangeLanNetworkServiceConfigUpdatePartial)

#endif // OAIExchangeLanNetworkServiceConfigUpdatePartial_H
