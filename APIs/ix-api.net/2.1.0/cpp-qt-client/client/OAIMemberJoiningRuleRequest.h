...
/*
 * OAIMemberJoiningRuleRequest.h
 *
 * Polymorphic Member Joining Rule Request
 */

#ifndef OAIMemberJoiningRuleRequest_H
#define OAIMemberJoiningRuleRequest_H
...
class OAIMemberJoiningRuleRequest : public OAIObject {
public:
    OAIMemberJoiningRuleRequest();
    OAIMemberJoiningRuleRequest(QString json);
    ~OAIMemberJoiningRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberJoiningRuleRequest)

#endif // OAIMemberJoiningRuleRequest_H
