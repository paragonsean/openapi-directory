...
#include "OAIAllowMemberJoiningRuleRequestPartial.h"
...
OAIAllowMemberJoiningRuleRequestPartial::OAIAllowMemberJoiningRuleRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllowMemberJoiningRuleRequestPartial::OAIAllowMemberJoiningRuleRequestPartial() {
    this->initializeModel();
}

OAIAllowMemberJoiningRuleRequestPartial::~OAIAllowMemberJoiningRuleRequestPartial() {}

void OAIAllowMemberJoiningRuleRequestPartial::initializeModel() {
...
void OAIAllowMemberJoiningRuleRequestPartial::fromJson(QString jsonString) {
...
void OAIAllowMemberJoiningRuleRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIAllowMemberJoiningRuleRequestPartial::asJson() const {
...
QJsonObject OAIAllowMemberJoiningRuleRequestPartial::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAllowMemberJoiningRuleRequestPartial::getCapacityMax() const {
    return m_capacity_max;
}
void OAIAllowMemberJoiningRuleRequestPartial::setCapacityMax(const qint32 &capacity_max) {
    m_capacity_max = capacity_max;
    m_capacity_max_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_capacity_max_Set() const{
    return m_capacity_max_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_capacity_max_Valid() const{
    return m_capacity_max_isValid;
}

qint32 OAIAllowMemberJoiningRuleRequestPartial::getCapacityMin() const {
    return m_capacity_min;
}
void OAIAllowMemberJoiningRuleRequestPartial::setCapacityMin(const qint32 &capacity_min) {
    m_capacity_min = capacity_min;
    m_capacity_min_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_capacity_min_Set() const{
    return m_capacity_min_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_capacity_min_Valid() const{
    return m_capacity_min_isValid;
}

QString OAIAllowMemberJoiningRuleRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIAllowMemberJoiningRuleRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIAllowMemberJoiningRuleRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIAllowMemberJoiningRuleRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIAllowMemberJoiningRuleRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIAllowMemberJoiningRuleRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIAllowMemberJoiningRuleRequestPartial::getNetworkService() const {
    return m_network_service;
}
void OAIAllowMemberJoiningRuleRequestPartial::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIAllowMemberJoiningRuleRequestPartial::getType() const {
    return m_type;
}
void OAIAllowMemberJoiningRuleRequestPartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAllowMemberJoiningRuleRequestPartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAllowMemberJoiningRuleRequestPartial::isSet() const {
...
bool OAIAllowMemberJoiningRuleRequestPartial::isValid() const {
