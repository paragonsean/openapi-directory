...
#ifndef OAIManageable_H
#define OAIManageable_H
...
class OAIManageable : public OAIObject {
public:
    OAIManageable();
    OAIManageable(QString json);
    ~OAIManageable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManageable)

#endif // OAIManageable_H
