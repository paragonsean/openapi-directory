...
/*
 * OAIMemberJoiningRule.h
 *
 * Polymorphic Member Joining Rule
 */

#ifndef OAIMemberJoiningRule_H
#define OAIMemberJoiningRule_H

#include <QJsonObject>

#include "OAIAllowMemberJoiningRule.h"
#include "OAIDenyMemberJoiningRule.h"
#include <QString>
...
class OAIMemberJoiningRule : public OAIObject {
public:
    OAIMemberJoiningRule();
    OAIMemberJoiningRule(QString json);
    ~OAIMemberJoiningRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberJoiningRule)

#endif // OAIMemberJoiningRule_H
