...
OAIConnectionUpdate::OAIConnectionUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectionUpdate::OAIConnectionUpdate() {
    this->initializeModel();
}

OAIConnectionUpdate::~OAIConnectionUpdate() {}

void OAIConnectionUpdate::initializeModel() {
...
void OAIConnectionUpdate::fromJson(QString jsonString) {
...
void OAIConnectionUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIConnectionUpdate::asJson() const {
...
QJsonObject OAIConnectionUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConnectionUpdate::getBillingAccount() const {
    return m_billing_account;
}
void OAIConnectionUpdate::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIConnectionUpdate::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIConnectionUpdate::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIConnectionUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIConnectionUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIConnectionUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIConnectionUpdate::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIConnectionUpdate::getContractRef() const {
    return m_contract_ref;
}
void OAIConnectionUpdate::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIConnectionUpdate::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIConnectionUpdate::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIConnectionUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIConnectionUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIConnectionUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIConnectionUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIConnectionUpdate::getLacpTimeout() const {
    return m_lacp_timeout;
}
void OAIConnectionUpdate::setLacpTimeout(const QString &lacp_timeout) {
    m_lacp_timeout = lacp_timeout;
    m_lacp_timeout_isSet = true;
}

bool OAIConnectionUpdate::is_lacp_timeout_Set() const{
    return m_lacp_timeout_isSet;
}

bool OAIConnectionUpdate::is_lacp_timeout_Valid() const{
    return m_lacp_timeout_isValid;
}

QString OAIConnectionUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIConnectionUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIConnectionUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIConnectionUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIConnectionUpdate::getMode() const {
    return m_mode;
}
void OAIConnectionUpdate::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIConnectionUpdate::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIConnectionUpdate::is_mode_Valid() const{
    return m_mode_isValid;
}

QString OAIConnectionUpdate::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIConnectionUpdate::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIConnectionUpdate::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIConnectionUpdate::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIConnectionUpdate::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIConnectionUpdate::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIConnectionUpdate::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIConnectionUpdate::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIConnectionUpdate::getSpeed() const {
    return m_speed;
}
void OAIConnectionUpdate::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIConnectionUpdate::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIConnectionUpdate::is_speed_Valid() const{
    return m_speed_isValid;
}

bool OAIConnectionUpdate::isSet() const {
...
bool OAIConnectionUpdate::isValid() const {
