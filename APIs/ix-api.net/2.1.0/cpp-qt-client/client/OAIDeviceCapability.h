...
/*
 * OAIDeviceCapability.h
 *
 * 
 */

#ifndef OAIDeviceCapability_H
#define OAIDeviceCapability_H
...
class OAIDeviceCapability : public OAIObject {
public:
    OAIDeviceCapability();
    OAIDeviceCapability(QString json);
    ~OAIDeviceCapability() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceCapability)

#endif // OAIDeviceCapability_H
