...
/*
 * OAIImplementationResponsePartial.h
 *
 * API Implementation
 */

#ifndef OAIImplementationResponsePartial_H
#define OAIImplementationResponsePartial_H
...
class OAIImplementationResponsePartial : public OAIObject {
public:
    OAIImplementationResponsePartial();
    OAIImplementationResponsePartial(QString json);
    ~OAIImplementationResponsePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImplementationResponsePartial)

#endif // OAIImplementationResponsePartial_H
