...
/*
 * OAIPortRequestPartial.h
 *
 * Port Request
 */

#ifndef OAIPortRequestPartial_H
#define OAIPortRequestPartial_H
...
class OAIPortRequestPartial : public OAIObject {
public:
    OAIPortRequestPartial();
    OAIPortRequestPartial(QString json);
    ~OAIPortRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortRequestPartial)

#endif // OAIPortRequestPartial_H
