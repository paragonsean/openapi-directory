...
#ifndef OAIOwnablePartial_H
#define OAIOwnablePartial_H
...
class OAIOwnablePartial : public OAIObject {
public:
    OAIOwnablePartial();
    OAIOwnablePartial(QString json);
    ~OAIOwnablePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOwnablePartial)

#endif // OAIOwnablePartial_H
