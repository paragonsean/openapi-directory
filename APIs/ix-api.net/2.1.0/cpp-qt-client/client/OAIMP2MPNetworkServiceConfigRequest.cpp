...
#include "OAIMP2MPNetworkServiceConfigRequest.h"
...
OAIMP2MPNetworkServiceConfigRequest::OAIMP2MPNetworkServiceConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMP2MPNetworkServiceConfigRequest::OAIMP2MPNetworkServiceConfigRequest() {
    this->initializeModel();
}

OAIMP2MPNetworkServiceConfigRequest::~OAIMP2MPNetworkServiceConfigRequest() {}

void OAIMP2MPNetworkServiceConfigRequest::initializeModel() {
...
void OAIMP2MPNetworkServiceConfigRequest::fromJson(QString jsonString) {
...
void OAIMP2MPNetworkServiceConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAIMP2MPNetworkServiceConfigRequest::asJson() const {
...
QJsonObject OAIMP2MPNetworkServiceConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMP2MPNetworkServiceConfigRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIMP2MPNetworkServiceConfigRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIMP2MPNetworkServiceConfigRequest::getCapacity() const {
    return m_capacity;
}
void OAIMP2MPNetworkServiceConfigRequest::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getConnection() const {
    return m_connection;
}
void OAIMP2MPNetworkServiceConfigRequest::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMP2MPNetworkServiceConfigRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIMP2MPNetworkServiceConfigRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIMP2MPNetworkServiceConfigRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigRequest::getMacs() const {
    return m_macs;
}
void OAIMP2MPNetworkServiceConfigRequest::setMacs(const QList<QString> &macs) {
    m_macs = macs;
    m_macs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_macs_Set() const{
    return m_macs_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_macs_Valid() const{
    return m_macs_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIMP2MPNetworkServiceConfigRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigRequest::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIMP2MPNetworkServiceConfigRequest::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getNetworkService() const {
    return m_network_service;
}
void OAIMP2MPNetworkServiceConfigRequest::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIMP2MPNetworkServiceConfigRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigRequest::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIMP2MPNetworkServiceConfigRequest::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIMP2MPNetworkServiceConfigRequest::getType() const {
    return m_type;
}
void OAIMP2MPNetworkServiceConfigRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIMP2MPNetworkServiceConfigRequest::getVlanConfig() const {
    return m_vlan_config;
}
void OAIMP2MPNetworkServiceConfigRequest::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIMP2MPNetworkServiceConfigRequest::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIMP2MPNetworkServiceConfigRequest::isSet() const {
...
bool OAIMP2MPNetworkServiceConfigRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_connection_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_network_service_isValid && m_role_assignments_isValid && m_type_isValid && m_vlan_config_isValid && true;
}
