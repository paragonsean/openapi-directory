...
/*
 * OAINetworkServiceConfigUpdate.h
 *
 * Polymorphic Network Service Config
 */

#ifndef OAINetworkServiceConfigUpdate_H
#define OAINetworkServiceConfigUpdate_H
...
class OAINetworkServiceConfigUpdate : public OAIObject {
public:
    OAINetworkServiceConfigUpdate();
    OAINetworkServiceConfigUpdate(QString json);
    ~OAINetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceConfigUpdate)

#endif // OAINetworkServiceConfigUpdate_H
