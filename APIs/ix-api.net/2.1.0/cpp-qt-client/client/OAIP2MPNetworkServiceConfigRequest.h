...
/*
 * OAIP2MPNetworkServiceConfigRequest.h
 *
 * 
 */

#ifndef OAIP2MPNetworkServiceConfigRequest_H
#define OAIP2MPNetworkServiceConfigRequest_H
...
class OAIP2MPNetworkServiceConfigRequest : public OAIObject {
public:
    OAIP2MPNetworkServiceConfigRequest();
    OAIP2MPNetworkServiceConfigRequest(QString json);
    ~OAIP2MPNetworkServiceConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceConfigRequest)

#endif // OAIP2MPNetworkServiceConfigRequest_H
