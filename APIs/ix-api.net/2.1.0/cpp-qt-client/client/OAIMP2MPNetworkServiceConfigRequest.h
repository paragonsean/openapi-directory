...
/*
 * OAIMP2MPNetworkServiceConfigRequest.h
 *
 * 
 */

#ifndef OAIMP2MPNetworkServiceConfigRequest_H
#define OAIMP2MPNetworkServiceConfigRequest_H
...
class OAIMP2MPNetworkServiceConfigRequest : public OAIObject {
public:
    OAIMP2MPNetworkServiceConfigRequest();
    OAIMP2MPNetworkServiceConfigRequest(QString json);
    ~OAIMP2MPNetworkServiceConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkServiceConfigRequest)

#endif // OAIMP2MPNetworkServiceConfigRequest_H
