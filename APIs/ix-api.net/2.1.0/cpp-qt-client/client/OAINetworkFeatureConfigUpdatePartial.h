...
/*
 * OAINetworkFeatureConfigUpdatePartial.h
 *
 * Polymorphic Network Feauture Config Update
 */

#ifndef OAINetworkFeatureConfigUpdatePartial_H
#define OAINetworkFeatureConfigUpdatePartial_H

#include <QJsonObject>

#include "OAIRouteServerNetworkFeatureConfigUpdatePartial.h"
#include <QString>
...
class OAINetworkFeatureConfigUpdatePartial : public OAIObject {
public:
    OAINetworkFeatureConfigUpdatePartial();
    OAINetworkFeatureConfigUpdatePartial(QString json);
    ~OAINetworkFeatureConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkFeatureConfigUpdatePartial)

#endif // OAINetworkFeatureConfigUpdatePartial_H
