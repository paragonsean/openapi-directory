...
/*
 * OAIP2MPNetworkProductOfferingPartial.h
 *
 * P2MP Network Product Offering
 */

#ifndef OAIP2MPNetworkProductOfferingPartial_H
#define OAIP2MPNetworkProductOfferingPartial_H
...
class OAIP2MPNetworkProductOfferingPartial : public OAIObject {
public:
    OAIP2MPNetworkProductOfferingPartial();
    OAIP2MPNetworkProductOfferingPartial(QString json);
    ~OAIP2MPNetworkProductOfferingPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkProductOfferingPartial)

#endif // OAIP2MPNetworkProductOfferingPartial_H
