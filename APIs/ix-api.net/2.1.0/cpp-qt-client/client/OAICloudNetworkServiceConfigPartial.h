...
/*
 * OAICloudNetworkServiceConfigPartial.h
 *
 * Cloud Network Service Config
 */

#ifndef OAICloudNetworkServiceConfigPartial_H
#define OAICloudNetworkServiceConfigPartial_H
...
class OAICloudNetworkServiceConfigPartial : public OAIObject {
public:
    OAICloudNetworkServiceConfigPartial();
    OAICloudNetworkServiceConfigPartial(QString json);
    ~OAICloudNetworkServiceConfigPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceConfigPartial)

#endif // OAICloudNetworkServiceConfigPartial_H
