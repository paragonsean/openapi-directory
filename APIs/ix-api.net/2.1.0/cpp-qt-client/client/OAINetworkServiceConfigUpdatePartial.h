...
/*
 * OAINetworkServiceConfigUpdatePartial.h
 *
 * Polymorphic Network Service Config
 */

#ifndef OAINetworkServiceConfigUpdatePartial_H
#define OAINetworkServiceConfigUpdatePartial_H
...
class OAINetworkServiceConfigUpdatePartial : public OAIObject {
public:
    OAINetworkServiceConfigUpdatePartial();
    OAINetworkServiceConfigUpdatePartial(QString json);
    ~OAINetworkServiceConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceConfigUpdatePartial)

#endif // OAINetworkServiceConfigUpdatePartial_H
