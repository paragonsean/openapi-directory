...
/*
 * OAIContactRequestPartial.h
 *
 * A contact creation request
 */

#ifndef OAIContactRequestPartial_H
#define OAIContactRequestPartial_H
...
class OAIContactRequestPartial : public OAIObject {
public:
    OAIContactRequestPartial();
    OAIContactRequestPartial(QString json);
    ~OAIContactRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactRequestPartial)

#endif // OAIContactRequestPartial_H
