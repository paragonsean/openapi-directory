...
/*
 * OAIDenyMemberJoiningRulePartial.h
 *
 * A rule for members joining a private vlan
 */

#ifndef OAIDenyMemberJoiningRulePartial_H
#define OAIDenyMemberJoiningRulePartial_H
...
class OAIDenyMemberJoiningRulePartial : public OAIObject {
public:
    OAIDenyMemberJoiningRulePartial();
    OAIDenyMemberJoiningRulePartial(QString json);
    ~OAIDenyMemberJoiningRulePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDenyMemberJoiningRulePartial)

#endif // OAIDenyMemberJoiningRulePartial_H
