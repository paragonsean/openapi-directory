...
/*
 * OAIConnectionRequest.h
 *
 * 
 */

#ifndef OAIConnectionRequest_H
#define OAIConnectionRequest_H
...
class OAIConnectionRequest : public OAIObject {
public:
    OAIConnectionRequest();
    OAIConnectionRequest(QString json);
    ~OAIConnectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionRequest)

#endif // OAIConnectionRequest_H
