...
/*
 * OAIConnectionUpdate.h
 *
 * 
 */

#ifndef OAIConnectionUpdate_H
#define OAIConnectionUpdate_H
...
class OAIConnectionUpdate : public OAIObject {
public:
    OAIConnectionUpdate();
    OAIConnectionUpdate(QString json);
    ~OAIConnectionUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionUpdate)

#endif // OAIConnectionUpdate_H
