...
OAIMemberJoiningRuleUpdatePartial::OAIMemberJoiningRuleUpdatePartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMemberJoiningRuleUpdatePartial::OAIMemberJoiningRuleUpdatePartial() {
    this->initializeModel();
}

OAIMemberJoiningRuleUpdatePartial::~OAIMemberJoiningRuleUpdatePartial() {}

void OAIMemberJoiningRuleUpdatePartial::initializeModel() {
...
void OAIMemberJoiningRuleUpdatePartial::fromJson(QString jsonString) {
...
void OAIMemberJoiningRuleUpdatePartial::fromJsonObject(QJsonObject json) {
...
QString OAIMemberJoiningRuleUpdatePartial::asJson() const {
...
QJsonObject OAIMemberJoiningRuleUpdatePartial::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMemberJoiningRuleUpdatePartial::getCapacityMax() const {
    return m_capacity_max;
}
void OAIMemberJoiningRuleUpdatePartial::setCapacityMax(const qint32 &capacity_max) {
    m_capacity_max = capacity_max;
    m_capacity_max_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_capacity_max_Set() const{
    return m_capacity_max_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_capacity_max_Valid() const{
    return m_capacity_max_isValid;
}

qint32 OAIMemberJoiningRuleUpdatePartial::getCapacityMin() const {
    return m_capacity_min;
}
void OAIMemberJoiningRuleUpdatePartial::setCapacityMin(const qint32 &capacity_min) {
    m_capacity_min = capacity_min;
    m_capacity_min_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_capacity_min_Set() const{
    return m_capacity_min_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_capacity_min_Valid() const{
    return m_capacity_min_isValid;
}

QString OAIMemberJoiningRuleUpdatePartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMemberJoiningRuleUpdatePartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMemberJoiningRuleUpdatePartial::getExternalRef() const {
    return m_external_ref;
}
void OAIMemberJoiningRuleUpdatePartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMemberJoiningRuleUpdatePartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIMemberJoiningRuleUpdatePartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIMemberJoiningRuleUpdatePartial::getType() const {
    return m_type;
}
void OAIMemberJoiningRuleUpdatePartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMemberJoiningRuleUpdatePartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMemberJoiningRuleUpdatePartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMemberJoiningRuleUpdatePartial::isSet() const {
...
bool OAIMemberJoiningRuleUpdatePartial::isValid() const {
