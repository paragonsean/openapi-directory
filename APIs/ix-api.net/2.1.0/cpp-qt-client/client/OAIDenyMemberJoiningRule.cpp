...
OAIDenyMemberJoiningRule::OAIDenyMemberJoiningRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDenyMemberJoiningRule::OAIDenyMemberJoiningRule() {
    this->initializeModel();
}

OAIDenyMemberJoiningRule::~OAIDenyMemberJoiningRule() {}

void OAIDenyMemberJoiningRule::initializeModel() {
...
void OAIDenyMemberJoiningRule::fromJson(QString jsonString) {
...
void OAIDenyMemberJoiningRule::fromJsonObject(QJsonObject json) {
...
QString OAIDenyMemberJoiningRule::asJson() const {
...
QJsonObject OAIDenyMemberJoiningRule::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDenyMemberJoiningRule::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIDenyMemberJoiningRule::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIDenyMemberJoiningRule::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIDenyMemberJoiningRule::getExternalRef() const {
    return m_external_ref;
}
void OAIDenyMemberJoiningRule::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIDenyMemberJoiningRule::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIDenyMemberJoiningRule::getId() const {
    return m_id;
}
void OAIDenyMemberJoiningRule::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDenyMemberJoiningRule::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDenyMemberJoiningRule::getManagingAccount() const {
    return m_managing_account;
}
void OAIDenyMemberJoiningRule::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIDenyMemberJoiningRule::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIDenyMemberJoiningRule::getNetworkService() const {
    return m_network_service;
}
void OAIDenyMemberJoiningRule::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIDenyMemberJoiningRule::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIDenyMemberJoiningRule::getType() const {
    return m_type;
}
void OAIDenyMemberJoiningRule::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDenyMemberJoiningRule::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDenyMemberJoiningRule::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDenyMemberJoiningRule::isSet() const {
...
bool OAIDenyMemberJoiningRule::isValid() const {
