...
/*
 * OAIRouteServerNetworkFeatureConfigRequest.h
 *
 * 
 */

#ifndef OAIRouteServerNetworkFeatureConfigRequest_H
#define OAIRouteServerNetworkFeatureConfigRequest_H
...
class OAIRouteServerNetworkFeatureConfigRequest : public OAIObject {
public:
    OAIRouteServerNetworkFeatureConfigRequest();
    OAIRouteServerNetworkFeatureConfigRequest(QString json);
    ~OAIRouteServerNetworkFeatureConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeatureConfigRequest)

#endif // OAIRouteServerNetworkFeatureConfigRequest_H
