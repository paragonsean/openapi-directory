...
/*
 * OAINetworkFeatureConfigUpdate.h
 *
 * Polymorphic Network Feauture Config Update
 */

#ifndef OAINetworkFeatureConfigUpdate_H
#define OAINetworkFeatureConfigUpdate_H
...
class OAINetworkFeatureConfigUpdate : public OAIObject {
public:
    OAINetworkFeatureConfigUpdate();
    OAINetworkFeatureConfigUpdate(QString json);
    ~OAINetworkFeatureConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkFeatureConfigUpdate)

#endif // OAINetworkFeatureConfigUpdate_H
