...
#ifndef OAIPortUpdate_H
#define OAIPortUpdate_H
...
class OAIPortUpdate : public OAIObject {
public:
    OAIPortUpdate();
    OAIPortUpdate(QString json);
    ~OAIPortUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortUpdate)

#endif // OAIPortUpdate_H
