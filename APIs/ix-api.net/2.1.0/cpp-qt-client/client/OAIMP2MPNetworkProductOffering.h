...
/*
 * OAIMP2MPNetworkProductOffering.h
 *
 * 
 */

#ifndef OAIMP2MPNetworkProductOffering_H
#define OAIMP2MPNetworkProductOffering_H
...
class OAIMP2MPNetworkProductOffering : public OAIObject {
public:
    OAIMP2MPNetworkProductOffering();
    OAIMP2MPNetworkProductOffering(QString json);
    ~OAIMP2MPNetworkProductOffering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkProductOffering)

#endif // OAIMP2MPNetworkProductOffering_H
