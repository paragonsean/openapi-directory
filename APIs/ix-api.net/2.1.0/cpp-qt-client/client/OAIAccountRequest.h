...
#ifndef OAIAccountRequest_H
#define OAIAccountRequest_H
...
class OAIAccountRequest : public OAIObject {
public:
    OAIAccountRequest();
    OAIAccountRequest(QString json);
    ~OAIAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountRequest)

#endif // OAIAccountRequest_H
