...
/*
 * OAICloudNetworkProductOfferingPartial.h
 *
 * Cloud Network Product Offering
 */

#ifndef OAICloudNetworkProductOfferingPartial_H
#define OAICloudNetworkProductOfferingPartial_H
...
class OAICloudNetworkProductOfferingPartial : public OAIObject {
public:
    OAICloudNetworkProductOfferingPartial();
    OAICloudNetworkProductOfferingPartial(QString json);
    ~OAICloudNetworkProductOfferingPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkProductOfferingPartial)

#endif // OAICloudNetworkProductOfferingPartial_H
