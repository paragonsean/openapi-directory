...
/*
 * OAIRouteServerNetworkFeatureConfigRequestPartial.h
 *
 * Route Server Network Feature Config Request
 */

#ifndef OAIRouteServerNetworkFeatureConfigRequestPartial_H
#define OAIRouteServerNetworkFeatureConfigRequestPartial_H
...
class OAIRouteServerNetworkFeatureConfigRequestPartial : public OAIObject {
public:
    OAIRouteServerNetworkFeatureConfigRequestPartial();
    OAIRouteServerNetworkFeatureConfigRequestPartial(QString json);
    ~OAIRouteServerNetworkFeatureConfigRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeatureConfigRequestPartial)

#endif // OAIRouteServerNetworkFeatureConfigRequestPartial_H
