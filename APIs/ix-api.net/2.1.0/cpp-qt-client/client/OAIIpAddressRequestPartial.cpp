...
#include "OAIIpAddressRequestPartial.h"
...
OAIIpAddressRequestPartial::OAIIpAddressRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIpAddressRequestPartial::OAIIpAddressRequestPartial() {
    this->initializeModel();
}

OAIIpAddressRequestPartial::~OAIIpAddressRequestPartial() {}

void OAIIpAddressRequestPartial::initializeModel() {
...
void OAIIpAddressRequestPartial::fromJson(QString jsonString) {
...
void OAIIpAddressRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIIpAddressRequestPartial::asJson() const {
...
QJsonObject OAIIpAddressRequestPartial::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIIpAddressRequestPartial::getAddress() const {
    return m_address;
}
void OAIIpAddressRequestPartial::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIpAddressRequestPartial::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIpAddressRequestPartial::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIpAddressRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIIpAddressRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIIpAddressRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIIpAddressRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIIpAddressRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIIpAddressRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIIpAddressRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIIpAddressRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIIpAddressRequestPartial::getFqdn() const {
    return m_fqdn;
}
void OAIIpAddressRequestPartial::setFqdn(const QString &fqdn) {
    m_fqdn = fqdn;
    m_fqdn_isSet = true;
}

bool OAIIpAddressRequestPartial::is_fqdn_Set() const{
    return m_fqdn_isSet;
}

bool OAIIpAddressRequestPartial::is_fqdn_Valid() const{
    return m_fqdn_isValid;
}

QString OAIIpAddressRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIIpAddressRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIIpAddressRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIIpAddressRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

qint32 OAIIpAddressRequestPartial::getPrefixLength() const {
    return m_prefix_length;
}
void OAIIpAddressRequestPartial::setPrefixLength(const qint32 &prefix_length) {
    m_prefix_length = prefix_length;
    m_prefix_length_isSet = true;
}

bool OAIIpAddressRequestPartial::is_prefix_length_Set() const{
    return m_prefix_length_isSet;
}

bool OAIIpAddressRequestPartial::is_prefix_length_Valid() const{
    return m_prefix_length_isValid;
}

QDateTime OAIIpAddressRequestPartial::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIIpAddressRequestPartial::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIIpAddressRequestPartial::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIIpAddressRequestPartial::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIIpAddressRequestPartial::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIIpAddressRequestPartial::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIIpAddressRequestPartial::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIIpAddressRequestPartial::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

qint32 OAIIpAddressRequestPartial::getVersion() const {
    return m_version;
}
void OAIIpAddressRequestPartial::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIIpAddressRequestPartial::is_version_Set() const{
    return m_version_isSet;
}

bool OAIIpAddressRequestPartial::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIIpAddressRequestPartial::isSet() const {
...
bool OAIIpAddressRequestPartial::isValid() const {
