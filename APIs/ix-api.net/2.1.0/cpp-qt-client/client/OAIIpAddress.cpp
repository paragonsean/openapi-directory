...
QString OAIIpAddress::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIIpAddress::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIIpAddress::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIIpAddress::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIIpAddress::getExternalRef() const {
    return m_external_ref;
}
void OAIIpAddress::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIIpAddress::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIIpAddress::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIIpAddress::getFqdn() const {
    return m_fqdn;
}
void OAIIpAddress::setFqdn(const QString &fqdn) {
    m_fqdn = fqdn;
    m_fqdn_isSet = true;
}

bool OAIIpAddress::is_fqdn_Set() const{
    return m_fqdn_isSet;
}

bool OAIIpAddress::is_fqdn_Valid() const{
    return m_fqdn_isValid;
}

QString OAIIpAddress::getId() const {
    return m_id;
}
void OAIIpAddress::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIIpAddress::getManagingAccount() const {
    return m_managing_account;
}
void OAIIpAddress::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIIpAddress::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIIpAddress::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

qint32 OAIIpAddress::getPrefixLength() const {
    return m_prefix_length;
}
void OAIIpAddress::setPrefixLength(const qint32 &prefix_length) {
    m_prefix_length = prefix_length;
    m_prefix_length_isSet = true;
}

bool OAIIpAddress::is_prefix_length_Set() const{
    return m_prefix_length_isSet;
}

bool OAIIpAddress::is_prefix_length_Valid() const{
    return m_prefix_length_isValid;
}

QDateTime OAIIpAddress::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIIpAddress::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIIpAddress::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIIpAddress::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIIpAddress::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIIpAddress::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIIpAddress::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIIpAddress::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

qint32 OAIIpAddress::getVersion() const {
    return m_version;
}
void OAIIpAddress::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIIpAddress::is_version_Set() const{
    return m_version_isSet;
}

bool OAIIpAddress::is_version_Valid() const{
...
bool OAIIpAddress::isValid() const {
    ...
    return m_address_isValid && m_consuming_account_isValid && m_id_isValid && m_managing_account_isValid && m_prefix_length_isValid && m_version_isValid && true;
}
