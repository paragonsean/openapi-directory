...
OAIMacAddressRequest::OAIMacAddressRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMacAddressRequest::OAIMacAddressRequest() {
    this->initializeModel();
}

OAIMacAddressRequest::~OAIMacAddressRequest() {}

void OAIMacAddressRequest::initializeModel() {
...
void OAIMacAddressRequest::fromJson(QString jsonString) {
...
void OAIMacAddressRequest::fromJsonObject(QJsonObject json) {
...
QString OAIMacAddressRequest::asJson() const {
...
QJsonObject OAIMacAddressRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIMacAddressRequest::getAddress() const {
    return m_address;
}
void OAIMacAddressRequest::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIMacAddressRequest::is_address_Set() const{
    return m_address_isSet;
}

bool OAIMacAddressRequest::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIMacAddressRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMacAddressRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMacAddressRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMacAddressRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMacAddressRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIMacAddressRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMacAddressRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMacAddressRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMacAddressRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIMacAddressRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMacAddressRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMacAddressRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QDateTime OAIMacAddressRequest::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIMacAddressRequest::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIMacAddressRequest::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIMacAddressRequest::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIMacAddressRequest::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIMacAddressRequest::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIMacAddressRequest::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIMacAddressRequest::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

bool OAIMacAddressRequest::isSet() const {
...
bool OAIMacAddressRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_address_isValid && m_consuming_account_isValid && m_managing_account_isValid && true;
}
