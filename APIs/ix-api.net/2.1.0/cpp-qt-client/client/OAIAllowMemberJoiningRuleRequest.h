...
/*
 * OAIAllowMemberJoiningRuleRequest.h
 *
 * 
 */

#ifndef OAIAllowMemberJoiningRuleRequest_H
#define OAIAllowMemberJoiningRuleRequest_H
...
class OAIAllowMemberJoiningRuleRequest : public OAIObject {
public:
    OAIAllowMemberJoiningRuleRequest();
    OAIAllowMemberJoiningRuleRequest(QString json);
    ~OAIAllowMemberJoiningRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowMemberJoiningRuleRequest)

#endif // OAIAllowMemberJoiningRuleRequest_H
