...
#include "OAIAllowMemberJoiningRuleUpdate.h"
...
OAIAllowMemberJoiningRuleUpdate::OAIAllowMemberJoiningRuleUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllowMemberJoiningRuleUpdate::OAIAllowMemberJoiningRuleUpdate() {
    this->initializeModel();
}

OAIAllowMemberJoiningRuleUpdate::~OAIAllowMemberJoiningRuleUpdate() {}

void OAIAllowMemberJoiningRuleUpdate::initializeModel() {
...
void OAIAllowMemberJoiningRuleUpdate::fromJson(QString jsonString) {
...
void OAIAllowMemberJoiningRuleUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIAllowMemberJoiningRuleUpdate::asJson() const {
...
QJsonObject OAIAllowMemberJoiningRuleUpdate::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAllowMemberJoiningRuleUpdate::getCapacityMax() const {
    return m_capacity_max;
}
void OAIAllowMemberJoiningRuleUpdate::setCapacityMax(const qint32 &capacity_max) {
    m_capacity_max = capacity_max;
    m_capacity_max_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_capacity_max_Set() const{
    return m_capacity_max_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_capacity_max_Valid() const{
    return m_capacity_max_isValid;
}

qint32 OAIAllowMemberJoiningRuleUpdate::getCapacityMin() const {
    return m_capacity_min;
}
void OAIAllowMemberJoiningRuleUpdate::setCapacityMin(const qint32 &capacity_min) {
    m_capacity_min = capacity_min;
    m_capacity_min_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_capacity_min_Set() const{
    return m_capacity_min_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_capacity_min_Valid() const{
    return m_capacity_min_isValid;
}

QString OAIAllowMemberJoiningRuleUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIAllowMemberJoiningRuleUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIAllowMemberJoiningRuleUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIAllowMemberJoiningRuleUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIAllowMemberJoiningRuleUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIAllowMemberJoiningRuleUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIAllowMemberJoiningRuleUpdate::getType() const {
    return m_type;
}
void OAIAllowMemberJoiningRuleUpdate::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAllowMemberJoiningRuleUpdate::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAllowMemberJoiningRuleUpdate::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAllowMemberJoiningRuleUpdate::isSet() const {
...
bool OAIAllowMemberJoiningRuleUpdate::isValid() const {
