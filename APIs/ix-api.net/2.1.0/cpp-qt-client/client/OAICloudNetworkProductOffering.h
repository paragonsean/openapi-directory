...
/*
 * OAICloudNetworkProductOffering.h
 *
 * 
 */

#ifndef OAICloudNetworkProductOffering_H
#define OAICloudNetworkProductOffering_H
...
class OAICloudNetworkProductOffering : public OAIObject {
public:
    OAICloudNetworkProductOffering();
    OAICloudNetworkProductOffering(QString json);
    ~OAICloudNetworkProductOffering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkProductOffering)

#endif // OAICloudNetworkProductOffering_H
