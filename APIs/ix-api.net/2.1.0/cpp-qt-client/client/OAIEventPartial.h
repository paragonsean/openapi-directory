...
#ifndef OAIEventPartial_H
#define OAIEventPartial_H
...
class OAIEventPartial : public OAIObject {
public:
    OAIEventPartial();
    OAIEventPartial(QString json);
    ~OAIEventPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventPartial)

#endif // OAIEventPartial_H
