...
/*
 * OAIMP2MPNetworkProductOfferingPartial.h
 *
 * MP2MP Network Product Offering
 */

#ifndef OAIMP2MPNetworkProductOfferingPartial_H
#define OAIMP2MPNetworkProductOfferingPartial_H
...
class OAIMP2MPNetworkProductOfferingPartial : public OAIObject {
public:
    OAIMP2MPNetworkProductOfferingPartial();
    OAIMP2MPNetworkProductOfferingPartial(QString json);
    ~OAIMP2MPNetworkProductOfferingPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkProductOfferingPartial)

#endif // OAIMP2MPNetworkProductOfferingPartial_H
