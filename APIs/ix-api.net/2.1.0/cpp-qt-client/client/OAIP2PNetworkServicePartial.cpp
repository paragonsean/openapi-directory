...
OAIP2PNetworkServicePartial::OAIP2PNetworkServicePartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2PNetworkServicePartial::OAIP2PNetworkServicePartial() {
    this->initializeModel();
}

OAIP2PNetworkServicePartial::~OAIP2PNetworkServicePartial() {}

void OAIP2PNetworkServicePartial::initializeModel() {
...
void OAIP2PNetworkServicePartial::fromJson(QString jsonString) {
...
void OAIP2PNetworkServicePartial::fromJsonObject(QJsonObject json) {
...
QString OAIP2PNetworkServicePartial::asJson() const {
...
QJsonObject OAIP2PNetworkServicePartial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2PNetworkServicePartial::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2PNetworkServicePartial::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2PNetworkServicePartial::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIP2PNetworkServicePartial::getCapacity() const {
    return m_capacity;
}
void OAIP2PNetworkServicePartial::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIP2PNetworkServicePartial::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAIP2PNetworkServicePartial::getChargedUntil() const {
    return m_charged_until;
}
void OAIP2PNetworkServicePartial::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAIP2PNetworkServicePartial::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAIP2PNetworkServicePartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2PNetworkServicePartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2PNetworkServicePartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2PNetworkServicePartial::getContractRef() const {
    return m_contract_ref;
}
void OAIP2PNetworkServicePartial::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2PNetworkServicePartial::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAIP2PNetworkServicePartial::getDecommissionAt() const {
    return m_decommission_at;
}
void OAIP2PNetworkServicePartial::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAIP2PNetworkServicePartial::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAIP2PNetworkServicePartial::getExternalRef() const {
    return m_external_ref;
}
void OAIP2PNetworkServicePartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2PNetworkServicePartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2PNetworkServicePartial::getId() const {
    return m_id;
}
void OAIP2PNetworkServicePartial::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_id_Set() const{
    return m_id_isSet;
}

bool OAIP2PNetworkServicePartial::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIP2PNetworkServicePartial::getJoiningMemberAccount() const {
    return m_joining_member_account;
}
void OAIP2PNetworkServicePartial::setJoiningMemberAccount(const QString &joining_member_account) {
    m_joining_member_account = joining_member_account;
    m_joining_member_account_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_joining_member_account_Set() const{
    return m_joining_member_account_isSet;
}

bool OAIP2PNetworkServicePartial::is_joining_member_account_Valid() const{
    return m_joining_member_account_isValid;
}

QString OAIP2PNetworkServicePartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2PNetworkServicePartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2PNetworkServicePartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIP2PNetworkServicePartial::getNscRequiredContactRoles() const {
    return m_nsc_required_contact_roles;
}
void OAIP2PNetworkServicePartial::setNscRequiredContactRoles(const QList<QString> &nsc_required_contact_roles) {
    m_nsc_required_contact_roles = nsc_required_contact_roles;
    m_nsc_required_contact_roles_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_nsc_required_contact_roles_Set() const{
    return m_nsc_required_contact_roles_isSet;
}

bool OAIP2PNetworkServicePartial::is_nsc_required_contact_roles_Valid() const{
    return m_nsc_required_contact_roles_isValid;
}

QString OAIP2PNetworkServicePartial::getProductOffering() const {
    return m_product_offering;
}
void OAIP2PNetworkServicePartial::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAIP2PNetworkServicePartial::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

QString OAIP2PNetworkServicePartial::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2PNetworkServicePartial::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2PNetworkServicePartial::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAIP2PNetworkServicePartial::getState() const {
    return m_state;
}
void OAIP2PNetworkServicePartial::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_state_Set() const{
    return m_state_isSet;
}

bool OAIP2PNetworkServicePartial::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIP2PNetworkServicePartial::getStatus() const {
    return m_status;
}
void OAIP2PNetworkServicePartial::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_status_Set() const{
    return m_status_isSet;
}

bool OAIP2PNetworkServicePartial::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIP2PNetworkServicePartial::getType() const {
    return m_type;
}
void OAIP2PNetworkServicePartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2PNetworkServicePartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2PNetworkServicePartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIP2PNetworkServicePartial::isSet() const {
...
bool OAIP2PNetworkServicePartial::isValid() const {
