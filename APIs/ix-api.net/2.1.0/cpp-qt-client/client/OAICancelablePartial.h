...
/*
 * OAICancelablePartial.h
 *
 * Service or config can be canceled
 */

#ifndef OAICancelablePartial_H
#define OAICancelablePartial_H
...
class OAICancelablePartial : public OAIObject {
public:
    OAICancelablePartial();
    OAICancelablePartial(QString json);
    ~OAICancelablePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelablePartial)

#endif // OAICancelablePartial_H
