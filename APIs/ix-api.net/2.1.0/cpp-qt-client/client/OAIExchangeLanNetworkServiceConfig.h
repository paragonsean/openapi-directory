...
/*
 * OAIExchangeLanNetworkServiceConfig.h
 *
 * 
 */

#ifndef OAIExchangeLanNetworkServiceConfig_H
#define OAIExchangeLanNetworkServiceConfig_H
...
class OAIExchangeLanNetworkServiceConfig : public OAIObject {
public:
    OAIExchangeLanNetworkServiceConfig();
    OAIExchangeLanNetworkServiceConfig(QString json);
    ~OAIExchangeLanNetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangeLanNetworkServiceConfig)

#endif // OAIExchangeLanNetworkServiceConfig_H
