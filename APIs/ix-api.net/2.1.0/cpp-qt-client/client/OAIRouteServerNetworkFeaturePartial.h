...
/*
 * OAIRouteServerNetworkFeaturePartial.h
 *
 * Route Server Network Feature
 */

#ifndef OAIRouteServerNetworkFeaturePartial_H
#define OAIRouteServerNetworkFeaturePartial_H
...
class OAIRouteServerNetworkFeaturePartial : public OAIObject {
public:
    OAIRouteServerNetworkFeaturePartial();
    OAIRouteServerNetworkFeaturePartial(QString json);
    ~OAIRouteServerNetworkFeaturePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeaturePartial)

#endif // OAIRouteServerNetworkFeaturePartial_H
