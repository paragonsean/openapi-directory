...
/*
 * OAICloudNetworkServiceConfigUpdatePartial.h
 *
 * Cloud Network Service Config Update
 */

#ifndef OAICloudNetworkServiceConfigUpdatePartial_H
#define OAICloudNetworkServiceConfigUpdatePartial_H
...
class OAICloudNetworkServiceConfigUpdatePartial : public OAIObject {
public:
    OAICloudNetworkServiceConfigUpdatePartial();
    OAICloudNetworkServiceConfigUpdatePartial(QString json);
    ~OAICloudNetworkServiceConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceConfigUpdatePartial)

#endif // OAICloudNetworkServiceConfigUpdatePartial_H
