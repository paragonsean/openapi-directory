...
OAIIpAddressPartial::OAIIpAddressPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIpAddressPartial::OAIIpAddressPartial() {
    this->initializeModel();
}

OAIIpAddressPartial::~OAIIpAddressPartial() {}

void OAIIpAddressPartial::initializeModel() {
...
void OAIIpAddressPartial::fromJson(QString jsonString) {
...
void OAIIpAddressPartial::fromJsonObject(QJsonObject json) {
...
QString OAIIpAddressPartial::asJson() const {
...
QJsonObject OAIIpAddressPartial::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIIpAddressPartial::getAddress() const {
    return m_address;
}
void OAIIpAddressPartial::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIpAddressPartial::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIpAddressPartial::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIpAddressPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIIpAddressPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIIpAddressPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIIpAddressPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIIpAddressPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIIpAddressPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIIpAddressPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIIpAddressPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIIpAddressPartial::getFqdn() const {
    return m_fqdn;
}
void OAIIpAddressPartial::setFqdn(const QString &fqdn) {
    m_fqdn = fqdn;
    m_fqdn_isSet = true;
}

bool OAIIpAddressPartial::is_fqdn_Set() const{
    return m_fqdn_isSet;
}

bool OAIIpAddressPartial::is_fqdn_Valid() const{
    return m_fqdn_isValid;
}

QString OAIIpAddressPartial::getId() const {
    return m_id;
}
void OAIIpAddressPartial::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIpAddressPartial::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIpAddressPartial::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIIpAddressPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIIpAddressPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIIpAddressPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIIpAddressPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

qint32 OAIIpAddressPartial::getPrefixLength() const {
    return m_prefix_length;
}
void OAIIpAddressPartial::setPrefixLength(const qint32 &prefix_length) {
    m_prefix_length = prefix_length;
    m_prefix_length_isSet = true;
}

bool OAIIpAddressPartial::is_prefix_length_Set() const{
    return m_prefix_length_isSet;
}

bool OAIIpAddressPartial::is_prefix_length_Valid() const{
    return m_prefix_length_isValid;
}

QDateTime OAIIpAddressPartial::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIIpAddressPartial::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIIpAddressPartial::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIIpAddressPartial::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIIpAddressPartial::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIIpAddressPartial::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIIpAddressPartial::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIIpAddressPartial::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

qint32 OAIIpAddressPartial::getVersion() const {
    return m_version;
}
void OAIIpAddressPartial::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIIpAddressPartial::is_version_Set() const{
    return m_version_isSet;
}

bool OAIIpAddressPartial::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIIpAddressPartial::isSet() const {
...
bool OAIIpAddressPartial::isValid() const {
