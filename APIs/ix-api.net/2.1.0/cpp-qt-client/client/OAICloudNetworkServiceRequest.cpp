...
#include "OAICloudNetworkServiceRequest.h"
...
OAICloudNetworkServiceRequest::OAICloudNetworkServiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloudNetworkServiceRequest::OAICloudNetworkServiceRequest() {
    this->initializeModel();
}

OAICloudNetworkServiceRequest::~OAICloudNetworkServiceRequest() {}

void OAICloudNetworkServiceRequest::initializeModel() {
...
void OAICloudNetworkServiceRequest::fromJson(QString jsonString) {
...
void OAICloudNetworkServiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAICloudNetworkServiceRequest::asJson() const {
...
QJsonObject OAICloudNetworkServiceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICloudNetworkServiceRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAICloudNetworkServiceRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAICloudNetworkServiceRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAICloudNetworkServiceRequest::getCapacity() const {
    return m_capacity;
}
void OAICloudNetworkServiceRequest::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAICloudNetworkServiceRequest::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAICloudNetworkServiceRequest::getCloudKey() const {
    return m_cloud_key;
}
void OAICloudNetworkServiceRequest::setCloudKey(const QString &cloud_key) {
    m_cloud_key = cloud_key;
    m_cloud_key_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_cloud_key_Set() const{
    return m_cloud_key_isSet;
}

bool OAICloudNetworkServiceRequest::is_cloud_key_Valid() const{
    return m_cloud_key_isValid;
}

QString OAICloudNetworkServiceRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAICloudNetworkServiceRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAICloudNetworkServiceRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAICloudNetworkServiceRequest::getContractRef() const {
    return m_contract_ref;
}
void OAICloudNetworkServiceRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAICloudNetworkServiceRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAICloudNetworkServiceRequest::getExternalRef() const {
    return m_external_ref;
}
void OAICloudNetworkServiceRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAICloudNetworkServiceRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAICloudNetworkServiceRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAICloudNetworkServiceRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAICloudNetworkServiceRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAICloudNetworkServiceRequest::getProductOffering() const {
    return m_product_offering;
}
void OAICloudNetworkServiceRequest::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAICloudNetworkServiceRequest::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

QString OAICloudNetworkServiceRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAICloudNetworkServiceRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAICloudNetworkServiceRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAICloudNetworkServiceRequest::getType() const {
    return m_type;
}
void OAICloudNetworkServiceRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICloudNetworkServiceRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICloudNetworkServiceRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICloudNetworkServiceRequest::isSet() const {
...
bool OAICloudNetworkServiceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_cloud_key_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_product_offering_isValid && m_type_isValid && true;
}
