...
/*
 * OAIP2PNetworkServiceConfigUpdatePartial.h
 *
 * P2P Network Service Config Update
 */

#ifndef OAIP2PNetworkServiceConfigUpdatePartial_H
#define OAIP2PNetworkServiceConfigUpdatePartial_H
...
class OAIP2PNetworkServiceConfigUpdatePartial : public OAIObject {
public:
    OAIP2PNetworkServiceConfigUpdatePartial();
    OAIP2PNetworkServiceConfigUpdatePartial(QString json);
    ~OAIP2PNetworkServiceConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceConfigUpdatePartial)

#endif // OAIP2PNetworkServiceConfigUpdatePartial_H
