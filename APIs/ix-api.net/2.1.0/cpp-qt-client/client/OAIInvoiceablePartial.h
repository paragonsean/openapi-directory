...
/*
 * OAIInvoiceablePartial.h
 *
 * Invoiceable
 */

#ifndef OAIInvoiceablePartial_H
#define OAIInvoiceablePartial_H
...
class OAIInvoiceablePartial : public OAIObject {
public:
    OAIInvoiceablePartial();
    OAIInvoiceablePartial(QString json);
    ~OAIInvoiceablePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceablePartial)

#endif // OAIInvoiceablePartial_H
