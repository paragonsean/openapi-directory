...
/*
 * OAIP2PNetworkServiceConfig.h
 *
 * 
 */

#ifndef OAIP2PNetworkServiceConfig_H
#define OAIP2PNetworkServiceConfig_H
...
class OAIP2PNetworkServiceConfig : public OAIObject {
public:
    OAIP2PNetworkServiceConfig();
    OAIP2PNetworkServiceConfig(QString json);
    ~OAIP2PNetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceConfig)

#endif // OAIP2PNetworkServiceConfig_H
