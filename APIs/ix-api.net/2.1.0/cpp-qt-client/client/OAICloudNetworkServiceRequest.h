...
/*
 * OAICloudNetworkServiceRequest.h
 *
 * 
 */

#ifndef OAICloudNetworkServiceRequest_H
#define OAICloudNetworkServiceRequest_H
...
class OAICloudNetworkServiceRequest : public OAIObject {
public:
    OAICloudNetworkServiceRequest();
    OAICloudNetworkServiceRequest(QString json);
    ~OAICloudNetworkServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceRequest)

#endif // OAICloudNetworkServiceRequest_H
