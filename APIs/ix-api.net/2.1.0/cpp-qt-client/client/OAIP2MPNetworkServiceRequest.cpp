...
#include "OAIP2MPNetworkServiceRequest.h"
...
OAIP2MPNetworkServiceRequest::OAIP2MPNetworkServiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2MPNetworkServiceRequest::OAIP2MPNetworkServiceRequest() {
    this->initializeModel();
}

OAIP2MPNetworkServiceRequest::~OAIP2MPNetworkServiceRequest() {}

void OAIP2MPNetworkServiceRequest::initializeModel() {
...
void OAIP2MPNetworkServiceRequest::fromJson(QString jsonString) {
...
void OAIP2MPNetworkServiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIP2MPNetworkServiceRequest::asJson() const {
...
QJsonObject OAIP2MPNetworkServiceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2MPNetworkServiceRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2MPNetworkServiceRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIP2MPNetworkServiceRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2MPNetworkServiceRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2MPNetworkServiceRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIP2MPNetworkServiceRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIP2MPNetworkServiceRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIP2MPNetworkServiceRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2MPNetworkServiceRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2MPNetworkServiceRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIP2MPNetworkServiceRequest::getName() const {
    return m_name;
}
void OAIP2MPNetworkServiceRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIP2MPNetworkServiceRequest::getProductOffering() const {
    return m_product_offering;
}
void OAIP2MPNetworkServiceRequest::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

bool OAIP2MPNetworkServiceRequest::isRPublic() const {
    return m_r_public;
}
void OAIP2MPNetworkServiceRequest::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIP2MPNetworkServiceRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2MPNetworkServiceRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAIP2MPNetworkServiceRequest::getType() const {
    return m_type;
}
void OAIP2MPNetworkServiceRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2MPNetworkServiceRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2MPNetworkServiceRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIP2MPNetworkServiceRequest::isSet() const {
...
bool OAIP2MPNetworkServiceRequest::isValid() const {
