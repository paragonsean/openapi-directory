...
OAIMacAddress::OAIMacAddress(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMacAddress::OAIMacAddress() {
    this->initializeModel();
}

OAIMacAddress::~OAIMacAddress() {}

void OAIMacAddress::initializeModel() {
...
void OAIMacAddress::fromJson(QString jsonString) {
...
void OAIMacAddress::fromJsonObject(QJsonObject json) {
...
QString OAIMacAddress::asJson() const {
...
QJsonObject OAIMacAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIMacAddress::getAddress() const {
    return m_address;
}
void OAIMacAddress::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIMacAddress::is_address_Set() const{
    return m_address_isSet;
}

bool OAIMacAddress::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIMacAddress::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMacAddress::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMacAddress::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMacAddress::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMacAddress::getExternalRef() const {
    return m_external_ref;
}
void OAIMacAddress::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMacAddress::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMacAddress::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMacAddress::getId() const {
    return m_id;
}
void OAIMacAddress::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMacAddress::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMacAddress::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMacAddress::getManagingAccount() const {
    return m_managing_account;
}
void OAIMacAddress::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMacAddress::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMacAddress::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QDateTime OAIMacAddress::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIMacAddress::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIMacAddress::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIMacAddress::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIMacAddress::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIMacAddress::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIMacAddress::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIMacAddress::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

bool OAIMacAddress::isSet() const {
...
bool OAIMacAddress::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_address_isValid && m_consuming_account_isValid && m_id_isValid && m_managing_account_isValid && true;
}
