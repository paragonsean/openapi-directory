...
/*
 * OAIMP2MPNetworkServicePartial.h
 *
 * MP2MP Network Service
 */

#ifndef OAIMP2MPNetworkServicePartial_H
#define OAIMP2MPNetworkServicePartial_H
...
class OAIMP2MPNetworkServicePartial : public OAIObject {
public:
    OAIMP2MPNetworkServicePartial();
    OAIMP2MPNetworkServicePartial(QString json);
    ~OAIMP2MPNetworkServicePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkServicePartial)

#endif // OAIMP2MPNetworkServicePartial_H
