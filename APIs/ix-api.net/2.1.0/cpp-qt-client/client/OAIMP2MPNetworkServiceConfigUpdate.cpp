...
#include "OAIMP2MPNetworkServiceConfigUpdate.h"
...
OAIMP2MPNetworkServiceConfigUpdate::OAIMP2MPNetworkServiceConfigUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMP2MPNetworkServiceConfigUpdate::OAIMP2MPNetworkServiceConfigUpdate() {
    this->initializeModel();
}

OAIMP2MPNetworkServiceConfigUpdate::~OAIMP2MPNetworkServiceConfigUpdate() {}

void OAIMP2MPNetworkServiceConfigUpdate::initializeModel() {
...
void OAIMP2MPNetworkServiceConfigUpdate::fromJson(QString jsonString) {
...
void OAIMP2MPNetworkServiceConfigUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIMP2MPNetworkServiceConfigUpdate::asJson() const {
...
QJsonObject OAIMP2MPNetworkServiceConfigUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMP2MPNetworkServiceConfigUpdate::getBillingAccount() const {
    return m_billing_account;
}
void OAIMP2MPNetworkServiceConfigUpdate::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIMP2MPNetworkServiceConfigUpdate::getCapacity() const {
    return m_capacity;
}
void OAIMP2MPNetworkServiceConfigUpdate::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getConnection() const {
    return m_connection;
}
void OAIMP2MPNetworkServiceConfigUpdate::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMP2MPNetworkServiceConfigUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getContractRef() const {
    return m_contract_ref;
}
void OAIMP2MPNetworkServiceConfigUpdate::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIMP2MPNetworkServiceConfigUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigUpdate::getMacs() const {
    return m_macs;
}
void OAIMP2MPNetworkServiceConfigUpdate::setMacs(const QList<QString> &macs) {
    m_macs = macs;
    m_macs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_macs_Set() const{
    return m_macs_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_macs_Valid() const{
    return m_macs_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIMP2MPNetworkServiceConfigUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigUpdate::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIMP2MPNetworkServiceConfigUpdate::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIMP2MPNetworkServiceConfigUpdate::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfigUpdate::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIMP2MPNetworkServiceConfigUpdate::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIMP2MPNetworkServiceConfigUpdate::getType() const {
    return m_type;
}
void OAIMP2MPNetworkServiceConfigUpdate::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIMP2MPNetworkServiceConfigUpdate::getVlanConfig() const {
    return m_vlan_config;
}
void OAIMP2MPNetworkServiceConfigUpdate::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIMP2MPNetworkServiceConfigUpdate::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIMP2MPNetworkServiceConfigUpdate::isSet() const {
...
bool OAIMP2MPNetworkServiceConfigUpdate::isValid() const {
