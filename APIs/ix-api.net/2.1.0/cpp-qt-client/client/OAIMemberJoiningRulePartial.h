...
/*
 * OAIMemberJoiningRulePartial.h
 *
 * Polymorphic Member Joining Rule
 */

#ifndef OAIMemberJoiningRulePartial_H
#define OAIMemberJoiningRulePartial_H
...
class OAIMemberJoiningRulePartial : public OAIObject {
public:
    OAIMemberJoiningRulePartial();
    OAIMemberJoiningRulePartial(QString json);
    ~OAIMemberJoiningRulePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberJoiningRulePartial)

#endif // OAIMemberJoiningRulePartial_H
