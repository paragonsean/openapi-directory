...
/*
 * OAICloudNetworkService.h
 *
 * 
 */

#ifndef OAICloudNetworkService_H
#define OAICloudNetworkService_H
...
class OAICloudNetworkService : public OAIObject {
public:
    OAICloudNetworkService();
    OAICloudNetworkService(QString json);
    ~OAICloudNetworkService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkService)

#endif // OAICloudNetworkService_H
