...
#include "OAIMacAddressRequestPartial.h"
...
OAIMacAddressRequestPartial::OAIMacAddressRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMacAddressRequestPartial::OAIMacAddressRequestPartial() {
    this->initializeModel();
}

OAIMacAddressRequestPartial::~OAIMacAddressRequestPartial() {}

void OAIMacAddressRequestPartial::initializeModel() {
...
void OAIMacAddressRequestPartial::fromJson(QString jsonString) {
...
void OAIMacAddressRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIMacAddressRequestPartial::asJson() const {
...
QJsonObject OAIMacAddressRequestPartial::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAIMacAddressRequestPartial::getAddress() const {
    return m_address;
}
void OAIMacAddressRequestPartial::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIMacAddressRequestPartial::is_address_Set() const{
    return m_address_isSet;
}

bool OAIMacAddressRequestPartial::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIMacAddressRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMacAddressRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMacAddressRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMacAddressRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMacAddressRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIMacAddressRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMacAddressRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMacAddressRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMacAddressRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIMacAddressRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMacAddressRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMacAddressRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QDateTime OAIMacAddressRequestPartial::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIMacAddressRequestPartial::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIMacAddressRequestPartial::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIMacAddressRequestPartial::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIMacAddressRequestPartial::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIMacAddressRequestPartial::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIMacAddressRequestPartial::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIMacAddressRequestPartial::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

bool OAIMacAddressRequestPartial::isSet() const {
...
bool OAIMacAddressRequestPartial::isValid() const {
