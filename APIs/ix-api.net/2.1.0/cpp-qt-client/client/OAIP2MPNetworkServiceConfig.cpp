...
#include "OAIP2MPNetworkServiceConfig.h"
...
OAIP2MPNetworkServiceConfig::OAIP2MPNetworkServiceConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2MPNetworkServiceConfig::OAIP2MPNetworkServiceConfig() {
    this->initializeModel();
}

OAIP2MPNetworkServiceConfig::~OAIP2MPNetworkServiceConfig() {}

void OAIP2MPNetworkServiceConfig::initializeModel() {
...
void OAIP2MPNetworkServiceConfig::fromJson(QString jsonString) {
...
void OAIP2MPNetworkServiceConfig::fromJsonObject(QJsonObject json) {
...
QString OAIP2MPNetworkServiceConfig::asJson() const {
...
QJsonObject OAIP2MPNetworkServiceConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2MPNetworkServiceConfig::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2MPNetworkServiceConfig::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIP2MPNetworkServiceConfig::getCapacity() const {
    return m_capacity;
}
void OAIP2MPNetworkServiceConfig::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAIP2MPNetworkServiceConfig::getChargedUntil() const {
    return m_charged_until;
}
void OAIP2MPNetworkServiceConfig::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAIP2MPNetworkServiceConfig::getConnection() const {
    return m_connection;
}
void OAIP2MPNetworkServiceConfig::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIP2MPNetworkServiceConfig::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2MPNetworkServiceConfig::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2MPNetworkServiceConfig::getContractRef() const {
    return m_contract_ref;
}
void OAIP2MPNetworkServiceConfig::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAIP2MPNetworkServiceConfig::getDecommissionAt() const {
    return m_decommission_at;
}
void OAIP2MPNetworkServiceConfig::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAIP2MPNetworkServiceConfig::getExternalRef() const {
    return m_external_ref;
}
void OAIP2MPNetworkServiceConfig::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2MPNetworkServiceConfig::getId() const {
    return m_id;
}
void OAIP2MPNetworkServiceConfig::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIP2MPNetworkServiceConfig::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2MPNetworkServiceConfig::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIP2MPNetworkServiceConfig::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIP2MPNetworkServiceConfig::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIP2MPNetworkServiceConfig::getNetworkService() const {
    return m_network_service;
}
void OAIP2MPNetworkServiceConfig::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIP2MPNetworkServiceConfig::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2MPNetworkServiceConfig::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAIP2MPNetworkServiceConfig::getRole() const {
    return m_role;
}
void OAIP2MPNetworkServiceConfig::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_role_Set() const{
    return m_role_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_role_Valid() const{
    return m_role_isValid;
}

QList<QString> OAIP2MPNetworkServiceConfig::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIP2MPNetworkServiceConfig::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIP2MPNetworkServiceConfig::getState() const {
    return m_state;
}
void OAIP2MPNetworkServiceConfig::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_state_Set() const{
    return m_state_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIP2MPNetworkServiceConfig::getStatus() const {
    return m_status;
}
void OAIP2MPNetworkServiceConfig::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_status_Set() const{
    return m_status_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIP2MPNetworkServiceConfig::getType() const {
    return m_type;
}
void OAIP2MPNetworkServiceConfig::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIP2MPNetworkServiceConfig::getVlanConfig() const {
    return m_vlan_config;
}
void OAIP2MPNetworkServiceConfig::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIP2MPNetworkServiceConfig::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIP2MPNetworkServiceConfig::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIP2MPNetworkServiceConfig::isSet() const {
...
bool OAIP2MPNetworkServiceConfig::isValid() const {
