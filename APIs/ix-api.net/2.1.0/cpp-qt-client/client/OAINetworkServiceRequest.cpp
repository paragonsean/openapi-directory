...
OAINetworkServiceRequest::OAINetworkServiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINetworkServiceRequest::OAINetworkServiceRequest() {
    this->initializeModel();
}

OAINetworkServiceRequest::~OAINetworkServiceRequest() {}

void OAINetworkServiceRequest::initializeModel() {
...
void OAINetworkServiceRequest::fromJson(QString jsonString) {
...
void OAINetworkServiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAINetworkServiceRequest::asJson() const {
...
QJsonObject OAINetworkServiceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAINetworkServiceRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAINetworkServiceRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAINetworkServiceRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAINetworkServiceRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAINetworkServiceRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAINetworkServiceRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAINetworkServiceRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAINetworkServiceRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAINetworkServiceRequest::getContractRef() const {
    return m_contract_ref;
}
void OAINetworkServiceRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAINetworkServiceRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAINetworkServiceRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAINetworkServiceRequest::getExternalRef() const {
    return m_external_ref;
}
void OAINetworkServiceRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAINetworkServiceRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAINetworkServiceRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAINetworkServiceRequest::getJoiningMemberAccount() const {
    return m_joining_member_account;
}
void OAINetworkServiceRequest::setJoiningMemberAccount(const QString &joining_member_account) {
    m_joining_member_account = joining_member_account;
    m_joining_member_account_isSet = true;
}

bool OAINetworkServiceRequest::is_joining_member_account_Set() const{
    return m_joining_member_account_isSet;
}

bool OAINetworkServiceRequest::is_joining_member_account_Valid() const{
    return m_joining_member_account_isValid;
}

QString OAINetworkServiceRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAINetworkServiceRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAINetworkServiceRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAINetworkServiceRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAINetworkServiceRequest::getProductOffering() const {
    return m_product_offering;
}
void OAINetworkServiceRequest::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAINetworkServiceRequest::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAINetworkServiceRequest::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

QString OAINetworkServiceRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAINetworkServiceRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAINetworkServiceRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAINetworkServiceRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAINetworkServiceRequest::getType() const {
    return m_type;
}
void OAINetworkServiceRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINetworkServiceRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAINetworkServiceRequest::is_type_Valid() const{
    return m_type_isValid;
}

QString OAINetworkServiceRequest::getName() const {
    return m_name;
}
void OAINetworkServiceRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAINetworkServiceRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAINetworkServiceRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAINetworkServiceRequest::isRPublic() const {
    return m_r_public;
}
void OAINetworkServiceRequest::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAINetworkServiceRequest::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAINetworkServiceRequest::is_r_public_Valid() const{
    return m_r_public_isValid;
}

qint32 OAINetworkServiceRequest::getCapacity() const {
    return m_capacity;
}
void OAINetworkServiceRequest::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAINetworkServiceRequest::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAINetworkServiceRequest::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAINetworkServiceRequest::getCloudKey() const {
    return m_cloud_key;
}
void OAINetworkServiceRequest::setCloudKey(const QString &cloud_key) {
    m_cloud_key = cloud_key;
    m_cloud_key_isSet = true;
}

bool OAINetworkServiceRequest::is_cloud_key_Set() const{
    return m_cloud_key_isSet;
}

bool OAINetworkServiceRequest::is_cloud_key_Valid() const{
    return m_cloud_key_isValid;
}

bool OAINetworkServiceRequest::isSet() const {
...
bool OAINetworkServiceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_consuming_account_isValid && m_joining_member_account_isValid && m_managing_account_isValid && m_product_offering_isValid && m_type_isValid && m_name_isValid && m_cloud_key_isValid && true;
}
