...
/*
 * OAIP2PNetworkService.h
 *
 * 
 */

#ifndef OAIP2PNetworkService_H
#define OAIP2PNetworkService_H
...
class OAIP2PNetworkService : public OAIObject {
public:
    OAIP2PNetworkService();
    OAIP2PNetworkService(QString json);
    ~OAIP2PNetworkService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkService)

#endif // OAIP2PNetworkService_H
