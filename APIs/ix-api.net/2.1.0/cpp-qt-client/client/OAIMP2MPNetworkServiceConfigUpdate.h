...
/*
 * OAIMP2MPNetworkServiceConfigUpdate.h
 *
 * 
 */

#ifndef OAIMP2MPNetworkServiceConfigUpdate_H
#define OAIMP2MPNetworkServiceConfigUpdate_H
...
class OAIMP2MPNetworkServiceConfigUpdate : public OAIObject {
public:
    OAIMP2MPNetworkServiceConfigUpdate();
    OAIMP2MPNetworkServiceConfigUpdate(QString json);
    ~OAIMP2MPNetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkServiceConfigUpdate)

#endif // OAIMP2MPNetworkServiceConfigUpdate_H
