...
/*
 * OAIP2PNetworkServiceConfigPartial.h
 *
 * P2P Network Service Config
 */

#ifndef OAIP2PNetworkServiceConfigPartial_H
#define OAIP2PNetworkServiceConfigPartial_H
...
class OAIP2PNetworkServiceConfigPartial : public OAIObject {
public:
    OAIP2PNetworkServiceConfigPartial();
    OAIP2PNetworkServiceConfigPartial(QString json);
    ~OAIP2PNetworkServiceConfigPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceConfigPartial)

#endif // OAIP2PNetworkServiceConfigPartial_H
