...
/*
 * OAIP2PNetworkServiceConfigUpdate.h
 *
 * 
 */

#ifndef OAIP2PNetworkServiceConfigUpdate_H
#define OAIP2PNetworkServiceConfigUpdate_H
...
class OAIP2PNetworkServiceConfigUpdate : public OAIObject {
public:
    OAIP2PNetworkServiceConfigUpdate();
    OAIP2PNetworkServiceConfigUpdate(QString json);
    ~OAIP2PNetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceConfigUpdate)

#endif // OAIP2PNetworkServiceConfigUpdate_H
