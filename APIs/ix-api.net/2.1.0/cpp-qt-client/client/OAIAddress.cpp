...
QString OAIAddress::getPostOfficeBoxNumber() const {
    return m_post_office_box_number;
}
void OAIAddress::setPostOfficeBoxNumber(const QString &post_office_box_number) {
    m_post_office_box_number = post_office_box_number;
    m_post_office_box_number_isSet = true;
}

bool OAIAddress::is_post_office_box_number_Set() const{
    return m_post_office_box_number_isSet;
}

bool OAIAddress::is_post_office_box_number_Valid() const{
...
bool OAIAddress::isValid() const {
    ...
    return m_country_isValid && m_locality_isValid && m_postal_code_isValid && m_street_address_isValid && true;
}
