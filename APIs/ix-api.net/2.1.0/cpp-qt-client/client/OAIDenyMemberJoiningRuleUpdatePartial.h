...
/*
 * OAIDenyMemberJoiningRuleUpdatePartial.h
 *
 * A vlan member joining rule update
 */

#ifndef OAIDenyMemberJoiningRuleUpdatePartial_H
#define OAIDenyMemberJoiningRuleUpdatePartial_H
...
class OAIDenyMemberJoiningRuleUpdatePartial : public OAIObject {
public:
    OAIDenyMemberJoiningRuleUpdatePartial();
    OAIDenyMemberJoiningRuleUpdatePartial(QString json);
    ~OAIDenyMemberJoiningRuleUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDenyMemberJoiningRuleUpdatePartial)

#endif // OAIDenyMemberJoiningRuleUpdatePartial_H
