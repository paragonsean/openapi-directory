...
OAIInvoiceable::OAIInvoiceable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInvoiceable::OAIInvoiceable() {
    this->initializeModel();
}

OAIInvoiceable::~OAIInvoiceable() {}

void OAIInvoiceable::initializeModel() {
...
void OAIInvoiceable::fromJson(QString jsonString) {
...
void OAIInvoiceable::fromJsonObject(QJsonObject json) {
...
QString OAIInvoiceable::asJson() const {
...
QJsonObject OAIInvoiceable::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInvoiceable::getBillingAccount() const {
    return m_billing_account;
}
void OAIInvoiceable::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIInvoiceable::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIInvoiceable::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIInvoiceable::getContractRef() const {
    return m_contract_ref;
}
void OAIInvoiceable::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIInvoiceable::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIInvoiceable::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIInvoiceable::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIInvoiceable::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIInvoiceable::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIInvoiceable::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

bool OAIInvoiceable::isSet() const {
...
bool OAIInvoiceable::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && true;
}
