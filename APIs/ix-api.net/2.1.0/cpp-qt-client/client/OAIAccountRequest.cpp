...
OAIAccountRequest::OAIAccountRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountRequest::OAIAccountRequest() {
    this->initializeModel();
}

OAIAccountRequest::~OAIAccountRequest() {}

void OAIAccountRequest::initializeModel() {
...
void OAIAccountRequest::fromJson(QString jsonString) {
...
void OAIAccountRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAccountRequest::asJson() const {
...
QJsonObject OAIAccountRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_address.isSet()) {
...
OAIAddress OAIAccountRequest::getAddress() const {
    return m_address;
}
void OAIAccountRequest::setAddress(const OAIAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIAccountRequest::is_address_Set() const{
    return m_address_isSet;
}

bool OAIAccountRequest::is_address_Valid() const{
    return m_address_isValid;
}

OAIBillingInformation OAIAccountRequest::getBillingInformation() const {
    return m_billing_information;
}
void OAIAccountRequest::setBillingInformation(const OAIBillingInformation &billing_information) {
    m_billing_information = billing_information;
    m_billing_information_isSet = true;
}

bool OAIAccountRequest::is_billing_information_Set() const{
    return m_billing_information_isSet;
}

bool OAIAccountRequest::is_billing_information_Valid() const{
    return m_billing_information_isValid;
}

bool OAIAccountRequest::isDiscoverable() const {
    return m_discoverable;
}
void OAIAccountRequest::setDiscoverable(const bool &discoverable) {
    m_discoverable = discoverable;
    m_discoverable_isSet = true;
}

bool OAIAccountRequest::is_discoverable_Set() const{
    return m_discoverable_isSet;
}

bool OAIAccountRequest::is_discoverable_Valid() const{
    return m_discoverable_isValid;
}

QString OAIAccountRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIAccountRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIAccountRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIAccountRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIAccountRequest::getLegalName() const {
    return m_legal_name;
}
void OAIAccountRequest::setLegalName(const QString &legal_name) {
    m_legal_name = legal_name;
    m_legal_name_isSet = true;
}

bool OAIAccountRequest::is_legal_name_Set() const{
    return m_legal_name_isSet;
}

bool OAIAccountRequest::is_legal_name_Valid() const{
    return m_legal_name_isValid;
}

QString OAIAccountRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIAccountRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIAccountRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIAccountRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIAccountRequest::getMetroAreaNetworkPresence() const {
    return m_metro_area_network_presence;
}
void OAIAccountRequest::setMetroAreaNetworkPresence(const QList<QString> &metro_area_network_presence) {
    m_metro_area_network_presence = metro_area_network_presence;
    m_metro_area_network_presence_isSet = true;
}

bool OAIAccountRequest::is_metro_area_network_presence_Set() const{
    return m_metro_area_network_presence_isSet;
}

bool OAIAccountRequest::is_metro_area_network_presence_Valid() const{
    return m_metro_area_network_presence_isValid;
}

QString OAIAccountRequest::getName() const {
    return m_name;
}
void OAIAccountRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAccountRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAccountRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIAccountRequest::isSet() const {
...
bool OAIAccountRequest::isValid() const {
