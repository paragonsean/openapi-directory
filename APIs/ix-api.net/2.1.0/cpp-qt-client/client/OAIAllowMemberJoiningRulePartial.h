...
/*
 * OAIAllowMemberJoiningRulePartial.h
 *
 * A rule for members joining a private vlan
 */

#ifndef OAIAllowMemberJoiningRulePartial_H
#define OAIAllowMemberJoiningRulePartial_H
...
class OAIAllowMemberJoiningRulePartial : public OAIObject {
public:
    OAIAllowMemberJoiningRulePartial();
    OAIAllowMemberJoiningRulePartial(QString json);
    ~OAIAllowMemberJoiningRulePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowMemberJoiningRulePartial)

#endif // OAIAllowMemberJoiningRulePartial_H
