...
OAINetworkServiceRequestPartial::OAINetworkServiceRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINetworkServiceRequestPartial::OAINetworkServiceRequestPartial() {
    this->initializeModel();
}

OAINetworkServiceRequestPartial::~OAINetworkServiceRequestPartial() {}

void OAINetworkServiceRequestPartial::initializeModel() {
...
void OAINetworkServiceRequestPartial::fromJson(QString jsonString) {
...
void OAINetworkServiceRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAINetworkServiceRequestPartial::asJson() const {
...
QJsonObject OAINetworkServiceRequestPartial::asJsonObject() const {
    QJsonObject obj;
...
QString OAINetworkServiceRequestPartial::getBillingAccount() const {
    return m_billing_account;
}
void OAINetworkServiceRequestPartial::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAINetworkServiceRequestPartial::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAINetworkServiceRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAINetworkServiceRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAINetworkServiceRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAINetworkServiceRequestPartial::getContractRef() const {
    return m_contract_ref;
}
void OAINetworkServiceRequestPartial::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAINetworkServiceRequestPartial::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAINetworkServiceRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAINetworkServiceRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAINetworkServiceRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAINetworkServiceRequestPartial::getJoiningMemberAccount() const {
    return m_joining_member_account;
}
void OAINetworkServiceRequestPartial::setJoiningMemberAccount(const QString &joining_member_account) {
    m_joining_member_account = joining_member_account;
    m_joining_member_account_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_joining_member_account_Set() const{
    return m_joining_member_account_isSet;
}

bool OAINetworkServiceRequestPartial::is_joining_member_account_Valid() const{
    return m_joining_member_account_isValid;
}

QString OAINetworkServiceRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAINetworkServiceRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAINetworkServiceRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAINetworkServiceRequestPartial::getProductOffering() const {
    return m_product_offering;
}
void OAINetworkServiceRequestPartial::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAINetworkServiceRequestPartial::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

QString OAINetworkServiceRequestPartial::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAINetworkServiceRequestPartial::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAINetworkServiceRequestPartial::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAINetworkServiceRequestPartial::getType() const {
    return m_type;
}
void OAINetworkServiceRequestPartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAINetworkServiceRequestPartial::is_type_Valid() const{
    return m_type_isValid;
}

QString OAINetworkServiceRequestPartial::getName() const {
    return m_name;
}
void OAINetworkServiceRequestPartial::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_name_Set() const{
    return m_name_isSet;
}

bool OAINetworkServiceRequestPartial::is_name_Valid() const{
    return m_name_isValid;
}

bool OAINetworkServiceRequestPartial::isRPublic() const {
    return m_r_public;
}
void OAINetworkServiceRequestPartial::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAINetworkServiceRequestPartial::is_r_public_Valid() const{
    return m_r_public_isValid;
}

qint32 OAINetworkServiceRequestPartial::getCapacity() const {
    return m_capacity;
}
void OAINetworkServiceRequestPartial::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAINetworkServiceRequestPartial::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QString OAINetworkServiceRequestPartial::getCloudKey() const {
    return m_cloud_key;
}
void OAINetworkServiceRequestPartial::setCloudKey(const QString &cloud_key) {
    m_cloud_key = cloud_key;
    m_cloud_key_isSet = true;
}

bool OAINetworkServiceRequestPartial::is_cloud_key_Set() const{
    return m_cloud_key_isSet;
}

bool OAINetworkServiceRequestPartial::is_cloud_key_Valid() const{
    return m_cloud_key_isValid;
}

bool OAINetworkServiceRequestPartial::isSet() const {
...
bool OAINetworkServiceRequestPartial::isValid() const {
