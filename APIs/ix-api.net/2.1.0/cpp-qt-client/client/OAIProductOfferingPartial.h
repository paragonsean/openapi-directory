...
/*
 * OAIProductOfferingPartial.h
 *
 * Polymorphic Product Offering
 */

#ifndef OAIProductOfferingPartial_H
#define OAIProductOfferingPartial_H
...
class OAIProductOfferingPartial : public OAIObject {
public:
    OAIProductOfferingPartial();
    OAIProductOfferingPartial(QString json);
    ~OAIProductOfferingPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductOfferingPartial)

#endif // OAIProductOfferingPartial_H
