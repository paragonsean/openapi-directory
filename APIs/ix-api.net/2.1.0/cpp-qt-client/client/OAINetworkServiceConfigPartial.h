...
/*
 * OAINetworkServiceConfigPartial.h
 *
 * Polymorphic Network Service Config
 */

#ifndef OAINetworkServiceConfigPartial_H
#define OAINetworkServiceConfigPartial_H
...
class OAINetworkServiceConfigPartial : public OAIObject {
public:
    OAINetworkServiceConfigPartial();
    OAINetworkServiceConfigPartial(QString json);
    ~OAINetworkServiceConfigPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceConfigPartial)

#endif // OAINetworkServiceConfigPartial_H
