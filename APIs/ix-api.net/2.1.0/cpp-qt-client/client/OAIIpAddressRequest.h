...
/*
 * OAIIpAddressRequest.h
 *
 * 
 */

#ifndef OAIIpAddressRequest_H
#define OAIIpAddressRequest_H
...
class OAIIpAddressRequest : public OAIObject {
public:
    OAIIpAddressRequest();
    OAIIpAddressRequest(QString json);
    ~OAIIpAddressRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressRequest)

#endif // OAIIpAddressRequest_H
