...
/*
 * OAICloudNetworkServiceConfigUpdate.h
 *
 * 
 */

#ifndef OAICloudNetworkServiceConfigUpdate_H
#define OAICloudNetworkServiceConfigUpdate_H
...
class OAICloudNetworkServiceConfigUpdate : public OAIObject {
public:
    OAICloudNetworkServiceConfigUpdate();
    OAICloudNetworkServiceConfigUpdate(QString json);
    ~OAICloudNetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceConfigUpdate)

#endif // OAICloudNetworkServiceConfigUpdate_H
