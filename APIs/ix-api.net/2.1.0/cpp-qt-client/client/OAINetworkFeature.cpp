...
OAINetworkFeature::OAINetworkFeature(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINetworkFeature::OAINetworkFeature() {
    this->initializeModel();
}

OAINetworkFeature::~OAINetworkFeature() {}

void OAINetworkFeature::initializeModel() {
...
void OAINetworkFeature::fromJson(QString jsonString) {
...
void OAINetworkFeature::fromJsonObject(QJsonObject json) {
...
QString OAINetworkFeature::asJson() const {
...
QJsonObject OAINetworkFeature::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAINetworkFeature::getAddressFamilies() const {
    return m_address_families;
}
void OAINetworkFeature::setAddressFamilies(const QList<QString> &address_families) {
    m_address_families = address_families;
    m_address_families_isSet = true;
}

bool OAINetworkFeature::is_address_families_Set() const{
    return m_address_families_isSet;
}

bool OAINetworkFeature::is_address_families_Valid() const{
    return m_address_families_isValid;
}

qint32 OAINetworkFeature::getAsn() const {
    return m_asn;
}
void OAINetworkFeature::setAsn(const qint32 &asn) {
    m_asn = asn;
    m_asn_isSet = true;
}

bool OAINetworkFeature::is_asn_Set() const{
    return m_asn_isSet;
}

bool OAINetworkFeature::is_asn_Valid() const{
    return m_asn_isValid;
}

QList<QString> OAINetworkFeature::getAvailableBgpSessionTypes() const {
    return m_available_bgp_session_types;
}
void OAINetworkFeature::setAvailableBgpSessionTypes(const QList<QString> &available_bgp_session_types) {
    m_available_bgp_session_types = available_bgp_session_types;
    m_available_bgp_session_types_isSet = true;
}

bool OAINetworkFeature::is_available_bgp_session_types_Set() const{
    return m_available_bgp_session_types_isSet;
}

bool OAINetworkFeature::is_available_bgp_session_types_Valid() const{
    return m_available_bgp_session_types_isValid;
}

QList<OAIIXPSpecificFeatureFlag> OAINetworkFeature::getFlags() const {
    return m_flags;
}
void OAINetworkFeature::setFlags(const QList<OAIIXPSpecificFeatureFlag> &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAINetworkFeature::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAINetworkFeature::is_flags_Valid() const{
    return m_flags_isValid;
}

QString OAINetworkFeature::getFqdn() const {
    return m_fqdn;
}
void OAINetworkFeature::setFqdn(const QString &fqdn) {
    m_fqdn = fqdn;
    m_fqdn_isSet = true;
}

bool OAINetworkFeature::is_fqdn_Set() const{
    return m_fqdn_isSet;
}

bool OAINetworkFeature::is_fqdn_Valid() const{
    return m_fqdn_isValid;
}

QString OAINetworkFeature::getId() const {
    return m_id;
}
void OAINetworkFeature::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINetworkFeature::is_id_Set() const{
    return m_id_isSet;
}

bool OAINetworkFeature::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINetworkFeature::getIpV4() const {
    return m_ip_v4;
}
void OAINetworkFeature::setIpV4(const QString &ip_v4) {
    m_ip_v4 = ip_v4;
    m_ip_v4_isSet = true;
}

bool OAINetworkFeature::is_ip_v4_Set() const{
    return m_ip_v4_isSet;
}

bool OAINetworkFeature::is_ip_v4_Valid() const{
    return m_ip_v4_isValid;
}

QString OAINetworkFeature::getIpV6() const {
    return m_ip_v6;
}
void OAINetworkFeature::setIpV6(const QString &ip_v6) {
    m_ip_v6 = ip_v6;
    m_ip_v6_isSet = true;
}

bool OAINetworkFeature::is_ip_v6_Set() const{
    return m_ip_v6_isSet;
}

bool OAINetworkFeature::is_ip_v6_Valid() const{
    return m_ip_v6_isValid;
}

QString OAINetworkFeature::getLookingGlassUrl() const {
    return m_looking_glass_url;
}
void OAINetworkFeature::setLookingGlassUrl(const QString &looking_glass_url) {
    m_looking_glass_url = looking_glass_url;
    m_looking_glass_url_isSet = true;
}

bool OAINetworkFeature::is_looking_glass_url_Set() const{
    return m_looking_glass_url_isSet;
}

bool OAINetworkFeature::is_looking_glass_url_Valid() const{
    return m_looking_glass_url_isValid;
}

QString OAINetworkFeature::getName() const {
    return m_name;
}
void OAINetworkFeature::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAINetworkFeature::is_name_Set() const{
    return m_name_isSet;
}

bool OAINetworkFeature::is_name_Valid() const{
    return m_name_isValid;
}

QString OAINetworkFeature::getNetworkService() const {
    return m_network_service;
}
void OAINetworkFeature::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAINetworkFeature::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAINetworkFeature::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QList<QString> OAINetworkFeature::getNfcRequiredContactRoles() const {
    return m_nfc_required_contact_roles;
}
void OAINetworkFeature::setNfcRequiredContactRoles(const QList<QString> &nfc_required_contact_roles) {
    m_nfc_required_contact_roles = nfc_required_contact_roles;
    m_nfc_required_contact_roles_isSet = true;
}

bool OAINetworkFeature::is_nfc_required_contact_roles_Set() const{
    return m_nfc_required_contact_roles_isSet;
}

bool OAINetworkFeature::is_nfc_required_contact_roles_Valid() const{
    return m_nfc_required_contact_roles_isValid;
}

bool OAINetworkFeature::isRequired() const {
    return m_required;
}
void OAINetworkFeature::setRequired(const bool &required) {
    m_required = required;
    m_required_isSet = true;
}

bool OAINetworkFeature::is_required_Set() const{
    return m_required_isSet;
}

bool OAINetworkFeature::is_required_Valid() const{
    return m_required_isValid;
}

QString OAINetworkFeature::getSessionMode() const {
    return m_session_mode;
}
void OAINetworkFeature::setSessionMode(const QString &session_mode) {
    m_session_mode = session_mode;
    m_session_mode_isSet = true;
}

bool OAINetworkFeature::is_session_mode_Set() const{
    return m_session_mode_isSet;
}

bool OAINetworkFeature::is_session_mode_Valid() const{
    return m_session_mode_isValid;
}

QString OAINetworkFeature::getType() const {
    return m_type;
}
void OAINetworkFeature::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINetworkFeature::is_type_Set() const{
    return m_type_isSet;
}

bool OAINetworkFeature::is_type_Valid() const{
    return m_type_isValid;
}

bool OAINetworkFeature::isSet() const {
...
bool OAINetworkFeature::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_address_families_isValid && m_asn_isValid && m_available_bgp_session_types_isValid && m_flags_isValid && m_fqdn_isValid && m_id_isValid && m_ip_v4_isValid && m_ip_v6_isValid && m_name_isValid && m_network_service_isValid && m_required_isValid && m_session_mode_isValid && m_type_isValid && true;
}
