...
/*
 * OAINetworkFeatureConfigPartial.h
 *
 * Polymorphic Network Feature Config
 */

#ifndef OAINetworkFeatureConfigPartial_H
#define OAINetworkFeatureConfigPartial_H
...
class OAINetworkFeatureConfigPartial : public OAIObject {
public:
    OAINetworkFeatureConfigPartial();
    OAINetworkFeatureConfigPartial(QString json);
    ~OAINetworkFeatureConfigPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkFeatureConfigPartial)

#endif // OAINetworkFeatureConfigPartial_H
