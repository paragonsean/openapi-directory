...
#include "OAIConnectionRequest.h"
...
OAIConnectionRequest::OAIConnectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectionRequest::OAIConnectionRequest() {
    this->initializeModel();
}

OAIConnectionRequest::~OAIConnectionRequest() {}

void OAIConnectionRequest::initializeModel() {
...
void OAIConnectionRequest::fromJson(QString jsonString) {
...
void OAIConnectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIConnectionRequest::asJson() const {
...
QJsonObject OAIConnectionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConnectionRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIConnectionRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIConnectionRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIConnectionRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIConnectionRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIConnectionRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIConnectionRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIConnectionRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIConnectionRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIConnectionRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIConnectionRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIConnectionRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIConnectionRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIConnectionRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIConnectionRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIConnectionRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIConnectionRequest::getLacpTimeout() const {
    return m_lacp_timeout;
}
void OAIConnectionRequest::setLacpTimeout(const QString &lacp_timeout) {
    m_lacp_timeout = lacp_timeout;
    m_lacp_timeout_isSet = true;
}

bool OAIConnectionRequest::is_lacp_timeout_Set() const{
    return m_lacp_timeout_isSet;
}

bool OAIConnectionRequest::is_lacp_timeout_Valid() const{
    return m_lacp_timeout_isValid;
}

QString OAIConnectionRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIConnectionRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIConnectionRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIConnectionRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIConnectionRequest::getMode() const {
    return m_mode;
}
void OAIConnectionRequest::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIConnectionRequest::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIConnectionRequest::is_mode_Valid() const{
    return m_mode_isValid;
}

QString OAIConnectionRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIConnectionRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIConnectionRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIConnectionRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIConnectionRequest::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIConnectionRequest::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIConnectionRequest::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIConnectionRequest::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIConnectionRequest::getSpeed() const {
    return m_speed;
}
void OAIConnectionRequest::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIConnectionRequest::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIConnectionRequest::is_speed_Valid() const{
    return m_speed_isValid;
}

bool OAIConnectionRequest::isSet() const {
...
bool OAIConnectionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_mode_isValid && m_role_assignments_isValid && true;
}
