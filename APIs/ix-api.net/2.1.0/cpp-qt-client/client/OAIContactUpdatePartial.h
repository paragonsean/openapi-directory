...
/*
 * OAIContactUpdatePartial.h
 *
 * A contact update
 */

#ifndef OAIContactUpdatePartial_H
#define OAIContactUpdatePartial_H
...
class OAIContactUpdatePartial : public OAIObject {
public:
    OAIContactUpdatePartial();
    OAIContactUpdatePartial(QString json);
    ~OAIContactUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactUpdatePartial)

#endif // OAIContactUpdatePartial_H
