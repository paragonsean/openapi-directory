...
QString OAIContactRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIContactRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIContactRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIContactRequest::is_consuming_account_Valid() const{
...
QString OAIContactRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIContactRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIContactRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIContactRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIContactRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIContactRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIContactRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIContactRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIContactRequest::getName() const {
    return m_name;
}
void OAIContactRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIContactRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIContactRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIContactRequest::getTelephone() const {
    return m_telephone;
}
void OAIContactRequest::setTelephone(const QString &telephone) {
    m_telephone = telephone;
    m_telephone_isSet = true;
}

bool OAIContactRequest::is_telephone_Set() const{
    return m_telephone_isSet;
}

bool OAIContactRequest::is_telephone_Valid() const{
