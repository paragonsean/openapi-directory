...
#include "OAIMemberJoiningRuleRequestPartial.h"
...
OAIMemberJoiningRuleRequestPartial::OAIMemberJoiningRuleRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMemberJoiningRuleRequestPartial::OAIMemberJoiningRuleRequestPartial() {
    this->initializeModel();
}

OAIMemberJoiningRuleRequestPartial::~OAIMemberJoiningRuleRequestPartial() {}

void OAIMemberJoiningRuleRequestPartial::initializeModel() {
...
void OAIMemberJoiningRuleRequestPartial::fromJson(QString jsonString) {
...
void OAIMemberJoiningRuleRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIMemberJoiningRuleRequestPartial::asJson() const {
...
QJsonObject OAIMemberJoiningRuleRequestPartial::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMemberJoiningRuleRequestPartial::getCapacityMax() const {
    return m_capacity_max;
}
void OAIMemberJoiningRuleRequestPartial::setCapacityMax(const qint32 &capacity_max) {
    m_capacity_max = capacity_max;
    m_capacity_max_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_capacity_max_Set() const{
    return m_capacity_max_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_capacity_max_Valid() const{
    return m_capacity_max_isValid;
}

qint32 OAIMemberJoiningRuleRequestPartial::getCapacityMin() const {
    return m_capacity_min;
}
void OAIMemberJoiningRuleRequestPartial::setCapacityMin(const qint32 &capacity_min) {
    m_capacity_min = capacity_min;
    m_capacity_min_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_capacity_min_Set() const{
    return m_capacity_min_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_capacity_min_Valid() const{
    return m_capacity_min_isValid;
}

QString OAIMemberJoiningRuleRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMemberJoiningRuleRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMemberJoiningRuleRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIMemberJoiningRuleRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMemberJoiningRuleRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIMemberJoiningRuleRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIMemberJoiningRuleRequestPartial::getNetworkService() const {
    return m_network_service;
}
void OAIMemberJoiningRuleRequestPartial::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIMemberJoiningRuleRequestPartial::getType() const {
    return m_type;
}
void OAIMemberJoiningRuleRequestPartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMemberJoiningRuleRequestPartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMemberJoiningRuleRequestPartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMemberJoiningRuleRequestPartial::isSet() const {
...
bool OAIMemberJoiningRuleRequestPartial::isValid() const {
