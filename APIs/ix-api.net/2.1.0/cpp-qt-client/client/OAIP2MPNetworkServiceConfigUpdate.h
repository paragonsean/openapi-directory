...
/*
 * OAIP2MPNetworkServiceConfigUpdate.h
 *
 * 
 */

#ifndef OAIP2MPNetworkServiceConfigUpdate_H
#define OAIP2MPNetworkServiceConfigUpdate_H
...
class OAIP2MPNetworkServiceConfigUpdate : public OAIObject {
public:
    OAIP2MPNetworkServiceConfigUpdate();
    OAIP2MPNetworkServiceConfigUpdate(QString json);
    ~OAIP2MPNetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceConfigUpdate)

#endif // OAIP2MPNetworkServiceConfigUpdate_H
