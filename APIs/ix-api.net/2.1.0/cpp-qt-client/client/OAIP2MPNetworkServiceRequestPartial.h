...
/*
 * OAIP2MPNetworkServiceRequestPartial.h
 *
 * P2MP Network Service Request
 */

#ifndef OAIP2MPNetworkServiceRequestPartial_H
#define OAIP2MPNetworkServiceRequestPartial_H
...
class OAIP2MPNetworkServiceRequestPartial : public OAIObject {
public:
    OAIP2MPNetworkServiceRequestPartial();
    OAIP2MPNetworkServiceRequestPartial(QString json);
    ~OAIP2MPNetworkServiceRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceRequestPartial)

#endif // OAIP2MPNetworkServiceRequestPartial_H
