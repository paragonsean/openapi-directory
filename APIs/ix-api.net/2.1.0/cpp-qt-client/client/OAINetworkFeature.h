...
#ifndef OAINetworkFeature_H
#define OAINetworkFeature_H
...
class OAINetworkFeature : public OAIObject {
public:
    OAINetworkFeature();
    OAINetworkFeature(QString json);
    ~OAINetworkFeature() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkFeature)

#endif // OAINetworkFeature_H
