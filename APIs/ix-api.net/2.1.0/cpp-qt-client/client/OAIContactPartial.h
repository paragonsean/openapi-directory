...
#ifndef OAIContactPartial_H
#define OAIContactPartial_H
...
class OAIContactPartial : public OAIObject {
public:
    OAIContactPartial();
    OAIContactPartial(QString json);
    ~OAIContactPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactPartial)

#endif // OAIContactPartial_H
