...
/*
 * OAIP2MPNetworkServiceConfigPartial.h
 *
 * P2MP Network Service Config
 */

#ifndef OAIP2MPNetworkServiceConfigPartial_H
#define OAIP2MPNetworkServiceConfigPartial_H
...
class OAIP2MPNetworkServiceConfigPartial : public OAIObject {
public:
    OAIP2MPNetworkServiceConfigPartial();
    OAIP2MPNetworkServiceConfigPartial(QString json);
    ~OAIP2MPNetworkServiceConfigPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceConfigPartial)

#endif // OAIP2MPNetworkServiceConfigPartial_H
