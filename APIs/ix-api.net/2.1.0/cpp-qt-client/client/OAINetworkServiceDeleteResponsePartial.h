...
/*
 * OAINetworkServiceDeleteResponsePartial.h
 *
 * Polymorphic Network Service Request
 */

#ifndef OAINetworkServiceDeleteResponsePartial_H
#define OAINetworkServiceDeleteResponsePartial_H
...
class OAINetworkServiceDeleteResponsePartial : public OAIObject {
public:
    OAINetworkServiceDeleteResponsePartial();
    OAINetworkServiceDeleteResponsePartial(QString json);
    ~OAINetworkServiceDeleteResponsePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceDeleteResponsePartial)

#endif // OAINetworkServiceDeleteResponsePartial_H
