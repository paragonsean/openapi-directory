...
/*
 * OAINetworkServiceConfigRequest.h
 *
 * Polymorhic Network Service Config Request
 */

#ifndef OAINetworkServiceConfigRequest_H
#define OAINetworkServiceConfigRequest_H
...
#include "OAIP2MPNetworkServiceConfigRequest.h"
...
class OAINetworkServiceConfigRequest : public OAIObject {
public:
    OAINetworkServiceConfigRequest();
    OAINetworkServiceConfigRequest(QString json);
    ~OAINetworkServiceConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceConfigRequest)

#endif // OAINetworkServiceConfigRequest_H
