...
/*
 * OAIExchangeLanNetworkProductOffering.h
 *
 * 
 */

#ifndef OAIExchangeLanNetworkProductOffering_H
#define OAIExchangeLanNetworkProductOffering_H
...
class OAIExchangeLanNetworkProductOffering : public OAIObject {
public:
    OAIExchangeLanNetworkProductOffering();
    OAIExchangeLanNetworkProductOffering(QString json);
    ~OAIExchangeLanNetworkProductOffering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangeLanNetworkProductOffering)

#endif // OAIExchangeLanNetworkProductOffering_H
