...
QString OAIIpAddressUpdate::getAddress() const {
    return m_address;
}
void OAIIpAddressUpdate::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIIpAddressUpdate::is_address_Set() const{
    return m_address_isSet;
}

bool OAIIpAddressUpdate::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIIpAddressUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIIpAddressUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIIpAddressUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIIpAddressUpdate::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIIpAddressUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIIpAddressUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIIpAddressUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIIpAddressUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIIpAddressUpdate::getFqdn() const {
    return m_fqdn;
}
void OAIIpAddressUpdate::setFqdn(const QString &fqdn) {
    m_fqdn = fqdn;
    m_fqdn_isSet = true;
}

bool OAIIpAddressUpdate::is_fqdn_Set() const{
    return m_fqdn_isSet;
}

bool OAIIpAddressUpdate::is_fqdn_Valid() const{
    return m_fqdn_isValid;
}

QString OAIIpAddressUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIIpAddressUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIIpAddressUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIIpAddressUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

qint32 OAIIpAddressUpdate::getPrefixLength() const {
    return m_prefix_length;
}
void OAIIpAddressUpdate::setPrefixLength(const qint32 &prefix_length) {
    m_prefix_length = prefix_length;
    m_prefix_length_isSet = true;
}

bool OAIIpAddressUpdate::is_prefix_length_Set() const{
    return m_prefix_length_isSet;
}

bool OAIIpAddressUpdate::is_prefix_length_Valid() const{
    return m_prefix_length_isValid;
}

QDateTime OAIIpAddressUpdate::getValidNotAfter() const {
    return m_valid_not_after;
}
void OAIIpAddressUpdate::setValidNotAfter(const QDateTime &valid_not_after) {
    m_valid_not_after = valid_not_after;
    m_valid_not_after_isSet = true;
}

bool OAIIpAddressUpdate::is_valid_not_after_Set() const{
    return m_valid_not_after_isSet;
}

bool OAIIpAddressUpdate::is_valid_not_after_Valid() const{
    return m_valid_not_after_isValid;
}

QDateTime OAIIpAddressUpdate::getValidNotBefore() const {
    return m_valid_not_before;
}
void OAIIpAddressUpdate::setValidNotBefore(const QDateTime &valid_not_before) {
    m_valid_not_before = valid_not_before;
    m_valid_not_before_isSet = true;
}

bool OAIIpAddressUpdate::is_valid_not_before_Set() const{
    return m_valid_not_before_isSet;
}

bool OAIIpAddressUpdate::is_valid_not_before_Valid() const{
    return m_valid_not_before_isValid;
}

qint32 OAIIpAddressUpdate::getVersion() const {
    return m_version;
}
void OAIIpAddressUpdate::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIIpAddressUpdate::is_version_Set() const{
    return m_version_isSet;
}

bool OAIIpAddressUpdate::is_version_Valid() const{
