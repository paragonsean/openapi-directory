...
/*
 * OAINetworkServiceRequest.h
 *
 * Polymorphic Network Service Request
 */

#ifndef OAINetworkServiceRequest_H
#define OAINetworkServiceRequest_H
...
class OAINetworkServiceRequest : public OAIObject {
public:
    OAINetworkServiceRequest();
    OAINetworkServiceRequest(QString json);
    ~OAINetworkServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceRequest)

#endif // OAINetworkServiceRequest_H
