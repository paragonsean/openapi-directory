...
public:
    ...
    QList<QString> getOuterVlanEthertypes() const;
    void setOuterVlanEthertypes(const QList<QString> &outer_vlan_ethertypes);
    bool is_outer_vlan_ethertypes_Set() const;
    bool is_outer_vlan_ethertypes_Valid() const;
    ...
    QList<QString> getVlanTypes() const;
    void setVlanTypes(const QList<QString> &vlan_types);
    bool is_vlan_types_Set() const;
    bool is_vlan_types_Valid() const;
...
private:
    ...
    QList<QString> m_outer_vlan_ethertypes;
    bool m_outer_vlan_ethertypes_isSet;
    bool m_outer_vlan_ethertypes_isValid;
    ...
    QList<QString> m_vlan_types;
    bool m_vlan_types_isSet;
    bool m_vlan_types_isValid;
};
