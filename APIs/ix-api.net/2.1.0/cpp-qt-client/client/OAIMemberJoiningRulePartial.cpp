...
#include "OAIMemberJoiningRulePartial.h"
...
OAIMemberJoiningRulePartial::OAIMemberJoiningRulePartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMemberJoiningRulePartial::OAIMemberJoiningRulePartial() {
    this->initializeModel();
}

OAIMemberJoiningRulePartial::~OAIMemberJoiningRulePartial() {}

void OAIMemberJoiningRulePartial::initializeModel() {
...
void OAIMemberJoiningRulePartial::fromJson(QString jsonString) {
...
void OAIMemberJoiningRulePartial::fromJsonObject(QJsonObject json) {
...
QString OAIMemberJoiningRulePartial::asJson() const {
...
QJsonObject OAIMemberJoiningRulePartial::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMemberJoiningRulePartial::getCapacityMax() const {
    return m_capacity_max;
}
void OAIMemberJoiningRulePartial::setCapacityMax(const qint32 &capacity_max) {
    m_capacity_max = capacity_max;
    m_capacity_max_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_capacity_max_Set() const{
    return m_capacity_max_isSet;
}

bool OAIMemberJoiningRulePartial::is_capacity_max_Valid() const{
    return m_capacity_max_isValid;
}

qint32 OAIMemberJoiningRulePartial::getCapacityMin() const {
    return m_capacity_min;
}
void OAIMemberJoiningRulePartial::setCapacityMin(const qint32 &capacity_min) {
    m_capacity_min = capacity_min;
    m_capacity_min_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_capacity_min_Set() const{
    return m_capacity_min_isSet;
}

bool OAIMemberJoiningRulePartial::is_capacity_min_Valid() const{
    return m_capacity_min_isValid;
}

QString OAIMemberJoiningRulePartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMemberJoiningRulePartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMemberJoiningRulePartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMemberJoiningRulePartial::getExternalRef() const {
    return m_external_ref;
}
void OAIMemberJoiningRulePartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMemberJoiningRulePartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMemberJoiningRulePartial::getId() const {
    return m_id;
}
void OAIMemberJoiningRulePartial::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMemberJoiningRulePartial::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMemberJoiningRulePartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIMemberJoiningRulePartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMemberJoiningRulePartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIMemberJoiningRulePartial::getNetworkService() const {
    return m_network_service;
}
void OAIMemberJoiningRulePartial::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIMemberJoiningRulePartial::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIMemberJoiningRulePartial::getType() const {
    return m_type;
}
void OAIMemberJoiningRulePartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMemberJoiningRulePartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMemberJoiningRulePartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMemberJoiningRulePartial::isSet() const {
...
bool OAIMemberJoiningRulePartial::isValid() const {
