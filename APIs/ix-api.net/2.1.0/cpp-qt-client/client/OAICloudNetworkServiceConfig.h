...
/*
 * OAICloudNetworkServiceConfig.h
 *
 * 
 */

#ifndef OAICloudNetworkServiceConfig_H
#define OAICloudNetworkServiceConfig_H
...
class OAICloudNetworkServiceConfig : public OAIObject {
public:
    OAICloudNetworkServiceConfig();
    OAICloudNetworkServiceConfig(QString json);
    ~OAICloudNetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServiceConfig)

#endif // OAICloudNetworkServiceConfig_H
