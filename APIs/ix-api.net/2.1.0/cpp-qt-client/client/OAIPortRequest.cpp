...
OAIPortRequest::OAIPortRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPortRequest::OAIPortRequest() {
    this->initializeModel();
}

OAIPortRequest::~OAIPortRequest() {}

void OAIPortRequest::initializeModel() {
...
void OAIPortRequest::fromJson(QString jsonString) {
...
void OAIPortRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPortRequest::asJson() const {
...
QJsonObject OAIPortRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPortRequest::getBillingAccount() const {
    return m_billing_account;
}
void OAIPortRequest::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIPortRequest::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIPortRequest::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIPortRequest::getConnection() const {
    return m_connection;
}
void OAIPortRequest::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIPortRequest::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIPortRequest::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIPortRequest::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIPortRequest::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIPortRequest::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIPortRequest::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIPortRequest::getContractRef() const {
    return m_contract_ref;
}
void OAIPortRequest::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIPortRequest::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIPortRequest::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIPortRequest::getExternalRef() const {
    return m_external_ref;
}
void OAIPortRequest::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIPortRequest::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIPortRequest::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIPortRequest::getManagingAccount() const {
    return m_managing_account;
}
void OAIPortRequest::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIPortRequest::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIPortRequest::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIPortRequest::getMediaType() const {
    return m_media_type;
}
void OAIPortRequest::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIPortRequest::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIPortRequest::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIPortRequest::getPop() const {
    return m_pop;
}
void OAIPortRequest::setPop(const QString &pop) {
    m_pop = pop;
    m_pop_isSet = true;
}

bool OAIPortRequest::is_pop_Set() const{
    return m_pop_isSet;
}

bool OAIPortRequest::is_pop_Valid() const{
    return m_pop_isValid;
}

QString OAIPortRequest::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIPortRequest::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIPortRequest::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIPortRequest::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIPortRequest::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIPortRequest::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIPortRequest::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIPortRequest::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIPortRequest::getSpeed() const {
    return m_speed;
}
void OAIPortRequest::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIPortRequest::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIPortRequest::is_speed_Valid() const{
    return m_speed_isValid;
}

bool OAIPortRequest::isSet() const {
...
bool OAIPortRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_media_type_isValid && m_pop_isValid && m_role_assignments_isValid && true;
}
