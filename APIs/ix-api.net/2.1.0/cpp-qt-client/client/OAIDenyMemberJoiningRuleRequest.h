...
/*
 * OAIDenyMemberJoiningRuleRequest.h
 *
 * 
 */

#ifndef OAIDenyMemberJoiningRuleRequest_H
#define OAIDenyMemberJoiningRuleRequest_H
...
class OAIDenyMemberJoiningRuleRequest : public OAIObject {
public:
    OAIDenyMemberJoiningRuleRequest();
    OAIDenyMemberJoiningRuleRequest(QString json);
    ~OAIDenyMemberJoiningRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDenyMemberJoiningRuleRequest)

#endif // OAIDenyMemberJoiningRuleRequest_H
