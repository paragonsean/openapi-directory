...
/*
 * OAICloudNetworkServicePartial.h
 *
 * Cloud Network Service
 */

#ifndef OAICloudNetworkServicePartial_H
#define OAICloudNetworkServicePartial_H
...
class OAICloudNetworkServicePartial : public OAIObject {
public:
    OAICloudNetworkServicePartial();
    OAICloudNetworkServicePartial(QString json);
    ~OAICloudNetworkServicePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudNetworkServicePartial)

#endif // OAICloudNetworkServicePartial_H
