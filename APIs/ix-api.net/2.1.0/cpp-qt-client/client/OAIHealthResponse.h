...
#ifndef OAIHealthResponse_H
#define OAIHealthResponse_H
...
class OAIHealthResponse : public OAIObject {
public:
    OAIHealthResponse();
    OAIHealthResponse(QString json);
    ~OAIHealthResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthResponse)

#endif // OAIHealthResponse_H
