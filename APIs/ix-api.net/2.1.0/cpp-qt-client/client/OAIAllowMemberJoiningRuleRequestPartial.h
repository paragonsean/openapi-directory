...
/*
 * OAIAllowMemberJoiningRuleRequestPartial.h
 *
 * A new vlan member joining rule
 */

#ifndef OAIAllowMemberJoiningRuleRequestPartial_H
#define OAIAllowMemberJoiningRuleRequestPartial_H
...
class OAIAllowMemberJoiningRuleRequestPartial : public OAIObject {
public:
    OAIAllowMemberJoiningRuleRequestPartial();
    OAIAllowMemberJoiningRuleRequestPartial(QString json);
    ~OAIAllowMemberJoiningRuleRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowMemberJoiningRuleRequestPartial)

#endif // OAIAllowMemberJoiningRuleRequestPartial_H
