...
/*
 * OAIRouteServerNetworkFeature.h
 *
 * 
 */

#ifndef OAIRouteServerNetworkFeature_H
#define OAIRouteServerNetworkFeature_H
...
class OAIRouteServerNetworkFeature : public OAIObject {
public:
    OAIRouteServerNetworkFeature();
    OAIRouteServerNetworkFeature(QString json);
    ~OAIRouteServerNetworkFeature() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeature)

#endif // OAIRouteServerNetworkFeature_H
