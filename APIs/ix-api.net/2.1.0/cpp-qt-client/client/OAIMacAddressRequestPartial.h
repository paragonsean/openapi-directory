...
/*
 * OAIMacAddressRequestPartial.h
 *
 * MAC-Address Request
 */

#ifndef OAIMacAddressRequestPartial_H
#define OAIMacAddressRequestPartial_H
...
class OAIMacAddressRequestPartial : public OAIObject {
public:
    OAIMacAddressRequestPartial();
    OAIMacAddressRequestPartial(QString json);
    ~OAIMacAddressRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMacAddressRequestPartial)

#endif // OAIMacAddressRequestPartial_H
