...
/*
 * OAIP2PNetworkProductOffering.h
 *
 * 
 */

#ifndef OAIP2PNetworkProductOffering_H
#define OAIP2PNetworkProductOffering_H
...
class OAIP2PNetworkProductOffering : public OAIObject {
public:
    OAIP2PNetworkProductOffering();
    OAIP2PNetworkProductOffering(QString json);
    ~OAIP2PNetworkProductOffering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkProductOffering)

#endif // OAIP2PNetworkProductOffering_H
