...
/*
 * OAIProblemResponse.h
 *
 * 
 */

#ifndef OAIProblemResponse_H
#define OAIProblemResponse_H
...
class OAIProblemResponse : public OAIObject {
public:
    OAIProblemResponse();
    OAIProblemResponse(QString json);
    ~OAIProblemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProblemResponse)

#endif // OAIProblemResponse_H
