...
/*
 * OAIPortUpdatePartial.h
 *
 * Port Update
 */

#ifndef OAIPortUpdatePartial_H
#define OAIPortUpdatePartial_H
...
class OAIPortUpdatePartial : public OAIObject {
public:
    OAIPortUpdatePartial();
    OAIPortUpdatePartial(QString json);
    ~OAIPortUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortUpdatePartial)

#endif // OAIPortUpdatePartial_H
