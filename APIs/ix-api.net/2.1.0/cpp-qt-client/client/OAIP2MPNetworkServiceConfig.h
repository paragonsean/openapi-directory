...
/*
 * OAIP2MPNetworkServiceConfig.h
 *
 * 
 */

#ifndef OAIP2MPNetworkServiceConfig_H
#define OAIP2MPNetworkServiceConfig_H
...
class OAIP2MPNetworkServiceConfig : public OAIObject {
public:
    OAIP2MPNetworkServiceConfig();
    OAIP2MPNetworkServiceConfig(QString json);
    ~OAIP2MPNetworkServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceConfig)

#endif // OAIP2MPNetworkServiceConfig_H
