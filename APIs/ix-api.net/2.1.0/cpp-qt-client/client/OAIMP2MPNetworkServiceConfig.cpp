...
#include "OAIMP2MPNetworkServiceConfig.h"
...
OAIMP2MPNetworkServiceConfig::OAIMP2MPNetworkServiceConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMP2MPNetworkServiceConfig::OAIMP2MPNetworkServiceConfig() {
    this->initializeModel();
}

OAIMP2MPNetworkServiceConfig::~OAIMP2MPNetworkServiceConfig() {}

void OAIMP2MPNetworkServiceConfig::initializeModel() {
...
void OAIMP2MPNetworkServiceConfig::fromJson(QString jsonString) {
...
void OAIMP2MPNetworkServiceConfig::fromJsonObject(QJsonObject json) {
...
QString OAIMP2MPNetworkServiceConfig::asJson() const {
...
QJsonObject OAIMP2MPNetworkServiceConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMP2MPNetworkServiceConfig::getBillingAccount() const {
    return m_billing_account;
}
void OAIMP2MPNetworkServiceConfig::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIMP2MPNetworkServiceConfig::getCapacity() const {
    return m_capacity;
}
void OAIMP2MPNetworkServiceConfig::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAIMP2MPNetworkServiceConfig::getChargedUntil() const {
    return m_charged_until;
}
void OAIMP2MPNetworkServiceConfig::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getConnection() const {
    return m_connection;
}
void OAIMP2MPNetworkServiceConfig::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIMP2MPNetworkServiceConfig::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getContractRef() const {
    return m_contract_ref;
}
void OAIMP2MPNetworkServiceConfig::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAIMP2MPNetworkServiceConfig::getDecommissionAt() const {
    return m_decommission_at;
}
void OAIMP2MPNetworkServiceConfig::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getExternalRef() const {
    return m_external_ref;
}
void OAIMP2MPNetworkServiceConfig::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getId() const {
    return m_id;
}
void OAIMP2MPNetworkServiceConfig::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfig::getMacs() const {
    return m_macs;
}
void OAIMP2MPNetworkServiceConfig::setMacs(const QList<QString> &macs) {
    m_macs = macs;
    m_macs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_macs_Set() const{
    return m_macs_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_macs_Valid() const{
    return m_macs_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getManagingAccount() const {
    return m_managing_account;
}
void OAIMP2MPNetworkServiceConfig::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfig::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIMP2MPNetworkServiceConfig::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getNetworkService() const {
    return m_network_service;
}
void OAIMP2MPNetworkServiceConfig::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIMP2MPNetworkServiceConfig::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIMP2MPNetworkServiceConfig::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIMP2MPNetworkServiceConfig::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getState() const {
    return m_state;
}
void OAIMP2MPNetworkServiceConfig::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_state_Set() const{
    return m_state_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIMP2MPNetworkServiceConfig::getStatus() const {
    return m_status;
}
void OAIMP2MPNetworkServiceConfig::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIMP2MPNetworkServiceConfig::getType() const {
    return m_type;
}
void OAIMP2MPNetworkServiceConfig::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIMP2MPNetworkServiceConfig::getVlanConfig() const {
    return m_vlan_config;
}
void OAIMP2MPNetworkServiceConfig::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIMP2MPNetworkServiceConfig::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIMP2MPNetworkServiceConfig::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIMP2MPNetworkServiceConfig::isSet() const {
...
bool OAIMP2MPNetworkServiceConfig::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_connection_isValid && m_consuming_account_isValid && m_id_isValid && m_managing_account_isValid && m_network_service_isValid && m_role_assignments_isValid && m_state_isValid && m_type_isValid && m_vlan_config_isValid && true;
}
