...
/*
 * OAIMacAddressPartial.h
 *
 * MAC-Address
 */

#ifndef OAIMacAddressPartial_H
#define OAIMacAddressPartial_H
...
class OAIMacAddressPartial : public OAIObject {
public:
    OAIMacAddressPartial();
    OAIMacAddressPartial(QString json);
    ~OAIMacAddressPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMacAddressPartial)

#endif // OAIMacAddressPartial_H
