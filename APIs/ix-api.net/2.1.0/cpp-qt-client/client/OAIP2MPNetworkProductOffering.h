...
/*
 * OAIP2MPNetworkProductOffering.h
 *
 * 
 */

#ifndef OAIP2MPNetworkProductOffering_H
#define OAIP2MPNetworkProductOffering_H
...
class OAIP2MPNetworkProductOffering : public OAIObject {
public:
    OAIP2MPNetworkProductOffering();
    OAIP2MPNetworkProductOffering(QString json);
    ~OAIP2MPNetworkProductOffering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkProductOffering)

#endif // OAIP2MPNetworkProductOffering_H
