...
/*
 * OAINetworkServiceRequestPartial.h
 *
 * Polymorphic Network Service Request
 */

#ifndef OAINetworkServiceRequestPartial_H
#define OAINetworkServiceRequestPartial_H

#include <QJsonObject>

#include "OAICloudNetworkServiceRequestPartial.h"
...
class OAINetworkServiceRequestPartial : public OAIObject {
public:
    OAINetworkServiceRequestPartial();
    OAINetworkServiceRequestPartial(QString json);
    ~OAINetworkServiceRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkServiceRequestPartial)

#endif // OAINetworkServiceRequestPartial_H
