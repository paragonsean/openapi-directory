...
/*
 * OAICancellationPolicyPartial.h
 *
 * Cancellation Policy
 */

#ifndef OAICancellationPolicyPartial_H
#define OAICancellationPolicyPartial_H
...
class OAICancellationPolicyPartial : public OAIObject {
public:
    OAICancellationPolicyPartial();
    OAICancellationPolicyPartial(QString json);
    ~OAICancellationPolicyPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancellationPolicyPartial)

#endif // OAICancellationPolicyPartial_H
