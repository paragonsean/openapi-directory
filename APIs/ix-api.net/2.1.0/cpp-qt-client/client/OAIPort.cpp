...
QString OAIPort::getBillingAccount() const {
    return m_billing_account;
}
void OAIPort::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIPort::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIPort::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIPort::getConnection() const {
    return m_connection;
}
void OAIPort::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIPort::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIPort::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIPort::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIPort::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIPort::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIPort::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIPort::getContractRef() const {
    return m_contract_ref;
}
void OAIPort::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIPort::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIPort::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIPort::getDevice() const {
    return m_device;
}
void OAIPort::setDevice(const QString &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIPort::is_device_Set() const{
    return m_device_isSet;
}

bool OAIPort::is_device_Valid() const{
    return m_device_isValid;
}

QString OAIPort::getExternalRef() const {
    return m_external_ref;
}
void OAIPort::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIPort::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIPort::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIPort::getId() const {
    return m_id;
}
void OAIPort::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPort::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPort::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPort::getManagingAccount() const {
    return m_managing_account;
}
void OAIPort::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIPort::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIPort::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIPort::getMediaType() const {
    return m_media_type;
}
void OAIPort::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIPort::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIPort::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIPort::getName() const {
    return m_name;
}
void OAIPort::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPort::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPort::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPort::getPop() const {
    return m_pop;
}
void OAIPort::setPop(const QString &pop) {
    m_pop = pop;
    m_pop_isSet = true;
}

bool OAIPort::is_pop_Set() const{
    return m_pop_isSet;
}

bool OAIPort::is_pop_Valid() const{
    return m_pop_isValid;
}

QString OAIPort::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIPort::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIPort::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIPort::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIPort::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIPort::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIPort::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIPort::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIPort::getSpeed() const {
    return m_speed;
}
void OAIPort::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIPort::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIPort::is_speed_Valid() const{
    return m_speed_isValid;
}

QString OAIPort::getState() const {
    return m_state;
}
void OAIPort::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIPort::is_state_Set() const{
    return m_state_isSet;
}

bool OAIPort::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIPort::getStatus() const {
    return m_status;
}
void OAIPort::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPort::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPort::is_status_Valid() const{
...
bool OAIPort::isValid() const {
    ...
    return m_billing_account_isValid && m_consuming_account_isValid && m_device_isValid && m_id_isValid && m_managing_account_isValid && m_media_type_isValid && m_pop_isValid && m_role_assignments_isValid && m_state_isValid && true;
}
