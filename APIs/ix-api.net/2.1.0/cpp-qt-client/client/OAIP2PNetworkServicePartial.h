...
/*
 * OAIP2PNetworkServicePartial.h
 *
 * P2P Network Service
 */

#ifndef OAIP2PNetworkServicePartial_H
#define OAIP2PNetworkServicePartial_H
...
class OAIP2PNetworkServicePartial : public OAIObject {
public:
    OAIP2PNetworkServicePartial();
    OAIP2PNetworkServicePartial(QString json);
    ~OAIP2PNetworkServicePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServicePartial)

#endif // OAIP2PNetworkServicePartial_H
