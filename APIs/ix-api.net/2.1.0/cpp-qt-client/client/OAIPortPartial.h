...
#ifndef OAIPortPartial_H
#define OAIPortPartial_H
...
class OAIPortPartial : public OAIObject {
public:
    OAIPortPartial();
    OAIPortPartial(QString json);
    ~OAIPortPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortPartial)

#endif // OAIPortPartial_H
