...
/*
 * OAIP2MPNetworkServiceRequest.h
 *
 * 
 */

#ifndef OAIP2MPNetworkServiceRequest_H
#define OAIP2MPNetworkServiceRequest_H
...
class OAIP2MPNetworkServiceRequest : public OAIObject {
public:
    OAIP2MPNetworkServiceRequest();
    OAIP2MPNetworkServiceRequest(QString json);
    ~OAIP2MPNetworkServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceRequest)

#endif // OAIP2MPNetworkServiceRequest_H
