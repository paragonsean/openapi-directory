...
OAIPortUpdate::OAIPortUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPortUpdate::OAIPortUpdate() {
    this->initializeModel();
}

OAIPortUpdate::~OAIPortUpdate() {}

void OAIPortUpdate::initializeModel() {
...
void OAIPortUpdate::fromJson(QString jsonString) {
...
void OAIPortUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIPortUpdate::asJson() const {
...
QJsonObject OAIPortUpdate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPortUpdate::getBillingAccount() const {
    return m_billing_account;
}
void OAIPortUpdate::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIPortUpdate::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIPortUpdate::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIPortUpdate::getConnection() const {
    return m_connection;
}
void OAIPortUpdate::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIPortUpdate::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIPortUpdate::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIPortUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIPortUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIPortUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIPortUpdate::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIPortUpdate::getContractRef() const {
    return m_contract_ref;
}
void OAIPortUpdate::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIPortUpdate::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIPortUpdate::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIPortUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIPortUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIPortUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIPortUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIPortUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIPortUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIPortUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIPortUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIPortUpdate::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIPortUpdate::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIPortUpdate::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIPortUpdate::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIPortUpdate::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIPortUpdate::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIPortUpdate::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIPortUpdate::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

qint32 OAIPortUpdate::getSpeed() const {
    return m_speed;
}
void OAIPortUpdate::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIPortUpdate::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIPortUpdate::is_speed_Valid() const{
    return m_speed_isValid;
}

bool OAIPortUpdate::isSet() const {
...
bool OAIPortUpdate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_billing_account_isValid && m_consuming_account_isValid && m_managing_account_isValid && m_role_assignments_isValid && true;
}
