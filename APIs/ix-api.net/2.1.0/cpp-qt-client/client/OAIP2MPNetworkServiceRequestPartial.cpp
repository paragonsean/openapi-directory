...
#include "OAIP2MPNetworkServiceRequestPartial.h"
...
OAIP2MPNetworkServiceRequestPartial::OAIP2MPNetworkServiceRequestPartial(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2MPNetworkServiceRequestPartial::OAIP2MPNetworkServiceRequestPartial() {
    this->initializeModel();
}

OAIP2MPNetworkServiceRequestPartial::~OAIP2MPNetworkServiceRequestPartial() {}

void OAIP2MPNetworkServiceRequestPartial::initializeModel() {
...
void OAIP2MPNetworkServiceRequestPartial::fromJson(QString jsonString) {
...
void OAIP2MPNetworkServiceRequestPartial::fromJsonObject(QJsonObject json) {
...
QString OAIP2MPNetworkServiceRequestPartial::asJson() const {
...
QJsonObject OAIP2MPNetworkServiceRequestPartial::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2MPNetworkServiceRequestPartial::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2MPNetworkServiceRequestPartial::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2MPNetworkServiceRequestPartial::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getContractRef() const {
    return m_contract_ref;
}
void OAIP2MPNetworkServiceRequestPartial::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getExternalRef() const {
    return m_external_ref;
}
void OAIP2MPNetworkServiceRequestPartial::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2MPNetworkServiceRequestPartial::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getName() const {
    return m_name;
}
void OAIP2MPNetworkServiceRequestPartial::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_name_Set() const{
    return m_name_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getProductOffering() const {
    return m_product_offering;
}
void OAIP2MPNetworkServiceRequestPartial::setProductOffering(const QString &product_offering) {
    m_product_offering = product_offering;
    m_product_offering_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_product_offering_Set() const{
    return m_product_offering_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_product_offering_Valid() const{
    return m_product_offering_isValid;
}

bool OAIP2MPNetworkServiceRequestPartial::isRPublic() const {
    return m_r_public;
}
void OAIP2MPNetworkServiceRequestPartial::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2MPNetworkServiceRequestPartial::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QString OAIP2MPNetworkServiceRequestPartial::getType() const {
    return m_type;
}
void OAIP2MPNetworkServiceRequestPartial::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2MPNetworkServiceRequestPartial::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2MPNetworkServiceRequestPartial::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIP2MPNetworkServiceRequestPartial::isSet() const {
...
bool OAIP2MPNetworkServiceRequestPartial::isValid() const {
