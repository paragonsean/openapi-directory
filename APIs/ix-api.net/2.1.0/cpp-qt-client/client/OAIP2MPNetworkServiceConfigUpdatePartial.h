...
/*
 * OAIP2MPNetworkServiceConfigUpdatePartial.h
 *
 * P2MP Network Service Config Update
 */

#ifndef OAIP2MPNetworkServiceConfigUpdatePartial_H
#define OAIP2MPNetworkServiceConfigUpdatePartial_H
...
class OAIP2MPNetworkServiceConfigUpdatePartial : public OAIObject {
public:
    OAIP2MPNetworkServiceConfigUpdatePartial();
    OAIP2MPNetworkServiceConfigUpdatePartial(QString json);
    ~OAIP2MPNetworkServiceConfigUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServiceConfigUpdatePartial)

#endif // OAIP2MPNetworkServiceConfigUpdatePartial_H
