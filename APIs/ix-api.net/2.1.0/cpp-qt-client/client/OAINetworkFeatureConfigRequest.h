...
/*
 * OAINetworkFeatureConfigRequest.h
 *
 * Polymorphic Network Feature Config Request
 */

#ifndef OAINetworkFeatureConfigRequest_H
#define OAINetworkFeatureConfigRequest_H

#include <QJsonObject>

#include "OAIRouteServerNetworkFeatureConfigRequest.h"
#include <QList>
#include <QString>
...
class OAINetworkFeatureConfigRequest : public OAIObject {
public:
    OAINetworkFeatureConfigRequest();
    OAINetworkFeatureConfigRequest(QString json);
    ~OAINetworkFeatureConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkFeatureConfigRequest)

#endif // OAINetworkFeatureConfigRequest_H
