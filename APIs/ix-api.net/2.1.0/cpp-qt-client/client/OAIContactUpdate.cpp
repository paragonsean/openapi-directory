...
QString OAIContactUpdate::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIContactUpdate::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIContactUpdate::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIContactUpdate::is_consuming_account_Valid() const{
...
QString OAIContactUpdate::getExternalRef() const {
    return m_external_ref;
}
void OAIContactUpdate::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIContactUpdate::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIContactUpdate::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIContactUpdate::getManagingAccount() const {
    return m_managing_account;
}
void OAIContactUpdate::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIContactUpdate::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIContactUpdate::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QString OAIContactUpdate::getName() const {
    return m_name;
}
void OAIContactUpdate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIContactUpdate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIContactUpdate::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIContactUpdate::getTelephone() const {
    return m_telephone;
}
void OAIContactUpdate::setTelephone(const QString &telephone) {
    m_telephone = telephone;
    m_telephone_isSet = true;
}

bool OAIContactUpdate::is_telephone_Set() const{
    return m_telephone_isSet;
}

bool OAIContactUpdate::is_telephone_Valid() const{
