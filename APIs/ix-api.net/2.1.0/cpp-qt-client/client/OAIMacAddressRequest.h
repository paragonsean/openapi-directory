...
/*
 * OAIMacAddressRequest.h
 *
 * 
 */

#ifndef OAIMacAddressRequest_H
#define OAIMacAddressRequest_H
...
class OAIMacAddressRequest : public OAIObject {
public:
    OAIMacAddressRequest();
    OAIMacAddressRequest(QString json);
    ~OAIMacAddressRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMacAddressRequest)

#endif // OAIMacAddressRequest_H
