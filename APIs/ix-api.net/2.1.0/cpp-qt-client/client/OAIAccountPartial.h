...
#ifndef OAIAccountPartial_H
#define OAIAccountPartial_H
...
class OAIAccountPartial : public OAIObject {
public:
    OAIAccountPartial();
    OAIAccountPartial(QString json);
    ~OAIAccountPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountPartial)

#endif // OAIAccountPartial_H
