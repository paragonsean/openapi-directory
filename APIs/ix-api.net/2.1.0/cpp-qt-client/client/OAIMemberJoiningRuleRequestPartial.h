...
/*
 * OAIMemberJoiningRuleRequestPartial.h
 *
 * Polymorphic Member Joining Rule Request
 */

#ifndef OAIMemberJoiningRuleRequestPartial_H
#define OAIMemberJoiningRuleRequestPartial_H
...
class OAIMemberJoiningRuleRequestPartial : public OAIObject {
public:
    OAIMemberJoiningRuleRequestPartial();
    OAIMemberJoiningRuleRequestPartial(QString json);
    ~OAIMemberJoiningRuleRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberJoiningRuleRequestPartial)

#endif // OAIMemberJoiningRuleRequestPartial_H
