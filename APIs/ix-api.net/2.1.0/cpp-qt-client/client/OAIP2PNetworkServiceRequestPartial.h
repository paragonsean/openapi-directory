...
/*
 * OAIP2PNetworkServiceRequestPartial.h
 *
 * P2P Network Service Request
 */

#ifndef OAIP2PNetworkServiceRequestPartial_H
#define OAIP2PNetworkServiceRequestPartial_H
...
class OAIP2PNetworkServiceRequestPartial : public OAIObject {
public:
    OAIP2PNetworkServiceRequestPartial();
    OAIP2PNetworkServiceRequestPartial(QString json);
    ~OAIP2PNetworkServiceRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2PNetworkServiceRequestPartial)

#endif // OAIP2PNetworkServiceRequestPartial_H
