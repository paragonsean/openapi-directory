...
#ifndef OAIMacAddress_H
#define OAIMacAddress_H
...
class OAIMacAddress : public OAIObject {
public:
    OAIMacAddress();
    OAIMacAddress(QString json);
    ~OAIMacAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMacAddress)

#endif // OAIMacAddress_H
