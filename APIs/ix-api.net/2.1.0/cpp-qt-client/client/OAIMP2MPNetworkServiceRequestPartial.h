...
/*
 * OAIMP2MPNetworkServiceRequestPartial.h
 *
 * MP2MP Network Service Request
 */

#ifndef OAIMP2MPNetworkServiceRequestPartial_H
#define OAIMP2MPNetworkServiceRequestPartial_H
...
class OAIMP2MPNetworkServiceRequestPartial : public OAIObject {
public:
    OAIMP2MPNetworkServiceRequestPartial();
    OAIMP2MPNetworkServiceRequestPartial(QString json);
    ~OAIMP2MPNetworkServiceRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMP2MPNetworkServiceRequestPartial)

#endif // OAIMP2MPNetworkServiceRequestPartial_H
