...
/*
 * OAIDenyMemberJoiningRuleRequestPartial.h
 *
 * A new vlan member joining rule
 */

#ifndef OAIDenyMemberJoiningRuleRequestPartial_H
#define OAIDenyMemberJoiningRuleRequestPartial_H
...
class OAIDenyMemberJoiningRuleRequestPartial : public OAIObject {
public:
    OAIDenyMemberJoiningRuleRequestPartial();
    OAIDenyMemberJoiningRuleRequestPartial(QString json);
    ~OAIDenyMemberJoiningRuleRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDenyMemberJoiningRuleRequestPartial)

#endif // OAIDenyMemberJoiningRuleRequestPartial_H
