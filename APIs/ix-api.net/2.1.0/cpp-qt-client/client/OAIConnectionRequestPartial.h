...
/*
 * OAIConnectionRequestPartial.h
 *
 * Connection Request
 */

#ifndef OAIConnectionRequestPartial_H
#define OAIConnectionRequestPartial_H
...
class OAIConnectionRequestPartial : public OAIObject {
public:
    OAIConnectionRequestPartial();
    OAIConnectionRequestPartial(QString json);
    ~OAIConnectionRequestPartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionRequestPartial)

#endif // OAIConnectionRequestPartial_H
