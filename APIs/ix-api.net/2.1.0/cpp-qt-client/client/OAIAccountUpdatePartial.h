...
/*
 * OAIAccountUpdatePartial.h
 *
 * Account Update Request
 */

#ifndef OAIAccountUpdatePartial_H
#define OAIAccountUpdatePartial_H
...
class OAIAccountUpdatePartial : public OAIObject {
public:
    OAIAccountUpdatePartial();
    OAIAccountUpdatePartial(QString json);
    ~OAIAccountUpdatePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountUpdatePartial)

#endif // OAIAccountUpdatePartial_H
