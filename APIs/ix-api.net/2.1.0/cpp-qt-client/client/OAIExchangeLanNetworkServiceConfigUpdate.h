...
/*
 * OAIExchangeLanNetworkServiceConfigUpdate.h
 *
 * 
 */

#ifndef OAIExchangeLanNetworkServiceConfigUpdate_H
#define OAIExchangeLanNetworkServiceConfigUpdate_H
...
class OAIExchangeLanNetworkServiceConfigUpdate : public OAIObject {
public:
    OAIExchangeLanNetworkServiceConfigUpdate();
    OAIExchangeLanNetworkServiceConfigUpdate(QString json);
    ~OAIExchangeLanNetworkServiceConfigUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangeLanNetworkServiceConfigUpdate)

#endif // OAIExchangeLanNetworkServiceConfigUpdate_H
