...
#ifndef OAIConsumable_H
#define OAIConsumable_H
...
class OAIConsumable : public OAIObject {
public:
    OAIConsumable();
    OAIConsumable(QString json);
    ~OAIConsumable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsumable)

#endif // OAIConsumable_H
