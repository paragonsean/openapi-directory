...
#include "OAIP2PNetworkServiceConfig.h"
...
OAIP2PNetworkServiceConfig::OAIP2PNetworkServiceConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIP2PNetworkServiceConfig::OAIP2PNetworkServiceConfig() {
    this->initializeModel();
}

OAIP2PNetworkServiceConfig::~OAIP2PNetworkServiceConfig() {}

void OAIP2PNetworkServiceConfig::initializeModel() {
...
void OAIP2PNetworkServiceConfig::fromJson(QString jsonString) {
...
void OAIP2PNetworkServiceConfig::fromJsonObject(QJsonObject json) {
...
QString OAIP2PNetworkServiceConfig::asJson() const {
...
QJsonObject OAIP2PNetworkServiceConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIP2PNetworkServiceConfig::getBillingAccount() const {
    return m_billing_account;
}
void OAIP2PNetworkServiceConfig::setBillingAccount(const QString &billing_account) {
    m_billing_account = billing_account;
    m_billing_account_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_billing_account_Set() const{
    return m_billing_account_isSet;
}

bool OAIP2PNetworkServiceConfig::is_billing_account_Valid() const{
    return m_billing_account_isValid;
}

qint32 OAIP2PNetworkServiceConfig::getCapacity() const {
    return m_capacity;
}
void OAIP2PNetworkServiceConfig::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAIP2PNetworkServiceConfig::is_capacity_Valid() const{
    return m_capacity_isValid;
}

QDate OAIP2PNetworkServiceConfig::getChargedUntil() const {
    return m_charged_until;
}
void OAIP2PNetworkServiceConfig::setChargedUntil(const QDate &charged_until) {
    m_charged_until = charged_until;
    m_charged_until_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_charged_until_Set() const{
    return m_charged_until_isSet;
}

bool OAIP2PNetworkServiceConfig::is_charged_until_Valid() const{
    return m_charged_until_isValid;
}

QString OAIP2PNetworkServiceConfig::getConnection() const {
    return m_connection;
}
void OAIP2PNetworkServiceConfig::setConnection(const QString &connection) {
    m_connection = connection;
    m_connection_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_connection_Set() const{
    return m_connection_isSet;
}

bool OAIP2PNetworkServiceConfig::is_connection_Valid() const{
    return m_connection_isValid;
}

QString OAIP2PNetworkServiceConfig::getConsumingAccount() const {
    return m_consuming_account;
}
void OAIP2PNetworkServiceConfig::setConsumingAccount(const QString &consuming_account) {
    m_consuming_account = consuming_account;
    m_consuming_account_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_consuming_account_Set() const{
    return m_consuming_account_isSet;
}

bool OAIP2PNetworkServiceConfig::is_consuming_account_Valid() const{
    return m_consuming_account_isValid;
}

QString OAIP2PNetworkServiceConfig::getContractRef() const {
    return m_contract_ref;
}
void OAIP2PNetworkServiceConfig::setContractRef(const QString &contract_ref) {
    m_contract_ref = contract_ref;
    m_contract_ref_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_contract_ref_Set() const{
    return m_contract_ref_isSet;
}

bool OAIP2PNetworkServiceConfig::is_contract_ref_Valid() const{
    return m_contract_ref_isValid;
}

QDate OAIP2PNetworkServiceConfig::getDecommissionAt() const {
    return m_decommission_at;
}
void OAIP2PNetworkServiceConfig::setDecommissionAt(const QDate &decommission_at) {
    m_decommission_at = decommission_at;
    m_decommission_at_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_decommission_at_Set() const{
    return m_decommission_at_isSet;
}

bool OAIP2PNetworkServiceConfig::is_decommission_at_Valid() const{
    return m_decommission_at_isValid;
}

QString OAIP2PNetworkServiceConfig::getExternalRef() const {
    return m_external_ref;
}
void OAIP2PNetworkServiceConfig::setExternalRef(const QString &external_ref) {
    m_external_ref = external_ref;
    m_external_ref_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_external_ref_Set() const{
    return m_external_ref_isSet;
}

bool OAIP2PNetworkServiceConfig::is_external_ref_Valid() const{
    return m_external_ref_isValid;
}

QString OAIP2PNetworkServiceConfig::getId() const {
    return m_id;
}
void OAIP2PNetworkServiceConfig::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_id_Set() const{
    return m_id_isSet;
}

bool OAIP2PNetworkServiceConfig::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIP2PNetworkServiceConfig::getManagingAccount() const {
    return m_managing_account;
}
void OAIP2PNetworkServiceConfig::setManagingAccount(const QString &managing_account) {
    m_managing_account = managing_account;
    m_managing_account_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_managing_account_Set() const{
    return m_managing_account_isSet;
}

bool OAIP2PNetworkServiceConfig::is_managing_account_Valid() const{
    return m_managing_account_isValid;
}

QList<QString> OAIP2PNetworkServiceConfig::getNetworkFeatureConfigs() const {
    return m_network_feature_configs;
}
void OAIP2PNetworkServiceConfig::setNetworkFeatureConfigs(const QList<QString> &network_feature_configs) {
    m_network_feature_configs = network_feature_configs;
    m_network_feature_configs_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_network_feature_configs_Set() const{
    return m_network_feature_configs_isSet;
}

bool OAIP2PNetworkServiceConfig::is_network_feature_configs_Valid() const{
    return m_network_feature_configs_isValid;
}

QString OAIP2PNetworkServiceConfig::getNetworkService() const {
    return m_network_service;
}
void OAIP2PNetworkServiceConfig::setNetworkService(const QString &network_service) {
    m_network_service = network_service;
    m_network_service_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_network_service_Set() const{
    return m_network_service_isSet;
}

bool OAIP2PNetworkServiceConfig::is_network_service_Valid() const{
    return m_network_service_isValid;
}

QString OAIP2PNetworkServiceConfig::getPurchaseOrder() const {
    return m_purchase_order;
}
void OAIP2PNetworkServiceConfig::setPurchaseOrder(const QString &purchase_order) {
    m_purchase_order = purchase_order;
    m_purchase_order_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_purchase_order_Set() const{
    return m_purchase_order_isSet;
}

bool OAIP2PNetworkServiceConfig::is_purchase_order_Valid() const{
    return m_purchase_order_isValid;
}

QList<QString> OAIP2PNetworkServiceConfig::getRoleAssignments() const {
    return m_role_assignments;
}
void OAIP2PNetworkServiceConfig::setRoleAssignments(const QList<QString> &role_assignments) {
    m_role_assignments = role_assignments;
    m_role_assignments_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_role_assignments_Set() const{
    return m_role_assignments_isSet;
}

bool OAIP2PNetworkServiceConfig::is_role_assignments_Valid() const{
    return m_role_assignments_isValid;
}

QString OAIP2PNetworkServiceConfig::getState() const {
    return m_state;
}
void OAIP2PNetworkServiceConfig::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_state_Set() const{
    return m_state_isSet;
}

bool OAIP2PNetworkServiceConfig::is_state_Valid() const{
    return m_state_isValid;
}

QList<OAIStatus> OAIP2PNetworkServiceConfig::getStatus() const {
    return m_status;
}
void OAIP2PNetworkServiceConfig::setStatus(const QList<OAIStatus> &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_status_Set() const{
    return m_status_isSet;
}

bool OAIP2PNetworkServiceConfig::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIP2PNetworkServiceConfig::getType() const {
    return m_type;
}
void OAIP2PNetworkServiceConfig::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_type_Set() const{
    return m_type_isSet;
}

bool OAIP2PNetworkServiceConfig::is_type_Valid() const{
    return m_type_isValid;
}

OAIVlanConfig OAIP2PNetworkServiceConfig::getVlanConfig() const {
    return m_vlan_config;
}
void OAIP2PNetworkServiceConfig::setVlanConfig(const OAIVlanConfig &vlan_config) {
    m_vlan_config = vlan_config;
    m_vlan_config_isSet = true;
}

bool OAIP2PNetworkServiceConfig::is_vlan_config_Set() const{
    return m_vlan_config_isSet;
}

bool OAIP2PNetworkServiceConfig::is_vlan_config_Valid() const{
    return m_vlan_config_isValid;
}

bool OAIP2PNetworkServiceConfig::isSet() const {
...
bool OAIP2PNetworkServiceConfig::isValid() const {
