...
/*
 * OAIRouteServerNetworkFeatureConfig.h
 *
 * 
 */

#ifndef OAIRouteServerNetworkFeatureConfig_H
#define OAIRouteServerNetworkFeatureConfig_H
...
class OAIRouteServerNetworkFeatureConfig : public OAIObject {
public:
    OAIRouteServerNetworkFeatureConfig();
    OAIRouteServerNetworkFeatureConfig(QString json);
    ~OAIRouteServerNetworkFeatureConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteServerNetworkFeatureConfig)

#endif // OAIRouteServerNetworkFeatureConfig_H
