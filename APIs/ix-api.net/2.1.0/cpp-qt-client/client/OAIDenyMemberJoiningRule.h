...
/*
 * OAIDenyMemberJoiningRule.h
 *
 * 
 */

#ifndef OAIDenyMemberJoiningRule_H
#define OAIDenyMemberJoiningRule_H
...
class OAIDenyMemberJoiningRule : public OAIObject {
public:
    OAIDenyMemberJoiningRule();
    OAIDenyMemberJoiningRule(QString json);
    ~OAIDenyMemberJoiningRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDenyMemberJoiningRule)

#endif // OAIDenyMemberJoiningRule_H
