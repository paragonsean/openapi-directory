...
/*
 * OAIP2MPNetworkServicePartial.h
 *
 * P2MP Network Service
 */

#ifndef OAIP2MPNetworkServicePartial_H
#define OAIP2MPNetworkServicePartial_H
...
class OAIP2MPNetworkServicePartial : public OAIObject {
public:
    OAIP2MPNetworkServicePartial();
    OAIP2MPNetworkServicePartial(QString json);
    ~OAIP2MPNetworkServicePartial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIP2MPNetworkServicePartial)

#endif // OAIP2MPNetworkServicePartial_H
