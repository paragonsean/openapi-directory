...
/**
 * The MP2MPNetworkServiceConfig model module.
 * @module model/MP2MPNetworkServiceConfig
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfig {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfig</code>.
     * @alias module:model/MP2MPNetworkServiceConfig
     * @implements module:model/MP2MPNetworkServiceConfigPartial
     ...
     * @param state {module:model/MP2MPNetworkServiceConfig.StateEnum} 
     * @param type {String} 
    ...
    constructor(billingAccount, connection, consumingAccount, id, managingAccount, networkService, roleAssignments, state, type, vlanConfig) { 
        ...
        MP2MPNetworkServiceConfig.initialize(this, billingAccount, connection, consumingAccount, id, managingAccount, networkService, roleAssignments, state, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfig} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfig} The populated <code>MP2MPNetworkServiceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfig();
            MP2MPNetworkServiceConfigPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfig.RequiredProperties) {
...
MP2MPNetworkServiceConfig.RequiredProperties = ["billing_account", "connection", "consuming_account", "id", "managing_account", "network_service", "role_assignments", "state", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfig.prototype['billing_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfig.prototype['capacity'] = undefined;
 ...
 */
MP2MPNetworkServiceConfig.prototype['charged_until'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfig.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfig.prototype['consuming_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfig.prototype['contract_ref'] = undefined;
 ...
 */
MP2MPNetworkServiceConfig.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfig.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
MP2MPNetworkServiceConfig.prototype['id'] = undefined;

/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfig.prototype['macs'] = undefined;
 ...
 */
MP2MPNetworkServiceConfig.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfig.prototype['network_feature_configs'] = undefined;

/**
 * The id of the configured network service.
 * @member {String} network_service
 */
MP2MPNetworkServiceConfig.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
MP2MPNetworkServiceConfig.prototype['purchase_order'] = '';
 ...
 */
MP2MPNetworkServiceConfig.prototype['role_assignments'] = undefined;

/**
 * @member {module:model/MP2MPNetworkServiceConfig.StateEnum} state
 */
MP2MPNetworkServiceConfig.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
MP2MPNetworkServiceConfig.prototype['status'] = undefined;

/**
 * @member {String} type
 */
MP2MPNetworkServiceConfig.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfig.prototype['vlan_config'] = undefined;


// Implement MP2MPNetworkServiceConfigPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
 ...
 * @readonly
 */
MP2MPNetworkServiceConfig['StateEnum'] = {
...
export default MP2MPNetworkServiceConfig;
