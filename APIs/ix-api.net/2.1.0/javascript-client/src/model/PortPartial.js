...
/**
 * The PortPartial model module.
 * @module model/PortPartial
 * @version 2.1.0
 */
class PortPartial {
    /**
     * Constructs a new <code>PortPartial</code>.
     * Port
     * @alias module:model/PortPartial
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PortPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortPartial} obj Optional instance to populate.
     * @return {module:model/PortPartial} The populated <code>PortPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>PortPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortPartial</code>.
     */
