...
/**
 * The CloudNetworkServiceConfigPartial model module.
 * @module model/CloudNetworkServiceConfigPartial
 * @version 2.1.0
 */
class CloudNetworkServiceConfigPartial {
    /**
     * Constructs a new <code>CloudNetworkServiceConfigPartial</code>.
     * Cloud Network Service Config
     * @alias module:model/CloudNetworkServiceConfigPartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>CloudNetworkServiceConfigPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkServiceConfigPartial} obj Optional instance to populate.
     * @return {module:model/CloudNetworkServiceConfigPartial} The populated <code>CloudNetworkServiceConfigPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkServiceConfigPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkServiceConfigPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkServiceConfigPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkServiceConfigPartial.RequiredProperties) {
...
CloudNetworkServiceConfigPartial.RequiredProperties = ["type"];
 ...
 * @readonly
 */
CloudNetworkServiceConfigPartial['StateEnum'] = {
...
export default CloudNetworkServiceConfigPartial;
