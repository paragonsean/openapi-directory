...
/**
 * The P2PNetworkServiceConfigRequestPartial model module.
 * @module model/P2PNetworkServiceConfigRequestPartial
 * @version 2.1.0
 */
class P2PNetworkServiceConfigRequestPartial {
    /**
     * Constructs a new <code>P2PNetworkServiceConfigRequestPartial</code>.
     * P2P Network Service Config Request
     * @alias module:model/P2PNetworkServiceConfigRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        P2PNetworkServiceConfigRequestPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>P2PNetworkServiceConfigRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2PNetworkServiceConfigRequestPartial} obj Optional instance to populate.
     * @return {module:model/P2PNetworkServiceConfigRequestPartial} The populated <code>P2PNetworkServiceConfigRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2PNetworkServiceConfigRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>P2PNetworkServiceConfigRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2PNetworkServiceConfigRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2PNetworkServiceConfigRequestPartial.RequiredProperties) {
...
P2PNetworkServiceConfigRequestPartial.RequiredProperties = ["type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfigRequestPartial.prototype['billing_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequestPartial.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfigRequestPartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfigRequestPartial.prototype['consuming_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequestPartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfigRequestPartial.prototype['external_ref'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequestPartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfigRequestPartial.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
P2PNetworkServiceConfigRequestPartial.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
P2PNetworkServiceConfigRequestPartial.prototype['purchase_order'] = '';
 ...
 */
P2PNetworkServiceConfigRequestPartial.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2PNetworkServiceConfigRequestPartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfigRequestPartial.prototype['vlan_config'] = undefined;
...
export default P2PNetworkServiceConfigRequestPartial;
