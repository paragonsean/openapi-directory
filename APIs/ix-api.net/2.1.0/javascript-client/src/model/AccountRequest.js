...
import AccountRequestPartial from './AccountRequestPartial';
...
class AccountRequest {
     ...
     * @implements module:model/AccountRequestPartial
    ...
    constructor(address, name) { 
        ...
        AccountRequest.initialize(this, address, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            AccountRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountRequest.RequiredProperties) {
...
AccountRequest.RequiredProperties = ["address", "name"];

/**
 * @member {module:model/Address} address
 */
AccountRequest.prototype['address'] = undefined;

/**
 * @member {module:model/BillingInformation} billing_information
 */
AccountRequest.prototype['billing_information'] = undefined;
 ...
 */
AccountRequest.prototype['metro_area_network_presence'] = undefined;

/**
 * Name of the account, how it gets represented in e.g. a \"customers list\". 
 * @member {String} name
 */
AccountRequest.prototype['name'] = undefined;


// Implement AccountRequestPartial interface:
/**
 * @member {module:model/Address} address
 */
