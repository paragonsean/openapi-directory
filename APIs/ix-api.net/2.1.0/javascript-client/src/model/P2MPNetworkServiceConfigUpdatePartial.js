...
/**
 * The P2MPNetworkServiceConfigUpdatePartial model module.
 * @module model/P2MPNetworkServiceConfigUpdatePartial
 * @version 2.1.0
 */
class P2MPNetworkServiceConfigUpdatePartial {
    /**
     * Constructs a new <code>P2MPNetworkServiceConfigUpdatePartial</code>.
     * P2MP Network Service Config Update
     * @alias module:model/P2MPNetworkServiceConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>P2MPNetworkServiceConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2MPNetworkServiceConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/P2MPNetworkServiceConfigUpdatePartial} The populated <code>P2MPNetworkServiceConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2MPNetworkServiceConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>P2MPNetworkServiceConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2MPNetworkServiceConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2MPNetworkServiceConfigUpdatePartial.RequiredProperties) {
...
P2MPNetworkServiceConfigUpdatePartial.RequiredProperties = ["type"];
 ...
 * @readonly
 */
P2MPNetworkServiceConfigUpdatePartial['RoleEnum'] = {
...
export default P2MPNetworkServiceConfigUpdatePartial;
