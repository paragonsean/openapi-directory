...
/**
 * The DenyMemberJoiningRuleUpdatePartial model module.
 * @module model/DenyMemberJoiningRuleUpdatePartial
 * @version 2.1.0
 */
class DenyMemberJoiningRuleUpdatePartial {
    /**
     * Constructs a new <code>DenyMemberJoiningRuleUpdatePartial</code>.
     * A vlan member joining rule update
     * @alias module:model/DenyMemberJoiningRuleUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>DenyMemberJoiningRuleUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DenyMemberJoiningRuleUpdatePartial} obj Optional instance to populate.
     * @return {module:model/DenyMemberJoiningRuleUpdatePartial} The populated <code>DenyMemberJoiningRuleUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DenyMemberJoiningRuleUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>DenyMemberJoiningRuleUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DenyMemberJoiningRuleUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DenyMemberJoiningRuleUpdatePartial.RequiredProperties) {
...
DenyMemberJoiningRuleUpdatePartial.RequiredProperties = ["type"];
...
export default DenyMemberJoiningRuleUpdatePartial;
