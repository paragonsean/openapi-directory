...
/**
 * The CloudNetworkServiceConfigRequest model module.
 * @module model/CloudNetworkServiceConfigRequest
 * @version 2.1.0
 */
class CloudNetworkServiceConfigRequest {
    /**
     * Constructs a new <code>CloudNetworkServiceConfigRequest</code>.
     * @alias module:model/CloudNetworkServiceConfigRequest
     * @implements module:model/CloudNetworkServiceConfigRequestPartial
     ...
     */
    constructor(billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
        CloudNetworkServiceConfigRequestPartial.initialize(this, type);
        CloudNetworkServiceConfigRequest.initialize(this, billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, networkService, roleAssignments, type, vlanConfig);
    }
     ...
     */
    static initialize(obj, billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
    ...
    /**
     * Constructs a <code>CloudNetworkServiceConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkServiceConfigRequest} obj Optional instance to populate.
     * @return {module:model/CloudNetworkServiceConfigRequest} The populated <code>CloudNetworkServiceConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkServiceConfigRequest();
            CloudNetworkServiceConfigRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkServiceConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkServiceConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkServiceConfigRequest.RequiredProperties) {
...
CloudNetworkServiceConfigRequest.RequiredProperties = ["billing_account", "cloud_vlan", "connection", "consuming_account", "handover", "managing_account", "network_service", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
CloudNetworkServiceConfigRequest.prototype['billing_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigRequest.prototype['cloud_vlan'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
CloudNetworkServiceConfigRequest.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
CloudNetworkServiceConfigRequest.prototype['consuming_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
CloudNetworkServiceConfigRequest.prototype['external_ref'] = undefined;
 ...
 */
CloudNetworkServiceConfigRequest.prototype['handover'] = undefined;
 ...
 */
CloudNetworkServiceConfigRequest.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
CloudNetworkServiceConfigRequest.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
CloudNetworkServiceConfigRequest.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
CloudNetworkServiceConfigRequest.prototype['purchase_order'] = '';
 ...
 */
CloudNetworkServiceConfigRequest.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
CloudNetworkServiceConfigRequest.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
CloudNetworkServiceConfigRequest.prototype['vlan_config'] = undefined;


// Implement CloudNetworkServiceConfigRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default CloudNetworkServiceConfigRequest;
