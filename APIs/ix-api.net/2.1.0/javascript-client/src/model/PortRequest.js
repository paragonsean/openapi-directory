...
import PortRequestPartial from './PortRequestPartial';

/**
 * The PortRequest model module.
 * @module model/PortRequest
 * @version 2.1.0
 */
class PortRequest {
    /**
     * Constructs a new <code>PortRequest</code>.
     * @alias module:model/PortRequest
     * @implements module:model/PortRequestPartial
     ...
     * @param mediaType {String} The media type of the interface. See the device's capabilities to see what types are available. 
     ...
     */
    constructor(billingAccount, consumingAccount, managingAccount, mediaType, pop, roleAssignments) { 
        PortRequestPartial.initialize(this);
        PortRequest.initialize(this, billingAccount, consumingAccount, managingAccount, mediaType, pop, roleAssignments);
    }
     ...
     */
    static initialize(obj, billingAccount, consumingAccount, managingAccount, mediaType, pop, roleAssignments) { 
    ...
    /**
     * Constructs a <code>PortRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortRequest} obj Optional instance to populate.
     * @return {module:model/PortRequest} The populated <code>PortRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortRequest();
            PortRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PortRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PortRequest.RequiredProperties) {
...
PortRequest.RequiredProperties = ["billing_account", "consuming_account", "managing_account", "media_type", "pop", "role_assignments"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
PortRequest.prototype['billing_account'] = undefined;

/**
 * @member {String} connection
 */
PortRequest.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
PortRequest.prototype['consuming_account'] = undefined;
 ...
 */
PortRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
PortRequest.prototype['external_ref'] = undefined;
 ...
 * @default ''
 */
PortRequest.prototype['purchase_order'] = '';
 ...
 */
PortRequest.prototype['role_assignments'] = undefined;

/**
 * @member {Number} speed
 */
PortRequest.prototype['speed'] = undefined;


// Implement PortRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
