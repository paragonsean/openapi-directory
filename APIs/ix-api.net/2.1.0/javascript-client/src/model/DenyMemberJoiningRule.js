...
/**
 * The DenyMemberJoiningRule model module.
 * @module model/DenyMemberJoiningRule
 * @version 2.1.0
 */
class DenyMemberJoiningRule {
    /**
     * Constructs a new <code>DenyMemberJoiningRule</code>.
     * @alias module:model/DenyMemberJoiningRule
     * @implements module:model/DenyMemberJoiningRulePartial
    ...
    constructor(consumingAccount, id, managingAccount, networkService, type) { 
        DenyMemberJoiningRulePartial.initialize(this, type);
        DenyMemberJoiningRule.initialize(this, consumingAccount, id, managingAccount, networkService, type);
    }
    ...
    /**
     * Constructs a <code>DenyMemberJoiningRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DenyMemberJoiningRule} obj Optional instance to populate.
     * @return {module:model/DenyMemberJoiningRule} The populated <code>DenyMemberJoiningRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DenyMemberJoiningRule();
            DenyMemberJoiningRulePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DenyMemberJoiningRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DenyMemberJoiningRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DenyMemberJoiningRule.RequiredProperties) {
...
DenyMemberJoiningRule.RequiredProperties = ["consuming_account", "id", "managing_account", "network_service", "type"];

/**
 * The `id` of the account to which access to the network service should be granted or denied. 
 * @member {String} consuming_account
 */
DenyMemberJoiningRule.prototype['consuming_account'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
DenyMemberJoiningRule.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
DenyMemberJoiningRule.prototype['id'] = undefined;
 ...
 */
DenyMemberJoiningRule.prototype['managing_account'] = undefined;

/**
 * @member {String} network_service
 */
DenyMemberJoiningRule.prototype['network_service'] = undefined;

/**
 * @member {String} type
 */
DenyMemberJoiningRule.prototype['type'] = undefined;


// Implement DenyMemberJoiningRulePartial interface:
/**
 * The `id` of the account to which access to the network service should be granted or denied. 
 * @member {String} consuming_account
 */
DenyMemberJoiningRulePartial.prototype['consuming_account'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
DenyMemberJoiningRulePartial.prototype['external_ref'] = undefined;
/**
 * @member {String} id
 */
DenyMemberJoiningRulePartial.prototype['id'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
DenyMemberJoiningRulePartial.prototype['managing_account'] = undefined;
/**
 * @member {String} network_service
 */
DenyMemberJoiningRulePartial.prototype['network_service'] = undefined;
/**
 * @member {String} type
 */
DenyMemberJoiningRulePartial.prototype['type'] = undefined;




export default DenyMemberJoiningRule;
