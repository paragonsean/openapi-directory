...
/**
 * The P2PNetworkServiceConfigUpdatePartial model module.
 * @module model/P2PNetworkServiceConfigUpdatePartial
 * @version 2.1.0
 */
class P2PNetworkServiceConfigUpdatePartial {
    /**
     * Constructs a new <code>P2PNetworkServiceConfigUpdatePartial</code>.
     * P2P Network Service Config Update
     * @alias module:model/P2PNetworkServiceConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
        
        P2PNetworkServiceConfigUpdatePartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>P2PNetworkServiceConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2PNetworkServiceConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/P2PNetworkServiceConfigUpdatePartial} The populated <code>P2PNetworkServiceConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2PNetworkServiceConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>P2PNetworkServiceConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2PNetworkServiceConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2PNetworkServiceConfigUpdatePartial.RequiredProperties) {
...
P2PNetworkServiceConfigUpdatePartial.RequiredProperties = ["type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfigUpdatePartial.prototype['billing_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdatePartial.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfigUpdatePartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfigUpdatePartial.prototype['consuming_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdatePartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfigUpdatePartial.prototype['external_ref'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdatePartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfigUpdatePartial.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
P2PNetworkServiceConfigUpdatePartial.prototype['purchase_order'] = '';
 ...
 */
P2PNetworkServiceConfigUpdatePartial.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2PNetworkServiceConfigUpdatePartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfigUpdatePartial.prototype['vlan_config'] = undefined;
...
export default P2PNetworkServiceConfigUpdatePartial;
