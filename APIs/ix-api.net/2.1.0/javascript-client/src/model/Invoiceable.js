...
import InvoiceablePartial from './InvoiceablePartial';

/**
 * The Invoiceable model module.
 * @module model/Invoiceable
 * @version 2.1.0
 */
class Invoiceable {
    /**
     * Constructs a new <code>Invoiceable</code>.
     * @alias module:model/Invoiceable
     * @implements module:model/InvoiceablePartial
    ...
    constructor(billingAccount) { 
        ...
        Invoiceable.initialize(this, billingAccount);
    }
     ...
     */
    static initialize(obj, billingAccount) { 
        obj['billing_account'] = billingAccount;
        obj['purchase_order'] = '';
    }

    /**
     * Constructs a <code>Invoiceable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Invoiceable} obj Optional instance to populate.
     * @return {module:model/Invoiceable} The populated <code>Invoiceable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Invoiceable();
            InvoiceablePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>Invoiceable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Invoiceable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Invoiceable.RequiredProperties) {
 ...
 */
Invoiceable.prototype['contract_ref'] = undefined;
 ...
 * @default ''
 */
Invoiceable.prototype['purchase_order'] = '';


// Implement InvoiceablePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
