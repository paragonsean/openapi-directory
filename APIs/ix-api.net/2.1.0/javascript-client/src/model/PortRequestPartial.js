...
/**
 * The PortRequestPartial model module.
 * @module model/PortRequestPartial
 * @version 2.1.0
 */
class PortRequestPartial {
    /**
     * Constructs a new <code>PortRequestPartial</code>.
     * Port Request
     * @alias module:model/PortRequestPartial
     */
    constructor() { 
        
        PortRequestPartial.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortRequestPartial} obj Optional instance to populate.
     * @return {module:model/PortRequestPartial} The populated <code>PortRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>PortRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortRequestPartial</code>.
     */
 ...
 */
PortRequestPartial.prototype['billing_account'] = undefined;

/**
 * @member {String} connection
 */
PortRequestPartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
PortRequestPartial.prototype['consuming_account'] = undefined;
 ...
 */
PortRequestPartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
PortRequestPartial.prototype['external_ref'] = undefined;
 ...
 */
PortRequestPartial.prototype['managing_account'] = undefined;

/**
 * The media type of the interface. See the device's capabilities to see what types are available. 
 * @member {String} media_type
 */
PortRequestPartial.prototype['media_type'] = undefined;

/**
 * Same as the `pop` of the `device`. 
 * @member {String} pop
 */
PortRequestPartial.prototype['pop'] = undefined;
 ...
 * @default ''
 */
PortRequestPartial.prototype['purchase_order'] = '';
 ...
 */
PortRequestPartial.prototype['role_assignments'] = undefined;

/**
 * @member {Number} speed
 */
PortRequestPartial.prototype['speed'] = undefined;
...
export default PortRequestPartial;
