...
/**
 * The AllowMemberJoiningRulePartial model module.
 * @module model/AllowMemberJoiningRulePartial
 * @version 2.1.0
 */
class AllowMemberJoiningRulePartial {
    /**
     * Constructs a new <code>AllowMemberJoiningRulePartial</code>.
     * A rule for members joining a private vlan
     * @alias module:model/AllowMemberJoiningRulePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>AllowMemberJoiningRulePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllowMemberJoiningRulePartial} obj Optional instance to populate.
     * @return {module:model/AllowMemberJoiningRulePartial} The populated <code>AllowMemberJoiningRulePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllowMemberJoiningRulePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>AllowMemberJoiningRulePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllowMemberJoiningRulePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllowMemberJoiningRulePartial.RequiredProperties) {
...
AllowMemberJoiningRulePartial.RequiredProperties = ["type"];
...
export default AllowMemberJoiningRulePartial;
