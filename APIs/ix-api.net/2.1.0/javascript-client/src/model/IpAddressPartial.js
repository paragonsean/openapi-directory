...
/**
 * The IpAddressPartial model module.
 * @module model/IpAddressPartial
 * @version 2.1.0
 */
class IpAddressPartial {
    /**
     * Constructs a new <code>IpAddressPartial</code>.
     * IP-Address
     * @alias module:model/IpAddressPartial
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>IpAddressPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpAddressPartial} obj Optional instance to populate.
     * @return {module:model/IpAddressPartial} The populated <code>IpAddressPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpAddressPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>IpAddressPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpAddressPartial</code>.
     */
...
export default IpAddressPartial;
