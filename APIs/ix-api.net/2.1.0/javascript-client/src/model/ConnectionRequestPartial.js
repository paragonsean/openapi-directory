...
/**
 * The ConnectionRequestPartial model module.
 * @module model/ConnectionRequestPartial
 * @version 2.1.0
 */
class ConnectionRequestPartial {
    /**
     * Constructs a new <code>ConnectionRequestPartial</code>.
     * Connection Request
     * @alias module:model/ConnectionRequestPartial
     */
    constructor() { 
        
        ConnectionRequestPartial.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConnectionRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectionRequestPartial} obj Optional instance to populate.
     * @return {module:model/ConnectionRequestPartial} The populated <code>ConnectionRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectionRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectionRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectionRequestPartial</code>.
     */
 ...
 */
ConnectionRequestPartial.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ConnectionRequestPartial.prototype['consuming_account'] = undefined;
 ...
 */
ConnectionRequestPartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ConnectionRequestPartial.prototype['external_ref'] = undefined;

/**
 * This sets the LACP Timeout mode. Both ends of the connections need to be configured the same. 
 * @member {module:model/ConnectionRequestPartial.LacpTimeoutEnum} lacp_timeout
 */
ConnectionRequestPartial.prototype['lacp_timeout'] = undefined;
 ...
 */
ConnectionRequestPartial.prototype['managing_account'] = undefined;
 ...
 * @member {module:model/ConnectionRequestPartial.ModeEnum} mode
 */
ConnectionRequestPartial.prototype['mode'] = undefined;
 ...
 * @default ''
 */
ConnectionRequestPartial.prototype['purchase_order'] = '';
 ...
 */
ConnectionRequestPartial.prototype['role_assignments'] = undefined;

/**
 * Shows the total bandwidth of the connection in Mbit/s. 
 * @member {Number} speed
 */
ConnectionRequestPartial.prototype['speed'] = undefined;
 ...
 * @readonly
 */
ConnectionRequestPartial['LacpTimeoutEnum'] = {
 ...
 * @readonly
 */
ConnectionRequestPartial['ModeEnum'] = {
...
export default ConnectionRequestPartial;
