...
/**
 * The RouteServerNetworkFeatureConfigRequest model module.
 * @module model/RouteServerNetworkFeatureConfigRequest
 * @version 2.1.0
 */
class RouteServerNetworkFeatureConfigRequest {
    /**
     * Constructs a new <code>RouteServerNetworkFeatureConfigRequest</code>.
     * @alias module:model/RouteServerNetworkFeatureConfigRequest
     * @implements module:model/RouteServerNetworkFeatureConfigRequestPartial
     * @param asn {Number} The ASN of the peer. 
     * @param bgpSessionType {module:model/RouteServerNetworkFeatureConfigRequest.BgpSessionTypeEnum} The session type describes which of the both parties will open the connection. If set to passive, the customer router needs to open the connection. If its set to active, the route server will open the connection. The standard behavior on most exchanges is passive. 
     ...
     * @param networkFeature {String} 
     * @param networkServiceConfig {String} 
     ...
     * @param sessionMode {module:model/RouteServerNetworkFeatureConfigRequest.SessionModeEnum} Set the session mode with the routeserver. 
     * @param type {String} 
     */
    constructor(asn, bgpSessionType, billingAccount, consumingAccount, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, type) { 
        RouteServerNetworkFeatureConfigRequestPartial.initialize(this, type);
        RouteServerNetworkFeatureConfigRequest.initialize(this, asn, bgpSessionType, billingAccount, consumingAccount, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, type);
    }
     ...
     */
    static initialize(obj, asn, bgpSessionType, billingAccount, consumingAccount, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, type) { 
        obj['asn'] = asn;
        ...
        obj['network_feature'] = networkFeature;
        obj['network_service_config'] = networkServiceConfig;
        obj['password'] = '';
        obj['purchase_order'] = '';
    ...
    /**
     * Constructs a <code>RouteServerNetworkFeatureConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteServerNetworkFeatureConfigRequest} obj Optional instance to populate.
     * @return {module:model/RouteServerNetworkFeatureConfigRequest} The populated <code>RouteServerNetworkFeatureConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteServerNetworkFeatureConfigRequest();
            RouteServerNetworkFeatureConfigRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RouteServerNetworkFeatureConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RouteServerNetworkFeatureConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RouteServerNetworkFeatureConfigRequest.RequiredProperties) {
...
RouteServerNetworkFeatureConfigRequest.RequiredProperties = ["asn", "bgp_session_type", "billing_account", "consuming_account", "ip", "managing_account", "network_feature", "network_service_config", "role_assignments", "session_mode", "type"];
 ...
 */
RouteServerNetworkFeatureConfigRequest.prototype['as_set_v4'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfigRequest.prototype['as_set_v6'] = undefined;

/**
 * The ASN of the peer. 
 * @member {Number} asn
 */
RouteServerNetworkFeatureConfigRequest.prototype['asn'] = undefined;
 ...
 * @member {module:model/RouteServerNetworkFeatureConfigRequest.BgpSessionTypeEnum} bgp_session_type
 */
RouteServerNetworkFeatureConfigRequest.prototype['bgp_session_type'] = undefined;

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
RouteServerNetworkFeatureConfigRequest.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
RouteServerNetworkFeatureConfigRequest.prototype['consuming_account'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfigRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
RouteServerNetworkFeatureConfigRequest.prototype['external_ref'] = undefined;
 ...
 * @default true
 */
RouteServerNetworkFeatureConfigRequest.prototype['insert_ixp_asn'] = true;
 ...
 * @member {String} ip
 */
RouteServerNetworkFeatureConfigRequest.prototype['ip'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfigRequest.prototype['managing_account'] = undefined;

/**
 * Announcing more than `max_prefix` IPv4 prefixes the bgp session will be droped. 
 * @member {Number} max_prefix_v4
 */
RouteServerNetworkFeatureConfigRequest.prototype['max_prefix_v4'] = undefined;

/**
 * Announcing more than `max_prefix` IPv6 prefixes the bgp session will be droped. 
 * @member {Number} max_prefix_v6
 */
RouteServerNetworkFeatureConfigRequest.prototype['max_prefix_v6'] = undefined;

/**
 * @member {String} network_feature
 */
RouteServerNetworkFeatureConfigRequest.prototype['network_feature'] = undefined;

/**
 * @member {String} network_service_config
 */
RouteServerNetworkFeatureConfigRequest.prototype['network_service_config'] = undefined;
 ...
 * @default ''
 */
RouteServerNetworkFeatureConfigRequest.prototype['password'] = '';
 ...
 * @default ''
 */
RouteServerNetworkFeatureConfigRequest.prototype['purchase_order'] = '';
 ...
 */
RouteServerNetworkFeatureConfigRequest.prototype['role_assignments'] = undefined;

/**
 * Set the session mode with the routeserver. 
 * @member {module:model/RouteServerNetworkFeatureConfigRequest.SessionModeEnum} session_mode
 */
RouteServerNetworkFeatureConfigRequest.prototype['session_mode'] = undefined;

/**
 * @member {String} type
 */
RouteServerNetworkFeatureConfigRequest.prototype['type'] = undefined;


// Implement RouteServerNetworkFeatureConfigRequestPartial interface:
/**
 * AS-SET of the customer for IPv4 prefix filtering. This is used to generate filters on the router servers.  Only valid referenced prefixes within the AS-SET are allowed inbound to the route server. All other routes are filtered.  This field is *required* if the route server network feature only supports the `af_inet` address family. If multiple address families are supported, it is optional if the `as_set_v6` is provided.  Important: The format has to be: \"AS-SET@IRR\". IRR is the database where the AS-SET is registred. Typically used IRR's are RADB, RIPE, NTTCOM, APNIC, ALTDB, LEVEL3, ARIN, AFRINIC, LACNIC 
 * @member {String} as_set_v4
 */
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfigRequest['BgpSessionTypeEnum'] = {
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfigRequest['SessionModeEnum'] = {
...
export default RouteServerNetworkFeatureConfigRequest;
