...
/**
 * The ExchangeLanNetworkServiceConfig model module.
 * @module model/ExchangeLanNetworkServiceConfig
 * @version 2.1.0
 */
class ExchangeLanNetworkServiceConfig {
    /**
     * Constructs a new <code>ExchangeLanNetworkServiceConfig</code>.
     * @alias module:model/ExchangeLanNetworkServiceConfig
     * @implements module:model/ExchangeLanNetworkServiceConfigPartial
     ...
     * @param state {module:model/ExchangeLanNetworkServiceConfig.StateEnum} 
     * @param type {String} 
     * @param vlanConfig {module:model/VlanConfig} 
     */
    constructor(asns, billingAccount, connection, consumingAccount, id, listed, managingAccount, networkService, productOffering, roleAssignments, state, type, vlanConfig) { 
        ExchangeLanNetworkServiceConfigPartial.initialize(this, type);
        ExchangeLanNetworkServiceConfig.initialize(this, asns, billingAccount, connection, consumingAccount, id, listed, managingAccount, networkService, productOffering, roleAssignments, state, type, vlanConfig);
    }
     ...
     */
    static initialize(obj, asns, billingAccount, connection, consumingAccount, id, listed, managingAccount, networkService, productOffering, roleAssignments, state, type, vlanConfig) { 
        obj['asns'] = asns;
    ...
    /**
     * Constructs a <code>ExchangeLanNetworkServiceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeLanNetworkServiceConfig} obj Optional instance to populate.
     * @return {module:model/ExchangeLanNetworkServiceConfig} The populated <code>ExchangeLanNetworkServiceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeLanNetworkServiceConfig();
            ExchangeLanNetworkServiceConfigPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeLanNetworkServiceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeLanNetworkServiceConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExchangeLanNetworkServiceConfig.RequiredProperties) {
...
ExchangeLanNetworkServiceConfig.RequiredProperties = ["asns", "billing_account", "connection", "consuming_account", "id", "listed", "managing_account", "network_service", "product_offering", "role_assignments", "state", "type", "vlan_config"];

/**
 * @member {Array.<Number>} asns
 */
ExchangeLanNetworkServiceConfig.prototype['asns'] = undefined;

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ExchangeLanNetworkServiceConfig.prototype['billing_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['capacity'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['charged_until'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
ExchangeLanNetworkServiceConfig.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ExchangeLanNetworkServiceConfig.prototype['consuming_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['contract_ref'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ExchangeLanNetworkServiceConfig.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
ExchangeLanNetworkServiceConfig.prototype['id'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['ips'] = undefined;

/**
 * The customer wants to be featured on the member list
 * @member {Boolean} listed
 */
ExchangeLanNetworkServiceConfig.prototype['listed'] = undefined;

/**
 * A list of mac-address IDs.
 * @member {Array.<String>} macs
 */
ExchangeLanNetworkServiceConfig.prototype['macs'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
ExchangeLanNetworkServiceConfig.prototype['network_feature_configs'] = undefined;

/**
 * The id of the configured network service.
 * @member {String} network_service
 */
ExchangeLanNetworkServiceConfig.prototype['network_service'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['product_offering'] = undefined;
 ...
 * @default ''
 */
ExchangeLanNetworkServiceConfig.prototype['purchase_order'] = '';
 ...
 */
ExchangeLanNetworkServiceConfig.prototype['role_assignments'] = undefined;

/**
 * @member {module:model/ExchangeLanNetworkServiceConfig.StateEnum} state
 */
ExchangeLanNetworkServiceConfig.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
ExchangeLanNetworkServiceConfig.prototype['status'] = undefined;

/**
 * @member {String} type
 */
ExchangeLanNetworkServiceConfig.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
ExchangeLanNetworkServiceConfig.prototype['vlan_config'] = undefined;


// Implement ExchangeLanNetworkServiceConfigPartial interface:
/**
 * @member {Array.<Number>} asns
 */
 ...
 * @readonly
 */
ExchangeLanNetworkServiceConfig['StateEnum'] = {
...
export default ExchangeLanNetworkServiceConfig;
