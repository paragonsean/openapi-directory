...
/**
 * The IpAddressUpdatePartial model module.
 * @module model/IpAddressUpdatePartial
 * @version 2.1.0
 */
class IpAddressUpdatePartial {
    /**
     * Constructs a new <code>IpAddressUpdatePartial</code>.
     * IP-Address Update
     * @alias module:model/IpAddressUpdatePartial
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>IpAddressUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpAddressUpdatePartial} obj Optional instance to populate.
     * @return {module:model/IpAddressUpdatePartial} The populated <code>IpAddressUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpAddressUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>IpAddressUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpAddressUpdatePartial</code>.
     */
...
export default IpAddressUpdatePartial;
