...
/**
 * The P2MPNetworkServiceRequest model module.
 * @module model/P2MPNetworkServiceRequest
 * @version 2.1.0
 */
class P2MPNetworkServiceRequest {
    /**
     * Constructs a new <code>P2MPNetworkServiceRequest</code>.
     * @alias module:model/P2MPNetworkServiceRequest
     * @implements module:model/P2MPNetworkServiceRequestPartial
     ...
     * @param type {String} 
     */
    constructor(billingAccount, consumingAccount, managingAccount, name, productOffering, type) { 
        P2MPNetworkServiceRequestPartial.initialize(this, type);
        P2MPNetworkServiceRequest.initialize(this, billingAccount, consumingAccount, managingAccount, name, productOffering, type);
    }
     ...
     */
    static initialize(obj, billingAccount, consumingAccount, managingAccount, name, productOffering, type) { 
    ...
    /**
     * Constructs a <code>P2MPNetworkServiceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2MPNetworkServiceRequest} obj Optional instance to populate.
     * @return {module:model/P2MPNetworkServiceRequest} The populated <code>P2MPNetworkServiceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2MPNetworkServiceRequest();
            P2MPNetworkServiceRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2MPNetworkServiceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2MPNetworkServiceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2MPNetworkServiceRequest.RequiredProperties) {
...
P2MPNetworkServiceRequest.RequiredProperties = ["billing_account", "consuming_account", "managing_account", "name", "product_offering", "type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2MPNetworkServiceRequest.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2MPNetworkServiceRequest.prototype['consuming_account'] = undefined;
 ...
 */
P2MPNetworkServiceRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2MPNetworkServiceRequest.prototype['external_ref'] = undefined;
 ...
 */
P2MPNetworkServiceRequest.prototype['managing_account'] = undefined;

/**
 * Name of the point to multi-point virtual circuit.
 * @member {String} name
 */
P2MPNetworkServiceRequest.prototype['name'] = undefined;

/**
 * @member {String} product_offering
 */
P2MPNetworkServiceRequest.prototype['product_offering'] = undefined;
 ...
 * @default false
 */
P2MPNetworkServiceRequest.prototype['public'] = false;
 ...
 * @default ''
 */
P2MPNetworkServiceRequest.prototype['purchase_order'] = '';

/**
 * @member {String} type
 */
P2MPNetworkServiceRequest.prototype['type'] = undefined;


// Implement P2MPNetworkServiceRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default P2MPNetworkServiceRequest;
