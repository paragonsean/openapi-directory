...
/**
 * The MP2MPNetworkServiceRequestPartial model module.
 * @module model/MP2MPNetworkServiceRequestPartial
 * @version 2.1.0
 */
class MP2MPNetworkServiceRequestPartial {
    /**
     * Constructs a new <code>MP2MPNetworkServiceRequestPartial</code>.
     * MP2MP Network Service Request
     * @alias module:model/MP2MPNetworkServiceRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        MP2MPNetworkServiceRequestPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceRequestPartial} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceRequestPartial} The populated <code>MP2MPNetworkServiceRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceRequestPartial.RequiredProperties) {
 ...
 */
MP2MPNetworkServiceRequestPartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceRequestPartial.prototype['external_ref'] = undefined;
 ...
 */
MP2MPNetworkServiceRequestPartial.prototype['managing_account'] = undefined;

/**
 * Name of the multi-point to multi-point virtual circuit.
 * @member {String} name
 */
MP2MPNetworkServiceRequestPartial.prototype['name'] = undefined;

/**
 * @member {String} product_offering
 */
MP2MPNetworkServiceRequestPartial.prototype['product_offering'] = undefined;
 ...
 * @default false
 */
MP2MPNetworkServiceRequestPartial.prototype['public'] = false;
 ...
 * @default ''
 */
MP2MPNetworkServiceRequestPartial.prototype['purchase_order'] = '';

/**
 * @member {String} type
 */
MP2MPNetworkServiceRequestPartial.prototype['type'] = undefined;
...
export default MP2MPNetworkServiceRequestPartial;
