...
/**
 * The P2PNetworkServiceConfigUpdate model module.
 * @module model/P2PNetworkServiceConfigUpdate
 * @version 2.1.0
 */
class P2PNetworkServiceConfigUpdate {
    /**
     * Constructs a new <code>P2PNetworkServiceConfigUpdate</code>.
     * @alias module:model/P2PNetworkServiceConfigUpdate
     * @implements module:model/P2PNetworkServiceConfigUpdatePartial
    ...
    constructor(billingAccount, connection, consumingAccount, managingAccount, roleAssignments, type, vlanConfig) { 
        ...
        P2PNetworkServiceConfigUpdate.initialize(this, billingAccount, connection, consumingAccount, managingAccount, roleAssignments, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>P2PNetworkServiceConfigUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2PNetworkServiceConfigUpdate} obj Optional instance to populate.
     * @return {module:model/P2PNetworkServiceConfigUpdate} The populated <code>P2PNetworkServiceConfigUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2PNetworkServiceConfigUpdate();
            P2PNetworkServiceConfigUpdatePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2PNetworkServiceConfigUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2PNetworkServiceConfigUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2PNetworkServiceConfigUpdate.RequiredProperties) {
...
P2PNetworkServiceConfigUpdate.RequiredProperties = ["billing_account", "connection", "consuming_account", "managing_account", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfigUpdate.prototype['billing_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdate.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfigUpdate.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfigUpdate.prototype['consuming_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdate.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfigUpdate.prototype['external_ref'] = undefined;
 ...
 */
P2PNetworkServiceConfigUpdate.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfigUpdate.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
P2PNetworkServiceConfigUpdate.prototype['purchase_order'] = '';
 ...
 */
P2PNetworkServiceConfigUpdate.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2PNetworkServiceConfigUpdate.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfigUpdate.prototype['vlan_config'] = undefined;


// Implement P2PNetworkServiceConfigUpdatePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default P2PNetworkServiceConfigUpdate;
