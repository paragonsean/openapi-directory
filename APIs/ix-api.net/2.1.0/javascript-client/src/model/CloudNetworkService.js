...
/**
 * The CloudNetworkService model module.
 * @module model/CloudNetworkService
 * @version 2.1.0
 */
class CloudNetworkService {
    /**
     * Constructs a new <code>CloudNetworkService</code>.
     * @alias module:model/CloudNetworkService
     * @implements module:model/CloudNetworkServicePartial
     ...
     * @param providerRef {String} For a cloud network service with the exchange first workflow, the `provider_ref` will be a reference to a resource of the cloud provider. (E.g. the UUID of a virtual circuit.)  The `provider_ref` is managed by the exchange and its meaning may vary between different cloud services. 
     * @param state {module:model/CloudNetworkService.StateEnum} 
     * @param type {String} 
     */
    constructor(billingAccount, cloudKey, consumingAccount, diversity, id, managingAccount, productOffering, providerRef, state, type) { 
        CloudNetworkServicePartial.initialize(this, type);
        CloudNetworkService.initialize(this, billingAccount, cloudKey, consumingAccount, diversity, id, managingAccount, productOffering, providerRef, state, type);
    }
     ...
     */
    static initialize(obj, billingAccount, cloudKey, consumingAccount, diversity, id, managingAccount, productOffering, providerRef, state, type) { 
    ...
    /**
     * Constructs a <code>CloudNetworkService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkService} obj Optional instance to populate.
     * @return {module:model/CloudNetworkService} The populated <code>CloudNetworkService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkService();
            CloudNetworkServicePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkService</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkService.RequiredProperties) {
...
CloudNetworkService.RequiredProperties = ["billing_account", "cloud_key", "consuming_account", "diversity", "id", "managing_account", "product_offering", "provider_ref", "state", "type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
CloudNetworkService.prototype['billing_account'] = undefined;

/**
 * The capacity of the service in Mbps. When null, the maximum capacity will be used.
 * @member {Number} capacity
 */
CloudNetworkService.prototype['capacity'] = undefined;
 ...
 */
CloudNetworkService.prototype['charged_until'] = undefined;

/**
 * @member {String} cloud_key
 */
CloudNetworkService.prototype['cloud_key'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
CloudNetworkService.prototype['consuming_account'] = undefined;
 ...
 */
CloudNetworkService.prototype['contract_ref'] = undefined;
 ...
 */
CloudNetworkService.prototype['decommission_at'] = undefined;

/**
 * Same value as the corresponding `ProductOffering`.  The service can be delivered over multiple handovers from the exchange to the `service_provider`.  The `diversity` denotes the number of handovers between the exchange and the service provider. A value of two signals a redundant service.  Only one network service configuration for each `handover` and `cloud_vlan` can be created.
 * @member {Number} diversity
 */
CloudNetworkService.prototype['diversity'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
CloudNetworkService.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
CloudNetworkService.prototype['id'] = undefined;
 ...
 */
CloudNetworkService.prototype['managing_account'] = undefined;
 ...
 */
CloudNetworkService.prototype['nsc_required_contact_roles'] = undefined;

/**
 * @member {String} product_offering
 */
CloudNetworkService.prototype['product_offering'] = undefined;
 ...
 */
CloudNetworkService.prototype['provider_ref'] = undefined;
 ...
 * @default ''
 */
CloudNetworkService.prototype['purchase_order'] = '';

/**
 * @member {module:model/CloudNetworkService.StateEnum} state
 */
CloudNetworkService.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
CloudNetworkService.prototype['status'] = undefined;

/**
 * @member {String} type
 */
CloudNetworkService.prototype['type'] = undefined;


// Implement CloudNetworkServicePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default CloudNetworkService;
