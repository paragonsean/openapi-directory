...
/**
 * The ContactPartial model module.
 * @module model/ContactPartial
 * @version 2.1.0
 */
class ContactPartial {
    /**
     * Constructs a new <code>ContactPartial</code>.
     * Contact
     * @alias module:model/ContactPartial
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ContactPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactPartial} obj Optional instance to populate.
     * @return {module:model/ContactPartial} The populated <code>ContactPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactPartial</code>.
     */
