...
/**
 * The DenyMemberJoiningRulePartial model module.
 * @module model/DenyMemberJoiningRulePartial
 * @version 2.1.0
 */
class DenyMemberJoiningRulePartial {
    /**
     * Constructs a new <code>DenyMemberJoiningRulePartial</code>.
     * A rule for members joining a private vlan
     * @alias module:model/DenyMemberJoiningRulePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>DenyMemberJoiningRulePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DenyMemberJoiningRulePartial} obj Optional instance to populate.
     * @return {module:model/DenyMemberJoiningRulePartial} The populated <code>DenyMemberJoiningRulePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DenyMemberJoiningRulePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>DenyMemberJoiningRulePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DenyMemberJoiningRulePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DenyMemberJoiningRulePartial.RequiredProperties) {
...
DenyMemberJoiningRulePartial.RequiredProperties = ["type"];
...
export default DenyMemberJoiningRulePartial;
