...
/**
 * The P2MPNetworkService model module.
 * @module model/P2MPNetworkService
 * @version 2.1.0
 */
class P2MPNetworkService {
    /**
     * Constructs a new <code>P2MPNetworkService</code>.
     * @alias module:model/P2MPNetworkService
     * @implements module:model/P2MPNetworkServicePartial
     ...
     * @param name {String} Name of the point to multi-point virtual circuit.
     * @param networkFeatures {Array.<String>} 
     * @param productOffering {String} 
     * @param state {module:model/P2MPNetworkService.StateEnum} 
     * @param type {String} 
     */
    constructor(billingAccount, consumingAccount, id, managingAccount, memberJoiningRules, name, networkFeatures, productOffering, state, type) { 
        P2MPNetworkServicePartial.initialize(this, type);
        P2MPNetworkService.initialize(this, billingAccount, consumingAccount, id, managingAccount, memberJoiningRules, name, networkFeatures, productOffering, state, type);
    }
    ...
    /**
     * Constructs a <code>P2MPNetworkService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2MPNetworkService} obj Optional instance to populate.
     * @return {module:model/P2MPNetworkService} The populated <code>P2MPNetworkService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2MPNetworkService();
            P2MPNetworkServicePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2MPNetworkService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2MPNetworkService</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2MPNetworkService.RequiredProperties) {
...
P2MPNetworkService.RequiredProperties = ["billing_account", "consuming_account", "id", "managing_account", "member_joining_rules", "name", "network_features", "product_offering", "state", "type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2MPNetworkService.prototype['billing_account'] = undefined;
 ...
 */
P2MPNetworkService.prototype['charged_until'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2MPNetworkService.prototype['consuming_account'] = undefined;
 ...
 */
P2MPNetworkService.prototype['contract_ref'] = undefined;
 ...
 */
P2MPNetworkService.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2MPNetworkService.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
P2MPNetworkService.prototype['id'] = undefined;
 ...
 */
P2MPNetworkService.prototype['managing_account'] = undefined;

/**
 * @member {Array.<String>} member_joining_rules
 */
P2MPNetworkService.prototype['member_joining_rules'] = undefined;

/**
 * Name of the point to multi-point virtual circuit.
 * @member {String} name
 */
P2MPNetworkService.prototype['name'] = undefined;

/**
 * @member {Array.<String>} network_features
 */
P2MPNetworkService.prototype['network_features'] = undefined;
 ...
 */
P2MPNetworkService.prototype['nsc_required_contact_roles'] = undefined;

/**
 * @member {String} product_offering
 */
P2MPNetworkService.prototype['product_offering'] = undefined;
 ...
 * @default false
 */
P2MPNetworkService.prototype['public'] = false;
 ...
 * @default ''
 */
P2MPNetworkService.prototype['purchase_order'] = '';

/**
 * @member {module:model/P2MPNetworkService.StateEnum} state
 */
P2MPNetworkService.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
P2MPNetworkService.prototype['status'] = undefined;

/**
 * @member {String} type
 */
P2MPNetworkService.prototype['type'] = undefined;


// Implement P2MPNetworkServicePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2MPNetworkServicePartial.prototype['billing_account'] = undefined;
/**
 * Your obligation to pay for the service will end on this date. Typically `≥ decommission_at`.  This field is only used when the state is `DECOMMISSION_REQUESTED` or `DECOMMISSIONED`.
 * @member {Date} charged_until
 */
P2MPNetworkServicePartial.prototype['charged_until'] = undefined;
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2MPNetworkServicePartial.prototype['consuming_account'] = undefined;
/**
 * A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 
 * @member {String} contract_ref
 */
P2MPNetworkServicePartial.prototype['contract_ref'] = undefined;
/**
 * The service will be decommissioned on this date.  This field is only used when the state is `DECOMMISSION_REQUESTED` or `DECOMMISSIONED`.
 * @member {Date} decommission_at
 */
P2MPNetworkServicePartial.prototype['decommission_at'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2MPNetworkServicePartial.prototype['external_ref'] = undefined;
/**
 * @member {String} id
 */
P2MPNetworkServicePartial.prototype['id'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
P2MPNetworkServicePartial.prototype['managing_account'] = undefined;
/**
 * @member {Array.<String>} member_joining_rules
 */
P2MPNetworkServicePartial.prototype['member_joining_rules'] = undefined;
/**
 * Name of the point to multi-point virtual circuit.
 * @member {String} name
 */
P2MPNetworkServicePartial.prototype['name'] = undefined;
/**
 * @member {Array.<String>} network_features
 */
P2MPNetworkServicePartial.prototype['network_features'] = undefined;
/**
 * The configuration will require at least one of each of the specified roles assigned to contacts.  The `RoleAssignment` is associated through the `role_assignments` list property of the network service configuration.
 * @member {Array.<String>} nsc_required_contact_roles
 */
P2MPNetworkServicePartial.prototype['nsc_required_contact_roles'] = undefined;
/**
 * @member {String} product_offering
 */
P2MPNetworkServicePartial.prototype['product_offering'] = undefined;
/**
 * A public p2mp network service can be joined by everyone on the exchange unless denied by a member-joining-rule.  Public network services are visible to other members of the IXP, however only `name`, `type`, `product_offering`, `consuming_account` and `managing_account` are made available.  Other required fields are redacted.
 * @member {Boolean} public
 * @default false
 */
P2MPNetworkServicePartial.prototype['public'] = false;
/**
 * Purchase Order ID which will be displayed on the invoice. 
 * @member {String} purchase_order
 * @default ''
 */
P2MPNetworkServicePartial.prototype['purchase_order'] = '';
/**
 * @member {module:model/P2MPNetworkServicePartial.StateEnum} state
 */
P2MPNetworkServicePartial.prototype['state'] = undefined;
/**
 * @member {Array.<module:model/Status>} status
 */
P2MPNetworkServicePartial.prototype['status'] = undefined;
/**
 * @member {String} type
 */
P2MPNetworkServicePartial.prototype['type'] = undefined;
...
export default P2MPNetworkService;
