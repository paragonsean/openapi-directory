...
/**
 * The RouteServerNetworkFeatureConfig model module.
 * @module model/RouteServerNetworkFeatureConfig
 * @version 2.1.0
 */
class RouteServerNetworkFeatureConfig {
    /**
     * Constructs a new <code>RouteServerNetworkFeatureConfig</code>.
     * @alias module:model/RouteServerNetworkFeatureConfig
     * @implements module:model/RouteServerNetworkFeatureConfigPartial
     * @param asn {Number} The ASN of the peer. 
     * @param bgpSessionType {module:model/RouteServerNetworkFeatureConfig.BgpSessionTypeEnum} The session type describes which of the both parties will open the connection. If set to passive, the customer router needs to open the connection. If its set to active, the route server will open the connection. The standard behavior on most exchanges is passive. 
     ...
     * @param sessionMode {module:model/RouteServerNetworkFeatureConfig.SessionModeEnum} Set the session mode with the routeserver. 
     * @param state {module:model/RouteServerNetworkFeatureConfig.StateEnum} 
     * @param type {String} 
     */
    constructor(asn, bgpSessionType, billingAccount, consumingAccount, id, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, state, type) { 
        RouteServerNetworkFeatureConfigPartial.initialize(this, type);
        RouteServerNetworkFeatureConfig.initialize(this, asn, bgpSessionType, billingAccount, consumingAccount, id, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, state, type);
    }
     ...
     */
    static initialize(obj, asn, bgpSessionType, billingAccount, consumingAccount, id, ip, managingAccount, networkFeature, networkServiceConfig, roleAssignments, sessionMode, state, type) { 
        obj['asn'] = asn;
    ...
    /**
     * Constructs a <code>RouteServerNetworkFeatureConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteServerNetworkFeatureConfig} obj Optional instance to populate.
     * @return {module:model/RouteServerNetworkFeatureConfig} The populated <code>RouteServerNetworkFeatureConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteServerNetworkFeatureConfig();
            RouteServerNetworkFeatureConfigPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RouteServerNetworkFeatureConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RouteServerNetworkFeatureConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RouteServerNetworkFeatureConfig.RequiredProperties) {
...
RouteServerNetworkFeatureConfig.RequiredProperties = ["asn", "bgp_session_type", "billing_account", "consuming_account", "id", "ip", "managing_account", "network_feature", "network_service_config", "role_assignments", "session_mode", "state", "type"];
 ...
 */
RouteServerNetworkFeatureConfig.prototype['as_set_v4'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfig.prototype['as_set_v6'] = undefined;

/**
 * The ASN of the peer. 
 * @member {Number} asn
 */
RouteServerNetworkFeatureConfig.prototype['asn'] = undefined;
 ...
 * @member {module:model/RouteServerNetworkFeatureConfig.BgpSessionTypeEnum} bgp_session_type
 */
RouteServerNetworkFeatureConfig.prototype['bgp_session_type'] = undefined;

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
RouteServerNetworkFeatureConfig.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
RouteServerNetworkFeatureConfig.prototype['consuming_account'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfig.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
RouteServerNetworkFeatureConfig.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
RouteServerNetworkFeatureConfig.prototype['id'] = undefined;
 ...
 * @default true
 */
RouteServerNetworkFeatureConfig.prototype['insert_ixp_asn'] = true;
 ...
 * @member {String} ip
 */
RouteServerNetworkFeatureConfig.prototype['ip'] = undefined;
 ...
 */
RouteServerNetworkFeatureConfig.prototype['managing_account'] = undefined;

/**
 * Announcing more than `max_prefix` IPv4 prefixes the bgp session will be droped. 
 * @member {Number} max_prefix_v4
 */
RouteServerNetworkFeatureConfig.prototype['max_prefix_v4'] = undefined;

/**
 * Announcing more than `max_prefix` IPv6 prefixes the bgp session will be droped. 
 * @member {Number} max_prefix_v6
 */
RouteServerNetworkFeatureConfig.prototype['max_prefix_v6'] = undefined;

/**
 * @member {String} network_feature
 */
RouteServerNetworkFeatureConfig.prototype['network_feature'] = undefined;

/**
 * @member {String} network_service_config
 */
RouteServerNetworkFeatureConfig.prototype['network_service_config'] = undefined;
 ...
 * @default ''
 */
RouteServerNetworkFeatureConfig.prototype['password'] = '';
 ...
 * @default ''
 */
RouteServerNetworkFeatureConfig.prototype['purchase_order'] = '';
 ...
 */
RouteServerNetworkFeatureConfig.prototype['role_assignments'] = undefined;

/**
 * Set the session mode with the routeserver. 
 * @member {module:model/RouteServerNetworkFeatureConfig.SessionModeEnum} session_mode
 */
RouteServerNetworkFeatureConfig.prototype['session_mode'] = undefined;

/**
 * @member {module:model/RouteServerNetworkFeatureConfig.StateEnum} state
 */
RouteServerNetworkFeatureConfig.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
RouteServerNetworkFeatureConfig.prototype['status'] = undefined;

/**
 * @member {String} type
 */
RouteServerNetworkFeatureConfig.prototype['type'] = undefined;


// Implement RouteServerNetworkFeatureConfigPartial interface:
/**
 * AS-SET of the customer for IPv4 prefix filtering. This is used to generate filters on the router servers.  Only valid referenced prefixes within the AS-SET are allowed inbound to the route server. All other routes are filtered.  This field is *required* if the route server network feature only supports the `af_inet` address family. If multiple address families are supported, it is optional if the `as_set_v6` is provided.  Important: The format has to be: \"AS-SET@IRR\". IRR is the database where the AS-SET is registred. Typically used IRR's are RADB, RIPE, NTTCOM, APNIC, ALTDB, LEVEL3, ARIN, AFRINIC, LACNIC 
 * @member {String} as_set_v4
 */
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfig['BgpSessionTypeEnum'] = {
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfig['SessionModeEnum'] = {
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfig['StateEnum'] = {
...
export default RouteServerNetworkFeatureConfig;
