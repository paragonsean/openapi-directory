...
/**
 * The P2MPNetworkServiceConfigRequestPartial model module.
 * @module model/P2MPNetworkServiceConfigRequestPartial
 * @version 2.1.0
 */
class P2MPNetworkServiceConfigRequestPartial {
    /**
     * Constructs a new <code>P2MPNetworkServiceConfigRequestPartial</code>.
     * P2MP Network Service Config Request
     * @alias module:model/P2MPNetworkServiceConfigRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        P2MPNetworkServiceConfigRequestPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>P2MPNetworkServiceConfigRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2MPNetworkServiceConfigRequestPartial} obj Optional instance to populate.
     * @return {module:model/P2MPNetworkServiceConfigRequestPartial} The populated <code>P2MPNetworkServiceConfigRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2MPNetworkServiceConfigRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>P2MPNetworkServiceConfigRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2MPNetworkServiceConfigRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2MPNetworkServiceConfigRequestPartial.RequiredProperties) {
...
P2MPNetworkServiceConfigRequestPartial.RequiredProperties = ["type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2MPNetworkServiceConfigRequestPartial.prototype['billing_account'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequestPartial.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2MPNetworkServiceConfigRequestPartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2MPNetworkServiceConfigRequestPartial.prototype['consuming_account'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequestPartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2MPNetworkServiceConfigRequestPartial.prototype['external_ref'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequestPartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2MPNetworkServiceConfigRequestPartial.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
P2MPNetworkServiceConfigRequestPartial.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
P2MPNetworkServiceConfigRequestPartial.prototype['purchase_order'] = '';
 ...
 * @member {module:model/P2MPNetworkServiceConfigRequestPartial.RoleEnum} role
 * @default 'leaf'
 */
P2MPNetworkServiceConfigRequestPartial.prototype['role'] = 'leaf';
 ...
 */
P2MPNetworkServiceConfigRequestPartial.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2MPNetworkServiceConfigRequestPartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2MPNetworkServiceConfigRequestPartial.prototype['vlan_config'] = undefined;
 ...
 * @readonly
 */
P2MPNetworkServiceConfigRequestPartial['RoleEnum'] = {
...
export default P2MPNetworkServiceConfigRequestPartial;
