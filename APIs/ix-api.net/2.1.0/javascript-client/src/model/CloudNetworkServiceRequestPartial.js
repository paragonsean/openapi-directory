...
/**
 * The CloudNetworkServiceRequestPartial model module.
 * @module model/CloudNetworkServiceRequestPartial
 * @version 2.1.0
 */
class CloudNetworkServiceRequestPartial {
    /**
     * Constructs a new <code>CloudNetworkServiceRequestPartial</code>.
     * Cloud Network Service Request
     * @alias module:model/CloudNetworkServiceRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>CloudNetworkServiceRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkServiceRequestPartial} obj Optional instance to populate.
     * @return {module:model/CloudNetworkServiceRequestPartial} The populated <code>CloudNetworkServiceRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkServiceRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkServiceRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkServiceRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkServiceRequestPartial.RequiredProperties) {
...
CloudNetworkServiceRequestPartial.RequiredProperties = ["type"];
...
export default CloudNetworkServiceRequestPartial;
