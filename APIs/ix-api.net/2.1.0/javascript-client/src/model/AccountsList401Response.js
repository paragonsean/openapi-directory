...
/**
 * The AccountsList401Response model module.
 * @module model/AccountsList401Response
 * @version 2.1.0
 */
class AccountsList401Response {
    /**
     * Constructs a new <code>AccountsList401Response</code>.
     * @alias module:model/AccountsList401Response
     * @implements module:model/ProblemResponse
     * @param type {module:model/AccountsList401Response.TypeEnum} 
     */
    constructor(type) { 
        ProblemResponse.initialize(this, type);
        AccountsList401Response.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>AccountsList401Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountsList401Response} obj Optional instance to populate.
     * @return {module:model/AccountsList401Response} The populated <code>AccountsList401Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountsList401Response();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountsList401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountsList401Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountsList401Response.RequiredProperties) {
...
AccountsList401Response.RequiredProperties = ["type"];

/**
 * A human-readable explanation specific to this occurrence of the problem.
 * @member {String} detail
 */
AccountsList401Response.prototype['detail'] = undefined;

/**
 * A URI reference that identifies the specific occurrence of the problem.  It may or may not yield further information if dereferenced.
 * @member {String} instance
 */
AccountsList401Response.prototype['instance'] = undefined;

/**
 * @member {Object} status
 */
AccountsList401Response.prototype['status'] = undefined;

/**
 * @member {Object} title
 */
AccountsList401Response.prototype['title'] = undefined;

/**
 * @member {module:model/AccountsList401Response.TypeEnum} type
 */
AccountsList401Response.prototype['type'] = undefined;
 ...
 * @readonly
 */
AccountsList401Response['TypeEnum'] = {
...
export default AccountsList401Response;
