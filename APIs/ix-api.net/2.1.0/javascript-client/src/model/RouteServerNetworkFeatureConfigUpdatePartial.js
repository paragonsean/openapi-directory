...
/**
 * The RouteServerNetworkFeatureConfigUpdatePartial model module.
 * @module model/RouteServerNetworkFeatureConfigUpdatePartial
 * @version 2.1.0
 */
class RouteServerNetworkFeatureConfigUpdatePartial {
    /**
     * Constructs a new <code>RouteServerNetworkFeatureConfigUpdatePartial</code>.
     * Route Server Network Feature Config Update
     * @alias module:model/RouteServerNetworkFeatureConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>RouteServerNetworkFeatureConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RouteServerNetworkFeatureConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/RouteServerNetworkFeatureConfigUpdatePartial} The populated <code>RouteServerNetworkFeatureConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RouteServerNetworkFeatureConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>RouteServerNetworkFeatureConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RouteServerNetworkFeatureConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RouteServerNetworkFeatureConfigUpdatePartial.RequiredProperties) {
...
RouteServerNetworkFeatureConfigUpdatePartial.RequiredProperties = ["type"];
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfigUpdatePartial['BgpSessionTypeEnum'] = {
 ...
 * @readonly
 */
RouteServerNetworkFeatureConfigUpdatePartial['SessionModeEnum'] = {
...
export default RouteServerNetworkFeatureConfigUpdatePartial;
