...
import ContactRequestPartial from './ContactRequestPartial';
...
class ContactRequest {
     ...
     * @implements module:model/ContactRequestPartial
    ...
    constructor(consumingAccount, managingAccount) { 
        ...
        ContactRequest.initialize(this, consumingAccount, managingAccount);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ContactRequestPartial.constructFromObject(data, obj);
...
ContactRequest.RequiredProperties = ["consuming_account", "managing_account"];

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ContactRequest.prototype['consuming_account'] = undefined;
 ...
 */
ContactRequest.prototype['external_ref'] = undefined;
 ...
 */
ContactRequest.prototype['managing_account'] = undefined;

/**
 * A name of a person or an organisation
 * @member {String} name
 */
ContactRequest.prototype['name'] = undefined;

/**
 * The telephone number in E.164 Phone Number Formatting
 * @member {String} telephone
 */
ContactRequest.prototype['telephone'] = undefined;


// Implement ContactRequestPartial interface:
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
