...
/**
 * The P2PNetworkServiceConfigRequest model module.
 * @module model/P2PNetworkServiceConfigRequest
 * @version 2.1.0
 */
class P2PNetworkServiceConfigRequest {
    /**
     * Constructs a new <code>P2PNetworkServiceConfigRequest</code>.
     * @alias module:model/P2PNetworkServiceConfigRequest
     * @implements module:model/P2PNetworkServiceConfigRequestPartial
    ...
    constructor(billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
        ...
        P2PNetworkServiceConfigRequest.initialize(this, billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>P2PNetworkServiceConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2PNetworkServiceConfigRequest} obj Optional instance to populate.
     * @return {module:model/P2PNetworkServiceConfigRequest} The populated <code>P2PNetworkServiceConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2PNetworkServiceConfigRequest();
            P2PNetworkServiceConfigRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2PNetworkServiceConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2PNetworkServiceConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2PNetworkServiceConfigRequest.RequiredProperties) {
...
P2PNetworkServiceConfigRequest.RequiredProperties = ["billing_account", "connection", "consuming_account", "managing_account", "network_service", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfigRequest.prototype['billing_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequest.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfigRequest.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfigRequest.prototype['consuming_account'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfigRequest.prototype['external_ref'] = undefined;
 ...
 */
P2PNetworkServiceConfigRequest.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfigRequest.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
P2PNetworkServiceConfigRequest.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
P2PNetworkServiceConfigRequest.prototype['purchase_order'] = '';
 ...
 */
P2PNetworkServiceConfigRequest.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2PNetworkServiceConfigRequest.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfigRequest.prototype['vlan_config'] = undefined;


// Implement P2PNetworkServiceConfigRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default P2PNetworkServiceConfigRequest;
