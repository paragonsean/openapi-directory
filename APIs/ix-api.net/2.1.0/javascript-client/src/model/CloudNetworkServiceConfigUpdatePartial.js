...
/**
 * The CloudNetworkServiceConfigUpdatePartial model module.
 * @module model/CloudNetworkServiceConfigUpdatePartial
 * @version 2.1.0
 */
class CloudNetworkServiceConfigUpdatePartial {
    /**
     * Constructs a new <code>CloudNetworkServiceConfigUpdatePartial</code>.
     * Cloud Network Service Config Update
     * @alias module:model/CloudNetworkServiceConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
        
        CloudNetworkServiceConfigUpdatePartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CloudNetworkServiceConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkServiceConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/CloudNetworkServiceConfigUpdatePartial} The populated <code>CloudNetworkServiceConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkServiceConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkServiceConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkServiceConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkServiceConfigUpdatePartial.RequiredProperties) {
...
CloudNetworkServiceConfigUpdatePartial.RequiredProperties = ["type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
CloudNetworkServiceConfigUpdatePartial.prototype['billing_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdatePartial.prototype['cloud_vlan'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
CloudNetworkServiceConfigUpdatePartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
CloudNetworkServiceConfigUpdatePartial.prototype['consuming_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdatePartial.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
CloudNetworkServiceConfigUpdatePartial.prototype['external_ref'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdatePartial.prototype['handover'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdatePartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
CloudNetworkServiceConfigUpdatePartial.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
CloudNetworkServiceConfigUpdatePartial.prototype['purchase_order'] = '';
 ...
 */
CloudNetworkServiceConfigUpdatePartial.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
CloudNetworkServiceConfigUpdatePartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
CloudNetworkServiceConfigUpdatePartial.prototype['vlan_config'] = undefined;
...
export default CloudNetworkServiceConfigUpdatePartial;
