...
/**
 * The MP2MPNetworkServiceRequest model module.
 * @module model/MP2MPNetworkServiceRequest
 * @version 2.1.0
 */
class MP2MPNetworkServiceRequest {
    /**
     * Constructs a new <code>MP2MPNetworkServiceRequest</code>.
     * @alias module:model/MP2MPNetworkServiceRequest
     * @implements module:model/MP2MPNetworkServiceRequestPartial
    ...
    constructor(billingAccount, consumingAccount, managingAccount, name, productOffering, type) { 
        ...
        MP2MPNetworkServiceRequest.initialize(this, billingAccount, consumingAccount, managingAccount, name, productOffering, type);
    }
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceRequest} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceRequest} The populated <code>MP2MPNetworkServiceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceRequest();
            MP2MPNetworkServiceRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceRequest.RequiredProperties) {
...
MP2MPNetworkServiceRequest.RequiredProperties = ["billing_account", "consuming_account", "managing_account", "name", "product_offering", "type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceRequest.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceRequest.prototype['consuming_account'] = undefined;
 ...
 */
MP2MPNetworkServiceRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceRequest.prototype['external_ref'] = undefined;
 ...
 */
MP2MPNetworkServiceRequest.prototype['managing_account'] = undefined;

/**
 * Name of the multi-point to multi-point virtual circuit.
 * @member {String} name
 */
MP2MPNetworkServiceRequest.prototype['name'] = undefined;

/**
 * @member {String} product_offering
 */
MP2MPNetworkServiceRequest.prototype['product_offering'] = undefined;
 ...
 * @default false
 */
MP2MPNetworkServiceRequest.prototype['public'] = false;
 ...
 * @default ''
 */
MP2MPNetworkServiceRequest.prototype['purchase_order'] = '';

/**
 * @member {String} type
 */
MP2MPNetworkServiceRequest.prototype['type'] = undefined;


// Implement MP2MPNetworkServiceRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default MP2MPNetworkServiceRequest;
