...
/**
 * The MP2MPNetworkServiceConfigRequestPartial model module.
 * @module model/MP2MPNetworkServiceConfigRequestPartial
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfigRequestPartial {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfigRequestPartial</code>.
     * MP2MP Network Service Config Request
     * @alias module:model/MP2MPNetworkServiceConfigRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfigRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfigRequestPartial} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfigRequestPartial} The populated <code>MP2MPNetworkServiceConfigRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfigRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfigRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfigRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfigRequestPartial.RequiredProperties) {
...
MP2MPNetworkServiceConfigRequestPartial.RequiredProperties = ["type"];
...
export default MP2MPNetworkServiceConfigRequestPartial;
