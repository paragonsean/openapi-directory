...
/**
 * The CloudNetworkServiceConfigUpdate model module.
 * @module model/CloudNetworkServiceConfigUpdate
 * @version 2.1.0
 */
class CloudNetworkServiceConfigUpdate {
    /**
     * Constructs a new <code>CloudNetworkServiceConfigUpdate</code>.
     * @alias module:model/CloudNetworkServiceConfigUpdate
     * @implements module:model/CloudNetworkServiceConfigUpdatePartial
     ...
     */
    constructor(billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, roleAssignments, type, vlanConfig) { 
        CloudNetworkServiceConfigUpdatePartial.initialize(this, type);
        CloudNetworkServiceConfigUpdate.initialize(this, billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, roleAssignments, type, vlanConfig);
    }
     ...
     */
    static initialize(obj, billingAccount, cloudVlan, connection, consumingAccount, handover, managingAccount, roleAssignments, type, vlanConfig) { 
    ...
    /**
     * Constructs a <code>CloudNetworkServiceConfigUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudNetworkServiceConfigUpdate} obj Optional instance to populate.
     * @return {module:model/CloudNetworkServiceConfigUpdate} The populated <code>CloudNetworkServiceConfigUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudNetworkServiceConfigUpdate();
            CloudNetworkServiceConfigUpdatePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CloudNetworkServiceConfigUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudNetworkServiceConfigUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudNetworkServiceConfigUpdate.RequiredProperties) {
...
CloudNetworkServiceConfigUpdate.RequiredProperties = ["billing_account", "cloud_vlan", "connection", "consuming_account", "handover", "managing_account", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
CloudNetworkServiceConfigUpdate.prototype['billing_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdate.prototype['cloud_vlan'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
CloudNetworkServiceConfigUpdate.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
CloudNetworkServiceConfigUpdate.prototype['consuming_account'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdate.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
CloudNetworkServiceConfigUpdate.prototype['external_ref'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdate.prototype['handover'] = undefined;
 ...
 */
CloudNetworkServiceConfigUpdate.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
CloudNetworkServiceConfigUpdate.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
CloudNetworkServiceConfigUpdate.prototype['purchase_order'] = '';
 ...
 */
CloudNetworkServiceConfigUpdate.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
CloudNetworkServiceConfigUpdate.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
CloudNetworkServiceConfigUpdate.prototype['vlan_config'] = undefined;


// Implement CloudNetworkServiceConfigUpdatePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
...
export default CloudNetworkServiceConfigUpdate;
