...
import MP2MPNetworkServiceConfigUpdatePartial from './MP2MPNetworkServiceConfigUpdatePartial';
import VlanConfig from './VlanConfig';

/**
 * The MP2MPNetworkServiceConfigUpdate model module.
 * @module model/MP2MPNetworkServiceConfigUpdate
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfigUpdate {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfigUpdate</code>.
     * @alias module:model/MP2MPNetworkServiceConfigUpdate
     * @implements module:model/MP2MPNetworkServiceConfigUpdatePartial
    ...
    constructor(billingAccount, connection, consumingAccount, managingAccount, roleAssignments, type, vlanConfig) { 
        MP2MPNetworkServiceConfigUpdatePartial.initialize(this, type);
        MP2MPNetworkServiceConfigUpdate.initialize(this, billingAccount, connection, consumingAccount, managingAccount, roleAssignments, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfigUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfigUpdate} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfigUpdate} The populated <code>MP2MPNetworkServiceConfigUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfigUpdate();
            MP2MPNetworkServiceConfigUpdatePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfigUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfigUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfigUpdate.RequiredProperties) {
...
MP2MPNetworkServiceConfigUpdate.RequiredProperties = ["billing_account", "connection", "consuming_account", "managing_account", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfigUpdate.prototype['billing_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigUpdate.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfigUpdate.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfigUpdate.prototype['consuming_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigUpdate.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfigUpdate.prototype['external_ref'] = undefined;

/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfigUpdate.prototype['macs'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigUpdate.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfigUpdate.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
MP2MPNetworkServiceConfigUpdate.prototype['purchase_order'] = '';
 ...
 */
MP2MPNetworkServiceConfigUpdate.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
MP2MPNetworkServiceConfigUpdate.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfigUpdate.prototype['vlan_config'] = undefined;


// Implement MP2MPNetworkServiceConfigUpdatePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['billing_account'] = undefined;
/**
 * The capacity of the service in Mbps. If set to Null, the maximum capacity will be used, i.e. the virtual circuit is not rate-limited.  An exchange may choose to constrain the available capacity range of a `ProductOffering`.  That means, the service can consume up to the total bandwidth of the `Connection`.  Typically the service is charged based on the capacity.
 * @member {Number} capacity
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['capacity'] = undefined;
/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['connection'] = undefined;
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['consuming_account'] = undefined;
/**
 * A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 
 * @member {String} contract_ref
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['contract_ref'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['external_ref'] = undefined;
/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['macs'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['managing_account'] = undefined;
/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['network_feature_configs'] = undefined;
/**
 * Purchase Order ID which will be displayed on the invoice. 
 * @member {String} purchase_order
 * @default ''
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['purchase_order'] = '';
/**
 * A set of `RoleAssignment`s. See the documentation on the specific `required_contact_roles`, `nfc_required_contact_roles` or `nsc_required_contact_roles` on what `RoleAssignment`s to provide. 
 * @member {Array.<String>} role_assignments
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['role_assignments'] = undefined;
/**
 * @member {String} type
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['type'] = undefined;
/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfigUpdatePartial.prototype['vlan_config'] = undefined;




export default MP2MPNetworkServiceConfigUpdate;
