...
/**
 * The ExchangeLanNetworkServiceConfigPartial model module.
 * @module model/ExchangeLanNetworkServiceConfigPartial
 * @version 2.1.0
 */
class ExchangeLanNetworkServiceConfigPartial {
    /**
     * Constructs a new <code>ExchangeLanNetworkServiceConfigPartial</code>.
     * Exchange Lan Network Service Config
     * @alias module:model/ExchangeLanNetworkServiceConfigPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        ExchangeLanNetworkServiceConfigPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>ExchangeLanNetworkServiceConfigPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeLanNetworkServiceConfigPartial} obj Optional instance to populate.
     * @return {module:model/ExchangeLanNetworkServiceConfigPartial} The populated <code>ExchangeLanNetworkServiceConfigPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeLanNetworkServiceConfigPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeLanNetworkServiceConfigPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeLanNetworkServiceConfigPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExchangeLanNetworkServiceConfigPartial.RequiredProperties) {
...
ExchangeLanNetworkServiceConfigPartial.RequiredProperties = ["type"];

/**
 * @member {Array.<Number>} asns
 */
ExchangeLanNetworkServiceConfigPartial.prototype['asns'] = undefined;

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ExchangeLanNetworkServiceConfigPartial.prototype['billing_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['capacity'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['charged_until'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
ExchangeLanNetworkServiceConfigPartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ExchangeLanNetworkServiceConfigPartial.prototype['consuming_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['contract_ref'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ExchangeLanNetworkServiceConfigPartial.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
ExchangeLanNetworkServiceConfigPartial.prototype['id'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['ips'] = undefined;

/**
 * The customer wants to be featured on the member list
 * @member {Boolean} listed
 */
ExchangeLanNetworkServiceConfigPartial.prototype['listed'] = undefined;

/**
 * A list of mac-address IDs.
 * @member {Array.<String>} macs
 */
ExchangeLanNetworkServiceConfigPartial.prototype['macs'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
ExchangeLanNetworkServiceConfigPartial.prototype['network_feature_configs'] = undefined;

/**
 * The id of the configured network service.
 * @member {String} network_service
 */
ExchangeLanNetworkServiceConfigPartial.prototype['network_service'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['product_offering'] = undefined;
 ...
 * @default ''
 */
ExchangeLanNetworkServiceConfigPartial.prototype['purchase_order'] = '';
 ...
 */
ExchangeLanNetworkServiceConfigPartial.prototype['role_assignments'] = undefined;

/**
 * @member {module:model/ExchangeLanNetworkServiceConfigPartial.StateEnum} state
 */
ExchangeLanNetworkServiceConfigPartial.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
ExchangeLanNetworkServiceConfigPartial.prototype['status'] = undefined;

/**
 * @member {String} type
 */
ExchangeLanNetworkServiceConfigPartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
ExchangeLanNetworkServiceConfigPartial.prototype['vlan_config'] = undefined;
 ...
 * @readonly
 */
ExchangeLanNetworkServiceConfigPartial['StateEnum'] = {
...
export default ExchangeLanNetworkServiceConfigPartial;
