...
/**
 * The P2PNetworkServiceConfig model module.
 * @module model/P2PNetworkServiceConfig
 * @version 2.1.0
 */
class P2PNetworkServiceConfig {
    /**
     * Constructs a new <code>P2PNetworkServiceConfig</code>.
     * @alias module:model/P2PNetworkServiceConfig
     * @implements module:model/P2PNetworkServiceConfigPartial
     ...
     * @param state {module:model/P2PNetworkServiceConfig.StateEnum} 
     * @param type {String} 
    ...
    constructor(billingAccount, connection, consumingAccount, id, managingAccount, networkService, roleAssignments, state, type, vlanConfig) { 
        P2PNetworkServiceConfigPartial.initialize(this, type);
        P2PNetworkServiceConfig.initialize(this, billingAccount, connection, consumingAccount, id, managingAccount, networkService, roleAssignments, state, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>P2PNetworkServiceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2PNetworkServiceConfig} obj Optional instance to populate.
     * @return {module:model/P2PNetworkServiceConfig} The populated <code>P2PNetworkServiceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2PNetworkServiceConfig();
            P2PNetworkServiceConfigPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2PNetworkServiceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2PNetworkServiceConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2PNetworkServiceConfig.RequiredProperties) {
...
P2PNetworkServiceConfig.RequiredProperties = ["billing_account", "connection", "consuming_account", "id", "managing_account", "network_service", "role_assignments", "state", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfig.prototype['billing_account'] = undefined;
 ...
 */
P2PNetworkServiceConfig.prototype['capacity'] = undefined;
 ...
 */
P2PNetworkServiceConfig.prototype['charged_until'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfig.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfig.prototype['consuming_account'] = undefined;
 ...
 */
P2PNetworkServiceConfig.prototype['contract_ref'] = undefined;
 ...
 */
P2PNetworkServiceConfig.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfig.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
P2PNetworkServiceConfig.prototype['id'] = undefined;
 ...
 */
P2PNetworkServiceConfig.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfig.prototype['network_feature_configs'] = undefined;

/**
 * The id of the configured network service.
 * @member {String} network_service
 */
P2PNetworkServiceConfig.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
P2PNetworkServiceConfig.prototype['purchase_order'] = '';
 ...
 */
P2PNetworkServiceConfig.prototype['role_assignments'] = undefined;

/**
 * @member {module:model/P2PNetworkServiceConfig.StateEnum} state
 */
P2PNetworkServiceConfig.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
P2PNetworkServiceConfig.prototype['status'] = undefined;

/**
 * @member {String} type
 */
P2PNetworkServiceConfig.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfig.prototype['vlan_config'] = undefined;


// Implement P2PNetworkServiceConfigPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2PNetworkServiceConfigPartial.prototype['billing_account'] = undefined;
/**
 * The capacity of the service in Mbps. If set to Null, the maximum capacity will be used, i.e. the virtual circuit is not rate-limited.  An exchange may choose to constrain the available capacity range of a `ProductOffering`.  That means, the service can consume up to the total bandwidth of the `Connection`.  Typically the service is charged based on the capacity.
 * @member {Number} capacity
 */
P2PNetworkServiceConfigPartial.prototype['capacity'] = undefined;
/**
 * Your obligation to pay for the service will end on this date. Typically `≥ decommission_at`.  This field is only used when the state is `DECOMMISSION_REQUESTED` or `DECOMMISSIONED`.
 * @member {Date} charged_until
 */
P2PNetworkServiceConfigPartial.prototype['charged_until'] = undefined;
/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2PNetworkServiceConfigPartial.prototype['connection'] = undefined;
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2PNetworkServiceConfigPartial.prototype['consuming_account'] = undefined;
/**
 * A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 
 * @member {String} contract_ref
 */
P2PNetworkServiceConfigPartial.prototype['contract_ref'] = undefined;
/**
 * The service will be decommissioned on this date.  This field is only used when the state is `DECOMMISSION_REQUESTED` or `DECOMMISSIONED`.
 * @member {Date} decommission_at
 */
P2PNetworkServiceConfigPartial.prototype['decommission_at'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2PNetworkServiceConfigPartial.prototype['external_ref'] = undefined;
/**
 * @member {String} id
 */
P2PNetworkServiceConfigPartial.prototype['id'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
P2PNetworkServiceConfigPartial.prototype['managing_account'] = undefined;
/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2PNetworkServiceConfigPartial.prototype['network_feature_configs'] = undefined;
/**
 * The id of the configured network service.
 * @member {String} network_service
 */
P2PNetworkServiceConfigPartial.prototype['network_service'] = undefined;
/**
 * Purchase Order ID which will be displayed on the invoice. 
 * @member {String} purchase_order
 * @default ''
 */
P2PNetworkServiceConfigPartial.prototype['purchase_order'] = '';
/**
 * A set of `RoleAssignment`s. See the documentation on the specific `required_contact_roles`, `nfc_required_contact_roles` or `nsc_required_contact_roles` on what `RoleAssignment`s to provide. 
 * @member {Array.<String>} role_assignments
 */
P2PNetworkServiceConfigPartial.prototype['role_assignments'] = undefined;
/**
 * @member {module:model/P2PNetworkServiceConfigPartial.StateEnum} state
 */
P2PNetworkServiceConfigPartial.prototype['state'] = undefined;
/**
 * @member {Array.<module:model/Status>} status
 */
P2PNetworkServiceConfigPartial.prototype['status'] = undefined;
/**
 * @member {String} type
 */
P2PNetworkServiceConfigPartial.prototype['type'] = undefined;
/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2PNetworkServiceConfigPartial.prototype['vlan_config'] = undefined;
 ...
 * @readonly
 */
P2PNetworkServiceConfig['StateEnum'] = {
...
export default P2PNetworkServiceConfig;
