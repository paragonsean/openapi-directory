...
/**
 * The MP2MPNetworkServicePartial model module.
 * @module model/MP2MPNetworkServicePartial
 * @version 2.1.0
 */
class MP2MPNetworkServicePartial {
    /**
     * Constructs a new <code>MP2MPNetworkServicePartial</code>.
     * MP2MP Network Service
     * @alias module:model/MP2MPNetworkServicePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>MP2MPNetworkServicePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServicePartial} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServicePartial} The populated <code>MP2MPNetworkServicePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServicePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServicePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServicePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServicePartial.RequiredProperties) {
...
MP2MPNetworkServicePartial.RequiredProperties = ["type"];
 ...
 * @readonly
 */
MP2MPNetworkServicePartial['StateEnum'] = {
...
export default MP2MPNetworkServicePartial;
