...
/**
 * The MP2MPNetworkServiceConfigUpdatePartial model module.
 * @module model/MP2MPNetworkServiceConfigUpdatePartial
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfigUpdatePartial {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfigUpdatePartial</code>.
     * MP2MP Network Service Config Update
     * @alias module:model/MP2MPNetworkServiceConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfigUpdatePartial} The populated <code>MP2MPNetworkServiceConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfigUpdatePartial.RequiredProperties) {
...
MP2MPNetworkServiceConfigUpdatePartial.RequiredProperties = ["type"];
...
export default MP2MPNetworkServiceConfigUpdatePartial;
