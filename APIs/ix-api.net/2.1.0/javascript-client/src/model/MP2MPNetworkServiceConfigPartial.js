...
/**
 * The MP2MPNetworkServiceConfigPartial model module.
 * @module model/MP2MPNetworkServiceConfigPartial
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfigPartial {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfigPartial</code>.
     * MP2MP Network Service Config
     * @alias module:model/MP2MPNetworkServiceConfigPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        MP2MPNetworkServiceConfigPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfigPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfigPartial} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfigPartial} The populated <code>MP2MPNetworkServiceConfigPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfigPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfigPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfigPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfigPartial.RequiredProperties) {
...
MP2MPNetworkServiceConfigPartial.RequiredProperties = ["type"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfigPartial.prototype['billing_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['capacity'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['charged_until'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfigPartial.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfigPartial.prototype['consuming_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['contract_ref'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['decommission_at'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfigPartial.prototype['external_ref'] = undefined;

/**
 * @member {String} id
 */
MP2MPNetworkServiceConfigPartial.prototype['id'] = undefined;

/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfigPartial.prototype['macs'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfigPartial.prototype['network_feature_configs'] = undefined;

/**
 * The id of the configured network service.
 * @member {String} network_service
 */
MP2MPNetworkServiceConfigPartial.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
MP2MPNetworkServiceConfigPartial.prototype['purchase_order'] = '';
 ...
 */
MP2MPNetworkServiceConfigPartial.prototype['role_assignments'] = undefined;

/**
 * @member {module:model/MP2MPNetworkServiceConfigPartial.StateEnum} state
 */
MP2MPNetworkServiceConfigPartial.prototype['state'] = undefined;

/**
 * @member {Array.<module:model/Status>} status
 */
MP2MPNetworkServiceConfigPartial.prototype['status'] = undefined;

/**
 * @member {String} type
 */
MP2MPNetworkServiceConfigPartial.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfigPartial.prototype['vlan_config'] = undefined;
 ...
 * @readonly
 */
MP2MPNetworkServiceConfigPartial['StateEnum'] = {
...
export default MP2MPNetworkServiceConfigPartial;
