...
/**
 * The AllowMemberJoiningRuleRequest model module.
 * @module model/AllowMemberJoiningRuleRequest
 * @version 2.1.0
 */
class AllowMemberJoiningRuleRequest {
    /**
     * Constructs a new <code>AllowMemberJoiningRuleRequest</code>.
     * @alias module:model/AllowMemberJoiningRuleRequest
     * @implements module:model/AllowMemberJoiningRuleRequestPartial
    ...
    constructor(consumingAccount, managingAccount, networkService, type) { 
        ...
        AllowMemberJoiningRuleRequest.initialize(this, consumingAccount, managingAccount, networkService, type);
    }
    ...
    /**
     * Constructs a <code>AllowMemberJoiningRuleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllowMemberJoiningRuleRequest} obj Optional instance to populate.
     * @return {module:model/AllowMemberJoiningRuleRequest} The populated <code>AllowMemberJoiningRuleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllowMemberJoiningRuleRequest();
            AllowMemberJoiningRuleRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AllowMemberJoiningRuleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllowMemberJoiningRuleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllowMemberJoiningRuleRequest.RequiredProperties) {
...
AllowMemberJoiningRuleRequest.RequiredProperties = ["consuming_account", "managing_account", "network_service", "type"];
 ...
 */
AllowMemberJoiningRuleRequest.prototype['managing_account'] = undefined;

/**
 * @member {String} network_service
 */
AllowMemberJoiningRuleRequest.prototype['network_service'] = undefined;

/**
 * @member {String} type
 */
AllowMemberJoiningRuleRequest.prototype['type'] = undefined;


// Implement AllowMemberJoiningRuleRequestPartial interface:
/**
 * An optional rate limit which has precedence over the capacity set in the network service config.
 * @member {Number} capacity_max
 */
...
export default AllowMemberJoiningRuleRequest;
