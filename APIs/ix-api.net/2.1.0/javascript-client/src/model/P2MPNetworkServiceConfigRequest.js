...
/**
 * The P2MPNetworkServiceConfigRequest model module.
 * @module model/P2MPNetworkServiceConfigRequest
 * @version 2.1.0
 */
class P2MPNetworkServiceConfigRequest {
    /**
     * Constructs a new <code>P2MPNetworkServiceConfigRequest</code>.
     * @alias module:model/P2MPNetworkServiceConfigRequest
     * @implements module:model/P2MPNetworkServiceConfigRequestPartial
    ...
    constructor(billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
        ...
        P2MPNetworkServiceConfigRequest.initialize(this, billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig);
    }
    ...
    /**
     * Constructs a <code>P2MPNetworkServiceConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/P2MPNetworkServiceConfigRequest} obj Optional instance to populate.
     * @return {module:model/P2MPNetworkServiceConfigRequest} The populated <code>P2MPNetworkServiceConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new P2MPNetworkServiceConfigRequest();
            P2MPNetworkServiceConfigRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>P2MPNetworkServiceConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>P2MPNetworkServiceConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of P2MPNetworkServiceConfigRequest.RequiredProperties) {
...
P2MPNetworkServiceConfigRequest.RequiredProperties = ["billing_account", "connection", "consuming_account", "managing_account", "network_service", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
P2MPNetworkServiceConfigRequest.prototype['billing_account'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequest.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
P2MPNetworkServiceConfigRequest.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
P2MPNetworkServiceConfigRequest.prototype['consuming_account'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
P2MPNetworkServiceConfigRequest.prototype['external_ref'] = undefined;
 ...
 */
P2MPNetworkServiceConfigRequest.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
P2MPNetworkServiceConfigRequest.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
P2MPNetworkServiceConfigRequest.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
P2MPNetworkServiceConfigRequest.prototype['purchase_order'] = '';
 ...
 * @member {module:model/P2MPNetworkServiceConfigRequest.RoleEnum} role
 * @default 'leaf'
 */
P2MPNetworkServiceConfigRequest.prototype['role'] = 'leaf';
 ...
 */
P2MPNetworkServiceConfigRequest.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
P2MPNetworkServiceConfigRequest.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
P2MPNetworkServiceConfigRequest.prototype['vlan_config'] = undefined;


// Implement P2MPNetworkServiceConfigRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
 ...
 * @readonly
 */
P2MPNetworkServiceConfigRequest['RoleEnum'] = {
...
export default P2MPNetworkServiceConfigRequest;
