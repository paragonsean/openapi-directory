...
import ConnectionRequestPartial from './ConnectionRequestPartial';

/**
 * The ConnectionRequest model module.
 * @module model/ConnectionRequest
 * @version 2.1.0
 */
class ConnectionRequest {
    /**
     * Constructs a new <code>ConnectionRequest</code>.
     * @alias module:model/ConnectionRequest
     * @implements module:model/ConnectionRequestPartial
     ...
     */
    constructor(billingAccount, consumingAccount, managingAccount, mode, roleAssignments) { 
        ConnectionRequestPartial.initialize(this);
        ConnectionRequest.initialize(this, billingAccount, consumingAccount, managingAccount, mode, roleAssignments);
    }
     ...
     */
    static initialize(obj, billingAccount, consumingAccount, managingAccount, mode, roleAssignments) { 
    ...
    /**
     * Constructs a <code>ConnectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectionRequest} obj Optional instance to populate.
     * @return {module:model/ConnectionRequest} The populated <code>ConnectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectionRequest();
            ConnectionRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectionRequest.RequiredProperties) {
...
ConnectionRequest.RequiredProperties = ["billing_account", "consuming_account", "managing_account", "mode", "role_assignments"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ConnectionRequest.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ConnectionRequest.prototype['consuming_account'] = undefined;
 ...
 */
ConnectionRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ConnectionRequest.prototype['external_ref'] = undefined;

/**
 * This sets the LACP Timeout mode. Both ends of the connections need to be configured the same. 
 * @member {module:model/ConnectionRequest.LacpTimeoutEnum} lacp_timeout
 */
ConnectionRequest.prototype['lacp_timeout'] = undefined;
 ...
 */
ConnectionRequest.prototype['managing_account'] = undefined;
 ...
 * @member {module:model/ConnectionRequest.ModeEnum} mode
 */
ConnectionRequest.prototype['mode'] = undefined;
 ...
 * @default ''
 */
ConnectionRequest.prototype['purchase_order'] = '';
 ...
 */
ConnectionRequest.prototype['role_assignments'] = undefined;

/**
 * Shows the total bandwidth of the connection in Mbit/s. 
 * @member {Number} speed
 */
ConnectionRequest.prototype['speed'] = undefined;


// Implement ConnectionRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
 ...
 * @readonly
 */
ConnectionRequest['LacpTimeoutEnum'] = {
