...
/**
 * The AllowMemberJoiningRuleRequestPartial model module.
 * @module model/AllowMemberJoiningRuleRequestPartial
 * @version 2.1.0
 */
class AllowMemberJoiningRuleRequestPartial {
    /**
     * Constructs a new <code>AllowMemberJoiningRuleRequestPartial</code>.
     * A new vlan member joining rule
     * @alias module:model/AllowMemberJoiningRuleRequestPartial
     * @param type {String} 
     */
    constructor(type) { 
        
        AllowMemberJoiningRuleRequestPartial.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>AllowMemberJoiningRuleRequestPartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllowMemberJoiningRuleRequestPartial} obj Optional instance to populate.
     * @return {module:model/AllowMemberJoiningRuleRequestPartial} The populated <code>AllowMemberJoiningRuleRequestPartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllowMemberJoiningRuleRequestPartial();
    ...
    /**
     * Validates the JSON data with respect to <code>AllowMemberJoiningRuleRequestPartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllowMemberJoiningRuleRequestPartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AllowMemberJoiningRuleRequestPartial.RequiredProperties) {
...
AllowMemberJoiningRuleRequestPartial.RequiredProperties = ["type"];
 ...
 */
AllowMemberJoiningRuleRequestPartial.prototype['capacity_max'] = undefined;

/**
 * Require an optional minimum capacity to join the network service.
 * @member {Number} capacity_min
 */
AllowMemberJoiningRuleRequestPartial.prototype['capacity_min'] = undefined;

/**
 * The `id` of the account to which access to the network service should be granted or denied. 
 * @member {String} consuming_account
 */
AllowMemberJoiningRuleRequestPartial.prototype['consuming_account'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
AllowMemberJoiningRuleRequestPartial.prototype['external_ref'] = undefined;
 ...
 */
AllowMemberJoiningRuleRequestPartial.prototype['managing_account'] = undefined;

/**
 * @member {String} network_service
 */
AllowMemberJoiningRuleRequestPartial.prototype['network_service'] = undefined;

/**
 * @member {String} type
 */
AllowMemberJoiningRuleRequestPartial.prototype['type'] = undefined;
...
export default AllowMemberJoiningRuleRequestPartial;
