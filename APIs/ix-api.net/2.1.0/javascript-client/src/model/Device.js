...
import DevicePartial from './DevicePartial';
...
class Device {
     ...
     * @implements module:model/DevicePartial
     * @param id {String} 
     * @param name {String} Name of the device 
     * @param pop {String} The `PointOfPresence` the device is in.
     */
    constructor(id, name, pop) { 
        DevicePartial.initialize(this);
        Device.initialize(this, id, name, pop);
    }
     ...
     */
    static initialize(obj, id, name, pop) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['pop'] = pop;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Device();
            DevicePartial.constructFromObject(data, obj);
 ...
 * @member {String} pop
 */
Device.prototype['pop'] = undefined;


// Implement DevicePartial interface:
/**
 * @member {Array.<module:model/DeviceCapability>} capabilities
 */
