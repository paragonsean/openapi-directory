...
/**
 * The ExchangeLanNetworkServiceConfigUpdate model module.
 * @module model/ExchangeLanNetworkServiceConfigUpdate
 * @version 2.1.0
 */
class ExchangeLanNetworkServiceConfigUpdate {
    /**
     * Constructs a new <code>ExchangeLanNetworkServiceConfigUpdate</code>.
     * @alias module:model/ExchangeLanNetworkServiceConfigUpdate
     * @implements module:model/ExchangeLanNetworkServiceConfigUpdatePartial
     ...
     */
    constructor(asns, billingAccount, connection, consumingAccount, listed, managingAccount, roleAssignments, type, vlanConfig) { 
        ExchangeLanNetworkServiceConfigUpdatePartial.initialize(this, type);
        ExchangeLanNetworkServiceConfigUpdate.initialize(this, asns, billingAccount, connection, consumingAccount, listed, managingAccount, roleAssignments, type, vlanConfig);
    }
     ...
     */
    static initialize(obj, asns, billingAccount, connection, consumingAccount, listed, managingAccount, roleAssignments, type, vlanConfig) { 
        obj['asns'] = asns;
    ...
    /**
     * Constructs a <code>ExchangeLanNetworkServiceConfigUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeLanNetworkServiceConfigUpdate} obj Optional instance to populate.
     * @return {module:model/ExchangeLanNetworkServiceConfigUpdate} The populated <code>ExchangeLanNetworkServiceConfigUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeLanNetworkServiceConfigUpdate();
            ExchangeLanNetworkServiceConfigUpdatePartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeLanNetworkServiceConfigUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeLanNetworkServiceConfigUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExchangeLanNetworkServiceConfigUpdate.RequiredProperties) {
...
ExchangeLanNetworkServiceConfigUpdate.RequiredProperties = ["asns", "billing_account", "connection", "consuming_account", "listed", "managing_account", "role_assignments", "type", "vlan_config"];

/**
 * @member {Array.<Number>} asns
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['asns'] = undefined;

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['billing_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['consuming_account'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['external_ref'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['ips'] = undefined;

/**
 * The customer wants to be featured on the member list
 * @member {Boolean} listed
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['listed'] = undefined;

/**
 * A list of mac-address IDs.
 * @member {Array.<String>} macs
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['macs'] = undefined;
 ...
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['network_feature_configs'] = undefined;
 ...
 * @default ''
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['purchase_order'] = '';
 ...
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
ExchangeLanNetworkServiceConfigUpdate.prototype['vlan_config'] = undefined;


// Implement ExchangeLanNetworkServiceConfigUpdatePartial interface:
/**
 * @member {Array.<Number>} asns
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['asns'] = undefined;
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['billing_account'] = undefined;
/**
 * The capacity of the service in Mbps. If set to Null, the maximum capacity will be used, i.e. the virtual circuit is not rate-limited.  An exchange may choose to constrain the available capacity range of a `ProductOffering`.  That means, the service can consume up to the total bandwidth of the `Connection`.  Typically the service is charged based on the capacity.
 * @member {Number} capacity
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['capacity'] = undefined;
/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['connection'] = undefined;
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['consuming_account'] = undefined;
/**
 * A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 
 * @member {String} contract_ref
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['contract_ref'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['external_ref'] = undefined;
/**
 * A list of ip-address IDs.  Allocation of IP Addresses might be deferred depending on the IXP implementation. No assumption should be made.
 * @member {Array.<String>} ips
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['ips'] = undefined;
/**
 * The customer wants to be featured on the member list
 * @member {Boolean} listed
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['listed'] = undefined;
/**
 * A list of mac-address IDs.
 * @member {Array.<String>} macs
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['macs'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['managing_account'] = undefined;
/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['network_feature_configs'] = undefined;
/**
 * Purchase Order ID which will be displayed on the invoice. 
 * @member {String} purchase_order
 * @default ''
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['purchase_order'] = '';
/**
 * A set of `RoleAssignment`s. See the documentation on the specific `required_contact_roles`, `nfc_required_contact_roles` or `nsc_required_contact_roles` on what `RoleAssignment`s to provide. 
 * @member {Array.<String>} role_assignments
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['role_assignments'] = undefined;
/**
 * @member {String} type
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['type'] = undefined;
/**
 * @member {module:model/VlanConfig} vlan_config
 */
ExchangeLanNetworkServiceConfigUpdatePartial.prototype['vlan_config'] = undefined;




export default ExchangeLanNetworkServiceConfigUpdate;
