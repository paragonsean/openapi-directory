...
/**
 * The ExchangeLanNetworkServiceConfigUpdatePartial model module.
 * @module model/ExchangeLanNetworkServiceConfigUpdatePartial
 * @version 2.1.0
 */
class ExchangeLanNetworkServiceConfigUpdatePartial {
    /**
     * Constructs a new <code>ExchangeLanNetworkServiceConfigUpdatePartial</code>.
     * Exchange Lan Network Service Config Update
     * @alias module:model/ExchangeLanNetworkServiceConfigUpdatePartial
     * @param type {String} 
     */
    constructor(type) { 
    ...
    /**
     * Constructs a <code>ExchangeLanNetworkServiceConfigUpdatePartial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeLanNetworkServiceConfigUpdatePartial} obj Optional instance to populate.
     * @return {module:model/ExchangeLanNetworkServiceConfigUpdatePartial} The populated <code>ExchangeLanNetworkServiceConfigUpdatePartial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeLanNetworkServiceConfigUpdatePartial();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeLanNetworkServiceConfigUpdatePartial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeLanNetworkServiceConfigUpdatePartial</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExchangeLanNetworkServiceConfigUpdatePartial.RequiredProperties) {
...
ExchangeLanNetworkServiceConfigUpdatePartial.RequiredProperties = ["type"];
...
export default ExchangeLanNetworkServiceConfigUpdatePartial;
