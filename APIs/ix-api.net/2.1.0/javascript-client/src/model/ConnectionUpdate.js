...
import ConnectionUpdatePartial from './ConnectionUpdatePartial';
...
class ConnectionUpdate {
     ...
     * @implements module:model/ConnectionUpdatePartial
    ...
    constructor(billingAccount, consumingAccount, managingAccount, mode, roleAssignments) { 
        ...
        ConnectionUpdate.initialize(this, billingAccount, consumingAccount, managingAccount, mode, roleAssignments);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ConnectionUpdatePartial.constructFromObject(data, obj);
...
ConnectionUpdate.RequiredProperties = ["billing_account", "consuming_account", "managing_account", "mode", "role_assignments"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
ConnectionUpdate.prototype['billing_account'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
ConnectionUpdate.prototype['consuming_account'] = undefined;
 ...
 */
ConnectionUpdate.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
ConnectionUpdate.prototype['external_ref'] = undefined;

/**
 * This sets the LACP Timeout mode. Both ends of the connections need to be configured the same. 
 * @member {module:model/ConnectionUpdate.LacpTimeoutEnum} lacp_timeout
 */
ConnectionUpdate.prototype['lacp_timeout'] = undefined;
 ...
 */
ConnectionUpdate.prototype['managing_account'] = undefined;
 ...
 * @member {module:model/ConnectionUpdate.ModeEnum} mode
 */
ConnectionUpdate.prototype['mode'] = undefined;
 ...
 * @default ''
 */
ConnectionUpdate.prototype['purchase_order'] = '';
 ...
 */
ConnectionUpdate.prototype['role_assignments'] = undefined;

/**
 * Shows the total bandwidth of the connection in Mbit/s. 
 * @member {Number} speed
 */
ConnectionUpdate.prototype['speed'] = undefined;


// Implement ConnectionUpdatePartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
 ...
 * @readonly
 */
ConnectionUpdate['LacpTimeoutEnum'] = {
