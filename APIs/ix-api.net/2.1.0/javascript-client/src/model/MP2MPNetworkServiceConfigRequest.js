...
/**
 * The MP2MPNetworkServiceConfigRequest model module.
 * @module model/MP2MPNetworkServiceConfigRequest
 * @version 2.1.0
 */
class MP2MPNetworkServiceConfigRequest {
    /**
     * Constructs a new <code>MP2MPNetworkServiceConfigRequest</code>.
     * @alias module:model/MP2MPNetworkServiceConfigRequest
     * @implements module:model/MP2MPNetworkServiceConfigRequestPartial
     ...
     */
    constructor(billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
        MP2MPNetworkServiceConfigRequestPartial.initialize(this, type);
        MP2MPNetworkServiceConfigRequest.initialize(this, billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig);
    }
     ...
     */
    static initialize(obj, billingAccount, connection, consumingAccount, managingAccount, networkService, roleAssignments, type, vlanConfig) { 
    ...
    /**
     * Constructs a <code>MP2MPNetworkServiceConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MP2MPNetworkServiceConfigRequest} obj Optional instance to populate.
     * @return {module:model/MP2MPNetworkServiceConfigRequest} The populated <code>MP2MPNetworkServiceConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MP2MPNetworkServiceConfigRequest();
            MP2MPNetworkServiceConfigRequestPartial.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MP2MPNetworkServiceConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MP2MPNetworkServiceConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MP2MPNetworkServiceConfigRequest.RequiredProperties) {
...
MP2MPNetworkServiceConfigRequest.RequiredProperties = ["billing_account", "connection", "consuming_account", "managing_account", "network_service", "role_assignments", "type", "vlan_config"];

/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfigRequest.prototype['billing_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigRequest.prototype['capacity'] = undefined;

/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfigRequest.prototype['connection'] = undefined;

/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfigRequest.prototype['consuming_account'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigRequest.prototype['contract_ref'] = undefined;

/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfigRequest.prototype['external_ref'] = undefined;

/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfigRequest.prototype['macs'] = undefined;
 ...
 */
MP2MPNetworkServiceConfigRequest.prototype['managing_account'] = undefined;

/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfigRequest.prototype['network_feature_configs'] = undefined;

/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
MP2MPNetworkServiceConfigRequest.prototype['network_service'] = undefined;
 ...
 * @default ''
 */
MP2MPNetworkServiceConfigRequest.prototype['purchase_order'] = '';
 ...
 */
MP2MPNetworkServiceConfigRequest.prototype['role_assignments'] = undefined;

/**
 * @member {String} type
 */
MP2MPNetworkServiceConfigRequest.prototype['type'] = undefined;

/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfigRequest.prototype['vlan_config'] = undefined;


// Implement MP2MPNetworkServiceConfigRequestPartial interface:
/**
 * An account requires billing_information to be used as a `billing_account`.
 * @member {String} billing_account
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['billing_account'] = undefined;
/**
 * The capacity of the service in Mbps. If set to Null, the maximum capacity will be used, i.e. the virtual circuit is not rate-limited.  An exchange may choose to constrain the available capacity range of a `ProductOffering`.  That means, the service can consume up to the total bandwidth of the `Connection`.  Typically the service is charged based on the capacity.
 * @member {Number} capacity
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['capacity'] = undefined;
/**
 * The id of the connection to use for this `NetworkServiceConfig`.
 * @member {String} connection
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['connection'] = undefined;
/**
 * The `id` of the account consuming a service.  Used to be `owning_customer`. 
 * @member {String} consuming_account
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['consuming_account'] = undefined;
/**
 * A reference to a contract. If no specific contract is used, a default MAY be chosen by the implementer. 
 * @member {String} contract_ref
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['contract_ref'] = undefined;
/**
 * Reference field, free to use for the API user.
 * @member {String} external_ref
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['external_ref'] = undefined;
/**
 * @member {Array.<String>} macs
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['macs'] = undefined;
/**
 * The `id` of the account responsible for managing the service via the API. A manager can read and update the state of entities. 
 * @member {String} managing_account
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['managing_account'] = undefined;
/**
 * A list of ids of `NetworkFeatureConfig`s. 
 * @member {Array.<String>} network_feature_configs
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['network_feature_configs'] = undefined;
/**
 * The id of the `NetworkService` to configure.
 * @member {String} network_service
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['network_service'] = undefined;
/**
 * Purchase Order ID which will be displayed on the invoice. 
 * @member {String} purchase_order
 * @default ''
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['purchase_order'] = '';
/**
 * A set of `RoleAssignment`s. See the documentation on the specific `required_contact_roles`, `nfc_required_contact_roles` or `nsc_required_contact_roles` on what `RoleAssignment`s to provide. 
 * @member {Array.<String>} role_assignments
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['role_assignments'] = undefined;
/**
 * @member {String} type
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['type'] = undefined;
/**
 * @member {module:model/VlanConfig} vlan_config
 */
MP2MPNetworkServiceConfigRequestPartial.prototype['vlan_config'] = undefined;




export default MP2MPNetworkServiceConfigRequest;
