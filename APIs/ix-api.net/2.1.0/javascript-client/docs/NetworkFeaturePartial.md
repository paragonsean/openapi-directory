...
**asn** | **Number** |  | [optional] 
**availableBgpSessionTypes** | **[String]** | The route server provides the following session modes.  | [optional] 
**flags** | [**[IXPSpecificFeatureFlag]**](IXPSpecificFeatureFlag.md) | A list of IXP specific feature flags. This can be used to see if e.g. RPKI hard filtering is available. | [optional] 
...
**sessionMode** | **String** | When creating a route server feature config, remember to specify the same session_mode as the route server.  | [optional] 
**type** | **String** |  | 
