...
**name** | **String** |  | 
**outerVlanEthertypes** | **[String]** | The ethertype of the outer tag in hexadecimal notation.  | 
...
**vlanTypes** | **[String]** | A list of vlan config types you can configure using this connection. | 
