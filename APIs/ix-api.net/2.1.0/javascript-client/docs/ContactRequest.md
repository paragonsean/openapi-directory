...
**email** | **String** | The email of the legal company entity.  | [optional] 
...
**name** | **String** | A name of a person or an organisation | [optional] 
**telephone** | **String** | The telephone number in E.164 Phone Number Formatting | [optional] 
