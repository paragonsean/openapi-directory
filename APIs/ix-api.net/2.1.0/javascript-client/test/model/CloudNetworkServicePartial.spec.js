...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServicePartial();
  });
  ...
  describe('CloudNetworkServicePartial', function() {
    it('should create an instance of CloudNetworkServicePartial', function() {
      // uncomment below and update the code to test CloudNetworkServicePartial
      //var instance = new IxApi.CloudNetworkServicePartial();
      //expect(instance).to.be.a(IxApi.CloudNetworkServicePartial);
    });
