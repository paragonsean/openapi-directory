...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceConfigPartial();
  });
  ...
  describe('CloudNetworkServiceConfigPartial', function() {
    it('should create an instance of CloudNetworkServiceConfigPartial', function() {
      // uncomment below and update the code to test CloudNetworkServiceConfigPartial
      //var instance = new IxApi.CloudNetworkServiceConfigPartial();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceConfigPartial);
    });
