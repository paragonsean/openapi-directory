...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRuleRequestPartial();
  });
  ...
  describe('DenyMemberJoiningRuleRequestPartial', function() {
    it('should create an instance of DenyMemberJoiningRuleRequestPartial', function() {
      // uncomment below and update the code to test DenyMemberJoiningRuleRequestPartial
      //var instance = new IxApi.DenyMemberJoiningRuleRequestPartial();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRuleRequestPartial);
    });
