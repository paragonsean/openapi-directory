...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceConfigPartial();
  });
  ...
  describe('P2MPNetworkServiceConfigPartial', function() {
    it('should create an instance of P2MPNetworkServiceConfigPartial', function() {
      // uncomment below and update the code to test P2MPNetworkServiceConfigPartial
      //var instance = new IxApi.P2MPNetworkServiceConfigPartial();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceConfigPartial);
    });
