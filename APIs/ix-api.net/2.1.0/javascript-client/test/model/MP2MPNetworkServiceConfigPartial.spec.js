...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceConfigPartial();
  });
  ...
  describe('MP2MPNetworkServiceConfigPartial', function() {
    it('should create an instance of MP2MPNetworkServiceConfigPartial', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceConfigPartial
      //var instance = new IxApi.MP2MPNetworkServiceConfigPartial();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceConfigPartial);
    });
