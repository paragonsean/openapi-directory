...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ConnectionUpdate();
  });
  ...
  describe('ConnectionUpdate', function() {
    it('should create an instance of ConnectionUpdate', function() {
      // uncomment below and update the code to test ConnectionUpdate
      //var instance = new IxApi.ConnectionUpdate();
      //expect(instance).to.be.a(IxApi.ConnectionUpdate);
    });
