...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceRequest();
  });
  ...
  describe('NetworkServiceRequest', function() {
    it('should create an instance of NetworkServiceRequest', function() {
      // uncomment below and update the code to test NetworkServiceRequest
      //var instance = new IxApi.NetworkServiceRequest();
      //expect(instance).to.be.a(IxApi.NetworkServiceRequest);
    });
