...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DevicePartial();
  });
  ...
  describe('DevicePartial', function() {
    it('should create an instance of DevicePartial', function() {
      // uncomment below and update the code to test DevicePartial
      //var instance = new IxApi.DevicePartial();
      //expect(instance).to.be.a(IxApi.DevicePartial);
    });
