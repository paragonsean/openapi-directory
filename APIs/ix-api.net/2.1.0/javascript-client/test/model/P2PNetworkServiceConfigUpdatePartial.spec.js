...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfigUpdatePartial();
  });
  ...
  describe('P2PNetworkServiceConfigUpdatePartial', function() {
    it('should create an instance of P2PNetworkServiceConfigUpdatePartial', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfigUpdatePartial
      //var instance = new IxApi.P2PNetworkServiceConfigUpdatePartial();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfigUpdatePartial);
    });
