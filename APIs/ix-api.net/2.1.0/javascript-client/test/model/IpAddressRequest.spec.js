...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.IpAddressRequest();
  });
  ...
  describe('IpAddressRequest', function() {
    it('should create an instance of IpAddressRequest', function() {
      // uncomment below and update the code to test IpAddressRequest
      //var instance = new IxApi.IpAddressRequest();
      //expect(instance).to.be.a(IxApi.IpAddressRequest);
    });
