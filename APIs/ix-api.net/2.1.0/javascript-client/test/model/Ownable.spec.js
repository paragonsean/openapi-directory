...
(function(root, factory) {
  ...
  describe('Ownable', function() {
    it('should create an instance of Ownable', function() {
      // uncomment below and update the code to test Ownable
      //var instance = new IxApi.Ownable();
      //expect(instance).to.be.a(IxApi.Ownable);
    });
