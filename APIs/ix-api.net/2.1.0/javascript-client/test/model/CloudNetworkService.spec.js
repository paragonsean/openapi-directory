...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkService();
  });
  ...
  describe('CloudNetworkService', function() {
    it('should create an instance of CloudNetworkService', function() {
      // uncomment below and update the code to test CloudNetworkService
      //var instance = new IxApi.CloudNetworkService();
      //expect(instance).to.be.a(IxApi.CloudNetworkService);
    });
