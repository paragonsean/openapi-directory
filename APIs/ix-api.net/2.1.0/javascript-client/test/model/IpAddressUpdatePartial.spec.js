...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.IpAddressUpdatePartial();
  });
  ...
  describe('IpAddressUpdatePartial', function() {
    it('should create an instance of IpAddressUpdatePartial', function() {
      // uncomment below and update the code to test IpAddressUpdatePartial
      //var instance = new IxApi.IpAddressUpdatePartial();
      //expect(instance).to.be.a(IxApi.IpAddressUpdatePartial);
    });
