...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfigRequest();
  });
  ...
  describe('P2PNetworkServiceConfigRequest', function() {
    it('should create an instance of P2PNetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfigRequest
      //var instance = new IxApi.P2PNetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfigRequest);
    });
