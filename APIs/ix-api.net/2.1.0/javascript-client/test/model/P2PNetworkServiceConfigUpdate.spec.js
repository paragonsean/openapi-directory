...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfigUpdate();
  });
  ...
  describe('P2PNetworkServiceConfigUpdate', function() {
    it('should create an instance of P2PNetworkServiceConfigUpdate', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfigUpdate
      //var instance = new IxApi.P2PNetworkServiceConfigUpdate();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfigUpdate);
    });
