...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ConnectionRequestPartial();
  });
  ...
  describe('ConnectionRequestPartial', function() {
    it('should create an instance of ConnectionRequestPartial', function() {
      // uncomment below and update the code to test ConnectionRequestPartial
      //var instance = new IxApi.ConnectionRequestPartial();
      //expect(instance).to.be.a(IxApi.ConnectionRequestPartial);
    });
