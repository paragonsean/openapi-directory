...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceConfigUpdatePartial();
  });
  ...
  describe('MP2MPNetworkServiceConfigUpdatePartial', function() {
    it('should create an instance of MP2MPNetworkServiceConfigUpdatePartial', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceConfigUpdatePartial
      //var instance = new IxApi.MP2MPNetworkServiceConfigUpdatePartial();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceConfigUpdatePartial);
    });
