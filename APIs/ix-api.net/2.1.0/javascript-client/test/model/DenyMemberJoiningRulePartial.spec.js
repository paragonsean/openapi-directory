...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRulePartial();
  });
  ...
  describe('DenyMemberJoiningRulePartial', function() {
    it('should create an instance of DenyMemberJoiningRulePartial', function() {
      // uncomment below and update the code to test DenyMemberJoiningRulePartial
      //var instance = new IxApi.DenyMemberJoiningRulePartial();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRulePartial);
    });
