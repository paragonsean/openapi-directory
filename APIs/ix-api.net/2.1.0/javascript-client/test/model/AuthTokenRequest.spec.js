...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.AuthTokenRequest();
  });
  ...
  describe('AuthTokenRequest', function() {
    it('should create an instance of AuthTokenRequest', function() {
      // uncomment below and update the code to test AuthTokenRequest
      //var instance = new IxApi.AuthTokenRequest();
      //expect(instance).to.be.a(IxApi.AuthTokenRequest);
    });
