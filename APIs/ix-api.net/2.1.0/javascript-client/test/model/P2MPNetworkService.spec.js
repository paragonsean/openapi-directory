...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkService();
  });
  ...
  describe('P2MPNetworkService', function() {
    it('should create an instance of P2MPNetworkService', function() {
      // uncomment below and update the code to test P2MPNetworkService
      //var instance = new IxApi.P2MPNetworkService();
      //expect(instance).to.be.a(IxApi.P2MPNetworkService);
    });
