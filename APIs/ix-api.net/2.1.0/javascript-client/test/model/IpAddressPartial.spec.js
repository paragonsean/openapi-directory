...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.IpAddressPartial();
  });
  ...
  describe('IpAddressPartial', function() {
    it('should create an instance of IpAddressPartial', function() {
      // uncomment below and update the code to test IpAddressPartial
      //var instance = new IxApi.IpAddressPartial();
      //expect(instance).to.be.a(IxApi.IpAddressPartial);
    });
