...
(function(root, factory) {
  ...
  describe('Manageable', function() {
    it('should create an instance of Manageable', function() {
      // uncomment below and update the code to test Manageable
      //var instance = new IxApi.Manageable();
      //expect(instance).to.be.a(IxApi.Manageable);
    });
