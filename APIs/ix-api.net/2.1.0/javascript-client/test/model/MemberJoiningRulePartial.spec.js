...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MemberJoiningRulePartial();
  });
  ...
  describe('MemberJoiningRulePartial', function() {
    it('should create an instance of MemberJoiningRulePartial', function() {
      // uncomment below and update the code to test MemberJoiningRulePartial
      //var instance = new IxApi.MemberJoiningRulePartial();
      //expect(instance).to.be.a(IxApi.MemberJoiningRulePartial);
    });
