...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MemberJoiningRule();
  });
  ...
  describe('MemberJoiningRule', function() {
    it('should create an instance of MemberJoiningRule', function() {
      // uncomment below and update the code to test MemberJoiningRule
      //var instance = new IxApi.MemberJoiningRule();
      //expect(instance).to.be.a(IxApi.MemberJoiningRule);
    });
