...
(function(root, factory) {
  ...
  describe('Cancelable', function() {
    it('should create an instance of Cancelable', function() {
      // uncomment below and update the code to test Cancelable
      //var instance = new IxApi.Cancelable();
      //expect(instance).to.be.a(IxApi.Cancelable);
    });
