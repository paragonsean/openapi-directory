...
(function(root, factory) {
  ...
  describe('PortUpdate', function() {
    it('should create an instance of PortUpdate', function() {
      // uncomment below and update the code to test PortUpdate
      //var instance = new IxApi.PortUpdate();
      //expect(instance).to.be.a(IxApi.PortUpdate);
    });
