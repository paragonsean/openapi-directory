...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DeviceCapability();
  });
  ...
  describe('DeviceCapability', function() {
    it('should create an instance of DeviceCapability', function() {
      // uncomment below and update the code to test DeviceCapability
      //var instance = new IxApi.DeviceCapability();
      //expect(instance).to.be.a(IxApi.DeviceCapability);
    });
