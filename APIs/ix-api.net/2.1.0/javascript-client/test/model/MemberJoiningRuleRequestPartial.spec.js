...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MemberJoiningRuleRequestPartial();
  });
  ...
  describe('MemberJoiningRuleRequestPartial', function() {
    it('should create an instance of MemberJoiningRuleRequestPartial', function() {
      // uncomment below and update the code to test MemberJoiningRuleRequestPartial
      //var instance = new IxApi.MemberJoiningRuleRequestPartial();
      //expect(instance).to.be.a(IxApi.MemberJoiningRuleRequestPartial);
    });
