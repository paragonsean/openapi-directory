...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceDeleteResponsePartial();
  });
  ...
  describe('NetworkServiceDeleteResponsePartial', function() {
    it('should create an instance of NetworkServiceDeleteResponsePartial', function() {
      // uncomment below and update the code to test NetworkServiceDeleteResponsePartial
      //var instance = new IxApi.NetworkServiceDeleteResponsePartial();
      //expect(instance).to.be.a(IxApi.NetworkServiceDeleteResponsePartial);
    });
