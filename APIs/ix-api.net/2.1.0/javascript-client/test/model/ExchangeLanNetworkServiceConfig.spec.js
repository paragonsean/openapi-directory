...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ExchangeLanNetworkServiceConfig();
  });
  ...
  describe('ExchangeLanNetworkServiceConfig', function() {
    it('should create an instance of ExchangeLanNetworkServiceConfig', function() {
      // uncomment below and update the code to test ExchangeLanNetworkServiceConfig
      //var instance = new IxApi.ExchangeLanNetworkServiceConfig();
      //expect(instance).to.be.a(IxApi.ExchangeLanNetworkServiceConfig);
    });
