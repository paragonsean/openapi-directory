...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceRequest();
  });
  ...
  describe('P2PNetworkServiceRequest', function() {
    it('should create an instance of P2PNetworkServiceRequest', function() {
      // uncomment below and update the code to test P2PNetworkServiceRequest
      //var instance = new IxApi.P2PNetworkServiceRequest();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceRequest);
    });
