...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServicePartial();
  });
  ...
  describe('P2MPNetworkServicePartial', function() {
    it('should create an instance of P2MPNetworkServicePartial', function() {
      // uncomment below and update the code to test P2MPNetworkServicePartial
      //var instance = new IxApi.P2MPNetworkServicePartial();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServicePartial);
    });
