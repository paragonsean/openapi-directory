...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRule();
  });
  ...
  describe('DenyMemberJoiningRule', function() {
    it('should create an instance of DenyMemberJoiningRule', function() {
      // uncomment below and update the code to test DenyMemberJoiningRule
      //var instance = new IxApi.DenyMemberJoiningRule();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRule);
    });
