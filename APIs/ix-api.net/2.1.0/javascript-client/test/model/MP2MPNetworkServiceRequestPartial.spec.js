...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceRequestPartial();
  });
  ...
  describe('MP2MPNetworkServiceRequestPartial', function() {
    it('should create an instance of MP2MPNetworkServiceRequestPartial', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceRequestPartial
      //var instance = new IxApi.MP2MPNetworkServiceRequestPartial();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceRequestPartial);
    });
