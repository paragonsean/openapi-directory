...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceConfigRequestPartial();
  });
  ...
  describe('P2MPNetworkServiceConfigRequestPartial', function() {
    it('should create an instance of P2MPNetworkServiceConfigRequestPartial', function() {
      // uncomment below and update the code to test P2MPNetworkServiceConfigRequestPartial
      //var instance = new IxApi.P2MPNetworkServiceConfigRequestPartial();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceConfigRequestPartial);
    });
