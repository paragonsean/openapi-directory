...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceDeleteResponse();
  });
  ...
  describe('NetworkServiceDeleteResponse', function() {
    it('should create an instance of NetworkServiceDeleteResponse', function() {
      // uncomment below and update the code to test NetworkServiceDeleteResponse
      //var instance = new IxApi.NetworkServiceDeleteResponse();
      //expect(instance).to.be.a(IxApi.NetworkServiceDeleteResponse);
    });
