...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRuleUpdatePartial();
  });
  ...
  describe('DenyMemberJoiningRuleUpdatePartial', function() {
    it('should create an instance of DenyMemberJoiningRuleUpdatePartial', function() {
      // uncomment below and update the code to test DenyMemberJoiningRuleUpdatePartial
      //var instance = new IxApi.DenyMemberJoiningRuleUpdatePartial();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRuleUpdatePartial);
    });
