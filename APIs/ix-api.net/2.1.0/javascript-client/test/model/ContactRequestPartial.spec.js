...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ContactRequestPartial();
  });
  ...
  describe('ContactRequestPartial', function() {
    it('should create an instance of ContactRequestPartial', function() {
      // uncomment below and update the code to test ContactRequestPartial
      //var instance = new IxApi.ContactRequestPartial();
      //expect(instance).to.be.a(IxApi.ContactRequestPartial);
    });
