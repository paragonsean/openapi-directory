...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfigRequestPartial();
  });
  ...
  describe('P2PNetworkServiceConfigRequestPartial', function() {
    it('should create an instance of P2PNetworkServiceConfigRequestPartial', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfigRequestPartial
      //var instance = new IxApi.P2PNetworkServiceConfigRequestPartial();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfigRequestPartial);
    });
