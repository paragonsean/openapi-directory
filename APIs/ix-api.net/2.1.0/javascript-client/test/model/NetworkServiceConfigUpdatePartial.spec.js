...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfigUpdatePartial();
  });
  ...
  describe('NetworkServiceConfigUpdatePartial', function() {
    it('should create an instance of NetworkServiceConfigUpdatePartial', function() {
      // uncomment below and update the code to test NetworkServiceConfigUpdatePartial
      //var instance = new IxApi.NetworkServiceConfigUpdatePartial();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfigUpdatePartial);
    });
    ...
    it('should have the property cloudVlan (base name: "cloud_vlan")', function() {
      // uncomment below and update the code to test the property cloudVlan
      //var instance = new IxApi.NetworkServiceConfigUpdatePartial();
      //expect(instance).to.be();
    });

    it('should have the property handover (base name: "handover")', function() {
      // uncomment below and update the code to test the property handover
      //var instance = new IxApi.NetworkServiceConfigUpdatePartial();
      //expect(instance).to.be();
    });
