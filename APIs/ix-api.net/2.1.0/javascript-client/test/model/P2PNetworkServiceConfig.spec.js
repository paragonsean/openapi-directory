...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfig();
  });
  ...
  describe('P2PNetworkServiceConfig', function() {
    it('should create an instance of P2PNetworkServiceConfig', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfig
      //var instance = new IxApi.P2PNetworkServiceConfig();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfig);
    });
