...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ProblemResponsePartial();
  });
  ...
  describe('ProblemResponsePartial', function() {
    it('should create an instance of ProblemResponsePartial', function() {
      // uncomment below and update the code to test ProblemResponsePartial
      //var instance = new IxApi.ProblemResponsePartial();
      //expect(instance).to.be.a(IxApi.ProblemResponsePartial);
    });
