...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceConfigUpdate();
  });
  ...
  describe('CloudNetworkServiceConfigUpdate', function() {
    it('should create an instance of CloudNetworkServiceConfigUpdate', function() {
      // uncomment below and update the code to test CloudNetworkServiceConfigUpdate
      //var instance = new IxApi.CloudNetworkServiceConfigUpdate();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceConfigUpdate);
    });
