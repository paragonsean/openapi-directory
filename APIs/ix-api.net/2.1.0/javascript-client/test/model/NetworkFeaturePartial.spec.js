...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkFeaturePartial();
  });
  ...
  describe('NetworkFeaturePartial', function() {
    it('should create an instance of NetworkFeaturePartial', function() {
      // uncomment below and update the code to test NetworkFeaturePartial
      //var instance = new IxApi.NetworkFeaturePartial();
      //expect(instance).to.be.a(IxApi.NetworkFeaturePartial);
    });
