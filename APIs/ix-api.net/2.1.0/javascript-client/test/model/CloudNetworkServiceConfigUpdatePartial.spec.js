...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceConfigUpdatePartial();
  });
  ...
  describe('CloudNetworkServiceConfigUpdatePartial', function() {
    it('should create an instance of CloudNetworkServiceConfigUpdatePartial', function() {
      // uncomment below and update the code to test CloudNetworkServiceConfigUpdatePartial
      //var instance = new IxApi.CloudNetworkServiceConfigUpdatePartial();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceConfigUpdatePartial);
    });
