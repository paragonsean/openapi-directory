...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceRequest();
  });
  ...
  describe('CloudNetworkServiceRequest', function() {
    it('should create an instance of CloudNetworkServiceRequest', function() {
      // uncomment below and update the code to test CloudNetworkServiceRequest
      //var instance = new IxApi.CloudNetworkServiceRequest();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceRequest);
    });
