...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceConfigRequest();
  });
  ...
  describe('MP2MPNetworkServiceConfigRequest', function() {
    it('should create an instance of MP2MPNetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceConfigRequest
      //var instance = new IxApi.MP2MPNetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceConfigRequest);
    });
