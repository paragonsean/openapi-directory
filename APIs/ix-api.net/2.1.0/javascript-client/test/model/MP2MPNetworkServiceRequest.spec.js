...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceRequest();
  });
  ...
  describe('MP2MPNetworkServiceRequest', function() {
    it('should create an instance of MP2MPNetworkServiceRequest', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceRequest
      //var instance = new IxApi.MP2MPNetworkServiceRequest();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceRequest);
    });
