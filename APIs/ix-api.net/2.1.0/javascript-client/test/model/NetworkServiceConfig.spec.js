...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfig();
  });
  ...
  describe('NetworkServiceConfig', function() {
    it('should create an instance of NetworkServiceConfig', function() {
      // uncomment below and update the code to test NetworkServiceConfig
      //var instance = new IxApi.NetworkServiceConfig();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfig);
    });
