...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceConfig();
  });
  ...
  describe('P2MPNetworkServiceConfig', function() {
    it('should create an instance of P2MPNetworkServiceConfig', function() {
      // uncomment below and update the code to test P2MPNetworkServiceConfig
      //var instance = new IxApi.P2MPNetworkServiceConfig();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceConfig);
    });
