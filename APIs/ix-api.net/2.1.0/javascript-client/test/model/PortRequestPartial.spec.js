...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.PortRequestPartial();
  });
  ...
  describe('PortRequestPartial', function() {
    it('should create an instance of PortRequestPartial', function() {
      // uncomment below and update the code to test PortRequestPartial
      //var instance = new IxApi.PortRequestPartial();
      //expect(instance).to.be.a(IxApi.PortRequestPartial);
    });
