...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfigUpdate();
  });
  ...
  describe('NetworkServiceConfigUpdate', function() {
    it('should create an instance of NetworkServiceConfigUpdate', function() {
      // uncomment below and update the code to test NetworkServiceConfigUpdate
      //var instance = new IxApi.NetworkServiceConfigUpdate();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfigUpdate);
    });
