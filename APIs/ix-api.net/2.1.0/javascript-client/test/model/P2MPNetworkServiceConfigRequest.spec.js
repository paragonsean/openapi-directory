...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceConfigRequest();
  });
  ...
  describe('P2MPNetworkServiceConfigRequest', function() {
    it('should create an instance of P2MPNetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test P2MPNetworkServiceConfigRequest
      //var instance = new IxApi.P2MPNetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceConfigRequest);
    });
