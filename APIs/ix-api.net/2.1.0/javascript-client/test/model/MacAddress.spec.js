...
(function(root, factory) {
  ...
  describe('MacAddress', function() {
    it('should create an instance of MacAddress', function() {
      // uncomment below and update the code to test MacAddress
      //var instance = new IxApi.MacAddress();
      //expect(instance).to.be.a(IxApi.MacAddress);
    });
