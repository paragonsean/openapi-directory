...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceConfigRequestPartial();
  });
  ...
  describe('MP2MPNetworkServiceConfigRequestPartial', function() {
    it('should create an instance of MP2MPNetworkServiceConfigRequestPartial', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceConfigRequestPartial
      //var instance = new IxApi.MP2MPNetworkServiceConfigRequestPartial();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceConfigRequestPartial);
    });
