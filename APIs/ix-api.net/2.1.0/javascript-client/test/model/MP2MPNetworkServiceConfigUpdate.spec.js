...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkServiceConfigUpdate();
  });
  ...
  describe('MP2MPNetworkServiceConfigUpdate', function() {
    it('should create an instance of MP2MPNetworkServiceConfigUpdate', function() {
      // uncomment below and update the code to test MP2MPNetworkServiceConfigUpdate
      //var instance = new IxApi.MP2MPNetworkServiceConfigUpdate();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkServiceConfigUpdate);
    });
