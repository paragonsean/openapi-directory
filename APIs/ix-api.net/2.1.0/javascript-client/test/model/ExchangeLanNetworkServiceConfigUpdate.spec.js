...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ExchangeLanNetworkServiceConfigUpdate();
  });
  ...
  describe('ExchangeLanNetworkServiceConfigUpdate', function() {
    it('should create an instance of ExchangeLanNetworkServiceConfigUpdate', function() {
      // uncomment below and update the code to test ExchangeLanNetworkServiceConfigUpdate
      //var instance = new IxApi.ExchangeLanNetworkServiceConfigUpdate();
      //expect(instance).to.be.a(IxApi.ExchangeLanNetworkServiceConfigUpdate);
    });
