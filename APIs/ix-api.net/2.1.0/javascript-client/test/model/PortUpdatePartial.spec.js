...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.PortUpdatePartial();
  });
  ...
  describe('PortUpdatePartial', function() {
    it('should create an instance of PortUpdatePartial', function() {
      // uncomment below and update the code to test PortUpdatePartial
      //var instance = new IxApi.PortUpdatePartial();
      //expect(instance).to.be.a(IxApi.PortUpdatePartial);
    });
