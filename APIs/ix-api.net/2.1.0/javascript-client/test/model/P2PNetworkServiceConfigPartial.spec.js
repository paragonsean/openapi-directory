...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceConfigPartial();
  });
  ...
  describe('P2PNetworkServiceConfigPartial', function() {
    it('should create an instance of P2PNetworkServiceConfigPartial', function() {
      // uncomment below and update the code to test P2PNetworkServiceConfigPartial
      //var instance = new IxApi.P2PNetworkServiceConfigPartial();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceConfigPartial);
    });
