...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRuleRequest();
  });
  ...
  describe('DenyMemberJoiningRuleRequest', function() {
    it('should create an instance of DenyMemberJoiningRuleRequest', function() {
      // uncomment below and update the code to test DenyMemberJoiningRuleRequest
      //var instance = new IxApi.DenyMemberJoiningRuleRequest();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRuleRequest);
    });
