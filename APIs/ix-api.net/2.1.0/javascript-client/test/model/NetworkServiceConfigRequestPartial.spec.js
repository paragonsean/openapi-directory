...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfigRequestPartial();
  });
  ...
  describe('NetworkServiceConfigRequestPartial', function() {
    it('should create an instance of NetworkServiceConfigRequestPartial', function() {
      // uncomment below and update the code to test NetworkServiceConfigRequestPartial
      //var instance = new IxApi.NetworkServiceConfigRequestPartial();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfigRequestPartial);
    });
