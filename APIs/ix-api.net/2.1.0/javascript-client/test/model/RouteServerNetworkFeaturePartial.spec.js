...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.RouteServerNetworkFeaturePartial();
  });
  ...
  describe('RouteServerNetworkFeaturePartial', function() {
    it('should create an instance of RouteServerNetworkFeaturePartial', function() {
      // uncomment below and update the code to test RouteServerNetworkFeaturePartial
      //var instance = new IxApi.RouteServerNetworkFeaturePartial();
      //expect(instance).to.be.a(IxApi.RouteServerNetworkFeaturePartial);
    });
