...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ConnectionRequest();
  });
  ...
  describe('ConnectionRequest', function() {
    it('should create an instance of ConnectionRequest', function() {
      // uncomment below and update the code to test ConnectionRequest
      //var instance = new IxApi.ConnectionRequest();
      //expect(instance).to.be.a(IxApi.ConnectionRequest);
    });
