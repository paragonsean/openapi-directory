...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.AccountPartial();
  });
  ...
  describe('AccountPartial', function() {
    it('should create an instance of AccountPartial', function() {
      // uncomment below and update the code to test AccountPartial
      //var instance = new IxApi.AccountPartial();
      //expect(instance).to.be.a(IxApi.AccountPartial);
    });
