...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.StatusPartial();
  });
  ...
  describe('StatusPartial', function() {
    it('should create an instance of StatusPartial', function() {
      // uncomment below and update the code to test StatusPartial
      //var instance = new IxApi.StatusPartial();
      //expect(instance).to.be.a(IxApi.StatusPartial);
    });
