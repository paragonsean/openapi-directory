...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ProblemResponse();
  });
  ...
  describe('ProblemResponse', function() {
    it('should create an instance of ProblemResponse', function() {
      // uncomment below and update the code to test ProblemResponse
      //var instance = new IxApi.ProblemResponse();
      //expect(instance).to.be.a(IxApi.ProblemResponse);
    });
