...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.AllowMemberJoiningRulePartial();
  });
  ...
  describe('AllowMemberJoiningRulePartial', function() {
    it('should create an instance of AllowMemberJoiningRulePartial', function() {
      // uncomment below and update the code to test AllowMemberJoiningRulePartial
      //var instance = new IxApi.AllowMemberJoiningRulePartial();
      //expect(instance).to.be.a(IxApi.AllowMemberJoiningRulePartial);
    });
