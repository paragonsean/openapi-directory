...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceRequestPartial();
  });
  ...
  describe('P2MPNetworkServiceRequestPartial', function() {
    it('should create an instance of P2MPNetworkServiceRequestPartial', function() {
      // uncomment below and update the code to test P2MPNetworkServiceRequestPartial
      //var instance = new IxApi.P2MPNetworkServiceRequestPartial();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceRequestPartial);
    });
