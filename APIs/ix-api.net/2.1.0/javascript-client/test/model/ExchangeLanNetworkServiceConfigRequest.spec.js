...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ExchangeLanNetworkServiceConfigRequest();
  });
  ...
  describe('ExchangeLanNetworkServiceConfigRequest', function() {
    it('should create an instance of ExchangeLanNetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test ExchangeLanNetworkServiceConfigRequest
      //var instance = new IxApi.ExchangeLanNetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.ExchangeLanNetworkServiceConfigRequest);
    });
