...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfigPartial();
  });
  ...
  describe('NetworkServiceConfigPartial', function() {
    it('should create an instance of NetworkServiceConfigPartial', function() {
      // uncomment below and update the code to test NetworkServiceConfigPartial
      //var instance = new IxApi.NetworkServiceConfigPartial();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfigPartial);
    });
