...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.Invoiceable();
  });
  ...
  describe('Invoiceable', function() {
    it('should create an instance of Invoiceable', function() {
      // uncomment below and update the code to test Invoiceable
      //var instance = new IxApi.Invoiceable();
      //expect(instance).to.be.a(IxApi.Invoiceable);
    });
