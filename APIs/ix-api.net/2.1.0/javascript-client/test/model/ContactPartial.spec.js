...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ContactPartial();
  });
  ...
  describe('ContactPartial', function() {
    it('should create an instance of ContactPartial', function() {
      // uncomment below and update the code to test ContactPartial
      //var instance = new IxApi.ContactPartial();
      //expect(instance).to.be.a(IxApi.ContactPartial);
    });
