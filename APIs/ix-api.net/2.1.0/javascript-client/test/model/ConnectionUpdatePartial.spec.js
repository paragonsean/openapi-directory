...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ConnectionUpdatePartial();
  });
  ...
  describe('ConnectionUpdatePartial', function() {
    it('should create an instance of ConnectionUpdatePartial', function() {
      // uncomment below and update the code to test ConnectionUpdatePartial
      //var instance = new IxApi.ConnectionUpdatePartial();
      //expect(instance).to.be.a(IxApi.ConnectionUpdatePartial);
    });
