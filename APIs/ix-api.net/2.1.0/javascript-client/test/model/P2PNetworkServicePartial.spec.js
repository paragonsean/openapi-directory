...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServicePartial();
  });
  ...
  describe('P2PNetworkServicePartial', function() {
    it('should create an instance of P2PNetworkServicePartial', function() {
      // uncomment below and update the code to test P2PNetworkServicePartial
      //var instance = new IxApi.P2PNetworkServicePartial();
      //expect(instance).to.be.a(IxApi.P2PNetworkServicePartial);
    });
