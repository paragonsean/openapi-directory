...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.AllowMemberJoiningRuleRequest();
  });
  ...
  describe('AllowMemberJoiningRuleRequest', function() {
    it('should create an instance of AllowMemberJoiningRuleRequest', function() {
      // uncomment below and update the code to test AllowMemberJoiningRuleRequest
      //var instance = new IxApi.AllowMemberJoiningRuleRequest();
      //expect(instance).to.be.a(IxApi.AllowMemberJoiningRuleRequest);
    });
