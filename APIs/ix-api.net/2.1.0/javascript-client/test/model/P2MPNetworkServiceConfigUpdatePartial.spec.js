...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2MPNetworkServiceConfigUpdatePartial();
  });
  ...
  describe('P2MPNetworkServiceConfigUpdatePartial', function() {
    it('should create an instance of P2MPNetworkServiceConfigUpdatePartial', function() {
      // uncomment below and update the code to test P2MPNetworkServiceConfigUpdatePartial
      //var instance = new IxApi.P2MPNetworkServiceConfigUpdatePartial();
      //expect(instance).to.be.a(IxApi.P2MPNetworkServiceConfigUpdatePartial);
    });
