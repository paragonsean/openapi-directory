...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceRequestPartial();
  });
  ...
  describe('NetworkServiceRequestPartial', function() {
    it('should create an instance of NetworkServiceRequestPartial', function() {
      // uncomment below and update the code to test NetworkServiceRequestPartial
      //var instance = new IxApi.NetworkServiceRequestPartial();
      //expect(instance).to.be.a(IxApi.NetworkServiceRequestPartial);
    });
