...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceConfig();
  });
  ...
  describe('CloudNetworkServiceConfig', function() {
    it('should create an instance of CloudNetworkServiceConfig', function() {
      // uncomment below and update the code to test CloudNetworkServiceConfig
      //var instance = new IxApi.CloudNetworkServiceConfig();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceConfig);
    });
