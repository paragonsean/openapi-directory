...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.IpAddressRequestPartial();
  });
  ...
  describe('IpAddressRequestPartial', function() {
    it('should create an instance of IpAddressRequestPartial', function() {
      // uncomment below and update the code to test IpAddressRequestPartial
      //var instance = new IxApi.IpAddressRequestPartial();
      //expect(instance).to.be.a(IxApi.IpAddressRequestPartial);
    });
