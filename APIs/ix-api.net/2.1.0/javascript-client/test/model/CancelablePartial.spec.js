...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CancelablePartial();
  });
  ...
  describe('CancelablePartial', function() {
    it('should create an instance of CancelablePartial', function() {
      // uncomment below and update the code to test CancelablePartial
      //var instance = new IxApi.CancelablePartial();
      //expect(instance).to.be.a(IxApi.CancelablePartial);
    });
