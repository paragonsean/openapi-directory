...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.CloudNetworkServiceConfigRequest();
  });
  ...
  describe('CloudNetworkServiceConfigRequest', function() {
    it('should create an instance of CloudNetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test CloudNetworkServiceConfigRequest
      //var instance = new IxApi.CloudNetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.CloudNetworkServiceConfigRequest);
    });
