...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.PortRequest();
  });
  ...
  describe('PortRequest', function() {
    it('should create an instance of PortRequest', function() {
      // uncomment below and update the code to test PortRequest
      //var instance = new IxApi.PortRequest();
      //expect(instance).to.be.a(IxApi.PortRequest);
    });
