...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.AuthTokenPartial();
  });
  ...
  describe('AuthTokenPartial', function() {
    it('should create an instance of AuthTokenPartial', function() {
      // uncomment below and update the code to test AuthTokenPartial
      //var instance = new IxApi.AuthTokenPartial();
      //expect(instance).to.be.a(IxApi.AuthTokenPartial);
    });
