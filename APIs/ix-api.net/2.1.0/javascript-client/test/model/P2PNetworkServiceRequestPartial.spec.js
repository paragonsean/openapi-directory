...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.P2PNetworkServiceRequestPartial();
  });
  ...
  describe('P2PNetworkServiceRequestPartial', function() {
    it('should create an instance of P2PNetworkServiceRequestPartial', function() {
      // uncomment below and update the code to test P2PNetworkServiceRequestPartial
      //var instance = new IxApi.P2PNetworkServiceRequestPartial();
      //expect(instance).to.be.a(IxApi.P2PNetworkServiceRequestPartial);
    });
