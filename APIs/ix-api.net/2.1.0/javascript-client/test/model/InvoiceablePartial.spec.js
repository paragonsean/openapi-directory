...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.InvoiceablePartial();
  });
  ...
  describe('InvoiceablePartial', function() {
    it('should create an instance of InvoiceablePartial', function() {
      // uncomment below and update the code to test InvoiceablePartial
      //var instance = new IxApi.InvoiceablePartial();
      //expect(instance).to.be.a(IxApi.InvoiceablePartial);
    });
