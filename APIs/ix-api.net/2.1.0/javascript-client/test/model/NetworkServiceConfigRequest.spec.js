...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.NetworkServiceConfigRequest();
  });
  ...
  describe('NetworkServiceConfigRequest', function() {
    it('should create an instance of NetworkServiceConfigRequest', function() {
      // uncomment below and update the code to test NetworkServiceConfigRequest
      //var instance = new IxApi.NetworkServiceConfigRequest();
      //expect(instance).to.be.a(IxApi.NetworkServiceConfigRequest);
    });
