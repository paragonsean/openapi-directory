...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.RouteServerNetworkFeature();
  });
  ...
  describe('RouteServerNetworkFeature', function() {
    it('should create an instance of RouteServerNetworkFeature', function() {
      // uncomment below and update the code to test RouteServerNetworkFeature
      //var instance = new IxApi.RouteServerNetworkFeature();
      //expect(instance).to.be.a(IxApi.RouteServerNetworkFeature);
    });
