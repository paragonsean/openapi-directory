...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.ContactUpdatePartial();
  });
  ...
  describe('ContactUpdatePartial', function() {
    it('should create an instance of ContactUpdatePartial', function() {
      // uncomment below and update the code to test ContactUpdatePartial
      //var instance = new IxApi.ContactUpdatePartial();
      //expect(instance).to.be.a(IxApi.ContactUpdatePartial);
    });
