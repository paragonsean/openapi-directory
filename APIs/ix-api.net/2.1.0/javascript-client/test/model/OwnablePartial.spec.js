...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.OwnablePartial();
  });
  ...
  describe('OwnablePartial', function() {
    it('should create an instance of OwnablePartial', function() {
      // uncomment below and update the code to test OwnablePartial
      //var instance = new IxApi.OwnablePartial();
      //expect(instance).to.be.a(IxApi.OwnablePartial);
    });
