...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.MP2MPNetworkService();
  });
  ...
  describe('MP2MPNetworkService', function() {
    it('should create an instance of MP2MPNetworkService', function() {
      // uncomment below and update the code to test MP2MPNetworkService
      //var instance = new IxApi.MP2MPNetworkService();
      //expect(instance).to.be.a(IxApi.MP2MPNetworkService);
    });
