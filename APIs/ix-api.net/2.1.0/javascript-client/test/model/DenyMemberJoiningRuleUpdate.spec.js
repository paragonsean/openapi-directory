...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IxApi.DenyMemberJoiningRuleUpdate();
  });
  ...
  describe('DenyMemberJoiningRuleUpdate', function() {
    it('should create an instance of DenyMemberJoiningRuleUpdate', function() {
      // uncomment below and update the code to test DenyMemberJoiningRuleUpdate
      //var instance = new IxApi.DenyMemberJoiningRuleUpdate();
      //expect(instance).to.be.a(IxApi.DenyMemberJoiningRuleUpdate);
    });
