...
(function(root, factory) {
  ...
  describe('RolesApi', function() {
    ...
    describe('rolesRead', function() {
      it('should call rolesRead successfully', function(done) {
        //uncomment below and update the code to test rolesRead
        //instance.rolesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
