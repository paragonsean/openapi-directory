...
(function(root, factory) {
  ...
  describe('DevicesApi', function() {
    ...
    describe('devicesRead', function() {
      it('should call devicesRead successfully', function(done) {
        //uncomment below and update the code to test devicesRead
        //instance.devicesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
