...
|**metroAreaNetworkPresence** | **List&lt;String&gt;** | Informal list of &#x60;MetroAreaNetwork&#x60; ids, indicating the presence to other accounts. The list is maintained by the account and can be empty.  |  |
