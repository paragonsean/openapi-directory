...
public class ExchangeLanNetworkServiceConfigRequest {
  ...
  public ExchangeLanNetworkServiceConfigRequest() {
  }
  ...
  public ExchangeLanNetworkServiceConfigRequest asns(List<Long> asns) {
    this.asns = asns;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequest addAsnsItem(Long asnsItem) {
    if (this.asns == null) {
  ...
  public ExchangeLanNetworkServiceConfigRequest billingAccount(String billingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequest capacity(Integer capacity) {
  ...
  public ExchangeLanNetworkServiceConfigRequest connection(String connection) {
  ...
  public ExchangeLanNetworkServiceConfigRequest consumingAccount(String consumingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequest contractRef(String contractRef) {
  ...
  public ExchangeLanNetworkServiceConfigRequest externalRef(String externalRef) {
  ...
  public ExchangeLanNetworkServiceConfigRequest listed(Boolean listed) {
    this.listed = listed;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigRequest macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequest addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public ExchangeLanNetworkServiceConfigRequest managingAccount(String managingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequest networkService(String networkService) {
  ...
  public ExchangeLanNetworkServiceConfigRequest productOffering(String productOffering) {
  ...
  public ExchangeLanNetworkServiceConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public ExchangeLanNetworkServiceConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ExchangeLanNetworkServiceConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigRequest vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkServiceConfigRequest exchangeLanNetworkServiceConfigRequest = (ExchangeLanNetworkServiceConfigRequest) o;
    return Objects.equals(this.asns, exchangeLanNetworkServiceConfigRequest.asns) &&
        Objects.equals(this.billingAccount, exchangeLanNetworkServiceConfigRequest.billingAccount) &&
        Objects.equals(this.capacity, exchangeLanNetworkServiceConfigRequest.capacity) &&
        Objects.equals(this.connection, exchangeLanNetworkServiceConfigRequest.connection) &&
        Objects.equals(this.consumingAccount, exchangeLanNetworkServiceConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, exchangeLanNetworkServiceConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, exchangeLanNetworkServiceConfigRequest.externalRef) &&
        Objects.equals(this.ips, exchangeLanNetworkServiceConfigRequest.ips) &&
        Objects.equals(this.listed, exchangeLanNetworkServiceConfigRequest.listed) &&
        Objects.equals(this.macs, exchangeLanNetworkServiceConfigRequest.macs) &&
        Objects.equals(this.managingAccount, exchangeLanNetworkServiceConfigRequest.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, exchangeLanNetworkServiceConfigRequest.networkFeatureConfigs) &&
        Objects.equals(this.networkService, exchangeLanNetworkServiceConfigRequest.networkService) &&
        Objects.equals(this.productOffering, exchangeLanNetworkServiceConfigRequest.productOffering) &&
        Objects.equals(this.purchaseOrder, exchangeLanNetworkServiceConfigRequest.purchaseOrder) &&
        Objects.equals(this.roleAssignments, exchangeLanNetworkServiceConfigRequest.roleAssignments) &&
        Objects.equals(this.type, exchangeLanNetworkServiceConfigRequest.type) &&
        Objects.equals(this.vlanConfig, exchangeLanNetworkServiceConfigRequest.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(asns, billingAccount, capacity, connection, consumingAccount, contractRef, externalRef, ips, listed, macs, managingAccount, networkFeatureConfigs, networkService, productOffering, purchaseOrder, roleAssignments, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeLanNetworkServiceConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkServiceConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkServiceConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkServiceConfigRequest is not found in the empty JSON string", ExchangeLanNetworkServiceConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkServiceConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkServiceConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkServiceConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkServiceConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkServiceConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkServiceConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkServiceConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkServiceConfigRequest>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkServiceConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkServiceConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkServiceConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkServiceConfigRequest
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkServiceConfigRequest
   */
  public static ExchangeLanNetworkServiceConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkServiceConfigRequest.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkServiceConfigRequest to an JSON string
   *
   * @return JSON string
   */
