...
public class ExchangeLanNetworkServiceConfigUpdatePartial {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial() {
  }
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial asns(List<Long> asns) {
    this.asns = asns;
    return this;
  }

  public ExchangeLanNetworkServiceConfigUpdatePartial addAsnsItem(Long asnsItem) {
    if (this.asns == null) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial billingAccount(String billingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial capacity(Integer capacity) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial connection(String connection) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial contractRef(String contractRef) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial externalRef(String externalRef) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial listed(Boolean listed) {
    this.listed = listed;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public ExchangeLanNetworkServiceConfigUpdatePartial addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial managingAccount(String managingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial purchaseOrder(String purchaseOrder) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ExchangeLanNetworkServiceConfigUpdatePartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigUpdatePartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkServiceConfigUpdatePartial exchangeLanNetworkServiceConfigUpdatePartial = (ExchangeLanNetworkServiceConfigUpdatePartial) o;
    return Objects.equals(this.asns, exchangeLanNetworkServiceConfigUpdatePartial.asns) &&
        Objects.equals(this.billingAccount, exchangeLanNetworkServiceConfigUpdatePartial.billingAccount) &&
        Objects.equals(this.capacity, exchangeLanNetworkServiceConfigUpdatePartial.capacity) &&
        Objects.equals(this.connection, exchangeLanNetworkServiceConfigUpdatePartial.connection) &&
        Objects.equals(this.consumingAccount, exchangeLanNetworkServiceConfigUpdatePartial.consumingAccount) &&
        Objects.equals(this.contractRef, exchangeLanNetworkServiceConfigUpdatePartial.contractRef) &&
        Objects.equals(this.externalRef, exchangeLanNetworkServiceConfigUpdatePartial.externalRef) &&
        Objects.equals(this.ips, exchangeLanNetworkServiceConfigUpdatePartial.ips) &&
        Objects.equals(this.listed, exchangeLanNetworkServiceConfigUpdatePartial.listed) &&
        Objects.equals(this.macs, exchangeLanNetworkServiceConfigUpdatePartial.macs) &&
        Objects.equals(this.managingAccount, exchangeLanNetworkServiceConfigUpdatePartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, exchangeLanNetworkServiceConfigUpdatePartial.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, exchangeLanNetworkServiceConfigUpdatePartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, exchangeLanNetworkServiceConfigUpdatePartial.roleAssignments) &&
        Objects.equals(this.type, exchangeLanNetworkServiceConfigUpdatePartial.type) &&
        Objects.equals(this.vlanConfig, exchangeLanNetworkServiceConfigUpdatePartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeLanNetworkServiceConfigUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkServiceConfigUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkServiceConfigUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkServiceConfigUpdatePartial is not found in the empty JSON string", ExchangeLanNetworkServiceConfigUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkServiceConfigUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkServiceConfigUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkServiceConfigUpdatePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkServiceConfigUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkServiceConfigUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkServiceConfigUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkServiceConfigUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkServiceConfigUpdatePartial>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkServiceConfigUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkServiceConfigUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkServiceConfigUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkServiceConfigUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkServiceConfigUpdatePartial
   */
  public static ExchangeLanNetworkServiceConfigUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkServiceConfigUpdatePartial.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkServiceConfigUpdatePartial to an JSON string
   *
   * @return JSON string
   */
