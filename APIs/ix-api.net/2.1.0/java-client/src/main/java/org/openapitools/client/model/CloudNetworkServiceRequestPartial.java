...
public class CloudNetworkServiceRequestPartial {
  ...
  public CloudNetworkServiceRequestPartial() {
  }

  public CloudNetworkServiceRequestPartial billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceRequestPartial capacity(Integer capacity) {
  ...
  public CloudNetworkServiceRequestPartial cloudKey(String cloudKey) {
  ...
  public CloudNetworkServiceRequestPartial consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceRequestPartial contractRef(String contractRef) {
  ...
  public CloudNetworkServiceRequestPartial externalRef(String externalRef) {
  ...
  public CloudNetworkServiceRequestPartial managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceRequestPartial productOffering(String productOffering) {
  ...
  public CloudNetworkServiceRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceRequestPartial cloudNetworkServiceRequestPartial = (CloudNetworkServiceRequestPartial) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceRequestPartial.billingAccount) &&
        Objects.equals(this.capacity, cloudNetworkServiceRequestPartial.capacity) &&
        Objects.equals(this.cloudKey, cloudNetworkServiceRequestPartial.cloudKey) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, cloudNetworkServiceRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceRequestPartial.managingAccount) &&
        Objects.equals(this.productOffering, cloudNetworkServiceRequestPartial.productOffering) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceRequestPartial.purchaseOrder) &&
        Objects.equals(this.type, cloudNetworkServiceRequestPartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudNetworkServiceRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceRequestPartial is not found in the empty JSON string", CloudNetworkServiceRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceRequestPartial>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceRequestPartial
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceRequestPartial
   */
  public static CloudNetworkServiceRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceRequestPartial.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceRequestPartial to an JSON string
   *
   * @return JSON string
   */
