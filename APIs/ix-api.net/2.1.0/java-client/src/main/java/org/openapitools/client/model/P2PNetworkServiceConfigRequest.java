...
public class P2PNetworkServiceConfigRequest {
  ...
  public P2PNetworkServiceConfigRequest() {
  }
  ...
  public P2PNetworkServiceConfigRequest billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfigRequest capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfigRequest connection(String connection) {
  ...
  public P2PNetworkServiceConfigRequest consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfigRequest contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfigRequest externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfigRequest managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfigRequest networkService(String networkService) {
  ...
  public P2PNetworkServiceConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfigRequest vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfigRequest p2PNetworkServiceConfigRequest = (P2PNetworkServiceConfigRequest) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfigRequest.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfigRequest.capacity) &&
        Objects.equals(this.connection, p2PNetworkServiceConfigRequest.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfigRequest.externalRef) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfigRequest.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfigRequest.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2PNetworkServiceConfigRequest.networkService) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfigRequest.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfigRequest.roleAssignments) &&
        Objects.equals(this.type, p2PNetworkServiceConfigRequest.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfigRequest.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfigRequest is not found in the empty JSON string", P2PNetworkServiceConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfigRequest>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfigRequest
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfigRequest
   */
  public static P2PNetworkServiceConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfigRequest.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfigRequest to an JSON string
   *
   * @return JSON string
   */
