...
public class RouteServerNetworkFeatureConfigRequest {
  ...
  public RouteServerNetworkFeatureConfigRequest() {
  }

  public RouteServerNetworkFeatureConfigRequest asSetV4(String asSetV4) {
  ...
  public RouteServerNetworkFeatureConfigRequest asSetV6(String asSetV6) {
  ...
  public RouteServerNetworkFeatureConfigRequest asn(Long asn) {
    this.asn = asn;
    return this;
  }
  ...
  public RouteServerNetworkFeatureConfigRequest bgpSessionType(BgpSessionTypeEnum bgpSessionType) {
  ...
  public RouteServerNetworkFeatureConfigRequest billingAccount(String billingAccount) {
  ...
  public RouteServerNetworkFeatureConfigRequest consumingAccount(String consumingAccount) {
  ...
  public RouteServerNetworkFeatureConfigRequest contractRef(String contractRef) {
  ...
  public RouteServerNetworkFeatureConfigRequest externalRef(String externalRef) {
  ...
  public RouteServerNetworkFeatureConfigRequest insertIxpAsn(Boolean insertIxpAsn) {
  ...
  public RouteServerNetworkFeatureConfigRequest ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public RouteServerNetworkFeatureConfigRequest managingAccount(String managingAccount) {
  ...
  public RouteServerNetworkFeatureConfigRequest maxPrefixV4(Integer maxPrefixV4) {
  ...
  public RouteServerNetworkFeatureConfigRequest maxPrefixV6(Integer maxPrefixV6) {
  ...
  public RouteServerNetworkFeatureConfigRequest networkFeature(String networkFeature) {
  ...
  public RouteServerNetworkFeatureConfigRequest networkServiceConfig(String networkServiceConfig) {
  ...
  public RouteServerNetworkFeatureConfigRequest password(String password) {
  ...
  public RouteServerNetworkFeatureConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public RouteServerNetworkFeatureConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public RouteServerNetworkFeatureConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public RouteServerNetworkFeatureConfigRequest sessionMode(SessionModeEnum sessionMode) {
  ...
  public RouteServerNetworkFeatureConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RouteServerNetworkFeatureConfigRequest routeServerNetworkFeatureConfigRequest = (RouteServerNetworkFeatureConfigRequest) o;
    return Objects.equals(this.asSetV4, routeServerNetworkFeatureConfigRequest.asSetV4) &&
        Objects.equals(this.asSetV6, routeServerNetworkFeatureConfigRequest.asSetV6) &&
        Objects.equals(this.asn, routeServerNetworkFeatureConfigRequest.asn) &&
        Objects.equals(this.bgpSessionType, routeServerNetworkFeatureConfigRequest.bgpSessionType) &&
        Objects.equals(this.billingAccount, routeServerNetworkFeatureConfigRequest.billingAccount) &&
        Objects.equals(this.consumingAccount, routeServerNetworkFeatureConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, routeServerNetworkFeatureConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, routeServerNetworkFeatureConfigRequest.externalRef) &&
        Objects.equals(this.insertIxpAsn, routeServerNetworkFeatureConfigRequest.insertIxpAsn) &&
        Objects.equals(this.ip, routeServerNetworkFeatureConfigRequest.ip) &&
        Objects.equals(this.managingAccount, routeServerNetworkFeatureConfigRequest.managingAccount) &&
        Objects.equals(this.maxPrefixV4, routeServerNetworkFeatureConfigRequest.maxPrefixV4) &&
        Objects.equals(this.maxPrefixV6, routeServerNetworkFeatureConfigRequest.maxPrefixV6) &&
        Objects.equals(this.networkFeature, routeServerNetworkFeatureConfigRequest.networkFeature) &&
        Objects.equals(this.networkServiceConfig, routeServerNetworkFeatureConfigRequest.networkServiceConfig) &&
        Objects.equals(this.password, routeServerNetworkFeatureConfigRequest.password) &&
        Objects.equals(this.purchaseOrder, routeServerNetworkFeatureConfigRequest.purchaseOrder) &&
        Objects.equals(this.roleAssignments, routeServerNetworkFeatureConfigRequest.roleAssignments) &&
        Objects.equals(this.sessionMode, routeServerNetworkFeatureConfigRequest.sessionMode) &&
        Objects.equals(this.type, routeServerNetworkFeatureConfigRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class RouteServerNetworkFeatureConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteServerNetworkFeatureConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteServerNetworkFeatureConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RouteServerNetworkFeatureConfigRequest is not found in the empty JSON string", RouteServerNetworkFeatureConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteServerNetworkFeatureConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RouteServerNetworkFeatureConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RouteServerNetworkFeatureConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RouteServerNetworkFeatureConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RouteServerNetworkFeatureConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RouteServerNetworkFeatureConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RouteServerNetworkFeatureConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RouteServerNetworkFeatureConfigRequest>() {
           @Override
           public void write(JsonWriter out, RouteServerNetworkFeatureConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RouteServerNetworkFeatureConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RouteServerNetworkFeatureConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RouteServerNetworkFeatureConfigRequest
   * @throws IOException if the JSON string is invalid with respect to RouteServerNetworkFeatureConfigRequest
   */
  public static RouteServerNetworkFeatureConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RouteServerNetworkFeatureConfigRequest.class);
  }

  /**
   * Convert an instance of RouteServerNetworkFeatureConfigRequest to an JSON string
   *
   * @return JSON string
   */
