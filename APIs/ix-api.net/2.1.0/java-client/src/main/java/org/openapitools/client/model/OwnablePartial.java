...
public class OwnablePartial {
  ...
  public OwnablePartial() {
  }

  public OwnablePartial consumingAccount(String consumingAccount) {
  ...
  public OwnablePartial externalRef(String externalRef) {
  ...
  public OwnablePartial managingAccount(String managingAccount) {
  ...
  public boolean equals(Object o) {
    ...
    OwnablePartial ownablePartial = (OwnablePartial) o;
    return Objects.equals(this.consumingAccount, ownablePartial.consumingAccount) &&
        Objects.equals(this.externalRef, ownablePartial.externalRef) &&
        Objects.equals(this.managingAccount, ownablePartial.managingAccount);
  }
  ...
  public String toString() {
    ...
    sb.append("class OwnablePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OwnablePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OwnablePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OwnablePartial is not found in the empty JSON string", OwnablePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OwnablePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OwnablePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OwnablePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OwnablePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OwnablePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OwnablePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<OwnablePartial>() {
           @Override
           public void write(JsonWriter out, OwnablePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OwnablePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OwnablePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OwnablePartial
   * @throws IOException if the JSON string is invalid with respect to OwnablePartial
   */
  public static OwnablePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OwnablePartial.class);
  }

  /**
   * Convert an instance of OwnablePartial to an JSON string
   *
   * @return JSON string
   */
