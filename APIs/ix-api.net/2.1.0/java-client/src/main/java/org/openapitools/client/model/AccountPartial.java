...
public class AccountPartial {
  ...
  public AccountPartial address(Address address) {
  ...
  public AccountPartial billingInformation(BillingInformation billingInformation) {
  ...
  public AccountPartial discoverable(Boolean discoverable) {
  ...
  public AccountPartial externalRef(String externalRef) {
  ...
  public AccountPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AccountPartial legalName(String legalName) {
  ...
  public AccountPartial managingAccount(String managingAccount) {
  ...
  public AccountPartial metroAreaNetworkPresence(List<String> metroAreaNetworkPresence) {
    this.metroAreaNetworkPresence = metroAreaNetworkPresence;
    return this;
  }

  public AccountPartial addMetroAreaNetworkPresenceItem(String metroAreaNetworkPresenceItem) {
  ...
  public AccountPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AccountPartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public AccountPartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public AccountPartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public boolean equals(Object o) {
    ...
    AccountPartial accountPartial = (AccountPartial) o;
    return Objects.equals(this.address, accountPartial.address) &&
        Objects.equals(this.billingInformation, accountPartial.billingInformation) &&
        Objects.equals(this.discoverable, accountPartial.discoverable) &&
        Objects.equals(this.externalRef, accountPartial.externalRef) &&
        Objects.equals(this.id, accountPartial.id) &&
        Objects.equals(this.legalName, accountPartial.legalName) &&
        Objects.equals(this.managingAccount, accountPartial.managingAccount) &&
        Objects.equals(this.metroAreaNetworkPresence, accountPartial.metroAreaNetworkPresence) &&
        Objects.equals(this.name, accountPartial.name) &&
        Objects.equals(this.state, accountPartial.state) &&
        Objects.equals(this.status, accountPartial.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountPartial is not found in the empty JSON string", AccountPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountPartial>() {
           @Override
           public void write(JsonWriter out, AccountPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountPartial
   * @throws IOException if the JSON string is invalid with respect to AccountPartial
   */
  public static AccountPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountPartial.class);
  }

  /**
   * Convert an instance of AccountPartial to an JSON string
   *
   * @return JSON string
   */
