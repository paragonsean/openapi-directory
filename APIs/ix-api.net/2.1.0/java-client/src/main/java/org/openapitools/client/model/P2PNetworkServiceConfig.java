...
public class P2PNetworkServiceConfig {
  ...
  public P2PNetworkServiceConfig() {
  }
  ...
  public P2PNetworkServiceConfig billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfig capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfig chargedUntil(LocalDate chargedUntil) {
  ...
  public P2PNetworkServiceConfig connection(String connection) {
  ...
  public P2PNetworkServiceConfig consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfig contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfig decommissionAt(LocalDate decommissionAt) {
  ...
  public P2PNetworkServiceConfig externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfig id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2PNetworkServiceConfig managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfig networkService(String networkService) {
  ...
  public P2PNetworkServiceConfig purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfig roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfig addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfig state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2PNetworkServiceConfig status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2PNetworkServiceConfig addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2PNetworkServiceConfig type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfig vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfig p2PNetworkServiceConfig = (P2PNetworkServiceConfig) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfig.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfig.capacity) &&
        Objects.equals(this.chargedUntil, p2PNetworkServiceConfig.chargedUntil) &&
        Objects.equals(this.connection, p2PNetworkServiceConfig.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfig.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfig.contractRef) &&
        Objects.equals(this.decommissionAt, p2PNetworkServiceConfig.decommissionAt) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfig.externalRef) &&
        Objects.equals(this.id, p2PNetworkServiceConfig.id) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfig.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfig.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2PNetworkServiceConfig.networkService) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfig.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfig.roleAssignments) &&
        Objects.equals(this.state, p2PNetworkServiceConfig.state) &&
        Objects.equals(this.status, p2PNetworkServiceConfig.status) &&
        Objects.equals(this.type, p2PNetworkServiceConfig.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfig.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfig is not found in the empty JSON string", P2PNetworkServiceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfig>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfig
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfig
   */
  public static P2PNetworkServiceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfig.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfig to an JSON string
   *
   * @return JSON string
   */
