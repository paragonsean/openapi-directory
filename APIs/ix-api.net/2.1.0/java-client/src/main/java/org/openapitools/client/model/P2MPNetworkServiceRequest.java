...
public class P2MPNetworkServiceRequest {
  ...
  public P2MPNetworkServiceRequest() {
  }

  public P2MPNetworkServiceRequest billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceRequest consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceRequest contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceRequest externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceRequest managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2MPNetworkServiceRequest productOffering(String productOffering) {
  ...
  public P2MPNetworkServiceRequest _public(Boolean _public) {
  ...
  public P2MPNetworkServiceRequest purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceRequest p2MPNetworkServiceRequest = (P2MPNetworkServiceRequest) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceRequest.billingAccount) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceRequest.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceRequest.contractRef) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceRequest.externalRef) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceRequest.managingAccount) &&
        Objects.equals(this.name, p2MPNetworkServiceRequest.name) &&
        Objects.equals(this.productOffering, p2MPNetworkServiceRequest.productOffering) &&
        Objects.equals(this._public, p2MPNetworkServiceRequest._public) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceRequest.purchaseOrder) &&
        Objects.equals(this.type, p2MPNetworkServiceRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceRequest is not found in the empty JSON string", P2MPNetworkServiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceRequest>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceRequest
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceRequest
   */
  public static P2MPNetworkServiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceRequest.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceRequest to an JSON string
   *
   * @return JSON string
   */
