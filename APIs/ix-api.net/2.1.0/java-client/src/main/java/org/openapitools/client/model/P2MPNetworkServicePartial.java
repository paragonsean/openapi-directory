...
public class P2MPNetworkServicePartial {
  ...
  public P2MPNetworkServicePartial() {
  }
  ...
  public P2MPNetworkServicePartial billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServicePartial chargedUntil(LocalDate chargedUntil) {
  ...
  public P2MPNetworkServicePartial consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServicePartial contractRef(String contractRef) {
  ...
  public P2MPNetworkServicePartial decommissionAt(LocalDate decommissionAt) {
  ...
  public P2MPNetworkServicePartial externalRef(String externalRef) {
  ...
  public P2MPNetworkServicePartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2MPNetworkServicePartial managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServicePartial memberJoiningRules(List<String> memberJoiningRules) {
    this.memberJoiningRules = memberJoiningRules;
    return this;
  }

  public P2MPNetworkServicePartial addMemberJoiningRulesItem(String memberJoiningRulesItem) {
  ...
  public P2MPNetworkServicePartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2MPNetworkServicePartial networkFeatures(List<String> networkFeatures) {
    this.networkFeatures = networkFeatures;
    return this;
  }

  public P2MPNetworkServicePartial addNetworkFeaturesItem(String networkFeaturesItem) {
  ...
  public P2MPNetworkServicePartial productOffering(String productOffering) {
  ...
  public P2MPNetworkServicePartial _public(Boolean _public) {
  ...
  public P2MPNetworkServicePartial purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServicePartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2MPNetworkServicePartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2MPNetworkServicePartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2MPNetworkServicePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServicePartial p2MPNetworkServicePartial = (P2MPNetworkServicePartial) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServicePartial.billingAccount) &&
        Objects.equals(this.chargedUntil, p2MPNetworkServicePartial.chargedUntil) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServicePartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServicePartial.contractRef) &&
        Objects.equals(this.decommissionAt, p2MPNetworkServicePartial.decommissionAt) &&
        Objects.equals(this.externalRef, p2MPNetworkServicePartial.externalRef) &&
        Objects.equals(this.id, p2MPNetworkServicePartial.id) &&
        Objects.equals(this.managingAccount, p2MPNetworkServicePartial.managingAccount) &&
        Objects.equals(this.memberJoiningRules, p2MPNetworkServicePartial.memberJoiningRules) &&
        Objects.equals(this.name, p2MPNetworkServicePartial.name) &&
        Objects.equals(this.networkFeatures, p2MPNetworkServicePartial.networkFeatures) &&
        Objects.equals(this.nscRequiredContactRoles, p2MPNetworkServicePartial.nscRequiredContactRoles) &&
        Objects.equals(this.productOffering, p2MPNetworkServicePartial.productOffering) &&
        Objects.equals(this._public, p2MPNetworkServicePartial._public) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServicePartial.purchaseOrder) &&
        Objects.equals(this.state, p2MPNetworkServicePartial.state) &&
        Objects.equals(this.status, p2MPNetworkServicePartial.status) &&
        Objects.equals(this.type, p2MPNetworkServicePartial.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServicePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServicePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServicePartial is not found in the empty JSON string", P2MPNetworkServicePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServicePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServicePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServicePartial.openapiRequiredFields) {
      ...
      if (jsonObj.get("member_joining_rules") != null && !jsonObj.get("member_joining_rules").isJsonNull() && !jsonObj.get("member_joining_rules").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServicePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServicePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServicePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServicePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServicePartial>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServicePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServicePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServicePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServicePartial
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServicePartial
   */
  public static P2MPNetworkServicePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServicePartial.class);
  }

  /**
   * Convert an instance of P2MPNetworkServicePartial to an JSON string
   *
   * @return JSON string
   */
