...
public class ExchangeLanNetworkServiceConfigPartial {
  ...
  public ExchangeLanNetworkServiceConfigPartial() {
  }
  ...
  public ExchangeLanNetworkServiceConfigPartial asns(List<Long> asns) {
    this.asns = asns;
    return this;
  }

  public ExchangeLanNetworkServiceConfigPartial addAsnsItem(Long asnsItem) {
    if (this.asns == null) {
  ...
  public ExchangeLanNetworkServiceConfigPartial billingAccount(String billingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigPartial capacity(Integer capacity) {
  ...
  public ExchangeLanNetworkServiceConfigPartial chargedUntil(LocalDate chargedUntil) {
  ...
  public ExchangeLanNetworkServiceConfigPartial connection(String connection) {
  ...
  public ExchangeLanNetworkServiceConfigPartial consumingAccount(String consumingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigPartial contractRef(String contractRef) {
  ...
  public ExchangeLanNetworkServiceConfigPartial decommissionAt(LocalDate decommissionAt) {
  ...
  public ExchangeLanNetworkServiceConfigPartial externalRef(String externalRef) {
  ...
  public ExchangeLanNetworkServiceConfigPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigPartial listed(Boolean listed) {
    this.listed = listed;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigPartial macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public ExchangeLanNetworkServiceConfigPartial addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public ExchangeLanNetworkServiceConfigPartial managingAccount(String managingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigPartial networkService(String networkService) {
  ...
  public ExchangeLanNetworkServiceConfigPartial productOffering(String productOffering) {
  ...
  public ExchangeLanNetworkServiceConfigPartial purchaseOrder(String purchaseOrder) {
  ...
  public ExchangeLanNetworkServiceConfigPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ExchangeLanNetworkServiceConfigPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ExchangeLanNetworkServiceConfigPartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigPartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public ExchangeLanNetworkServiceConfigPartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public ExchangeLanNetworkServiceConfigPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkServiceConfigPartial exchangeLanNetworkServiceConfigPartial = (ExchangeLanNetworkServiceConfigPartial) o;
    return Objects.equals(this.asns, exchangeLanNetworkServiceConfigPartial.asns) &&
        Objects.equals(this.billingAccount, exchangeLanNetworkServiceConfigPartial.billingAccount) &&
        Objects.equals(this.capacity, exchangeLanNetworkServiceConfigPartial.capacity) &&
        Objects.equals(this.chargedUntil, exchangeLanNetworkServiceConfigPartial.chargedUntil) &&
        Objects.equals(this.connection, exchangeLanNetworkServiceConfigPartial.connection) &&
        Objects.equals(this.consumingAccount, exchangeLanNetworkServiceConfigPartial.consumingAccount) &&
        Objects.equals(this.contractRef, exchangeLanNetworkServiceConfigPartial.contractRef) &&
        Objects.equals(this.decommissionAt, exchangeLanNetworkServiceConfigPartial.decommissionAt) &&
        Objects.equals(this.externalRef, exchangeLanNetworkServiceConfigPartial.externalRef) &&
        Objects.equals(this.id, exchangeLanNetworkServiceConfigPartial.id) &&
        Objects.equals(this.ips, exchangeLanNetworkServiceConfigPartial.ips) &&
        Objects.equals(this.listed, exchangeLanNetworkServiceConfigPartial.listed) &&
        Objects.equals(this.macs, exchangeLanNetworkServiceConfigPartial.macs) &&
        Objects.equals(this.managingAccount, exchangeLanNetworkServiceConfigPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, exchangeLanNetworkServiceConfigPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, exchangeLanNetworkServiceConfigPartial.networkService) &&
        Objects.equals(this.productOffering, exchangeLanNetworkServiceConfigPartial.productOffering) &&
        Objects.equals(this.purchaseOrder, exchangeLanNetworkServiceConfigPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, exchangeLanNetworkServiceConfigPartial.roleAssignments) &&
        Objects.equals(this.state, exchangeLanNetworkServiceConfigPartial.state) &&
        Objects.equals(this.status, exchangeLanNetworkServiceConfigPartial.status) &&
        Objects.equals(this.type, exchangeLanNetworkServiceConfigPartial.type) &&
        Objects.equals(this.vlanConfig, exchangeLanNetworkServiceConfigPartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeLanNetworkServiceConfigPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkServiceConfigPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkServiceConfigPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkServiceConfigPartial is not found in the empty JSON string", ExchangeLanNetworkServiceConfigPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkServiceConfigPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkServiceConfigPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkServiceConfigPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkServiceConfigPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkServiceConfigPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkServiceConfigPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkServiceConfigPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkServiceConfigPartial>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkServiceConfigPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkServiceConfigPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkServiceConfigPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkServiceConfigPartial
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkServiceConfigPartial
   */
  public static ExchangeLanNetworkServiceConfigPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkServiceConfigPartial.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkServiceConfigPartial to an JSON string
   *
   * @return JSON string
   */
