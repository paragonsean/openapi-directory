...
public class P2PNetworkServiceConfigRequestPartial {
  ...
  public P2PNetworkServiceConfigRequestPartial() {
  }
  ...
  public P2PNetworkServiceConfigRequestPartial billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfigRequestPartial capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfigRequestPartial connection(String connection) {
  ...
  public P2PNetworkServiceConfigRequestPartial consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfigRequestPartial contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfigRequestPartial externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfigRequestPartial managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfigRequestPartial networkService(String networkService) {
  ...
  public P2PNetworkServiceConfigRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfigRequestPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfigRequestPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfigRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfigRequestPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfigRequestPartial p2PNetworkServiceConfigRequestPartial = (P2PNetworkServiceConfigRequestPartial) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfigRequestPartial.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfigRequestPartial.capacity) &&
        Objects.equals(this.connection, p2PNetworkServiceConfigRequestPartial.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfigRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfigRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfigRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfigRequestPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfigRequestPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2PNetworkServiceConfigRequestPartial.networkService) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfigRequestPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfigRequestPartial.roleAssignments) &&
        Objects.equals(this.type, p2PNetworkServiceConfigRequestPartial.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfigRequestPartial.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, connection, consumingAccount, contractRef, externalRef, managingAccount, networkFeatureConfigs, networkService, purchaseOrder, roleAssignments, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfigRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfigRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfigRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfigRequestPartial is not found in the empty JSON string", P2PNetworkServiceConfigRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfigRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfigRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfigRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfigRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfigRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfigRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfigRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfigRequestPartial>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfigRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfigRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfigRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfigRequestPartial
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfigRequestPartial
   */
  public static P2PNetworkServiceConfigRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfigRequestPartial.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfigRequestPartial to an JSON string
   *
   * @return JSON string
   */
