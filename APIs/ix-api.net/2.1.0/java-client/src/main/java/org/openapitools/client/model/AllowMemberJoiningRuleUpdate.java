...
public class AllowMemberJoiningRuleUpdate {
  ...
  public AllowMemberJoiningRuleUpdate() {
  }

  public AllowMemberJoiningRuleUpdate capacityMax(Integer capacityMax) {
  ...
  public AllowMemberJoiningRuleUpdate capacityMin(Integer capacityMin) {
  ...
  public AllowMemberJoiningRuleUpdate consumingAccount(String consumingAccount) {
  ...
  public AllowMemberJoiningRuleUpdate externalRef(String externalRef) {
  ...
  public AllowMemberJoiningRuleUpdate managingAccount(String managingAccount) {
  ...
  public AllowMemberJoiningRuleUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllowMemberJoiningRuleUpdate allowMemberJoiningRuleUpdate = (AllowMemberJoiningRuleUpdate) o;
    return Objects.equals(this.capacityMax, allowMemberJoiningRuleUpdate.capacityMax) &&
        Objects.equals(this.capacityMin, allowMemberJoiningRuleUpdate.capacityMin) &&
        Objects.equals(this.consumingAccount, allowMemberJoiningRuleUpdate.consumingAccount) &&
        Objects.equals(this.externalRef, allowMemberJoiningRuleUpdate.externalRef) &&
        Objects.equals(this.managingAccount, allowMemberJoiningRuleUpdate.managingAccount) &&
        Objects.equals(this.type, allowMemberJoiningRuleUpdate.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AllowMemberJoiningRuleUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllowMemberJoiningRuleUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllowMemberJoiningRuleUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllowMemberJoiningRuleUpdate is not found in the empty JSON string", AllowMemberJoiningRuleUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllowMemberJoiningRuleUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllowMemberJoiningRuleUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllowMemberJoiningRuleUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllowMemberJoiningRuleUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllowMemberJoiningRuleUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllowMemberJoiningRuleUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllowMemberJoiningRuleUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<AllowMemberJoiningRuleUpdate>() {
           @Override
           public void write(JsonWriter out, AllowMemberJoiningRuleUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllowMemberJoiningRuleUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllowMemberJoiningRuleUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllowMemberJoiningRuleUpdate
   * @throws IOException if the JSON string is invalid with respect to AllowMemberJoiningRuleUpdate
   */
  public static AllowMemberJoiningRuleUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllowMemberJoiningRuleUpdate.class);
  }

  /**
   * Convert an instance of AllowMemberJoiningRuleUpdate to an JSON string
   *
   * @return JSON string
   */
