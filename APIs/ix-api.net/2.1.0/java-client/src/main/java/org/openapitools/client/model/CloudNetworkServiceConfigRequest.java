...
public class CloudNetworkServiceConfigRequest {
  ...
  public CloudNetworkServiceConfigRequest() {
  }
  ...
  public CloudNetworkServiceConfigRequest billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceConfigRequest cloudVlan(Integer cloudVlan) {
  ...
  public CloudNetworkServiceConfigRequest connection(String connection) {
  ...
  public CloudNetworkServiceConfigRequest consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceConfigRequest contractRef(String contractRef) {
  ...
  public CloudNetworkServiceConfigRequest externalRef(String externalRef) {
  ...
  public CloudNetworkServiceConfigRequest handover(Integer handover) {
  ...
  public CloudNetworkServiceConfigRequest managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceConfigRequest networkService(String networkService) {
  ...
  public CloudNetworkServiceConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public CloudNetworkServiceConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public CloudNetworkServiceConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CloudNetworkServiceConfigRequest vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceConfigRequest cloudNetworkServiceConfigRequest = (CloudNetworkServiceConfigRequest) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceConfigRequest.billingAccount) &&
        Objects.equals(this.cloudVlan, cloudNetworkServiceConfigRequest.cloudVlan) &&
        Objects.equals(this.connection, cloudNetworkServiceConfigRequest.connection) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, cloudNetworkServiceConfigRequest.externalRef) &&
        Objects.equals(this.handover, cloudNetworkServiceConfigRequest.handover) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceConfigRequest.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, cloudNetworkServiceConfigRequest.networkFeatureConfigs) &&
        Objects.equals(this.networkService, cloudNetworkServiceConfigRequest.networkService) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceConfigRequest.purchaseOrder) &&
        Objects.equals(this.roleAssignments, cloudNetworkServiceConfigRequest.roleAssignments) &&
        Objects.equals(this.type, cloudNetworkServiceConfigRequest.type) &&
        Objects.equals(this.vlanConfig, cloudNetworkServiceConfigRequest.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudNetworkServiceConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceConfigRequest is not found in the empty JSON string", CloudNetworkServiceConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceConfigRequest>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceConfigRequest
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceConfigRequest
   */
  public static CloudNetworkServiceConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceConfigRequest.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceConfigRequest to an JSON string
   *
   * @return JSON string
   */
