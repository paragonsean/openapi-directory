...
public class IpAddressUpdatePartial {
  ...
  public IpAddressUpdatePartial() {
  }

  public IpAddressUpdatePartial address(String address) {
  ...
  public IpAddressUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public IpAddressUpdatePartial externalRef(String externalRef) {
  ...
  public IpAddressUpdatePartial fqdn(String fqdn) {
    this.fqdn = fqdn;
    return this;
  }
  ...
  public IpAddressUpdatePartial managingAccount(String managingAccount) {
  ...
  public IpAddressUpdatePartial prefixLength(Integer prefixLength) {
  ...
  public IpAddressUpdatePartial validNotAfter(OffsetDateTime validNotAfter) {
  ...
  public IpAddressUpdatePartial validNotBefore(OffsetDateTime validNotBefore) {
  ...
  public IpAddressUpdatePartial version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    IpAddressUpdatePartial ipAddressUpdatePartial = (IpAddressUpdatePartial) o;
    return Objects.equals(this.address, ipAddressUpdatePartial.address) &&
        Objects.equals(this.consumingAccount, ipAddressUpdatePartial.consumingAccount) &&
        Objects.equals(this.externalRef, ipAddressUpdatePartial.externalRef) &&
        Objects.equals(this.fqdn, ipAddressUpdatePartial.fqdn) &&
        Objects.equals(this.managingAccount, ipAddressUpdatePartial.managingAccount) &&
        Objects.equals(this.prefixLength, ipAddressUpdatePartial.prefixLength) &&
        Objects.equals(this.validNotAfter, ipAddressUpdatePartial.validNotAfter) &&
        Objects.equals(this.validNotBefore, ipAddressUpdatePartial.validNotBefore) &&
        Objects.equals(this.version, ipAddressUpdatePartial.version);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, consumingAccount, externalRef, fqdn, managingAccount, prefixLength, validNotAfter, validNotBefore, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class IpAddressUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpAddressUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpAddressUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpAddressUpdatePartial is not found in the empty JSON string", IpAddressUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpAddressUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpAddressUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IpAddressUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IpAddressUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IpAddressUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpAddressUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<IpAddressUpdatePartial>() {
           @Override
           public void write(JsonWriter out, IpAddressUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IpAddressUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IpAddressUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IpAddressUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to IpAddressUpdatePartial
   */
  public static IpAddressUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IpAddressUpdatePartial.class);
  }

  /**
   * Convert an instance of IpAddressUpdatePartial to an JSON string
   *
   * @return JSON string
   */
