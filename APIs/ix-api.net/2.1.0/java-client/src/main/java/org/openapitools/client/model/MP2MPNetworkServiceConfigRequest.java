...
public class MP2MPNetworkServiceConfigRequest {
  ...
  public MP2MPNetworkServiceConfigRequest() {
  }
  ...
  public MP2MPNetworkServiceConfigRequest billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequest capacity(Integer capacity) {
  ...
  public MP2MPNetworkServiceConfigRequest connection(String connection) {
  ...
  public MP2MPNetworkServiceConfigRequest consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequest contractRef(String contractRef) {
  ...
  public MP2MPNetworkServiceConfigRequest externalRef(String externalRef) {
  ...
  public MP2MPNetworkServiceConfigRequest macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public MP2MPNetworkServiceConfigRequest addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public MP2MPNetworkServiceConfigRequest managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequest networkService(String networkService) {
  ...
  public MP2MPNetworkServiceConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServiceConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public MP2MPNetworkServiceConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public MP2MPNetworkServiceConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigRequest vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServiceConfigRequest mp2MPNetworkServiceConfigRequest = (MP2MPNetworkServiceConfigRequest) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServiceConfigRequest.billingAccount) &&
        Objects.equals(this.capacity, mp2MPNetworkServiceConfigRequest.capacity) &&
        Objects.equals(this.connection, mp2MPNetworkServiceConfigRequest.connection) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServiceConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServiceConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, mp2MPNetworkServiceConfigRequest.externalRef) &&
        Objects.equals(this.macs, mp2MPNetworkServiceConfigRequest.macs) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServiceConfigRequest.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, mp2MPNetworkServiceConfigRequest.networkFeatureConfigs) &&
        Objects.equals(this.networkService, mp2MPNetworkServiceConfigRequest.networkService) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServiceConfigRequest.purchaseOrder) &&
        Objects.equals(this.roleAssignments, mp2MPNetworkServiceConfigRequest.roleAssignments) &&
        Objects.equals(this.type, mp2MPNetworkServiceConfigRequest.type) &&
        Objects.equals(this.vlanConfig, mp2MPNetworkServiceConfigRequest.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServiceConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServiceConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServiceConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServiceConfigRequest is not found in the empty JSON string", MP2MPNetworkServiceConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServiceConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServiceConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServiceConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServiceConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServiceConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServiceConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServiceConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServiceConfigRequest>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServiceConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServiceConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServiceConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServiceConfigRequest
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServiceConfigRequest
   */
  public static MP2MPNetworkServiceConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServiceConfigRequest.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServiceConfigRequest to an JSON string
   *
   * @return JSON string
   */
