...
public class ContactPartial {
  ...
  public ContactPartial consumingAccount(String consumingAccount) {
  ...
  public ContactPartial email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactPartial externalRef(String externalRef) {
  ...
  public ContactPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ContactPartial managingAccount(String managingAccount) {
  ...
  public ContactPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ContactPartial telephone(String telephone) {
  ...
  public boolean equals(Object o) {
    ...
    ContactPartial contactPartial = (ContactPartial) o;
    return Objects.equals(this.consumingAccount, contactPartial.consumingAccount) &&
        Objects.equals(this.email, contactPartial.email) &&
        Objects.equals(this.externalRef, contactPartial.externalRef) &&
        Objects.equals(this.id, contactPartial.id) &&
        Objects.equals(this.managingAccount, contactPartial.managingAccount) &&
        Objects.equals(this.name, contactPartial.name) &&
        Objects.equals(this.telephone, contactPartial.telephone);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactPartial is not found in the empty JSON string", ContactPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactPartial>() {
           @Override
           public void write(JsonWriter out, ContactPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactPartial
   * @throws IOException if the JSON string is invalid with respect to ContactPartial
   */
  public static ContactPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactPartial.class);
  }

  /**
   * Convert an instance of ContactPartial to an JSON string
   *
   * @return JSON string
   */
