...
public class P2PNetworkServiceConfigUpdatePartial {
  ...
  public P2PNetworkServiceConfigUpdatePartial() {
  }
  ...
  public P2PNetworkServiceConfigUpdatePartial billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfigUpdatePartial capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfigUpdatePartial connection(String connection) {
  ...
  public P2PNetworkServiceConfigUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfigUpdatePartial contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfigUpdatePartial externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfigUpdatePartial managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfigUpdatePartial purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfigUpdatePartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfigUpdatePartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfigUpdatePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfigUpdatePartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfigUpdatePartial p2PNetworkServiceConfigUpdatePartial = (P2PNetworkServiceConfigUpdatePartial) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfigUpdatePartial.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfigUpdatePartial.capacity) &&
        Objects.equals(this.connection, p2PNetworkServiceConfigUpdatePartial.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfigUpdatePartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfigUpdatePartial.contractRef) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfigUpdatePartial.externalRef) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfigUpdatePartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfigUpdatePartial.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfigUpdatePartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfigUpdatePartial.roleAssignments) &&
        Objects.equals(this.type, p2PNetworkServiceConfigUpdatePartial.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfigUpdatePartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfigUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfigUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfigUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfigUpdatePartial is not found in the empty JSON string", P2PNetworkServiceConfigUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfigUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfigUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfigUpdatePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfigUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfigUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfigUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfigUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfigUpdatePartial>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfigUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfigUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfigUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfigUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfigUpdatePartial
   */
  public static P2PNetworkServiceConfigUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfigUpdatePartial.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfigUpdatePartial to an JSON string
   *
   * @return JSON string
   */
