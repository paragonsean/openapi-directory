...
public class MP2MPNetworkProductOfferingPartial {
  ...
  public MP2MPNetworkProductOfferingPartial() {
  }

  public MP2MPNetworkProductOfferingPartial bandwidthMax(Integer bandwidthMax) {
  ...
  public MP2MPNetworkProductOfferingPartial bandwidthMin(Integer bandwidthMin) {
  ...
  public MP2MPNetworkProductOfferingPartial displayName(String displayName) {
  ...
  public MP2MPNetworkProductOfferingPartial downgradeAllowed(Boolean downgradeAllowed) {
  ...
  public MP2MPNetworkProductOfferingPartial handoverMetroArea(String handoverMetroArea) {
  ...
  public MP2MPNetworkProductOfferingPartial handoverMetroAreaNetwork(String handoverMetroAreaNetwork) {
  ...
  public MP2MPNetworkProductOfferingPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MP2MPNetworkProductOfferingPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MP2MPNetworkProductOfferingPartial physicalPortSpeed(Integer physicalPortSpeed) {
  ...
  public MP2MPNetworkProductOfferingPartial providerVlans(ProviderVlansEnum providerVlans) {
  ...
  public MP2MPNetworkProductOfferingPartial resourceType(ResourceTypeEnum resourceType) {
  ...
  public MP2MPNetworkProductOfferingPartial serviceMetroArea(String serviceMetroArea) {
  ...
  public MP2MPNetworkProductOfferingPartial serviceMetroAreaNetwork(String serviceMetroAreaNetwork) {
  ...
  public MP2MPNetworkProductOfferingPartial serviceProvider(String serviceProvider) {
  ...
  public MP2MPNetworkProductOfferingPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MP2MPNetworkProductOfferingPartial upgradeAllowed(Boolean upgradeAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkProductOfferingPartial mp2MPNetworkProductOfferingPartial = (MP2MPNetworkProductOfferingPartial) o;
    return Objects.equals(this.bandwidthMax, mp2MPNetworkProductOfferingPartial.bandwidthMax) &&
        Objects.equals(this.bandwidthMin, mp2MPNetworkProductOfferingPartial.bandwidthMin) &&
        Objects.equals(this.displayName, mp2MPNetworkProductOfferingPartial.displayName) &&
        Objects.equals(this.downgradeAllowed, mp2MPNetworkProductOfferingPartial.downgradeAllowed) &&
        Objects.equals(this.handoverMetroArea, mp2MPNetworkProductOfferingPartial.handoverMetroArea) &&
        Objects.equals(this.handoverMetroAreaNetwork, mp2MPNetworkProductOfferingPartial.handoverMetroAreaNetwork) &&
        Objects.equals(this.id, mp2MPNetworkProductOfferingPartial.id) &&
        Objects.equals(this.name, mp2MPNetworkProductOfferingPartial.name) &&
        Objects.equals(this.physicalPortSpeed, mp2MPNetworkProductOfferingPartial.physicalPortSpeed) &&
        Objects.equals(this.providerVlans, mp2MPNetworkProductOfferingPartial.providerVlans) &&
        Objects.equals(this.resourceType, mp2MPNetworkProductOfferingPartial.resourceType) &&
        Objects.equals(this.serviceMetroArea, mp2MPNetworkProductOfferingPartial.serviceMetroArea) &&
        Objects.equals(this.serviceMetroAreaNetwork, mp2MPNetworkProductOfferingPartial.serviceMetroAreaNetwork) &&
        Objects.equals(this.serviceProvider, mp2MPNetworkProductOfferingPartial.serviceProvider) &&
        Objects.equals(this.type, mp2MPNetworkProductOfferingPartial.type) &&
        Objects.equals(this.upgradeAllowed, mp2MPNetworkProductOfferingPartial.upgradeAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkProductOfferingPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkProductOfferingPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkProductOfferingPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkProductOfferingPartial is not found in the empty JSON string", MP2MPNetworkProductOfferingPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkProductOfferingPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkProductOfferingPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkProductOfferingPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkProductOfferingPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkProductOfferingPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkProductOfferingPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkProductOfferingPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkProductOfferingPartial>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkProductOfferingPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkProductOfferingPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkProductOfferingPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkProductOfferingPartial
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkProductOfferingPartial
   */
  public static MP2MPNetworkProductOfferingPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkProductOfferingPartial.class);
  }

  /**
   * Convert an instance of MP2MPNetworkProductOfferingPartial to an JSON string
   *
   * @return JSON string
   */
