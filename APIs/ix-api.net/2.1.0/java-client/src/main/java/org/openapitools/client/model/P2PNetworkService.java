...
public class P2PNetworkService {
  ...
  public P2PNetworkService billingAccount(String billingAccount) {
  ...
  public P2PNetworkService capacity(Integer capacity) {
  ...
  public P2PNetworkService chargedUntil(LocalDate chargedUntil) {
  ...
  public P2PNetworkService consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkService contractRef(String contractRef) {
  ...
  public P2PNetworkService decommissionAt(LocalDate decommissionAt) {
  ...
  public P2PNetworkService externalRef(String externalRef) {
  ...
  public P2PNetworkService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2PNetworkService joiningMemberAccount(String joiningMemberAccount) {
  ...
  public P2PNetworkService managingAccount(String managingAccount) {
  ...
  public P2PNetworkService productOffering(String productOffering) {
  ...
  public P2PNetworkService purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkService state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2PNetworkService status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2PNetworkService addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2PNetworkService type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkService p2PNetworkService = (P2PNetworkService) o;
    return Objects.equals(this.billingAccount, p2PNetworkService.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkService.capacity) &&
        Objects.equals(this.chargedUntil, p2PNetworkService.chargedUntil) &&
        Objects.equals(this.consumingAccount, p2PNetworkService.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkService.contractRef) &&
        Objects.equals(this.decommissionAt, p2PNetworkService.decommissionAt) &&
        Objects.equals(this.externalRef, p2PNetworkService.externalRef) &&
        Objects.equals(this.id, p2PNetworkService.id) &&
        Objects.equals(this.joiningMemberAccount, p2PNetworkService.joiningMemberAccount) &&
        Objects.equals(this.managingAccount, p2PNetworkService.managingAccount) &&
        Objects.equals(this.nscRequiredContactRoles, p2PNetworkService.nscRequiredContactRoles) &&
        Objects.equals(this.productOffering, p2PNetworkService.productOffering) &&
        Objects.equals(this.purchaseOrder, p2PNetworkService.purchaseOrder) &&
        Objects.equals(this.state, p2PNetworkService.state) &&
        Objects.equals(this.status, p2PNetworkService.status) &&
        Objects.equals(this.type, p2PNetworkService.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkService is not found in the empty JSON string", P2PNetworkService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkService.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkService.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkService>() {
           @Override
           public void write(JsonWriter out, P2PNetworkService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkService
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkService
   */
  public static P2PNetworkService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkService.class);
  }

  /**
   * Convert an instance of P2PNetworkService to an JSON string
   *
   * @return JSON string
   */
