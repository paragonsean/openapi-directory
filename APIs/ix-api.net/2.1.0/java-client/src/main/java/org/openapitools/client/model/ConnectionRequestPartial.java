...
public class ConnectionRequestPartial {
  ...
  public ConnectionRequestPartial() {
  }

  public ConnectionRequestPartial billingAccount(String billingAccount) {
  ...
  public ConnectionRequestPartial consumingAccount(String consumingAccount) {
  ...
  public ConnectionRequestPartial contractRef(String contractRef) {
  ...
  public ConnectionRequestPartial externalRef(String externalRef) {
  ...
  public ConnectionRequestPartial lacpTimeout(LacpTimeoutEnum lacpTimeout) {
  ...
  public ConnectionRequestPartial managingAccount(String managingAccount) {
  ...
  public ConnectionRequestPartial mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public ConnectionRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public ConnectionRequestPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ConnectionRequestPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ConnectionRequestPartial speed(Integer speed) {
    this.speed = speed;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConnectionRequestPartial connectionRequestPartial = (ConnectionRequestPartial) o;
    return Objects.equals(this.billingAccount, connectionRequestPartial.billingAccount) &&
        Objects.equals(this.consumingAccount, connectionRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, connectionRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, connectionRequestPartial.externalRef) &&
        Objects.equals(this.lacpTimeout, connectionRequestPartial.lacpTimeout) &&
        Objects.equals(this.managingAccount, connectionRequestPartial.managingAccount) &&
        Objects.equals(this.mode, connectionRequestPartial.mode) &&
        Objects.equals(this.purchaseOrder, connectionRequestPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, connectionRequestPartial.roleAssignments) &&
        Objects.equals(this.speed, connectionRequestPartial.speed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionRequestPartial is not found in the empty JSON string", ConnectionRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionRequestPartial>() {
           @Override
           public void write(JsonWriter out, ConnectionRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionRequestPartial
   * @throws IOException if the JSON string is invalid with respect to ConnectionRequestPartial
   */
  public static ConnectionRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionRequestPartial.class);
  }

  /**
   * Convert an instance of ConnectionRequestPartial to an JSON string
   *
   * @return JSON string
   */
