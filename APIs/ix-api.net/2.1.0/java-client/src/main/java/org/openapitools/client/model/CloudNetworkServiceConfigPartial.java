...
public class CloudNetworkServiceConfigPartial {
  ...
  public CloudNetworkServiceConfigPartial() {
  }
  ...
  public CloudNetworkServiceConfigPartial billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceConfigPartial chargedUntil(LocalDate chargedUntil) {
  ...
  public CloudNetworkServiceConfigPartial cloudVlan(Integer cloudVlan) {
  ...
  public CloudNetworkServiceConfigPartial connection(String connection) {
  ...
  public CloudNetworkServiceConfigPartial consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceConfigPartial contractRef(String contractRef) {
  ...
  public CloudNetworkServiceConfigPartial decommissionAt(LocalDate decommissionAt) {
  ...
  public CloudNetworkServiceConfigPartial externalRef(String externalRef) {
  ...
  public CloudNetworkServiceConfigPartial handover(Integer handover) {
  ...
  public CloudNetworkServiceConfigPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CloudNetworkServiceConfigPartial managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceConfigPartial networkService(String networkService) {
  ...
  public CloudNetworkServiceConfigPartial purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceConfigPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public CloudNetworkServiceConfigPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public CloudNetworkServiceConfigPartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public CloudNetworkServiceConfigPartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public CloudNetworkServiceConfigPartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public CloudNetworkServiceConfigPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CloudNetworkServiceConfigPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceConfigPartial cloudNetworkServiceConfigPartial = (CloudNetworkServiceConfigPartial) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceConfigPartial.billingAccount) &&
        Objects.equals(this.chargedUntil, cloudNetworkServiceConfigPartial.chargedUntil) &&
        Objects.equals(this.cloudVlan, cloudNetworkServiceConfigPartial.cloudVlan) &&
        Objects.equals(this.connection, cloudNetworkServiceConfigPartial.connection) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceConfigPartial.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceConfigPartial.contractRef) &&
        Objects.equals(this.decommissionAt, cloudNetworkServiceConfigPartial.decommissionAt) &&
        Objects.equals(this.externalRef, cloudNetworkServiceConfigPartial.externalRef) &&
        Objects.equals(this.handover, cloudNetworkServiceConfigPartial.handover) &&
        Objects.equals(this.id, cloudNetworkServiceConfigPartial.id) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceConfigPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, cloudNetworkServiceConfigPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, cloudNetworkServiceConfigPartial.networkService) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceConfigPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, cloudNetworkServiceConfigPartial.roleAssignments) &&
        Objects.equals(this.state, cloudNetworkServiceConfigPartial.state) &&
        Objects.equals(this.status, cloudNetworkServiceConfigPartial.status) &&
        Objects.equals(this.type, cloudNetworkServiceConfigPartial.type) &&
        Objects.equals(this.vlanConfig, cloudNetworkServiceConfigPartial.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, chargedUntil, cloudVlan, connection, consumingAccount, contractRef, decommissionAt, externalRef, handover, id, managingAccount, networkFeatureConfigs, networkService, purchaseOrder, roleAssignments, state, status, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudNetworkServiceConfigPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceConfigPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceConfigPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceConfigPartial is not found in the empty JSON string", CloudNetworkServiceConfigPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceConfigPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceConfigPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceConfigPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceConfigPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceConfigPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceConfigPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceConfigPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceConfigPartial>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceConfigPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceConfigPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceConfigPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceConfigPartial
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceConfigPartial
   */
  public static CloudNetworkServiceConfigPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceConfigPartial.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceConfigPartial to an JSON string
   *
   * @return JSON string
   */
