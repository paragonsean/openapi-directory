...
public class RouteServerNetworkFeatureConfigUpdatePartial {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial() {
  }

  public RouteServerNetworkFeatureConfigUpdatePartial asSetV4(String asSetV4) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial asSetV6(String asSetV6) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial asn(Long asn) {
    this.asn = asn;
    return this;
  }
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial bgpSessionType(BgpSessionTypeEnum bgpSessionType) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial externalRef(String externalRef) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial insertIxpAsn(Boolean insertIxpAsn) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial managingAccount(String managingAccount) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial maxPrefixV4(Integer maxPrefixV4) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial maxPrefixV6(Integer maxPrefixV6) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial password(String password) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial sessionMode(SessionModeEnum sessionMode) {
  ...
  public RouteServerNetworkFeatureConfigUpdatePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RouteServerNetworkFeatureConfigUpdatePartial routeServerNetworkFeatureConfigUpdatePartial = (RouteServerNetworkFeatureConfigUpdatePartial) o;
    return Objects.equals(this.asSetV4, routeServerNetworkFeatureConfigUpdatePartial.asSetV4) &&
        Objects.equals(this.asSetV6, routeServerNetworkFeatureConfigUpdatePartial.asSetV6) &&
        Objects.equals(this.asn, routeServerNetworkFeatureConfigUpdatePartial.asn) &&
        Objects.equals(this.bgpSessionType, routeServerNetworkFeatureConfigUpdatePartial.bgpSessionType) &&
        Objects.equals(this.consumingAccount, routeServerNetworkFeatureConfigUpdatePartial.consumingAccount) &&
        Objects.equals(this.externalRef, routeServerNetworkFeatureConfigUpdatePartial.externalRef) &&
        Objects.equals(this.insertIxpAsn, routeServerNetworkFeatureConfigUpdatePartial.insertIxpAsn) &&
        Objects.equals(this.ip, routeServerNetworkFeatureConfigUpdatePartial.ip) &&
        Objects.equals(this.managingAccount, routeServerNetworkFeatureConfigUpdatePartial.managingAccount) &&
        Objects.equals(this.maxPrefixV4, routeServerNetworkFeatureConfigUpdatePartial.maxPrefixV4) &&
        Objects.equals(this.maxPrefixV6, routeServerNetworkFeatureConfigUpdatePartial.maxPrefixV6) &&
        Objects.equals(this.password, routeServerNetworkFeatureConfigUpdatePartial.password) &&
        Objects.equals(this.sessionMode, routeServerNetworkFeatureConfigUpdatePartial.sessionMode) &&
        Objects.equals(this.type, routeServerNetworkFeatureConfigUpdatePartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class RouteServerNetworkFeatureConfigUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteServerNetworkFeatureConfigUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteServerNetworkFeatureConfigUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RouteServerNetworkFeatureConfigUpdatePartial is not found in the empty JSON string", RouteServerNetworkFeatureConfigUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteServerNetworkFeatureConfigUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RouteServerNetworkFeatureConfigUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RouteServerNetworkFeatureConfigUpdatePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RouteServerNetworkFeatureConfigUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RouteServerNetworkFeatureConfigUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RouteServerNetworkFeatureConfigUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RouteServerNetworkFeatureConfigUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<RouteServerNetworkFeatureConfigUpdatePartial>() {
           @Override
           public void write(JsonWriter out, RouteServerNetworkFeatureConfigUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RouteServerNetworkFeatureConfigUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RouteServerNetworkFeatureConfigUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RouteServerNetworkFeatureConfigUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to RouteServerNetworkFeatureConfigUpdatePartial
   */
  public static RouteServerNetworkFeatureConfigUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RouteServerNetworkFeatureConfigUpdatePartial.class);
  }

  /**
   * Convert an instance of RouteServerNetworkFeatureConfigUpdatePartial to an JSON string
   *
   * @return JSON string
   */
