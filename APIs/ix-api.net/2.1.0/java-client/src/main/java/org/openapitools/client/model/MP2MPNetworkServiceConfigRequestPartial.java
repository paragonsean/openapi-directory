...
public class MP2MPNetworkServiceConfigRequestPartial {
  ...
  public MP2MPNetworkServiceConfigRequestPartial() {
  }
  ...
  public MP2MPNetworkServiceConfigRequestPartial billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial capacity(Integer capacity) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial connection(String connection) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial contractRef(String contractRef) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial externalRef(String externalRef) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public MP2MPNetworkServiceConfigRequestPartial addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial networkService(String networkService) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public MP2MPNetworkServiceConfigRequestPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public MP2MPNetworkServiceConfigRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigRequestPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServiceConfigRequestPartial mp2MPNetworkServiceConfigRequestPartial = (MP2MPNetworkServiceConfigRequestPartial) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServiceConfigRequestPartial.billingAccount) &&
        Objects.equals(this.capacity, mp2MPNetworkServiceConfigRequestPartial.capacity) &&
        Objects.equals(this.connection, mp2MPNetworkServiceConfigRequestPartial.connection) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServiceConfigRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServiceConfigRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, mp2MPNetworkServiceConfigRequestPartial.externalRef) &&
        Objects.equals(this.macs, mp2MPNetworkServiceConfigRequestPartial.macs) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServiceConfigRequestPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, mp2MPNetworkServiceConfigRequestPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, mp2MPNetworkServiceConfigRequestPartial.networkService) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServiceConfigRequestPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, mp2MPNetworkServiceConfigRequestPartial.roleAssignments) &&
        Objects.equals(this.type, mp2MPNetworkServiceConfigRequestPartial.type) &&
        Objects.equals(this.vlanConfig, mp2MPNetworkServiceConfigRequestPartial.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, connection, consumingAccount, contractRef, externalRef, macs, managingAccount, networkFeatureConfigs, networkService, purchaseOrder, roleAssignments, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServiceConfigRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServiceConfigRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServiceConfigRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServiceConfigRequestPartial is not found in the empty JSON string", MP2MPNetworkServiceConfigRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServiceConfigRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServiceConfigRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServiceConfigRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServiceConfigRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServiceConfigRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServiceConfigRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServiceConfigRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServiceConfigRequestPartial>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServiceConfigRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServiceConfigRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServiceConfigRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServiceConfigRequestPartial
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServiceConfigRequestPartial
   */
  public static MP2MPNetworkServiceConfigRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServiceConfigRequestPartial.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServiceConfigRequestPartial to an JSON string
   *
   * @return JSON string
   */
