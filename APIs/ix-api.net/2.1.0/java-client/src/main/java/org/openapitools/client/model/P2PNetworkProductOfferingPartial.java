...
public class P2PNetworkProductOfferingPartial {
  ...
  public P2PNetworkProductOfferingPartial() {
  }

  public P2PNetworkProductOfferingPartial bandwidthMax(Integer bandwidthMax) {
  ...
  public P2PNetworkProductOfferingPartial bandwidthMin(Integer bandwidthMin) {
  ...
  public P2PNetworkProductOfferingPartial displayName(String displayName) {
  ...
  public P2PNetworkProductOfferingPartial downgradeAllowed(Boolean downgradeAllowed) {
  ...
  public P2PNetworkProductOfferingPartial handoverMetroArea(String handoverMetroArea) {
  ...
  public P2PNetworkProductOfferingPartial handoverMetroAreaNetwork(String handoverMetroAreaNetwork) {
  ...
  public P2PNetworkProductOfferingPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2PNetworkProductOfferingPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2PNetworkProductOfferingPartial physicalPortSpeed(Integer physicalPortSpeed) {
  ...
  public P2PNetworkProductOfferingPartial providerVlans(ProviderVlansEnum providerVlans) {
  ...
  public P2PNetworkProductOfferingPartial resourceType(ResourceTypeEnum resourceType) {
  ...
  public P2PNetworkProductOfferingPartial serviceMetroArea(String serviceMetroArea) {
  ...
  public P2PNetworkProductOfferingPartial serviceMetroAreaNetwork(String serviceMetroAreaNetwork) {
  ...
  public P2PNetworkProductOfferingPartial serviceProvider(String serviceProvider) {
  ...
  public P2PNetworkProductOfferingPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkProductOfferingPartial upgradeAllowed(Boolean upgradeAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkProductOfferingPartial p2PNetworkProductOfferingPartial = (P2PNetworkProductOfferingPartial) o;
    return Objects.equals(this.bandwidthMax, p2PNetworkProductOfferingPartial.bandwidthMax) &&
        Objects.equals(this.bandwidthMin, p2PNetworkProductOfferingPartial.bandwidthMin) &&
        Objects.equals(this.displayName, p2PNetworkProductOfferingPartial.displayName) &&
        Objects.equals(this.downgradeAllowed, p2PNetworkProductOfferingPartial.downgradeAllowed) &&
        Objects.equals(this.handoverMetroArea, p2PNetworkProductOfferingPartial.handoverMetroArea) &&
        Objects.equals(this.handoverMetroAreaNetwork, p2PNetworkProductOfferingPartial.handoverMetroAreaNetwork) &&
        Objects.equals(this.id, p2PNetworkProductOfferingPartial.id) &&
        Objects.equals(this.name, p2PNetworkProductOfferingPartial.name) &&
        Objects.equals(this.physicalPortSpeed, p2PNetworkProductOfferingPartial.physicalPortSpeed) &&
        Objects.equals(this.providerVlans, p2PNetworkProductOfferingPartial.providerVlans) &&
        Objects.equals(this.resourceType, p2PNetworkProductOfferingPartial.resourceType) &&
        Objects.equals(this.serviceMetroArea, p2PNetworkProductOfferingPartial.serviceMetroArea) &&
        Objects.equals(this.serviceMetroAreaNetwork, p2PNetworkProductOfferingPartial.serviceMetroAreaNetwork) &&
        Objects.equals(this.serviceProvider, p2PNetworkProductOfferingPartial.serviceProvider) &&
        Objects.equals(this.type, p2PNetworkProductOfferingPartial.type) &&
        Objects.equals(this.upgradeAllowed, p2PNetworkProductOfferingPartial.upgradeAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkProductOfferingPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkProductOfferingPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkProductOfferingPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkProductOfferingPartial is not found in the empty JSON string", P2PNetworkProductOfferingPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkProductOfferingPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkProductOfferingPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkProductOfferingPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkProductOfferingPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkProductOfferingPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkProductOfferingPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkProductOfferingPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkProductOfferingPartial>() {
           @Override
           public void write(JsonWriter out, P2PNetworkProductOfferingPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkProductOfferingPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkProductOfferingPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkProductOfferingPartial
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkProductOfferingPartial
   */
  public static P2PNetworkProductOfferingPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkProductOfferingPartial.class);
  }

  /**
   * Convert an instance of P2PNetworkProductOfferingPartial to an JSON string
   *
   * @return JSON string
   */
