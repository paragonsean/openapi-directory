...
public class ContactUpdatePartial {
  ...
  public ContactUpdatePartial() {
  }

  public ContactUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public ContactUpdatePartial email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactUpdatePartial externalRef(String externalRef) {
  ...
  public ContactUpdatePartial managingAccount(String managingAccount) {
  ...
  public ContactUpdatePartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ContactUpdatePartial telephone(String telephone) {
  ...
  public boolean equals(Object o) {
    ...
    ContactUpdatePartial contactUpdatePartial = (ContactUpdatePartial) o;
    return Objects.equals(this.consumingAccount, contactUpdatePartial.consumingAccount) &&
        Objects.equals(this.email, contactUpdatePartial.email) &&
        Objects.equals(this.externalRef, contactUpdatePartial.externalRef) &&
        Objects.equals(this.managingAccount, contactUpdatePartial.managingAccount) &&
        Objects.equals(this.name, contactUpdatePartial.name) &&
        Objects.equals(this.telephone, contactUpdatePartial.telephone);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUpdatePartial is not found in the empty JSON string", ContactUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUpdatePartial>() {
           @Override
           public void write(JsonWriter out, ContactUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to ContactUpdatePartial
   */
  public static ContactUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUpdatePartial.class);
  }

  /**
   * Convert an instance of ContactUpdatePartial to an JSON string
   *
   * @return JSON string
   */
