...
public class P2PNetworkServiceRequest {
  ...
  public P2PNetworkServiceRequest() {
  }

  public P2PNetworkServiceRequest billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceRequest consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceRequest contractRef(String contractRef) {
  ...
  public P2PNetworkServiceRequest externalRef(String externalRef) {
  ...
  public P2PNetworkServiceRequest joiningMemberAccount(String joiningMemberAccount) {
  ...
  public P2PNetworkServiceRequest managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceRequest productOffering(String productOffering) {
  ...
  public P2PNetworkServiceRequest purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceRequest p2PNetworkServiceRequest = (P2PNetworkServiceRequest) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceRequest.billingAccount) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceRequest.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceRequest.contractRef) &&
        Objects.equals(this.externalRef, p2PNetworkServiceRequest.externalRef) &&
        Objects.equals(this.joiningMemberAccount, p2PNetworkServiceRequest.joiningMemberAccount) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceRequest.managingAccount) &&
        Objects.equals(this.productOffering, p2PNetworkServiceRequest.productOffering) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceRequest.purchaseOrder) &&
        Objects.equals(this.type, p2PNetworkServiceRequest.type);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("joining_member_account");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceRequest is not found in the empty JSON string", P2PNetworkServiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("joining_member_account").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceRequest>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceRequest
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceRequest
   */
  public static P2PNetworkServiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceRequest.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceRequest to an JSON string
   *
   * @return JSON string
   */
