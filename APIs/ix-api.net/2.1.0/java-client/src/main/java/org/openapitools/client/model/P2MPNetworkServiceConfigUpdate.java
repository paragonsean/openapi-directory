...
public class P2MPNetworkServiceConfigUpdate {
  ...
  public P2MPNetworkServiceConfigUpdate() {
  }
  ...
  public P2MPNetworkServiceConfigUpdate billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceConfigUpdate capacity(Integer capacity) {
  ...
  public P2MPNetworkServiceConfigUpdate connection(String connection) {
  ...
  public P2MPNetworkServiceConfigUpdate consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceConfigUpdate contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceConfigUpdate externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceConfigUpdate managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceConfigUpdate purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceConfigUpdate role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigUpdate roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2MPNetworkServiceConfigUpdate addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2MPNetworkServiceConfigUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigUpdate vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceConfigUpdate p2MPNetworkServiceConfigUpdate = (P2MPNetworkServiceConfigUpdate) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceConfigUpdate.billingAccount) &&
        Objects.equals(this.capacity, p2MPNetworkServiceConfigUpdate.capacity) &&
        Objects.equals(this.connection, p2MPNetworkServiceConfigUpdate.connection) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceConfigUpdate.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceConfigUpdate.contractRef) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceConfigUpdate.externalRef) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceConfigUpdate.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2MPNetworkServiceConfigUpdate.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceConfigUpdate.purchaseOrder) &&
        Objects.equals(this.role, p2MPNetworkServiceConfigUpdate.role) &&
        Objects.equals(this.roleAssignments, p2MPNetworkServiceConfigUpdate.roleAssignments) &&
        Objects.equals(this.type, p2MPNetworkServiceConfigUpdate.type) &&
        Objects.equals(this.vlanConfig, p2MPNetworkServiceConfigUpdate.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceConfigUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceConfigUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceConfigUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceConfigUpdate is not found in the empty JSON string", P2MPNetworkServiceConfigUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceConfigUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceConfigUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceConfigUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceConfigUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceConfigUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceConfigUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceConfigUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceConfigUpdate>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceConfigUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceConfigUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceConfigUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceConfigUpdate
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceConfigUpdate
   */
  public static P2MPNetworkServiceConfigUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceConfigUpdate.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceConfigUpdate to an JSON string
   *
   * @return JSON string
   */
