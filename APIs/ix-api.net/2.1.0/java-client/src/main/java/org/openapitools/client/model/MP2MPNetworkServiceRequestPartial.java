...
public class MP2MPNetworkServiceRequestPartial {
  ...
  public MP2MPNetworkServiceRequestPartial() {
  }

  public MP2MPNetworkServiceRequestPartial billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServiceRequestPartial consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServiceRequestPartial contractRef(String contractRef) {
  ...
  public MP2MPNetworkServiceRequestPartial externalRef(String externalRef) {
  ...
  public MP2MPNetworkServiceRequestPartial managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServiceRequestPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MP2MPNetworkServiceRequestPartial productOffering(String productOffering) {
  ...
  public MP2MPNetworkServiceRequestPartial _public(Boolean _public) {
  ...
  public MP2MPNetworkServiceRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServiceRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServiceRequestPartial mp2MPNetworkServiceRequestPartial = (MP2MPNetworkServiceRequestPartial) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServiceRequestPartial.billingAccount) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServiceRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServiceRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, mp2MPNetworkServiceRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServiceRequestPartial.managingAccount) &&
        Objects.equals(this.name, mp2MPNetworkServiceRequestPartial.name) &&
        Objects.equals(this.productOffering, mp2MPNetworkServiceRequestPartial.productOffering) &&
        Objects.equals(this._public, mp2MPNetworkServiceRequestPartial._public) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServiceRequestPartial.purchaseOrder) &&
        Objects.equals(this.type, mp2MPNetworkServiceRequestPartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServiceRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServiceRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServiceRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServiceRequestPartial is not found in the empty JSON string", MP2MPNetworkServiceRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServiceRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServiceRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServiceRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServiceRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServiceRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServiceRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServiceRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServiceRequestPartial>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServiceRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServiceRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServiceRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServiceRequestPartial
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServiceRequestPartial
   */
  public static MP2MPNetworkServiceRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServiceRequestPartial.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServiceRequestPartial to an JSON string
   *
   * @return JSON string
   */
