...
public class AllowMemberJoiningRuleRequest {
  ...
  public AllowMemberJoiningRuleRequest() {
  }

  public AllowMemberJoiningRuleRequest capacityMax(Integer capacityMax) {
  ...
  public AllowMemberJoiningRuleRequest capacityMin(Integer capacityMin) {
  ...
  public AllowMemberJoiningRuleRequest consumingAccount(String consumingAccount) {
  ...
  public AllowMemberJoiningRuleRequest externalRef(String externalRef) {
  ...
  public AllowMemberJoiningRuleRequest managingAccount(String managingAccount) {
  ...
  public AllowMemberJoiningRuleRequest networkService(String networkService) {
  ...
  public AllowMemberJoiningRuleRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllowMemberJoiningRuleRequest allowMemberJoiningRuleRequest = (AllowMemberJoiningRuleRequest) o;
    return Objects.equals(this.capacityMax, allowMemberJoiningRuleRequest.capacityMax) &&
        Objects.equals(this.capacityMin, allowMemberJoiningRuleRequest.capacityMin) &&
        Objects.equals(this.consumingAccount, allowMemberJoiningRuleRequest.consumingAccount) &&
        Objects.equals(this.externalRef, allowMemberJoiningRuleRequest.externalRef) &&
        Objects.equals(this.managingAccount, allowMemberJoiningRuleRequest.managingAccount) &&
        Objects.equals(this.networkService, allowMemberJoiningRuleRequest.networkService) &&
        Objects.equals(this.type, allowMemberJoiningRuleRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AllowMemberJoiningRuleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllowMemberJoiningRuleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllowMemberJoiningRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllowMemberJoiningRuleRequest is not found in the empty JSON string", AllowMemberJoiningRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllowMemberJoiningRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllowMemberJoiningRuleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllowMemberJoiningRuleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllowMemberJoiningRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllowMemberJoiningRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllowMemberJoiningRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllowMemberJoiningRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AllowMemberJoiningRuleRequest>() {
           @Override
           public void write(JsonWriter out, AllowMemberJoiningRuleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllowMemberJoiningRuleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllowMemberJoiningRuleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllowMemberJoiningRuleRequest
   * @throws IOException if the JSON string is invalid with respect to AllowMemberJoiningRuleRequest
   */
  public static AllowMemberJoiningRuleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllowMemberJoiningRuleRequest.class);
  }

  /**
   * Convert an instance of AllowMemberJoiningRuleRequest to an JSON string
   *
   * @return JSON string
   */
