...
public class AllowMemberJoiningRule {
  ...
  public AllowMemberJoiningRule() {
  }

  public AllowMemberJoiningRule capacityMax(Integer capacityMax) {
  ...
  public AllowMemberJoiningRule capacityMin(Integer capacityMin) {
  ...
  public AllowMemberJoiningRule consumingAccount(String consumingAccount) {
  ...
  public AllowMemberJoiningRule externalRef(String externalRef) {
  ...
  public AllowMemberJoiningRule id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AllowMemberJoiningRule managingAccount(String managingAccount) {
  ...
  public AllowMemberJoiningRule networkService(String networkService) {
  ...
  public AllowMemberJoiningRule type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllowMemberJoiningRule allowMemberJoiningRule = (AllowMemberJoiningRule) o;
    return Objects.equals(this.capacityMax, allowMemberJoiningRule.capacityMax) &&
        Objects.equals(this.capacityMin, allowMemberJoiningRule.capacityMin) &&
        Objects.equals(this.consumingAccount, allowMemberJoiningRule.consumingAccount) &&
        Objects.equals(this.externalRef, allowMemberJoiningRule.externalRef) &&
        Objects.equals(this.id, allowMemberJoiningRule.id) &&
        Objects.equals(this.managingAccount, allowMemberJoiningRule.managingAccount) &&
        Objects.equals(this.networkService, allowMemberJoiningRule.networkService) &&
        Objects.equals(this.type, allowMemberJoiningRule.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AllowMemberJoiningRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllowMemberJoiningRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllowMemberJoiningRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllowMemberJoiningRule is not found in the empty JSON string", AllowMemberJoiningRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllowMemberJoiningRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllowMemberJoiningRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllowMemberJoiningRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllowMemberJoiningRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllowMemberJoiningRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllowMemberJoiningRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllowMemberJoiningRule.class));

       return (TypeAdapter<T>) new TypeAdapter<AllowMemberJoiningRule>() {
           @Override
           public void write(JsonWriter out, AllowMemberJoiningRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllowMemberJoiningRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllowMemberJoiningRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllowMemberJoiningRule
   * @throws IOException if the JSON string is invalid with respect to AllowMemberJoiningRule
   */
  public static AllowMemberJoiningRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllowMemberJoiningRule.class);
  }

  /**
   * Convert an instance of AllowMemberJoiningRule to an JSON string
   *
   * @return JSON string
   */
