...
public class DenyMemberJoiningRulePartial {
  ...
  public DenyMemberJoiningRulePartial() {
  }

  public DenyMemberJoiningRulePartial consumingAccount(String consumingAccount) {
  ...
  public DenyMemberJoiningRulePartial externalRef(String externalRef) {
  ...
  public DenyMemberJoiningRulePartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DenyMemberJoiningRulePartial managingAccount(String managingAccount) {
  ...
  public DenyMemberJoiningRulePartial networkService(String networkService) {
  ...
  public DenyMemberJoiningRulePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DenyMemberJoiningRulePartial denyMemberJoiningRulePartial = (DenyMemberJoiningRulePartial) o;
    return Objects.equals(this.consumingAccount, denyMemberJoiningRulePartial.consumingAccount) &&
        Objects.equals(this.externalRef, denyMemberJoiningRulePartial.externalRef) &&
        Objects.equals(this.id, denyMemberJoiningRulePartial.id) &&
        Objects.equals(this.managingAccount, denyMemberJoiningRulePartial.managingAccount) &&
        Objects.equals(this.networkService, denyMemberJoiningRulePartial.networkService) &&
        Objects.equals(this.type, denyMemberJoiningRulePartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DenyMemberJoiningRulePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DenyMemberJoiningRulePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DenyMemberJoiningRulePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DenyMemberJoiningRulePartial is not found in the empty JSON string", DenyMemberJoiningRulePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DenyMemberJoiningRulePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DenyMemberJoiningRulePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DenyMemberJoiningRulePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DenyMemberJoiningRulePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DenyMemberJoiningRulePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DenyMemberJoiningRulePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DenyMemberJoiningRulePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<DenyMemberJoiningRulePartial>() {
           @Override
           public void write(JsonWriter out, DenyMemberJoiningRulePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DenyMemberJoiningRulePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DenyMemberJoiningRulePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DenyMemberJoiningRulePartial
   * @throws IOException if the JSON string is invalid with respect to DenyMemberJoiningRulePartial
   */
  public static DenyMemberJoiningRulePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DenyMemberJoiningRulePartial.class);
  }

  /**
   * Convert an instance of DenyMemberJoiningRulePartial to an JSON string
   *
   * @return JSON string
   */
