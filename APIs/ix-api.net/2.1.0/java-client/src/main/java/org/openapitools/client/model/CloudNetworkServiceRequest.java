...
public class CloudNetworkServiceRequest {
  ...
  public CloudNetworkServiceRequest billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceRequest capacity(Integer capacity) {
  ...
  public CloudNetworkServiceRequest cloudKey(String cloudKey) {
  ...
  public CloudNetworkServiceRequest consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceRequest contractRef(String contractRef) {
  ...
  public CloudNetworkServiceRequest externalRef(String externalRef) {
  ...
  public CloudNetworkServiceRequest managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceRequest productOffering(String productOffering) {
  ...
  public CloudNetworkServiceRequest purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceRequest cloudNetworkServiceRequest = (CloudNetworkServiceRequest) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceRequest.billingAccount) &&
        Objects.equals(this.capacity, cloudNetworkServiceRequest.capacity) &&
        Objects.equals(this.cloudKey, cloudNetworkServiceRequest.cloudKey) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceRequest.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceRequest.contractRef) &&
        Objects.equals(this.externalRef, cloudNetworkServiceRequest.externalRef) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceRequest.managingAccount) &&
        Objects.equals(this.productOffering, cloudNetworkServiceRequest.productOffering) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceRequest.purchaseOrder) &&
        Objects.equals(this.type, cloudNetworkServiceRequest.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, cloudKey, consumingAccount, contractRef, externalRef, managingAccount, productOffering, purchaseOrder, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceRequest is not found in the empty JSON string", CloudNetworkServiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceRequest>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceRequest
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceRequest
   */
  public static CloudNetworkServiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceRequest.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceRequest to an JSON string
   *
   * @return JSON string
   */
