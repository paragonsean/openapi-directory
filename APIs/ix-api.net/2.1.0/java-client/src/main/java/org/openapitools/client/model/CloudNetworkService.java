...
public class CloudNetworkService {
  ...
  public CloudNetworkService billingAccount(String billingAccount) {
  ...
  public CloudNetworkService capacity(Integer capacity) {
  ...
  public CloudNetworkService chargedUntil(LocalDate chargedUntil) {
  ...
  public CloudNetworkService cloudKey(String cloudKey) {
  ...
  public CloudNetworkService consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkService contractRef(String contractRef) {
  ...
  public CloudNetworkService decommissionAt(LocalDate decommissionAt) {
  ...
  public CloudNetworkService diversity(Integer diversity) {
  ...
  public CloudNetworkService externalRef(String externalRef) {
  ...
  public CloudNetworkService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CloudNetworkService managingAccount(String managingAccount) {
  ...
  public CloudNetworkService productOffering(String productOffering) {
  ...
  public CloudNetworkService providerRef(String providerRef) {
  ...
  public CloudNetworkService purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkService state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public CloudNetworkService status(List<Status> status) {
    this.status = status;
    return this;
  }

  public CloudNetworkService addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public CloudNetworkService type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkService cloudNetworkService = (CloudNetworkService) o;
    return Objects.equals(this.billingAccount, cloudNetworkService.billingAccount) &&
        Objects.equals(this.capacity, cloudNetworkService.capacity) &&
        Objects.equals(this.chargedUntil, cloudNetworkService.chargedUntil) &&
        Objects.equals(this.cloudKey, cloudNetworkService.cloudKey) &&
        Objects.equals(this.consumingAccount, cloudNetworkService.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkService.contractRef) &&
        Objects.equals(this.decommissionAt, cloudNetworkService.decommissionAt) &&
        Objects.equals(this.diversity, cloudNetworkService.diversity) &&
        Objects.equals(this.externalRef, cloudNetworkService.externalRef) &&
        Objects.equals(this.id, cloudNetworkService.id) &&
        Objects.equals(this.managingAccount, cloudNetworkService.managingAccount) &&
        Objects.equals(this.nscRequiredContactRoles, cloudNetworkService.nscRequiredContactRoles) &&
        Objects.equals(this.productOffering, cloudNetworkService.productOffering) &&
        Objects.equals(this.providerRef, cloudNetworkService.providerRef) &&
        Objects.equals(this.purchaseOrder, cloudNetworkService.purchaseOrder) &&
        Objects.equals(this.state, cloudNetworkService.state) &&
        Objects.equals(this.status, cloudNetworkService.status) &&
        Objects.equals(this.type, cloudNetworkService.type);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("cloud_key");
    ...
    openapiRequiredFields.add("provider_ref");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkService is not found in the empty JSON string", CloudNetworkService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkService.openapiRequiredFields) {
      ...
      if (!jsonObj.get("cloud_key").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkService.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkService>() {
           @Override
           public void write(JsonWriter out, CloudNetworkService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkService
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkService
   */
  public static CloudNetworkService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkService.class);
  }

  /**
   * Convert an instance of CloudNetworkService to an JSON string
   *
   * @return JSON string
   */
