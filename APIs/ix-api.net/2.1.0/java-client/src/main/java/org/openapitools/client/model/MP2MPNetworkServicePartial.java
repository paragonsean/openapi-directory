...
public class MP2MPNetworkServicePartial {
  ...
  public MP2MPNetworkServicePartial() {
  }
  ...
  public MP2MPNetworkServicePartial billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServicePartial chargedUntil(LocalDate chargedUntil) {
  ...
  public MP2MPNetworkServicePartial consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServicePartial contractRef(String contractRef) {
  ...
  public MP2MPNetworkServicePartial decommissionAt(LocalDate decommissionAt) {
  ...
  public MP2MPNetworkServicePartial externalRef(String externalRef) {
  ...
  public MP2MPNetworkServicePartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MP2MPNetworkServicePartial managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServicePartial memberJoiningRules(List<String> memberJoiningRules) {
    this.memberJoiningRules = memberJoiningRules;
    return this;
  }

  public MP2MPNetworkServicePartial addMemberJoiningRulesItem(String memberJoiningRulesItem) {
  ...
  public MP2MPNetworkServicePartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MP2MPNetworkServicePartial networkFeatures(List<String> networkFeatures) {
    this.networkFeatures = networkFeatures;
    return this;
  }

  public MP2MPNetworkServicePartial addNetworkFeaturesItem(String networkFeaturesItem) {
  ...
  public MP2MPNetworkServicePartial productOffering(String productOffering) {
  ...
  public MP2MPNetworkServicePartial _public(Boolean _public) {
  ...
  public MP2MPNetworkServicePartial purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServicePartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public MP2MPNetworkServicePartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public MP2MPNetworkServicePartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public MP2MPNetworkServicePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServicePartial mp2MPNetworkServicePartial = (MP2MPNetworkServicePartial) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServicePartial.billingAccount) &&
        Objects.equals(this.chargedUntil, mp2MPNetworkServicePartial.chargedUntil) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServicePartial.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServicePartial.contractRef) &&
        Objects.equals(this.decommissionAt, mp2MPNetworkServicePartial.decommissionAt) &&
        Objects.equals(this.externalRef, mp2MPNetworkServicePartial.externalRef) &&
        Objects.equals(this.id, mp2MPNetworkServicePartial.id) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServicePartial.managingAccount) &&
        Objects.equals(this.memberJoiningRules, mp2MPNetworkServicePartial.memberJoiningRules) &&
        Objects.equals(this.name, mp2MPNetworkServicePartial.name) &&
        Objects.equals(this.networkFeatures, mp2MPNetworkServicePartial.networkFeatures) &&
        Objects.equals(this.nscRequiredContactRoles, mp2MPNetworkServicePartial.nscRequiredContactRoles) &&
        Objects.equals(this.productOffering, mp2MPNetworkServicePartial.productOffering) &&
        Objects.equals(this._public, mp2MPNetworkServicePartial._public) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServicePartial.purchaseOrder) &&
        Objects.equals(this.state, mp2MPNetworkServicePartial.state) &&
        Objects.equals(this.status, mp2MPNetworkServicePartial.status) &&
        Objects.equals(this.type, mp2MPNetworkServicePartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServicePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServicePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServicePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServicePartial is not found in the empty JSON string", MP2MPNetworkServicePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServicePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServicePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServicePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServicePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServicePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServicePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServicePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServicePartial>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServicePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServicePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServicePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServicePartial
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServicePartial
   */
  public static MP2MPNetworkServicePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServicePartial.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServicePartial to an JSON string
   *
   * @return JSON string
   */
