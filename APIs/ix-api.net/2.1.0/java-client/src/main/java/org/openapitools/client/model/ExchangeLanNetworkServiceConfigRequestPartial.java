...
public class ExchangeLanNetworkServiceConfigRequestPartial {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial() {
  }
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial asns(List<Long> asns) {
    this.asns = asns;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequestPartial addAsnsItem(Long asnsItem) {
    if (this.asns == null) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial billingAccount(String billingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial capacity(Integer capacity) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial connection(String connection) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial consumingAccount(String consumingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial contractRef(String contractRef) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial externalRef(String externalRef) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial listed(Boolean listed) {
    this.listed = listed;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequestPartial addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial managingAccount(String managingAccount) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial networkService(String networkService) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial productOffering(String productOffering) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ExchangeLanNetworkServiceConfigRequestPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ExchangeLanNetworkServiceConfigRequestPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkServiceConfigRequestPartial exchangeLanNetworkServiceConfigRequestPartial = (ExchangeLanNetworkServiceConfigRequestPartial) o;
    return Objects.equals(this.asns, exchangeLanNetworkServiceConfigRequestPartial.asns) &&
        Objects.equals(this.billingAccount, exchangeLanNetworkServiceConfigRequestPartial.billingAccount) &&
        Objects.equals(this.capacity, exchangeLanNetworkServiceConfigRequestPartial.capacity) &&
        Objects.equals(this.connection, exchangeLanNetworkServiceConfigRequestPartial.connection) &&
        Objects.equals(this.consumingAccount, exchangeLanNetworkServiceConfigRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, exchangeLanNetworkServiceConfigRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, exchangeLanNetworkServiceConfigRequestPartial.externalRef) &&
        Objects.equals(this.ips, exchangeLanNetworkServiceConfigRequestPartial.ips) &&
        Objects.equals(this.listed, exchangeLanNetworkServiceConfigRequestPartial.listed) &&
        Objects.equals(this.macs, exchangeLanNetworkServiceConfigRequestPartial.macs) &&
        Objects.equals(this.managingAccount, exchangeLanNetworkServiceConfigRequestPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, exchangeLanNetworkServiceConfigRequestPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, exchangeLanNetworkServiceConfigRequestPartial.networkService) &&
        Objects.equals(this.productOffering, exchangeLanNetworkServiceConfigRequestPartial.productOffering) &&
        Objects.equals(this.purchaseOrder, exchangeLanNetworkServiceConfigRequestPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, exchangeLanNetworkServiceConfigRequestPartial.roleAssignments) &&
        Objects.equals(this.type, exchangeLanNetworkServiceConfigRequestPartial.type) &&
        Objects.equals(this.vlanConfig, exchangeLanNetworkServiceConfigRequestPartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeLanNetworkServiceConfigRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkServiceConfigRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkServiceConfigRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkServiceConfigRequestPartial is not found in the empty JSON string", ExchangeLanNetworkServiceConfigRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkServiceConfigRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkServiceConfigRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkServiceConfigRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkServiceConfigRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkServiceConfigRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkServiceConfigRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkServiceConfigRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkServiceConfigRequestPartial>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkServiceConfigRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkServiceConfigRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkServiceConfigRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkServiceConfigRequestPartial
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkServiceConfigRequestPartial
   */
  public static ExchangeLanNetworkServiceConfigRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkServiceConfigRequestPartial.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkServiceConfigRequestPartial to an JSON string
   *
   * @return JSON string
   */
