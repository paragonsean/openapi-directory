...
public class P2MPNetworkServiceConfig {
  ...
  public P2MPNetworkServiceConfig() {
  }
  ...
  public P2MPNetworkServiceConfig billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceConfig capacity(Integer capacity) {
  ...
  public P2MPNetworkServiceConfig chargedUntil(LocalDate chargedUntil) {
  ...
  public P2MPNetworkServiceConfig connection(String connection) {
  ...
  public P2MPNetworkServiceConfig consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceConfig contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceConfig decommissionAt(LocalDate decommissionAt) {
  ...
  public P2MPNetworkServiceConfig externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceConfig id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2MPNetworkServiceConfig managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceConfig networkService(String networkService) {
  ...
  public P2MPNetworkServiceConfig purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceConfig role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public P2MPNetworkServiceConfig roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2MPNetworkServiceConfig addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2MPNetworkServiceConfig state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2MPNetworkServiceConfig status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2MPNetworkServiceConfig addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2MPNetworkServiceConfig type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2MPNetworkServiceConfig vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceConfig p2MPNetworkServiceConfig = (P2MPNetworkServiceConfig) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceConfig.billingAccount) &&
        Objects.equals(this.capacity, p2MPNetworkServiceConfig.capacity) &&
        Objects.equals(this.chargedUntil, p2MPNetworkServiceConfig.chargedUntil) &&
        Objects.equals(this.connection, p2MPNetworkServiceConfig.connection) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceConfig.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceConfig.contractRef) &&
        Objects.equals(this.decommissionAt, p2MPNetworkServiceConfig.decommissionAt) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceConfig.externalRef) &&
        Objects.equals(this.id, p2MPNetworkServiceConfig.id) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceConfig.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2MPNetworkServiceConfig.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2MPNetworkServiceConfig.networkService) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceConfig.purchaseOrder) &&
        Objects.equals(this.role, p2MPNetworkServiceConfig.role) &&
        Objects.equals(this.roleAssignments, p2MPNetworkServiceConfig.roleAssignments) &&
        Objects.equals(this.state, p2MPNetworkServiceConfig.state) &&
        Objects.equals(this.status, p2MPNetworkServiceConfig.status) &&
        Objects.equals(this.type, p2MPNetworkServiceConfig.type) &&
        Objects.equals(this.vlanConfig, p2MPNetworkServiceConfig.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceConfig is not found in the empty JSON string", P2MPNetworkServiceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceConfig>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceConfig
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceConfig
   */
  public static P2MPNetworkServiceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceConfig.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceConfig to an JSON string
   *
   * @return JSON string
   */
