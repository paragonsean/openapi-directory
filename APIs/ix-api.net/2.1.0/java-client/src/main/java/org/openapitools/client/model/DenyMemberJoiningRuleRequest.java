...
public class DenyMemberJoiningRuleRequest {
  ...
  public DenyMemberJoiningRuleRequest() {
  }

  public DenyMemberJoiningRuleRequest consumingAccount(String consumingAccount) {
  ...
  public DenyMemberJoiningRuleRequest externalRef(String externalRef) {
  ...
  public DenyMemberJoiningRuleRequest managingAccount(String managingAccount) {
  ...
  public DenyMemberJoiningRuleRequest networkService(String networkService) {
  ...
  public DenyMemberJoiningRuleRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DenyMemberJoiningRuleRequest denyMemberJoiningRuleRequest = (DenyMemberJoiningRuleRequest) o;
    return Objects.equals(this.consumingAccount, denyMemberJoiningRuleRequest.consumingAccount) &&
        Objects.equals(this.externalRef, denyMemberJoiningRuleRequest.externalRef) &&
        Objects.equals(this.managingAccount, denyMemberJoiningRuleRequest.managingAccount) &&
        Objects.equals(this.networkService, denyMemberJoiningRuleRequest.networkService) &&
        Objects.equals(this.type, denyMemberJoiningRuleRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DenyMemberJoiningRuleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DenyMemberJoiningRuleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DenyMemberJoiningRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DenyMemberJoiningRuleRequest is not found in the empty JSON string", DenyMemberJoiningRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DenyMemberJoiningRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DenyMemberJoiningRuleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DenyMemberJoiningRuleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DenyMemberJoiningRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DenyMemberJoiningRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DenyMemberJoiningRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DenyMemberJoiningRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DenyMemberJoiningRuleRequest>() {
           @Override
           public void write(JsonWriter out, DenyMemberJoiningRuleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DenyMemberJoiningRuleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DenyMemberJoiningRuleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DenyMemberJoiningRuleRequest
   * @throws IOException if the JSON string is invalid with respect to DenyMemberJoiningRuleRequest
   */
  public static DenyMemberJoiningRuleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DenyMemberJoiningRuleRequest.class);
  }

  /**
   * Convert an instance of DenyMemberJoiningRuleRequest to an JSON string
   *
   * @return JSON string
   */
