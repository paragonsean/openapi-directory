...
public class MacAddress {
  ...
  public MacAddress address(String address) {
  ...
  public MacAddress consumingAccount(String consumingAccount) {
  ...
  public MacAddress externalRef(String externalRef) {
  ...
  public MacAddress id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MacAddress managingAccount(String managingAccount) {
  ...
  public MacAddress validNotAfter(OffsetDateTime validNotAfter) {
  ...
  public MacAddress validNotBefore(OffsetDateTime validNotBefore) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, macAddress.address) &&
        Objects.equals(this.consumingAccount, macAddress.consumingAccount) &&
        Objects.equals(this.externalRef, macAddress.externalRef) &&
        Objects.equals(this.id, macAddress.id) &&
        Objects.equals(this.managingAccount, macAddress.managingAccount) &&
        Objects.equals(this.validNotAfter, macAddress.validNotAfter) &&
        Objects.equals(this.validNotBefore, macAddress.validNotBefore);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MacAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MacAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MacAddress is not found in the empty JSON string", MacAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MacAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MacAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MacAddress.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MacAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MacAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MacAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MacAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<MacAddress>() {
           @Override
           public void write(JsonWriter out, MacAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MacAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MacAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MacAddress
   * @throws IOException if the JSON string is invalid with respect to MacAddress
   */
  public static MacAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MacAddress.class);
  }

  /**
   * Convert an instance of MacAddress to an JSON string
   *
   * @return JSON string
   */
