...
public class CloudNetworkServiceConfigUpdatePartial {
  ...
  public CloudNetworkServiceConfigUpdatePartial() {
  }
  ...
  public CloudNetworkServiceConfigUpdatePartial billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceConfigUpdatePartial cloudVlan(Integer cloudVlan) {
  ...
  public CloudNetworkServiceConfigUpdatePartial connection(String connection) {
  ...
  public CloudNetworkServiceConfigUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceConfigUpdatePartial contractRef(String contractRef) {
  ...
  public CloudNetworkServiceConfigUpdatePartial externalRef(String externalRef) {
  ...
  public CloudNetworkServiceConfigUpdatePartial handover(Integer handover) {
  ...
  public CloudNetworkServiceConfigUpdatePartial managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceConfigUpdatePartial purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceConfigUpdatePartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public CloudNetworkServiceConfigUpdatePartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public CloudNetworkServiceConfigUpdatePartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CloudNetworkServiceConfigUpdatePartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceConfigUpdatePartial cloudNetworkServiceConfigUpdatePartial = (CloudNetworkServiceConfigUpdatePartial) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceConfigUpdatePartial.billingAccount) &&
        Objects.equals(this.cloudVlan, cloudNetworkServiceConfigUpdatePartial.cloudVlan) &&
        Objects.equals(this.connection, cloudNetworkServiceConfigUpdatePartial.connection) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceConfigUpdatePartial.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceConfigUpdatePartial.contractRef) &&
        Objects.equals(this.externalRef, cloudNetworkServiceConfigUpdatePartial.externalRef) &&
        Objects.equals(this.handover, cloudNetworkServiceConfigUpdatePartial.handover) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceConfigUpdatePartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, cloudNetworkServiceConfigUpdatePartial.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceConfigUpdatePartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, cloudNetworkServiceConfigUpdatePartial.roleAssignments) &&
        Objects.equals(this.type, cloudNetworkServiceConfigUpdatePartial.type) &&
        Objects.equals(this.vlanConfig, cloudNetworkServiceConfigUpdatePartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudNetworkServiceConfigUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceConfigUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceConfigUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceConfigUpdatePartial is not found in the empty JSON string", CloudNetworkServiceConfigUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceConfigUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceConfigUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceConfigUpdatePartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceConfigUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceConfigUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceConfigUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceConfigUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceConfigUpdatePartial>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceConfigUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceConfigUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceConfigUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceConfigUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceConfigUpdatePartial
   */
  public static CloudNetworkServiceConfigUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceConfigUpdatePartial.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceConfigUpdatePartial to an JSON string
   *
   * @return JSON string
   */
