...
public class MP2MPNetworkServiceConfigPartial {
  ...
  public MP2MPNetworkServiceConfigPartial() {
  }
  ...
  public MP2MPNetworkServiceConfigPartial billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServiceConfigPartial capacity(Integer capacity) {
  ...
  public MP2MPNetworkServiceConfigPartial chargedUntil(LocalDate chargedUntil) {
  ...
  public MP2MPNetworkServiceConfigPartial connection(String connection) {
  ...
  public MP2MPNetworkServiceConfigPartial consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServiceConfigPartial contractRef(String contractRef) {
  ...
  public MP2MPNetworkServiceConfigPartial decommissionAt(LocalDate decommissionAt) {
  ...
  public MP2MPNetworkServiceConfigPartial externalRef(String externalRef) {
  ...
  public MP2MPNetworkServiceConfigPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigPartial macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public MP2MPNetworkServiceConfigPartial addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public MP2MPNetworkServiceConfigPartial managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServiceConfigPartial networkService(String networkService) {
  ...
  public MP2MPNetworkServiceConfigPartial purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServiceConfigPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public MP2MPNetworkServiceConfigPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public MP2MPNetworkServiceConfigPartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigPartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public MP2MPNetworkServiceConfigPartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public MP2MPNetworkServiceConfigPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServiceConfigPartial mp2MPNetworkServiceConfigPartial = (MP2MPNetworkServiceConfigPartial) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServiceConfigPartial.billingAccount) &&
        Objects.equals(this.capacity, mp2MPNetworkServiceConfigPartial.capacity) &&
        Objects.equals(this.chargedUntil, mp2MPNetworkServiceConfigPartial.chargedUntil) &&
        Objects.equals(this.connection, mp2MPNetworkServiceConfigPartial.connection) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServiceConfigPartial.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServiceConfigPartial.contractRef) &&
        Objects.equals(this.decommissionAt, mp2MPNetworkServiceConfigPartial.decommissionAt) &&
        Objects.equals(this.externalRef, mp2MPNetworkServiceConfigPartial.externalRef) &&
        Objects.equals(this.id, mp2MPNetworkServiceConfigPartial.id) &&
        Objects.equals(this.macs, mp2MPNetworkServiceConfigPartial.macs) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServiceConfigPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, mp2MPNetworkServiceConfigPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, mp2MPNetworkServiceConfigPartial.networkService) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServiceConfigPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, mp2MPNetworkServiceConfigPartial.roleAssignments) &&
        Objects.equals(this.state, mp2MPNetworkServiceConfigPartial.state) &&
        Objects.equals(this.status, mp2MPNetworkServiceConfigPartial.status) &&
        Objects.equals(this.type, mp2MPNetworkServiceConfigPartial.type) &&
        Objects.equals(this.vlanConfig, mp2MPNetworkServiceConfigPartial.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServiceConfigPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServiceConfigPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServiceConfigPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServiceConfigPartial is not found in the empty JSON string", MP2MPNetworkServiceConfigPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServiceConfigPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServiceConfigPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServiceConfigPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServiceConfigPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServiceConfigPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServiceConfigPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServiceConfigPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServiceConfigPartial>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServiceConfigPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServiceConfigPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServiceConfigPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServiceConfigPartial
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServiceConfigPartial
   */
  public static MP2MPNetworkServiceConfigPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServiceConfigPartial.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServiceConfigPartial to an JSON string
   *
   * @return JSON string
   */
