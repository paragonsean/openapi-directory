...
public class CloudNetworkServiceConfig {
  ...
  public CloudNetworkServiceConfig() {
  }
  ...
  public CloudNetworkServiceConfig billingAccount(String billingAccount) {
  ...
  public CloudNetworkServiceConfig chargedUntil(LocalDate chargedUntil) {
  ...
  public CloudNetworkServiceConfig cloudVlan(Integer cloudVlan) {
  ...
  public CloudNetworkServiceConfig connection(String connection) {
  ...
  public CloudNetworkServiceConfig consumingAccount(String consumingAccount) {
  ...
  public CloudNetworkServiceConfig contractRef(String contractRef) {
  ...
  public CloudNetworkServiceConfig decommissionAt(LocalDate decommissionAt) {
  ...
  public CloudNetworkServiceConfig externalRef(String externalRef) {
  ...
  public CloudNetworkServiceConfig handover(Integer handover) {
  ...
  public CloudNetworkServiceConfig id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CloudNetworkServiceConfig managingAccount(String managingAccount) {
  ...
  public CloudNetworkServiceConfig networkService(String networkService) {
  ...
  public CloudNetworkServiceConfig purchaseOrder(String purchaseOrder) {
  ...
  public CloudNetworkServiceConfig roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public CloudNetworkServiceConfig addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public CloudNetworkServiceConfig state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public CloudNetworkServiceConfig status(List<Status> status) {
    this.status = status;
    return this;
  }

  public CloudNetworkServiceConfig addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public CloudNetworkServiceConfig type(String type) {
    this.type = type;
    return this;
  }
  ...
  public CloudNetworkServiceConfig vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CloudNetworkServiceConfig cloudNetworkServiceConfig = (CloudNetworkServiceConfig) o;
    return Objects.equals(this.billingAccount, cloudNetworkServiceConfig.billingAccount) &&
        Objects.equals(this.chargedUntil, cloudNetworkServiceConfig.chargedUntil) &&
        Objects.equals(this.cloudVlan, cloudNetworkServiceConfig.cloudVlan) &&
        Objects.equals(this.connection, cloudNetworkServiceConfig.connection) &&
        Objects.equals(this.consumingAccount, cloudNetworkServiceConfig.consumingAccount) &&
        Objects.equals(this.contractRef, cloudNetworkServiceConfig.contractRef) &&
        Objects.equals(this.decommissionAt, cloudNetworkServiceConfig.decommissionAt) &&
        Objects.equals(this.externalRef, cloudNetworkServiceConfig.externalRef) &&
        Objects.equals(this.handover, cloudNetworkServiceConfig.handover) &&
        Objects.equals(this.id, cloudNetworkServiceConfig.id) &&
        Objects.equals(this.managingAccount, cloudNetworkServiceConfig.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, cloudNetworkServiceConfig.networkFeatureConfigs) &&
        Objects.equals(this.networkService, cloudNetworkServiceConfig.networkService) &&
        Objects.equals(this.purchaseOrder, cloudNetworkServiceConfig.purchaseOrder) &&
        Objects.equals(this.roleAssignments, cloudNetworkServiceConfig.roleAssignments) &&
        Objects.equals(this.state, cloudNetworkServiceConfig.state) &&
        Objects.equals(this.status, cloudNetworkServiceConfig.status) &&
        Objects.equals(this.type, cloudNetworkServiceConfig.type) &&
        Objects.equals(this.vlanConfig, cloudNetworkServiceConfig.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudNetworkServiceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudNetworkServiceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudNetworkServiceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudNetworkServiceConfig is not found in the empty JSON string", CloudNetworkServiceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudNetworkServiceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudNetworkServiceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudNetworkServiceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudNetworkServiceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudNetworkServiceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudNetworkServiceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudNetworkServiceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudNetworkServiceConfig>() {
           @Override
           public void write(JsonWriter out, CloudNetworkServiceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudNetworkServiceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudNetworkServiceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudNetworkServiceConfig
   * @throws IOException if the JSON string is invalid with respect to CloudNetworkServiceConfig
   */
  public static CloudNetworkServiceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudNetworkServiceConfig.class);
  }

  /**
   * Convert an instance of CloudNetworkServiceConfig to an JSON string
   *
   * @return JSON string
   */
