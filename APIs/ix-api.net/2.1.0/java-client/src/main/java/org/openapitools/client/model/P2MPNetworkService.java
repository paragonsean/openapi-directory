...
public class P2MPNetworkService {
  ...
  public P2MPNetworkService billingAccount(String billingAccount) {
  ...
  public P2MPNetworkService chargedUntil(LocalDate chargedUntil) {
  ...
  public P2MPNetworkService consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkService contractRef(String contractRef) {
  ...
  public P2MPNetworkService decommissionAt(LocalDate decommissionAt) {
  ...
  public P2MPNetworkService externalRef(String externalRef) {
  ...
  public P2MPNetworkService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2MPNetworkService managingAccount(String managingAccount) {
  ...
  public P2MPNetworkService memberJoiningRules(List<String> memberJoiningRules) {
    this.memberJoiningRules = memberJoiningRules;
    return this;
  }

  public P2MPNetworkService addMemberJoiningRulesItem(String memberJoiningRulesItem) {
  ...
  public P2MPNetworkService name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2MPNetworkService networkFeatures(List<String> networkFeatures) {
    this.networkFeatures = networkFeatures;
    return this;
  }

  public P2MPNetworkService addNetworkFeaturesItem(String networkFeaturesItem) {
  ...
  public P2MPNetworkService productOffering(String productOffering) {
  ...
  public P2MPNetworkService _public(Boolean _public) {
  ...
  public P2MPNetworkService purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkService state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2MPNetworkService status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2MPNetworkService addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2MPNetworkService type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkService p2MPNetworkService = (P2MPNetworkService) o;
    return Objects.equals(this.billingAccount, p2MPNetworkService.billingAccount) &&
        Objects.equals(this.chargedUntil, p2MPNetworkService.chargedUntil) &&
        Objects.equals(this.consumingAccount, p2MPNetworkService.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkService.contractRef) &&
        Objects.equals(this.decommissionAt, p2MPNetworkService.decommissionAt) &&
        Objects.equals(this.externalRef, p2MPNetworkService.externalRef) &&
        Objects.equals(this.id, p2MPNetworkService.id) &&
        Objects.equals(this.managingAccount, p2MPNetworkService.managingAccount) &&
        Objects.equals(this.memberJoiningRules, p2MPNetworkService.memberJoiningRules) &&
        Objects.equals(this.name, p2MPNetworkService.name) &&
        Objects.equals(this.networkFeatures, p2MPNetworkService.networkFeatures) &&
        Objects.equals(this.nscRequiredContactRoles, p2MPNetworkService.nscRequiredContactRoles) &&
        Objects.equals(this.productOffering, p2MPNetworkService.productOffering) &&
        Objects.equals(this._public, p2MPNetworkService._public) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkService.purchaseOrder) &&
        Objects.equals(this.state, p2MPNetworkService.state) &&
        Objects.equals(this.status, p2MPNetworkService.status) &&
        Objects.equals(this.type, p2MPNetworkService.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkService is not found in the empty JSON string", P2MPNetworkService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkService.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkService.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkService>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkService
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkService
   */
  public static P2MPNetworkService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkService.class);
  }

  /**
   * Convert an instance of P2MPNetworkService to an JSON string
   *
   * @return JSON string
   */
