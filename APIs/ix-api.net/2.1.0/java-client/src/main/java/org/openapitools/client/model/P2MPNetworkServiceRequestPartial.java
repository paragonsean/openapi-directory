...
public class P2MPNetworkServiceRequestPartial {
  ...
  public P2MPNetworkServiceRequestPartial() {
  }

  public P2MPNetworkServiceRequestPartial billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceRequestPartial consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceRequestPartial contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceRequestPartial externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceRequestPartial managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceRequestPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2MPNetworkServiceRequestPartial productOffering(String productOffering) {
  ...
  public P2MPNetworkServiceRequestPartial _public(Boolean _public) {
  ...
  public P2MPNetworkServiceRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceRequestPartial p2MPNetworkServiceRequestPartial = (P2MPNetworkServiceRequestPartial) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceRequestPartial.billingAccount) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceRequestPartial.managingAccount) &&
        Objects.equals(this.name, p2MPNetworkServiceRequestPartial.name) &&
        Objects.equals(this.productOffering, p2MPNetworkServiceRequestPartial.productOffering) &&
        Objects.equals(this._public, p2MPNetworkServiceRequestPartial._public) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceRequestPartial.purchaseOrder) &&
        Objects.equals(this.type, p2MPNetworkServiceRequestPartial.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceRequestPartial is not found in the empty JSON string", P2MPNetworkServiceRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceRequestPartial>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceRequestPartial
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceRequestPartial
   */
  public static P2MPNetworkServiceRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceRequestPartial.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceRequestPartial to an JSON string
   *
   * @return JSON string
   */
