...
public class MP2MPNetworkServiceConfigUpdate {
  ...
  public MP2MPNetworkServiceConfigUpdate() {
  }
  ...
  public MP2MPNetworkServiceConfigUpdate billingAccount(String billingAccount) {
  ...
  public MP2MPNetworkServiceConfigUpdate capacity(Integer capacity) {
  ...
  public MP2MPNetworkServiceConfigUpdate connection(String connection) {
  ...
  public MP2MPNetworkServiceConfigUpdate consumingAccount(String consumingAccount) {
  ...
  public MP2MPNetworkServiceConfigUpdate contractRef(String contractRef) {
  ...
  public MP2MPNetworkServiceConfigUpdate externalRef(String externalRef) {
  ...
  public MP2MPNetworkServiceConfigUpdate macs(List<String> macs) {
    this.macs = macs;
    return this;
  }

  public MP2MPNetworkServiceConfigUpdate addMacsItem(String macsItem) {
    if (this.macs == null) {
  ...
  public MP2MPNetworkServiceConfigUpdate managingAccount(String managingAccount) {
  ...
  public MP2MPNetworkServiceConfigUpdate purchaseOrder(String purchaseOrder) {
  ...
  public MP2MPNetworkServiceConfigUpdate roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public MP2MPNetworkServiceConfigUpdate addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public MP2MPNetworkServiceConfigUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MP2MPNetworkServiceConfigUpdate vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    MP2MPNetworkServiceConfigUpdate mp2MPNetworkServiceConfigUpdate = (MP2MPNetworkServiceConfigUpdate) o;
    return Objects.equals(this.billingAccount, mp2MPNetworkServiceConfigUpdate.billingAccount) &&
        Objects.equals(this.capacity, mp2MPNetworkServiceConfigUpdate.capacity) &&
        Objects.equals(this.connection, mp2MPNetworkServiceConfigUpdate.connection) &&
        Objects.equals(this.consumingAccount, mp2MPNetworkServiceConfigUpdate.consumingAccount) &&
        Objects.equals(this.contractRef, mp2MPNetworkServiceConfigUpdate.contractRef) &&
        Objects.equals(this.externalRef, mp2MPNetworkServiceConfigUpdate.externalRef) &&
        Objects.equals(this.macs, mp2MPNetworkServiceConfigUpdate.macs) &&
        Objects.equals(this.managingAccount, mp2MPNetworkServiceConfigUpdate.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, mp2MPNetworkServiceConfigUpdate.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, mp2MPNetworkServiceConfigUpdate.purchaseOrder) &&
        Objects.equals(this.roleAssignments, mp2MPNetworkServiceConfigUpdate.roleAssignments) &&
        Objects.equals(this.type, mp2MPNetworkServiceConfigUpdate.type) &&
        Objects.equals(this.vlanConfig, mp2MPNetworkServiceConfigUpdate.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MP2MPNetworkServiceConfigUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MP2MPNetworkServiceConfigUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MP2MPNetworkServiceConfigUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MP2MPNetworkServiceConfigUpdate is not found in the empty JSON string", MP2MPNetworkServiceConfigUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MP2MPNetworkServiceConfigUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MP2MPNetworkServiceConfigUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MP2MPNetworkServiceConfigUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MP2MPNetworkServiceConfigUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MP2MPNetworkServiceConfigUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MP2MPNetworkServiceConfigUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MP2MPNetworkServiceConfigUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<MP2MPNetworkServiceConfigUpdate>() {
           @Override
           public void write(JsonWriter out, MP2MPNetworkServiceConfigUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MP2MPNetworkServiceConfigUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MP2MPNetworkServiceConfigUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MP2MPNetworkServiceConfigUpdate
   * @throws IOException if the JSON string is invalid with respect to MP2MPNetworkServiceConfigUpdate
   */
  public static MP2MPNetworkServiceConfigUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MP2MPNetworkServiceConfigUpdate.class);
  }

  /**
   * Convert an instance of MP2MPNetworkServiceConfigUpdate to an JSON string
   *
   * @return JSON string
   */
