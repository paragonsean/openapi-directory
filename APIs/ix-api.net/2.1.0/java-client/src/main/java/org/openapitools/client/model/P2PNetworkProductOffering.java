...
public class P2PNetworkProductOffering {
  ...
  public P2PNetworkProductOffering() {
  }

  public P2PNetworkProductOffering bandwidthMax(Integer bandwidthMax) {
  ...
  public P2PNetworkProductOffering bandwidthMin(Integer bandwidthMin) {
  ...
  public P2PNetworkProductOffering displayName(String displayName) {
  ...
  public P2PNetworkProductOffering downgradeAllowed(Boolean downgradeAllowed) {
  ...
  public P2PNetworkProductOffering handoverMetroArea(String handoverMetroArea) {
  ...
  public P2PNetworkProductOffering handoverMetroAreaNetwork(String handoverMetroAreaNetwork) {
  ...
  public P2PNetworkProductOffering id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2PNetworkProductOffering name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2PNetworkProductOffering physicalPortSpeed(Integer physicalPortSpeed) {
  ...
  public P2PNetworkProductOffering providerVlans(ProviderVlansEnum providerVlans) {
  ...
  public P2PNetworkProductOffering resourceType(ResourceTypeEnum resourceType) {
  ...
  public P2PNetworkProductOffering serviceMetroArea(String serviceMetroArea) {
  ...
  public P2PNetworkProductOffering serviceMetroAreaNetwork(String serviceMetroAreaNetwork) {
  ...
  public P2PNetworkProductOffering serviceProvider(String serviceProvider) {
  ...
  public P2PNetworkProductOffering type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkProductOffering upgradeAllowed(Boolean upgradeAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkProductOffering p2PNetworkProductOffering = (P2PNetworkProductOffering) o;
    return Objects.equals(this.bandwidthMax, p2PNetworkProductOffering.bandwidthMax) &&
        Objects.equals(this.bandwidthMin, p2PNetworkProductOffering.bandwidthMin) &&
        Objects.equals(this.displayName, p2PNetworkProductOffering.displayName) &&
        Objects.equals(this.downgradeAllowed, p2PNetworkProductOffering.downgradeAllowed) &&
        Objects.equals(this.handoverMetroArea, p2PNetworkProductOffering.handoverMetroArea) &&
        Objects.equals(this.handoverMetroAreaNetwork, p2PNetworkProductOffering.handoverMetroAreaNetwork) &&
        Objects.equals(this.id, p2PNetworkProductOffering.id) &&
        Objects.equals(this.name, p2PNetworkProductOffering.name) &&
        Objects.equals(this.physicalPortSpeed, p2PNetworkProductOffering.physicalPortSpeed) &&
        Objects.equals(this.providerVlans, p2PNetworkProductOffering.providerVlans) &&
        Objects.equals(this.resourceType, p2PNetworkProductOffering.resourceType) &&
        Objects.equals(this.serviceMetroArea, p2PNetworkProductOffering.serviceMetroArea) &&
        Objects.equals(this.serviceMetroAreaNetwork, p2PNetworkProductOffering.serviceMetroAreaNetwork) &&
        Objects.equals(this.serviceProvider, p2PNetworkProductOffering.serviceProvider) &&
        Objects.equals(this.type, p2PNetworkProductOffering.type) &&
        Objects.equals(this.upgradeAllowed, p2PNetworkProductOffering.upgradeAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkProductOffering {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkProductOffering
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkProductOffering.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkProductOffering is not found in the empty JSON string", P2PNetworkProductOffering.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkProductOffering.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkProductOffering` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkProductOffering.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkProductOffering.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkProductOffering' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkProductOffering> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkProductOffering.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkProductOffering>() {
           @Override
           public void write(JsonWriter out, P2PNetworkProductOffering value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkProductOffering read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkProductOffering given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkProductOffering
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkProductOffering
   */
  public static P2PNetworkProductOffering fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkProductOffering.class);
  }

  /**
   * Convert an instance of P2PNetworkProductOffering to an JSON string
   *
   * @return JSON string
   */
