...
public class ExchangeLanNetworkProductOfferingPartial {
  ...
  public ExchangeLanNetworkProductOfferingPartial() {
  }

  public ExchangeLanNetworkProductOfferingPartial bandwidthMax(Integer bandwidthMax) {
  ...
  public ExchangeLanNetworkProductOfferingPartial bandwidthMin(Integer bandwidthMin) {
  ...
  public ExchangeLanNetworkProductOfferingPartial displayName(String displayName) {
  ...
  public ExchangeLanNetworkProductOfferingPartial downgradeAllowed(Boolean downgradeAllowed) {
  ...
  public ExchangeLanNetworkProductOfferingPartial exchangeLanNetworkService(String exchangeLanNetworkService) {
  ...
  public ExchangeLanNetworkProductOfferingPartial handoverMetroArea(String handoverMetroArea) {
  ...
  public ExchangeLanNetworkProductOfferingPartial handoverMetroAreaNetwork(String handoverMetroAreaNetwork) {
  ...
  public ExchangeLanNetworkProductOfferingPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExchangeLanNetworkProductOfferingPartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ExchangeLanNetworkProductOfferingPartial physicalPortSpeed(Integer physicalPortSpeed) {
  ...
  public ExchangeLanNetworkProductOfferingPartial providerVlans(ProviderVlansEnum providerVlans) {
  ...
  public ExchangeLanNetworkProductOfferingPartial resourceType(ResourceTypeEnum resourceType) {
  ...
  public ExchangeLanNetworkProductOfferingPartial serviceMetroArea(String serviceMetroArea) {
  ...
  public ExchangeLanNetworkProductOfferingPartial serviceMetroAreaNetwork(String serviceMetroAreaNetwork) {
  ...
  public ExchangeLanNetworkProductOfferingPartial serviceProvider(String serviceProvider) {
  ...
  public ExchangeLanNetworkProductOfferingPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ExchangeLanNetworkProductOfferingPartial upgradeAllowed(Boolean upgradeAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkProductOfferingPartial exchangeLanNetworkProductOfferingPartial = (ExchangeLanNetworkProductOfferingPartial) o;
    return Objects.equals(this.bandwidthMax, exchangeLanNetworkProductOfferingPartial.bandwidthMax) &&
        Objects.equals(this.bandwidthMin, exchangeLanNetworkProductOfferingPartial.bandwidthMin) &&
        Objects.equals(this.displayName, exchangeLanNetworkProductOfferingPartial.displayName) &&
        Objects.equals(this.downgradeAllowed, exchangeLanNetworkProductOfferingPartial.downgradeAllowed) &&
        Objects.equals(this.exchangeLanNetworkService, exchangeLanNetworkProductOfferingPartial.exchangeLanNetworkService) &&
        Objects.equals(this.handoverMetroArea, exchangeLanNetworkProductOfferingPartial.handoverMetroArea) &&
        Objects.equals(this.handoverMetroAreaNetwork, exchangeLanNetworkProductOfferingPartial.handoverMetroAreaNetwork) &&
        Objects.equals(this.id, exchangeLanNetworkProductOfferingPartial.id) &&
        Objects.equals(this.name, exchangeLanNetworkProductOfferingPartial.name) &&
        Objects.equals(this.physicalPortSpeed, exchangeLanNetworkProductOfferingPartial.physicalPortSpeed) &&
        Objects.equals(this.providerVlans, exchangeLanNetworkProductOfferingPartial.providerVlans) &&
        Objects.equals(this.resourceType, exchangeLanNetworkProductOfferingPartial.resourceType) &&
        Objects.equals(this.serviceMetroArea, exchangeLanNetworkProductOfferingPartial.serviceMetroArea) &&
        Objects.equals(this.serviceMetroAreaNetwork, exchangeLanNetworkProductOfferingPartial.serviceMetroAreaNetwork) &&
        Objects.equals(this.serviceProvider, exchangeLanNetworkProductOfferingPartial.serviceProvider) &&
        Objects.equals(this.type, exchangeLanNetworkProductOfferingPartial.type) &&
        Objects.equals(this.upgradeAllowed, exchangeLanNetworkProductOfferingPartial.upgradeAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangeLanNetworkProductOfferingPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkProductOfferingPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkProductOfferingPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkProductOfferingPartial is not found in the empty JSON string", ExchangeLanNetworkProductOfferingPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkProductOfferingPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkProductOfferingPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkProductOfferingPartial.openapiRequiredFields) {
      ...
      if ((jsonObj.get("exchange_lan_network_service") != null && !jsonObj.get("exchange_lan_network_service").isJsonNull()) && !jsonObj.get("exchange_lan_network_service").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkProductOfferingPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkProductOfferingPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkProductOfferingPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkProductOfferingPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkProductOfferingPartial>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkProductOfferingPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkProductOfferingPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkProductOfferingPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkProductOfferingPartial
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkProductOfferingPartial
   */
  public static ExchangeLanNetworkProductOfferingPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkProductOfferingPartial.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkProductOfferingPartial to an JSON string
   *
   * @return JSON string
   */
