...
public class Ownable {
  ...
  public Ownable consumingAccount(String consumingAccount) {
  ...
  public Ownable externalRef(String externalRef) {
  ...
  public Ownable managingAccount(String managingAccount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consumingAccount, ownable.consumingAccount) &&
        Objects.equals(this.externalRef, ownable.externalRef) &&
        Objects.equals(this.managingAccount, ownable.managingAccount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consumingAccount, externalRef, managingAccount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ownable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ownable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ownable is not found in the empty JSON string", Ownable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ownable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ownable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Ownable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ownable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ownable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ownable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ownable.class));

       return (TypeAdapter<T>) new TypeAdapter<Ownable>() {
           @Override
           public void write(JsonWriter out, Ownable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ownable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ownable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ownable
   * @throws IOException if the JSON string is invalid with respect to Ownable
   */
  public static Ownable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ownable.class);
  }

  /**
   * Convert an instance of Ownable to an JSON string
   *
   * @return JSON string
   */
