...
public class AccountUpdatePartial {
  ...
  public AccountUpdatePartial() {
  }

  public AccountUpdatePartial address(Address address) {
  ...
  public AccountUpdatePartial billingInformation(BillingInformation billingInformation) {
  ...
  public AccountUpdatePartial discoverable(Boolean discoverable) {
  ...
  public AccountUpdatePartial externalRef(String externalRef) {
  ...
  public AccountUpdatePartial legalName(String legalName) {
  ...
  public AccountUpdatePartial managingAccount(String managingAccount) {
  ...
  public AccountUpdatePartial metroAreaNetworkPresence(List<String> metroAreaNetworkPresence) {
    this.metroAreaNetworkPresence = metroAreaNetworkPresence;
    return this;
  }

  public AccountUpdatePartial addMetroAreaNetworkPresenceItem(String metroAreaNetworkPresenceItem) {
  ...
  public AccountUpdatePartial name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountUpdatePartial accountUpdatePartial = (AccountUpdatePartial) o;
    return Objects.equals(this.address, accountUpdatePartial.address) &&
        Objects.equals(this.billingInformation, accountUpdatePartial.billingInformation) &&
        Objects.equals(this.discoverable, accountUpdatePartial.discoverable) &&
        Objects.equals(this.externalRef, accountUpdatePartial.externalRef) &&
        Objects.equals(this.legalName, accountUpdatePartial.legalName) &&
        Objects.equals(this.managingAccount, accountUpdatePartial.managingAccount) &&
        Objects.equals(this.metroAreaNetworkPresence, accountUpdatePartial.metroAreaNetworkPresence) &&
        Objects.equals(this.name, accountUpdatePartial.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountUpdatePartial is not found in the empty JSON string", AccountUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountUpdatePartial>() {
           @Override
           public void write(JsonWriter out, AccountUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to AccountUpdatePartial
   */
  public static AccountUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountUpdatePartial.class);
  }

  /**
   * Convert an instance of AccountUpdatePartial to an JSON string
   *
   * @return JSON string
   */
