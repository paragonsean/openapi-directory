...
public class ConnectionUpdatePartial {
  ...
  public ConnectionUpdatePartial() {
  }

  public ConnectionUpdatePartial billingAccount(String billingAccount) {
  ...
  public ConnectionUpdatePartial consumingAccount(String consumingAccount) {
  ...
  public ConnectionUpdatePartial contractRef(String contractRef) {
  ...
  public ConnectionUpdatePartial externalRef(String externalRef) {
  ...
  public ConnectionUpdatePartial lacpTimeout(LacpTimeoutEnum lacpTimeout) {
  ...
  public ConnectionUpdatePartial managingAccount(String managingAccount) {
  ...
  public ConnectionUpdatePartial mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public ConnectionUpdatePartial purchaseOrder(String purchaseOrder) {
  ...
  public ConnectionUpdatePartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public ConnectionUpdatePartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public ConnectionUpdatePartial speed(Integer speed) {
    this.speed = speed;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConnectionUpdatePartial connectionUpdatePartial = (ConnectionUpdatePartial) o;
    return Objects.equals(this.billingAccount, connectionUpdatePartial.billingAccount) &&
        Objects.equals(this.consumingAccount, connectionUpdatePartial.consumingAccount) &&
        Objects.equals(this.contractRef, connectionUpdatePartial.contractRef) &&
        Objects.equals(this.externalRef, connectionUpdatePartial.externalRef) &&
        Objects.equals(this.lacpTimeout, connectionUpdatePartial.lacpTimeout) &&
        Objects.equals(this.managingAccount, connectionUpdatePartial.managingAccount) &&
        Objects.equals(this.mode, connectionUpdatePartial.mode) &&
        Objects.equals(this.purchaseOrder, connectionUpdatePartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, connectionUpdatePartial.roleAssignments) &&
        Objects.equals(this.speed, connectionUpdatePartial.speed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionUpdatePartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionUpdatePartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionUpdatePartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionUpdatePartial is not found in the empty JSON string", ConnectionUpdatePartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionUpdatePartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionUpdatePartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionUpdatePartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionUpdatePartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionUpdatePartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionUpdatePartial.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionUpdatePartial>() {
           @Override
           public void write(JsonWriter out, ConnectionUpdatePartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionUpdatePartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionUpdatePartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionUpdatePartial
   * @throws IOException if the JSON string is invalid with respect to ConnectionUpdatePartial
   */
  public static ConnectionUpdatePartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionUpdatePartial.class);
  }

  /**
   * Convert an instance of ConnectionUpdatePartial to an JSON string
   *
   * @return JSON string
   */
