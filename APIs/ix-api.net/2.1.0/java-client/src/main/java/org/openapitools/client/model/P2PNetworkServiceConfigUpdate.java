...
public class P2PNetworkServiceConfigUpdate {
  ...
  public P2PNetworkServiceConfigUpdate() {
  }
  ...
  public P2PNetworkServiceConfigUpdate billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfigUpdate capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfigUpdate connection(String connection) {
  ...
  public P2PNetworkServiceConfigUpdate consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfigUpdate contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfigUpdate externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfigUpdate managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfigUpdate purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfigUpdate roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfigUpdate addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfigUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfigUpdate vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfigUpdate p2PNetworkServiceConfigUpdate = (P2PNetworkServiceConfigUpdate) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfigUpdate.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfigUpdate.capacity) &&
        Objects.equals(this.connection, p2PNetworkServiceConfigUpdate.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfigUpdate.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfigUpdate.contractRef) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfigUpdate.externalRef) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfigUpdate.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfigUpdate.networkFeatureConfigs) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfigUpdate.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfigUpdate.roleAssignments) &&
        Objects.equals(this.type, p2PNetworkServiceConfigUpdate.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfigUpdate.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, connection, consumingAccount, contractRef, externalRef, managingAccount, networkFeatureConfigs, purchaseOrder, roleAssignments, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfigUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfigUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfigUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfigUpdate is not found in the empty JSON string", P2PNetworkServiceConfigUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfigUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfigUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfigUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfigUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfigUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfigUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfigUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfigUpdate>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfigUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfigUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfigUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfigUpdate
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfigUpdate
   */
  public static P2PNetworkServiceConfigUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfigUpdate.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfigUpdate to an JSON string
   *
   * @return JSON string
   */
