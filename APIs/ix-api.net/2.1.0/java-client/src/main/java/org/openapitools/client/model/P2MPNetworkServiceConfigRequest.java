...
public class P2MPNetworkServiceConfigRequest {
  ...
  public P2MPNetworkServiceConfigRequest() {
  }
  ...
  public P2MPNetworkServiceConfigRequest billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceConfigRequest capacity(Integer capacity) {
  ...
  public P2MPNetworkServiceConfigRequest connection(String connection) {
  ...
  public P2MPNetworkServiceConfigRequest consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceConfigRequest contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceConfigRequest externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceConfigRequest managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceConfigRequest networkService(String networkService) {
  ...
  public P2MPNetworkServiceConfigRequest purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceConfigRequest role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigRequest roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2MPNetworkServiceConfigRequest addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2MPNetworkServiceConfigRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigRequest vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceConfigRequest p2MPNetworkServiceConfigRequest = (P2MPNetworkServiceConfigRequest) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceConfigRequest.billingAccount) &&
        Objects.equals(this.capacity, p2MPNetworkServiceConfigRequest.capacity) &&
        Objects.equals(this.connection, p2MPNetworkServiceConfigRequest.connection) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceConfigRequest.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceConfigRequest.contractRef) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceConfigRequest.externalRef) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceConfigRequest.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2MPNetworkServiceConfigRequest.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2MPNetworkServiceConfigRequest.networkService) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceConfigRequest.purchaseOrder) &&
        Objects.equals(this.role, p2MPNetworkServiceConfigRequest.role) &&
        Objects.equals(this.roleAssignments, p2MPNetworkServiceConfigRequest.roleAssignments) &&
        Objects.equals(this.type, p2MPNetworkServiceConfigRequest.type) &&
        Objects.equals(this.vlanConfig, p2MPNetworkServiceConfigRequest.vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceConfigRequest is not found in the empty JSON string", P2MPNetworkServiceConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceConfigRequest>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceConfigRequest
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceConfigRequest
   */
  public static P2MPNetworkServiceConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceConfigRequest.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceConfigRequest to an JSON string
   *
   * @return JSON string
   */
