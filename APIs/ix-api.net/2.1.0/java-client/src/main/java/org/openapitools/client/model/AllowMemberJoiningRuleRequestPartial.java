...
public class AllowMemberJoiningRuleRequestPartial {
  ...
  public AllowMemberJoiningRuleRequestPartial() {
  }

  public AllowMemberJoiningRuleRequestPartial capacityMax(Integer capacityMax) {
  ...
  public AllowMemberJoiningRuleRequestPartial capacityMin(Integer capacityMin) {
  ...
  public AllowMemberJoiningRuleRequestPartial consumingAccount(String consumingAccount) {
  ...
  public AllowMemberJoiningRuleRequestPartial externalRef(String externalRef) {
  ...
  public AllowMemberJoiningRuleRequestPartial managingAccount(String managingAccount) {
  ...
  public AllowMemberJoiningRuleRequestPartial networkService(String networkService) {
  ...
  public AllowMemberJoiningRuleRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllowMemberJoiningRuleRequestPartial allowMemberJoiningRuleRequestPartial = (AllowMemberJoiningRuleRequestPartial) o;
    return Objects.equals(this.capacityMax, allowMemberJoiningRuleRequestPartial.capacityMax) &&
        Objects.equals(this.capacityMin, allowMemberJoiningRuleRequestPartial.capacityMin) &&
        Objects.equals(this.consumingAccount, allowMemberJoiningRuleRequestPartial.consumingAccount) &&
        Objects.equals(this.externalRef, allowMemberJoiningRuleRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, allowMemberJoiningRuleRequestPartial.managingAccount) &&
        Objects.equals(this.networkService, allowMemberJoiningRuleRequestPartial.networkService) &&
        Objects.equals(this.type, allowMemberJoiningRuleRequestPartial.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capacityMax, capacityMin, consumingAccount, externalRef, managingAccount, networkService, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AllowMemberJoiningRuleRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllowMemberJoiningRuleRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllowMemberJoiningRuleRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllowMemberJoiningRuleRequestPartial is not found in the empty JSON string", AllowMemberJoiningRuleRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllowMemberJoiningRuleRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllowMemberJoiningRuleRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllowMemberJoiningRuleRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllowMemberJoiningRuleRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllowMemberJoiningRuleRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllowMemberJoiningRuleRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllowMemberJoiningRuleRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<AllowMemberJoiningRuleRequestPartial>() {
           @Override
           public void write(JsonWriter out, AllowMemberJoiningRuleRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllowMemberJoiningRuleRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllowMemberJoiningRuleRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllowMemberJoiningRuleRequestPartial
   * @throws IOException if the JSON string is invalid with respect to AllowMemberJoiningRuleRequestPartial
   */
  public static AllowMemberJoiningRuleRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllowMemberJoiningRuleRequestPartial.class);
  }

  /**
   * Convert an instance of AllowMemberJoiningRuleRequestPartial to an JSON string
   *
   * @return JSON string
   */
