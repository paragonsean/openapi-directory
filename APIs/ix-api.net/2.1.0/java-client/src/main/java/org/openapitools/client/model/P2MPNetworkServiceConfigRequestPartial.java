...
public class P2MPNetworkServiceConfigRequestPartial {
  ...
  public P2MPNetworkServiceConfigRequestPartial() {
  }
  ...
  public P2MPNetworkServiceConfigRequestPartial billingAccount(String billingAccount) {
  ...
  public P2MPNetworkServiceConfigRequestPartial capacity(Integer capacity) {
  ...
  public P2MPNetworkServiceConfigRequestPartial connection(String connection) {
  ...
  public P2MPNetworkServiceConfigRequestPartial consumingAccount(String consumingAccount) {
  ...
  public P2MPNetworkServiceConfigRequestPartial contractRef(String contractRef) {
  ...
  public P2MPNetworkServiceConfigRequestPartial externalRef(String externalRef) {
  ...
  public P2MPNetworkServiceConfigRequestPartial managingAccount(String managingAccount) {
  ...
  public P2MPNetworkServiceConfigRequestPartial networkService(String networkService) {
  ...
  public P2MPNetworkServiceConfigRequestPartial purchaseOrder(String purchaseOrder) {
  ...
  public P2MPNetworkServiceConfigRequestPartial role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigRequestPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2MPNetworkServiceConfigRequestPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2MPNetworkServiceConfigRequestPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2MPNetworkServiceConfigRequestPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkServiceConfigRequestPartial p2MPNetworkServiceConfigRequestPartial = (P2MPNetworkServiceConfigRequestPartial) o;
    return Objects.equals(this.billingAccount, p2MPNetworkServiceConfigRequestPartial.billingAccount) &&
        Objects.equals(this.capacity, p2MPNetworkServiceConfigRequestPartial.capacity) &&
        Objects.equals(this.connection, p2MPNetworkServiceConfigRequestPartial.connection) &&
        Objects.equals(this.consumingAccount, p2MPNetworkServiceConfigRequestPartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2MPNetworkServiceConfigRequestPartial.contractRef) &&
        Objects.equals(this.externalRef, p2MPNetworkServiceConfigRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, p2MPNetworkServiceConfigRequestPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2MPNetworkServiceConfigRequestPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2MPNetworkServiceConfigRequestPartial.networkService) &&
        Objects.equals(this.purchaseOrder, p2MPNetworkServiceConfigRequestPartial.purchaseOrder) &&
        Objects.equals(this.role, p2MPNetworkServiceConfigRequestPartial.role) &&
        Objects.equals(this.roleAssignments, p2MPNetworkServiceConfigRequestPartial.roleAssignments) &&
        Objects.equals(this.type, p2MPNetworkServiceConfigRequestPartial.type) &&
        Objects.equals(this.vlanConfig, p2MPNetworkServiceConfigRequestPartial.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, connection, consumingAccount, contractRef, externalRef, managingAccount, networkFeatureConfigs, networkService, purchaseOrder, role, roleAssignments, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkServiceConfigRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkServiceConfigRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkServiceConfigRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkServiceConfigRequestPartial is not found in the empty JSON string", P2MPNetworkServiceConfigRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkServiceConfigRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkServiceConfigRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkServiceConfigRequestPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkServiceConfigRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkServiceConfigRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkServiceConfigRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkServiceConfigRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkServiceConfigRequestPartial>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkServiceConfigRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkServiceConfigRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkServiceConfigRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkServiceConfigRequestPartial
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkServiceConfigRequestPartial
   */
  public static P2MPNetworkServiceConfigRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkServiceConfigRequestPartial.class);
  }

  /**
   * Convert an instance of P2MPNetworkServiceConfigRequestPartial to an JSON string
   *
   * @return JSON string
   */
