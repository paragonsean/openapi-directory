...
public class MacAddressRequest {
  ...
  public MacAddressRequest address(String address) {
  ...
  public MacAddressRequest consumingAccount(String consumingAccount) {
  ...
  public MacAddressRequest externalRef(String externalRef) {
  ...
  public MacAddressRequest managingAccount(String managingAccount) {
  ...
  public MacAddressRequest validNotAfter(OffsetDateTime validNotAfter) {
  ...
  public MacAddressRequest validNotBefore(OffsetDateTime validNotBefore) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, macAddressRequest.address) &&
        Objects.equals(this.consumingAccount, macAddressRequest.consumingAccount) &&
        Objects.equals(this.externalRef, macAddressRequest.externalRef) &&
        Objects.equals(this.managingAccount, macAddressRequest.managingAccount) &&
        Objects.equals(this.validNotAfter, macAddressRequest.validNotAfter) &&
        Objects.equals(this.validNotBefore, macAddressRequest.validNotBefore);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MacAddressRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MacAddressRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MacAddressRequest is not found in the empty JSON string", MacAddressRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MacAddressRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MacAddressRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MacAddressRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MacAddressRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MacAddressRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MacAddressRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MacAddressRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MacAddressRequest>() {
           @Override
           public void write(JsonWriter out, MacAddressRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MacAddressRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MacAddressRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MacAddressRequest
   * @throws IOException if the JSON string is invalid with respect to MacAddressRequest
   */
  public static MacAddressRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MacAddressRequest.class);
  }

  /**
   * Convert an instance of MacAddressRequest to an JSON string
   *
   * @return JSON string
   */
