...
public class P2PNetworkServiceConfigPartial {
  ...
  public P2PNetworkServiceConfigPartial() {
  }
  ...
  public P2PNetworkServiceConfigPartial billingAccount(String billingAccount) {
  ...
  public P2PNetworkServiceConfigPartial capacity(Integer capacity) {
  ...
  public P2PNetworkServiceConfigPartial chargedUntil(LocalDate chargedUntil) {
  ...
  public P2PNetworkServiceConfigPartial connection(String connection) {
  ...
  public P2PNetworkServiceConfigPartial consumingAccount(String consumingAccount) {
  ...
  public P2PNetworkServiceConfigPartial contractRef(String contractRef) {
  ...
  public P2PNetworkServiceConfigPartial decommissionAt(LocalDate decommissionAt) {
  ...
  public P2PNetworkServiceConfigPartial externalRef(String externalRef) {
  ...
  public P2PNetworkServiceConfigPartial id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2PNetworkServiceConfigPartial managingAccount(String managingAccount) {
  ...
  public P2PNetworkServiceConfigPartial networkService(String networkService) {
  ...
  public P2PNetworkServiceConfigPartial purchaseOrder(String purchaseOrder) {
  ...
  public P2PNetworkServiceConfigPartial roleAssignments(List<String> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public P2PNetworkServiceConfigPartial addRoleAssignmentsItem(String roleAssignmentsItem) {
  ...
  public P2PNetworkServiceConfigPartial state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public P2PNetworkServiceConfigPartial status(List<Status> status) {
    this.status = status;
    return this;
  }

  public P2PNetworkServiceConfigPartial addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public P2PNetworkServiceConfigPartial type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2PNetworkServiceConfigPartial vlanConfig(VlanConfig vlanConfig) {
  ...
  public boolean equals(Object o) {
    ...
    P2PNetworkServiceConfigPartial p2PNetworkServiceConfigPartial = (P2PNetworkServiceConfigPartial) o;
    return Objects.equals(this.billingAccount, p2PNetworkServiceConfigPartial.billingAccount) &&
        Objects.equals(this.capacity, p2PNetworkServiceConfigPartial.capacity) &&
        Objects.equals(this.chargedUntil, p2PNetworkServiceConfigPartial.chargedUntil) &&
        Objects.equals(this.connection, p2PNetworkServiceConfigPartial.connection) &&
        Objects.equals(this.consumingAccount, p2PNetworkServiceConfigPartial.consumingAccount) &&
        Objects.equals(this.contractRef, p2PNetworkServiceConfigPartial.contractRef) &&
        Objects.equals(this.decommissionAt, p2PNetworkServiceConfigPartial.decommissionAt) &&
        Objects.equals(this.externalRef, p2PNetworkServiceConfigPartial.externalRef) &&
        Objects.equals(this.id, p2PNetworkServiceConfigPartial.id) &&
        Objects.equals(this.managingAccount, p2PNetworkServiceConfigPartial.managingAccount) &&
        Objects.equals(this.networkFeatureConfigs, p2PNetworkServiceConfigPartial.networkFeatureConfigs) &&
        Objects.equals(this.networkService, p2PNetworkServiceConfigPartial.networkService) &&
        Objects.equals(this.purchaseOrder, p2PNetworkServiceConfigPartial.purchaseOrder) &&
        Objects.equals(this.roleAssignments, p2PNetworkServiceConfigPartial.roleAssignments) &&
        Objects.equals(this.state, p2PNetworkServiceConfigPartial.state) &&
        Objects.equals(this.status, p2PNetworkServiceConfigPartial.status) &&
        Objects.equals(this.type, p2PNetworkServiceConfigPartial.type) &&
        Objects.equals(this.vlanConfig, p2PNetworkServiceConfigPartial.vlanConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingAccount, capacity, chargedUntil, connection, consumingAccount, contractRef, decommissionAt, externalRef, id, managingAccount, networkFeatureConfigs, networkService, purchaseOrder, roleAssignments, state, status, type, vlanConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PNetworkServiceConfigPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2PNetworkServiceConfigPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2PNetworkServiceConfigPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2PNetworkServiceConfigPartial is not found in the empty JSON string", P2PNetworkServiceConfigPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2PNetworkServiceConfigPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2PNetworkServiceConfigPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2PNetworkServiceConfigPartial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2PNetworkServiceConfigPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2PNetworkServiceConfigPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2PNetworkServiceConfigPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2PNetworkServiceConfigPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<P2PNetworkServiceConfigPartial>() {
           @Override
           public void write(JsonWriter out, P2PNetworkServiceConfigPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2PNetworkServiceConfigPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2PNetworkServiceConfigPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2PNetworkServiceConfigPartial
   * @throws IOException if the JSON string is invalid with respect to P2PNetworkServiceConfigPartial
   */
  public static P2PNetworkServiceConfigPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2PNetworkServiceConfigPartial.class);
  }

  /**
   * Convert an instance of P2PNetworkServiceConfigPartial to an JSON string
   *
   * @return JSON string
   */
