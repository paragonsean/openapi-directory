...
public class P2MPNetworkProductOffering {
  ...
  public P2MPNetworkProductOffering() {
  }

  public P2MPNetworkProductOffering bandwidthMax(Integer bandwidthMax) {
  ...
  public P2MPNetworkProductOffering bandwidthMin(Integer bandwidthMin) {
  ...
  public P2MPNetworkProductOffering displayName(String displayName) {
  ...
  public P2MPNetworkProductOffering downgradeAllowed(Boolean downgradeAllowed) {
  ...
  public P2MPNetworkProductOffering handoverMetroArea(String handoverMetroArea) {
  ...
  public P2MPNetworkProductOffering handoverMetroAreaNetwork(String handoverMetroAreaNetwork) {
  ...
  public P2MPNetworkProductOffering id(String id) {
    this.id = id;
    return this;
  }
  ...
  public P2MPNetworkProductOffering name(String name) {
    this.name = name;
    return this;
  }
  ...
  public P2MPNetworkProductOffering physicalPortSpeed(Integer physicalPortSpeed) {
  ...
  public P2MPNetworkProductOffering providerVlans(ProviderVlansEnum providerVlans) {
  ...
  public P2MPNetworkProductOffering resourceType(ResourceTypeEnum resourceType) {
  ...
  public P2MPNetworkProductOffering serviceMetroArea(String serviceMetroArea) {
  ...
  public P2MPNetworkProductOffering serviceMetroAreaNetwork(String serviceMetroAreaNetwork) {
  ...
  public P2MPNetworkProductOffering serviceProvider(String serviceProvider) {
  ...
  public P2MPNetworkProductOffering type(String type) {
    this.type = type;
    return this;
  }
  ...
  public P2MPNetworkProductOffering upgradeAllowed(Boolean upgradeAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    P2MPNetworkProductOffering p2MPNetworkProductOffering = (P2MPNetworkProductOffering) o;
    return Objects.equals(this.bandwidthMax, p2MPNetworkProductOffering.bandwidthMax) &&
        Objects.equals(this.bandwidthMin, p2MPNetworkProductOffering.bandwidthMin) &&
        Objects.equals(this.displayName, p2MPNetworkProductOffering.displayName) &&
        Objects.equals(this.downgradeAllowed, p2MPNetworkProductOffering.downgradeAllowed) &&
        Objects.equals(this.handoverMetroArea, p2MPNetworkProductOffering.handoverMetroArea) &&
        Objects.equals(this.handoverMetroAreaNetwork, p2MPNetworkProductOffering.handoverMetroAreaNetwork) &&
        Objects.equals(this.id, p2MPNetworkProductOffering.id) &&
        Objects.equals(this.name, p2MPNetworkProductOffering.name) &&
        Objects.equals(this.physicalPortSpeed, p2MPNetworkProductOffering.physicalPortSpeed) &&
        Objects.equals(this.providerVlans, p2MPNetworkProductOffering.providerVlans) &&
        Objects.equals(this.resourceType, p2MPNetworkProductOffering.resourceType) &&
        Objects.equals(this.serviceMetroArea, p2MPNetworkProductOffering.serviceMetroArea) &&
        Objects.equals(this.serviceMetroAreaNetwork, p2MPNetworkProductOffering.serviceMetroAreaNetwork) &&
        Objects.equals(this.serviceProvider, p2MPNetworkProductOffering.serviceProvider) &&
        Objects.equals(this.type, p2MPNetworkProductOffering.type) &&
        Objects.equals(this.upgradeAllowed, p2MPNetworkProductOffering.upgradeAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2MPNetworkProductOffering {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2MPNetworkProductOffering
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2MPNetworkProductOffering.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2MPNetworkProductOffering is not found in the empty JSON string", P2MPNetworkProductOffering.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2MPNetworkProductOffering.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2MPNetworkProductOffering` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2MPNetworkProductOffering.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2MPNetworkProductOffering.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2MPNetworkProductOffering' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2MPNetworkProductOffering> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2MPNetworkProductOffering.class));

       return (TypeAdapter<T>) new TypeAdapter<P2MPNetworkProductOffering>() {
           @Override
           public void write(JsonWriter out, P2MPNetworkProductOffering value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2MPNetworkProductOffering read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2MPNetworkProductOffering given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2MPNetworkProductOffering
   * @throws IOException if the JSON string is invalid with respect to P2MPNetworkProductOffering
   */
  public static P2MPNetworkProductOffering fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2MPNetworkProductOffering.class);
  }

  /**
   * Convert an instance of P2MPNetworkProductOffering to an JSON string
   *
   * @return JSON string
   */
