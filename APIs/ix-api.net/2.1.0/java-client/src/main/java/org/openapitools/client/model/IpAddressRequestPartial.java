...
public class IpAddressRequestPartial {
  ...
  public IpAddressRequestPartial() {
  }

  public IpAddressRequestPartial address(String address) {
  ...
  public IpAddressRequestPartial consumingAccount(String consumingAccount) {
  ...
  public IpAddressRequestPartial externalRef(String externalRef) {
  ...
  public IpAddressRequestPartial fqdn(String fqdn) {
    this.fqdn = fqdn;
    return this;
  }
  ...
  public IpAddressRequestPartial managingAccount(String managingAccount) {
  ...
  public IpAddressRequestPartial prefixLength(Integer prefixLength) {
  ...
  public IpAddressRequestPartial validNotAfter(OffsetDateTime validNotAfter) {
  ...
  public IpAddressRequestPartial validNotBefore(OffsetDateTime validNotBefore) {
  ...
  public IpAddressRequestPartial version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    IpAddressRequestPartial ipAddressRequestPartial = (IpAddressRequestPartial) o;
    return Objects.equals(this.address, ipAddressRequestPartial.address) &&
        Objects.equals(this.consumingAccount, ipAddressRequestPartial.consumingAccount) &&
        Objects.equals(this.externalRef, ipAddressRequestPartial.externalRef) &&
        Objects.equals(this.fqdn, ipAddressRequestPartial.fqdn) &&
        Objects.equals(this.managingAccount, ipAddressRequestPartial.managingAccount) &&
        Objects.equals(this.prefixLength, ipAddressRequestPartial.prefixLength) &&
        Objects.equals(this.validNotAfter, ipAddressRequestPartial.validNotAfter) &&
        Objects.equals(this.validNotBefore, ipAddressRequestPartial.validNotBefore) &&
        Objects.equals(this.version, ipAddressRequestPartial.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class IpAddressRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpAddressRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpAddressRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpAddressRequestPartial is not found in the empty JSON string", IpAddressRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpAddressRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpAddressRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IpAddressRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IpAddressRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IpAddressRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpAddressRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<IpAddressRequestPartial>() {
           @Override
           public void write(JsonWriter out, IpAddressRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IpAddressRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IpAddressRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IpAddressRequestPartial
   * @throws IOException if the JSON string is invalid with respect to IpAddressRequestPartial
   */
  public static IpAddressRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IpAddressRequestPartial.class);
  }

  /**
   * Convert an instance of IpAddressRequestPartial to an JSON string
   *
   * @return JSON string
   */
