...
public class Device {
  ...
  public Device capabilities(List<DeviceCapability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public Device addCapabilitiesItem(DeviceCapability capabilitiesItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("pop").isJsonPrimitive()) {
