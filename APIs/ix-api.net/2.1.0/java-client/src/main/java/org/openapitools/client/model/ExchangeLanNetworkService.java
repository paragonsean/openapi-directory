...
public class ExchangeLanNetworkService {
  ...
  public ExchangeLanNetworkService() {
  }
  ...
  public ExchangeLanNetworkService consumingAccount(String consumingAccount) {
  ...
  public ExchangeLanNetworkService externalRef(String externalRef) {
  ...
  public ExchangeLanNetworkService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExchangeLanNetworkService ixfdbIxid(Integer ixfdbIxid) {
  ...
  public ExchangeLanNetworkService managingAccount(String managingAccount) {
  ...
  public ExchangeLanNetworkService metroAreaNetwork(String metroAreaNetwork) {
  ...
  public ExchangeLanNetworkService name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ExchangeLanNetworkService networkFeatures(List<String> networkFeatures) {
    this.networkFeatures = networkFeatures;
    return this;
  }

  public ExchangeLanNetworkService addNetworkFeaturesItem(String networkFeaturesItem) {
  ...
  public ExchangeLanNetworkService peeringdbIxid(Integer peeringdbIxid) {
  ...
  public ExchangeLanNetworkService productOffering(String productOffering) {
  ...
  public ExchangeLanNetworkService state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public ExchangeLanNetworkService status(List<Status> status) {
    this.status = status;
    return this;
  }

  public ExchangeLanNetworkService addStatusItem(Status statusItem) {
    if (this.status == null) {
  ...
  public ExchangeLanNetworkService subnetV4(String subnetV4) {
  ...
  public ExchangeLanNetworkService subnetV6(String subnetV6) {
  ...
  public ExchangeLanNetworkService type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangeLanNetworkService exchangeLanNetworkService = (ExchangeLanNetworkService) o;
    return Objects.equals(this.consumingAccount, exchangeLanNetworkService.consumingAccount) &&
        Objects.equals(this.externalRef, exchangeLanNetworkService.externalRef) &&
        Objects.equals(this.id, exchangeLanNetworkService.id) &&
        Objects.equals(this.ixfdbIxid, exchangeLanNetworkService.ixfdbIxid) &&
        Objects.equals(this.managingAccount, exchangeLanNetworkService.managingAccount) &&
        Objects.equals(this.metroAreaNetwork, exchangeLanNetworkService.metroAreaNetwork) &&
        Objects.equals(this.name, exchangeLanNetworkService.name) &&
        Objects.equals(this.networkFeatures, exchangeLanNetworkService.networkFeatures) &&
        Objects.equals(this.nscRequiredContactRoles, exchangeLanNetworkService.nscRequiredContactRoles) &&
        Objects.equals(this.peeringdbIxid, exchangeLanNetworkService.peeringdbIxid) &&
        Objects.equals(this.productOffering, exchangeLanNetworkService.productOffering) &&
        Objects.equals(this.state, exchangeLanNetworkService.state) &&
        Objects.equals(this.status, exchangeLanNetworkService.status) &&
        Objects.equals(this.subnetV4, exchangeLanNetworkService.subnetV4) &&
        Objects.equals(this.subnetV6, exchangeLanNetworkService.subnetV6) &&
        Objects.equals(this.type, exchangeLanNetworkService.type);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("subnet_v6");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangeLanNetworkService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangeLanNetworkService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangeLanNetworkService is not found in the empty JSON string", ExchangeLanNetworkService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangeLanNetworkService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangeLanNetworkService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExchangeLanNetworkService.openapiRequiredFields) {
      ...
      if (!jsonObj.get("subnet_v4").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("subnet_v6").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangeLanNetworkService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangeLanNetworkService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangeLanNetworkService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangeLanNetworkService.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangeLanNetworkService>() {
           @Override
           public void write(JsonWriter out, ExchangeLanNetworkService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangeLanNetworkService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangeLanNetworkService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangeLanNetworkService
   * @throws IOException if the JSON string is invalid with respect to ExchangeLanNetworkService
   */
  public static ExchangeLanNetworkService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangeLanNetworkService.class);
  }

  /**
   * Convert an instance of ExchangeLanNetworkService to an JSON string
   *
   * @return JSON string
   */
