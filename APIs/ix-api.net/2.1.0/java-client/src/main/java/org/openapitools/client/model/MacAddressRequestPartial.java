...
public class MacAddressRequestPartial {
  ...
  public MacAddressRequestPartial() {
  }

  public MacAddressRequestPartial address(String address) {
  ...
  public MacAddressRequestPartial consumingAccount(String consumingAccount) {
  ...
  public MacAddressRequestPartial externalRef(String externalRef) {
  ...
  public MacAddressRequestPartial managingAccount(String managingAccount) {
  ...
  public MacAddressRequestPartial validNotAfter(OffsetDateTime validNotAfter) {
  ...
  public MacAddressRequestPartial validNotBefore(OffsetDateTime validNotBefore) {
  ...
  public boolean equals(Object o) {
    ...
    MacAddressRequestPartial macAddressRequestPartial = (MacAddressRequestPartial) o;
    return Objects.equals(this.address, macAddressRequestPartial.address) &&
        Objects.equals(this.consumingAccount, macAddressRequestPartial.consumingAccount) &&
        Objects.equals(this.externalRef, macAddressRequestPartial.externalRef) &&
        Objects.equals(this.managingAccount, macAddressRequestPartial.managingAccount) &&
        Objects.equals(this.validNotAfter, macAddressRequestPartial.validNotAfter) &&
        Objects.equals(this.validNotBefore, macAddressRequestPartial.validNotBefore);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, consumingAccount, externalRef, managingAccount, validNotAfter, validNotBefore);
  }
  ...
  public String toString() {
    ...
    sb.append("class MacAddressRequestPartial {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MacAddressRequestPartial
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MacAddressRequestPartial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MacAddressRequestPartial is not found in the empty JSON string", MacAddressRequestPartial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MacAddressRequestPartial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MacAddressRequestPartial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MacAddressRequestPartial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MacAddressRequestPartial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MacAddressRequestPartial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MacAddressRequestPartial.class));

       return (TypeAdapter<T>) new TypeAdapter<MacAddressRequestPartial>() {
           @Override
           public void write(JsonWriter out, MacAddressRequestPartial value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MacAddressRequestPartial read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MacAddressRequestPartial given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MacAddressRequestPartial
   * @throws IOException if the JSON string is invalid with respect to MacAddressRequestPartial
   */
  public static MacAddressRequestPartial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MacAddressRequestPartial.class);
  }

  /**
   * Convert an instance of MacAddressRequestPartial to an JSON string
   *
   * @return JSON string
   */
