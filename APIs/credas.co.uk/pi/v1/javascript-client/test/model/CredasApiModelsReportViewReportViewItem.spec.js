...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsReportViewReportViewItem();
  });
  ...
  describe('CredasApiModelsReportViewReportViewItem', function() {
    it('should create an instance of CredasApiModelsReportViewReportViewItem', function() {
      // uncomment below and update the code to test CredasApiModelsReportViewReportViewItem
      //var instance = new CredasApi.CredasApiModelsReportViewReportViewItem();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsReportViewReportViewItem);
    });
