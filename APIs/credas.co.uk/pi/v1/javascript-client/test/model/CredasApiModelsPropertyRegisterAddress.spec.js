...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsPropertyRegisterAddress();
  });
  ...
  describe('CredasApiModelsPropertyRegisterAddress', function() {
    it('should create an instance of CredasApiModelsPropertyRegisterAddress', function() {
      // uncomment below and update the code to test CredasApiModelsPropertyRegisterAddress
      //var instance = new CredasApi.CredasApiModelsPropertyRegisterAddress();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsPropertyRegisterAddress);
    });
