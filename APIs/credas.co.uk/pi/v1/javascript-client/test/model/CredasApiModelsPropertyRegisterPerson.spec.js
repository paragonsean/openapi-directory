...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsPropertyRegisterPerson();
  });
  ...
  describe('CredasApiModelsPropertyRegisterPerson', function() {
    it('should create an instance of CredasApiModelsPropertyRegisterPerson', function() {
      // uncomment below and update the code to test CredasApiModelsPropertyRegisterPerson
      //var instance = new CredasApi.CredasApiModelsPropertyRegisterPerson();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsPropertyRegisterPerson);
    });
