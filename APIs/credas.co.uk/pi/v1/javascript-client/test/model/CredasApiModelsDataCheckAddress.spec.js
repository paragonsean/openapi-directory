...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsDataCheckAddress();
  });
  ...
  describe('CredasApiModelsDataCheckAddress', function() {
    it('should create an instance of CredasApiModelsDataCheckAddress', function() {
      // uncomment below and update the code to test CredasApiModelsDataCheckAddress
      //var instance = new CredasApi.CredasApiModelsDataCheckAddress();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsDataCheckAddress);
    });
