...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsRegistrationsPersonalDetails();
  });
  ...
  describe('CredasApiModelsRegistrationsPersonalDetails', function() {
    it('should create an instance of CredasApiModelsRegistrationsPersonalDetails', function() {
      // uncomment below and update the code to test CredasApiModelsRegistrationsPersonalDetails
      //var instance = new CredasApi.CredasApiModelsRegistrationsPersonalDetails();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsRegistrationsPersonalDetails);
    });
