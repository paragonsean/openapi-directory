...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsImagesAddIdDocumentImageResponse();
  });
  ...
  describe('CredasApiModelsImagesAddIdDocumentImageResponse', function() {
    it('should create an instance of CredasApiModelsImagesAddIdDocumentImageResponse', function() {
      // uncomment below and update the code to test CredasApiModelsImagesAddIdDocumentImageResponse
      //var instance = new CredasApi.CredasApiModelsImagesAddIdDocumentImageResponse();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsImagesAddIdDocumentImageResponse);
    });
