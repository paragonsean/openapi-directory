...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CredasApi.CredasApiModelsBankAccountsPerson();
  });
  ...
  describe('CredasApiModelsBankAccountsPerson', function() {
    it('should create an instance of CredasApiModelsBankAccountsPerson', function() {
      // uncomment below and update the code to test CredasApiModelsBankAccountsPerson
      //var instance = new CredasApi.CredasApiModelsBankAccountsPerson();
      //expect(instance).to.be.a(CredasApi.CredasApiModelsBankAccountsPerson);
    });
