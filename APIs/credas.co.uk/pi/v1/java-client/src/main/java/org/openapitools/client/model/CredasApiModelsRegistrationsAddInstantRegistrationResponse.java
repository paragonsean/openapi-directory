...
public class CredasApiModelsRegistrationsAddInstantRegistrationResponse {
  ...
  public CredasApiModelsRegistrationsAddInstantRegistrationResponse() {
  }

  public CredasApiModelsRegistrationsAddInstantRegistrationResponse documentStatus(DocumentStatusEnum documentStatus) {
  ...
  public CredasApiModelsRegistrationsAddInstantRegistrationResponse documentType(DocumentTypeEnum documentType) {
  ...
  public CredasApiModelsRegistrationsAddInstantRegistrationResponse facialMatch(Boolean facialMatch) {
  ...
  public CredasApiModelsRegistrationsAddInstantRegistrationResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CredasApiModelsRegistrationsAddInstantRegistrationResponse regCode(String regCode) {
  ...
  public boolean equals(Object o) {
    ...
    CredasApiModelsRegistrationsAddInstantRegistrationResponse credasApiModelsRegistrationsAddInstantRegistrationResponse = (CredasApiModelsRegistrationsAddInstantRegistrationResponse) o;
    return Objects.equals(this.documentStatus, credasApiModelsRegistrationsAddInstantRegistrationResponse.documentStatus) &&
        Objects.equals(this.documentType, credasApiModelsRegistrationsAddInstantRegistrationResponse.documentType) &&
        Objects.equals(this.facialMatch, credasApiModelsRegistrationsAddInstantRegistrationResponse.facialMatch) &&
        Objects.equals(this.id, credasApiModelsRegistrationsAddInstantRegistrationResponse.id) &&
        Objects.equals(this.regCode, credasApiModelsRegistrationsAddInstantRegistrationResponse.regCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CredasApiModelsRegistrationsAddInstantRegistrationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CredasApiModelsRegistrationsAddInstantRegistrationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CredasApiModelsRegistrationsAddInstantRegistrationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CredasApiModelsRegistrationsAddInstantRegistrationResponse is not found in the empty JSON string", CredasApiModelsRegistrationsAddInstantRegistrationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CredasApiModelsRegistrationsAddInstantRegistrationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CredasApiModelsRegistrationsAddInstantRegistrationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CredasApiModelsRegistrationsAddInstantRegistrationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CredasApiModelsRegistrationsAddInstantRegistrationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CredasApiModelsRegistrationsAddInstantRegistrationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CredasApiModelsRegistrationsAddInstantRegistrationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CredasApiModelsRegistrationsAddInstantRegistrationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CredasApiModelsRegistrationsAddInstantRegistrationResponse>() {
           @Override
           public void write(JsonWriter out, CredasApiModelsRegistrationsAddInstantRegistrationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CredasApiModelsRegistrationsAddInstantRegistrationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CredasApiModelsRegistrationsAddInstantRegistrationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CredasApiModelsRegistrationsAddInstantRegistrationResponse
   * @throws IOException if the JSON string is invalid with respect to CredasApiModelsRegistrationsAddInstantRegistrationResponse
   */
  public static CredasApiModelsRegistrationsAddInstantRegistrationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CredasApiModelsRegistrationsAddInstantRegistrationResponse.class);
  }

  /**
   * Convert an instance of CredasApiModelsRegistrationsAddInstantRegistrationResponse to an JSON string
   *
   * @return JSON string
   */
