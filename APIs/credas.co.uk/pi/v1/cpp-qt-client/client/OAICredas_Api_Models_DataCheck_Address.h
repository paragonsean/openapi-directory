...
/*
 * OAICredas_Api_Models_DataCheck_Address.h
 *
 * 
 */

#ifndef OAICredas_Api_Models_DataCheck_Address_H
#define OAICredas_Api_Models_DataCheck_Address_H
...
class OAICredas_Api_Models_DataCheck_Address : public OAIObject {
public:
    OAICredas_Api_Models_DataCheck_Address();
    OAICredas_Api_Models_DataCheck_Address(QString json);
    ~OAICredas_Api_Models_DataCheck_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICredas_Api_Models_DataCheck_Address)

#endif // OAICredas_Api_Models_DataCheck_Address_H
