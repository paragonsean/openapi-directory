...
/*
 * OAICredas_Api_Models_PropertyRegister_Address.h
 *
 * 
 */

#ifndef OAICredas_Api_Models_PropertyRegister_Address_H
#define OAICredas_Api_Models_PropertyRegister_Address_H
...
class OAICredas_Api_Models_PropertyRegister_Address : public OAIObject {
public:
    OAICredas_Api_Models_PropertyRegister_Address();
    OAICredas_Api_Models_PropertyRegister_Address(QString json);
    ~OAICredas_Api_Models_PropertyRegister_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICredas_Api_Models_PropertyRegister_Address)

#endif // OAICredas_Api_Models_PropertyRegister_Address_H
