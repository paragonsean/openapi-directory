...
class CredasApiModelsRegistrationsAddInstantRegistrationResponse(Model):
    ...
    def __init__(self, document_status: int=None, document_type: int=None, facial_match: bool=None, id: str=None, reg_code: str=None):
        """CredasApiModelsRegistrationsAddInstantRegistrationResponse - a model defined in OpenAPI

        :param document_status: The document_status of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :param document_type: The document_type of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :param facial_match: The facial_match of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :param id: The id of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :param reg_code: The reg_code of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        """
        self.openapi_types = {
            'document_status': int,
            'document_type': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CredasApiModelsRegistrationsAddInstantRegistrationResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Credas.Api.Models.Registrations.AddInstantRegistrationResponse of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def document_status(self):
        """Gets the document_status of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.

        Active = 1, Deleted = 2, UnderReview = 3

        :return: The document_status of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :rtype: int
        """
    ...
    def document_status(self, document_status):
        """Sets the document_status of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
    ...
    def document_type(self):
        """Gets the document_type of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        ...
        :return: The document_type of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :rtype: int
        """
    ...
    def document_type(self, document_type):
        """Sets the document_type of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
    ...
    def facial_match(self):
        """Gets the facial_match of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.


        :return: The facial_match of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :rtype: bool
        """
    ...
    def facial_match(self, facial_match):
        """Sets the facial_match of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
    ...
    @property
    def id(self):
        """Gets the id of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.


        :return: The id of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
    ...
    @property
    def reg_code(self):
        """Gets the reg_code of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.


        :return: The reg_code of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
        :rtype: str
        """
    ...
    def reg_code(self, reg_code):
        """Sets the reg_code of this CredasApiModelsRegistrationsAddInstantRegistrationResponse.
