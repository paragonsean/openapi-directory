...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.DeveloperToken();
  });
  ...
  describe('DeveloperToken', function() {
    it('should create an instance of DeveloperToken', function() {
      // uncomment below and update the code to test DeveloperToken
      //var instance = new OpenChannelMarketApi.DeveloperToken();
      //expect(instance).to.be.a(OpenChannelMarketApi.DeveloperToken);
    });
