...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.ReviewPages();
  });
  ...
  describe('ReviewPages', function() {
    it('should create an instance of ReviewPages', function() {
      // uncomment below and update the code to test ReviewPages
      //var instance = new OpenChannelMarketApi.ReviewPages();
      //expect(instance).to.be.a(OpenChannelMarketApi.ReviewPages);
    });
