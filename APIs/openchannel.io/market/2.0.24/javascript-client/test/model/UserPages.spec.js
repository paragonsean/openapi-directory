...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.UserPages();
  });
  ...
  describe('UserPages', function() {
    it('should create an instance of UserPages', function() {
      // uncomment below and update the code to test UserPages
      //var instance = new OpenChannelMarketApi.UserPages();
      //expect(instance).to.be.a(OpenChannelMarketApi.UserPages);
    });
