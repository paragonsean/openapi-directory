...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.SearchPages();
  });
  ...
  describe('SearchPages', function() {
    it('should create an instance of SearchPages', function() {
      // uncomment below and update the code to test SearchPages
      //var instance = new OpenChannelMarketApi.SearchPages();
      //expect(instance).to.be.a(OpenChannelMarketApi.SearchPages);
    });
