...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.AppPages();
  });
  ...
  describe('AppPages', function() {
    it('should create an instance of AppPages', function() {
      // uncomment below and update the code to test AppPages
      //var instance = new OpenChannelMarketApi.AppPages();
      //expect(instance).to.be.a(OpenChannelMarketApi.AppPages);
    });
