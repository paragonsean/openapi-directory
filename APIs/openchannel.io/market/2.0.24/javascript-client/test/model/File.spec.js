...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.File();
  });
  ...
  describe('File', function() {
    it('should create an instance of File', function() {
      ...
      //var instance = new OpenChannelMarketApi.File();
      //expect(instance).to.be.a(OpenChannelMarketApi.File);
    });
    ...
    it('should have the property mimeCheck (base name: "mimeCheck")', function() {
      // uncomment below and update the code to test the property mimeCheck
      //var instance = new OpenChannelMarketApi.File();
      //expect(instance).to.be();
    });
    ...
    it('should have the property virusScan (base name: "virusScan")', function() {
      // uncomment below and update the code to test the property virusScan
      //var instance = new OpenChannelMarketApi.File();
      //expect(instance).to.be();
    });
