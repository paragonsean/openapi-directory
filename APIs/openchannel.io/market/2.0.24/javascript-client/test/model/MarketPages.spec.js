...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.MarketPages();
  });
  ...
  describe('MarketPages', function() {
    it('should create an instance of MarketPages', function() {
      // uncomment below and update the code to test MarketPages
      //var instance = new OpenChannelMarketApi.MarketPages();
      //expect(instance).to.be.a(OpenChannelMarketApi.MarketPages);
    });
