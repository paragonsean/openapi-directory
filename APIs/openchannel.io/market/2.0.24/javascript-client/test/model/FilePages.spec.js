...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenChannelMarketApi.FilePages();
  });
  ...
  describe('FilePages', function() {
    it('should create an instance of FilePages', function() {
      // uncomment below and update the code to test FilePages
      //var instance = new OpenChannelMarketApi.FilePages();
      //expect(instance).to.be.a(OpenChannelMarketApi.FilePages);
    });
