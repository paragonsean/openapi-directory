...
|**rating** | **Integer** | The rating given within this review. The rating is represented as an integer between 100 and 500 (1 - 5 stars) |  |
|**reportDate** | **Long** | The date (in millis) this Review was posted |  |
