...
/*
 * OAIUserAccountPages.h
 *
 * Pages of userAccount results
 */

#ifndef OAIUserAccountPages_H
#define OAIUserAccountPages_H
...
class OAIUserAccountPages : public OAIObject {
public:
    OAIUserAccountPages();
    OAIUserAccountPages(QString json);
    ~OAIUserAccountPages() override;
    ...
    QList<OAIUserAccount> getList() const;
    void setList(const QList<OAIUserAccount> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserAccountPages)

#endif // OAIUserAccountPages_H
