...
#ifndef OAIAppPages_H
#define OAIAppPages_H
...
class OAIAppPages : public OAIObject {
public:
    OAIAppPages();
    OAIAppPages(QString json);
    ~OAIAppPages() override;
    ...
    QList<OAIApp> getList() const;
    void setList(const QList<OAIApp> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppPages)
