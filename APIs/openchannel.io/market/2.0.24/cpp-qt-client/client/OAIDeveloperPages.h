...
#ifndef OAIDeveloperPages_H
#define OAIDeveloperPages_H
...
class OAIDeveloperPages : public OAIObject {
public:
    OAIDeveloperPages();
    OAIDeveloperPages(QString json);
    ~OAIDeveloperPages() override;
    ...
    QList<OAIDeveloper> getList() const;
    void setList(const QList<OAIDeveloper> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeveloperPages)

#endif // OAIDeveloperPages_H
