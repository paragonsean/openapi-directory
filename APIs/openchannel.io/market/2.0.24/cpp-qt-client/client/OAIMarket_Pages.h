...
#ifndef OAIMarket_Pages_H
#define OAIMarket_Pages_H
...
class OAIMarket_Pages : public OAIObject {
public:
    OAIMarket_Pages();
    OAIMarket_Pages(QString json);
    ~OAIMarket_Pages() override;
    ...
    QList<OAIMarket> getList() const;
    void setList(const QList<OAIMarket> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarket_Pages)

#endif // OAIMarket_Pages_H
