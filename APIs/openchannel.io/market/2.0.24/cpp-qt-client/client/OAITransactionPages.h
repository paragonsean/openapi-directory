...
/*
 * OAITransactionPages.h
 *
 * Pages of transaction results
 */

#ifndef OAITransactionPages_H
#define OAITransactionPages_H
...
class OAITransactionPages : public OAIObject {
public:
    OAITransactionPages();
    OAITransactionPages(QString json);
    ~OAITransactionPages() override;
    ...
    QList<OAITransaction> getList() const;
    void setList(const QList<OAITransaction> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionPages)

#endif // OAITransactionPages_H
