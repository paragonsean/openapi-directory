...
#ifndef OAIReviewPages_H
#define OAIReviewPages_H
...
class OAIReviewPages : public OAIObject {
public:
    OAIReviewPages();
    OAIReviewPages(QString json);
    ~OAIReviewPages() override;
    ...
    QList<OAIReview> getList() const;
    void setList(const QList<OAIReview> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReviewPages)

#endif // OAIReviewPages_H
