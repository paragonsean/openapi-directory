...
#ifndef OAIVersionPages_H
#define OAIVersionPages_H
...
class OAIVersionPages : public OAIObject {
public:
    OAIVersionPages();
    OAIVersionPages(QString json);
    ~OAIVersionPages() override;
    ...
    QList<OAIAppVersion> getList() const;
    void setList(const QList<OAIAppVersion> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVersionPages)

#endif // OAIVersionPages_H
