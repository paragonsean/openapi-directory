...
#ifndef OAISearchPages_H
#define OAISearchPages_H
...
class OAISearchPages : public OAIObject {
public:
    OAISearchPages();
    OAISearchPages(QString json);
    ~OAISearchPages() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPages)

#endif // OAISearchPages_H
