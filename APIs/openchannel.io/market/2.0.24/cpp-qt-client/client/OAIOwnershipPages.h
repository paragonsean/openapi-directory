...
#ifndef OAIOwnershipPages_H
#define OAIOwnershipPages_H
...
class OAIOwnershipPages : public OAIObject {
public:
    OAIOwnershipPages();
    OAIOwnershipPages(QString json);
    ~OAIOwnershipPages() override;
    ...
    QList<OAIOwnership> getList() const;
    void setList(const QList<OAIOwnership> &list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOwnershipPages)

#endif // OAIOwnershipPages_H
