...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.Extras();
  });
  ...
  describe('Extras', function() {
    it('should create an instance of Extras', function() {
      // uncomment below and update the code to test Extras
      //var instance = new PlatformApi.Extras();
      //expect(instance).to.be.a(PlatformApi.Extras);
    });
