...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.ChannelDetails();
  });
  ...
  describe('ChannelDetails', function() {
    it('should create an instance of ChannelDetails', function() {
      ...
      //var instance = new PlatformApi.ChannelDetails();
      //expect(instance).to.be.a(PlatformApi.ChannelDetails);
    });
    ...
    it('should have the property isGlobalMaster (base name: "isGlobalMaster")', function() {
      // uncomment below and update the code to test the property isGlobalMaster
      //var instance = new PlatformApi.ChannelDetails();
      //expect(instance).to.be();
    });
