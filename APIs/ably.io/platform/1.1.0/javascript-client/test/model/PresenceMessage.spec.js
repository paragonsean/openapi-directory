...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.PresenceMessage();
  });
  ...
  describe('PresenceMessage', function() {
    it('should create an instance of PresenceMessage', function() {
      // uncomment below and update the code to test PresenceMessage
      //var instance = new PlatformApi.PresenceMessage();
      //expect(instance).to.be.a(PlatformApi.PresenceMessage);
    });
