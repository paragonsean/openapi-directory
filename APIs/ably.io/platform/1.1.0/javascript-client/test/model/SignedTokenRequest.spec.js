...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.SignedTokenRequest();
  });
  ...
  describe('SignedTokenRequest', function() {
    it('should create an instance of SignedTokenRequest', function() {
      // uncomment below and update the code to test SignedTokenRequest
      //var instance = new PlatformApi.SignedTokenRequest();
      //expect(instance).to.be.a(PlatformApi.SignedTokenRequest);
    });
