...
#ifndef OAIPush_fcm_H
#define OAIPush_fcm_H
...
class OAIPush_fcm : public OAIObject {
public:
    OAIPush_fcm();
    OAIPush_fcm(QString json);
    ~OAIPush_fcm() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPush_fcm)
