...
/*
 * OAISignedTokenRequest.h
 *
 * 
 */

#ifndef OAISignedTokenRequest_H
#define OAISignedTokenRequest_H
...
class OAISignedTokenRequest : public OAIObject {
public:
    OAISignedTokenRequest();
    OAISignedTokenRequest(QString json);
    ~OAISignedTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignedTokenRequest)

#endif // OAISignedTokenRequest_H
