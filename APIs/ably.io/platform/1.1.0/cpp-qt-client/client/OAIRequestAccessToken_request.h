...
/*
 * OAIRequestAccessToken_request.h
 *
 * 
 */

#ifndef OAIRequestAccessToken_request_H
#define OAIRequestAccessToken_request_H
...
class OAIRequestAccessToken_request : public OAIObject {
public:
    OAIRequestAccessToken_request();
    OAIRequestAccessToken_request(QString json);
    ~OAIRequestAccessToken_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestAccessToken_request)

#endif // OAIRequestAccessToken_request_H
