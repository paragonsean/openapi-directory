...
QString OAIError::getServerId() const {
    return m_server_id;
}
void OAIError::setServerId(const QString &server_id) {
    m_server_id = server_id;
    m_server_id_isSet = true;
}

bool OAIError::is_server_id_Set() const{
    return m_server_id_isSet;
}

bool OAIError::is_server_id_Valid() const{
