...
#ifndef OAITimeCardListVO_H
#define OAITimeCardListVO_H
...
namespace OpenAPI {
class OAITimeCardSimpleVO;

class OAITimeCardListVO : public OAIObject {
public:
    OAITimeCardListVO();
    OAITimeCardListVO(QString json);
    ~OAITimeCardListVO() override;
    ...
    QList<OAITimeCardSimpleVO> getResults() const;
    void setResults(const QList<OAITimeCardSimpleVO> &results);
...
private:
    ...
    QList<OAITimeCardSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeCardListVO)

#endif // OAITimeCardListVO_H
