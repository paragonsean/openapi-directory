...
#ifndef OAIFileResponseVO_H
#define OAIFileResponseVO_H
...
class OAIFileResponseVO : public OAIObject {
public:
    OAIFileResponseVO();
    OAIFileResponseVO(QString json);
    ~OAIFileResponseVO() override;
    ...
    OAIFileVO getResult() const;
    void setResult(const OAIFileVO &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileResponseVO)

#endif // OAIFileResponseVO_H
