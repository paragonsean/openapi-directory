...
#ifndef OAITaskListVO_H
#define OAITaskListVO_H
...
namespace OpenAPI {
class OAITaskSimpleVO;

class OAITaskListVO : public OAIObject {
public:
    OAITaskListVO();
    OAITaskListVO(QString json);
    ~OAITaskListVO() override;
    ...
    QList<OAITaskSimpleVO> getResults() const;
    void setResults(const QList<OAITaskSimpleVO> &results);
...
private:
    ...
    QList<OAITaskSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskListVO)

#endif // OAITaskListVO_H
