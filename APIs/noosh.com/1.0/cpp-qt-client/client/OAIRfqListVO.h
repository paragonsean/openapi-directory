...
#ifndef OAIRfqListVO_H
#define OAIRfqListVO_H
...
namespace OpenAPI {
class OAIRfqSimpleVO;

class OAIRfqListVO : public OAIObject {
public:
    OAIRfqListVO();
    OAIRfqListVO(QString json);
    ~OAIRfqListVO() override;
    ...
    QList<OAIRfqSimpleVO> getResult() const;
    void setResult(const QList<OAIRfqSimpleVO> &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRfqListVO)

#endif // OAIRfqListVO_H
