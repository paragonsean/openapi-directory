...
#ifndef OAIRfeListVO_H
#define OAIRfeListVO_H
...
namespace OpenAPI {
class OAIRfeSimpleVO;

class OAIRfeListVO : public OAIObject {
public:
    OAIRfeListVO();
    OAIRfeListVO(QString json);
    ~OAIRfeListVO() override;
    ...
    QList<OAIRfeSimpleVO> getResults() const;
    void setResults(const QList<OAIRfeSimpleVO> &results);
...
private:
    ...
    QList<OAIRfeSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRfeListVO)

#endif // OAIRfeListVO_H
