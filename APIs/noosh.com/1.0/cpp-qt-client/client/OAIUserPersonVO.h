...
#ifndef OAIUserPersonVO_H
#define OAIUserPersonVO_H
...
class OAIUserPersonVO : public OAIObject {
public:
    OAIUserPersonVO();
    OAIUserPersonVO(QString json);
    ~OAIUserPersonVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPersonVO)

#endif // OAIUserPersonVO_H
