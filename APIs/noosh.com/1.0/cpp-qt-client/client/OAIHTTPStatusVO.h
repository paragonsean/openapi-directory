...
#ifndef OAIHTTPStatusVO_H
#define OAIHTTPStatusVO_H
...
class OAIHTTPStatusVO : public OAIObject {
public:
    OAIHTTPStatusVO();
    OAIHTTPStatusVO(QString json);
    ~OAIHTTPStatusVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHTTPStatusVO)

#endif // OAIHTTPStatusVO_H
