...
#include "OAIOrderDetailBaseVO.h"
...
OAIOrderDetailBaseVO::OAIOrderDetailBaseVO(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderDetailBaseVO::OAIOrderDetailBaseVO() {
    this->initializeModel();
}

OAIOrderDetailBaseVO::~OAIOrderDetailBaseVO() {}

void OAIOrderDetailBaseVO::initializeModel() {
...
void OAIOrderDetailBaseVO::fromJson(QString jsonString) {
...
void OAIOrderDetailBaseVO::fromJsonObject(QJsonObject json) {
...
QString OAIOrderDetailBaseVO::asJson() const {
...
QJsonObject OAIOrderDetailBaseVO::asJsonObject() const {
    QJsonObject obj;
...
QDate OAIOrderDetailBaseVO::getAcceptedDate() const {
    return m_accepted_date;
}
void OAIOrderDetailBaseVO::setAcceptedDate(const QDate &accepted_date) {
    m_accepted_date = accepted_date;
    m_accepted_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_accepted_date_Set() const{
    return m_accepted_date_isSet;
}

bool OAIOrderDetailBaseVO::is_accepted_date_Valid() const{
    return m_accepted_date_isValid;
}

QDate OAIOrderDetailBaseVO::getAnnulledDate() const {
    return m_annulled_date;
}
void OAIOrderDetailBaseVO::setAnnulledDate(const QDate &annulled_date) {
    m_annulled_date = annulled_date;
    m_annulled_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_annulled_date_Set() const{
    return m_annulled_date_isSet;
}

bool OAIOrderDetailBaseVO::is_annulled_date_Valid() const{
    return m_annulled_date_isValid;
}

QDate OAIOrderDetailBaseVO::getApprovedDate() const {
    return m_approved_date;
}
void OAIOrderDetailBaseVO::setApprovedDate(const QDate &approved_date) {
    m_approved_date = approved_date;
    m_approved_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_approved_date_Set() const{
    return m_approved_date_isSet;
}

bool OAIOrderDetailBaseVO::is_approved_date_Valid() const{
    return m_approved_date_isValid;
}

QDate OAIOrderDetailBaseVO::getAwardedDate() const {
    return m_awarded_date;
}
void OAIOrderDetailBaseVO::setAwardedDate(const QDate &awarded_date) {
    m_awarded_date = awarded_date;
    m_awarded_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_awarded_date_Set() const{
    return m_awarded_date_isSet;
}

bool OAIOrderDetailBaseVO::is_awarded_date_Valid() const{
    return m_awarded_date_isValid;
}

QString OAIOrderDetailBaseVO::getBudgetType() const {
    return m_budget_type;
}
void OAIOrderDetailBaseVO::setBudgetType(const QString &budget_type) {
    m_budget_type = budget_type;
    m_budget_type_isSet = true;
}

bool OAIOrderDetailBaseVO::is_budget_type_Set() const{
    return m_budget_type_isSet;
}

bool OAIOrderDetailBaseVO::is_budget_type_Valid() const{
    return m_budget_type_isValid;
}

OAIUserVO OAIOrderDetailBaseVO::getBuyer() const {
    return m_buyer;
}
void OAIOrderDetailBaseVO::setBuyer(const OAIUserVO &buyer) {
    m_buyer = buyer;
    m_buyer_isSet = true;
}

bool OAIOrderDetailBaseVO::is_buyer_Set() const{
    return m_buyer_isSet;
}

bool OAIOrderDetailBaseVO::is_buyer_Valid() const{
    return m_buyer_isValid;
}

OAIWorkgroupBaseVO OAIOrderDetailBaseVO::getBuyerWorkgroup() const {
    return m_buyer_workgroup;
}
void OAIOrderDetailBaseVO::setBuyerWorkgroup(const OAIWorkgroupBaseVO &buyer_workgroup) {
    m_buyer_workgroup = buyer_workgroup;
    m_buyer_workgroup_isSet = true;
}

bool OAIOrderDetailBaseVO::is_buyer_workgroup_Set() const{
    return m_buyer_workgroup_isSet;
}

bool OAIOrderDetailBaseVO::is_buyer_workgroup_Valid() const{
    return m_buyer_workgroup_isValid;
}

QString OAIOrderDetailBaseVO::getClassification() const {
    return m_classification;
}
void OAIOrderDetailBaseVO::setClassification(const QString &classification) {
    m_classification = classification;
    m_classification_isSet = true;
}

bool OAIOrderDetailBaseVO::is_classification_Set() const{
    return m_classification_isSet;
}

bool OAIOrderDetailBaseVO::is_classification_Valid() const{
    return m_classification_isValid;
}

QDate OAIOrderDetailBaseVO::getClosedDate() const {
    return m_closed_date;
}
void OAIOrderDetailBaseVO::setClosedDate(const QDate &closed_date) {
    m_closed_date = closed_date;
    m_closed_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_closed_date_Set() const{
    return m_closed_date_isSet;
}

bool OAIOrderDetailBaseVO::is_closed_date_Valid() const{
    return m_closed_date_isValid;
}

QString OAIOrderDetailBaseVO::getComments() const {
    return m_comments;
}
void OAIOrderDetailBaseVO::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIOrderDetailBaseVO::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIOrderDetailBaseVO::is_comments_Valid() const{
    return m_comments_isValid;
}

QDate OAIOrderDetailBaseVO::getCompletionDate() const {
    return m_completion_date;
}
void OAIOrderDetailBaseVO::setCompletionDate(const QDate &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAIOrderDetailBaseVO::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

qint64 OAIOrderDetailBaseVO::getCreatorUserId() const {
    return m_creator_user_id;
}
void OAIOrderDetailBaseVO::setCreatorUserId(const qint64 &creator_user_id) {
    m_creator_user_id = creator_user_id;
    m_creator_user_id_isSet = true;
}

bool OAIOrderDetailBaseVO::is_creator_user_id_Set() const{
    return m_creator_user_id_isSet;
}

bool OAIOrderDetailBaseVO::is_creator_user_id_Valid() const{
    return m_creator_user_id_isValid;
}

QString OAIOrderDetailBaseVO::getCurrency() const {
    return m_currency;
}
void OAIOrderDetailBaseVO::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIOrderDetailBaseVO::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIOrderDetailBaseVO::is_currency_Valid() const{
    return m_currency_isValid;
}

QList<OAIPropertyPaAndAttVO> OAIOrderDetailBaseVO::getCustomFields() const {
    return m_custom_fields;
}
void OAIOrderDetailBaseVO::setCustomFields(const QList<OAIPropertyPaAndAttVO> &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIOrderDetailBaseVO::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIOrderDetailBaseVO::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getGrandTotal() const {
    return m_grand_total;
}
void OAIOrderDetailBaseVO::setGrandTotal(const QJsonValue &grand_total) {
    m_grand_total = grand_total;
    m_grand_total_isSet = true;
}

bool OAIOrderDetailBaseVO::is_grand_total_Set() const{
    return m_grand_total_isSet;
}

bool OAIOrderDetailBaseVO::is_grand_total_Valid() const{
    return m_grand_total_isValid;
}

qint32 OAIOrderDetailBaseVO::getItemCount() const {
    return m_item_count;
}
void OAIOrderDetailBaseVO::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAIOrderDetailBaseVO::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAIOrderDetailBaseVO::is_item_count_Valid() const{
    return m_item_count_isValid;
}

QDate OAIOrderDetailBaseVO::getLastActivityDate() const {
    return m_last_activity_date;
}
void OAIOrderDetailBaseVO::setLastActivityDate(const QDate &last_activity_date) {
    m_last_activity_date = last_activity_date;
    m_last_activity_date_isSet = true;
}

bool OAIOrderDetailBaseVO::is_last_activity_date_Set() const{
    return m_last_activity_date_isSet;
}

bool OAIOrderDetailBaseVO::is_last_activity_date_Valid() const{
    return m_last_activity_date_isValid;
}

QDate OAIOrderDetailBaseVO::getLastChanged() const {
    return m_last_changed;
}
void OAIOrderDetailBaseVO::setLastChanged(const QDate &last_changed) {
    m_last_changed = last_changed;
    m_last_changed_isSet = true;
}

bool OAIOrderDetailBaseVO::is_last_changed_Set() const{
    return m_last_changed_isSet;
}

bool OAIOrderDetailBaseVO::is_last_changed_Valid() const{
    return m_last_changed_isValid;
}

QDate OAIOrderDetailBaseVO::getLastStatusChange() const {
    return m_last_status_change;
}
void OAIOrderDetailBaseVO::setLastStatusChange(const QDate &last_status_change) {
    m_last_status_change = last_status_change;
    m_last_status_change_isSet = true;
}

bool OAIOrderDetailBaseVO::is_last_status_change_Set() const{
    return m_last_status_change_isSet;
}

bool OAIOrderDetailBaseVO::is_last_status_change_Valid() const{
    return m_last_status_change_isValid;
}

double OAIOrderDetailBaseVO::getMiscCost() const {
    return m_misc_cost;
}
void OAIOrderDetailBaseVO::setMiscCost(const double &misc_cost) {
    m_misc_cost = misc_cost;
    m_misc_cost_isSet = true;
}

bool OAIOrderDetailBaseVO::is_misc_cost_Set() const{
    return m_misc_cost_isSet;
}

bool OAIOrderDetailBaseVO::is_misc_cost_Valid() const{
    return m_misc_cost_isValid;
}

qint64 OAIOrderDetailBaseVO::getOrderId() const {
    return m_order_id;
}
void OAIOrderDetailBaseVO::setOrderId(const qint64 &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAIOrderDetailBaseVO::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAIOrderDetailBaseVO::is_order_id_Valid() const{
    return m_order_id_isValid;
}

QString OAIOrderDetailBaseVO::getOrderNumber() const {
    return m_order_number;
}
void OAIOrderDetailBaseVO::setOrderNumber(const QString &order_number) {
    m_order_number = order_number;
    m_order_number_isSet = true;
}

bool OAIOrderDetailBaseVO::is_order_number_Set() const{
    return m_order_number_isSet;
}

bool OAIOrderDetailBaseVO::is_order_number_Valid() const{
    return m_order_number_isValid;
}

QString OAIOrderDetailBaseVO::getOrderTitle() const {
    return m_order_title;
}
void OAIOrderDetailBaseVO::setOrderTitle(const QString &order_title) {
    m_order_title = order_title;
    m_order_title_isSet = true;
}

bool OAIOrderDetailBaseVO::is_order_title_Set() const{
    return m_order_title_isSet;
}

bool OAIOrderDetailBaseVO::is_order_title_Valid() const{
    return m_order_title_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getOrderTotal() const {
    return m_order_total;
}
void OAIOrderDetailBaseVO::setOrderTotal(const QJsonValue &order_total) {
    m_order_total = order_total;
    m_order_total_isSet = true;
}

bool OAIOrderDetailBaseVO::is_order_total_Set() const{
    return m_order_total_isSet;
}

bool OAIOrderDetailBaseVO::is_order_total_Valid() const{
    return m_order_total_isValid;
}

double OAIOrderDetailBaseVO::getOversPercent() const {
    return m_overs_percent;
}
void OAIOrderDetailBaseVO::setOversPercent(const double &overs_percent) {
    m_overs_percent = overs_percent;
    m_overs_percent_isSet = true;
}

bool OAIOrderDetailBaseVO::is_overs_percent_Set() const{
    return m_overs_percent_isSet;
}

bool OAIOrderDetailBaseVO::is_overs_percent_Valid() const{
    return m_overs_percent_isValid;
}

qint64 OAIOrderDetailBaseVO::getParentOrderId() const {
    return m_parent_order_id;
}
void OAIOrderDetailBaseVO::setParentOrderId(const qint64 &parent_order_id) {
    m_parent_order_id = parent_order_id;
    m_parent_order_id_isSet = true;
}

bool OAIOrderDetailBaseVO::is_parent_order_id_Set() const{
    return m_parent_order_id_isSet;
}

bool OAIOrderDetailBaseVO::is_parent_order_id_Valid() const{
    return m_parent_order_id_isValid;
}

QString OAIOrderDetailBaseVO::getPaymentReference() const {
    return m_payment_reference;
}
void OAIOrderDetailBaseVO::setPaymentReference(const QString &payment_reference) {
    m_payment_reference = payment_reference;
    m_payment_reference_isSet = true;
}

bool OAIOrderDetailBaseVO::is_payment_reference_Set() const{
    return m_payment_reference_isSet;
}

bool OAIOrderDetailBaseVO::is_payment_reference_Valid() const{
    return m_payment_reference_isValid;
}

QList<qint64> OAIOrderDetailBaseVO::getPrintOrderIds() const {
    return m_print_order_ids;
}
void OAIOrderDetailBaseVO::setPrintOrderIds(const QList<qint64> &print_order_ids) {
    m_print_order_ids = print_order_ids;
    m_print_order_ids_isSet = true;
}

bool OAIOrderDetailBaseVO::is_print_order_ids_Set() const{
    return m_print_order_ids_isSet;
}

bool OAIOrderDetailBaseVO::is_print_order_ids_Valid() const{
    return m_print_order_ids_isValid;
}

qint64 OAIOrderDetailBaseVO::getQuoteId() const {
    return m_quote_id;
}
void OAIOrderDetailBaseVO::setQuoteId(const qint64 &quote_id) {
    m_quote_id = quote_id;
    m_quote_id_isSet = true;
}

bool OAIOrderDetailBaseVO::is_quote_id_Set() const{
    return m_quote_id_isSet;
}

bool OAIOrderDetailBaseVO::is_quote_id_Valid() const{
    return m_quote_id_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getShipping() const {
    return m_shipping;
}
void OAIOrderDetailBaseVO::setShipping(const QJsonValue &shipping) {
    m_shipping = shipping;
    m_shipping_isSet = true;
}

bool OAIOrderDetailBaseVO::is_shipping_Set() const{
    return m_shipping_isSet;
}

bool OAIOrderDetailBaseVO::is_shipping_Valid() const{
    return m_shipping_isValid;
}

QString OAIOrderDetailBaseVO::getStatus() const {
    return m_status;
}
void OAIOrderDetailBaseVO::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOrderDetailBaseVO::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOrderDetailBaseVO::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIOrderDetailBaseVO::getStatusComments() const {
    return m_status_comments;
}
void OAIOrderDetailBaseVO::setStatusComments(const QString &status_comments) {
    m_status_comments = status_comments;
    m_status_comments_isSet = true;
}

bool OAIOrderDetailBaseVO::is_status_comments_Set() const{
    return m_status_comments_isSet;
}

bool OAIOrderDetailBaseVO::is_status_comments_Valid() const{
    return m_status_comments_isValid;
}

OAIUserVO OAIOrderDetailBaseVO::getSupplier() const {
    return m_supplier;
}
void OAIOrderDetailBaseVO::setSupplier(const OAIUserVO &supplier) {
    m_supplier = supplier;
    m_supplier_isSet = true;
}

bool OAIOrderDetailBaseVO::is_supplier_Set() const{
    return m_supplier_isSet;
}

bool OAIOrderDetailBaseVO::is_supplier_Valid() const{
    return m_supplier_isValid;
}

QString OAIOrderDetailBaseVO::getSupplierReference() const {
    return m_supplier_reference;
}
void OAIOrderDetailBaseVO::setSupplierReference(const QString &supplier_reference) {
    m_supplier_reference = supplier_reference;
    m_supplier_reference_isSet = true;
}

bool OAIOrderDetailBaseVO::is_supplier_reference_Set() const{
    return m_supplier_reference_isSet;
}

bool OAIOrderDetailBaseVO::is_supplier_reference_Valid() const{
    return m_supplier_reference_isValid;
}

QString OAIOrderDetailBaseVO::getSupplierSelectionReason() const {
    return m_supplier_selection_reason;
}
void OAIOrderDetailBaseVO::setSupplierSelectionReason(const QString &supplier_selection_reason) {
    m_supplier_selection_reason = supplier_selection_reason;
    m_supplier_selection_reason_isSet = true;
}

bool OAIOrderDetailBaseVO::is_supplier_selection_reason_Set() const{
    return m_supplier_selection_reason_isSet;
}

bool OAIOrderDetailBaseVO::is_supplier_selection_reason_Valid() const{
    return m_supplier_selection_reason_isValid;
}

OAIWorkgroupBaseVO OAIOrderDetailBaseVO::getSupplierWorkgroup() const {
    return m_supplier_workgroup;
}
void OAIOrderDetailBaseVO::setSupplierWorkgroup(const OAIWorkgroupBaseVO &supplier_workgroup) {
    m_supplier_workgroup = supplier_workgroup;
    m_supplier_workgroup_isSet = true;
}

bool OAIOrderDetailBaseVO::is_supplier_workgroup_Set() const{
    return m_supplier_workgroup_isSet;
}

bool OAIOrderDetailBaseVO::is_supplier_workgroup_Valid() const{
    return m_supplier_workgroup_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getTax() const {
    return m_tax;
}
void OAIOrderDetailBaseVO::setTax(const QJsonValue &tax) {
    m_tax = tax;
    m_tax_isSet = true;
}

bool OAIOrderDetailBaseVO::is_tax_Set() const{
    return m_tax_isSet;
}

bool OAIOrderDetailBaseVO::is_tax_Valid() const{
    return m_tax_isValid;
}

QString OAIOrderDetailBaseVO::getTransactionalCurrency() const {
    return m_transactional_currency;
}
void OAIOrderDetailBaseVO::setTransactionalCurrency(const QString &transactional_currency) {
    m_transactional_currency = transactional_currency;
    m_transactional_currency_isSet = true;
}

bool OAIOrderDetailBaseVO::is_transactional_currency_Set() const{
    return m_transactional_currency_isSet;
}

bool OAIOrderDetailBaseVO::is_transactional_currency_Valid() const{
    return m_transactional_currency_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getTransactionalGrandTotal() const {
    return m_transactional_grand_total;
}
void OAIOrderDetailBaseVO::setTransactionalGrandTotal(const QJsonValue &transactional_grand_total) {
    m_transactional_grand_total = transactional_grand_total;
    m_transactional_grand_total_isSet = true;
}

bool OAIOrderDetailBaseVO::is_transactional_grand_total_Set() const{
    return m_transactional_grand_total_isSet;
}

bool OAIOrderDetailBaseVO::is_transactional_grand_total_Valid() const{
    return m_transactional_grand_total_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getTransactionalOrderTotal() const {
    return m_transactional_order_total;
}
void OAIOrderDetailBaseVO::setTransactionalOrderTotal(const QJsonValue &transactional_order_total) {
    m_transactional_order_total = transactional_order_total;
    m_transactional_order_total_isSet = true;
}

bool OAIOrderDetailBaseVO::is_transactional_order_total_Set() const{
    return m_transactional_order_total_isSet;
}

bool OAIOrderDetailBaseVO::is_transactional_order_total_Valid() const{
    return m_transactional_order_total_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getTransactionalShipping() const {
    return m_transactional_shipping;
}
void OAIOrderDetailBaseVO::setTransactionalShipping(const QJsonValue &transactional_shipping) {
    m_transactional_shipping = transactional_shipping;
    m_transactional_shipping_isSet = true;
}

bool OAIOrderDetailBaseVO::is_transactional_shipping_Set() const{
    return m_transactional_shipping_isSet;
}

bool OAIOrderDetailBaseVO::is_transactional_shipping_Valid() const{
    return m_transactional_shipping_isValid;
}

QJsonValue OAIOrderDetailBaseVO::getTransactionalTax() const {
    return m_transactional_tax;
}
void OAIOrderDetailBaseVO::setTransactionalTax(const QJsonValue &transactional_tax) {
    m_transactional_tax = transactional_tax;
    m_transactional_tax_isSet = true;
}

bool OAIOrderDetailBaseVO::is_transactional_tax_Set() const{
    return m_transactional_tax_isSet;
}

bool OAIOrderDetailBaseVO::is_transactional_tax_Valid() const{
    return m_transactional_tax_isValid;
}

double OAIOrderDetailBaseVO::getUndersPercent() const {
    return m_unders_percent;
}
void OAIOrderDetailBaseVO::setUndersPercent(const double &unders_percent) {
    m_unders_percent = unders_percent;
    m_unders_percent_isSet = true;
}

bool OAIOrderDetailBaseVO::is_unders_percent_Set() const{
    return m_unders_percent_isSet;
}

bool OAIOrderDetailBaseVO::is_unders_percent_Valid() const{
    return m_unders_percent_isValid;
}

bool OAIOrderDetailBaseVO::isSet() const {
...
bool OAIOrderDetailBaseVO::isValid() const {
