...
/*
 * OAIEstimateListExpandVO.h
 *
 * Java type: com.noosh.nooshapi.vo.EstimateListExpandVO
 */

#ifndef OAIEstimateListExpandVO_H
#define OAIEstimateListExpandVO_H
...
namespace OpenAPI {
class OAIEstimateBaseVO;

class OAIEstimateListExpandVO : public OAIObject {
public:
    OAIEstimateListExpandVO();
    OAIEstimateListExpandVO(QString json);
    ~OAIEstimateListExpandVO() override;
    ...
    QList<OAIEstimateBaseVO> getResult() const;
    void setResult(const QList<OAIEstimateBaseVO> &result);
...
private:
    ...
    QList<OAIEstimateBaseVO> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimateListExpandVO)

#endif // OAIEstimateListExpandVO_H
