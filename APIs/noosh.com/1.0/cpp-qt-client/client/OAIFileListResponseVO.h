...
/*
 * OAIFileListResponseVO.h
 *
 * Java type: com.noosh.nooshapi.vo.file.FileListResponseVO
 */

#ifndef OAIFileListResponseVO_H
#define OAIFileListResponseVO_H
...
class OAIFileListResponseVO : public OAIObject {
public:
    OAIFileListResponseVO();
    OAIFileListResponseVO(QString json);
    ~OAIFileListResponseVO() override;
    ...
    QList<OAIFileVO> getResult() const;
    void setResult(const QList<OAIFileVO> &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileListResponseVO)

#endif // OAIFileListResponseVO_H
