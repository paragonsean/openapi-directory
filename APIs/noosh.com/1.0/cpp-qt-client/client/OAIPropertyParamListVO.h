...
/*
 * OAIPropertyParamListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.PropertyParamListVO
 */

#ifndef OAIPropertyParamListVO_H
#define OAIPropertyParamListVO_H
...
namespace OpenAPI {
class OAIPropertyParamSimpleVO;

class OAIPropertyParamListVO : public OAIObject {
public:
    OAIPropertyParamListVO();
    OAIPropertyParamListVO(QString json);
    ~OAIPropertyParamListVO() override;
    ...
    QList<OAIPropertyParamSimpleVO> getResult() const;
    void setResult(const QList<OAIPropertyParamSimpleVO> &result);
...
private:
    ...
    QList<OAIPropertyParamSimpleVO> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPropertyParamListVO)

#endif // OAIPropertyParamListVO_H
