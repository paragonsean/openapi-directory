...
#ifndef OAIOrderListVO_H
#define OAIOrderListVO_H
...
namespace OpenAPI {
class OAIOrderSimpleVO;

class OAIOrderListVO : public OAIObject {
public:
    OAIOrderListVO();
    OAIOrderListVO(QString json);
    ~OAIOrderListVO() override;
    ...
    QList<OAIOrderSimpleVO> getResults() const;
    void setResults(const QList<OAIOrderSimpleVO> &results);
...
private:
    ...
    QList<OAIOrderSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderListVO)

#endif // OAIOrderListVO_H
