...
#ifndef OAIPersonVO_H
#define OAIPersonVO_H
...
class OAIPersonVO : public OAIObject {
public:
    OAIPersonVO();
    OAIPersonVO(QString json);
    ~OAIPersonVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonVO)
