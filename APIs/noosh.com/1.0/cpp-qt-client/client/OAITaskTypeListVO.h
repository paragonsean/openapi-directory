...
#ifndef OAITaskTypeListVO_H
#define OAITaskTypeListVO_H
...
namespace OpenAPI {
class OAITaskTypeSimpleVO;

class OAITaskTypeListVO : public OAIObject {
public:
    OAITaskTypeListVO();
    OAITaskTypeListVO(QString json);
    ~OAITaskTypeListVO() override;
    ...
    QList<OAITaskTypeSimpleVO> getResults() const;
    void setResults(const QList<OAITaskTypeSimpleVO> &results);
...
private:
    ...
    QList<OAITaskTypeSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskTypeListVO)

#endif // OAITaskTypeListVO_H
