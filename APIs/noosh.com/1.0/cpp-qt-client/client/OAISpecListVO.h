...
#ifndef OAISpecListVO_H
#define OAISpecListVO_H
...
class OAISpecListVO : public OAIObject {
public:
    OAISpecListVO();
    OAISpecListVO(QString json);
    ~OAISpecListVO() override;
    ...
    QList<OAISpecSimpleVO> getResults() const;
    void setResults(const QList<OAISpecSimpleVO> &results);
...
private:
    ...
    QList<OAISpecSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecListVO)

#endif // OAISpecListVO_H
