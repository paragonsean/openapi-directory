...
/*
 * OAIProjectStatusListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.ProjectStatusListVO
 */

#ifndef OAIProjectStatusListVO_H
#define OAIProjectStatusListVO_H
...
namespace OpenAPI {
class OAIProjectStatusSimpleVO;

class OAIProjectStatusListVO : public OAIObject {
public:
    OAIProjectStatusListVO();
    OAIProjectStatusListVO(QString json);
    ~OAIProjectStatusListVO() override;
    ...
    QList<OAIProjectStatusSimpleVO> getResults() const;
    void setResults(const QList<OAIProjectStatusSimpleVO> &results);
...
private:
    ...
    QList<OAIProjectStatusSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectStatusListVO)

#endif // OAIProjectStatusListVO_H
