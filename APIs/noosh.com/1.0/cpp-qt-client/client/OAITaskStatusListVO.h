...
/*
 * OAITaskStatusListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.TaskStatusListVO
 */

#ifndef OAITaskStatusListVO_H
#define OAITaskStatusListVO_H
...
namespace OpenAPI {
class OAITaskStatusVO;

class OAITaskStatusListVO : public OAIObject {
public:
    OAITaskStatusListVO();
    OAITaskStatusListVO(QString json);
    ~OAITaskStatusListVO() override;
    ...
    QList<OAITaskStatusVO> getResults() const;
    void setResults(const QList<OAITaskStatusVO> &results);
...
private:
    ...
    QList<OAITaskStatusVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskStatusListVO)

#endif // OAITaskStatusListVO_H
