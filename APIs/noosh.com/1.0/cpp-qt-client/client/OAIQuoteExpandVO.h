...
#ifndef OAIQuoteExpandVO_H
#define OAIQuoteExpandVO_H
...
namespace OpenAPI {
class OAIQuoteDetailVO;

class OAIQuoteExpandVO : public OAIObject {
public:
    OAIQuoteExpandVO();
    OAIQuoteExpandVO(QString json);
    ~OAIQuoteExpandVO() override;
    ...
    OAIQuoteDetailVO getResult() const;
    void setResult(const OAIQuoteDetailVO &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteExpandVO)

#endif // OAIQuoteExpandVO_H
