...
#ifndef OAISpecSimplestVO_H
#define OAISpecSimplestVO_H
...
class OAISpecSimplestVO : public OAIObject {
public:
    OAISpecSimplestVO();
    OAISpecSimplestVO(QString json);
    ~OAISpecSimplestVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecSimplestVO)

#endif // OAISpecSimplestVO_H
