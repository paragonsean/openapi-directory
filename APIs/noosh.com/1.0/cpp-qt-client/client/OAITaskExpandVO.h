...
#ifndef OAITaskExpandVO_H
#define OAITaskExpandVO_H
...
namespace OpenAPI {
class OAITaskDetailVO;

class OAITaskExpandVO : public OAIObject {
public:
    OAITaskExpandVO();
    OAITaskExpandVO(QString json);
    ~OAITaskExpandVO() override;
    ...
    OAITaskDetailVO getResult() const;
    void setResult(const OAITaskDetailVO &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskExpandVO)

#endif // OAITaskExpandVO_H
