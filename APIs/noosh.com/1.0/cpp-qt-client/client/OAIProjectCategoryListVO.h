...
/*
 * OAIProjectCategoryListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.ProjectCategoryListVO
 */

#ifndef OAIProjectCategoryListVO_H
#define OAIProjectCategoryListVO_H
...
namespace OpenAPI {
class OAIProjectCategorySimpleVO;

class OAIProjectCategoryListVO : public OAIObject {
public:
    OAIProjectCategoryListVO();
    OAIProjectCategoryListVO(QString json);
    ~OAIProjectCategoryListVO() override;
    ...
    QList<OAIProjectCategorySimpleVO> getResults() const;
    void setResults(const QList<OAIProjectCategorySimpleVO> &results);
...
private:
    ...
    QList<OAIProjectCategorySimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCategoryListVO)

#endif // OAIProjectCategoryListVO_H
