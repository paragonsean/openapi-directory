...
#ifndef OAIShipmentListVO_H
#define OAIShipmentListVO_H
...
namespace OpenAPI {
class OAIShipmentSimpleVO;

class OAIShipmentListVO : public OAIObject {
public:
    OAIShipmentListVO();
    OAIShipmentListVO(QString json);
    ~OAIShipmentListVO() override;
    ...
    QList<OAIShipmentSimpleVO> getResult() const;
    void setResult(const QList<OAIShipmentSimpleVO> &result);
...
private:
    ...
    QList<OAIShipmentSimpleVO> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShipmentListVO)

#endif // OAIShipmentListVO_H
