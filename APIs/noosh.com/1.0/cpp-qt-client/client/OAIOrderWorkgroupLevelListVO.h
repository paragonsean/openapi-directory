...
/*
 * OAIOrderWorkgroupLevelListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.OrderWorkgroupLevelListVO
 */

#ifndef OAIOrderWorkgroupLevelListVO_H
#define OAIOrderWorkgroupLevelListVO_H
...
namespace OpenAPI {
class OAIOrderWorkgroupLevelSimpleVO;

class OAIOrderWorkgroupLevelListVO : public OAIObject {
public:
    OAIOrderWorkgroupLevelListVO();
    OAIOrderWorkgroupLevelListVO(QString json);
    ~OAIOrderWorkgroupLevelListVO() override;
    ...
    QList<OAIOrderWorkgroupLevelSimpleVO> getResults() const;
    void setResults(const QList<OAIOrderWorkgroupLevelSimpleVO> &results);
...
private:
    ...
    QList<OAIOrderWorkgroupLevelSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderWorkgroupLevelListVO)

#endif // OAIOrderWorkgroupLevelListVO_H
