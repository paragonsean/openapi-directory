...
/*
 * OAIClientWorkgroupExpandVO.h
 *
 * Java type: com.noosh.nooshapi.vo.ClientWorkgroupExpandVO
 */

#ifndef OAIClientWorkgroupExpandVO_H
#define OAIClientWorkgroupExpandVO_H
...
namespace OpenAPI {
class OAIClientWorkgroupDetailVO;

class OAIClientWorkgroupExpandVO : public OAIObject {
public:
    OAIClientWorkgroupExpandVO();
    OAIClientWorkgroupExpandVO(QString json);
    ~OAIClientWorkgroupExpandVO() override;
    ...
    OAIClientWorkgroupDetailVO getResult() const;
    void setResult(const OAIClientWorkgroupDetailVO &result);
...
private:
    ...
    OAIClientWorkgroupDetailVO m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientWorkgroupExpandVO)

#endif // OAIClientWorkgroupExpandVO_H
