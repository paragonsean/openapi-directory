...
/*
 * OAIShipmentDetailVO.h
 *
 * Java type: com.noosh.nooshapi.vo.ShipmentDetailVO
 */

#ifndef OAIShipmentDetailVO_H
#define OAIShipmentDetailVO_H
...
namespace OpenAPI {
class OAIShipmentRequestBaseVO;
class OAISpecBaseVO;

class OAIShipmentDetailVO : public OAIObject {
public:
    OAIShipmentDetailVO();
    OAIShipmentDetailVO(QString json);
    ~OAIShipmentDetailVO() override;
    ...
    QList<OAIShipmentRequestBaseVO> getLocations() const;
    void setLocations(const QList<OAIShipmentRequestBaseVO> &locations);
...
private:
    ...
    QList<OAIShipmentRequestBaseVO> m_locations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShipmentDetailVO)

#endif // OAIShipmentDetailVO_H
