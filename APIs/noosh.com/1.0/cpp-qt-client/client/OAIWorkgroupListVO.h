...
/*
 * OAIWorkgroupListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.WorkgroupListVO
 */

#ifndef OAIWorkgroupListVO_H
#define OAIWorkgroupListVO_H
...
namespace OpenAPI {
class OAIWorkgroupSimpleVO;

class OAIWorkgroupListVO : public OAIObject {
public:
    OAIWorkgroupListVO();
    OAIWorkgroupListVO(QString json);
    ~OAIWorkgroupListVO() override;
    ...
    QList<OAIWorkgroupSimpleVO> getResults() const;
    void setResults(const QList<OAIWorkgroupSimpleVO> &results);
...
private:
    ...
    QList<OAIWorkgroupSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkgroupListVO)

#endif // OAIWorkgroupListVO_H
