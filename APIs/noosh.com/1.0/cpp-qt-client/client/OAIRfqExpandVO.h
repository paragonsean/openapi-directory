...
#ifndef OAIRfqExpandVO_H
#define OAIRfqExpandVO_H
...
namespace OpenAPI {
class OAIRfqDetailsVO;

class OAIRfqExpandVO : public OAIObject {
public:
    OAIRfqExpandVO();
    OAIRfqExpandVO(QString json);
    ~OAIRfqExpandVO() override;
    ...
    OAIRfqDetailsVO getResult() const;
    void setResult(const OAIRfqDetailsVO &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRfqExpandVO)

#endif // OAIRfqExpandVO_H
