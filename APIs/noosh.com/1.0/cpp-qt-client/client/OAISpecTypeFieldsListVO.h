...
/*
 * OAISpecTypeFieldsListVO.h
 *
 * Java type: com.noosh.nooshapi.vo.v1x1.SpecTypeFieldsListVO
 */

#ifndef OAISpecTypeFieldsListVO_H
#define OAISpecTypeFieldsListVO_H
...
class OAISpecTypeFieldsListVO : public OAIObject {
public:
    OAISpecTypeFieldsListVO();
    OAISpecTypeFieldsListVO(QString json);
    ~OAISpecTypeFieldsListVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecTypeFieldsListVO)

#endif // OAISpecTypeFieldsListVO_H
