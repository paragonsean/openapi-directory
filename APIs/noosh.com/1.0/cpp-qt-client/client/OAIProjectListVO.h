...
#ifndef OAIProjectListVO_H
#define OAIProjectListVO_H
...
namespace OpenAPI {
class OAIProjectSimpleVO;

class OAIProjectListVO : public OAIObject {
public:
    OAIProjectListVO();
    OAIProjectListVO(QString json);
    ~OAIProjectListVO() override;
    ...
    QList<OAIProjectSimpleVO> getResults() const;
    void setResults(const QList<OAIProjectSimpleVO> &results);
...
private:
    ...
    QList<OAIProjectSimpleVO> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectListVO)

#endif // OAIProjectListVO_H
