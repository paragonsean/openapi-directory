...
/*
 * OAISpecHTTPStatusVO.h
 *
 * Java type: com.noosh.nooshapi.vo.SpecHTTPStatusVO
 */

#ifndef OAISpecHTTPStatusVO_H
#define OAISpecHTTPStatusVO_H
...
class OAISpecHTTPStatusVO : public OAIObject {
public:
    OAISpecHTTPStatusVO();
    OAISpecHTTPStatusVO(QString json);
    ~OAISpecHTTPStatusVO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpecHTTPStatusVO)

#endif // OAISpecHTTPStatusVO_H
