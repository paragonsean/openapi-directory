...
/*
 * OAIInvoiceDetailVO.h
 *
 * Java type: com.noosh.nooshapi.vo.InvoiceDetailVO
 */

#ifndef OAIInvoiceDetailVO_H
#define OAIInvoiceDetailVO_H
...
class OAIInvoiceItemDetailVO;

class OAIInvoiceDetailVO : public OAIObject {
public:
    OAIInvoiceDetailVO();
    OAIInvoiceDetailVO(QString json);
    ~OAIInvoiceDetailVO() override;
    ...
    QList<OAIInvoiceItemDetailVO> getItems() const;
    void setItems(const QList<OAIInvoiceItemDetailVO> &items);
...
private:
    ...
    QList<OAIInvoiceItemDetailVO> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceDetailVO)

#endif // OAIInvoiceDetailVO_H
