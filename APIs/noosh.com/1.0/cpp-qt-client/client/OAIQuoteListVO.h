...
#ifndef OAIQuoteListVO_H
#define OAIQuoteListVO_H
...
namespace OpenAPI {
class OAIQuoteSimpleVO;

class OAIQuoteListVO : public OAIObject {
public:
    OAIQuoteListVO();
    OAIQuoteListVO(QString json);
    ~OAIQuoteListVO() override;
    ...
    QList<OAIQuoteSimpleVO> getResult() const;
    void setResult(const QList<OAIQuoteSimpleVO> &result);
...
private:
    ...
    QList<OAIQuoteSimpleVO> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteListVO)

#endif // OAIQuoteListVO_H
