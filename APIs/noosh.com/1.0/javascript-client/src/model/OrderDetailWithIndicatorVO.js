...
/**
 * The OrderDetailWithIndicatorVO model module.
 * @module model/OrderDetailWithIndicatorVO
 * @version 1.0
 */
class OrderDetailWithIndicatorVO {
    /**
     * Constructs a new <code>OrderDetailWithIndicatorVO</code>.
     * Java type: com.noosh.nooshapi.vo.OrderDetailWithIndicatorVO
     * @alias module:model/OrderDetailWithIndicatorVO
     */
    constructor() { 
        
        OrderDetailWithIndicatorVO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderDetailWithIndicatorVO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderDetailWithIndicatorVO} obj Optional instance to populate.
     * @return {module:model/OrderDetailWithIndicatorVO} The populated <code>OrderDetailWithIndicatorVO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderDetailWithIndicatorVO();
            ...
            if (data.hasOwnProperty('is_sell_order')) {
                obj['is_sell_order'] = ApiClient.convertToType(data['is_sell_order'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderDetailWithIndicatorVO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderDetailWithIndicatorVO</code>.
     */
 ...
 */
OrderDetailWithIndicatorVO.prototype['accepted_date'] = undefined;

/**
 * 
 * @member {Date} annulled_date
 */
OrderDetailWithIndicatorVO.prototype['annulled_date'] = undefined;

/**
 * 
 * @member {Date} approved_date
 */
OrderDetailWithIndicatorVO.prototype['approved_date'] = undefined;

/**
 * 
 * @member {Date} awarded_date
 */
OrderDetailWithIndicatorVO.prototype['awarded_date'] = undefined;

/**
 * 
 * @member {String} budget_type
 */
OrderDetailWithIndicatorVO.prototype['budget_type'] = undefined;

/**
 * @member {module:model/UserVO} buyer
 */
OrderDetailWithIndicatorVO.prototype['buyer'] = undefined;

/**
 * @member {module:model/WorkgroupBaseVO} buyer_workgroup
 */
OrderDetailWithIndicatorVO.prototype['buyer_workgroup'] = undefined;

/**
 * 
 * @member {Array.<module:model/OrderDetailBaseVO>} change_orders
 */
OrderDetailWithIndicatorVO.prototype['change_orders'] = undefined;

/**
 * 
 * @member {String} classification
 */
OrderDetailWithIndicatorVO.prototype['classification'] = undefined;

/**
 * 
 * @member {Date} closed_date
 */
OrderDetailWithIndicatorVO.prototype['closed_date'] = undefined;

/**
 * 
 * @member {Array.<module:model/OrderDetailBaseVO>} closing_change_orders
 */
OrderDetailWithIndicatorVO.prototype['closing_change_orders'] = undefined;

/**
 * 
 * @member {String} comments
 */
OrderDetailWithIndicatorVO.prototype['comments'] = undefined;

/**
 * 
 * @member {Date} completion_date
 */
OrderDetailWithIndicatorVO.prototype['completion_date'] = undefined;

/**
 * 
 * @member {Number} creator_user_id
 */
OrderDetailWithIndicatorVO.prototype['creator_user_id'] = undefined;

/**
 * 
 * @member {String} currency
 */
OrderDetailWithIndicatorVO.prototype['currency'] = undefined;

/**
 * 
 * @member {Array.<module:model/PropertyPaAndAttVO>} custom_fields
 */
OrderDetailWithIndicatorVO.prototype['custom_fields'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} grand_total
 */
OrderDetailWithIndicatorVO.prototype['grand_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} grand_total_with_changes
 */
OrderDetailWithIndicatorVO.prototype['grand_total_with_changes'] = undefined;

/**
 * 
 * @member {Boolean} is_sell_order
 */
OrderDetailWithIndicatorVO.prototype['is_sell_order'] = undefined;

/**
 * 
 * @member {Number} item_count
 */
OrderDetailWithIndicatorVO.prototype['item_count'] = undefined;

/**
 * 
 * @member {Date} last_activity_date
 */
OrderDetailWithIndicatorVO.prototype['last_activity_date'] = undefined;

/**
 * 
 * @member {Date} last_changed
 */
OrderDetailWithIndicatorVO.prototype['last_changed'] = undefined;

/**
 * 
 * @member {Date} last_status_change
 */
OrderDetailWithIndicatorVO.prototype['last_status_change'] = undefined;

/**
 * 
 * @member {Number} misc_cost
 */
OrderDetailWithIndicatorVO.prototype['misc_cost'] = undefined;

/**
 * 
 * @member {Number} order_id
 */
OrderDetailWithIndicatorVO.prototype['order_id'] = undefined;

/**
 * 
 * @member {Array.<module:model/OrderItemSimpleVO>} order_items
 */
OrderDetailWithIndicatorVO.prototype['order_items'] = undefined;

/**
 * 
 * @member {String} order_number
 */
OrderDetailWithIndicatorVO.prototype['order_number'] = undefined;

/**
 * 
 * @member {String} order_title
 */
OrderDetailWithIndicatorVO.prototype['order_title'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} order_total
 */
OrderDetailWithIndicatorVO.prototype['order_total'] = undefined;

/**
 * 
 * @member {Number} overs_percent
 */
OrderDetailWithIndicatorVO.prototype['overs_percent'] = undefined;

/**
 * 
 * @member {Number} parent_order_id
 */
OrderDetailWithIndicatorVO.prototype['parent_order_id'] = undefined;

/**
 * 
 * @member {String} payment_reference
 */
OrderDetailWithIndicatorVO.prototype['payment_reference'] = undefined;

/**
 * 
 * @member {Array.<Number>} print_order_ids
 */
OrderDetailWithIndicatorVO.prototype['print_order_ids'] = undefined;

/**
 * 
 * @member {Number} quote_id
 */
OrderDetailWithIndicatorVO.prototype['quote_id'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} shipping
 */
OrderDetailWithIndicatorVO.prototype['shipping'] = undefined;

/**
 * 
 * @member {String} status
 */
OrderDetailWithIndicatorVO.prototype['status'] = undefined;

/**
 * 
 * @member {String} status_comments
 */
OrderDetailWithIndicatorVO.prototype['status_comments'] = undefined;

/**
 * @member {module:model/UserVO} supplier
 */
OrderDetailWithIndicatorVO.prototype['supplier'] = undefined;

/**
 * 
 * @member {String} supplier_reference
 */
OrderDetailWithIndicatorVO.prototype['supplier_reference'] = undefined;

/**
 * 
 * @member {String} supplier_selection_reason
 */
OrderDetailWithIndicatorVO.prototype['supplier_selection_reason'] = undefined;

/**
 * @member {module:model/WorkgroupBaseVO} supplier_workgroup
 */
OrderDetailWithIndicatorVO.prototype['supplier_workgroup'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} tax
 */
OrderDetailWithIndicatorVO.prototype['tax'] = undefined;

/**
 * 
 * @member {String} transactional_currency
 */
OrderDetailWithIndicatorVO.prototype['transactional_currency'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_grand_total
 */
OrderDetailWithIndicatorVO.prototype['transactional_grand_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_grand_total_with_changes
 */
OrderDetailWithIndicatorVO.prototype['transactional_grand_total_with_changes'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_order_total
 */
OrderDetailWithIndicatorVO.prototype['transactional_order_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_shipping
 */
OrderDetailWithIndicatorVO.prototype['transactional_shipping'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_tax
 */
OrderDetailWithIndicatorVO.prototype['transactional_tax'] = undefined;

/**
 * 
 * @member {Number} unders_percent
 */
OrderDetailWithIndicatorVO.prototype['unders_percent'] = undefined;
...
export default OrderDetailWithIndicatorVO;
