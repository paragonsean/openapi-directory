...
class ProjectVO {
     ...
     * @alias module:model/ProjectVO
     */
    constructor() { 
        
        ProjectVO.initialize(this);
    }
     ...
     * @param {module:model/ProjectVO} obj Optional instance to populate.
     * @return {module:model/ProjectVO} The populated <code>ProjectVO</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectVO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectVO</code>.
     */
 ...
 */
ProjectVO.prototype['project_id'] = undefined;

/**
 * 
 * @member {Number} status_code
 */
ProjectVO.prototype['status_code'] = undefined;

/**
 * 
 * @member {String} status_reason
 */
ProjectVO.prototype['status_reason'] = undefined;
