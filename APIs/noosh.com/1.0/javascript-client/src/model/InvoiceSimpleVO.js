...
/**
 * The InvoiceSimpleVO model module.
 * @module model/InvoiceSimpleVO
 * @version 1.0
 */
class InvoiceSimpleVO {
    /**
     * Constructs a new <code>InvoiceSimpleVO</code>.
     * Java type: com.noosh.nooshapi.vo.InvoiceSimpleVO
     * @alias module:model/InvoiceSimpleVO
     */
    constructor() { 
        
        InvoiceSimpleVO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvoiceSimpleVO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvoiceSimpleVO} obj Optional instance to populate.
     * @return {module:model/InvoiceSimpleVO} The populated <code>InvoiceSimpleVO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvoiceSimpleVO();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [InvoiceItemSimpleVO]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InvoiceSimpleVO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvoiceSimpleVO</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                InvoiceItemSimpleVO.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
InvoiceSimpleVO.prototype['comments'] = undefined;

/**
 * 
 * @member {String} currency
 */
InvoiceSimpleVO.prototype['currency'] = undefined;

/**
 * 
 * @member {Array.<module:model/PropertyPaAndAttVO>} custom_fields
 */
InvoiceSimpleVO.prototype['custom_fields'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} grand_total
 */
InvoiceSimpleVO.prototype['grand_total'] = undefined;

/**
 * 
 * @member {Date} invoice_date
 */
InvoiceSimpleVO.prototype['invoice_date'] = undefined;

/**
 * 
 * @member {Date} invoice_due_date
 */
InvoiceSimpleVO.prototype['invoice_due_date'] = undefined;

/**
 * 
 * @member {Number} invoice_id
 */
InvoiceSimpleVO.prototype['invoice_id'] = undefined;

/**
 * 
 * @member {String} invoice_number
 */
InvoiceSimpleVO.prototype['invoice_number'] = undefined;

/**
 * 
 * @member {String} invoice_to
 */
InvoiceSimpleVO.prototype['invoice_to'] = undefined;

/**
 * 
 * @member {Number} is_final
 */
InvoiceSimpleVO.prototype['is_final'] = undefined;

/**
 * 
 * @member {Number} is_nonBillable
 */
InvoiceSimpleVO.prototype['is_nonBillable'] = undefined;

/**
 * 
 * @member {Array.<module:model/InvoiceItemSimpleVO>} items
 */
InvoiceSimpleVO.prototype['items'] = undefined;

/**
 * 
 * @member {String} order_reference
 */
InvoiceSimpleVO.prototype['order_reference'] = undefined;

/**
 * 
 * @member {String} order_title
 */
InvoiceSimpleVO.prototype['order_title'] = undefined;

/**
 * 
 * @member {String} payment_method
 */
InvoiceSimpleVO.prototype['payment_method'] = undefined;

/**
 * 
 * @member {String} prepared_by
 */
InvoiceSimpleVO.prototype['prepared_by'] = undefined;

/**
 * 
 * @member {Number} project_number
 */
InvoiceSimpleVO.prototype['project_number'] = undefined;

/**
 * 
 * @member {String} reference_number
 */
InvoiceSimpleVO.prototype['reference_number'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} shipping
 */
InvoiceSimpleVO.prototype['shipping'] = undefined;

/**
 * 
 * @member {String} status
 */
InvoiceSimpleVO.prototype['status'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} sub_total
 */
InvoiceSimpleVO.prototype['sub_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} tax
 */
InvoiceSimpleVO.prototype['tax'] = undefined;

/**
 * 
 * @member {String} transactional_currency
 */
InvoiceSimpleVO.prototype['transactional_currency'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_grand_total
 */
InvoiceSimpleVO.prototype['transactional_grand_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_shipping
 */
InvoiceSimpleVO.prototype['transactional_shipping'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_sub_total
 */
InvoiceSimpleVO.prototype['transactional_sub_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_tax
 */
InvoiceSimpleVO.prototype['transactional_tax'] = undefined;
...
export default InvoiceSimpleVO;
