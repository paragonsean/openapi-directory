...
/**
 * The TimeCardReceivedDetailVO model module.
 * @module model/TimeCardReceivedDetailVO
 * @version 1.0
 */
class TimeCardReceivedDetailVO {
    /**
     * Constructs a new <code>TimeCardReceivedDetailVO</code>.
     * Java type: com.noosh.nooshapi.vo.TimeCardReceivedDetailVO
     * @alias module:model/TimeCardReceivedDetailVO
     */
    constructor() { 
        
        TimeCardReceivedDetailVO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeCardReceivedDetailVO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeCardReceivedDetailVO} obj Optional instance to populate.
     * @return {module:model/TimeCardReceivedDetailVO} The populated <code>TimeCardReceivedDetailVO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeCardReceivedDetailVO();
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = PersonVO.constructFromObject(data['owner']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TimeCardReceivedDetailVO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeCardReceivedDetailVO</code>.
     */
    static validateJSON(data) {
        // validate the optional field `owner`
        if (data['owner']) { // data not null
          PersonVO.validateJSON(data['owner']);
        }
 ...
 */
TimeCardReceivedDetailVO.prototype['billable_hours'] = undefined;

/**
 * 
 * @member {Boolean} is_submit
 */
TimeCardReceivedDetailVO.prototype['is_submit'] = undefined;

/**
 * 
 * @member {Date} last_updated_date
 */
TimeCardReceivedDetailVO.prototype['last_updated_date'] = undefined;

/**
 * 
 * @member {Number} no_of_workdays
 */
TimeCardReceivedDetailVO.prototype['no_of_workdays'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} nonbillable_hours
 */
TimeCardReceivedDetailVO.prototype['nonbillable_hours'] = undefined;

/**
 * @member {module:model/PersonVO} owner
 */
TimeCardReceivedDetailVO.prototype['owner'] = undefined;

/**
 * 
 * @member {Date} submit_date
 */
TimeCardReceivedDetailVO.prototype['submit_date'] = undefined;

/**
 * 
 * @member {Array.<module:model/TimeCardLineVO>} time_card_line
 */
TimeCardReceivedDetailVO.prototype['time_card_line'] = undefined;

/**
 * 
 * @member {Number} timecard_id
 */
TimeCardReceivedDetailVO.prototype['timecard_id'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} total_hours
 */
TimeCardReceivedDetailVO.prototype['total_hours'] = undefined;

/**
 * 
 * @member {Date} week_beginning
 */
TimeCardReceivedDetailVO.prototype['week_beginning'] = undefined;
...
export default TimeCardReceivedDetailVO;
