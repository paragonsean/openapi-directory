...
/**
 * The OrderSimpleVO model module.
 * @module model/OrderSimpleVO
 * @version 1.0
 */
class OrderSimpleVO {
    /**
     * Constructs a new <code>OrderSimpleVO</code>.
     * Java type: com.noosh.nooshapi.vo.OrderSimpleVO
     * @alias module:model/OrderSimpleVO
     */
    constructor() { 
        
        OrderSimpleVO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderSimpleVO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderSimpleVO} obj Optional instance to populate.
     * @return {module:model/OrderSimpleVO} The populated <code>OrderSimpleVO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderSimpleVO();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderSimpleVO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderSimpleVO</code>.
     */
 ...
 */
OrderSimpleVO.prototype['buyer_workgroup'] = undefined;

/**
 * 
 * @member {Array.<module:model/OrderSimpleBaseVO>} change_orders
 */
OrderSimpleVO.prototype['change_orders'] = undefined;

/**
 * 
 * @member {Array.<module:model/OrderSimpleBaseVO>} closing_change_orders
 */
OrderSimpleVO.prototype['closing_change_orders'] = undefined;

/**
 * 
 * @member {String} comments
 */
OrderSimpleVO.prototype['comments'] = undefined;

/**
 * 
 * @member {Date} completion_date
 */
OrderSimpleVO.prototype['completion_date'] = undefined;

/**
 * 
 * @member {String} currency
 */
OrderSimpleVO.prototype['currency'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} grand_total
 */
OrderSimpleVO.prototype['grand_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} grand_total_with_changes
 */
OrderSimpleVO.prototype['grand_total_with_changes'] = undefined;

/**
 * 
 * @member {Date} last_changed
 */
OrderSimpleVO.prototype['last_changed'] = undefined;

/**
 * 
 * @member {Date} last_status_change
 */
OrderSimpleVO.prototype['last_status_change'] = undefined;

/**
 * 
 * @member {Number} order_id
 */
OrderSimpleVO.prototype['order_id'] = undefined;

/**
 * 
 * @member {String} order_number
 */
OrderSimpleVO.prototype['order_number'] = undefined;

/**
 * 
 * @member {String} order_title
 */
OrderSimpleVO.prototype['order_title'] = undefined;

/**
 * 
 * @member {String} payment_reference
 */
OrderSimpleVO.prototype['payment_reference'] = undefined;

/**
 * 
 * @member {Array.<Number>} print_order_ids
 */
OrderSimpleVO.prototype['print_order_ids'] = undefined;

/**
 * 
 * @member {String} status
 */
OrderSimpleVO.prototype['status'] = undefined;

/**
 * 
 * @member {String} status_comments
 */
OrderSimpleVO.prototype['status_comments'] = undefined;

/**
 * 
 * @member {String} supplier_reference
 */
OrderSimpleVO.prototype['supplier_reference'] = undefined;

/**
 * @member {module:model/WorkgroupBaseVO} supplier_workgroup
 */
OrderSimpleVO.prototype['supplier_workgroup'] = undefined;

/**
 * 
 * @member {String} transactional_currency
 */
OrderSimpleVO.prototype['transactional_currency'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_grand_total
 */
OrderSimpleVO.prototype['transactional_grand_total'] = undefined;

/**
 * Java type: java.math.BigDecimal
 * @member {Object} transactional_grand_total_with_changes
 */
OrderSimpleVO.prototype['transactional_grand_total_with_changes'] = undefined;
