...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ProjectVO();
  });
  ...
  describe('ProjectVO', function() {
    it('should create an instance of ProjectVO', function() {
      // uncomment below and update the code to test ProjectVO
      //var instance = new NooshApiApplication.ProjectVO();
      //expect(instance).to.be.a(NooshApiApplication.ProjectVO);
    });
