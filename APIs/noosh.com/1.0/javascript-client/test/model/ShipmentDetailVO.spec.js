...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ShipmentDetailVO();
  });
  ...
  describe('ShipmentDetailVO', function() {
    it('should create an instance of ShipmentDetailVO', function() {
      // uncomment below and update the code to test ShipmentDetailVO
      //var instance = new NooshApiApplication.ShipmentDetailVO();
      //expect(instance).to.be.a(NooshApiApplication.ShipmentDetailVO);
    });
