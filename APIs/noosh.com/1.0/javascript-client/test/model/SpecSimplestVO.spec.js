...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecSimplestVO();
  });
  ...
  describe('SpecSimplestVO', function() {
    it('should create an instance of SpecSimplestVO', function() {
      // uncomment below and update the code to test SpecSimplestVO
      //var instance = new NooshApiApplication.SpecSimplestVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecSimplestVO);
    });
