...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecBaseVO();
  });
  ...
  describe('SpecBaseVO', function() {
    it('should create an instance of SpecBaseVO', function() {
      // uncomment below and update the code to test SpecBaseVO
      //var instance = new NooshApiApplication.SpecBaseVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecBaseVO);
    });
