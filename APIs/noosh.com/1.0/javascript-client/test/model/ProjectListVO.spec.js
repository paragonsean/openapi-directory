...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ProjectListVO();
  });
  ...
  describe('ProjectListVO', function() {
    it('should create an instance of ProjectListVO', function() {
      // uncomment below and update the code to test ProjectListVO
      //var instance = new NooshApiApplication.ProjectListVO();
      //expect(instance).to.be.a(NooshApiApplication.ProjectListVO);
    });
