...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RfeExpandVO();
  });
  ...
  describe('RfeExpandVO', function() {
    it('should create an instance of RfeExpandVO', function() {
      // uncomment below and update the code to test RfeExpandVO
      //var instance = new NooshApiApplication.RfeExpandVO();
      //expect(instance).to.be.a(NooshApiApplication.RfeExpandVO);
    });
