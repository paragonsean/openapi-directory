...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.OrderListVO();
  });
  ...
  describe('OrderListVO', function() {
    it('should create an instance of OrderListVO', function() {
      // uncomment below and update the code to test OrderListVO
      //var instance = new NooshApiApplication.OrderListVO();
      //expect(instance).to.be.a(NooshApiApplication.OrderListVO);
    });
