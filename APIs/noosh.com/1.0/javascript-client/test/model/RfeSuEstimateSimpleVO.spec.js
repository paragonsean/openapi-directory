...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RfeSuEstimateSimpleVO();
  });
  ...
  describe('RfeSuEstimateSimpleVO', function() {
    it('should create an instance of RfeSuEstimateSimpleVO', function() {
      // uncomment below and update the code to test RfeSuEstimateSimpleVO
      //var instance = new NooshApiApplication.RfeSuEstimateSimpleVO();
      //expect(instance).to.be.a(NooshApiApplication.RfeSuEstimateSimpleVO);
    });
