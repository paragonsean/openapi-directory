...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RfqListVO();
  });
  ...
  describe('RfqListVO', function() {
    it('should create an instance of RfqListVO', function() {
      // uncomment below and update the code to test RfqListVO
      //var instance = new NooshApiApplication.RfqListVO();
      //expect(instance).to.be.a(NooshApiApplication.RfqListVO);
    });
