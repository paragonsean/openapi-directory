...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.TaskExpandVO();
  });
  ...
  describe('TaskExpandVO', function() {
    it('should create an instance of TaskExpandVO', function() {
      // uncomment below and update the code to test TaskExpandVO
      //var instance = new NooshApiApplication.TaskExpandVO();
      //expect(instance).to.be.a(NooshApiApplication.TaskExpandVO);
    });
