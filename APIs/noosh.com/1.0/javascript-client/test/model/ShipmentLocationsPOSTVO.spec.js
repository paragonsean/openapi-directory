...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ShipmentLocationsPOSTVO();
  });
  ...
  describe('ShipmentLocationsPOSTVO', function() {
    it('should create an instance of ShipmentLocationsPOSTVO', function() {
      // uncomment below and update the code to test ShipmentLocationsPOSTVO
      //var instance = new NooshApiApplication.ShipmentLocationsPOSTVO();
      //expect(instance).to.be.a(NooshApiApplication.ShipmentLocationsPOSTVO);
    });
