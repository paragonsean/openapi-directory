...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RfqExpandVO();
  });
  ...
  describe('RfqExpandVO', function() {
    it('should create an instance of RfqExpandVO', function() {
      // uncomment below and update the code to test RfqExpandVO
      //var instance = new NooshApiApplication.RfqExpandVO();
      //expect(instance).to.be.a(NooshApiApplication.RfqExpandVO);
    });
