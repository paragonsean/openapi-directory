...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RoleSimpleVO();
  });
  ...
  describe('RoleSimpleVO', function() {
    it('should create an instance of RoleSimpleVO', function() {
      // uncomment below and update the code to test RoleSimpleVO
      //var instance = new NooshApiApplication.RoleSimpleVO();
      //expect(instance).to.be.a(NooshApiApplication.RoleSimpleVO);
    });
