...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ErgoSpecSimpleVO();
  });
  ...
  describe('ErgoSpecSimpleVO', function() {
    it('should create an instance of ErgoSpecSimpleVO', function() {
      // uncomment below and update the code to test ErgoSpecSimpleVO
      //var instance = new NooshApiApplication.ErgoSpecSimpleVO();
      //expect(instance).to.be.a(NooshApiApplication.ErgoSpecSimpleVO);
    });
