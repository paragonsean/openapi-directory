...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.InvoiceDetailVO();
  });
  ...
  describe('InvoiceDetailVO', function() {
    it('should create an instance of InvoiceDetailVO', function() {
      // uncomment below and update the code to test InvoiceDetailVO
      //var instance = new NooshApiApplication.InvoiceDetailVO();
      //expect(instance).to.be.a(NooshApiApplication.InvoiceDetailVO);
    });
