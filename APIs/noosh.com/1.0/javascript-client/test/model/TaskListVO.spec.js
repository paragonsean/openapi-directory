...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.TaskListVO();
  });
  ...
  describe('TaskListVO', function() {
    it('should create an instance of TaskListVO', function() {
      // uncomment below and update the code to test TaskListVO
      //var instance = new NooshApiApplication.TaskListVO();
      //expect(instance).to.be.a(NooshApiApplication.TaskListVO);
    });
