...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RoleListVO();
  });
  ...
  describe('RoleListVO', function() {
    it('should create an instance of RoleListVO', function() {
      // uncomment below and update the code to test RoleListVO
      //var instance = new NooshApiApplication.RoleListVO();
      //expect(instance).to.be.a(NooshApiApplication.RoleListVO);
    });
