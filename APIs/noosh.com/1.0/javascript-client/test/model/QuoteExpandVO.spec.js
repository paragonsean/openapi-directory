...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.QuoteExpandVO();
  });
  ...
  describe('QuoteExpandVO', function() {
    it('should create an instance of QuoteExpandVO', function() {
      // uncomment below and update the code to test QuoteExpandVO
      //var instance = new NooshApiApplication.QuoteExpandVO();
      //expect(instance).to.be.a(NooshApiApplication.QuoteExpandVO);
    });
