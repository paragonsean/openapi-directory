...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.QuoteListVO();
  });
  ...
  describe('QuoteListVO', function() {
    it('should create an instance of QuoteListVO', function() {
      // uncomment below and update the code to test QuoteListVO
      //var instance = new NooshApiApplication.QuoteListVO();
      //expect(instance).to.be.a(NooshApiApplication.QuoteListVO);
    });
