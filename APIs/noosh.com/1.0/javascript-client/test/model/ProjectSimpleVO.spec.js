...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.ProjectSimpleVO();
  });
  ...
  describe('ProjectSimpleVO', function() {
    it('should create an instance of ProjectSimpleVO', function() {
      // uncomment below and update the code to test ProjectSimpleVO
      //var instance = new NooshApiApplication.ProjectSimpleVO();
      //expect(instance).to.be.a(NooshApiApplication.ProjectSimpleVO);
    });
