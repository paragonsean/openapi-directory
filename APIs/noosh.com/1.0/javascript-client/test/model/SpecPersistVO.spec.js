...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecPersistVO();
  });
  ...
  describe('SpecPersistVO', function() {
    it('should create an instance of SpecPersistVO', function() {
      // uncomment below and update the code to test SpecPersistVO
      //var instance = new NooshApiApplication.SpecPersistVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecPersistVO);
    });
