...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.HTTPStatusVO();
  });
  ...
  describe('HTTPStatusVO', function() {
    it('should create an instance of HTTPStatusVO', function() {
      // uncomment below and update the code to test HTTPStatusVO
      //var instance = new NooshApiApplication.HTTPStatusVO();
      //expect(instance).to.be.a(NooshApiApplication.HTTPStatusVO);
    });
