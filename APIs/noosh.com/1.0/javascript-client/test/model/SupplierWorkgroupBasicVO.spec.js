...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SupplierWorkgroupBasicVO();
  });
  ...
  describe('SupplierWorkgroupBasicVO', function() {
    it('should create an instance of SupplierWorkgroupBasicVO', function() {
      // uncomment below and update the code to test SupplierWorkgroupBasicVO
      //var instance = new NooshApiApplication.SupplierWorkgroupBasicVO();
      //expect(instance).to.be.a(NooshApiApplication.SupplierWorkgroupBasicVO);
    });
