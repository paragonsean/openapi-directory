...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.WorkgroupHTTPStatusVO();
  });
  ...
  describe('WorkgroupHTTPStatusVO', function() {
    it('should create an instance of WorkgroupHTTPStatusVO', function() {
      // uncomment below and update the code to test WorkgroupHTTPStatusVO
      //var instance = new NooshApiApplication.WorkgroupHTTPStatusVO();
      //expect(instance).to.be.a(NooshApiApplication.WorkgroupHTTPStatusVO);
    });
