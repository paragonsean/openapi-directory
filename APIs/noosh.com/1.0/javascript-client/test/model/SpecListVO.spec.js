...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecListVO();
  });
  ...
  describe('SpecListVO', function() {
    it('should create an instance of SpecListVO', function() {
      // uncomment below and update the code to test SpecListVO
      //var instance = new NooshApiApplication.SpecListVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecListVO);
    });
