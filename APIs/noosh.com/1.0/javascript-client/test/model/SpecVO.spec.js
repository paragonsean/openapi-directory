...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecVO();
  });
  ...
  describe('SpecVO', function() {
    it('should create an instance of SpecVO', function() {
      // uncomment below and update the code to test SpecVO
      //var instance = new NooshApiApplication.SpecVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecVO);
    });
