...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SupplierWorkgroupDetailVO();
  });
  ...
  describe('SupplierWorkgroupDetailVO', function() {
    it('should create an instance of SupplierWorkgroupDetailVO', function() {
      // uncomment below and update the code to test SupplierWorkgroupDetailVO
      //var instance = new NooshApiApplication.SupplierWorkgroupDetailVO();
      //expect(instance).to.be.a(NooshApiApplication.SupplierWorkgroupDetailVO);
    });

    it('should have the property additionalWorkgroupsContainSameSupplier (base name: "additional_workgroups_contain_same_supplier")', function() {
      // uncomment below and update the code to test the property additionalWorkgroupsContainSameSupplier
      //var instance = new NooshApiApplication.SupplierWorkgroupDetailVO();
