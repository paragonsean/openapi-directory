...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.TaskCreatedVO();
  });
  ...
  describe('TaskCreatedVO', function() {
    it('should create an instance of TaskCreatedVO', function() {
      // uncomment below and update the code to test TaskCreatedVO
      //var instance = new NooshApiApplication.TaskCreatedVO();
      //expect(instance).to.be.a(NooshApiApplication.TaskCreatedVO);
    });
