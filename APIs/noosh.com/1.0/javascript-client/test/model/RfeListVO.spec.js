...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.RfeListVO();
  });
  ...
  describe('RfeListVO', function() {
    it('should create an instance of RfeListVO', function() {
      // uncomment below and update the code to test RfeListVO
      //var instance = new NooshApiApplication.RfeListVO();
      //expect(instance).to.be.a(NooshApiApplication.RfeListVO);
    });
