...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.OrderVO();
  });
  ...
  describe('OrderVO', function() {
    it('should create an instance of OrderVO', function() {
      // uncomment below and update the code to test OrderVO
      //var instance = new NooshApiApplication.OrderVO();
      //expect(instance).to.be.a(NooshApiApplication.OrderVO);
    });
