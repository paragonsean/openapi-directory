...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.SpecHTTPStatusVO();
  });
  ...
  describe('SpecHTTPStatusVO', function() {
    it('should create an instance of SpecHTTPStatusVO', function() {
      // uncomment below and update the code to test SpecHTTPStatusVO
      //var instance = new NooshApiApplication.SpecHTTPStatusVO();
      //expect(instance).to.be.a(NooshApiApplication.SpecHTTPStatusVO);
    });
