...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.CountryListVO();
  });
  ...
  describe('CountryListVO', function() {
    it('should create an instance of CountryListVO', function() {
      // uncomment below and update the code to test CountryListVO
      //var instance = new NooshApiApplication.CountryListVO();
      //expect(instance).to.be.a(NooshApiApplication.CountryListVO);
    });
