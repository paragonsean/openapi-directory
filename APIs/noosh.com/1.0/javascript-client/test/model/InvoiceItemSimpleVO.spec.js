...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NooshApiApplication.InvoiceItemSimpleVO();
  });
  ...
  describe('InvoiceItemSimpleVO', function() {
    it('should create an instance of InvoiceItemSimpleVO', function() {
      // uncomment below and update the code to test InvoiceItemSimpleVO
      //var instance = new NooshApiApplication.InvoiceItemSimpleVO();
      //expect(instance).to.be.a(NooshApiApplication.InvoiceItemSimpleVO);
    });
