...
public class InvoiceDetailVO {
  ...
  private List<InvoiceItemDetailVO> items = new ArrayList<>();
  ...
  public InvoiceDetailVO comments(String comments) {
  ...
  public InvoiceDetailVO currency(String currency) {
  ...
  public InvoiceDetailVO customFields(List<PropertyPaAndAttVO> customFields) {
    this.customFields = customFields;
    return this;
  }

  public InvoiceDetailVO addCustomFieldsItem(PropertyPaAndAttVO customFieldsItem) {
  ...
  public InvoiceDetailVO grandTotal(Object grandTotal) {
  ...
  public InvoiceDetailVO invoiceDate(LocalDate invoiceDate) {
  ...
  public InvoiceDetailVO invoiceDueDate(LocalDate invoiceDueDate) {
  ...
  public InvoiceDetailVO invoiceId(Long invoiceId) {
  ...
  public InvoiceDetailVO invoiceNumber(String invoiceNumber) {
  ...
  public InvoiceDetailVO invoiceTo(String invoiceTo) {
  ...
  public InvoiceDetailVO isFinal(Integer isFinal) {
  ...
  public InvoiceDetailVO isNonBillable(Integer isNonBillable) {
  ...
  public InvoiceDetailVO items(List<InvoiceItemDetailVO> items) {
    this.items = items;
    return this;
  }

  public InvoiceDetailVO addItemsItem(InvoiceItemDetailVO itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<InvoiceItemDetailVO> getItems() {
    return items;
  }

  public void setItems(List<InvoiceItemDetailVO> items) {
    this.items = items;
  }


  public InvoiceDetailVO orderReference(String orderReference) {
  ...
  public InvoiceDetailVO orderTitle(String orderTitle) {
  ...
  public InvoiceDetailVO paymentMethod(String paymentMethod) {
  ...
  public InvoiceDetailVO preparedBy(String preparedBy) {
  ...
  public InvoiceDetailVO projectNumber(Long projectNumber) {
  ...
  public InvoiceDetailVO referenceNumber(String referenceNumber) {
  ...
  public InvoiceDetailVO shipping(Object shipping) {
  ...
  public InvoiceDetailVO status(String status) {
    this.status = status;
    return this;
  }
  ...
  public InvoiceDetailVO subTotal(Object subTotal) {
  ...
  public InvoiceDetailVO tax(Object tax) {
    this.tax = tax;
    return this;
  }
  ...
  public InvoiceDetailVO transactionalCurrency(String transactionalCurrency) {
  ...
  public InvoiceDetailVO transactionalGrandTotal(Object transactionalGrandTotal) {
  ...
  public InvoiceDetailVO transactionalShipping(Object transactionalShipping) {
  ...
  public InvoiceDetailVO transactionalSubTotal(Object transactionalSubTotal) {
  ...
  public InvoiceDetailVO transactionalTax(Object transactionalTax) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceDetailVO invoiceDetailVO = (InvoiceDetailVO) o;
    return Objects.equals(this.comments, invoiceDetailVO.comments) &&
        Objects.equals(this.currency, invoiceDetailVO.currency) &&
        Objects.equals(this.customFields, invoiceDetailVO.customFields) &&
        Objects.equals(this.grandTotal, invoiceDetailVO.grandTotal) &&
        Objects.equals(this.invoiceDate, invoiceDetailVO.invoiceDate) &&
        Objects.equals(this.invoiceDueDate, invoiceDetailVO.invoiceDueDate) &&
        Objects.equals(this.invoiceId, invoiceDetailVO.invoiceId) &&
        Objects.equals(this.invoiceNumber, invoiceDetailVO.invoiceNumber) &&
        Objects.equals(this.invoiceTo, invoiceDetailVO.invoiceTo) &&
        Objects.equals(this.isFinal, invoiceDetailVO.isFinal) &&
        Objects.equals(this.isNonBillable, invoiceDetailVO.isNonBillable) &&
        Objects.equals(this.items, invoiceDetailVO.items) &&
        Objects.equals(this.orderReference, invoiceDetailVO.orderReference) &&
        Objects.equals(this.orderTitle, invoiceDetailVO.orderTitle) &&
        Objects.equals(this.paymentMethod, invoiceDetailVO.paymentMethod) &&
        Objects.equals(this.preparedBy, invoiceDetailVO.preparedBy) &&
        Objects.equals(this.projectNumber, invoiceDetailVO.projectNumber) &&
        Objects.equals(this.referenceNumber, invoiceDetailVO.referenceNumber) &&
        Objects.equals(this.shipping, invoiceDetailVO.shipping) &&
        Objects.equals(this.status, invoiceDetailVO.status) &&
        Objects.equals(this.subTotal, invoiceDetailVO.subTotal) &&
        Objects.equals(this.tax, invoiceDetailVO.tax) &&
        Objects.equals(this.transactionalCurrency, invoiceDetailVO.transactionalCurrency) &&
        Objects.equals(this.transactionalGrandTotal, invoiceDetailVO.transactionalGrandTotal) &&
        Objects.equals(this.transactionalShipping, invoiceDetailVO.transactionalShipping) &&
        Objects.equals(this.transactionalSubTotal, invoiceDetailVO.transactionalSubTotal) &&
        Objects.equals(this.transactionalTax, invoiceDetailVO.transactionalTax);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceDetailVO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceDetailVO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceDetailVO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceDetailVO is not found in the empty JSON string", InvoiceDetailVO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceDetailVO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceDetailVO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            InvoiceItemDetailVO.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceDetailVO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceDetailVO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceDetailVO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceDetailVO.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceDetailVO>() {
           @Override
           public void write(JsonWriter out, InvoiceDetailVO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceDetailVO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceDetailVO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceDetailVO
   * @throws IOException if the JSON string is invalid with respect to InvoiceDetailVO
   */
  public static InvoiceDetailVO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceDetailVO.class);
  }

  /**
   * Convert an instance of InvoiceDetailVO to an JSON string
   *
   * @return JSON string
   */
