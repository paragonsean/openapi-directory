...
public class OrderDetailVO {
  ...
  public OrderDetailVO acceptedDate(LocalDate acceptedDate) {
  ...
  public OrderDetailVO annulledDate(LocalDate annulledDate) {
  ...
  public OrderDetailVO approvedDate(LocalDate approvedDate) {
  ...
  public OrderDetailVO awardedDate(LocalDate awardedDate) {
  ...
  public OrderDetailVO budgetType(String budgetType) {
  ...
  public OrderDetailVO buyer(UserVO buyer) {
    this.buyer = buyer;
    return this;
  }
  ...
  public OrderDetailVO buyerWorkgroup(WorkgroupBaseVO buyerWorkgroup) {
  ...
  public OrderDetailVO changeOrders(List<OrderDetailBaseVO> changeOrders) {
    this.changeOrders = changeOrders;
    return this;
  }

  public OrderDetailVO addChangeOrdersItem(OrderDetailBaseVO changeOrdersItem) {
  ...
  public OrderDetailVO classification(String classification) {
  ...
  public OrderDetailVO closedDate(LocalDate closedDate) {
  ...
  public OrderDetailVO closingChangeOrders(List<OrderDetailBaseVO> closingChangeOrders) {
    this.closingChangeOrders = closingChangeOrders;
    return this;
  }

  public OrderDetailVO addClosingChangeOrdersItem(OrderDetailBaseVO closingChangeOrdersItem) {
  ...
  public OrderDetailVO comments(String comments) {
  ...
  public OrderDetailVO completionDate(LocalDate completionDate) {
  ...
  public OrderDetailVO creatorUserId(Long creatorUserId) {
  ...
  public OrderDetailVO currency(String currency) {
  ...
  public OrderDetailVO customFields(List<PropertyPaAndAttVO> customFields) {
    this.customFields = customFields;
    return this;
  }

  public OrderDetailVO addCustomFieldsItem(PropertyPaAndAttVO customFieldsItem) {
  ...
  public OrderDetailVO grandTotal(Object grandTotal) {
  ...
  public OrderDetailVO grandTotalWithChanges(Object grandTotalWithChanges) {
  ...
  public OrderDetailVO itemCount(Integer itemCount) {
  ...
  public OrderDetailVO lastActivityDate(LocalDate lastActivityDate) {
  ...
  public OrderDetailVO lastChanged(LocalDate lastChanged) {
  ...
  public OrderDetailVO lastStatusChange(LocalDate lastStatusChange) {
  ...
  public OrderDetailVO miscCost(Double miscCost) {
  ...
  public OrderDetailVO orderId(Long orderId) {
  ...
  public OrderDetailVO orderItems(List<OrderItemSimpleVO> orderItems) {
    this.orderItems = orderItems;
    return this;
  }

  public OrderDetailVO addOrderItemsItem(OrderItemSimpleVO orderItemsItem) {
  ...
  public OrderDetailVO orderNumber(String orderNumber) {
  ...
  public OrderDetailVO orderTitle(String orderTitle) {
  ...
  public OrderDetailVO orderTotal(Object orderTotal) {
  ...
  public OrderDetailVO oversPercent(Double oversPercent) {
  ...
  public OrderDetailVO parentOrderId(Long parentOrderId) {
  ...
  public OrderDetailVO paymentReference(String paymentReference) {
  ...
  public OrderDetailVO printOrderIds(List<Long> printOrderIds) {
    this.printOrderIds = printOrderIds;
    return this;
  }

  public OrderDetailVO addPrintOrderIdsItem(Long printOrderIdsItem) {
  ...
  public OrderDetailVO quoteId(Long quoteId) {
  ...
  public OrderDetailVO shipping(Object shipping) {
  ...
  public OrderDetailVO status(String status) {
    this.status = status;
    return this;
  }
  ...
  public OrderDetailVO statusComments(String statusComments) {
  ...
  public OrderDetailVO supplier(UserVO supplier) {
  ...
  public OrderDetailVO supplierReference(String supplierReference) {
  ...
  public OrderDetailVO supplierSelectionReason(String supplierSelectionReason) {
  ...
  public OrderDetailVO supplierWorkgroup(WorkgroupBaseVO supplierWorkgroup) {
  ...
  public OrderDetailVO tax(Object tax) {
    this.tax = tax;
    return this;
  }
  ...
  public OrderDetailVO transactionalCurrency(String transactionalCurrency) {
  ...
  public OrderDetailVO transactionalGrandTotal(Object transactionalGrandTotal) {
  ...
  public OrderDetailVO transactionalGrandTotalWithChanges(Object transactionalGrandTotalWithChanges) {
  ...
  public OrderDetailVO transactionalOrderTotal(Object transactionalOrderTotal) {
  ...
  public OrderDetailVO transactionalShipping(Object transactionalShipping) {
  ...
  public OrderDetailVO transactionalTax(Object transactionalTax) {
  ...
  public OrderDetailVO undersPercent(Double undersPercent) {
  ...
  public boolean equals(Object o) {
    ...
    OrderDetailVO orderDetailVO = (OrderDetailVO) o;
    return Objects.equals(this.acceptedDate, orderDetailVO.acceptedDate) &&
        Objects.equals(this.annulledDate, orderDetailVO.annulledDate) &&
        Objects.equals(this.approvedDate, orderDetailVO.approvedDate) &&
        Objects.equals(this.awardedDate, orderDetailVO.awardedDate) &&
        Objects.equals(this.budgetType, orderDetailVO.budgetType) &&
        Objects.equals(this.buyer, orderDetailVO.buyer) &&
        Objects.equals(this.buyerWorkgroup, orderDetailVO.buyerWorkgroup) &&
        Objects.equals(this.changeOrders, orderDetailVO.changeOrders) &&
        Objects.equals(this.classification, orderDetailVO.classification) &&
        Objects.equals(this.closedDate, orderDetailVO.closedDate) &&
        Objects.equals(this.closingChangeOrders, orderDetailVO.closingChangeOrders) &&
        Objects.equals(this.comments, orderDetailVO.comments) &&
        Objects.equals(this.completionDate, orderDetailVO.completionDate) &&
        Objects.equals(this.creatorUserId, orderDetailVO.creatorUserId) &&
        Objects.equals(this.currency, orderDetailVO.currency) &&
        Objects.equals(this.customFields, orderDetailVO.customFields) &&
        Objects.equals(this.grandTotal, orderDetailVO.grandTotal) &&
        Objects.equals(this.grandTotalWithChanges, orderDetailVO.grandTotalWithChanges) &&
        Objects.equals(this.itemCount, orderDetailVO.itemCount) &&
        Objects.equals(this.lastActivityDate, orderDetailVO.lastActivityDate) &&
        Objects.equals(this.lastChanged, orderDetailVO.lastChanged) &&
        Objects.equals(this.lastStatusChange, orderDetailVO.lastStatusChange) &&
        Objects.equals(this.miscCost, orderDetailVO.miscCost) &&
        Objects.equals(this.orderId, orderDetailVO.orderId) &&
        Objects.equals(this.orderItems, orderDetailVO.orderItems) &&
        Objects.equals(this.orderNumber, orderDetailVO.orderNumber) &&
        Objects.equals(this.orderTitle, orderDetailVO.orderTitle) &&
        Objects.equals(this.orderTotal, orderDetailVO.orderTotal) &&
        Objects.equals(this.oversPercent, orderDetailVO.oversPercent) &&
        Objects.equals(this.parentOrderId, orderDetailVO.parentOrderId) &&
        Objects.equals(this.paymentReference, orderDetailVO.paymentReference) &&
        Objects.equals(this.printOrderIds, orderDetailVO.printOrderIds) &&
        Objects.equals(this.quoteId, orderDetailVO.quoteId) &&
        Objects.equals(this.shipping, orderDetailVO.shipping) &&
        Objects.equals(this.status, orderDetailVO.status) &&
        Objects.equals(this.statusComments, orderDetailVO.statusComments) &&
        Objects.equals(this.supplier, orderDetailVO.supplier) &&
        Objects.equals(this.supplierReference, orderDetailVO.supplierReference) &&
        Objects.equals(this.supplierSelectionReason, orderDetailVO.supplierSelectionReason) &&
        Objects.equals(this.supplierWorkgroup, orderDetailVO.supplierWorkgroup) &&
        Objects.equals(this.tax, orderDetailVO.tax) &&
        Objects.equals(this.transactionalCurrency, orderDetailVO.transactionalCurrency) &&
        Objects.equals(this.transactionalGrandTotal, orderDetailVO.transactionalGrandTotal) &&
        Objects.equals(this.transactionalGrandTotalWithChanges, orderDetailVO.transactionalGrandTotalWithChanges) &&
        Objects.equals(this.transactionalOrderTotal, orderDetailVO.transactionalOrderTotal) &&
        Objects.equals(this.transactionalShipping, orderDetailVO.transactionalShipping) &&
        Objects.equals(this.transactionalTax, orderDetailVO.transactionalTax) &&
        Objects.equals(this.undersPercent, orderDetailVO.undersPercent);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderDetailVO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailVO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderDetailVO is not found in the empty JSON string", OrderDetailVO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailVO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderDetailVO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderDetailVO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderDetailVO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderDetailVO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderDetailVO.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderDetailVO>() {
           @Override
           public void write(JsonWriter out, OrderDetailVO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderDetailVO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderDetailVO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderDetailVO
   * @throws IOException if the JSON string is invalid with respect to OrderDetailVO
   */
  public static OrderDetailVO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderDetailVO.class);
  }

  /**
   * Convert an instance of OrderDetailVO to an JSON string
   *
   * @return JSON string
   */
