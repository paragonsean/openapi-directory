...
public class OrderWorkgroupLevelSimpleVO {
  ...
  public OrderWorkgroupLevelSimpleVO buyerWorkgroup(WorkgroupBaseVO buyerWorkgroup) {
  ...
  public OrderWorkgroupLevelSimpleVO changeOrders(List<OrderSimpleBaseVO> changeOrders) {
    this.changeOrders = changeOrders;
    return this;
  }

  public OrderWorkgroupLevelSimpleVO addChangeOrdersItem(OrderSimpleBaseVO changeOrdersItem) {
  ...
  public OrderWorkgroupLevelSimpleVO closingChangeOrders(List<OrderSimpleBaseVO> closingChangeOrders) {
    this.closingChangeOrders = closingChangeOrders;
    return this;
  }

  public OrderWorkgroupLevelSimpleVO addClosingChangeOrdersItem(OrderSimpleBaseVO closingChangeOrdersItem) {
  ...
  public OrderWorkgroupLevelSimpleVO comments(String comments) {
  ...
  public OrderWorkgroupLevelSimpleVO completionDate(LocalDate completionDate) {
  ...
  public OrderWorkgroupLevelSimpleVO currency(String currency) {
  ...
  public OrderWorkgroupLevelSimpleVO grandTotal(Object grandTotal) {
  ...
  public OrderWorkgroupLevelSimpleVO grandTotalWithChanges(Object grandTotalWithChanges) {
  ...
  public OrderWorkgroupLevelSimpleVO lastChanged(LocalDate lastChanged) {
  ...
  public OrderWorkgroupLevelSimpleVO lastStatusChange(LocalDate lastStatusChange) {
  ...
  public OrderWorkgroupLevelSimpleVO orderId(Long orderId) {
  ...
  public OrderWorkgroupLevelSimpleVO orderNumber(String orderNumber) {
  ...
  public OrderWorkgroupLevelSimpleVO orderTitle(String orderTitle) {
  ...
  public OrderWorkgroupLevelSimpleVO paymentReference(String paymentReference) {
  ...
  public OrderWorkgroupLevelSimpleVO printOrderIds(List<Long> printOrderIds) {
    this.printOrderIds = printOrderIds;
    return this;
  }

  public OrderWorkgroupLevelSimpleVO addPrintOrderIdsItem(Long printOrderIdsItem) {
  ...
  public OrderWorkgroupLevelSimpleVO project(ProjectBaseVO project) {
  ...
  public OrderWorkgroupLevelSimpleVO status(String status) {
    this.status = status;
    return this;
  }
  ...
  public OrderWorkgroupLevelSimpleVO statusComments(String statusComments) {
  ...
  public OrderWorkgroupLevelSimpleVO supplierReference(String supplierReference) {
  ...
  public OrderWorkgroupLevelSimpleVO supplierWorkgroup(WorkgroupBaseVO supplierWorkgroup) {
  ...
  public OrderWorkgroupLevelSimpleVO transactionalCurrency(String transactionalCurrency) {
  ...
  public OrderWorkgroupLevelSimpleVO transactionalGrandTotal(Object transactionalGrandTotal) {
  ...
  public OrderWorkgroupLevelSimpleVO transactionalGrandTotalWithChanges(Object transactionalGrandTotalWithChanges) {
  ...
  public boolean equals(Object o) {
    ...
    OrderWorkgroupLevelSimpleVO orderWorkgroupLevelSimpleVO = (OrderWorkgroupLevelSimpleVO) o;
    return Objects.equals(this.buyerWorkgroup, orderWorkgroupLevelSimpleVO.buyerWorkgroup) &&
        Objects.equals(this.changeOrders, orderWorkgroupLevelSimpleVO.changeOrders) &&
        Objects.equals(this.closingChangeOrders, orderWorkgroupLevelSimpleVO.closingChangeOrders) &&
        Objects.equals(this.comments, orderWorkgroupLevelSimpleVO.comments) &&
        Objects.equals(this.completionDate, orderWorkgroupLevelSimpleVO.completionDate) &&
        Objects.equals(this.currency, orderWorkgroupLevelSimpleVO.currency) &&
        Objects.equals(this.grandTotal, orderWorkgroupLevelSimpleVO.grandTotal) &&
        Objects.equals(this.grandTotalWithChanges, orderWorkgroupLevelSimpleVO.grandTotalWithChanges) &&
        Objects.equals(this.lastChanged, orderWorkgroupLevelSimpleVO.lastChanged) &&
        Objects.equals(this.lastStatusChange, orderWorkgroupLevelSimpleVO.lastStatusChange) &&
        Objects.equals(this.orderId, orderWorkgroupLevelSimpleVO.orderId) &&
        Objects.equals(this.orderNumber, orderWorkgroupLevelSimpleVO.orderNumber) &&
        Objects.equals(this.orderTitle, orderWorkgroupLevelSimpleVO.orderTitle) &&
        Objects.equals(this.paymentReference, orderWorkgroupLevelSimpleVO.paymentReference) &&
        Objects.equals(this.printOrderIds, orderWorkgroupLevelSimpleVO.printOrderIds) &&
        Objects.equals(this.project, orderWorkgroupLevelSimpleVO.project) &&
        Objects.equals(this.status, orderWorkgroupLevelSimpleVO.status) &&
        Objects.equals(this.statusComments, orderWorkgroupLevelSimpleVO.statusComments) &&
        Objects.equals(this.supplierReference, orderWorkgroupLevelSimpleVO.supplierReference) &&
        Objects.equals(this.supplierWorkgroup, orderWorkgroupLevelSimpleVO.supplierWorkgroup) &&
        Objects.equals(this.transactionalCurrency, orderWorkgroupLevelSimpleVO.transactionalCurrency) &&
        Objects.equals(this.transactionalGrandTotal, orderWorkgroupLevelSimpleVO.transactionalGrandTotal) &&
        Objects.equals(this.transactionalGrandTotalWithChanges, orderWorkgroupLevelSimpleVO.transactionalGrandTotalWithChanges);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderWorkgroupLevelSimpleVO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderWorkgroupLevelSimpleVO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderWorkgroupLevelSimpleVO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderWorkgroupLevelSimpleVO is not found in the empty JSON string", OrderWorkgroupLevelSimpleVO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderWorkgroupLevelSimpleVO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderWorkgroupLevelSimpleVO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderWorkgroupLevelSimpleVO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderWorkgroupLevelSimpleVO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderWorkgroupLevelSimpleVO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderWorkgroupLevelSimpleVO.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderWorkgroupLevelSimpleVO>() {
           @Override
           public void write(JsonWriter out, OrderWorkgroupLevelSimpleVO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderWorkgroupLevelSimpleVO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderWorkgroupLevelSimpleVO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderWorkgroupLevelSimpleVO
   * @throws IOException if the JSON string is invalid with respect to OrderWorkgroupLevelSimpleVO
   */
  public static OrderWorkgroupLevelSimpleVO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderWorkgroupLevelSimpleVO.class);
  }

  /**
   * Convert an instance of OrderWorkgroupLevelSimpleVO to an JSON string
   *
   * @return JSON string
   */
