...
public class OrderDetailWorkgroupLevelVO {
  ...
  public OrderDetailWorkgroupLevelVO acceptedDate(LocalDate acceptedDate) {
  ...
  public OrderDetailWorkgroupLevelVO annulledDate(LocalDate annulledDate) {
  ...
  public OrderDetailWorkgroupLevelVO approvedDate(LocalDate approvedDate) {
  ...
  public OrderDetailWorkgroupLevelVO awardedDate(LocalDate awardedDate) {
  ...
  public OrderDetailWorkgroupLevelVO budgetType(String budgetType) {
  ...
  public OrderDetailWorkgroupLevelVO buyer(UserVO buyer) {
    this.buyer = buyer;
    return this;
  }
  ...
  public OrderDetailWorkgroupLevelVO buyerWorkgroup(WorkgroupBaseVO buyerWorkgroup) {
  ...
  public OrderDetailWorkgroupLevelVO changeOrders(List<OrderDetailBaseVO> changeOrders) {
    this.changeOrders = changeOrders;
    return this;
  }

  public OrderDetailWorkgroupLevelVO addChangeOrdersItem(OrderDetailBaseVO changeOrdersItem) {
  ...
  public OrderDetailWorkgroupLevelVO classification(String classification) {
  ...
  public OrderDetailWorkgroupLevelVO closedDate(LocalDate closedDate) {
  ...
  public OrderDetailWorkgroupLevelVO closingChangeOrders(List<OrderDetailBaseVO> closingChangeOrders) {
    this.closingChangeOrders = closingChangeOrders;
    return this;
  }

  public OrderDetailWorkgroupLevelVO addClosingChangeOrdersItem(OrderDetailBaseVO closingChangeOrdersItem) {
  ...
  public OrderDetailWorkgroupLevelVO comments(String comments) {
  ...
  public OrderDetailWorkgroupLevelVO completionDate(LocalDate completionDate) {
  ...
  public OrderDetailWorkgroupLevelVO creatorUserId(Long creatorUserId) {
  ...
  public OrderDetailWorkgroupLevelVO currency(String currency) {
  ...
  public OrderDetailWorkgroupLevelVO customFields(List<PropertyPaAndAttVO> customFields) {
    this.customFields = customFields;
    return this;
  }

  public OrderDetailWorkgroupLevelVO addCustomFieldsItem(PropertyPaAndAttVO customFieldsItem) {
  ...
  public OrderDetailWorkgroupLevelVO grandTotal(Object grandTotal) {
  ...
  public OrderDetailWorkgroupLevelVO grandTotalWithChanges(Object grandTotalWithChanges) {
  ...
  public OrderDetailWorkgroupLevelVO itemCount(Integer itemCount) {
  ...
  public OrderDetailWorkgroupLevelVO lastActivityDate(LocalDate lastActivityDate) {
  ...
  public OrderDetailWorkgroupLevelVO lastChanged(LocalDate lastChanged) {
  ...
  public OrderDetailWorkgroupLevelVO lastStatusChange(LocalDate lastStatusChange) {
  ...
  public OrderDetailWorkgroupLevelVO miscCost(Double miscCost) {
  ...
  public OrderDetailWorkgroupLevelVO orderId(Long orderId) {
  ...
  public OrderDetailWorkgroupLevelVO orderItems(List<OrderItemSimpleVO> orderItems) {
    this.orderItems = orderItems;
    return this;
  }

  public OrderDetailWorkgroupLevelVO addOrderItemsItem(OrderItemSimpleVO orderItemsItem) {
  ...
  public OrderDetailWorkgroupLevelVO orderNumber(String orderNumber) {
  ...
  public OrderDetailWorkgroupLevelVO orderTitle(String orderTitle) {
  ...
  public OrderDetailWorkgroupLevelVO orderTotal(Object orderTotal) {
  ...
  public OrderDetailWorkgroupLevelVO oversPercent(Double oversPercent) {
  ...
  public OrderDetailWorkgroupLevelVO parentOrderId(Long parentOrderId) {
  ...
  public OrderDetailWorkgroupLevelVO paymentReference(String paymentReference) {
  ...
  public OrderDetailWorkgroupLevelVO printOrderIds(List<Long> printOrderIds) {
    this.printOrderIds = printOrderIds;
    return this;
  }

  public OrderDetailWorkgroupLevelVO addPrintOrderIdsItem(Long printOrderIdsItem) {
  ...
  public OrderDetailWorkgroupLevelVO project(ProjectBaseVO project) {
  ...
  public OrderDetailWorkgroupLevelVO quoteId(Long quoteId) {
  ...
  public OrderDetailWorkgroupLevelVO shipping(Object shipping) {
  ...
  public OrderDetailWorkgroupLevelVO status(String status) {
    this.status = status;
    return this;
  }
  ...
  public OrderDetailWorkgroupLevelVO statusComments(String statusComments) {
  ...
  public OrderDetailWorkgroupLevelVO supplier(UserVO supplier) {
  ...
  public OrderDetailWorkgroupLevelVO supplierReference(String supplierReference) {
  ...
  public OrderDetailWorkgroupLevelVO supplierSelectionReason(String supplierSelectionReason) {
  ...
  public OrderDetailWorkgroupLevelVO supplierWorkgroup(WorkgroupBaseVO supplierWorkgroup) {
  ...
  public OrderDetailWorkgroupLevelVO tax(Object tax) {
    this.tax = tax;
    return this;
  }
  ...
  public OrderDetailWorkgroupLevelVO transactionalCurrency(String transactionalCurrency) {
  ...
  public OrderDetailWorkgroupLevelVO transactionalGrandTotal(Object transactionalGrandTotal) {
  ...
  public OrderDetailWorkgroupLevelVO transactionalGrandTotalWithChanges(Object transactionalGrandTotalWithChanges) {
  ...
  public OrderDetailWorkgroupLevelVO transactionalOrderTotal(Object transactionalOrderTotal) {
  ...
  public OrderDetailWorkgroupLevelVO transactionalShipping(Object transactionalShipping) {
  ...
  public OrderDetailWorkgroupLevelVO transactionalTax(Object transactionalTax) {
  ...
  public OrderDetailWorkgroupLevelVO undersPercent(Double undersPercent) {
  ...
  public boolean equals(Object o) {
    ...
    OrderDetailWorkgroupLevelVO orderDetailWorkgroupLevelVO = (OrderDetailWorkgroupLevelVO) o;
    return Objects.equals(this.acceptedDate, orderDetailWorkgroupLevelVO.acceptedDate) &&
        Objects.equals(this.annulledDate, orderDetailWorkgroupLevelVO.annulledDate) &&
        Objects.equals(this.approvedDate, orderDetailWorkgroupLevelVO.approvedDate) &&
        Objects.equals(this.awardedDate, orderDetailWorkgroupLevelVO.awardedDate) &&
        Objects.equals(this.budgetType, orderDetailWorkgroupLevelVO.budgetType) &&
        Objects.equals(this.buyer, orderDetailWorkgroupLevelVO.buyer) &&
        Objects.equals(this.buyerWorkgroup, orderDetailWorkgroupLevelVO.buyerWorkgroup) &&
        Objects.equals(this.changeOrders, orderDetailWorkgroupLevelVO.changeOrders) &&
        Objects.equals(this.classification, orderDetailWorkgroupLevelVO.classification) &&
        Objects.equals(this.closedDate, orderDetailWorkgroupLevelVO.closedDate) &&
        Objects.equals(this.closingChangeOrders, orderDetailWorkgroupLevelVO.closingChangeOrders) &&
        Objects.equals(this.comments, orderDetailWorkgroupLevelVO.comments) &&
        Objects.equals(this.completionDate, orderDetailWorkgroupLevelVO.completionDate) &&
        Objects.equals(this.creatorUserId, orderDetailWorkgroupLevelVO.creatorUserId) &&
        Objects.equals(this.currency, orderDetailWorkgroupLevelVO.currency) &&
        Objects.equals(this.customFields, orderDetailWorkgroupLevelVO.customFields) &&
        Objects.equals(this.grandTotal, orderDetailWorkgroupLevelVO.grandTotal) &&
        Objects.equals(this.grandTotalWithChanges, orderDetailWorkgroupLevelVO.grandTotalWithChanges) &&
        Objects.equals(this.itemCount, orderDetailWorkgroupLevelVO.itemCount) &&
        Objects.equals(this.lastActivityDate, orderDetailWorkgroupLevelVO.lastActivityDate) &&
        Objects.equals(this.lastChanged, orderDetailWorkgroupLevelVO.lastChanged) &&
        Objects.equals(this.lastStatusChange, orderDetailWorkgroupLevelVO.lastStatusChange) &&
        Objects.equals(this.miscCost, orderDetailWorkgroupLevelVO.miscCost) &&
        Objects.equals(this.orderId, orderDetailWorkgroupLevelVO.orderId) &&
        Objects.equals(this.orderItems, orderDetailWorkgroupLevelVO.orderItems) &&
        Objects.equals(this.orderNumber, orderDetailWorkgroupLevelVO.orderNumber) &&
        Objects.equals(this.orderTitle, orderDetailWorkgroupLevelVO.orderTitle) &&
        Objects.equals(this.orderTotal, orderDetailWorkgroupLevelVO.orderTotal) &&
        Objects.equals(this.oversPercent, orderDetailWorkgroupLevelVO.oversPercent) &&
        Objects.equals(this.parentOrderId, orderDetailWorkgroupLevelVO.parentOrderId) &&
        Objects.equals(this.paymentReference, orderDetailWorkgroupLevelVO.paymentReference) &&
        Objects.equals(this.printOrderIds, orderDetailWorkgroupLevelVO.printOrderIds) &&
        Objects.equals(this.project, orderDetailWorkgroupLevelVO.project) &&
        Objects.equals(this.quoteId, orderDetailWorkgroupLevelVO.quoteId) &&
        Objects.equals(this.shipping, orderDetailWorkgroupLevelVO.shipping) &&
        Objects.equals(this.status, orderDetailWorkgroupLevelVO.status) &&
        Objects.equals(this.statusComments, orderDetailWorkgroupLevelVO.statusComments) &&
        Objects.equals(this.supplier, orderDetailWorkgroupLevelVO.supplier) &&
        Objects.equals(this.supplierReference, orderDetailWorkgroupLevelVO.supplierReference) &&
        Objects.equals(this.supplierSelectionReason, orderDetailWorkgroupLevelVO.supplierSelectionReason) &&
        Objects.equals(this.supplierWorkgroup, orderDetailWorkgroupLevelVO.supplierWorkgroup) &&
        Objects.equals(this.tax, orderDetailWorkgroupLevelVO.tax) &&
        Objects.equals(this.transactionalCurrency, orderDetailWorkgroupLevelVO.transactionalCurrency) &&
        Objects.equals(this.transactionalGrandTotal, orderDetailWorkgroupLevelVO.transactionalGrandTotal) &&
        Objects.equals(this.transactionalGrandTotalWithChanges, orderDetailWorkgroupLevelVO.transactionalGrandTotalWithChanges) &&
        Objects.equals(this.transactionalOrderTotal, orderDetailWorkgroupLevelVO.transactionalOrderTotal) &&
        Objects.equals(this.transactionalShipping, orderDetailWorkgroupLevelVO.transactionalShipping) &&
        Objects.equals(this.transactionalTax, orderDetailWorkgroupLevelVO.transactionalTax) &&
        Objects.equals(this.undersPercent, orderDetailWorkgroupLevelVO.undersPercent);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderDetailWorkgroupLevelVO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderDetailWorkgroupLevelVO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailWorkgroupLevelVO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderDetailWorkgroupLevelVO is not found in the empty JSON string", OrderDetailWorkgroupLevelVO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailWorkgroupLevelVO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderDetailWorkgroupLevelVO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderDetailWorkgroupLevelVO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderDetailWorkgroupLevelVO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderDetailWorkgroupLevelVO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderDetailWorkgroupLevelVO.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderDetailWorkgroupLevelVO>() {
           @Override
           public void write(JsonWriter out, OrderDetailWorkgroupLevelVO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderDetailWorkgroupLevelVO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderDetailWorkgroupLevelVO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderDetailWorkgroupLevelVO
   * @throws IOException if the JSON string is invalid with respect to OrderDetailWorkgroupLevelVO
   */
  public static OrderDetailWorkgroupLevelVO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderDetailWorkgroupLevelVO.class);
  }

  /**
   * Convert an instance of OrderDetailWorkgroupLevelVO to an JSON string
   *
   * @return JSON string
   */
