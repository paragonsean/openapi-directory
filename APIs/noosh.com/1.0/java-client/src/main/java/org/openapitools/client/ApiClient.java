...
public class ApiClient {
    ...
    private String basePath = "http://example.com:80/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("HTTP_BASIC", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://example.com:80/v1
