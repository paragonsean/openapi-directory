...
async def open_banking_v22_branches_get(request: web.Request, ) -> web.Response:
...
async def x_open_banking_v22_branches_country_country_get(request: web.Request, country) -> web.Response:
...
async def x_open_banking_v22_branches_country_country_town_town_get(request: web.Request, country, town) -> web.Response:
...
async def x_open_banking_v22_branches_geo_location_lat_latitude_long_longitude_get(request: web.Request, latitude, longitude, radius) -> web.Response:
...
async def x_open_banking_v22_branches_postcode_postcode_get(request: web.Request, postcode) -> web.Response:
...
async def x_open_banking_v22_branches_sortcode_sortcode_get(request: web.Request, sortcode) -> web.Response:
    ...
    :param sortcode: 6 digit number with no spaces or special characters. eg. &amp;quot;400003&amp;quot;
    :type sortcode: str
