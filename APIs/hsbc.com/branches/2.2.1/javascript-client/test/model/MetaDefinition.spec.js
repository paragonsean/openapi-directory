...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BranchLocatorApi.MetaDefinition();
  });
  ...
  describe('MetaDefinition', function() {
    it('should create an instance of MetaDefinition', function() {
      // uncomment below and update the code to test MetaDefinition
      //var instance = new BranchLocatorApi.MetaDefinition();
      //expect(instance).to.be.a(BranchLocatorApi.MetaDefinition);
    });
