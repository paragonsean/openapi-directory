...
async def open_banking_v22_unsecured_sme_loans_get(request: web.Request, ) -> web.Response:
...
async def x_open_banking_v22_unsecured_sme_loans_segment_segment_get(request: web.Request, segment) -> web.Response:
    ...
    :param segment: Segment name from this list&amp;#58; &amp;quot;AgricultureSector&amp;quot;, &amp;quot;Business&amp;quot;, &amp;quot;FixedGroup&amp;quot;, &amp;quot;FlexibleBusinessLoan&amp;quot;, &amp;quot;GovernmentScheme&amp;quot;, &amp;quot;Other&amp;quot;, &amp;quot;SectorSpecific&amp;quot;.
    :type segment: str
