...
/*
 * OAISMELoanMarketingState_inner.h
 *
 * The marketing state (promotional or regular) of the SME Loan Product.
 */

#ifndef OAISMELoanMarketingState_inner_H
#define OAISMELoanMarketingState_inner_H
...
namespace OpenAPI {
class OAIRepayment_inner;

class OAISMELoanMarketingState_inner : public OAIObject {
public:
    OAISMELoanMarketingState_inner();
    OAISMELoanMarketingState_inner(QString json);
    ~OAISMELoanMarketingState_inner() override;
    ...
    OAIObject getLoanInterest() const;
    void setLoanInterest(const OAIObject &loan_interest);
    bool is_loan_interest_Set() const;
    bool is_loan_interest_Valid() const;
    ...
    QList<OAIRepayment_inner> getRepayment() const;
    void setRepayment(const QList<OAIRepayment_inner> &repayment);
...
private:
    ...
    OAIObject m_loan_interest;
    bool m_loan_interest_isSet;
    bool m_loan_interest_isValid;
    ...
    QList<OAIRepayment_inner> m_repayment;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMELoanMarketingState_inner)

#endif // OAISMELoanMarketingState_inner_H
