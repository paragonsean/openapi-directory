...
void OAIBrand_inner::fromJsonObject(QJsonObject json) {
    ...
    m_bca_isValid = ::OpenAPI::fromJsonValue(m_bca, json[QString("BCA")]);
    m_bca_isSet = !json[QString("BCA")].isNull() && m_bca_isValid;
...
QJsonObject OAIBrand_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_bca.size() > 0) {
        obj.insert(QString("BCA"), ::OpenAPI::toJsonValue(m_bca));
    }
...
QList<OAIBCA_inner> OAIBrand_inner::getBca() const {
    return m_bca;
}
void OAIBrand_inner::setBca(const QList<OAIBCA_inner> &bca) {
    m_bca = bca;
    m_bca_isSet = true;
}

bool OAIBrand_inner::is_bca_Set() const{
    return m_bca_isSet;
}

bool OAIBrand_inner::is_bca_Valid() const{
    return m_bca_isValid;
}
...
bool OAIBrand_inner::isValid() const {
    ...
    return m_bca_isValid && m_brand_name_isValid && true;
}
