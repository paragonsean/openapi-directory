...
/*
 * OAIBCAMarketingState_inner.h
 *
 * The marketing state (promotional or regular) of the BCA Product.
 */

#ifndef OAIBCAMarketingState_inner_H
#define OAIBCAMarketingState_inner_H
...
namespace OpenAPI {
class OAIOtherFeesCharges_inner;

class OAIBCAMarketingState_inner : public OAIObject {
public:
    OAIBCAMarketingState_inner();
    OAIBCAMarketingState_inner(QString json);
    ~OAIBCAMarketingState_inner() override;
    ...
    QList<OAIOtherFeesCharges_inner> getOtherFeesCharges() const;
    void setOtherFeesCharges(const QList<OAIOtherFeesCharges_inner> &other_fees_charges);
...
private:
    ...
    QList<OAIOtherFeesCharges_inner> m_other_fees_charges;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBCAMarketingState_inner)

#endif // OAIBCAMarketingState_inner_H
