...
OAICCCMarketingState_inner::OAICCCMarketingState_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICCCMarketingState_inner::OAICCCMarketingState_inner() {
    this->initializeModel();
}

OAICCCMarketingState_inner::~OAICCCMarketingState_inner() {}

void OAICCCMarketingState_inner::initializeModel() {
...
void OAICCCMarketingState_inner::fromJson(QString jsonString) {
...
void OAICCCMarketingState_inner::fromJsonObject(QJsonObject json) {
...
QString OAICCCMarketingState_inner::asJson() const {
...
QJsonObject OAICCCMarketingState_inner::asJsonObject() const {
    QJsonObject obj;
...
OAIObject OAICCCMarketingState_inner::getCoreProduct() const {
    return m_core_product;
}
void OAICCCMarketingState_inner::setCoreProduct(const OAIObject &core_product) {
    m_core_product = core_product;
    m_core_product_isSet = true;
}

bool OAICCCMarketingState_inner::is_core_product_Set() const{
    return m_core_product_isSet;
}

bool OAICCCMarketingState_inner::is_core_product_Valid() const{
    return m_core_product_isValid;
}

OAIObject OAICCCMarketingState_inner::getEligibility() const {
    return m_eligibility;
}
void OAICCCMarketingState_inner::setEligibility(const OAIObject &eligibility) {
    m_eligibility = eligibility;
    m_eligibility_isSet = true;
}

bool OAICCCMarketingState_inner::is_eligibility_Set() const{
    return m_eligibility_isSet;
}

bool OAICCCMarketingState_inner::is_eligibility_Valid() const{
    return m_eligibility_isValid;
}

OAIObject OAICCCMarketingState_inner::getFeaturesAndBenefits() const {
    return m_features_and_benefits;
}
void OAICCCMarketingState_inner::setFeaturesAndBenefits(const OAIObject &features_and_benefits) {
    m_features_and_benefits = features_and_benefits;
    m_features_and_benefits_isSet = true;
}

bool OAICCCMarketingState_inner::is_features_and_benefits_Set() const{
    return m_features_and_benefits_isSet;
}

bool OAICCCMarketingState_inner::is_features_and_benefits_Valid() const{
    return m_features_and_benefits_isValid;
}

QDate OAICCCMarketingState_inner::getFirstMarketedDate() const {
    return m_first_marketed_date;
}
void OAICCCMarketingState_inner::setFirstMarketedDate(const QDate &first_marketed_date) {
    m_first_marketed_date = first_marketed_date;
    m_first_marketed_date_isSet = true;
}

bool OAICCCMarketingState_inner::is_first_marketed_date_Set() const{
    return m_first_marketed_date_isSet;
}

bool OAICCCMarketingState_inner::is_first_marketed_date_Valid() const{
    return m_first_marketed_date_isValid;
}

QString OAICCCMarketingState_inner::getIdentification() const {
    return m_identification;
}
void OAICCCMarketingState_inner::setIdentification(const QString &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAICCCMarketingState_inner::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAICCCMarketingState_inner::is_identification_Valid() const{
    return m_identification_isValid;
}

QDate OAICCCMarketingState_inner::getLastMarketedDate() const {
    return m_last_marketed_date;
}
void OAICCCMarketingState_inner::setLastMarketedDate(const QDate &last_marketed_date) {
    m_last_marketed_date = last_marketed_date;
    m_last_marketed_date_isSet = true;
}

bool OAICCCMarketingState_inner::is_last_marketed_date_Set() const{
    return m_last_marketed_date_isSet;
}

bool OAICCCMarketingState_inner::is_last_marketed_date_Valid() const{
    return m_last_marketed_date_isValid;
}

QString OAICCCMarketingState_inner::getMarketingState() const {
    return m_marketing_state;
}
void OAICCCMarketingState_inner::setMarketingState(const QString &marketing_state) {
    m_marketing_state = marketing_state;
    m_marketing_state_isSet = true;
}

bool OAICCCMarketingState_inner::is_marketing_state_Set() const{
    return m_marketing_state_isSet;
}

bool OAICCCMarketingState_inner::is_marketing_state_Valid() const{
    return m_marketing_state_isValid;
}

QList<QString> OAICCCMarketingState_inner::getNotes() const {
    return m_notes;
}
void OAICCCMarketingState_inner::setNotes(const QList<QString> &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAICCCMarketingState_inner::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAICCCMarketingState_inner::is_notes_Valid() const{
    return m_notes_isValid;
}

OAIObject OAICCCMarketingState_inner::getOtherFeesCharges() const {
    return m_other_fees_charges;
}
void OAICCCMarketingState_inner::setOtherFeesCharges(const OAIObject &other_fees_charges) {
    m_other_fees_charges = other_fees_charges;
    m_other_fees_charges_isSet = true;
}

bool OAICCCMarketingState_inner::is_other_fees_charges_Set() const{
    return m_other_fees_charges_isSet;
}

bool OAICCCMarketingState_inner::is_other_fees_charges_Valid() const{
    return m_other_fees_charges_isValid;
}

QString OAICCCMarketingState_inner::getPredecessorId() const {
    return m_predecessor_id;
}
void OAICCCMarketingState_inner::setPredecessorId(const QString &predecessor_id) {
    m_predecessor_id = predecessor_id;
    m_predecessor_id_isSet = true;
}

bool OAICCCMarketingState_inner::is_predecessor_id_Set() const{
    return m_predecessor_id_isSet;
}

bool OAICCCMarketingState_inner::is_predecessor_id_Valid() const{
    return m_predecessor_id_isValid;
}

OAIObject OAICCCMarketingState_inner::getRepayment() const {
    return m_repayment;
}
void OAICCCMarketingState_inner::setRepayment(const OAIObject &repayment) {
    m_repayment = repayment;
    m_repayment_isSet = true;
}

bool OAICCCMarketingState_inner::is_repayment_Set() const{
    return m_repayment_isSet;
}

bool OAICCCMarketingState_inner::is_repayment_Valid() const{
    return m_repayment_isValid;
}

float OAICCCMarketingState_inner::getStateTenureLength() const {
    return m_state_tenure_length;
}
void OAICCCMarketingState_inner::setStateTenureLength(const float &state_tenure_length) {
    m_state_tenure_length = state_tenure_length;
    m_state_tenure_length_isSet = true;
}

bool OAICCCMarketingState_inner::is_state_tenure_length_Set() const{
    return m_state_tenure_length_isSet;
}

bool OAICCCMarketingState_inner::is_state_tenure_length_Valid() const{
    return m_state_tenure_length_isValid;
}

QString OAICCCMarketingState_inner::getStateTenurePeriod() const {
    return m_state_tenure_period;
}
void OAICCCMarketingState_inner::setStateTenurePeriod(const QString &state_tenure_period) {
    m_state_tenure_period = state_tenure_period;
    m_state_tenure_period_isSet = true;
}

bool OAICCCMarketingState_inner::is_state_tenure_period_Set() const{
    return m_state_tenure_period_isSet;
}

bool OAICCCMarketingState_inner::is_state_tenure_period_Valid() const{
    return m_state_tenure_period_isValid;
}

bool OAICCCMarketingState_inner::isSet() const {
...
bool OAICCCMarketingState_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_core_product_isValid && m_eligibility_isValid && m_features_and_benefits_isValid && m_identification_isValid && m_marketing_state_isValid && m_other_fees_charges_isValid && true;
}
