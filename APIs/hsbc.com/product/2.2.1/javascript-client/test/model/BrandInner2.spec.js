...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductFinderApi.BrandInner2();
  });
  ...
  describe('BrandInner2', function() {
    it('should create an instance of BrandInner2', function() {
      // uncomment below and update the code to test BrandInner2
      //var instance = new ProductFinderApi.BrandInner2();
      //expect(instance).to.be.a(ProductFinderApi.BrandInner2);
    });
