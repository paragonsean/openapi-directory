...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductFinderApi.CCCMarketingStateInner();
  });
  ...
  describe('CCCMarketingStateInner', function() {
    it('should create an instance of CCCMarketingStateInner', function() {
      // uncomment below and update the code to test CCCMarketingStateInner
      //var instance = new ProductFinderApi.CCCMarketingStateInner();
      //expect(instance).to.be.a(ProductFinderApi.CCCMarketingStateInner);
    });
