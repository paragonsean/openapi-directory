...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductFinderApi.FeeChargeCapInner();
  });
  ...
  describe('FeeChargeCapInner', function() {
    it('should create an instance of FeeChargeCapInner', function() {
      // uncomment below and update the code to test FeeChargeCapInner
      //var instance = new ProductFinderApi.FeeChargeCapInner();
      //expect(instance).to.be.a(ProductFinderApi.FeeChargeCapInner);
    });
