...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductFinderApi.PCAMarketingStateInner();
  });
  ...
  describe('PCAMarketingStateInner', function() {
    it('should create an instance of PCAMarketingStateInner', function() {
      // uncomment below and update the code to test PCAMarketingStateInner
      //var instance = new ProductFinderApi.PCAMarketingStateInner();
      //expect(instance).to.be.a(ProductFinderApi.PCAMarketingStateInner);
    });
