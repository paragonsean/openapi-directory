...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductFinderApi.SMELoanMarketingStateInner();
  });
  ...
  describe('SMELoanMarketingStateInner', function() {
    it('should create an instance of SMELoanMarketingStateInner', function() {
      // uncomment below and update the code to test SMELoanMarketingStateInner
      //var instance = new ProductFinderApi.SMELoanMarketingStateInner();
      //expect(instance).to.be.a(ProductFinderApi.SMELoanMarketingStateInner);
    });
    ...
    it('should have the property loanInterest (base name: "LoanInterest")', function() {
      // uncomment below and update the code to test the property loanInterest
      //var instance = new ProductFinderApi.SMELoanMarketingStateInner();
      //expect(instance).to.be();
    });
