...
import EditorsItemsInner from './EditorsItemsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [EditorsItemsInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                EditorsItemsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/EditorsItemsInner>} items
 */
Editors.prototype['items'] = undefined;
