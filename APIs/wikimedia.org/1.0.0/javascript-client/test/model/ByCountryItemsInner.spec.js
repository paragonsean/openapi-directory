...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Wikimedia.ByCountryItemsInner();
  });
  ...
  describe('ByCountryItemsInner', function() {
    it('should create an instance of ByCountryItemsInner', function() {
      // uncomment below and update the code to test ByCountryItemsInner
      //var instance = new Wikimedia.ByCountryItemsInner();
      //expect(instance).to.be.a(Wikimedia.ByCountryItemsInner);
    });
