...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Wikimedia.PageviewArticleItemsInner();
  });
  ...
  describe('PageviewArticleItemsInner', function() {
    it('should create an instance of PageviewArticleItemsInner', function() {
      // uncomment below and update the code to test PageviewArticleItemsInner
      //var instance = new Wikimedia.PageviewArticleItemsInner();
      //expect(instance).to.be.a(Wikimedia.PageviewArticleItemsInner);
    });
