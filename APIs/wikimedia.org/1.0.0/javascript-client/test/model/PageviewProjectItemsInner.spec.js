...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Wikimedia.PageviewProjectItemsInner();
  });
  ...
  describe('PageviewProjectItemsInner', function() {
    it('should create an instance of PageviewProjectItemsInner', function() {
      // uncomment below and update the code to test PageviewProjectItemsInner
      //var instance = new Wikimedia.PageviewProjectItemsInner();
      //expect(instance).to.be.a(Wikimedia.PageviewProjectItemsInner);
    });
