...
QString OAIThumbnail::getSource() const {
    return m_source;
}
void OAIThumbnail::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIThumbnail::is_source_Set() const{
    return m_source_isSet;
}

bool OAIThumbnail::is_source_Valid() const{
