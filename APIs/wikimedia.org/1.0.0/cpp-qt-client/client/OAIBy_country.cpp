...
QList<OAIBy_country_items_inner> OAIBy_country::getItems() const {
    return m_items;
}
void OAIBy_country::setItems(const QList<OAIBy_country_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIBy_country::is_items_Set() const{
    return m_items_isSet;
}

bool OAIBy_country::is_items_Valid() const{
