...
QList<QString> OAIListing::getItems() const {
    return m_items;
}
void OAIListing::setItems(const QList<QString> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListing::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListing::is_items_Valid() const{
