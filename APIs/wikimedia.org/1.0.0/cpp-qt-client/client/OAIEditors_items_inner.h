...
/*
 * OAIEditors_items_inner.h
 *
 * 
 */

#ifndef OAIEditors_items_inner_H
#define OAIEditors_items_inner_H

#include <QJsonObject>

#include "OAIEditors_items_inner_results_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIEditors_items_inner_results_inner;

class OAIEditors_items_inner : public OAIObject {
public:
    OAIEditors_items_inner();
    OAIEditors_items_inner(QString json);
    ~OAIEditors_items_inner() override;
    ...
    QList<OAIEditors_items_inner_results_inner> getResults() const;
    void setResults(const QList<OAIEditors_items_inner_results_inner> &results);
...
private:
    ...
    QList<OAIEditors_items_inner_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditors_items_inner)

#endif // OAIEditors_items_inner_H
