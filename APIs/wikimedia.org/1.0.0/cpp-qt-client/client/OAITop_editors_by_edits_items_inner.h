...
/*
 * OAITop_editors_by_edits_items_inner.h
 *
 * 
 */

#ifndef OAITop_editors_by_edits_items_inner_H
#define OAITop_editors_by_edits_items_inner_H
...
namespace OpenAPI {
class OAITop_editors_by_edits_items_inner_results_inner;

class OAITop_editors_by_edits_items_inner : public OAIObject {
public:
    OAITop_editors_by_edits_items_inner();
    OAITop_editors_by_edits_items_inner(QString json);
    ~OAITop_editors_by_edits_items_inner() override;
    ...
    QList<OAITop_editors_by_edits_items_inner_results_inner> getResults() const;
    void setResults(const QList<OAITop_editors_by_edits_items_inner_results_inner> &results);
...
private:
    ...
    QList<OAITop_editors_by_edits_items_inner_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITop_editors_by_edits_items_inner)

#endif // OAITop_editors_by_edits_items_inner_H
