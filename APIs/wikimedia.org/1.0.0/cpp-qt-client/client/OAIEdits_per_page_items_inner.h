...
/*
 * OAIEdits_per_page_items_inner.h
 *
 * 
 */

#ifndef OAIEdits_per_page_items_inner_H
#define OAIEdits_per_page_items_inner_H
...
class OAIEdits_per_page_items_inner : public OAIObject {
public:
    OAIEdits_per_page_items_inner();
    OAIEdits_per_page_items_inner(QString json);
    ~OAIEdits_per_page_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdits_per_page_items_inner)

#endif // OAIEdits_per_page_items_inner_H
