...
/*
 * OAIEdited_pages_items_inner.h
 *
 * 
 */

#ifndef OAIEdited_pages_items_inner_H
#define OAIEdited_pages_items_inner_H
...
namespace OpenAPI {
class OAIEdited_pages_items_inner_results_inner;

class OAIEdited_pages_items_inner : public OAIObject {
public:
    OAIEdited_pages_items_inner();
    OAIEdited_pages_items_inner(QString json);
    ~OAIEdited_pages_items_inner() override;
    ...
    QList<OAIEdited_pages_items_inner_results_inner> getResults() const;
    void setResults(const QList<OAIEdited_pages_items_inner_results_inner> &results);
...
private:
    ...
    QList<OAIEdited_pages_items_inner_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdited_pages_items_inner)

#endif // OAIEdited_pages_items_inner_H
