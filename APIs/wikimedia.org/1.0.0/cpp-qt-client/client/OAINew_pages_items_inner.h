...
/*
 * OAINew_pages_items_inner.h
 *
 * 
 */

#ifndef OAINew_pages_items_inner_H
#define OAINew_pages_items_inner_H
...
namespace OpenAPI {
class OAINew_pages_items_inner_results_inner;

class OAINew_pages_items_inner : public OAIObject {
public:
    OAINew_pages_items_inner();
    OAINew_pages_items_inner(QString json);
    ~OAINew_pages_items_inner() override;
    ...
    QList<OAINew_pages_items_inner_results_inner> getResults() const;
    void setResults(const QList<OAINew_pages_items_inner_results_inner> &results);
...
private:
    ...
    QList<OAINew_pages_items_inner_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAINew_pages_items_inner)

#endif // OAINew_pages_items_inner_H
