...
/*
 * OAIEdits_items_inner.h
 *
 * 
 */

#ifndef OAIEdits_items_inner_H
#define OAIEdits_items_inner_H
...
namespace OpenAPI {
class OAIEdits_items_inner_results_inner;

class OAIEdits_items_inner : public OAIObject {
public:
    OAIEdits_items_inner();
    OAIEdits_items_inner(QString json);
    ~OAIEdits_items_inner() override;
    ...
    QList<OAIEdits_items_inner_results_inner> getResults() const;
    void setResults(const QList<OAIEdits_items_inner_results_inner> &results);
...
private:
    ...
    QList<OAIEdits_items_inner_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdits_items_inner)

#endif // OAIEdits_items_inner_H
