...
QList<OAIEditors_items_inner> OAIEditors::getItems() const {
    return m_items;
}
void OAIEditors::setItems(const QList<OAIEditors_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIEditors::is_items_Set() const{
    return m_items_isSet;
}

bool OAIEditors::is_items_Valid() const{
