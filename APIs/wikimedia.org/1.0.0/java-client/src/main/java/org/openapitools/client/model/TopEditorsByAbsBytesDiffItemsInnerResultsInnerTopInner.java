...
public class TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(absBytesDiff, rank, userText);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
