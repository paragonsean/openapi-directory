...
import org.openapitools.client.model.NewPagesItemsInnerResultsInner;
...
public class NewPagesItemsInner {
  ...
  private List<NewPagesItemsInnerResultsInner> results = new ArrayList<>();
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewPagesItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewPagesItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewPagesItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewPagesItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            NewPagesItemsInnerResultsInner.validateJsonElement(jsonArrayresults.get(i));
          };
        }
      }
  }
