...
public class FeedContentAvailabilityApiTest {
    ...
    private final FeedContentAvailabilityApi api = new FeedContentAvailabilityApi();
     ...
     */
    @Test
    public void feedAvailabilityGetTest() throws ApiException {
        Availability response = api.feedAvailabilityGet();
