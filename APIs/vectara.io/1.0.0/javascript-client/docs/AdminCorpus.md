# VectaraRestApi.AdminCorpus

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**customDimensions** | [**[AdminDimension]**](AdminDimension.md) |  | [optional] 
...
**filterAttributes** | [**[AdminFilterAttribute]**](AdminFilterAttribute.md) |  | [optional] 
**id** | **Number** | The Corpus ID. | [optional] 
**metadataMaxBytes** | **Number** | An optional maximum size of the metadata that each document can contain. | [optional] 
