...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VectaraRestApi.QueryServiceApi();
  });
  ...
  describe('QueryServiceApi', function() {
    ...
    describe('streamQuery', function() {
      it('should call streamQuery successfully', function(done) {
        //uncomment below and update the code to test streamQuery
        //instance.streamQuery(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
