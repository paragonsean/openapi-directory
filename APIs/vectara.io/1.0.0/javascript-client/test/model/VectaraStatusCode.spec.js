...
(function(root, factory) {
  ...
  describe('VectaraStatusCode', function() {
    it('should create an instance of VectaraStatusCode', function() {
      // uncomment below and update the code to test VectaraStatusCode
      //var instance = new VectaraRestApi.VectaraStatusCode();
      //expect(instance).to.be.a(VectaraRestApi.VectaraStatusCode);
    });
