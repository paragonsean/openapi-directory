...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VectaraRestApi.ComvectaraStatus();
  });
  ...
  describe('ComvectaraStatus', function() {
    it('should create an instance of ComvectaraStatus', function() {
      // uncomment below and update the code to test ComvectaraStatus
      //var instance = new VectaraRestApi.ComvectaraStatus();
      //expect(instance).to.be.a(VectaraRestApi.ComvectaraStatus);
    });
