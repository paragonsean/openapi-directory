...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VectaraRestApi.AdminFilterAttribute();
  });
  ...
  describe('AdminFilterAttribute', function() {
    it('should create an instance of AdminFilterAttribute', function() {
      // uncomment below and update the code to test AdminFilterAttribute
      //var instance = new VectaraRestApi.AdminFilterAttribute();
      //expect(instance).to.be.a(VectaraRestApi.AdminFilterAttribute);
    });
