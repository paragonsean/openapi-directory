...
class GifImagesFixedWidth(Model):
    ...
    def __init__(self, frames: str=None, height: str=None, mp4: str=None, mp4_size: str=None, size: str=None, url: str=None, webp: str=None, webp_size: str=None, width: str=None):
        """GifImagesFixedWidth - a model defined in OpenAPI

        :param frames: The frames of this GifImagesFixedWidth.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GifImagesFixedWidth':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Gif_images_fixed_width of this GifImagesFixedWidth.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def frames(self):
        """Gets the frames of this GifImagesFixedWidth.

        The number of frames in this GIF.

        :return: The frames of this GifImagesFixedWidth.
        :rtype: str
        """
        return self._frames
    ...
    def frames(self, frames):
        """Sets the frames of this GifImagesFixedWidth.
