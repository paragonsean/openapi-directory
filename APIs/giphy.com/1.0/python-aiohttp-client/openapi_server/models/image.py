...
class Image(Model):
    ...
    def __init__(self, frames: str=None, height: str=None, mp4: str=None, mp4_size: str=None, size: str=None, url: str=None, webp: str=None, webp_size: str=None, width: str=None):
        ...
        :param frames: The frames of this Image.
        :param height: The height of this Image.
        :param mp4: The mp4 of this Image.
        :param mp4_size: The mp4_size of this Image.
        :param size: The size of this Image.
        :param url: The url of this Image.
        :param webp: The webp of this Image.
        :param webp_size: The webp_size of this Image.
    ...
    def frames(self):
        ...
        :return: The frames of this Image.
        :rtype: str
        """
        return self._frames
    ...
    @property
    def mp4(self):
        """Gets the mp4 of this Image.

        The URL for this GIF in .MP4 format.

        :return: The mp4 of this Image.
        :rtype: str
        """
        return self._mp4
    ...
    @property
    def mp4_size(self):
        """Gets the mp4_size of this Image.

        The size in bytes of the .MP4 file corresponding to this GIF.

        :return: The mp4_size of this Image.
        :rtype: str
        """
    ...
    def mp4_size(self, mp4_size):
        """Sets the mp4_size of this Image.
    ...
    @property
    def webp(self):
        """Gets the webp of this Image.

        The URL for this GIF in .webp format.

        :return: The webp of this Image.
        :rtype: str
        """
        return self._webp
    ...
    @property
    def webp_size(self):
        """Gets the webp_size of this Image.

        The size in bytes of the .webp file corresponding to this GIF.

        :return: The webp_size of this Image.
        :rtype: str
        """
    ...
    def webp_size(self, webp_size):
        """Sets the webp_size of this Image.
