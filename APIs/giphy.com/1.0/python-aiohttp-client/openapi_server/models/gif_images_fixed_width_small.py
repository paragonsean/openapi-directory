...
class GifImagesFixedWidthSmall(Model):
    ...
    def __init__(self, frames: str=None, height: str=None, mp4: str=None, mp4_size: str=None, size: str=None, url: str=None, webp: str=None, webp_size: str=None, width: str=None):
        """GifImagesFixedWidthSmall - a model defined in OpenAPI

        :param frames: The frames of this GifImagesFixedWidthSmall.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GifImagesFixedWidthSmall':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Gif_images_fixed_width_small of this GifImagesFixedWidthSmall.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def frames(self):
        """Gets the frames of this GifImagesFixedWidthSmall.

        The number of frames in this GIF.

        :return: The frames of this GifImagesFixedWidthSmall.
        :rtype: str
        """
        return self._frames
    ...
    def frames(self, frames):
        """Sets the frames of this GifImagesFixedWidthSmall.
