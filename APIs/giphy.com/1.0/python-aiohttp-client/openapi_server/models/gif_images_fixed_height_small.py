...
class GifImagesFixedHeightSmall(Model):
    ...
    def __init__(self, frames: str=None, height: str=None, mp4: str=None, mp4_size: str=None, size: str=None, url: str=None, webp: str=None, webp_size: str=None, width: str=None):
        """GifImagesFixedHeightSmall - a model defined in OpenAPI

        :param frames: The frames of this GifImagesFixedHeightSmall.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GifImagesFixedHeightSmall':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Gif_images_fixed_height_small of this GifImagesFixedHeightSmall.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def frames(self):
        """Gets the frames of this GifImagesFixedHeightSmall.

        The number of frames in this GIF.

        :return: The frames of this GifImagesFixedHeightSmall.
        :rtype: str
        """
        return self._frames
    ...
    def frames(self, frames):
        """Sets the frames of this GifImagesFixedHeightSmall.
