...
class GifImagesFixedHeightDownsampled(Model):
    ...
    def __init__(self, frames: str=None, height: str=None, mp4: str=None, mp4_size: str=None, size: str=None, url: str=None, webp: str=None, webp_size: str=None, width: str=None):
        """GifImagesFixedHeightDownsampled - a model defined in OpenAPI

        :param frames: The frames of this GifImagesFixedHeightDownsampled.
        :param height: The height of this GifImagesFixedHeightDownsampled.
        :param mp4: The mp4 of this GifImagesFixedHeightDownsampled.
        :param mp4_size: The mp4_size of this GifImagesFixedHeightDownsampled.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GifImagesFixedHeightDownsampled':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Gif_images_fixed_height_downsampled of this GifImagesFixedHeightDownsampled.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def frames(self):
        """Gets the frames of this GifImagesFixedHeightDownsampled.

        The number of frames in this GIF.

        :return: The frames of this GifImagesFixedHeightDownsampled.
        :rtype: str
        """
        return self._frames
    ...
    def frames(self, frames):
        """Sets the frames of this GifImagesFixedHeightDownsampled.
    ...
    @property
    def mp4(self):
        """Gets the mp4 of this GifImagesFixedHeightDownsampled.

        The URL for this GIF in .MP4 format.

        :return: The mp4 of this GifImagesFixedHeightDownsampled.
        :rtype: str
        """
        return self._mp4
    ...
    @mp4.setter
    def mp4(self, mp4):
        """Sets the mp4 of this GifImagesFixedHeightDownsampled.
    ...
    @property
    def mp4_size(self):
        """Gets the mp4_size of this GifImagesFixedHeightDownsampled.

        The size in bytes of the .MP4 file corresponding to this GIF.

        :return: The mp4_size of this GifImagesFixedHeightDownsampled.
        :rtype: str
        """
    ...
    def mp4_size(self, mp4_size):
        """Sets the mp4_size of this GifImagesFixedHeightDownsampled.
