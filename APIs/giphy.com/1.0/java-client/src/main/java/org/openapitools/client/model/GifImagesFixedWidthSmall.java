...
public class GifImagesFixedWidthSmall {
  ...
  public GifImagesFixedWidthSmall() {
  }

  public GifImagesFixedWidthSmall frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall mp4Size(String mp4Size) {
  ...
  public GifImagesFixedWidthSmall size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesFixedWidthSmall webpSize(String webpSize) {
  ...
  public GifImagesFixedWidthSmall width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesFixedWidthSmall gifImagesFixedWidthSmall = (GifImagesFixedWidthSmall) o;
    return Objects.equals(this.frames, gifImagesFixedWidthSmall.frames) &&
        Objects.equals(this.height, gifImagesFixedWidthSmall.height) &&
        Objects.equals(this.mp4, gifImagesFixedWidthSmall.mp4) &&
        Objects.equals(this.mp4Size, gifImagesFixedWidthSmall.mp4Size) &&
        Objects.equals(this.size, gifImagesFixedWidthSmall.size) &&
        Objects.equals(this.url, gifImagesFixedWidthSmall.url) &&
        Objects.equals(this.webp, gifImagesFixedWidthSmall.webp) &&
        Objects.equals(this.webpSize, gifImagesFixedWidthSmall.webpSize) &&
        Objects.equals(this.width, gifImagesFixedWidthSmall.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesFixedWidthSmall {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesFixedWidthSmall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesFixedWidthSmall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesFixedWidthSmall is not found in the empty JSON string", GifImagesFixedWidthSmall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesFixedWidthSmall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesFixedWidthSmall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesFixedWidthSmall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesFixedWidthSmall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesFixedWidthSmall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesFixedWidthSmall.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesFixedWidthSmall>() {
           @Override
           public void write(JsonWriter out, GifImagesFixedWidthSmall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesFixedWidthSmall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesFixedWidthSmall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesFixedWidthSmall
   * @throws IOException if the JSON string is invalid with respect to GifImagesFixedWidthSmall
   */
  public static GifImagesFixedWidthSmall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesFixedWidthSmall.class);
  }

  /**
   * Convert an instance of GifImagesFixedWidthSmall to an JSON string
   *
   * @return JSON string
   */
