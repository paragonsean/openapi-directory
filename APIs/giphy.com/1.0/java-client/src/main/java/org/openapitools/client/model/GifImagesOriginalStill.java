...
public class GifImagesOriginalStill {
  ...
  public GifImagesOriginalStill() {
  }

  public GifImagesOriginalStill frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesOriginalStill height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesOriginalStill mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesOriginalStill mp4Size(String mp4Size) {
  ...
  public GifImagesOriginalStill size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesOriginalStill url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesOriginalStill webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesOriginalStill webpSize(String webpSize) {
  ...
  public GifImagesOriginalStill width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesOriginalStill gifImagesOriginalStill = (GifImagesOriginalStill) o;
    return Objects.equals(this.frames, gifImagesOriginalStill.frames) &&
        Objects.equals(this.height, gifImagesOriginalStill.height) &&
        Objects.equals(this.mp4, gifImagesOriginalStill.mp4) &&
        Objects.equals(this.mp4Size, gifImagesOriginalStill.mp4Size) &&
        Objects.equals(this.size, gifImagesOriginalStill.size) &&
        Objects.equals(this.url, gifImagesOriginalStill.url) &&
        Objects.equals(this.webp, gifImagesOriginalStill.webp) &&
        Objects.equals(this.webpSize, gifImagesOriginalStill.webpSize) &&
        Objects.equals(this.width, gifImagesOriginalStill.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesOriginalStill {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesOriginalStill
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesOriginalStill.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesOriginalStill is not found in the empty JSON string", GifImagesOriginalStill.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesOriginalStill.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesOriginalStill` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesOriginalStill.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesOriginalStill' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesOriginalStill> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesOriginalStill.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesOriginalStill>() {
           @Override
           public void write(JsonWriter out, GifImagesOriginalStill value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesOriginalStill read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesOriginalStill given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesOriginalStill
   * @throws IOException if the JSON string is invalid with respect to GifImagesOriginalStill
   */
  public static GifImagesOriginalStill fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesOriginalStill.class);
  }

  /**
   * Convert an instance of GifImagesOriginalStill to an JSON string
   *
   * @return JSON string
   */
