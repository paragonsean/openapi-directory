...
/*
 * OAIGif_images_fixed_width.h
 *
 * 
 */

#ifndef OAIGif_images_fixed_width_H
#define OAIGif_images_fixed_width_H
...
class OAIGif_images_fixed_width : public OAIObject {
public:
    OAIGif_images_fixed_width();
    OAIGif_images_fixed_width(QString json);
    ~OAIGif_images_fixed_width() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_fixed_width)

#endif // OAIGif_images_fixed_width_H
