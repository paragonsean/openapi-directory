...
/*
 * OAIGif_images_original.h
 *
 * 
 */

#ifndef OAIGif_images_original_H
#define OAIGif_images_original_H
...
class OAIGif_images_original : public OAIObject {
public:
    OAIGif_images_original();
    OAIGif_images_original(QString json);
    ~OAIGif_images_original() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_original)

#endif // OAIGif_images_original_H
