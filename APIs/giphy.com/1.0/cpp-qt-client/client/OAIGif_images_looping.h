...
/*
 * OAIGif_images_looping.h
 *
 * 
 */

#ifndef OAIGif_images_looping_H
#define OAIGif_images_looping_H
...
class OAIGif_images_looping : public OAIObject {
public:
    OAIGif_images_looping();
    OAIGif_images_looping(QString json);
    ~OAIGif_images_looping() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_looping)

#endif // OAIGif_images_looping_H
