...
/*
 * OAIGif_images_downsized_small.h
 *
 * 
 */

#ifndef OAIGif_images_downsized_small_H
#define OAIGif_images_downsized_small_H
...
class OAIGif_images_downsized_small : public OAIObject {
public:
    OAIGif_images_downsized_small();
    OAIGif_images_downsized_small(QString json);
    ~OAIGif_images_downsized_small() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_downsized_small)

#endif // OAIGif_images_downsized_small_H
