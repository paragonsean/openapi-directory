...
/*
 * OAIGif_images_fixed_height.h
 *
 * 
 */

#ifndef OAIGif_images_fixed_height_H
#define OAIGif_images_fixed_height_H
...
class OAIGif_images_fixed_height : public OAIObject {
public:
    OAIGif_images_fixed_height();
    OAIGif_images_fixed_height(QString json);
    ~OAIGif_images_fixed_height() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_fixed_height)

#endif // OAIGif_images_fixed_height_H
