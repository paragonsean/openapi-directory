...
/*
 * OAIGif_images_downsized_still.h
 *
 * 
 */

#ifndef OAIGif_images_downsized_still_H
#define OAIGif_images_downsized_still_H
...
class OAIGif_images_downsized_still : public OAIObject {
public:
    OAIGif_images_downsized_still();
    OAIGif_images_downsized_still(QString json);
    ~OAIGif_images_downsized_still() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_downsized_still)

#endif // OAIGif_images_downsized_still_H
