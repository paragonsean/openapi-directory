...
/*
 * OAIGif_images_fixed_width_small_still.h
 *
 * 
 */

#ifndef OAIGif_images_fixed_width_small_still_H
#define OAIGif_images_fixed_width_small_still_H
...
class OAIGif_images_fixed_width_small_still : public OAIObject {
public:
    OAIGif_images_fixed_width_small_still();
    OAIGif_images_fixed_width_small_still(QString json);
    ~OAIGif_images_fixed_width_small_still() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_fixed_width_small_still)

#endif // OAIGif_images_fixed_width_small_still_H
