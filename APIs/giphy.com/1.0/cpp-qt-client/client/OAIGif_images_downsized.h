...
/*
 * OAIGif_images_downsized.h
 *
 * 
 */

#ifndef OAIGif_images_downsized_H
#define OAIGif_images_downsized_H
...
class OAIGif_images_downsized : public OAIObject {
public:
    OAIGif_images_downsized();
    OAIGif_images_downsized(QString json);
    ~OAIGif_images_downsized() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_downsized)

#endif // OAIGif_images_downsized_H
