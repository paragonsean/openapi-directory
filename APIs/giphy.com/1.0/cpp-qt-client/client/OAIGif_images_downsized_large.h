...
/*
 * OAIGif_images_downsized_large.h
 *
 * 
 */

#ifndef OAIGif_images_downsized_large_H
#define OAIGif_images_downsized_large_H
...
class OAIGif_images_downsized_large : public OAIObject {
public:
    OAIGif_images_downsized_large();
    OAIGif_images_downsized_large(QString json);
    ~OAIGif_images_downsized_large() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_downsized_large)

#endif // OAIGif_images_downsized_large_H
