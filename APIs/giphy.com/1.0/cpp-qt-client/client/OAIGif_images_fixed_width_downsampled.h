...
/*
 * OAIGif_images_fixed_width_downsampled.h
 *
 * 
 */

#ifndef OAIGif_images_fixed_width_downsampled_H
#define OAIGif_images_fixed_width_downsampled_H
...
class OAIGif_images_fixed_width_downsampled : public OAIObject {
public:
    OAIGif_images_fixed_width_downsampled();
    OAIGif_images_fixed_width_downsampled(QString json);
    ~OAIGif_images_fixed_width_downsampled() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_fixed_width_downsampled)

#endif // OAIGif_images_fixed_width_downsampled_H
