...
/*
 * OAIGif_images_preview_gif.h
 *
 * 
 */

#ifndef OAIGif_images_preview_gif_H
#define OAIGif_images_preview_gif_H
...
class OAIGif_images_preview_gif : public OAIObject {
public:
    OAIGif_images_preview_gif();
    OAIGif_images_preview_gif(QString json);
    ~OAIGif_images_preview_gif() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_preview_gif)

#endif // OAIGif_images_preview_gif_H
