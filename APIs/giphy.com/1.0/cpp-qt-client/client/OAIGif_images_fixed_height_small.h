...
/*
 * OAIGif_images_fixed_height_small.h
 *
 * 
 */

#ifndef OAIGif_images_fixed_height_small_H
#define OAIGif_images_fixed_height_small_H
...
class OAIGif_images_fixed_height_small : public OAIObject {
public:
    OAIGif_images_fixed_height_small();
    OAIGif_images_fixed_height_small(QString json);
    ~OAIGif_images_fixed_height_small() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_fixed_height_small)

#endif // OAIGif_images_fixed_height_small_H
