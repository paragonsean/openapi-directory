...
/*
 * OAIGif_images_preview.h
 *
 * 
 */

#ifndef OAIGif_images_preview_H
#define OAIGif_images_preview_H
...
class OAIGif_images_preview : public OAIObject {
public:
    OAIGif_images_preview();
    OAIGif_images_preview(QString json);
    ~OAIGif_images_preview() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_preview)

#endif // OAIGif_images_preview_H
