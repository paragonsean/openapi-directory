...
/*
 * OAIGif_images_downsized_medium.h
 *
 * 
 */

#ifndef OAIGif_images_downsized_medium_H
#define OAIGif_images_downsized_medium_H
...
class OAIGif_images_downsized_medium : public OAIObject {
public:
    OAIGif_images_downsized_medium();
    OAIGif_images_downsized_medium(QString json);
    ~OAIGif_images_downsized_medium() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGif_images_downsized_medium)

#endif // OAIGif_images_downsized_medium_H
